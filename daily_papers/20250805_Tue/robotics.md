...
>
---
#### [new 003] RoboMemory: A Brain-inspired Multi-memory Agentic Framework for Lifelong Learning in Physical Embodied Systems
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出一种基于脑机网络的多模态记忆框架，旨在解决连续学习、多模块延迟、任务关联及无限循环问题，在物理实体系统中实现长期学习，通过整合信息预处理、长期记忆、闭环规划与低级执行模块，验证了其性能优势并建立了新的SOTA基准。**

- **链接: [http://arxiv.org/pdf/2508.01415v1](http://arxiv.org/pdf/2508.01415v1)**
...
>
---
#### [new 004] Set the Stage: Enabling Storytelling with Multiple Robots through Roleplaying Metaphors
- **分类: cs.RO; cs.HC**

- **简介: 该论文旨在解决手势控制多机器人系统中映射与识别约束问题，通过引入角色扮演元手法（Director/Puppeteer/Wizard）构建叙事框架，展示手势多样性与交互风格的创新设计，强调创意表达与直观性作为未来人机交互的关键要素。**

- **链接: [http://arxiv.org/pdf/2508.01736v1](http://arxiv.org/pdf/2508.01736v1)**

> **作者:** Tyrone Justin Sta Maria; Faith Griffin; Jordan Aiko Deja
>
> **备注:** 3 pages, 2 figures, UIST Poster, adjunct proceedings
>
> **摘要:** Gestures are an expressive input modality for controlling multiple robots, but their use is often limited by rigid mappings and recognition constraints. To move beyond these limitations, we propose roleplaying metaphors as a scaffold for designing richer interactions. By introducing three roles: Director, Puppeteer, and Wizard, we demonstrate how narrative framing can guide the creation of diverse gesture sets and interaction styles. These roles enable a variety of scenarios, showing how roleplay can unlock new possibilities for multi-robot systems. Our approach emphasizes creativity, expressiveness, and intuitiveness as key elements for future human-robot interaction design.
>
---
#### [new 005] Framework for Robust Motion Planning of Tethered Multi-Robot Systems in Marine Environments
- **分类: cs.RO**

- **简介: 该论文提出了一种针对海洋环境中多机器人系统（ASV/AUV）的路径规划框架CoralGuide，解决了在复杂海洋环境下协同导航的安全性与效率问题，通过改进A*算法并融合catenary曲线与Bezier插值技术，实现了轨迹优化与同步控制。**

- **链接: [http://arxiv.org/pdf/2508.02287v1](http://arxiv.org/pdf/2508.02287v1)**
...
>
---
#### [new 007] Energy-Predictive Planning for Optimizing Drone Service Delivery
- **分类: cs.RO; cs.DC; cs.ET**

- **简介: 该论文提出一种基于能量预测的无人机服务优化框架，解决多无人机协同配送中的路径规划与能源管理问题，通过自适应LSTM模型预测能量状态并优化路径与充电策略，实验验证其有效性。**

- **链接: [http://arxiv.org/pdf/2508.01671v1](http://arxiv.org/pdf/2508.01671v1)**

> **作者:** Guanting Ren; Babar Shahzaad; Balsam Alkouz; Abdallah Lakhdari; Athman Bouguettaya
>
> **备注:** 37 pages, 16 figures. This is an accepted paper, and it is going to appear in the Expert Systems with Applications journal
>
...
>
---
#### [new 008] Periodic robust robotic rock chop via virtual model control
- **分类: cs.RO; cs.SY; eess.SY**

- **简介: 该论文提出了一种基于虚拟模型控制的周期性机械臂切削解决方案，解决了接触复杂环境下的动态响应与多变量交互问题，通过虚拟弹簧、减震器等机制实现无预规划轨迹的自主控制，验证了其在Franka manipulator上的鲁棒性和适应性。**

- **链接: [http://arxiv.org/pdf/2508.02604v1](http://arxiv.org/pdf/2508.02604v1)**
...
>
---
#### [new 009] HyCodePolicy: Hybrid Language Controllers for Multimodal Monitoring and Decision in Embodied Agents
...
>
---
#### [new 010] CLASS: Contrastive Learning via Action Sequence Supervision for Robot Manipulation
- **分类: cs.RO**

- **简介: 该论文旨在解决机器人操作学习中的跨数据集泛化问题，通过动作序列监督（CLASS）利用DTW识别相似动作序列，并优化软信息NCE损失，提升在视觉变化显著任务中的成功率。**

- **链接: [http://arxiv.org/pdf/2508.01600v1](http://arxiv.org/pdf/2508.01600v1)**
...
>
---
#### [new 011] Sparse 3D Perception for Rose Harvesting Robots: A Two-Stage Approach Bridging Simulation and Real-World Applications
...
>
---
#### [new 012] VLH: Vision-Language-Haptics Foundation Model
- **分类: cs.RO**

- **简介: 该论文提出VLH（视觉-语言-触觉基础模型），旨在整合感知、语言和触觉反馈以增强无人机与VR系统的交互能力。通过将中空力与振动从视觉语义推导而来，结合8英寸四旋翼和逆五连杆数组，采用INT8量化和OpenVLA骨干网络优化实现实时操作，验证了其在目标识别（56.7%）、纹理区分（100%）和多模态适应性中的表现。**

- **链接: [http://arxiv.org/pdf/2508.01361v1](http://arxiv.org/pdf/2508.01361v1)**
...
>
---
#### [new 017] CO-RFT: Efficient Fine-Tuning of Vision-Language-Action Models through Chunked Offline Reinforcement Learning
- **分类: cs.RO; cs.LG**

- **简介: 该论文旨在解决VLA模型微调中的样本效率低、兼容性差及训练稳定性问题，提出基于分块的Offline RL框架CO-RFT，通过IL初始化参数并优化policy，实现在30-60个样本下的有效微调，实现57%的成功率提升和22.3%的响应时间减少，具备鲁棒性。**

- **链接: [http://arxiv.org/pdf/2508.02219v1](http://arxiv.org/pdf/2508.02219v1)**
...
>
---
#### [new 020] Unified Generation-Refinement Planning: Bridging Flow Matching and Sampling-Based MPC
- **分类: cs.RO**

- **简介: 该论文提出一种统一生成-精炼规划框架，解决机器人在动态环境中的安全高效行为规划问题。通过结合强化学习的CFM模型与模型预测控制（MPPI），融合样本引导的约束采样与实时优化路径，展示了在自主社交导航等场景下的实时安全适应能力。**

- **链接: [http://arxiv.org/pdf/2508.01192v1](http://arxiv.org/pdf/2508.01192v1)**
...
>
---
#### [new 021] QuaDreamer: Controllable Panoramic Video Generation for Quadruped Robots
...
>
---
#### [new 024] Manip4Care: Robotic Manipulation of Human Limbs for Solving Assistive Tasks
- **分类: cs.RO**

- **简介: 该论文提出了一种模块化仿真实验系统，旨在通过机器人抓握与重定位技术提升对严重肢体障碍患者的辅助功能，解决传统静态/静止假想模型受限于关节范围等问题，实现了床态洗浴等高精度任务的可行性验证。**

- **链接: [http://arxiv.org/pdf/2508.02649v1](http://arxiv.org/pdf/2508.02649v1)**

> **作者:** Yubin Koh; Ahmed H. Qureshi
>
> **备注:** Accepted to IROS 2025
>
> **摘要:** Enabling robots to grasp and reposition human limbs can significantly enhance their ability to provide assistive care to individuals with severe mobility impairments, particularly in tasks such as robot-assisted bed bathing and dressing. However, existing assistive robotics solutions often assume that the human remains static or quasi-static, limiting their effectiveness. To address this issue, we present Manip4Care, a modular simulation pipeline that enables robotic manipulators to grasp and reposition human limbs effectively. Our approach features a physics simulator equipped with built-in techniques for grasping and repositioning while considering biomechanical and collision avoidance constraints. Our grasping method employs antipodal sampling with force closure to grasp limbs, and our repositioning system utilizes the Model Predictive Path Integral (MPPI) and vector-field-based control method to generate motion trajectories under collision avoidance and biomechanical constraints. We evaluate this approach across various limb manipulation tasks in both supine and sitting positions and compare outcomes for different age groups with differing shoulder joint limits. Additionally, we demonstrate our approach for limb manipulation using a real-world mannequin and further showcase its effectiveness in bed bathing tasks.
>
---
#### [new 025] Towards Zero-Shot Terrain Traversability Estimation: Challenges and Opportunities
- **分类: cs.RO**

- **简介: 该论文旨在解决地形可通行性估计问题，通过引入人类标注数据和VLM结合的方法，探索零样本任务的挑战与机遇。研究提出了简化管道并验证了其有效性，尽管基础模型尚不成熟，但仍为后续研究提供了方向。**

- **链接: [http://arxiv.org/pdf/2508.01715v1](http://arxiv.org/pdf/2508.01715v1)**
...
>
---
#### [new 028] From Photons to Physics: Autonomous Indoor Drones and the Future of Objective Property Assessment
...
>
---
#### [new 031] "Set It Up": Functional Object Arrangement with Compositional Generative Models
- **分类: cs.RO**

- **简介: 该论文研究了功能对象排列（FORM）任务，旨在解决指令模糊导致的未指定目标姿态问题。通过神经符号系统设计，SetItUp将FORM拆分为两阶段：先预测抽象空间关系图，再生成物体姿态。利用LLMs生成程序与扩散模型在线组合，实现了对物理可行性和美学的优化，实验表明其优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.02068v1](http://arxiv.org/pdf/2508.02068v1)**
...
>
---
#### [new 034] Design and Control of an Actively Morphing Quadrotor with Vertically Foldable Arms
- **分类: cs.RO**

- **简介: 该论文设计并开发了一种可主动变形的四旋翼无人机，解决狭小空间抓取与导航问题，通过伺服系统和自适应滑模控制实现有效形态转换。**

- **链接: [http://arxiv.org/pdf/2508.02022v1](http://arxiv.org/pdf/2508.02022v1)**

> **作者:** Tingyu Yeh; Mengxin Xu; Lijun Han
>
...
>
---
#### [new 035] ScrewSplat: An End-to-End Method for Articulated Object Recognition
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 036] Improving Generalization of Language-Conditioned Robot Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 039] Coordinated Humanoid Robot Locomotion with Symmetry Equivariant Reinforcement Learning Policy
- **分类: cs.RO**

- **简介: 该论文探讨了协调人类移动机器人运动的方法，通过引入对称等价强化学习策略解决了传统方法忽略对称性导致的不协调问题，提出了SE-Policy框架并进行了实验证明其在跟踪任务中的性能提升。**

- **链接: [http://arxiv.org/pdf/2508.01247v1](http://arxiv.org/pdf/2508.01247v1)**
...
>
---
#### [new 042] Human-Robot Red Teaming for Safety-Aware Reasoning
- **分类: cs.RO; cs.AI**

- **简介: 该论文探讨了基于人机协作的安全推理方法，旨在解决机器人在高风险场景中的安全决策与信任建立问题，通过红队合作探索环境风险，验证不同环境下的适应性与安全性。**

- **链接: [http://arxiv.org/pdf/2508.01129v1](http://arxiv.org/pdf/2508.01129v1)**
...
>
---
#### [new 043] Failure-Aware Multi-Robot Coordination for Resilient and Adaptive Target Tracking
- **分类: cs.RO**

- **简介: 该论文旨在解决多机器人在动态环境中的可靠协同与目标追踪问题，针对临时/永久故障设计统一框架，通过分组协作与自主优化实现鲁棒性提升，并在实验证明其在未知危险区域中的有效性。**

- **链接: [http://arxiv.org/pdf/2508.02529v1](http://arxiv.org/pdf/2508.02529v1)**

> **作者:** Peihan Li; Jiazhen Liu; Yuwei Wu; Gaurav S. Sukhatme; Vijay Kumar; Lifeng Zhou
>
...
>
---
#### [new 044] Service Discovery-Based Hybrid Network Middleware for Efficient Communication in Distributed Robotic Systems
- **分类: cs.RO; cs.DC; cs.NI; I.2.9; C.2.4; D.4.7**

- **简介: 该论文提出了一种基于服务发现的混合网络通信中间件（RIMAOS2C），旨在解决分布式机器人系统中多通信模式下的数据传输效率低、调度不确定性高等问题。通过消息桥接机制优化数据转发与共享内存技术，结合TCP-ZeroMQ协议克服了大型消息传输瓶颈，并在跨芯片场景下实现了36%-40%的冗余消除和42%-906%的延迟降低。**

- **链接: [http://arxiv.org/pdf/2508.00947v1](http://arxiv.org/pdf/2508.00947v1)**

> **作者:** Shiyao Sang; Yinggang Ling
>
> **备注:** 8 pages, 8 figures, accepted to IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) 2025, oral presentation
>
...
>
---
#### [new 047] FedVLA: Federated Vision-Language-Action Learning with Dual Gating Mixture-of-Experts for Robotic Manipulation
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于**联邦视觉-语言-动作学习任务**，旨在解决传统VLA模型依赖大规模用户数据带来的隐私与安全问题。通过引入Instruction-Oriented Scene-Parsing机制、Dual Gating Mixture-of-Experts (DGMoE)和Expert-Driven Aggregation策略，实现了高效且隐私保护的分布式训练，显著提升任务性能和计算效率。**

- **链接: [http://arxiv.org/pdf/2508.02190v1](http://arxiv.org/pdf/2508.02190v1)**
...
>
---
#### [new 048] Hestia: Hierarchical Next-Best-View Exploration for Systematic Intelligent Autonomous Data Collection
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 049] Design of Q8bot: A Miniature, Low-Cost, Dynamic Quadruped Built with Zero Wires
- **分类: cs.RO; cs.SY; eess.SY**

- **简介: 该论文旨在开发一款基于零线设计的微型四足机器人，解决低成本、高性能与可扩展性问题，通过简化电路并采用模块化结构实现轻量化与耐用性。**

- **链接: [http://arxiv.org/pdf/2508.01149v1](http://arxiv.org/pdf/2508.01149v1)**
...
>
---
#### [new 050] Decentralized Aerial Manipulation of a Cable-Suspended Load using Multi-Agent Reinforcement Learning
- **分类: cs.RO; cs.AI; cs.MA; I.2.9; I.2.11; I.2.6**

- **简介: 该论文提出了一种分布式多智能体强化学习方法，解决实时6DoF悬停控制问题，通过自主决策优化并结合低功耗通信，在无中央控制架构下实现了高效率的负载操控。**

- **链接: [http://arxiv.org/pdf/2508.01522v1](http://arxiv.org/pdf/2508.01522v1)**
...
>
---
#### [new 051] COLLAGE: Adaptive Fusion-based Retrieval for Augmented Policy Learning
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属于few-shot imitation learning任务，旨在解决从大量数据中高效选择示例以训练性能优异的政策的问题。通过采用自适应融合机制，COLLAGE利用子集权重动态调整数据检索策略，提升多任务学习效果。**

- **链接: [http://arxiv.org/pdf/2508.01131v1](http://arxiv.org/pdf/2508.01131v1)**
...
>
---
#### [new 052] A Moment Matching-Based Method for Sparse and Noisy Point Cloud Registration
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 053] Adverse Weather-Independent Framework Towards Autonomous Driving Perception through Temporal Correlation and Unfolded Regularization
- **分类: cs.RO**

- **简介: 该论文研究了一种天气无关的自动驾驶感知框架，旨在解决传统域适应方法依赖清晰图像参考和单一天气条件的问题。通过引入局部顺序机制（LSM）、全局随机化机制（GSM）和展开正则化（URs），有效提升了模型在多天气场景下的泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.01583v1](http://arxiv.org/pdf/2508.01583v1)**

> **作者:** Wei-Bin Kou; Guangxu Zhu; Rongguang Ye; Jingreng Lei; Shuai Wang; Qingfeng Lin; Ming Tang; Yik-Chung Wu
>
> **备注:** 10 pages. arXiv admin note: substantial text overlap with arXiv:2409.14737
>
...
>
---
#### [new 056] Physically-based Lighting Augmentation for Robotic Manipulation
- **分类: cs.RO**

- **简介: 该论文旨在解决光照变化对机器人操作泛化能力的影响，提出物理基照明度增强框架。通过逆向渲染分解光照参数并结合细调模型实现时间一致性增强，验证了其在减少行为模仿泛化能力（40.1%）方面的有效性，展示了其在机器人操作中的应用。**

- **链接: [http://arxiv.org/pdf/2508.01442v1](http://arxiv.org/pdf/2508.01442v1)**
...
>
---
#### [new 057] HALO: Human Preference Aligned Offline Reward Learning for Robot Navigation
- **分类: cs.RO**

- **简介: 该论文提出一种基于人类偏好与线下奖励学习的机器人导航方法（HALO），解决传统视觉导航方法难以捕捉人类意图的问题，通过采样、Boltzmann分布等机制融合偏好反馈，利用Plackett-Luce损失优化奖励模型，在两种应用场景中验证其有效性，实现导航性能提升。**

- **链接: [http://arxiv.org/pdf/2508.01539v1](http://arxiv.org/pdf/2508.01539v1)**
...
>
---
#### [new 059] A Simple Algebraic Solution for Estimating the Pose of a Camera from Planar Point Features
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 060] 3DRot: 3D Rotation Augmentation for RGB-Based 3D Tasks
...
>
---
#### [new 061] An Event-based Fast Intensity Reconstruction Scheme for UAV Real-time Perception
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 062] mmWave Radar-Based Non-Line-of-Sight Pedestrian Localization at T-Junctions Utilizing Road Layout Extraction via Camera
...
>
---
#### [new 067] DiffSemanticFusion: Semantic Raster BEV Fusion for Autonomous Driving via Online HD Map Diffusion
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 068] NarraGuide: an LLM-based Narrative Mobile Robot for Remote Place Exploration
- **分类: cs.HC; cs.RO; 68**

- **简介: 该论文提出了一种基于LLM的移动机器人NarraGuide，旨在通过对话式交互支持远程探索，解决传统机器人缺乏环境知识导致的导航与感知能力不足的问题。实验显示，系统帮助用户学习并体验陌生环境，验证了LLM在增强远程探索体验中的潜力。**

- **链接: [http://arxiv.org/pdf/2508.01235v1](http://arxiv.org/pdf/2508.01235v1)**
...
>
---
#### [new 069] RoboLinker: A Diffusion-model-based Matching Clothing Generator Between Humans and Companion Robots
- **分类: cs.HC; cs.CY; cs.RO**

- **简介: 该论文提出了一种基于扩散模型的服装配对生成系统（RoboLinker），用于将机器人服装与人类服装风格匹配。通过交互式界面优化设计并评估其效果，解决了服装风格一致性与情感共鸣的问题。**

- **链接: [http://arxiv.org/pdf/2508.01165v1](http://arxiv.org/pdf/2508.01165v1)**
...
>
---
#### [new 070] A Coarse-to-Fine Approach to Multi-Modality 3D Occupancy Grounding
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 076] ROVER: Recursive Reasoning Over Videos with Vision-Language Models for Embodied Tasks
...
>
---
#### [new 077] Towards Immersive Human-X Interaction: A Real-Time Framework for Physically Plausible Motion Synthesis
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 078] Dynamic Robot-Assisted Surgery with Hierarchical Class-Incremental Semantic Segmentation
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 079] Perspective from a Broader Context: Can Room Style Knowledge Help Visual Floorplan Localization?
- **分类: cs.CV; cs.RO**
...
#### [replaced 001] ReCoDe: Reinforcement Learning-based Dynamic Constraint Design for Multi-Agent Coordination
- **分类: cs.RO; cs.AI; cs.LG; cs.MA; I.2.9**

- **链接: [http://arxiv.org/pdf/2507.19151v2](http://arxiv.org/pdf/2507.19151v2)**
...
>
---
#### [replaced 002] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 003] Human-Machine Shared Control Approach for the Takeover of Cooperative Adaptive Cruise Control
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2407.11551v3](http://arxiv.org/pdf/2407.11551v3)**
...
>
---
#### [replaced 007] Dynamic-Dark SLAM: RGB-Thermal Cooperative Robot Vision Strategy for Multi-Person Tracking in Both Well-Lit and Low-Light Scenes
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 008] OmniPose6D: Towards Short-Term Object Pose Tracking in Dynamic Scenes from Monocular RGB
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 009] Faster Motion Planning via Restarts
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2506.19016v2](http://arxiv.org/pdf/2506.19016v2)**
...
>
---
#### [replaced 010] AgiBot World Colosseo: A Large-scale Manipulation Platform for Scalable and Intelligent Embodied Systems
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [replaced 011] DiffSSC: Semantic LiDAR Scan Completion using Denoising Diffusion Probabilistic Models
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 012] Learning Physical Interaction Skills from Human Demonstrations
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2507.20445v2](http://arxiv.org/pdf/2507.20445v2)**
...
>
---
#### [replaced 015] Exploring 3D Reasoning-Driven Planning: From Implicit Human Intentions to Route-Aware Activity Planning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 020] pySLAM: An Open-Source, Modular, and Extensible Framework for SLAM
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 021] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 029] NeuFlow v2: Push High-Efficiency Optical Flow To the Limit
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 030] P2 Explore: Efficient Exploration in Unknown Cluttered Environment with Floor Plan Prediction
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2409.10878v3](http://arxiv.org/pdf/2409.10878v3)**

> **作者:** Kun Song; Gaoming Chen; Masayoshi Tomizuka; Wei Zhan; Zhenhua Xiong; Mingyu Ding
>
> **备注:** 7 pages, Accepted by IROS 2025, Open-sourced at https://github.com/KunSong-L/P2Explore
>
...
>
---
#### [replaced 031] Model Tensor Planning
- **分类: cs.RO; cs.AI; cs.LG; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2505.01059v2](http://arxiv.org/pdf/2505.01059v2)**
...
>
---
#### [replaced 032] MIXPINN: Mixed-Material Simulations by Physics-Informed Neural Network
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.13123v2](http://arxiv.org/pdf/2503.13123v2)**
...
>
---
#### [replaced 036] Eyes Will Shut: A Vision-Based Next GPS Location Prediction Model by Reinforcement Learning from Visual Map Feed Back
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 037] LanternNet: A Hub-and-Spoke System to Seek and Suppress Spotted Lanternfly Populations
...
>
---
#### [replaced 038] Unified Locomotion Transformer with Simultaneous Sim-to-Real Transfer for Quadrupeds
- **分类: cs.RO; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.08997v2](http://arxiv.org/pdf/2503.08997v2)**
...
>
---
#### [replaced 043] 3D-CDRGP: Towards Cross-Device Robotic Grasping Policy in 3D Open World
- **分类: cs.RO; cs.CV**
