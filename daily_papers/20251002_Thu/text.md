...
>
---
#### [new 003] EuroSpeech: A Multilingual Speech Corpus
- **分类: cs.CL; cs.LG**
...
- **简介: 该论文属于模型编辑任务，解决顺序编辑导致的性能下降和知识遗忘问题。通过引入超球面能量机制，提出SPHERE方法，稳定权重分布并提升编辑效果。**
...
- **简介: 该论文属于文本生成任务，旨在解决语言模型输出缺乏结构多样性与个性化的问题。通过引入语法引导和用户个性化机制，提升生成文本的质量与可控性。**
...
- **简介: 该论文提出DRBench，一个用于评估企业深度研究AI代理的基准。解决复杂多步骤任务的评估问题，涵盖多个领域，验证模型在事实准确性与报告生成方面的能力。**
...
- **链接: [http://arxiv.org/pdf/2510.00280v1](http://arxiv.org/pdf/2510.00280v1)**
...
- **简介: 该论文属于GUI自动化任务，解决GUI代理在处理长序列时的效率问题。提出GUI-KV方法，通过空间和时间冗余压缩KV缓存，提升推理效率与准确性。**
...
- **简介: 该论文属于自然语言处理任务，针对监督微调中的目标函数问题，研究不同概率目标在模型能力连续体上的表现，提出适应模型能力的优化方法。**
...
- **链接: [http://arxiv.org/pdf/2510.00276v1](http://arxiv.org/pdf/2510.00276v1)**
...
- **简介: 该论文属于机器学习中的模型遗忘任务，旨在无需外部资源的情况下有效移除模型中特定数据的影响，提出DTO方法直接优化令牌层级目标。**
...
- **简介: 该论文属于医疗文本生成任务，旨在提升心电图语言模型的准确性。通过引入检索增强生成技术，解决模型幻觉问题，并提供开源实现与实验验证。**
...
- **链接: [http://arxiv.org/pdf/2510.00568v1](http://arxiv.org/pdf/2510.00568v1)**
...
- **简介: 该论文属于自然语言处理任务，旨在解决Tenyidie语言的音节划分问题。作者创建了10,120个音节化的语料库，并应用深度学习方法进行实验，取得了高准确率。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型对网络迷因理解不足的问题。研究构建了CHIME数据集，并设计了两项任务评估模型的迷因解释与识别能力。**
...
- **简介: 该论文属于少样本推理任务，旨在解决传统RAG方法依赖静态数据库的问题。提出GRAD模型，动态生成输入相关演示，提升推理效果。**
...
- **简介: 该论文提出TokMem，解决大语言模型任务依赖提示效率低的问题。通过tokenized procedural memory实现模块化、可扩展的存储与调用。**
...
- **链接: [http://arxiv.org/pdf/2510.00890v1](http://arxiv.org/pdf/2510.00890v1)**
...
- **链接: [http://arxiv.org/pdf/2510.00579v1](http://arxiv.org/pdf/2510.00579v1)**
...
- **简介: 该论文属于对话状态追踪任务，旨在提升波斯语聊天机器人的准确性和连贯性。通过结合规则方法与语言模型，提出一种混合模型以解决传统方法适应性不足的问题。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决稀疏自编码器（SAE）在表示双向概念上的局限性。通过提出AbsTopK方法，提升模型的可解释性和表达能力。**
...
- **简介: 该论文属于人工智能可解释性研究，旨在评估EAP-IG方法的稳定性与可靠性，通过方差分析揭示其易受参数影响的问题，并提出改进建议。**
...
- **简介: 该论文属于信息检索任务，解决传统对比损失与AUC不匹配的问题。提出MW损失函数，提升检索器的校准性和区分度。**
...
- **链接: [http://arxiv.org/pdf/2510.01003v1](http://arxiv.org/pdf/2510.01003v1)**
...
>
---
#### [new 068] It Takes Two: Your GRPO Is Secretly DPO
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决GRPO训练效率低的问题。通过将GRPO与DPO关联，提出2-GRPO方法，在减少计算量的同时保持性能。**

- **链接: [http://arxiv.org/pdf/2510.00977v1](http://arxiv.org/pdf/2510.00977v1)**
...
>
> **摘要:** Group Relative Policy Optimization (GRPO) is a prominent reinforcement learning algorithm for post-training Large Language Models (LLMs). It is commonly believed that GRPO necessitates a large group size to ensure stable training via precise statistical estimation, which incurs substantial computational overhead. In this work, we challenge this assumption by reframing GRPO as a form of contrastive learning, which reveals a fundamental connection to Direct Preference Optimization (DPO). Motivated by DPO's empirical success, we investigate the minimal two-rollout case (2-GRPO), a configuration previously deemed infeasible. We provide a rigorous theoretical analysis to validate 2-GRPO and demonstrate empirically that it achieves performance on par with 16-GRPO, despite using only 1/8 of the rollouts and reducing training time by over 70%.
>
---
#### [new 069] IA aplicada al análisis del conflicto Irán-Israel: Mapeo de discursos en YouTube
- **分类: cs.SI; cs.AI; cs.CL; I.2.7, H.3.3**

- **简介: 该论文属于情感分析任务，旨在研究伊朗与以色列冲突在YouTube上的数字话语。通过AI技术分析大量评论，揭示话语分布及算法偏见影响。**

- **链接: [http://arxiv.org/pdf/2510.00021v1](http://arxiv.org/pdf/2510.00021v1)**
...
>
---
#### [new 070] Stochastic Self-Organization in Multi-Agent Systems
- **分类: cs.MA; cs.CL; cs.LG**

- **简介: 该论文属于多智能体系统任务，解决协作机制优化问题。提出SelfOrg框架，通过动态图结构实现自组织通信，提升协作效率与稳定性。**

- **链接: [http://arxiv.org/pdf/2510.00685v1](http://arxiv.org/pdf/2510.00685v1)**
...
>
---
#### [new 073] What You See is What You Ask: Evaluating Audio Descriptions
...
>
---
#### [new 074] Shape Happens: Automatic Feature Manifold Discovery in LLMs via Supervised Multi-Dimensional Scaling
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型中概念表示的几何结构问题。提出SMDS方法自动发现特征流形，揭示其在推理中的作用。**

- **链接: [http://arxiv.org/pdf/2510.01025v1](http://arxiv.org/pdf/2510.01025v1)**
...
>
---
#### [new 075] Milco: Learned Sparse Retrieval Across Languages via a Multilingual Connector
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于多语言信息检索任务，解决跨语言稀疏检索效率与效果问题。提出MILCO模型，通过多语言连接器将不同语言映射到共享英语空间，并引入LexEcho头提升鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.00671v1](http://arxiv.org/pdf/2510.00671v1)**
...
>
---
#### [new 076] HARPA: A Testability-Driven, Literature-Grounded Framework for Research Ideation
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于AI科学发现任务，旨在解决生成可测试且文献支持的假设问题。工作包括设计HARPA框架，结合文献分析与实验反馈优化假设生成。**

- **链接: [http://arxiv.org/pdf/2510.00620v1](http://arxiv.org/pdf/2510.00620v1)**
...
>
---
#### [new 078] The data-quality illusion: Rethinking Classifier-based quality filtering for LLM Pretraining
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理任务，研究数据质量过滤问题。针对CQF方法在预训练中的效果进行分析，发现其未必提升语言模型性能，挑战了数据质量评估的合理性。**

- **链接: [http://arxiv.org/pdf/2510.00866v1](http://arxiv.org/pdf/2510.00866v1)**
...
>
---
#### [new 079] Simultaneous Multi-objective Alignment Across Verifiable and Non-verifiable Rewards
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于多目标对齐任务，旨在解决模型在不同奖励类型（可验证、主观、交互场景）下的协同优化问题。提出MAH-DPO框架实现多目标训练与推理控制。**

- **链接: [http://arxiv.org/pdf/2510.01167v1](http://arxiv.org/pdf/2510.01167v1)**
...
>
---
#### [new 080] Spiralformer: Low Latency Encoder for Streaming Speech Recognition with Circular Layer Skipping and Early Exiting
...
>
---
#### [new 081] Can World Models Benefit VLMs for World Dynamics?
...
>
---
#### [new 082] Authentic Discrete Diffusion Model
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [new 083] TOUCAN: Synthesizing 1.5M Tool-Agentic Data from Real-World MCP Environments
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决工具代理数据不足的问题。通过合成1.5M真实MCP环境数据，提升LLM代理的多工具交互能力。**

- **链接: [http://arxiv.org/pdf/2510.01179v1](http://arxiv.org/pdf/2510.01179v1)**
...
>
---
#### [new 084] GEM: A Gym for Agentic LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决LLMs训练环境不足的问题。提出GEM框架，提供标准化环境与工具，支持多种训练算法，促进agentic LLM研究。**

- **链接: [http://arxiv.org/pdf/2510.01051v1](http://arxiv.org/pdf/2510.01051v1)**
...
>
---
#### [new 087] ARS: Adaptive Reasoning Suppression for Efficient Large Reasoning Language Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，针对大推理语言模型计算效率低的问题，提出ARS方法动态抑制冗余推理步骤，提升效率并保持准确率。**

- **链接: [http://arxiv.org/pdf/2510.00071v1](http://arxiv.org/pdf/2510.00071v1)**
...
>
---
#### [new 088] Bridging Language Gaps: Advances in Cross-Lingual Information Retrieval with Multilingual LLMs
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于跨语言信息检索任务，解决不同语言间文档检索问题，综述了从翻译方法到嵌入和生成技术的进展。**

- **链接: [http://arxiv.org/pdf/2510.00908v1](http://arxiv.org/pdf/2510.00908v1)**
...
>
---
#### [new 089] From Scores to Preferences: Redefining MOS Benchmarking for Speech Quality Reward Modeling
...
>
---
#### [new 090] Automated Evaluation can Distinguish the Good and Bad AI Responses to Patient Questions about Hospitalization
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于AI医疗问答评估任务，旨在解决如何高效、准确评价AI回答患者医院相关问题的质量。通过自动化方法对比28个AI系统的回答，验证了其与专家评价的一致性。**

- **链接: [http://arxiv.org/pdf/2510.00436v1](http://arxiv.org/pdf/2510.00436v1)**
...
>
---
#### [new 091] Eyes-on-Me: Scalable RAG Poisoning through Transferable Attention-Steering Attractors
- **分类: cs.LG; cs.CL; cs.CR**

- **简介: 该论文属于RAG系统安全研究，解决数据投毒攻击效率低的问题。提出Eyes-on-Me方法，通过可转移的注意力引导模块实现高效攻击。**

- **链接: [http://arxiv.org/pdf/2510.00586v1](http://arxiv.org/pdf/2510.00586v1)**
...
>
---
#### [replaced 002] DeepSearch: Overcome the Bottleneck of Reinforcement Learning with Verifiable Rewards via Monte Carlo Tree Search
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.25454v2](http://arxiv.org/pdf/2509.25454v2)**
...
>
---
#### [replaced 003] Mitigating Multimodal Hallucinations via Gradient-based Self-Reflection
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 004] $p$-less Sampling: A Robust Hyperparameter-Free Approach for LLM Decoding
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.23234v2](http://arxiv.org/pdf/2509.23234v2)**
...
>
---
#### [replaced 005] LoRA Users Beware: A Few Spurious Tokens Can Manipulate Your Finetuned Model
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.11402v2](http://arxiv.org/pdf/2506.11402v2)**
...
>
---
#### [replaced 010] Interactive Recommendation Agent with Active User Commands
- **分类: cs.IR; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2509.21317v2](http://arxiv.org/pdf/2509.21317v2)**
...
>
---
#### [replaced 011] The Illusion of Readiness: Stress Testing Large Frontier Models on Multimodal Medical Benchmarks
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.18234v2](http://arxiv.org/pdf/2509.18234v2)**
...
>
---
#### [replaced 012] v1: Learning to Point Visual Tokens for Multimodal Grounded Reasoning
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 013] Precise Information Control in Long-Form Text Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.06589v2](http://arxiv.org/pdf/2506.06589v2)**
...
>
---
#### [replaced 015] Scaling Linear Attention with Sparse State Expansion
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.16577v2](http://arxiv.org/pdf/2507.16577v2)**
...
>
---
#### [replaced 016] Metaphor identification using large language models: A comparison of RAG, prompt engineering, and fine-tuning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.24866v2](http://arxiv.org/pdf/2509.24866v2)**
...
>
---
#### [replaced 017] Learning to Rank Chain-of-Thought: Using a Small Model
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **链接: [http://arxiv.org/pdf/2505.14999v3](http://arxiv.org/pdf/2505.14999v3)**
...
>
---
#### [replaced 019] NAIPv2: Debiased Pairwise Learning for Efficient Paper Quality Estimation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.25179v2](http://arxiv.org/pdf/2509.25179v2)**
...
>
---
#### [replaced 020] Taxonomy of Comprehensive Safety for Clinical Agents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22041v3](http://arxiv.org/pdf/2509.22041v3)**
...
- **链接: [http://arxiv.org/pdf/2509.26184v2](http://arxiv.org/pdf/2509.26184v2)**
...
>
---
#### [replaced 022] TokenSmith: Streamlining Data Editing, Search, and Inspection for Large-Scale Language Model Training and Interpretability
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.19419v2](http://arxiv.org/pdf/2507.19419v2)**
...
>
---
#### [replaced 023] The Rarity Blind Spot: A Framework for Evaluating Statistical Reasoning in LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.00245v2](http://arxiv.org/pdf/2509.00245v2)**
...
>
---
#### [replaced 024] SafeSearch: Automated Red-Teaming for the Safety of LLM-Based Search Agents
- **分类: cs.AI; cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2509.23694v2](http://arxiv.org/pdf/2509.23694v2)**
...
>
---
#### [replaced 025] Through the Valley: Path to Effective Long CoT Training for Small Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.07712v2](http://arxiv.org/pdf/2506.07712v2)**
...
>
---
#### [replaced 026] Explaining novel senses using definition generation with open language models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.26181v2](http://arxiv.org/pdf/2509.26181v2)**
...
>
---
#### [replaced 027] MobileLLM-R1: Exploring the Limits of Sub-Billion Language Model Reasoners with Open Training Recipes
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.24945v2](http://arxiv.org/pdf/2509.24945v2)**
...
>
---
#### [replaced 030] Leaky Thoughts: Large Reasoning Models Are Not Private Thinkers
- **分类: cs.CL; cs.AI; cs.CR**

- **链接: [http://arxiv.org/pdf/2506.15674v2](http://arxiv.org/pdf/2506.15674v2)**
...
>
---
#### [replaced 031] PhyloLM : Inferring the Phylogeny of Large Language Models and Predicting their Performances in Benchmarks
- **分类: cs.CL; cs.LG; q-bio.PE**

- **链接: [http://arxiv.org/pdf/2404.04671v4](http://arxiv.org/pdf/2404.04671v4)**
...
>
---
#### [replaced 032] CounselBench: A Large-Scale Expert Evaluation and Adversarial Benchmarking of Large Language Models in Mental Health Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.08584v2](http://arxiv.org/pdf/2506.08584v2)**
...
>
---
#### [replaced 033] Out of the Box, into the Clinic? Evaluating State-of-the-Art ASR for Clinical Applications for Older Adults
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 034] MMGeoLM: Hard Negative Contrastive Learning for Fine-Grained Geometric Understanding in Large Multimodal Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 035] Beyond the Exploration-Exploitation Trade-off: A Hidden State Approach for LLM Reasoning in RLVR
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.23808v2](http://arxiv.org/pdf/2509.23808v2)**
...
>
---
#### [replaced 038] Evolving Language Models without Labels: Majority Drives Selection, Novelty Promotes Variation
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.15194v2](http://arxiv.org/pdf/2509.15194v2)**
...
>
---
#### [replaced 042] Are Knowledge and Reference in Multilingual Language Models Cross-Lingually Consistent?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.12838v2](http://arxiv.org/pdf/2507.12838v2)**

> **作者:** Xi Ai; Mahardika Krisna Ihsani; Min-Yen Kan
>
> **备注:** EMNLP'25 Findings Camera Ready
>
...
>
---
#### [replaced 043] Mapping Overlaps in Benchmarks through Perplexity in the Wild
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.23488v2](http://arxiv.org/pdf/2509.23488v2)**
...
>
---
#### [replaced 044] GIM: Improved Interpretability for Large Language Models
- **分类: cs.CL; cs.LG; 68T07; I.2.0; I.2.7**

- **链接: [http://arxiv.org/pdf/2505.17630v3](http://arxiv.org/pdf/2505.17630v3)**

> **作者:** Joakim Edin; Róbert Csordás; Tuukka Ruotsalo; Zhengxuan Wu; Maria Maistro; Casper L. Christensen; Jing Huang; Lars Maaløe
>
...
>
---
#### [replaced 047] Imagining Alternatives: Towards High-Resolution 3D Counterfactual Medical Image Generation via Language Guidance
...
>
---
#### [replaced 048] Ambiguity in LLMs is a concept missing problem
- **分类: cs.CL; cs.LG; I.2.7**

- **链接: [http://arxiv.org/pdf/2505.11679v3](http://arxiv.org/pdf/2505.11679v3)**

> **作者:** Zhibo Hu; Chen Wang; Yanfeng Shu; Hye-Young Paik; Liming Zhu
>
> **备注:** 17 pages, 11 figures, title updated
>
...
>
---
#### [replaced 049] ReFACT: A Benchmark for Scientific Confabulation Detection with Positional Error Annotations
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.25868v2](http://arxiv.org/pdf/2509.25868v2)**
...
>
---
#### [replaced 050] Stepwise Guided Policy Optimization: Coloring your Incorrect Reasoning in GRPO
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.11595v4](http://arxiv.org/pdf/2505.11595v4)**

> **作者:** Peter Chen; Xiaopeng Li; Ziniu Li; Xi Chen; Tianyi Lin
>
> **备注:** 42 pages; correct some typos
>
...
>
---
#### [replaced 051] Probing the Critical Point (CritPt) of AI Reasoning: a Frontier Physics Research Benchmark
- **分类: cs.AI; cond-mat.other; cs.CL; hep-th; quant-ph**

- **链接: [http://arxiv.org/pdf/2509.26574v2](http://arxiv.org/pdf/2509.26574v2)**
...
>
---
#### [replaced 052] Second Language (Arabic) Acquisition of LLMs via Progressive Vocabulary Expansion
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2412.12310v2](http://arxiv.org/pdf/2412.12310v2)**
...
>
> **摘要:** This paper addresses the critical need for democratizing large language models (LLM) in the Arab world, a region that has seen slower progress in developing models comparable to state-of-the-art offerings like GPT-4 or ChatGPT 3.5, due to a predominant focus on mainstream languages (e.g., English and Chinese). One practical objective for an Arabic LLM is to utilize an Arabic-specific vocabulary for the tokenizer that could speed up decoding. However, using a different vocabulary often leads to a degradation of learned knowledge since many words are initially out-of-vocabulary (OOV) when training starts. Inspired by the vocabulary learning during Second Language (Arabic) Acquisition for humans, the released AraLLaMA employs progressive vocabulary expansion, which is implemented by a modified BPE algorithm that progressively extends the Arabic subwords in its dynamic vocabulary during training, thereby balancing the OOV ratio at every stage. The ablation study demonstrated the effectiveness of Progressive Vocabulary Expansion. Moreover, AraLLaMA achieves decent performance comparable to the best Arabic LLMs across a variety of Arabic benchmarks. Models, training data, benchmarks, and codes will be all open-sourced.
>
---
#### [replaced 053] CultranAI at PalmX 2025: Data Augmentation for Cultural Knowledge Representation
- **分类: cs.CL; cs.AI; 68T50; F.2.2; I.2.7**

- **链接: [http://arxiv.org/pdf/2508.17324v2](http://arxiv.org/pdf/2508.17324v2)**
...
>
---
#### [replaced 054] LoRA meets Riemannion: Muon Optimizer for Parametrization-independent Low-Rank Adapters
- **分类: cs.LG; cs.CL; cs.NA; math.DG; math.NA; 68T07, 65F55, 53Z50**

- **链接: [http://arxiv.org/pdf/2507.12142v2](http://arxiv.org/pdf/2507.12142v2)**
...
>
---
#### [replaced 055] Learning Human-Perceived Fakeness in AI-Generated Videos via Multimodal LLMs
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 056] Breaking Down and Building Up: Mixture of Skill-Based Vision-and-Language Navigation Agents
...
>
---
#### [replaced 059] Steering When Necessary: Flexible Steering Large Language Models with Backtracking
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.17621v2](http://arxiv.org/pdf/2508.17621v2)**
...
>
---
#### [replaced 060] ConciseHint: Boosting Efficient Reasoning via Continuous Concise Hints during Generation
- **分类: cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 061] GUI-R1 : A Generalist R1-Style Vision-Language Action Model For GUI Agents
...
>
---
#### [replaced 062] GuRE:Generative Query REwriter for Legal Passage Retrieval
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.12950v2](http://arxiv.org/pdf/2505.12950v2)**

> **作者:** Daehee Kim; Deokhyung Kang; Jonghwi Kim; Sangwon Ryu; Gary Geunbae Lee
>
> **备注:** NLLP Workshop at EMNLP 2025
>
...
>
---
#### [replaced 063] Language Models can Subtly Deceive Without Lying: A Case Study on Strategic Phrasing in Legislation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2405.04325v3](http://arxiv.org/pdf/2405.04325v3)**
...
>
---
#### [replaced 065] Whose Journey Matters? Investigating Identity Biases in Large Language Models (LLMs) for Travel Planning Assistance
...
>
---
#### [replaced 066] A Multimodal LLM Approach for Visual Question Answering on Multiparametric 3D Brain MRI
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 067] Retain or Reframe? A Computational Framework for the Analysis of Framing in News Articles and Reader Comments
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.04612v2](http://arxiv.org/pdf/2507.04612v2)**
...
>
---
#### [replaced 070] jina-reranker-v3: Last but Not Late Interaction for Document Reranking
- **分类: cs.CL; cs.AI; cs.IR; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.25085v2](http://arxiv.org/pdf/2509.25085v2)**
...
>
---
#### [replaced 071] An Ethically Grounded LLM-Based Approach to Insider Threat Synthesis and Detection
...
>
---
#### [replaced 072] ATLAS: Autoformalizing Theorems through Lifting, Augmentation, and Synthesis of Data
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.05567v3](http://arxiv.org/pdf/2502.05567v3)**
...
>
---
#### [replaced 073] MLLM-CL: Continual Learning for Multimodal Large Language Models
...
>
---
#### [replaced 076] Fingerprinting LLMs via Prompt Injection
- **分类: cs.CR; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.25448v2](http://arxiv.org/pdf/2509.25448v2)**
...
>
---
#### [replaced 077] OmniThink: Expanding Knowledge Boundaries in Machine Writing through Thinking
- **分类: cs.CL; cs.AI; cs.HC; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.09751v4](http://arxiv.org/pdf/2501.09751v4)**
