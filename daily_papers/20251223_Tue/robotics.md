...
#### [new 001] TwinAligner: Visual-Dynamic Alignment Empowers Physics-aware Real2Sim2Real for Robotic Manipulation
...
>
---
#### [new 016] Offline Reinforcement Learning for End-to-End Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 017] InDRiVE: Reward-Free World-Model Pretraining for Autonomous Driving via Latent Disagreement
- **分类: cs.RO**

- **简介: 该论文提出InDRiVE，一种无需奖励的自动驾驶世界模型预训练方法，利用潜空间集成分歧作为内在动机，在CARLA中进行无任务奖励的探索预训练；解决MBRL依赖脆弱、难设计的外部奖励问题；支持零样本迁移与少量样本下游任务适配。**

- **链接: [https://arxiv.org/pdf/2512.18850v1](https://arxiv.org/pdf/2512.18850v1)**
...
>
---
#### [new 018] REALM: A Real-to-Sim Validated Benchmark for Generalization in Robotic Manipulation
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出REALM基准，旨在评估视觉-语言-动作（VLA）模型在机器人操作任务中的泛化能力。针对真实世界评测难、成本高的问题，构建高保真仿真环境，含15种扰动、7种技能和3500+物体，并验证仿真与现实性能强相关，揭示当前VLA模型泛化与鲁棒性仍不足。**

- **链接: [https://arxiv.org/pdf/2512.19562v1](https://arxiv.org/pdf/2512.19562v1)**
...
>
---
#### [new 019] MaP-AVR: A Meta-Action Planner for Agents Leveraging Vision Language Models and Retrieval-Augmented Generation
- **分类: cs.RO**

- **简介: 该论文提出MaP-AVR，一种面向具身机器人的元动作任务规划器。针对现有方法忽视技能抽象与格式可控性的问题，它定义三元组元动作（移动/旋转、末端状态变化、环境关系），并结合RAG增强VLM生成规范元动作的能力，提升泛化性与执行对齐度。**

- **链接: [https://arxiv.org/pdf/2512.19453v1](https://arxiv.org/pdf/2512.19453v1)**
...
>
---
#### [new 023] LIMOncello: Revisited IKFoM on the SGal(3) Manifold for Fast LiDAR-Inertial Odometry
- **分类: cs.RO**

- **简介: 该论文提出LIMOncello，一种基于SGal(3)流形的紧耦合激光-惯性里程计系统，旨在解决低可观测性环境下位姿估计易漂移、地图更新慢与内存占用高的问题；工作包括设计SGal(3)上的迭代误差状态卡尔曼滤波器及轻量级i-Octree建图后端。**

- **链接: [https://arxiv.org/pdf/2512.19567v1](https://arxiv.org/pdf/2512.19567v1)**
...
>
---
#### [new 024] CoDrone: Autonomous Drone Navigation Assisted by Edge and Cloud Foundation Models
- **分类: cs.RO**

- **简介: 该论文提出CoDrone框架，解决无人机因算力受限难以部署复杂模型导致导航性能差的问题。通过云-边-端协同，融合基础模型（如Depth Anything V2、VLM），采用灰度输入、1D占据栅格与DRL调度器，提升资源受限无人机在动态环境中的自主导航能力。**

- **链接: [https://arxiv.org/pdf/2512.19083v1](https://arxiv.org/pdf/2512.19083v1)**
...
>
---
#### [new 025] Dynamic Entropy Tuning in Reinforcement Learning Low-Level Quadcopter Control: Stochasticity vs Determinism
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属强化学习控制任务，旨在解决低空四旋翼飞行器控制中策略退化与探索不足问题。工作包括：对比SAC（动态熵调优）与TD3（确定性策略），验证动态熵调优在训练随机策略后执行确定性动作时，可提升探索效率并防止灾难性遗忘。**

- **链接: [https://arxiv.org/pdf/2512.18336v1](https://arxiv.org/pdf/2512.18336v1)**
...
>
---
#### [new 026] A Flexible Field-Based Policy Learning Framework for Diverse Robotic Systems and Sensors
- **分类: cs.RO**

- **简介: 该论文提出一种基于场的柔性策略学习框架，解决跨机器人平台与多传感器（如Azure Kinect、RealSense）的泛化控制问题。通过融合扩散策略与D3Fields语义场景表征，实现类别级操作泛化，在抓取任务中仅用100次演示即达80%成功率。**

- **链接: [https://arxiv.org/pdf/2512.19148v1](https://arxiv.org/pdf/2512.19148v1)**
...
>
---
#### [new 031] Results of the 2024 CommonRoad Motion Planning Competition for Autonomous Vehicles
- **分类: cs.RO; cs.AI**

- **简介: 该论文属自动驾驶运动规划评估任务，旨在解决算法缺乏标准化对比的问题。作者组织并分析了2024年CommonRoad运动规划竞赛，基于统一基准（含高速/城市场景）从效率、安全、舒适、合规四维度评测多类规划器性能。**

- **链接: [https://arxiv.org/pdf/2512.19564v1](https://arxiv.org/pdf/2512.19564v1)**

> **作者:** Yanliang Huang; Xia Yan; Peiran Yin; Zhenduo Zhang; Zeyan Shao; Youran Wang; Haoliang Huang; Matthias Althoff
>
> **摘要:** Over the past decade, a wide range of motion planning approaches for autonomous vehicles has been developed to handle increasingly complex traffic scenarios. However, these approaches are rarely compared on standardized benchmarks, limiting the assessment of relative strengths and weaknesses. To address this gap, we present the setup and results of the 4th CommonRoad Motion Planning Competition held in 2024, conducted using the CommonRoad benchmark suite. This annual competition provides an open-source and reproducible framework for benchmarking motion planning algorithms. The benchmark scenarios span highway and urban environments with diverse traffic participants, including passenger cars, buses, and bicycles. Planner performance is evaluated along four dimensions: efficiency, safety, comfort, and compliance with selected traffic rules. This report introduces the competition format and provides a comparison of representative high-performing planners from the 2023 and 2024 editions.
>
---
#### [new 032] Learning Semantic Atomic Skills for Multi-Task Robotic Manipulation
- **分类: cs.RO**

- **简介: 该论文属多任务机器人操纵的模仿学习任务，旨在解决跨任务泛化难、技能语义不一致等问题。提出AtomSkill框架：构建语义 grounded 的可变长原子技能库，并设计含关键位姿想象的动作生成模块，实现鲁棒技能组合。**

- **链接: [https://arxiv.org/pdf/2512.18368v1](https://arxiv.org/pdf/2512.18368v1)**
...
>
---
#### [new 035] LeLaR: The First In-Orbit Demonstration of an AI-Based Satellite Attitude Controller
- **分类: cs.RO; cs.AI; cs.LG; eess.SY**

- **简介: 该论文属航天智能控制任务，旨在解决卫星姿态控制中经典控制器设计复杂、鲁棒性差及Sim2Real迁移难的问题。作者提出LeLaR系统，首次在轨验证了纯仿真训练的DRL姿态控制器，部署于InnoCube纳卫星，实测表明其性能优于传统PD控制器。**

- **链接: [https://arxiv.org/pdf/2512.19576v1](https://arxiv.org/pdf/2512.19576v1)**
...
>
---
#### [new 036] Embodied4C: Measuring What Matters for Embodied Vision-Language Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 037] Translating Flow to Policy via Hindsight Online Imitation
- **分类: cs.RO; cs.LG**

- **简介: 该论文属机器人模仿学习任务，旨在解决高阶规划到低阶动作的落地难题。提出HinFlow方法：用2D点流作高层规划器，通过在线交互采集轨迹，利用后见之明（hindsight）重标定目标，更新目标条件化模仿策略，在仿真与实物中实现2倍以上性能提升。**

- **链接: [https://arxiv.org/pdf/2512.19269v1](https://arxiv.org/pdf/2512.19269v1)**
...
>
---
#### [new 038] Design of a Polymer-based Steerable Cannula for Neurosurgical Applications
- **分类: cs.RO**

- **简介: 该论文属医疗器械设计任务，旨在解决神经外科中刚性器械易损组织、干扰MRI等问题。作者采用激光微加工技术制备聚酰亚胺（PI）柔性可转向套管，实现小尺寸（最小OD 1.5 mm）多关节结构，并实验表征其力学性能。**

- **链接: [https://arxiv.org/pdf/2512.18048v1](https://arxiv.org/pdf/2512.18048v1)**
...
>
> **摘要:** We present a system for learning generalizable hand-object tracking controllers purely from synthetic data, without requiring any human demonstrations. Our approach makes two key contributions: (1) HOP, a Hand-Object Planner, which can synthesize diverse hand-object trajectories; and (2) HOT, a Hand-Object Tracker that bridges synthetic-to-physical transfer through reinforcement learning and interaction imitation learning, delivering a generalizable controller conditioned on target hand-object states. Our method extends to diverse object shapes and hand morphologies. Through extensive evaluations, we show that our approach enables dexterous hands to track challenging, long-horizon sequences including object re-arrangement and agile in-hand reorientation. These results represent a significant step toward scalable foundation controllers for manipulation that can learn entirely from synthetic data, breaking the data bottleneck that has long constrained progress in dexterous manipulation.
>
---
#### [new 040] Towards Autonomous Navigation in Endovascular Interventions
- **分类: cs.RO**

- **简介: 该论文属医疗机器人任务，旨在解决血管介入手术中导丝自主导航精度低、缺乏触觉反馈与数据稀缺等问题。工作包括：构建高保真仿真平台CathSim；提出融合多模态感知的Expert Navigation Network；发布开源数据集Guide3D；设计SplineFormer模型直接预测导丝B样条几何。**

- **链接: [https://arxiv.org/pdf/2512.18081v1](https://arxiv.org/pdf/2512.18081v1)**
...
>
---
#### [new 041] AOMGen: Photoreal, Physics-Consistent Demonstration Generation for Articulated Object Manipulation
- **分类: cs.RO**

- **简介: 该论文属机器人操作任务，旨在解决 articulated object 操控所需真实演示数据稀缺、昂贵问题。提出 AOMGen 框架，仅需单次扫描、一次真实演示和数字资产库，即可生成物理一致、多视角、带动作与状态标注的合成数据，显著提升 VLA 策略泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.18396v1](https://arxiv.org/pdf/2512.18396v1)**
...
>
---
#### [new 047] Reinforcement Learning Position Control of a Quadrotor Using Soft Actor-Critic (SAC)
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属于无人机控制任务，旨在解决传统RL直接控电机转速导致训练慢、轨迹不平滑的问题。提出基于SAC算法的推力矢量控制器，输出z轴推力百分比及期望横滚/俯仰角，交由PID实现底层电机分配，提升训练效率与路径跟踪精度。**

- **链接: [https://arxiv.org/pdf/2512.18333v1](https://arxiv.org/pdf/2512.18333v1)**

> **作者:** Youssef Mahran; Zeyad Gamal; Ayman El-Badawy
>
> **备注:** This is the Author Accepted Manuscript version of a paper accepted for publication. The final published version is available via IEEE Xplore
>
> **摘要:** This paper proposes a new Reinforcement Learning (RL) based control architecture for quadrotors. With the literature focusing on controlling the four rotors' RPMs directly, this paper aims to control the quadrotor's thrust vector. The RL agent computes the percentage of overall thrust along the quadrotor's z-axis along with the desired Roll ($φ$) and Pitch ($θ$) angles. The agent then sends the calculated control signals along with the current quadrotor's Yaw angle ($ψ$) to an attitude PID controller. The PID controller then maps the control signals to motor RPMs. The Soft Actor-Critic algorithm, a model-free off-policy stochastic RL algorithm, was used to train the RL agents. Training results show the faster training time of the proposed thrust vector controller in comparison to the conventional RPM controllers. Simulation results show smoother and more accurate path-following for the proposed thrust vector controller.
>
---
#### [new 048] DTCCL: Disengagement-Triggered Contrastive Continual Learning for Autonomous Bus Planners
- **分类: cs.RO**

- **简介: 该论文面向自动驾驶公交规划任务，解决因稀疏、局部化人工接管（disengagement）数据导致的策略优化困难问题。提出DTCCL框架：利用接管事件触发云端对比式持续学习，通过扰动周围车辆生成正负样本，增强策略对安全/危险行为的判别能力，并实现无监督云边协同更新。**

- **链接: [https://arxiv.org/pdf/2512.18988v1](https://arxiv.org/pdf/2512.18988v1)**
...
>
---
#### [new 054] Sign Language Recognition using Parallel Bidirectional Reservoir Computing
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 055] Privacy-Aware Sharing of Raw Spatial Sensor Data for Cooperative Perception
...
>
---
#### [new 056] Joint Learning of Depth, Pose, and Local Radiance Field for Large Scale Monocular 3D Reconstruction
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 057] Point What You Mean: Visually Grounded Instruction Policy
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 058] Mixed formulation and structure-preserving discretization of Cosserat rod dynamics in a port-Hamiltonian framework
- **分类: math.NA; cs.CE; cs.RO; eess.SY; math.DS**

- **简介: 该论文提出一种基于端口-哈密顿框架的Cosserat杆动力学建模与结构保持离散化方法，解决大变形、有限旋转下能量-动量一致性模拟难题；通过混合变量 formulation、无奇点 director 描述和时间微分本构关系，实现客观、无锁、可嵌入耗散与驱动的PH系统离散。**

- **链接: [https://arxiv.org/pdf/2512.19408v1](https://arxiv.org/pdf/2512.19408v1)**

> **作者:** Philipp L. Kinon; Simon R. Eugster; Peter Betsch
>
> **备注:** 37 pages, 16 figures, currently under review
>
...
>
---
#### [new 061] PalpAid: Multimodal Pneumatic Tactile Sensor for Tissue Palpation
- **分类: eess.SP; cs.RO**

- **简介: 该论文提出PalpAid——一种多模态气动触觉传感器，旨在解决机器人辅助手术中触觉缺失问题。通过压力传感器与麦克风协同感知组织弹性与边界，实现肿瘤识别与组织分类。工作包括传感器设计、制造、鲁棒性测试及在硬物与软组织上的分类验证。**

- **链接: [https://arxiv.org/pdf/2512.19010v1](https://arxiv.org/pdf/2512.19010v1)**
...
#### [replaced 001] Geometric Data-Driven Multi-Jet Locomotion Inspired by Salps
- **分类: cs.RO**

- **简介: 该论文属机器人学任务，旨在解决多喷射仿生机器人建模与控制难题。提出基于几何力学的salp-inspired模型，突破传统形状轴控制限制；设计LandSalp陆地实验平台；用李群微分与系统辨识学习阻力主导动力学；实现全向运动、形变与弯曲控制。**

- **链接: [https://arxiv.org/pdf/2503.08817v2](https://arxiv.org/pdf/2503.08817v2)**
...
>
---
#### [replaced 005] OW-Rep: Open World Object Detection with Instance Representation Learning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 006] cVLA: Towards Efficient Camera-Space VLAs
- **分类: cs.RO; cs.LG**

- **简介: 该论文提出cVLA，一种高效相机空间视觉-语言-动作模型。旨在解决VLA训练成本高、依赖机器人本体的问题，通过VLM直接预测图像坐标系下的轨迹 waypoint，实现轻量、通用、强sim-to-real迁移的机器人操作。**

- **链接: [https://arxiv.org/pdf/2507.02190v2](https://arxiv.org/pdf/2507.02190v2)**
...
>
---
#### [replaced 007] Continuous Vision-Language-Action Co-Learning with Semantic-Physical Alignment for Behavioral Cloning
...
>
---
#### [replaced 008] Towards Senior-Robot Interaction: Reactive Robot Dog Gestures
- **分类: cs.RO**

- **简介: 该论文面向老年陪伴场景，解决现有机器人社交表达弱、交互不直观问题。提出基于手势/头部识别的免遥控输入，及用课程强化学习训练的拟犬社交姿态（如抬爪），在仿真达95%+成功率，并在Unitree真机验证可行性。**

- **链接: [https://arxiv.org/pdf/2512.17136v2](https://arxiv.org/pdf/2512.17136v2)**
...
>
---
#### [replaced 009] WebATLAS: An LLM Agent with Experience-Driven Memory and Action Simulation
...
>
---
#### [replaced 010] AsyMoE: Leveraging Modal Asymmetry for Enhanced Expert Specialization in Large Vision-Language Models
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 011] CRISP: Contact-Guided Real2Sim from Monocular Video with Planar Scene Primitives
...
>
---
#### [replaced 012] Human Centric General Physical Intelligence for Agile Manufacturing Automation
- **分类: cs.RO**

- **简介: 该论文是一篇实践性综述，旨在解决通用物理智能（GPI）在敏捷制造中落地难的问题。它系统梳理VLA模型进展，通过六支柱框架对比分析，并开展消融实验评估工业就绪度，推动GPI赋能Industry 5.0。**

- **链接: [https://arxiv.org/pdf/2508.11960v2](https://arxiv.org/pdf/2508.11960v2)**
...
>
---
#### [replaced 016] Iterative Compositional Data Generation for Robot Control
- **分类: cs.RO; cs.LG**

- **简介: 该论文属机器人控制中的数据生成任务，旨在解决多物体/多机器人场景下真实演示数据昂贵、泛化难的问题。提出语义组合式扩散Transformer，解耦并建模机器人、物体等组件交互；结合迭代式自改进机制，实现零样本生成高质量过渡数据以训练新任务策略。**

- **链接: [https://arxiv.org/pdf/2512.10891v3](https://arxiv.org/pdf/2512.10891v3)**
...
>
---
#### [replaced 017] Event Spectroscopy: Event-based Multispectral and Depth Sensing using Structured Light
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 018] Collaborative Representation Learning for Alignment of Tactile, Language, and Vision Modalities
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 019] DeltaFlow: An Efficient Multi-frame Scene Flow Estimation Method
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 020] PRISM-Loc: a Lightweight Long-range LiDAR Localization in Urban Environments with Topological Maps
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 021] Py-DiSMech: A Scalable and Efficient Framework for Discrete Differential Geometry-Based Modeling and Control of Soft Robots
- **分类: cs.RO; physics.comp-ph**

- **简介: 该论文提出Py-DiSMech——一个基于离散微分几何的开源Python框架，旨在解决软体机器人高保真、高效仿真与控制难题。它通过向量化实现、隐式接触模型、自然应变反馈控制和模块化设计，提升计算效率与物理精度，支持仿真驱动设计与sim-to-real研究。**

- **链接: [https://arxiv.org/pdf/2512.09911v2](https://arxiv.org/pdf/2512.09911v2)**
...
>
---
#### [replaced 024] Fine-Tuning of Neural Network Approximate MPC without Retraining via Bayesian Optimization
- **分类: cs.RO; eess.SY**

- **简介: 该论文属控制领域，解决AMPC部署中需手动调参、重训练的难题。提出用贝叶斯优化自动、数据高效地在线微调AMPC策略参数，无需重训练，已在倒立摆与单轮机器人硬件实验中验证有效。**

- **链接: [https://arxiv.org/pdf/2512.14350v2](https://arxiv.org/pdf/2512.14350v2)**
...
>
---
#### [replaced 025] Vidar: Embodied Video Diffusion Model for Generalist Manipulation
...
>
---
#### [replaced 029] QDepth-VLA: Quantized Depth Prediction as Auxiliary Supervision for Vision-Language-Action Models
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 030] TakeAD: Preference-based Post-optimization for End-to-end Autonomous Driving with Expert Takeover Data
- **分类: cs.RO; cs.AI**

- **简介: 该论文属端到端自动驾驶任务，旨在解决模仿学习中开环训练与闭环部署的不一致问题。提出TakeAD框架，利用专家接管数据，结合DAgger（模仿接管行为）和DPO（偏好对齐）进行后优化，提升闭环驾驶鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.17370v2](https://arxiv.org/pdf/2512.17370v2)**
...
>
> **备注:** This work has been accepted by IEEE RA-L. Manuscript submitted: July, 8, 2025; Accepted: November, 24, 2025
>
...
>
---
#### [replaced 031] HEIGHT: Heterogeneous Interaction Graph Transformer for Robot Navigation in Crowded and Constrained Environments
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属机器人导航任务，解决密集动态人群与静态障碍（如走廊、家具）共存下的安全高效导航问题。提出HEIGHT模型：构建异构时空图建模人-机-障交互，结合注意力机制与循环网络学习自适应避障策略。**

- **链接: [https://arxiv.org/pdf/2411.12150v3](https://arxiv.org/pdf/2411.12150v3)**
