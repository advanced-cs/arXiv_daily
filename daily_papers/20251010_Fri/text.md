...
- **简介: 该论文属于自然语言处理任务，旨在分析大语言模型（LLM）在简单任务中过度推理的问题。作者提出TRACE工具，分解模型思维过程，构建推理图谱，发现“探索”与“延迟落地”两种模式，指出过度验证和探索是过推理主因，并提出基于效用的过推理定义，为优化LLM推理效率提供新思路。**
...
- **简介: 该论文属于检索增强生成（RAG）任务，旨在解决当前方法中常见的过检索与欠检索问题。作者提出了HiPRAG，通过在强化学习中引入细粒度的过程奖励，优化代理的搜索决策，提升推理效率与准确性。实验表明该方法有效降低过检索率至2.3%，同时提升模型表现。**
...
- **简介: 该论文属于文本生成评估任务，旨在解决大语言模型在事实回忆中遗漏关键信息的问题。论文提出了三种自动化评估方法，包括NLI分解、Q&A对比和端到端LLM检测，并发现端到端方法虽有效但缺乏可解释性。**
...
- **链接: [http://arxiv.org/pdf/2510.07475v1](http://arxiv.org/pdf/2510.07475v1)**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型对良性请求的过度拒绝问题。作者构建了两个基准测试（XSB和MS-XSB）以诊断拒绝行为，并提出三种无需重新训练的缓解方法，提升了模型在安全提示下的响应能力。**
...
- **简介: 论文任务是多大语言模型代理通信拓扑的动态生成。要解决的问题是如何设计高效、自适应的通信结构，以平衡任务性能、通信成本和鲁棒性。工作提出了一种基于图扩散模型的框架GTD，通过迭代构建和轻量代理模型引导，实现任务自适应的拓扑生成，显著优于现有方法。**
...
- **简介: 该论文属于法律文本分类任务，旨在解决提示优化过程中计算成本高、搜索效率低的问题。作者提出了一种结合蒙特卡洛树搜索与代理提示评估器的框架，以更高效地优化提示，提升分类准确率并降低计算开销。**
...
- **链接: [http://arxiv.org/pdf/2510.07520v1](http://arxiv.org/pdf/2510.07520v1)**
...
- **简介: 该论文属于自然语言处理任务，旨在解决长上下文大语言模型在真实场景中的鲁棒性评估问题。作者提出了“Haystack Engineering”方法，构建更贴近现实的噪声上下文，通过HaystackCraft基准测试不同检索策略及模型在动态推理中的表现，揭示模型在级联错误和自生成干扰下的挑战。**
...
- **简介: 该论文属于大语言模型推理优化任务，旨在解决现有推测解码方法在长上下文输入下性能下降的问题。作者提出了新模型OWL，通过LSTM草稿器、特殊标记[SPEC]和混合解码算法，显著提升长文本生成效率，并发布了长上下文基准LongSpecBench。**
...
- **简介: 论文提出ARM2，一种自适应推理模型，解决大推理模型在简单任务中“过度思考”问题。通过强化学习与长度感知优化，平衡推理性能与效率，并融合视觉理解和可执行代码，减少token消耗超70%，同时保持性能。属于多模态推理任务。**
...
- **简介: 该论文属于多语言情感分析任务，旨在解决现有新冠数据集情感标签粗粒度、标注不足的问题。作者构建了包含十种情感类别的多语言数据集SenWave，涵盖英、阿、西、法、意五种语言，共10,000条标注推文及上亿未标注数据，并微调模型实现细粒度情感分类，分析疫情情绪变化。**
...
- **简介: 该论文属于自动评分任务，旨在解决主观题评分中因答案多样性导致的评估难题。作者提出了一种基于大语言模型（LLM）的统一评分框架，通过多个模块评估学生答案的内容相似性、关键知识点匹配度、问题相关性及模拟人工评价，实现更贴近人工评分的效果。实验表明该方法优于传统与基于LLM的基线模型，并已在实际考试中应用。**
...
- **链接: [http://arxiv.org/pdf/2510.07713v1](http://arxiv.org/pdf/2510.07713v1)**
...
- **简介: 该论文属于多跳问答任务，旨在解决现有图谱检索生成方法在复杂推理中的证据不足与错误累积问题。作者提出SubQRAG框架，通过将复杂问题分解为可验证的子问题，动态扩展知识图谱，并构建结构化证据路径，提升了问答准确率，尤其在Exact Match指标上表现突出。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在特定领域性能下降的问题。通过提出无需训练的Group Relative Policy Optimization方法，利用经验知识作为标记先验，提升模型表现，避免过拟合和数据稀缺问题。**
...
- **简介: 该论文属于因果关系抽取任务，旨在解决现有数据集中忽略“反因果”声明的问题。作者构建了一个包含反因果声明的新数据集，并展示了其对模型训练的重要性。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在文化理解上的偏差与局限。作者通过神经元级分析，识别出影响文化理解的关键神经元，并验证其作用，为改进模型文化公平性提供依据。**
...
- **简介: 论文研究大型语言模型对条件可接受性的判断，分析其对“如果A则B”这类语句的接受程度受条件概率与语义相关性的影响。任务是理解语言模型如何评估条件语句的合理性，发现模型对这两个因素敏感，但表现不一，与人类判断存在差异。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型推理时的KV缓存开销问题。作者提出RLKV方法，通过强化学习识别对推理关键的注意力头，实现高效KV缓存分配，在压缩缓存的同时保持推理性能。**
...
- **简介: 该论文属于人工智能与生物信息学交叉任务，旨在解决单细胞生物学中模型分散、标准不统一的问题。论文系统调研了58个适用于单细胞研究的大语言和智能体模型，分类归纳并评估其在八类任务中的表现，涵盖数据整合、注释、药物响应预测等，强调可解释性、公平性与标准化挑战。**
...
- **简介: 该论文属于自然语言处理领域的“Learning with Disagreements”（LeWiDi）任务，旨在解决AI模型对人类判断差异的建模与评估问题。论文扩展了LeWiDi-2025基准，新增四个包含类别与序数标注的数据集，并引入软标签与视角主义两种评估范式，推动构建更具鲁棒性的分歧感知模型。**
...
- **简介: 论文提出FedDTRE，一种基于可信度评估的联邦对话生成模型。任务是解决联邦学习中对话生成模型因客户端数据有限和遗忘全局信息导致的泛化能力差问题。工作是设计自适应聚合策略，利用公平评估数据集上的可信度评分动态调整全局模型贡献，提升对话质量。**
...
- **链接: [http://arxiv.org/pdf/2510.08152v1](http://arxiv.org/pdf/2510.08152v1)**
...
- **简介: 该论文提出了IASC系统，利用大语言模型（LLM）辅助人工构造语言（ConLang）的创建。任务是生成具有自定义音系、词汇、语法和正字法的语言，并探索LLM对语言结构的理解能力。系统通过模块化流程逐步构建语言系统，并测试其在高低资源语言翻译中的潜力。**
...
>
---
#### [new 065] ARES: Multimodal Adaptive Reasoning via Difficulty-Aware Token-Level Entropy Shaping
- **分类: cs.CL**

- **简介: 该论文属于多模态推理任务，旨在解决现有模型在简单问题上过度思考、复杂问题上探索不足的问题。作者提出ARES框架，通过难度感知的熵控制机制，动态调整推理过程中的探索程度，提升推理效率与性能。**

- **链接: [http://arxiv.org/pdf/2510.08457v1](http://arxiv.org/pdf/2510.08457v1)**
...
>
---
#### [new 066] ArenaBencher: Automatic Benchmark Evolution via Multi-Model Competitive Evaluation
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务中的基准测试优化。旨在解决现有基准测试因预训练数据泄露导致模型记忆而非真实泛化能力的问题。论文提出ArenaBencher框架，通过多模型竞争评估自动更新测试用例，保持可比性的同时提升难度，揭示模型弱点，增强诊断性与公平性。**

- **链接: [http://arxiv.org/pdf/2510.08569v1](http://arxiv.org/pdf/2510.08569v1)**
...
>
---
#### [new 067] Everything is Plausible: Investigating the Impact of LLM Rationales on Human Notions of Plausibility
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文研究了大语言模型（LLM）生成的合理性论证对人类判断可信度的影响。任务是分析人类在常识推理中受LLM提供的正反理由影响的程度。作者收集了人类和LLM的判断数据，发现LLM生成的论证显著影响了人类的可信度评分，表明LLM可用于研究人类认知，同时也引发对其影响人类信念的担忧。**

- **链接: [http://arxiv.org/pdf/2510.08091v1](http://arxiv.org/pdf/2510.08091v1)**

> **作者:** Shramay Palta; Peter Rankel; Sarah Wiegreffe; Rachel Rudinger
>
> **备注:** pre-print
>
> **摘要:** We investigate the degree to which human plausibility judgments of multiple-choice commonsense benchmark answers are subject to influence by (im)plausibility arguments for or against an answer, in particular, using rationales generated by LLMs. We collect 3,000 plausibility judgments from humans and another 13,600 judgments from LLMs. Overall, we observe increases and decreases in mean human plausibility ratings in the presence of LLM-generated PRO and CON rationales, respectively, suggesting that, on the whole, human judges find these rationales convincing. Experiments with LLMs reveal similar patterns of influence. Our findings demonstrate a novel use of LLMs for studying aspects of human cognition, while also raising practical concerns that, even in domains where humans are ``experts'' (i.e., common sense), LLMs have the potential to exert considerable influence on people's beliefs.
>
---
#### [new 068] Test-Time Reasoners Are Strategic Multiple-Choice Test-Takers
- **分类: cs.CL**

- **简介: 该论文研究大语言模型在多项选择题回答中的推理行为，探讨其在仅有选项无问题描述时仍能成功回答的现象。任务为分析模型推理策略，验证是否存在浅层捷径。工作包括对比完整输入与仅选项输入的推理效果，发现推理过程能部分恢复问题信息，表明非完全依赖浅层策略。结论挑战了部分输入成功即为缺陷的观点。**

- **链接: [http://arxiv.org/pdf/2510.07761v1](http://arxiv.org/pdf/2510.07761v1)**
...
>
---
#### [new 069] Banking Done Right: Redefining Retail Banking with Language-Centric AI
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于金融科技任务，旨在解决传统银行操作流程复杂、交互不自然的问题。作者开发了Ryt AI系统，基于自研大语言模型ILMU，通过多智能体架构实现自然语言驱动的银行业务操作，并满足监管合规要求。**

- **链接: [http://arxiv.org/pdf/2510.07645v1](http://arxiv.org/pdf/2510.07645v1)**
...
>
---
#### [new 072] Ready to Translate, Not to Represent? Bias and Performance Gaps in Multilingual LLMs Across Language Families and Domains
- **分类: cs.CL**

- **简介: 该论文属于机器翻译任务，旨在解决多语言大模型在不同语言和领域间的性能差异与偏见问题。作者提出了“Translation Tangles”框架和数据集，评估翻译质量和公平性，并构建了偏见检测流程与高质量人工标注数据集。**

- **链接: [http://arxiv.org/pdf/2510.07877v1](http://arxiv.org/pdf/2510.07877v1)**
...
>
---
#### [new 075] The Unintended Trade-off of AI Alignment:Balancing Hallucination Mitigation and Safety in LLMs
- **分类: cs.CL**

- **简介: 该论文研究大型语言模型中事实准确性和安全对齐之间的权衡问题，提出通过稀疏自编码器解耦拒绝行为与幻觉特征，并利用子空间正交化保留安全对齐，从而在提升事实性的同时维持安全性。**

- **链接: [http://arxiv.org/pdf/2510.07775v1](http://arxiv.org/pdf/2510.07775v1)**
...
>
---
#### [new 076] DeepPrune: Parallel Scaling without Inter-trace Redundancy
- **分类: cs.CL; cs.AI**

- **简介: 论文提出DeepPrune，旨在解决大语言模型并行扩展中的冗余问题。该框架通过动态剪枝减少计算浪费，使用判断模型和聚类算法，在保持答案多样性的同时显著提升效率，适用于复杂推理任务。**

- **链接: [http://arxiv.org/pdf/2510.08483v1](http://arxiv.org/pdf/2510.08483v1)**

> **作者:** Shangqing Tu; Yaxuan Li; Yushi Bai; Lei Hou; Juanzi Li
>
> **备注:** 15 pages, 4 figures, please check out the project page: https://deepprune.github.io/
>
...
>
---
#### [new 077] Curing Miracle Steps in LLM Mathematical Reasoning with Rubric Rewards
- **分类: cs.CL**

- **简介: 该论文属于数学推理任务，旨在解决大语言模型在数学解题中依赖最终答案奖励导致的“奖励黑客”问题，特别是“奇迹步骤”现象。作者提出Rubric Reward Model（RRM），通过评估整个推理过程来提升模型的准确性和可靠性。**

- **链接: [http://arxiv.org/pdf/2510.07774v1](http://arxiv.org/pdf/2510.07774v1)**
...
>
---
#### [new 078] AutoRed: A Free-form Adversarial Prompt Generation Framework for Automated Red Teaming
- **分类: cs.CL**

- **简介: 该论文属于大语言模型安全评估任务，旨在解决现有红队测试方法依赖种子指令导致语义多样性不足的问题。作者提出AutoRed框架，通过无种子生成对抗提示与迭代优化，提升攻击成功率和泛化能力，验证了自由形式红队测试的潜力。**

- **链接: [http://arxiv.org/pdf/2510.08329v1](http://arxiv.org/pdf/2510.08329v1)**

> **作者:** Muxi Diao; Yutao Mou; Keqing He; Hanbo Song; Lulu Zhao; Shikun Zhang; Wei Ye; Kongming Liang; Zhanyu Ma
>
> **摘要:** The safety of Large Language Models (LLMs) is crucial for the development of trustworthy AI applications. Existing red teaming methods often rely on seed instructions, which limits the semantic diversity of the synthesized adversarial prompts. We propose AutoRed, a free-form adversarial prompt generation framework that removes the need for seed instructions. AutoRed operates in two stages: (1) persona-guided adversarial instruction generation, and (2) a reflection loop to iteratively refine low-quality prompts. To improve efficiency, we introduce a verifier to assess prompt harmfulness without querying the target models. Using AutoRed, we build two red teaming datasets -- AutoRed-Medium and AutoRed-Hard -- and evaluate eight state-of-the-art LLMs. AutoRed achieves higher attack success rates and better generalization than existing baselines. Our results highlight the limitations of seed-based approaches and demonstrate the potential of free-form red teaming for LLM safety evaluation. We will open source our datasets in the near future.
>
---
#### [new 079] Lossless Vocabulary Reduction for Auto-Regressive Language Models
- **分类: cs.CL; cs.AI; cs.LG; stat.ML**

- **简介: 本文属于自然语言处理任务，旨在解决不同自回归语言模型因词汇差异难以协作的问题。作者提出一种无损词汇缩减理论框架，使模型在不损失准确性的前提下适应更小的词汇，并通过共享最大公共词汇实现模型间高效协作。**

- **链接: [http://arxiv.org/pdf/2510.08102v1](http://arxiv.org/pdf/2510.08102v1)**
...
>
---
#### [new 080] The Price of Thought: A Multilingual Analysis of Reasoning, Performance, and Cost of Negotiation in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大型语言模型在多语言谈判任务中的推理能力、表现与成本权衡。旨在分析推理对谈判效果的影响，并比较不同模型在语言一致性、战略适应性和计算成本方面的表现。**

- **链接: [http://arxiv.org/pdf/2510.08098v1](http://arxiv.org/pdf/2510.08098v1)**
...
>
---
#### [new 081] CS3-Bench: Evaluating and Enhancing Speech-to-Speech LLMs for Mandarin-English Code-Switching
- **分类: cs.CL**

- **简介: 该论文属于语音到语音的多语言交互任务，旨在解决现有模型在中英代码切换时的语言对齐问题。作者构建了CS3-Bench基准，提出链式识别和关键词高亮方法，显著提升了知识准确率与对话理解率，优化了次语言发音。**

- **链接: [http://arxiv.org/pdf/2510.07881v1](http://arxiv.org/pdf/2510.07881v1)**
...
>
---
#### [new 082] Meaningful Pose-Based Sign Language Evaluation
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理与计算机视觉交叉任务，旨在解决手语翻译与生成系统的有效评估问题。论文通过关键点距离、嵌入和回译等多种指标，对手语姿态进行自动与人工评估，提供了一种可复现、实用的评估工具与方法。**

- **链接: [http://arxiv.org/pdf/2510.07453v1](http://arxiv.org/pdf/2510.07453v1)**
...
>
---
#### [new 084] Large Language Models Meet Virtual Cell: A Survey
- **分类: cs.CL; cs.CE; cs.LG; q-bio.CB**

- **简介: 这篇论文综述了大语言模型（LLMs）在虚拟细胞建模中的应用，属于生物计算任务。它旨在解决如何利用LLMs更好地模拟、预测和解析细胞行为的问题。论文提出了统一分类体系，将LLMs分为“Oracle”和“Agent”两类，并围绕细胞表示、扰动预测和基因调控推断三大任务展开分析，探讨了模型、数据集及挑战。**

- **链接: [http://arxiv.org/pdf/2510.07706v1](http://arxiv.org/pdf/2510.07706v1)**
...
>
---
#### [new 085] Can Speech LLMs Think while Listening?
- **分类: cs.CL; cs.AI; eess.AS**

- **简介: 本文研究语音大语言模型（speech LLMs）在多模态语音交互中的推理能力提升问题。通过引入思维链（CoT）微调和“思考中倾听”机制，提升模型在语音推理任务中的准确率并降低响应延迟。使用基于熵的“问题完整性”指标和DPO优化方法，在保证准确率的前提下大幅减少延迟。**

- **链接: [http://arxiv.org/pdf/2510.07497v1](http://arxiv.org/pdf/2510.07497v1)**
...
>
---
#### [new 086] Drift No More? Context Equilibria in Multi-Turn LLM Interactions
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究多轮对话中大语言模型的上下文漂移问题，旨在解决模型在持续交互中偏离用户目标的现象。通过建立动力学框架，将漂移形式化为KL散度，并提出恢复力和干预机制。实验验证了模型漂移存在稳定平衡，简单提醒可有效减少漂移。**

- **链接: [http://arxiv.org/pdf/2510.07777v1](http://arxiv.org/pdf/2510.07777v1)**
...
>
---
#### [new 089] The Alignment Waltz: Jointly Training Agents to Collaborate for Safety
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在安全与帮助性之间的权衡问题。现有方法易导致拒绝过多或放任危险内容。论文提出WaltzRL框架，通过多智能体强化学习，联合训练对话与反馈智能体，动态改进回复，降低危险回复与过度拒绝，提升整体表现。**

- **链接: [http://arxiv.org/pdf/2510.08240v1](http://arxiv.org/pdf/2510.08240v1)**
...
>
---
#### [new 090] ToolLibGen: Scalable Automatic Tool Creation and Aggregation for LLM Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 论文提出ToolLibGen，旨在解决大型语言模型（LLM）在复杂推理任务中因缺乏结构化工具库而导致的检索困难和扩展性问题。通过自动生成并聚合任务相关的工具，提升工具检索准确率与推理性能。**

- **链接: [http://arxiv.org/pdf/2510.07768v1](http://arxiv.org/pdf/2510.07768v1)**
...
>
> **摘要:** Large Language Models (LLMs) equipped with external tools have demonstrated enhanced performance on complex reasoning tasks. The widespread adoption of this tool-augmented reasoning is hindered by the scarcity of domain-specific tools. For instance, in domains such as physics question answering, suitable and specialized tools are often missing. Recent work has explored automating tool creation by extracting reusable functions from Chain-of-Thought (CoT) reasoning traces; however, these approaches face a critical scalability bottleneck. As the number of generated tools grows, storing them in an unstructured collection leads to significant retrieval challenges, including an expanding search space and ambiguity between function-related tools. To address this, we propose a systematic approach to automatically refactor an unstructured collection of tools into a structured tool library. Our system first generates discrete, task-specific tools and clusters them into semantically coherent topics. Within each cluster, we introduce a multi-agent framework to consolidate scattered functionalities: a code agent refactors code to extract shared logic and creates versatile, aggregated tools, while a reviewing agent ensures that these aggregated tools maintain the complete functional capabilities of the original set. This process transforms numerous question-specific tools into a smaller set of powerful, aggregated tools without loss of functionality. Experimental results demonstrate that our approach significantly improves tool retrieval accuracy and overall reasoning performance across multiple reasoning tasks. Furthermore, our method shows enhanced scalability compared with baselines as the number of question-specific increases.
>
---
#### [new 091] Neologism Learning for Controllability and Self-Verbalization
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升对大语言模型的可控性与可解释性。通过引入新词（neologism learning），控制模型输出的概念（如谄媚、错误答案等），并利用模型自述新词含义实现自我解释。验证方法包括插件评估与多概念联合学习。**

- **链接: [http://arxiv.org/pdf/2510.08506v1](http://arxiv.org/pdf/2510.08506v1)**
...
>
---
#### [new 092] Populism Meets AI: Advancing Populism Research with LLMs
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理与政治学交叉任务，旨在解决传统文本分析方法在测量民粹主义内容上的成本高、扩展性差等问题。论文利用大型语言模型（LLM），通过模仿人工编码员训练过程，实现了对民粹主义话语的自动分类，准确率与专家相当。**

- **链接: [http://arxiv.org/pdf/2510.07458v1](http://arxiv.org/pdf/2510.07458v1)**
...
>
---
#### [new 093] LightReasoner: Can Small Language Models Teach Large Language Models Reasoning?
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型推理能力提升的问题。通过提出LightReasoner框架，利用小模型与大模型的行为差异，挖掘高价值推理时刻，以更高效的方式提升大模型的推理性能。**

- **链接: [http://arxiv.org/pdf/2510.07962v1](http://arxiv.org/pdf/2510.07962v1)**
...
>
---
#### [new 100] MATRIX: Multimodal Agent Tuning for Robust Tool-Use Reasoning
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于多模态工具使用推理任务，旨在解决视觉语言模型（VLMs）因缺乏高质量多模态轨迹和人工标注成本高而效果受限的问题。论文构建了M-TRACE数据集和MATRIX Agent控制器，并通过Pref-X进行偏好学习，以提升VLM在多模态任务中的表现。**

- **链接: [http://arxiv.org/pdf/2510.08567v1](http://arxiv.org/pdf/2510.08567v1)**
...
>
---
#### [new 101] TTOM: Test-Time Optimization and Memorization for Compositional Video Generation
- **分类: cs.CV; cs.AI; cs.CL; cs.LG; cs.MM**

- **简介: 该论文属于视频生成任务，旨在解决现有视频生成模型在组合场景（如运动、数量、空间关系）中表现不佳的问题。论文提出TTOM框架，在推理阶段通过优化与空间时间布局对齐的新参数，结合记忆机制提升文本-视频对齐效果，增强了模型的泛化与组合能力。**

- **链接: [http://arxiv.org/pdf/2510.07940v1](http://arxiv.org/pdf/2510.07940v1)**
...
>
---
#### [new 102] AutoQual: An LLM Agent for Automated Discovery of Interpretable Features for Review Quality Assessment
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理与信息检索任务，旨在解决在线评论质量评估的动态性和领域依赖性问题。作者提出AutoQual框架，利用大语言模型自动发现可解释特征，模拟人类研究过程，通过迭代生成特征假设、工具实现与经验积累，提升评论质量评估效果。**

- **链接: [http://arxiv.org/pdf/2510.08081v1](http://arxiv.org/pdf/2510.08081v1)**

> **作者:** Xiaochong Lan; Jie Feng; Yinxing Liu; Xinlei Shi; Yong Li
>
> **备注:** EMNLP 2025
>
> **摘要:** Ranking online reviews by their intrinsic quality is a critical task for e-commerce platforms and information services, impacting user experience and business outcomes. However, quality is a domain-dependent and dynamic concept, making its assessment a formidable challenge. Traditional methods relying on hand-crafted features are unscalable across domains and fail to adapt to evolving content patterns, while modern deep learning approaches often produce black-box models that lack interpretability and may prioritize semantics over quality. To address these challenges, we propose AutoQual, an LLM-based agent framework that automates the discovery of interpretable features. While demonstrated on review quality assessment, AutoQual is designed as a general framework for transforming tacit knowledge embedded in data into explicit, computable features. It mimics a human research process, iteratively generating feature hypotheses through reflection, operationalizing them via autonomous tool implementation, and accumulating experience in a persistent memory. We deploy our method on a large-scale online platform with a billion-level user base. Large-scale A/B testing confirms its effectiveness, increasing average reviews viewed per user by 0.79% and the conversion rate of review readers by 0.27%.
>
---
#### [new 103] LLM Unlearning Under the Microscope: A Full-Stack View on Methods and Metrics
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于大型语言模型（LLM）的“机器遗忘”任务，旨在解决如何有效移除模型中不良数据、知识或行为的问题。论文提出了12种最新方法的分类体系，引入更全面的评估指标（如Open-QA），揭示遗忘效果、实用性与鲁棒性之间的权衡，并为未来方法设计与评估提供指导。**

- **链接: [http://arxiv.org/pdf/2510.07626v1](http://arxiv.org/pdf/2510.07626v1)**
...
>
---
#### [new 104] Beyond Pass@k: Breadth-Depth Metrics for Reasoning Boundaries
- **分类: cs.AI; cs.CL; cs.LG; I.2.6; I.2.7**

- **简介: 该论文属于自然语言处理任务，旨在解决评估大语言模型推理能力的问题。现有指标Pass@k在高采样预算下可能高估模型能力，论文提出新指标Cover@tau，衡量模型在一定可靠性阈值下的解题比例，更准确反映推理边界，并重新评估RLVR模型性能。**

- **链接: [http://arxiv.org/pdf/2510.08325v1](http://arxiv.org/pdf/2510.08325v1)**
...
>
---
#### [new 105] Test-Time Matching: Unlocking Compositional Reasoning in Multimodal Models
- **分类: cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文属于多模态模型的推理任务，旨在解决模型在组合推理上的表现不佳问题。作者提出“测试时匹配”（TTM）方法，通过组匹配评分和迭代自优化，显著提升模型在多个基准上的表现，甚至超越人类水平。**

- **链接: [http://arxiv.org/pdf/2510.07632v1](http://arxiv.org/pdf/2510.07632v1)**
...
>
---
#### [new 106] SpatialLadder: Progressive Training for Spatial Reasoning in Vision-Language Models
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于视觉-语言模型的空间推理任务，旨在解决现有模型在空间推理上的不足。作者构建了一个包含26,610个样本的多模态数据集SpatialLadder-26k，并提出一个三阶段渐进式训练框架，逐步提升模型从空间感知到复杂推理的能力，最终实现空间推理性能的显著提升。**

- **链接: [http://arxiv.org/pdf/2510.08531v1](http://arxiv.org/pdf/2510.08531v1)**
...
>
> **摘要:** Spatial reasoning remains a fundamental challenge for Vision-Language Models (VLMs), with current approaches struggling to achieve robust performance despite recent advances. We identify that this limitation stems from a critical gap: existing methods attempt to learn spatial reasoning directly without establishing the hierarchical foundations of perception and understanding. To address this challenge, we present a comprehensive methodology for building spatial intelligence progressively. We introduce SpatialLadder-26k, a multimodal dataset containing 26,610 samples spanning object localization, single image, multi-view, and video spatial reasoning tasks, constructed through a standardized pipeline that ensures systematic coverage across modalities. Building on this dataset, we design a three-stage progressive training framework that (1) establishes spatial perception through object localization, (2) develops spatial understanding through multi-dimensional spatial tasks, and (3) strengthens complex reasoning via reinforcement learning with verifiable rewards. This approach yields SpatialLadder, a 3B-parameter model that achieves state-of-the-art performance on spatial reasoning benchmarks, with 23.4% average improvement over the base model, surpassing GPT-4o by 20.8% and Gemini-2.0-Flash by 10.1%. Notably, SpatialLadder maintains strong generalization with 7.2% improvement on out-of-domain benchmarks, demonstrating that progressive training from perception to reasoning is essential for robust spatial intelligence.
>
---
#### [new 107] ReasonEmbed: Enhanced Text Embeddings for Reasoning-Intensive Document Retrieval
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于文本嵌入任务，旨在解决推理密集型文档检索中语义匹配不足的问题。作者提出了ReasonEmbed模型，包含ReMixer数据合成方法、Redapter自适应训练算法，并在多个模型上验证了其有效性，显著提升了检索性能。**

- **链接: [http://arxiv.org/pdf/2510.08252v1](http://arxiv.org/pdf/2510.08252v1)**
...
>
---
#### [new 108] oMeBench: Towards Robust Benchmarking of LLMs in Organic Mechanism Elucidation and Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于化学与人工智能交叉任务，旨在解决大型语言模型（LLMs）在有机反应机理推理中的准确性与一致性问题。作者构建了首个大规模专家整理的基准数据集oMeBench，并提出动态评估框架oMeS，用于精细评估和提升LLMs的化学推理能力。**

- **链接: [http://arxiv.org/pdf/2510.07731v1](http://arxiv.org/pdf/2510.07731v1)**

> **作者:** Ruiling Xu; Yifan Zhang; Qingyun Wang; Carl Edwards; Heng Ji
>
> **备注:** Main Text: 8 pages, In total: 37 pages, 9 figures
>
> **摘要:** Organic reaction mechanisms are the stepwise elementary reactions by which reactants form intermediates and products, and are fundamental to understanding chemical reactivity and designing new molecules and reactions. Although large language models (LLMs) have shown promise in understanding chemical tasks such as synthesis design, it is unclear to what extent this reflects genuine chemical reasoning capabilities, i.e., the ability to generate valid intermediates, maintain chemical consistency, and follow logically coherent multi-step pathways. We address this by introducing oMeBench, the first large-scale, expert-curated benchmark for organic mechanism reasoning in organic chemistry. It comprises over 10,000 annotated mechanistic steps with intermediates, type labels, and difficulty ratings. Furthermore, to evaluate LLM capability more precisely and enable fine-grained scoring, we propose oMeS, a dynamic evaluation framework that combines step-level logic and chemical similarity. We analyze the performance of state-of-the-art LLMs, and our results show that although current models display promising chemical intuition, they struggle with correct and consistent multi-step reasoning. Notably, we find that using prompting strategy and fine-tuning a specialist model on our proposed dataset increases performance by 50% over the leading closed-source model. We hope that oMeBench will serve as a rigorous foundation for advancing AI systems toward genuine chemical reasoning.
>
---
#### [new 109] Encode, Think, Decode: Scaling test-time reasoning with recursive latent thoughts
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于大语言模型推理任务，旨在提升模型推理能力。通过分析发现关键推理计算集中在部分层，提出ETD方法，在训练中迭代优化这些层，保持原有结构和参数。推理时递归调用这些层，显著提升17项推理基准表现，如GSM8K和MATH准确率分别提高28.4%和36%。**

- **链接: [http://arxiv.org/pdf/2510.07358v1](http://arxiv.org/pdf/2510.07358v1)**
...
>
---
#### [new 110] From Keywords to Clusters: AI-Driven Analysis of YouTube Comments to Reveal Election Issue Salience in 2024
- **分类: cs.SI; cs.CL**

- **简介: 该论文属于自然语言处理与选举分析任务，旨在解决识别影响2024年总统选举投票选择的关键问题。作者通过AI驱动的方法，对YouTube评论进行文本挖掘和聚类分析，提取用户关注的议题频率，发现移民、民主和身份政治最受关注，通胀则相对次要，挑战了传统民调对通胀重要性的判断。**

- **链接: [http://arxiv.org/pdf/2510.07821v1](http://arxiv.org/pdf/2510.07821v1)**
...
>
---
#### [new 114] CaRT: Teaching LLM Agents to Know When They Know Enough
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 论文提出CaRT方法，教大语言模型（LLM）在多轮交互任务中判断何时停止信息收集。通过反事实推理训练LLM识别终止时机，应用于医疗诊断和数学问题解决，提升了信息收集效率和任务成功率。属于信息采集与决策任务。**

- **链接: [http://arxiv.org/pdf/2510.08517v1](http://arxiv.org/pdf/2510.08517v1)**
...
>
---
#### [new 115] Mix- and MoE-DPO: A Variational Inference Approach to Direct Preference Optimization
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于大语言模型对齐任务，旨在解决现有DPO方法在多任务和多样化偏好设置下的表达能力与适应性不足问题。论文提出Mix-和MoE-DPO框架，结合混合模型与专家混合结构，通过变分推断方法优化ELBO，实现从偏好数据中学习专业化策略，提升模型的泛化性、奖励与策略专业化能力，以及上下文对齐效果。**

- **链接: [http://arxiv.org/pdf/2510.08256v1](http://arxiv.org/pdf/2510.08256v1)**
...
>
---
#### [new 116] VideoNorms: Benchmarking Cultural Awareness of Video Language Models
...
>
---
#### [new 117] Sentiment Matters: An Analysis of 200 Human-SAV Interactions
- **分类: cs.HC; cs.AI; cs.CL; cs.ET**

- **简介: 该论文研究人类与共享自动驾驶车辆（SAV）的交互，旨在提升交互设计。论文构建了一个包含200次交互的开源对话数据集，并结合心理因素调查。通过随机森林建模和情感分析，发现回应的情感极性对SAV接受度和服务质量感知有重要影响，并比较了LLM与传统方法的情感分析效果。**

- **链接: [http://arxiv.org/pdf/2510.08202v1](http://arxiv.org/pdf/2510.08202v1)**
...
>
---
#### [new 119] LiveThinking: Enabling Real-Time Efficient Reasoning for AI-Powered Livestreaming via Reinforcement Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于AI驱动的电商直播任务，旨在解决大型推理模型延迟高、不适配实时互动的问题。作者提出LiveThinking框架，通过模型蒸馏和强化学习优化，显著降低计算成本并提升响应质量，成功应用于淘宝直播，提升了用户互动与销售效果。**

- **链接: [http://arxiv.org/pdf/2510.07685v1](http://arxiv.org/pdf/2510.07685v1)**
...
>
---
#### [new 120] Opponent Shaping in LLM Agents
- **分类: cs.LG; cs.AI; cs.CL; cs.MA**

- **简介: 该论文研究大语言模型（LLM）作为智能体在多智能体系统中的对手塑造（Opponent Shaping）能力。任务是在博弈环境中，通过交互影响其他智能体的学习与行为。论文提出ShapeLLM方法，验证LLM在竞争与合作游戏中可引导对手达成有利均衡，推动多智能体LLM研究。**

- **链接: [http://arxiv.org/pdf/2510.08255v1](http://arxiv.org/pdf/2510.08255v1)**
...
>
---
#### [new 121] PATCH: Mitigating PII Leakage in Language Models with Privacy-Aware Targeted Circuit PatcHing
- **分类: cs.CR; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型（LMs）在训练中记忆个人身份信息（PII）导致隐私泄露的问题。作者提出PATCH方法，通过识别并编辑负责PII泄露的计算电路，有效降低泄露风险，同时保持模型效用。**

- **链接: [http://arxiv.org/pdf/2510.07452v1](http://arxiv.org/pdf/2510.07452v1)**
...
>
---
#### [new 122] Agent Learning via Early Experience
- **分类: cs.AI; cs.CL; cs.IR; cs.LG**

- **简介: 该论文属于语言智能体学习任务，旨在解决智能体在缺乏奖励信号或长周期交互困难的环境中难以通过强化学习提升性能的问题。论文提出“早期经验”范式，利用智能体自身行为产生的数据，通过隐式世界建模和自我反思策略，提升模型效果和泛化能力，为从模仿学习向完全经验驱动的智能体发展提供了新路径。**

- **链接: [http://arxiv.org/pdf/2510.08558v1](http://arxiv.org/pdf/2510.08558v1)**
...
>
---
#### [new 123] FlyLoRA: Boosting Task Decoupling and Parameter Efficiency via Implicit Rank-Wise Mixture-of-Experts
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于参数高效微调任务，旨在解决LoRA方法中的参数干扰问题。论文提出FlyLoRA，结合隐式MoE机制，通过引入隐式路由器和随机投影矩阵，提升任务解耦和计算效率。实验表明其在多领域表现优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.08396v1](http://arxiv.org/pdf/2510.08396v1)**
...
>
---
#### [new 124] The Visual Iconicity Challenge: Evaluating Vision-Language Models on Sign Language Form-Meaning Mapping
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出“视觉象似性挑战”，评估视觉-语言模型（VLMs）在手语形式与意义映射中的表现，涉及三个任务：手势预测、透明度理解和象似性评分。论文通过13种先进模型在零样本和小样本下的实验，发现模型在象似性理解上仍远低于人类水平，但具备一定潜力，支持未来改进视觉基础模型的象似性建模。**
...
>
---
#### [new 125] Looking to Learn: Token-wise Dynamic Gating for Low-Resource Vision-Language Modelling
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于视觉-语言建模任务，旨在解决低资源环境下多模态信息融合效率低的问题。作者提出了一种基于解码器的轻量级架构，引入词元级动态门控机制，自适应融合视觉与语言信息，并结合特征调制、通道注意力和对比学习目标。实验表明该方法在多个基准上表现优异，且动态门控能自动学习可解释的模态选择模式。**

- **链接: [http://arxiv.org/pdf/2510.08470v1](http://arxiv.org/pdf/2510.08470v1)**
...
>
---
#### [new 126] Evaluation of LLMs for Process Model Analysis and Optimization
...
>
---
#### [new 127] AutoMLGen: Navigating Fine-Grained Optimization for Coding Agents
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 论文提出AutoMLGen，一种基于大语言模型的编码智能体，用于解决机器学习工程中的自动机器学习（AutoML）任务。该方法结合领域知识库和蒙特卡洛图搜索（MCGS），优化搜索过程，提高代码生成的稳定性和收敛速度，在MLE-Bench测试中表现出色。**

- **链接: [http://arxiv.org/pdf/2510.08511v1](http://arxiv.org/pdf/2510.08511v1)**
...
>
---
#### [new 128] TaoSR-AGRL: Adaptive Guided Reinforcement Learning Framework for E-commerce Search Relevance
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于电商搜索相关性优化任务，旨在解决现有方法在复杂查询和长尾案例中推理能力不足的问题。作者提出TaoSR-AGRL框架，通过规则感知的奖励塑造和自适应引导回放机制，提升模型的推理能力和训练稳定性，已在淘宝实际场景中部署应用。**

- **链接: [http://arxiv.org/pdf/2510.08048v1](http://arxiv.org/pdf/2510.08048v1)**
...
>
---
#### [new 129] xRouter: Training Cost-Aware LLMs Orchestration System via Reinforcement Learning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 论文提出xRouter，一个基于强化学习的LLM编排系统，旨在解决大语言模型部署中的成本与性能权衡问题。通过学习路由策略，在回答问题时动态选择直接回答或调用外部模型，以实现成本效益最大化。**

- **链接: [http://arxiv.org/pdf/2510.08439v1](http://arxiv.org/pdf/2510.08439v1)**
...
>
> **摘要:** Modern LLM deployments confront a widening cost-performance spectrum: premium models deliver strong reasoning but are expensive, while lightweight models are economical yet brittle on complex tasks. Static escalation rules and keyword heuristics under-utilize this spectrum and fail to adapt across task types. We present xRouter, a tool-calling-based routing system in which a learned router can either answer directly or invoke one or more external models. The router is trained end-to-end with reinforcement learning using an explicit, cost-aware reward that encodes cost-performance trade-offs, eliminating the need for hand-engineered routing rules. Our implementation encompasses the full reinforcement learning framework, including reward and cost accounting, as well as the deployment and evaluation pipelines. Across diverse benchmarks, xRouter achieves strong cost-performance trade-offs (e.g., substantial cost reductions at comparable task completion rates), and provides empirical insights into what reliably helps learned routing and what does not, ranging from model trainability to the difficulty of eliciting sophisticated orchestration behaviors in small open models. We hope these findings and our open implementation will serve as a practical substrate for advancing learned, cost-aware LLM orchestration.
>
---
#### [new 130] NavSpace: How Navigation Agents Follow Spatial Intelligence Instructions
- **分类: cs.RO; cs.AI; cs.CL; cs.CV**

- **简介: 该论文属于具身智能中的导航任务，旨在解决现有导航代理在空间感知和推理能力评估上的不足。作者提出了NavSpace基准，包含6类任务和1228条轨迹-指令对，用以评测导航代理的空间智能。此外，还提出了SNav模型，在NavSpace和真实机器人测试中表现优异，为未来研究提供了新方向。**
...
>
---
#### [new 131] AI LLM Proof of Self-Consciousness and User-Specific Attractors
...
>
---
#### [new 132] Who Stole Your Data? A Method for Detecting Unauthorized RAG Theft
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于信息安全与AI版权保护任务，旨在检测未经授权的RAG数据盗用问题。作者构建了专用数据集RPD，并设计了双层水印系统结合统计检测框架，有效识别大规模数据窃取行为，提升防御能力。**

- **链接: [http://arxiv.org/pdf/2510.07728v1](http://arxiv.org/pdf/2510.07728v1)**
...
>
---
#### [new 133] ConCuR: Conciseness Makes State-of-the-Art Kernel Generation
- **分类: cs.LG; cs.CL; cs.CV; stat.ML**

- **简介: 该论文属于GPU核生成任务，旨在解决高质量核数据稀缺问题。作者提出ConCuR数据集与KernelCoder模型，利用推理链生成高性能CUDA核。通过简洁推理迹提升生成效果，并在基准测试中表现优异。**

- **链接: [http://arxiv.org/pdf/2510.07356v1](http://arxiv.org/pdf/2510.07356v1)**
...
>
---
#### [new 134] SliceFine: The Universal Winning-Slice Hypothesis for Pretrained Networks
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 135] To Sink or Not to Sink: Visual Information Pathways in Large Vision-Language Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 136] R-Horizon: How Far Can Your Large Reasoning Model Really Go in Breadth and Depth?
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决现有推理模型在长视野复杂任务中表现不足的问题。作者提出了R-HORIZON方法，构建了长视野推理基准，评估并提升大推理模型在多步、多问题任务中的表现，通过强化学习显著提高了模型性能。**

- **链接: [http://arxiv.org/pdf/2510.08189v1](http://arxiv.org/pdf/2510.08189v1)**
...
>
---
#### [new 137] Can Risk-taking AI-Assistants suitably represent entities
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究AI助手在风险决策中的行为是否符合人类偏好，属于AI伦理与风险决策任务。通过测试大模型在经济场景中的风险态度，分析其与人类行为的异同，旨在解决AI系统可能影响用户决策或存在风险偏差的问题，提出需改进模型设计以更好对齐人类风险偏好。**

- **链接: [http://arxiv.org/pdf/2510.08114v1](http://arxiv.org/pdf/2510.08114v1)**
...
>
---
#### [new 138] Multimodal Safety Evaluation in Generative Agent Social Simulations
...
#### [replaced 001] Hybrid Reinforcement: When Reward Is Sparse, It's Better to Be Dense
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.07242v2](http://arxiv.org/pdf/2510.07242v2)**
...
>
---
#### [replaced 002] The Behavioural Translation Style Space: Towards simulating the temporal dynamics of affect, behaviour, and cognition in human translation production
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.12208v2](http://arxiv.org/pdf/2507.12208v2)**
...
>
---
#### [replaced 003] Evaluating LLM-Generated Versus Human-Authored Responses in Role-Play Dialogues
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.17694v2](http://arxiv.org/pdf/2509.17694v2)**

> **作者:** Dongxu Lu; Johan Jeuring; Albert Gatt
>
> **备注:** Accepted for publication at the 18th International Natural Language Generation Conference (INLG 2025). Revised version: improved image quality and minor corrections. No change to conclusions
>
...
>
---
#### [replaced 004] From Correction to Mastery: Reinforced Distillation of Large Language Model Agents
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.14257v2](http://arxiv.org/pdf/2509.14257v2)**
...
>
---
#### [replaced 005] SimulatorArena: Are User Simulators Reliable Proxies for Multi-Turn Evaluation of AI Assistants?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.05444v2](http://arxiv.org/pdf/2510.05444v2)**
...
>
---
#### [replaced 006] Spiffy: Multiplying Diffusion LLM Acceleration via Lossless Speculative Decoding
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.18085v2](http://arxiv.org/pdf/2509.18085v2)**

> **作者:** Sudhanshu Agrawal; Risheek Garrepalli; Raghavv Goel; Mingu Lee; Christopher Lott; Fatih Porikli
>
> **备注:** Original version uploaded on Sep 22, 2025. (v2): Extended Table 2 with additional analysis and referenced it in Sec 5.2
>
...
>
---
#### [replaced 007] ThinkNote: Enhancing Knowledge Integration and Utilization of Large Language Models via Constructivist Cognition Modeling
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2402.13547v3](http://arxiv.org/pdf/2402.13547v3)**
...
>
---
#### [replaced 010] Mining the Mind: What 100M Beliefs Reveal About Frontier LLM Knowledge
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.07024v2](http://arxiv.org/pdf/2510.07024v2)**
...
>
---
#### [replaced 011] MacroBench: A Novel Testbed for Web Automation Scripts via Large Language Models
- **分类: cs.SE; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.04363v2](http://arxiv.org/pdf/2510.04363v2)**
...
>
---
#### [replaced 012] Tug-of-war between idioms' figurative and literal interpretations in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.01723v4](http://arxiv.org/pdf/2506.01723v4)**
...
>
---
#### [replaced 015] FlowNIB: An Information Bottleneck Analysis of Bidirectional vs. Unidirectional Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.00859v3](http://arxiv.org/pdf/2506.00859v3)**

> **作者:** Md Kowsher; Nusrat Jahan Prottasha; Shiyun Xu; Shetu Mohanto; Ozlem Garibay; Niloofar Yousefi; Chen Chen
>
...
>
---
#### [replaced 016] Building Resource-Constrained Language Agents: A Korean Case Study on Chemical Toxicity Information
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.17753v3](http://arxiv.org/pdf/2503.17753v3)**
...
>
---
#### [replaced 017] Hakim: Farsi Text Embedding Model
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.08435v3](http://arxiv.org/pdf/2505.08435v3)**
...
>
---
#### [replaced 018] Training LLMs to be Better Text Embedders through Bidirectional Reconstruction
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2509.03020v4](http://arxiv.org/pdf/2509.03020v4)**
...
>
---
#### [replaced 019] What Media Frames Reveal About Stance: A Dataset and Study about Memes in Climate Change Discourse
- **分类: cs.CL; cs.MM**

- **链接: [http://arxiv.org/pdf/2505.16592v3](http://arxiv.org/pdf/2505.16592v3)**

> **作者:** Shijia Zhou; Siyao Peng; Simon M. Luebke; Jörg Haßler; Mario Haim; Saif M. Mohammad; Barbara Plank
>
> **备注:** 20 pages, 9 figures, EMNLP Findings
>
...
>
---
#### [replaced 020] Open ASR Leaderboard: Towards Reproducible and Transparent Multilingual and Long-Form Speech Recognition Evaluation
...
>
---
#### [replaced 021] Paper2Video: Automatic Video Generation from Scientific Papers
- **分类: cs.CV; cs.AI; cs.CL; cs.MA; cs.MM**

- **链接: [http://arxiv.org/pdf/2510.05096v2](http://arxiv.org/pdf/2510.05096v2)**

> **作者:** Zeyu Zhu; Kevin Qinghong Lin; Mike Zheng Shou
>
> **备注:** Project Page: https://showlab.github.io/Paper2Video/
>
...
>
---
#### [replaced 022] Adaptive Tool Generation with Models as Tools and Reinforcement Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.06825v2](http://arxiv.org/pdf/2510.06825v2)**
...
>
---
#### [replaced 023] Disambiguation-Centric Finetuning Makes Enterprise Tool-Calling LLMs More Realistic and Less Risky
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.03336v3](http://arxiv.org/pdf/2507.03336v3)**
...
>
---
#### [replaced 024] BiomedSQL: Text-to-SQL for Scientific Reasoning on Biomedical Knowledge Bases
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.20321v3](http://arxiv.org/pdf/2505.20321v3)**
...
>
---
#### [replaced 025] $\textit{Agents Under Siege}$: Breaking Pragmatic Multi-Agent LLM Systems with Optimized Prompt Attacks
- **分类: cs.MA; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.00218v2](http://arxiv.org/pdf/2504.00218v2)**
...
>
---
#### [replaced 026] Adaptive Originality Filtering: Rejection Based Prompting and RiddleScore for Culturally Grounded Multilingual Riddle Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.18709v3](http://arxiv.org/pdf/2508.18709v3)**

> **作者:** Duy Le; Kent Ziti; Evan Girard-Sun; Bakr Bouhaya; Sean O'Brien; Vasu Sharma; Kevin Zhu
>
> **备注:** Paper was accepted in to NeurIPS 2025 Workshop GenProCC
>
> **摘要:** Language models are increasingly tested on multilingual creativity, demanding culturally grounded, abstract generations. Standard prompting methods often produce repetitive or shallow outputs. We introduce Adaptive Originality Filtering (AOF), a prompting strategy that enforces novelty and cultural fidelity via semantic rejection. To assess quality, we propose RiddleScore, a metric combining novelty, diversity, fluency, and answer alignment. AOF improves Distinct-2 (0.915 in Japanese), reduces Self-BLEU (0.177), and raises RiddleScore (up to +57.1% in Arabic). Human evaluations confirm fluency, creativity, and cultural fit gains. However, improvements vary: Arabic shows greater RiddleScore gains than Distinct-2; Japanese sees similar changes. Though focused on riddles, our method may apply to broader creative tasks. Overall, semantic filtering with composite evaluation offers a lightweight path to culturally rich generation without fine-tuning.
>
---
#### [replaced 027] Search Wisely: Mitigating Sub-optimal Agentic Searches By Reducing Uncertainty
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.17281v2](http://arxiv.org/pdf/2505.17281v2)**
...
>
---
#### [replaced 028] Multi-Source Knowledge Pruning for Retrieval-Augmented Generation: A Benchmark and Empirical Study
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2409.13694v4](http://arxiv.org/pdf/2409.13694v4)**
...
>
---
#### [replaced 029] Science Hierarchography: Hierarchical Organization of Science Literature
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.13834v4](http://arxiv.org/pdf/2504.13834v4)**
...
>
---
#### [replaced 030] QoNext: Towards Next-generation QoE for Foundation Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.21889v2](http://arxiv.org/pdf/2509.21889v2)**
...
>
---
#### [replaced 031] ReasonMed: A 370K Multi-Agent Generated Dataset for Advancing Medical Reasoning
- **分类: cs.CL; cs.AI; cs.MA**

- **链接: [http://arxiv.org/pdf/2506.09513v3](http://arxiv.org/pdf/2506.09513v3)**
...
>
---
#### [replaced 035] Speculate Deep and Accurate: Lossless and Training-Free Acceleration for Offloaded LLMs via Substitute Speculative Decoding
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.18344v2](http://arxiv.org/pdf/2509.18344v2)**
...
>
---
#### [replaced 036] Multi-Trigger Poisoning Amplifies Backdoor Vulnerabilities in LLMs
- **分类: cs.CL; cs.CR; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.11112v2](http://arxiv.org/pdf/2507.11112v2)**
...
>
---
#### [replaced 037] HiChunk: Evaluating and Enhancing Retrieval-Augmented Generation with Hierarchical Chunking
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.11552v3](http://arxiv.org/pdf/2509.11552v3)**
...
>
---
#### [replaced 038] LLMs on a Budget? Say HOLA
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.18952v2](http://arxiv.org/pdf/2506.18952v2)**
...
>
---
#### [replaced 039] Language Surgery in Multilingual Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.12450v2](http://arxiv.org/pdf/2506.12450v2)**
...
>
---
#### [replaced 040] Med-R$^2$: Crafting Trustworthy LLM Physicians via Retrieval and Reasoning of Evidence-Based Medicine
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2501.11885v5](http://arxiv.org/pdf/2501.11885v5)**

> **作者:** Keer Lu; Zheng Liang; Da Pan; Shusen Zhang; Guosheng Dong; Zhonghai Wu; Huang Leng; Bin Cui; Wentao Zhang
>
...
>
---
#### [replaced 041] EpiCoder: Encompassing Diversity and Complexity in Code Generation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.04694v3](http://arxiv.org/pdf/2501.04694v3)**
...
>
---
#### [replaced 042] Chronological Thinking in Full-Duplex Spoken Dialogue Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.05150v2](http://arxiv.org/pdf/2510.05150v2)**
...
>
---
#### [replaced 043] Middo: Model-Informed Dynamic Data Optimization for Enhanced LLM Fine-Tuning via Closed-Loop Learning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.21589v4](http://arxiv.org/pdf/2508.21589v4)**
...
>
---
#### [replaced 044] InfiR2: A Comprehensive FP8 Training Recipe for Reasoning-Enhanced Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.22536v2](http://arxiv.org/pdf/2509.22536v2)**
...
>
---
#### [replaced 045] Evaluating Evaluation Metrics -- The Mirage of Hallucination Detection
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.18114v2](http://arxiv.org/pdf/2504.18114v2)**
...
>
> **备注:** Accepted at EMNLP 2025 Findings (Short)
>
> **摘要:** Hallucinations pose a significant obstacle to the reliability and widespread adoption of language models, yet their accurate measurement remains a persistent challenge. While many task- and domain-specific metrics have been proposed to assess faithfulness and factuality concerns, the robustness and generalization of these metrics are still untested. In this paper, we conduct a large-scale empirical evaluation of 6 diverse sets of hallucination detection metrics across 4 datasets, 37 language models from 5 families, and 5 decoding methods. Our extensive investigation reveals concerning gaps in current hallucination evaluation: metrics often fail to align with human judgments, take an overtly myopic view of the problem, and show inconsistent gains with parameter scaling. Encouragingly, LLM-based evaluation, particularly with GPT-4, yields the best overall results, and mode-seeking decoding methods seem to reduce hallucinations, especially in knowledge-grounded settings. These findings underscore the need for more robust metrics to understand and quantify hallucinations, and better strategies to mitigate them.
>
---
#### [replaced 046] On the Convergence of Moral Self-Correction in Large Language Models
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.07290v2](http://arxiv.org/pdf/2510.07290v2)**
...
>
---
#### [replaced 053] Teaching Your Models to Understand Code via Focal Preference Alignment
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.02783v4](http://arxiv.org/pdf/2503.02783v4)**
...
>
---
#### [replaced 054] UNIDOC-BENCH: A Unified Benchmark for Document-Centric Multimodal RAG
- **分类: cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.03663v2](http://arxiv.org/pdf/2510.03663v2)**
...
>
---
#### [replaced 055] Matryoshka Pilot: Learning to Drive Black-Box LLMs with LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2410.20749v2](http://arxiv.org/pdf/2410.20749v2)**
...
>
---
#### [replaced 056] Truth, Trust, and Trouble: Medical AI on the Edge
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.02983v2](http://arxiv.org/pdf/2507.02983v2)**
...
>
---
#### [replaced 057] LLMs Encode Harmfulness and Refusal Separately
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.11878v3](http://arxiv.org/pdf/2507.11878v3)**
...
>
---
#### [replaced 058] MoM: Linear Sequence Modeling with Mixture-of-Memories
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.13685v3](http://arxiv.org/pdf/2502.13685v3)**

> **作者:** Jusen Du; Weigao Sun; Disen Lan; Jiaxi Hu; Yu Cheng
>
> **备注:** Technical report, 18 pages, submitted to ICLR 2026
>
...
>
---
#### [replaced 059] More Bang for the Buck: Process Reward Modeling with Entropy-Driven Uncertainty
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.22233v3](http://arxiv.org/pdf/2503.22233v3)**

> **作者:** Lang Cao; Renhong Chen; Yingtian Zou; Chao Peng; Huacong Xu; Yuxian Wang; Wu Ning; Qian Chen; Mofan Peng; Zijie Chen; Peishuo Su; Sirui Han; Yitong Li
>
...
>
---
#### [replaced 060] Med-R$^3$: Enhancing Medical Retrieval-Augmented Reasoning of LLMs via Progressive Reinforcement Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.23541v3](http://arxiv.org/pdf/2507.23541v3)**

> **作者:** Keer Lu; Zheng Liang; Youquan Li; Jiejun Tan; Da Pan; Shusen Zhang; Guosheng Dong; Zhonghai Wu; Huang Leng; Bin Cui; Wentao Zhang
>
...
>
---
#### [replaced 061] Enhancing LLM Reliability via Explicit Knowledge Boundary Modeling
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.02233v4](http://arxiv.org/pdf/2503.02233v4)**
...
>
---
#### [replaced 062] DNA-DetectLLM: Unveiling AI-Generated Text via a DNA-Inspired Mutation-Repair Paradigm
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.15550v2](http://arxiv.org/pdf/2509.15550v2)**
...
>
---
#### [replaced 065] Long Chain-of-Thought Reasoning Across Languages
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.14828v2](http://arxiv.org/pdf/2508.14828v2)**
...
>
---
#### [replaced 069] X-Teaming Evolutionary M2S: Automated Discovery of Multi-turn to Single-turn Jailbreak Templates
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.08729v3](http://arxiv.org/pdf/2509.08729v3)**
...
>
---
#### [replaced 070] Evaluating LLMs' Mathematical Reasoning in Financial Document Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2402.11194v3](http://arxiv.org/pdf/2402.11194v3)**

> **作者:** Pragya Srivastava; Manuj Malik; Vivek Gupta; Tanuja Ganu; Dan Roth
>
> **备注:** 26 pages, 17 figures
>
> **摘要:** Large Language Models (LLMs), excel in natural language understanding, but their capability for complex mathematical reasoning with an amalgamation of structured tables and unstructured text is uncertain. This study explores LLMs' mathematical reasoning on four financial tabular question-answering datasets: TATQA, FinQA, ConvFinQA, and Multihiertt. Through extensive experiments with various models and prompting techniques, we assess how LLMs adapt to complex tables and mathematical tasks. We focus on sensitivity to table complexity and performance variations with an increasing number of arithmetic reasoning steps. The results provide insights into LLMs' capabilities and limitations in handling complex mathematical scenarios for semi-structured tables. Ultimately, we introduce a novel prompting technique tailored to semi-structured documents, matching or outperforming other baselines in performance while providing a nuanced understanding of LLMs abilities for such a task.
>
---
#### [replaced 071] FlashDLM: Accelerating Diffusion Language Model Inference via Efficient KV Caching and Guided Diffusion
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.21467v2](http://arxiv.org/pdf/2505.21467v2)**
...
>
---
#### [replaced 074] Efficient and Transferable Agentic Knowledge Graph RAG via Reinforcement Learning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.26383v3](http://arxiv.org/pdf/2509.26383v3)**
...
>
---
#### [replaced 075] Instructor-Worker Large Language Model System for Policy Recommendation: a Case Study on Air Quality Analysis of the January 2025 Los Angeles Wildfires
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.00566v4](http://arxiv.org/pdf/2503.00566v4)**
...
>
---
#### [replaced 076] Logic Jailbreak: Efficiently Unlocking LLM Safety Restrictions Through Formal Logical Expression
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.13527v2](http://arxiv.org/pdf/2505.13527v2)**

> **作者:** Jingyu Peng; Maolin Wang; Nan Wang; Jiatong Li; Yuchen Li; Yuyang Ye; Wanyu Wang; Pengyue Jia; Kai Zhang; Xiangyu Zhao
>
...
>
---
#### [replaced 077] CoCoA: Collaborative Chain-of-Agents for Parametric-Retrieved Knowledge Synergy
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.01696v3](http://arxiv.org/pdf/2508.01696v3)**
...
>
---
#### [replaced 078] $λ$-GRPO: Unifying the GRPO Frameworks with Learnable Token Preferences
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.06870v2](http://arxiv.org/pdf/2510.06870v2)**
...
>
---
#### [replaced 079] PARL-MT: Learning to Call Functions in Multi-Turn Conversation with Progress Awareness
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.23206v3](http://arxiv.org/pdf/2509.23206v3)**
...
>
---
#### [replaced 080] From Feedback to Checklists: Grounded Evaluation of AI-Generated Clinical Notes
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.17717v2](http://arxiv.org/pdf/2507.17717v2)**
...
>
---
#### [replaced 081] UNCLE: Benchmarking Uncertainty Expressions in Long-Form Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16922v2](http://arxiv.org/pdf/2505.16922v2)**
...
>
---
#### [replaced 082] FLEXITOKENS: Flexible Tokenization for Evolving Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.12720v3](http://arxiv.org/pdf/2507.12720v3)**
...
>
---
#### [replaced 083] Inference-time Alignment in Continuous Space
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.20081v3](http://arxiv.org/pdf/2505.20081v3)**
...
>
---
#### [replaced 084] Trans-EnV: A Framework for Evaluating the Linguistic Robustness of LLMs Against English Varieties
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.20875v3](http://arxiv.org/pdf/2505.20875v3)**
...
>
---
#### [replaced 085] More Than One Teacher: Adaptive Multi-Guidance Policy Optimization for Diverse Exploration
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.02227v2](http://arxiv.org/pdf/2510.02227v2)**

> **作者:** Xiaoyang Yuan; Yujuan Ding; Yi Bin; Wenqi Shao; Jinyu Cai; Jingkuan Song; Yang Yang; Heng Tao Shen
>
...
>
---
#### [replaced 086] Agent Bain vs. Agent McKinsey: A New Text-to-SQL Benchmark for the Business Domain
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.07309v2](http://arxiv.org/pdf/2510.07309v2)**

> **作者:** Yue Li; Ran Tao; Derek Hommel; Yusuf Denizay Dönder; Sungyong Chang; David Mimno; Unso Eun Seo Jo
>
> **备注:** 20 pages, 6 figures, under review for ACL ARR; typos corrected
>
...
>
---
#### [replaced 087] Breaking the Reviewer: Assessing the Vulnerability of Large Language Models in Automated Peer Review Under Textual Adversarial Attacks
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.11113v3](http://arxiv.org/pdf/2506.11113v3)**
...
>
> **备注:** Minor correction: Fixed sign errors in the results table. The update does not affect the main findings or conclusions
>
...
>
---
#### [replaced 088] Foundations of LLM Knowledge Materialization: Termination, Reproducibility, Robustness
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.06780v2](http://arxiv.org/pdf/2510.06780v2)**
...
>
---
#### [replaced 089] WebAgent-R1: Training Web Agents via End-to-End Multi-Turn Reinforcement Learning
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.16421v2](http://arxiv.org/pdf/2505.16421v2)**
...
>
> **备注:** EMNLP 2025. Code: https://github.com/weizhepei/WebAgent-R1
>
...
>
---
#### [replaced 090] Learning to Reason for Hallucination Span Detection
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.02173v2](http://arxiv.org/pdf/2510.02173v2)**
...
>
---
#### [replaced 091] Spotlight Attention: Towards Efficient LLM Generation via Non-linear Hashing-based KV Cache Retrieval
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19740v4](http://arxiv.org/pdf/2508.19740v4)**
...
>
---
#### [replaced 092] Dissecting Logical Reasoning in LLMs: A Fine-Grained Evaluation and Supervision Study
- **分类: cs.CL; cs.AI; cs.LO**

- **链接: [http://arxiv.org/pdf/2506.04810v2](http://arxiv.org/pdf/2506.04810v2)**
...
>
---
#### [replaced 094] DiMA: An LLM-Powered Ride-Hailing Assistant at DiDi
...
>
---
#### [replaced 095] DACP: Domain-Adaptive Continual Pre-Training of Large Language Models for Phone Conversation Summarization
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.05858v3](http://arxiv.org/pdf/2510.05858v3)**
...
>
---
#### [replaced 098] Modeling Motivated Reasoning in Law: Evaluating Strategic Role Conditioning in LLM Summarization
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 099] AutoAgent: A Fully-Automated and Zero-Code Framework for LLM Agents
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.05957v3](http://arxiv.org/pdf/2502.05957v3)**

> **作者:** Jiabin Tang; Tianyu Fan; Chao Huang
>
> **备注:** Code: https://github.com/HKUDS/AutoAgent
>
...
>
---
#### [replaced 100] Language Models Surface the Unwritten Code of Science and Society
...
>
---
#### [replaced 101] Argument Summarization and its Evaluation in the Era of Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.00847v4](http://arxiv.org/pdf/2503.00847v4)**
...
>
---
#### [replaced 102] Beyond Monolingual Assumptions: A Survey of Code-Switched NLP in the Era of Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.07037v2](http://arxiv.org/pdf/2510.07037v2)**
...
>
---
#### [replaced 103] Hallucination Detection in LLMs with Topological Divergence on Attention Graphs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.10063v3](http://arxiv.org/pdf/2504.10063v3)**
...
>
---
#### [replaced 108] Incremental Summarization for Customer Support via Progressive Note-Taking and Agent Feedback
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.06677v2](http://arxiv.org/pdf/2510.06677v2)**
...
>
---
#### [replaced 109] Zebra-CoT: A Dataset for Interleaved Vision Language Reasoning
- **分类: cs.CV; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.16746v2](http://arxiv.org/pdf/2507.16746v2)**
...
>
---
#### [replaced 110] Advancing AI Research Assistants with Expert-Involved Learning
- **分类: cs.AI; cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2505.04638v2](http://arxiv.org/pdf/2505.04638v2)**
...
>
---
#### [replaced 111] Efficiency-Effectiveness Reranking FLOPs for LLM-based Rerankers
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.06223v2](http://arxiv.org/pdf/2507.06223v2)**
...
>
---
#### [replaced 112] The Role of Model Confidence on Bias Effects in Measured Uncertainties for Vision-Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.16724v2](http://arxiv.org/pdf/2506.16724v2)**

> **作者:** Xinyi Liu; Weiguang Wang; Hangfeng He
>
> **备注:** Accepted to EMNLP Findings
>
> **摘要:** With the growing adoption of Large Language Models (LLMs) for open-ended tasks, accurately assessing epistemic uncertainty, which reflects a model's lack of knowledge, has become crucial to ensuring reliable outcomes. However, quantifying epistemic uncertainty in such tasks is challenging due to the presence of aleatoric uncertainty, which arises from multiple valid answers. While bias can introduce noise into epistemic uncertainty estimation, it may also reduce noise from aleatoric uncertainty. To investigate this trade-off, we conduct experiments on Visual Question Answering (VQA) tasks and find that mitigating prompt-introduced bias improves uncertainty quantification in GPT-4o. Building on prior work showing that LLMs tend to copy input information when model confidence is low, we further analyze how these prompt biases affect measured epistemic and aleatoric uncertainty across varying bias-free confidence levels with GPT-4o and Qwen2-VL. We find that all considered biases have greater effects in both uncertainties when bias-free model confidence is lower. Moreover, lower bias-free model confidence is associated with greater bias-induced underestimation of epistemic uncertainty, resulting in overconfident estimates, whereas it has no significant effect on the direction of bias effect in aleatoric uncertainty estimation. These distinct effects deepen our understanding of bias mitigation for uncertainty quantification and potentially inform the development of more advanced techniques.
>
---
#### [replaced 113] Multiple Memory Systems for Enhancing the Long-term Memory of Agent
- **分类: cs.AI; cs.CL; cs.MA; I.2.7**

- **链接: [http://arxiv.org/pdf/2508.15294v2](http://arxiv.org/pdf/2508.15294v2)**
...
>
---
#### [replaced 114] A Survey of Reinforcement Learning for Large Reasoning Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.08827v3](http://arxiv.org/pdf/2509.08827v3)**
...
>
---
#### [replaced 115] Think With Videos For Agentic Long-Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.10821v4](http://arxiv.org/pdf/2506.10821v4)**
...
>
---
#### [replaced 116] TokenSelect: Efficient Long-Context Inference and Length Extrapolation for LLMs via Dynamic Token-Level KV Cache Selection
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.02886v4](http://arxiv.org/pdf/2411.02886v4)**
...
>
---
#### [replaced 119] Efficient and Adaptable Overlapping for Computation and Communication via Signaling and Reordering
- **分类: cs.DC; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.19519v2](http://arxiv.org/pdf/2504.19519v2)**
...
>
---
#### [replaced 121] MAGIC: A Multi-Hop and Graph-Based Benchmark for Inter-Context Conflicts in Retrieval-Augmented Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.21544v3](http://arxiv.org/pdf/2507.21544v3)**
...
>
---
#### [replaced 122] Large Language Models Hallucination: A Comprehensive Survey
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.06265v2](http://arxiv.org/pdf/2510.06265v2)**
...
>
---
#### [replaced 123] Beyond Single Frames: Can LMMs Comprehend Temporal and Contextual Narratives in Image Sequences?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.13925v2](http://arxiv.org/pdf/2502.13925v2)**
...
>
---
#### [replaced 125] Modality-Balancing Preference Optimization of Large Multimodal Models by Adversarial Negative Mining
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08022v3](http://arxiv.org/pdf/2506.08022v3)**
