...
- **简介: 该论文属于多模态视频模型的对齐任务，旨在解决人工反馈成本高的问题。提出Oracle-RLAIF框架，用Oracle排名器替代奖励模型，提升效率与效果。**
...
- **简介: 该论文属于视觉语言模型研究任务，旨在揭示模型在解决谜题时的认知局限。通过构建数据集和分析不同提示策略，探索模型的推理过程与失败模式。**
...
- **链接: [http://arxiv.org/pdf/2510.02654v1](http://arxiv.org/pdf/2510.02654v1)**
...
- **链接: [http://arxiv.org/pdf/2510.02733v1](http://arxiv.org/pdf/2510.02733v1)**
...
> **作者:** P. Jonathon Phillips; Geraldine Jeckeln; Carina A. Hahn; Amy N. Yates; Peter C. Fontana; Alice J. O'Toole
>
...
- **链接: [http://arxiv.org/pdf/2510.02909v1](http://arxiv.org/pdf/2510.02909v1)**
...
- **简介: 该论文属于数据隐私保护任务，旨在解决未经授权的模型个性化问题。通过在扩散模型的潜在空间中进行扰动，生成难以被逆向和个性化但视觉质量高的图像，提升数据安全性。**
...
- **简介: 该论文属于目标识别与检测任务，解决VLM在分布偏移下的性能下降问题。提出BCA+方法，通过动态缓存和贝叶斯推理实现无训练的测试时适应。**
...
- **简介: 该论文属于视频生成任务，旨在解决扩散模型实时性差的问题。通过引入输入感知的稀疏注意力和蒸馏损失，提升推理效率与视频质量。**
...
- **链接: [http://arxiv.org/pdf/2510.02631v1](http://arxiv.org/pdf/2510.02631v1)**
...
- **简介: 该论文属于视觉语言模型的鲁棒性研究，旨在提升模型在对抗攻击下的零样本泛化能力。通过提出CAW方法，结合置信度加权和特征对齐，增强模型的鲁棒性与准确性。**
...
- **简介: 该论文属于动态3D重建任务，解决单目视频中3D运动模糊与计算效率问题。通过语义引导的运动自适应控制框架，提升重建质量与效率。**
...
- **简介: 该论文属于医学目标检测任务，解决多模态数据（如X光、CT、MRI）间表示不一致的问题。通过引入模态标记和注意力机制，对齐查询表示，提升检测性能。**
...
- **简介: 该论文属于图像超分辨率任务，解决边缘设备部署难题。提出PocketSR模型，通过轻量化设计实现高效高质图像增强。**
...
- **链接: [http://arxiv.org/pdf/2510.02601v1](http://arxiv.org/pdf/2510.02601v1)**
...
- **简介: 该论文属于零样本图像描述任务，解决传统方法依赖成对数据和全局描述的问题。提出统一框架，通过局部图像块进行区域描述，提升灵活性与性能。**
...
- **简介: 该论文研究双语视觉问答任务，通过OCR增强生成方法提升模型性能，提出KLOCR模型和KOCRBench数据集。**
...
- **链接: [http://arxiv.org/pdf/2510.03198v1](http://arxiv.org/pdf/2510.03198v1)**
...
- **链接: [http://arxiv.org/pdf/2510.03110v1](http://arxiv.org/pdf/2510.03110v1)**
...
- **链接: [http://arxiv.org/pdf/2510.02781v1](http://arxiv.org/pdf/2510.02781v1)**
...
- **简介: 该论文属于天文学中的小目标检测任务，旨在解决高分辨率图像中微弱且重叠天体的检测问题。通过引入自回归变分分布和神经后验估计方法，提升了检测精度与后验校准效果。**
...
- **简介: 该论文属于生成模型任务，旨在解决生物启发的生成方法问题。通过结合Dale定律与几何布朗运动，提出一种基于乘法更新的去噪扩散模型。**
...
- **简介: 该论文属于医学图像分割任务，旨在解决在有限GPU内存下高效训练模型的问题。提出Wave-GMS模型，具有少量参数且支持大批次训练。**

- **链接: [http://arxiv.org/pdf/2510.03216v1](http://arxiv.org/pdf/2510.03216v1)**
...
>
---
#### [new 069] Learning a distance measure from the information-estimation geometry of data
...
>
---
#### [new 070] Glaucoma Detection and Structured OCT Report Generation via a Fine-tuned Multimodal Large Language Model
- **分类: q-bio.QM; cs.AI; cs.CV**

- **简介: 该论文属于医学影像分析任务，旨在通过多模态大语言模型自动检测青光眼并生成结构化OCT报告，解决图像质量评估和临床诊断问题。**

- **链接: [http://arxiv.org/pdf/2510.02403v1](http://arxiv.org/pdf/2510.02403v1)**
...
>
---
#### [new 072] A Statistical Method for Attack-Agnostic Adversarial Attack Detection with Compressive Sensing Comparison
- **分类: cs.CR; cs.CV; cs.LG; eess.IV**

- **简介: 该论文属于对抗攻击检测任务，旨在解决现有方法无法有效检测未知攻击的问题。通过比较压缩与未压缩神经网络的行为，提出一种统计检测方法，实现高精度实时检测。**

- **链接: [http://arxiv.org/pdf/2510.02707v1](http://arxiv.org/pdf/2510.02707v1)**
...
>
---
#### [new 073] Work Zones challenge VLM Trajectory Planning: Toward Mitigation and Robust Autonomous Driving
...
>
---
#### [new 074] PyRadiomics-cuda: a GPU-accelerated 3D features extraction from medical images within PyRadiomics
- **分类: cs.DC; cs.CV**

- **简介: 该论文属于医学图像分析任务，解决3D特征提取计算效率低的问题，通过GPU加速实现快速、高效的放射组学分析。**

- **链接: [http://arxiv.org/pdf/2510.02894v1](http://arxiv.org/pdf/2510.02894v1)**
...
#### [replaced 001] CostFilter-AD: Enhancing Anomaly Detection through Matching Cost Filtering
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.01476v4](http://arxiv.org/pdf/2505.01476v4)**
...
>
---
#### [replaced 002] Equivariant Splitting: Self-supervised learning from incomplete data
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.00929v3](http://arxiv.org/pdf/2510.00929v3)**
...
>
---
#### [replaced 003] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.24758v2](http://arxiv.org/pdf/2509.24758v2)**
...
>
---
#### [replaced 004] YOLO-Based Defect Detection for Metal Sheets
...
>
---
#### [replaced 005] Contextualized Representation Learning for Effective Human-Object Interaction Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.12784v2](http://arxiv.org/pdf/2509.12784v2)**
...
>
---
#### [replaced 006] PATS: Proficiency-Aware Temporal Sampling for Multi-View Sports Skill Assessment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04996v5](http://arxiv.org/pdf/2506.04996v5)**

> **作者:** Edoardo Bianchi; Antonio Liotta
>
> **备注:** Accepted at the 2025 4th IEEE International Workshop on Sport Technology and Research. Visit our project page at https://edowhite.github.io/PATS
>
...
>
---
#### [replaced 007] Robust Pan-Cancer Mitotic Figure Detection with YOLOv12
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.02593v3](http://arxiv.org/pdf/2509.02593v3)**
...
>
---
#### [replaced 008] CBVLM: Training-free Explainable Concept-based Large Vision Language Models for Medical Image Classification
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 011] Gate-Shift-Pose: Enhancing Action Recognition in Sports with Skeleton Information
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.04470v2](http://arxiv.org/pdf/2503.04470v2)**
...
- **链接: [http://arxiv.org/pdf/2509.24798v3](http://arxiv.org/pdf/2509.24798v3)**
...
>
---
#### [replaced 016] Ultra-Efficient Decoding for End-to-End Neural Compression and Reconstruction
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.01407v2](http://arxiv.org/pdf/2510.01407v2)**
...
>
---
#### [replaced 017] HopaDIFF: Holistic-Partial Aware Fourier Conditioned Diffusion for Referring Human Action Segmentation in Multi-Person Scenarios
...
>
---
#### [replaced 018] From Long Videos to Engaging Clips: A Human-Inspired Video Editing Framework with Multimodal Narrative Understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 022] VirDA: Reusing Backbone for Unsupervised Domain Adaptation with Visual Reprogramming
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.01660v2](http://arxiv.org/pdf/2510.01660v2)**
...
>
---
#### [replaced 023] SP-VLA: A Joint Model Scheduling and Token Pruning Approach for VLA Model Acceleration
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.12723v3](http://arxiv.org/pdf/2506.12723v3)**
...
>
---
#### [replaced 024] Unified Domain Adaptive Semantic Segmentation
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [http://arxiv.org/pdf/2311.13254v5](http://arxiv.org/pdf/2311.13254v5)**
...
>
---
#### [replaced 026] S-Graphs 2.0 -- A Hierarchical-Semantic Optimization and Loop Closure for SLAM
...
>
---
#### [replaced 027] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
- **分类: cs.RO; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.14191v2](http://arxiv.org/pdf/2509.14191v2)**
...
>
---
#### [replaced 028] RACCooN: A Versatile Instructional Video Editing Framework with Auto-Generated Narratives
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 033] SoccerSynth-Detection: A Synthetic Dataset for Soccer Player Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.09281v2](http://arxiv.org/pdf/2501.09281v2)**

> **作者:** Haobin Qin; Calvin Yeung; Rikuhei Umemoto; Keisuke Fujii
>
> **备注:** The SoccerSynth-Detection Dataset is available at https://github.com/open-starlab/SoccerSynth-Detection
>
...
>
---
#### [replaced 034] PointAD+: Learning Hierarchical Representations for Zero-shot 3D Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.03277v3](http://arxiv.org/pdf/2509.03277v3)**
...
>
---
#### [replaced 035] A Survey of Defenses against AI-generated Visual Media: Detection, Disruption, and Authentication
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.10575v2](http://arxiv.org/pdf/2407.10575v2)**

> **作者:** Jingyi Deng; Chenhao Lin; Zhengyu Zhao; Shuai Liu; Qian Wang; Chao Shen
>
...
>
---
#### [replaced 036] Addressing Representation Collapse in Vector Quantized Models with One Linear Layer
...
>
---
#### [replaced 037] Revisiting Reweighted Risk for Calibration: AURC, Focal, and Inverse Focal Loss
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23463v3](http://arxiv.org/pdf/2505.23463v3)**
...
>
---
#### [replaced 038] Towards Size-invariant Salient Object Detection: A Generic Evaluation and Optimization Approach
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.15573v2](http://arxiv.org/pdf/2509.15573v2)**
...
>
---
#### [replaced 043] VOTE: Vision-Language-Action Optimization with Trajectory Ensemble Voting
...
>
---
#### [replaced 044] Dual-Stage Reweighted MoE for Long-Tailed Egocentric Mistake Detection
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.12990v2](http://arxiv.org/pdf/2509.12990v2)**
...
>
---
#### [replaced 045] Photography Perspective Composition: Towards Aesthetic Perspective Recommendation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.20655v4](http://arxiv.org/pdf/2505.20655v4)**
...
>
---
#### [replaced 046] Less is More: Lean yet Powerful Vision-Language Model for Autonomous Driving
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 047] RelayFormer: A Unified Local-Global Attention Framework for Scalable Image and Video Manipulation Localization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09459v2](http://arxiv.org/pdf/2508.09459v2)**
...
>
---
#### [replaced 048] Evict3R: Training-Free Token Eviction for Memory-Bounded Streaming Visual Geometry Transformers
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17650v2](http://arxiv.org/pdf/2509.17650v2)**

> **作者:** Soroush Mahdi; Fardin Ayar; Ehsan Javanmardi; Manabu Tsukada; Mahdi Javanmardi
>
> **备注:** project page: https://soroush-mim.github.io/projects/evict3r/
>
...
>
---
#### [replaced 051] Pack and Force Your Memory: Long-form and Consistent Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.01784v2](http://arxiv.org/pdf/2510.01784v2)**
...
>
---
#### [replaced 052] Learning High-Fidelity Robot Self-Model with Articulated 3D Gaussian Splatting
- **分类: cs.RO; cs.CV**
