...
- **简介: 该论文研究文本到图像生成中的身份一致性问题，旨在解决现有模型因数据不足导致的“复制粘贴”缺陷。作者构建大规模配对数据集MultiID-2M，提出新训练范式与评测基准，实现兼顾身份保持与多样性的可控生成。**
...
- **简介: 该论文针对视频时序定位与推理问题，提出无需训练的VTimeCoT框架。受人类使用进度条理解视频启发，引入可视化进度条工具和高亮工具，结合视听链式思维（visuotemporal CoT），提升多模态大模型在视频问答中的时序理解与推理能力。**
...
- **简介: 该论文针对腹腔镜视频中子宫内膜异位症因形态多变而难以识别的问题，提出一种系统，专门分割术后常见的深色病灶区域。属于医学图像分割任务，通过多色标注和摘要显示辅助医生浏览与诊断。**
...
- **简介: 该论文提出VisualSplit框架，旨在通过解耦经典视觉描述符（如边缘、颜色）来提升图像表征的可解释性。它属于视觉表示学习任务，解决深度模型特征不透明问题，实现可解释且可控的图像生成与编辑。**
...
- **简介: 该论文针对文本到图像生成中多物体提示常出现的物体忽略或混合问题，提出DOS方法。通过分析CLIP文本嵌入特性，改进三类嵌入表示，增强物体间方向性分离，有效提升多物体生成准确率与质量。**
...
- **简介: 该论文研究高效生成模型，提出RepTok框架。利用自监督视觉Transformer提取单个连续潜在token，通过微调语义token并结合生成解码器，实现高质量图像重建与生成，降低训练成本，在图像生成任务中表现优异。**
...
- **简介: 该论文针对视频异常检测中复杂交互异常难检测和缺乏可解释性的问题，提出一种基于多模态大语言模型的半监督方法。通过生成正常视频中物体交互的文本描述用于异常检测与解释，提升了对交互异常的检测能力，并增强了模型可解释性。**
...
- **简介: 该论文研究远距离户外光学相机通信，提出基于事件视觉传感器的鲁棒解调方案，结合OOK、切换解调和数字锁相环，首次在200米60kbps和400米30kbps下实现误码率低于10⁻³。**
...
>
---
#### [new 031] PaddleOCR-VL: Boosting Multilingual Document Parsing via a 0.9B Ultra-Compact Vision-Language Model
- **分类: cs.CV**
...
- **简介: 该论文研究多任务图像修复模型的压缩问题，旨在解决模型参数过多导致计算效率低的问题。提出MIR-L方法，通过迭代剪枝与权重重置，在仅保留10%参数的情况下，仍保持高性能，适用于去雨、去雾和去噪等Web图像恢复任务。**
...
- **简介: 该论文研究高分辨率跨视图匹配任务，旨在解决现有交叉注意力在计算复杂度和匹配约束上的不足。提出MatchAttention机制，通过动态匹配相对位置和滑动窗口采样提升效率与精度，并设计MatchDecoder及抗遮挡策略，在多个基准上实现最先进性能。**
...
- **简介: 该论文针对病理图像跨域分布偏移问题，提出基于因果推断的CLEAR框架。通过引入中介变量和前门准则，建模语义特征与标签间的因果关系，削弱混杂因素影响，在CAMELYON17及私有数据集上实现优于现有方法的鲁棒肿瘤检测性能。**
...
- **简介: 该论文研究羽毛球视频的多尺度战术理解，提出Shot2Tactic-Caption框架，生成击球级和战术级双层描述。构建首个包含击球与战术标注的数据集，设计双分支模型并引入战术单元检测与提示机制，实现对动态战术执行（含中断与恢复）的准确描述。**
...
- **简介: 该论文研究图像到视频生成中的人脸身份一致性问题，提出IPRO方法，通过奖励引导优化和面部特征池机制，在不改模型结构的前提下提升身份保持能力，结合KL正则化稳定训练。**
...
- **简介: 该论文针对视觉语言模型易产生幻觉的问题，提出一种无需训练的三层次对比解码方法，通过水印问题选择视觉 grounding 良好的中间层，结合成熟层与业余层生成更真实、可信的输出，在多个基准上显著降低幻觉。**
...
- **简介: 该论文提出DentVFM，首个面向口腔医学的视觉基础模型，旨在解决现有牙科AI模型任务单一、依赖标注数据的问题。通过自监督学习和大规模多模态数据，实现跨任务、跨模态的通用牙科影像分析，并构建新基准DentBench评估性能。**
...
- **简介: 该论文提出使用Vision Mamba模型预测三维多孔介质渗透率，解决传统ViT和CNN计算效率低、参数量大的问题。通过对比实验和消融研究，验证了其在精度、效率和内存占用上的优势，并公开代码以促进后续研究。**
...
- **简介: 该论文针对主板装配缺陷检测任务，解决现有方法在精度与召回率间的权衡问题。提出YOLO+Faster-RCNN融合模型CTV Voter，提升检测稳定性，并发布可部署的GUI工具，推动视觉技术在实际制造质检中的应用。**
...
- **简介: 该论文针对大规模场景定位与渲染效率低的问题，提出MACE方法，引入混合专家系统与门控网络，实现单次推理仅激活一个子网络，并设计无辅助损失的负载均衡策略，提升定位精度与渲染质量，显著降低计算成本。**
...
- **简介: 该论文针对视频目标检测中的通用对抗攻击任务，旨在生成隐蔽且高效的结构化扰动。通过核范数正则化使扰动集中于背景，并提出自适应乐观指数梯度法优化求解，提升了攻击效果与收敛性。**
...
- **简介: 该论文提出“Capture, Canonicalize, Splat”流程，解决从无结构手机图像生成高保真3D高斯溅射化身像的难题。针对单视图方法几何不一致和合成数据训练细节缺失问题，引入生成性标准化模块与基于真实人物数据训练的Transformer模型，实现零样本、身份保持的高质量3D化身像重建。**
...
- **简介: 该论文研究图像编辑任务，旨在解决缺乏配对训练数据的问题。提出无需图像编辑配对的新训练范式，通过视觉语言模型提供反馈梯度，并结合分布匹配损失优化扩散模型，在无监督条件下实现与有监督方法相当的性能。**
...
>
---
#### [new 064] ChangingGrounding: 3D Visual Grounding in Changing Scenes
- **分类: cs.CV**

- **简介: 该论文研究3D视觉定位在动态场景中的任务，解决传统方法依赖完整点云导致重扫描成本高的问题。提出ChangingGrounding基准和Mem-ChangingGrounder方法，结合记忆与多视角融合，实现高效、准确的物体定位。**

- **链接: [http://arxiv.org/pdf/2510.14965v1](http://arxiv.org/pdf/2510.14965v1)**

> **作者:** Miao Hu; Zhiwei Huang; Tai Wang; Jiangmiao Pang; Dahua Lin; Nanning Zheng; Runsen Xu
>
> **备注:** 30 pages
>
> **摘要:** Real-world robots localize objects from natural-language instructions while scenes around them keep changing. Yet most of the existing 3D visual grounding (3DVG) method still assumes a reconstructed and up-to-date point cloud, an assumption that forces costly re-scans and hinders deployment. We argue that 3DVG should be formulated as an active, memory-driven problem, and we introduce ChangingGrounding, the first benchmark that explicitly measures how well an agent can exploit past observations, explore only where needed, and still deliver precise 3D boxes in changing scenes. To set a strong reference point, we also propose Mem-ChangingGrounder, a zero-shot method for this task that marries cross-modal retrieval with lightweight multi-view fusion: it identifies the object type implied by the query, retrieves relevant memories to guide actions, then explores the target efficiently in the scene, falls back when previous operations are invalid, performs multi-view scanning of the target, and projects the fused evidence from multi-view scans to get accurate object bounding boxes. We evaluate different baselines on ChangingGrounding, and our Mem-ChangingGrounder achieves the highest localization accuracy while greatly reducing exploration cost. We hope this benchmark and method catalyze a shift toward practical, memory-centric 3DVG research for real-world applications. Project page: https://hm123450.github.io/CGB/ .
>
---
#### [new 065] Scaling Tumor Segmentation: Best Lessons from Real and Synthetic Data
- **分类: cs.CV**

- **简介: 该论文聚焦肿瘤分割任务，旨在解决标注数据稀缺导致AI性能受限的问题。作者基于真实与合成数据研究数据规模效应，发现合成数据可提升训练效率，并据此构建大规模腹部肿瘤数据集AbdomenAtlas 2.0，显著提升模型在分布内和分布外测试中的表现。**

- **链接: [http://arxiv.org/pdf/2510.14831v1](http://arxiv.org/pdf/2510.14831v1)**
...
>
---
#### [new 071] RealDPO: Real or Not Real, that is the Preference
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视频生成中的复杂动作合成问题，提出RealDPO方法，利用真实视频作为正样本，通过改进的偏好优化机制提升动作自然性与真实性，并构建RealAction-5K数据集支持训练，显著提升生成质量。**

- **链接: [http://arxiv.org/pdf/2510.14955v1](http://arxiv.org/pdf/2510.14955v1)**
...
>
---
#### [new 079] ScaleWeaver: Weaving Efficient Controllable T2I Generation with Multi-Scale Reference Attention
- **分类: cs.CV**

- **简介: 该论文研究文本到图像生成中的可控生成任务，旨在解决视觉自回归（VAR）模型缺乏高效精细控制的问题。作者提出ScaleWeaver框架，通过改进MMDiT块和引用注意力模块，实现参数高效微调，兼顾生成质量与控制精度。**

- **链接: [http://arxiv.org/pdf/2510.14882v1](http://arxiv.org/pdf/2510.14882v1)**
...
>
---
#### [new 080] Decorrelation Speeds Up Vision Transformers
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究视觉Transformer的高效预训练，旨在降低MAE方法的计算成本。通过在编码器中引入去相关反向传播（DBP），加快收敛速度，显著减少训练时间和碳排放，同时提升下游分割性能。**

- **链接: [http://arxiv.org/pdf/2510.14657v1](http://arxiv.org/pdf/2510.14657v1)**
...
>
---
#### [new 083] From Pixels to Words -- Towards Native Vision-Language Primitives at Scale
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦原生视觉-语言模型（VLMs）构建，旨在解决其与模块化模型的本质差异及研究门槛高问题。作者提出NEO模型家族，基于新设计的原生多模态基元，实现像素与文本的统一表征与推理，推动可扩展、低成本的视觉语言研究。**

- **链接: [http://arxiv.org/pdf/2510.14979v1](http://arxiv.org/pdf/2510.14979v1)**
...
>
---
#### [new 092] Vgent: Graph-based Retrieval-Reasoning-Augmented Generation For Long Video Understanding
- **分类: cs.CV**

- **简介: 该论文针对长视频理解中上下文过长和时序依赖难保留的问题，提出Vgent框架。通过构建视频语义图并引入中间推理步骤，提升检索有效性与跨片段推理能力，在多个基准上显著优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.14032v1](http://arxiv.org/pdf/2510.14032v1)**
...
>
---
#### [new 095] Leveraging Learned Image Prior for 3D Gaussian Compression
- **分类: cs.CV**

- **简介: 该论文研究3D高斯点阵压缩任务，旨在解决压缩导致的质量下降问题。提出利用学习到的图像先验和渲染残差辅助恢复图像质量，提升率失真性能，兼容现有方法，显著降低存储并提高重建效果。**

- **链接: [http://arxiv.org/pdf/2510.14705v1](http://arxiv.org/pdf/2510.14705v1)**
...
>
---
#### [new 098] ImagerySearch: Adaptive Test-Time Search for Video Generation Beyond Semantic Dependency Constraints
- **分类: cs.CV**

- **简介: 该论文研究视频生成中的想象力场景生成任务，旨在解决现有方法在长距离语义关联提示下生成效果差的问题。作者提出ImagerySearch，通过提示引导的自适应搜索策略，动态调整推理搜索空间与奖励函数，并构建LDT-Bench基准进行评估。**

- **链接: [http://arxiv.org/pdf/2510.14847v1](http://arxiv.org/pdf/2510.14847v1)**
...
>
---
#### [new 103] Reinforcement Learning for Unsupervised Domain Adaptation in Spatio-Temporal Echocardiography Segmentation
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文研究无监督域自适应在时空超声心动图分割中的应用，旨在解决跨域分割中准确性、解剖有效性及时间一致性差的问题。作者提出RL4Seg3D框架，结合强化学习与新奖励函数，提升关键点精度和分割质量，并提供不确定性估计，无需目标域标签即可实现优越性能。**

- **链接: [http://arxiv.org/pdf/2510.14244v1](http://arxiv.org/pdf/2510.14244v1)**
...
>
---
#### [new 104] DialectGen: Benchmarking and Improving Dialect Robustness in Multimodal Generation
...
>
---
#### [new 105] Self-Training with Dynamic Weighting for Robust Gradual Domain Adaptation
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究渐进域适应（GDA）任务，旨在解决源域到目标域知识迁移不充分的问题。作者提出动态加权自训练方法（STDW），通过时变参数调控源域与目标域损失权重，提升跨域鲁棒性。实验验证了其在多个数据集上的有效性。**

- **链接: [http://arxiv.org/pdf/2510.13864v1](http://arxiv.org/pdf/2510.13864v1)**
...
>
---
#### [new 106] RDD: Retrieval-Based Demonstration Decomposer for Planner Alignment in Long-Horizon Tasks
- **分类: cs.RO; cs.AI; cs.CV; cs.LG; cs.SY; eess.SY**

- **简介: 该论文针对长视野任务中的子任务分解问题，提出检索式示范分解器（RDD），通过匹配视觉特征自动将示范分解为与底层策略训练数据对齐的子任务，提升任务性能。**
...
>
---
#### [new 107] Towards Reversible Model Merging For Low-rank Weights
...
>
---
#### [new 110] AI for Service: Proactive Assistance with AI Glasses
...
>
---
#### [new 113] GOPLA: Generalizable Object Placement Learning via Synthetic Augmentation of Human Arrangement
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 116] Multimodal Retrieval-Augmented Generation with Large Language Models for Medical VQA
...
>
---
#### [new 117] Learning Human-Humanoid Coordination for Collaborative Object Carrying
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**

- **简介: 该论文研究人形机器人与人类协同搬运物体任务，旨在解决复杂动态下协调控制难题。提出仅用本体感知的强化学习方法COLA，实现领导者与跟随者行为统一，无需外部传感器，提升协作效率与鲁棒性。**
...
>
---
#### [new 118] Distributional Consistency Loss: Beyond Pointwise Data Terms in Inverse Problems
- **分类: cs.LG; cs.CV; physics.med-ph**

- **简介: 该论文研究逆问题中的数据保真度损失函数，提出分布一致性（DC）损失，通过统计检验替代点对点匹配，避免过拟合噪声。适用于已知噪声分布的多测量逆问题，在去噪与医学成像中提升性能。**

- **链接: [http://arxiv.org/pdf/2510.13972v1](http://arxiv.org/pdf/2510.13972v1)**
...
>
---
#### [new 119] pi-Flow: Policy-Based Few-Step Generation via Imitation Distillation
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究少数步生成模型，旨在解决传统蒸馏方法存在的质量-多样性权衡问题。作者提出π-Flow，通过策略蒸馏让学生模型预测无网络策略，动态生成子步速度，实现高效准确的生成，在图像生成任务中兼顾高质量与高多样性。**

- **链接: [http://arxiv.org/pdf/2510.14974v1](http://arxiv.org/pdf/2510.14974v1)**

> **作者:** Hansheng Chen; Kai Zhang; Hao Tan; Leonidas Guibas; Gordon Wetzstein; Sai Bi
>
> **备注:** Code: https://github.com/Lakonik/piFlow Demos: https://huggingface.co/spaces/Lakonik/pi-Qwen and https://huggingface.co/spaces/Lakonik/pi-FLUX.1
>
...
>
---
#### [replaced 002] A Clinically-Grounded Two-Stage Framework for Renal CT Report Generation
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23584v2](http://arxiv.org/pdf/2506.23584v2)**

> **作者:** Renjie Liang; Zhengkang Fan; Jinqian Pan; Chenkun Sun; Bruce Daniel Steinberg; Russell Terry; Jie Xu
>
...
>
---
#### [replaced 003] TopoStreamer: Temporal Lane Segment Topology Reasoning in Autonomous Driving
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.00709v3](http://arxiv.org/pdf/2507.00709v3)**
...
>
---
#### [replaced 004] SGAligner++: Cross-Modal Language-Aided 3D Scene Graph Alignment
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 005] MSF-Mamba: Motion-aware State Fusion Mamba for Efficient Micro-Gesture Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.10478v2](http://arxiv.org/pdf/2510.10478v2)**
...
>
---
#### [replaced 006] Group-Wise Optimization for Self-Extensible Codebooks in Vector Quantized Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13331v2](http://arxiv.org/pdf/2510.13331v2)**
...
>
---
#### [replaced 007] Incomplete Multimodal Industrial Anomaly Detection via Cross-Modal Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.13571v4](http://arxiv.org/pdf/2405.13571v4)**

> **作者:** Wenbo Sui; Daniel Lichau; Josselin Lefèvre; Harold Phelippeau
>
> **备注:** For a published version refer to the Information Fusion, DOI. 10.1016/j.inffus.2025.103572
>
...
>
---
#### [replaced 008] Emergent Visual Grounding in Large Multimodal Models Without Grounding Supervision
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.08209v2](http://arxiv.org/pdf/2410.08209v2)**
...
>
---
#### [replaced 009] Mapping Farmed Landscapes from Remote Sensing
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.13993v2](http://arxiv.org/pdf/2506.13993v2)**
...
>
---
#### [replaced 015] Moto: Latent Motion Token as the Bridging Language for Learning Robot Manipulation from Videos
...
>
> **备注:** Manuscript under review in IEEE Transactions on Radiation and Plasma Medical Sciences
>
...
>
---
#### [replaced 019] InfoDet: A Dataset for Infographic Element Detection
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 020] On Large Multimodal Models as Open-World Image Classifiers
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.21851v2](http://arxiv.org/pdf/2503.21851v2)**
...
>
---
#### [replaced 023] HyCoVAD: A Hybrid SSL-LLM Model for Complex Video Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.22544v2](http://arxiv.org/pdf/2509.22544v2)**
...
>
> **备注:** The submission was made prematurely. The authors plan to resubmit under the supervision of the corresponding author
>
...
>
---
#### [replaced 024] CAP: Evaluation of Persuasive and Creative Image Generation
...
>
---
#### [replaced 025] The Mechanistic Emergence of Symbol Grounding in Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 029] TRACE: Your Diffusion Model is Secretly an Instance Edge Detector
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.07982v2](http://arxiv.org/pdf/2503.07982v2)**
...
>
---
#### [replaced 030] A Denoising Framework for Real-World Ultra-Low Dose Lung CT Images Based on an Image Purification Strategy
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.07492v2](http://arxiv.org/pdf/2510.07492v2)**
...
>
---
#### [replaced 031] MAPS: Masked Attribution-based Probing of Strategies- A computational framework to align human and model explanations
- **分类: q-bio.NC; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.12141v2](http://arxiv.org/pdf/2510.12141v2)**
...
>
---
#### [replaced 032] DevFD: Developmental Face Forgery Detection by Learning Shared and Orthogonal LoRA Subspaces
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.19230v2](http://arxiv.org/pdf/2509.19230v2)**
...
>
---
#### [replaced 038] One Stone with Two Birds: A Null-Text-Null Frequency-Aware Diffusion Models for Text-Guided Image Inpainting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.08273v4](http://arxiv.org/pdf/2510.08273v4)**
...
>
---
#### [replaced 039] NExT-OMNI: Towards Any-to-Any Omnimodal Foundation Models with Discrete Flow Matching
...
>
---
#### [replaced 040] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.07944v2](http://arxiv.org/pdf/2510.07944v2)**
...
>
---
#### [replaced 041] WoW: Towards a World omniscient World model Through Embodied Interaction
- **分类: cs.RO; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2509.22642v2](http://arxiv.org/pdf/2509.22642v2)**
...
>
---
#### [replaced 044] CymbaDiff: Structured Spatial Diffusion for Sketch-based 3D Semantic Urban Scene Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13245v2](http://arxiv.org/pdf/2510.13245v2)**
...
>
---
#### [replaced 047] SphereDrag: Spherical Geometry-Aware Panoramic Image Editing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.11863v2](http://arxiv.org/pdf/2506.11863v2)**
...
>
---
#### [replaced 048] TinyRS-R1: Compact Multimodal Language Model for Remote Sensing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.12099v2](http://arxiv.org/pdf/2505.12099v2)**

> **作者:** Aybora Koksal; A. Aydin Alatan
>
> **备注:** Accepted to IEEE Geoscience and Remote Sensing Letters (GRSL). Code, models, and the captions for datasets are available at https://github.com/aybora/TinyRS
>
...
>
---
#### [replaced 049] Gradient-Sign Masking for Task Vector Transport Across Pre-Trained Models
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.09658v2](http://arxiv.org/pdf/2510.09658v2)**
...
>
---
#### [replaced 052] OmnimatteZero: Fast Training-free Omnimatte with Pre-trained Video Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.18033v3](http://arxiv.org/pdf/2503.18033v3)**

> **作者:** Dvir Samuel; Matan Levy; Nir Darshan; Gal Chechik; Rami Ben-Ari
>
> **备注:** Accepted to SIGGRAPH ASIA 2025. Project Page: https://dvirsamuel.github.io/omnimattezero.github.io/
>
...
>
---
#### [replaced 055] Ctrl-VI: Controllable Video Synthesis via Variational Inference
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.07670v2](http://arxiv.org/pdf/2510.07670v2)**
...
>
---
#### [replaced 056] Spot the Fake: Large Multimodal Model-Based Synthetic Image Detection with Artifact Explanation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.14905v2](http://arxiv.org/pdf/2503.14905v2)**
...
>
---
#### [replaced 061] ChartGalaxy: A Dataset for Infographic Chart Understanding and Generation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 062] TTT3R: 3D Reconstruction as Test-Time Training
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.26645v3](http://arxiv.org/pdf/2509.26645v3)**
...
>
---
#### [replaced 063] Flows and Diffusions on the Neural Manifold
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.10623v2](http://arxiv.org/pdf/2507.10623v2)**

> **作者:** Daniel Saragih; Deyu Cao; Tejas Balaji
>
> **备注:** 43 pages, 11 figures, 14 tables
>
...
>
---
#### [replaced 064] Subspace-Boosted Model Merging
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.16506v2](http://arxiv.org/pdf/2506.16506v2)**

> **作者:** Ronald Skorobogat; Karsten Roth; Mariana-Iuliana Georgescu
>
> **备注:** 22 pages (main + supp)
>
...
>
---
#### [replaced 065] EdiVal-Agent: An Object-Centric Framework for Automated, Fine-Grained Evaluation of Multi-Turn Editing
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.13399v2](http://arxiv.org/pdf/2509.13399v2)**
...
>
---
#### [replaced 068] LinPrim: Linear Primitives for Differentiable Volumetric Rendering
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.16312v4](http://arxiv.org/pdf/2501.16312v4)**
...
>
---
#### [replaced 070] Impact of Regularization on Calibration and Robustness: from the Representation Space Perspective
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.03999v2](http://arxiv.org/pdf/2410.03999v2)**
...
>
---
#### [replaced 071] ForensicHub: A Unified Benchmark & Codebase for All-Domain Fake Image Detection and Localization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.11003v2](http://arxiv.org/pdf/2505.11003v2)**
...
>
---
#### [replaced 072] SOHES: Self-supervised Open-world Hierarchical Entity Segmentation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2404.12386v2](http://arxiv.org/pdf/2404.12386v2)**

> **作者:** Shengcao Cao; Jiuxiang Gu; Jason Kuen; Hao Tan; Ruiyi Zhang; Handong Zhao; Ani Nenkova; Liang-Yan Gui; Tong Sun; Yu-Xiong Wang
>
> **备注:** ICLR 2024
>
> **摘要:** Open-world entity segmentation, as an emerging computer vision task, aims at segmenting entities in images without being restricted by pre-defined classes, offering impressive generalization capabilities on unseen images and concepts. Despite its promise, existing entity segmentation methods like Segment Anything Model (SAM) rely heavily on costly expert annotators. This work presents Self-supervised Open-world Hierarchical Entity Segmentation (SOHES), a novel approach that eliminates the need for human annotations. SOHES operates in three phases: self-exploration, self-instruction, and self-correction. Given a pre-trained self-supervised representation, we produce abundant high-quality pseudo-labels through visual feature clustering. Then, we train a segmentation model on the pseudo-labels, and rectify the noises in pseudo-labels via a teacher-student mutual-learning procedure. Beyond segmenting entities, SOHES also captures their constituent parts, providing a hierarchical understanding of visual entities. Using raw images as the sole training data, our method achieves unprecedented performance in self-supervised open-world segmentation, marking a significant milestone towards high-quality open-world entity segmentation in the absence of human-annotated masks. Project page: https://SOHES-ICLR.github.io.
>
---
#### [replaced 073] Deep Few-view High-resolution Photon-counting CT at Halved Dose for Extremity Imaging
- **分类: physics.med-ph; cs.CV**

- **链接: [http://arxiv.org/pdf/2403.12331v2](http://arxiv.org/pdf/2403.12331v2)**

> **作者:** Mengzhou Li; Chuang Niu; Ge Wang; Maya R Amma; Krishna M Chapagain; Stefan Gabrielson; Andrew Li; Kevin Jonker; Niels de Ruiter; Jennifer A Clark; Phil Butler; Anthony Butler; Hengyong Yu
>
> **备注:** Accepted for publication in IEEE TMI, https://ieeexplore.ieee.org/document/11200164; IEEE Transactions on Medical Imaging
>
> **摘要:** X-ray photon-counting computed tomography (PCCT) for extremity allows multi-energy high-resolution (HR) imaging but its radiation dose can be further improved. Despite the great potential of deep learning techniques, their application in HR volumetric PCCT reconstruction has been challenged by the large memory burden, training data scarcity, and domain gap issues. In this paper, we propose a deep learning-based approach for PCCT image reconstruction at halved dose and doubled speed validated in a New Zealand clinical trial. Specifically, we design a patch-based volumetric refinement network to alleviate the GPU memory limitation, train network with synthetic data, and use model-based iterative refinement to bridge the gap between synthetic and clinical data. Our results in a reader study of 8 patients from the clinical trial demonstrate a great potential to cut the radiation dose to half that of the clinical PCCT standard without compromising image quality and diagnostic value.
>
---
#### [replaced 074] OmniGaze: Reward-inspired Generalizable Gaze Estimation In The Wild
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13660v2](http://arxiv.org/pdf/2510.13660v2)**
...
>
---
#### [replaced 075] UniEgoMotion: A Unified Model for Egocentric Motion Reconstruction, Forecasting, and Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.01126v2](http://arxiv.org/pdf/2508.01126v2)**
...
>
---
#### [replaced 076] Mitigating Hallucinations in Vision-Language Models through Image-Guided Head Suppression
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.16411v2](http://arxiv.org/pdf/2505.16411v2)**
...
>
---
#### [replaced 077] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23402v2](http://arxiv.org/pdf/2509.23402v2)**
...
>
---
#### [replaced 080] SVAG-Bench: A Large-Scale Benchmark for Multi-Instance Spatio-temporal Video Action Grounding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13016v2](http://arxiv.org/pdf/2510.13016v2)**
...
>
---
#### [replaced 081] Earth-Agent: Unlocking the Full Landscape of Earth Observation with Agents
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23141v2](http://arxiv.org/pdf/2509.23141v2)**
...
>
---
#### [replaced 082] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
- **分类: cs.CV; cs.GR; cs.LG; cs.RO**

- **链接: [http://arxiv.org/pdf/2510.12901v2](http://arxiv.org/pdf/2510.12901v2)**
...
>
---
#### [replaced 083] Backpropagation-Free Test-Time Adaptation via Probabilistic Gaussian Alignment
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.15568v4](http://arxiv.org/pdf/2508.15568v4)**
...
>
---
#### [replaced 086] CL-Splats: Continual Learning of Gaussian Splatting with Local Optimization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21117v2](http://arxiv.org/pdf/2506.21117v2)**
