...
#### [new 001] Gotta Grow Fast: Design and Benchmarking of a Tip Mount for High-Speed Vine Robots
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于软体机器人任务，解决传感器在生长型藤蔓机器人尖端稳定安装的问题。设计了三角滚轮尖端支架，降低内部阻力，提升生长稳定性与可重复性。**

- **链接: [https://arxiv.org/pdf/2606.06040](https://arxiv.org/pdf/2606.06040)**

> **作者:** Antonio Alvarez Valdivia; Robert Reeve; Ankush Dhawan; Ciera McFarland; Chad Council; Margaret McGuinness; Nathaniel Hanson
>
...
>
---
#### [new 014] Discrete-WAM: Unified Discrete Vision-Action Token Editing for World-Policy Learning
- **分类: cs.RO**

- **简介: 该论文提出Discrete-WAM，用于自动驾驶中的世界-策略学习。解决传统方法缺乏显式动态建模和因果推理的问题，通过离散视觉-动作令牌统一表示，实现因果推理与生成控制。**

- **链接: [https://arxiv.org/pdf/2606.05645](https://arxiv.org/pdf/2606.05645)**
...
>
---
#### [new 020] Breaking Time: A Fully Gaussian Framework for Distributed and Continuous-Time SLAM
- **分类: cs.RO**

- **简介: 该论文属于SLAM任务，解决连续时间轨迹估计问题。提出G-solver框架，结合高斯信念传播和高斯过程，实现分布式、异步传感器融合的精确轨迹估计。**

- **链接: [https://arxiv.org/pdf/2606.06250](https://arxiv.org/pdf/2606.06250)**

> **作者:** Davide Ceriola; Simone Ferrari; Luca Di Giammarino; Leonardo Brizi; Giorgio Grisetti
>
> **备注:** To be published in RA-L. Open-source implementation is released at this https URL
>
...
>
---
#### [new 023] Ask-to-Clarify: Resolving Instruction Ambiguity through Multi-turn Dialogue
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 024] RiskFlow: Fast and Faithful Safety-Critical Traffic Scenario Generation
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于安全关键交通场景生成任务，解决现有方法计算昂贵且生成不真实的问题。提出RiskFlow，通过动作空间运输实现高效、真实的多智能体场景生成。**

- **链接: [https://arxiv.org/pdf/2606.06423](https://arxiv.org/pdf/2606.06423)**
...
>
---
#### [new 025] FlowPRO: Reward-Free Reinforced Fine-Tuning of Flow-Matching VLAs via Proximalized Preference Optimization
- **分类: cs.RO**

- **简介: 该论文属于视觉-语言-动作模型的微调任务，旨在解决真实机器人部署中的策略训练问题。提出FlowPRO框架，通过无奖励的强化微调提升模型性能。**

- **链接: [https://arxiv.org/pdf/2606.05468](https://arxiv.org/pdf/2606.05468)**
...
>
---
#### [new 026] World-Language-Action Model for Unified World Modeling, Language Reasoning, and Action Synthesis
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出WLA模型，解决多任务和长周期机器人控制问题。通过融合世界建模、语言推理与动作生成，实现高效、准确的机器人操作。**

- **链接: [https://arxiv.org/pdf/2606.05979](https://arxiv.org/pdf/2606.05979)**
...
>
---
#### [new 038] TAGA: Terrain-aware Active Gaze Learning for Generalizable Agile Humanoid Locomotion
- **分类: cs.RO**

- **简介: 该论文属于仿人机器人运动控制任务，解决复杂地形下感知与运动的问题。提出TAGA框架，通过视觉和本体感觉融合，实现自适应注意力机制，提升运动泛化能力与稳定性。**

- **链接: [https://arxiv.org/pdf/2606.05880](https://arxiv.org/pdf/2606.05880)**
...
>
---
#### [new 040] RadiusFPS: Efficient Farthest Point Sampling on CPUs and GPUs via Spherical Voxel Pruning
...
>
---
#### [new 041] HANDOFF: Humanoid Agentic Task-Space Whole-Body Control via Distilled Complementary Teachers
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文提出HANDOFF控制器，解决人形机器人任务空间控制问题，通过多教师蒸馏实现高效、通用的全身控制，提升操作灵活性与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2606.06493](https://arxiv.org/pdf/2606.06493)**
...
>
---
#### [new 042] Uncertainty-Aware Adaptive Sensor Fusion for Autonomous Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 047] 3D Underwater Path Planning via Generative Flow Field Surrogates
- **分类: cs.RO; cs.LG**

- **简介: 该论文属于水下路径规划任务，解决AUV在复杂三维螺旋桨尾流中高效安全航行的问题。通过引入生成对抗网络替代高成本CFD模拟，提升路径规划效率与精度。**

- **链接: [https://arxiv.org/pdf/2606.06077](https://arxiv.org/pdf/2606.06077)**
...
>
---
#### [new 052] DexFuture: Hierarchical Future-State Visuomotor Targeting for Bimanual Dexterous Tool Use
- **分类: cs.RO**

- **简介: 该论文属于双臂精细操作任务，解决机器人在无先验状态情况下生成动态一致未来轨迹的问题。提出DexFuture系统，结合高层预测与低层控制，实现高效精准操作。**

- **链接: [https://arxiv.org/pdf/2606.05699](https://arxiv.org/pdf/2606.05699)**
...
>
---
#### [new 055] Let It Be Simple: One-Step Action Generation for Vision-Language-Action Models
...
>
---
#### [new 056] T-FunS3D: Task-Driven Hierarchical Open-Vocabulary 3D Functionality Segmentation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 059] Flash-WAM: Modality-Aware Distillation for World Action Models
...
>
---
#### [new 060] What Objects Enable, Not What They Are: Functional Latent Spaces for Affordance Reasoning
...
>
---
#### [new 061] Synthetic Data Generation and Vision-based Wrinkle and Keypoint Detection for Bimanual Cloth Manipulation
- **分类: cs.CV; cs.RO**
...
#### [replaced 001] Beyond Imitation: Reinforcement Learning-Based Sim-Real Co-Training for VLA Models
- **分类: cs.RO**

- **简介: 该论文属于视觉-语言-动作（VLA）模型的训练任务，旨在解决真实世界部署效果有限的问题。通过强化学习的模拟-现实协同训练框架，提升模型在真实环境中的表现和泛化能力。**
...
>
---
#### [replaced 002] ContactExplorer: Contact Coverage-Guided Exploration for General-Purpose Dexterous Manipulation
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出ContactExplorer，用于解决灵活操作任务中的探索问题。通过接触模式引导探索，提升样本效率和成功率。**
...
>
---
#### [replaced 005] Test-Time Training for Visual Foresight Vision-Language-Action Models
...
>
---
#### [replaced 006] Safe and Energy-Aware Multi-Robot Density Control via PDE-Constrained Optimization for Long-Duration Autonomy
- **分类: eess.SY; cs.RO**
...
>
---
#### [replaced 007] HERO: Learning Humanoid End-Effector Control for Visual Whole-Body Open-Vocabulary Object Grasping
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 008] OSCAR: Omni-Embodiment Action-Conditioned World Model for Robotics
- **分类: cs.RO**

- **简介: 该论文提出OSCAR，用于机器人策略评估的视频世界模型，解决真实机器人评估中的泛化与动作跟随问题。通过标准化数据管道和2D骨骼渲染提升模型性能。**
...
>
---
#### [replaced 009] Worth Remembering: Surprise-Gated Robot Episodic Memory
- **分类: cs.RO**

- **简介: 该论文研究机器人记忆系统，旨在解决如何选择性存储高价值经验的问题。通过引入贝叶斯惊喜作为记忆门控机制，提升机器人问答与事件分割任务性能。**

- **链接: [https://arxiv.org/pdf/2606.03787](https://arxiv.org/pdf/2606.03787)**
...
>
---
#### [replaced 010] SEDualVLN: A Spatially-Enhanced Dual-System for Vision-Language Navigation
- **分类: cs.RO**

- **简介: 该论文属于视觉语言导航任务，旨在解决传统方法在长距离导航和动态推理上的不足。提出SEDualVLN框架，结合空间增强的双系统提升导航性能。**
...
>
---
#### [replaced 013] VISTA: Vision-Grounded and Physics-Validated Adaptation of UMI data for VLA Training
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出VISTA框架，解决UMI数据与VLA模型之间的视觉与物理不匹配问题，通过数据增强、物理验证和联合训练提升机器人控制性能。**
...
>
---
#### [replaced 014] EgoHumanoid: Unlocking In-the-Wild Loco-Manipulation with Robot-Free Egocentric Demonstration
- **分类: cs.RO**

- **简介: 该论文属于人形机器人操控任务，解决真实环境中人形机器人操作难题。通过融合人类视角数据与少量机器人数据，提升机器人在复杂环境中的操作能力。**

- **链接: [https://arxiv.org/pdf/2602.10106](https://arxiv.org/pdf/2602.10106)**
...
>
---
#### [replaced 015] StereoPolicy: Improving Robotic Manipulation Policies via Stereo Perception
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 016] Learning Predictive Visuomotor Coordination
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 017] AgenticRL: Self-Refining Agentic Reinforcement Learning for Vision-Conditioned UAV Navigation
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出AgenticRL框架，用于无人机视觉导航任务，解决传统强化学习依赖人工设计奖励和调优的问题，通过自优化机制提升策略性能与真实场景适应性。**

- **链接: [https://arxiv.org/pdf/2606.03963](https://arxiv.org/pdf/2606.03963)**
...
>
---
#### [replaced 020] PHUMA: Physically Reliable Humanoid Locomotion Dataset
- **分类: cs.RO**

- **简介: 该论文提出PHUMA数据集，解决人形机器人运动模仿中的物理可靠性问题。通过物理感知的筛选与约束重定向，整合动作捕捉与网络视频，提升训练效果与真实迁移能力。**

- **链接: [https://arxiv.org/pdf/2510.26236](https://arxiv.org/pdf/2510.26236)**

> **作者:** Kyungmin Lee; Sibeen Kim; Youngdo Lee; Minho Park; Hyunseung Kim; Dongyoon Hwang; Donghu Kim; Hojoon Lee; Jaegul Choo
>
...
- **简介: 该论文属于机器人安全控制任务，旨在解决不确定动态下的安全交互问题。通过自适应阻抗控制与非光滑控制屏障函数，确保关节状态安全并实现鲁棒跟踪。**
