...
- **简介: 该论文提出一种结合GAN和YOLOv5的混合模型，用于自动车牌识别任务。旨在解决车牌模糊、检测精度低的问题，通过去模糊预处理和高效检测算法提升识别准确率与实时性。**
...
- **简介: 该论文属于工业异常合成任务，旨在解决现有方法在纹理细节和像素级异常生成上的不足。提出STAGE方法，通过分级扩散与显式掩码对齐策略，提升异常区域的精细度与背景一致性，实现更优的异常合成效果。**
...
- **简介: 该论文属于医学图像配准任务，解决术中2D/3D图像对齐问题。提出基于球面相似性学习和微分Levenberg-Marquardt优化的方法，提升配准精度与鲁棒性。**
...
- **链接: [http://arxiv.org/pdf/2509.06387v1](http://arxiv.org/pdf/2509.06387v1)**
...
- **简介: 该论文提出BLaVe-CoT框架，解决盲人和低视力用户在视觉问答任务中因图像模糊或问题模糊导致的答案不一致问题。通过生成多候选答案并评估其空间一致性，提升系统对模糊输入的鲁棒性。属于视觉问答任务。**
...
- **简介: 该论文提出Zo3T框架，解决零样本轨迹引导的图像到视频生成问题。通过3D感知投影、动态LoRA适配和引导场修正，提升生成视频的3D真实感与运动准确性。**
...
- **简介: 该论文提出MeshMetrics，一种基于网格的框架，用于更精确地计算图像分割的距离度量，解决传统方法因离散化导致的精度问题，提升评估可靠性。**
...
- **链接: [http://arxiv.org/pdf/2509.06142v1](http://arxiv.org/pdf/2509.06142v1)**
...
- **简介: 该论文提出VALA方法，解决3D高斯泼溅中开放词汇分割的语言特征一致性问题。通过可见性感知聚合和多视角特征融合，提升分割效果与视图一致性。属于3D场景理解任务。**
...
- **链接: [http://arxiv.org/pdf/2509.06830v1](http://arxiv.org/pdf/2509.06830v1)**
...
- **简介: 该论文属于人脸识别反欺骗（FAS）任务，旨在提升跨域性能。提出MVP-FAS框架，通过多视角槽注意力和多文本补丁对齐模块，利用多样化的文本增强特征表达，提升模型泛化能力。**
...
- **简介: 该论文提出BranchGRPO方法，用于改进扩散模型中的图像和视频生成对齐任务。针对计算成本高、训练不稳定等问题，通过分支采样、树状优势估计和路径剪枝策略，显著降低计算消耗并提升对齐效果。**
...
- **链接: [http://arxiv.org/pdf/2509.05809v1](http://arxiv.org/pdf/2509.05809v1)**
...
- **简介: 该论文提出一种结合神经网络与数学优化的高精度断层图像重建方法，用于提升纳米和微米断层扫描中均匀材料样品的边缘清晰度和均匀性，解决传统算法存在的模糊和伪影问题。**
...
- **简介: 该论文提出BTCChat，用于双时相遥感图像变化描述任务。针对现有方法未能有效建模时间关联与空间语义变化的问题，设计了变化提取模块和提示增强机制，提升模型对时空特征的理解能力，实现更准确的变化描述与问答。**
...
- **简介: 论文评估DINOv3在医疗视觉任务中的表现，探索其无需领域预训练的通用性。通过多任务基准测试，发现其性能优异但存在领域特异性限制，为医疗视觉模型提供新基线。**
...
- **简介: 该论文属于多类分类任务，解决洋葱病虫害识别中类别不平衡和样本少的问题。提出基于注意力机制和数据增强的深度学习模型，实现96.90%准确率和0.96 F1分数，优于现有方法。**
...
- **简介: 该论文提出OOTSM框架，解决场景图预测中的长期鲁棒性问题。通过分离视觉与语言模型，利用大语言模型预测未来场景图，提升短期和长期预测性能，实现更有效的场景图预见任务。**
...
- **简介: 该论文研究FairCLIP模型的可复现性，旨在提升CLIP在视觉-语言学习中的公平性。作者发现原实现与描述不符，提出A-FairCLIP和FairCLIP+进行改进，并验证其在零样本青光眼分类任务中未提升性能与公平性。**
...
- **简介: 论文提出RARL方法，解决增量开放集识别（IOSR）问题，使模型能持续识别新出现的未知类别。通过构造角空间对齐未知表示，并采用VII训练策略和分层校正策略，提升分类性能，实验证明其在CIFAR100和TinyImageNet上效果优越。**
...
- **简介: 论文提出Raw2Event系统，将低成本的原始帧相机实时转换为事件相机。旨在解决事件相机成本高、分辨率低等问题，通过直接访问原始Bayer数据，提升动态范围和分辨率，并支持参数调节与嵌入式部署。**
...
- **简介: 该论文属于视频伪装目标检测任务，旨在解决SAM模型冻结和MLLM前景背景分离差的问题。提出Phantom-Insight方法，融合多模态LLM与动态提示，增强边缘分离与泛化能力，实验证明其性能优越。**
...
- **简介: 该论文提出一种结合结构保持神经网络与机器学习的方法，用于预测细胞迁移轨迹及分裂事件，解决细胞群体行为建模问题。**
...
- **简介: 该论文提出VILOD工具，用于改进目标检测的标注流程。通过可视化分析与人机协作，解决数据标注耗时昂贵、主动学习策略不透明的问题，提升标注效率与模型性能。**

- **链接: [http://arxiv.org/pdf/2509.05317v1](http://arxiv.org/pdf/2509.05317v1)**
...
>
---
#### [new 084] Spatial Reasoning with Vision-Language Models in Ego-Centric Multi-View Scenes
- **分类: cs.CV**

- **简介: 该论文提出Ego3D-Bench基准和Ego3D-VLM框架，用于评估和提升VLM在多视角场景中的空间推理能力，解决现有模型在真实环境中空间理解不足的问题。**

- **链接: [http://arxiv.org/pdf/2509.06266v1](http://arxiv.org/pdf/2509.06266v1)**

> **作者:** Mohsen Gholami; Ahmad Rezaei; Zhou Weimin; Yong Zhang; Mohammad Akbari
>
> **摘要:** Understanding 3D spatial relationships remains a major limitation of current Vision-Language Models (VLMs). Prior work has addressed this issue by creating spatial question-answering (QA) datasets based on single images or indoor videos. However, real-world embodied AI agents such as robots and self-driving cars typically rely on ego-centric, multi-view observations. To this end, we introduce Ego3D-Bench, a new benchmark designed to evaluate the spatial reasoning abilities of VLMs using ego-centric, multi-view outdoor data. Ego3D-Bench comprises over 8,600 QA pairs, created with significant involvement from human annotators to ensure quality and diversity. We benchmark 16 SOTA VLMs, including GPT-4o, Gemini1.5-Pro, InternVL3, and Qwen2.5-VL. Our results reveal a notable performance gap between human level scores and VLM performance, highlighting that current VLMs still fall short of human level spatial understanding. To bridge this gap, we propose Ego3D-VLM, a post-training framework that enhances 3D spatial reasoning of VLMs. Ego3D-VLM generates cognitive map based on estimated global 3D coordinates, resulting in 12% average improvement on multi-choice QA and 56% average improvement on absolute distance estimation. Ego3D-VLM is modular and can be integrated with any existing VLM. Together, Ego3D-Bench and Ego3D-VLM offer valuable tools for advancing toward human level spatial understanding in real-world, multi-view environments.
>
---
#### [new 085] MRD-LiNet: A Novel Lightweight Hybrid CNN with Gradient-Guided Unlearning for Improved Drought Stress Identification
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 论文提出轻量级混合CNN模型MRD-LiNet，用于精准农业中的干旱胁迫识别。针对传统模型参数多、计算成本高的问题，设计轻量化架构并引入梯度引导的遗忘机制，提升模型适应性与效率。**

- **链接: [http://arxiv.org/pdf/2509.06367v1](http://arxiv.org/pdf/2509.06367v1)**
...
>
---
#### [new 086] Quaternion Approximation Networks for Enhanced Image Classification and Oriented Object Detection
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 090] Text4Seg++: Advancing Image Segmentation via Generative Language Modeling
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，旨在将分割问题转化为文本生成。提出Text4Seg++模型，通过语义描述符和结构化标记提升分割效率与精度，无需额外解码器，在多种数据集上优于现有方法。**

- **链接: [http://arxiv.org/pdf/2509.06321v1](http://arxiv.org/pdf/2509.06321v1)**
...
>
---
#### [new 098] Cross-Modal Enhancement and Benchmark for UAV-based Open-Vocabulary Object Detection
- **分类: cs.CV**

- **简介: 该论文属于无人机开放词汇目标检测任务，旨在解决现有数据与无人机图像间的领域差异问题。提出UAV-Label引擎、构建新数据集，并设计CAGE模块改进YOLO-World-v2模型，提升检测性能。**

- **链接: [http://arxiv.org/pdf/2509.06011v1](http://arxiv.org/pdf/2509.06011v1)**
...
>
---
#### [new 106] Dual Interaction Network with Cross-Image Attention for Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决因图像噪声、模糊等问题导致的分割不准确问题。提出双交互融合模块（DIFM），利用跨图像注意力机制融合原始与增强图像信息，并引入多尺度边界损失提升分割精度。**

- **链接: [http://arxiv.org/pdf/2509.05953v1](http://arxiv.org/pdf/2509.05953v1)**
...
>
---
#### [new 112] Challenges in Deep Learning-Based Small Organ Segmentation: A Benchmarking Perspective for Medical Research with Limited Datasets
- **分类: cs.CV; cs.AI**

- **简介: 论文研究小器官分割中的深度学习挑战，针对医学图像数据稀缺问题，评估多种模型在有限数据下的表现，揭示模型性能受数据划分影响大，质疑传统基准测试的有效性。属于医学图像分割任务。**

- **链接: [http://arxiv.org/pdf/2509.05892v1](http://arxiv.org/pdf/2509.05892v1)**
...
>
---
#### [new 115] Micro-Expression Recognition via Fine-Grained Dynamic Perception
- **分类: cs.CV**

- **简介: 该论文属于微表情识别任务，旨在解决微表情短暂、微妙和动态带来的识别难题。提出细粒度动态感知框架FDP，通过时序特征排序与动态图像重建提升识别性能，显著优于现有方法。**

- **链接: [http://arxiv.org/pdf/2509.06015v1](http://arxiv.org/pdf/2509.06015v1)**
...
>
---
#### [new 121] Detection of trade in products derived from threatened species using machine learning and a smartphone
- **分类: cs.CV; cs.LG**

- **简介: 论文提出一种基于机器学习的智能手机应用，用于自动识别非法野生动物制品图像。任务是检测数字市场中的濒危物种贸易，解决传统方法效率低的问题。研究开发了高准确率模型，并实现手机端实时识别，辅助执法监管。**

- **链接: [http://arxiv.org/pdf/2509.06585v1](http://arxiv.org/pdf/2509.06585v1)**
...
>
---
#### [new 122] Application of discrete Ricci curvature in pruning randomly wired neural networks: A case study with chest x-ray classification of COVID-19
- **分类: cs.CV; cs.LG; cs.SI; physics.comp-ph**

- **简介: 论文研究利用离散Ricci曲率（FRC、ORC）和边介数（EBC）对随机连接神经网络进行剪枝，以压缩网络结构并保持性能。任务是探索不同网络拓扑剪枝方法的有效性，解决如何在减少复杂度的同时维持模型准确率的问题。**

- **链接: [http://arxiv.org/pdf/2509.05322v1](http://arxiv.org/pdf/2509.05322v1)**
...
>
---
#### [new 130] Compression Beyond Pixels: Semantic Compression with Multimodal Foundation Models
- **分类: cs.CV; cs.IT; math.IT**

- **简介: 论文提出一种基于CLIP模型的语义压缩方法，旨在在极低比特率下保留图像语义信息，而非像素重建。该方法适用于跨任务和数据分布的鲁棒语义压缩，解决传统压缩方法在语义保持上的不足。**

- **链接: [http://arxiv.org/pdf/2509.05925v1](http://arxiv.org/pdf/2509.05925v1)**
...
>
---
#### [new 132] Quantitative Currency Evaluation in Low-Resource Settings through Pattern Analysis to Assist Visually Impaired Users
- **分类: cs.CV**

- **简介: 该论文提出一种面向低资源环境的货币评估框架，解决视障用户对纸币真伪与损毁程度的识别问题。通过轻量CNN分类、UCDI损伤指数和模板匹配检测伪造，实现高效、实时的设备端推理。**

- **链接: [http://arxiv.org/pdf/2509.06331v1](http://arxiv.org/pdf/2509.06331v1)**

> **作者:** Md Sultanul Islam Ovi; Mainul Hossain; Md Badsha Biswas
>
> **备注:** 10 Pages, 9 Figures, 5 Tables
>
> **摘要:** Currency recognition systems often overlook usability and authenticity assessment, especially in low-resource environments where visually impaired users and offline validation are common. While existing methods focus on denomination classification, they typically ignore physical degradation and forgery, limiting their applicability in real-world conditions. This paper presents a unified framework for currency evaluation that integrates three modules: denomination classification using lightweight CNN models, damage quantification through a novel Unified Currency Damage Index (UCDI), and counterfeit detection using feature-based template matching. The dataset consists of over 82,000 annotated images spanning clean, damaged, and counterfeit notes. Our Custom_CNN model achieves high classification performance with low parameter count. The UCDI metric provides a continuous usability score based on binary mask loss, chromatic distortion, and structural feature loss. The counterfeit detection module demonstrates reliable identification of forged notes across varied imaging conditions. The framework supports real-time, on-device inference and addresses key deployment challenges in constrained environments. Results show that accurate, interpretable, and compact solutions can support inclusive currency evaluation in practical settings.
>
---
#### [new 133] UNO: Unifying One-stage Video Scene Graph Generation via Object-Centric Visual Representation Learning
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出UNO，一种统一的单阶段视频场景图生成框架，解决粗粒度和细粒度视频场景图生成任务。通过对象中心表示和时序一致性学习，实现跨粒度的高效建模与预测。**

- **链接: [http://arxiv.org/pdf/2509.06165v1](http://arxiv.org/pdf/2509.06165v1)**
...
>
---
#### [new 137] LiDAR-BIND-T: Improving SLAM with Temporally Consistent Cross-Modal LiDAR Reconstruction
...
>
---
#### [new 149] Analysis of Blood Report Images Using General Purpose Vision-Language Models
- **分类: cs.CV**

- **简介: 论文研究通用视觉-语言模型在血检报告图像分析中的应用，旨在解决个人解读困难的问题。通过比较三种VLM模型在100张血检图像上的表现，评估其临床问答能力，为开发AI辅助医疗工具奠定基础。**

- **链接: [http://arxiv.org/pdf/2509.06033v1](http://arxiv.org/pdf/2509.06033v1)**
...
>
---
#### [new 152] Depth-Aware Super-Resolution via Distance-Adaptive Variational Formulation
- **分类: cs.CV**

- **简介: 该论文属于图像超分辨率任务，解决传统方法忽略深度变化导致的退化问题。提出基于距离自适应变分框架的深度感知超分辨率方法，通过几何信息引导重建，实现更优性能。**

- **链接: [http://arxiv.org/pdf/2509.05746v1](http://arxiv.org/pdf/2509.05746v1)**
...
>
---
#### [new 157] Systematic Integration of Attention Modules into CNNs for Accurate and Generalizable Medical Image Diagnosis
- **分类: cs.CV**

- **简介: 论文提出将注意力机制系统集成到五种CNN架构中，以提升医学图像诊断的准确性与泛化性。通过在不同数据集上的实验验证，证明注意力增强的CNN优于基线模型，尤其在EfficientNetB5上效果最佳。任务为医学图像分类，解决传统CNN特征提取不足的问题。**

- **链接: [http://arxiv.org/pdf/2509.05343v1](http://arxiv.org/pdf/2509.05343v1)**
...
>
---
#### [new 158] AI-based response assessment and prediction in longitudinal imaging for brain metastases treated with stereotactic radiosurgery
- **分类: cs.CV**

- **简介: 该论文提出基于AI的自动化流程，分析脑转移瘤患者长期MRI影像数据，识别生长轨迹并预测治疗反应。任务为纵向影像响应评估与预测，解决人工分析效率低、缺乏量化的问题，通过聚类与机器学习实现高精度预测。**

- **链接: [http://arxiv.org/pdf/2509.06396v1](http://arxiv.org/pdf/2509.06396v1)**
...
>
---
#### [new 166] Stereovision Image Processing for Planetary Navigation Maps with Semi-Global Matching and Superpixel Segmentation
...
>
---
#### [new 171] O$^3$Afford: One-Shot 3D Object-to-Object Affordance Grounding for Generalizable Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 172] eKalibr-Inertial: Continuous-Time Spatiotemporal Calibration for Event-Based Visual-Inertial Systems
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 173] Tackling Device Data Distribution Real-time Shift via Prototype-based Parameter Editing
- **分类: cs.LG; cs.CV; cs.DC; cs.IR**

- **简介: 论文提出Persona方法，解决设备端实时数据分布变化导致模型泛化性能下降的问题。通过云端神经适配器生成参数编辑矩阵，实现无需再训练的模型自适应，提升轻量模型在多任务中的泛化能力。**

- **链接: [http://arxiv.org/pdf/2509.06552v1](http://arxiv.org/pdf/2509.06552v1)**
...
>
---
#### [new 175] LocoMamba: Vision-Driven Locomotion via End-to-End Deep Reinforcement Learning with Mamba
...
>
---
#### [new 178] Multimodal Reasoning for Science: Technical Report and 1st Place Solution to the ICML 2025 SeePhys Challenge
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 179] From Skin to Skeleton: Towards Biomechanically Accurate 3D Digital Humans
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出SKEL模型，改进SMPL人体模型的骨骼结构，使其更符合真实人体生物力学。通过优化骨骼参数并学习回归器，实现更准确的关节位置和骨骼旋转，提升人体建模在生物力学领域的应用。**

- **链接: [http://arxiv.org/pdf/2509.06607v1](http://arxiv.org/pdf/2509.06607v1)**
...
>
---
#### [new 185] Impact of Labeling Inaccuracy and Image Noise on Tooth Segmentation in Panoramic Radiographs using Federated, Centralized and Local Learning
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 论文研究联邦学习（FL）在牙科全景片牙齿分割中的表现，对比集中式和本地学习。探讨标签不准确和图像噪声对模型的影响，验证FL在隐私保护与性能上的优势。**

- **链接: [http://arxiv.org/pdf/2509.06553v1](http://arxiv.org/pdf/2509.06553v1)**
...
>
---
#### [new 186] Imagining Alternatives: Towards High-Resolution 3D Counterfactual Medical Image Generation via Language Guidance
...
>
---
#### [new 191] FASL-Seg: Anatomy and Tool Segmentation of Surgical Scenes
- **分类: eess.IV; cs.AI; cs.CV; I.4.6; I.4.8; J.3**

- **简介: 该论文提出FASL-Seg模型，用于手术场景的解剖结构与工具分割。针对现有模型在解剖对象识别和特征分辨率平衡上的不足，设计双流结构实现多尺度特征提取，提升分割精度，在多个数据集上优于SOTA方法。**

- **链接: [http://arxiv.org/pdf/2509.06159v1](http://arxiv.org/pdf/2509.06159v1)**
...
>
---
#### [new 192] Learning in ImaginationLand: Omnidirectional Policies through 3D Generative Models (OP-Gen)
...
>
---
#### [new 193] A Synthetic-to-Real Dehazing Method based on Domain Unification
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于图像去雾任务，旨在解决深度学习方法在真实场景中因领域差异导致的性能下降问题。提出了一种基于领域统一的合成到真实去雾方法，通过统一合成与真实域的关系，提升模型在真实图像上的去雾效果。**

- **链接: [http://arxiv.org/pdf/2509.05374v1](http://arxiv.org/pdf/2509.05374v1)**
...
>
---
#### [replaced 002] Hyper Diffusion Avatars: Dynamic Human Avatar Generation using Network Weight Space Diffusion
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.04145v2](http://arxiv.org/pdf/2509.04145v2)**

> **作者:** Dongliang Cao; Guoxing Sun; Marc Habermann; Florian Bernard
>
> **备注:** Project webpage: https://vcai.mpi-inf.mpg.de/projects/HDA/
>
...
>
---
#### [replaced 003] Bridging the Sim2Real Gap: Vision Encoder Pre-Training for Visuomotor Policy Transfer
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 009] QuadKAN: KAN-Enhanced Quadruped Motion Control via End-to-End Reinforcement Learning
- **分类: cs.RO; cs.AI; cs.CV; cs.SY; eess.IV; eess.SY**
...
>
---
#### [replaced 010] Osprey: Pixel Understanding with Visual Instruction Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2312.10032v4](http://arxiv.org/pdf/2312.10032v4)**
...
>
> **摘要:** Multimodal large language models (MLLMs) have recently achieved impressive general-purpose vision-language capabilities through visual instruction tuning. However, current MLLMs primarily focus on image-level or box-level understanding, falling short in achieving fine-grained vision-language alignment at pixel level. Besides, the lack of mask-based instruction data limits their advancements. In this paper, we propose Osprey, a mask-text instruction tuning approach, to extend MLLMs by incorporating fine-grained mask regions into language instruction, aiming at achieving pixel-wise visual understanding. To achieve this goal, we first meticulously curate a mask-based region-text dataset with 724K samples, and then design a vision-language model by injecting pixel-level representation into LLM. Specifically, Osprey adopts a convolutional CLIP backbone as the vision encoder and employs a mask-aware visual extractor to extract precise visual mask features from high resolution input. Experimental results demonstrate Osprey's superiority in various region understanding tasks, showcasing its new capability for pixel-level instruction tuning. In particular, Osprey can be integrated with Segment Anything Model (SAM) seamlessly to obtain multi-granularity semantics. The source code, dataset and demo can be found at https://github.com/CircleRadon/Osprey.
>
---
#### [replaced 011] AURAD: Anatomy-Pathology Unified Radiology Synthesis with Progressive Representations
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.04819v2](http://arxiv.org/pdf/2509.04819v2)**
...
>
---
#### [replaced 013] Flexible Coded Distributed Convolution Computing for Enhanced Straggler Resilience and Numerical Stability in Distributed CNNs
- **分类: cs.DC; cs.AI; cs.CV; cs.IT; cs.LG; math.IT**

- **链接: [http://arxiv.org/pdf/2411.01579v3](http://arxiv.org/pdf/2411.01579v3)**
...
>
---
#### [replaced 014] The GOOSE Dataset for Perception in Unstructured Environments
...
>
---
#### [replaced 019] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.11854v2](http://arxiv.org/pdf/2508.11854v2)**
...
>
---
#### [replaced 025] Leveraging Out-of-Distribution Unlabeled Images: Semi-Supervised Semantic Segmentation with an Open-Vocabulary Model
- **分类: cs.CV; cs.AI; I.4.6**

- **链接: [http://arxiv.org/pdf/2507.03302v2](http://arxiv.org/pdf/2507.03302v2)**
...
>
---
#### [replaced 026] DEXOP: A Device for Robotic Transfer of Dexterous Human Manipulation
...
>
---
#### [replaced 027] Parameter-Efficient Adaptation of mPLUG-Owl2 via Pixel-Level Visual Prompts for NR-IQA
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.03494v2](http://arxiv.org/pdf/2509.03494v2)**
...
>
---
#### [replaced 030] REVEAL -- Reasoning and Evaluation of Visual Evidence through Aligned Language
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12543v2](http://arxiv.org/pdf/2508.12543v2)**

> **作者:** Ipsita Praharaj; Yukta Butala; Badrikanath Praharaj; Yash Butala
>
...
>
---
#### [replaced 031] Efficient Alignment of Unconditioned Action Prior for Language-conditioned Pick and Place in Clutter
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 032] Hessian-Based Lightweight Neural Network HessNet for State-of-the-Art Brain Vessel Segmentation on a Minimal Training Dataset
- **分类: eess.IV; cs.CV; I.4.6; I.5.4; J.3**

- **链接: [http://arxiv.org/pdf/2508.15660v3](http://arxiv.org/pdf/2508.15660v3)**
...
>
---
#### [replaced 033] In-Context Reverse Classification Accuracy: Efficient Estimation of Segmentation Quality without Ground-Truth
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.04522v2](http://arxiv.org/pdf/2503.04522v2)**

> **作者:** Matias Cosarinsky; Ramiro Billot; Lucas Mansilla; Gabriel Jimenez; Nicolas Gaggión; Guanghui Fu; Enzo Ferrante
>
...
>
---
#### [replaced 036] ILeSiA: Interactive Learning of Robot Situational Awareness from Camera Input
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [replaced 037] DeepShade: Enable Shade Simulation by Text-conditioned Image Generation
- **分类: cs.CV; cs.CY; 68T45, 68U10, 62H35; I.2.10; I.4.8; I.5.1**

- **链接: [http://arxiv.org/pdf/2507.12103v4](http://arxiv.org/pdf/2507.12103v4)**
...
>
---
#### [replaced 038] Kwai Keye-VL 1.5 Technical Report
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.01563v3](http://arxiv.org/pdf/2509.01563v3)**

> **作者:** Biao Yang; Bin Wen; Boyang Ding; Changyi Liu; Chenglong Chu; Chengru Song; Chongling Rao; Chuan Yi; Da Li; Dunju Zang; Fan Yang; Guorui Zhou; Guowang Zhang; Han Shen; Hao Peng; Haojie Ding; Hao Wang; Haonan Fan; Hengrui Ju; Jiaming Huang; Jiangxia Cao; Jiankang Chen; Jingyun Hua; Kaibing Chen; Kaiyu Jiang; Kaiyu Tang; Kun Gai; Muhao Wei; Qiang Wang; Ruitao Wang; Sen Na; Shengnan Zhang; Siyang Mao; Sui Huang; Tianke Zhang; Tingting Gao; Wei Chen; Wei Yuan; Xiangyu Wu; Xiao Hu; Xingyu Lu; Yi-Fan Zhang; Yiping Yang; Yulong Chen; Zeyi Lu; Zhenhua Wu; Zhixin Ling; Zhuoran Yang; Ziming Li; Di Xu; Haixuan Gao; Hang Li; Jing Wang; Lejian Ren; Qigen Hu; Qianqian Wang; Shiyao Wang; Xinchen Luo; Yan Li; Yuhang Hu; Zixing Zhang
>
...
>
---
#### [replaced 043] What Can We Learn from Harry Potter? An Exploratory Study of Visual Representation Learning from Atypical Videos
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.21770v2](http://arxiv.org/pdf/2508.21770v2)**
...
>
---
#### [replaced 044] Robust and Label-Efficient Deep Waste Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.18799v2](http://arxiv.org/pdf/2508.18799v2)**

> **作者:** Hassan Abid; Khan Muhammad; Muhammad Haris Khan
>
> **备注:** Accepted at BMVC 2025
>
> **摘要:** Effective waste sorting is critical for sustainable recycling, yet AI research in this domain continues to lag behind commercial systems due to limited datasets and reliance on legacy object detectors. In this work, we advance AI-driven waste detection by establishing strong baselines and introducing an ensemble-based semi-supervised learning framework. We first benchmark state-of-the-art Open-Vocabulary Object Detection (OVOD) models on the real-world ZeroWaste dataset, demonstrating that while class-only prompts perform poorly, LLM-optimized prompts significantly enhance zero-shot accuracy. Next, to address domain-specific limitations, we fine-tune modern transformer-based detectors, achieving a new baseline of 51.6 mAP. We then propose a soft pseudo-labeling strategy that fuses ensemble predictions using spatial and consensus-aware weighting, enabling robust semi-supervised training. Applied to the unlabeled ZeroWaste-s subset, our pseudo-annotations achieve performance gains that surpass fully supervised training, underscoring the effectiveness of scalable annotation pipelines. Our work contributes to the research community by establishing rigorous baselines, introducing a robust ensemble-based pseudo-labeling pipeline, generating high-quality annotations for the unlabeled ZeroWaste-s subset, and systematically evaluating OVOD models under real-world waste sorting conditions. Our code is available at: https://github.com/h-abid97/robust-waste-detection.
>
---
#### [replaced 045] Visual Structures Helps Visual Reasoning: Addressing the Binding Problem in VLMs
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.22146v3](http://arxiv.org/pdf/2506.22146v3)**
...
>
---
#### [replaced 048] SUDER: Self-Improving Unified Large Multimodal Models for Understanding and Generation with Dual Self-Rewards
...
>
---
#### [replaced 049] Physical Autoregressive Model for Robotic Manipulation without Action Pretraining
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09822v4](http://arxiv.org/pdf/2508.09822v4)**
...
>
---
#### [replaced 050] Transforming Hyperspectral Images Into Chemical Maps: A Novel End-to-End Deep Learning Approach
- **分类: cs.CV; cs.LG; q-bio.QM**

- **链接: [http://arxiv.org/pdf/2504.14131v4](http://arxiv.org/pdf/2504.14131v4)**
...
>
---
#### [replaced 051] LMM4Edit: Benchmarking and Evaluating Multimodal Image Editing with LMMs
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.16193v2](http://arxiv.org/pdf/2507.16193v2)**
...
>
---
#### [replaced 052] ElectroVizQA: How well do Multi-modal LLMs perform in Electronics Visual Question Answering?
...
>
---
#### [replaced 053] Making Rotation Averaging Fast and Robust with Anisotropic Coordinate Descent
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.01940v2](http://arxiv.org/pdf/2506.01940v2)**
...
>
---
#### [replaced 054] MM-Spatial: Exploring 3D Spatial Understanding in Multimodal LLMs
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 055] ESVO2: Direct Visual-Inertial Odometry with Stereo Event Cameras
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 062] LanternNet: A Hub-and-Spoke System to Seek and Suppress Spotted Lanternfly Populations
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 063] GoalFlow: Goal-Driven Flow Matching for Multimodal Trajectories Generation in End-to-End Autonomous Driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.05689v5](http://arxiv.org/pdf/2503.05689v5)**
...
>
---
#### [replaced 064] Exploring the Landscape of Non-Equilibrium Memories with Neural Cellular Automata
- **分类: cond-mat.stat-mech; cs.CV; cs.LG; nlin.CG**

- **链接: [http://arxiv.org/pdf/2508.15726v2](http://arxiv.org/pdf/2508.15726v2)**

> **作者:** Ehsan Pajouheshgar; Aditya Bhardwaj; Nathaniel Selub; Ethan Lake
>
> **备注:** 4+9 pages; v2: expanded discussion, typos fixed
>
...
>
---
#### [replaced 067] Learn2Reg 2024: New Benchmark Datasets Driving Progress on New Challenges
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.01217v2](http://arxiv.org/pdf/2509.01217v2)**
...
>
> **备注:** submitted to MELBA Journal v2: added Jinming Duan to author list
>
...
>
---
#### [replaced 068] VIBESegmentator: Full Body MRI Segmentation for the NAKO and UK Biobank
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2406.00125v4](http://arxiv.org/pdf/2406.00125v4)**

> **作者:** Robert Graf; Paul-Sören Platzek; Evamaria Olga Riedel; Constanze Ramschütz; Sophie Starck; Hendrik Kristian Möller; Matan Atad; Henry Völzke; Robin Bülow; Carsten Oliver Schmidt; Julia Rüdebusch; Matthias Jung; Marco Reisert; Jakob Weiss; Maximilian Löffler; Fabian Bamberg; Bene Wiestler; Johannes C. Paetzold; Daniel Rueckert; Jan Stefan Kirschke
>
> **备注:** https://github.com/robert-graf/VIBESegmentator
>
...
>
---
#### [replaced 077] Llama Learns to Direct: DirectorLLM for Human-Centric Video Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.14484v3](http://arxiv.org/pdf/2412.14484v3)**
...
>
---
#### [replaced 078] AI Sees Your Location, But With A Bias Toward The Wealthy World
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 079] Multimodal Latent Fusion of ECG Leads for Early Assessment of Pulmonary Hypertension
...
>
---
#### [replaced 080] PractiLight: Practical Light Control Using Foundational Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.01837v2](http://arxiv.org/pdf/2509.01837v2)**
...
>
---
#### [replaced 081] Slice-100K: A Multimodal Dataset for Extrusion-based 3D Printing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.04180v3](http://arxiv.org/pdf/2407.04180v3)**
...
>
---
#### [replaced 083] Dita: Scaling Diffusion Transformer for Generalist Vision-Language-Action Policy
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 084] Representation-Centric Survey of Skeletal Action Recognition and the ANUBIS Benchmark
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2205.02071v5](http://arxiv.org/pdf/2205.02071v5)**
...
>
---
#### [replaced 085] HumaniBench: A Human-Centric Framework for Large Multimodal Models Evaluation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.11454v4](http://arxiv.org/pdf/2505.11454v4)**
...
>
---
#### [replaced 086] Unsupervised cell segmentation by fast Gaussian Processes
- **分类: stat.AP; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18902v2](http://arxiv.org/pdf/2505.18902v2)**
...
>
---
#### [replaced 087] LatticeWorld: A Multimodal Large Language Model-Empowered Framework for Interactive Complex World Generation
- **分类: cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.05263v2](http://arxiv.org/pdf/2509.05263v2)**
...
>
---
#### [replaced 088] Support or Refute: Analyzing the Stance of Evidence to Detect Out-of-Context Mis- and Disinformation
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 089] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2408.10906v2](http://arxiv.org/pdf/2408.10906v2)**
...
>
---
#### [replaced 092] MovieCORE: COgnitive REasoning in Movies
...
>
---
#### [replaced 096] SGDFuse: SAM-Guided Diffusion for High-Fidelity Infrared and Visible Image Fusion
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.05264v2](http://arxiv.org/pdf/2508.05264v2)**
...
>
---
#### [replaced 097] Semi-SMD: Semi-Supervised Metric Depth Estimation via Surrounding Cameras for Autonomous Driving
- **分类: cs.RO; cs.CV**
