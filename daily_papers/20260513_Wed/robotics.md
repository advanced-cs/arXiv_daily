...
>
---
#### [new 003] Premover: Fast Vision-Language-Action Control by Acting Before Instructions Are Complete
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出Premover，解决VLA政策在用户输入完成前的空闲期浪费问题。通过预计算提升响应速度，减少执行时间，同时保持成功率。属于视觉-语言-动作控制任务。**

- **链接: [https://arxiv.org/pdf/2605.12160](https://arxiv.org/pdf/2605.12160)**
...
>
---
#### [new 013] Coordinated Diffusion: Generating Multi-Agent Behavior Without Multi-Agent Demonstrations
- **分类: cs.RO**
...
>
---
#### [new 014] From Imagined Futures to Executable Actions: Mixture of Latent Actions for Robot Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 019] GuidedVLA: Specifying Task-Relevant Factors via Plug-and-Play Action Attention Specialization
- **分类: cs.RO**

- **简介: 该论文提出GuidedVLA，解决VLA模型因缺乏显式引导导致的过拟合问题。通过手动引导注意力机制，提升任务相关特征学习，增强模型泛化能力。**
...
>
---
#### [new 020] See What Matters: Differentiable Grid Sample Pruning for Generalizable Vision-Language-Action Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 030] Cooperative Robotics Reinforced by Collective Perception for Traffic Moderation
- **分类: cs.RO; cs.AI; cs.ET; eess.SY**

- **简介: 该论文属于交通安全任务，旨在解决非视距交叉口的碰撞风险问题。通过融合视觉与V2X感知，结合协作机器人实现危险预警与物理阻断。**

- **链接: [https://arxiv.org/pdf/2605.11972](https://arxiv.org/pdf/2605.11972)**
...
>
---
#### [new 035] Nautilus: From One Prompt to Plug-and-Play Robot Learning
- **分类: cs.RO**

- **简介: 该论文提出NAUTILUS，解决机器人学习中不同组件难以集成的问题。通过统一接口和自动化流程，实现策略、仿真与真实机器人的快速适配与验证，提升研究效率。**

- **链接: [https://arxiv.org/pdf/2605.11665](https://arxiv.org/pdf/2605.11665)**
...
>
---
#### [new 042] JACoP: Joint Alignment for Compliant Multi-Agent Prediction
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 043] Weather-Robust Cross-View Geo-Localization via Prototype-Based Semantic Part Discovery
...
>
---
#### [new 044] RoboBlockly Studio: Conversational Block Programming with Embodied Robot Feedback for Computational Thinking
- **分类: cs.HC; cs.RO**

- **简介: 该论文介绍RoboBlockly Studio，一个结合编程、AI对话和机器人反馈的系统，旨在提升计算思维学习。任务是解决抽象编程与实际应用脱节的问题，通过互动反馈促进理解与反思。**

- **链接: [https://arxiv.org/pdf/2605.12059](https://arxiv.org/pdf/2605.12059)**
...
>
---
#### [new 047] EgoEV-HandPose: Egocentric 3D Hand Pose Estimation and Gesture Recognition with Stereo Event Cameras
...
>
---
#### [new 050] Trust Region Inverse Reinforcement Learning: Explicit Dual Ascent using Local Policy Updates
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于逆强化学习任务，解决传统方法计算成本高或稳定性差的问题。提出TRIRL算法，通过信任区域策略更新实现稳定且高效的奖励函数学习。**

- **链接: [https://arxiv.org/pdf/2605.11020](https://arxiv.org/pdf/2605.11020)**
...
>
---
#### [replaced 002] IMPACT: An Implicit Active-Set Augmented Lagrangian for Fast Contact-Implicit Trajectory Optimization
- **分类: cs.RO**
...
>
---
#### [replaced 003] Picasso: Holistic Scene Reconstruction with Physics-Constrained Sampling
...
>
---
#### [replaced 006] HeteroGenManip: Generalizable Manipulation For Heterogeneous Object Interactions
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出HeteroGenManip，解决机器人在异质物体交互中的泛化操作问题。通过分阶段框架，提升抓取与交互的准确性与适应性。**
...
>
---
#### [replaced 007] A comprehensive control architecture for semi-autonomous dual-arm robots in agriculture settings
- **分类: cs.RO**

- **简介: 论文提出一种用于农业环境中半自主双臂机器人的控制架构，解决复杂任务下的感知与控制集成问题。采用16-DOF双臂机器人，通过分层二次规划实现多约束下的采摘操作，并支持人机协作。**

- **链接: [https://arxiv.org/pdf/2506.23723](https://arxiv.org/pdf/2506.23723)**
...
>
---
#### [replaced 008] SOAR: Regression-based LiDAR Relocalization for UAVs
- **分类: cs.CV; cs.RO; eess.IV**
...
>
---
#### [replaced 009] BEACON: Cross-Domain Co-Training of Generative Robot Policies via Best-Effort Adaptation
- **分类: cs.RO**
...
>
---
#### [replaced 010] Action Hallucination in Generative Vision-Language-Action Models
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于机器人学习任务，研究生成式视觉-语言-动作模型中的动作幻觉问题，分析其导致的物理约束违反和计划失败，提出改进方向。**

- **链接: [https://arxiv.org/pdf/2602.06339](https://arxiv.org/pdf/2602.06339)**

> **作者:** Harold Soh; Eugene Lim
>
> **备注:** 24 pages; updated setup with minor changes to proofs. changed template
>
...
>
---
#### [replaced 011] Efficient Emotion-Aware Iconic Gesture Prediction for Robot Co-Speech
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于情感感知的图标手势预测任务，旨在提升机器人共言手势的语义准确性。通过轻量级Transformer模型，仅凭文本和情感信息生成手势，解决现有系统缺乏语义强调的问题。**
...
>
---
#### [replaced 012] SHIELD: Scalable Optimal Control with Certification using Duality and Convexity
- **分类: cs.RO**

- **简介: 该论文提出SHIELD算法，用于解决复杂交通场景下的模型预测控制问题，通过降维和约束安全剔除实现高效计算，确保控制安全性与可行性。**
...
>
---
#### [replaced 013] SAGAS: Semantic-Aware Graph-Assisted Stitching for Offline Temporal Logic Planning
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于机器人路径规划任务，解决离线LTL任务执行问题。通过结合符号合成与数据驱动方法，提出SAGAS框架，实现无需在线交互的零样本泛化。**

- **链接: [https://arxiv.org/pdf/2512.00775](https://arxiv.org/pdf/2512.00775)**

> **作者:** Ruijia Liu; Ancheng Hou; Xiang Yin
>
...
>
---
#### [replaced 019] Trajectory First: A Curriculum for Discovering Diverse Policies
- **分类: cs.LG; cs.RO**

- **简介: 该论文属于强化学习领域，旨在解决复杂任务中策略多样性不足的问题。通过两阶段课程方法，提升策略的多样性与任务性能。**

- **链接: [https://arxiv.org/pdf/2506.01568](https://arxiv.org/pdf/2506.01568)**
...
>
---
#### [replaced 024] IGV-RRT: Prior-Real-Time Observation Fusion for Active Object Search in Changing Environments
- **分类: cs.RO**

- **简介: 该论文属于目标导航任务，解决动态环境中物体重置导致的导航失效问题。通过融合先验知识与实时视觉语言模型信息，提出IGV-RRT方法提升搜索效率和成功率。**

- **链接: [https://arxiv.org/pdf/2603.21887](https://arxiv.org/pdf/2603.21887)**

> **作者:** Wei Zhang; Ping Gong; Yujie Wang; Leilei Yao; Minghui Bai; Rongfeng Ye; Yinchuan Wang; Yachao Wang; Chen Sun; Chaoqun Wang
>
...
>
---
#### [replaced 025] Learning What Can Be Picked: Active Reachability Estimation for Efficient Robotic Fruit Harvesting
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于农业机器人任务，解决果实可抓取性判断问题。通过结合RGB-D感知与主动学习，提升感知效率，减少标注需求，提高预测准确性。**
...
>
---
#### [replaced 026] Transformer-Based Autonomous Driving Models and Deployment-Oriented Compression: A Survey
...
>
---
#### [replaced 027] Simulation Distillation: Pretraining World Models in Simulation for Rapid Real-World Adaptation
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文提出SimDist框架，用于机器人世界模型的预训练与现实适应。针对真实环境中数据获取困难的问题，利用物理模拟器生成经验进行模型预训练，并在真实场景中仅微调动态模型，提升在线规划能力。**
...
>
---
#### [replaced 029] Constraint-Aware Diffusion Priors for High-Fidelity and Versatile Quadruped Locomotion
- **分类: cs.RO**

- **简介: 该论文属于四足机器人运动控制任务，旨在解决运动多样性不足、轨迹漂移和硬件安全问题。提出Diff-CAST框架，利用扩散模型提升运动分布建模，结合约束强化学习确保安全可靠部署。**
...
>
---
#### [replaced 033] Active inference as a unified model of collision avoidance behavior in human drivers
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于驾驶行为建模任务，旨在解决现有碰撞避让模型碎片化的问题。提出基于主动推理的统一模型，模拟两种碰撞避让场景，有效解释多种实验结果。**

- **链接: [https://arxiv.org/pdf/2506.02215](https://arxiv.org/pdf/2506.02215)**
...
>
---
#### [replaced 034] Certified Gradient-Based Contact-Rich Manipulation via Smoothing-Error Reachable Tubes
- **分类: cs.RO**

- **简介: 该论文属于机器人操控任务，解决接触丰富环境下的控制器优化问题。通过平滑动力学并量化误差，实现安全且可靠的控制策略。**

- **链接: [https://arxiv.org/pdf/2602.09368](https://arxiv.org/pdf/2602.09368)**

> **作者:** Wei-Chen Li; Glen Chou
>
> **备注:** Robotics: Science & Systems (RSS) 2026
>
...
>
---
#### [replaced 035] Interpreting Context-Aware Human Preferences for Multi-Objective Robot Navigation
- **分类: cs.RO**

- **简介: 该论文属于多目标机器人导航任务，旨在解决如何理解并适应人类上下文感知的偏好。通过结合大模型与强化学习，实现高效、透明的导航行为调整。**
...
>
---
#### [replaced 036] Failing Forward: Adaptive Failure-Informed Learning for Vision-Language-Action Models
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，解决VLA模型因依赖成功数据而易失效的问题。提出AFIL框架，利用失败轨迹提升模型鲁棒性，通过双动作生成器实现高效学习。**
...
>
---
#### [replaced 037] Retrieve-then-Steer: Online Success Memory for Test-Time Adaptation of Generative VLAs
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于机器人视觉-语言-动作（VLA）模型的测试时适应任务，旨在提升模型在长期部署中的可靠性。通过在线成功记忆机制，利用过往成功经验优化动作生成，无需更新参数即可提高任务成功率和稳定性。**
