...
- **简介: 该论文属于医学图像分割任务，旨在比较不同模型在MRI脑肿瘤分割中的表现，评估多种提示质量下的性能。**
...
- **链接: [http://arxiv.org/pdf/2506.21184v1](http://arxiv.org/pdf/2506.21184v1)**
...
- **简介: 该论文属于3D物体识别任务，解决在复杂室内环境中仅凭遮挡2D图像和自然语言描述检索3D物体的问题。提出SAMURAI方法，结合语义匹配与形状重排序，提升检索性能。**
...
- **简介: 该论文属于图像生成任务，旨在解决模型崩溃问题。提出BitMark水印框架，在比特层嵌入水印，确保生成图像可检测且不影响质量。**
...
- **简介: 该论文属于生存预测任务，解决WSI中病理异质性建模问题。提出OTSurv框架，结合最优输运理论，提升预测性能与可解释性。**
...
- **简介: 该论文属于低光图像增强任务，解决极端暗光场景下图像质量差的问题。通过构建数据集和提出扩散框架提升图像质量。**
...
- **简介: 该论文属于图像生成任务，解决扩散模型中高引导尺度导致的过饱和和不真实问题。通过分析低频信号，提出LF-CFG方法减轻冗余信息影响。**
...
- **链接: [http://arxiv.org/pdf/2506.21005v1](http://arxiv.org/pdf/2506.21005v1)**
...
- **简介: 该论文属于训练-free 开放词汇分割任务，旨在无需微调模型的情况下实现图像分割。通过构建高质量参考集并利用相似性检索提升性能。**
...
- **简介: 该论文属于深度补全任务，旨在解决非朗伯物体深度图噪声大、不完整的问题。通过改进扩散框架和引入语义增强，提升深度预测精度与泛化能力。**
...
- **简介: 该论文属于医学图像分割任务，旨在解决心脏MRI中肌心梗区域分割的问题，通过改进深度学习模型应对标签噪声和数据异质性。**
...
- **简介: 该论文属于人脸老化任务，旨在解决年龄准确性和身份一致性之间的平衡问题。提出两阶段框架Cradle2Cane，提升老化效果与身份保留。**
...
- **简介: 该论文属于面部老化生成任务，旨在通过无训练扩散方法生成多条件的面部老化轨迹，解决传统方法单一且不可控的问题。**
...
- **链接: [http://arxiv.org/pdf/2506.21045v1](http://arxiv.org/pdf/2506.21045v1)**
...
- **简介: 该论文属于场景文本生成任务，旨在实现精确的单词级排版控制。通过构建数据集和提出TIA框架及WordCon方法，提升文本与图像的一致性与可编辑性。**
...
- **链接: [http://arxiv.org/pdf/2506.21002v1](http://arxiv.org/pdf/2506.21002v1)**
...
- **简介: 该论文属于医学图像分类任务，旨在解决乳腺癌中非典型有丝分裂的自动识别问题。通过对比不同深度学习模型，在跨数据集评估中验证了模型的有效性。**
...
- **简介: 该论文属于航空气象可见度估计任务，旨在解决缺乏公开标注数据的问题，提出一个新数据集并进行基准测试。**
...
- **链接: [http://arxiv.org/pdf/2506.21357v1](http://arxiv.org/pdf/2506.21357v1)**
...
- **链接: [http://arxiv.org/pdf/2506.21022v1](http://arxiv.org/pdf/2506.21022v1)**
...
- **简介: 该论文属于场景重建任务，旨在解决现有方法难以生成新颖驾驶场景的问题。通过引入外部记忆库，替换车辆以实现更逼真的场景合成。**
...
>
---
#### [new 069] Evaluation of Traffic Signals for Daily Traffic Pattern
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于交通信号优化任务，旨在解决交通流量管理问题。通过提出动态、静态和混合配置方法，评估不同信号设计对交通流的影响。**

- **链接: [http://arxiv.org/pdf/2506.21469v1](http://arxiv.org/pdf/2506.21469v1)**
...
>
---
#### [new 070] StruMamba3D: Exploring Structural Mamba for Self-supervised Point Cloud Representation Learning
- **分类: cs.CV**

- **简介: 该论文属于点云表示学习任务，旨在解决Mamba方法在处理3D点云时破坏邻接性和长序列记忆不足的问题。通过设计空间状态和优化策略提升模型性能。**

- **链接: [http://arxiv.org/pdf/2506.21541v1](http://arxiv.org/pdf/2506.21541v1)**
...
>
---
#### [new 071] Enhancing Ambiguous Dynamic Facial Expression Recognition with Soft Label-based Data Augmentation
- **分类: cs.CV**

- **简介: 该论文属于动态面部表情识别任务，旨在解决模糊表情识别问题。提出MIDAS方法，通过软标签数据增强提升模型性能。**

- **链接: [http://arxiv.org/pdf/2506.20867v1](http://arxiv.org/pdf/2506.20867v1)**
...
>
---
#### [new 072] Curve-Aware Gaussian Splatting for 3D Parametric Curve Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于3D曲线重建任务，解决多视角边缘图到参数化曲线的直接优化问题。提出CurveGaussian方法，实现端到端高效重建。**

- **链接: [http://arxiv.org/pdf/2506.21401v1](http://arxiv.org/pdf/2506.21401v1)**

> **作者:** Zhirui Gao. Renjiao Yi; Yaqiao Dai; Xuening Zhu; Wei Chen; Chenyang Zhu; Kai Xu
>
> **备注:** Code: https://github.com/zhirui-gao/Curve-Gaussian Accepted by ICCV 2025
>
...
>
---
#### [new 075] SAM4D: Segment Anything in Camera and LiDAR Streams
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 076] Pushing Trade-Off Boundaries: Compact yet Effective Remote Sensing Change Detection
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于遥感变化检测任务，旨在提升模型效率与精度的平衡。提出FlickCD模型，通过优化模块设计，在降低计算和存储开销的同时保持高检测性能。**

- **链接: [http://arxiv.org/pdf/2506.21109v1](http://arxiv.org/pdf/2506.21109v1)**
...
>
---
#### [new 077] Real-Time ESFP: Estimating, Smoothing, Filtering, and Pose-Mapping
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 081] Video Virtual Try-on with Conditional Diffusion Transformer Inpainter
- **分类: cs.CV**

- **简介: 该论文属于视频虚拟试衣任务，旨在解决视频中衣物与人物的时空一致性问题。提出ViTI模型，通过条件视频修复实现更自然的试衣效果。**

- **链接: [http://arxiv.org/pdf/2506.21270v1](http://arxiv.org/pdf/2506.21270v1)**
...
>
---
#### [new 082] G$^{2}$D: Boosting Multimodal Learning with Gradient-Guided Distillation
- **分类: cs.CV**

- **简介: 该论文属于多模态学习任务，旨在解决模态不平衡问题。通过引入G²D框架和动态模态优先技术，提升弱模态表现并优化模型性能。**

- **链接: [http://arxiv.org/pdf/2506.21514v1](http://arxiv.org/pdf/2506.21514v1)**
...
>
---
#### [new 085] Hierarchical Sub-action Tree for Continuous Sign Language Recognition
- **分类: cs.CV; cs.MM**

- **简介: 该论文属于连续手语识别任务，旨在解决数据不足和模态对齐问题。提出HST-CSLR方法，结合文本知识与视觉表示，提升识别效果。**

- **链接: [http://arxiv.org/pdf/2506.20947v1](http://arxiv.org/pdf/2506.20947v1)**
...
>
---
#### [new 086] HyperSORT: Self-Organising Robust Training with hyper-networks
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决数据集中的异质偏差问题。通过构建HyperSORT框架，利用超网络学习UNet参数分布，识别系统性偏差和错误样本。**

- **链接: [http://arxiv.org/pdf/2506.21430v1](http://arxiv.org/pdf/2506.21430v1)**
...
>
---
#### [new 092] GGTalker: Talking Head Systhesis with Generalizable Gaussian Priors and Identity-Specific Adaptation
- **分类: cs.CV**

- **简介: 该论文属于语音驱动3D说话头生成任务，解决大角度旋转和分布外音频下的生成质量与效率问题。提出GGTalker，结合通用先验与个性适应，提升合成效果。**

- **链接: [http://arxiv.org/pdf/2506.21513v1](http://arxiv.org/pdf/2506.21513v1)**
...
>
---
#### [new 095] XVerse: Consistent Multi-Subject Control of Identity and Semantic Attributes via DiT Modulation
- **分类: cs.CV**

- **简介: 该论文属于文本到图像生成任务，解决多主体身份与语义属性控制问题。提出XVerse模型，通过文本流调制实现精准、独立控制，提升生成质量与可编辑性。**

- **链接: [http://arxiv.org/pdf/2506.21416v1](http://arxiv.org/pdf/2506.21416v1)**

> **作者:** Bowen Chen; Mengyi Zhao; Haomiao Sun; Li Chen; Xu Wang; Kang Du; Xinglong Wu
>
> **备注:** Project Page: https://bytedance.github.io/XVerse Github Link: https://github.com/bytedance/XVerse
>
...
>
---
#### [new 096] ShotBench: Expert-Level Cinematic Understanding in Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于视觉语言理解任务，旨在解决VLM在电影镜头语言理解上的不足。提出ShotBench基准和ShotQA数据集，并构建了性能更优的ShotVL模型。**

- **链接: [http://arxiv.org/pdf/2506.21356v1](http://arxiv.org/pdf/2506.21356v1)**
...
>
---
#### [new 101] DeOcc-1-to-3: 3D De-Occlusion from a Single Image via Self-Supervised Multi-View Diffusion
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，解决单图像部分遮挡下的3D重建问题。提出一种端到端框架，直接生成多视角图像以提升重建质量。**

- **链接: [http://arxiv.org/pdf/2506.21544v1](http://arxiv.org/pdf/2506.21544v1)**
...
>
---
#### [new 102] EgoAdapt: Adaptive Multisensory Distillation and Policy Learning for Efficient Egocentric Perception
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于多模态自我中心感知任务，旨在降低计算成本。提出EgoAdapt框架，通过自适应蒸馏和策略学习提升效率。**

- **链接: [http://arxiv.org/pdf/2506.21080v1](http://arxiv.org/pdf/2506.21080v1)**
...
>
---
#### [new 107] How do Foundation Models Compare to Skeleton-Based Approaches for Gesture Recognition in Human-Robot Interaction?
...
>
---
#### [new 113] HalluSegBench: Counterfactual Visual Reasoning for Segmentation Hallucination Evaluation
...
>
---
#### [new 116] Spatial Mental Modeling from Limited Views
...
>
---
#### [new 117] Development of MR spectral analysis method robust against static magnetic field inhomogeneity
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学影像分析任务，旨在解决B0场不均匀性对谱分析精度的影响。通过构建模型谱并结合深度学习提升分析准确性。**

- **链接: [http://arxiv.org/pdf/2506.20897v1](http://arxiv.org/pdf/2506.20897v1)**
...
>
---
#### [new 118] FairyGen: Storied Cartoon Video from a Single Child-Drawn Character
- **分类: cs.GR; cs.CV; cs.MM**

- **简介: 该论文提出FairyGen，用于从儿童画作生成风格化动画视频，解决个性化故事动画生成问题。通过分离角色建模与背景生成，结合镜头设计和运动定制，实现风格一致、叙事连贯的动画。**

- **链接: [http://arxiv.org/pdf/2506.21272v1](http://arxiv.org/pdf/2506.21272v1)**
...
>
---
#### [new 119] V2X-REALM: Vision-Language Model-Based Robust End-to-End Cooperative Autonomous Driving with Adaptive Long-Tail Modeling
...
>
---
#### [new 120] ThermalDiffusion: Visual-to-Thermal Image-to-Image Translation for Autonomous Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 121] Multimodal LLMs for Visualization Reconstruction and Understanding
- **分类: cs.HC; cs.CV**

- **简介: 该论文属于可视化理解任务，旨在解决多模态大模型难以解析数据与视觉映射关系的问题。通过构建数据集并训练专门模型，提升可视化内容的重建与数据提取效果。**

- **链接: [http://arxiv.org/pdf/2506.21319v1](http://arxiv.org/pdf/2506.21319v1)**
...
>
> **摘要:** We present 3DGH, an unconditional generative model for 3D human heads with composable hair and face components. Unlike previous work that entangles the modeling of hair and face, we propose to separate them using a novel data representation with template-based 3D Gaussian Splatting, in which deformable hair geometry is introduced to capture the geometric variations across different hairstyles. Based on this data representation, we design a 3D GAN-based architecture with dual generators and employ a cross-attention mechanism to model the inherent correlation between hair and face. The model is trained on synthetic renderings using carefully designed objectives to stabilize training and facilitate hair-face separation. We conduct extensive experiments to validate the design choice of 3DGH, and evaluate it both qualitatively and quantitatively by comparing with several state-of-the-art 3D GAN methods, demonstrating its effectiveness in unconditional full-head image synthesis and composable 3D hairstyle editing. More details will be available on our project page: https://c-he.github.io/projects/3dgh/.
>
---
#### [new 124] RL-Selector: Reinforcement Learning-Guided Data Selection via Redundancy Assessment
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于数据选择任务，旨在减少训练中的冗余，提升效率与泛化能力。通过引入epsilon-sample cover和强化学习方法优化数据选择策略。**

- **链接: [http://arxiv.org/pdf/2506.21037v1](http://arxiv.org/pdf/2506.21037v1)**
...
>
---
#### [new 125] Generative Blocks World: Moving Things Around in Pictures
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出Generative Blocks World，属于图像编辑任务，解决3D场景编辑与图像生成问题。通过3D几何抽象实现灵活编辑，并生成高质量图像。**

- **链接: [http://arxiv.org/pdf/2506.20703v1](http://arxiv.org/pdf/2506.20703v1)**
...
>
---
#### [new 129] ThinkSound: Chain-of-Thought Reasoning in Multimodal Large Language Models for Audio Generation and Editing
...
>
---
#### [new 134] SharpZO: Hybrid Sharpness-Aware Vision Language Model Prompt Tuning via Forward-Only Passes
...
>
---
#### [new 135] ResQ: A Novel Framework to Implement Residual Neural Networks on Analog Rydberg Atom Quantum Computers
- **分类: quant-ph; cs.CV; cs.ET**

- **简介: 该论文属于量子机器学习任务，旨在解决传统ResNet在量子计算中的应用问题。工作是提出ResQ框架，利用模拟Rydberg原子量子计算机实现神经ODE-based ResNets。**

- **链接: [http://arxiv.org/pdf/2506.21537v1](http://arxiv.org/pdf/2506.21537v1)**
...
>
---
#### [replaced 002] Tackling fluffy clouds: robust field boundary delineation across global agricultural landscapes with Sentinel-1 and Sentinel-2 Time Series
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2409.13568v2](http://arxiv.org/pdf/2409.13568v2)**
...
>
---
#### [replaced 006] AirCache: Activating Inter-modal Relevancy KV Cache Compression for Efficient Large Vision-Language Model Inference
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.23956v2](http://arxiv.org/pdf/2503.23956v2)**

> **作者:** Kai Huang; Hao Zou; Bochen Wang; Ye Xi; Zhen Xie; Hao Wang
>
> **备注:** We have withdrawn this manuscript due to a critical error in the methodology which affects the validity of the main results. We are currently working to address this issue and will resubmit once the correction is complete
>
...
>
---
#### [replaced 007] Variational Supervised Contrastive Learning
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07413v2](http://arxiv.org/pdf/2506.07413v2)**
...
>
---
#### [replaced 008] DisCoPatch: Taming Adversarially-driven Batch Statistics for Improved Out-of-Distribution Detection
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [http://arxiv.org/pdf/2501.08005v3](http://arxiv.org/pdf/2501.08005v3)**
...
>
---
#### [replaced 009] Generate the Forest before the Trees -- A Hierarchical Diffusion model for Climate Downscaling
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.19391v2](http://arxiv.org/pdf/2506.19391v2)**
...
>
---
#### [replaced 010] TCDiff++: An End-to-end Trajectory-Controllable Diffusion Model for Harmonious Music-Driven Group Choreography
...
>
---
#### [replaced 011] Do It Yourself: Learning Semantic Correspondence from Pseudo-Labels
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05312v2](http://arxiv.org/pdf/2506.05312v2)**
...
>
---
#### [replaced 012] QuEST: Low-bit Diffusion Model Quantization via Efficient Selective Finetuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2402.03666v4](http://arxiv.org/pdf/2402.03666v4)**
...
>
---
#### [replaced 015] OneIG-Bench: Omni-dimensional Nuanced Evaluation for Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07977v3](http://arxiv.org/pdf/2506.07977v3)**
...
>
---
#### [replaced 016] LBONet: Supervised Spectral Descriptors for Shape Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.08272v2](http://arxiv.org/pdf/2411.08272v2)**
...
>
---
#### [replaced 017] SoK: Can Synthetic Images Replace Real Data? A Survey of Utility and Privacy of Synthetic Image Generation
- **分类: cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.19360v2](http://arxiv.org/pdf/2506.19360v2)**
...
>
---
#### [replaced 018] SA-Person: Text-Based Person Retrieval with Scene-aware Re-ranking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24466v2](http://arxiv.org/pdf/2505.24466v2)**
...
>
---
#### [replaced 019] Consensus-Driven Uncertainty for Robotic Grasping based on RGB Perception
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 020] Fake it till You Make it: Reward Modeling as Discriminative Prediction
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.13846v2](http://arxiv.org/pdf/2506.13846v2)**
...
>
---
#### [replaced 024] Self-Regulated Neurogenesis for Online Data-Incremental Learning
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2403.14684v2](http://arxiv.org/pdf/2403.14684v2)**

> **作者:** Murat Onur Yildirim; Elif Ceren Gok Yildirim; Decebal Constantin Mocanu; Joaquin Vanschoren
>
> **备注:** Published at Conference on Lifelong Learning Agents (CoLLAs) 2025
>
...
- **链接: [http://arxiv.org/pdf/2506.18028v2](http://arxiv.org/pdf/2506.18028v2)**
...
>
---
#### [replaced 026] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction for Large-Scale Aerial Scenes
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.16606v2](http://arxiv.org/pdf/2504.16606v2)**
...
>
---
#### [replaced 028] Discovering Global False Negatives On the Fly for Self-supervised Contrastive Learning
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.20612v2](http://arxiv.org/pdf/2502.20612v2)**
...
>
---
#### [replaced 029] RobustSplat: Decoupling Densification and Dynamics for Transient-Free 3DGS
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.02751v2](http://arxiv.org/pdf/2506.02751v2)**
...
>
---
#### [replaced 033] ARTalk: Speech-Driven 3D Head Animation via Autoregressive Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.20323v3](http://arxiv.org/pdf/2502.20323v3)**
...
>
---
#### [replaced 034] HERMES: temporal-coHERent long-forM understanding with Episodes and Semantics
...
>
---
#### [replaced 035] Structure-Preserving Patch Decoding for Efficient Neural Video Representation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.12896v2](http://arxiv.org/pdf/2506.12896v2)**
...
>
---
#### [replaced 036] Chain-of-Sketch: Enabling Global Visual Reasoning
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2410.08165v2](http://arxiv.org/pdf/2410.08165v2)**
...
>
---
#### [replaced 046] ROA-BEV: 2D Region-Oriented Attention for BEV-based 3D Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.10298v2](http://arxiv.org/pdf/2410.10298v2)**

> **作者:** Jiwei Chen; Yubao Sun; Laiyan Ding; Rui Huang
>
> **备注:** accepted by IROS 2025
>
> **摘要:** Vision-based Bird's-Eye-View (BEV) 3D object detection has recently become popular in autonomous driving. However, objects with a high similarity to the background from a camera perspective cannot be detected well by existing methods. In this paper, we propose a BEV-based 3D Object Detection Network with 2D Region-Oriented Attention (ROA-BEV), which enables the backbone to focus more on feature learning of the regions where objects exist. Moreover, our method further enhances the information feature learning ability of ROA through multi-scale structures. Each block of ROA utilizes a large kernel to ensure that the receptive field is large enough to catch information about large objects. Experiments on nuScenes show that ROA-BEV improves the performance based on BEVDepth. The source codes of this work will be available at https://github.com/DFLyan/ROA-BEV.
>
---
#### [replaced 047] GASP: Efficient Black-Box Generation of Adversarial Suffixes for Jailbreaking LLMs
- **分类: cs.LG; cs.AI; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2411.14133v2](http://arxiv.org/pdf/2411.14133v2)**

> **作者:** Advik Raj Basani; Xiao Zhang
>
> **备注:** 38 pages, 8 tables, 18 figures
>
...
>
---
#### [replaced 048] PP-DocBee: Improving Multimodal Document Understanding Through a Bag of Tricks
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 049] 3D Hierarchical Panoptic Segmentation in Real Orchard Environments Across Different Sensors
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 056] Metis-RISE: RL Incentivizes and SFT Enhances Multimodal Reasoning Model Learning
- **分类: cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.13056v2](http://arxiv.org/pdf/2506.13056v2)**
...
>
---
#### [replaced 057] Materialist: Physically Based Editing Using Single-Image Inverse Rendering
- **分类: cs.CV; cs.AI; cs.GR**

- **链接: [http://arxiv.org/pdf/2501.03717v2](http://arxiv.org/pdf/2501.03717v2)**

> **作者:** Lezhong Wang; Duc Minh Tran; Ruiqi Cui; Thomson TG; Anders Bjorholm Dahl; Siavash Arjomand Bigdeli; Jeppe Revall Frisvad; Manmohan Chandraker
>
> **备注:** Add acknowledgements, more authors and more results. Project website: https://lez-s.github.io/materialist_project/
>
...
>
---
#### [replaced 058] DeSPITE: Exploring Contrastive Deep Skeleton-Pointcloud-IMU-Text Embeddings for Advanced Point Cloud Human Activity Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13897v3](http://arxiv.org/pdf/2506.13897v3)**
...
>
---
#### [replaced 062] JointDiT: Enhancing RGB-Depth Joint Modeling with Diffusion Transformers
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.00482v2](http://arxiv.org/pdf/2505.00482v2)**

> **作者:** Kwon Byung-Ki; Qi Dai; Lee Hyoseok; Chong Luo; Tae-Hyun Oh
>
> **备注:** Accepted to IEEE/CVF International Conference on Computer Vision (ICCV) 2025. Project page: https://byungki-k.github.io/JointDiT/ Code: https://github.com/ByungKi-K/JointDiT-code
>
...
>
---
#### [replaced 063] UP-VLA: A Unified Understanding and Prediction Model for Embodied Agent
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.18867v3](http://arxiv.org/pdf/2501.18867v3)**
...
>
---
#### [replaced 071] TaxaDiffusion: Progressively Trained Diffusion Model for Fine-Grained Species Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.01923v2](http://arxiv.org/pdf/2506.01923v2)**
...
>
---
#### [replaced 072] Cell Tracking according to Biological Needs -- Strong Mitosis-aware Multi-Hypothesis Tracker with Aleatoric Uncertainty
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.15011v4](http://arxiv.org/pdf/2403.15011v4)**

> **作者:** Timo Kaiser; Maximilian Schier; Bodo Rosenhahn
>
> **备注:** 13 pages, 4 figures, 4 tables. This work has been accepted to the IEEE for publication
>
...
>
---
#### [replaced 076] GroundCap: A Visually Grounded Image Captioning Dataset
...
>
---
#### [replaced 079] CREStE: Scalable Mapless Navigation with Internet Scale Priors and Counterfactual Guidance
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 080] DWIM: Towards Tool-aware Visual Reasoning via Discrepancy-aware Workflow Generation & Instruct-Masking Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.19263v2](http://arxiv.org/pdf/2503.19263v2)**
...
>
---
#### [replaced 081] HyperPath: Knowledge-Guided Hyperbolic Semantic Hierarchy Modeling for WSI Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.16398v2](http://arxiv.org/pdf/2506.16398v2)**
...
>
---
#### [replaced 082] Semantic Scene Graph for Ultrasound Image Explanation and Scanning Guidance
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2506.19683v2](http://arxiv.org/pdf/2506.19683v2)**
