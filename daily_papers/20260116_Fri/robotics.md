...
>
---
#### [new 015] UEOF: A Benchmark Dataset for Underwater Event-Based Optical Flow
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 016] Self-Organizing Dual-Buffer Adaptive Clustering Experience Replay (SODASER) for Safe Reinforcement Learning in Optimal Control
- **分类: eess.SY; cs.AI; cs.LG; cs.RO; math.OC**

- **简介: 该论文提出SODASER框架，用于安全强化学习中的最优控制任务，解决非线性系统控制中的安全性与效率问题，通过双缓冲和自组织聚类提升样本效率与稳定性。**

- **链接: [https://arxiv.org/pdf/2601.06540v1](https://arxiv.org/pdf/2601.06540v1)**
...
>
---
#### [new 017] RAG-3DSG: Enhancing 3D Scene Graphs with Re-Shot Guided Retrieval-Augmented Generation
...
>
---
#### [new 018] LCF3D: A Robust and Real-Time Late-Cascade Fusion Framework for 3D Object Detection in Autonomous Driving
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 019] OT-Drive: Out-of-Distribution Off-Road Traversable Area Segmentation via Optimal Transport
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 020] Heterogeneous computing platform for real-time robotics
- **分类: cs.NE; cs.AI; cs.RO**

- **简介: 论文探讨了用于实时机器人的异构计算平台，解决人机协作中的感知与决策问题。结合神经形态芯片与GPU，实现高效交互任务。**

- **链接: [https://arxiv.org/pdf/2601.09755v1](https://arxiv.org/pdf/2601.09755v1)**
...
#### [replaced 001] Robot-R1: Reinforcement Learning for Enhanced Embodied Reasoning in Robotics
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出Robot-R1，用于增强机器人控制的具身推理。针对SFT方法的不足，采用强化学习提升任务完成效果。实验表明其性能优于SFT和GPT-4o。**

- **链接: [https://arxiv.org/pdf/2506.00070v2](https://arxiv.org/pdf/2506.00070v2)**
...
>
---
#### [replaced 002] CoinFT: A Coin-Sized, Capacitive 6-Axis Force Torque Sensor for Robotic Applications
- **分类: cs.RO; cs.HC**

- **简介: 该论文提出CoinFT，一种微型六轴力/扭矩传感器，用于机器人应用。旨在解决高精度、低成本、紧凑型传感器的不足，通过结构设计与微控制器优化实现高效测量。**

- **链接: [https://arxiv.org/pdf/2503.19225v3](https://arxiv.org/pdf/2503.19225v3)**

> **作者:** Hojung Choi; Jun En Low; Tae Myung Huh; Seongheon Hong; Gabriela A. Uribe; Kenneth A. W. Hoffmann; Julia Di; Tony G. Chen; Andrew A. Stanley; Mark R. Cutkosky
>
> **摘要:** We introduce CoinFT, a capacitive 6-axis force/torque (F/T) sensor that is compact, light, low-cost, and robust with an average root-mean-squared error of 0.16N for force and 1.08mNm for moment when the input ranges from 0~14N and 0~5N in normal and shear directions, respectively. CoinFT is a stack of two rigid PCBs with comb-shaped electrodes connected by an array of silicone rubber pillars. The microcontroller interrogates the electrodes in different subsets in order to enhance sensitivity for measuring 6-axis F/T. The combination of features of CoinFT enables various contact-rich robot interactions across different embodiment domains including drones, robot end-effectors, and wearable haptic devices. We demonstrate the utility of CoinFT through two representative applications: a multi-axial contact-probing experiment in which a CoinFT mounted beneath a hemispherical fingertip measures 6-axes of force and torque representative of manipulation scenarios, and an attitude-based force-control task on a drone. The design, fabrication, and firmware of CoinFT are open-sourced at https://coin-ft.github.io/.
>
---
#### [replaced 003] Sampling-Based Constrained Motion Planning with Products of Experts
- **分类: cs.RO**

- **简介: 该论文属于运动规划任务，旨在解决约束优化下的采样型模型预测控制问题。通过引入专家产品方法，提升采样效率与多样性，实现更优的可行性与最优性平衡。**

- **链接: [https://arxiv.org/pdf/2412.17462v2](https://arxiv.org/pdf/2412.17462v2)**
...
>
---
#### [replaced 004] Safety Not Found (404): Hidden Risks of LLM-Based Robotics Decision Making
- **分类: cs.AI; cs.RO**

- **简介: 该论文属于安全评估任务，旨在解决LLM在机器人决策中的潜在风险问题。通过设计不同场景测试模型安全性，发现其存在严重漏洞，不适用于安全关键系统。**

- **链接: [https://arxiv.org/pdf/2601.05529v2](https://arxiv.org/pdf/2601.05529v2)**
...
>
---
#### [replaced 005] Bootstrap Off-policy with World Model
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于强化学习任务，旨在解决在线规划与策略学习间的偏差问题。提出BOOM框架，通过世界模型和Bootstrap机制提升训练稳定性和性能。**

- **链接: [https://arxiv.org/pdf/2511.00423v3](https://arxiv.org/pdf/2511.00423v3)**
...
>
---
#### [replaced 006] Learning Quadrotor Control From Visual Features Using Differentiable Simulation
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决强化学习样本效率低的问题。通过不同iable simulation提升quadrotor控制的训练效率与性能。**

- **链接: [https://arxiv.org/pdf/2410.15979v3](https://arxiv.org/pdf/2410.15979v3)**
...
>
---
#### [replaced 008] Bayesian Monocular Depth Refinement via Neural Radiance Fields
...
>
---
#### [replaced 009] UrbanNav: Learning Language-Guided Urban Navigation from Web-Scale Human Trajectories
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 012] Adaptive Querying for Reward Learning from Human Feedback
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属于强化学习任务，旨在通过自适应查询提高从人类反馈中学习安全行为的效率。工作包括设计一种迭代方法，优化查询状态和反馈格式选择。**

- **链接: [https://arxiv.org/pdf/2412.07990v2](https://arxiv.org/pdf/2412.07990v2)**

> **作者:** Yashwanthi Anand; Nnamdi Nwagwu; Kevin Sabbe; Naomi T. Fitter; Sandhya Saisubramanian
>
...
>
---
#### [replaced 013] DAVOS: An Autonomous Vehicle Operating System in the Vehicle Computing Era
- **分类: cs.OS; cs.RO**

- **简介: 该论文属于车载操作系统研究，旨在解决自动驾驶系统中安全、安全、效率和可扩展性问题。提出DAVOS统一架构，整合实时控制与数据服务。**

- **链接: [https://arxiv.org/pdf/2601.05072v2](https://arxiv.org/pdf/2601.05072v2)**
