...
- **简介: 该论文属于多模态知识图谱补全任务，旨在解决融合与独立模态表示的协同问题，提出M-Hyper方法结合两者优势，提升模型性能。**
...
- **简介: 该论文属于模型置信度估计任务，旨在解决LLM在高风险场景中准确校准信心的问题。通过构建通用正确性模型（GCM），利用历史预测数据提升正确性预测能力，实现跨模型和数据集的泛化。**
...
- **简介: 该论文属于AI伦理研究任务，旨在评估LLMs中的认知偏差问题。通过大规模实验分析8种偏差，探讨模型规模与提示细节对偏差的影响。**
...
- **简介: 该论文属于视觉文档检索任务，解决多向量表示导致的存储开销过大的问题。通过自适应剪枝方法减少存储，提升系统效率。**
...
- **简介: 该论文属于隐私保护任务，旨在解决LLM生成有害内容的问题。提出Self-Sanitize框架，实现实时内容检测与修复，提升安全性。**
...
- **简介: 该论文属于语言模型推理评估任务，旨在解决传统基准数据污染问题。通过算法生成问题，构建无污染的评估框架，测试模型在不同难度任务中的推理能力。**
...
- **简介: 该论文属于多模态语言模型评估任务，旨在解决生物推理中的事实准确性问题。构建了ADAM数据集与评估框架，并提出AdamRAG系统以减少幻觉。**
...
- **链接: [http://arxiv.org/pdf/2509.24186v1](http://arxiv.org/pdf/2509.24186v1)**
...
- **简介: 该论文研究Transformer在程序追踪生成任务中的局限性，探索其在不同场景下的泛化能力与改进方法。**
...
- **简介: 该论文属于多语言推理任务，旨在解决LLMs在跨语言场景下的推理能力不足问题。通过对比强化学习与监督微调，发现RL在跨语言泛化上表现更优。**
...
- **链接: [http://arxiv.org/pdf/2509.25138v1](http://arxiv.org/pdf/2509.25138v1)**
...
- **简介: 该论文属于机器学习中的推理任务，旨在解决数据依赖性强、质量不稳的问题。通过自进化框架Socratic-Zero生成高质量训练数据，提升模型推理能力。**
...
- **简介: 该论文研究预训练文本与合成数据对上下文学习的影响，旨在优化模型性能。任务是评估不同数据策略在相同计算预算下的效果，通过实验发现自然文本更有效。**
...
- **简介: 该论文属于自然语言处理任务，解决LLMs在多项选择题上的知识-预测差距问题。通过分析隐藏状态，提出KAPPA方法对齐知识与预测空间，提升准确率。**
...
- **简介: 该论文参与QIAS 2025伊斯兰知识问答任务，提出混合检索增强生成系统，结合多种检索方法提升大模型性能。**
...
- **简介: 该论文属于医疗问答任务，旨在解决模型推理长度与效率的平衡问题。提出AdaThink-Med框架，通过不确定性引导的长度校准实现自适应推理，减少冗余计算。**
...
- **简介: 该论文属于阿拉伯语语音欺骗检测任务，旨在解决阿拉伯语方言中真实与合成语音区分难题。工作包括构建多方言数据集，并评估不同文本转语音模型的生成效果。**
...
- **简介: 该论文属于数据解析任务，解决开放源代码模型在处理复杂数据分析时的不足。提出DataMind框架，提升模型泛化能力和稳定性。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决LLMs中的社会偏见与文化常识的平衡问题。通过构建日本基准数据集SOBACO，评估去偏方法对文化常识的影响，发现去偏会显著降低模型在文化常识任务上的表现。**
...
- **简介: 该论文属于教育领域的问答任务，旨在利用多模态大语言模型自动回答学生从课程视频中提出的问题。研究构建了EduVidQA数据集，并评估了模型性能。**
...
- **简介: 该论文属于自然语言处理任务，旨在生成可与传统语料库对比的LLM生成语料，解决人类写作与AI文本比较的问题。工作包括构建英捷语料库并进行标注。**
...
- **简介: 该论文研究LLMs中内在与提示值表达的机制差异，旨在理解其在价值对齐中的作用。通过分析值向量和值神经元，揭示两者既有共通部分也有独特之处。**
...
- **简介: 该论文研究K-pop歌词中的语言切换现象，分析其在全球排行榜成功中的作用，属于语言学与音乐产业交叉研究，旨在揭示语言策略与市场成功的关系。**
...
- **简介: 该论文属于领域自适应任务，旨在提升大语言模型在专业领域的准确性。通过分析错误层级结构，提出分阶段纠错框架，有效提高医疗、法律等领域的模型性能。**
...
- **简介: 该论文属于分子生成任务，旨在解决LLMs生成无效分子的问题。通过提出SmiSelf框架，将无效SMILES转换为有效SELFIES，实现100%有效性。**
...
- **简介: 该论文属于社会智能对话任务，旨在解决LLM缺乏理论心智的问题。通过引入ToMAgent，提升对话效果与目标达成效率。**
...
>
---
#### [new 066] CCD: Mitigating Hallucinations in Radiology MLLMs via Clinical Contrastive Decoding
- **分类: cs.CL; cs.AI; cs.CV; I.2.10; J.3; I.5.4**

- **简介: 该论文属于医学影像报告生成任务，旨在解决MLLM在放射学中产生的医学幻觉问题。通过引入CCD框架，提升报告的临床准确性。**

- **链接: [http://arxiv.org/pdf/2509.23379v1](http://arxiv.org/pdf/2509.23379v1)**
...
>
---
#### [new 067] From Personal to Collective: On the Role of Local and Global Memory in LLM Personalization
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于LLM个性化任务，解决冷启动和偏差问题。提出LoGo框架，结合局部与全局记忆，提升个性化效果。**

- **链接: [http://arxiv.org/pdf/2509.23767v1](http://arxiv.org/pdf/2509.23767v1)**
...
>
---
#### [new 070] ByteSized32Refactored: Towards an Extensible Interactive Text Games Corpus for LLM World Modeling and Evaluation
- **分类: cs.CL**

- **简介: 该论文属于文本游戏生成任务，旨在解决LLM世界建模与评估问题。通过重构ByteSized32，优化代码结构，提升可扩展性与效率。**

- **链接: [http://arxiv.org/pdf/2509.23979v1](http://arxiv.org/pdf/2509.23979v1)**
...
>
> **摘要:** Large Language Models (LLMs) increasingly rely on chain-of-thought (CoT) reasoning to improve accuracy on complex tasks. However, always generating lengthy reasoning traces is inefficient, leading to excessive token usage and higher inference costs. This paper introduces the Hybrid Policy Optimization (i.e., HiPO), a framework for adaptive reasoning control that enables LLMs to selectively decide when to engage in detailed reasoning (Think-on) and when to respond directly (Think-off). Specifically, HiPO combines a hybrid data pipelineproviding paired Think-on and Think-off responseswith a hybrid reinforcement learning reward system that balances accuracy and efficiency while avoiding over-reliance on detailed reasoning. Experiments across mathematics and coding benchmarks demonstrate that HiPO can substantially reduce token length while maintaining or improving accuracy. Finally, we hope HiPO a can be a principled approach for efficient adaptive reasoning, advancing the deployment of reasoning-oriented LLMs in real-world, resource-sensitive settings.
>
---
#### [new 075] AceSearcher: Bootstrapping Reasoning and Search for LLMs via Reinforced Self-Play
- **分类: cs.CL; cs.AI; cs.IR; cs.LG**

- **简介: 该论文提出AceSearcher，解决LLMs在复杂推理任务中的多跳检索和推理能力不足问题，通过自博弈训练提升性能。**

- **链接: [http://arxiv.org/pdf/2509.24193v1](http://arxiv.org/pdf/2509.24193v1)**
...
>
---
#### [new 082] Alignment through Meta-Weighted Online Sampling: Bridging the Gap between Data Generation and Preference Optimization
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于大模型对齐任务，解决数据生成与偏好优化间的分布不匹配问题。提出MetaAPO框架，动态耦合数据生成与训练，提升效果并降低标注成本。**

- **链接: [http://arxiv.org/pdf/2509.23371v1](http://arxiv.org/pdf/2509.23371v1)**
...
>
---
#### [new 083] CDT: A Comprehensive Capability Framework for Large Language Models Across Cognition, Domain, and Task
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理领域，旨在解决LLM评估框架不足的问题。提出CDT框架，从认知、领域和任务三方面全面评估模型能力。**

- **链接: [http://arxiv.org/pdf/2509.24422v1](http://arxiv.org/pdf/2509.24422v1)**
...
>
---
#### [new 088] d$^2$Cache: Accelerating Diffusion-Based LLMs via Dual Adaptive Caching
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决扩散型大语言模型推理效率低的问题。通过引入d²Cache框架，实现快速KV缓存优化，提升生成速度与质量。**

- **链接: [http://arxiv.org/pdf/2509.23094v1](http://arxiv.org/pdf/2509.23094v1)**
...
>
---
#### [new 089] Open-DeBias: Toward Mitigating Open-Set Bias in Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的偏见缓解任务，旨在解决开放集文本问答中的社会偏见问题。提出Open-DeBias方法，有效减少已知和未知偏见，提升模型公平性。**

- **链接: [http://arxiv.org/pdf/2509.23805v1](http://arxiv.org/pdf/2509.23805v1)**
...
>
---
#### [new 095] SPELL: Self-Play Reinforcement Learning for evolving Long-Context Language Models
- **分类: cs.CL**

- **简介: 该论文属于长文本推理任务，解决LLM在处理长文本时的性能不足问题。通过自博弈强化学习框架SPELL，实现无需标注的数据优化，提升模型推理能力。**

- **链接: [http://arxiv.org/pdf/2509.23863v1](http://arxiv.org/pdf/2509.23863v1)**

> **作者:** Ziyi Yang; Weizhou Shen; Ruijun Chen; Chenliang Li; Fanqi Wan; Ming Yan; Xiaojun Quan; Fei Huang
>
...
>
---
#### [new 106] RAR$^2$: Retrieval-Augmented Medical Reasoning via Thought-Driven Retrieval
- **分类: cs.CL**

- **简介: 该论文属于医学问答任务，旨在解决复杂医疗问题中的知识不足和推理缺陷。提出RAR$^2$框架，结合推理与检索，提升问答准确性。**

- **链接: [http://arxiv.org/pdf/2509.22713v1](http://arxiv.org/pdf/2509.22713v1)**

> **作者:** Kaishuai Xu; Wenjun Hou; Yi Cheng; Wenjie Li
>
...
>
---
#### [new 107] MIRAGE: Multi-hop Reasoning with Ambiguity Evaluation for Illusory Questions
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多跳问答任务，解决模糊性带来的推理挑战。提出MIRAGE基准和CLARION框架，提升模型处理多层模糊性推理的能力。**

- **链接: [http://arxiv.org/pdf/2509.22750v1](http://arxiv.org/pdf/2509.22750v1)**

> **作者:** Jeonghyun Park; Ingeol Baek; Seunghyun Yoon; Haeun Jang; Aparna Garimella; Akriti Jain; Nedim Lipka; Hwanhee Lee
>
...
>
---
#### [new 110] Multi-Modal Sentiment Analysis with Dynamic Attention Fusion
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多模态情感分析任务，解决传统方法仅依赖文本忽略非语言线索的问题。通过动态注意力融合框架，结合文本和语音特征，提升情感预测效果。**

- **链接: [http://arxiv.org/pdf/2509.22729v1](http://arxiv.org/pdf/2509.22729v1)**

> **作者:** Sadia Abdulhalim; Muaz Albaghdadi; Moshiur Farazi
>
...
>
---
#### [new 118] SimuHome: A Temporal- and Environment-Aware Benchmark for Smart Home LLM Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于智能家庭领域，旨在解决LLM代理在处理时间依赖和环境感知任务中的挑战。提出SimuHome仿真平台与基准测试，评估代理在复杂任务中的表现。**

- **链接: [http://arxiv.org/pdf/2509.24282v1](http://arxiv.org/pdf/2509.24282v1)**
...
>
---
#### [new 119] EasySteer: A Unified Framework for High-Performance and Extensible LLM Steering
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型控制任务，解决LLM steering的效率与扩展性问题。提出EasySteer框架，提升推理速度并支持多种应用。**

- **链接: [http://arxiv.org/pdf/2509.25175v1](http://arxiv.org/pdf/2509.25175v1)**
...
>
---
#### [new 120] C-Evolve: Consensus-based Evolution for Prompt Groups
- **分类: cs.CL**

- **简介: 该论文属于AI系统优化任务，旨在通过聚合多个提示的共识提升模型性能。工作是提出C-Evolve算法，利用群体进化和投票机制优化提示组。**

- **链接: [http://arxiv.org/pdf/2509.23331v1](http://arxiv.org/pdf/2509.23331v1)**

> **作者:** Tiancheng Li; Yuhang Wang; Zhiyang Chen; Zijun Wang; Liyuan Ma; Guo-jun Qi
>
...
>
---
#### [new 127] HarmMetric Eval: Benchmarking Metrics and Judges for LLM Harmfulness Assessment
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于LLM有害性评估任务，旨在解决现有评估指标和判断者效果不明确的问题。工作包括构建基准HarmMetric Eval，并发现传统指标优于LLM judges。**

- **链接: [http://arxiv.org/pdf/2509.24384v1](http://arxiv.org/pdf/2509.24384v1)**
...
>
---
#### [new 132] HiKE: Hierarchical Evaluation Framework for Korean-English Code-Switching Speech Recognition
...
>
---
#### [new 133] Enabling Approximate Joint Sampling in Diffusion LMs
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，解决扩散语言模型中并行生成文本时偏离真实联合分布的问题。通过设计轻量级采样器，实现单次前向传播中近似联合采样，提升生成质量。**

- **链接: [http://arxiv.org/pdf/2509.22738v1](http://arxiv.org/pdf/2509.22738v1)**
...
>
---
#### [new 139] SemShareKV: Efficient KVCache Sharing for Semantically Similar Prompts via Token-Level LSH Matching
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，解决LLM推理中KV缓存占用过高的问题。通过语义相似提示的token级LSH匹配实现缓存共享，提升效率并降低内存使用。**

- **链接: [http://arxiv.org/pdf/2509.24832v1](http://arxiv.org/pdf/2509.24832v1)**

> **作者:** Xinye Zhao; Spyridon Mastorakis
>
> **备注:** 11 figures, 14pages
>
> **摘要:** As large language models (LLMs) continue to scale, the memory footprint of key-value (KV) caches during inference has become a significant bottleneck. Existing approaches primarily focus on compressing KV caches within a single prompt or reusing shared prefixes or frequently ocurred text segments across prompts. However, such strategies are limited in scenarios where prompts are semantically similar but lexically different, which frequently occurs in tasks such as multi-document summarization and conversational agents. We propose \textit{SemShareKV}, a KV cache sharing and compression framework that accelerates LLM inference by reusing KVCache in semantically similar prompts. Instead of relying on exact token matches, SemShareKV applies fuzzy token matching using locality-sensitive hashing (LSH) on token embeddings and incorporates Rotary Position Embedding (RoPE) to better preserve positional information. By selectively reusing relevant key-value pairs from a reference prompt's cache, SemShareKV reduces redundant computation while maintaining output quality. Experiments on diverse summarization datasets show up to 6.25$\times$ speedup and 42\% lower GPU memory usage with 5k tokens input, with negligible quality degradation. These results highlight the potential of semantic-aware cache sharing for efficient LLM inference.
>
---
#### [new 140] BTC-SAM: Leveraging LLMs for Generation of Bias Test Cases for Sentiment Analysis Models
- **分类: cs.CL**

- **简介: 该论文属于情感分析模型的偏见测试任务，旨在解决人工构建测试用例成本高的问题，通过LLMs生成高质量、多样化的测试句子。**

- **链接: [http://arxiv.org/pdf/2509.24101v1](http://arxiv.org/pdf/2509.24101v1)**
...
>
---
#### [new 141] ProxyAttn: Guided Sparse Attention via Representative Heads
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，解决LLM在长文本处理中的效率问题。通过稀疏注意力机制提升计算效率，实现更快的预填充速度。**

- **链接: [http://arxiv.org/pdf/2509.24745v1](http://arxiv.org/pdf/2509.24745v1)**
...
>
---
#### [new 142] The Hidden Costs of Translation Accuracy: Distillation, Quantization, and Environmental Impact
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于机器翻译任务，研究模型压缩策略对翻译质量与环境影响的平衡，比较了完整、蒸馏和量化模型的性能与碳排放，旨在提升效率与可持续性。**

- **链接: [http://arxiv.org/pdf/2509.23990v1](http://arxiv.org/pdf/2509.23990v1)**
...
>
---
#### [new 143] Don't Settle Too Early: Self-Reflective Remasking for Diffusion Language Models
- **分类: cs.CL**

- **简介: 该论文属于文本生成任务，解决DLMs难以修正错误token的问题。提出RemeDi模型，通过remasking机制动态调整生成过程，提升文本质量。**

- **链接: [http://arxiv.org/pdf/2509.23653v1](http://arxiv.org/pdf/2509.23653v1)**
...
>
---
#### [new 144] Towards Personalized Deep Research: Benchmarks and Evaluations
- **分类: cs.CL; cs.AI; cs.IR**

- **简介: 该论文属于AI研究助手领域，旨在解决个性化深度研究评估不足的问题。提出首个个性化深度研究基准及评估框架，以提升系统在个性化场景下的表现。**

- **链接: [http://arxiv.org/pdf/2509.25106v1](http://arxiv.org/pdf/2509.25106v1)**
...
>
---
#### [new 145] A Text-To-Text Alignment Algorithm for Better Evaluation of Modern Speech Recognition Systems
- **分类: cs.CL**

- **简介: 该论文属于语音识别任务，旨在解决传统评估方法无法准确分析罕见词错误的问题。提出一种结合动态规划和束搜索的文本对齐算法，提升误差分析精度。**

- **链接: [http://arxiv.org/pdf/2509.24478v1](http://arxiv.org/pdf/2509.24478v1)**
...
>
---
#### [new 146] SparseD: Sparse Attention for Diffusion Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决扩散语言模型推理延迟高的问题。通过设计稀疏注意力机制SparseD，提升效率并保持生成质量。**

- **链接: [http://arxiv.org/pdf/2509.24014v1](http://arxiv.org/pdf/2509.24014v1)**

> **作者:** Zeqing Wang; Gongfan Fang; Xinyin Ma; Xingyi Yang; Xinchao Wang
>
> **备注:** The code is available at https://github.com/INV-WZQ/SparseD
>
...
>
---
#### [new 158] MCPMark: A Benchmark for Stress-Testing Realistic and Comprehensive MCP Use
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大模型评估任务，旨在解决现有MCP基准测试不足的问题。提出MCPMark，通过多样化任务全面评估模型交互能力。**

- **链接: [http://arxiv.org/pdf/2509.24002v1](http://arxiv.org/pdf/2509.24002v1)**
...
>
> **摘要:** MCP standardizes how LLMs interact with external systems, forming the foundation for general agents. However, existing MCP benchmarks remain narrow in scope: they focus on read-heavy tasks or tasks with limited interaction depth, and fail to capture the complexity and realism of real-world workflows. To address this gap, we propose MCPMark, a benchmark designed to evaluate MCP use in a more realistic and comprehensive manner. It consists of $127$ high-quality tasks collaboratively created by domain experts and AI agents. Each task begins with a curated initial state and includes a programmatic script for automatic verification. These tasks demand richer and more diverse interactions with the environment, involving a broad range of create, read, update, and delete (CRUD) operations. We conduct a comprehensive evaluation of cutting-edge LLMs using a minimal agent framework that operates in a tool-calling loop. Empirical results show that the best-performing model, gpt-5-medium, reaches only $52.56$\% pass@1 and $33.86$\% pass^4, while other widely regarded strong models, including claude-sonnet-4 and o3, fall below $30$\% pass@1 and $15$\% pass^4. On average, LLMs require $16.2$ execution turns and $17.4$ tool calls per task, significantly surpassing those in previous MCP benchmarks and highlighting the stress-testing nature of MCPMark.
>
---
#### [new 159] A2D: Any-Order, Any-Step Safety Alignment for Diffusion Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于安全对齐任务，旨在解决扩散语言模型中任意位置生成有害内容的问题。提出A2D方法，在token级别实现安全对齐，有效阻止有害输出。**

- **链接: [http://arxiv.org/pdf/2509.23286v1](http://arxiv.org/pdf/2509.23286v1)**
...
>
---
#### [new 163] Localizing Task Recognition and Task Learning in In-Context Learning via Attention Head Analysis
- **分类: cs.CL**

- **简介: 该论文研究大语言模型中的上下文学习机制，解决如何分解任务识别与任务学习的问题。通过分析注意力头，提出TSLA框架，揭示其在任务识别和学习中的不同作用。**

- **链接: [http://arxiv.org/pdf/2509.24164v1](http://arxiv.org/pdf/2509.24164v1)**
...
>
---
#### [new 164] Emergent morpho-phonological representations in self-supervised speech models
- **分类: cs.CL**

- **简介: 该论文研究自监督语音模型如何表征语言信息，旨在理解其在单词识别任务中的语素和音位表示。工作包括分析模型对英语名词和动词变化的几何结构表示。**

- **链接: [http://arxiv.org/pdf/2509.22973v1](http://arxiv.org/pdf/2509.22973v1)**

> **作者:** Jon Gauthier; Canaan Breiss; Matthew Leonard; Edward F. Chang
>
> **备注:** Accepted at EMNLP 2025
>
...
>
---
#### [new 165] Reference-Free Rating of LLM Responses via Latent Information
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于大模型评估任务，解决无参考情况下评分不稳定的问题。通过分析模型内部信息，提出三种方法提升评分准确性与稳定性。**

- **链接: [http://arxiv.org/pdf/2509.24678v1](http://arxiv.org/pdf/2509.24678v1)**
...
>
---
#### [new 166] Test-Time Policy Adaptation for Enhanced Multi-Turn Interactions with LLMs
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决LLMs在多轮交互中性能下降的问题。提出T2PAM框架和ROSA算法，通过用户反馈实时优化模型策略，提升交互效果与效率。**

- **链接: [http://arxiv.org/pdf/2509.23166v1](http://arxiv.org/pdf/2509.23166v1)**
...
>
---
#### [new 167] Hyperdimensional Probe: Decoding LLM Representations via Vector Symbolic Architectures
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理中的模型解释任务，旨在解决LLM内部表示难以理解的问题。提出Hyperdimensional Probe方法，利用VSAs技术解码LLM向量空间中的可解释概念。**

- **链接: [http://arxiv.org/pdf/2509.25045v1](http://arxiv.org/pdf/2509.25045v1)**
...
>
---
#### [new 179] Comparison of Scoring Rationales Between Large Language Models and Human Raters
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自动化评分任务，旨在比较LLM与人类评分者的评分逻辑，通过分析一致性、相似性和聚类模式，提升对两者评分机制的理解。**

- **链接: [http://arxiv.org/pdf/2509.23412v1](http://arxiv.org/pdf/2509.23412v1)**
...
>
---
#### [new 180] Winning the Pruning Gamble: A Unified Approach to Joint Sample and Token Pruning for Efficient Supervised Fine-Tuning
- **分类: cs.CL**

- **简介: 该论文属于语言模型微调任务，解决数据效率问题。通过联合样本和标记剪枝，提升在有限预算下的模型性能。**

- **链接: [http://arxiv.org/pdf/2509.23873v1](http://arxiv.org/pdf/2509.23873v1)**
...
>
---
#### [new 181] DiaCDM: Cognitive Diagnosis in Teacher-Student Dialogues using the Initiation-Response-Evaluation Framework
- **分类: cs.CL**

- **简介: 该论文属于认知诊断任务，旨在解决教师-学生对话中知识掌握评估的问题。提出DiaCDM模型，结合IRE框架和图编码方法，提升诊断准确性和可解释性。**

- **链接: [http://arxiv.org/pdf/2509.24821v1](http://arxiv.org/pdf/2509.24821v1)**
...
>
---
#### [new 185] Dual-Space Smoothness for Robust and Balanced LLM Unlearning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于机器学习中的模型遗忘任务，旨在解决遗忘效果与模型性能间的不平衡及安全问题。提出PRISM框架，通过双空间平滑提升鲁棒性与平衡性。**

- **链接: [http://arxiv.org/pdf/2509.23362v1](http://arxiv.org/pdf/2509.23362v1)**
...
>
---
#### [new 187] InfoAgent: Advancing Autonomous Information-Seeking Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于信息检索任务，旨在提升AI代理的自主搜索能力。通过构建数据合成管道和自建搜索系统，解决传统方法依赖商业工具的问题，并提高代理的问答准确性。**

- **链接: [http://arxiv.org/pdf/2509.25189v1](http://arxiv.org/pdf/2509.25189v1)**
...
>
---
#### [new 189] GEAR: A General Evaluation Framework for Abductive Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于Abductive Reasoning任务，解决如何评估大模型发现新知识的能力。提出GEAR框架，通过一致性、泛化性和多样性评分，实现自动化、无标签的模型评估与训练优化。**

- **链接: [http://arxiv.org/pdf/2509.24096v1](http://arxiv.org/pdf/2509.24096v1)**
...
>
---
#### [new 193] PARL-MT: Learning to Call Functions in Multi-Turn Conversation with Progress Awareness
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多轮对话中的函数调用任务，旨在解决多轮对话中保持进展意识的问题。工作包括构建数据集和引入强化学习方法以提升任务执行效果。**

- **链接: [http://arxiv.org/pdf/2509.23206v1](http://arxiv.org/pdf/2509.23206v1)**
...
>
---
#### [new 194] HEART: Emotionally-driven test-time scaling of Language Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在提升语言模型的推理能力。通过引入情感驱动的反馈机制，解决模型在复杂推理中陷入错误路径的问题。**

- **链接: [http://arxiv.org/pdf/2509.22876v1](http://arxiv.org/pdf/2509.22876v1)**

> **作者:** Gabriela Pinto; Palash Goyal; Yiwen Song; Souradip Chakraborty; Zifeng Wang; Tomas Pfister; Hamid Palangi
>
...
>
---
#### [new 197] Causally-Enhanced Reinforcement Policy Optimization
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决大模型生成过程中的因果不一致问题。通过引入CE-PO框架，增强策略优化的因果一致性，提升模型的鲁棒性和可信度。**

- **链接: [http://arxiv.org/pdf/2509.23095v1](http://arxiv.org/pdf/2509.23095v1)**
...
>
---
#### [new 200] VSSFlow: Unifying Video-conditioned Sound and Speech Generation via Joint Learning
...
>
---
#### [new 201] PARROT: A Benchmark for Evaluating LLMs in Cross-System SQL Translation
- **分类: cs.DB; cs.AI; cs.CL; cs.IR; cs.LG**

- **简介: 该论文属于SQL翻译任务，解决跨数据库系统SQL转换问题。提出PARROT基准，包含多种SQL翻译数据集，以评估LLMs在不同数据库系统间的SQL理解能力。**

- **链接: [http://arxiv.org/pdf/2509.23338v1](http://arxiv.org/pdf/2509.23338v1)**
...
>
---
#### [new 202] SCI-Verifier: Scientific Verifier with Thinking
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于科学验证任务，旨在解决LLM答案验证的复杂性和多样性问题。构建了SCI-VerifyBench基准和SCI-Verifier模型，提升验证准确性与通用性。**

- **链接: [http://arxiv.org/pdf/2509.24285v1](http://arxiv.org/pdf/2509.24285v1)**
...
>
---
#### [new 204] Adaptive Margin RLHF via Preference over Preferences
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，解决奖励模型中偏好边缘不足的问题。通过引入偏好间的偏好信号，提出DPO-PoP方法，实现自适应边缘优化，提升分类与生成性能。**

- **链接: [http://arxiv.org/pdf/2509.22851v1](http://arxiv.org/pdf/2509.22851v1)**
...
>
---
#### [new 205] Beyond the Exploration-Exploitation Trade-off: A Hidden State Approach for LLM Reasoning in RLVR
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决LLM推理中的探索与利用平衡问题。通过引入隐藏状态分析和新指标，提出VERL方法实现协同增强。**

- **链接: [http://arxiv.org/pdf/2509.23808v1](http://arxiv.org/pdf/2509.23808v1)**
...
>
---
#### [new 208] CAOTE: KV Cache Selection for LLMs via Attention Output Error-Based Token Eviction
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于大语言模型优化任务，解决长上下文支持下的内存瓶颈问题。通过引入基于注意力输出误差的令牌驱逐方法CAOTE，提升驱逐准确性。**

- **链接: [http://arxiv.org/pdf/2504.14051v5](http://arxiv.org/pdf/2504.14051v5)**
...
>
---
#### [new 212] GSM8K-V: Can Vision Language Models Solve Grade School Math Word Problems in Visual Contexts
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于视觉数学推理任务，旨在解决现有基准缺乏多图数学问题评估的问题。通过构建GSM8K-V数据集，评估模型在视觉环境下的数学推理能力。**

- **链接: [http://arxiv.org/pdf/2509.25160v1](http://arxiv.org/pdf/2509.25160v1)**
...
>
---
#### [new 216] Clean First, Align Later: Benchmarking Preference Data Cleaning for Reliable LLM Alignment
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于LLM对齐任务，解决人类反馈数据噪声问题。通过构建基准测试，评估13种数据清洗方法，提升模型对齐效果。**

- **链接: [http://arxiv.org/pdf/2509.23564v1](http://arxiv.org/pdf/2509.23564v1)**
...
>
---
#### [new 226] MASLegalBench: Benchmarking Multi-Agent Systems in Deductive Legal Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于法律推理任务，旨在解决多智能体系统在法律领域评估不足的问题。提出MASLegalBench基准，用于评估多智能体在法律推理中的表现。**

- **链接: [http://arxiv.org/pdf/2509.24922v1](http://arxiv.org/pdf/2509.24922v1)**

> **作者:** Huihao Jing; Wenbin Hu; Hongyu Luo; Jianhui Yang; Wei Fan; Haoran Li; Yangqiu Song
>
> **摘要:** Multi-agent systems (MAS), leveraging the remarkable capabilities of Large Language Models (LLMs), show great potential in addressing complex tasks. In this context, integrating MAS with legal tasks is a crucial step. While previous studies have developed legal benchmarks for LLM agents, none are specifically designed to consider the unique advantages of MAS, such as task decomposition, agent specialization, and flexible training. In fact, the lack of evaluation methods limits the potential of MAS in the legal domain. To address this gap, we propose MASLegalBench, a legal benchmark tailored for MAS and designed with a deductive reasoning approach. Our benchmark uses GDPR as the application scenario, encompassing extensive background knowledge and covering complex reasoning processes that effectively reflect the intricacies of real-world legal situations. Furthermore, we manually design various role-based MAS and conduct extensive experiments using different state-of-the-art LLMs. Our results highlight the strengths, limitations, and potential areas for improvement of existing models and MAS architectures.
>
---
#### [new 227] Learning from Convenience Samples: A Case Study on Fine-Tuning LLMs for Survey Non-response in the German Longitudinal Election Study
- **分类: cs.CY; cs.CL**
...
>
---
#### [new 231] Tracing the Representation Geometry of Language Models from Pretraining to Post-training
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究大语言模型表示几何的变化，解决如何理解模型能力涌现的问题。通过分析预训练和微调过程中的几何阶段，揭示了模型表征的动态演化规律。**

- **链接: [http://arxiv.org/pdf/2509.23024v1](http://arxiv.org/pdf/2509.23024v1)**
...
>
---
#### [new 233] NeMo: Needle in a Montage for Video-Language Understanding
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出NeMo任务，解决视频语言理解中的长时记忆和时间定位问题。构建了NeMoBench基准，通过自动化数据生成评估视频大模型性能。**

- **链接: [http://arxiv.org/pdf/2509.24563v1](http://arxiv.org/pdf/2509.24563v1)**
...
>
---
#### [new 234] Reasoning or Retrieval? A Study of Answer Attribution on Large Reasoning Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，研究大模型回答不一致的问题。通过实验发现模型依赖推理和检索两种机制，提出FARL框架提升推理能力。**

- **链接: [http://arxiv.org/pdf/2509.24156v1](http://arxiv.org/pdf/2509.24156v1)**
...
>
---
#### [new 249] $p$-less Sampling: A Robust Hyperparameter-Free Approach for LLM Decoding
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于语言模型解码任务，旨在解决采样方法对超参数依赖的问题。提出p-less采样，无需超参数且提升生成质量与效率。**

- **链接: [http://arxiv.org/pdf/2509.23234v1](http://arxiv.org/pdf/2509.23234v1)**
...
>
---
#### [new 257] OrthAlign: Orthogonal Subspace Decomposition for Non-Interfering Multi-Objective Alignment
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于多目标对齐任务，解决LLM在多个偏好间存在冲突的问题。提出OrthAlign方法，通过正交子空间分解实现非干扰优化，提升对齐效果。**

- **链接: [http://arxiv.org/pdf/2509.24610v1](http://arxiv.org/pdf/2509.24610v1)**
...
>
---
#### [new 258] On the Self-awareness of Large Reasoning Models' Capability Boundaries
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于模型自我认知研究，旨在解决LRMs在复杂任务中的能力边界识别问题。通过分析推理过程和隐藏状态，提出优化策略以提升模型效率与可靠性。**

- **链接: [http://arxiv.org/pdf/2509.24711v1](http://arxiv.org/pdf/2509.24711v1)**
...
>
---
#### [new 259] Benefits and Pitfalls of Reinforcement Learning for Language Model Planning: A Theoretical Perspective
- **分类: cs.AI; cs.CL; cs.LG; stat.ML**

- **简介: 该论文研究强化学习在语言模型规划中的应用，分析其优势与局限，解决理论理解不足的问题，通过理论分析和实验验证RL方法的有效性与挑战。**

- **链接: [http://arxiv.org/pdf/2509.22613v1](http://arxiv.org/pdf/2509.22613v1)**
...
>
---
#### [new 260] Do Repetitions Matter? Strengthening Reliability in LLM Evaluations
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于模型评估任务，解决LLM排行榜可靠性问题。通过多次运行分析，发现单次运行不可靠，建议至少两次重复以提高结果稳定性。**

- **链接: [http://arxiv.org/pdf/2509.24086v1](http://arxiv.org/pdf/2509.24086v1)**
...
>
---
#### [new 263] Multi-modal Data Spectrum: Multi-modal Datasets are Multi-dimensional
- **分类: cs.CV; cs.CL; cs.LG**

- **简介: 该论文属于多模态学习任务，旨在解决多模态数据依赖性分析问题。通过大规模实验，量化了视觉、文本及其交互在不同基准中的依赖程度，揭示了现有基准的偏差问题。**

- **链接: [http://arxiv.org/pdf/2509.23499v1](http://arxiv.org/pdf/2509.23499v1)**
...
>
---
#### [new 264] Explore-Execute Chain: Towards an Efficient Structured Reasoning Paradigm
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文属于结构化推理任务，旨在解决LLM推理效率低、可解释性差的问题。提出E²C框架，分离探索与执行阶段，提升效率和准确性。**

- **链接: [http://arxiv.org/pdf/2509.23946v1](http://arxiv.org/pdf/2509.23946v1)**

> **作者:** Kaisen Yang; Lixuan He; Rushi Shah; Kaicheng Yang; Qinwei Ma; Dianbo Liu; Alex Lamb
>
> **备注:** Under review ICLR 2026
>
> **摘要:** Chain-of-Thought (CoT) and its variants have markedly advanced the reasoning abilities of Large Language Models (LLMs), yet their monolithic and auto-regressive architecture inherently conflates high-level strategic planning with low-level step-by-step execution, leading to computational inefficiency, limited exploration of reasoning paths, and reduced interpretability. To overcome these issues, we propose the Explore-Execute Chain ($E^2C$), a structured reasoning framework that decouples reasoning into two distinct phases: an exploratory phase that stochastically generates succinct high-level plans, followed by an execution phase that deterministically carries out the chosen plan. Our approach incorporates a two-stage training methodology, which combines Supervised Fine-Tuning (SFT) - augmented by a novel data generation algorithm enforcing strict plan adherence - with a subsequent Reinforcement Learning (RL) stage that capitalizes on the informativeness of exploration and reinforces the determinism of execution.This decomposition enables an efficient test-time scaling strategy: on AIME'2024, $E^2C$ Test Time Scaling reaches 58.1% accuracy using <10% of the decoding tokens required by comparable methods (e.g., Forest-of-Thought), sharply cutting self-consistency overhead. For cross-domain adaptation, our Exploration-Focused SFT (EF-SFT) fine-tunes with only 3.5% of the tokens used by standard SFT yet yields up to 14.5% higher accuracy than standard SFT on medical benchmarks, delivering state-of-the-art performance, strong generalization, and greater interpretability by separating planning from execution. The code and pre-trained models for the project are available at: https://github.com/yks23/Explore-Execute-Chain.git
>
---
#### [new 265] Pushing LLMs to Their Logical Reasoning Bound: The Role of Data Reasoning Intensity
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在提升LLM逻辑推理能力。解决训练数据推理复杂度不足的问题，提出DRI指标并优化数据逻辑强度以增强模型表现。**

- **链接: [http://arxiv.org/pdf/2509.24836v1](http://arxiv.org/pdf/2509.24836v1)**
...
>
---
#### [new 266] Kimi-Dev: Agentless Training as Skill Prior for SWE-Agents
- **分类: cs.AI; cs.CL; cs.SE**

- **简介: 该论文属于软件工程领域的语言模型研究，旨在提升SWE-Agents的性能。通过Agentless训练引入技能先验，优化代码生成与修复能力。**

- **链接: [http://arxiv.org/pdf/2509.23045v1](http://arxiv.org/pdf/2509.23045v1)**
...
>
---
#### [new 267] Bridging the behavior-neural gap: A multimodal AI reveals the brain's geometry of emotion more accurately than human self-reports
...
>
---
#### [new 270] Knowledge Homophily in Large Language Models
- **分类: cs.LG; cs.AI; cs.CL; cs.SI**

- **简介: 该论文研究LLM中的知识同质性，解决知识组织结构不明确的问题。通过图神经网络评估实体知识水平，提升知识覆盖效率与问答性能。**

- **链接: [http://arxiv.org/pdf/2509.23773v1](http://arxiv.org/pdf/2509.23773v1)**
...
>
---
#### [new 271] From $f(x)$ and $g(x)$ to $f(g(x))$: LLMs Learn New Skills in RL by Composing Old Ones
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，研究LLMs是否通过组合已有技能获得新能力。工作包括设计合成框架验证LLMs能通过RL学习新组合技能并实现跨任务迁移。**

- **链接: [http://arxiv.org/pdf/2509.25123v1](http://arxiv.org/pdf/2509.25123v1)**
...
>
---
#### [new 272] DiaMoE-TTS: A Unified IPA-Based Dialect TTS Framework with Mixture-of-Experts and Parameter-Efficient Zero-Shot Adaptation
...
>
---
#### [new 282] PCRI: Measuring Context Robustness in Multimodal Models for Enterprise Applications
- **分类: cs.CV; cs.AI; cs.CL; cs.MM; 68T50, 68T45; I.2.7; I.2.10; I.4.8; I.4.10; I.4.0**

- **简介: 该论文属于多模态模型评估任务，旨在解决模型对视觉背景噪声敏感的问题。提出PCRI指标，评估模型在不同视觉上下文下的鲁棒性。**

- **链接: [http://arxiv.org/pdf/2509.23879v1](http://arxiv.org/pdf/2509.23879v1)**

> **作者:** Hitesh Laxmichand Patel; Amit Agarwal; Srikant Panda; Hansa Meghwani; Karan Dua; Paul Li; Tao Sheng; Sujith Ravi; Dan Roth
>
> **备注:** Accepted in EMNLP 2025
>
> **摘要:** The reliability of Multimodal Large Language Models (MLLMs) in real-world settings is often undermined by sensitivity to irrelevant or distracting visual context, an aspect not captured by existing evaluation metrics. We introduce the \textbf{Patch Context Robustness Index (PCRI)}, the first systematic and interpretable score for quantifying MLLM robustness to variations in visual context granularity, measuring performance changes between localized image patches and full-image input. Applying PCRI to 19 state-of-the-art MLLMs across 15 vision-language benchmarks, we find that most leading models remain brittle to background noise, with only a few, such as InternVL2-26B and Qwen2VL-72B, demonstrating consistent robustness across tasks. PCRI analysis also highlights how different model architectures handle and integrate visual context, offering actionable diagnostic insight for both researchers and practitioners. PCRI enables rigorous comparison of context robustness, supporting principled model selection and guiding the development of future architectures and training strategies for robust, real-world deployment.
>
---
#### [new 283] Metamorphic Testing for Audio Content Moderation Software
- **分类: cs.SE; cs.AI; cs.CL; cs.MM**

- **简介: 该论文属于音频内容审核任务，旨在解决恶意绕过审核系统的问题。通过提出MTAM框架，生成能规避检测的测试用例以评估审核工具的有效性。**

- **链接: [http://arxiv.org/pdf/2509.24215v1](http://arxiv.org/pdf/2509.24215v1)**
...
>
---
#### [new 284] RCI: A Score for Evaluating Global and Local Reasoning in Multimodal Benchmarks
- **分类: cs.CV; cs.AI; cs.CL; cs.MM; 68T45, 68T50; I.2.7; I.2.10; I.4.7; I.4.8**

- **简介: 该论文属于多模态任务，旨在解决现有基准测试难以区分全局与局部推理的问题。提出RCI评分，评估数据集对全局或局部视觉信息的依赖性。**

- **链接: [http://arxiv.org/pdf/2509.23673v1](http://arxiv.org/pdf/2509.23673v1)**
...
>
---
#### [new 287] VideoScore2: Think before You Score in Generative Video Evaluation
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于视频生成评估任务，解决现有评估方法单一、不透明的问题，提出VideoScore2框架，多维度评估视频质量并提供可解释性分析。**

- **链接: [http://arxiv.org/pdf/2509.22799v1](http://arxiv.org/pdf/2509.22799v1)**
...
#### [replaced 001] OmniGen2: Exploration to Advanced Multimodal Generation
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.18871v3](http://arxiv.org/pdf/2506.18871v3)**
...
>
---
#### [replaced 010] Diversity-Enhanced Reasoning for Subjective Questions
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.20187v2](http://arxiv.org/pdf/2507.20187v2)**
...
>
---
#### [replaced 011] SVeritas: Benchmark for Robust Speaker Verification under Diverse Conditions
- **分类: cs.SD; cs.CL**
...
>
---
#### [replaced 012] SynParaSpeech: Automated Synthesis of Paralinguistic Datasets for Speech Generation and Understanding
- **分类: eess.AS; cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.14946v3](http://arxiv.org/pdf/2509.14946v3)**
...
>
> **摘要:** Retrieval Augmented Generation (RAG) enhances the abilities of Large Language Models (LLMs) by enabling the retrieval of documents into the LLM context to provide more accurate and relevant responses. Existing RAG solutions do not focus on queries that may require fetching multiple documents with substantially different contents. Such queries occur frequently, but are challenging because the embeddings of these documents may be distant in the embedding space, making it hard to retrieve them all. This paper introduces Multi-Head RAG (MRAG), a novel scheme designed to address this gap with a simple yet powerful idea: leveraging activations of Transformer's multi-head attention layer, instead of the decoder layer, as keys for fetching multi-aspect documents. The driving observation is that different attention heads learn to capture different data aspects. Harnessing the corresponding activations results in embeddings that represent various facets of data items and queries, improving the retrieval accuracy for complex queries. We provide an evaluation methodology and metrics, multi-aspect datasets, and real-world use cases to demonstrate MRAG's effectiveness. We show MRAG's design advantages over 18 RAG baselines, empirical improvements of up to 20% in retrieval success ratios, and benefits for downstream LLM generation. MRAG can be seamlessly integrated with existing RAG frameworks and benchmarks.
>
---
#### [replaced 015] Streaming Sequence-to-Sequence Learning with Delayed Streams Modeling
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.08753v2](http://arxiv.org/pdf/2509.08753v2)**
...
>
---
#### [replaced 016] LiTEx: A Linguistic Taxonomy of Explanations for Understanding Within-Label Variation in Natural Language Inference
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.22848v4](http://arxiv.org/pdf/2505.22848v4)**
...
>
---
#### [replaced 017] DEL-ToM: Inference-Time Scaling for Theory-of-Mind Reasoning via Dynamic Epistemic Logic
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17348v2](http://arxiv.org/pdf/2505.17348v2)**
...
>
---
#### [replaced 018] Hierarchical Task Environments as the Next Frontier for Embodied World Models in Robot Soccer
...
>
---
#### [replaced 019] Don't Trust Generative Agents to Mimic Communication on Social Networks Unless You Benchmarked their Empirical Realism
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.21974v2](http://arxiv.org/pdf/2506.21974v2)**
...
>
---
#### [replaced 020] The Thinking Spectrum: An Empirical Study of Tunable Reasoning in LLMs through Model Merging
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22034v2](http://arxiv.org/pdf/2509.22034v2)**
...
>
---
#### [replaced 021] The Ever-Evolving Science Exam
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.16514v2](http://arxiv.org/pdf/2507.16514v2)**
...
>
---
#### [replaced 022] Align-GRAG: Reasoning-Guided Dual Alignment for Graph Retrieval-Augmented Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16237v2](http://arxiv.org/pdf/2505.16237v2)**
...
>
---
#### [replaced 025] Evaluating and Steering Modality Preferences in Multimodal Large Language Model
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.20977v2](http://arxiv.org/pdf/2505.20977v2)**
...
>
---
#### [replaced 026] A Practical Synthesis of Detecting AI-Generated Textual, Visual, and Audio Content
- **分类: cs.CL; cs.LG; 68T50, 68T45, 68T10, 68T30, 94A08, 62H30, 68U10; I.2.7; I.2.10; I.2.6; H.5.5; K.6.5; K.4.1; I.4.9; H.3.1**

- **链接: [http://arxiv.org/pdf/2504.02898v2](http://arxiv.org/pdf/2504.02898v2)**
...
>
---
#### [replaced 027] CADDesigner: Conceptual Design of CAD Models Based on General-Purpose Agent
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.01031v3](http://arxiv.org/pdf/2508.01031v3)**

> **作者:** Jingzhe Ni; Xiaolong Yin; Xingyu Lu; Xintong Li; Ji Wei; Ruofeng Tong; Min Tang; Peng Du
>
> **备注:** The theoretical proof of Context-Independent Imperative Paradigm is flawed; I request withdrawal of the manuscript
>
...
>
---
#### [replaced 028] Evaluating the Effectiveness of Transformer Layers in Wav2Vec 2.0, XLS-R, and Whisper for Speaker Identification Tasks
...
>
---
#### [replaced 029] MemeIntel: Explainable Detection of Propagandistic and Hateful Memes
- **分类: cs.CL; cs.AI; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2502.16612v2](http://arxiv.org/pdf/2502.16612v2)**
...
>
---
#### [replaced 030] OnPrem.LLM: A Privacy-Conscious Document Intelligence Toolkit
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.07672v3](http://arxiv.org/pdf/2505.07672v3)**
...
>
---
#### [replaced 033] Continual Dialogue State Tracking via Example-Guided Question Answering
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2305.13721v3](http://arxiv.org/pdf/2305.13721v3)**

> **作者:** Hyundong Cho; Andrea Madotto; Zhaojiang Lin; Khyathi Raghavi Chandu; Satwik Kottur; Jing Xu; Jonathan May; Chinnadhurai Sankar
>
> **备注:** 11 pages, EMNLP 2023
>
...
>
---
#### [replaced 038] HS-STaR: Hierarchical Sampling for Self-Taught Reasoners via Difficulty Estimation and Budget Reallocation
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.19866v2](http://arxiv.org/pdf/2505.19866v2)**

> **作者:** Feng Xiong; Hongling Xu; Yifei Wang; Runxi Cheng; Yong Wang; Xiangxiang Chu
>
> **摘要:** Self-taught reasoners (STaRs) enhance the mathematical reasoning abilities of large language models (LLMs) by leveraging self-generated responses for self-training. Recent studies have incorporated reward models to guide response selection or decoding, aiming to obtain higher-quality data. However, they typically allocate a uniform sampling budget across all problems, overlooking the varying utility of problems at different difficulty levels. In this work, we conduct an empirical study and find that problems near the boundary of the LLM's reasoning capability offer significantly greater learning utility than both easy and overly difficult ones. To identify and exploit such problems, we propose HS-STaR, a Hierarchical Sampling framework for Self-Taught Reasoners. Given a fixed sampling budget, HS-STaR first performs lightweight pre-sampling with a reward-guided difficulty estimation strategy to efficiently identify boundary-level problems. Subsequently, it dynamically reallocates the remaining budget toward these high-utility problems during a re-sampling phase, maximizing the generation of valuable training data. Extensive experiments across multiple reasoning benchmarks and backbone LLMs demonstrate that HS-STaR significantly outperforms other baselines without requiring additional sampling budget.
>
---
#### [replaced 039] Generalizable Process Reward Models via Formally Verified Training Data
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.15960v2](http://arxiv.org/pdf/2505.15960v2)**
...
>
---
#### [replaced 042] Probabilistic Soundness Guarantees in LLM Reasoning Chains
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.12948v2](http://arxiv.org/pdf/2507.12948v2)**

> **作者:** Weiqiu You; Anton Xue; Shreya Havaldar; Delip Rao; Helen Jin; Chris Callison-Burch; Eric Wong
>
> **备注:** EMNLP 2025 camera ready
>
> **摘要:** In reasoning chains generated by large language models (LLMs), initial errors often propagate and undermine the reliability of the final conclusion. Current LLM-based error detection methods often fail to detect propagated errors because earlier errors can corrupt judgments of downstream reasoning. To better detect such errors, we introduce Autoregressive Reasoning Entailment Stability (ARES), a probabilistic framework that evaluates each reasoning step based solely on previously-verified premises. This inductive method yields a nuanced score for each step and provides certified statistical guarantees of its soundness, rather than a brittle binary label. ARES achieves state-of-the-art performance across four benchmarks (72.1% Macro-F1, +8.2 points) and demonstrates superior robustness on very long synthetic reasoning chains, where it excels at detecting propagated errors (90.3% F1, +27.6 points).
>
---
#### [replaced 043] Parse Trees Guided LLM Prompt Compression
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2409.15395v3](http://arxiv.org/pdf/2409.15395v3)**
...
>
---
#### [replaced 044] Visual Planning: Let's Think Only with Images
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.11409v2](http://arxiv.org/pdf/2505.11409v2)**

> **作者:** Yi Xu; Chengzu Li; Han Zhou; Xingchen Wan; Caiqi Zhang; Anna Korhonen; Ivan Vulić
>
> **备注:** 9 pages, 6 figures, 2 tables (31 pages, 15 figures, 10 tables including references and appendices)
>
...
>
---
#### [replaced 045] Beyond Classification: Towards Speech Emotion Reasoning with Multitask AudioLLMs
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [replaced 046] Query-Focused Retrieval Heads Improve Long-Context Reasoning and Re-ranking
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.09944v2](http://arxiv.org/pdf/2506.09944v2)**

> **作者:** Wuwei Zhang; Fangcong Yin; Howard Yen; Danqi Chen; Xi Ye
>
> **备注:** EMNLP 2025; Code at https://github.com/princeton-pli/QRHead
>
...
>
---
#### [replaced 047] PiERN: Token-Level Routing for Integrating High-Precision Computation and Reasoning
- **分类: cs.LG; cs.CE; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.18169v2](http://arxiv.org/pdf/2509.18169v2)**
...
>
---
#### [replaced 048] Enhancing Textual Personality Detection toward Social Media: Integrating Long-term and Short-term Perspectives
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2404.15067v2](http://arxiv.org/pdf/2404.15067v2)**
...
>
---
#### [replaced 050] Comba: Improving Bilinear RNNs with Closed-loop Control
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02475v4](http://arxiv.org/pdf/2506.02475v4)**
...
>
---
#### [replaced 051] Jet-Nemotron: Efficient Language Model with Post Neural Architecture Search
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.15884v3](http://arxiv.org/pdf/2508.15884v3)**
...
>
---
#### [replaced 052] Group-Adaptive Threshold Optimization for Robust AI-Generated Text Detection
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.04528v5](http://arxiv.org/pdf/2502.04528v5)**
...
>
---
#### [replaced 053] Causal Attention with Lookahead Keys
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.07301v2](http://arxiv.org/pdf/2509.07301v2)**
...
>
---
#### [replaced 054] Trinity-RFT: A General-Purpose and Unified Framework for Reinforcement Fine-Tuning of Large Language Models
- **分类: cs.LG; cs.CL; cs.DC**

- **链接: [http://arxiv.org/pdf/2505.17826v3](http://arxiv.org/pdf/2505.17826v3)**
...
>
---
#### [replaced 055] On the Design of KL-Regularized Policy Gradient Algorithms for LLM Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17508v2](http://arxiv.org/pdf/2505.17508v2)**
...
>
---
#### [replaced 056] K-DeCore: Facilitating Knowledge Transfer in Continual Structured Knowledge Reasoning via Knowledge Decoupling
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.16929v3](http://arxiv.org/pdf/2509.16929v3)**
...
>
---
#### [replaced 057] When Thinking Backfires: Mechanistic Insights Into Reasoning-Induced Misalignment
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.00544v2](http://arxiv.org/pdf/2509.00544v2)**
...
>
---
#### [replaced 058] AdaBoN: Adaptive Best-of-N Alignment
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.12050v2](http://arxiv.org/pdf/2505.12050v2)**
...
>
---
#### [replaced 059] Semantic-guided Diverse Decoding for Large Language Model
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.23601v2](http://arxiv.org/pdf/2506.23601v2)**
...
>
---
#### [replaced 060] ProxyThinker: Test-Time Guidance through Small Visual Reasoners
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.24872v2](http://arxiv.org/pdf/2505.24872v2)**
...
>
---
#### [replaced 061] Mechanistic Fine-tuning for In-context Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.14233v2](http://arxiv.org/pdf/2505.14233v2)**
...
>
---
#### [replaced 064] Prior-based Noisy Text Data Filtering: Fast and Strong Alternative For Perplexity
- **分类: cs.CL; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.18577v2](http://arxiv.org/pdf/2509.18577v2)**
...
>
---
#### [replaced 065] CoDiEmb: A Collaborative yet Distinct Framework for Unified Representation Learning in Information Retrieval and Semantic Textual Similarity
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.11442v2](http://arxiv.org/pdf/2508.11442v2)**
...
>
---
#### [replaced 066] A Partition Cover Approach to Tokenization
- **分类: cs.CL; cs.AI; cs.DS**

- **链接: [http://arxiv.org/pdf/2501.06246v3](http://arxiv.org/pdf/2501.06246v3)**

> **作者:** Jia Peng Lim; Shawn Tan; Davin Choo; Hady W. Lauw
>
> **备注:** NeurIPS 2025
>
> **摘要:** Tokenization is the process of encoding strings into tokens of a fixed vocabulary size, and is widely utilized in Natural Language Processing applications. The leading tokenization algorithm today is Byte-Pair Encoding (BPE), which formulates the tokenization problem as a compression problem and tackles it by performing sequences of merges. In this work, we formulate tokenization as an optimization objective, show that it is NP-hard via a simple reduction from vertex cover, and propose a polynomial-time greedy algorithm GreedTok. Our formulation naturally relaxes to the well-studied weighted maximum coverage problem which has a simple $(1 - 1/e)$-approximation algorithm GreedWMC. Through empirical evaluations on real-world corpora, we show that GreedTok outperforms BPE and Unigram on compression and achieves a covering score comparable to GreedWMC. Finally, our extensive pre-training for two transformer-based language models with 1 billion parameters, comparing the choices of BPE and GreedTok as the tokenizer, shows that GreedTok achieves a lower bit per byte even when we control for either the total dataset proportion or total training tokens.
>
---
#### [replaced 067] Fine-tuning Done Right in Model Editing
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22072v2](http://arxiv.org/pdf/2509.22072v2)**
...
>
---
#### [replaced 068] AdversariaL attacK sAfety aLIgnment(ALKALI): Safeguarding LLMs through GRACE: Geometric Representation-Aware Contrastive Enhancement- Introducing Adversarial Vulnerability Quality Index (AVQI)
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.08885v3](http://arxiv.org/pdf/2506.08885v3)**

> **作者:** Danush Khanna; Gurucharan Marthi Krishna Kumar; Basab Ghosh; Yaswanth Narsupalli; Vinija Jain; Vasu Sharma; Aman Chadha; Amitava Das
>
...
>
---
#### [replaced 071] On the Same Wavelength? Evaluating Pragmatic Reasoning in Language Models across Broad Concepts
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.06952v2](http://arxiv.org/pdf/2509.06952v2)**
...
>
---
#### [replaced 076] From Single to Multi-Granularity: Toward Long-Term Memory Association and Selection of Conversational Agents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.19549v2](http://arxiv.org/pdf/2505.19549v2)**
...
>
---
#### [replaced 077] vCache: Verified Semantic Prompt Caching
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.03771v4](http://arxiv.org/pdf/2502.03771v4)**

> **作者:** Luis Gaspar Schroeder; Aditya Desai; Alejandro Cuadron; Kyle Chu; Shu Liu; Mark Zhao; Stephan Krusche; Alfons Kemper; Ion Stoica; Matei Zaharia; Joseph E. Gonzalez
>
...
>
---
#### [replaced 078] How to Protect Yourself from 5G Radiation? Investigating LLM Responses to Implicit Misinformation
- **分类: cs.CL; cs.AI; cs.CY**
...
>
---
#### [replaced 079] Multilingual Prompting for Improving LLM Generation Diversity
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 080] What Makes a Reward Model a Good Teacher? An Optimization Perspective
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **链接: [http://arxiv.org/pdf/2503.15477v3](http://arxiv.org/pdf/2503.15477v3)**
...
>
---
#### [replaced 081] A Markov Categorical Framework for Language Modeling
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.19247v3](http://arxiv.org/pdf/2507.19247v3)**
...
>
---
#### [replaced 082] Answer Convergence as a Signal for Early Stopping in Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02536v2](http://arxiv.org/pdf/2506.02536v2)**
...
>
---
#### [replaced 083] Memory-QA: Answering Recall Questions Based on Multimodal Memories
- **分类: cs.AI; cs.CL; cs.DB**

- **链接: [http://arxiv.org/pdf/2509.18436v2](http://arxiv.org/pdf/2509.18436v2)**

> **作者:** Hongda Jiang; Xinyuan Zhang; Siddhant Garg; Rishab Arora; Shiun-Zu Kuo; Jiayang Xu; Ankur Bansal; Christopher Brossman; Yue Liu; Aaron Colak; Ahmed Aly; Anuj Kumar; Xin Luna Dong
>
...
>
---
#### [replaced 084] AttriLens-Mol: Attribute Guided Reinforcement Learning for Molecular Property Prediction with Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.04748v2](http://arxiv.org/pdf/2508.04748v2)**
...
>
---
#### [replaced 085] A Survey on Stereotype Detection in Natural Language Processing
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 088] Sotopia-RL: Reward Design for Social Intelligence
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.03905v2](http://arxiv.org/pdf/2508.03905v2)**
...
>
---
#### [replaced 089] Do LLMs Adhere to Label Definitions? Examining Their Receptivity to External Label Definitions
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.02452v2](http://arxiv.org/pdf/2509.02452v2)**
...
>
---
#### [replaced 092] Discrete Audio Tokens: More Than a Survey!
...
>
---
#### [replaced 096] Automatically Advancing LLM Expertise in Technology Judgment
...
>
---
#### [replaced 097] Cross-lingual Human-Preference Alignment for Neural Machine Translation with Direct Quality Optimization
- **分类: cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2409.17673v3](http://arxiv.org/pdf/2409.17673v3)**
...
>
---
#### [replaced 100] Sculptor: Empowering LLMs with Cognitive Agency via Active Context Management
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.04664v2](http://arxiv.org/pdf/2508.04664v2)**
...
>
---
#### [replaced 101] LLMs4All: A Review on Large Language Models for Research and Applications in Academic Disciplines
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.19580v3](http://arxiv.org/pdf/2509.19580v3)**
...
>
---
#### [replaced 102] Patterns in the Transition From Founder-Leadership to Community Governance of Open Source
...
>
---
#### [replaced 103] Beyond checkmate: exploring the creative chokepoints in AI text
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.19301v3](http://arxiv.org/pdf/2501.19301v3)**
...
>
---
#### [replaced 104] ViSpec: Accelerating Vision-Language Models with Vision-Aware Speculative Decoding
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.15235v4](http://arxiv.org/pdf/2509.15235v4)**
...
>
---
#### [replaced 107] Improving LLM Reasoning through Interpretable Role-Playing Steering
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.07335v2](http://arxiv.org/pdf/2506.07335v2)**
...
>
---
#### [replaced 108] Omni-SafetyBench: A Benchmark for Safety Evaluation of Audio-Visual Large Language Models
- **分类: cs.CL; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2508.07173v2](http://arxiv.org/pdf/2508.07173v2)**
...
>
---
#### [replaced 109] Coarse-to-Fine Personalized LLM Impressions for Streamlined Radiology Reports
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.15845v2](http://arxiv.org/pdf/2508.15845v2)**
...
>
---
#### [replaced 110] CGELBank Annotation Manual v1.2
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2305.17347v3](http://arxiv.org/pdf/2305.17347v3)**

> **作者:** Brett Reynolds; Nathan Schneider; Aryaman Arora
>
> **摘要:** CGELBank is a treebank and associated tools based on a syntactic formalism for English derived from the Cambridge Grammar of the English Language (CGEL; Huddleston and Pullum, 2002). It is hosted on GitHub at https://github.com/nert-nlp/cgel. This document lays out the particularities of the CGELBank annotation scheme.
>
---
#### [replaced 111] Fast and Fluent Diffusion Language Models via Convolutional Decoding and Rejective Fine-tuning
- **分类: cs.CL; cs.AI; cs.LG; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.15188v2](http://arxiv.org/pdf/2509.15188v2)**
...
>
---
#### [replaced 112] CoT-TL: Low-Resource Temporal Knowledge Representation of Planning Instructions Using Chain-of-Thought Reasoning
...
>
---
#### [replaced 113] Cooking Up Creativity: Enhancing LLM Creativity through Structured Recombination
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.20643v2](http://arxiv.org/pdf/2504.20643v2)**
...
>
---
#### [replaced 115] UniHR: Hierarchical Representation Learning for Unified Knowledge Graph Link Prediction
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2411.07019v5](http://arxiv.org/pdf/2411.07019v5)**

> **作者:** Zhiqiang Liu; Yin Hua; Mingyang Chen; Yichi Zhang; Zhuo Chen; Lei Liang; Huajun Chen; Wen Zhang
>
...
>
---
#### [replaced 116] XL-Suite: Cross-Lingual Synthetic Training and Evaluation Data for Open-Ended Generation
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.22973v3](http://arxiv.org/pdf/2503.22973v3)**
...
>
---
#### [replaced 117] DESIGNER: Design-Logic-Guided Multidisciplinary Data Synthesis for LLM Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.12726v2](http://arxiv.org/pdf/2508.12726v2)**
...
>
---
#### [replaced 122] Ko-PIQA: A Korean Physical Commonsense Reasoning Dataset with Cultural Context
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.11303v3](http://arxiv.org/pdf/2509.11303v3)**
...
>
---
#### [replaced 123] Improving Reliability and Explainability of Medical Question Answering through Atomic Fact Checking in Retrieval-Augmented LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24830v2](http://arxiv.org/pdf/2505.24830v2)**
...
>
> **备注:** 15 pages, 5 figures and tables
>
...
>
---
#### [replaced 127] SUV: Scalable Large Language Model Copyright Compliance with Regularized Selective Unlearning
...
>
---
#### [replaced 132] Taxonomy of Comprehensive Safety for Clinical Agents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22041v2](http://arxiv.org/pdf/2509.22041v2)**
...
>
---
#### [replaced 133] Automotive-ENV: Benchmarking Multimodal Agents in Vehicle Interface Systems
...
>
---
#### [replaced 134] Un-Doubling Diffusion: LLM-guided Disambiguation of Homonym Duplication
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.21262v2](http://arxiv.org/pdf/2509.21262v2)**
...
>
---
#### [replaced 135] MetaMind: Modeling Human Social Thoughts with Metacognitive Multi-Agent Systems
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.18943v2](http://arxiv.org/pdf/2505.18943v2)**
...
>
---
#### [replaced 138] Nested Named Entity Recognition as Single-Pass Sequence Labeling
- **分类: cs.CL; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2505.16855v2](http://arxiv.org/pdf/2505.16855v2)**
...
>
---
#### [replaced 141] The Counting Power of Transformers
- **分类: cs.CL; cs.FL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.11199v2](http://arxiv.org/pdf/2505.11199v2)**
...
>
---
#### [replaced 142] CTTS: Collective Test-Time Scaling
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.03333v2](http://arxiv.org/pdf/2508.03333v2)**
...
>
---
#### [replaced 143] COMPACT: Common-token Optimized Model Pruning Across Channels and Tokens
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.06836v2](http://arxiv.org/pdf/2509.06836v2)**
...
>
---
#### [replaced 144] Long Context Scaling: Divide and Conquer via Multi-Agent Question-driven Collaboration
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.20625v3](http://arxiv.org/pdf/2505.20625v3)**
...
>
---
#### [replaced 147] TabularGSM: Understanding the Limitations of LLMs in Tabular Math Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.19563v2](http://arxiv.org/pdf/2505.19563v2)**
...
>
---
#### [replaced 149] Mind the Value-Action Gap: Do LLMs Act in Alignment with Their Values?
- **分类: cs.HC; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2501.15463v3](http://arxiv.org/pdf/2501.15463v3)**
...
>
---
#### [replaced 150] Beyond Pass@1: Self-Play with Variational Problem Synthesis Sustains RLVR
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.14029v3](http://arxiv.org/pdf/2508.14029v3)**
...
>
---
#### [replaced 153] Entropy-Memorization Law: Evaluating Memorization Difficulty of Data in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.06056v3](http://arxiv.org/pdf/2507.06056v3)**
...
>
---
#### [replaced 154] WebWeaver: Structuring Web-Scale Evidence with Dynamic Outlines for Open-Ended Deep Research
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.13312v2](http://arxiv.org/pdf/2509.13312v2)**
...
>
---
#### [replaced 155] SpecExtend: A Drop-in Enhancement for Speculative Decoding of Long Sequences
- **分类: cs.CL; cs.AI; cs.LG; I.2.7; C.4**

- **链接: [http://arxiv.org/pdf/2505.20776v3](http://arxiv.org/pdf/2505.20776v3)**
...
>
---
#### [replaced 156] LLM-3D Print: Large Language Models To Monitor and Control 3D Printing
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2408.14307v3](http://arxiv.org/pdf/2408.14307v3)**

> **作者:** Yayati Jadhav; Peter Pak; Amir Barati Farimani
>
> **摘要:** Industry 4.0 has revolutionized manufacturing by driving digitalization and shifting the paradigm toward additive manufacturing (AM). Fused Deposition Modeling (FDM), a key AM technology, enables the creation of highly customized, cost-effective products with minimal material waste through layer-by-layer extrusion, posing a significant challenge to traditional subtractive methods. However, the susceptibility of material extrusion techniques to errors often requires expert intervention to detect and mitigate defects that can severely compromise product quality. While automated error detection and machine learning models exist, their generalizability across diverse 3D printer setups, firmware, and sensors is limited, and deep learning methods require extensive labeled datasets, hindering scalability and adaptability. To address these challenges, we present a process monitoring and control framework that leverages pre-trained Large Language Models (LLMs) alongside 3D printers to detect and address printing defects. The LLM evaluates print quality by analyzing images captured after each layer or print segment, identifying failure modes and querying the printer for relevant parameters. It then generates and executes a corrective action plan. We validated the effectiveness of the proposed framework in identifying defects by comparing it against a control group of engineers with diverse AM expertise. Our evaluation demonstrated that LLM-based agents not only accurately identify common 3D printing errors, such as inconsistent extrusion, stringing, warping, and layer adhesion, but also effectively determine the parameters causing these failures and autonomously correct them without any need for human intervention.
>
---
#### [replaced 157] Dual-Head Reasoning Distillation: Improving Classifier Accuracy with Train-Time-Only Reasoning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.21487v2](http://arxiv.org/pdf/2509.21487v2)**
...
>
---
#### [replaced 158] FuseCodec: Semantic-Contextual Fusion and Supervision for Neural Codecs
- **分类: cs.SD; cs.AI; cs.CL; eess.AS**
...
>
---
#### [replaced 165] Emergent Hierarchical Reasoning in LLMs through Reinforcement Learning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.03646v3](http://arxiv.org/pdf/2509.03646v3)**
...
>
---
#### [replaced 166] Game-RL: Synthesizing Multimodal Verifiable Game Data to Boost VLMs' General Reasoning
- **分类: cs.CL; I.2.7; I.2.10**

- **链接: [http://arxiv.org/pdf/2505.13886v5](http://arxiv.org/pdf/2505.13886v5)**
...
>
---
#### [replaced 168] B-cos LM: Efficiently Transforming Pre-trained Language Models for Improved Explainability
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.12992v3](http://arxiv.org/pdf/2502.12992v3)**
...
>
---
#### [replaced 169] Language Models Optimized to Fool Detectors Still Have a Distinct Style (And How to Change It)
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.14608v2](http://arxiv.org/pdf/2505.14608v2)**
...
>
---
#### [replaced 172] Rare-to-Frequent: Unlocking Compositional Generation Power of Diffusion Models on Rare Concepts with LLM Guidance
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2410.22376v4](http://arxiv.org/pdf/2410.22376v4)**
...
>
---
#### [replaced 173] Fine-Grained Detection of Context-Grounded Hallucinations Using LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22582v2](http://arxiv.org/pdf/2509.22582v2)**
...
>
---
#### [replaced 174] Confidence Improves Self-Consistency in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.06233v2](http://arxiv.org/pdf/2502.06233v2)**

> **作者:** Amir Taubenfeld; Tom Sheffer; Eran Ofek; Amir Feder; Ariel Goldstein; Zorik Gekhman; Gal Yona
>
> **摘要:** Self-consistency decoding enhances LLMs' performance on reasoning tasks by sampling diverse reasoning paths and selecting the most frequent answer. However, it is computationally expensive, as sampling many of these (lengthy) paths is required to increase the chances that the correct answer emerges as the most frequent one. To address this, we introduce Confidence-Informed Self-Consistency (CISC). CISC performs a weighted majority vote based on confidence scores obtained directly from the model. By prioritizing high-confidence paths, it can identify the correct answer with a significantly smaller sample size. When tested on nine models and four datasets, CISC outperforms self-consistency in nearly all configurations, reducing the required number of reasoning paths by over 40% on average. In addition, we introduce the notion of within-question confidence evaluation, after showing that standard evaluation methods are poor predictors of success in distinguishing correct and incorrect answers to the same question. In fact, the most calibrated confidence method proved to be the least effective for CISC. Lastly, beyond these practical implications, our results and analyses show that LLMs can effectively judge the correctness of their own outputs, contributing to the ongoing debate on this topic.
>
---
#### [replaced 175] Can Language Models Discover Scaling Laws?
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.21184v2](http://arxiv.org/pdf/2507.21184v2)**
...
>
---
#### [replaced 176] Better Safe Than Sorry? Overreaction Problem of Vision Language Models in Visual Emergency Recognition
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.15367v3](http://arxiv.org/pdf/2505.15367v3)**
...
>
---
#### [replaced 182] Adaptive Group Policy Optimization: Towards Stable Training and Token-Efficient Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.15952v3](http://arxiv.org/pdf/2503.15952v3)**
...
>
---
#### [replaced 183] Artificially Fluent: Swahili AI Performance Benchmarks Between English-Trained and Natively-Trained Datasets
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 186] A Neurosymbolic Fast and Slow Architecture for Graph Coloring
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2412.01752v2](http://arxiv.org/pdf/2412.01752v2)**
...
>
---
#### [replaced 189] Internal Chain-of-Thought: Empirical Evidence for Layer-wise Subtask Scheduling in LLMs
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.14530v2](http://arxiv.org/pdf/2505.14530v2)**
...
>
---
#### [replaced 194] Agribot: agriculture-specific question answer system
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.21535v2](http://arxiv.org/pdf/2509.21535v2)**

> **作者:** Naman Jain; Pranjali Jain; Pratik Kayal; Jayakrishna Sahit; Soham Pachpande; Jayesh Choudhari; Mayank Singh
>
...
>
---
#### [replaced 195] Long-Context Generalization with Sparse Attention
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.16640v3](http://arxiv.org/pdf/2506.16640v3)**
...
>
---
#### [replaced 196] ToDi: Token-wise Distillation via Fine-Grained Divergence Control
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16297v2](http://arxiv.org/pdf/2505.16297v2)**
...
>
---
#### [replaced 197] Position: Towards Bidirectional Human-AI Alignment
- **分类: cs.HC; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2406.09264v4](http://arxiv.org/pdf/2406.09264v4)**

> **作者:** Hua Shen; Tiffany Knearem; Reshmi Ghosh; Kenan Alkiek; Kundan Krishna; Yachuan Liu; Ziqiao Ma; Savvas Petridis; Yi-Hao Peng; Li Qiwei; Sushrita Rakshit; Chenglei Si; Yutong Xie; Jeffrey P. Bigham; Frank Bentley; Joyce Chai; Zachary Lipton; Qiaozhu Mei; Rada Mihalcea; Michael Terry; Diyi Yang; Meredith Ringel Morris; Paul Resnick; David Jurgens
>
> **备注:** NeurIPS 2025 Position Paper
>
...
>
---
#### [replaced 201] EmbeddingGemma: Powerful and Lightweight Text Representations
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.20354v2](http://arxiv.org/pdf/2509.20354v2)**
...
>
---
#### [replaced 202] CORE-RAG: Lossless Compression for Retrieval-Augmented LLMs via Reinforcement Learning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.19282v3](http://arxiv.org/pdf/2508.19282v3)**
...
>
---
#### [replaced 204] Curriculum-Guided Layer Scaling for Language Model Pretraining
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.11389v2](http://arxiv.org/pdf/2506.11389v2)**
...
>
---
#### [replaced 210] VeriFact: Enhancing Long-Form Factuality Evaluation with Refined Fact Extraction and Reference Facts
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.09701v2](http://arxiv.org/pdf/2505.09701v2)**
...
>
---
#### [replaced 211] Infini-gram mini: Exact n-gram Search at the Internet Scale with FM-Index
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.12229v3](http://arxiv.org/pdf/2506.12229v3)**
...
>
---
#### [replaced 212] PAFT: Prompt-Agnostic Fine-Tuning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.12859v2](http://arxiv.org/pdf/2502.12859v2)**
...
>
---
#### [replaced 213] ArtifactsBench: Bridging the Visual-Interactive Gap in LLM Code Generation Evaluation
- **分类: cs.CL; cs.SE**

- **链接: [http://arxiv.org/pdf/2507.04952v2](http://arxiv.org/pdf/2507.04952v2)**
...
>
---
#### [replaced 219] ATTS: Asynchronous Test-Time Scaling via Conformal Prediction
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.15148v2](http://arxiv.org/pdf/2509.15148v2)**
...
>
---
#### [replaced 222] UltraIF: Advancing Instruction Following from the Wild
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.04153v2](http://arxiv.org/pdf/2502.04153v2)**

> **作者:** Kaikai An; Li Sheng; Ganqu Cui; Shuzheng Si; Ning Ding; Yu Cheng; Baobao Chang
>
> **备注:** Accepted by EMNLP 2025
>
> **摘要:** Instruction-following made modern large language models (LLMs) helpful assistants. However, the key to taming LLMs on complex instructions remains mysterious, for that there are huge gaps between models trained by open-source community and those trained by leading companies. To bridge the gap, we propose a simple and scalable approach UltraIF for building LLMs that can follow complex instructions with open-source data. UltraIF first decomposes real-world user prompts into simpler queries, constraints, and corresponding evaluation questions for the constraints. Then, we train an UltraComposer to compose constraint-associated prompts with evaluation questions. This prompt composer allows us to synthesize complicated instructions as well as filter responses with evaluation questions. In our experiment, for the first time, we successfully align LLaMA-3.1-8B-Base to catch up with its instruct version on 5 instruction-following benchmarks without any benchmark information, using only 8B model as response generator and evaluator. The aligned model also achieved competitive scores on other benchmarks. Moreover, we also show that UltraIF could further improve LLaMA-3.1-8B-Instruct through self-alignment, motivating broader use cases for the method. Our code is available at https://github.com/kkk-an/UltraIF.
>
---
#### [replaced 223] Mitigating Barren Plateaus in Quantum Neural Networks via an AI-Driven Submartingale-Based Framework
- **分类: quant-ph; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.13166v2](http://arxiv.org/pdf/2502.13166v2)**

> **作者:** Jun Zhuang; Chaowen Guan
>
> **备注:** TL;DR: We propose AdaInit, a novel AI-driven submartingale-based framework that adaptively generates effective initial parameters for quantum neural networks to mitigate barren plateaus by leveraging generative models with the submartingale property
>
