...
>
> **摘要:** While Multimodal Large Language Models (MLLMs) have achieved remarkable progress in visual understanding, they often struggle when faced with the unstructured and ambiguous nature of human-generated sketches. This limitation is particularly pronounced in the underexplored task of visual grading, where models should not only solve a problem but also diagnose errors in hand-drawn diagrams. Such diagnostic capabilities depend on complex structural, semantic, and metacognitive reasoning. To bridge this gap, we introduce SketchJudge, a novel benchmark tailored for evaluating MLLMs as graders of hand-drawn STEM diagrams. SketchJudge encompasses 1,015 hand-drawn student responses across four domains: geometry, physics, charts, and flowcharts, featuring diverse stylistic variations and distinct error types. Evaluations on SketchJudge demonstrate that even advanced MLLMs lag significantly behind humans, validating the benchmark's effectiveness in exposing the fragility of current vision-language alignment in symbolic and noisy contexts. All data, code, and evaluation scripts are publicly available at https://github.com/yuhangsu82/SketchJudge.
>
---
#### [new 003] Motion Focus Recognition in Fast-Moving Egocentric Video
- **分类: cs.CV**

- **简介: 该论文属于动作识别任务，旨在解决快速运动场景中运动焦点识别问题。通过实时分析自视角视频，估计运动意图，提升边缘部署的可行性。**

- **链接: [https://arxiv.org/pdf/2601.07154v1](https://arxiv.org/pdf/2601.07154v1)**
...
>
---
#### [new 017] Billboard in Focus: Estimating Driver Gaze Duration from a Single Image
- **分类: cs.CV**

- **简介: 该论文属于视觉任务，旨在解决驾驶员注视广告牌时长的估计问题。通过自动化流程检测广告牌并利用特征分类，实现无需眼动设备的注视时长评估。**

- **链接: [https://arxiv.org/pdf/2601.07073v1](https://arxiv.org/pdf/2601.07073v1)**
...
>
---
#### [new 027] Low-Back Pain Physical Rehabilitation by Movement Analysis in Clinical Trial
...
>
---
#### [new 028] Measuring Social Bias in Vision-Language Models with Face-Only Counterfactuals from Real Photos
...
>
---
#### [new 031] Cascading multi-agent anomaly detection in surveillance systems via vision-language models and embedding-based classification
- **分类: cs.CV; cs.MA**

- **简介: 该论文属于异常检测任务，解决动态视觉环境中实时性与语义可解释性的矛盾。提出级联多智能体框架，融合重建、目标检测与视觉语言模型，提升效率与可解释性。**

- **链接: [https://arxiv.org/pdf/2601.06204v1](https://arxiv.org/pdf/2601.06204v1)**

> **作者:** Tayyab Rehman; Giovanni De Gasperis; Aly Shmahell
>
> **摘要:** Intelligent anomaly detection in dynamic visual environments requires reconciling real-time performance with semantic interpretability. Conventional approaches address only fragments of this challenge. Reconstruction-based models capture low-level deviations without contextual reasoning, object detectors provide speed but limited semantics, and large vision-language systems deliver interpretability at prohibitive computational cost. This work introduces a cascading multi-agent framework that unifies these complementary paradigms into a coherent and interpretable architecture. Early modules perform reconstruction-gated filtering and object-level assessment, while higher-level reasoning agents are selectively invoked to interpret semantically ambiguous events. The system employs adaptive escalation thresholds and a publish-subscribe communication backbone, enabling asynchronous coordination and scalable deployment across heterogeneous hardware. Extensive evaluation on large-scale monitoring data demonstrates that the proposed cascade achieves a threefold reduction in latency compared to direct vision-language inference, while maintaining high perceptual fidelity (PSNR = 38.3 dB, SSIM = 0.965) and consistent semantic labeling. The framework advances beyond conventional detection pipelines by combining early-exit efficiency, adaptive multi-agent reasoning, and explainable anomaly attribution, establishing a reproducible and energy-efficient foundation for scalable intelligent visual monitoring.
>
---
#### [new 032] BabyVision: Visual Reasoning Beyond Language
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 041] Tone Matters: The Impact of Linguistic Tone on Hallucination in VLMs
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 046] OSCAR: Open-Set CAD Retrieval from a Language Prompt and a Single Image
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 047] MHLA: Restoring Expressivity of Linear Attention via Token-Level Multi-Head
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于自然语言处理与计算机视觉任务，解决线性注意力表达能力不足的问题。提出MHLA方法，在保持线性复杂度的同时提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.07832v1](https://arxiv.org/pdf/2601.07832v1)**

> **作者:** Kewei Zhang; Ye Huang; Yufan Deng; Jincheng Yu; Junsong Chen; Huan Ling; Enze Xie; Daquan Zhou
>
> **备注:** Code: https://github.com/DAGroup-PKU/MHLA/ Project website: https://dagroup-pku.github.io/MHLA/
>
> **摘要:** While the Transformer architecture dominates many fields, its quadratic self-attention complexity hinders its use in large-scale applications. Linear attention offers an efficient alternative, but its direct application often degrades performance, with existing fixes typically re-introducing computational overhead through extra modules (e.g., depthwise separable convolution) that defeat the original purpose. In this work, we identify a key failure mode in these methods: global context collapse, where the model loses representational diversity. To address this, we propose Multi-Head Linear Attention (MHLA), which preserves this diversity by computing attention within divided heads along the token dimension. We prove that MHLA maintains linear complexity while recovering much of the expressive power of softmax attention, and verify its effectiveness across multiple domains, achieving a 3.6\% improvement on ImageNet classification, a 6.3\% gain on NLP, a 12.6\% improvement on image generation, and a 41\% enhancement on video generation under the same time complexity.
>
---
#### [new 048] GeoMotionGPT: Geometry-Aligned Motion Understanding with Large Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于动作理解任务，旨在解决运动与语义嵌入空间对齐不足的问题。通过引入几何对齐框架，提升大语言模型的运动推理能力。**

- **链接: [https://arxiv.org/pdf/2601.07632v1](https://arxiv.org/pdf/2601.07632v1)**

> **作者:** Zhankai Ye; Bofan Li; Yukai Jin; Shuoqiu Li; Wei Wang; Yanfu Zhang; Shangqian Gao; Xin Liu
>
> **摘要:** Discrete motion tokenization has recently enabled Large Language Models (LLMs) to serve as versatile backbones for motion understanding and motion-language reasoning. However, existing pipelines typically decouple motion quantization from semantic embedding learning, linking them solely via token IDs. This approach fails to effectively align the intrinsic geometry of the motion space with the embedding space, thereby hindering the LLM's capacity for nuanced motion reasoning. We argue that alignment is most effective when both modalities share a unified geometric basis. Therefore, instead of forcing the LLM to reconstruct the complex geometry among motion tokens from scratch, we present a novel framework that explicitly enforces orthogonality on both the motion codebook and the LLM embedding space, ensuring that their relational structures naturally mirror each other. Specifically, we employ a decoder-only quantizer with Gumbel-Softmax for differentiable training and balanced codebook usage. To bridge the modalities, we use a sparse projection that maps motion codes into the LLM embedding space while preserving orthogonality. Finally, a two-stage orthonormal regularization schedule enforces soft constraints during tokenizer training and LLM fine-tuning to maintain geometric alignment without hindering semantic adaptation. Extensive experiments on HumanML3D demonstrate that our framework achieves a 20% performance improvement over current state-of-the-art methods, validating that a unified geometric basis effectively empowers the LLM for nuanced motion reasoning.
>
---
#### [new 049] RenderFlow: Single-Step Neural Rendering via Flow Matching
- **分类: cs.CV**

- **简介: 该论文提出RenderFlow，解决传统渲染效率低和生成模型不准确的问题，通过流匹配实现单步神经渲染，提升速度与质量。**

- **链接: [https://arxiv.org/pdf/2601.06928v1](https://arxiv.org/pdf/2601.06928v1)**
...
>
---
#### [new 088] FocalOrder: Focal Preference Optimization for Reading Order Detection
- **分类: cs.CV**

- **简介: 该论文属于文档理解任务，解决阅读顺序检测问题。针对现有方法在复杂区域性能下降的问题，提出FocalOrder框架，通过焦点偏好优化提升模型对复杂结构的处理能力。**

- **链接: [https://arxiv.org/pdf/2601.07483v1](https://arxiv.org/pdf/2601.07483v1)**
...
>
---
#### [new 096] Smooth Operator: Smooth Verifiable Reward Activates Spatial Reasoning Ability of Vision-Language Model
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言模型的3D场景理解任务，旨在解决奖励稀疏和梯度不稳定问题。提出SNRA和AP-GRPO方法，提升模型的3D推理能力。**

- **链接: [https://arxiv.org/pdf/2601.07695v1](https://arxiv.org/pdf/2601.07695v1)**

> **作者:** Siwen Jiao; Tianxiong Lv; Kangan Qian; Chenxu Zhao; Xiuyuan Zhu; Tianlun Li; Xiaolong Cheng; Jinyu Li; Zhihao Liao; Yang Cai
>
> **摘要:** Vision-Language Models (VLMs) face a critical bottleneck in achieving precise numerical prediction for 3D scene understanding. Traditional reinforcement learning (RL) approaches, primarily based on relative ranking, often suffer from severe reward sparsity and gradient instability, failing to effectively exploit the verifiable signals provided by 3D physical constraints. Notably, in standard GRPO frameworks, relative normalization causes "near-miss" samples (characterized by small but non-zero errors) to suffer from advantage collapse. This leads to a severe data utilization bottleneck where valuable boundary samples are discarded during optimization. To address this, we introduce the Smooth Numerical Reward Activation (SNRA) operator and the Absolute-Preserving GRPO (AP-GRPO) framework. SNRA employs a dynamically parameterized Sigmoid function to transform raw feedback into a dense, continuous reward continuum. Concurrently, AP-GRPO integrates absolute scalar gradients to mitigate the numerical information loss inherent in conventional relative-ranking mechanisms. By leveraging this approach, we constructed Numerical3D-50k, a dataset comprising 50,000 verifiable 3D subtasks. Empirical results indicate that AP-GRPO achieves performance parity with large-scale supervised methods while maintaining higher data efficiency, effectively activating latent 3D reasoning in VLMs without requiring architectural modifications.
>
---
#### [new 097] On the application of the Wasserstein metric to 2D curves classification
- **分类: cs.CV**

- **简介: 该论文属于2D曲线分类任务，旨在通过改进的Wasserstein距离聚焦曲线特定部分，提升分类效果。研究提出多种概率测度方法，并在考古数据上验证其性能。**

- **链接: [https://arxiv.org/pdf/2601.07749v1](https://arxiv.org/pdf/2601.07749v1)**
...
>
> **摘要:** Large Vision Language Models (LVLMs) have demonstrated remarkable capabilities, yet their proficiency in understanding and reasoning over multiple images remains largely unexplored. While existing benchmarks have initiated the evaluation of multi-image models, a comprehensive analysis of their core weaknesses and their causes is still lacking. In this work, we introduce MIMIC (Multi-Image Model Insights and Challenges), a new benchmark designed to rigorously evaluate the multi-image capabilities of LVLMs. Using MIMIC, we conduct a series of diagnostic experiments that reveal pervasive issues: LVLMs often fail to aggregate information across images and struggle to track or attend to multiple concepts simultaneously. To address these failures, we propose two novel complementary remedies. On the data side, we present a procedural data-generation strategy that composes single-image annotations into rich, targeted multi-image training examples. On the optimization side, we analyze layer-wise attention patterns and derive an attention-masking scheme tailored for multi-image inputs. Experiments substantially improved cross-image aggregation, while also enhancing performance on existing multi-image benchmarks, outperforming prior state of the art across tasks. Data and code will be made available at https://github.com/anurag-198/MIMIC.
>
---
#### [new 108] Watching, Reasoning, and Searching: A Video Deep Research Benchmark on Open Web for Agentic Video Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频问答任务，旨在解决视频与开放网络信息结合的复杂推理问题。构建了VideoDR基准，评估模型在跨帧提取、检索和多跳推理中的表现。**

- **链接: [https://arxiv.org/pdf/2601.06943v1](https://arxiv.org/pdf/2601.06943v1)**
...
>
---
#### [new 112] COVR:Collaborative Optimization of VLMs and RL Agent for Visual-Based Control
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视觉强化学习任务，解决样本效率低的问题。通过COVR框架协同优化视觉语言模型和RL策略，提升任务理解与控制效果。**

- **链接: [https://arxiv.org/pdf/2601.06122v1](https://arxiv.org/pdf/2601.06122v1)**
...
>
---
#### [new 113] DIVER: Dynamic Iterative Visual Evidence Reasoning for Multimodal Fake News Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态假新闻检测任务，旨在解决现有方法计算冗余和幻觉风险的问题。提出DIVER框架，通过动态视觉证据推理提升检测效果与效率。**

- **链接: [https://arxiv.org/pdf/2601.07178v1](https://arxiv.org/pdf/2601.07178v1)**
...
>
---
#### [new 116] Can Textual Reasoning Improve the Performance of MLLMs on Fine-grained Visual Classification?
- **分类: cs.CV**

- **简介: 该论文研究多模态大语言模型在细粒度视觉分类任务中的表现，探讨文本推理对模型性能的影响，并提出新方法提升效果。**

- **链接: [https://arxiv.org/pdf/2601.06993v1](https://arxiv.org/pdf/2601.06993v1)**
...
>
---
#### [new 130] CliffordNet: All You Need is Geometric Algebra
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出CliffordNet，一种基于几何代数的视觉模型，解决传统视觉架构参数冗余问题，通过几何乘积实现高效特征交互。**

- **链接: [https://arxiv.org/pdf/2601.06793v1](https://arxiv.org/pdf/2601.06793v1)**
...
>
---
#### [new 137] Explainable Deep Radiogenomic Molecular Imaging for MGMT Methylation Prediction in Glioblastoma
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于GBM患者MGMT甲基化状态的非侵入性预测任务，旨在解决传统方法的局限性。通过融合影像组学与深度学习，结合可解释AI提升模型可信度。**

- **链接: [https://arxiv.org/pdf/2601.07035v1](https://arxiv.org/pdf/2601.07035v1)**
...
>
---
#### [new 140] Semantic Enrichment of CAD-Based Industrial Environments via Scene Graphs for Simulation and Reasoning
...
>
---
#### [new 146] From Easy to Hard++: Promoting Differentially Private Image Synthesis Through Spatial-Frequency Curriculum
- **分类: cs.CR; cs.CV**

- **简介: 该论文属于图像合成任务，旨在提升差分隐私下的生成图像质量。通过引入频率特征作为训练捷径，结合空间特征，优化DP训练流程，提高生成图像的保真度和实用性。**

- **链接: [https://arxiv.org/pdf/2601.06368v1](https://arxiv.org/pdf/2601.06368v1)**

> **作者:** Chen Gong; Kecen Li; Zinan Lin; Tianhao Wang
>
> **备注:** Accepted at Usenix Security 2026; code available at https://github.com/2019ChenGong/Feta-Pro
>
...
>
---
#### [new 147] SC-MII: Infrastructure LiDAR-based 3D Object Detection on Edge Devices for Split Computing with Multiple Intermediate Outputs Integration
- **分类: cs.DC; cs.CV**

- **简介: 该论文属于3D目标检测任务，解决边缘设备部署复杂模型及单个LiDAR盲区问题。通过分层计算和多中间输出融合，提升效率与隐私保护。**

- **链接: [https://arxiv.org/pdf/2601.07119v1](https://arxiv.org/pdf/2601.07119v1)**
...
>
---
#### [new 149] Using street view images and visual LLMs to predict heritage values for governance support: Risks, ethics, and policy implications
- **分类: cs.CY; cs.AI; cs.CV**

- **简介: 该论文属于建筑遗产价值评估任务，旨在解决瑞典缺乏全国建筑遗产登记的问题。研究利用街景图像和大语言模型预测建筑遗产价值，支持建筑翻新计划制定。**

- **链接: [https://arxiv.org/pdf/2601.06056v1](https://arxiv.org/pdf/2601.06056v1)**

> **作者:** Tim Johansson; Mikael Mangold; Kristina Dabrock; Anna Donarelli; Ingrid Campo-Ruiz
>
> **摘要:** During 2025 and 2026, the Energy Performance of Buildings Directive is being implemented in the European Union member states, requiring all member states to have National Building Renovation Plans. In Sweden, there is a lack of a national register of buildings with heritage values. This is seen as a barrier for the analyses underlying the development of Building Renovation Plans by the involved Swedish authorities. The purpose of this research was to assist Swedish authorities in assigning heritage values to building in the Swedish building stock. As part of the analyses, buildings in street view images from all over Sweden (N=154 710) have been analysed using multimodal Large Language Models (LLM) to assess aspects of heritage value. Zero-shot predictions by LLMs were used as a basis to for identifying buildings with potential heritage values for 5.0 million square meters of heated floor area for the Swedish Building Renovation Plan. In this paper, the results of the predictions and lessons learnt are presented and related to the development of Swedish Building Renovation Plan as part of governance. Potential risks for authorities using LLM-based data are addressed, with a focus on issues of transparency, error detection and sycophancy.
>
---
#### [new 150] BlindU: Blind Machine Unlearning without Revealing Erasing Data
- **分类: cs.CR; cs.AI; cs.CV**

- **简介: 该论文属于隐私保护下的机器去学习任务，解决数据删除过程中隐私泄露问题。提出BlindU方法，通过压缩表示实现无数据暴露的去学习。**

- **链接: [https://arxiv.org/pdf/2601.07214v1](https://arxiv.org/pdf/2601.07214v1)**
...
>
---
#### [new 155] A Multimodal Dataset of Student Oral Presentations with Sensors and Evaluation Data
- **分类: cs.HC; cs.CV**

- **简介: 该论文提出SOPHIAS数据集，用于研究学生口头报告表现。任务是构建多模态数据集，解决缺乏真实场景下多源数据的问题。工作包括采集多种传感器数据及评估信息，支持行为分析与自动化反馈研究。**

- **链接: [https://arxiv.org/pdf/2601.07576v1](https://arxiv.org/pdf/2601.07576v1)**
...
>
---
#### [new 159] ObjSplat: Geometry-Aware Gaussian Surfels for Active Object Reconstruction
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 160] Judge Model for Large-scale Multimodality Benchmarks
...
>
---
#### [new 161] Forest Before Trees: Latent Superposition for Efficient Visual Reasoning
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 162] OceanSAR-2: A Universal Feature Extractor for SAR Ocean Observation
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出OceanSAR-2，用于合成孔径雷达海洋观测的通用特征提取模型，解决海洋参数估计与目标检测问题，通过改进自监督学习提升性能并降低训练成本。**

- **链接: [https://arxiv.org/pdf/2601.07392v1](https://arxiv.org/pdf/2601.07392v1)**
...
>
---
#### [new 164] Deep Joint Source-Channel Coding for Wireless Video Transmission with Asymmetric Context
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于视频传输任务，解决JSCC中误差累积问题。通过设计不对称上下文的神经网络和特征传播，提升传输效率与稳定性。**

- **链接: [https://arxiv.org/pdf/2601.06170v1](https://arxiv.org/pdf/2601.06170v1)**
...
>
---
#### [new 166] Beyond Perfect Scores: Proof-by-Contradiction for Trustworthy Machine Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于机器学习可信性研究任务，旨在解决模型是否依赖真实临床特征的问题。通过构造反证测试，评估模型是否过拟合或依赖数据偏差，提升模型的可信度。**

- **链接: [https://arxiv.org/pdf/2601.06704v1](https://arxiv.org/pdf/2601.06704v1)**
...
>
---
#### [new 170] ReinPool: Reinforcement Learning Pooling Multi-Vector Embeddings for Retrieval System
...
>
---
#### [new 171] CulinaryCut-VLAP: A Vision-Language-Action-Physics Framework for Food Cutting via a Force-Aware Material Point Method
- **分类: cs.RO; cs.CV**
...
#### [replaced 001] From Features to Reference Points: Lightweight and Adaptive Fusion for Cooperative Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18757v2](https://arxiv.org/pdf/2511.18757v2)**

> **作者:** Yongqi Zhu; Morui Zhu; Qi Chen; Deyuan Qu; Isabella Luo; Song Fu; Qing Yang
>
> **备注:** v2: Updated author list to reflect contributions to this work
>
...
>
---
#### [replaced 002] TRASE: Tracking-free 4D Segmentation and Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.19290v2](https://arxiv.org/pdf/2411.19290v2)**
...
>
---
#### [replaced 004] Mesquite MoCap: Democratizing Real-Time Motion Capture with Affordable, Bodyworn IoT Sensors and WebXR SLAM
- **分类: cs.MM; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22690v2](https://arxiv.org/pdf/2512.22690v2)**
...
>
---
#### [replaced 005] Image-to-Video Transfer Learning based on Image-Language Foundation Models: A Comprehensive Survey
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.10671v2](https://arxiv.org/pdf/2510.10671v2)**
...
>
---
#### [replaced 006] Navigation Around Unknown Space Objects Using Visible-Thermal Image Fusion
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 007] What Is The Best 3D Scene Representation for Robotics? From Geometric to Foundation Models
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 008] A Vision for Multisensory Intelligence: Sensing, Synergy, and Science
...
>
---
#### [replaced 009] A Global Atlas of Digital Dermatology to Map Innovation and Disparities
- **分类: cs.DL; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.00840v2](https://arxiv.org/pdf/2601.00840v2)**
...
>
---
#### [replaced 010] Diagnostic Performance of Universal-Learning Ultrasound AI Across Multiple Organs and Tasks: the UUSIC25 Challenge
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17279v2](https://arxiv.org/pdf/2512.17279v2)**

> **作者:** Zehui Lin; Luyi Han; Xin Wang; Ying Zhou; Yanming Zhang; Tianyu Zhang; Lingyun Bao; Jiarui Zhou; Yue Sun; Jieyun Bai; Shuo Li; Shandong Wu; Dong Ni; Ritse Mann; Wendie Berg; Dong Xu; Tao Tan; the UUSIC25 Challenge Consortium
>
...
>
---
#### [replaced 012] On the Design of One-step Diffusion via Shortcutting Flow Paths
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11831v4](https://arxiv.org/pdf/2512.11831v4)**
...
>
---
#### [replaced 013] TLRN: Temporal Latent Residual Networks For Large Deformation Image Registration
- **分类: cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2407.11219v3](https://arxiv.org/pdf/2407.11219v3)**

> **作者:** Nian Wu; Jiarui Xing; Miaomiao Zhang
>
> **备注:** 10 pages. Accepted by MICCAI 2024
>
...
>
---
#### [replaced 019] GaussianDWM: 3D Gaussian Driving World Model for Unified Scene Understanding and Multi-Modal Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23180v2](https://arxiv.org/pdf/2512.23180v2)**
...
>
---
#### [replaced 020] Toward Stable Semi-Supervised Remote Sensing Segmentation via Co-Guidance and Co-Fusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23035v2](https://arxiv.org/pdf/2512.23035v2)**

> **作者:** Yi Zhou; Xuechao Zou; Shun Zhang; Kai Li; Shiying Wang; Jingming Chen; Congyan Lang; Tengfei Cao; Pin Tao; Yuanchun Shi
>
> **备注:** 12 pages, 5 figures, 9 tables
>
...
>
---
#### [replaced 021] A Survey of Multimodal Hallucination Evaluation and Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.19024v2](https://arxiv.org/pdf/2507.19024v2)**
...
>
---
#### [replaced 025] MiCo: Multiple Instance Learning with Context-Aware Clustering for Whole Slide Image Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.18028v3](https://arxiv.org/pdf/2506.18028v3)**
...
>
---
#### [replaced 026] Generative Digital Twins: Vision-Language Simulation Models for Executable Industrial Systems
...
>
---
#### [replaced 027] Flow Matching and Diffusion Models via PointNet for Generating Fluid Fields on Irregular Geometries
- **分类: cs.CV; cs.LG; physics.comp-ph**

- **链接: [https://arxiv.org/pdf/2601.03030v2](https://arxiv.org/pdf/2601.03030v2)**
...
>
---
#### [replaced 030] BLANKET: Anonymizing Faces in Infant Video Recordings
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.15542v2](https://arxiv.org/pdf/2512.15542v2)**
...
>
---
#### [replaced 031] Fuzzy-Logic and Deep Learning for Environmental Condition-Aware Road Surface Classification
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.23436v2](https://arxiv.org/pdf/2512.23436v2)**

> **作者:** Mustafa Demetgul; Sanja Lazarova Molnar
>
> **备注:** This paper has been withdrawn by the authors because the manuscript was submitted before all authors reached a final agreement on the content and readiness of the work. The paper should not be cited
>
...
>
---
#### [replaced 032] Polymorph: Energy-Efficient Multi-Label Classification for Video Streams on Embedded Devices
- **分类: cs.CV; cs.PF**

- **链接: [https://arxiv.org/pdf/2507.14959v3](https://arxiv.org/pdf/2507.14959v3)**
...
>
---
#### [replaced 033] Accelerating Targeted Hard-Label Adversarial Attacks in Low-Query Black-Box Settings
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.16313v3](https://arxiv.org/pdf/2505.16313v3)**

> **作者:** Arjhun Swaminathan; Mete Akgün
>
> **备注:** This paper contains 10 pages, 8 figures and 8 tables. For associated supplementary code, see https://github.com/mdppml/TEA. This work has been accepted for publication at the IEEE Conference on Secure and Trustworthy Machine Learning (SaTML). The final version will be available on IEEE Xplore
>
...
>
---
#### [replaced 034] GM-MoE: Low-Light Enhancement with Gated-Mechanism Mixture-of-Experts
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.07417v5](https://arxiv.org/pdf/2503.07417v5)**
...
>
---
#### [replaced 035] LangHOPS: Language Grounded Hierarchical Open-Vocabulary Part Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.25263v3](https://arxiv.org/pdf/2510.25263v3)**
...
>
---
#### [replaced 036] MomentSeeker: A Task-Oriented Benchmark For Long-Video Moment Retrieval
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2502.12558v5](https://arxiv.org/pdf/2502.12558v5)**
...
>
---
#### [replaced 037] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.18992v2](https://arxiv.org/pdf/2505.18992v2)**
...
>
---
#### [replaced 038] RealCamo: Boosting Real Camouflage Synthesis with Layout Controls and Textual-Visual Guidance
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22974v2](https://arxiv.org/pdf/2512.22974v2)**
...
>
---
#### [replaced 039] REXO: Indoor Multi-View Radar Object Detection via 3D Bounding Box Diffusion
- **分类: cs.CV; cs.AI; cs.LG; eess.SP**

- **链接: [https://arxiv.org/pdf/2511.17806v2](https://arxiv.org/pdf/2511.17806v2)**

> **作者:** Ryoma Yataka; Pu Perry Wang; Petros Boufounos; Ryuhei Takahashi
>
> **备注:** 26 pages; Accepted to AAAI 2026; Code available at https://github.com/merlresearch/radar-bbox-diffusion
>
...
>
---
#### [replaced 040] CaTS-Bench: Can Language Models Describe Time Series?
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.20823v4](https://arxiv.org/pdf/2509.20823v4)**

> **作者:** Luca Zhou; Pratham Yashwante; Marshall Fisher; Alessio Sampieri; Zihao Zhou; Fabio Galasso; Rose Yu
>
> **备注:** 8 pages, 6 figures, 3 tables in the main paper. Many more in the appendix
>
...
>
---
#### [replaced 043] StarFlow: Generating Structured Workflow Outputs From Sketch Images
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2503.21889v2](https://arxiv.org/pdf/2503.21889v2)**
...
>
> **摘要:** Workflows are a fundamental component of automation in enterprise platforms, enabling the orchestration of tasks, data processing, and system integrations. Despite being widely used, building workflows can be complex, often requiring manual configuration through low-code platforms or visual programming tools. To simplify this process, we explore the use of generative foundation models, particularly vision-language models (VLMs), to automatically generate structured workflows from visual inputs. Translating hand-drawn sketches or computer-generated diagrams into executable workflows is challenging due to the ambiguity of free-form drawings, variations in diagram styles, and the difficulty of inferring execution logic from visual elements. To address this, we introduce StarFlow, a framework for generating structured workflow outputs from sketches using vision-language models. We curate a diverse dataset of workflow diagrams -- including synthetic, manually annotated, and real-world samples -- to enable robust training and evaluation. We finetune and benchmark multiple vision-language models, conducting a series of ablation studies to analyze the strengths and limitations of our approach. Our results show that finetuning significantly enhances structured workflow generation, outperforming large vision-language models on this task.
>
---
#### [replaced 044] Proper Body Landmark Subset Enables More Accurate and 5X Faster Recognition of Isolated Signs in LIBRAS
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.24887v2](https://arxiv.org/pdf/2510.24887v2)**
...
>
---
#### [replaced 045] Gems: Group Emotion Profiling Through Multimodal Situational Understanding
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.22393v2](https://arxiv.org/pdf/2507.22393v2)**
...
>
---
#### [replaced 046] SGDrive: Scene-to-Goal Hierarchical World Cognition for Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.05640v2](https://arxiv.org/pdf/2601.05640v2)**
...
>
---
#### [replaced 047] VibES: Induced Vibration for Persistent Event-Based Sensing
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 051] Frequency-Aware Gaussian Splatting Decomposition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.21226v2](https://arxiv.org/pdf/2503.21226v2)**
...
>
---
#### [replaced 052] FashionMAC: Deformation-Free Fashion Image Generation with Fine-Grained Model Appearance Customization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.14031v2](https://arxiv.org/pdf/2511.14031v2)**
...
>
---
#### [replaced 055] Sketch&Patch++: Efficient Structure-Aware 3D Gaussian Representation
- **分类: cs.CV; cs.GR; cs.MM; eess.IV**

- **链接: [https://arxiv.org/pdf/2601.05394v2](https://arxiv.org/pdf/2601.05394v2)**
...
>
---
#### [replaced 062] SuperFlow: Training Flow Matching Models with RL on the Fly
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17951v2](https://arxiv.org/pdf/2512.17951v2)**
...
>
---
#### [replaced 063] SeePerSea: Multi-modal Perception Dataset of In-water Objects for Autonomous Surface Vehicles
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 064] Does DINOv3 Set a New Medical Vision Standard?
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.06467v2](https://arxiv.org/pdf/2509.06467v2)**
...
>
---
#### [replaced 067] Physics-Inspired Modeling and Content Adaptive Routing in an Infrared Gas Leak Detection Network
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.23234v2](https://arxiv.org/pdf/2512.23234v2)**

> **作者:** Dongsheng Li; Tianli Ma; Siling Wang; Beibei Duan; Song Gao
>
...
>
---
#### [replaced 068] Towards Scalable Training for Handwritten Mathematical Expression Recognition
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.09220v4](https://arxiv.org/pdf/2508.09220v4)**

> **作者:** Haoyang Li; Jiaqing Li; Jialun Cao; Zongyuan Yang; Yongping Xiong
>
> **备注:** The authors have decided to temporarily withdraw this paper to make substantial revisions
>
...
>
---
#### [replaced 069] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.19142v2](https://arxiv.org/pdf/2412.19142v2)**

> **作者:** Siyu Jiao; Haoye Dong; Yuyang Yin; Zequn Jie; Yinlong Qian; Yao Zhao; Humphrey Shi; Yunchao Wei
>
> **摘要:** Recent works in 3D multimodal learning have made remarkable progress. However, typically 3D multimodal models are only capable of handling point clouds. Compared to the emerging 3D representation technique, 3D Gaussian Splatting (3DGS), the spatially sparse point cloud cannot depict the texture information of 3D objects, resulting in inferior reconstruction capabilities. This limitation constrains the potential of point cloud-based 3D multimodal representation learning. In this paper, we present CLIP-GS, a novel multimodal representation learning framework grounded in 3DGS. We introduce the GS Tokenizer to generate serialized gaussian tokens, which are then processed through transformer layers pre-initialized with weights from point cloud models, resulting in the 3DGS embeddings. CLIP-GS leverages contrastive loss between 3DGS and the visual-text embeddings of CLIP, and we introduce an image voting loss to guide the directionality and convergence of gradient optimization. Furthermore, we develop an efficient way to generate triplets of 3DGS, images, and text, facilitating CLIP-GS in learning unified multimodal representations. Leveraging the well-aligned multimodal representations, CLIP-GS demonstrates versatility and outperforms point cloud-based models on various 3D tasks, including multimodal retrieval, zero-shot, and few-shot classification.
>
---
#### [replaced 070] PositionIC: Unified Position and Identity Consistency for Image Customization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.13861v5](https://arxiv.org/pdf/2507.13861v5)**
...
>
---
#### [replaced 071] ART: Articulated Reconstruction Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.14671v2](https://arxiv.org/pdf/2512.14671v2)**
...
>
---
#### [replaced 072] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.10231v2](https://arxiv.org/pdf/2412.10231v2)**

> **作者:** Siyun Liang; Sen Wang; Kunyi Li; Michael Niemeyer; Stefano Gasperini; Nassir Navab; Federico Tombari
>
> **备注:** 13 pages, 8 figures
>
> **摘要:** 3D Gaussian Splatting has recently gained traction for its efficient training and real-time rendering. While the vanilla Gaussian Splatting representation is mainly designed for view synthesis, more recent works investigated how to extend it with scene understanding and language features. However, existing methods lack a detailed comprehension of scenes, limiting their ability to segment and interpret complex structures. To this end, We introduce SuperGSeg, a novel approach that fosters cohesive, context-aware scene representation by disentangling segmentation and language field distillation. SuperGSeg first employs neural Gaussians to learn instance and hierarchical segmentation features from multi-view images with the aid of off-the-shelf 2D masks. These features are then leveraged to create a sparse set of what we call Super-Gaussians. Super-Gaussians facilitate the distillation of 2D language features into 3D space. Through Super-Gaussians, our method enables high-dimensional language feature rendering without extreme increases in GPU memory. Extensive experiments demonstrate that SuperGSeg outperforms prior works on both open-vocabulary object localization and semantic segmentation tasks.
>
---
#### [replaced 073] Omni2Sound: Towards Unified Video-Text-to-Audio Generation
...
>
---
#### [replaced 074] FMVP: Masked Flow Matching for Adversarial Video Purification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02228v2](https://arxiv.org/pdf/2601.02228v2)**
...
>
---
#### [replaced 075] LOGLO-FNO: Efficient Learning of Local and Global Features in Fourier Neural Operators
- **分类: cs.LG; cs.AI; cs.CV; physics.geo-ph**

- **链接: [https://arxiv.org/pdf/2504.04260v2](https://arxiv.org/pdf/2504.04260v2)**
...
>
---
#### [replaced 077] Radiant Foam Rendering on a Graph Processor
- **分类: cs.GR; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.04382v2](https://arxiv.org/pdf/2601.04382v2)**
...
>
---
#### [replaced 080] Towards Trustworthy Dermatology MLLMs: A Benchmark and Multimodal Evaluator for Diagnostic Narratives
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.09195v2](https://arxiv.org/pdf/2511.09195v2)**
...
>
---
#### [replaced 081] SegDAC: Improving Visual Reinforcement Learning by Extracting Dynamic Object-Centric Representations from Pretrained Vision Models
...
>
---
#### [replaced 082] MoE3D: A Mixture-of-Experts Module for 3D Reconstruction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.05208v2](https://arxiv.org/pdf/2601.05208v2)**
...
>
---
#### [replaced 085] Studying Illustrations in Manuscripts: An Efficient Deep-Learning Approach
- **分类: cs.IR; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.05269v2](https://arxiv.org/pdf/2601.05269v2)**
...
>
---
#### [replaced 086] Integrated Multivariate Segmentation Tree for Heterogeneous Credit Data Analysis in Small- and Medium-Sized Enterprises
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.00550v2](https://arxiv.org/pdf/2509.00550v2)**

> **作者:** Lu Han; Xiuying Wang
>
> **备注:** 32 pages,12 figures, 9 tables
>
...
>
---
#### [replaced 093] Combining Facial Videos and Biosignals for Stress Estimation During Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.04376v2](https://arxiv.org/pdf/2601.04376v2)**
