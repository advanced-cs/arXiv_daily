...
>
---
#### [new 016] Frame Semantic Patterns for Identifying Underreporting of Notifiable Events in Healthcare: The Case of Gender-Based Violence
- **分类: cs.CL; cs.AI**

- **简介: 该论文针对医疗记录中性别暴力事件的漏报问题，提出基于语义框架的细粒度模式识别方法，从海量非结构化电子病历文本中自动检测未报告的暴力事件。通过构建8个语义模式，在2100万条巴西葡萄牙语语料上实现0.726的识别精度，验证了方法的有效性与可迁移性。**

- **链接: [http://arxiv.org/pdf/2510.26969v1](http://arxiv.org/pdf/2510.26969v1)**
...
>
---
#### [new 017] Kad: A Framework for Proxy-based Test-time Alignment with Knapsack Approximation Deferral
- **分类: cs.CL**

- **简介: 该论文提出Kad框架，通过小规模对齐模型在测试时引导大模型生成，解决大语言模型对齐成本高的问题。将令牌级延迟决策建模为0-1背包问题，设计近似算法，在保证任务性能的同时提升推测解码速度。**

- **链接: [http://arxiv.org/pdf/2510.27017v1](http://arxiv.org/pdf/2510.27017v1)**
...
>
---
#### [new 022] A Unified Representation Underlying the Judgment of Large Language Models
- **分类: cs.CL**

- **简介: 该论文研究大语言模型的判断机制，旨在揭示其是否基于专用模块或统一资源。通过实证发现，多种评价判断共享一个“情感-认同轴”（VAA），该轴联合编码主观价值与事实认同，控制生成过程，导致推理为判断服务，引发系统性偏见与幻觉。**

- **链接: [http://arxiv.org/pdf/2510.27328v1](http://arxiv.org/pdf/2510.27328v1)**
...
>
---
#### [new 023] VISTA Score: Verification In Sequential Turn-based Assessment
- **分类: cs.CL**

- **简介: 该论文提出VISTA框架，用于评估对话系统中的事实性。针对多轮对话中幻觉检测难题，通过逐条验证语句并追踪上下文一致性，提升事实性评估的准确性和透明度，显著优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.27052v1](http://arxiv.org/pdf/2510.27052v1)**
...
>
---
#### [new 029] Overview of the MEDIQA-OE 2025 Shared Task on Medical Order Extraction from Doctor-Patient Consultations
- **分类: cs.CL; cs.AI**

- **简介: 该论文介绍MEDIQA-OE 2025共享任务，聚焦从医患对话中提取医疗医嘱。针对临床文档自动化中医嘱生成难题，构建了首个相关数据集，六支团队参与，采用大语言模型等方法，评估并展示了不同解决方案的性能。**

- **链接: [http://arxiv.org/pdf/2510.26974v1](http://arxiv.org/pdf/2510.26974v1)**
...
>
---
#### [new 038] DialectalArabicMMLU: Benchmarking Dialectal Capabilities in Arabic and Multilingual Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出DialectalArabicMMLU基准，用于评估大语言模型在阿拉伯语方言上的能力。针对现有评测多集中于标准语（MSA）而忽视日常使用的方言问题，研究者将3000个问答对人工翻译并适配至5种主要方言，构建15K条数据，覆盖32个领域。实验评估19个模型，揭示其在方言泛化上的显著差距，推动更包容的多语种模型发展。**

- **链接: [http://arxiv.org/pdf/2510.27543v1](http://arxiv.org/pdf/2510.27543v1)**
...
>
---
#### [new 039] From the Rock Floor to the Cloud: A Systematic Survey of State-of-the-Art NLP in Battery Life Cycle
- **分类: cs.CL**

- **简介: 该论文系统调研NLP在电池全生命周期的应用，提出面向数字电池护照的TLP框架，解决领域内缺乏标准基准等问题。工作包括基于PRISMA方法筛选66篇相关文献，构建可复现的分析体系，并引入智能体AI与优化提示技术以支持材料发现等新任务。**

- **链接: [http://arxiv.org/pdf/2510.27369v1](http://arxiv.org/pdf/2510.27369v1)**
...
>
---
#### [new 042] Simple Additions, Substantial Gains: Expanding Scripts, Languages, and Lineage Coverage in URIEL+
- **分类: cs.CL**

- **简介: 该论文针对多语言知识库URIEL+的数据稀疏问题，通过引入脚本向量、整合Glottolog扩充语言数量、扩展谱系推断，显著提升语言覆盖与特征完整度，增强低资源语言的跨语言迁移性能。**

- **链接: [http://arxiv.org/pdf/2510.27183v1](http://arxiv.org/pdf/2510.27183v1)**
...
>
---
#### [new 043] Why Do Multilingual Reasoning Gaps Emerge in Reasoning Language Models?
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究多语言推理模型中的跨语言推理差距问题。针对高资源语言表现优于低资源语言的现象，揭示其主因是模型在理解多语言输入时无法准确映射至英语。提出通过检测理解失败并仅对失败样本进行选择性翻译，有效缩小差距，提升公平性。**

- **链接: [http://arxiv.org/pdf/2510.27269v1](http://arxiv.org/pdf/2510.27269v1)**
...
>
---
#### [new 046] Evaluating Perspectival Biases in Cross-Modal Retrieval
- **分类: cs.IR; cs.CL; H.3.3; I.2.7; I.2.10**

- **简介: 该论文研究跨模态检索中的视角偏差问题，聚焦语言流行度和文化关联性带来的偏见。针对图像到文本与文本到图像检索，发现流行语言偏见可通过显式对齐缓解，而文化关联偏见更难解决，需针对性策略。**

- **链接: [http://arxiv.org/pdf/2510.26861v1](http://arxiv.org/pdf/2510.26861v1)**
...
>
---
#### [new 047] CATArena: Evaluation of LLM Agents through Iterative Tournament Competitions
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出CATArena，一个基于迭代锦标赛的LLM智能体评估框架，旨在解决现有基准在动态能力评估、评分饱和及依赖人工标注等问题。通过四类开放性棋牌游戏，实现对智能体学习能力与策略优化的持续、稳定评估，推动其向人类水平智能演进。**

- **链接: [http://arxiv.org/pdf/2510.26852v1](http://arxiv.org/pdf/2510.26852v1)**
...
>
---
#### [new 053] Towards Universal Video Retrieval: Generalizing Video Embedding via Synthesized Multimodal Pyramid Curriculum
...
>
> **备注:** 272 pages. Examples of 11 AI-generated paper drafts from different scientific disciplines. Code publicly available at https://github.com/AstroPilot-AI/Denario
>
> **摘要:** We present Denario, an AI multi-agent system designed to serve as a scientific research assistant. Denario can perform many different tasks, such as generating ideas, checking the literature, developing research plans, writing and executing code, making plots, and drafting and reviewing a scientific paper. The system has a modular architecture, allowing it to handle specific tasks, such as generating an idea, or carrying out end-to-end scientific analysis using Cmbagent as a deep-research backend. In this work, we describe in detail Denario and its modules, and illustrate its capabilities by presenting multiple AI-generated papers generated by it in many different scientific disciplines such as astrophysics, biology, biophysics, biomedical informatics, chemistry, material science, mathematical physics, medicine, neuroscience and planetary science. Denario also excels at combining ideas from different disciplines, and we illustrate this by showing a paper that applies methods from quantum physics and machine learning to astrophysical data. We report the evaluations performed on these papers by domain experts, who provided both numerical scores and review-like feedback. We then highlight the strengths, weaknesses, and limitations of the current system. Finally, we discuss the ethical implications of AI-driven research and reflect on how such technology relates to the philosophy of science. We publicly release the code at https://github.com/AstroPilot-AI/Denario. A Denario demo can also be run directly on the web at https://huggingface.co/spaces/astropilot-ai/Denario, and the full app will be deployed on the cloud.
>
---
#### [new 056] DeepCompress: A Dual Reward Strategy for Dynamically Exploring and Compressing Reasoning Chains
- **分类: cs.AI; cs.CL**

- **简介: 该论文针对大推理模型效率与准确率难以兼顾的问题，提出DeepCompress框架。通过动态区分问题难易度，采用双奖励机制：对简单问题压缩推理链以提升效率，对复杂问题扩展推理链以增强准确性，实现自适应推理优化。**

- **链接: [http://arxiv.org/pdf/2510.27419v1](http://arxiv.org/pdf/2510.27419v1)**
...
>
---
#### [new 057] Measuring Chain-of-Thought Monitorability Through Faithfulness and Verbosity
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究链式思维（CoT）的可监控性，旨在评估模型推理过程的透明度。针对现有方法仅关注答案变化导致的不忠实问题，提出引入“冗余度”概念，结合忠实性与完整性，构建综合监控评分。通过在多个基准上测试，发现模型即使表面忠实，仍可能因遗漏关键因素而难以监控，且不同模型家族表现差异显著。**

- **链接: [http://arxiv.org/pdf/2510.27378v1](http://arxiv.org/pdf/2510.27378v1)**
...
>
---
#### [new 058] Semantic Frame Aggregation-based Transformer for Live Video Comment Generation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 059] RepV: Safety-Separable Latent Spaces for Scalable Neurosymbolic Plan Verification
...
>
---
#### [new 062] Glia: A Human-Inspired AI for Automated Systems Design and Optimization
- **分类: cs.AI; cs.CL; cs.DC**

- **简介: 该论文提出Glia，一种受人类启发的多智能体AI架构，用于自动化计算机系统设计与优化。针对传统方法难以生成可解释设计的问题，Glia结合大语言模型与结构化实验，实现推理、实验与分析协同，高效生成高性能、可理解的分布式系统算法，显著提升设计效率并揭示工作负载特性。**

- **链接: [http://arxiv.org/pdf/2510.27176v1](http://arxiv.org/pdf/2510.27176v1)**
...
>
---
#### [new 063] Can MLLMs Read the Room? A Multimodal Benchmark for Verifying Truthfulness in Multi-Party Social Interactions
...
#### [replaced 001] Unlocking Reasoning Capabilities in LLMs via Reinforcement Learning Exploration
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.03865v2](http://arxiv.org/pdf/2510.03865v2)**
...
>
---
#### [replaced 002] VeriFastScore: Speeding up long-form factuality evaluation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16973v3](http://arxiv.org/pdf/2505.16973v3)**
...
>
---
#### [replaced 006] HELIOS: Adaptive Model And Early-Exit Selection for Efficient LLM Inference Serving
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.10724v2](http://arxiv.org/pdf/2504.10724v2)**
...
>
---
#### [replaced 007] R$^2$ec: Towards Large Recommender Models with Reasoning
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16994v3](http://arxiv.org/pdf/2505.16994v3)**
...
>
> **备注:** Accepted at NeurIPS 2025 Datasets & Benchmarks Track
>
...
>
---
#### [replaced 010] Prompt-MII: Meta-Learning Instruction Induction for LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.16932v2](http://arxiv.org/pdf/2510.16932v2)**
...
>
---
#### [replaced 011] HiRA: A Hierarchical Reasoning Framework for Decoupled Planning and Execution in Deep Search
- **分类: cs.AI; cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2507.02652v2](http://arxiv.org/pdf/2507.02652v2)**
...
>
---
#### [replaced 012] Beyond Pixels: Exploring DOM Downsampling for LLM-Based Web Agents
- **分类: cs.AI; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2508.04412v2](http://arxiv.org/pdf/2508.04412v2)**

> **作者:** Thassilo M. Schiepanski; Nicholas Piël
>
> **备注:** 20 pages, LaTeX; repository URL updated, typos corrected
>
...
>
---
#### [replaced 013] Reinforcing the Diffusion Chain of Lateral Thought with Diffusion Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.10446v3](http://arxiv.org/pdf/2505.10446v3)**

> **作者:** Zemin Huang; Zhiyang Chen; Zijun Wang; Tiancheng Li; Guo-Jun Qi
>
> **备注:** Accepted to NeurIPS 2025. Code link: https://github.com/maple-research-lab/LLaDOU
>
...
>
---
#### [replaced 016] Accelerating Diffusion LLMs via Adaptive Parallel Decoding
- **分类: cs.CL; cs.AI; cs.LG; cs.PF**

- **链接: [http://arxiv.org/pdf/2506.00413v2](http://arxiv.org/pdf/2506.00413v2)**

> **作者:** Daniel Israel; Guy Van den Broeck; Aditya Grover
>
> **备注:** 10 pages, 5 figures
>
> **摘要:** The generation speed of LLMs are bottlenecked by autoregressive decoding, where tokens are predicted sequentially one by one. Alternatively, diffusion large language models (dLLMs) theoretically allow for parallel token generation, but in practice struggle to achieve the speed of autoregressive models without significantly sacrificing quality. We therefore introduce adaptive parallel decoding (APD), a novel method that dynamically adjusts the number of tokens sampled in parallel. We achieve this by defining a multiplicative mixture between the dLLM marginal probabilities and the joint probability of sequences under a small auxiliary autoregressive model. This inverts the standard setup of speculative decoding, where the goal is to sample from a large autoregressive verifier by drafting from a smaller model. We further optimize APD by enabling KV caching and limiting the size of the masked input. Altogether, our method puts forward three tunable parameters to flexibly tradeoff throughput and quality. We show that APD provides markedly higher throughput with minimal quality degradations on downstream benchmarks.
>
---
#### [replaced 017] Multilingual Political Views of Large Language Models: Identification and Steering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.22623v2](http://arxiv.org/pdf/2507.22623v2)**
...
>
---
#### [replaced 018] DiffAdapt: Difficulty-Adaptive Reasoning for Token-Efficient LLM Inference
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.19669v2](http://arxiv.org/pdf/2510.19669v2)**
...
>
---
#### [replaced 019] Token Distillation: Attention-aware Input Embeddings For New Tokens
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.20133v2](http://arxiv.org/pdf/2505.20133v2)**
...
>
---
#### [replaced 020] Mathematics Isn't Culture-Free: Probing Cultural Gaps via Entity and Scenario Perturbations
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.00883v2](http://arxiv.org/pdf/2507.00883v2)**
...
>
---
#### [replaced 021] Training a Generally Curious Agent
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.17543v4](http://arxiv.org/pdf/2502.17543v4)**
...
>
---
#### [replaced 022] Integrating Video and Text: A Balanced Approach to Multimodal Summary Generation and Evaluation
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 023] DiagramEval: Evaluating LLM-Generated Diagrams via Graphs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.25761v2](http://arxiv.org/pdf/2510.25761v2)**
...
>
---
#### [replaced 026] Ready to Translate, Not to Represent? Bias and Performance Gaps in Multilingual LLMs Across Language Families and Domains
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.07877v2](http://arxiv.org/pdf/2510.07877v2)**
...
>
---
#### [replaced 027] MindSearch: Mimicking Human Minds Elicits Deep AI Searcher
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2407.20183v2](http://arxiv.org/pdf/2407.20183v2)**
...
>
> **摘要:** Information seeking and integration is a complex cognitive task that consumes enormous time and effort. Inspired by the remarkable progress of Large Language Models, recent works attempt to solve this task by combining LLMs and search engines. However, these methods still obtain unsatisfying performance due to three challenges: (1) complex requests often cannot be accurately and completely retrieved by the search engine once (2) corresponding information to be integrated is spread over multiple web pages along with massive noise, and (3) a large number of web pages with long contents may quickly exceed the maximum context length of LLMs. Inspired by the cognitive process when humans solve these problems, we introduce MindSearch to mimic the human minds in web information seeking and integration, which can be instantiated by a simple yet effective LLM-based multi-agent framework. The WebPlanner models the human mind of multi-step information seeking as a dynamic graph construction process: it decomposes the user query into atomic sub-questions as nodes in the graph and progressively extends the graph based on the search result from WebSearcher. Tasked with each sub-question, WebSearcher performs hierarchical information retrieval with search engines and collects valuable information for WebPlanner. The multi-agent design of MindSearch enables the whole framework to seek and integrate information parallelly from larger-scale (e.g., more than 300) web pages in 3 minutes, which is worth 3 hours of human effort. MindSearch demonstrates significant improvement in the response quality in terms of depth and breadth, on both close-set and open-set QA problems. Besides, responses from MindSearch based on InternLM2.5-7B are preferable by humans to ChatGPT-Web and Perplexity.ai applications, which implies that MindSearch can already deliver a competitive solution to the proprietary AI search engine.
>
---
#### [replaced 028] LIBMoE: A Library for comprehensive benchmarking Mixture of Experts in Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.00918v2](http://arxiv.org/pdf/2411.00918v2)**
...
>
---
#### [replaced 029] Navigating the Alignment-Calibration Trade-off: A Pareto-Superior Frontier via Model Merging
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.17426v2](http://arxiv.org/pdf/2510.17426v2)**
...
>
---
#### [replaced 030] Reinforcement Learning vs. Distillation: Understanding Accuracy and Capability in LLM Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.14216v2](http://arxiv.org/pdf/2505.14216v2)**
...
>
---
#### [replaced 031] More of the Same: Persistent Representational Harms Under Increased Representation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.00333v3](http://arxiv.org/pdf/2503.00333v3)**

> **作者:** Jennifer Mickel; Maria De-Arteaga; Leqi Liu; Kevin Tian
>
> **备注:** Proceedings of the Neural Information Processing Systems (NeurIPS) 2025; 39 pages, 7 figures, 15 tables
>
> **摘要:** To recognize and mitigate the harms of generative AI systems, it is crucial to consider whether and how different societal groups are represented by these systems. A critical gap emerges when naively measuring or improving who is represented, as this does not consider how people are represented. In this work, we develop GAS(P), an evaluation methodology for surfacing distribution-level group representational biases in generated text, tackling the setting where groups are unprompted (i.e., groups are not specified in the input to generative systems). We apply this novel methodology to investigate gendered representations in occupations across state-of-the-art large language models. We show that, even though the gender distribution when models are prompted to generate biographies leads to a large representation of women, even representational biases persist in how different genders are represented. Our evaluation methodology reveals that there are statistically significant distribution-level differences in the word choice used to describe biographies and personas of different genders across occupations, and we show that many of these differences are associated with representational harms and stereotypes. Our empirical findings caution that naively increasing (unprompted) representation may inadvertently proliferate representational biases, and our proposed evaluation methodology enables systematic and rigorous measurement of the problem.
>
---
#### [replaced 032] RADAR: Benchmarking Language Models on Imperfect Tabular Data
- **分类: cs.DB; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.08249v2](http://arxiv.org/pdf/2506.08249v2)**
...
>
---
#### [replaced 035] A Multi-Stage Framework with Taxonomy-Guided Reasoning for Occupation Classification Using Large Language Models
- **分类: cs.CL; cs.AI; cs.SI**

- **链接: [http://arxiv.org/pdf/2503.12989v3](http://arxiv.org/pdf/2503.12989v3)**
...
>
---
#### [replaced 036] KAT-Coder Technical Report
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.18779v3](http://arxiv.org/pdf/2510.18779v3)**
...
>
---
#### [replaced 037] Minitron-SSM: Efficient Hybrid Language Model Compression through Group-Aware SSM Pruning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.11409v2](http://arxiv.org/pdf/2504.11409v2)**
...
>
---
#### [replaced 039] The End of Manual Decoding: Towards Truly End-to-End Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.26697v2](http://arxiv.org/pdf/2510.26697v2)**
...
>
---
#### [replaced 041] Normative Reasoning in Large Language Models: A Comparative Benchmark from Logical and Modal Perspectives
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.26606v2](http://arxiv.org/pdf/2510.26606v2)**
...
>
---
#### [replaced 044] E2Rank: Your Text Embedding can Also be an Effective and Efficient Listwise Reranker
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2510.22733v2](http://arxiv.org/pdf/2510.22733v2)**
...
>
> **摘要:** Text embedding models serve as a fundamental component in real-world search applications. By mapping queries and documents into a shared embedding space, they deliver competitive retrieval performance with high efficiency. However, their ranking fidelity remains limited compared to dedicated rerankers, especially recent LLM-based listwise rerankers, which capture fine-grained query-document and document-document interactions. In this paper, we propose a simple yet effective unified framework E2Rank, means Efficient Embedding-based Ranking (also means Embedding-to-Rank), which extends a single text embedding model to perform both high-quality retrieval and listwise reranking through continued training under a listwise ranking objective, thereby achieving strong effectiveness with remarkable efficiency. By applying cosine similarity between the query and document embeddings as a unified ranking function, the listwise ranking prompt, which is constructed from the original query and its candidate documents, serves as an enhanced query enriched with signals from the top-K documents, akin to pseudo-relevance feedback (PRF) in traditional retrieval models. This design preserves the efficiency and representational quality of the base embedding model while significantly improving its reranking performance. Empirically, E2Rank achieves state-of-the-art results on the BEIR reranking benchmark and demonstrates competitive performance on the reasoning-intensive BRIGHT benchmark, with very low reranking latency. We also show that the ranking training process improves embedding performance on the MTEB benchmark. Our findings indicate that a single embedding model can effectively unify retrieval and reranking, offering both computational efficiency and competitive ranking accuracy.
>
---
#### [replaced 045] Cancer-Myth: Evaluating Large Language Models on Patient Questions with False Presuppositions
- **分类: cs.CL; cs.CY**

- **链接: [http://arxiv.org/pdf/2504.11373v3](http://arxiv.org/pdf/2504.11373v3)**
...
>
---
#### [replaced 046] NeuronMM: High-Performance Matrix Multiplication for LLM Inference on AWS Trainium
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.25977v2](http://arxiv.org/pdf/2510.25977v2)**
