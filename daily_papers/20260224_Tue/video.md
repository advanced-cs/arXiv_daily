...
>
---
#### [new 008] A Very Big Video Reasoning Suite
...
>
---
#### [new 013] Descriptor: Dataset of Parasitoid Wasps and Associated Hymenoptera (DAPWH)
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像识别任务，旨在解决寄生蜂分类困难的问题。构建了一个包含3556张高分辨率图像的标注数据集，用于训练自动化识别模型。**

- **链接: [https://arxiv.org/pdf/2602.20028v1](https://arxiv.org/pdf/2602.20028v1)**
...
>
---
#### [new 016] Decoupling Vision and Language: Codebook Anchored Visual Adaptation
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型领域，解决视觉编码器在特定任务中表现不佳的问题。提出CRAFT方法，通过离散代码本实现视觉表示的稳定适配，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.19449v1](https://arxiv.org/pdf/2602.19449v1)**
...
>
---
#### [new 026] SeaCache: Spectral-Evolution-Aware Cache for Accelerating Diffusion Models
- **分类: cs.CV**

- **简介: 该论文属于视觉生成任务，旨在加速扩散模型的推理。针对其序列去噪过程慢的问题，提出SeaCache方法，通过谱进化特性优化缓存策略，提升效率与质量平衡。**

- **链接: [https://arxiv.org/pdf/2602.18993v1](https://arxiv.org/pdf/2602.18993v1)**

> **作者:** Jiwoo Chung; Sangeek Hyun; MinKyu Lee; Byeongju Han; Geonho Cha; Dongyoon Wee; Youngjun Hong; Jae-Pil Heo
>
> **备注:** Accepted to CVPR 2026 Main. Project page:https://jiwoogit.github.io/SeaCache
>
...
>
---
#### [new 027] Think with Grounding: Curriculum Reinforced Reasoning with Video Grounding for Long Video Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于长视频理解任务，旨在解决因视频上下文有限导致的推理幻觉问题。提出Video-TwG框架，通过分阶段强化课程策略和TwG-GRPO算法，提升视频问答性能。**

- **链接: [https://arxiv.org/pdf/2602.18702v1](https://arxiv.org/pdf/2602.18702v1)**
...
>
---
#### [new 028] FUSAR-GPT : A Spatiotemporal Feature-Embedded and Two-Stage Decoupled Visual Language Model for SAR Imagery
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于遥感图像理解任务，旨在解决SAR图像智能解析难题。通过构建专用数据集和设计时空特征嵌入与两阶段解耦框架，提升VLM在SAR领域的性能。**

- **链接: [https://arxiv.org/pdf/2602.19190v1](https://arxiv.org/pdf/2602.19190v1)**
...
>
---
#### [new 031] CLCR: Cross-Level Semantic Collaborative Representation for Multimodal Learning
- **分类: cs.CV; cs.AI; cs.MM**

- **简介: 该论文提出CLCR模型，用于多模态学习任务，解决跨模态语义对齐和信息泄露问题。通过构建三级语义层次结构，实现共享与私有特征的有效分离与融合。**

- **链接: [https://arxiv.org/pdf/2602.19605v1](https://arxiv.org/pdf/2602.19605v1)**

> **作者:** Chunlei Meng; Guanhong Huang; Rong Fu; Runmin Jian; Zhongxue Gan; Chun Ouyang
>
> **备注:** This study has been Accepted by CVPR 2026
>
> **摘要:** Multimodal learning aims to capture both shared and private information from multiple modalities. However, existing methods that project all modalities into a single latent space for fusion often overlook the asynchronous, multi-level semantic structure of multimodal data. This oversight induces semantic misalignment and error propagation, thereby degrading representation quality. To address this issue, we propose Cross-Level Co-Representation (CLCR), which explicitly organizes each modality's features into a three-level semantic hierarchy and specifies level-wise constraints for cross-modal interactions. First, a semantic hierarchy encoder aligns shallow, mid, and deep features across modalities, establishing a common basis for interaction. And then, at each level, an Intra-Level Co-Exchange Domain (IntraCED) factorizes features into shared and private subspaces and restricts cross-modal attention to the shared subspace via a learnable token budget. This design ensures that only shared semantics are exchanged and prevents leakage from private channels. To integrate information across levels, the Inter-Level Co-Aggregation Domain (InterCAD) synchronizes semantic scales using learned anchors, selectively fuses the shared representations, and gates private cues to form a compact task representation. We further introduce regularization terms to enforce separation of shared and private features and to minimize cross-level interference. Experiments on six benchmarks spanning emotion recognition, event localization, sentiment analysis, and action recognition show that CLCR achieves strong performance and generalizes well across tasks.
>
---
#### [new 032] ConceptPrism: Concept Disentanglement in Personalized Diffusion Models via Residual Token Optimization
- **分类: cs.CV**

- **简介: 该论文属于个性化文本到图像生成任务，解决概念纠缠问题。通过自动分离共享视觉概念与图像特定残差，提升生成质量与文本对齐。**

- **链接: [https://arxiv.org/pdf/2602.19575v1](https://arxiv.org/pdf/2602.19575v1)**
...
>
---
#### [new 033] No Need For Real Anomaly: MLLM Empowered Zero-Shot Video Anomaly Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频异常检测任务，解决开放场景下异常数据稀缺的问题。提出LAVIDA框架，利用伪异常和多模态大语言模型实现零样本检测。**

- **链接: [https://arxiv.org/pdf/2602.19248v1](https://arxiv.org/pdf/2602.19248v1)**
...
>
---
#### [new 045] Gradient based Severity Labeling for Biomarker Classification in OCT
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分类任务，旨在提升糖尿病视网膜病变生物标志物的检测精度。针对医疗图像中随意增强可能破坏关键区域的问题，提出基于梯度的严重程度标签生成方法，优化对比学习效果。**

- **链接: [https://arxiv.org/pdf/2602.19907v1](https://arxiv.org/pdf/2602.19907v1)**
...
>
> **摘要:** We study the task of establishing object-level visual correspondence across different viewpoints in videos, focusing on the challenging egocentric-to-exocentric and exocentric-to-egocentric scenarios. We propose a simple yet effective framework based on conditional binary segmentation, where an object query mask is encoded into a latent representation to guide the localization of the corresponding object in a target video. To encourage robust, view-invariant representations, we introduce a cycle-consistency training objective: the predicted mask in the target view is projected back to the source view to reconstruct the original query mask. This bidirectional constraint provides a strong self-supervisory signal without requiring ground-truth annotations and enables test-time training (TTT) at inference. Experiments on the Ego-Exo4D and HANDAL-X benchmarks demonstrate the effectiveness of our optimization objective and TTT strategy, achieving state-of-the-art performance. The code is available at https://github.com/shannany0606/CCMP.
>
---
#### [new 048] DUET-VLM: Dual stage Unified Efficient Token reduction for VLM Training and Inference
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出DUET-VLM，解决视觉语言模型的计算效率问题。通过双阶段压缩，在保持高精度的同时显著减少视觉token数量。**

- **链接: [https://arxiv.org/pdf/2602.18846v1](https://arxiv.org/pdf/2602.18846v1)**

> **作者:** Aditya Kumar Singh; Hitesh Kandala; Pratik Prabhanjan Brahma; Zicheng Liu; Emad Barsoum
>
> **备注:** 15 Pages, 8 figures, 15 tables, CVPR 2026; Code: https://github.com/AMD-AGI/DUET-VLM
>
...
>
---
#### [new 057] ORION: ORthonormal Text Encoding for Universal VLM AdaptatION
- **分类: cs.CV**

- **简介: 该论文提出ORION框架，用于优化视觉语言模型的文本编码，解决文本原型质量与几何分布问题，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.19530v1](https://arxiv.org/pdf/2602.19530v1)**
...
>
---
#### [new 073] Physics-informed Active Polarimetric 3D Imaging for Specular Surfaces
- **分类: cs.CV; physics.optics**

- **简介: 该论文属于3D成像任务，旨在解决复杂镜面表面单次拍摄的精确测量问题。通过融合偏振信息与深度学习，提升成像精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2602.19470v1](https://arxiv.org/pdf/2602.19470v1)**
...
>
---
#### [new 078] MRI Contrast Enhancement Kinetics World Model
- **分类: cs.CV**

- **简介: 该论文属于医学影像生成任务，旨在解决MRI对比增强动态建模问题。针对数据稀疏和时间不连续，提出CEKWorld模型，结合时空一致性学习提升生成质量与动态连贯性。**

- **链接: [https://arxiv.org/pdf/2602.19285v1](https://arxiv.org/pdf/2602.19285v1)**
...
>
---
#### [new 084] StructXLIP: Enhancing Vision-language Models with Multimodal Structural Cues
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出StructXLIP，用于增强视觉-语言模型的对齐。任务是跨模态检索，解决细粒度描述下的对齐问题，通过引入结构线索提升性能。**

- **链接: [https://arxiv.org/pdf/2602.20089v1](https://arxiv.org/pdf/2602.20089v1)**
...
>
---
#### [new 087] MeanFuser: Fast One-Step Multi-Modal Trajectory Generation and Adaptive Reconstruction via MeanFlow for End-to-End Autonomous Driving
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 090] MIRROR: Multimodal Iterative Reasoning via Reflection on Visual Regions
- **分类: cs.CV**

- **简介: 该论文属于视觉语言推理任务，旨在解决VLMs在复杂视觉输入中产生幻觉或逻辑错误的问题。提出MIRROR框架，通过多轮视觉区域反思实现更准确的推理。**

- **链接: [https://arxiv.org/pdf/2602.18746v1](https://arxiv.org/pdf/2602.18746v1)**
...
>
---
#### [new 098] DICArt: Advancing Category-level Articulated Object Pose Estimation in Discrete State-Spaces
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于具身AI中的刚体物体位姿估计任务，解决连续空间中搜索复杂和约束不足的问题，提出DICArt框架，通过离散扩散过程实现更准确的位姿估计。**

- **链接: [https://arxiv.org/pdf/2602.19565v1](https://arxiv.org/pdf/2602.19565v1)**
...
>
---
#### [new 104] WiCompass: Oracle-driven Data Scaling for mmWave Human Pose Estimation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于毫米波人体姿态估计任务，解决分布偏移下的泛化能力问题。提出WiCompass框架，通过覆盖感知的数据采集提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2602.18726v1](https://arxiv.org/pdf/2602.18726v1)**
...
>
---
#### [new 106] Learning Mutual View Information Graph for Adaptive Adversarial Collaborative Perception
- **分类: cs.CV**

- **简介: 该论文属于对抗性协同感知任务，旨在解决防御系统易受自适应攻击的问题。提出MVIG框架，通过学习互视信息图生成动态攻击策略，有效降低防御成功率。**

- **链接: [https://arxiv.org/pdf/2602.19596v1](https://arxiv.org/pdf/2602.19596v1)**
...
>
---
#### [new 107] RL-RIG: A Generative Spatial Reasoner via Intrinsic Reflection
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在解决空间关系理解不足的问题。提出RL-RIG框架，通过强化学习提升生成图像的空间一致性与结构准确性。**

- **链接: [https://arxiv.org/pdf/2602.19974v1](https://arxiv.org/pdf/2602.19974v1)**
...
>
---
#### [new 112] Multimodal Dataset Distillation Made Simple by Prototype-Guided Data Synthesis
- **分类: cs.CV**

- **简介: 该论文属于多模态学习任务，旨在解决大规模数据训练成本高的问题。提出一种无需训练的高效数据蒸馏方法，提升跨架构泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.19756v1](https://arxiv.org/pdf/2602.19756v1)**
...
>
---
#### [new 126] RAP: Fast Feedforward Rendering-Free Attribute-Guided Primitive Importance Score Prediction for Efficient 3D Gaussian Splatting Processing
- **分类: cs.CV; cs.GR**

- **简介: 该论文属于3D场景重建任务，解决3DGS中大量原始体重要性评估问题。提出RAP方法，通过高斯属性和局部统计直接预测重要性，无需渲染，提升效率与通用性。**

- **链接: [https://arxiv.org/pdf/2602.19753v1](https://arxiv.org/pdf/2602.19753v1)**
...
>
---
#### [new 136] HeRO: Hierarchical 3D Semantic Representation for Pose-aware Object Manipulation
- **分类: cs.CV**

- **简介: 该论文提出HeRO，用于姿态感知的物体操作任务，解决几何与语义结合不足的问题。通过融合DINOv2和Stable Diffusion，构建层次化语义场，提升操作成功率。**

- **链接: [https://arxiv.org/pdf/2602.18817v1](https://arxiv.org/pdf/2602.18817v1)**
...
>
> **摘要:** This work proposes a green learning (GL) approach to restore medical images. Without loss of generality, we use low-dose computed tomography (LDCT) images as examples. LDCT images are susceptible to noise and artifacts, where the imaging process introduces distortion. LDCT image restoration is an important preprocessing step for further medical analysis. Deep learning (DL) methods have been developed to solve this problem. We examine an alternative solution using the Green Learning (GL) methodology. The new restoration method is characterized by mathematical transparency, computational and memory efficiency, and high performance. Experiments show that our GL method offers state-of-the-art restoration performance at a smaller model size and with lower inference complexity.
>
---
#### [new 142] A Text-Guided Vision Model for Enhanced Recognition of Small Instances
- **分类: cs.CV**

- **简介: 该论文属于目标检测任务，旨在提升小目标的识别精度。通过改进YOLO-World模型，优化结构并提高效率，实现更准确的小目标检测。**

- **链接: [https://arxiv.org/pdf/2602.19503v1](https://arxiv.org/pdf/2602.19503v1)**
...
>
---
#### [new 143] Subtle Motion Blur Detection and Segmentation from Static Image Artworks
- **分类: cs.CV**

- **简介: 该论文属于图像质量评估任务，解决静态图像中细微运动模糊检测与分割问题。通过构建高质量数据集和设计端到端检测框架，提升检测精度与泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.18720v1](https://arxiv.org/pdf/2602.18720v1)**
...
>
---
#### [new 148] FOCA: Frequency-Oriented Cross-Domain Forgery Detection, Localization and Explanation via Multi-Modal Large Language Model
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像伪造检测任务，解决现有方法依赖语义、忽视纹理及解释性差的问题，提出FOCA框架，结合多模态大模型实现精准检测与解释。**

- **链接: [https://arxiv.org/pdf/2602.18880v1](https://arxiv.org/pdf/2602.18880v1)**
...
>
---
#### [new 160] Multi-Modal Representation Learning via Semi-Supervised Rate Reduction for Generalized Category Discovery
- **分类: cs.CV**

- **简介: 该论文属于广义类别发现任务，旨在识别已知和未知类别。针对多模态表示学习中的问题，提出SSR²-GCD框架，强化模态内对齐，提升跨模态表示质量。**

- **链接: [https://arxiv.org/pdf/2602.19910v1](https://arxiv.org/pdf/2602.19910v1)**
...
>
---
#### [new 161] RADE-Net: Robust Attention Network for Radar-Only Object Detection in Adverse Weather
- **分类: cs.CV**

- **简介: 该论文属于雷达目标检测任务，旨在解决恶劣天气下感知性能下降的问题。通过3D投影方法和轻量模型RADE-Net，提升雷达数据处理效率与检测精度。**

- **链接: [https://arxiv.org/pdf/2602.19994v1](https://arxiv.org/pdf/2602.19994v1)**
...
>
---
#### [new 170] Artefact-Aware Fungal Detection in Dermatophytosis: A Real-Time Transformer-Based Approach for KOH Microscopy
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分析任务，旨在解决KOH显微镜下真菌检测中因伪影导致的识别困难问题。通过Transformer模型实现精准定位与分类。**

- **链接: [https://arxiv.org/pdf/2602.19156v1](https://arxiv.org/pdf/2602.19156v1)**
...
>
---
#### [new 184] MiSCHiEF: A Benchmark in Minimal-Pairs of Safety and Culture for Holistic Evaluation of Fine-Grained Image-Caption Alignment
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MiSCHiEF基准，用于评估视觉语言模型在安全与文化场景下的细粒度图像-标题对齐能力，解决跨模态对齐难题。**

- **链接: [https://arxiv.org/pdf/2602.18729v1](https://arxiv.org/pdf/2602.18729v1)**
...
>
---
#### [new 205] Deep LoRA-Unfolding Networks for Image Restoration
- **分类: cs.CV**

- **简介: 该论文提出LoRun，用于图像修复任务，解决传统深度展开网络参数冗余和阶段适应性差的问题，通过共享预训练去噪器和轻量级LoRA适配器实现高效去噪。**

- **链接: [https://arxiv.org/pdf/2602.18697v1](https://arxiv.org/pdf/2602.18697v1)**
...
>
---
#### [new 212] Characterization of Residual Morphological Substructure Using Supervised and Unsupervised Deep Learning
- **分类: astro-ph.GA; cs.CV**

- **简介: 该论文属于天体物理中的图像分析任务，旨在通过深度学习识别星系残差结构。研究使用监督和非监督方法处理星系图像，以区分不同类型的残差特征。**

- **链接: [https://arxiv.org/pdf/2602.18883v1](https://arxiv.org/pdf/2602.18883v1)**

> **作者:** Kameswara Bharadwaj Mantha; Daniel H. McIntosh; Cody Ciaschi; Rubyet Evan; Luther Landry; Henry C. Ferguson; Camilla Pacifici; Joel Primack; Nimish Hathi; Anton Koekemoer; Yicheng Guo; The CANDELS Collaboration
>
...
>
---
#### [new 217] A Markovian View of Iterative-Feedback Loops in Image Generative Models: Neural Resonance and Model Collapse
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究生成模型中的反馈循环问题，提出“神经共振”机制解释模型崩溃现象，并通过马尔可夫链分析提供诊断方法。**

- **链接: [https://arxiv.org/pdf/2602.19033v1](https://arxiv.org/pdf/2602.19033v1)**
...
>
---
#### [new 229] Simulation-Ready Cluttered Scene Estimation via Physics-aware Joint Shape and Pose Optimization
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 232] Systematic Analysis of Coupling Effects on Closed-Loop and Open-Loop Performance in Aerial Continuum Manipulators
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 238] OVerSeeC: Open-Vocabulary Costmap Generation from Satellite Images and Natural Language
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 246] WildOS: Open-Vocabulary Object Search in the Wild
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 247] EEG-Driven Intention Decoding: Offline Deep Learning Benchmarking on a Robotic Rover
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 248] To Move or Not to Move: Constraint-based Planning Enables Zero-Shot Generalization for Interactive Navigation
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 002] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.10065v2](https://arxiv.org/pdf/2507.10065v2)**

> **作者:** Chenguo Lin; Yuchen Lin; Panwang Pan; Yifan Yu; Tao Hu; Honglei Yan; Katerina Fragkiadaki; Yadong Mu
>
> **备注:** Project page: https://chenguolin.github.io/projects/MoVieS; Accepted to CVPR 2026
>
...
>
---
#### [replaced 003] Editable-DeepSC: Reliable Cross-Modal Semantic Communications for Facial Editing
- **分类: cs.IT; cs.CV; cs.NI**

- **链接: [https://arxiv.org/pdf/2411.15702v4](https://arxiv.org/pdf/2411.15702v4)**

> **作者:** Bin Chen; Wenbo Yu; Qinshan Zhang; Tianqu Zhuang; Hao Wu; Yong Jiang; Shu-Tao Xia
>
> **备注:** accepted by Chinese Journal of Electronics
>
...
>
---
#### [replaced 006] OBS-Diff: Accurate Pruning For Diffusion Models in One-Shot
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.06751v3](https://arxiv.org/pdf/2510.06751v3)**
...
>
---
#### [replaced 010] VIRTUE: Visual-Interactive Text-Image Universal Embedder
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.00523v2](https://arxiv.org/pdf/2510.00523v2)**

> **作者:** Wei-Yao Wang; Kazuya Tateishi; Qiyu Wu; Shusuke Takahashi; Yuki Mitsufuji
>
> **备注:** ICLR 2026. 25 pages. Project page: https://sony.github.io/virtue/
>
> **摘要:** Multimodal representation learning models have demonstrated successful operation across complex tasks, and the integration of vision-language models (VLMs) has further enabled embedding models with instruction-following capabilities. However, existing embedding models lack visual-interactive capabilities to specify regions of interest from users (e.g., point, bounding box, mask), which have been explored in generative models to broaden their human-interactive applicability. Equipping embedding models with visual interactions not only would unlock new applications with localized grounding of user intent, which remains unexplored, but also enable the models to learn entity-level information within images to complement their global representations for conventional embedding tasks. In this paper, we propose a novel Visual-InteRactive Text-Image Universal Embedder (VIRTUE) that extends the capabilities of the segmentation model and the vision-language model to the realm of representation learning. In VIRTUE, the segmentation model can process visual prompts that pinpoint specific regions within an image, thereby enabling the embedder to handle complex and ambiguous scenarios more precisely. To evaluate the visual-interaction ability of VIRTUE, we introduce a large-scale Segmentation-and-Scene Caption Retrieval (SCaR) benchmark comprising 1M samples that aims to retrieve the text caption by jointly considering the entity with a specific object and image scene. VIRTUE consistently achieves a state-of-the-art performance with significant improvements across 36 universal MMEB (3.1%-8.5%) and five visual-interactive SCaR (15.2%-20.3%) tasks.
>
---
#### [replaced 011] Geometry Distributions
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2411.16076v2](https://arxiv.org/pdf/2411.16076v2)**

> **作者:** Biao Zhang; Jing Ren; Peter Wonka
>
> **备注:** Accepted to ICCV 2025. For the project site, see https://1zb.github.io/GeomDist/
>
...
>
---
#### [replaced 012] $R^2$-Mesh: Reinforcement Learning Powered Mesh Reconstruction via Geometry and Appearance Refinement
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2408.10135v2](https://arxiv.org/pdf/2408.10135v2)**

> **作者:** Haoyang Wang; Liming Liu; Xinggong Zhang
>
> **摘要:** Mesh reconstruction from Neural Radiance Fields (NeRF) is widely used in 3D reconstruction and has been applied across numerous domains. However, existing methods typically rely solely on the given training set images, which restricts supervision to limited observations and makes it difficult to fully constrain geometry and appearance. Moreover, the contribution of each viewpoint for training is not uniform and changes dynamically during the optimization process, which can result in suboptimal guidance for both geometric refinement and rendering quality. To address these limitations, we propose $R^2$-Mesh, a reinforcement learning framework that combines NeRF-rendered pseudo-supervision with online viewpoint selection. Our key insight is to exploit NeRF's rendering ability to synthesize additional high-quality images, enriching training with diverse viewpoint information. To ensure that supervision focuses on the most beneficial perspectives, we introduce a UCB-based strategy with a geometry-aware reward, which dynamically balances exploration and exploitation to identify informative viewpoints throughout training. Within this framework, we jointly optimize SDF geometry and view-dependent appearance under differentiable rendering, while periodically refining meshes to capture fine geometric details. Experiments demonstrate that our method achieves competitive results in both geometric accuracy and rendering quality.
>
---
#### [replaced 013] AGE-Net: Spectral--Spatial Fusion and Anatomical Graph Reasoning with Evidential Ordinal Regression for Knee Osteoarthritis Grading
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.17336v2](https://arxiv.org/pdf/2601.17336v2)**

> **作者:** Xiaoyang Li; Runni Zhou; Xinghao Yan; Chenjie Zhu; Zhaochen Li; Liehao Yan; Yuan Chai
>
> **备注:** 26 pages
>
> **摘要:** Automated Kellgren--Lawrence (KL) grading from knee radiographs is challenging due to subtle structural changes, long-range anatomical dependencies, and ambiguity near grade boundaries. We propose AGE-Net, a ConvNeXt-based framework that integrates Spectral--Spatial Fusion (SSF), Anatomical Graph Reasoning (AGR), and Differential Refinement (DFR). To capture predictive uncertainty and preserve label ordinality, AGE-Net employs a Normal-Inverse-Gamma (NIG) evidential regression head and a pairwise ordinal ranking constraint. On a knee KL dataset, AGE-Net achieves a quadratic weighted kappa (QWK) of 0.9017 +/- 0.0045 and a mean squared error (MSE) of 0.2349 +/- 0.0028 over three random seeds, outperforming strong CNN baselines and showing consistent gains in ablation studies. We further outline evaluations of uncertainty quality, robustness, and explainability, with additional experimental figures to be included in the full manuscript.
>
---
#### [replaced 014] Foundation Model Priors Enhance Object Focus in Feature Space for Source-Free Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17514v3](https://arxiv.org/pdf/2512.17514v3)**
...
>
---
#### [replaced 015] Countering Multi-modal Representation Collapse through Rank-targeted Fusion
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.06450v2](https://arxiv.org/pdf/2511.06450v2)**
...
>
---
#### [replaced 021] Unleashing the Power of Discrete-Time State Representation: Ultrafast Target-based IMU-Camera Spatial-Temporal Calibration
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 022] WAVE: Learning Unified & Versatile Audio-Visual Embeddings with Multimodal LLM
- **分类: cs.CV; cs.SD**
...
>
---
#### [replaced 027] Refine Now, Query Fast: A Decoupled Refinement Paradigm for Implicit Neural Fields
- **分类: cs.LG; cs.CE; cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2602.15155v2](https://arxiv.org/pdf/2602.15155v2)**
...
>
---
#### [replaced 028] LRR-Bench: Left, Right or Rotate? Vision-Language models Still Struggle With Spatial Understanding Tasks
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.20174v3](https://arxiv.org/pdf/2507.20174v3)**
...
>
---
#### [replaced 029] MSGNav: Unleashing the Power of Multi-modal 3D Scene Graph for Zero-Shot Embodied Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 030] Geometry-Aware Rotary Position Embedding for Consistent Video World Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.07854v3](https://arxiv.org/pdf/2602.07854v3)**
...
>
---
#### [replaced 034] Meta-DAN: towards an efficient prediction strategy for page-level handwritten text recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.03349v2](https://arxiv.org/pdf/2504.03349v2)**
...
>
---
#### [replaced 035] DL$^3$M: A Vision-to-Language Framework for Expert-Level Medical Reasoning through Deep Learning and Large Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.13742v2](https://arxiv.org/pdf/2512.13742v2)**
...
>
---
#### [replaced 036] BLM-Guard: Explainable Multimodal Ad Moderation with Chain-of-Thought and Policy-Aligned Rewards
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.18193v2](https://arxiv.org/pdf/2602.18193v2)**
...
>
> **摘要:** Short-video platforms now host vast multimodal ads whose deceptive visuals, speech and subtitles demand finer-grained, policy-driven moderation than community safety filters. We present BLM-Guard, a content-audit framework for commercial ads that fuses Chain-of-Thought reasoning with rule-based policy principles and a critic-guided reward. A rule-driven ICoT data-synthesis pipeline jump-starts training by generating structured scene descriptions, reasoning chains and labels, cutting annotation costs. Reinforcement learning then refines the model using a composite reward balancing causal coherence with policy adherence. A multitask architecture models intra-modal manipulations (e.g., exaggerated imagery) and cross-modal mismatches (e.g., subtitle-speech drift), boosting robustness. Experiments on real short-video ads show BLM-Guard surpasses strong baselines in accuracy, consistency and generalization.
>
---
#### [replaced 037] MedDIFT: Multi-Scale Diffusion-Based Correspondence in 3D Medical Imaging
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05571v2](https://arxiv.org/pdf/2512.05571v2)**
...
>
---
#### [replaced 038] Agent Banana: High-Fidelity Image Editing with Agentic Thinking and Tooling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.09084v2](https://arxiv.org/pdf/2602.09084v2)**
...
>
---
#### [replaced 047] GuideFlow: Constraint-Guided Flow Matching for Planning in End-to-End Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18729v3](https://arxiv.org/pdf/2511.18729v3)**
...
>
---
#### [replaced 048] ReMoRa: Multimodal Large Language Model based on Refined Motion Representation for Long-Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.16412v2](https://arxiv.org/pdf/2602.16412v2)**

> **作者:** Daichi Yashima; Shuhei Kurita; Yusuke Oda; Komei Sugiura
>
> **备注:** Accepted to CVPR 2026
>
> **摘要:** While multimodal large language models (MLLMs) have shown remarkable success across a wide range of tasks, long-form video understanding remains a significant challenge. In this study, we focus on video understanding by MLLMs. This task is challenging because processing a full stream of RGB frames is computationally intractable and highly redundant, as self-attention have quadratic complexity with sequence length. In this paper, we propose ReMoRa, a video MLLM that processes videos by operating directly on their compressed representations. A sparse set of RGB keyframes is retained for appearance, while temporal dynamics are encoded as a motion representation, removing the need for sequential RGB frames. These motion representations act as a compact proxy for optical flow, capturing temporal dynamics without full frame decoding. To refine the noise and low fidelity of block-based motions, we introduce a module to denoise and generate a fine-grained motion representation. Furthermore, our model compresses these features in a way that scales linearly with sequence length. We demonstrate the effectiveness of ReMoRa through extensive experiments across a comprehensive suite of long-video understanding benchmarks. ReMoRa outperformed baseline methods on multiple challenging benchmarks, including LongVideoBench, NExT-QA, and MLVU.
>
---
#### [replaced 049] The Intricate Dance of Prompt Complexity, Quality, Diversity, and Consistency in T2I Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.19557v2](https://arxiv.org/pdf/2510.19557v2)**

> **作者:** Zhang Xiaofeng; Aaron Courville; Michal Drozdzal; Adriana Romero-Soriano
>
> **备注:** accepted to ICLR 2026
>
...
>
---
#### [replaced 055] MRD: Using Physically Based Differentiable Rendering to Probe Vision Models for 3D Scene Understanding
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2512.12307v4](https://arxiv.org/pdf/2512.12307v4)**

> **作者:** Benjamin Beilharz; Thomas S. A. Wallis
>
> **备注:** Note: v2/v3 had a false citation (citation key 16) which was fixed in v4 and was already correct in v1. 23 pages, 11 figures. Added appendix with more figure results. Code is available here: https://github.com/ag-perception-wallis-lab/MRD
>
...
>
---
#### [replaced 056] MEt3R: Measuring Multi-View Consistency in Generated Images
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2501.06336v2](https://arxiv.org/pdf/2501.06336v2)**

> **作者:** Mohammad Asim; Christopher Wewer; Thomas Wimmer; Bernt Schiele; Jan Eric Lenssen
>
> **备注:** Project website: https://geometric-rl.mpi-inf.mpg.de/met3r/ Updated to Camera-Ready version
>
> **摘要:** We introduce MEt3R, a metric for multi-view consistency in generated images. Large-scale generative models for multi-view image generation are rapidly advancing the field of 3D inference from sparse observations. However, due to the nature of generative modeling, traditional reconstruction metrics are not suitable to measure the quality of generated outputs and metrics that are independent of the sampling procedure are desperately needed. In this work, we specifically address the aspect of consistency between generated multi-view images, which can be evaluated independently of the specific scene. Our approach uses DUSt3R to obtain dense 3D reconstructions from image pairs in a feed-forward manner, which are used to warp image contents from one view into the other. Then, feature maps of these images are compared to obtain a similarity score that is invariant to view-dependent effects. Using MEt3R, we evaluate the consistency of a large set of previous methods for novel view and video generation, including our open, multi-view latent diffusion model.
>
---
#### [replaced 057] VidEoMT: Your ViT is Secretly Also a Video Segmentation Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.17807v2](https://arxiv.org/pdf/2602.17807v2)**

> **作者:** Narges Norouzi; Idil Esen Zulfikar; Niccolò Cavagnero; Tommie Kerssies; Bastian Leibe; Gijs Dubbelman; Daan de Geus
>
> **备注:** CVPR 2025. Code: https://www.tue-mps.org/videomt/
>
...
>
---
#### [replaced 063] SelfAI: A self-directed framework for long-horizon scientific discovery
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00403v2](https://arxiv.org/pdf/2512.00403v2)**
...
>
---
#### [replaced 064] RangeSAM: On the Potential of Visual Foundation Models for Range-View represented LiDAR segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.15886v4](https://arxiv.org/pdf/2509.15886v4)**

> **作者:** Paul Julius Kühn; Duc Anh Nguyen; Arjan Kuijper; Saptarshi Neil Sinha
>
...
>
---
#### [replaced 065] Follow-Your-Shape: Shape-Aware Image Editing via Trajectory-Guided Region Control
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.08134v4](https://arxiv.org/pdf/2508.08134v4)**

> **作者:** Zeqian Long; Mingzhe Zheng; Kunyu Feng; Xinhua Zhang; Hongyu Liu; Harry Yang; Linfeng Zhang; Qifeng Chen; Yue Ma
>
> **备注:** Accepted to ICLR 2026. Project webpage is available at https://follow-your-shape.github.io/
>
...
>
---
#### [replaced 066] SAGE: Scalable Agentic 3D Scene Generation for Embodied AI
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 073] JavisDiT: Joint Audio-Video Diffusion Transformer with Hierarchical Spatio-Temporal Prior Synchronization
...
>
---
#### [replaced 076] GOT-Edit: Geometry-Aware Generic Object Tracking via Online Model Editing
- **分类: cs.CV; cs.AI; cs.LG; cs.MM; eess.IV**

- **链接: [https://arxiv.org/pdf/2602.08550v2](https://arxiv.org/pdf/2602.08550v2)**
...
>
---
#### [replaced 077] Embed-RL: Reinforcement Learning for Reasoning-Driven Multimodal Embeddings
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.13823v2](https://arxiv.org/pdf/2602.13823v2)**
...
>
---
#### [replaced 078] PyraTok: Language-Aligned Pyramidal Tokenizer for Video Understanding and Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.16210v2](https://arxiv.org/pdf/2601.16210v2)**
...
>
---
#### [replaced 079] SABER: Spatially Consistent 3D Universal Adversarial Objects for BEV Detectors
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.22499v3](https://arxiv.org/pdf/2505.22499v3)**
...
>
---
#### [replaced 080] GRILL: Restoring Gradient Signal in Ill-Conditioned Layers for More Effective Adversarial Attacks on Autoencoders
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2505.03646v4](https://arxiv.org/pdf/2505.03646v4)**
...
>
---
#### [replaced 081] MoDES: Accelerating Mixture-of-Experts Multimodal Large Language Models via Dynamic Expert Skipping
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 082] SAGE: Spatial-visual Adaptive Graph Exploration for Efficient Visual Place Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.25723v3](https://arxiv.org/pdf/2509.25723v3)**
...
>
---
#### [replaced 084] Emotion-LLaMAv2 and MMEVerse: A New Framework and Benchmark for Multimodal Emotion Understanding
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.16449v2](https://arxiv.org/pdf/2601.16449v2)**
...
>
> **摘要:** Understanding human emotions from multimodal signals poses a significant challenge in affective computing and human-robot interaction. While multimodal large language models (MLLMs) have excelled in general vision-language tasks, their capabilities in emotional reasoning remain limited. The field currently suffers from a scarcity of large-scale datasets with high-quality, descriptive emotion annotations and lacks standardized benchmarks for evaluation. Our preliminary framework, Emotion-LLaMA, pioneered instruction-tuned multimodal learning for emotion reasoning but was restricted by explicit face detectors, implicit fusion strategies, and low-quality training data with limited scale. To address these limitations, we present Emotion-LLaMAv2 and the MMEVerse benchmark, establishing an end-to-end pipeline together with a standardized evaluation setting for emotion recognition and reasoning. Emotion-LLaMAv2 introduces three key advances. First, an end-to-end multiview encoder eliminates external face detection and captures nuanced emotional cues via richer spatial and temporal multiview tokens. Second, a Conv Attention pre-fusion module is designed to enable simultaneous local and global multimodal feature interactions external to the LLM backbone. Third, a perception-to-cognition curriculum instruction tuning scheme within the LLaMA2 backbone unifies emotion recognition and free-form emotion reasoning. To support large-scale training and reproducible evaluation, MMEVerse aggregates twelve publicly available emotion datasets, including IEMOCAP, MELD, DFEW, and MAFW, into a unified multimodal instruction format. The data are re-annotated via a multi-agent pipeline involving Qwen2 Audio, Qwen2.5 VL, and GPT 4o, producing 130k training clips and 36k testing clips across 18 evaluation benchmarks.
>
---
#### [replaced 085] Gradient-Aligned Calibration for Post-Training Quantization of Diffusion Models
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.01289v2](https://arxiv.org/pdf/2602.01289v2)**

> **作者:** Dung Anh Hoang; Cuong Pham anh Trung Le; Jianfei Cai; Thanh-Toan Do
>
...
>
---
#### [replaced 086] A Novel Public Dataset for Strawberry (Fragaria x ananassa) Ripeness Detection and Comparative Evaluation of YOLO-Based Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.15656v3](https://arxiv.org/pdf/2602.15656v3)**
...
>
---
#### [replaced 087] Latent Equivariant Operators for Robust Object Recognition: Promise and Challenges
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.18406v2](https://arxiv.org/pdf/2602.18406v2)**
...
>
---
#### [replaced 090] Tele-Omni: a Unified Multimodal Framework for Video Generation and Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.09609v2](https://arxiv.org/pdf/2602.09609v2)**

> **作者:** Jialun Liu; Tian Li; Xiao Cao; Yukuo Ma; Gonghu Shang; Haibin Huang; Chi Zhang; Xiangzhen Chang; Zhiyong Huang; Jiakui Hu; Zuoxin Li; Yuanzhi Liang; Cong Liu; Junqi Liu; Robby T. Tan; Haitong Tang; Qizhen Weng; Yifan Xu; Liying Yang; Xiaoyan Yang; Peng Yu; Shiwen Zhang; Xuelong Li
>
...
>
---
#### [replaced 091] BEAT: Visual Backdoor Attacks on VLM-based Embodied Agents via Contrastive Trigger Learning
...
>
---
#### [replaced 092] Learn by Reasoning: Analogical Weight Generation for Few-Shot Class-Incremental Learning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2503.21258v2](https://arxiv.org/pdf/2503.21258v2)**
...
>
> **备注:** Accepted by MLSys 2026. Project Page: http://streamdiffusionv2.github.io
>
...
>
---
#### [replaced 096] Hier-COS: Making Deep Features Hierarchy-aware via Composition of Orthogonal Subspaces
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2503.07853v2](https://arxiv.org/pdf/2503.07853v2)**
...
>
---
#### [replaced 099] Face Pyramid Vision Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2210.11974v2](https://arxiv.org/pdf/2210.11974v2)**

> **作者:** Khawar Islam; Muhammad Zaigham Zaheer; Arif Mahmood
>
> **备注:** Accepted in BMVC 2022
>
...
>
---
#### [replaced 100] MapReduce LoRA: Advancing the Pareto Front in Multi-Preference Optimization for Generative Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.20629v4](https://arxiv.org/pdf/2511.20629v4)**
...
>
---
#### [replaced 101] GraphThinker: Reinforcing Video Reasoning with Event Graph Thinking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.17555v2](https://arxiv.org/pdf/2602.17555v2)**

> **作者:** Zixu Cheng; Da Li; Jian Hu; Yuhang Zang; Ziquan Liu; Shaogang Gong; Wei Li
>
> **备注:** Under review
>
...
>
---
#### [replaced 102] FLUID: A Fine-Grained Lightweight Urban Signalized-Intersection Dataset of Dense Conflict Trajectories
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 103] DesignAsCode: Bridging Structural Editability and Visual Fidelity in Graphic Design Generation
- **分类: cs.GR; cs.AI; cs.CV; cs.LG; cs.MM**

- **链接: [https://arxiv.org/pdf/2602.17690v2](https://arxiv.org/pdf/2602.17690v2)**
...
>
---
#### [replaced 104] Query-Based Adaptive Aggregation for Multi-Dataset Joint Training Toward Universal Visual Place Recognition
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 114] KINESIS: Motion Imitation for Human Musculoskeletal Locomotion
...
>
---
#### [replaced 115] Mantis: A Versatile Vision-Language-Action Model with Disentangled Visual Foresight
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.16175v2](https://arxiv.org/pdf/2511.16175v2)**
