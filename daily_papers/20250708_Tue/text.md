...
- **简介: 该论文属于临床数据标准化任务，旨在解决HL7 FHIR格式转换的自动化问题。通过引入大语言模型，实现结构化临床数据到FHIR的高效准确映射。**
...
- **简介: 该论文属于AI心理咨询任务，评估日语环境下AI在咨询师、来访者和评估者角色的表现，旨在提升AI在非英语文化中的心理辅导能力。**
...
- **简介: 该论文属于医疗AI任务，旨在解决抑郁症治疗局限性问题，通过结合非洲天然药物与大语言模型，开发个性化心理健康支持系统。**
...
- **简介: 该论文属于多模态讽刺检测任务，解决资源受限环境下模型效率问题。提出AdS框架，通过适配器共享机制提升跨模态学习效率。**
...
- **链接: [http://arxiv.org/pdf/2507.03167v1](http://arxiv.org/pdf/2507.03167v1)**
...
- **简介: 该论文属于AI系统任务，解决LLM缺乏有效内存管理的问题，提出MemOS系统统一管理多种记忆资源，提升持续学习与个性化能力。**
...
>
---
#### [new 022] Context Tuning for In-Context Optimization
- **分类: cs.CL; cs.AI; cs.LG**
...
- **简介: 该论文属于医疗转录与笔记生成任务，旨在解决临床文档耗时、隐私担忧和计算成本高的问题。通过微调Llama 3.2模型实现本地化部署，提升准确性与隐私保护。**
...
- **简介: 该论文属于科学文档翻译任务，旨在解决翻译过程中布局信息丢失的问题。通过引入PDFMathTranslate，实现精准且高效的多语言科学文档翻译。**
...
- **简介: 该论文介绍BMMR数据集，用于多模态模型的跨学科推理任务，解决模型在多领域知识与推理能力评估问题，包含中英文数据及验证工具。**
...
- **简介: 该论文属于临床自然语言推理任务，研究提示结构与模型微调对临床NLI性能的影响，通过实验验证提示设计与LoRA方法的有效性。**
...
- **链接: [http://arxiv.org/pdf/2507.04708v1](http://arxiv.org/pdf/2507.04708v1)**
...
>
---
#### [new 047] ARF-RLHF: Adaptive Reward-Following for RLHF through Emotion-Driven Self-Supervision and Trace-Biased Dynamic Optimization
...
- **简介: 该论文属于结构分析任务，旨在解决LLM在工程应用中可靠性与鲁棒性不足的问题。通过将结构分析转化为代码生成任务，开发了一个LLM驱动的代理系统，显著提升了分析准确性。**
...
- **简介: 该论文属于金融推理任务，评估LLMs在CFA Level III考试中的表现，解决模型在金融领域应用的可靠性问题，通过多种提示策略测试23个模型。**
...
- **简介: 该论文属于大语言模型优化任务，旨在解决冗余计算问题。通过分析sink token特性，提出OrthoRank方法动态选择重要token，提升推理效率与性能。**
...
- **简介: 该论文属于语言模型领域适应任务，旨在提升模型在国防领域的表现。通过数据收集与模型微调，增强其专业能力，同时保持通用性能。**
...
- **简介: 该论文属于长对话中的用户偏好建模任务，旨在解决LLM个性化问题。通过结合BERT分类器与LSTM记忆模块，实现高效偏好过滤与记忆存储。**
...
- **简介: 该论文属于图数据修复任务，旨在解决属性图中的错误问题。通过评估六种大语言模型的修复效果，探索其在准确性与效率上的表现。**
...
- **链接: [http://arxiv.org/pdf/2507.03005v1](http://arxiv.org/pdf/2507.03005v1)**
...
>
---
#### [new 075] DP-Fusion: Token-Level Differentially Private Inference for Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于隐私保护任务，旨在解决大语言模型在推理时泄露敏感信息的问题。提出DP-Fusion机制，在保持文本实用性的同时，通过差分隐私技术隐藏敏感内容。**

- **链接: [http://arxiv.org/pdf/2507.04531v1](http://arxiv.org/pdf/2507.04531v1)**
...
>
---
#### [new 077] Backtesting Sentiment Signals for Trading: Evaluating the Viability of Alpha Generation from Sentiment Analysis
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于金融领域，旨在评估情感分析在交易中的应用。通过回测验证情感信号能否生成超额收益，结果表明情感模型优于传统策略。**

- **链接: [http://arxiv.org/pdf/2507.03350v1](http://arxiv.org/pdf/2507.03350v1)**

> **作者:** Elvys Linhares Pontes; Carlos-Emiliano González-Gallardo; Georgeta Bordea; José G. Moreno; Mohamed Ben Jannet; Yuxuan Zhao; Antoine Doucet
>
> **备注:** Actes de CORIA-TALN-RJCRI-RECITAL 2025 (Association pour le Traitement Automatique des Langues)
>
> **摘要:** Sentiment analysis, widely used in product reviews, also impacts financial markets by influencing asset prices through microblogs and news articles. Despite research in sentiment-driven finance, many studies focus on sentence-level classification, overlooking its practical application in trading. This study bridges that gap by evaluating sentiment-based trading strategies for generating positive alpha. We conduct a backtesting analysis using sentiment predictions from three models (two classification and one regression) applied to news articles on Dow Jones 30 stocks, comparing them to the benchmark Buy&Hold strategy. Results show all models produced positive returns, with the regression model achieving the highest return of 50.63% over 28 months, outperforming the benchmark Buy&Hold strategy. This highlights the potential of sentiment in enhancing investment strategies and financial decision-making.
>
---
#### [new 078] From Fragments to Facts: A Curriculum-Driven DPO Approach for Generating Hindi News Veracity Explanations
- **分类: cs.CL**

- **简介: 该论文属于新闻真实性解释生成任务，旨在解决 Hindi 语言中虚假信息检测工具不足的问题。通过结合 DPO 和课程学习，提升模型生成解释的准确性和一致性。**

- **链接: [http://arxiv.org/pdf/2507.05179v1](http://arxiv.org/pdf/2507.05179v1)**
...
>
---
#### [new 083] EMERGE: A Benchmark for Updating Knowledge Graphs with Emerging Textual Knowledge
- **分类: cs.CL**

- **简介: 该论文属于知识图谱更新任务，旨在解决从文本中自动更新知识图谱的问题。工作包括构建包含1.25M KG编辑的基准数据集EMERGE。**

- **链接: [http://arxiv.org/pdf/2507.03617v1](http://arxiv.org/pdf/2507.03617v1)**

> **作者:** Klim Zaporojets; Daniel Daza; Edoardo Barba; Ira Assent; Roberto Navigli; Paul Groth
>
...
>
---
#### [new 084] We Need Knowledge Distillation for Solving Math Word Problems
- **分类: cs.CL**

- **简介: 该论文属于数学问题求解任务，旨在降低大语言模型的计算成本。通过知识蒸馏压缩模型，保持高精度且参数减少12倍，提升教育系统的效率。**

- **链接: [http://arxiv.org/pdf/2507.02982v1](http://arxiv.org/pdf/2507.02982v1)**
...
>
---
#### [new 085] InfoSteer: Steering Information Utility in Language Model Post-Training
- **分类: cs.CL**

- **简介: 该论文属于语言模型后训练任务，旨在提升模型对预训练知识的利用效率。提出一种轻量方法，通过干预FFN层增强信息使用效果。**

- **链接: [http://arxiv.org/pdf/2507.05158v1](http://arxiv.org/pdf/2507.05158v1)**

> **作者:** Chunyuan Deng; Ruidi Chang; Hanjie Chen
>
> **摘要:** Recent advancements in language models (LMs) gradually ushered in an era where post-training is crucial. Yet, post-training approaches such as supervised fine-tuning (SFT) do not guarantee effective use of knowledge acquired during pretraining. We therefore present \ours, a lightweight method that encourages parametric information utilization in LMs during post-training. This is achieved via treating FFN layer as associate key-value memory, and promotes the use of stored memory vectors via forward-pass interventions or regularization during backpropagation. We find this simple guidance during post-training phase delivers consistent performance improvements across diverse model families--including Qwen, Gemma and Llama-spanning over 15 downstream tasks in both ID and OOD evaluations. Beyond performance gains, we also find that steered LMs can adaptively allocate information-placing more emphasis on generating semantically meaningful tokens, while using fewer resources on simple transition ones (e.g., `,' or `and'). Our work underscores that vanilla post-training does not fully leverage pre-training potential, and steering LMs in latent representation space offers a promising approach that enhances both performance and interpretability.
>
---
#### [new 086] Making Sense of Korean Sentences: A Comprehensive Evaluation of LLMs through KoSEnd Dataset
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决低资源语言中句子结尾理解的问题。通过构建KoSEnd数据集，评估LLMs对韩语句尾的掌握情况。**

- **链接: [http://arxiv.org/pdf/2507.03378v1](http://arxiv.org/pdf/2507.03378v1)**

> **作者:** Seunguk Yu; Kyeonghyun Kim; Jungmin Yun; Youngbin Kim
>
> **备注:** ACL 2025 student research workshop
>
> **摘要:** Although LLMs have made significant progress in various languages, there are still concerns about their effectiveness with low-resource agglutinative languages compared to languages such as English. In this study, we focused on Korean, a language known for its complex sentence endings, and evaluated LLMs on this challenging aspect. We introduce the Korean Sentence Endings (KoSEnd) dataset, which includes 3,000 sentences, each annotated for the naturalness of 15 sentence ending forms. These were collected from diverse sources to cover a range of contexts. We evaluated 11 LLMs to assess their understanding of Korean sentence endings, analyzing them based on parameter count and prediction consistency. Notably, we found that informing models about the possibility of missing sentence endings improved performance, highlighting the impact of explicitly considering certain linguistic features.
>
---
#### [new 087] Can LLMs Play Ô Ăn Quan Game? A Study of Multi-Step Planning and Decision Making
- **分类: cs.CL**

- **简介: 该论文属于策略决策任务，研究LLMs在Ô Ăn Quan游戏中多步规划与决策能力，通过不同策略测试模型表现，分析其推理与战略优劣。**

- **链接: [http://arxiv.org/pdf/2507.03711v1](http://arxiv.org/pdf/2507.03711v1)**
...
>
---
#### [new 088] Truth, Trust, and Trouble: Medical AI on the Edge
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗问答任务，旨在解决医疗AI模型在准确性、安全性和实用性上的挑战。通过基准测试评估多个模型表现，分析其优缺点。**

- **链接: [http://arxiv.org/pdf/2507.02983v1](http://arxiv.org/pdf/2507.02983v1)**
...
>
---
#### [new 089] No Language Data Left Behind: A Comparative Study of CJK Language Datasets in the Hugging Face Ecosystem
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理领域，旨在解决CJK语言数据集在Hugging Face生态中的分布不均问题。通过分析3300多个数据集，探讨不同文化背景下的数据创建模式。**

- **链接: [http://arxiv.org/pdf/2507.04329v1](http://arxiv.org/pdf/2507.04329v1)**
...
>
---
#### [new 090] A Comparative Study of Competency Question Elicitation Methods from Ontology Requirements
- **分类: cs.CL**

- **简介: 该论文属于知识工程任务，旨在比较不同CQ生成方法的效果。通过实证分析三种方法生成的CQ质量，提出多标注数据集并评估其特性。**

- **链接: [http://arxiv.org/pdf/2507.02989v1](http://arxiv.org/pdf/2507.02989v1)**
...
>
---
#### [new 091] Dialogue-Based Multi-Dimensional Relationship Extraction from Novels
- **分类: cs.CL**

- **简介: 该论文属于关系抽取任务，旨在解决小说中复杂语境下人物关系提取难题。通过结合对话数据和上下文学习，提升模型对隐含关系的理解能力，并构建了中文小说关系数据集。**

- **链接: [http://arxiv.org/pdf/2507.04852v1](http://arxiv.org/pdf/2507.04852v1)**
...
>
---
#### [new 093] A Tale of Two Scripts: Transliteration and Post-Correction for Judeo-Arabic
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决 Judeo-Arabic 转写难题。通过两步方法实现准确转写，并验证其对 NLP 工具的适用性。**

- **链接: [http://arxiv.org/pdf/2507.04746v1](http://arxiv.org/pdf/2507.04746v1)**

> **作者:** Juan Moreno Gonzalez; Bashar Alhafni; Nizar Habash
>
...
>
---
#### [new 094] SIGIR 2025 -- LiveRAG Challenge Report
- **分类: cs.CL; cs.IR; H.3.3**

- **简介: 该论文报告了SIGIR 2025的LiveRAG挑战赛，旨在推动检索增强生成技术的发展，通过统一数据集和模型进行问答系统竞赛，评估不同检索与提示策略的效果。**

- **链接: [http://arxiv.org/pdf/2507.04942v1](http://arxiv.org/pdf/2507.04942v1)**

> **作者:** David Carmel; Simone Filice; Guy Horowitz; Yoelle Maarek; Oren Somekh; Ran Tavory
>
> **备注:** 9 pages, 5 tables
>
...
>
---
#### [new 099] Does Learning Mathematical Problem-Solving Generalize to Broader Reasoning?
- **分类: cs.CL**

- **简介: 该论文属于数学问题解决与推理能力研究，探讨MPS训练对通用推理的泛化效果。通过实验比较不同训练方法，发现长推理链和自省机制更有效。**

- **链接: [http://arxiv.org/pdf/2507.04391v1](http://arxiv.org/pdf/2507.04391v1)**
...
>
---
#### [new 104] Response Attack: Exploiting Contextual Priming to Jailbreak Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于模型安全任务，旨在解决LLM被劫持生成有害内容的问题。通过上下文引导攻击，提升攻击成功率，并提出防御数据集。**

- **链接: [http://arxiv.org/pdf/2507.05248v1](http://arxiv.org/pdf/2507.05248v1)**

> **作者:** Ziqi Miao; Lijun Li; Yuan Xiong; Zhenhua Liu; Pengyu Zhu; Jing Shao
>
> **备注:** 21 pages, 9 figures. Code and data available at https://github.com/Dtc7w3PQ/Response-Attack
>
...
>
> **摘要:** Access to consumer grievance redressal in India is often hindered by procedural complexity, legal jargon, and jurisdictional challenges. To address this, we present $\textbf{Grahak-Nyay}$ (Justice-to-Consumers), a chatbot that streamlines the process using open-source Large Language Models (LLMs) and Retrieval-Augmented Generation (RAG). Grahak-Nyay simplifies legal complexities through a concise and up-to-date knowledge base. We introduce three novel datasets: $\textit{GeneralQA}$ (general consumer law), $\textit{SectoralQA}$ (sector-specific knowledge) and $\textit{SyntheticQA}$ (for RAG evaluation), along with $\textit{NyayChat}$, a dataset of 300 annotated chatbot conversations. We also introduce $\textit{Judgments}$ data sourced from Indian Consumer Courts to aid the chatbot in decision making and to enhance user trust. We also propose $\textbf{HAB}$ metrics ($\textbf{Helpfulness, Accuracy, Brevity}$) to evaluate chatbot performance. Legal domain experts validated Grahak-Nyay's effectiveness. Code and datasets will be released.
>
---
#### [new 112] Building Open-Retrieval Conversational Question Answering Systems by Generating Synthetic Data and Decontextualizing User Questions
- **分类: cs.CL**

- **简介: 该论文研究开放检索对话问答任务，解决领域专用数据稀缺问题，通过生成合成数据和去上下文化用户问题，构建训练数据并提升问答系统性能。**

- **链接: [http://arxiv.org/pdf/2507.04884v1](http://arxiv.org/pdf/2507.04884v1)**

> **作者:** Christos Vlachos; Nikolaos Stylianou; Alexandra Fiotaki; Spiros Methenitis; Elisavet Palogiannidi; Themos Stafylakis; Ion Androutsopoulos
>
...
>
---
#### [new 113] ArtifactsBench: Bridging the Visual-Interactive Gap in LLM Code Generation Evaluation
- **分类: cs.CL; cs.SE**

- **简介: 该论文属于代码生成评估任务，解决传统基准无法评价视觉和交互质量的问题。提出ArtifactsBench，通过多模态评估生成代码的视觉效果和交互性。**

- **链接: [http://arxiv.org/pdf/2507.04952v1](http://arxiv.org/pdf/2507.04952v1)**
...
>
---
#### [new 124] Co-DETECT: Collaborative Discovery of Edge Cases in Text Classification
- **分类: cs.CL**

- **简介: 该论文属于文本分类任务，旨在解决边缘案例识别问题。通过结合人类专家与大语言模型，提出Co-DETECT框架，有效发现并处理边缘案例。**

- **链接: [http://arxiv.org/pdf/2507.05010v1](http://arxiv.org/pdf/2507.05010v1)**
...
>
---
#### [new 126] PRIME: Large Language Model Personalization with Cognitive Memory and Thought Processes
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型个性化任务，旨在解决如何有效对齐模型输出与用户偏好。工作包括引入PRIME框架，结合记忆机制和思考策略提升个性化效果。**

- **链接: [http://arxiv.org/pdf/2507.04607v1](http://arxiv.org/pdf/2507.04607v1)**
...
>
---
#### [new 127] A Unified Speech LLM for Diarization and Speech Recognition in Multilingual Conversations
- **分类: cs.CL; cs.AI; cs.SD; eess.AS**
...
>
---
#### [new 128] From Individuals to Interactions: Benchmarking Gender Bias in Multimodal Large Language Models from the Lens of Social Relationship
- **分类: cs.CL; cs.AI; cs.CY**
...
>
---
#### [new 129] Knowledge-Aware Self-Correction in Language Models via Structured Memory Graphs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识增强任务，旨在解决LLM生成事实错误的问题。通过结构化记忆图进行自我修正，无需重新训练即可纠正输出中的不一致之处。**

- **链接: [http://arxiv.org/pdf/2507.04625v1](http://arxiv.org/pdf/2507.04625v1)**

> **作者:** Swayamjit Saha
>
> **备注:** 8 pages, 4 figures
>
> **摘要:** Large Language Models (LLMs) are powerful yet prone to generating factual errors, commonly referred to as hallucinations. We present a lightweight, interpretable framework for knowledge-aware self-correction of LLM outputs using structured memory graphs based on RDF triples. Without retraining or fine-tuning, our method post-processes model outputs and corrects factual inconsistencies via external semantic memory. We demonstrate the approach using DistilGPT-2 and show promising results on simple factual prompts.
>
---
#### [new 130] BYOKG-RAG: Multi-Strategy Graph Retrieval for Knowledge Graph Question Answering
- **分类: cs.CL**

- **简介: 该论文属于知识图谱问答任务，解决定制知识图谱下问答的挑战。通过结合大语言模型与图检索工具，提升问答准确性和泛化能力。**

- **链接: [http://arxiv.org/pdf/2507.04127v1](http://arxiv.org/pdf/2507.04127v1)**
...
>
---
#### [new 134] Losing our Tail -- Again: On (Un)Natural Selection And Multilingual Large Language Models
- **分类: cs.CL**

- **简介: 论文探讨多语言大模型对语言多样性的负面影响，属于自然语言处理领域。它分析模型崩溃现象，呼吁保护语言多样性与文化特色。**

- **链接: [http://arxiv.org/pdf/2507.03933v1](http://arxiv.org/pdf/2507.03933v1)**
...
>
---
#### [new 135] CoSteer: Collaborative Decoding-Time Personalization via Local Delta Steering
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于个性化文本生成任务，解决设备端与云端模型协同优化问题。通过本地差异引导云端模型生成个性化内容，保障隐私且无需微调。**

- **链接: [http://arxiv.org/pdf/2507.04756v1](http://arxiv.org/pdf/2507.04756v1)**
...
>
---
#### [new 136] Theory of Mind in Action: The Instruction Inference Task
- **分类: cs.CL; cs.AI; cs.MA**

- **简介: 该论文提出Instruction Inference任务，旨在评估AI在协作环境中理解模糊指令的理论心智能力。通过构建Tomcat模型，探索其与人类相当的ToM表现。**

- **链接: [http://arxiv.org/pdf/2507.02935v1](http://arxiv.org/pdf/2507.02935v1)**
...
>
---
#### [new 139] SMART: Simulated Students Aligned with Item Response Theory for Question Difficulty Prediction
- **分类: cs.CL; cs.CY; cs.LG**
...
>
---
#### [new 142] Identification of Potentially Misclassified Crash Narratives using Machine Learning (ML) and Deep Learning (DL)
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本分类任务，旨在解决交通事故数据误标问题。通过ML和DL方法检测误分类的事故叙述，提升数据准确性。**

- **链接: [http://arxiv.org/pdf/2507.03066v1](http://arxiv.org/pdf/2507.03066v1)**

> **作者:** Sudesh Bhagat; Ibne Farabi Shihab; Jonathan Wood
>
...
>
---
#### [new 148] VLM2Vec-V2: Advancing Multimodal Embedding for Videos, Images, and Visual Documents
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 149] Disambiguation-Centric Finetuning Makes Enterprise Tool-Calling LLMs More Realistic and Less Risky
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理中的工具调用任务，旨在解决LLM在企业API调用中因歧义或参数不足导致的失败问题。通过DiaFORGE框架提升模型准确性与可靠性。**

- **链接: [http://arxiv.org/pdf/2507.03336v1](http://arxiv.org/pdf/2507.03336v1)**
...
>
---
#### [new 150] A Weakly Supervised Transformer to Support Rare Disease Diagnosis from Electronic Health Records: Methods and Applications in Rare Pulmonary Disease
- **分类: cs.LG; cs.CL; stat.ML**

- **简介: 该论文属于罕见病诊断任务，旨在解决标注数据稀缺和噪声问题。通过弱监督的Transformer框架，结合少量金标准标签与大量EHR生成的银标准标签，提升罕见肺病的检测与分型效果。**

- **链接: [http://arxiv.org/pdf/2507.02998v1](http://arxiv.org/pdf/2507.02998v1)**
...
>
---
#### [new 152] Efficient Detection of Intermittent Job Failures Using Few-Shot Learning
- **分类: cs.SE; cs.CL; cs.LG**

- **简介: 该论文属于软件工程中的异常检测任务，旨在解决间歇性作业失败的准确识别问题。通过少量标注数据微调语言模型生成嵌入，训练分类器以提高检测效果。**

- **链接: [http://arxiv.org/pdf/2507.04173v1](http://arxiv.org/pdf/2507.04173v1)**

> **作者:** Henri Aïdasso; Francis Bordeleau; Ali Tizghadam
>
> **备注:** Accepted at the 41st International Conference on Software Maintenance and Evolution - ICSME 2025, Industry Track
>
...
>
---
#### [new 153] Multi-Modal Semantic Parsing for the Interpretation of Tombstone Inscriptions
...
>
---
#### [new 154] Navigating Speech Recording Collections with AI-Generated Illustrations
...
>
---
#### [new 155] Transcribing Spanish Texts from the Past: Experiments with Transkribus, Tesseract and Granite
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 156] Taming the Tri-Space Tension: ARC-Guided Hallucination Modeling and Control for Text-to-Image Generation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 160] ReLoop: "Seeing Twice and Thinking Backwards" via Closed-loop Training to Mitigate Hallucinations in Multimodal understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 161] Evaluating LLMs on Real-World Forecasting Against Human Superforecasters
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于预测任务，旨在评估LLMs在现实世界预测中的表现。研究比较了LLMs与人类超级预测者的准确性，发现LLMs仍不及超级预测者。**

- **链接: [http://arxiv.org/pdf/2507.04562v1](http://arxiv.org/pdf/2507.04562v1)**
...
>
---
#### [new 162] SciMaster: Towards General-Purpose Scientific AI Agents, Part I. X-Master as Foundation: Can We Lead on Humanity's Last Exam?
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于科学AI代理任务，旨在提升AI在复杂科学问题上的表现。通过构建X-Master系统，实现对HLE的领先成绩，推动通用科学AI的发展。**

- **链接: [http://arxiv.org/pdf/2507.05241v1](http://arxiv.org/pdf/2507.05241v1)**

> **作者:** Jingyi Chai; Shuo Tang; Rui Ye; Yuwen Du; Xinyu Zhu; Mengcheng Zhou; Yanfeng Wang; Weinan E; Siheng Chen
>
...
>
---
#### [new 165] An HTR-LLM Workflow for High-Accuracy Transcription and Analysis of Abbreviated Latin Court Hand
...
>
---
#### [new 166] Large Language Model Agent for Modular Task Execution in Drug Discovery
- **分类: cs.LG; cs.CL; q-bio.BM**

- **简介: 该论文属于药物发现任务，旨在解决早期计算药物发现中的自动化问题。通过结合大语言模型与领域工具，实现分子生成、性质预测与结构评估等模块化工作。**

- **链接: [http://arxiv.org/pdf/2507.02925v1](http://arxiv.org/pdf/2507.02925v1)**
...
>
---
#### [new 167] MedGellan: LLM-Generated Medical Guidance to Support Physicians
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于医疗诊断辅助任务，旨在提升医生诊断准确性。通过MedGellan框架，利用LLM生成临床指导，改善诊断性能。**

- **链接: [http://arxiv.org/pdf/2507.04431v1](http://arxiv.org/pdf/2507.04431v1)**
...
>
---
#### [new 168] Intrinsic Fingerprint of LLMs: Continue Training is NOT All You Need to Steal A Model!
- **分类: cs.CR; cs.CL; cs.LG**

- **简介: 该论文属于模型指纹识别任务，旨在解决LLM版权保护问题。通过分析注意力参数分布特征，提出一种鲁棒的模型指纹方法，可检测模型抄袭与侵权。**

- **链接: [http://arxiv.org/pdf/2507.03014v1](http://arxiv.org/pdf/2507.03014v1)**
...
>
---
#### [new 170] RECA-PD: A Robust Explainable Cross-Attention Method for Speech-based Parkinson's Disease Classification
...
>
---
#### [new 171] GameTileNet: A Semantic Dataset for Low-Resolution Game Art in Procedural Content Generation
...
>
---
#### [new 172] Federated Learning for ICD Classification with Lightweight Models and Pretrained Embeddings
- **分类: cs.IR; cs.CL; cs.LG**

- **简介: 该论文属于医疗文本分类任务，旨在通过联邦学习实现ICD编码，解决隐私和部署效率问题。工作包括设计轻量级模型与预训练嵌入结合的管道，并验证其性能。**

- **链接: [http://arxiv.org/pdf/2507.03122v1](http://arxiv.org/pdf/2507.03122v1)**
...
>
---
#### [new 179] DOTResize: Reducing LLM Width via Discrete Optimal Transport-based Neuron Merging
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于模型压缩任务，旨在减少大语言模型的宽度。通过离散最优传输方法合并冗余神经元，实现高效压缩与性能保持。**

- **链接: [http://arxiv.org/pdf/2507.04517v1](http://arxiv.org/pdf/2507.04517v1)**
...
>
---
#### [new 180] Gated Recursive Fusion: A Stateful Approach to Scalable Multimodal Transformers
...
>
---
#### [new 187] Critiques of World Models
...
>
---
#### [new 188] Attention Slipping: A Mechanistic Understanding of Jailbreak Attacks and Defenses in LLMs
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于AI安全任务，解决LLM jailbreak攻击问题。通过分析Attention Slipping现象，提出防御方法Attention Sharpening，有效抵御攻击并保持模型性能。**

- **链接: [http://arxiv.org/pdf/2507.04365v1](http://arxiv.org/pdf/2507.04365v1)**
...
>
---
#### [new 189] ABench-Physics: Benchmarking Physical Reasoning in LLMs via High-Difficulty and Dynamic Physics Problems
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于物理推理任务，旨在解决LLMs在物理领域能力不足的问题。通过构建ABench-Physics基准，评估模型的物理建模与泛化能力。**

- **链接: [http://arxiv.org/pdf/2507.04766v1](http://arxiv.org/pdf/2507.04766v1)**
...
>
---
#### [new 194] MedGemma Technical Report
...
>
---
#### [new 195] SmartThinker: Learning to Compress and Preserve Reasoning by Step-Level Length Control
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于模型压缩任务，旨在解决大推理模型冗余和低效问题。通过分步长度控制策略，提升推理效率与准确性。**

- **链接: [http://arxiv.org/pdf/2507.04348v1](http://arxiv.org/pdf/2507.04348v1)**
...
>
---
#### [new 196] DeepGesture: A conversational gesture synthesis system based on emotions and semantics
...
>
---
#### [new 200] Causal-SAM-LLM: Large Language Models as Causal Reasoners for Robust Medical Segmentation
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 205] MateInfoUB: A Real-World Benchmark for Testing LLMs in Competitive, Multilingual, and Multimodal Educational Tasks
- **分类: cs.CY; cs.AI; cs.CL**

- **简介: 该论文提出MateInfoUB数据集，用于评估LLMs在多语言、多模态和竞赛型计算机科学教育任务中的表现，解决模型在不同语言和任务类型下的适用性问题。**

- **链接: [http://arxiv.org/pdf/2507.03162v1](http://arxiv.org/pdf/2507.03162v1)**
...
#### [replaced 001] Bi-directional Context-Enhanced Speech Large Language Models for Multilingual Conversational ASR
- **分类: cs.CL; eess.AS**

- **链接: [http://arxiv.org/pdf/2506.13396v2](http://arxiv.org/pdf/2506.13396v2)**
...
>
---
#### [replaced 006] Extended Inductive Reasoning for Personalized Preference Inference from Behavioral Signals
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.18071v2](http://arxiv.org/pdf/2505.18071v2)**
...
>
---
#### [replaced 007] FinBERT2: A Specialized Bidirectional Encoder for Bridging the Gap in Finance-Specific Deployment of Large Language Models
- **分类: cs.IR; cs.AI; cs.CE; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.06335v2](http://arxiv.org/pdf/2506.06335v2)**
...
>
---
#### [replaced 013] BiMa: Towards Biases Mitigation for Text-Video Retrieval via Scene Element Guidance
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 019] Should We Still Pretrain Encoders with Masked Language Modeling?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.00994v2](http://arxiv.org/pdf/2507.00994v2)**
...
>
---
#### [replaced 020] Neural Discrete Token Representation Learning for Extreme Token Reduction in Video Large Language Models
...
>
---
#### [replaced 029] Language Models can Self-Improve at State-Value Estimation for Better Search
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.02878v2](http://arxiv.org/pdf/2503.02878v2)**
...
>
---
#### [replaced 030] UNITYAI-GUARD: Pioneering Toxicity Detection Across Low-Resource Indian Languages
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.23088v2](http://arxiv.org/pdf/2503.23088v2)**

> **作者:** Himanshu Beniwal; Reddybathuni Venkat; Rohit Kumar; Birudugadda Srivibhav; Daksh Jain; Pavan Doddi; Eshwar Dhande; Adithya Ananth; Kuldeep; Mayank Singh
>
> **摘要:** This work introduces UnityAI-Guard, a framework for binary toxicity classification targeting low-resource Indian languages. While existing systems predominantly cater to high-resource languages, UnityAI-Guard addresses this critical gap by developing state-of-the-art models for identifying toxic content across diverse Brahmic/Indic scripts. Our approach achieves an impressive average F1-score of 84.23% across seven languages, leveraging a dataset of 567k training instances and 30k manually verified test instances. By advancing multilingual content moderation for linguistically diverse regions, UnityAI-Guard also provides public API access to foster broader adoption and application.
>
---
#### [replaced 031] Enhancing Personalized Multi-Turn Dialogue with Curiosity Reward
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.03206v2](http://arxiv.org/pdf/2504.03206v2)**
...
>
---
#### [replaced 032] iNews: A Multimodal Dataset for Modeling Personalized Affective Responses to News
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 035] Thunder-DeID: Accurate and Efficient De-identification Framework for Korean Court Judgments
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.15266v2](http://arxiv.org/pdf/2506.15266v2)**
...
>
---
#### [replaced 036] Self-Consistency Preference Optimization
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.04109v3](http://arxiv.org/pdf/2411.04109v3)**
...
>
> **摘要:** Self-alignment, whereby models learn to improve themselves without human annotation, is a rapidly growing research area. However, existing techniques often fail to improve complex reasoning tasks due to the difficulty of assigning correct rewards. An orthogonal approach that is known to improve correctness is self-consistency, a method applied at inference time based on multiple sampling in order to find the most consistent answer. In this work, we extend the self-consistency concept to help train models. We thus introduce self-consistency preference optimization (ScPO), which iteratively trains consistent answers to be preferred over inconsistent ones on unsupervised new problems. We show ScPO leads to large improvements over conventional reward model training on reasoning tasks such as GSM8K and MATH, closing the gap with supervised training with gold answers or preferences, and that combining ScPO with standard supervised learning improves results even further. On ZebraLogic, ScPO finetunes Llama-3 8B to be superior to Llama-3 70B, Gemma-2 27B, and Claude-3 Haiku.
>
---
#### [replaced 037] Perception, Reason, Think, and Plan: A Survey on Large Multimodal Reasoning Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 038] Play to Generalize: Learning to Reason Through Game Play
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 039] Judging the Judges: Can Large Vision-Language Models Fairly Evaluate Chart Comprehension and Reasoning?
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 045] CritiQ: Mining Data Quality Criteria from Human Preferences
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.19279v2](http://arxiv.org/pdf/2502.19279v2)**
...
>
---
#### [replaced 046] MoralBench: Moral Evaluation of LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2406.04428v2](http://arxiv.org/pdf/2406.04428v2)**
...
>
---
#### [replaced 054] Evaluating AI capabilities in detecting conspiracy theories on YouTube
...
>
---
#### [replaced 055] Text Detoxification: Data Efficiency, Semantic Preservation and Model Generalization
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.01050v2](http://arxiv.org/pdf/2507.01050v2)**
...
>
---
#### [replaced 056] Towards Understanding the Cognitive Habits of Large Reasoning Models
- **分类: cs.CL; cs.AI; cs.CR**

- **链接: [http://arxiv.org/pdf/2506.21571v2](http://arxiv.org/pdf/2506.21571v2)**
...
>
---
#### [replaced 059] Comparative Evaluation of ChatGPT and DeepSeek Across Key NLP Tasks: Strengths, Weaknesses, and Domain-Specific Performance
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.18501v3](http://arxiv.org/pdf/2506.18501v3)**
...
>
---
#### [replaced 060] Constrain Alignment with Sparse Autoencoders
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2411.07618v3](http://arxiv.org/pdf/2411.07618v3)**
...
>
---
#### [replaced 061] Towards Universal Semantics With Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.11764v3](http://arxiv.org/pdf/2505.11764v3)**
...
>
---
#### [replaced 062] On Fusing ChatGPT and Ensemble Learning in Discon-tinuous Named Entity Recognition in Health Corpora
- **分类: cs.CL; cs.AI; I.2.7; J.3**

- **链接: [http://arxiv.org/pdf/2412.16976v2](http://arxiv.org/pdf/2412.16976v2)**

> **作者:** Tzu-Chieh Chen; Wen-Yang Lin
>
> **备注:** 13 pages; a short version has been accpeted for presentation at MedInfo2025
>
...
>
---
#### [replaced 063] On the Role of Feedback in Test-Time Scaling of Agentic AI Workflows
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.01931v3](http://arxiv.org/pdf/2504.01931v3)**
...
>
---
#### [replaced 064] Parsing Through Boundaries in Chinese Word Segmentation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.23091v2](http://arxiv.org/pdf/2503.23091v2)**

> **作者:** Yige Chen; Zelong Li; Cindy Zhang; Changbing Yang; Amandisa Cady; Ai Ka Lee; Zejiao Zeng; Eunkyul Leah Jo; Haihua Pan; Jungyeul Park
>
> **备注:** Submitted to EMNLP2025 System Demonstration
>
> **摘要:** Chinese word segmentation is a foundational task in natural language processing (NLP), with far-reaching effects on syntactic analysis. Unlike alphabetic languages like English, Chinese lacks explicit word boundaries, making segmentation both necessary and inherently ambiguous. This study highlights the intricate relationship between word segmentation and syntactic parsing, providing a clearer understanding of how different segmentation strategies shape dependency structures in Chinese. Focusing on the Chinese GSD treebank, we analyze multiple word boundary schemes, each reflecting distinct linguistic and computational assumptions, and examine how they influence the resulting syntactic structures. To support detailed comparison, we introduce an interactive web-based visualization tool that displays parsing outcomes across segmentation methods.
>
---
#### [replaced 065] A Causal World Model Underlying Next Token Prediction: Exploring GPT in a Controlled Environment
- **分类: cs.AI; cs.CL; cs.LG; stat.ML**

- **链接: [http://arxiv.org/pdf/2412.07446v4](http://arxiv.org/pdf/2412.07446v4)**
...
>
---
#### [replaced 068] End-to-End Evaluation for Low-Latency Simultaneous Speech Translation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2308.03415v4](http://arxiv.org/pdf/2308.03415v4)**

> **作者:** Christian Huber; Tu Anh Dinh; Carlos Mullov; Ngoc Quan Pham; Thai Binh Nguyen; Fabian Retkowski; Stefan Constantin; Enes Yavuz Ugan; Danni Liu; Zhaolin Li; Sai Koneru; Jan Niehues; Alexander Waibel
>
> **备注:** Demo paper at EMNLP 2023
>
> **摘要:** The challenge of low-latency speech translation has recently draw significant interest in the research community as shown by several publications and shared tasks. Therefore, it is essential to evaluate these different approaches in realistic scenarios. However, currently only specific aspects of the systems are evaluated and often it is not possible to compare different approaches. In this work, we propose the first framework to perform and evaluate the various aspects of low-latency speech translation under realistic conditions. The evaluation is carried out in an end-to-end fashion. This includes the segmentation of the audio as well as the run-time of the different components. Secondly, we compare different approaches to low-latency speech translation using this framework. We evaluate models with the option to revise the output as well as methods with fixed output. Furthermore, we directly compare state-of-the-art cascaded as well as end-to-end systems. Finally, the framework allows to automatically evaluate the translation quality as well as latency and also provides a web interface to show the low-latency model outputs to the user.
>
---
#### [replaced 069] Generalization or Hallucination? Understanding Out-of-Context Reasoning in Transformers
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.10887v2](http://arxiv.org/pdf/2506.10887v2)**
...
>
---
#### [replaced 070] On the Expressiveness and Length Generalization of Selective State-Space Models on Regular Languages
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2412.19350v2](http://arxiv.org/pdf/2412.19350v2)**
...
>
---
#### [replaced 072] NTU Speechlab LLM-Based Multilingual ASR System for Interspeech MLC-SLM Challenge 2025
- **分类: cs.CL; eess.AS**

- **链接: [http://arxiv.org/pdf/2506.13339v2](http://arxiv.org/pdf/2506.13339v2)**

> **作者:** Yizhou Peng; Bin Wang; Yi-Wen Chao; Ziyang Ma; Haoyang Zhang; Hexin Liu; Xie Chen; Eng Siong Chng
>
> **备注:** Accepted by Interspeech 2025 MLC-SLM challenge (5th place). System report
>
...
>
---
#### [replaced 077] EAQuant: Enhancing Post-Training Quantization for MoE Models via Expert-Aware Optimization
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.13329v2](http://arxiv.org/pdf/2506.13329v2)**
...
>
---
#### [replaced 078] NativQA Framework: Enabling LLMs with Native, Local, and Everyday Knowledge
- **分类: cs.CL; cs.AI; 68T50; F.2.2; I.2.7**

- **链接: [http://arxiv.org/pdf/2504.05995v2](http://arxiv.org/pdf/2504.05995v2)**
...
>
> **摘要:** The rapid advancement of large language models (LLMs) has raised concerns about cultural bias, fairness, and their applicability in diverse linguistic and underrepresented regional contexts. To enhance and benchmark the capabilities of LLMs, there is a need to develop large-scale resources focused on multilingual, local, and cultural contexts. In this study, we propose the NativQA framework, which can seamlessly construct large-scale, culturally and regionally aligned QA datasets in native languages. The framework utilizes user-defined seed queries and leverages search engines to collect location-specific, everyday information. It has been evaluated across 39 locations in 24 countries and in 7 languages -- ranging from extremely low-resource to high-resource languages -- resulting in over 300K Question-Answer (QA) pairs. The developed resources can be used for LLM benchmarking and further fine-tuning. The framework has been made publicly available for the community (https://gitlab.com/nativqa/nativqa-framework).
>
---
#### [replaced 079] Position: Machine Learning Conferences Should Establish a "Refutations and Critiques" Track
...
>
---
#### [replaced 080] Hunyuan-TurboS: Advancing Large Language Models through Mamba-Transformer Synergy and Adaptive Chain-of-Thought
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.15431v3](http://arxiv.org/pdf/2505.15431v3)**
...
>
---
#### [replaced 081] From Intentions to Techniques: A Comprehensive Taxonomy and Challenges in Text Watermarking for Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2406.11106v2](http://arxiv.org/pdf/2406.11106v2)**

> **作者:** Harsh Nishant Lalai; Aashish Anantha Ramakrishnan; Raj Sanjay Shah; Dongwon Lee
>
> **备注:** NAACL Findings 2025
>
...
>
---
#### [replaced 082] VOCABTRIM: Vocabulary Pruning for Efficient Speculative Decoding in LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.22694v2](http://arxiv.org/pdf/2506.22694v2)**
...
>
> **备注:** 8 pages, 4 figures, 5 tables, accepted at ICML 2025 workshop on Efficient Systems for Foundational Models
>
...
>
---
#### [replaced 083] The Super Weight in Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2411.07191v2](http://arxiv.org/pdf/2411.07191v2)**
...
>
---
#### [replaced 087] MT2-CSD: A New Dataset and Multi-Semantic Knowledge Fusion Method for Conversational Stance Detection
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.21053v2](http://arxiv.org/pdf/2506.21053v2)**
...
>
---
#### [replaced 088] Eka-Eval : A Comprehensive Evaluation Framework for Large Language Models in Indian Languages
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.01853v2](http://arxiv.org/pdf/2507.01853v2)**
...
>
---
#### [replaced 089] jina-embeddings-v4: Universal Embeddings for Multimodal Multilingual Retrieval
- **分类: cs.AI; cs.CL; cs.IR; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2506.18902v3](http://arxiv.org/pdf/2506.18902v3)**
...
>
---
#### [replaced 090] RAG+: Enhancing Retrieval-Augmented Generation with Application-Aware Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.11555v3](http://arxiv.org/pdf/2506.11555v3)**

> **作者:** Yu Wang; Shiwan Zhao; Zhihu Wang; Ming Fan; Yubo Zhang; Xicheng Zhang; Zhengfan Wang; Heyuan Huang; Ting Liu
>
...
>
---
#### [replaced 091] Reviewing Scientific Papers for Critical Problems With Reasoning LLMs: Baseline Approaches and Automatic Evaluation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23824v2](http://arxiv.org/pdf/2505.23824v2)**
...
>
---
#### [replaced 092] Elements of World Knowledge (EWoK): A Cognition-Inspired Framework for Evaluating Basic World Knowledge in Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2405.09605v2](http://arxiv.org/pdf/2405.09605v2)**
...
>
---
#### [replaced 096] Inside you are many wolves: Using cognitive models to interpret value trade-offs in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.20666v2](http://arxiv.org/pdf/2506.20666v2)**
...
>
---
#### [replaced 097] RewardAnything: Generalizable Principle-Following Reward Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.03637v2](http://arxiv.org/pdf/2506.03637v2)**

> **作者:** Zhuohao Yu; Jiali Zeng; Weizheng Gu; Yidong Wang; Jindong Wang; Fandong Meng; Jie Zhou; Yue Zhang; Shikun Zhang; Wei Ye
>
> **备注:** 25 pages, 9 figures, Code & model weights available at: https://zhuohaoyu.github.io/RewardAnything
>
...
>
---
#### [replaced 098] Implicit Reward as the Bridge: A Unified View of SFT and DPO Connections
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.00018v2](http://arxiv.org/pdf/2507.00018v2)**
...
>
---
#### [replaced 099] Pensieve Grader: An AI-Powered, Ready-to-Use Platform for Effortless Handwritten STEM Grading
- **分类: cs.AI; cs.CL; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.01431v2](http://arxiv.org/pdf/2507.01431v2)**
...
>
---
#### [replaced 100] Sequoia: Scalable, Robust, and Hardware-aware Speculative Decoding
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2402.12374v3](http://arxiv.org/pdf/2402.12374v3)**
...
>
---
#### [replaced 101] Evaluating AI for Finance: Is AI Credible at Assessing Investment Risk?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.18953v2](http://arxiv.org/pdf/2505.18953v2)**
