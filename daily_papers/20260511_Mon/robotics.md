...
#### [new 001] How to utilize failure demo data?: Effective data selection for imitation learning using distribution differences in attention mechanism
- **分类: cs.RO**

- **简介: 该论文属于机器人模仿学习任务，旨在有效利用失败数据。通过分析成功与失败数据的分布差异，改进注意力机制，提升动作稳定性。**
...
>
---
#### [new 002] Is the Future Compatible? Diagnosing Dynamic Consistency in World Action Models
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 025] TAVIS: A Benchmark for Egocentric Active Vision and Anticipatory Gaze in Imitation Learning
...
>
---
#### [new 038] Operating Within the Operational Design Domain: Zero-Shot Perception with Vision-Language Models
...
>
---
#### [new 039] Text-to-CAD Evaluation with CADTests
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [new 043] Learning Visual Feature-Based World Models via Residual Latent Action
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [new 044] TriP: A Triangle Puzzle Approach to Robust Translation Averaging
...
>
---
#### [new 045] HumanNet: Scaling Human-centric Video Learning to One Million Hours
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 003] Large Video Planner Enables Generalizable Robot Control
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 004] Balancing Act: Trading Off Odometry and Map Registration for Efficient Lidar Localization
- **分类: cs.RO**

- **简介: 论文研究自动驾驶中的激光雷达定位问题，旨在平衡定位精度与计算效率。通过集成轻量级里程计方法，优化定位更新频率，实现高效且准确的定位。**
...
>
---
#### [replaced 005] Bluetooth Phased-array Aided Inertial Navigation Using Factor Graphs: Experimental Verification
- **分类: eess.SY; cs.RO**

- **简介: 该论文属于导航任务，解决GNSS失效下的定位问题。通过实验验证基于因子图的蓝牙相控阵辅助惯性导航方法，评估其性能。**
...
>
---
#### [replaced 006] Dynamic Properties and Motion Reproducibility of a Compact Pneumatically Actuated Humanoid Upper Body for Data-Driven Control
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决高自由度气动机器人精确控制问题。通过构建13-DOF上半身人形机器人，验证系统可重复性，并设计数据驱动控制器提升轨迹跟踪性能。**

- **链接: [https://arxiv.org/pdf/2603.14787](https://arxiv.org/pdf/2603.14787)**

> **作者:** Hiroshi Atsuta; Hisashi Ishihara; Minoru Asada
>
> **备注:** 25 pages, 21 figures. Submitted to Advanced Robotics
>
...
>
---
#### [replaced 007] SeedPolicy: Horizon Scaling via Self-Evolving Diffusion Policy for Robot Manipulation
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，解决长时序模仿学习中的时间建模问题。提出SeedPolicy，通过自进化注意力机制提升扩散策略的长期上下文理解能力，显著提升性能。**
...
>
---
#### [replaced 008] Hydra-DP3: Frequency-Aware Right-Sizing of 3D Diffusion Policies for Visuomotor Control
- **分类: cs.RO**

- **简介: 该论文属于机器人视觉控制任务，解决3D扩散策略的参数过多和推理延迟高的问题。提出HDP3模型，采用轻量级解码器和两步DDIM推理，提升效率并保持性能。**
...
>
---
#### [replaced 009] A Cost-Effective and Climate-Resilient Air Pressure System for Rain Effect Reduction on Automated Vehicle Cameras
- **分类: cs.RO**

- **简介: 该论文属于自动驾驶感知任务，旨在解决雨天摄像头性能下降问题。提出一种低成本、抗气候的空气压力系统，提升行人检测准确率。**

- **链接: [https://arxiv.org/pdf/2602.17472](https://arxiv.org/pdf/2602.17472)**
...
>
---
#### [replaced 010] Latent Reasoning VLA: Latent Thinking and Prediction for Vision-Language-Action Models
- **分类: cs.RO**

- **简介: 该论文提出LaRA-VLA，解决VLA模型推理效率低和表示不匹配问题，通过连续潜在推理实现高效动作控制。**

- **链接: [https://arxiv.org/pdf/2602.01166](https://arxiv.org/pdf/2602.01166)**
...
>
---
#### [replaced 013] 3D Generation for Embodied AI and Robotic Simulation: A Survey
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 014] Contact-Grounded Policy: Dexterous Visuotactile Policy with Generative Contact Grounding
- **分类: cs.RO**

- **简介: 该论文提出CGP，解决多指灵巧操作中接触状态建模问题，通过预测机器人状态与触觉反馈的耦合轨迹，提升操作任务性能。**
...
>
---
#### [replaced 015] Goal-Conditioned Decision Transformer for Multi-Goal Offline Reinforcement Learning
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于多目标离线强化学习任务，旨在提高样本效率和泛化能力。通过引入目标条件决策变压器，利用预收集数据解决不同任务，实验表明其效果优于现有方法。**

- **链接: [https://arxiv.org/pdf/2410.06347](https://arxiv.org/pdf/2410.06347)**

> **作者:** Paweł Gajewski; Dominik Żurek; Marcin Pietroń; Kamil Faber
>
...
>
---
#### [replaced 016] Agent-Centric Observation Adaptation for Robust Visual Control under Dynamic Perturbations
- **分类: cs.RO**

- **简介: 该论文属于视觉控制任务，解决动态扰动下视觉系统鲁棒性问题。提出ACO-MoE方法，通过代理中心观察适配提升控制性能。**
...
>
---
#### [replaced 018] HAIC: Humanoid Agile Object Interaction Control via Dynamics-Aware World Model
- **分类: cs.RO**

- **简介: 该论文提出HAIC框架，解决人形机器人在非结构化环境中与不同动力学物体的敏捷交互问题，通过动态预测和自适应世界模型实现鲁棒控制。**

- **链接: [https://arxiv.org/pdf/2602.11758](https://arxiv.org/pdf/2602.11758)**
...
>
---
#### [replaced 023] AGILE: Hand-Object Interaction Reconstruction from Video via Agentic Generation
...
>
---
#### [replaced 024] Docking and Persistent Operations for a Resident Underwater Vehicle
- **分类: cs.RO**

- **简介: 该论文属于水下监测任务，旨在解决长期自主作业难题。通过开发带 docking 站的微型 ROV，实现自主导航、定位与巡检，提升水下监测效率与可靠性。**

- **链接: [https://arxiv.org/pdf/2602.16360](https://arxiv.org/pdf/2602.16360)**
...
>
---
#### [replaced 025] GATO: GPU-Accelerated and Batched Trajectory Optimization for Scalable Edge Model Predictive Control
- **分类: cs.RO; eess.SY**

- **简介: 该论文提出GATO，一种用于实时轨迹优化的GPU加速求解器，解决MPC中批量计算效率低的问题。**

- **链接: [https://arxiv.org/pdf/2510.07625](https://arxiv.org/pdf/2510.07625)**

> **作者:** Alexander Du; Emre Adabag; Gabriel Bravo-Palacios; Brian Plancher
>
> **备注:** Accepted to ICRA 2026. 8 pages, 8 figures, 2 tables
>
...
>
---
#### [replaced 026] MolmoAct2: Action Reasoning Models for Real-world Deployment
- **分类: cs.RO**

- **简介: 该论文属于机器人视觉-语言-动作任务，解决实际部署中模型性能不足问题，提出MolmoAct2模型及配套数据与方法，提升推理效率与可靠性。**

- **链接: [https://arxiv.org/pdf/2605.02881](https://arxiv.org/pdf/2605.02881)**
...
>
---
#### [replaced 027] GustPilot: A Hierarchical DRL-INDI Framework for Wind-Resilient Quadrotor Navigation
- **分类: cs.RO**

- **简介: 该论文提出GustPilot框架，解决轻型四旋翼在风扰下的自主导航问题。结合DRL与INDI，提升飞行稳定性与成功率。**
...
>
---
#### [replaced 030] Affordance Agent Harness: Verification-Gated Skill Orchestration
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 031] TAG-K: Tail-Averaged Greedy Kaczmarz for Computationally Efficient and Performant Online Inertial Parameter Estimation
- **分类: cs.RO**

- **简介: 该论文属于在线惯性参数估计任务，解决动态环境中参数跟踪慢和计算成本高的问题。提出TAG-K算法，结合贪婪选择与尾部平均，提升速度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2510.04839](https://arxiv.org/pdf/2510.04839)**

> **作者:** Shuo Sha; Anupam Bhakta; Zhenyuan Jiang; Kevin Qiu; Ishaan Mahajan; Gabriel Bravo-Palacios; Brian Plancher
>
> **备注:** Accepted to ICRA 2026. 3 Figures. 3 Tables
>
> **摘要:** Accurate online inertial parameter estimation is essential for adaptive robotic control, enabling real-time adjustment to payload changes, environmental interactions, and system wear. Traditional methods often struggle to track abrupt parameter shifts or incur high computational costs, limiting their effectiveness in dynamic environments and for computationally constrained robotic systems. We introduce TAG-K, a lightweight extension of the Kaczmarz method that combines greedy randomized row selection for rapid convergence with tail averaging for robustness under noise and inconsistency. This design enables fast, stable parameter adaptation while retaining the low per-iteration complexity inherent to the Kaczmarz framework. We evaluate TAG-K in synthetic benchmarks and quadrotor tracking tasks against RLS, KF, and other Kaczmarz variants. TAG-K achieves 1.5x-1.9x faster solve times on laptop-class CPUs and 4.8x-20.7x faster solve times on embedded microcontrollers. More importantly, these speedups are paired with improved robustness to measurement noise and a 25% reduction in estimation error, leading to nearly 2x better end-to-end tracking performance. Website, documentation, and code available at: this https URL.
>
---
#### [replaced 032] Continually Evolving Skill Knowledge in Vision Language Action Model
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于视觉-语言-动作模型的持续学习任务，旨在解决VLA模型在高效适应新任务时参数膨胀的问题。提出Stellar VLA框架，通过知识引导机制实现无新增参数的持续学习。**

- **链接: [https://arxiv.org/pdf/2511.18085](https://arxiv.org/pdf/2511.18085)**

> **作者:** Yuxuan Wu; Guangming Wang; Zhiheng Yang; Tianchen Deng; Maoqing Yao; Brian Sheil; Hesheng Wang
>
...
>
---
#### [replaced 033] DynaRetarget: Dynamically-Feasible Retargeting using Sampling-Based Trajectory Optimization
- **分类: cs.RO**

- **简介: 该论文提出DynaRetarget，解决人体动作到人形机器人控制策略的迁移问题。通过SBTO框架优化轨迹，提升动态可行性，实现高效、鲁棒的动作迁移。**

- **链接: [https://arxiv.org/pdf/2602.06827](https://arxiv.org/pdf/2602.06827)**
