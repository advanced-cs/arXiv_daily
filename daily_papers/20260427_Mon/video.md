...
#### [new 001] SAMIDARE: Advanced Tracking-by-Segmentation for Dense Scenarios
- **分类: cs.CV**

- **简介: 该论文属于多目标跟踪任务，解决密集场景下的遮挡与ID切换问题。提出SAMIDARE框架，通过自适应掩码控制和状态感知关联提升跟踪性能。**

- **链接: [https://arxiv.org/pdf/2604.22162](https://arxiv.org/pdf/2604.22162)**

> **作者:** Shozaburo Hirano; Norimichi Ukita
>
> **摘要:** Automated sports analysis demands robust multi-object tracking (MOT), yet segmentation-based methods often struggle with mask errors and ID switches in dense scenes. We propose SAMIDARE, a framework that enhances SAM2MOT for crowded scenes through three key components: (1) density-aware mask re-generation and (2) selective memory updates, both for adaptive mask control to preserve target feature integrity, and (3) state-aware association and new track initialization, which improves robustness under mutual occlusions and frequent frame-out events. Evaluated on the SportsMOT dataset, SAMIDARE achieves state-of-the-art performance, outperforming the baseline by 2.5 HOTA and 4.2 IDF1 points on the validation set. These results demonstrate that adaptive feature management using mask control and state-aware association provide a robust and efficient solution for dense sports tracking. Code is available at this https URL
>
---
#### [new 002] CAGE-SGG: Counterfactual Active Graph Evidence for Open-Vocabulary Scene Graph Generation
- **分类: cs.CV**

- **简介: 该论文属于开放词汇场景图生成任务，解决模型依赖语言先验而非视觉证据的问题。通过反事实验证机制，提升关系的可靠性与可解释性。**
...
>
---
#### [new 003] PASR: Pose-Aware 3D Shape Retrieval from Occluded Single Views
- **分类: cs.CV**

- **简介: 该论文提出PASR，解决单视角3D形状检索问题。通过将2D特征与3D投影对齐，提升检索鲁棒性和精度。**
...
>
---
#### [new 004] Soft Anisotropic Diagrams for Differentiable Image Representation
- **分类: cs.CV**

- **简介: 该论文提出Soft Anisotropic Diagrams（SAD），用于高效图像表示，解决图像压缩与渲染问题，通过可微分的拓扑结构实现快速编码和高质量重建。**
...
>
---
#### [new 011] ReLIC-SGG: Relation Lattice Completion for Open-Vocabulary Scene Graph Generation
- **分类: cs.CV**

- **简介: 该论文属于开放词汇场景图生成任务，解决标注不完整导致的负样本误判问题。提出ReLIC-SGG框架，通过语义关系格网模型增强对缺失正样本的识别与推理。**
...
>
---
#### [new 012] Railway Artificial Intelligence Learning Benchmark (RAIL-BENCH): A Benchmark Suite for Perception in the Railway Domain
- **分类: cs.CV**

- **简介: 该论文提出RAIL-BENCH，首个铁路领域感知基准套件，解决铁路环境下的视觉感知问题，包含五项挑战及标准化评估方法。**

- **链接: [https://arxiv.org/pdf/2604.22507](https://arxiv.org/pdf/2604.22507)**
...
>
---
#### [new 017] PAGaS: Pixel-Aligned 1DoF Gaussian Splatting for Depth Refinement
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 018] SpaMEM: Benchmarking Dynamic Spatial Reasoning via Perception-Memory Integration in Embodied Environments
- **分类: cs.CV**

- **简介: 该论文提出SpaMEM基准，用于评估具身环境中的动态空间推理。解决多模态大模型在长期空间一致性上的不足，通过三个层级任务测试感知、时间推理和信念维护能力。**
...
>
---
#### [new 019] EgoMAGIC- An Egocentric Video Field Medicine Dataset for Training Perception Algorithms
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出EgoMAGIC数据集，用于医疗任务的感知算法训练，解决医学视频中动作检测与物体识别问题。**

- **链接: [https://arxiv.org/pdf/2604.22036](https://arxiv.org/pdf/2604.22036)**
...
>
---
#### [new 020] Cross-Stage Coherence in Hierarchical Driving VQA: Explicit Baselines and Learned Gated Context Projectors
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究自动驾驶中的图视觉问答任务，解决跨阶段一致性问题。通过显式和隐式两种机制提升规划阶段的语义一致性与推理质量。**

- **链接: [https://arxiv.org/pdf/2604.22560](https://arxiv.org/pdf/2604.22560)**
...
>
---
#### [new 021] Revisiting Geometric Obfuscation with Dual Convergent Lines for Privacy-Preserving Image Queries in Visual Localization
- **分类: cs.CV**

- **简介: 该论文属于视觉定位任务，旨在解决隐私保护图像查询中的关键点泄露问题。提出Dual Convergent Lines方法，增强几何遮蔽的隐私性，有效抵御隐私攻击。**

- **链接: [https://arxiv.org/pdf/2604.22310](https://arxiv.org/pdf/2604.22310)**
...
>
---
#### [new 026] Unlocking Optical Prior: Spectrum-Guided Knowledge Transfer for SAR Generalized Category Discovery
- **分类: cs.CV**

- **简介: 该论文属于SAR图像分类任务，解决光学先验与SAR图像跨模态不兼容问题。提出MDC和MCPT框架，通过频域建模实现有效知识迁移。**

- **链接: [https://arxiv.org/pdf/2604.22174](https://arxiv.org/pdf/2604.22174)**
...
>
---
#### [new 027] All Eyes on the Workflow: Automated and Efficient Event Discovery from Video Streams
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于事件发现任务，解决视频数据难以直接用于流程分析的问题。通过提取视频中的事件数据，生成可分析的日志。**

- **链接: [https://arxiv.org/pdf/2604.22476](https://arxiv.org/pdf/2604.22476)**
...
>
---
#### [new 037] A Non-Invasive Alternative to RFID: Self-Sufficient 3D Identification of Group-Housed Livestock
- **分类: cs.CV**

- **简介: 该论文属于动物识别任务，旨在解决群体饲养中个体识别的问题。提出一种基于3D点云的非侵入式识别系统，采用自适应框架TARA实现高精度识别。**

- **链接: [https://arxiv.org/pdf/2604.22657](https://arxiv.org/pdf/2604.22657)**
...
>
---
#### [new 048] Different Strokes for Different Folks: Writer Identification for Historical Arabic Manuscripts
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于手写阿拉伯文稿作者识别任务，旨在解决历史文献的来源确认与真实性验证问题。通过扩展数据集并提出CNN模型，评估不同评价协议下的识别效果。**

- **链接: [https://arxiv.org/pdf/2604.22515](https://arxiv.org/pdf/2604.22515)**
...
>
---
#### [new 049] Contrastive Semantic Projection: Faithful Neuron Labeling with Contrastive Examples
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于神经元标注任务，解决现有方法依赖高激活样本导致标签不准确的问题。通过引入对比样本，提升标注的准确性和语义细粒度。**
...
>
---
#### [new 058] GenMatter: Perceiving Physical Objects with Generative Matter Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出GenMatter模型，用于通过生成式方法感知物理物体。解决计算机视觉在不同场景下缺乏统一运动感知的问题，通过分层 grouping 运动线索和外观特征，实现物体分割与跟踪。**

- **链接: [https://arxiv.org/pdf/2604.22160](https://arxiv.org/pdf/2604.22160)**
...
>
---
#### [new 064] Data-Free Contribution Estimation in Federated Learning using Gradient von Neumann Entropy
- **分类: cs.LG; cs.AI; cs.CV; cs.DC**

- **简介: 该论文属于联邦学习中的客户端贡献评估任务，旨在无需验证数据或客户端信息的情况下，通过梯度冯·诺依曼熵衡量客户端贡献，提出两种方案提升公平性和稳定性。**

- **链接: [https://arxiv.org/pdf/2604.22562](https://arxiv.org/pdf/2604.22562)**
...
>
---
#### [new 068] LTBs-KAN: Linear-Time B-splines Kolmogorov-Arnold Networks
- **分类: cs.LG; cs.CV; cs.NE**

- **简介: 该论文提出LTBs-KAN，解决KAN计算慢、参数多的问题，通过线性时间基样条和矩阵分解实现高效且参数减少的神经网络。**

- **链接: [https://arxiv.org/pdf/2604.22034](https://arxiv.org/pdf/2604.22034)**
...
>
---
#### [new 069] Multimodal Diffusion to Mutually Enhance Polarized Light and Low Resolution EBSD Data
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于多模态数据融合任务，旨在解决EBSD数据采集耗时及低分辨率问题。通过构建扩散模型，实现EBSD与偏光数据的相互增强，提升数据质量与效率。**

- **链接: [https://arxiv.org/pdf/2604.22212](https://arxiv.org/pdf/2604.22212)**
...
>
---
#### [new 070] An Artifact-based Agent Framework for Adaptive and Reproducible Medical Image Processing
- **分类: cs.AI; cs.CV; cs.MA**

- **简介: 该论文属于医学图像处理任务，解决临床环境中流程适应性与可复现性问题。提出基于实体的代理框架，实现流程配置自适应和结果可追溯。**

- **链接: [https://arxiv.org/pdf/2604.21936](https://arxiv.org/pdf/2604.21936)**
...
>
---
#### [new 072] Conditional Diffusion Posterior Alignment for Sparse-View CT Reconstruction
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学影像重建任务，解决稀疏视角CT重建中的质量与规模问题。提出CDPA方法，结合条件扩散与数据一致性，实现高效3D重建。**

- **链接: [https://arxiv.org/pdf/2604.21960](https://arxiv.org/pdf/2604.21960)**
...
>
---
#### [new 073] Are Natural-Domain Foundation Models Effective for Accelerated Cardiac MRI Reconstruction?
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于加速心脏MRI重建任务，探讨自然域基础模型的有效性。工作包括构建框架，比较基础模型与领域模型性能，验证其在跨域场景中的鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.22557](https://arxiv.org/pdf/2604.22557)**
...
>
---
#### [replaced 002] Gaussians on a Diet: High-Quality Memory-Bounded 3D Gaussian Splatting Training
- **分类: cs.CV**
...
>
---
#### [replaced 003] Reshoot-Anything: A Self-Supervised Model for In-the-Wild Video Reshooting
- **分类: cs.CV**
...
>
> **备注:** CVPRW 2026, Project page: this https URL, Code: this https URL
>
...
>
---
#### [replaced 004] Wan-Image: Pushing the Boundaries of Generative Visual Intelligence
- **分类: cs.CV**
...
>
---
#### [replaced 005] PanoSAMic: Panoramic Image Segmentation from SAM Feature Encoding and Dual View Fusion
- **分类: cs.CV**
...
>
---
#### [replaced 006] Nuclear Diffusion Models for Low-Rank Background Suppression in Videos
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2509.20886](https://arxiv.org/pdf/2509.20886)**
...
>
---
#### [replaced 007] LLMPhy: Parameter-Identifiable Physical Reasoning Combining Large Language Models and Physics Engines
...
>
> **备注:** Preprint. 10 pages, 7 figures
>
...
>
---
#### [replaced 012] Adapting MLLMs for Nuanced Video Retrieval
- **分类: cs.CV; cs.IR**

- **链接: [https://arxiv.org/pdf/2512.13511](https://arxiv.org/pdf/2512.13511)**

> **作者:** Piyush Bagad; Andrew Zisserman
>
> **备注:** 38 Pages. Project page at this http URL
>
...
>
---
#### [replaced 013] TEMA: Anchor the Image, Follow the Text for Multi-Modification Composed Image Retrieval
- **分类: cs.CV**
...
>
---
#### [replaced 014] OREN: Octree Residual Network for Real-Time Euclidean Signed Distance Mapping
...
>
> **备注:** Accepted to CVPR 2026 main track(poster)
>
...
>
---
#### [replaced 019] FeudalNav: A Simple Framework for Visual Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 022] Decomposed Attention Fusion in MLLMs for Training-Free Video Reasoning Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.19592](https://arxiv.org/pdf/2510.19592)**
...
>
---
#### [replaced 023] Teaching an Agent to Sketch One Part at a Time
...
>
---
#### [replaced 027] GOSPA and T-GOSPA quasi-metrics for evaluation of multi-object tracking algorithms
- **分类: cs.CV; math.ST**

- **链接: [https://arxiv.org/pdf/2507.13706](https://arxiv.org/pdf/2507.13706)**

> **作者:** Ángel F. García-Fernández; Jinhao Gu; Lennart Svensson; Yuxuan Xia; Jan Krejčí; Oliver Kost; Ondřej Straka
>
> **备注:** Matlab code of GOSPA and T-GOSPA q-metrics is provided at this https URL. Python code of the T-GOSPA q-metric is provided at this https URL
>
...
>
---
#### [replaced 028] Edit-aware RAW Reconstruction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05859](https://arxiv.org/pdf/2512.05859)**
...
>
---
#### [replaced 029] DVGT-2: Vision-Geometry-Action Model for Autonomous Driving at Scale
...
>
---
#### [replaced 030] UNIKIE-BENCH: Benchmarking Large Multimodal Models for Key Information Extraction in Visual Documents
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 031] Altitude-Adaptive Vision-Only Geo-Localization for UAVs in GPS-Denied Environments
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 032] Test-Time Matching: Unlocking Compositional Reasoning in Multimodal Models
...
>
---
#### [replaced 033] Segmentation of Gray Matters and White Matters from Brain MRI data
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 034] Lifting Unlabeled Internet-level Data for 3D Scene Understanding
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 035] Frozen LLMs as Map-Aware Spatio-Temporal Reasoners for Vehicle Trajectory Prediction
- **分类: cs.CV**
...
>
> **备注:** Accepted for publictaion at IEEE Intelligent Vehicles Symposium 2026
>
...
>
---
#### [replaced 036] ORSIFlow: Saliency-Guided Rectified Flow for Optical Remote Sensing Salient Object Detection
- **分类: cs.CV**
