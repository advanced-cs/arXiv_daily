...
>
---
#### [new 008] Dual-Stream Cross-Modal Representation Learning via Residual Semantic Decorrelation
- **分类: cs.CV; cs.AI; eess.IV**

- **简介: 该论文研究跨模态学习，旨在解决模态主导、冗余耦合和虚假相关问题。提出DSRSD-Net框架，通过残差分解和语义去相关约束，解耦模态共享与特有信息，提升预测性能与可解释性。**

- **链接: [https://arxiv.org/pdf/2512.07568v1](https://arxiv.org/pdf/2512.07568v1)**
...
>
---
#### [new 009] On The Role of K-Space Acquisition in MRI Reconstruction Domain-Generalization
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究MRI中k空间采样对重建模型跨域泛化的影响。针对现有采样策略泛化性差的问题，提出通过随机扰动k空间轨迹增强训练时的采集不确定性，提升模型在不同成像域间的适应能力，实现更鲁棒的加速重建。**

- **链接: [https://arxiv.org/pdf/2512.06530v1](https://arxiv.org/pdf/2512.06530v1)**
...
>
---
#### [new 010] Balanced Learning for Domain Adaptive Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文研究无监督域自适应语义分割，旨在解决跨域迁移中因类别不平衡导致的预测偏差问题。提出BLDA方法，通过分析预测logits分布，动态校正类别偏置，并利用共享锚分布对齐类间分布，提升模型对少见类的识别能力。**

- **链接: [https://arxiv.org/pdf/2512.06886v1](https://arxiv.org/pdf/2512.06886v1)**
...
>
---
#### [new 012] Unison: A Fully Automatic, Task-Universal, and Low-Cost Framework for Unified Understanding and Generation
- **分类: cs.CV**

- **简介: 该论文提出Unison框架，解决多模态统一理解与生成中任务覆盖窄、生成质量差、依赖人工配置的问题。采用两阶段低成本方案，实现自动解析意图、识别任务与参数，支持多种理解与生成任务，无需人工干预。**

- **链接: [https://arxiv.org/pdf/2512.07747v1](https://arxiv.org/pdf/2512.07747v1)**
...
>
---
#### [new 013] Decomposition Sampling for Efficient Region Annotations in Active Learning
- **分类: cs.CV**

- **简介: 该论文研究主动学习中的密集预测任务，旨在解决区域标注效率低、计算成本高和样本多样性不足的问题。提出分解采样（DECOMP）方法，通过伪标签分解图像并按类别采样，提升难类和小类区域的标注效率与模型性能。**

- **链接: [https://arxiv.org/pdf/2512.07606v1](https://arxiv.org/pdf/2512.07606v1)**
...
>
---
#### [new 014] STRinGS: Selective Text Refinement in Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于3D场景重建任务，旨在解决3D高斯溅射中文本细节模糊的问题。提出STRinGS框架，分离优化文本与非文本区域，提升文本清晰度，并引入OCR CER指标和新数据集STRinGS-360验证效果。**

- **链接: [https://arxiv.org/pdf/2512.07230v1](https://arxiv.org/pdf/2512.07230v1)**
...
>
---
#### [new 018] VG3T: Visual Geometry Grounded Gaussian Transformer
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于3D场景生成任务，旨在解决多视角图像融合中的碎片化问题。作者提出VG3T模型，通过联合多视角预测带语义的3D高斯分布，并引入网格采样与位置优化，提升几何与语义一致性，在nuScenes上实现了更高效、更精确的3D语义占据预测。**

- **链接: [https://arxiv.org/pdf/2512.05988v1](https://arxiv.org/pdf/2512.05988v1)**
...
>
---
#### [new 019] Think-Reflect-Revise: A Policy-Guided Reflective Framework for Safety Alignment in Large Vision Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 020] SUGAR: A Sweeter Spot for Generative Unlearning of Many Identities
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出SUGAR框架，解决3D生成模型中多身份遗忘问题。无需重训练，通过学习个性化代理隐变量，实现高效、高质量的身份移除，保持模型多样性与实用性，支持连续遗忘与优越保留性能。**

- **链接: [https://arxiv.org/pdf/2512.06562v1](https://arxiv.org/pdf/2512.06562v1)**
...
>
---
#### [new 021] Reevaluating Automated Wildlife Species Detection: A Reproducibility Study on a Custom Image Dataset
- **分类: cs.CV**

- **简介: 该论文属于野生动物图像识别任务，旨在验证预训练模型在不同数据集上的可重复性与泛化能力。作者使用新采集的900张跨90物种图像复现实验，获得62%准确率，验证了原研究结果，并指出需针对性优化以提升性能。**

- **链接: [https://arxiv.org/pdf/2512.07305v1](https://arxiv.org/pdf/2512.07305v1)**
...
>
---
#### [new 030] MMRPT: MultiModal Reinforcement Pre-Training via Masked Vision-Dependent Reasoning
- **分类: cs.CV**

- **简介: 该论文聚焦多模态预训练任务，旨在缓解图像-文本对中的描述偏差问题。作者提出MMRPT框架，首次将强化学习引入预训练，通过掩码视觉依赖片段并以视觉语义奖励引导重建，增强模型的视觉推理与泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.07203v1](https://arxiv.org/pdf/2512.07203v1)**
...
>
---
#### [new 031] WorldReel: 4D Video Generation with Consistent Geometry and Motion Modeling
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出WorldReel，致力于解决视频生成中3D不一致的问题。属于4D视频生成任务，通过联合建模RGB帧与4D场景表示，实现几何与运动的时空一致性，结合合成与真实数据训练，提升动态场景下视频的几何连贯性与视觉质量。**

- **链接: [https://arxiv.org/pdf/2512.07821v1](https://arxiv.org/pdf/2512.07821v1)**
...
>
---
#### [new 032] VG-Refiner: Towards Tool-Refined Referring Grounded Reasoning via Agentic Reinforcement Learning
- **分类: cs.CV**

- **简介: 该论文属于工具增强的视觉推理任务，旨在解决现有方法对不可靠工具输出缺乏有效响应机制的问题。作者提出VG-Refiner框架，通过两阶段思考-重思机制与精细化奖励，提升模型在指代表达与定位任务中的纠错能力，并设计新指标评估改进效果。**

- **链接: [https://arxiv.org/pdf/2512.06373v1](https://arxiv.org/pdf/2512.06373v1)**
...
>
> **摘要:** Tool-integrated visual reasoning (TiVR) has demonstrated great potential in enhancing multimodal problem-solving. However, existing TiVR paradigms mainly focus on integrating various visual tools through reinforcement learning, while neglecting to design effective response mechanisms for handling unreliable or erroneous tool outputs. This limitation is particularly pronounced in referring and grounding tasks, where inaccurate detection tool predictions often mislead TiVR models into generating hallucinated reasoning. To address this issue, we propose the VG-Refiner, the first framework aiming at the tool-refined referring grounded reasoning. Technically, we introduce a two-stage think-rethink mechanism that enables the model to explicitly analyze and respond to tool feedback, along with a refinement reward that encourages effective correction in response to poor tool results. In addition, we propose two new metrics and establish fair evaluation protocols to systematically measure the refinement ability of current models. We adopt a small amount of task-specific data to enhance the refinement capability of VG-Refiner, achieving a significant improvement in accuracy and correction ability on referring and reasoning grounding benchmarks while preserving the general capabilities of the pretrained model.
>
---
#### [new 033] Bridging spatial awareness and global context in medical image segmentation
- **分类: cs.CV**

- **简介: 该论文研究医学图像分割任务，旨在解决现有模型难以兼顾局部细节与全局上下文信息的问题。作者提出U-CycleMLP网络，通过改进编码器-解码器结构，增强上下文感知与边界精度，实现高效准确的分割，在多模态数据上表现优越。**

- **链接: [https://arxiv.org/pdf/2512.06560v1](https://arxiv.org/pdf/2512.06560v1)**
...
>
---
#### [new 034] COREA: Coarse-to-Fine 3D Representation Alignment Between Relightable 3D Gaussians and SDF via Bidirectional 3D-to-3D Supervision
- **分类: cs.CV**

- **简介: 该论文提出COREA框架，解决3D高斯点阵几何粗糙与BRDF-光照分解不稳定问题。通过粗到细的3D-3D双向对齐，联合优化可重光照的3D高斯与SDF，提升几何重建与渲染质量。**

- **链接: [https://arxiv.org/pdf/2512.07107v1](https://arxiv.org/pdf/2512.07107v1)**

> **作者:** Jaeyoon Lee; Hojoon Jung; Sungtae Hwang; Jihyong Oh; Jongwon Choi
>
> **备注:** Project page: https://vilab-cau.github.io/COREA/
>
...
>
---
#### [new 035] Debiasing Diffusion Priors via 3D Attention for Consistent Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于3D生成与编辑任务，旨在解决文本到图像扩散模型因先验视角偏差导致的多视图不一致问题。提出TD-Attn框架，通过3D感知注意力引导和分层注意力调制模块，增强跨视图一致性与编辑可控性。**

- **链接: [https://arxiv.org/pdf/2512.07345v1](https://arxiv.org/pdf/2512.07345v1)**
...
>
---
#### [new 036] How Far are Modern Trackers from UAV-Anti-UAV? A Million-Scale Benchmark and New Baseline
- **分类: cs.CV**

- **简介: 该论文提出UAV-Anti-UAV任务，解决移动无人机平台追踪对抗无人机的难题。针对现有研究不足，构建百万级多模态数据集，提出MambaSTS模型，融合时空语义信息，推动该领域发展。**

- **链接: [https://arxiv.org/pdf/2512.07385v1](https://arxiv.org/pdf/2512.07385v1)**

> **作者:** Chunhui Zhang; Li Liu; Zhipeng Zhang; Yong Wang; Hao Wen; Xi Zhou; Shiming Ge; Yanfeng Wang
>
> **备注:** https://github.com/983632847/Awesome-Multimodal-Object-Tracking
>
...
>
---
#### [new 037] AdLift: Lifting Adversarial Perturbations to Safeguard 3D Gaussian Splatting Assets Against Instruction-Driven Editing
- **分类: cs.CV; cs.CR; cs.LG**

- **简介: 该论文针对3D高斯点阵资产在指令编辑下的安全问题，提出首个防护方法AdLift。通过将2D对抗扰动提升至3D高斯表示，实现跨视角的编辑防护，兼顾不可见性与防护能力。**

- **链接: [https://arxiv.org/pdf/2512.07247v1](https://arxiv.org/pdf/2512.07247v1)**
...
>
---
#### [new 038] Hierarchical Image-Guided 3D Point Cloud Segmentation in Industrial Scenes via Multi-View Bayesian Fusion
- **分类: cs.CV**

- **简介: 该论文研究工业场景中的3D点云分割任务，旨在解决遮挡严重、物体尺度差异大导致的分割难题。提出一种分层图像引导的多视角贝叶斯融合框架，通过实例级到部件级的两阶段分割，提升语义一致性和细节捕捉能力。**

- **链接: [https://arxiv.org/pdf/2512.06882v1](https://arxiv.org/pdf/2512.06882v1)**
...
>
---
#### [new 052] VFM-VLM: Vision Foundation Model and Vision Language Model based Visual Comparison for 3D Pose Estimation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究3D姿态估计任务，解决手物抓取场景中语义与几何特征的权衡问题。作者比较了基于CLIP和DINOv2的视觉模型，发现前者语义强，后者几何精度高，为机器人抓取应用提供选型依据。**

- **链接: [https://arxiv.org/pdf/2512.07215v1](https://arxiv.org/pdf/2512.07215v1)**
...
>
---
#### [new 053] The Role of Entropy in Visual Grounding: Analysis and Optimization
...
>
---
#### [new 054] SUCCESS-GS: Survey of Compactness and Compression for Efficient Static and Dynamic Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于综述任务，旨在解决3D/4D高斯点阵的存储与计算开销问题。作者系统梳理了参数压缩与结构重构两类高效化方法，总结了数据集、指标与基准，并探讨了未来研究方向。**

- **链接: [https://arxiv.org/pdf/2512.07197v1](https://arxiv.org/pdf/2512.07197v1)**

> **作者:** Seokhyun Youn; Soohyun Lee; Geonho Kim; Weeyoung Kwon; Sung-Ho Bae; Jihyong Oh
>
> **备注:** The first three authors contributed equally to this work. The last two authors are co-corresponding authors. Please visit our project page at https://cmlab-korea.github.io/Awesome-Efficient-GS/
>
...
>
---
#### [new 057] DragMesh: Interactive 3D Generation Made Easy
- **分类: cs.CV**

- **简介: 该论文属于3D交互生成任务，旨在解决现有方法在物理合理性和实时性间的权衡问题。作者提出DragMesh，通过解耦运动学推理与动作生成，结合KPP-Net与DQ-VAE，实现无需训练即可对新物体进行实时、符合运动学的交互式3D操作。**

- **链接: [https://arxiv.org/pdf/2512.06424v1](https://arxiv.org/pdf/2512.06424v1)**

> **作者:** Tianshan Zhang; Zeyu Zhang; Hao Tang
>
> **摘要:** While generative models have excelled at creating static 3D content, the pursuit of systems that understand how objects move and respond to interactions remains a fundamental challenge. Current methods for articulated motion lie at a crossroads: they are either physically consistent but too slow for real-time use, or generative but violate basic kinematic constraints. We present DragMesh, a robust framework for real-time interactive 3D articulation built around a lightweight motion generation core. Our core contribution is a novel decoupled kinematic reasoning and motion generation framework. First, we infer the latent joint parameters by decoupling semantic intent reasoning (which determines the joint type) from geometric regression (which determines the axis and origin using our Kinematics Prediction Network (KPP-Net)). Second, to leverage the compact, continuous, and singularity-free properties of dual quaternions for representing rigid body motion, we develop a novel Dual Quaternion VAE (DQ-VAE). This DQ-VAE receives these predicted priors, along with the original user drag, to generate a complete, plausible motion trajectory. To ensure strict adherence to kinematics, we inject the joint priors at every layer of the DQ-VAE's non-autoregressive Transformer decoder using FiLM (Feature-wise Linear Modulation) conditioning. This persistent, multi-scale guidance is complemented by a numerically-stable cross-product loss to guarantee axis alignment. This decoupled design allows DragMesh to achieve real-time performance and enables plausible, generative articulation on novel objects without retraining, offering a practical step toward generative 3D intelligence. Code: https://github.com/AIGeeksGroup/DragMesh. Website: https://aigeeksgroup.github.io/DragMesh.
>
---
#### [new 058] Hide-and-Seek Attribution: Weakly Supervised Segmentation of Vertebral Metastases in CT
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究CT中椎体转移瘤的弱监督分割任务，旨在仅用椎体级良恶性标签生成精确的病灶掩膜。提出“Hide-and-Seek Attribution”方法，结合扩散自编码器与像素差分图，通过生成编辑和选择性遮蔽定位真正恶性区域，实现无需病灶标注的准确分割。**

- **链接: [https://arxiv.org/pdf/2512.06849v1](https://arxiv.org/pdf/2512.06849v1)**
...
>
---
#### [new 059] See More, Change Less: Anatomy-Aware Diffusion for Contrast Enhancement
- **分类: cs.CV**

- **简介: 该论文属医学图像增强任务，旨在解决现有模型因缺乏解剖认知导致的过编辑问题。作者提出SMILE方法，通过结构感知监督、免配准学习和统一推理，实现仅增强临床相关区域且保持解剖准确性的对比度优化。**

- **链接: [https://arxiv.org/pdf/2512.07251v1](https://arxiv.org/pdf/2512.07251v1)**
...
>
> **备注:** Project Page: https://zhaochongan.github.io/projects/OneStory
>
...
>
---
#### [new 062] Selective Masking based Self-Supervised Learning for Image Semantic Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究图像语义分割的自监督预训练方法，提出选择性掩码重建策略，通过迭代筛选难样本进行掩码，提升模型对低频类别的识别能力，优于随机掩码和ImageNet监督预训练，在多种数据集上显著提升下游分割精度。**

- **链接: [https://arxiv.org/pdf/2512.06981v1](https://arxiv.org/pdf/2512.06981v1)**
...
>
---
#### [new 063] Can We Go Beyond Visual Features? Neural Tissue Relation Modeling for Relational Graph Analysis in Non-Melanoma Skin Histology
- **分类: cs.CV**

- **简介: 该论文属医学图像分割任务，旨在解决皮肤癌组织切片中因组织重叠或形态相似导致的分割难题。作者提出NTRM框架，结合CNN与图神经网络，建模组织间的空间与功能关系，提升分割精度，尤其在边界密集区域表现优越。**

- **链接: [https://arxiv.org/pdf/2512.06949v1](https://arxiv.org/pdf/2512.06949v1)**
...
>
---
#### [new 068] Guiding What Not to Generate: Automated Negative Prompting for Text-Image Alignment
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究文本到图像生成中的图文对齐问题，提出自动化负向提示（NPC）方法，通过分析注意力机制识别并抑制错误内容，提升生成准确性。**

- **链接: [https://arxiv.org/pdf/2512.07702v1](https://arxiv.org/pdf/2512.07702v1)**
...
>
---
#### [new 069] ReLKD: Inter-Class Relation Learning with Knowledge Distillation for Generalized Category Discovery
- **分类: cs.CV**

- **简介: 该论文研究广义类别发现任务，旨在利用已知类标签对包含新旧类的无标签数据进行分类。针对现有方法忽略类间关系的问题，提出ReLKD框架，通过粗粒度模块捕捉隐式类间关系，并经知识蒸馏提升细粒度分类性能。**

- **链接: [https://arxiv.org/pdf/2512.07229v1](https://arxiv.org/pdf/2512.07229v1)**
...
>
---
#### [new 070] Spoofing-aware Prompt Learning for Unified Physical-Digital Facial Attack Detection
- **分类: cs.CV**

- **简介: 该论文研究统一的物理与数字人脸攻击检测任务，旨在解决现有方法因共享提示空间导致的优化冲突问题。提出欺骗感知提示学习框架，通过解耦提示分支和增强攻击上下文生成，提升对未见攻击类型的检测鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.06363v1](https://arxiv.org/pdf/2512.06363v1)**
...
>
---
#### [new 073] Single-step Diffusion-based Video Coding with Semantic-Temporal Guidance
- **分类: cs.CV**

- **简介: 该论文属于视频编码任务，旨在提升低码率下的感知质量。针对现有方法生成能力不足或计算复杂的问题，提出单步扩散视频编解码框架S2VC，引入上下文语义与时间一致性引导，实现高效高质量视频重建。**

- **链接: [https://arxiv.org/pdf/2512.07480v1](https://arxiv.org/pdf/2512.07480v1)**
...
>
---
#### [new 074] GlimmerNet: A Lightweight Grouped Dilated Depthwise Convolutions for UAV-Based Emergency Monitoring
- **分类: cs.CV**

- **简介: 该论文针对无人机应急监测中模型轻量化与全局感知兼顾的问题，提出GlimmerNet网络。通过分组扩张深度卷积和高效聚合模块，在极低参数量下实现多尺度特征提取与融合，提升精度与效率。**

- **链接: [https://arxiv.org/pdf/2512.07391v1](https://arxiv.org/pdf/2512.07391v1)**
...
>
---
#### [new 075] DFIR-DETR: Frequency Domain Enhancement and Dynamic Feature Aggregation for Cross-Scene Small Object Detection
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究跨场景小目标检测，针对特征弱、背景杂、尺度变化大等问题，提出DFIR-DETR模型。通过频率域增强与动态特征聚合，结合DCFA、DFPN和FIRC3模块，在保持轻量的同时提升检测性能，显著优于现有方法。**

- **链接: [https://arxiv.org/pdf/2512.07078v1](https://arxiv.org/pdf/2512.07078v1)**
...
>
---
#### [new 078] DGGAN: Degradation Guided Generative Adversarial Network for Real-time Endoscopic Video Enhancement
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对内窥镜视频因光照不均、散射等因素导致质量下降的问题，提出DGGAN框架，通过对比学习提取退化特征并跨帧传播，结合单帧增强模型与循环一致性训练，实现高效实时的视频增强，适用于临床手术场景。**

- **链接: [https://arxiv.org/pdf/2512.07253v1](https://arxiv.org/pdf/2512.07253v1)**
...
>
---
#### [new 079] Towards Unified Semantic and Controllable Image Fusion: A Diffusion Transformer Approach
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究图像融合任务，旨在解决现有方法在语义理解、用户控制和多场景适应上的不足。提出DiTFuse框架，基于扩散Transformer实现指令驱动的端到端融合，支持多模态统一建模与多层次交互控制，无需真值图像训练，提升融合质量与泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.07170v1](https://arxiv.org/pdf/2512.07170v1)**
...
>
---
#### [new 080] Towards Robust Pseudo-Label Learning in Semantic Segmentation: An Encoding Perspective
- **分类: cs.CV**

- **简介: 该论文聚焦语义分割中的伪标签学习，针对伪标签误差因独热编码被放大的问题，提出ECOCSeg方法，采用纠错输出码（ECOC）实现细粒度类别编码，提升模型对错误标签的鲁棒性，并设计位级去噪机制优化伪标签质量。**

- **链接: [https://arxiv.org/pdf/2512.06870v1](https://arxiv.org/pdf/2512.06870v1)**
...
>
---
#### [new 082] LongCat-Image Technical Report
- **分类: cs.CV**

- **简介: 该论文提出LongCat-Image，属多语言图像生成任务，旨在解决中英文文本渲染、真实感、部署效率与开源开放性问题。通过数据优化、小参数扩散模型设计及完整工具链开源，实现高质量生成与编辑，提升中文字符支持与推理效率。**

- **链接: [https://arxiv.org/pdf/2512.07584v1](https://arxiv.org/pdf/2512.07584v1)**
...
>
---
#### [new 085] Toward More Reliable Artificial Intelligence: Reducing Hallucinations in Vision-Language Models
...
>
---
#### [new 086] More than Segmentation: Benchmarking SAM 3 for Segmentation, 3D Perception, and Reconstruction in Robotic Surgery
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 087] HLTCOE Evaluation Team at TREC 2025: VQA Track
- **分类: cs.CV**

- **简介: 该论文针对TREC 2025 VQA赛道的答案生成任务，旨在提升答案的语义准确性和排序一致性。提出一种列表式学习框架，结合掩码指针交叉熵损失与排序权重，对多模态模型生成的候选答案进行重排序，增强细粒度判断，尤其改善需时序推理和语义消歧的问题。**

- **链接: [https://arxiv.org/pdf/2512.07738v1](https://arxiv.org/pdf/2512.07738v1)**
...
>
---
#### [new 088] The Inductive Bottleneck: Data-Driven Emergence of Representational Sparsity in Vision Transformers
- **分类: cs.CV**

- **简介: 该论文研究视觉Transformer（ViT）中表示稀疏性的数据驱动成因。针对ViT为何出现中间层信息压缩的“归纳瓶颈”问题，作者通过分析不同数据集上的有效编码维度，发现该现象是模型对任务语义抽象需求的自适应响应，而非结构缺陷。**

- **链接: [https://arxiv.org/pdf/2512.07331v1](https://arxiv.org/pdf/2512.07331v1)**
...
>
---
#### [new 089] CLUENet: Cluster Attention Makes Neural Networks Have Eyes
- **分类: cs.CV**

- **简介: 该论文提出CLUENet，用于视觉语义理解任务，旨在解决现有模型在可解释性、灵活性和准确性间的权衡问题。通过引入聚类注意力机制、特征调度和改进池化策略，提升了模型性能与透明度。**

- **链接: [https://arxiv.org/pdf/2512.06345v1](https://arxiv.org/pdf/2512.06345v1)**
...
>
---
#### [new 091] RefLSM: Linearized Structural-Prior Reflectance Model for Medical Image Segmentation and Bias-Field Correction
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决强度不均、噪声和模糊边界导致的分割难题。提出RefLSM模型，结合反射率分解与线性结构先验，直接分割光照不变的反射分量，并引入松弛二值水平集提升稳定性和效率。**

- **链接: [https://arxiv.org/pdf/2512.07191v1](https://arxiv.org/pdf/2512.07191v1)**
...
>
---
#### [new 094] Masked Autoencoder Pretraining on Strong-Lensing Images for Joint Dark-Matter Model Classification and Super-Resolution
- **分类: cs.CV; astro-ph.CO; astro-ph.IM; cs.AI; cs.LG**

- **简介: 该论文提出用掩码自编码器（MAE）在强引力透镜图像上预训练，解决暗物质模型分类与图像超分辨率重建问题。通过模拟数据预训练Vision Transformer，实现两个下游任务的联合优化，提升分类性能与图像复原质量。**

- **链接: [https://arxiv.org/pdf/2512.06642v1](https://arxiv.org/pdf/2512.06642v1)**
...
>
---
#### [new 095] Spatial Retrieval Augmented Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文提出空间检索增强的自动驾驶新范式，旨在解决感知视野受限问题。通过引入离线获取的地理图像作为“记忆”输入，扩展nuScenes数据集，并在五项核心任务上验证其有效性，提升模型在遮挡、恶劣天气等场景下的性能。**

- **链接: [https://arxiv.org/pdf/2512.06865v1](https://arxiv.org/pdf/2512.06865v1)**
...
>
---
#### [new 097] Lang3D-XL: Language Embedded 3D Gaussians for Large-scale Scenes
- **分类: cs.CV; cs.GR**

- **简介: 该论文属于3D场景语义建模任务，旨在解决大规模场景中语言嵌入的语义错位与效率问题。提出Lang3D-XL，通过低维语义瓶颈特征、哈希编码器和衰减下采样模块，提升语义对齐能力与计算效率。**

- **链接: [https://arxiv.org/pdf/2512.07807v1](https://arxiv.org/pdf/2512.07807v1)**
...
>
---
#### [new 098] Object Pose Distribution Estimation for Determining Revolution and Reflection Uncertainty in Point Clouds
- **分类: cs.CV**

- **简介: 该论文研究物体位姿估计中的不确定性问题，针对工业场景中缺乏颜色信息的点云数据，提出一种仅用3D无色数据的神经网络方法，估计物体旋转与反射对称性带来的位姿分布，为机器人感知提供更可靠的位姿不确定性输出。**

- **链接: [https://arxiv.org/pdf/2512.07211v1](https://arxiv.org/pdf/2512.07211v1)**
...
>
---
#### [new 099] Dropout Prompt Learning: Towards Robust and Adaptive Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视觉-语言模型的鲁棒性与适应性，提出Dropout Prompt Learning方法。通过在文本和视觉分支的token上应用基于重要性的dropout，并引入残差熵正则化，提升模型在低样本、长尾分布等场景下的泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.07234v1](https://arxiv.org/pdf/2512.07234v1)**
...
>
---
#### [new 102] AutoLugano: A Deep Learning Framework for Fully Automated Lymphoma Segmentation and Lugano Staging on FDG-PET/CT
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出AutoLugano，首个端到端自动化淋巴瘤分期系统。基于FDG-PET/CT扫描，通过病变分割、解剖定位和Lugano分期三模块，实现全自动区域受累检测与治疗分层，准确率达85.07%，助力临床决策。**

- **链接: [https://arxiv.org/pdf/2512.07206v1](https://arxiv.org/pdf/2512.07206v1)**
...
>
---
#### [new 103] InterAgent: Physics-based Multi-agent Command Execution via Diffusion on Interaction Graphs
- **分类: cs.CV**

- **简介: 该论文研究文本驱动的物理真实多智能体 humanoid 控制任务，旨在解决现有方法忽视多智能体间物理交互的问题。提出 InterAgent 框架，通过扩散 transformer 与交互图表示建模细粒度关节间依赖，实现协同动作生成。**

- **链接: [https://arxiv.org/pdf/2512.07410v1](https://arxiv.org/pdf/2512.07410v1)**
...
>
---
#### [new 106] PrefGen: Multimodal Preference Learning for Preference-Conditioned Image Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究偏好条件图像生成，旨在根据用户个性化审美生成图像。提出PrefGen框架，利用多模态大模型提取用户偏好特征，通过对比问答任务和对齐损失，实现文本与偏好的有效融合，提升生成图像的质量与偏好一致性。**

- **链接: [https://arxiv.org/pdf/2512.06020v1](https://arxiv.org/pdf/2512.06020v1)**

> **作者:** Wenyi Mo; Tianyu Zhang; Yalong Bai; Ligong Han; Ying Ba; Dimitris N. Metaxas
>
> **备注:** Project Page: \href{https://prefgen.github.io/}{\texttt{https://prefgen.github.io}}
>
...
>
---
#### [new 107] From Orbit to Ground: Generative City Photogrammetry from Extreme Off-Nadir Satellite Images
- **分类: cs.CV; cs.GR**

- **简介: 该论文研究城市级卫星图像的3D重建，旨在从极倾斜、稀疏的轨道图像生成逼真的地面视角。提出2.5D高度图建模与生成式纹理恢复网络，解决大视角外推中几何失真与纹理模糊问题，实现高质量城市场景重建。**

- **链接: [https://arxiv.org/pdf/2512.07527v1](https://arxiv.org/pdf/2512.07527v1)**
...
>
---
#### [new 110] UltrasODM: A Dual Stream Optical Flow Mamba Network for 3D Freehand Ultrasound Reconstruction
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 111] Generalized Referring Expression Segmentation on Aerial Photos
- **分类: cs.CV**

- **简介: 该论文研究航拍图像中的指代表达分割任务，旨在解决因分辨率、色彩、遮挡等导致的定位难题。作者构建了大规模数据集Aerial-D，提出自动化的表达生成流程，并结合历史影像模拟，实现对现代与历史航拍图的统一文本驱动分割。**

- **链接: [https://arxiv.org/pdf/2512.07338v1](https://arxiv.org/pdf/2512.07338v1)**
...
>
---
#### [new 112] All You Need Are Random Visual Tokens? Demystifying Token Pruning in VLLMs
- **分类: cs.CV**

- **简介: 该论文研究视觉大语言模型（VLLM）中的视觉令牌剪枝，旨在降低推理成本。发现深层视觉令牌信息趋于消失，随机剪枝在深层同样有效，并提出“信息视界”概念，指导高效剪枝，兼顾性能与效率。**

- **链接: [https://arxiv.org/pdf/2512.07580v1](https://arxiv.org/pdf/2512.07580v1)**
...
>
---
#### [new 117] DAUNet: A Lightweight UNet Variant with Deformable Convolutions and Parameter-Free Attention for Medical Image Segmentation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文面向医学图像分割任务，旨在提升模型对几何变化和低对比度区域的适应性。作者提出DAUNet，结合可变形卷积与无参注意力机制，在保持轻量化的同时增强特征表达，实现在资源受限场景下的高效精确分割。**

- **链接: [https://arxiv.org/pdf/2512.07051v1](https://arxiv.org/pdf/2512.07051v1)**
...
>
---
#### [new 118] OpenVE-3M: A Large-Scale High-Quality Dataset for Instruction-Guided Video Editing
- **分类: cs.CV**

- **简介: 该论文聚焦指令引导的视频编辑任务，旨在解决高质量、大规模数据集和统一评测基准缺失的问题。作者构建了包含300万样本的开源数据集OpenVE-3M和评测基准OpenVE-Bench，并训练5B模型OpenVE-Edit，在性能上超越现有开源模型。**

- **链接: [https://arxiv.org/pdf/2512.07826v1](https://arxiv.org/pdf/2512.07826v1)**
...
>
---
#### [new 119] When normalization hallucinates: unseen risks in AI-powered whole slide image processing
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦于AI病理全切片图像处理中的归一化任务，揭示其易产生视觉难辨的幻觉伪影问题。作者提出新指标自动检测幻觉，并在真实临床数据上验证主流方法的缺陷，强调需更鲁棒的归一化技术与严格验证。**

- **链接: [https://arxiv.org/pdf/2512.07426v1](https://arxiv.org/pdf/2512.07426v1)**
...
>
---
#### [new 120] MICo-150K: A Comprehensive Dataset Advancing Multi-Image Composition
- **分类: cs.CV**

- **简介: 该论文聚焦多图像合成（MICo）任务，旨在解决因缺乏高质量数据导致的生成一致性难题。作者构建了包含15万样本的数据集MICo-150K和评测基准MICo-Bench，提出新指标并训练出支持任意多图输入的模型Qwen-MICo，显著提升合成效果。**

- **链接: [https://arxiv.org/pdf/2512.07348v1](https://arxiv.org/pdf/2512.07348v1)**

> **作者:** Xinyu Wei; Kangrui Cen; Hongyang Wei; Zhen Guo; Bairui Li; Zeqing Wang; Jinrui Zhang; Lei Zhang
>
> **备注:** Project Page: https://MICo-150K.github.io/
>
...
>
---
#### [new 121] Rethinking Training Dynamics in Scale-wise Autoregressive Generation
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [new 122] Improving action classification with brain-inspired deep networks
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究动作分类任务，旨在解决深度神经网络过度依赖背景信息的问题。通过模仿人脑对身体和场景的分离处理机制，设计双流网络架构，提升模型对身体与背景信息的平衡利用，使性能更接近人类表现。**

- **链接: [https://arxiv.org/pdf/2512.07729v1](https://arxiv.org/pdf/2512.07729v1)**
...
>
---
#### [new 125] sim2art: Accurate Articulated Object Modeling from a Single Video using Synthetic Training Data Only
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 126] Simple Agents Outperform Experts in Biomedical Imaging Workflow Optimization
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦生物医学图像流程优化，解决科学家缺乏数据与时间手动适配模型的问题。提出并评估了一种简单AI代理框架，自动生成适配代码，效果优于专家手工方案，且开源框架验证了其实用性。**

- **链接: [https://arxiv.org/pdf/2512.06006v1](https://arxiv.org/pdf/2512.06006v1)**

> **作者:** Xuefei; Wang; Kai A. Horstmann; Ethan Lin; Jonathan Chen; Alexander R. Farhang; Sophia Stiles; Atharva Sehgal; Jonathan Light; David Van Valen; Yisong Yue; Jennifer J. Sun
>
> **摘要:** Adapting production-level computer vision tools to bespoke scientific datasets is a critical "last mile" bottleneck. Current solutions are impractical: fine-tuning requires large annotated datasets scientists often lack, while manual code adaptation costs scientists weeks to months of effort. We consider using AI agents to automate this manual coding, and focus on the open question of optimal agent design for this targeted task. We introduce a systematic evaluation framework for agentic code optimization and use it to study three production-level biomedical imaging pipelines. We demonstrate that a simple agent framework consistently generates adaptation code that outperforms human-expert solutions. Our analysis reveals that common, complex agent architectures are not universally beneficial, leading to a practical roadmap for agent design. We open source our framework and validate our approach by deploying agent-generated functions into a production pipeline, demonstrating a clear pathway for real-world impact.
>
---
#### [new 127] Knowing the Answer Isn't Enough: Fixing Reasoning Path Failures in LVLMs
- **分类: cs.CV**

- **简介: 该论文针对大视觉语言模型（LVLMs）中“答案正确但推理错误”的问题，提出一种两阶段后训练框架PSO，通过路径选择优化和负例回放机制，提升推理准确率与稳定性，解决模型因推理路径偏差导致的不可靠问题。**

- **链接: [https://arxiv.org/pdf/2512.06258v1](https://arxiv.org/pdf/2512.06258v1)**
...
>
---
#### [new 128] A Perception CNN for Facial Expression Recognition
- **分类: cs.CV**

- **简介: 该论文研究面部表情识别任务，旨在解决CNN忽略面部分割影响的问题。提出感知CNN（PCNN），通过并行网络提取局部特征，结合多域交互融合局部与全局特征，并设计两阶段损失函数提升识别性能。**

- **链接: [https://arxiv.org/pdf/2512.06422v1](https://arxiv.org/pdf/2512.06422v1)**
...
>
---
#### [new 130] A Sleep Monitoring System Based on Audio, Video and Depth Information
- **分类: cs.CV; cs.MM**

- **简介: 该论文提出一种基于音频、视频和深度信息的非侵入式睡眠监测系统，旨在定量评估睡眠干扰。通过多传感器融合与事件检测算法，识别运动、光照和噪声三类睡眠事件，实现在低光环境下的可靠睡眠监测。**

- **链接: [https://arxiv.org/pdf/2512.06282v1](https://arxiv.org/pdf/2512.06282v1)**
...
>
---
#### [new 144] HVQ-CGIC: Enabling Hyperprior Entropy Modeling for VQ-Based Controllable Generative Image Compression
- **分类: cs.CV**

- **简介: 该论文研究基于向量量化的生成式图像压缩，旨在解决现有方法熵建模非自适应导致的码率浪费和率控困难问题。作者提出HVQ-CGIC框架，首次引入超先验对VQ索引建模，并实现率失真平衡与可控性，显著提升压缩性能。**

- **链接: [https://arxiv.org/pdf/2512.07192v1](https://arxiv.org/pdf/2512.07192v1)**
...
>
---
#### [new 149] NeuroABench: A Multimodal Evaluation Benchmark for Neurosurgical Anatomy Identification
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 150] High-Throughput Unsupervised Profiling of the Morphology of 316L Powder Particles for Use in Additive Manufacturing
- **分类: cs.CV**

- **简介: 该论文针对金属粉末形态表征难题，提出一种高通量无监督机器学习框架，结合图像采集与聚类分析，实现对316L粉末颗粒形态的自动化快速分类，为增材制造中粉体质量监控提供技术支持。**

- **链接: [https://arxiv.org/pdf/2512.06012v1](https://arxiv.org/pdf/2512.06012v1)**
...
>
---
#### [new 151] VAD-Net: Multidimensional Facial Expression Recognition in Intelligent Education System
- **分类: cs.CV**

- **简介: 该论文属多维表情识别任务，旨在解决现有数据集缺乏VAD三维情感标注及Dominance维度难预测问题。作者为FER2013标注VAD数据，提出正交卷积网络提升预测精度，发布新数据集与代码供后续研究使用。**

- **链接: [https://arxiv.org/pdf/2512.06377v1](https://arxiv.org/pdf/2512.06377v1)**
...
>
---
#### [new 152] Language-driven Fine-grained Retrieval
- **分类: cs.CV**

- **简介: 该论文研究细粒度图像检索，旨在解决传统方法因使用稀疏类别标签而限制跨类别泛化的问题。提出LaFG框架，利用大语言模型和视觉-语言模型从类别名称生成属性级监督，构建语言原型指导检索模型训练，提升对未见类别的泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.06255v1](https://arxiv.org/pdf/2512.06255v1)**
...
>
---
#### [new 153] Adaptive Dataset Quantization: A New Direction for Dataset Pruning
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究数据集压缩任务，旨在降低边缘设备中大数据集的存储与通信开销。提出自适应数据集量化方法，通过减少样本内冗余，在保持训练性能的同时实现高效压缩，优于传统剪枝与量化方法。**

- **链接: [https://arxiv.org/pdf/2512.05987v1](https://arxiv.org/pdf/2512.05987v1)**
...
>
---
#### [new 154] TrajMoE: Scene-Adaptive Trajectory Planning with Mixture of Experts and Reinforcement Learning
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究自动驾驶轨迹规划任务，针对现有方法忽略场景差异性和评分机制局限性的问题，提出TrajMoE模型，结合专家混合网络自适应选择轨迹先验，并用强化学习优化评分，提升规划性能。**

- **链接: [https://arxiv.org/pdf/2512.07135v1](https://arxiv.org/pdf/2512.07135v1)**
...
>
---
#### [new 155] An AI-Powered Autonomous Underwater System for Sea Exploration and Scientific Research
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出一种AI驱动的自主水下系统，用于海洋探索与科研。针对传统探测成本高、风险大、效率低的问题，设计融合目标检测、特征提取、聚类与语言模型的AUV系统，实现水下物体自动识别与报告生成，提升探测效率与数据分析深度。**

- **链接: [https://arxiv.org/pdf/2512.07652v1](https://arxiv.org/pdf/2512.07652v1)**
...
>
---
#### [new 156] MultiMotion: Multi Subject Video Motion Transfer via Video Diffusion Transformer
- **分类: cs.CV**

- **简介: 该论文研究多对象视频动作迁移任务，旨在解决DiT中动作纠缠与缺乏对象级控制的问题。提出MultiMotion框架，引入Maskaware Attention Motion Flow和RectPC采样器，实现精确、连贯的多对象动作迁移，并构建首个相关基准数据集。**

- **链接: [https://arxiv.org/pdf/2512.07500v1](https://arxiv.org/pdf/2512.07500v1)**
...
>
---
#### [new 157] MedGRPO: Multi-Task Reinforcement Learning for Heterogeneous Medical Video Understanding
- **分类: cs.CV**

- **简介: 该论文聚焦医疗视频理解任务，解决现有模型在多源异构数据下因奖励尺度不均导致的训练不稳定问题。作者构建大规模基准MedVidBench，并提出MedGRPO框架，通过跨数据集奖励归一化与医学LLM裁判实现多任务强化学习优化。**

- **链接: [https://arxiv.org/pdf/2512.06581v1](https://arxiv.org/pdf/2512.06581v1)**
...
>
---
#### [new 158] UnityVideo: Unified Multi-Modal Multi-Task Learning for Enhancing World-Aware Video Generation
- **分类: cs.CV**

- **简介: 该论文聚焦视频生成任务，旨在提升模型对真实世界的理解。针对现有方法依赖单模态输入、世界感知不足的问题，提出UnityVideo框架，通过多模态联合学习和动态加噪机制，实现更优的生成质量与物理一致性。**

- **链接: [https://arxiv.org/pdf/2512.07831v1](https://arxiv.org/pdf/2512.07831v1)**

> **作者:** Jiehui Huang; Yuechen Zhang; Xu He; Yuan Gao; Zhi Cen; Bin Xia; Yan Zhou; Xin Tao; Pengfei Wan; Jiaya Jia
>
> **备注:** Project Website https://jackailab.github.io/Projects/UnityVideo
>
...
>
---
#### [new 159] Integrating Multi-scale and Multi-filtration Topological Features for Medical Image Classification
- **分类: cs.CV**

- **简介: 该论文属医学图像分类任务，旨在解决现有模型忽略复杂拓扑结构的问题。作者提出一种新框架，通过多尺度多滤波持续同调提取拓扑特征，结合“vineyard”算法整合并利用交叉注意力网络融合至深度学习模型，提升对复杂解剖结构的识别能力。**

- **链接: [https://arxiv.org/pdf/2512.07190v1](https://arxiv.org/pdf/2512.07190v1)**
...
>
---
#### [new 160] Evaluating and Preserving High-level Fidelity in Super-Resolution
- **分类: cs.CV; cs.LG**

- **简介: 该论文聚焦图像超分辨率中的高阶保真度评估问题，旨在解决生成模型可能“幻构”内容而降低真实性的缺陷。作者构建了首个带保真标注的数据集，分析现有指标与高阶保真的相关性，提出利用基础模型更好衡量保真度，并通过反馈优化模型，兼顾语义保真与视觉质量。**

- **链接: [https://arxiv.org/pdf/2512.07037v1](https://arxiv.org/pdf/2512.07037v1)**
...
>
---
#### [new 161] MeshSplatting: Differentiable Rendering with Opaque Meshes
- **分类: cs.CV**

- **简介: 该论文提出MeshSplatting，旨在解决点基表示与主流网格管线不兼容的问题。它通过可微渲染联合优化几何与外观，生成高质量、实时渲染的连通网格，提升视图合成性能，融合神经渲染与交互式图形应用。**

- **链接: [https://arxiv.org/pdf/2512.06818v1](https://arxiv.org/pdf/2512.06818v1)**
...
>
> **摘要:** Primitive-based splatting methods like 3D Gaussian Splatting have revolutionized novel view synthesis with real-time rendering. However, their point-based representations remain incompatible with mesh-based pipelines that power AR/VR and game engines. We present MeshSplatting, a mesh-based reconstruction approach that jointly optimizes geometry and appearance through differentiable rendering. By enforcing connectivity via restricted Delaunay triangulation and refining surface consistency, MeshSplatting creates end-to-end smooth, visually high-quality meshes that render efficiently in real-time 3D engines. On Mip-NeRF360, it boosts PSNR by +0.69 dB over the current state-of-the-art MiLo for mesh-based novel view synthesis, while training 2x faster and using 2x less memory, bridging neural rendering and interactive 3D graphics for seamless real-time scene interaction. The project page is available at https://meshsplatting.github.io/.
>
---
#### [new 162] ContextAnyone: Context-Aware Diffusion for Character-Consistent Text-to-Video Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于文本到视频生成任务，旨在解决角色身份在多场景中不一致的问题。提出ContextAnyone框架，通过强调注意力模块和双引导损失，结合单张参考图实现发型、衣着等上下文特征的稳定建模，提升角色一致性与视觉质量。**

- **链接: [https://arxiv.org/pdf/2512.07328v1](https://arxiv.org/pdf/2512.07328v1)**
...
>
---
#### [new 163] EgoEdit: Dataset, Real-Time Streaming Model, and Benchmark for Egocentric Video Editing
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究第一人称视角视频的指令编辑任务，解决现有方法在快速自我运动和手物交互下的域差异与高延迟问题。提出EgoEditData数据集、实时流式模型EgoEdit及评测基准EgoEditBench，实现低延迟、高保真的交互式编辑。**

- **链接: [https://arxiv.org/pdf/2512.06065v1](https://arxiv.org/pdf/2512.06065v1)**
...
>
> **摘要:** We study instruction-guided editing of egocentric videos for interactive AR applications. While recent AI video editors perform well on third-person footage, egocentric views present unique challenges - including rapid egomotion and frequent hand-object interactions - that create a significant domain gap. Moreover, existing offline editing pipelines suffer from high latency, limiting real-time interaction. To address these issues, we present a complete ecosystem for egocentric video editing. First, we construct EgoEditData, a carefully designed and manually curated dataset specifically designed for egocentric editing scenarios, featuring rich hand-object interactions, while explicitly preserving hands. Second, we develop EgoEdit, an instruction-following egocentric video editor that supports real-time streaming inference on a single GPU. Finally, we introduce EgoEditBench, an evaluation suite targeting instruction faithfulness, hand and interaction preservation, and temporal stability under egomotion. Across both egocentric and general editing tasks, EgoEdit produces temporally stable, instruction-faithful results with interactive latency. It achieves clear gains on egocentric editing benchmarks-where existing methods struggle-while maintaining performance comparable to the strongest baselines on general editing tasks. EgoEditData and EgoEditBench will be made public for the research community. See our website at https://snap-research.github.io/EgoEdit
>
---
#### [new 164] Towards Accurate UAV Image Perception: Guiding Vision-Language Models with Stronger Task Prompts
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦无人机图像感知任务，旨在解决视觉-语言模型因简单提示难以应对复杂场景的问题。提出AerialVP框架，通过多维度辅助信息增强任务提示，并构建AerialSense基准进行评测，显著提升模型性能。**

- **链接: [https://arxiv.org/pdf/2512.07302v1](https://arxiv.org/pdf/2512.07302v1)**
...
>
---
#### [new 165] Less Is More, but Where? Dynamic Token Compression via LLM-Guided Keyframe Prior
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [new 168] MoCA: Mixture-of-Components Attention for Scalable Compositional 3D Generation
- **分类: cs.CV**

- **简介: 该论文属于3D生成任务，旨在解决现有方法在组件增多时计算成本高的问题。提出MoCA模型，通过重要性路由和非重要组件压缩，实现高效、可扩展的细粒度3D组合生成。**

- **链接: [https://arxiv.org/pdf/2512.07628v1](https://arxiv.org/pdf/2512.07628v1)**
...
>
---
#### [new 169] Distribution Matching Variational AutoEncoder
- **分类: cs.CV**

- **简介: 该论文研究生成模型的潜在空间分布设计问题，提出分布匹配变分自编码器（DMVAE），通过显式对齐任意参考分布优化潜变量结构。实验证明，自监督特征导出的分布在图像重建与建模效率间取得良好平衡，提升了生成性能。**

- **链接: [https://arxiv.org/pdf/2512.07778v1](https://arxiv.org/pdf/2512.07778v1)**
...
>
---
#### [new 170] ControlVP: Interactive Geometric Refinement of AI-Generated Images with Consistent Vanishing Points
- **分类: cs.CV**

- **简介: 该论文针对AI生成图像中透视不一致问题，提出ControlVP框架，通过用户引导和几何约束校正消失点，提升建筑场景的结构合理性，同时保持图像质量，适用于需精确空间结构的任务。**

- **链接: [https://arxiv.org/pdf/2512.07504v1](https://arxiv.org/pdf/2512.07504v1)**

> **作者:** Ryota Okumura; Kaede Shiohara; Toshihiko Yamasaki
>
> **备注:** Accepted to WACV 2026, 8 pages, supplementary included. Dataset and code: https://github.com/RyotaOkumura/ControlVP
>
...
>
---
#### [new 171] JOCA: Task-Driven Joint Optimisation of Camera Hardware and Adaptive Camera Control Algorithms
- **分类: cs.CV**

- **简介: 该论文研究任务驱动的相机系统设计，旨在联合优化相机硬件与自适应控制算法。针对现有方法多忽略运行时动态参数调控的问题，提出统一框架JOCA，结合梯度与无梯度方法，优化包括曝光等可调参数，提升低光、高速运动等场景下的感知性能。**

- **链接: [https://arxiv.org/pdf/2512.06763v1](https://arxiv.org/pdf/2512.06763v1)**
...
>
---
#### [new 172] MeshRipple: Structured Autoregressive Generation of Artist-Meshes
- **分类: cs.CV**

- **简介: 该论文研究3D网格生成任务，旨在解决现有自回归方法因内存限制导致的几何碎片与拓扑不连贯问题。作者提出MeshRipple，通过前沿感知的序列化、扩展式预测与稀疏注意力全局记忆，实现高保真、拓扑完整的网格生成。**

- **链接: [https://arxiv.org/pdf/2512.07514v1](https://arxiv.org/pdf/2512.07514v1)**
...
>
---
#### [new 175] OCFER-Net: Recognizing Facial Expression in Online Learning System
- **分类: cs.CV**

- **简介: 该论文针对在线教育中的表情识别任务，提出OCFER-Net模型。为提升卷积特征的多样性与表达能力，引入正交正则化约束卷积核，增强面部表情识别精度，在FER-2013数据集上优于基线方法。**

- **链接: [https://arxiv.org/pdf/2512.06379v1](https://arxiv.org/pdf/2512.06379v1)**
...
>
---
#### [new 176] SJD++: Improved Speculative Jacobi Decoding for Training-free Acceleration of Discrete Auto-regressive Text-to-Image Generation
- **分类: cs.CV**

- **简介: 该论文针对自回归文生图模型生成速度慢的问题，提出SJD++方法，通过多token预测与概率性草案验证机制，实现免训练的加速推理，显著减少生成步数和延迟，同时保持图像质量。**

- **链接: [https://arxiv.org/pdf/2512.07503v1](https://arxiv.org/pdf/2512.07503v1)**
...
>
---
#### [new 177] Tessellation GS: Neural Mesh Gaussians for Robust Monocular Reconstruction of Dynamic Objects
- **分类: cs.CV**

- **简介: 该论文聚焦单目动态物体三维重建，针对3D Gaussian Splatting在稀疏视角下泛化性差的问题，提出Tessellation GS。通过将2D高斯置于网格面并结合神经特征与自适应细分，提升重建鲁棒性，显著优化外观与几何质量。**

- **链接: [https://arxiv.org/pdf/2512.07381v1](https://arxiv.org/pdf/2512.07381v1)**
...
>
---
#### [new 178] Effective Attention-Guided Multi-Scale Medical Network for Skin Lesion Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究皮肤病变分割任务，旨在解决病灶形状不规则和对比度低导致的分割难题。提出一种多尺度注意力引导网络，通过多分辨率融合、跨模态注意力和外部注意力桥模块，提升特征提取精度与信息利用率，显著优于现有模型。**

- **链接: [https://arxiv.org/pdf/2512.07275v1](https://arxiv.org/pdf/2512.07275v1)**
...
>
---
#### [new 179] Enhancing Small Object Detection with YOLO: A Novel Framework for Improved Accuracy and Efficiency
- **分类: cs.CV**

- **简介: 该论文针对航拍图像中小目标检测难的问题，基于YOLO框架，通过优化滑动窗口裁剪策略并改进网络结构（如引入CBAM和新检测头），显著提升了检测精度，在VisDrone2019数据集上mAP达到61.2，优于现有方法。**

- **链接: [https://arxiv.org/pdf/2512.07379v1](https://arxiv.org/pdf/2512.07379v1)**
...
>
---
#### [new 182] Relational Visual Similarity
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文研究视觉关系相似性，旨在让模型理解图像间元素的结构对应而非仅外观相似。针对现有方法忽略关系相似的问题，作者构建了11.4万图文对数据集，训练视觉-语言模型以度量图像的关系相似性，推动图像按内在结构关联。**

- **链接: [https://arxiv.org/pdf/2512.07833v1](https://arxiv.org/pdf/2512.07833v1)**
...
>
---
#### [new 183] Multi-Modal Zero-Shot Prediction of Color Trajectories in Food Drying
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **简介: 该论文研究食品干燥过程中的颜色变化预测，属多模态时序预测任务。针对现有方法特征表达不足和泛化能力差的问题，提出融合高维颜色时序与工艺参数的模型，实现对未见条件下的颜色轨迹精准预测，显著降低误差。**

- **链接: [https://arxiv.org/pdf/2512.06190v1](https://arxiv.org/pdf/2512.06190v1)**

> **作者:** Shichen Li; Ahmadreza Eslaminia; Chenhui Shao
>
> **摘要:** Food drying is widely used to reduce moisture content, ensure safety, and extend shelf life. Color evolution of food samples is an important indicator of product quality in food drying. Although existing studies have examined color changes under different drying conditions, current approaches primarily rely on low-dimensional color features and cannot fully capture the complex, dynamic color trajectories of food samples. Moreover, existing modeling approaches lack the ability to generalize to unseen process conditions. To address these limitations, we develop a novel multi-modal color-trajectory prediction method that integrates high-dimensional temporal color information with drying process parameters to enable accurate and data-efficient color trajectory prediction. Under unseen drying conditions, the model attains RMSEs of 2.12 for cookie drying and 1.29 for apple drying, reducing errors by over 90% compared with baseline models. These experimental results demonstrate the model's superior accuracy, robustness, and broad applicability.
>
---
#### [new 184] TIDE: Two-Stage Inverse Degradation Estimation with Guided Prior Disentanglement for Underwater Image Restoration
- **分类: cs.CV**

- **简介: 该论文研究水下图像恢复，旨在解决复杂多变的退化问题。提出TIDE框架，通过两阶段逆向退化估计与引导先验解耦，将退化分解为颜色失真、雾气、细节丢失和噪声，分别由专用专家网络处理，并自适应融合与精细优化，提升恢复质量。**

- **链接: [https://arxiv.org/pdf/2512.07171v1](https://arxiv.org/pdf/2512.07171v1)**
...
>
---
#### [new 185] Towards Robust Protective Perturbation against DeepFake Face Swapping
- **分类: cs.CV; cs.AI; cs.CR; cs.LG**

- **简介: 该论文属图像安全任务，针对DeepFake换脸防御中扰动易被破坏的问题，提出EOLT框架，通过可学习的变换分布和强化学习策略，自适应生成更鲁棒的保护扰动，显著提升抗变换能力。**

- **链接: [https://arxiv.org/pdf/2512.07228v1](https://arxiv.org/pdf/2512.07228v1)**
...
>
---
#### [new 186] Domain-Specific Foundation Model Improves AI-Based Analysis of Neuropathology
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对通用病理模型在神经病理学分析中的局限，提出专用于脑组织的域特异性基础模型NeuroFM，通过训练于多种神经退行性病变全切片图像，提升阿尔茨海默病等疾病的分类与分割性能，推动精准神经病理AI诊断。**

- **链接: [https://arxiv.org/pdf/2512.05993v1](https://arxiv.org/pdf/2512.05993v1)**
...
>
---
#### [new 188] Context-measure: Contextualizing Metric for Camouflage
- **分类: cs.CV**

- **简介: 该论文针对伪装物体分割任务，指出现有评估指标忽略上下文依赖的问题，提出一种新的上下文化评价指标Context-measure。该方法结合像素级伪装量化与空间相关性建模，更符合人类感知，提升了评估可靠性，适用于农业、工业和医疗等场景。**

- **链接: [https://arxiv.org/pdf/2512.07076v1](https://arxiv.org/pdf/2512.07076v1)**
...
>
---
#### [new 189] Human3R: Incorporating Human Priors for Better 3D Dynamic Reconstruction from Monocular Videos
- **分类: cs.CV**

- **简介: 该论文属单目动态人体三维重建任务，旨在解决几何不一致与边界模糊问题。作者提出Human3R方法，融合SMPL人体先验与深度估计，通过分层流程和特征融合模块，在全分辨率下提升人体结构一致性与细节精度。**

- **链接: [https://arxiv.org/pdf/2512.06368v1](https://arxiv.org/pdf/2512.06368v1)**
...
>
---
#### [new 190] MMDuet2: Enhancing Proactive Interaction of Video MLLMs with Multi-Turn Reinforcement Learning
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 191] From Remote Sensing to Multiple Time Horizons Forecasts: Transformers Model for CyanoHAB Intensity in Lake Champlain
- **分类: cs.CV**

- **简介: 该论文属遥感时间序列预测任务，旨在解决湖泊蓝藻水华（CyanoHAB）多步提前预警问题。作者提出Transformer-BiLSTM模型，利用稀疏卫星数据，经两阶段预处理和特征工程，实现未来14天蓝藻强度的高精度预测。**

- **链接: [https://arxiv.org/pdf/2512.06598v1](https://arxiv.org/pdf/2512.06598v1)**
...
>
---
#### [new 194] Modality-Aware Bias Mitigation and Invariance Learning for Unsupervised Visible-Infrared Person Re-Identification
- **分类: cs.CV**

- **简介: 该论文研究无监督可见光-红外行人重识别，旨在解决跨模态差异导致的关联误差与表示学习难题。提出模态感知距离与“分而对比”策略，实现更优的跨模态匹配。**

- **链接: [https://arxiv.org/pdf/2512.07760v1](https://arxiv.org/pdf/2512.07760v1)**
...
>
---
#### [new 195] GorillaWatch: An Automated System for In-the-Wild Gorilla Re-Identification and Population Monitoring
- **分类: cs.CV**

- **简介: 该论文聚焦野生动物个体重识别与种群监测，旨在解决因缺乏大规模野外视频数据导致的自动化监测难题。作者构建了三个新数据集，提出GorillaWatch系统，结合检测、跟踪与重识别，并通过自监督预训练和可解释性方法提升模型性能，实现对西部低地大猩猩的非侵入式智能监测。**

- **链接: [https://arxiv.org/pdf/2512.07776v1](https://arxiv.org/pdf/2512.07776v1)**
...
>
---
#### [new 196] Robust Variational Model Based Tailored UNet: Leveraging Edge Detector and Mean Curvature for Improved Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，旨在解决噪声和边界模糊导致的分割难题。作者提出一种融合变分模型与深度学习的UNet框架，引入边缘检测和平均曲率先验，结合频域预处理与稳定局部计算，在保持高效的同时提升分割精度与视觉质量。**

- **链接: [https://arxiv.org/pdf/2512.07590v1](https://arxiv.org/pdf/2512.07590v1)**
...
>
---
#### [new 201] START: Spatial and Textual Learning for Chart Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究图表理解任务，旨在解决现有方法难以同时掌握图表空间结构与文本数据的问题。提出START框架及数据集，通过图表元素定位和代码生成增强多模态大模型的细粒度理解能力，并构建CS-Bench评估基准，显著提升性能。**

- **链接: [https://arxiv.org/pdf/2512.07186v1](https://arxiv.org/pdf/2512.07186v1)**
...
>
---
#### [new 208] Optimization-Guided Diffusion for Interactive Scene Generation
- **分类: cs.CV**

- **简介: 该论文属自动驾驶仿真任务，旨在解决安全关键场景稀缺与生成场景不真实的问题。提出OMEGA框架，通过优化引导扩散模型生成物理合理、交互可信的驾驶场景，提升 realism、controllability 与安全性验证能力。**

- **链接: [https://arxiv.org/pdf/2512.07661v1](https://arxiv.org/pdf/2512.07661v1)**
...
>
---
#### [new 209] Structure-Aware Feature Rectification with Region Adjacency Graphs for Training-Free Open-Vocabulary Semantic Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究无需训练的开放词汇语义分割，旨在解决CLIP模型因全局对齐偏好导致的局部区域分割噪声问题。提出基于低层特征构建区域邻接图，利用图像自身结构先验优化CLIP特征，提升局部一致性和分割精度。**

- **链接: [https://arxiv.org/pdf/2512.07360v1](https://arxiv.org/pdf/2512.07360v1)**
...
>
---
#### [new 210] CHIMERA: Adaptive Cache Injection and Semantic Anchor Prompting for Zero-shot Image Morphing with Morphing-oriented Metrics
- **分类: cs.CV**

- **简介: 该论文研究零样本图像形变任务，旨在解决现有方法在语义一致性和过渡平滑性上的不足。提出CHIMERA框架，通过自适应缓存注入和语义锚点提示实现结构与语义对齐，并设计形变评估指标GLCS，显著提升形变效果。**

- **链接: [https://arxiv.org/pdf/2512.07155v1](https://arxiv.org/pdf/2512.07155v1)**
...
>
---
#### [new 215] Explainable Melanoma Diagnosis with Contrastive Learning and LLM-based Report Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦皮肤癌诊断中的可解释性问题，提出一种基于对比学习的跨模态框架CEFM，将临床ABC准则与视觉特征对齐，并生成自然语言报告，提升模型透明度与临床可信度。**

- **链接: [https://arxiv.org/pdf/2512.06105v1](https://arxiv.org/pdf/2512.06105v1)**
...
>
---
#### [new 216] Boosting Unsupervised Video Instance Segmentation with Automatic Quality-Guided Self-Training
- **分类: cs.CV**

- **简介: 该论文研究无监督视频实例分割（VIS），旨在解决合成数据到真实数据的域差距问题。提出AutoQ-VIS框架，通过质量引导的自训练闭环系统，实现伪标签生成与自动质量评估，显著提升性能，无需人工标注。**

- **链接: [https://arxiv.org/pdf/2512.06864v1](https://arxiv.org/pdf/2512.06864v1)**
...
>
---
#### [new 217] Scaling Zero-Shot Reference-to-Video Generation
- **分类: cs.CV**

- **简介: 该论文研究参考到视频（R2V）生成任务，旨在解决依赖昂贵标注数据的问题。提出Saber框架，通过无监督方式利用视频-文本对训练，结合掩码策略与注意力设计，实现零样本、可扩展的主体一致视频生成，并提升多参考泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.06905v1](https://arxiv.org/pdf/2512.06905v1)**
...
>
> **备注:** Website: https://franciszzj.github.io/Saber/
>
> **摘要:** Reference-to-video (R2V) generation aims to synthesize videos that align with a text prompt while preserving the subject identity from reference images. However, current R2V methods are hindered by the reliance on explicit reference image-video-text triplets, whose construction is highly expensive and difficult to scale. We bypass this bottleneck by introducing Saber, a scalable zero-shot framework that requires no explicit R2V data. Trained exclusively on video-text pairs, Saber employs a masked training strategy and a tailored attention-based model design to learn identity-consistent and reference-aware representations. Mask augmentation techniques are further integrated to mitigate copy-paste artifacts common in reference-to-video generation. Moreover, Saber demonstrates remarkable generalization capabilities across a varying number of references and achieves superior performance on the OpenS2V-Eval benchmark compared to methods trained with R2V data.
>
---
#### [new 218] Method of UAV Inspection of Photovoltaic Modules Using Thermal and RGB Data Fusion
...
>
---
#### [new 224] RefBench-PRO: Perceptual and Reasoning Oriented Benchmark for Referring Expression Comprehension
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉-语言任务中的指代表达理解（REC）。针对现有基准缺乏对感知与推理能力的细粒度评估问题，提出RefBench-PRO基准，分解为六项子任务，并构建自动化数据生成 pipeline 与新训练方法Ref-R1，实现更全面、可解释的多模态模型评估。**

- **链接: [https://arxiv.org/pdf/2512.06276v1](https://arxiv.org/pdf/2512.06276v1)**
...
>
---
#### [new 227] Clinical Interpretability of Deep Learning Segmentation Through Shapley-Derived Agreement and Uncertainty Metrics
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文聚焦医学图像分割的可解释性，利用Shapley值分析不同MRI对比度对深度学习模型的影响，提出基于Shapley排序的临床一致性与不确定性指标，验证其与模型性能的相关性，提升模型在临床中的可信度与可理解性。**

- **链接: [https://arxiv.org/pdf/2512.07224v1](https://arxiv.org/pdf/2512.07224v1)**
...
>
---
#### [new 228] Estimating Black Carbon Concentration from Urban Traffic Using Vision-Based Machine Learning
- **分类: cs.LG; cs.CV; cs.CY; cs.ET**

- **简介: 该论文提出一种基于视觉的机器学习方法，利用交通监控视频和天气数据估计城市道路黑碳浓度。旨在解决黑碳监测成本高、数据缺失问题，为城市污染治理与环境公平提供支持。**

- **链接: [https://arxiv.org/pdf/2512.06649v1](https://arxiv.org/pdf/2512.06649v1)**
...
>
---
#### [new 229] MIND-V: Hierarchical Video Generation for Long-Horizon Robotic Manipulation with RL-based Physical Alignment
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 230] HalluShift++: Bridging Language and Vision through Internal Representation Shifts for Hierarchical Hallucinations in MLLMs
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 231] Revolutionizing Mixed Precision Quantization: Towards Training-free Automatic Proxy Discovery via Large Language Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究混合精度量化（MPQ）任务，旨在解决传统方法依赖人工设计或昂贵优化的问题。提出一种基于大语言模型的免训练自动代理（TAP）发现框架，结合强化学习优化提示，实现高效、自动的量化策略生成。**

- **链接: [https://arxiv.org/pdf/2512.07419v1](https://arxiv.org/pdf/2512.07419v1)**
...
>
---
#### [new 232] Enhancing Interpretability of AR-SSVEP-Based Motor Intention Recognition via CNN-BiLSTM and SHAP Analysis on EEG Data
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究AR-SSVEP脑机接口中的运动意图识别任务，旨在提升患者康复训练的主动性和系统实用性。提出MACNN-BiLSTM模型并结合SHAP方法，增强模型可解释性，实现高效、可解读的EEG运动意图分类。**

- **链接: [https://arxiv.org/pdf/2512.06730v1](https://arxiv.org/pdf/2512.06730v1)**

> **作者:** Lin Yang; Xiang Li; Xin Ma; Xinxin Zhao
>
> **摘要:** Patients with motor dysfunction show low subjective engagement in rehabilitation training. Traditional SSVEP-based brain-computer interface (BCI) systems rely heavily on external visual stimulus equipment, limiting their practicality in real-world settings. This study proposes an augmented reality steady-state visually evoked potential (AR-SSVEP) system to address the lack of patient initiative and the high workload on therapists. Firstly, we design four HoloLens 2-based EEG classes and collect EEG data from seven healthy subjects for analysis. Secondly, we build upon the conventional CNN-BiLSTM architecture by integrating a multi-head attention mechanism (MACNN-BiLSTM). We extract ten temporal-spectral EEG features and feed them into a CNN to learn high-level representations. Then, we use BiLSTM to model sequential dependencies and apply a multi-head attention mechanism to highlight motor-intention-related patterns. Finally, the SHAP (SHapley Additive exPlanations) method is applied to visualize EEG feature contributions to the neural network's decision-making process, enhancing the model's interpretability. These findings enhance real-time motor intention recognition and support recovery in patients with motor impairments.
>
---
#### [new 233] Semantic Temporal Single-photon LiDAR
- **分类: eess.IV; cs.CV; quant-ph**

- **简介: 该论文研究远距离目标识别任务，针对现有TSP-LiDAR在低信噪比、短采集时间及开放场景下性能差的问题，提出基于自更新语义知识库的语义TSP-LiDAR方法，提升识别鲁棒性与适应性。**

- **链接: [https://arxiv.org/pdf/2512.06008v1](https://arxiv.org/pdf/2512.06008v1)**
...
>
---
#### [new 235] Stronger is not better: Better Augmentations in Contrastive Learning for Medical Image Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文研究医学图像分割中的自监督对比学习，探讨强数据增强的影响。发现现有强增强方法未必提升性能，实验验证了更优的增强策略，表明“更强”不等于“更好”。**

- **链接: [https://arxiv.org/pdf/2512.05992v1](https://arxiv.org/pdf/2512.05992v1)**
...
>
---
#### [new 236] VideoVLA: Video Generators Can Be Generalizable Robot Manipulators
...
>
---
#### [new 237] Mimir: Hierarchical Goal-Driven Diffusion with Uncertainty Propagation for End-to-End Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 238] Vector Quantization using Gaussian Variational Autoencoder
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究图像压缩中的向量量化任务，旨在解决VQ-VAE因离散化导致的训练困难问题。作者提出Gaussian Quant方法，将高斯VAE直接转为VQ-VAE，并设计目标散度约束提升性能，无需额外训练即可实现优异量化效果。**

- **链接: [https://arxiv.org/pdf/2512.06609v1](https://arxiv.org/pdf/2512.06609v1)**
...
>
---
#### [new 239] Dynamic Visual SLAM using a General 3D Prior
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 242] GuideNav: User-Informed Development of a Vision-Only Robotic Navigation Assistant For Blind Travelers
...
>
---
#### [new 243] Financial Fraud Identification and Interpretability Study for Listed Companies Based on Convolutional Neural Network
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究上市公司财务欺诈识别，旨在提升检测准确性与可解释性。提出基于CNN的框架，将面板数据转为类图像输入，实现早期预警；结合局部解释方法，从实体、特征、时间维度分析模型，揭示关键预测因素。**

- **链接: [https://arxiv.org/pdf/2512.06648v1](https://arxiv.org/pdf/2512.06648v1)**
...
>
---
#### [new 244] Task adaptation of Vision-Language-Action model: 1st Place Solution for the 2025 BEHAVIOR Challenge
...
>
---
#### [new 245] Rethinking Robustness: A New Approach to Evaluating Feature Attribution Methods
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究深度神经网络特征归因方法的鲁棒性评估，指出当前指标忽略模型输出变化的问题。提出新的相似输入定义、鲁棒性度量及基于生成对抗网络的输入生成方法，旨在更客观地评估归因方法本身的有效性。**

- **链接: [https://arxiv.org/pdf/2512.06665v1](https://arxiv.org/pdf/2512.06665v1)**

> **作者:** Panagiota Kiourti; Anu Singh; Preeti Duraipandian; Weichao Zhou; Wenchao Li
>
> **摘要:** This paper studies the robustness of feature attribution methods for deep neural networks. It challenges the current notion of attributional robustness that largely ignores the difference in the model's outputs and introduces a new way of evaluating the robustness of attribution methods. Specifically, we propose a new definition of similar inputs, a new robustness metric, and a novel method based on generative adversarial networks to generate these inputs. In addition, we present a comprehensive evaluation with existing metrics and state-of-the-art attribution methods. Our findings highlight the need for a more objective metric that reveals the weaknesses of an attribution method rather than that of the neural network, thus providing a more accurate evaluation of the robustness of attribution methods.
>
---
#### [new 246] A Geometric Unification of Concept Learning with Concept Cones
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文属可解释性AI任务，旨在统一监督式概念瓶颈模型（CBM）与无监督稀疏自编码器（SAE）的概念学习。通过提出“概念锥”几何框架，揭示二者本质相同，仅选锥方式不同，并建立量化指标评估SAE发现概念与人类概念的对齐程度。**

- **链接: [https://arxiv.org/pdf/2512.07355v1](https://arxiv.org/pdf/2512.07355v1)**
...
>
---
#### [new 247] Precise Liver Tumor Segmentation in CT Using a Hybrid Deep Learning-Radiomics Framework
- **分类: eess.IV; cs.CR; cs.CV**

- **简介: 该论文研究肝肿瘤CT图像分割任务，旨在解决肿瘤边界模糊、对比度低导致的分割难题。提出结合注意力级联U-Net、手工放射组学特征与3D CNN的混合框架，实现精准的肝脏及肿瘤联合分割。**

- **链接: [https://arxiv.org/pdf/2512.07574v1](https://arxiv.org/pdf/2512.07574v1)**
...
>
---
#### [new 248] Exploring possible vector systems for faster training of neural networks with preconfigured latent spaces
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究神经网络训练中预设潜在空间向量系统的方法，旨在加速训练并支持超大类别分类。通过构建如An根系等向量系统，优化嵌入分布，实现无分类层的高效训练，减少维度需求，提升收敛速度与存储效率。**

- **链接: [https://arxiv.org/pdf/2512.07509v1](https://arxiv.org/pdf/2512.07509v1)**
...
>
---
#### [new 249] R2MF-Net: A Recurrent Residual Multi-Path Fusion Network for Robust Multi-directional Spine X-ray Segmentation
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属医学图像分割任务，旨在解决多方向脊柱X光片中因低对比度和组织重叠导致的分割难题。提出R2MF-Net网络，通过级联粗细分割、多路径融合与循环残差连接，提升分割鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.07576v1](https://arxiv.org/pdf/2512.07576v1)**
...
>
---
#### [new 250] Arc Gradient Descent: A Mathematically Derived Reformulation of Gradient Descent with Phase-Aware, User-Controlled Step Dynamics
...
>
---
#### [new 251] AquaFusionNet: Lightweight VisionSensor Fusion Framework for Real-Time Pathogen Detection and Water Quality Anomaly Prediction on Edge Devices
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 252] ReLaX: Reasoning with Latent Exploration for Large Reasoning Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究大推理模型的强化学习训练中熵崩溃导致的过早收敛问题。提出ReLaX框架，基于Koopman算子线性化模型隐态动态，引入动态谱分散度量，通过调控隐空间动态优化探索-利用平衡，提升推理性能。**

- **链接: [https://arxiv.org/pdf/2512.07558v1](https://arxiv.org/pdf/2512.07558v1)**
...
>
---
#### [new 253] XM-ALIGN: Unified Cross-Modal Embedding Alignment for Face-Voice Association
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 254] KAN-Dreamer: Benchmarking Kolmogorov-Arnold Networks as Function Approximators in World Models
...
>
---
#### [new 257] Winning the Lottery by Preserving Network Training Dynamics with Concrete Ticket Search
- **分类: cs.LG; cs.AI; cs.CV; cs.NE**

- **简介: 该论文属于神经网络剪枝任务，旨在解决现有彩票发现方法计算成本高或性能差的问题。作者提出Concrete Ticket Search（CTS），通过可微分搜索与梯度平衡机制，高效找到初始化阶段的高性能稀疏子网络，兼顾精度与效率。**

- **链接: [https://arxiv.org/pdf/2512.07142v1](https://arxiv.org/pdf/2512.07142v1)**
...
>
---
#### [new 258] Towards Reliable Test-Time Adaptation: Style Invariance as a Correctness Likelihood
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究测试时自适应（TTA）中的不确定性校准问题，提出SICL框架，利用风格不变性估计样本级预测正确概率。仅通过前向传播实现即插即用的校准，兼容现有TTA方法，显著降低校准误差。**

- **链接: [https://arxiv.org/pdf/2512.07390v1](https://arxiv.org/pdf/2512.07390v1)**
...
>
---
#### [new 259] Affine Subspace Models and Clustering for Patch-Based Image Denoising
- **分类: eess.IV; cs.CV**

- **简介: 该论文研究图像去噪中的块聚类建模问题，指出线性子空间不适于非负图像块的几何结构。提出采用仿射子空间模型更准确描述图像块分布，并设计基于最小二乘投影的简单去噪算法，验证了其在聚类与去噪性能上的提升。**

- **链接: [https://arxiv.org/pdf/2512.07259v1](https://arxiv.org/pdf/2512.07259v1)**
...
>
---
#### [replaced 003] Algorithms Trained on Normal Chest X-rays Can Predict Health Insurance Types
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.11030v4](https://arxiv.org/pdf/2511.11030v4)**

> **作者:** Chi-Yu Chen; Rawan Abulibdeh; Arash Asgari; Sebastián Andrés Cajas Ordóñez; Leo Anthony Celi; Deirdre Goode; Hassan Hamidi; Laleh Seyyed-Kalantari; Ned McCague; Thomas Sounack; Po-Chih Kuo
>
...
>
---
#### [replaced 008] Beyond Words and Pixels: A Benchmark for Implicit World Knowledge Reasoning in Generative Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.18271v2](https://arxiv.org/pdf/2511.18271v2)**
...
>
---
#### [replaced 009] Intra-Class Probabilistic Embeddings for Uncertainty Estimation in Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22019v2](https://arxiv.org/pdf/2511.22019v2)**
...
>
---
#### [replaced 010] VGS-ATD: Robust Distributed Learning for Multi-Label Medical Image Classification Under Heterogeneous and Imbalanced Conditions
- **分类: cs.CV; cs.CR**

- **链接: [https://arxiv.org/pdf/2507.18657v3](https://arxiv.org/pdf/2507.18657v3)**
...
>
---
#### [replaced 011] Iwin Transformer: Hierarchical Vision Transformer using Interleaved Windows
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.18405v2](https://arxiv.org/pdf/2507.18405v2)**

> **作者:** Simin Huo; Ning Li
>
> **备注:** 17 pages, 12 figures, Submitted to IEEE Transactions on Pattern Analysis and Machine Intelligence. Add additional video experiments
>
...
>
---
#### [replaced 012] CORE-3D: Context-aware Open-vocabulary Retrieval by Embeddings in 3D
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.24528v3](https://arxiv.org/pdf/2509.24528v3)**
...
>
---
#### [replaced 017] Towards Explainable Bilingual Multimodal Misinformation Detection and Localization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.22930v2](https://arxiv.org/pdf/2506.22930v2)**
...
>
---
#### [replaced 018] Image-Guided Semantic Pseudo-LiDAR Point Generation for 3D Object Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2409.14985v4](https://arxiv.org/pdf/2409.14985v4)**
...
>
---
#### [replaced 019] Expectation-Maximization as the Engine of Scalable Medical Intelligence
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2501.03410v2](https://arxiv.org/pdf/2501.03410v2)**

> **作者:** Wenxuan Li; Pedro R. A. S. Bassi; Tianyu Lin; Yu-Cheng Chou; Jakob Wasserthal; Xinze Zhou; Qi Chen; Fabian Isensee; Yannick Kirchhoff; Maximilian Rokuss; Saikat Roy; Constantin Ulrich; Klaus Maier-Hein; Szymon Płotka; Xiaoxi Chen; Kang Wang; Yang Yang; Daguang Xu; Kai Ding; Yucheng Tang; Alan L. Yuille; Zongwei Zhou
>
...
>
---
#### [replaced 028] Normalize Filters! Classical Wisdom for Deep Vision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.04401v3](https://arxiv.org/pdf/2506.04401v3)**
...
>
---
#### [replaced 029] Robust brain age estimation from structural MRI with contrastive learning
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.01794v2](https://arxiv.org/pdf/2507.01794v2)**
...
>
---
#### [replaced 030] CountLoop: Training-Free High-Instance Image Generation via Iterative Agent Guidance
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.16644v2](https://arxiv.org/pdf/2508.16644v2)**
...
>
---
#### [replaced 034] D$^{2}$-VPR: A Parameter-efficient Visual-foundation-model-based Visual Place Recognition Method via Knowledge Distillation and Deformable Aggregation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.12528v3](https://arxiv.org/pdf/2511.12528v3)**
...
>
---
#### [replaced 038] MajutsuCity: Language-driven Aesthetic-adaptive City Generation with Controllable 3D Assets and Layouts
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.20415v2](https://arxiv.org/pdf/2511.20415v2)**
...
>
---
#### [replaced 039] Know-Show: Benchmarking Video-Language Models on Spatio-Temporal Grounded Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05513v2](https://arxiv.org/pdf/2512.05513v2)**
...
>
---
#### [replaced 040] Improving Medical Visual Representation Learning with Pathological-level Cross-Modal Alignment and Correlation Exploration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.10573v2](https://arxiv.org/pdf/2506.10573v2)**

> **作者:** Jun Wang; Lixing Zhu; Xiaohan Yu; Abhir Bhalerao; Yulan He
>
> **备注:** Accepted to IEEE Journal of Biomedical and Health Informatics (JBHI).Code: https://github.com/Markin-Wang/PLACE
>
...
>
---
#### [replaced 052] MotionStream: Real-Time Video Generation with Interactive Motion Controls
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.01266v2](https://arxiv.org/pdf/2511.01266v2)**

> **作者:** Joonghyuk Shin; Zhengqi Li; Richard Zhang; Jun-Yan Zhu; Jaesik Park; Eli Shechtman; Xun Huang
>
> **备注:** Project webpage: https://joonghyuk.com/motionstream-web/
>
...
>
---
#### [replaced 053] The Universal Weight Subspace Hypothesis
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05117v2](https://arxiv.org/pdf/2512.05117v2)**
...
>
---
#### [replaced 054] VEIL: Jailbreaking Text-to-Video Models via Visual Exploitation from Implicit Language
- **分类: cs.CV; cs.CR**

- **链接: [https://arxiv.org/pdf/2511.13127v2](https://arxiv.org/pdf/2511.13127v2)**

> **作者:** Zonghao Ying; Moyang Chen; Nizhang Li; Zhiqiang Wang; Wenxin Zhang; Quanchen Zou; Zonglei Jing; Aishan Liu; Xianglong Liu
>
> **摘要:** Jailbreak attacks can circumvent model safety guardrails and reveal critical blind spots. Prior attacks on text-to-video (T2V) models typically add adversarial perturbations to obviously unsafe prompts, which are often easy to detect and defend. In contrast, we show that benign-looking prompts containing rich, implicit cues can induce T2V models to generate semantically unsafe videos that both violate policy and preserve the original (blocked) intent. To realize this, we propose VEIL, a jailbreak framework that leverages T2V models' cross-modal associative patterns via a modular prompt design. Specifically, our prompts combine three components: neutral scene anchors, which provide the surface-level scene description extracted from the blocked intent to maintain plausibility; latent auditory triggers, textual descriptions of innocuous-sounding audio events (e.g., creaking, muffled noises) that exploit learned audio-visual co-occurrence priors to bias the model toward particular unsafe visual concepts; and stylistic modulators, cinematic directives (e.g., camera framing, atmosphere) that amplify and stabilize the latent trigger's effect. We formalize attack generation as a constrained optimization over the above modular prompt space and solve it with a guided search procedure that balances stealth and effectiveness. Extensive experiments over 7 T2V models demonstrate the efficacy of our attack, achieving a 23 percent improvement in average attack success rate in commercial models. Our demos and codes can be found at https://github.com/NY1024/VEIL.
>
---
#### [replaced 055] Tyche: Stochastic In-Context Learning for Medical Image Segmentation
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2401.13650v2](https://arxiv.org/pdf/2401.13650v2)**

> **作者:** Marianne Rakic; Hallee E. Wong; Jose Javier Gonzalez Ortiz; Beth Cimini; John Guttag; Adrian V. Dalca
>
> **备注:** Accepted at IEEE / CVF Computer Vision and Pattern Recognition Conference (CVPR) 2024 as a highlight. Code available at https://github.com/mariannerakic/tyche
>
> **摘要:** Existing learning-based solutions to medical image segmentation have two important shortcomings. First, for most new segmentation task, a new model has to be trained or fine-tuned. This requires extensive resources and machine learning expertise, and is therefore often infeasible for medical researchers and clinicians. Second, most existing segmentation methods produce a single deterministic segmentation mask for a given image. In practice however, there is often considerable uncertainty about what constitutes the correct segmentation, and different expert annotators will often segment the same image differently. We tackle both of these problems with Tyche, a model that uses a context set to generate stochastic predictions for previously unseen tasks without the need to retrain. Tyche differs from other in-context segmentation methods in two important ways. (1) We introduce a novel convolution block architecture that enables interactions among predictions. (2) We introduce in-context test-time augmentation, a new mechanism to provide prediction stochasticity. When combined with appropriate model design and loss functions, Tyche can predict a set of plausible diverse segmentation candidates for new or unseen medical images and segmentation tasks without the need to retrain.
>
---
#### [replaced 056] Roadside Monocular 3D Detection Prompted by 2D Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2404.01064v5](https://arxiv.org/pdf/2404.01064v5)**
...
>
---
#### [replaced 062] HodgeFormer: Transformers for Learnable Operators on Triangular Meshes through Data-Driven Hodge Matrices
- **分类: cs.GR; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.01839v5](https://arxiv.org/pdf/2509.01839v5)**

> **作者:** Akis Nousias; Stavros Nousias
>
> **备注:** 15 pages, 13 figures, 10 tables
>
...
>
---
#### [replaced 063] PosA-VLA: Enhancing Action Generation via Pose-Conditioned Anchor Attention
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 064] Efficient and Scalable Monocular Human-Object Interaction Motion Reconstruction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00960v2](https://arxiv.org/pdf/2512.00960v2)**
...
>
---
#### [replaced 067] PPTArena: A Benchmark for Agentic PowerPoint Editing
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.03042v2](https://arxiv.org/pdf/2512.03042v2)**

> **作者:** Michael Ofengenden; Yunze Man; Ziqi Pang; Yu-Xiong Wang
>
> **备注:** Project webpage: https://ppt-arena.onrender.com/evaluation GitHub: https://github.com/michaelofengend/PPTArena
>
...
>
---
#### [replaced 072] JambaTalk: Speech-Driven 3D Talking Head Generation Based on Hybrid Transformer-Mamba Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2408.01627v3](https://arxiv.org/pdf/2408.01627v3)**
...
>
---
#### [replaced 073] Descrip3D: Enhancing Large Language Model-based 3D Scene Understanding with Object-Level Text Descriptions
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.14555v2](https://arxiv.org/pdf/2507.14555v2)**
...
>
---
#### [replaced 074] Seeing through Imagination: Learning Scene Geometry via Implicit Spatial World Modeling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01821v2](https://arxiv.org/pdf/2512.01821v2)**
...
>
---
#### [replaced 075] MM-ACT: Learn from Multimodal Parallel Generation to Act
- **分类: cs.CV; cs.LG; cs.RO**
...
>
---
#### [replaced 080] A Biophysically-Conditioned Generative Framework for 3D Brain Tumor MRI Synthesis
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.09365v2](https://arxiv.org/pdf/2510.09365v2)**

> **作者:** Valentin Biller; Lucas Zimmer; Ayhan Can Erdur; Sandeep Nagar; Daniel Rückert; Niklas Bubeck; Jonas Weidner
>
...
>
---
#### [replaced 081] MIRAM: Masked Image Autoencoders Across Multiple Scales with Hybrid-Attention Mechanism for Breast Lesion Risk Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.07157v3](https://arxiv.org/pdf/2503.07157v3)**
...
>
---
#### [replaced 082] Structured Initialization for Vision Transformers
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.19985v2](https://arxiv.org/pdf/2505.19985v2)**
...
>
---
#### [replaced 085] FACT-GS: Frequency-Aligned Complexity-Aware Texture Reparameterization for 2D Gaussian Splatting
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2511.23292v2](https://arxiv.org/pdf/2511.23292v2)**
...
>
---
#### [replaced 086] PoSh: Using Scene Graphs To Guide LLMs-as-a-Judge For Detailed Image Descriptions
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 087] Skywork-R1V4: Toward Agentic Multimodal Intelligence through Interleaved Thinking with Images and DeepResearch
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02395v2](https://arxiv.org/pdf/2512.02395v2)**
...
>
---
#### [replaced 088] Image2Net: Datasets, Benchmark and Hybrid Framework to Convert Analog Circuit Diagrams into Netlists
- **分类: cs.AR; cs.AI; cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2508.13157v2](https://arxiv.org/pdf/2508.13157v2)**
...
>
---
#### [replaced 093] Radial Attention: $O(n\log n)$ Sparse Attention with Energy Decay for Long Video Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.19852v2](https://arxiv.org/pdf/2506.19852v2)**
...
>
> **备注:** Accepted to NeurIPS 2025, Code: https://github.com/mit-han-lab/radial-attention
>
...
>
---
#### [replaced 094] Bi-ICE: An Inner Interpretable Framework for Image Classification via Bi-directional Interactions between Concept and Input Embeddings
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2411.18645v2](https://arxiv.org/pdf/2411.18645v2)**
...
>
---
#### [replaced 096] 3DRS: MLLMs Need 3D-Aware Representation Supervision for Scene Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.01946v2](https://arxiv.org/pdf/2506.01946v2)**
...
>
---
#### [replaced 097] Learn the Ropes, Then Trust the Wins: Self-imitation with Progressive Exploration for Agentic Reinforcement Learning
...
>
---
#### [replaced 098] WiseEdit: Benchmarking Cognition- and Creativity-Informed Image Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00387v2](https://arxiv.org/pdf/2512.00387v2)**

> **作者:** Kaihang Pan; Weile Chen; Haiyi Qiu; Qifan Yu; Wendong Bu; Zehan Wang; Yun Zhu; Juncheng Li; Siliang Tang
>
> **备注:** 32 pages, 20 figures. Project Page: https://qnancy.github.io/wiseedit_project_page/. Benchmark: https://huggingface.co/datasets/123123chen/WiseEdit-Benchmark/
>
...
>
---
#### [replaced 099] TEMPLE: Incentivizing Temporal Understanding of Video Large Language Models via Progressive Pre-SFT Alignment
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2503.16929v4](https://arxiv.org/pdf/2503.16929v4)**
...
>
---
#### [replaced 101] Coefficients-Preserving Sampling for Reinforcement Learning with Flow Matching
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.05952v4](https://arxiv.org/pdf/2509.05952v4)**
...
>
---
#### [replaced 102] TRELLISWorld: Training-Free World Generation from Object Generators
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2510.23880v2](https://arxiv.org/pdf/2510.23880v2)**
...
>
---
#### [replaced 103] DCText: Scheduled Attention Masking for Visual Text Generation via Divide-and-Conquer Strategy
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01302v2](https://arxiv.org/pdf/2512.01302v2)**
...
>
---
#### [replaced 104] Griffin: Aerial-Ground Cooperative Detection and Tracking Dataset and Benchmark
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 107] SIGMMA: Hierarchical Graph-Based Multi-Scale Multi-modal Contrastive Alignment of Histopathology Image and Spatial Transcriptome
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.15464v2](https://arxiv.org/pdf/2511.15464v2)**
...
>
---
#### [replaced 110] LAMP: Language-Assisted Motion Planning for Controllable Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.03619v2](https://arxiv.org/pdf/2512.03619v2)**
...
>
---
#### [replaced 116] uCLIP: Parameter-Efficient Multilingual Extension of Vision-Language Models with Unpaired Data
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13036v2](https://arxiv.org/pdf/2511.13036v2)**
...
>
> **摘要:** Contrastive Language-Image Pre-training (CLIP) has demonstrated strong generalization across a wide range of visual tasks by leveraging large-scale English-image pairs. However, its extension to low-resource languages remains limited due to the scarcity of high-quality multilingual image-text data. Existing multilingual vision-language models exhibit consistently low retrieval performance in underrepresented languages including Czech, Finnish, Croatian, Hungarian, and Romanian on the Crossmodal-3600 (XM3600) benchmark. To address this, we propose a lightweight and data-efficient framework for multilingual vision-language alignment. Our approach requires no image-text pairs or text-text pairs and freezes both the pretrained image encoder and multilingual text encoder during training. Only a compact 1.7M-parameter projection module is trained, using a contrastive loss over English representations as semantic anchors. This minimal training setup enables robust multilingual alignment even for languages with limited supervision. Extensive evaluation across multiple multilingual retrieval benchmarks confirms the effectiveness of our method, showing significant gains in five underrepresented languages where existing models typically underperform. These findings highlight the effectiveness of our pivot-based, parameter-efficient alignment strategy for inclusive multimodal learning.
>
---
#### [replaced 117] RDD: Robust Feature Detector and Descriptor using Deformable Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.08013v5](https://arxiv.org/pdf/2505.08013v5)**
...
>
---
#### [replaced 123] Asynchronous Bioplausible Neuron for SNN for Event Vision
- **分类: cs.NE; cs.CV; q-bio.NC**

- **链接: [https://arxiv.org/pdf/2311.11853v3](https://arxiv.org/pdf/2311.11853v3)**

> **作者:** Sanket Kachole; Hussain Sajwani; Fariborz Baghaei Naeini; Dimitrios Makris; Yahya Zweiri
>
> **备注:** 10 pages
>
...
>
---
#### [replaced 124] Towards Resilient Safety-driven Unlearning for Diffusion Models against Downstream Fine-tuning
- **分类: cs.LG; cs.AI; cs.CR; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.16302v2](https://arxiv.org/pdf/2507.16302v2)**
...
>
---
#### [replaced 125] Splannequin: Freezing Monocular Mannequin-Challenge Footage with Dual-Detection Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05113v2](https://arxiv.org/pdf/2512.05113v2)**
...
>
> **摘要:** Synthesizing high-fidelity frozen 3D scenes from monocular Mannequin-Challenge (MC) videos is a unique problem distinct from standard dynamic scene reconstruction. Instead of focusing on modeling motion, our goal is to create a frozen scene while strategically preserving subtle dynamics to enable user-controlled instant selection. To achieve this, we introduce a novel application of dynamic Gaussian splatting: the scene is modeled dynamically, which retains nearby temporal variation, and a static scene is rendered by fixing the model's time parameter. However, under this usage, monocular capture with sparse temporal supervision introduces artifacts like ghosting and blur for Gaussians that become unobserved or occluded at weakly supervised timestamps. We propose Splannequin, an architecture-agnostic regularization that detects two states of Gaussian primitives, hidden and defective, and applies temporal anchoring. Under predominantly forward camera motion, hidden states are anchored to their recent well-observed past states, while defective states are anchored to future states with stronger supervision. Our method integrates into existing dynamic Gaussian pipelines via simple loss terms, requires no architectural changes, and adds zero inference overhead. This results in markedly improved visual quality, enabling high-fidelity, user-selectable frozen-time renderings, validated by a 96% user preference. Project page: https://chien90190.github.io/splannequin/
>
---
#### [replaced 126] MM-SeR: Multimodal Self-Refinement for Lightweight Image Captioning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.21451v3](https://arxiv.org/pdf/2508.21451v3)**
...
>
---
#### [replaced 127] Z-Image: An Efficient Image Generation Foundation Model with Single-Stream Diffusion Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22699v3](https://arxiv.org/pdf/2511.22699v3)**
...
>
---
#### [replaced 128] Towards Cross-View Point Correspondence in Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.04686v2](https://arxiv.org/pdf/2512.04686v2)**
...
>
---
#### [replaced 133] FLAIR: Frequency- and Locality-Aware Implicit Neural Representations
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.13544v4](https://arxiv.org/pdf/2508.13544v4)**
...
>
---
#### [replaced 136] Exploring the Potential of Encoder-free Architectures in 3D LMMs
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 137] EVCtrl: Efficient Control Adapter for Visual Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.10963v2](https://arxiv.org/pdf/2508.10963v2)**
...
>
---
#### [replaced 138] VRSA: Jailbreaking Multimodal Large Language Models through Visual Reasoning Sequential Attack
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05853v2](https://arxiv.org/pdf/2512.05853v2)**
...
>
---
#### [replaced 139] FootFormer: Estimating Stability from Visual Input
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.19170v2](https://arxiv.org/pdf/2510.19170v2)**
...
>
---
#### [replaced 140] X-Scene: Large-Scale Driving Scene Generation with High Fidelity and Flexible Controllability
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.13558v3](https://arxiv.org/pdf/2506.13558v3)**
...
>
---
#### [replaced 141] Breaking the Modality Barrier: Universal Embedding Learning with Multimodal LLMs
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.17432v4](https://arxiv.org/pdf/2504.17432v4)**
...
>
---
#### [replaced 142] TranSplat: Instant Cross-Scene Object Relighting in Gaussian Splatting via Spherical Harmonic Transfer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.22676v3](https://arxiv.org/pdf/2503.22676v3)**
...
>
---
#### [replaced 143] Switch-JustDance: Benchmarking Whole Body Motion Tracking Policies Using a Commercial Console Game
- **分类: cs.RO; cs.CV**
