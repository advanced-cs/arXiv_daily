...
>
---
#### [new 006] Position-Based Flocking for Persistent Alignment without Velocity Sensing
- **分类: cs.RO**

- **简介: 该论文属于群体机器人协同运动任务，旨在解决无速度传感下的持续速度对齐问题。通过位置信息实现 flocking 控制，提升机器人集群的稳定性与一致性。**

- **链接: [https://arxiv.org/pdf/2602.22154v1](https://arxiv.org/pdf/2602.22154v1)**
...
>
---
#### [new 010] DexRepNet++: Learning Dexterous Robotic Manipulation with Geometric and Spatial Hand-Object Representations
- **分类: cs.RO**

- **简介: 该论文属于机器人灵巧操作任务，旨在解决高自由度和复杂接触下的操作问题。提出DexRep表示方法，提升策略泛化能力，并在抓取、翻转和交接任务中验证其有效性。**

- **链接: [https://arxiv.org/pdf/2602.21811v1](https://arxiv.org/pdf/2602.21811v1)**
...
>
---
#### [new 012] Therapist-Robot-Patient Physical Interaction is Worth a Thousand Words: Enabling Intuitive Therapist Guidance via Remote Haptic Control
- **分类: cs.RO; cs.LG**

- **简介: 该论文属于人机交互任务，旨在解决远程康复训练中交互不直观的问题。通过设计触觉遥操作系统，实现治疗师对患者运动的直观引导，提升训练效率与体验。**

- **链接: [https://arxiv.org/pdf/2602.21783v1](https://arxiv.org/pdf/2602.21783v1)**
...
>
---
#### [new 015] Self-Correcting VLA: Online Action Refinement via Sparse World Imagination
...
>
---
#### [new 018] Force Policy: Learning Hybrid Force-Position Control Policy under Interaction Frame for Contact-Rich Manipulation
- **分类: cs.RO**

- **简介: 该论文属于机器人接触操作任务，解决感知与力反馈融合不足的问题。提出Force Policy，结合全局视觉与局部力控，提升接触稳定性与执行质量。**

- **链接: [https://arxiv.org/pdf/2602.22088v1](https://arxiv.org/pdf/2602.22088v1)**
...
>
---
#### [new 024] World Guidance: World Modeling in Condition Space for Action Generation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 025] VLA Knows Its Limits
- **分类: cs.RO**

- **简介: 该论文属于视觉-语言-动作（VLA）模型任务，解决执行范围选择问题。通过分析注意力机制，提出AutoHorizon方法动态调整执行范围，提升模型适应性。**

- **链接: [https://arxiv.org/pdf/2602.21445v1](https://arxiv.org/pdf/2602.21445v1)**

> **作者:** Haoxuan Wang; Gengyu Zhang; Yan Yan; Ramana Rao Kompella; Gaowen Liu
>
> **备注:** Project page at https://hatchetproject.github.io/autohorizon/
>
...
>
---
#### [new 026] Hierarchical LLM-Based Multi-Agent Framework with Prompt Optimization for Multi-Robot Task Planning
- **分类: cs.RO; cs.AI; cs.MA**

- **简介: 该论文属于多机器人任务规划领域，解决自然语言指令到可执行动作的转换问题。提出一种基于大语言模型的分层多智能体框架，结合提示优化提升规划成功率。**

- **链接: [https://arxiv.org/pdf/2602.21670v1](https://arxiv.org/pdf/2602.21670v1)**
...
>
---
#### [new 030] Enhancing Cellular-enabled Collaborative Robots Planning through GNSS data for SAR Scenarios
- **分类: cs.RO; cs.NI**

- **简介: 该论文属于SAR任务，旨在解决机器人在救援中因通信和能耗限制而影响效率的问题。通过引入GNSS数据优化机器人部署与路径规划，提升任务效果。**

- **链接: [https://arxiv.org/pdf/2602.21899v1](https://arxiv.org/pdf/2602.21899v1)**
...
>
---
#### [new 042] The Swarm Intelligence Freeway-Urban Trajectories (SWIFTraj) Dataset - Part II: A Graph-Based Approach for Trajectory Connection
- **分类: physics.soc-ph; cs.RO**

- **简介: 该论文属于轨迹连接任务，解决 UAV 无人机群轨迹连续性与匹配问题。提出图方法实现时间对齐与车辆匹配，提升轨迹连接效果。**

- **链接: [https://arxiv.org/pdf/2602.21954v1](https://arxiv.org/pdf/2602.21954v1)**
...
>
---
#### [new 043] UNet-Based Keypoint Regression for 3D Cone Localization in Autonomous Racing
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 044] Uncertainty-Aware Diffusion Model for Multimodal Highway Trajectory Prediction via DDIM Sampling
...
#### [replaced 001] Heuristic Adaptation of Potentially Misspecified Domain Support for Likelihood-Free Inference in Stochastic Dynamical Systems
- **分类: cs.RO; cs.LG**

- **简介: 该论文属于机器人学中的概率推理任务，旨在解决LFI中先验支持误设导致的后验不准确问题。通过提出三种启发式方法，动态调整支持区域，提升参数推断与策略学习效果。**

- **链接: [https://arxiv.org/pdf/2510.26656v3](https://arxiv.org/pdf/2510.26656v3)**
...
>
---
#### [replaced 002] Toward a Decision Support System for Energy-Efficient Ferry Operation on Lake Constance based on Optimal Control
- **分类: eess.SY; cs.HC; cs.RO**

- **简介: 论文提出一种基于最优控制的决策支持系统，用于提高康斯坦茨湖渡轮的能效运营。解决 inland vessel 操作优化问题，通过数学模型和实时数据提供导航指导。**

- **链接: [https://arxiv.org/pdf/2512.11786v2](https://arxiv.org/pdf/2512.11786v2)**
...
>
> **备注:** 6 pages, 8 figures, parts of this preprint are directly taken from Chapter 6 of the main author's PhD thesis with title "Optimal Control for Efficient Vessel Operation: From Theory to Real-World Applications"
>
...
>
---
#### [replaced 003] Gauss-Newton accelerated MPPI Control
- **分类: eess.SY; cs.RO**

- **简介: 该论文属于控制领域，针对MPPI在高维问题中效率低下的问题，提出Gauss-Newton加速的MPPI方法，提升其计算效率和可扩展性。**

- **链接: [https://arxiv.org/pdf/2512.04579v3](https://arxiv.org/pdf/2512.04579v3)**

> **作者:** Hannes Homburger; Katrin Baumgärtner; Moritz Diehl; Johannes Reuter
>
> **备注:** 6 pages, 3 figures, submitted to the IFAC World Congress 2026, parts of this preprint are directly taken from Chapter 3 of the main author's PhD thesis with title "Optimal Control for Efficient Vessel Operation: From Theory to Real-World Applications"
>
...
>
---
#### [replaced 004] MALLVI: A Multi-Agent Framework for Integrated Generalized Robotics Manipulation
...
>
---
#### [replaced 005] mjlab: A Lightweight Framework for GPU-Accelerated Robot Learning
- **分类: cs.RO**

- **简介: 该论文提出mjlab，一个轻量级的GPU加速机器人学习框架，解决传统环境配置复杂的问题。通过模块化设计和MuJoCo Warp实现高效仿真，支持快速任务开发与测试。**

- **链接: [https://arxiv.org/pdf/2601.22074v2](https://arxiv.org/pdf/2601.22074v2)**

> **作者:** Kevin Zakka; Qiayuan Liao; Brent Yi; Louis Le Lay; Koushil Sreenath; Pieter Abbeel
>
> **备注:** Comments: 11 pages; Code is available at https://github.com/mujocolab/mjlab ; Expanded sensor and domain randomization sections, added references, minor edits
>
...
>
---
#### [replaced 006] Lang2Lift: A Language-Guided Autonomous Forklift System for Outdoor Industrial Pallet Handling
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 007] Perception-Control Coupled Visual Servoing for Textureless Objects Using Keypoint-Based EKF
- **分类: cs.RO**

- **简介: 该论文属于视觉伺服任务，旨在解决纹理缺失物体的定位与控制问题。通过融合关键点检测与EKF，实现鲁棒的6D位姿估计和不确定性感知控制。**

- **链接: [https://arxiv.org/pdf/2602.06834v2](https://arxiv.org/pdf/2602.06834v2)**
...
>
---
#### [replaced 008] Contextual Safety Reasoning and Grounding for Open-World Robots
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于机器人安全任务，解决开放环境中动态安全策略问题。提出CORE框架，通过视觉语言模型进行在线上下文推理和安全约束落地，实现自适应安全控制。**

- **链接: [https://arxiv.org/pdf/2602.19983v2](https://arxiv.org/pdf/2602.19983v2)**
...
>
---
#### [replaced 009] Adaptive Diffusion Constrained Sampling for Bimanual Robot Manipulation
- **分类: cs.RO**

- **简介: 该论文属于双臂机器人操作任务，解决多臂协同操作中高维空间下的几何约束问题。提出ADCS框架，结合能量模型与Transformer架构，实现灵活的约束整合与高效采样。**

- **链接: [https://arxiv.org/pdf/2505.13667v5](https://arxiv.org/pdf/2505.13667v5)**

> **作者:** Haolei Tong; Yuezhe Zhang; Sophie Lueth; Georgia Chalvatzaki
>
> **备注:** Accepted by IEEE International Conference on Robotics and Automation 2026(ICRA 2026)
>
...
>
---
#### [replaced 010] Synthetic vs. Real Training Data for Visual Navigation
- **分类: cs.RO; cs.LG**

- **简介: 该论文研究视觉导航策略在仿真与真实数据训练下的性能对比，解决sim-to-real差距问题。通过预训练视觉表示和实时策略，提升仿真训练模型在真实环境中的表现。**

- **链接: [https://arxiv.org/pdf/2509.11791v2](https://arxiv.org/pdf/2509.11791v2)**

> **作者:** Lauri Suomela; Sasanka Kuruppu Arachchige; German F. Torres; Harry Edelman; Joni-Kristian Kämäräinen
>
> **备注:** ICRA2026 Camera ready
>
...
>
---
#### [replaced 011] Active Tactile Exploration for Rigid Body Pose and Shape Estimation
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，解决未知物体的位姿与形状估计问题。通过触觉数据，提出一种学习与探索框架，实现快速准确的物体建模。**

- **链接: [https://arxiv.org/pdf/2510.13595v2](https://arxiv.org/pdf/2510.13595v2)**

> **作者:** Ethan K. Gordon; Bruke Baraki; Hien Bui; Michael Posa
>
> **备注:** Presented at ICRA 2026; 8 pages, 6 figures
>
...
>
---
#### [replaced 012] World Simulation with Video Foundation Models for Physical AI
...
>
---
#### [replaced 013] MPPI-Generic: A CUDA Library for Stochastic Trajectory Optimization
- **分类: cs.MS; cs.DC; cs.RO; eess.SY**

- **简介: 该论文提出MPPI-Generic库，用于GPU加速的随机轨迹优化。解决传统方法计算效率低的问题，实现多种控制算法的高效应用与扩展。**

- **链接: [https://arxiv.org/pdf/2409.07563v4](https://arxiv.org/pdf/2409.07563v4)**

> **作者:** Bogdan Vlahov; Jason Gibson; Manan Gandhi; Evangelos A. Theodorou
>
> **备注:** Renamed ros2 comparisons to nav2 after feedback. Also added more tests on Jetson Orin Nano in the appendix
>
...
>
---
#### [replaced 014] Dual-Regularized Riccati Recursions for Interior-Point Optimal Control
- **分类: math.OC; cs.MS; cs.RO; eess.SY**

- **简介: 该论文属于最优控制任务，解决非凸约束问题。通过双正则化Riccati递归，改进了内点法，确保每一步为下降方向。**

- **链接: [https://arxiv.org/pdf/2509.16370v5](https://arxiv.org/pdf/2509.16370v5)**
...
>
---
#### [replaced 020] Learning Dexterous Manipulation Skills from Imperfect Simulations
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，解决仿真与现实转移中的接触动力学和触觉反馈问题。通过三阶段框架，提升抓取和拧紧等精细操作的泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.02011v2](https://arxiv.org/pdf/2512.02011v2)**
...
>
---
#### [replaced 021] HetroD: A High-Fidelity Drone Dataset and Benchmark for Autonomous Driving in Heterogeneous Traffic
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 022] A Distributional Treatment of Real2Sim2Real for Object-Centric Agent Adaptation in Vision-Driven Deformable Linear Object Manipulation
- **分类: cs.RO; cs.LG**

- **简介: 该论文研究视觉驱动的可变形线性物体操作问题，通过分布处理实现真实到模拟再到真实的迁移。使用似然自由推断估计物理参数后验，训练对象特定策略，以零样本方式部署于现实环境。**

- **链接: [https://arxiv.org/pdf/2502.18615v3](https://arxiv.org/pdf/2502.18615v3)**
...
>
---
#### [replaced 023] MoMaGen: Generating Demonstrations under Soft and Hard Constraints for Multi-Step Bimanual Mobile Manipulation
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文针对多步骤双臂移动操作任务，解决数据生成中可达性和可视性约束问题，提出MoMaGen框架生成多样化数据集，支持有效模仿学习。**

- **链接: [https://arxiv.org/pdf/2510.18316v4](https://arxiv.org/pdf/2510.18316v4)**
...
>
---
#### [replaced 024] JanusVLN: Decoupling Semantics and Spatiality with Dual Implicit Memory for Vision-Language Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 025] PD-VLA: Accelerating Vision-Language-Action Model Integrated with Action Chunking via Parallel Decoding
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 026] SPACeR: Self-Play Anchoring with Centralized Reference Models
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于自动驾驶任务，旨在解决仿生、高效且可扩展的多智能体行为问题。提出SPACeR框架，结合预训练模型与自博弈强化学习，提升性能并降低计算成本。**

- **链接: [https://arxiv.org/pdf/2510.18060v2](https://arxiv.org/pdf/2510.18060v2)**

> **作者:** Wei-Jer Chang; Akshay Rangesh; Kevin Joseph; Matthew Strong; Masayoshi Tomizuka; Yihan Hu; Wei Zhan
>
> **备注:** Accepted at ICLR 2026. Project page: https://spacer-ai.github.io/
>
...
>
---
#### [replaced 027] Flow-Based Single-Step Completion for Efficient and Expressive Policy Learning
- **分类: cs.LG; cs.RO**

- **简介: 该论文提出SSCP，解决离线强化学习中生成模型采样效率低的问题，通过单步完成策略实现高效且表达能力强的策略学习。**

- **链接: [https://arxiv.org/pdf/2506.21427v3](https://arxiv.org/pdf/2506.21427v3)**
...
>
---
#### [replaced 028] EO-1: An Open Unified Embodied Foundation Model for General Robot Control
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出EO-1模型，解决开放世界中机器人控制与多模态推理问题，通过统一架构和大规模数据实现视觉-文本-动作的联合训练。**

- **链接: [https://arxiv.org/pdf/2508.21112v5](https://arxiv.org/pdf/2508.21112v5)**
...
>
---
#### [replaced 029] ArtVIP: Articulated Digital Assets of Visual Realism, Modular Interaction, and Physical Fidelity for Robot Learning
- **分类: cs.RO**

- **简介: 该论文提出ArtVIP数据集，解决机器人学习中模拟与现实差距问题，提升数字资产的视觉真实性和物理精度，支持更有效的机器人训练。**

- **链接: [https://arxiv.org/pdf/2506.04941v3](https://arxiv.org/pdf/2506.04941v3)**

> **作者:** Zhao Jin; Zhengping Che; Tao Li; Zhen Zhao; Kun Wu; Yuheng Zhang; Yinuo Zhao; Zehui Liu; Qiang Zhang; Xiaozhu Ju; Jing Tian; Yousong Xue; Jian Tang
>
