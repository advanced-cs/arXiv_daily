...
>
---
#### [new 011] AnyTouch 2: General Optical Tactile Representation Learning For Dynamic Tactile Perception
...
>
---
#### [new 020] Design and Evaluation of an Assisted Programming Interface for Behavior Trees in Robotics
- **分类: cs.RO**

- **简介: 该论文属于机器人编程任务，旨在解决如何高效创建行为树的问题。通过结合AI辅助与图形界面，提出BETR-GUI工具，提升用户编程效率与效果。**

- **链接: [https://arxiv.org/pdf/2602.09772v1](https://arxiv.org/pdf/2602.09772v1)**
...
>
---
#### [new 021] Legs Over Arms: On the Predictive Value of Lower-Body Pose for Human Trajectory Prediction from Egocentric Robot Perception
- **分类: cs.RO**

- **简介: 该论文属于人类轨迹预测任务，旨在提升社交机器人在拥挤环境中的导航能力。通过分析下肢姿态和生物力学特征，提高了预测精度。**

- **链接: [https://arxiv.org/pdf/2602.09076v1](https://arxiv.org/pdf/2602.09076v1)**

> **作者:** Nhat Le; Daeun Song; Xuesu Xiao
>
> **备注:** Accepted to IEEE ICRA 2026
>
> **摘要:** Predicting human trajectory is crucial for social robot navigation in crowded environments. While most existing approaches treat human as point mass, we present a study on multi-agent trajectory prediction that leverages different human skeletal features for improved forecast accuracy. In particular, we systematically evaluate the predictive utility of 2D and 3D skeletal keypoints and derived biomechanical cues as additional inputs. Through a comprehensive study on the JRDB dataset and another new dataset for social navigation with 360-degree panoramic videos, we find that focusing on lower-body 3D keypoints yields a 13% reduction in Average Displacement Error and augmenting 3D keypoint inputs with corresponding biomechanical cues provides a further 1-4% improvement. Notably, the performance gain persists when using 2D keypoint inputs extracted from equirectangular panoramic images, indicating that monocular surround vision can capture informative cues for motion forecasting. Our finding that robots can forecast human movement efficiently by watching their legs provides actionable insights for designing sensing capabilities for social robot navigation.
>
---
#### [new 022] TaCo: A Benchmark for Lossless and Lossy Codecs of Heterogeneous Tactile Data
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于 tactile data compression 任务，旨在解决高效压缩问题。通过构建 TaCo 基准，评估多种压缩方法，提出新型数据驱动编解码器，提升任务性能与压缩效率。**

- **链接: [https://arxiv.org/pdf/2602.09893v1](https://arxiv.org/pdf/2602.09893v1)**

> **作者:** Zhengxue Cheng; Yan Zhao; Keyu Wang; Hengdi Zhang; Li Song
>
> **备注:** 27 pages
>
> **摘要:** Tactile sensing is crucial for embodied intelligence, providing fine-grained perception and control in complex environments. However, efficient tactile data compression, which is essential for real-time robotic applications under strict bandwidth constraints, remains underexplored. The inherent heterogeneity and spatiotemporal complexity of tactile data further complicate this challenge. To bridge this gap, we introduce TaCo, the first comprehensive benchmark for Tactile data Codecs. TaCo evaluates 30 compression methods, including off-the-shelf compression algorithms and neural codecs, across five diverse datasets from various sensor types. We systematically assess both lossless and lossy compression schemes on four key tasks: lossless storage, human visualization, material and object classification, and dexterous robotic grasping. Notably, we pioneer the development of data-driven codecs explicitly trained on tactile data, TaCo-LL (lossless) and TaCo-L (lossy). Results have validated the superior performance of our TaCo-LL and TaCo-L. This benchmark provides a foundational framework for understanding the critical trade-offs between compression efficiency and task performance, paving the way for future advances in tactile perception.
>
---
#### [new 023] Humanoid Factors: Design Principles for AI Humanoids in Human Worlds
- **分类: cs.RO**

- **简介: 该论文属于人机交互领域，旨在解决人形机器人与人类共存的设计问题。提出“人形因素”框架，涵盖物理、认知、社交和伦理四方面，以优化人形机器人设计与评估。**

- **链接: [https://arxiv.org/pdf/2602.10069v1](https://arxiv.org/pdf/2602.10069v1)**
...
>
---
#### [new 024] Risk-Aware Obstacle Avoidance Algorithm for Real-Time Applications
- **分类: cs.RO**

- **简介: 该论文属于自主导航任务，解决动态环境中障碍物避让问题。提出一种融合概率建模与轨迹优化的算法，提升航行安全与适应性。**

- **链接: [https://arxiv.org/pdf/2602.09204v1](https://arxiv.org/pdf/2602.09204v1)**
...
>
---
#### [new 025] A Collision-Free Sway Damping Model Predictive Controller for Safe and Reactive Forestry Crane Navigation
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决林业起重机的碰撞避免与负载摆动抑制问题。提出一种统一的模型预测控制器，实现实时环境适应与安全导航。**

- **链接: [https://arxiv.org/pdf/2602.10035v1](https://arxiv.org/pdf/2602.10035v1)**
...
>
---
#### [new 028] RoboSubtaskNet: Temporal Sub-task Segmentation for Human-to-Robot Skill Transfer in Real-World Environments
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出RoboSubtaskNet，解决人机协作中细粒度子任务分割问题，通过多阶段框架实现视频到机器人可执行指令的映射。**

- **链接: [https://arxiv.org/pdf/2602.10015v1](https://arxiv.org/pdf/2602.10015v1)**
...
>
---
#### [new 033] TeleGate: Whole-Body Humanoid Teleoperation via Gated Expert Selection with Motion Prior
- **分类: cs.RO**

- **简介: 该论文提出TeleGate框架，解决人形机器人实时全身遥操作问题，通过门控专家选择和运动先验模块，实现高精度动态动作跟踪。**

- **链接: [https://arxiv.org/pdf/2602.09628v1](https://arxiv.org/pdf/2602.09628v1)**
...
>
---
#### [new 036] Sample-Efficient Real-World Dexterous Policy Fine-Tuning via Action-Chunked Critics and Normalizing Flows
- **分类: cs.RO; cs.LG**

- **简介: 该论文针对真实世界中精细操作策略的微调问题，提出SOFT-FLOW框架，利用归一化流和动作块评论家，提升样本效率与长期信用分配。**

- **链接: [https://arxiv.org/pdf/2602.09580v1](https://arxiv.org/pdf/2602.09580v1)**
...
>
---
#### [new 037] NavDreamer: Video Models as Zero-Shot 3D Navigators
- **分类: cs.RO**

- **简介: 该论文提出NavDreamer，用于3D导航任务，解决数据稀缺和动态建模不足的问题。通过视频模型实现零样本泛化，结合采样优化与逆动力学模型提升导航效果。**

- **链接: [https://arxiv.org/pdf/2602.09765v1](https://arxiv.org/pdf/2602.09765v1)**
...
>
---
#### [new 038] Phase-Aware Policy Learning for Skateboard Riding of Quadruped Robots via Feature-wise Linear Modulation
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决四足机器人滑板骑行中的策略学习问题。通过引入相位感知的强化学习框架，提升控制效果与适应性。**

- **链接: [https://arxiv.org/pdf/2602.09370v1](https://arxiv.org/pdf/2602.09370v1)**
...
>
---
#### [new 042] Data-centric Design of Learning-based Surgical Gaze Perception Models in Multi-Task Simulation
- **分类: cs.RO; cs.HC**

- **简介: 该论文属于手术视觉感知任务，旨在解决专家眼动数据稀缺问题。通过构建多任务眼动数据集，研究不同来源眼动监督对模型性能的影响，探索被动眼动作为替代监督的可行性。**

- **链接: [https://arxiv.org/pdf/2602.09259v1](https://arxiv.org/pdf/2602.09259v1)**
...
>
---
#### [new 043] AutoFly: Vision-Language-Action Model for UAV Autonomous Navigation in the Wild
- **分类: cs.RO**

- **简介: 该论文属于视觉语言导航任务，解决UAV在未知环境中自主导航的问题。提出AutoFly模型，结合视觉、语言和动作，提升导航成功率。**

- **链接: [https://arxiv.org/pdf/2602.09657v1](https://arxiv.org/pdf/2602.09657v1)**
...
>
> **摘要:** Vision-language navigation (VLN) requires intelligent agents to navigate environments by interpreting linguistic instructions alongside visual observations, serving as a cornerstone task in Embodied AI. Current VLN research for unmanned aerial vehicles (UAVs) relies on detailed, pre-specified instructions to guide the UAV along predetermined routes. However, real-world outdoor exploration typically occurs in unknown environments where detailed navigation instructions are unavailable. Instead, only coarse-grained positional or directional guidance can be provided, requiring UAVs to autonomously navigate through continuous planning and obstacle avoidance. To bridge this gap, we propose AutoFly, an end-to-end Vision-Language-Action (VLA) model for autonomous UAV navigation. AutoFly incorporates a pseudo-depth encoder that derives depth-aware features from RGB inputs to enhance spatial reasoning, coupled with a progressive two-stage training strategy that effectively aligns visual, depth, and linguistic representations with action policies. Moreover, existing VLN datasets have fundamental limitations for real-world autonomous navigation, stemming from their heavy reliance on explicit instruction-following over autonomous decision-making and insufficient real-world data. To address these issues, we construct a novel autonomous navigation dataset that shifts the paradigm from instruction-following to autonomous behavior modeling through: (1) trajectory collection emphasizing continuous obstacle avoidance, autonomous planning, and recognition workflows; (2) comprehensive real-world data integration. Experimental results demonstrate that AutoFly achieves a 3.9% higher success rate compared to state-of-the-art VLA baselines, with consistent performance across simulated and real environments.
>
---
#### [new 044] EgoHumanoid: Unlocking In-the-Wild Loco-Manipulation with Robot-Free Egocentric Demonstration
- **分类: cs.RO**

- **简介: 该论文属于人形机器人运动操作任务，解决真实环境中机器人自主操作难题。通过融合人类第一视角数据与少量机器人数据，提升机器人在复杂环境中的操作能力。**

- **链接: [https://arxiv.org/pdf/2602.10106v1](https://arxiv.org/pdf/2602.10106v1)**
...
>
---
#### [new 045] Optimal Control of Microswimmers for Trajectory Tracking Using Bayesian Optimization
- **分类: cs.RO; math.OC**

- **简介: 该论文属于微游泳器轨迹跟踪任务，解决低雷诺数下控制设计复杂的问题。通过贝叶斯优化与B样条参数化结合，实现高效控制策略。**

- **链接: [https://arxiv.org/pdf/2602.09563v1](https://arxiv.org/pdf/2602.09563v1)**

> **作者:** Lucas Palazzolo; Mickaël Binois; Laëtitia Giraldi
>
> **备注:** 16 pages, 16 figures
>
> **摘要:** Trajectory tracking for microswimmers remains a key challenge in microrobotics, where low-Reynolds-number dynamics make control design particularly complex. In this work, we formulate the trajectory tracking problem as an optimal control problem and solve it using a combination of B-spline parametrization with Bayesian optimization, allowing the treatment of high computational costs without requiring complex gradient computations. Applied to a flagellated magnetic swimmer, the proposed method reproduces a variety of target trajectories, including biologically inspired paths observed in experimental studies. We further evaluate the approach on a three-sphere swimmer model, demonstrating that it can adapt to and partially compensate for wall-induced hydrodynamic effects. The proposed optimization strategy can be applied consistently across models of different fidelity, from low-dimensional ODE-based models to high-fidelity PDE-based simulations, showing its robustness and generality. These results highlight the potential of Bayesian optimization as a versatile tool for optimal control strategies in microscale locomotion under complex fluid-structure interactions.
>
---
#### [new 046] Decoupled MPPI-Based Multi-Arm Motion Planning
- **分类: cs.RO**

- **简介: 该论文属于多机械臂运动规划任务，解决多臂协同效率低的问题。通过改进STORM算法，实现分布式规划与动态障碍处理，提升性能。**

- **链接: [https://arxiv.org/pdf/2602.10114v1](https://arxiv.org/pdf/2602.10114v1)**
...
>
---
#### [new 047] Rethinking Visual-Language-Action Model Scaling: Alignment, Mixture, and Regularization
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，研究VLA模型在不同机器人间的泛化问题。通过实验分析了对齐、数据混合和正则化策略，提出提升跨机器人迁移能力的实践方法。**

- **链接: [https://arxiv.org/pdf/2602.09722v1](https://arxiv.org/pdf/2602.09722v1)**
...
>
---
#### [new 048] SAGE: Scalable Agentic 3D Scene Generation for Embodied AI
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 049] LiDAR-based 3D Change Detection at City Scale
...
>
---
#### [new 050] Lateral tracking control of all-wheel steering vehicles with intelligent tires
- **分类: eess.SY; cs.RO**

- **简介: 该论文属于车辆控制任务，解决智能轮胎下全轮转向车辆的横向跟踪问题，通过模型基方法融合轮胎动力学与智能传感技术，实现精准路径跟随与微振抑制。**

- **链接: [https://arxiv.org/pdf/2602.09427v1](https://arxiv.org/pdf/2602.09427v1)**

> **作者:** Luigi Romano; Ole Morten Aamo; Jan Åslund; Erik Frisk
>
> **备注:** 17 pages, 12 figures. Under review at IEEE Transactions on Intelligent Vehicles
>
...
>
---
#### [new 051] First-order friction models with bristle dynamics: lumped and distributed formulations
- **分类: eess.SY; cs.RO**

- **简介: 该论文属于摩擦建模任务，旨在建立更物理可解释的动态摩擦模型。通过引入一阶摩擦模型和分布参数模型，解决传统经验模型可解释性差的问题，并验证其有效性。**

- **链接: [https://arxiv.org/pdf/2602.09429v1](https://arxiv.org/pdf/2602.09429v1)**
...
>
---
#### [new 052] Finite-time Stable Pose Estimation on TSE(3) using Point Cloud and Velocity Sensors
- **分类: eess.SY; cs.RO**

- **简介: 该论文属于姿态估计任务，解决三维刚体运动的实时稳定估计问题。提出一种基于点云和速度传感器的有限时间稳定观测器，无需局部坐标或四元数，避免奇点和展开现象。**

- **链接: [https://arxiv.org/pdf/2602.09414v1](https://arxiv.org/pdf/2602.09414v1)**
...
>
---
#### [new 053] Perception with Guarantees: Certified Pose Estimation via Reachability Analysis
- **分类: cs.CV; cs.RO**
...
#### [replaced 001] UFM: A Simple Path towards Unified Dense Correspondence with Flow
...
>
---
#### [replaced 002] CoLA-Flow Policy: Temporally Coherent Imitation Learning via Continuous Latent Action Flow Matching for Robotic Manipulation
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，旨在解决长时程操作中的行为建模与稳定执行问题。提出LG-Flow Policy，通过连续潜在动作空间的流匹配实现高效、平滑的轨迹模仿学习。**

- **链接: [https://arxiv.org/pdf/2601.23087v2](https://arxiv.org/pdf/2601.23087v2)**

> **作者:** Wu Songwei; Jiang Zhiduo; Xie Guanghu; Sun Wandong; Liu Hong; Liu Yang
>
...
>
---
#### [replaced 003] Simultaneous Calibration of Noise Covariance and Kinematics for State Estimation of Legged Robots via Bi-level Optimization
- **分类: cs.RO; math.OC**

- **简介: 该论文属于机器人状态估计任务，解决噪声协方差和运动学参数未知的问题，通过双层优化框架实现联合校准，提升估计精度。**

- **链接: [https://arxiv.org/pdf/2510.11539v3](https://arxiv.org/pdf/2510.11539v3)**
...
>
---
#### [replaced 004] GenTrack2: An Improved Hybrid Approach for Multi-Object Tracking
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 005] xFLIE: Leveraging Actionable Hierarchical Scene Representations for Autonomous Semantic-Aware Inspection Missions
- **分类: cs.RO**

- **简介: 该论文提出xFLIE框架，解决自主语义感知巡检任务中的路径规划与场景理解问题，通过构建3DLSG实现高效增量式场景表示与导航。**

- **链接: [https://arxiv.org/pdf/2412.19571v3](https://arxiv.org/pdf/2412.19571v3)**
...
>
---
#### [replaced 008] Hoi! -- A Multimodal Dataset for Force-Grounded, Cross-View Articulated Manipulation
- **分类: cs.RO**

- **简介: 该论文提出一个用于力感知、跨视角操作的多模态数据集，解决人机交互理解与迁移问题，涵盖多种操作工具和传感信息。**

- **链接: [https://arxiv.org/pdf/2512.04884v2](https://arxiv.org/pdf/2512.04884v2)**
...
>
---
#### [replaced 009] Toward Efficient and Robust Behavior Models for Multi-Agent Driving Simulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 010] Symmetry-Guided Memory Augmentation for Efficient Locomotion Learning
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于强化学习任务，旨在提升腿部机器人运动学习的训练效率。通过结合对称性和记忆增强，生成有效训练经验，减少环境交互需求。**

- **链接: [https://arxiv.org/pdf/2502.01521v3](https://arxiv.org/pdf/2502.01521v3)**
...
>
---
#### [replaced 013] karl. -- A Research Vehicle for Automated and Connected Driving
- **分类: cs.AR; cs.RO; eess.SY**

- **简介: 该论文介绍了一款用于自动驾驶和车联网研究的实验车辆karl.，旨在解决研究机构缺乏L4级测试平台的问题，通过分享设计与技术细节，提供灵活的研究平台。**

- **链接: [https://arxiv.org/pdf/2602.08842v2](https://arxiv.org/pdf/2602.08842v2)**
...
>
---
#### [replaced 014] Toward Reliable Sim-to-Real Predictability for MoE-based Robust Quadrupedal Locomotion
- **分类: cs.RO**

- **简介: 该论文属于四足机器人运动控制任务，旨在解决sim-to-real迁移和奖励过拟合问题。提出MoE策略与RoboGauge评估框架，提升复杂地形下的运动鲁棒性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.00678v2](https://arxiv.org/pdf/2602.00678v2)**

> **作者:** Tianyang Wu; Hanwei Guo; Yuhang Wang; Junshu Yang; Xinyang Sui; Jiayi Xie; Xingyu Chen; Zeyang Liu; Xuguang Lan
>
> **备注:** fix RoboGauge linear velocity metric, friction error; update radar fig (page 1), score tables (page 6,7); fix obs stack bug
>
...
>
---
#### [replaced 015] Bi-Adapt: Few-shot Bimanual Adaptation for Novel Categories of 3D Objects via Semantic Correspondence
- **分类: cs.RO**

- **简介: 该论文属于机器人双臂操作任务，旨在解决少样本下新类别3D物体的泛化问题。通过语义对应实现高效跨类别操作，使用有限数据进行微调，提升零样本泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.08425v2](https://arxiv.org/pdf/2602.08425v2)**
...
>
---
#### [replaced 016] Going with the Flow: Koopman Behavioral Models as Implicit Planners for Visuo-Motor Dexterity
- **分类: cs.RO**

- **简介: 该论文属于视觉-运动控制任务，旨在解决多指灵巧操作中的动作连贯性与反应性矛盾。提出UBMs框架，通过动态系统建模实现更可靠的行为规划。**

- **链接: [https://arxiv.org/pdf/2602.07413v2](https://arxiv.org/pdf/2602.07413v2)**
...
>
---
#### [replaced 018] RLinf-USER: A Unified and Extensible System for Real-World Online Policy Learning in Embodied AI
- **分类: cs.RO**

- **简介: 该论文提出USER系统，解决真实世界在线策略学习的系统性难题。针对多机器人协作与长周期训练，设计统一硬件抽象和高效通信机制，支持多种算法与模型的灵活部署。**

- **链接: [https://arxiv.org/pdf/2602.07837v2](https://arxiv.org/pdf/2602.07837v2)**
...
>
---
#### [replaced 019] LCLA: Language-Conditioned Latent Alignment for Vision-Language Navigation
- **分类: cs.RO**

- **简介: 该论文属于视觉-语言导航任务，解决如何将感知与控制解耦的问题。通过构建语言条件的潜在对齐框架，实现稳定、泛化的导航策略。**

- **链接: [https://arxiv.org/pdf/2602.07629v2](https://arxiv.org/pdf/2602.07629v2)**
...
>
---
#### [replaced 020] Implicit State Estimation via Video Replanning
- **分类: cs.RO**

- **简介: 该论文属于视频规划任务，旨在解决部分观测环境中不确定性导致的失败适应问题。通过在线更新模型和过滤失败计划，实现隐式状态估计，提升重规划性能。**

- **链接: [https://arxiv.org/pdf/2510.17315v2](https://arxiv.org/pdf/2510.17315v2)**
...
>
---
#### [replaced 022] VDRive: Leveraging Reinforced VLA and Diffusion Policy for End-to-end Autonomous Driving
- **分类: cs.RO**

- **简介: 该论文属于自动驾驶任务，旨在解决动态环境下的状态理解和决策问题。通过结合VLA与扩散策略，构建端到端驾驶系统，提升决策的鲁棒性和可解释性。**

- **链接: [https://arxiv.org/pdf/2510.15446v2](https://arxiv.org/pdf/2510.15446v2)**
...
>
---
#### [replaced 023] Model Predictive Control via Probabilistic Inference: A Tutorial and Survey
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于机器人控制任务，解决如何通过概率推断实现最优控制问题。工作包括教程与综述，分析PI-MPC的设计选择与应用。**

- **链接: [https://arxiv.org/pdf/2511.08019v2](https://arxiv.org/pdf/2511.08019v2)**
