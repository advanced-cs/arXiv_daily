...
- **简介: 该论文属于3D环境生成任务，旨在解决长时空中空间一致性问题。通过结合全景视频生成与动态3D记忆，提升场景的视觉真实感和几何一致性。**
...
- **简介: 该论文属于地理空间推理任务，旨在提升视觉语言模型的地理推理能力。通过结合思维框架和强化学习，Geo-R1在无需人工标注的情况下实现跨模态特征融合与精准预测。**
...
- **简介: 该论文属于视频超分辨率任务，解决长视频处理效率低和时空不连续问题，提出InfVSR方法实现高效可扩展的视频超分辨率。**
...
- **简介: 该论文属于情绪预测任务，旨在用少量EEG通道实现高精度情绪分类。通过转换数据并训练ViT模型，仅用12通道即达到91.57%准确率，优于现有方法。**
...
- **链接: [http://arxiv.org/pdf/2510.01119v1](http://arxiv.org/pdf/2510.01119v1)**
...
- **简介: 该论文提出MathSticks，一个用于视觉符号组合推理的基准任务，解决错误火柴棍方程的修正问题，通过移动火柴棒实现算术一致。**
...
- **简介: 该论文提出PhraseStereo数据集，解决多模态语义分割中立体图像的区域定位问题，通过生成立体图像对和标注，促进语言、视觉与3D感知的联合建模。**
...
- **链接: [http://arxiv.org/pdf/2510.00041v1](http://arxiv.org/pdf/2510.00041v1)**
...
- **简介: 该论文属于教育视频生成任务，解决专业教育视频生成难题。提出Code2Video框架，通过代码控制生成结构化、连贯的教育视频。**
...
- **简介: 该论文属于图像-文本对齐任务，旨在解决多方面人类偏好评估问题。提出MULTI-TAP模型，支持多目标评分，提升评估效率与准确性。**
...
>
---
#### [new 040] Cascaded Diffusion Framework for Probabilistic Coarse-to-Fine Hand Pose Estimation
- **分类: cs.CV**
...
- **简介: 该论文属于自动驾驶中的地图分割任务，旨在提升分割精度与实时性。通过融合摄像头和雷达数据，提出一种高效架构，实现高准确率与低推理时间。**
...
- **简介: 该论文属于图像生成任务，解决AR模型中CFG的引导衰减和过度引导问题。提出SoftCFG，通过不确定性加权引导提升生成质量与稳定性。**
...
- **简介: 该论文属于自监督学习任务，解决从不完整数据中训练重建网络的问题。通过引入等变性与分割损失，实现无监督下的准确重建。**
...
- **简介: 该论文属于遥感图像语义分割任务，旨在解决因灰度变化导致的语义边缘模糊问题。通过结合频域与空域信息，提升边界分割精度。**
...
- **简介: 该论文属于3D风格迁移任务，解决内容保留与艺术风格转换不协调的问题。提出多级动态风格迁移方法，提升风格化效果。**
...
- **简介: 该论文提出OTTER，解决多模态标签任务中固定类别与开放标签的平衡问题。通过融合视觉与文本表示，实现稳定且灵活的多标签分类。**
...
- **简介: 该论文属于人工智能领域，旨在解决大模型中的幻觉问题。通过构建统一框架，分析幻觉成因，提出更有效的应对策略。**
...
- **简介: 该论文属于视频生成任务，解决物理不一致运动问题。提出TrajVLM-Gen框架，结合轨迹预测与视频生成，提升运动合理性。**
...
- **简介: 该论文属于图像处理任务，旨在比较不同颜色模型的性能。研究分析了多种颜色模型，评估其在设备依赖性、色彩一致性和计算复杂性等方面的表现，以找出更符合人类感知的模型。**

- **链接: [http://arxiv.org/pdf/2510.00584v1](http://arxiv.org/pdf/2510.00584v1)**
...
>
---
#### [new 095] Beyond one-hot encoding? Journey into compact encoding for large multi-class segmentation
- **分类: cs.CV; eess.IV**

- **简介: 该论文属于医学图像分割任务，旨在解决多类分割中计算和内存消耗过高的问题。通过研究二进制编码替代独热编码，探索更高效的编码策略。**

- **链接: [http://arxiv.org/pdf/2510.00667v1](http://arxiv.org/pdf/2510.00667v1)**
...
>
---
#### [new 096] PAL-UI: Planning with Active Look-back for Vision-Based GUI Agents
- **分类: cs.CV**

- **简介: 该论文属于GUI代理任务，解决长时序任务中记忆不足的问题。提出PAL-UI框架，通过主动回溯历史视觉信息提升导航性能。**

- **链接: [http://arxiv.org/pdf/2510.00413v1](http://arxiv.org/pdf/2510.00413v1)**
...
>
---
#### [new 099] Survey of AI-Powered Approaches for Osteoporosis Diagnosis in Medical Imaging
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学影像中的AI诊断任务，旨在解决 osteoporosis 早期检测问题。通过综述不同影像技术和AI方法，整合现有研究，提出未来研究方向。**

- **链接: [http://arxiv.org/pdf/2510.00061v1](http://arxiv.org/pdf/2510.00061v1)**
...
>
---
#### [new 102] Batch-CAM: Introduction to better reasoning in convolutional deep learning models
- **分类: cs.AI; cs.CV; 68; I.2; I.4**

- **简介: 该论文属于图像分类任务，旨在提升深度学习模型的可解释性与性能。提出Batch-CAM方法，结合Grad-CAM与重建损失，增强模型对关键特征的关注。**

- **链接: [http://arxiv.org/pdf/2510.00664v1](http://arxiv.org/pdf/2510.00664v1)**
...
>
---
#### [new 108] A Deep Learning Pipeline for Epilepsy Genomic Analysis Using GPT-2 XL and NVIDIA H100
- **分类: q-bio.GN; cs.CV; cs.LG**

- **简介: 该论文属于癫痫基因组分析任务，旨在解决复杂转录组数据解读难题。通过结合GPT-2 XL与NVIDIA H100 GPU，实现高效基因表达模式识别。**

- **链接: [http://arxiv.org/pdf/2510.00392v1](http://arxiv.org/pdf/2510.00392v1)**
...
>
---
#### [new 115] EditTrack: Detecting and Attributing AI-assisted Image Editing
- **分类: cs.CR; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于图像编辑检测与归属任务，解决如何判断可疑图像是否由特定基础图像通过AI模型编辑生成，并识别具体模型。论文提出EditTrack框架，有效提升检测与归属准确性。**

- **链接: [http://arxiv.org/pdf/2510.01173v1](http://arxiv.org/pdf/2510.01173v1)**
...
>
---
#### [new 116] U-DFA: A Unified DINOv2-Unet with Dual Fusion Attention for Multi-Dataset Medical Segmentation
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分割任务，解决CNN与Transformer融合不足及域适应问题。提出U-DFA架构，结合DINOv2与Unet，提升分割性能。**

- **链接: [http://arxiv.org/pdf/2510.00585v1](http://arxiv.org/pdf/2510.00585v1)**
...
>
---
#### [new 117] Enhancing Safety in Diabetic Retinopathy Detection: Uncertainty-Aware Deep Learning Models with Rejection Capabilities
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像诊断任务，旨在解决深度学习模型在糖尿病视网膜病变检测中的不确定性问题，通过引入不确定性感知和拒绝机制提升诊断可靠性。**

- **链接: [http://arxiv.org/pdf/2510.00029v1](http://arxiv.org/pdf/2510.00029v1)**
...
>
---
#### [new 119] Deep Learning-Based Pneumonia Detection from Chest X-ray Images: A CNN Approach with Performance Analysis and Clinical Implications
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于肺炎检测任务，旨在通过CNN提升胸部X光片的肺炎识别精度与速度，解决临床应用中的数据隐私、模型可解释性等问题。**

- **链接: [http://arxiv.org/pdf/2510.00035v1](http://arxiv.org/pdf/2510.00035v1)**
...
>
---
#### [new 125] ReSWD: ReSTIR'd, not shaken. Combining Reservoir Sampling and Sliced Wasserstein Distance for Variance Reduction
- **分类: cs.GR; cs.CV; cs.LG**

- **简介: 该论文属于视觉与图形任务，解决SWD高方差问题，通过结合加权水库采样提升稳定性与效果。**

- **链接: [http://arxiv.org/pdf/2510.01061v1](http://arxiv.org/pdf/2510.01061v1)**

> **作者:** Mark Boss; Andreas Engelhardt; Simon Donné; Varun Jampani
>
> **摘要:** Distribution matching is central to many vision and graphics tasks, where the widely used Wasserstein distance is too costly to compute for high dimensional distributions. The Sliced Wasserstein Distance (SWD) offers a scalable alternative, yet its Monte Carlo estimator suffers from high variance, resulting in noisy gradients and slow convergence. We introduce Reservoir SWD (ReSWD), which integrates Weighted Reservoir Sampling into SWD to adaptively retain informative projection directions in optimization steps, resulting in stable gradients while remaining unbiased. Experiments on synthetic benchmarks and real-world tasks such as color correction and diffusion guidance show that ReSWD consistently outperforms standard SWD and other variance reduction baselines. Project page: https://reservoirswd.github.io/
>
---
#### [new 126] Audio Driven Real-Time Facial Animation for Social Telepresence
...
>
---
#### [new 127] Variable Rate Image Compression via N-Gram Context based Swin-transformer
- **分类: eess.IV; cs.CV; cs.MM**

- **简介: 该论文属于图像压缩任务，解决高分辨率图像重建质量不足的问题。通过引入N-gram上下文增强Swin Transformer，提升压缩效果与ROI质量。**

- **链接: [http://arxiv.org/pdf/2510.00058v1](http://arxiv.org/pdf/2510.00058v1)**
...
>
---
#### [replaced 003] Alternating Training-based Label Smoothing Enhances Prompt Generalization
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.17846v2](http://arxiv.org/pdf/2508.17846v2)**
...
>
---
#### [replaced 004] Editing Physiological Signals in Videos Using Latent Representations
- **分类: cs.CV; cs.HC; cs.MM**

- **链接: [http://arxiv.org/pdf/2509.25348v2](http://arxiv.org/pdf/2509.25348v2)**
...
>
---
#### [replaced 008] v1: Learning to Point Visual Tokens for Multimodal Grounded Reasoning
- **分类: cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18842v3](http://arxiv.org/pdf/2505.18842v3)**
...
- **链接: [http://arxiv.org/pdf/2508.10549v3](http://arxiv.org/pdf/2508.10549v3)**
...
>
---
#### [replaced 010] SeMoBridge: Semantic Modality Bridge for Efficient Few-Shot Adaptation of CLIP
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.26036v2](http://arxiv.org/pdf/2509.26036v2)**
...
>
---
#### [replaced 011] Multi-modal Spatio-Temporal Transformer for High-resolution Land Subsidence Prediction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.25393v2](http://arxiv.org/pdf/2509.25393v2)**
...
>
---
#### [replaced 012] SMaRt: Improving GANs with Score Matching Regularity
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2311.18208v3](http://arxiv.org/pdf/2311.18208v3)**

> **作者:** Mengfei Xia; Yujun Shen; Ceyuan Yang; Ran Yi; Wenping Wang; Yong-Jin Liu
>
...
>
---
#### [replaced 013] HodgeFormer: Transformers for Learnable Operators on Triangular Meshes through Data-Driven Hodge Matrices
- **分类: cs.GR; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.01839v4](http://arxiv.org/pdf/2509.01839v4)**
...
>
---
#### [replaced 014] Dolphin v1.0 Technical Report
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.25748v2](http://arxiv.org/pdf/2509.25748v2)**
...
>
---
#### [replaced 017] DC-Gen: Post-Training Diffusion Acceleration with Deeply Compressed Latent Space
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.25180v2](http://arxiv.org/pdf/2509.25180v2)**
...
>
---
#### [replaced 019] Dressing the Imagination: A Dataset for AI-Powered Translation of Text into Fashion Outfits and A Novel KAN Adapter for Enhanced Feature Adaptation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.13901v3](http://arxiv.org/pdf/2411.13901v3)**
...
>
---
#### [replaced 020] CogVLA: Cognition-Aligned Vision-Language-Action Model via Instruction-Driven Routing & Sparsification
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 021] SafeEraser: Enhancing Safety in Multimodal Large Language Models through Multimodal Machine Unlearning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.12520v5](http://arxiv.org/pdf/2502.12520v5)**
...
>
---
#### [replaced 024] CoFFT: Chain of Foresight-Focus Thought for Visual Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.22010v3](http://arxiv.org/pdf/2509.22010v3)**
...
>
---
#### [replaced 025] Text-to-CT Generation via 3D Latent Diffusion Model with Contrastive Vision-Language Pretraining
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.00633v2](http://arxiv.org/pdf/2506.00633v2)**
...
>
---
#### [replaced 029] Diffusion Model as a Noise-Aware Latent Reward Model for Step-Level Preference Optimization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.01051v4](http://arxiv.org/pdf/2502.01051v4)**
...
>
---
#### [replaced 030] AS400-DET: Detection using Deep Learning Model for IBM i (AS/400)
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.13032v2](http://arxiv.org/pdf/2506.13032v2)**

> **作者:** Thanh Tran; Son T. Luu; Quan Bui; Shoshin Nomura
>
> **备注:** Published at the IVSP 2025 conference
>
...
>
---
#### [replaced 031] Scheduling Weight Transitions for Quantization-Aware Training
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.19248v4](http://arxiv.org/pdf/2404.19248v4)**

> **作者:** Junghyup Lee; Jeimin Jeon; Dohyung Kim; Bumsub Ham
>
> **备注:** Accepted to ICCV 2025
>
...
>
---
#### [replaced 032] ExoPredicator: Learning Abstract Models of Dynamic Worlds for Robot Planning
- **分类: cs.AI; cs.CV; cs.LG**
...
>
---
#### [replaced 033] Image-Difficulty-Aware Evaluation of Super-Resolution Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.26398v2](http://arxiv.org/pdf/2509.26398v2)**
...
>
---
#### [replaced 034] Balancing Multimodal Training Through Game-Theoretic Regularization
- **分类: cs.LG; cs.AI; cs.CV; cs.GT; cs.MM**

- **链接: [http://arxiv.org/pdf/2411.07335v3](http://arxiv.org/pdf/2411.07335v3)**
...
>
---
#### [replaced 038] AgenticIQA: An Agentic Framework for Adaptive and Interpretable Image Quality Assessment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.26006v2](http://arxiv.org/pdf/2509.26006v2)**
...
>
---
#### [replaced 039] Easier Painting Than Thinking: Can Text-to-Image Models Set the Stage, but Not Direct the Play?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.03516v2](http://arxiv.org/pdf/2509.03516v2)**

> **作者:** Ouxiang Li; Yuan Wang; Xinting Hu; Huijuan Huang; Rui Chen; Jiarong Ou; Xin Tao; Pengfei Wan; Xiaojuan Qi; Fuli Feng
>
...
>
---
#### [replaced 040] H3AE: High Compression, High Speed, and High Quality AutoEncoder for Video Diffusion Models
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2504.10567v2](http://arxiv.org/pdf/2504.10567v2)**
...
>
---
#### [replaced 042] Source-Free Domain Adaptive Object Detection with Semantics Compensation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.05557v3](http://arxiv.org/pdf/2410.05557v3)**
...
>
---
#### [replaced 043] Divergence-Based Similarity Function for Multi-View Contrastive Learning
- **分类: cs.CV; cs.LG; 68T07, 62H12; I.2.6; I.4.8; I.5.1**

- **链接: [http://arxiv.org/pdf/2507.06560v2](http://arxiv.org/pdf/2507.06560v2)**
...
>
---
#### [replaced 050] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.24421v2](http://arxiv.org/pdf/2509.24421v2)**
...
>
---
#### [replaced 051] iFinder: Structured Zero-Shot Vision-Based LLM Grounding for Dash-Cam Video Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.19552v2](http://arxiv.org/pdf/2509.19552v2)**
...
>
---
#### [replaced 052] HR-INR: Continuous Space-Time Video Super-Resolution via Event Camera
...
>
---
#### [replaced 053] Combating Noisy Labels via Dynamic Connection Masking
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09697v2](http://arxiv.org/pdf/2508.09697v2)**
...
>
---
#### [replaced 054] PRPO: Paragraph-level Policy Optimization for Vision-Language Deepfake Detection
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.26272v2](http://arxiv.org/pdf/2509.26272v2)**
...
>
---
#### [replaced 058] Dynamic-TreeRPO: Breaking the Independent Trajectory Bottleneck with Structured Sampling
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.23352v2](http://arxiv.org/pdf/2509.23352v2)**

> **作者:** Xiaolong Fu; Lichen Ma; Zipeng Guo; Gaojing Zhou; Chongxiao Wang; ShiPing Dong; Shizhe Zhou; Shizhe Zhou; Ximan Liu; Jingling Fu; Tan Lit Sin; Yu Shi; Zhen Chen; Junshi Huang; Jason Li
>
> **备注:** Fig.3 updated
>
...
>
---
#### [replaced 059] DISCOVER: Data-driven Identification of Sub-activities via Clustering and Visualization for Enhanced Activity Recognition in Smart Homes
- **分类: cs.HC; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.01733v2](http://arxiv.org/pdf/2503.01733v2)**

> **作者:** Alexander Karpekov; Sonia Chernova; Thomas Plötz
>
> **备注:** v1: Initial submission. Under review at IMWUT
>
...
>
---
#### [replaced 064] Breaking Down and Building Up: Mixture of Skill-Based Vision-and-Language Navigation Agents
- **分类: cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07642v2](http://arxiv.org/pdf/2508.07642v2)**
...
>
---
#### [replaced 065] PAN: Pillars-Attention-Based Network for 3D Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.15935v2](http://arxiv.org/pdf/2509.15935v2)**
...
>
---
#### [replaced 066] ATAS: Any-to-Any Self-Distillation for Enhanced Open-Vocabulary Dense Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08678v2](http://arxiv.org/pdf/2506.08678v2)**

> **作者:** Juan Yeo; Soonwoo Cha; Jiwoo Song; Hyunbin Jin; Taesup Kim
>
> **备注:** Accepted at ICCV25
>
...
>
---
#### [replaced 067] ZoDIAC: Zoneout Dropout Injection Attention Calculation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2206.14263v4](http://arxiv.org/pdf/2206.14263v4)**

> **作者:** Zanyar Zohourianshahzadi; Terrance E. Boult; Jugal K. Kalita
>
> **备注:** This work was published at IEEE AIxSET 2024 (DOI: 10.1109/AIxSET62544.2024.00008). Arxiv didn't allow a new submission for the journal version (DOI: 10.1142/S1793351X25440039), so both versions with separate DOIs are merged into one Arxiv entry to reflect the latest journal updates
>
...
>
---
#### [replaced 068] ConciseHint: Boosting Efficient Reasoning via Continuous Concise Hints during Generation
- **分类: cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.18810v3](http://arxiv.org/pdf/2506.18810v3)**
...
>
---
#### [replaced 069] Toward a Robust R2D2 Paradigm for Radio-interferometric Imaging: Revisiting Deep Neural Network Training and Architecture
...
>
---
#### [replaced 072] IC-Custom: Diverse Image Customization via In-Context Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.01926v3](http://arxiv.org/pdf/2507.01926v3)**
...
>
> **备注:** Revised version with improved writing. Project page: https://liyaowei-stu.github.io/project/IC_Custom
>
...
>
---
#### [replaced 077] FakeChain: Exposing Shallow Cues in Multi-Step Deepfake Detection
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.16602v2](http://arxiv.org/pdf/2509.16602v2)**
...
>
---
#### [replaced 078] DreamCS: Geometry-Aware Text-to-3D Generation with Unpaired 3D Reward Supervision
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.09814v2](http://arxiv.org/pdf/2506.09814v2)**
...
>
---
#### [replaced 079] MLLM-CL: Continual Learning for Multimodal Large Language Models
- **分类: cs.CL; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05453v2](http://arxiv.org/pdf/2506.05453v2)**
...
>
---
#### [replaced 080] Are All Marine Species Created Equal? Performance Disparities in Underwater Object Detection
