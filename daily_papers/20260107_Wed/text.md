...
#### [new 001] ModeX: Evaluator-Free Best-of-N Selection for Open-Ended Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出ModeX，解决开放性生成任务中选择高质量输出的问题。通过无评估器的多数投票方法，提升生成质量与效率。**

- **链接: [https://arxiv.org/pdf/2601.02535v1](https://arxiv.org/pdf/2601.02535v1)**
...
>
---
#### [new 002] Automated Semantic Rules Detection (ASRD) for Emergent Communication Interpretation
- **分类: cs.CL**

- **简介: 该论文属于 emergent communication 解释任务，旨在解决自动解析自主代理通信语言的问题。提出ASRD算法，用于提取消息中的语义规则，提升通信可解释性。**

- **链接: [https://arxiv.org/pdf/2601.03254v1](https://arxiv.org/pdf/2601.03254v1)**

> **作者:** Bastien Vanderplaetse; Xavier Siebert; Stéphane Dupont
>
> **摘要:** The field of emergent communication within multi-agent systems examines how autonomous agents can independently develop communication strategies, without explicit programming, and adapt them to varied environments. However, few studies have focused on the interpretability of emergent languages. The research exposed in this paper proposes an Automated Semantic Rules Detection (ASRD) algorithm, which extracts relevant patterns in messages exchanged by agents trained with two different datasets on the Lewis Game, which is often studied in the context of emergent communication. ASRD helps at the interpretation of the emergent communication by relating the extracted patterns to specific attributes of the input data, thereby considerably simplifying subsequent analysis.
>
---
#### [new 003] MedDialogRubrics: A Comprehensive Benchmark and Evaluation Framework for Multi-turn Medical Consultations in Large Language Models
- **分类: cs.CL; cs.HC**

- **简介: 该论文属于医疗对话系统任务，旨在解决医学大模型评估基准不足的问题。构建了MedDialogRubrics基准，包含合成病例和专家标注的评价标准，用于评估模型的多轮诊断能力。**

- **链接: [https://arxiv.org/pdf/2601.03023v1](https://arxiv.org/pdf/2601.03023v1)**
...
>
---
#### [new 004] SYNAPSE: Empowering LLM Agents with Episodic-Semantic Memory via Spreading Activation
- **分类: cs.CL**

- **简介: 该论文提出Synapse架构，解决LLM代理长期记忆的离散性问题。通过动态图模型实现语义记忆，提升复杂时间推理能力。属于自然语言处理中的记忆增强任务。**

- **链接: [https://arxiv.org/pdf/2601.02744v1](https://arxiv.org/pdf/2601.02744v1)**
...
>
---
#### [new 005] MMFormalizer: Multimodal Autoformalization in the Wild
- **分类: cs.CL**

- **简介: 该论文提出MMFormalizer，解决多模态自动形式化问题，将自然语言数学转化为形式化陈述，融合视觉与物理约束，提升机器推理能力。**

- **链接: [https://arxiv.org/pdf/2601.03017v1](https://arxiv.org/pdf/2601.03017v1)**
...
>
---
#### [new 006] Transparent Semantic Change Detection with Dependency-Based Profiles
- **分类: cs.CL**

- **简介: 该论文属于词汇语义变化检测任务，旨在解决传统方法透明度不足的问题。通过依赖关系共现模式进行语义变化检测，效果优于部分分布模型。**

- **链接: [https://arxiv.org/pdf/2601.02891v1](https://arxiv.org/pdf/2601.02891v1)**
...
>
---
#### [new 007] Revisiting Data Compression with Language Modeling
- **分类: cs.CL**

- **简介: 该论文研究将大语言模型用于数据压缩任务，旨在提升压缩率并解决实际应用中的挑战。工作包括优化模型配置，实现更优压缩效果，并验证其在多种数据类型上的适用性。**

- **链接: [https://arxiv.org/pdf/2601.02875v1](https://arxiv.org/pdf/2601.02875v1)**

> **作者:** Chen-Han Tsai
>
> **备注:** Preprint
>
> **摘要:** In this report, we investigate the potential use of large language models (LLM's) in the task of data compression. Previous works have demonstrated promising results in applying LLM's towards compressing not only text, but also a wide range of multi-modal data. Despite the favorable performance achieved, there still remains several practical questions that pose a challenge towards replacing existing data compression algorithms with LLM's. In this work, we explore different methods to achieve a lower adjusted compression rate using LLM's as data compressors. In comparison to previous works, we were able to achieve a new state-of-the-art (SOTA) adjusted compression rate of around $18\%$ on the enwik9 dataset without additional model training. Furthermore, we explore the use of LLM's in compressing non-English data, code data, byte stream sequences. We show that while LLM's excel in compressing data in text-dominant domains, their ability in compressing non-natural text sequences still remain competitive if configured in the right way.
>
---
#### [new 008] LongBench Pro: A More Realistic and Comprehensive Bilingual Long-Context Evaluation Benchmark
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出LongBench Pro，一个更真实、全面的双语长上下文评估基准，解决现有基准在可扩展性与真实性间的平衡问题。**

- **链接: [https://arxiv.org/pdf/2601.02872v1](https://arxiv.org/pdf/2601.02872v1)**

> **作者:** Ziyang Chen; Xing Wu; Junlong Jia; Chaochen Gao; Qi Fu; Debing Zhang; Songlin Hu
>
> **摘要:** The rapid expansion of context length in large language models (LLMs) has outpaced existing evaluation benchmarks. Current long-context benchmarks often trade off scalability and realism: synthetic tasks underrepresent real-world complexity, while fully manual annotation is costly to scale to extreme lengths and diverse scenarios. We present LongBench Pro, a more realistic and comprehensive bilingual benchmark of 1,500 naturally occurring long-context samples in English and Chinese spanning 11 primary tasks and 25 secondary tasks, with input lengths from 8k to 256k tokens. LongBench Pro supports fine-grained analysis with task-specific metrics and a multi-dimensional taxonomy of context requirement (full vs. partial dependency), length (six levels), and difficulty (four levels calibrated by model performance). To balance quality with scalability, we propose a Human-Model Collaborative Construction pipeline: frontier LLMs draft challenging questions and reference answers, along with design rationales and solution processes, to reduce the cost of expert verification. Experts then rigorously validate correctness and refine problematic cases. Evaluating 46 widely used long-context LLMs on LongBench Pro yields three findings: (1) long-context optimization contributes more to long-context comprehension than parameter scaling; (2) effective context length is typically shorter than the claimed context length, with pronounced cross-lingual misalignment; and (3) the "thinking" paradigm helps primarily models trained with native reasoning, while mixed-thinking designs offer a promising Pareto trade-off. In summary, LongBench Pro provides a robust testbed for advancing long-context understanding.
>
---
#### [new 009] Extracting books from production language models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于模型安全任务，研究生产级大语言模型是否可能提取训练数据。通过实验验证了在特定条件下，可从模型输出中提取受版权保护的文本，揭示了模型存在数据泄露风险。**

- **链接: [https://arxiv.org/pdf/2601.02671v1](https://arxiv.org/pdf/2601.02671v1)**
...
>
---
#### [new 010] Lil: Less is Less When Applying Post-Training Sparse-Attention Algorithms in Long-Decode Stage
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，针对长解码阶段的推理效率问题，提出稀疏注意力算法导致信息丢失进而增加复杂度的现象，并设计早停算法优化性能。**

- **链接: [https://arxiv.org/pdf/2601.03043v1](https://arxiv.org/pdf/2601.03043v1)**
...
>
---
#### [new 011] When Do Tools and Planning Help LLMs Think? A Cost- and Latency-Aware Benchmark
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究LLMs在事件问答和Reddit说服性回复任务中使用工具和规划的效果，评估不同配置的准确性与延迟，探讨模型规模与工具复杂性的权衡。**

- **链接: [https://arxiv.org/pdf/2601.02663v1](https://arxiv.org/pdf/2601.02663v1)**
...
>
---
#### [new 015] UltraLogic: Enhancing LLM Reasoning through Large-Scale Data Synthesis and Bipolar Float Reward
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM在复杂推理中的瓶颈问题。通过构建大规模数据集和引入BFR机制，提升模型的逻辑推理能力。**

- **链接: [https://arxiv.org/pdf/2601.03205v1](https://arxiv.org/pdf/2601.03205v1)**
...
>
> **摘要:** While Large Language Models (LLMs) have demonstrated significant potential in natural language processing , complex general-purpose reasoning requiring multi-step logic, planning, and verification remains a critical bottleneck. Although Reinforcement Learning with Verifiable Rewards (RLVR) has succeeded in specific domains , the field lacks large-scale, high-quality, and difficulty-calibrated data for general reasoning. To address this, we propose UltraLogic, a framework that decouples the logical core of a problem from its natural language expression through a Code-based Solving methodology to automate high-quality data production. The framework comprises hundreds of unique task types and an automated calibration pipeline across ten difficulty levels. Furthermore, to mitigate binary reward sparsity and the Non-negative Reward Trap, we introduce the Bipolar Float Reward (BFR) mechanism, utilizing graded penalties to effectively distinguish perfect responses from those with logical flaws. Our experiments demonstrate that task diversity is the primary driver for reasoning enhancement , and that BFR, combined with a difficulty matching strategy, significantly improves training efficiency, guiding models toward global logical optima.
>
---
#### [new 016] Image, Word and Thought: A More Challenging Language Task for the Iterated Learning Model
- **分类: cs.CL; cs.LG; cs.MA**

- **简介: 该论文属于语言习得任务，探讨语言结构在代际传递中的形成。研究通过改进的半监督迭代学习模型，解决复杂意义表达问题，成功实现对七段显示器图像的准确、组合和稳定语言传输。**

- **链接: [https://arxiv.org/pdf/2601.02911v1](https://arxiv.org/pdf/2601.02911v1)**
...
>
---
#### [new 017] Window-based Membership Inference Attacks Against Fine-tuned Large Language Models
- **分类: cs.CL; cs.AI; cs.CR**

- **简介: 该论文属于隐私安全任务，旨在解决细调大语言模型中的成员推理问题。通过局部窗口比较方法，提升攻击效果，揭示模型隐私漏洞。**

- **链接: [https://arxiv.org/pdf/2601.02751v1](https://arxiv.org/pdf/2601.02751v1)**

> **作者:** Yuetian Chen; Yuntao Du; Kaiyuan Zhang; Ashish Kundu; Charles Fleming; Bruno Ribeiro; Ninghui Li
>
> **备注:** Code is available at [https://github.com/Stry233/WBC/](https://github.com/Stry233/WBC/). This arXiv version corresponds to the accepted paper and includes the full experimental results
>
...
>
---
#### [new 018] MiMo-V2-Flash Technical Report
- **分类: cs.CL; cs.AI**

- **简介: 该论文介绍了一种名为MiMo-V2-Flash的Mixture-of-Experts模型，旨在提升推理与代理能力。针对大模型参数量大、效率低的问题，提出混合注意力机制和多教师在线蒸馏方法，实现高效推理与性能优化。**

- **链接: [https://arxiv.org/pdf/2601.02780v1](https://arxiv.org/pdf/2601.02780v1)**
...
>
---
#### [new 019] Low-Resource Heuristics for Bahnaric Optical Character Recognition Improvement
...
>
---
#### [new 020] Learning to Diagnose and Correct Moral Errors: Towards Enhancing Moral Sensitivity in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于道德感知任务，旨在提升大语言模型的道德敏感性。通过提出两种推理方法，帮助模型识别并纠正道德错误。**

- **链接: [https://arxiv.org/pdf/2601.03079v1](https://arxiv.org/pdf/2601.03079v1)**
...
>
---
#### [new 021] LLM-Augmented Changepoint Detection: A Framework for Ensemble Detection and Automated Explanation
- **分类: cs.CL**

- **简介: 该论文属于时间序列分析任务，旨在解决 changepoint 检测的准确性与解释性问题。通过集成多种方法并结合 LLM 生成解释，提升检测效果与可理解性。**

- **链接: [https://arxiv.org/pdf/2601.02957v1](https://arxiv.org/pdf/2601.02957v1)**
...
>
---
#### [new 022] EvoRoute: Experience-Driven Self-Routing LLM Agent Systems
- **分类: cs.CL; cs.MA**

- **简介: 该论文属于智能代理系统任务，解决高成本与高延迟的问题。提出EvoRoute动态选择最优模型，平衡性能、成本与效率。**

- **链接: [https://arxiv.org/pdf/2601.02695v1](https://arxiv.org/pdf/2601.02695v1)**

> **作者:** Guibin Zhang; Haiyang Yu; Kaiming Yang; Bingli Wu; Fei Huang; Yongbin Li; Shuicheng Yan
>
> **摘要:** Complex agentic AI systems, powered by a coordinated ensemble of Large Language Models (LLMs), tool and memory modules, have demonstrated remarkable capabilities on intricate, multi-turn tasks. However, this success is shadowed by prohibitive economic costs and severe latency, exposing a critical, yet underexplored, trade-off. We formalize this challenge as the \textbf{Agent System Trilemma}: the inherent tension among achieving state-of-the-art performance, minimizing monetary cost, and ensuring rapid task completion. To dismantle this trilemma, we introduce EvoRoute, a self-evolving model routing paradigm that transcends static, pre-defined model assignments. Leveraging an ever-expanding knowledge base of prior experience, EvoRoute dynamically selects Pareto-optimal LLM backbones at each step, balancing accuracy, efficiency, and resource use, while continually refining its own selection policy through environment feedback. Experiments on challenging agentic benchmarks such as GAIA and BrowseComp+ demonstrate that EvoRoute, when integrated into off-the-shelf agentic systems, not only sustains or enhances system performance but also reduces execution cost by up to $80\%$ and latency by over $70\%$.
>
---
#### [new 023] Enhancing Multilingual RAG Systems with Debiased Language Preference-Guided Query Fusion
- **分类: cs.CL**

- **简介: 该论文属于多语言检索增强生成任务，旨在解决mRAG系统对英语的偏好问题。通过消除评估偏差，提出DELTA框架，提升跨语言检索与生成效果。**

- **链接: [https://arxiv.org/pdf/2601.02956v1](https://arxiv.org/pdf/2601.02956v1)**
...
>
---
#### [new 024] X-MuTeST: A Multilingual Benchmark for Explainable Hate Speech Detection and A Novel LLM-consulted Explanation Framework
- **分类: cs.CL**

- **简介: 该论文属于仇恨语言检测任务，解决多语言下准确性和可解释性问题。通过结合大模型与传统方法，构建多语言基准数据集并提出可解释框架。**

- **链接: [https://arxiv.org/pdf/2601.03194v1](https://arxiv.org/pdf/2601.03194v1)**
...
>
> **摘要:** Hate speech detection on social media faces challenges in both accuracy and explainability, especially for underexplored Indic languages. We propose a novel explainability-guided training framework, X-MuTeST (eXplainable Multilingual haTe Speech deTection), for hate speech detection that combines high-level semantic reasoning from large language models (LLMs) with traditional attention-enhancing techniques. We extend this research to Hindi and Telugu alongside English by providing benchmark human-annotated rationales for each word to justify the assigned class label. The X-MuTeST explainability method computes the difference between the prediction probabilities of the original text and those of unigrams, bigrams, and trigrams. Final explanations are computed as the union between LLM explanations and X-MuTeST explanations. We show that leveraging human rationales during training enhances both classification performance and explainability. Moreover, combining human rationales with our explainability method to refine the model attention yields further improvements. We evaluate explainability using Plausibility metrics such as Token-F1 and IOU-F1 and Faithfulness metrics such as Comprehensiveness and Sufficiency. By focusing on under-resourced languages, our work advances hate speech detection across diverse linguistic contexts. Our dataset includes token-level rationale annotations for 6,004 Hindi, 4,492 Telugu, and 6,334 English samples. Data and code are available on https://github.com/ziarehman30/X-MuTeST
>
---
#### [new 025] EComStage: Stage-wise and Orientation-specific Benchmarking for Large Language Models in E-commerce
- **分类: cs.CL**

- **简介: 该论文提出EComStage，用于评估大语言模型在电商中的多阶段推理能力，解决现有基准仅关注最终任务的问题。工作包括设计多任务评测框架，覆盖用户与商家场景，分析模型优劣。**

- **链接: [https://arxiv.org/pdf/2601.02752v1](https://arxiv.org/pdf/2601.02752v1)**
...
>
---
#### [new 026] Temporal Graph Network: Hallucination Detection in Multi-Turn Conversation
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于对话系统中的幻觉检测任务，旨在解决多轮对话中因上下文变化导致的幻觉问题。通过构建时序图模型，结合实体和时间边进行信息传递，提升幻觉检测效果。**

- **链接: [https://arxiv.org/pdf/2601.03051v1](https://arxiv.org/pdf/2601.03051v1)**
...
>
---
#### [new 027] Large Reasoning Models Are (Not Yet) Multilingual Latent Reasoners
- **分类: cs.CL**

- **简介: 该论文研究多语言大推理模型的隐式推理能力，探讨其在不同语言中的表现差异。任务为分析模型内部推理机制，解决其是否具备跨语言隐式推理的问题。工作包括实验与表征分析。**

- **链接: [https://arxiv.org/pdf/2601.02996v1](https://arxiv.org/pdf/2601.02996v1)**
...
>
---
#### [new 028] WearVox: An Egocentric Multichannel Voice Assistant Benchmark for Wearables
...
>
---
#### [new 029] Reliability-Aware Adaptive Self-Consistency for Efficient Sampling in LLM Reasoning
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于大模型推理任务，解决自一致性方法计算成本高的问题。提出ReASC方法，通过置信度评估实现更高效的采样与信息聚合。**

- **链接: [https://arxiv.org/pdf/2601.02970v1](https://arxiv.org/pdf/2601.02970v1)**
...
>
---
#### [new 030] Losses that Cook: Topological Optimal Transport for Structured Recipe Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于烹饪配方生成任务，旨在提升配方的准确性与一致性。通过引入拓扑损失和组合目标函数，优化食材与步骤的生成效果。**

- **链接: [https://arxiv.org/pdf/2601.02531v1](https://arxiv.org/pdf/2601.02531v1)**
...
>
---
#### [new 034] Correct, Concise and Complete: Multi-stage Training For Adaptive Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的推理任务，旨在解决大模型推理过程中“过度思考”导致的冗长和性能下降问题。通过多阶段训练方法提升推理效率与准确性。**

- **链接: [https://arxiv.org/pdf/2601.02972v1](https://arxiv.org/pdf/2601.02972v1)**

> **作者:** Nathanaël Carraz Rakotonirina; Ren Pang; Neha Anna John; Michael Bohlke-Schneider; Momchil Hardalov
>
> **摘要:** The reasoning capabilities of large language models (LLMs) have improved substantially through increased test-time computation, typically in the form of intermediate tokens known as chain-of-thought (CoT). However, CoT often becomes unnecessarily long, increasing computation cost without actual accuracy gains or sometimes even degrading performance, a phenomenon known as ``overthinking''. We propose a multi-stage efficient reasoning method that combines supervised fine-tuning -- via rejection sampling or reasoning trace reformatting -- with reinforcement learning using an adaptive length penalty. We introduce a lightweight reward function that penalizes tokens generated after the first correct answer but encouraging self-verification only when beneficial. We conduct a holistic evaluation across seven diverse reasoning tasks, analyzing the accuracy-response length trade-off. Our approach reduces response length by an average of 28\% for 8B models and 40\% for 32B models, while incurring only minor performance drops of 1.6 and 2.5 points, respectively. Despite its conceptual simplicity, it achieves a superior trade-off compared to more complex state-of-the-art efficient reasoning methods, scoring 76.6, in terms of the area under the Overthinking-Adjusted Accuracy curve ($\text{AUC}_{\text{OAA}}$) -- 5 points above the base model and 2.5 points above the second-best approach.
>
---
#### [new 035] The performances of the Chinese and U.S. Large Language Models on the Topic of Chinese Culture
- **分类: cs.CL**

- **简介: 该论文属于跨文化语言模型评估任务，旨在比较中美国别大模型在中文文化主题上的表现差异，通过直接提问方式分析其对传统文化的理解能力。**

- **链接: [https://arxiv.org/pdf/2601.02830v1](https://arxiv.org/pdf/2601.02830v1)**
...
>
---
#### [new 036] TiMem: Temporal-Hierarchical Memory Consolidation for Long-Horizon Conversational Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出TiMem框架，解决长周期对话代理的记忆管理问题。通过时间层次结构组织对话，实现高效记忆整合与召回。**

- **链接: [https://arxiv.org/pdf/2601.02845v1](https://arxiv.org/pdf/2601.02845v1)**
...
>
---
#### [new 037] Pearmut: Human Evaluation of Translation Made Trivial
- **分类: cs.CL; cs.HC**

- **简介: 该论文提出Pearmut，解决机器翻译中人工评估难的问题，提供轻量易用的平台，支持多语言任务，提升评估效率与可靠性。**

- **链接: [https://arxiv.org/pdf/2601.02933v1](https://arxiv.org/pdf/2601.02933v1)**
...
>
---
#### [new 042] P-Check: Advancing Personalized Reward Model via Learning to Generate Dynamic Checklist
- **分类: cs.CL**

- **简介: 该论文属于个性化奖励建模任务，旨在解决用户判断动态性与多维性问题。提出P-Check框架，通过生成动态检查清单提升奖励预测准确性。**

- **链接: [https://arxiv.org/pdf/2601.02986v1](https://arxiv.org/pdf/2601.02986v1)**
...
>
---
#### [new 043] Can Embedding Similarity Predict Cross-Lingual Transfer? A Systematic Study on African Languages
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究跨语言迁移在低资源非洲语言中的应用，解决如何选择有效源语言的问题。通过实验评估多种嵌入相似性指标，发现部分指标能可靠预测迁移效果。**

- **链接: [https://arxiv.org/pdf/2601.03168v1](https://arxiv.org/pdf/2601.03168v1)**
...
>
---
#### [new 044] Improving Indigenous Language Machine Translation with Synthetic Data and Language-Specific Preprocessing
- **分类: cs.CL**

- **简介: 该论文属于机器翻译任务，旨在解决低资源原住民语言翻译问题。通过合成数据和语言特定预处理提升翻译质量。**

- **链接: [https://arxiv.org/pdf/2601.03135v1](https://arxiv.org/pdf/2601.03135v1)**
...
>
---
#### [new 045] Do LLMs Encode Functional Importance of Reasoning Tokens?
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究大语言模型是否编码推理标记的功能重要性。任务是理解模型内部如何处理推理过程，解决如何有效压缩推理链的问题。工作包括提出贪心剪枝方法，验证其有效性并分析注意力机制的作用。**

- **链接: [https://arxiv.org/pdf/2601.03066v1](https://arxiv.org/pdf/2601.03066v1)**
...
>
---
#### [new 046] Memorization, Emergence, and Explaining Reversal Failures: A Controlled Study of Relational Semantics in LLMs
- **分类: cs.CL**

- **简介: 该论文研究语言模型在关系语义上的表现，解决其是否理解逻辑关系及反转失败原因。通过构建知识图谱框架训练模型，分析记忆、推理和泛化能力，发现反转失败主要由顺序偏差引起。**

- **链接: [https://arxiv.org/pdf/2601.02931v1](https://arxiv.org/pdf/2601.02931v1)**
...
>
---
#### [new 047] Discovering and Causally Validating Emotion-Sensitive Neurons in Large Audio-Language Models
- **分类: cs.CL; eess.AS**
...
>
---
#### [new 048] Training Language Models with homotokens Leads to Delayed Overfitting
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型过拟合问题。通过引入同形词（homotokens）进行数据增强，提升模型泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.02867v1](https://arxiv.org/pdf/2601.02867v1)**
...
>
---
#### [new 054] FlowPlan-G2P: A Structured Generation Framework for Transforming Scientific Papers into Patent Descriptions
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于将科学论文转换为专利描述的任务，旨在解决结构和法律合规问题。提出FlowPlan-G2P框架，分三阶段生成逻辑清晰、合法的专利文本。**

- **链接: [https://arxiv.org/pdf/2601.02589v1](https://arxiv.org/pdf/2601.02589v1)**
...
>
---
#### [new 055] Grad-ELLM: Gradient-based Explanations for Decoder-only LLMs
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理领域，旨在提升解码器型大语言模型的可解释性。针对现有方法缺乏对Transformer架构的针对性问题，提出Grad-ELLM方法，通过梯度和注意力图生成热图，提高解释的可信度。**

- **链接: [https://arxiv.org/pdf/2601.03089v1](https://arxiv.org/pdf/2601.03089v1)**
...
>
---
#### [new 058] Towards Comprehensive Stage-wise Benchmarking of Large Language Models in Fact-Checking
- **分类: cs.CL**

- **简介: 该论文属于事实核查任务，旨在解决现有评估仅关注声明验证而忽略完整流程的问题。工作包括提出FactArena框架，实现全面的阶段式评测。**

- **链接: [https://arxiv.org/pdf/2601.02669v1](https://arxiv.org/pdf/2601.02669v1)**
...
>
---
#### [new 062] Linear Script Representations in Speech Foundation Models Enable Zero-Shot Transliteration
- **分类: cs.CL**

- **简介: 该论文属于语音识别任务，解决多语言模型中因不同书写系统导致的输出不确定性问题。通过在激活空间中线性编码脚本信息，实现对识别结果脚本的零样本控制。**

- **链接: [https://arxiv.org/pdf/2601.02906v1](https://arxiv.org/pdf/2601.02906v1)**
...
>
---
#### [new 064] Stable-RAG: Mitigating Retrieval-Permutation-Induced Hallucinations in Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于问答任务，解决RAG模型在文档排列变化下的幻觉问题。通过稳定生成过程，提升答案准确性和一致性。**

- **链接: [https://arxiv.org/pdf/2601.02993v1](https://arxiv.org/pdf/2601.02993v1)**
...
>
---
#### [new 067] To Generate or Discriminate? Methodological Considerations for Measuring Cultural Alignment in LLMs
- **分类: cs.CL**

- **简介: 该论文属于文化对齐评估任务，旨在解决SDP方法的偏差与任务设计混淆问题。通过ISDP方法测试LLMs在真实与模拟行为上的表现，分析其文化理解能力及个性化限制。**

- **链接: [https://arxiv.org/pdf/2601.02858v1](https://arxiv.org/pdf/2601.02858v1)**
...
>
---
#### [new 073] Dementia-R1: Reinforced Pretraining and Reasoning from Unstructured Clinical Notes for Real-World Dementia Prognosis
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于医疗文本理解任务，旨在解决 dementia 预测问题。通过强化学习框架 Dementia-R1，从临床笔记中学习症状演变，提升预测准确性。**

- **链接: [https://arxiv.org/pdf/2601.03018v1](https://arxiv.org/pdf/2601.03018v1)**
...
>
---
#### [new 074] ToxiGAN: Toxic Data Augmentation via LLM-Guided Directional Adversarial Generation
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于文本分类任务，旨在解决毒性语言数据增强的挑战。提出ToxiGAN框架，结合对抗生成与大模型语义引导，提升分类鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.03121v1](https://arxiv.org/pdf/2601.03121v1)**
...
>
---
#### [new 075] Decoupling the Effect of Chain-of-Thought Reasoning: A Human Label Variation Perspective
- **分类: cs.CL**

- **简介: 该论文研究长链式思维（CoT）对模型输出分布的影响，旨在解决模型在处理模糊任务时的不确定性建模问题。通过实验分离推理文本与模型先验的影响，发现CoT主要提升准确性，而分布结构由模型先验决定。**

- **链接: [https://arxiv.org/pdf/2601.03154v1](https://arxiv.org/pdf/2601.03154v1)**
...
>
---
#### [new 078] STReasoner: Empowering LLMs for Spatio-Temporal Reasoning in Time Series via Spatial-Aware Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于时序时空推理任务，旨在提升大模型在时间序列中的空间-时间推理能力。通过引入STReasoner和S-GRPO算法，解决现有模型重预测轻推理的问题。**

- **链接: [https://arxiv.org/pdf/2601.03248v1](https://arxiv.org/pdf/2601.03248v1)**
...
>
---
#### [new 079] DIP: Dynamic In-Context Planner For Diffusion Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，解决扩散语言模型因上下文过长导致的计算成本高的问题。提出DIP方法，动态调整上下文以提升效率。**

- **链接: [https://arxiv.org/pdf/2601.03199v1](https://arxiv.org/pdf/2601.03199v1)**
...
>
---
#### [new 080] Limited Linguistic Diversity in Embodied AI Datasets
...
>
---
#### [new 081] Maximizing Local Entropy Where It Matters: Prefix-Aware Localized LLM Unlearning
- **分类: cs.CL**

- **简介: 该论文属于机器学习中的模型遗忘任务，旨在有效删除LLM中的敏感信息而不损害整体性能。提出PALU框架，通过局部熵最大化实现精准遗忘。**

- **链接: [https://arxiv.org/pdf/2601.03190v1](https://arxiv.org/pdf/2601.03190v1)**
...
>
---
#### [new 082] Multi-RADS Synthetic Radiology Report Dataset and Head-to-Head Benchmarking of 41 Open-Weight and Proprietary Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医学影像报告自动化任务，旨在解决多标准RADS自动分类的挑战。研究构建了合成数据集并对比了多种语言模型的性能。**

- **链接: [https://arxiv.org/pdf/2601.03232v1](https://arxiv.org/pdf/2601.03232v1)**
...
>
---
#### [new 084] One Sample to Rule Them All: Extreme Data Efficiency in RL Scaling
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决大语言模型训练数据需求高的问题。通过设计高质量单一样本，提升多领域推理性能，强调样本质量而非数量的重要性。**

- **链接: [https://arxiv.org/pdf/2601.03111v1](https://arxiv.org/pdf/2601.03111v1)**
...
>
---
#### [new 085] Compressed code: the hidden effects of quantization and distillation on programming tokens
- **分类: cs.SE; cs.CL; cs.LG; cs.PL**

- **简介: 该论文研究压缩模型中量化与蒸馏对编程令牌的影响，旨在提升代码生成质量。属于代码生成优化任务，通过分析令牌表示和优化技术效果解决问题。**

- **链接: [https://arxiv.org/pdf/2601.02563v1](https://arxiv.org/pdf/2601.02563v1)**
...
>
---
#### [new 086] Prioritized Replay for RL Post-training
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习后训练任务，解决模型训练效率问题。提出一种基于优先级的样本选择方法，自动调整训练重点，提升学习效果。**

- **链接: [https://arxiv.org/pdf/2601.02648v1](https://arxiv.org/pdf/2601.02648v1)**
...
>
---
#### [new 087] Multi-Modal Data-Enhanced Foundation Models for Prediction and Control in Wireless Networks: A Survey
...
>
---
#### [new 088] DNACHUNKER: Learnable Tokenization for DNA Language Models
- **分类: q-bio.GN; cs.CL**

- **简介: 该论文属于DNA语言模型任务，解决tokenization策略影响模型性能的问题。提出DNACHUNKER，通过可学习的动态分块机制提升模型对DNA序列的解析能力。**

- **链接: [https://arxiv.org/pdf/2601.03019v1](https://arxiv.org/pdf/2601.03019v1)**
...
>
---
#### [new 089] Prompt-Counterfactual Explanations for Generative AI System Behavior
- **分类: cs.LG; cs.AI; cs.CL; cs.CY**

- **简介: 该论文属于AI可解释性任务，旨在解决生成式AI行为的解释问题。通过提出提示反事实解释框架，帮助理解输入提示如何导致特定输出特征。**

- **链接: [https://arxiv.org/pdf/2601.03156v1](https://arxiv.org/pdf/2601.03156v1)**
...
>
---
#### [new 090] ATLAS: Adaptive Test-Time Latent Steering with External Verifiers for Enhancing LLMs Reasoning
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出ATLAS框架，用于增强大语言模型的推理能力。通过动态调整推理过程中的潜在表示，提升准确性和效率，解决固定策略导致的过强或不足问题。**

- **链接: [https://arxiv.org/pdf/2601.03093v1](https://arxiv.org/pdf/2601.03093v1)**
...
>
---
#### [new 091] Logical Phase Transitions: Understanding Collapse in LLM Logical Reasoning
- **分类: cs.AI; cs.CL; cs.LO**

- **简介: 该论文研究大语言模型在逻辑推理中的性能崩溃问题，提出逻辑相变现象及神经符号课程调优方法，提升复杂逻辑任务的推理能力。**

- **链接: [https://arxiv.org/pdf/2601.02902v1](https://arxiv.org/pdf/2601.02902v1)**
...
>
---
#### [new 094] Fine-tuning Small Language Models as Efficient Enterprise Search Relevance Labelers
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于信息检索任务，解决企业搜索中高质量标注数据稀缺的问题。通过微调小型语言模型，结合合成数据生成，实现高效准确的相关性标注。**

- **链接: [https://arxiv.org/pdf/2601.03211v1](https://arxiv.org/pdf/2601.03211v1)**
...
>
---
#### [new 095] Cross-Platform Digital Discourse Analysis of the Israel-Hamas Conflict: Sentiment, Topics, and Event Dynamics
- **分类: cs.CY; cs.AI; cs.CL; cs.IR; cs.LG; cs.SI**

- **简介: 该论文属于跨平台数字话语分析任务，旨在研究以色列-哈马斯冲突中不同社交媒体上的情感、主题和事件动态，通过文本分析技术揭示冲突叙事的传播机制。**

- **链接: [https://arxiv.org/pdf/2601.02367v1](https://arxiv.org/pdf/2601.02367v1)**
...
>
---
#### [new 096] HAL: Inducing Human-likeness in LLMs with Alignment
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出HAL框架，用于提升语言模型的对话人类相似性。任务是使AI更贴近人类对话行为，解决难以定义和优化的问题。通过数据驱动的奖励机制实现模型对齐。**

- **链接: [https://arxiv.org/pdf/2601.02813v1](https://arxiv.org/pdf/2601.02813v1)**
...
>
---
#### [new 097] Chronicals: A High-Performance Framework for LLM Fine-Tuning with 3.51x Speedup over Unsloth
- **分类: cs.LG; cs.AI; cs.CL; cs.DC; stat.ML**

- **简介: 该论文提出Chronicals框架，解决大语言模型微调中的内存与效率问题，通过多项优化实现3.51倍速度提升。**

- **链接: [https://arxiv.org/pdf/2601.02609v1](https://arxiv.org/pdf/2601.02609v1)**
...
>
---
#### [new 098] Dynamic Quantization Error Propagation in Encoder-Decoder ASR Quantization
...
>
---
#### [new 099] Automatic Prompt Engineering with No Task Cues and No Tuning
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出一种无需任务提示和调优的自动提示工程方法，用于解决数据库列名扩展问题，首次在英文和德语中应用此技术。**

- **链接: [https://arxiv.org/pdf/2601.03130v1](https://arxiv.org/pdf/2601.03130v1)**
...
#### [replaced 001] EduBench: A Comprehensive Benchmarking Dataset for Evaluating Large Language Models in Diverse Educational Scenarios
- **分类: cs.CL**

- **简介: 该论文属于教育领域语言模型评估任务，旨在解决大模型在教育场景中应用不足的问题。构建了EduBench数据集，涵盖9类教育场景，提出多维评估指标，验证模型效果。**

- **链接: [https://arxiv.org/pdf/2505.16160v4](https://arxiv.org/pdf/2505.16160v4)**

> **作者:** Bin Xu; Yu Bai; Huashan Sun; Yiguan Lin; Siming Liu; Xinyue Liang; Yaolin Li; Zhuangzhi Dong; Jingren Zhang; Yufan Deng; Xinyu Zou; Yang Gao; Heyan Huang
>
...
>
---
#### [replaced 002] From Intrinsic Toxicity to Reception-Based Toxicity: A Contextual Framework for Prediction and Evaluation
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于文本毒性检测任务，解决现有模型忽略上下文影响的问题。提出CSF框架，将毒性视为情境相关压力信号，并引入PONOS度量社交反应，提升检测的上下文敏感性。**

- **链接: [https://arxiv.org/pdf/2503.16072v3](https://arxiv.org/pdf/2503.16072v3)**

> **作者:** Sergey Berezin; Reza Farahbakhsh; Noel Crespi
>
> **摘要:** Most toxicity detection models treat toxicity as an intrinsic property of text, overlooking the role of context in shaping its impact. In this position paper, drawing on insights from psychology, neuroscience, and computational social science, we reconceptualise toxicity as a socially emergent signal of stress. We formalise this perspective in the Contextual Stress Framework (CSF), which defines toxicity as a stress-inducing norm violation within a given context and introduces an additional dimension for toxicity detection. As one possible realisation of CSF, we introduce PONOS (Proportion Of Negative Observed Sentiments), a metric that quantifies toxicity through collective social reception rather than lexical features. We validate this approach on a novel dataset, demonstrating improved contextual sensitivity and adaptability when used alongside existing models.
>
---
#### [replaced 003] Do You Get the Hint? Benchmarking LLMs on the Board Game Concept
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在评估大语言模型在逻辑推理和意图理解方面的能力。通过设计一个名为Concept的单词猜谜游戏，测试模型的归纳推理能力，发现模型表现远低于人类。**

- **链接: [https://arxiv.org/pdf/2510.13271v2](https://arxiv.org/pdf/2510.13271v2)**
...
>
---
#### [replaced 004] Whose story is it? Personalizing story generation by inferring author styles
- **分类: cs.CL**

- **简介: 该论文属于故事生成任务，旨在通过分析作者风格实现个性化生成。工作包括构建数据集、提出两阶段个性化生成方法，并验证效果。**

- **链接: [https://arxiv.org/pdf/2502.13028v3](https://arxiv.org/pdf/2502.13028v3)**

> **作者:** Nischal Ashok Kumar; Chau Minh Pham; Mohit Iyyer; Andrew Lan
>
> **备注:** Accepted to IJCNLP-AACL 2025 (Main)
>
...
>
---
#### [replaced 007] Qomhra: A Bilingual Irish and English Large Language Model
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决低资源语言（如爱尔兰语）大语言模型不足的问题。研究提出Qomhrá，通过预训练、指令调优和合成人类偏好数据提升性能。**

- **链接: [https://arxiv.org/pdf/2510.17652v2](https://arxiv.org/pdf/2510.17652v2)**
...
>
---
#### [replaced 016] Iterative Topic Taxonomy Induction with LLMs: A Case Study of Electoral Advertising
- **分类: cs.CL; cs.AI; cs.CY; cs.LG; cs.SI**

- **简介: 该论文属于主题分类任务，旨在解决无监督构建可解释话题分类的问题。通过结合聚类与提示推理，利用大语言模型迭代生成分类体系，应用于政治广告分析。**

- **链接: [https://arxiv.org/pdf/2510.15125v2](https://arxiv.org/pdf/2510.15125v2)**
...
>
---
#### [replaced 017] POLAR: A Benchmark for Multilingual, Multicultural, and Multi-Event Online Polarization
- **分类: cs.CL**

- **简介: 该论文提出POLAR数据集，用于多语言、多文化、多事件的在线极化研究。旨在解决极化检测与分析中的跨语言、跨文化挑战，通过实验评估模型性能。**

- **链接: [https://arxiv.org/pdf/2505.20624v2](https://arxiv.org/pdf/2505.20624v2)**
...
>
---
#### [replaced 022] Learning an Efficient Multi-Turn Dialogue Evaluator from Multiple LLM Judges
- **分类: cs.CL**

- **简介: 该论文属于对话评估任务，旨在解决LLM评估中因单judge导致的偏差问题。通过聚合多个LLM judge的偏好知识，构建高效评估模型，提升评估效率与准确性。**

- **链接: [https://arxiv.org/pdf/2508.00454v4](https://arxiv.org/pdf/2508.00454v4)**

> **作者:** Yuqi Tang; Kehua Feng; Yunfeng Wang; Zhiwen Chen; Chengfei Lv; Gang Yu; Qiang Zhang; Keyan Ding; Huajun Chen
>
...
>
---
#### [replaced 023] Infini-gram mini: Exact n-gram Search at the Internet Scale with FM-Index
- **分类: cs.CL**

- **简介: 该论文提出Infini-gram mini系统，解决大规模文本数据的精确n-gram搜索问题，通过FM-index实现高效压缩与快速检索。**

- **链接: [https://arxiv.org/pdf/2506.12229v5](https://arxiv.org/pdf/2506.12229v5)**
...
>
---
#### [replaced 024] ReCode: Unify Plan and Action for Universal Granularity Control
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于人工智能决策任务，旨在解决LLM代理在不同决策粒度间切换的能力不足问题。通过提出ReCode框架，统一规划与行动，实现动态粒度控制。**

- **链接: [https://arxiv.org/pdf/2510.23564v4](https://arxiv.org/pdf/2510.23564v4)**
...
>
---
#### [replaced 025] Predicting Failures of LLMs to Link Biomedical Ontology Terms to Identifiers Evidence Across Models and Ontologies
- **分类: cs.CL**

- **简介: 该论文属于生物医学自然语言处理任务，旨在解决LLMs在链接术语与正确标识符时的失败问题。通过分析两个ontology和两个模型，发现标识符曝光是成功的关键因素。**

- **链接: [https://arxiv.org/pdf/2509.04458v2](https://arxiv.org/pdf/2509.04458v2)**
...
>
---
#### [replaced 026] Large Language Models can Achieve Social Balance
- **分类: cs.CL; cs.AI; cs.MA; cs.SI; physics.soc-ph**

- **简介: 该论文研究LLM在社会平衡框架下的互动机制，探讨其如何实现社会均衡。属于社会模拟任务，解决LLM在多代理系统中维持稳定关系的问题。**

- **链接: [https://arxiv.org/pdf/2410.04054v3](https://arxiv.org/pdf/2410.04054v3)**

> **作者:** Pedro Cisneros-Velarde
>
> **摘要:** Large Language Models (LLMs) can be deployed in situations where they process positive/negative interactions with other agents. We study how this is done under the sociological framework of social balance, which explains the emergence of one faction or multiple antagonistic ones among agents. Across different LLM models, we find that balance depends on the (i) type of interaction, (ii) update mechanism, and (iii) population size. Across (i)-(iii), we characterize the frequency at which social balance is achieved, the justifications for the social dynamics, and the diversity and stability of interactions. Finally, we explain how our findings inform the deployment of agentic systems.
>
---
#### [replaced 027] SignX: Continuous Sign Recognition in Compact Pose-Rich Latent Space
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 032] LORE: A Large Generative Model for Search Relevance
- **分类: cs.IR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于电商搜索相关性任务，旨在提升搜索结果的相关性。通过构建LORE框架，解决传统方法性能瓶颈，实现显著效果提升。**

- **链接: [https://arxiv.org/pdf/2512.03025v3](https://arxiv.org/pdf/2512.03025v3)**
...
>
---
#### [replaced 033] Adaptive Constraint Propagation: Scaling Structured Inference for Large Language Models via Meta-Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文提出MetaJuLS，解决结构化推理中的约束传播问题，通过元强化学习实现跨语言任务的快速适应，提升大模型推理效率与绿色AI。**

- **链接: [https://arxiv.org/pdf/2601.00095v2](https://arxiv.org/pdf/2601.00095v2)**
...
>
---
#### [replaced 034] d-TreeRPO: Towards More Reliable Policy Optimization for Diffusion Language Models
- **分类: cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决扩散语言模型策略优化中的可靠性问题，提出d-TreeRPO框架提升奖励计算和概率估计的准确性。**

- **链接: [https://arxiv.org/pdf/2512.09675v2](https://arxiv.org/pdf/2512.09675v2)**
...
>
---
#### [replaced 035] MIRAGE: A Benchmark for Multimodal Information-Seeking and Reasoning in Agricultural Expert-Guided Conversations
...
>
---
#### [replaced 036] Quantifying LLM Biases Across Instruction Boundary in Mixed Question Forms
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM在混合题型数据集中的偏差问题。通过引入“指令边界”概念和BiasDetector基准，研究不同指令对模型识别稀疏标签的影响。**

- **链接: [https://arxiv.org/pdf/2509.20278v3](https://arxiv.org/pdf/2509.20278v3)**
...
>
---
#### [replaced 037] Reference-Free Evaluation of Taxonomies
- **分类: cs.CL**

- **简介: 该论文属于知识图谱质量评估任务，解决无标签情况下分类体系质量评估问题。提出两种无参考指标，分别评估语义一致性与逻辑合理性，并验证其有效性。**

- **链接: [https://arxiv.org/pdf/2505.11470v2](https://arxiv.org/pdf/2505.11470v2)**

> **作者:** Pascal Wullschleger; Majid Zarharan; Donnacha Daly; Marc Pouly; Jennifer Foster
>
> **备注:** Under review at ARR January 2026 cycle
>
...
>
---
#### [replaced 038] Protecting multimodal large language models against misleading visualizations
- **分类: cs.CL**

- **简介: 该论文属于多模态语言模型任务，旨在解决模型在面对误导性图表时回答准确率下降的问题。通过比较六种方法，发现基于表格和重绘图表有效提升性能。**

- **链接: [https://arxiv.org/pdf/2502.20503v5](https://arxiv.org/pdf/2502.20503v5)**
...
>
---
#### [replaced 039] SLR: Automated Synthesis for Scalable Logical Reasoning
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出SLR框架，用于自动化生成逻辑推理任务，解决LLM在逻辑推理上的不足。通过自动生成指令、验证程序和规则，提升模型推理能力。**

- **链接: [https://arxiv.org/pdf/2506.15787v5](https://arxiv.org/pdf/2506.15787v5)**
...
>
---
#### [replaced 040] The Homogenizing Effect of Large Language Models on Human Expression and Thought
- **分类: cs.CL**

- **简介: 论文探讨大语言模型对人类表达和思维的同质化影响，属于认知科学与人工智能交叉研究。旨在揭示LLMs如何导致语言和思维模式趋同，削弱多样性与创造力。通过跨学科分析，论证其设计与使用带来的影响。**

- **链接: [https://arxiv.org/pdf/2508.01491v2](https://arxiv.org/pdf/2508.01491v2)**
...
>
---
#### [replaced 041] Emergence and Localisation of Semantic Role Circuits in LLMs
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理领域，研究LLMs内部语义角色机制。通过分析揭示了语义角色电路的集中性、结构渐进优化及跨模型相似性，旨在理解LLMs如何实现抽象语义结构。**

- **链接: [https://arxiv.org/pdf/2511.20910v2](https://arxiv.org/pdf/2511.20910v2)**
...
>
---
#### [replaced 042] The MASK Benchmark: Disentangling Honesty From Accuracy in AI Systems
- **分类: cs.LG; cs.AI; cs.CL; cs.CY**

- **简介: 该论文属于AI可信性研究任务，旨在解决LLM诚实性与准确性的区分问题。通过构建数据集，发现大模型准确性高但诚实性不足，并验证了简单方法可提升诚实性。**

- **链接: [https://arxiv.org/pdf/2503.03750v3](https://arxiv.org/pdf/2503.03750v3)**
...
>
---
#### [replaced 045] TELEVAL: A Dynamic Benchmark Designed for Spoken Language Models in Chinese Interactive Scenarios
...
>
---
#### [replaced 046] Style over Story: Measuring LLM Narrative Preferences via Structured Selection
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的叙事分析任务，旨在探究大语言模型的叙事偏好。通过设计约束选择实验，发现模型更重视风格而非内容元素。**

- **链接: [https://arxiv.org/pdf/2510.02025v3](https://arxiv.org/pdf/2510.02025v3)**
...
>
---
#### [replaced 047] Less is more: Probabilistic reduction is best explained by small-scale predictability measures
- **分类: cs.CL**

- **简介: 该论文属于语言模型与认知研究任务，探讨语言模型概率与认知现象的关系。解决的问题是：是否需要完整语句来观察概率缩减，工作表明n-gram足够。**

- **链接: [https://arxiv.org/pdf/2512.23659v2](https://arxiv.org/pdf/2512.23659v2)**
...
>
---
#### [replaced 050] Hidden State Poisoning Attacks against Mamba-based Language Models
- **分类: cs.CL**

- **简介: 该论文研究了针对Mamba模型的隐藏状态污染攻击（HiSPA），揭示其对抗脆弱性，提出基准测试并分析攻击影响，旨在提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.01972v2](https://arxiv.org/pdf/2601.01972v2)**
...
>
---
#### [replaced 051] Uncovering Autoregressive LLM Knowledge of Thematic Fit in Event Representation
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究语言模型在事件表征中的主题匹配能力，比较了闭源与开源模型的表现，分析了推理步骤、生成句子等因素的影响。**

- **链接: [https://arxiv.org/pdf/2410.15173v2](https://arxiv.org/pdf/2410.15173v2)**
...
>
---
#### [replaced 053] pdfQA: Diverse, Challenging, and Realistic Question Answering over PDFs
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出pdfQA，一个用于PDF文档问答的多领域数据集，解决通用且复杂QA任务。通过真实与合成数据，评估问答系统在不同难度维度下的表现。**

- **链接: [https://arxiv.org/pdf/2601.02285v2](https://arxiv.org/pdf/2601.02285v2)**
...
>
---
#### [replaced 056] ShareChat: A Dataset of Chatbot Conversations in the Wild
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文提出ShareChat数据集，用于研究真实场景下的用户与大语言模型的对话互动。旨在解决现有数据集无法反映实际使用情况的问题。**

- **链接: [https://arxiv.org/pdf/2512.17843v2](https://arxiv.org/pdf/2512.17843v2)**
...
>
---
#### [replaced 057] Enhancing Reasoning Skills in Small Persian Medical Language Models Can Outperform Large-Scale Data Training
- **分类: cs.CL**

- **简介: 该论文属于医疗问答任务，旨在提升小规模波斯语语言模型的推理能力。通过RLAIF和DPO方法，利用少量数据训练出性能优于大模型的医学推理模型。**

- **链接: [https://arxiv.org/pdf/2510.20059v5](https://arxiv.org/pdf/2510.20059v5)**
...
>
---
#### [replaced 058] VocabTailor: Dynamic Vocabulary Selection for Downstream Tasks in Small Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出VocabTailor，解决小语言模型中词汇导致的内存瓶颈问题。通过动态词汇选择策略，显著降低内存占用，同时保持任务性能。属于自然语言处理中的模型优化任务。**

- **链接: [https://arxiv.org/pdf/2508.15229v2](https://arxiv.org/pdf/2508.15229v2)**
...
>
---
#### [replaced 061] Self-Filtered Distillation with LLMs-generated Trust Indicators for Reliable Patent Classification
- **分类: cs.CL**

- **简介: 该论文属于专利分类任务，解决LLM生成推理过程中的错误问题。通过引入自过滤蒸馏框架，利用信任指标提升分类的准确性和稳定性。**

- **链接: [https://arxiv.org/pdf/2510.05431v3](https://arxiv.org/pdf/2510.05431v3)**
...
>
---
#### [replaced 062] VisRet: Visualization Improves Knowledge-Intensive Text-to-Image Retrieval
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 063] MemeMind: A Large-Scale Multimodal Dataset with Chain-of-Thought Reasoning for Harmful Meme Detection
...
>
---
#### [replaced 064] CMDAR: A Chinese Multi-scene Dynamic Audio Reasoning Benchmark with Diverse Challenges
...
>
---
#### [replaced 065] Communication Compression for Tensor Parallel LLM Inference
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于深度学习优化任务，旨在降低张量并行推理中的通信延迟。通过量化压缩激活值，减少跨加速器通信开销，显著提升推理速度。**

- **链接: [https://arxiv.org/pdf/2411.09510v3](https://arxiv.org/pdf/2411.09510v3)**

> **作者:** Jan Hansen-Palmus; Michael Truong Le; Oliver Hausdörfer; Alok Verma
>
> **摘要:** Large Language Models (LLMs) have pushed the frontier of artificial intelligence but are comprised of hundreds of billions of parameters and operations. For faster inference latency, LLMs are deployed on multiple hardware accelerators through various Model Parallelism strategies. Our paper looks into the details on one such strategy - Tensor Parallel - and proposes to reduce latency by compressing inter-accelerator communication. We leverage fine grained quantization techniques to compress selected activations by 3.5 - 4.5x. Our proposed method leads up to 2x reduction of time-to-first-token (TTFT) with negligible model performance degradation.
>
---
#### [replaced 066] Enhancing Multimodal Reasoning via Latent Refocusing
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 067] Adapting Web Agents with Synthetic Supervision
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于Web代理适应任务，解决新网站适应性差的问题。通过合成监督提升数据质量，提出SynthAgent框架，优化任务与轨迹生成。**

- **链接: [https://arxiv.org/pdf/2511.06101v2](https://arxiv.org/pdf/2511.06101v2)**
...
>
---
#### [replaced 068] Steerability of Instrumental-Convergence Tendencies in LLMs
- **分类: cs.CL**

- **简介: 该论文研究AI模型的可引导性问题，探讨能力增长对控制能力的影响。通过实验发现，反工具性提示能显著降低模型行为收敛率，提升安全性。属于AI安全领域，解决模型可控性与安全性矛盾问题。**

- **链接: [https://arxiv.org/pdf/2601.01584v2](https://arxiv.org/pdf/2601.01584v2)**
...
>
---
#### [replaced 069] AgentArch: A Comprehensive Benchmark to Evaluate Agent Architectures in Enterprise
- **分类: cs.AI; cs.CL; cs.MA**

- **简介: 该论文属于智能体系统研究，旨在评估企业场景下的代理架构。解决现有研究缺乏对多智能体系统设计维度交互理解的问题，通过构建基准测试18种配置，分析关键维度表现。**

- **链接: [https://arxiv.org/pdf/2509.10769v2](https://arxiv.org/pdf/2509.10769v2)**
