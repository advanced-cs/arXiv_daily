...
#### [new 001] Polarization-resolved imaging improves eye tracking
- **分类: cs.CV; physics.optics**

- **简介: 该论文提出极化分辨近红外成像用于眼动追踪，解决传统强度图像中特征不足的问题。通过极化滤波相机与偏振光源，揭示角膜与巩膜的隐含特征，结合CNN模型，显著降低 gaze 误差，提升穿戴设备的鲁棒性。**

- **链接: [http://arxiv.org/pdf/2511.04652v1](http://arxiv.org/pdf/2511.04652v1)**
...
>
> **备注:** Website: https://cambrian-mllm.github.io/
>
...
>
---
#### [new 007] BoRe-Depth: Self-supervised Monocular Depth Estimation with Boundary Refinement for Embedded Systems
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 008] THEval. Evaluation Framework for Talking Head Video Generation
- **分类: cs.CV**

- **简介: 该论文针对说话头视频生成评估不足的问题，提出一个包含8个指标的多维评估框架，聚焦质量、自然性与同步性，基于新构建的高质量数据集，系统评估17个前沿模型，推动领域标准化评估。**

- **链接: [http://arxiv.org/pdf/2511.04520v1](http://arxiv.org/pdf/2511.04520v1)**
...
>
---
#### [new 014] LoRA-Edge: Tensor-Train-Assisted LoRA for Practical CNN Fine-Tuning on Edge Devices
- **分类: cs.CV; cs.AR**

- **简介: 论文提出LoRA-Edge，面向边缘设备的CNN微调任务，解决全参数微调资源消耗大的问题。通过TT-SVD分解与选择性核心更新，大幅减少可训练参数（达98.5%），保持推理开销不变，显著提升收敛速度与能效。**

- **链接: [http://arxiv.org/pdf/2511.03765v1](http://arxiv.org/pdf/2511.03765v1)**
...
>
---
#### [new 015] Vision Foundation Models in Agriculture: Toward Domain-Specific Adaptation for Weed Herbicide Trials Assessment
- **分类: cs.CV**

- **简介: 该论文针对农业除草剂试验中的植物识别与损伤评估任务，提出一种领域自适应视觉基础模型，通过自监督预训练提升在稀标注、跨场景下的性能，显著降低标注成本并提高泛化能力。**

- **链接: [http://arxiv.org/pdf/2511.04288v1](http://arxiv.org/pdf/2511.04288v1)**
...
>
---
#### [new 024] DMSORT: An efficient parallel maritime multi-object tracking architecture for unmanned vessel platforms
- **分类: cs.CV; cs.AI**

- **简介: 论文提出DMSORT，用于无人船平台的海洋多目标跟踪，解决海面相机抖动与视觉退化导致的跟踪漂移问题。通过双分支架构融合运动补偿、轻量ReID与特征融合，实现高精度、高速度跟踪。**

- **链接: [http://arxiv.org/pdf/2511.04128v1](http://arxiv.org/pdf/2511.04128v1)**
...
>
---
#### [new 026] Unveiling Deep Semantic Uncertainty Perception for Language-Anchored Multi-modal Vision-Brain Alignment
- **分类: cs.CV**

- **简介: 论文提出Bratrix框架，首次实现语言锚定的视觉-脑信号对齐，通过解耦视觉与语义成分、引入不确定性感知模块，提升EEG/MEG/fMRI的语义解码精度，显著优于现有方法。**

- **链接: [http://arxiv.org/pdf/2511.04078v1](http://arxiv.org/pdf/2511.04078v1)**
...
>
---
#### [new 030] SpatialLock: Precise Spatial Control in Text-to-Image Synthesis
- **分类: cs.CV**

- **简介: 该论文属于文本到图像生成任务，旨在解决对象定位不精确的问题。提出SpatialLock框架，通过位置感知注入与位置引导学习，联合利用空间信息，显著提升生成图像中对象的定位精度，IOU超0.9，达到新SOTA。**

- **链接: [http://arxiv.org/pdf/2511.04112v1](http://arxiv.org/pdf/2511.04112v1)**

> **作者:** Biao Liu; Yuanzhi Liang
>
> **备注:** Work in progress
>
> **摘要:** Text-to-Image (T2I) synthesis has made significant advancements in recent years, driving applications such as generating datasets automatically. However, precise control over object localization in generated images remains a challenge. Existing methods fail to fully utilize positional information, leading to an inadequate understanding of object spatial layouts. To address this issue, we propose SpatialLock, a novel framework that leverages perception signals and grounding information to jointly control the generation of spatial locations. SpatialLock incorporates two components: Position-Engaged Injection (PoI) and Position-Guided Learning (PoG). PoI directly integrates spatial information through an attention layer, encouraging the model to learn the grounding information effectively. PoG employs perception-based supervision to further refine object localization. Together, these components enable the model to generate objects with precise spatial arrangements and improve the visual quality of the generated images. Experiments show that SpatialLock sets a new state-of-the-art for precise object positioning, achieving IOU scores above 0.9 across multiple datasets.
>
---
#### [new 031] Tracking and Understanding Object Transformations
- **分类: cs.CV**

- **简介: 该论文提出“Track Any State”任务，解决物体形态突变时跟踪失效问题，构建了VOST-TAS基准，并设计TubeletGraph零样本系统，通过语义与邻近先验恢复丢失轨迹，生成状态变化图，实现高精度跟踪与深层语义理解。**

- **链接: [http://arxiv.org/pdf/2511.04678v1](http://arxiv.org/pdf/2511.04678v1)**
...
>
---
#### [new 032] Text to Sketch Generation with Multi-Styles
- **分类: cs.CV**

- **简介: 该论文提出M3S框架，实现文本到多风格草图生成，解决现有方法缺乏精确风格控制的问题。通过无需训练的扩散模型，结合文本提示与参考草图，利用风格引导机制实现高质量、低内容泄漏的多风格合成。**

- **链接: [http://arxiv.org/pdf/2511.04123v1](http://arxiv.org/pdf/2511.04123v1)**
...
>
---
#### [new 033] Improving Multi-View Reconstruction via Texture-Guided Gaussian-Mesh Joint Optimization
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对多视角重建中几何与纹理分离优化的问题，提出高斯引导的网格联合优化框架，同步优化网格几何与顶点颜色，实现几何与外观的统一重建，提升下游编辑任务性能。**

- **链接: [http://arxiv.org/pdf/2511.03950v1](http://arxiv.org/pdf/2511.03950v1)**
...
>
---
#### [new 034] HideAndSeg: an AI-based tool with automated prompting for octopus segmentation in natural habitats
- **分类: cs.CV**

- **简介: HideAndSeg是一种用于自然栖息地中章鱼视频分割的最小监督AI工具，结合SAM2与YOLOv11，通过自动化提示减少人工干预，并引入无监督指标评估性能，解决章鱼伪装、形变与遮挡导致的分割难题。**

- **链接: [http://arxiv.org/pdf/2511.04426v1](http://arxiv.org/pdf/2511.04426v1)**
...
>
---
#### [new 035] Near-Lossless 3D Voxel Representation Free from Iso-surface
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出Faithful Contouring，一种无需等值面提取的稀疏体素表示方法，解决传统方法几何失真问题，实现高精度、高分辨率的3D网格近无损表示与重建，显著提升形状保真度与编辑灵活性。**

- **链接: [http://arxiv.org/pdf/2511.04029v1](http://arxiv.org/pdf/2511.04029v1)**
...
>
---
#### [new 038] Improving Diagnostic Performance on Small and Imbalanced Datasets Using Class-Based Input Image Composition
- **分类: cs.CV; cs.AI; cs.DB**

- **简介: 该论文针对小样本、类别不平衡的医学图像诊断问题，提出类内图像融合方法（CoImg），通过构建多图复合输入提升特征密度与判别能力，在OCT视网膜数据集上显著提升模型性能，准确率达99.6%。**

- **链接: [http://arxiv.org/pdf/2511.03891v1](http://arxiv.org/pdf/2511.03891v1)**
...
>
---
#### [new 039] CaRF: Enhancing Multi-View Consistency in Referring 3D Gaussian Splatting Segmentation
- **分类: cs.CV**

- **简介: 论文提出CaRF框架，解决3D高斯泼溅中跨视图一致性差的问题，通过相机感知的高斯编码与配对视图监督，实现语言驱动的3D区域分割，显著提升多视图分割精度。**

- **链接: [http://arxiv.org/pdf/2511.03992v1](http://arxiv.org/pdf/2511.03992v1)**
...
>
---
#### [new 053] I Detect What I Don't Know: Incremental Anomaly Learning with Stochastic Weight Averaging-Gaussian for Oracle-Free Medical Imaging
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出一种无监督、无标注的增量异常检测框架，用于医疗影像中未知异常识别。通过轻量适配器与SWAG不确定性引导的样本筛选，逐步扩展正常样本集，避免模型漂移，在无标签场景下显著提升检测性能。**

- **链接: [http://arxiv.org/pdf/2511.03912v1](http://arxiv.org/pdf/2511.03912v1)**
...
>
---
#### [new 063] Multi-Task Learning for Visually Grounded Reasoning in Gastrointestinal VQA
- **分类: cs.CV; cs.LG**

- **简介: 该论文面向胃肠镜视觉问答（VQA）任务，提出基于LoRA微调Florence-2的多任务框架，联合学习答案预测、解释生成与视觉定位，融合三类医学数据提升模型准确性与可解释性。**

- **链接: [http://arxiv.org/pdf/2511.04384v1](http://arxiv.org/pdf/2511.04384v1)**
...
>
---
#### [new 065] X-Diffusion: Training Diffusion Policies on Cross-Embodiment Human Demonstrations
...
>
---
#### [new 068] GentleHumanoid: Learning Upper-body Compliance for Contact-rich Human and Object Interaction
...
>
---
#### [new 073] Jr. AI Scientist and Its Risk Report: Autonomous Scientific Exploration from a Baseline Paper
- **分类: cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文提出Jr. AI Scientist，一个模拟新手研究者工作流程的自主AI科研系统，旨在解决AI驱动科学探索的可信性与风险问题，通过复现-改进-发表全流程生成高质量论文，并系统评估其能力与潜在风险。**

- **链接: [http://arxiv.org/pdf/2511.04583v1](http://arxiv.org/pdf/2511.04583v1)**
...
>
---
#### [new 076] Real-to-Sim Robot Policy Evaluation with Gaussian Splatting Simulation of Soft-Body Interactions
...
>
---
#### [new 077] Evo-1: Lightweight Vision-Language-Action Model with Preserved Semantic Alignment
- **分类: cs.RO; cs.CV**
...
#### [replaced 001] RealDPO: Real or Not Real, that is the Preference
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.14955v2](http://arxiv.org/pdf/2510.14955v2)**
...
>
---
#### [replaced 002] Back on Track: Bundle Adjustment for Dynamic Scene Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.14516v2](http://arxiv.org/pdf/2504.14516v2)**
...
>
---
#### [replaced 005] Poutine: Vision-Language-Trajectory Pre-Training and Reinforcement Learning Post-Training Enable Robust End-to-End Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 009] Med-GLIP: Advancing Medical Language-Image Pre-training with Large-scale Grounded Dataset
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.10528v2](http://arxiv.org/pdf/2508.10528v2)**
...
>
---
#### [replaced 010] HoliSafe: Holistic Safety Benchmarking and Modeling for Vision-Language Model
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.04704v4](http://arxiv.org/pdf/2506.04704v4)**
...
>
---
#### [replaced 013] Zero-Shot Referring Expression Comprehension via Vison-Language True/False Verification
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.09958v2](http://arxiv.org/pdf/2509.09958v2)**
...
>
---
#### [replaced 014] Seeing What Matters: Generalizable AI-generated Video Detection with Forensic-Oriented Augmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.16802v2](http://arxiv.org/pdf/2506.16802v2)**
...
>
---
#### [replaced 017] Optimized Minimal 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.16924v2](http://arxiv.org/pdf/2503.16924v2)**
...
>
---
#### [replaced 018] DOVE: Efficient One-Step Diffusion Model for Real-World Video Super-Resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.16239v3](http://arxiv.org/pdf/2505.16239v3)**
...
>
---
#### [replaced 021] Two Causally Related Needles in a Video Haystack
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.19853v3](http://arxiv.org/pdf/2505.19853v3)**
...
>
---
#### [replaced 022] Source-Only Cross-Weather LiDAR via Geometry-Aware Point Drop
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2511.01250v2](http://arxiv.org/pdf/2511.01250v2)**
...
>
---
#### [replaced 023] Shallow Diffuse: Robust and Invisible Watermarking through Low-Dimensional Subspaces in Diffusion Models
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2410.21088v3](http://arxiv.org/pdf/2410.21088v3)**
...
>
---
#### [replaced 024] Gestura: A LVLM-Powered System Bridging Motion and Semantics for Real-Time Free-Form Gesture Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.21814v2](http://arxiv.org/pdf/2510.21814v2)**
...
>
---
#### [replaced 025] AutoVLA: A Vision-Language-Action Model for End-to-End Autonomous Driving with Adaptive Reasoning and Reinforcement Fine-Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13757v3](http://arxiv.org/pdf/2506.13757v3)**
...
>
---
#### [replaced 026] Caption-Driven Explainability: Probing CNNs for Bias via CLIP
- **分类: cs.CV; eess.IV; I.2.6; I.2.8; I.2.10; I.4.8**

- **链接: [http://arxiv.org/pdf/2510.22035v4](http://arxiv.org/pdf/2510.22035v4)**
...
>
---
#### [replaced 027] Advanced Sign Language Video Generation with Compressed and Quantized Multi-Condition Tokenization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.15980v2](http://arxiv.org/pdf/2506.15980v2)**

> **作者:** Cong Wang; Zexuan Deng; Zhiwei Jiang; Yafeng Yin; Fei Shen; Zifeng Cheng; Shiping Ge; Shiwei Gan; Qing Gu
>
...
>
---
#### [replaced 032] TextRegion: Text-Aligned Region Tokens from Frozen Image-Text Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23769v2](http://arxiv.org/pdf/2505.23769v2)**
...
>
---
#### [replaced 033] JaneEye: A 12-nm 2K-FPS 18.9-$μ$J/Frame Event-based Eye Tracking Accelerator
- **分类: eess.SP; cs.AR; cs.CV; cs.HC; eess.IV**

- **链接: [http://arxiv.org/pdf/2510.01213v2](http://arxiv.org/pdf/2510.01213v2)**

> **作者:** Tao Han; Ang Li; Qinyu Chen; Chang Gao
>
> **备注:** Accepted to 2026 IEEE 31st Asia and South Pacific Design Automation Conference (ASP-DAC)
>
...
>
---
#### [replaced 034] X-Diffusion: Generating Detailed 3D MRI Volumes From a Single Image Using Cross-Sectional Diffusion Models
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2404.19604v3](http://arxiv.org/pdf/2404.19604v3)**
...
>
---
#### [replaced 039] MIND: Material Interface Generation from UDFs for Non-Manifold Surface Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.02938v2](http://arxiv.org/pdf/2506.02938v2)**
...
>
---
#### [replaced 040] OmniVLA: Physically-Grounded Multimodal VLA with Unified Multi-Sensor Perception for Robotic Manipulation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 041] Neural Posterior Estimation for Cataloging Astronomical Images from the Legacy Survey of Space and Time
- **分类: astro-ph.IM; cs.CV; stat.AP; 85A35 (Primary), 62F15 (Secondary)**

- **链接: [http://arxiv.org/pdf/2510.15315v3](http://arxiv.org/pdf/2510.15315v3)**

> **作者:** Yicun Duan; Xinyue Li; Camille Avestruz; Jeffrey Regier; LSST Dark Energy Science Collaboration
>
...
>
---
#### [replaced 042] BasicAVSR: Arbitrary-Scale Video Super-Resolution via Image Priors and Enhanced Motion Compensation
- **分类: cs.CV; I.4.3**

- **链接: [http://arxiv.org/pdf/2510.26149v2](http://arxiv.org/pdf/2510.26149v2)**
...
>
---
#### [replaced 045] GASP: Efficient Black-Box Generation of Adversarial Suffixes for Jailbreaking LLMs
- **分类: cs.LG; cs.AI; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2411.14133v3](http://arxiv.org/pdf/2411.14133v3)**

> **作者:** Advik Raj Basani; Xiao Zhang
>
> **备注:** Accepted to NeurIPS 2025. Project page and demos: https://air-ml.org/project/gasp/
>
...
>
---
#### [replaced 046] Residual Diffusion Bridge Model for Image Restoration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.23116v2](http://arxiv.org/pdf/2510.23116v2)**
...
>
---
#### [replaced 047] Seg the HAB: Language-Guided Geospatial Algae Bloom Reasoning and Segmentation
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.18751v2](http://arxiv.org/pdf/2510.18751v2)**
...
>
---
#### [replaced 048] Comparing Computational Pathology Foundation Models using Representational Similarity Analysis
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.15482v2](http://arxiv.org/pdf/2509.15482v2)**
...
>
---
#### [replaced 049] Assessing the value of Geo-Foundational Models for Flood Inundation Mapping: Benchmarking models for Sentinel-1, Sentinel-2, and Planetscope for end-users
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2511.01990v2](http://arxiv.org/pdf/2511.01990v2)**
...
>
---
#### [replaced 050] WaveGuard: Robust Deepfake Detection and Source Tracing via Dual-Tree Complex Wavelet and Graph Neural Networks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.08614v4](http://arxiv.org/pdf/2505.08614v4)**
...
>
---
#### [replaced 051] Bridging Generative and Discriminative Noisy-Label Learning via Direction-Agnostic EM Formulation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2308.01184v3](http://arxiv.org/pdf/2308.01184v3)**

> **作者:** Fengbei Liu; Chong Wang; Yuanhong Chen; Yuyuan Liu; Gustavo Carneiro
>
...
>
---
#### [replaced 054] SurgViVQA: Temporally-Grounded Video Question Answering for Surgical Scene Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2511.03325v2](http://arxiv.org/pdf/2511.03325v2)**
...
>
---
#### [replaced 055] Learning to Navigate Socially Through Proactive Risk Perception
...
>
---
#### [replaced 056] UMA: Ultra-detailed Human Avatars via Multi-level Surface Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.01802v2](http://arxiv.org/pdf/2506.01802v2)**

> **作者:** Heming Zhu; Guoxing Sun; Christian Theobalt; Marc Habermann
>
> **备注:** Project page: https://vcai.mpi-inf.mpg.de/projects/UMA/
>
...
>
---
#### [replaced 057] Towards Efficient and Accurate Spiking Neural Networks via Adaptive Bit Allocation
- **分类: cs.NE; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.23717v3](http://arxiv.org/pdf/2506.23717v3)**
...
>
---
#### [replaced 058] Particle-Grid Neural Dynamics for Learning Deformable Object Models from RGB-D Videos
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [replaced 059] LEAP-VO: Long-term Effective Any Point Tracking for Visual Odometry
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2401.01887v3](http://arxiv.org/pdf/2401.01887v3)**
...
>
---
#### [replaced 061] Cross-modal Causal Intervention for Alzheimer's Disease Prediction
- **分类: cs.AI; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.13956v2](http://arxiv.org/pdf/2507.13956v2)**

> **作者:** Yutao Jin; Haowen Xiao; Junyong Zhai; Yuxiao Li; Jielei Chu; Fengmao Lv; Yuxiao Li
>
...
>
---
#### [replaced 062] TraceTrans: Translation and Spatial Tracing for Surgical Prediction
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.22379v3](http://arxiv.org/pdf/2510.22379v3)**
...
>
---
#### [replaced 063] FlexAC: Towards Flexible Control of Associative Reasoning in Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.11190v3](http://arxiv.org/pdf/2510.11190v3)**
