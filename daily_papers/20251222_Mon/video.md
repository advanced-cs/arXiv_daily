...
>
---
#### [new 005] Democratizing Pathology Co-Pilots: An Open Pipeline and Dataset for Whole-Slide Vision-Language Modelling
- **分类: cs.CV**

- **简介: 该论文面向病理学视觉-语言建模任务，解决现有VLM在全切片图像（WSI）上缺乏公开、高质量指令数据及可复现训练流程的问题。提出Polysome合成指令工具，构建HISTAI-Instruct数据集，并训练开源VLM ANTONI-α，在WSI级VQA任务中超越MedGemma。**

- **链接: [https://arxiv.org/pdf/2512.17326v1](https://arxiv.org/pdf/2512.17326v1)**
...
>
> **摘要:** Vision-language models (VLMs) have the potential to become co-pilots for pathologists. However, most VLMs either focus on small regions of interest within whole-slide images, provide only static slide-level outputs, or rely on data that is not publicly available, limiting reproducibility. Furthermore, training data containing WSIs paired with detailed clinical reports is scarce, restricting progress toward transparent and generalisable VLMs. We address these limitations with three main contributions. First, we introduce Polysome, a standardised tool for synthetic instruction generation. Second, we apply Polysome to the public HISTAI dataset, generating HISTAI-Instruct, a large whole-slide instruction tuning dataset spanning 24,259 slides and over 1.1 million instruction-response pairs. Finally, we use HISTAI-Instruct to train ANTONI-α, a VLM capable of visual-question answering (VQA). We show that ANTONI-α outperforms MedGemma on WSI-level VQA tasks of tissue identification, neoplasm detection, and differential diagnosis. We also compare the performance of multiple incarnations of ANTONI-α trained with different amounts of data. All methods, data, and code are publicly available.
>
---
#### [new 006] ABE-CLIP: Training-Free Attribute Binding Enhancement for Compositional Image-Text Matching
- **分类: cs.CV; cs.IR**

- **简介: 该论文属多模态图文匹配任务，旨在解决CLIP模型在属性-物体绑定（如“红苹果”）上的细粒度语义缺失问题。提出训练-free的ABE-CLIP方法：通过语义精炼机制优化文本token，并引入局部词元-图像块对齐策略，提升绑定精度。**

- **链接: [https://arxiv.org/pdf/2512.17178v1](https://arxiv.org/pdf/2512.17178v1)**

> **作者:** Qi Zhang; Yuxu Chen; Lei Deng; Lili Shen
>
> **备注:** 10 pages, 8 figures
>
> **摘要:** Contrastive Language-Image Pretraining (CLIP) has achieved remarkable performance in various multimodal tasks. However, it still struggles with compositional image-text matching, particularly in accurately associating objects with their corresponding attributes, because its inherent global representation often overlooks fine-grained semantics for attribute binding. Existing methods often require additional training or extensive hard negative sampling, yet they frequently show limited generalization to novel compositional concepts and fail to fundamentally address the drawbacks of global representations. In this paper, we propose ABE-CLIP, a novel training-free Attribute Binding Enhancement method designed to strengthen attribute-object binding in CLIP-like models. Specifically, we employ a Semantic Refinement Mechanism to refine token embeddings for both object and attribute phrases in the text, thereby mitigating attribute confusion and improving semantic precision. We further introduce a Local Token-Patch Alignment strategy that computes similarity scores between refined textual tokens and their most relevant image patches. By aggregating localized similarity scores, ABE-CLIP computes the final image-text similarity. Experiments on multiple datasets demonstrate that ABE-CLIP significantly improves attribute-object binding performance, even surpassing methods that require extensive training.
>
---
#### [new 007] InsertAnywhere: Bridging 4D Scene Geometry and Diffusion Models for Realistic Video Object Insertion
- **分类: cs.CV; cs.AI**

- **简介: 该论文属视频对象插入（VOI）任务，旨在解决现有方法在4D场景理解、遮挡与光照一致性方面的不足。提出InsertAnywhere框架：先通过4D感知掩码模块实现几何一致的对象时序定位，再基于扩散模型联合合成对象及局部光影变化，并构建ROSE++合成数据集支持训练。**

- **链接: [https://arxiv.org/pdf/2512.17504v1](https://arxiv.org/pdf/2512.17504v1)**
...
>
---
#### [new 008] It is not always greener on the other side: Greenery perception across demographics and personalities in multiple cities
- **分类: cs.CV**

- **简介: 该论文属城市感知研究任务，旨在探究客观绿度测量（如GVI）与主观绿度感知间的差异及成因。作者基于街景图像与千人跨五国视觉调查数据，分析人口统计、人格、空间特征等因素影响，发现居住地（非个体特征）是解释感知差异的最主要因素。**

- **链接: [https://arxiv.org/pdf/2512.17186v1](https://arxiv.org/pdf/2512.17186v1)**
...
>
---
#### [new 009] RadImageNet-VQA: A Large-Scale CT and MRI Dataset for Radiologic Visual Question Answering
...
>
---
#### [new 010] Enhancing Tree Species Classification: Insights from YOLOv8 and Explainable AI Applied to TLS Point Cloud Projections
- **分类: cs.CV; cs.AI**

- **简介: 该论文属树种分类任务，旨在提升模型可解释性。针对TLS点云投影分类中决策过程不透明的问题，提出结合YOLOv8与Finer-CAM的可解释方法，分析特征贡献，揭示冠层与枝干等结构对七类欧洲树种判别的作用机制。**

- **链接: [https://arxiv.org/pdf/2512.16950v1](https://arxiv.org/pdf/2512.16950v1)**
...
>
---
#### [new 022] Bitbox: Behavioral Imaging Toolbox for Computational Analysis of Behavior from Videos
- **分类: cs.CV; q-bio.NC**

- **简介: 该论文提出Bitbox工具箱，属行为计算分析任务，旨在解决AI行为分析工具难被心理学、临床等领域研究者使用的门槛问题。作者设计开源、模块化、可解释的视频行为测量平台，支持面部、头部、身体等多模态高阶行为指标提取，降低技术使用门槛，促进跨学科应用。**

- **链接: [https://arxiv.org/pdf/2512.17655v1](https://arxiv.org/pdf/2512.17655v1)**
...
>
---
#### [new 028] Towards Pixel-Wise Anomaly Location for High-Resolution PCBA \\ via Self-Supervised Image Reconstruction
- **分类: cs.CV**

- **简介: 该论文面向高分辨率PCBA缺陷检测任务，解决微小缺陷定位难、标注数据少、重建伪影多等问题。提出HiSIR-Net框架，含SIR-Gate和ROPS模块，实现像素级异常定位；构建SIPCBA-500数据集，验证方法在精度与速度上的优越性。**

- **链接: [https://arxiv.org/pdf/2512.17296v1](https://arxiv.org/pdf/2512.17296v1)**
...
>
---
#### [new 043] Xiaomi MiMo-VL-Miloco Technical Report
- **分类: cs.CV**

- **简介: 该论文提出面向智能家居的视觉语言模型MiMo-VL-Miloco-7B，解决家庭场景理解与通用多模态推理兼顾难题。通过两阶段训练（监督微调+组相对策略优化）、思维链监督和令牌预算感知推理，提升手势识别、视频理解等性能，并开源模型、量化权重及评测工具。**

- **链接: [https://arxiv.org/pdf/2512.17436v1](https://arxiv.org/pdf/2512.17436v1)**
...
>
---
#### [new 048] Robust Scene Coordinate Regression via Geometrically-Consistent Global Descriptors
- **分类: cs.CV**

- **简介: 该论文属视觉定位任务，旨在解决现有方法仅依赖几何线索导致全局描述符判别力弱、鲁棒性差的问题。提出融合几何结构与视觉相似性的聚合模块，结合基于重叠分的批采样与改进对比损失，实现无标签训练与跨场景泛化。**

- **链接: [https://arxiv.org/pdf/2512.17226v1](https://arxiv.org/pdf/2512.17226v1)**
...
>
---
#### [new 049] A unified FLAIR hyperintensity segmentation model for various CNS tumor types and acquisition time points
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出一种基于Attention U-Net的统一FLAIR高信号分割模型，旨在自动分割多种中枢神经系统肿瘤（如脑膜瘤、转移瘤、胶质瘤）及不同时期（术前/术后）MRI中的FLAIR高信号区域，解决临床中跨病种、跨时间点泛化性差的问题。**

- **链接: [https://arxiv.org/pdf/2512.17566v1](https://arxiv.org/pdf/2512.17566v1)**
...
>
---
#### [new 052] FLEG: Feed-Forward Language Embedded Gaussian Splatting from Any Views
- **分类: cs.CV**

- **简介: 该论文提出FLEG方法，属多视图3D重建任务，旨在从任意未标定、稀疏或稠密的2D图像中，端到端生成带语言语义嵌入的3D高斯泼溅表示。其创新包括：无3D标注的训练框架、实例引导的对比学习对齐2D/3D语义、几何-语义分层稀疏化策略。**

- **链接: [https://arxiv.org/pdf/2512.17541v1](https://arxiv.org/pdf/2512.17541v1)**
...
>
---
#### [new 057] Video Detective: Seek Critical Clues Recurrently to Answer Question from Long Videos
- **分类: cs.CV**

- **简介: 该论文面向长视频问答（LVQA）任务，解决MLLM处理超长视频时内存爆炸与信息过载问题。提出VideoDetective方法：通过问题感知的迭代子段处理、记忆令牌压缩与历史上下文递归聚合，高效定位关键线索。并构建GLVC新数据集评估。**

- **链接: [https://arxiv.org/pdf/2512.17229v1](https://arxiv.org/pdf/2512.17229v1)**
...
>
---
#### [new 060] Region-Constraint In-Context Generation for Instructional Video Editing
- **分类: cs.CV; cs.MM**

- **简介: 该论文面向指令驱动的视频编辑任务，解决区域不明确导致的编辑不准与跨区域token干扰问题。提出ReCo方法：宽向拼接源/目标视频联合去噪，引入潜在空间与注意力双重正则化，并构建50万对ReCo-Data数据集。**

- **链接: [https://arxiv.org/pdf/2512.17650v1](https://arxiv.org/pdf/2512.17650v1)**

> **作者:** Zhongwei Zhang; Fuchen Long; Wei Li; Zhaofan Qiu; Wu Liu; Ting Yao; Tao Mei
>
> **备注:** Project page: https://zhw-zhang.github.io/ReCo-page/
>
> **摘要:** The In-context generation paradigm recently has demonstrated strong power in instructional image editing with both data efficiency and synthesis quality. Nevertheless, shaping such in-context learning for instruction-based video editing is not trivial. Without specifying editing regions, the results can suffer from the problem of inaccurate editing regions and the token interference between editing and non-editing areas during denoising. To address these, we present ReCo, a new instructional video editing paradigm that novelly delves into constraint modeling between editing and non-editing regions during in-context generation. Technically, ReCo width-wise concatenates source and target video for joint denoising. To calibrate video diffusion learning, ReCo capitalizes on two regularization terms, i.e., latent and attention regularization, conducting on one-step backward denoised latents and attention maps, respectively. The former increases the latent discrepancy of the editing region between source and target videos while reducing that of non-editing areas, emphasizing the modification on editing area and alleviating outside unexpected content generation. The latter suppresses the attention of tokens in the editing region to the tokens in counterpart of the source video, thereby mitigating their interference during novel object generation in target video. Furthermore, we propose a large-scale, high-quality video editing dataset, i.e., ReCo-Data, comprising 500K instruction-video pairs to benefit model training. Extensive experiments conducted on four major instruction-based video editing tasks demonstrate the superiority of our proposal.
>
---
#### [new 061] Visually Prompted Benchmarks Are Surprisingly Fragile
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究视觉提示基准（VPB）的脆弱性问题，揭示其性能易受视觉标记颜色、大小、JPEG压缩等无关细节影响，导致模型排名失真。作者构建了含16种标记变体的稳健基准VPBench，并开源以提升VLM评估可靠性。**

- **链接: [https://arxiv.org/pdf/2512.17875v1](https://arxiv.org/pdf/2512.17875v1)**
...
>
> **摘要:** Long-form multimodal video understanding requires integrating vision, speech, and ambient audio with coherent long-range reasoning. Existing benchmarks emphasize either temporal length or multimodal richness, but rarely both and while some incorporate open-ended questions and advanced metrics, they mostly rely on single-score accuracy, obscuring failure modes. We introduce LongShOTBench, a diagnostic benchmark with open-ended, intent-driven questions; single- and multi-turn dialogues; and tasks requiring multimodal reasoning and agentic tool use across video, audio, and speech. Each item includes a reference answer and graded rubric for interpretable, and traceable evaluation. LongShOTBench is produced via a scalable, human-validated pipeline to ensure coverage and reproducibility. All samples in our LongShOTBench are human-verified and corrected. Furthermore, we present LongShOTAgent, an agentic system that analyzes long videos via preprocessing, search, and iterative refinement. On LongShOTBench, state-of-the-art MLLMs show large gaps: Gemini-2.5-Flash achieves 52.95%, open-source models remain below 30%, and LongShOTAgent attains 44.66%. These results underscore the difficulty of real-world long-form video understanding. LongShOTBench provides a practical, reproducible foundation for evaluating and improving MLLMs. All resources are available on GitHub: https://github.com/mbzuai-oryx/longshot.
>
---
#### [new 066] AnyCXR: Human Anatomy Segmentation of Chest X-ray at Any Acquisition Position using Multi-stage Domain Randomized Synthetic Data with Imperfect Annotations and Conditional Joint Annotation Regularization Learning
- **分类: cs.CV**

- **简介: 该论文属医学图像分割任务，旨在解决胸片（CXRs）因标注稀缺、成像角度多变导致的解剖结构分割泛化性差问题。提出AnyCXR框架：用多阶段域随机化生成10万+合成X光片，并通过条件联合标注正则化学习利用不完美标注，实现零样本跨角度54结构精准分割。**

- **链接: [https://arxiv.org/pdf/2512.17263v1](https://arxiv.org/pdf/2512.17263v1)**
...
>
---
#### [new 068] Chorus: Multi-Teacher Pretraining for Holistic 3D Gaussian Scene Encoding
- **分类: cs.CV**

- **简介: 该论文提出Chorus框架，解决3D高斯泼溅（3DGS）场景缺乏通用特征编码的问题。通过多教师知识蒸馏（语言对齐、通用、物体感知模型），学习共享的前馈3D编码器，并支持点云迁移与渲染蒸馏微调。**

- **链接: [https://arxiv.org/pdf/2512.17817v1](https://arxiv.org/pdf/2512.17817v1)**
...
>
---
#### [new 071] Medical Imaging AI Competitions Lack Fairness
- **分类: cs.CV**

- **简介: 该论文属科技伦理与AI评估任务，旨在揭示医学影像AI竞赛在数据代表性与可重用性上的公平性缺陷。作者系统分析241个挑战赛的458项任务，发现其存在地域、模态及问题类型偏差，且常受限于模糊许可、文档缺失等问题，导致临床相关性弱、复现困难。**

- **链接: [https://arxiv.org/pdf/2512.17581v1](https://arxiv.org/pdf/2512.17581v1)**
...
>
---
#### [new 077] Interpretable Plant Leaf Disease Detection Using Attention-Enhanced CNN
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向植物叶片病害检测任务，旨在解决现有模型可解释性差、定位不准的问题。提出CBAM-VGG16模型，在VGG16中嵌入CBAM模块以增强特征提取与病灶定位能力，并结合多种可视化方法验证其可解释性，提升农业智能诊断的透明性与可靠性。**

- **链接: [https://arxiv.org/pdf/2512.17864v1](https://arxiv.org/pdf/2512.17864v1)**
...
>
---
#### [new 078] Animate Any Character in Any World
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出AniX方法，属具身AI与生成式视频任务，旨在解决现有世界模型无法同时支持高保真静态场景与多角色开放动作控制的问题。它将3DGS场景与用户指定角色结合，通过自然语言驱动角色完成多样化交互，并生成时序一致、视觉保真的视频。**

- **链接: [https://arxiv.org/pdf/2512.17796v1](https://arxiv.org/pdf/2512.17796v1)**
...
>
---
#### [new 084] Validation of Diagnostic Artificial Intelligence Models for Prostate Pathology in a Middle Eastern Cohort
- **分类: cs.CV**

- **简介: 该论文属医学AI验证任务，旨在解决病理AI模型在中东等欠代表人群中的泛化性问题。研究首次在伊拉克库尔德地区339例前列腺活检样本上，外部验证了AI模型的诊断与Gleason分级性能，并评估其跨不同数字扫描仪（含低成本款）的一致性。**

- **链接: [https://arxiv.org/pdf/2512.17499v1](https://arxiv.org/pdf/2512.17499v1)**
...
>
---
#### [new 091] EMMA: Concept Erasure Benchmark with Comprehensive Semantic Metrics and Diverse Categories
- **分类: cs.CV**

- **简介: 该论文提出EMMA基准，用于评估文本到图像模型中的概念擦除技术。旨在解决现有方法评测不全面、缺乏语义鲁棒性与社会意识分析的问题。工作包括构建12项多维指标，覆盖5类概念，测试隐式提示、相似干扰及偏见等挑战，并实证分析5种方法的局限性。**

- **链接: [https://arxiv.org/pdf/2512.17320v1](https://arxiv.org/pdf/2512.17320v1)**
...
>
---
#### [new 092] SDUM: A Scalable Deep Unrolled Model for Universal MRI Reconstruction
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出SDUM——一种可扩展的通用MRI重建深度展开模型，旨在解决现有方法泛化差、需协议定制的问题。它融合Restormer重建器、学习型线圈估计、采样感知数据一致性、通用条件机制及渐进级联训练，在多任务上实现SOTA且无需微调。**

- **链接: [https://arxiv.org/pdf/2512.17137v1](https://arxiv.org/pdf/2512.17137v1)**
...
>
---
#### [new 097] InfSplign: Inference-Time Spatial Alignment of Text-to-Image Diffusion Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属文本到图像生成任务，旨在解决扩散模型对文本中空间关系（如物体位置、布局）理解不足的问题。提出InfSplign——一种无需训练、即插即用的推理时方法，通过在每步去噪中利用跨注意力图设计复合损失，优化噪声调整，提升空间对齐精度。**

- **链接: [https://arxiv.org/pdf/2512.17851v1](https://arxiv.org/pdf/2512.17851v1)**
...
>
---
#### [new 100] SAVeD: A First-Person Social Media Video Dataset for ADAS-equipped vehicle Near-Miss and Crash Event Analyses
- **分类: cs.CV**

- **简介: 该论文属自动驾驶安全分析任务，旨在解决ADAS车辆真实高风险场景（如近撞、失灵）数据缺失问题。作者构建首个大规模第一人称社交视频数据集SAVeD（2119段），含细粒度帧级标注，并提出TTC计算框架、极端风险建模方法及VLLM基准测试。**

- **链接: [https://arxiv.org/pdf/2512.17724v1](https://arxiv.org/pdf/2512.17724v1)**
...
>
---
#### [new 101] 3D-RE-GEN: 3D Reconstruction of Indoor Scenes with a Generative Framework
- **分类: cs.CV**

- **简介: 该论文属单图像室内场景3D重建任务，旨在解决现有方法物体分解错误、空间关系不准、缺失背景等问题。提出3D-RE-GEN框架，融合多领域SOTA模型，通过资产检测、重建与放置、生成完整背景、4-DoF地面约束优化，实现可编辑、物理合理的纹理网格场景重建。**

- **链接: [https://arxiv.org/pdf/2512.17459v1](https://arxiv.org/pdf/2512.17459v1)**
...
>
---
#### [new 110] Breast Cancer Neoadjuvant Chemotherapy Treatment Response Prediction Using Aligned Longitudinal MRI and Clinical Data
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属医学影像辅助诊断任务，旨在预测乳腺癌新辅助化疗后的病理完全缓解（PCR）和5年无复发生存（RFS）。作者提出基于MRI图像配准的纵向特征提取框架，比较多种特征提取器与模型，发现配准增强的放射组学方法性能最优、可解释性好。**

- **链接: [https://arxiv.org/pdf/2512.17759v1](https://arxiv.org/pdf/2512.17759v1)**
...
>
---
#### [new 111] Colormap-Enhanced Vision Transformers for MRI-Based Multiclass (4-Class) Alzheimer's Disease Classification
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属医学图像多分类任务，旨在提升MRI脑扫描对阿尔茨海默病（4级痴呆程度）的自动识别精度。针对灰度MRI纹理对比弱、特征难提取的问题，提出PseudoColorViT-Alz模型，融合伪彩色映射与视觉Transformer，显著提升分类性能（99.79%准确率，AUC 100%）。**

- **链接: [https://arxiv.org/pdf/2512.16964v1](https://arxiv.org/pdf/2512.16964v1)**
...
>
---
#### [new 112] MedNeXt-v2: Scaling 3D ConvNeXts for Large-Scale Supervised Representation Learning in Medical Image Segmentation
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **简介: 该论文面向3D医学图像分割任务，解决现有大规模监督预训练中主干网络表征能力不足的问题。提出MedNeXt-v2——一种经微架构改进（如3D GRN）与复合缩放（深度/宽度/上下文）的3D ConvNeXt，在18k CT上预训练，显著提升下游多模态、多结构分割性能。**

- **链接: [https://arxiv.org/pdf/2512.17774v1](https://arxiv.org/pdf/2512.17774v1)**
...
>
---
#### [new 113] MAD-OOD: A Deep Learning Cluster-Driven Framework for an Out-of-Distribution Malware Detection and Classification
- **分类: cs.CR; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属OOD（分布外）恶意软件检测与分类任务，旨在解决现有模型因闭集假设和忽略族内变异而无法识别新型恶意软件的问题。提出MAD-OOD框架：第一阶段用GDA建模球形决策边界并基于Z分数距离检测OOD样本；第二阶段融合聚类预测与监督输出提升分类精度。**

- **链接: [https://arxiv.org/pdf/2512.17594v1](https://arxiv.org/pdf/2512.17594v1)**
...
>
---
#### [new 114] Adaptive Covariance and Quaternion-Focused Hybrid Error-State EKF/UKF for Visual-Inertial Odometry
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 115] SkinGenBench: Generative Model and Preprocessing Effects for Synthetic Dermoscopic Augmentation in Melanoma Diagnosis
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属医学图像生成与诊断任务，旨在探究生成模型与预处理对合成皮肤镜图像质量及黑色素瘤诊断性能的影响。作者构建SkinGenBench基准，对比StyleGAN2-ADA与DDPM在不同预处理下的表现，发现模型选择比预处理更关键，并验证合成数据可显著提升诊断F1和AUC。**

- **链接: [https://arxiv.org/pdf/2512.17585v1](https://arxiv.org/pdf/2512.17585v1)**
...
>
---
#### [new 116] Are Vision Language Models Cross-Cultural Theory of Mind Reasoners?
...
>
---
#### [replaced 003] Restrictive Hierarchical Semantic Segmentation for Stratified Tooth Layer Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.07984v2](https://arxiv.org/pdf/2512.07984v2)**
...
>
---
#### [replaced 004] Discovering Latent Graphs with GFlowNets for Diverse Conditional Image Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.22107v2](https://arxiv.org/pdf/2510.22107v2)**
...
>
---
#### [replaced 007] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2411.15355v3](https://arxiv.org/pdf/2411.15355v3)**

> **作者:** Yuan Ren; Guile Wu; Runhao Li; Zheyuan Yang; Yibo Liu; Xingxin Chen; Tongtong Cao; Bingbing Liu
>
> **备注:** 3DV 2026
>
> **摘要:** Urban scene reconstruction is crucial for real-world autonomous driving simulators. Although existing methods have achieved photorealistic reconstruction, they mostly focus on pinhole cameras and neglect fisheye cameras. In fact, how to effectively simulate fisheye cameras in driving scene remains an unsolved problem. In this work, we propose UniGaussian, a novel approach that learns a unified 3D Gaussian representation from multiple camera models for urban scene reconstruction in autonomous driving. Our contributions are two-fold. First, we propose a new differentiable rendering method that distorts 3D Gaussians using a series of affine transformations tailored to fisheye camera models. This addresses the compatibility issue of 3D Gaussian splatting with fisheye cameras, which is hindered by light ray distortion caused by lenses or mirrors. Besides, our method maintains real-time rendering while ensuring differentiability. Second, built on the differentiable rendering method, we design a new framework that learns a unified Gaussian representation from multiple camera models. By applying affine transformations to adapt different camera models and regularizing the shared Gaussians with supervision from different modalities, our framework learns a unified 3D Gaussian representation with input data from multiple sources and achieves holistic driving scene understanding. As a result, our approach models multiple sensors (pinhole and fisheye cameras) and modalities (depth, semantic, normal and LiDAR point clouds). Our experiments show that our method achieves superior rendering quality and fast rendering speed for driving scene simulation.
>
---
#### [replaced 008] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.13911v2](https://arxiv.org/pdf/2508.13911v2)**
...
>
---
#### [replaced 018] Equivariant symmetry-aware head pose estimation for fetal MRI
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.04890v4](https://arxiv.org/pdf/2512.04890v4)**
...
>
---
#### [replaced 019] Seeing Structural Failure Before it Happens: An Image-Based Physics-Informed Neural Network (PINN) for Spaghetti Bridge Load Prediction
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23117v3](https://arxiv.org/pdf/2510.23117v3)**
...
>
---
#### [replaced 020] Step-GUI Technical Report
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.15431v2](https://arxiv.org/pdf/2512.15431v2)**
...
>
---
#### [replaced 021] V-Rex: Real-Time Streaming Video LLM Acceleration via Dynamic KV Cache Retrieval
- **分类: eess.IV; cs.AI; cs.AR; cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2512.12284v2](https://arxiv.org/pdf/2512.12284v2)**
...
>
---
#### [replaced 025] CLUENet: Cluster Attention Makes Neural Networks Have Eyes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06345v2](https://arxiv.org/pdf/2512.06345v2)**
...
>
---
#### [replaced 028] The Generation Phases of Flow Matching: a Denoising Perspective
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.24830v2](https://arxiv.org/pdf/2510.24830v2)**
...
>
---
#### [replaced 031] MiVLA: Towards Generalizable Vision-Language-Action Model with Human-Robot Mutual Imitation Pre-training
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 032] DocR1: Evidence Page-Guided GRPO for Multi-Page Document Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.07313v3](https://arxiv.org/pdf/2508.07313v3)**
...
>
---
#### [replaced 033] SGS-3D: High-Fidelity 3D Instance Segmentation via Reliable Semantic Mask Splitting and Growing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.05144v2](https://arxiv.org/pdf/2509.05144v2)**
...
>
---
#### [replaced 034] mimic-video: Video-Action Models for Generalizable Robot Control Beyond VLAs
...
>
---
#### [replaced 035] A multi-centre, multi-device benchmark dataset for landmark-based comprehensive fetal biometry
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16710v2](https://arxiv.org/pdf/2512.16710v2)**
...
>
---
#### [replaced 036] TimeSenCLIP: A Time Series Vision-Language Model for Remote Sensing Using Single-Pixel
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.11919v2](https://arxiv.org/pdf/2508.11919v2)**
...
>
---
#### [replaced 039] Towards Facilitated Fairness Assessment of AI-based Skin Lesion Classifiers Through GenAI-based Image Synthesis
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.17860v3](https://arxiv.org/pdf/2507.17860v3)**
...
>
---
#### [replaced 040] SSCATeR: Sparse Scatter-Based Convolution Algorithm with Temporal Data Recycling for Real-Time 3D Object Detection in LiDAR Point Clouds
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08557v2](https://arxiv.org/pdf/2512.08557v2)**
...
>
---
#### [replaced 041] Journey Before Destination: On the importance of Visual Faithfulness in Slow Thinking
...
>
---
#### [replaced 042] Human Mesh Modeling for Anny Body
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.03589v2](https://arxiv.org/pdf/2511.03589v2)**
...
>
---
#### [replaced 044] LookAhead Tuning: Safer Language Models via Partial Answer Previews
...
>
---
#### [replaced 045] Is Nano Banana Pro a Low-Level Vision All-Rounder? A Comprehensive Evaluation on 14 Tasks and 40 Datasets
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.15110v2](https://arxiv.org/pdf/2512.15110v2)**
...
>
---
#### [replaced 046] Text-guided multi-stage cross-perception network for medical image segmentation
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.07475v3](https://arxiv.org/pdf/2506.07475v3)**
...
>
---
#### [replaced 050] Human-like Content Analysis for Generative AI with Language-Grounded Sparse Encoders
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.18236v3](https://arxiv.org/pdf/2508.18236v3)**
...
>
---
#### [replaced 053] LN3DIFF++: Scalable Latent Neural Fields Diffusion for Speedy 3D Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2403.12019v3](https://arxiv.org/pdf/2403.12019v3)**
...
>
> **摘要:** The field of neural rendering has witnessed significant progress with advancements in generative models and differentiable rendering techniques. Though 2D diffusion has achieved success, a unified 3D diffusion pipeline remains unsettled. This paper introduces a novel framework called LN3Diff++ to address this gap and enable fast, high-quality, and generic conditional 3D generation. Our approach harnesses a 3D-aware architecture and variational autoencoder (VAE) to encode the input image into a structured, compact, and 3D latent space. The latent is decoded by a transformer-based decoder into a high-capacity 3D neural field. Through training a diffusion model on this 3D-aware latent space, our method achieves state-of-the-art performance on ShapeNet for 3D generation and demonstrates superior performance in monocular 3D reconstruction and conditional 3D generation across various datasets. Moreover, it surpasses existing 3D diffusion methods in terms of inference speed, requiring no per-instance optimization. Our proposed LN3Diff presents a significant advancement in 3D generative modeling and holds promise for various applications in 3D vision and graphics tasks.
>
---
#### [replaced 054] STAGNet: A Spatio-Temporal Graph and LSTM Framework for Accident Anticipation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.15216v3](https://arxiv.org/pdf/2508.15216v3)**
...
>
---
#### [replaced 055] FlowerDance: MeanFlow for Efficient and Refined 3D Dance Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21029v2](https://arxiv.org/pdf/2511.21029v2)**
...
>
---
#### [replaced 056] From Engineering Diagrams to Graphs: Digitizing P&IDs with Transformers
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.13929v3](https://arxiv.org/pdf/2411.13929v3)**

> **作者:** Jan Marius Stürmer; Marius Graumann; Tobias Koch
>
> **备注:** (c) 2025 IEEE. Published in the conference proceedings of the 2025 IEEE 12th International Conference on Data Science and Advanced Analytics (DSAA)
>
...
>
---
#### [replaced 057] FakeParts: a New Family of AI-Generated DeepFakes
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [https://arxiv.org/pdf/2508.21052v2](https://arxiv.org/pdf/2508.21052v2)**

> **作者:** Ziyi Liu; Firas Gabetni; Awais Hussain Sani; Xi Wang; Soobash Daiboo; Gaetan Brison; Gianni Franchi; Vicky Kalogeiton
>
...
>
---
#### [replaced 058] VideoGameQA-Bench: Evaluating Vision-Language Models for Video Game Quality Assurance
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.15952v2](https://arxiv.org/pdf/2505.15952v2)**
