...
#### [new 001] ROMAN: Reward-Orchestrated Multi-Head Attention Network for Autonomous Driving System Testing
- **分类: cs.CV**

- **简介: 该论文属于自动驾驶系统测试任务，旨在解决现有测试方法在生成高风险违规场景上的不足。提出ROMAN模型，结合多头注意力与交通法规权重机制，有效生成多样且高风险的测试场景。**

- **链接: [https://arxiv.org/pdf/2602.05629v1](https://arxiv.org/pdf/2602.05629v1)**
...
>
---
#### [new 002] Contour Refinement using Discrete Diffusion in Low Data Regime
- **分类: cs.CV**

- **简介: 该论文属于边界检测任务，解决低数据环境下不规则和半透明物体的边界识别问题。通过轻量级离散扩散方法，提升边界检测效果与效率。**

- **链接: [https://arxiv.org/pdf/2602.05880v1](https://arxiv.org/pdf/2602.05880v1)**
...
>
---
#### [new 007] Enhancing Personality Recognition by Comparing the Predictive Power of Traits, Facets, and Nuances
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于人格识别任务，旨在解决因依赖粗粒度特质评分导致的模型泛化问题。通过引入更细粒度的维度和细微特征，提升从多模态数据中识别人格的准确性。**

- **链接: [https://arxiv.org/pdf/2602.05650v1](https://arxiv.org/pdf/2602.05650v1)**
...
>
---
#### [new 016] Self-Supervised Learning with a Multi-Task Latent Space Objective
- **分类: cs.CV**

- **简介: 该论文属于自监督学习任务，解决多裁剪策略在Siamese网络中的不稳定问题。通过为不同视图分配独立预测器，并引入遮罩视图，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.05845v1](https://arxiv.org/pdf/2602.05845v1)**
...
>
---
#### [new 017] Sparse Video Generation Propels Real-World Beyond-the-View Vision-Language Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 018] RFM-Pose:Reinforcement-Guided Flow Matching for Fast Category-Level 6D Pose Estimation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 019] LoGoSeg: Integrating Local and Global Features for Open-Vocabulary Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文属于开放词汇语义分割任务，解决传统方法在模糊场景中分割不准确的问题。提出LoGoSeg框架，融合局部与全局特征，提升分割精度和泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.05578v1](https://arxiv.org/pdf/2602.05578v1)**

> **作者:** Junyang Chen; Xiangbo Lv; Zhiqiang Kou; Xingdong Sheng; Ning Xu; Yiguo Qiao
>
> **摘要:** Open-vocabulary semantic segmentation (OVSS) extends traditional closed-set segmentation by enabling pixel-wise annotation for both seen and unseen categories using arbitrary textual descriptions. While existing methods leverage vision-language models (VLMs) like CLIP, their reliance on image-level pretraining often results in imprecise spatial alignment, leading to mismatched segmentations in ambiguous or cluttered scenes. However, most existing approaches lack strong object priors and region-level constraints, which can lead to object hallucination or missed detections, further degrading performance. To address these challenges, we propose LoGoSeg, an efficient single-stage framework that integrates three key innovations: (i) an object existence prior that dynamically weights relevant categories through global image-text similarity, effectively reducing hallucinations; (ii) a region-aware alignment module that establishes precise region-level visual-textual correspondences; and (iii) a dual-stream fusion mechanism that optimally combines local structural information with global semantic context. Unlike prior works, LoGoSeg eliminates the need for external mask proposals, additional backbones, or extra datasets, ensuring efficiency. Extensive experiments on six benchmarks (A-847, PC-459, A-150, PC-59, PAS-20, and PAS-20b) demonstrate its competitive performance and strong generalization in open-vocabulary settings.
>
---
#### [new 020] PIRATR: Parametric Object Inference for Robotic Applications with Transformers in 3D Point Clouds
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 028] DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频生成任务，旨在解决扩散模型计算负担重与加速方法质量下降的问题。通过引入可学习的特征缓存机制和稳定蒸馏方法，提升加速效果并保持生成质量。**

- **链接: [https://arxiv.org/pdf/2602.05449v1](https://arxiv.org/pdf/2602.05449v1)**
...
>
---
#### [new 029] Visual concept ranking uncovers medical shortcuts used by large multimodal models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医疗AI审计任务，旨在发现大模型在医学任务中的缺陷。通过视觉概念排序方法，识别模型依赖的视觉特征并验证其偏差。**

- **链接: [https://arxiv.org/pdf/2602.05096v1](https://arxiv.org/pdf/2602.05096v1)**
...
>
---
#### [new 030] Predicting Camera Pose from Perspective Descriptions for Spatial Reasoning
- **分类: cs.CV**

- **简介: 该论文属于多视角空间推理任务，旨在解决从语言描述中预测相机位姿的问题。通过引入CAMCUE框架，提升跨视角融合与新视角推理的准确性与效率。**

- **链接: [https://arxiv.org/pdf/2602.06041v1](https://arxiv.org/pdf/2602.06041v1)**
...
>
---
#### [new 039] Multimodal Latent Reasoning via Hierarchical Visual Cues Injection
- **分类: cs.CV**

- **简介: 该论文提出HIVE框架，解决多模态模型推理效率低、易幻觉的问题。通过引入层次化视觉线索，在潜在空间中实现更稳健的多步推理。属于多模态推理任务。**

- **链接: [https://arxiv.org/pdf/2602.05359v1](https://arxiv.org/pdf/2602.05359v1)**
...
>
> **备注:** Accepted by ICLR2026, Project page: fastvmt.gitHub.io, Code: https://github.com/mayuelala/FastVMT
>
...
>
---
#### [new 042] SwimBird: Eliciting Switchable Reasoning Mode in Hybrid Autoregressive MLLMs
- **分类: cs.CV**

- **简介: 该论文提出SwimBird，一种可切换推理模式的多模态大语言模型，解决传统模型在视觉和文本推理中适应性不足的问题。通过动态切换三种推理模式，提升多模态任务性能。**

- **链接: [https://arxiv.org/pdf/2602.06040v1](https://arxiv.org/pdf/2602.06040v1)**
...
>
---
#### [new 046] GT-SVJ: Generative-Transformer-Based Self-Supervised Video Judge For Efficient Video Reward Modeling
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决视频生成模型与人类偏好对齐的问题。提出一种基于生成模型的自监督视频评价方法，通过重构为能量模型提升视频质量评估效果。**

- **链接: [https://arxiv.org/pdf/2602.05202v1](https://arxiv.org/pdf/2602.05202v1)**
...
>
---
#### [new 050] Poster: Camera Tampering Detection for Outdoor IoT Systems
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像篡改检测任务，旨在解决户外物联网系统中摄像头图像被篡改的问题。提出两种检测方法，并提供数据集支持研究。**

- **链接: [https://arxiv.org/pdf/2602.05706v1](https://arxiv.org/pdf/2602.05706v1)**
...
>
---
#### [new 055] E.M.Ground: A Temporal Grounding Vid-LLM with Holistic Event Perception and Matching
- **分类: cs.CV**

- **简介: 该论文提出E.M.Ground，解决视频中时间片段定位任务（TVG）中的语义连续性问题，通过引入事件标记、平滑算法和多粒度特征聚合提升匹配精度。**

- **链接: [https://arxiv.org/pdf/2602.05215v1](https://arxiv.org/pdf/2602.05215v1)**
...
>
---
#### [new 060] Disco: Densely-overlapping Cell Instance Segmentation via Adjacency-aware Collaborative Coloring
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于细胞实例分割任务，解决密集重叠细胞的分割难题。提出Disco框架，结合拓扑标注与深度学习，有效处理复杂邻接关系。**

- **链接: [https://arxiv.org/pdf/2602.05420v1](https://arxiv.org/pdf/2602.05420v1)**
...
>
---
#### [new 062] PatchFlow: Leveraging a Flow-Based Model with Patch Features
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于工业缺陷检测任务，旨在解决 die casting 表面缺陷检测问题。通过结合局部特征与流模型，提升异常检测的准确性和效率。**

- **链接: [https://arxiv.org/pdf/2602.05238v1](https://arxiv.org/pdf/2602.05238v1)**
...
>
---
#### [new 063] V-Retrver: Evidence-Driven Agentic Reasoning for Universal Multimodal Retrieval
- **分类: cs.CV**

- **简介: 该论文提出V-Retrver，解决多模态检索中视觉证据不足的问题。通过主动获取视觉证据，提升检索准确性和推理可靠性。**

- **链接: [https://arxiv.org/pdf/2602.06034v1](https://arxiv.org/pdf/2602.06034v1)**
...
>
> **摘要:** SAM3D enables scalable, open-world 3D reconstruction from complex scenes, yet its deployment is hindered by prohibitive inference latency. In this work, we conduct the \textbf{first systematic investigation} into its inference dynamics, revealing that generic acceleration strategies are brittle in this context. We demonstrate that these failures stem from neglecting the pipeline's inherent multi-level \textbf{heterogeneity}: the kinematic distinctiveness between shape and layout, the intrinsic sparsity of texture refinement, and the spectral variance across geometries. To address this, we present \textbf{Fast-SAM3D}, a training-free framework that dynamically aligns computation with instantaneous generation complexity. Our approach integrates three heterogeneity-aware mechanisms: (1) \textit{Modality-Aware Step Caching} to decouple structural evolution from sensitive layout updates; (2) \textit{Joint Spatiotemporal Token Carving} to concentrate refinement on high-entropy regions; and (3) \textit{Spectral-Aware Token Aggregation} to adapt decoding resolution. Extensive experiments demonstrate that Fast-SAM3D delivers up to \textbf{2.67$\times$} end-to-end speedup with negligible fidelity loss, establishing a new Pareto frontier for efficient single-view 3D generation. Our code is released in https://github.com/wlfeng0509/Fast-SAM3D.
>
---
#### [new 066] Wid3R: Wide Field-of-View 3D Reconstruction via Camera Model Conditioning
- **分类: cs.CV**

- **简介: 该论文提出Wid3R，解决宽视场3D重建问题。通过引入球面谐波和相机模型令牌，实现无畸变的多视角3D重建。**

- **链接: [https://arxiv.org/pdf/2602.05321v1](https://arxiv.org/pdf/2602.05321v1)**
...
>
---
#### [new 067] GenArena: How Can We Achieve Human-Aligned Evaluation for Visual Generation Tasks?
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉生成任务，旨在解决传统评估方法与人类感知不一致的问题。通过引入GenArena框架，采用成对比较提升评估准确性与一致性。**

- **链接: [https://arxiv.org/pdf/2602.06013v1](https://arxiv.org/pdf/2602.06013v1)**

> **作者:** Ruihang Li; Leigang Qu; Jingxu Zhang; Dongnan Gui; Mengde Xu; Xiaosong Zhang; Han Hu; Wenjie Wang; Jiaqi Wang
>
> **备注:** Project Page: https://genarena.github.io/, Code: https://github.com/ruihanglix/genarena
>
> **摘要:** The rapid advancement of visual generation models has outpaced traditional evaluation approaches, necessitating the adoption of Vision-Language Models as surrogate judges. In this work, we systematically investigate the reliability of the prevailing absolute pointwise scoring standard, across a wide spectrum of visual generation tasks. Our analysis reveals that this paradigm is limited due to stochastic inconsistency and poor alignment with human perception. To resolve these limitations, we introduce GenArena, a unified evaluation framework that leverages a pairwise comparison paradigm to ensure stable and human-aligned evaluation. Crucially, our experiments uncover a transformative finding that simply adopting this pairwise protocol enables off-the-shelf open-source models to outperform top-tier proprietary models. Notably, our method boosts evaluation accuracy by over 20% and achieves a Spearman correlation of 0.86 with the authoritative LMArena leaderboard, drastically surpassing the 0.36 correlation of pointwise methods. Based on GenArena, we benchmark state-of-the-art visual generation models across diverse tasks, providing the community with a rigorous and automated evaluation standard for visual generation.
>
---
#### [new 068] Visual Implicit Geometry Transformer for Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文提出ViGT模型，用于自动驾驶中的3D占用场估计。解决多传感器配置下的几何建模问题，通过自监督学习实现高效、通用的场景理解。**

- **链接: [https://arxiv.org/pdf/2602.05573v1](https://arxiv.org/pdf/2602.05573v1)**
...
>
---
#### [new 080] EgoPoseVR: Spatiotemporal Multi-Modal Reasoning for Egocentric Full-Body Pose in Virtual Reality
- **分类: cs.CV; cs.ET; cs.GR**

- **简介: 该论文属于姿态估计任务，解决VR中自观视角全身姿态追踪问题。提出EgoPoseVR框架，融合头显与RGB-D数据，提升姿态准确性与稳定性。**

- **链接: [https://arxiv.org/pdf/2602.05590v1](https://arxiv.org/pdf/2602.05590v1)**
...
>
---
#### [new 081] FlashBlock: Attention Caching for Efficient Long-Context Block Diffusion
...
>
---
#### [new 082] RISE-Video: Can Video Generators Decode Implicit World Rules?
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出RISE-Video基准，用于评估视频生成模型对隐含世界规则的理解与推理能力，解决当前模型在复杂场景模拟中的不足。**

- **链接: [https://arxiv.org/pdf/2602.05986v1](https://arxiv.org/pdf/2602.05986v1)**
...
>
---
#### [new 088] A Comparative Study of 3D Person Detection: Sensor Modalities and Robustness in Diverse Indoor and Outdoor Environments
- **分类: cs.CV**

- **简介: 该论文属于3D人体检测任务，旨在比较不同传感器模态在复杂环境中的检测性能与鲁棒性。通过分析相机、激光雷达及融合模型，验证了融合方法的优势及存在的问题。**

- **链接: [https://arxiv.org/pdf/2602.05538v1](https://arxiv.org/pdf/2602.05538v1)**
...
>
---
#### [new 091] CLEAR-HPV: Interpretable Concept Discovery for HPV-Associated Morphology in Whole-Slide Histology
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在解决HPV相关组织形态学解释性不足的问题。提出CLEAR-HPV框架，通过注意力机制实现可解释的概念发现与特征表示。**

- **链接: [https://arxiv.org/pdf/2602.05126v1](https://arxiv.org/pdf/2602.05126v1)**
...
>
---
#### [new 092] Magic-MM-Embedding: Towards Visual-Token-Efficient Universal Multimodal Embedding with MLLMs
- **分类: cs.CV**

- **简介: 该论文属于多模态嵌入任务，解决MLLMs在处理视觉输入时计算成本高的问题。提出Magic-MM-Embedding，通过视觉令牌压缩和分阶段训练提升效率与性能。**

- **链接: [https://arxiv.org/pdf/2602.05275v1](https://arxiv.org/pdf/2602.05275v1)**
...
>
---
#### [new 098] Splat and Distill: Augmenting Teachers with Feed-Forward 3D Reconstruction For 3D-Aware Distillation
- **分类: cs.CV**

- **简介: 该论文针对2D视觉基础模型缺乏3D感知的问题，提出Splat and Distill框架，通过3D重建增强教师模型，提升学生模型的3D意识和语义能力。**

- **链接: [https://arxiv.org/pdf/2602.06032v1](https://arxiv.org/pdf/2602.06032v1)**
...
>
---
#### [new 099] InterPrior: Scaling Generative Control for Physics-Based Human-Object Interactions
...
>
---
#### [new 105] IndustryShapes: An RGB-D Benchmark dataset for 6D object pose estimation of industrial assembly components and tools
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 109] Extreme Weather Nowcasting via Local Precipitation Pattern Prediction
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于极端天气短临预报任务，旨在解决降水预测中的空间局部性、结构复杂性和预报时长不稳定性问题。提出exPreCast模型并构建平衡数据集，提升预测精度与适用性。**

- **链接: [https://arxiv.org/pdf/2602.05204v1](https://arxiv.org/pdf/2602.05204v1)**
...
>
---
#### [new 114] Towards Segmenting the Invisible: An End-to-End Registration and Segmentation Framework for Weakly Supervised Tumour Analysis
- **分类: eess.IV; cs.AI; cs.CV; cs.LG; physics.med-ph**

- **简介: 该论文属于跨模态医学图像分析任务，旨在解决CT中肿瘤不可见的问题。通过结合配准与分割框架，利用MRI标签生成CT伪标签，但发现当病理特征缺失时效果下降，揭示了当前方法的局限性。**

- **链接: [https://arxiv.org/pdf/2602.05453v1](https://arxiv.org/pdf/2602.05453v1)**
...
>
---
#### [new 115] Refine and Purify: Orthogonal Basis Optimization with Null-Space Denoising for Conditional Representation Learning
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于条件表征学习任务，旨在解决子空间基敏感和跨子空间干扰问题。提出OD-CRL框架，结合正交基优化与空域去噪，提升表征质量。**

- **链接: [https://arxiv.org/pdf/2602.05464v1](https://arxiv.org/pdf/2602.05464v1)**
...
>
---
#### [new 116] VLN-Pilot: Large Vision-Language Model as an Autonomous Indoor Drone Operator
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 126] When Shared Knowledge Hurts: Spectral Over-Accumulation in Model Merging
...
>
---
#### [new 127] Ethology of Latent Spaces
...
>
---
#### [new 128] Pseudo-Invertible Neural Networks
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出SPNN，解决非线性逆问题，通过非线性伪逆实现零样本反演，扩展了扩散模型的应用范围。**

- **链接: [https://arxiv.org/pdf/2602.06042v1](https://arxiv.org/pdf/2602.06042v1)**
...
>
---
#### [new 129] Erase at the Core: Representation Unlearning for Machine Unlearning
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于机器遗忘任务，解决模型在遗忘特定数据时仅实现表面遗忘的问题。提出EC框架，通过多层对比遗忘和深度监督学习，增强模型内部表示的遗忘效果。**

- **链接: [https://arxiv.org/pdf/2602.05375v1](https://arxiv.org/pdf/2602.05375v1)**
...
#### [replaced 001] MVGS: Multi-view Regulated Gaussian Splatting for Novel View Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2410.02103v3](https://arxiv.org/pdf/2410.02103v3)**
...
>
---
#### [replaced 002] EEG Foundation Models: Progresses, Benchmarking, and Open Problems
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.17883v2](https://arxiv.org/pdf/2601.17883v2)**
...
>
---
#### [replaced 003] LayoutCoT: Unleashing the Deep Reasoning Potential of Large Language Models for Layout Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.10829v3](https://arxiv.org/pdf/2504.10829v3)**

> **作者:** Hengyu Shi; Junhao Su; Tianyang Han; Junfeng Luo; Jialin Gao
>
...
>
---
#### [replaced 004] All You Need for Object Detection: From Pixels, Points, and Prompts to Next-Gen Fusion and Multimodal LLMs/VLMs in Autonomous Vehicles
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.26641v3](https://arxiv.org/pdf/2510.26641v3)**
...
>
---
#### [replaced 005] Event2Vec: Processing Neuromorphic Events Directly by Representations in Vector Space
- **分类: cs.CV; cs.NE**

- **链接: [https://arxiv.org/pdf/2504.15371v5](https://arxiv.org/pdf/2504.15371v5)**

> **作者:** Wei Fang; Priyadarshini Panda
>
> **备注:** Fix a minor error in the abstract within the metadata of the previous version
>
...
>
---
#### [replaced 006] One-step Latent-free Image Generation with Pixel Mean Flows
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.22158v2](https://arxiv.org/pdf/2601.22158v2)**

> **作者:** Yiyang Lu; Susie Lu; Qiao Sun; Hanhong Zhao; Zhicheng Jiang; Xianbang Wang; Tianhong Li; Zhengyang Geng; Kaiming He
>
> **备注:** Tech report. Code at https://github.com/Lyy-iiis/pMF
>
...
>
---
#### [replaced 007] TennisTV: Do Multimodal Large Language Models Understand Tennis Rallies?
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.15602v4](https://arxiv.org/pdf/2509.15602v4)**
...
>
---
#### [replaced 008] MaxSup: Overcoming Representation Collapse in Label Smoothing
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2502.15798v4](https://arxiv.org/pdf/2502.15798v4)**
...
>
---
#### [replaced 009] An Example for Domain Adaptation Using CycleGAN
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.08776v2](https://arxiv.org/pdf/2601.08776v2)**
...
>
---
#### [replaced 010] Feature Engineering is Not Dead: Reviving Classical Machine Learning with Entropy, HOG, and LBP Feature Fusion for Image Classification
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.13772v2](https://arxiv.org/pdf/2507.13772v2)**
...
>
---
#### [replaced 013] CMD-HAR: Cross-Modal Disentanglement for Wearable Human Activity Recognition
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2503.21843v4](https://arxiv.org/pdf/2503.21843v4)**

> **作者:** Ying Yu; Siyao Li; Yixuan Jiang; Hang Xiao; Jingxi Long; Haotian Tang; Hanyu Liu; Chao Li
>
...
>
---
#### [replaced 014] Vector Quantization using Gaussian Variational Autoencoder
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06609v2](https://arxiv.org/pdf/2512.06609v2)**
...
>
---
#### [replaced 015] Vision-R1: Incentivizing Reasoning Capability in Multimodal Large Language Models
...
>
---
#### [replaced 016] SharpTimeGS: Sharp and Stable Dynamic Gaussian Splatting via Lifespan Modulation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.02989v2](https://arxiv.org/pdf/2602.02989v2)**
...
>
---
#### [replaced 017] Test-Time Iterative Error Correction for Efficient Diffusion Models
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.06250v2](https://arxiv.org/pdf/2511.06250v2)**
...
>
---
#### [replaced 018] SurgLaVi: Large-Scale Hierarchical Dataset for Surgical Vision-Language Representation Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.10555v2](https://arxiv.org/pdf/2509.10555v2)**
...
>
---
#### [replaced 019] Physics-Driven Local-Whole Elastic Deformation Modeling for Point Cloud Representation Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.13812v3](https://arxiv.org/pdf/2505.13812v3)**
...
>
---
#### [replaced 020] RANGER: A Monocular Zero-Shot Semantic Navigation Framework through Contextual Adaptation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 021] GIQ: Benchmarking 3D Geometric Reasoning of Vision Foundation Models with Simulated and Real Polyhedra
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.08194v3](https://arxiv.org/pdf/2506.08194v3)**
...
>
---
#### [replaced 024] An AI-enabled tool for quantifying overlapping red blood cell sickling dynamics in microfluidic assays
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.17703v2](https://arxiv.org/pdf/2601.17703v2)**

> **作者:** Nikhil Kadivar; Guansheng Li; Jianlu Zheng; Ming Dao; George Em Karniadakis; Mengjia Xu
>
...
>
---
#### [replaced 025] Investigating the Impact of Histopathological Foundation Models on Regressive Prediction of Homologous Recombination Deficiency
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.00151v2](https://arxiv.org/pdf/2602.00151v2)**

> **作者:** Alexander Blezinger; Wolfgang Nejdl; Ming Tang
>
> **备注:** 9 pages, 7 figures and 5 tables
>
...
>
---
#### [replaced 026] TrajVG: 3D Trajectory-Coupled Visual Geometry Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.04439v2](https://arxiv.org/pdf/2602.04439v2)**

> **作者:** Xingyu Miao; Weiguang Zhao; Tao Lu; Linning Xu; Mulin Yu; Yang Long; Jiangmiao Pang; Junting Dong
>
> **摘要:** Feed-forward multi-frame 3D reconstruction models often degrade on videos with object motion. Global-reference becomes ambiguous under multiple motions, while the local pointmap relies heavily on estimated relative poses and can drift, causing cross-frame misalignment and duplicated structures. We propose TrajVG, a reconstruction framework that makes cross-frame 3D correspondence an explicit prediction by estimating camera-coordinate 3D trajectories. We couple sparse trajectories, per-frame local point maps, and relative camera poses with geometric consistency objectives: (i) bidirectional trajectory-pointmap consistency with controlled gradient flow, and (ii) a pose consistency objective driven by static track anchors that suppresses gradients from dynamic regions. To scale training to in-the-wild videos where 3D trajectory labels are scarce, we reformulate the same coupling constraints into self-supervised objectives using only pseudo 2D tracks, enabling unified training with mixed supervision. Extensive experiments across 3D tracking, pose estimation, pointmap reconstruction, and video depth show that TrajVG surpasses the current feedforward performance baseline.
>
---
#### [replaced 027] A 96pJ/Frame/Pixel and 61pJ/Event Anti-UAV System with Hybrid Object Tracking Modes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17939v2](https://arxiv.org/pdf/2512.17939v2)**
...
>
---
#### [replaced 028] PPE: Positional Preservation Embedding for Token Compression in Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.22936v2](https://arxiv.org/pdf/2510.22936v2)**
...
>
---
#### [replaced 029] BioLite U-Net: Edge-Deployable Semantic Segmentation for In Situ Bioprinting Monitoring
- **分类: cs.CV; cs.AI; cs.AR**

- **链接: [https://arxiv.org/pdf/2509.06690v2](https://arxiv.org/pdf/2509.06690v2)**
...
>
---
#### [replaced 030] EchoJEPA: A Latent Predictive Foundation Model for Echocardiography
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.02603v2](https://arxiv.org/pdf/2602.02603v2)**
...
>
---
#### [replaced 031] Histo-Miner: Deep learning based tissue features extraction pipeline from H&E whole slide images of cutaneous squamous cell carcinoma
- **分类: cs.CV; q-bio.QM**

- **链接: [https://arxiv.org/pdf/2505.04672v3](https://arxiv.org/pdf/2505.04672v3)**

> **作者:** Lucas Sancéré; Carina Lorenz; Doris Helbig; Oana-Diana Persa; Sonja Dengler; Alexander Kreuter; Martim Laimer; Roland Lang; Anne Fröhlich; Jennifer Landsberg; Johannes Brägelmann; Katarzyna Bozek
>
> **备注:** 37 pages including supplement, 5 core figures. Version 2: change sections order, add new supplementary sections, minor text updates. Version 3: Author addition and update of author contributions, increase font on 2 figures, minor text updates
>
...
>
---
#### [replaced 032] Customizing Visual Emotion Evaluation for MLLMs: An Open-vocabulary, Multifaceted, and Scalable Approach
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.21950v2](https://arxiv.org/pdf/2509.21950v2)**
...
>
---
#### [replaced 033] A Contrastive Learning Foundation Model Based on Perfectly Aligned Sample Pairs for Remote Sensing Images
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2505.19447v3](https://arxiv.org/pdf/2505.19447v3)**

> **作者:** Hengtong Shen; Haiyan Gu; Haitao Li; Yi Yang; Agen Qiu
>
> **备注:** This article has been accepted for publication in Geo-spatial Information Science, published by Taylor & Francis
>
...
>
---
#### [replaced 034] TextOCVP: Object-Centric Video Prediction with Language Guidance
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.11655v3](https://arxiv.org/pdf/2502.11655v3)**

> **作者:** Angel Villar-Corrales; Gjergj Plepi; Sven Behnke
>
> **备注:** Published at TMLR 02/2026
>
...
>
---
#### [replaced 035] Active Perception Agent for Omnimodal Audio-Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23646v2](https://arxiv.org/pdf/2512.23646v2)**

> **作者:** Keda Tao; Wenjie Du; Bohan Yu; Weiqiang Wang; Jian Liu; Huan Wang
>
> **备注:** Website:https://kd-tao.github.io/OmniAgent/
>
> **摘要:** Omnimodal large language models have made significant strides in unifying audio and visual modalities; however, they often face challenges in fine-grained cross-modal understanding and have difficulty with multimodal alignment. To address these limitations, we introduce OmniAgent, to our best knowledge, the first fully active perception agent that dynamically orchestrates specialized unimodal tools to achieve more fine-grained omnimodal reasoning. Unlike previous works that rely on rigid, static workflows and dense frame-captioning, we demonstrate a paradigm shift from passive response generation to active multimodal inquiry. OmniAgent employs dynamic planning to autonomously orchestrate tool invocation on demand, strategically concentrating perceptual attention on task-relevant cues. Central to our approach is a novel coarse-to-fine audio-guided perception paradigm, which leverages audio cues to localize temporal events and guide subsequent reasoning. Extensive empirical evaluations on three audio-video understanding benchmarks demonstrate that OmniAgent achieves state-of-the-art performance, surpassing leading open-source and closed-source models by substantial margins of 10% - 20% accuracy without training.
>
---
#### [replaced 036] Quantification and Classification of Carbon Nanotubes in Electron Micrographs using Vision Foundation Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.06673v2](https://arxiv.org/pdf/2601.06673v2)**
...
>
---
#### [replaced 037] Sounding Highlights: Dual-Pathway Audio Encoders for Audio-Visual Video Highlight Detection
...
>
---
#### [replaced 038] Improved Bag-of-Words Image Retrieval with Geometric Constraints for Ground Texture Localization
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 039] RefAM: Attention Magnets for Zero-Shot Referral Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.22650v2](https://arxiv.org/pdf/2509.22650v2)**
...
>
---
#### [replaced 042] UAM: A Unified Attention-Mamba Backbone of Multimodal Framework for Tumor Cell Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.17355v2](https://arxiv.org/pdf/2511.17355v2)**
...
>
---
#### [replaced 046] RAD: Region-Aware Diffusion Models for Image Inpainting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.09191v5](https://arxiv.org/pdf/2412.09191v5)**

> **作者:** Sora Kim; Sungho Suh; Minsik Lee
>
> **备注:** Code: https://github.com/srk1995/RAD
>
...
>
---
#### [replaced 047] Image-to-Image Translation with Diffusion Transformers and CLIP-Based Image Conditioning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.16001v2](https://arxiv.org/pdf/2505.16001v2)**

> **作者:** Qiang Zhu; Kuan Lu; Menghao Huo; Yuxiao Li
>
> **备注:** Published in: 2025 6th International Conference on Computer Vision, Image and Deep Learning (CVIDL)
>
...
>
---
#### [replaced 050] Invariance on Manifolds: Understanding Robust Visual Representations for Place Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00841v3](https://arxiv.org/pdf/2602.00841v3)**
...
>
---
#### [replaced 051] LookWhere? Efficient Visual Recognition by Learning Where to Look and What to See from Self-Supervision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.18051v3](https://arxiv.org/pdf/2505.18051v3)**
...
>
---
#### [replaced 054] Representation Geometry as a Diagnostic for Out-of-Distribution Robustness
- **分类: cs.LG; cs.CV; math.DG; math.GN**

- **链接: [https://arxiv.org/pdf/2602.03951v2](https://arxiv.org/pdf/2602.03951v2)**
...
>
---
#### [replaced 057] Efficient Scene Modeling via Structure-Aware and Region-Prioritized 3D Gaussians
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.12788v2](https://arxiv.org/pdf/2411.12788v2)**
...
>
---
#### [replaced 058] VisMem: Latent Vision Memory Unlocks Potential of Vision-Language Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.11007v2](https://arxiv.org/pdf/2511.11007v2)**
...
>
---
#### [replaced 065] EUGens: Efficient, Unified, and General Dense Layers
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2410.09771v2](https://arxiv.org/pdf/2410.09771v2)**
...
> **备注:** Neurips 2025
>
> **摘要:** Efficient neural networks are essential for scaling machine learning models to real-time applications and resource-constrained environments. Fully-connected feedforward layers (FFLs) introduce computation and parameter count bottlenecks within neural network architectures. To address this challenge, in this work, we propose a new class of dense layers that generalize standard fully-connected feedforward layers, \textbf{E}fficient, \textbf{U}nified and \textbf{Gen}eral dense layers (EUGens). EUGens leverage random features to approximate standard FFLs and go beyond them by incorporating a direct dependence on the input norms in their computations. The proposed layers unify existing efficient FFL extensions and improve efficiency by reducing inference complexity from quadratic to linear time. They also lead to \textbf{the first} unbiased algorithms approximating FFLs with arbitrary polynomial activation functions. Furthermore, EuGens reduce the parameter count and computational overhead while preserving the expressive power and adaptability of FFLs. We also present a layer-wise knowledge transfer technique that bypasses backpropagation, enabling efficient adaptation of EUGens to pre-trained models. Empirically, we observe that integrating EUGens into Transformers and MLPs yields substantial improvements in inference speed (up to \textbf{27}\%) and memory efficiency (up to \textbf{30}\%) across a range of tasks, including image classification, language model pre-training, and 3D scene reconstruction. Overall, our results highlight the potential of EUGens for the scalable deployment of large-scale neural networks in real-world scenarios.
>
---
#### [replaced 066] See Less, See Right: Bi-directional Perceptual Shaping For Multimodal Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22120v2](https://arxiv.org/pdf/2512.22120v2)**

> **作者:** Shuoshuo Zhang; Yizhen Zhang; Jingjing Fu; Lei Song; Jiang Bian; Yujiu Yang; Rui Wang
>
> **摘要:** Large vision-language models (VLMs) often benefit from intermediate visual cues, either injected via external tools or generated as latent visual tokens during reasoning, but these mechanisms still overlook fine-grained visual evidence (e.g., polylines in charts), generalize poorly across domains, and incur high inference-time cost. In this paper, we propose Bi-directional Perceptual Shaping (BiPS), which transforms question-conditioned masked views into bidirectional where-to-look signals that shape perception during training. BiPS first applies a KL-consistency constraint between the original image and an evidence-preserving view that keeps only question-relevant regions, encouraging coarse but complete coverage of supporting pixels. It then applies a KL-separation constraint between the original and an evidence-ablated view where critical pixels are masked so the image no longer supports the original answer, discouraging text-only shortcuts (i.e., answering from text alone) and enforcing fine-grained visual reliance. Across eight benchmarks, BiPS boosts Qwen2.5-VL-7B by 8.2% on average and shows strong out-of-domain generalization to unseen datasets and image types.
>
---
#### [replaced 067] DPMambaIR: All-in-One Image Restoration via Degradation-Aware Prompt State Space Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.17732v3](https://arxiv.org/pdf/2504.17732v3)**
...
>
---
#### [replaced 068] SIRR-LMM: Single-image Reflection Removal via Large Multimodal Model
- **分类: cs.CV; cs.AI; cs.GR**

- **链接: [https://arxiv.org/pdf/2601.07209v2](https://arxiv.org/pdf/2601.07209v2)**
...
>
---
#### [replaced 072] Alignment of Diffusion Models: Fundamentals, Challenges, and Future
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2409.07253v4](https://arxiv.org/pdf/2409.07253v4)**

> **作者:** Buhua Liu; Shitong Shao; Bao Li; Lichen Bai; Zhiqiang Xu; Haoyi Xiong; James Kwok; Sumi Helal; Zeke Xie
>
> **备注:** Accepted at ACM Computing Surveys. 35 pages, 5 figures, 4 tables. Paper List: github.com/xie-lab-ml/awesome-alignment-of-diffusion-models
>
...
>
---
#### [replaced 073] Many-for-Many: Unify the Training of Multiple Video and Image Generation and Manipulation Tasks
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.01758v3](https://arxiv.org/pdf/2506.01758v3)**

> **作者:** Ruibin Li; Tao Yang; Yangming Shi; Weiguo Feng; Shilei Wen; Bingyue Peng; Lei Zhang
>
...
>
---
#### [replaced 074] Near-Light Color Photometric Stereo for Mono-Chromatic Non-Lambertian Surfaces
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.12666v2](https://arxiv.org/pdf/2601.12666v2)**
...
>
---
#### [replaced 075] PIO-FVLM: Rethinking Training-Free Visual Token Reduction for VLM Acceleration from an Inference-Objective Perspective
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.04657v2](https://arxiv.org/pdf/2602.04657v2)**
...
>
---
#### [replaced 076] Robust automatic brain vessel segmentation in 3D CTA scans using dynamic 4D-CTA data
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00391v3](https://arxiv.org/pdf/2602.00391v3)**

> **作者:** Alberto Mario Ceballos-Arroyo; Shrikanth M. Yadav; Chu-Hsuan Lin; Jisoo Kim; Geoffrey S. Young; Lei Qin; Huaizu Jiang
>
