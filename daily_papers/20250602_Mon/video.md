...
- **简介: 该论文属于RGBD语义分割任务，旨在解决多模态训练与单模态推理的数据模态不匹配问题。传统跨模态知识蒸馏依赖教师-学生框架，存在架构选择与蒸馏策略的局限。作者提出CroDiNo-KD，通过解纠缠表示、对比学习和解耦数据增强，协同训练单模态模型，重构神经网络内部结构，提升单模态模型性能，实验证明其优于现有方法。**
...
- **简介: 该论文提出AdaHuman框架，解决单图生成高保真可动画3D人体avatar的难题。通过姿态驱动的3D扩散模型生成多视角图像与3DGS重建，并用局部细化模块提升细节，实现无严重自遮挡的A姿标准化输出，显著优于现有方法。**
...
- **链接: [http://arxiv.org/pdf/2505.24380v1](http://arxiv.org/pdf/2505.24380v1)**
...
- **简介: 该论文属于3D点云异常检测与修复任务，旨在解决现有方法因离散表示导致的定位精度不足及姿态变化干扰问题。提出PASDF框架，通过姿态对齐模块和连续符号距离场（SDF）网络，实现姿态不变的高保真几何表示，支持精准异常定位与原位修复，实验显示其在公开数据集上达到领先检测效果。**
...
- **简介: 该论文属于零样本模型的置信预测任务，解决领域偏移导致的置信集效率下降问题。提出Conf-OT方法，通过最优传输桥接预训练与目标域差距，在单校准集上提升预测效率达20%，且速度更快，适用于多数据集验证。**
...
- **简介: 论文提出CSVQA，中文多模态基准，评估VLM在STEM领域的科学推理能力。针对现有基准缺乏真实科学情境和领域知识整合的问题，构建1378个需视觉证据分析与学科知识的题目，并设计评估协议分析推理步骤。测试15个模型显示性能差距显著（最优模型49.6%准确率），强调需提升科学推理能力。**
...
- **简介: 该论文提出SARD数据集，旨在解决阿拉伯语OCR训练数据缺乏规模与书籍布局多样性的难题。通过合成生成84万余张含6.9亿单词的书籍风格图像（覆盖10种字体），提供无噪声、可控制的训练资源，并 benchmark多类OCR模型，推动阿拉伯语文本识别研究。**
...
- **简介: 该论文针对Ego4D社交互动挑战赛，提出PCIE_Interaction方案，解决Looking At Me（LAM）和Talking To Me（TTM）任务。通过面部质量增强与集成方法处理LAM的凝视检测，结合音频-视觉多模态融合（以视觉质量加权）处理TTM的对话检测，实现0.81/0.71 mAP的精度。**
...
> **作者:** Sangwon Jung; Alex Oesterling; Claudio Mayrink Verdun; Sajani Vithana; Taesup Moon; Flavio P. Calmon
>
...
- **链接: [http://arxiv.org/pdf/2505.23980v1](http://arxiv.org/pdf/2505.23980v1)**
...
- **简介: 该论文属6D姿态估计任务，针对自主拆卸中因遮挡和单视角数据导致螺栓检测不全的问题，提出结合领域知识的多阶段pipeline，通过整合先验信息和点云数据，实现电机螺栓完整6D位姿估计，提升自动化拆卸可靠性。**
...
- **简介: 该论文提出Period-LLM模型，解决多模态大语言模型在周期性任务中的时间建模不足和周期冲突问题。通过构建分难度的跨模态基准测试，并采用"易到难"训练范式及"抵抗逻辑遗忘"优化策略，提升模型周期推理能力，实验验证其优势。**
...
- **简介: 该论文属于多任务学习领域，针对自主系统在跨第一人称视频任务中难以复用知识的问题，提出Hier-EgoPack框架，通过构建可迁移的任务视角集合实现跨任务技能协同，提升新技能学习效率。**
...
- **简介: 该论文属于3D开放词汇场景理解任务，解决现有方法忽视视点依赖语义的问题。提出LaGa方法，通过分解场景为物体并聚类加权多视图语义描述符，构建跨视角语义表示，显著提升3D场景理解精度（mIoU+18.7%）。**
...
- **简介: 该论文提出一种基于手持设备生成全身动作视频的方法，解决传统方案依赖固定相机和复杂拍摄的问题。通过输入前后镜像照片及IMU运动数据，结合视频扩散模型、多参考注意力机制和图像微调策略，生成自然光照与阴影的逼真视频，实现便捷的动态人体场景合成。**
...
- **简介: 该论文研究视频语言模型在纯时间模式识别中的局限性，指出其过度依赖空间特征而无法处理时间线索。提出SpookyBench基准，展示人类可超98%识别噪声帧序列中的规律，而模型完全失效，强调需新架构解耦时空处理以提升时间理解能力。**
...
- **简介: 该论文提出S3CE-Net模型，针对长序列事件相机数据的人员重识别任务。旨在解决异步事件数据处理、复杂光照干扰及长期时序语义建模难题。方法基于脉冲神经网络，设计时空语义耦合机制（SSAM）增强特征交互，并通过无参数的时空特征采样策略（STFS）提升模型效率与鲁棒性，实现高效低参数的长序列Re-ID。**
...
- **简介: 该论文针对长视频理解中MLLMs因帧过多导致的上下文限制与计算负担问题，提出Nar-KFC模块：通过整数二次规划优化关键帧选择（贪心算法加速），并插入非关键帧的文本叙事，缓解时空断层，提升模型效率与性能。**
...
- **简介: 该论文属于零样本中文字符识别（CCR）任务，针对现有方法无法有效利用中文字符多粒度结构信息的问题，提出Hi-GITA框架。通过设计图像与文本的多粒度编码器（捕捉笔画到整体结构）、跨模态融合模块及细粒度解耦对比损失，实现跨层级对齐，显著提升识别精度。**
...
- **简介: 该论文属于开放集半监督学习任务，旨在解决未标注数据含未知类别（离群值）导致模型性能下降的问题。提出"Diversify and Conquer"框架，通过单次训练构建多组偏置不同的模型头，利用其对离群值的预测分歧识别未知类，同时保持对已知类的一致性，提升鲁棒性。**
...
- **简介: 该论文属于混合域半监督医疗图像分割任务，旨在解决标注数据有限与领域偏移共存的问题。提出UST-RUN框架，通过构建中间域并采用统一粘贴、对称引导训练及自适应混合策略，利用无标签多域数据提升分割性能，实验显示显著提升分割精度。**
...
- **简介: 该论文属于视觉基础模型推理能力提升任务，旨在解决视觉模型（如DINO系列）缺乏类似语言模型的推理能力问题。提出DINO-R1，通过新型强化学习策略GRQO（基于组归一化对齐质量的查询优化）及KL正则化稳定训练，结合视觉提示编码器与查询选择机制，增强模型在开放/闭合场景的视觉推理表现。**
...
- **简介: 论文属于自动驾驶端到端运动规划任务，旨在解决现有方法依赖2D空间预训练或标注数据导致性能不足的问题。提出S4-Driver，通过稀疏体积策略将多模态模型的视觉表示从2D转为3D，整合多视角与多帧数据，实现无标注的自监督轨迹预测。**
...
- **简介: 论文提出无需训练的零样本3D对称检测方法，解决传统和学习方法依赖训练或精度不足的问题。通过将视觉基础模型（如DINOv2）提取的特征回投影至3D几何，利用其对称不变性设计算法识别反射对称平面，在ShapeNet上优于现有方法。**
...
>
---
#### [new 062] VideoCAD: A Large-Scale Video Dataset for Learning UI Interactions and 3D Reasoning from CAD Software
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出VideoCAD数据集，解决专业CAD软件复杂3D交互与长期任务学习难题。包含41K标注视频，用于训练UI交互模型（VideoCADFormer）和评估多模态模型的空间推理能力，填补工程领域视频UI理解的数据与方法空白。**

- **链接: [http://arxiv.org/pdf/2505.24838v1](http://arxiv.org/pdf/2505.24838v1)**
...
>
---
#### [new 068] Unleashing High-Quality Image Generation in Diffusion Sampling Using Second-Order Levenberg-Marquardt-Langevin
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于扩散模型采样优化任务，旨在解决高维扩散模型中二阶Hessian几何计算复杂度问题。提出LML方法，通过低秩Hessian近似和阻尼机制高效利用几何信息，提升采样精度与图像质量，理论分析验证有效性，实验证明效果显著且计算开销小。**

- **链接: [http://arxiv.org/pdf/2505.24222v1](http://arxiv.org/pdf/2505.24222v1)**

> **作者:** Fangyikang Wang; Hubery Yin; Lei Qian; Yinan Li; Shaobin Zhuang; Huminhao Zhu; Yilin Zhang; Yanlong Tang; Chao Zhang; Hanbin Zhao; Hui Qian; Chen Li
>
> **摘要:** The diffusion models (DMs) have demonstrated the remarkable capability of generating images via learning the noised score function of data distribution. Current DM sampling techniques typically rely on first-order Langevin dynamics at each noise level, with efforts concentrated on refining inter-level denoising strategies. While leveraging additional second-order Hessian geometry to enhance the sampling quality of Langevin is a common practice in Markov chain Monte Carlo (MCMC), the naive attempts to utilize Hessian geometry in high-dimensional DMs lead to quadratic-complexity computational costs, rendering them non-scalable. In this work, we introduce a novel Levenberg-Marquardt-Langevin (LML) method that approximates the diffusion Hessian geometry in a training-free manner, drawing inspiration from the celebrated Levenberg-Marquardt optimization algorithm. Our approach introduces two key innovations: (1) A low-rank approximation of the diffusion Hessian, leveraging the DMs' inherent structure and circumventing explicit quadratic-complexity computations; (2) A damping mechanism to stabilize the approximated Hessian. This LML approximated Hessian geometry enables the diffusion sampling to execute more accurate steps and improve the image generation quality. We further conduct a theoretical analysis to substantiate the approximation error bound of low-rank approximation and the convergence property of the damping mechanism. Extensive experiments across multiple pretrained DMs validate that the LML method significantly improves image generation quality, with negligible computational overhead.
>
---
#### [new 069] InteractAnything: Zero-shot Human Object Interaction Synthesis via LLM Feedback and Object Affordance Parsing
- **分类: cs.CV**

- **简介: 该论文提出零样本3D人类-物体交互生成框架InteractAnything，解决开放集物体交互生成难题。通过LLM推理人-物关系初始化属性，结合2D扩散模型解析新物体接触点，多视角生成初始姿势，并优化实现精细真实接触，提升开放集物体处理能力。**

- **链接: [http://arxiv.org/pdf/2505.24315v1](http://arxiv.org/pdf/2505.24315v1)**
...
>
---
#### [new 070] DrVD-Bench: Do Vision-Language Models Reason Like Human Doctors in Medical Image Diagnosis?
- **分类: cs.CV**

- **简介: 该论文提出DrVD-Bench，首个评估视觉语言模型（VLM）临床推理能力的多模态基准，解决现有基准无法系统验证模型是否真正具备医生级推理的问题。通过包含视觉证据理解、推理路径评估和报告生成的7789个医疗影像任务，测试19种VLM发现其依赖表面关联而非深度推理，为开发可信医疗VLM提供评估框架。**

- **链接: [http://arxiv.org/pdf/2505.24173v1](http://arxiv.org/pdf/2505.24173v1)**

> **作者:** Tianhong Zhou; Yin Xu; Yingtao Zhu; Chuxi Xiao; Haiyang Bian; Lei Wei; Xuegong Zhang
>
...
>
---
#### [new 076] Draw ALL Your Imagine: A Holistic Benchmark and Agent Framework for Complex Instruction-based Image Generation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 077] Category-Level 6D Object Pose Estimation in Agricultural Settings Using a Lattice-Deformation Framework and Diffusion-Augmented Synthetic Data
- **分类: cs.CV**

- **简介: 该论文提出PLANTPose框架，解决农业场景下果蔬高内类变异的6D姿态估计问题。通过类别级CAD模型变形预测与扩散模型增强合成数据，实现仅RGB输入的准确姿态估计，无需实例级CAD或深度传感器，在香蕉数据集上超越现有方法。**

- **链接: [http://arxiv.org/pdf/2505.24636v1](http://arxiv.org/pdf/2505.24636v1)**

> **作者:** Marios Glytsos; Panagiotis P. Filntisis; George Retsinas; Petros Maragos
>
> **备注:** 7 pages, 4 figures. Submitted to the IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) 2025. This work has been submitted to the IEEE for possible publication
>
...
>
---
#### [new 078] Optimal Weighted Convolution for Classification and Denosing
- **分类: cs.CV; 68T05**

- **简介: 该论文提出一种带空间密度函数的加权卷积操作，旨在提升CNN的空间特征提取能力。通过动态调整邻域像素权重，解决传统卷积固定权重导致的信息利用不足问题。方法保持参数量不变且兼容现有架构，在分类（CIFAR-100）和去噪（DIV2K）任务中显著优于标准卷积，代码已开源。**

- **链接: [http://arxiv.org/pdf/2505.24558v1](http://arxiv.org/pdf/2505.24558v1)**
...
>
---
#### [new 079] 50 Years of Automated Face Recognition
- **分类: cs.CV**

- **简介: 该论文综述了50年自动人脸识别技术发展，梳理了从传统方法到深度学习的演进路径，分析了数据集、损失函数、网络设计等关键技术突破，探讨了数据规模对模型泛化的影响，并指出现有挑战及未来方向如多模态融合和可解释性研究。**

- **链接: [http://arxiv.org/pdf/2505.24247v1](http://arxiv.org/pdf/2505.24247v1)**
...
>
---
#### [new 080] AMIA: Automatic Masking and Joint Intention Analysis Makes LVLMs Robust Jailbreak Defenders
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 085] Point-MoE: Towards Cross-Domain Generalization in 3D Semantic Segmentation via Mixture-of-Experts
- **分类: cs.CV**

- **简介: 该论文属于3D语义分割任务，针对跨领域数据泛化难题，提出Point-MoE架构。通过混合专家与top-k路由策略，模型自动适应不同传感器/场景（如室内/户外）的异构点云数据，在无领域标签情况下提升跨域性能，优于传统方法并泛化至未知领域。**

- **链接: [http://arxiv.org/pdf/2505.23926v1](http://arxiv.org/pdf/2505.23926v1)**

> **作者:** Xuweiyi Chen; Wentao Zhou; Aruni RoyChowdhury; Zezhou Cheng
>
> **备注:** Project page: https://uva-computer-vision-lab.github.io/point-moe/
>
...
>
---
#### [new 091] MiniMax-Remover: Taming Bad Noise Helps Video Object Removal
- **分类: cs.CV**

- **简介: 该论文提出MiniMax-Remover，针对视频对象移除任务中存在幻觉物体、视觉伪影及计算效率低的问题。通过两阶段方法：首先简化预训练模型去除文本相关组件，其次采用对抗蒸馏优化，利用minimax策略识别并消除"坏噪声"，提升效果与速度。最终实现少步采样、无需CFG的高效SOTA视频移除。**

- **链接: [http://arxiv.org/pdf/2505.24873v1](http://arxiv.org/pdf/2505.24873v1)**
...
>
---
#### [new 092] ScaleLong: A Multi-Timescale Benchmark for Long Video Understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 093] MoDoMoDo: Multi-Domain Data Mixtures for Multimodal LLM Reinforcement Learning
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [new 098] Decoupled Competitive Framework for Semi-supervised Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于半监督医学图像分割任务，针对Mean Teacher结构的过度耦合及Dual Students结构的认知偏差问题，提出Decoupled Competitive Framework（DCF）。通过竞争机制动态解耦师生关系，并促进学生间知识交换，实验验证其优于现有方法。**

- **链接: [http://arxiv.org/pdf/2505.24667v1](http://arxiv.org/pdf/2505.24667v1)**

> **作者:** Jiahe Chen; Jiahe Ying; Shen Wang; Jianwei Zheng
>
> **备注:** Published in ECAI 2024
>
...
>
---
#### [new 099] Grid-LOGAT: Grid Based Local and Global Area Transcription for Video Question Answering
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Grid-LOGAT系统，用于视频问答任务。针对传统方法在局部细节与全局信息融合及隐私保护上的不足，其通过网格划分视频帧，结合视觉语言模型提取局部文本并融合全局信息，再利用大语言模型生成答案。实验显示其在NExT-QA和STAR-QA数据集上分别达65.9%和50.11%的准确率，显著优于同类方法，尤其在定位问题上提升24%。**

- **链接: [http://arxiv.org/pdf/2505.24371v1](http://arxiv.org/pdf/2505.24371v1)**
...
>
---
#### [new 107] Reading Recognition in the Wild
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出阅读识别任务，旨在通过智能眼镜实时检测用户阅读行为。构建了首个大规模多模态数据集（含100小时真实场景视频），结合RGB、眼动及头部姿态模态，设计灵活的Transformer模型，验证了模态互补性及阅读类型分类的扩展性，推动开放场景下的阅读理解研究。**

- **链接: [http://arxiv.org/pdf/2505.24848v1](http://arxiv.org/pdf/2505.24848v1)**
...
>
---
#### [new 123] Efficient RAW Image Deblurring with Adaptive Frequency Modulation
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出FrENet框架，针对RAW图像去模糊任务，解决频域依赖性模糊与计算效率问题。通过自适应频率位置调制模块动态控制频谱成分，并采用频域跳层连接，实现高质量、高效RAW图像复原，同时扩展至sRGB场景表现优异。**

- **链接: [http://arxiv.org/pdf/2505.24407v1](http://arxiv.org/pdf/2505.24407v1)**

> **作者:** Wenlong Jiao; Binglong Li; Wei Shang; Ping Wang; Dongwei Ren
>
> **备注:** Preprint. Submitted to NeurIPS 2025
>
...
>
---
#### [new 127] Bi-Manual Joint Camera Calibration and Scene Representation
- **分类: cs.RO; cs.CV; cs.LG**

- **简介: 该论文属于机器人视觉与场景理解任务，旨在解决多臂机器人系统中多摄像头校准繁琐及环境表示分散的问题。提出Bi-JCR框架，通过3D基础模型实现无标记多视角对应，联合估计相机与末端执行器的外参、多机械臂相对位姿及统一的3D工作空间表示，支持碰撞检测与语义分割，提升双臂协作效率。**

- **链接: [http://arxiv.org/pdf/2505.24819v1](http://arxiv.org/pdf/2505.24819v1)**
...
>
---
#### [new 128] Open CaptchaWorld: A Comprehensive Web-based Platform for Testing and Benchmarking Multimodal LLM Agents
...
>
---
#### [new 129] LegalEval-Q: A New Benchmark for The Quality Evaluation of LLM-Generated Legal Text
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 130] Graph Flow Matching: Enhancing Image Generation with Neighbor-Aware Flow Fields
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于图像生成任务，针对传统流匹配方法忽略邻近点关联的问题，提出Graph Flow Matching（GFM）。通过将速度场分解为反应项（标准流匹配网络）与扩散项（图神经模块聚合邻居信息），提升生成质量。实验显示其在多个基准数据集上改善了生成指标。**

- **链接: [http://arxiv.org/pdf/2505.24434v1](http://arxiv.org/pdf/2505.24434v1)**
...
>
---
#### [new 131] Parameter-Free Bio-Inspired Channel Attention for Enhanced Cardiac MRI Reconstruction
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于心脏MRI图像重建任务，旨在解决现有注意力模块理论不足及参数依赖问题。提出基于单物种生态增长模型的无参数非线性通道注意力机制，提升重建效果并超越现有方法。**

- **链接: [http://arxiv.org/pdf/2505.23872v1](http://arxiv.org/pdf/2505.23872v1)**

> **作者:** Anam Hashmi; Julia Dietlmeier; Kathleen M. Curran; Noel E. O'Connor
>
> **备注:** presented at the 28th UK Conference on Medical Image Understanding and Analysis - MIUA, 24 - 26 July 2024
>
> **摘要:** Attention is a fundamental component of the human visual recognition system. The inclusion of attention in a convolutional neural network amplifies relevant visual features and suppresses the less important ones. Integrating attention mechanisms into convolutional neural networks enhances model performance and interpretability. Spatial and channel attention mechanisms have shown significant advantages across many downstream tasks in medical imaging. While existing attention modules have proven to be effective, their design often lacks a robust theoretical underpinning. In this study, we address this gap by proposing a non-linear attention architecture for cardiac MRI reconstruction and hypothesize that insights from ecological principles can guide the development of effective and efficient attention mechanisms. Specifically, we investigate a non-linear ecological difference equation that describes single-species population growth to devise a parameter-free attention module surpassing current state-of-the-art parameter-free methods.
>
---
#### [new 132] My Answer Is NOT 'Fair': Mitigating Social Bias in Vision-Language Models via Fair and Biased Residuals
...
>
---
#### [new 133] SR3D: Unleashing Single-view 3D Reconstruction for Transparent and Specular Object Grasping
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于单视图3D重建与机器人抓取任务，旨在解决透明/镜面物体因深度传感受限导致的抓取难题。提出无训练框架SR3D，通过RGB图像生成3D网格，结合视图匹配与关键点匹配机制，精准定位物体位姿与尺度，重建鲁棒深度图以提升抓取效果，实验验证其有效性。**

- **链接: [http://arxiv.org/pdf/2505.24305v1](http://arxiv.org/pdf/2505.24305v1)**
...
>
> **摘要:** Large language models (LLMs) memorize a vast amount of prior knowledge from the Internet that help them on downstream tasks but also may notoriously sway their outputs towards wrong or biased answers. In this work, we test how the knowledge about popular subjects hurt the accuracy of vision language models (VLMs) on standard, objective visual tasks of counting and identification. We find that state-of-the-art VLMs are strongly biased (e.g, unable to recognize a fourth stripe has been added to a 3-stripe Adidas logo) scoring an average of 17.05% accuracy in counting (e.g., counting stripes in an Adidas-like logo) across 7 diverse domains from animals, logos, chess, board games, optical illusions, to patterned grids. Insert text (e.g., "Adidas") describing the subject name into the counterfactual image further decreases VLM accuracy. The biases in VLMs are so strong that instructing them to double-check their results or rely exclusively on image details to answer improves counting accuracy by only +2 points, on average. Our work presents an interesting failure mode in VLMs and an automated framework for testing VLM biases. Code and data are available at: vlmsarebiased.github.io.
>
---
#### [new 136] Proxy-FDA: Proxy-based Feature Distribution Alignment for Fine-tuning Vision Foundation Models without Forgetting
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于视觉基础模型微调任务，解决微调导致的"概念遗忘"问题。提出Proxy-FDA方法，通过特征分布对齐（基于最近邻图）及动态生成的代理，保留特征空间结构知识，减少遗忘。实验验证其在多种微调设置和任务中的有效性。**

- **链接: [http://arxiv.org/pdf/2505.24088v1](http://arxiv.org/pdf/2505.24088v1)**
...
>
---
#### [new 139] From Images to Signals: Are Large Vision Models Useful for Time Series Analysis?
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 论文评估大型视觉模型（LVMs）在时间序列分析中的效用，探究其在分类与预测任务中的适用性。通过测试4种LVM、8种成像方法及18个数据集，发现LVM对分类有效但预测效果受限，存在模型依赖、周期偏好及长窗口利用率低的问题，为多模态研究提供基础。（99字）**

- **链接: [http://arxiv.org/pdf/2505.24030v1](http://arxiv.org/pdf/2505.24030v1)**
...
>
---
#### [new 140] Conformal Object Detection by Sequential Risk Control
- **分类: stat.ML; cs.CV; cs.LG**

- **简介: 该论文属于对象检测任务，旨在解决神经网络可靠性不足导致工业部署受阻的问题。提出Conformal Object Detection（COD）框架，开发Sequential Conformal Risk Control（SeqCRC）方法扩展统计保证至双参数序列任务，并设计适配不同需求的损失函数与预测集，提供工具包及实验验证方法有效性及性能权衡。**

- **链接: [http://arxiv.org/pdf/2505.24038v1](http://arxiv.org/pdf/2505.24038v1)**
...
>
---
#### [new 143] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
- **分类: cs.GR; cs.CV; cs.DC; I.3.6; I.3.2; D.1.3**

- **简介: 该论文属于3D高斯粒子渲染加速任务，旨在解决渲染管线中alpha混合耗时及半精度计算误差问题。提出TC-GS模块，通过将alpha计算映射为矩阵乘法充分利用Tensor Core，并引入坐标变换减少误差，实现渲染质量不变下2.18倍加速，总加速达5.6倍。**

- **链接: [http://arxiv.org/pdf/2505.24796v1](http://arxiv.org/pdf/2505.24796v1)**
...
>
---
#### [new 146] A Novel Coronary Artery Registration Method Based on Super-pixel Particle Swarm Optimization
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出一种基于超像素粒子群优化的多模态冠状动脉图像配准方法，解决PCI手术中2D X光血管造影与3D CT血管成像的几何、对比度及噪声差异导致的配准难题。方法包含预处理与特征提取注册模块，实验显示其在精度、鲁棒性及效率上优于四种现有算法。**

- **链接: [http://arxiv.org/pdf/2505.24351v1](http://arxiv.org/pdf/2505.24351v1)**

> **作者:** Peng Qi; Wenxi Qu; Tianliang Yao; Haonan Ma; Dylan Wintle; Yinyi Lai; Giorgos Papanastasiou; Chengjia Wang
>
...
>
---
#### [new 153] Contrast-Invariant Self-supervised Segmentation for Quantitative Placental MRI
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于胎盘MRI分割任务，旨在解决多回波T2*-w MRI中边界对比弱、标注缺失及运动伪影导致的分割难题。提出对比不变自监督框架，整合掩码自编码预训练、伪标签领域自适应及全局局部特征协作，并引入语义匹配损失，提升跨回波分割鲁棒性，超越传统基线方法。**

- **链接: [http://arxiv.org/pdf/2505.24739v1](http://arxiv.org/pdf/2505.24739v1)**
...
>
---
#### [replaced 005] Expanding the Boundaries of Vision Prior Knowledge in Multi-modal Large Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 009] MTVCrafter: 4D Motion Tokenization for Open-World Human Image Animation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.10238v4](http://arxiv.org/pdf/2505.10238v4)**

> **作者:** Yanbo Ding; Xirui Hu; Zhizhi Guo; Chi Zhang; Yali Wang
>
...
>
---
#### [replaced 012] MedDiff-FM: A Diffusion-based Foundation Model for Versatile Medical Image Applications
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.15432v2](http://arxiv.org/pdf/2410.15432v2)**
...
>
---
#### [replaced 015] Using Knowledge Graphs to harvest datasets for efficient CLIP model training
...
>
---
#### [replaced 016] OpenUni: A Simple Baseline for Unified Multimodal Understanding and Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23661v2](http://arxiv.org/pdf/2505.23661v2)**
...
>
---
#### [replaced 017] Progressive Prompt Detailing for Improved Alignment in Text-to-Image Generative Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.17794v4](http://arxiv.org/pdf/2503.17794v4)**

> **作者:** Ketan Suhaas Saichandran; Xavier Thomas; Prakhar Kaushik; Deepti Ghadiyaram
>
> **备注:** Accepted at CVPR 2025 workshops (AI4CC (oral) & GMCV (poster))
>
> **摘要:** Text-to-image generative models often struggle with long prompts detailing complex scenes, diverse objects with distinct visual characteristics and spatial relationships. In this work, we propose SCoPE (Scheduled interpolation of Coarse-to-fine Prompt Embeddings), a training-free method to improve text-to-image alignment by progressively refining the input prompt in a coarse-to-fine-grained manner. Given a detailed input prompt, we first decompose it into multiple sub-prompts which evolve from describing broad scene layout to highly intricate details. During inference, we interpolate between these sub-prompts and thus progressively introduce finer-grained details into the generated image. Our training-free plug-and-play approach significantly enhances prompt alignment, achieves an average improvement of more than +8 in Visual Question Answering (VQA) scores over the Stable Diffusion baselines on 83% of the prompts from the GenAI-Bench dataset.
>
---
#### [replaced 018] IMTS is Worth Time $\times$ Channel Patches: Visual Masked Autoencoders for Irregular Multivariate Time Series Prediction
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.22815v2](http://arxiv.org/pdf/2505.22815v2)**
...
>
---
#### [replaced 019] Behind the Magic, MERLIM: Multi-modal Evaluation Benchmark for Large Image-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 020] Post-hoc Probabilistic Vision-Language Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.06014v3](http://arxiv.org/pdf/2412.06014v3)**

> **作者:** Anton Baumann; Rui Li; Marcus Klasson; Santeri Mentu; Shyamgopal Karthik; Zeynep Akata; Arno Solin; Martin Trapp
>
> **备注:** Project page: https://aaltoml.github.io/BayesVLM/
>
...
>
---
#### [replaced 021] Graph-guided Cross-composition Feature Disentanglement for Compositional Zero-shot Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2408.09786v2](http://arxiv.org/pdf/2408.09786v2)**
...
>
---
#### [replaced 028] Adversarially Robust AI-Generated Image Detection for Free: An Information Theoretic Perspective
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.22604v2](http://arxiv.org/pdf/2505.22604v2)**
...
>
---
#### [replaced 029] Are MLMs Trapped in the Visual Room?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23272v2](http://arxiv.org/pdf/2505.23272v2)**
...
>
---
#### [replaced 032] TheaterGen: Character Management with LLM for Consistent Multi-turn Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.18919v2](http://arxiv.org/pdf/2404.18919v2)**

> **作者:** Junhao Cheng; Baiqiao Yin; Kaixin Cai; Minbin Huang; Hanhui Li; Yuxin He; Xi Lu; Yue Li; Yifei Li; Yuhao Cheng; Yiqiang Yan; Xiaodan Liang
>
...
>
---
#### [replaced 033] WTEFNet: Real-Time Low-Light Object Detection for Advanced Driver Assistance Systems
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23201v2](http://arxiv.org/pdf/2505.23201v2)**
...
>
---
#### [replaced 034] ProReason: Multi-Modal Proactive Reasoning with Decoupled Eyesight and Wisdom
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2410.14138v3](http://arxiv.org/pdf/2410.14138v3)**
...
>
---
#### [replaced 035] $\textit{Revelio}$: Interpreting and leveraging semantic information in diffusion models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.16725v2](http://arxiv.org/pdf/2411.16725v2)**
...
>
---
#### [replaced 036] ReelWave: Multi-Agentic Movie Sound Generation through Multimodal LLM Conversation
- **分类: cs.SD; cs.CV**
...
>
---
#### [replaced 037] Large Language Model-Driven Distributed Integrated Multimodal Sensing and Semantic Communications
...
>
---
#### [replaced 038] Structured 3D Latents for Scalable and Versatile 3D Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.01506v3](http://arxiv.org/pdf/2412.01506v3)**

> **作者:** Jianfeng Xiang; Zelong Lv; Sicheng Xu; Yu Deng; Ruicheng Wang; Bowen Zhang; Dong Chen; Xin Tong; Jiaolong Yang
>
> **备注:** Project Page: https://github.com/Microsoft/TRELLIS
>
...
>
---
#### [replaced 039] Efficient Universal Goal Hijacking with Semantics-guided Prompt Organization
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 040] When Are Concepts Erased From Diffusion Models?
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17013v4](http://arxiv.org/pdf/2505.17013v4)**
...
>
---
#### [replaced 043] CLIP-IT: CLIP-based Pairing for Histology Images Classification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.16181v2](http://arxiv.org/pdf/2504.16181v2)**

> **作者:** Banafsheh Karimian; Giulia Avanzato; Soufian Belharbi; Luke McCaffrey; Mohammadhadi Shateri; Eric Granger
>
...
>
---
#### [replaced 046] U2-BENCH: Benchmarking Large Vision-Language Models on Ultrasound Understanding
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.17779v2](http://arxiv.org/pdf/2505.17779v2)**
...
>
---
#### [replaced 047] CraftsMan3D: High-fidelity Mesh Generation with 3D Native Generation and Interactive Geometry Refiner
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2405.14979v4](http://arxiv.org/pdf/2405.14979v4)**
...
>
---
#### [replaced 048] VLM-R$^3$: Region Recognition, Reasoning, and Refinement for Enhanced Multimodal Chain-of-Thought
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.16192v2](http://arxiv.org/pdf/2505.16192v2)**
...
>
---
#### [replaced 049] A Survey on Self-supervised Contrastive Learning for Multimodal Text-Image Analysis
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.11101v3](http://arxiv.org/pdf/2503.11101v3)**
...
>
---
#### [replaced 050] V2SFlow: Video-to-Speech Generation with Speech Decomposition and Rectified Flow
...
>
---
#### [replaced 051] Expansion Quantization Network: An Efficient Micro-emotion Annotation and Detection Framework
...
>
---
#### [replaced 052] Hierarchical Attention Fusion of Visual and Textual Representations for Cross-Domain Sequential Recommendation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.15085v2](http://arxiv.org/pdf/2504.15085v2)**
...
>
---
#### [replaced 053] Reefknot: A Comprehensive Benchmark for Relation Hallucination Evaluation, Analysis and Mitigation in Multimodal Large Language Models
- **分类: cs.LG; cs.CL; cs.CV**
...
>
---
#### [replaced 054] Theorem-Validated Reverse Chain-of-Thought Problem Generation for Geometric Reasoning
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2410.17885v4](http://arxiv.org/pdf/2410.17885v4)**
...
>
---
#### [replaced 055] Adventurer: Optimizing Vision Mamba Architecture Designs for Efficiency
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.07599v2](http://arxiv.org/pdf/2410.07599v2)**
...
>
---
#### [replaced 059] Towards Dynamic 3D Reconstruction of Hand-Instrument Interaction in Ophthalmic Surgery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17677v2](http://arxiv.org/pdf/2505.17677v2)**

> **作者:** Ming Hu; Zhengdi Yu; Feilong Tang; Kaiwen Chen; Yulong Li; Imran Razzak; Junjun He; Tolga Birdal; Kaijing Zhou; Zongyuan Ge
>
...
>
---
#### [replaced 060] SoTA with Less: MCTS-Guided Sample Selection for Data-Efficient Visual Reasoning Self-Improvement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.07934v3](http://arxiv.org/pdf/2504.07934v3)**
...
>
---
#### [replaced 069] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.19883v2](http://arxiv.org/pdf/2505.19883v2)**
...
>
---
#### [replaced 070] Patho-R1: A Multimodal Reinforcement Learning-Based Pathology Expert Reasoner
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.11404v2](http://arxiv.org/pdf/2505.11404v2)**
...
>
---
#### [replaced 073] One-Step is Enough: Sparse Autoencoders for Text-to-Image Diffusion Models
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2410.22366v3](http://arxiv.org/pdf/2410.22366v3)**
...
>
---
#### [replaced 076] A Decade of Wheat Mapping for Lebanon
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.11366v2](http://arxiv.org/pdf/2504.11366v2)**
...
>
---
#### [replaced 082] Enhancing Table Recognition with Vision LLMs: A Benchmark and Neighbor-Guided Toolchain Reasoner
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2412.20662v3](http://arxiv.org/pdf/2412.20662v3)**
...
>
---
#### [replaced 083] Image Captioning Evaluation in the Age of Multimodal LLMs: Challenges and Future Perspectives
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 092] Disentangled Source-Free Personalization for Facial Expression Recognition with Neutral Target Data
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.20771v4](http://arxiv.org/pdf/2503.20771v4)**

> **作者:** Masoumeh Sharafi; Emma Ollivier; Muhammad Osama Zeeshan; Soufiane Belharbi; Marco Pedersoli; Alessandro Lameiras Koerich; Simon Bacon; Eric Granger
>
> **备注:** 13 pages, 13 figures, FG 2025: IEEE Conf. on Automatic Face and Gesture Recognition
>
...
>
---
#### [replaced 093] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23734v2](http://arxiv.org/pdf/2505.23734v2)**
...
>
---
#### [replaced 096] GUICourse: From General Vision Language Models to Versatile GUI Agents
...
>
---
#### [replaced 097] Deep Augmentation: Dropout as Augmentation for Self-Supervised Learning
- **分类: cs.LG; cs.CL; cs.CV**
...
>
---
#### [replaced 098] Re-ttention: Ultra Sparse Visual Generation via Attention Statistical Reshape
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.22918v2](http://arxiv.org/pdf/2505.22918v2)**

> **作者:** Ruichen Chen; Keith G. Mills; Liyao Jiang; Chao Gao; Di Niu
>
> **备注:** Submitted before obtaining agreement of all authors
>
...
>
---
#### [replaced 099] Evaluating Visual and Cultural Interpretation: The K-Viscuit Benchmark with Human-VLM Collaboration
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 100] VideoGameBench: Can Vision-Language Models complete popular video games?
...
>
---
#### [replaced 101] T2VUnlearning: A Concept Erasing Method for Text-to-Video Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17550v2](http://arxiv.org/pdf/2505.17550v2)**
