...
- **链接: [http://arxiv.org/pdf/2509.12046v1](http://arxiv.org/pdf/2509.12046v1)**
...
- **简介: 该论文提出3DAeroRelief，首个用于灾后评估的3D无人机数据集。解决传统2D图像在灾后结构损伤检测中的局限，通过UAV采集真实灾害场景的3D点云与语义标注，推动3D视觉在灾后响应中的应用。**
...
- **简介: 该论文属于医学影像处理任务，旨在解决HR-pQCT中的运动伪影问题。研究提出ESWGAN-GP模型，通过模拟运动伪影并利用深度学习进行图像修复，有效提升了图像质量与结构相似性。**
...
- **简介: 该论文属于多目标跟踪任务，旨在提升运动估计的准确性与鲁棒性。提出SIKNet方法，利用语义无关编码处理状态向量，改进传统卡尔曼滤波器，实验表明其性能优于现有方法。**
...
- **简介: 论文提出CLAIRE模型，用于多模态遥感图像土地覆盖分割。通过双编码器与跨模态融合模块解决类别不平衡和视觉相似性问题，并引入Phi-3语言模型提升可解释性。**
...
- **简介: 论文提出DTGen，基于生成扩散模型的少样本数据增强方法，用于细粒度脏餐具识别。解决现有方法分类粗粒度、少样本数据不足的问题，通过LoRA、结构化提示和CLIP过滤生成高质量样本，提升分类性能，并支持嵌入式部署。**
...
- **简介: 该论文提出Sphere-GAN，用于360°视频显著性估计任务，解决现有算法在球面内容处理上的不足。通过引入球面卷积的GAN模型，提升显著性图预测精度，实验表明其优于现有方法。**
...
- **链接: [http://arxiv.org/pdf/2509.11649v1](http://arxiv.org/pdf/2509.11649v1)**
...
- **链接: [http://arxiv.org/pdf/2509.11539v1](http://arxiv.org/pdf/2509.11539v1)**
...
- **简介: 该论文提出MVQA-68K数据集，用于视频质量评估任务。针对传统方法缺乏可解释性的问题，其引入多维度标注与因果推理，提升模型性能与泛化能力。**
...
- **简介: 该论文提出USCTNet，解决从单幅RGB图像重建物理一致的高光谱图像（HSI）问题。通过核范数正则化和自适应低秩子空间SVT操作，结合CSS和光照估计，提升重建精度。属于图像重建任务。**
...
- **链接: [http://arxiv.org/pdf/2509.10815v1](http://arxiv.org/pdf/2509.10815v1)**
...
>
---
#### [new 033] A Computer Vision Pipeline for Individual-Level Behavior Analysis: Benchmarking on the Edinburgh Pig Dataset
- **分类: cs.CV; cs.AI**
...
- **简介: 该论文提出工业金属数据集IMD，用于6自由度位姿估计，解决现有基准在工业场景中泛化能力不足的问题。构建包含45个真实比例工业部件的数据集，并评估多种模型性能，为工业机器人算法研究提供基准。**
...
- **简介: 该论文提出MHIM-MIL框架，用于巨像素病理图像分析任务，解决传统MIL方法忽视难例的问题。通过掩码硬实例挖掘和一致性约束，提升模型性能与效率。**
...
- **简介: 论文提出Pseudo-D框架，解决医学图像诊断中模型过度自信的问题。通过神经网络训练动态生成不确定性伪标签，提升多视角分类的鲁棒性和校准能力。属于医疗图像分类任务。**
...
- **简介: 该论文提出一种多任务扩散模型，用于预测胶质瘤进展。解决数据稀疏导致的建模困难，通过生成未来MRI图像和概率图，并结合放射治疗信息优化预测，提升肿瘤演变预测的准确性与可靠性。**
...
- **简介: 论文提出一种音视频融合方法，用于动画电影中角色识别与理解。针对传统人脸识别在动画角色多样性上的不足，构建音视频角色库，并应用于无障碍描述生成与字幕生成。任务为角色中心的动画内容理解，解决角色识别与多模态信息处理问题。**
...
- **链接: [http://arxiv.org/pdf/2509.11301v1](http://arxiv.org/pdf/2509.11301v1)**
...
- **简介: 该论文提出EditDuet，一种多智能体视频非线性编辑系统。任务是自动化视频编辑，解决传统方法依赖用户操作的问题。设计Editor和Critic智能体，通过自然语言指令与反馈实现自动编辑，并引入LLM评估指标，实验表明其在多个方面优于现有方法。**
...
- **简介: 论文提出GEMMNet框架，解决遥感语义分割中多模态数据缺失问题。通过HyFEx、HyFMA和CoLoss组件，提升生成模型在复杂场景下的性能，优于现有生成与非生成方法。属于多模态遥感图像语义分割任务。**
...
- **简介: 该论文提出通过旋转潜在空间分离生物与技术因素，解决医学影像中因设备和技术参数导致的域偏移问题，提升疾病模式发现效果。方法在真实数据中显著提升聚类稳定性，并增强生存预测能力，属于医学影像表征学习任务。**
...
- **简介: 该论文提出Beyond Sliders框架，结合GAN与扩散模型，解决传统概念滑块在真实场景图像编辑中的不足，实现更精细的文本和视觉引导图像操控，提升生成质量与真实性。属于图像编辑任务。**
...
- **简介: 该论文提出SP4D框架，从单目输入生成多视角RGB和运动部件视频。任务为多视角视频生成，解决传统分割方法依赖外观线索的问题。采用双分支扩散模型与空间颜色编码，提升部件一致性与生成质量。**
...
- **简介: 论文提出AutoOEP，一种多模态在线考试监考框架，通过双摄像头和机器学习检测作弊行为。该系统整合人脸识别、手部动作分析及LSTM网络，实现高效、准确的自动监考，提升在线考试的学术诚信。**
...
- **简介: 该论文属于小样本分类任务，旨在解决真菌物种识别中数据不平衡和样本稀缺问题。提出基于原型网络的深度学习方法，提升稀有物种识别效果，在FungiCLEF 2025竞赛中显著超越基线。**
...
>
---
#### [new 066] The Impact of Skin Tone Label Granularity on the Performance and Fairness of AI Based Dermatology Image Classification Models
- **分类: cs.CV**

- **简介: 该论文研究皮肤色调分类粒度对AI皮肤病分类模型性能与公平性的影响。通过对比不同粒度FST数据训练的模型，发现粒度影响性能与偏见。提出应采用更公平的皮肤色调分类标准以提升模型公平性。**

- **链接: [http://arxiv.org/pdf/2509.11184v1](http://arxiv.org/pdf/2509.11184v1)**
...
>
---
#### [new 074] Learning to Generate 4D LiDAR Sequences
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出LiDARCrafter框架，用于生成4D LiDAR序列，解决生成可控、时序稳定LiDAR数据的问题。通过语言指令生成场景图，并利用扩散模型生成可编辑的LiDAR序列，提供评估基准EvalSuite，实现高保真和时序一致性。**
...
>
---
#### [new 075] Point-Plane Projections for Accurate LiDAR Semantic Segmentation in Small Data Scenarios
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 076] Leveraging Geometric Priors for Unaligned Scene Change Detection
- **分类: cs.CV**

- **简介: 该论文属于未对齐场景变化检测任务，旨在解决视角变化导致的匹配失效问题。提出利用几何先验信息，结合视觉基础模型，实现无需训练的可靠变化检测，提升多视角下重叠区域识别与遮挡检测能力。**

- **链接: [http://arxiv.org/pdf/2509.11292v1](http://arxiv.org/pdf/2509.11292v1)**
...
>
---
#### [new 077] Every Camera Effect, Every Time, All at Once: 4D Gaussian Ray Tracing for Physics-based Camera Effect Data Generation
- **分类: cs.CV**

- **简介: 论文提出4D-GRT方法，解决真实相机效果数据生成问题。通过结合4D高斯点绘与物理光线追踪，实现高效、高质量的动态场景渲染，并构建基准数据集评估效果。属于计算机视觉中的相机效果模拟任务。**

- **链接: [http://arxiv.org/pdf/2509.10759v1](http://arxiv.org/pdf/2509.10759v1)**
...
>
> **摘要:** Recent advancements in large video models (LVMs) have significantly enhance video understanding. However, these models continue to suffer from hallucinations, producing content that conflicts with input videos. To address this issue, we propose Dr.V, a hierarchical framework covering perceptive, temporal, and cognitive levels to diagnose video hallucination by fine-grained spatial-temporal grounding. Dr.V comprises of two key components: a benchmark dataset Dr.V-Bench and a satellite video agent Dr.V-Agent. Dr.V-Bench includes 10k instances drawn from 4,974 videos spanning diverse tasks, each enriched with detailed spatial-temporal annotation. Dr.V-Agent detects hallucinations in LVMs by systematically applying fine-grained spatial-temporal grounding at the perceptive and temporal levels, followed by cognitive level reasoning. This step-by-step pipeline mirrors human-like video comprehension and effectively identifies hallucinations. Extensive experiments demonstrate that Dr.V-Agent is effective in diagnosing hallucination while enhancing interpretability and reliability, offering a practical blueprint for robust video understanding in real-world scenarios. All our data and code are available at https://github.com/Eurekaleo/Dr.V.
>
---
#### [new 088] In-Vivo Skin 3-D Surface Reconstruction and Wrinkle Depth Estimation using Handheld High Resolution Tactile Sensing
- **分类: cs.CV**

- **简介: 该论文提出一种手持式高分辨率触觉传感探头，用于皮肤3D表面重建与皱纹深度估计。任务是解决缺乏便携、高精度皮肤深度测量工具的问题，通过弹性凝胶和学习算法实现微米级精度，并验证其在多部位皮肤分析中的有效性。**

- **链接: [http://arxiv.org/pdf/2509.11385v1](http://arxiv.org/pdf/2509.11385v1)**
...
>
---
#### [new 090] MindVL: Towards Efficient and Effective Training of Multimodal Large Language Models on Ascend NPUs
...
>
---
#### [new 091] No Modality Left Behind: Dynamic Model Generation for Incomplete Medical Data
- **分类: cs.CV**

- **简介: 论文提出一种基于超网络的方法，动态生成适应可用模态的任务模型，解决医疗数据多模态缺失问题。该方法无需丢弃或填补缺失数据，提升模型鲁棒性与泛化能力，属于多模态医学图像分类任务。**

- **链接: [http://arxiv.org/pdf/2509.11406v1](http://arxiv.org/pdf/2509.11406v1)**
...
>
---
#### [new 096] Lost in Embeddings: Information Loss in Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 097] RouteExtract: A Modular Pipeline for Extracting Routes from Paper Maps
- **分类: cs.CV**

- **简介: 该论文提出RouteExtract，从纸质地图中提取路线用于GPS导航。任务是地图路线提取，解决数字导航缺少本地化信息的问题。方法结合地理配准、图像分割、图构建和路径优化，实现多样地图风格的路线恢复。**

- **链接: [http://arxiv.org/pdf/2509.11674v1](http://arxiv.org/pdf/2509.11674v1)**
...
>
---
#### [new 105] End-to-End Visual Autonomous Parking via Control-Aided Attention
- **分类: cs.CV**

- **简介: 该论文提出CAA-Policy，解决端到端视觉自主泊车中感知与控制协同不足的问题。通过控制信号引导视觉注意力学习，提升政策稳定性与泛化性，并引入辅助任务增强跟踪能力，实验证明其在CARLA中表现优于现有方法。**

- **链接: [http://arxiv.org/pdf/2509.11090v1](http://arxiv.org/pdf/2509.11090v1)**
...
>
---
#### [new 106] A Copula-Guided Temporal Dependency Method for Multitemporal Hyperspectral Images Unmixing
- **分类: cs.CV**

- **简介: 该论文提出一种基于Copula理论的时序依赖方法（Cog-TD），用于多时相高光谱图像解混任务，旨在建模动态端元和丰度变化。通过引入Copula函数，构建框架并设计两个关键模块，有效捕捉时间依赖性，提升解混性能。**

- **链接: [http://arxiv.org/pdf/2509.11096v1](http://arxiv.org/pdf/2509.11096v1)**
...
>
---
#### [new 109] LFRA-Net: A Lightweight Focal and Region-Aware Attention Network for Retinal Vessel Segmentatio
- **分类: cs.CV**

- **简介: 该论文提出LFRA-Net，用于视网膜血管分割任务，旨在解决小血管提取困难和计算成本高的问题。通过引入焦点调制注意力和区域感知注意力机制，实现轻量高效分割，在多个数据集上取得优异性能。**

- **链接: [http://arxiv.org/pdf/2509.11811v1](http://arxiv.org/pdf/2509.11811v1)**
...
>
---
#### [new 110] FineQuest: Adaptive Knowledge-Assisted Sports Video Understanding via Agent-of-Thoughts Reasoning
- **分类: cs.CV**

- **简介: 该论文提出FineQuest，一种无需训练的视频问答框架，用于解决体育视频理解中的复杂问题。通过引入认知科学启发的双模式推理和多模态知识图谱SSGraph，提升模型在体育领域的问答性能，并构建两个新基准测试数据集。**

- **链接: [http://arxiv.org/pdf/2509.11796v1](http://arxiv.org/pdf/2509.11796v1)**
...
>
---
#### [new 116] OmniWorld: A Multi-Domain and Multi-Modal Dataset for 4D World Modeling
- **分类: cs.CV**

- **简介: 该论文提出OmniWorld数据集，用于4D世界建模任务，解决现有数据集动态复杂度和多领域多样性不足的问题。通过构建大规模、多模态数据集，推动4D几何重建与视频生成等任务的发展。**

- **链接: [http://arxiv.org/pdf/2509.12201v1](http://arxiv.org/pdf/2509.12201v1)**
...
>
> **备注:** https://yangzhou24.github.io/OmniWorld/
>
> **摘要:** The field of 4D world modeling - aiming to jointly capture spatial geometry and temporal dynamics - has witnessed remarkable progress in recent years, driven by advances in large-scale generative models and multimodal learning. However, the development of truly general 4D world models remains fundamentally constrained by the availability of high-quality data. Existing datasets and benchmarks often lack the dynamic complexity, multi-domain diversity, and spatial-temporal annotations required to support key tasks such as 4D geometric reconstruction, future prediction, and camera-control video generation. To address this gap, we introduce OmniWorld, a large-scale, multi-domain, multi-modal dataset specifically designed for 4D world modeling. OmniWorld consists of a newly collected OmniWorld-Game dataset and several curated public datasets spanning diverse domains. Compared with existing synthetic datasets, OmniWorld-Game provides richer modality coverage, larger scale, and more realistic dynamic interactions. Based on this dataset, we establish a challenging benchmark that exposes the limitations of current state-of-the-art (SOTA) approaches in modeling complex 4D environments. Moreover, fine-tuning existing SOTA methods on OmniWorld leads to significant performance gains across 4D reconstruction and video generation tasks, strongly validating OmniWorld as a powerful resource for training and evaluation. We envision OmniWorld as a catalyst for accelerating the development of general-purpose 4D world models, ultimately advancing machines' holistic understanding of the physical world.
>
---
#### [new 117] Integrating Prior Observations for Incremental 3D Scene Graph Prediction
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出一种异构图模型，用于增量式3D语义场景图预测，整合多模态信息如先验观察，解决传统方法依赖完整场景重建和单一传感器数据的问题，提升现实复杂环境中的泛化能力。**

- **链接: [http://arxiv.org/pdf/2509.11895v1](http://arxiv.org/pdf/2509.11895v1)**
...
>
---
#### [new 119] End-to-End 4D Heart Mesh Recovery Across Full-Stack and Sparse Cardiac MRI
- **分类: cs.CV**

- **简介: 该论文提出TetHeart框架，解决从稀疏或完整心脏MRI序列中重建4D心脏网格的问题。其统一处理全栈与稀疏观测，利用深度可变形四面体和混合表示，实现高精度、强泛化的术前与术中心脏运动建模。**

- **链接: [http://arxiv.org/pdf/2509.12090v1](http://arxiv.org/pdf/2509.12090v1)**
...
>
---
#### [new 120] Progressive Flow-inspired Unfolding for Spectral Compressive Imaging
- **分类: cs.CV**

- **简介: 该论文提出一种轨迹可控的深度展开网络，用于解决高光谱成像中的重建问题。通过引入扩散轨迹与流匹配思想，设计高效的空间-光谱Transformer和频域融合模块，实现更优的重建质量与效率。**

- **链接: [http://arxiv.org/pdf/2509.12079v1](http://arxiv.org/pdf/2509.12079v1)**
...
>
---
#### [new 129] Action Hints: Semantic Typicality and Context Uniqueness for Generalizable Skeleton-based Video Anomaly Detection
- **分类: cs.CV**

- **简介: 论文提出一种零样本视频异常检测框架，利用骨骼数据中的动作典型性与场景独特性进行检测。无需目标域训练数据，通过语义引导和时空分析实现跨场景泛化，在多个数据集上取得优异结果。属于视频异常检测任务，解决跨场景泛化问题。**

- **链接: [http://arxiv.org/pdf/2509.11058v1](http://arxiv.org/pdf/2509.11058v1)**
...
>
---
#### [new 130] A Fully Open and Generalizable Foundation Model for Ultrasound Clinical Applications
- **分类: cs.CV**

- **简介: 论文提出EchoCare，一个基于自监督学习的超声基础模型，解决临床超声AI模型泛化性差的问题。利用全球多中心、多设备数据集，结合分层分类器，实现像素级与表征级特征联合学习，提升多种超声任务性能。**

- **链接: [http://arxiv.org/pdf/2509.11752v1](http://arxiv.org/pdf/2509.11752v1)**
...
>
---
#### [new 134] Robust Fetal Pose Estimation across Gestational Ages via Cross-Population Augmentation
- **分类: cs.CV**

- **简介: 该论文提出一种跨人群数据增强框架，用于解决胎儿体姿估计在不同孕周间的泛化问题。通过模拟早期孕周的子宫环境，提升模型在早孕期的估计性能，从而支持更早的临床检测与干预。**

- **链接: [http://arxiv.org/pdf/2509.12062v1](http://arxiv.org/pdf/2509.12062v1)**
...
>
---
#### [new 135] The System Description of CPS Team for Track on Driving with Language of CVPR 2024 Autonomous Grand Challenge
...
>
---
#### [new 138] IS-Diff: Improving Diffusion-Based Inpainting with Better Initial Seed
- **分类: cs.CV**

- **简介: 该论文属于图像修复任务，旨在解决传统扩散模型因随机初始化种子导致的语义不一致问题。提出IS-Diff方法，利用未遮挡区域生成初始种子，并引入动态修正机制，提升修复结果的一致性与真实性。**

- **链接: [http://arxiv.org/pdf/2509.11638v1](http://arxiv.org/pdf/2509.11638v1)**
...
>
> **摘要:** Diffusion models have revolutionized high-fidelity image and video synthesis, yet their computational demands remain prohibitive for real-time applications. These models face two fundamental challenges: strict temporal dependencies preventing parallelization, and computationally intensive forward passes required at each denoising step. Drawing inspiration from speculative decoding in large language models, we present SpeCa, a novel 'Forecast-then-verify' acceleration framework that effectively addresses both limitations. SpeCa's core innovation lies in introducing Speculative Sampling to diffusion models, predicting intermediate features for subsequent timesteps based on fully computed reference timesteps. Our approach implements a parameter-free verification mechanism that efficiently evaluates prediction reliability, enabling real-time decisions to accept or reject each prediction while incurring negligible computational overhead. Furthermore, SpeCa introduces sample-adaptive computation allocation that dynamically modulates resources based on generation complexity, allocating reduced computation for simpler samples while preserving intensive processing for complex instances. Experiments demonstrate 6.34x acceleration on FLUX with minimal quality degradation (5.5% drop), 7.3x speedup on DiT while preserving generation fidelity, and 79.84% VBench score at 6.1x acceleration for HunyuanVideo. The verification mechanism incurs minimal overhead (1.67%-3.5% of full inference costs), establishing a new paradigm for efficient diffusion model inference while maintaining generation quality even at aggressive acceleration ratios. Our codes have been released in Github: \textbf{https://github.com/Shenyi-Z/Cache4Diffusion}
>
---
#### [new 146] Early Detection of Branched Broomrape (Phelipanche ramosa) Infestation in Tomato Crops Using Leaf Spectral Analysis and Machine Learning
...
>
---
#### [new 147] Maestro: Self-Improving Text-to-Image Generation via Agent Orchestration
- **分类: cs.AI; cs.CV**

- **简介: 论文提出Maestro系统，解决文本到图像生成中依赖人工干预的问题。通过自我批评和进化机制，利用多模态大模型自动优化提示词，提升生成图像质量，属于自改进图像生成任务。**

- **链接: [http://arxiv.org/pdf/2509.10704v1](http://arxiv.org/pdf/2509.10704v1)**
...
>
---
#### [new 153] Introduction to a Low-Cost AI-Powered GUI for Unstained Cell Culture Analysis
- **分类: q-bio.QM; cs.CV; eess.IV; q-bio.CB**

- **简介: 论文提出一种低成本AI驱动的GUI工具，用于分析未染色细胞培养图像。该框架无需标注数据，支持语义分割与特征提取，适用于无编程基础用户，具备快速分割与自动化报告生成能力，提升细胞研究效率。**

- **链接: [http://arxiv.org/pdf/2509.11354v1](http://arxiv.org/pdf/2509.11354v1)**
...
>
---
#### [new 156] Spectral and Rhythm Features for Audio Classification with Deep Convolutional Neural Networks
...
>
---
#### [new 157] TrajBooster: Boosting Humanoid Whole-Body Manipulation via Trajectory-Centric Learning
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 160] UltraUPConvNet: A UPerNet- and ConvNeXt-Based Multi-Task Network for Ultrasound Tissue Segmentation and Disease Prediction
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出UltraUPConvNet，一种基于UPerNet和ConvNeXt的多任务网络，用于超声图像的组织分割与疾病预测。旨在解决传统方法分别处理任务导致的计算开销大的问题，实现高效统一的模型。**

- **链接: [http://arxiv.org/pdf/2509.11108v1](http://arxiv.org/pdf/2509.11108v1)**
...
>
---
#### [new 161] Advancing Medical Artificial Intelligence Using a Century of Cases
- **分类: cs.AI; cs.CV**

- **简介: 论文提出CPC-Bench基准和Dr. CaBot AI系统，评估大语言模型在医学推理与展示中的表现。任务为提升医疗AI，解决其在复杂诊断与图像识别中的不足，通过大量病例数据验证模型性能，并推动医疗AI研究进展。**

- **链接: [http://arxiv.org/pdf/2509.12194v1](http://arxiv.org/pdf/2509.12194v1)**
...
>
---
#### [new 166] Adapting Medical Vision Foundation Models for Volumetric Medical Image Segmentation via Active Learning and Selective Semi-supervised Fine-tuning
- **分类: eess.IV; cs.CV**

- **简介: 论文提出一种主动源无关域适应（ASFDA）方法，用于高效适配医学视觉基础模型（Med-VFMs）进行体积医学图像分割。通过主动学习选择信息样本和半监督微调，解决目标域性能优化问题。**

- **链接: [http://arxiv.org/pdf/2509.10784v1](http://arxiv.org/pdf/2509.10784v1)**
...
>
---
#### [new 167] CrunchLLM: Multitask LLMs for Structured Business Reasoning and Outcome Prediction
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出CrunchLLM，用于预测初创公司成功（如被收购或上市）。任务是结合结构化和非结构化数据进行多任务学习。通过参数高效微调和提示优化，提升预测准确率至80%以上，并提供可解释的推理过程，助力决策。**

- **链接: [http://arxiv.org/pdf/2509.10698v1](http://arxiv.org/pdf/2509.10698v1)**
...
>
---
#### [new 168] CoachMe: Decoding Sport Elements with a Reference-Based Coaching Instruction Generation Model
...
>
---
#### [new 169] ParaEQsA: Parallel and Asynchronous Embodied Questions Scheduling and Answering
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文提出ParaEQsA框架，解决多任务、异步且有紧急程度的具身问答问题。通过共享记忆模块和优先级调度，提升系统效率与响应性，并构建PAEQs基准与新评估指标。**
...
>
---
#### [new 170] DSRAG: A Domain-Specific Retrieval Framework Based on Document-derived Multimodal Knowledge Graph
...
>
---
#### [new 171] Accurate and Private Diagnosis of Rare Genetic Syndromes from Facial Images with Federated Deep Learning
- **分类: cs.LG; cs.CR; cs.CV**

- **简介: 论文提出一种联邦深度学习框架，用于在保护隐私的前提下，通过面部图像准确诊断罕见遗传综合征。该方法解决了数据分散和隐私限制问题，实现了跨机构协作训练，保持高诊断性能。**

- **链接: [http://arxiv.org/pdf/2509.10635v1](http://arxiv.org/pdf/2509.10635v1)**
...
>
---
#### [new 172] PersonaX: Multimodal Datasets with LLM-Inferred Behavior Traits
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出PersonaX多模态数据集，包含公众人物和运动员的面部图像、生平信息及LLM推断的行为特征，用于研究行为特质的跨模态分析与因果推理，解决现有数据缺乏多模态行为描述的问题。**

- **链接: [http://arxiv.org/pdf/2509.11362v1](http://arxiv.org/pdf/2509.11362v1)**

> **作者:** Loka Li; Wong Yu Kang; Minghao Fu; Guangyi Chen; Zhenhao Chen; Gongxu Luo; Yuewen Sun; Salman Khan; Peter Spirtes; Kun Zhang
>
> **摘要:** Understanding human behavior traits is central to applications in human-computer interaction, computational social science, and personalized AI systems. Such understanding often requires integrating multiple modalities to capture nuanced patterns and relationships. However, existing resources rarely provide datasets that combine behavioral descriptors with complementary modalities such as facial attributes and biographical information. To address this gap, we present PersonaX, a curated collection of multimodal datasets designed to enable comprehensive analysis of public traits across modalities. PersonaX consists of (1) CelebPersona, featuring 9444 public figures from diverse occupations, and (2) AthlePersona, covering 4181 professional athletes across 7 major sports leagues. Each dataset includes behavioral trait assessments inferred by three high-performing large language models, alongside facial imagery and structured biographical features. We analyze PersonaX at two complementary levels. First, we abstract high-level trait scores from text descriptions and apply five statistical independence tests to examine their relationships with other modalities. Second, we introduce a novel causal representation learning (CRL) framework tailored to multimodal and multi-measurement data, providing theoretical identifiability guarantees. Experiments on both synthetic and real-world data demonstrate the effectiveness of our approach. By unifying structured and unstructured analysis, PersonaX establishes a foundation for studying LLM-inferred behavioral traits in conjunction with visual and biographical attributes, advancing multimodal trait analysis and causal reasoning.
>
---
#### [new 173] Geometric Analysis of Magnetic Labyrinthine Stripe Evolution via U-Net Segmentation
- **分类: cond-mat.mtrl-sci; cs.CV**

- **简介: 该论文利用U-Net分割磁光图像，分析磁场退火下Bi:YIG薄膜中迷宫条纹的几何演化，解决其定量表征难题，提出几何分析框架，揭示两种演化模式，为复杂迷宫系统提供分析工具。**

- **链接: [http://arxiv.org/pdf/2509.11485v1](http://arxiv.org/pdf/2509.11485v1)**
...
>
---
#### [new 177] MIDOG 2025 Track 2: A Deep Learning Model for Classification of Atypical and Normal Mitotic Figures under Class and Hardness Imbalances
- **分类: eess.IV; cs.CV; q-bio.QM**

- **简介: 该论文提出一种基于ResNet的深度学习模型，用于分类正常与异常有丝分裂图像，解决类别不平衡和图像难度差异问题。通过焦点损失和数据增强，模型在MIDOG 2025数据集上表现出高准确率和泛化能力。**

- **链接: [http://arxiv.org/pdf/2509.10502v1](http://arxiv.org/pdf/2509.10502v1)**
...
>
---
#### [new 184] AD-GS: Alternating Densification for Sparse-Input 3D Gaussian Splatting
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出AD-GS方法，解决3D高斯泼溅在稀疏视角下出现的伪影和几何不准确问题。通过交替高、低密度阶段，控制模型容量增长，提升渲染质量和几何一致性，属于三维重建与新视角合成任务。**

- **链接: [http://arxiv.org/pdf/2509.11003v1](http://arxiv.org/pdf/2509.11003v1)**
...
#### [replaced 001] HueManity: Probing Fine-Grained Visual Perception in MLLMs
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.03194v4](http://arxiv.org/pdf/2506.03194v4)**
...
>
---
#### [replaced 002] PartComposer: Learning and Composing Part-Level Concepts from Single-Image Examples
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03004v2](http://arxiv.org/pdf/2506.03004v2)**
...
>
---
#### [replaced 003] Blending 3D Geometry and Machine Learning for Multi-View Stereopsis
- **分类: cs.CV; cs.AI; cs.CG; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.03470v4](http://arxiv.org/pdf/2505.03470v4)**
...
>
---
#### [replaced 007] LayerLock: Non-collapsing Representation Learning with Progressive Freezing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.10156v2](http://arxiv.org/pdf/2509.10156v2)**
...
>
---
#### [replaced 008] SCP-Diff: Spatial-Categorical Joint Prior for Diffusion Based Semantic Image Synthesis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.09638v3](http://arxiv.org/pdf/2403.09638v3)**

> **作者:** Huan-ang Gao; Mingju Gao; Jiaju Li; Wenyi Li; Rong Zhi; Hao Tang; Hao Zhao
>
> **备注:** Project Page: https://air-discover.github.io/SCP-Diff/
>
...
>
---
#### [replaced 009] Earth Observation Foundation Model PhilEO: Pretraining on the MajorTOM and FastTOM Datasets
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.14765v3](http://arxiv.org/pdf/2506.14765v3)**
...
>
---
#### [replaced 012] Remote Sensing SpatioTemporal Vision-Language Models: A Comprehensive Survey
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.02573v3](http://arxiv.org/pdf/2412.02573v3)**

> **作者:** Chenyang Liu; Jiafan Zhang; Keyan Chen; Man Wang; Zhengxia Zou; Zhenwei Shi
>
> **备注:** Published in IEEE Geoscience and Remote Sensing Magazine
>
...
>
---
#### [replaced 013] GGMotion: Group Graph Dynamics-Kinematics Networks for Human Motion Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07515v2](http://arxiv.org/pdf/2507.07515v2)**
...
>
---
#### [replaced 016] On the Generalization of Representation Uncertainty in Earth Observation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.07082v2](http://arxiv.org/pdf/2503.07082v2)**
...
>
> **备注:** 14 pages, 5 figures; accepted at the 2025 MICCAI Perinatal, Preterm and Paediatric Image Analysis (PIPPI) Workshop
>
...
>
---
#### [replaced 019] DLF: Extreme Image Compression with Dual-generative Latent Fusion
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2503.01428v3](http://arxiv.org/pdf/2503.01428v3)**
...
>
---
#### [replaced 020] Evaluating Representational Similarity Measures from the Lens of Functional Correspondence
- **分类: q-bio.NC; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2411.14633v2](http://arxiv.org/pdf/2411.14633v2)**

> **作者:** Yiqing Bo; Ansh Soni; Sudhanshu Srivastava; Meenakshi Khosla
>
> **备注:** Published in CCN 2025 Proceedings (Talk & Poster), May 14, 2025
>
> **摘要:** Neuroscience and artificial intelligence (AI) both face the challenge of interpreting high-dimensional neural data, where the comparative analysis of such data is crucial for revealing shared mechanisms and differences between these complex systems. Despite the widespread use of representational comparisons and the abundance classes of comparison methods, a critical question remains: which metrics are most suitable for these comparisons? While some studies evaluate metrics based on their ability to differentiate models of different origins or constructions (e.g., various architectures), another approach is to assess how well they distinguish models that exhibit distinct behaviors. To investigate this, we examine the degree of alignment between various representational similarity measures and behavioral outcomes, employing group statistics and a comprehensive suite of behavioral metrics for comparison. In our evaluation of eight commonly used representational similarity metrics in the visual domain -- spanning alignment-based, Canonical Correlation Analysis (CCA)-based, inner product kernel-based, and nearest-neighbor methods -- we found that metrics like linear Centered Kernel Alignment (CKA) and Procrustes distance, which emphasize the overall geometric structure or shape of representations, excelled in differentiating trained from untrained models and aligning with behavioral measures, whereas metrics such as linear predictivity, commonly used in neuroscience, demonstrated only moderate alignment with behavior. These insights are crucial for selecting metrics that emphasize behaviorally meaningful comparisons in NeuroAI research.
>
---
#### [replaced 021] LH2Face: Loss function for Hard High-quality Face
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23555v2](http://arxiv.org/pdf/2506.23555v2)**
...
>
---
#### [replaced 022] KB-DMGen: Knowledge-Based Global Guidance and Dynamic Pose Masking for Human Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.20083v2](http://arxiv.org/pdf/2507.20083v2)**
...
>
---
#### [replaced 023] UnIRe: Unsupervised Instance Decomposition for Dynamic Urban Scene Reconstruction
- **分类: cs.CV; cs.RO**

- **链接: [http://arxiv.org/pdf/2504.00763v2](http://arxiv.org/pdf/2504.00763v2)**

> **作者:** Yunxuan Mao; Rong Xiong; Yue Wang; Yiyi Liao
>
> **摘要:** Reconstructing and decomposing dynamic urban scenes is crucial for autonomous driving, urban planning, and scene editing. However, existing methods fail to perform instance-aware decomposition without manual annotations, which is crucial for instance-level scene editing.We propose UnIRe, a 3D Gaussian Splatting (3DGS) based approach that decomposes a scene into a static background and individual dynamic instances using only RGB images and LiDAR point clouds. At its core, we introduce 4D superpoints, a novel representation that clusters multi-frame LiDAR points in 4D space, enabling unsupervised instance separation based on spatiotemporal correlations. These 4D superpoints serve as the foundation for our decomposed 4D initialization, i.e., providing spatial and temporal initialization to train a dynamic 3DGS for arbitrary dynamic classes without requiring bounding boxes or object templates.Furthermore, we introduce a smoothness regularization strategy in both 2D and 3D space, further improving the temporal stability.Experiments on benchmark datasets show that our method outperforms existing methods in decomposed dynamic scene reconstruction while enabling accurate and flexible instance-level editing, making it a practical solution for real-world applications.
>
---
#### [replaced 024] First RAG, Second SEG: A Training-Free Paradigm for Camouflaged Object Detection
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.15313v2](http://arxiv.org/pdf/2508.15313v2)**
...
>
---
#### [replaced 025] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.20220v2](http://arxiv.org/pdf/2502.20220v2)**
...
>
---
#### [replaced 027] IRDFusion: Iterative Relation-Map Difference guided Feature Fusion for Multispectral Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.09085v2](http://arxiv.org/pdf/2509.09085v2)**

> **作者:** Jifeng Shen; Haibo Zhan; Xin Zuo; Heng Fan; Xiaohui Yuan; Jun Li; Wankou Yang
>
> **备注:** 31 pages,6 figures, submitted on 3 Sep,2025
>
...
>
---
#### [replaced 032] PainFormer: a Vision Foundation Model for Automatic Pain Assessment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.01571v4](http://arxiv.org/pdf/2505.01571v4)**
...
>
---
#### [replaced 033] STRICT: Stress Test of Rendering Images Containing Text
...
>
---
#### [replaced 034] 3D Mesh Editing using Masked LRMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.08641v2](http://arxiv.org/pdf/2412.08641v2)**

> **作者:** Will Gao; Dilin Wang; Yuchen Fan; Aljaz Bozic; Tuur Stuyck; Zhengqin Li; Zhao Dong; Rakesh Ranjan; Nikolaos Sarafianos
>
> **备注:** ICCV 2025. Project Page: https://chocolatebiscuit.github.io/MaskedLRM/
>
...
>
---
#### [replaced 035] Video Signature: In-generation Watermarking for Latent Video Diffusion Models
- **分类: cs.CV; cs.CR**

- **链接: [http://arxiv.org/pdf/2506.00652v3](http://arxiv.org/pdf/2506.00652v3)**
...
>
---
#### [replaced 036] Implicit Neural Representations of Intramyocardial Motion and Strain
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.09004v2](http://arxiv.org/pdf/2509.09004v2)**

> **作者:** Andrew Bell; Yan Kit Choi; Steffen E Peterson; Andrew King; Muhummad Sohaib Nazir; Alistair A Young
>
...
>
---
#### [replaced 037] EasyEdit2: An Easy-to-use Steering Framework for Editing Large Language Models
...
>
---
#### [replaced 038] Occlusion-Aware Temporally Consistent Amodal Completion for 3D Human-Object Interaction Reconstruction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.08137v3](http://arxiv.org/pdf/2507.08137v3)**
...
>
---
#### [replaced 039] Abn-BLIP: Abnormality-aligned Bootstrapping Language-Image Pre-training for Pulmonary Embolism Diagnosis and Report Generation from CTPA
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.02034v2](http://arxiv.org/pdf/2503.02034v2)**
...
>
---
#### [replaced 040] So-Fake: Benchmarking and Explaining Social Media Image Forgery Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18660v3](http://arxiv.org/pdf/2505.18660v3)**
...
>
---
#### [replaced 041] MEPG:Multi-Expert Planning and Generation for Compositionally-Rich Image Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.04126v2](http://arxiv.org/pdf/2509.04126v2)**

> **作者:** Yuan Zhao; Lin Liu
>
...
>
---
#### [replaced 042] Motion Blender Gaussian Splatting for Dynamic Scene Reconstruction
- **分类: cs.CV; cs.RO**

- **链接: [http://arxiv.org/pdf/2503.09040v3](http://arxiv.org/pdf/2503.09040v3)**
...
>
---
#### [replaced 045] Single-shot HDR using conventional image sensor shutter functions and optical randomization
...
>
---
#### [replaced 046] SAIF: Sparse Adversarial and Imperceptible Attack Framework
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2212.07495v4](http://arxiv.org/pdf/2212.07495v4)**

> **作者:** Tooba Imtiaz; Morgan Kohler; Jared Miller; Zifeng Wang; Masih Eskandar; Mario Sznaier; Octavia Camps; Jennifer Dy
>
...
>
---
#### [replaced 047] CVVNet: A Cross-Vertical-View Network for Gait Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.01837v3](http://arxiv.org/pdf/2505.01837v3)**

> **作者:** Xiangru Li; Wei Song; Yingda Huang; Wei Meng; Le Chang; Hongyang Li
>
...
>
---
#### [replaced 048] TeleOpBench: A Simulator-Centric Benchmark for Dual-Arm Dexterous Teleoperation
- **分类: cs.RO; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.12748v2](http://arxiv.org/pdf/2505.12748v2)**
...
>
---
#### [replaced 049] How Blind and Low-Vision Individuals Prefer Large Vision-Language Model-Generated Scene Descriptions
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.14883v2](http://arxiv.org/pdf/2502.14883v2)**

> **作者:** Na Min An; Eunki Kim; Wan Ju Kang; Sangryul Kim; James Thorne; Hyunjung Shim
>
> **备注:** 23 pages, 8 figures, 16 tables
>
...
>
---
#### [replaced 050] Improved Classification of Nitrogen Stress Severity in Plants Under Combined Stress Conditions Using Spatio-Temporal Deep Learning Framework
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.06625v2](http://arxiv.org/pdf/2509.06625v2)**
...
>
---
#### [replaced 055] Similarity-based Outlier Detection for Noisy Object Re-Identification Using Beta Mixtures
- **分类: cs.CV; cs.AI; cs.LG; math.ST; stat.ML; stat.TH**

- **链接: [http://arxiv.org/pdf/2509.08926v3](http://arxiv.org/pdf/2509.08926v3)**
...
>
---
#### [replaced 059] What is the Visual Cognition Gap between Humans and Multimodal LLMs?
- **分类: cs.CV; cs.AI; 68T01**

- **链接: [http://arxiv.org/pdf/2406.10424v2](http://arxiv.org/pdf/2406.10424v2)**
...
>
---
#### [replaced 061] Steering LVLMs via Sparse Autoencoder for Hallucination Mitigation
...
>
---
#### [replaced 062] STADI: Fine-Grained Step-Patch Diffusion Parallelism for Heterogeneous GPUs
- **分类: cs.DC; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.04719v2](http://arxiv.org/pdf/2509.04719v2)**
...
>
---
#### [replaced 063] Social Perception of Faces in a Vision-Language Model
...
>
---
#### [replaced 064] Surveying the Landscape of Image Captioning Evaluation: A Comprehensive Taxonomy, Trends and Metrics Analysis
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 065] Multilingual Diversity Improves Vision-Language Representations
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2405.16915v3](http://arxiv.org/pdf/2405.16915v3)**
...
>
---
#### [replaced 067] A Statistical 3D Stomach Shape Model for Anatomical Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.06464v2](http://arxiv.org/pdf/2509.06464v2)**
...
>
---
#### [replaced 072] Eye, Robot: Learning to Look to Act with a BC-RL Perception-Action Loop
- **分类: cs.RO; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.10968v2](http://arxiv.org/pdf/2506.10968v2)**
...
>
---
#### [replaced 073] Shot-by-Shot: Film-Grammar-Aware Training-Free Audio Description Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.01020v2](http://arxiv.org/pdf/2504.01020v2)**

> **作者:** Junyu Xie; Tengda Han; Max Bain; Arsha Nagrani; Eshika Khandelwal; Gül Varol; Weidi Xie; Andrew Zisserman
>
> **备注:** ICCV 2025. Project Page: https://www.robots.ox.ac.uk/vgg/research/shot-by-shot/
>
...
>
---
#### [replaced 074] Improvement of Human-Object Interaction Action Recognition Using Scene Information and Multi-Task Learning Approach
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.09067v2](http://arxiv.org/pdf/2509.09067v2)**
...
>
---
#### [replaced 075] FOCUS on Contamination: A Geospatial Deep Learning Framework with a Noise-Aware Loss for Surface Water PFAS Prediction
...
>
---
#### [replaced 079] Spectral and Rhythm Feature Performance Evaluation for Category and Class Level Audio Classification with Deep Convolutional Neural Networks
- **分类: cs.SD; cs.AI; cs.CV; cs.LG; eess.AS**
...
>
---
#### [replaced 080] EndoGeDE: Generalizable Monocular Depth Estimation with Mixture of Low-Rank Experts for Diverse Endoscopic Scenes
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.01206v2](http://arxiv.org/pdf/2509.01206v2)**

> **作者:** Liangjing Shao; Benshuang Chen; Chenkang Du; Xueli Liu; Xinrong Chen
>
> **备注:** 22 pages, 12 figures, 7 tables. Under Review
>
...
>
---
#### [replaced 081] Enhancing Traffic Incident Response through Sub-Second Temporal Localization with HybridMamba
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.03235v3](http://arxiv.org/pdf/2504.03235v3)**
...
>
---
#### [replaced 082] On the Geometric Accuracy of Implicit and Primitive-based Representations Derived from View Rendering Constraints
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.10241v2](http://arxiv.org/pdf/2509.10241v2)**
...
>
---
#### [replaced 083] Multi-View Slot Attention Using Paraphrased Texts for Face Anti-Spoofing
- **分类: cs.CV; cs.AI; cs.CR**

- **链接: [http://arxiv.org/pdf/2509.06336v2](http://arxiv.org/pdf/2509.06336v2)**
...
>
---
#### [replaced 084] FM2DS: Few-Shot Multimodal Multihop Data Synthesis with Knowledge Distillation for Question Answering
...
>
---
#### [replaced 085] AnySplat: Feed-forward 3D Gaussian Splatting from Unconstrained Views
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23716v2](http://arxiv.org/pdf/2505.23716v2)**
...
>
---
#### [replaced 088] RemixFusion: Residual-based Mixed Representation for Large-scale Online RGB-D Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.17594v3](http://arxiv.org/pdf/2507.17594v3)**

> **作者:** Yuqing Lan; Chenyang Zhu; Shuaifeng Zhi; Jiazhao Zhang; Zhoufeng Wang; Renjiao Yi; Yijie Wang; Kai Xu
>
> **备注:** project page: https://lanlan96.github.io/RemixFusion/
>
