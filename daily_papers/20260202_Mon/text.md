...
>
---
#### [new 003] Are LLM Evaluators Really Narcissists? Sanity Checking Self-Preference Evaluations
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于模型评估任务，旨在解决LLM在自评中可能存在的偏见问题。通过引入基准测试，识别并减少评估中的噪声，提升自偏好测量的准确性。**

- **链接: [https://arxiv.org/pdf/2601.22548v1](https://arxiv.org/pdf/2601.22548v1)**
...
>
---
#### [new 004] Time-Annealed Perturbation Sampling: Diverse Generation for Diffusion Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本生成任务，旨在提升扩散语言模型的生成多样性。通过TAPS方法，在早期引入语义分支，后期减少扰动，实现多样且流畅的输出。**

- **链接: [https://arxiv.org/pdf/2601.22629v1](https://arxiv.org/pdf/2601.22629v1)**
...
>
> **摘要:** Despite the non-autoregressive potential of diffusion language models (dLLMs), existing decoding strategies demonstrate positional bias, failing to fully unlock the potential of arbitrary generation. In this work, we delve into the inherent spectral characteristics of dLLMs and present the first frequency-domain analysis showing that low-frequency components in hidden states primarily encode global structural information and long-range dependencies, while high-frequency components are responsible for characterizing local details. Based on this observation, we propose FourierSampler, which leverages a frequency-domain sliding window mechanism to dynamically guide the model to achieve a "structure-to-detail" generation. FourierSampler outperforms other inference enhancement strategies on LLADA and SDAR, achieving relative improvements of 20.4% on LLaDA1.5-8B and 16.0% on LLaDA-8B-Instruct. It notably surpasses similarly sized autoregressive models like Llama3.1-8B-Instruct.
>
---
#### [new 007] From Labels to Facets: Building a Taxonomically Enriched Turkish Learner Corpus
- **分类: cs.CL**

- **简介: 该论文属于语言学标注任务，旨在解决学习者语料标注维度不足的问题。通过提出一种半自动标注方法，构建了一个多维分类的土耳其学习者语料库，提升标注的深度与分析能力。**

- **链接: [https://arxiv.org/pdf/2601.22875v1](https://arxiv.org/pdf/2601.22875v1)**
...
>
> **摘要:** We investigate the functional role of emergent outliers in large language models, specifically attention sinks (a few tokens that consistently receive large attention logits) and residual sinks (a few fixed dimensions with persistently large activations across most tokens). We hypothesize that these outliers, in conjunction with the corresponding normalizations (\textit{e.g.}, softmax attention and RMSNorm), effectively rescale other non-outlier components. We term this phenomenon \textit{outlier-driven rescaling} and validate this hypothesis across different model architectures and training token counts. This view unifies the origin and mitigation of both sink types. Our main conclusions and observations include: (1) Outliers function jointly with normalization: removing normalization eliminates the corresponding outliers but degrades training stability and performance; directly clipping outliers while retaining normalization leads to degradation, indicating that outlier-driven rescaling contributes to training stability. (2) Outliers serve more as rescale factors rather than contributors, as the final contributions of attention and residual sinks are significantly smaller than those of non-outliers. (3) Outliers can be absorbed into learnable parameters or mitigated via explicit gated rescaling, leading to improved training performance (average gain of 2 points) and enhanced quantization robustness (1.2 points degradation under W4A4 quantization).
>
---
#### [new 010] Bias Beyond Borders: Political Ideology Evaluation and Steering in Multilingual LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多语言大模型的政治偏见评估与修正任务，旨在解决跨语言一致性问题。通过构建多语言评估体系并提出CLAS框架，实现有效降低偏见同时保持响应质量。**

- **链接: [https://arxiv.org/pdf/2601.23001v1](https://arxiv.org/pdf/2601.23001v1)**
...
>
---
#### [new 013] LLMs Explain't: A Post-Mortem on Semantic Interpretability in Transformer Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型解释性研究，旨在探讨Transformer模型中语义可解释性。通过分析注意力机制和嵌入层，发现现有方法在解释LLMs时存在局限，无法可靠反映模型理解能力。**

- **链接: [https://arxiv.org/pdf/2601.22928v1](https://arxiv.org/pdf/2601.22928v1)**
...
>
---
#### [new 024] Prepare Reasoning Language Models for Multi-Agent Debate with Self-Debate Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升大语言模型在多智能体辩论中的推理能力。针对现有方法未充分准备模型应对辩论中多样化推理路径的问题，提出SDRL框架，增强模型独立解决问题和参与辩论的能力。**

- **链接: [https://arxiv.org/pdf/2601.22297v1](https://arxiv.org/pdf/2601.22297v1)**
...
>
---
#### [new 027] SP^2DPO: An LLM-assisted Semantic Per-Pair DPO Generalization
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出SP2DPO方法，解决传统DPO在处理异质偏好数据时的不足，通过实例化温度参数提升模型性能。属于大模型优化任务。**

- **链接: [https://arxiv.org/pdf/2601.22385v1](https://arxiv.org/pdf/2601.22385v1)**
...
>
---
#### [new 030] MERMAID: Memory-Enhanced Retrieval and Reasoning with Multi-Agent Iterative Knowledge Grounding for Veracity Assessment
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于事实核查任务，旨在解决证据检索与推理效率低的问题。提出MERMAID框架，通过记忆增强实现动态证据获取与复用，提升验证效率和一致性。**

- **链接: [https://arxiv.org/pdf/2601.22361v1](https://arxiv.org/pdf/2601.22361v1)**
...
>
> **摘要:** Reinforcement learning with verifiable rewards has emerged as a powerful paradigm for training intelligent agents. However, existing methods typically employ binary rewards that fail to capture quality differences among trajectories achieving identical outcomes, thereby overlooking potential diversity within the solution space. Inspired by the ``sweet spot'' concept in tennis-the racket's core region that produces optimal hitting effects, we introduce \textbf{S}weet \textbf{S}pot \textbf{L}earning (\textbf{SSL}), a novel framework that provides differentiated guidance for agent optimization. SSL follows a simple yet effective principle: progressively amplified, tiered rewards guide policies toward the sweet-spot region of the solution space. This principle naturally adapts across diverse tasks: visual perception tasks leverage distance-tiered modeling to reward proximity, while complex reasoning tasks reward incremental progress toward promising solutions. We theoretically demonstrate that SSL preserves optimal solution ordering and enhances the gradient signal-to-noise ratio, thereby fostering more directed optimization. Extensive experiments across GUI perception, short/long-term planning, and complex reasoning tasks show consistent improvements over strong baselines on 12 benchmarks, achieving up to 2.5X sample efficiency gains and effective cross-task transferability. Our work establishes SSL as a general principle for training capable and robust agents.
>
---
#### [new 049] InstructDiff: Domain-Adaptive Data Selection via Differential Entropy for Efficient LLM Fine-Tuning
- **分类: cs.CL**

- **简介: 该论文提出InstructDiff，解决大模型微调中数据选择效率低的问题。通过差分熵实现领域自适应的数据筛选，提升不同任务性能。**

- **链接: [https://arxiv.org/pdf/2601.23006v1](https://arxiv.org/pdf/2601.23006v1)**
...
>
---
#### [new 050] DART-ing Through the Drift: Dynamic Tracing of Knowledge Neurons for Adaptive Inference-Time Pruning
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型压缩任务，旨在解决LLM中参数冗余和动态上下文适应问题。提出DART方法，实现运行时动态剪枝，提升模型效率与性能。**

- **链接: [https://arxiv.org/pdf/2601.22632v1](https://arxiv.org/pdf/2601.22632v1)**
...
>
---
#### [new 053] Should LLMs, $\textit{like}$, Generate How Users Talk? Building Dialect-Accurate Dialog[ue]s Beyond the American Default with MDial
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决LLMs对非美式英语方言支持不足的问题。通过构建MDial框架和MDialBench数据集，提升模型对多种英语方言的对话生成能力。**

- **链接: [https://arxiv.org/pdf/2601.22888v1](https://arxiv.org/pdf/2601.22888v1)**
...
>
---
#### [new 054] In Vino Veritas and Vulnerabilities: Examining LLM Safety via Drunk Language Inducement
- **分类: cs.CL; cs.AI; cs.CR; cs.LG**

- **简介: 该论文研究LLM在醉酒语言诱导下的安全问题，属于模型安全性任务。通过三种方法诱导醉酒语言，发现LLM更易被破解和泄露隐私，揭示了其与人类醉酒行为的相似性。**

- **链接: [https://arxiv.org/pdf/2601.22169v1](https://arxiv.org/pdf/2601.22169v1)**
...
>
---
#### [new 055] One Ring to Rule Them All: Unifying Group-Based RL via Dynamic Power-Mean Geometry
- **分类: cs.CL**

- **简介: 该论文属于强化学习任务，解决轨迹聚合几何固定的问题。提出PMPO框架，通过调整幂均指数p动态优化梯度更新，提升算法稳定性与性能。**

- **链接: [https://arxiv.org/pdf/2601.22521v1](https://arxiv.org/pdf/2601.22521v1)**
...
>
---
#### [new 057] MrRoPE: Mixed-radix Rotary Position Embedding
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决RoPE扩展问题。提出MrRoPE，通过基数转换统一不同扩展方法，实现长序列建模。**

- **链接: [https://arxiv.org/pdf/2601.22181v1](https://arxiv.org/pdf/2601.22181v1)**
...
>
---
#### [new 058] Now You Hear Me: Audio Narrative Attacks Against Large Audio-Language Models
- **分类: cs.CL; cs.AI; cs.CR**

- **简介: 该论文属于安全任务，研究音频语言模型的漏洞。通过设计文本转音频攻击，嵌入不当指令，绕过安全机制，揭示语音接口的安全风险。**

- **链接: [https://arxiv.org/pdf/2601.23255v1](https://arxiv.org/pdf/2601.23255v1)**

> **作者:** Ye Yu; Haibo Jin; Yaoning Yu; Jun Zhuang; Haohan Wang
>
> **备注:** to be published at EACL 2026 main conference
>
> **摘要:** Large audio-language models increasingly operate on raw speech inputs, enabling more seamless integration across domains such as voice assistants, education, and clinical triage. This transition, however, introduces a distinct class of vulnerabilities that remain largely uncharacterized. We examine the security implications of this modality shift by designing a text-to-audio jailbreak that embeds disallowed directives within a narrative-style audio stream. The attack leverages an advanced instruction-following text-to-speech (TTS) model to exploit structural and acoustic properties, thereby circumventing safety mechanisms primarily calibrated for text. When delivered through synthetic speech, the narrative format elicits restricted outputs from state-of-the-art models, including Gemini 2.0 Flash, achieving a 98.26% success rate that substantially exceeds text-only baselines. These results highlight the need for safety frameworks that jointly reason over linguistic and paralinguistic representations, particularly as speech-based interfaces become more prevalent.
>
---
#### [new 059] Culturally Grounded Personas in Large Language Models: Characterization and Alignment with Socio-Psychological Value Frameworks
...
- **链接: [https://arxiv.org/pdf/2601.22396v1](https://arxiv.org/pdf/2601.22396v1)**
...
>
---
#### [new 062] Scaling Multiagent Systems with Process Rewards
- **分类: cs.AI; cs.CL; cs.ET; cs.MA**

- **简介: 该论文研究多智能体系统优化任务，解决信用分配和样本效率问题。提出MAPPA方法，通过每步过程奖励提升训练效果，验证了在数学和数据分析任务中的有效性。**

- **链接: [https://arxiv.org/pdf/2601.23228v1](https://arxiv.org/pdf/2601.23228v1)**

> **作者:** Ed Li; Junyu Ren; Cat Yan
>
> **摘要:** While multiagent systems have shown promise for tackling complex tasks via specialization, finetuning multiple agents simultaneously faces two key challenges: (1) credit assignment across agents, and (2) sample efficiency of expensive multiagent rollouts. In this work, we propose finetuning multiagent systems with per-action process rewards from AI feedback (MAPPA) to address both. Through assigning credit to individual agent actions rather than only at task completion, MAPPA enables fine-grained supervision without ground truth labels while extracting maximal training signal from each rollout. We demonstrate our approach on competition math problems and tool-augmented data analysis tasks. On unseen math problems, MAPPA achieves +5.0--17.5pp on AIME and +7.8--17.2pp on AMC. For data analysis tasks, our method improves success rate by +12.5pp while quality metrics improve by up to 30%, validating that per-action supervision can lead to improvements across different multiagent system on various domains. By addressing these challenges, our work takes a first step toward scaling multiagent systems for complex, long-horizon tasks with minimal human supervision.
>
---
#### [new 063] TTCS: Test-Time Curriculum Synthesis for Self-Evolving
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在测试时推理能力不足的问题。通过提出TTCS框架，结合问题生成与推理优化，提升模型的自我进化能力。**

- **链接: [https://arxiv.org/pdf/2601.22628v1](https://arxiv.org/pdf/2601.22628v1)**
...
>
---
#### [new 064] Sylber 2.0: A Universal Syllable Embedding
- **分类: eess.AS; cs.CL**
...
>
---
#### [new 065] MoVE: Mixture of Value Embeddings -- A New Axis for Scaling Parametric Memory in Autoregressive Models
...
>
---
#### [new 066] Towards Resiliency in Large Language Model Serving with KevlarFlow
- **分类: cs.DC; cs.CL; cs.LG**

- **简介: 该论文属于大语言模型服务任务，旨在解决硬件故障导致的服务中断问题。通过KevlarFlow架构，实现快速恢复和高可用性。**

- **链接: [https://arxiv.org/pdf/2601.22438v1](https://arxiv.org/pdf/2601.22438v1)**
...
>
---
#### [new 067] DIFFA-2: A Practical Diffusion Large Language Model for General Audio Understanding
- **分类: cs.SD; cs.CL**
...
>
---
#### [new 068] MiTa: A Hierarchical Multi-Agent Collaboration Framework with Memory-integrated and Task Allocation
- **分类: cs.ET; cs.CL**

- **简介: 该论文提出MiTa框架，解决多智能体协作中的记忆不一致和行为冲突问题，通过层级结构与记忆整合提升协作效率。**

- **链接: [https://arxiv.org/pdf/2601.22974v1](https://arxiv.org/pdf/2601.22974v1)**
...
>
---
#### [new 069] Mem-T: Densifying Rewards for Long-Horizon Memory Agents
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决长视界记忆管理中奖励稀疏的问题。提出Mem-T和MoT-GRPO，通过密集奖励提升记忆代理的性能与效率。**

- **链接: [https://arxiv.org/pdf/2601.23014v1](https://arxiv.org/pdf/2601.23014v1)**
...
>
---
#### [new 070] Why Reasoning Fails to Plan: A Planning-Centric Analysis of Long-Horizon Decision Making in LLM Agents
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文研究LLM代理在长周期决策中的规划问题，指出基于推理的策略因局部最优导致早期短视选择。提出FLARE方法实现未来感知规划，提升任务表现。**

- **链接: [https://arxiv.org/pdf/2601.22311v1](https://arxiv.org/pdf/2601.22311v1)**
...
>
---
#### [new 073] Predicting Intermittent Job Failure Categories for Diagnosis Using Few-Shot Fine-Tuned Language Models
- **分类: cs.SE; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于软件工程中的故障诊断任务，解决间歇性CI流水线失败的分类与诊断问题。提出FlaXifyer和LogSift方法，实现高效自动化故障定位与分析。**

- **链接: [https://arxiv.org/pdf/2601.22264v1](https://arxiv.org/pdf/2601.22264v1)**
...
>
---
#### [new 076] Perplexity Cannot Always Tell Right from Wrong
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文属于自然语言处理领域，探讨困惑度作为模型选择指标的局限性。研究证明，困惑度可能无法准确反映模型性能，导致错误选择。**

- **链接: [https://arxiv.org/pdf/2601.22950v1](https://arxiv.org/pdf/2601.22950v1)**

> **作者:** Petar Veličković; Federico Barbero; Christos Perivolaropoulos; Simon Osindero; Razvan Pascanu
>
> **备注:** 11 pages, 4 figures
>
> **摘要:** Perplexity -- a function measuring a model's overall level of "surprise" when encountering a particular output -- has gained significant traction in recent years, both as a loss function and as a simple-to-compute metric of model quality. Prior studies have pointed out several limitations of perplexity, often from an empirical manner. Here we leverage recent results on Transformer continuity to show in a rigorous manner how perplexity may be an unsuitable metric for model selection. Specifically, we prove that, if there is any sequence that a compact decoder-only Transformer model predicts accurately and confidently -- a necessary pre-requisite for strong generalisation -- it must imply existence of another sequence with very low perplexity, but not predicted correctly by that same model. Further, by analytically studying iso-perplexity plots, we find that perplexity will not always select for the more accurate model -- rather, any increase in model confidence must be accompanied by a commensurate rise in accuracy for the new model to be selected.
>
---
#### [new 077] SOMBRERO: Measuring and Steering Boundary Placement in End-to-End Hierarchical Sequence Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出Sombrero方法，解决层次序列模型中边界定位的问题，通过优化边界放置提升预测效率与准确性。**

- **链接: [https://arxiv.org/pdf/2601.22805v1](https://arxiv.org/pdf/2601.22805v1)**
...
>
---
#### [new 078] Learnable Permutation for Structured Sparsity on Transformer Models
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于模型压缩任务，旨在解决Transformer模型中结构化稀疏性下的权重排列问题。提出一种可学习的排列框架，通过优化排列矩阵提升剪枝效果。**

- **链接: [https://arxiv.org/pdf/2601.22980v1](https://arxiv.org/pdf/2601.22980v1)**
...
>
---
#### [new 079] ReNCE: Learning to Reason by Noise Contrastive Estimation
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，旨在提升预训练大语言模型的推理能力。提出ReNCE方法，通过对比学习区分正负样本，替代传统优势估计，提高推理效果。**

- **链接: [https://arxiv.org/pdf/2601.22432v1](https://arxiv.org/pdf/2601.22432v1)**
...
>
---
#### [new 080] AI and My Values: User Perceptions of LLMs' Ability to Extract, Embody, and Explain Human Values from Casual Conversations
- **分类: cs.HC; cs.AI; cs.CL**

- **简介: 该论文属于人机交互任务，探讨AI如何理解并反映人类价值观。通过实验和访谈，研究者评估LLMs在提取、体现和解释价值观方面的能力，并提出VAPT工具以促进负责任的AI设计。**

- **链接: [https://arxiv.org/pdf/2601.22440v1](https://arxiv.org/pdf/2601.22440v1)**
...
>
---
#### [new 083] A Systematic Literature Review on LLM Defenses Against Prompt Injection and Jailbreaking: Expanding NIST Taxonomy
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于安全防御任务，旨在解决LLM对抗性攻击问题。通过系统综述88项研究，扩展NIST分类，提出新防御类别，并提供防御效果目录。**

- **链接: [https://arxiv.org/pdf/2601.22240v1](https://arxiv.org/pdf/2601.22240v1)**
...
>
---
#### [new 084] From Self-Evolving Synthetic Data to Verifiable-Reward RL: Post-Training Multi-turn Interactive Tool-Using Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究交互式工具使用代理的后训练问题，旨在提升多轮对话中工具使用的可靠性与效率。通过合成数据与验证奖励强化学习结合的方法，提高模型性能。**

- **链接: [https://arxiv.org/pdf/2601.22607v1](https://arxiv.org/pdf/2601.22607v1)**
...
>
---
#### [new 085] PhoStream: Benchmarking Real-World Streaming for Omnimodal Assistants in Mobile Scenarios
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 088] HeaPA: Difficulty-Aware Heap Sampling and On-Policy Query Augmentation for LLM Reinforcement Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出HeaPA方法，用于提升大语言模型强化学习的效率。针对传统采样方式在动态能力边界下的低效问题，通过堆采样和策略内查询增强，实现更精准的提示选择与池增长，提高训练效果。**

- **链接: [https://arxiv.org/pdf/2601.22448v1](https://arxiv.org/pdf/2601.22448v1)**
...
>
---
#### [new 089] FOCUS: DLLMs Know How to Tame Their Compute Bound
- **分类: cs.LG; cs.AR; cs.CL**

- **简介: 该论文针对扩散大语言模型（DLLMs）解码效率低的问题，提出FOCUS系统，通过动态聚焦可解码令牌提升吞吐量。属于自然语言处理任务。**

- **链接: [https://arxiv.org/pdf/2601.23278v1](https://arxiv.org/pdf/2601.23278v1)**
...
>
---
#### [new 090] UniFinEval: Towards Unified Evaluation of Financial Multimodal Models across Text, Images and Videos
- **分类: q-fin.GN; cs.AI; cs.CL**

- **简介: 该论文提出UniFinEval，一个针对金融多模态模型的统一评估基准，解决现有基准无法覆盖高密度金融信息的问题。**

- **链接: [https://arxiv.org/pdf/2601.22162v1](https://arxiv.org/pdf/2601.22162v1)**
...
>
---
#### [new 092] Lost in Space? Vision-Language Models Struggle with Relative Camera Pose Estimation
...
>
---
#### [new 093] Agnostic Language Identification and Generation
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究语言识别与生成任务，在不依赖数据分布假设的“非教条”框架下，提出新目标并获得更优理论结果。**

- **链接: [https://arxiv.org/pdf/2601.23258v1](https://arxiv.org/pdf/2601.23258v1)**
...
>
---
#### [replaced 003] Synthetic Socratic Debates: Examining Persona Effects on Moral Decision and Persuasion Dynamics
- **分类: cs.CL**

- **简介: 该论文属于AI道德推理研究，探讨AI角色设定对辩论和说服的影响。通过模拟AI间辩论，分析不同人格特征对道德决策和说服效果的作用。**

- **链接: [https://arxiv.org/pdf/2506.12657v2](https://arxiv.org/pdf/2506.12657v2)**
...
>
---
#### [replaced 004] VScan: Rethinking Visual Token Reduction for Efficient Large Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 005] Moral Outrage Shapes Commitments Beyond Attention: Multimodal Moral Emotions on YouTube in Korea and the US
- **分类: cs.CY; cs.AI; cs.CL; cs.SI**

- **简介: 该论文属于情感分析任务，研究道德愤怒如何影响用户行为。通过构建多模态情绪分类器，分析YouTube视频的观看、点赞和评论数据，探讨道德情绪对用户参与度的影响。**

- **链接: [https://arxiv.org/pdf/2601.21815v2](https://arxiv.org/pdf/2601.21815v2)**
...
>
---
#### [replaced 006] Tracing Multilingual Representations in LLMs with Cross-Layer Transcoders
- **分类: cs.CL**

- **简介: 该论文研究多语言大模型内部表示机制，解决多语言处理中性能差异问题。通过CLTs和 Attribution Graphs 分析模型，揭示共享表示与语言特异性解码的关系。**

- **链接: [https://arxiv.org/pdf/2511.10840v2](https://arxiv.org/pdf/2511.10840v2)**
...
>
---
#### [replaced 007] ARB-LLM: Alternating Refined Binarizations for Large Language Models
...
>
---
#### [replaced 010] Towards Atoms of Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，旨在定义大语言模型的基本表示单元（atoms），解决其内在机制理解难题。通过提出原子理论和AIP度量，验证了理想原子的特性。**

- **链接: [https://arxiv.org/pdf/2509.20784v2](https://arxiv.org/pdf/2509.20784v2)**
...
>
---
#### [replaced 011] DialectGen: Benchmarking and Improving Dialect Robustness in Multimodal Generation
...
>
---
#### [replaced 017] Automatic Reviewers Fail to Detect Faulty Reasoning in Research Papers: A New Counterfactual Evaluation Framework
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的学术评审任务，旨在解决自动评审系统无法检测研究逻辑错误的问题。研究提出一种对抗性评估框架，验证现有系统在逻辑检测上的不足，并给出改进建议。**

- **链接: [https://arxiv.org/pdf/2508.21422v2](https://arxiv.org/pdf/2508.21422v2)**

> **作者:** Nils Dycke; Iryna Gurevych
>
> **备注:** accepted to TACL 2026 (presented at EACL 2026)
>
...
>
---
#### [replaced 018] CATArena: Evaluating Evolutionary Capabilities of Code Agents via Iterative Tournaments
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于代码生成评估任务，旨在解决现有方法无法有效评估代码代理持续优化能力的问题。提出CATArena框架，通过迭代竞赛评估代码代理的进化能力。**

- **链接: [https://arxiv.org/pdf/2510.26852v2](https://arxiv.org/pdf/2510.26852v2)**
...
>
---
#### [replaced 026] Beyond Retrieval: A Modular Benchmark for Academic Deep Research Agents
- **分类: cs.CL**

- **简介: 该论文属于学术深度研究代理评估任务，解决现有基准不足问题。构建ADRA-Bank和ADRA-Eval，评估规划、检索与推理能力，提升研究助手可靠性。**

- **链接: [https://arxiv.org/pdf/2512.00986v2](https://arxiv.org/pdf/2512.00986v2)**
...
>
---
#### [replaced 027] Transparent Semantic Change Detection with Dependency-Based Profiles
- **分类: cs.CL**

- **简介: 该论文属于词汇语义变化检测任务，旨在解决传统方法透明性不足的问题。研究提出基于依存共现模式的方法，有效且可解释。**

- **链接: [https://arxiv.org/pdf/2601.02891v3](https://arxiv.org/pdf/2601.02891v3)**
...
>
---
#### [replaced 028] Mechanistic evaluation of Transformers and state space models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，旨在比较Transformer与状态空间模型（SSM）在信息回忆任务中的机制差异。通过实验和因果干预，分析不同架构的成功与失败原因，揭示其内部工作机制。**

- **链接: [https://arxiv.org/pdf/2505.15105v3](https://arxiv.org/pdf/2505.15105v3)**

> **作者:** Aryaman Arora; Neil Rathi; Nikil Roashan Selvam; Róbert Csordás; Dan Jurafsky; Christopher Potts
>
> **备注:** 9 page main text, 22 pages total
>
...
>
---
#### [replaced 029] SuperCoder: Assembly Program Superoptimization with Large Language Models
- **分类: cs.CL; cs.AI; cs.PF; cs.PL; cs.SE**

- **简介: 该论文属于程序优化任务，旨在通过大语言模型提升汇编代码性能。研究构建了大规模基准，验证LLM作为超优化器的可行性，并提出改进方法提升效率与正确率。**

- **链接: [https://arxiv.org/pdf/2505.11480v3](https://arxiv.org/pdf/2505.11480v3)**
...
>
---
#### [replaced 030] Warm Up Before You Train: Unlocking General Reasoning in Resource-Constrained Settings
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于大模型推理任务，解决数据稀缺下构建有效推理模型的问题。提出两阶段训练策略，先通过逻辑谜题预热模型，再进行有限数据的强化学习，提升模型泛化能力和样本效率。**

- **链接: [https://arxiv.org/pdf/2505.13718v3](https://arxiv.org/pdf/2505.13718v3)**
...
>
---
#### [replaced 031] Toward Culturally Aligned LLMs through Ontology-Guided Multi-Agent Reasoning
- **分类: cs.CL; cs.AI; cs.IR; cs.MA; cs.SI**

- **简介: 该论文属于文化对齐任务，旨在解决LLM在决策中因数据偏见和缺乏结构化价值观导致的不一致问题。提出OG-MAR框架，通过本体引导多智能体推理提升文化一致性与透明度。**

- **链接: [https://arxiv.org/pdf/2601.21700v2](https://arxiv.org/pdf/2601.21700v2)**
...
>
---
#### [replaced 032] DNACHUNKER: Learnable Tokenization for DNA Language Models
- **分类: q-bio.GN; cs.CL**

- **简介: 该论文提出DNACHUNKER，解决DNA序列建模中的分词问题，通过可学习的自适应分割模块提升模型效果。**

- **链接: [https://arxiv.org/pdf/2601.03019v2](https://arxiv.org/pdf/2601.03019v2)**

> **作者:** Taewon Kim; Jihwan Shin; Hyomin Kim; Youngmok Jung; Jonghoon Lee; Won-Chul Lee; Insu Han; Sungsoo Ahn
>
...
>
---
#### [replaced 033] The Unintended Trade-off of AI Alignment:Balancing Hallucination Mitigation and Safety in LLMs
- **分类: cs.CL**

- **简介: 该论文属于AI安全与对齐任务，解决 hallucination 与安全之间的权衡问题。通过解耦相关特征，提升事实准确性同时保持拒绝行为。**

- **链接: [https://arxiv.org/pdf/2510.07775v2](https://arxiv.org/pdf/2510.07775v2)**

> **作者:** Omar Mahmoud; Ali Khalil; Buddhika Laknath Semage; Thommen George Karimpanal; Santu Rana
>
> **摘要:** Hallucination in large language models (LLMs) has been widely studied in recent years, with progress in both detection and mitigation aimed at improving truthfulness. Yet, a critical side effect remains largely overlooked: enhancing truthfulness can negatively impact safety alignment. In this paper, we investigate this trade-off and show that increasing factual accuracy often comes at the cost of weakened refusal behavior. Our analysis reveals that this arises from overlapping components in the model that simultaneously encode hallucination and refusal information, leading alignment methods to suppress factual knowledge unintentionally. We further examine how fine-tuning on benign datasets, even when curated for safety, can degrade alignment for the same reason. To address this, we propose a method that disentangles refusal-related features from hallucination features using sparse autoencoders, and preserves refusal behavior during fine-tuning through subspace orthogonalization. This approach prevents hallucinations from increasing while maintaining safety alignment.We evaluate our method on commonsense reasoning tasks and harmful benchmarks (AdvBench and StrongReject). Results demonstrate that our approach preserves refusal behavior and task utility, mitigating the trade-off between truthfulness and safety.
>
---
#### [replaced 034] ATOD: An Evaluation Framework and Benchmark for Agentic Task-Oriented Dialogue Systems
- **分类: cs.CL; cs.AI; cs.MA**

- **简介: 该论文属于任务导向对话系统领域，旨在解决现有基准无法有效评估智能体行为的问题。提出ATOD框架和评估体系，支持多目标协调与长期推理的评测。**

- **链接: [https://arxiv.org/pdf/2601.11854v2](https://arxiv.org/pdf/2601.11854v2)**
...
>
---
#### [replaced 039] Multi-Step Knowledge Interaction Analysis via Rank-2 Subspace Disentanglement
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在分析LLM决策中参数知识与上下文知识的交互。通过引入秩-2子空间，更准确地分离两者贡献，解决传统方法在多步骤生成中的局限性。**

- **链接: [https://arxiv.org/pdf/2511.01706v2](https://arxiv.org/pdf/2511.01706v2)**
...
>
---
#### [replaced 040] LogicScore: Fine-grained Logic Evaluation of Conciseness, Completeness, and Determinateness in Attributed Question Answering
- **分类: cs.CL**

- **简介: 该论文属于Attributed Question Answering任务，解决LLM答案逻辑不连贯问题，提出LogicScore框架评估答案的完整性、简洁性和确定性。**

- **链接: [https://arxiv.org/pdf/2601.15050v3](https://arxiv.org/pdf/2601.15050v3)**
...
>
---
#### [replaced 047] BiasGym: Fantastic LLM Biases and How to Find (and Remove) Them
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理中的模型偏见研究任务，旨在解决LLM中隐含偏见的检测与消除问题。工作包括提出BiasGym框架，实现偏见注入、分析和缓解。**

- **链接: [https://arxiv.org/pdf/2508.08855v3](https://arxiv.org/pdf/2508.08855v3)**
...
>
---
#### [replaced 048] PICACO: Pluralistic In-Context Value Alignment of LLMs via Total Correlation Optimization
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文属于自然语言处理中的对齐任务，解决LLMs在单个提示中难以平衡多种价值冲突的问题。提出PICACO方法，通过优化总相关性提升模型对多元价值的理解与对齐效果。**

- **链接: [https://arxiv.org/pdf/2507.16679v2](https://arxiv.org/pdf/2507.16679v2)**
...
>
---
#### [replaced 049] Zero-Shot Open-Schema Entity Structure Discovery
- **分类: cs.CL**

- **简介: 该论文属于实体结构抽取任务，旨在解决传统方法依赖预定义模式和标注数据导致的提取不完整问题。提出ZOES方法，无需schema或样本，通过增强、精炼和统一机制提升抽取效果。**

- **链接: [https://arxiv.org/pdf/2506.04458v2](https://arxiv.org/pdf/2506.04458v2)**
...
>
---
#### [replaced 052] LLM Latent Reasoning as Chain of Superposition
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决latent reasoning性能下降的问题。通过引入Latent-SFT框架，提升推理效率与效果。**

- **链接: [https://arxiv.org/pdf/2510.15522v2](https://arxiv.org/pdf/2510.15522v2)**

> **作者:** Jingcheng Deng; Liang Pang; Zihao Wei; Shicheng Xu; Zenghao Duan; Kun Xu; Yang Song; Huawei Shen; Xueqi Cheng
>
> **摘要:** Latent reasoning offers a computation-efficient alternative to Chain-of-Thought but often suffers from performance degradation due to distributional misalignment and ambiguous chain definitions. Ideally, latent reasoning should function as a superposition of multiple reasoning paths. To realize this, we introduce Latent-SFT, a unified framework addressing challenges at three levels: token, chain, and learning. First, we define the Latent-Vocab to constrain hidden states within the pre-trained vocab-space. Second, we construct the Latent-Chain via Induction-Supervision Masking to ensure semantic compactness and sufficiency. Third, we employ Latent-Optim with stochastic Gumbel-Softmax to guide the model toward generalizable solutions. Empirical results demonstrate that Latent-SFT consistently outperforms explicit SFT across six mathematical benchmarks (e.g., GSM8k, AIME24) while achieving a 2.7x to 5.5x reduction in reasoning length. Analysis confirms that our method effectively captures a superposition of diverse reasoning trajectories rather than merely compressing a single path.
>
---
#### [replaced 053] TALES: A Taxonomy and Analysis of Cultural Representations in LLM-generated Stories
- **分类: cs.HC; cs.AI; cs.CL; cs.CY**

- **简介: 该论文属于文化表示评估任务，旨在解决LLM生成故事中的文化误述问题。通过构建分类体系和大规模标注，分析模型在印度多元文化中的表现。**

- **链接: [https://arxiv.org/pdf/2511.21322v2](https://arxiv.org/pdf/2511.21322v2)**
...
>
---
#### [replaced 054] Which Heads Matter for Reasoning? RL-Guided KV Cache Compression
- **分类: cs.CL**

- **简介: 该论文属于大模型推理优化任务，解决KV缓存压缩中信息丢失导致的推理失效问题。通过强化学习识别关键注意力头，实现高效缓存压缩与性能保持。**

- **链接: [https://arxiv.org/pdf/2510.08525v2](https://arxiv.org/pdf/2510.08525v2)**
...
>
---
#### [replaced 055] SAFER: Probing Safety in Reward Models with Sparse Autoencoder
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型对齐任务，旨在提升奖励模型的安全性。通过SAFER框架，解析奖励模型中的可解释特征，并优化安全对齐效果。**

- **链接: [https://arxiv.org/pdf/2507.00665v3](https://arxiv.org/pdf/2507.00665v3)**

> **作者:** Wei Shi; Ziyuan Xie; Sihang Li; Xiang Wang
>
...
>
---
#### [replaced 056] From Next-Token to Next-Block: A Principled Adaptation Path for Diffusion LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型适应任务，解决如何有效将自回归模型迁移到扩散模型的问题。通过设计渐进式适配路径，提升长序列生成能力，提出NBDiff-7B模型。**

- **链接: [https://arxiv.org/pdf/2512.06776v2](https://arxiv.org/pdf/2512.06776v2)**
...
>
---
#### [replaced 059] Emotions Where Art Thou: Understanding and Characterizing the Emotional Latent Space of Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于情感分析任务，研究LLM如何内部表征情感。通过分析隐藏状态空间的几何结构，揭示情感的低维流形和可操控的语义空间。**

- **链接: [https://arxiv.org/pdf/2510.22042v2](https://arxiv.org/pdf/2510.22042v2)**
...
>
---
#### [replaced 060] FactSelfCheck: Fact-Level Black-Box Hallucination Detection for LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于事实性幻觉检测任务，旨在解决LLM生成内容中的不实信息问题。提出FactSelfCheck方法，实现细粒度的事实级检测与修正。**

- **链接: [https://arxiv.org/pdf/2503.17229v3](https://arxiv.org/pdf/2503.17229v3)**

> **作者:** Albert Sawczyn; Jakub Binkowski; Denis Janiak; Bogdan Gabrys; Tomasz Kajdanowicz
>
> **备注:** Accepted for EACL 2026 (findings)
>
...
>
---
#### [replaced 061] Defending Large Language Models Against Jailbreak Attacks via In-Decoding Safety-Awareness Probing
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于安全防护任务，旨在防御大语言模型的越狱攻击。通过分析解码过程中的潜在安全信号，提出一种早期检测方法，在保持模型性能的同时提升安全性。**

- **链接: [https://arxiv.org/pdf/2601.10543v2](https://arxiv.org/pdf/2601.10543v2)**
...
>
---
#### [replaced 062] FLM-Audio: Natural Monologues Improves Native Full-Duplex Chatbots via Dual Training
...
>
---
#### [replaced 066] Text-only adaptation in LLM-based ASR through text denoising
...
>
---
#### [replaced 067] LightRetriever: A LLM-based Text Retrieval Architecture with Extremely Faster Query Inference
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文提出LightRetriever，解决LLM在文本检索中查询编码效率低的问题。通过轻量级查询编码器提升检索速度，保持高性能。属于信息检索任务。**

- **链接: [https://arxiv.org/pdf/2505.12260v5](https://arxiv.org/pdf/2505.12260v5)**
...
>
---
#### [replaced 068] AgentLongBench: A Controllable Long Benchmark For Long-Contexts Agents via Environment Rollouts
- **分类: cs.CL**

- **简介: 该论文属于长上下文代理评估任务，旨在解决现有基准无法模拟动态交互的问题。通过环境滚动生成测试场景，评估代理在复杂任务中的表现。**

- **链接: [https://arxiv.org/pdf/2601.20730v3](https://arxiv.org/pdf/2601.20730v3)**
...
>
---
#### [replaced 069] Diverse, not Short: A Length-Controlled Data Selection Strategy for Improving Response Diversity of Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言生成任务，旨在解决语言模型输出缺乏多样性的问题。通过引入Diverse-NS策略，平衡多样性、质量和长度，提升模型输出的多样性。**

- **链接: [https://arxiv.org/pdf/2505.16245v4](https://arxiv.org/pdf/2505.16245v4)**
...
>
---
#### [replaced 072] Post-LayerNorm Is Back: Stable, ExpressivE, and Deep
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理任务，解决深度Transformer模型训练不稳定的问题。通过引入Highway连接改进Post-LN结构，实现稳定深度训练。**

- **链接: [https://arxiv.org/pdf/2601.19895v2](https://arxiv.org/pdf/2601.19895v2)**
...
>
---
#### [replaced 073] Dual Mechanisms of Value Expression: Intrinsic vs. Prompted Values in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大语言模型中内在与提示值表达的机制差异，属于价值对齐任务。通过分析值向量和值神经元，揭示两者共享与独特组件，解决其机制是否重叠的问题。**

- **链接: [https://arxiv.org/pdf/2509.24319v3](https://arxiv.org/pdf/2509.24319v3)**
...
>
---
#### [replaced 074] SSA: Sparse Sparse Attention by Aligning Full and Sparse Attention Outputs in Feature Space
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决稀疏注意力的性能下降问题。通过引入双向对齐机制，提升稀疏注意力模型的性能与稳定性。**

- **链接: [https://arxiv.org/pdf/2511.20102v2](https://arxiv.org/pdf/2511.20102v2)**
...
>
---
#### [replaced 075] Vulnerability of LLMs' Belief Systems? LLMs Belief Resistance Check Through Strategic Persuasive Conversation Interventions
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，研究LLMs在说服下的信念稳定性问题。通过实验分析不同策略对模型信念的影响，探讨提升模型抗说服能力的方法。**

- **链接: [https://arxiv.org/pdf/2601.13590v2](https://arxiv.org/pdf/2601.13590v2)**

> **作者:** Fan Huang; Haewoon Kwak; Jisun An
>
> **备注:** Updated Table 12 with the detailed calculation approach and its related statements
>
...
>
---
#### [replaced 076] GraphGhost: Tracing Structures Behind Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理领域，旨在揭示大语言模型的内部结构。通过构建图模型，分析token和神经元的交互，解决模型推理机制不明确的问题。**

- **链接: [https://arxiv.org/pdf/2510.08613v2](https://arxiv.org/pdf/2510.08613v2)**
...
>
---
#### [replaced 077] Qwen3-ASR Technical Report
...
>
---
#### [replaced 078] Deep Delta Learning
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 079] CoFrGeNet: Continued Fraction Architectures for Language Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出CoFrGeNet，一种基于连分数的生成模型架构，用于语言生成任务。旨在替代Transformer中的注意力机制，减少参数量并提升效率。**

- **链接: [https://arxiv.org/pdf/2601.21766v2](https://arxiv.org/pdf/2601.21766v2)**
...
>
---
#### [replaced 080] Metis-SPECS: Decoupling Multimodal Learning via Self-distilled Preference-based Cold Start
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 081] FESTA: Functionally Equivalent Sampling for Trust Assessment of Multimodal LLMs
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出FESTA方法，用于评估多模态大语言模型的可信度。解决模型预测可靠性问题，通过输入采样量化不确定性，提升选择性预测性能。**

- **链接: [https://arxiv.org/pdf/2509.16648v4](https://arxiv.org/pdf/2509.16648v4)**
...
>
---
#### [replaced 082] RAFFLES: Reasoning-based Attribution of Faults for LLM Systems
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出RAFFLES，用于检测LLM系统的故障。属于系统评估任务，解决手动审查效率低的问题，通过迭代推理框架自动识别故障。**

- **链接: [https://arxiv.org/pdf/2509.06822v3](https://arxiv.org/pdf/2509.06822v3)**
...
>
---
#### [replaced 083] Framing Political Bias in Multilingual LLMs Across Pakistani Languages
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的偏见检测任务，旨在解决多语言大模型在巴基斯坦地区政治偏见的评估问题。通过构建文化适配的测试框架，分析了13个模型在五种语言中的政治倾向与风格特征。**

- **链接: [https://arxiv.org/pdf/2506.00068v3](https://arxiv.org/pdf/2506.00068v3)**
...
>
---
#### [replaced 087] Quantifying Data Contamination in Psychometric Evaluations of LLMs
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型评估任务，旨在解决心理测量评估中的数据污染问题。通过框架量化模型对问卷的记忆和响应调整，发现主流问卷存在显著污染。**

- **链接: [https://arxiv.org/pdf/2510.07175v2](https://arxiv.org/pdf/2510.07175v2)**
...
>
---
#### [replaced 088] Are LLMs Stable Formal Logic Translators in Logical Reasoning Across Linguistically Diversified Texts?
- **分类: cs.CL**

- **简介: 该论文属于逻辑推理任务，解决LLMs在不同语言表达下生成不一致符号表示的问题。提出SoLT基准和MenTaL方法，提升翻译稳定性与推理准确性。**

- **链接: [https://arxiv.org/pdf/2506.04575v3](https://arxiv.org/pdf/2506.04575v3)**
...
>
---
#### [replaced 089] ChatInject: Abusing Chat Templates for Prompt Injection in LLM Agents
- **分类: cs.CL**

- **简介: 该论文属于安全领域，研究LLM代理中的提示注入攻击。针对现有防御不足，提出ChatInject攻击方法，通过模仿对话模板实现高效攻击，验证其有效性与跨模型迁移能力。**

- **链接: [https://arxiv.org/pdf/2509.22830v2](https://arxiv.org/pdf/2509.22830v2)**
...
>
---
#### [replaced 090] HumanLLM: Benchmarking and Improving LLM Anthropomorphism via Human Cognitive Patterns
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升语言模型的人类化表现。通过分析人类认知模式，构建多场景评估框架，解决模型与人类行为不一致的问题。**

- **链接: [https://arxiv.org/pdf/2601.10198v2](https://arxiv.org/pdf/2601.10198v2)**
...
>
> **备注:** change "reinforce" to "improve"
>
