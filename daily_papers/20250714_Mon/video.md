...
>
---
#### [new 003] Deep Hashing with Semantic Hash Centers for Image Retrieval
- **分类: cs.CV; cs.AI**
...
- **简介: 该论文属于传播模型优化任务，旨在解决环境分类不准确的问题，通过机器学习生成加拿大全国地貌图，提升路径损耗估算精度。**
...
- **链接: [http://arxiv.org/pdf/2507.08330v1](http://arxiv.org/pdf/2507.08330v1)**
...
- **链接: [http://arxiv.org/pdf/2507.08776v1](http://arxiv.org/pdf/2507.08776v1)**
...
- **简介: 该论文属于运动分析任务，旨在解决临床中缺乏客观运动测量工具的问题。通过开发基于智能手机的便携生物力学实验室，实现准确、易用的运动评估。**
...
- **链接: [http://arxiv.org/pdf/2507.08290v1](http://arxiv.org/pdf/2507.08290v1)**
...
- **简介: 该论文属于视觉-语言模型任务，旨在解决类嵌入建模不足和跨模态对齐限制的问题。提出MuGCP框架，通过多模态互引导机制提升模型性能。**
...
- **链接: [http://arxiv.org/pdf/2507.08248v1](http://arxiv.org/pdf/2507.08248v1)**
...
- **链接: [http://arxiv.org/pdf/2507.08448v1](http://arxiv.org/pdf/2507.08448v1)**
...
- **简介: 该论文属于视觉对象跟踪任务，旨在解决SAM 2模型中记忆更新效率问题，通过强化学习优化记忆控制，提升跟踪性能。**
...
- **简介: 该论文属于多摄像头车辆跟踪任务，旨在解决现有数据集不足的问题。构建了高分辨率的真实路口数据集RoundaboutHD，包含40分钟标注视频和多种任务子集。**
...
- **简介: 该论文属于3D语义场景补全任务，旨在解决传统方法中因使用体素导致类别信息利用不足的问题。通过引入双流结构和类别查询，提升场景与实例分类性能。**
...
- **链接: [http://arxiv.org/pdf/2507.08044v1](http://arxiv.org/pdf/2507.08044v1)**
...
- **简介: 该论文属于视频质量提升任务，旨在解决视频退化问题。综述了无监督的视频修复与增强方法，分析其技术路线和挑战。**
...
- **简介: 该论文属于医学图像分割任务，解决ICL中查询图像与上下文对对齐不足的问题。提出CCV框架，通过循环验证提升分割精度。**
...
- **链接: [http://arxiv.org/pdf/2507.08340v1](http://arxiv.org/pdf/2507.08340v1)**
...
- **链接: [http://arxiv.org/pdf/2507.08367v1](http://arxiv.org/pdf/2507.08367v1)**
...
- **简介: 该论文属于图像去噪任务，探讨在非高斯噪声下扩散模型的性能。研究替换噪声类型，分析算法适应性，验证其鲁棒性。**
...
- **简介: 该论文属于医学图像分析任务，解决CT数据预测PET高摄取的问题。通过构建基于STV特征的弱学习器集成模型，提升预测性能。**
...
- **链接: [http://arxiv.org/pdf/2507.08380v1](http://arxiv.org/pdf/2507.08380v1)**
...
- **简介: 该论文属于图像生成任务，旨在提升自回归图像生成效果。通过构建基于视觉基础模型的图像分词器，解决传统方法效率与质量不足的问题。**
...
- **简介: 该论文属于遥感图像处理任务，解决云和云影遮挡问题。通过评估多种机器学习模型，提出轻量级CNN模型，实现高效、准确的云掩膜分割。**
...
>
> **摘要:** Concept Bottleneck Models (CBMs) provide interpretable and controllable generative modeling by routing generation through explicit, human-understandable concepts. However, previous generative CBMs often rely on auxiliary visual cues at the bottleneck to compensate for information not captured by the concepts, which undermines interpretability and compositionality. We propose CoCo-Bot, a post-hoc, composable concept bottleneck generative model that eliminates the need for auxiliary cues by transmitting all information solely through explicit concepts. Guided by diffusion-based energy functions, CoCo-Bot supports robust post-hoc interventions-such as concept composition and negation-across arbitrary concepts. Experiments using StyleGAN2 pre-trained on CelebA-HQ show that CoCo-Bot improves concept-level controllability and interpretability, while maintaining competitive visual quality.
>
---
#### [new 070] CuriosAI Submission to the EgoExo4D Proficiency Estimation Challenge 2025
- **分类: cs.CV**

- **简介: 该论文属于技能评估任务，旨在提升多视角技能评估的准确性。通过两种方法进行尝试，其中两阶段方法表现更优。**

- **链接: [http://arxiv.org/pdf/2507.08022v1](http://arxiv.org/pdf/2507.08022v1)**
...
>
---
#### [new 074] Raptor: Scalable Train-Free Embeddings for 3D Medical Volumes Leveraging Pretrained 2D Foundation Models
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学影像处理任务，旨在解决3D医学体积数据训练成本高、数据不足的问题。通过引入Raptor方法，利用预训练2D模型提取特征并压缩，实现高效嵌入生成。**

- **链接: [http://arxiv.org/pdf/2507.08254v1](http://arxiv.org/pdf/2507.08254v1)**
...
>
---
#### [new 080] Large Multi-modal Model Cartographic Map Comprehension for Textual Locality Georeferencing
...
>
---
#### [new 081] VideoConviction: A Multimodal Benchmark for Human Conviction and Stock Market Recommendations
...
>
---
#### [new 082] Learning human-to-robot handovers through 3D scene reconstruction
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 083] Depth-Sequence Transformer (DST) for Segment-Specific ICA Calcification Mapping on Non-Contrast CT
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分析任务，解决ICAC段位量化难题。提出DST框架，通过1D轴向处理实现精准定位，首次实现自动化段位特异性分析。**

- **链接: [http://arxiv.org/pdf/2507.08214v1](http://arxiv.org/pdf/2507.08214v1)**
...
>
---
#### [new 084] Emergent Natural Language with Communication Games for Improving Image Captioning Capabilities without Additional Data
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于图像描述任务，旨在提升图像 captioning 性能而不依赖额外数据。通过多智能体强化学习方法 LoGIC 实现自然语言交流策略的学习。**

- **链接: [http://arxiv.org/pdf/2507.08610v1](http://arxiv.org/pdf/2507.08610v1)**
...
>
---
#### [new 085] PUMA: Layer-Pruned Language Model for Efficient Unified Multimodal Retrieval with Modality-Adaptive Learning
- **分类: cs.MM; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.08064v1](http://arxiv.org/pdf/2507.08064v1)**
...
>
---
#### [new 086] Barriers in Integrating Medical Visual Question Answering into Radiology Workflows: A Scoping Review and Clinicians' Insights
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 087] CL3R: 3D Reconstruction and Contrastive Learning for Enhanced Robotic Manipulation Representations
...
>
---
#### [new 088] Improving MLLM's Document Image Machine Translation via Synchronously Self-reviewing Its OCR Proficiency
...
>
---
#### [replaced 002] Sim-to-Real: An Unsupervised Noise Layer for Screen-Camera Watermarking Robustness
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.18906v2](http://arxiv.org/pdf/2504.18906v2)**
...
>
---
#### [replaced 006] Token Communications: A Unified Framework for Cross-modal Context-aware Semantic Communications
...
>
---
#### [replaced 007] SDR-GAIN: A High Real-Time Occluded Pedestrian Pose Completion Method for Autonomous Driving
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2306.03538v5](http://arxiv.org/pdf/2306.03538v5)**

> **作者:** Honghao Fu; Yongli Gu; Yidong Yan; Yilang Shen; Yiwen Wu; Libo Sun
>
...
>
---
#### [replaced 010] FreeScale: Unleashing the Resolution of Diffusion Models via Tuning-Free Scale Fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.09626v2](http://arxiv.org/pdf/2412.09626v2)**

> **作者:** Haonan Qiu; Shiwei Zhang; Yujie Wei; Ruihang Chu; Hangjie Yuan; Xiang Wang; Yingya Zhang; Ziwei Liu
>
> **备注:** ICCV 2025, Project Page: http://haonanqiu.com/projects/FreeScale.html, Code Repo: https://github.com/ali-vilab/FreeScale
>
...
>
---
#### [replaced 011] ViLU: Learning Vision-Language Uncertainties for Failure Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07620v2](http://arxiv.org/pdf/2507.07620v2)**
...
>
---
#### [replaced 012] Lighting the Night with Generative Artificial Intelligence
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [http://arxiv.org/pdf/2506.22511v2](http://arxiv.org/pdf/2506.22511v2)**

> **作者:** Tingting Zhou; Feng Zhang; Haoyang Fu; Baoxiang Pan; Renhe Zhang; Feng Lu; Zhixin Yang
>
> **备注:** Title corrected (Lightning to Lighting); terminology updated (retrieval to generative)
>
...
>
---
#### [replaced 015] Synergistic Prompting for Robust Visual Recognition with Missing Modalities
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07802v2](http://arxiv.org/pdf/2507.07802v2)**
...
>
---
#### [replaced 016] MP-HSIR: A Multi-Prompt Framework for Universal Hyperspectral Image Restoration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.09131v2](http://arxiv.org/pdf/2503.09131v2)**
...
>
---
#### [replaced 017] Understanding Dataset Bias in Medical Imaging: A Case Study on Chest X-rays
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07722v2](http://arxiv.org/pdf/2507.07722v2)**
...
>
---
#### [replaced 020] Field Matching: an Electrostatic Paradigm to Generate and Transfer Data
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.02367v2](http://arxiv.org/pdf/2502.02367v2)**
...
>
---
#### [replaced 021] T-GVC: Trajectory-Guided Generative Video Coding at Ultra-Low Bitrates
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.07633v2](http://arxiv.org/pdf/2507.07633v2)**
...
>
---
#### [replaced 022] Single-Step Latent Diffusion for Underwater Image Restoration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07878v2](http://arxiv.org/pdf/2507.07878v2)**
...
>
---
#### [replaced 032] UWarp: A Whole Slide Image Registration Pipeline to Characterize Scanner-Induced Local Domain Shift
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.20653v3](http://arxiv.org/pdf/2503.20653v3)**

> **作者:** Antoine Schieb; Bilal Hadjadji; Natalia Fernanda Valderrama; Daniel Tshokola Mweze; Valentin Derangère; Laurent Arnould; Sylvain Ladoire; Alain Lalande; Alessio Fiorin; Carlos López Pablo; Noèlia Gallardo Borràs; Shrief Abdelazeez; Vincenzo Della Mea; Anna Korzynska; Louis-Oscar Morel; Nathan Vinçon
>
> **备注:** preprint
>
...
>
---
#### [replaced 033] Doodle Your Keypoints: Sketch-Based Few-Shot Keypoint Detection
- **分类: cs.CV; I.4.0; I.4.9**

- **链接: [http://arxiv.org/pdf/2507.07994v2](http://arxiv.org/pdf/2507.07994v2)**
...
>
---
#### [replaced 034] DriveTransformer: Unified Transformer for Scalable End-to-End Autonomous Driving
- **分类: cs.LG; cs.CV; cs.RO**

- **链接: [http://arxiv.org/pdf/2503.07656v2](http://arxiv.org/pdf/2503.07656v2)**
...
>
---
#### [replaced 035] SP$^2$T: Sparse Proxy Attention for Dual-stream Point Transformer
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2412.11540v2](http://arxiv.org/pdf/2412.11540v2)**

> **作者:** Jiaxu Wan; Hong Zhang; Ziqi He; Yangyan Deng; Qishu Wang; Ding Yuan; Yifan Yang
>
...
>
---
#### [replaced 038] Spline Deformation Field
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07521v2](http://arxiv.org/pdf/2507.07521v2)**
...
>
---
#### [replaced 041] Vision-Language-Vision Auto-Encoder: Scalable Knowledge Distillation from Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07104v2](http://arxiv.org/pdf/2507.07104v2)**
...
>
---
#### [replaced 042] Quantifying Context Bias in Domain Adaptation for Object Detection
...
- **链接: [http://arxiv.org/pdf/2403.06759v3](http://arxiv.org/pdf/2403.06759v3)**

> **作者:** Theodore Barfoot; Luis Garcia-Peraza-Herrera; Ben Glocker; Tom Vercauteren
>
> **备注:** accidental replacement intended for arXiv:2506.03942
>
...
>
---
#### [replaced 046] Hita: Holistic Tokenizer for Autoregressive Image Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.02358v4](http://arxiv.org/pdf/2507.02358v4)**
...
>
---
#### [replaced 051] Learning to Generate Vectorized Maps at Intersections with Multiple Roadside Cameras
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.02899v3](http://arxiv.org/pdf/2507.02899v3)**
