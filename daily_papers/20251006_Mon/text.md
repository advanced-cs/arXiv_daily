...
- **简介: 该论文属于Speech Emotion Recognition任务，旨在解决情感识别中语义复杂性问题。通过区分描述性和表达性语义，分析情绪标签与情感反应的关系。**
...
>
---
#### [new 008] Revisiting Direct Speech-to-Text Translation with Speech LLMs: Better Scaling than CoT Prompting?
- **分类: cs.CL; cs.SD**
...
- **简介: 该论文属于多跳问答任务，解决知识检索与推理整合难题。提出StepChain GraphRAG框架，通过知识图谱和BFS推理提升问答准确性和可解释性。**
...
- **简介: 该论文属于多模态大语言模型自提升研究，旨在解决如何高效提升模型能力的问题。通过数据收集、组织与模型优化方法，推动自提升技术的发展。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大模型参数冗余和边缘设备计算限制问题。通过引入分层记忆架构，将长尾知识存储于外部记忆中，提升模型效率与性能。**
...
- **简介: 该论文属于医学文本分析任务，旨在解决放射学报告间语义相似性比较问题。通过结合LLM与NER提出Llama-EntScore方法，提升比较准确性。**
...
- **简介: 该论文属于自然语言处理任务，解决MoE模型的负载不均、参数冗余和通信开销问题。通过动态专家聚类和结构压缩，提升模型效率与性能。**
...
- **简介: 该论文属于人机交互任务，研究用户与LLM助手和人类交互时的语言差异，探索适应策略以提升交互体验。**
...
- **简介: 该论文属于医疗信息检索任务，旨在解决临床指南查询效率低的问题。通过构建RAG系统，提升LLM回答的准确性和可靠性。**
...
- **简介: 该论文聚焦于上下文问答中的认知不确定性量化问题，提出一种基于特征差距的不确定性评估方法，有效提升模型可靠性。**
...
- **简介: 该论文属于环境数据处理任务，旨在解决排放数据获取与分析效率低的问题。通过构建Emission-GPT模型，实现精准问答与数据交互分析。**
...
- **简介: 该论文属于语言神经机制研究，旨在探索语言皮层中意义的抽象表示。通过结合视觉和语言模型，验证了语言系统具有比语言模型更丰富、更抽象的意义表征。**
...
- **简介: 该论文属于语言隐写任务，解决令牌歧义导致的解码失败问题。提出look-ahead Sync方法，在保证安全性的前提下提升嵌入容量。**
...
- **简介: 该论文介绍CLARITY，一个用于患者分诊、诊断和转诊的AI平台。解决医疗流程效率问题，结合FSM与LLM实现高效精准分诊。**
...
- **简介: 该论文属于语义文本相似度任务，旨在解决库尔德语等低资源语言NLP资源不足的问题。研究构建了首个库尔德语STS数据集，并进行了基准测试。**
...
- **简介: 该论文属于RAG系统评估任务，旨在解决传统评估方法难以捕捉LLM生成内容特点的问题，提出基于知识图谱的评估框架，提升评估的全面性和敏感性。**
...
- **链接: [http://arxiv.org/pdf/2510.02524v1](http://arxiv.org/pdf/2510.02524v1)**
...
- **简介: 该论文属于自然语言处理任务，研究语言模型如何在训练中平衡参数化知识与上下文知识的使用，旨在提升模型的知识仲裁能力。**
...
- **简介: 该论文属于自然语言处理任务，研究如何在论证型大语言模型中评估不确定性量化方法，旨在提升模型决策的可靠性。通过实验比较不同方法的有效性。**
...
- **简介: 该论文属于情感分析任务，旨在解决政治推文中侮辱性内容的个性化检测问题。通过测试不同大语言模型在多种政治立场下的表现，研究其对意识形态和文化差异的敏感度。**
...
- **链接: [http://arxiv.org/pdf/2510.02341v1](http://arxiv.org/pdf/2510.02341v1)**
...
- **简介: 该论文属于自然语言处理与神经科学交叉任务，旨在验证语言模型与大脑语言响应的相关性是否可靠。研究通过多种方法验证了这种相关性，确认其与人类语言训练相关。**
...
>
---
#### [new 069] mini-vec2vec: Scaling Universal Geometry Alignment with Linear Transformations
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于文本嵌入对齐任务，解决vec2vec效率低、不稳定的问题，提出mini-vec2vec方法，采用线性变换实现高效稳定对齐。**

- **链接: [http://arxiv.org/pdf/2510.02348v1](http://arxiv.org/pdf/2510.02348v1)**
...
>
---
#### [new 070] Topic Modeling as Long-Form Generation: Can Long-Context LLMs revolutionize NTM via Zero-Shot Prompting?
- **分类: cs.CL; cs.AI**

- **简介: 该论文将主题建模视为长文本生成任务，探讨大语言模型是否能通过零样本提示超越传统模型，解决传统方法效率低的问题。**

- **链接: [http://arxiv.org/pdf/2510.03174v1](http://arxiv.org/pdf/2510.03174v1)**
...
>
---
#### [new 077] Learning to Route: A Rule-Driven Agent Framework for Hybrid-Source Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于问答任务，解决领域特定信息获取问题。通过规则驱动的路由框架，有效整合数据库与文档，提升生成准确性与效率。**

- **链接: [http://arxiv.org/pdf/2510.02388v1](http://arxiv.org/pdf/2510.02388v1)**
...
>
---
#### [new 078] SIMSplat: Predictive Driving Scene Editing with Language-aligned 4D Gaussian Splatting
...
>
---
#### [new 079] MaskCD: Mitigating LVLM Hallucinations by Image Head Masked Contrastive Decoding
...
>
---
#### [new 080] A Granular Study of Safety Pretraining under Model Abliteration
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究安全预训练模型在推理时的鲁棒性，解决安全干预是否经得起简单激活修改的问题。通过模型消融实验，评估不同安全组件的有效性及评价者选择的影响。**

- **链接: [http://arxiv.org/pdf/2510.02768v1](http://arxiv.org/pdf/2510.02768v1)**
...
>
---
#### [new 085] Less LLM, More Documents: Searching for Improved RAG
- **分类: cs.IR; cs.CL; H.3.3; I.2.7**

- **简介: 该论文属于信息检索任务，解决RAG中依赖大模型的问题，通过扩大语料库来提升效果，减少对大语言模型的依赖。**

- **链接: [http://arxiv.org/pdf/2510.02657v1](http://arxiv.org/pdf/2510.02657v1)**
...
>
---
#### [new 090] Beyond the Final Answer: Evaluating the Reasoning Trajectories of Tool-Augmented Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于工具增强型语言模型代理评估任务，旨在解决现有评估方法仅关注最终答案的问题，提出TRACE框架以多维评估代理的推理轨迹。**

- **链接: [http://arxiv.org/pdf/2510.02837v1](http://arxiv.org/pdf/2510.02837v1)**
...
>
---
#### [new 093] NCV: A Node-Wise Consistency Verification Approach for Low-Cost Structured Error Localization in LLM Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于大模型推理验证任务，旨在解决误差定位不精确和高成本问题。提出NCV方法，通过节点级一致性检查实现高效准确的错误定位。**

- **链接: [http://arxiv.org/pdf/2510.02816v1](http://arxiv.org/pdf/2510.02816v1)**
...
>
---
#### [new 094] Low-probability Tokens Sustain Exploration in Reinforcement Learning with Verifiable Reward
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，解决RLVR中探索不足问题。通过引入Lp-Reg，保留低概率探索token，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2510.03222v1](http://arxiv.org/pdf/2510.03222v1)**
...
>
---
#### [new 098] How Confident are Video Models? Empowering Video Models to Express their Uncertainty
...
>
---
#### [new 099] SpeechCT-CLIP: Distilling Text-Image Knowledge to Speech for Voice-Native Multimodal CT Analysis
- **分类: eess.AS; cs.CL**

- **简介: 该论文属于多模态学习任务，旨在解决医疗AI仅依赖文本的问题。通过构建语音数据集并训练SpeechCT-CLIP模型，实现语音与CT图像的对齐，提升语音驱动的诊断能力。**

- **链接: [http://arxiv.org/pdf/2510.02322v1](http://arxiv.org/pdf/2510.02322v1)**
...
>
---
#### [replaced 003] jina-reranker-v3: Last but Not Late Interaction for Listwise Document Reranking
- **分类: cs.CL; cs.AI; cs.IR; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.25085v3](http://arxiv.org/pdf/2509.25085v3)**

> **作者:** Feng Wang; Yuqing Li; Han Xiao
>
> **备注:** early draft, CodeIR table needs to be updated (qwen baselines are missing)
>
...
>
---
#### [replaced 004] Did Translation Models Get More Robust Without Anyone Even Noticing?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2403.03923v2](http://arxiv.org/pdf/2403.03923v2)**

> **作者:** Ben Peters; André F. T. Martins
>
> **备注:** ACL 2025 (Main) camera ready
>
> **摘要:** Neural machine translation (MT) models achieve strong results across a variety of settings, but it is widely believed that they are highly sensitive to "noisy" inputs, such as spelling errors, abbreviations, and other formatting issues. In this paper, we revisit this insight in light of recent multilingual MT models and large language models (LLMs) applied to machine translation. Somewhat surprisingly, we show through controlled experiments that these models are far more robust to many kinds of noise than previous models, even when they perform similarly on clean data. This is notable because, even though LLMs have more parameters and more complex training processes than past models, none of the open ones we consider use any techniques specifically designed to encourage robustness. Next, we show that similar trends hold for social media translation experiments -- LLMs are more robust to social media text. We include an analysis of the circumstances in which source correction techniques can be used to mitigate the effects of noise. Altogether, we show that robustness to many types of noise has increased.
>
---
#### [replaced 005] Towards Economical Inference: Enabling DeepSeek's Multi-Head Latent Attention in Any Transformer-based LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.14837v2](http://arxiv.org/pdf/2502.14837v2)**

> **作者:** Tao Ji; Bin Guo; Yuanbin Wu; Qipeng Guo; Lixing Shen; Zhan Chen; Xipeng Qiu; Qi Zhang; Tao Gui
>
> **备注:** 16 pages, 8 figures; Accepted to ACL 2025
>
...
>
---
#### [replaced 006] Can Language Models Handle a Non-Gregorian Calendar?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.04432v2](http://arxiv.org/pdf/2509.04432v2)**
...
>
---
#### [replaced 011] Learning to Parallel: Accelerating Diffusion Large Language Models via Learnable Parallel Decoding
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.25188v2](http://arxiv.org/pdf/2509.25188v2)**
...
>
---
#### [replaced 012] CBVLM: Training-free Explainable Concept-based Large Vision Language Models for Medical Image Classification
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2501.12266v2](http://arxiv.org/pdf/2501.12266v2)**
...
>
---
#### [replaced 017] The Prompt Makes the Person(a): A Systematic Evaluation of Sociodemographic Persona Prompting for Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.16076v2](http://arxiv.org/pdf/2507.16076v2)**
...
>
---
#### [replaced 018] Query-Level Uncertainty in Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.09669v2](http://arxiv.org/pdf/2506.09669v2)**
...
>
---
#### [replaced 019] GPT and Prejudice: A Sparse Approach to Understanding Learned Representations in Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.01252v2](http://arxiv.org/pdf/2510.01252v2)**
...
>
---
#### [replaced 020] Same Task, Different Circuits: Disentangling Modality-Specific Mechanisms in VLMs
- **分类: cs.CL; 68T5; I.2.7**

- **链接: [http://arxiv.org/pdf/2506.09047v3](http://arxiv.org/pdf/2506.09047v3)**
...
>
---
#### [replaced 021] EconWebArena: Benchmarking Autonomous Agents on Economic Tasks in Realistic Web Environments
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.08136v2](http://arxiv.org/pdf/2506.08136v2)**
...
>
---
#### [replaced 022] From Long Videos to Engaging Clips: A Human-Inspired Video Editing Framework with Multimodal Narrative Understanding
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.02790v2](http://arxiv.org/pdf/2507.02790v2)**
...
>
---
#### [replaced 023] Understanding the Performance Gap in Preference Learning: A Dichotomy of RLHF and DPO
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.19770v2](http://arxiv.org/pdf/2505.19770v2)**
...
>
---
#### [replaced 024] Enhancing Large Language Model Reasoning with Reward Models: An Analytical Survey
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.01925v2](http://arxiv.org/pdf/2510.01925v2)**
...
>
---
#### [replaced 025] PRIME: Planning and Retrieval-Integrated Memory for Enhanced Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22315v2](http://arxiv.org/pdf/2509.22315v2)**
...
>
---
#### [replaced 026] RephQA: Evaluating Readability of Large Language Models in Public Health Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.16360v2](http://arxiv.org/pdf/2509.16360v2)**
...
>
---
#### [replaced 029] MarketSenseAI 2.0: Enhancing Stock Analysis through LLM Agents
- **分类: q-fin.CP; cs.AI; cs.CL; cs.MA; q-fin.PM; 68T07, 68T50, 91G10, 91G15; I.2.1; I.2.7; J.4**

- **链接: [http://arxiv.org/pdf/2502.00415v2](http://arxiv.org/pdf/2502.00415v2)**
...
>
---
#### [replaced 030] Quantum-RAG and PunGPT2: Advancing Low-Resource Language Generation and Retrieval for the Punjabi Language
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.01918v2](http://arxiv.org/pdf/2508.01918v2)**
...
>
---
#### [replaced 037] Better by Comparison: Retrieval-Augmented Contrastive Reasoning for Automatic Prompt Optimization
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2509.02093v2](http://arxiv.org/pdf/2509.02093v2)**
...
>
---
#### [replaced 038] Did I Faithfully Say What I Thought? Bridging the Gap Between Neural Activity and Self-Explanations in Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.09277v3](http://arxiv.org/pdf/2506.09277v3)**
...
>
---
#### [replaced 039] Leveraging Online Data to Enhance Medical Knowledge in a Small Persian Language Model
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.16000v4](http://arxiv.org/pdf/2505.16000v4)**
...
>
---
#### [replaced 042] PrisonBreak: Jailbreaking Large Language Models with at Most Twenty-Five Targeted Bit-flips
- **分类: cs.CR; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.07192v3](http://arxiv.org/pdf/2412.07192v3)**
...
>
---
#### [replaced 044] Unveiling Unicode's Unseen Underpinnings in Undermining Authorship Attribution
- **分类: cs.CR; cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2508.15840v2](http://arxiv.org/pdf/2508.15840v2)**
...
>
---
#### [replaced 045] A Survey of Pun Generation: Datasets, Evaluations and Methodologies
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.04793v2](http://arxiv.org/pdf/2507.04793v2)**
...
>
---
#### [replaced 046] Triadic Multi-party Voice Activity Projection for Turn-taking in Spoken Dialogue Systems
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.07518v2](http://arxiv.org/pdf/2507.07518v2)**
...
>
---
#### [replaced 047] SelfBudgeter: Adaptive Token Allocation for Efficient LLM Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.11274v4](http://arxiv.org/pdf/2505.11274v4)**
...
>
---
#### [replaced 048] THOR: Tool-Integrated Hierarchical Optimization via RL for Mathematical Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.13761v2](http://arxiv.org/pdf/2509.13761v2)**
...
>
---
#### [replaced 049] Do AI Models Perform Human-like Abstract Reasoning Across Modalities?
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.02125v2](http://arxiv.org/pdf/2510.02125v2)**
...
>
---
#### [replaced 050] When Long Helps Short: How Context Length in Supervised Fine-tuning Affects Behavior of Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.18762v3](http://arxiv.org/pdf/2509.18762v3)**
