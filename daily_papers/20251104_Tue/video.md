...
#### [new 001] Benchmarking Federated Learning Frameworks for Medical Imaging Deployment: A Comparative Study of NVIDIA FLARE, Flower, and Owkin Substra
- **分类: cs.CV; cs.DC**

- **简介: 该论文对比了NVIDIA FLARE、Flower和Owkin Substra三大联邦学习框架在医学影像部署中的表现，评估其性能、效率、隐私与易用性，旨在为医疗AI实际应用选型提供依据。**

- **链接: [http://arxiv.org/pdf/2511.00037v1](http://arxiv.org/pdf/2511.00037v1)**
...
>
---
#### [new 002] BlurGuard: A Simple Approach for Robustifying Image Protection Against AI-Powered Editing
- **分类: cs.CV**

- **简介: 论文提出BlurGuard，通过自适应区域高斯模糊增强图像保护噪声的不可逆性，解决现有对抗噪声易被JPEG等操作消除的问题，提升对AI图像编辑的鲁棒防护，同时降低感知失真。**

- **链接: [http://arxiv.org/pdf/2511.00143v1](http://arxiv.org/pdf/2511.00143v1)**

> **作者:** Jinsu Kim; Yunhun Nam; Minseon Kim; Sangpil Kim; Jongheon Jeong
>
> **备注:** 36 pages; NeurIPS 2025; Code is available at https://github.com/jsu-kim/BlurGuard
>
...
>
---
#### [new 003] Driving scenario generation and evaluation using a structured layer representation and foundational models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出一种五层结构化场景表示法，结合基础模型生成罕见驾驶场景，解决传统方法难以评估生成场景多样性和原创性的问题，并设计两类评估指标，实现高效合成与验证。**

- **链接: [http://arxiv.org/pdf/2511.01541v1](http://arxiv.org/pdf/2511.01541v1)**

> **作者:** Arthur Hubert; Gamal Elghazaly; Raphaël Frank
>
> **摘要:** Rare and challenging driving scenarios are critical for autonomous vehicle development. Since they are difficult to encounter, simulating or generating them using generative models is a popular approach. Following previous efforts to structure driving scenario representations in a layer model, we propose a structured five-layer model to improve the evaluation and generation of rare scenarios. We use this model alongside large foundational models to generate new driving scenarios using a data augmentation strategy. Unlike previous representations, our structure introduces subclasses and characteristics for every agent of the scenario, allowing us to compare them using an embedding specific to our layer-model. We study and adapt two metrics to evaluate the relevance of a synthetic dataset in the context of a structured representation: the diversity score estimates how different the scenarios of a dataset are from one another, while the originality score calculates how similar a synthetic dataset is from a real reference set. This paper showcases both metrics in different generation setup, as well as a qualitative evaluation of synthetic videos generated from structured scenario descriptions. The code and extended results can be found at https://github.com/Valgiz/5LMSG.
>
---
#### [new 004] HGFreNet: Hop-hybrid GraphFomer for 3D Human Pose Estimation with Trajectory Consistency in Frequency Domain
- **分类: cs.CV**

- **简介: HGFreNet面向单目视频的2D到3D人体姿态提升任务，解决3D轨迹时序不一致问题，提出跳-混合图注意力与频域轨迹一致性约束，提升姿态精度与时间连贯性。**

- **链接: [http://arxiv.org/pdf/2511.01756v1](http://arxiv.org/pdf/2511.01756v1)**
...
>
---
#### [new 005] Reg-DPO: SFT-Regularized Direct Preference Optimization with GT-Pair for Improving Video Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对视频生成任务，提出Reg-DPO方法，通过GT-Pair自动构建高质量偏好对，并引入SFT正则化提升训练稳定性与生成质量，结合内存优化技术显著提升训练效率，超越现有方法。**

- **链接: [http://arxiv.org/pdf/2511.01450v1](http://arxiv.org/pdf/2511.01450v1)**
...
>
---
#### [new 033] Towards classification-based representation learning for place recognition on LiDAR scans
- **分类: cs.CV**

- **简介: 该论文将激光雷达扫描的地点识别任务转化为多分类问题，提出基于编码器-解码器的分类模型，替代传统对比学习方法，在NuScenes数据集上验证了其性能相当且训练更高效稳定。**

- **链接: [http://arxiv.org/pdf/2511.00738v1](http://arxiv.org/pdf/2511.00738v1)**

> **作者:** Dmitrii Khizbullin; Maksim Konoplia
>
> **摘要:** Place recognition is a crucial task in autonomous driving, allowing vehicles to determine their position using sensor data. While most existing methods rely on contrastive learning, we explore an alternative approach by framing place recognition as a multi-class classification problem. Our method assigns discrete location labels to LiDAR scans and trains an encoder-decoder model to classify each scan's position directly. We evaluate this approach on the NuScenes dataset and show that it achieves competitive performance compared to contrastive learning-based methods while offering advantages in training efficiency and stability.
>
---
#### [new 034] Actial: Activate Spatial Reasoning Ability of Multimodal Large Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 035] Generalized Category Discovery under Domain Shift: A Frequency Domain Perspective
- **分类: cs.CV**

- **简介: 该论文提出FREE框架，解决域偏移下的广义类别发现（DS_GCD）问题，通过频域信息分离域、跨域/域内扰动增强鲁棒性，并结合对比学习与自适应重采样，提升已知与未知类别在分布偏移下的聚类性能。**

- **链接: [http://arxiv.org/pdf/2511.00573v1](http://arxiv.org/pdf/2511.00573v1)**
...
>
---
#### [new 038] Validating Deep Models for Alzheimer's 18F-FDG PET Diagnosis Across Populations: A Study with Latin American Data
- **分类: cs.CV**

- **简介: 该论文研究深度学习模型在阿尔茨海默病18F-FDG PET诊断中的跨人群泛化性，发现ADNI训练的模型在拉美人群上性能显著下降，揭示域偏移问题，并指出归一化与采样策略为关键因素，呼吁重视人群多样性验证。**

- **链接: [http://arxiv.org/pdf/2511.00728v1](http://arxiv.org/pdf/2511.00728v1)**
...
>
---
#### [new 039] SciTextures: Collecting and Connecting Visual Patterns, Models, and Code Across Science and Art
- **分类: cs.CV**

- **简介: 论文提出SciTextures数据集，连接科学与艺术中的视觉纹理、生成模型与代码，旨在让AI理解并重建图案背后的物理机制，评估视觉语言模型的因果推理能力。**

- **链接: [http://arxiv.org/pdf/2511.01817v1](http://arxiv.org/pdf/2511.01817v1)**
...
>
---
#### [new 040] How Far Are Surgeons from Surgical World Models? A Pilot Study on Zero-shot Surgical Video Generation with Expert Assessment
- **分类: cs.CV; cs.AI; cs.MM**

- **简介: 该论文提出SurgVeo基准与SPP评估框架，评估Veo-3模型在零样本手术视频生成中的因果理解能力，揭示其虽视觉逼真，但缺乏手术操作与策略的深层理解，填补了手术AI因果建模的评估空白。**

- **链接: [http://arxiv.org/pdf/2511.01775v1](http://arxiv.org/pdf/2511.01775v1)**
...
>
---
#### [new 041] Oitijjo-3D: Generative AI Framework for Rapid 3D Heritage Reconstruction from Street View Imagery
- **分类: cs.CV; cs.AI; cs.GR**

- **简介: Oitijjo-3D提出一种基于生成式AI的低成本3D文化遗产重建框架，利用街景图像自动生成高保真三维模型，解决发展中国家因资源匮乏导致的遗产数字化难题，无需专业设备或专家操作。**

- **链接: [http://arxiv.org/pdf/2511.00362v1](http://arxiv.org/pdf/2511.00362v1)**
...
>
---
#### [new 043] Spot The Ball: A Benchmark for Visual Social Inference
- **分类: cs.CV; cs.HC**

- **简介: 论文提出“Spot The Ball”基准，评估视觉语言模型在体育场景中通过 gaze、姿态等社会线索推断缺失球体位置的能力，发现人类远优于模型，揭示模型依赖肤浅空间启发，亟需编码结构化行为线索的架构。**

- **链接: [http://arxiv.org/pdf/2511.00261v1](http://arxiv.org/pdf/2511.00261v1)**
...
>
---
#### [new 046] HMVLM: Human Motion-Vision-Lanuage Model via MoE LoRA
- **分类: cs.CV; cs.AI; cs.GR; 68T45; I.2.10; I.3.7**

- **简介: 论文提出HMVLM，面向人机交互的多模态理解与生成任务，解决运动与文本模态差距导致的灾难性遗忘与姿态表征泛化问题，通过MoE LoRA与零专家机制实现高效微调，结合分组关节标记提升表示精度。**

- **链接: [http://arxiv.org/pdf/2511.01463v1](http://arxiv.org/pdf/2511.01463v1)**
...
>
---
#### [new 050] ToxicTextCLIP: Text-Based Poisoning and Backdoor Attacks on CLIP Pre-training
- **分类: cs.CV; cs.CR; cs.LG**

- **简介: 论文提出ToxicTextCLIP，针对CLIP预训练中的文本投毒与后门攻击问题，通过背景感知选择与增强生成对抗文本，实现高达95.83%的投毒成功率，突破现有防御机制。**

- **链接: [http://arxiv.org/pdf/2511.00446v1](http://arxiv.org/pdf/2511.00446v1)**
...
>
---
#### [new 071] Learning with Category-Equivariant Architectures for Human Activity Recognition
- **分类: cs.CV; cs.AI; cs.HC; cs.LG**

- **简介: 该论文面向人体活动识别（HAR）任务，提出CatEquiv网络，通过编码时间、幅值与传感器层级的范畴对称性，实现对数据变换的等变性，显著提升模型在分布外扰动下的鲁棒性与泛化能力，无需增加模型容量。**

- **链接: [http://arxiv.org/pdf/2511.01139v1](http://arxiv.org/pdf/2511.01139v1)**
...
>
---
#### [new 072] REASON: Probability map-guided dual-branch fusion framework for gastric content assessment
- **分类: cs.CV**

- **简介: 该论文提出REASON框架，用于超声图像中胃内容物自动评估，解决传统人工方法效率低、准确性差的问题。通过概率图引导的双分支融合，结合两种体位图像，提升误吸风险评估精度。**

- **链接: [http://arxiv.org/pdf/2511.01302v1](http://arxiv.org/pdf/2511.01302v1)**
...
>
---
#### [new 075] A filtering scheme for confocal laser endomicroscopy (CLE)-video sequences for self-supervised learning
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对CLE视频序列自监督学习中的数据冗余问题，提出一种视频滤波方法，降低帧间冗余，提升训练效率与收敛速度。在两个临床数据集上验证，滤波后SSL模型准确率显著提升，训练时间减少67%。**

- **链接: [http://arxiv.org/pdf/2511.00098v1](http://arxiv.org/pdf/2511.00098v1)**
...
>
---
#### [new 084] BeetleFlow: An Integrative Deep Learning Pipeline for Beetle Image Processing
- **分类: cs.CV**

- **简介: 论文提出BeetleFlow，一个面向甲虫图像处理的深度学习流水线，解决大规模甲虫图像手动分析效率低的问题，通过检测、裁剪与形态分割三阶段自动化处理，结合视觉语言模型与细粒度分割模型提升分析效率。**

- **链接: [http://arxiv.org/pdf/2511.00255v1](http://arxiv.org/pdf/2511.00255v1)**
...
>
---
#### [new 088] Occlusion-Aware Diffusion Model for Pedestrian Intention Prediction
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对行人遮挡场景下的意图预测任务，提出一种遮挡感知扩散模型（ODM），通过重构遮挡运动模式并引入遮挡掩码引导的逆向过程，提升预测鲁棒性，在PIE和JAAD数据集上表现优于现有方法。**

- **链接: [http://arxiv.org/pdf/2511.00858v1](http://arxiv.org/pdf/2511.00858v1)**
...
>
---
#### [new 089] Metadata-Aligned 3D MRI Representations for Contrast Understanding and Quality Control
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出MR-CLIP，通过对齐MRI图像与DICOM元数据，学习无监督的3D对比度表征，解决多中心数据异构与标签缺失问题，实现少样本序列分类与质量控制。**

- **链接: [http://arxiv.org/pdf/2511.00681v1](http://arxiv.org/pdf/2511.00681v1)**
...
>
---
#### [new 094] Integrating Visual and X-Ray Machine Learning Features in the Study of Paintings by Goya
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对戈雅画作真伪鉴定难题，提出一种多模态机器学习框架，统一提取视觉与X光图像的相同特征，通过One-Class SVM实现高精度分类，准确率达97.8%，显著优于单模态方法。**

- **链接: [http://arxiv.org/pdf/2511.01000v1](http://arxiv.org/pdf/2511.01000v1)**
...
>
---
#### [new 095] World Simulation with Video Foundation Models for Physical AI
...
>
---
#### [new 098] SegDebias: Test-Time Bias Mitigation for ViT-Based CLIP via Segmentation
- **分类: cs.CV**

- **简介: 该论文提出SegDebias，一种无需训练数据的测试时去偏方法，用于ViT-CLIP模型。通过预训练分割模型定位目标区域，均匀化非目标区域的视觉嵌入，消除虚假相关性，提升零样本分类的泛化性。**

- **链接: [http://arxiv.org/pdf/2511.00523v1](http://arxiv.org/pdf/2511.00523v1)**
...
>
---
#### [new 099] Which LiDAR scanning pattern is better for roadside perception: Repetitive or Non-repetitive?
...
>
---
#### [new 100] CueBench: Advancing Unified Understanding of Context-Aware Video Anomalies in Real-World
- **分类: cs.CV**

- **简介: 论文提出CueBench首个上下文感知视频异常理解统一基准，构建细粒度异常分类体系，定义32类上下文依赖异常事件，并设计多任务评估框架，提出Cue-R1模型显著超越现有VLMs，推动真实场景异常理解。**

- **链接: [http://arxiv.org/pdf/2511.00613v1](http://arxiv.org/pdf/2511.00613v1)**
...
>
---
#### [new 103] Boosting performance of computer vision applications through embedded GPUs on the edge
- **分类: cs.CV; cs.DC**

- **简介: 该论文研究边缘计算中嵌入式GPU加速计算机视觉应用的任务，解决低端设备资源不足导致体验差的问题，通过实验验证GPU相比CPU能显著提升性能，改善用户体验。**

- **链接: [http://arxiv.org/pdf/2511.01129v1](http://arxiv.org/pdf/2511.01129v1)**

> **作者:** Fabio Diniz Rossi
>
> **备注:** 4 pages, 6 figures
>
> **摘要:** Computer vision applications, especially those using augmented reality technology, are becoming quite popular in mobile devices. However, this type of application is known as presenting significant demands regarding resources. In order to enable its utilization in devices with more modest resources, edge computing can be used to offload certain high intensive tasks. Still, edge computing is usually composed of devices with limited capacity, which may impact in users quality of experience when using computer vision applications. This work proposes the use of embedded devices with graphics processing units (GPUs) to overcome such limitation. Experiments performed shown that GPUs can attain a performance gain when compared to using only CPUs, which guarantee a better experience to users using such kind of application.
>
---
#### [new 104] Epanechnikov nonparametric kernel density estimation based feature-learning in respiratory disease chest X-ray images
- **分类: cs.CV**

- **简介: 该论文提出基于Epanechnikov核密度估计（EKDE）的无参数特征学习方法，用于胸部X光片的呼吸系统疾病诊断，结合双模逻辑回归分类器，提升图像特征提取能力，实现70.14%准确率，探索非参数统计模型在医学影像分析中的应用潜力。**

- **链接: [http://arxiv.org/pdf/2511.01098v1](http://arxiv.org/pdf/2511.01098v1)**
...
>
---
#### [new 105] $\left|\,\circlearrowright\,\boxed{\text{BUS}}\,\right|$: A Large and Diverse Multimodal Benchmark for evaluating the ability of Vision-Language Models to understand Rebus Puzzles
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 112] End-to-End Framework Integrating Generative AI and Deep Reinforcement Learning for Autonomous Ultrasound Scanning
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出首个端到端框架，融合生成AI（VAE-GAN）与深度强化学习，实现自主心脏超声扫描，解决人工依赖与可重复性差问题，并发布公开数据集验证有效性。**

- **链接: [http://arxiv.org/pdf/2511.00114v1](http://arxiv.org/pdf/2511.00114v1)**
...
>
---
#### [new 113] Merlin L48 Spectrogram Dataset
- **分类: cs.CV**

- **简介: 该论文提出L48鸟类声音频谱数据集，面向单正多标签（SPML）任务，解决合成数据与真实场景脱节问题，首次提供真实细粒度SPML基准，并评估现有方法在该数据集上的表现与局限。**

- **链接: [http://arxiv.org/pdf/2511.00252v1](http://arxiv.org/pdf/2511.00252v1)**
...
>
---
#### [new 123] MicroAUNet: Boundary-Enhanced Multi-scale Fusion with Knowledge Distillation for Colonoscopy Polyp Image Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对结肠镜息肉分割中边界模糊与计算复杂度高的问题，提出轻量级MicroAUNet网络，融合多尺度边界增强与知识蒸馏，在极低参数量下实现高精度实时分割。**

- **链接: [http://arxiv.org/pdf/2511.01143v1](http://arxiv.org/pdf/2511.01143v1)**

> **作者:** Ziyi Wang; Yuanmei Zhang; Dorna Esrafilzadeh; Ali R. Jalili; Suncheng Xiang
>
> **备注:** Work in progress
>
> **摘要:** Early and accurate segmentation of colorectal polyps is critical for reducing colorectal cancer mortality, which has been extensively explored by academia and industry. However, current deep learning-based polyp segmentation models either compromise clinical decision-making by providing ambiguous polyp margins in segmentation outputs or rely on heavy architectures with high computational complexity, resulting in insufficient inference speeds for real-time colorectal endoscopic applications. To address this problem, we propose MicroAUNet, a light-weighted attention-based segmentation network that combines depthwise-separable dilated convolutions with a single-path, parameter-shared channel-spatial attention block to strengthen multi-scale boundary features. On the basis of it, a progressive two-stage knowledge-distillation scheme is introduced to transfer semantic and boundary cues from a high-capacity teacher. Extensive experiments on benchmarks also demonstrate the state-of-the-art accuracy under extremely low model complexity, indicating that MicroAUNet is suitable for real-time clinical polyp segmentation. The code is publicly available at https://github.com/JeremyXSC/MicroAUNet.
>
---
#### [new 124] OSMGen: Highly Controllable Satellite Image Synthesis using OpenStreetMap Data
- **分类: cs.CV; cs.LG**

- **简介: OSMGen提出一种基于OpenStreetMap矢量数据的卫星图像生成框架，解决城市监测数据稀缺与类别不平衡问题，支持精准编辑驱动的前后景图像对生成，实现地图修改与视觉变化的闭环联动。**

- **链接: [http://arxiv.org/pdf/2511.00345v1](http://arxiv.org/pdf/2511.00345v1)**
...
>
---
#### [new 125] Towards One-step Causal Video Generation via Adversarial Self-Distillation
- **分类: cs.CV**

- **简介: 该论文致力于单步因果视频生成，解决传统方法迭代慢、误差累积问题。提出对抗自蒸馏（ASD）与首帧增强（FFE）策略，实现仅1-2步高质量视频生成，无需重复蒸馏，显著提升效率与稳定性。**

- **链接: [http://arxiv.org/pdf/2511.01419v1](http://arxiv.org/pdf/2511.01419v1)**
...
>
---
#### [new 126] FedMGP: Personalized Federated Learning with Multi-Group Text-Visual Prompts
- **分类: cs.CV; cs.LG**

- **简介: FedMGP提出一种个性化联邦提示学习框架，通过多组文本-视觉提示捕捉客户端局部特征，结合相似性引导的动态聚合策略，在保持参数高效的同时提升个性化与泛化性能，解决联邦学习中个性化与共性平衡难题。**

- **链接: [http://arxiv.org/pdf/2511.00480v1](http://arxiv.org/pdf/2511.00480v1)**
...
>
---
#### [new 127] OmniTrack++: Omnidirectional Multi-Object Tracking by Learning Large-FoV Trajectory Feedback
- **分类: cs.CV; cs.RO; eess.IV**
...
>
---
#### [new 128] 3EED: Ground Everything Everywhere in 3D
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 129] Beyond ImageNet: Understanding Cross-Dataset Robustness of Lightweight Vision Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文评估轻量级视觉模型在ImageNet之外的跨数据集泛化能力，提出xScore指标量化鲁棒性，发现架构中同质卷积与通道注意力更利于泛化，揭示ImageNet准确率非可靠预测指标，为移动端模型设计提供新准则。**

- **链接: [http://arxiv.org/pdf/2511.00335v1](http://arxiv.org/pdf/2511.00335v1)**
...
>
---
#### [new 130] OmniVLA: Unifiying Multi-Sensor Perception for Physically-Grounded Multimodal VLA
- **分类: cs.CV**

- **简介: OmniVLA提出一种多模态视觉-语言-动作模型，通过融合红外、毫米波雷达和麦克风阵列数据，构建统一的“传感器掩码图像”，突破RGB-only感知限制，显著提升物理交互任务的成功率与泛化能力。**
...
>
---
#### [new 139] A DeepONet joint Neural Tangent Kernel Hybrid Framework for Physics-Informed Inverse Source Problems and Robust Image Reconstruction
- **分类: cs.CV**

- **简介: 该论文提出DeepONet与神经切线核融合框架，用于求解非线性、稀疏、噪声干扰下的物理信息逆源问题与图像重建，通过物理约束与正则化提升解的准确性与鲁棒性。**

- **链接: [http://arxiv.org/pdf/2511.00338v1](http://arxiv.org/pdf/2511.00338v1)**
...
>
---
#### [new 149] Weakly Supervised Concept Learning with Class-Level Priors for Interpretable Medical Diagnosis
- **分类: cs.CV**

- **简介: 该论文提出弱监督概念预测器PCP，解决医学影像解释性模型依赖人工概念标注的问题，利用类级先验替代标注，无需语言模型，通过KL与熵正则化提升概念预测准确性，在多个医学数据集上显著优于零样本基线。**

- **链接: [http://arxiv.org/pdf/2511.01131v1](http://arxiv.org/pdf/2511.01131v1)**
...
>
---
#### [new 158] VinDr-CXR-VQA: A Visual Question Answering Dataset for Explainable Chest X-Ray Analysis with Multi-Task Learning
- **分类: cs.CV**

- **简介: 该论文构建了VinDr-CXR-VQA，首个用于可解释胸部X光视觉问答的多任务数据集，融合定位与临床推理，解决医疗VQA中幻觉与可解释性不足问题，提升诊断准确性与可信度。**

- **链接: [http://arxiv.org/pdf/2511.00504v1](http://arxiv.org/pdf/2511.00504v1)**
...
>
---
#### [new 166] MambaNetLK: Enhancing Colonoscopy Point Cloud Registration with Mamba
- **分类: cs.CV; 68T07 (Primary) 68T45, 92C55 (Secondary)**

- **简介: 论文提出MambaNetLK，用于结肠镜点云配准，解决组织纹理重复与术前术后域偏移导致的配准不稳定问题。结合新数据集C3VD-Raycasting-10k，引入Mamba SSM提升特征提取，实现高效高精度配准。**

- **链接: [http://arxiv.org/pdf/2511.00260v1](http://arxiv.org/pdf/2511.00260v1)**
...
>
---
#### [new 171] CMI-MTL: Cross-Mamba interaction based multi-task learning for medical visual question answering
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向医学视觉问答（Med-VQA）任务，解决传统方法难以对齐跨模态语义与受限于固定答案集的问题。提出CMI-MTL框架，通过细粒度对齐、交叉模态交互和自由回答增强多任务学习，提升开放答案生成能力。**

- **链接: [http://arxiv.org/pdf/2511.01357v1](http://arxiv.org/pdf/2511.01357v1)**
...
>
---
#### [new 172] VesSAM: Efficient Multi-Prompting for Segmenting Complex Vessel
- **分类: cs.CV**

- **简介: VesSAM针对血管分割难题，提出高效多提示框架，通过卷积适配器增强纹理、多提示编码融合解剖特征、轻量解码器减少伪影，并构建多模态基准，显著超越现有方法，以极低参数实现高性能与强泛化。**

- **链接: [http://arxiv.org/pdf/2511.00981v1](http://arxiv.org/pdf/2511.00981v1)**
...
>
---
#### [new 175] Weakly Supervised Pneumonia Localization from Chest X-Rays Using Deep Neural Network and Grad-CAM Explanations
- **分类: cs.CV**

- **简介: 该论文提出一种弱监督深度学习框架，利用图像级标签和Grad-CAM实现肺炎分类与定位，无需像素级标注。在Kermany数据集上验证了ResNet-18和EfficientNet-B0的高性能，并证明热力图具有临床可解释性。**

- **链接: [http://arxiv.org/pdf/2511.00456v1](http://arxiv.org/pdf/2511.00456v1)**
...
>
---
#### [new 182] Self-Improving Vision-Language-Action Models with Data Generation via Residual RL
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 183] PixelVLA: Advancing Pixel-level Understanding in Vision-Language-Action Model
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 189] Unified Diffusion VLA: Vision-Language-Action Model via Joint Discrete Denoising Diffusion Process
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 192] Fast-SmartWay: Panoramic-Free End-to-End Zero-Shot Vision-and-Language Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 193] Multimodal Learning with Augmentation Techniques for Natural Disaster Assessment
...
>
---
#### [new 194] LiDAR-VGGT: Cross-Modal Coarse-to-Fine Fusion for Globally Consistent and Metric-Scale Dense Mapping
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 195] EraseFlow: Learning Concept Erasure Policies via GFlowNet-Driven Alignment
- **分类: cs.LG; cs.CV**

- **简介: EraseFlow将概念擦除建模为去噪轨迹的探索问题，利用GFlowNet优化随机策略，在不损害图像质量的前提下，高效移除文本到图像生成器中的有害或专有概念，无需人工奖励模型。**

- **链接: [http://arxiv.org/pdf/2511.00804v1](http://arxiv.org/pdf/2511.00804v1)**
...
>
---
#### [new 196] Learning with Category-Equivariant Representations for Human Activity Recognition
- **分类: cs.LG; cs.AI; cs.CV; cs.HC**

- **简介: 该论文面向人体活动识别任务，解决传感器信号受环境扰动导致模型不稳定的问题。通过引入类别等变表示框架，显式建模时序、尺度与传感器层级的对称性，显著提升模型在分布外数据上的泛化能力。**

- **链接: [http://arxiv.org/pdf/2511.00900v1](http://arxiv.org/pdf/2511.00900v1)**
...
>
---
#### [new 197] SonarSweep: Fusing Sonar and Vision for Robust 3D Reconstruction via Plane Sweeping
...
>
---
#### [new 198] Melanoma Classification Through Deep Ensemble Learning and Explainable AI
- **分类: cs.LG; cs.CV**

- **简介: 该论文针对黑色素瘤分类任务，提出一种基于深度集成学习的模型，结合可解释AI（XAI）技术，提升诊断准确性并增强模型决策的可解释性与可信度。**

- **链接: [http://arxiv.org/pdf/2511.00246v1](http://arxiv.org/pdf/2511.00246v1)**
...
>
---
#### [new 199] GeneFlow: Translation of Single-cell Gene Expression to Histopathological Images via Rectified Flow
- **分类: q-bio.QM; cs.CV**

- **简介: 论文提出GeneFlow，将单细胞基因表达映射为组织病理图像，解决基因与形态间的多对一映射难题。基于修正流与注意力UNet，生成高分辨率染色图像，优于扩散模型，助力疾病诊断与扰动研究。**

- **链接: [http://arxiv.org/pdf/2511.00119v1](http://arxiv.org/pdf/2511.00119v1)**
...
>
---
#### [new 201] VRScout: Towards Real-Time, Autonomous Testing of Virtual Reality Games
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: VRScout提出一种基于深度学习的自主代理，用于实时自动化测试VR游戏，解决传统人工测试效率低、现有方法难适配VR高维实时需求的问题，通过增强的动作分块Transformer实现专家级性能与60 FPS实时推理。**

- **链接: [http://arxiv.org/pdf/2511.00002v1](http://arxiv.org/pdf/2511.00002v1)**
...
>
---
#### [new 202] Region-Aware Reconstruction Strategy for Pre-training fMRI Foundation Model
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文面向fMRI基础模型预训练，提出基于AAL3脑区掩码的区域感知重建策略，替代随机掩码，提升模型对ADHD分类的准确性与可解释性，揭示边缘系统与小脑对表征的关键贡献。**

- **链接: [http://arxiv.org/pdf/2511.00443v1](http://arxiv.org/pdf/2511.00443v1)**
...
>
---
#### [new 203] Multimodal Detection of Fake Reviews using BERT and ResNet-50
...
>
---
#### [new 204] Few-Shot Multimodal Medical Imaging: A Theoretical Framework
- **分类: stat.ML; cs.AI; cs.CV; cs.LG; eess.IV**

- **简介: 该论文提出一种少样本多模态医学影像的统一理论框架，解决低数据环境下模型泛化与解释性不足的问题，通过PAC学习理论量化样本复杂度、不确定性与解释稳定性，为数据高效诊断系统提供理论基础。**

- **链接: [http://arxiv.org/pdf/2511.01140v1](http://arxiv.org/pdf/2511.01140v1)**
...
>
---
#### [new 205] Towards Reliable Pediatric Brain Tumor Segmentation: Task-Specific nnU-Net Enhancements
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文针对儿科脑肿瘤多参数MRI分割任务，提出改进的nnU-Net框架，通过增强编码器、深度可分离卷积、特异性正则化等方法，解决数据少、变异大等问题，在BraTS 2025 Task-6上取得最优分割效果。**

- **链接: [http://arxiv.org/pdf/2511.00449v1](http://arxiv.org/pdf/2511.00449v1)**
...
>
---
#### [new 209] Applying Medical Imaging Tractography Techniques to Painterly Rendering of Images
- **分类: cs.GR; cs.CV**

- **简介: 该论文将医学DTI tractography技术迁移到绘画渲染，利用结构张量替代梯度，模拟艺术家笔触走向，实现仿真人绘画效果，探索跨领域图像处理新方法。**

- **链接: [http://arxiv.org/pdf/2511.00702v1](http://arxiv.org/pdf/2511.00702v1)**

> **作者:** Alberto Di Biase
>
> **备注:** Exploratory investigation applying medical imaging tractography techniques to painterly image rendering. Code available at https://github.com/tito21/st-python
>
> **摘要:** Doctors and researchers routinely use diffusion tensor imaging (DTI) and tractography to visualize the fibrous structure of tissues in the human body. This paper explores the connection of these techniques to the painterly rendering of images. Using a tractography algorithm the presented method can place brush strokes that mimic the painting process of human artists, analogously to how fibres are tracked in DTI. The analogue to the diffusion tensor for image orientation is the structural tensor, which can provide better local orientation information than the gradient alone. I demonstrate this technique in portraits and general images, and discuss the parallels between fibre tracking and brush stroke placement, and frame it in the language of tractography. This work presents an exploratory investigation into the cross-domain application of diffusion tensor imaging techniques to painterly rendering of images. All the code is available at https://github.com/tito21/st-python
>
---
#### [new 210] POSESTITCH-SLT: Linguistically Inspired Pose-Stitching for End-to-End Sign Language Translation
...
>
---
#### [new 211] MARS: Multi-Agent Robotic System with Multimodal Large Language Models for Assistive Intelligence
...
>
---
#### [new 212] Learning to Seek Evidence: A Verifiable Reasoning Agent with Causal Faithfulness Analysis
- **分类: cs.AI; cs.CV; I.2.6; I.2.10**

- **简介: 该论文提出一种可验证的推理代理，通过强化学习学习主动寻求视觉证据以支持医学诊断，提升解释的可信度与准确性，并引入因果干预验证证据的忠实性，解决AI解释不可验证的问题。**

- **链接: [http://arxiv.org/pdf/2511.01425v1](http://arxiv.org/pdf/2511.01425v1)**
...
>
---
#### [new 214] Three-dimensional narrow volume reconstruction method with unconditional stability based on a phase-field Lagrange multiplier approach
- **分类: math.NA; cs.CG; cs.CV; cs.NA; 65M06, 65M12, 35K57, 65D18**

- **简介: 该论文提出一种基于相场-拉格朗日乘子的三维窄体重建方法，解决点云数据重建稳定性和细节保持问题，通过无条件稳定数值格式实现高效高精度三维重建，并验证于复杂对象如《星球大战》字符。**

- **链接: [http://arxiv.org/pdf/2511.00508v1](http://arxiv.org/pdf/2511.00508v1)**
...
>
---
#### [replaced 002] MGPATH: Vision-Language Model with Multi-Granular Prompt Learning for Few-Shot WSI Classification
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.07409v5](http://arxiv.org/pdf/2502.07409v5)**
...
>
> **备注:** Published in Transactions on Machine Learning Research (09/2025)
>
...
>
---
#### [replaced 003] Knolling Bot: Teaching Robots the Human Notion of Tidiness
...
>
---
#### [replaced 004] Audio Driven Real-Time Facial Animation for Social Telepresence
...
>
---
#### [replaced 005] Rethinking Visual Intelligence: Insights from Video Pretraining
- **分类: cs.CV; cs.AI; 68T07, 68T45, 68T20; I.2.10; I.4.8; I.5.1; I.2.6**

- **链接: [http://arxiv.org/pdf/2510.24448v2](http://arxiv.org/pdf/2510.24448v2)**
...
>
---
#### [replaced 006] FlexEvent: Towards Flexible Event-Frame Object Detection at Varying Operational Frequencies
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 007] Geospatial Foundation Models to Enable Progress on Sustainable Development Goals
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.24528v2](http://arxiv.org/pdf/2505.24528v2)**
...
>
---
#### [replaced 008] REN: Fast and Efficient Region Encodings from Patch-Based Image Encoders
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18153v2](http://arxiv.org/pdf/2505.18153v2)**
...
>
---
#### [replaced 009] Vision-Language Model-Based Semantic-Guided Imaging Biomarker for Lung Nodule Malignancy Prediction
- **分类: cs.CV; cs.AI; q-bio.QM**

- **链接: [http://arxiv.org/pdf/2504.21344v3](http://arxiv.org/pdf/2504.21344v3)**
...
>
---
#### [replaced 010] Kineo: Calibration-Free Metric Motion Capture From Sparse RGB Cameras
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.24464v2](http://arxiv.org/pdf/2510.24464v2)**
...
>
---
#### [replaced 015] Vision Foundation Models Can Be Good Tokenizers for Latent Diffusion Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.18457v2](http://arxiv.org/pdf/2510.18457v2)**
...
>
---
#### [replaced 016] Keep It Real: Challenges in Attacking Compression-Based Adversarial Purification
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2508.05489v3](http://arxiv.org/pdf/2508.05489v3)**

> **作者:** Samuel Räber; Till Aczel; Andreas Plesner; Roger Wattenhofer
>
> **备注:** Accepted to the Reliable ML from Unreliable Data workshop at NeurIPS 2025 (ReliableML@NeurIPS)
>
...
>
---
#### [replaced 019] Scaling Tumor Segmentation: Best Lessons from Real and Synthetic Data
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14831v2](http://arxiv.org/pdf/2510.14831v2)**
...
>
---
#### [replaced 027] Policy Optimized Text-to-Image Pipeline Design
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.21478v2](http://arxiv.org/pdf/2505.21478v2)**
...
>
---
#### [replaced 035] MindJourney: Test-Time Scaling with World Models for Spatial Reasoning
...
>
---
#### [replaced 036] Robust Atypical Mitosis Classification with DenseNet121: Stain-Aware Augmentation and Hybrid Loss for Domain Generalization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.22630v2](http://arxiv.org/pdf/2510.22630v2)**
...
>
---
#### [replaced 037] Pragmatic Heterogeneous Collaborative Perception via Generative Communication Mechanism
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.19618v3](http://arxiv.org/pdf/2510.19618v3)**

> **作者:** Junfei Zhou; Penglin Dai; Quanmin Wei; Bingyi Liu; Xiao Wu; Jianping Wang
>
> **备注:** 26 pages, 10 figures, accepted to NeurIPS 2025
>
...
>
---
#### [replaced 038] AdaSCALE: Adaptive Scaling for OOD Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.08023v2](http://arxiv.org/pdf/2503.08023v2)**
...
>
---
#### [replaced 039] MotionGPT3: Human Motion as a Second Modality
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 042] TextAtlas5M: A Large-scale Dataset for Dense Text Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.07870v2](http://arxiv.org/pdf/2502.07870v2)**
...
>
> **备注:** 27 pages, 15 figures. Dataset Website: https://textatlas5m.github.io
>
...
>
---
#### [replaced 045] LoVR: A Benchmark for Long Video Retrieval in Multimodal Contexts
- **分类: cs.CV; cs.IR**

- **链接: [http://arxiv.org/pdf/2505.13928v2](http://arxiv.org/pdf/2505.13928v2)**
...
>
---
#### [replaced 046] Multimodal Spatial Reasoning in the Large Model Era: A Survey and Benchmarks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.25760v2](http://arxiv.org/pdf/2510.25760v2)**
...
>
---
#### [replaced 049] MOSPA: Human Motion Generation Driven by Spatial Audio
...
>
---
#### [replaced 050] Non-Contact Health Monitoring During Daily Personal Care Routines
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.09718v2](http://arxiv.org/pdf/2506.09718v2)**
...
>
---
#### [replaced 053] Lattice Boltzmann Model for Learning Real-World Pixel Dynamicity
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.16527v2](http://arxiv.org/pdf/2509.16527v2)**
...
>
---
#### [replaced 054] A Study in Dataset Distillation for Image Super-Resolution
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.03656v2](http://arxiv.org/pdf/2502.03656v2)**
...
>
---
#### [replaced 058] OpenMaterial: A Large-scale Dataset of Complex Materials for 3D Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2406.08894v2](http://arxiv.org/pdf/2406.08894v2)**
...
>
---
#### [replaced 061] Efficiency vs. Efficacy: Assessing the Compression Ratio-Dice Score Relationship through a Simple Benchmarking Framework for Cerebrovascular 3D Segmentation
- **分类: cs.CV; eess.SP**

- **链接: [http://arxiv.org/pdf/2510.03769v2](http://arxiv.org/pdf/2510.03769v2)**
...
>
---
#### [replaced 062] Preliminary study on artificial intelligence methods for cybersecurity threat detection in computer networks based on raw data packets
- **分类: cs.CV; cs.AI; cs.CR; I.5.4; C.2.0; I.2.1**

- **链接: [http://arxiv.org/pdf/2407.17339v2](http://arxiv.org/pdf/2407.17339v2)**
...
>
---
#### [replaced 065] Autoadaptive Medical Segment Anything Model
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.01828v2](http://arxiv.org/pdf/2507.01828v2)**
...
>
---
#### [replaced 070] AI-Driven Detection and Analysis of Handwriting on Seized Ivory: A Tool to Uncover Criminal Networks in the Illicit Wildlife Trade
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10219v3](http://arxiv.org/pdf/2508.10219v3)**

> **作者:** Will Fein; Ryan J. Horwitz; John E. Brown III; Amit Misra; Felipe Oviedo; Kevin White; Juan M. Lavista Ferres; Samuel K. Wasser
>
> **备注:** Submitted. 5 pages, 3 figures, 1 table
>
...
>
---
#### [replaced 073] Space Object Detection using Multi-frame Temporal Trajectory Completion Method
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.19220v2](http://arxiv.org/pdf/2510.19220v2)**

> **作者:** Xiaoqing Lan; Biqiao Xin; Bingshu Wang; Han Zhang; Rui Zhu; Laixian Zhang
>
...
>
---
#### [replaced 074] SAIL-Embedding Technical Report: Omni-modal Embedding Foundation Model
- **分类: cs.IR; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.12709v3](http://arxiv.org/pdf/2510.12709v3)**
...
>
---
#### [replaced 075] DeGMix: Efficient Multi-Task Dense Prediction with Deformable and Gating Mixer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2308.05721v5](http://arxiv.org/pdf/2308.05721v5)**

> **作者:** Yangyang Xu; Yibo Yang; Bernard Ghanem; Lefei Zhang; Bo Du; Jun Zhu
>
...
>
---
#### [replaced 076] SPIRAL: Semantic-Aware Progressive LiDAR Scene Generation and Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.22643v2](http://arxiv.org/pdf/2505.22643v2)**

> **作者:** Dekai Zhu; Yixuan Hu; Youquan Liu; Dongyue Lu; Lingdong Kong; Slobodan Ilic
>
> **备注:** NeurIPS 2025; 24 pages, 10 figures, 9 tables; Code at https://dekai21.github.io/SPIRAL/
>
...
>
---
#### [replaced 077] RareFlow: Physics-Aware Flow-Matching for Cross-Sensor Super-Resolution of Rare-Earth Features
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.23816v2](http://arxiv.org/pdf/2510.23816v2)**
...
>
---
#### [replaced 078] Representation-Level Counterfactual Calibration for Debiased Zero-Shot Recognition
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.26466v2](http://arxiv.org/pdf/2510.26466v2)**
...
>
---
#### [replaced 079] Detailed Aerial Mapping of Photovoltaic Power Plants Through Semantically Significant Keypoints
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.04840v2](http://arxiv.org/pdf/2510.04840v2)**

> **作者:** Viktor Kozák; Jan Chudoba; Libor Přeučil
>
> **备注:** 11 pages, 18 figures. Accepted version
>
...
>
---
#### [replaced 085] PixelRefer: A Unified Framework for Spatio-Temporal Object Referring with Arbitrary Granularity
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.23603v2](http://arxiv.org/pdf/2510.23603v2)**
...
>
---
#### [replaced 090] EgoBlind: Towards Egocentric Visual Assistance for the Blind
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2503.08221v4](http://arxiv.org/pdf/2503.08221v4)**
...
>
---
#### [replaced 091] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2510.14270v2](http://arxiv.org/pdf/2510.14270v2)**
...
>
---
#### [replaced 092] Distribution-aware Knowledge Unification and Association for Non-exemplar Lifelong Person Re-identification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03516v2](http://arxiv.org/pdf/2508.03516v2)**

> **作者:** Shiben Liu; Mingyue Xu; Huijie Fan; Qiang Wang; Yandong Tang; Zhi Han
>
> **备注:** 11 papges, 6 figures
>
...
>
---
#### [replaced 093] Double Descent Meets Out-of-Distribution Detection: Theoretical Insights and Empirical Analysis on the role of model complexity
- **分类: stat.ML; cs.AI; cs.CV; cs.LG; math.ST; stat.TH; I.2.6; I.5.1**

- **链接: [http://arxiv.org/pdf/2411.02184v3](http://arxiv.org/pdf/2411.02184v3)**

> **作者:** Mouïn Ben Ammar; David Brellmann; Arturo Mendoza; Antoine Manzanera; Gianni Franchi
>
> **备注:** Accepted at NeurIPS 2025 (Conference on Neural Information Processing Systems)
>
...
>
---
#### [replaced 094] Modality-AGnostic Image Cascade (MAGIC) for Multi-Modality Cardiac Substructure Segmentation
- **分类: physics.med-ph; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.10797v2](http://arxiv.org/pdf/2506.10797v2)**
...
>
---
#### [replaced 104] Risk-adaptive Activation Steering for Safe Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13698v2](http://arxiv.org/pdf/2510.13698v2)**
...
>
---
#### [replaced 105] A Racing Dataset and Baseline Model for Track Detection in Autonomous Racing
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [http://arxiv.org/pdf/2502.14068v2](http://arxiv.org/pdf/2502.14068v2)**
...
>
---
#### [replaced 107] Consistent Supervised-Unsupervised Alignment for Generalized Category Discovery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.04725v2](http://arxiv.org/pdf/2507.04725v2)**
...
>
---
#### [replaced 108] Deep Video Discovery: Agentic Search with Tool Use for Long-form Video Understanding
...
>
---
#### [replaced 109] Generative diffusion modeling protocols for improving the Kikuchi pattern indexing in electron back-scatter diffraction
- **分类: cond-mat.mtrl-sci; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.26907v2](http://arxiv.org/pdf/2510.26907v2)**
...
>
---
#### [replaced 110] 50 Years of Water Body Monitoring: The Case of Qaraaoun Reservoir, Lebanon
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.24413v2](http://arxiv.org/pdf/2510.24413v2)**
...
>
---
#### [replaced 111] Hyperparameter Optimization and Reproducibility in Deep Learning Model Training
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.15164v2](http://arxiv.org/pdf/2510.15164v2)**
...
>
---
#### [replaced 112] Multi-Focused Video Group Activities Hashing
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.00490v2](http://arxiv.org/pdf/2509.00490v2)**
...
>
---
#### [replaced 115] ChartAB: A Benchmark for Chart Grounding & Dense Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.26781v2](http://arxiv.org/pdf/2510.26781v2)**
...
>
---
#### [replaced 116] A Low-Resolution Image is Worth 1x1 Words: Enabling Fine Image Super-Resolution with Transformers and TaylorShift
- **分类: cs.CV; cs.AI; cs.LG; cs.MM**

- **链接: [http://arxiv.org/pdf/2411.10231v2](http://arxiv.org/pdf/2411.10231v2)**
...
>
---
#### [replaced 118] Aligning Effective Tokens with Video Anomaly in Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.06350v2](http://arxiv.org/pdf/2508.06350v2)**

> **作者:** Yingxian Chen; Jiahui Liu; Ruidi Fan; Yanwei Li; Chirui Chang; Shizhen Zhao; Wilton W. T. Fok; Xiaojuan Qi; Yik-Chung Wu
>
...
>
---
#### [replaced 119] EndoGMDE: Generalizable Monocular Depth Estimation with Mixture of Low-Rank Experts for Diverse Endoscopic Scenes
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.01206v3](http://arxiv.org/pdf/2509.01206v3)**

> **作者:** Liangjing Shao; Chenkang Du; Benshuang Chen; Xueli Liu; Xinrong Chen
>
> **备注:** 12 pages, 12 figures, 7 tables. Under Review
>
...
>
---
#### [replaced 120] Event-RGB Fusion for Spacecraft Pose Estimation Under Harsh Lighting
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 121] VO-DP: Semantic-Geometric Adaptive Diffusion Policy for Vision-Only Robotic Manipulation
...
>
---
#### [replaced 122] REP: Resource-Efficient Prompting for Rehearsal-Free Continual Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2406.04772v5](http://arxiv.org/pdf/2406.04772v5)**
...
>
---
#### [replaced 127] DMVFC: Deep Learning Based Functionally Consistent Tractography Fiber Clustering Using Multimodal Diffusion MRI and Functional MRI
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.24770v2](http://arxiv.org/pdf/2510.24770v2)**
...
>
---
#### [replaced 128] Dual-level Progressive Hardness-Aware Reweighting for Cross-View Geo-Localization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.27181v2](http://arxiv.org/pdf/2510.27181v2)**
...
>
---
#### [replaced 131] mmCooper: A Multi-agent Multi-stage Communication-efficient and Collaboration-robust Cooperative Perception Framework
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.12263v3](http://arxiv.org/pdf/2501.12263v3)**
...
>
---
#### [replaced 132] Coarse Attribute Prediction with Task Agnostic Distillation for Real World Clothes Changing ReID
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.12580v2](http://arxiv.org/pdf/2505.12580v2)**
...
>
---
#### [replaced 133] AI-Generated Video Detection via Perceptual Straightening
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.00583v3](http://arxiv.org/pdf/2507.00583v3)**

> **作者:** Christian Internò; Robert Geirhos; Markus Olhofer; Sunny Liu; Barbara Hammer; David Klindt
>
> **备注:** Advances in Neural Information Processing Systems 38 (NeurIPS 2025)
>
...
>
---
#### [replaced 134] Res-Bench: Benchmarking the Robustness of Multimodal Large Language Models to Dynamic Resolution Input
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 139] EDITOR: Effective and Interpretable Prompt Inversion for Text-to-Image Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03067v2](http://arxiv.org/pdf/2506.03067v2)**

> **作者:** Mingzhe Li; Gehao Zhang; Zhenting Wang; Guanhong Tao; Siqi Pan; Richard Cartwright; Juan Zhai; Shiqing Ma
>
...
>
---
#### [replaced 140] V2X-Radar: A Multi-modal Dataset with 4D Radar for Cooperative Perception
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.10962v4](http://arxiv.org/pdf/2411.10962v4)**

> **作者:** Lei Yang; Xinyu Zhang; Jun Li; Chen Wang; Jiaqi Ma; Zhiying Song; Tong Zhao; Ziying Song; Li Wang; Mo Zhou; Yang Shen; Kai Wu; Chen Lv
>
> **备注:** NeurIPS 2025 Spotlight
>
> **摘要:** Modern autonomous vehicle perception systems often struggle with occlusions and limited perception range. Previous studies have demonstrated the effectiveness of cooperative perception in extending the perception range and overcoming occlusions, thereby enhancing the safety of autonomous driving. In recent years, a series of cooperative perception datasets have emerged; however, these datasets primarily focus on cameras and LiDAR, neglecting 4D Radar, a sensor used in single-vehicle autonomous driving to provide robust perception in adverse weather conditions. In this paper, to bridge the gap created by the absence of 4D Radar datasets in cooperative perception, we present V2X-Radar, the first large-scale, real-world multi-modal dataset featuring 4D Radar. V2X-Radar dataset is collected using a connected vehicle platform and an intelligent roadside unit equipped with 4D Radar, LiDAR, and multi-view cameras. The collected data encompasses sunny and rainy weather conditions, spanning daytime, dusk, and nighttime, as well as various typical challenging scenarios. The dataset consists of 20K LiDAR frames, 40K camera images, and 20K 4D Radar data, including 350K annotated boxes across five categories. To support various research domains, we have established V2X-Radar-C for cooperative perception, V2X-Radar-I for roadside perception, and V2X-Radar-V for single-vehicle perception. Furthermore, we provide comprehensive benchmarks across these three sub-datasets. We will release all datasets and benchmark codebase at https://huggingface.co/datasets/yanglei18/V2X-Radar and https://github.com/yanglei18/V2X-Radar.
>
---
#### [replaced 141] Keep It on a Leash: Controllable Pseudo-label Generation Towards Realistic Long-Tailed Semi-Supervised Learning
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.03993v5](http://arxiv.org/pdf/2510.03993v5)**
...
>
---
#### [replaced 142] Learning to Steer: Input-dependent Steering for Multimodal LLMs
...
>
---
#### [replaced 143] VidText: Towards Comprehensive Evaluation for Video Text Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.22810v2](http://arxiv.org/pdf/2505.22810v2)**
...
>
---
#### [replaced 144] WildCAT3D: Appearance-Aware Multi-View Diffusion in the Wild
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13030v2](http://arxiv.org/pdf/2506.13030v2)**

> **作者:** Morris Alper; David Novotny; Filippos Kokkinos; Hadar Averbuch-Elor; Tom Monnier
>
> **备注:** Accepted to NeurIPS 2025. Project page: https://wildcat3d.github.io
>
...
>
---
#### [replaced 145] Mitigating Attention Sinks and Massive Activations in Audio-Visual Speech Recognition with LLMs
...
>
---
#### [replaced 146] Where and How to Perturb: On the Design of Perturbation Guidance in Diffusion and Flow Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.10978v4](http://arxiv.org/pdf/2506.10978v4)**
...
>
> **备注:** Accepted at NeurIPS 2025. Project page: https://cvlab-kaist.github.io/HeadHunter/
>
...
>
---
#### [replaced 147] PRISM2: Unlocking Multi-Modal General Pathology AI with Clinical Dialogue
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 148] Combinative Matching for Geometric Shape Assembly
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09780v2](http://arxiv.org/pdf/2508.09780v2)**
...
>
---
#### [replaced 149] CrowdVLM-R1: Expanding R1 Ability to Vision Language Model for Crowd Counting using Fuzzy Group Relative Policy Reward
- **分类: cs.CV; cs.CL**
