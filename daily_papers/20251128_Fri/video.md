...
#### [new 001] CanKD: Cross-Attention-based Non-local operation for Feature-based Knowledge Distillation
- **分类: cs.CV**

- **简介: 该论文提出CanKD，一种基于交叉注意力的非局部特征知识蒸馏方法，用于计算机视觉中的目标检测与图像分割任务。针对传统方法仅局部对齐特征的问题，提出动态全局关联机制，通过跨注意力增强学生与教师特征间的非局部关系建模，仅引入额外损失即显著提升性能。**
...
>
---
#### [new 002] Test-Time Alignment of Text-to-Image Diffusion Models via Null-Text Embedding Optimisation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对文本到图像扩散模型的测试时对齐（TTA）任务，解决现有方法易导致优化不足或奖励劫持的问题。提出Null-TTA方法，通过优化无条件文本嵌入而非噪声变量，实现语义一致的分布对齐，提升生成质量与跨奖励泛化能力，建立基于语义空间优化的新范式。**
...
>
---
#### [new 003] MIRA: Multimodal Iterative Reasoning Agent for Image Editing
- **分类: cs.CV**

- **简介: 该论文针对指令引导图像编辑中复杂语义理解困难的问题，提出轻量级多模态迭代推理代理MIRA。通过感知-推理-行动循环，逐步生成原子编辑指令，结合视觉反馈实现精准编辑，显著提升语义一致性和视觉质量，优于多个开源与闭源系统。**
...
>
---
#### [new 004] A deep learning model to reduce agent dose for contrast-enhanced MRI of the cerebellopontine angle cistern
- **分类: cs.CV**

- **简介: 该论文属于医学影像低剂量重建任务，旨在降低脑桥小脑角池增强MRI的对比剂剂量。通过深度学习模型从低剂量模拟数据中恢复高质量图像，显著提升图像质量与病灶分割精度，实现10%-30%标准剂量下的有效诊断。**
...
>
---
#### [new 005] Attention-Guided Patch-Wise Sparse Adversarial Attacks on Vision-Language-Action Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对视觉-语言-动作（VLA）模型的对抗攻击问题，提出一种基于注意力引导的稀疏局部攻击框架ADVLA。通过在视觉编码特征投影空间施加低幅值、稀疏扰动，实现高效精准攻击，显著降低训练成本与视觉可见性，提升攻击隐蔽性与效率。**
...
>
---
#### [new 006] Deformation-aware Temporal Generation for Early Prediction of Alzheimers Disease
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对阿尔茨海默病（AD）早期预测任务，解决传统方法依赖人工特征提取及缺失数据影响问题。提出变形感知时序生成网络（DATGN），通过插值补全缺失MRI序列，并生成符合疾病进展趋势的未来脑图像，提升分类准确率。**
...
>
---
#### [new 007] From Observation to Action: Latent Action-based Primitive Segmentation for VLA Pre-training in Industrial Settings
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对工业场景中海量未标注视频数据难以用于视觉-语言-动作（VLA）模型预训练的问题，提出一种端到端的无监督框架。通过轻量级运动分词器与基于“潜在动作能量”的动作分割算法，自动提取语义一致的动作基元，生成可直接用于VLA预训练的结构化数据，实现工业视频的高效利用。**
...
>
---
#### [new 008] Are Neuro-Inspired Multi-Modal Vision-Language Models Resilient to Membership Inference Privacy Leakage?
- **分类: cs.CV; cs.AI; cs.CR**

- **简介: 该论文研究多模态视觉语言模型（VLMs）在会员推理攻击（MIA）下的隐私韧性问题，属于隐私安全任务。针对现有研究忽视神经启发式多模态模型隐私防护的问题，提出基于拓扑正则化的神经启发框架（tau），在BLIP、PaliGemma 2和ViT-GPT2上验证其对图像-文本数据的隐私保护能力。实验表明，神经启发模型在保持模型性能的同时，显著降低隐私泄露风险。**
...
>
---
#### [new 009] Which Layer Causes Distribution Deviation? Entropy-Guided Adaptive Pruning for Diffusion and Flow Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [new 010] Do Reasoning Vision-Language Models Inversely Scale in Test-Time Compute? A Distractor-centric Empirical Analysis
...
>
---
#### [new 011] Generalized Design Choices for Deepfake Detectors
- **分类: cs.CV**

- **简介: 该论文针对深度伪造检测模型性能受实现细节影响大的问题，系统研究了训练、推理和增量更新中的设计选择。通过隔离变量实验，识别出提升检测效果与泛化能力的关键因素，提出了一套不依赖特定架构的优化实践，助力构建更高效可靠的检测系统。**
...
>
---
#### [new 012] Merge and Bound: Direct Manipulations on Weights for Class Incremental Learning
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对类增量学习（CIL）中的灾难性遗忘问题，提出直接在参数空间操作权重的Merge-and-Bound（M&B）方法。通过任务间与任务内权重融合，并结合有界更新策略，实现对旧知识的有效保留与新任务的高效学习，无需修改网络结构或损失函数，显著提升性能。**
...
>
---
#### [new 013] G$^2$VLM: Geometry Grounded Vision Language Model with Unified 3D Reconstruction and Spatial Reasoning
...
>
---
#### [new 014] CaliTex: Geometry-Calibrated Attention for View-Coherent 3D Texture Generation
- **分类: cs.CV**

- **简介: 该论文针对3D纹理生成中的视图不一致问题，提出CaliTex框架。通过几何校准注意力机制，引入部件对齐与条件路由模块，强化几何结构与外观的耦合，实现视图一致的3D纹理生成。**
...
>
---
#### [new 015] CANVAS: A Benchmark for Vision-Language Models on Tool-Based User Interface Design
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 016] E-M3RF: An Equivariant Multimodal 3D Re-assembly Framework
- **分类: cs.CV**

- **简介: 该论文针对3D碎片重装任务，解决几何信息不足时的装配难题及物理重叠问题。提出E-M3RF框架，融合点云位置与颜色的多模态特征，利用旋转等变编码和SE(3)流匹配，实现更精准的变换预测，在真实数据集上显著降低误差。**
...
>
---
#### [new 017] Smooth regularization for efficient video recognition
- **分类: cs.CV**

- **简介: 该论文针对视频识别任务，解决轻量级模型难以捕捉复杂时序动态的问题。提出基于高斯随机游走的平滑正则化方法，强制连续帧间特征表示平滑过渡，增强时间归纳偏置，显著提升模型性能，在Kinetics-600上实现3.8%~6.4%准确率提升。**
...
>
---
#### [new 018] UruDendro4: A Benchmark Dataset for Automatic Tree-Ring Detection in Cross-Section Images of Pinus taeda L
- **分类: cs.CV**

- **简介: 该论文针对树轮自动检测任务，解决人工测量耗时且不精确的问题。构建了UruDendro4数据集，包含102张湿地松横截面图像及多高度标注的年轮信息，支持体积化木材生长建模，并提供深度学习基准，验证了模型泛化能力。**
...
>
---
#### [new 019] CLRecogEye : Curriculum Learning towards exploiting convolution features for Dynamic Iris Recognition
- **分类: cs.CV**

- **简介: 该论文针对动态虹膜识别中因旋转、缩放、反光和模糊导致的鲁棒性不足问题，提出基于课程学习的CLRecogEye框架。通过将虹膜图像沿一维分割为序列输入3D-CNN，捕捉时空特征，并采用课程学习与三元组+ArcFace损失联合训练，增强特征判别力，提升识别性能。**
...
>
---
#### [new 020] MetaRank: Task-Aware Metric Selection for Model Transferability Estimation
- **分类: cs.CV**

- **简介: 该论文针对迁移学习中模型可迁移性评估（MTE）指标选择困难的问题，提出MetaRank框架。通过文本描述编码数据集与指标，利用元学习建立任务感知的自动选优机制，以提升指标选择效率与准确性。**
...
>
---
#### [new 021] The More, the Merrier: Contrastive Fusion for Higher-Order Multimodal Alignment
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对多模态学习中高阶交互建模不足的问题，提出对比融合（ConFu）框架。通过联合对齐单模态与融合模态，扩展对比学习目标，同时捕捉高阶依赖与成对对应关系。在合成与真实数据上验证了其在检索与分类任务中的有效性，支持统一的多种检索模式。**
...
>
---
#### [new 022] Endo-G$^{2}$T: Geometry-Guided & Temporally Aware Time-Embedded 4DGS For Endoscopic Scenes
- **分类: cs.CV**

- **简介: 该论文针对内窥镜视频重建任务，解决纯光度监督导致几何漂移的问题。提出Endo-G²T，通过几何引导先验蒸馏、时间嵌入的高斯场建模和关键帧约束流式优化，实现早期几何锚定、时序一致性与高效重建，在单目内窥镜场景下达到先进性能。**
...
>
---
#### [new 023] Hybrid SIFT-SNN for Efficient Anomaly Detection of Traffic Flow-Control Infrastructure
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出SIFT-SNN框架，用于交通基础设施的实时异常检测任务。针对传统CNN在边缘部署中高延迟、低可解释性问题，融合SIFT与脉冲神经网络，实现低延迟（9.5ms/帧）、高精度（92.3%）的结构异常识别，支持透明决策与低功耗部署。**
...
>
---
#### [new 024] MODEST: Multi-Optics Depth-of-Field Stereo Dataset
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **简介: 该论文提出MODEST数据集，解决真实光学条件下深度估计缺乏高质量实拍数据的问题。针对立体视觉任务，构建了高分辨率、多光学校准的实拍DSLRA数据集，涵盖复杂场景与全范围光学参数，支持深度估计、3D重建等任务，推动模型在真实世界中的泛化能力。**
...
>
---
#### [new 025] Video Generation Models Are Good Latent Reward Models
- **分类: cs.CV**

- **简介: 该论文研究视频生成中的偏好对齐任务，针对现有方法依赖像素空间、效率低且缺乏早期监督的问题，提出在潜空间进行奖励反馈学习（PRFL）。通过利用预训练视频模型的潜空间建模能力，实现全程高效梯度传播，显著提升对齐效果，降低内存与训练时间。**
...
>
---
#### [new 026] Privacy-Preserving Federated Vision Transformer Learning Leveraging Lightweight Homomorphic Encryption in Medical AI
- **分类: cs.CV; cs.CR**

- **简介: 该论文针对医疗影像协作建模中的隐私问题，提出一种基于轻量级同态加密的联邦视觉变压器框架。通过加密ViT的CLS token实现安全聚合，解决模型梯度泄露风险，显著降低通信开销并保障隐私，同时支持密文推理，兼顾安全性与效率。**
...
>
---
#### [new 027] Intriguing Properties of Dynamic Sampling Networks
- **分类: cs.CV**

- **简介: 该论文研究动态采样网络的理论机制，针对其缺乏统一分析的问题，提出“扭曲”算子统一现有方法。通过统计分析与实证研究，揭示其前向/反向传递的不对称性及非平移不变特性，明确稳定训练条件，并提出基于梯度更新的损失景观可视化新方法。**
...
>
---
#### [new 028] TEAR: Temporal-aware Automated Red-teaming for Text-to-Video Models
- **分类: cs.CV**

- **简介: 该论文针对文本生成视频（T2V）模型的安全风险，提出TEAR框架，解决静态评估方法无法捕捉视频时序动态的问题。通过时序感知的自动化红队测试，生成隐蔽且具攻击性的提示词，有效触发违规视频输出，实验显示攻击成功率超80%，显著优于此前57%的最优水平。**
...
>
---
#### [new 029] EvRainDrop: HyperGraph-guided Completion for Effective Frame and Event Stream Aggregation
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对事件相机数据空间稀疏导致的欠采样问题，提出EvRainDrop框架。通过超图建模跨时空事件关联，利用上下文消息传递完成事件补全，并融合RGB信息实现多模态特征学习与聚合，有效提升事件流表示能力。**
...
>
---
#### [new 030] From Diffusion to One-Step Generation: A Comparative Study of Flow-Based Models with Application to Image Inpainting
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究生成模型在图像修复中的应用，对比了扩散模型、流匹配与均值流三类方法。针对传统迭代采样效率低的问题，提出基于均值流的一步生成方法，显著提升速度；并改进条件流匹配用于图像修复，通过掩码引导实现高效高质修复。**
...
>
---
#### [new 031] One Patch is All You Need: Joint Surface Material Reconstruction and Classification from Minimal Visual Cues
- **分类: cs.CV**

- **简介: 该论文提出SMARC模型，解决从极少量视觉线索（单个10%图像块）中联合重建完整表面材质并分类材料类别的问题。针对现有方法依赖密集观测的局限，采用部分卷积U-Net结合分类头，实现稀疏输入下的空间补全与语义理解，在真实纹理数据集上达到先进性能。**
...
>
---
#### [new 032] Multi-Crit: Benchmarking Multimodal Judges on Pluralistic Criteria-Following
- **分类: cs.CV**

- **简介: 该论文提出Multi-Crit基准，用于评估多模态大模型在遵循多样、细粒度评价标准方面的能力。针对现有模型在复杂评判任务中一致性与灵活性不足的问题，构建了包含人类标注的挑战性数据集，并设计新指标，分析25个模型表现，揭示其在开放生成与推理任务中的局限性，推动可信赖、可调控的多模态评估发展。**
...
>
---
#### [new 033] Efficient Training for Human Video Generation with Entropy-Guided Prioritized Progressive Learning
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对高分辨率人体视频生成中扩散模型训练成本高的问题，提出熵引导的优先渐进学习框架（Ent-Prog）。通过条件熵膨胀评估组件重要性，实现关键组件优先训练，并设计自适应渐进调度策略，显著降低训练时间与显存占用，提升训练效率。**
...
>
---
#### [new 034] Deep Learning-Based Multiclass Classification of Oral Lesions with Stratified Augmentation
- **分类: cs.CV**

- **简介: 该论文属于多类分类任务，旨在解决口腔病变早期诊断中因数据有限且不平衡导致的分类难题。通过结合分层数据分割与增强、过采样技术，构建深度学习模型，实现16类口腔病变的准确分类，提升了少数类别识别性能，为临床辅助诊断系统提供可行方案。**
...
>
---
#### [new 035] EoS-FM: Can an Ensemble of Specialist Models act as a Generalist Feature Extractor?
- **分类: cs.CV**

- **简介: 该论文针对遥感领域基础模型训练资源消耗大的问题，提出EoS-FM框架。通过构建轻量级任务专用模型的集成，实现高效、可解释且可扩展的特征提取。该方法支持联邦学习与持续集成，降低计算成本，推动可持续遥感AI发展。**
...
>
---
#### [new 036] MUSE: Manipulating Unified Framework for Synthesizing Emotions in Images via Test-Time Optimization
- **分类: cs.CV**

- **简介: 该论文提出MUSE，首个统一的图像情感合成框架，解决生成与编辑分离导致的效率低、应用受限问题。通过测试时优化，利用预训练情绪分类器和语义相似性指导，实现稳定的情感引导与多情感平衡，提升情感准确性与内容真实性，推动图像情感合成新范式。**
...
>
---
#### [new 037] Active Learning for GCN-based Action Recognition
- **分类: cs.CV**

- **简介: 该论文针对骨架动作识别中标签数据稀缺问题，提出一种高效的主动学习方法。通过对抗式选择策略优化样本筛选，并设计双向稳定GCN架构，提升模型对标注数据的利用效率，在两个基准上显著优于现有方法。**
...
>
---
#### [new 038] LongVT: Incentivizing "Thinking with Long Videos" via Native Tool Calling
- **分类: cs.CV**

- **简介: 该论文针对长视频理解中因证据稀疏导致的幻觉问题，提出LongVT框架，通过“全局-局部”推理循环与多模态工具思维，利用大模型自有的时间定位能力实现视频裁剪与细粒度分析。构建VideoSIAH数据集支持训练与评估，显著提升长视频问答准确性。**
...
>
---
#### [new 039] Wavefront-Constrained Passive Obscured Object Detection
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对远场模糊光场中被遮挡物体的检测难题，提出物理驱动的WavePCNet模型。通过复振幅传播约束与动量记忆机制，提升相干光传播模拟精度，抑制噪声扰动，并引入高频跨层补偿增强结构一致性，显著提升检测准确率与鲁棒性。**
...
>
---
#### [new 040] Qwen3-VL Technical Report
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Qwen3-VL，一个强大的多模态模型，解决长文本与多模态内容理解难题。通过增强的时空建模、深度视觉-语言对齐及文本时间对齐，实现256K令牌长上下文处理，在图像、视频与文本联合推理任务中表现领先。**
...
>
---
#### [new 041] Scaling Foundation Models for Radar Scene Understanding
- **分类: cs.CV**

- **简介: 该论文针对雷达场景理解中模型碎片化、难迁移的问题，提出RadarFM雷达基础模型。通过结构化语义标注与哈希感知对比学习，实现统一的场景表征，提升跨任务泛化能力，并在CARLA仿真环境中构建大规模数据集，引入定位感知评估指标。**
...
>
---
#### [new 042] LaGen: Towards Autoregressive LiDAR Scene Generation
- **分类: cs.CV**

- **简介: 该论文提出LaGen，首个支持长时序交互式生成的自回归LiDAR场景生成框架。针对现有方法无法实现帧间交互与长期生成的问题，提出基于单帧输入的逐帧生成机制，结合边界框条件与场景解耦、噪声调制模块，提升生成质量与稳定性。在nuScenes数据集上验证了其优越性。**
...
>
---
#### [new 043] Revolutionizing Glioma Segmentation & Grading Using 3D MRI - Guided Hybrid Deep Learning Models
- **分类: cs.CV**

- **简介: 该论文针对胶质瘤的精准诊断与分级问题，提出一种基于3D MRI的混合深度学习框架。结合U-Net分割与注意力增强的DenseNet-VGG分类网络，通过多头及空间-通道注意力机制，实现高精度肿瘤分割（Dice 98%）与分类（准确率99%），显著提升诊断效率与可解释性。**
...
>
---
#### [new 044] GuardTrace-VL: Detecting Unsafe Multimodel Reasoning via Iterative Safety Supervision
- **分类: cs.CV; cs.AI; cs.CR**

- **简介: 该论文针对多模态大模型推理中中间过程存在安全隐患的问题，提出GuardTrace-VL，通过联合图文分析监控全链条推理过程。构建了高质量标注数据集，设计三阶段训练策略，显著提升对隐蔽风险的检测能力，F1达93.1%，优于现有方法。**
...
>
---
#### [new 045] Revisiting KRISP: A Lightweight Reproduction and Analysis of Knowledge-Enhanced Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对知识增强视觉问答（VQA）模型计算开销大、难以部署的问题，复现并轻量化了KRISP模型。通过减少参数量，提升在边缘设备上的可行性，验证了知识图谱约束对抑制AI幻觉的有效性，并揭示了原模型的设计缺陷与实际应用挑战。**
...
>
---
#### [new 046] Harmony: Harmonizing Audio and Video Generation through Cross-Task Synergy
- **分类: cs.CV**

- **简介: 该论文针对生成式AI中音视频同步难题，提出Harmony框架。通过跨任务协同训练缓解对应漂移，设计全局-局部解耦模块增强时序对齐，引入SyncCFG显式强化同步信号，显著提升音视频生成的精确同步与质量。**
...
>
---
#### [new 047] PG-ControlNet: A Physics-Guided ControlNet for Generative Spatially Varying Image Deblurring
- **分类: cs.CV**

- **简介: 该论文针对空间变化图像去模糊任务，解决复杂退化下物理准确与感知真实性的矛盾。提出PG-ControlNet，通过建模密集高维退化核场，以物理约束引导生成过程，有效融合模型与生成优势，在严重模糊场景中实现更精准且自然的去模糊效果。**
...
>
---
#### [new 048] 3-Tracer: A Tri-level Temporal-Aware Framework for Audio Forgery Detection and Localization
- **分类: cs.CV**

- **简介: 该论文针对部分音频伪造检测任务，解决现有方法难以捕捉跨时序层级异常的问题。提出T3-Tracer框架，通过帧、段、音频三级时序感知，融合帧级与全局特征，结合双分支多尺度模块，精准定位伪造边界，实现更全面的伪造检测。**
...
>
---
#### [new 049] Structure-Aware Prototype Guided Trusted Multi-View Classification
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对可信多视图分类（TMVC）任务，解决现有方法因依赖全局邻近关系导致计算成本高、跨视图一致性难保证的问题。提出基于结构感知原型的框架，通过原型简化视图内邻接关系学习，动态对齐视图间结构，提升分类一致性与效率。**
...
>
---
#### [new 050] Enhanced Landmark Detection Model in Pelvic Fluoroscopy using 2D/3D Registration Loss
- **分类: cs.CV**

- **简介: 该论文针对骨盆荧光透视中因患者体位变化导致的地标检测精度下降问题，提出一种融合2D/3D注册损失的U-Net模型。通过引入注册损失优化训练，提升模型在非标准视角下的地标检测鲁棒性，解决实际手术中体位可变带来的挑战。**
...
>
---
#### [new 051] CaFlow: Enhancing Long-Term Action Quality Assessment with Causal Counterfactual Flow
- **分类: cs.CV**

- **简介: 该论文针对长期动作质量评估（Long-term AQA）任务，解决现有方法依赖昂贵标注、易受混淆因素干扰的问题。提出CaFlow框架，通过因果反事实正则化模块分离因果与混淆特征，并结合双向时序流模型实现更稳定、连贯的长期动作表示，显著提升评估性能。**
...
>
---
#### [new 052] Inversion-Free Style Transfer with Dual Rectified Flows
- **分类: cs.CV**

- **简介: 该论文针对风格迁移任务，解决现有方法依赖耗时且易出错的反演过程的问题。提出无反演风格迁移框架，基于双修正流，仅通过前向传播并行预测内容与风格轨迹，动态融合生成高质量图像，提升效率与视觉保真度。**
...
>
---
#### [new 053] TrafficLens: Multi-Camera Traffic Video Analysis Using LLMs
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 054] LungNoduleAgent: A Collaborative Multi-Agent System for Precision Diagnosis of Lung Nodules
- **分类: cs.CV**

- **简介: 该论文针对肺结节精准诊断任务，解决现有模型在形态描述与医学知识融合上的不足。提出LungNoduleAgent多智能体系统，通过检测、报告生成与恶性度推理三模块协同，实现区域语义对齐与临床推理，显著提升诊断精度。**
...
>
---
#### [new 055] MoGAN: Improving Motion Quality in Video Diffusion via Few-Step Motion Adversarial Post-Training
- **分类: cs.CV**

- **简介: 该论文针对视频生成中运动不连贯、失真等问题，提出MoGAN框架。基于三步蒸馏视频扩散模型，通过光流判别器与分布匹配正则化，实现无需奖励模型的运动质量优化，显著提升运动真实感，同时保持视觉质量与生成效率。**
...
>
---
#### [new 056] BotaCLIP: Contrastive Learning for Botany-Aware Representation of Earth Observation Data
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出BotaCLIP，一种轻量级多模态对比学习框架，用于将植物学知识注入地球观测基础模型。针对数据稀缺下领域知识融入难题，通过高分辨率航拍图与植物样方数据对齐，实现生态结构建模，提升生物多样性预测等任务性能。**
...
>
---
#### [new 057] Canvas-to-Image: Compositional Image Generation with Multimodal Controls
- **分类: cs.CV**

- **简介: 该论文提出Canvas-to-Image框架，解决扩散模型在多模态控制下（如文本、姿态、布局）的高保真图像生成问题。通过将异构控制信号编码为统一画布，实现端到端的视觉-空间联合推理，显著提升身份保留与控制遵循能力。**
...
>
---
#### [new 058] Unsupervised Memorability Modeling from Tip-of-the-Tongue Retrieval Queries
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 059] CaptionQA: Is Your Caption as Useful as the Image Itself?
- **分类: cs.CV**

- **简介: 该论文提出CaptionQA，一个用于评估图像描述在下游任务中实用性的基准。针对现有评价忽略描述是否可替代图像的问题，构建跨4个领域的细粒度问答数据集，通过LLM仅用描述回答问题来衡量其信息保真度。实验揭示主流多模态模型在描述实用性上存在显著差距。**
...
>
---
#### [new 060] Referring Video Object Segmentation with Cross-Modality Proxy Queries
- **分类: cs.CV**

- **简介: 该论文研究指代视频目标分割（RVOS）任务，旨在根据文本描述精准定位视频中的目标对象。针对现有方法在跨模态对齐中缺乏帧间依赖与文本约束滞后的问题，提出ProxyFormer架构，通过动态更新的代理查询融合视觉与文本语义，实现跨模态协同与帧间一致性建模，提升分割精度与跟踪稳定性。**
...
>
---
#### [new 061] The Age-specific Alzheimer 's Disease Prediction with Characteristic Constraints in Nonuniform Time Span
- **分类: cs.CV**

- **简介: 该论文针对阿尔茨海默病在非均匀时间间隔下的预测难题，提出一种基于定量指标与年龄缩放的序列图像生成方法。通过引入年龄尺度像素损失，提升MRI图像生成质量，增强疾病进展特征表征，实现更精准的年龄特异性预测。**
...
>
---
#### [new 062] SPHINX: A Synthetic Environment for Visual Perception and Reasoning
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出SPHINX，一个用于视觉感知与推理的合成环境，解决多模态推理能力评估难题。通过程序化生成含真实答案的谜题，覆盖25类任务，评估大模型表现并验证强化学习结合可验证奖励能显著提升推理性能。**
...
>
---
#### [new 063] PFF-Net: Patch Feature Fitting for Point Cloud Normal Estimation
- **分类: cs.CV**

- **简介: 该论文针对点云法向估计任务，解决局部邻域尺寸选择困难的问题。提出PFF-Net，通过多尺度特征融合与跨尺度补偿，实现自适应的局部几何描述，提升法向估计精度与效率。**
...
>
---
#### [new 064] Open Vocabulary Compositional Explanations for Neuron Alignment
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对神经元解释中概念受限问题，提出一种开放词汇的组合解释框架。通过开放词汇语义分割生成掩码，实现对任意概念和数据集的神经元激活解释，提升解释灵活性与可扩展性。**
...
>
---
#### [new 065] Towards an Effective Action-Region Tracking Framework for Fine-grained Video Action Recognition
- **分类: cs.CV**

- **简介: 该论文针对细粒度视频动作识别任务，解决现有方法难以捕捉局部细微动态变化的问题。提出基于查询-响应机制的行动区域追踪（ART）框架，通过语义约束查询定位关键区域，构建时序连贯的动作轨迹，并设计多层级对比损失与任务微调机制，有效区分相似动作。**
...
>
---
#### [new 066] Estimating Fog Parameters from a Sequence of Stereo Images
- **分类: cs.CV**

- **简介: 该论文针对雾天视觉感知中雾参数估计不准确的问题，提出一种基于立体图像序列的雾参数联合优化估计算法。通过假设雾局部均匀，有效处理全局非均匀雾，实现参数动态更新。构建了首个含相机标定与清晰对比数据的实时雾天立体数据集SDIRF，验证了方法在真实场景下的优越性。**
...
>
---
#### [new 067] MobileI2V: Fast and High-Resolution Image-to-Video on Mobile Devices
- **分类: cs.CV**

- **简介: 该论文针对移动设备上图像到视频（I2V）生成速度慢、计算复杂的问题，提出轻量级模型MobileI2V。通过线性混合去噪器、两步采样蒸馏策略及移动端注意力优化，实现720p视频实时生成，单帧生成时间小于100ms，显著提升效率与实用性。**
...
>
---
#### [new 068] EM-KD: Distilling Efficient Multimodal Large Language Model with Unbalanced Vision Tokens
- **分类: cs.CV**

- **简介: 该论文针对高效多模态大模型因压缩视觉令牌导致的视觉理解能力下降问题，提出EM-KD框架。通过匈牙利匹配对齐不平衡视觉令牌，引入视觉-语言亲和性与视觉语义蒸馏策略，提升学生模型性能。实验表明，该方法在准确率与效率上均显著优于现有方法。**
...
>
---
#### [new 069] Video Object Recognition in Mobile Edge Networks: Local Tracking or Edge Detection?
- **分类: cs.CV; eess.IV**

- **简介: 该论文研究移动边缘网络中视频目标识别任务，针对资源受限设备的实时识别难题，提出自适应选择本地跟踪与边缘检测的策略。通过深度强化学习与联邦学习，优化单/多设备场景下的延迟与准确率平衡，实验验证了方法的有效性。**
...
>
---
#### [new 070] RefTr: Recurrent Refinement of Confluent Trajectories for 3D Vascular Tree Centerline Graphs
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对3D血管树中心线生成任务，解决传统方法召回率低、拓扑错误问题。提出RefTr模型，采用递归精炼的生产者-精炼器架构，通过共轭轨迹表示与高效非极大抑制，提升召回率与精度，显著减少参数量并加快推理速度。**
...
>
---
#### [new 071] Frequency-Aware Token Reduction for Efficient Vision Transformer
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对视觉Transformer计算复杂度高的问题，提出一种频率感知的令牌压缩方法。通过区分高频与低频令牌，保留高频信息并聚合低频信息为直流令牌，有效降低计算量，缓解秩坍缩与过平滑问题，提升模型效率与性能。**
...
>
---
#### [new 072] Long-Term Alzheimers Disease Prediction: A Novel Image Generation Method Using Temporal Parameter Estimation with Normal Inverse Gamma Distribution on Uneven Time Series
- **分类: cs.CV**

- **简介: 该论文针对阿尔茨海默病（AD）长期预测中因时间间隔不规则导致图像生成失真的问题，提出基于正态逆高斯分布的时序参数估计模型T-NIG。通过引入时间参数与不确定性建模，提升不规则时序脑影像生成的准确性与疾病特征保持能力，实现更可靠的短期与长期疾病进展预测。**
...
>
---
#### [new 073] Seeing without Pixels: Perception from Camera Trajectories
- **分类: cs.CV**

- **简介: 该论文研究视频内容感知任务，旨在解决仅通过相机轨迹（而非像素）识别视频内容的问题。提出CamFormer模型，利用对比学习将相机姿态轨迹映射到与自然语言对齐的嵌入空间，证明轨迹蕴含丰富语义信息，可实现跨模态对齐、分类与时间分析，且对不同姿态估计方法具有鲁棒性。**
...
>
---
#### [new 074] Foundry: Distilling 3D Foundation Models for the Edge
- **分类: cs.CV; cs.AI; cs.LG; cs.NE**

- **简介: 该论文针对大尺寸3D基础模型难以在边缘设备部署的问题，提出FMD范式与Foundry方法。通过训练学生模型学习教师模型的超令牌表示，实现高效压缩，保留模型通用性。可在分类、分割等任务上接近原模型性能，显著降低计算开销，适用于资源受限硬件。**
...
>
---
#### [new 075] BUSTR: Breast Ultrasound Text Reporting with a Descriptor-Aware Vision-Language Model
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出BUSTR，一种无需配对图像-报告数据的乳腺超声文本报告生成框架。针对缺乏标注数据和大模型幻觉问题，通过描述符感知视觉-语言建模，结合结构化描述符与影像特征，利用多任务损失和双层对齐目标生成报告，显著提升报告质量和临床有效性。**
...
>
---
#### [new 076] Self-Paced Learning for Images of Antinuclear Antibodies
- **分类: cs.CV**

- **简介: 该论文针对抗核抗体（ANA）检测中的多实例多标签学习（MIML）难题，提出一种自适应自定进度学习框架。通过实例采样、概率伪标签分发与自定进度权重学习，实现无需预处理的端到端训练，显著提升检测精度，在公开数据集上大幅优于现有方法。**
...
>
---
#### [new 077] Thinking With Bounding Boxes: Enhancing Spatio-Temporal Video Grounding via Reinforcement Fine-Tuning
- **分类: cs.CV**

- **简介: 该论文针对多模态大模型在时空视频定位任务中表现不佳的问题，提出STVG-o1框架。通过引入边界框思维链和多维强化奖励机制，增强模型对时空位置的细粒度推理能力，无需修改架构即实现顶尖性能，显著提升定位精度与跨数据集泛化能力。**
...
>
---
#### [new 078] Training-Free Diffusion Priors for Text-to-Image Generation via Optimization-based Visual Inversion
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [new 079] CameraMaster: Unified Camera Semantic-Parameter Control for Photography Retouching
- **分类: cs.CV**

- **简介: 该论文针对图像调色中物理一致性与精确参数控制难题，提出CameraMaster框架。通过解耦拍摄意图与相机参数，联合建模指令与参数嵌入，实现统一、可扩展的参数化图像调色，支持多参数组合与敏感响应，显著提升编辑精度与一致性。**
...
>
---
#### [new 080] Inferix: A Block-Diffusion based Next-Generation Inference Engine for World Simulation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Inferix，一个基于块扩散（block-diffusion）的下一代推理引擎，用于世界模拟。针对现有视频生成模型在长序列、高保真与交互性上的不足，通过优化半自回归解码、引入KV缓存与实时流式传输，实现高效、可变长度、高质量的沉浸式视频生成，并集成细粒度评估基准，推动世界模型发展。**
...
>
---
#### [new 081] Multimodal Robust Prompt Distillation for 3D Point Cloud Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对3D点云模型的对抗攻击问题，提出多模态鲁棒提示蒸馏框架MRPD。通过融合视觉、3D和文本模态的稳健特征，实现高效知识迁移，在不增加推理开销的前提下，显著提升模型在多种攻击下的鲁棒性与干净数据表现。**
...
>
---
#### [new 082] Beyond Realism: Learning the Art of Expressive Composition with StickerNet
- **分类: cs.CV**

- **简介: 该论文提出“表达性图像合成”任务，针对非现实主义、注重艺术与社交吸引力的用户创作需求。提出StickerNet框架，基于180万真实平台编辑行为数据，学习用户意图下的贴纸布局（位置、尺度、透明度等），实现更符合人类创作习惯的表达性合成，超越传统以真实感为目标的图像合成方法。**
...
>
---
#### [new 083] RefOnce: Distilling References into a Prototype Memory for Referring Camouflaged Object Detection
- **分类: cs.CV**

- **简介: 该论文针对参照式伪装目标检测（Ref-COD）任务，解决测试时需依赖参考图像导致的部署困难与延迟问题。提出RefOnce框架，通过训练阶段将参考信息压缩为类别原型记忆，并在推理时基于查询条件合成参考向量，实现无需测试时参考图像的高效检测。**
...
>
---
#### [new 084] CtrlVDiff: Controllable Video Generation via Unified Multimodal Video Diffusion
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出CtrlVDiff，一个统一的可控视频生成框架，解决视频理解与生成中控制不精准、时序不一致的问题。通过融合深度、法向、语义分割等多模态线索，实现对光照、材质等细节的精确控制，并构建MMVideo数据集支持训练。模型可处理缺失模态，保持强时序一致性，显著提升生成质量与可控性。**
...
>
---
#### [new 085] From Inpainting to Layer Decomposition: Repurposing Generative Inpainting Models for Image Layer Decomposition
- **分类: cs.CV**

- **简介: 该论文将生成式图像修复模型用于图像层分解任务，解决单图分层难的问题。通过轻量微调扩散模型，并引入线性注意力多模态融合模块，在合成数据上实现高效细节保留，提升物体移除与遮挡恢复效果，推动图像独立编辑应用。**
...
>
---
#### [new 086] DeepRFTv2: Kernel-level Learning for Image Deblurring
- **分类: cs.CV**

- **简介: 该论文针对图像去模糊任务，解决现有深度网络仅在像素级学习、无法理解模糊本质的问题。提出傅里叶核估计器（FKE），在频域实现核级模糊过程学习，结合特征与估计核的卷积，提升去模糊性能。设计解耦多尺度架构，高效提取多尺度特征，实现低内存训练。**
...
>
---
#### [new 087] Co-Training Vision Language Models for Remote Sensing Multi-task Learning
- **分类: cs.CV**

- **简介: 该论文提出RSCoVLM，面向遥感多任务学习，解决统一模型跨任务性能不足问题。通过构建数据引擎、动态分辨率策略及Zoom-in Chain机制，提升模型在多尺度遥感图像上的理解与检测能力，实现端到端高效训练与评估。**
...
>
---
#### [new 088] When Robots Obey the Patch: Universal Transferable Patch Attacks on Vision-Language-Action Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视觉-语言-动作（VLA）模型的通用可转移对抗补丁攻击。针对现有攻击多针对单一模型、缺乏跨模型泛化的问题，提出UPA-RFAS框架，通过共享特征空间优化物理补丁，结合特征、注意力与语义损失，实现对未知架构、微调模型及仿真到现实迁移场景的强泛化攻击，揭示了实际应用中的安全风险。**
...
>
---
#### [new 089] Pygmalion Effect in Vision: Image-to-Clay Translation for Reflective Geometry Reconstruction
- **分类: cs.CV; cs.AI; cs.GR**

- **简介: 该论文针对反射导致的3D重建难题，提出“视觉中的皮格马利翁效应”框架。通过图像到陶土状图像的翻译，抑制镜面反射，保留几何一致性。设计双分支网络联合训练，利用无反射的陶土图像作为监督信号，显著提升表面法向和网格完整性，实现更鲁棒的反射物体三维重建。**
...
>
---
#### [new 090] HTTM: Head-wise Temporal Token Merging for Faster VGGT
- **分类: cs.CV**

- **简介: 该论文针对3D场景重建中VGGT模型因全局注意力导致的高延迟问题，提出无需训练的头级时序令牌合并方法HTTM。通过在多头粒度上融合令牌，保留特征唯一性并利用头级别空间与时间对应关系，实现高达7倍加速，同时保持性能稳定。**
...
>
---
#### [new 091] V$^{2}$-SAM: Marrying SAM2 with Multi-Prompt Experts for Cross-View Object Correspondence
- **分类: cs.CV**

- **简介: 该论文针对跨视角物体对应任务，解决因视角和外观差异导致的匹配难题。提出V²-SAM框架，融合DINOv3特征的坐标提示与视觉提示，通过多专家设计与后处理循环一致性选择，实现精准跨视角物体对应，在多个数据集上达到新最优性能。**
...
>
---
#### [new 092] Shift-Equivariant Complex-Valued Convolutional Neural Networks
- **分类: cs.CV**

- **简介: 该论文研究复杂值卷积神经网络的平移等变性问题。针对传统CNN因下采样/上采样破坏平移等变性与不变性的缺陷，提出基于LPS的扩展方法，并引入复数到实数的投影层与Gumbel Softmax，实现理论保障的等变/不变性。在极化SAR图像的分类、重建与语义分割任务中验证有效性。**
...
>
---
#### [new 093] AnchorOPT: Towards Optimizing Dynamic Anchors for Adaptive Prompt Learning
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 094] LLaVA-UHD v3: Progressive Visual Compression for Efficient Native-Resolution Encoding in MLLMs
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对多模态大模型（MLLMs）中高分辨率视觉编码带来的计算开销问题，提出基于渐进式视觉压缩（PVC）的高效原生分辨率编码方法。通过优化嵌入与分层令牌压缩，实现低延迟、高性能的视觉建模，显著降低首令牌时间（TTFT），并提升模型效率。**
...
>
---
#### [new 095] Layer-Aware Video Composition via Split-then-Merge
- **分类: cs.CV**

- **简介: 该论文提出Split-then-Merge（StM）框架，用于增强生成视频的可控性并解决数据稀缺问题。通过无标注视频自动分离前景与背景层，自动生成合成视频以学习动态交互，结合多层融合与身份保持损失，实现更真实的视频组合。**
...
>
---
#### [new 096] You Can Trust Your Clustering Model: A Parameter-free Self-Boosting Plug-in for Deep Clustering
- **分类: cs.CV**

- **简介: 该论文针对深度聚类中全局特征结构分离度差的问题，提出无需参数的DCBoost方法。通过自适应局部一致性筛选高置信样本，构建判别损失以增强类间分离与类内紧凑，提升现有模型性能。**
...
>
---
#### [new 097] AVFakeBench: A Comprehensive Audio-Video Forgery Detection Benchmark for AV-LMMs
- **分类: cs.CV**

- **简介: 该论文针对音视频伪造检测任务，解决现有基准数据集类型单一、标注粒度粗的问题。提出AVFakeBench，涵盖12K多类型、多粒度标注的音视频伪造样本，构建了包含四类任务的评估框架，并验证了AV-LMMs在检测中的潜力与局限。**
...
>
---
#### [new 098] FlowerDance: MeanFlow for Efficient and Refined 3D Dance Generation
- **分类: cs.CV**

- **简介: 该论文聚焦音乐到舞蹈生成任务，旨在提升3D舞蹈生成的效率与质量。针对现有方法生成慢、内存占用高的问题，提出FlowerDance，结合MeanFlow与物理约束，实现高效非自回归生成，并支持交互式编辑，显著提升推理速度与运动质量。**
...
>
---
#### [new 099] SurgMLLMBench: A Multimodal Large Language Model Benchmark Dataset for Surgical Scene Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对手术场景理解中多模态大模型评估缺乏统一基准的问题，提出SurgMLLMBench基准数据集。它整合了腹腔镜、机器人辅助和显微手术的像素级分割与结构化VQA标注，支持跨域通用性评估。通过新构建的MAVIS数据集和统一标签体系，推动交互式多模态手术AI模型的研发与可复现评估。**
...
>
---
#### [new 100] Monet: Reasoning in Latent Visual Space Beyond Images and Language
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Monet框架，解决多模态大模型在视觉隐空间中抽象推理能力不足的问题。通过三阶段监督微调与视觉隐空间强化学习（VLPO），实现基于连续嵌入的中间视觉思维，提升模型在真实世界和抽象视觉任务中的推理能力。**
...
>
---
#### [new 101] UAVLight: A Benchmark for Illumination-Robust 3D Reconstruction in Unmanned Aerial Vehicle (UAV) Scenes
- **分类: cs.CV**

- **简介: 该论文提出UAVLight，一个用于无人机场景下光照鲁棒三维重建的基准数据集。针对光照变化导致的几何漂移、颜色不一致等问题，通过在固定飞行路径上多时次采集，实现光照变化下的几何一致性。建立了标准化评估协议，为鲁棒重建方法提供可靠测试平台。**
...
>
---
#### [new 102] Text-Guided Semantic Image Encoder
- **分类: cs.CV**

- **简介: 该论文提出Text-Guided Semantic Image Encoder（TIE），用于视觉-语言模型中。针对传统图像编码器忽视文本查询的问题，TIE使图像表示生成过程受文本条件引导，提升任务相关性与效率。在多个图文任务上表现更优，且减少图像块使用量，增强可解释性。**
...
>
---
#### [new 103] ReSAM: Refine, Requery, and Reinforce: Self-Prompting Point-Supervised Segmentation for Remote Sensing Images
- **分类: cs.CV**

- **简介: 该论文针对遥感图像分割中领域偏差大、密集标注稀缺的问题，提出一种自提示点监督分割框架ReSAM。通过“精炼-重查询-强化”循环，仅用稀疏点标注即可提升SAM在遥感图像上的性能，实现高效、可扩展的模型适应。**
...
>
---
#### [new 104] GaINeR: Geometry-Aware Implicit Network Representation
- **分类: cs.CV**

- **简介: 该论文提出GaINeR，一种面向2D图像的几何感知隐式网络表示方法。针对传统隐式神经表示缺乏显式几何结构、难以实现局部编辑与物理模拟的问题，引入可学习高斯分布，通过最近邻高斯加权聚合嵌入，实现连续表示、可解释几何结构及灵活编辑，支持物理感知与交互式图像操作。**
...
>
---
#### [new 105] Unlocking Zero-shot Potential of Semi-dense Image Matching via Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文针对图像匹配任务中缺乏高质量训练数据的问题，提出MatchGS框架。通过几何修正的3DGS数据生成与2D-3D表示对齐，实现高精度零样本图像匹配，显著提升匹配性能。**
...
>
---
#### [new 106] $Δ$-NeRF: Incremental Refinement of Neural Radiance Fields through Residual Control and Knowledge Transfer
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对NeRF增量更新时需重训且易遗忘旧数据的问题，提出Δ-NeRF框架。通过残差控制器、不确定性门控与视图选择策略，实现无需历史数据的高效增量优化，并结合知识蒸馏压缩模型。实验表明其在卫星图像上性能接近联合训练，训练时间减少30%-42%。**
...
>
---
#### [new 107] Knowledge Completes the Vision: A Multimodal Entity-aware Retrieval-Augmented Generation Framework for News Image Captioning
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对新闻图像字幕生成任务，解决信息不全、跨模态对齐弱、视觉实体定位不准问题。提出MERGE框架，构建实体中心的多模态知识库，通过检索增强生成提升图文对齐与实体识别，显著优于现有方法，在多个数据集上取得优异性能。**
...
>
---
#### [new 108] Scenes as Tokens: Multi-Scale Normal Distributions Transform Tokenizer for General 3D Vision-Language Understanding
- **分类: cs.CV**

- **简介: 该论文提出NDTokenizer3D，针对3D视觉语言理解中场景令牌化困难的问题，基于多尺度正态分布变换（NDT）构建三阶段令牌化流程。通过多尺度NDT表示与解码器，实现细粒度场景令牌生成，并统一支持交互式提示与分割任务，显著提升3D指代分割、视觉问答等能力。**
...
>
---
#### [new 109] FaithFusion: Harmonizing Reconstruction and Generation via Pixel-wise Information Gain
- **分类: cs.CV**

- **简介: 该论文针对可控驾驶场景重建与3D生成中几何保真与视角大变化下外观合理性难以兼顾的问题，提出FaithFusion框架。通过像素级期望信息增益（EIG）统一指导3DGS与扩散模型融合，实现高不确定性区域精修与几何一致性保持，无需额外条件或结构修改，在Waymo数据集上达SOTA性能。**
...
>
---
#### [new 110] Continual Error Correction on Low-Resource Devices
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对低资源设备上AI模型预测错误问题，提出一种持续误差纠正系统。通过服务器端知识蒸馏与设备端原型适应相结合，实现高效、低开销的少样本纠错，显著提升准确率并减少遗忘，在图像分类与检测任务中表现优异。**
...
>
---
#### [new 111] FIELDS: Face reconstruction with accurate Inference of Expression using Learning with Direct Supervision
- **分类: cs.CV**

- **简介: 该论文针对3D人脸重建中表达细节丢失的问题，提出FIELDS方法。通过引入直接的3D表情参数监督和情绪识别分支，结合真实4D扫描数据，提升表达真实性与细微情感还原能力，显著改善了真实场景下表情识别性能。**
...
>
---
#### [new 112] PathMamba: A Hybrid Mamba-Transformer for Topologically Coherent Road Segmentation in Satellite Imagery
- **分类: cs.CV**

- **简介: 该论文针对卫星图像中道路分割的拓扑连续性与精度难题，提出PathMamba混合模型。结合Mamba的线性效率与Transformer的全局建模能力，实现高效高精度分割，在DeepGlobe和Massachusetts数据集上达到新SOTA，显著提升拓扑连通性。**
...
>
---
#### [new 113] DiverseVAR: Balancing Diversity and Quality of Next-Scale Visual Autoregressive Models
- **分类: cs.CV**

- **简介: 该论文针对文本条件视觉自回归模型（VAR）生成图像多样性不足的问题，提出DiverseVAR框架。通过在测试时注入文本嵌入噪声提升多样性，并结合多尺度潜空间重构的scale-travel技术，有效平衡多样性与图像质量，无需重训练且计算开销低。**
...
>
---
#### [new 114] DinoLizer: Learning from the Best for Generative Inpainting Localization
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出DinoLizer，一种基于DINOv2的生成式修复图像篡改定位方法。针对生成图像中局部篡改难以检测的问题，利用预训练模型在B-Free数据集上识别合成图像，并通过线性分类头在14×14像素块级别预测篡改区域。结合滑动窗口与后处理，生成高精度掩码，在多个数据集上显著优于现有方法，且对常见后处理操作具有鲁棒性。**
...
>
---
#### [new 115] DeeAD: Dynamic Early Exit of Vision-Language Action for Efficient Autonomous Driving
...
>
---
#### [new 116] Progress by Pieces: Test-Time Scaling for Autoregressive Image Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对自回归图像生成中的测试时扩展问题，提出GridAR框架。通过网格分区渐进生成与布局引导提示重构，提升生成质量与效率，显著优于传统方法，在保持低计算成本下实现更优图像生成与编辑效果。**
...
>
---
#### [new 117] SAM Guided Semantic and Motion Changed Region Mining for Remote Sensing Change Captioning
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对遥感变化描述任务，解决现有方法区域感知弱、时序对齐不足的问题。提出基于SAM模型挖掘语义与运动变化区域，融合全局特征与知识图谱，通过跨注意力机制实现多源信息融合，提升描述准确性。**
...
>
---
#### [new 118] SocialNav: Training Human-Inspired Foundation Model for Socially-Aware Embodied Navigation
...
>
---
#### [new 119] Probabilistic Wildfire Spread Prediction Using an Autoregressive Conditional Generative Adversarial Network
- **分类: cs.LG; cs.AI; cs.CE; cs.CV**

- **简介: 该论文针对火灾蔓延预测任务，解决物理模型计算慢、深度学习模型预测平滑的问题。提出自回归条件生成对抗网络（CGAN），通过序列建模捕捉非线性动态与不确定性，提升预测精度与边界清晰度，实现高效、可解释的时序火灾演化预测。**
...
>
---
#### [new 120] AV-Edit: Multimodal Generative Sound Effect Editing via Audio-Visual Semantic Joint Control
...
>
---
#### [new 121] CHiQPM: Calibrated Hierarchical Interpretable Image Classification
- **分类: cs.LG; cs.CV; cs.HC**

- **简介: 该论文提出CHiQPM模型，针对图像分类任务中的可解释性与准确性平衡问题。通过层次化对比解释实现全局与局部可解释性，结合校准的置信预测，既保持99%高准确率，又提供人类可理解的预测集，推动人机协同决策。**
...
>
---
#### [new 122] A Fractional Variational Approach to Spectral Filtering Using the Fourier Transform
- **分类: eess.IV; cs.CV; math-ph**

- **简介: 该论文针对拉曼光谱中荧光干扰与噪声掩盖关键化学特征的问题，提出一种基于分数阶变分法的频域滤波方法。通过傅里叶变换将问题转至频域，利用分数阶导数平衡去噪与特征保留，并结合香农熵优化正则化参数与导数阶次，实现高效、鲁棒的信号处理。**
...
>
---
#### [new 123] Bangla Sign Language Translation: Dataset Creation Challenges, Benchmarking and Prospects
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 124] Prompt-Aware Adaptive Elastic Weight Consolidation for Continual Learning in Medical Vision-Language Models
- **分类: cs.MM; cs.CV**

- **简介: 该论文针对医疗视觉-语言模型在持续学习中面临的灾难性遗忘问题，提出Prompt-Aware EWC方法。通过分组保护关键参数、自适应计算Fisher信息与医学术语密度加权，实现对跨模态知识的高效保留。在五大数据集上验证，显著降低遗忘并提升病理定位与分割性能。**
...
>
---
#### [new 125] Automated Histopathologic Assessment of Hirschsprung Disease Using a Multi-Stage Vision Transformer Framework
- **分类: q-bio.QM; cs.CV; eess.IV**

- **简介: 该论文针对希克林病（Hirschsprung Disease）的病理诊断，提出一种基于Vision Transformer的多阶段分割框架，旨在自动识别肠壁肌层、肌间神经丛及无神经节细胞。通过三阶段流程模拟病理医生诊断，实现高精度分割与细胞检测，有效提升诊断一致性与效率。**
...
>
---
#### [new 126] CNN-LSTM Hybrid Architecture for Over-the-Air Automatic Modulation Classification Using SDR
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究无线信号调制识别任务，旨在解决无先验知识下自动调制分类问题。提出CNN-LSTM混合模型，结合软件定义无线电平台，利用CNN提取空间特征、LSTM捕捉时序依赖，基于混合数据集训练，在0-30dB信噪比下实现93.48%准确率，验证了其在复杂环境中的有效性。**
...
>
---
#### [new 127] Mechanisms of Non-Monotonic Scaling in Vision Transformers
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究视觉变换器（ViT）深度扩展中的非单调性能下降问题。通过分析不同规模ViT在ImageNet上的表现，发现其表征演化呈现“悬崖-平台-爬升”三阶段模式，揭示[CLS] token被分散的patch token取代，并提出信息混淆指数作为诊断工具，建议通过精细调控深度而非盲目增加参数量来优化模型。**
...
>
---
#### [new 128] ENACT: Evaluating Embodied Cognition with World Modeling of Egocentric Interaction
...
>
---
#### [new 129] OVOD-Agent: A Markov-Bandit Framework for Proactive Visual Reasoning and Self-Evolving Detection
- **分类: cs.AI; cs.CV**

- **简介: 该论文针对开放词汇目标检测（OVOD）中类别泛化能力不足的问题，提出OVOD-Agent框架。通过将被动匹配转为主动视觉推理，构建基于弱马尔可夫决策过程与强化学习的自进化检测机制，实现对稀有类别的有效识别，显著提升性能。**
...
>
---
#### [new 131] BanglaMM-Disaster: A Multimodal Transformer-Based Deep Learning Framework for Multiclass Disaster Classification in Bangla
- **分类: cs.LG; cs.CV**

- **简介: 该论文针对孟加拉语自然灾害分类任务，提出BanglaMM-Disaster框架，融合文本与图像多模态数据，构建5,037条标注数据集，利用Transformer与CNN模型实现端到端分类，显著提升准确率，尤其改善模糊样本识别，助力低资源环境下的实时灾情响应。**
...
>
---
#### [new 133] Guaranteed Optimal Compositional Explanations for Neurons
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文针对深度神经网络中神经元的可解释性问题，提出首个能保证最优性的组合解释框架。通过分解影响空间对齐的因素、设计启发式估计算法，实现高效且最优的逻辑规则搜索。实验表明，传统束搜索有10%-40%解释次优，新方法在效率与灵活性上优于现有方法。**
...
>
---
#### [new 134] Adversarial Multi-Task Learning for Liver Tumor Segmentation, Dynamic Enhancement Regression, and Classification
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文提出MTI-Net框架，同时解决肝肿瘤分割、动态增强回归和分类任务。针对多任务间关联性不足及动态MRI信息提取困难的问题，引入熵融合特征、任务交互模块与任务驱动判别器，有效提升多任务协同性能，实现在238例数据上的优异表现。**
...
>
---
#### [new 135] Multi-Reward GRPO for Stable and Prosodic Single-Codebook TTS LLMs at Scale
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 136] Deep Parameter Interpolation for Scalar Conditioning
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出深度参数插值（DPI），用于在现有神经网络中引入标量条件。针对生成模型中需融合高维输入与标量的问题，DPI通过动态插值两组可学习参数实现标量依赖，无需修改网络结构。方法简洁高效，提升扩散与流匹配模型的去噪性能与生成质量。**
...
>
---
#### [new 137] TraceGen: World Modeling in 3D Trace Space Enables Learning from Cross-Embodiment Videos
...
>
---
#### [new 138] STAR: Smartphone-analogous Typing in Augmented Reality
- **分类: cs.HC; cs.CV**

- **简介: 该论文提出STAR，一种模拟智能手机双指输入的增强现实文本输入方法。针对AR中高效易用文本输入难题，研究设计在手部皮肤上显示虚拟键盘，用户以熟悉方式打字。实验表明，经30分钟练习，用户平均输入速度达21.9词/分钟，错误率仅0.3%，性能接近手机输入。**
...
#### [replaced 001] Diffusion-Denoised Hyperspectral Gaussian Splatting
- **分类: cs.CV**
...
>
---
#### [replaced 002] GFT-GCN: Privacy-Preserving 3D Face Mesh Recognition with Spectral Diffusion
- **分类: cs.CV**
...
>
---
#### [replaced 003] CAPability: A Comprehensive Visual Caption Benchmark for Evaluating Both Correctness and Thoroughness
...
>
---
#### [replaced 004] Decorrelation Speeds Up Vision Transformers
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 005] PointNSP: Autoregressive 3D Point Cloud Generation with Next-Scale Level-of-Detail Prediction
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 006] Towards Spatially Consistent Image Generation: On Incorporating Intrinsic Scene Properties into Diffusion Models
- **分类: cs.CV**
...
>
---
#### [replaced 007] SaFiRe: Saccade-Fixation Reiteration with Mamba for Referring Image Segmentation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 008] DWFF-Net : A Multi-Scale Farmland System Habitat Identification Method with Adaptive Dynamic Weight
- **分类: cs.CV**
...
>
---
#### [replaced 009] OuroMamba: A Data-Free Quantization Framework for Vision Mamba
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 010] Gen-3Diffusion: Realistic Image-to-3D Generation via 2D & 3D Diffusion Synergy
- **分类: cs.CV**
...
>
---
#### [replaced 011] From Limited Labels to Open Domains:An Efficient Learning Method for Drone-view Geo-Localization
- **分类: cs.CV; cs.IR**
...
>
---
#### [replaced 012] VGGTFace: Topologically Consistent Facial Geometry Reconstruction in the Wild
- **分类: cs.CV**
...
>
---
#### [replaced 013] Dynamic Epsilon Scheduling: A Multi-Factor Adaptive Perturbation Budget for Adversarial Training
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 014] XYZCylinder: Towards Compatible Feed-Forward 3D Gaussian Splatting for Driving Scenes via Unified Cylinder Lifting Method
- **分类: cs.CV**
...
>
---
#### [replaced 015] Filter Like You Test: Data-Driven Data Filtering for CLIP Pretraining
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 016] Class-Independent Increment: An Efficient Approach for Multi-label Class-Incremental Learning
- **分类: cs.CV**
...
>
---
#### [replaced 017] Open Vocabulary Monocular 3D Object Detection
- **分类: cs.CV**
...
>
---
#### [replaced 018] A Simple Framework Towards Vision-based Traffic Signal Control with Microscopic Simulation
- **分类: cs.CV**
...
>
---
#### [replaced 019] Probabilistic Robustness for Free? Revisiting Training via a Benchmark
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 020] Active Negative Loss: A Robust Framework for Learning with Noisy Labels
- **分类: cs.CV**
...
>
---
#### [replaced 021] SKEL-CF: Coarse-to-Fine Biomechanical Skeleton and Surface Mesh Recovery
- **分类: cs.CV**
...
>
---
#### [replaced 022] TimeViper: A Hybrid Mamba-Transformer Vision-Language Model for Efficient Long Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 023] WeatherDiffusion: Controllable Weather Editing in Intrinsic Space
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 024] One-Step Diffusion Transformer for Controllable Real-World Image Super-Resolution
- **分类: cs.CV**
...
>
---
#### [replaced 025] DiffSeg30k: A Multi-Turn Diffusion Editing Benchmark for Localized AIGC Detection
- **分类: cs.CV**
...
>
---
#### [replaced 026] MoEGCL: Mixture of Ego-Graphs Contrastive Representation Learning for Multi-View Clustering
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 027] Stream and Query-guided Feature Aggregation for Efficient and Effective 3D Occupancy Prediction
- **分类: cs.CV**
...
>
---
#### [replaced 028] EvoEmpirBench: Dynamic Spatial Reasoning with Agent-ExpVer
- **分类: cs.CV**
...
>
---
#### [replaced 029] LightMem: Lightweight and Efficient Memory-Augmented Generation
...
>
---
#### [replaced 030] UniGame: Turning a Unified Multimodal Model Into Its Own Adversary
- **分类: cs.LG; cs.AI; cs.CV**
...
>
---
#### [replaced 031] CrossEarth-Gate: Fisher-Guided Adaptive Tuning Engine for Efficient Adaptation of Cross-Domain Remote Sensing Semantic Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 032] Contrast-Prior Enhanced Duality for Mask-Free Shadow Removal
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 033] A Gray-box Attack against Latent Diffusion Model-based Image Editing by Posterior Collapse
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 034] Interactive Occlusion Boundary Estimation through Exploitation of Synthetic Data
- **分类: cs.CV**
...
>
---
#### [replaced 036] EmoFeedback$^2$: Reinforcement of Continuous Emotional Image Generation via LVLM-based Reward and Textual Feedback
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 037] Think Visually, Reason Textually: Vision-Language Synergy in ARC
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 038] Thinking in 360°: Humanoid Visual Search in the Wild
- **分类: cs.CV**
...
>
---
#### [replaced 039] Activator: GLU Activation Function as the Core Component of a Vision Transformer
- **分类: cs.CV**
...
>
---
#### [replaced 040] Unsupervised Segmentation by Diffusing, Walking and Cutting
- **分类: cs.CV**
...
>
---
#### [replaced 041] Scale Where It Matters: Training-Free Localized Scaling for Diffusion Models
- **分类: cs.CV**
...
>
---
#### [replaced 042] Improved Visually Prompted Keyword Localisation in Real Low-Resource Settings
...
>
---
#### [replaced 043] BRIC: Bridging Kinematic Plans and Physical Control at Test Time
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 044] Uncovering and Mitigating Destructive Multi-Embedding Attacks in Deepfake Proactive Forensics
- **分类: cs.CV**
...
>
---
#### [replaced 046] DensiCrafter: Physically-Constrained Generation and Fabrication of Self-Supporting Hollow Structures
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 047] SARVLM: A Vision Language Foundation Model for Semantic Understanding and Target Recognition in SAR Imagery
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 048] ISAC: Training-Free Instance-to-Semantic Attention Control for Improving Multi-Instance Generation
- **分类: cs.CV**
...
>
---
#### [replaced 049] Saliency-R1: Incentivizing Unified Saliency Reasoning Capability in MLLM with Confidence-Guided Reinforcement Learning
- **分类: cs.CV**
...
>
---
#### [replaced 050] Learning Normals of Noisy Points by Local Gradient-Aware Surface Filtering
- **分类: cs.CV**
...
>
---
#### [replaced 051] RobustMerge: Parameter-Efficient Model Merging for MLLMs with Direction Robustness
- **分类: cs.CV**
...
>
---
#### [replaced 052] Geometrically Regularized Transfer Learning with On-Manifold and Off-Manifold Perturbation
- **分类: cs.CV**
...
>
---
#### [replaced 053] Systematic Evaluation and Guidelines for Segment Anything Model in Surgical Video Analysis
- **分类: cs.CV**
...
>
---
#### [replaced 054] IVY-FAKE: A Unified Explainable Framework and Benchmark for Image and Video AIGC Detection
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 055] GreenHyperSpectra: A multi-source hyperspectral dataset for global vegetation trait prediction
- **分类: cs.CV; eess.IV**
...
>
---
#### [replaced 056] Adaptive Object Detection for Indoor Navigation Assistance: A Performance Evaluation of Real-Time Algorithms
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 057] Video-R4: Reinforcing Text-Rich Video Reasoning with Visual Rumination
- **分类: cs.CV**
...
>
---
#### [replaced 058] DEMIST: Decoupled Multi-stream latent diffusion for Quantitative Myelin Map Synthesis
- **分类: eess.IV; cs.CV**
...
>
---
#### [replaced 059] Disentangled Geometric Alignment with Adaptive Contrastive Perturbation for Reliable Domain Transfer
- **分类: cs.CV**
...
>
---
#### [replaced 060] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
- **分类: cs.CV**
...
>
---
#### [replaced 061] Force Prompting: Video Generation Models Can Learn and Generalize Physics-based Control Signals
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 062] Agent0-VL: Exploring Self-Evolving Agent for Tool-Integrated Vision-Language Reasoning
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 063] One-Step Diffusion-Based Image Compression with Semantic Distillation
- **分类: cs.CV; eess.IV**
...
>
---
#### [replaced 064] TinyChemVL: Advancing Chemical Vision-Language Models via Efficient Visual Token Reduction and Complex Reaction Tasks
- **分类: cs.CV**
...
>
---
#### [replaced 065] Not All Splits Are Equal: Rethinking Attribute Generalization Across Unrelated Categories
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 066] MeshCone: Second-Order Cone Programming for Geometrically-Constrained Mesh Enhancement
...
>
---
#### [replaced 067] Directed-Tokens: A Robust Multi-Modality Alignment Approach to Large Language-Vision Models
- **分类: cs.CV**
...
>
---
#### [replaced 068] FlowTok: Flowing Seamlessly Across Text and Image Tokens
- **分类: cs.CV**
...
>
---
#### [replaced 069] CroMe: Multimodal Fake News Detection using Cross-Modal Tri-Transformer and Metric Learning
- **分类: cs.LG; cs.AI; cs.CV**
...
>
---
#### [replaced 070] ProtoPFormer: Concentrating on Prototypical Parts in Vision Transformers for Interpretable Image Recognition
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 071] Leveraging Contrast Information for Efficient Document Shadow Removal
- **分类: cs.CV**
...
>
---
#### [replaced 072] Earth-Adapter: Bridge the Geospatial Domain Gaps with Mixture of Frequency Adaptation
- **分类: cs.CV**
...
>
---
#### [replaced 073] Image as an IMU: Estimating Camera Motion from a Single Motion-Blurred Image
- **分类: cs.CV**
...
>
---
#### [replaced 074] Vision-Language Enhanced Foundation Model for Semi-supervised Medical Image Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 075] Point-Supervised Facial Expression Spotting with Gaussian-Based Instance-Adaptive Intensity Modeling
- **分类: cs.CV**
...
>
---
#### [replaced 076] Comparison of Generative Learning Methods for Turbulence Surrogates
...
>
---
#### [replaced 077] Pistachio: Towards Synthetic, Balanced, and Long-Form Video Anomaly Benchmarks
...
>
---
#### [replaced 078] LogicOCR: Do Your Large Multimodal Models Excel at Logical Reasoning on Text-Rich Images?
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 079] LASER: Lip Landmark Assisted Speaker Detection for Robustness
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 080] Automated Neural Architecture Design for Industrial Defect Detection
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 081] SOAP: Enhancing Spatio-Temporal Relation and Motion Information Capturing for Few-Shot Action Recognition
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 082] Restoration-Oriented Video Frame Interpolation with Region-Distinguishable Priors from SAM
- **分类: cs.CV**
...
>
---
#### [replaced 083] AMLP: Adjustable Masking Lesion Patches for Self-Supervised Medical Image Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 084] Multi-scale Temporal Prediction via Incremental Generation and Multi-agent Collaboration
- **分类: cs.CV**
...
>
---
#### [replaced 085] Vision Remember: Recovering Visual Information in Efficient LVLM with Vision Feature Resampling
- **分类: cs.CV**
...
>
---
#### [replaced 086] MetricHMSR:Metric Human Mesh and Scene Recovery from Monocular Images
- **分类: cs.CV**
...
>
---
#### [replaced 087] ReMatch: Boosting Representation through Matching for Multimodal Retrieval
- **分类: cs.CV**
...
>
---
#### [replaced 088] ReasonAct: Progressive Training for Fine-Grained Video Reasoning in Small Models
- **分类: cs.CV**
...
>
---
#### [replaced 089] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
- **分类: cs.CV**
...
>
---
#### [replaced 090] LMLCC-Net: A Semi-Supervised Deep Learning Model for Lung Nodule Malignancy Prediction from CT Scans using a Novel Hounsfield Unit-Based Intensity Filtering
- **分类: eess.IV; cs.CV**
...
>
---
#### [replaced 091] LTD: Low Temperature Distillation for Gradient Masking-free Adversarial Training
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 092] Connecting the Dots: Training-Free Visual Grounding via Agentic Reasoning
- **分类: cs.CV**
...
>
---
#### [replaced 093] ControlEvents: Controllable Synthesis of Event Camera Datawith Foundational Prior from Image Diffusion Models
- **分类: cs.CV**
...
>
---
#### [replaced 094] Without Paired Labeled Data: End-to-End Self-Supervised Learning for Drone-view Geo-Localization
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 095] MANGO: Multimodal Attention-based Normalizing Flow Approach to Fusion Learning
- **分类: cs.CV**
...
>
---
#### [replaced 096] Modular, On-Site Solutions with Lightweight Anomaly Detection for Sustainable Nutrient Management in Agriculture
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 097] UniChange: Unifying Change Detection with Multimodal Large Language Model
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 098] Adapting Segment Anything Model for Power Transmission Corridor Hazard Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 099] STARFlow-V: End-to-End Video Generative Modeling with Normalizing Flows
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 100] PointNSP: Autoregressive 3D Point Cloud Generation with Next-Scale Level-of-Detail Prediction
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 101] Benchmarking the Trustworthiness in Multimodal LLMs for Video Understanding
- **分类: cs.CV**
...
>
---
#### [replaced 102] Restora-Flow: Mask-Guided Image Restoration with Flow Matching
- **分类: cs.CV**
...
>
---
#### [replaced 103] Bayesian Neural Networks for One-to-Many Mapping in Image Enhancement
- **分类: cs.CV**
...
>
---
#### [replaced 104] Passive Dementia Screening via Facial Temporal Micro-Dynamics Analysis of In-the-Wild Talking-Head Video
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 105] Towards Consistent and Controllable Image Synthesis for Face Editing
- **分类: cs.CV**
...
>
---
#### [replaced 106] Cheating Stereo Matching in Full-scale: Physical Adversarial Attack against Binocular Depth Estimation in Autonomous Driving
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 107] ConceptGuard: Proactive Safety in Text-and-Image-to-Video Generation through Multimodal Risk Detection
- **分类: cs.CV; cs.AI**
