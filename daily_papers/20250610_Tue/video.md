...
- **简介: 该论文提出SAR目标结构恢复任务，旨在从单视角SAR图像中提取飞机目标的3D语义结构表示，解决传统方法忽略结构建模的问题。**
...
- **简介: 该论文属于单图像深度估计任务，解决从单一模糊图像中恢复场景深度的问题。通过引入暗通道先验，提升深度估计效果。**
...
- **链接: [http://arxiv.org/pdf/2506.07399v1](http://arxiv.org/pdf/2506.07399v1)**
...
- **简介: 该论文属于工业物体检测任务，旨在通过域随机化生成合成数据提升检测性能。研究构建了数据生成流程并提出SIP15-OD数据集，验证了合成数据在真实场景中的有效性。**
...
- **简介: 该论文属于遥感变化检测任务，旨在比较不同U-Net架构在卫星图像变化检测中的效果，分析其优缺点，为选择合适模型提供参考。**
...
- **简介: 该论文属于图像编辑任务，旨在解决文本描述不足时的语义控制问题。提出PairEdit方法，通过图像对学习语义变化，提升内容一致性。**
...
- **简介: 该论文属于视觉特征分析任务，旨在揭示视觉编码器内部特征表示。通过图像重建方法，比较不同模型的特征信息保留能力，并探索特征空间的结构。**
...
- **简介: 该论文提出LiFT模型，用于远程监测健身训练。任务是运动识别与重复计数，解决现有模型泛化能力差和复杂度高的问题。通过构建大规模数据集并使用视觉-语言Transformer实现多任务处理。**
...
- **简介: 该论文提出Genesis，用于生成具有时空一致性和跨模态一致性的多视角驾驶视频和LiDAR序列，解决驾驶场景生成任务中的数据质量和语义一致性问题。**
...
- **简介: 该论文属于舞蹈生成任务，旨在解决多模态数据不足和生成可控性差的问题。构建了OpenDance5D数据集，并提出OpenDanceNet模型实现灵活的舞蹈生成。**
...
- **简介: 该论文属于图像分割任务，解决多模态推理中的视觉感知与语义理解问题。提出DTwinSeger方法，通过数字孪生表示分离感知与推理，提升分割性能。**
...
- **简介: 该论文属于视频编辑任务，解决对象添加和非刚性变换问题。通过分析模型层重要性，实现无需训练的文本引导视频编辑。**
...
- **简介: 该论文属于神经网络压缩任务，旨在解决SNN中二值化激活导致的精度下降问题。通过反转权重与激活的位数，提升信息容量并保持效率。**
...
- **简介: 该论文属于神经元解释评估任务，旨在提高众包评价的准确性和成本效益。通过重要性采样和贝叶斯聚合方法，减少评估成本并提升结果可靠性。**
...
- **简介: 该论文属于3D人脸识别任务，旨在解决点云噪声影响识别精度的问题。提出cGAN-TOP去噪和LDGCNN识别方法，提升噪声环境下识别准确率。**
...
- **链接: [http://arxiv.org/pdf/2506.06780v1](http://arxiv.org/pdf/2506.06780v1)**
...
- **简介: 该论文提出PhysLab数据集，用于物理实验的多粒度视觉解析。解决现有数据集标注粗略、领域覆盖窄和缺乏流程指导的问题。通过构建包含多种实验的视频数据集，支持多种视觉任务。**
...
- **简介: 该论文属于历史数据挖掘任务，旨在将芬兰1800-1920年的教会迁徙记录转化为结构化数据，解决手工处理效率低的问题。通过深度学习自动化提取六百万条迁移信息。**
...
- **链接: [http://arxiv.org/pdf/2506.07555v1](http://arxiv.org/pdf/2506.07555v1)**
...
- **简介: 该论文属于农业目标检测任务，解决模型在遮挡和非刚性变形下的检测精度问题。通过结合CBAM、STN和TPS，提升空间适应性和注意力机制，提高检测效果。**
...
>
---
#### [new 077] DeepVideo-R1: Video Reinforcement Fine-Tuning via Difficulty-aware Regressive GRPO
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频语言模型任务，解决GRPO在视频LLMs中应用的两个问题，提出Reg-GRPO和难度感知数据增强方法，提升视频推理性能。**

- **链接: [http://arxiv.org/pdf/2506.07464v1](http://arxiv.org/pdf/2506.07464v1)**

> **作者:** Jinyoung Park; Jeehye Na; Jinyoung Kim; Hyunwoo J. Kim
>
> **备注:** Work in progress
>
> **摘要:** Recent works have demonstrated the effectiveness of reinforcement learning (RL)-based post-training in enhancing the reasoning capabilities of large language models (LLMs). In particular, Group Relative Policy Optimization (GRPO) has shown impressive success by employing a PPO-style reinforcement algorithm with group-based normalized rewards. However, the application of GRPO to Video Large Language Models (Video LLMs) has been less studied. In this paper, we explore GRPO for video LLMs and identify two primary issues that impede its effective learning: (1) reliance on safeguards, and (2) the vanishing advantage problem. To mitigate these challenges, we propose DeepVideo-R1, a video large language model trained with our proposed Reg-GRPO (Regressive GRPO) and difficulty-aware data augmentation strategy. Reg-GRPO reformulates the GRPO objective as a regression task, directly predicting the advantage in GRPO. This design eliminates the need for safeguards like clipping and min functions, thereby facilitating more direct policy guidance by aligning the model with the advantage values. We also design the difficulty-aware data augmentation strategy that dynamically augments training samples at solvable difficulty levels, fostering diverse and informative reward signals. Our comprehensive experiments show that DeepVideo-R1 significantly improves video reasoning performance across multiple video reasoning benchmarks.
>
---
#### [new 078] SpaCE-10: A Comprehensive Benchmark for Multimodal Large Language Models in Compositional Spatial Intelligence
- **分类: cs.CV**

- **简介: 该论文属于多模态大语言模型任务，旨在解决空间智能评估不足的问题。提出SpaCE-10基准，涵盖10项基础空间能力及8项组合能力，构建高质量数据集以全面评估模型表现。**

- **链接: [http://arxiv.org/pdf/2506.07966v1](http://arxiv.org/pdf/2506.07966v1)**
...
>
---
#### [new 079] Vision Transformers Don't Need Trained Registers
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉Transformer任务，解决高范数token导致的注意力噪声问题。通过训练-free方法将高范数激活转移到未训练token，提升模型性能与可解释性。**

- **链接: [http://arxiv.org/pdf/2506.08010v1](http://arxiv.org/pdf/2506.08010v1)**
...
>
---
#### [new 083] Sleep Stage Classification using Multimodal Embedding Fusion from EOG and PSM
- **分类: cs.CV**

- **简介: 该论文属于睡眠阶段分类任务，旨在解决传统方法依赖复杂设备的问题。通过融合EOG和PSM数据，使用ImageBind模型提升分类准确率。**

- **链接: [http://arxiv.org/pdf/2506.06912v1](http://arxiv.org/pdf/2506.06912v1)**
...
>
---
#### [new 085] Learning Compact Vision Tokens for Efficient Large Multimodal Models
...
>
---
#### [new 086] EgoM2P: Egocentric Multimodal Multitask Pretraining
- **分类: cs.CV**

- **简介: 该论文提出EgoM2P，解决egocentric视觉中多模态任务的预训练问题，通过时空tokenizers提升模型效率与性能。**

- **链接: [http://arxiv.org/pdf/2506.07886v1](http://arxiv.org/pdf/2506.07886v1)**
...
>
---
#### [new 117] Backdoor Attack on Vision Language Models with Stealthy Semantic Manipulation
- **分类: cs.CV; cs.CR**

- **简介: 该论文属于安全领域，研究VLMs的语义后门攻击。通过构造跨模态语义不匹配触发器，实现隐蔽攻击，并验证其有效性与泛化性。**

- **链接: [http://arxiv.org/pdf/2506.07214v1](http://arxiv.org/pdf/2506.07214v1)**
...
>
---
#### [new 132] Learning Speaker-Invariant Visual Features for Lipreading
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 142] ArchiLense: A Framework for Quantitative Analysis of Architectural Styles Based on Vision Large Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于建筑风格分析任务，旨在解决传统方法主观性强、范围有限的问题。构建了ArchDiffBench数据集，提出ArchiLense框架，实现建筑风格的自动识别与分类。**

- **链接: [http://arxiv.org/pdf/2506.07739v1](http://arxiv.org/pdf/2506.07739v1)**
...
>
---
#### [new 143] UA-Pose: Uncertainty-Aware 6D Object Pose Estimation and Online Object Completion with Partial References
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 144] Stepwise Decomposition and Dual-stream Focus: A Novel Approach for Training-free Camouflaged Object Segmentation
- **分类: cs.CV**

- **简介: 该论文属于伪装目标分割任务，解决语义模糊和空间分离问题，提出RDVP-MSD框架实现无需训练的高效分割。**

- **链接: [http://arxiv.org/pdf/2506.06818v1](http://arxiv.org/pdf/2506.06818v1)**
...
>
---
#### [new 153] TABLET: Table Structure Recognition using Encoder-only Transformers
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于表格结构识别任务，旨在解决大而密集表格的识别问题。通过双Transformer编码器进行行列分割与单元格合并，提升识别准确率与效率。**

- **链接: [http://arxiv.org/pdf/2506.07015v1](http://arxiv.org/pdf/2506.07015v1)**
...
>
---
#### [new 154] M2Restore: Mixture-of-Experts-based Mamba-CNN Fusion Framework for All-in-One Image Restoration
- **分类: cs.CV**

- **简介: 该论文属于图像修复任务，解决复杂退化场景下的通用性不足和局部细节与全局依赖平衡问题。提出M2Restore框架，融合CNN与Mamba，提升修复效果。**

- **链接: [http://arxiv.org/pdf/2506.07814v1](http://arxiv.org/pdf/2506.07814v1)**
...
>
---
#### [new 155] Image segmentation and classification of E-waste for waste segregation
- **分类: cs.CV; cs.AI; I.2.10**

- **简介: 该论文属于电子垃圾图像分割与分类任务，旨在解决自动化分拣问题。通过构建数据集并训练YOLOv11和Mask-RCNN模型实现高效识别。**

- **链接: [http://arxiv.org/pdf/2506.07122v1](http://arxiv.org/pdf/2506.07122v1)**

> **作者:** Prakriti Tripathi; Theertha Biju; Maniram Thota; Rakesh Lingam
>
> **备注:** 4 pages, 7 figures. For code and link to dataset, see https://github.com/prakriti16/Image-segmentation-and-classification-of-e-waste
>
> **摘要:** Industry partners provided a problem statement that involves classifying electronic waste using machine learning models that will be used by pick-and-place robots for waste segregation. We started by taking common electronic waste items, such as a mouse and charger, unsoldering them, and taking pictures to create a custom dataset. Then state-of-the art YOLOv11 model was trained and run to achieve 70 mAP in real-time. Mask-RCNN model was also trained and achieved 41 mAP. The model will be further integrated with pick-and-place robots to perform segregation of e-waste.
>
---
#### [new 156] Re-ranking Reasoning Context with Tree Search Makes Large Vision-Language Models Stronger
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视觉问答任务，旨在解决LVLMs知识匮乏和回答不稳定的问题。提出RCTS框架，通过构建增强知识库和树搜索重排序方法提升模型性能。**

- **链接: [http://arxiv.org/pdf/2506.07785v1](http://arxiv.org/pdf/2506.07785v1)**

> **作者:** Qi Yang; Chenghao Zhang; Lubin Fan; Kun Ding; Jieping Ye; Shiming Xiang
>
> **备注:** ICML 2025 Spotlight. 22 pages, 16 figures
>
> **摘要:** Recent advancements in Large Vision Language Models (LVLMs) have significantly improved performance in Visual Question Answering (VQA) tasks through multimodal Retrieval-Augmented Generation (RAG). However, existing methods still face challenges, such as the scarcity of knowledge with reasoning examples and erratic responses from retrieved knowledge. To address these issues, in this study, we propose a multimodal RAG framework, termed RCTS, which enhances LVLMs by constructing a Reasoning Context-enriched knowledge base and a Tree Search re-ranking method. Specifically, we introduce a self-consistent evaluation mechanism to enrich the knowledge base with intrinsic reasoning patterns. We further propose a Monte Carlo Tree Search with Heuristic Rewards (MCTS-HR) to prioritize the most relevant examples. This ensures that LVLMs can leverage high-quality contextual reasoning for better and more consistent responses. Extensive experiments demonstrate that our framework achieves state-of-the-art performance on multiple VQA datasets, significantly outperforming In-Context Learning (ICL) and Vanilla-RAG methods. It highlights the effectiveness of our knowledge base and re-ranking method in improving LVLMs. Our code is available at https://github.com/yannqi/RCTS-RAG.
>
---
#### [new 157] From Generation to Generalization: Emergent Few-Shot Learning in Video Diffusion Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视频扩散模型的少样本泛化能力，旨在探索其作为视觉学习基础模型的潜力。通过微调框架，模型在少量示例下完成多种视觉任务。**

- **链接: [http://arxiv.org/pdf/2506.07280v1](http://arxiv.org/pdf/2506.07280v1)**
...
>
---
#### [new 160] Mimicking or Reasoning: Rethinking Multi-Modal In-Context Learning in Vision-Language Models
...
>
---
#### [new 166] SceneRAG: Scene-level Retrieval-Augmented Generation for Video Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出SceneRAG，解决视频理解中长视频内容处理问题。通过场景分割与多模态信息融合，提升生成任务性能。**

- **链接: [http://arxiv.org/pdf/2506.07600v1](http://arxiv.org/pdf/2506.07600v1)**
...
>
---
#### [new 171] LaTtE-Flow: Layerwise Timestep-Expert Flow-based Transformer
- **分类: cs.CV**

- **简介: 该论文提出LaTtE-Flow，解决多模态任务中统一模型效率低的问题，通过分层时间专家流架构提升图像生成速度与性能。**

- **链接: [http://arxiv.org/pdf/2506.06952v1](http://arxiv.org/pdf/2506.06952v1)**
...
>
---
#### [new 174] Interpretable and Reliable Detection of AI-Generated Images via Grounded Reasoning in MLLMs
...
>
---
#### [new 175] Egocentric Event-Based Vision for Ping Pong Ball Trajectory Prediction
- **分类: cs.CV**

- **简介: 该论文属于轨迹预测任务，旨在解决乒乓球轨迹实时预测问题。使用事件相机和眼动数据，提升预测精度与速度。**

- **链接: [http://arxiv.org/pdf/2506.07860v1](http://arxiv.org/pdf/2506.07860v1)**
...
>
---
#### [new 178] FreeGave: 3D Physics Learning from Dynamic Videos by Gaussian Velocity
...
>
---
#### [new 179] Deep Inertial Pose: A deep learning approach for human pose estimation
- **分类: cs.CV; eess.SP**
...
>
---
#### [new 180] Interpretation of Deep Learning Model in Embryo Selection for In Vitro Fertilization (IVF) Treatment
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于胚胎筛选任务，旨在解决IVF中胚胎评估效率低的问题，通过CNN-LSTM模型实现高精度且可解释的胚胎分类。**

- **链接: [http://arxiv.org/pdf/2506.06680v1](http://arxiv.org/pdf/2506.06680v1)**
...
>
---
#### [new 183] MoQAE: Mixed-Precision Quantization for Long-Context LLM Inference via Mixture of Quantization-Aware Experts
- **分类: cs.CV**

- **简介: 该论文属于大语言模型优化任务，解决长文本推理中KV缓存内存消耗过高的问题。提出MoQAE方法，通过混合精度量化和专家机制提升效率与效果。**

- **链接: [http://arxiv.org/pdf/2506.07533v1](http://arxiv.org/pdf/2506.07533v1)**
...
>
---
#### [new 188] LoopDB: A Loop Closure Dataset for Large Scale Simultaneous Localization and Mapping
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 191] Diffuse Everything: Multimodal Diffusion Models on Arbitrary State Spaces
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于多模态生成任务，旨在解决扩散模型在联合生成多模态数据时依赖预处理的问题，提出一种无需外部编码器的框架，实现跨模态原生生成。**

- **链接: [http://arxiv.org/pdf/2506.07903v1](http://arxiv.org/pdf/2506.07903v1)**
...
>
---
#### [new 202] BitVLA: 1-bit Vision-Language-Action Models for Robotics Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 210] Text-guided multi-stage cross-perception network for medical image segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决目标区域语义表达弱的问题。通过引入多阶段跨模态交互机制提升分割精度。**

- **链接: [http://arxiv.org/pdf/2506.07475v1](http://arxiv.org/pdf/2506.07475v1)**
...
>
---
#### [new 211] Generalized Trajectory Scoring for End-to-end Multimodal Planning
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 212] LLMs as World Models: Data-Driven and Human-Centered Pre-Event Simulation for Disaster Impact Assessment
...
>
---
#### [new 213] DriveSuprim: Towards Precise Trajectory Selection for End-to-End Planning
...
>
---
#### [new 214] A Narrative Review on Large AI Models in Lung Cancer Screening, Diagnosis, and Treatment Planning
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学AI任务，旨在利用大模型提升肺癌筛查、诊断与治疗的准确性。通过分析多种AI架构，探索其在多模态数据中的应用及挑战。**

- **链接: [http://arxiv.org/pdf/2506.07236v1](http://arxiv.org/pdf/2506.07236v1)**
...
>
---
#### [new 215] SpikePingpong: High-Frequency Spike Vision-based Robot Learning for Precise Striking in Table Tennis Game
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 221] Experimental Evaluation of Static Image Sub-Region-Based Search Models Using CLIP
- **分类: cs.MM; cs.CV; 68U10; H.3.3; I.4.10; H.2.8**

- **简介: 该论文属于图像检索任务，旨在解决在同质化场景中因文本描述模糊导致的检索难题。通过添加位置提示和划分图像子区域，提升CLIP模型的检索效果。**

- **链接: [http://arxiv.org/pdf/2506.06938v1](http://arxiv.org/pdf/2506.06938v1)**
...
>
---
#### [new 222] Mitigating Behavioral Hallucination in Multimodal Large Language Models for Sequential Images
- **分类: cs.AI; cs.CL; cs.CV**
...
>
---
#### [new 223] Active Illumination Control in Low-Light Environments using NightHawk
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 224] FREE: Fast and Robust Vision Language Models with Early Exits
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于视觉语言模型任务，旨在解决大模型推理延迟问题。通过引入早期退出机制和对抗训练方法，提升推理速度与模型鲁棒性。**

- **链接: [http://arxiv.org/pdf/2506.06884v1](http://arxiv.org/pdf/2506.06884v1)**
...
>
---
#### [new 226] Speedy Deformable 3D Gaussian Splatting: Fast Rendering and Compression of Dynamic Scenes
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于动态3D场景渲染任务，解决动态3D高斯点云的渲染速度与压缩问题。通过剪枝和运动聚类技术提升效率并减小模型规模。**

- **链接: [http://arxiv.org/pdf/2506.07917v1](http://arxiv.org/pdf/2506.07917v1)**
...
>
---
#### [new 227] A Culturally-diverse Multilingual Multimodal Video Benchmark & Model
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 230] Vision-QRWKV: Exploring Quantum-Enhanced RWKV Models for Image Classification
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于图像分类任务，旨在通过量子增强的RWKV模型提升复杂数据的分类性能。工作包括引入量子电路改进模型结构，并在多个数据集上验证其有效性。**

- **链接: [http://arxiv.org/pdf/2506.06633v1](http://arxiv.org/pdf/2506.06633v1)**
...
>
---
#### [new 233] Edge-Enabled Collaborative Object Detection for Real-Time Multi-Vehicle Perception
...
>
---
#### [new 236] Contextual Experience Replay for Self-Improvement of Language Agents
...
>
---
#### [new 237] Multimodal Spatial Language Maps for Robot Navigation and Manipulation
...
>
---
#### [new 238] Unblocking Fine-Grained Evaluation of Detailed Captions: An Explaining AutoRater and Critic-and-Revise Pipeline
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 239] Splat and Replace: 3D Reconstruction with Repetitive Elements
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于3D重建任务，旨在解决因视角不足导致的渲染质量差问题。通过利用场景中的重复元素，提升重建效果。**

- **链接: [http://arxiv.org/pdf/2506.06462v1](http://arxiv.org/pdf/2506.06462v1)**
...
>
---
#### [new 243] Long-Tailed Learning for Generalized Category Discovery
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于通用类别发现任务，旨在解决真实数据集长尾分布下模型性能下降的问题。提出自引导标注和表征平衡方法，提升对尾部类别的识别效果。**

- **链接: [http://arxiv.org/pdf/2506.06965v1](http://arxiv.org/pdf/2506.06965v1)**
...
>
---
#### [new 246] GaussianVAE: Adaptive Learning Dynamics of 3D Gaussians for High-Fidelity Super-Resolution
- **分类: cs.GR; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于3D重建任务，解决3D高分辨率重建问题。通过自适应生成模型提升3D高斯点云的细节和几何精度。**

- **链接: [http://arxiv.org/pdf/2506.07897v1](http://arxiv.org/pdf/2506.07897v1)**
...
>
---
#### [new 247] MapBERT: Bitwise Masked Modeling for Real-Time Semantic Mapping Generation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 248] Diffusion Counterfactual Generation with Semantic Abduction
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **简介: 该论文属于图像生成任务，解决 counterfactual 图像生成中的身份保持与因果控制问题，提出基于扩散模型的语义归纳框架。**

- **链接: [http://arxiv.org/pdf/2506.07883v1](http://arxiv.org/pdf/2506.07883v1)**
...
>
---
#### [new 249] Rewriting the Budget: A General Framework for Black-Box Attacks Under Cost Asymmetry
- **分类: cs.LG; cs.AI; cs.CR; cs.CV**

- **简介: 该论文属于对抗攻击任务，解决黑盒攻击中查询成本不对称的问题。提出AS和AGREST方法，降低总攻击成本并减少扰动。**

- **链接: [http://arxiv.org/pdf/2506.06933v1](http://arxiv.org/pdf/2506.06933v1)**
...
>
---
#### [new 250] Lingshu: A Generalist Foundation Model for Unified Multimodal Medical Understanding and Reasoning
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 251] Meta-Adaptive Prompt Distillation for Few-Shot Visual Question Answering
- **分类: cs.AI; cs.CL; cs.CV**
...
>
---
#### [new 252] GUI-Reflection: Empowering Multimodal GUI Models with Self-Reflection Behavior
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于GUI自动化任务，旨在解决现有模型缺乏自我反思和错误恢复能力的问题。通过构建数据管道、训练环境和迭代算法，提升模型的自省与纠错能力。**

- **链接: [http://arxiv.org/pdf/2506.08012v1](http://arxiv.org/pdf/2506.08012v1)**

> **作者:** Penghao Wu; Shengnan Ma; Bo Wang; Jiaheng Yu; Lewei Lu; Ziwei Liu
>
> **备注:** Project Page at https://penghao-wu.github.io/GUI_Reflection/
>
...
>
---
#### [replaced 004] LLM-HDR: Bridging LLM-based Perception and Self-Supervision for Unpaired LDR-to-HDR Image Reconstruction
...
>
---
#### [replaced 005] Reinforcing Video Reasoning with Focused Thinking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24718v3](http://arxiv.org/pdf/2505.24718v3)**
...
>
---
#### [replaced 006] Unifying 2D and 3D Vision-Language Understanding
...
>
---
#### [replaced 010] RainFusion: Adaptive Video Generation Acceleration via Multi-Dimensional Visual Redundancy
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.21036v2](http://arxiv.org/pdf/2505.21036v2)**

> **作者:** Aiyue Chen; Bin Dong; Jingru Li; Jing Lin; Kun Tian; Yiwu Yao; Gongyi Wang
>
...
>
---
#### [replaced 011] SYNTHIA: Novel Concept Design with Affordance Composition
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.17793v3](http://arxiv.org/pdf/2502.17793v3)**
...
>
> **摘要:** Text-to-image (T2I) models enable rapid concept design, making them widely used in AI-driven design. While recent studies focus on generating semantic and stylistic variations of given design concepts, functional coherence--the integration of multiple affordances into a single coherent concept--remains largely overlooked. In this paper, we introduce SYNTHIA, a framework for generating novel, functionally coherent designs based on desired affordances. Our approach leverages a hierarchical concept ontology that decomposes concepts into parts and affordances, serving as a crucial building block for functionally coherent design. We also develop a curriculum learning scheme based on our ontology that contrastively fine-tunes T2I models to progressively learn affordance composition while maintaining visual novelty. To elaborate, we (i) gradually increase affordance distance, guiding models from basic concept-affordance association to complex affordance compositions that integrate parts of distinct affordances into a single, coherent form, and (ii) enforce visual novelty by employing contrastive objectives to push learned representations away from existing concepts. Experimental results show that SYNTHIA outperforms state-of-the-art T2I models, demonstrating absolute gains of 25.1% and 14.7% for novelty and functional coherence in human evaluation, respectively.
>
---
#### [replaced 012] A Diffusion-Driven Temporal Super-Resolution and Spatial Consistency Enhancement Framework for 4D MRI imaging
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04116v2](http://arxiv.org/pdf/2506.04116v2)**
...
>
---
#### [replaced 013] Diffusion-based Adversarial Purification from the Perspective of the Frequency Domain
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.01267v2](http://arxiv.org/pdf/2505.01267v2)**
...
>
---
#### [replaced 014] SimLTD: Simple Supervised and Semi-Supervised Long-Tailed Object Detection
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.20047v3](http://arxiv.org/pdf/2412.20047v3)**

> **作者:** Phi Vu Tran
>
> **备注:** CVPR 2025. The reference code is available at https://github.com/lexisnexis-risk-open-source/simltd
>
> **摘要:** While modern visual recognition systems have made significant advancements, many continue to struggle with the open problem of learning from few exemplars. This paper focuses on the task of object detection in the setting where object classes follow a natural long-tailed distribution. Existing methods for long-tailed detection resort to external ImageNet labels to augment the low-shot training instances. However, such dependency on a large labeled database has limited utility in practical scenarios. We propose a versatile and scalable approach to leverage optional unlabeled images, which are easy to collect without the burden of human annotations. Our SimLTD framework is straightforward and intuitive, and consists of three simple steps: (1) pre-training on abundant head classes; (2) transfer learning on scarce tail classes; and (3) fine-tuning on a sampled set of both head and tail classes. Our approach can be viewed as an improved head-to-tail model transfer paradigm without the added complexities of meta-learning or knowledge distillation, as was required in past research. By harnessing supplementary unlabeled images, without extra image labels, SimLTD establishes new record results on the challenging LVIS v1 benchmark across both supervised and semi-supervised settings.
>
---
#### [replaced 015] Can MLLMs Guide Me Home? A Benchmark Study on Fine-Grained Visual Reasoning from Transit Maps
- **分类: cs.CV; cs.AI; cs.CL**
...
>
> **备注:** Accepted to ACL 2025 Main. Project page: https://friedrichor.github.io/projects/TUNA
>
...
>
---
#### [replaced 018] A Robust Real-Time Lane Detection Method with Fog-Enhanced Feature Fusion for Foggy Conditions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.06121v4](http://arxiv.org/pdf/2504.06121v4)**
...
>
---
#### [replaced 019] Learning Efficient and Effective Trajectories for Differential Equation-based Image Restoration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.04811v2](http://arxiv.org/pdf/2410.04811v2)**
...
>
---
#### [replaced 023] Detect Anything 3D in the Wild
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.07958v2](http://arxiv.org/pdf/2504.07958v2)**
...
>
---
#### [replaced 024] QP-SNN: Quantized and Pruned Spiking Neural Networks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.05905v2](http://arxiv.org/pdf/2502.05905v2)**
...
>
---
#### [replaced 026] When Incentives Backfire, Data Stops Being Human
...
>
---
#### [replaced 029] GRE Suite: Geo-localization Inference via Fine-Tuned Vision-Language Models and Enhanced Reasoning Chains
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.18700v2](http://arxiv.org/pdf/2505.18700v2)**
...
>
---
#### [replaced 030] ViVo: A Dataset for Volumetric Video Reconstruction and Compression
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.00558v2](http://arxiv.org/pdf/2506.00558v2)**
...
>
---
#### [replaced 031] EmoVOCA: Speech-Driven Emotional 3D Talking Heads
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.12886v3](http://arxiv.org/pdf/2403.12886v3)**
...
>
---
#### [replaced 032] Seeing Far and Clearly: Mitigating Hallucinations in MLLMs with Attention Causal Decoding
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.16652v2](http://arxiv.org/pdf/2505.16652v2)**
...
>
---
#### [replaced 033] A multistep segmentation algorithm for vessel extraction in medical imaging
- **分类: cs.CV; cs.NA; math.NA**

- **链接: [http://arxiv.org/pdf/1412.8656v2](http://arxiv.org/pdf/1412.8656v2)**

> **作者:** Nasser Aghazadeh; Ladan Sharafyan Cigaroudy
>
> **备注:** 9 pages,4 figures
>
> **摘要:** The main contribution of this paper is to propose an iterative procedure for tubular structure segmentation of 2D images, which combines tight frame of Curvelet transforms with a SURE technique thresholding which is based on principle obtained by minimizing Stein Unbiased Risk Estimate for denoising. This proposed algorithm is mainly based on the TFA proposal presented in [1, 9], which we use eigenvectors of Hessian matrix of image for improving this iterative part in segmenting unclear and narrow vessels and filling the gap between separate pieces of detected vessels. The experimental results are presented to demonstrate the effectiveness of the proposed model.
>
---
#### [replaced 034] GHOST 2.0: generative high-fidelity one shot transfer of heads
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.18417v4](http://arxiv.org/pdf/2502.18417v4)**

> **作者:** Alexander Groshev; Anastasiia Iashchenko; Pavel Paramonov; Denis Dimitrov; Andrey Kuznetsov
>
> **摘要:** While the task of face swapping has recently gained attention in the research community, a related problem of head swapping remains largely unexplored. In addition to skin color transfer, head swap poses extra challenges, such as the need to preserve structural information of the whole head during synthesis and inpaint gaps between swapped head and background. In this paper, we address these concerns with GHOST 2.0, which consists of two problem-specific modules. First, we introduce enhanced Aligner model for head reenactment, which preserves identity information at multiple scales and is robust to extreme pose variations. Secondly, we use a Blender module that seamlessly integrates the reenacted head into the target background by transferring skin color and inpainting mismatched regions. Both modules outperform the baselines on the corresponding tasks, allowing to achieve state of the art results in head swapping. We also tackle complex cases, such as large difference in hair styles of source and target. Code is available at https://github.com/ai-forever/ghost-2.0
>
---
#### [replaced 035] Unlocking the Capabilities of Large Vision-Language Models for Generalizable and Explainable Deepfake Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.14853v2](http://arxiv.org/pdf/2503.14853v2)**

> **作者:** Peipeng Yu; Jianwei Fei; Hui Gao; Xuan Feng; Zhihua Xia; Chip Hong Chang
>
> **备注:** Accepted by ICML 2025
>
> **摘要:** Current Large Vision-Language Models (LVLMs) have demonstrated remarkable capabilities in understanding multimodal data, but their potential remains underexplored for deepfake detection due to the misalignment of their knowledge and forensics patterns. To this end, we present a novel framework that unlocks LVLMs' potential capabilities for deepfake detection. Our framework includes a Knowledge-guided Forgery Detector (KFD), a Forgery Prompt Learner (FPL), and a Large Language Model (LLM). The KFD is used to calculate correlations between image features and pristine/deepfake image description embeddings, enabling forgery classification and localization. The outputs of the KFD are subsequently processed by the Forgery Prompt Learner to construct fine-grained forgery prompt embeddings. These embeddings, along with visual and question prompt embeddings, are fed into the LLM to generate textual detection responses. Extensive experiments on multiple benchmarks, including FF++, CDF2, DFD, DFDCP, DFDC, and DF40, demonstrate that our scheme surpasses state-of-the-art methods in generalization performance, while also supporting multi-turn dialogue capabilities.
>
---
#### [replaced 036] OctFusion: Octree-based Diffusion Models for 3D Shape Generation
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2408.14732v2](http://arxiv.org/pdf/2408.14732v2)**

> **作者:** Bojun Xiong; Si-Tong Wei; Xin-Yang Zheng; Yan-Pei Cao; Zhouhui Lian; Peng-Shuai Wang
>
> **备注:** Accepted to Computer Graphics Forum (SGP), 2025
>
> **摘要:** Diffusion models have emerged as a popular method for 3D generation. However, it is still challenging for diffusion models to efficiently generate diverse and high-quality 3D shapes. In this paper, we introduce OctFusion, which can generate 3D shapes with arbitrary resolutions in 2.5 seconds on a single Nvidia 4090 GPU, and the extracted meshes are guaranteed to be continuous and manifold. The key components of OctFusion are the octree-based latent representation and the accompanying diffusion models. The representation combines the benefits of both implicit neural representations and explicit spatial octrees and is learned with an octree-based variational autoencoder. The proposed diffusion model is a unified multi-scale U-Net that enables weights and computation sharing across different octree levels and avoids the complexity of widely used cascaded diffusion schemes. We verify the effectiveness of OctFusion on the ShapeNet and Objaverse datasets and achieve state-of-the-art performances on shape generation tasks. We demonstrate that OctFusion is extendable and flexible by generating high-quality color fields for textured mesh generation and high-quality 3D shapes conditioned on text prompts, sketches, or category labels. Our code and pre-trained models are available at https://github.com/octree-nn/octfusion.
>
---
#### [replaced 037] Four Eyes Are Better Than Two: Harnessing the Collaborative Potential of Large Models via Differentiated Thinking and Complementary Ensembles
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.16784v2](http://arxiv.org/pdf/2505.16784v2)**

> **作者:** Jun Xie; Xiongjun Guan; Yingjian Zhu; Zhaoran Zhao; Xinming Wang; Hongzhu Yi; Feng Chen; Zhepeng Wang
>
...
>
---
#### [replaced 042] Vector-Quantized Vision Foundation Models for Object-Centric Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.20263v3](http://arxiv.org/pdf/2502.20263v3)**
...
>
---
#### [replaced 043] BiggerGait: Unlocking Gait Recognition with Layer-wise Representations from Large Vision Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18132v2](http://arxiv.org/pdf/2505.18132v2)**
...
>
---
#### [replaced 044] TissUnet: Improved Extracranial Tissue and Cranium Segmentation for Children through Adulthood
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.05660v2](http://arxiv.org/pdf/2506.05660v2)**

> **作者:** Markiian Mandzak; Elvira Yang; Anna Zapaishchykova; Yu-Hui Chen; Lucas Heilbroner; John Zielke; Divyanshu Tak; Reza Mojahed-Yazdi; Francesca Romana Mussa; Zezhong Ye; Sridhar Vajapeyam; Viviana Benitez; Ralph Salloum; Susan N. Chi; Houman Sotoudeh; Jakob Seidlitz; Sabine Mueller; Hugo J. W. L. Aerts; Tina Y. Poussaint; Benjamin H. Kann
>
...
>
---
#### [replaced 054] Stop Looking for Important Tokens in Multimodal Language Models: Duplication Matters More
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 055] From Thousands to Billions: 3D Visual Language Grounding via Render-Supervised Distillation from 2D VLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.20389v2](http://arxiv.org/pdf/2502.20389v2)**
...
>
---
#### [replaced 057] Scalable Vision Language Model Training via High Quality Data Curation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 058] HAIC: Improving Human Action Understanding and Generation with Better Captions for Multi-modal Large Language Models
...
>
---
#### [replaced 063] Improving Generalization in MRI-Based Deep Learning Models for Total Knee Replacement Prediction
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.19203v4](http://arxiv.org/pdf/2504.19203v4)**
...
>
---
#### [replaced 069] C2F-CHART: A Curriculum Learning Approach to Chart Classification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2409.04683v2](http://arxiv.org/pdf/2409.04683v2)**
...
>
---
#### [replaced 072] CORDIAL: Can Multimodal Large Language Models Effectively Understand Coherence Relationships?
...
>
---
#### [replaced 073] EgoNormia: Benchmarking Physical Social Norm Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 074] An Overview of the Burer-Monteiro Method for Certifiable Robot Perception
...
>
---
#### [replaced 075] Fine-grained Hierarchical Crop Type Classification from Integrated Hyperspectral EnMAP Data and Multispectral Sentinel-2 Time Series: A Large-scale Dataset and Dual-stream Transformer Method
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.06155v2](http://arxiv.org/pdf/2506.06155v2)**
...
>
---
#### [replaced 077] Gaussian is All You Need: A Unified Framework for Solving Inverse Problems via Diffusion Posterior Sampling
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2409.08906v2](http://arxiv.org/pdf/2409.08906v2)**
...
>
---
#### [replaced 081] Skywork-VL Reward: An Effective Reward Model for Multimodal Understanding and Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.07263v2](http://arxiv.org/pdf/2505.07263v2)**
...
>
---
#### [replaced 083] Unlocking Smarter Device Control: Foresighted Planning with a World Model-Driven Code Execution Approach
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.16422v2](http://arxiv.org/pdf/2505.16422v2)**
...
>
---
#### [replaced 086] Towards Achieving Perfect Multimodal Alignment
- **分类: cs.LG; cs.AI; cs.CV; eess.SP**
...
>
---
#### [replaced 087] From Pixels to Predicates: Learning Symbolic World Models via Pretrained Vision-Language Models
...
>
---
#### [replaced 088] Skywork R1V: Pioneering Multimodal Reasoning with Chain-of-Thought
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 089] I-INR: Iterative Implicit Neural Representations
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.17364v2](http://arxiv.org/pdf/2504.17364v2)**
...
>
---
#### [replaced 090] Multi-GraspLLM: A Multimodal LLM for Multi-Hand Semantic Guided Grasp Generation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 103] MMScan: A Multi-Modal 3D Scene Dataset with Hierarchical Grounded Language Annotations
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 104] Diffusion as Reasoning: Enhancing Object Navigation via Diffusion Model Conditioned on LLM-based Object-Room Knowledge
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2410.21842v2](http://arxiv.org/pdf/2410.21842v2)**
...
>
---
#### [replaced 105] BrainMorph: A Foundational Keypoint Model for Robust and Flexible Brain MRI Registration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.14019v3](http://arxiv.org/pdf/2405.14019v3)**

> **作者:** Alan Q. Wang; Rachit Saluja; Heejong Kim; Xinzi He; Adrian Dalca; Mert R. Sabuncu
>
> **备注:** Accepted for publication at the Journal of Machine Learning for Biomedical Imaging (MELBA) https://melba-journal.org/2025:010
>
> **摘要:** We present a keypoint-based foundation model for general purpose brain MRI registration, based on the recently-proposed KeyMorph framework. Our model, called BrainMorph, serves as a tool that supports multi-modal, pairwise, and scalable groupwise registration. BrainMorph is trained on a massive dataset of over 100,000 3D volumes, skull-stripped and non-skull-stripped, from nearly 16,000 unique healthy and diseased subjects. BrainMorph is robust to large misalignments, interpretable via interrogating automatically-extracted keypoints, and enables rapid and controllable generation of many plausible transformations with different alignment types and different degrees of nonlinearity at test-time. We demonstrate the superiority of BrainMorph in solving 3D rigid, affine, and nonlinear registration on a variety of multi-modal brain MRI scans of healthy and diseased subjects, in both the pairwise and groupwise setting. In particular, we show registration accuracy and speeds that surpass many classical and learning-based methods, especially in the context of large initial misalignments and large group settings. All code and models are available at https://github.com/alanqrwang/brainmorph.
>
---
#### [replaced 106] Hypergraph Tversky-Aware Domain Incremental Learning for Brain Tumor Segmentation with Missing Modalities
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2505.16809v3](http://arxiv.org/pdf/2505.16809v3)**
...
>
---
#### [replaced 110] Feature-Based Lie Group Transformer for Real-World Applications
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.04668v3](http://arxiv.org/pdf/2506.04668v3)**

> **作者:** Takayuki Komatsu; Yoshiyuki Ohmura; Kayato Nishitsunoi; Yasuo Kuniyoshi
>
> **备注:** 8 pages, the dataset used in this work is https://drive.google.com/file/d/1RaSWNN2GEyV3zQPeGya4Mr9DDhJ7OMz7/view?usp=sharing
>
...
>
---
#### [replaced 111] Monocular Dynamic Gaussian Splatting: Fast, Brittle, and Scene Complexity Rules
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.04457v2](http://arxiv.org/pdf/2412.04457v2)**
...
>
---
#### [replaced 112] Hummingbird: High Fidelity Image Generation via Multimodal Context Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.05153v2](http://arxiv.org/pdf/2502.05153v2)**
...
>
---
#### [replaced 116] Peer-Ranked Precision: Creating a Foundational Dataset for Fine-Tuning Vision Models from DataSeeds' Annotated Imagery
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05673v2](http://arxiv.org/pdf/2506.05673v2)**
...
>
---
#### [replaced 117] ShapeICP: Iterative Category-level Object Pose and Shape Estimation from Depth
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 118] CAST: Contrastive Adaptation and Distillation for Semi-Supervised Instance Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.21904v3](http://arxiv.org/pdf/2505.21904v3)**
...
>
---
#### [replaced 119] UStyle: Waterbody Style Transfer of Underwater Scenes by Depth-Guided Feature Synthesis
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2503.11893v2](http://arxiv.org/pdf/2503.11893v2)**
...
>
---
#### [replaced 120] AdaReTaKe: Adaptive Redundancy Reduction to Perceive Longer for Video-language Understanding
- **分类: cs.CV; cs.CL; cs.MM**
...
>
---
#### [replaced 121] Spatial457: A Diagnostic Benchmark for 6D Spatial Reasoning of Large Multimodal Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.08636v4](http://arxiv.org/pdf/2502.08636v4)**
...
>
---
#### [replaced 130] LLM-attacker: Enhancing Closed-loop Adversarial Scenario Generation for Autonomous Driving with Large Language Models
...
>
---
#### [replaced 131] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.21041v3](http://arxiv.org/pdf/2505.21041v3)**
...
>
---
#### [replaced 132] VideoPrism: A Foundational Visual Encoder for Video Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2402.13217v3](http://arxiv.org/pdf/2402.13217v3)**
...
>
> **备注:** Accepted to ICML 2024. v2: added retrieval results on MSRVTT (1K-A), more data analyses, and ablation studies; v3: released models at https://github.com/google-deepmind/videoprism
>
> **摘要:** We introduce VideoPrism, a general-purpose video encoder that tackles diverse video understanding tasks with a single frozen model. We pretrain VideoPrism on a heterogeneous corpus containing 36M high-quality video-caption pairs and 582M video clips with noisy parallel text (e.g., ASR transcripts). The pretraining approach improves upon masked autoencoding by global-local distillation of semantic video embeddings and a token shuffling scheme, enabling VideoPrism to focus primarily on the video modality while leveraging the invaluable text associated with videos. We extensively test VideoPrism on four broad groups of video understanding tasks, from web video question answering to CV for science, achieving state-of-the-art performance on 31 out of 33 video understanding benchmarks. Our models are released at https://github.com/google-deepmind/videoprism.
>
---
#### [replaced 133] Deep Learning for Retinal Degeneration Assessment: A Comprehensive Analysis of the MARIO AMD Progression Challenge
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.02976v2](http://arxiv.org/pdf/2506.02976v2)**
...
>
---
#### [replaced 134] Towards Black-Box Membership Inference Attack for Diffusion Models
- **分类: cs.CR; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2405.20771v4](http://arxiv.org/pdf/2405.20771v4)**
...
>
---
#### [replaced 135] What Changed and What Could Have Changed? State-Change Counterfactuals for Procedure-Aware Video Representation Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.21055v2](http://arxiv.org/pdf/2503.21055v2)**
...
>
---
#### [replaced 136] A Hypernetwork-Based Approach to KAN Representation of Audio Signals
...
>
---
#### [replaced 137] Black-Box Forgery Attacks on Semantic Watermarks for Diffusion Models
- **分类: cs.CR; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2412.03283v3](http://arxiv.org/pdf/2412.03283v3)**

> **作者:** Andreas Müller; Denis Lukovnikov; Jonas Thietke; Asja Fischer; Erwin Quiring
>
> **备注:** CVPR 2025
>
> **摘要:** Integrating watermarking into the generation process of latent diffusion models (LDMs) simplifies detection and attribution of generated content. Semantic watermarks, such as Tree-Rings and Gaussian Shading, represent a novel class of watermarking techniques that are easy to implement and highly robust against various perturbations. However, our work demonstrates a fundamental security vulnerability of semantic watermarks. We show that attackers can leverage unrelated models, even with different latent spaces and architectures (UNet vs DiT), to perform powerful and realistic forgery attacks. Specifically, we design two watermark forgery attacks. The first imprints a targeted watermark into real images by manipulating the latent representation of an arbitrary image in an unrelated LDM to get closer to the latent representation of a watermarked image. We also show that this technique can be used for watermark removal. The second attack generates new images with the target watermark by inverting a watermarked image and re-generating it with an arbitrary prompt. Both attacks just need a single reference image with the target watermark. Overall, our findings question the applicability of semantic watermarks by revealing that attackers can easily forge or remove these watermarks under realistic conditions.
>
---
#### [replaced 138] Revisiting semi-supervised learning in the era of foundation models
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.09707v2](http://arxiv.org/pdf/2503.09707v2)**
...
>
---
#### [replaced 139] RetinaLogos: Fine-Grained Synthesis of High-Resolution Retinal Images Through Captions
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.12887v2](http://arxiv.org/pdf/2505.12887v2)**
...
>
> **备注:** The paper is being withdrawn due to issues with the authorship list. Specifically, one or more contributors were unintentionally omitted in the initial submission
>
...
>
---
#### [replaced 140] Group-On: Boosting One-Shot Segmentation with Supportive Query
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.11871v2](http://arxiv.org/pdf/2404.11871v2)**

> **作者:** Hanjing Zhou; Mingze Yin; Danny Chen; Jian Wu; JinTai Chen
>
...
>
---
#### [replaced 141] MutualNeRF: Improve the Performance of NeRF under Limited Samples with Mutual Information Theory
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.11386v2](http://arxiv.org/pdf/2505.11386v2)**
