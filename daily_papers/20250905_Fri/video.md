...
- **简介: 该论文提出MEPG框架，解决文本到图像生成中复杂提示与风格多样性不足的问题，通过结合位置-风格感知LLM与多专家模块，实现动态区域生成与风格控制，提升图像质量与多样性。**
...
- **简介: 该论文提出EGTM框架，利用事件相机的高效稀疏成像机制解决传统湍流抑制方法效率低的问题，通过事件流分析与幸运融合提升去噪效率，构建首个事件驱动TM数据集，显著优化模型规模与推理速度。**
...
- **简介: 该论文针对植物物种分类任务，利用叶脉模式数据，比较ResNet50、MobileNetV2和EfficientNetB0三种CNN模型的分类效果，发现EfficientNetB0在测试准确率和F1分数上表现最优，适用于高精度植物自动识别。**
...
- **链接: [http://arxiv.org/pdf/2509.03883v1](http://arxiv.org/pdf/2509.03883v1)**
...
- **简介: 该论文提出ChexGen，一个生成式基础模型，解决医疗图像标注数据稀缺问题。通过合成胸部X光片用于数据增强和预训练，提升疾病分类、检测性能，并增强模型公平性。**
...
- **简介: 该论文提出LMVC框架，解决多视角视频压缩效率低的问题。通过深度学习利用运动和内容相关性，提升压缩效率，超越传统MV-HEVC标准，实现高效编码与随机访问。**
...
- **简介: 该论文针对真实场景深度伪造检测，优化简单基线方法，通过调整超参数将准确率提升至81%，接近商业检测器水平，并探讨实际部署中的权衡。**
...
- **简介: 该论文提出基于单目SLAM的视频摘要生成方法，通过轨迹估计、关键帧聚类与多帧拼接，将身体摄像头视频转化为全景图像，以快速理解复杂环境并提升应急决策效率。**
...
- **简介: 论文提出SAC-MIL方法，用于全滑片图像分类。解决空间关系建模与序列长度差异问题，通过位置编码模块和MLP结构实现高效全实例相关性，达到SOTA性能。**
...
- **链接: [http://arxiv.org/pdf/2509.03754v1](http://arxiv.org/pdf/2509.03754v1)**
...
- **简介: 该论文提出SLENet框架，解决水下伪装目标检测（UCOD）中因光学畸变、水浑浊和复杂生物特征导致的识别难题。通过Gamma-Asymmetric Enhancement模块和定位引导分支提升多尺度特征表示，验证了其在UCOD任务中的优越性能。**
...
- **简介: 该论文提出SliceSemOcc框架，针对自动驾驶中3D语义占用预测任务，解决现有方法忽略高度信息的问题。通过垂直切片提取特征，结合全局局部融合与动态通道注意力模块，显著提升小物体类别IoU。**
...
- **简介: 该论文提出ANTS方法，利用MLLM生成适应性负文本空间，解决OOD检测中负空间构建不准确和假负标签问题，提升远近OOD检测效果，实现训练免费和零样本。**
...
- **简介: 论文提出TopoSculpt框架，用于3D细粒度管状结构的拓扑重建。针对现有方法无法保证全局拓扑正确性和几何精度的问题，引入Betti约束和课程式精炼策略，显著提升几何与拓扑准确性。**
...
- **简介: 该论文针对多模态虚假信息检测任务，解决现有方法单一、泛化差的问题。提出TRUST-VL模型，融合视觉-语言模块与指令数据集，提升跨模态推理能力与可解释性，实现状态-of-the-art性能。**
...
- **简介: 论文提出QuantV2X，解决V2X协作感知中效率与延迟问题，通过全量化多智能体系统降低计算与传输成本，提升部署性能。**
...
- **简介: 该论文提出OccTENS，解决长期3D场景生成中的效率、时间退化和可控性问题。通过TENS框架与TensFormer模型，结合姿态聚合策略，实现高效、可控的高保真占用场景生成。**
...
- **简介: 该论文针对半监督医学图像分割中特征提取与先验信息利用不足的问题，提出结合双尺度体积先验与Wasserstein一致性约束的框架。通过图像级和数据集级的Wasserstein距离约束，优化分割网络，提升无标签数据的分割准确性。**
...
- **简介: 该论文提出教师-学生模型，解决有丝分裂检测与分类任务中的领域偏移和数据不平衡问题，通过UNet骨干网络结合对比学习、对抗训练及多任务学习框架，实现高精度的分割与分类。**
...
- **简介: 该论文提出FE2E框架，通过改造图像编辑模型（基于DiT架构）解决密集几何估计任务（单目深度/法线预测）。针对生成模型在密集预测中的局限性，引入一致速度训练目标与对数量化技术，并利用全局注意力实现深度与法线联合估计，显著提升零样本性能。**
...
- **简介: 该论文提出Plot'n Polish框架，解决文本到图像模型在故事可视化中的零样本生成与细粒度编辑问题，通过增强控制与一致性，实现多帧叙事的灵活修改。**
...
- **简介: 论文提出Attn-Adapter框架，解决视觉-语言模型少样本学习中离线微调计算成本高和过拟合问题，通过双注意力机制动态适应少量样本，提升跨数据集泛化能力。**
...
- **简介: 该论文提出GeoArena平台，解决图像地理定位任务中数据泄露和评估指标不足的问题。通过真实场景数据和人类判断，实现对大模型的无偏基准测试，提升评估的准确性和隐私保护。**
...
- **简介: 该论文针对长尾分布下的动态面部表情识别任务，提出MICACL框架，通过多实例学习、图增强模块和对比学习策略解决类别不平衡与时空特征建模难题，提升模型鲁棒性与泛化能力。**
...
>
---
#### [new 068] Multimodal Feature Fusion Network with Text Difference Enhancement for Remote Sensing Change Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MMChange方法，通过融合图像与文本模态，解决遥感变化检测中光照噪声干扰下的特征表示不足问题，提升检测准确性和鲁棒性。**

- **链接: [http://arxiv.org/pdf/2509.03961v1](http://arxiv.org/pdf/2509.03961v1)**
...
>
---
#### [new 069] Weakly-Supervised Learning of Dense Functional Correspondences
- **分类: cs.CV**

- **简介: 该论文提出弱监督学习方法，通过视觉-语言模型和对比学习建立跨类别图像的密集功能对应，解决形状重建与机器人操作中的对应难题，优于现有方法。**

- **链接: [http://arxiv.org/pdf/2509.03893v1](http://arxiv.org/pdf/2509.03893v1)**
...
>
---
#### [new 072] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出ContraGS方法，解决3D高斯溅射（3DGS）训练中因高斯数量多导致的内存占用高、训练渲染慢问题。通过代码本压缩参数并结合贝叶斯推理框架，实现无需减少高斯数量的高效训练，显著降低内存消耗并加速训练与渲染。**

- **链接: [http://arxiv.org/pdf/2509.03775v1](http://arxiv.org/pdf/2509.03775v1)**
...
>
---
#### [new 073] TensoIS: A Step Towards Feed-Forward Tensorial Inverse Subsurface Scattering for Perlin Distributed Heterogeneous Media
- **分类: cs.GR; cs.CV; cs.LG**

- **简介: 论文提出TensoIS框架，通过Fractal Perlin噪声建模异质介质散射参数，解决逆次表面散射估计问题，利用低秩张量组件实现高效预测，并在合成与真实数据上验证有效性。**

- **链接: [http://arxiv.org/pdf/2509.04047v1](http://arxiv.org/pdf/2509.04047v1)**
...
>
> **备注:** To appear in Pacific Graphics 2025 (CGF Journal Track), Project page: https://yashbachwana.github.io/TensoIS/
>
...
>
---
#### [new 074] FedQuad: Federated Stochastic Quadruplet Learning to Mitigate Data Heterogeneity
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出FedQuad方法，通过联邦四元组学习优化类内方差与类间方差，解决联邦学习中数据异质性导致的模型泛化问题。**

- **链接: [http://arxiv.org/pdf/2509.04107v1](http://arxiv.org/pdf/2509.04107v1)**
...
>
---
#### [new 076] A Multidimensional AI-powered Framework for Analyzing Tourist Perception in Historic Urban Quarters: A Case Study in Shanghai
...
>
---
#### [new 077] Global-to-Local or Local-to-Global? Enhancing Image Retrieval with Efficient Local Search and Effective Global Re-ranking
- **分类: cs.IR; cs.CV**

- **简介: 该论文针对图像检索任务，提出局部到全局的新型框架，结合高效局部搜索与动态全局重排序，通过多维标度生成符合局部相似性的全局特征嵌入，提升大规模检索性能，刷新Revisited Oxford和Paris数据集的SOTA。**

- **链接: [http://arxiv.org/pdf/2509.04351v1](http://arxiv.org/pdf/2509.04351v1)**
...
>
---
#### [new 078] SMooGPT: Stylized Motion Generation using Large Language Models
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出SMooGPT，通过大语言模型解决风格化运动生成问题，利用身体部位文本空间提升可解释性和泛化能力，有效生成多样化的运动风格。**

- **链接: [http://arxiv.org/pdf/2509.04058v1](http://arxiv.org/pdf/2509.04058v1)**
...
>
---
#### [new 081] Data-Augmented Quantization-Aware Knowledge Distillation
- **分类: cs.LG; cs.CV**

- **简介: 论文提出数据增强与量化感知知识蒸馏结合方法，解决低精度模型中数据增强策略选择问题。通过设计新指标评估DA对上下文互信息和预测准确性的贡献，自动筛选最优DA策略，提升量化模型性能。**

- **链接: [http://arxiv.org/pdf/2509.03850v1](http://arxiv.org/pdf/2509.03850v1)**
...
>
---
#### [new 082] LuxDiT: Lighting Estimation with Video Diffusion Transformer
- **分类: cs.GR; cs.AI; cs.CV**

- **简介: 论文提出LuxDiT，通过视频扩散Transformer生成HDR环境图，解决光照估计中数据稀缺和间接线索问题，利用合成数据和低秩适配提升效果。**

- **链接: [http://arxiv.org/pdf/2509.03680v1](http://arxiv.org/pdf/2509.03680v1)**

> **作者:** Ruofan Liang; Kai He; Zan Gojcic; Igor Gilitschenski; Sanja Fidler; Nandita Vijaykumar; Zian Wang
>
> **备注:** Project page: https://research.nvidia.com/labs/toronto-ai/LuxDiT/
>
...
>
---
#### [new 085] MobileRAG: Enhancing Mobile Agent with Retrieval-Augmented Generation
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 086] Transition Models: Rethinking the Generative Learning Objective
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出Transition Models（TiM），解决生成模型中生成质量与计算成本的矛盾。通过引入连续时间动力学方程，实现任意步数的高质量生成，超越主流模型性能，且参数更少，支持高分辨率输出。**

- **链接: [http://arxiv.org/pdf/2509.04394v1](http://arxiv.org/pdf/2509.04394v1)**

> **作者:** Zidong Wang; Yiyuan Zhang; Xiaoyu Yue; Xiangyu Yue; Yangguang Li; Wanli Ouyang; Lei Bai
>
> **备注:** The code is released at https://github.com/WZDTHU/TiM
>
> **摘要:** A fundamental dilemma in generative modeling persists: iterative diffusion models achieve outstanding fidelity, but at a significant computational cost, while efficient few-step alternatives are constrained by a hard quality ceiling. This conflict between generation steps and output quality arises from restrictive training objectives that focus exclusively on either infinitesimal dynamics (PF-ODEs) or direct endpoint prediction. We address this challenge by introducing an exact, continuous-time dynamics equation that analytically defines state transitions across any finite time interval. This leads to a novel generative paradigm, Transition Models (TiM), which adapt to arbitrary-step transitions, seamlessly traversing the generative trajectory from single leaps to fine-grained refinement with more steps. Despite having only 865M parameters, TiM achieves state-of-the-art performance, surpassing leading models such as SD3.5 (8B parameters) and FLUX.1 (12B parameters) across all evaluated step counts. Importantly, unlike previous few-step generators, TiM demonstrates monotonic quality improvement as the sampling budget increases. Additionally, when employing our native-resolution strategy, TiM delivers exceptional fidelity at resolutions up to 4096x4096.
>
---
## 更新

#### [replaced 001] BuzzSet v1.0: A Dataset for Pollinator Detection in Field Conditions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.19762v3](http://arxiv.org/pdf/2508.19762v3)**
...
>
---
#### [replaced 002] Kwai Keye-VL 1.5 Technical Report
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.01563v2](http://arxiv.org/pdf/2509.01563v2)**

> **作者:** Biao Yang; Bin Wen; Boyang Ding; Changyi Liu; Chenglong Chu; Chengru Song; Chongling Rao; Chuan Yi; Da Li; Dunju Zang; Fan Yang; Guorui Zhou; Guowang Zhang; Han Shen; Hao Peng; Haojie Ding; Hao Wang; Haonan Fang; Hengrui Ju; Jiaming Huang; Jiangxia Cao; Jiankang Chen; Jingyun Hua; Kaibing Chen; Kaiyu Jiang; Kaiyu Tang; Kun Gai; Muhao Wei; Qiang Wang; Ruitao Wang; Sen Na; Shengnan Zhang; Siyang Mao; Sui Huang; Tianke Zhang; Tingting Gao; Wei Chen; Wei Yuan; Xiangyu Wu; Xiao Hu; Xingyu Lu; Yi-Fan Zhang; Yiping Yang; Yulong Chen; Zeyi Lu; Zhenhua Wu; Zhixin Ling; Zhuoran Yang; Ziming Li; Di Xu; Haixuan Gao; Hang Li; Jing Wang; Lejian Ren; Qigen Hu; Qianqian Wang; Shiyao Wang; Xinchen Luo; Yan Li; Yuhang Hu; Zixing Zhang
>
...
>
---
#### [replaced 003] Transferable Mask Transformer: Cross-domain Semantic Segmentation with Region-adaptive Transferability Estimation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.05774v2](http://arxiv.org/pdf/2504.05774v2)**

> **作者:** Jianhua Liu; Zhengyu Li; Yanru Wu; Jingge Wang; Yang Tan; Ruizhe Zhao; Guan Wang; Yang Li
>
...
>
---
#### [replaced 004] Ensemble of Pathology Foundation Models for MIDOG 2025 Track 2: Atypical Mitosis Classification
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.02591v2](http://arxiv.org/pdf/2509.02591v2)**
...
>
---
#### [replaced 005] Optimization of Module Transferability in Single Image Super-Resolution: Universality Assessment and Cycle Residual Blocks
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.03522v2](http://arxiv.org/pdf/2505.03522v2)**

> **作者:** Haotong Cheng; Zhiqi Zhang; Hao Li; Xinshang Zhang
>
> **备注:** The paper has been accepted to IET Image Processing
>
...
>
---
#### [replaced 006] Encoder-Only Image Registration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.00451v2](http://arxiv.org/pdf/2509.00451v2)**
...
>
---
#### [replaced 007] PIN: A Knowledge-Intensive Dataset for Paired and Interleaved Multimodal Documents
...
>
---
#### [replaced 010] Drawing2CAD: Sequence-to-Sequence Learning for CAD Generation from Vector Drawings
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.18733v3](http://arxiv.org/pdf/2508.18733v3)**
...
>
---
#### [replaced 011] Accurate and lightweight dehazing via multi-receptive-field non-local network and novel contrastive regularization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2309.16494v3](http://arxiv.org/pdf/2309.16494v3)**
...
>
---
#### [replaced 017] From Embeddings to Accuracy: Comparing Foundation Models for Radiographic Classification
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2505.10823v2](http://arxiv.org/pdf/2505.10823v2)**
...
>
---
#### [replaced 020] SPARE: Symmetrized Point-to-Plane Distance for Robust Non-Rigid Registration
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2405.20188v2](http://arxiv.org/pdf/2405.20188v2)**
...
>
---
#### [replaced 027] Style Transfer to Calvin and Hobbes comics using Stable Diffusion
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2312.03993v2](http://arxiv.org/pdf/2312.03993v2)**

> **作者:** Asvin Kumar Venkataramanan; Sloke Shrestha; Sundar Sripada Venugopalaswamy Sriraman
>
> **备注:** Updated authorship
>
> **摘要:** This project report summarizes our journey to perform stable diffusion fine-tuning on a dataset containing Calvin and Hobbes comics. The purpose is to convert any given input image into the comic style of Calvin and Hobbes, essentially performing style transfer. We train stable-diffusion-v1.5 using Low Rank Adaptation (LoRA) to efficiently speed up the fine-tuning process. The diffusion itself is handled by a Variational Autoencoder (VAE), which is a U-net. Our results were visually appealing for the amount of training time and the quality of input data that went into training.
>
---
#### [replaced 028] ARTalk: Speech-Driven 3D Head Animation via Autoregressive Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.20323v5](http://arxiv.org/pdf/2502.20323v5)**

> **作者:** Xuangeng Chu; Nabarun Goswami; Ziteng Cui; Hanqin Wang; Tatsuya Harada
>
> **备注:** SIGGRAPH Asia 2025, More video demonstrations, code, models and data can be found on our project website: http://xg-chu.site/project_artalk/
>
...
>
---
#### [replaced 029] AutoPETIII: The Tracer Frontier. What Frontier?
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2410.02807v2](http://arxiv.org/pdf/2410.02807v2)**

> **作者:** Zacharia Mesbah; Léo Mottay; Romain Modzelewski; Pierre Decazes; Sébastien Hapdey; Su Ruan; Sébastien Thureau
>
> **摘要:** For the last three years, the AutoPET competition gathered the medical imaging community around a hot topic: lesion segmentation on Positron Emitting Tomography (PET) scans. Each year a different aspect of the problem is presented; in 2024 the multiplicity of existing and used tracers was at the core of the challenge. Specifically, this year's edition aims to develop a fully automatic algorithm capable of performing lesion segmentation on a PET/CT scan, without knowing the tracer, which can either be a FDG or PSMA-based tracer. In this paper we describe how we used the nnUNetv2 framework to train two sets of 6 fold ensembles of models to perform fully automatic PET/CT lesion segmentation as well as a MIP-CNN to choose which set of models to use for segmentation.
>
---
#### [replaced 030] Enhanced Generative Data Augmentation for Semantic Segmentation via Stronger Guidance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2409.06002v5](http://arxiv.org/pdf/2409.06002v5)**

> **作者:** Quang-Huy Che; Duc-Tri Le; Bich-Nga Pham; Duc-Khai Lam; Vinh-Tiep Nguyen
>
> **备注:** Published in ICPRAM 2025, ISBN 978-989-758-730-6, ISSN 2184-4313
>
> **摘要:** Data augmentation is crucial for pixel-wise annotation tasks like semantic segmentation, where labeling requires significant effort and intensive labor. Traditional methods, involving simple transformations such as rotations and flips, create new images but often lack diversity along key semantic dimensions and fail to alter high-level semantic properties. To address this issue, generative models have emerged as an effective solution for augmenting data by generating synthetic images. Controllable Generative models offer data augmentation methods for semantic segmentation tasks by using prompts and visual references from the original image. However, these models face challenges in generating synthetic images that accurately reflect the content and structure of the original image due to difficulties in creating effective prompts and visual references. In this work, we introduce an effective data augmentation pipeline for semantic segmentation using Controllable Diffusion model. Our proposed method includes efficient prompt generation using Class-Prompt Appending and Visual Prior Blending to enhance attention to labeled classes in real images, allowing the pipeline to generate a precise number of augmented images while preserving the structure of segmentation-labeled classes. In addition, we implement a class balancing algorithm to ensure a balanced training dataset when merging the synthetic and original images. Evaluation on PASCAL VOC datasets, our pipeline demonstrates its effectiveness in generating high-quality synthetic images for semantic segmentation. Our code is available at https://github.com/chequanghuy/Enhanced-Generative-Data-Augmentation-for-Semantic-Segmentation-via-Stronger-Guidance.
>
---
#### [replaced 031] MUNBa: Machine Unlearning via Nash Bargaining
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.15537v4](http://arxiv.org/pdf/2411.15537v4)**
...
>
---
#### [replaced 032] Is an Ultra Large Natural Image-Based Foundation Model Superior to a Retina-Specific Model for Detecting Ocular and Systemic Diseases?
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.06289v2](http://arxiv.org/pdf/2502.06289v2)**
...
>
---
#### [replaced 034] Replication Study and Benchmarking of Real-Time Object Detection Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.06911v2](http://arxiv.org/pdf/2405.06911v2)**

> **作者:** Pierre-Luc Asselin; Vincent Coulombe; William Guimont-Martin; William Larrivée-Hardy
>
> **备注:** Authors are presented in alphabetical order, each having equal contribution to the work
>
...
>
---
#### [replaced 035] Pulling Back the Curtain on ReLU Networks
- **分类: cs.LG; cs.CV; cs.NE; I.2.6; I.4.10**

- **链接: [http://arxiv.org/pdf/2507.22832v3](http://arxiv.org/pdf/2507.22832v3)**

> **作者:** Maciej Satkiewicz
>
> **备注:** 12 pages, 3-page appendix, 4 figures, preprint; v3 changes: changed title, improved abstract, expanded introduction, added section on implications of the path stability
>
...
>
---
#### [replaced 036] Vision-based Manipulation from Single Human Video with Open-World Object Graphs
...
>
---
#### [replaced 042] Integrating Intermediate Layer Optimization and Projected Gradient Descent for Solving Inverse Problems with Diffusion Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.20789v3](http://arxiv.org/pdf/2505.20789v3)**
...
>
---
#### [replaced 044] TriCLIP-3D: A Unified Parameter-Efficient Framework for Tri-Modal 3D Visual Grounding based on CLIP
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.14904v2](http://arxiv.org/pdf/2507.14904v2)**
...
>
---
#### [replaced 045] Real-Time Per-Garment Virtual Try-On with Temporal Consistency for Loose-Fitting Garments
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.12348v3](http://arxiv.org/pdf/2506.12348v3)**
...
>
---
#### [replaced 046] Foundations and Models in Modern Computer Vision: Key Building Blocks in Landmark Architectures
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23357v2](http://arxiv.org/pdf/2507.23357v2)**

> **作者:** Radu-Andrei Bourceanu; Neil De La Fuente; Jan Grimm; Andrei Jardan; Andriy Manucharyan; Cornelius Weiss; Daniel Cremers; Roman Pflugfelder
>
...
>
---
#### [replaced 047] DianJin-OCR-R1: Enhancing OCR Capabilities via a Reasoning-and-Tool Interleaved Vision-Language Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.13238v2](http://arxiv.org/pdf/2508.13238v2)**
...
>
---
#### [replaced 048] Defending LVLMs Against Vision Attacks through Partial-Perception Supervision
- **分类: cs.CV; cs.AI; cs.CR**

- **链接: [http://arxiv.org/pdf/2412.12722v2](http://arxiv.org/pdf/2412.12722v2)**
...
>
---
#### [replaced 049] Demographic-aware fine-grained classification of pediatric wrist fractures
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.12964v5](http://arxiv.org/pdf/2507.12964v5)**
...
>
---
#### [replaced 050] Fast rigid alignment of heterogeneous images in sliced Wasserstein distance
- **分类: cs.CV; cs.NA; math.NA**

- **链接: [http://arxiv.org/pdf/2503.13756v2](http://arxiv.org/pdf/2503.13756v2)**
...
>
---
#### [replaced 051] HLG: Comprehensive 3D Room Construction via Hierarchical Layout Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.17832v2](http://arxiv.org/pdf/2508.17832v2)**
...
>
---
#### [replaced 052] Towards Controllable Real Image Denoising with Camera Parameters
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2507.01587v2](http://arxiv.org/pdf/2507.01587v2)**

> **作者:** Youngjin Oh; Junhyeong Kwon; Keuntek Lee; Nam Ik Cho
>
> **备注:** Published in 2025 IEEE International Conference on Image Processing (ICIP)
>
...
>
---
#### [replaced 053] Imitating Radiological Scrolling: A Global-Local Attention Model for 3D Chest CT Volumes Multi-Label Anomaly Classification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.20652v5](http://arxiv.org/pdf/2503.20652v5)**
...
>
---
#### [replaced 054] DIO: Refining Mutual Information and Causal Chain to Enhance Machine Abstract Reasoning Ability
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15387v4](http://arxiv.org/pdf/2508.15387v4)**
...
>
---
#### [replaced 055] Image Embedding Sampling Method for Diverse Captioning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.10118v2](http://arxiv.org/pdf/2502.10118v2)**
...
>
---
#### [replaced 058] Cryo-em images are intrinsically low dimensional
- **分类: q-bio.QM; cs.CV; cs.LG; q-bio.BM; stat.ML**

- **链接: [http://arxiv.org/pdf/2504.11249v3](http://arxiv.org/pdf/2504.11249v3)**
