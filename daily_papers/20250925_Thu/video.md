...
- **链接: [http://arxiv.org/pdf/2509.19979v1](http://arxiv.org/pdf/2509.19979v1)**
...
- **简介: 该论文研究数据集蒸馏任务，旨在解决现有解耦方法评估不一致的问题。提出RD$^3$，系统分析不同评估设置对性能的影响，建立标准化基准，推动公平可比的研究。**
...
- **简介: 该论文提出CapStARE，一种基于胶囊的时空架构，用于实时、鲁棒的眼动估计。结合ConvNeXt、注意力路由胶囊和双GRU解码器，在多个数据集上达到SOTA性能，参数更少且可解释性更强。**
...
- **简介: 该论文提出nnFilterMatch，一种结合半监督学习与熵基伪标签过滤的医学图像分割框架。旨在减少标注需求，通过单次训练避免迭代重训，提升效率与可扩展性，在少量标注数据下实现高性能分割。**
...
- **简介: 该论文提出一种参数高效的多任务学习方法，通过渐进式任务特定适配模块减少任务干扰。在预训练模型中，早期层共享适配器，后期层逐渐任务特异化，并基于梯度计算任务相似性分配适配器。实验表明该方法在少于五分之一参数下优于全微调模型。**
...
- **简介: 该论文属于图像生成中的伪影检测任务，旨在解决训练像素级伪影检测器时人工标注数据稀缺的问题。提出了一种自动注入伪影的合成方法，生成带像素标注的数据集，有效提升了检测性能。**
...
- **简介: 该论文提出一种通过神经元-注意力分解来解释CLIP-ResNet模型的方法，旨在揭示其内部计算路径的可解释性，并将其应用于语义分割和数据集分布监测任务。**
...
- **链接: [http://arxiv.org/pdf/2509.19664v1](http://arxiv.org/pdf/2509.19664v1)**
...
- **链接: [http://arxiv.org/pdf/2509.19694v1](http://arxiv.org/pdf/2509.19694v1)**
...
- **简介: 该论文针对医学图像分割中的上下文学习（ICL）面临的数据稀缺问题，提出SynthICL框架，通过域随机化生成多样且逼真的医学数据，提升模型泛化能力。实验显示性能提升最高达63%。**
...
- **简介: 该论文研究音频驱动的虚拟人头生成任务，旨在实现精细的表情控制。提出两阶段框架：第一阶段通过AU引导生成面部关键点序列，第二阶段基于扩散模型合成视频。方法提升了表情准确性与视觉真实感。**
...
- **简介: 该论文提出SphSPS方法，用于360°球面图像的超像素分割。针对现有方法在球面几何适应性差的问题，通过最短路径算法提升分割精度与形状规则性，并在真实和合成数据集上验证了优越性。**
...
- **简介: 该论文研究自动驾驶中AI系统的透明性问题，探讨剪枝等训练方法对模型解释质量的影响。通过实验发现，剪枝能显著提升模型的可解释性和可靠性，为车载AI提供更透明的决策支持。**
...
- **链接: [http://arxiv.org/pdf/2509.20271v1](http://arxiv.org/pdf/2509.20271v1)**
...
- **简介: 该论文提出SHMoAReg，针对可变形图像配准任务，通过在编解码器中引入混合专家机制，解决特征提取不专精和形变预测同质化的问题。编码器使用混合注意力头，解码器采用空间异构混合专家，提升配准精度与模型可解释性。**
...
- **简介: 该论文提出EditVerse，一个统一的图像与视频生成与编辑框架。通过将文本、图像和视频表示为统一的token序列，利用自注意力机制实现跨模态学习，并构建了232K视频编辑数据集及首个视频编辑基准EditVerseBench，解决了视频编辑领域模型碎片化和数据稀缺的问题。**
...
- **简介: 该论文提出FAST，用于工业异常分割任务。针对现有异常合成方法采样效率低、生成质量差的问题，设计了AIAS和FARM两个模块，实现高效且高质量的异常合成，提升分割性能。**
...
- **简介: 该论文提出EfficienT-HDR，一种用于HDR重建的轻量级视觉Transformer框架。针对多曝光融合（MEF）中计算成本高和鬼影问题，设计了IAAF模块、IRE、DyT和E-MSDC等技术，实现高效且无鬼影的HDR成像，适用于边缘设备。**
...
- **简介: 该论文提出SynchroRaMa，用于音频驱动的说话人脸生成任务。针对现有方法情感表达示弱、动作单一的问题，通过多模态情感嵌入（文本+音频）和LLM场景描述增强表情与动作的真实性和多样性，提升视频自然度与一致性。**
...
- **简介: 该论文提出PerFace，用于人脸匿名化任务，旨在解决现有方法难以平衡匿名性与自然性的难题。通过构建感知相似度度量模型，利用三元组标注数据和度量学习提升人脸相似度预测效果。**
...
- **链接: [http://arxiv.org/pdf/2509.20022v1](http://arxiv.org/pdf/2509.20022v1)**
...
- **简介: 该论文属于隐私保护任务，旨在解决生物识别认证中用户数据泄露和滥用的问题。作者提出基于生成对抗网络（GAN）的方法，将人脸图像转换为非敏感图像（如花朵或鞋子），用于训练认证分类器，从而在保障隐私的同时保持系统实用性。**
...
- **简介: 该论文属于计算机视觉领域，旨在探讨CNN是否依赖纹理特征。作者提出一种无偏框架，通过系统抑制形状、纹理和颜色线索，发现CNN主要依赖局部形状特征，并分析了不同任务下的特征依赖差异。**
...
- **简介: 该论文提出GS-RoadPatching，一种面向驾驶场景的3D高斯泼溅（3DGS）补全方法。针对现有方法依赖2D生成模型、效率低的问题，通过3D空间特征匹配与替换优化，实现高效、高质量的3D场景修补，提升了视觉一致性与通用性。**
...
- **简介: 该论文针对图像去雾任务，提出DiffLI$^2$D方法。通过利用预训练扩散模型的语义潜在空间特性，避免了重新训练和迭代采样，有效提升了去雾性能。**
...
- **简介: 该论文提出基于视频生成用户投诉文本的新任务CoD-V，构建含1,175个视频的多模态数据集ComVID，并设计CR评估指标及改进模型VideoLLaMA2-7b，以帮助用户更清晰地表达投诉内容。**
...
- **简介: 该论文研究了高分辨率遥感数据中云和云影分割任务，旨在提升甲烷浓度反演精度。针对MethaneSAT/AIR任务，对比了传统方法与深度学习模型（UNet、SCAN），发现SCAN在卫星数据上表现最优，有效提升了检测质量。**
...
>
---
#### [new 064] StrCGAN: A Generative Framework for Stellar Image Restoration
- **分类: cs.CV; astro-ph.IM; astro-ph.SR**

- **简介: 该论文提出StrCGAN，用于提升天文图像的分辨率和质量。针对小望远镜观测图像分辨率低的问题，通过引入3D卷积、多光谱融合和天体物理正则化模块，改进CycleGAN框架，在保持星体形态的同时实现更真实的图像重建。**

- **链接: [http://arxiv.org/pdf/2509.19805v1](http://arxiv.org/pdf/2509.19805v1)**
...
>
---
#### [new 065] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
- **分类: cs.CV**

- **简介: 该论文提出PU-Gaussian，用于点云上采样任务。针对传感器生成的稀疏噪声点云问题，利用各向异性3D高斯分布建模局部结构，通过显式采样和后续优化网络生成密集、高质量点云，在PU1K和PUGAN数据集上取得SOTA效果。**

- **链接: [http://arxiv.org/pdf/2509.20207v1](http://arxiv.org/pdf/2509.20207v1)**
...
>
> **摘要:** Point clouds produced by 3D sensors are often sparse and noisy, posing challenges for tasks requiring dense and high-fidelity 3D representations. Prior work has explored both implicit feature-based upsampling and distance-function learning to address this, but often at the expense of geometric interpretability or robustness to input sparsity. To overcome these limitations, we propose PU-Gaussian, a novel upsampling network that models the local neighborhood around each point using anisotropic 3D Gaussian distributions. These Gaussians capture the underlying geometric structure, allowing us to perform upsampling explicitly in the local geometric domain by direct point sampling. The sampling process generates a dense, but coarse, point cloud. A subsequent refinement network adjusts the coarse output to produce a more uniform distribution and sharper edges. We perform extensive testing on the PU1K and PUGAN datasets, demonstrating that PU-Gaussian achieves state-of-the-art performance. We make code and model weights publicly available at https://github.com/mvg-inatech/PU-Gaussian.git.
>
---
#### [new 066] HiPerformer: A High-Performance Global-Local Segmentation Model with Modular Hierarchical Fusion Strategy
- **分类: cs.CV**

- **简介: 该论文提出HiPerformer，用于医学图像分割任务。针对现有方法在融合局部细节与全局信息时存在的特征不一致和信息丢失问题，设计了模块化分层架构、LGFF模块和PPA模块，实现了更高效准确的特征融合，提升了分割性能。**

- **链接: [http://arxiv.org/pdf/2509.20280v1](http://arxiv.org/pdf/2509.20280v1)**
...
>
---
#### [new 070] Logics-Parsing Technical Report
- **分类: cs.CV**

- **简介: 该论文提出Logics-Parsing，一种基于LVLM并结合强化学习的端到端文档解析模型，旨在解决复杂版式（如多栏、海报）的结构化输出问题。通过设计奖励机制和引入多样化数据进行微调，并构建LogicsParsingBench评估集，验证了模型在多种场景下的SOTA性能。**

- **链接: [http://arxiv.org/pdf/2509.19760v1](http://arxiv.org/pdf/2509.19760v1)**
...
>
---
#### [new 071] EchoBench: Benchmarking Sycophancy in Medical Large Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出了EchoBench，用于评估医学大视觉语言模型（LVLMs）在临床场景中的顺从性问题。通过分析多个模型的顺从表现，研究发现所有模型均存在较高顺从性，并探索了缓解策略，旨在提升模型的安全性和可靠性。**

- **链接: [http://arxiv.org/pdf/2509.20146v1](http://arxiv.org/pdf/2509.20146v1)**
...
>
> **摘要:** Recent benchmarks for medical Large Vision-Language Models (LVLMs) emphasize leaderboard accuracy, overlooking reliability and safety. We study sycophancy -- models' tendency to uncritically echo user-provided information -- in high-stakes clinical settings. We introduce EchoBench, a benchmark to systematically evaluate sycophancy in medical LVLMs. It contains 2,122 images across 18 departments and 20 modalities with 90 prompts that simulate biased inputs from patients, medical students, and physicians. We evaluate medical-specific, open-source, and proprietary LVLMs. All exhibit substantial sycophancy; the best proprietary model (Claude 3.7 Sonnet) still shows 45.98% sycophancy, and GPT-4.1 reaches 59.15%. Many medical-specific models exceed 95% sycophancy despite only moderate accuracy. Fine-grained analyses by bias type, department, perceptual granularity, and modality identify factors that increase susceptibility. We further show that higher data quality/diversity and stronger domain knowledge reduce sycophancy without harming unbiased accuracy. EchoBench also serves as a testbed for mitigation: simple prompt-level interventions (negative prompting, one-shot, few-shot) produce consistent reductions and motivate training- and decoding-time strategies. Our findings highlight the need for robust evaluation beyond accuracy and provide actionable guidance toward safer, more trustworthy medical LVLMs.
>
---
#### [new 072] Table Detection with Active Learning
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **简介: 该论文聚焦表格检测任务，旨在解决标注成本高的问题。提出结合多样性与不确定性策略的主动学习方法，有效减少标注量，提升模型性能。实验表明，在有限预算下，其方法在基准数据集上优于随机采样。**

- **链接: [http://arxiv.org/pdf/2509.20003v1](http://arxiv.org/pdf/2509.20003v1)**
...
>
---
#### [new 073] U-Mamba2-SSL for Semi-Supervised Tooth and Pulp Segmentation in CBCT
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出U-Mamba2-SSL，用于CBCT图像中的牙齿和牙髓半监督分割。针对标注数据少的问题，采用自监督预训练、一致性正则化和伪标签策略，有效利用未标注数据，提升了分割性能。**

- **链接: [http://arxiv.org/pdf/2509.20154v1](http://arxiv.org/pdf/2509.20154v1)**
...
>
---
#### [new 074] CAMILA: Context-Aware Masking for Image Editing with Language Alignment
- **分类: cs.CV**

- **简介: 该论文提出CAMILA，用于文本引导的图像编辑任务，旨在解决用户指令与图像内容不一致导致的不合理输出问题。通过上下文感知的掩码机制，筛选并执行可行的编辑指令，提升语义对齐与图像完整性。**

- **链接: [http://arxiv.org/pdf/2509.19731v1](http://arxiv.org/pdf/2509.19731v1)**
...
>
---
#### [new 075] Enhancing Transformer-Based Vision Models: Addressing Feature Map Anomalies Through Novel Optimization Strategies
- **分类: cs.CV**

- **简介: 该论文针对视觉Transformer（ViT）特征图中的结构化噪声问题，提出两种轻量优化方法：STA和ANF。STA通过空间扰动增强token多样性，ANF在层间进行自适应去噪。实验表明，这两种方法能有效提升模型性能与可解释性。**

- **链接: [http://arxiv.org/pdf/2509.19687v1](http://arxiv.org/pdf/2509.19687v1)**
...
>
---
#### [new 080] Queryable 3D Scene Representation: A Multi-Modal Framework for Semantic Reasoning and Robotic Task Planning
...
>
---
#### [new 081] Anatomy of a Feeling: Narrating Embodied Emotions via Large Vision-Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 082] HUNT: High-Speed UAV Navigation and Tracking in Unstructured Environments via Instantaneous Relative Frames
...
>
---
#### [new 083] EgoBridge: Domain Adaptation for Generalizable Imitation from Egocentric Human Data
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [new 084] CHURRO: Making History Readable with an Open-Weight Large Vision-Language Model for High-Accuracy, Low-Cost Historical Text Recognition
- **分类: cs.CL; cs.CV**

- **简介: 该论文提出CHURRO，一个面向历史文本识别的3B参数开源视觉-语言模型。针对历史文献语言多样、布局不规整和退化问题，构建了包含155个语料库的CHURRO-DS数据集，并在识别准确率和成本效益上优于现有模型。**
...
>
---
#### [new 085] Video models are zero-shot learners and reasoners
...
>
---
#### [new 086] Predictive Coding-based Deep Neural Network Fine-tuning for Computationally Efficient Domain Adaptation
- **分类: cs.LG; cs.CV; cs.NE**

- **简介: 该论文提出一种结合反向传播和预测编码的混合训练方法，用于高效域适应。任务是计算高效的模型自适应，解决因数据分布变化导致的性能下降问题。方法先离线训练模型，再在线用预测编码适应新数据，适用于边缘设备。**

- **链接: [http://arxiv.org/pdf/2509.20269v1](http://arxiv.org/pdf/2509.20269v1)**
...
>
---
#### [new 087] Design Insights and Comparative Evaluation of a Hardware-Based Cooperative Perception Architecture for Lane Change Prediction
- **分类: cs.AI; cs.AR; cs.CV; cs.LG**

- **简介: 该论文研究基于硬件的协同感知架构用于车道变换预测，旨在解决实际部署中的感知、通信与交通行为建模问题。通过真实硬件部署，分析了系统瓶颈、可靠性及操作限制，总结实践经验为同类系统提供指导。**

- **链接: [http://arxiv.org/pdf/2509.20218v1](http://arxiv.org/pdf/2509.20218v1)**
...
>
---
#### [new 088] Frequency-Aware Ensemble Learning for BraTS 2025 Pediatric Brain Tumor Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文针对儿童脑肿瘤分割任务，提出一种集成学习方法，结合nnU-Net、Swin UNETR和HFF-Net，通过初始化调整、迁移学习和频域分解提升模型性能，在BraTS-PED 2025数据集上取得优异结果。**

- **链接: [http://arxiv.org/pdf/2509.19353v1](http://arxiv.org/pdf/2509.19353v1)**
...
>
---
#### [new 089] TIMED: Adversarial and Autoregressive Refinement of Diffusion-Based Time Series Generation
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出TIMED，一种用于时间序列生成的统一框架，结合扩散模型、自回归监督和对抗学习，解决高质量合成时间序列生成的问题，提升序列的真实性和时序连贯性。**

- **链接: [http://arxiv.org/pdf/2509.19638v1](http://arxiv.org/pdf/2509.19638v1)**
...
>
---
#### [new 090] VisualMimic: Visual Humanoid Loco-Manipulation via Motion Tracking and Generation
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [new 091] Ensuring Reliable Participation in Subjective Video Quality Tests Across Platforms
- **分类: eess.IV; cs.CV; cs.MM**

- **简介: 该论文属于主观视频质量评估（VQA）研究，旨在解决众包测试中用户不按规则操作导致结果偏差的问题。提出了客观和主观检测方法，识别远程桌面用户，并对比了两个主流平台在实际测试中的表现与应对能力。**

- **链接: [http://arxiv.org/pdf/2509.20001v1](http://arxiv.org/pdf/2509.20001v1)**

> **作者:** Babak Naderi; Ross Cutler
>
> **摘要:** Subjective video quality assessment (VQA) is the gold standard for measuring end-user experience across communication, streaming, and UGC pipelines. Beyond high-validity lab studies, crowdsourcing offers accurate, reliable, faster, and cheaper evaluation-but suffers from unreliable submissions by workers who ignore instructions or game rewards. Recent tests reveal sophisticated exploits of video metadata and rising use of remote-desktop (RD) connections, both of which bias results. We propose objective and subjective detectors for RD users and compare two mainstream crowdsourcing platforms on their susceptibility and mitigation under realistic test conditions and task designs.
>
---
#### [new 092] C${}^2$Prompt: Class-aware Client Knowledge Interaction for Federated Continual Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究联邦持续学习任务，旨在解决跨客户端的时序和空间遗忘问题。针对现有基于提示的方法在类间知识一致性上的不足，提出C²Prompt方法，通过类分布补偿和类感知聚合增强类级知识一致性，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2509.19674v1](http://arxiv.org/pdf/2509.19674v1)**
...
>
---
#### [new 093] ROPA: Synthetic Robot Pose Generation for RGB-D Bimanual Data Augmentation
...
>
---
#### [new 094] Agentic Scene Policies: Unifying Space, Semantics, and Affordances for Robot Action
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 095] MultiSoundGen: Video-to-Audio Generation for Multi-Event Scenarios via SlowFast Contrastive Audio-Visual Pretraining and Direct Preference Optimization
...
#### [replaced 001] LEMUR Neural Network Dataset: Towards Seamless AutoML
- **分类: cs.LG; cs.AI; cs.CV; cs.DL**

- **链接: [http://arxiv.org/pdf/2504.10552v4](http://arxiv.org/pdf/2504.10552v4)**
...
>
---
#### [replaced 003] OmniWorld: A Multi-Domain and Multi-Modal Dataset for 4D World Modeling
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.12201v2](http://arxiv.org/pdf/2509.12201v2)**
...
>
---
#### [replaced 004] To Fold or Not to Fold: Graph Regularized Tensor Train for Visual Data Completion
- **分类: eess.SP; cs.CV**
...
>
---
#### [replaced 005] Online Language Splatting
...
>
---
#### [replaced 006] PerceptronCARE: A Deep Learning-Based Intelligent Teleophthalmology Application for Diabetic Retinopathy Diagnosis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.18160v2](http://arxiv.org/pdf/2509.18160v2)**

> **作者:** Akwasi Asare; Isaac Baffour Senkyire; Emmanuel Freeman; Mary Sagoe; Simon Hilary Ayinedenaba Aluze-Ele; Kelvin Kwao
>
...
>
---
#### [replaced 012] MOIS-SAM2: Exemplar-based Segment Anything Model 2 for multilesion interactive segmentation of neurofibromas in whole-body MRI
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.19277v2](http://arxiv.org/pdf/2509.19277v2)**

> **作者:** Georgii Kolokolnikov; Marie-Lena Schmalhofer; Sophie Goetz; Lennart Well; Said Farschtschi; Victor-Felix Mautner; Inka Ristow; Rene Werner
>
...
>
---
#### [replaced 013] Lost in Translation? Vocabulary Alignment for Source-Free Domain Adaptation in Open-Vocabulary Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.15225v2](http://arxiv.org/pdf/2509.15225v2)**
...
>
---
#### [replaced 014] VER-Bench: Evaluating MLLMs on Reasoning with Fine-Grained Visual Evidence
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.04852v2](http://arxiv.org/pdf/2508.04852v2)**
...
>
---
#### [replaced 017] Rethinking Pulmonary Embolism Segmentation: A Study of Current Approaches and Challenges with an Open Weight Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.18308v2](http://arxiv.org/pdf/2509.18308v2)**

> **作者:** Yixin Zhang; Ryan Chamberlain; Lawrence Ngo; Kevin Kramer; Maciej A. Mazurowski
>
...
>
---
#### [replaced 018] LEDiT: Your Length-Extrapolatable Diffusion Transformer without Positional Encoding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.04344v3](http://arxiv.org/pdf/2503.04344v3)**
...
>
---
#### [replaced 020] Multimodal Reference Visual Grounding
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.02876v2](http://arxiv.org/pdf/2504.02876v2)**

> **作者:** Yangxiao Lu; Ruosen Li; Liqiang Jing; Jikai Wang; Xinya Du; Yunhui Guo; Nicholas Ruozzi; Yu Xiang
>
> **备注:** Project page with our code and dataset: https://irvlutd.github.io/MultiGrounding
>
> **摘要:** Visual grounding focuses on detecting objects from images based on language expressions. Recent Large Vision-Language Models (LVLMs) have significantly advanced visual grounding performance by training large models with large-scale datasets. However, the problem remains challenging, especially when similar objects appear in the input image. For example, an LVLM may not be able to differentiate Diet Coke and regular Coke in an image. In this case, if additional reference images of Diet Coke and regular Coke are available, it can help the visual grounding of similar objects. In this work, we introduce a new task named Multimodal Reference Visual Grounding (MRVG). In this task, a model has access to a set of reference images of objects in a database. Based on these reference images and a language expression, the model is required to detect a target object from a query image. We first introduce a new dataset to study the MRVG problem. Then we introduce a novel method, named MRVG-Net, to solve this visual grounding problem. We show that by efficiently using reference images with few-shot object detection and using Large Language Models (LLMs) for object matching, our method achieves superior visual grounding performance compared to the state-of-the-art LVLMs such as Qwen2.5-VL-72B. Our approach bridges the gap between few-shot detection and visual grounding, unlocking new capabilities for visual understanding, which has wide applications in robotics. Project page with our video, code, and dataset: https://irvlutd.github.io/MultiGrounding
>
---
#### [replaced 021] COLT: Enhancing Video Large Language Models with Continual Tool Usage
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.18754v2](http://arxiv.org/pdf/2509.18754v2)**
...
>
---
#### [replaced 024] RG-Attn: Radian Glue Attention for Multi-modality Multi-agent Cooperative Perception
...
>
---
#### [replaced 025] OmniSpatial: Towards Comprehensive Spatial Reasoning Benchmark for Vision Language Models
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.03135v2](http://arxiv.org/pdf/2506.03135v2)**
...
>
---
#### [replaced 026] Latent Wavelet Diffusion For Ultra-High-Resolution Image Synthesis
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2506.00433v3](http://arxiv.org/pdf/2506.00433v3)**
...
>
---
#### [replaced 027] Probabilistic Online Event Downsampling
- **分类: cs.CV; cs.ET**

- **链接: [http://arxiv.org/pdf/2506.02547v2](http://arxiv.org/pdf/2506.02547v2)**

> **作者:** Andreu Girbau-Xalabarder; Jun Nagata; Shinichi Sumiyoshi; Ricard Marsal; Shin'ichi Satoh
>
> **备注:** Best paper award finalist at CVPR 2025 Event-Vision workshop
>
...
>
---
#### [replaced 028] HAZEMATCHING: Dehazing Light Microscopy Images with Guided Conditional Flow Matching
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.22397v4](http://arxiv.org/pdf/2506.22397v4)**

> **作者:** Anirban Ray; Ashesh; Florian Jug
>
> **备注:** 4 figures, 9 pages + refs, 38 pages total (including supplement), 23 supplementary figures
>
...
>
---
#### [replaced 029] Ctrl-Room: Controllable Text-to-3D Room Meshes Generation with Layout Constraints
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2310.03602v5](http://arxiv.org/pdf/2310.03602v5)**
...
>
---
#### [replaced 030] Deciphering Functions of Neurons in Vision-Language Models
- **分类: q-bio.NC; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.18485v4](http://arxiv.org/pdf/2502.18485v4)**

> **作者:** Jiaqi Xu; Cuiling Lan; Yan Lu
>
> **备注:** Accepted by the 31st ACM International Conference on Multimedia (ACM MM 2025)
>
...
>
---
#### [replaced 033] Diffusion Curriculum: Synthetic-to-Real Generative Curriculum Learning via Image-Guided Diffusion
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2410.13674v3](http://arxiv.org/pdf/2410.13674v3)**
...
>
---
#### [replaced 034] NERO: Explainable Out-of-Distribution Detection with Neuron-level Relevance
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.15404v2](http://arxiv.org/pdf/2506.15404v2)**
...
>
---
#### [replaced 035] Multimodal Chain of Continuous Thought for Latent-Space Reasoning in Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12587v2](http://arxiv.org/pdf/2508.12587v2)**
...
>
> **备注:** Tech Report, Project Page: https://yanxinhao.github.io/Projects/X-Part/
>
...
>
---
#### [replaced 038] Towards Visual Text Grounding of Multimodal Large Language Model
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.04974v2](http://arxiv.org/pdf/2504.04974v2)**
...
>
> **摘要:** Despite the existing evolution of Multimodal Large Language Models (MLLMs), a non-neglectable limitation remains in their struggle with visual text grounding, especially in text-rich images of documents. Document images, such as scanned forms and infographics, highlight critical challenges due to their complex layouts and textual content. However, current benchmarks do not fully address these challenges, as they mostly focus on visual grounding on natural images, rather than text-rich document images. Thus, to bridge this gap, we introduce TRIG, a novel task with a newly designed instruction dataset for benchmarking and improving the Text-Rich Image Grounding capabilities of MLLMs in document question-answering. Specifically, we propose an OCR-LLM-human interaction pipeline to create 800 manually annotated question-answer pairs as a benchmark and a large-scale training set of 90$ synthetic data based on four diverse datasets. A comprehensive evaluation of various MLLMs on our proposed benchmark exposes substantial limitations in their grounding capability on text-rich images. In addition, we propose two simple and effective TRIG methods based on general instruction tuning and plug-and-play efficient embedding, respectively. By finetuning MLLMs on our synthetic dataset, they promisingly improve spatial reasoning and grounding capabilities.
>
---
#### [replaced 039] Replay-Free Continual Low-Rank Adaptation with Dynamic Memory
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.00623v3](http://arxiv.org/pdf/2411.00623v3)**
...
>
---
#### [replaced 040] CLOSP: A Unified Semantic Space for SAR, MSI, and Text in Remote Sensing
- **分类: cs.CV; cs.CL; cs.IR; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.10403v2](http://arxiv.org/pdf/2507.10403v2)**
...
>
---
#### [replaced 041] Intervening in Black Box: Concept Bottleneck Model for Enhancing Human Neural Network Mutual Understanding
- **分类: cs.CV; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.22803v3](http://arxiv.org/pdf/2506.22803v3)**

> **作者:** Nuoye Xiong; Anqi Dong; Ning Wang; Cong Hua; Guangming Zhu; Lin Mei; Peiyi Shen; Liang Zhang
>
> **备注:** Accepted by ICCV 2025
>
...
>
---
#### [replaced 042] ChartQA-X: Generating Explanations for Visual Chart Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.13275v3](http://arxiv.org/pdf/2504.13275v3)**
...
>
---
#### [replaced 046] From Slow Bidirectional to Fast Autoregressive Video Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.07772v4](http://arxiv.org/pdf/2412.07772v4)**

> **作者:** Tianwei Yin; Qiang Zhang; Richard Zhang; William T. Freeman; Fredo Durand; Eli Shechtman; Xun Huang
>
> **备注:** CVPR 2025. Project Page: https://causvid.github.io/
>
> **摘要:** Current video diffusion models achieve impressive generation quality but struggle in interactive applications due to bidirectional attention dependencies. The generation of a single frame requires the model to process the entire sequence, including the future. We address this limitation by adapting a pretrained bidirectional diffusion transformer to an autoregressive transformer that generates frames on-the-fly. To further reduce latency, we extend distribution matching distillation (DMD) to videos, distilling 50-step diffusion model into a 4-step generator. To enable stable and high-quality distillation, we introduce a student initialization scheme based on teacher's ODE trajectories, as well as an asymmetric distillation strategy that supervises a causal student model with a bidirectional teacher. This approach effectively mitigates error accumulation in autoregressive generation, allowing long-duration video synthesis despite training on short clips. Our model achieves a total score of 84.27 on the VBench-Long benchmark, surpassing all previous video generation models. It enables fast streaming generation of high-quality videos at 9.4 FPS on a single GPU thanks to KV caching. Our approach also enables streaming video-to-video translation, image-to-video, and dynamic prompting in a zero-shot manner.
>
---
#### [replaced 047] SoFar: Language-Grounded Orientation Bridges Spatial Reasoning and Object Manipulation
...
>
---
#### [replaced 048] Minimal Semantic Sufficiency Meets Unsupervised Domain Generalization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.15791v2](http://arxiv.org/pdf/2509.15791v2)**
...
>
---
#### [replaced 049] Chirality in Action: Time-Aware Video Representation Learning by Latent Straightening
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.08502v2](http://arxiv.org/pdf/2509.08502v2)**
...
>
---
#### [replaced 050] Sparse VideoGen2: Accelerate Video Generation with Sparse Attention via Semantic-Aware Permutation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18875v2](http://arxiv.org/pdf/2505.18875v2)**
...
>
---
#### [replaced 054] Citrus-V: Advancing Medical Foundation Models with Unified Medical Image Grounding for Clinical Reasoning
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.19090v2](http://arxiv.org/pdf/2509.19090v2)**
...
>
---
#### [replaced 057] Infrared Image Super-Resolution: Systematic Review, and Future Trends
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2212.12322v5](http://arxiv.org/pdf/2212.12322v5)**

> **作者:** Yongsong Huang; Tomo Miyazaki; Xiaofeng Liu; Shinichiro Omachi
>
> **备注:** This work has been submitted to the IEEE JSTARS for possible publication
>
> **摘要:** Image Super-Resolution (SR) is essential for a wide range of computer vision and image processing tasks. Investigating infrared (IR) image (or thermal images) super-resolution is a continuing concern within the development of deep learning. This survey aims to provide a comprehensive perspective of IR image super-resolution, including its applications, hardware imaging system dilemmas, and taxonomy of image processing methodologies. In addition, the datasets and evaluation metrics in IR image super-resolution tasks are also discussed. Furthermore, the deficiencies in current technologies and possible promising directions for the community to explore are highlighted. To cope with the rapid development in this field, we intend to regularly update the relevant excellent work at https://github.com/yongsongH/Infrared_Image_SR_Survey.
>
---
#### [replaced 058] PolypSeg-GradCAM: Towards Explainable Computer-Aided Gastrointestinal Disease Detection Using U-Net Based Segmentation and Grad-CAM Visualization on the Kvasir Dataset
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.18159v2](http://arxiv.org/pdf/2509.18159v2)**
...
>
---
#### [replaced 061] VLM See, Robot Do: Human Demo Video to Robot Action Plan via Vision Language Model
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**
...
>
---
#### [replaced 064] AutoOEP -- A Multi-modal Framework for Online Exam Proctoring
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.10887v2](http://arxiv.org/pdf/2509.10887v2)**
...
>
---
#### [replaced 065] Investigating Traffic Accident Detection Using Multimodal Large Language Models
- **分类: cs.CV; cs.SE**

- **链接: [http://arxiv.org/pdf/2509.19096v2](http://arxiv.org/pdf/2509.19096v2)**
...
>
---
#### [replaced 066] GraphEQA: Using 3D Semantic Scene Graphs for Real-time Embodied Question Answering
...
>
---
#### [replaced 067] Challenges and Trends in Egocentric Vision: A Survey
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.15275v4](http://arxiv.org/pdf/2503.15275v4)**
...
>
---
#### [replaced 072] Cross-Domain Underwater Image Enhancement Guided by No-Reference Image Quality Assessment: A Transfer Learning Approach
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.17937v2](http://arxiv.org/pdf/2503.17937v2)**
...
>
---
#### [replaced 073] SurgVidLM: Towards Multi-grained Surgical Video Understanding with Large Language Model
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.17873v2](http://arxiv.org/pdf/2506.17873v2)**
...
>
---
#### [replaced 074] Imaging Biomarkers for Neurodegenerative Diseases from Detailed Segmentation of Medial Temporal Lobe Subregions on in vivo Brain MRI Using Upsampling Strategy Guided by High-resolution ex vivo MRI
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.18442v2](http://arxiv.org/pdf/2504.18442v2)**

> **作者:** Yue Li; Pulkit Khandelwal; Long Xie; Laura E. M. Wisse; Amanda E. Denning; Christopher A. Brown; Emily McGrew; Sydney A. Lim; Niyousha Sadeghpour; Sadhana Ravikumar; Ranjit Ittyerah; Eunice Chung; Daniel T. Ohm; Nidhi S. Mundada; María Mercedes Íñiguez de Onzoño Martín; María del Mar Arroyo Jiménez; Monica Mũnoz; Maria del Pilar Marcos Rabal; David J. Irwin; Edward B. Lee; Ricardo Insausti; Sandhitsu R. Das; David A. Wolk; Paul A. Yushkevich
>
...
>
---
#### [replaced 075] Adversarial Robustness of Discriminative Self-Supervised Learning in Vision
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.06361v2](http://arxiv.org/pdf/2503.06361v2)**
...
>
---
#### [replaced 076] Understanding-in-Generation: Reinforcing Generative Capability of Unified Model via Infusing Understanding into Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.18639v2](http://arxiv.org/pdf/2509.18639v2)**
...
>
---
#### [replaced 077] An Optimized PatchMatch for Multi-scale and Multi-feature Label Fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/1903.07165v2](http://arxiv.org/pdf/1903.07165v2)**

> **作者:** Rémi Giraud; Vinh-Thong Ta; Nicolas Papadakis; José V. Manjón; D. Louis Collins; Pierrick Coupé; Alzheimer's Disease Neuroimaging Initiative
>
> **备注:** Neuroimage 2016
>
> **摘要:** Automatic segmentation methods are important tools for quantitative analysis of Magnetic Resonance Images (MRI). Recently, patch-based label fusion approaches have demonstrated state-of-the-art segmentation accuracy. In this paper, we introduce a new patch-based label fusion framework to perform segmentation of anatomical structures. The proposed approach uses an Optimized PAtchMatch Label fusion (OPAL) strategy that drastically reduces the computation time required for the search of similar patches. The reduced computation time of OPAL opens the way for new strategies and facilitates processing on large databases. In this paper, we investigate new perspectives offered by OPAL, by introducing a new multi-scale and multi-feature framework. During our validation on hippocampus segmentation we use two datasets: young adults in the ICBM cohort and elderly adults in the EADC-ADNI dataset. For both, OPAL is compared to state-of-the-art methods. Results show that OPAL obtained the highest median Dice coefficient (89.9% for ICBM and 90.1% for EADC-ADNI). Moreover, in both cases, OPAL produced a segmentation accuracy similar to inter-expert variability. On the EADC-ADNI dataset, we compare the hippocampal volumes obtained by manual and automatic segmentation. The volumes appear to be highly correlated that enables to perform more accurate separation of pathological populations.
>
---
#### [replaced 078] SEM: Enhancing Spatial Understanding for Robust Robot Manipulation
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 079] EndoBench: A Comprehensive Evaluation of Multi-Modal Large Language Models for Endoscopy Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23601v2](http://arxiv.org/pdf/2505.23601v2)**
