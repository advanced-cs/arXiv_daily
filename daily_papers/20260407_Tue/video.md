...
>
---
#### [new 006] Reinforce to Learn, Elect to Reason: A Dual Paradigm for Video Reasoning
- **分类: cs.CV**

- **简介: 该论文提出RLER框架，解决视频推理中证据不明确的问题。通过双范式训练与推理，提升模型可靠性与可解释性。**

- **链接: [https://arxiv.org/pdf/2604.04379](https://arxiv.org/pdf/2604.04379)**
...
>
---
#### [new 007] PollutionNet: A Vision Transformer Framework for Climatological Assessment of NO$_2$ and SO$_2$ Using Satellite-Ground Data Fusion
- **分类: cs.CV; physics.ao-ph**

- **简介: 该论文属于大气污染评估任务，旨在解决卫星与地面数据融合问题，提出PollutionNet框架提升NO₂和SO₂预测精度。**

- **链接: [https://arxiv.org/pdf/2604.03311](https://arxiv.org/pdf/2604.03311)**
...
>
---
#### [new 017] Multimodal Structure Learning: Disentangling Shared and Specific Topology via Cross-Modal Graphical Lasso
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于多模态学习任务，旨在解决高维噪声和模态对齐问题。通过引入CM-GLasso方法，实现共享与特定拓扑的解耦，提升生成分类和语义分割性能。**

- **链接: [https://arxiv.org/pdf/2604.03953](https://arxiv.org/pdf/2604.03953)**
...
>
---
#### [new 018] 4C4D: 4 Camera 4D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于4D动态场景重建任务，解决从少量相机视频中恢复高保真4D场景的问题。提出4C4D框架，通过优化几何建模提升渲染效果。**

- **链接: [https://arxiv.org/pdf/2604.04063](https://arxiv.org/pdf/2604.04063)**
...
>
---
#### [new 020] VidNum-1.4K: A Comprehensive Benchmark for Video-based Numerical Reasoning
- **分类: cs.CV**

- **简介: 该论文提出VidNum-1.4K，一个视频数值推理基准，用于评估视觉语言模型的真实数值推理能力。解决现有基准领域狭窄、任务浅显的问题，通过多层级结构测试模型的算术、比较和逻辑推理能力。**
...
>
---
#### [new 021] HorizonWeaver: Generalizable Multi-Level Semantic Editing for Driving Scenes
- **分类: cs.CV**

- **简介: 该论文提出HorizonWeaver，解决自动驾驶场景的多粒度语义编辑问题，通过数据、模型和训练优化，实现高精度、可控制的场景生成。**

- **链接: [https://arxiv.org/pdf/2604.04887](https://arxiv.org/pdf/2604.04887)**
...
>
---
#### [new 031] Physics-Informed Untrained Learning for RGB-Guided Superresolution Single-Pixel Hyperspectral Imaging
- **分类: cs.CV; physics.optics**

- **简介: 该论文属于 hyperspectral imaging 任务，解决低采样率下高保真重建问题。提出无需训练数据的物理引导框架，结合RGB指导实现超分辨率重建。**

- **链接: [https://arxiv.org/pdf/2604.03572](https://arxiv.org/pdf/2604.03572)**
...
>
---
#### [new 032] Temporal Inversion for Learning Interval Change in Chest X-Rays
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出TILA框架，解决医学影像中时间变化检测问题，通过时间反转增强模型对时间顺序的敏感性。**
...
>
---
#### [new 033] Intelligent Traffic Monitoring with YOLOv11: A Case Study in Real-Time Vehicle Detection
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于交通监控任务，旨在实现高效实时车辆检测与计数。通过集成YOLOv11和跟踪算法，构建了一个无需云端的智能监控系统。**

- **链接: [https://arxiv.org/pdf/2604.04080](https://arxiv.org/pdf/2604.04080)**
...
>
---
#### [new 034] StableTTA: Training-Free Test-Time Adaptation that Improves Model Accuracy on ImageNet1K to 96%
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像分类任务，解决模型预测稳定性问题。提出StableTTA方法，在不训练的情况下提升聚合稳定性，显著提高ImageNet-1K准确率。**
...
>
---
#### [new 039] Don't Waste Bits! Adaptive KV-Cache Quantization for Lightweight On-Device LLMs
- **分类: cs.CV**

- **简介: 该论文属于自然语言处理任务，解决LLM在设备端部署中的KV缓存内存与带宽瓶颈问题。通过自适应量化策略，动态分配比特宽度，提升效率与精度。**

- **链接: [https://arxiv.org/pdf/2604.04722](https://arxiv.org/pdf/2604.04722)**
...
>
---
#### [new 041] Learning Superpixel Ensemble and Hierarchy Graphs for Melanoma Detection
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于皮肤癌检测任务，旨在提升黑色素瘤识别精度。通过构建超像素图结构，结合纹理特征进行分类，实现高准确率的检测。**

- **链接: [https://arxiv.org/pdf/2604.03710](https://arxiv.org/pdf/2604.03710)**
...
>
---
#### [new 044] A reconfigurable smart camera implementation for jet flames characterization based on an optimized segmentation model
- **分类: cs.CV; cs.AI**

- **简介: 论文提出一种可重构智能相机系统，用于工业喷射火焰的实时识别与分析。针对工业火灾早期检测中缺乏实时分割方案的问题，优化UNet模型并部署到SoC FPGA，实现低延迟、高精度的火焰特征提取。**

- **链接: [https://arxiv.org/pdf/2604.03267](https://arxiv.org/pdf/2604.03267)**
...
>
---
#### [new 045] When Sinks Help or Hurt: Unified Framework for Attention Sink in Large Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文研究视觉-语言模型中注意力下沉现象，探讨其对模型性能的影响，并提出一种轻量级模块以优化注意力分配，提升多模态任务表现。**

- **链接: [https://arxiv.org/pdf/2604.03316](https://arxiv.org/pdf/2604.03316)**
...
>
---
#### [new 046] XAttnRes: Cross-Stage Attention Residuals for Medical Image Segmentation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出XAttnRes，用于医学图像分割任务，解决传统残差连接信息流不足的问题。通过跨阶段注意力聚合，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2604.03297](https://arxiv.org/pdf/2604.03297)**
...
>
---
#### [new 047] Your Pre-trained Diffusion Model Secretly Knows Restoration
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像修复任务，旨在解决如何有效利用预训练扩散模型进行修复的问题。通过学习提示嵌入解锁模型的修复能力，无需微调或控制模块。**

- **链接: [https://arxiv.org/pdf/2604.04924](https://arxiv.org/pdf/2604.04924)**
...
>
---
#### [new 052] Vero: An Open RL Recipe for General Visual Reasoning
...
>
---
#### [new 053] Beyond Standard Benchmarks: A Systematic Audit of Vision-Language Model's Robustness to Natural Semantic Variation Across Diverse Tasks
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言模型的鲁棒性评估任务，旨在解决模型在自然语义变化下的性能问题。通过构建对抗数据集，评估不同模型在多种任务中的表现。**

- **链接: [https://arxiv.org/pdf/2604.04473](https://arxiv.org/pdf/2604.04473)**
...
>
---
#### [new 054] Firebolt-VL: Efficient Vision-Language Understanding with Cross-Modality Modulation
- **分类: cs.CV**

- **简介: 该论文属于视觉语言理解任务，旨在解决多模态模型计算成本高和细粒度视觉区域捕捉不足的问题。提出Firebolt-VL，采用LFM解码器和Token-Grid模块提升效率与精度。**
...
>
---
#### [new 057] Beyond the Global Scores: Fine-Grained Token Grounding as a Robust Detector of LVLM Hallucinations
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型 hallucination 检测任务，旨在解决模型生成内容中不准确的物体标记识别问题。通过分析token的细粒度注意力模式和语义对齐，提出一种更有效的检测方法。**

- **链接: [https://arxiv.org/pdf/2604.04863](https://arxiv.org/pdf/2604.04863)**
...
>
---
#### [new 061] V-Reflection: Transforming MLLMs from Passive Observers to Active Interrogators
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出V-Reflection框架，解决MLLM在细粒度任务中因视觉感知不足导致的幻觉问题。通过视觉反思机制，使模型主动查询视觉信息，提升推理准确性。**

- **链接: [https://arxiv.org/pdf/2604.03307](https://arxiv.org/pdf/2604.03307)**
...
>
---
#### [new 068] A Systematic Study of Cross-Modal Typographic Attacks on Audio-Visual Reasoning
- **分类: cs.CV; cs.SD**
...
>
---
#### [new 069] Gram-Anchored Prompt Learning for Vision-Language Models via Second-Order Statistics
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉-语言模型的适应任务，旨在解决领域迁移中的鲁棒性问题。通过引入二阶统计信息增强提示学习，提升模型在不同领域的适应能力。**

- **链接: [https://arxiv.org/pdf/2604.03980](https://arxiv.org/pdf/2604.03980)**
...
>
---
#### [new 070] Preserving Forgery Artifacts: AI-Generated Video Detection at Native Scale
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于AI生成视频检测任务，旨在解决传统方法因预处理导致的伪造痕迹丢失问题。工作包括构建大规模数据集和提出原生尺度检测框架。**

- **链接: [https://arxiv.org/pdf/2604.04634](https://arxiv.org/pdf/2604.04634)**
...
>
---
#### [new 071] 3D-Fixer: Coarse-to-Fine In-place Completion for 3D Scenes from a Single Image
- **分类: cs.CV**

- **简介: 该论文提出3D-Fixer，解决单图像生成完整3D场景的问题。通过粗到细的生成策略和数据集ARSG-110K，提升精度与效率。**

- **链接: [https://arxiv.org/pdf/2604.04406](https://arxiv.org/pdf/2604.04406)**
...
>
---
#### [new 073] SymphoMotion: Joint Control of Camera Motion and Object Dynamics for Coherent Video Generation
- **分类: cs.CV**

- **简介: 该论文提出SymphoMotion，解决视频生成中相机运动与物体动态联合控制的问题，通过统一框架实现稳定视角转换和精准物体操作。**
...
>
---
#### [new 076] ITIScore: An Image-to-Text-to-Image Rating Framework for the Image Captioning Ability of MLLMs
- **分类: cs.CV**

- **简介: 该论文属于图像描述生成任务，旨在解决现有基准数据集的不足。提出ICBench基准和ITIScore评估方法，提升模型评价的全面性和准确性。**
...
>
---
#### [new 086] YOLOv11 Demystified: A Practical Guide to High-Performance Object Detection
- **分类: cs.CV**

- **简介: 本文介绍YOLOv11，一种高性能实时目标检测模型，解决小物体检测和特征提取问题，通过创新模块提升精度与速度。**

- **链接: [https://arxiv.org/pdf/2604.03349](https://arxiv.org/pdf/2604.03349)**
...
>
---
#### [new 104] ZeD-MAP: Bundle Adjustment Guided Zero-Shot Depth Maps for Real-Time Aerial Imaging
...
>
---
#### [new 105] Review and Evaluation of Point-Cloud based Leaf Surface Reconstruction Methods for Agricultural Applications
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 106] HOIGS: Human-Object Interaction Gaussian Splatting
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于动态场景重建任务，旨在解决复杂人-物交互建模的问题。提出HOIGS方法，通过交叉注意力模块显式建模人-物相互作用，提升变形估计效果。**

- **链接: [https://arxiv.org/pdf/2604.04016](https://arxiv.org/pdf/2604.04016)**
...
>
---
#### [new 110] Free-Range Gaussians: Non-Grid-Aligned Generative 3D Gaussian Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，解决传统方法生成冗余且不完整的问题，通过非网格对齐的3D高斯分布实现更高质量的多视角重建。**

- **链接: [https://arxiv.org/pdf/2604.04874](https://arxiv.org/pdf/2604.04874)**
...
>
---
#### [new 116] VitaTouch: Property-Aware Vision-Tactile-Language Model for Robotic Quality Inspection in Manufacturing
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 117] Multimodal Backdoor Attack on VLMs for Autonomous Driving via Graffiti and Cross-Lingual Triggers
- **分类: cs.CV**

- **简介: 该论文属于安全攻击任务，针对自动驾驶中的视觉语言模型（VLM），提出一种隐蔽的后门攻击方法，利用涂鸦和跨语言触发器，在保持模型性能的同时实现高攻击成功率。**

- **链接: [https://arxiv.org/pdf/2604.04630](https://arxiv.org/pdf/2604.04630)**
...
>
---
#### [new 118] ATSS: Detecting AI-Generated Videos via Anomalous Temporal Self-Similarity
- **分类: cs.CV**

- **简介: 该论文属于视频检测任务，旨在解决AI生成视频的检测问题。针对现有方法无法捕捉全局时间逻辑的不足，提出ATSS方法，利用异常时间自相似性进行检测。**

- **链接: [https://arxiv.org/pdf/2604.04029](https://arxiv.org/pdf/2604.04029)**
...
>
---
#### [new 119] A Frame is Worth One Token: Efficient Generative World Modeling with Delta Tokens
- **分类: cs.CV**

- **简介: 该论文属于视频世界建模任务，旨在解决生成多样未来状态的计算成本高问题。通过引入DeltaTok和DeltaWorld，利用特征差分生成高效且多样的未来预测。**

- **链接: [https://arxiv.org/pdf/2604.04913](https://arxiv.org/pdf/2604.04913)**
...
>
---
#### [new 123] Shower-Aware Dual-Stream Voxel Networks for Structural Defect Detection in Cosmic-Ray Muon Tomography
- **分类: cs.CV; physics.comp-ph**

- **简介: 该论文属于结构缺陷检测任务，旨在提升宇宙线缪子成像中的缺陷识别效果。通过结合缪子散射和次级电磁簇射信息，提出SA-DSVN网络，显著提高了检测精度。**

- **链接: [https://arxiv.org/pdf/2604.03741](https://arxiv.org/pdf/2604.03741)**
...
>
---
#### [new 130] PR-IQA: Partial-Reference Image Quality Assessment for Diffusion-Based Novel View Synthesis
- **分类: cs.CV**

- **简介: 该论文属于图像质量评估任务，解决扩散模型生成图像在三维重建中的不一致性问题。提出PR-IQA框架，通过参考图像评估生成质量，提升重建效果。**
...
>
---
#### [new 131] Zero-Shot Quantization via Weight-Space Arithmetic
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于模型压缩任务，解决PTQ导致的性能下降问题。通过权重空间算术提取量化向量，无需训练即可提升模型鲁棒性。**
...
>
---
#### [new 138] E-VLA: Event-Augmented Vision-Language-Action Model for Dark and Blurred Scenes
...
>
---
#### [new 139] MinerU2.5-Pro: Pushing the Limits of Data-Centric Document Parsing at Scale
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 140] Stochastic Generative Plug-and-Play Priors
- **分类: cs.CV; cs.LG; eess.IV**

- **简介: 该论文属于图像逆问题任务，解决如何将分数扩散模型作为先验引入PnP框架的问题。通过注入噪声提升鲁棒性，实验表明效果优于传统方法。**

- **链接: [https://arxiv.org/pdf/2604.03603](https://arxiv.org/pdf/2604.03603)**
...
>
---
#### [new 141] HEDGE: Heterogeneous Ensemble for Detection of AI-GEnerated Images in the Wild
- **分类: cs.CV**

- **简介: 该论文属于AI生成图像检测任务，旨在解决真实场景下AI生成图像的鲁棒检测问题。通过构建异构集成模型HEDGE，融合多路径检测结果，提升检测性能与稳定性。**

- **链接: [https://arxiv.org/pdf/2604.03555](https://arxiv.org/pdf/2604.03555)**
...
>
---
#### [new 149] Hierarchical Point-Patch Fusion with Adaptive Patch Codebook for 3D Shape Anomaly Detection
- **分类: cs.CV**

- **简介: 该论文属于3D形状异常检测任务，旨在解决现有方法在多样异常类型和噪声下的泛化能力不足问题。提出一种分层点-块融合网络，提升异常识别的鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.03972](https://arxiv.org/pdf/2604.03972)**
...
>
---
#### [new 150] Learning 3D Reconstruction with Priors in Test Time
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，解决如何在不重新训练模型的情况下融入先验信息的问题。通过测试时优化框架，提升多视角Transformer的性能。**

- **链接: [https://arxiv.org/pdf/2604.03878](https://arxiv.org/pdf/2604.03878)**
...
>
---
#### [new 151] The Indra Representation Hypothesis for Multimodal Alignment
- **分类: cs.CV**

- **简介: 该论文提出Indra表示假设，解决多模态对齐问题。通过类别理论构建关系表示，提升不同模型和模态间的对齐与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.04496](https://arxiv.org/pdf/2604.04496)**
...
>
---
#### [new 152] OpenWorldLib: A Unified Codebase and Definition of Advanced World Models
- **分类: cs.CV**

- **简介: 该论文属于人工智能领域，旨在解决世界模型定义不统一的问题。提出OpenWorldLib框架，整合多任务模型，提升推理效率与协作能力。**
...
>
---
#### [new 153] Inference-Path Optimization via Circuit Duplication in Frozen Visual Transformers for Marine Species Classification
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于海洋物种分类任务，解决标注成本高和模型泛化能力弱的问题。通过在推理阶段应用电路复制技术优化冻结的视觉Transformer模型，提升分类性能。**

- **链接: [https://arxiv.org/pdf/2604.03428](https://arxiv.org/pdf/2604.03428)**
...
>
---
#### [new 154] 1.x-Distill: Breaking the Diversity, Quality, and Efficiency Barrier in Distribution Matching Distillation
- **分类: cs.CV**

- **简介: 该论文属于文本到图像生成任务，解决扩散模型少步蒸馏中的多样性下降和质量损失问题，提出1.x-Distill框架提升效率与效果。**

- **链接: [https://arxiv.org/pdf/2604.04018](https://arxiv.org/pdf/2604.04018)**
...
>
---
#### [new 163] Love Me, Love My Label: Rethinking the Role of Labels in Prompt Retrieval for Visual In-Context Learning
- **分类: cs.CV; cs.IR; cs.MM**

- **简介: 该论文属于视觉上下文学习任务，旨在提升提示检索效果。针对现有方法忽略标签的问题，提出LaPR框架，结合图像与标签信息，增强提示一致性，提升任务性能。**

- **链接: [https://arxiv.org/pdf/2604.03657](https://arxiv.org/pdf/2604.03657)**
...
>
---
#### [new 173] Bridging Restoration and Diagnosis: A Comprehensive Benchmark for Retinal Fundus Enhancement
- **分类: cs.CV**

- **简介: 该论文属于视网膜图像增强任务，旨在解决评估标准不足的问题。提出EyeBench-V2基准，通过临床任务评估模型性能，提升模型的临床实用性。**

- **链接: [https://arxiv.org/pdf/2604.03806](https://arxiv.org/pdf/2604.03806)**
...
>
---
#### [new 178] Event-Driven Neuromorphic Vision Enables Energy-Efficient Visual Place Recognition
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视觉定位任务，解决动态环境下视觉位置识别的高能耗问题。提出SpikeVPR，结合事件相机与脉冲神经网络，实现高效、鲁棒的定位。**

- **链接: [https://arxiv.org/pdf/2604.03277](https://arxiv.org/pdf/2604.03277)**
...
>
---
#### [new 179] CGHair: Compact Gaussian Hair Reconstruction with Card Clustering
- **分类: cs.CV; cs.GR**

- **简介: 该论文属于三维重建任务，旨在解决高精度头发重建的存储和计算成本高的问题。通过聚类发丝为发卡并共享纹理代码本，结合3DGS方法，显著降低存储和时间开销。**

- **链接: [https://arxiv.org/pdf/2604.03716](https://arxiv.org/pdf/2604.03716)**
...
>
---
#### [new 181] Erasure or Erosion? Evaluating Compositional Degradation in Unlearned Text-To-Image Diffusion Models
- **分类: cs.CV**

- **简介: 该论文属于文本到图像生成领域的概念移除任务，旨在评估去学习方法对生成能力的影响。研究发现，现有方法在去除特定概念时会损害生成的语义完整性。**

- **链接: [https://arxiv.org/pdf/2604.04575](https://arxiv.org/pdf/2604.04575)**
...
>
---
#### [new 186] DINO-VO: Learning Where to Focus for Enhanced State Estimation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 191] OmniSonic: Towards Universal and Holistic Audio Generation from Video and Text
...
>
---
#### [new 192] Hierarchical Semantic Correlation-Aware Masked Autoencoder for Unsupervised Audio-Visual Representation Learning
...
>
---
#### [new 196] CRAFT: Video Diffusion for Bimanual Robot Data Generation
...
>
---
#### [new 197] Efficient Onboard Spacecraft Pose Estimation with Event Cameras and Neuromorphic Hardware
...
>
---
#### [new 198] RAIN-FIT: Learning of Fitting Surfaces and Noise Distribution from Large Data Sets
- **分类: eess.SY; cs.CV; eess.SP**

- **简介: 该论文提出一种从噪声数据中估计表面的方法，属于表面拟合任务。解决噪声干扰下的表面重建问题，通过结合特征函数和噪声分布模型，实现高效、通用的表面拟合与参数估计。**

- **链接: [https://arxiv.org/pdf/2604.03491](https://arxiv.org/pdf/2604.03491)**
...
>
---
#### [new 199] Visual Prompt Based Reasoning for Offroad Mapping using Multimodal LLMs
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 202] Is a Picture Worth a Thousand Words? Adaptive Multimodal Fact-Checking with Visual Evidence Necessity
...
>
---
#### [new 203] Batch Loss Score for Dynamic Data Pruning
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于深度学习中的数据剪枝任务，旨在解决复杂模型中难以获取样本损失的问题。提出Batch Loss Score（BLS）作为高效替代方案，通过EMA平滑批量损失来评估样本重要性，实现有效剪枝。**

- **链接: [https://arxiv.org/pdf/2604.04681](https://arxiv.org/pdf/2604.04681)**
...
>
---
#### [new 204] HAD: Combining Hierarchical Diffusion with Metric-Decoupled RL for End-to-End Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 205] Sim2Real-AD: A Modular Sim-to-Real Framework for Deploying VLM-Guided Reinforcement Learning in Real-World Autonomous Driving
...
>
---
#### [new 206] Estimating Central, Peripheral, and Temporal Visual Contributions to Human Decision Making in Atari Games
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究人类在Atari游戏中决策的视觉信息贡献，通过眼动数据和模型分析，区分中心、周边和历史信息的作用，解决视觉信息对决策影响的量化问题。**

- **链接: [https://arxiv.org/pdf/2604.04439](https://arxiv.org/pdf/2604.04439)**
...
>
---
#### [new 207] Responses Fall Short of Understanding: Revealing the Gap between Internal Representations and Responses in Visual Document Understanding
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 208] L-SPINE: A Low-Precision SIMD Spiking Neural Compute Engine for Resource-efficient Edge Inference
- **分类: cs.AR; cs.CV; cs.NE; eess.IV**

- **简介: 该论文属于边缘计算任务，旨在解决SNN硬件部署中的能效与效率问题。提出L-SPINE架构，实现低精度、高并行的脉冲神经网络推理。**

- **链接: [https://arxiv.org/pdf/2604.03626](https://arxiv.org/pdf/2604.03626)**
...
>
---
#### [new 209] Reproducibility study on how to find Spurious Correlations, Shortcut Learning, Clever Hans or Group-Distributional non-robustness and how to fix them
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于模型可靠性研究，旨在解决深度学习中因虚假相关性导致的模型不可靠问题。通过比较不同修正方法，评估其在有限数据和子组不平衡下的效果。**

- **链接: [https://arxiv.org/pdf/2604.04518](https://arxiv.org/pdf/2604.04518)**
...
>
---
#### [new 210] NAIMA: Semantics Aware RGB Guided Depth Super-Resolution
- **分类: eess.IV; cs.CV; cs.LG; cs.MM**

- **简介: 该论文属于深度图超分辨率任务，解决RGB图像中误导性纹理导致深度边界模糊的问题。通过引入语义感知的注意力机制，提升深度图细节质量。**

- **链接: [https://arxiv.org/pdf/2604.04407](https://arxiv.org/pdf/2604.04407)**
...
>
---
#### [new 211] VisionClaw: Always-On AI Agents through Smart Glasses
- **分类: cs.HC; cs.AI; cs.CV; cs.LG; cs.MA**

- **简介: 该论文提出VisionClaw，一种通过智能眼镜实现的持续运行AI代理系统，解决实时情境感知与任务执行问题，通过整合视觉感知与代理执行提升交互效率。**
...
>
---
#### [new 214] UniSurgSAM: A Unified Promptable Model for Reliable Surgical Video Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于视频目标分割任务，解决手术视频中多模态提示下的可靠分割问题。提出UniSurgSAM模型，采用解耦框架提升分割准确性与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.03645](https://arxiv.org/pdf/2604.03645)**
...
>
---
#### [new 216] Can LLMs Reason About Attention? Towards Zero-Shot Analysis of Multimodal Classroom Behavior
- **分类: cs.HC; cs.AI; cs.CV**

- **简介: 该论文属于教育分析任务，旨在解决学生注意力检测问题。通过隐私保护的视频处理流程，结合LLM进行行为分析，提取课堂行为特征。**
...
>
---
#### [new 217] BAAI Cardiac Agent: An intelligent multimodal agent for automated reasoning and diagnosis of cardiovascular diseases from cardiac magnetic resonance imaging
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文提出BAAI Cardiac Agent，用于心血管疾病自动诊断与分析。解决CMR图像复杂解读问题，集成多模态模型实现结构分割、功能评估与疾病诊断，生成临床报告。**

- **链接: [https://arxiv.org/pdf/2604.04078](https://arxiv.org/pdf/2604.04078)**
...
>
---
#### [new 222] Supervised Dimensionality Reduction Revisited: Why LDA on Frozen CNN Features Deserves a Second Look
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于交通调度任务，旨在减少乘客等待时间。通过需求分段与匹配，结合线性规划和匈牙利算法优化车辆调度，显著提升了服务效率。**

- **链接: [https://arxiv.org/pdf/2604.03928](https://arxiv.org/pdf/2604.03928)**
...
#### [replaced 001] Vision-as-Inverse-Graphics Agent via Interleaved Multimodal Reasoning
- **分类: cs.CV; cs.AI; cs.GR**

- **链接: [https://arxiv.org/pdf/2601.11109](https://arxiv.org/pdf/2601.11109)**
...
>
---
#### [replaced 003] Agile Deliberation: Concept Deliberation for Subjective Visual Classification
- **分类: cs.AI; cs.CV; cs.HC; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.10821](https://arxiv.org/pdf/2512.10821)**
...
>
---
#### [replaced 004] XModBench: Benchmarking Cross-Modal Capabilities and Consistency in Omni-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.15148](https://arxiv.org/pdf/2510.15148)**
...
>
---
#### [replaced 005] FinPercep-RM: A Fine-grained Reward Model and Co-evolutionary Curriculum for RL-based Real-world Super-Resolution
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22647](https://arxiv.org/pdf/2512.22647)**
...
>
---
#### [replaced 006] Automated Wildfire Damage Assessment from Multi view Ground level Imagery Via Vision Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.01895](https://arxiv.org/pdf/2509.01895)**
...
>
---
#### [replaced 009] TIGFlow-GRPO: Trajectory Forecasting via Interaction-Aware Flow Matching and Reward-Guided Optimization
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 010] Chain-of-Frames: Advancing Video Understanding in Multimodal LLMs via Frame-Aware Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.00318](https://arxiv.org/pdf/2506.00318)**
...
>
---
#### [replaced 013] More than the Sum: Panorama-Language Models for Adverse Omni-Scenes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.09573](https://arxiv.org/pdf/2603.09573)**
...
>
---
#### [replaced 015] Image Hashing via Cross-View Code Alignment in the Age of Foundation Models
- **分类: cs.CV; cs.IR; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.27584](https://arxiv.org/pdf/2510.27584)**
...
>
---
#### [replaced 016] SkillSight: Efficient First-Person Skill Assessment with Gaze
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.19629](https://arxiv.org/pdf/2511.19629)**
...
>
---
#### [replaced 017] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
- **分类: cs.CV**
...
>
---
#### [replaced 018] Document Parsing Unveiled: Techniques, Challenges, and Prospects for Structured Information Extraction
...
>
---
#### [replaced 019] Disentangled World Models: Learning to Transfer Semantic Knowledge from Distracting Videos for Reinforcement Learning
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2503.08751](https://arxiv.org/pdf/2503.08751)**
...
>
---
#### [replaced 021] FreeGraftor: Training-Free Cross-Image Feature Grafting for Subject-Driven Text-to-Image Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.15958](https://arxiv.org/pdf/2504.15958)**

> **作者:** Zebin Yao; Lei Ren; Huixing Jiang; Wei Chen; Xiaojie Wang; Ruifan Li; Fangxiang Feng
>
> **备注:** Code: this https URL
>
...
>
---
#### [replaced 022] ST-BiBench: Benchmarking Multi-Stream Multimodal Coordination in Bimanual Embodied Tasks for MLLMs
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 023] MARC: Multi-Label Adaptive Retrieval Contrastive Loss for Remote Sensing Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16294](https://arxiv.org/pdf/2512.16294)**
...
>
---
#### [replaced 029] Universal Skeleton Understanding via Differentiable Rendering and MLLMs
- **分类: cs.CV**
...
>
---
#### [replaced 030] LongTail Driving Scenarios with Reasoning Traces: The KITScenes LongTail Dataset
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 031] Event6D: Event-based Novel Object 6D Pose Tracking
- **分类: cs.CV**
...
>
---
#### [replaced 032] Revisiting Multimodal Positional Encoding in Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23095](https://arxiv.org/pdf/2510.23095)**
...
>
---
#### [replaced 041] Beyond Corner Patches: Semantics-Aware Backdoor Attack in Federated Learning
...
>
---
#### [replaced 042] THOM: Generating Physically Plausible Hand-Object Meshes From Text
- **分类: cs.CV**
...
>
---
#### [replaced 046] Sky2Ground: A Benchmark for Site Modeling under Varying Altitude
- **分类: cs.CV**
...
>
---
#### [replaced 049] MRI-to-CT synthesis using drifting models
- **分类: eess.IV; cs.AI; cs.CV**
...
>
---
#### [replaced 052] MuDD: A Multimodal Deception Detection Dataset and GSR-Guided Progressive Distillation for Non-Contact Deception Detection
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 053] Learning to Grasp Anything by Playing with Random Toys
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 054] VOIC: Visible-Occluded Integrated Guidance for 3D Semantic Scene Completion
- **分类: cs.CV**
...
>
---
#### [replaced 055] ShelfGaussian: Shelf-Supervised Open-Vocabulary Gaussian-based 3D Scene Understanding
- **分类: cs.CV**
...
>
---
#### [replaced 056] Contextualized Visual Personalization in Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 060] SketchDeco: Training-Free Latent Composition for Precise Sketch Colourisation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2405.18716](https://arxiv.org/pdf/2405.18716)**

> **作者:** Chaitat Utintu; Yi-Zhe Song
>
> **备注:** Accepted in CVPR 2026. Project page available at this https URL
>
...
>
---
#### [replaced 061] NASTaR: NovaSAR Automated Ship Target Recognition Dataset
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.18503](https://arxiv.org/pdf/2512.18503)**
...
>
---
#### [replaced 062] Low-Bitrate Video Compression through Semantic-Conditioned Diffusion
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.00408](https://arxiv.org/pdf/2512.00408)**
...
>
---
#### [replaced 065] SPHINX: A Synthetic Environment for Visual Perception and Reasoning
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.20814](https://arxiv.org/pdf/2511.20814)**
...
>
---
#### [replaced 066] VERDI: VLM-Embedded Reasoning for Autonomous Driving
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 070] Weakly Convex Ridge Regularization for 3D Non-Cartesian MRI Reconstruction
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 071] Bringing Your Portrait to 3D Presence
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22553](https://arxiv.org/pdf/2511.22553)**
...
>
---
#### [replaced 072] BrepGaussian: CAD reconstruction from Multi-View Images with Gaussian Splatting
- **分类: cs.CV**
...
>
---
#### [replaced 073] ToG-Bench: Task-Oriented Spatio-Temporal Grounding in Egocentric Videos
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.03666](https://arxiv.org/pdf/2512.03666)**
...
>
---
#### [replaced 076] LoFT: Parameter-Efficient Fine-Tuning for Long-tailed Semi-Supervised Learning in Open-World Scenarios
- **分类: cs.LG; cs.CV**
...
>
---
#### [replaced 079] VABench: A Comprehensive Benchmark for Audio-Video Generation
- **分类: cs.CV; cs.SD**
...
>
---
#### [replaced 083] FLEG: Feed-Forward Language Embedded Gaussian Splatting from Any Views via Compact Semantic Representation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17541](https://arxiv.org/pdf/2512.17541)**
...
>
---
#### [replaced 087] EI: Early Intervention for Multimodal Imaging based Disease Recognition
- **分类: cs.CV**
...
>
---
#### [replaced 088] An Analytical Theory of Spectral Bias in the Learning Dynamics of Diffusion Models
- **分类: cs.LG; cs.CV; math.ST; stat.ML**

- **链接: [https://arxiv.org/pdf/2503.03206](https://arxiv.org/pdf/2503.03206)**

> **作者:** Binxu Wang; Cengiz Pehlevan
>
> **备注:** 96 pages, 29 figures. Published in Advances in Neural Information Processing Systems, NeurIPS 2025 (Spotlight)
>
...
>
---
#### [replaced 089] SparseCam4D: Spatio-Temporally Consistent 4D Reconstruction from Sparse Cameras
- **分类: cs.CV**
...
>
> **备注:** Accepted to CVPR 2026. Project page available at this https URL and code at this https URL
>
...
>
---
#### [replaced 092] SCP: Spatial Causal Prediction in Video
- **分类: cs.CV**
...
>
---
#### [replaced 095] GPA: Learning GUI Process Automation from Demonstrations
...
>
---
#### [replaced 096] Improving Multimodal Learning with Dispersive and Anchoring Regularization
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 097] Beyond Classification Accuracy: Neural-MedBench and the Need for Deeper Reasoning Benchmarks
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.22258](https://arxiv.org/pdf/2509.22258)**
...
>
---
#### [replaced 098] Comparing SAM 2 and SAM 3 for Zero-Shot Segmentation of 3D Medical Data
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21926](https://arxiv.org/pdf/2511.21926)**
...
>
---
#### [replaced 099] ZINA: Multimodal Fine-grained Hallucination Detection and Editing
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 103] CREG: Compass Relational Evidence Graph for Characterizing Directional Structure in VLM Spatial-Reasoning Attribution
- **分类: cs.CV**
...
>
---
#### [replaced 106] ATAC: Augmentation-Based Test-Time Adversarial Correction for CLIP
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.17362](https://arxiv.org/pdf/2511.17362)**
...
>
---
#### [replaced 107] SpikeStereoNet: A Brain-Inspired Framework for Stereo Depth Estimation from Spike Streams
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.19487](https://arxiv.org/pdf/2505.19487)**
...
>
---
#### [replaced 108] Robust Adaptation of Foundation Models with Black-Box Visual Prompting
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 109] MPDiT: Multi-Patch Global-to-Local Transformer Architecture For Efficient Flow Matching and Diffusion Model
- **分类: cs.CV**
...
>
---
#### [replaced 110] 2D Triangle Splatting for Direct Differentiable Mesh Training
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.18575](https://arxiv.org/pdf/2506.18575)**
...
>
---
#### [replaced 111] MeDUET: Disentangled Unified Pretraining for 3D Medical Image Synthesis and Analysis
- **分类: eess.IV; cs.CV; cs.GT**

- **链接: [https://arxiv.org/pdf/2602.17901](https://arxiv.org/pdf/2602.17901)**
...
>
---
#### [replaced 117] Prediction of Grade, Gender, and Academic Performance of Children and Teenagers from Handwriting Using the Sigma-Lognormal Model
- **分类: cs.HC; cs.CV**
...
>
---
#### [replaced 118] Patch-Wise Hypergraph Contrastive Learning with Dual Normal Distribution Weighting for Multi-Domain Stain Transfer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.09523](https://arxiv.org/pdf/2503.09523)**

> **作者:** Haiyan Wei; Hangrui Xu; Bingxu Zhu; Yulian Geng; Aolei Liu; Wenfei Yin; Jian Liu
>
> **备注:** Accepted to ICME 2025
>
> **摘要:** Virtual stain transfer leverages computer-assisted technology to transform the histochemical staining patterns of tissue samples into other staining types. However, existing methods often lose detailed pathological information due to the limitations of the cycle consistency assumption. To address this challenge, we propose STNHCL, a hypergraph-based patch-wise contrastive learning method. STNHCL captures higher-order relationships among patches through hypergraph modeling, ensuring consistent higher-order topology between input and output images. Additionally, we introduce a novel negative sample weighting strategy that leverages discriminator heatmaps to apply different weights based on the Gaussian distribution for tissue and background, thereby enhancing traditional weighting methods. Experiments demonstrate that STNHCL achieves state-of-the-art performance in the two main categories of stain transfer tasks. Furthermore, our model also performs excellently in downstream tasks. Code is available at this https URL
>
---
#### [replaced 119] PhysGaia: A Physics-Aware Benchmark with Multi-Body Interactions for Dynamic Novel View Synthesis
...
>
---
#### [replaced 122] Vision Transformer-Based Time-Series Image Reconstruction for Cloud-Filling Applications
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2506.19591](https://arxiv.org/pdf/2506.19591)**
...
>
---
#### [replaced 123] SciGA: A Comprehensive Dataset for Designing Graphical Abstracts in Academic Papers
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 124] Unified Removal of Raindrops and Reflections: A New Benchmark and A Novel Pipeline
- **分类: cs.CV**
...
>
---
#### [replaced 127] Sub-metre Lunar DEM Generation and Validation from Chandrayaan-2 OHRC Multi-View Imagery Using an Open-Source Pipeline
- **分类: cs.CV**
...
>
---
#### [replaced 128] Detecting and Characterising Mobile App Metamorphosis in Google Play Store
- **分类: cs.SE; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2407.14565](https://arxiv.org/pdf/2407.14565)**

> **作者:** D. Denipitiyage; B. Silva; K. Gunathilaka; S. Seneviratne; A. Mahanti; A. Seneviratne; S. Chawla
>
...
>
---
#### [replaced 129] JAMMEval: A Refined Collection of Japanese Benchmarks for Reliable VLM Evaluation
- **分类: cs.CV**
