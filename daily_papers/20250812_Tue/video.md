...
- **简介: 论文提出基于人类-人工智能协作的深度学习系统，用于乳腺病理图像中浸润性导管癌检测，通过反馈循环提升AI精度，最终达到93.65%准确率，推动AI辅助诊断发展。**
...
- **简介: 论文提出ProGraD方法，利用可学习组提示与轻量级Transformer，提升群体活动检测性能，尤其在多群体场景中表现优异。**
...
- **简介: 论文提出Matrix-3D框架，通过结合视频生成与全景重建技术，实现可探索的三维世界生成，解决现有方法场景范围有限的问题，提出双阶段重建方法及大规模数据集Matrix-Pano。**
...
- **简介: 本文提出ForensicsSAM框架，针对图像伪造检测与定位任务，解决对抗攻击导致的性能下降问题。通过注入伪造专家、设计轻量级对抗检测器及全局注意力层对抗专家，提升模型鲁棒性，实现高精度伪造识别与定位。**
...
- **简介: 论文提出基于CTC对齐算法的自训练方法，解决历史文档手写文本识别中标注错误（如分隔符问题），通过动态规划与模型概率优化提升CER并增强对齐精度，弱模型迭代训练策略显著改善识别效果，发布100页手动修正数据集及代码。**
...
- **简介: 论文提出一种结合自监督视觉模型与层级推理的植物语义分割方法，解决传统人工评估效率低、领域漂移下性能下降的问题，通过多国多年数据训练及无人机测试验证其鲁棒性，提升除草剂试验中作物与杂草的自动化监测能力。**
...
- **简介: 该论文针对类增量学习任务，解决模块选择错误及通用知识遗漏问题，提出整合任务专用与通用适配器（TUNA）框架，通过熵机制选择适配器并融合策略构建跨任务通用特征，提升模型性能。**
...
- **简介: 论文提出MIMIC框架，通过多模态逆向提升视觉语言模型（VLM）的可解释性，解决其内部表示透明度问题，结合逆向与特征对齐技术，引入空间对齐、图像平滑和语义真实性的正则化，实现对VLM概念的可视化分析。**
...
- **链接: [http://arxiv.org/pdf/2508.07330v1](http://arxiv.org/pdf/2508.07330v1)**
...
- **简介: 论文提出HiMat，基于DiT生成高分辨率SVBRDF，通过CrossStitch模块保持一致性，无需修改DiT结构，实现高效多图生成。**
...
- **链接: [http://arxiv.org/pdf/2508.07656v1](http://arxiv.org/pdf/2508.07656v1)**
...
- **简介: 论文提出基于纹理细分立方体树（TeSO）的3D场景表示与压缩方法，解决现有点云/网格/高斯面在渲染质量与压缩效率的不足，通过八叉树结构整合纹理信息，降低冗余并提升压缩效率。**
...
- **链接: [http://arxiv.org/pdf/2508.08219v1](http://arxiv.org/pdf/2508.08219v1)**
...
- **简介: 论文提出Cut2Next框架，通过Hierarchical Multi-Prompting生成符合编辑模式的下一帧，提升视觉一致性与叙事质量。**
...
- **简介: 论文提出Pose-RFT框架，通过混合强化学习优化语言与姿态生成，解决多模态输入下3D姿态生成的歧义问题，提升空间对齐与语义一致性。**
...
- **简介: 论文提出Contrastive Inversion方法，通过对比学习提取图像共性，无需人工指导，结合解耦注意力提升生成质量，解决传统方法依赖人工标注导致的特征分离不足问题。**
...
- **简介: 论文提出一种混合协作方法，解决多智能体3D检测中通信带宽瓶颈，通过融合感知输出与原始观测，优化信息传输效率，构建HyComm系统实现高效协作。**
...
- **简介: 论文提出MiraMo框架，通过线性注意力和运动残差学习解决图像动画中的外观一致性、运动突变及计算复杂度问题，实现高效可控的动画生成。**
...
- **简介: 论文提出通过补丁级和WSI级对比学习解决病理图像分割领域泛化问题，利用医院内部特征差异减少跨域误差。**
...
- **链接: [http://arxiv.org/pdf/2508.07960v1](http://arxiv.org/pdf/2508.07960v1)**
...
- **简介: 论文提出基于注册的星形分割模型，解决遮挡、噪声等导致的图像分割难题，通过结合水平集与注册框架实现全/部分星形分割，并采用ADMM优化，实验验证其有效性。**
...
- **链接: [http://arxiv.org/pdf/2508.08094v1](http://arxiv.org/pdf/2508.08094v1)**
...
- **简介: 论文提出基于多视角RGB图像的3D场景图生成方法，解决无3D标注时噪声与背景干扰问题，通过语义掩码、邻近节点信息及统计先验优化预测，提升准确率。**
...
- **简介: 该论文提出一种基于面部地标辅助的视觉特征提取器，用于解决视觉语音识别在有限资源下的性能问题，通过多图卷积网络与多级融合框架提升模型精度。**
...
- **简介: 论文提出CannyEdit框架，解决训练免去的图像编辑中文本遵循与上下文保真度平衡及编辑无缝性问题，通过Selective Canny Control和Dual-Prompt Guidance实现精准编辑，提升2.93%-10.49%平衡，并获得49.2%用户认可。**

- **链接: [http://arxiv.org/pdf/2508.06937v1](http://arxiv.org/pdf/2508.06937v1)**

> **作者:** Weiyan Xie; Han Gao; Didan Deng; Kaican Li; April Hua Liu; Yongxiang Huang; Nevin L. Zhang
>
> **备注:** Project Page: vaynexie.github.io/CannyEdit/
>
...
>
---
#### [new 065] Adversarial Video Promotion Against Text-to-Video Retrieval
- **分类: cs.CV**

- **简介: 该论文提出对抗性视频推广攻击（ViPro），旨在提升文本到视频检索中视频的排名，解决现有方法未探索推广攻击的问题，通过Modal Refinement增强黑盒转移性，实验显示其性能显著优于基线。**

- **链接: [http://arxiv.org/pdf/2508.06964v1](http://arxiv.org/pdf/2508.06964v1)**
...
>
---
#### [new 066] Large-scale Multi-sequence Pretraining for Generalizable MRI Analysis in Versatile Clinical Applications
- **分类: cs.CV; cs.AI**

- **简介: 论文提出PRISM模型，通过大规模多序列MRI预训练解决泛化问题，构建跨临床任务基准，提升AI在放射学中的应用。**

- **链接: [http://arxiv.org/pdf/2508.07165v1](http://arxiv.org/pdf/2508.07165v1)**
...
>
---
#### [new 067] Static and Plugged: Make Embodied Evaluation Simple
- **分类: cs.CV**

- **简介: 论文提出静态插件式基准StaticEmbodiedBench，解决传统评估成本高、碎片化问题，通过静态场景覆盖42场景与8维度，评估19个VLMs和11个VLAs，加速 embodied intelligence 发展。**

- **链接: [http://arxiv.org/pdf/2508.06553v1](http://arxiv.org/pdf/2508.06553v1)**
...
>
---
#### [new 081] KARMA: Efficient Structural Defect Segmentation via Kolmogorov-Arnold Representation Learning
- **分类: cs.CV**

- **简介: 论文提出KARMA框架，通过Kolmogorov-Arnold表示学习解决结构缺陷分割难题，采用低秩因子分解、分离式卷积和动态原型机制，提升效率并适应类别不平衡。**

- **链接: [http://arxiv.org/pdf/2508.08186v1](http://arxiv.org/pdf/2508.08186v1)**
...
>
---
#### [new 082] LaRender: Training-Free Occlusion Control in Image Generation via Latent Rendering
- **分类: cs.CV**

- **简介: 论文提出无需训练的图像生成方法LaRender，通过潜在空间体积渲染实现精确遮挡控制，解决现有方法依赖提示或布局无法有效处理遮挡问题，通过物理基础实现高精度遮挡管理并支持多维度效果调整。**

- **链接: [http://arxiv.org/pdf/2508.07647v1](http://arxiv.org/pdf/2508.07647v1)**

> **作者:** Xiaohang Zhan; Dingming Liu
>
> **备注:** Accepted by ICCV 2025 (oral). Project page: https://xiaohangzhan.github.io/projects/larender/
>
...
>
---
#### [new 087] TrackOR: Towards Personalized Intelligent Operating Rooms Through Robust Tracking
- **分类: cs.CV**

- **简介: 论文提出TrackOR框架，解决长手术中多人员跟踪与重识别问题，通过3D几何特征实现高精度跟踪及离线轨迹恢复，推动个性化手术室智能化。**

- **链接: [http://arxiv.org/pdf/2508.07968v1](http://arxiv.org/pdf/2508.07968v1)**
...
>
---
#### [new 090] Age-Diverse Deepfake Dataset: Bridging the Age Gap in Deepfake Detection
- **分类: cs.CV; cs.LG**

- **简介: 论文针对深度伪造检测中的年龄偏见问题，提出年龄多样的数据集，整合Celeb-DF等数据并生成合成数据，提升模型公平性与泛化能力，贡献可复现的公平数据集和模型管道。**

- **链接: [http://arxiv.org/pdf/2508.06552v1](http://arxiv.org/pdf/2508.06552v1)**
...
>
---
#### [new 091] MMFformer: Multimodal Fusion Transformer Network for Depression Detection
...
>
---
#### [new 103] Low-Rank Expert Merging for Multi-Source Domain Adaptation in Person Re-Identification
- **分类: cs.CV**

- **简介: 论文提出源自由多源域适应（MSDA）方法，通过低秩适配器（LoRA）和轻量级门控网络实现跨域知识迁移，降低参数量与计算成本，提升人像再识别性能。**

- **链接: [http://arxiv.org/pdf/2508.06831v1](http://arxiv.org/pdf/2508.06831v1)**
...
>
---
#### [new 107] SOFA: Deep Learning Framework for Simulating and Optimizing Atrial Fibrillation Ablation
- **分类: cs.CV; cs.AI**

- **简介: 论文提出SOFA框架，通过深度学习模拟房颤消融效果并优化参数，解决术前复发风险预测与操作优化问题，实现个性化治疗。**

- **链接: [http://arxiv.org/pdf/2508.07621v1](http://arxiv.org/pdf/2508.07621v1)**
...
>
---
#### [new 112] UniSVG: A Unified Dataset for Vector Graphic Understanding and Generation with Multimodal Large Language Models
- **分类: cs.CV; cs.AI**

- **简介: 论文提出UniSVG数据集，解决SVG理解和生成难题，通过多模态MLLMs提升性能，超越现有方法。**

- **链接: [http://arxiv.org/pdf/2508.07766v1](http://arxiv.org/pdf/2508.07766v1)**
...
>
---
#### [new 115] PP-Motion: Physical-Perceptual Fidelity Evaluation for Human Motion Generation
- **分类: cs.CV; cs.MM**

- **简介: 该论文提出一种物理-感知保真度评估方法PP-Motion，解决传统方法无法兼顾物理约束与人类感知的问题，通过物理标注和联合损失函数实现更精确的运动生成评估。**

- **链接: [http://arxiv.org/pdf/2508.08179v1](http://arxiv.org/pdf/2508.08179v1)**
...
>
---
#### [new 116] Morphological Analysis of Semiconductor Microstructures using Skeleton Graphs
- **分类: cs.CV**

- **简介: 论文通过骨架图与图卷积网络分析Ge表面微结构，解决照射角度对形貌影响的识别问题，提出方法验证角度变化比剂量更具决定性。**

- **链接: [http://arxiv.org/pdf/2508.07850v1](http://arxiv.org/pdf/2508.07850v1)**
...
>
---
#### [new 126] Talk2Image: A Multi-Agent System for Multi-Turn Image Generation and Editing
- **分类: cs.CV**

- **简介: 论文提出多智能体系统Talk2Image，解决多轮图像生成与编辑中的意图漂移问题，通过意图解析、任务分解与协作及反馈优化，提升可控性、连贯性和用户满意度。**

- **链接: [http://arxiv.org/pdf/2508.06916v1](http://arxiv.org/pdf/2508.06916v1)**
...
>
---
#### [new 127] CoT-Pose: Chain-of-Thought Reasoning for 3D Pose Generation from Abstract Prompts
- **分类: cs.CV**

- **简介: 该论文提出CoT-Pose框架，通过链式思维推理解决3D姿态生成中抽象提示处理难题，实现从抽象文本生成准确姿态。**

- **链接: [http://arxiv.org/pdf/2508.07540v1](http://arxiv.org/pdf/2508.07540v1)**
...
>
---
#### [new 144] DiffUS: Differentiable Ultrasound Rendering from Volumetric Imaging
- **分类: cs.CV; cs.GR**

- **简介: 论文提出DiffUS，基于物理的可微分超声渲染器，解决超声图像噪声、伪影及与MRI/CT对齐问题，生成高保真B-mode图像。**

- **链接: [http://arxiv.org/pdf/2508.06768v1](http://arxiv.org/pdf/2508.06768v1)**
...
>
---
#### [new 145] BEVANet: Bilateral Efficient Visual Attention Network for Real-Time Semantic Segmentation
- **分类: cs.CV**

- **简介: 论文提出BEVANet，通过LKA机制与多模块融合，解决实时语义分割中高效架构与细节捕捉的矛盾，实现33FPS下79.3% mIoU，性能优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.07300v1](http://arxiv.org/pdf/2508.07300v1)**
...
>
---
#### [new 147] FormCoach: Lift Smarter, Not Harder
- **分类: cs.CV; cs.HC**

- **简介: 论文提出FormCoach，利用摄像头和视觉语言模型实现居家健身动作实时纠错，解决专业反馈缺失问题，通过数据集与评估管道标准化对比AI性能，推动可解释性交互式AI发展。**

- **链接: [http://arxiv.org/pdf/2508.07501v1](http://arxiv.org/pdf/2508.07501v1)**
...
>
---
#### [new 150] Dream4D: Lifting Camera-Controlled I2V towards Spatiotemporally Consistent 4D Generation
- **分类: cs.CV**

- **简介: 论文提出Dream4D框架，解决相机控制的I2V生成中时空一致性难题，通过两阶段架构融合可控视频生成与神经4D重建，提升多视角序列的几何一致性与时序合理性。**

- **链接: [http://arxiv.org/pdf/2508.07769v1](http://arxiv.org/pdf/2508.07769v1)**
...
>
---
#### [new 151] CATP: Contextually Adaptive Token Pruning for Efficient and Enhanced Multimodal In-Context Learning
- **分类: cs.CV**

- **简介: 论文提出CATP，针对多模态在上下文学习中图像token冗余问题，通过两阶段剪枝优化跨模态交互，提升效率与性能，超越基线。**

- **链接: [http://arxiv.org/pdf/2508.07871v1](http://arxiv.org/pdf/2508.07871v1)**
...
>
---
#### [new 161] OpenHAIV: A Framework Towards Practical Open-World Learning
- **分类: cs.CV; cs.AI; cs.LG; eess.IV; stat.ML**

- **简介: 该论文提出OpenHAIV框架，解决开放世界学习中OOD检测与增量微调的不足，通过整合三要素实现自主知识更新。**

- **链接: [http://arxiv.org/pdf/2508.07270v1](http://arxiv.org/pdf/2508.07270v1)**

> **作者:** Xiang Xiang; Qinhao Zhou; Zhuo Xu; Jing Ma; Jiaxin Dai; Yifan Liang; Hanlin Li
>
> **备注:** Codes, results, and OpenHAIV documentation available at https://haiv-lab.github.io/openhaiv
>
...
>
---
#### [new 162] Freeze and Reveal: Exposing Modality Bias in Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文旨在检测并减少视觉-语言模型中的模态偏见，解决其继承训练数据中的性别偏误问题，通过对比分析视觉与文本编码器的贡献，提出基于度量指标的去偏方法，量化改进效果并指导未来多模态系统优化。**

- **链接: [http://arxiv.org/pdf/2508.07432v1](http://arxiv.org/pdf/2508.07432v1)**
...
>
---
#### [new 163] Restage4D: Reanimating Deformable 3D Reconstruction from a Single Video
- **分类: cs.CV**

- **简介: 论文提出Restage4D方法，通过利用真实视频的运动先验修正合成3D重建中的瑕疵，实现可变形场景的视频驱动重建，提升几何一致性与运动质量。**

- **链接: [http://arxiv.org/pdf/2508.06715v1](http://arxiv.org/pdf/2508.06715v1)**
...
>
---
#### [new 166] A Simple yet Powerful Instance-Aware Prompting Framework for Training-free Camouflaged Object Segmentation
- **分类: cs.CV**

- **简介: 该论文提出一种无需训练的伪装目标分割框架IAPF，解决标注稀疏导致的性能下降问题，通过实例感知提示生成与自一致性投票提升分割精度。**

- **链接: [http://arxiv.org/pdf/2508.06904v1](http://arxiv.org/pdf/2508.06904v1)**
...
>
---
#### [new 167] Towards Robust Red-Green Watermarking for Autoregressive Image Generators
- **分类: cs.CV**

- **简介: 论文提出基于视觉token聚类的鲁棒红绿水印方法，解决自回归图像生成器中水印检测失效问题，提升鲁棒性与图像质量。**

- **链接: [http://arxiv.org/pdf/2508.06656v1](http://arxiv.org/pdf/2508.06656v1)**
...
>
---
#### [new 168] StyleTailor: Towards Personalized Fashion Styling via Hierarchical Negative Feedback
...
>
---
#### [new 179] Mitigating Biases in Surgical Operating Rooms with Geometry
- **分类: cs.CV**

- **简介: 论文旨在减少手术室中因标准化衣着导致的模型偏见，通过几何方法（3D点云序列）分离身份特征，提升人员身份识别准确性。任务聚焦于消除数据集特定因素对模型的干扰，解决传统RGB方法在真实临床环境下的性能下降问题。**

- **链接: [http://arxiv.org/pdf/2508.08028v1](http://arxiv.org/pdf/2508.08028v1)**
...
>
---
#### [new 193] SLRTP2025 Sign Language Production Challenge: Methodology, Results, and Future Work
...
>
---
#### [new 198] Tracking Any Point Methods for Markerless 3D Tissue Tracking in Endoscopic Stereo Images
- **分类: cs.CV**

- **简介: 论文提出基于TAP网络的无标记三维组织跟踪方法，解决微创手术中动态组织运动与视野受限问题，通过结合CoTracker模型实现立体内窥镜图像的精准3D运动估计，实验显示误差低至1.1mm。**

- **链接: [http://arxiv.org/pdf/2508.07851v1](http://arxiv.org/pdf/2508.07851v1)**
...
>
---
#### [new 208] X2Edit: Revisiting Arbitrary-Instruction Image Editing through Self-Constructed Data and Task-Aware Representation Learning
- **分类: cs.CV**

- **简介: 论文提出X2Edit数据集，解决现有任意指令图像编辑数据不足问题，通过自建数据与任务感知表示学习提升编辑性能，采用MoE-LoRA和对比学习优化模型效果，开源代码可在GitHub获取。**

- **链接: [http://arxiv.org/pdf/2508.07607v1](http://arxiv.org/pdf/2508.07607v1)**

> **作者:** Jian Ma; Xujie Zhu; Zihao Pan; Qirong Peng; Xu Guo; Chen Chen; Haonan Lu
>
> **备注:** https://github.com/OPPO-Mente-Lab/X2Edit
>
...
>
---
#### [new 209] RSVLM-QA: A Benchmark Dataset for Remote Sensing Vision Language Model-based Question Answering
- **分类: cs.CV**

- **简介: 论文提出RSVLM-QA数据集，用于遥感视觉问答任务，解决现有数据标注不足及推理能力评估缺失问题，通过整合多源遥感数据并引入双轨注释机制，构建包含13.8万张图像与16.2万VQA对的高质量数据集，验证视觉语言模型在遥感场景下的性能。**

- **链接: [http://arxiv.org/pdf/2508.07918v1](http://arxiv.org/pdf/2508.07918v1)**
...
>
---
#### [new 213] GRASPTrack: Geometry-Reasoned Association via Segmentation and Projection for Multi-Object Tracking
- **分类: cs.CV; cs.AI**

- **简介: 论文提出GRASPTrack，通过融合深度估计与实例分割生成3D点云，利用几何推理提升多目标跟踪鲁棒性，尤其在遮挡和复杂运动场景中表现优异。**

- **链接: [http://arxiv.org/pdf/2508.08117v1](http://arxiv.org/pdf/2508.08117v1)**

> **作者:** Xudong Han; Pengcheng Fang; Yueying Tian; Jianhui Yu; Xiaohao Cai; Daniel Roggen; Philip Birch
>
> **摘要:** Multi-object tracking (MOT) in monocular videos is fundamentally challenged by occlusions and depth ambiguity, issues that conventional tracking-by-detection (TBD) methods struggle to resolve owing to a lack of geometric awareness. To address these limitations, we introduce GRASPTrack, a novel depth-aware MOT framework that integrates monocular depth estimation and instance segmentation into a standard TBD pipeline to generate high-fidelity 3D point clouds from 2D detections, thereby enabling explicit 3D geometric reasoning. These 3D point clouds are then voxelized to enable a precise and robust Voxel-Based 3D Intersection-over-Union (IoU) for spatial association. To further enhance tracking robustness, our approach incorporates Depth-aware Adaptive Noise Compensation, which dynamically adjusts the Kalman filter process noise based on occlusion severity for more reliable state estimation. Additionally, we propose a Depth-enhanced Observation-Centric Momentum, which extends the motion direction consistency from the image plane into 3D space to improve motion-based association cues, particularly for objects with complex trajectories. Extensive experiments on the MOT17, MOT20, and DanceTrack benchmarks demonstrate that our method achieves competitive performance, significantly improving tracking robustness in complex scenes with frequent occlusions and intricate motion patterns.
>
---
#### [new 214] ReferSplat: Referring Segmentation in 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 论文提出R3DGS任务，通过自然语言描述实现3D高斯点分割，解决新视角下遮挡对象识别问题，提出ReferSplat框架提升性能并发布Ref-LERF数据集。**

- **链接: [http://arxiv.org/pdf/2508.08252v1](http://arxiv.org/pdf/2508.08252v1)**
...
>
---
#### [new 227] SketchAnimator: Animate Sketch via Motion Customization of Text-to-Video Diffusion Models
- **分类: cs.CV**

- **简介: 论文提出SketchAnimator模型，通过LoRA和SDS将草图与参考视频运动结合，生成动态视频，解决传统动画耗时难的问题。**

- **链接: [http://arxiv.org/pdf/2508.07149v1](http://arxiv.org/pdf/2508.07149v1)**
...
>
---
#### [new 233] MILD: Multi-Layer Diffusion Strategy for Complex and Precise Multi-IP Aware Human Erasing
- **分类: cs.CV**

- **简介: 该论文提出多层扩散策略（MILD）用于复杂多IP场景的人脸擦除，解决遮挡、背景干扰等问题，通过分离实例与背景路径并引入人体形态引导与空间注意力提升精度。**

- **链接: [http://arxiv.org/pdf/2508.06543v1](http://arxiv.org/pdf/2508.06543v1)**
...
>
---
#### [new 234] Training and Inference within 1 Second -- Tackle Cross-Sensor Degradation of Real-World Pansharpening with Efficient Residual Feature Tailoring
- **分类: cs.CV**

- **简介: 论文提出一种跨传感器融合方法，通过模块化设计与物理感知损失优化特征映射，实现快速训练与推理，显著提升跨传感器泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.07369v1](http://arxiv.org/pdf/2508.07369v1)**
...
>
---
#### [new 235] Selective Contrastive Learning for Weakly Supervised Affordance Grounding
- **分类: cs.CV; cs.AI**

- **简介: 论文提出一种基于选择性对比学习的方法，解决弱监督下物体与动作关联识别难题，通过动态捕捉关键特征提升模型性能。**

- **链接: [http://arxiv.org/pdf/2508.07877v1](http://arxiv.org/pdf/2508.07877v1)**

> **作者:** WonJun Moon; Hyun Seok Seong; Jae-Pil Heo
>
> **备注:** Accepted to ICCV 2025
>
> **摘要:** Facilitating an entity's interaction with objects requires accurately identifying parts that afford specific actions. Weakly supervised affordance grounding (WSAG) seeks to imitate human learning from third-person demonstrations, where humans intuitively grasp functional parts without needing pixel-level annotations. To achieve this, grounding is typically learned using a shared classifier across images from different perspectives, along with distillation strategies incorporating part discovery process. However, since affordance-relevant parts are not always easily distinguishable, models primarily rely on classification, often focusing on common class-specific patterns that are unrelated to affordance. To address this limitation, we move beyond isolated part-level learning by introducing selective prototypical and pixel contrastive objectives that adaptively learn affordance-relevant cues at both the part and object levels, depending on the granularity of the available information. Initially, we find the action-associated objects in both egocentric (object-focused) and exocentric (third-person example) images by leveraging CLIP. Then, by cross-referencing the discovered objects of complementary views, we excavate the precise part-level affordance clues in each perspective. By consistently learning to distinguish affordance-relevant regions from affordance-irrelevant background context, our approach effectively shifts activation from irrelevant areas toward meaningful affordance cues. Experimental results demonstrate the effectiveness of our method. Codes are available at github.com/hynnsk/SelectiveCL.
>
---
#### [new 236] AMFT: Aligning LLM Reasoners by Meta-Learning the Optimal Imitation-Exploration Balance
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **简介: 论文提出AMFT，通过元学习动态平衡模仿与探索，解决LLM推理对齐问题，提升任务性能。**

- **链接: [http://arxiv.org/pdf/2508.06944v1](http://arxiv.org/pdf/2508.06944v1)**
...
>
---
#### [new 244] CountQA: How Well Do MLLMs Count in the Wild?
- **分类: cs.AI; cs.CV**

- **简介: 论文提出CountQA基准，评估MLLMs在真实场景下的物体计数能力，解决现有基准不足问题，通过高密度图像测试模型性能并开源数据。**

- **链接: [http://arxiv.org/pdf/2508.06585v1](http://arxiv.org/pdf/2508.06585v1)**
...
>
---
#### [new 250] Membership Inference Attacks with False Discovery Rate Control
- **分类: stat.ML; cs.CV; cs.LG**

- **简介: 本文提出一种新型成员身份推断攻击方法，通过控制假发现率（FDR）并保证真非成员数据被误标为成员的概率，解决现有方法在分布未知和依赖性问题，实现有效集成于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.07066v1](http://arxiv.org/pdf/2508.07066v1)**
...
>
---
#### [new 251] Breaking Down and Building Up: Mixture of Skill-Based Vision-and-Language Navigation Agents
- **分类: cs.AI; cs.CL; cs.CV**

- **简介: 论文提出SkillNav框架，通过技能分解与零样本路由选择提升视觉-语言导航性能，解决复杂场景泛化问题。**

- **链接: [http://arxiv.org/pdf/2508.07642v1](http://arxiv.org/pdf/2508.07642v1)**
...
>
---
#### [new 254] Progressive Bird's Eye View Perception for Safety-Critical Autonomous Driving: A Comprehensive Survey
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 257] KLASSify to Verify: Audio-Visual Deepfake Detection Using SSL-based Audio and Handcrafted Visual Features
- **分类: eess.AS; cs.CV**

- **简介: 论文提出基于SSL音频和手工视觉特征的多模态方法，解决时序深度伪造检测中的计算成本高、泛化差问题，实现92.78% AUC和0.3536 IoU的性能。**

- **链接: [http://arxiv.org/pdf/2508.07337v1](http://arxiv.org/pdf/2508.07337v1)**
...
>
---
#### [new 258] FEAT: A Multi-Agent Forensic AI System with Domain-Adapted Large Language Model for Automated Cause-of-Death Analysis
- **分类: cs.AI; cs.CV; cs.LG; cs.MA**

- **简介: 论文提出FEAT系统，通过多智能体框架与领域适应大语言模型解决法医死因分析中的人员短缺和诊断差异问题，实现自动化、标准化分析，跨六地泛化良好，获专家认可，为法医医学提供高效可靠解决方案。**

- **链接: [http://arxiv.org/pdf/2508.07950v1](http://arxiv.org/pdf/2508.07950v1)**
...
>
> **摘要:** Forensic cause-of-death determination faces systemic challenges, including workforce shortages and diagnostic variability, particularly in high-volume systems like China's medicolegal infrastructure. We introduce FEAT (ForEnsic AgenT), a multi-agent AI framework that automates and standardizes death investigations through a domain-adapted large language model. FEAT's application-oriented architecture integrates: (i) a central Planner for task decomposition, (ii) specialized Local Solvers for evidence analysis, (iii) a Memory & Reflection module for iterative refinement, and (iv) a Global Solver for conclusion synthesis. The system employs tool-augmented reasoning, hierarchical retrieval-augmented generation, forensic-tuned LLMs, and human-in-the-loop feedback to ensure legal and medical validity. In evaluations across diverse Chinese case cohorts, FEAT outperformed state-of-the-art AI systems in both long-form autopsy analyses and concise cause-of-death conclusions. It demonstrated robust generalization across six geographic regions and achieved high expert concordance in blinded validations. Senior pathologists validated FEAT's outputs as comparable to those of human experts, with improved detection of subtle evidentiary nuances. To our knowledge, FEAT is the first LLM-based AI agent system dedicated to forensic medicine, offering scalable, consistent death certification while maintaining expert-level rigor. By integrating AI efficiency with human oversight, this work could advance equitable access to reliable medicolegal services while addressing critical capacity constraints in forensic systems.
>
---
#### [new 259] MIND: A Noise-Adaptive Denoising Framework for Medical Images Integrating Multi-Scale Transformer
- **分类: eess.IV; cs.AI; cs.CV; cs.LG; cs.MM**

- **简介: 论文提出基于多尺度Transformer的噪声自适应去噪模型（MI-ND），解决医学图像噪声干扰问题，通过NLE和NAAB实现通道-空间注意力调控与跨模态融合，提升PSNR、SSIM等指标及诊断性能。**

- **链接: [http://arxiv.org/pdf/2508.07817v1](http://arxiv.org/pdf/2508.07817v1)**
...
>
---
#### [new 260] InterChart: Benchmarking Visual Reasoning Across Decomposed and Distributed Chart Information
...
>
---
#### [new 261] Autonomous Navigation of Cloud-Controlled Quadcopters in Confined Spaces Using Multi-Modal Perception and LLM-Driven High Semantic Reasoning
...
>
---
#### [new 262] PCA-Guided Autoencoding for Structured Dimensionality Reduction in Active Infrared Thermography
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **简介: 该论文提出一种基于PCA引导的自编码框架，针对高维AIRT数据的结构化降维问题，通过引入PCA蒸馏损失构建有序潜在空间，提升缺陷特征捕捉能力，实验表明优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.07773v1](http://arxiv.org/pdf/2508.07773v1)**
...
>
---
#### [new 263] Vision-Based Localization and LLM-based Navigation for Indoor Environments
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 论文提出融合视觉定位与LLM导航的室内导航方法，解决GPS缺失和建筑复杂性问题，实现高精度导航。**

- **链接: [http://arxiv.org/pdf/2508.08120v1](http://arxiv.org/pdf/2508.08120v1)**
...
>
---
#### [replaced 004] Unleashing the Potential of Large Language Models for Text-to-Image Generation through Autoregressive Representation Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.07334v3](http://arxiv.org/pdf/2503.07334v3)**
...
>
---
#### [replaced 005] BadPatch: Diffusion-Based Generation of Physical Adversarial Patches
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.01440v5](http://arxiv.org/pdf/2412.01440v5)**

> **作者:** Zhixiang Wang; Xingjun Ma; Yu-Gang Jiang
>
> **备注:** Code available at: https://github.com/Wwangb/BadPatch
>
...
>
---
#### [replaced 006] Universally Unfiltered and Unseen:Input-Agnostic Multimodal Jailbreaks against Text-to-Image Model Safeguards
- **分类: cs.CR; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2508.05658v2](http://arxiv.org/pdf/2508.05658v2)**
...
>
---
#### [replaced 007] Foundation versus Domain-specific Models: Performance Comparison, Fusion, and Explainability in Face Recognition
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.03541v2](http://arxiv.org/pdf/2507.03541v2)**

> **作者:** Redwan Sony; Parisa Farmanifard; Arun Ross; Anil K. Jain
>
> **备注:** Accepted at the International Conference on Computer Vision (ICCV) 2025 Workshop
>
...
>
---
#### [replaced 008] GAITGen: Disentangled Motion-Pathology Impaired Gait Generative Model -- Bringing Motion Generation to the Clinical Domain
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.22397v2](http://arxiv.org/pdf/2503.22397v2)**
...
>
---
#### [replaced 009] TextInPlace: Indoor Visual Place Recognition in Repetitive Structures with Scene Text Spotting and Verification
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 010] BonnBeetClouds3D: A Dataset Towards Point Cloud-based Organ-level Phenotyping of Sugar Beet Plants under Field Conditions
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 011] Maximum Dispersion, Maximum Concentration: Enhancing the Quality of MOP Solutions
- **分类: math.OC; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.22568v3](http://arxiv.org/pdf/2506.22568v3)**
...
>
---
#### [replaced 012] D-Judge: How Far Are We? Assessing the Discrepancies Between AI-synthesized and Natural Images through Multimodal Guidance
- **分类: cs.AI; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2412.17632v4](http://arxiv.org/pdf/2412.17632v4)**
...
>
---
#### [replaced 013] Co-VisiON: Co-Visibility ReasONing on Sparse Image Sets of Indoor Scenes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.16805v3](http://arxiv.org/pdf/2506.16805v3)**
...
>
---
#### [replaced 016] HiGarment: Cross-modal Harmony Based Diffusion Model for Flat Sketch to Realistic Garment Image
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23186v2](http://arxiv.org/pdf/2505.23186v2)**
...
>
---
#### [replaced 017] Semantic Mapping in Indoor Embodied AI -- A Survey on Advances, Challenges, and Future Directions
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 018] Speckle2Self: Self-Supervised Ultrasound Speckle Reduction Without Clean Data
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.06828v2](http://arxiv.org/pdf/2507.06828v2)**
...
>
---
#### [replaced 019] LoRA.rar: Learning to Merge LoRAs via Hypernetworks for Subject-Style Conditioned Image Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.05148v2](http://arxiv.org/pdf/2412.05148v2)**
...
>
---
#### [replaced 020] Efficient Face Image Quality Assessment via Self-training and Knowledge Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15709v2](http://arxiv.org/pdf/2507.15709v2)**
...
>
---
#### [replaced 021] DreamFrame: Enhancing Video Understanding via Automatically Generated QA and Style-Consistent Keyframes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.01422v5](http://arxiv.org/pdf/2403.01422v5)**

> **作者:** Zhende Song; Chenchen Wang; Jiamu Sheng; Chi Zhang; Shengji Tang; Jiayuan Fan; Tao Chen
>
> **备注:** Accepted by ACMM'MM 2025
>
...
>
---
#### [replaced 022] STF: Shallow-Level Temporal Feedback to Enhance Spiking Transformers
- **分类: cs.NE; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.00387v3](http://arxiv.org/pdf/2508.00387v3)**
...
>
---
#### [replaced 023] WSI-LLaVA: A Multimodal Large Language Model for Whole Slide Image
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2412.02141v4](http://arxiv.org/pdf/2412.02141v4)**

> **作者:** Yuci Liang; Xinheng Lyu; Meidan Ding; Wenting Chen; Jipeng Zhang; Yuexiang Ren; Xiangjian He; Song Wu; Xiyue Wang; Sen Yang; Xiaohan Xing; Linlin Shen
>
...
>
---
#### [replaced 024] CPKD: Clinical Prior Knowledge-Constrained Diffusion Models for Surgical Phase Recognition in Endoscopic Submucosal Dissection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.03295v2](http://arxiv.org/pdf/2507.03295v2)**
...
>
---
#### [replaced 025] In-Situ Fine-Tuning of Wildlife Models in IoT-Enabled Camera Traps for Efficient Adaptation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2409.07796v3](http://arxiv.org/pdf/2409.07796v3)**
...
>
---
#### [replaced 026] Griffon v2: Advancing Multimodal Perception with High-Resolution Scaling and Visual-Language Co-Referring
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2403.09333v2](http://arxiv.org/pdf/2403.09333v2)**
...
>
---
#### [replaced 028] ArtiMuse: Fine-Grained Image Aesthetics Assessment with Joint Scoring and Expert-Level Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.14533v2](http://arxiv.org/pdf/2507.14533v2)**
...
>
---
#### [replaced 029] Flow Matching Posterior Sampling: A Training-free Conditional Generation for Flow Matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.07625v3](http://arxiv.org/pdf/2411.07625v3)**
...
>
---
#### [replaced 030] AU-IQA: A Benchmark Dataset for Perceptual Quality Assessment of AI-Enhanced User-Generated Content
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2508.05016v2](http://arxiv.org/pdf/2508.05016v2)**
...
>
---
#### [replaced 037] Robustness to Geographic Distribution Shift Using Location Encoders
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.02036v2](http://arxiv.org/pdf/2503.02036v2)**
...
>
---
#### [replaced 038] CoherenDream: Boosting Holistic Text Coherence in 3D Generation via Multimodal Large Language Models Feedback
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.19860v2](http://arxiv.org/pdf/2504.19860v2)**
...
>
---
#### [replaced 039] Scaling Laws for Native Multimodal Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.07951v4](http://arxiv.org/pdf/2504.07951v4)**
...
>
---
#### [replaced 040] CLGRPO: Reasoning Ability Enhancement for Small VLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.18048v2](http://arxiv.org/pdf/2506.18048v2)**
...
>
---
#### [replaced 041] A Steel Surface Defect Detection Method Based on Lightweight Convolution Optimization
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15476v2](http://arxiv.org/pdf/2507.15476v2)**

> **作者:** Cong Chen; Ming Chen; Hoileong Lee; Yan Li; Jiyang Yu
>
> **备注:** This is a preprint of an article accepted for publication in the International Journal of Advanced Computer Science and Applications (IJACSA). The final authenticated version is available online at: https://doi.org/10.14569/IJACSA.2025.0160619
>
...
>
---
#### [replaced 042] Zero-shot Compositional Action Recognition with Neural Logic Constraints
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.02320v2](http://arxiv.org/pdf/2508.02320v2)**
...
>
---
#### [replaced 043] LVBench: An Extreme Long Video Understanding Benchmark
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2406.08035v3](http://arxiv.org/pdf/2406.08035v3)**
...
>
---
#### [replaced 045] Simple Radiology VLLM Test-time Scaling with Thought Graph Traversal
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.11989v2](http://arxiv.org/pdf/2506.11989v2)**
...
>
---
#### [replaced 046] A Multimodal Deep Learning Approach for White Matter Shape Prediction in Diffusion MRI Tractography
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.18400v2](http://arxiv.org/pdf/2504.18400v2)**
...
>
> **备注:** 25 pages, 3 figures, 8 tables
>
...
>
---
#### [replaced 047] MoGA: 3D Generative Avatar Prior for Monocular Gaussian Avatar Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23597v3](http://arxiv.org/pdf/2507.23597v3)**
...
>
---
#### [replaced 050] Unbiased Region-Language Alignment for Open-Vocabulary Dense Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.06244v3](http://arxiv.org/pdf/2412.06244v3)**
...
>
---
#### [replaced 053] Scene Summarization: Clustering Scene Videos into Spatially Diverse Frames
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2311.17940v2](http://arxiv.org/pdf/2311.17940v2)**
...
>
---
#### [replaced 054] Evaluating structural uncertainty in accelerated MRI: are voxelwise measures useful surrogates?
- **分类: eess.IV; cs.CV; physics.med-ph**

- **链接: [http://arxiv.org/pdf/2503.10527v2](http://arxiv.org/pdf/2503.10527v2)**

> **作者:** Luca L. C. Trautmann; Peter A. Wijeratne; Itamar Ronen; Ivor J. A. Simpson
>
> **摘要:** Introducing accelerated reconstruction algorithms into clinical settings requires measures of uncertainty quantification that accurately assess the relevant uncertainty introduced by the reconstruction algorithm. Many currently deployed approaches quantifying uncertainty by focusing on measuring the variability in voxelwise intensity variation. Although these provide interpretable maps, they lack a structural interpretation and do not show a clear relationship to how the data will be analysed subsequently. In this work we show that voxel level uncertainty does not provide insight into morphological uncertainty. To do so, we use segmentation as a clinically-relevant downstream task and deploy ensembles of reconstruction modes to measure uncertainty in the reconstructions. We show that variability and bias in the morphological structures are present and within-ensemble variability cannot be predicted well with uncertainty measured only by voxel intensity variations.
>
---
#### [replaced 055] SGAD: Semantic and Geometric-aware Descriptor for Local Feature Matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.02278v2](http://arxiv.org/pdf/2508.02278v2)**
...
>
---
#### [replaced 056] NEXT: Multi-Grained Mixture of Experts via Text-Modulation for Multi-Modal Object Re-Identification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.20001v4](http://arxiv.org/pdf/2505.20001v4)**
...
>
---
#### [replaced 060] LayerTracer: Cognitive-Aligned Layered SVG Synthesis via Diffusion Transformer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.01105v2](http://arxiv.org/pdf/2502.01105v2)**
...
>
---
#### [replaced 061] Learning 3D-Gaussian Simulators from RGB Videos
...
>
---
#### [replaced 064] RAPNet: A Receptive-Field Adaptive Convolutional Neural Network for Pansharpening
- **分类: cs.CV; cs.AI; cs.LG; cs.MM; eess.IV**

- **链接: [http://arxiv.org/pdf/2507.10461v2](http://arxiv.org/pdf/2507.10461v2)**
...
>
---
#### [replaced 065] Just Say the Word: Annotation-Free Fine-Grained Object Counting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.11705v2](http://arxiv.org/pdf/2504.11705v2)**
...
>
---
#### [replaced 068] Anchor Token Matching: Implicit Structure Locking for Training-free AR Image Editing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.10434v2](http://arxiv.org/pdf/2504.10434v2)**

> **作者:** Taihang Hu; Linxuan Li; Kai Wang; Yaxing Wang; Jian Yang; Ming-Ming Cheng
>
> **备注:** Accepted by ICCV2025. Code will be released in https://github.com/hutaiHang/ATM
>
...
>
---
#### [replaced 072] Solving Zero-Shot 3D Visual Grounding as Constraint Satisfaction Problems
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.14594v2](http://arxiv.org/pdf/2411.14594v2)**
...
>
---
#### [replaced 073] Hierarchical Relation-augmented Representation Generalization for Few-shot Action Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.10079v2](http://arxiv.org/pdf/2504.10079v2)**
...
>
---
#### [replaced 074] Less is More: Token-Efficient Video-QA via Adaptive Frame-Pruning and Semantic Graph Integration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03337v3](http://arxiv.org/pdf/2508.03337v3)**

> **作者:** Shaoguang Wang; Jianxiang He; Yijie Xu; Ziyang Chen; Weiyu Guo; Hui Xiong
>
> **备注:** Corresponding authors: Weiyu Guo, Hui Xiong This manuscript is a preprint. An earlier version of this work was submitted to AAAI 2026 and was not accepted due to exceeding the page limit. This version has been revised and is formatted using the AAAI 2026 style file
>
...
>
---
#### [replaced 075] Street Gaussians without 3D Object Tracker
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.05548v3](http://arxiv.org/pdf/2412.05548v3)**
...
>
---
#### [replaced 076] Spotter+GPT: Turning Sign Spottings into Sentences with LLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.10434v3](http://arxiv.org/pdf/2403.10434v3)**
...
>
---
#### [replaced 079] A Plug-and-Play Method for Guided Multi-contrast MRI Reconstruction based on Content/Style Modeling
- **分类: eess.IV; cs.CV; physics.med-ph; I.4.5**

- **链接: [http://arxiv.org/pdf/2409.13477v4](http://arxiv.org/pdf/2409.13477v4)**
...
>
---
#### [replaced 080] Continual Multiple Instance Learning for Hematologic Disease Diagnosis
- **分类: cs.LG; cs.CV; eess.IV; q-bio.QM**

- **链接: [http://arxiv.org/pdf/2508.04368v2](http://arxiv.org/pdf/2508.04368v2)**

> **作者:** Zahra Ebrahimi; Raheleh Salehi; Nassir Navab; Carsten Marr; Ario Sadafi
>
> **备注:** Accepted for publication at MICCAI 2025 workshop on Efficient Medical AI
>
...
>
---
#### [replaced 085] Dynamic Robot-Assisted Surgery with Hierarchical Class-Incremental Semantic Segmentation
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 086] CDP: Towards Robust Autoregressive Visuomotor Policy Learning via Causal Diffusion
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 087] Self-Navigated Residual Mamba for Universal Industrial Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.01591v2](http://arxiv.org/pdf/2508.01591v2)**

> **作者:** Hanxi Li; Jingqi Wu; Lin Yuanbo Wu; Mingliang Li; Deyin Liu; Jialie Shen; Chunhua Shen
>
> **备注:** 13 pages, 4 figures, submitted to AAAI2026
>
...
>
---
#### [replaced 088] Interpreting the linear structure of vision-language model embedding spaces
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2504.11695v3](http://arxiv.org/pdf/2504.11695v3)**
...
>
---
#### [replaced 091] DS$^2$Net: Detail-Semantic Deep Supervision Network for Medical Image Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.04131v2](http://arxiv.org/pdf/2508.04131v2)**

> **作者:** Zhaohong Huang; Yuxin Zhang; Taojian Zhou; Guorong Cai; Rongrong Ji
>
...
>
---
#### [replaced 094] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.05591v2](http://arxiv.org/pdf/2505.05591v2)**

> **作者:** Yueh-Cheng Liu; Lukas Höllein; Matthias Nießner; Angela Dai
>
> **备注:** ICCV 2025. Project page: https://liu115.github.io/quicksplat, Video: https://youtu.be/2IA_gnFvFG8
>
...
>
---
#### [replaced 095] FunGraph: Functionality Aware 3D Scene Graphs for Language-Prompted Scene Interaction
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 096] Toward Errorless Training ImageNet-1k
- **分类: cs.CV; cs.LG; 68T07**

- **链接: [http://arxiv.org/pdf/2508.04941v2](http://arxiv.org/pdf/2508.04941v2)**
...
>
---
#### [replaced 101] EA-KD: Entropy-based Adaptive Knowledge Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2311.13621v3](http://arxiv.org/pdf/2311.13621v3)**
...
>
---
#### [replaced 104] Inference-Time Gaze Refinement for Micro-Expression Recognition: Enhancing Event-Based Eye Tracking with Motion-Aware Post-Processing
- **分类: cs.CV; cs.HC; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2506.12524v3](http://arxiv.org/pdf/2506.12524v3)**
...
>
---
#### [replaced 105] SPRMamba: Surgical Phase Recognition for Endoscopic Submucosal Dissection with Mamba
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2409.12108v3](http://arxiv.org/pdf/2409.12108v3)**
...
>
---
#### [replaced 106] Ethical Challenges in Computer Vision: Ensuring Privacy and Mitigating Bias in Publicly Available Datasets
...
>
---
#### [replaced 111] 3D Gaussian Splatting Data Compression with Mixture of Priors
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.03310v2](http://arxiv.org/pdf/2505.03310v2)**
...
>
---
#### [replaced 112] Generative AI for Cel-Animation: A Survey
- **分类: cs.CV; cs.AI; cs.HC**

- **链接: [http://arxiv.org/pdf/2501.06250v3](http://arxiv.org/pdf/2501.06250v3)**
...
>
---
#### [replaced 113] Fractured Glass, Failing Cameras: Simulating Physics-Based Adversarial Samples for Autonomous Driving Systems
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [http://arxiv.org/pdf/2405.15033v2](http://arxiv.org/pdf/2405.15033v2)**
...
>
---
#### [replaced 114] When Trackers Date Fish: A Benchmark and Framework for Underwater Multiple Fish Tracking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.06400v2](http://arxiv.org/pdf/2507.06400v2)**
...
>
---
#### [replaced 115] Multi-Modal Semantic Parsing for the Interpretation of Tombstone Inscriptions
- **分类: cs.CV; cs.CL; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.04377v3](http://arxiv.org/pdf/2507.04377v3)**
...
>
---
#### [replaced 116] TARS: MinMax Token-Adaptive Preference Strategy for MLLM Hallucination Reduction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.21584v3](http://arxiv.org/pdf/2507.21584v3)**
...
>
---
#### [replaced 117] Toward Patient-specific Partial Point Cloud to Surface Completion for Pre- to Intra-operative Registration in Image-guided Liver Interventions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.19518v2](http://arxiv.org/pdf/2505.19518v2)**
...
>
---
#### [replaced 118] Quadratic Gaussian Splatting: High Quality Surface Reconstruction with Second-order Geometric Primitives
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.16392v3](http://arxiv.org/pdf/2411.16392v3)**
...
>
---
#### [replaced 119] Spatio-Temporal Representation Decoupling and Enhancement for Federated Instrument Segmentation in Surgical Videos
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23759v2](http://arxiv.org/pdf/2506.23759v2)**
...
>
---
#### [replaced 120] From Time-series Generation, Model Selection to Transfer Learning: A Comparative Review of Pixel-wise Approaches for Large-scale Crop Mapping
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.12590v2](http://arxiv.org/pdf/2507.12590v2)**

> **作者:** Judy Long; Tao Liu; Sean Alexander Woznicki; Miljana Marković; Oskar Marko; Molly Sears
>
> **备注:** A review paper on pixel-wise approaches for large-scale crop mapping. 29 pages, 18 figures. Preprint
>
...
>
---
#### [replaced 121] LifelongPR: Lifelong point cloud place recognition based on sample replay and prompt learning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 124] EDiT: Efficient Diffusion Transformers with Linear Compressed Attention
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.16726v2](http://arxiv.org/pdf/2503.16726v2)**
...
>
---
#### [replaced 129] DexVLA: Vision-Language Model with Plug-In Diffusion Expert for General Robot Control
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 132] Multimodal Visual Transformer for Sim2real Transfer in Visual Reinforcement Learning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 133] GenEscape: Hierarchical Multi-Agent Generation of Escape Room Puzzles
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.21839v2](http://arxiv.org/pdf/2506.21839v2)**
...
>
---
#### [replaced 134] Learning 3D Object Spatial Relationships from Pre-trained 2D Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.19914v2](http://arxiv.org/pdf/2503.19914v2)**
...
>
---
#### [replaced 137] TAR3D: Creating High-Quality 3D Assets via Next-Part Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.16919v3](http://arxiv.org/pdf/2412.16919v3)**
...
>
---
#### [replaced 140] TSPO: Temporal Sampling Policy Optimization for Long-form Video Language Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.04369v3](http://arxiv.org/pdf/2508.04369v3)**
...
>
---
#### [replaced 147] PCLVis: Visual Analytics of Process Communication Latency in Large-Scale Simulation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23257v2](http://arxiv.org/pdf/2506.23257v2)**

> **作者:** Chongke Bi; Xin Gao; Baofeng Fu; Yuheng Zhao; Siming Chen; Ying Zhao; Lu Yang
>
...
>
---
#### [replaced 148] InfiniBench: A Benchmark for Large Multi-Modal Models in Long-Form Movies and TV Shows
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2406.19875v3](http://arxiv.org/pdf/2406.19875v3)**
...
>
---
#### [replaced 152] Engagement Prediction of Short Videos with Large Multimodal Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.02516v2](http://arxiv.org/pdf/2508.02516v2)**
...
>
---
#### [replaced 153] When Cars Have Stereotypes: Auditing Demographic Bias in Objects from Text-to-Image Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.03483v2](http://arxiv.org/pdf/2508.03483v2)**
...
>
---
#### [replaced 154] DanceChat: Large Language Model-Guided Music-to-Dance Generation
...
>
---
#### [replaced 159] MomentMix Augmentation with Length-Aware DETR for Temporally Robust Moment Retrieval
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2412.20816v2](http://arxiv.org/pdf/2412.20816v2)**
...
>
---
#### [replaced 160] A New One-Shot Federated Learning Framework for Medical Imaging Classification with Feature-Guided Rectified Flow and Knowledge Distillation
- **分类: cs.CV; cs.DC**

- **链接: [http://arxiv.org/pdf/2507.19045v2](http://arxiv.org/pdf/2507.19045v2)**
...
>
---
#### [replaced 161] Zoom-Refine: Boosting High-Resolution Multimodal Understanding via Localized Zoom and Self-Refinement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.01663v2](http://arxiv.org/pdf/2506.01663v2)**

> **作者:** Xuan Yu; Dayan Guan; Yanfeng Gu
>
...
>
---
#### [replaced 162] Decoupled Global-Local Alignment for Improving Compositional Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.16801v2](http://arxiv.org/pdf/2504.16801v2)**

> **作者:** Xiaoxing Hu; Kaicheng Yang; Jun Wang; Haoran Xu; Ziyong Feng; Yupei Wang
>
> **备注:** [ACM MM]2025
>
> **摘要:** Contrastive Language-Image Pre-training (CLIP) has achieved success on multiple downstream tasks by aligning image and text modalities. However, the nature of global contrastive learning limits CLIP's ability to comprehend compositional concepts, such as relations and attributes. Although recent studies employ global hard negative samples to improve compositional understanding, these methods significantly compromise the model's inherent general capabilities by forcibly distancing textual negative samples from images in the embedding space. To overcome this limitation, we introduce a Decoupled Global-Local Alignment (DeGLA) framework that improves compositional understanding while substantially mitigating losses in general capabilities. To optimize the retention of the model's inherent capabilities, we incorporate a self-distillation mechanism within the global alignment process, aligning the learnable image-text encoder with a frozen teacher model derived from an exponential moving average. Under the constraint of self-distillation, it effectively mitigates the catastrophic forgetting of pretrained knowledge during fine-tuning. To improve compositional understanding, we first leverage the in-context learning capability of Large Language Models (LLMs) to construct about 2M high-quality negative captions across five types. Subsequently, we propose the Image-Grounded Contrast (IGC) loss and Text-Grounded Contrast (TGC) loss to enhance vision-language compositionally. Extensive experimental results demonstrate the effectiveness of the DeGLA framework. Compared to previous state-of-the-art methods, DeGLA achieves an average enhancement of 3.5% across the VALSE, SugarCrepe, and ARO benchmarks. Concurrently, it obtains an average performance improvement of 13.0% on zero-shot classification tasks across eleven datasets. Our code will be released at https://github.com/xiaoxing2001/DeGLA
>
---
#### [replaced 163] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03643v3](http://arxiv.org/pdf/2508.03643v3)**
...
>
---
#### [replaced 164] LIRA: Inferring Segmentation in Large Multi-modal Models with Local Interleaved Region Assistance
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.06272v3](http://arxiv.org/pdf/2507.06272v3)**
...
>
---
#### [replaced 165] MambaFlow: A Mamba-Centric Architecture for End-to-End Optical Flow Estimation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.07046v3](http://arxiv.org/pdf/2503.07046v3)**
...
>
---
#### [replaced 166] OceanSim: A GPU-Accelerated Underwater Robot Perception Simulation Framework
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 171] Efficient RAW Image Deblurring with Adaptive Frequency Modulation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24407v3](http://arxiv.org/pdf/2505.24407v3)**

> **作者:** Wenlong Jiao; Binglong Li; Wei Shang; Ping Wang; Dongwei Ren
>
> **备注:** This paper has been withdrawn by the authors as the work is still in progress. A more complete version will be submitted in the future
>
...
>
---
#### [replaced 172] Fourier-VLM: Compressing Vision Tokens in the Frequency Domain for Large Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.06038v2](http://arxiv.org/pdf/2508.06038v2)**
