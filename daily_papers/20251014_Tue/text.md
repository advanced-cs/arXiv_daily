...
>
---
#### [new 003] Large Language Model Sourcing: A Survey
- **分类: cs.CL; cs.AI**
...
- **简介: 该论文研究大语言模型压缩中校准数据对模型能力的影响，旨在解决压缩后复杂推理能力下降的问题。通过分析激活模式，提出以代表性和多样性为准则的校准数据构建框架，提升现有压缩方法对关键能力的保持效果。**
...
- **简介: 该论文研究低资源语言下的大模型安全防护任务，旨在解决现有分类方法可解释性差、跨语言性能弱的问题。作者提出ConsistentGuard，一种基于推理与对齐的多语言防护框架，仅用1000样本即在六种语言上实现优越性能，并提升可解释性与泛化能力。**
...
- **简介: 该论文研究利用大语言模型自动评估科学文献的方法学质量，以中介分析为例，对比模型与专家在180篇全文上的判断。结果显示模型对显式信息识别准确，但复杂推理任务仍需人工干预。**
...
- **简介: 该论文提出CoBia，通过构造对话触发大模型中隐藏的社会偏见。属于安全与公平性评估任务，旨在揭示模型在交互中放大的偏见问题。作者设计轻量对抗攻击，测试11个LLM对六类社会群体的偏见响应，并结合自动指标与人工判断评估模型对齐能力。**
...
- **简介: 该论文研究端到端语音识别与翻译任务，旨在通过结合预训练语音编码器与大语言模型，统一实现ASR和ST。实验表明，该方法在英-德翻译上优于现有模型，性能媲美级联系统，提升显著。**
...
- **简介: 该论文研究持续命名实体识别（CNER），旨在缓解类别增量学习中的灾难性遗忘和非实体类语义偏移问题。作者提出GenCNER，将任务转化为生成实体三元组序列，结合置信度伪标签与知识蒸馏，有效保留历史知识并降低标签噪声影响。**
...
- **简介: 该论文提出BabyBabelLM，构建45种语言的发展合理预训练数据集（约1亿英文词当量/语言），用于模拟母语习得过程。属于多语言认知建模任务，旨在支持多语言预训练与人类语言发展研究。**
...
- **简介: 该论文研究语言模型的知识注入效率，旨在解决arLLM微调时数据效率低和“反转诅咒”问题。通过对比发现dLLM更高效且无此缺陷，进而提出一种新的掩码微调方法，显著提升arLLM的数据效率，缩小了二者差距。**
...
- **简介: 该论文提出一种基于深度卷积神经网络的模块化框架，用于文本讽刺检测。针对缺乏语调线索导致的讽刺识别难题，融合BERT等上下文模型，结合情感、语言特征与情绪信息，构建多层架构，旨在提升社交平台和聊天机器人中的讽刺识别效果。**
...
>
---
#### [new 029] Investigating Large Language Models' Linguistic Abilities for Text Preprocessing
- **分类: cs.CL; cs.AI**
...
- **简介: 该论文提出BILLY框架，旨在解决多LLM系统高成本与延迟问题。通过在激活空间融合不同人格向量，实现单模型内多视角创意生成，提升创造力与效率，无需训练，兼具控制性与可解释性。**
...
- **简介: 该论文研究文本到图像对齐，旨在提升智障人士的语言可及性。提出基于模板的视觉-语言模型提示框架，设计五种提示模板生成简化文本对应的图像，通过自动与人工评估验证效果，发现基本对象聚焦模板和复古风格最有效。**
...
- **简介: 该论文聚焦推理增强任务，旨在解决长链思维推理中因错误累积导致的偏离问题。作者提出多路径计划聚合（MPPA）框架，通过分阶段生成与聚合候选计划，并引入在线Step-DPO训练方法，提升小模型长推理链的准确性与训练效率。**
...
- **简介: 该论文针对RAG系统易受知识污染的问题，提出SeCon-RAG框架。通过两阶段语义过滤与无冲突机制，结合实体-意图-关系提取，提升检索安全性与生成可信度，有效平衡知识保留与污染防御。**
...
- **简介: 该论文研究长时记忆型大模型代理的偏好记忆更新问题，提出PAMU机制，融合滑动窗口与指数移动平均，动态优化用户偏好表征，提升长期对话中的决策质量。**
...
- **链接: [http://arxiv.org/pdf/2510.10062v1](http://arxiv.org/pdf/2510.10062v1)**
...
- **简介: 该论文研究多标签文本分类中的距离基分类方法，解决固定阈值不适应不同标签的问题。作者提出基于验证集优化的标签特异性阈值方法，显著提升分类性能，尤其在标签集多样和样本有限时效果更优。**
...
- **简介: 该论文提出动态嵌套深度（DND）方法，旨在提升现成大语言模型性能。通过在Transformer层后动态选择关键token进行复处理，实现对难点token的“复习”，并减少冗余计算，有效增强模型表现，适用于dense与MoE架构，仅增少量计算开销。**
...
- **简介: 该论文属于综述任务，旨在解决大语言模型中归纳推理研究缺乏系统总结的问题。作者分类归纳了提升方法，整理了基准测试，并提出基于沙盒和观测覆盖率的评估方式，分析了归纳能力来源，为后续研究提供基础。**
...
- **简介: 该论文研究实时假新闻检测任务，解决证据不足场景下现有方法泛化能力差的问题。提出EASE框架，通过证据、推理和情感三个动态评估模块进行决策，并构建新基准RealTimeNews-25验证效果。**
...
- **链接: [http://arxiv.org/pdf/2510.10453v1](http://arxiv.org/pdf/2510.10453v1)**
...
- **链接: [http://arxiv.org/pdf/2510.09709v1](http://arxiv.org/pdf/2510.09709v1)**
...
- **简介: 该论文研究上下文学习中的 emergent misalignment（EM）问题，探究窄域示例是否导致大模型产生广泛不合规响应。实验发现，仅通过有害的上下文示例即可引发模型不安全行为，部分响应通过采纳危险“人设”合理化错误输出。**
...
- **链接: [http://arxiv.org/pdf/2510.10475v1](http://arxiv.org/pdf/2510.10475v1)**
...
- **链接: [http://arxiv.org/pdf/2510.10252v1](http://arxiv.org/pdf/2510.10252v1)**
...
>
---
#### [new 072] Toward Machine Translation Literacy: How Lay Users Perceive and Rely on Imperfect Translations
- **分类: cs.CL**

- **简介: 该论文研究公众对机器翻译错误的感知与依赖问题，属于人机交互与NLP交叉任务。通过博物馆实证研究（n=452），发现非双语者因缺乏评估能力而过度依赖MT，错误体验可促使其调整依赖程度，提出需提升用户MT素养。**

- **链接: [http://arxiv.org/pdf/2510.09994v1](http://arxiv.org/pdf/2510.09994v1)**
...
>
---
#### [new 075] FactAppeal: Identifying Epistemic Factual Appeals in News Media
- **分类: cs.CL**

- **简介: 该论文提出“认知诉求识别”任务，旨在识别新闻中事实主张的证据来源及支撑方式。作者构建了含3,226条句子的标注数据集FactAppeal，标注细粒度信息如来源类型、引用方式等，并基于大模型进行建模，最高达0.73宏F1值。**

- **链接: [http://arxiv.org/pdf/2510.10627v1](http://arxiv.org/pdf/2510.10627v1)**
...
>
---
#### [new 076] Evaluating Language Models' Evaluations of Games
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出评估AI对游戏评价能力的新范式，聚焦语言与推理模型在判断游戏公平性和趣味性上的表现。通过100多个新棋盘游戏及450项人类判断数据，比较模型与人类及符号代理的评价一致性，发现推理模型更贴近人类，但接近博弈论最优时反而偏离人类判断，且资源消耗不稳定。**

- **链接: [http://arxiv.org/pdf/2510.10930v1](http://arxiv.org/pdf/2510.10930v1)**
...
>
---
#### [new 077] Do Psychometric Tests Work for Large Language Models? Evaluation of Tests on Sexism, Racism, and Morality
- **分类: cs.CL**

- **简介: 该论文评估人类心理测量测试在大语言模型中的适用性，聚焦性别歧视、种族歧视和道德三个维度。研究检验了测试的信度与效度，发现其得分与模型实际行为缺乏对齐，表明直接将人类心理测试用于大语言模型存在局限，需针对性改进。**

- **链接: [http://arxiv.org/pdf/2510.11254v1](http://arxiv.org/pdf/2510.11254v1)**
...
>
---
#### [new 078] Layout-Aware Parsing Meets Efficient LLMs: A Unified, Scalable Framework for Resume Information Extraction and Evaluation
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 079] Information-Preserving Reformulation of Reasoning Traces for Antidistillation
- **分类: cs.CL**

- **简介: 该论文针对大模型推理链易被窃取的问题，提出PART方法，在保留信息的同时防御知识蒸馏。通过去除自言自语和重排子结论，有效降低学生模型性能，实现轻量级、高鲁棒的抗蒸馏保护。**

- **链接: [http://arxiv.org/pdf/2510.11545v1](http://arxiv.org/pdf/2510.11545v1)**
...
>
---
#### [new 080] DeepResearchGuard: Deep Research with Open-Domain Evaluation and Multi-Stage Guardrails for Safety
- **分类: cs.CL; cs.AI**

- **简介: 该论文针对深度研究框架在开放域报告生成中的安全与质量缺陷，提出DEEPRESEARCHGUARD框架，通过四阶段防护机制和开放域评估，提升报告的可信度、连贯性与安全性，有效降低有害内容传播风险。**

- **链接: [http://arxiv.org/pdf/2510.10994v1](http://arxiv.org/pdf/2510.10994v1)**
...
>
---
#### [new 081] NarraBench: A Comprehensive Framework for Narrative Benchmarking
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出NarraBench，构建叙事理解任务的理论分类体系，并调研78个现有基准。旨在揭示当前叙事理解评测的不足，特别是事件、风格、视角等方面覆盖不足的问题，推动更全面、主观性叙事评测基准的发展。**

- **链接: [http://arxiv.org/pdf/2510.09869v1](http://arxiv.org/pdf/2510.09869v1)**
...
>
---
#### [new 082] Survey Response Generation: Generating Closed-Ended Survey Responses In-Silico with Large Language Models
- **分类: cs.CL; cs.CY**

- **简介: 该论文研究大语言模型生成封闭式问卷答案的方法，旨在解决不同生成方法对模拟结果的影响问题。作者通过3200万次模拟，评估8种方法在10个模型上的表现，发现受限生成效果最佳，并提出方法选择建议。**

- **链接: [http://arxiv.org/pdf/2510.11586v1](http://arxiv.org/pdf/2510.11586v1)**
...
>
---
#### [new 085] Emotionally Charged, Logically Blurred: AI-driven Emotional Framing Impairs Human Fallacy Detection
- **分类: cs.CL**

- **简介: 该论文研究AI生成的情感框架如何影响人类对逻辑谬误的识别。通过大语言模型在谬误论证中注入情感，发现情感化表述降低人类识破谬误的能力，尤以恐惧和悲伤情绪增强说服力。揭示AI情感操纵在误导性论证中的风险。**

- **链接: [http://arxiv.org/pdf/2510.09695v1](http://arxiv.org/pdf/2510.09695v1)**
...
>
---
#### [new 092] LinearRAG: Linear Graph Retrieval Augmented Generation on Large-scale Corpora
- **分类: cs.CL**

- **简介: 该论文属于检索增强生成（RAG）任务，旨在解决现有图RAG方法因关系抽取不稳定导致的噪声图问题。作者提出LinearRAG，通过轻量实体提取构建无关系分层图（Tri-Graph），并采用两阶段策略实现高效精准检索。**

- **链接: [http://arxiv.org/pdf/2510.10114v1](http://arxiv.org/pdf/2510.10114v1)**
...
>
---
#### [new 098] BitMar: Low-Bit Multimodal Fusion with Episodic Memory for Edge Devices
...
>
---
#### [new 099] Detecting Hallucinations in Authentic LLM-Human Interactions
- **分类: cs.CL**

- **简介: 该论文聚焦大语言模型幻觉检测任务，旨在解决现有基准数据人工构造、缺乏真实性的缺陷。作者构建了首个基于真实人机交互的幻觉检测基准AuthenHallu，并统计分析幻觉分布，验证了通用大模型作为检测器的局限性。**

- **链接: [http://arxiv.org/pdf/2510.10539v1](http://arxiv.org/pdf/2510.10539v1)**
...
>
---
#### [new 100] Dynamic Topic Evolution with Temporal Decay and Attention in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究动态主题演化任务，旨在建模文本中主题随时间的变化。提出结合时间衰减和注意力机制的框架，利用大语言模型生成时序语义表示，并通过状态转移矩阵刻画主题演化，提升主题连贯性、多样性和可解释性。**

- **链接: [http://arxiv.org/pdf/2510.10613v1](http://arxiv.org/pdf/2510.10613v1)**
...
>
---
#### [new 105] Stabilizing MoE Reinforcement Learning by Aligning Training and Inference Routers
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文针对MoE模型在强化学习中因训练与推理路由不一致导致的训练崩溃问题，提出Rollout Routing Replay（R3）方法，通过回放推理时的路由分布来对齐训练过程，提升稳定性，有效防止训练崩溃并优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.11370v1](http://arxiv.org/pdf/2510.11370v1)**
...
>
---
#### [new 110] Latent Refinement Decoding: Enhancing Diffusion-Based Language Models by Refining Belief States
- **分类: cs.CL**

- **简介: 该论文研究非自回归文本生成任务，旨在解决并行解码中的信息丢失和过早决策问题。提出Latent Refinement Decoding框架，通过分布式掩码更新与反馈机制，在保持生成质量的同时显著提升速度。**

- **链接: [http://arxiv.org/pdf/2510.11052v1](http://arxiv.org/pdf/2510.11052v1)**
...
>
---
#### [new 111] The Curious Case of Factual (Mis)Alignment between LLMs' Short- and Long-Form Answers
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大模型在简单与复杂查询中事实回答的一致性问题，提出SLAQ框架评估16个LLM在600个问题上的表现，发现短长答案存在系统性错位，并揭示位置效应与机制相似性可预测对齐性，挑战现有评测假设。**

- **链接: [http://arxiv.org/pdf/2510.11218v1](http://arxiv.org/pdf/2510.11218v1)**
...
>
---
#### [new 112] XQuant: Achieving Ultra-Low Bit KV Cache Quantization with Cross-Layer Compression
- **分类: cs.CL**

- **简介: 该论文聚焦大模型推理中的内存优化任务，旨在解决KV缓存占用过大的问题。提出XQuant框架，通过无训练、跨层量化与数据无关校准，实现低于1.4比特的超低比特KV缓存压缩，在降低内存的同时保持模型性能。**

- **链接: [http://arxiv.org/pdf/2510.11236v1](http://arxiv.org/pdf/2510.11236v1)**
...
>
---
#### [new 125] Table Question Answering in the Era of Large Language Models: A Comprehensive Survey of Tasks, Methods, and Evaluation
- **分类: cs.CL**

- **简介: 该论文属于表格问答（TQA）任务，旨在系统梳理基于大语言模型的TQA研究。它分类整理了任务设置、方法与评测基准，分析挑战与局限，并指出未充分探索的方向，为领域发展提供统一框架和指导。**

- **链接: [http://arxiv.org/pdf/2510.09671v1](http://arxiv.org/pdf/2510.09671v1)**
...
>
---
#### [new 126] Enabling Doctor-Centric Medical AI with LLMs through Workflow-Aligned Tasks and Benchmarks
- **分类: cs.CL**

- **简介: 该论文聚焦医生中心的医疗AI任务，旨在解决LLM直接服务患者的安全风险。通过调研构建了含9.2万问答的中文数据集DoctorFLAN，并提出DoctorFLAN-test与DotaBench评测基准，提升开源LLM在临床工作流中的表现。**

- **链接: [http://arxiv.org/pdf/2510.11040v1](http://arxiv.org/pdf/2510.11040v1)**
...
>
---
#### [new 129] SemCSE-Multi: Multifaceted and Decodable Embeddings for Aspect-Specific and Interpretable Scientific Domain Mapping
- **分类: cs.CL; cs.AI; cs.IR; cs.LG**

- **简介: 该论文提出SemCSE-Multi，旨在生成可解释、多维度的科学文献嵌入。它通过无监督方法构建面向不同语义方面的嵌入模型，并实现单次前向传播输出多个方面嵌入，支持细粒度相似性计算与用户可控的可视化，提升科学领域映射的可解释性。**

- **链接: [http://arxiv.org/pdf/2510.11599v1](http://arxiv.org/pdf/2510.11599v1)**
...
>
---
#### [new 132] Lightweight Baselines for Medical Abstract Classification: DistilBERT with Cross-Entropy as a Strong Default
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究医疗文本分类任务，旨在解决大模型难以在医疗场景部署的问题。作者在固定预算下比较不同损失函数，发现轻量化的DistilBERT配合交叉熵效果最佳，提出应以紧凑模型为起点的实用方案。**

- **链接: [http://arxiv.org/pdf/2510.10025v1](http://arxiv.org/pdf/2510.10025v1)**
...
>
---
#### [new 134] Rethinking LLM Evaluation: Can We Evaluate LLMs with 200x Less Data?
- **分类: cs.CL; cs.LG**

- **简介: 该论文聚焦大模型评测任务，旨在解决评测数据冗余导致效率低下的问题。作者提出EssenceBench框架，通过遗传算法实现样本级压缩，在保证模型排名一致性的前提下，显著减少评测所需数据量，最高可用200倍更少数据完成有效评估。**

- **链接: [http://arxiv.org/pdf/2510.10457v1](http://arxiv.org/pdf/2510.10457v1)**
...
>
---
#### [new 140] DiffHeads: Differential Analysis and Inference-Time Masking of Bias Heads in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大语言模型中的偏见问题，旨在揭示偏见生成机制并提出轻量级去偏方法。通过分析不同提示方式下注意力头的差异激活，发现“偏见头”，并据此提出DiffHeads方法，有效降低模型不公平性而不影响性能。**

- **链接: [http://arxiv.org/pdf/2510.10142v1](http://arxiv.org/pdf/2510.10142v1)**
...
>
---
#### [new 148] Unilaw-R1: A Large Language Model for Legal Reasoning with Reinforcement Learning and Iterative Inference
- **分类: cs.CL**

- **简介: 该论文聚焦法律推理任务，旨在解决法律领域知识不足、推理不可靠和泛化能力弱的问题。作者提出7B规模的Unilaw-R1模型，通过构建高质量推理数据集，结合监督微调与强化学习，并设计评测基准Unilaw-R1-Eval，显著提升小模型在复杂法律任务中的表现。**

- **链接: [http://arxiv.org/pdf/2510.10072v1](http://arxiv.org/pdf/2510.10072v1)**
...
>
---
#### [new 149] Are Large Language Models Effective Knowledge Graph Constructors?
- **分类: cs.CL**

- **简介: 该论文探讨大语言模型（LLM）在构建知识图谱（KG）中的有效性，旨在解决现有方法局限于句子级抽取和预定义模式的问题。作者提出一种分层抽取框架，从研究论文中生成结构丰富、语义清晰的KG，并发布儿童心理健康领域的KG数据集以推动高风险领域应用。**

- **链接: [http://arxiv.org/pdf/2510.11297v1](http://arxiv.org/pdf/2510.11297v1)**
...
>
---
#### [new 150] Is Implicit Knowledge Enough for LLMs? A RAG Approach for Tree-based Structures
- **分类: cs.CL; cs.AI; cs.IR; cs.LG**

- **简介: 该论文研究如何高效利用RAG处理树形结构数据。针对现有方法直接检索原始代码导致冗余的问题，提出一种自底向上的线性化方法，通过层级聚合生成隐式摘要，减少检索文档量，提升效率，同时保持响应质量。**

- **链接: [http://arxiv.org/pdf/2510.10806v1](http://arxiv.org/pdf/2510.10806v1)**
...
>
---
#### [new 151] BrowserAgent: Building Web Agents with Human-Inspired Web Browsing Actions
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出BrowserAgent，旨在解决LLM在动态网页中交互能力弱的问题。通过模拟人类浏览行为（如点击、滚动），结合两阶段训练与显式记忆机制，直接在原始网页上操作，提升复杂多跳问答任务的性能。**

- **链接: [http://arxiv.org/pdf/2510.10666v1](http://arxiv.org/pdf/2510.10666v1)**
...
>
---
#### [new 152] Are LLMs Empathetic to All? Investigating the Influence of Multi-Demographic Personas on a Model's Empathy
- **分类: cs.CL**

- **简介: 该论文研究大语言模型对不同人口特征用户群体的共情差异，属人机交互与公平性任务。通过构建315种多维人口组合的用户画像，评估四类LLM在认知与情感共情上的表现，揭示模型共情偏差，强调需设计兼顾多样性的共情感知模型。**

- **链接: [http://arxiv.org/pdf/2510.10328v1](http://arxiv.org/pdf/2510.10328v1)**
...
>
---
#### [new 160] ReLook: Vision-Grounded RL with a Multimodal LLM Critic for Agentic Web Coding
- **分类: cs.LG; cs.CL**

- **简介: 该论文聚焦前端代码生成任务，解决LLM在视觉正确性判断上的不足。提出ReLook框架，结合视觉强化学习与多模态大模型作为视觉批评器，实现生成-诊断-优化闭环，提升代码渲染效果与交互匹配度。**

- **链接: [http://arxiv.org/pdf/2510.11498v1](http://arxiv.org/pdf/2510.11498v1)**
...
>
---
#### [new 161] Bag of Tricks for Subverting Reasoning-based Safety Guardrails
- **分类: cs.CR; cs.CL**

- **简介: 该论文研究大推理模型的推理型安全防护机制，揭示其易受输入提示微小操纵而失效的问题。作者提出多种越狱方法，在白盒、灰盒、黑盒场景下高效绕过防护，暴露开源模型的安全隐患，强调需更强的对齐技术。**

- **链接: [http://arxiv.org/pdf/2510.11570v1](http://arxiv.org/pdf/2510.11570v1)**
...
>
---
#### [new 162] Rediscovering Entropy Regularization: Adaptive Coefficient Unlocks Its Potential for LLM Reinforcement Learning
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文研究大模型强化学习中的推理能力提升，针对RLVR训练中熵崩溃问题，提出自适应熵正则化框架AER，通过动态调节探索与利用平衡，有效提升数学推理性能。**

- **链接: [http://arxiv.org/pdf/2510.10959v1](http://arxiv.org/pdf/2510.10959v1)**
...
>
---
#### [new 163] VCB Bench: An Evaluation Benchmark for Audio-Grounded Large Language Model Conversational Agents
- **分类: cs.SD; cs.CL**
...
>
---
#### [new 164] ArtPerception: ASCII Art-based Jailbreak on LLMs with Recognition Pre-test
...
>
---
#### [new 165] Building a Foundational Guardrail for General Agentic Systems via Synthetic Data
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文聚焦于智能体系统执行前的安全防护，旨在解决现有方法缺乏执行前风险干预的问题。作者提出合成数据引擎AuraGen、基础守护模型Safiron及新基准Pre-Exec Bench，覆盖数据生成、模型构建与评估，实现对多步计划中潜在风险的检测、分类与解释。**

- **链接: [http://arxiv.org/pdf/2510.09781v1](http://arxiv.org/pdf/2510.09781v1)**
...
>
---
#### [new 173] A Comprehensive Survey on Benchmarks and Solutions in Software Engineering of LLM-Empowered Agentic System
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于综述任务，旨在解决LLM赋能的软件工程中 benchmarks 与解决方案脱节的问题。作者分析了150+篇论文，构建了涵盖解决方案与基准的统一分类体系，揭示了技术演进路径，并提出了未来研究方向。**

- **链接: [http://arxiv.org/pdf/2510.09721v1](http://arxiv.org/pdf/2510.09721v1)**
...
>
---
#### [new 175] Translution: Unifying Self-attention and Convolution for Adaptive and Relative Modeling
...
>
---
#### [new 176] The Geometry of Reasoning: Flowing Logics in Representation Space
- **分类: cs.AI; cs.CL; cs.LG; cs.LO**

- **简介: 该论文研究大语言模型在表示空间中的推理机制，提出将推理过程建模为逻辑驱动的几何流。通过解耦逻辑结构与语义，验证模型是否真正理解逻辑，并用几何量分析推理轨迹，建立可解释的推理分析框架。**

- **链接: [http://arxiv.org/pdf/2510.09782v1](http://arxiv.org/pdf/2510.09782v1)**

> **作者:** Yufa Zhou; Yixiao Wang; Xunjian Yin; Shuyan Zhou; Anru R. Zhang
>
> **备注:** Code: https://github.com/MasterZhou1/Reasoning-Flow
>
...
>
---
#### [new 179] The Social Cost of Intelligence: Emergence, Propagation, and Amplification of Stereotypical Bias in Multi-Agent Systems
- **分类: cs.MA; cs.CL**

- **简介: 该论文研究多智能体系统中刻板偏见的产生与传播问题，属于AI公平性任务。通过模拟不同社会群体代理的交互，分析专业化、模型选择和通信机制对偏见的影响，发现合作与辩论可缓解偏见，更强的基座模型提升系统鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.10943v1](http://arxiv.org/pdf/2510.10943v1)**
...
>
---
#### [new 182] RLFR: Extending Reinforcement Learning for LLMs with Flow Environment
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究大模型推理优化任务，针对强化学习中二值奖励忽视探索的问题，提出RLFR方法，利用潜在空间流场构建奖励信号，通过压缩专家数据的上下文依赖生成流程奖励，提升语言与多模态推理能力。**

- **链接: [http://arxiv.org/pdf/2510.10201v1](http://arxiv.org/pdf/2510.10201v1)**
...
>
---
#### [new 185] QDER: Query-Specific Document and Entity Representations for Multi-Vector Document Re-Ranking
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于信息检索任务，旨在提升文档重排序效果。针对现有模型在细粒度语义和知识融合上的不足，提出QDER模型，引入 late aggregation 机制，结合多向量表示与知识图谱实体信息，显著提升复杂查询的检索性能。**

- **链接: [http://arxiv.org/pdf/2510.11589v1](http://arxiv.org/pdf/2510.11589v1)**
...
>
---
#### [new 189] Boundary-Guided Policy Optimization for Memory-efficient RL of Diffusion Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究扩散大语言模型的强化学习，解决因似然不可计算导致的高内存开销问题。提出边界引导策略优化（BGPO），通过线性可分解下界实现高效梯度计算，在降低内存的同时提升训练精度。**

- **链接: [http://arxiv.org/pdf/2510.11683v1](http://arxiv.org/pdf/2510.11683v1)**
...
>
---
#### [new 190] REGENT: Relevance-Guided Attention for Entity-Aware Multi-Vector Neural Re-Ranking
- **分类: cs.IR; cs.CL**

- **简介: 该论文针对神经重排序模型在长文档中内容选择能力弱的问题，提出REGENT模型，通过引入实体语义作为“语义骨架”指导注意力机制，融合词汇匹配与语义推理，在信息检索任务中显著提升性能。**

- **链接: [http://arxiv.org/pdf/2510.11592v1](http://arxiv.org/pdf/2510.11592v1)**
...
>
---
#### [new 193] Revisiting Model Interpolation for Efficient Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究模型插值在高效推理中的应用，旨在通过简单权重插值融合指令与思维模型。作者发现插值过程遵循三阶段演化规律，并据此提出策略性插值方法，在效率与性能上优于复杂合并方法，为定制化推理模型提供实用框架。**

- **链接: [http://arxiv.org/pdf/2510.10977v1](http://arxiv.org/pdf/2510.10977v1)**
...
>
---
#### [new 197] DRIFT: Decompose, Retrieve, Illustrate, then Formalize Theorems
- **分类: cs.AI; cs.CL; cs.IR; cs.SC**

- **简介: 该论文聚焦数学定理的自动形式化任务，旨在解决大模型因缺乏上下文而难以准确检索所需数学知识的问题。作者提出DRIFT框架，通过分解命题、检索前提与示例定理，提升形式化效果，在多个基准上显著优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.10815v1](http://arxiv.org/pdf/2510.10815v1)**
...
>
---
#### [replaced 004] From Problem-Solving to Teaching Problem-Solving: Aligning LLMs with Pedagogy using Reinforcement Learning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.15607v2](http://arxiv.org/pdf/2505.15607v2)**
...
>
---
#### [replaced 005] Talk Less, Call Right: Enhancing Role-Play LLM Agents with Automatic Prompt Optimization and Role Prompting
- **分类: cs.CL; cs.AI; cs.HC**

- **链接: [http://arxiv.org/pdf/2509.00482v2](http://arxiv.org/pdf/2509.00482v2)**
...
>
---
#### [replaced 008] DiaCDM: Cognitive Diagnosis in Teacher-Student Dialogues using the Initiation-Response-Evaluation Framework
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.24821v2](http://arxiv.org/pdf/2509.24821v2)**
...
>
---
#### [replaced 009] MFTCXplain: A Multilingual Benchmark Dataset for Evaluating the Moral Reasoning of LLMs through Multi-hop Hate Speech Explanation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.19073v4](http://arxiv.org/pdf/2506.19073v4)**

> **作者:** Jackson Trager; Francielle Vargas; Diego Alves; Matteo Guida; Mikel K. Ngueajio; Ameeta Agrawal; Yalda Daryani; Farzan Karimi-Malekabadi; Flor Miriam Plaza-del-Arco
>
> **备注:** Jackson Trager and Francielle Vargas contributed equally
>
...
>
---
#### [replaced 010] Retro*: Optimizing LLMs for Reasoning-Intensive Document Retrieval
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.24869v2](http://arxiv.org/pdf/2509.24869v2)**
...
>
---
#### [replaced 011] Evaluating LLMs for Demographic-Targeted Social Bias Detection: A Comprehensive Benchmark Study
- **分类: cs.CL; cs.CY; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.04641v2](http://arxiv.org/pdf/2510.04641v2)**
...
>
---
#### [replaced 012] On the Interplay between Musical Preferences and Personality through the Lens of Language
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.18208v2](http://arxiv.org/pdf/2508.18208v2)**
...
>
---
#### [replaced 013] Automated Alignment of Math Items to Content Standards in Large-Scale Assessments Using Language Models
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.05129v2](http://arxiv.org/pdf/2510.05129v2)**
...
>
---
#### [replaced 014] Language Surgery in Multilingual Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.12450v3](http://arxiv.org/pdf/2506.12450v3)**
...
>
---
#### [replaced 015] Saten: Sparse Augmented Tensor Networks for Post-Training Compression of Large Language Models
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.14871v2](http://arxiv.org/pdf/2505.14871v2)**
...
>
---
#### [replaced 016] Adaptive Stress Testing Black-Box LLM Planners
...
>
---
#### [replaced 017] Complexity-aware fine-tuning
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.21220v2](http://arxiv.org/pdf/2506.21220v2)**
...
>
---
#### [replaced 018] Agentic large language models improve retrieval-based radiology question answering
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.00743v3](http://arxiv.org/pdf/2508.00743v3)**
...
>
---
#### [replaced 019] HebID: Detecting Social Identities in Hebrew-language Political Text
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.15483v2](http://arxiv.org/pdf/2508.15483v2)**
...
>
---
#### [replaced 020] DITING: A Multi-Agent Evaluation Framework for Benchmarking Web Novel Translation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.09116v2](http://arxiv.org/pdf/2510.09116v2)**
...
>
---
#### [replaced 021] "Haet Bhasha aur Diskrimineshun": Phonetic Perturbations in Code-Mixed Hinglish to Red-Team LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.14226v3](http://arxiv.org/pdf/2505.14226v3)**
...
>
---
#### [replaced 022] Tailored Teaching with Balanced Difficulty: Elevating Reasoning in Multimodal Chain-of-Thought via Prompt Curriculum
- **分类: cs.CL; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2508.18673v2](http://arxiv.org/pdf/2508.18673v2)**
...
>
---
#### [replaced 023] Learning to Instruct for Visual Instruction Tuning
...
>
---
#### [replaced 026] Draw with Thought: Unleashing Multimodal Reasoning for Scientific Diagram Generation
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2504.09479v2](http://arxiv.org/pdf/2504.09479v2)**
...
>
---
#### [replaced 027] Demystifying deep search: a holistic evaluation with hint-free multi-hop questions and factorised metrics
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.05137v2](http://arxiv.org/pdf/2510.05137v2)**
...
>
---
#### [replaced 028] BabyVLM: Data-Efficient Pretraining of VLMs Inspired by Infant Learning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 029] Evolving LLMs' Self-Refinement Capability via Synergistic Training-Inference Optimization
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.05605v4](http://arxiv.org/pdf/2502.05605v4)**
...
>
---
#### [replaced 030] LIDDIA: Language-based Intelligent Drug Discovery Agent
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.13959v3](http://arxiv.org/pdf/2502.13959v3)**
...
>
---
#### [replaced 031] Knowledge-Level Consistency Reinforcement Learning: Dual-Fact Alignment for Long-Form Factuality
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.23765v2](http://arxiv.org/pdf/2509.23765v2)**
...
>
---
#### [replaced 032] A Practical Review of Mechanistic Interpretability for Transformer-Based Language Models
- **分类: cs.AI; cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2407.02646v4](http://arxiv.org/pdf/2407.02646v4)**

> **作者:** Daking Rai; Yilun Zhou; Shi Feng; Abulhair Saparov; Ziyu Yao
>
> **备注:** 61 pages, 15 figures, Preprint
>
...
>
---
#### [replaced 033] Learning to Reason as Action Abstractions with Scalable Mid-Training RL
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **链接: [http://arxiv.org/pdf/2509.25810v3](http://arxiv.org/pdf/2509.25810v3)**
...
>
---
#### [replaced 034] From $f(x)$ and $g(x)$ to $f(g(x))$: LLMs Learn New Skills in RL by Composing Old Ones
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.25123v2](http://arxiv.org/pdf/2509.25123v2)**
...
>
---
#### [replaced 035] LaDiR: Latent Diffusion Enhances LLMs for Text Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.04573v3](http://arxiv.org/pdf/2510.04573v3)**
...
>
---
#### [replaced 036] Doc2SAR: A Synergistic Framework for High-Fidelity Extraction of Structure-Activity Relationships from Scientific Documents
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2506.21625v2](http://arxiv.org/pdf/2506.21625v2)**
...
>
---
#### [replaced 037] Training and Evaluating with Human Label Variation: An Empirical Study
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.01891v5](http://arxiv.org/pdf/2502.01891v5)**

> **作者:** Kemal Kurniawan; Meladel Mistica; Timothy Baldwin; Jey Han Lau
>
> **备注:** 27 pages, 7 figures. Accepted to CL. Pre-MIT Press publication version. Fixed PO-JSD values on the MFRC dataset. Completely redid the empirical meta-evaluation, added more related work, and other minor edits
>
...
>
---
#### [replaced 038] A Survey on Automatic Credibility Assessment Using Textual Credibility Signals in the Era of Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.21360v2](http://arxiv.org/pdf/2410.21360v2)**
...
>
---
#### [replaced 040] Clip Your Sequences Fairly: Enforcing Length Fairness for Sequence-Level RL
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.09177v3](http://arxiv.org/pdf/2509.09177v3)**
...
>
---
#### [replaced 041] SkewRoute: Training-Free LLM Routing for Knowledge Graph Retrieval-Augmented Generation via Score Skewness of Retrieved Context
- **分类: cs.IR; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23841v2](http://arxiv.org/pdf/2505.23841v2)**
...
>
---
#### [replaced 044] Do LLMs Really Need 10+ Thoughts for "Find the Time 1000 Days Later"? Towards Structural Understanding of LLM Overthinking
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.07880v2](http://arxiv.org/pdf/2510.07880v2)**
...
>
---
#### [replaced 045] Retrieval is Not Enough: Enhancing RAG Reasoning through Test-Time Critique and Optimization
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2504.14858v4](http://arxiv.org/pdf/2504.14858v4)**
...
>
---
#### [replaced 046] Chronological Passage Assembling in RAG framework for Temporal Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.18748v2](http://arxiv.org/pdf/2508.18748v2)**
...
>
---
#### [replaced 047] Formalizing Style in Personal Narratives
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.08649v2](http://arxiv.org/pdf/2510.08649v2)**
...
>
---
#### [replaced 048] Exploring Compositional Generalization (in COGS/ReCOGS_pos) by Transformers using Restricted Access Sequence Processing (RASP)
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.15349v2](http://arxiv.org/pdf/2504.15349v2)**
...
>
---
#### [replaced 049] Part-of-speech tagging for Nagamese Language using CRF
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.19343v3](http://arxiv.org/pdf/2509.19343v3)**
...
>
---
#### [replaced 050] Hope vs. Hate: Understanding User Interactions with LGBTQ+ News Content in Mainstream US News Media through the Lens of Hope Speech
- **分类: cs.CL; cs.CY; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.09004v2](http://arxiv.org/pdf/2502.09004v2)**
...
>
---
#### [replaced 053] Revisit What You See: Disclose Language Prior in Vision Tokens for LVLM Decoding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 054] References Indeed Matter? Reference-Free Preference Optimization for Conversational Query Reformulation
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.06552v3](http://arxiv.org/pdf/2505.06552v3)**
...
>
---
#### [replaced 057] Test-Time Alignment for Large Language Models via Textual Model Predictive Control
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.20795v3](http://arxiv.org/pdf/2502.20795v3)**
...
>
---
#### [replaced 060] Layered Insights: Generalizable Analysis of Authorial Style by Leveraging All Transformer Layers
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.00958v3](http://arxiv.org/pdf/2503.00958v3)**
...
>
---
#### [replaced 065] Forecasting Clinical Risk from Textual Time Series: Structuring Narratives for Temporal AI in Healthcare
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.10340v3](http://arxiv.org/pdf/2504.10340v3)**
...
>
---
#### [replaced 066] Towards Thinking-Optimal Scaling of Test-Time Compute for LLM Reasoning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.18080v2](http://arxiv.org/pdf/2502.18080v2)**
...
>
---
#### [replaced 071] SPFT-SQL: Enhancing Large Language Model for Text-to-SQL Parsing by Self-Play Fine-Tuning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.03937v2](http://arxiv.org/pdf/2509.03937v2)**
...
>
---
#### [replaced 072] On the Mathematical Relationship Between Layer Normalization and Dynamic Activation Functions
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.21708v3](http://arxiv.org/pdf/2503.21708v3)**

> **作者:** Felix Stollenwerk
>
> **备注:** Revision and Simplification (starting point RMSNorm instead of LN)
>
...
>
---
#### [replaced 073] MADS: Multi-Agent Dialogue Simulation for Diverse Persuasion Data Generation
- **分类: cs.CL; cs.AI; cs.CY; cs.HC; cs.MA**

- **链接: [http://arxiv.org/pdf/2510.05124v2](http://arxiv.org/pdf/2510.05124v2)**

> **作者:** Mingjin Li; Yu Liu; Huayi Liu; Xiang Ye; Chao Jiang; Hongguang Zhang; Yu Ruan
>
...
>
---
#### [replaced 074] Self-Filtered Distillation with LLMs-generated Trust Indicators for Reliable Patent Classification
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.05431v2](http://arxiv.org/pdf/2510.05431v2)**
...
>
---
#### [replaced 082] Jigsaw-R1: A Study of Rule-based Visual Reinforcement Learning with Jigsaw Puzzles
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 083] Rethinking the Residual Distribution of Locate-then-Editing Methods in Model Editing
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.03748v2](http://arxiv.org/pdf/2502.03748v2)**
...
>
---
#### [replaced 084] MathTutorBench: A Benchmark for Measuring Open-ended Pedagogical Capabilities of LLM Tutors
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.18940v2](http://arxiv.org/pdf/2502.18940v2)**

> **作者:** Jakub Macina; Nico Daheim; Ido Hakimi; Manu Kapur; Iryna Gurevych; Mrinmaya Sachan
>
> **备注:** Accepted to EMNLP 2025 Main as an oral presentation. Website: https://eth-lre.github.io/mathtutorbench
>
> **摘要:** Evaluating the pedagogical capabilities of AI-based tutoring models is critical for making guided progress in the field. Yet, we lack a reliable, easy-to-use, and simple-to-run evaluation that reflects the pedagogical abilities of models. To fill this gap, we present MathTutorBench, an open-source benchmark for holistic tutoring model evaluation. MathTutorBench contains a collection of datasets and metrics that broadly cover tutor abilities as defined by learning sciences research in dialog-based teaching. To score the pedagogical quality of open-ended teacher responses, we train a reward model and show it can discriminate expert from novice teacher responses with high accuracy. We evaluate a wide set of closed- and open-weight models on MathTutorBench and find that subject expertise, indicated by solving ability, does not immediately translate to good teaching. Rather, pedagogy and subject expertise appear to form a trade-off that is navigated by the degree of tutoring specialization of the model. Furthermore, tutoring appears to become more challenging in longer dialogs, where simpler questioning strategies begin to fail. We release the benchmark, code, and leaderboard openly to enable rapid benchmarking of future models.
>
---
#### [replaced 085] Prompt4Trust: A Reinforcement Learning Prompt Augmentation Framework for Clinically-Aligned Confidence Calibration in Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 086] HalluDetect: Detecting, Mitigating, and Benchmarking Hallucinations in Conversational Systems in the Legal Domain
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.11619v2](http://arxiv.org/pdf/2509.11619v2)**
...
>
> **备注:** 7 pages + references + appendix, 3 figures, 3 tables
>
...
>
---
#### [replaced 087] Unveiling Downstream Performance Scaling of LLMs: A Clustering-Based Perspective
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.17262v3](http://arxiv.org/pdf/2502.17262v3)**
...
>
---
#### [replaced 090] The Visual Iconicity Challenge: Evaluating Vision-Language Models on Sign Language Form-Meaning Mapping
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 091] REFRAG: Rethinking RAG based Decoding
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.01092v2](http://arxiv.org/pdf/2509.01092v2)**
...
>
---
#### [replaced 094] PhoniTale: Phonologically Grounded Mnemonic Generation for Typologically Distant Language Pairs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.05444v3](http://arxiv.org/pdf/2507.05444v3)**

> **作者:** Sana Kang; Myeongseok Gwon; Su Young Kwon; Jaewook Lee; Andrew Lan; Bhiksha Raj; Rita Singh
>
> **备注:** Accepted to EMNLP 2025 Main Conference
>
> **摘要:** Vocabulary acquisition poses a significant challenge for second-language (L2) learners, especially when learning typologically distant languages such as English and Korean, where phonological and structural mismatches complicate vocabulary learning. Recently, large language models (LLMs) have been used to generate keyword mnemonics by leveraging similar keywords from a learner's first language (L1) to aid in acquiring L2 vocabulary. However, most methods still rely on direct IPA-based phonetic matching or employ LLMs without phonological guidance. In this paper, we present PhoniTale, a novel cross-lingual mnemonic generation system that performs IPA-based phonological adaptation and syllable-aware alignment to retrieve L1 keyword sequence and uses LLMs to generate verbal cues. We evaluate PhoniTale through automated metrics and a short-term recall test with human participants, comparing its output to human-written and prior automated mnemonics. Our findings show that PhoniTale consistently outperforms previous automated approaches and achieves quality comparable to human-written mnemonics.
>
---
#### [replaced 095] Hallucinate at the Last in Long Response Generation: A Case Study on Long Document Summarization
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.15291v2](http://arxiv.org/pdf/2505.15291v2)**

> **作者:** Joonho Yang; Seunghyun Yoon; Hwan Chang; Byeongjeong Kim; Hwanhee Lee
>
> **备注:** 22 tables, 8 figures
>
...
>
---
#### [replaced 096] SliceFine: The Universal Winning-Slice Hypothesis for Pretrained Networks
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 097] dInfer: An Efficient Inference Framework for Diffusion Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.08666v2](http://arxiv.org/pdf/2510.08666v2)**
...
>
---
#### [replaced 098] SPG: Sandwiched Policy Gradient for Masked Diffusion Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.09541v2](http://arxiv.org/pdf/2510.09541v2)**
...
>
---
#### [replaced 099] Efficient Compositional Multi-tasking for On-device Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.16083v2](http://arxiv.org/pdf/2507.16083v2)**
...
>
---
#### [replaced 100] Personality Editing for Language Models through Adjusting Self-Referential Queries
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.11789v3](http://arxiv.org/pdf/2502.11789v3)**

> **作者:** Seojin Hwang; Yumin Kim; Byeongjeong Kim; Donghoon Shin; Hwanhee Lee
>
> **备注:** 22 pages, 5 figures, 26 tables
>
...
>
---
#### [replaced 101] Talk Isn't Always Cheap: Understanding Failure Modes in Multi-Agent Debate
- **分类: cs.CL; cs.AI; cs.MA**

- **链接: [http://arxiv.org/pdf/2509.05396v2](http://arxiv.org/pdf/2509.05396v2)**
...
>
---
#### [replaced 102] Revisiting Chain-of-Thought Prompting: Zero-shot Can Be Stronger than Few-shot
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.14641v2](http://arxiv.org/pdf/2506.14641v2)**
...
>
---
#### [replaced 103] Think in Safety: Unveiling and Mitigating Safety Alignment Collapse in Multimodal Large Reasoning Model
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.06538v4](http://arxiv.org/pdf/2505.06538v4)**
...
>
---
#### [replaced 108] Are Language Models Consequentialist or Deontological Moral Reasoners?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.21479v2](http://arxiv.org/pdf/2505.21479v2)**
...
>
---
#### [replaced 109] Token Hidden Reward: Steering Exploration-Exploitation in Group Relative Deep Reinforcement Learning
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.03669v2](http://arxiv.org/pdf/2510.03669v2)**
...
>
---
#### [replaced 112] Can Compact Language Models Search Like Agents? Distillation-Guided Policy Optimization for Preserving Agentic RAG Capabilities
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.20324v3](http://arxiv.org/pdf/2508.20324v3)**
...
>
---
#### [replaced 113] mCLM: A Modular Chemical Language Model that Generates Functional and Makeable Molecules
- **分类: cs.AI; cs.CL; cs.LG; q-bio.QM**

- **链接: [http://arxiv.org/pdf/2505.12565v2](http://arxiv.org/pdf/2505.12565v2)**
...
>
---
#### [replaced 114] Tversky Neural Networks: Psychologically Plausible Deep Learning with Differentiable Tversky Similarity
...
>
---
#### [replaced 115] FURINA: A Fully Customizable Role-Playing Benchmark via Scalable Multi-Agent Collaboration Pipeline
- **分类: cs.CL; cs.AI; cs.HC; cs.MA**

- **链接: [http://arxiv.org/pdf/2510.06800v2](http://arxiv.org/pdf/2510.06800v2)**

> **作者:** Haotian Wu; Shufan Jiang; Mingyu Chen; Yiyang Feng; Hehai Lin; Heqing Zou; Yao Shu; Chengwei Qin
>
...
>
---
#### [replaced 116] DeAL: Decoding-time Alignment for Large Language Models
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2402.06147v3](http://arxiv.org/pdf/2402.06147v3)**
...
>
---
#### [replaced 119] Human-inspired Episodic Memory for Infinite Context LLMs
- **分类: cs.AI; cs.CL; cs.LG; q-bio.NC**

- **链接: [http://arxiv.org/pdf/2407.09450v3](http://arxiv.org/pdf/2407.09450v3)**
...
>
---
#### [replaced 120] MemGen: Weaving Generative Latent Memory for Self-Evolving Agents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.24704v2](http://arxiv.org/pdf/2509.24704v2)**
...
>
---
#### [replaced 121] TemplateRL: Structured Template-Guided Reinforcement Learning for LLM Reasoning
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.15692v3](http://arxiv.org/pdf/2505.15692v3)**
...
>
---
#### [replaced 122] Attributing Response to Context: A Jensen-Shannon Divergence Driven Mechanistic Study of Context Attribution in Retrieval-Augmented Generation
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.16415v4](http://arxiv.org/pdf/2505.16415v4)**

> **作者:** Ruizhe Li; Chen Chen; Yuchen Hu; Yanjun Gao; Xi Wang; Emine Yilmaz
>
> **备注:** Best Paper Award at COLM 2025 XLLM-Reason-Plan Workshop; Accepted at NeurIPS 2025 Mechanistic Interpretability Workshop
>
...
>
---
#### [replaced 123] J1: Incentivizing Thinking in LLM-as-a-Judge via Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.10320v3](http://arxiv.org/pdf/2505.10320v3)**
...
>
---
#### [replaced 124] Reveal-Bangla: A Dataset for Cross-Lingual Multi-Step Reasoning Evaluation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.08933v2](http://arxiv.org/pdf/2508.08933v2)**

> **作者:** Khondoker Ittehadul Islam; Gabriele Sarti
>
> **备注:** Submitted to BLP workshop @ IJCNLP-AACL 2025
>
...
>
---
#### [replaced 125] VLMGuard-R1: Proactive Safety Alignment for VLMs via Reasoning-Driven Prompt Optimization
- **分类: cs.LG; cs.CL; cs.CV**
...
>
---
#### [replaced 126] Text-Based Approaches to Item Alignment to Content Standards in Large-Scale Reading & Writing Tests
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.26431v4](http://arxiv.org/pdf/2509.26431v4)**

> **作者:** Yanbin Fu; Hong Jiao; Tianyi Zhou; Nan Zhang; Ming Li; Qingshu Xu; Sydney Peters; Robert W. Lissitz
>
> **备注:** need updates
>
...
>
---
#### [replaced 127] DrDiff: Dynamic Routing Diffusion with Hierarchical Attention for Breaking the Efficiency-Quality Trade-off
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.02785v2](http://arxiv.org/pdf/2509.02785v2)**
...
>
---
#### [replaced 128] TriangleMix: Accelerating Prefilling via Decoding-time Contribution Sparsity
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.21526v2](http://arxiv.org/pdf/2507.21526v2)**
...
>
---
#### [replaced 129] MultiFinBen: Benchmarking Large Language Models for Multilingual and Multimodal Financial Application
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.14028v3](http://arxiv.org/pdf/2506.14028v3)**
...
>
> **摘要:** Real-world financial analysis involves information across multiple languages and modalities, from reports and news to scanned filings and meeting recordings. Yet most existing evaluations of LLMs in finance remain text-only, monolingual, and largely saturated by current models. To bridge these gaps, we present MultiFinBen, the first expert-annotated multilingual (five languages) and multimodal (text, vision, audio) benchmark for evaluating LLMs in realistic financial contexts. MultiFinBen introduces two new task families: multilingual financial reasoning, which tests cross-lingual evidence integration from filings and news, and financial OCR, which extracts structured text from scanned documents containing tables and charts. Rather than aggregating all available datasets, we apply a structured, difficulty-aware selection based on advanced model performance, ensuring balanced challenge and removing redundant tasks. Evaluating 21 leading LLMs shows that even frontier multimodal models like GPT-4o achieve only 46.01% overall, stronger on vision and audio but dropping sharply in multilingual settings. These findings expose persistent limitations in multilingual, multimodal, and expert-level financial reasoning. All datasets, evaluation scripts, and leaderboards are publicly released.
>
---
#### [replaced 130] Does Machine Unlearning Truly Remove Knowledge?
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23270v2](http://arxiv.org/pdf/2505.23270v2)**
...
>
> **备注:** NeurIPS 2025 (Lock-LLM Workshop)
>
...
>
---
#### [replaced 131] Why Is Spatial Reasoning Hard for VLMs? An Attention Mechanism Perspective on Focus Areas
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.01773v3](http://arxiv.org/pdf/2503.01773v3)**
...
>
---
#### [replaced 133] Equivalent Linear Mappings of Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.24293v3](http://arxiv.org/pdf/2505.24293v3)**
...
>
---
#### [replaced 135] Steering LLMs for Formal Theorem Proving
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.15507v5](http://arxiv.org/pdf/2502.15507v5)**
...
>
---
#### [replaced 136] VNJPTranslate: A comprehensive pipeline for Vietnamese-Japanese translation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.00339v2](http://arxiv.org/pdf/2504.00339v2)**
...
>
---
#### [replaced 139] Self-Exploring Language Models for Explainable Link Forecasting on Temporal Graphs via Reinforcement Learning
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.00975v2](http://arxiv.org/pdf/2509.00975v2)**
...
>
---
#### [replaced 140] DSPO: Stable and Efficient Policy Optimization for Agentic Search and Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.09255v2](http://arxiv.org/pdf/2510.09255v2)**
...
>
---
#### [replaced 141] When Machine Unlearning Meets Retrieval-Augmented Generation (RAG): Keep Secret or Forget Knowledge?
- **分类: cs.CR; cs.CL**

- **链接: [http://arxiv.org/pdf/2410.15267v2](http://arxiv.org/pdf/2410.15267v2)**
...
>
---
#### [replaced 144] TRepLiNa: Layer-wise CKA+REPINA Alignment Improves Low-Resource Machine Translation in Aya-23 8B
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.06249v2](http://arxiv.org/pdf/2510.06249v2)**
...
>
---
#### [replaced 145] Dyna-Think: Synergizing Reasoning, Acting, and World Model Simulation in AI Agents
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.00320v3](http://arxiv.org/pdf/2506.00320v3)**
...
>
---
#### [replaced 146] ViDRiP-LLaVA: A Dataset and Benchmark for Diagnostic Reasoning from Pathology Videos
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 147] Dynamic Optimizations of LLM Ensembles with Two-Stage Reinforcement Learning Agents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.04492v2](http://arxiv.org/pdf/2502.04492v2)**
...
>
---
#### [replaced 148] Exploring the Generalizability of Factual Hallucination Mitigation via Enhancing Precise Knowledge Utilization
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.19127v3](http://arxiv.org/pdf/2502.19127v3)**
...
>
---
#### [replaced 150] Teaching LLM to be Persuasive: Reward-Enhanced Policy Optimization for Alignment frm Heterogeneous Rewards
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.04214v2](http://arxiv.org/pdf/2510.04214v2)**
...
>
---
#### [replaced 151] The Enemy from Within: A Study of Political Delegitimization Discourse in Israeli Political Speech
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.15524v2](http://arxiv.org/pdf/2508.15524v2)**
...
>
---
#### [replaced 152] Noise Injection Systemically Degrades Large Language Model Safety Guardrails
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.13500v2](http://arxiv.org/pdf/2505.13500v2)**

> **作者:** Prithviraj Singh Shahani; Kaveh Eskandari Miandoab; Matthias Scheutz
>
...
>
---
#### [replaced 153] Probing the Difficulty Perception Mechanism of Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.05969v2](http://arxiv.org/pdf/2510.05969v2)**
...
>
---
#### [replaced 154] Effectiveness of Counter-Speech against Abusive Content: A Multidimensional Annotation and Classification Study
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.11919v2](http://arxiv.org/pdf/2506.11919v2)**
...
>
---
#### [replaced 155] DMDTEval: An Evaluation and Analysis of LLMs on Disambiguation in Multi-domain Translation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.20371v3](http://arxiv.org/pdf/2504.20371v3)**
...
>
---
#### [replaced 156] Training Long-Context, Multi-Turn Software Engineering Agents with Reinforcement Learning
- **分类: cs.LG; cs.CL; cs.SE**

- **链接: [http://arxiv.org/pdf/2508.03501v2](http://arxiv.org/pdf/2508.03501v2)**
...
>
---
#### [replaced 158] LADM: Long-context Training Data Selection with Attention-based Dependency Measurement for LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.02502v3](http://arxiv.org/pdf/2503.02502v3)**
...
>
---
#### [replaced 161] EpiCache: Episodic KV Cache Management for Long Conversational Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.17396v3](http://arxiv.org/pdf/2509.17396v3)**
...
>
---
#### [replaced 162] Question-Driven Analysis and Synthesis: Building Interpretable Thematic Trees with LLMs for Text Clustering and Controllable Generation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.22211v2](http://arxiv.org/pdf/2509.22211v2)**
...
>
---
#### [replaced 163] Debate, Deliberate, Decide (D3): A Cost-Aware Adversarial Framework for Reliable and Interpretable LLM Evaluation
- **分类: cs.CL; cs.LG; cs.MA**

- **链接: [http://arxiv.org/pdf/2410.04663v3](http://arxiv.org/pdf/2410.04663v3)**

> **作者:** Chaithanya Bandi; Abir Harrasse
>
...
>
---
#### [replaced 164] Does Reinforcement Learning Really Incentivize Reasoning Capacity in LLMs Beyond the Base Model?
...
>
---
#### [replaced 167] Distribution-Aligned Decoding for Efficient LLM Task Adaptation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.15888v3](http://arxiv.org/pdf/2509.15888v3)**
...
>
---
#### [replaced 168] oMeBench: Towards Robust Benchmarking of LLMs in Organic Mechanism Elucidation and Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.07731v2](http://arxiv.org/pdf/2510.07731v2)**
...
>
---
#### [replaced 169] Re:Form -- Reducing Human Priors in Scalable Formal Software Verification with RL in LLMs: A Preliminary Study on Dafny
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.16331v3](http://arxiv.org/pdf/2507.16331v3)**
...
>
---
#### [replaced 170] Native Hybrid Attention for Efficient Sequence Modeling
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.07019v2](http://arxiv.org/pdf/2510.07019v2)**

> **作者:** Jusen Du; Jiaxi Hu; Tao Zhang; Weigao Sun; Yu Cheng
>
> **备注:** This article is temporarily withdrawn by the author(s) pending the completion of a mandatory internal review process
>
