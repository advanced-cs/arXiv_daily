...
>
---
#### [new 003] BLaDA: Bridging Language to Functional Dexterous Actions within 3DGS Fields
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 004] Stitch4D: Sparse Multi-Location 4D Urban Reconstruction via Spatio-Temporal Interpolation
- **分类: cs.CV**

- **简介: 论文提出Stitch4D，解决稀疏多视角城市4D重建问题。通过合成中间视图和联合优化，提升空间覆盖与时间一致性，实现稳定重建。**

- **链接: [https://arxiv.org/pdf/2604.07923](https://arxiv.org/pdf/2604.07923)**
...
>
> **摘要:** We introduce RewardFlow, an inversion-free framework that steers pretrained diffusion and flow-matching models at inference time through multi-reward Langevin dynamics. RewardFlow unifies complementary differentiable rewards for semantic alignment, perceptual fidelity, localized grounding, object consistency, and human preference, and further introduces a differentiable VQA-based reward that provides fine-grained semantic supervision through language-vision reasoning. To coordinate these heterogeneous objectives, we design a prompt-aware adaptive policy that extracts semantic primitives from the instruction, infers edit intent, and dynamically modulates reward weights and step sizes throughout sampling. Across several image editing and compositional generation benchmarks, RewardFlow delivers state-of-the-art edit fidelity and compositional alignment.
>
---
#### [new 011] Symbiotic-MoE: Unlocking the Synergy between Generation and Understanding
- **分类: cs.CV; cs.CL; cs.LG**

- **简介: 该论文属于多模态任务，解决生成与理解任务间的冲突问题。提出Symbiotic-MoE框架，通过专家解耦和渐进训练提升跨模态协同效果。**

- **链接: [https://arxiv.org/pdf/2604.07753](https://arxiv.org/pdf/2604.07753)**
...
>
---
#### [new 012] ParseBench: A Document Parsing Benchmark for AI Agents
- **分类: cs.CV**

- **简介: 该论文提出ParseBench，一个面向AI代理的文档解析基准，解决企业自动化中语义正确性不足的问题。通过多维度评估，揭示现有方法的局限性。**
...
>
---
#### [new 013] DSCA: Dynamic Subspace Concept Alignment for Lifelong VLM Editing
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视觉语言模型的持续编辑任务，解决多轮编辑中概念干扰和遗忘问题。提出DSCA方法，通过分解表示空间实现精准无干扰编辑。**

- **链接: [https://arxiv.org/pdf/2604.07965](https://arxiv.org/pdf/2604.07965)**
...
>
---
#### [new 016] Visually-grounded Humanoid Agents
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 019] Adapting Foundation Models for Annotation-Efficient Adnexal Mass Segmentation in Cine Images
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决标注数据不足下的卵巢囊肿分割问题。通过引入预训练的DINOv3模型，提升分割性能与数据效率。**

- **链接: [https://arxiv.org/pdf/2604.08045](https://arxiv.org/pdf/2604.08045)**
...
>
---
#### [new 022] WUTDet: A 100K-Scale Ship Detection Dataset and Benchmarks with Dense Small Objects
- **分类: cs.CV**

- **简介: 该论文属于目标检测任务，旨在解决现有船检测数据集规模小、场景单一的问题。构建了大规模的WUTDet数据集，并评估不同检测模型的性能与泛化能力。**

- **链接: [https://arxiv.org/pdf/2604.07759](https://arxiv.org/pdf/2604.07759)**
...
>
---
#### [new 023] Weakly-Supervised Lung Nodule Segmentation via Training-Free Guidance of 3D Rectified Flow
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，解决3D肺结节分割中标注成本高的问题。通过结合预训练模型，实现弱监督下的准确分割。**
...
>
---
#### [new 024] HY-Embodied-0.5: Embodied Foundation Models for Real-World Agents
- **分类: cs.CV**

- **简介: 该论文提出HY-Embodied-0.5，用于提升实体智能体的视觉感知与推理能力，解决现实世界中代理的感知与决策问题。**

- **链接: [https://arxiv.org/pdf/2604.07430](https://arxiv.org/pdf/2604.07430)**
...
>
---
#### [new 030] Scal3R: Scalable Test-Time Training for Large-Scale 3D Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，旨在解决长视频序列中重建精度和一致性问题。提出一种轻量级全局上下文表示，提升重建效果与效率。**

- **链接: [https://arxiv.org/pdf/2604.08542](https://arxiv.org/pdf/2604.08542)**
...
>
> **摘要:** Processing long-form videos with Video Large Language Models (Video-LLMs) is computationally prohibitive. Current efficiency methods often compromise fine-grained perception through irreversible information disposal or inhibit long-range temporal modeling via rigid, predefined sparse patterns. This paper introduces AdaSpark, an adaptive sparsity framework designed to address these limitations. AdaSpark first partitions video inputs into 3D spatio-temporal cubes. It then employs two co-designed, context-aware components: (1) Adaptive Cube-Selective Attention (AdaS-Attn), which adaptively selects a subset of relevant video cubes to attend for each query token, and (2) Adaptive Token-Selective FFN (AdaS-FFN), which selectively processes only the most salient tokens within each cube. An entropy-based (Top-p) selection mechanism adaptively allocates computational resources based on input complexity. Experiments demonstrate that AdaSpark significantly reduces computational load by up to 57% FLOPs while maintaining comparable performance to dense models and preserving fine-grained, long-range dependencies, as validated on challenging hour-scale video benchmarks.
>
---
#### [new 033] Tensor-Augmented Convolutional Neural Networks: Enhancing Expressivity with Generic Tensor Kernels
- **分类: cs.CV; physics.comp-ph**

- **简介: 该论文提出TACNN，通过引入通用张量核增强CNN表达能力，解决深度网络计算复杂和难以解释的问题，实现高效高精度的图像分类。**

- **链接: [https://arxiv.org/pdf/2604.08072](https://arxiv.org/pdf/2604.08072)**
...
>
---
#### [new 034] PokeGym: A Visually-Driven Long-Horizon Benchmark for Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出PokeGym，一个用于视觉语言模型的3D长周期基准任务，解决其在复杂环境中的交互与导航问题，通过严格隔离和自动化评估，揭示模型在物理死锁上的局限性。**

- **链接: [https://arxiv.org/pdf/2604.08340](https://arxiv.org/pdf/2604.08340)**
...
>
---
#### [new 040] On the Uphill Battle of Image frequency Analysis
- **分类: cs.CV**

- **简介: 论文探讨非均匀数据的聚类算法，研究三维图像傅里叶变换以发现隐藏模式，属于图像分析任务，旨在提升频域分析效果。**

- **链接: [https://arxiv.org/pdf/2604.07563](https://arxiv.org/pdf/2604.07563)**
...
>
> **摘要:** This work is a follow up on the newly proposed clustering algorithm called The Inverse Square Mean Shift Algorithm. In this paper a special case of algorithm for dealing with non-homogenous data is formulated and the three dimensional Fast Fourier Transform of images is investigated with the aim of finding hidden patterns.
>
---
#### [new 041] PolySLGen: Online Multimodal Speaking-Listening Reaction Generation in Polyadic Interaction
- **分类: cs.CV**

- **简介: 该论文提出PolySLGen，解决多模态对话生成任务中的多人群体互动问题，通过融合姿态和社交线索，生成自然的语音与动作反应。**
...
>
---
#### [new 042] Lost in the Hype: Revealing and Dissecting the Performance Degradation of Medical Multimodal Large Language Models in Image Classification
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于医学图像分类任务，旨在解决医疗多模态大语言模型性能下降的问题。通过实验与特征分析，揭示了四个性能退化原因并提出评估指标。**

- **链接: [https://arxiv.org/pdf/2604.08333](https://arxiv.org/pdf/2604.08333)**
...
>
---
#### [new 043] LPM 1.0: Video-based Character Performance Model
- **分类: cs.CV; cs.AI; cs.MM**

- **简介: 该论文提出LPM 1.0，解决视频角色表演生成中的表达力、实时性和身份稳定性问题，通过多模态模型实现对话场景下的高质量角色表演生成。**

- **链接: [https://arxiv.org/pdf/2604.07823](https://arxiv.org/pdf/2604.07823)**
...
>
> **摘要:** Performance, the externalization of intent, emotion, and personality through visual, vocal, and temporal behavior, is what makes a character alive. Learning such performance from video is a promising alternative to traditional 3D pipelines. However, existing video models struggle to jointly achieve high expressiveness, real-time inference, and long-horizon identity stability, a tension we call the performance trilemma. Conversation is the most comprehensive performance scenario, as characters simultaneously speak, listen, react, and emote while maintaining identity over time. To address this, we present LPM 1.0 (Large Performance Model), focusing on single-person full-duplex audio-visual conversational performance. Concretely, we build a multimodal human-centric dataset through strict filtering, speaking-listening audio-video pairing, performance understanding, and identity-aware multi-reference extraction; train a 17B-parameter Diffusion Transformer (Base LPM) for highly controllable, identity-consistent performance through multimodal conditioning; and distill it into a causal streaming generator (Online LPM) for low-latency, infinite-length interaction. At inference, given a character image with identity-aware references, LPM 1.0 generates listening videos from user audio and speaking videos from synthesized audio, with text prompts for motion control, all at real-time speed with identity-stable, infinite-length generation. LPM 1.0 thus serves as a visual engine for conversational agents, live streaming characters, and game NPCs. To systematically evaluate this setting, we propose LPM-Bench, the first benchmark for interactive character performance. LPM 1.0 achieves state-of-the-art results across all evaluated dimensions while maintaining real-time inference.
>
---
#### [new 044] E-3DPSM: A State Machine for Event-Based Egocentric 3D Human Pose Estimation
- **分类: cs.CV**

- **简介: 该论文属于事件相机下的自视角3D人体姿态估计任务，旨在解决现有方法精度低、稳定性差的问题。提出E-3DPSM模型，通过事件驱动的状态机提升姿态估计的准确性和稳定性。**

- **链接: [https://arxiv.org/pdf/2604.08543](https://arxiv.org/pdf/2604.08543)**
...
>
---
#### [new 052] What They Saw, Not Just Where They Looked: Semantic Scanpath Similarity via VLMs and NLP metric
- **分类: cs.CV; cs.CL; cs.HC**

- **简介: 该论文属于眼动分析任务，解决传统方法忽略语义相似性的问题。通过融合视觉语言模型，提取注视区域的语义描述，计算语义相似性，补充了空间对齐的不足。**

- **链接: [https://arxiv.org/pdf/2604.08494](https://arxiv.org/pdf/2604.08494)**
...
>
---
#### [new 056] 3DrawAgent: Teaching LLM to Draw in 3D with Early Contrastive Experience
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出3DrawAgent，解决从自然语言生成3D草图的问题。利用LLM和几何反馈，通过对比学习优化绘制质量，实现无需参数更新的3D空间理解与绘图能力。**

- **链接: [https://arxiv.org/pdf/2604.08042](https://arxiv.org/pdf/2604.08042)**
...
>
---
#### [new 062] Bridging Time and Space: Decoupled Spatio-Temporal Alignment for Video Grounding
- **分类: cs.CV**

- **简介: 该论文属于视频定位任务，解决时空对齐和视觉冗余问题。提出Bridge-STG框架，通过解耦时空定位并保持语义一致，提升视频理解性能。**
...
>
---
#### [new 063] Act Wisely: Cultivating Meta-Cognitive Tool Use in Agentic Multimodal Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于人工智能任务，解决agentic multimodal模型中元认知不足问题，通过HDPO框架提升工具使用效率与推理准确性。**

- **链接: [https://arxiv.org/pdf/2604.08545](https://arxiv.org/pdf/2604.08545)**
...
>
---
#### [new 071] ReconPhys: Reconstruct Appearance and Physical Attributes from Single Video
- **分类: cs.CV**

- **简介: 该论文提出ReconPhys，用于从单视频中重建物体外观和物理属性，解决非刚性物体物理合理重建的问题，通过联合学习与自监督训练实现快速准确的3D重建。**

- **链接: [https://arxiv.org/pdf/2604.07882](https://arxiv.org/pdf/2604.07882)**
...
>
---
#### [new 076] SceneScribe-1M: A Large-Scale Video Dataset with Comprehensive Geometric and Semantic Annotations
- **分类: cs.CV**

- **简介: 该论文提出SceneScribe-1M，一个包含百万视频的多模态数据集，解决3D感知与视频生成融合中的数据不足问题，提供丰富的几何和语义标注，支持多种下游任务。**
...
>
---
#### [new 077] Latent Anomaly Knowledge Excavation: Unveiling Sparse Sensitive Neurons in Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于异常检测任务，旨在解决VLMs中隐含异常知识难以被激活的问题。通过LAKE框架，识别并激发少量正常样本中的敏感神经元，提升检测性能并增强可解释性。**
...
>
---
#### [new 087] OpenVLThinkerV2: A Generalist Multimodal Reasoning Model for Multi-domain Visual Tasks
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文提出G²RPO方法，解决多模态模型训练中的奖励分布不均和感知与推理平衡问题，构建了高效通用的多领域视觉模型OpenVLThinkerV2。**
...
>
---
#### [new 088] SyncBreaker:Stage-Aware Multimodal Adversarial Attacks on Audio-Driven Talking Head Generation
- **分类: cs.CV**

- **简介: 该论文属于音频驱动的说话头生成防护任务，旨在解决单模态攻击效果差的问题。提出SyncBreaker框架，通过多阶段联合扰动图像和音频输入，有效破坏唇形同步与面部动态。**
...
>
---
#### [new 092] EditCaption: Human-Aligned Instruction Synthesis for Image Editing via Supervised Fine-Tuning and Direct Preference Optimization
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像编辑任务，解决指令合成中的错误问题。通过两阶段方法提升指令质量，提高模型性能与准确性。**
...
>
---
#### [new 093] Sampling-Aware 3D Spatial Analysis in Multiplexed Imaging
- **分类: cs.CV**

- **简介: 该论文属于三维空间分析任务，解决二维采样与三维组织结构不匹配的问题。通过几何感知重建模块，实现从稀疏切片中可靠进行三维分析。**

- **链接: [https://arxiv.org/pdf/2604.07890](https://arxiv.org/pdf/2604.07890)**
...
>
---
#### [new 102] ETCH-X: Robustify Expressive Body Fitting to Clothed Humans with Composable Datasets
- **分类: cs.CV**

- **简介: 该论文属于人体姿态估计任务，解决衣着人类3D点云与人体模型对齐的问题。提出ETCH-X方法，通过解耦“脱衣”和“密集匹配”模块，提升拟合的鲁棒性和表达能力。**
...
>
---
#### [new 103] MSCT: Differential Cross-Modal Attention for Deepfake Detection
- **分类: cs.CV; cs.MM**

- **简介: 该论文属于深度伪造检测任务，旨在解决多模态特征提取不足和对齐偏差问题。提出MSCT模型，结合多尺度自注意力和差异跨模态注意力进行特征融合。**

- **链接: [https://arxiv.org/pdf/2604.07741](https://arxiv.org/pdf/2604.07741)**
...
>
---
#### [new 104] Needle in a Haystack -- One-Class Representation Learning for Detecting Rare Malignant Cells in Computational Cytology
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分析任务，旨在解决低见证率下恶性细胞检测难题。通过一阶表示学习方法，在无监督情况下提升检测效果。**
...
>
---
#### [new 107] DinoRADE: Full Spectral Radar-Camera Fusion with Vision Foundation Model Features for Multi-class Object Detection in Adverse Weather
- **分类: cs.CV**

- **简介: 该论文属于多模态目标检测任务，解决恶劣天气下小目标检测不足的问题。提出DinoRADE方法，融合雷达与视觉特征，提升检测性能。**

- **链接: [https://arxiv.org/pdf/2604.08074](https://arxiv.org/pdf/2604.08074)**
...
>
---
#### [new 114] Shortcut Learning in Glomerular AI: Adversarial Penalties Hurt, Entropy Helps
- **分类: cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在解决肾病AI中因染色差异导致的快捷学习问题。通过多中心、多染色数据集和熵正则化方法，提升模型对病变的准确识别并减少对染色的依赖。**
...
>
---
#### [new 115] Cross-Modal Emotion Transfer for Emotion Editing in Talking Face Video
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于情感编辑任务，旨在解决说话人脸视频中情感表达不灵活、难以生成扩展情感的问题。提出C-MET方法，通过跨模态情感迁移生成更真实的情感视频。**

- **链接: [https://arxiv.org/pdf/2604.07786](https://arxiv.org/pdf/2604.07786)**
...
>
---
#### [new 116] LINE: LLM-based Iterative Neuron Explanations for Vision Models
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出LINE，用于视觉模型中神经元概念的开放词汇解释。解决传统方法受限于预定义词汇或描述过细的问题，通过迭代生成提升解释效果。**
...
>
---
#### [new 117] Direct Segmentation without Logits Optimization for Training-Free Open-Vocabulary Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文属于开放词汇语义分割任务，旨在解决传统方法依赖迭代训练和注意力调优的问题。提出直接通过分布差异计算分割图，提升效率与性能。**

- **链接: [https://arxiv.org/pdf/2604.07723](https://arxiv.org/pdf/2604.07723)**
...
>
---
#### [new 118] SAT: Selective Aggregation Transformer for Image Super-Resolution
- **分类: cs.CV**

- **简介: 该论文属于图像超分辨率任务，解决Transformer模型计算复杂度高和感受野受限的问题。提出SAT模型，通过选择性聚合减少计算量，提升效率并保持细节。**
...
>
---
#### [new 119] AVGen-Bench: A Task-Driven Benchmark for Multi-Granular Evaluation of Text-to-Audio-Video Generation
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文提出AVGen-Bench，解决文本到音频视频生成的评估问题。通过多粒度框架评估生成内容的语义和感知质量，揭示现有方法在语义可靠性上的不足。**

- **链接: [https://arxiv.org/pdf/2604.08540](https://arxiv.org/pdf/2604.08540)**
...
>
---
#### [new 122] Adaptive Depth-converted-Scale Convolution for Self-supervised Monocular Depth Estimation
- **分类: cs.CV**

- **简介: 该论文属于单目深度估计任务，旨在解决物体尺寸与深度变化带来的模糊问题。提出DcSConv和DcS-F模块，通过尺度自适应卷积增强特征提取，提升深度估计精度。**

- **链接: [https://arxiv.org/pdf/2604.07665](https://arxiv.org/pdf/2604.07665)**
...
>
---
#### [new 125] Plug-and-Play Logit Fusion for Heterogeneous Pathology Foundation Models
- **分类: cs.CV**

- **简介: 该论文针对病理学基础模型融合问题，提出LogitProd方法，在不重训练编码器的情况下融合多个模型输出，提升诊断性能。**
...
>
---
#### [new 126] Entropy-Gradient Grounding: Training-Free Evidence Retrieval in Vision-Language Models
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于视觉语言模型的接地任务，解决细节依赖和多区域线索融合问题。提出一种无需训练的熵梯度方法，通过不确定性监督获取视觉区域相关性，提升证据检索效果。**

- **链接: [https://arxiv.org/pdf/2604.08456](https://arxiv.org/pdf/2604.08456)**
...
>
---
#### [new 131] Generative 3D Gaussian Splatting for Arbitrary-ResolutionAtmospheric Downscaling and Forecasting
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于气象预测任务，旨在解决高分辨率大气数据生成与降尺度的计算效率问题。提出GSSA-ViT框架，结合3D高斯点云与尺度感知注意力机制，实现多尺度精准预测。**
...
>
---
#### [new 138] EgoVerse: An Egocentric Human Dataset for Robot Learning from Around the World
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 139] Are GUI Agents Focused Enough? Automated Distraction via Semantic-level UI Element Injection
- **分类: cs.CR; cs.CL; cs.CV**

- **简介: 该论文属于安全领域，研究GUI代理的鲁棒性问题。通过语义级UI元素注入，模拟对抗攻击，验证模型在实际威胁下的脆弱性。**

- **链接: [https://arxiv.org/pdf/2604.07831](https://arxiv.org/pdf/2604.07831)**
...
>
---
#### [new 141] PrivFedTalk: Privacy-Aware Federated Diffusion with Identity-Stable Adapters for Personalized Talking-Head Generation
- **分类: cs.CR; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于个性化说话头像生成任务，解决隐私保护下的联邦学习问题。提出PrivFedTalk框架，结合扩散模型与轻量身份适配器，保障数据隐私并提升生成效果。**

- **链接: [https://arxiv.org/pdf/2604.08037](https://arxiv.org/pdf/2604.08037)**
...
>
---
#### [new 142] A Physical Agentic Loop for Language-Guided Grasping with Execution-State Monitoring
...
>
---
#### [new 143] MonoUNet: A Robust Tiny Neural Network for Automated Knee Cartilage Segmentation on Point-of-Care Ultrasound Devices
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决膝关节软骨自动分割问题。提出MonoUNet模型，提升小型化深度学习模型的鲁棒性与效率。**

- **链接: [https://arxiv.org/pdf/2604.07780](https://arxiv.org/pdf/2604.07780)**
...
>
---
#### [new 145] Open-Ended Instruction Realization with LLM-Enabled Multi-Planner Scheduling in Autonomous Vehicles
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 146] PASK: Toward Intent-Aware Proactive Agents with Long-Term Memory
- **分类: cs.AI; cs.CL; cs.CV; cs.HC; cs.MA**

- **简介: 该论文属于智能代理任务，旨在解决真实场景下主动代理的长期记忆与意图感知问题。提出DD-MM-PAS框架和Pask系统，结合流式意图模型与混合记忆，提升代理的主动性和准确性。**

- **链接: [https://arxiv.org/pdf/2604.08000](https://arxiv.org/pdf/2604.08000)**
...
>
---
#### [new 147] RoboAgent: Chaining Basic Capabilities for Embodied Task Planning
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 148] Scaling-Aware Data Selection for End-to-End Autonomous Driving Systems
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出MOSAIC框架，解决自动驾驶中数据选择问题，通过划分数据域并优化数据混合，提升模型性能。任务是提高端到端自动驾驶系统的训练效率。**

- **链接: [https://arxiv.org/pdf/2604.08366](https://arxiv.org/pdf/2604.08366)**
...
>
---
#### [new 149] Semantic Noise Reduction via Teacher-Guided Dual-Path Audio-Visual Representation Learning
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 150] MVOS_HSI: A Python Library for Preprocessing Agricultural Crop Hyperspectral Data
- **分类: cs.SE; cs.CV**

- **简介: 该论文提出MVOS_HSI库，解决农业高光谱数据处理流程不统一、难以复现的问题，提供标准化预处理工具。**
...
>
---
#### [new 151] Bias Redistribution in Visual Machine Unlearning: Does Forgetting One Group Harm Another?
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于机器学习公平性研究，探讨模型遗忘特定群体数据后是否导致偏见转移。通过实验分析CLIP模型在不同群体间的偏见分布，揭示当前遗忘方法的局限性。**

- **链接: [https://arxiv.org/pdf/2604.08111](https://arxiv.org/pdf/2604.08111)**
...
>
---
#### [new 152] Kuramoto Oscillatory Phase Encoding: Neuro-inspired Synchronization for Improved Learning Efficiency
- **分类: cs.LG; cs.CV; cs.NE**

- **简介: 该论文提出KoPE机制，将神经同步引入视觉Transformer，解决模型学习效率低的问题，提升结构学习和任务表现。**

- **链接: [https://arxiv.org/pdf/2604.07904](https://arxiv.org/pdf/2604.07904)**
...
>
---
#### [new 153] Fail2Drive: Benchmarking Closed-Loop Driving Generalization
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 154] WorldMAP: Bootstrapping Vision-Language Navigation Trajectory Prediction with Generative World Models
...
>
---
#### [new 155] SIM1: Physics-Aligned Simulator as Zero-Shot Data Scaler in Deformable Worlds
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 156] U-CECE: A Universal Multi-Resolution Framework for Conceptual Counterfactual Explanations
- **分类: cs.AI; cs.CV**

- **简介: 该论文提出U-CECE框架，解决概念反事实解释的表达与效率平衡问题，支持多分辨率表示，提升解释的准确性与效率。**
...
#### [replaced 001] MCLR: Improving Conditional Modeling via Inter-Class Likelihood-Ratio Maximization and Unifying Classifier-Free Guidance with Alignment Objectives
- **分类: cs.LG; cs.AI; cs.CV**
...
>
---
#### [replaced 002] EchoTorrent: Towards Swift, Sustained, and Streaming Multi-Modal Video Generation
- **分类: cs.CV**
...
>
---
#### [replaced 003] AnyImageNav: Any-View Geometry for Precise Last-Meter Image-Goal Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 004] VAREX: A Benchmark for Multi-Modal Structured Extraction from Documents
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.15118](https://arxiv.org/pdf/2603.15118)**
...
- **链接: [https://arxiv.org/pdf/2503.06717](https://arxiv.org/pdf/2503.06717)**
...
>
---
#### [replaced 015] The Persistence of Cultural Memory: Investigating Multimodal Iconicity in Diffusion Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 016] SD-FSMIS: Adapting Stable Diffusion for Few-Shot Medical Image Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.03134](https://arxiv.org/pdf/2604.03134)**
...
>
---
#### [replaced 019] A Geometric Algorithm for Blood Vessel Reconstruction from Skeletal Representation
- **分类: cs.CV; cs.CG**

- **链接: [https://arxiv.org/pdf/2402.12797](https://arxiv.org/pdf/2402.12797)**

> **作者:** Guoqing Zhang; Yang Li
>
> **备注:** 9 pages (without reference), 6 figures
>
...
>
---
#### [replaced 020] PixelCAM: Pixel Class Activation Mapping for Histology Image Classification and ROI Localization
- **分类: cs.CV**
...
>
---
#### [replaced 021] Face2Scene: Using Facial Degradation as an Oracle for Diffusion-Based Scene Restoration
- **分类: cs.CV**
...
>
---
#### [replaced 022] SpatialMosaic: A Multiview VLM Dataset for Partial Visibility
- **分类: cs.CV**
...
>
---
#### [replaced 023] Nearest Neighbor Projection Removal Adversarial Training
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.07673](https://arxiv.org/pdf/2509.07673)**
...
>
---
#### [replaced 024] Making MLLMs Blind: Adversarial Smuggling Attacks in MLLM Content Moderation
- **分类: cs.CV**
...
>
---
#### [replaced 025] Physical Knot Classification Beyond Accuracy: A Benchmark and Diagnostic Study
- **分类: cs.CV**
...
>
---
#### [replaced 029] CodecSight: Leveraging Video Codec Signals for Efficient Streaming VLM Inference
...
>
---
#### [replaced 030] Towards Effective Long Video Understanding of Multimodal Large Language Models via One-shot Clip Retrieval
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08410](https://arxiv.org/pdf/2512.08410)**
...
>
---
#### [replaced 033] BADiff: Bandwidth Adaptive Diffusion Model
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.21366](https://arxiv.org/pdf/2510.21366)**
...
>
---
#### [replaced 036] PSR: Scaling Multi-Subject Personalized Image Generation with Pairwise Subject-Consistency Rewards
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01236](https://arxiv.org/pdf/2512.01236)**
...
>
---
#### [replaced 037] Mind the Generative Details: Direct Localized Detail Preference Optimization for Video Diffusion Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 038] Location Is All You Need: Continuous Spatiotemporal Neural Representations of Earth Observation Data
- **分类: cs.CV**
...
>
> **备注:** Updated the affiliation of one of the authors, no changes to the technical content
>
...
>
---
#### [replaced 039] PhyEdit: Towards Real-World Object Manipulation via Physically-Grounded Image Editing
- **分类: cs.CV**
...
>
---
#### [replaced 040] GenLCA: 3D Diffusion for Full-Body Avatars from In-the-Wild Videos
- **分类: cs.CV**
...
>
---
#### [replaced 041] AI-Driven Marine Robotics: Emerging Trends in Underwater Perception and Ecosystem Monitoring
...
>
---
#### [replaced 044] Reason-SVG: Enhancing Structured Reasoning for Vector Graphics Generation with Reinforcement Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.24499](https://arxiv.org/pdf/2505.24499)**

> **作者:** Ximing Xing; Ziteng Xue; Yandong Guan; Jing Zhang; Dong Xu; Qian Yu
>
> **备注:** Accepted by CVPR 2026. 16 pages, 7 figures
>
...
>
---
#### [replaced 045] AnchorSplat: Feed-Forward 3D Gaussian Splatting with 3D Geometric Priors
- **分类: cs.CV**
...
>
---
#### [replaced 050] Learning to Search: A Decision-Based Agent for Knowledge-Based Visual Question Answering
- **分类: cs.CV**
...
>
---
#### [replaced 051] Mitigating Spurious Background Bias in Multimedia Recognition with Disentangled Concept Bottlenecks
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 052] Reasoning Within the Mind: Dynamic Multimodal Interleaving in Latent Space
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于多模态推理任务，旨在解决模型在推理过程中依赖显式步骤、交互不稳定的问题。提出DMLR框架，通过动态融合视觉与文本信息提升推理效率与性能。**

- **链接: [https://arxiv.org/pdf/2512.12623](https://arxiv.org/pdf/2512.12623)**
...
>
---
#### [replaced 053] Adversarial Flow Models
- **分类: cs.LG; cs.CV**
...
>
---
#### [replaced 056] UniLACT: Depth-Aware RGB Latent Action Learning for Vision-Language-Action Models
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 062] Adversarial Evasion Attacks on Computer Vision using SHAP Values
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 063] Deep Learning-Powered Visual SLAM Aimed at Assisting Visually Impaired Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 064] SUPERGLASSES: Benchmarking Vision Language Models as Intelligent Agents for AI Smart Glasses
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.22683](https://arxiv.org/pdf/2602.22683)**
...
>
---
#### [replaced 065] OxEnsemble: Fair Ensembles for Low-Data Classification
- **分类: cs.CV; cs.CY; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.09665](https://arxiv.org/pdf/2512.09665)**

> **作者:** Jonathan Rystrøm; Zihao Fu; Chris Russell
>
> **备注:** Forthcoming @ MIDL 2026
>
...
>
---
#### [replaced 066] Privacy Attacks on Image AutoRegressive Models
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2502.02514](https://arxiv.org/pdf/2502.02514)**
...
>
---
#### [replaced 067] Evaluating Low-Light Image Enhancement Across Multiple Intensity Levels
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.15496](https://arxiv.org/pdf/2511.15496)**
...
>
---
#### [replaced 068] Pseudo-Expert Regularized Offline RL for End-to-End Autonomous Driving in Photorealistic Closed-Loop Environments
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 071] Action Without Interaction: Probing the Physical Foundations of Video LMMs via Contact-Release Detection
- **分类: cs.CV; cs.AI; q-bio.NC**

- **链接: [https://arxiv.org/pdf/2511.20162](https://arxiv.org/pdf/2511.20162)**

> **作者:** Daniel Harari; Michael Sidorov; Chen Shterental; Liel David; Abrham Kahsay Gebreselasie; Muhammad Haris Khan
>
...
>
---
#### [replaced 074] Video Parallel Scaling: Aggregating Diverse Frame Subsets for VideoLLMs
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.08016](https://arxiv.org/pdf/2509.08016)**

> **作者:** Hyungjin Chung; Hyelin Nam; Jiyeon Kim; Hyojun Go; Byeongjun Park; Junho Kim; Joonseok Lee; Seongsu Ha; Byung-Hoon Kim
>
> **备注:** CVPR Findings 2026; code: this https URL
>
...
>
---
#### [replaced 075] Understanding Task Transfer in Vision-Language Models
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.18787](https://arxiv.org/pdf/2511.18787)**
...
>
---
#### [replaced 076] Ecological Legacies of Pre-Columbian Settlements Evident in Palm Clusters of Neotropical Mountain Forests
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.06949](https://arxiv.org/pdf/2507.06949)**
...
>
---
#### [replaced 080] ChangeBridge: Spatiotemporal Image Generation with Multimodal Controls for Remote Sensing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.04678](https://arxiv.org/pdf/2507.04678)**
...
>
---
#### [replaced 081] CompoDistill: Attention Distillation for Compositional Reasoning in Multimodal LLMs
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.12184](https://arxiv.org/pdf/2510.12184)**

> **作者:** Jiwan Kim; Kibum Kim; Sangwoo Seo; Chanyoung Park
>
> **备注:** ICLR'26, Project Page : this https URL
>
...
>
---
#### [replaced 082] SonoSelect: Efficient Ultrasound Perception via Active Probe Exploration
- **分类: cs.CV**
...
>
---
#### [replaced 083] Cost-Efficient Multi-Scale Fovea for Semantic-Based Visual Search Attention
- **分类: eess.IV; cs.CV**
...
>
---
#### [replaced 086] MinerU2.5-Pro: Pushing the Limits of Data-Centric Document Parsing at Scale
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于文档解析任务，解决数据不足与标注质量低的问题。通过数据工程和训练策略提升模型性能，无需改变架构。**
...
>
---
#### [replaced 088] Reading Recognition in the Wild
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 089] Horticultural Temporal Fruit Monitoring via 3D Instance Segmentation and Re-Identification using Colored Point Clouds
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 090] Machine Unlearning in the Era of Quantum Machine Learning: An Empirical Study
- **分类: cs.LG; cs.AI; cs.CV**
...
>
---
#### [replaced 091] RQR3D: Reparametrizing the regression targets for BEV-based 3D object detection
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.17732](https://arxiv.org/pdf/2505.17732)**

> **作者:** Ozsel Kilinc; Cem Tarhan
>
> **备注:** To appear in proceedings of CVPR Findings 2026
>
