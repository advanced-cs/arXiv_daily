...
>
---
#### [new 007] Learning Neural Parametric 3D Breast Shape Models for Metrical Surface Reconstruction From Monocular RGB Videos
- **分类: cs.CV**
...
- **简介: 该论文研究生成健康反事实图像，用于医学影像异常检测。针对现有扩散模型难以平衡病灶去除与解剖特征保留的问题，提出使用去噪扩散桥模型（DDBM），通过引入合成病理图像作为结构先验，实现更精准的健康反事实生成。**
...
- **简介: 该论文针对光流估计中成本体积计算开销大的问题，提出一种训练策略，可在训练中移除成本体积。方法显著提升推理速度、降低内存占用，实现高效高精度光流估计。**
...
- **简介: 该论文提出NoisePrints，一种无需修改生成过程的轻量级水印方法，用于在私有扩散模型中证明生成内容的作者身份。通过将初始噪声种子作为水印，并结合哈希函数与零知识证明，实现高效、安全的第三方验证。**
...
- **简介: 该论文研究视频生成中的物理合理性问题，提出PhysMaster框架。通过设计PhysEncoder，利用强化学习结合人类反馈，从图像中提取物理表征并指导视频生成，提升模型对物理规律的遵循能力，实现更真实的动态预测。**
...
- **简介: 该论文针对视觉-语言-动作（VLA）模型空间推理能力不足的问题，提出DepthVLA框架，通过引入预训练深度预测模块和混合Transformer结构，实现端到端的深度感知空间推理，在真实与模拟环境中均显著提升性能。**
...
- **链接: [http://arxiv.org/pdf/2510.13808v1](http://arxiv.org/pdf/2510.13808v1)**
...
- **简介: 该论文研究基于DINOv2的少样本异常检测，探讨其对抗鲁棒性和不确定性量化问题。作者提出轻量线性头实现白盒攻击，发现模型易受扰动影响；并通过Platt scaling校准异常分数，提升不确定性和攻击检测能力，推动可信部署。**
...
- **简介: 该论文研究12导联心电图多标签异常分类任务，旨在提升长序列心电信号的分类性能。提出一种结合一维卷积与Mamba状态空间模型的混合框架，通过增强时序依赖建模，在PhysioNet 2020和2021挑战赛数据上取得了优于现有方法的AUPRC和AUROC表现。**
...
- **简介: 该论文针对嵌入式系统上的实时人群计数任务，解决现有模型参数多、计算复杂的问题。提出一种轻量级茎-编码器-解码器结构，通过大卷积核、条件通道加权和特征金字塔网络，在保证精度的同时实现最快推理速度。**
...
- **简介: 该论文提出多视图定制任务，解决现有模型在视角控制与文本定制间难以兼顾的问题。作者设计MVCustom框架，通过几何隐式渲染与一致性补全，实现兼具多视图几何一致性和文本定制准确性的生成。**
...
- **简介: 该论文针对视觉-语言模型在描述对象检测中难以理解否定（如“不是女孩”）的问题，提出构建高质量否定数据集CoVAND，并设计轻量级文本标记合并模块NegToMe，保留否定语义结构，提升模型对否定的识别能力。**
...
- **简介: 该论文聚焦脑部动脉环（CoW）中心线提取，解决传统方法因复杂几何导致的中心线提取难题。作者基于TopCoW数据集，构建中心线图谱与形态特征，提出U-Net结合A*的算法，实现高精度拓扑重建与稳健特征提取，并发布数据与代码推动后续研究。**
...
- **简介: 该论文研究图像隐写术，旨在提升信息嵌入容量。通过引入中央凹渲染与高效潜在表示，模型将容量从100提升至500比特，显著降低误码率，并保持良好视觉质量，验证了感知设计在多模态隐写中的有效性。**
...
- **链接: [http://arxiv.org/pdf/2510.13670v1](http://arxiv.org/pdf/2510.13670v1)**
...
- **简介: 该论文研究多模态视觉-语言模型中的高效视觉编码问题，提出SCOPE框架，通过实例级路由动态选择最优视觉编码器，结合共享编码器与轻量路由器，以显著降低计算成本并提升性能，证明智能选择优于直接堆叠编码器。**
...
- **简介: 该论文研究视觉图神经网络（ViG）在图像分类与语义分割中的应用，旨在解决现有图构建方法计算昂贵且易丢失长程连接的问题。作者提出对数可扩展图构建（LSGC）和多尺度高分辨率模型LogViG，显著降低计算与参数量，同时提升性能。**
...
- **简介: 该论文旨在将fMRI数据适配于Vision Transformers。通过将4D fMRI转为2D视频平面图，利用MAE框架自监督训练，验证数据规模与性能的幂律关系，支持跨被试状态识别与个体特质解码，推动fMRI基础模型的开放研究。**
...
- **简介: 该论文研究手术视频中的未来事件预测，旨在解决现有方法缺乏统一框架和细粒度监督的问题。提出状态变化学习新范式，构建SurgFUTR模型与多任务基准SFPBench，实现短/长期手术事件的准确预测，提升跨手术泛化能力。**
...
- **简介: 该论文针对文本到视频生成模型在长序列叙事连贯性评估方面的不足，提出SeqBench基准，包含多复杂度叙事提示和人工标注视频，并设计基于动态时序图的自动评测指标，系统揭示了现有模型在对象状态一致性、物理合理性和动作时序上的缺陷。**
...
>
---
#### [new 060] Epistemic-aware Vision-Language Foundation Model for Fetal Ultrasound Interpretation
- **分类: cs.CV; cs.AI; cs.IR; cs.MM**

- **简介: 该论文针对胎儿超声解读任务，解决现有模型在多视图、多疾病和图像多样性下的性能瓶颈。提出FetalMind系统，结合专家知识图与强化学习，解耦视图-疾病关联，并构建大规模数据集FetalSigma-1M，提升报告生成与诊断准确性。**

- **链接: [http://arxiv.org/pdf/2510.12953v1](http://arxiv.org/pdf/2510.12953v1)**
...
>
---
#### [new 064] CymbaDiff: Structured Spatial Diffusion for Sketch-based 3D Semantic Urban Scene Generation
- **分类: cs.CV**

- **简介: 该论文研究基于草图的3D语义城市场景生成，旨在解决缺乏标注数据和空间连贯性差的问题。作者构建了首个大规模基准SketchSem3D，并提出CymbaDiff模型，通过结构化扩散增强场景的语义一致性与空间合理性。**

- **链接: [http://arxiv.org/pdf/2510.13245v1](http://arxiv.org/pdf/2510.13245v1)**
...
>
---
#### [new 065] Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering
- **分类: cs.CV; cs.GR**

- **简介: 该论文研究动态城市场景渲染，旨在减少对LiDAR和真实运动标注的依赖。提出结合2D先验与SDF引导的3DGS方法，通过SDF与高斯点阵融合优化几何与形变建模，提升渲染与重建精度，并支持场景编辑。**

- **链接: [http://arxiv.org/pdf/2510.13381v1](http://arxiv.org/pdf/2510.13381v1)**
...
>
> **摘要:** Dynamic scene rendering and reconstruction play a crucial role in computer vision and augmented reality. Recent methods based on 3D Gaussian Splatting (3DGS), have enabled accurate modeling of dynamic urban scenes, but for urban scenes they require both camera and LiDAR data, ground-truth 3D segmentations and motion data in the form of tracklets or pre-defined object templates such as SMPL. In this work, we explore whether a combination of 2D object agnostic priors in the form of depth and point tracking coupled with a signed distance function (SDF) representation for dynamic objects can be used to relax some of these requirements. We present a novel approach that integrates Signed Distance Functions (SDFs) with 3D Gaussian Splatting (3DGS) to create a more robust object representation by harnessing the strengths of both methods. Our unified optimization framework enhances the geometric accuracy of 3D Gaussian splatting and improves deformation modeling within the SDF, resulting in a more adaptable and precise representation. We demonstrate that our method achieves state-of-the-art performance in rendering metrics even without LiDAR data on urban scenes. When incorporating LiDAR, our approach improved further in reconstructing and generating novel views across diverse object categories, without ground-truth 3D motion annotation. Additionally, our method enables various scene editing tasks, including scene decomposition, and scene composition.
>
---
#### [new 066] ExpressNet-MoE: A Hybrid Deep Neural Network for Emotion Recognition
- **分类: cs.CV; cs.LG; I.2.10; I.5.2; H.4.2**

- **简介: 该论文研究面部表情识别任务，旨在解决复杂条件下情绪识别准确率低的问题。作者提出ExpressNet-MoE模型，融合CNN与MoE框架，通过多尺度特征提取和自适应专家选择提升泛化能力，在多个数据集上取得优异性能。**

- **链接: [http://arxiv.org/pdf/2510.13493v1](http://arxiv.org/pdf/2510.13493v1)**
...
>
---
#### [new 067] MimicParts: Part-aware Style Injection for Speech-Driven 3D Motion Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究语音驱动的3D人物动作生成，旨在解决现有方法对风格多样性及局部运动差异建模不足的问题。提出MimicParts框架，通过分区域风格注入与注意力机制，实现基于语音节奏和情感的精细化、个性化动作生成。**

- **链接: [http://arxiv.org/pdf/2510.13208v1](http://arxiv.org/pdf/2510.13208v1)**
...
>
---
#### [new 077] MMLongCite: A Benchmark for Evaluating Fidelity of Long-Context Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 078] Trace Anything: Representing Any Video in 4D via Trajectory Fields
- **分类: cs.CV**

- **简介: 该论文提出“轨迹场”表示视频中每个像素的连续3D运动轨迹，构建4D时空表征。针对视频动态建模任务，设计Trace Anything网络，单次前向预测全轨迹场，实现高效、精确的点跟踪与运动预测，兼具操控、预报和融合能力。**

- **链接: [http://arxiv.org/pdf/2510.13802v1](http://arxiv.org/pdf/2510.13802v1)**

> **作者:** Xinhang Liu; Yuxi Xiao; Donny Y. Chen; Jiashi Feng; Yu-Wing Tai; Chi-Keung Tang; Bingyi Kang
>
> **摘要:** Effective spatio-temporal representation is fundamental to modeling, understanding, and predicting dynamics in videos. The atomic unit of a video, the pixel, traces a continuous 3D trajectory over time, serving as the primitive element of dynamics. Based on this principle, we propose representing any video as a Trajectory Field: a dense mapping that assigns a continuous 3D trajectory function of time to each pixel in every frame. With this representation, we introduce Trace Anything, a neural network that predicts the entire trajectory field in a single feed-forward pass. Specifically, for each pixel in each frame, our model predicts a set of control points that parameterizes a trajectory (i.e., a B-spline), yielding its 3D position at arbitrary query time instants. We trained the Trace Anything model on large-scale 4D data, including data from our new platform, and our experiments demonstrate that: (i) Trace Anything achieves state-of-the-art performance on our new benchmark for trajectory field estimation and performs competitively on established point-tracking benchmarks; (ii) it offers significant efficiency gains thanks to its one-pass paradigm, without requiring iterative optimization or auxiliary estimators; and (iii) it exhibits emergent abilities, including goal-conditioned manipulation, motion forecasting, and spatio-temporal fusion. Project page: https://trace-anything.github.io/.
>
---
#### [new 079] Accelerated Feature Detectors for Visual SLAM: A Comparative Study of FPGA vs GPU
...
>
---
#### [new 080] AVAR-Net: A Lightweight Audio-Visual Anomaly Recognition Framework with a Benchmark Dataset
- **分类: cs.CV**

- **简介: 该论文研究音频-视觉异常识别任务，旨在解决现有方法仅依赖视觉模态及缺乏同步音视频数据集的问题。作者提出轻量级框架AVAR-Net，结合Wav2Vec2与MobileViT提取多模态特征，通过早期融合和MTCN建模时序依赖，并构建新基准数据集VAAR，验证了方法的有效性与优越性。**

- **链接: [http://arxiv.org/pdf/2510.13630v1](http://arxiv.org/pdf/2510.13630v1)**
...
>
---
#### [new 081] High Semantic Features for the Continual Learning of Complex Emotions: a Lightweight Solution
- **分类: cs.CV**

- **简介: 该论文研究复杂情感的持续学习任务，旨在缓解灾难性遗忘问题。作者提出使用语义性强、非瞬态的动作单元（AUs）作为特征，构建轻量模型，在CFEE数据集上实现75%准确率，优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.13534v1](http://arxiv.org/pdf/2510.13534v1)**
...
>
---
#### [new 082] True Self-Supervised Novel View Synthesis is Transferable
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文研究自监督新视角合成（NVS）任务，旨在解决现有方法姿态表示不可迁移的问题。作者提出XFactor模型，首次实现无需几何先验的可迁移NVS，通过配对姿态估计与输入输出增强，解耦姿态与场景内容，验证了潜变量姿态与真实姿态的高度相关性。**

- **链接: [http://arxiv.org/pdf/2510.13063v1](http://arxiv.org/pdf/2510.13063v1)**
...
>
---
#### [new 083] Model-agnostic Adversarial Attack and Defense for Vision-Language-Action Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究视觉-语言-动作（VLA）模型的对抗鲁棒性，提出一种无需模型知识的通用对抗贴片攻击EDPA，通过破坏视觉与文本语义对齐误导模型；并设计基于对抗微调的防御方法，有效缓解攻击影响。实验表明攻击显著提升任务失败率，防御机制具备有效性。**

- **链接: [http://arxiv.org/pdf/2510.13237v1](http://arxiv.org/pdf/2510.13237v1)**
...
>
---
#### [new 084] UniCalli: A Unified Diffusion Framework for Column-Level Generation and Recognition of Chinese Calligraphy
- **分类: cs.CV**

- **简介: 该论文提出UniCalli，一个统一的扩散框架，用于列级中文书法生成与识别。旨在解决现有方法在布局美感与书写正确性间的权衡问题，通过联合训练提升两者性能，尤其在数据有限时，并扩展至甲骨文、埃及象形文字等古文字。**

- **链接: [http://arxiv.org/pdf/2510.13745v1](http://arxiv.org/pdf/2510.13745v1)**
...
>
---
#### [new 085] Map the Flow: Revealing Hidden Pathways of Information in VideoLLMs
- **分类: cs.CV**

- **简介: 该论文研究视频大语言模型（VideoLLMs）的内部信息流动机制，旨在揭示其在视频问答任务中如何进行时空推理。通过可解释性技术，发现跨帧交互与视频-语言逐步融合的关键路径，并验证了基于此路径剪枝仍能保持性能，为提升模型可解释性与泛化提供依据。**

- **链接: [http://arxiv.org/pdf/2510.13251v1](http://arxiv.org/pdf/2510.13251v1)**
...
>
---
#### [new 091] Paper Copilot: Tracking the Evolution of Peer Review in AI Conferences
- **分类: cs.CV; cs.AI; cs.DL; cs.LG**

- **简介: 该论文聚焦于AI会议同行评审系统的演进问题，旨在解决评审负荷重、标准不一、过程不透明等挑战。作者构建了Paper Copilot系统，建立可持久化存档的评审数据库，发布开放数据集并开展大规模实证分析，支持对评审机制的可重复研究，推动评审体系向更稳健、透明和可靠方向发展。**

- **链接: [http://arxiv.org/pdf/2510.13201v1](http://arxiv.org/pdf/2510.13201v1)**
...
>
---
#### [new 092] Self-Augmented Visual Contrastive Decoding
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对大视觉语言模型易产生幻觉的问题，提出一种无需训练的解码策略。通过查询感知的自增强提示和基于输出稀疏性的自适应阈值算法，提升生成结果的事实一致性。**

- **链接: [http://arxiv.org/pdf/2510.13315v1](http://arxiv.org/pdf/2510.13315v1)**
...
>
---
#### [new 093] Spatial-DISE: A Unified Benchmark for Evaluating Spatial Reasoning in Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文聚焦视觉语言模型的空间推理能力评估，提出新基准Spatial-DISE，涵盖认知启发的四类空间推理任务。针对数据稀缺，构建自动化生成 pipeline，发布评测集与训练集，并评估28种主流VLM，揭示其在多步多视角推理上显著落后于人类。**

- **链接: [http://arxiv.org/pdf/2510.13394v1](http://arxiv.org/pdf/2510.13394v1)**
...
>
---
#### [new 094] Direction-aware multi-scale gradient loss for infrared and visible image fusion
- **分类: cs.CV**

- **简介: 该论文研究红外与可见光图像融合，旨在解决传统梯度损失忽略方向信息导致边缘模糊的问题。作者提出一种方向感知的多尺度梯度损失，分别监督水平和垂直梯度分量并保留符号，提升边缘清晰度与纹理保持，无需修改网络结构。**

- **链接: [http://arxiv.org/pdf/2510.13067v1](http://arxiv.org/pdf/2510.13067v1)**

> **作者:** Kaixuan Yang; Wei Xiang; Zhenshuai Chen; Tong Jin; Yunpeng Liu
>
> **摘要:** Infrared and visible image fusion aims to integrate complementary information from co-registered source images to produce a single, informative result. Most learning-based approaches train with a combination of structural similarity loss, intensity reconstruction loss, and a gradient-magnitude term. However, collapsing gradients to their magnitude removes directional information, yielding ambiguous supervision and suboptimal edge fidelity. We introduce a direction-aware, multi-scale gradient loss that supervises horizontal and vertical components separately and preserves their sign across scales. This axis-wise, sign-preserving objective provides clear directional guidance at both fine and coarse resolutions, promoting sharper, better-aligned edges and richer texture preservation without changing model architectures or training protocols. Experiments on open-source model and multiple public benchmarks demonstrate effectiveness of our approach.
>
---
#### [new 095] Seeing and Knowing in the Wild: Open-domain Visual Entity Recognition with Large-scale Knowledge Graphs via Contrastive Learning
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究开放域视觉实体识别，旨在将图像中的实体链接到大规模知识图谱（如Wikidata）。针对未见实体识别难、标注少等问题，提出KnowCoL框架，结合图像、文本与知识图谱结构信息，通过对比学习实现零样本识别，在OVEN基准上显著提升对罕见和未见实体的识别精度。**

- **链接: [http://arxiv.org/pdf/2510.13675v1](http://arxiv.org/pdf/2510.13675v1)**
...
>
---
#### [new 096] CADE 2.5 - ZeResFDG: Frequency-Decoupled, Rescaled and Zero-Projected Guidance for SD/SDXL Latent Diffusion Models
- **分类: cs.CV; 68T07, 68U10; I.2.10; I.4.8; I.4.9**

- **简介: 该论文针对SD/SDXL隐扩散模型的采样过程，提出CADE 2.5（含ZeResFDG模块），通过频解耦、能量重标和零投影提升细节、提示遵循与稳定性，结合无训练微纹理稳定器，增强生成质量。**

- **链接: [http://arxiv.org/pdf/2510.12954v1](http://arxiv.org/pdf/2510.12954v1)**

> **作者:** Denis Rychkovskiy; GPT-5
>
...
>
---
#### [new 098] Bee: A High-Quality Corpus and Full-Stack Suite to Unlock Advanced Fully Open MLLMs
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦于提升全开源多模态大语言模型（MLLM）性能，旨在解决现有开源数据集质量低、缺乏复杂推理数据的问题。作者构建了高质量SFT数据集Honey-Data-15M，开发了数据清洗与增强框架HoneyPipe和DataStudio，并训练出8B规模的Bee模型，显著提升了全开源MLLM的性能。**

- **链接: [http://arxiv.org/pdf/2510.13795v1](http://arxiv.org/pdf/2510.13795v1)**
...
>
---
#### [new 101] VLURes: Benchmarking VLM Visual and Linguistic Understanding in Low-Resource Languages
...
>
---
#### [new 102] UrbanFusion: Stochastic Multimodal Fusion for Contrastive Learning of Robust Spatial Representations
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出UrbanFusion，属于地理基础模型任务，旨在解决多模态地理数据融合与空间表征鲁棒性问题。作者设计了支持任意模态组合的Stochastic Multimodal Fusion框架，通过模态编码器与Transformer融合模块，在41项任务中实现跨城市良好泛化。**

- **链接: [http://arxiv.org/pdf/2510.13774v1](http://arxiv.org/pdf/2510.13774v1)**

> **作者:** Dominik J. Mühlematter; Lin Che; Ye Hong; Martin Raubal; Nina Wiedemann
>
> **摘要:** Forecasting urban phenomena such as housing prices and public health indicators requires the effective integration of various geospatial data. Current methods primarily utilize task-specific models, while recent foundation models for spatial representations often support only limited modalities and lack multimodal fusion capabilities. To overcome these challenges, we present UrbanFusion, a Geo-Foundation Model (GeoFM) that features Stochastic Multimodal Fusion (SMF). The framework employs modality-specific encoders to process different types of inputs, including street view imagery, remote sensing data, cartographic maps, and points of interest (POIs) data. These multimodal inputs are integrated via a Transformer-based fusion module that learns unified representations. An extensive evaluation across 41 tasks in 56 cities worldwide demonstrates UrbanFusion's strong generalization and predictive performance compared to state-of-the-art GeoAI models. Specifically, it 1) outperforms prior foundation models on location-encoding, 2) allows multimodal input during inference, and 3) generalizes well to regions unseen during training. UrbanFusion can flexibly utilize any subset of available modalities for a given location during both pretraining and inference, enabling broad applicability across diverse data availability scenarios. All source code is available at https://github.com/DominikM198/UrbanFusion.
>
---
#### [new 103] UNCAP: Uncertainty-Guided Planning Using Natural Language Communication for Cooperative Autonomous Vehicles
...
>
---
#### [new 104] The Mechanistic Emergence of Symbol Grounding in Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 105] Learning to Grasp Anything by Playing with Random Toys
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 109] Steerable Conditional Diffusion for Domain Adaptation in PET Image Reconstruction
- **分类: physics.med-ph; cs.CV; cs.LG**

- **简介: 该论文研究PET图像重建中的域偏移问题，提出将可调控条件扩散（SCD）与PET-LiSch框架结合，利用低秩适配（LoRA）在重建过程中动态调整扩散模型先验，以适应目标域，有效抑制跨域伪影，提升重建质量。**

- **链接: [http://arxiv.org/pdf/2510.13441v1](http://arxiv.org/pdf/2510.13441v1)**
...
>
---
#### [new 111] InternVLA-M1: A Spatially Guided Vision-Language-Action Framework for Generalist Robot Policy
...
#### [replaced 001] Ultralytics YOLO Evolution: An Overview of YOLO26, YOLO11, YOLOv8 and YOLOv5 Object Detectors for Computer Vision and Pattern Recognition
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.09653v2](http://arxiv.org/pdf/2510.09653v2)**
...
>
---
#### [replaced 003] MEGC2025: Micro-Expression Grand Challenge on Spot Then Recognize and Visual Question Answering
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2506.15298v2](http://arxiv.org/pdf/2506.15298v2)**
...
>
---
#### [replaced 006] Position: The Artificial Intelligence and Machine Learning Community Should Adopt a More Transparent and Regulated Peer Review Process
- **分类: cs.DL; cs.AI; cs.CV; cs.CY**

- **链接: [http://arxiv.org/pdf/2502.00874v3](http://arxiv.org/pdf/2502.00874v3)**
...
>
---
#### [replaced 007] SynDiff-AD: Improving Semantic Segmentation and End-to-End Autonomous Driving with Synthetic Data from Latent Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.16776v2](http://arxiv.org/pdf/2411.16776v2)**
...
>
---
#### [replaced 008] Diffusion-Classifier Synergy: Reward-Aligned Learning via Mutual Boosting Loop for FSCIL
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.03608v2](http://arxiv.org/pdf/2510.03608v2)**
...
>
---
#### [replaced 013] SAIL-Embedding Technical Report: Omni-modal Embedding Foundation Model
- **分类: cs.IR; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.12709v2](http://arxiv.org/pdf/2510.12709v2)**
...
>
---
#### [replaced 014] Software System for Low-Cost, GUI-Based Microscopy Segmentation: Algorithmic Implementation
- **分类: q-bio.QM; cs.CV; eess.IV; q-bio.CB**

- **链接: [http://arxiv.org/pdf/2509.11354v3](http://arxiv.org/pdf/2509.11354v3)**
...
>
---
#### [replaced 018] MIRROR: Multimodal Cognitive Reframing Therapy for Rolling with Resistance
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.13211v3](http://arxiv.org/pdf/2504.13211v3)**
...
>
---
#### [replaced 019] SemVink: Advancing VLMs' Semantic Understanding of Optical Illusions via Visual Global Thinking
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 020] Survival Modeling from Whole Slide Images via Patch-Level Graph Clustering and Mixture Density Experts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.16476v3](http://arxiv.org/pdf/2507.16476v3)**
...
>
---
#### [replaced 023] $Δ\mathrm{Energy}$: Optimizing Energy Change During Vision-Language Alignment Improves both OOD Detection and OOD Generalization
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.11296v2](http://arxiv.org/pdf/2510.11296v2)**
...
>
---
#### [replaced 024] TempFlow-GRPO: When Timing Matters for GRPO in Flow Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.04324v4](http://arxiv.org/pdf/2508.04324v4)**
...
>
---
#### [replaced 025] Uncolorable Examples: Preventing Unauthorized AI Colorization via Perception-Aware Chroma-Restrictive Perturbation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.08979v2](http://arxiv.org/pdf/2510.08979v2)**

> **作者:** Yuki Nii; Futa Waseda; Ching-Chun Chang; Isao Echizen
>
> **备注:** APSIPA ASC 2025 Accepted
>
...
>
---
#### [replaced 026] Unconditional CNN denoisers contain sparse semantic representation of images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.01912v2](http://arxiv.org/pdf/2506.01912v2)**
...
>
---
#### [replaced 027] SafeGuider: Robust and Practical Content Safety Control for Text-to-Image Models
- **分类: cs.CR; cs.AI; cs.CV; I.2**

- **链接: [http://arxiv.org/pdf/2510.05173v3](http://arxiv.org/pdf/2510.05173v3)**

> **作者:** Peigui Qi; Kunsheng Tang; Wenbo Zhou; Weiming Zhang; Nenghai Yu; Tianwei Zhang; Qing Guo; Jie Zhang
>
> **备注:** Accepted by ACM CCS 2025, Code is available at [this https URL](https://github.com/pgqihere/safeguider)
>
...
>
---
#### [replaced 028] Backdoor Mitigation via Invertible Pruning Masks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.15497v2](http://arxiv.org/pdf/2509.15497v2)**
...
>
---
#### [replaced 029] EReLiFM: Evidential Reliability-Aware Residual Flow Meta-Learning for Open-Set Domain Generalization under Noisy Labels
...
>
---
#### [replaced 030] TMT: Cross-domain Semantic Segmentation with Region-adaptive Transferability Estimation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.05774v3](http://arxiv.org/pdf/2504.05774v3)**

> **作者:** Enming Zhang; Zhengyu Li; Yanru Wu; Jingge Wang; Yang Tan; Guan Wang; Yang Li; Xiaoping Zhang
>
...
>
---
#### [replaced 034] GLSim: Detecting Object Hallucinations in LVLMs via Global-Local Similarity
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 037] VR-Thinker: Boosting Video Reward Models through Thinking-with-Image Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.10518v3](http://arxiv.org/pdf/2510.10518v3)**
...
>
---
#### [replaced 040] FlashAdventure: A Benchmark for GUI Agents Solving Full Story Arcs in Diverse Adventure Games
...
>
---
#### [replaced 041] IterMask3D: Unsupervised Anomaly Detection and Segmentation with Test-Time Iterative Mask Refinement in 3D Brain MR
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.04911v2](http://arxiv.org/pdf/2504.04911v2)**
...
>
---
#### [replaced 043] RealEngine: Simulating Autonomous Driving in Realistic Context
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 044] FMANet: A Novel Dual-Phase Optical Flow Approach with Fusion Motion Attention Network for Robust Micro-expression Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.07810v3](http://arxiv.org/pdf/2510.07810v3)**
...
>
---
#### [replaced 045] SSL4Eco: A Global Seasonal Dataset for Geospatial Foundation Models in Ecology
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.18256v2](http://arxiv.org/pdf/2504.18256v2)**
...
>
---
#### [replaced 046] QuaDreamer: Controllable Panoramic Video Generation for Quadruped Robots
...
>
---
#### [replaced 047] PRISM: Self-Pruning Intrinsic Selection Method for Training-Free Multimodal Data Selection
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 048] Multimodal Fusion and Vision-Language Models: A Survey for Robot Vision
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 049] Fact-R1: Towards Explainable Video Misinformation Detection with Deep Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.16836v3](http://arxiv.org/pdf/2505.16836v3)**

> **作者:** Fanrui Zhang; Dian Li; Qiang Zhang; Jun Chen; Gang Liu; Junxiong Lin; Jiahong Yan; Jiawei Liu; Zheng-Jun Zha
>
...
>
---
#### [replaced 054] On Robustness of Vision-Language-Action Model against Multi-Modal Perturbations
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.00037v2](http://arxiv.org/pdf/2510.00037v2)**
...
>
---
#### [replaced 055] Spatio-Temporal LLM: Reasoning about Environments and Actions
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.05258v2](http://arxiv.org/pdf/2507.05258v2)**
...
>
---
#### [replaced 057] Backpropagation-Free Test-Time Adaptation via Probabilistic Gaussian Alignment
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.15568v3](http://arxiv.org/pdf/2508.15568v3)**
...
>
---
#### [replaced 062] MedDINOv3: How to adapt vision foundation models for medical image segmentation?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.02379v3](http://arxiv.org/pdf/2509.02379v3)**
...
>
---
#### [replaced 063] Systematic Literature Review on Vehicular Collaborative Perception - A Computer Vision Perspective
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.04631v2](http://arxiv.org/pdf/2504.04631v2)**
...
>
---
#### [replaced 064] ESG-Net: Event-Aware Semantic Guided Network for Dense Audio-Visual Event Localization
- **分类: cs.MM; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09945v2](http://arxiv.org/pdf/2507.09945v2)**
...
>
---
#### [replaced 065] Perspective-Aware Teaching: Adapting Knowledge for Heterogeneous Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.08885v2](http://arxiv.org/pdf/2501.08885v2)**
...
>
---
#### [replaced 066] Brought a Gun to a Knife Fight: Modern VFM Baselines Outgun Specialized Detectors on In-the-Wild AI Image Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.12995v3](http://arxiv.org/pdf/2509.12995v3)**
...
>
---
#### [replaced 067] ChA-MAEViT: Unifying Channel-Aware Masked Autoencoders and Multi-Channel Vision Transformers for Improved Cross-Channel Learning
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.19331v2](http://arxiv.org/pdf/2503.19331v2)**
...
>
> **备注:** SIGGRAPH Asia 2025 (ACM Transactions on Graphics (TOG)). Project page: https://shawn615.github.io/genhmc/
>
...
>
---
#### [replaced 074] MERIT: Multilingual Semantic Retrieval with Interleaved Multi-Condition Query
...
>
---
#### [replaced 075] Data-Efficient Fine-Tuning of Vision-Language Models for Diagnosis of Alzheimer's Disease
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.07613v3](http://arxiv.org/pdf/2509.07613v3)**
...
>
---
#### [replaced 076] MetaCaptioner: Towards Generalist Visual Captioning with Open-source Suites
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.12126v2](http://arxiv.org/pdf/2510.12126v2)**
