...
- **链接: [http://arxiv.org/pdf/2507.12157v1](http://arxiv.org/pdf/2507.12157v1)**
...
- **简介: 该论文属于个性化文本生成图像任务，解决身份一致性问题。提出ID-EA框架，通过文本与视觉嵌入对齐提升身份保留效果。**
...
- **链接: [http://arxiv.org/pdf/2507.11642v1](http://arxiv.org/pdf/2507.11642v1)**
...
- **简介: 该论文属于3D资产生成任务，旨在解决现有模型忽视物理属性的问题。通过构建物理标注数据集和提出物理感知生成框架，提升3D资产的物理合理性与应用价值。**
...
- **简介: 该论文属于自主车辆避障任务，旨在提升车辆在复杂环境中的安全导航能力。通过融合视觉感知与路径规划，实现高效避障。**
...
- **简介: 该论文属于图像生成任务，旨在提升扩散模型的生成质量和多样性。通过引入离散潜在代码（DLC），实现更高质量和多样化的图像生成。**
...
- **简介: 该论文属于生成模型任务，解决扩散模型采样中的幻觉问题。通过优化视角引入RODS方法，检测并减少幻觉，提升采样质量和鲁棒性。**
...
- **链接: [http://arxiv.org/pdf/2507.12455v1](http://arxiv.org/pdf/2507.12455v1)**
...
- **简介: 该论文属于 underwater image restoration 任务，解决复杂光照导致的图像退化问题。提出 xOp-GAN 模型，通过多个专家生成器提升恢复效果。**
...
- **简介: 该论文属于文化遗址修复任务，旨在通过计算机视觉技术恢复古建筑瓷砖。提出三种方法提升修复精度与效率。**
...
- **简介: 该论文属于室内场景问答任务，旨在生成高质量的3D语言数据集。通过整合多模态和语言模型，3D-MoRe提升了复杂环境下的推理能力，并在多个基准上取得了显著效果。**
...
- **简介: 该论文属于视频时刻检索与亮点检测任务，解决视频中时空信息融合不足的问题。提出MS-DETR框架，通过联合运动与语义学习提升模型性能。**
...
- **简介: 该论文属于语义分割任务，解决高频率信息在下采样中易失真的问题。提出SFM模块，通过调制与解调保留细节，提升分割精度。**
...
- **简介: 该论文属于开放集小样本图像分类任务，旨在提升模型在未知环境下的泛化能力。通过引入上下文信息和原型对齐，增强特征空间多样性，提高分类准确性。**
...
- **简介: 该论文属于农业图像识别任务，旨在提升轻量级模型的杂草检测精度。通过知识蒸馏方法改进模型，在不增加复杂度的情况下提高检测效果。**
...
- **简介: 该论文属于动作分类任务，旨在解决传统姿态估计方法计算成本高、效率低的问题。通过深度估计和运动员区域提取，提高分类效率与准确性。**
...
- **简介: 该论文属于脑肿瘤分类任务，旨在提高MRI图像诊断的准确性。通过融合深度学习特征和优化机器学习分类器，提升分类效果。**
...
- **简介: 该论文属于医学图像分割任务，旨在解决多发性硬化症皮质病灶自动检测难题。通过构建多中心数据集并优化分割模型，提升临床应用可行性。**
...
- **简介: 该论文属于目标重识别任务，旨在解决野外流浪猫的个体识别问题。通过改进PPGNet模型并引入对比学习方法，提升了识别准确率。**
...
- **链接: [http://arxiv.org/pdf/2507.11994v1](http://arxiv.org/pdf/2507.11994v1)**
...
- **简介: 该论文属于低光立体图像增强任务，旨在解决光照不均导致的特征纠缠问题。通过小波变换分解特征空间，并引入跨视图交互模块提升细节恢复效果。**
...
- **简介: 该论文属于语义分割任务，旨在提升模型在未见领域的泛化能力。针对原型对齐不足、过拟合和样本权重一致等问题，提出PPAR框架，通过渐进对齐和重加权机制增强泛化效果。**
...
- **简介: 该论文属于医学图像分析任务，旨在解析放射科医生在胸片诊断中的注视意图。通过深度学习模型RadGazeIntent，捕捉其搜索行为中的诊断目标，提升对医生意图的理解。**
...
- **简介: 该论文属于医学图像解释任务，旨在解决医疗模型缺乏可解释性的问题。通过构建CytoSAE模型，实现对血液细胞的可解释嵌入和异常检测。**
...
- **简介: 该论文属于时空预测任务，旨在解决视觉基础模型在处理时空数据时的时序建模不足和模态差异问题。通过引入双分支架构和重新编程阶段，提升模型性能。**
...
>
---
#### [new 060] MoViAD: Modular Visual Anomaly Detection
- **分类: cs.CV**
...
- **简介: 该论文属于多污染物预测任务，旨在解决单污染物预测忽略交互关系的问题。提出MVAR模型，提升多污染物长期预测效果。**
...
>
---
#### [new 066] Beyond Task-Specific Reasoning: A Unified Conditional Generative Framework for Abstract Visual Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于抽象视觉推理任务，旨在解决多任务下模型泛化能力不足的问题。提出统一条件生成框架UCGS，实现跨任务的抽象推理与零样本学习。**

- **链接: [http://arxiv.org/pdf/2507.11761v1](http://arxiv.org/pdf/2507.11761v1)**
...
>
---
#### [new 069] Hyperphantasia: A Benchmark for Evaluating the Mental Visualization Capabilities of Multimodal LLMs
- **分类: cs.CV**

- **简介: 该论文属于多模态大模型评估任务，旨在解决MLLMs在心理可视化能力上的不足。通过构建基准测试，评估模型在复杂视觉问题中的模拟与推理能力。**

- **链接: [http://arxiv.org/pdf/2507.11932v1](http://arxiv.org/pdf/2507.11932v1)**
...
>
---
#### [new 070] DeepShade: Enable Shade Simulation by Text-conditioned Image Generation
...
>
---
#### [new 071] InterpIoU: Rethinking Bounding Box Regression with Interpolation-Based IoU Optimization
- **分类: cs.CV**

- **简介: 该论文属于目标检测任务，解决Bounding Box Regression（BBR）中的定位问题。针对现有IoU损失的不足，提出InterpIoU，通过插值框优化梯度，提升小目标检测效果。**

- **链接: [http://arxiv.org/pdf/2507.12420v1](http://arxiv.org/pdf/2507.12420v1)**
...
>
---
#### [new 072] Learning Pixel-adaptive Multi-layer Perceptrons for Real-time Image Enhancement
- **分类: cs.CV**

- **简介: 该论文属于图像增强任务，解决传统方法难以建模复杂颜色关系的问题，提出BPAM框架，结合双边网格与MLP，实现像素自适应的非线性映射。**

- **链接: [http://arxiv.org/pdf/2507.12135v1](http://arxiv.org/pdf/2507.12135v1)**
...
>
---
#### [new 073] Comparative Analysis of CNN Performance in Keras, PyTorch and JAX on PathMNIST
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分类任务，比较Keras、PyTorch和JAX在PathMNIST上的CNN性能，分析训练效率、准确率和推理速度。**

- **链接: [http://arxiv.org/pdf/2507.12248v1](http://arxiv.org/pdf/2507.12248v1)**
...
>
---
#### [new 074] Describe Anything Model for Visual Question Answering on Text-rich Images
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视觉问答任务，解决文本密集图像中的问答问题。提出DAM-QA框架，利用区域感知能力提升文本信息提取与推理效果。**

- **链接: [http://arxiv.org/pdf/2507.12441v1](http://arxiv.org/pdf/2507.12441v1)**
...
>
---
#### [new 091] EgoVLA: Learning Vision-Language-Action Models from Egocentric Human Videos
...
>
---
#### [new 092] PRISM: Distributed Inference for Foundation Models at Edge
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于边缘计算任务，解决基础模型在边缘设备上的部署问题。提出PRISM方法，通过优化通信和计算减少资源消耗。**

- **链接: [http://arxiv.org/pdf/2507.12145v1](http://arxiv.org/pdf/2507.12145v1)**
...
>
---
#### [new 093] Unit-Based Histopathology Tissue Segmentation via Multi-Level Feature Representation
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于病理图像分割任务，旨在减少标注工作量并提高计算效率。通过将32*32图像块作为分割单元，并使用多级视觉Transformer进行特征提取，实现更准确的组织分类。**

- **链接: [http://arxiv.org/pdf/2507.12427v1](http://arxiv.org/pdf/2507.12427v1)**
...
>
---
#### [new 094] IDFace: Face Template Protection for Efficient and Secure Identification
- **分类: cs.CR; cs.CV; I.5.4; K.6.5; D.4.6; I.4.7**

- **简介: 该论文属于生物特征识别任务，解决面部模板保护问题。提出IDFace方法，利用同态加密实现高效安全的面部识别。**

- **链接: [http://arxiv.org/pdf/2507.12050v1](http://arxiv.org/pdf/2507.12050v1)**
...
>
---
#### [new 095] A Spatial-Physics Informed Model for 3D Spiral Sample Scanned by SQUID Microscopy
- **分类: physics.ins-det; cs.CV**

- **简介: 该论文属于非破坏性检测任务，解决3D螺旋样品磁成像中的误差问题。通过引入空间物理模型，提升图像清晰度并校正偏差。**

- **链接: [http://arxiv.org/pdf/2507.11853v1](http://arxiv.org/pdf/2507.11853v1)**
...
>
---
#### [new 096] FactorHD: A Hyperdimensional Computing Model for Multi-Object Multi-Class Representation and Factorization
- **分类: cs.SC; cs.AI; cs.CV**

- **简介: 该论文属于神经符号AI任务，解决类-子类关系表示与因子分解问题。提出FactorHD模型，提升多对象的高效准确表示与分解能力。**

- **链接: [http://arxiv.org/pdf/2507.12366v1](http://arxiv.org/pdf/2507.12366v1)**
...
>
---
#### [new 097] Image-Based Multi-Survey Classification of Light Curves with a Pre-Trained Vision Transformer
- **分类: astro-ph.IM; cs.CV**

- **简介: 该论文属于天体分类任务，解决多巡天光变曲线分类问题。使用预训练视觉Transformer模型，融合ZTF和ATLAS数据，提升分类性能。**

- **链接: [http://arxiv.org/pdf/2507.11711v1](http://arxiv.org/pdf/2507.11711v1)**
...
>
---
#### [new 099] MOSPA: Human Motion Generation Driven by Spatial Audio
...
>
---
#### [new 100] PROL : Rehearsal Free Continual Learning in Streaming Data via Prompt Online Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于在线持续学习任务，解决数据隐私下灾难性遗忘问题。提出一种无需重放的提示学习方法，包含四个组件，提升模型性能并降低参数和计算开销。**

- **链接: [http://arxiv.org/pdf/2507.12305v1](http://arxiv.org/pdf/2507.12305v1)**
...
>
---
#### [new 101] Landmark Detection for Medical Images using a General-purpose Segmentation Model
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决骨骼 landmarks 精确分割问题。通过结合 YOLO 和 SAM 模型，提升对骨盆放射图像中复杂结构的分割精度。**

- **链接: [http://arxiv.org/pdf/2507.11551v1](http://arxiv.org/pdf/2507.11551v1)**
...
>
---
#### [new 102] RegCL: Continual Adaptation of Segment Anything Model via Model Merging
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于持续学习任务，解决SAM在不同领域适应时的灾难性遗忘问题。通过模型合并实现多领域知识整合，保持参数效率。**

- **链接: [http://arxiv.org/pdf/2507.12297v1](http://arxiv.org/pdf/2507.12297v1)**
...
>
---
#### [new 103] MapIQ: Benchmarking Multimodal Large Language Models for Map Question Answering
...
>
---
#### [new 106] The Impact of Coreset Selection on Spurious Correlations and Group Robustness
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于数据高效机器学习任务，研究数据选择方法对虚假相关性和模型鲁棒性的影响，分析不同采样策略在降低偏差和提升模型稳定性方面的效果。**

- **链接: [http://arxiv.org/pdf/2507.11690v1](http://arxiv.org/pdf/2507.11690v1)**
...
>
---
#### [new 107] Spontaneous Spatial Cognition Emerges during Egocentric Video Viewing through Non-invasive BCI
...
>
---
#### [new 108] A Survey of Deep Learning for Geometry Problem Solving
- **分类: cs.CL; cs.AI; cs.CV; cs.LG**
...
>
---
#### [new 109] Effective Fine-Tuning of Vision Transformers with Low-Rank Adaptation for Privacy-Preserving Image Classification
- **分类: cs.CR; cs.AI; cs.CV**

- **简介: 该论文属于图像分类任务，旨在解决隐私保护下的模型微调问题。通过引入低秩适配矩阵，在保持高精度的同时减少可训练参数。**

- **链接: [http://arxiv.org/pdf/2507.11943v1](http://arxiv.org/pdf/2507.11943v1)**
...
>
---
#### [new 112] DoRF: Doppler Radiance Fields for Robust Human Activity Recognition Using Wi-Fi
- **分类: eess.SP; cs.CV**
...
>
---
#### [new 113] Stereo Sound Event Localization and Detection with Onscreen/offscreen Classification
...
>
---
#### [new 114] A Multi-Level Similarity Approach for Single-View Object Grasping: Matching, Planning, and Fine-Tuning
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 115] Towards Autonomous Riding: A Review of Perception, Planning, and Control in Intelligent Two-Wheelers
...
#### [replaced 001] Boost 3D Reconstruction using Diffusion-based Monocular Camera Calibration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.17240v2](http://arxiv.org/pdf/2411.17240v2)**
...
>
---
#### [replaced 002] Incremental Joint Learning of Depth, Pose and Implicit Scene Representation on Monocular Camera in Large-scale Scenes
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 003] MapEx: Indoor Structure Exploration with Probabilistic Information Gain from Global Map Predictions
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 009] CultureCLIP: Empowering CLIP with Cultural Awareness through Synthetic Images and Contextualized Captions
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 010] Vamba: Understanding Hour-Long Videos with Hybrid Mamba-Transformers
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.11579v2](http://arxiv.org/pdf/2503.11579v2)**
...
>
> **摘要:** Large-scale cell microscopy screens are used in drug discovery and molecular biology research to study the effects of millions of chemical and genetic perturbations on cells. To use these images in downstream analysis, we need models that can map each image into a feature space that represents diverse biological phenotypes consistently, in the sense that perturbations with similar biological effects have similar representations. In this work, we present the largest foundation model for cell microscopy data to date, a new 1.9 billion-parameter ViT-G/8 MAE trained on over 8 billion microscopy image crops. Compared to a previous published ViT-L/8 MAE, our new model achieves a 60% improvement in linear separability of genetic perturbations and obtains the best overall performance on whole-genome biological relationship recall and replicate consistency benchmarks. Beyond scaling, we developed two key methods that improve performance: (1) training on a curated and diverse dataset; and, (2) using biologically motivated linear probing tasks to search across each transformer block for the best candidate representation of whole-genome screens. We find that many self-supervised vision transformers, pretrained on either natural or microscopy images, yield significantly more biologically meaningful representations of microscopy images in their intermediate blocks than in their typically used final blocks. More broadly, our approach and results provide insights toward a general strategy for successfully building foundation models for large-scale biological data.
>
---
#### [replaced 013] SPA: Efficient User-Preference Alignment against Uncertainty in Medical Image Segmentation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2411.15513v2](http://arxiv.org/pdf/2411.15513v2)**

> **作者:** Jiayuan Zhu; Junde Wu; Cheng Ouyang; Konstantinos Kamnitsas; J. Alison Noble
>
...
>
---
#### [replaced 014] A computationally frugal open-source foundation model for thoracic disease detection in lung cancer screening programs
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.01881v2](http://arxiv.org/pdf/2507.01881v2)**
...
>
---
#### [replaced 019] StreakNet-Arch: An Anti-scattering Network-based Architecture for Underwater Carrier LiDAR-Radar Imaging
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2404.09158v4](http://arxiv.org/pdf/2404.09158v4)**
...
>
---
#### [replaced 020] Rethinking Data Protection in the (Generative) Artificial Intelligence Era
...
>
---
#### [replaced 026] Alleviating Textual Reliance in Medical Language-guided Segmentation via Prototype-driven Semantic Approximation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.11055v2](http://arxiv.org/pdf/2507.11055v2)**
...
>
---
#### [replaced 027] Robust Low-light Scene Restoration via Illumination Transition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.03976v2](http://arxiv.org/pdf/2507.03976v2)**

> **作者:** Ze Li; Feng Zhang; Xiatian Zhu; Meng Zhang; Yanghong Zhou; P. Y. Mok
>
> **备注:** 10 pages, 5 figures, Accepted to ICCV 2025
>
...
>
---
#### [replaced 028] FLUXSynID: A Framework for Identity-Controlled Synthetic Face Generation with Document and Live Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.07530v3](http://arxiv.org/pdf/2505.07530v3)**
...
>
---
#### [replaced 029] CFFormer: Cross CNN-Transformer Channel Attention and Spatial Feature Fusion for Improved Segmentation of Heterogeneous Medical Images
- **分类: cs.CV; I.2; I.4; I.5**

- **链接: [http://arxiv.org/pdf/2501.03629v2](http://arxiv.org/pdf/2501.03629v2)**
...
>
---
#### [replaced 033] 4D-MISR: A unified model for low-dose super-resolution imaging via feature fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09953v2](http://arxiv.org/pdf/2507.09953v2)**

> **作者:** Zifei Wang; Zian Mao; Xiaoya He; Xi Huang; Haoran Zhang; Chun Cheng; Shufen Chu; Tingzheng Hou; Xiaoqin Zeng; Yujun Xie
>
> **备注:** The authors have decided to withdraw this submission due to incorrect affiliation information and certain logical inconsistencies in the manuscript that require revision
>
...
>
---
#### [replaced 036] OpenLKA: An Open Dataset of Lane Keeping Assist from Recent Car Models under Real-world Driving Conditions
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 039] Neurons: Emulating the Human Visual Cortex Improves Fidelity and Interpretability in fMRI-to-Video Reconstruction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.11167v3](http://arxiv.org/pdf/2503.11167v3)**

> **作者:** Haonan Wang; Qixiang Zhang; Lehan Wang; Xuanqi Huang; Xiaomeng Li
>
> **备注:** Accepted by ICCV 2025, camera ready version
>
...
>
---
#### [replaced 040] Distilling Invariant Representations with Dual Augmentation
- **分类: cs.CV; cs.AI; cs.LG; 68T07; I.4; I.2**

- **链接: [http://arxiv.org/pdf/2410.09474v4](http://arxiv.org/pdf/2410.09474v4)**

> **作者:** Nikolaos Giakoumoglou; Tania Stathaki
>
> **备注:** After further review, we determined that the submission does not meet the quality standards we intended
>
...
>
---
#### [replaced 041] Benchmarking Deep Learning and Vision Foundation Models for Atypical vs. Normal Mitosis Classification with Cross-Dataset Evaluation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21444v2](http://arxiv.org/pdf/2506.21444v2)**
...
>
---
#### [replaced 042] Flow-GRPO: Training Flow Matching Models via Online RL
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.05470v4](http://arxiv.org/pdf/2505.05470v4)**
...
>
---
#### [replaced 043] Multimodal Fusion and Vision-Language Models: A Survey for Robot Vision
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 044] VAPO: Visibility-Aware Keypoint Localization for Efficient 6DoF Object Pose Estimation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.14559v4](http://arxiv.org/pdf/2403.14559v4)**
...
>
---
#### [replaced 045] TRAN-D: 2D Gaussian Splatting-based Sparse-view Transparent Object Depth Reconstruction via Physics Simulation for Scene Update
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 054] ICME 2025 Generalizable HDR and SDR Video Quality Measurement Grand Challenge
- **分类: eess.IV; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2506.22790v2](http://arxiv.org/pdf/2506.22790v2)**
...
>
---
#### [replaced 055] GIE-Bench: Towards Grounded Evaluation for Text-Guided Image Editing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.11493v2](http://arxiv.org/pdf/2505.11493v2)**
...
>
---
#### [replaced 064] PATCH: a deep learning method to assess heterogeneity of artistic practice in historical paintings
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.01912v3](http://arxiv.org/pdf/2502.01912v3)**
...
>
---
#### [replaced 067] Dual Dimensions Geometric Representation Learning Based Document Dewarping
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.08492v2](http://arxiv.org/pdf/2507.08492v2)**
...
>
---
#### [replaced 068] SpikeDet: Better Firing Patterns for Accurate and Energy-Efficient Object Detection with Spiking Neuron Networks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.15151v3](http://arxiv.org/pdf/2501.15151v3)**
...
>
---
#### [replaced 069] DRISHTIKON: Visual Grounding at Multiple Granularities in Documents
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21316v2](http://arxiv.org/pdf/2506.21316v2)**
