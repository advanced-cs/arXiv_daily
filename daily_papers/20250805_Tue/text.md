...
>
---
#### [new 003] WarriorMath: Enhancing the Mathematical Ability of Large Language Models with a Defect-aware Framework
- **分类: cs.CL**
...
- **链接: [http://arxiv.org/pdf/2508.02074v1](http://arxiv.org/pdf/2508.02074v1)**
...
- **链接: [http://arxiv.org/pdf/2508.01930v1](http://arxiv.org/pdf/2508.01930v1)**
...
- **简介: 该论文旨在解决LLM生成的对话中事实性评估问题，通过引入3D分解框架（Decompose, Decouple, Detach）改进事实标签构建，并开发FECT基准数据集，解决企业应用场景下的主观判断与客观事实脱节问题。**
...
- **简介: 该论文提出了一种大规模多样化问答数据合成方法，旨在解决传统训练数据稀缺及跨域知识多样性不足的问题。通过构建BoostQA（100Btoken）数据集，在模型中进行中训练阶段优化，提升了LLM在STEM领域和高难度数据上的表现，实现了12.74%的性能提升。**
...
- **简介: 该论文旨在解决大型语言模型（LLMs）中提示优化难题，提出MOPrompt框架以双目标优化准确性与上下文规模，通过多目标进化实现帕累托前沿，验证其在葡萄牙语情感分析中的有效性。**
...
- **简介: 该论文旨在设计一个任务，通过大语言模型检测Dementia家庭成员的tweets（二分类任务），解决识别特定语境下与家庭成员相关的 dementia tweets 的问题，并探索多种提示方法优化性能，最终实现高精度检测。**
...
- **简介: 该论文旨在研究LLM幻觉问题，解决其生成虚假事实或不实内容的挑战，通过分类不同类型的幻觉（如事实错误、逻辑矛盾等）并分析其成因，提出检测、缓解和监控策略，为负责任部署LLM提供理论支持。**
...
- **简介: 该论文旨在开发基于大型语言模型（LLMs）的创新测量框架，解决传统专家评估受限问题，通过实验验证其性能与可靠性，并探讨设计决策对成果的影响。**
...
- **简介: 该论文研究了AI生成文本的非平稳性问题，提出Temporal Discrepancy Tomography（TDT）方法，通过时序信号处理检测统计异常，并在RAID基准上实现了0.855 AUROC提升，解决了传统方法忽略位置信息导致的检测局限性。**
...
- **简介: 该论文旨在解决注意力攻击对偏好建模的影响，提出"交互蒸馏"框架通过注意力优化实现更稳定的奖励信号生成，有效弥补传统单向因果注意力和独立编码结构的不足。**
...
- **简介: 该论文旨在解决传统语言模型微调任务中资源浪费和效率低下的问题，提出XAutoLM框架通过元学习和自动机器学习优化微调流程，有效提升了任务性能和效率。**
...
- **简介: 该论文旨在解决临床文本中标准化医学概念自动标注的问题，通过Bi-GRU模型实现SNOMED CT概念识别，利用MIMIC-IV数据集优化文本预处理与语义分割，达到90%F1分数，比传统规则系统和现有神经网络模型性能优越。**
...
- **链接: [http://arxiv.org/pdf/2508.01213v1](http://arxiv.org/pdf/2508.01213v1)**
...
- **简介: 该论文为SemEval-2025 Task 11，旨在解决多语言下情感识别的挑战，通过调整多语言LLM实现任务适配，证明需分别对每种语言进行微调以提升性能。**
...
- **链接: [http://arxiv.org/pdf/2508.02322v1](http://arxiv.org/pdf/2508.02322v1)**
...
- **简介: 该论文提出了一种基于离散状态扩散的大型语言模型Seed Diffusion Preview，旨在解决代码推理速度不足的问题。通过非序列化并行生成技术，显著提升了推理速度至2,146 token/s（H20 GPU），优于当前主流模型，建立了速度-质量帕累托前沿。**
...
- **简介: 该论文旨在构建能解答大学政策问题并提供逻辑解释的教育问答系统，通过XAI挑战解决AI在教育中的透明性问题，使用轻量级LLMs或混合模型，并基于逻辑模板和Z3验证优化数据集，推动符号推理与LLM的融合研究。**
...
>
---
#### [new 046] PoeTone: A Framework for Constrained Generation of Structured Chinese Songci with LLMs
- **分类: cs.CL; cs.LG**
...
- **简介: 该论文提出了一种通过移除路径中包含答案的知识片段，以增强LLM处理未知实体问题的能力的任务，解决了传统RAG方法因知识缺失导致的效率问题，并开发了Unseen Entity KGQA任务以验证其有效性。**
...
- **简介: 该论文旨在构建一个用于Telugu语言的公平性可解释情感分类基准数据集TeSent，解决标注资源不足问题，通过多领域文本预处理、自定义注释协议及实验验证方法，提升模型解释性和公平性。**
...
- **简介: 该论文探讨了大型语言模型如何通过标准化语言和推理模式影响人类认知多样性，分析其设计与大规模应用对文化背景的冲击，并提出缓解机制。**
...
- **链接: [http://arxiv.org/pdf/2508.01739v1](http://arxiv.org/pdf/2508.01739v1)**
...
- **链接: [http://arxiv.org/pdf/2508.02256v1](http://arxiv.org/pdf/2508.02256v1)**
...
>
---
#### [new 065] SpeechRole: A Large-Scale Dataset and Benchmark for Evaluating Speech Role-Playing Agents
- **分类: cs.CL**

- **简介: 该论文构建了SpeechRole-Data（98个角色及112k对话）和SpeechRole-Eval（多维度评估体系），解决语音交互不足问题，提出基于语调/声学的SRPAs评估方法，验证了端到端与链式模型的优劣，为语音驱动的跨模态角色扮演提供数据与基准。**

- **链接: [http://arxiv.org/pdf/2508.02013v1](http://arxiv.org/pdf/2508.02013v1)**
...
>
---
#### [new 068] LinkQA: Synthesizing Diverse QA from Multiple Seeds Strongly Linked by Knowledge Points
- **分类: cs.CL**

- **简介: 该论文提出一种基于知识点的图合成框架，解决训练数据稀缺问题，通过多种子和扩散合成增强多样性和提升性能。**

- **链接: [http://arxiv.org/pdf/2508.01317v1](http://arxiv.org/pdf/2508.01317v1)**
...
>
---
#### [new 069] Proof2Hybrid: Automatic Mathematical Benchmark Synthesis for Proof-Centric Problems
- **分类: cs.CL; cs.AI**

- **简介: 该论文旨在解决大型语言模型数学能力评估中的挑战，提出Proof2Hybrid框架，通过自动合成数学证明导向的基准来提升AI数学理解度，并设计了m-out-of-n多判断问题以增强验证效率。**

- **链接: [http://arxiv.org/pdf/2508.02208v1](http://arxiv.org/pdf/2508.02208v1)**
...
>
---
#### [new 074] Sparse-dLLM: Accelerating Diffusion LLMs with Dynamic Cache Eviction
- **分类: cs.CL**

- **简介: 该论文旨在解决扩散语言模型（dLLMs）因高计算复杂度和内存需求而面临效率瓶颈的问题，通过动态缓存策略与稀疏注意力结合，实现10倍提升吞吐量，优化长上下文应用中的内存效率。**

- **链接: [http://arxiv.org/pdf/2508.02558v1](http://arxiv.org/pdf/2508.02558v1)**
...
>
---
#### [new 078] MedSynth: Realistic, Synthetic Medical Dialogue-Note Pairs
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出MedSynth数据集，解决医疗文档自动化中的知识获取与生成难题，通过合成对话/笔记对提升模型性能，提供开放数据资源。**

- **链接: [http://arxiv.org/pdf/2508.01401v1](http://arxiv.org/pdf/2508.01401v1)**
...
>
> **摘要:** Physicians spend significant time documenting clinical encounters, a burden that contributes to professional burnout. To address this, robust automation tools for medical documentation are crucial. We introduce MedSynth -- a novel dataset of synthetic medical dialogues and notes designed to advance the Dialogue-to-Note (Dial-2-Note) and Note-to-Dialogue (Note-2-Dial) tasks. Informed by an extensive analysis of disease distributions, this dataset includes over 10,000 dialogue-note pairs covering over 2000 ICD-10 codes. We demonstrate that our dataset markedly enhances the performance of models in generating medical notes from dialogues, and dialogues from medical notes. The dataset provides a valuable resource in a field where open-access, privacy-compliant, and diverse training data are scarce. Code is available at https://github.com/ahmadrezarm/MedSynth/tree/main and the dataset is available at https://huggingface.co/datasets/Ahmad0067/MedSynth.
>
---
#### [new 079] Test Set Quality in Multilingual LLM Evaluation
- **分类: cs.CL**

- **简介: 该论文旨在评估多语言LLM性能并解决数据集质量不足问题，通过分析法国和泰语测试集发现误差并对比LLM差异，提出需重新审视测试集的建议。**

- **链接: [http://arxiv.org/pdf/2508.02635v1](http://arxiv.org/pdf/2508.02635v1)**
...
>
> **摘要:** Several multilingual benchmark datasets have been developed in a semi-automatic manner in the recent past to measure progress and understand the state-of-the-art in the multilingual capabilities of Large Language Models. However, there is not a lot of attention paid to the quality of the datasets themselves, despite the existence of previous work in identifying errors in even fully human-annotated test sets. In this paper, we manually analyze recent multilingual evaluation sets in two languages - French and Telugu, identifying several errors in the process. We compare the performance difference across several LLMs with the original and revised versions of the datasets and identify large differences (almost 10% in some cases) in both languages). Based on these results, we argue that test sets should not be considered immutable and should be revisited, checked for correctness, and potentially versioned. We end with some recommendations for both the dataset creators as well as consumers on addressing the dataset quality issues.
>
---
#### [new 080] A French Version of the OLDI Seed Corpus
- **分类: cs.CL**

- **简介: The paper presents a French version of the OLDI Seed Corpus, a shared task submission for WMT 2025. It creates a corpus combining technical terms and user-generated content from Wikipedia, addressing challenges in translating user-submitted text. The work includes using machine translation systems and a custom interface to post-edit by native speakers, aiming to support parallel corpora collection for under-resourced French regions. (98 words)**

- **链接: [http://arxiv.org/pdf/2508.02290v1](http://arxiv.org/pdf/2508.02290v1)**

> **作者:** Malik Marmonier; Benoît Sagot; Rachel Bawden
>
> **摘要:** We present the first French partition of the OLDI Seed Corpus, our submission to the WMT 2025 Open Language Data Initiative (OLDI) shared task. We detail its creation process, which involved using multiple machine translation systems and a custom-built interface for post-editing by qualified native speakers. We also highlight the unique translation challenges presented by the source data, which combines highly technical, encyclopedic terminology with the stylistic irregularities characteristic of user-generated content taken from Wikipedia. This French corpus is not an end in itself, but is intended as a crucial pivot resource to facilitate the collection of parallel corpora for the under-resourced regional languages of France.
>
---
#### [new 081] CUPID: Evaluating Personalized and Contextualized Alignment of LLMs from Interactions
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文旨在评估大型语言模型（LLM）在多轮交互中推断用户动态偏好并生成响应的能力，解决当前模型难以捕捉上下文关联性的问题，通过CUPID基准测试验证了LLM在个性化与上下文感知方面的局限性。**

- **链接: [http://arxiv.org/pdf/2508.01674v1](http://arxiv.org/pdf/2508.01674v1)**
...
>
---
#### [new 082] LatentPrompt: Optimizing Promts in Latent Space
- **分类: cs.CL**

- **简介: 该论文提出了一种模型无关的框架**LatentPrompt**，通过将提示词嵌入潜在语义空间并自动优化，解决了传统方法依赖人工规则导致效率低下的问题。在金融情感分类任务中，显著提升了模型性能。**

- **链接: [http://arxiv.org/pdf/2508.02452v1](http://arxiv.org/pdf/2508.02452v1)**
...
>
---
#### [new 083] CharBench: Evaluating the Role of Tokenization in Character-Level Tasks
- **分类: cs.CL**

- **简介: 该论文旨在评估token化对字符级任务的影响，解决语言模型在字符级推理任务（如计数、定位）中表现不佳的问题。通过构建CharBench基准，对比多种模型，发现token化特性对计数任务影响较小，而词长与字符位置关系更关键，提出改进方向以提升此类任务性能。**

- **链接: [http://arxiv.org/pdf/2508.02591v1](http://arxiv.org/pdf/2508.02591v1)**
...
>
---
#### [new 091] Learning Dynamics of Meta-Learning in Small Model Pretraining
- **分类: cs.CL; cs.AI**

- **简介: 本研究提出了一种结合元学习的小规模语言模型预训练方法，旨在提升其效率与可解释性。**

- **链接: [http://arxiv.org/pdf/2508.02189v1](http://arxiv.org/pdf/2508.02189v1)**
...
>
---
#### [new 092] Learning to Evolve: Bayesian-Guided Continual Knowledge Graph Embedding
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于知识图谱持续学习任务，旨在解决传统KGE模型因" catastrophic forgetting "导致的知识丢失问题，提出基于贝叶斯框架的CKGE模型BAKE，通过持续更新和知识聚类机制有效缓解遗忘。**

- **链接: [http://arxiv.org/pdf/2508.02426v1](http://arxiv.org/pdf/2508.02426v1)**
...
>
---
#### [new 095] Rethinking Graph-Based Document Classification: Learning Data-Driven Structures Beyond Heuristic Approaches
- **分类: cs.CL**

- **简介: 该论文旨在解决传统图模型在文档分类中的序列长度限制和理解不足问题，提出通过自注意力和统计过滤学习数据驱动的图结构，替代传统规则和专家知识，提升分类性能。**

- **链接: [http://arxiv.org/pdf/2508.00864v1](http://arxiv.org/pdf/2508.00864v1)**

> **作者:** Margarita Bugueño; Gerard de Melo
>
> **备注:** 7 pages, 3 figures, 3 tables. Appendix starts on page 10
>
> **摘要:** In document classification, graph-based models effectively capture document structure, overcoming sequence length limitations and enhancing contextual understanding. However, most existing graph document representations rely on heuristics, domain-specific rules, or expert knowledge. Unlike previous approaches, we propose a method to learn data-driven graph structures, eliminating the need for manual design and reducing domain dependence. Our approach constructs homogeneous weighted graphs with sentences as nodes, while edges are learned via a self-attention model that identifies dependencies between sentence pairs. A statistical filtering strategy aims to retain only strongly correlated sentences, improving graph quality while reducing the graph size. Experiments on three document classification datasets demonstrate that learned graphs consistently outperform heuristic-based graphs, achieving higher accuracy and $F_1$ score. Furthermore, our study demonstrates the effectiveness of the statistical filtering in improving classification robustness. These results highlight the potential of automatic graph generation over traditional heuristic approaches and open new directions for broader applications in NLP.
>
---
#### [new 096] D-SCoRE: Document-Centric Segmentation and CoT Reasoning with Structured Export for QA-CoT Data Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出D-SCoRE（文档驱动的分段与推理结合）框架，解决高成本与稀缺QA数据对监督学习的挑战，通过结构化输出和多维度控制机制生成多样化QA-COT数据集，实现高效泛化和跨领域性能优化。**

- **链接: [http://arxiv.org/pdf/2508.01309v1](http://arxiv.org/pdf/2508.01309v1)**

> **作者:** Weibo Zhou; Lingbo Li; Shangsong Liang
>
> **摘要:** The scarcity and high cost of high-quality question-answering (QA) datasets hinder supervised fine-tuning (SFT) for domain-specific large language models (LLMs). To address this, we introduce D-SCoRE, a training-free pipeline that utilizes LLMs and prompt engineering to produce diverse, high-quality QA datasets from arbitrary textual sources. D-SCoRE integrates $\textbf{D}$ocument-centric processing, $\textbf{S}$egmentation, $\textbf{Co}$T $\textbf{R}$easoning, and structured $\textbf{E}$xport to generate QA-COT datasets tailored for domain-aware SFT. Multi-dimensional control mechanisms, such as semantic role transformation, question type balancing, and counterfactual materials, enhance diversity and relevance, overcoming limitations of existing QA generation. LLMs fine-tuned on D-SCoRE-generated QA datasets, and human-annotated QA datasets (SQuAD, Covid-QA) are evaluated on SQuADShifts and Covid-QA test sets, with D-SCoRE outperforming across most domains. D-SCoRE generates six QA-CoT pairs with four-option counterfactual materials per 100-200-word text in 90 seconds using an 8B LLM on consumer-grade hardware. Its simplicity and scalability enable efficient QA generation and high-performance fine-tuning across domains.
>
---
#### [new 097] LaMPE: Length-aware Multi-grained Position Encoding for Adaptive Long-context Scaling Without Training
- **分类: cs.CL**

- **简介: 该论文提出长度感知多粒度位置编码（LaMPE），解决了大型语言模型在长输入下性能退化的问题，通过训练自由方法利用模型有效上下文窗口实现自适应长-context扩展，同时创新性地构建了动态映射关系和多粒度注意力机制，适用于RoPE基LLMs，显著提升了性能。**

- **链接: [http://arxiv.org/pdf/2508.02308v1](http://arxiv.org/pdf/2508.02308v1)**
...
>
---
#### [new 098] AgentTTS: Large Language Model Agent for Test-time Compute-optimal Scaling Strategy in Complex Tasks
- **分类: cs.AI; cs.CL; cs.LG; I.2.7**

- **简介: 该论文研究了多阶段复杂任务中的测试时间计算优化问题，旨在通过LLM代理自主搜索模型与预算分配方案以提升性能。提出了AgentTTS框架，解决了模型与预算的组合搜索空间过大及子任务间依赖性高的挑战，实验验证其在效率和鲁棒性上的优势。**

- **链接: [http://arxiv.org/pdf/2508.00890v1](http://arxiv.org/pdf/2508.00890v1)**
...
>
---
#### [new 099] LiveMCPBench: Can Agents Navigate an Ocean of MCP Tools?
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究了代理如何在大量MCP工具中导航，解决现有单服务器基准无法有效评估大范围代理能力的问题，提出LiveMCPBench等方法，并展示了其优势与挑战。**

- **链接: [http://arxiv.org/pdf/2508.01780v1](http://arxiv.org/pdf/2508.01780v1)**
...
>
> **摘要:** Large Language Models (LLMs) have achieved remarkable success in software engineering tasks when trained with executable runtime environments, particularly in resolving GitHub issues. However, such runtime environments are often unavailable in other domains, especially cybersecurity, where challenge configurations and execution contexts are ephemeral or restricted. We present Cyber-Zero, the first runtime-free framework for synthesizing high-quality agent trajectories to train cybersecurity LLMs. Cyber-Zero leverages publicly available CTF writeups and employs persona-driven LLM simulation to reverse-engineer runtime behaviors and generate realistic, long-horizon interaction sequences without actual environments. Using trajectories synthesized by Cyber-Zero, we train LLM-based agents that achieve up to 13.1% absolute performance gains over baseline models on three prominent CTF benchmarks: InterCode-CTF, NYU CTF Bench, and Cybench. Our best model, Cyber-Zero-32B, establishes new state-of-the-art performance among open-weight models, matching the capabilities of proprietary systems like DeepSeek-V3-0324 and Claude-3.5-Sonnet while offering superior cost-effectiveness, and demonstrating that runtime-free trajectory synthesis can effectively democratize the development of state-of-the-art cybersecurity agents.
>
---
#### [new 101] Language Model Guided Reinforcement Learning in Quantitative Trading
- **分类: cs.LG; cs.CL; q-fin.TR; I.2.7; I.2.6; J.4**

- **简介: 该论文旨在解决量化交易中短时决策与长期目标对齐的问题，通过构建LLM生成策略引导RL，评估其风险与收益表现。研究工作包括设计混合系统并对比不同策略效果。**

- **链接: [http://arxiv.org/pdf/2508.02366v1](http://arxiv.org/pdf/2508.02366v1)**
...
>
---
#### [new 103] Modality Bias in LVLMs: Analyzing and Mitigating Object Hallucination via Attention Lens
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 104] Is Chain-of-Thought Reasoning of LLMs a Mirage? A Data Distribution Lens
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文探讨了链式推理（CoT）在LLM中是否真实反映推理能力，通过数据分布分析其有效性。研究旨在验证CoT是否具有结构化的学习偏见，并探索其在不同数据分布下的泛化特性，提出通过隔离环境训练模型以评估其行为模式。**

- **链接: [http://arxiv.org/pdf/2508.01191v1](http://arxiv.org/pdf/2508.01191v1)**
...
>
---
#### [new 105] Filtering with Self-Attention and Storing with MLP: One-Layer Transformers Can Provably Acquire and Extract Knowledge
- **分类: cs.LG; cs.CL**

- **简介: 该论文旨在解决大型语言模型在知识存储与提取中的理论与实践挑战，提出通过自注意力和MLP结合的框架，证明其可实现知识的有效获取与泛化，同时验证了不同训练策略对知识效果的影响。**

- **链接: [http://arxiv.org/pdf/2508.00901v1](http://arxiv.org/pdf/2508.00901v1)**
...
>
---
#### [new 106] Test-time Prompt Intervention
- **分类: cs.AI; cs.CL**

- **简介: 该论文探讨了在测试时间对大型语言模型推理过程的干预方法，旨在解决其因过度依赖结果奖励导致的冗余问题，通过动态干预和样本选择优化推理路径，增强模型的可控性与解释性。**

- **链接: [http://arxiv.org/pdf/2508.02511v1](http://arxiv.org/pdf/2508.02511v1)**
...
>
---
#### [new 107] CSLRConformer: A Data-Centric Conformer Approach for Continuous Arabic Sign Language Recognition on the Isharah Datase
...
>
---
#### [new 112] CellForge: Agentic Design of Virtual Cell Models
- **分类: cs.LG; cs.AI; cs.CL; q-bio.QM**

- **简介: 该论文介绍了一种名为CellForge的多智能体框架，用于自动生成虚拟细胞模型，解决了传统建模方法面临的生物学复杂性、数据异构性和跨学科需求等问题。其核心能力包括任务分析、方法设计和实验执行，通过协作优化模型架构并提供可执行代码，显著提升了单细胞数据驱动的预测性能。**

- **链接: [http://arxiv.org/pdf/2508.02276v1](http://arxiv.org/pdf/2508.02276v1)**
...
>
> **摘要:** Virtual cell modeling represents an emerging frontier at the intersection of artificial intelligence and biology, aiming to predict quantities such as responses to diverse perturbations quantitatively. However, autonomously building computational models for virtual cells is challenging due to the complexity of biological systems, the heterogeneity of data modalities, and the need for domain-specific expertise across multiple disciplines. Here, we introduce CellForge, an agentic system that leverages a multi-agent framework that transforms presented biological datasets and research objectives directly into optimized computational models for virtual cells. More specifically, given only raw single-cell multi-omics data and task descriptions as input, CellForge outputs both an optimized model architecture and executable code for training virtual cell models and inference. The framework integrates three core modules: Task Analysis for presented dataset characterization and relevant literature retrieval, Method Design, where specialized agents collaboratively develop optimized modeling strategies, and Experiment Execution for automated generation of code. The agents in the Design module are separated into experts with differing perspectives and a central moderator, and have to collaboratively exchange solutions until they achieve a reasonable consensus. We demonstrate CellForge's capabilities in single-cell perturbation prediction, using six diverse datasets that encompass gene knockouts, drug treatments, and cytokine stimulations across multiple modalities. CellForge consistently outperforms task-specific state-of-the-art methods. Overall, CellForge demonstrates how iterative interaction between LLM agents with differing perspectives provides better solutions than directly addressing a modeling challenge. Our code is publicly available at https://github.com/gersteinlab/CellForge.
>
---
#### [new 113] What are you sinking? A geometric approach on attention sink
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文探讨了注意力耗损现象的几何机制，旨在揭示其作为基础几何原理的来源，并通过分析不同参考框架类型及位置编码的影响，解决了Transformer中为何出现AS的问题，提出了架构设计与AS关系的理论框架。**

- **链接: [http://arxiv.org/pdf/2508.02546v1](http://arxiv.org/pdf/2508.02546v1)**

> **作者:** Valeria Ruscio; Umberto Nanni; Fabrizio Silvestri
>
> **摘要:** Attention sink (AS) is a consistent pattern in transformer attention maps where certain tokens (often special tokens or positional anchors) disproportionately attract attention from other tokens. We show that in transformers, AS is not an architectural artifact, but it is the manifestation of a fundamental geometric principle: the establishment of reference frames that anchor representational spaces. We analyze several architectures and identify three distinct reference frame types, centralized, distributed, and bidirectional, that correlate with the attention sink phenomenon. We show that they emerge during the earliest stages of training as optimal solutions to the problem of establishing stable coordinate systems in high-dimensional spaces. We show the influence of architecture components, particularly position encoding implementations, on the specific type of reference frame. This perspective transforms our understanding of transformer attention mechanisms and provides insights for both architecture design and the relationship with AS.
>
---
#### [new 114] AgentArmor: Enforcing Program Analysis on Agent Runtime Trace to Defend Against Prompt Injection
- **分类: cs.CR; cs.AI; cs.CL; cs.LG; cs.SE**

- **简介: 该论文提出了一种基于结构化程序分析的方法，旨在通过将代理运行时跟踪器转化为图结构（如CFG/DAG/PDG）并结合类型系统，防御提示注入攻击，解决动态代理行为不透明带来的安全风险。**

- **链接: [http://arxiv.org/pdf/2508.01249v1](http://arxiv.org/pdf/2508.01249v1)**
...
>
---
#### [new 115] DBAIOps: A Reasoning LLM-Enhanced Database Operation and Maintenance System using Knowledge Graphs
- **分类: cs.DB; cs.AI; cs.CL; cs.IR; cs.LG**

- **简介: 该论文提出DBAIOps系统，结合知识图谱与推理LLM实现数据库O&M，解决传统方法依赖专家经验不足的问题，通过构建混合模型、开发异常模型及自动推导机制提升诊断效率和准确性。**

- **链接: [http://arxiv.org/pdf/2508.01136v1](http://arxiv.org/pdf/2508.01136v1)**

> **作者:** Wei Zhou; Peng Sun; Xuanhe Zhou; Qianglei Zang; Ji Xu; Tieying Zhang; Guoliang Li; Fan Wu
>
> **备注:** DBAIOps supports 25 database systems and has been deployed in 20 real-world scenarios, covering domains like finance, energy, and healthcare. See website at: https://www.dbaiops.com; See code at: https://github.com/weAIDB/DBAIOps/
>
> **摘要:** The operation and maintenance (O&M) of database systems is critical to ensuring system availability and performance, typically requiring expert experience (e.g., identifying metric-to-anomaly relations) for effective diagnosis and recovery. However, existing automatic database O&M methods, including commercial products, cannot effectively utilize expert experience. On the one hand, rule-based methods only support basic O&M tasks (e.g., metric-based anomaly detection), which are mostly numerical equations and cannot effectively incorporate literal O&M experience (e.g., troubleshooting guidance in manuals). On the other hand, LLM-based methods, which retrieve fragmented information (e.g., standard documents + RAG), often generate inaccurate or generic results. To address these limitations, we present DBAIOps, a novel hybrid database O&M system that combines reasoning LLMs with knowledge graphs to achieve DBA-style diagnosis. First, DBAIOps introduces a heterogeneous graph model for representing the diagnosis experience, and proposes a semi-automatic graph construction algorithm to build that graph from thousands of documents. Second, DBAIOps develops a collection of (800+) reusable anomaly models that identify both directly alerted metrics and implicitly correlated experience and metrics. Third, for each anomaly, DBAIOps proposes a two-stage graph evolution mechanism to explore relevant diagnosis paths and identify missing relations automatically. It then leverages a reasoning LLM (e.g., DeepSeek-R1) to infer root causes and generate clear diagnosis reports for both DBAs and common users. Our evaluation over four mainstream database systems (Oracle, MySQL, PostgreSQL, and DM8) demonstrates that DBAIOps outperforms state-of-the-art baselines, 34.85% and 47.22% higher in root cause and human evaluation accuracy, respectively.
>
---
#### [new 116] Subject or Style: Adaptive and Training-Free Mixture of LoRAs
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 119] CAPO: Towards Enhancing LLM Reasoning through Verifiable Generative Credit Assignment
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文旨在解决LLM推理过程中粗粒度奖励分配不足的问题，提出CAPO方法通过生成式LLM提供步骤级奖励并结合投票机制提升信用分配精度，实验表明其在数学与跨域任务中优于传统方法。**

- **链接: [http://arxiv.org/pdf/2508.02298v1](http://arxiv.org/pdf/2508.02298v1)**
...
>
---
#### [new 120] Hidden in the Noise: Unveiling Backdoors in Audio LLMs Alignment through Latent Acoustic Pattern Triggers
- **分类: cs.SD; cs.CL**
...
>
---
#### [new 128] CRINN: Contrastive Reinforcement Learning for Approximate Nearest Neighbor Search
- **分类: cs.LG; cs.AI; cs.CL; cs.DB**

- **简介: 该论文提出CRINN（基于对比强化学习的近似最近邻搜索）任务，解决ANNS算法在效率与精度间的平衡问题。通过将优化目标作为强化学习奖励，自动优化近似实现速度与准确性的参数组合，验证了强化学习在自动化算法优化中的有效性。**

- **链接: [http://arxiv.org/pdf/2508.02091v1](http://arxiv.org/pdf/2508.02091v1)**
...
>
---
#### [new 129] ChEmbed: Enhancing Chemical Literature Search Through Domain-Specific Text Embeddings
- **分类: cs.IR; cs.CL**

- **简介: 该论文提出ChEmbed，解决化学文献检索中的领域适配不足问题，通过定制化文本嵌入模型与领域数据增强技术提升检索效果，有效提升了nDCG@10值并优化了上下文长度。**

- **链接: [http://arxiv.org/pdf/2508.01643v1](http://arxiv.org/pdf/2508.01643v1)**
...
>
---
#### [new 132] Voxlect: A Speech Foundation Model Benchmark for Modeling Dialects and Regional Languages Around the Globe
- **分类: cs.SD; cs.CL**
...
>
---
#### [new 133] Revisiting Replay and Gradient Alignment for Continual Pre-Training of Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文旨在探索在连续预训练过程中优化资源效率的技术方案，解决分布变化引发的性能退化问题。通过实验验证了经验回放与梯度对齐方法的有效性，提出改进元经验回放（MER）并证明其计算效率优势。**

- **链接: [http://arxiv.org/pdf/2508.01908v1](http://arxiv.org/pdf/2508.01908v1)**
...
>
---
#### [new 137] An analysis of AI Decision under Risk: Prospect theory emerges in Large Language Models
- **分类: cs.AI; cs.CL; cs.CY**

- **简介: 该论文旨在分析大型语言模型在风险决策中的表现，探讨前景理论如何影响其对风险的感知与决策。研究揭示模型通过情境框架（如军事场景）体现人类偏好的非理性特征，验证了语言建模捕捉人类心理偏差的能力，并指出框架的重要性。**
...
>
---
#### [new 138] Contextual Phenotyping of Pediatric Sepsis Cohort Using Large Language Models
- **分类: q-bio.QM; cs.AI; cs.CL; cs.LG; stat.AP**

- **简介: 该论文旨在通过大型语言模型（LLMs）对儿科脓毒症患者子群进行聚类分析，解决高维异构数据下的个性化护理与资源优化问题，研究了LLM与传统聚类算法的对比，并验证了其在捕捉情境特征方面的优势。**

- **链接: [http://arxiv.org/pdf/2505.09805v1](http://arxiv.org/pdf/2505.09805v1)**
...
>
> **摘要:** Clustering patient subgroups is essential for personalized care and efficient resource use. Traditional clustering methods struggle with high-dimensional, heterogeneous healthcare data and lack contextual understanding. This study evaluates Large Language Model (LLM) based clustering against classical methods using a pediatric sepsis dataset from a low-income country (LIC), containing 2,686 records with 28 numerical and 119 categorical variables. Patient records were serialized into text with and without a clustering objective. Embeddings were generated using quantized LLAMA 3.1 8B, DeepSeek-R1-Distill-Llama-8B with low-rank adaptation(LoRA), and Stella-En-400M-V5 models. K-means clustering was applied to these embeddings. Classical comparisons included K-Medoids clustering on UMAP and FAMD-reduced mixed data. Silhouette scores and statistical tests evaluated cluster quality and distinctiveness. Stella-En-400M-V5 achieved the highest Silhouette Score (0.86). LLAMA 3.1 8B with the clustering objective performed better with higher number of clusters, identifying subgroups with distinct nutritional, clinical, and socioeconomic profiles. LLM-based methods outperformed classical techniques by capturing richer context and prioritizing key features. These results highlight potential of LLMs for contextual phenotyping and informed decision-making in resource-limited settings.
>
---
#### [new 139] HyCodePolicy: Hybrid Language Controllers for Multimodal Monitoring and Decision in Embodied Agents
- **分类: cs.RO; cs.AI; cs.CL**

- **简介: 该论文提出了一种混合语言控制框架HyCodePolicy，解决在多模态环境中对代码策略进行实时监控与修复的问题。通过将代码生成、几何地基、视觉反馈和迭代修复整合到闭环编程循环中，实现了自主修正程序的自适应能力，并验证了其在机器人操作策略优化中的有效性。**

- **链接: [http://arxiv.org/pdf/2508.02629v1](http://arxiv.org/pdf/2508.02629v1)**
...
>
> **摘要:** Large Language Models(LLMs) have demonstrated remarkable performance across various domains, yet their capabilities in molecular reasoning remain insufficiently explored. Current approaches tend to rely heavily on general-purpose prompting, which lacks domain-specific molecular semantics, while those that use fine-tuning strategies often face challenges with interpretability and reasoning depth. To address these issues, we introduce MolReasoner, a two-stage framework designed to transition LLMs from memorization towards chemical reasoning. First, we propose Mol-SFT, which initializes the model's reasoning abilities via synthetic Chain-of-Thought(CoT) samples generated by GPT-4o and verified for chemical accuracy. Subsequently, Mol-RL applies reinforcement learning with specialized reward functions designed explicitly to align chemical structures with linguistic descriptions, thereby enhancing molecular reasoning capabilities. Our approach notably enhances interpretability, improving the model 's molecular understanding and enabling better generalization. Extensive experiments demonstrate that MolReasoner outperforms existing methods, and marking a significant shift from memorization-based outputs to robust chemical reasoning.
>
---
#### [new 142] OptiHive: Ensemble Selection for LLM-Based Optimization via Statistical Modeling
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出一种基于统计建模的LLM优化框架（OptiHive），解决传统与复杂优化问题中的不确定性量化与高效求解，通过单次批量查询生成并过滤错误组件，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2508.02503v1](http://arxiv.org/pdf/2508.02503v1)**

> **作者:** Maxime Bouscary; Saurabh Amin
>
> **摘要:** LLM-based solvers have emerged as a promising means of automating problem modeling and solving. However, they remain unreliable and often depend on iterative repair loops that result in significant latency. We introduce OptiHive, an LLM-based framework that produces high-quality solvers for optimization problems from natural-language descriptions without iterative self-correction. OptiHive uses a single batched LLM query to generate diverse components (solvers, problem instances, and validation tests) and filters out erroneous components to ensure fully interpretable outputs. Taking into account the imperfection of the generated components, we employ a statistical model to infer their true performance, enabling principled uncertainty quantification and solver selection. On tasks ranging from traditional optimization problems to challenging variants of the Multi-Depot Vehicle Routing Problem, OptiHive significantly outperforms baselines, increasing the optimality rate from 5\% to 92\% on the most complex problems.
>
---
#### [new 143] Parameter-Efficient Routed Fine-Tuning: Mixture-of-Experts Demands Mixture of Adaptation Modules
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文探讨了在混合专家架构下如何提升参数高效微调能力，提出将适应模块与路由机制结合以优化MoE模型性能，验证了其有效性并提供了配置优化方案。**

- **链接: [http://arxiv.org/pdf/2508.02587v1](http://arxiv.org/pdf/2508.02587v1)**
...
>
---
#### [replaced 002] Shifting AI Efficiency From Model-Centric to Data-Centric Compression
...
>
---
#### [replaced 005] StableGS: A Floater-Free Framework for 3D Gaussian Splatting
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 006] It's High Time: A Survey of Temporal Question Answering
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2505.20243v3](http://arxiv.org/pdf/2505.20243v3)**

> **作者:** Bhawna Piryani; Abdelrahman Abdallah; Jamshid Mozafari; Avishek Anand; Adam Jatowt
>
> **摘要:** Time plays a critical role in how information is generated, retrieved, and interpreted. In this survey, we provide a comprehensive overview of Temporal Question Answering (TQA), a research area that focuses on answering questions involving temporal constraints or context. As the amount of time-stamped content from sources like news articles, web archives, and knowledge bases increases, systems must address challenges such as detecting temporal intent, normalizing time expressions, ordering events, and reasoning over evolving or ambiguous facts. We focus on recent advances in TQA enabled by neural architectures, especially transformer-based models and Large Language Models (LLMs), highlighting progress in temporal language modeling, retrieval-augmented generation (RAG), and temporal reasoning. We also discuss benchmark datasets and evaluation strategies designed to test temporal robustness, recency awareness, and generalization.
>
---
#### [replaced 007] Disambiguation-Centric Finetuning Makes Enterprise Tool-Calling LLMs More Realistic and Less Risky
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.03336v2](http://arxiv.org/pdf/2507.03336v2)**
...
>
---
#### [replaced 008] What to Keep and What to Drop: Adaptive Table Filtering Framework
- **分类: cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2506.23463v3](http://arxiv.org/pdf/2506.23463v3)**
...
>
---
#### [replaced 011] Arena-Lite: Efficient and Reliable Large Language Model Evaluation via Tournament-Based Direct Comparisons
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2411.01281v4](http://arxiv.org/pdf/2411.01281v4)**
...
>
---
#### [replaced 012] JurisTCU: A Brazilian Portuguese Information Retrieval Dataset with Query Relevance Judgments
- **分类: cs.IR; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.08379v2](http://arxiv.org/pdf/2503.08379v2)**
...
>
---
#### [replaced 015] THREAD: Thinking Deeper with Recursive Spawning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2405.17402v2](http://arxiv.org/pdf/2405.17402v2)**
...
>
---
#### [replaced 020] Med-R$^3$: Enhancing Medical Retrieval-Augmented Reasoning of LLMs via Progressive Reinforcement Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.23541v2](http://arxiv.org/pdf/2507.23541v2)**

> **作者:** Keer Lu; Zheng Liang; Youquan Li; Jiejun Tan; Da Pan; Shusen Zhang; Guosheng Dong; Huang Leng; Bin Cui; Wentao Zhang
>
...
>
---
#### [replaced 023] Efficient Dynamic Clustering-Based Document Compression for Retrieval-Augmented-Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.03165v2](http://arxiv.org/pdf/2504.03165v2)**
...
>
---
#### [replaced 024] GEM: Gaussian Embedding Modeling for Out-of-Distribution Detection in GUI Agents
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.12842v3](http://arxiv.org/pdf/2505.12842v3)**
...
>
---
#### [replaced 025] Think, Reflect, Create: Metacognitive Learning for Zero-Shot Robotic Planning with LLMs
- **分类: cs.RO; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.14899v2](http://arxiv.org/pdf/2505.14899v2)**
...
>
---
#### [replaced 026] Rethinking Table Instruction Tuning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.14693v4](http://arxiv.org/pdf/2501.14693v4)**
...
>
---
#### [replaced 027] Kestrel: 3D Multimodal LLM for Part-Aware Grounded Description
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 028] Gandalf the Red: Adaptive Security for LLMs
- **分类: cs.LG; cs.AI; cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2501.07927v3](http://arxiv.org/pdf/2501.07927v3)**
...
>
---
#### [replaced 032] Associative memory inspires improvements for in-context learning using a novel attention residual stream architecture
- **分类: cs.NE; cs.AI; cs.CL; 92B20, 68T01, 68T37, 68T50; I.2; I.5; I.7; J.2; J.3**

- **链接: [http://arxiv.org/pdf/2412.15113v2](http://arxiv.org/pdf/2412.15113v2)**

> **作者:** Thomas F Burns; Tomoki Fukai; Christopher J Earls
>
> **备注:** 35 pages, 14 figures, 6 tables; accepted and published in TMLR
>
> **摘要:** Large language models (LLMs) demonstrate an impressive ability to utilise information within the context of their input sequences to appropriately respond to data unseen by the LLM during its training procedure. This ability is known as in-context learning (ICL). Humans and non-human animals demonstrate similar abilities, however their neural architectures differ substantially from LLMs. Despite this, a critical component within LLMs, the attention mechanism, resembles modern associative memory models, widely used in and influenced by the computational neuroscience community to model biological memory systems. Using this connection, we introduce an associative memory model capable of performing ICL. We use this as inspiration for a novel residual stream architecture which allows information to directly flow between attention heads. We test this architecture during training within a two-layer Transformer and show its ICL abilities manifest more quickly than without this modification. We then apply our architecture in small language models with 8 million and 1 billion parameters, focusing on attention head values, with results also indicating improved performance at these larger and more naturalistic scales.
>
---
#### [replaced 033] ParetoHqD: Fast Offline Multiobjective Alignment of Large Language Models using Pareto High-quality Data
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2504.16628v2](http://arxiv.org/pdf/2504.16628v2)**
...
>
---
#### [replaced 034] Language-based Audio Moment Retrieval
...
>
---
#### [replaced 035] MaPPO: Maximum a Posteriori Preference Optimization with Prior Knowledge
- **分类: cs.LG; cs.AI; cs.CL; I.2.6; I.2.7**

- **链接: [http://arxiv.org/pdf/2507.21183v2](http://arxiv.org/pdf/2507.21183v2)**
...
>
---
#### [replaced 038] Agree to Disagree? A Meta-Evaluation of LLM Misgendering
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 039] XtraGPT: Context-Aware and Controllable Academic Paper Revision via Human-AI Collaboration
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.11336v2](http://arxiv.org/pdf/2505.11336v2)**
...
>
---
#### [replaced 040] LinguaSynth: Heterogeneous Linguistic Signals for News Classification
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.21848v3](http://arxiv.org/pdf/2506.21848v3)**
...
>
---
#### [replaced 041] Your AI, Not Your View: The Bias of LLMs in Investment Analysis
- **分类: q-fin.PM; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.20957v2](http://arxiv.org/pdf/2507.20957v2)**
...
>
---
#### [replaced 042] Cascade Reward Sampling for Efficient Decoding-Time Alignment
- **分类: cs.CL; cs.LG; stat.ML**

- **链接: [http://arxiv.org/pdf/2406.16306v3](http://arxiv.org/pdf/2406.16306v3)**

> **作者:** Bolian Li; Yifan Wang; Anamika Lochab; Ananth Grama; Ruqi Zhang
>
...
>
---
#### [replaced 043] Rethinking the Role of Prompting Strategies in LLM Test-Time Scaling: A Perspective of Probability Theory
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.10981v3](http://arxiv.org/pdf/2505.10981v3)**

> **作者:** Yexiang Liu; Zekun Li; Zhi Fang; Nan Xu; Ran He; Tieniu Tan
>
> **备注:** ACL 2025 Outstanding Paper Award, 33 pages, 51 figures
>
...
>
---
#### [replaced 046] Safety at Scale: A Comprehensive Survey of Large Model and Agent Safety
...
>
---
#### [replaced 047] BiDoRA: Bi-level Optimization-Based Weight-Decomposed Low-Rank Adaptation
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2410.09758v2](http://arxiv.org/pdf/2410.09758v2)**
...
>
---
#### [replaced 048] From Semantic Web and MAS to Agentic AI: A Unified Narrative of the Web of Agents
- **分类: cs.AI; cs.CL; cs.CR; cs.HC; cs.MA; I.2.11; I.2.7; C.2.4; K.6.5; I.2.4**

- **链接: [http://arxiv.org/pdf/2507.10644v3](http://arxiv.org/pdf/2507.10644v3)**
...
>
---
#### [replaced 051] Thinker-DDM: Modeling Deliberation for Machine Translation with a Drift-Diffusion Process
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2402.10699v2](http://arxiv.org/pdf/2402.10699v2)**

> **作者:** Hongbin Na; Zimu Wang; Mieradilijiang Maimaiti; Tong Chen; Wei Wang; Tao Shen; Ling Chen
>
> **备注:** Under review
>
> **摘要:** Large language models (LLMs) have demonstrated promising potential in various downstream tasks, including machine translation. However, prior work on LLM-based machine translation has mainly focused on better utilizing training data, demonstrations, or pre-defined and universal knowledge to improve performance, with a lack of consideration of decision-making like human translators. In this paper, we incorporate Thinker with the Drift-Diffusion Model (Thinker-DDM) to address this issue. We then redefine the Drift-Diffusion process to emulate human translators' dynamic decision-making under constrained resources. We conduct extensive experiments under the high-resource, low-resource, and commonsense translation settings using the WMT22 and CommonMT datasets, in which Thinker-DDM outperforms baselines in the first two scenarios. We also perform additional analysis and evaluation on commonsense translation to illustrate the high effectiveness and efficacy of the proposed method.
>
---
#### [replaced 052] SCOPE: Stochastic and Counterbiased Option Placement for Evaluating Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.18182v2](http://arxiv.org/pdf/2507.18182v2)**
...
>
---
#### [replaced 053] R1-VL: Learning to Reason with Multimodal Large Language Models via Step-wise Group Relative Policy Optimization
...
>
---
#### [replaced 056] A Guide to Misinformation Detection Data and Evaluation
...
>
---
#### [replaced 057] How Can I Publish My LLM Benchmark Without Giving the True Answers Away?
- **分类: cs.LG; cs.AI; cs.CL; stat.ME**

- **链接: [http://arxiv.org/pdf/2505.18102v3](http://arxiv.org/pdf/2505.18102v3)**
...
>
---
#### [replaced 058] Speak Easy: Eliciting Harmful Jailbreaks from LLMs with Simple Interactions
...
>
---
#### [replaced 059] HuggingGraph: Understanding the Supply Chain of LLM Ecosystem
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.14240v2](http://arxiv.org/pdf/2507.14240v2)**

> **作者:** Mohammad Shahedur Rahman; Runbang Hu; Peng Gao; Yuede Ji
>
...
>
---
#### [replaced 060] Ref-Long: Benchmarking the Long-context Referencing Capability of Long-context Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.09506v2](http://arxiv.org/pdf/2507.09506v2)**

> **作者:** Junjie Wu; Gefei Gu; Yanan Zheng; Dit-Yan Yeung; Arman Cohan
>
> **备注:** ACL 2025 Main Conference. First 2 authors contributed equally. Project webpage: https://wujunjie1998.github.io/Ref-Long-website/
>
...
>
---
#### [replaced 061] One Trigger Token Is Enough: A Defense Strategy for Balancing Safety and Usability in Large Language Models
- **分类: cs.CR; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.07167v2](http://arxiv.org/pdf/2505.07167v2)**
...
>
---
#### [replaced 062] On the Generalization vs Fidelity Paradox in Knowledge Distillation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.15442v2](http://arxiv.org/pdf/2505.15442v2)**
...
>
---
#### [replaced 063] Trustworthy Reasoning: Evaluating and Enhancing Factual Accuracy in LLM Intermediate Thought Processes
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.22940v2](http://arxiv.org/pdf/2507.22940v2)**
...
>
---
#### [replaced 064] Reasoning with Exploration: An Entropy Perspective on Reinforcement Learning for LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.14758v2](http://arxiv.org/pdf/2506.14758v2)**
...
>
---
#### [replaced 065] Large Language Models in Argument Mining: A Survey
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.16383v5](http://arxiv.org/pdf/2506.16383v5)**
...
>
---
#### [replaced 066] MCPEval: Automatic MCP-based Deep Evaluation for AI Agent Models
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.12806v2](http://arxiv.org/pdf/2507.12806v2)**
...
>
---
#### [replaced 067] FlexOlmo: Open Language Models for Flexible Data Use
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.07024v3](http://arxiv.org/pdf/2507.07024v3)**
...
>
---
#### [replaced 068] RAISE: Enhancing Scientific Reasoning in LLMs via Step-by-Step Retrieval
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.08625v2](http://arxiv.org/pdf/2506.08625v2)**
...
>
---
#### [replaced 069] MIST: Jailbreaking Black-box Large Language Models via Iterative Semantic Tuning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.16792v2](http://arxiv.org/pdf/2506.16792v2)**

> **作者:** Muyang Zheng; Yuanzhi Yao; Changting Lin; Rui Wang; Caihong Kai
>
...
>
---
#### [replaced 070] DYNARTmo: A Dynamic Articulatory Model for Visualization of Speech Movement Patterns
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.20343v2](http://arxiv.org/pdf/2507.20343v2)**

> **作者:** Bernd J. Kröger
>
> **备注:** 10 pages, 29 references, 2 figures, supplementary material. V2: Discussion of the tongue-palate contact pattern for /t/
>
...
>
---
#### [replaced 071] Self-Evolving Critique Abilities in Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.05727v2](http://arxiv.org/pdf/2501.05727v2)**
...
>
---
#### [replaced 077] Robust and Efficient Fine-tuning of LLMs with Bayesian Reparameterization of Low-Rank Adaptation
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2411.04358v3](http://arxiv.org/pdf/2411.04358v3)**
...
>
---
#### [replaced 078] MECAT: A Multi-Experts Constructed Benchmark for Fine-Grained Audio Understanding Tasks
...
>
---
#### [replaced 079] Can Reasoning Help Large Language Models Capture Human Annotator Disagreement?
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.19467v2](http://arxiv.org/pdf/2506.19467v2)**
...
>
---
#### [replaced 080] Extrapolation by Association: Length Generalization Transfer in Transformers
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.09251v2](http://arxiv.org/pdf/2506.09251v2)**
...
>
---
#### [replaced 081] MCTS-SQL: Light-Weight LLMs can Master the Text-to-SQL through Monte Carlo Tree Search
- **分类: cs.DB; cs.AI; cs.CL; cs.PL**

- **链接: [http://arxiv.org/pdf/2501.16607v2](http://arxiv.org/pdf/2501.16607v2)**

> **作者:** Shuozhi Yuan; Limin Chen; Miaomiao Yuan; Jin Zhao
>
...
>
---
#### [replaced 082] Compressing KV Cache for Long-Context LLM Inference with Inter-Layer Attention Similarity
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2412.02252v2](http://arxiv.org/pdf/2412.02252v2)**
...
>
---
#### [replaced 084] AIRepr: An Analyst-Inspector Framework for Evaluating Reproducibility of LLMs in Data Science
- **分类: cs.LG; cs.AI; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2502.16395v2](http://arxiv.org/pdf/2502.16395v2)**
...
>
---
#### [replaced 085] Do MLLMs Capture How Interfaces Guide User Behavior? A Benchmark for Multimodal UI/UX Design Understanding
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.05026v3](http://arxiv.org/pdf/2505.05026v3)**
...
- **链接: [http://arxiv.org/pdf/2502.14037v3](http://arxiv.org/pdf/2502.14037v3)**
...
>
---
#### [replaced 088] Predictive Data Selection: The Data That Predicts Is the Data That Teaches
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.00808v4](http://arxiv.org/pdf/2503.00808v4)**

> **作者:** Kashun Shum; Yuzhen Huang; Hongjian Zou; Qi Ding; Yixuan Liao; Xiaoxin Chen; Qian Liu; Junxian He
>
> **备注:** ICML 2025
>
...
>
---
#### [replaced 089] More than Memes: A Multimodal Topic Modeling Approach to Conspiracy Theories on Telegram
...
>
---
#### [replaced 090] CheXalign: Preference fine-tuning in chest X-ray interpretation models without human feedback
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 091] PRISON: Unmasking the Criminal Potential of Large Language Models
- **分类: cs.CR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.16150v2](http://arxiv.org/pdf/2506.16150v2)**
...
>
---
#### [replaced 092] Beyond Scaling: Measuring and Predicting the Upper Bound of Knowledge Retention in Language Model Pre-Training
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.04066v4](http://arxiv.org/pdf/2502.04066v4)**

> **作者:** Changhao Jiang; Ming Zhang; Junjie Ye; Xiaoran Fan; Yifei Cao; Jiajun Sun; Zhiheng Xi; Shihan Dou; Yi Dong; Yujiong Shen; Jingqi Tong; Baoyu Fan; Zhen Wang; Tao Liang; Zhihui Fei; Mingyang Wan; Guojun Ma; Qi Zhang; Tao Gui; Xuanjing Huang
>
...
>
---
#### [replaced 093] A Scoping Review of Natural Language Processing in Addressing Medically Inaccurate Information: Errors, Misinformation, and Hallucination
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.00008v2](http://arxiv.org/pdf/2505.00008v2)**

> **作者:** Zhaoyi Sun; Wen-Wai Yim; Ozlem Uzuner; Fei Xia; Meliha Yetisgen
>
> **备注:** This paper has been accepted by the Journal of Biomedical Informatics
>
...
>
---
#### [replaced 094] Emergent Response Planning in LLMs
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.06258v3](http://arxiv.org/pdf/2502.06258v3)**
...
>
---
#### [replaced 095] FloorPlan-DeepSeek (FPDS): A multimodal approach to floorplan generation using vector-based next room prediction
- **分类: cs.CL; cs.AI; cs.AR**

- **链接: [http://arxiv.org/pdf/2506.21562v2](http://arxiv.org/pdf/2506.21562v2)**
...
>
---
#### [replaced 096] Core Context Aware Transformers for Long Context Language Modeling
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.12465v3](http://arxiv.org/pdf/2412.12465v3)**
