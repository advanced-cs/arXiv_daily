...
#### [new 001] DOCR-Inspector: Fine-Grained and Automated Evaluation of Document Parsing with VLM
- **分类: cs.CV**

- **简介: 该论文属文档解析评估任务，旨在解决现有基准测试偏差大、评估粗粒度的问题。作者提出DOCR-Inspector，利用VLM实现细粒度错误检测与分类，构建大规模数据集和新推理范式，实现自动化、精细化的文档解析质量评估。**

- **链接: [https://arxiv.org/pdf/2512.10619v1](https://arxiv.org/pdf/2512.10619v1)**
...
>
> **摘要:** Despite significant progress in 4D content generation, the conversion of monocular videos into high-quality animated 3D assets with explicit 4D meshes remains considerably challenging. The scarcity of large-scale, naturally captured 4D mesh datasets further limits the ability to train generalizable video-to-4D models from scratch in a purely data-driven manner. Meanwhile, advances in image-to-3D generation, supported by extensive datasets, offer powerful prior models that can be leveraged. To better utilize these priors while minimizing reliance on 4D supervision, we introduce SWiT-4D, a Sliding-Window Transformer for lossless, parameter-free temporal 4D mesh generation. SWiT-4D integrates seamlessly with any Diffusion Transformer (DiT)-based image-to-3D generator, adding spatial-temporal modeling across video frames while preserving the original single-image forward process, enabling 4D mesh reconstruction from videos of arbitrary length. To recover global translation, we further introduce an optimization-based trajectory module tailored for static-camera monocular videos. SWiT-4D demonstrates strong data efficiency: with only a single short (<10s) video for fine-tuning, it achieves high-fidelity geometry and stable temporal consistency, indicating practical deployability under extremely limited 4D supervision. Comprehensive experiments on both in-domain zoo-test sets and challenging out-of-domain benchmarks (C4D, Objaverse, and in-the-wild videos) show that SWiT-4D consistently outperforms existing baselines in temporal smoothness. Project page: https://animotionlab.github.io/SWIT4D/
>
---
#### [new 007] EchoingPixels: Cross-Modal Adaptive Token Reduction for Efficient Audio-Visual LLMs
- **分类: cs.CV**

- **简介: 该论文研究音频-视觉大模型的高效推理，解决多模态令牌冗余问题。提出EchoingPixels框架，通过跨模态语义筛动态联合压缩音视频令牌，并设计同步增强位置编码保留时序信息，实现显著加速与降耗。**

- **链接: [https://arxiv.org/pdf/2512.10324v1](https://arxiv.org/pdf/2512.10324v1)**
...
>
---
#### [new 008] Independent Density Estimation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视觉-语言模型任务，旨在解决现有模型在 compositional generalization 上的不足。提出独立密度估计（IDE）方法，通过词-图特征解耦建模与熵基推理，提升对未见组合的泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.10067v1](https://arxiv.org/pdf/2512.10067v1)**
...
>
---
#### [new 017] From Macro to Micro: Benchmarking Microscopic Spatial Intelligence on Molecules via Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文提出微观空间智能（MiSI）概念，构建MiSI-Bench基准，评估视觉语言模型在分子空间推理中的能力。涵盖九项任务，含16.3万问答对和58.7万图像，揭示现有模型与人类水平的差距，强调融合领域知识的重要性。**

- **链接: [https://arxiv.org/pdf/2512.10867v1](https://arxiv.org/pdf/2512.10867v1)**
...
>
---
#### [new 023] Optimal transport unlocks end-to-end learning for single-molecule localization
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于单分子定位显微镜（SMLM）超分辨成像任务，旨在解决高密度荧光发射下传统方法依赖非可微NMS导致信息丢失的问题。作者提出基于最优传输的损失函数和端到端可训练网络，避免NMS并提升定位精度。**

- **链接: [https://arxiv.org/pdf/2512.10683v1](https://arxiv.org/pdf/2512.10683v1)**
...
>
---
#### [new 030] Beyond Endpoints: Path-Centric Reasoning for Vectorized Off-Road Network Extraction
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究矢量化越野道路提取，解决现有方法在野外环境中因数据缺乏和结构缺陷导致的拓扑错误问题。提出WildRoad数据集与路径中心的MaGRoad框架，通过沿路径聚合多尺度视觉证据，提升鲁棒性与推理速度。**

- **链接: [https://arxiv.org/pdf/2512.10416v1](https://arxiv.org/pdf/2512.10416v1)**
...
>
---
#### [new 031] Mull-Tokens: Modality-Agnostic Latent Thinking
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究多模态推理任务，旨在解决现有模型依赖外部工具或手工数据、难以扩展的问题。提出Mull-Tokens，通过预训练模态无关的隐含token，支持自由形式的图文中间推理，提升空间推理表现。**

- **链接: [https://arxiv.org/pdf/2512.10941v1](https://arxiv.org/pdf/2512.10941v1)**
...
>
---
#### [new 032] Audio-sync Video Instance Editing with Granularity-Aware Mask Refiner
- **分类: cs.CV**

- **简介: 该论文研究音频同步的视频实例编辑任务，旨在解决现有方法缺乏音视频同步与精细时空控制的问题。提出AVI-Edit框架，包含粒度感知掩码优化器和自反馈音频代理，并构建高质量数据集，实现精准实例编辑与音视频同步。**

- **链接: [https://arxiv.org/pdf/2512.10571v1](https://arxiv.org/pdf/2512.10571v1)**
...
>
---
#### [new 041] Hierarchical Instance Tracking to Balance Privacy Preservation with Accessible Information
- **分类: cs.CV**

- **简介: 该论文提出层次实例跟踪任务，旨在追踪物体及其部件并保持层级关系。为解决隐私与信息可及性的平衡问题，构建了包含552个视频的新数据集，并评估了多种模型，验证任务挑战性。**

- **链接: [https://arxiv.org/pdf/2512.10102v1](https://arxiv.org/pdf/2512.10102v1)**
...
>
---
#### [new 046] WorldLens: Full-Spectrum Evaluations of Driving World Models in Real World
- **分类: cs.CV**

- **简介: 该论文聚焦驾驶场景的生成世界模型评估任务，旨在解决现有模型缺乏全面、统一评估标准的问题。作者提出WorldLens基准，涵盖生成、重建、行为控制等方面，并构建数据集与评估代理，实现对世界模型在视觉、几何、物理和功能层面的综合评测。**

- **链接: [https://arxiv.org/pdf/2512.10958v1](https://arxiv.org/pdf/2512.10958v1)**
...
>
---
#### [new 049] SceneMaker: Open-set 3D Scene Generation with Decoupled De-occlusion and Pose Estimation Model
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于3D场景生成任务，旨在解决开放集中严重遮挡下的几何质量与姿态估计精度问题。提出SceneMaker框架，解耦去遮挡与姿态估计，利用图像和去遮挡数据增强先验，并设计统一姿态估计模型提升准确性。**

- **链接: [https://arxiv.org/pdf/2512.10957v1](https://arxiv.org/pdf/2512.10957v1)**
...
>
---
#### [new 052] MoCapAnything: Unified 3D Motion Capture for Arbitrary Skeletons from Monocular Videos
- **分类: cs.CV**

- **简介: 该论文研究类别无关的3D动作捕捉（CAMoCap），旨在从单目视频中为任意骨骼结构的3D角色生成动画。提出MoCapAnything框架，通过参考引导与解耦设计，实现高质量、跨物种的动作重建与重定向。**

- **链接: [https://arxiv.org/pdf/2512.10881v1](https://arxiv.org/pdf/2512.10881v1)**
...
>
> **备注:** Project page: https://animotionlab.github.io/MoCapAnything/
>
...
>
---
#### [new 060] Multi-dimensional Preference Alignment by Conditioning Reward Itself
- **分类: cs.CV**

- **简介: 该论文属多模态生成模型对齐任务，旨在解决传统DPO因单标量奖励导致的多维度偏好冲突问题。作者提出MCDPO方法，通过条件化多维奖励向量与解耦优化，实现各评价轴独立学习，并支持推理时动态调控各偏好维度。**

- **链接: [https://arxiv.org/pdf/2512.10237v1](https://arxiv.org/pdf/2512.10237v1)**
...
>
---
#### [new 061] Efficient-VLN: A Training-Efficient Vision-Language Navigation Model
- **分类: cs.CV**

- **简介: 该论文研究视觉-语言导航（VLN）任务，旨在降低多模态大模型训练开销。针对长序列处理和探索效率的矛盾，提出Efficient-VLN，设计渐进式与递归记忆机制及动态混合策略，显著减少GPU训练耗时，同时达到最优性能。**

- **链接: [https://arxiv.org/pdf/2512.10310v1](https://arxiv.org/pdf/2512.10310v1)**
...
>
---
#### [new 062] Any4D: Unified Feed-Forward Metric 4D Reconstruction
...
>
---
#### [new 063] XDen-1K: A Density Field Dataset of Real-World Objects
- **分类: cs.CV**

- **简介: 该论文聚焦物理属性建模任务，旨在解决真实物体内部密度场数据缺失问题。作者构建了XDen-1K数据集，包含千个物体的3D模型与X光扫描，并提出密度场优化框架，提升物体重心估计与机器人操作性能。**

- **链接: [https://arxiv.org/pdf/2512.10668v1](https://arxiv.org/pdf/2512.10668v1)**
...
>
---
#### [new 064] BabyVLM-V2: Toward Developmentally Grounded Pretraining and Benchmarking of Vision Foundation Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出BabyVLM-V2，旨在通过婴幼儿发展轨迹指导视觉基础模型的高效预训练。构建婴儿中心多模态数据集与DevCV认知评测工具箱，实现对空间推理、记忆等能力的评估，推动发展可解释、样本高效的视觉模型研究。**

- **链接: [https://arxiv.org/pdf/2512.10932v1](https://arxiv.org/pdf/2512.10932v1)**
...
>
---
#### [new 065] CoSPlan: Corrective Sequential Planning via Scene Graph Incremental Updates
- **分类: cs.CV**

- **简介: 该论文研究视觉语言模型在易出错场景下的序列规划任务，提出CoSPlan基准评测其错误检测与修正能力，并设计无需训练的SGI方法，通过场景图增量更新提升推理性能。**

- **链接: [https://arxiv.org/pdf/2512.10342v1](https://arxiv.org/pdf/2512.10342v1)**
...
>
---
#### [new 066] Point2Pose: A Generative Framework for 3D Human Pose Estimation with Multi-View Point Cloud Dataset
- **分类: cs.CV**

- **简介: 该论文研究3D人体姿态估计任务，旨在解决复杂形变、自遮挡及缺乏多模态数据的问题。作者提出Point2Pose框架，结合点云与姿态历史进行生成式姿态预测，并发布包含多视角点云、IMU和RGB的大规模数据集MVPose3D。**

- **链接: [https://arxiv.org/pdf/2512.10321v1](https://arxiv.org/pdf/2512.10321v1)**
...
>
---
#### [new 067] MMSI-Video-Bench: A Holistic Benchmark for Video-Based Spatial Intelligence
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MMSI-Video-Bench，旨在评估多模态大语言模型在视频空间智能上的能力。针对现有基准缺失问题，构建了包含感知、规划、预测和跨视频推理的四层评测体系，揭示模型在几何推理、运动理解等方面存在显著缺陷。**

- **链接: [https://arxiv.org/pdf/2512.10863v1](https://arxiv.org/pdf/2512.10863v1)**
...
>
> **摘要:** Spatial understanding over continuous visual input is crucial for MLLMs to evolve into general-purpose assistants in physical environments. Yet there is still no comprehensive benchmark that holistically assesses the progress toward this goal. In this work, we introduce MMSI-Video-Bench, a fully human-annotated benchmark for video-based spatial intelligence in MLLMs. It operationalizes a four-level framework, Perception, Planning, Prediction, and Cross-Video Reasoning, through 1,106 questions grounded in 1,278 clips from 25 datasets and in-house videos. Each item is carefully designed and reviewed by 3DV experts with explanatory rationales to ensure precise, unambiguous grounding. Leveraging its diverse data sources and holistic task coverage, MMSI-Video-Bench also supports three domain-oriented sub-benchmarks (Indoor Scene Perception Bench, Robot Bench and Grounding Bench) for targeted capability assessment. We evaluate 25 strong open-source and proprietary MLLMs, revealing a striking human--AI gap: many models perform near chance, and the best reasoning model lags humans by nearly 60%. We further find that spatially fine-tuned models still fail to generalize effectively on our benchmark. Fine-grained error analysis exposes systematic failures in geometric reasoning, motion grounding, long-horizon prediction, and cross-video correspondence. We also show that typical frame-sampling strategies transfer poorly to our reasoning-intensive benchmark, and that neither 3D spatial cues nor chain-of-thought prompting yields meaningful gains. We expect our benchmark to establish a solid testbed for advancing video-based spatial intelligence.
>
---
#### [new 068] StereoSpace: Depth-Free Synthesis of Stereo Geometry via End-to-End Diffusion in a Canonical Space
- **分类: cs.CV**

- **简介: 该论文研究单目图像生成立体几何，提出StereoSpace框架，通过端到端扩散模型在标准矫正空间中实现无需深度估计的立体合成，仅依赖视角条件生成视差，解决了传统方法依赖显式深度或形变的问题，提升了生成质量与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.10959v1](https://arxiv.org/pdf/2512.10959v1)**
...
>
---
#### [new 069] What matters for Representation Alignment: Global Information or Spatial Structure?
- **分类: cs.CV; cs.AI; cs.GR; cs.LG; stat.ML**

- **简介: 该论文研究表示对齐（REPA）中影响生成性能的关键因素，发现空间结构比全局语义信息更重要。作者提出iREPA方法，通过卷积和空间归一化增强空间信息传递，显著提升训练效率，适用于多种模型与训练变体。**

- **链接: [https://arxiv.org/pdf/2512.10794v1](https://arxiv.org/pdf/2512.10794v1)**
...
>
---
#### [new 072] VL-JEPA: Joint Embedding Predictive Architecture for Vision-language
- **分类: cs.CV**

- **简介: 该论文提出VL-JEPA，一种基于联合嵌入预测架构的视觉-语言模型。它通过预测连续文本嵌入替代传统token生成，减少参数量与解码开销，支持高效生成及多种下游任务，提升性能与效率。**

- **链接: [https://arxiv.org/pdf/2512.10942v1](https://arxiv.org/pdf/2512.10942v1)**
...
>
---
#### [new 078] E-RayZer: Self-supervised 3D Reconstruction as Spatial Visual Pre-training
- **分类: cs.CV**

- **简介: 该论文聚焦3D视觉预训练任务，旨在从无标签多视角图像中学习3D感知表征。提出E-RayZer模型，通过显式3D重建和细粒度课程学习，实现几何明确的自监督3D表示学习，提升下游3D任务性能。**

- **链接: [https://arxiv.org/pdf/2512.10950v1](https://arxiv.org/pdf/2512.10950v1)**
...
>
---
#### [new 079] MotionEdit: Benchmarking and Learning Motion-Centric Image Editing
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 080] Blink: Dynamic Visual Token Resolution for Enhanced Multimodal Understanding
- **分类: cs.CV**

- **简介: 该论文针对多模态大模型视觉感知能力有限的问题，受人类“眨眼式”动态注视启发，提出Blink框架。通过显著性引导扫描与动态令牌超分模块，在单次前向过程中自适应增强关键视觉区域，提升多模态理解效果。**

- **链接: [https://arxiv.org/pdf/2512.10548v1](https://arxiv.org/pdf/2512.10548v1)**
...
>
---
#### [new 081] MeViS: A Multi-Modal Dataset for Referring Motion Expression Video Segmentation
- **分类: cs.CV**

- **简介: 该论文提出MeViS数据集，面向指代表情运动的视频分割任务，旨在通过语言描述中的运动信息实现目标对象的像素级分割与跟踪。针对现有方法在运动理解上的不足，构建多模态数据并评测现有方法，同时提出LMPM++模型提升性能。**

- **链接: [https://arxiv.org/pdf/2512.10945v1](https://arxiv.org/pdf/2512.10945v1)**
...
>
---
#### [new 082] ConStruct: Structural Distillation of Foundation Models for Prototype-Based Weakly Supervised Histopathology Segmentation
- **分类: cs.CV**

- **简介: 该论文研究弱监督组织病理学图像分割，旨在解决分类模型定位不全的问题。作者提出ConStruct框架，融合CONCH的语义与SegFormer的空间信息，通过文本引导原型初始化和结构蒸馏生成高质量伪掩码，提升分割完整性和语义一致性。**

- **链接: [https://arxiv.org/pdf/2512.10316v1](https://arxiv.org/pdf/2512.10316v1)**
...
>
---
#### [new 083] Solving Semi-Supervised Few-Shot Learning from an Auto-Annotation Perspective
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究半监督少样本学习（SSFSL）任务，旨在实现自动标注。针对现有方法忽略开源视觉语言模型资源的问题，提出SWIFT方法，通过分类器初始化和温度调整增强伪标签质量，有效利用无标签数据，显著提升性能。**

- **链接: [https://arxiv.org/pdf/2512.10244v1](https://arxiv.org/pdf/2512.10244v1)**
...
>
---
#### [new 084] Breaking the Vicious Cycle: Coherent 3D Gaussian Splatting from Sparse and Motion-Blurred Views
- **分类: cs.CV**

- **简介: 该论文研究稀疏且运动模糊图像下的3D高斯点阵化重建任务，旨在打破因数据退化导致的重建失败循环。提出CoherentGS框架，结合去模糊网络与扩散模型的双重先验，并引入相机探索与深度正则化技术，实现高质量新视图合成。**

- **链接: [https://arxiv.org/pdf/2512.10369v1](https://arxiv.org/pdf/2512.10369v1)**
...
>
---
#### [new 091] mmCounter: Static People Counting in Dense Indoor Scenarios Using mmWave Radar
- **分类: cs.CV**

- **简介: 该论文属于静态人数统计任务，旨在解决密集室内场景下毫米波雷达因缺乏运动和分辨率不足导致的计数难题。作者提出mmCounter，通过提取呼吸等超低频信号并结合空间信息，实现高精度静态人数统计。**

- **链接: [https://arxiv.org/pdf/2512.10357v1](https://arxiv.org/pdf/2512.10357v1)**
...
>
---
#### [new 094] CheXmask-U: Quantifying uncertainty in landmark-based anatomical segmentation for X-ray images
- **分类: cs.CV**

- **简介: 该论文研究胸部X光解剖标志物分割中的不确定性估计，旨在提升模型可靠性。提出CheXmask-U方法，基于变分隐空间生成两种不确定性度量，并发布含65万张带不确定性的标注数据集，支持错误检测与分布外识别。**

- **链接: [https://arxiv.org/pdf/2512.10715v1](https://arxiv.org/pdf/2512.10715v1)**

> **作者:** Matias Cosarinsky; Nicolas Gaggion; Rodrigo Echeveste; Enzo Ferrante
>
> **摘要:** Uncertainty estimation is essential for the safe clinical deployment of medical image segmentation systems, enabling the identification of unreliable predictions and supporting human oversight. While prior work has largely focused on pixel-level uncertainty, landmark-based segmentation offers inherent topological guarantees yet remains underexplored from an uncertainty perspective. In this work, we study uncertainty estimation for anatomical landmark-based segmentation on chest X-rays. Inspired by hybrid neural network architectures that combine standard image convolutional encoders with graph-based generative decoders, and leveraging their variational latent space, we derive two complementary measures: (i) latent uncertainty, captured directly from the learned distribution parameters, and (ii) predictive uncertainty, obtained by generating multiple stochastic output predictions from latent samples. Through controlled corruption experiments we show that both uncertainty measures increase with perturbation severity, reflecting both global and local degradation. We demonstrate that these uncertainty signals can identify unreliable predictions by comparing with manual ground-truth, and support out-of-distribution detection on the CheXmask dataset. More importantly, we release CheXmask-U (huggingface.co/datasets/mcosarinsky/CheXmask-U), a large scale dataset of 657,566 chest X-ray landmark segmentations with per-node uncertainty estimates, enabling researchers to account for spatial variations in segmentation quality when using these anatomical masks. Our findings establish uncertainty estimation as a promising direction to enhance robustness and safe deployment of landmark-based anatomical segmentation methods in chest X-ray. A fully working interactive demo of the method is available at huggingface.co/spaces/matiasky/CheXmask-U and the source code at github.com/mcosarinsky/CheXmask-U.
>
---
#### [new 095] Visual Funnel: Resolving Contextual Blindness in Multimodal Large Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对多模态大模型在精细视觉任务中因局部与全局信息割裂导致的“上下文失明”问题，提出无需训练的Visual Funnel方法。通过上下文锚定和基于注意力熵的分层裁剪策略，构建结构化图像输入，有效融合细粒度细节与全局上下文。**

- **链接: [https://arxiv.org/pdf/2512.10362v1](https://arxiv.org/pdf/2512.10362v1)**
...
>
---
#### [new 101] Feature Coding for Scalable Machine Vision
- **分类: cs.CV**

- **简介: 该论文属于机器视觉任务，旨在解决边缘设备上DNN推理的带宽与计算矛盾。提出特征编码测试模型（FCTM），通过压缩中间特征显著降低传输比特率（平均85.14%），支持边缘-云协同推理，兼顾效率、隐私与准确性。**

- **链接: [https://arxiv.org/pdf/2512.10209v1](https://arxiv.org/pdf/2512.10209v1)**
...
>
> **摘要:** Motion understanding is fundamental to physical reasoning, enabling models to infer dynamics and predict future states. However, state-of-the-art models still struggle on recent motion benchmarks, primarily due to the scarcity of large-scale, fine-grained motion datasets. Existing motion datasets are often constructed from costly manual annotation, severely limiting scalability. To address this challenge, we introduce FoundationMotion, a fully automated data curation pipeline that constructs large-scale motion datasets. Our approach first detects and tracks objects in videos to extract their trajectories, then leverages these trajectories and video frames with Large Language Models (LLMs) to generate fine-grained captions and diverse question-answer pairs about motion and spatial reasoning. Using datasets produced by this pipeline, we fine-tune open-source models including NVILA-Video-15B and Qwen2.5-7B, achieving substantial improvements in motion understanding without compromising performance on other tasks. Notably, our models outperform strong closed-source baselines like Gemini-2.5 Flash and large open-source models such as Qwen2.5-VL-72B across diverse motion understanding datasets and benchmarks. FoundationMotion thus provides a scalable solution for curating fine-grained motion datasets that enable effective fine-tuning of diverse models to enhance motion understanding and spatial reasoning capabilities.
>
---
#### [new 104] Grounding Everything in Tokens for Multimodal Large Language Models
- **分类: cs.CV**

- **简介: 该论文研究多模态大语言模型中的视觉 grounding 任务，旨在解决图像标记化导致的空间定位不准问题。提出 GETok 方法，引入可学习的网格与偏移标记，将空间关系嵌入标记中，提升模型在2D空间的定位与推理能力。**

- **链接: [https://arxiv.org/pdf/2512.10554v1](https://arxiv.org/pdf/2512.10554v1)**
...
>
---
#### [new 105] Group Diffusion: Enhancing Image Generation by Unlocking Cross-Sample Collaboration
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在提升扩散模型的生成质量。作者提出Group Diffusion，通过共享跨样本注意力实现图像协同去噪，挖掘样本间关联。方法在ImageNet上显著提升FID，揭示了跨样本推理的有效性。**

- **链接: [https://arxiv.org/pdf/2512.10954v1](https://arxiv.org/pdf/2512.10954v1)**
...
>
> **备注:** Project Page: https://sichengmo.github.io/GroupDiff/
>
...
>
---
#### [new 106] Evaluating Gemini Robotics Policies in a Veo World Simulator
...
>
---
#### [new 107] Design of a six wheel suspension and a three-axis linear actuation mechanism for a laser weeding robot
...
>
---
#### [new 108] Echo-CoPilot: A Multi-View, Multi-Task Agent for Echocardiography Interpretation and Reporting
- **分类: cs.AI; cs.CV; cs.LG; eess.IV**

- **简介: 该论文提出Echo-CoPilot，旨在解决超声心动图多视图、多任务解读难题。它结合大语言模型与专业工具，通过推理-行动循环实现自动分析、测量、诊断与报告生成，在MIMIC-EchoQA上表现优于现有模型。**

- **链接: [https://arxiv.org/pdf/2512.09944v1](https://arxiv.org/pdf/2512.09944v1)**
...
>
---
#### [new 109] Enhancing Radiology Report Generation and Visual Grounding using Reinforcement Learning
- **分类: cs.AI; cs.CV**

- **简介: 该论文研究胸部X光影像报告生成与视觉定位任务，旨在提升医学视觉语言模型的临床实用性。通过监督微调构建基础模型，引入强化学习（GRPO）结合临床任务奖励，并探索“思考”机制的影响，结果表明强化学习可有效提升性能，而显式思考未带来增益。**

- **链接: [https://arxiv.org/pdf/2512.10691v1](https://arxiv.org/pdf/2512.10691v1)**
...
>
---
#### [new 110] Extrapolation of Periodic Functions Using Binary Encoding of Continuous Numerical Values
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **简介: 该论文研究周期函数外推任务，解决神经网络在无先验知识下难以外推周期信号的问题。提出归一化二进制编码（NB2E），使MLP通过位相表示学习信号结构，实现跨位置的周期函数外推。**

- **链接: [https://arxiv.org/pdf/2512.10817v1](https://arxiv.org/pdf/2512.10817v1)**
...
>
---
#### [new 111] Stronger Normalization-Free Transformers
...
>
---
#### [new 112] Agile Deliberation: Concept Deliberation for Subjective Visual Classification
- **分类: cs.AI; cs.CV; cs.HC; cs.LG**

- **简介: 该论文针对主观视觉概念分类中用户概念模糊的问题，提出“敏捷思辨”人机协作框架，通过概念界定与迭代两阶段帮助用户厘清主观概念，提升分类效果与理解清晰度。**

- **链接: [https://arxiv.org/pdf/2512.10821v1](https://arxiv.org/pdf/2512.10821v1)**
...
>
---
#### [new 113] Mode-Seeking for Inverse Problems with Diffusion Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究利用预训练扩散模型求解无条件逆问题，提出变分模式寻求损失（VML），通过最小化两类后验分布的KL散度，直接逼近MAP估计。方法无需任务微调，理论清晰且计算高效，显著提升图像恢复性能与速度。**

- **链接: [https://arxiv.org/pdf/2512.10524v1](https://arxiv.org/pdf/2512.10524v1)**
...
>
---
#### [new 114] Federated Domain Generalization with Latent Space Inversion
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究联邦域泛化（FedDG）任务，旨在解决非独立同分布客户端间的数据隐私与模型泛化问题。提出基于潜在空间反演的本地训练和重要权重聚合策略，在保护隐私的同时提升全局模型对未见客户端的适应能力。**

- **链接: [https://arxiv.org/pdf/2512.10224v1](https://arxiv.org/pdf/2512.10224v1)**
...
>
---
#### [new 115] Interpretable and Steerable Concept Bottleneck Sparse Autoencoders
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于模型可解释性与控制任务，旨在解决稀疏自编码器（SAE）在视觉语言模型中特征不可控、概念缺失的问题。提出CB-SAE框架，通过剪枝低效神经元并引入用户定义的概念瓶颈，提升特征的可解释性与可操控性。**

- **链接: [https://arxiv.org/pdf/2512.10805v1](https://arxiv.org/pdf/2512.10805v1)**
...
>
---
#### [new 116] Metaphor-based Jailbreaking Attacks on Text-to-Image Models
- **分类: cs.CR; cs.AI; cs.CV**

- **简介: 该论文研究文本到图像模型的 jailbreaking 攻击，旨在绕过安全防御生成敏感内容。提出 MJA 方法，利用隐喻生成对抗提示，无需知晓防御机制类型，通过多智能体生成和优化提示，提升攻击效率与泛化性。**

- **链接: [https://arxiv.org/pdf/2512.10766v1](https://arxiv.org/pdf/2512.10766v1)**
...
>
---
#### [new 117] Bidirectional Normalizing Flow: From Data to Noise and Back
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于生成建模任务，旨在解决标准归一化流中因果解码导致的采样慢问题。作者提出双向归一化流（BiFlow），放弃精确逆映射约束，学习近似逆过程，显著提升采样速度与生成质量。**

- **链接: [https://arxiv.org/pdf/2512.10953v1](https://arxiv.org/pdf/2512.10953v1)**
...
>
---
#### [new 118] CC-GRMAS: A Multi-Agent Graph Neural System for Spatiotemporal Landslide Risk Assessment in High Mountain Asia
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出CC-GRMAS，一个基于多智能体图神经网络的系统，用于高亚洲山区的滑坡风险时空评估。针对气候引发的滑坡灾害预警不足问题，融合卫星与环境数据，构建预测、规划与执行协同框架，实现精准、实时的风险感知与响应决策。**

- **链接: [https://arxiv.org/pdf/2510.20875v1](https://arxiv.org/pdf/2510.20875v1)**
...
#### [replaced 001] EvoIR: Towards All-in-One Image Restoration via Evolutionary Frequency Modulation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05104v2](https://arxiv.org/pdf/2512.05104v2)**

> **作者:** Jiaqi Ma; Shengkai Hu; Xu Zhang; Jun Wan; Jiaxing Huang; Lefei Zhang; Salman Khan
>
...
>
---
#### [replaced 002] Relightable and Dynamic Gaussian Avatar Reconstruction from Monocular Video
- **分类: cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2512.09335v2](https://arxiv.org/pdf/2512.09335v2)**
...
>
---
#### [replaced 003] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.07752v2](https://arxiv.org/pdf/2510.07752v2)**
...
>
> **摘要:** Reconstructing Dynamic 3D Gaussian Splatting (3DGS) from low-framerate RGB videos is challenging. This is because large inter-frame motions will increase the uncertainty of the solution space. For example, one pixel in the first frame might have more choices to reach the corresponding pixel in the second frame. Event cameras can asynchronously capture rapid visual changes and are robust to motion blur, but they do not provide color information. Intuitively, the event stream can provide deterministic constraints for the inter-frame large motion by the event trajectories. Hence, combining low-temporal-resolution images with high-framerate event streams can address this challenge. However, it is challenging to jointly optimize Dynamic 3DGS using both RGB and event modalities due to the significant discrepancy between these two data modalities. This paper introduces a novel framework that jointly optimizes dynamic 3DGS from the two modalities. The key idea is to adopt event motion priors to guide the optimization of the deformation fields. First, we extract the motion priors encoded in event streams by using the proposed LoCM unsupervised fine-tuning framework to adapt an event flow estimator to a certain unseen scene. Then, we present the geometry-aware data association method to build the event-Gaussian motion correspondence, which is the primary foundation of the pipeline, accompanied by two useful strategies, namely motion decomposition and inter-frame pseudo-label. Extensive experiments show that our method outperforms existing image and event-based approaches across synthetic and real scenes and prove that our method can effectively optimize dynamic 3DGS with the help of event data.
>
---
#### [replaced 004] ConsistCompose: Unified Multimodal Layout Control for Image Composition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18333v2](https://arxiv.org/pdf/2511.18333v2)**
...
>
---
#### [replaced 005] ReSAM: Refine, Requery, and Reinforce: Self-Prompting Point-Supervised Segmentation for Remote Sensing Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21606v2](https://arxiv.org/pdf/2511.21606v2)**
...
>
---
#### [replaced 006] Perception-Inspired Color Space Design for Photo White Balance Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09383v2](https://arxiv.org/pdf/2512.09383v2)**

> **作者:** Yang Cheng; Ziteng Cui; Shenghan Su; Lin Gu; Zenghui Zhang
>
...
>
---
#### [replaced 007] MedReasoner: Reinforcement Learning Drives Reasoning Grounding from Clinical Thought to Pixel-Level Precision
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.08177v2](https://arxiv.org/pdf/2508.08177v2)**
...
>
---
#### [replaced 008] Fairness-Aware Fine-Tuning of Vision-Language Models for Medical Glaucoma Diagnosis
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.03477v2](https://arxiv.org/pdf/2512.03477v2)**
...
>
---
#### [replaced 009] Development and Testing for Perception Based Autonomous Landing of a Long-Range QuadPlane
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 010] EmoDiffTalk:Emotion-aware Diffusion for Editable 3D Gaussian Talking Head
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05991v2](https://arxiv.org/pdf/2512.05991v2)**
...
>
---
#### [replaced 011] Orbis: Overcoming Challenges of Long-Horizon Prediction in Driving World Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.13162v2](https://arxiv.org/pdf/2507.13162v2)**
...
>
---
#### [replaced 012] Enhancing Hand Palm Motion Gesture Recognition by Eliminating Reference Frame Bias via Frame-Invariant Similarity Measures
...
>
---
#### [replaced 013] AttenDence: Maximizing Attention Confidence for Test Time Adaptation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18925v2](https://arxiv.org/pdf/2511.18925v2)**
...
>
---
#### [replaced 014] Hierarchical Deep Learning for Diatom Image Classification: A Multi-Level Taxonomic Approach
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06613v2](https://arxiv.org/pdf/2512.06613v2)**

> **作者:** Yueying Ke
>
> **备注:** Version 2: Corrected reference details, improved architectural diagram, and enhanced writing for clarity and precision. Added a table illustrating the masking mechanism. No changes to experimental results or conclusions. 11 pages, 6 figures, 3 tables
>
...
>
---
#### [replaced 015] Counting with Confidence: Accurate Pest Monitoring in Water Traps
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.22438v2](https://arxiv.org/pdf/2506.22438v2)**

> **作者:** Xumin Gao; Mark Stevens; Grzegorz Cielniak
>
> **备注:** Accepted to AGRICONTROL 2025. \c{opyright} 2025 the authors. This work has been accepted to IFAC for publication under a Creative Commons Licence CC-BY-NC-ND. Published in IFAC-PapersOnLine, DOI: 10.1016/j.ifacol.2025.11.792
>
...
>
---
#### [replaced 016] Thinking Ahead: Foresight Intelligence in MLLMs and World Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.18735v2](https://arxiv.org/pdf/2511.18735v2)**

> **作者:** Zhantao Gong; Liaoyuan Fan; Qing Guo; Xun Xu; Xulei Yang; Shijie Li
>
> **备注:** 25 pages, 27 figures
>
...
>
---
#### [replaced 017] Learning Generalizable Shape Completion with SIM(3) Equivariance
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.26631v3](https://arxiv.org/pdf/2509.26631v3)**
...
>
---
#### [replaced 027] Optimization-Guided Diffusion for Interactive Scene Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.07661v2](https://arxiv.org/pdf/2512.07661v2)**
...
>
---
#### [replaced 028] dots.ocr: Multilingual Document Layout Parsing in a Single Vision-Language Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02498v2](https://arxiv.org/pdf/2512.02498v2)**
...
>
---
#### [replaced 029] Multi-Modal Graph Convolutional Network with Sinusoidal Encoding for Robust Human Action Segmentation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 030] CAPE: A CLIP-Aware Pointing Ensemble of Complementary Heatmap Cues for Embodied Reference Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.21888v4](https://arxiv.org/pdf/2507.21888v4)**
...
>
---
#### [replaced 031] Panoramic Out-of-Distribution Segmentation
...
>
---
#### [replaced 035] Looking Beyond Visible Cues: Implicit Video Question Answering via Dual-Clue Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.07811v2](https://arxiv.org/pdf/2506.07811v2)**

> **作者:** Tieyuan Chen; Huabin Liu; Yi Wang; Chaofan Gan; Mingxi Lyu; Ziran Qin; Shijie Li; Liquan Shen; Junhui Hou; Zheng Wang; Weiyao Lin
>
> **备注:** Preprint
>
...
>
---
#### [replaced 036] Rethinking Driving World Model as Synthetic Data Generator for Perception Tasks
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.19195v3](https://arxiv.org/pdf/2510.19195v3)**
...
>
---
#### [replaced 037] diffDemorph: Extending Reference-Free Demorphing to Unseen Faces
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.14527v4](https://arxiv.org/pdf/2505.14527v4)**
...
>
---
#### [replaced 038] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.17329v2](https://arxiv.org/pdf/2509.17329v2)**
...
>
---
#### [replaced 039] Video4Spatial: Towards Visuospatial Intelligence with Context-Guided Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.03040v2](https://arxiv.org/pdf/2512.03040v2)**

> **作者:** Zeqi Xiao; Yiwei Zhao; Lingxiao Li; Yushi Lan; Ning Yu; Rahul Garg; Roshni Cooper; Mohammad H. Taghavi; Xingang Pan
>
...
>
---
#### [replaced 047] Continuous Vision-Language-Action Co-Learning with Semantic-Physical Alignment for Behavioral Cloning
...
>
---
#### [replaced 048] Beyond Classification Accuracy: Neural-MedBench and the Need for Deeper Reasoning Benchmarks
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.22258v2](https://arxiv.org/pdf/2509.22258v2)**
...
>
---
#### [replaced 049] UltraCUA: A Foundation Model for Computer Use Agents with Hybrid Action
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 050] When Alignment Fails: Multimodal Adversarial Attacks on Vision-Language-Action Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.16203v3](https://arxiv.org/pdf/2511.16203v3)**
...
>
---
#### [replaced 051] Vision-centric Token Compression in Large Language Model
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 055] Geometric Regularity in Deterministic Sampling Dynamics of Diffusion-based Generative Models
- **分类: cs.LG; cond-mat.stat-mech; cs.CV; stat.ML**

- **链接: [https://arxiv.org/pdf/2506.10177v3](https://arxiv.org/pdf/2506.10177v3)**
...
>
---
#### [replaced 056] LoC-Path: Learning to Compress for Pathology Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05391v2](https://arxiv.org/pdf/2512.05391v2)**
...
>
---
#### [replaced 057] Thinking with Images via Self-Calling Agent
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08511v2](https://arxiv.org/pdf/2512.08511v2)**

> **作者:** Wenxi Yang; Yuzhong Zhao; Fang Wan; Qixiang Ye
>
> **备注:** Code is available at https://github.com/YWenxi/think-with-images-through-self-calling
>
...
>
---
#### [replaced 058] SplatCo: Structure-View Collaborative Gaussian Splatting for Detail-Preserving Rendering of Large-Scale Unbounded Scenes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.17951v4](https://arxiv.org/pdf/2505.17951v4)**
...
>
---
#### [replaced 059] SAVE: Sparse Autoencoder-Driven Visual Information Enhancement for Mitigating Object Hallucination
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.07730v2](https://arxiv.org/pdf/2512.07730v2)**
...
>
---
#### [replaced 060] HunyuanOCR Technical Report
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.19575v2](https://arxiv.org/pdf/2511.19575v2)**

> **作者:** Hunyuan Vision Team; Pengyuan Lyu; Xingyu Wan; Gengluo Li; Shangpin Peng; Weinong Wang; Liang Wu; Huawen Shen; Yu Zhou; Canhui Tang; Qi Yang; Qiming Peng; Bin Luo; Hower Yang; Xinsong Zhang; Jinnian Zhang; Houwen Peng; Hongming Yang; Senhao Xie; Longsha Zhou; Ge Pei; Binghong Wu; Rui Yan; Kan Wu; Jieneng Yang; Bochao Wang; Kai Liu; Jianchen Zhu; Jie Jiang; Linus; Han Hu; Chengquan Zhang
>
...
>
---
#### [replaced 061] Towards Open-World Human Action Segmentation Using Graph Convolutional Networks
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 062] Dressing the Imagination: A Dataset for AI-Powered Translation of Text into Fashion Outfits and A Novel NeRA Adapter for Enhanced Feature Adaptation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.13901v5](https://arxiv.org/pdf/2411.13901v5)**
...
>
---
#### [replaced 063] UniBiomed: A Universal Foundation Model for Grounded Biomedical Image Interpretation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.21336v3](https://arxiv.org/pdf/2504.21336v3)**
...
>
---
#### [replaced 064] AFRAgent : An Adaptive Feature Renormalization Based High Resolution Aware GUI agent
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00846v2](https://arxiv.org/pdf/2512.00846v2)**
...
>
---
#### [replaced 065] UnReflectAnything: RGB-Only Highlight Removal by Rendering Synthetic Specular Supervision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09583v2](https://arxiv.org/pdf/2512.09583v2)**
...
>
---
#### [replaced 066] SpatialScore: Towards Comprehensive Evaluation for Spatial Intelligence
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.17012v2](https://arxiv.org/pdf/2505.17012v2)**
...
>
---
#### [replaced 067] Less is More: Data-Efficient Adaptation for Controllable Text-to-Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.17844v2](https://arxiv.org/pdf/2511.17844v2)**
...
>
---
#### [replaced 068] GuideFlow: Constraint-Guided Flow Matching for Planning in End-to-End Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18729v2](https://arxiv.org/pdf/2511.18729v2)**
...
>
---
#### [replaced 069] Guiding What Not to Generate: Automated Negative Prompting for Text-Image Alignment
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.07702v2](https://arxiv.org/pdf/2512.07702v2)**
...
>
---
#### [replaced 070] Think Before You Drive: World Model-Inspired Multimodal Grounding for Autonomous Vehicles
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.03454v2](https://arxiv.org/pdf/2512.03454v2)**
...
>
---
#### [replaced 071] StateSpace-SSL: Linear-Time Self-supervised Learning for Plant Disease Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09492v2](https://arxiv.org/pdf/2512.09492v2)**
...
>
---
#### [replaced 074] Architecture Decoupling Is Not All You Need For Unified Multimodal Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22663v2](https://arxiv.org/pdf/2511.22663v2)**
...
>
---
#### [replaced 075] Towards Visual Re-Identification of Fish using Fine-Grained Classification for Electronic Monitoring in Fisheries
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08400v2](https://arxiv.org/pdf/2512.08400v2)**

> **作者:** Samitha Nuwan Thilakarathna; Ercan Avsar; Martin Mathias Nielsen; Malte Pedersen
>
> **备注:** The paper has been accepted for publication at Northern Lights Deep Learning (NLDL) Conference 2026
>
...
>
---
#### [replaced 076] Quantifying the Reliability of Predictions in Detection Transformers: Object-Level Calibration and Image-Level Uncertainty
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2412.01782v3](https://arxiv.org/pdf/2412.01782v3)**
...
>
---
#### [replaced 077] LeMiCa: Lexicographic Minimax Path Caching for Efficient Diffusion-Based Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.00090v3](https://arxiv.org/pdf/2511.00090v3)**
...
>
---
#### [replaced 078] Exploring Automated Recognition of Instructional Activity and Discourse from Multimodal Classroom Data
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00087v2](https://arxiv.org/pdf/2512.00087v2)**
...
>
---
#### [replaced 079] Beyond Words and Pixels: A Benchmark for Implicit World Knowledge Reasoning in Generative Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.18271v3](https://arxiv.org/pdf/2511.18271v3)**
...
>
---
#### [replaced 080] StereoWorld: Geometry-Aware Monocular-to-Stereo Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09363v2](https://arxiv.org/pdf/2512.09363v2)**
...
>
---
#### [replaced 081] ReViSE: Towards Reason-Informed Video Editing in Unified Models with Self-Reflective Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09924v2](https://arxiv.org/pdf/2512.09924v2)**
...
>
> **备注:** Project Page: [this https URL](https://github.com/Liuxinyv/ReViSE)
>
...
>
---
#### [replaced 082] AGORA: Adversarial Generation Of Real-time Animatable 3D Gaussian Head Avatars
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06438v2](https://arxiv.org/pdf/2512.06438v2)**
...
>
---
#### [replaced 083] Leveraging Depth and Language for Open-Vocabulary Domain-Generalized Semantic Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.09881v3](https://arxiv.org/pdf/2506.09881v3)**
...
>
---
#### [replaced 084] Deferred Poisoning: Making the Model More Vulnerable via Hessian Singularization
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [https://arxiv.org/pdf/2411.03752v3](https://arxiv.org/pdf/2411.03752v3)**

> **作者:** Yuhao He; Jinyu Tian; Xianwei Zheng; Li Dong; Yuanman Li; Jiantao Zhou
>
...
>
---
#### [replaced 085] RectifiedHR: High-Resolution Diffusion via Energy Profiling and Adaptive Guidance Scheduling
- **分类: cs.GR; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.09441v2](https://arxiv.org/pdf/2507.09441v2)**
...
>
---
#### [replaced 086] When Worse is Better: Navigating the compression-generation tradeoff in visual tokenization
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2412.16326v2](https://arxiv.org/pdf/2412.16326v2)**

> **作者:** Vivek Ramanujan; Kushal Tirumala; Armen Aghajanyan; Luke Zettlemoyer; Ali Farhadi
>
> **备注:** Spotlight at NeurIPS 2025
>
...
>
---
#### [replaced 087] FAST: Foreground-aware Diffusion with Accelerated Sampling Trajectory for Segmentation-oriented Anomaly Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.20295v4](https://arxiv.org/pdf/2509.20295v4)**
...
>
---
#### [replaced 088] It Hears, It Sees too: Multi-Modal LLM for Depression Detection By Integrating Visual Understanding into Audio Language Models
...
>
---
#### [replaced 089] Changes in Real Time: Online Scene Change Detection with Multi-View Fusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.12370v2](https://arxiv.org/pdf/2511.12370v2)**
...
>
---
#### [replaced 090] Glance: Accelerating Diffusion Models with 1 Sample
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02899v2](https://arxiv.org/pdf/2512.02899v2)**
