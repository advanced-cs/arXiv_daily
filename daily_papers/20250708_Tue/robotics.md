...
- **简介: 该论文属于纺织品分类与选择任务，解决机器人精准识别和排序织物的问题。通过多模态大语言模型和传感器融合，提升分类准确性和选择可靠性。**
...
>
---
#### [new 010] LERa: Replanning with Visual Feedback in Instruction Following
- **分类: cs.RO**
...
- **简介: 该论文属于状态估计任务，解决IEKF左右版本差异问题，证明二者在适当重置步骤下等价，提升导航系统性能。**
...
- **简介: 该论文属于机器人模仿学习任务，解决人类手部动作与机器人抓取器动作之间的观察差距问题。通过收集人类手部数据并生成机器人抓取演示，提升数据效率与实用性。**
...
- **简介: 该论文属于无人机轨迹预测任务，解决长时程3D轨迹预测问题。通过融合RGB与事件数据，提出无监督方法提升预测精度。**
...
- **简介: 该论文属于机器人操作任务，解决复杂环境中3D感知与动作生成问题。提出PRISM框架，直接处理点云和机器人状态，提升模仿学习的鲁棒性与效率。**
...
- **链接: [http://arxiv.org/pdf/2507.04443v1](http://arxiv.org/pdf/2507.04443v1)**
...
- **简介: 该论文属于室内导航任务，旨在比较学习方法与传统方法的适用性。通过模仿学习训练导航策略，并与传统方法对比，验证其在复杂环境中的可行性。**
...
- **简介: 该论文属于激光雷达-惯性里程计任务，解决高振动下LiDAR扫描失真问题，通过建模点云不确定性提升定位精度。**
...
- **链接: [http://arxiv.org/pdf/2507.03227v1](http://arxiv.org/pdf/2507.03227v1)**
...
- **简介: 该论文属于机器人操作任务，旨在解决长时域操作中扩散策略性能下降的问题。通过结合视觉语言模型和轨迹条件扩散策略，提升鲁棒性和成功率。**
...
- **简介: 该论文属于机器人控制任务，旨在解决四足机器人携带机械臂时的运动与操作难题。通过将运动学模型融入强化学习，提升控制策略的效率与稳定性。**
...
> **作者:** Alexander Estornell; Leonard Jung; Michael Everett
>
...
- **简介: 该论文属于机器人运动控制任务，旨在提升人形机器人平衡性。通过多智能体强化学习，协调四肢运动以减少角动量，增强行走稳定性。**
...
- **简介: 该论文属于机器人机构设计任务，旨在解决三维肌腱驱动结构中线缆交叉问题。通过多目标优化方法，设计无交叉且能提供足够扭矩的线缆布局。**
...
- **简介: 该论文属于机器人长期学习与任务适应任务，解决灾难性遗忘和任务迁移问题。提出DRAE架构，结合MoE、RAG和强化学习，提升任务成功率和知识复用。**
...
- **简介: 该论文属于自主导航任务，解决未知环境中因视野受限导致的障碍物碰撞问题。提出VA-MPPI框架，通过隐式双控制平衡探索与利用，提升安全性和路径规划效果。**
...
- **简介: 该论文属于机器人优化任务，解决复杂运动规划与控制问题。提出TTTS方法，结合蒙特卡洛树搜索与张量分解，提升计算效率与存储性能。**
...
- **简介: 该论文属于农业机器人任务，旨在解决 vineyard 疾病管理问题。通过比较人类操作员与VR控制机器人在扫描和治疗阶段的表现，评估VR接口的有效性。**
...
- **简介: 该论文属于控制与深度学习交叉任务，解决神经控制器在嵌入式系统中因权重过多导致的内存和实时性问题。通过分析二阶剪枝对控制性能的影响，提供闭环稳定性保障。**
...
>
---
#### [new 064] Learning Robust Stereo Matching in the Wild with Selective Mixture-of-Experts
...
>
---
#### [new 072] Beyond One Shot, Beyond One Perspective: Cross-View and Long-Horizon Distillation for Better LiDAR Representations
...
>
---
#### [new 073] A Simulator Dataset to Support the Study of Impaired Driving
- **分类: cs.CV; cs.LG; cs.RO**
...
>
---
#### [new 074] Query-Based Adaptive Aggregation for Multi-Dataset Joint Training Toward Universal Visual Place Recognition
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 075] VISC: mmWave Radar Scene Flow Estimation using Pervasive Visual-Inertial Supervision
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 079] U-ViLAR: Uncertainty-Aware Visual Localization for Autonomous Driving via Differentiable Association and Registration
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 080] Grounded Gesture Generation: Language, Motion, and Space
...
>
---
#### [new 083] From Marginal to Joint Predictions: Evaluating Scene-Consistent Trajectory Prediction Approaches for Automated Driving
...
>
---
#### [new 084] DreamVLA: A Vision-Language-Action Model Dreamed with Comprehensive World Knowledge
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 085] DriveMRP: Enhancing Vision-Language Models with Synthetic Motion Data for Motion Risk Prediction
...
>
---
#### [new 086] Thousand-Brains Systems: Sensorimotor Intelligence for Rapid, Robust Learning and Inference
...
>
---
#### [new 087] SAFERad: A Framework to Enable Radar Data for Safety-Relevant Perception Tasks
- **分类: eess.SP; cs.RO**
...
#### [replaced 001] TeachingBot: Robot Teacher for Human Handwriting
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2309.11848v2](http://arxiv.org/pdf/2309.11848v2)**

> **作者:** Zhimin Hou; Cunjun Yu; David Hsu; Haoyong Yu
>
...
>
---
#### [replaced 002] Gesture-Controlled Aerial Robot Formation for Human-Swarm Interaction in Safety Monitoring Applications
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2403.15333v3](http://arxiv.org/pdf/2403.15333v3)**
...
>
---
#### [replaced 003] Human2LocoMan: Learning Versatile Quadrupedal Manipulation with Human Pretraining
- **分类: cs.RO; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.16475v2](http://arxiv.org/pdf/2506.16475v2)**
...
>
---
#### [replaced 007] Event-based Stereo Depth Estimation: A Survey
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 010] RoboBrain 2.0 Technical Report
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2507.02029v2](http://arxiv.org/pdf/2507.02029v2)**
...
>
---
#### [replaced 013] One Demo Is All It Takes: Planning Domain Derivation with LLMs from A Single Demonstration
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2505.18382v2](http://arxiv.org/pdf/2505.18382v2)**
...
>
---
#### [replaced 014] Deep Transformer Network for Monocular Pose Estimation of Shipborne Unmanned Aerial Vehicle
...
>
---
#### [replaced 015] CoInfra: A Large-Scale Cooperative Infrastructure Perception System and Dataset in Adverse Weather
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2507.02245v2](http://arxiv.org/pdf/2507.02245v2)**
...
>
---
#### [replaced 016] Learning Maximal Safe Sets Using Hypernetworks for MPC-based Local Trajectory Planning in Unknown Environments
- **分类: cs.RO; cs.LG; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2410.20267v3](http://arxiv.org/pdf/2410.20267v3)**
...
>
---
#### [replaced 017] PIMBS: Efficient Body Schema Learning for Musculoskeletal Humanoids with Physics-Informed Neural Networks
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2506.20343v2](http://arxiv.org/pdf/2506.20343v2)**
...
>
---
#### [replaced 018] Towards Universal Shared Control in Teleoperation Without Haptic Feedback
- **分类: cs.RO; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2506.23624v2](http://arxiv.org/pdf/2506.23624v2)**
...
>
---
#### [replaced 019] Making Physical Objects with Generative AI and Robotic Assembly: Considering Fabrication Constraints, Sustainability, Time, Functionality, and Accessibility
- **分类: cs.RO; cs.HC**

- **链接: [http://arxiv.org/pdf/2504.19131v2](http://arxiv.org/pdf/2504.19131v2)**

> **作者:** Alexander Htet Kyaw; Se Hwan Jeon; Miana Smith; Neil Gershenfeld
>
> **备注:** Presented at the CHI 2025 Workshop on Generative AI and HCI
>
...
>
---
#### [replaced 020] NOVA: Navigation via Object-Centric Visual Autonomy for High-Speed Target Tracking in Unstructured GPS-Denied Environments
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.18689v2](http://arxiv.org/pdf/2506.18689v2)**
...
>
---
#### [replaced 025] ParticleFormer: A 3D Point Cloud World Model for Multi-Object, Multi-Material Robotic Manipulation
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2506.23126v3](http://arxiv.org/pdf/2506.23126v3)**
...
>
---
#### [replaced 026] Occlusion-Aware Consistent Model Predictive Control for Robot Navigation in Occluded Obstacle-Dense Environments
- **分类: cs.RO; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2503.04563v2](http://arxiv.org/pdf/2503.04563v2)**

> **作者:** Minzhe Zheng; Lei Zheng; Jun Ma
>
...
>
---
#### [replaced 027] cHyRRT and cHySST: Two Motion Planning Tools for Hybrid Dynamical Systems
- **分类: cs.RO; I.2.9**

- **链接: [http://arxiv.org/pdf/2411.11812v3](http://arxiv.org/pdf/2411.11812v3)**
...
>
---
#### [replaced 029] RoboMonkey: Scaling Test-Time Sampling and Verification for Vision-Language-Action Models
- **分类: cs.RO; cs.AI; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2506.17811v2](http://arxiv.org/pdf/2506.17811v2)**
...
>
---
#### [replaced 030] Boundary Exploration of Next Best View Policy in 3D Robotic Scanning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 033] Robotic Manipulation by Imitating Generated Videos Without Physical Demonstrations
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 034] MMD-OPT : Maximum Mean Discrepancy Based Sample Efficient Collision Risk Minimization for Autonomous Driving
- **分类: cs.LG; cs.RO**

- **链接: [http://arxiv.org/pdf/2412.09121v2](http://arxiv.org/pdf/2412.09121v2)**
...
>
---
#### [replaced 037] End-to-end 2D-3D Registration between Image and LiDAR Point Cloud for Vehicle Localization
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 038] EndoFlow-SLAM: Real-Time Endoscopic SLAM with Flow-Constrained Gaussian Splatting
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 039] Optimizing Start Locations in Ergodic Search for Disaster Response
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2507.02708v2](http://arxiv.org/pdf/2507.02708v2)**
...
>
---
#### [replaced 040] A Convex Formulation of Material Points and Rigid Bodies with GPU-Accelerated Async-Coupling for Interactive Simulation
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2503.05046v2](http://arxiv.org/pdf/2503.05046v2)**
...
>
---
#### [replaced 041] SEAL: Vision-Language Model-Based Safe End-to-End Cooperative Autonomous Driving with Adaptive Long-Tail Modeling
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 042] AC-DiT: Adaptive Coordination Diffusion Transformer for Mobile Manipulation
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.01961v3](http://arxiv.org/pdf/2507.01961v3)**
