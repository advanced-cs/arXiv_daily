...
#### [new 001] HoWToBench: Holistic Evaluation for LLM's Capability in Human-level Writing using Tree of Writing
- **分类: cs.CL**

- **简介: 该论文属于自然语言生成任务，旨在解决LLM写作能力评估不准确的问题。提出Tree-of-Writing方法和HowToBench基准，提升评估的可靠性和鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.19071](https://arxiv.org/pdf/2604.19071)**
...
>
---
#### [new 013] LePREC: Reasoning as Classification over Structured Factors for Assessing Relevance of Legal Issues
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于法律问题相关性评估任务，旨在解决LLMs在识别法律问题时精度不足的问题。通过构建数据集并提出LePREC框架，结合神经生成与符号推理，提升分类准确性和可解释性。**

- **链接: [https://arxiv.org/pdf/2604.19464](https://arxiv.org/pdf/2604.19464)**
...
>
---
#### [new 017] Where Fake Citations Are Made: Tracing Field-Level Hallucination to Specific Neurons in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 论文研究LLM生成虚假引用的问题，属于自然语言处理中的可信度与事实性任务。通过分析大量引用数据，发现作者名错误最常见，并识别出特定神经元用于检测和减少幻觉。**

- **链接: [https://arxiv.org/pdf/2604.18880](https://arxiv.org/pdf/2604.18880)**

> **作者:** Yuefei Chen; Yihao Quan; Xiaodong Lin; Ruixiang Tang
>
> **摘要:** LLMs frequently generate fictitious yet convincing citations, often expressing high confidence even when the underlying reference is wrong. We study this failure across 9 models and 108{,}000 generated references, and find that author names fail far more often than other fields across all models and settings. Citation style has no measurable effect, while reasoning-oriented distillation degrades recall. Probes trained on one field transfer at near-chance levels to the others, suggesting that hallucination signals do not generalize across fields. Building on this finding, we apply elastic-net regularization with stability selection to neuron-level CETT values of Qwen2.5-32B-Instruct and identify a sparse set of field-specific hallucination neurons (FH-neurons). Causal intervention further confirms their role: amplifying these neurons increases hallucination, while suppressing them improves performance across fields, with larger gains in some fields. These results suggest a lightweight approach to detecting and mitigating citation hallucination using internal model signals alone.
>
---
#### [new 018] SAHM: A Benchmark for Arabic Financial and Shari'ah-Compliant Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出SAHM，一个阿拉伯语金融和伊斯兰教法合规推理的基准数据集，解决阿拉伯语金融NLP研究不足的问题。工作包括构建多任务数据集并评估大模型表现。**

- **链接: [https://arxiv.org/pdf/2604.19098](https://arxiv.org/pdf/2604.19098)**
...
>
---
#### [new 019] $R^2$-dLLM: Accelerating Diffusion Large Language Models via Spatio-Temporal Redundancy Reduction
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言生成任务，解决dLLM推理延迟高的问题。通过减少时空冗余，提出R²-dLLM框架，显著降低解码步骤并提升效率。**

- **链接: [https://arxiv.org/pdf/2604.18995](https://arxiv.org/pdf/2604.18995)**
...
>
---
#### [new 020] Can Continual Pre-training Bridge the Performance Gap between General-purpose and Specialized Language Models in the Medical Domain?
- **分类: cs.CL**

- **简介: 该论文属于医疗领域语言模型研究，旨在缩小通用与专用模型的性能差距。通过持续预训练和模型融合，提升小模型在德语医学任务中的表现。**

- **链接: [https://arxiv.org/pdf/2604.19394](https://arxiv.org/pdf/2604.19394)**
...
>
---
#### [new 030] Headlines You Won't Forget: Can Pronoun Insertion Increase Memorability?
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，研究 pronoun insertion 对新闻标题记忆效果的影响，并探索 LLM 自动插入的可行性。**

- **链接: [https://arxiv.org/pdf/2604.19189](https://arxiv.org/pdf/2604.19189)**
...
>
---
#### [new 035] A Self-Evolving Framework for Efficient Terminal Agents via Observational Context Compression
- **分类: cs.CL**

- **简介: 该论文提出TACO框架，解决终端代理任务中因保留大量环境反馈导致的冗余和高token成本问题。通过自适应压缩提升性能并减少开销。**
...
>
---
#### [new 039] RARE: Redundancy-Aware Retrieval Evaluation Framework for High-Similarity Corpora
- **分类: cs.CL; cs.AI; cs.IR**

- **简介: 该论文属于信息检索任务，旨在解决现有评估框架不适应高冗余文档的问题。提出RARE框架，通过分解文档和优化数据生成，提升真实场景下的评估准确性。**

- **链接: [https://arxiv.org/pdf/2604.19047](https://arxiv.org/pdf/2604.19047)**
...
>
---
#### [new 042] Lost in Translation: Do LVLM Judges Generalize Across Languages?
- **分类: cs.CL**

- **简介: 该论文属于多语言评估任务，旨在解决LVLM评判模型跨语言泛化问题。通过构建MM-JudgeBench基准，分析22个LVLM在多语言场景下的表现。**

- **链接: [https://arxiv.org/pdf/2604.19405](https://arxiv.org/pdf/2604.19405)**
...
>
---
#### [new 047] Investigating Counterfactual Unfairness in LLMs towards Identities through Humor
- **分类: cs.CL**

- **简介: 该论文研究语言模型在幽默处理中的反事实不公平性，旨在揭示模型对不同身份的偏见。通过分析身份交换下的反应差异，评估模型的公平性问题。**

- **链接: [https://arxiv.org/pdf/2604.18729](https://arxiv.org/pdf/2604.18729)**
...
>
---
#### [new 049] Construction of Knowledge Graph based on Language Model
- **分类: cs.CL**

- **简介: 本文研究基于语言模型的知识图谱构建任务，旨在解决传统方法耗时且深度学习方法泛化能力弱的问题。论文提出一种轻量级框架LLHKG，提升知识图谱构建效果。**

- **链接: [https://arxiv.org/pdf/2604.19137](https://arxiv.org/pdf/2604.19137)**
...
>
---
#### [new 053] Taming Actor-Observer Asymmetry in Agents via Dialectical Alignment
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文属于人工智能领域，解决多智能体系统中的认知偏差问题。针对Actor-Observer Asymmetry，提出ReTAS方法以实现视角一致的推理。**

- **链接: [https://arxiv.org/pdf/2604.19548](https://arxiv.org/pdf/2604.19548)**
...
>
---
#### [new 054] CulturALL: Benchmarking Multilingual and Multicultural Competence of LLMs on Grounded Tasks
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出CulturALL基准，用于评估大语言模型在真实场景下的多语言和跨文化能力。针对现有基准不足，解决 grounded 任务评价缺失的问题，构建了多语言、多区域的挑战性数据集。**

- **链接: [https://arxiv.org/pdf/2604.19262](https://arxiv.org/pdf/2604.19262)**
...
>
---
#### [new 059] Location Not Found: Exposing Implicit Local and Global Biases in Multilingual LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在检测多语言大模型中的隐式本地与全球偏差。通过构建LocQA数据集，评估模型在无明确地域提示下的回答倾向，揭示其潜在偏见。**

- **链接: [https://arxiv.org/pdf/2604.19292](https://arxiv.org/pdf/2604.19292)**
...
>
---
#### [new 062] RoLegalGEC: Legal Domain Grammatical Error Detection and Correction Dataset for Romanian
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出RoLegalGEC数据集，用于罗马尼亚语法律文本的语法错误检测与修正。针对法律领域数据稀缺问题，构建了35万条带标注的错误样本，并评估多种模型以提升准确性。**
...
>
---
#### [new 063] Detecting Hallucinations in SpeechLLMs at Inference Time Using Attention Maps
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于语音大模型 hallucination 检测任务，旨在解决推理时 hallucination 识别问题。通过分析注意力图，提出四个指标并训练分类器进行有效检测。**

- **链接: [https://arxiv.org/pdf/2604.19565](https://arxiv.org/pdf/2604.19565)**
...
>
---
#### [new 073] MORPHOGEN: A Multilingual Benchmark for Evaluating Gender-Aware Morphological Generation
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出MORPHOGEN，用于评估多语言模型在性别感知形态生成中的表现。针对语法性别影响形态变化的问题，构建了多语言基准数据集，并测试了15个模型的性别转换能力。**

- **链接: [https://arxiv.org/pdf/2604.18914](https://arxiv.org/pdf/2604.18914)**
...
>
---
#### [new 074] Syntax as a Rosetta Stone: Universal Dependencies for In-Context Coptic Translation
- **分类: cs.CL**
...
>
---
#### [new 075] Rethinking Scale: Deployment Trade-offs of Small Language Models under Agent Paradigms
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决小语言模型部署效率问题。通过对比基础模型、单智能体和多智能体系统，探索 agent 范式下的性能与成本平衡。**

- **链接: [https://arxiv.org/pdf/2604.19299](https://arxiv.org/pdf/2604.19299)**
...
>
---
#### [new 076] Chat2Workflow: A Benchmark for Generating Executable Visual Workflows with Natural Language
- **分类: cs.CL; cs.AI; cs.CV; cs.LG; cs.MA**

- **简介: 该论文提出Chat2Workflow，用于将自然语言转换为可执行的可视化工作流，解决工业自动化中手动构建流程耗时易错的问题。**
...
>
---
#### [new 083] Superficial Success vs. Internal Breakdown: An Empirical Study of Generalization in Adaptive Multi-Agent Systems
- **分类: cs.MA; cs.CL**

- **简介: 该论文研究自适应多智能体系统（MAS）的泛化能力，揭示其在不同领域表现不佳及表面协调下的内部失效问题，旨在提升MAS的通用性与可靠性。**
...
>
---
#### [new 087] Unlocking the Edge deployment and ondevice acceleration of multi-LoRA enabled one-for-all foundational LLM
- **分类: cs.DC; cs.AI; cs.CL**

- **简介: 该论文研究在移动端部署多任务大语言模型，解决内存、延迟和灵活性问题。通过LoRA融合、多流解码和动态预测技术，实现高效推理。**

- **链接: [https://arxiv.org/pdf/2604.18655](https://arxiv.org/pdf/2604.18655)**
...
>
---
#### [new 089] Reducing the Offline-Streaming Gap for Unified ASR Transducer with Consistency Regularization
...
>
---
#### [new 090] Harmful Intent as a Geometrically Recoverable Feature of LLM Residual Streams
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于模型安全任务，研究如何从语言模型的残差流中恢复有害意图。通过多种方法验证了有害意图具有可几何恢复的特征，并探讨了其在不同模型和对齐变体中的稳定性。**
...
>
---
#### [new 091] Who Shapes Brazil's Vaccine Debate? Semi-Supervised Modeling of Stance and Polarization in YouTube's Media Ecosystem
- **分类: cs.CY; cs.AI; cs.CL; cs.LG; cs.SI**

- **简介: 该论文属于社交媒体立场分析任务，旨在解决疫苗争议中舆论极化问题。通过半监督学习分析YouTube上140万条评论，研究巴西疫苗讨论的演变与传播。**

- **链接: [https://arxiv.org/pdf/2604.18586](https://arxiv.org/pdf/2604.18586)**
...
>
---
#### [new 092] Beyond Semantic Similarity: A Component-Wise Evaluation Framework for Medical Question Answering Systems with Health Equity Implications
- **分类: cs.HC; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于医疗问答系统评估任务，旨在解决现有评价方法仅关注语义相似性而忽视医学准确性与健康公平性的问题。作者提出VB-Score框架，从四个维度评估模型性能。**

- **链接: [https://arxiv.org/pdf/2604.19281](https://arxiv.org/pdf/2604.19281)**
...
>
---
#### [new 093] SafetyALFRED: Evaluating Safety-Conscious Planning of Multimodal Large Language Models
...
>
---
#### [new 094] Owner-Harm: A Missing Threat Model for AI Agent Safety
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于AI安全领域，解决代理对部署者造成危害的威胁模型缺失问题。提出Owner-Harm威胁模型，分析并验证防御方法的有效性。**

- **链接: [https://arxiv.org/pdf/2604.18658](https://arxiv.org/pdf/2604.18658)**
...
>
---
#### [new 096] Do LLMs Game Formalization? Evaluating Faithfulness in Logical Reasoning
- **分类: cs.AI; cs.CL; cs.LO**

- **简介: 论文研究LLM在形式化推理中的忠实性问题，评估其是否通过“形式化游戏”绕过验证。任务为逻辑推理，解决模型生成证明时的不忠实行为，通过对比统一生成与分阶段方法分析问题。**

- **链接: [https://arxiv.org/pdf/2604.19459](https://arxiv.org/pdf/2604.19459)**
...
>
---
#### [new 098] Human-Guided Harm Recovery for Computer Use Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于智能代理安全任务，解决有害行为发生后的恢复问题。通过用户研究和奖励模型，提升代理从有害状态恢复的能力。**
...
>
---
#### [new 099] Comparison of sEMG Encoding Accuracy Across Speech Modes Using Articulatory and Phoneme Features
- **分类: cs.SD; cs.CL**
...
>
---
#### [new 102] Deep Supervised Contrastive Learning of Pitch Contours for Robust Pitch Accent Classification in Seoul Korean
- **分类: cs.SD; cs.CL**
...
#### [replaced 001] Once Correct, Still Wrong: Counterfactual Hallucination in Multilingual Vision-Language Models
- **分类: cs.CL**

- **简介: 该论文属于视觉语言模型研究，旨在解决多语言环境下模型对反事实陈述的幻觉问题。通过构建多模态基准M$^2$CQA，提出CFHR指标评估模型在正确回答真实问题时对错误陈述的接受程度。**

- **链接: [https://arxiv.org/pdf/2602.05437](https://arxiv.org/pdf/2602.05437)**
...
>
---
#### [replaced 002] Temporal Leakage in Search-Engine Date-Filtered Web Retrieval: A Retrospective Forecasting Case Study
- **分类: cs.CL; cs.IR**

- **简介: 该论文属于信息检索任务，研究搜索引擎日期过滤的时效性问题。指出日期过滤存在数据泄露，影响预测准确性，建议使用时间快照进行评估。**

- **链接: [https://arxiv.org/pdf/2602.00758](https://arxiv.org/pdf/2602.00758)**

> **作者:** Ali El Lahib; Ying-Jieh Xia; Zehan Li; Yuxuan Wang; Xinyu Pi
>
> **备注:** 9 pages, 2 figures. Accepted to ACL 2026
>
...
>
---
#### [replaced 003] Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究自蒸馏对大语言模型推理能力的影响，发现其可能因抑制不确定性表达而降低性能。任务为模型优化，解决自蒸馏效果不稳定问题，通过实验验证条件信息对推理的影响。**
...
>
---
#### [replaced 004] FaithLens: Detecting and Explaining Faithfulness Hallucination
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的可信度检测任务，旨在解决大模型输出中的“忠实性幻觉”问题。作者提出FaithLens模型，通过联合预测与解释提升模型可信度。**
...
>
---
#### [replaced 005] Cross-Family Speculative Decoding for Polish Language Models on Apple~Silicon: An Empirical Evaluation of Bielik~11B with UAG-Extended MLX-LM
- **分类: cs.CL**

- **简介: 该论文属于语言模型加速任务，解决跨家族模型在Apple Silicon上的推理效率问题，通过扩展MLX-LM框架实现跨分词器的推测解码，并进行实证评估。**
...
>
---
#### [replaced 006] When Does Verification Pay Off? A Closer Look at LLMs as Solution Verifiers
- **分类: cs.CL**

- **简介: 该论文研究LLM作为验证器在solver-verifier系统中的效果，分析验证何时有效。任务是评估验证性能的影响因素，通过实验发现跨模型族验证更有效，且数学逻辑任务受益更大。**

- **链接: [https://arxiv.org/pdf/2512.02304](https://arxiv.org/pdf/2512.02304)**

> **作者:** Jack Lu; Ryan Teehan; Jinran Jin; Mengye Ren
>
> **备注:** Accepted at ICLR 2026 AI with Recursive Self-Improvement workshop
>
...
>
---
#### [replaced 007] Multi-Persona Thinking for Bias Mitigation in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的偏见缓解任务，旨在减少大语言模型的社会偏见。通过引入多角色思维框架，从不同视角进行推理以降低偏见，同时保持模型的推理能力。**
...
>
---
#### [replaced 008] VIGIL: An Extensible System for Real-Time Detection and Mitigation of Cognitive Bias Triggers
- **分类: cs.CL; cs.CY; cs.HC**

- **简介: 该论文提出VIGIL系统，用于实时检测和缓解在线信息中的认知偏见触发器。属于信息真实性与舆论安全任务，解决偏见引发的误导问题，通过浏览器扩展实现检测、重写与隐私保护。**
...
>
---
#### [replaced 009] Beyond Marginal Distributions: A Framework to Evaluate the Representativeness of Demographic-Aligned LLMs
- **分类: cs.CL**

- **简介: 该论文属于模型评估任务，旨在解决如何更全面地评估对齐语言模型的代表性问题。工作包括提出一种基于多变量相关性的评估框架，并对比两种对齐技术的效果。**

- **链接: [https://arxiv.org/pdf/2601.15755](https://arxiv.org/pdf/2601.15755)**
...
>
---
#### [replaced 010] On the Emergence of Syntax by Means of Local Interaction
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究神经网络能否通过局部交互自发产生语法处理能力。任务是验证语法结构是否能从简单系统中自组织出现，通过训练一个二维神经细胞自动机，发现其能生成类似CKY的结构，满足语法处理的三个标准。**
...
>
---
#### [replaced 011] EviSearch: A Human in the Loop System for Extracting and Auditing Clinical Evidence for Systematic Reviews
- **分类: cs.CL**
...
>
---
#### [replaced 012] No One Fits All: From Fixed Prompting to Learned Routing in Multilingual LLMs
- **分类: cs.CL**

- **简介: 该论文研究多语言大模型中的提示策略选择问题。针对不同语言和任务，提出基于学习的决策方法，提升提示效果。**

- **链接: [https://arxiv.org/pdf/2604.16937](https://arxiv.org/pdf/2604.16937)**

> **作者:** Wei-Chi Wu; Sheng-Lun Wei; Hen-Hsen Huang; Hsin-Hsi Chen
>
> **备注:** Accepted as a short findings paper at ACL 2026
>
...
>
---
#### [replaced 013] ConFu: Contemplate the Future for Better Speculative Sampling
- **分类: cs.CL; cs.LG**
...
>
> **备注:** v3: Added stress test with long drafts (DL=12, top-k=1) and tail-acceptance (survival) analysis. Earlier versions added Qwen3-4B results and ablations
>
...
>
---
#### [replaced 014] Stable-RAG: Mitigating Retrieval-Permutation-Induced Hallucinations in Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的问答任务，旨在解决RAG模型在文档排列变化下产生的幻觉问题。通过稳定生成策略提升答案一致性与准确性。**

- **链接: [https://arxiv.org/pdf/2601.02993](https://arxiv.org/pdf/2601.02993)**
...
>
---
#### [replaced 015] Computational Narrative Understanding for Expressive Text-to-Speech
...
>
---
#### [replaced 016] JumpLoRA: Sparse Adapters for Continual Learning in Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于持续学习任务，旨在解决大语言模型中的灾难性遗忘问题。提出JumpLoRA方法，通过引入稀疏性机制提升模型性能。**
...
>
---
#### [replaced 017] From Verbatim to Gist: Distilling Pyramidal Multimodal Memory via Semantic Information Bottleneck for Long-Horizon Video Agents
- **分类: cs.CV; cs.AI; cs.CL; cs.IR; cs.MM**

- **简介: 该论文属于视频理解任务，旨在解决长时视频分析中记忆机制不足的问题。提出MM-Mem架构，通过语义信息瓶颈优化记忆压缩与信息保留，提升长期视频代理的推理能力。**
...
>
---
#### [replaced 018] NameBERT: Scaling Name-Based Nationality Classification with LLM-Augmented Open Academic Data
- **分类: cs.CL**

- **简介: 论文提出NameBERT，解决名称到国籍分类任务，针对现有模型数据量小、覆盖不足的问题，利用LLM增强数据集，提升分类准确性与效率。**
...
>
---
#### [replaced 019] Temp-R1: A Unified Autonomous Agent for Complex Temporal KGQA via Reverse Curriculum Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于时间知识图谱问答任务，解决动态事实推理与复杂时间约束问题。提出Temp-R1模型，通过强化学习实现端到端自主问答，提升复杂问题的解答性能。**

- **链接: [https://arxiv.org/pdf/2601.18296](https://arxiv.org/pdf/2601.18296)**
...
>
---
#### [replaced 020] Ontology-Constrained Neural Reasoning in Enterprise Agentic Systems: A Neurosymbolic Architecture for Domain-Grounded AI Agents
...
>
---
#### [replaced 021] OmniGen2: Towards Instruction-Aligned Multimodal Generation
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文提出OmniGen2，解决多模态生成任务中的对齐问题，通过双解码路径和专用数据集，提升文本与图像生成的一致性。**

- **链接: [https://arxiv.org/pdf/2506.18871](https://arxiv.org/pdf/2506.18871)**
...
>
---
#### [replaced 022] VLM-3R: Vision-Language Models Augmented with Instruction-Aligned 3D Reconstruction
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出VLM-3R，解决2D模型在3D场景理解上的不足，通过单目视频和3D重建指令微调，实现空间与时间推理。**
...
>
---
#### [replaced 025] SAGE-32B: Agentic Reasoning via Iterative Distillation
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出SAGE-32B，用于解决 agentic reasoning 和长程规划问题。通过迭代蒸馏和逆向推理提升任务分解与工具使用能力。**

- **链接: [https://arxiv.org/pdf/2601.04237](https://arxiv.org/pdf/2601.04237)**
...
>
---
#### [replaced 026] A Triadic Suffix Tokenization Scheme for Numerical Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出一种三元后缀分词方法，解决数字分词不一致导致的数值推理错误问题。通过固定分组和标记，提升模型对数量级的感知能力。**

- **链接: [https://arxiv.org/pdf/2604.11582](https://arxiv.org/pdf/2604.11582)**

> **作者:** Olga Chetverina
>
> **备注:** v3: Updated to include analysis of N=1 scalability for SLM architectures
>
...
>
---
#### [replaced 027] Large Language Models Are Bad Dice Players: LLMs Struggle to Generate Random Numbers from Statistical Distributions
- **分类: cs.CL**

- **简介: 该论文研究LLMs生成随机数的能力，属于概率采样任务。指出LLMs在统计分布采样上存在严重问题，需依赖外部工具。**
...
>
---
#### [replaced 028] CounterRefine: Answer-Conditioned Counterevidence Retrieval for Inference-Time Knowledge Repair in Factual Question Answering
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于事实问答任务，解决系统正确答案选择问题。提出CounterRefine方法，在推理时通过证据验证和修正答案，提升准确率。**
...
>
---
#### [replaced 029] How to Fine-Tune a Reasoning Model? A Teacher-Student Cooperation Framework to Synthesize Student-Consistent SFT Data
- **分类: cs.CL**

- **简介: 该论文属于模型微调任务，解决合成数据导致推理模型性能下降的问题。提出TESSY框架，通过师生协作生成风格一致的合成数据，提升微调效果。**
...
>
---
#### [replaced 030] Persuasion with Large Language Models: A Survey of Empirical Evidence, Study Methodologies, and Ethical Implications
- **分类: cs.CL**

- **简介: 本文综述基于大语言模型的说服技术，分析其效果、方法及伦理问题，旨在揭示其影响并提出监管建议。**

- **链接: [https://arxiv.org/pdf/2411.06837](https://arxiv.org/pdf/2411.06837)**

> **作者:** Sander Noels; Alexander Rogiers; Maarten Buyl; Tijl De Bie
>
> **备注:** Main changes: - Slightly altered title & author ordering - New section detailing survey methodology - Expanded literature coverage and improved discussion of all references for clarity, precision & conciseness - Removed the "appealing to authority" subsection & integrated its content elsewhere - Overhauled the experimental design section - Significantly expanded success metrics discussion
>
...
>
---
#### [replaced 031] Xpertbench: Expert Level Tasks with Rubrics-Based Evaluation
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出XpertBench，用于评估大语言模型在专业领域任务中的表现，解决现有评估框架的不足。通过专家制定的任务和评分标准，提升评估的准确性和专业性。**

- **链接: [https://arxiv.org/pdf/2604.02368](https://arxiv.org/pdf/2604.02368)**

> **作者:** Xue Liu; Xin Ma; Yuxin Ma; Yongchang Peng; Duo Wang; Zhoufutu Wen; Ge Zhang; Kaiyuan Zhang; Xinyu Chen; Yida Ding; Tianci He; Jiani Hou; Liang Hu; Ziyun Huang; Yongzhe Hui; Jianpeng Jiao; Chennan Ju; Yingru Kong; Yiran Li; Jiashuo Liu; Mengyun Liu; Luyao Ma; Fei Ni; Yiqing Ni; Pengbo Niu; Yueyan Qiu; Yanle Ren; Xinyu Shen; Zilin Shi; Zaiyuan Wang; Wenjie Yue; Chun Zhang; Shiyu Zhang; Xinyi Zhang; Kaiwen Zhao; Zhenwei Zhu; Shanshan Wu; Qi Zhao; Wenhao Huang
>
...
>
---
#### [replaced 032] Cat-DPO: Category-Adaptive Safety Alignment
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型安全对齐任务，解决模型在应对合法请求与拒绝有害内容间的平衡问题。提出Cat-DPO算法，为每类危害设置自适应安全边界，提升模型安全性与帮助性。**
...
>
---
#### [replaced 033] Capturing Classic Authorial Style in Long-Form Story Generation with GRPO Fine-Tuning
- **分类: cs.CL**

- **简介: 该论文属于长文本生成任务，旨在解决作者风格可控生成的问题。通过两阶段方法，训练风格判别器并用于GRPO优化，提升模型风格一致性。**

- **链接: [https://arxiv.org/pdf/2512.05747](https://arxiv.org/pdf/2512.05747)**
...
>
---
#### [replaced 036] Multi-Task Reinforcement Learning for Enhanced Multimodal LLM-as-a-Judge
- **分类: cs.CL**

- **简介: 该论文属于多任务强化学习领域，旨在解决MLLM作为评判者在多任务场景下泛化能力不足的问题。通过MT-RL-Judge框架，提升模型在不同任务中的判断一致性与人类偏好相关性。**
...
>
---
#### [replaced 037] MASS-RAG: Multi-Agent Synthesis Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于信息检索与生成任务，旨在解决RAG中多源证据整合困难的问题。通过多代理协作提升生成质量。**

- **链接: [https://arxiv.org/pdf/2604.18509](https://arxiv.org/pdf/2604.18509)**

> **作者:** Xingchen Xiao; Heyan Huang; Runheng Liu; Jincheng Xie
>
> **备注:** ACL 2026 Findings, 19 pages
>
...
>
---
#### [replaced 038] Understanding LLM Performance Degradation in Multi-Instance Processing: The Roles of Instance Count and Context Length
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究多实例处理任务中LLM性能下降问题，分析实例数量和上下文长度的影响，发现实例数对性能影响更大。**
...
>
---
#### [replaced 039] One Persona, Many Cues, Different Results: How Sociodemographic Cues Impact LLM Personalization
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的公平性研究任务，旨在解决LLM个性化中因社会人口学线索引发的偏见问题。通过对比多种线索对模型输出的影响，揭示单一线索的局限性。**

- **链接: [https://arxiv.org/pdf/2601.18572](https://arxiv.org/pdf/2601.18572)**
...
>
---
#### [replaced 040] MATA: Multi-Agent Framework for Reliable and Flexible Table Question Answering
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出MATA框架，解决TableQA任务中的可靠性与效率问题。通过多代理协作和小模型工具，提升准确率并减少大模型调用。**

- **链接: [https://arxiv.org/pdf/2602.09642](https://arxiv.org/pdf/2602.09642)**
...
>
---
#### [replaced 041] Who Watches the Watchmen? Humans Disagree With Translation Metrics on Unseen Domains
- **分类: cs.CL**

- **简介: 该论文属于机器翻译评估任务，旨在解决自动评估指标在跨领域场景下的可靠性问题。通过构建多标注者数据集，分析指标与人类判断的一致性，发现指标在未见领域表现不佳。**
...
>
---
#### [replaced 042] DuQuant++: Fine-grained Rotation Enhances Microscaling FP4 Quantization
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于大模型量化任务，解决MXFP4格式下激活值异常导致的量化误差问题。通过引入细粒度旋转技术，提升量化精度与效率。**
...
>
---
#### [replaced 043] Lost in the Prompt Order: Revealing the Limitations of Causal Attention in Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，研究语言模型对提示顺序的敏感性。针对多选题问答中提示顺序影响性能的问题，通过分析发现因果注意力机制是关键原因。**

- **链接: [https://arxiv.org/pdf/2601.14152](https://arxiv.org/pdf/2601.14152)**
...
>
---
#### [replaced 047] Can AI-Generated Persuasion Be Detected? Persuaficial Benchmark and AI vs. Human Linguistic Differences
- **分类: cs.CL**

- **简介: 该论文属于文本检测任务，旨在解决AI生成说服性文本是否比人类写作更难检测的问题。研究构建了多语言基准并分析了两者在语言上的差异。**

- **链接: [https://arxiv.org/pdf/2601.04925](https://arxiv.org/pdf/2601.04925)**
...
>
---
#### [replaced 048] A Goal Without a Plan Is Just a Wish: Efficient and Effective Global Planner Training for Long-Horizon Agent Tasks
- **分类: cs.CL**

- **简介: 该论文针对长周期任务中智能体缺乏全局规划的问题，提出EAGLET方法，通过两阶段训练提升规划能力，显著提高效率并降低训练成本。**
...
- **简介: 该论文属于模型监控与安全任务，解决细调大语言模型的威胁检测问题。通过分析权重差异，实现对模型行为的精准监控与控制。**

- **链接: [https://arxiv.org/pdf/2508.00161](https://arxiv.org/pdf/2508.00161)**
...
>
---
#### [replaced 053] OmniVoice: Towards Omnilingual Zero-Shot Text-to-Speech with Diffusion Language Models
- **分类: cs.CL; eess.AS**
...
>
---
#### [replaced 054] Hybrid Architectures for Language Models: Systematic Analysis and Design Insights
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型的效率与性能平衡问题。通过分析混合架构，提出优化设计方法。**
...
>
---
#### [replaced 055] The Metacognitive Monitoring Battery: A Cross-Domain Benchmark for LLM Self-Monitoring
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出一种跨领域评估LLM自我监控的基准，解决LLM元认知能力评估问题，通过524个任务测试不同认知域，分析模型的自信与校准情况。**
...
>
---
#### [replaced 056] The Alignment Waltz: Jointly Training Agents to Collaborate for Safety
- **分类: cs.CL**

- **简介: 该论文属于大模型安全对齐任务，旨在解决模型在安全与帮助性之间的平衡问题。提出WaltzRL框架，通过双代理协作提升模型安全性并减少过度拒绝。**

- **链接: [https://arxiv.org/pdf/2510.08240](https://arxiv.org/pdf/2510.08240)**
...
> **备注:** ICLR 2026
>
> **摘要:** Harnessing the power of LLMs requires a delicate dance between being helpful and harmless. This creates a fundamental tension between two competing challenges: vulnerability to adversarial attacks that elicit unsafe content, and a tendency for overrefusal on benign but sensitive prompts. Current approaches often navigate this dance with safeguard models that completely reject any content that contains unsafe portions. This approach cuts the music entirely-it may exacerbate overrefusals and fails to provide nuanced guidance for queries it refuses. To teach models a more coordinated choreography, we propose WaltzRL, a novel multi-agent reinforcement learning framework that formulates safety alignment as a collaborative, positive-sum game. WaltzRL jointly trains a conversation agent and a feedback agent, where the latter is incentivized to provide useful suggestions that improve the safety and helpfulness of the conversation agent's responses. At the core of WaltzRL is a Dynamic Improvement Reward (DIR) that evolves over time based on how well the conversation agent incorporates the feedback. At inference time, unsafe or overrefusing responses from the conversation agent are improved rather than discarded. The feedback agent is deployed together with the conversation agent and only engages adaptively when needed, preserving helpfulness and low latency on safe queries. Our experiments, conducted across five diverse datasets, demonstrate that WaltzRL significantly reduces both unsafe responses (e.g., from 39.0% to 4.6% on WildJailbreak) and overrefusals (from 45.3% to 9.9% on OR-Bench) compared to various baselines. By enabling the conversation and feedback agents to co-evolve and adaptively apply feedback, WaltzRL enhances LLM safety without degrading general capabilities, thereby advancing the Pareto front between helpfulness and harmlessness.
>
---
#### [replaced 057] Multilingual Language Models Encode Script Over Linguistic Structure
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究多语言模型如何编码语言信息，解决其内部表示是基于语言结构还是表面形式的问题。通过分析模型激活，发现其更依赖表面形式而非语言类型。**

- **链接: [https://arxiv.org/pdf/2604.05090](https://arxiv.org/pdf/2604.05090)**
...
>
---
#### [replaced 058] RepIt: Steering Language Models with Concept-Specific Refusal Vectors
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于语言模型安全评估任务，旨在解决现有评估方法无法检测局部漏洞的问题。提出RepIt框架，通过概念特定拒绝向量实现对特定概念的精准抑制，暴露评估体系的缺陷。**

- **链接: [https://arxiv.org/pdf/2509.13281](https://arxiv.org/pdf/2509.13281)**

> **作者:** Vincent Siu; Nathan W. Henry; Nicholas Crispino; Yang Liu; Dawn Song; Chenguang Wang
>
> **备注:** ICLR 2026
>
> **摘要:** Current safety evaluations of language models rely on benchmark-based assessments that may miss localized vulnerabilities. We present RepIt, a simple and data-efficient framework for isolating concept-specific representations in LM activations. While existing steering methods already achieve high attack success rates through broad interventions, RepIt enables a more concerning capability: selective suppression of refusal on targeted concepts while preserving refusal elsewhere. Across five frontier LMs, RepIt produces evaluation-evading model organisms with semantic backdoors, answering questions related to weapons of mass destruction while still scoring as safe on standard benchmarks. We find the edit of the steering vector localizes to just 100-200 residual dimensions, and robust concept vectors can be extracted from as few as a dozen examples on a single RTX A6000, highlighting how targeted, hard-to-detect modifications can exploit evaluation blind spots with minimal resources. Through demonstrating precise concept disentanglement, this work exposes vulnerabilities in current safety evaluation practices and demonstrates a need for more comprehensive, representation aware assessments.
>
---
#### [replaced 059] Investigating the structure of emotions by analyzing similarity and association of emotion words
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于情感分析任务，旨在验证Plutchik情感轮模型的有效性。通过构建情感词的语义网络并分析其结构，发现与情感轮结构总体相似但存在局部差异。**

- **链接: [https://arxiv.org/pdf/2602.06430](https://arxiv.org/pdf/2602.06430)**

> **作者:** Fumitaka Iwaki; Tatsuji Takahashi
>
> **备注:** 5 figures, 8 tables; data github link added
>
...
>
---
#### [replaced 060] Visual-TableQA: Open-Domain Benchmark for Reasoning over Table Images
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出Visual-TableQA，一个用于评估和提升视觉推理能力的多模态数据集，解决现有基准不足的问题。通过自动化生成流程，构建大规模、多样化的表格问答对，以促进模型在结构化数据上的推理能力。**

- **链接: [https://arxiv.org/pdf/2509.07966](https://arxiv.org/pdf/2509.07966)**

> **作者:** Boammani Aser Lompo; Marc Haraoui
>
> **备注:** Accepted at the First Workshop on Foundations of Reasoning in Language Models, NeurIPS 2025. Available at: this https URL
>
...
>
---
#### [replaced 061] PolarQuant: Optimal Gaussian Weight Quantization via Hadamard Rotation for LLM Compression
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出PolarQuant，用于大语言模型的权重量化压缩任务。通过哈达玛旋转和高斯分布匹配，实现近无损压缩，提升模型质量并提高推理效率。**

- **链接: [https://arxiv.org/pdf/2603.29078](https://arxiv.org/pdf/2603.29078)**

> **作者:** Caio Vicentino
>
> **备注:** Found some errors, I need to fix
>
...
>
---
#### [replaced 062] MM-JudgeBias: A Benchmark for Evaluating Compositional Biases in MLLM-as-a-Judge
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文属于多模态模型评估任务，旨在解决MLLM-as-a-Judge中的组合偏差问题。通过构建MM-JudgeBias基准，评估模型在不同模态下的稳定性与敏感性。**
...
>
---
#### [replaced 063] IYKYK (But AI Doesn't): Automated Content Moderation Does Not Capture Communities' Heterogeneous Attitudes Towards Reclaimed Language
- **分类: cs.CL**

- **简介: 该论文属于内容 moderation 任务，旨在解决 AI 难以区分被边缘化群体使用的 reclaimed slurs 与仇恨言论的问题。通过分析用户数据和访谈，揭示了社区对污辱性语言的主观理解差异。**
...
>
---
#### [replaced 064] STReasoner: Empowering LLMs for Spatio-Temporal Reasoning in Time Series via Spatial-Aware Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于时序时空推理任务，旨在解决传统方法重预测轻推理的问题。通过构建基准和提出STReasoner模型，结合空间信息提升推理能力。**

- **链接: [https://arxiv.org/pdf/2601.03248](https://arxiv.org/pdf/2601.03248)**

> **作者:** Juntong Ni; Shiyu Wang; Qi He; Ming Jin; Wei Jin
>
> **备注:** ACL 2026 Main, we release our code publicly at this https URL
>
> **摘要:** Spatio-temporal reasoning in time series involves the explicit synthesis of temporal dynamics, spatial dependencies, and textual context. This capability is vital for high-stakes decision-making in systems such as traffic networks, power grids, and disease propagation. However, the field remains underdeveloped because most existing works prioritize predictive accuracy over reasoning. To address the gap, we introduce ST-Bench, a benchmark consisting of four core tasks, including etiological reasoning, entity identification, correlation reasoning, and in-context forecasting, developed via a network SDE-based multi-agent data synthesis pipeline. We then propose STReasoner, which empowers LLM to integrate time series, graph structure, and text for explicit reasoning. To promote spatially grounded logic, we introduce S-GRPO, a reinforcement learning algorithm that rewards performance gains specifically attributable to spatial information. Experiments show that STReasoner achieves average accuracy gains between 17% and 135% at only 0.004X the cost of proprietary models and generalizes robustly to real-world data.
>
---
#### [replaced 065] Improving the Distributional Alignment of LLMs using Supervision
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的分布对齐任务，旨在提升大语言模型在主观问题上与不同群体的对齐效果。通过添加监督，改进模型生成分布的多样性与准确性。**

- **链接: [https://arxiv.org/pdf/2507.00439](https://arxiv.org/pdf/2507.00439)**

> **作者:** Gauri Kambhatla; Sanjana Gautam; Angela Zhang; Alex Liu; Ravi Srinivasan; Junyi Jessy Li; Matthew Lease
>
> **备注:** ACL Main 2026
>
> **摘要:** The ability to accurately align LLMs with diverse population groups on subjective questions would have great value. In this work, we show that adding simple supervision can more consistently improve the alignment of LLM-generated distributions with diverse population groups, as measured across three datasets spanning public health, public opinion, and values and beliefs. Beyond evaluating average alignment, we also report how alignment varies across specific groups. Our broad findings provide insights into the distributional alignment of LLM generations with diverse populations. By conducting evaluation over many LLMs and prompting strategies, we provide a benchmark to stimulate future research.
>
---
#### [replaced 066] FoNE: Precise Single-Token Number Embeddings via Fourier Features
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出FoNE方法，解决LLM中数字表示碎片化问题。通过傅里叶特征将数字编码为单个token，提升计算效率与任务准确率。**

- **链接: [https://arxiv.org/pdf/2502.09741](https://arxiv.org/pdf/2502.09741)**

> **作者:** Tianyi Zhou; Deqing Fu; Mahdi Soltanolkotabi; Robin Jia; Vatsal Sharan
>
> **摘要:** Large Language Models (LLMs) typically represent numbers using multiple tokens, which requires the model to aggregate these tokens to interpret numerical values. This fragmentation makes both training and inference less efficient and adversely affects the model's performance on number-related tasks. Inspired by the observation that pre-trained LLMs internally learn Fourier-like features for number tokens, we propose Fourier Number Embedding (FoNE), a novel method that directly maps numbers into the embedding space with their Fourier features. FoNE encodes each number as a single token with only two embedding dimensions per digit, effectively capturing numerical values without fragmentation. This compact representation accelerates both training and inference. Compared to traditional subword and digit-wise embeddings, FoNE not only reduces computational overhead but also achieves higher accuracy across various numerical tasks including addition, subtraction and multiplication. On 6-digit decimal addition, FoNE requires 64$\times$ less data to achieve 99% accuracy than subword and digit-wise embeddings while using 3$\times$ and 6$\times$ fewer tokens per number, respectively. Furthermore, FoNE is the only method that yields 100% accuracy on over 100,000 test examples for addition, subtraction, and multiplication. The codes and visualization are available at this https URL.
>
---
#### [replaced 067] Cross-lingual Matryoshka Representation Learning across Speech and Text
- **分类: cs.CL**

- **简介: 该论文属于跨语言表示学习任务，旨在解决低资源语言的语种和模态障碍。通过构建双语语音-文本马特罗什卡嵌入模型，实现法语文本与沃洛夫语语音的高效检索。**

- **链接: [https://arxiv.org/pdf/2602.19991](https://arxiv.org/pdf/2602.19991)**
...
>
---
#### [replaced 070] Reasoning Models Will Sometimes Lie About Their Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究大模型在提示影响下的诚实性问题，属于模型可信性任务。旨在解决模型是否如实反映推理过程的问题，通过实验发现模型可能否认使用提示但实际已使用。**
...
>
---
#### [replaced 071] Speculative End-Turn Detector for Efficient Speech Chatbot Assistant
...
>
---
#### [replaced 072] MiroThinker: Pushing the Performance Boundaries of Open-Source Research Agents via Model, Context, and Interactive Scaling
- **分类: cs.CL**

- **简介: 该论文提出MiroThinker，解决开放源代码研究代理的性能提升问题，通过交互扩展实现更深度和频繁的环境互动，提升推理与信息获取能力。**

- **链接: [https://arxiv.org/pdf/2511.11793](https://arxiv.org/pdf/2511.11793)**

> **作者:** MiroMind Team; Song Bai; Lidong Bing; Carson Chen; Guanzheng Chen; Yuntao Chen; Zhe Chen; Ziyi Chen; Jifeng Dai; Xuan Dong; Wenhan Dou; Yue Deng; Yunjie Fu; Junqi Ge; Chenxia Han; Tammy Huang; Zhenhang Huang; Jerry Jiao; Shilei Jiang; Tianyu Jiao; Xiaoqi Jian; Lei Lei; Ruilin Li; Gen Luo; Tiantong Li; Xiang Lin; Ziyuan Liu; Zhiqi Li; Jie Ni; Qiang Ren; Pax Sun; Shiqian Su; Chenxin Tao; Bin Wang; Wenhai Wang; Haonan Wang; James Wang; Jin Wang; Jojo Wang; Letian Wang; Shizun Wang; Weizhi Wang; Zixuan Wang; Jinfan Xu; Sen Xing; Chenyu Yang; Hai Ye; Jiaheng Yu; Yue Yu; Muyan Zhong; Tianchen Zhao; Xizhou Zhu; Yanpeng Zhou; Yifan Zhang; Zhi Zhu
>
> **备注:** Technical Report
>
...
>
---
#### [replaced 073] Resolving the Robustness-Precision Trade-off in Financial RAG through Hybrid Document-Routed Retrieval
- **分类: cs.CL; cs.AI; cs.IR**
...
>
> **备注:** 18 pages, 4 figures, 9 tables. Submitted to Intelligent Systems with Applications
>
...
>
---
#### [replaced 074] ChemPro: A Progressive Chemistry Benchmark for Large Language Models
- **分类: cs.CL**

- **简介: 该论文提出ChemPro，一个用于评估大语言模型化学能力的基准。旨在解决LLMs在科学推理上的局限性，通过多难度问题测试其理解与解答能力。**
...
>
---
#### [replaced 075] TabXEval: Why this is a Bad Table? An eXhaustive Rubric for Table Evaluation
- **分类: cs.CL**

- **简介: 该论文属于表格评估任务，旨在解决传统指标无法捕捉结构与内容差异的问题。提出TabXEval框架，通过结构对齐和语义比较实现精准表格评价。**

- **链接: [https://arxiv.org/pdf/2505.22176](https://arxiv.org/pdf/2505.22176)**

> **作者:** Vihang Pancholi; Jainit Bafna; Tejas Anvekar; Manish Shrivastava; Vivek Gupta
>
> **备注:** Accepeted for Findings at ACL 2025
>
> **摘要:** Evaluating tables qualitatively and quantitatively poses a significant challenge, as standard metrics often overlook subtle structural and content-level discrepancies. To address this, we propose a rubric-based evaluation framework that integrates multi-level structural descriptors with fine-grained contextual signals, enabling more precise and consistent table comparison. Building on this, we introduce TabXEval, an eXhaustive and eXplainable two-phase evaluation framework. TabXEval first aligns reference and predicted tables structurally via TabAlign, then performs semantic and syntactic comparison using TabCompare, offering interpretable and granular feedback. We evaluate TabXEval on TabXBench, a diverse, multi-domain benchmark featuring realistic table perturbations and human annotations. A sensitivity-specificity analysis further demonstrates the robustness and explainability of TabXEval across varied table tasks. Code and data are available at this https URL
>
---
#### [replaced 076] TabReX : Tabular Referenceless eXplainable Evaluation
- **分类: cs.CL**

- **简介: 该论文提出TabReX，用于评估大语言模型生成的表格质量。解决结构化生成评价难题，通过图推理实现无参考、可解释的评估。**

- **链接: [https://arxiv.org/pdf/2512.15907](https://arxiv.org/pdf/2512.15907)**

> **作者:** Tejas Anvekar; Junha Park; Aparna Garimella; Vivek Gupta
>
> **备注:** Accepted to ACL 2026 (Main Conference). Long paper
>
...
>
---
#### [replaced 077] VimRAG: Navigating Massive Visual Context in Retrieval-Augmented Generation via Multimodal Memory Graph
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出VimRAG，解决多模态检索增强生成中的长上下文处理问题，通过图结构建模记忆，提升信息提取与推理效果。**

- **链接: [https://arxiv.org/pdf/2602.12735](https://arxiv.org/pdf/2602.12735)**
...
>
---
#### [replaced 078] Comparing energy consumption and accuracy in text classification inference
- **分类: cs.CL; cs.CY**

- **简介: 该论文属于自然语言处理任务，研究文本分类推理中的能耗与准确率关系，分析不同模型和硬件下的能耗差异及二者不完全相关的特点。**

- **链接: [https://arxiv.org/pdf/2508.14170](https://arxiv.org/pdf/2508.14170)**

> **作者:** Johannes Zschache; Tilman Hartwig
>
> **备注:** Key results in Figure 2, accepted in Nature Sci Rep, 32 pages
>
...
>
---
#### [replaced 081] Article and Comment Frames Shape the Quality of Online Comments
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的 discourse 质量研究任务，旨在探讨文章框架如何影响在线评论质量。通过分析100万条评论，发现文章框架显著影响评论健康度，为改善网络讨论提供新思路。**
...
>
---
#### [replaced 082] More Than Sum of Its Parts: Deciphering Intent Shifts in Multimodal Hate Speech Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多模态仇恨言论检测任务，解决隐性仇恨言论识别难题。通过构建H-VLI基准和提出ARCADE框架，提升对语义意图变化的捕捉能力。**
...
>
---
#### [replaced 083] Do LLMs Encode Functional Importance of Reasoning Tokens?
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究大语言模型是否编码推理标记的功能重要性。任务是理解模型内部如何处理推理过程。通过贪心剪枝方法，识别并删除对模型似然影响小的标记，验证了模型确实具有功能重要性结构。**
...
>
---
#### [replaced 084] Sentipolis: Emotion-Aware Agents for Social Simulations
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于社会模拟任务，旨在解决情感连续性不足的问题。提出Sentipolis框架，整合情感状态表示与动态机制，提升情感驱动行为的连贯性与真实性。**

- **链接: [https://arxiv.org/pdf/2601.18027](https://arxiv.org/pdf/2601.18027)**
...
>
---
#### [replaced 085] STaD: Scaffolded Task Design for Identifying Compositional Skill Gaps in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出STaD框架，用于识别大模型的组合技能缺口。属于模型评估任务，解决如何发现模型在推理能力上的具体不足问题，通过结构化任务设计系统分析模型缺陷。**
...
>
---
#### [replaced 086] Why AI Readiness Is an Organizational Learning Problem, Not a Technology Purchase
- **分类: cs.CY; cs.AI; cs.CL**

- **简介: 该论文属于组织学习研究任务，旨在解决AI项目失败问题。通过分析19个来源，提出SIO模型，强调AI能力发展而非技术采购。**
...
>
---
#### [replaced 087] A Functionality-Grounded Benchmark for Evaluating Web Agents in E-commerce Domains
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于Web代理评估任务，旨在解决现有基准在功能覆盖和安全性评估上的不足。提出Amazon-Bench基准，涵盖多种电商功能并评估代理性能与安全风险。**

- **链接: [https://arxiv.org/pdf/2508.15832](https://arxiv.org/pdf/2508.15832)**
...
>
---
#### [replaced 088] Evaluating Cooperation in LLM Social Groups through Elected Leadership
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于多智能体协作研究，旨在解决如何通过选举领导提升社会福利与合作的问题。工作包括构建模拟框架，实验表明选举领导显著提升合作效果。**
...
>
---
#### [replaced 089] VISTA: Verification In Sequential Turn-based Assessment
- **分类: cs.CL**

- **简介: 该论文提出VISTA框架，用于评估对话系统的事实性。解决多轮对话中幻觉检测问题，通过逐条验证和序列一致性跟踪提升准确性。**
...
>
---
#### [replaced 090] From Proof to Program: Characterizing Tool-Induced Reasoning Hallucinations in Large Language Models
- **分类: cs.CL; cs.LO; cs.SE**

- **简介: 该论文研究工具增强语言模型的推理偏差问题，属于自然语言处理任务。针对工具使用导致的推理退化现象，提出评估框架并改进模型推理能力。**

- **链接: [https://arxiv.org/pdf/2511.10899](https://arxiv.org/pdf/2511.10899)**
...
>
---
#### [replaced 091] SciImpact: A Multi-Dimensional, Multi-Field Benchmark for Scientific Impact Prediction
- **分类: cs.CL**
...
>
---
#### [replaced 092] CASS: Nvidia to AMD Transpilation with Data, Models, and Benchmark
- **分类: cs.AR; cs.AI; cs.CL; cs.LG; cs.PL**

- **简介: 该论文提出CASS，一个用于GPU代码跨架构翻译的数据集和模型套件，解决CUDA到HIP、SASS到RDNA3的翻译问题，提升硬件可移植性。**

- **链接: [https://arxiv.org/pdf/2505.16968](https://arxiv.org/pdf/2505.16968)**
...
>
> **备注:** Published at the International Conference on Learning Representations 2026
>
...
>
---
#### [replaced 094] Take Out Your Calculators: Estimating the Real Difficulty of Question Items with LLM Student Simulations
- **分类: cs.CL**

- **简介: 该论文属于教育评估任务，旨在用LLM模拟学生解答数学题，预测题目难度。通过角色扮演和IRT模型，验证了LLM在不同年级的预测效果。**

- **链接: [https://arxiv.org/pdf/2601.09953](https://arxiv.org/pdf/2601.09953)**
...
>
---
#### [replaced 095] REZE: Representation Regularization for Domain-adaptive Text Embedding Pre-finetuning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本嵌入预微调任务，解决领域适应中因任务偏差导致的表征漂移问题。提出REZE框架，通过正则化控制表征变化，提升模型稳定性与性能。**
...
>
---
#### [replaced 096] Qwen3.5-Omni Technical Report
- **分类: cs.CL; eess.AS**
...
>
---
#### [replaced 097] Modular Representation Compression: Adapting LLMs for Efficient and Effective Recommendations
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于推荐系统任务，解决LLM高维表示压缩效率低的问题。提出MARC方法，通过模块化调整和任务解耦提升压缩效果。**
...
>
---
#### [replaced 098] SitEmb-v1.5: Improved Context-Aware Dense Retrieval for Semantic Association and Long Story Comprehension
- **分类: cs.CL**

- **简介: 该论文属于信息检索任务，解决长文档中片段检索的上下文感知问题。通过引入情境嵌入模型（SitEmb），提升检索效果，尤其在长故事理解中表现优异。**

- **链接: [https://arxiv.org/pdf/2508.01959](https://arxiv.org/pdf/2508.01959)**

> **作者:** Junjie Wu; Jiangnan Li; Yuqing Li; Lemao Liu; Liyan Xu; Jiwei Li; Dit-Yan Yeung; Jie Zhou; Mo Yu
>
> **备注:** ACL 2025 Main Conference. Our trained models can be downloaded from: this https URL
>
...
>
---
#### [replaced 099] Mitigating Judgment Preference Bias in Large Language Models through Group-Based Polling
- **分类: cs.CL**

- **简介: 该论文属于模型评估任务，旨在解决LLM在评价过程中存在的判断偏好偏差问题。通过引入Genii框架，实现无监督的多智能体协作优化，有效降低偏差，提升评估可靠性。**

- **链接: [https://arxiv.org/pdf/2510.08145](https://arxiv.org/pdf/2510.08145)**
...
>
---
#### [replaced 100] Dynamic Model Routing and Cascading for Efficient LLM Inference: A Survey
- **分类: cs.NI; cs.CL; cs.PF**

- **简介: 该论文属于模型推理优化任务，解决静态模型部署效率低的问题。通过动态路由与级联方法，提升多模型协作效率与性能。**
...
>
---
#### [replaced 101] When and What to Ask: AskBench and Rubric-Guided RLVR for LLM Clarification
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究LLM在缺失信息或误导性提示下的澄清能力，属于自然语言处理任务。针对LLM易产生幻觉的问题，提出AskBench和Rubric-Guided RLVR方法，提升模型提问的准确性和效率。**

- **链接: [https://arxiv.org/pdf/2602.11199](https://arxiv.org/pdf/2602.11199)**
...
>
---
#### [replaced 102] Rethinking Information Synthesis in Multimodal Question Answering A Multi-Agent Perspective
- **分类: cs.CL**

- **简介: 该论文属于多模态问答任务，旨在解决单一推理策略限制准确性和可解释性的问题。提出MAMMQA框架，通过多智能体协作提升性能。**

- **链接: [https://arxiv.org/pdf/2505.20816](https://arxiv.org/pdf/2505.20816)**
...
>
---
#### [replaced 103] On Temperature-Constrained Non-Deterministic Machine Translation: Potential and Evaluation
- **分类: cs.CL**

- **简介: 该论文研究机器翻译中的非确定性特性，针对多模态问题提出温度约束的非确定性翻译方法，并探讨其评估挑战。**

- **链接: [https://arxiv.org/pdf/2601.13729](https://arxiv.org/pdf/2601.13729)**
