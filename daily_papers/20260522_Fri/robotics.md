...
>
---
#### [new 004] Quantifying Full-Body Immersion
- **分类: cs.RO; cs.HC**

- **简介: 论文提出全身体感沉浸框架，解决虚拟与现实融合问题。通过模块化机器人系统实现动态物理交互，提升沉浸体验。**

- **链接: [https://arxiv.org/pdf/2605.22521](https://arxiv.org/pdf/2605.22521)**
...
>
---
#### [new 018] Industrial Dual-Arm Box Handling via Online Inertial Estimation and Convex Wrench Optimization
- **分类: cs.RO**

- **简介: 该论文属于工业双臂抓取任务，解决未知质量物体的稳定抓取问题。通过在线估计惯性参数并优化接触力，实现安全抓取与稳定提升。**

- **链接: [https://arxiv.org/pdf/2605.22021](https://arxiv.org/pdf/2605.22021)**
...
>
---
#### [new 021] Distributed Multi-Coverage for Robot Swarms
- **分类: cs.RO**

- **简介: 该论文属于机器人编队任务，解决无人机群在局部通信和计算限制下实现多覆盖的问题，提出一种分布式算法以确保关键资产被多个机器人冗余监控。**

- **链接: [https://arxiv.org/pdf/2605.21686](https://arxiv.org/pdf/2605.21686)**

> **作者:** Mariem Guitouni; Aaron T. Becker
>
> **备注:** Accepted at ANTS 2026 (International Conference on Swarm Intelligence), published by Springer Nature
>
> **摘要:** Autonomous drone swarms deployed for surveillance, environmental monitoring, and infrastructure inspection must maintain reliable coverage of critical assets despite robot failures. This requires multicoverage: each asset must be observed by multiple robots for redundancy, with coverage requirements varying by asset importance. While recent work has solved the centralized problem optimally using integer programming, practical deployments face constraints that demand distributed solutions: robots operate with limited communication ranges, onboard computation restricts global planning, and partial system failures must not cause mission abort. We present a distributed multicoverage algorithm for robot swarms operating with local sensing, local communication, and no global coordination.
>
---
#### [new 022] N3P: Accelerated Automated Parking via a Learning-Based Naturalistic Three-Stage Scheme
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于自主泊车任务，解决路径规划效率与可靠性问题。提出N3P框架，通过分阶段学习提升规划速度和轨迹质量。**

- **链接: [https://arxiv.org/pdf/2605.22722](https://arxiv.org/pdf/2605.22722)**
...
>
---
#### [new 031] CoRMA: Contrastive RMA for Contact-Rich Meta-Adaptation
- **分类: cs.RO; cs.LG**

- **简介: 该论文提出CoRMA，用于高接触装配任务的元适应，解决仿真与真实环境差异问题。通过语义接触推理实现在线适应，提升真实场景成功率。**
...
>
---
#### [new 032] Imagine2Real: Towards Zero-shot Humanoid-Object Interaction via Video Generative Priors
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 033] TacO: Benchmarking Tactile Sensors for Object Manipulation
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，旨在解决 tactile sensor 选择问题。通过评估四种传感器模态在三种操作任务中的表现，分析传感器特性对任务的影响。**

- **链接: [https://arxiv.org/pdf/2605.21976](https://arxiv.org/pdf/2605.21976)**
...
>
---
#### [new 037] Branch-Stochastic Model Predictive Control for Motion Planning under Multi-Modal Uncertainty with Scenario Clustering
- **分类: cs.RO**

- **简介: 该论文属于自主驾驶中的运动规划任务，解决多模态不确定性下的路径规划问题。通过结合SMPC与分支结构，生成不同意图的轨迹，提升安全性与实时性。**

- **链接: [https://arxiv.org/pdf/2605.22600](https://arxiv.org/pdf/2605.22600)**
...
>
---
#### [new 040] Improving 3D Labeling in Self-Driving by Inferring Vehicle Information using Vision Language Models
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 041] Efficient Agentic Reasoning Through Self-Regulated Simulative Planning
...
>
---
#### [new 042] stable-worldmodel: A Platform for Reproducible World Modeling Research and Evaluation
- **分类: cs.LG; cs.RO**

- **简介: 该论文提出stable-worldmodel平台，解决世界模型研究中的可复现性和评估标准不统一问题，整合数据、模型和评估环境，提升研究效率。**

- **链接: [https://arxiv.org/pdf/2605.21800](https://arxiv.org/pdf/2605.21800)**
...
>
---
#### [new 045] FRED: A Multi-Modal Autonomous Driving Dataset for Flooded Road Environments
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 046] PhysX-Omni: Unified Simulation-Ready Physical 3D Generation for Rigid, Deformable, and Articulated Objects
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 051] Diffusion-guided Generalizable Enhancer for Urban Scene Reconstruction
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 002] DSSP: Diffusion State Space Policy with Full-History Encoding
- **分类: cs.RO**

- **简介: 该论文提出DSSP，解决机器人操作中长序列任务的历史依赖问题。通过全历史编码和层次化条件机制，提升策略效率与性能。**
...
>
---
#### [replaced 003] Active Defense Against False Data Injection Attacks in Robotic Manipulators
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于机器人安全任务，解决FDIA导致的传感器信号篡改问题。通过引入虚拟阻尼和可操作性降低方法，提升机械臂对抗攻击的韧性。**
...
>
> **备注:** Extended 8-page version containing full proofs. An abridged 6-page version has been accepted for publication in the Proceedings of the 23rd IFAC World Congress (2026). v3: Minor typographical fixes and updated reference formatting
>
...
>
---
#### [replaced 004] Federated Single-Agent Robotics: Multi-Robot Coordination Without Intra-Robot Multi-Agent Fragmentation
- **分类: cs.RO; cs.AI**
...
>
---
#### [replaced 005] SENIOR: Efficient Query Selection and Preference-Guided Exploration in Preference-based Reinforcement Learning
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于偏好强化学习任务，旨在提升人类反馈效率和策略收敛速度。提出SENIOR方法，通过有效查询选择和偏好引导探索解决样本效率低的问题。**

- **链接: [https://arxiv.org/pdf/2506.14648](https://arxiv.org/pdf/2506.14648)**

> **作者:** Hexian Ni; Tao Lu; Haoyuan Hu; Yinghao Cai; Shuo Wang
>
> **备注:** 8 pages, 8 figures, IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS 2025)
>
...
>
---
#### [replaced 006] Harnessing Embodied Agents: Runtime Governance for Policy-Constrained Execution
- **分类: cs.RO**

- **简介: 该论文属于智能系统安全任务，解决 embodied agents 运行时的可控性问题。提出分离认知与治理的框架，实现政策约束执行，提升安全性与可审计性。**
...
>
---
#### [replaced 007] General Agentic Planning Through Simulative Reasoning with World Models
- **分类: cs.AI; cs.CL; cs.LG; cs.RO**
...
>
---
#### [replaced 008] 4D Radar Semantic Segmentation of People in Field Conditions Using Temporal Multi-View Networks
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 009] Pelican-Unify 1.0: A Unified Embodied Intelligence Model for Understanding, Reasoning, Imagination and Action
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出Pelican-Unify 1.0，一个统一的具身智能模型，解决多模态理解、推理、想象与行动的整合问题。通过单一模型实现多项能力，提升任务表现。**
...
>
> **摘要:** We present Pelican-Unify 1.0, the first embodied foundation model trained according to the principle of unification. Pelican-Unify 1.0 uses a single VLM as a unified understanding module, mapping scenes, instructions, visual contexts, and action histories into a shared semantic space. The same VLM also serves as a unified reasoning module, autoregressively producing task-, action-, and future-oriented chains of thought in a single forward pass and projecting the final hidden state into a dense latent variable. A Unified Future Generator (UFG) then conditions on this latent variable and jointly generates future videos and future actions through two modality-specific output heads within the same denoising process. The language, video, and action losses are all backpropagated into the shared representation, enabling the model to jointly optimize understanding, reasoning, imagination, and action during training, rather than training three isolated expert systems. Experiments demonstrate that unification does not imply compromise. With a single checkpoint, Pelican-Unify 1.0 achieves strong performance across all three capabilities: 64.7 on eight VLM benchmarks, the best among comparable-scale models; 66.03 on WorldArena, ranking first; and 93.5 on RoboTwin, the second-best average among compared action methods. These results show that the unified paradigm succeeds in preserving specialist strength while bringing understanding, reasoning, imagination, and action into one model.
>
---
#### [replaced 010] VRA: Grounding Discrete-Time Joint Acceleration in Voltage-Constrained Actuation
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，解决电压约束下关节加速度不可行的问题。提出VRA方法，将加速度限制在电压可行范围内，提升执行一致性。**
...
>
---
#### [replaced 013] Dissecting Embodied Abilities in Multimodal Language Models through Skill-level Evaluation and Diagnosis
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 014] When Simultaneous Localization and Mapping Meets Wireless Communications: A Survey
...
>
---
#### [replaced 015] FUSE: A Framework for Unified State Estimation in Vehicular and Robotic SLAM Systems
- **分类: cs.RO**

- **简介: 该论文提出FUSE框架，用于车辆和机器人的SLAM状态估计。解决多速率传感下状态估计设计耦合问题，通过模块化设计提升灵活性与精度。**

- **链接: [https://arxiv.org/pdf/2605.18047](https://arxiv.org/pdf/2605.18047)**

> **作者:** Wei Wu; Honglin Chen; Wenhan Cao; Yao Lyu; Shaobing Xu; Kun Jiang; Jiangtao Li; Tao Zhang; Lei Guo; Shengbo Eben Li
>
...
>
---
#### [replaced 016] Parallel OctoMapping: A Scalable Framework for Enhanced Path Planning in Autonomous Navigation
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于自主导航任务，解决固定分辨率地图导致路径规划效率低的问题。提出POMP方法，提升自由空间表示和计算效率，改善复杂环境下的路径规划效果。**
...
>
---
#### [replaced 017] IVGT: Implicit Visual Geometry Transformer for Neural Scene Representation
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 018] Learning Without Losing Identity: Capability Evolution for Embodied Agents
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于机器人学习任务，解决长期运行中代理稳定性与能力提升的矛盾。提出基于能力演化的框架，保持代理身份不变，持续改进功能模块。**
...
>
---
#### [replaced 019] A KL-regularization Framework for Learning to Plan with Adaptive Priors
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于强化学习领域，解决模型预测控制中的探索效率问题。通过引入KL正则化框架，将规划器分布作为策略优化的先验，提升策略与规划器的一致性，从而提高性能。**

- **链接: [https://arxiv.org/pdf/2510.04280](https://arxiv.org/pdf/2510.04280)**

> **作者:** Álvaro Serra-Gomez; Daniel Jarne Ornia; Dhruva Tirumala; Thomas Moerland
>
> **备注:** Published at ICML2026
>
...
>
---
#### [replaced 020] Learning Human-Intention Priors from Large-Scale Human Demonstrations for Robotic Manipulation
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，旨在解决从人类演示中学习人类意图先验的问题。通过构建大规模数据集并设计分层框架，提升机器人运动的合理性和控制鲁棒性。**
...
>
---
#### [replaced 021] SONIC: Supersizing Motion Tracking for Natural Humanoid Whole-Body Control
