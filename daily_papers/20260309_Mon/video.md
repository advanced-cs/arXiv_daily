...
#### [new 001] BEVLM: Distilling Semantic Knowledge from LLMs into Bird's-Eye View Representations
...
>
---
#### [new 002] CHMv2: Improvements in Global Canopy Height Mapping using DINOv3
- **分类: cs.CV**

- **简介: 该论文属于遥感任务，旨在解决全球树冠高度精确测量问题。通过改进的DINOv3模型，利用卫星影像生成高精度树冠高度图CHMv2，提升测量准确性与细节保留。**

- **链接: [https://arxiv.org/pdf/2603.06382](https://arxiv.org/pdf/2603.06382)**
...
>
---
#### [new 003] Mitigating Bias in Concept Bottleneck Models for Fair and Interpretable Image Classification
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像分类任务，旨在解决模型中的偏见问题。通过改进概念瓶颈模型，减少性别偏见，提升公平性和可解释性。**

- **链接: [https://arxiv.org/pdf/2603.05899](https://arxiv.org/pdf/2603.05899)**
...
>
---
#### [new 006] Contrastive-to-Self-Supervised: A Two-Stage Framework for Script Similarity Learning
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于脚本相似性学习任务，解决历史脚本关系不确定的问题。通过两阶段框架，结合对比学习与知识蒸馏，实现有效脚本聚类和字形识别。**

- **链接: [https://arxiv.org/pdf/2603.06180](https://arxiv.org/pdf/2603.06180)**
...
>
---
#### [new 007] Towards High-resolution and Disentangled Reference-based Sketch Colorization
- **分类: cs.CV**

- **简介: 该论文属于图像着色任务，旨在解决训练与测试数据分布差异导致的着色质量下降问题。通过双分支框架和Gram正则化损失，提升着色精度与可控性。**
...
>
---
#### [new 008] InnoAds-Composer: Efficient Condition Composition for E-Commerce Poster Generation
- **分类: cs.CV**

- **简介: 该论文属于电商海报生成任务，解决多条件控制不一致的问题。提出InnoAds-Composer框架，实现高效三条件控制，并优化文本渲染与训练数据。**

- **链接: [https://arxiv.org/pdf/2603.05898](https://arxiv.org/pdf/2603.05898)**
...
>
---
#### [new 024] OralGPT-Plus: Learning to Use Visual Tools via Reinforcement Learning for Panoramic X-ray Analysis
- **分类: cs.CV**

- **简介: 该论文属于口腔X光影像分析任务，旨在解决传统模型在空间推理和对称性理解上的不足。提出OralGPT-Plus模型，结合强化学习与结构化数据，提升诊断准确性。**

- **链接: [https://arxiv.org/pdf/2603.06366](https://arxiv.org/pdf/2603.06366)**
...
>
---
#### [new 027] Spatial Calibration of Diffuse LiDARs
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 033] EntON: Eigenentropy-Optimized Neighborhood Densification in 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，旨在解决传统方法在几何精度和渲染质量间的平衡问题。提出EntON方法，通过Eigenentropy优化邻域密度，提升重建效果并提高效率。**

- **链接: [https://arxiv.org/pdf/2603.06216](https://arxiv.org/pdf/2603.06216)**
...
>
---
#### [new 034] Dynamic Chunking Diffusion Transformer
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出DC-DiT，用于图像生成任务，解决固定长度token处理导致计算浪费的问题，通过动态分块机制自适应压缩图像，提升生成质量与效率。**

- **链接: [https://arxiv.org/pdf/2603.06351](https://arxiv.org/pdf/2603.06351)**
...
>
---
#### [new 035] DeepSight: Bridging Depth Maps and Language with a Depth-Driven Multimodal Model
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出DeepSight，解决多模态模型对深度信息理解不足的问题，通过结合深度图与文本提升三维场景理解。**

- **链接: [https://arxiv.org/pdf/2603.06090](https://arxiv.org/pdf/2603.06090)**
...
>
---
#### [new 036] Can we Trust Unreliable Voxels? Exploring 3D Semantic Occupancy Prediction under Label Noise
...
>
---
#### [new 039] Ensemble Learning with Sparse Hypercolumns
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，旨在解决高维超列计算复杂度高的问题。通过分层抽样和集成学习，提升模型性能，尤其在小样本情况下表现优异。**

- **链接: [https://arxiv.org/pdf/2603.06036](https://arxiv.org/pdf/2603.06036)**
...
>
---
#### [new 053] DEX-AR: A Dynamic Explainability Method for Autoregressive Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉语言模型解释任务，旨在解决自回归模型决策过程难以解释的问题。提出DEX-AR方法，生成动态热图以解释模型文本输出。**

- **链接: [https://arxiv.org/pdf/2603.06302](https://arxiv.org/pdf/2603.06302)**
...
>
---
#### [new 054] Penguin-VL: Exploring the Efficiency Limits of VLM with LLM-based Vision Encoders
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型（VLM）任务，旨在提升小型VLM的性能。针对传统预训练方法的局限性，提出基于文本大模型的视觉编码器，提升视觉理解精度与效率。**

- **链接: [https://arxiv.org/pdf/2603.06569](https://arxiv.org/pdf/2603.06569)**

> **作者:** Boqiang Zhang; Lei Ke; Ruihan Yang; Qi Gao; Tianyuan Qu; Rossell Chen; Dong Yu; Leoweiliang
>
> **备注:** Penguin-VL Technical Report; Code: this https URL
>
...
>
---
#### [new 069] FlowMotion: Training-Free Flow Guidance for Video Motion Transfer
- **分类: cs.CV**

- **简介: 该论文属于视频动作迁移任务，解决训练-free 方法计算开销大、灵活性差的问题。提出FlowMotion，通过直接利用流模型预测结果，实现高效灵活的运动迁移。**
...
>
---
#### [new 070] Making Reconstruction FID Predictive of Diffusion Generation FID
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像生成任务，旨在解决rFID与gFID相关性低的问题。通过引入iFID，提升与gFID的相关性，实现更准确的生成质量评估。**

- **链接: [https://arxiv.org/pdf/2603.05630](https://arxiv.org/pdf/2603.05630)**
...
>
---
#### [new 075] OVGGT: O(1) Constant-Cost Streaming Visual Geometry Transformer
- **分类: cs.CV**

- **简介: 该论文属于3D几何重建任务，解决视频流中长期推理的资源限制问题。提出OVGGT框架，在固定内存和计算预算下实现高效、准确的3D重建。**
...
>
---
#### [new 076] Adaptive Radial Projection on Fourier Magnitude Spectrum for Document Image Skew Estimation
- **分类: cs.CV**

- **简介: 该论文属于文档图像处理任务，解决扫描文档的倾斜角度估计问题。提出一种基于傅里叶幅度谱自适应径向投影的新方法，并构建高质量数据集进行评估。**

- **链接: [https://arxiv.org/pdf/2603.05942](https://arxiv.org/pdf/2603.05942)**

> **作者:** Luan Pham; Phu Hao Hoang; Xuan Toan Mai; Tuan Anh Tran
>
> **备注:** This paper has been accepted to ICIP 2022
>
> **摘要:** Skew estimation is one of the vital tasks in document processing systems, especially for scanned document images, because its performance impacts subsequent steps directly. Over the years, an enormous number of researches focus on this challenging problem in the rise of digitization age. In this research, we first propose a novel skew estimation method that extracts the dominant skew angle of the given document image by applying an Adaptive Radial Projection on the 2D Discrete Fourier Magnitude spectrum. Second, we introduce a high quality skew estimation dataset DISE-2021 to assess the performance of different estimators. Finally, we provide comprehensive analyses that focus on multiple improvement aspects of Fourier-based methods. Our results show that the proposed method is robust, reliable, and outperforms all compared methods. The source code is available at this https URL.
>
---
#### [new 077] EventGeM: Global-to-Local Feature Matching for Event-Based Visual Place Recognition
- **分类: cs.CV**

- **简介: 该论文属于视觉定位任务，解决事件相机下的场景识别问题。通过融合全局与局部特征，提出EventGeM方法，提升定位精度与实时性。**

- **链接: [https://arxiv.org/pdf/2603.05807](https://arxiv.org/pdf/2603.05807)**
...
>
---
#### [new 086] GenHOI: Towards Object-Consistent Hand-Object Interaction with Temporally Balanced and Spatially Selective Object Injection
- **分类: cs.CV**

- **简介: 该论文聚焦于手-物体交互（HOI）任务，解决视频生成中物体一致性与真实感问题。提出GenHOI方法，通过时空优化注入参考物体信息，提升交互质量。**

- **链接: [https://arxiv.org/pdf/2603.06048](https://arxiv.org/pdf/2603.06048)**
...
>
---
#### [new 094] Occlusion-Aware SORT: Observing Occlusion for Robust Multi-Object Tracking
- **分类: cs.CV**

- **简介: 该论文属于多目标跟踪任务，解决部分遮挡导致的轨迹混淆问题。提出OA-SORT框架，通过分析遮挡状态提升跟踪鲁棒性。**
...
>
---
#### [new 104] Energy-Driven Adaptive Visual Token Pruning for Efficient Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉语言模型优化任务，解决固定token预算导致效率低的问题。提出E-AdaPrune方法，根据图像信息密度动态调整token数量，提升模型效率与性能。**

- **链接: [https://arxiv.org/pdf/2603.05950](https://arxiv.org/pdf/2603.05950)**

> **作者:** Jialuo He; Huangxun Chen
>
> **摘要:** Visual token reduction is critical for accelerating Vision-Language Models (VLMs), yet most existing approaches rely on a fixed budget shared across all inputs, overlooking the substantial variation in image information density. We propose E-AdaPrune, an energy-driven adaptive pruning framework that determines the token budget from the singular value spectrum of the visual features space. By preserving a certain proportion of spectral energy, our method allocates more tokens to information-dense scenes while aggressively compressing redundant ones, without introducing additional learnable parameters. We evaluate E-AdaPrune on nine benchmarks and three VLM backbones, LLaVA-1.5-7B, LLaVA-1.5-13B, and LLaVA-NeXT-8B. Under matched average token budgets, E-AdaPrune consistently yields an average improvement of up to 0.6\%, including a significant +5.1\% relative boost on the MMVet reasoning task. Using randomized singular value decomposition, the additional latency is limited to 8ms per image.
>
---
#### [new 105] Imagine How To Change: Explicit Procedure Modeling for Change Captioning
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于变化描述任务，解决静态图像对比忽略动态变化过程的问题。提出ProCap框架，通过两阶段设计建模变化过程并生成描述。**

- **链接: [https://arxiv.org/pdf/2603.05969](https://arxiv.org/pdf/2603.05969)**
...
>
---
#### [new 107] NOVA: Next-step Open-Vocabulary Autoregression for 3D Multi-Object Tracking in Autonomous Driving
- **分类: cs.CV; cs.RO; eess.IV**
...
>
---
#### [new 116] Modeling and Measuring Redundancy in Multisource Multimodal Data for Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文属于自动驾驶领域，研究多源多模态数据中的冗余问题，通过分析数据质量对检测性能的影响，提出减少冗余以提升感知效果的方法。**

- **链接: [https://arxiv.org/pdf/2603.06544](https://arxiv.org/pdf/2603.06544)**
...
>
---
#### [new 119] What if? Emulative Simulation with World Models for Situated Reasoning
- **分类: cs.CV**

- **简介: 该论文属于 situated reasoning 任务，解决在无法实际探索时的虚拟推理问题。通过构建数据集 WanderDream，研究心理模拟与世界模型的推理能力。**

- **链接: [https://arxiv.org/pdf/2603.06445](https://arxiv.org/pdf/2603.06445)**
...
>
---
#### [new 124] SCOPE: Scene-Contextualized Incremental Few-Shot 3D Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于3D分割任务，解决增量少样本学习中的类别遗忘和原型学习问题。提出SCOPE框架，通过背景引导增强原型表示，提升分割性能。**
...
>
---
#### [new 125] LATO: 3D Mesh Flow Matching with Structured TOpology Preserving LAtents
- **分类: cs.CV**

- **简介: 该论文提出LATO，用于生成具有复杂几何和良好拓扑的3D网格。解决传统方法效率低、拓扑不保的问题，通过结构化潜在表示实现高效生成。**

- **链接: [https://arxiv.org/pdf/2603.06357](https://arxiv.org/pdf/2603.06357)**
...
>
---
#### [new 138] K-MaT: Knowledge-Anchored Manifold Transport for Cross-Modal Prompt Learning in Medical Imaging
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出K-MaT框架，解决医学影像跨模态迁移问题，通过知识锚定的流形传输提升模型在低端模态上的性能。**

- **链接: [https://arxiv.org/pdf/2603.06340](https://arxiv.org/pdf/2603.06340)**
...
>
---
#### [new 142] Facial Expression Recognition Using Residual Masking Network
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于面部表情识别任务，旨在提升CNN在该任务中的性能。通过引入残差掩码网络，结合分割网络优化特征图，提高识别准确率。**

- **链接: [https://arxiv.org/pdf/2603.05937](https://arxiv.org/pdf/2603.05937)**

> **作者:** Luan Pham; Huynh Vu; Tuan Anh Tran
>
...
>
---
#### [new 143] Physical Simulator In-the-Loop Video Generation
- **分类: cs.CV; cs.AI; cs.GR**

- **简介: 该论文属于视频生成任务，旨在解决AI生成视频中物理规律不遵循的问题。通过集成物理模拟器和优化纹理一致性，生成更符合现实物理的视频。**

- **链接: [https://arxiv.org/pdf/2603.06408](https://arxiv.org/pdf/2603.06408)**
...
>
---
#### [new 148] Skeleton-to-Image Encoding: Enabling Skeleton Representation Learning via Vision-Pretrained Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于动作识别任务，解决3D人体骨骼数据与视觉模型不兼容的问题。通过将骨骼序列转换为图像格式，利用预训练视觉模型进行自监督学习，提升骨骼表示效果。**

- **链接: [https://arxiv.org/pdf/2603.05963](https://arxiv.org/pdf/2603.05963)**
...
>
---
#### [new 153] Bridging Domains through Subspace-Aware Model Merging
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于模型融合任务，旨在解决跨领域泛化问题。通过分析参数冲突，提出SCORE方法缓解子空间冲突，提升模型在未见领域的表现。**
...
>
---
#### [new 154] CRIMSON: A Clinically-Grounded LLM-Based Metric for Generative Radiology Report Evaluation
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文提出CRIMSON，用于评估生成的胸部X光报告，解决报告质量评价问题。通过临床数据和错误分类，提升评估准确性。**
...
>
---
#### [new 155] PROBE: Probabilistic Occupancy BEV Encoding with Analytical Translation Robustness for 3D Place Recognition
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 156] Clinical-Injection Transformer with Domain-Adapted MAE for Lupus Nephritis Prognosis Prediction
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学图像分析任务，旨在解决儿童狼疮性肾炎预后预测问题。通过结合病理图像和临床数据，提出新的模型以提高预测准确性。**

- **链接: [https://arxiv.org/pdf/2603.05535](https://arxiv.org/pdf/2603.05535)**
...
>
---
#### [new 157] Bias In, Bias Out? Finding Unbiased Subnetworks in Vanilla Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于模型偏见缓解任务，旨在从标准模型中提取无偏子网络。通过剪枝方法识别并隔离不依赖偏差特征的子网络，实现高效去偏。**
...
>
---
#### [new 158] Enhancing Neural Video Compression of Static Scenes with Positive-Incentive Noise
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于视频压缩任务，旨在解决静态场景视频编码效率低的问题。通过引入正向激励噪声，提升模型性能，实现更高效压缩与传输。**
...
>
---
#### [new 165] RoboLayout: Differentiable 3D Scene Generation for Embodied Agents
...
>
---
#### [new 166] Gabor Primitives for Accelerated Cardiac Cine MRI Reconstruction
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学影像重建任务，旨在解决加速心脏动态MRI的图像重构问题。通过引入Gabor primitives，提升高采样率下的图像质量与效率。**

- **链接: [https://arxiv.org/pdf/2603.05681](https://arxiv.org/pdf/2603.05681)**
...
>
---
#### [new 168] AutothinkRAG: Complexity-Aware Control of Retrieval-Augmented Reasoning for Image-Text Interaction
- **分类: cs.IR; cs.CV**

- **简介: 该论文属于文档问答任务，旨在解决长文本和信息过载导致的推理困难。提出AutoThinkRAG框架，通过模型协同提升复杂文档理解能力。**
...
>
---
#### [new 170] Digital-Twin Losses for Lane-Compliant Trajectory Prediction at Urban Intersections
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 171] Restoring Linguistic Grounding in VLA Models via Train-Free Attention Recalibration
...
>
---
#### [replaced 006] LikePhys: Evaluating Intuitive Physics Understanding in Video Diffusion Models via Likelihood Preference
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.11512](https://arxiv.org/pdf/2510.11512)**
...
>
---
#### [replaced 007] Co-Layout: LLM-driven Co-optimization for Interior Layout
- **分类: cs.CV; cs.CL; cs.GR**

- **简介: 该论文属于室内设计任务，解决布局与家具摆放的联合优化问题。通过结合LLM和整数规划，提升设计质量和计算效率。**

- **链接: [https://arxiv.org/pdf/2511.12474](https://arxiv.org/pdf/2511.12474)**
...
>
---
#### [replaced 011] Kiwi-Edit: Versatile Video Editing via Instruction and Reference Guidance
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 018] UniTS: Unified Spatio-Temporal Generative Model for Remote Sensing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.04461](https://arxiv.org/pdf/2512.04461)**
...
>
---
#### [replaced 020] C^2Prompt: Class-aware Client Knowledge Interaction for Federated Continual Learning
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.19674](https://arxiv.org/pdf/2509.19674)**
...
>
---
#### [replaced 026] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.18923](https://arxiv.org/pdf/2507.18923)**
...
>
---
#### [replaced 027] LaxMotion: Rethinking Supervision Granularity for 3D Human Motion Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.11368](https://arxiv.org/pdf/2511.11368)**
...
>
---
#### [replaced 028] SyncMV4D: Synchronized Multi-view Joint Diffusion of Appearance and Motion for Hand-Object Interaction Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.19319](https://arxiv.org/pdf/2511.19319)**

> **作者:** Lingwei Dang; Zonghan Li; Juntong Li; Hongwen Zhang; Liang An; Yebin Liu; Qingyao Wu
>
> **备注:** The structure and logic of writing will undergo a complete revision
>
...
>
> **备注:** Accepted to CVPR 2026. All code and datasets will be publicly released at this https URL
>
...
>
---
#### [replaced 032] SPoT: Subpixel Placement of Tokens in Vision Transformers
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.01654](https://arxiv.org/pdf/2507.01654)**

> **作者:** Martine Hjelkrem-Tan; Marius Aasan; Gabriel Y. Arteaga; Adín Ramírez Rivera
>
> **备注:** Appeared in Workshop on Efficient Computing under Limited Resources: Visual Computing (ICCV 2025). Code available at this https URL
>
> **摘要:** Vision Transformers naturally accommodate sparsity, yet standard tokenization methods confine features to discrete patch grids. This constraint prevents models from fully exploiting sparse regimes, forcing awkward compromises. We propose Subpixel Placement of Tokens (SPoT), a novel tokenization strategy that positions tokens continuously within images, effectively sidestepping grid-based limitations. With our proposed oracle-guided search, we uncover substantial performance gains achievable with ideal subpixel token positioning, drastically reducing the number of tokens necessary for accurate predictions during inference. SPoT provides a new direction for flexible, efficient, and interpretable ViT architectures, redefining sparsity as a strategic advantage rather than an imposed limitation.
>
---
#### [replaced 033] SSL-SLR: Self-Supervised Representation Learning for Sign Language Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.05188](https://arxiv.org/pdf/2509.05188)**
...
>
---
#### [replaced 034] Transforming Science with Large Language Models: A Survey on AI-assisted Scientific Discovery, Experimentation, Content Generation, and Evaluation
- **分类: cs.CL; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于AI辅助科学发现的综述任务，旨在梳理AI在科研各环节的应用与挑战，涵盖文献检索、实验设计、内容生成及评价等，解决如何有效整合AI技术提升科研效率的问题。**

- **链接: [https://arxiv.org/pdf/2502.05151](https://arxiv.org/pdf/2502.05151)**
...
>
> **备注:** 46 pages, 7 figures, 7 tables
>
...
>
---
#### [replaced 037] SPARK: Jailbreaking T2V Models by Synergistically Prompting Auditory and Recontextualized Knowledge
- **分类: cs.CV; cs.CR**

- **链接: [https://arxiv.org/pdf/2511.13127](https://arxiv.org/pdf/2511.13127)**
...
>
---
#### [replaced 038] MAP: Mitigating Hallucinations in Large Vision-Language Models with Map-Level Attention Processing
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.01653](https://arxiv.org/pdf/2508.01653)**
...
>
---
#### [replaced 041] SPARC: Concept-Aligned Sparse Autoencoders for Cross-Model and Cross-Modal Interpretability
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.06265](https://arxiv.org/pdf/2507.06265)**
...
>
---
#### [replaced 042] A Novel Patch-Based TDA Approach for Computed Tomography Imaging
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.12108](https://arxiv.org/pdf/2512.12108)**

> **作者:** Dashti A. Ali; Aras T. Asaad; Jacob J. Peoples; Mohammad Hamghalam; Natalie Gangai; Richard K. G. Do; Alice C. Wei; Amber L. Simpson
>
...
>
---
#### [replaced 056] DFIR-DETR: Frequency-Domain Iterative Refinement and Dynamic Feature Aggregation for Small Object Detection
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 057] SRA 2: Variational Autoencoder Self-Representation Alignment for Efficient Diffusion Training
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.17830](https://arxiv.org/pdf/2601.17830)**
...
>
---
#### [replaced 058] DAV-GSWT: Diffusion-Active-View Sampling for Data-Efficient Gaussian Splatting Wang Tiles
- **分类: cs.CV**
...
>
---
#### [replaced 059] EgoCogNav: Cognition-aware Human Egocentric Navigation
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.17581](https://arxiv.org/pdf/2511.17581)**
...
>
---
#### [replaced 063] Think with 3D: Geometric Imagination Grounded Spatial Reasoning from Limited Views
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 064] Adaptive Dynamic Dehazing via Instruction-Driven and Task-Feedback Closed-Loop Optimization for Diverse Downstream Task Adaptation
- **分类: cs.CV**
...
>
---
#### [replaced 065] FALCON: Future-Aware Learning with Contextual Object-Centric Pretraining for UAV Action Recognition
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [replaced 066] Alchemist: Turning Public Text-to-Image Data into Generative Gold
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.19297](https://arxiv.org/pdf/2505.19297)**

> **作者:** Valerii Startsev; Alexander Ustyuzhanin; Alexey Kirillov; Dmitry Baranchuk; Sergey Kastryulin
>
> **备注:** Accepted to the Datasets and Benchmarks Track of the 39th Conference on Neural Information Processing Systems
>
...
>
---
#### [replaced 067] A method for tissue-mask supported whole-body image registration in the UK Biobank
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02702](https://arxiv.org/pdf/2512.02702)**
...
>
---
#### [replaced 068] A Multi-Agent System Enables Versatile Information Extraction from the Chemical Literature
- **分类: cs.AI; cs.CV; cs.MA**

- **链接: [https://arxiv.org/pdf/2507.20230](https://arxiv.org/pdf/2507.20230)**
...
>
---
#### [replaced 069] SGDFuse: SAM-Guided Diffusion Model for High-Fidelity Infrared and Visible Image Fusion
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.05264](https://arxiv.org/pdf/2508.05264)**

> **作者:** Xiaoyang Zhang; jinjiang Li; Guodong Fan; Yakun Ju; Linwei Fan; Jun Liu; Alex C. Kot
>
> **备注:** Accept by Information Fusion
>
...
>
---
#### [replaced 070] Decoupling Bias, Aligning Distributions: Synergistic Fairness Optimization for Deepfake Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.10150](https://arxiv.org/pdf/2511.10150)**
...
>
---
#### [replaced 073] Mobile-VTON: High-Fidelity On-Device Virtual Try-On
- **分类: cs.CV**
...
>
---
#### [replaced 074] Token Bottleneck: One Token to Remember Dynamics
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.06543](https://arxiv.org/pdf/2507.06543)**

> **作者:** Taekyung Kim; Dongyoon Han; Byeongho Heo; Jeongeun Park; Sangdoo Yun
>
> **备注:** NeurIPS 2025, 18 pages, 9 figures, 10 tables, project page: this https URL, code: this https URL
>
...
>
---
#### [replaced 077] OnlineSI: Taming Large Language Model for Online 3D Understanding and Grounding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.16538](https://arxiv.org/pdf/2601.16538)**
...
>
---
#### [replaced 078] (MGS)$^2$-Net: Unifying Micro-Geometric Scale and Macro-Geometric Structure for Cross-View Geo-Localization
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 081] MRIQT: Physics-Aware Diffusion Model for Image Quality Transfer in Neonatal Ultra-Low-Field MRI
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13232](https://arxiv.org/pdf/2511.13232)**
...
>
---
#### [replaced 084] Probing and Bridging Geometry-Interaction Cues for Affordance Reasoning in Vision Foundation Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.20501](https://arxiv.org/pdf/2602.20501)**
...
>
---
#### [replaced 085] Maximizing Asynchronicity in Event-based Neural Networks
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **简介: 该论文属于事件相机的视觉任务，旨在解决异步事件数据与传统机器学习不兼容的问题。提出EVA框架，提升事件特征的表达能力和泛化性，实现高效实时处理。**

- **链接: [https://arxiv.org/pdf/2505.11165](https://arxiv.org/pdf/2505.11165)**

> **作者:** Haiqing Hao; Nikola Zubić; Weihua He; Zhipeng Sui; Davide Scaramuzza; Wenhui Wang
>
> **备注:** 22 pages, 7 figures, 15 tables, ICLR 2026 Camera Ready paper
>
...
>
---
#### [replaced 089] FunnyNodules: A Customizable Medical Dataset Tailored for Evaluating Explainable AI
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.15481](https://arxiv.org/pdf/2511.15481)**
...
>
---
#### [replaced 090] Fast-BEV++: Fast by Algorithm, Deployable by Design
- **分类: cs.CV**
...
>
---
#### [replaced 091] Spatial4D-Bench: A Versatile 4D Spatial Intelligence Benchmark
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.00092](https://arxiv.org/pdf/2601.00092)**
...
>
---
#### [replaced 097] VisioMath: Benchmarking Figure-based Mathematical Reasoning in LMMs
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.06727](https://arxiv.org/pdf/2506.06727)**
...
>
---
#### [replaced 098] UrbanAlign: Post-hoc Semantic Calibration for VLM-Human Preference Alignment
- **分类: cs.CV**
...
>
---
#### [replaced 099] DianJin-OCR-R1: Enhancing OCR Capabilities via a Reasoning-and-Tool Interleaved Vision-Language Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.13238](https://arxiv.org/pdf/2508.13238)**
