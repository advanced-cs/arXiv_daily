...
- **简介: 该论文属于立体匹配任务，旨在解决恶劣天气下模型泛化能力差的问题。通过生成合成数据和设计鲁棒特征编码器提升模型在极端条件下的性能。**
...
- **简介: 该论文属于医学图像分割任务，旨在解决MRI模态缺失时脑肿瘤分割精度下降的问题。通过引入Hölder散度和互信息增强的知识迁移方法，提升模型鲁棒性。**
...
- **简介: 该论文属于光照估计任务，解决从单张LDR图像生成HDR光探针的问题。通过改进扩散模型和引入加速方法，提升效率与质量。**
...
- **简介: 该论文属于 hyperspectral reconstruction 任务，解决从 RGB 图像重建高光谱图像的问题。通过多视角和光谱滤镜提升重建精度。**
...
- **简介: 该论文属于人-物交互生成任务，解决现有方法无法建模真实交互动态的问题。提出HOI-Dyn框架，通过驱动-响应机制和轻量Transformer模型提升生成质量。**
...
- **链接: [http://arxiv.org/pdf/2507.01800v1](http://arxiv.org/pdf/2507.01800v1)**
...
- **简介: 该论文属于事件视觉数据过滤任务，旨在减少事件相机数据中的噪声。提出四种IIR滤波算法，有效去除约99%噪声，适合嵌入式设备应用。**
...
- **链接: [http://arxiv.org/pdf/2507.01607v1](http://arxiv.org/pdf/2507.01607v1)**
...
- **链接: [http://arxiv.org/pdf/2507.01756v1](http://arxiv.org/pdf/2507.01756v1)**
...
- **简介: 该论文属于树冠检测任务，旨在提升卫星图像中树冠识别的准确性与鲁棒性。通过融合传统方法与深度学习，提出一种规则集成方法进行优化。**
...
- **链接: [http://arxiv.org/pdf/2507.01478v1](http://arxiv.org/pdf/2507.01478v1)**
...
- **简介: 该论文属于 Talking Head 生成任务，旨在解决身份泄露和渲染伪影问题。提出 FixTalk 框架，通过 EMI 和 EDI 同时缓解这两个问题。**
...
- **简介: 该论文属于视频理解任务，旨在提升多模态大模型对短视频的解析能力。通过构建大规模数据集和创新训练方法，提出Keye-VL模型，显著提升视频理解和推理性能。**
...
- **简介: 该论文属于弱监督分割任务，解决标签稀缺问题。通过软自标注和Potts松弛优化，提升模型性能。**
...
- **链接: [http://arxiv.org/pdf/2507.01494v1](http://arxiv.org/pdf/2507.01494v1)**
...
- **链接: [http://arxiv.org/pdf/2507.01428v1](http://arxiv.org/pdf/2507.01428v1)**
...
- **简介: 该论文提出NOCTIS框架，解决RGB图像中未见物体实例分割问题，无需重新训练即可泛化到不同物体。**
...
- **简介: 该论文属于图像生成任务，旨在加速自回归图像生成。通过引入两种技术，减少生成步骤并降低延迟，同时保持生成质量。**
...
- **简介: 该论文属于OOD检测任务，旨在解决模型在开放世界中对异常输入的识别问题。通过分析梯度特性，提出一种轻量级方法提升检测效果。**
...
- **简介: 该论文属于图像生成任务，旨在解决扩散模型训练效率低的问题。提出REG方法，通过图像潜变量与高阶语义token的纠缠，提升生成质量和训练速度。**
...
- **简介: 该论文属于图像变形任务，解决传统方法依赖微调和效率低的问题。提出FreeMorph，通过创新的插值设计和步骤趋势控制，实现高效高质量的图像变形。**
...
- **简介: 该论文属于果园自动化任务，解决植被遮挡导致的树体结构识别问题。通过融合冬眠期与生长期的多季节数据，实现精准的3D重建与模型对齐。**
...
- **简介: 该论文属于2D动画上色任务，旨在解决人工上色耗时问题。提出SketchColour方法，利用DiT架构和轻量适配器实现高效、连贯的自动上色。**
...
- **简介: 该论文属于AI生成视频评估任务，旨在解决现有评估方法缺乏解释性的问题。提出AIGVE-MACS模型，提供多方面评分与评论，提升评估的可解释性与人类一致性。**
...
>
---
#### [new 067] Boosting Adversarial Transferability Against Defenses via Multi-Scale Transformation
- **分类: cs.CV**

- **简介: 该论文属于对抗攻击任务，旨在提升对抗样本的迁移性以突破防御模型。通过多尺度变换方法增强攻击效果。**

- **链接: [http://arxiv.org/pdf/2507.01791v1](http://arxiv.org/pdf/2507.01791v1)**
...
>
---
#### [new 068] Following the Clues: Experiments on Person Re-ID using Cross-Modal Intelligence
...
>
---
#### [new 069] Coherent Online Road Topology Estimation and Reasoning with Standard-Definition Maps
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于自动驾驶中的地图构建任务，旨在解决在线生成高精度地图的难题。通过融合标准地图信息与传感器数据，提升地图构建的准确性和一致性。**

- **链接: [http://arxiv.org/pdf/2507.01397v1](http://arxiv.org/pdf/2507.01397v1)**
...
>
---
#### [new 070] Landslide Detection and Mapping Using Deep Learning Across Multi-Source Satellite Data and Geographic Regions
- **分类: cs.CV; cs.LG; eess.IV**

- **简介: 该论文属于 landslide detection 任务，旨在通过深度学习和多源卫星数据提高滑坡识别与预测的准确性。**

- **链接: [http://arxiv.org/pdf/2507.01123v1](http://arxiv.org/pdf/2507.01123v1)**
...
>
---
#### [new 071] SPoT: Subpixel Placement of Tokens in Vision Transformers
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视觉Transformer任务，解决传统token化方法受限于离散网格的问题。提出SPoT方法实现token的亚像素定位，提升模型效率与性能。**

- **链接: [http://arxiv.org/pdf/2507.01654v1](http://arxiv.org/pdf/2507.01654v1)**

> **作者:** Martine Hjelkrem-Tan; Marius Aasan; Gabriel Y. Arteaga; Adín Ramírez Rivera
>
> **备注:** To appear in Workshop on Efficient Computing under Limited Resources: Visual Computing (ICCV 2025). Code available at https://github.com/dsb-ifi/SPoT
>
...
>
---
#### [new 072] Learning Camera-Agnostic White-Balance Preferences
- **分类: cs.CV**

- **简介: 该论文属于图像处理任务，解决跨相机白平衡一致性问题。通过学习后照明映射，实现风格化色彩渲染，模型轻量且高效。**

- **链接: [http://arxiv.org/pdf/2507.01342v1](http://arxiv.org/pdf/2507.01342v1)**
...
>
---
#### [new 076] 3D Gaussian Splatting Driven Multi-View Robust Physical Adversarial Camouflage Generation
- **分类: cs.CV**

- **简介: 该论文属于物理对抗攻击任务，旨在生成多视角鲁棒的伪装攻击。针对现有方法依赖虚拟环境和背景限制的问题，提出基于3D高斯泼溅的PGA框架，提升攻击效果与鲁棒性。**

- **链接: [http://arxiv.org/pdf/2507.01367v1](http://arxiv.org/pdf/2507.01367v1)**
...
>
---
#### [new 077] A Multi-Centric Anthropomorphic 3D CT Phantom-Based Benchmark Dataset for Harmonization
- **分类: cs.CV**

- **简介: 该论文属于医学AI领域，旨在解决CT图像数据分布差异导致的模型泛化问题。通过构建多中心3D人体phantom数据集，促进AI harmonization技术的发展。**

- **链接: [http://arxiv.org/pdf/2507.01539v1](http://arxiv.org/pdf/2507.01539v1)**
...
>
---
#### [new 079] Autoregressive Image Generation with Linear Complexity: A Spatial-Aware Decay Perspective
- **分类: cs.CV; cs.AI; cs.MM**

- **简介: 该论文属于图像生成任务，旨在解决AR模型计算复杂度高和空间依赖捕获不足的问题。提出LASAD机制，实现线性复杂度下的高效图像生成。**

- **链接: [http://arxiv.org/pdf/2507.01652v1](http://arxiv.org/pdf/2507.01652v1)**
...
>
---
#### [new 080] Activation Reward Models for Few-Shot Model Alignment
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于模型对齐任务，旨在解决传统奖励模型适应新偏好困难的问题。提出Activation RMs方法，在少量监督下构建对齐奖励信号，提升安全性和性能。**

- **链接: [http://arxiv.org/pdf/2507.01368v1](http://arxiv.org/pdf/2507.01368v1)**
...
>
---
#### [new 081] Using Wavelet Domain Fingerprints to Improve Source Camera Identification
- **分类: cs.CV; eess.IV; stat.AP**

- **简介: 该论文属于图像取证任务，旨在提高源相机识别的准确性与效率。通过引入小波域指纹，避免了去噪后的图像重建步骤，直接在小波域进行比较，提升了处理速度和检测精度。**

- **链接: [http://arxiv.org/pdf/2507.01712v1](http://arxiv.org/pdf/2507.01712v1)**
...
>
---
#### [new 082] ECCV 2024 W-CODA: 1st Workshop on Multimodal Perception and Comprehension of Corner Cases in Autonomous Driving
...
>
---
#### [new 083] Autonomous AI Surveillance: Multimodal Deep Learning for Cognitive and Behavioral Monitoring
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于课堂监控任务，旨在提升学生注意力评估的准确性。通过多模态深度学习技术，结合手机检测、睡眠识别和人脸识别，实现实时行为分析与自动考勤。**

- **链接: [http://arxiv.org/pdf/2507.01590v1](http://arxiv.org/pdf/2507.01590v1)**
...
>
---
#### [new 086] How Well Does GPT-4o Understand Vision? Evaluating Multimodal Foundation Models on Standard Computer Vision Tasks
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于计算机视觉任务，评估多模态大模型在标准视觉任务中的表现，解决模型理解视觉能力不足的问题，通过构建基准框架进行性能对比分析。**

- **链接: [http://arxiv.org/pdf/2507.01955v1](http://arxiv.org/pdf/2507.01955v1)**
...
>
---
#### [new 087] Towards Controllable Real Image Denoising with Camera Parameters
- **分类: cs.CV; eess.IV**

- **简介: 该论文属于图像去噪任务，旨在解决传统方法缺乏可调性的问题。通过引入相机参数（如ISO、快门速度、光圈）控制去噪强度，提升去噪效果。**

- **链接: [http://arxiv.org/pdf/2507.01587v1](http://arxiv.org/pdf/2507.01587v1)**
...
>
---
#### [new 092] Escaping Platos Cave: JAM for Aligning Independently Trained Vision and Language Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于多模态对齐任务，旨在解决独立训练的视觉与语言模型间表示不一致的问题。通过JAM框架，联合训练自动编码器以实现跨模态对齐。**

- **链接: [http://arxiv.org/pdf/2507.01201v1](http://arxiv.org/pdf/2507.01201v1)**
...
>
---
#### [new 093] How Do Vision-Language Models Process Conflicting Information Across Modalities?
...
>
---
#### [new 094] MID-INFRARED (MIR) OCT-based inspection in industry
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于工业无损检测任务，旨在评估MIR OCT系统在材料内部缺陷检测中的应用，通过实验和算法分析提升检测效果。**

- **链接: [http://arxiv.org/pdf/2507.01074v1](http://arxiv.org/pdf/2507.01074v1)**
...
>
---
#### [new 096] VLAD: A VLM-Augmented Autonomous Driving Framework with Hierarchical Planning and Interpretable Decision Process
...
>
---
#### [new 097] Robust brain age estimation from structural MRI with contrastive learning
- **分类: eess.IV; cs.CV; 68T07; I.2.6**

- **简介: 该论文属于脑龄估计任务，旨在提高模型的泛化性和鲁棒性。通过对比学习方法，设计新损失函数$\mathcal{L}^{exp}$，在多数据集上验证其有效性。**

- **链接: [http://arxiv.org/pdf/2507.01794v1](http://arxiv.org/pdf/2507.01794v1)**
...
>
---
#### [new 098] Multi Source COVID-19 Detection via Kernel-Density-based Slice Sampling
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于多源新冠检测任务，旨在解决跨机构CT图像分类问题。通过KDS方法提取特征并比较模型性能，提升分类准确性。**

- **链接: [http://arxiv.org/pdf/2507.01564v1](http://arxiv.org/pdf/2507.01564v1)**
...
>
---
#### [new 099] Age Sensitive Hippocampal Functional Connectivity: New Insights from 3D CNNs and Saliency Mapping
- **分类: q-bio.NC; cs.AI; cs.CV**

- **简介: 该论文属于神经影像分析任务，旨在揭示海马体功能连接随年龄变化的机制。通过3D CNN和显著性映射，识别关键连接区域，提供可解释的衰老机制洞察。**

- **链接: [http://arxiv.org/pdf/2507.01411v1](http://arxiv.org/pdf/2507.01411v1)**
...
>
---
#### [new 100] Autoadaptive Medical Segment Anything Model
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决标注数据稀缺下的分割精度问题。提出ADA-SAM模型，结合分类与分割，提升半监督学习效果。**

- **链接: [http://arxiv.org/pdf/2507.01828v1](http://arxiv.org/pdf/2507.01828v1)**
...
>
---
#### [new 101] SafePTR: Token-Level Jailbreak Defense in Multimodal LLMs via Prune-then-Restore Mechanism
- **分类: cs.CR; cs.CV**

- **简介: 该论文属于多模态大模型安全任务，旨在解决 multimodal jailbreak 攻击问题。通过分析并移除有害token，提出SafePTR框架提升安全性。**

- **链接: [http://arxiv.org/pdf/2507.01513v1](http://arxiv.org/pdf/2507.01513v1)**
...
>
---
#### [new 102] Embedding-based Retrieval in Multimodal Content Moderation
- **分类: cs.IR; cs.CV; cs.LG**

- **简介: 该论文属于内容 moderation 任务，旨在解决传统分类方法在快速响应和成本效率上的不足。通过引入基于嵌入的检索方法（EBR），提升趋势处理效果与效率。**

- **链接: [http://arxiv.org/pdf/2507.01066v1](http://arxiv.org/pdf/2507.01066v1)**
...
>
---
#### [new 103] Empowering Manufacturers with Privacy-Preserving AI Tools: A Case Study in Privacy-Preserving Machine Learning to Solve Real-World Problems
- **分类: cs.CR; cs.AI; cs.CV; cs.ET; 68T01, 68T05, 68T45, 94A60**

- **简介: 该论文属于隐私保护机器学习任务，旨在解决制造商数据共享与隐私矛盾的问题。通过开发安全工具实现数据共享与分析，提升食品晶体质量控制效率。**

- **链接: [http://arxiv.org/pdf/2507.01808v1](http://arxiv.org/pdf/2507.01808v1)**
...
>
---
#### [new 108] A computationally frugal open-source foundation model for thoracic disease detection in lung cancer screening programs
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学影像分析任务，旨在解决肺癌筛查中放射科医生不足的问题。提出TANGERINE模型，实现高效、低成本的胸部疾病检测。**

- **链接: [http://arxiv.org/pdf/2507.01881v1](http://arxiv.org/pdf/2507.01881v1)**
...
>
---
#### [new 110] LANet: A Lane Boundaries-Aware Approach For Robust Trajectory Prediction
- **分类: cs.RO; cs.CV**
...
#### [replaced 001] Advancing Textual Prompt Learning with Anchored Attributes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.09442v3](http://arxiv.org/pdf/2412.09442v3)**
...
>
---
#### [replaced 004] Reducing Variability of Multiple Instance Learning Methods for Digital Pathology
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.00292v2](http://arxiv.org/pdf/2507.00292v2)**

> **作者:** Ali Mammadov; Loïc Le Folgoc; Guillaume Hocquet; Pietro Gori
>
> **备注:** MICCAI 2025 - This preprint has not undergone peer review or any post-submission improvements or corrections. The Version of Record of this article is published in LNCS, Springer
>
...
>
---
#### [replaced 005] Articulate3D: Holistic Understanding of 3D Scenes as Universal Scene Description
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 006] Unsupervised Panoptic Interpretation of Latent Spaces in GANs Using Space-Filling Vector Quantization
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.20573v2](http://arxiv.org/pdf/2410.20573v2)**
...
>
---
#### [replaced 007] 2HandedAfforder: Learning Precise Actionable Bimanual Affordances from Human Videos
...
>
---
#### [replaced 010] A Baseline Method for Removing Invisible Image Watermarks using Deep Image Prior
- **分类: eess.IV; cs.AI; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.13998v2](http://arxiv.org/pdf/2502.13998v2)**

> **作者:** Hengyue Liang; Taihui Li; Ju Sun
>
> **备注:** Pulished in Transaction of Machine Learning Research (TMLR): https://openreview.net/forum?id=g85Vxlrq0O
>
...
>
---
#### [replaced 011] UniGlyph: Unified Segmentation-Conditioned Diffusion for Precise Visual Text Synthesis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00992v2](http://arxiv.org/pdf/2507.00992v2)**

> **作者:** Yuanrui Wang; Cong Han; Yafei Li; Zhipeng Jin; Xiawei Li; SiNan Du; Wen Tao; Yi Yang; Shuanglong Li; Chun Yuan; Liu Lin
>
> **备注:** Accepted by ICCV 2025
>
...
>
---
#### [replaced 012] Real-Time Blind Defocus Deblurring for Earth Observation: The IMAGIN-e Mission Approach
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.22128v2](http://arxiv.org/pdf/2505.22128v2)**

> **作者:** Alejandro D. Mousist
>
> **备注:** Accepted for presentation at the European Space Agency's Big Data from Space (BiDS) 2025 Conference (https://www.bigdatafromspace2025.org/)
>
...
>
---
#### [replaced 013] Admitting Ignorance Helps the Video Question Answering Models to Answer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.08771v2](http://arxiv.org/pdf/2501.08771v2)**
...
>
---
#### [replaced 014] Is Visual in-Context Learning for Compositional Medical Tasks within Reach?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00868v2](http://arxiv.org/pdf/2507.00868v2)**
...
>
---
#### [replaced 019] Towards Cardiac MRI Foundation Models: Comprehensive Visual-Tabular Representations for Whole-Heart Assessment and Beyond
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.13037v3](http://arxiv.org/pdf/2504.13037v3)**
...
>
---
#### [replaced 022] LUSD: Localized Update Score Distillation for Text-Guided Image Editing
- **分类: cs.GR; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.11054v2](http://arxiv.org/pdf/2503.11054v2)**
...
>
---
#### [replaced 030] BusterX: MLLM-Powered AI-Generated Video Forgery Detection and Explanation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.12620v3](http://arxiv.org/pdf/2505.12620v3)**
...
>
---
#### [replaced 036] Hierarchical Patch Compression for ColPali: Efficient Multi-Vector Document Retrieval with Dynamic Pruning and Quantization
- **分类: cs.IR; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21601v2](http://arxiv.org/pdf/2506.21601v2)**
...
>
---
#### [replaced 037] GraphGSOcc: Semantic-Geometric Graph Transformer with Dynamic-Static Decoupling for 3D Gaussian Splatting-based Occupancy Prediction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.14825v2](http://arxiv.org/pdf/2506.14825v2)**
...
>
---
#### [replaced 041] Unified Triplet-Level Hallucination Evaluation for Large Vision-Language Models
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 042] Towards Universal & Efficient Model Compression via Exponential Torque Pruning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.22015v2](http://arxiv.org/pdf/2506.22015v2)**
...
>
---
#### [replaced 043] Average Calibration Error: A Differentiable Loss for Improved Reliability in Image Segmentation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2403.06759v2](http://arxiv.org/pdf/2403.06759v2)**
...
>
---
#### [replaced 046] Semantic Alignment and Reinforcement for Data-Free Quantization of Vision Transformers
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.16553v3](http://arxiv.org/pdf/2412.16553v3)**
...
>
---
#### [replaced 047] EP-Diffuser: An Efficient Diffusion Model for Traffic Scene Generation and Prediction via Polynomial Representations
- **分类: cs.CV; cs.LG; cs.RO**
...
>
---
#### [replaced 048] Mod-Adapter: Tuning-Free and Versatile Multi-concept Personalization via Modulation Adapter
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18612v2](http://arxiv.org/pdf/2505.18612v2)**
...
>
---
#### [replaced 049] SURE-VQA: Systematic Understanding of Robustness Evaluation in Medical VQA Tasks
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.19688v2](http://arxiv.org/pdf/2411.19688v2)**
...
>
---
#### [replaced 050] Evolutionary Caching to Accelerate Your Off-the-Shelf Diffusion Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.15682v2](http://arxiv.org/pdf/2506.15682v2)**
...
>
---
#### [replaced 053] ExPaMoE: An Expandable Parallel Mixture of Experts for Continual Test-Time Adaptation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00502v2](http://arxiv.org/pdf/2507.00502v2)**

> **作者:** JianChao Zhao; Chenhao Ding; Songlin Dong; Yuhang He; Yihong Gong
>
...
>
---
#### [replaced 054] Scaling Open-Vocabulary Action Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.03096v3](http://arxiv.org/pdf/2504.03096v3)**
...
>
---
#### [replaced 055] Graph-Based Deep Learning for Component Segmentation of Maize Plants
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00182v2](http://arxiv.org/pdf/2507.00182v2)**

> **作者:** J. I. Ruiz-Martinez; A. Mendez-Vazquez; E. Rodriguez-Tello
>
...
>
---
#### [replaced 056] Just Noticeable Difference for Large Multimodal Models
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2507.00490v2](http://arxiv.org/pdf/2507.00490v2)**
...
>
---
#### [replaced 057] Robust 6DoF Pose Tracking Considering Contour and Interior Correspondence Uncertainty for AR Assembly Guidance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.11971v4](http://arxiv.org/pdf/2502.11971v4)**
...
>
---
#### [replaced 058] Real-Time AIoT for AAV Antenna Interference Detection via Edge-Cloud Collaboration
- **分类: eess.SP; cs.CV**
...
>
---
#### [replaced 059] On Efficient Variants of Segment Anything Model: A Survey
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.04960v3](http://arxiv.org/pdf/2410.04960v3)**
...
>
---
#### [replaced 060] Diffusion-based Iterative Counterfactual Explanations for Fetal Ultrasound Image Quality Assessment
- **分类: eess.IV; cs.CV; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2403.08700v2](http://arxiv.org/pdf/2403.08700v2)**

> **作者:** Paraskevas Pegios; Manxi Lin; Nina Weng; Morten Bo Søndergaard Svendsen; Zahra Bashir; Siavash Bigdeli; Anders Nymark Christensen; Martin Tolsgaard; Aasa Feragen
>
> **摘要:** Obstetric ultrasound image quality is crucial for accurate diagnosis and monitoring of fetal health. However, acquiring high-quality standard planes is difficult, influenced by the sonographer's expertise and factors like the maternal BMI or fetus dynamics. In this work, we explore diffusion-based counterfactual explainable AI to generate realistic, high-quality standard planes from low-quality non-standard ones. Through quantitative and qualitative evaluation, we demonstrate the effectiveness of our approach in generating plausible counterfactuals of increased quality. This shows future promise for enhancing training of clinicians by providing visual feedback and potentially improving standard plane quality and acquisition for downstream diagnosis and monitoring.
>
---
#### [replaced 061] DeGauss: Dynamic-Static Decomposition with Gaussian Splatting for Distractor-free 3D Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.13176v2](http://arxiv.org/pdf/2503.13176v2)**
...
>
---
#### [replaced 062] GLM-4.1V-Thinking: Towards Versatile Multimodal Reasoning with Scalable Reinforcement Learning
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.01006v2](http://arxiv.org/pdf/2507.01006v2)**
...
>
---
#### [replaced 063] There and Back Again: On the relation between Noise and Image Inversions in Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2410.23530v3](http://arxiv.org/pdf/2410.23530v3)**
...
>
---
#### [replaced 064] TC-Light: Temporally Coherent Generative Rendering for Realistic World Transfer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.18904v2](http://arxiv.org/pdf/2506.18904v2)**

> **作者:** Yang Liu; Chuanchen Luo; Zimo Tang; Yingyan Li; Yuran Yang; Yuanyong Ning; Lue Fan; Zhaoxiang Zhang; Junran Peng
>
...
>
---
#### [replaced 067] Perceiving Beyond Language Priors: Enhancing Visual Comprehension and Attention in Multimodal Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.05626v3](http://arxiv.org/pdf/2505.05626v3)**

> **作者:** Aarti Ghatkesar; Ganesh Venkatesh
>
...
>
---
#### [replaced 068] A Review of Bayesian Uncertainty Quantification in Deep Probabilistic Image Segmentation
- **分类: cs.CV; cs.AI; cs.LG; eess.IV; stat.ML**

- **链接: [http://arxiv.org/pdf/2411.16370v4](http://arxiv.org/pdf/2411.16370v4)**

> **作者:** M. M. A. Valiuddin; R. J. G. van Sloun; C. G. A. Viviers; P. H. N. de With; F. van der Sommen
>
> **备注:** 31 pages of content, revised
>
...
>
---
#### [replaced 069] Efficient Self-Supervised Adaptation for Medical Image Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.18873v2](http://arxiv.org/pdf/2503.18873v2)**

> **作者:** Moein Sorkhei; Emir Konuk; Jingyu Guo; Chanjuan Meng; Christos Matsoukas; Kevin Smith
>
...
>
---
#### [replaced 073] Generalizable Neural Electromagnetic Inverse Scattering
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2506.21349v2](http://arxiv.org/pdf/2506.21349v2)**
