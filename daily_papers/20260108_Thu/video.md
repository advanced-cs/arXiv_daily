...
#### [new 001] FocusUI: Efficient UI Grounding via Position-Preserving Visual Token Selection
...
>
---
#### [new 002] ImLoc: Revisiting Visual Localization with Image-based Representation
- **分类: cs.CV**

- **简介: 该论文属于视觉定位任务，解决传统方法在几何推理和更新性上的不足。通过引入带深度图的2D图像表示，提升定位精度与效率。**

- **链接: [https://arxiv.org/pdf/2601.04185v1](https://arxiv.org/pdf/2601.04185v1)**

> **作者:** Xudong Jiang; Fangjinhua Wang; Silvano Galliani; Christoph Vogel; Marc Pollefeys
>
> **备注:** Code will be available at https://github.com/cvg/Hierarchical-Localization
>
> **摘要:** Existing visual localization methods are typically either 2D image-based, which are easy to build and maintain but limited in effective geometric reasoning, or 3D structure-based, which achieve high accuracy but require a centralized reconstruction and are difficult to update. In this work, we revisit visual localization with a 2D image-based representation and propose to augment each image with estimated depth maps to capture the geometric structure. Supported by the effective use of dense matchers, this representation is not only easy to build and maintain, but achieves highest accuracy in challenging conditions. With compact compression and a GPU-accelerated LO-RANSAC implementation, the whole pipeline is efficient in both storage and computation and allows for a flexible trade-off between accuracy and highest memory efficiency. Our method achieves a new state-of-the-art accuracy on various standard benchmarks and outperforms existing memory-efficient methods at comparable map sizes. Code will be available at https://github.com/cvg/Hierarchical-Localization.
>
---
#### [new 003] MMErroR: A Benchmark for Erroneous Reasoning in Vision-Language Models
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视觉语言模型错误推理检测任务，旨在评估模型识别和分类推理错误的能力。研究构建了MMErroR基准，包含2013个样本，用于过程级错误分析。**

- **链接: [https://arxiv.org/pdf/2601.03331v1](https://arxiv.org/pdf/2601.03331v1)**
...
>
---
#### [new 004] Adaptive Attention Distillation for Robust Few-Shot Segmentation under Environmental Perturbations
- **分类: cs.CV**

- **简介: 该论文属于少样本分割任务，旨在提升模型在复杂环境下的鲁棒性。通过引入环境干扰因素和提出自适应注意力蒸馏方法，增强模型对未知目标的识别能力。**

- **链接: [https://arxiv.org/pdf/2601.03596v1](https://arxiv.org/pdf/2601.03596v1)**
...
>
---
#### [new 005] EASLT: Emotion-Aware Sign Language Translation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 006] Thinking with Frames: Generative Video Distortion Evaluation via Frame Reward Model
- **分类: cs.CV**

- **简介: 该论文属于视频生成质量评估任务，旨在解决结构失真检测问题。提出REACT模型，通过帧级评分和归因分析，提升对视频结构失真的评估能力。**

- **链接: [https://arxiv.org/pdf/2601.04033v1](https://arxiv.org/pdf/2601.04033v1)**
...
>
---
#### [new 007] RiskCueBench: Benchmarking Anticipatory Reasoning from Early Risk Cues in Video-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 008] IDESplat: Iterative Depth Probability Estimation for Generalizable 3D Gaussian Splatting
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于3D重建任务，解决Gaussian参数预测难题，特别是深度估计不稳定问题。通过迭代深度概率估计提升重建精度。**

- **链接: [https://arxiv.org/pdf/2601.03824v1](https://arxiv.org/pdf/2601.03824v1)**
...
>
---
#### [new 015] Latent Geometry of Taste: Scalable Low-Rank Matrix Factorization
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于推荐系统任务，解决协同过滤中的可扩展性和数据稀疏性问题。通过低秩矩阵分解和优化，提升模型泛化能力，并验证其在冷启动场景中的有效性。**

- **链接: [https://arxiv.org/pdf/2601.03466v1](https://arxiv.org/pdf/2601.03466v1)**
...
>
---
#### [new 016] Higher order PCA-like rotation-invariant features for detailed shape descriptors modulo rotation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于形状描述任务，旨在解决旋转不变特征提取问题。通过扩展PCA至高阶张量，提出更精确的旋转不变特征，用于形状匹配与识别。**

- **链接: [https://arxiv.org/pdf/2601.03326v1](https://arxiv.org/pdf/2601.03326v1)**

> **作者:** Jarek Duda
>
> **备注:** 4 pages, 4 figures
>
> **摘要:** PCA can be used for rotation invariant features, describing a shape with its $p_{ab}=E[(x_i-E[x_a])(x_b-E[x_b])]$ covariance matrix approximating shape by ellipsoid, allowing for rotation invariants like its traces of powers. However, real shapes are usually much more complicated, hence there is proposed its extension to e.g. $p_{abc}=E[(x_a-E[x_a])(x_b-E[x_b])(x_c-E[x_c])]$ order-3 or higher tensors describing central moments, or polynomial times Gaussian allowing decodable shape descriptors of arbitrarily high accuracy, and their analogous rotation invariants. Its practical applications could be rotation-invariant features to include shape modulo rotation e.g. for molecular shape descriptors, or for up to rotation object recognition in 2D images/3D scans, or shape similarity metric allowing their inexpensive comparison (modulo rotation) without costly optimization over rotations.
>
---
#### [new 017] Systematic Evaluation of Depth Backbones and Semantic Cues for Monocular Pseudo-LiDAR 3D Detection
...
>
---
#### [new 018] MFC-RFNet: A Multi-scale Guided Rectified Flow Network for Radar Sequence Prediction
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MFC-RFNet，用于雷达回波序列预测，解决多尺度演化建模、帧间对齐和长时序依赖捕捉问题。**

- **链接: [https://arxiv.org/pdf/2601.03633v1](https://arxiv.org/pdf/2601.03633v1)**
...
>
---
#### [new 019] RadDiff: Describing Differences in Radiology Image Sets with Natural Language
...
>
---
#### [new 024] FLNet: Flood-Induced Agriculture Damage Assessment using Super Resolution of Satellite Images
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于农业灾害评估任务，旨在解决洪水后作物损伤快速准确评估问题。通过引入FLNet模型，提升卫星图像分辨率并进行损伤分类，提高评估效果。**

- **链接: [https://arxiv.org/pdf/2601.03884v1](https://arxiv.org/pdf/2601.03884v1)**
...
>
---
#### [new 027] GeoReason: Aligning Thinking And Answering In Remote Sensing Vision-Language Models Via Logical Consistency Reinforcement Learning
- **分类: cs.CV**

- **简介: 该论文属于遥感视觉-语言模型任务，旨在解决逻辑幻觉问题。通过构建数据集和强化学习方法，提升模型推理的逻辑一致性和可靠性。**

- **链接: [https://arxiv.org/pdf/2601.04118v1](https://arxiv.org/pdf/2601.04118v1)**
...
>
---
#### [new 028] I2E: From Image Pixels to Actionable Interactive Environments for Text-Guided Image Editing
- **分类: cs.CV**

- **简介: 该论文属于文本引导图像编辑任务，旨在解决复杂组合编辑中的局部控制与多对象空间推理问题。提出I2E框架，通过分解图像并生成可操作动作序列实现精准编辑。**

- **链接: [https://arxiv.org/pdf/2601.03741v1](https://arxiv.org/pdf/2601.03741v1)**
...
>
---
#### [new 029] Can LLMs See Without Pixels? Benchmarking Spatial Intelligence from Textual Descriptions
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于空间智能任务，旨在检验LLMs在无像素输入下的空间理解能力。通过构建SiT-Bench基准，评估LLMs的符号推理能力，揭示其空间建模潜力。**

- **链接: [https://arxiv.org/pdf/2601.03590v1](https://arxiv.org/pdf/2601.03590v1)**

> **作者:** Zhongbin Guo; Zhen Yang; Yushan Li; Xinyue Zhang; Wenyu Gao; Jiacheng Wang; Chengzhi Li; Xiangrui Liu; Ping Jian
>
> **摘要:** Recent advancements in Spatial Intelligence (SI) have predominantly relied on Vision-Language Models (VLMs), yet a critical question remains: does spatial understanding originate from visual encoders or the fundamental reasoning backbone? Inspired by this question, we introduce SiT-Bench, a novel benchmark designed to evaluate the SI performance of Large Language Models (LLMs) without pixel-level input, comprises over 3,800 expert-annotated items across five primary categories and 17 subtasks, ranging from egocentric navigation and perspective transformation to fine-grained robotic manipulation. By converting single/multi-view scenes into high-fidelity, coordinate-aware textual descriptions, we challenge LLMs to perform symbolic textual reasoning rather than visual pattern matching. Evaluation results of state-of-the-art (SOTA) LLMs reveals that while models achieve proficiency in localized semantic tasks, a significant "spatial gap" remains in global consistency. Notably, we find that explicit spatial reasoning significantly boosts performance, suggesting that LLMs possess latent world-modeling potential. Our proposed dataset SiT-Bench serves as a foundational resource to foster the development of spatially-grounded LLM backbones for future VLMs and embodied agents. Our code and benchmark will be released at https://github.com/binisalegend/SiT-Bench .
>
---
#### [new 030] Gen3R: 3D Scene Generation Meets Feed-Forward Reconstruction
- **分类: cs.CV**

- **简介: 该论文提出Gen3R，解决3D场景生成任务，通过结合重建模型与视频扩散模型，生成RGB视频及对应3D几何结构。**

- **链接: [https://arxiv.org/pdf/2601.04090v1](https://arxiv.org/pdf/2601.04090v1)**
...
>
---
#### [new 033] VideoMemory: Toward Consistent Video Generation via Memory Integration
- **分类: cs.CV**

- **简介: 该论文提出VideoMemory，解决叙事视频生成中角色、道具和环境一致性问题。通过动态记忆库实现多镜头连贯生成。**

- **链接: [https://arxiv.org/pdf/2601.03655v1](https://arxiv.org/pdf/2601.03655v1)**

> **作者:** Jinsong Zhou; Yihua Du; Xinli Xu; Luozhou Wang; Zijie Zhuang; Yehang Zhang; Shuaibo Li; Xiaojun Hu; Bolan Su; Ying-cong Chen
>
> **备注:** Project page: https://hit-perfect.github.io/VideoMemory/
>
...
>
---
#### [new 037] Understanding Reward Hacking in Text-to-Image Reinforcement Learning
- **分类: cs.CV**

- **简介: 该论文属于文本到图像强化学习任务，旨在解决奖励黑客问题。通过分析奖励机制的缺陷，提出轻量级人工制品奖励模型以提升生成图像的真实性和减少奖励欺骗。**

- **链接: [https://arxiv.org/pdf/2601.03468v1](https://arxiv.org/pdf/2601.03468v1)**
...
>
---
#### [new 038] VLM4VLA: Revisiting Vision-Language-Models in Vision-Language-Action Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉-语言-动作模型领域，研究VLM选择对VLA性能的影响。通过简单适配方法，发现VLM通用能力不足以预测下游任务表现，强调视觉模块的重要性。**

- **链接: [https://arxiv.org/pdf/2601.03309v1](https://arxiv.org/pdf/2601.03309v1)**
...
>
---
#### [new 048] EvalBlocks: A Modular Pipeline for Rapidly Evaluating Foundation Models in Medical Imaging
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出EvalBlocks，一个用于医学影像基础模型快速评估的模块化框架，解决模型评估流程繁琐的问题，提升研究效率。**

- **链接: [https://arxiv.org/pdf/2601.03811v1](https://arxiv.org/pdf/2601.03811v1)**
...
>
---
#### [new 061] MGPC: Multimodal Network for Generalizable Point Cloud Completion With Modality Dropout and Progressive Decoding
- **分类: cs.CV**

- **简介: 该论文属于点云补全任务，旨在解决真实场景下点云不完整的问题。提出MGPC框架，融合多模态数据并引入创新策略提升泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.03660v1](https://arxiv.org/pdf/2601.03660v1)**
...
>
---
#### [new 062] GAMBIT: A Gamified Jailbreak Framework for Multimodal Large Language Models
- **分类: cs.CV**

- **简介: 该论文提出GAMBIT框架，用于攻击多模态大语言模型的安全机制。任务是破解模型安全防护，通过游戏化设计诱导模型生成有害内容。**

- **链接: [https://arxiv.org/pdf/2601.03416v1](https://arxiv.org/pdf/2601.03416v1)**
...
>
---
#### [new 063] ThinkRL-Edit: Thinking in Reinforcement Learning for Reasoning-Centric Image Editing
- **分类: cs.CV**

- **简介: 该论文属于图像编辑任务，解决推理驱动的图像编辑性能不足问题。提出ThinkRL-Edit框架，通过增强推理探索和优化奖励机制提升编辑效果。**

- **链接: [https://arxiv.org/pdf/2601.03467v1](https://arxiv.org/pdf/2601.03467v1)**
...
>
---
#### [new 066] ResTok: Learning Hierarchical Residuals in 1D Visual Tokenizers for Autoregressive Image Generation
- **分类: cs.CV**

- **简介: 该论文提出ResTok，用于自回归图像生成的1D视觉分词器，解决传统方法忽视视觉层次残差问题，通过构建层次残差提升生成效果。**

- **链接: [https://arxiv.org/pdf/2601.03955v1](https://arxiv.org/pdf/2601.03955v1)**

> **作者:** Xu Zhang; Cheng Da; Huan Yang; Kun Gai; Ming Lu; Zhan Ma
>
> **备注:** Technical report
>
> **摘要:** Existing 1D visual tokenizers for autoregressive (AR) generation largely follow the design principles of language modeling, as they are built directly upon transformers whose priors originate in language, yielding single-hierarchy latent tokens and treating visual data as flat sequential token streams. However, this language-like formulation overlooks key properties of vision, particularly the hierarchical and residual network designs that have long been essential for convergence and efficiency in visual models. To bring "vision" back to vision, we propose the Residual Tokenizer (ResTok), a 1D visual tokenizer that builds hierarchical residuals for both image tokens and latent tokens. The hierarchical representations obtained through progressively merging enable cross-level feature fusion at each layer, substantially enhancing representational capacity. Meanwhile, the semantic residuals between hierarchies prevent information overlap, yielding more concentrated latent distributions that are easier for AR modeling. Cross-level bindings consequently emerge without any explicit constraints. To accelerate the generation process, we further introduce a hierarchical AR generator that substantially reduces sampling steps by predicting an entire level of latent tokens at once rather than generating them strictly token-by-token. Extensive experiments demonstrate that restoring hierarchical residual priors in visual tokenization significantly improves AR image generation, achieving a gFID of 2.34 on ImageNet-256 with only 9 sampling steps. Code is available at https://github.com/Kwai-Kolors/ResTok.
>
---
#### [new 067] REFA: Real-time Egocentric Facial Animations for Virtual Reality
- **分类: cs.CV**

- **简介: 该论文属于实时面部表情追踪任务，解决VR中非侵入式驱动虚拟角色面部表情的问题。通过多源数据训练模型，并构建轻量采集系统与渲染管道实现高效表达捕捉。**

- **链接: [https://arxiv.org/pdf/2601.03507v1](https://arxiv.org/pdf/2601.03507v1)**
...
>
---
#### [new 070] Better, But Not Sufficient: Testing Video ANNs Against Macaque IT Dynamics
- **分类: cs.CV; cs.NE**

- **简介: 该论文属于视觉模型研究任务，旨在解决视频处理中动态计算与生物视觉的匹配问题。通过对比不同ANN模型与猕猴IT皮层响应，发现现有模型仍不足。**

- **链接: [https://arxiv.org/pdf/2601.03392v1](https://arxiv.org/pdf/2601.03392v1)**
...
>
---
#### [new 072] CSMCIR: CoT-Enhanced Symmetric Alignment with Memory Bank for Composed Image Retrieval
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像检索任务，解决多模态查询与目标对齐问题。提出CSMCIR框架，通过对齐机制提升检索效果。**

- **链接: [https://arxiv.org/pdf/2601.03728v1](https://arxiv.org/pdf/2601.03728v1)**
...
>
---
#### [new 075] e5-omni: Explicit Cross-modal Alignment for Omni-modal Embeddings
...
>
---
#### [new 076] A low-complexity method for efficient depth-guided image deblurring
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于图像去模糊任务，旨在解决深度引导下的去模糊问题。通过引入低复杂度神经网络，结合小波变换和深度信息，实现高效且高质量的去模糊。**

- **链接: [https://arxiv.org/pdf/2601.03924v1](https://arxiv.org/pdf/2601.03924v1)**
...
>
---
#### [new 079] PointWorld: Scaling 3D World Models for In-The-Wild Robotic Manipulation
...
>
---
#### [new 080] Inferring Clinically Relevant Molecular Subtypes of Pancreatic Cancer from Routine Histopathology Using Deep Learning
- **分类: cs.LG; cs.CV; eess.IV**

- **简介: 该论文属于分子亚型分类任务，旨在通过深度学习从常规病理切片预测胰腺癌分子亚型，解决传统方法成本高、耗时长的问题。**

- **链接: [https://arxiv.org/pdf/2601.03410v1](https://arxiv.org/pdf/2601.03410v1)**
...
>
---
#### [new 081] InfiniteWeb: Scalable Web Environment Synthesis for GUI Agent Training
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 084] Wow, wo, val! A Comprehensive Embodied World Model Evaluation Turing Test
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 085] Visual Merit or Linguistic Crutch? A Close Look at DeepSeek-OCR
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 086] CLAP: Contrastive Latent Action Pretraining for Learning Vision-Language-Action Models from Human Videos
- **分类: cs.RO; cs.CV**
...
#### [replaced 001] ProCLIP: Progressive Vision-Language Alignment via LLM-based Embedder
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.18795v3](https://arxiv.org/pdf/2510.18795v3)**
...
>
---
#### [replaced 002] Where MLLMs Attend and What They Rely On: Explaining Autoregressive Token Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.22496v4](https://arxiv.org/pdf/2509.22496v4)**
...
>
---
#### [replaced 008] Multivariate Diffusion Transformer with Decoupled Attention for High-Fidelity Mask-Text Collaborative Facial Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.12631v2](https://arxiv.org/pdf/2511.12631v2)**
...
>
---
#### [replaced 009] HOLO: Homography-Guided Pose Estimator Network for Fine-Grained Visual Localization on SD Maps
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02730v2](https://arxiv.org/pdf/2601.02730v2)**
...
>
---
#### [replaced 010] Deep But Reliable: Advancing Multi-turn Reasoning for Thinking with Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17306v2](https://arxiv.org/pdf/2512.17306v2)**
...
>
---
#### [replaced 011] From Human Intention to Action Prediction: Intention-Driven End-to-End Autonomous Driving
...
>
---
#### [replaced 015] FastV-RAG: Towards Fast and Fine-Grained Video QA with Retrieval-Augmented Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.01513v2](https://arxiv.org/pdf/2601.01513v2)**
...
>
---
#### [replaced 016] Deflickering Vision-Based Occupancy Networks through Lightweight Spatio-Temporal Correlation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.15438v4](https://arxiv.org/pdf/2502.15438v4)**
...
>
---
#### [replaced 017] Language as Prior, Vision as Calibration: Metric Scale Recovery for Monocular Depth Estimation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.01457v2](https://arxiv.org/pdf/2601.01457v2)**
...
>
---
#### [replaced 018] MoTE: Mixture of Ternary Experts for Memory-efficient Large Multimodal Models
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.14435v2](https://arxiv.org/pdf/2506.14435v2)**
...
>
---
#### [replaced 019] WebGym: Scaling Training Environments for Visual Web Agents with Realistic Tasks
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02439v2](https://arxiv.org/pdf/2601.02439v2)**

> **作者:** Hao Bai; Alexey Taymanov; Tong Zhang; Aviral Kumar; Spencer Whitehead
>
> **备注:** Slightly modified format; added Table 3 for better illustration of the scaling results
>
...
>
---
#### [replaced 020] ChartAgent: A Multimodal Agent for Visually Grounded Reasoning in Complex Chart Question Answering
...
>
---
#### [replaced 023] DiFlow-TTS: Compact and Low-Latency Zero-Shot Text-to-Speech with Factorized Discrete Flow Matching
...
>
---
#### [replaced 024] Generalized Logit Adjustment: Calibrating Fine-tuned Models by Removing Label Bias in Foundation Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2310.08106v4](https://arxiv.org/pdf/2310.08106v4)**
...
>
---
#### [replaced 025] Are Vision Language Models Cross-Cultural Theory of Mind Reasoners?
...
>
---
#### [replaced 026] SpatialTree: How Spatial Abilities Branch Out in MLLMs
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.20617v2](https://arxiv.org/pdf/2512.20617v2)**
...
>
---
#### [replaced 030] VULCAN: Tool-Augmented Multi Agents for Iterative 3D Object Arrangement
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.22351v2](https://arxiv.org/pdf/2512.22351v2)**
...
>
---
#### [replaced 037] UniVideo: Unified Understanding, Generation, and Editing for Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.08377v3](https://arxiv.org/pdf/2510.08377v3)**
...
>
---
#### [replaced 038] CaTS-Bench: Can Language Models Describe Time Series?
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.20823v3](https://arxiv.org/pdf/2509.20823v3)**
...
>
---
#### [replaced 039] Data relativistic uncertainty framework for low-illumination anime scenery image enhancement
- **分类: cs.CV; cs.LG; cs.MM**

- **链接: [https://arxiv.org/pdf/2512.21944v2](https://arxiv.org/pdf/2512.21944v2)**
...
>
---
#### [replaced 040] PM4Bench: Benchmarking Large Vision-Language Models with Parallel Multilingual Multi-Modal Multi-task Corpus
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 041] SortWaste: A Densely Annotated Dataset for Object Detection in Industrial Waste Sorting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02299v2](https://arxiv.org/pdf/2601.02299v2)**
...
>
---
#### [replaced 042] FairT2I: Mitigating Social Bias in Text-to-Image Generation via Large Language Model-Assisted Detection and Attribute Rebalancing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.03826v4](https://arxiv.org/pdf/2502.03826v4)**
...
>
---
#### [replaced 045] BiPO: Bidirectional Partial Occlusion Network for Text-to-Motion Synthesis
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2412.00112v3](https://arxiv.org/pdf/2412.00112v3)**
...
>
---
#### [replaced 046] Adaptive Anomaly Recovery for Telemanipulation: A Diffusion Model Approach to Vision-Based Tracking
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 047] Learn2Reg 2024: New Benchmark Datasets Driving Progress on New Challenges
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.01217v3](https://arxiv.org/pdf/2509.01217v3)**
...
>
---
#### [replaced 050] I-Scene: 3D Instance Models are Implicit Generalizable Spatial Learners
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.13683v2](https://arxiv.org/pdf/2512.13683v2)**
...
>
---
#### [replaced 051] ViMoNet: A Multimodal Vision-Language Framework for Human Behavior Understanding from Motion and Video
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09818v3](https://arxiv.org/pdf/2508.09818v3)**

> **作者:** Rajan Das Gupta; Lei Wei; Md Yeasin Rahat; Nafiz Fahad; Abir Ahmed; Liew Tze Hui
>
