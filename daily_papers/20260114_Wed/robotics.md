...
>
---
#### [new 003] ActiveVLA: Injecting Active Perception into Vision-Language-Action Models for Precise 3D Robotic Manipulation
- **分类: cs.RO**

- **简介: 该论文提出ActiveVLA，解决3D机器人操作中视角固定导致的精度不足问题，通过主动感知提升精细操作能力。**

- **链接: [https://arxiv.org/pdf/2601.08325v1](https://arxiv.org/pdf/2601.08325v1)**
...
>
---
#### [new 008] VLingNav: Embodied Navigation with Adaptive Reasoning and Visual-Assisted Linguistic Memory
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 012] A Hybrid Model-based and Data-based Approach Developed for a Prosthetic Hand Wrist
- **分类: cs.RO**

- **简介: 该论文属于控制任务，旨在提升假肢手腕的运动性能。通过结合神经网络与滑模控制器，实现快速且高效的腕部控制。**

- **链接: [https://arxiv.org/pdf/2601.08711v1](https://arxiv.org/pdf/2601.08711v1)**
...
>
---
#### [new 013] Robust Subpixel Localization of Diagonal Markers in Large-Scale Navigation via Multi-Layer Screening and Adaptive Matching
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 019] Keyframe-based Dense Mapping with the Graph of View-Dependent Local Maps
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 020] Spiking Neural-Invariant Kalman Fusion for Accurate Localization Using Low-Cost IMUs
- **分类: cs.RO**

- **简介: 该论文属于移动机器人定位任务，旨在解决低成本IMU在航迹推算中因噪声导致的定位精度下降问题。通过融合脉冲神经网络与不变扩展卡尔曼滤波，提升定位精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.08248v1](https://arxiv.org/pdf/2601.08248v1)**
...
>
---
#### [new 021] Large Language Models to Enhance Multi-task Drone Operations in Simulated Environments
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于自然语言处理与无人机控制的交叉任务，旨在解决多任务无人机操作中指令理解与执行效率问题。通过融合CodeT5模型与AirSim仿真环境，实现自然语言到代码的自动转换。**

- **链接: [https://arxiv.org/pdf/2601.08405v1](https://arxiv.org/pdf/2601.08405v1)**
...
>
---
#### [new 025] Motion Attribution for Video Generation
...
>
---
#### [new 026] μDopplerTag: CNN-Based Drone Recognition via Cooperative Micro-Doppler Tagging
- **分类: physics.app-ph; cs.RO**

- **简介: 论文提出一种基于电磁标签和CNN的无人机识别方法，解决复杂环境下无人机准确识别难题。通过微多普勒特征与机器学习结合，实现高效、可靠分类。**

- **链接: [https://arxiv.org/pdf/2601.08042v1](https://arxiv.org/pdf/2601.08042v1)**
...
>
---
#### [new 027] The embodied brain: Bridging the brain, body, and behavior with neuromechanical digital twins
- **分类: q-bio.NC; cs.RO**

- **简介: 论文探讨了神经机械数字双胞胎在连接大脑、身体与行为中的应用，属于跨学科研究任务。旨在解决行为控制机制的解析问题，通过构建仿真模型促进神经科学、机器人学和机器学习的交流与医疗发展。**

- **链接: [https://arxiv.org/pdf/2601.08056v1](https://arxiv.org/pdf/2601.08056v1)**

> **作者:** Sibo Wang-Chen; Pavan Ramdya
>
> **备注:** 17 pages, 4 figures (including 1 graphical abstract), 1 table
>
...
>
---
#### [replaced 005] CLAMP: Crowdsourcing a LArge-scale in-the-wild haptic dataset with an open-source device for Multimodal robot Perception
- **分类: cs.RO**

- **简介: 该论文提出CLAMP设备，用于收集大规模真实场景下的多模态触觉数据，解决机器人感知材料属性的问题。通过构建CLAMP数据集，训练出可泛化的触觉编码器和视觉-触觉感知模型，提升机器人操作能力。**

- **链接: [https://arxiv.org/pdf/2505.21495v2](https://arxiv.org/pdf/2505.21495v2)**
...
>
---
#### [replaced 008] Robotic Tele-Operation for Upper Aerodigestive Tract Microsurgery: System Design and Validation
- **分类: cs.RO**

- **简介: 该论文属于医疗机器人任务，旨在解决UADT手术中手动操作力臂的局限性。设计了新型末端执行器和远程操控系统，提升手术精度与医生操作舒适度。**

- **链接: [https://arxiv.org/pdf/2601.06617v2](https://arxiv.org/pdf/2601.06617v2)**

> **作者:** Giovani Braglia; José Jair Alves Mendes Junior; Augusto Tetsuo Prado Inafuco; Federico Mariano; Leonardo S. Mattos
>
> **备注:** I would like to withdraw the paper because I would like to change some of the results in it which will take some time. For this reason, I prefer to remove it and do a new resubmission once I've finished my work
>
...
>
---
#### [replaced 009] Learning Contextually-Adaptive Rewards via Calibrated Features
- **分类: cs.RO**

- **简介: 该论文属于强化学习中的奖励学习任务，解决如何根据上下文调整奖励特征重要性的问题。通过显式建模特征显著性，提升样本效率和个性化适应能力。**

- **链接: [https://arxiv.org/pdf/2506.15012v3](https://arxiv.org/pdf/2506.15012v3)**

> **作者:** Alexandra Forsey-Smerek; Julie Shah; Andreea Bobu
>
> **备注:** Proceedings of the 21st ACM/IEEE International Conference on Human-Robot Interaction (HRI '26), March 16 - 19, 2026, Edinburgh, Scotland, UK
>
...
>
---
#### [replaced 012] Variable Elimination in Hybrid Factor Graphs for Discrete-Continuous Inference & Estimation
- **分类: cs.RO**

- **简介: 该论文属于机器人学中的估计任务，解决混合问题中离散与连续变量联合建模的难题。提出一种新的混合因子图框架及变量消去算法，实现精确推断与边际化。**

- **链接: [https://arxiv.org/pdf/2601.00545v2](https://arxiv.org/pdf/2601.00545v2)**
...
>
---
#### [replaced 013] RGS-SLAM: Robust Gaussian Splatting SLAM with One-Shot Dense Initialization
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 014] UNCAP: Uncertainty-Guided Neurosymbolic Planning Using Natural Language Communication for Cooperative Autonomous Vehicles
...
>
---
#### [replaced 015] Symbolic Learning of Interpretable Reduced-Order Models for Jumping Quadruped Robots
- **分类: cs.RO; cs.AI; eess.SY**

- **简介: 该论文属于机器人运动建模任务，旨在自动提取可解释的降阶模型。通过结合线性自编码器与符号回归，解决传统手工模型适应性差的问题，提升跳跃四足机器人的控制效果。**

- **链接: [https://arxiv.org/pdf/2508.06538v2](https://arxiv.org/pdf/2508.06538v2)**
...
>
---
#### [replaced 016] FoldNet: Learning Generalizable Closed-Loop Policy for Garment Folding via Keypoint-Driven Asset and Demonstration Synthesis
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 017] Real-Time LiDAR Point Cloud Densification for Low-Latency Spatial Data Transmission
- **分类: cs.CV; cs.RO**
