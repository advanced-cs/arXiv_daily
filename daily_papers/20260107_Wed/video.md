...
>
---
#### [new 013] A Spatio-Temporal Deep Learning Approach For High-Resolution Gridded Monsoon Prediction
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于气候预测任务，旨在解决传统方法缺乏空间细节的问题。通过深度学习框架，将季风预测转化为时空视觉任务，实现高分辨率降雨预测。**

- **链接: [https://arxiv.org/pdf/2601.02445v1](https://arxiv.org/pdf/2601.02445v1)**
...
>
> **摘要:** We introduce NitroGen, a vision-action foundation model for generalist gaming agents that is trained on 40,000 hours of gameplay videos across more than 1,000 games. We incorporate three key ingredients: 1) an internet-scale video-action dataset constructed by automatically extracting player actions from publicly available gameplay videos, 2) a multi-game benchmark environment that can measure cross-game generalization, and 3) a unified vision-action model trained with large-scale behavior cloning. NitroGen exhibits strong competence across diverse domains, including combat encounters in 3D action games, high-precision control in 2D platformers, and exploration in procedurally generated worlds. It transfers effectively to unseen games, achieving up to 52% relative improvement in task success rates over models trained from scratch. We release the dataset, evaluation suite, and model weights to advance research on generalist embodied agents.
>
---
#### [new 016] Don't Mind the Gaps: Implicit Neural Representations for Resolution-Agnostic Retinal OCT Analysis
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，解决OCT图像因大间距导致的三维不一致问题。通过引入隐式神经表示，实现跨B-scan插值和分辨率无关的视网膜图谱，提升三维分析精度。**

- **链接: [https://arxiv.org/pdf/2601.02447v1](https://arxiv.org/pdf/2601.02447v1)**
...
>
---
#### [new 017] PrismVAU: Prompt-Refined Inference System for Multimodal Video Anomaly Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出PrismVAU，解决视频异常理解任务，通过轻量级系统实现高效异常检测与解释，无需复杂模块或标注。**

- **链接: [https://arxiv.org/pdf/2601.02927v1](https://arxiv.org/pdf/2601.02927v1)**
...
>
---
#### [new 018] Understanding Multi-Agent Reasoning with Large Language Models for Cartoon VQA
- **分类: cs.CV**

- **简介: 该论文属于卡通图像视觉问答任务，旨在解决标准LLM在处理卡通图像时的不足。提出多智能体框架，包含视觉、语言和评论智能体，协同进行结构化推理。**

- **链接: [https://arxiv.org/pdf/2601.03073v1](https://arxiv.org/pdf/2601.03073v1)**
...
>
---
#### [new 023] Unified Thinker: A General Reasoning Modular Core for Image Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Unified Thinker，解决图像生成中的逻辑推理不足问题，通过分离推理与生成模块，提升图像生成质量。**

- **链接: [https://arxiv.org/pdf/2601.03127v1](https://arxiv.org/pdf/2601.03127v1)**
...
>
---
#### [new 036] ReCCur: A Recursive Corner-Case Curation Framework for Robust Vision-Language Understanding in Open and Edge Scenarios
- **分类: cs.CV; cs.MA**

- **简介: 该论文提出ReCCur框架，解决开放和边缘场景下的视觉-语言理解中罕见案例的标注问题。通过递归管道提升标签精度与可解释性。**

- **链接: [https://arxiv.org/pdf/2601.03011v1](https://arxiv.org/pdf/2601.03011v1)**
...
>
---
#### [new 043] AnatomiX, an Anatomy-Aware Grounded Multimodal Large Language Model for Chest X-Ray Interpretation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出AnatomiX，解决胸部X光片解读中的解剖结构理解问题。通过多任务方法提升空间推理与解剖对应，显著提高相关任务性能。**

- **链接: [https://arxiv.org/pdf/2601.03191v1](https://arxiv.org/pdf/2601.03191v1)**
...
>
---
#### [new 048] ClearAIR: A Human-Visual-Perception-Inspired All-in-One Image Restoration
- **分类: cs.CV**

- **简介: 该论文属于图像修复任务，旨在解决传统方法因依赖特定退化表示而导致的过度平滑和伪影问题。提出ClearAIR框架，结合人类视觉感知，采用分层修复策略提升恢复效果。**

- **链接: [https://arxiv.org/pdf/2601.02763v1](https://arxiv.org/pdf/2601.02763v1)**
...
>
---
#### [new 049] DreamStyle: A Unified Framework for Video Stylization
- **分类: cs.CV**

- **简介: 该论文提出DreamStyle，解决视频风格化任务中条件单一、风格不一致的问题。通过统一框架支持文本、图像和首帧风格化，并优化数据与模型训练，提升风格一致性与视频质量。**

- **链接: [https://arxiv.org/pdf/2601.02785v1](https://arxiv.org/pdf/2601.02785v1)**

> **作者:** Mengtian Li; Jinshu Chen; Songtao Zhao; Wanquan Feng; Pengqi Tu; Qian He
>
> **备注:** Github Page: https://lemonsky1995.github.io/dreamstyle/
>
> **摘要:** Video stylization, an important downstream task of video generation models, has not yet been thoroughly explored. Its input style conditions typically include text, style image, and stylized first frame. Each condition has a characteristic advantage: text is more flexible, style image provides a more accurate visual anchor, and stylized first frame makes long-video stylization feasible. However, existing methods are largely confined to a single type of style condition, which limits their scope of application. Additionally, their lack of high-quality datasets leads to style inconsistency and temporal flicker. To address these limitations, we introduce DreamStyle, a unified framework for video stylization, supporting (1) text-guided, (2) style-image-guided, and (3) first-frame-guided video stylization, accompanied by a well-designed data curation pipeline to acquire high-quality paired video data. DreamStyle is built on a vanilla Image-to-Video (I2V) model and trained using a Low-Rank Adaptation (LoRA) with token-specific up matrices that reduces the confusion among different condition tokens. Both qualitative and quantitative evaluations demonstrate that DreamStyle is competent in all three video stylization tasks, and outperforms the competitors in style consistency and video quality.
>
---
#### [new 050] HOLO: Homography-Guided Pose Estimator Network for Fine-Grained Visual Localization on SD Maps
- **分类: cs.CV**

- **简介: 该论文属于视觉定位任务，解决SD地图上精确定位的问题。通过构建满足单应性约束的输入对，结合语义对齐与单应性引导，提升定位精度与训练效率。**

- **链接: [https://arxiv.org/pdf/2601.02730v1](https://arxiv.org/pdf/2601.02730v1)**
...
>
---
#### [new 065] CT Scans As Video: Efficient Intracranial Hemorrhage Detection Using Multi-Object Tracking
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在解决CT影像中颅内出血检测的效率与准确性问题。通过将3D CT数据转化为视频流，结合轻量级模型和跟踪算法，提升检测精度与实时性。**

- **链接: [https://arxiv.org/pdf/2601.02521v1](https://arxiv.org/pdf/2601.02521v1)**
...
>
---
#### [new 066] Expert-Guided Explainable Few-Shot Learning with Active Sample Selection for Medical Image Analysis
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分析任务，解决数据稀缺与模型不可解释问题。提出EGxFSL和xGAL框架，结合专家指导与可解释性，提升Few-Shot学习效果。**

- **链接: [https://arxiv.org/pdf/2601.02409v1](https://arxiv.org/pdf/2601.02409v1)**
...
>
---
#### [new 070] From Memorization to Creativity: LLM as a Designer of Novel Neural-Architectures
- **分类: cs.LG; cs.CV**

- **简介: 论文探讨将大语言模型用于设计新型神经网络架构的任务，解决其在结构新颖性与性能间的平衡问题。通过闭环框架优化模型，提升生成有效架构的能力。**

- **链接: [https://arxiv.org/pdf/2601.02997v1](https://arxiv.org/pdf/2601.02997v1)**
...
>
---
#### [new 071] Annealed Langevin Posterior Sampling (ALPS): A Rapid Algorithm for Image Restoration with Multiscale Energy Models
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于图像恢复任务，旨在解决逆问题中的高效推断与不确定性量化。通过引入ALPS算法，结合多尺度能量模型，提升恢复精度与效率。**

- **链接: [https://arxiv.org/pdf/2601.02594v1](https://arxiv.org/pdf/2601.02594v1)**
...
>
---
#### [new 072] Normalized Conditional Mutual Information Surrogate Loss for Deep Neural Classifiers
- **分类: cs.LG; cs.AI; cs.CV; cs.IT**

- **简介: 该论文属于分类任务，旨在用NCMI替代交叉熵损失。通过优化NCMI提升模型性能，实验显示其在多个基准上优于现有方法。**

- **链接: [https://arxiv.org/pdf/2601.02543v1](https://arxiv.org/pdf/2601.02543v1)**
...
>
---
#### [new 073] Loop Closure using AnyLoc Visual Place Recognition in DPV-SLAM
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 074] Omni2Sound: Towards Unified Video-Text-to-Audio Generation
...
>
---
#### [new 078] WebGym: Scaling Training Environments for Visual Web Agents with Realistic Tasks
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出WebGym，用于训练视觉网络代理的开放环境，解决真实网页任务多样性和非平稳性带来的挑战。通过大规模任务集和强化学习方法提升代理性能。**

- **链接: [https://arxiv.org/pdf/2601.02439v1](https://arxiv.org/pdf/2601.02439v1)**
...
>
---
#### [new 079] Deep Learning Superresolution for 7T Knee MR Imaging: Impact on Image Quality and Diagnostic Performance
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学影像处理任务，旨在评估深度学习超分辨率技术对7T膝关节MRI图像质量及诊断效果的影响。研究比较了超分辨率、低分辨率和高分辨率图像的质量与诊断性能。**

- **链接: [https://arxiv.org/pdf/2601.02436v1](https://arxiv.org/pdf/2601.02436v1)**
...
>
---
#### [replaced 002] VLN-MME: Diagnosing MLLMs as Language-guided Visual Navigation agents
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 005] Towards Unbiased Cross-Modal Representation Learning for Food Image-to-Recipe Retrieval
- **分类: cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2511.15201v2](https://arxiv.org/pdf/2511.15201v2)**

> **作者:** Qing Wang; Chong-Wah Ngo; Ee-Peng Lim
>
> **备注:** Code link: https://github.com/GZWQ/Towards-Unbiased-Cross-Modal-Representation-Learning-for-Food-Image-to-Recipe-Retrieval
>
...
>
---
#### [replaced 006] RoboTracer: Mastering Spatial Trace with Reasoning in Vision-Language Models for Robotics
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 007] CVBench: Benchmarking Cross-Video Synergies for Complex Multimodal Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.19542v4](https://arxiv.org/pdf/2508.19542v4)**
...
>
---
#### [replaced 008] Spatial Polarization Multiplexing: Single-Shot Invisible Shape and Reflectance Recovery
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.13177v3](https://arxiv.org/pdf/2504.13177v3)**

> **作者:** Tomoki Ichikawa; Ryo Kawahara; Ko Nishino
>
> **备注:** Project page: https://vision.ist.i.kyoto-u.ac.jp/research/spm/
>
...
>
---
#### [replaced 009] RSwinV2-MD: An Enhanced Residual SwinV2 Transformer for Monkeypox Detection from Skin Images
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.01835v2](https://arxiv.org/pdf/2601.01835v2)**
...
>
---
#### [replaced 010] RxnCaption: Reformulating Reaction Diagram Parsing as Visual Prompt Guided Captioning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.02384v2](https://arxiv.org/pdf/2511.02384v2)**
...
>
---
#### [replaced 011] SmartSnap: Proactive Evidence Seeking for Self-Verifying Agents
- **分类: cs.CL; cs.AI; cs.CV; cs.LG; cs.MA**

- **简介: 该论文提出SmartSnap，解决自主代理任务验证效率低的问题，通过主动取证实现自我验证，提升训练效率与性能。**

- **链接: [https://arxiv.org/pdf/2512.22322v2](https://arxiv.org/pdf/2512.22322v2)**
...
>
---
#### [replaced 012] Geolocation with Real Human Gameplay Data: A Large-Scale Dataset and Human-Like Reasoning Framework
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.13759v3](https://arxiv.org/pdf/2502.13759v3)**
...
>
---
#### [replaced 013] SignX: Continuous Sign Recognition in Compact Pose-Rich Latent Space
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于连续手语识别任务，旨在解决手语数据处理复杂性问题。通过构建紧凑的姿势潜在空间，实现高效准确的手语识别。**

- **链接: [https://arxiv.org/pdf/2504.16315v2](https://arxiv.org/pdf/2504.16315v2)**
...
>
---
#### [replaced 018] Scene-Aware Vectorized Memory Multi-Agent Framework with Cross-Modal Differentiated Quantization VLMs for Visually Impaired Assistance
- **分类: cs.CV; cs.LG; cs.MA**

- **链接: [https://arxiv.org/pdf/2508.18177v2](https://arxiv.org/pdf/2508.18177v2)**
...
>
---
#### [replaced 019] PartHOI: Part-based Hand-Object Interaction Transfer via Generalized Cylinders
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.20599v2](https://arxiv.org/pdf/2504.20599v2)**
...
>
---
#### [replaced 021] LVLM-Aware Multimodal Retrieval for RAG-Based Medical Diagnosis with General-Purpose Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.17394v4](https://arxiv.org/pdf/2508.17394v4)**
...
>
---
#### [replaced 022] RoboTransfer: Controllable Geometry-Consistent Video Diffusion for Manipulation Policy Transfer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.23171v2](https://arxiv.org/pdf/2505.23171v2)**
...
>
---
#### [replaced 024] Quantifying task-relevant representational similarity using decision variable correlation
- **分类: cs.CV; cs.LG; q-bio.NC; q-bio.QM**

- **链接: [https://arxiv.org/pdf/2506.02164v3](https://arxiv.org/pdf/2506.02164v3)**
...
>
---
#### [replaced 025] SAGOnline: Segment Any Gaussians Online
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.08219v2](https://arxiv.org/pdf/2508.08219v2)**
...
>
> **摘要:** 3D Gaussian Splatting has emerged as a powerful paradigm for explicit 3D scene representation, yet achieving efficient and consistent 3D segmentation remains challenging. Existing segmentation approaches typically rely on high-dimensional feature lifting, which causes costly optimization, implicit semantics, and task-specific constraints. We present \textbf{Segment Any Gaussians Online (SAGOnline)}, a unified, zero-shot framework that achieves real-time, cross-view consistent segmentation without scene-specific training. SAGOnline decouples the monolithic segmentation problem into lightweight sub-tasks. By integrating video foundation models (e.g., SAM 2), we first generate temporally consistent 2D masks across rendered views. Crucially, instead of learning continuous feature fields, we introduce a \textbf{Rasterization-aware Geometric Consensus} mechanism that leverages the traceability of the Gaussian rasterization pipeline. This allows us to deterministically map 2D predictions to explicit, discrete 3D primitive labels in real-time. This discrete representation eliminates the memory and computational burden of feature distillation, enabling instant inference. Extensive evaluations on NVOS and SPIn-NeRF benchmarks demonstrate that SAGOnline achieves state-of-the-art accuracy (92.7\% and 95.2\% mIoU) while operating at the fastest speed at 27 ms per frame. By providing a flexible interface for diverse foundation models, our framework supports instant prompt, instance, and semantic segmentation, paving the way for interactive 3D understanding in AR/VR and robotics.
>
---
#### [replaced 026] D^3ETOR: Debate-Enhanced Pseudo Labeling and Frequency-Aware Progressive Debiasing for Weakly-Supervised Camouflaged Object Detection with Scribble Annotations
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.20260v2](https://arxiv.org/pdf/2512.20260v2)**
...
>
---
#### [replaced 027] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.09111v2](https://arxiv.org/pdf/2502.09111v2)**
...
>
---
#### [replaced 028] Point-Supervised Facial Expression Spotting with Gaussian-Based Instance-Adaptive Intensity Modeling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.16952v3](https://arxiv.org/pdf/2511.16952v3)**
...
>
---
#### [replaced 029] Machine-Learning Based Detection of Coronary Artery Calcification Using Synthetic Chest X-Rays
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.11093v2](https://arxiv.org/pdf/2511.11093v2)**

> **作者:** Dylan Saeed; Ramtin Gharleghi; Susann Beier; Sonit Singh
>
...
>
---
#### [replaced 032] Intervene-All-Paths: Unified Mitigation of LVLM Hallucinations across Alignment Formats
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.17254v2](https://arxiv.org/pdf/2511.17254v2)**
...
>
---
#### [replaced 033] FCMBench: A Comprehensive Financial Credit Multimodal Benchmark for Real-world Applications
- **分类: cs.CV; cs.AI; cs.CE; cs.MM**

- **链接: [https://arxiv.org/pdf/2601.00150v2](https://arxiv.org/pdf/2601.00150v2)**

> **作者:** Yehui Yang; Dalu Yang; Wenshuo Zhou; Fangxin Shang; Yifan Liu; Jie Ren; Haojun Fei; Qing Yang; Yanwu Xu; Tao Chen
>
> **摘要:** As multimodal AI becomes widely used for credit risk assessment and document review, a domain-specific benchmark is urgently needed that (1) reflects documents and workflows specific to financial credit applications, (2) includes credit-specific understanding and real-world robustness, and (3) preserves privacy compliance without sacrificing practical utility. Here, we introduce FCMBench-V1.0 -- a large-scale financial credit multimodal benchmark for real-world applications, covering 18 core certificate types, with 4,043 privacy-compliant images and 8,446 QA samples. The FCMBench evaluation framework consists of three dimensions: Perception, Reasoning, and Robustness, including 3 foundational perception tasks, 4 credit-specific reasoning tasks that require decision-oriented understanding of visual evidence, and 10 real-world acquisition artifact types for robustness stress testing. To reconcile compliance with realism, we construct all samples via a closed synthesis-capture pipeline: we manually synthesize document templates with virtual content and capture scenario-aware images in-house. This design also mitigates pre-training data leakage by avoiding web-sourced or publicly released images. FCMBench can effectively discriminate performance disparities and robustness across modern vision-language models. Extensive experiments were conducted on 23 state-of-the-art vision-language models (VLMs) from 14 top AI companies and research institutes. Among them, Gemini 3 Pro achieves the best F1(\%) score as a commercial model (64.61), Qwen3-VL-235B achieves the best score as an open-source baseline (57.27), and our financial credit-specific model, Qfin-VL-Instruct, achieves the top overall score (64.92). Robustness evaluations show that even top-performing models suffer noticeable performance drops under acquisition artifacts.
>
---
#### [replaced 034] Explainable AI Technique in Lung Cancer Detection Using Convolutional Neural Networks
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.10196v3](https://arxiv.org/pdf/2508.10196v3)**
...
>
---
#### [replaced 035] MCD-Net: A Lightweight Deep Learning Baseline for Optical-Only Moraine Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02091v2](https://arxiv.org/pdf/2601.02091v2)**

> **作者:** Zhehuan Cao; Fiseha Berhanu Tesema; Ping Fu; Jianfeng Ren; Ahmed Nasr
>
> **备注:** 13 pages, 10 figures. This manuscript is under review at IEEE Transactions on Geoscience and Remote Sensing. Minor correction to abstract text
>
...
>
---
#### [replaced 036] Chain-of-Action: Trajectory Autoregressive Modeling for Robotic Manipulation
...
>
---
#### [replaced 037] Compositional Discrete Latent Code for High Fidelity, Productive Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.12318v3](https://arxiv.org/pdf/2507.12318v3)**

> **作者:** Samuel Lavoie; Michael Noukhovitch; Aaron Courville
>
> **备注:** Published at NeurIPS, 22 pages, 7 tables, 12 figures, code and models available
>
...
>
---
#### [replaced 038] Go with Your Gut: Scaling Confidence for Autoregressive Image Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.26376v2](https://arxiv.org/pdf/2509.26376v2)**
...
>
---
#### [replaced 039] Robust Egoistic Rigid Body Localization
- **分类: eess.SP; cs.CV**

- **链接: [https://arxiv.org/pdf/2501.10219v2](https://arxiv.org/pdf/2501.10219v2)**
...
>
---
#### [replaced 044] VisRet: Visualization Improves Knowledge-Intensive Text-to-Image Retrieval
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于文本到图像检索任务，旨在解决跨模态嵌入无法有效表示视觉关系的问题。通过先可视化再检索的方法，提升检索效果。**

- **链接: [https://arxiv.org/pdf/2505.20291v3](https://arxiv.org/pdf/2505.20291v3)**
...
>
---
#### [replaced 045] MemeMind: A Large-Scale Multimodal Dataset with Chain-of-Thought Reasoning for Harmful Meme Detection
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文属于有害表情包检测任务，旨在解决隐含有害内容识别困难的问题。构建了MemeMind数据集并提出MemeGuard模型，提升检测准确性和可解释性。**

- **链接: [https://arxiv.org/pdf/2506.18919v3](https://arxiv.org/pdf/2506.18919v3)**
...
>
---
#### [replaced 046] ImageNet-trained CNNs are not biased towards texture: Revisiting feature reliance through controlled suppression
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.20234v4](https://arxiv.org/pdf/2509.20234v4)**
...
>
---
#### [replaced 049] PhysSFI-Net: Physics-informed Geometric Learning of Skeletal and Facial Interactions for Orthognathic Surgical Outcome Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02088v2](https://arxiv.org/pdf/2601.02088v2)**
...
>
---
#### [replaced 050] HAPNet: Toward Superior RGB-Thermal Scene Parsing via Hybrid, Asymmetric, and Progressive Heterogeneous Feature Fusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2404.03527v3](https://arxiv.org/pdf/2404.03527v3)**
...
>
---
#### [replaced 052] How Many Images Does It Take? Estimating Imitation Thresholds in Text-to-Image Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2410.15002v2](https://arxiv.org/pdf/2410.15002v2)**
...
>
---
#### [replaced 055] BusterX++: Towards Unified Cross-Modal AI-Generated Content Detection and Explanation with MLLM
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.14632v3](https://arxiv.org/pdf/2507.14632v3)**
...
>
---
#### [replaced 056] Efficient and Robust Video Defense Framework against 3D-field Personalized Talking Face
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21019v3](https://arxiv.org/pdf/2512.21019v3)**
...
>
---
#### [replaced 057] Mitigating Error Accumulation in Co-Speech Motion Generation via Global Rotation Diffusion and Multi-Level Constraints
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.10076v2](https://arxiv.org/pdf/2511.10076v2)**
...
>
---
#### [replaced 058] CaTS-Bench: Can Language Models Describe Time Series?
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.20823v2](https://arxiv.org/pdf/2509.20823v2)**
...
>
---
#### [replaced 059] A Multidimensional AI-powered Framework for Analyzing Tourist Perception in Historic Urban Quarters: A Case Study in Shanghai
- **分类: cs.AI; cs.CV; cs.CY**

- **链接: [https://arxiv.org/pdf/2509.03830v2](https://arxiv.org/pdf/2509.03830v2)**
...
>
---
#### [replaced 060] TEyeD: Over 20 million real-world eye images with Pupil, Eyelid, and Iris 2D and 3D Segmentations, 2D and 3D Landmarks, 3D Eyeball, Gaze Vector, and Eye Movement Types
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2102.02115v5](https://arxiv.org/pdf/2102.02115v5)**

> **作者:** Wolfgang Fuhl; Gjergji Kasneci; Enkelejda Kasneci
>
> **备注:** Download: https://es-cloud.cs.uni-tuebingen.de/d/8e2ab8c3fdd444e1a135/?p=%2FTEyeDS&mode=list Alternative Download: https://hctlsrva.edu.sot.tum.de/TEyeDS/
>
