...
#### [new 001] D$^2$GSLAM: 4D Dynamic Gaussian Splatting SLAM
- **分类: cs.RO**

- **简介: 该论文属于SLAM任务，旨在解决动态环境中的建图与定位问题。提出D²GSLAM系统，通过几何提示分离动静态区域，采用静态3D与动态4D高斯混合表示，结合运动一致性损失和渐进位姿优化，实现精准动态建模与鲁棒跟踪。**

- **链接: [https://arxiv.org/pdf/2512.09411v1](https://arxiv.org/pdf/2512.09411v1)**
...
>
---
#### [new 002] Generalizable Collaborative Search-and-Capture in Cluttered Environments via Path-Guided MAPPO and Directional Frontier Allocation
- **分类: cs.RO; cs.LG; cs.MA**

- **简介: 该论文研究多智能体协同搜索与围捕任务，解决复杂环境中探索效率低和奖励稀疏问题。提出PGF-MAPPO框架，结合路径引导、密集奖励塑造与方向性前沿分配，实现高效覆盖与零样本迁移。**

- **链接: [https://arxiv.org/pdf/2512.09410v1](https://arxiv.org/pdf/2512.09410v1)**
...
>
---
#### [new 003] One-Shot Real-World Demonstration Synthesis for Scalable Bimanual Manipulation
- **分类: cs.RO**

- **简介: 该论文研究双臂灵巧操作的示范生成任务，旨在解决高质量演示数据获取困难的问题。提出BiDemoSyn框架，通过分解任务结构，从单个真实示例合成大量物理合理的多样化演示，实现高效、可扩展的模仿学习。**

- **链接: [https://arxiv.org/pdf/2512.09297v1](https://arxiv.org/pdf/2512.09297v1)**
...
>
---
#### [new 004] GLaD: Geometric Latent Distillation for Vision-Language-Action Models
- **分类: cs.RO**

- **简介: 该论文针对视觉-语言-动作（VLA）模型忽略几何信息的问题，提出GLaD框架，通过知识蒸馏将3D几何先验融入多模态表征。其在预训练中对齐大语言模型的视觉隐状态与几何视觉Transformer特征，提升空间推理与策略泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.09619v1](https://arxiv.org/pdf/2512.09619v1)**
...
>
---
#### [new 005] LISN: Language-Instructed Social Navigation with VLM-based Controller Modulating
...
>
---
#### [new 006] Development of a Compliant Gripper for Safe Robot-Assisted Trouser Dressing-Undressing
- **分类: cs.RO**

- **简介: 该论文针对老年人及偏瘫患者穿脱裤子困难的问题，研发了一种柔顺抓取力可控的夹持器，集成于机器人系统，实现安全、高效的辅助穿衣操作，提升行动不便者的独立生活能力。**

- **链接: [https://arxiv.org/pdf/2512.09462v1](https://arxiv.org/pdf/2512.09462v1)**
...
>
---
#### [new 007] Scene-agnostic Hierarchical Bimanual Task Planning via Visual Affordance Reasoning
- **分类: cs.RO**

- **简介: 该论文研究场景无关的双手机械臂任务规划，旨在解决开放环境中双臂协调操作的泛化与几何推理问题。提出包含视觉点定位、双臂子目标规划与交互点驱动提示的统一框架，实现从单张图像生成可执行的双手机械动作序列。**

- **链接: [https://arxiv.org/pdf/2512.09310v1](https://arxiv.org/pdf/2512.09310v1)**
...
>
---
#### [new 008] ViTA-Seg: Vision Transformer for Amodal Segmentation in Robotics
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 009] Mastering Diverse, Unknown, and Cluttered Tracks for Robust Vision-Based Drone Racing
- **分类: cs.RO**

- **简介: 该论文研究视觉无人机竞速任务，旨在解决在未知、杂乱环境中兼顾高速飞行与避障的泛化难题。提出两阶段学习框架，结合自适应课程学习与Lipschitz约束，实现从仿真到真实场景的鲁棒跨环境飞行。**

- **链接: [https://arxiv.org/pdf/2512.09571v1](https://arxiv.org/pdf/2512.09571v1)**

> **作者:** Feng Yu; Yu Hu; Yang Su; Yang Deng; Linzuo Zhang; Danping Zou
>
> **备注:** 8 pages, 9 figures, Robotics and Automation Letters accept
>
...
>
---
#### [new 010] Sequential Testing for Descriptor-Agnostic LiDAR Loop Closure in Repetitive Environments
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 011] ShelfAware: Real-Time Visual-Inertial Semantic Localization in Quasi-Static Environments with Low-Cost Sensors
- **分类: cs.RO; cs.AI**

- **简介: 该论文属机器人定位任务，旨在解决动态变化的准静态环境中视觉定位易受干扰的问题。作者提出ShelfAware方法，利用语义类别分布与逆语义提议，在低成本视觉-惯性系统上实现快速、鲁棒的全局定位，显著提升成功率与精度。**

- **链接: [https://arxiv.org/pdf/2512.09065v1](https://arxiv.org/pdf/2512.09065v1)**
...
>
---
#### [new 012] COVLM-RL: Critical Object-Oriented Reasoning for Autonomous Driving Using VLM-Guided Reinforcement Learning
- **分类: cs.RO**

- **简介: 该论文研究端到端自动驾驶，旨在提升泛化性、训练效率与决策可解释性。提出COVLM-RL框架，结合视觉语言模型的语义推理与强化学习，通过关键对象感知和一致性损失，实现语义决策与低层控制对齐，在CARLA中显著提升性能。**

- **链接: [https://arxiv.org/pdf/2512.09349v1](https://arxiv.org/pdf/2512.09349v1)**
...
>
---
#### [new 013] A Hierarchical, Model-Based System for High-Performance Humanoid Soccer
- **分类: cs.RO**

- **简介: 该论文针对高性能人形机器人足球比赛任务，解决动态环境下的运动控制与智能决策问题。提出新型轻量化硬件平台与集成感知-导航-行为协同软件系统，实现快速精准的对抗性足球竞技，助力ARTEMIS获2024 RoboCup成人组冠军。**

- **链接: [https://arxiv.org/pdf/2512.09431v1](https://arxiv.org/pdf/2512.09431v1)**
...
>
---
#### [new 014] ReMoSPLAT: Reactive Mobile Manipulation Control on a Gaussian Splat
- **分类: cs.RO**

- **简介: 该论文研究移动操作臂的反应式控制任务，旨在解决动态避障与运动协调问题。提出ReMoSPLAT方法，基于高斯点阵表示，通过优化框架实现高效碰撞检测与运动控制，在仿真中验证了其在复杂环境下的有效性。**

- **链接: [https://arxiv.org/pdf/2512.09656v1](https://arxiv.org/pdf/2512.09656v1)**
...
>
---
#### [new 015] Super4DR: 4D Radar-centric Self-supervised Odometry and Gaussian-based Map Optimization
- **分类: cs.RO**

- **简介: 该论文属SLAM任务，旨在解决4D雷达在稀疏噪声下位姿估计不准和地图模糊问题。提出Super4DR框架，通过聚类感知的自监督里程计与高斯地图优化，提升定位精度与地图质量。**

- **链接: [https://arxiv.org/pdf/2512.09608v1](https://arxiv.org/pdf/2512.09608v1)**
...
>
---
#### [new 016] Simultaneous Tactile-Visual Perception for Learning Multimodal Robot Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 017] On Mobile Ad Hoc Networks for Coverage of Partially Observable Worlds
- **分类: cs.RO; cs.CG; cs.MA**

- **简介: 该论文研究移动自组织网络在未知环境中的覆盖与连通问题，提出部分可观测合作哨兵画廊问题（POCGAGP），并设计了集中式CADENCE和分布式DADENCE两种算法，在保证覆盖与连通的同时实现高效探索。**

- **链接: [https://arxiv.org/pdf/2512.09495v1](https://arxiv.org/pdf/2512.09495v1)**
...
>
---
#### [new 018] Masked Generative Policy for Robotic Control
- **分类: cs.RO; cs.AI**

- **简介: 该论文提出Masked Generative Policy（MGP），用于视觉运动模仿学习。针对现有方法在复杂、非马尔可夫任务中推理慢、成功率低的问题，设计并行生成与动态修复机制，提升推理速度与鲁棒性，在多任务上实现更高成功率与更快推断。**

- **链接: [https://arxiv.org/pdf/2512.09101v1](https://arxiv.org/pdf/2512.09101v1)**
...
>
---
#### [new 019] Bridging the Basilisk Astrodynamics Framework with ROS 2 for Modular Spacecraft Simulation and Hardware Integration
- **分类: cs.RO**

- **简介: 该论文旨在解决高保真航天器仿真与模块化机器人框架集成难题，提出了一种轻量级开源通信桥，实现Basilisk与ROS 2间的实时双向数据交互，支持仿真与硬件测试的无缝衔接。**

- **链接: [https://arxiv.org/pdf/2512.09833v1](https://arxiv.org/pdf/2512.09833v1)**
...
>
---
#### [new 020] YOPO-Nav: Visual Navigation using 3DGS Graphs from One-Pass Videos
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 025] H2R-Grounder: A Paired-Data-Free Paradigm for Translating Human Interaction Videos into Physically Grounded Robot Videos
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 026] UrbanNav: Learning Language-Guided Urban Navigation from Web-Scale Human Trajectories
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 029] High-Resolution Water Sampling via a Solar-Powered Autonomous Surface Vehicle
- **分类: cs.RO**

- **简介: 该论文致力于提升水体监测的空间分辨率，解决传统无人船采样点少、代表性差的问题。研发了一款太阳能自主水面船，集成新型注射式采样系统与ROS 2自主架构，实现72份无污染水样采集及高精度导航，适用于远程环境大范围、高可靠性水质监测。**

- **链接: [https://arxiv.org/pdf/2512.09798v1](https://arxiv.org/pdf/2512.09798v1)**
...
>
---
#### [new 030] Visual Heading Prediction for Autonomous Aerial Vehicles
...
>
---
#### [new 031] REASAN: Learning Reactive Safe Navigation for Legged Robots
- **分类: cs.RO**

- **简介: 该论文研究足式机器人在复杂动态环境中的反应式安全导航任务，旨在实现仅凭单个LiDAR实时避障与运动控制。作者提出REASAN框架，由四个模块化网络组成，通过强化学习与Transformer结构实现端到端训练，支持机载实时运行，无需启发式规则。**

- **链接: [https://arxiv.org/pdf/2512.09537v1](https://arxiv.org/pdf/2512.09537v1)**
...
>
---
#### [new 032] Py-DiSMech: A Scalable and Efficient Framework for Discrete Differential Geometry-Based Modeling and Control of Soft Robots
- **分类: cs.RO; physics.comp-ph**

- **简介: 该论文提出Py-DiSMech，一个基于离散微分几何的软体机器人建模与控制框架。旨在解决高保真仿真中计算效率与物理精度难以兼顾的问题，通过向量化实现、隐式接触模型和模块化设计，实现高效、可扩展的软体机器人仿真与控制。**

- **链接: [https://arxiv.org/pdf/2512.09911v1](https://arxiv.org/pdf/2512.09911v1)**
...
>
---
#### [new 033] Development and Testing for Perception Based Autonomous Landing of a Long-Range QuadPlane
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 034] Observability Analysis and Composite Disturbance Filtering for a Bar Tethered to Dual UAVs Subject to Multi-source Disturbances
- **分类: cs.RO**

- **简介: 该论文研究双无人机-杆系统的可观测性问题，解决仅用无人机里程计信息能否估计负载姿态的难题。证明了在少于两类干扰下系统可观测，并提出复合干扰滤波方法，通过误差状态卡尔曼滤波实现状态与干扰联合估计。**

- **链接: [https://arxiv.org/pdf/2512.09377v1](https://arxiv.org/pdf/2512.09377v1)**
...
>
---
#### [new 037] Adaptive Thresholding for Visual Place Recognition using Negative Gaussian Mixture Statistics
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 038] CS3D: An Efficient Facial Expression Recognition via Event Vision
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 039] Closing the Train-Test Gap in World Models for Gradient-Based Planning
- **分类: cs.LG; cs.RO**

- **简介: 该论文属于世界模型与规划任务，旨在解决训练与测试目标不一致导致梯度规划性能不足的问题。作者提出训练时的数据合成方法，缩小了预测状态与规划动作间的差距，显著提升梯度规划效率与性能。**

- **链接: [https://arxiv.org/pdf/2512.09929v1](https://arxiv.org/pdf/2512.09929v1)**
...
>
---
#### [new 040] MPC for momentum counter-balanced and zero-impulse contact with a free-spinning satellite
- **分类: eess.SY; cs.RO**

- **简介: 该论文研究在轨服务卫星与自由旋转目标卫星的零冲击接触问题，提出一种非线性模型预测控制（MPC）方法，协调力矩生成与机械臂操纵模块，实现带约束的平稳接触。通过蒙特卡洛仿真验证了方法在噪声和动态变化下的有效性。**

- **链接: [https://arxiv.org/pdf/2512.09213v1](https://arxiv.org/pdf/2512.09213v1)**
...
>
---
#### [replaced 002] Connectivity-Preserving Multi-Agent Area Coverage via Optimal-Transport-Based Density-Driven Optimal Control (D2OC)
- **分类: eess.SY; cs.RO**

- **简介: 该论文研究多智能体区域覆盖任务，解决非均匀覆盖中通信连通性易丢失的问题。提出基于最优传输的密度驱动控制方法（D2OC），通过引入平滑连通性惩罚项，在保证分布匹配参考密度的同时维持网络连通，提升覆盖质量与收敛速度。**

- **链接: [https://arxiv.org/pdf/2511.18579v3](https://arxiv.org/pdf/2511.18579v3)**
...
>
---
#### [replaced 003] Model-free Adaptive Output Feedback Vibration Suppression in a Cantilever Beam
- **分类: eess.SY; cs.RO**

- **简介: 该论文研究悬臂梁振动抑制问题，提出一种无模型自适应输出反馈控制方法。基于回顾性成本优化，利用位移和加速度测量设计采样数据控制器，并设计滤波器从加速度信号中提取位移信息以抑制高频模态干扰，提升抑制性能。**

- **链接: [https://arxiv.org/pdf/2511.06084v2](https://arxiv.org/pdf/2511.06084v2)**
...
>
---
#### [replaced 004] Proportional integral derivative booster for neural networks-based time-series prediction: Case of water demand prediction
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文研究多步时间序列预测，旨在提升神经网络模型的预测精度。通过引入类PID控制方法对预测值进行动态修正，在不增加模型复杂度的前提下，有效提高了水需求和能耗预测的准确性。**

- **链接: [https://arxiv.org/pdf/2512.06357v2](https://arxiv.org/pdf/2512.06357v2)**

> **作者:** Tony Salloom; Okyay Kaynak; Xinbo Yub; Wei He
>
...
>
---
#### [replaced 005] SensHRPS: Sensing Comfortable Human-Robot Proxemics and Personal Space With Eye-Tracking
- **分类: cs.RO; cs.AI; cs.HC**

- **简介: 该论文研究人与机器人交互中的舒适距离感知任务，旨在通过眼动追踪识别用户对机器人空间距离的舒适度。实验采集不同距离下的眼动数据，使用机器学习模型预测舒适状态，发现决策树效果最佳，最小瞳孔直径为关键特征，揭示人机舒适机制与人际差异。**

- **链接: [https://arxiv.org/pdf/2512.08518v2](https://arxiv.org/pdf/2512.08518v2)**
...
>
---
#### [replaced 006] Flow-Aided Flight Through Dynamic Clutters From Point To Motion
- **分类: cs.RO**

- **简介: 该论文研究动态环境中无人机自主飞行任务，旨在解决传统避障方法依赖复杂运动预测的问题。提出一种基于强化学习的框架，利用LiDAR点云生成距离图与点流作为感知输入，隐式感知环境变化，实现从点云到控制动作的端到端避障策略，无需显式建模障碍物运动，提升系统实时性与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2511.16372v2](https://arxiv.org/pdf/2511.16372v2)**
...
- **简介: 该论文研究四轮独立转向机器人路径规划，旨在解决传统方法无法充分利用多运动模式的问题。提出扩展Hybrid A*框架，集成多模态运动，优化状态转移与启发式函数，实现复杂环境下的高效灵活路径规划。**

- **链接: [https://arxiv.org/pdf/2509.06115v2](https://arxiv.org/pdf/2509.06115v2)**

> **作者:** Runjiao Bao; Lin Zhang; Tianwei Niu; Haoyu Yuan; Shoukun Wang
>
> **备注:** Corrected some formatting errors
>
...
>
---
#### [replaced 008] Breaking the Circle: An Autonomous Control-Switching Strategy for Stable Orographic Soaring in MAVs
- **分类: cs.RO**

- **简介: 该论文研究微小型飞行器（MAVs）的地形抬升气流滑翔任务，旨在解决因控制耦合导致的盘旋问题。提出SAOS切换控制策略，通过分时控制水平与垂直轴并改进力估计，抑制盘旋、降低能耗，提升飞行稳定性与续航能力。**

- **链接: [https://arxiv.org/pdf/2510.23084v2](https://arxiv.org/pdf/2510.23084v2)**
...
>
---
#### [replaced 009] PUL-SLAM: Path-Uncertainty Co-Optimization with Lightweight Stagnation Detection for Efficient Robotic Exploration
- **分类: cs.RO**

- **简介: 该论文属机器人自主探索任务，旨在解决现有SLAM方法探索慢、路径不佳的问题。提出PUL-SLAM框架，结合路径与不确定性联合优化的深度强化学习和轻量级停滞检测机制，提升探索效率与地图完整性。**

- **链接: [https://arxiv.org/pdf/2511.04180v2](https://arxiv.org/pdf/2511.04180v2)**
...
>
---
#### [replaced 010] Mind to Hand: Purposeful Robotic Control via Embodied Reasoning
- **分类: cs.RO; cs.AI**

- **简介: 该论文研究通用机器人控制任务，旨在解决AI推理与物理动作脱节的问题。作者提出Lumo-1模型，通过三阶段预训练将视觉-语言推理与机器人动作结合，并引入强化学习提升推理与动作的一致性，实现基于意图的灵巧操作。**

- **链接: [https://arxiv.org/pdf/2512.08580v2](https://arxiv.org/pdf/2512.08580v2)**
...
>
---
#### [replaced 011] C*: A Coverage Path Planning Algorithm for Unknown Environments using Rapidly Covering Graphs
- **分类: cs.RO; eess.SY**

- **简介: 该论文研究未知环境下的覆盖路径规划（CPP）任务，提出C*算法。基于快速覆盖图（RCG），实现高效、实时的完全覆盖，避免覆盖盲区，优化路径长度与时间，适用于单/多机器人及能量受限场景。**

- **链接: [https://arxiv.org/pdf/2505.13782v2](https://arxiv.org/pdf/2505.13782v2)**
...
>
---
#### [replaced 012] Toward Efficient and Robust Behavior Models for Multi-Agent Driving Simulation
- **分类: cs.RO; cs.CV**
