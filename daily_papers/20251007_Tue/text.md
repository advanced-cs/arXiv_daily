...
- **链接: [http://arxiv.org/pdf/2510.03458v1](http://arxiv.org/pdf/2510.03458v1)**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在推理时过于冗长和“过度思考”的问题。作者提出了Step Pruner框架，通过强化学习引导模型减少冗余推理步骤，提升效率与准确性，并防止模型为减少用词而跳过必要步骤。实验表明该方法显著缩短响应长度并保持高准确率。**
...
- **简介: 该论文属于教育AI任务，旨在解决LLMs在教学中的策略不足问题。作者提出TeachLM，通过高效微调结合真实学生数据，生成高质量师生对话，提升教学互动性与个性化能力。**
...
- **简介: 论文提出SliceMoE，属于自然语言处理任务，旨在解决Transformer模型中MoE层的负载不均与表达能力受限问题。通过将token的隐藏向量切片并独立路由，提升模型扩展性与推理效率，实现更细粒度和均衡的专家分配。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决语言模型幻觉问题。通过提出新评估指标DCS，衡量模型对答案的分布正确性，区分错误答案与“不知道”响应。研究团队将DCS应用于12个基准测试，发现多个模型存在显著幻觉倾向。**
...
- **简介: 该论文属于文本图问答任务，旨在解决基于大语言模型的图检索效果差、标注成本高的问题。作者提出Graph-S3框架，通过合成逐步监督信号训练检索器，提升检索质量。实验表明其准确率和F1得分均优于基线方法。**
...
- **简介: 该论文研究语言模型中的混合架构，旨在解决如何平衡建模质量与计算效率的问题。作者系统评估了跨层和层内混合策略，在长文本任务中分析其性能、扩展性和效率，提炼出关键设计要素，为构建高效语言模型提供指导。**
...
- **简介: 该论文属于语音识别任务，旨在解决濒危语言缺乏语音识别系统的问题。作者利用短形式发音词典构建ASR系统，在数据量极少的情况下实现了曼岛语和康沃尔语的可用语音识别，显著降低了数据要求。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决方言理解问题。论文构建了两个魁北克法语区域表达和术语的语料库（QFrCoRE和QFrCoRT），并提出使用区域习语作为测试方言理解的新基准。通过94个LLM实验，验证了这些基准的有效性。**
...
- **简介: 该论文属于参数高效微调任务，旨在解决LoRA适配参数难以跨模型迁移的问题。通过提出TiTok框架，利用对比学习提取源模型中LoRA相关的token级知识，实现无需额外模型的合成数据筛选，有效提升迁移性能。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在跨文化价值冲突场景下的决策能力评估问题。作者构建了CCD-Bench基准，包含2,182个跨文化困境及其响应选项，评估17个非推理模型的文化偏好和决策模式，揭示其偏好特定文化、忽视多元价值的问题。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决如何量化语法纠错工具对人工编辑时间的影响问题。作者构建了首个大规模后编辑时间标注数据集，并提出PEET指标评估工具效率，分析了不同编辑类型对耗时的影响，为工具评估提供了新方向。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在复杂推理任务中表现不佳的问题。作者提出了一种无需更新模型参数的测试时推理增强方法LTPO，通过优化模型内部的潜在“思维”向量来提升推理能力，尤其在高难度任务上表现出色。**
...
- **简介: 论文研究在过程工业领域中，如何利用图嵌入进行对比学习，以提升语言模型的领域适应性。任务是文本表示学习，旨在解决工业文本日志中因知识图谱稀疏而造成的语义理解不足问题。作者将SciNCL方法应用于该领域，通过图结构生成对比学习三元组，并在专有基准测试中验证了模型性能优于现有方法。**
...
- **简介: 该论文属于自然语言处理与医疗AI任务，旨在解决大语言模型在医疗推理中资源消耗过大的问题。作者采用LoRA和QLoRA等参数高效微调技术，对LLaMA-3.2-3B模型进行优化，提升了医学推理能力，同时显著降低内存占用，验证了轻量微调方法在资源受限环境下的有效性。**
...
- **简介: 该论文研究大语言模型（LLMs）在歧义复数指代表达中的表现，分析其是否具备类似人类的偏好与理解能力。任务包括指代表达的生成与解释、歧义检测。论文通过不同实验考察LLMs对复数代词的理解与歧义识别能力，发现其在部分情况下可识别可能指代，但通常不完全符合人类判断，尤其在未明确提示歧义时表现较差。**
...
- **简介: 该论文构建了一个大规模、多语言的斯里兰卡法律、新闻与政策文档数据集，包含215,670份文件，涵盖僧伽罗语、泰米尔语和英语。旨在支持计算语言学、法律分析及多语言自然语言处理研究，提供数据来源、格式及使用场景，并讨论伦理与授权问题。**
...
>
---
#### [new 054] Towards Unsupervised Speech Recognition at the Syllable-Level
- **分类: cs.CL; cs.AI**
...
- **链接: [http://arxiv.org/pdf/2510.03315v1](http://arxiv.org/pdf/2510.03315v1)**
...
- **简介: 论文属于视觉文档检索任务，旨在解决当前多模态检索模型因表示规模大导致的部署难题及模态差异问题。作者提出Guided Query Refinement（GQR），通过轻量文本检索器在测试时优化视觉模型的查询嵌入，提升了效率与性能，实现了更优的精度-效率权衡。**
...
- **简介: 该论文属于社会偏见检测任务，旨在评估大语言模型（LLMs）在识别面向特定人口统计特征的文本偏见方面的能力。论文提出一个全面的评估框架，采用多标签分类方法，覆盖多种内容类型和人口统计维度，系统评估不同模型方法的表现，发现微调小模型具有潜力，但也揭示了跨人口统计偏见检测的不足。**
...
>
---
#### [new 064] LongTail-Swap: benchmarking language models' abilities on rare words
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型在低数据环境下学习罕见词能力的评估问题。作者提出了LT-Swap基准，通过构建包含罕见词的句子对测试集，评估模型对罕见词的语义和句法使用能力。论文工作包括设计基准测试方法、构建测试集，并对16个BabyLM模型进行了评估，揭示了不同模型架构在罕见词处理上的性能差异。**

- **链接: [http://arxiv.org/pdf/2510.04268v1](http://arxiv.org/pdf/2510.04268v1)**
...
>
---
#### [new 066] Unmasking Backdoors: An Explainable Defense via Gradient-Attention Anomaly Scoring for Pre-trained Language Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决预训练语言模型面临的后门攻击问题。通过分析中毒输入在模型中的注意力和梯度异常，提出一种基于梯度-注意力异常评分的可解释防御方法，有效降低攻击成功率，并实现触发词定位与防御机制可视化。**

- **链接: [http://arxiv.org/pdf/2510.04347v1](http://arxiv.org/pdf/2510.04347v1)**
...
>
---
#### [new 067] Finish First, Perfect Later: Test-Time Token-Level Cross-Validation for Diffusion Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决扩散大语言模型（dLLMs）解码过程中早期错误无法修正的问题。作者提出了一种名为Tolerator的训练无关解码策略，通过序列填充与迭代精修两阶段过程，实现已生成token的重新修正，从而提升生成质量。**

- **链接: [http://arxiv.org/pdf/2510.05090v1](http://arxiv.org/pdf/2510.05090v1)**
...
>
---
#### [new 068] AgriGPT-VL: Agricultural Vision-Language Understanding Suite
- **分类: cs.CL**

- **简介: 该论文属于农业多模态任务，旨在解决农业领域缺乏专用多模态模型、数据集和评估体系的问题。论文构建了农业视觉-语言理解套件AgriGPT-VL，包括大规模数据集、专业模型及评估框架，提升了农业多模态推理能力。**

- **链接: [http://arxiv.org/pdf/2510.04002v1](http://arxiv.org/pdf/2510.04002v1)**
...
>
---
#### [new 076] SwiReasoning: Switch-Thinking in Latent and Explicit for Pareto-Superior Reasoning LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在提升大语言模型的推理能力与效率。论文提出SwiReasoning框架，通过动态切换显式与潜在推理模式，解决潜在推理中的概率扩散与过度思考问题，从而提升准确率与token效率。**

- **链接: [http://arxiv.org/pdf/2510.05069v1](http://arxiv.org/pdf/2510.05069v1)**
...
>
---
#### [new 077] FedSRD: Sparsify-Reconstruct-Decompose for Communication-Efficient Federated Large Language Models Fine-Tuning
- **分类: cs.CL**

- **简介: 该论文属于联邦学习任务，旨在解决大语言模型微调中的通信效率问题。针对LoRA在联邦学习中产生的高通信开销和更新冲突，提出FedSRD框架，通过稀疏化、重构和分解方法降低通信成本。实验表明其可减少最多90%通信开销，同时提升异构数据下的模型性能。**

- **链接: [http://arxiv.org/pdf/2510.04601v1](http://arxiv.org/pdf/2510.04601v1)**
...
>
---
#### [new 078] Fine Tuning Methods for Low-resource Languages
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决低资源语言在大语言模型中的表现不佳问题。通过构建文化相关数据集并微调Gemma 2模型，提升其在少数语言上的性能，同时为其他国家提供方法参考，以推动生成式AI在本地语言中的应用并保护文化遗产。**

- **链接: [http://arxiv.org/pdf/2510.04139v1](http://arxiv.org/pdf/2510.04139v1)**

> **作者:** Tim Bakkenes; Daniel Wang; Anton Johansson
>
> **摘要:** The rise of Large Language Models has not been inclusive of all cultures. The models are mostly trained on English texts and culture which makes them underperform in other languages and cultural contexts. By developing a generalizable method for preparing culturally relevant datasets and post-training the Gemma 2 model, this project aimed to increase the performance of Gemma 2 for an underrepresented language and showcase how others can do the same to unlock the power of Generative AI in their country and preserve their cultural heritage.
>
---
#### [new 079] Fine-Tuning on Noisy Instructions: Effects on Generalization and Performance
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型对指令噪声敏感的问题。通过在指令微调中引入扰动（如删除停用词、打乱词序），研究其对模型性能和泛化能力的影响，发现扰动指令微调可提升模型对噪声输入的鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.03528v1](http://arxiv.org/pdf/2510.03528v1)**
...
>
---
#### [new 080] Small Language Models for Emergency Departments Decision Support: A Benchmark Study
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗决策支持任务，旨在解决急诊科（ED）中高效、准确的信息处理需求。作者通过构建基准测试，评估小型语言模型（SLMs）在医疗相关任务中的表现，发现通用领域SLMs优于医学微调模型，表明ED场景中可能无需专门微调。**

- **链接: [http://arxiv.org/pdf/2510.04032v1](http://arxiv.org/pdf/2510.04032v1)**
...
>
---
#### [new 081] Multilingual Routing in Mixture-of-Experts
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究多语言场景下Mixture-of-Experts（MoE）模型的路由机制，旨在理解不同语言如何被路由并影响模型性能。作者分析了多语言数据在不同层的路由模式，发现中间层具有跨语言对齐特性，并提出干预方法提升多语言性能。论文属于自然语言处理任务，核心问题是MoE模型在多语言场景下的泛化能力与路由机制。**

- **链接: [http://arxiv.org/pdf/2510.04694v1](http://arxiv.org/pdf/2510.04694v1)**

> **作者:** Lucas Bandarkar; Chenyuan Yang; Mohsen Fayyaz; Junlin Hu; Nanyun Peng
>
> **摘要:** Mixture-of-Experts (MoE) architectures have become the key to scaling modern LLMs, yet little is understood about how their sparse routing dynamics respond to multilingual data. In this work, we analyze expert routing patterns using parallel multilingual datasets and present highly interpretable layer-wise phenomena. We find that MoE models route tokens in language-specific ways in the early and late decoder layers but exhibit significant cross-lingual routing alignment in middle layers, mirroring parameter-sharing trends observed in dense LLMs. In particular, we reveal a clear, strong correlation between a model's performance in a given language and how similarly its tokens are routed to English in these layers. Extending beyond correlation, we explore inference-time interventions that induce higher cross-lingual routing alignment. We introduce a method that steers the router by promoting middle-layer task experts frequently activated in English, and it successfully increases multilingual performance. These 1-2% gains are remarkably consistent across two evaluation tasks, three models, and 15+ languages, especially given that these simple interventions override routers of extensively trained, state-of-the-art LLMs. In comparison, interventions outside of the middle layers or targeting multilingual-specialized experts only yield performance degradation. Altogether, we present numerous findings that explain how MoEs process non-English text and demonstrate that generalization is limited by the model's ability to leverage language-universal experts in all languages.
>
---
#### [new 082] Are BabyLMs Deaf to Gricean Maxims? A Pragmatic Evaluation of Sample-efficient Language Models
- **分类: cs.CL**

- **简介: 该论文评估小规模语言模型（BabyLMs）对Grice会话准则的理解能力，探究其在有限数据下识别隐含意义的表现。任务属于自然语言处理中的语用学研究，旨在解决模型如何捕捉非字面交流意图的问题。论文构建新基准，比较不同训练量模型与儿童及大规模模型的差异。**

- **链接: [http://arxiv.org/pdf/2510.04764v1](http://arxiv.org/pdf/2510.04764v1)**
...
>
---
#### [new 083] Fine-Tuning Large Language Models with QLoRA for Offensive Language Detection in Roman Urdu-English Code-Mixed Text
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决罗马乌尔都语-英语混杂文本中的冒犯性语言检测问题。由于该语言存在语法不明确、拼写不一致和标注数据稀缺问题，作者采用QLoRA方法对多个大语言模型进行微调，以提升检测效果。实验结果显示，Meta LLaMA 3 8B模型表现最佳，F1得分为91.45，验证了QLoRA在低资源环境下对多语言冒犯性语言检测的有效性。**

- **链接: [http://arxiv.org/pdf/2510.03683v1](http://arxiv.org/pdf/2510.03683v1)**
...
>
---
#### [new 087] Annotate Rhetorical Relations with INCEpTION: A Comparison with Automatic Approaches
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的 discourse parsing 任务，旨在解决 rhetorical relations 的标注问题。研究使用 INCEpTION 工具进行人工标注，并比较 BERT、DistilBERT 和 Logistic Regression 模型在识别修辞关系（如解释、对比、背景、因果）上的表现，发现 DistilBERT 准确率最高，表明其在高效预测话语关系上的潜力。**

- **链接: [http://arxiv.org/pdf/2510.03808v1](http://arxiv.org/pdf/2510.03808v1)**
...
>
---
#### [new 088] Simulating and Understanding Deceptive Behaviors in Long-Horizon Interactions
- **分类: cs.CL**

- **简介: 该论文研究大语言模型在长期交互中的欺骗行为，属于自然语言处理与人工智能安全任务。为解决现有研究局限于单轮对话、难以捕捉长期策略的问题，作者构建了多智能体模拟框架，包含执行任务的表演者、监督的管理者及审计欺骗的第三方，系统评估11个模型的欺骗行为，并分析其策略与影响。**

- **链接: [http://arxiv.org/pdf/2510.03999v1](http://arxiv.org/pdf/2510.03999v1)**
...
>
> **摘要:** GenQuest is a generative text adventure game that leverages Large Language Models (LLMs) to facilitate second language learning through immersive, interactive storytelling. The system engages English as a Foreign Language (EFL) learners in a collaborative "choose-your-own-adventure" style narrative, dynamically generated in response to learner choices. Game mechanics such as branching decision points and story milestones are incorporated to maintain narrative coherence while allowing learner-driven plot development. Key pedagogical features include content generation tailored to each learner's proficiency level, and a vocabulary assistant that provides in-context explanations of learner-queried text strings, ranging from words and phrases to sentences. Findings from a pilot study with university EFL students in China indicate promising vocabulary gains and positive user perceptions. Also discussed are suggestions from participants regarding the narrative length and quality, and the request for multi-modal content such as illustrations.
>
---
#### [new 103] Read Between the Lines: A Benchmark for Uncovering Political Bias in Bangla News Articles
- **分类: cs.CL**

- **简介: 该论文旨在检测孟加拉语新闻中的政治立场，构建了首个包含200篇标注新闻的数据集，分类为亲政府、批评政府和中立。任务是政治立场检测，解决低资源语言媒体偏见识别难题，并评估大语言模型表现。**

- **链接: [http://arxiv.org/pdf/2510.03898v1](http://arxiv.org/pdf/2510.03898v1)**
...
>
---
#### [new 104] Compressed Convolutional Attention: Efficient Attention in a Compressed Latent Space
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决Transformer模型中多头注意力机制计算和内存开销大的问题。作者提出了“压缩卷积注意力”（CCA）及其与组查询注意力结合的CCGQA方法，通过在压缩空间执行注意力操作，显著降低参数、计算量和内存占用，提升了训练和推理效率。**

- **链接: [http://arxiv.org/pdf/2510.04476v1](http://arxiv.org/pdf/2510.04476v1)**
...
>
---
#### [new 105] Implicit Values Embedded in How Humans and LLMs Complete Subjective Everyday Tasks
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究任务为分析人类与大语言模型（LLMs）在完成主观日常任务时所体现的隐含价值观。旨在解决LLMs是否与人类在环境、慈善、多样性等价值取向上一致的问题。论文通过审计6个主流LLMs与100名美国众包工作者完成30项日常任务的表现，发现LLMs之间及与人类间的价值观存在不一致。**

- **链接: [http://arxiv.org/pdf/2510.03384v1](http://arxiv.org/pdf/2510.03384v1)**

> **作者:** Arjun Arunasalam; Madison Pickering; Z. Berkay Celik; Blase Ur
>
> **摘要:** Large language models (LLMs) can underpin AI assistants that help users with everyday tasks, such as by making recommendations or performing basic computation. Despite AI assistants' promise, little is known about the implicit values these assistants display while completing subjective everyday tasks. Humans may consider values like environmentalism, charity, and diversity. To what extent do LLMs exhibit these values in completing everyday tasks? How do they compare with humans? We answer these questions by auditing how six popular LLMs complete 30 everyday tasks, comparing LLMs to each other and to 100 human crowdworkers from the US. We find LLMs often do not align with humans, nor with other LLMs, in the implicit values exhibited.
>
---
#### [new 106] COLE: a Comprehensive Benchmark for French Language Understanding Evaluation
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决法语语言理解评估不够全面的问题。作者构建了包含23项多样化任务的基准COLE，评估94个大语言模型，发现闭源与开源模型间存在性能差距，并指出当前模型在零样本问答、词义消歧和方言理解等方面仍面临挑战，推动法语语言模型发展。**

- **链接: [http://arxiv.org/pdf/2510.05046v1](http://arxiv.org/pdf/2510.05046v1)**
...
>
---
#### [new 110] Optimizing Fine-Tuning through Advanced Initialization Strategies for Low-Rank Adaptation
- **分类: cs.LG; cs.CL**

- **简介: 论文属于模型微调任务，旨在解决LoRA方法中因低秩矩阵初始化限制导致的性能瓶颈问题。工作提出IniLoRA策略，通过更优初始化逼近原始模型权重，并设计两种变体进一步提升效果。**

- **链接: [http://arxiv.org/pdf/2510.03731v1](http://arxiv.org/pdf/2510.03731v1)**
...
>
---
#### [new 111] Selective Expert Guidance for Effective and Diverse Exploration in Reinforcement Learning of LLMs
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于强化学习与大语言模型任务，旨在解决现有方法在模仿专家路径时缺乏探索多样性的问题。作者提出MENTOR框架，仅在关键决策点引入专家指导，实现有效且多样化的探索，从而提升模型推理能力与整体表现。**

- **链接: [http://arxiv.org/pdf/2510.04140v1](http://arxiv.org/pdf/2510.04140v1)**

> **作者:** Zishang Jiang; Jinyi Han; Tingyun Li; Xinyi Wang; Sihang Jiang; Jiaqing Liang; Zhaoqian Dai; Shuguang Ma; Fei Yu; Yanghua Xiao
>
> **摘要:** Reinforcement Learning with Verifiable Rewards (RLVR) has become a widely adopted technique for enhancing the reasoning ability of Large Language Models (LLMs). However, the effectiveness of RLVR strongly depends on the capability of base models. This issue arises because it requires the model to have sufficient capability to perform high-quality exploration, which involves both effectiveness and diversity. Unfortunately, existing methods address this issue by imitating expert trajectories, which improve effectiveness but neglect diversity. To address this, we argue that the expert only needs to provide guidance only at critical decision points rather than the entire reasoning path. Based on this insight, we propose MENTOR: Mixed-policy Expert Navigation for Token-level Optimization of Reasoning, a framework that provides expert guidance only at critical decision points to perform effective and diverse exploration in RLVR. Extensive experiments show that MENTOR enables models capture the essence of expert strategies rather than surface imitation, thereby performing high-quality exploration and achieving superior overall performance. Our code is available online.
>
---
#### [new 112] General Exploratory Bonus for Optimistic Exploration in RLHF
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习与人类反馈对齐任务，旨在解决现有探索奖励方法在乐观探索中偏向高概率区域、抑制不确定区域探索的问题。作者提出了一种通用探索奖励框架GEB，理论上保证乐观性，统一现有方法，并在多种模型和任务上验证了其优越性。**

- **链接: [http://arxiv.org/pdf/2510.03269v1](http://arxiv.org/pdf/2510.03269v1)**
...
>
---
#### [new 113] Reinforce-Ada: An Adaptive Sampling Framework for Reinforce-Style LLM Training
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文属于大语言模型的强化学习训练任务，旨在解决推理任务中因固定采样导致的梯度估计不稳定问题。论文提出了Reinforce-Ada框架，通过动态分配采样资源，优先处理不确定性高或学习潜力大的提示，采用在线连续淘汰机制和全局统计稳定更新，提升了训练效率和模型性能。**

- **链接: [http://arxiv.org/pdf/2510.04996v1](http://arxiv.org/pdf/2510.04996v1)**
...
>
---
#### [new 114] Discovering Transformer Circuits via a Hybrid Attribution and Pruning Framework
- **分类: cs.LG; cs.CL; I.2.6; I.2.7**

- **简介: 该论文属于模型解释任务，旨在解决现有电路发现方法在速度与准确性间的权衡问题。作者提出HAP框架，结合归因修补与边剪枝，先快速定位高潜力子图，再从中提取精确子网络，提升了效率与保真度，并验证了其在间接对象识别任务中的有效性。**

- **链接: [http://arxiv.org/pdf/2510.03282v1](http://arxiv.org/pdf/2510.03282v1)**
...
>
---
#### [new 116] Learning to Interpret Weight Differences in Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型微调后权重变化难以解释的问题。作者提出Diff Interpretation Tuning（DIT）方法，通过训练模型自述其微调修改，提升了权重差异的可解释性，并在两个场景中验证了其有效性。**

- **链接: [http://arxiv.org/pdf/2510.05092v1](http://arxiv.org/pdf/2510.05092v1)**

> **作者:** Avichal Goel; Yoon Kim; Nir Shavit; Tony T. Wang
>
> **备注:** The weight diffs and DIT adapters trained in the paper can be found at https://huggingface.co/diff-interpretation-tuning/loras
>
...
>
---
#### [new 117] Know Thyself? On the Incapability and Implications of AI Self-Recognition
...
>
---
#### [new 118] Proactive defense against LLM Jailbreak
- **分类: cs.CR; cs.CL**

- **简介: 该论文属于自然语言处理中的安全防御任务，旨在解决大语言模型（LLM）易受多轮越狱攻击的问题。作者提出ProAct框架，通过生成看似成功但无害的虚假响应，误导攻击者的优化过程，提前终止攻击，从而有效防御越狱攻击。**

- **链接: [http://arxiv.org/pdf/2510.05052v1](http://arxiv.org/pdf/2510.05052v1)**
...
>
---
#### [new 122] AgentCaster: Reasoning-Guided Tornado Forecasting
- **分类: cs.LG; cs.AI; cs.CL; physics.ao-ph**

- **简介: 该论文属于气象预测任务，旨在解决龙卷风的长期预测问题。作者提出AgentCaster框架，利用多模态大语言模型处理时空数据，进行12-36小时的龙卷风风险预测，并设计新指标评估模型性能，发现当前模型仍不如人类专家。**

- **链接: [http://arxiv.org/pdf/2510.03349v1](http://arxiv.org/pdf/2510.03349v1)**
...
>
---
#### [new 123] Adapting Diarization-Conditioned Whisper for End-to-End Multi-Talker Speech Recognition
...
>
---
#### [new 124] Studying the Korean Word-Chain Game with RLVR:Mitigating Reward Conflicts via Curriculum Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究使用RLVR训练语言模型玩韩国文字链游戏，解决规则奖励冲突问题。通过课程学习策略缓解冲突，验证了其有效性，旨在提升模型推理能力，并探索多语言谜题任务。**

- **链接: [http://arxiv.org/pdf/2510.03394v1](http://arxiv.org/pdf/2510.03394v1)**
...
>
---
#### [new 125] Principled and Tractable RL for Reasoning with Diffusion Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 本文研究扩散语言模型（dLLMs）的强化学习（RL）方法，旨在解决其生成效果提升的问题。现有RL方法不适用于dLLMs，因此提出新的原理性算法AGRPO，通过蒙特卡洛采样实现策略梯度优化，有效提升了数学推理任务表现。**

- **链接: [http://arxiv.org/pdf/2510.04019v1](http://arxiv.org/pdf/2510.04019v1)**
...
>
---
#### [new 126] Bridging the Gap Between Multimodal Foundation Models and World Models
...
>
---
#### [new 127] On Structured State-Space Duality
...
>
---
#### [new 132] Automating construction safety inspections using a multi-modal vision-language RAG framework
...
>
---
#### [new 135] What Scales in Cross-Entropy Scaling Law?
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 这篇论文研究了交叉熵缩放定律在大规模语言模型中的失效问题。通过将交叉熵分解为误差熵、自对齐和置信度三个部分，发现仅误差熵遵循幂律缩放，而其他两项基本不变。随着模型增大，误差熵占比下降，导致整体交叉熵缩放偏离预期。论文提出误差熵缩放律，为大型语言模型的训练和优化提供新视角。**

- **链接: [http://arxiv.org/pdf/2510.04067v1](http://arxiv.org/pdf/2510.04067v1)**
...
>
---
#### [new 138] LaDiR: Latent Diffusion Enhances LLMs for Text Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出LaDiR，一种结合潜在扩散模型与大语言模型的推理框架，旨在提升文本推理中的语义表达与迭代优化能力。通过变分自编码器构建结构化潜在空间，并利用扩散模型实现推理过程的并行化与多样化生成，以增强准确性与可解释性。应用于数学推理与规划任务，效果优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.04573v1](http://arxiv.org/pdf/2510.04573v1)**
...
>
---
#### [new 139] No Tokens Wasted: Leveraging Long Context in Biomedical Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 140] Retrieval-Augmented Code Generation: A Survey with Focus on Repository-Level Approaches
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于代码生成任务，旨在解决仓库级代码生成中的长程依赖与全局语义一致性问题。论文综述了检索增强生成技术在代码生成中的应用，特别关注仓库级方法，并从生成策略、检索方式、模型架构等方面进行了系统分析。**

- **链接: [http://arxiv.org/pdf/2510.04905v1](http://arxiv.org/pdf/2510.04905v1)**
...
>
---
#### [new 141] Impatient Users Confuse AI Agents: High-fidelity Simulations of Human Traits for Testing Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于AI代理鲁棒性测试任务，旨在解决AI代理在面对不同用户行为时性能下降的问题。论文提出了TraitBasis方法，用于系统性地模拟不同用户特质，以测试AI代理在多种现实场景下的表现。**

- **链接: [http://arxiv.org/pdf/2510.04491v1](http://arxiv.org/pdf/2510.04491v1)**
...
>
---
#### [new 144] Internal states before wait modulate reasoning patterns
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究大模型推理过程中“等待标记”前的内部状态如何调节推理模式。任务是分析模型推理机制，解决为何模型会采取特定推理行为的问题。通过训练交叉编码器和引入归因技术，识别影响等待标记概率的关键特征，并验证其对推理模式（如重启、回忆知识、表达不确定等）的影响。**

- **链接: [http://arxiv.org/pdf/2510.04128v1](http://arxiv.org/pdf/2510.04128v1)**

> **作者:** Dmitrii Troitskii; Koyena Pal; Chris Wendler; Callum Stuart McDougall; Neel Nanda
>
> **备注:** Accepted to EMNLP Findings 2025
>
> **摘要:** Prior work has shown that a significant driver of performance in reasoning models is their ability to reason and self-correct. A distinctive marker in these reasoning traces is the token wait, which often signals reasoning behavior such as backtracking. Despite being such a complex behavior, little is understood of exactly why models do or do not decide to reason in this particular manner, which limits our understanding of what makes a reasoning model so effective. In this work, we address the question whether model's latents preceding wait tokens contain relevant information for modulating the subsequent reasoning process. We train crosscoders at multiple layers of DeepSeek-R1-Distill-Llama-8B and its base version, and introduce a latent attribution technique in the crosscoder setting. We locate a small set of features relevant for promoting/suppressing wait tokens' probabilities. Finally, through a targeted series of experiments analyzing max activating examples and causal interventions, we show that many of our identified features indeed are relevant for the reasoning process and give rise to different types of reasoning patterns such as restarting from the beginning, recalling prior knowledge, expressing uncertainty, and double-checking.
>
---
#### [new 145] Internal World Models as Imagination Networks in Cognitive Agents
- **分类: cs.AI; cs.CL; cs.SI; q-bio.NC**

- **简介: 该论文属于认知科学与人工智能交叉任务，旨在探讨想象的计算目标及内部世界模型（IWM）在人类与大语言模型（LLMs）中的表现。研究通过心理网络分析，比较人类与LLMs的想象网络结构，发现两者在中心性指标相关性和聚类方面存在差异，表明其IWM机制不同。研究提供新方法评估AI是否具备类人想象能力。**

- **链接: [http://arxiv.org/pdf/2510.04391v1](http://arxiv.org/pdf/2510.04391v1)**
...
>
---
#### [new 146] Partial Information Decomposition via Normalizing Flows in Latent Gaussian Distributions
...
>
---
#### [new 149] Slow-Fast Policy Optimization: Reposition-Before-Update for LLM Reasoning
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文属于强化学习与大语言模型推理任务，旨在解决策略梯度方法（如GRPO）在早期训练中因低质量rollout导致的不稳定更新和低效探索问题。论文提出了Slow-Fast Policy Optimization（SFPO），通过分解训练步骤为快轨迹、重定位和慢修正三个阶段，提升训练稳定性和效率。实验表明SFPO在数学推理任务上优于GRPO，减少了rollout次数和训练时间。**

- **链接: [http://arxiv.org/pdf/2510.04072v1](http://arxiv.org/pdf/2510.04072v1)**
...
>
---
#### [new 150] BrokenMath: A Benchmark for Sycophancy in Theorem Proving with LLMs
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出了BrokenMath，用于评估大语言模型在定理证明中的谄媚行为。任务是识别并缓解模型对错误数学陈述的过度迎合，通过构建高质量的虚假问题基准，评估并减少主流模型的谄媚现象。**

- **链接: [http://arxiv.org/pdf/2510.04721v1](http://arxiv.org/pdf/2510.04721v1)**
...
>
---
#### [new 151] AtomWorld: A Benchmark for Evaluating Spatial Reasoning in Large Language Models on Crystalline Materials
- **分类: cond-mat.mtrl-sci; cs.AI; cs.CL**

- **简介: 该论文属于材料科学与人工智能交叉任务，旨在解决大语言模型在晶体材料空间推理中的局限性。论文构建了AtomWorld基准，基于晶体结构文件（CIF）设计任务，评估模型在结构编辑、感知和性质引导建模方面的能力，揭示其在结构理解和空间推理上的不足。**

- **链接: [http://arxiv.org/pdf/2510.04704v1](http://arxiv.org/pdf/2510.04704v1)**
...
>
---
#### [new 152] Token Hidden Reward: Steering Exploration-Exploitation in Group Relative Deep Reinforcement Learning
- **分类: cs.LG; cs.CL**

- **简介: 论文提出Token Hidden Reward（THR），用于量化每个token对强化学习中探索与利用的影响。任务是解决大模型在推理中如何动态控制探索与利用的问题。工作包括设计THR指标、分析其作用机制，并提出重加权算法优化训练策略，在数学推理任务中验证有效性。**

- **链接: [http://arxiv.org/pdf/2510.03669v1](http://arxiv.org/pdf/2510.03669v1)**

> **作者:** Wenlong Deng; Yi Ren; Yushu Li; Boying Gong; Danica J. Sutherland; Xiaoxiao Li; Christos Thrampoulidis
>
> **摘要:** Reinforcement learning with verifiable rewards has significantly advanced the reasoning capabilities of large language models, yet how to explicitly steer training toward exploration or exploitation remains an open problem. We introduce Token Hidden Reward (THR), a token-level metric that quantifies each token's influence on the likelihood of correct responses under Group Relative Policy Optimization (GRPO). We find that training dynamics are dominated by a small subset of tokens with high absolute THR values. Most interestingly, tokens with positive THR strengthen confidence in correct outputs, thus favoring exploitation, while tokens with negative THR preserve probability mass for alternative outputs, enabling exploration. This insight suggests a natural intervention: a THR-guided reweighting algorithm that modulates GRPO's learning signals to explicitly bias training toward exploitation or exploration. We validate the efficacy of this algorithm on diverse math reasoning benchmarks. By amplifying tokens with positive THR value and weakening negative ones, our algorithm improves greedy-decoding accuracy, favoring exploitation. The reverse strategy yields consistent gains in Pass@K accuracy, favoring exploration. We further demonstrate that our algorithm integrates seamlessly with other RL objectives such as GSPO and generalizes across architectures including Llama. These findings establish THR as a principled and fine-grained mechanism for dynamically controlling exploration and exploitation in RL-tuned LLMs, providing new tools for targeted fine-tuning in reasoning-intensive applications.
>
---
#### [new 153] MARS: Optimizing Dual-System Deep Research via Multi-Agent Reinforcement Learning
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决大模型在简单任务中过度推理、效率低及适应动态环境能力差的问题。工作提出MARS框架，结合直觉与深度推理，利用多智能体强化学习与外部工具，提升复杂推理性能。**

- **链接: [http://arxiv.org/pdf/2510.04935v1](http://arxiv.org/pdf/2510.04935v1)**
...
> **备注:** Ongoing Work
>
> **摘要:** Large Reasoning Models (LRMs) often exhibit a tendency for overanalysis in simple tasks, where the models excessively utilize System 2-type, deliberate reasoning, leading to inefficient token generation. Furthermore, these models face challenges in adapting their reasoning capabilities to rapidly changing environments due to the static nature of their pretraining data. To address these issues, advancing Large Language Models (LLMs) for complex reasoning tasks requires innovative approaches that bridge intuitive and deliberate cognitive processes, akin to human cognition's dual-system dynamic. This paper introduces a Multi-Agent System for Deep ReSearch (MARS) enabling seamless integration of System 1's fast, intuitive thinking with System 2's deliberate reasoning within LLMs. MARS strategically integrates multiple external tools, such as Google Search, Google Scholar, and Python Interpreter, to access up-to-date information and execute complex computations, while creating a specialized division of labor where System 1 efficiently processes and summarizes high-volume external information, providing distilled insights that expand System 2's reasoning context without overwhelming its capacity. Furthermore, we propose a multi-agent reinforcement learning framework extending Group Relative Policy Optimization to simultaneously optimize both systems with multi-turn tool interactions, bin-packing optimization, and sample balancing strategies that enhance collaborative efficiency. Extensive experiments demonstrate MARS achieves substantial improvements of 3.86% on the challenging Humanity's Last Exam (HLE) benchmark and an average gain of 8.9% across 7 knowledge-intensive tasks, validating the effectiveness of our dual-system paradigm for complex reasoning in dynamic information environments.
>
---
#### [new 154] Investigating LLM Variability in Personalized Conversational Information Retrieval
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于个性化对话信息检索（CIR）任务，旨在解决大型语言模型（LLM）在个性化检索中的输出变异性与可重复性问题。作者通过复现并扩展前人工作，评估不同模型与数据集下的性能差异，发现人工选择的个性化知识库更有效，且强调多轮评估与方差报告的重要性。**

- **链接: [http://arxiv.org/pdf/2510.03795v1](http://arxiv.org/pdf/2510.03795v1)**
...
>
---
#### [new 157] Person-Centric Annotations of LAION-400M: Auditing Bias and Its Transfer to Models
...
>
---
#### [new 158] P2P: A Poison-to-Poison Remedy for Reliable Backdoor Defense in LLMs
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在微调过程中易受数据投毒后门攻击的问题。作者提出了一种名为Poison-to-Poison（P2P）的防御方法，通过在训练数据中注入良性触发器并进行提示学习，使模型将触发器与安全输出关联，从而覆盖恶意后门的影响，提升模型的可靠性和安全性。**

- **链接: [http://arxiv.org/pdf/2510.04503v1](http://arxiv.org/pdf/2510.04503v1)**
...
>
---
#### [new 159] CAFL-L: Constraint-Aware Federated Learning with Lagrangian Dual Optimization for On-Device Language Models
- **分类: cs.LG; cs.CL; cs.DC**

- **简介: 论文提出CAFL-L，一种考虑设备资源约束的联邦学习方法，用于设备端语言模型训练。它通过拉格朗日对偶优化动态调整训练参数，在满足能量、通信、内存等限制的同时保持训练稳定性和性能。**

- **链接: [http://arxiv.org/pdf/2510.03298v1](http://arxiv.org/pdf/2510.03298v1)**
...
>
---
#### [new 160] Lightweight Prompt Engineering for Cognitive Alignment in Educational AI: A OneClickQuiz Case Study
...
>
---
#### [new 161] Consistent Kernel Change-Point Detection under m-Dependence for Text Segmentation
- **分类: cs.LG; cs.CL; stat.ML**

- **简介: 该论文属于文本分割任务，旨在解决在强依赖数据下检测文本结构变化点的问题。论文提出在m-依赖数据下对核变点检测（KCPD）方法的一致性保证，并通过LLM生成合成数据验证理论结果。此外，论文展示了基于现代文本嵌入的KCPD方法在多个文本数据集上的优越性能，并通过泰勒·斯威夫特推文的案例研究展示了其实用效果。**

- **链接: [http://arxiv.org/pdf/2510.03437v1](http://arxiv.org/pdf/2510.03437v1)**
...
>
---
#### [new 164] MedCLM: Learning to Localize and Reason via a CoT-Curriculum in Medical Vision-Language Models
...
>
---
#### [new 165] Mind the Goal: Data-Efficient Goal-Oriented Evaluation of Conversational Agents and Chatbots using Teacher Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于对话系统评估任务，旨在解决现有方法无法有效衡量用户目标完成情况的问题。论文提出了一种目标导向的评估框架，包括目标成功率（GSR）和失败根本原因（RCOF）分类体系，利用教师模型进行数据高效、可解释的评估，并应用于企业聊天机器人AIDA，取得了GSR提升。**

- **链接: [http://arxiv.org/pdf/2510.03696v1](http://arxiv.org/pdf/2510.03696v1)**
...
>
---
#### [new 166] Speak, Edit, Repeat: High-Fidelity Voice Editing and Zero-Shot TTS with Cross-Attentive Mamba
...
>
---
#### [new 169] Visual Lifelog Retrieval through Captioning-Enhanced Interpretation
...
>
---
#### [new 172] Enhancing OCR for Sino-Vietnamese Language Processing via Fine-tuned PaddleOCRv5
...
>
---
#### [new 173] Red Lines and Grey Zones in the Fog of War: Benchmarking Legal Risk, Moral Harm, and Regional Bias in Large Language Model Military Decision-Making
- **分类: cs.CY; cs.AI; cs.CL**
...
>
---
#### [new 176] Multimodal Arabic Captioning with Interpretable Visual Concept Integration
...
>
---
#### [new 179] More Than Meets the Eye? Uncovering the Reasoning-Planning Disconnect in Training Vision-Language Driving Models
- **分类: cs.AI; cs.CL; cs.RO**

- **简介: 该论文研究视觉-语言模型（VLM）在自动驾驶中的推理与规划之间的因果关系。它提出了DriveMind数据集和训练-免费探测工具，揭示推理并非规划的因果中介，挑战了现有假设，并为未来模型评估提供新方法。**

- **链接: [http://arxiv.org/pdf/2510.04532v1](http://arxiv.org/pdf/2510.04532v1)**
...
#### [replaced 001] Post-training Large Language Models for Diverse High-Quality Responses
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.04784v2](http://arxiv.org/pdf/2509.04784v2)**
...
>
---
#### [replaced 002] Infini-gram mini: Exact n-gram Search at the Internet Scale with FM-Index
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.12229v4](http://arxiv.org/pdf/2506.12229v4)**
...
>
---
#### [replaced 003] Beyond Chunking: Discourse-Aware Hierarchical Retrieval for Long Document Question Answering
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.06313v3](http://arxiv.org/pdf/2506.06313v3)**
...
>
---
#### [replaced 004] Revisiting Backdoor Attacks on LLMs: A Stealthy and Practical Poisoning Framework via Harmless Inputs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17601v5](http://arxiv.org/pdf/2505.17601v5)**
...
>
---
#### [replaced 005] Self-Correction Bench: Uncovering and Addressing the Self-Correction Blind Spot in Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.02778v2](http://arxiv.org/pdf/2507.02778v2)**
...
>
---
#### [replaced 008] OptimalThinkingBench: Evaluating Over and Underthinking in LLMs
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.13141v2](http://arxiv.org/pdf/2508.13141v2)**

> **作者:** Pranjal Aggarwal; Seungone Kim; Jack Lanchantin; Sean Welleck; Jason Weston; Ilia Kulikov; Swarnadeep Saha
>
> **备注:** 30 pages, 10 tables, 11 figures
>
...
>
---
#### [replaced 009] Less LLM, More Documents: Searching for Improved RAG
- **分类: cs.IR; cs.CL; H.3.3; I.2.7**

- **链接: [http://arxiv.org/pdf/2510.02657v2](http://arxiv.org/pdf/2510.02657v2)**

> **作者:** Jingjie Ning; Yibo Kong; Yunfan Long; Jamie Callan
>
> **摘要:** Retrieval-Augmented Generation (RAG) couples document retrieval with large language models (LLMs). While scaling generators improves accuracy, it also raises cost and limits deployability. We explore an orthogonal axis: enlarging the retriever's corpus to reduce reliance on large LLMs. Experimental results show that corpus scaling consistently strengthens RAG and can often serve as a substitute for increasing model size, though with diminishing returns at larger scales. Small- and mid-sized generators paired with larger corpora often rival much larger models with smaller corpora; mid-sized models tend to gain the most, while tiny and large models benefit less. Our analysis shows that improvements arise primarily from increased coverage of answer-bearing passages, while utilization efficiency remains largely unchanged. These findings establish a principled corpus-generator trade-off: investing in larger corpora offers an effective path to stronger RAG, often comparable to enlarging the LLM itself.
>
---
#### [replaced 010] Improving Low-Resource Sequence Labeling with Knowledge Fusion and Contextual Label Explanations
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2501.19093v4](http://arxiv.org/pdf/2501.19093v4)**
...
>
---
#### [replaced 011] SurGE: A Benchmark and Evaluation Framework for Scientific Survey Generation
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2508.15658v2](http://arxiv.org/pdf/2508.15658v2)**
...
>
---
#### [replaced 012] Auto-ARGUE: LLM-Based Report Generation Evaluation
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.26184v3](http://arxiv.org/pdf/2509.26184v3)**

> **作者:** William Walden; Orion Weller; Laura Dietz; Bryan Li; Gabrielle Kaili-May Liu; Yu Hou; Eugene Yang
>
> **备注:** ECIR 2025 demo format
>
> **摘要:** Generation of long-form, citation-backed reports is a primary use case for retrieval augmented generation (RAG) systems. While open-source evaluation tools exist for various RAG tasks, ones tailored to report generation are lacking. Accordingly, we introduce Auto-ARGUE, a robust LLM-based implementation of the recent ARGUE framework for report generation evaluation. We present analysis of Auto-ARGUE on the report generation pilot task from the TREC 2024 NeuCLIR track, showing good system-level correlations with human judgments. We further release a web app for visualization of Auto-ARGUE outputs.
>
---
#### [replaced 013] Scientific Paper Retrieval with LLM-Guided Semantic-Based Ranking
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.21815v2](http://arxiv.org/pdf/2505.21815v2)**
...
>
---
#### [replaced 014] FedMentor: Domain-Aware Differential Privacy for Heterogeneous Federated LLMs in Mental Health
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.14275v2](http://arxiv.org/pdf/2509.14275v2)**
...
>
---
#### [replaced 015] Instruction Boundary: Quantifying Biases in LLM Reasoning under Various Coverage
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.20278v2](http://arxiv.org/pdf/2509.20278v2)**
...
>
---
#### [replaced 017] A Stitch in Time Saves Nine: Proactive Self-Refinement for Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.12903v2](http://arxiv.org/pdf/2508.12903v2)**
...
>
---
#### [replaced 018] HEART: Emotionally-driven test-time scaling of Language Models
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.22876v2](http://arxiv.org/pdf/2509.22876v2)**
...
>
---
#### [replaced 019] DISC: Dynamic Decomposition Improves LLM Inference Scaling
- **分类: cs.LG; cs.AI; cs.CL; cs.SE; 68T07, 68W40; I.2.6; I.2.7; I.2.8; D.2.3; F.2.2**

- **链接: [http://arxiv.org/pdf/2502.16706v3](http://arxiv.org/pdf/2502.16706v3)**
...
>
---
#### [replaced 021] Safety Subspaces are Not Linearly Distinct: A Fine-Tuning Case Study
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.14185v2](http://arxiv.org/pdf/2505.14185v2)**
...
>
---
#### [replaced 022] Adversarial Defence without Adversarial Defence: Enhancing Language Model Robustness via Instance-level Principal Component Removal
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.21750v2](http://arxiv.org/pdf/2507.21750v2)**
...
>
---
#### [replaced 023] Insights from the Inverse: Reconstructing LLM Training Goals Through Inverse Reinforcement Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.12491v3](http://arxiv.org/pdf/2410.12491v3)**

> **作者:** Jared Joselowitz; Ritam Majumdar; Arjun Jagota; Matthieu Bou; Nyal Patel; Satyapriya Krishna; Sonali Parbhoo
>
> **备注:** Published as a conference paper at COLM 2025
>
> **摘要:** Large language models (LLMs) trained with Reinforcement Learning from Human Feedback (RLHF) have demonstrated remarkable capabilities, but their underlying reward functions and decision-making processes remain opaque. This paper introduces a novel approach to interpreting LLMs by applying inverse reinforcement learning (IRL) to recover their implicit reward functions. We conduct experiments on toxicity-aligned LLMs of varying sizes, extracting reward models that achieve up to 85% accuracy in predicting human preferences. Our analysis reveals key insights into the non-identifiability of reward functions, the relationship between model size and interpretability, and potential pitfalls in the RLHF process. We demonstrate that IRL-derived reward models can be used to fine-tune new LLMs, resulting in comparable or improved performance on toxicity benchmarks. This work provides a new lens for understanding and improving LLM alignment, with implications for the responsible development and deployment of these powerful systems.
>
---
#### [replaced 024] CBVLM: Training-free Explainable Concept-based Large Vision Language Models for Medical Image Classification
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 028] Extracting the Structure of Press Releases for Predicting Earnings Announcement Returns
- **分类: q-fin.CP; cs.CE; cs.CL; cs.LG; J.4; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.24254v2](http://arxiv.org/pdf/2509.24254v2)**
...
>
---
#### [replaced 029] A quantitative analysis of semantic information in deep representations of text and images
- **分类: cs.CL; cs.LG; physics.comp-ph**

- **链接: [http://arxiv.org/pdf/2505.17101v3](http://arxiv.org/pdf/2505.17101v3)**
...
>
---
#### [replaced 030] SSFO: Self-Supervised Faithfulness Optimization for Retrieval-Augmented Generation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.17225v2](http://arxiv.org/pdf/2508.17225v2)**
...
>
---
#### [replaced 031] TACO: Enhancing Multimodal In-context Learning via Task Mapping-Guided Sequence Configuration
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 032] Praxis-VLM: Vision-Grounded Decision Making via Text-Driven Reinforcement Learning
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 043] MAGIC: A Multi-Hop and Graph-Based Benchmark for Inter-Context Conflicts in Retrieval-Augmented Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.21544v2](http://arxiv.org/pdf/2507.21544v2)**
...
>
---
#### [replaced 046] Testing Low-Resource Language Support in LLMs Using Language Proficiency Exams: the Case of Luxembourgish
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.01667v3](http://arxiv.org/pdf/2504.01667v3)**

> **作者:** Cedric Lothritz; Jordi Cabot; Laura Bernardy
>
> **备注:** 23pages, 4 figures, 14 tables
>
...
>
---
#### [replaced 047] SemViQA: A Semantic Question Answering System for Vietnamese Information Fact-Checking
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.00955v3](http://arxiv.org/pdf/2503.00955v3)**

> **作者:** Dien X. Tran; Nam V. Nguyen; Thanh T. Tran; Anh T. Hoang; Tai V. Duong; Di T. Le; Phuc-Lu Le
>
> **备注:** 18 pages
>
> **摘要:** The rise of misinformation, exacerbated by Large Language Models (LLMs) like GPT and Gemini, demands robust fact-checking solutions, especially for low-resource languages like Vietnamese. Existing methods struggle with semantic ambiguity, homonyms, and complex linguistic structures, often trading accuracy for efficiency. We introduce SemViQA, a novel Vietnamese fact-checking framework integrating Semantic-based Evidence Retrieval (SER) and Two-step Verdict Classification (TVC). Our approach balances precision and speed, achieving state-of-the-art results with 78.97\% strict accuracy on ISE-DSC01 and 80.82\% on ViWikiFC, securing 1st place in the UIT Data Science Challenge. Additionally, SemViQA Faster improves inference speed 7x while maintaining competitive accuracy. SemViQA sets a new benchmark for Vietnamese fact verification, advancing the fight against misinformation. The source code is available at: https://github.com/DAVID-NGUYEN-S16/SemViQA.
>
---
#### [replaced 048] Can Large Language Models Outperform Non-Experts in Poetry Evaluation? A Comparative Study Using the Consensual Assessment Technique
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.19064v2](http://arxiv.org/pdf/2502.19064v2)**
...
>
---
#### [replaced 053] SRPO: Enhancing Multimodal LLM Reasoning via Reflection-Aware Reinforcement Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.01713v3](http://arxiv.org/pdf/2506.01713v3)**
...
>
---
#### [replaced 054] Pretraining with hierarchical memories: separating long-tail and common knowledge
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.02375v2](http://arxiv.org/pdf/2510.02375v2)**
...
>
---
#### [replaced 055] SurveyBench: Can LLM(-Agents) Write Academic Surveys that Align with Reader Needs?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.03120v2](http://arxiv.org/pdf/2510.03120v2)**

> **作者:** Zhaojun Sun; Xuzhou Zhu; Xuanhe Zhou; Xin Tong; Shuo Wang; Jie Fu; Guoliang Li; Zhiyuan Liu; Fan Wu
>
> **备注:** Visit our code repository at: https://github.com/weAIDB/SurveyBench
>
...
>
---
#### [replaced 056] Learning to Reason as Action Abstractions with Scalable Mid-Training RL
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **链接: [http://arxiv.org/pdf/2509.25810v2](http://arxiv.org/pdf/2509.25810v2)**

> **作者:** Shenao Zhang; Donghan Yu; Yihao Feng; Bowen Jin; Zhaoran Wang; John Peebles; Zirui Wang
>
> **摘要:** Large language models excel with reinforcement learning (RL), but fully unlocking this potential requires a mid-training stage. An effective mid-training phase should identify a compact set of useful actions and enable fast selection among them through online RL. We formalize this intuition by presenting the first theoretical result on how mid-training shapes post-training: it characterizes an action subspace that minimizes both the value approximation error from pruning and the RL error during subsequent planning. Our analysis reveals two key determinants of mid-training effectiveness: pruning efficiency, which shapes the prior of the initial RL policy, and its impact on RL convergence, which governs the extent to which that policy can be improved via online interactions. These results suggest that mid-training is most effective when the decision space is compact and the effective horizon is short, highlighting the importance of operating in the space of action abstractions rather than primitive actions. Building on these insights, we propose Reasoning as Action Abstractions (RA3), a scalable mid-training algorithm. Specifically, we derive a sequential variational lower bound and optimize it by iteratively discovering temporally-consistent latent structures via RL, followed by fine-tuning on the bootstrapped data. Experiments on code generation tasks demonstrate the effectiveness of our approach. Across multiple base models, RA3 improves the average performance on HumanEval and MBPP by 8 and 4 points over the base model and the next-token prediction baseline. Furthermore, RA3 achieves faster convergence and higher asymptotic performance in RLVR on HumanEval+, MBPP+, LiveCodeBench, and Codeforces.
>
---
#### [replaced 057] LexiMark: Robust Watermarking via Lexical Substitutions to Enhance Membership Verification of an LLM's Textual Training Data
- **分类: cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2506.14474v2](http://arxiv.org/pdf/2506.14474v2)**
...
>
---
#### [replaced 058] InfoMosaic-Bench: Evaluating Multi-Source Information Seeking in Tool-Augmented Agents
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.02271v2](http://arxiv.org/pdf/2510.02271v2)**

> **作者:** Yaxin Du; Yuanshuo Zhang; Xiyuan Yang; Yifan Zhou; Cheng Wang; Gongyi Zou; Xianghe Pang; Wenhao Wang; Menglan Chen; Shuo Tang; Zhiyu Li; Feiyu Xiong; Siheng Chen
>
...
>
---
#### [replaced 059] Don't Pay Attention, PLANT It: Pretraining Attention via Learning-to-Rank
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.23066v2](http://arxiv.org/pdf/2410.23066v2)**
...
>
---
#### [replaced 060] Improve MLLM Benchmark Efficiency through Interview
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.00883v2](http://arxiv.org/pdf/2506.00883v2)**

> **作者:** Farong Wen; Yijin Guo; Junying Wang; Jiaohao Xiao; Yingjie Zhou; Ye Shen; Qi Jia; Chunyi Li; Zicheng Zhang
>
> **摘要:** The rapid development of Multimodal Large Language Models (MLLM) has led to a wide range of MLLM applications, and a number of benchmark datasets have sprung up in order to assess MLLM abilities. However, full-coverage Q&A testing on large-scale data is resource-intensive and time-consuming. To address this issue, we propose the MLLM Interview (MITV) strategy, which aims to quickly obtain MLLM performance metrics by quizzing fewer question. First, First, we constructed the interview dataset, which was built on an existing MLLM assessment dataset, by adding difficulty labels based on the performance of some typical MLLMs in this dataset. Second, we propose an MLLM Interview strategy, which obtains an initial performance situation of the large model by quizzing a small number of topics and then continuously tries to test the model's limits. Through extensive experiments, the result shows that the MITV strategy proposed in this paper performs well on MLLM benchmark datasets, and it is able to obtain the model evaluation capability faster through a small number of questions and answers.
>
---
#### [replaced 061] Format Inertia: A Failure Mechanism of LLMs in Medical Pre-Consultation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.01688v2](http://arxiv.org/pdf/2510.01688v2)**
...
>
---
#### [replaced 067] Towards Enforcing Company Policy Adherence in Agentic Workflows
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.16459v2](http://arxiv.org/pdf/2507.16459v2)**
...
>
---
#### [replaced 068] Pushing LLMs to Their Logical Reasoning Bound: The Role of Data Reasoning Intensity
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.24836v3](http://arxiv.org/pdf/2509.24836v3)**
...
>
---
#### [replaced 069] On the Self-awareness of Large Reasoning Models' Capability Boundaries
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.24711v2](http://arxiv.org/pdf/2509.24711v2)**
...
>
---
#### [replaced 070] Enhancing Unsupervised Sentence Embeddings via Knowledge-Driven Data Augmentation and Gaussian-Decayed Contrastive Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2409.12887v5](http://arxiv.org/pdf/2409.12887v5)**
...
>
---
#### [replaced 071] When "Competency" in Reasoning Opens the Door to Vulnerability: Jailbreaking LLMs via Novel Complex Ciphers
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2402.10601v4](http://arxiv.org/pdf/2402.10601v4)**
...
>
---
#### [replaced 072] RAG over Tables: Hierarchical Memory Index, Multi-Stage Retrieval, and Benchmarking
- **分类: cs.CL; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.01346v4](http://arxiv.org/pdf/2504.01346v4)**

> **作者:** Jiaru Zou; Dongqi Fu; Sirui Chen; Xinrui He; Zihao Li; Yada Zhu; Jiawei Han; Jingrui He
>
> **备注:** Project Link: https://github.com/jiaruzouu/T-RAG
>
...
>
---
#### [replaced 073] Fed-SB: A Silver Bullet for Extreme Communication Efficiency and Performance in (Private) Federated LoRA Fine-Tuning
- **分类: cs.LG; cs.AI; cs.CL; cs.DC**

- **链接: [http://arxiv.org/pdf/2502.15436v2](http://arxiv.org/pdf/2502.15436v2)**
...
>
---
#### [replaced 074] Rethinking Exact Unlearning under Exposure: Extracting Forgotten Data under Exact Unlearning in Large Language Model
- **分类: cs.LG; cs.AI; cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2505.24379v2](http://arxiv.org/pdf/2505.24379v2)**
...
>
---
#### [replaced 075] SSA-COMET: Do LLMs Outperform Learned Metrics in Evaluating MT for Under-Resourced African Languages?
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.04557v2](http://arxiv.org/pdf/2506.04557v2)**
...
>
---
#### [replaced 076] AgentBench: Evaluating LLMs as Agents
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2308.03688v3](http://arxiv.org/pdf/2308.03688v3)**
...
>
---
#### [replaced 078] StressTest: Can YOUR Speech LM Handle the Stress?
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [replaced 079] CE-GPPO: Coordinating Entropy via Gradient-Preserving Clipping Policy Optimization in Reinforcement Learning
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.20712v3](http://arxiv.org/pdf/2509.20712v3)**
...
>
---
#### [replaced 080] Chasing Moving Targets with Online Self-Play Reinforcement Learning for Safer Language Models
- **分类: cs.LG; cs.CL; cs.MA**

- **链接: [http://arxiv.org/pdf/2506.07468v3](http://arxiv.org/pdf/2506.07468v3)**
...
>
---
#### [replaced 081] Text-Based Approaches to Item Alignment to Content Standards in Large-Scale Reading & Writing Tests
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.26431v2](http://arxiv.org/pdf/2509.26431v2)**
...
>
---
#### [replaced 082] From Compression to Expression: A Layerwise Analysis of In-Context Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.17322v2](http://arxiv.org/pdf/2505.17322v2)**
...
>
---
#### [replaced 083] Can We Infer Confidential Properties of Training Data from LLMs?
- **分类: cs.LG; cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2506.10364v3](http://arxiv.org/pdf/2506.10364v3)**
...
>
---
#### [replaced 084] Reasoning over Boundaries: Enhancing Specification Alignment via Test-time Deliberation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.14760v2](http://arxiv.org/pdf/2509.14760v2)**
...
>
---
#### [replaced 085] Your Models Have Thought Enough: Training Large Reasoning Models to Stop Overthinking
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.23392v2](http://arxiv.org/pdf/2509.23392v2)**
...
>
---
#### [replaced 086] X-Teaming Evolutionary M2S: Automated Discovery of Multi-turn to Single-turn Jailbreak Templates
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.08729v2](http://arxiv.org/pdf/2509.08729v2)**
...
>
---
#### [replaced 087] Empowering Healthcare Practitioners with Language Models: Structuring Speech Transcripts in Two Real-World Clinical Applications
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.05517v3](http://arxiv.org/pdf/2507.05517v3)**

> **作者:** Jean-Philippe Corbeil; Asma Ben Abacha; George Michalopoulos; Phillip Swazinna; Miguel Del-Agua; Jerome Tremblay; Akila Jeeson Daniel; Cari Bader; Yu-Cheng Cho; Pooja Krishnan; Nathan Bodenstab; Thomas Lin; Wenxuan Teng; Francois Beaulieu; Paul Vozila
>
...
>
---
#### [replaced 088] TIME: A Multi-level Benchmark for Temporal Reasoning of LLMs in Real-World Scenarios
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.12891v3](http://arxiv.org/pdf/2505.12891v3)**
...
>
---
#### [replaced 089] ArcMemo: Abstract Reasoning Composition with Lifelong LLM Memory
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.04439v3](http://arxiv.org/pdf/2509.04439v3)**
...
>
---
#### [replaced 090] RL Grokking Recipe: How Does RL Unlock and Transfer New Algorithms in LLMs?
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.21016v2](http://arxiv.org/pdf/2509.21016v2)**
...
>
---
#### [replaced 091] Query-Level Uncertainty in Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.09669v3](http://arxiv.org/pdf/2506.09669v3)**
...
>
---
#### [replaced 092] XAutoLM: Efficient Fine-Tuning of Language Models via Meta-Learning and AutoML
- **分类: cs.CL; 68T05, 68T50; I.2.6; I.2.7; I.2.8**

- **链接: [http://arxiv.org/pdf/2508.00924v3](http://arxiv.org/pdf/2508.00924v3)**
...
>
---
#### [replaced 093] K-DeCore: Facilitating Knowledge Transfer in Continual Structured Knowledge Reasoning via Knowledge Decoupling
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.16929v5](http://arxiv.org/pdf/2509.16929v5)**
...
>
---
#### [replaced 094] DiffSampling: Enhancing Diversity and Accuracy in Neural Text Generation
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.14037v4](http://arxiv.org/pdf/2502.14037v4)**
...
>
---
#### [replaced 095] Time Is a Feature: Exploiting Temporal Dynamics in Diffusion Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09138v3](http://arxiv.org/pdf/2508.09138v3)**
...
>
---
#### [replaced 096] Unlocking In-Context Learning for Natural Datasets Beyond Language Modelling
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.06256v3](http://arxiv.org/pdf/2501.06256v3)**
...
>
---
#### [replaced 097] RealKIE: Five Novel Datasets for Enterprise Key Information Extraction
...
>
---
#### [replaced 098] Fun-ASR Technical Report
...
>
---
#### [replaced 099] Non-Collaborative User Simulators for Tool Agents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.23124v2](http://arxiv.org/pdf/2509.23124v2)**
...
>
---
#### [replaced 100] ClinicRealm: Re-evaluating Large Language Models with Conventional Machine Learning for Non-Generative Clinical Prediction Tasks
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2407.18525v3](http://arxiv.org/pdf/2407.18525v3)**
...
>
---
#### [replaced 103] AgentRewardBench: Evaluating Automatic Evaluations of Web Agent Trajectories
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2504.08942v2](http://arxiv.org/pdf/2504.08942v2)**
...
>
---
#### [replaced 104] What Has Been Lost with Synthetic Evaluation?
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.22830v3](http://arxiv.org/pdf/2505.22830v3)**
...
>
---
#### [replaced 105] Scaling Laws of Synthetic Data for Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.19551v3](http://arxiv.org/pdf/2503.19551v3)**
...
>
---
#### [replaced 109] SCAN: Structured Capability Assessment and Navigation for LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.06698v3](http://arxiv.org/pdf/2505.06698v3)**
...
>
---
#### [replaced 110] J1: Incentivizing Thinking in LLM-as-a-Judge via Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.10320v2](http://arxiv.org/pdf/2505.10320v2)**

> **作者:** Chenxi Whitehouse; Tianlu Wang; Ping Yu; Xian Li; Jason Weston; Ilia Kulikov; Swarnadeep Saha
>
> **备注:** 10 pages, 13 tables, 14 figures
>
...
>
---
#### [replaced 111] Language Agents Mirror Human Causal Reasoning Biases. How Can We Help Them Think Like Scientists?
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.09614v3](http://arxiv.org/pdf/2505.09614v3)**

> **作者:** Anthony GX-Chen; Dongyan Lin; Mandana Samiei; Doina Precup; Blake A. Richards; Rob Fergus; Kenneth Marino
>
> **备注:** Conference on Language Modelling (COLM) 2025, Camera Ready
>
...
>
---
#### [replaced 112] HiKE: Hierarchical Evaluation Framework for Korean-English Code-Switching Speech Recognition
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [replaced 113] Beyond Manuals and Tasks: Instance-Level Context Learning for LLM Agents
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.02369v2](http://arxiv.org/pdf/2510.02369v2)**
...
>
---
#### [replaced 114] Non-Interactive Symbolic-Aided Chain-of-Thought for Logical Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.12425v2](http://arxiv.org/pdf/2508.12425v2)**
...
>
---
#### [replaced 115] Latent Visual Reasoning
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 116] Deliberate Planning in Language Models with Symbolic Representation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.01479v3](http://arxiv.org/pdf/2505.01479v3)**
...
>
---
#### [replaced 118] C3: A Bilingual Benchmark for Spoken Dialogue Models Exploring Challenges in Complex Conversations
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.22968v3](http://arxiv.org/pdf/2507.22968v3)**
...
>
---
#### [replaced 119] COSPADI: Compressing LLMs via Calibration-Guided Sparse Dictionary Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22075v2](http://arxiv.org/pdf/2509.22075v2)**
...
>
---
#### [replaced 124] Understanding R1-Zero-Like Training: A Critical Perspective
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.20783v2](http://arxiv.org/pdf/2503.20783v2)**

> **作者:** Zichen Liu; Changyu Chen; Wenjun Li; Penghui Qi; Tianyu Pang; Chao Du; Wee Sun Lee; Min Lin
>
> **摘要:** DeepSeek-R1-Zero has shown that reinforcement learning (RL) at scale can directly enhance the reasoning capabilities of LLMs without supervised fine-tuning. In this work, we critically examine R1-Zero-like training by analyzing its two core components: base models and RL. We investigate a wide range of base models, including DeepSeek-V3-Base, to understand how pretraining characteristics influence RL performance. Our analysis reveals that DeepSeek-V3-Base already exhibit ''Aha moment'', while Qwen2.5 base models demonstrate strong reasoning capabilities even without prompt templates, suggesting potential pretraining biases. Additionally, we identify an optimization bias in Group Relative Policy Optimization (GRPO), which artificially increases response length (especially for incorrect outputs) during training. To address this, we introduce Dr. GRPO, an unbiased optimization method that improves token efficiency while maintaining reasoning performance. Leveraging these insights, we present a minimalist R1-Zero recipe that achieves 43.3% accuracy on AIME 2024 with a 7B base model, establishing a new state-of-the-art. Our code is available at https://github.com/sail-sg/understand-r1-zero.
>
---
#### [replaced 125] Self-GIVE: Associative Thinking from Limited Structured Knowledge for Enhanced Large Language Model Reasoning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.15062v3](http://arxiv.org/pdf/2505.15062v3)**
...
>
---
#### [replaced 128] Semantic Similarity in Radiology Reports via LLMs and NER
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.03102v2](http://arxiv.org/pdf/2510.03102v2)**

> **作者:** Beth Pearson; Ahmed Adnan; Zahraa S. Abdallah
>
...
>
---
#### [replaced 129] Summaries as Centroids for Interpretable and Scalable Text Clustering
- **分类: cs.CL; cs.LG; stat.ML**

- **链接: [http://arxiv.org/pdf/2502.09667v3](http://arxiv.org/pdf/2502.09667v3)**
...
>
---
#### [replaced 130] ML2B: Multi-Lingual ML Benchmark For AutoML
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22768v2](http://arxiv.org/pdf/2509.22768v2)**
...
>
---
#### [replaced 133] Can Large Language Models generalize analogy solving like children can?
- **分类: cs.AI; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2411.02348v3](http://arxiv.org/pdf/2411.02348v3)**
...
>
---
#### [replaced 134] Is It Thinking or Cheating? Detecting Implicit Reward Hacking by Measuring Reasoning Effort
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.01367v2](http://arxiv.org/pdf/2510.01367v2)**
...
>
---
#### [replaced 135] Char-mander Use mBackdoor! A Study of Cross-lingual Backdoor Attacks in Multilingual LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.16901v3](http://arxiv.org/pdf/2502.16901v3)**
...
>
---
#### [replaced 136] Meta-Pretraining for Zero-Shot Cross-Lingual Named Entity Recognition in Low-Resource Philippine Languages
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.02160v2](http://arxiv.org/pdf/2509.02160v2)**

> **作者:** David Demitri Africa; Suchir Salhan; Yuval Weiss; Paula Buttery; Richard Diehl Martinez
>
> **备注:** Accepted (poster) to 5th Workshop on Multilingual Representation Learning at EMNLP 2025
>
...
>
---
#### [replaced 139] Filtering for Creativity: Adaptive Prompting for Multilingual Riddle Generation in LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.18709v2](http://arxiv.org/pdf/2508.18709v2)**

> **作者:** Duy Le; Kent Ziti; Evan Girard-Sun; Bakr Bouhaya; Sean O'Brien; Vasu Sharma; Kevin Zhu
>
...
>
---
#### [replaced 142] MMLongBench: Benchmarking Long-Context Vision-Language Models Effectively and Thoroughly
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 145] Understanding Retrieval Augmentation for Long-Form Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2310.12150v2](http://arxiv.org/pdf/2310.12150v2)**

> **作者:** Hung-Ting Chen; Fangyuan Xu; Shane Arora; Eunsol Choi
>
> **备注:** COLM 2024 Camera Ready Version
>
> **摘要:** How retrieved documents are used in language models (LMs) for long-form generation task is understudied. We present two controlled studies on retrieval-augmented LM for long-form question answering (LFQA): one fixing the LM and varying evidence documents and the other fixing evidence documents and varying the LMs. We study various attributes of generated answers (e.g., fluency, length, variance), with an emphasis on the attribution of generated answers to in-context evidence documents. We collect a dataset (SALAD) containing human annotations of sentence-level answer attribution in LFQA and evaluate existing methods for automatically judging attribution. We find that while LMs can leverage relevant in-context documents, the generated answer is only partially attributable towards the documents, especially for LMs trained without retrieval augmentation. Together, our analysis reveals how retrieval augmentation impacts long knowledge-rich text generation and provide directions for future work.
>
---
#### [replaced 146] Analyzing Information-Seeking Behaviors in a Hakka AI Chatbot: A Cognitive-Pragmatic Study
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.11591v2](http://arxiv.org/pdf/2509.11591v2)**
...
>
---
#### [replaced 147] LegalSearchLM: Rethinking Legal Case Retrieval as Legal Elements Generation
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2505.23832v3](http://arxiv.org/pdf/2505.23832v3)**
...
>
---
#### [replaced 148] Geometry of orofacial neuromuscular signals: speech articulation decoding using surface electromyography
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2411.02591v3](http://arxiv.org/pdf/2411.02591v3)**
...
>
---
#### [replaced 151] ZSMerge: Zero-Shot KV Cache Compression for Memory-Efficient Long-Context LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.10714v3](http://arxiv.org/pdf/2503.10714v3)**

> **作者:** Xin Liu; Xudong Wang; Pei Liu; Guoming Tang
>
> **摘要:** The linear growth of key-value (KV) cache memory and quadratic computational in attention mechanisms complexity pose significant bottlenecks for large language models (LLMs) in long-context processing. While existing KV cache optimization methods address these challenges through token pruning or feature merging, they often incur irreversible information loss or require costly parameter retraining. To this end, we propose ZSMerge, a dynamic KV cache compression framework designed for efficient cache management, featuring three key operations: (1) fine-grained memory allocation guided by multi-dimensional token importance metrics at head-level granularity, (2) a residual merging mechanism that preserves critical context through compensated attention scoring, and (3) a zero-shot adaptation mechanism compatible with diverse LLM architectures without requiring retraining. ZSMerge significantly enhances memory efficiency and inference speed with negligible performance degradation across LLMs. When applied to LLaMA2-7B, it demonstrates a 20:1 compression ratio for key-value cache retention (reducing memory footprint to 5\% of baseline) while sustaining comparable generation quality, coupled with triple throughput gains at extreme 54k-token contexts that eliminate out-of-memory failures. The code is available at https://github.com/SusCom-Lab/ZSMerge.
>
---
#### [replaced 152] MEDAL: A Framework for Benchmarking LLMs as Multilingual Open-Domain Dialogue Evaluators
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.22777v4](http://arxiv.org/pdf/2505.22777v4)**
