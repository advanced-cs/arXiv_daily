...
- **链接: [http://arxiv.org/pdf/2506.03569v1](http://arxiv.org/pdf/2506.03569v1)**
...
- **简介: 该论文属于知识编辑任务，旨在解决现有方法（如MEMIT）更新语言模型知识时所需的高昂预计算成本。作者提出仅需预计算极小部分隐藏向量即可实现有效编辑，从而大幅减少预计算时间，使用户几分钟内即可开始编辑新模型。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决欧洲语言在现有大模型中覆盖不足的问题。作者开发了EuroLLM-9B，涵盖24种欧盟官方语言及11种其他语言，设计了多语言过滤器EuroFilter和合成数据集EuroBlocks-Synthetic，提升了多语言支持能力，并公开了模型及相关工具。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决如何高效释放预训练大语言模型（LLM）推理能力的问题。作者提出了一种称为“批判微调”（CFT）的方法，在仅一个问题上生成多样化解题方案并由教师模型提供反馈，用于微调模型。实验表明，该方法在多个推理任务上显著提升性能，且计算成本远低于强化学习。**
...
- **简介: 该论文属于Web智能体任务，旨在解决数字智能体在复杂网页环境中缺乏环境理解能力的问题。作者提出了Go-Browse方法，通过结构化探索网页环境，自动收集多样化、真实的数据，并基于WebArena基准构建了大规模数据集。使用该数据集微调语言模型，在该基准上取得了优于GPT-4o mini和当前SOTA小模型的效果。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在推理过程中的不确定性校准问题。通过监督微调生成口头化置信度评分，使模型自发形成自我验证行为，无需显式推理监督或强化学习。实验表明，该方法提升了准确性与可解释性，并优化了模型对低置信度问题的响应方式。**
...
- **简介: 该论文属于法律文本中的事件时序推理任务，旨在解决现有数据集缺乏专业语言评估的问题。作者构建了LexTime数据集，包含512个标注的法律事件对，用于评估大语言模型在法律语境下的事件排序能力，并分析影响模型表现的因素。**
...
- **简介: 该论文属于自然语言处理与知识图谱构建任务，旨在解决从自然语言指令生成符合ODRL标准的使用策略问题。作者利用GPT-4等大语言模型，结合ODRL本体及其文档作为提示核心，提出一种端到端的方法，并在文化领域的数据空间中进行评估，取得了高达91.95%的准确率。**
...
- **简介: 该论文属于自然语言处理任务，旨在提升结构化文本生成效率。针对现有方法解析LR(1)文法时效率低、运行时开销大的问题，提出Pre³方法，利用确定性下推自动机优化解码过程，通过预计算实现并行处理和减少运行时路径探索，显著提升了生成速度与吞吐量。**
...
- **简介: 该论文属于多语言幻觉检测任务，旨在解决大语言模型生成虚假信息的问题。通过计算特定领域模型的困惑度分布差异，识别可能的幻觉内容。方法无需外部数据或训练，适用于多种语言，并在14种语言的数据集上验证了有效性。**
...
- **链接: [http://arxiv.org/pdf/2506.04182v1](http://arxiv.org/pdf/2506.04182v1)**
...
- **简介: 论文提出“淘汰评估法”，利用大语言模型（LLMs）通过迭代的两两比较构建淘汰赛制，解决当前LLM作为评判者时缺乏全局排名的问题。该方法提升了评分准确性，更贴近专家评价，在考试评分和机器翻译评估任务中平均皮尔逊相关系数提高0.07。**
...
- **简介: 该论文属于大语言模型微调任务，旨在解决领域微调导致通用能力下降的问题。作者提出APT方法，通过自生成弱点数据和迭代偏好训练，在提升领域性能的同时保留通用能力，验证了其有效性。**
...
- **简介: 该论文探讨机器学习在评估法律推理公平性中的局限性，尤其关注难民裁决领域。任务是分析三种常见ML方法（特征分析、语义聚类、预测建模）在真实大规模数据集上的表现。研究发现这些方法存在分歧、依赖非法律特征、无法捕捉实质性法律推理，指出统计方法难以准确评估具有自由裁量权的法律公平性问题。**
...
- **简介: 该论文属于自然语言处理任务，旨在提升语言模型的数学推理能力。通过引入ClozeMath方法，以填空形式训练模型预测被掩码的方程，从而增强其解题逻辑。实验表明该方法在多个数据集上优于现有基线模型，并分析了不同设计选择的影响。**
...
- **简介: 论文研究信息密度波动是否受隐含语言周期性影响，属于自然语言处理任务。通过调和回归与时间扩展分析多语言文本，发现信息率存在与语篇结构一致的周期模式，揭示语言结构压力对信息分布的影响。**
...
- **链接: [http://arxiv.org/pdf/2506.03570v1](http://arxiv.org/pdf/2506.03570v1)**
...
- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在长文本生成中连贯性、逻辑性和质量下降的问题。作者提出了SuperWriter-Agent框架，引入结构化思考与优化流程，并通过监督微调和分层DPO训练提升生成效果，最终在多项基准测试中取得最优表现。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决奖励模型（RMs）在不同任务中适应性差的问题。现有RMs依赖固定数据集，难以应对多样化需求。作者提出RewardAnything，一种可根据自然语言原则动态调整的奖励模型，并构建了评估基准RABench。实验表明其在无需重新训练的情况下具备良好泛化能力，能有效对齐大型语言模型与多样任务目标。**
...
- **简介: 该论文属于灾害评估任务，旨在解决地震灾情快速细粒度评估问题。利用多模态大语言模型（MLLMs），构建了一个多模态、多语言、多维度的分析流程，通过图文信息实现灾情评估，并验证了其与真实地震数据的相关性，为实时灾害响应提供了新方法。**
...
- **简介: 该论文属于知识图谱嵌入任务，旨在解决现有方法未能同时有效融合知识图结构与文本语义的问题。作者提出了KG-BiLM框架，结合双向语言模型与KG信息，通过三种关键组件实现结构与语义的统一建模，并在大规模图数据上验证了其优越性能。**
...
- **简介: 该论文属于SemEval-2025 Task 4任务，旨在解决从大语言模型中移除特定知识而不影响整体性能的问题。作者提出LIBU方法，结合影响函数与二阶优化，实现高效模型“遗忘”。**
...
- **简介: 该论文提出了TextAtari基准，用于评估语言代理在长达100,000步的长视野决策任务中的表现。通过将Atari游戏视觉状态转为文本描述，结合自然语言处理与顺序决策，测试多种模型和框架，探索语义理解、指令遵循和专家示范对长期规划的影响。**
...
- **链接: [http://arxiv.org/pdf/2506.04051v1](http://arxiv.org/pdf/2506.04051v1)**
...
>
---
#### [new 072] From Understanding to Generation: An Efficient Shortcut for Evaluating Language Models
- **分类: cs.CL**

- **简介: 该论文旨在解决大语言模型（LLM）训练中生成任务（NLG）评估计算成本高的问题。通过将生成任务转化为更高效的理解任务（NLU），实现对关键能力的快速评估，实验表明两者能力评估高度相关，并减少了35倍以上的评估时间。属于模型评估优化任务。**

- **链接: [http://arxiv.org/pdf/2506.03592v1](http://arxiv.org/pdf/2506.03592v1)**
...
>
---
#### [new 077] The mutual exclusivity bias of bilingual visually grounded speech models
- **分类: cs.CL; eess.AS**

- **简介: 论文研究视觉-语音模型中的互斥性偏差，探索双语模型相较于单语模型偏差减弱的原因。任务为语言学习机制分析，问题为双语儿童为何较少使用互斥策略。工作包括训练多语言模型并分析其视觉嵌入特性。**

- **链接: [http://arxiv.org/pdf/2506.04037v1](http://arxiv.org/pdf/2506.04037v1)**
...
>
---
#### [new 078] Explainability-Based Token Replacement on LLM-Generated Text
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本生成与检测任务，旨在解决AI生成文本的可检测性问题。通过使用可解释AI方法（如SHAP和LIME）识别关键token，并提出四种基于解释性的token替换策略，以降低AI生成文本被检测的可能性。同时，设计了一个鲁棒的集成分类器来提升跨语言和跨领域的检测能力。**

- **链接: [http://arxiv.org/pdf/2506.04050v1](http://arxiv.org/pdf/2506.04050v1)**
...
>
---
#### [new 079] EuroGEST: Investigating gender stereotypes in multilingual language models
- **分类: cs.CL**

- **简介: 该论文属于多语言性别偏见评估任务，旨在解决非英语语言模型中的性别刻板印象问题。作者构建了包含29种欧洲语言的EuroGEST数据集，基于16种性别刻板印象进行扩展，并通过翻译工具、质量估计和形态学方法生成数据。经人类评估验证后，用于评测24个多语言模型，发现较大模型强化性别刻板印象，而指令微调效果不一。论文强调公平性研究需覆盖多语言场景。**

- **链接: [http://arxiv.org/pdf/2506.03867v1](http://arxiv.org/pdf/2506.03867v1)**
...
>
---
#### [new 080] LaF-GRPO: In-Situ Navigation Instruction Generation for the Visually Impaired via GRPO with LLM-as-Follower Reward
- **分类: cs.CL; cs.MM**

- **简介: 该论文属于导航指令生成任务，旨在为视障人士提供实用的实时导航指导。研究提出LaF-GRPO方法，利用大语言模型模拟用户反馈以优化视觉-语言模型的训练，减少真实数据依赖。同时构建了包含27,000个样本的开源基准NIG4VI，提升指令生成的准确性与安全性，并通过实验验证了方法的有效性。**

- **链接: [http://arxiv.org/pdf/2506.04070v1](http://arxiv.org/pdf/2506.04070v1)**
...
>
---
#### [new 088] Robust Preference Optimization via Dynamic Target Margins
- **分类: cs.CL**

- **简介: 该论文属于大型语言模型对齐任务，旨在解决偏好优化中数据噪声影响效果的问题。通过提出γ-PO算法，动态调整奖励边距，优先考虑高置信度偏好对，抑制低质量数据干扰。方法兼容现有DPO变体，提升性能且训练效率影响小。**

- **链接: [http://arxiv.org/pdf/2506.03690v1](http://arxiv.org/pdf/2506.03690v1)**
...
>
---
#### [new 093] A conclusive remark on linguistic theorizing and language modeling
- **分类: cs.CL**

- **简介: 该论文是对作者在《意大利语言学杂志》上发表的目标论文所收到的回复进行总结性评论。任务是回应学术讨论，问题为澄清语言理论化与语言建模的关系，工作是对相关争议和观点进行了最终阐述。**

- **链接: [http://arxiv.org/pdf/2506.03268v1](http://arxiv.org/pdf/2506.03268v1)**

> **作者:** Cristiano Chesi
>
> **摘要:** This is the final remark on the replies received to my target paper in the Italian Journal of Linguistics
>
---
#### [new 094] Auto prompt sql: a resource-efficient architecture for text-to-sql translation in constrained environments
- **分类: cs.CL; cs.AI; 68T50**

- **简介: 该论文属于文本到SQL（Text-to-SQL）任务，旨在解决在资源受限环境下高效实现自然语言转SQL的问题。论文提出Auto Prompt SQL架构，结合小模型与大模型优势，并引入提示工程提升推理能力，以提高在Spider基准上的准确率。**

- **链接: [http://arxiv.org/pdf/2506.03598v1](http://arxiv.org/pdf/2506.03598v1)**
...
>
---
#### [new 097] Progressive Mastery: Customized Curriculum Learning with Guided Prompting for Mathematical Reasoning
- **分类: cs.CL**

- **简介: 论文提出“渐进掌握”框架，用于数学推理任务中的定制化课程学习。针对大语言模型训练中样本利用效率低和难度处理不灵活的问题，设计了模型自适应的难度定义与“引导提示”方法，动态优化难样本使用，显著提升训练效果。**

- **链接: [http://arxiv.org/pdf/2506.04065v1](http://arxiv.org/pdf/2506.04065v1)**
...
>
> **摘要:** Large Language Models (LLMs) have achieved remarkable performance across various reasoning tasks, yet post-training is constrained by inefficient sample utilization and inflexible difficulty samples processing. To address these limitations, we propose Customized Curriculum Learning (CCL), a novel framework with two key innovations. First, we introduce model-adaptive difficulty definition that customizes curriculum datasets based on each model's individual capabilities rather than using predefined difficulty metrics. Second, we develop "Guided Prompting," which dynamically reduces sample difficulty through strategic hints, enabling effective utilization of challenging samples that would otherwise degrade performance. Comprehensive experiments on supervised fine-tuning and reinforcement learning demonstrate that CCL significantly outperforms uniform training approaches across five mathematical reasoning benchmarks, confirming its effectiveness across both paradigms in enhancing sample utilization and model performance.
>
---
#### [new 098] On Support Samples of Next Word Prediction
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升语言模型预测结果的可解释性。通过研究“支持样本”在下一词预测中的作用，利用定理分析发现支持样本是模型决策的关键因素，并揭示非支持样本在防止过拟合和表示学习中的重要性，从而提供对模型行为的新理解。**

- **链接: [http://arxiv.org/pdf/2506.04047v1](http://arxiv.org/pdf/2506.04047v1)**
...
>
---
#### [new 099] Acoustically Precise Hesitation Tagging Is Essential for End-to-End Verbatim Transcription Systems
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [new 100] A Novel Data Augmentation Approach for Automatic Speaking Assessment on Opinion Expressions
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [new 101] DynTok: Dynamic Compression of Visual Tokens for Efficient and Effective Video Understanding
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 102] ConsistentChat: Building Skeleton-Guided Consistent Dialogues for Large Language Models from Scratch
- **分类: cs.CL**

- **简介: 该论文属于对话生成任务，旨在解决多轮对话中上下文不连贯、任务完成率低的问题。作者提出Skeleton-Guided Multi-Turn Dialogue Generation框架，通过建模对话意图和生成结构化对话骨架，构建了多轮指令数据集ConsistentChat，显著提升了模型的对话一致性和任务成功率。**

- **链接: [http://arxiv.org/pdf/2506.03558v1](http://arxiv.org/pdf/2506.03558v1)**
...
>
---
#### [new 103] An Efficient Task-Oriented Dialogue Policy: Evolutionary Reinforcement Learning Injected by Elite Individuals
- **分类: cs.CL**

- **简介: 该论文属于任务导向对话系统研究，旨在解决深度强化学习在平衡探索与利用上的难题。作者提出一种融合进化算法与精英个体注入机制的方法，优化对话策略，提升性能并缩短搜索时间。**

- **链接: [http://arxiv.org/pdf/2506.03519v1](http://arxiv.org/pdf/2506.03519v1)**
...
>
---
#### [new 104] TableEval: A Real-World Benchmark for Complex, Multilingual, and Multi-Structured Table Question Answering
- **分类: cs.CL**

- **简介: 该论文属于表格问答任务，旨在解决现有基准在复杂、多语言和多结构表格理解上的不足。作者构建了新基准TableEval，包含多领域、多语言的真实表格数据，并提出新评估框架SEAT以提高评估准确性，揭示当前模型在处理实际表格问答任务中的不足。**

- **链接: [http://arxiv.org/pdf/2506.03949v1](http://arxiv.org/pdf/2506.03949v1)**
...
>
---
#### [new 105] Robustness of Prompting: Enhancing Robustness of Large Language Models Against Prompting Attacks
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型对输入扰动敏感的问题。作者提出RoP方法，通过错误修正和引导两个阶段提升模型鲁棒性，有效应对拼写错误等干扰，同时保持较高准确性。**

- **链接: [http://arxiv.org/pdf/2506.03627v1](http://arxiv.org/pdf/2506.03627v1)**
...
>
---
#### [new 106] Kinship in Speech: Leveraging Linguistic Relatedness for Zero-Shot TTS in Indian Languages
...
>
---
#### [new 113] mRAG: Elucidating the Design Space of Multi-modal Retrieval-Augmented Generation
...
>
---
#### [new 114] AmbiK: Dataset of Ambiguous Tasks in Kitchen Environment
...
>
---
#### [new 115] CETBench: A Novel Dataset constructed via Transformations over Programs for Benchmarking LLMs for Code-Equivalence Checking
- **分类: cs.SE; cs.CL; cs.LG; cs.PL; 68-02 (Primary) 68T50, 68T07, 68N19, 68N30 (Secondary); I.2.7; I.2.6; I.2.5; D.3.0; D.3.3; D.3.1; F.3.2; F.3.1; F.3.3;
  D.2.3; D.2.5**

- **简介: 该论文属于代码等价性检查任务，旨在评估大语言模型（LLMs）判断两段程序是否功能等价的能力。作者构建了CETBench数据集，通过预定义的代码变换生成等价或非等价程序对，发现简单变换即可显著降低LLMs性能，并提出微调方法提升效果，揭示了LLMs在代码语义理解方面仍存在不足。**

- **链接: [http://arxiv.org/pdf/2506.04019v1](http://arxiv.org/pdf/2506.04019v1)**

> **作者:** Neeva Oza; Ishaan Govil; Parul Gupta; Dinesh Khandelwal; Dinesh Garg; Parag Singla
>
> **摘要:** LLMs have been extensively used for the task of automated code generation. In this work, we examine the applicability of LLMs for the related but relatively unexplored task of code-equivalence checking, i.e., given two programs, whether they are functionally equivalent or not. This is an important problem since benchmarking code equivalence can play a critical role in evaluating LLM capabilities for tasks such as code re-writing and code translation. Towards this end, we present CETBench - Code Equivalence with Transformations Benchmark, constructed via a repository of programs, where two programs in the repository may be solving the same or different tasks. Each instance in our dataset is obtained by taking a pair of programs in the repository and applying a random series of pre-defined code transformations, resulting in (non-)equivalent pairs. Our analysis on this dataset reveals a surprising finding that very simple code transformations in the underlying pair of programs can result in a significant drop in performance of SOTA LLMs for the task of code-equivalence checking. To remedy this, we present a simple fine-tuning-based approach to boost LLM performance on the transformed pairs of programs. Our approach for dataset generation is generic, and can be used with repositories with varying program difficulty levels and allows for applying varying numbers as well as kinds of transformations. In our experiments, we perform ablations over the difficulty level of original programs, as well as the kind of transformations used in generating pairs for equivalence checking. Our analysis presents deep insights into the working of LLMs for the task of code-equivalence, and points to the fact that they may still be far from what could be termed as a semantic understanding of the underlying code.
>
---
#### [new 116] Prompt Candidates, then Distill: A Teacher-Student Framework for LLM-driven Data Annotation
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于数据标注任务，旨在解决大模型标注结果不可靠的问题。通过提出候选标注范式和教师-学生框架 CanDist，让大模型输出多个可能标签，并由小模型蒸馏出最终标签，提升标注质量与理论保证。**

- **链接: [http://arxiv.org/pdf/2506.03857v1](http://arxiv.org/pdf/2506.03857v1)**

> **作者:** Mingxuan Xia; Haobo Wang; Yixuan Li; Zewei Yu; Jindong Wang; Junbo Zhao; Runze Wu
>
> **备注:** Accepted to ACL 2025 (Main conference)
>
> **摘要:** Recently, Large Language Models (LLMs) have demonstrated significant potential for data annotation, markedly reducing the labor costs associated with downstream applications. However, existing methods mostly adopt an aggressive strategy by prompting LLM to determine a single gold label for each unlabeled sample. Due to the inherent uncertainty within LLMs, they often produce incorrect labels for difficult samples, severely compromising the data quality for downstream applications. Motivated by ambiguity aversion in human behaviors, we propose a novel candidate annotation paradigm wherein large language models are encouraged to output all possible labels when incurring uncertainty. To ensure unique labels are provided for downstream tasks, we develop a teacher-student framework CanDist that distills candidate annotations with a Small Language Model (SLM). We further provide a rigorous justification demonstrating that distilling candidate annotations from the teacher LLM offers superior theoretical guarantees compared to directly using single annotations. Extensive experiments across six text classification tasks validate the effectiveness of our proposed method. The source code is available at https://github.com/MingxuanXia/CanDist.
>
---
#### [new 117] ProRank: Prompt Warmup via Reinforcement Learning for Small Language Models Reranking
- **分类: cs.IR; cs.CL**

- **简介: 论文提出ProRank，通过强化学习和两阶段训练提升小型语言模型（SLM）在文档重排序任务中的表现。该方法解决了SLM在理解任务提示上的不足，实现了比大型语言模型更优的重排序效果，同时保持计算效率。**

- **链接: [http://arxiv.org/pdf/2506.03487v1](http://arxiv.org/pdf/2506.03487v1)**
...
>
---
#### [new 118] MMR-V: What's Left Unsaid? A Benchmark for Multimodal Deep Reasoning in Videos
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 119] Video-Skill-CoT: Skill-based Chain-of-Thoughts for Domain-Adaptive Video Reasoning
...
>
---
#### [new 120] BiMa: Towards Biases Mitigation for Text-Video Retrieval via Scene Element Guidance
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 121] Advancing Multimodal Reasoning: From Optimized Cold Start to Staged Reinforcement Learning
...
>
---
#### [new 122] VLMs Can Aggregate Scattered Training Patches
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 123] Does Thinking More always Help? Understanding Test-Time Scaling in Reasoning Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决推理模型在测试时通过延长思考时间提升性能的有效性问题。作者发现“过度思考”会降低精度，并提出并行思考方法，通过生成多条独立推理路径并投票选择结果，显著提升了准确率。**

- **链接: [http://arxiv.org/pdf/2506.04210v1](http://arxiv.org/pdf/2506.04210v1)**
...
>
---
#### [new 124] AgentMisalignment: Measuring the Propensity for Misaligned Behaviour in LLM-Based Agents
- **分类: cs.AI; cs.CL; cs.CY; cs.LG; I.2.7; I.2.11; K.4.1; I.2.6**

- **简介: 该论文属于人工智能安全任务，旨在解决大语言模型代理的对齐问题。作者构建了一个名为AgentMisalignment的基准测试，评估代理在现实场景中表现出目标守护、抗拒关闭、能力隐藏和权力追求等行为的倾向，并发现模型能力和系统提示显著影响对齐程度。**

- **链接: [http://arxiv.org/pdf/2506.04018v1](http://arxiv.org/pdf/2506.04018v1)**
...
>
---
#### [new 125] Mitigating Hallucinations in Large Vision-Language Models via Entity-Centric Multimodal Preference Optimization
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 130] Multimodal Tabular Reasoning with Privileged Structured Information
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [new 131] Tone recognition in low-resource languages of North-East India: peeling the layers of SSL-based speech models
...
#### [replaced 001] Critique-GRPO: Advancing LLM Reasoning with Natural Language and Numerical Feedback
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.03106v2](http://arxiv.org/pdf/2506.03106v2)**
...
>
---
#### [replaced 002] Comparative Analysis of AI Agent Architectures for Entity Relationship Classification
- **分类: cs.CL; cs.AI; I.2.7; I.2.1**

- **链接: [http://arxiv.org/pdf/2506.02426v2](http://arxiv.org/pdf/2506.02426v2)**
...
>
---
#### [replaced 007] A Survey on (M)LLM-Based GUI Agents
...
>
---
#### [replaced 008] Sleepless Nights, Sugary Days: Creating Synthetic Users with Health Conditions for Realistic Coaching Agent Interactions
- **分类: cs.LG; cs.AI; cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2502.13135v2](http://arxiv.org/pdf/2502.13135v2)**
...
>
---
#### [replaced 009] Large Language Models Struggle to Describe the Haystack without Human Help: Human-in-the-loop Evaluation of Topic Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.14748v2](http://arxiv.org/pdf/2502.14748v2)**
...
>
---
#### [replaced 011] CoRe-MMRAG: Cross-Source Knowledge Reconciliation for Multimodal RAG
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.02544v2](http://arxiv.org/pdf/2506.02544v2)**
...
>
---
#### [replaced 012] Probing LLMs for Multilingual Discourse Generalization Through a Unified Label Set
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.10515v2](http://arxiv.org/pdf/2503.10515v2)**
...
>
> **摘要:** Discourse understanding is essential for many NLP tasks, yet most existing work remains constrained by framework-dependent discourse representations. This work investigates whether large language models (LLMs) capture discourse knowledge that generalizes across languages and frameworks. We address this question along two dimensions: (1) developing a unified discourse relation label set to facilitate cross-lingual and cross-framework discourse analysis, and (2) probing LLMs to assess whether they encode generalizable discourse abstractions. Using multilingual discourse relation classification as a testbed, we examine a comprehensive set of 23 LLMs of varying sizes and multilingual capabilities. Our results show that LLMs, especially those with multilingual training corpora, can generalize discourse information across languages and frameworks. Further layer-wise analyses reveal that language generalization at the discourse level is most salient in the intermediate layers. Lastly, our error analysis provides an account of challenging relation classes.
>
---
#### [replaced 013] The Arabic AI Fingerprint: Stylometric Analysis and Detection of Large Language Models Text
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.23276v2](http://arxiv.org/pdf/2505.23276v2)**
...
>
---
#### [replaced 016] On the Acquisition of Shared Grammatical Representations in Bilingual Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.03962v2](http://arxiv.org/pdf/2503.03962v2)**

> **作者:** Catherine Arnett; Tyler A. Chang; James A. Michaelov; Benjamin K. Bergen
>
> **备注:** 9 pages, 5 figures. Accepted at ACL 2025
>
> **摘要:** Crosslingual transfer is crucial to contemporary language models' multilingual capabilities, but how it occurs is not well understood. We ask what happens to a monolingual language model when it begins to be trained on a second language. Specifically, we train small bilingual models for which we control the amount of data for each language and the order of language exposure. To find evidence of shared multilingual representations, we turn to structural priming, a method used to study grammatical representations in humans. We first replicate previous crosslingual structural priming results and find that after controlling for training data quantity and language exposure, there are asymmetrical effects across language pairs and directions. We argue that this asymmetry may shape hypotheses about human structural priming effects. We also find that structural priming effects are less robust for less similar language pairs, highlighting potential limitations of crosslingual transfer learning and shared representations for typologically diverse languages.
>
---
#### [replaced 017] On-Policy RL with Optimal Reward Baseline
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23585v2](http://arxiv.org/pdf/2505.23585v2)**
...
>
---
#### [replaced 018] Social Genome: Grounded Social Reasoning Abilities of Multimodal Models
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.15109v4](http://arxiv.org/pdf/2502.15109v4)**
...
>
---
#### [replaced 021] DynaSaur: Large Language Agents Beyond Predefined Actions
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2411.01747v2](http://arxiv.org/pdf/2411.01747v2)**
...
>
---
#### [replaced 022] Meta-rater: A Multi-dimensional Data Selection Method for Pre-training Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.14194v3](http://arxiv.org/pdf/2504.14194v3)**
...
>
---
#### [replaced 023] Sliding Window Attention Training for Efficient Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.18845v2](http://arxiv.org/pdf/2502.18845v2)**
...
>
---
#### [replaced 024] UIO-LLMs: Unbiased Incremental Optimization for Long-Context LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2406.18173v2](http://arxiv.org/pdf/2406.18173v2)**

> **作者:** Wenhao Li; Mingbao Lin; Yunshan Zhong; Shuicheng Yan; Rongrong Ji
>
> **备注:** The experimental results of the paper require further validation
>
...
>
---
#### [replaced 028] WizardMath: Empowering Mathematical Reasoning for Large Language Models via Reinforced Evol-Instruct
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2308.09583v3](http://arxiv.org/pdf/2308.09583v3)**
...
>
> **备注:** This paper has been accepted to ICLR 2025 as an Oral presentation
>
> **摘要:** Large language models (LLMs), such as GPT-4, have shown remarkable performance in natural language processing (NLP) tasks, including challenging mathematical reasoning. However, most existing open-source models are only pre-trained on large-scale internet data and without math-related optimization. In this paper, we present WizardMath, which enhances the mathematical CoT reasoning abilities of LLMs without using external python tools, by applying our proposed Reinforcement Learning from Evol-Instruct Feedback (RLEIF) method to the domain of math. Through extensive experiments on two mathematical reasoning benchmarks, namely GSM8k and MATH, we reveal the extraordinary capabilities of our model. Remarkably, WizardMath-Mistral 7B surpasses top-tier open-source LLMs by a substantial margin with higher data efficiency. Furthermore, WizardMath 70B even outperforms GPT-3.5-Turbo, Claude 2, Gemini Pro and GPT-4-early-version. Additionally, our preliminary exploration highlights the pivotal role of instruction evolution and process supervision in achieving exceptional math performance. For more details refer to https://github.com/nlpxucan/WizardLM
>
---
#### [replaced 029] DOVE: A Large-Scale Multi-Dimensional Predictions Dataset Towards Meaningful LLM Evaluation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.01622v3](http://arxiv.org/pdf/2503.01622v3)**
...
>
---
#### [replaced 033] From Intention To Implementation: Automating Biomedical Research via LLMs
- **分类: cs.MA; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2412.09429v3](http://arxiv.org/pdf/2412.09429v3)**

> **作者:** Yi Luo; Linghang Shi; Yihao Li; Aobo Zhuang; Yeyun Gong; Ling Liu; Chen Lin
>
> **备注:** The paper involves material for which we have not yet obtained proper copyright permissions
>
...
>
---
#### [replaced 037] THELMA: Task Based Holistic Evaluation of Large Language Model Applications-RAG Question Answering
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.11626v2](http://arxiv.org/pdf/2505.11626v2)**

> **作者:** Udita Patel; Rutu Mulkar; Jay Roberts; Cibi Chakravarthy Senthilkumar; Sujay Gandhi; Xiaofei Zheng; Naumaan Nayyar; Parul Kalra; Rafael Castrillo
>
> **备注:** Added author
>
...
>
---
#### [replaced 038] UBench: Benchmarking Uncertainty in Large Language Models with Multiple Choice Questions
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2406.12784v2](http://arxiv.org/pdf/2406.12784v2)**
...
>
---
#### [replaced 041] Scaling Laws for Floating Point Quantization Training
- **分类: cs.LG; cs.AR; cs.CL**

- **链接: [http://arxiv.org/pdf/2501.02423v3](http://arxiv.org/pdf/2501.02423v3)**
...
>
---
#### [replaced 042] Large Language Models are Locally Linear Mappings
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.24293v2](http://arxiv.org/pdf/2505.24293v2)**

> **作者:** James R. Golden
>
> **备注:** minor updates to Fig 2; code available at https://github.com/jamesgolden1/llms-are-llms
>
...
>
---
#### [replaced 045] PAST: Phonetic-Acoustic Speech Tokenizer
...
>
---
#### [replaced 046] LLMs Think, But Not In Your Flow: Reasoning-Level Personalization for Black-Box Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.21082v3](http://arxiv.org/pdf/2505.21082v3)**
...
>
---
#### [replaced 047] STEER-BENCH: A Benchmark for Evaluating the Steerability of Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.20645v2](http://arxiv.org/pdf/2505.20645v2)**
...
>
---
#### [replaced 048] Identifying Aspects in Peer Reviews
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.06910v2](http://arxiv.org/pdf/2504.06910v2)**
...
>
---
#### [replaced 049] AlignMMBench: Evaluating Chinese Multimodal Alignment in Large Vision-Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 050] CARE: Assessing the Impact of Multilingual Human Preference Learning on Cultural Awareness
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.05154v3](http://arxiv.org/pdf/2504.05154v3)**
...
>
---
#### [replaced 051] Refining Sentence Embedding Model through Ranking Sentences Generation with Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.13656v2](http://arxiv.org/pdf/2502.13656v2)**

> **作者:** Liyang He; Chenglong Liu; Rui Li; Zhenya Huang; Shulan Ruan; Jun Zhou; Enhong Chen
>
> **摘要:** Sentence embedding is essential for many NLP tasks, with contrastive learning methods achieving strong performance using annotated datasets like NLI. Yet, the reliance on manual labels limits scalability. Recent studies leverage large language models (LLMs) to generate sentence pairs, reducing annotation dependency. However, they overlook ranking information crucial for fine-grained semantic distinctions. To tackle this challenge, we propose a method for controlling the generation direction of LLMs in the latent space. Unlike unconstrained generation, the controlled approach ensures meaningful semantic divergence. Then, we refine exist sentence embedding model by integrating ranking information and semantic information. Experiments on multiple benchmarks demonstrate that our method achieves new SOTA performance with a modest cost in ranking sentence synthesis.
>
---
#### [replaced 052] Trans-EnV: A Framework for Evaluating the Linguistic Robustness of LLMs Against English Varieties
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.20875v2](http://arxiv.org/pdf/2505.20875v2)**
...
>
---
#### [replaced 053] Demystifying Reasoning Dynamics with Mutual Information: Thinking Tokens are Information Peaks in LLM Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02867v2](http://arxiv.org/pdf/2506.02867v2)**
...
>
---
#### [replaced 054] MAmmoTH-VL: Eliciting Multimodal Reasoning with Instruction Tuning at Scale
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 055] Dynamic Benchmarking of Reasoning Capabilities in Code Large Language Models Under Data Contamination
- **分类: cs.SE; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.04149v2](http://arxiv.org/pdf/2503.04149v2)**
...
>
---
#### [replaced 060] What LLMs Miss in Recommendations: Bridging the Gap with Retrieval-Augmented Collaborative Signals
- **分类: cs.IR; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.20730v2](http://arxiv.org/pdf/2505.20730v2)**
...
>
---
#### [replaced 061] ReFoRCE: A Text-to-SQL Agent with Self-Refinement, Consensus Enforcement, and Column Exploration
- **分类: cs.CL; I.2.7; I.2.0; H.2.0**

- **链接: [http://arxiv.org/pdf/2502.00675v5](http://arxiv.org/pdf/2502.00675v5)**
...
>
---
#### [replaced 062] Should LLM Safety Be More Than Refusing Harmful Instructions?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02442v2](http://arxiv.org/pdf/2506.02442v2)**
...
>
---
#### [replaced 063] Bench4KE: Benchmarking Automated Competency Question Generation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24554v2](http://arxiv.org/pdf/2505.24554v2)**
...
>
---
#### [replaced 066] PFDial: A Structured Dialogue Instruction Fine-tuning Method Based on UML Flowcharts
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.06706v2](http://arxiv.org/pdf/2503.06706v2)**
...
>
---
#### [replaced 067] Tug-of-war between idiom's figurative and literal meanings in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.01723v2](http://arxiv.org/pdf/2506.01723v2)**
...
>
---
#### [replaced 068] Assistant-Guided Mitigation of Teacher Preference Bias in LLM-as-a-Judge
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.19176v2](http://arxiv.org/pdf/2505.19176v2)**
...
>
---
#### [replaced 069] SCORE: Story Coherence and Retrieval Enhancement for AI Narratives
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.23512v3](http://arxiv.org/pdf/2503.23512v3)**

> **作者:** Qiang Yi; Yangfan He; Jianhui Wang; Xinyuan Song; Shiyao Qian; Xinhang Yuan; Li Sun; Yi Xin; Keqin Li; Kuan Lu; Menghao Huo; Jiaqi Chen; Tianyu Shi
>
...
>
---
#### [replaced 070] Soft Reasoning: Navigating Solution Spaces in Large Language Models through Controlled Embedding Exploration
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.24688v2](http://arxiv.org/pdf/2505.24688v2)**
...
>
---
#### [replaced 073] On the class of coding optimality of human languages and the origins of Zipf's law
- **分类: cs.CL; physics.soc-ph**

- **链接: [http://arxiv.org/pdf/2505.20015v3](http://arxiv.org/pdf/2505.20015v3)**
...
>
---
#### [replaced 074] An Expanded Massive Multilingual Dataset for High-Performance Language Technologies (HPLT)
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.10267v3](http://arxiv.org/pdf/2503.10267v3)**
...
>
> **备注:** ACL'2025 Main Proceedings
>
> **摘要:** Training state-of-the-art large language models requires vast amounts of clean and diverse textual data. However, building suitable multilingual datasets remains a challenge. In this work, we present HPLT v2, a collection of high-quality multilingual monolingual and parallel corpora, extending prior work of the HPLT project. The monolingual portion of the data contains 8T tokens covering 193 languages, while the parallel data contains 380M sentence pairs covering 51 languages. We document the entire data pipeline and release the code to reproduce it. We provide extensive analysis of the quality and characteristics of our data. Finally, we evaluate the performance of language models and machine translation systems trained on HPLT v2, demonstrating its value.
>
---
#### [replaced 075] MASTER: Enhancing Large Language Model via Multi-Agent Simulated Teaching
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02689v2](http://arxiv.org/pdf/2506.02689v2)**
...
>
---
#### [replaced 078] MMedPO: Aligning Medical Vision-Language Models with Clinical-Aware Multimodal Preference Optimization
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 079] Revisiting Uncertainty Quantification Evaluation in Language Models: Spurious Interactions with Response Length Bias Results
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.13677v2](http://arxiv.org/pdf/2504.13677v2)**
...
>
---
#### [replaced 081] Beyond the Safety Bundle: Auditing the Helpful and Harmless Dataset
- **分类: cs.CL; cs.CY**

- **链接: [http://arxiv.org/pdf/2411.08243v3](http://arxiv.org/pdf/2411.08243v3)**
...
>
---
#### [replaced 082] Concept-Guided Chain-of-Thought Prompting for Pairwise Comparison Scoring of Texts with Large Language Models
- **分类: cs.CL; cs.CY**

- **链接: [http://arxiv.org/pdf/2310.12049v3](http://arxiv.org/pdf/2310.12049v3)**
...
>
---
#### [replaced 085] InSerter: Speech Instruction Following with Unsupervised Interleaved Pre-training
...
>
---
#### [replaced 090] SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.19641v4](http://arxiv.org/pdf/2505.19641v4)**
...
>
---
#### [replaced 091] RULEBREAKERS: Challenging LLMs at the Crossroads between Formal Logic and Human-like Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.16502v3](http://arxiv.org/pdf/2410.16502v3)**
...
>
---
#### [replaced 092] Full-Duplex-Bench: A Benchmark to Evaluate Full-duplex Spoken Dialogue Models on Turn-taking Capabilities
- **分类: cs.CL; eess.AS**

- **链接: [http://arxiv.org/pdf/2503.04721v2](http://arxiv.org/pdf/2503.04721v2)**
...
>
---
#### [replaced 093] Enhancing LLM-Based Short Answer Grading with Retrieval-Augmented Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.05276v2](http://arxiv.org/pdf/2504.05276v2)**
...
>
---
#### [replaced 095] A Survey of Event Causality Identification: Taxonomy, Challenges, Assessment, and Prospects
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2411.10371v3](http://arxiv.org/pdf/2411.10371v3)**
...
>
---
#### [replaced 096] REAL: Response Embedding-based Alignment for LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2409.17169v4](http://arxiv.org/pdf/2409.17169v4)**
...
>
---
#### [replaced 099] CheckEmbed: Effective Verification of LLM Solutions to Open-Ended Tasks
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2406.02524v3](http://arxiv.org/pdf/2406.02524v3)**
...
>
---
#### [replaced 100] Geometric Signatures of Compositionality Across a Language Model's Lifetime
- **分类: cs.CL; cs.AI; cs.IT; cs.LG; math.IT**

- **链接: [http://arxiv.org/pdf/2410.01444v4](http://arxiv.org/pdf/2410.01444v4)**
