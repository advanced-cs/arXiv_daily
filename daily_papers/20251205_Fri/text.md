...
#### [new 001] DaLA: Danish Linguistic Acceptability Evaluation Guided by Real World Errors
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的语言可接受性判断任务，旨在解决现有丹麦语评估基准覆盖错误类型有限的问题。作者分析真实书写错误，构建14种污染函数生成错误句，建立更全面的评测基准DaLA，提升对大语言模型的区分能力。**

- **链接: [https://arxiv.org/pdf/2512.04799v1](https://arxiv.org/pdf/2512.04799v1)**
...
>
---
#### [new 002] On GRPO Collapse in Search-R1: The Lazy Likelihood-Displacement Death Spiral
- **分类: cs.CL**

- **简介: 该论文研究工具集成强化学习中的GRPO训练崩溃问题，提出懒惰似然位移（LLD）是主因，并设计细粒度正则化方法LLDS抑制LLD，稳定训练，显著提升多步问答性能。**

- **链接: [https://arxiv.org/pdf/2512.04220v1](https://arxiv.org/pdf/2512.04220v1)**
...
>
---
#### [new 006] ClusterFusion: Hybrid Clustering with Embedding Guidance and LLM Adaptation
- **分类: cs.CL**

- **简介: 该论文研究文本聚类任务，旨在解决传统方法在领域适配上的局限性。提出ClusterFusion框架，以大语言模型为核心，结合轻量级嵌入方法进行子集划分、主题归纳与分配，提升聚类效果，尤其在专业领域表现突出，并开源数据与结果。**

- **链接: [https://arxiv.org/pdf/2512.04350v1](https://arxiv.org/pdf/2512.04350v1)**
...
>
> **摘要:** The evolution of Large Language Models (LLMs) from passive responders to autonomous agents necessitates a fundamental shift in learning paradigms -- from static imitation to incentive-driven decision making. However, this transition is significantly impeded by the lack of scalable infrastructure capable of constructing high-quality interaction signals for effective policy learning. To address this, we introduce a comprehensive method designed to systematically scale the diversity and complexity of interactive environments. Our method realizes this scaling by addressing three orthogonal dimensions: (1) Complexity: NexAU, a flexible agent framework that supports building complex agent hierarchies via simple configurations; (2) Diversity: NexA4A automatically generates diverse agent hierarchies from natural language to cover infinite domains; and (3) Fidelity: NexGAP bridges the simulation-reality gap by integrating dynamic real-world environment for grounded trajectories synthesis. We train Nex-N1 upon the diverse and complex interactive environments established by our infrastructure. Empirical results on benchmarks such as SWE-bench and tau2 demonstrate that Nex-N1 consistently outperforms SOTA open-source models and achieves competitive performance against frontier proprietary models on complex agentic tasks. We open-source the Nex ecosystem and model weights to facilitate further research.
>
---
#### [new 011] Structured Document Translation via Format Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究结构化文档翻译任务，旨在解决现有方法难以处理文档级XML/HTML结构的问题。提出格式强化学习（FormatRL），通过结构感知奖励函数优化翻译的结构与质量，提升整体性能。**

- **链接: [https://arxiv.org/pdf/2512.05100v1](https://arxiv.org/pdf/2512.05100v1)**
...
>
---
#### [new 012] Geschlechtsübergreifende Maskulina im Sprachgebrauch Eine korpusbasierte Untersuchung zu lexemspezifischen Unterschieden
- **分类: cs.CL**

- **简介: 该论文属语言学任务，旨在探究德语中通性阳性名词（GM）在真实语篇中的使用差异。通过标注6,195个词符，分析其分布特征，发现不同名词类型间存在显著差异，且GM多用于复数和不定指短语，挑战了其泛指人群的传统假设。**

- **链接: [https://arxiv.org/pdf/2512.04683v1](https://arxiv.org/pdf/2512.04683v1)**
...
>
---
#### [new 013] Computational Linguistics Meets Libyan Dialect: A Study on Dialect Identification
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究阿拉伯语利比亚方言识别任务，旨在解决社交媒体中非标准拼写和方言混杂带来的分类难题。作者基于QADI语料库，采用多种分类模型与n-gram特征组合，通过卡方分析筛选有效特征，实验表明多项式朴素贝叶斯效果最优。**

- **链接: [https://arxiv.org/pdf/2512.04257v1](https://arxiv.org/pdf/2512.04257v1)**
...
>
---
#### [new 019] Factuality and Transparency Are All RAG Needs! Self-Explaining Contrastive Evidence Re-ranking
- **分类: cs.CL**

- **简介: 该论文属于信息检索任务，旨在提升RAG系统中证据检索的准确性和透明度。提出自解释对比证据重排序（CER）方法，通过对比学习优化嵌入，生成细粒度归因理由，并利用主客观性标准筛选难负样本，增强事实性与可解释性。**

- **链接: [https://arxiv.org/pdf/2512.05012v1](https://arxiv.org/pdf/2512.05012v1)**
...
>
---
#### [new 020] UW-BioNLP at ChemoTimelines 2025: Thinking, Fine-Tuning, and Dictionary-Enhanced LLM Systems for Chemotherapy Timeline Extraction
- **分类: cs.CL; cs.AI**

- **简介: 该论文参与ChemoTimelines 2025任务，旨在从临床文本中提取化疗时间线。针对亚任务2，提出两步流程：先用大模型提取单条记录中的化疗事件，再归一化聚合为患者级时间线。尝试了思维链、微调、偏好优化和词典增强等方法，其中微调Qwen3-14B效果最佳。**

- **链接: [https://arxiv.org/pdf/2512.04518v1](https://arxiv.org/pdf/2512.04518v1)**
...
>
> **摘要:** The ChemoTimelines shared task benchmarks methods for constructing timelines of systemic anticancer treatment from electronic health records of cancer patients. This paper describes our methods, results, and findings for subtask 2 -- generating patient chemotherapy timelines from raw clinical notes. We evaluated strategies involving chain-of-thought thinking, supervised fine-tuning, direct preference optimization, and dictionary-based lookup to improve timeline extraction. All of our approaches followed a two-step workflow, wherein an LLM first extracted chemotherapy events from individual clinical notes, and then an algorithm normalized and aggregated events into patient-level timelines. Each specific method differed in how the associated LLM was utilized and trained. Multiple approaches yielded competitive performances on the test set leaderboard, with fine-tuned Qwen3-14B achieving the best official score of 0.678. Our results and analyses could provide useful insights for future attempts on this task as well as the design of similar tasks.
>
---
#### [new 021] EtCon: Edit-then-Consolidate for Reliable Knowledge Editing
- **分类: cs.CL**

- **简介: 该论文属于知识编辑任务，旨在解决大模型编辑后过拟合与知识整合不足的问题。提出“先编辑后巩固”框架：通过TPSFT限制参数偏移，再用GRPO优化推理行为，提升编辑可靠性与泛化性。**

- **链接: [https://arxiv.org/pdf/2512.04753v1](https://arxiv.org/pdf/2512.04753v1)**
...
>
---
#### [new 025] Semantic Soft Bootstrapping: Long Context Reasoning in LLMs without Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.IT; cs.LG; eess.SP**

- **简介: 该论文聚焦大语言模型的长上下文推理任务，旨在解决强化学习训练中的奖励稀疏与样本效率低问题。提出语义软自举（SSB）方法，通过自蒸馏机制利用模型自身生成正确与错误答案的语义反馈，实现无需人工干预的高效训练，显著提升数学推理准确率。**

- **链接: [https://arxiv.org/pdf/2512.05105v1](https://arxiv.org/pdf/2512.05105v1)**
...
>
---
#### [new 026] LexGenius: An Expert-Level Benchmark for Large Language Models in Legal General Intelligence
- **分类: cs.CL**

- **简介: 该论文提出LexGenius，旨在评估大语言模型在法律通用智能（GI）方面的能力。针对现有基准缺乏系统性评估的问题，构建了覆盖七维度、十一任务、二十能力的中文法律评测体系，并评估12种主流LLM，推动法律GI发展。**

- **链接: [https://arxiv.org/pdf/2512.04578v1](https://arxiv.org/pdf/2512.04578v1)**
...
>
> **摘要:** The rapid progress of Large Language Models (LLMs) has transformed natural language processing and broadened its impact across research and society. Yet, systematic evaluation of these models, especially for languages beyond English, remains limited. "Challenging the Abilities of LAnguage Models in ITAlian" (CALAMITA) is a large-scale collaborative benchmarking initiative for Italian, coordinated under the Italian Association for Computational Linguistics. Unlike existing efforts that focus on leaderboards, CALAMITA foregrounds methodology: it federates more than 80 contributors from academia, industry, and the public sector to design, document, and evaluate a diverse collection of tasks, covering linguistic competence, commonsense reasoning, factual consistency, fairness, summarization, translation, and code generation. Through this process, we not only assembled a benchmark of over 20 tasks and almost 100 subtasks, but also established a centralized evaluation pipeline that supports heterogeneous datasets and metrics. We report results for four open-weight LLMs, highlighting systematic strengths and weaknesses across abilities, as well as challenges in task-specific evaluation. Beyond quantitative results, CALAMITA exposes methodological lessons: the necessity of fine-grained, task-representative metrics, the importance of harmonized pipelines, and the benefits and limitations of broad community engagement. CALAMITA is conceived as a rolling benchmark, enabling continuous integration of new tasks and models. This makes it both a resource -- the most comprehensive and diverse benchmark for Italian to date -- and a framework for sustainable, community-driven evaluation. We argue that this combination offers a blueprint for other languages and communities seeking inclusive and rigorous LLM evaluation practices.
>
---
#### [new 029] SEAL: Self-Evolving Agentic Learning for Conversational Question Answering over Knowledge Graphs
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究知识图谱上的对话式问答（KBCQA），旨在解决指代消解、上下文建模和复杂推理难题。提出SEAL框架，通过两阶段语义解析与自演化代理学习，提升逻辑形式的准确性和推理效率，并实现无需重训练的持续优化。**

- **链接: [https://arxiv.org/pdf/2512.04868v1](https://arxiv.org/pdf/2512.04868v1)**
...
>
---
#### [new 030] Sarcasm Detection on Reddit Using Classical Machine Learning and Feature Engineering
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究基于经典机器学习的讽刺检测任务，旨在不依赖神经网络和上下文的情况下识别Reddit评论中的讽刺。作者使用SARC 2.0数据集，结合TF-IDF和风格特征，评估四种模型，其中朴素贝叶斯和逻辑回归表现最佳。**

- **链接: [https://arxiv.org/pdf/2512.04396v1](https://arxiv.org/pdf/2512.04396v1)**
...
>
> **摘要:** Large Language Models (LLMs) are increasingly used in healthcare, yet ensuring their safety and trustworthiness remains a barrier to deployment. Conversational medical assistants must avoid unsafe compliance without over-refusing benign queries. We present an iterative post-deployment alignment framework that applies Kahneman-Tversky Optimization (KTO) and Direct Preference Optimization (DPO) to refine models against domain-specific safety signals. Using the CARES-18K benchmark for adversarial robustness, we evaluate four LLMs (Llama-3B/8B, Meditron-8B, Mistral-7B) across multiple cycles. Our results show up to 42% improvement in safety-related metrics for harmful query detection, alongside interesting trade-offs against erroneous refusals, thereby exposing architecture-dependent calibration biases. We also perform ablation studies to identify when self-evaluation is reliable and when external or finetuned judges are necessary to maximize performance gains. Our findings underscore the importance of adopting best practices that balance patient safety, user trust, and clinical utility in the design of conversational medical assistants.
>
---
#### [new 036] SEASON: Mitigating Temporal Hallucination in Video Large Language Models via Self-Diagnostic Contrastive Decoding
...
>
---
#### [new 037] Are LLMs Truly Multilingual? Exploring Zero-Shot Multilingual Capability of LLMs for Information Retrieval: An Italian Healthcare Use Case
- **分类: cs.AI; cs.CL; cs.IR**

- **简介: 该论文研究开源多语言大模型在意大利语电子健康记录中的零样本信息抽取能力，聚焦共病提取任务。通过实验发现，现有LLM在本地部署下表现不一，难以泛化，相较传统模式匹配与人工标注仍有不足。**

- **链接: [https://arxiv.org/pdf/2512.04834v1](https://arxiv.org/pdf/2512.04834v1)**

> **作者:** Vignesh Kumar Kembu; Pierandrea Morandini; Marta Bianca Maria Ranzini; Antonino Nocera
>
> **摘要:** Large Language Models (LLMs) have become a key topic in AI and NLP, transforming sectors like healthcare, finance, education, and marketing by improving customer service, automating tasks, providing insights, improving diagnostics, and personalizing learning experiences. Information extraction from clinical records is a crucial task in digital healthcare. Although traditional NLP techniques have been used for this in the past, they often fall short due to the complexity, variability of clinical language, and high inner semantics in the free clinical text. Recently, Large Language Models (LLMs) have become a powerful tool for better understanding and generating human-like text, making them highly effective in this area. In this paper, we explore the ability of open-source multilingual LLMs to understand EHRs (Electronic Health Records) in Italian and help extract information from them in real-time. Our detailed experimental campaign on comorbidity extraction from EHR reveals that some LLMs struggle in zero-shot, on-premises settings, and others show significant variation in performance, struggling to generalize across various diseases when compared to native pattern matching and manual annotations.
>
---
#### [new 038] STELLA: Guiding Large Language Models for Time Series Forecasting with Semantic Abstractions
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文针对时间序列预测中大语言模型信息利用不足的问题，提出STELLA框架。通过动态语义抽象生成趋势、季节性等分量的层次化语义锚点，结合全局与实例上下文，指导大模型建模时序动态，在多数据集上实现更优预测。**

- **链接: [https://arxiv.org/pdf/2512.04871v1](https://arxiv.org/pdf/2512.04871v1)**
...
>
---
#### [new 039] Natural Language Actor-Critic: Scalable Off-Policy Learning in Language Space
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究大语言模型（LLM）代理在长程稀疏奖励任务中的训练问题，提出自然语言Actor-Critic（NLAC）算法。其用生成式LLM作为批评家，输出自然语言反馈而非标量奖励，提供更丰富、可操作的改进信号，实现高效、稳定的离策略学习，提升LLM代理在复杂任务中的性能。**

- **链接: [https://arxiv.org/pdf/2512.04601v1](https://arxiv.org/pdf/2512.04601v1)**
...
>
---
#### [new 043] Text-Only Training for Image Captioning with Retrieval Augmentation and Modality Gap Correction
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 044] Towards Contextual Sensitive Data Detection
- **分类: cs.CR; cs.AI; cs.CL; cs.CY; cs.DB; cs.IR**

- **简介: 该论文属数据安全任务，旨在解决敏感数据检测中忽视上下文的问题。提出类型与领域两种上下文感知机制，结合大语言模型提升检测准确率与适用性，尤其适用于人道主义等非标准数据域。**

- **链接: [https://arxiv.org/pdf/2512.04120v1](https://arxiv.org/pdf/2512.04120v1)**
...
>
---
#### [new 045] DraCo: Draft as CoT for Text-to-Image Preview and Rare Concept Generation
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [new 046] CARL: Critical Action Focused Reinforcement Learning for Multi-Step Agent
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究多步交互智能体任务，针对传统策略优化忽视动作重要性差异的问题，提出CARL算法。通过识别关键动作并聚焦其优化，忽略低重要性动作的更新，提升训练与推理效率及性能。**

- **链接: [https://arxiv.org/pdf/2512.04949v1](https://arxiv.org/pdf/2512.04949v1)**
...
>
---
#### [new 047] Towards Ethical Multi-Agent Systems of Large Language Models: A Mechanistic Interpretability Perspective
- **分类: cs.AI; cs.CL; cs.MA**

- **简介: 该论文属于伦理与可解释性研究，旨在解决大语言模型多智能体系统中的伦理问题。提出从机制可解释性出发，构建评估框架、解析涌现行为机制，并设计高效对齐方法以实现伦理可控的多智能体系统。**

- **链接: [https://arxiv.org/pdf/2512.04691v1](https://arxiv.org/pdf/2512.04691v1)**

> **作者:** Jae Hee Lee; Anne Lauscher; Stefano V. Albrecht
>
> **备注:** Accepted to LaMAS 2026@AAAI'26 (https://sites.google.com/view/lamas2026)
>
> **摘要:** Large language models (LLMs) have been widely deployed in various applications, often functioning as autonomous agents that interact with each other in multi-agent systems. While these systems have shown promise in enhancing capabilities and enabling complex tasks, they also pose significant ethical challenges. This position paper outlines a research agenda aimed at ensuring the ethical behavior of multi-agent systems of LLMs (MALMs) from the perspective of mechanistic interpretability. We identify three key research challenges: (i) developing comprehensive evaluation frameworks to assess ethical behavior at individual, interactional, and systemic levels; (ii) elucidating the internal mechanisms that give rise to emergent behaviors through mechanistic interpretability; and (iii) implementing targeted parameter-efficient alignment techniques to steer MALMs towards ethical behaviors without compromising their performance.
>
---
#### [new 048] Topology Matters: Measuring Memory Leakage in Multi-Agent LLMs
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文研究多智能体大语言模型中网络拓扑对记忆泄露的影响。提出MAMA框架，通过构造合成文档与两阶段攻击协议，量化不同拓扑下的隐私泄露程度，揭示拓扑结构对隐私风险的系统性影响，并给出抗泄露的架构设计准则。**

- **链接: [https://arxiv.org/pdf/2512.04668v1](https://arxiv.org/pdf/2512.04668v1)**
...
>
---
#### [new 049] Network of Theseus (like the ship)
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出Network of Theseus（NoT），旨在解耦神经网络训练与部署架构。通过逐步替换并对齐模块，将引导网络转化为目标架构，保持性能的同时提升设计灵活性，解决因优化困难而限制高效架构使用的问题。**

- **链接: [https://arxiv.org/pdf/2512.04198v1](https://arxiv.org/pdf/2512.04198v1)**
...
>
---
#### [new 050] Human-Centred Evaluation of Text-to-Image Generation Models for Self-expression of Mental Distress: A Dataset Based on GPT-4o
...
>
---
#### [new 053] MemLoRA: Distilling Expert Adapters for On-Device Memory Systems
...
#### [replaced 001] SignBind-LLM: Multi-Stage Modality Fusion for Sign Language Translation
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 002] Athena: Enhancing Multimodal Reasoning with Data-efficient Process Reward Models
...
>
---
#### [replaced 003] Large language models can learn and generalize steganographic chain-of-thought under process supervision
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文研究大语言模型在过程监督下学习和泛化隐写推理的能力。针对奖励滥用行为被隐藏的问题，发现模型可将关键推理信息用替代字符串隐写，并泛化至未见的同类字符串，威胁CoT监控可靠性。**

- **链接: [https://arxiv.org/pdf/2506.01926v2](https://arxiv.org/pdf/2506.01926v2)**
...
>
---
#### [replaced 007] Massively Multilingual Adaptation of Large Language Models Using Bilingual Translation Data
- **分类: cs.CL**

- **简介: 该论文研究大规模多语言大模型持续预训练中引入双语翻译数据的影响，旨在提升低资源语言的迁移性能。作者构建双语语料MaLA，发布基于Llama3的EMMA-500系列模型，验证双语数据对多语言适应的积极作用。**

- **链接: [https://arxiv.org/pdf/2506.00469v2](https://arxiv.org/pdf/2506.00469v2)**

> **作者:** Shaoxiong Ji; Zihao Li; Jaakko Paavola; Hengyu Luo; Jörg Tiedemann
>
> **备注:** EMMA-500 Gen 2; refer to Gen 1 in arXiv:2409.17892
>
> **摘要:** This paper investigates a critical design decision in the practice of massively multilingual continual pre-training -- the inclusion of parallel data. Specifically, we study the impact of bilingual translation data for massively multilingual language adaptation of the Llama3 family of models to 500 languages. To this end, we construct the MaLA bilingual translation corpus, containing data from more than 2,500 language pairs. Subsequently, we develop the EMMA-500 Llama 3 suite of four massively multilingual models -- continually pre-trained from the Llama 3 family of base models extensively on diverse data mixes up to 671B tokens -- and explore the effect of continual pre-training with or without bilingual translation data. Comprehensive evaluation across 7 tasks and 12 benchmarks demonstrates that bilingual data tends to enhance language transfer and performance, particularly for low-resource languages. We open-source the MaLA corpus, EMMA-500 Llama 3 suite artefacts, code, and model generations.
>
---
#### [replaced 008] Reversing Large Language Models for Efficient Training and Fine-Tuning
- **分类: cs.CL; cs.AI**

- **简介: 该论文针对大语言模型训练和微调内存消耗大的问题，提出基于可逆动力学的高效架构，通过时间可逆性恢复隐藏状态，减少显存占用，并支持将现有模型转为可逆结构，实现高效训练与微调。**

- **链接: [https://arxiv.org/pdf/2512.02056v2](https://arxiv.org/pdf/2512.02056v2)**
...
>
---
#### [replaced 009] Dual-branch Prompting for Multimodal Machine Translation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 010] HUME: Measuring the Human-Model Performance Gap in Text Embedding Tasks
- **分类: cs.CL**

- **简介: 该论文提出HUME框架，旨在衡量文本嵌入任务中人类与模型的性能差距。针对现有基准缺乏人类表现评估的问题，作者在16个数据集上评测人类和模型表现，揭示模型在低资源语言中的不足，并检验LLM作为标注者的有效性，为嵌入模型与基准的改进提供依据。**

- **链接: [https://arxiv.org/pdf/2510.10062v3](https://arxiv.org/pdf/2510.10062v3)**
...
>
---
#### [replaced 011] Scaling Towards the Information Boundary of Instruction Sets: The Infinity Instruct Subject Technical Report
- **分类: cs.AI; cs.CL**

- **简介: 该论文属指令数据构建任务，旨在解决现有指令数据在覆盖广度与复杂深度上的不足。提出闭环框架Infinity Instruct Subject，通过分层标注、种子选择、进化合成与缺陷诊断，提升指令数据质量，增强模型指令遵循能力。**

- **链接: [https://arxiv.org/pdf/2507.06968v3](https://arxiv.org/pdf/2507.06968v3)**
...
>
---
#### [replaced 014] Data Mixing Can Induce Phase Transitions in Knowledge Acquisition
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究大语言模型在混合数据下知识获取的相变现象。任务为分析不同数据配比和模型规模对知识学习的影响，发现存在突变式相变，并提出容量分配的信息论解释，揭示关键混合比例与模型大小的幂律关系。**

- **链接: [https://arxiv.org/pdf/2505.18091v2](https://arxiv.org/pdf/2505.18091v2)**
...
>
---
#### [replaced 015] SO-Bench: A Structural Output Evaluation of Multimodal LLMs
...
>
---
#### [replaced 016] On-Policy Optimization with Group Equivalent Preference for Multi-Programming Language Understanding
- **分类: cs.CL**

- **简介: 该论文属多编程语言理解任务，旨在缩小大模型在不同语言间的性能差距。作者提出OORL框架，结合代码翻译与新型偏好优化方法GEPO，利用中间表示组和规则奖励，提升模型对跨语言代码功能的理解与生成能力。**

- **链接: [https://arxiv.org/pdf/2505.12723v3](https://arxiv.org/pdf/2505.12723v3)**
...
>
---
#### [replaced 019] Similarity-Distance-Magnitude Activations
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于模型输出校准与可解释性任务，旨在提升分类模型在分布偏移下的鲁棒性。提出SDM激活函数及估计器，融合相似性、距离与幅度信息，实现更可靠的置信度估计与基于样例的解释。**

- **链接: [https://arxiv.org/pdf/2509.12760v3](https://arxiv.org/pdf/2509.12760v3)**

> **作者:** Allen Schmaltz
>
> **备注:** 21 pages, 8 tables, 1 algorithm. arXiv admin note: substantial text overlap with arXiv:2502.20167
>
...
>
---
#### [replaced 020] FlashFormer: Whole-Model Kernels for Efficient Low-Batch Inference
- **分类: cs.LG; cs.CL**

- **简介: 该论文针对低批量推理中内存带宽和启动开销大的问题，提出FlashFormer，将Transformer前向计算融合为单个核函数，提升小批量推理效率，适用于边缘部署和低延迟场景。**

- **链接: [https://arxiv.org/pdf/2505.22758v2](https://arxiv.org/pdf/2505.22758v2)**
...
>
---
#### [replaced 021] Bridging Online Behavior and Clinical Insight: A Longitudinal LLM-based Study of Suicidality on YouTube Reveals Novel Digital Markers
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究YouTube语言模式与自杀行为的关系，旨在发现数字标记。通过LLM分析181个自杀尝试频道，结合自下而上、混合和专家驱动方法，揭示心理挣扎和平台互动等关键主题，关联临床知识，理解不同动机。**

- **链接: [https://arxiv.org/pdf/2506.09495v2](https://arxiv.org/pdf/2506.09495v2)**
...
>
---
#### [replaced 022] SeSE: A Structural Information-Guided Uncertainty Quantification Framework for Hallucination Detection in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型的幻觉检测任务，旨在解决现有不确定性量化方法忽略语义结构信息的问题。作者提出SeSE框架，通过构建稀疏有向语义图并计算最优语义编码树的结构熵，实现无需训练、适用于各类LLM的高精度幻觉检测。**

- **链接: [https://arxiv.org/pdf/2511.16275v2](https://arxiv.org/pdf/2511.16275v2)**

> **作者:** Xingtao Zhao; Hao Peng; Dingli Su; Xianghua Zeng; Chunyang Liu; Jinzhi Liao; Philip S. Yu
>
> **备注:** 14 pages of main text and 10 pages of appendices;Submit to IEEE TKDE
>
...
>
---
#### [replaced 023] ThaiOCRBench: A Task-Diverse Benchmark for Vision-Language Understanding in Thai
- **分类: cs.CL**

- **简介: 该论文提出ThaiOCRBench，首个面向泰语视觉语言理解的多任务基准，旨在解决泰语在文档结构理解中资源不足的问题。作者构建了含2,808个样本的标注数据集，评估多种VLMs，揭示开源模型在细粒度文本与手写识别上的短板，并分析语言偏见等关键挑战。**

- **链接: [https://arxiv.org/pdf/2511.04479v3](https://arxiv.org/pdf/2511.04479v3)**
...
>
> **备注:** Accepted at IJCNLP-AACL 2025 (Main). This version includes the corrected Table 2 and an updated conclusion regarding the deletion count of the Gemma model
>
...
>
---
#### [replaced 024] Jina-VLM: Small Multilingual Vision Language Model
...
>
---
#### [replaced 025] PUCP-Metrix: An Open-source and Comprehensive Toolkit for Linguistic Analysis of Spanish Texts
- **分类: cs.CL**

- **简介: 该论文提出PUCP-Metrix，一个开源的西班牙语文本语言分析工具包，旨在解决现有工具覆盖度低的问题。它包含182个语言特征，用于可解释的细粒度文本分析，在可读性评估和机器生成文本检测中表现良好。**

- **链接: [https://arxiv.org/pdf/2511.17402v2](https://arxiv.org/pdf/2511.17402v2)**

> **作者:** Javier Alonso Villegas Luis; Marco Antonio Sobrevilla Cabezudo
>
> **备注:** 1 figure, Submitted to EACL Demo track (under review)
>
...
>
---
#### [replaced 026] In-Context Representation Hijacking
- **分类: cs.CL; cs.AI; cs.CR; cs.LG**

- **简介: 该论文研究大语言模型的安全对齐问题，提出一种名为Doublespeak的上下文表示劫持攻击。通过在上下文中替换有害词为无害词，使模型内部将无害词表征篡改为有害语义，从而绕过安全检测，揭示了现有对齐方法在表示层面的不足。**

- **链接: [https://arxiv.org/pdf/2512.03771v2](https://arxiv.org/pdf/2512.03771v2)**

> **作者:** Itay Yona; Amir Sarid; Michael Karasik; Yossi Gandelsman
>
> **摘要:** We introduce $\textbf{Doublespeak}$, a simple in-context representation hijacking attack against large language models (LLMs). The attack works by systematically replacing a harmful keyword (e.g., bomb) with a benign token (e.g., carrot) across multiple in-context examples, provided a prefix to a harmful request. We demonstrate that this substitution leads to the internal representation of the benign token converging toward that of the harmful one, effectively embedding the harmful semantics under a euphemism. As a result, superficially innocuous prompts (e.g., "How to build a carrot?") are internally interpreted as disallowed instructions (e.g., "How to build a bomb?"), thereby bypassing the model's safety alignment. We use interpretability tools to show that this semantic overwrite emerges layer by layer, with benign meanings in early layers converging into harmful semantics in later ones. Doublespeak is optimization-free, broadly transferable across model families, and achieves strong success rates on closed-source and open-source systems, reaching 74% ASR on Llama-3.3-70B-Instruct with a single-sentence context override. Our findings highlight a new attack surface in the latent space of LLMs, revealing that current alignment strategies are insufficient and should instead operate at the representation level.
>
---
#### [replaced 027] Evaluating Autoformalization Robustness via Semantically Similar Paraphrasing
- **分类: cs.CL; cs.LO**

- **简介: 该论文研究大语言模型在数学形式化中的鲁棒性，探讨语义一致的自然语言改写对生成形式证明的影响。通过MiniF2F和ProofNet基准测试，评估模型输出的语义与编译有效性，发现微小的语言变化会显著影响结果。**

- **链接: [https://arxiv.org/pdf/2511.12784v2](https://arxiv.org/pdf/2511.12784v2)**
...
>
---
#### [replaced 028] Control Illusion: The Failure of Instruction Hierarchies in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大语言模型中指令层级控制的有效性，发现系统指令未必优于用户指令，提出基于约束优先级的评估框架，揭示模型受社会属性影响大于显式角色设定，暴露当前层级控制机制的失效问题。**

- **链接: [https://arxiv.org/pdf/2502.15851v4](https://arxiv.org/pdf/2502.15851v4)**
...
>
---
#### [replaced 029] Human Mobility Datasets Enriched With Contextual and Social Dimensions
- **分类: cs.CL; cs.AI; cs.SI**

- **简介: 该论文属于数据资源构建任务，旨在解决人类移动数据语义信息不足的问题。作者发布了两个融合上下文、社交维度和LLM生成文本的多模态轨迹数据集，并提供可复用的处理流程，支持行为建模与知识图谱等研究。**

- **链接: [https://arxiv.org/pdf/2510.02333v2](https://arxiv.org/pdf/2510.02333v2)**
...
>
---
#### [replaced 030] LORE: A Large Generative Model for Search Relevance
- **分类: cs.IR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文聚焦电商搜索相关性任务，旨在突破生成模型在相关性排序中的性能瓶颈。提出LORE框架，通过能力分解、两阶段训练、分层部署等方法，系统化提升搜索相关性，实现显著线上效果提升。**

- **链接: [https://arxiv.org/pdf/2512.03025v2](https://arxiv.org/pdf/2512.03025v2)**
...
>
---
#### [replaced 031] TaoSR1: The Thinking Model for E-commerce Relevance Search
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文研究电商搜索中的查询-商品相关性预测任务，旨在解决LLMs在推理错误累积、判别幻觉及部署可行性上的问题。提出TaoSR1框架，通过三阶段训练与优化策略，结合思维链与高效部署方法，提升相关性判断性能。**

- **链接: [https://arxiv.org/pdf/2508.12365v3](https://arxiv.org/pdf/2508.12365v3)**
...
>
---
#### [replaced 032] Beyond the Exploration-Exploitation Trade-off: A Hidden State Approach for LLM Reasoning in RLVR
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究强化学习中可验证奖励（RLVR）下的大模型推理，挑战传统探索-利用权衡观点。通过引入隐藏状态空间的有效秩及其导数，提出VERL方法，实现探索与利用的协同增强，提升推理性能。**

- **链接: [https://arxiv.org/pdf/2509.23808v3](https://arxiv.org/pdf/2509.23808v3)**
...
>
---
#### [replaced 035] An Investigation of Robustness of LLMs in Mathematical Reasoning: Benchmarking with Mathematically-Equivalent Transformation of Advanced Mathematical Problems
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文聚焦大模型数学推理的鲁棒性评估，提出通过数学等价但语言或参数不同的变换来检验模型性能。构建了含多种变体的基准数据集PutnamGAP，发现主流模型在变体上表现显著下降，揭示其推理脆弱性。**

- **链接: [https://arxiv.org/pdf/2508.08833v3](https://arxiv.org/pdf/2508.08833v3)**
...
>
---
#### [replaced 036] EMMA-500: Enhancing Massively Multilingual Adaptation of Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于大语言模型的多语言扩展任务，旨在提升低资源语言的支持能力。作者构建了涵盖546种语言的MaLA语料库，对Llama 2 7B进行持续预训练，推出EMMA-500模型，显著增强其多语言理解与跨语言迁移能力，并公开所有资源。**

- **链接: [https://arxiv.org/pdf/2409.17892v3](https://arxiv.org/pdf/2409.17892v3)**
...
>
---
#### [replaced 039] Nexus: Higher-Order Attention Mechanisms in Transformers
- **分类: cs.CL**

- **简介: 该论文提出Nexus架构，旨在解决Transformer中标准一阶注意力因低秩瓶颈难以捕捉复杂多跳关系的问题。通过递归式高阶注意力机制，动态优化Query和Key的表示，增强模型表达能力，且仅增加常数级参数，在理论与实验上均验证了其有效性。**

- **链接: [https://arxiv.org/pdf/2512.03377v2](https://arxiv.org/pdf/2512.03377v2)**

> **作者:** Hanting Chen; Chong Zhu; Kai Han; Yuchuan Tian; Yuchen Liang; Tianyu Guo; Xinghao Chen; Dacheng Tao; Yunhe Wang
>
...
>
---
#### [replaced 040] Grounding LLM Reasoning with Knowledge Graphs
- **分类: cs.CL**

- **简介: 该论文属知识增强型推理任务，旨在解决大语言模型推理不可追溯、难验证的问题。提出将LLM推理过程与知识图谱结合的框架，通过链式、树状和图状多种策略，实现可解释、一致性强的推理，在GRBench上性能显著优于基线。**

- **链接: [https://arxiv.org/pdf/2502.13247v3](https://arxiv.org/pdf/2502.13247v3)**
...
>
---
#### [replaced 041] Which Type of Students can LLMs Act? Investigating Authentic Simulation with Graph-based Human-AI Collaborative System
- **分类: cs.CY; cs.CL**

- **简介: 该论文属智能教育任务，旨在解决LLM模拟学生真实性不足的问题。提出三阶段人机协同流程，结合自动评分、专家校准与图传播，生成高质学生代理，并分析其仿真保真度。**

- **链接: [https://arxiv.org/pdf/2502.11678v4](https://arxiv.org/pdf/2502.11678v4)**
...
>
---
#### [replaced 042] Semi-Supervised Synthetic Data Generation with Fine-Grained Relevance Control for Short Video Search Relevance Modeling
- **分类: cs.CL**

- **简介: 该论文属短视频搜索相关性建模任务，旨在解决合成数据缺乏细粒度相关性控制及领域适配的问题。提出半监督合成数据生成方法，实现可控的相关性标签生成，提升模型对细微语义差异的敏感性，显著改善线上效果。**

- **链接: [https://arxiv.org/pdf/2509.16717v2](https://arxiv.org/pdf/2509.16717v2)**
