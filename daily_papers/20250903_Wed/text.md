...
- **简介: 该论文提出GIER框架，通过识别推理差距并迭代优化，提升大语言模型的推理质量与准确性，解决传统方法依赖示例或模板的局限性。**
...
- **链接: [http://arxiv.org/pdf/2509.02503v1](http://arxiv.org/pdf/2509.02503v1)**
...
>
> **摘要:** Large Language Models (LLMs) have achieved remarkable success across various domains. However, a fundamental question remains: Can LLMs effectively utilize causal knowledge for prediction and generation? Through empirical studies, we find that LLMs trained directly on large-scale data often capture spurious correlations rather than true causal relationships, leading to suboptimal performance, especially in out-of-distribution (OOD) scenarios. To address this challenge, we propose Causal Attention Tuning (CAT), a novel approach that injects fine-grained causal knowledge into the attention mechanism. We propose an automated pipeline that leverages human priors to automatically generate token-level causal signals and introduce the Re-Attention mechanism to guide training, helping the model focus on causal structures while mitigating noise and biases in attention scores. Experimental results on our proposed Spurious Token Game (STG) benchmark and multiple downstream tasks demonstrate that our approach effectively leverages causal knowledge for prediction and remains robust in OOD scenarios. Implementation details can be found at https://github.com/Kairong-Han/CAT.
>
---
...
- **简介: 该论文提出元预训练方法，针对低资源菲律宾语言的零样本跨语言NER任务，通过MAML优化小解码器LM，提升微调后准确率并缩短收敛时间。**
...
- **简介: 该论文提出基于发音转录的词相似性计算方法，解决大规模数据处理效率问题。通过并行化Needleman-Wunsch算法（CUDA加速），构建图结构并聚类分析，验证方法有效性及多语言扩展性。**
...
- **简介: 该论文提出零样本可调加速方法，解决大语言模型推理效率与性能平衡问题。通过动态调整硬件使用，在无需额外微调情况下实现多任务加速，最高达11倍速度提升。**
...
- **链接: [http://arxiv.org/pdf/2509.00709v1](http://arxiv.org/pdf/2509.00709v1)**
...
- **简介: 论文提出GraphKV框架，通过图结构动态更新token重要性，解决传统静态KV缓存淘汰策略在长文本处理中的不足，提升LLM缓存效率。**
...
- **链接: [http://arxiv.org/pdf/2509.02534v1](http://arxiv.org/pdf/2509.02534v1)**
...
- **简介: 该论文提出StructCoh框架，解决文本语义匹配中结构关系与细粒度语义理解不足的问题。通过双图编码器与分层对比学习，结合语法依赖与主题建模，提升跨文档结构语义对齐效果，在法律匹配等任务中取得显著提升。**
...
- **简介: 该论文提出Genetic Prompt框架，融合遗传算法与LLM，将文本属性视为基因序列，通过模拟交叉突变生成高质量合成数据，并结合主动学习优化父代选择，实验证明其在NLP任务中有效提升模型性能，尤其适用于类别不平衡场景。**
...
- **简介: 该论文提出“有意文化评估”框架，批判现有方法忽视文化复杂性，强调评估中文化假设与研究者立场，推动包容性NLP研究。**
...
- **链接: [http://arxiv.org/pdf/2509.00461v1](http://arxiv.org/pdf/2509.00461v1)**
...
- **简介: 该论文提出InSide模型，通过图结构联合学习新闻意图与语义，解决现有方法仅依赖语义导致的表面模式问题，提升假新闻检测效果。**
...
- **简介: 该论文针对多模态文档视觉问答任务，提出CMRAG方法，通过联合文本与图像的跨模态检索，解决现有方法仅依赖单一模态或忽略文本语义的问题，提升复杂文档问答性能。**
...
- **简介: 该论文针对大模型故事生成中重复单调的问题，提出Avoidance Decoding策略，通过概念级和叙事级相似性惩罚机制提升输出多样性，实现多分支故事生成任务中2.6倍多样性提升和30%重复率降低。**
...
- **链接: [http://arxiv.org/pdf/2509.01379v1](http://arxiv.org/pdf/2509.01379v1)**
...
- **链接: [http://arxiv.org/pdf/2509.00934v1](http://arxiv.org/pdf/2509.00934v1)**
...
- **简介: 该论文研究乌尔都语动词与体貌组合的语法演变，揭示完美体形式在现代语言中消失的现象。通过历史文本分析和语料库研究，发现其因形态句法冲突导致结构不稳定，最终被其他构造取代，形成语法缺口。**
...
>
---
#### [new 068] CaresAI at BioCreative IX Track 1 -- LLM for Biomedical QA
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文针对生物医学多跳问答任务，解决LLM在复杂QA中的准确性和格式输出问题。作者采用LLaMA 3微调策略，结合多数据集进行实验，并设计两阶段推理管道优化短答案提取，揭示语义理解与精确评估间的差距。**

- **链接: [http://arxiv.org/pdf/2509.00806v1](http://arxiv.org/pdf/2509.00806v1)**
...
>
---
#### [new 086] Zero-shot Cross-lingual NER via Mitigating Language Difference: An Entity-aligned Translation Perspective
- **分类: cs.CL**

- **简介: 该论文提出实体对齐翻译（EAT）方法，解决零样本跨语言NER中非拉丁语系语言性能下降问题。通过双翻译策略与多语言维基微调，实现源语言到目标语言的实体对齐，缓解语言结构差异带来的知识迁移困难。**

- **链接: [http://arxiv.org/pdf/2509.01147v1](http://arxiv.org/pdf/2509.01147v1)**
...
>
---
#### [new 087] On the Alignment of Large Language Models with Global Human Opinion
- **分类: cs.CL**

- **简介: 本研究评估大语言模型与全球人类意见的对齐情况，解决现有研究缺乏全球、历史及语言维度的问题。通过基于WVS的框架，发现LLMs在少数国家过度对齐，多数国家不足，且提示语言可有效引导对齐，首次实现跨全球、语言和时间的全面分析。**

- **链接: [http://arxiv.org/pdf/2509.01418v1](http://arxiv.org/pdf/2509.01418v1)**
...
>
---
#### [new 088] MultiStream-LLM: Bridging Modalities for Robust Sign Language Translation
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 089] Do LLMs Adhere to Label Definitions? Examining Their Receptivity to External Label Definitions
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究LLMs是否遵循外部标签定义，通过控制实验分析其对不同定义的响应，发现其依赖内部表示，尤其在通用任务中，而领域任务受益更多。**

- **链接: [http://arxiv.org/pdf/2509.02452v1](http://arxiv.org/pdf/2509.02452v1)**
...
>
---
#### [new 090] SeLeRoSa: Sentence-Level Romanian Satire Detection Dataset
- **分类: cs.CL; I.2.7; I.7**

- **简介: 论文构建首个罗马尼亚语句子级讽刺检测数据集SeLeRoSa，包含13,873个标注句子，评估LLM和Transformer模型，揭示当前模型在该任务的局限性，推动后续研究。**

- **链接: [http://arxiv.org/pdf/2509.00893v1](http://arxiv.org/pdf/2509.00893v1)**
...
>
---
#### [new 091] LLMs cannot spot math errors, even when allowed to peek into the solution
- **分类: cs.CL; cs.AI**

- **简介: 论文研究LLM在数学解题错误定位任务中的表现，发现即使提供参考答案也难以识别首个错误步骤，提出生成中间修正解的方法提升性能。**

- **链接: [http://arxiv.org/pdf/2509.01395v1](http://arxiv.org/pdf/2509.01395v1)**

> **作者:** KV Aditya Srivatsa; Kaushal Kumar Maurya; Ekaterina Kochmar
>
> **备注:** Accepted to EMNLP 2025
>
> **摘要:** Large language models (LLMs) demonstrate remarkable performance on math word problems, yet they have been shown to struggle with meta-reasoning tasks such as identifying errors in student solutions. In this work, we investigate the challenge of locating the first error step in stepwise solutions using two error reasoning datasets: VtG and PRM800K. Our experiments show that state-of-the-art LLMs struggle to locate the first error step in student solutions even when given access to the reference solution. To that end, we propose an approach that generates an intermediate corrected student solution, aligning more closely with the original student's solution, which helps improve performance.
>
---
#### [new 092] LongCat-Flash Technical Report
- **分类: cs.CL; cs.AI; cs.DC; cs.LG**

- **简介: 该论文提出LongCat-Flash，一个5600亿参数的MoE语言模型，解决大规模模型计算效率与代理能力问题。通过零计算专家和快捷连接MoE设计优化资源分配与推理效率，结合创新训练框架实现高效训练与微调，开源以促进研究。**

- **链接: [http://arxiv.org/pdf/2509.01322v1](http://arxiv.org/pdf/2509.01322v1)**
...
>
---
#### [new 093] Can Large Language Models Master Complex Card Games?
- **分类: cs.CL**

- **简介: 该论文评估大语言模型在复杂卡牌游戏中的能力，解决其能否媲美传统AI的问题。通过系统测试八种游戏，分析微调数据的影响及模型通用能力保留情况，验证LLM的学习潜力与局限性。**

- **链接: [http://arxiv.org/pdf/2509.01328v1](http://arxiv.org/pdf/2509.01328v1)**
...
>
---
#### [new 094] LLM Encoder vs. Decoder: Robust Detection of Chinese AI-Generated Text with LoRA
- **分类: cs.CL**

- **简介: 该论文针对中文AI生成文本检测任务，比较了编码器模型与LoRA微调的解码器模型性能。研究发现，LoRA优化的Qwen2.5-7B在测试中达到95.94%准确率，展现更强的鲁棒性，表明解码器架构结合参数高效微调更适用于该任务。**

- **链接: [http://arxiv.org/pdf/2509.00731v1](http://arxiv.org/pdf/2509.00731v1)**
...
>
---
#### [new 095] CE-Bench: Towards a Reliable Contrastive Evaluation Benchmark of Interpretability of Sparse Autoencoders
- **分类: cs.CL**

- **简介: 该论文提出CE-Bench，构建对比评估基准以衡量稀疏自编码器的可解释性，解决现有缺乏自动化评估方法的问题。通过对比故事对数据集和消融实验验证有效性，无需外部LLM，开源代码与数据集。**

- **链接: [http://arxiv.org/pdf/2509.00691v1](http://arxiv.org/pdf/2509.00691v1)**

> **作者:** Alex Gulko; Yusen Peng; Sachin Kumar
>
> **摘要:** Probing with sparse autoencoders is a promising approach for uncovering interpretable features in large language models (LLMs). However, the lack of automated evaluation methods has hindered their broader adoption and development. In this work, we introduce CE-Bench, a novel and lightweight contrastive evaluation benchmark for sparse autoencoders, built on a curated dataset of contrastive story pairs. We conduct comprehensive ablation studies to validate the effectiveness of our approach. Our results show that CE-Bench reliably measures the interpretability of sparse autoencoders and aligns well with existing benchmarks, all without requiring an external LLM. The official implementation and evaluation dataset are open-sourced under the MIT License.
>
---
#### [new 096] Assessing Large Language Models on Islamic Legal Reasoning: Evidence from Inheritance Law Evaluation
- **分类: cs.CL; cs.AI; I.2.6; I.2.7**

- **简介: 该论文评估大语言模型在伊斯兰法律推理（继承法）中的表现，通过1000道多选题测试七种模型，揭示其在法律规则应用和领域知识掌握上的显著差异，并分析错误模式以指导改进。**

- **链接: [http://arxiv.org/pdf/2509.01081v1](http://arxiv.org/pdf/2509.01081v1)**
...
>
---
#### [new 100] Balanced Actor Initialization: Stable RLHF Training of Distillation-Based Reasoning Models
- **分类: cs.CL**

- **简介: 论文提出BAI方法，解决基于蒸馏模型的RLHF训练中的序列长度崩溃和奖励曲线问题，通过两阶段加权融合提升训练稳定性。**

- **链接: [http://arxiv.org/pdf/2509.00309v1](http://arxiv.org/pdf/2509.00309v1)**
...
>
---
#### [new 103] Enhancing Uncertainty Estimation in LLMs with Expectation of Aggregated Internal Belief
- **分类: cs.CL**

- **简介: 该论文提出EAGLE方法，通过聚合LLM中间层内部信念并计算期望，提升不确定性估计的准确性，解决模型过度自信问题，增强部署可靠性。**

- **链接: [http://arxiv.org/pdf/2509.01564v1](http://arxiv.org/pdf/2509.01564v1)**
...
>
---
#### [new 108] MoSEs: Uncertainty-Aware AI-Generated Text Detection via Mixture of Stylistics Experts with Conditional Thresholds
- **分类: cs.CL; cs.AI**

- **简介: 论文提出MoSEs框架，用于AI生成文本检测，解决现有方法忽视风格建模与静态阈值的问题。通过风格参考库、路由器和条件阈值估计器动态调整阈值，提升检测性能，尤其在低资源场景下效果显著。**

- **链接: [http://arxiv.org/pdf/2509.02499v1](http://arxiv.org/pdf/2509.02499v1)**
...
>
---
#### [new 109] Vis-CoT: A Human-in-the-Loop Framework for Interactive Visualization and Intervention in LLM Chain-of-Thought Reasoning
- **分类: cs.CL; 68T07, 68T50, 68T05; I.2.7; I.2.6; I.2.8; H.5.2**

- **简介: 论文提出Vis-CoT框架，通过交互式可视化与干预提升LLM链式推理的透明度与准确性，解决推理过程不透明问题，实现人机协作验证与控制。**

- **链接: [http://arxiv.org/pdf/2509.01412v1](http://arxiv.org/pdf/2509.01412v1)**
...
>
---
#### [new 110] Analysing the Language of Neural Audio Codecs
- **分类: cs.CL; eess.AS**

- **简介: 该论文分析神经音频编解码器生成的离散语音标记的语言统计特性，如齐普夫定律和熵，评估其与语音合成质量及识别性能的关系，旨在揭示标记结构对生成模型效果的影响，指导更高效的语音模型设计。**

- **链接: [http://arxiv.org/pdf/2509.01390v1](http://arxiv.org/pdf/2509.01390v1)**
...
>
---
#### [new 111] Can Multi-turn Self-refined Single Agent LMs with Retrieval Solve Hard Coding Problems?
- **分类: cs.CL**

- **简介: 论文评估语言模型在编程竞赛中的表现，解决复杂代码问题。提出ICPC基准，测试多轮自我优化与检索结合的推理技术，提升解决率至42.2%，并发现模型可解决此前无法解决的17/18问题。**

- **链接: [http://arxiv.org/pdf/2509.00629v1](http://arxiv.org/pdf/2509.00629v1)**
...
>
---
#### [new 113] OpinioRAG: Towards Generating User-Centric Opinion Highlights from Large-scale Online Reviews
- **分类: cs.CL; cs.AI; cs.IR**

- **简介: 该论文提出OpinioRAG框架，解决大规模在线评论中生成个性化意见摘要的问题，结合RAG与LLM实现可扩展的定制化总结，并设计领域专用验证指标与大型数据集。**

- **链接: [http://arxiv.org/pdf/2509.00285v1](http://arxiv.org/pdf/2509.00285v1)**
...
>
---
#### [new 114] TableZoomer: A Collaborative Agent Framework for Large-scale Table Question Answering
- **分类: cs.CL**

- **简介: 论文提出TableZoomer框架，解决大规模表格问答中的结构异质性、定位效率低和推理瓶颈问题。通过结构化表格、查询感知缩放和程序思维策略，结合ReAct范式，提升准确率与可扩展性。**

- **链接: [http://arxiv.org/pdf/2509.01312v1](http://arxiv.org/pdf/2509.01312v1)**
...
>
---
#### [new 123] We Politely Insist: Your LLM Must Learn the Persian Art of Taarof
- **分类: cs.CL**

- **简介: 该论文提出TaarofBench基准，评估LLM对伊朗taarof礼仪的理解，发现模型表现低于母语者，通过微调和优化提升表现，并开展人类研究建立基线。**

- **链接: [http://arxiv.org/pdf/2509.01035v1](http://arxiv.org/pdf/2509.01035v1)**

> **作者:** Nikta Gohari Sadr; Sahar Heidariasl; Karine Megerdoomian; Laleh Seyyed-Kalantari; Ali Emami
>
> **备注:** Accepted to EMNLP 2025 Main Conference
>
> **摘要:** Large language models (LLMs) struggle to navigate culturally specific communication norms, limiting their effectiveness in global contexts. We focus on Persian taarof, a social norm in Iranian interactions, which is a sophisticated system of ritual politeness that emphasizes deference, modesty, and indirectness, yet remains absent from existing cultural benchmarks. We introduce TaarofBench, the first benchmark for evaluating LLM understanding of taarof, comprising 450 role-play scenarios covering 12 common social interaction topics, validated by native speakers. Our evaluation of five frontier LLMs reveals substantial gaps in cultural competence, with accuracy rates 40-48% below native speakers when taarof is culturally appropriate. Performance varies between interaction topics, improves with Persian-language prompts, and exhibits gender-based asymmetries. We also show that responses rated "polite" by standard metrics often violate taarof norms, indicating the limitations of Western politeness frameworks. Through supervised fine-tuning and Direct Preference Optimization, we achieve 21.8% and 42.3% improvement in model alignment with cultural expectations. Our human study with 33 participants (11 native Persian, 11 heritage, and 11 non-Iranian speakers) forms baselines in varying degrees of familiarity with Persian norms. This work lays the foundation for developing diverse and culturally aware LLMs, enabling applications that better navigate complex social interactions.
>
---
#### [new 124] SpecEval: Evaluating Model Adherence to Behavior Specifications
- **分类: cs.CL**

- **简介: 该论文提出SpecEval框架，解决模型是否遵循开发者行为规范的验证问题。通过解析规范、生成提示并利用模型自我评估，实现三重一致性检查，发现多模型存在高达20%的合规差距。**

- **链接: [http://arxiv.org/pdf/2509.02464v1](http://arxiv.org/pdf/2509.02464v1)**
...
>
---
#### [new 125] Trusted Uncertainty in Large Language Models: A Unified Framework for Confidence Calibration and Risk-Controlled Refusal
- **分类: cs.CL; 68T50; I.2.7**

- **简介: 论文提出UniCR框架，解决大模型在不确定时的拒绝问题，通过整合多源不确定性证据校准置信度，结合风险控制策略实现可信拒绝，提升问答等任务的可信度与覆盖范围。**

- **链接: [http://arxiv.org/pdf/2509.01455v1](http://arxiv.org/pdf/2509.01455v1)**
...
>
---
#### [new 126] ResearchQA: Evaluating Scholarly Question Answering at Scale Across 75 Fields with Survey-Mined Questions and Rubrics
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出ResearchQA，构建跨75领域的学术问答评估资源，提取21K问题及160K评分项，评估LLM系统覆盖能力，揭示当前系统在引用、限制等关键指标上的不足。**

- **链接: [http://arxiv.org/pdf/2509.00496v1](http://arxiv.org/pdf/2509.00496v1)**
...
>
---
#### [new 127] DRAssist: Dispute Resolution Assistance using Large Language Models
- **分类: cs.CL**

- **简介: 论文提出DRAssist系统，利用LLM辅助解决汽车保险和域名纠纷，通过结构化摘要与多策略提示评估LLM在三方任务中的表现。**

- **链接: [http://arxiv.org/pdf/2509.01962v1](http://arxiv.org/pdf/2509.01962v1)**
...
>
---
#### [new 132] Neural Models and Language Model Prompting for the Multidimensional Evaluation of Open-Ended Conversations
- **分类: cs.CL**

- **简介: 该论文针对开放对话系统的多维评估任务，解决小模型高效评价难题。通过语言模型提示与编码器分类/回归模型，预测对话维度评分，对比不同方法效果，探索小模型在对话评估中的应用。**

- **链接: [http://arxiv.org/pdf/2509.00841v1](http://arxiv.org/pdf/2509.00841v1)**
...
>
---
#### [new 142] DynaGuard: A Dynamic Guardrail Model With User-Defined Policies
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出动态守卫模型DynaGuard，解决现有模型无法处理用户自定义策略的问题。通过结合用户定义政策，实现对自由形式违规的高效检测，兼顾准确性和速度。**

- **链接: [http://arxiv.org/pdf/2509.02563v1](http://arxiv.org/pdf/2509.02563v1)**
...
>
---
#### [new 143] Evaluating Cumulative Spectral Gradient as a Complexity Measure
- **分类: cs.LG; cs.CL**

- **简介: 论文评估CSG作为知识图谱链接预测的复杂度度量，发现其对参数敏感且与性能指标相关性弱，通过实验揭示其局限性，呼吁更稳健的度量方法。**

- **链接: [http://arxiv.org/pdf/2509.02399v1](http://arxiv.org/pdf/2509.02399v1)**
...
>
---
#### [new 146] ArabEmoNet: A Lightweight Hybrid 2D CNN-BiLSTM Model with Attention for Robust Arabic Speech Emotion Recognition
...
>
---
#### [new 147] DTRNet: Dynamic Token Routing Network to Reduce Quadratic Costs in Transformers
- **分类: cs.LG; cs.CL**

- **简介: 论文提出DTRNet，通过动态路由减少Transformer中二次计算成本，保留MLP模块，显著降低FLOPs，提升长序列处理效率。**

- **链接: [http://arxiv.org/pdf/2509.00925v1](http://arxiv.org/pdf/2509.00925v1)**
...
>
---
#### [new 154] UI-TARS-2 Technical Report: Advancing GUI Agent with Multi-Turn Reinforcement Learning
- **分类: cs.AI; cs.CL; cs.CV; cs.HC**
...
>
---
#### [new 155] Towards High Data Efficiency in Reinforcement Learning with Verifiable Reward
- **分类: cs.LG; cs.CL**

- **简介: 论文提出DEPO框架，通过离线精选样本和在线动态筛选，结合回放机制，提升RLVR的数据效率，降低训练成本，在多个基准测试中表现优异。**

- **链接: [http://arxiv.org/pdf/2509.01321v1](http://arxiv.org/pdf/2509.01321v1)**
...
>
---
#### [new 156] Analysis of Error Sources in LLM-based Hypothesis Search for Few-Shot Rule Induction
- **分类: cs.AI; cs.CL; cs.LG; cs.NE**

- **简介: 论文研究LLM基于假设搜索的少样本规则归纳任务，对比LLM框架与直接生成方法，发现假设搜索表现接近人类而直接生成效果差，通过错误分析识别瓶颈并提出改进方向，强调LLM在归纳推理中的潜力及系统优化挑战。**

- **链接: [http://arxiv.org/pdf/2509.01016v1](http://arxiv.org/pdf/2509.01016v1)**
...
>
---
#### [new 159] Do Video Language Models Really Know Where to Look? Diagnosing Attention Failures in Video Language Models
...
>
---
#### [new 160] LLM-Assisted Iterative Evolution with Swarm Intelligence Toward SuperBrain
- **分类: cs.AI; cs.CL; 68T99; I.2.11; I.2.8; I.2.6**

- **简介: 该论文提出SuperBrain框架，通过LLM与人类用户共进化、群体智能协同优化，解决静态提示工程与孤立代理模拟的不足，实现可扩展、可解释的集体智能系统。**

- **链接: [http://arxiv.org/pdf/2509.00510v1](http://arxiv.org/pdf/2509.00510v1)**
...
>
---
#### [new 161] Understanding Space Is Rocket Science - Only Top Reasoning Models Can Solve Spatial Understanding Tasks
...
>
---
#### [new 162] FlashAdventure: A Benchmark for GUI Agents Solving Full Story Arcs in Diverse Adventure Games
...
>
---
#### [new 163] ChatCLIDS: Simulating Persuasive AI Dialogues to Promote Closed-Loop Insulin Adoption in Type 1 Diabetes Care
- **分类: cs.AI; cs.CL**

- **简介: 论文提出ChatCLIDS基准，评估LLM驱动的说服对话在促进T1DM患者采用CLIDS中的效果，解决低采用率问题，揭示LLM在应对社会压力时的局限性。**

- **链接: [http://arxiv.org/pdf/2509.00891v1](http://arxiv.org/pdf/2509.00891v1)**
...
>
---
#### [new 164] CSRM-LLM: Embracing Multilingual LLMs for Cold-Start Relevance Matching in Emerging E-commerce Markets
- **分类: cs.IR; cs.CL**

- **简介: 论文提出CSRM-LLM框架，利用多语言大模型解决新兴电商市场的冷启动相关匹配问题，通过跨语言迁移、查询增强与自蒸馏策略提升效果，实验证明有效并带来显著收益。**

- **链接: [http://arxiv.org/pdf/2509.01566v1](http://arxiv.org/pdf/2509.01566v1)**
...
>
---
#### [new 170] ShortageSim: Simulating Drug Shortages under Information Asymmetry
- **分类: cs.MA; cs.CL; cs.GT**

- **简介: 该论文提出ShortageSim框架，通过LLM模拟药品短缺场景下多方主体的有限理性决策，解决信息不对称导致的监管干预效果评估难题，分析FDA公告对供应链的影响并验证模型有效性。**

- **链接: [http://arxiv.org/pdf/2509.01813v1](http://arxiv.org/pdf/2509.01813v1)**
...
>
---
#### [new 171] Reinforced Visual Perception with Tools
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 172] VerlTool: Towards Holistic Agentic Reinforcement Learning with Tool Use
- **分类: cs.AI; cs.CL; cs.CV**
...
>
---
#### [new 173] Content and Engagement Trends in COVID-19 YouTube Videos: Evidence from the Late Pandemic
...
>
---
#### [new 177] Adaptive Monitoring and Real-World Evaluation of Agentic AI Systems
- **分类: cs.AI; cs.CL; cs.MA**

- **简介: 该论文提出AMDM算法，解决代理AI系统评估中技术指标主导、缺乏多维度实时监控的问题，通过自适应阈值和联合异常检测提升检测效率与准确性。**

- **链接: [http://arxiv.org/pdf/2509.00115v1](http://arxiv.org/pdf/2509.00115v1)**
...
>
---
#### [new 178] Pruning Weights but Not Truth: Safeguarding Truthfulness While Pruning LLMs
- **分类: cs.LG; cs.CL**

- **简介: 本论文针对LLM剪枝导致的真相检测能力下降问题，提出TPLO方法，通过保留关键激活特征提升剪枝模型的谎言检测性能，并优化TruthfulQA基准。**

- **链接: [http://arxiv.org/pdf/2509.00096v1](http://arxiv.org/pdf/2509.00096v1)**
...
>
---
#### [new 181] MixedG2P-T5: G2P-free Speech Synthesis for Mixed-script texts using Speech Self-Supervised Learning and Language Model
- **分类: eess.AS; cs.CL**

- **简介: 该论文提出MixedG2P-T5模型，利用语音自监督学习和语言模型，直接从混合脚本文本生成伪标签，替代传统G2P转换，实现无需手动音素转录的语音合成，提升效率与性能。**

- **链接: [http://arxiv.org/pdf/2509.01391v1](http://arxiv.org/pdf/2509.01391v1)**
...
>
---
#### [new 182] Ensemble Debates with Local Large Language Models for AI Alignment
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出通过本地开源LLM集合辩论提升AI对齐，解决依赖专有API的可重复性问题。实验显示集合模型在推理深度和论点质量上优于单模型，提供代码和数据集支持研究。**

- **链接: [http://arxiv.org/pdf/2509.00091v1](http://arxiv.org/pdf/2509.00091v1)**
...
>
---
#### [new 183] Oyster-I: Beyond Refusal -- Constructive Safety Alignment for Responsible Language Models
...
>
---
#### [new 184] L-MARS -- Legal Multi-Agent Workflow with Orchestrated Reasoning and Agentic Search
- **分类: cs.AI; cs.CL**

- **简介: 论文提出L-MARS系统，通过多智能体协作分解法律查询、跨源搜索与验证，解决法律问答中的幻觉与不确定性问题，提升事实准确性与可靠性。**

- **链接: [http://arxiv.org/pdf/2509.00761v1](http://arxiv.org/pdf/2509.00761v1)**
...
>
---
#### [new 185] GradeSQL: Outcome Reward Models for Ranking SQL Queries from Large Language Models
- **分类: cs.AI; cs.CL; cs.DB**

- **简介: 论文针对Text-to-SQL任务中复杂查询的意图与数据库对齐问题，提出基于语义正确性的ORMs框架，通过微调模型提升效果，在BIRD和SPIDER数据集上验证，ORMs优于传统方法，执行准确率提升显著。**

- **链接: [http://arxiv.org/pdf/2509.01308v1](http://arxiv.org/pdf/2509.01308v1)**
...
>
---
#### [new 186] Amplifying Emotional Signals: Data-Efficient Deep Learning for Robust Speech Emotion Recognition
...
>
---
#### [new 187] EigenBench: A Comparative Behavioral Measure of Value Alignment
- **分类: cs.AI; cs.CL; cs.CY; cs.LG**

- **简介: 论文提出EigenBench，通过模型间判断与EigenTrust算法，量化语言模型与价值宪法的对齐程度，解决价值对齐缺乏量化指标的问题，无需真实标签，揭示模型自身倾向。**

- **链接: [http://arxiv.org/pdf/2509.01938v1](http://arxiv.org/pdf/2509.01938v1)**
...
>
---
#### [new 188] Aligning Reasoning LLMs for Materials Discovery with Physics-aware Rejection Sampling
- **分类: cs.AI; cond-mat.mtrl-sci; cs.CL**

- **简介: 该论文针对材料发现中物理合理性和预测准确性不足的问题，提出Physics-aware Rejection Sampling方法，通过物理约束筛选推理轨迹，提升模型可靠性与效率。**

- **链接: [http://arxiv.org/pdf/2509.00768v1](http://arxiv.org/pdf/2509.00768v1)**
...
>
---
#### [new 189] Evaluating the Effectiveness of Transformer Layers in Wav2Vec 2.0, XLS-R, and Whisper for Speaker Identification Tasks
...
>
---
#### [new 190] MEPT: Mixture of Expert Prompt Tuning as a Manifold Mapper
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出MEPT框架，属于参数高效微调任务，旨在解决传统方法参数空间僵化问题。通过混合专家架构与提示调优，动态激活神经路径以适应非平稳数据分布，提升模型适应性。**

- **链接: [http://arxiv.org/pdf/2509.00996v1](http://arxiv.org/pdf/2509.00996v1)**
...
#### [replaced 001] On the Diagram of Thought
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2409.10038v4](http://arxiv.org/pdf/2409.10038v4)**
...
>
---
#### [replaced 002] Automated Essay Scoring Incorporating Annotations from Automated Feedback Systems
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.22771v2](http://arxiv.org/pdf/2505.22771v2)**
...
>
---
#### [replaced 003] Cross-Domain Transfer and Few-Shot Learning for Personal Identifiable Information Recognition
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.11862v2](http://arxiv.org/pdf/2507.11862v2)**

> **作者:** Junhong Ye; Xu Yuan; Xinying Qiu
>
> **备注:** To fix the performance summary statistics in Section 4
>
...
>
---
#### [replaced 004] A Multi-granularity Concept Sparse Activation and Hierarchical Knowledge Graph Fusion Framework for Rare Disease Diagnosis
- **分类: cs.AI; cs.CL; 68T50, 92C50, 68T05; J.3; I.2.7; H.3.3; I.2.1**

- **链接: [http://arxiv.org/pdf/2507.08529v3](http://arxiv.org/pdf/2507.08529v3)**
...
>
---
#### [replaced 008] Distill Visual Chart Reasoning Ability from LLMs to MLLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.18798v2](http://arxiv.org/pdf/2410.18798v2)**
...
>
---
#### [replaced 011] Guiding Large Language Models to Post-Edit Machine Translation with Error Annotations
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2404.07851v2](http://arxiv.org/pdf/2404.07851v2)**

> **作者:** Dayeon Ki; Marine Carpuat
>
> **备注:** NAACL 2024 Findings
>
> **摘要:** Machine Translation (MT) remains one of the last NLP tasks where large language models (LLMs) have not yet replaced dedicated supervised systems. This work exploits the complementary strengths of LLMs and supervised MT by guiding LLMs to automatically post-edit MT with external feedback on its quality, derived from Multidimensional Quality Metric (MQM) annotations. Working with LLaMA-2 models, we consider prompting strategies varying the nature of feedback provided and then fine-tune the LLM to improve its ability to exploit the provided guidance. Through experiments on Chinese-English, English-German, and English-Russian MQM data, we demonstrate that prompting LLMs to post-edit MT improves TER, BLEU and COMET scores, although the benefits of fine-grained feedback are not clear. Fine-tuning helps integrate fine-grained feedback more effectively and further improves translation quality based on both automatic and human evaluation.
>
---
#### [replaced 012] Persona Vectors: Monitoring and Controlling Character Traits in Language Models
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.21509v2](http://arxiv.org/pdf/2507.21509v2)**
...
>
---
#### [replaced 017] Advancing Grounded Multimodal Named Entity Recognition via LLM-Based Reformulation and Box-Based Segmentation
...
>
---
#### [replaced 018] Mirage or Method? How Model-Task Alignment Induces Divergent RL Conclusions
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.21188v2](http://arxiv.org/pdf/2508.21188v2)**
...
>
---
#### [replaced 021] Multilingual != Multicultural: Evaluating Gaps Between Multilingual Capabilities and Cultural Alignment in LLMs
- **分类: cs.CL; cs.AI; cs.CY**
...
>
---
#### [replaced 024] Towards Compute-Optimal Many-Shot In-Context Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.16217v2](http://arxiv.org/pdf/2507.16217v2)**
...
>
---
#### [replaced 025] Improving Informally Romanized Language Identification
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.21540v2](http://arxiv.org/pdf/2504.21540v2)**
...
>
---
#### [replaced 028] AskQE: Question Answering as Automatic Evaluation for Machine Translation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.11582v2](http://arxiv.org/pdf/2504.11582v2)**

> **作者:** Dayeon Ki; Kevin Duh; Marine Carpuat
>
> **备注:** ACL 2025 Findings
>
> **摘要:** How can a monolingual English speaker determine whether an automatic translation in French is good enough to be shared? Existing MT error detection and quality estimation (QE) techniques do not address this practical scenario. We introduce AskQE, a question generation and answering framework designed to detect critical MT errors and provide actionable feedback, helping users decide whether to accept or reject MT outputs even without the knowledge of the target language. Using ContraTICO, a dataset of contrastive synthetic MT errors in the COVID-19 domain, we explore design choices for AskQE and develop an optimized version relying on LLaMA-3 70B and entailed facts to guide question generation. We evaluate the resulting system on the BioMQM dataset of naturally occurring MT errors, where AskQE has higher Kendall's Tau correlation and decision accuracy with human ratings compared to other QE metrics.
>
---
#### [replaced 029] Multimodal LLMs Can Reason about Aesthetics in Zero-Shot
...
>
---
#### [replaced 030] Multiple LLM Agents Debate for Equitable Cultural Alignment
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24671v2](http://arxiv.org/pdf/2505.24671v2)**
...
>
---
#### [replaced 033] How Does Knowledge Selection Help Retrieval Augmented Generation?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.13258v4](http://arxiv.org/pdf/2410.13258v4)**
...
>
---
#### [replaced 034] Bias Analysis and Mitigation through Protected Attribute Detection and Regard Classification
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.14212v2](http://arxiv.org/pdf/2504.14212v2)**
...
>
---
#### [replaced 035] Conan: A Chunkwise Online Network for Zero-Shot Adaptive Voice Conversion
...
>
---
#### [replaced 036] MedVAL: Toward Expert-Level Medical Text Validation with Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.03152v3](http://arxiv.org/pdf/2507.03152v3)**
...
>
---
#### [replaced 037] A Computational Method for Measuring "Open Codes" in Qualitative Analysis
- **分类: cs.CL; cs.AI; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.12142v3](http://arxiv.org/pdf/2411.12142v3)**

> **作者:** John Chen; Alexandros Lotsos; Sihan Cheng; Caiyi Wang; Lexie Zhao; Jessica Hullman; Bruce Sherin; Uri Wilensky; Michael Horn
>
...
>
---
#### [replaced 038] LLM Assertiveness can be Mechanistically Decomposed into Emotional and Logical Components
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.17182v2](http://arxiv.org/pdf/2508.17182v2)**
...
>
---
#### [replaced 039] Explaining Length Bias in LLM-Based Preference Evaluations
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2407.01085v4](http://arxiv.org/pdf/2407.01085v4)**
...
>
---
#### [replaced 040] MMReview: A Multidisciplinary and Multimodal Benchmark for LLM-Based Peer Review Automation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.14146v2](http://arxiv.org/pdf/2508.14146v2)**
...
>
---
#### [replaced 041] From Tokens to Thoughts: How LLMs and Humans Trade Compression for Meaning
- **分类: cs.CL; cs.AI; cs.IT; math.IT**

- **链接: [http://arxiv.org/pdf/2505.17117v4](http://arxiv.org/pdf/2505.17117v4)**
...
>
---
#### [replaced 042] From Automation to Autonomy: A Survey on Large Language Models in Scientific Discovery
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.13259v2](http://arxiv.org/pdf/2505.13259v2)**
...
>
---
#### [replaced 043] A Survey on Vision-Language-Action Models for Embodied AI
...
>
---
#### [replaced 046] VPO: Aligning Text-to-Video Generation Models with Prompt Optimization
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 047] Quantifying Label-Induced Bias in Large Language Model Self- and Cross-Evaluations
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.21164v2](http://arxiv.org/pdf/2508.21164v2)**
...
>
---
#### [replaced 050] Semantic Parsing for Question Answering over Knowledge Graphs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2401.06772v3](http://arxiv.org/pdf/2401.06772v3)**

> **作者:** Sijia Wei; Wenwen Zhang; Qisong Li; Jiang Zhao
>
...
>
---
#### [replaced 051] FlairGPT: Repurposing LLMs for Interior Designs
...
>
---
#### [replaced 052] Should I Share this Translation? Evaluating Quality Feedback for User Reliance on Machine Translation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24683v2](http://arxiv.org/pdf/2505.24683v2)**
...
>
---
#### [replaced 057] Automatic Input Rewriting Improves Translation with Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.16682v3](http://arxiv.org/pdf/2502.16682v3)**

> **作者:** Dayeon Ki; Marine Carpuat
>
> **备注:** NAACL 2025
>
> **摘要:** Can we improve machine translation (MT) with LLMs by rewriting their inputs automatically? Users commonly rely on the intuition that well-written text is easier to translate when using off-the-shelf MT systems. LLMs can rewrite text in many ways but in the context of MT, these capabilities have been primarily exploited to rewrite outputs via post-editing. We present an empirical study of 21 input rewriting methods with 3 open-weight LLMs for translating from English into 6 target languages. We show that text simplification is the most effective MT-agnostic rewrite strategy and that it can be improved further when using quality estimation to assess translatability. Human evaluation further confirms that simplified rewrites and their MT outputs both largely preserve the original meaning of the source and MT. These results suggest LLM-assisted input rewriting as a promising direction for improving translations.
>
---
#### [replaced 058] Temporal Preference Optimization for Long-Form Video Understanding
...
>
---
#### [replaced 061] MedResearcher-R1: Expert-Level Medical Deep Researcher via A Knowledge-Informed Trajectory Synthesis Framework
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.14880v3](http://arxiv.org/pdf/2508.14880v3)**
...
>
---
#### [replaced 064] Injecting Domain-Specific Knowledge into Large Language Models: A Comprehensive Survey
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.10708v2](http://arxiv.org/pdf/2502.10708v2)**

> **作者:** Zirui Song; Bin Yan; Yuhan Liu; Miao Fang; Mingzhe Li; Rui Yan; Xiuying Chen
>
> **备注:** EMNLP 2025 findings
>
> **摘要:** Large Language Models (LLMs) have demonstrated remarkable success in various tasks such as natural language understanding, text summarization, and machine translation. However, their general-purpose nature often limits their effectiveness in domain-specific applications that require specialized knowledge, such as healthcare, chemistry, or legal analysis. To address this, researchers have explored diverse methods to enhance LLMs by integrating domain-specific knowledge. In this survey, we provide a comprehensive overview of these methods, which we categorize into four key approaches: dynamic knowledge injection, static knowledge embedding, modular adapters, and prompt optimization. Each approach offers unique mechanisms to equip LLMs with domain expertise, balancing trade-offs between flexibility, scalability, and efficiency. We discuss how these methods enable LLMs to tackle specialized tasks, compare their advantages and disadvantages, evaluate domain-specific LLMs against general LLMs, and highlight the challenges and opportunities in this emerging field. For those interested in delving deeper into this area, we also summarize the commonly used datasets and benchmarks. To keep researchers updated on the latest studies, we maintain an open-source at: https://github.com/abilliyb/Knowledge_Injection_Survey_Papers, dedicated to documenting research in the field of specialized LLM.
>
---
#### [replaced 065] MEGen: Generative Backdoor into Large Language Models via Model Editing
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2408.10722v2](http://arxiv.org/pdf/2408.10722v2)**
...
>
---
#### [replaced 068] SparK: Query-Aware Unstructured Sparsity with Recoverable KV Cache Channel Pruning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.15212v2](http://arxiv.org/pdf/2508.15212v2)**
...
>
---
#### [replaced 071] Auto prompt sql: a resource-efficient architecture for text-to-sql translation in constrained environments
- **分类: cs.CL; cs.AI; 68T50**

- **链接: [http://arxiv.org/pdf/2506.03598v3](http://arxiv.org/pdf/2506.03598v3)**
...
>
---
#### [replaced 072] SETS: Leveraging Self-Verification and Self-Correction for Improved Test-Time Scaling
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2501.19306v4](http://arxiv.org/pdf/2501.19306v4)**
...
>
---
#### [replaced 073] Token Assorted: Mixing Latent and Text Tokens for Improved Language Model Reasoning
- **分类: cs.CL; cs.AI; cs.LG; cs.LO**

- **链接: [http://arxiv.org/pdf/2502.03275v2](http://arxiv.org/pdf/2502.03275v2)**

> **作者:** DiJia Su; Hanlin Zhu; Yingchen Xu; Jiantao Jiao; Yuandong Tian; Qinqing Zheng
>
> **摘要:** Large Language Models (LLMs) excel at reasoning and planning when trained on chainof-thought (CoT) data, where the step-by-step thought process is explicitly outlined by text tokens. However, this results in lengthy inputs where many words support textual coherence rather than core reasoning information, and processing these inputs consumes substantial computation resources. In this work, we propose a hybrid representation of the reasoning process, where we partially abstract away the initial reasoning steps using latent discrete tokens generated by VQ-VAE, significantly reducing the length of reasoning traces. We explore the use of latent trace abstractions in two scenarios: 1) training the model from scratch for the Keys-Finding Maze problem, 2) fine-tuning LLMs on this hybrid data with an extended vocabulary including unseen latent tokens, for both logical and mathematical reasoning problems. To facilitate effective learning, we introduce a simple training procedure that randomly mixes latent and text tokens, which enables fast adaptation to new latent tokens. Our approach consistently outperforms the baselines methods in various benchmarks.
>
---
#### [replaced 074] Can Large Language Models be Effective Online Opinion Miners?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.15695v2](http://arxiv.org/pdf/2505.15695v2)**
...
>
---
#### [replaced 075] ObjexMT: Objective Extraction and Metacognitive Calibration for LLM-as-a-Judge under Multi-Turn Jailbreaks
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.16889v2](http://arxiv.org/pdf/2508.16889v2)**
...
> **备注:** ACL 2025 (main)
>
> **摘要:** Given the increasing use of synthetic data in language model (LM) post-training, an LM's ability to generate high-quality data has become nearly as crucial as its ability to solve problems directly. While prior works have focused on developing effective data generation methods, they lack systematic comparison of different LMs as data generators in a unified setting. To address this gap, we propose AgoraBench, a benchmark that provides standardized settings and metrics to evaluate LMs' data generation abilities. Through synthesizing 1.26 million training instances using 6 LMs and training 99 student models, we uncover key insights about LMs' data generation capabilities. First, we observe that LMs exhibit distinct strengths. For instance, GPT-4o excels at generating new problems, while Claude-3.5-Sonnet performs better at enhancing existing ones. Furthermore, our analysis reveals that an LM's data generation ability doesn't necessarily correlate with its problem-solving ability. Instead, multiple intrinsic features of data quality-including response quality, perplexity, and instruction difficulty-collectively serve as better indicators. Finally, we demonstrate that strategic choices in output format and cost-conscious model selection significantly impact data generation effectiveness.
>
---
#### [replaced 078] Designing across domains with declarative thinking: Insights from the 96-Eyes ptychographic imager project
- **分类: physics.optics; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.18512v2](http://arxiv.org/pdf/2508.18512v2)**

> **作者:** Antony C Chan
>
> **备注:** Minor changes: resolve HTML rendering issues of sideways tables; Code listing in dark mode. Cite three more journal articles
>
...
>
---
#### [replaced 079] How Can I Publish My LLM Benchmark Without Giving the True Answers Away?
- **分类: cs.LG; cs.AI; cs.CL; stat.ME**

- **链接: [http://arxiv.org/pdf/2505.18102v4](http://arxiv.org/pdf/2505.18102v4)**
...
>
---
#### [replaced 080] Text Meets Topology: Rethinking Out-of-distribution Detection in Text-Rich Networks
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.17690v2](http://arxiv.org/pdf/2508.17690v2)**
...
>
---
#### [replaced 081] Rule-Guided Joint Embedding Learning over Knowledge Graphs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2401.02968v3](http://arxiv.org/pdf/2401.02968v3)**

> **作者:** Qisong Li; Ji Lin; Sijia Wei; Neng Liu
>
...
>
---
#### [replaced 082] Enhancing Cryptocurrency Sentiment Analysis with Multimodal Features
- **分类: cs.CL; q-fin.ST**

- **链接: [http://arxiv.org/pdf/2508.15825v2](http://arxiv.org/pdf/2508.15825v2)**
...
>
---
#### [replaced 083] A Structured Bangla Dataset of Disease-Symptom Associations to Improve Diagnostic Accuracy
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.13610v4](http://arxiv.org/pdf/2506.13610v4)**
...
>
---
#### [replaced 084] CRMAgent: A Multi-Agent LLM System for E-Commerce CRM Message Template Generation
- **分类: cs.CL; cs.MA**

- **链接: [http://arxiv.org/pdf/2507.08325v2](http://arxiv.org/pdf/2507.08325v2)**
...
>
---
#### [replaced 085] A Markov Categorical Framework for Language Modeling
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.19247v2](http://arxiv.org/pdf/2507.19247v2)**
...
>
---
#### [replaced 090] Towards a cognitive architecture to enable natural language interaction in co-constructive task learning
...
>
---
#### [replaced 091] Language Models and Logic Programs for Trustworthy Financial Reasoning
- **分类: cs.CL; cs.AI; cs.CY**
...
>
---
#### [replaced 092] Learning to (Learn at Test Time): RNNs with Expressive Hidden States
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2407.04620v4](http://arxiv.org/pdf/2407.04620v4)**
...
>
---
#### [replaced 094] When Thinking Fails: The Pitfalls of Reasoning for Instruction-Following in LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.11423v3](http://arxiv.org/pdf/2505.11423v3)**
...
>
---
#### [replaced 095] Inclusion Arena: An Open Platform for Evaluating Large Foundation Models with Real-World Apps
- **分类: cs.AI; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2508.11452v2](http://arxiv.org/pdf/2508.11452v2)**
...
>
---
#### [replaced 096] StoryReasoning Dataset: Using Chain-of-Thought for Scene Understanding and Grounded Story Generation
...
>
---
#### [replaced 097] Label Unification for Cross-Dataset Generalization in Cybersecurity NER
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.13870v2](http://arxiv.org/pdf/2507.13870v2)**
...
>
---
#### [replaced 098] A Comprehensive Survey of Self-Evolving AI Agents: A New Paradigm Bridging Foundation Models and Lifelong Agentic Systems
- **分类: cs.AI; cs.CL; cs.MA**

- **链接: [http://arxiv.org/pdf/2508.07407v2](http://arxiv.org/pdf/2508.07407v2)**
...
>
---
#### [replaced 099] Re-Representation in Sentential Relation Extraction with Sequence Routing Algorithm
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.21049v2](http://arxiv.org/pdf/2508.21049v2)**
...
>
---
#### [replaced 100] Unmasking Deceptive Visuals: Benchmarking Multimodal Large Language Models on Misleading Chart Question Answering
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.18172v4](http://arxiv.org/pdf/2503.18172v4)**

> **作者:** Zixin Chen; Sicheng Song; Kashun Shum; Yanna Lin; Rui Sheng; Huamin Qu
>
> **备注:** 30 pages in total. EMNLP 2025 Main
>
...
>
---
#### [replaced 103] Continuously Steering LLMs Sensitivity to Contextual Knowledge with Proxy Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19720v3](http://arxiv.org/pdf/2508.19720v3)**
...
>
---
#### [replaced 106] CytoDiff: AI-Driven Cytomorphology Image Synthesis for Medical Diagnostics
...
>
---
#### [replaced 107] Bottom-up Domain-specific Superintelligence: A Reliable Knowledge Graph is What We Need
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.13966v2](http://arxiv.org/pdf/2507.13966v2)**
...
>
---
#### [replaced 111] MAQuA: Adaptive Question-Asking for Multidimensional Mental Health Screening using Item Response Theory
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.07279v2](http://arxiv.org/pdf/2508.07279v2)**
...
>
---
#### [replaced 115] Building Self-Evolving Agents via Experience-Driven Lifelong Learning: A Framework and Benchmark
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19005v2](http://arxiv.org/pdf/2508.19005v2)**
...
>
---
#### [replaced 116] Search and Refine During Think: Autonomous Retrieval-Augmented Reasoning of LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.11277v4](http://arxiv.org/pdf/2505.11277v4)**
...
>
---
#### [replaced 117] Exploring Response Uncertainty in MLLMs: An Empirical Evaluation under Misleading Scenarios
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2411.02708v2](http://arxiv.org/pdf/2411.02708v2)**
...
>
---
#### [replaced 118] LLMEval-Med: A Real-world Clinical Benchmark for Medical LLMs with Physician Validation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.04078v3](http://arxiv.org/pdf/2506.04078v3)**
...
>
---
#### [replaced 119] SpatialViz-Bench: An MLLM Benchmark for Spatial Visualization
...
>
---
#### [replaced 120] Weakly Supervised Fine-grained Span-Level Framework for Chinese Radiology Report Quality Assurance
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.08876v2](http://arxiv.org/pdf/2508.08876v2)**
...
>
---
#### [replaced 121] Instruction Tuning on Public Government and Cultural Data for Low-Resource Language: a Case Study in Kazakh
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.13647v2](http://arxiv.org/pdf/2502.13647v2)**
...
>
---
#### [replaced 125] Opportunities and Challenges of Large Language Models for Low-Resource Languages in Humanities Research
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2412.04497v3](http://arxiv.org/pdf/2412.04497v3)**

> **作者:** Tianyang Zhong; Zhenyuan Yang; Zhengliang Liu; Ruidong Zhang; Yiheng Liu; Haiyang Sun; Yi Pan; Yiwei Li; Yifan Zhou; Hanqi Jiang; Junhao Chen; Tianming Liu
>
...
>
---
#### [replaced 126] MetaAgent: Toward Self-Evolving Agent via Tool Meta-Learning
- **分类: cs.AI; cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2508.00271v2](http://arxiv.org/pdf/2508.00271v2)**
...
>
---
#### [replaced 134] Affective Polarization across European Parliaments
- **分类: cs.CL; cs.SI**

- **链接: [http://arxiv.org/pdf/2508.18916v2](http://arxiv.org/pdf/2508.18916v2)**
...
>
---
#### [replaced 135] ExCyTIn-Bench: Evaluating LLM agents on Cyber Threat Investigation
- **分类: cs.CR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.14201v2](http://arxiv.org/pdf/2507.14201v2)**
...
>
---
#### [replaced 136] DivScene: Towards Open-Vocabulary Object Navigation with Large Vision Language Models in Diverse Scenes
...
>
---
#### [replaced 139] Cross-Modal Adapter for Vision-Language Retrieval
- **分类: cs.CV; cs.AI; cs.CL**
