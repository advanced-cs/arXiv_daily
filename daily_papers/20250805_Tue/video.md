...
- **简介: 该论文属于跨模态多任务学习任务，旨在解决工业视觉检测中传统模型效率与鲁棒性的矛盾。通过构建InspectVLM，在保持视觉信息的同时提升语言驱动架构的泛化能力，优化了关键指标（如分类精度、关键点定位），解决了低提示波动下的行为偏差问题。**
...
- **简介: 该论文旨在解决多模态媒体操控检测与定位任务，通过引入多模态可靠性监督、单模态内部监督和跨模态监督等技术，构建了FMS网络，有效解决了传统方法因忽略误判干扰和缺乏全面监督而导致的性能不足问题。**
...
- **简介: 该论文属于计算机视觉任务，旨在解决基于生成模型的图像检测泛化能力不足的问题。提出NS-Net框架，通过NULL-Space投影分离语义信息、对比学习捕捉分布差异、Patch Selection优化细节特征，实验表明其在7.4%精度提升下达到良好泛化效果。**
...
- **简介: 该论文旨在解决3D物体触觉区域预测中的通用知识捕捉问题，通过引入文本到图像扩散模型构建DAG框架，开发多源解耦结构与多模态解码器，实现了开放世界泛化和3D密集视觉感知任务。**
...
- **简介: 该论文旨在解决3D胸部CT扫描中多标签异常分类的问题，通过引入结构化图神经网络提升模型泛化能力与性能，克服传统CNN/Transformer的长距离依赖不足及计算成本问题。**
...
- **简介: 该论文旨在解决3DGS中因标签噪声导致的重建误差问题，提出OCSplats框架结合混合噪声评估与动态锚点方法，提升噪声分类精度并实现场景适应性优化。**
...
- **简介: 该论文研究了如何通过进化算法优化预训练视觉语言模型（VLM）的适应过程，解决了传统人工设计方法效率低的问题，提出了一种基于特征选择与逻辑计算的两阶段进化算法，并结合低精度代码转换实现自动化优化。**
...
- **简介: 该论文提出参考音频视频分割（Ref-AVS）任务，旨在通过结构化推理与强化学习提升模型对语义的理解能力。解决了现有方法依赖固定模式、像素精度不足等问题，创新性地设计了结构化CoT提示机制和分层损失融合训练策略，并结合纠正反射式训练与GRPO强化学习提升鲁棒性，实现了最优性能。**
...
- **简介: 该论文旨在解决文本描述生成与真实人体运动序列合成的挑战，通过整合Bidirectional Momentum Text-Motion模型、Semantic Spatio-temporal注意力机制和RAG-Free指导，构建高效统一框架ReMoMask，显著提升了FID分数并超越当前SOTA方法。**
...
- **简介: 该论文提出了一种基于毫米波雷达与相机融合的多模态方法，旨在解决植物叶湿程度检测中的标准化缺失和环境适应性问题。通过构建CNN和Transformer编码器进行特征融合，并采用FMCW雷达技术验证其性能，实现96%以上的准确率，在不同光照条件下仍保持约90%的检测效果。**
...
- **简介: 该论文研究了基于深度引导的Gaussian采样方法，解决了传统对象中心框架在单张图像中的效率低下和噪声引入问题。通过深度分支结合GMF模块与DGA等技术，提升了语义场景完整性和计算效率。**
...
- **简介: 该论文提出了一种**spatio-temporal连续网络（STCN）**，用于解决连续时间动态学习与随机运动序列预测的问题，通过引入锚点集缓解模式坍缩并利用GMM分布建模观测序列，实现了人类动作的高多样性和准确性。**
...
- **简介: 该论文旨在开发基于深度学习的DICOM医学图像脱敏算法，解决医疗图像数据中个人身份信息（PII/PHI）的隐私保护问题，通过安全港方法结合可定制输入参数实现高效分类与脱敏。**
...
- **简介: 该论文提出了一种基于状态空间模型的镜头模糊去除方法，解决了上下文不一致的问题，通过层次结构捕捉像素相关性并增强局部细节。**
...
- **简介: 该论文属于Embodied AI研究领域，旨在解决3D物体可操作性（affordance）的多任务学习问题，通过多尺度交叉模态表示学习融合图像与3D数据，构建跨任务耦合的2阶段推理机制，有效提升对象定位与功能分类能力。**
...
- **简介: 该论文提出一种语言-窗口结合的可控二分图像分割框架（LawDIS），通过将传统DIS任务映射到扩散模型中，实现宏（语言控制）和微（窗口控制）模式切换，显著提升高精度和个性化应用效果。**
...
- **简介: 该论文提出了一种基于Vision Transformers（ViTs）的医学影像任务，用于glioblastoma整体生存率预测。通过直接从MRI图像提取特征，解决了肿瘤分割问题，验证了其在BRATS数据集上的有效性，达到了62.5%的准确率，并提升了模型泛化能力。**
...
- **简介: 该论文旨在解决传统unsupervised stereo匹配中的歧义与效率问题，提出基于3D几何知识的插件式方法，通过局部一致性检查、准密集对应构建和双损失函数优化，实现了高精度的立体匹配。**
...
- **简介: 该论文旨在解决跨域立体匹配（Domain-agnostic Stereo Matching）中的泛化不足问题，提出一种基于不确定性引导的数据增强（UgDA）方法，通过扩展训练域并利用RGB空间统计信息生成样本，同时引入结构一致性和不确定性建模，提升模型对不同领域的适应能力。**
...
- **简介: 该论文提出E-VRAG框架，解决视频RAG任务中的计算效率与准确性不足问题。通过预处理消除冗余帧、采用轻量VLM和全局统计框架提升性能，有效平衡检索与生成效率。**
...
- **简介: 该论文属于多模态生成式AI图像检测任务，旨在解决传统方法因新生成模型特征重叠导致的泛化能力不足问题。通过构建跨类特征分离框架并结合CLIP的多模态提示机制，创新性地实现了生成模型的鲁棒性增强。**
...
- **简介: 该论文旨在评估多模态大语言模型在视觉问答（VQA）任务中的性能变异性，分析训练种子、框架非确定性等因素对模型表现的影响，并探讨Cloze式评估策略以减少随机性，揭示现有评价方法的局限性并提出优化方向。**
...
- **简介: 该论文提出了一种实时、物理合理的人类-机器人交互框架（Human-X），解决了动态交互中响应延迟、物理不现实与安全性问题。通过联合预测动作与反应并利用强化学习训练的运动跟踪策略，在保证同步性与安全性的前提下提升交互质量。**
...
- **简介: 该论文属于零样本动作识别任务，解决未见过的动宾组合识别问题，通过引入逻辑驱动的约束（显式与隐式）提升模型的结构与语义建模能力，构建LogicCAR框架并验证其有效性。**
...
- **简介: 该论文旨在解决传统深度神经网络（DNN）由于梯度优化导致的权重结构不规整问题，提出Eigen Neural Network（ENN），通过层共享、可对齐的正交基重构权重，实现更高效的特征表示和非退化学习，显著提升图像分类和跨模态检索性能。**
...
- **简介: 该论文旨在解决无人机拍摄视频中多目标跟踪的稳定性与准确性问题，通过联合利用出现-运动一致性矩阵（AMC）和运动感知延续模块（MTC），创新性地整合空间时序交互，显著提升了跟踪鲁棒性和泛化能力。**
...
- **简介: 该论文研究了电商场景下的图像背景补全任务，解决了保持产品一致性与融合视觉信息的问题，提出了基于文本提示和参考图信息的DreamPainter框架，显著提升了性能。**
...
- **简介: 该论文提出了一种基于多模态融合的自适应LiDAR扫描方法，通过预测历史信息提升3D物体检测效率，解决了传统密集扫描带来的冗余与高功耗问题。**
...
>
---
#### [new 063] SBP-YOLO:A Lightweight Real-Time Model for Detecting Speed Bumps and Potholes
- **分类: cs.CV; cs.AI; 68T45; I.4.8; C.3**

- **简介: 该论文提出SBP-YOLO，针对新能车行驶中速度坑和水洼检测任务，通过YOLOv11优化框架结合GhostConv、VoVGSCSPC等技术，采用混合训练策略提升检测鲁棒性，实现87.0% mAP和139.5 FPS实测性能，验证其适用于智能悬挂系统的实时检测任务。**

- **链接: [http://arxiv.org/pdf/2508.01339v1](http://arxiv.org/pdf/2508.01339v1)**
...
>
---
#### [new 066] Zero-shot Segmentation of Skin Conditions: Erythema with Edit-Friendly Inversion
- **分类: cs.CV**

- **简介: 该研究提出了一种零样本皮肤病变检测框架，旨在通过生成编辑合成无红斑参考图并结合颜色空间分析实现红斑识别，解决了传统标注数据依赖问题，实现了高效诊断支持。**

- **链接: [http://arxiv.org/pdf/2508.01334v1](http://arxiv.org/pdf/2508.01334v1)**
...
>
---
#### [new 067] SoccerTrack v2: A Full-Pitch Multi-View Soccer Dataset for Game State Reconstruction
- **分类: cs.CV**

- **简介: 该论文旨在构建全视角足球数据分析任务的多模态数据集，解决从视频中提取游戏状态和球员动作的问题，通过10个全景4K视频和12类动作标签实现高质量标注与训练。**

- **链接: [http://arxiv.org/pdf/2508.01802v1](http://arxiv.org/pdf/2508.01802v1)**

> **作者:** Atom Scott; Ikuma Uchida; Kento Kuroda; Yufi Kim; Keisuke Fujii
>
> **备注:** 4 pages, 1 figure. Dataset and code available at https://github.com/AtomScott/SoccerTrack-v2 and https://huggingface.co/datasets/atomscott/soccertrack-v2. Preliminary paper for dataset release
>
> **摘要:** SoccerTrack v2 is a new public dataset for advancing multi-object tracking (MOT), game state reconstruction (GSR), and ball action spotting (BAS) in soccer analytics. Unlike prior datasets that use broadcast views or limited scenarios, SoccerTrack v2 provides 10 full-length, panoramic 4K recordings of university-level matches, captured with BePro cameras for complete player visibility. Each video is annotated with GSR labels (2D pitch coordinates, jersey-based player IDs, roles, teams) and BAS labels for 12 action classes (e.g., Pass, Drive, Shot). This technical report outlines the datasets structure, collection pipeline, and annotation process. SoccerTrack v2 is designed to advance research in computer vision and soccer analytics, enabling new benchmarks and practical applications in tactical analysis and automated tools.
>
---
#### [new 068] Predicting Video Slot Attention Queries from Random Slot-Feature Pairs
- **分类: cs.CV**

- **简介: 该论文提出了一种改进的Unsupervised视频OCL方法，旨在预测视频中slot-feature间的注意力查询。通过设计新过渡器并利用随机采样的slot-feature对训练，解决了传统方法忽略下一帧信息和学习过渡动态的问题，实验表明其在对象发现和下游任务中优于现有方法，具有潜在应用价值。**

- **链接: [http://arxiv.org/pdf/2508.01345v1](http://arxiv.org/pdf/2508.01345v1)**
...
>
---
#### [new 075] After the Party: Navigating the Mapping From Color to Ambient Lighting
- **分类: cs.CV**

- **简介: 该论文旨在解决复杂光照映射中的反射与阴影问题，提出CL3AN数据集及学习框架，通过分解色度与亮度信息提升鲁棒性，优化非均匀光照下的图像修复效果。**

- **链接: [http://arxiv.org/pdf/2508.02168v1](http://arxiv.org/pdf/2508.02168v1)**
...
>
---
#### [new 076] Uncertainty-Aware Segmentation Quality Prediction via Deep Learning Bayesian Modeling: Comprehensive Evaluation and Interpretation on Skin Cancer and Liver Segmentation
- **分类: cs.CV**

- **简介: 该论文旨在解决医学图像分割中缺乏标注数据时评估质量的挑战，提出通过贝叶斯建模整合不确定性估计的方法，结合预测分割与不确定性图，构建了跨模态评估框架，提升了分割质量的可靠性与鲁棒性。**

- **链接: [http://arxiv.org/pdf/2508.01460v1](http://arxiv.org/pdf/2508.01460v1)**
...
>
---
#### [new 077] S-RRG-Bench: Structured Radiology Report Generation with Fine-Grained Evaluation Framework
- **分类: cs.CV**

- **简介: 该论文旨在解决传统自由文本报告生成中冗余与临床细节缺失的问题，提出基于LLM的S-RRG框架并创新性设计S-Score评估指标，实现结构化报告生成与高质量临床决策支持。**

- **链接: [http://arxiv.org/pdf/2508.02082v1](http://arxiv.org/pdf/2508.02082v1)**
...
>
---
#### [new 078] Personalized Safety Alignment for Text-to-Image Diffusion Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文旨在解决文本到图像扩散模型在安全性约束上的不足，通过个性化安全对齐框架PSA，结合用户画像与跨注意力机制，提升有害内容抑制效果并增强生成内容与用户需求的契合度。**

- **链接: [http://arxiv.org/pdf/2508.01151v1](http://arxiv.org/pdf/2508.01151v1)**
...
>
---
#### [new 079] Raw Data Matters: Enhancing Prompt Tuning by Internal Augmentation on Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文旨在解决基于CLIP的提示微调中依赖外部知识带来的成本高与特征利用不足的问题，提出AugPT通过内部增强策略（自监督训练）和共识机制优化模型泛化能力，有效提升模型性能并减少额外数据需求。**

- **链接: [http://arxiv.org/pdf/2508.02671v1](http://arxiv.org/pdf/2508.02671v1)**
...
>
---
#### [new 080] Benefits of Feature Extraction and Temporal Sequence Analysis for Video Frame Prediction: An Evaluation of Hybrid Deep Learning Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文评估了混合深度学习模型（结合autoencoders与RNN/3D CNN）用于视频帧预测的任务，解决了传统模型在精度和泛化性上的不足问题，通过对比实验验证了3D CNN在SSIM指标上的优势，适用于实时视频压缩与流媒体场景。**

- **链接: [http://arxiv.org/pdf/2508.00898v1](http://arxiv.org/pdf/2508.00898v1)**
...
>
---
#### [new 091] Enhancing Zero-Shot Brain Tumor Subtype Classification via Fine-Grained Patch-Text Alignment
- **分类: cs.CV**

- **简介: 该论文旨在提升零样本脑瘤亚型分类能力，解决细粒度特征捕捉与标注数据稀缺问题，通过融合视觉语言模型的局部特征和文本描述模块，显著增强分类鲁棒性。**

- **链接: [http://arxiv.org/pdf/2508.01602v1](http://arxiv.org/pdf/2508.01602v1)**
...
>
---
#### [new 092] TESPEC: Temporally-Enhanced Self-Supervised Pretraining for Event Cameras
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究了事件相机任务中长时信息的重要性，提出TESPEC框架用于自监督预训练，通过长序列事件处理和时空建模，解决了传统方法忽略事件时序问题，显著提升下游任务性能（如检测、分割和深度估计）。**

- **链接: [http://arxiv.org/pdf/2508.00913v1](http://arxiv.org/pdf/2508.00913v1)**
...
>
---
#### [new 096] MASIV: Toward Material-Agnostic System Identification from Videos
- **分类: cs.CV**

- **简介: 该论文提出MASIV，旨在实现材料无关的系统识别，解决传统方法依赖预设材料假设的问题。通过学习可微材料模型和重建连续粒子轨迹，克服了缺乏完整物理状态带来的优化不稳定和物理不合理的挑战，实现了高精度、高质量和泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.01112v1](http://arxiv.org/pdf/2508.01112v1)**
...
>
---
#### [new 098] Semi-Supervised Anomaly Detection in Brain MRI Using a Domain-Agnostic Deep Reinforcement Learning Approach
- **分类: cs.CV**

- **简介: 该论文提出了一种基于领域无关的半监督深度强化学习框架，用于脑MRI异常检测，解决了大规模数据、过拟合和类别不平衡问题，整合了特征表示与DRL技术，在T1/T2影像上验证了其性能，实现了88.7%（像素级）至96.7%的AUROC，工业数据也表现出优异表现，表明其具有跨领域通用性和高效性。**

- **链接: [http://arxiv.org/pdf/2508.01137v1](http://arxiv.org/pdf/2508.01137v1)**
...
>
---
#### [new 102] StreamAgent: Towards Anticipatory Agents for Streaming Video Understanding
- **分类: cs.CV**

- **简介: 该论文提出了一种面向实时视频理解的预测性代理StreamAgent，解决了传统方法在动态视频环境中缺乏连续感知与任务驱动规划的问题，通过预测关键事件时间空间特征、整合历史观察与问句信息，设计了流式KV缓存机制，提升了实时响应准确性和效率。**

- **链接: [http://arxiv.org/pdf/2508.01875v1](http://arxiv.org/pdf/2508.01875v1)**
...
>
---
#### [new 103] Simulated Ensemble Attack: Transferring Jailbreaks Across Fine-tuned Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文提出Simulated Ensemble Attack（SEA），旨在解决微调后的VLMs因继承原始模型漏洞而难以抵御的攻击问题，通过FTS模拟参数迁移和TPG引导输出，验证其在Qwen2-VL家族上的高成功率（>86.5%）及低毒性（<49.5%），填补了传统PGD攻击跨微调的空白，推动了模型安全防护的全面升级。**

- **链接: [http://arxiv.org/pdf/2508.01741v1](http://arxiv.org/pdf/2508.01741v1)**
...
>
---
#### [new 104] Medical Image De-Identification Resources: Synthetic DICOM Data and Tools for Validation
- **分类: cs.CV**

- **简介: 该论文旨在构建医学图像脱敏资源，解决隐私保护与数据完整性冲突，开发了含合成PHI/PII的DICOM数据集及评估框架，支持标准化验证流程以提升可信度。**

- **链接: [http://arxiv.org/pdf/2508.01889v1](http://arxiv.org/pdf/2508.01889v1)**
...
>
---
#### [new 110] HCF: Hierarchical Cascade Framework for Distributed Multi-Stage Image Compression
- **分类: cs.CV**

- **简介: 该论文提出Hierarchical Cascade Framework（HCF）解决分布式多阶段图像压缩中的变质量需求问题，通过政策驱动量化控制和边缘量化原理优化率-熵trade-off，实现高率-信噪比性能，并在Kodak、CLIC等数据集上优于现有方法，节省计算资源。**

- **链接: [http://arxiv.org/pdf/2508.02051v1](http://arxiv.org/pdf/2508.02051v1)**
...
>
---
#### [new 123] HateClipSeg: A Segment-Level Annotated Dataset for Fine-Grained Hate Video Detection
- **分类: cs.CV; cs.AI; cs.CV, cs.MM; I.2.10**

- **简介: The paper presents HateClipSeg, a dataset for fine-grained hate video detection, addressing multimodal content complexity and annotation gaps. It uses a three-stage annotation process to benchmark performance, including tasks like Hateful Video Classification, Localization, and Online Detection, highlighting the need for more sophisticated models.**

- **链接: [http://arxiv.org/pdf/2508.01712v1](http://arxiv.org/pdf/2508.01712v1)**
...
>
---
#### [new 124] ModelNet40-E: An Uncertainty-Aware Benchmark for Point Cloud Classification
- **分类: cs.CV**

- **简介: 该论文提出ModelNet40-E作为点云分类基准，旨在评估模型在合成LiDAR噪声下的鲁棒性与校准能力，通过引入高斯噪声参数实现点云与不确定性注释的联合评估，对比PointNet等模型的不确定性感知能力。**

- **链接: [http://arxiv.org/pdf/2508.01269v1](http://arxiv.org/pdf/2508.01269v1)**

> **作者:** Pedro Alonso; Tianrui Li; Chongshou Li
>
> **摘要:** We introduce ModelNet40-E, a new benchmark designed to assess the robustness and calibration of point cloud classification models under synthetic LiDAR-like noise. Unlike existing benchmarks, ModelNet40-E provides both noise-corrupted point clouds and point-wise uncertainty annotations via Gaussian noise parameters ({\sigma}, {\mu}), enabling fine-grained evaluation of uncertainty modeling. We evaluate three popular models-PointNet, DGCNN, and Point Transformer v3-across multiple noise levels using classification accuracy, calibration metrics, and uncertainty-awareness. While all models degrade under increasing noise, Point Transformer v3 demonstrates superior calibration, with predicted uncertainties more closely aligned with the underlying measurement uncertainty.
>
---
#### [new 125] StarPose: 3D Human Pose Estimation via Spatial-Temporal Autoregressive Diffusion
- **分类: cs.CV**

- **简介: 本研究旨在解决深度模糊与遮挡下的多模态人体姿态估计问题，提出基于自回归扩散的改进方法，通过整合历史预测和物理指导显著提升性能。**

- **链接: [http://arxiv.org/pdf/2508.02056v1](http://arxiv.org/pdf/2508.02056v1)**
...
>
---
#### [new 126] GMAT: Grounded Multi-Agent Clinical Description Generation for Text Encoder in Vision-Language MIL for Whole Slide Image Classification
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出了一种基于多智能体的临床描述生成框架（GMAT），解决传统LLMs生成描述不足和缺乏领域特性的问题，通过结合MIL与VLM，在WSI分类中提升了文本编码的表达能力与视觉特征匹配度，实现性能优化。**

- **链接: [http://arxiv.org/pdf/2508.01293v1](http://arxiv.org/pdf/2508.01293v1)**
...
>
---
#### [new 127] VPN: Visual Prompt Navigation
- **分类: cs.CV**

- **简介: 该论文提出Visual Prompt Navigation（VPN）任务，通过2D地图中的视觉提示引导非专家用户完成连续场景导航，解决语言引导导航的模糊性与冗余性问题，构建R2R-VP和R2R-CE-VP两个数据集，并设计VPNet网络结合视图/轨迹增强策略提升性能。**

- **链接: [http://arxiv.org/pdf/2508.01766v1](http://arxiv.org/pdf/2508.01766v1)**
...
>
---
#### [new 133] From Pixels to Places: A Systematic Benchmark for Evaluating Image Geolocalization Ability in Large Language Models
- **分类: cs.CV**

- **简介: 该论文旨在评估大语言模型（LLMs）在图像地标的性能差异，解决如何提高地理认知能力的问题，并通过 IMAGEO-Bench 基准测试其精度、偏差及推理能力。研究发现闭源模型在高资源地区表现更优，但存在地域偏倚，揭示了地理感知的关键特征。**

- **链接: [http://arxiv.org/pdf/2508.01608v1](http://arxiv.org/pdf/2508.01608v1)**
...
>
---
#### [new 142] IMoRe: Implicit Program-Guided Reasoning for Human Motion Q&A
- **分类: cs.CV**

- **简介: 该论文旨在解决传统人类动作问答系统中显式模块依赖导致的可扩展性与适应性不足问题，提出隐式程序引导推理框架IMoRe，通过结构化程序函数统一跨类型查询处理，并结合程序驱动的视觉信息提取机制实现高效运动场景问答。**

- **链接: [http://arxiv.org/pdf/2508.01984v1](http://arxiv.org/pdf/2508.01984v1)**
...
>
---
#### [new 144] StyDeco: Unsupervised Style Transfer with Distilling Priors and Semantic Decoupling
- **分类: cs.CV**

- **简介: 该论文提出了一种无监督风格迁移框架StyDeco，旨在解决文本描述与视觉风格之间语义缺失的问题。通过Prior-Guided Data Distillation（PGD）提取先验知识并利用冻结生成器自动合成伪对数据，结合Contrastive Semantic Decoupling（CSD）实现任务特定语义分组，有效提升风格迁移的忠实度和结构保留能力，支持脱风格化过程。**

- **链接: [http://arxiv.org/pdf/2508.01215v1](http://arxiv.org/pdf/2508.01215v1)**
...
>
---
#### [new 145] Dataset Condensation with Color Compensation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文旨在解决数据集压缩中性能与忠实度的矛盾，通过改进色彩丰富度提升表示学习效果，提出DC3框架并结合扩散模型增强颜色多样性，验证其优于现有方法且适用于下游任务。**

- **链接: [http://arxiv.org/pdf/2508.01139v1](http://arxiv.org/pdf/2508.01139v1)**
...
>
---
#### [new 148] CLIP-IN: Enhancing Fine-Grained Visual Understanding in CLIP via Instruction Editing Data and Long Captions
- **分类: cs.CV**

- **简介: 该论文旨在提升Vision-Language Models（VLMs）的细粒度视觉理解能力，解决传统方法在细节识别中的不足。通过引入指令编辑数据与长描述，结合对比学习机制，构建了CLIP-IN框架，有效增强了多模态信息整合并提升了推理能力。**

- **链接: [http://arxiv.org/pdf/2508.02329v1](http://arxiv.org/pdf/2508.02329v1)**
...
>
---
#### [new 149] Uni-Layout: Integrating Human Feedback in Unified Layout Generation and Evaluation
- **分类: cs.CV; cs.IR; cs.LG**

- **简介: 该论文提出**布局生成与评估一体化框架**，解决任务特定性与评价指标不一致的问题。通过统一生成、人类反馈建模和动态对齐优化，显著提升布局生成效果。**

- **链接: [http://arxiv.org/pdf/2508.02374v1](http://arxiv.org/pdf/2508.02374v1)**
...
>
---
#### [new 162] Benchmarking Adversarial Patch Selection and Location
- **分类: cs.CV; cs.CR; cs.LG**

- **简介: 该论文旨在评估对抗性特征图的选择与位置，并提出改进方法以增强模型防御能力。通过构建PatchMap基准测试，发现小特征图对模型置信度的影响，并利用遮罩引导策略提升攻击成功率。**

- **链接: [http://arxiv.org/pdf/2508.01676v1](http://arxiv.org/pdf/2508.01676v1)**
...
>
---
#### [new 163] YOLOv1 to YOLOv11: A Comprehensive Survey of Real-Time Object Detection Innovations and Challenges
- **分类: cs.CV**

- **简介: 该论文属于对象检测领域的实现实验综述，旨在分析YOLO家族模型的演变（从回归检测到多任务扩展），解决实时检测与跨领域应用问题，通过架构创新、性能优化及应用场景探讨，推动模型在工业、医疗等领域的落地与扩展。**

- **链接: [http://arxiv.org/pdf/2508.02067v1](http://arxiv.org/pdf/2508.02067v1)**
...
>
---
#### [new 166] The Promise of RL for Autoregressive Image Editing
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究了基于强化学习（RL）的自回归图像编辑方法，旨在提升多模态图像编辑任务的性能。通过构建统一的自回归多模态模型并结合大量训练数据，提出EARL，解决了传统方法依赖小规模数据的问题，实现了与强基线相当的效果。**

- **链接: [http://arxiv.org/pdf/2508.01119v1](http://arxiv.org/pdf/2508.01119v1)**
...
>
---
#### [new 167] CMIC: Content-Adaptive Mamba for Learned Image Compression
- **分类: cs.CV**

- **简介: 该论文提出**Content-Adaptive Mamba（CAM）**，用于图像压缩任务，解决传统Mamba因内容无关性导致的动态内容利用受限问题。通过动态内容感知token重组和全局前缀词优化，结合固定与自适应结构，实现高效率-失真性能提升，超越现有技术。**

- **链接: [http://arxiv.org/pdf/2508.02192v1](http://arxiv.org/pdf/2508.02192v1)**
...
>
---
#### [new 168] Beyond Vulnerabilities: A Survey of Adversarial Attacks as Both Threats and Defenses in Computer Vision Systems
- **分类: cs.CV; cs.AI; cs.CR**

- **简介: 该论文旨在系统分析对抗攻击的双重属性（威胁与防御），探索其在计算机视觉系统的演化路径与实际应用，重点研究其在生物识别和生成模型中的潜力，并指出相关研究的局限性。**

- **链接: [http://arxiv.org/pdf/2508.01845v1](http://arxiv.org/pdf/2508.01845v1)**
...
>
---
#### [new 169] ForenX: Towards Explainable AI-Generated Image Detection with Multimodal Large Language Models
- **分类: cs.CV**

- **简介: 该论文旨在解决AI生成图像真实性检测与解释性不足的问题，通过引入多模态LLM和定制化提示词提升检测精度与解释质量，构建 ForgReason 数据集以优化模型性能，并验证其在两个基准上的有效性。**

- **链接: [http://arxiv.org/pdf/2508.01402v1](http://arxiv.org/pdf/2508.01402v1)**
...
>
> **摘要:** Autonomous driving requires accurate scene understanding, including road geometry, traffic agents, and their semantic relationships. In online HD map generation scenarios, raster-based representations are well-suited to vision models but lack geometric precision, while graph-based representations retain structural detail but become unstable without precise maps. To harness the complementary strengths of both, we propose DiffSemanticFusion -- a fusion framework for multimodal trajectory prediction and planning. Our approach reasons over a semantic raster-fused BEV space, enhanced by a map diffusion module that improves both the stability and expressiveness of online HD map representations. We validate our framework on two downstream tasks: trajectory prediction and planning-oriented end-to-end autonomous driving. Experiments on real-world autonomous driving benchmarks, nuScenes and NAVSIM, demonstrate improved performance over several state-of-the-art methods. For the prediction task on nuScenes, we integrate DiffSemanticFusion with the online HD map informed QCNet, achieving a 5.1\% performance improvement. For end-to-end autonomous driving in NAVSIM, DiffSemanticFusion achieves state-of-the-art results, with a 15\% performance gain in NavHard scenarios. In addition, extensive ablation and sensitivity studies show that our map diffusion module can be seamlessly integrated into other vector-based approaches to enhance performance. All artifacts are available at https://github.com/SunZhigang7/DiffSemanticFusion.
>
---
#### [new 173] MonoDream: Monocular Vision-Language Navigation with Panoramic Dreaming
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于Vision-Language Navigation (VLN)任务，旨在解决单目视觉-语言导航中因传感器成本或数据获取限制导致的性能瓶颈。 MonoDream通过构建Unified Navigation Representation (UNR)整合视觉和语言信息，结合Latent Panoramic Dreaming (LPD)任务监督模型预测全景特征，显著提升单目环境下的导航能力。**

- **链接: [http://arxiv.org/pdf/2508.02549v1](http://arxiv.org/pdf/2508.02549v1)**
...
>
---
#### [new 189] EgoTrigger: Toward Audio-Driven Image Capture for Human Memory Enhancement in All-Day Energy-Efficient Smart Glasses
...
>
---
#### [new 197] AG$^2$aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
- **分类: cs.CV**

- **简介: 该论文提出AG$^2$aussian框架，解决3DGS中特征分割与选择不准确的问题，通过锚图结构优化Gaussian分布并实现图传播，提升实例级场景理解与编辑效果，适用于多种应用。**

- **链接: [http://arxiv.org/pdf/2508.01740v1](http://arxiv.org/pdf/2508.01740v1)**
...
>
---
#### [new 204] Conditional Diffusion Model with Anatomical-Dose Dual Constraints for End-to-End Multi-Tumor Dose Prediction
- **分类: cs.CV**

- **简介: 该论文提出了一种基于条件扩散的多靶向肿瘤剂量预测模型（ADDiff-Dose），解决了传统方法泛化性差、临床适用性弱的问题。通过引入轻量VAE3D压缩CT数据并集成多模态特征，结合复合损失函数优化性能，验证其在减少计划时间至22秒的同时显著提升剂量误差和临床合规性。**

- **链接: [http://arxiv.org/pdf/2508.02043v1](http://arxiv.org/pdf/2508.02043v1)**
...
>
---
#### [new 205] mmWave Radar-Based Non-Line-of-Sight Pedestrian Localization at T-Junctions Utilizing Road Layout Extraction via Camera
- **分类: cs.CV; cs.AI; cs.RO**

- **简介: 该论文旨在解决城市环境中非视线（NLoS）行人定位的挑战，通过将毫米波雷达与摄像头数据结合，利用道路布局提取进行空间重建，有效解决了多路径干扰和深度感知不足的问题。**

- **链接: [http://arxiv.org/pdf/2508.02348v1](http://arxiv.org/pdf/2508.02348v1)**
...
>
> **备注:** https://github.com/QwenLM/Qwen-Image
>
...
>
---
#### [new 224] Proactive Disentangled Modeling of Trigger-Object Pairings for Backdoor Defense
- **分类: cs.CV; cs.AI**

- **简介: 该论文旨在解决多触发器与未见配置下的backdoor攻击问题，提出DBOM框架通过结构化分层建模（VLM）分解输入特征并分离触发/物体，实现零样本泛化，显著提升DNN安全性。**

- **链接: [http://arxiv.org/pdf/2508.01932v1](http://arxiv.org/pdf/2508.01932v1)**
...
>
---
#### [new 225] Skip priors and add graph-based anatomical information, for point-based Couinaud segmentation
- **分类: cs.CV**

- **简介: 该论文提出了一种无需显性肝血管结构的点基Couinaud分割方法，通过添加图推理模块学习邻域关联以补充隐式解剖信息，解决了传统方法依赖显性结构的问题，与现有方法在Dice系数和平均表面距离等指标上表现优异。**

- **链接: [http://arxiv.org/pdf/2508.01785v1](http://arxiv.org/pdf/2508.01785v1)**
...
>
---
#### [new 232] ReCoSeg++:Extended Residual-Guided Cross-Modal Diffusion for Brain Tumor Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出了一种基于半监督和两阶段框架的脑肿瘤MRI分割方法，解决了在更大、更复杂的BraTS 2021数据集上的分割任务，通过残差引导DDPM和轻量级U-Net结合多模态信息提升性能，实现了更高的Dice和IoU指标。**

- **链接: [http://arxiv.org/pdf/2508.01058v1](http://arxiv.org/pdf/2508.01058v1)**
...
>
---
#### [new 242] OccamVTS: Distilling Vision Models to 1% Parameters for Time Series Forecasting
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究了视觉模型蒸馏技术，在时间序列预测任务中实现1%参数优化，通过交叉模态分析发现时间序列依赖低级纹理特征而非高阶语义，提出基于金字塔特征对齐和特征蒸馏的方法，有效提升预测性能并减少过拟合。**

- **链接: [http://arxiv.org/pdf/2508.01727v1](http://arxiv.org/pdf/2508.01727v1)**
...
>
---
#### [new 243] Sonify Anything: Towards Context-Aware Sonic Interactions in AR
...
>
---
#### [new 250] Uncertainty Estimation for Novel Views in Gaussian Splatting from Primitive-Based Representations of Error and Visibility
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出了一种基于原始误差和可见性的不确定性估计方法，解决了Gaussian Splatting中对新视图不确定性建模的问题。通过投影训练视图信息并进行像素级回归，实现了对新视图的不确定性特征提取与聚合，验证了其在前景物体识别中的优越性。**

- **链接: [http://arxiv.org/pdf/2508.02443v1](http://arxiv.org/pdf/2508.02443v1)**
...
>
---
#### [new 251] ScrewSplat: An End-to-End Method for Articulated Object Recognition
- **分类: cs.RO; cs.CV**

- **简介: 该论文旨在解决可移动物体的几何与运动关节识别问题，通过端到端方法结合Gaussian Splatting实现零样本训练，解决了传统方法依赖固定结构、输入需求等问题。**

- **链接: [http://arxiv.org/pdf/2508.02146v1](http://arxiv.org/pdf/2508.02146v1)**
...
>
---
#### [new 258] Towards Reliable Audio Deepfake Attribution and Model Recognition: A Multi-Level Autoencoder-Based Framework
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 259] CoCoLIT: ControlNet-Conditioned Latent Image Translation for MRI to Amyloid PET Synthesis
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文提出CoCoLIT（控制网络条件化隐空间翻译），解决MRI到Amyloid PET合成问题，通过改进权重图像空间损失和理论分析LAS技术，实现跨模态翻译优化，显著提升图像和病理分类性能（+10.5%）。**

- **链接: [http://arxiv.org/pdf/2508.01292v1](http://arxiv.org/pdf/2508.01292v1)**
...
>
---
#### [new 260] QuaDreamer: Controllable Panoramic Video Generation for Quadruped Robots
- **分类: cs.RO; cs.CV; eess.IV**

- **简介: 该论文旨在解决四足机器人全景视觉感知系统的训练数据不足问题，提出QuaDreamer作为首个面向四足平台的全景数据生成引擎，通过垂直抖动编码（VJE）、场景对象控制器（SOC）和全景增强器（PE）等技术，有效提升视频生成质量与下游任务性能，为多目标360度环境感知提供数据支持。**

- **链接: [http://arxiv.org/pdf/2508.02512v1](http://arxiv.org/pdf/2508.02512v1)**
...
>
---
#### [new 261] FairFedMed: Benchmarking Group Fairness in Federated Medical Imaging with FairLoRA
- **分类: cs.CY; cs.CV; cs.LG**

- **简介: 该论文旨在构建医疗领域联邦学习（FL）的公平性基准测试，解决医疗影像数据不均衡与跨机构协作中的公平性问题。通过设计FairFedMed数据集和FairLoRA框架，研究展示了基于低秩近似改进FL模型的公平性增强方案，验证其在医学图像分类中的性能提升及跨人群适应性。**
...
>
---
#### [new 262] A Survey on Deep Multi-Task Learning in Connected Autonomous Vehicles
- **分类: cs.RO; cs.CV; cs.LG**

- **简介: 该论文探讨了基于多任务学习（MTL）的CAV系统，旨在解决传统方法效率低、成本高、实时性差的问题，通过整合多个任务提升性能。**

- **链接: [http://arxiv.org/pdf/2508.00917v1](http://arxiv.org/pdf/2508.00917v1)**
...
>
---
#### [new 263] From Pixels to Pathology: Restoration Diffusion for Diagnostic-Consistent Virtual IHC
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出了一种端到端框架Star-Diff，旨在通过恢复H&E染色图像到IHC标本中以提高诊断一致性。其解决的问题在于传统方法缺乏对合成图像与IHC真实值的对比分析及翻译过程的结构保真性。工作包括构建基于残差和噪声的结构-aware生成模型，并设计Semantic Fidelity Score（SFS）指标来量化诊断相关性，实验表明在BCI数据集上实现了最先进的性能。**

- **链接: [http://arxiv.org/pdf/2508.02528v1](http://arxiv.org/pdf/2508.02528v1)**
...
>
---
#### [new 269] IMU: Influence-guided Machine Unlearning
- **分类: cs.LG; cs.CR; cs.CV**

- **简介: 该论文旨在解决深度学习模型在未授权访问训练数据时的隐私泄露问题，提出**影响引导型机器去模（IMU）**，通过梯度上升动态分配遗忘强度，实现保留数据集的无损去模，有效平衡隐私与模型性能。**

- **链接: [http://arxiv.org/pdf/2508.01620v1](http://arxiv.org/pdf/2508.01620v1)**
...
>
---
#### [new 272] ROVER: Recursive Reasoning Over Videos with Vision-Language Models for Embodied Tasks
...
>
---
#### [new 277] RL-U$^2$Net: A Dual-Branch UNet with Reinforcement Learning-Assisted Multimodal Feature Fusion for Accurate 3D Whole-Heart Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出了一种基于强化学习的双分支U-Net架构，解决了多模态3D心脏分割中的空间一致性、静态融合策略及特征对齐效率问题，通过交叉模态注意力和强化学习优化特征融合过程，实现了Dice系数93.1%（CT）和87.0%（MRI）。**

- **链接: [http://arxiv.org/pdf/2508.02557v1](http://arxiv.org/pdf/2508.02557v1)**
...
>
---
#### [replaced 005] SiM3D: Single-instance Multiview Multimodal and Multisetup 3D Anomaly Detection Benchmark
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21549v2](http://arxiv.org/pdf/2506.21549v2)**
...
>
---
#### [replaced 006] Long-tailed Adversarial Training with Self-Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.06461v2](http://arxiv.org/pdf/2503.06461v2)**
...
>
---
#### [replaced 007] Occlusion-Aware Temporally Consistent Amodal Completion for 3D Human-Object Interaction Reconstruction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.08137v2](http://arxiv.org/pdf/2507.08137v2)**
...
>
---
#### [replaced 010] Reconstructing 4D Spatial Intelligence: A Survey
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.21045v2](http://arxiv.org/pdf/2507.21045v2)**
...
>
---
#### [replaced 011] Shifting AI Efficiency From Model-Centric to Data-Centric Compression
- **分类: cs.CL; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.19147v2](http://arxiv.org/pdf/2505.19147v2)**
...
>
---
#### [replaced 012] Evaluating Deepfake Detectors in the Wild
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.21905v2](http://arxiv.org/pdf/2507.21905v2)**
...
>
---
#### [replaced 013] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.12799v2](http://arxiv.org/pdf/2504.12799v2)**
...
>
---
#### [replaced 015] Multi-Modal Semantic Parsing for the Interpretation of Tombstone Inscriptions
- **分类: cs.CV; cs.CL; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.04377v2](http://arxiv.org/pdf/2507.04377v2)**
...
>
---
#### [replaced 019] SplatTalk: 3D VQA with Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.06271v2](http://arxiv.org/pdf/2503.06271v2)**

> **作者:** Anh Thai; Songyou Peng; Kyle Genova; Leonidas Guibas; Thomas Funkhouser
>
> **备注:** Accepted at ICCV 2025
>
> **摘要:** Language-guided 3D scene understanding is important for advancing applications in robotics, AR/VR, and human-computer interaction, enabling models to comprehend and interact with 3D environments through natural language. While 2D vision-language models (VLMs) have achieved remarkable success in 2D VQA tasks, progress in the 3D domain has been significantly slower due to the complexity of 3D data and the high cost of manual annotations. In this work, we introduce SplatTalk, a novel method that uses a generalizable 3D Gaussian Splatting (3DGS) framework to produce 3D tokens suitable for direct input into a pretrained LLM, enabling effective zero-shot 3D visual question answering (3D VQA) for scenes with only posed images. During experiments on multiple benchmarks, our approach outperforms both 3D models trained specifically for the task and previous 2D-LMM-based models utilizing only images (our setting), while achieving competitive performance with state-of-the-art 3D LMMs that additionally utilize 3D inputs. Project website: https://splat-talk.github.io/
>
---
#### [replaced 020] Reinforcing VLMs to Use Tools for Detailed Visual Reasoning Under Resource Constraints
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.14821v2](http://arxiv.org/pdf/2506.14821v2)**
...
>
---
#### [replaced 021] Scaling Vision Pre-Training to 4K Resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.19903v2](http://arxiv.org/pdf/2503.19903v2)**
...
>
---
#### [replaced 035] Contextual Gesture: Co-Speech Gesture Video Generation through Context-aware Gesture Representation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.07239v2](http://arxiv.org/pdf/2502.07239v2)**

> **作者:** Pinxin Liu; Pengfei Zhang; Hyeongwoo Kim; Pablo Garrido; Ari Sharpio; Kyle Olszewski
>
> **备注:** Accepted to ACMMM 2025. Project Page: https://andypinxinliu.github.io/Contextual-Gesture/
>
...
>
---
#### [replaced 036] FastDriveVLA: Efficient End-to-End Driving via Plug-and-Play Reconstruction-based Token Pruning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.23318v2](http://arxiv.org/pdf/2507.23318v2)**
...
>
---
#### [replaced 037] Automated Label Placement on Maps via Large Language Models
- **分类: cs.HC; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.22952v2](http://arxiv.org/pdf/2507.22952v2)**
...
>
---
#### [replaced 044] Taming SAM for Underwater Instance Segmentation and Beyond
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.15581v2](http://arxiv.org/pdf/2505.15581v2)**

> **作者:** Hua Li; Shijie Lian; Zhiyuan Li; Runmin Cong; Chongyi Li
>
...
>
---
#### [replaced 045] Spatial Transcriptomics Analysis of Spatially Dense Gene Expression Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.01347v2](http://arxiv.org/pdf/2503.01347v2)**
...
>
---
#### [replaced 049] SDMatte: Grafting Diffusion Models for Interactive Matting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.00443v2](http://arxiv.org/pdf/2508.00443v2)**

> **作者:** Longfei Huang; Yu Liang; Hao Zhang; Jinwei Chen; Wei Dong; Lunde Chen; Wanyu Liu; Bo Li; Peng-Tao Jiang
>
...
>
---
#### [replaced 061] Anti-Inpainting: A Proactive Defense Approach against Malicious Diffusion-based Inpainters under Unknown Conditions
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2505.13023v3](http://arxiv.org/pdf/2505.13023v3)**
...
>
---
#### [replaced 062] Efficient Autoregressive Shape Generation via Octree-Based Adaptive Tokenization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.02817v2](http://arxiv.org/pdf/2504.02817v2)**
...
>
---
#### [replaced 064] Coordinate-based Speed of Sound Recovery for Aberration-Corrected Photoacoustic Computed Tomography
...
>
---
#### [replaced 065] Conditional Balance: Improving Multi-Conditioning Trade-Offs in Image Generation
- **分类: cs.CV; cs.GR; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.19853v2](http://arxiv.org/pdf/2412.19853v2)**

> **作者:** Nadav Z. Cohen; Oron Nir; Ariel Shamir
>
> **备注:** Conference paper at CVPR 2025. Project page: https://nadavc220.github.io/conditional-balance.github.io/
>
> **摘要:** Balancing content fidelity and artistic style is a pivotal challenge in image generation. While traditional style transfer methods and modern Denoising Diffusion Probabilistic Models (DDPMs) strive to achieve this balance, they often struggle to do so without sacrificing either style, content, or sometimes both. This work addresses this challenge by analyzing the ability of DDPMs to maintain content and style equilibrium. We introduce a novel method to identify sensitivities within the DDPM attention layers, identifying specific layers that correspond to different stylistic aspects. By directing conditional inputs only to these sensitive layers, our approach enables fine-grained control over style and content, significantly reducing issues arising from over-constrained inputs. Our findings demonstrate that this method enhances recent stylization techniques by better aligning style and content, ultimately improving the quality of generated visual content.
>
---
#### [replaced 066] Voyaging into Perpetual Dynamic Scenes from a Single View
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.04183v2](http://arxiv.org/pdf/2507.04183v2)**
...
>
---
#### [replaced 069] Collaborative Perceiver: Elevating Vision-based 3D Object Detection via Local Density-Aware Spatial Occupancy
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.21358v4](http://arxiv.org/pdf/2507.21358v4)**
...
>
---
#### [replaced 070] ProSAM: Enhancing the Robustness of SAM-based Visual Reference Segmentation with Probabilistic Prompts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21835v3](http://arxiv.org/pdf/2506.21835v3)**
...
>
---
#### [replaced 073] Uncertainty-Aware Knowledge Distillation for Compact and Efficient 6DoF Pose Estimation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.13053v2](http://arxiv.org/pdf/2503.13053v2)**
...
>
---
#### [replaced 075] SEAL: Semantic Aware Image Watermarking
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.12172v3](http://arxiv.org/pdf/2503.12172v3)**
...
>
---
#### [replaced 078] Democratizing Text-to-Image Masked Generative Models with Compact Text-Aware One-Dimensional Tokens
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.07730v2](http://arxiv.org/pdf/2501.07730v2)**

> **作者:** Dongwon Kim; Ju He; Qihang Yu; Chenglin Yang; Xiaohui Shen; Suha Kwak; Liang-Chieh Chen
>
> **备注:** ICCV 2025. Project page at https://tacju.github.io/projects/maskgen.html
>
> **摘要:** Image tokenizers form the foundation of modern text-to-image generative models but are notoriously difficult to train. Furthermore, most existing text-to-image models rely on large-scale, high-quality private datasets, making them challenging to replicate. In this work, we introduce Text-Aware Transformer-based 1-Dimensional Tokenizer (TA-TiTok), an efficient and powerful image tokenizer that can utilize either discrete or continuous 1-dimensional tokens. TA-TiTok uniquely integrates textual information during the tokenizer decoding stage (i.e., de-tokenization), accelerating convergence and enhancing performance. TA-TiTok also benefits from a simplified, yet effective, one-stage training process, eliminating the need for the complex two-stage distillation used in previous 1-dimensional tokenizers. This design allows for seamless scalability to large datasets. Building on this, we introduce a family of text-to-image Masked Generative Models (MaskGen), trained exclusively on open data while achieving comparable performance to models trained on private data. We aim to release both the efficient, strong TA-TiTok tokenizers and the open-data, open-weight MaskGen models to promote broader access and democratize the field of text-to-image masked generative models.
>
---
#### [replaced 079] Progressive Growing of Video Tokenizers for Temporally Compact Latent Spaces
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [http://arxiv.org/pdf/2501.05442v2](http://arxiv.org/pdf/2501.05442v2)**
...
>
> **摘要:** Video tokenizers are essential for latent video diffusion models, converting raw video data into spatiotemporally compressed latent spaces for efficient training. However, extending state-of-the-art video tokenizers to achieve a temporal compression ratio beyond 4x without increasing channel capacity poses significant challenges. In this work, we propose an alternative approach to enhance temporal compression. We find that the reconstruction quality of temporally subsampled videos from a low-compression encoder surpasses that of high-compression encoders applied to original videos. This indicates that high-compression models can leverage representations from lower-compression models. Building on this insight, we develop a bootstrapped high-temporal-compression model that progressively trains high-compression blocks atop well-trained lower-compression models. Our method includes a cross-level feature-mixing module to retain information from the pretrained low-compression model and guide higher-compression blocks to capture the remaining details from the full video sequence. Evaluation of video benchmarks shows that our method significantly improves reconstruction quality while increasing temporal compression compared to directly training the full model. Furthermore, the resulting compact latent space effectively trains a video diffusion model for high-quality video generation with a significantly reduced token budget.
>
---
#### [replaced 080] MoGA: 3D Generative Avatar Prior for Monocular Gaussian Avatar Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23597v2](http://arxiv.org/pdf/2507.23597v2)**
...
>
---
#### [replaced 083] Safety at Scale: A Comprehensive Survey of Large Model and Agent Safety
- **分类: cs.CR; cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.05206v5](http://arxiv.org/pdf/2502.05206v5)**

> **作者:** Xingjun Ma; Yifeng Gao; Yixu Wang; Ruofan Wang; Xin Wang; Ye Sun; Yifan Ding; Hengyuan Xu; Yunhao Chen; Yunhan Zhao; Hanxun Huang; Yige Li; Yutao Wu; Jiaming Zhang; Xiang Zheng; Yang Bai; Zuxuan Wu; Xipeng Qiu; Jingfeng Zhang; Yiming Li; Xudong Han; Haonan Li; Jun Sun; Cong Wang; Jindong Gu; Baoyuan Wu; Siheng Chen; Tianwei Zhang; Yang Liu; Mingming Gong; Tongliang Liu; Shirui Pan; Cihang Xie; Tianyu Pang; Yinpeng Dong; Ruoxi Jia; Yang Zhang; Shiqing Ma; Xiangyu Zhang; Neil Gong; Chaowei Xiao; Sarah Erfani; Tim Baldwin; Bo Li; Masashi Sugiyama; Dacheng Tao; James Bailey; Yu-Gang Jiang
>
> **备注:** 706 papers, 60 pages, 3 figures, 14 tables; GitHub: https://github.com/xingjunm/Awesome-Large-Model-Safety
>
...
>
---
#### [replaced 084] Wi-CBR: Salient-aware Adaptive WiFi Sensing for Cross-domain Behavior Recognition
- **分类: cs.CV; eess.SP**
...
>
---
#### [replaced 085] SuperCarver: Texture-Consistent 3D Geometry Super-Resolution for High-Fidelity Surface Detail Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.09439v2](http://arxiv.org/pdf/2503.09439v2)**
...
>
---
#### [replaced 086] Vision Calorimeter for Anti-neutron Reconstruction: A Baseline
- **分类: hep-ex; cs.CV**

- **链接: [http://arxiv.org/pdf/2408.10599v3](http://arxiv.org/pdf/2408.10599v3)**
...
>
> **备注:** Submitted to AAAI 2025 but rejected
>
...
>
---
#### [replaced 089] GausSim: Foreseeing Reality by Gaussian Simulator for Elastic Objects
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2412.17804v3](http://arxiv.org/pdf/2412.17804v3)**
...
>
---
#### [replaced 093] Rectifying Magnitude Neglect in Linear Attention
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00698v3](http://arxiv.org/pdf/2507.00698v3)**
...
>
---
#### [replaced 094] Polymorph: Energy-Efficient Multi-Label Classification for Video Streams on Embedded Devices
- **分类: cs.CV; cs.PF**

- **链接: [http://arxiv.org/pdf/2507.14959v2](http://arxiv.org/pdf/2507.14959v2)**
...
>
---
#### [replaced 095] HOLa: Zero-Shot HOI Detection with Low-Rank Decomposed VLM Feature Adaptation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15542v2](http://arxiv.org/pdf/2507.15542v2)**
...
>
---
#### [replaced 096] VoiceCloak: A Multi-Dimensional Defense Framework against Unauthorized Diffusion-based Voice Cloning
...
>
---
#### [replaced 097] WhoFi: Deep Person Re-Identification via Wi-Fi Channel Signal Encoding
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.12869v2](http://arxiv.org/pdf/2507.12869v2)**

> **作者:** Danilo Avola; Emad Emam; Dario Montagnini; Daniele Pannone; Amedeo Ranaldi
>
...
>
---
#### [replaced 098] CityNav: A Large-Scale Dataset for Real-World Aerial Navigation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2406.14240v3](http://arxiv.org/pdf/2406.14240v3)**
...
>
> **摘要:** Vision-and-language navigation (VLN) aims to develop agents capable of navigating in realistic environments. While recent cross-modal training approaches have significantly improved navigation performance in both indoor and outdoor scenarios, aerial navigation over real-world cities remains underexplored primarily due to limited datasets and the difficulty of integrating visual and geographic information. To fill this gap, we introduce CityNav, the first large-scale real-world dataset for aerial VLN. Our dataset consists of 32,637 human demonstration trajectories, each paired with a natural language description, covering 4.65 km$^2$ across two real cities: Cambridge and Birmingham. In contrast to existing datasets composed of synthetic scenes such as AerialVLN, our dataset presents a unique challenge because agents must interpret spatial relationships between real-world landmarks and the navigation destination, making CityNav an essential benchmark for advancing aerial VLN. Furthermore, as an initial step toward addressing this challenge, we provide a methodology of creating geographic semantic maps that can be used as an auxiliary modality input during navigation. In our experiments, we compare performance of three representative aerial VLN agents (Seq2seq, CMA and AerialVLN models) and demonstrate that the semantic map representation significantly improves their navigation performance.
>
---
#### [replaced 099] Exploration of Low-Cost but Accurate Radar-Based Human Motion Direction Determination
...
>
---
#### [replaced 100] SAGI: Semantically Aligned and Uncertainty Guided AI Image Inpainting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.06593v3](http://arxiv.org/pdf/2502.06593v3)**
...
>
---
#### [replaced 101] TKG-DM: Training-free Chroma Key Content Generation Diffusion Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.15580v3](http://arxiv.org/pdf/2411.15580v3)**

> **作者:** Ryugo Morita; Stanislav Frolov; Brian Bernhard Moser; Takahiro Shirakawa; Ko Watanabe; Andreas Dengel; Jinjia Zhou
>
> **备注:** Accepted to CVPR2025(Highlight). Code at: https://github.com/ryugo417/TKG-DM
>
> **摘要:** Diffusion models have enabled the generation of high-quality images with a strong focus on realism and textual fidelity. Yet, large-scale text-to-image models, such as Stable Diffusion, struggle to generate images where foreground objects are placed over a chroma key background, limiting their ability to separate foreground and background elements without fine-tuning. To address this limitation, we present a novel Training-Free Chroma Key Content Generation Diffusion Model (TKG-DM), which optimizes the initial random noise to produce images with foreground objects on a specifiable color background. Our proposed method is the first to explore the manipulation of the color aspects in initial noise for controlled background generation, enabling precise separation of foreground and background without fine-tuning. Extensive experiments demonstrate that our training-free method outperforms existing methods in both qualitative and quantitative evaluations, matching or surpassing fine-tuned models. Finally, we successfully extend it to other tasks (e.g., consistency models and text-to-video), highlighting its transformative potential across various generative applications where independent control of foreground and background is crucial.
>
---
#### [replaced 102] R1-VL: Learning to Reason with Multimodal Large Language Models via Step-wise Group Relative Policy Optimization
- **分类: cs.AI; cs.CL; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.12937v2](http://arxiv.org/pdf/2503.12937v2)**
...
>
---
#### [replaced 103] A novel approach to navigate the taxonomic hierarchy to address the Open-World Scenarios in Medicinal Plant Classification
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.17289v4](http://arxiv.org/pdf/2502.17289v4)**

> **作者:** Soumen Sinha; Tanisha Rana; Susmita Ghosh; Rahul Roy
>
...
>
---
#### [replaced 104] Describe Anything Model for Visual Question Answering on Text-rich Images
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.12441v2](http://arxiv.org/pdf/2507.12441v2)**
...
>
---
#### [replaced 113] CoT-Vid: Dynamic Chain-of-Thought Routing with Self Verification for Training-Free Video Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.11830v2](http://arxiv.org/pdf/2505.11830v2)**
...
>
---
#### [replaced 114] GLDesigner: Leveraging Multi-Modal LLMs as Designer for Enhanced Aesthetic Text Glyph Layouts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.11435v2](http://arxiv.org/pdf/2411.11435v2)**
...
>
---
#### [replaced 126] MoKD: Multi-Task Optimization for Knowledge Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.08170v2](http://arxiv.org/pdf/2505.08170v2)**
...
>
---
#### [replaced 127] DreamFrame: Enhancing Video Understanding via Automatically Generated QA and Style-Consistent Keyframes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.01422v4](http://arxiv.org/pdf/2403.01422v4)**

> **作者:** Zhende Song; Chenchen Wang; Jiamu Sheng; Chi Zhang; Shengji Tang; Jiayuan Fan; Tao Chen
>
> **备注:** Accepted by ACMMMM'25 Dataset Track
>
...
>
---
#### [replaced 128] Survivability of Backdoor Attacks on Unconstrained Face Recognition Systems
- **分类: cs.CV; cs.AI; cs.CR; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.01607v2](http://arxiv.org/pdf/2507.01607v2)**
...
>
---
#### [replaced 129] Towards Modality Generalization: A Benchmark and Prospective Analysis
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.18277v3](http://arxiv.org/pdf/2412.18277v3)**

> **作者:** Xiaohao Liu; Xiaobo Xia; Zhuo Huang; See-Kiong Ng; Tat-Seng Chua
>
> **备注:** Accepted by ACM MM 2025 (CR)
>
...
>
---
#### [replaced 130] MCA-Bench: A Multimodal Benchmark for Evaluating CAPTCHA Robustness Against VLM-based Attacks
- **分类: cs.CV; I.4.9**

- **链接: [http://arxiv.org/pdf/2506.05982v3](http://arxiv.org/pdf/2506.05982v3)**
...
>
---
#### [replaced 131] GS-Occ3D: Scaling Vision-only Occupancy Reconstruction with Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.19451v3](http://arxiv.org/pdf/2507.19451v3)**
...
>
---
#### [replaced 132] MEGANet-W: A Wavelet-Driven Edge-Guided Attention Framework for Weak Boundary Polyp Detection
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.02668v3](http://arxiv.org/pdf/2507.02668v3)**
...
>
---
#### [replaced 133] UniLDiff: Unlocking the Power of Diffusion Priors for All-in-One Image Restoration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23685v2](http://arxiv.org/pdf/2507.23685v2)**
...
>
---
#### [replaced 134] SegmentDreamer: Towards High-fidelity Text-to-3D Synthesis with Segmented Consistency Trajectory Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.05256v2](http://arxiv.org/pdf/2507.05256v2)**
...
>
---
#### [replaced 135] HumanDiT: Pose-Guided Diffusion Transformer for Long-form Human Motion Video Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.04847v5](http://arxiv.org/pdf/2502.04847v5)**
...
>
---
#### [replaced 136] Beyond Images: Adaptive Fusion of Visual and Textual Data for Food Classification
- **分类: cs.CV; cs.AI; cs.CY; cs.LG**

- **链接: [http://arxiv.org/pdf/2308.02562v3](http://arxiv.org/pdf/2308.02562v3)**
...
>
---
#### [replaced 143] MuteSwap: Visual-informed Silent Video Identity Conversion
...
>
---
#### [replaced 144] IV-tuning: Parameter-Efficient Transfer Learning for Infrared-Visible Tasks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.16654v3](http://arxiv.org/pdf/2412.16654v3)**
...
>
---
#### [replaced 145] Multimodal 3D Reasoning Segmentation with Complex Scenes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.13927v4](http://arxiv.org/pdf/2411.13927v4)**
...
>
---
#### [replaced 146] EchoMimicV3: 1.3B Parameters are All You Need for Unified Multi-Modal and Multi-Task Human Animation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.03905v2](http://arxiv.org/pdf/2507.03905v2)**
...
>
---
#### [replaced 147] Eyes Will Shut: A Vision-Based Next GPS Location Prediction Model by Reinforcement Learning from Visual Map Feed Back
- **分类: cs.CV; cs.RO**

- **链接: [http://arxiv.org/pdf/2507.18661v3](http://arxiv.org/pdf/2507.18661v3)**
...
>
---
#### [replaced 148] Model-Independent Machine Learning Approach for Nanometric Axial Localization and Tracking
- **分类: eess.IV; astro-ph.IM; cs.CV; cs.LG; physics.ins-det**

- **链接: [http://arxiv.org/pdf/2505.14754v2](http://arxiv.org/pdf/2505.14754v2)**
...
>
---
#### [replaced 149] LanternNet: A Hub-and-Spoke System to Seek and Suppress Spotted Lanternfly Populations
- **分类: cs.RO; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.20800v2](http://arxiv.org/pdf/2507.20800v2)**
...
>
---
#### [replaced 150] PixNerd: Pixel Neural Field Diffusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23268v2](http://arxiv.org/pdf/2507.23268v2)**
...
>
---
#### [replaced 151] Evaluating the evaluators: Towards human-aligned metrics for missing markers reconstruction
- **分类: cs.CV; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.14334v3](http://arxiv.org/pdf/2410.14334v3)**
...
>
---
#### [replaced 152] RedDiffuser: Red Teaming Vision-Language Models for Toxic Continuation via Reinforced Stable Diffusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.06223v3](http://arxiv.org/pdf/2503.06223v3)**
...
>
---
#### [replaced 155] Detecting Visual Information Manipulation Attacks in Augmented Reality: A Multimodal Semantic Reasoning Approach
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.20356v3](http://arxiv.org/pdf/2507.20356v3)**
...
>
---
#### [replaced 156] Prototype Embedding Optimization for Human-Object Interaction Detection in Livestreaming
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.22011v2](http://arxiv.org/pdf/2505.22011v2)**
...
>
---
#### [replaced 157] CapRecover: A Cross-Modality Feature Inversion Attack Framework on Vision Language Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.22828v2](http://arxiv.org/pdf/2507.22828v2)**
...
>
---
#### [replaced 158] StyleDrive: Towards Driving-Style Aware Benchmarking of End-To-End Autonomous Driving
- **分类: cs.CV; cs.RO; I.4.9**

- **链接: [http://arxiv.org/pdf/2506.23982v2](http://arxiv.org/pdf/2506.23982v2)**
...
>
---
#### [replaced 159] Hypergraph Mamba for Efficient Whole Slide Image Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.17457v2](http://arxiv.org/pdf/2505.17457v2)**

> **作者:** Jiaxuan Lu; Yuhui Lin; Junyan Shi; Fang Yan; Dongzhan Zhou; Yue Gao; Xiaosong Wang
>
...
>
---
#### [replaced 166] On the Discriminability of Self-Supervised Representation Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.13541v2](http://arxiv.org/pdf/2407.13541v2)**
...
>
---
#### [replaced 173] Style Content Decomposition-based Data Augmentation for Domain Generalizable Medical Image Segmentation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.20619v2](http://arxiv.org/pdf/2502.20619v2)**
...
>
---
#### [replaced 174] Individual Content and Motion Dynamics Preserved Pruning for Video Diffusion Models
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2411.18375v2](http://arxiv.org/pdf/2411.18375v2)**
...
>
---
#### [replaced 175] GAS: Generative Avatar Synthesis from a Single Image
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.06957v2](http://arxiv.org/pdf/2502.06957v2)**
...
>
> **摘要:** Building general-purpose models that can effectively perceive the world through multimodal signals has been a long-standing goal. Current approaches involve integrating separately pre-trained components, such as connecting vision encoders to LLMs and continuing multimodal training. While such approaches exhibit remarkable sample efficiency, it remains an open question whether such late-fusion architectures are inherently superior. In this work, we revisit the architectural design of native multimodal models (NMMs)-those trained from the ground up on all modalities-and conduct an extensive scaling laws study, spanning 457 trained models with different architectures and training mixtures. Our investigation reveals no inherent advantage to late-fusion architectures over early-fusion ones, which do not rely on image encoders or tokenizers. On the contrary, early-fusion exhibits stronger performance at lower parameter counts, is more efficient to train, and is easier to deploy. Motivated by the strong performance of the early-fusion architectures, we show that incorporating Mixture of Experts (MoEs) allows models to learn modality-specific weights, significantly benefiting performance.
>
---
#### [replaced 177] Subjective Camera 0.1: Bridging Human Cognition and Visual Reconstruction through Sequence-Aware Sketch-Guided Diffusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23711v2](http://arxiv.org/pdf/2506.23711v2)**
...
>
---
#### [replaced 178] Action2Dialogue: Generating Character-Centric Narratives from Scene-Level Prompts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.16819v2](http://arxiv.org/pdf/2505.16819v2)**

> **作者:** Taewon Kang; Ming C. Lin
>
> **备注:** 18 pages, 5 figures; revised manuscript
>
...
>
---
#### [replaced 179] CSDN: A Context-Gated Self-Adaptive Detection Network for Real-Time Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.17679v2](http://arxiv.org/pdf/2506.17679v2)**
...
>
---
#### [replaced 180] DRC: Enhancing Personalized Image Generation via Disentangled Representation Composition
- **分类: cs.CV; cs.IR**

- **链接: [http://arxiv.org/pdf/2504.17349v2](http://arxiv.org/pdf/2504.17349v2)**
