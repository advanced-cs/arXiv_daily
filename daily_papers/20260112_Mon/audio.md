...
#### [new 001] CosyEdit: Unlocking End-to-End Speech Editing Capability from Zero-Shot Text-to-Speech Models
- **分类: cs.SD; eess.AS**

- **简介: 该论文属于语音编辑任务，旨在解决传统系统复杂和依赖外部对齐的问题。通过微调和优化推理，提出CosyEdit模型实现高效端到端语音编辑。**

- **链接: [https://arxiv.org/pdf/2601.05329v1](https://arxiv.org/pdf/2601.05329v1)**

> **作者:** Junyang Chen; Yuhang Jia; Hui Wang; Jiaming Zhou; Yaxin Han; Mengying Feng; Yong Qin
>
...
>
---
#### [new 002] SPAM: Style Prompt Adherence Metric for Prompt-based TTS
- **分类: cs.SD; eess.AS**

- **简介: 该论文属于语音合成任务，解决风格提示遵循性评估问题。提出SPAM度量方法，通过声学属性对齐和对比损失训练，实现更准确的自动评估。**

- **链接: [https://arxiv.org/pdf/2601.05554v1](https://arxiv.org/pdf/2601.05554v1)**
...
>
---
#### [new 003] The ICASSP 2026 HumDial Challenge: Benchmarking Human-like Spoken Dialogue Systems in the LLM Era
...
>
---
#### [new 004] Discriminative-Generative Target Speaker Extraction with Decoder-Only Language Models
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于语音处理任务，旨在解决目标说话人提取问题。提出一种结合判别与生成模型的框架，提升语音质量与自然度。**

- **链接: [https://arxiv.org/pdf/2601.06006v1](https://arxiv.org/pdf/2601.06006v1)**
...
>
---
#### [new 005] Closing the Modality Reasoning Gap for Speech Large Language Models
...
#### [replaced 001] Detect All-Type Deepfake Audio: Wavelet Prompt Tuning for Enhanced Auditory Perception
- **分类: cs.SD; cs.AI**

- **简介: 该论文属于全类型深度伪造音频检测任务，旨在解决跨类型检测性能下降的问题。提出WPT-SSL方法，通过小波提示调优提升检测效果。**

- **链接: [https://arxiv.org/pdf/2504.06753v2](https://arxiv.org/pdf/2504.06753v2)**
...
>
---
#### [replaced 002] Zero-Day Audio DeepFake Detection via Retrieval Augmentation and Profile Matching
- **分类: cs.SD**

- **简介: 该论文属于音频深度伪造检测任务，旨在解决零日攻击检测问题。提出一种无需训练的检索增强框架，通过知识表示和语音特征匹配实现有效检测。**

- **链接: [https://arxiv.org/pdf/2509.21728v3](https://arxiv.org/pdf/2509.21728v3)**
...
>
---
#### [replaced 003] Spectral Masking and Interpolation Attack (SMIA): A Black-box Adversarial Attack against Voice Authentication and Anti-Spoofing Systems
- **分类: cs.SD; cs.AI**

- **简介: 该论文属于语音认证安全任务，旨在解决对抗攻击对语音验证系统和反欺骗机制的威胁。提出SMIA方法，通过频谱掩码和插值攻击，有效欺骗现有系统。**

- **链接: [https://arxiv.org/pdf/2509.07677v4](https://arxiv.org/pdf/2509.07677v4)**
...
>
---
#### [replaced 004] IndexTTS 2.5 Technical Report
- **分类: cs.SD; cs.AI**

- **简介: 该论文属于文本到语音合成任务，旨在提升多语言情感语音生成的质量与效率。通过优化模型结构和引入强化学习，实现了更快的推理速度和更广的语言支持。**

- **链接: [https://arxiv.org/pdf/2601.03888v3](https://arxiv.org/pdf/2601.03888v3)**
