...
>
---
#### [new 021] TIPS Over Tricks: Simple Prompts for Effective Zero-shot Anomaly Detection
- **分类: cs.CV**

- **简介: 该论文属于零样本异常检测任务，解决目标域正常数据缺失时的检测问题。通过改进的TIPS模型和简单提示策略，提升检测效果。**

- **链接: [https://arxiv.org/pdf/2602.03594v1](https://arxiv.org/pdf/2602.03594v1)**
...
>
---
#### [new 022] SceneLinker: Compositional 3D Scene Generation via Semantic Scene Graph from RGB Sequences
- **分类: cs.CV**

- **简介: 该论文提出SceneLinker，用于从RGB序列生成符合语义关系的3D场景。解决的是如何准确构建与现实布局一致的3D场景问题，通过图网络和变分自编码器实现。**

- **链接: [https://arxiv.org/pdf/2602.02974v1](https://arxiv.org/pdf/2602.02974v1)**
...
>
---
#### [new 025] LIVE: Long-horizon Interactive Video World Modeling
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决长时序视频预测中误差累积问题。提出LIVE模型，通过循环一致性约束减少误差传播，提升长序列生成质量。**

- **链接: [https://arxiv.org/pdf/2602.03747v1](https://arxiv.org/pdf/2602.03747v1)**

> **作者:** Junchao Huang; Ziyang Ye; Xinting Hu; Tianyu He; Guiyu Zhang; Shaoshuai Shi; Jiang Bian; Li Jiang
>
> **备注:** 18 pages, 22 figures
>
> **摘要:** Autoregressive video world models predict future visual observations conditioned on actions. While effective over short horizons, these models often struggle with long-horizon generation, as small prediction errors accumulate over time. Prior methods alleviate this by introducing pre-trained teacher models and sequence-level distribution matching, which incur additional computational cost and fail to prevent error propagation beyond the training horizon. In this work, we propose LIVE, a Long-horizon Interactive Video world modEl that enforces bounded error accumulation via a novel cycle-consistency objective, thereby eliminating the need for teacher-based distillation. Specifically, LIVE first performs a forward rollout from ground-truth frames and then applies a reverse generation process to reconstruct the initial state. The diffusion loss is subsequently computed on the reconstructed terminal state, providing an explicit constraint on long-horizon error propagation. Moreover, we provide an unified view that encompasses different approaches and introduce progressive training curriculum to stabilize training. Experiments demonstrate that LIVE achieves state-of-the-art performance on long-horizon benchmarks, generating stable, high-quality videos far beyond training rollout lengths.
>
---
#### [new 026] Spiral RoPE: Rotate Your Rotary Positional Embeddings in the 2D Plane
- **分类: cs.CV**

- **简介: 该论文属于视觉Transformer任务，解决2D位置编码方向受限问题，提出Spiral RoPE实现多方向位置编码，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.03227v1](https://arxiv.org/pdf/2602.03227v1)**
...
>
---
#### [new 027] RegionReasoner: Region-Grounded Multi-Round Visual Reasoning
- **分类: cs.CV**

- **简介: 该论文提出RegionReasoner，解决多轮视觉推理问题，通过强化学习实现区域引导的语义一致性推理，提升空间定位和全局一致性。**

- **链接: [https://arxiv.org/pdf/2602.03733v1](https://arxiv.org/pdf/2602.03733v1)**

> **作者:** Wenfang Sun; Hao Chen; Yingjun Du; Yefeng Zheng; Cees G. M. Snoek
>
> **备注:** Accepted by ICLR 2026
>
> **摘要:** Large vision-language models have achieved remarkable progress in visual reasoning, yet most existing systems rely on single-step or text-only reasoning, limiting their ability to iteratively refine understanding across multiple visual contexts. To address this limitation, we introduce a new multi-round visual reasoning benchmark with training and test sets spanning both detection and segmentation tasks, enabling systematic evaluation under iterative reasoning scenarios. We further propose RegionReasoner, a reinforcement learning framework that enforces grounded reasoning by requiring each reasoning trace to explicitly cite the corresponding reference bounding boxes, while maintaining semantic coherence via a global-local consistency reward. This reward extracts key objects and nouns from both global scene captions and region-level captions, aligning them with the reasoning trace to ensure consistency across reasoning steps. RegionReasoner is optimized with structured rewards combining grounding fidelity and global-local semantic alignment. Experiments on detection and segmentation tasks show that RegionReasoner-7B, together with our newly introduced benchmark RegionDial-Bench, considerably improves multi-round reasoning accuracy, spatial grounding precision, and global-local consistency, establishing a strong baseline for this emerging research direction.
>
---
#### [new 028] Z3D: Zero-Shot 3D Visual Grounding from Images
- **分类: cs.CV**

- **简介: 该论文属于3D视觉定位任务，解决零样本下从图像中定位3D物体的问题。提出Z3D方法，无需几何监督，通过多视角图像和先进分割技术实现高效3D定位。**

- **链接: [https://arxiv.org/pdf/2602.03361v1](https://arxiv.org/pdf/2602.03361v1)**
...
>
---
#### [new 032] Symbol-Aware Reasoning with Masked Discrete Diffusion for Handwritten Mathematical Expression Recognition
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于手写数学表达式识别任务，解决符号和结构推理问题。提出一种离散扩散框架，通过迭代优化提升识别准确性和结构一致性。**

- **链接: [https://arxiv.org/pdf/2602.03370v1](https://arxiv.org/pdf/2602.03370v1)**
...
>
---
#### [new 033] HypCBC: Domain-Invariant Hyperbolic Cross-Branch Consistency for Generalizable Medical Image Analysis
- **分类: cs.CV; cs.LG; eess.IV**

- **简介: 该论文属于医学图像分析任务，旨在解决模型泛化能力不足的问题。通过引入双曲流形和跨分支一致性约束，提升模型在不同数据分布下的性能。**

- **链接: [https://arxiv.org/pdf/2602.03264v1](https://arxiv.org/pdf/2602.03264v1)**
...
>
---
#### [new 035] HP-GAN: Harnessing pretrained networks for GAN improvement with FakeTwins and discriminator consistency
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在提升GAN生成图像的质量与多样性。通过引入FakeTwins和判别器一致性机制，优化预训练网络的利用，显著改善生成效果。**

- **链接: [https://arxiv.org/pdf/2602.03039v1](https://arxiv.org/pdf/2602.03039v1)**
...
>
---
#### [new 040] From Vicious to Virtuous Cycles: Synergistic Representation Learning for Unsupervised Video Object-Centric Learning
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视频对象中心学习任务，解决无监督模型中编码器与解码器的矛盾问题。提出SRL方法建立良性循环，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.03390v1](https://arxiv.org/pdf/2602.03390v1)**
...
>
---
#### [new 043] A generalizable large-scale foundation model for musculoskeletal radiographs
- **分类: cs.CV**

- **简介: 该论文提出SKELEX，一个用于骨骼肌肉X光片的通用大模型，解决任务特定、标注依赖和泛化能力弱的问题。通过自监督学习训练，提升诊断任务性能并实现零样本异常定位。**

- **链接: [https://arxiv.org/pdf/2602.03076v1](https://arxiv.org/pdf/2602.03076v1)**
...
>
---
#### [new 045] Fisheye Stereo Vision: Depth and Range Error
- **分类: cs.CV**

- **简介: 该论文属于视觉测量任务，研究鱼眼立体视觉系统的深度和距离误差问题，推导了误差与物距的解析表达式，解决大角度下的精度问题。**

- **链接: [https://arxiv.org/pdf/2602.02973v1](https://arxiv.org/pdf/2602.02973v1)**

> **作者:** Leaf Jiang; Matthew Holzel; Bernhard Kaplan; Hsiou-Yuan Liu; Sabyasachi Paul; Karen Rankin; Piotr Swierczynski
>
> **摘要:** This study derives analytical expressions for the depth and range error of fisheye stereo vision systems as a function of object distance, specifically accounting for accuracy at large angles.
>
---
#### [new 046] VIRAL: Visual In-Context Reasoning via Analogy in Diffusion Transformers
- **分类: cs.CV**

- **简介: 该论文提出VIRAL框架，解决视觉类比推理问题，通过条件生成实现图像编辑中的上下文学习，提升视觉任务处理能力。**

- **链接: [https://arxiv.org/pdf/2602.03210v1](https://arxiv.org/pdf/2602.03210v1)**

> **作者:** Zhiwen Li; Zhongjie Duan; Jinyan Ye; Cen Chen; Daoyuan Chen; Yaliang Li; Yingda Chen
>
> **摘要:** Replicating In-Context Learning (ICL) in computer vision remains challenging due to task heterogeneity. We propose \textbf{VIRAL}, a framework that elicits visual reasoning from a pre-trained image editing model by formulating ICL as conditional generation via visual analogy ($x_s : x_t :: x_q : y_q$). We adapt a frozen Diffusion Transformer (DiT) using role-aware multi-image conditioning and introduce a Mixture-of-Experts LoRA to mitigate gradient interference across diverse tasks. Additionally, to bridge the gaps in current visual context datasets, we curate a large-scale dataset spanning perception, restoration, and editing. Experiments demonstrate that VIRAL outperforms existing methods, validating that a unified V-ICL paradigm can handle the majority of visual tasks, including open-domain editing. Our code is available at https://anonymous.4open.science/r/VIRAL-744A
>
---
#### [new 047] LEVIO: Lightweight Embedded Visual Inertial Odometry for Resource-Constrained Devices
...
>
---
#### [new 048] A3-TTA: Adaptive Anchor Alignment Test-Time Adaptation for Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，解决领域偏移下的测试时自适应问题。提出A3-TTA框架，通过锚点引导生成可靠伪标签，提升分割性能。**

- **链接: [https://arxiv.org/pdf/2602.03292v1](https://arxiv.org/pdf/2602.03292v1)**
...
>
---
#### [new 052] AdaptMMBench: Benchmarking Adaptive Multimodal Reasoning for Mode Selection and Reasoning Process
- **分类: cs.CV**

- **简介: 该论文属于多模态推理任务，旨在解决现有评估方法无法反映模型动态适应能力的问题。提出AdaptMMBench基准，评估模式选择与推理过程的适应性。**

- **链接: [https://arxiv.org/pdf/2602.02676v1](https://arxiv.org/pdf/2602.02676v1)**
...
>
---
#### [new 053] Semantic Routing: Exploring Multi-Layer LLM Feature Weighting for Diffusion Transformers
- **分类: cs.CV**

- **简介: 该论文属于文本到图像生成任务，旨在解决文本条件静态与特征注入时机不当的问题。通过多层LLM特征加权融合，提升生成效果。**

- **链接: [https://arxiv.org/pdf/2602.03510v1](https://arxiv.org/pdf/2602.03510v1)**

> **作者:** Bozhou Li; Yushuo Guan; Haolin Li; Bohan Zeng; Yiyan Ji; Yue Ding; Pengfei Wan; Kun Gai; Yuanxing Zhang; Wentao Zhang
>
> **摘要:** Recent DiT-based text-to-image models increasingly adopt LLMs as text encoders, yet text conditioning remains largely static and often utilizes only a single LLM layer, despite pronounced semantic hierarchy across LLM layers and non-stationary denoising dynamics over both diffusion time and network depth. To better match the dynamic process of DiT generation and thereby enhance the diffusion model's generative capability, we introduce a unified normalized convex fusion framework equipped with lightweight gates to systematically organize multi-layer LLM hidden states via time-wise, depth-wise, and joint fusion. Experiments establish Depth-wise Semantic Routing as the superior conditioning strategy, consistently improving text-image alignment and compositional generation (e.g., +9.97 on the GenAI-Bench Counting task). Conversely, we find that purely time-wise fusion can paradoxically degrade visual generation fidelity. We attribute this to a train-inference trajectory mismatch: under classifier-free guidance, nominal timesteps fail to track the effective SNR, causing semantically mistimed feature injection during inference. Overall, our results position depth-wise routing as a strong and effective baseline and highlight the critical need for trajectory-aware signals to enable robust time-dependent conditioning.
>
---
#### [new 054] Diversity-Preserved Distribution Matching Distillation for Fast Visual Synthesis
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，解决DMD方法中的模式崩溃问题。提出DP-DMD框架，分离蒸馏步骤，保留样本多样性并提升生成质量。**

- **链接: [https://arxiv.org/pdf/2602.03139v1](https://arxiv.org/pdf/2602.03139v1)**
...
>
---
#### [new 055] LmPT: Conditional Point Transformer for Anatomical Landmark Detection on 3D Point Clouds
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于医学图像分析任务，旨在解决 anatomical landmark detection 的问题。提出 LmPT 模型，用于点云上的自动骨骼标志点检测，支持跨物种学习与泛化。**

- **链接: [https://arxiv.org/pdf/2602.02808v1](https://arxiv.org/pdf/2602.02808v1)**
...
>
---
#### [new 062] 3D-Aware Implicit Motion Control for View-Adaptive Human Video Generation
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决人体运动控制问题。传统方法依赖2D姿态或3D模型，存在视角限制或误差。本文提出3DiMo，通过隐式3D感知运动表示，提升生成质量与视角适应性。**

- **链接: [https://arxiv.org/pdf/2602.03796v1](https://arxiv.org/pdf/2602.03796v1)**
...
>
---
#### [new 064] Nüwa: Mending the Spatial Integrity Torn by VLM Token Pruning
...
>
---
#### [new 079] Making Avatars Interact: Towards Text-Driven Human-Object Interaction for Controllable Talking Avatars
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 091] Constrained Dynamic Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文提出CDGS框架，解决4D重建中的内存与质量平衡问题，通过预算约束优化实现高效渲染。**

- **链接: [https://arxiv.org/pdf/2602.03538v1](https://arxiv.org/pdf/2602.03538v1)**
...
>
---
#### [new 092] Efficient Sequential Neural Network with Spatial-Temporal Attention and Linear LSTM for Robust Lane Detection Using Multi-Frame Images
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **简介: 该论文属于车道检测任务，旨在解决现有方法在复杂环境下检测不准确的问题。提出一种结合时空注意力和线性LSTM的序列神经网络，提升检测精度与效率。**

- **链接: [https://arxiv.org/pdf/2602.03669v1](https://arxiv.org/pdf/2602.03669v1)**
...
>
---
#### [new 108] A Vision-Based Analysis of Congestion Pricing in New York City
- **分类: cs.CV**

- **简介: 论文通过分析交通摄像头数据，研究纽约市拥堵收费政策的影响，属于交通管理任务，旨在评估政策对车流量变化的效果。**

- **链接: [https://arxiv.org/pdf/2602.03015v1](https://arxiv.org/pdf/2602.03015v1)**

> **作者:** Mehmet Kerem Turkcan; Jhonatan Tavori; Javad Ghaderi; Gil Zussman; Zoran Kostic; Andrew Smyth
>
> **摘要:** We examine the impact of New York City's congestion pricing program through automated analysis of traffic camera data. Our computer vision pipeline processes footage from over 900 cameras distributed throughout Manhattan and New York, comparing traffic patterns from November 2024 through the program's implementation in January 2025 until January 2026. We establish baseline traffic patterns and identify systematic changes in vehicle density across the monitored region.
>
---
#### [new 109] UnHype: CLIP-Guided Hypernetworks for Dynamic LoRA Unlearning
- **分类: cs.CV**

- **简介: 该论文属于机器学习中的知识删除任务，旨在解决LoRA方法在概念删除时适应性差、难以平衡删除与泛化的问题。工作是引入UnHype框架，结合超网络和CLIP嵌入实现动态、可扩展的LoRA去学习。**

- **链接: [https://arxiv.org/pdf/2602.03410v1](https://arxiv.org/pdf/2602.03410v1)**
...
>
---
#### [new 110] Contextualized Visual Personalization in Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言模型任务，旨在解决个性化响应不足的问题，通过提出CoViP框架提升图像描述的个性化能力。**

- **链接: [https://arxiv.org/pdf/2602.03454v1](https://arxiv.org/pdf/2602.03454v1)**

> **作者:** Yeongtak Oh; Sangwon Yu; Junsung Park; Han Cheol Moon; Jisoo Mok; Sungroh Yoon
>
> **备注:** Project Page: https://github.com/oyt9306/CoViP
>
...
>
---
#### [new 111] Scaling Continual Learning with Bi-Level Routing Mixture-of-Experts
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出CaRE，解决长序列持续学习中的特征表示与稳定性问题。通过双级路由混合专家机制，实现高效任务扩展和性能提升。**

- **链接: [https://arxiv.org/pdf/2602.03473v1](https://arxiv.org/pdf/2602.03473v1)**
...
>
---
#### [new 112] R1-SyntheticVL: Is Synthetic Data from Generative Models Ready for Multimodal Large Language Model?
...
>
---
#### [new 113] MVP-LAM: Learning Action-Centric Latent Action via Cross-Viewpoint Reconstruction
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 114] POP: Prefill-Only Pruning for Efficient Large Model Inference
...
>
---
#### [new 115] AutoFigure: Generating and Refining Publication-Ready Scientific Illustrations
...
>
---
#### [new 120] PlanTRansformer: Unified Prediction and Planning with Goal-conditioned Transformer
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 121] PrevizWhiz: Combining Rough 3D Scenes and 2D Video to Guide Generative Video Previsualization
- **分类: cs.HC; cs.AI; cs.CV**

- **简介: 该论文提出PrevizWhiz系统，解决影视预演中效率与表达的矛盾，通过结合粗略3D场景和生成模型生成风格化视频预览。**

- **链接: [https://arxiv.org/pdf/2602.03838v1](https://arxiv.org/pdf/2602.03838v1)**
...
>
---
#### [new 124] BridgeV2W: Bridging Video Generation Models to Embodied World Models via Embodiment Masks
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 125] FullStack-Agent: Enhancing Agentic Full-Stack Web Coding via Development-Oriented Testing and Repository Back-Translation
...
>
---
#### [new 126] Beyond Translation: Cross-Cultural Meme Transcreation with Vision-Language Models
...
>
---
#### [new 127] ToolTok: Tool Tokenization for Efficient and Generalizable GUI Agents
- **分类: cs.LG; cs.AI; cs.CV; cs.MA**

- **简介: 该论文提出ToolTok，解决GUI代理在不同分辨率和数据稀缺下的泛化问题。通过工具序列建模和语义锚定机制，提升模型性能与泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.02548v1](https://arxiv.org/pdf/2602.02548v1)**
...
>
---
#### [new 129] EchoJEPA: A Latent Predictive Foundation Model for Echocardiography
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出EchoJEPA，用于超声心动图的预训练基础模型，解决标注负担重和诊断不一致问题。通过大规模数据训练，提升模型性能与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2602.02603v1](https://arxiv.org/pdf/2602.02603v1)**
...
>
---
#### [new 138] RDT2: Exploring the Scaling Limit of UMI Data Towards Zero-Shot Cross-Embodiment Generalization
...
>
---
#### [new 139] SAFE-KD: Risk-Controlled Early-Exit Distillation for Vision Backbones
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出SAFE-KD，解决视觉模型早停的可靠性问题，通过知识蒸馏和风险控制提升模型效率与准确性。**

- **链接: [https://arxiv.org/pdf/2602.03043v1](https://arxiv.org/pdf/2602.03043v1)**
...
>
---
#### [new 140] Spectral Evolution Search: Efficient Inference-Time Scaling for Reward-Aligned Image Generation
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于图像生成任务，解决推理时高效对齐问题。提出SES方法，在低频子空间进行进化搜索，提升生成质量与计算效率的平衡。**

- **链接: [https://arxiv.org/pdf/2602.03208v1](https://arxiv.org/pdf/2602.03208v1)**
...
>
---
#### [new 141] HetroD: A High-Fidelity Drone Dataset and Benchmark for Autonomous Driving in Heterogeneous Traffic
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 148] Time Is All It Takes: Spike-Retiming Attacks on Event-Driven Spiking Neural Networks
- **分类: cs.CR; cs.CV**

- **简介: 该论文研究了事件驱动脉冲神经网络中的时间重定时攻击，属于安全防护任务，旨在解决如何通过调整脉冲时间进行隐蔽攻击的问题，并提出优化方法进行有效攻击。**

- **链接: [https://arxiv.org/pdf/2602.03284v1](https://arxiv.org/pdf/2602.03284v1)**
...
>
---
#### [replaced 003] UniADC: A Unified Framework for Anomaly Detection and Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.06644v2](https://arxiv.org/pdf/2511.06644v2)**
...
>
---
#### [replaced 004] ShotFinder: Imagination-Driven Open-Domain Video Shot Retrieval via Web Search
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.23232v2](https://arxiv.org/pdf/2601.23232v2)**

> **作者:** Tao Yu; Haopeng Jin; Hao Wang; Shenghua Chai; Yujia Yang; Junhao Gong; Jiaming Guo; Minghui Zhang; Xinlong Chen; Zhenghao Zhang; Yuxuan Zhou; Yufei Xiong; Shanbin Zhang; Jiabing Yang; Hongzhu Yi; Xinming Wang; Cheng Zhong; Xiao Ma; Zhang Zhang; Yan Huang; Liang Wang
>
...
>
---
#### [replaced 005] A Multicenter Benchmark of Multiple Instance Learning Models for Lymphoma Subtyping from HE-stained Whole Slide Images
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.14640v2](https://arxiv.org/pdf/2512.14640v2)**
...
>
---
#### [replaced 007] SyNeT: Synthetic Negatives for Traversability Learning
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 008] Mixture of Distributions Matters: Dynamic Sparse Attention for Efficient Video Diffusion Transformers
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.11641v2](https://arxiv.org/pdf/2601.11641v2)**
...
>
---
#### [replaced 009] Generating a Paracosm for Training-Free Zero-Shot Composed Image Retrieval
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00813v2](https://arxiv.org/pdf/2602.00813v2)**
...
>
---
#### [replaced 010] ECORE: Energy-Conscious Optimized Routing for Deep Learning Models at the Edge
- **分类: cs.DC; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.06011v4](https://arxiv.org/pdf/2507.06011v4)**
...
>
---
#### [replaced 011] Infinite-World: Scaling Interactive World Models to 1000-Frame Horizons via Pose-Free Hierarchical Memory
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.02393v2](https://arxiv.org/pdf/2602.02393v2)**
...
>
> **备注:** project page: https://rq-wu.github.io/projects/infinite-world/index.html
>
...
>
---
#### [replaced 012] Cross-Modal Alignment and Fusion for RGB-D Transmission-Line Defect Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.01696v2](https://arxiv.org/pdf/2602.01696v2)**
...
>
---
#### [replaced 013] Can 3D point cloud data improve automated body condition score prediction in dairy cattle?
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.22522v2](https://arxiv.org/pdf/2601.22522v2)**
...
>
---
#### [replaced 014] Towards Sustainable Universal Deepfake Detection with Frequency-Domain Masking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08042v3](https://arxiv.org/pdf/2512.08042v3)**

> **作者:** Chandler Timm C. Doloriel; Habib Ullah; Kristian Hovde Liland; Fadi Al Machot; Ngai-Man Cheung
>
> **备注:** Accepted to ACM TOMM
>
...
>
---
#### [replaced 015] SEMNAV: Enhancing Visual Semantic Navigation in Robotics through Semantic Segmentation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 016] Beyond the Vision Encoder: Identifying and Mitigating Spatial Bias in Large Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 017] MiTA Attention: Efficient Fast-Weight Scaling via a Mixture of Top-k Activations
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.01219v2](https://arxiv.org/pdf/2602.01219v2)**
...
>
---
#### [replaced 018] LazyDrag: Enabling Stable Drag-Based Editing on Multi-Modal Diffusion Transformers via Explicit Correspondence
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.12203v3](https://arxiv.org/pdf/2509.12203v3)**

> **作者:** Zixin Yin; Xili Dai; Duomin Wang; Xianfang Zeng; Lionel M. Ni; Gang Yu; Heung-Yeung Shum
>
> **备注:** https://zxyin.github.io/LazyDrag
>
...
>
---
#### [replaced 019] Geometry-aware 4D Video Generation for Robot Manipulation
...
>
---
#### [replaced 020] SAIL-RL: Guiding MLLMs in When and How to Think via Dual-Reward RL Tuning
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 023] L2M-Reg: Building-level Uncertainty-aware Registration of Outdoor LiDAR Point Clouds and Semantic 3D City Models
- **分类: cs.CV; cs.RO; eess.IV**
...
>
---
#### [replaced 031] DiffVL: Diffusion-Based Visual Localization on 2D Maps via BEV-Conditioned GPS Denoising
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.14565v2](https://arxiv.org/pdf/2509.14565v2)**
...
>
---
#### [replaced 032] Understanding-informed Bias Mitigation for Fair CMR Segmentation
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2503.17089v3](https://arxiv.org/pdf/2503.17089v3)**
...
>
> **备注:** Accepted for publication at the Journal of Machine Learning for Biomedical Imaging (MELBA) https://melba-journal.org/2025:036
>
...
>
---
#### [replaced 035] CountZES: Counting via Zero-Shot Exemplar Selection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16415v2](https://arxiv.org/pdf/2512.16415v2)**
...
>
---
#### [replaced 036] Creative Image Generation with Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.22125v2](https://arxiv.org/pdf/2601.22125v2)**
...
>
---
#### [replaced 037] Diff4MMLiTS: Advanced Multimodal Liver Tumor Segmentation via Diffusion-Based Image Synthesis and Alignment
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2412.20418v2](https://arxiv.org/pdf/2412.20418v2)**

> **作者:** Shiyun Chen; Li Lin; Pujin Cheng; ZhiCheng Jin; JianJian Chen; HaiDong Zhu; Kenneth K. Y. Wong; Xiaoying Tang
>
> **备注:** International Workshop on Machine Learning in Medical Imaging, 668-678
>
...
>
---
#### [replaced 040] Happy Young Women, Grumpy Old Men? Emotion-Driven Demographic Biases in Synthetic Face Generation
- **分类: cs.CY; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00032v2](https://arxiv.org/pdf/2602.00032v2)**
...
>
---
#### [replaced 041] MixGRPO: Unlocking Flow-based GRPO Efficiency with Mixed ODE-SDE
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.21802v4](https://arxiv.org/pdf/2507.21802v4)**
...
>
---
#### [replaced 042] Thalia: A Global, Multi-Modal Dataset for Volcanic Activity Monitoring
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.17782v2](https://arxiv.org/pdf/2505.17782v2)**
...
>
---
#### [replaced 043] SurfSplat: Conquering Feedforward 2D Gaussian Splatting with Surface Continuity Priors
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.02000v2](https://arxiv.org/pdf/2602.02000v2)**

> **作者:** Bing He; Jingnan Gao; Yunuo Chen; Ning Cao; Gang Chen; Zhengxue Cheng; Li Song; Wenjun Zhang
>
> **备注:** ICLR 2026; Project Page: https://hebing-sjtu.github.io/SurfSplat-website/
>
...
>
---
#### [replaced 044] DeepUrban: Interaction-Aware Trajectory Prediction and Planning for Automated Driving by Aerial Imagery
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.10554v2](https://arxiv.org/pdf/2601.10554v2)**

> **作者:** Constantin Selzer; Fabian B. Flohr
>
> **摘要:** The efficacy of autonomous driving systems hinges critically on robust prediction and planning capabilities. However, current benchmarks are impeded by a notable scarcity of scenarios featuring dense traffic, which is essential for understanding and modeling complex interactions among road users. To address this gap, we collaborated with our industrial partner, DeepScenario, to develop DeepUrban-a new drone dataset designed to enhance trajectory prediction and planning benchmarks focusing on dense urban settings. DeepUrban provides a rich collection of 3D traffic objects, extracted from high-resolution images captured over urban intersections at approximately 100 meters altitude. The dataset is further enriched with comprehensive map and scene information to support advanced modeling and simulation tasks. We evaluate state-of-the-art (SOTA) prediction and planning methods, and conducted experiments on generalization capabilities. Our findings demonstrate that adding DeepUrban to nuScenes can boost the accuracy of vehicle predictions and planning, achieving improvements up to 44.1 % / 44.3% on the ADE / FDE metrics. Website: https://iv.ee.hm.edu/deepurban
>
---
#### [replaced 045] Training-Free Text-Guided Color Editing with Multi-Modal Diffusion Transformer
- **分类: cs.GR; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09131v3](https://arxiv.org/pdf/2508.09131v3)**

> **作者:** Zixin Yin; Xili Dai; Ling-Hao Chen; Deyu Zhou; Jianan Wang; Duomin Wang; Gang Yu; Lionel M. Ni; Lei Zhang; Heung-Yeung Shum
>
> **备注:** https://zxyin.github.io/ColorCtrl
>
...
>
---
#### [replaced 048] No time to train! Training-Free Reference-Based Instance Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.02798v4](https://arxiv.org/pdf/2507.02798v4)**
...
>
---
#### [replaced 049] PISA: Piecewise Sparse Attention Is Wiser for Efficient Diffusion Transformers
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.01077v2](https://arxiv.org/pdf/2602.01077v2)**
...
>
---
#### [replaced 052] RANKVIDEO: Reasoning Reranking for Text-to-Video Retrieval
- **分类: cs.IR; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.02444v2](https://arxiv.org/pdf/2602.02444v2)**
...
>
---
#### [replaced 053] DuoGen: Towards General Purpose Interleaved Multimodal Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00508v2](https://arxiv.org/pdf/2602.00508v2)**
...
>
> **备注:** Technical Report. Project Page: https://research.nvidia.com/labs/dir/duogen/
>
...
>
---
#### [replaced 054] CAD-SLAM: Consistency-Aware Dynamic SLAM with Dynamic-Static Decoupled Mapping
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.19420v2](https://arxiv.org/pdf/2505.19420v2)**

> **作者:** Wenhua Wu; Chenpeng Su; Siting Zhu; Tianchen Deng; Jianhao Jiao; Guangming Wang; Dimitrios Kanoulas; Zhe Liu; Hesheng Wang
>
...
>
---
#### [replaced 055] TP-Blend: Textual-Prompt Attention Pairing for Precise Object-Style Blending in Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG; cs.MM**

- **链接: [https://arxiv.org/pdf/2601.08011v3](https://arxiv.org/pdf/2601.08011v3)**
...
>
---
#### [replaced 056] Decipher-MR: A Vision-Language Foundation Model for 3D MRI Representations
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.21249v2](https://arxiv.org/pdf/2509.21249v2)**
...
>
---
#### [replaced 058] Accurate and Efficient World Modeling with Masked Latent Transformers
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.04075v2](https://arxiv.org/pdf/2507.04075v2)**
...
>
---
#### [replaced 059] Proteus-ID: ID-Consistent and Motion-Coherent Video Customization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.23729v2](https://arxiv.org/pdf/2506.23729v2)**
...
>
---
#### [replaced 060] From Frames to Sequences: Temporally Consistent Human-Centric Dense Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.01661v2](https://arxiv.org/pdf/2602.01661v2)**
...
>
---
#### [replaced 061] FlyPrompt: Brain-Inspired Random-Expanded Routing with Temporal-Ensemble Experts for General Continual Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.01976v2](https://arxiv.org/pdf/2602.01976v2)**
...
>
---
#### [replaced 062] EVODiff: Entropy-aware Variance Optimized Diffusion Inference
- **分类: cs.CV; cs.IT; cs.LG; math.OC; stat.ML**

- **链接: [https://arxiv.org/pdf/2509.26096v3](https://arxiv.org/pdf/2509.26096v3)**

> **作者:** Shigui Li; Wei Chen; Delu Zeng
>
> **备注:** NeurIPS 2025, 41 pages, 14 figures
>
...
>
---
#### [replaced 065] Seeing through Satellite Images at Street Views
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.17001v2](https://arxiv.org/pdf/2505.17001v2)**

> **作者:** Ming Qian; Bin Tan; Qiuyu Wang; Xianwei Zheng; Hanjiang Xiong; Gui-Song Xia; Yujun Shen; Nan Xue
>
> **备注:** Accepted to IEEE TPAMI. Initially submitted in July 2024. Code is available on https://qianmingduowan.github.io/sat2density-pp/
>
...
>
---
#### [replaced 066] UniFGVC: Universal Training-Free Few-Shot Fine-Grained Vision Classification via Attribute-Aware Multimodal Retrieval
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.04136v3](https://arxiv.org/pdf/2508.04136v3)**

> **作者:** Hongyu Guo; Xiangzhao Hao; Jiarui Guo; Haiyun Guo; Jinqiao Wang; Tat-Seng Chua
>
...
>
---
#### [replaced 069] What does really matter in image goal navigation?
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 070] TFFM: Topology-Aware Feature Fusion Module via Latent Graph Reasoning for Retinal Vessel Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.19136v2](https://arxiv.org/pdf/2601.19136v2)**
...
>
---
#### [replaced 072] v1: Learning to Point Visual Tokens for Multimodal Grounded Reasoning
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 073] ObjEmbed: Towards Universal Multimodal Object Embeddings
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.01753v2](https://arxiv.org/pdf/2602.01753v2)**
...
>
---
#### [replaced 074] MapDream: Task-Driven Map Learning for Vision-Language Navigation
...
>
---
#### [replaced 077] Imbalance-Robust and Sampling-Efficient Continuous Conditional GANs via Adaptive Vicinity and Auxiliary Regularization
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.01725v4](https://arxiv.org/pdf/2508.01725v4)**
...
>
---
#### [replaced 078] MedFrameQA: A Multi-Image Medical VQA Benchmark for Clinical Reasoning
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 079] Rectification Reimagined: A Unified Mamba Model for Image Correction and Rectangling with Prompts
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.18718v2](https://arxiv.org/pdf/2512.18718v2)**
...
>
---
#### [replaced 080] OptiPMB: Enhancing 3D Multi-Object Tracking with Optimized Poisson Multi-Bernoulli Filtering
- **分类: cs.CV; cs.RO**
