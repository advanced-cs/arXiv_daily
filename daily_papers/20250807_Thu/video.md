...
- **简介: 该论文旨在重新审视DFT在连续语义分割中的性能，解决如何有效利用预训练视觉模型（PVMs）克服灾难性遗忘问题。通过实验验证发现，PVMs具有显著的抗遗忘能力，提出DFT*方法结合冻结骨干和预训练分类器，实现高效改进。**
...
- **简介: 该论文提出了一种基于不确定性感知的低光照图像增强方法，解决传统方法忽略特征表示不确定性的问题，通过熵驱动的框架引入两个关键模块（UaD和层次因果网络），实现空间-色相关建模与误差补偿，达到显著改善低光照场景性能的效果。**
...
- **简介: 该论文旨在开发零样本实例分割任务的扩散模型OC-DiT，解决如何在无目标数据情况下有效分割物体实例的问题，通过条件化扩散框架生成实例掩码并实现多模型变异优化，在大量高质量合成数据集上达到实时性能。**
...
- **简介: 该论文提出了一种结合特权信息与深度学习的新型方法，用于提升小颗粒和遮挡物体的 litter 检测准确性，通过构建二进制掩码优化检测指导，解决了传统方法面临的问题，实现了高效性和泛化性。**
...
- **简介: 该论文旨在解决单目视频动态场景重建中的多要素联合建模难题，通过将场景表示分解为静态与动态组件，并分离运动模型实现时空独立建模，有效解决了运动泄漏、几何畸变等问题，提升了重建质量与实时性。**
...
- **简介: 该论文提出两向服装转移模型TWGTM，解决传统虚拟试穿（VTON）与虚拟试穿（VTOFF）任务的互补性问题。通过双向特征分离和分阶段训练，融合参考图像的双重引导，有效解决了mask依赖性及多模态任务整合难题。**
...
- **简介: 该论文提出UniFGVC框架，解决Few-shot视觉分类中模型泛化能力不足的问题。通过构建Category-Discriminative Visual Captioner（CDV-Captioner）等方法，利用多模态检索技术将图像转化为特征表示并实现统一检索，有效提升模型性能。**
...
- **简介: 该论文旨在评估大型多模体模型（LMMs）的输入审查能力，解决其对缺陷输入被动接受的问题，通过构建Input Scrutiny Ability Evaluation Framework（ISEval）框架，分析了七类故障前提及三种评估指标，验证了模型对逻辑错误的敏感性与模态信任度差异，并提出了改进方向。**
...
- **简介: 该论文旨在解决海洋视频理解与生成中的复杂性问题，提出基于三元组的两阶段视频理解框架，构建了包含视觉引导和clip-level captioning的海洋野生动物视频数据集，并通过视频剪切技术增强语义表达能力。**
...
- **链接: [http://arxiv.org/pdf/2508.04366v1](http://arxiv.org/pdf/2508.04366v1)**
...
>
---
#### [new 032] Hierarchical Event Memory for Accurate and Low-latency Online Video Temporal Grounding
- **分类: cs.CV**
...
- **简介: 该论文旨在开发基于CCTV图像的实时城市轨道交通平台拥挤度估计方法，解决了传统依赖间接数据的估算难题。研究通过比较三种计算机视觉模型（YOLOv11、RT-DETRv2、DeepLabV3）及高效优化算法，实现了更精确的乘客分布建模，验证了CCTV数据作为独立数据源的优势。**
...
- **简介: 该论文探讨了通过基础模型（foundation models）进行细胞分裂图分类的任务，旨在解决有限数据下的模型性能问题。研究利用自监督方法和低秩适应（LoRA）优化注意力机制，将新基础模型与端到端训练的CNN/ViT进行对比，证明LoRA在数据泛化性和鲁棒性方面优于传统方法，达到接近100%数据可用性水平。**
...
- **简介: 该论文提出了一种融合通用人类-物体-人类交互任务与第一人视角感知的系统，旨在构建多模态交互平台。通过嵌入视觉语言-动作框架，实现了跨情境的互动数据采集与分析，解决了传统方法忽略第一人视角的局限性，并建立了包含11.4小时数据的大型基准测试，推动了AI在物理世界中的应用。**
...
- **简介: 该论文提出PIS3R算法，解决大范围畸变图像对齐问题。通过深度3D重建与点条件扩散模块，在视觉几何变换下实现像素级对齐，并在3D光子学场景中有效处理畸变，优于现有方法。**
...
- **简介: 该论文旨在解决医学图像分割中单一特征监督不足的问题，提出Detail-Semantic Deep Supervision Network（DS2Net）通过互补模块实现多尺度特征强化与不确定性损失优化，显著提升性能。**
...
- **简介: 该论文属于多模态视频语言理解任务，旨在解决长时视频输入下MLLMs因上下文限制和训练成本导致的事件捕捉不足问题。提出TSPO通过强化学习优化时间采样策略，结合事件感知代理、联合决策优化及长视频训练数据，实现高效组级相对优化，并验证其跨模型的泛化能力。**
...
- **简介: 本文综述了音频-视觉分割（AVS）的研究进展，探讨了其目标、方法及挑战。**
...
- **简介: 该论文研究了点云注册任务，解决了传统方法受相似变换、噪声点和几何缺陷影响的问题，提出了基于形状空间的鲁棒方法PKSS-Align，通过形状特征基测量生成变换矩阵，无需数据训练和复杂编码，实现高效注册。**
...
- **简介: 该论文属于医学影像分割任务，旨在解决传统Transformer因高计算复杂度和局部特征捕捉不足导致的性能与效率矛盾。通过引入压缩注意力（CA）和双分支FFN模块，优化了模型结构，提升了医疗图像分割精度与计算效率。**
...
- **简介: 该论文提出了一种**单尺度分解网络（SSD-Net）**，旨在解决水下图像增强中因多尺度特征融合导致的复杂度增加问题。通过创新的双分支特征分解和双向通信模块，结合CNN与Transformer的优势，实现了对水下环境光衰等非线性效应的有效降噪与重构，提升了单尺度特征提取的效果。**
...
- **简介: 该论文提出NEARL-CLIP框架，解决跨模态医疗视觉-语言理解中的领域差异问题，通过动态生成互作用查询和正交注意力调整器实现多模态信息融合，仅需1.46M参数。**
...
- **简介: 该论文提出多基线通用馈送方法MuRF，解决视图合成任务，有效处理稀疏输入场景并提升几何精度与渲染质量，通过融合MVS/MDE特征、投影-采样机制和参考视图损失实现高效训练。**
...
>
---
#### [new 063] Occupancy Learning with Spatiotemporal Memory
- **分类: cs.CV**

- **简介: 该论文旨在解决3D空间占用信息在多帧时间序列中的高效聚合问题，提出ST-Occ框架通过时空记忆与注意力机制实现动态感知，显著提升了3D占用预测任务的精度与一致性（实验结果：3 mIoU，29%减少时间不一致）。**

- **链接: [http://arxiv.org/pdf/2508.04705v1](http://arxiv.org/pdf/2508.04705v1)**
...
>
---
#### [new 065] Investigating the Impact of Large-Scale Pre-training on Nutritional Content Estimation from 2D Images
- **分类: cs.CV**

- **简介: 该论文旨在研究基于2D图像的营养成分估算任务，解决依赖2D图像的挑战问题。通过对比ViT与CNN模型及预训练数据性能，验证了大规模预训练数据对迁移学习的有效性，并分析了数据特征（如规模、领域相关性等）的影响。**

- **链接: [http://arxiv.org/pdf/2508.03996v1](http://arxiv.org/pdf/2508.03996v1)**
...
>
---
#### [new 066] Zero-Residual Concept Erasure via Progressive Alignment in Text-to-Image Model
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于文本到图像（Text-to-Image）任务，旨在解决概念擦除问题（防止预训练模型生成与有害概念相关的内容），通过改进零残差约束和分层更新策略，实现更完整的概念擦除并提升生成质量。**

- **链接: [http://arxiv.org/pdf/2508.04472v1](http://arxiv.org/pdf/2508.04472v1)**
...
>
---
#### [new 067] A machine learning approach for image classification in synthetic aperture RADAR
- **分类: cs.CV; cs.NA; math.NA**

- **简介: 该论文提出基于卷积神经网络（CNN）的合成孔径雷达（SAR）图像分类任务，解决地表物体及冰类型识别问题。通过模拟数据与重建图像融合训练模型，并评估不同方法的性能，最终实现高精度分类（≥75%）。研究探讨了天线高度对分类效果的影响。**

- **链接: [http://arxiv.org/pdf/2508.04234v1](http://arxiv.org/pdf/2508.04234v1)**
...
>
---
#### [new 068] Deep Learning-based Scalable Image-to-3D Facade Parser for Generating Thermal 3D Building Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文旨在解决现有建筑早期改造中热3D建模的特征识别问题，提出基于图像解析与深度学习的SI3FP框架，通过直接建模图像平面几何体实现LoD3热模型生成，有效提升窗口到墙体比估计精度（5%），并支持多源数据融合，用于能源规划与城市开发。**

- **链接: [http://arxiv.org/pdf/2508.04406v1](http://arxiv.org/pdf/2508.04406v1)**
...
>
---
#### [new 070] ToxicTAGS: Decoding Toxic Memes with Rich Tag Annotations
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 071] Bootstrap Deep Spectral Clustering with Optimal Transport
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出一种端到端的深度谱聚类模型BootSC，解决传统方法的分离优化与表示局限性，通过联合学习多阶段谱聚类步骤并利用最优运输监督进行有效泛化，实现16%的NMI提升。**

- **链接: [http://arxiv.org/pdf/2508.04200v1](http://arxiv.org/pdf/2508.04200v1)**
...
>
---
#### [new 075] Unlocking the Potential of MLLMs in Referring Expression Segmentation via a Light-weight Mask Decode
- **分类: cs.CV; cs.AI**

- **简介: 该论文旨在解决基于MLLM的表达分割任务，通过引入视觉细节特征与语义特征融合模块，设计轻量化掩码解码器，优化参数效率并提升性能，实现准确分割。**

- **链接: [http://arxiv.org/pdf/2508.04107v1](http://arxiv.org/pdf/2508.04107v1)**
...
>
---
#### [new 078] PixCuboid: Room Layout Estimation from Multi-view Featuremetric Alignment
- **分类: cs.CV; I.4**

- **简介: 该论文旨在解决传统单视角房间布局估计方法难以适应多视角场景的问题，提出PixCuboid通过多视角特征对齐优化训练，学习生成具有大基区和平滑损失的特征图，从而实现灵活的多房间空间建模。**

- **链接: [http://arxiv.org/pdf/2508.04659v1](http://arxiv.org/pdf/2508.04659v1)**
...
>
---
#### [new 082] TNet: Terrace Convolutional Decoder Network for Remote Sensing Image Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文旨在解决远程 sensing 图像语义分割中的全局-局部特征融合不足问题，提出 Terrace Convolutional Decoder Network (TNet)，通过卷积与加法操作实现多尺度特征融合，使模型在 ResNet-18 编码器基础上取得 85.35% - 52.19% 的 mIoU 值，同时保持高计算效率。**

- **链接: [http://arxiv.org/pdf/2508.04061v1](http://arxiv.org/pdf/2508.04061v1)**
...
>
---
#### [new 087] HPSv3: Towards Wide-Spectrum Human Preference Score
- **分类: cs.CV**

- **简介: 该论文旨在解决文本-图像生成模型评估中的数据覆盖不足、特征提取与损失函数效率等问题，提出了Human Preference Score v3（HPSv3）和Chain-of-Human-Preference（CoHP）方法，通过整合大规模数据和高效算法实现宽谱评估和图像质量提升。**

- **链接: [http://arxiv.org/pdf/2508.03789v1](http://arxiv.org/pdf/2508.03789v1)**
...
>
---
#### [new 088] Analyzing and Mitigating Object Hallucination: A Training Bias Perspective
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 091] A Large Language Model Powered Integrated Circuit Footprint Geometry Understanding
- **分类: cs.CV**

- **简介: 该论文旨在解决IC PCB布局几何标注问题，提出LMM4-IC8K框架（两阶段训练+多模态数据集），通过LLM解析IC机械图并增强几何推理能力，验证其在实际场景中的有效性。**

- **链接: [http://arxiv.org/pdf/2508.03725v1](http://arxiv.org/pdf/2508.03725v1)**
...
>
---
#### [new 103] Audio-Assisted Face Video Restoration with Temporal and Identity Complementary Learning
- **分类: cs.CV; cs.MM**

- **简介: 该论文提出了一种基于时序与身份互补学习的音频-辅助面部视频恢复网络（GAVN），解决视觉与音频特征不匹配问题，通过多尺度特征融合实现高质量视频重建，显著提升压缩伪影去除与图像质量。**

- **链接: [http://arxiv.org/pdf/2508.04161v1](http://arxiv.org/pdf/2508.04161v1)**
...
>
---
#### [new 111] LayerT2V: Interactive Multi-Object Trajectory Layering for Video Generation
- **分类: cs.CV; cs.AI; cs.LG; cs.MM**

- **简介: 该论文提出了一种交互式多物体轨迹层叠方法LayerT2V，旨在解决文本到视频（T2V）中多物体运动控制的问题。任务为视频生成，需在复杂场景中整合独立对象，工作是通过分层合成背景与前景物体，克服单对象模型局限性及轨迹冲突带来的性能瓶颈。**

- **链接: [http://arxiv.org/pdf/2508.04228v1](http://arxiv.org/pdf/2508.04228v1)**

> **作者:** Kangrui Cen; Baixuan Zhao; Yi Xin; Siqi Luo; Guangtao Zhai; Xiaohong Liu
>
> **备注:** Project webpage: https://kr-panghu.github.io/LayerT2V/
>
...
>
---
#### [new 112] InceptoFormer: A Multi-Signal Neural Framework for Parkinson's Disease Severity Evaluation from Gait
- **分类: cs.CV**

- **简介: 该论文提出一个基于步态分析的神经网络框架（InceptoFormer），用于帕金森病（PD）严重程度评估。通过引入1D Inception模块和Transformer结构，结合多尺度时序特征提取与长距离依赖建模，解决传统方法在不平衡分类中的问题，实现96.6%的准确率提升。**

- **链接: [http://arxiv.org/pdf/2508.04540v1](http://arxiv.org/pdf/2508.04540v1)**
...
>
---
#### [new 115] No Masks Needed: Explainable AI for Deriving Segmentation from Classification
- **分类: cs.CV**

- **简介: 该论文提出了一种无需遮罩的医学图像分割方法，利用预训练模型结合可解释AI，解决了传统方法在医疗应用中的局限性，实现了更准确的分割效果。**

- **链接: [http://arxiv.org/pdf/2508.04534v1](http://arxiv.org/pdf/2508.04534v1)**
...
>
---
#### [new 116] Refine-IQA: Multi-Stage Reinforcement Finetuning for Perceptual Image Quality Assessment
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对图像质量评估任务，通过多阶段强化学习改进现有方法，解决了传统RFT方法缺乏"think"过程监督和提升低层视觉感知能力的问题，构建了包含多任务奖励函数的增强型模型。**

- **链接: [http://arxiv.org/pdf/2508.03763v1](http://arxiv.org/pdf/2508.03763v1)**
...
>
---
#### [new 124] ANPrompt: Anti-noise Prompt Tuning for Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文旨在改进视觉-语言模型（VLMs）的鲁棒性，解决传统提示调整方法忽略弱语义扰动问题的任务，提出ANPrompt框架通过构建噪声提示并计算WALoss提升抗噪能力与泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.04677v1](http://arxiv.org/pdf/2508.04677v1)**
...
>
---
#### [new 125] Augmentation-based Domain Generalization and Joint Training from Multiple Source Domains for Whole Heart Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文旨在解决医疗图像分割中领域迁移问题，提出基于增强的多源域联合训练方法，通过5折融合模型实现了对CT和MR数据的最佳性能，验证了其在心脏分割领域的有效性。**

- **链接: [http://arxiv.org/pdf/2508.04552v1](http://arxiv.org/pdf/2508.04552v1)**
...
>
---
#### [new 126] VisionTS++: Cross-Modal Time Series Foundation Model with Continual Pre-trained Visual Backbones
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出一个跨模态时间序列基础模型VisionTS++，解决图像与时序数据的跨模态迁移问题，通过三种创新机制（数据滤波、多维RGB转换、多分位数预测）有效缓解模态差异和不确定性，获得在TSF基准上的SOTA性能，推动了跨模态时间序列模型的发展。**

- **链接: [http://arxiv.org/pdf/2508.04379v1](http://arxiv.org/pdf/2508.04379v1)**
...
>
---
#### [new 130] RPCANet++: Deep Interpretable Robust PCA for Sparse Object Segmentation
- **分类: cs.CV**

- **简介: 该论文旨在解决传统RPCA在稀疏对象分割中的计算效率低、超参数依赖及可解释性不足等问题，提出融合解释性与深度架构的RPCANet++框架，通过结构化模块（BAM/OEM/IRM）和改进的模块机制实现高效且可解释的稀疏对象分割。**

- **链接: [http://arxiv.org/pdf/2508.04190v1](http://arxiv.org/pdf/2508.04190v1)**

> **作者:** Fengyi Wu; Yimian Dai; Tianfang Zhang; Yixuan Ding; Jian Yang; Ming-Ming Cheng; Zhenming Peng
>
> **备注:** Project Webpage: https://fengyiwu98.github.io/rpcanetx
>
...
>
---
#### [new 135] SEAgent: Self-Evolving Computer Use Agent with Autonomous Learning from Experience
...
>
---
#### [new 145] Chain of Questions: Guiding Multimodal Curiosity in Language Models
...
>
---
#### [new 146] CX-Mind: A Pioneering Multimodal Large Language Model for Interleaved Reasoning in Chest X-ray via Curriculum-Guided Reinforcement Learning
...
>
---
#### [new 147] Beyond the Leaderboard: Rethinking Medical Benchmarks for Large Language Models
...
>
---
#### [new 148] ZARA: Zero-shot Motion Time-Series Analysis via Knowledge and Retrieval Driven LLM Agents
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 153] Scaling Artificial Intelligence for Prostate Cancer Detection on MRI towards Population-Based Screening and Primary Diagnosis in a Global, Multiethnic Population (Study Protocol)
- **分类: eess.IV; cs.CV**

- **简介: The study scales AI for prostate cancer detection on MRI to improve population-based screening and diagnosis, training a model with data from intercontinental cohorts and clinical trials. It validates AI accuracy through external testing and analyzes biases via statistical metrics.**

- **链接: [http://arxiv.org/pdf/2508.03762v1](http://arxiv.org/pdf/2508.03762v1)**
...
>
---
#### [new 154] LRTuckerRep: Low-rank Tucker Representation Model for Multi-dimensional Data Completion
- **分类: cs.LG; cs.CV; cs.NA; math.NA**

- **简介: 该论文提出了一种基于 Tucker 分解的多维数据填充模型 LRTuckerRep，解决传统方法因计算复杂度高或破坏数据结构而无法有效填补多维数据的问题。通过自适应权重核正则化与稀疏核心，结合参数自由的拉普拉斯正则化，开发了两个迭代算法并进行了实验验证，显著优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.03755v1](http://arxiv.org/pdf/2508.03755v1)**
...
>
---
#### [new 155] A Modified VGG19-Based Framework for Accurate and Interpretable Real-Time Bone Fracture Detection
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文旨在开发一种基于VGG-19模型的改进框架，解决骨骨折断检测中的准确性和可解释性问题，通过CLAHE预处理、Grad-CAM解释及实时部署实现高精度诊断，达到99.78%的分类准确率和1.00的AUC值，为临床提供可靠、快速且可解释的解决方案。**

- **链接: [http://arxiv.org/pdf/2508.03739v1](http://arxiv.org/pdf/2508.03739v1)**
...
>
---
#### [new 157] FLAT: Latent-Driven Arbitrary-Target Backdoor Attacks in Federated Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出了一种基于潜在驱动的任意目标回放攻击（FLAT），解决FL中因固定模式或单一触发导致的攻击灵活性不足和防御脆弱性问题，通过条件自编码器生成多样化的攻击触发并引入潜在代码实现隐蔽性与多样性提升。**

- **链接: [http://arxiv.org/pdf/2508.04064v1](http://arxiv.org/pdf/2508.04064v1)**
...
>
---
#### [new 158] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
- **分类: cs.GR; cs.CV; cs.LG**

- **简介: 该论文提出RLGS框架，通过轻量级策略模块动态调整3DGS超参数（如学习率、密度阈值），解决传统方法耗时且易受专家控制的问题，有效提升重建质量并验证其泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.04078v1](http://arxiv.org/pdf/2508.04078v1)**
...
>
---
#### [new 161] Boosting Vision Semantic Density with Anatomy Normality Modeling for Medical Vision-language Pre-training
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于医学视觉语言预训练任务，旨在解决语义密度不足导致的视觉对齐偏差问题。通过增强视觉语义和利用正常体分布建模，提升模型对异常信号的识别能力，并在CT图像任务中达到84.9%的AUC，验证了其优越性。**

- **链接: [http://arxiv.org/pdf/2508.03742v1](http://arxiv.org/pdf/2508.03742v1)**
...
>
---
#### [new 162] When Deep Learning Fails: Limitations of Recurrent Models on Stroke-Based Handwriting for Alzheimer's Disease Detection
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文研究了基于深度学习的非侵入性手写识别对阿尔茨海默病检测的有效性，解决了传统模型在处理离散特征时的局限性，通过比较三种递归神经网络与传统机器学习方法，验证了其数据特征与模型设计的不兼容性。**

- **链接: [http://arxiv.org/pdf/2508.03773v1](http://arxiv.org/pdf/2508.03773v1)**
...
>
---
#### [new 163] DRIVE-T: A Methodology for Discriminative and Representative Data Viz Item Selection for Literacy Construct and Assessment
- **分类: cs.HC; cs.CV; K.3; K.3.2**

- **简介: 该论文提出 DRIVE-T 方法，解决数据可视化能力测验中测量构造设计与测试重复性不足的问题，通过三步方法（标签、评分、建模）提升表达力测试的有效性，基于符号学知识构建测量模型并验证其可行性。**

- **链接: [http://arxiv.org/pdf/2508.04160v1](http://arxiv.org/pdf/2508.04160v1)**
...
>
---
#### [new 166] Conditional Fetal Brain Atlas Learning for Automatic Tissue Segmentation
- **分类: eess.IV; cs.CV; cs.LG; 68T07 (Primary) 92C50 (Secondary); I.4.9; I.4.6; I.2.0**

- **简介: 该论文旨在解决MRI评估胎儿脑发育的标准化与精准化难题，通过深度学习框架构建年龄特异性脑图谱，结合直接注册与条件判别器提升分割性能（DSC 86.3%），实现个体化评估并支持临床应用。**

- **链接: [http://arxiv.org/pdf/2508.04522v1](http://arxiv.org/pdf/2508.04522v1)**
...
>
---
#### [new 172] Tell Me Without Telling Me: Two-Way Prediction of Visualization Literacy and Visual Attention
- **分类: cs.HC; cs.CV**

- **简介: 该论文旨在通过两组用户研究发现可视化素养与视觉注意力之间的关联，提出基于这两个变量的预测模型，解决了可视化设计有效性提升的问题，提出了Lit2Sal和Sal2Lit两种方法。**

- **链接: [http://arxiv.org/pdf/2508.03713v1](http://arxiv.org/pdf/2508.03713v1)**
...
- **链接: [http://arxiv.org/pdf/2412.07689v4](http://arxiv.org/pdf/2412.07689v4)**
...
>
---
#### [replaced 004] Through the Magnifying Glass: Adaptive Perception Magnification for Hallucination-Free VLM Decoding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.10183v3](http://arxiv.org/pdf/2503.10183v3)**
...
>
---
#### [replaced 005] OccLE: Label-Efficient 3D Semantic Occupancy Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.20617v2](http://arxiv.org/pdf/2505.20617v2)**
...
>
---
#### [replaced 006] AgentSense: Virtual Sensor Data Generation Using LLM Agents in Simulated Home Environments
- **分类: cs.CV; cs.HC**

- **链接: [http://arxiv.org/pdf/2506.11773v3](http://arxiv.org/pdf/2506.11773v3)**
...
>
---
#### [replaced 007] Interpretable Estimation of CNN Deep Feature Density using Copula and the Generalized Characteristic Function
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.05183v3](http://arxiv.org/pdf/2411.05183v3)**
...
>
---
#### [replaced 015] Zero-Shot Neural Architecture Search with Weighted Response Correlation
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.08841v2](http://arxiv.org/pdf/2507.08841v2)**
...
>
---
#### [replaced 016] Modality and Task Adaptation for Enhanced Zero-shot Composed Image Retrieval
- **分类: cs.CV; cs.IR**

- **链接: [http://arxiv.org/pdf/2410.23736v2](http://arxiv.org/pdf/2410.23736v2)**
...
>
---
#### [replaced 017] The Aging Multiverse: Generating Condition-Aware Facial Aging Tree via Training-Free Diffusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21008v3](http://arxiv.org/pdf/2506.21008v3)**
...
>
---
#### [replaced 018] IS-Bench: Evaluating Interactive Safety of VLM-Driven Embodied Agents in Daily Household Tasks
...
>
---
#### [replaced 025] VOTE: Vision-Language-Action Optimization with Trajectory Ensemble Voting
- **分类: cs.CV; cs.AI; cs.RO**

- **链接: [http://arxiv.org/pdf/2507.05116v3](http://arxiv.org/pdf/2507.05116v3)**
...
>
---
#### [replaced 026] UnMix-NeRF: Spectral Unmixing Meets Neural Radiance Fields
...
>
---
#### [replaced 027] Confounder-Free Continual Learning via Recursive Feature Normalization
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09031v2](http://arxiv.org/pdf/2507.09031v2)**
...
>
---
#### [replaced 031] VISO-Grasp: Vision-Language Informed Spatial Object-centric 6-DoF Active View Planning and Grasping in Clutter and Invisibility
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 034] Ctrl-Z Sampling: Diffusion Sampling with Controlled Random Zigzag Explorations
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.20294v2](http://arxiv.org/pdf/2506.20294v2)**
...
>
---
#### [replaced 037] A Comprohensive Review of Domain Adaptation Techniques for Agricultural Image Analysis in Precision Agriculture
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05972v4](http://arxiv.org/pdf/2506.05972v4)**
...
>
---
#### [replaced 038] GRILL: Gradient Signal Restoration in Ill-Conditioned Layers to Enhance Adversarial Attacks on Autoencoders
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.03646v3](http://arxiv.org/pdf/2505.03646v3)**
...
>
---
#### [replaced 041] CCStereo: Audio-Visual Contextual and Contrastive Learning for Binaural Audio Generation
...
>
---
#### [replaced 044] Vision without Images: End-to-End Computer Vision from Single Compressive Measurements
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.15122v2](http://arxiv.org/pdf/2501.15122v2)**
...
>
---
#### [replaced 047] DiffGAN: A Test Generation Approach for Differential Testing of Deep Neural Networks for Image Analysis
- **分类: cs.CV; cs.LG; cs.SE**

- **链接: [http://arxiv.org/pdf/2410.19794v3](http://arxiv.org/pdf/2410.19794v3)**
...
>
---
#### [replaced 048] HiPrune: Training-Free Visual Token Pruning via Hierarchical Attention in Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.00553v2](http://arxiv.org/pdf/2508.00553v2)**
...
>
---
#### [replaced 049] EchoMimicV3: 1.3B Parameters are All You Need for Unified Multi-Modal and Multi-Task Human Animation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.03905v3](http://arxiv.org/pdf/2507.03905v3)**
...
>
---
#### [replaced 050] NACHOS: Neural Architecture Search for Hardware Constrained Early Exit Neural Networks
- **分类: cs.LG; cs.CV; cs.NE; 68T07**

- **链接: [http://arxiv.org/pdf/2401.13330v3](http://arxiv.org/pdf/2401.13330v3)**

> **作者:** Matteo Gambella; Jary Pomponi; Simone Scardapane; Manuel Roveri
>
> **备注:** Published in IEEE Transactions on Neural Networks and Learning Systems (TNNLS) 2025
>
...
>
---
#### [replaced 051] CHARM: Collaborative Harmonization across Arbitrary Modalities for Modality-agnostic Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03060v2](http://arxiv.org/pdf/2508.03060v2)**
...
>
---
#### [replaced 052] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03643v2](http://arxiv.org/pdf/2508.03643v2)**
...
>
---
#### [replaced 053] CostFilter-AD: Enhancing Anomaly Detection through Matching Cost Filtering
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.01476v3](http://arxiv.org/pdf/2505.01476v3)**
...
>
---
#### [replaced 054] Bidirectional Likelihood Estimation with Multi-Modal Large Language Models for Text-Video Retrieval
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23284v2](http://arxiv.org/pdf/2507.23284v2)**
...
>
---
#### [replaced 055] AURA: A Hybrid Spatiotemporal-Chromatic Framework for Robust, Real-Time Detection of Industrial Smoke Emissions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.01095v2](http://arxiv.org/pdf/2508.01095v2)**
...
>
---
#### [replaced 058] Go-with-the-Flow: Motion-Controllable Video Diffusion Models Using Real-Time Warped Noise
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.08331v5](http://arxiv.org/pdf/2501.08331v5)**
...
>
---
#### [replaced 061] MultiADS: Defect-aware Supervision for Multi-type Anomaly Detection and Segmentation in Zero-Shot Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.06740v2](http://arxiv.org/pdf/2504.06740v2)**

> **作者:** Ylli Sadikaj; Hongkuan Zhou; Lavdim Halilaj; Stefan Schmid; Steffen Staab; Claudia Plant
>
> **摘要:** Precise optical inspection in industrial applications is crucial for minimizing scrap rates and reducing the associated costs. Besides merely detecting if a product is anomalous or not, it is crucial to know the distinct type of defect, such as a bent, cut, or scratch. The ability to recognize the "exact" defect type enables automated treatments of the anomalies in modern production lines. Current methods are limited to solely detecting whether a product is defective or not without providing any insights on the defect type, nevertheless detecting and identifying multiple defects. We propose MultiADS, a zero-shot learning approach, able to perform Multi-type Anomaly Detection and Segmentation. The architecture of MultiADS comprises CLIP and extra linear layers to align the visual- and textual representation in a joint feature space. To the best of our knowledge, our proposal, is the first approach to perform a multi-type anomaly segmentation task in zero-shot learning. Contrary to the other baselines, our approach i) generates specific anomaly masks for each distinct defect type, ii) learns to distinguish defect types, and iii) simultaneously identifies multiple defect types present in an anomalous product. Additionally, our approach outperforms zero/few-shot learning SoTA methods on image-level and pixel-level anomaly detection and segmentation tasks on five commonly used datasets: MVTec-AD, Visa, MPDD, MAD and Real-IAD.
>
---
#### [replaced 062] WAVE: Warp-Based View Guidance for Consistent Novel View Synthesis Using a Single Image
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23518v2](http://arxiv.org/pdf/2506.23518v2)**
...
>
---
#### [replaced 063] AtmosMJ: Revisiting Gating Mechanism for AI Weather Forecasting Beyond the Year Scale
- **分类: cs.LG; cs.AI; cs.CV; physics.ao-ph**

- **链接: [http://arxiv.org/pdf/2506.09733v2](http://arxiv.org/pdf/2506.09733v2)**
...
>
---
#### [replaced 064] Breaking the Modality Barrier: Universal Embedding Learning with Multimodal LLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.17432v3](http://arxiv.org/pdf/2504.17432v3)**
...
>
---
#### [replaced 065] BlurryScope enables compact, cost-effective scanning microscopy for HER2 scoring using deep learning on blurry images
- **分类: eess.IV; cs.CV; cs.LG; physics.med-ph**

- **链接: [http://arxiv.org/pdf/2410.17557v2](http://arxiv.org/pdf/2410.17557v2)**

> **作者:** Michael John Fanous; Christopher Michael Seybold; Hanlong Chen; Nir Pillar; Aydogan Ozcan
>
> **备注:** 22 Pages, 5 Figures, 1 Table
>
> **摘要:** We developed a rapid scanning optical microscope, termed "BlurryScope", that leverages continuous image acquisition and deep learning to provide a cost-effective and compact solution for automated inspection and analysis of tissue sections. This device offers comparable speed to commercial digital pathology scanners, but at a significantly lower price point and smaller size/weight. Using BlurryScope, we implemented automated classification of human epidermal growth factor receptor 2 (HER2) scores on motion-blurred images of immunohistochemically (IHC) stained breast tissue sections, achieving concordant results with those obtained from a high-end digital scanning microscope. Using a test set of 284 unique patient cores, we achieved testing accuracies of 79.3% and 89.7% for 4-class (0, 1+, 2+, 3+) and 2-class (0/1+, 2+/3+) HER2 classification, respectively. BlurryScope automates the entire workflow, from image scanning to stitching and cropping, as well as HER2 score classification.
>
---
#### [replaced 066] DeMo++: Motion Decoupling for Autonomous Driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.17342v2](http://arxiv.org/pdf/2507.17342v2)**
...
>
---
#### [replaced 067] PiT: Progressive Diffusion Transformer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.13219v3](http://arxiv.org/pdf/2505.13219v3)**
...
>
---
#### [replaced 068] Uncertainty-aware Medical Diagnostic Phrase Identification and Grounding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.06798v3](http://arxiv.org/pdf/2404.06798v3)**
...
>
---
#### [replaced 069] False Promises in Medical Imaging AI? Assessing Validity of Outperformance Claims
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.04720v2](http://arxiv.org/pdf/2505.04720v2)**
...
>
> **摘要:** Performance comparisons are fundamental in medical imaging Artificial Intelligence (AI) research, often driving claims of superiority based on relative improvements in common performance metrics. However, such claims frequently rely solely on empirical mean performance. In this paper, we investigate whether newly proposed methods genuinely outperform the state of the art by analyzing a representative cohort of medical imaging papers. We quantify the probability of false claims based on a Bayesian approach that leverages reported results alongside empirically estimated model congruence to estimate whether the relative ranking of methods is likely to have occurred by chance. According to our results, the majority (>80%) of papers claims outperformance when introducing a new method. Our analysis further revealed a high probability (>5%) of false outperformance claims in 86% of classification papers and 53% of segmentation papers. These findings highlight a critical flaw in current benchmarking practices: claims of outperformance in medical imaging AI are frequently unsubstantiated, posing a risk of misdirecting future research efforts.
>
---
#### [replaced 070] Enhancing Multi-view Open-set Learning via Ambiguity Uncertainty Calibration and View-wise Debiasing
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.01227v2](http://arxiv.org/pdf/2508.01227v2)**
...
>
---
#### [replaced 071] Less is More: Token-Efficient Video-QA via Adaptive Frame-Pruning and Semantic Graph Integration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03337v2](http://arxiv.org/pdf/2508.03337v2)**
...
>
---
#### [replaced 072] Beyond Adapter Retrieval: Latent Geometry-Preserving Composition via Sparse Task Projection
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 073] ChartM$^3$: Benchmarking Chart Editing with Multimodal Instructions
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.21167v3](http://arxiv.org/pdf/2507.21167v3)**
...
>
---
#### [replaced 074] Dual-Expert Consistency Model for Efficient and High-Quality Video Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03123v2](http://arxiv.org/pdf/2506.03123v2)**

> **作者:** Zhengyao Lv; Chenyang Si; Tianlin Pan; Zhaoxi Chen; Kwan-Yee K. Wong; Yu Qiao; Ziwei Liu
>
> **备注:** This paper has been accepted to ICCV 2025
>
...
>
---
#### [replaced 075] True Multimodal In-Context Learning Needs Attention to the Visual Context
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.15807v2](http://arxiv.org/pdf/2507.15807v2)**
...
>
---
#### [replaced 076] Synthesizing Near-Boundary OOD Samples for Out-of-Distribution Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.10225v2](http://arxiv.org/pdf/2507.10225v2)**
...
>
---
#### [replaced 077] Mjölnir: A Deep Learning Parametrization Framework for Global Lightning Flash Density
- **分类: cs.LG; cs.AI; cs.CV; physics.ao-ph**

- **链接: [http://arxiv.org/pdf/2504.19822v2](http://arxiv.org/pdf/2504.19822v2)**
...
>
---
#### [replaced 078] OpenScan: A Benchmark for Generalized Open-Vocabulary 3D Scene Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2408.11030v3](http://arxiv.org/pdf/2408.11030v3)**

> **作者:** Youjun Zhao; Jiaying Lin; Shuquan Ye; Qianshi Pang; Rynson W. H. Lau
>
> **备注:** Project Page: https://youjunzhao.github.io/OpenScan/
>
...
>
---
#### [replaced 079] 3DTTNet: Multimodal Fusion-Based 3D Traversable Terrain Modeling for Off-Road Environments
...
>
---
#### [replaced 080] READ: Real-time and Efficient Asynchronous Diffusion for Audio-driven Talking Head Generation
...
>
---
#### [replaced 088] FFHQ-Makeup: Paired Synthetic Makeup Dataset with Facial Consistency Across Multiple Styles
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03241v2](http://arxiv.org/pdf/2508.03241v2)**
...
>
---
#### [replaced 089] SimMLM: A Simple Framework for Multi-modal Learning with Missing Modality
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.19264v2](http://arxiv.org/pdf/2507.19264v2)**
...
>
---
#### [replaced 090] Random Erasing vs. Model Inversion: A Promising Defense or a False Hope?
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2409.01062v3](http://arxiv.org/pdf/2409.01062v3)**
...
>
---
#### [replaced 091] p-MoD: Building Mixture-of-Depths MLLMs via Progressive Ratio Decay
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 092] Live Demonstration: Neuromorphic Radar for Gesture Recognition
- **分类: cs.CV; cs.ET; cs.NE; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2508.03324v2](http://arxiv.org/pdf/2508.03324v2)**

> **作者:** Satyapreet Singh Yadav; Akash K S; Chandra Sekhar Seelamantula; Chetan Singh Thakur
>
...
>
---
#### [replaced 096] Automatic Synthesis of High-Quality Triplet Data for Composed Image Retrieval
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.05970v2](http://arxiv.org/pdf/2507.05970v2)**
...
>
---
#### [replaced 097] NuPlanQA: A Large-Scale Dataset and Benchmark for Multi-View Driving Scene Understanding in Multi-Modal Large Language Models
- **分类: cs.CV; cs.AI; cs.RO**

- **链接: [http://arxiv.org/pdf/2503.12772v2](http://arxiv.org/pdf/2503.12772v2)**
...
>
---
#### [replaced 098] Neutralizing Token Aggregation via Information Augmentation for Efficient Test-Time Adaptation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03388v2](http://arxiv.org/pdf/2508.03388v2)**
...
>
---
#### [replaced 101] ProbRadarM3F: mmWave Radar based Human Skeletal Pose Estimation with Probability Map Guided Multi-Format Feature Fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.05164v4](http://arxiv.org/pdf/2405.05164v4)**
...
>
---
#### [replaced 102] DSOcc: Leveraging Depth Awareness and Semantic Aid to Boost Camera-Based 3D Semantic Occupancy Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.20951v2](http://arxiv.org/pdf/2505.20951v2)**
...
>
---
#### [replaced 103] Enhancing Zero-Shot Brain Tumor Subtype Classification via Fine-Grained Patch-Text Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.01602v2](http://arxiv.org/pdf/2508.01602v2)**
