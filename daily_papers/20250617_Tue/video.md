...
- **简介: 该论文属于少样本动作识别任务，旨在解决单模态数据限制问题。通过主动多模态蒸馏方法，提升识别性能。**
...
- **简介: 该论文属于小目标检测任务，旨在解决无人机图像中小目标检测困难的问题。提出MGDFIS框架，融合多尺度全局与细节特征，提升检测精度与效率。**
...
- **简介: 该论文属于事件相机目标检测任务，解决稀疏事件数据处理效率低的问题，提出SEED模型实现高效时空推理。**
...
- **简介: 该论文属于单目深度估计任务，解决相对深度到度量深度的转换问题。通过融合文本与图像信息，利用注意力机制和对比学习提升模型性能。**
...
- **链接: [http://arxiv.org/pdf/2506.13260v1](http://arxiv.org/pdf/2506.13260v1)**
...
- **简介: 该论文属于3D重建任务，旨在解决传统3DGS方法依赖启发式策略的问题。通过Metropolis-Hastings采样框架，实现自适应的高斯分布优化。**
...
- **简介: 该论文提出LVVO数据集，用于教育视频中的视觉目标检测任务。旨在解决教育视频内容分析问题，通过人工与半监督方法构建高质量标注数据集。**
...
- **链接: [http://arxiv.org/pdf/2506.13224v1](http://arxiv.org/pdf/2506.13224v1)**
...
- **简介: 该论文属于交通目标检测任务，研究CARLA模拟器生成的事件相机数据与真实数据之间的差距，通过实验分析模型在合成与真实数据上的表现差异。**
...
- **简介: 该论文属于GUI组件检测任务，旨在解决IBM i系统屏幕组件自动识别问题。作者构建了标注数据集并开发了检测系统。**
...
>
---
#### [new 039] Generalized Category Discovery under the Long-Tailed Distribution
- **分类: cs.CV**
...
- **简介: 该论文属于无线信号建模任务，旨在解决传统方法精度低和计算成本高的问题。通过引入可变形2D高斯点云渲染技术，实现高效准确的无线辐射场重建。**
...
- **简介: 该论文属于重叠目标感知任务，旨在提升模型区分前景与背景的能力。提出FOAM框架，结合频域与空域特征，增强纹理和轮廓信息提取。**
...
- **简介: 该论文属于高光谱图像合成任务，旨在生成真实丰富的丰度图。通过结合盲解混与扩散模型，实现无监督的高光谱数据增强与仿真。**
...
- **简介: 该论文属于4D场景生成任务，解决多物体视频中复杂场景的动态重建问题。通过结合生成先验与可变形高斯优化，实现更真实的视图合成和精确点轨迹追踪。**
...
- **简介: 该论文研究人类视觉稳定机制，探讨如何在眼动情况下仍感知物体稳定。属于感知神经科学任务，解决视觉信号处理问题，通过实验提出功能与神经电路模型。**
...
- **链接: [http://arxiv.org/pdf/2506.12447v1](http://arxiv.org/pdf/2506.12447v1)**
...
- **简介: 该论文属于目标检测任务，解决恶劣天气下图像退化导致的检测困难问题。提出UniDet-D模型，集成动态光谱注意力机制，实现统一的检测与图像恢复。**
...
- **链接: [http://arxiv.org/pdf/2506.13355v1](http://arxiv.org/pdf/2506.13355v1)**
...
- **简介: 该论文属于图像聚类任务，旨在解决传统方法因缺乏用户意图导致的聚类模糊问题。通过引入文本指导和迭代搜索，生成更符合用户需求的可解释聚类结果。**
...
>
---
#### [new 075] X-Scene: Large-Scale Driving Scene Generation with High Fidelity and Flexible Controllability
- **分类: cs.CV**

- **简介: 该论文属于自动驾驶场景生成任务，旨在解决大规模3D场景生成中空间一致性不足的问题。提出X-Scene框架，实现高保真和灵活控制的场景生成。**

- **链接: [http://arxiv.org/pdf/2506.13558v1](http://arxiv.org/pdf/2506.13558v1)**

> **作者:** Yu Yang; Alan Liang; Jianbiao Mei; Yukai Ma; Yong Liu; Gim Hee Lee
>
> **备注:** 28 pages, 9 figures, Project page at https://x-scene.github.io/
>
...
>
---
#### [new 082] PRISM2: Unlocking Multi-Modal General Pathology AI with Clinical Dialogue
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 095] SA-LUT: Spatial Adaptive 4D Look-Up Table for Photorealistic Style Transfer
- **分类: cs.CV; eess.IV**

- **简介: 该论文属于图像风格迁移任务，解决传统方法在保持结构与局部适应性上的不足。提出SA-LUT，结合LUT效率与神经网络适应性，实现高效精确的色彩转换。**

- **链接: [http://arxiv.org/pdf/2506.13465v1](http://arxiv.org/pdf/2506.13465v1)**
...
>
---
#### [new 101] Towards Fine-Grained Emotion Understanding via Skeleton-Based Micro-Gesture Recognition
- **分类: cs.CV**

- **简介: 该论文属于微表情识别任务，旨在通过骨架序列识别微动作以理解隐藏情绪。针对微动作的细微性、短暂性和低幅度，提出三种改进方法，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2506.12848v1](http://arxiv.org/pdf/2506.12848v1)**
...
>
---
#### [new 102] GS-2DGS: Geometrically Supervised 2DGS for Reflective Object Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，旨在解决高反射物体建模中表面过平滑和计算效率低的问题。通过结合2DGS与几何信息，提出GS-2DGS方法，提升重建质量和速度。**

- **链接: [http://arxiv.org/pdf/2506.13110v1](http://arxiv.org/pdf/2506.13110v1)**
...
>
---
#### [new 106] Fine-Grained HDR Image Quality Assessment From Noticeably Distorted to Very High Fidelity
- **分类: cs.CV**

- **简介: 该论文属于HDR图像质量评估任务，旨在解决高保真范围内主观质量评价难题。构建了AIC-HDR2025数据集，并验证了AIC-3方法的有效性。**

- **链接: [http://arxiv.org/pdf/2506.12505v1](http://arxiv.org/pdf/2506.12505v1)**
...
>
---
#### [new 124] ViewPCL: a point cloud based active learning method for multi-view segmentation
- **分类: cs.CV**

- **简介: 该论文属于多视角语义分割任务，旨在提升主动学习的数据效率与可解释性。通过计算点云分布差异设计新评分机制，实现更优的样本选择。**

- **链接: [http://arxiv.org/pdf/2506.13043v1](http://arxiv.org/pdf/2506.13043v1)**
...
>
---
#### [new 125] Open-Set LiDAR Panoptic Segmentation Guided by Uncertainty-Aware Learning
...
>
---
#### [new 129] EgoPrivacy: What Your First-Person Camera Says About You?
- **分类: cs.CV; cs.CY**
...
>
---
#### [new 130] Omni-AdaVideoRAG: Omni-Contextual Adaptive Retrieval-Augmented for Efficient Long Video Understanding
- **分类: cs.CV**

- **简介: 该论文属于视频理解任务，解决长视频处理中上下文限制和依赖建模不足的问题。提出AdaVideoRAG框架，动态调整检索粒度，提升效率与准确性。**

- **链接: [http://arxiv.org/pdf/2506.13589v1](http://arxiv.org/pdf/2506.13589v1)**
...
>
---
#### [new 131] Automatic Multi-View X-Ray/CT Registration Using Bone Substructure Contours
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学影像配准任务，旨在解决术中X光/CT配准精度低、依赖人工标注的问题。提出基于骨结构轮廓的多视角ICP方法，实现自动、高精度配准。**

- **链接: [http://arxiv.org/pdf/2506.13292v1](http://arxiv.org/pdf/2506.13292v1)**
...
>
---
#### [new 139] MAMMA: Markerless & Automatic Multi-Person Motion Action Capture
- **分类: cs.CV**

- **简介: 该论文提出MAMMA，用于无标记多人动作捕捉，解决传统方法依赖标记、耗时及单人限制问题，通过密集关键点预测实现准确多人交互捕获。**

- **链接: [http://arxiv.org/pdf/2506.13040v1](http://arxiv.org/pdf/2506.13040v1)**
...
>
---
#### [new 145] OscNet v1.5: Energy Efficient Hopfield Network on CMOS Oscillators for Image Classification
- **分类: cs.CV**

- **简介: 该论文属于图像分类任务，旨在解决传统深度学习能耗高的问题。提出OscNet v1.5，基于CMOS振荡器的Hopfield网络，实现高效能图像分类。**

- **链接: [http://arxiv.org/pdf/2506.12610v1](http://arxiv.org/pdf/2506.12610v1)**
...
>
---
#### [new 148] Exploring Audio Cues for Enhanced Test-Time Video Model Adaptation
...
>
---
#### [new 149] SP-VLA: A Joint Model Scheduling and Token Pruning Approach for VLA Model Acceleration
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于VLA模型加速任务，解决其计算成本高和执行频率低的问题。通过模型调度与令牌剪枝联合方法提升效率，保持高精度。**

- **链接: [http://arxiv.org/pdf/2506.12723v1](http://arxiv.org/pdf/2506.12723v1)**
...
>
---
#### [new 160] ICME 2025 Grand Challenge on Video Super-Resolution for Video Conferencing
- **分类: eess.IV; cs.CV; cs.MM**

- **简介: 该论文属于视频超分辨率任务，旨在提升视频会议中低分辨率视频的清晰度。通过因果模型在低延迟下实现高质量上采样，并针对不同视频类型设置多个赛道进行评估。**

- **链接: [http://arxiv.org/pdf/2506.12269v1](http://arxiv.org/pdf/2506.12269v1)**
...
>
---
#### [new 165] AI Flow: Perspectives, Scenarios, and Approaches
...
>
---
#### [new 166] Unsupervised Document and Template Clustering using Multimodal Embeddings
...
>
---
#### [new 170] Simple is what you need for efficient and accurate medical image segmentation
- **分类: eess.IV; cs.AI; cs.CV; I.4.6**

- **简介: 该论文属于医学图像分割任务，旨在提高模型的效率与准确性。通过设计SimpleUNet，解决轻量化与性能平衡的问题，实现高效准确的分割。**

- **链接: [http://arxiv.org/pdf/2506.13415v1](http://arxiv.org/pdf/2506.13415v1)**
...
>
---
#### [new 177] JENGA: Object selection and pose estimation for robotic grasping from a stack
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 180] Adapting by Analogy: OOD Generalization of Visuomotor Policies via Functional Correspondence
...
>
---
#### [new 181] Dynamic Context-oriented Decomposition for Task-aware Low-rank Adaptation with Less Forgetting and Faster Convergence
...
>
---
#### [new 182] A Comprehensive Survey on Continual Learning in Generative Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13045v1](http://arxiv.org/pdf/2506.13045v1)**
...
>
---
#### [new 183] Enhancing Privacy: The Utility of Stand-Alone Synthetic CT and MRI for Tumor and Bone Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学影像分割任务，旨在解决医疗数据隐私与合成数据实用性问题。通过生成对抗网络和扩散模型生成合成影像，并评估其分割效果。**

- **链接: [http://arxiv.org/pdf/2506.12106v1](http://arxiv.org/pdf/2506.12106v1)**
...
>
---
#### [new 185] CertDW: Towards Certified Dataset Ownership Verification via Conformal Prediction
- **分类: cs.LG; cs.AI; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13160v1](http://arxiv.org/pdf/2506.13160v1)**
...
>
---
#### [new 191] TextureSplat: Per-Primitive Texture Mapping for Reflective Gaussian Splatting
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于三维重建任务，旨在解决高反射场景中复杂光照建模问题，通过改进高斯点云渲染方法提升表现。**

- **链接: [http://arxiv.org/pdf/2506.13348v1](http://arxiv.org/pdf/2506.13348v1)**

> **作者:** Mae Younes; Adnane Boukhayma
>
> **备注:** Code will be available at https://github.com/maeyounes/TextureSplat
>
...
>
---
#### [new 192] A Novel ViDAR Device With Visual Inertial Encoder Odometry and Reinforcement Learning-Based Active SLAM Method
...
>
---
#### [new 204] Style-based Composer Identification and Attribution of Symbolic Music Scores: a Systematic Survey
...
>
---
#### [new 205] MM-R5: MultiModal Reasoning-Enhanced ReRanker via Reinforcement Learning for Document Retrieval
...
>
---
#### [new 206] Flexible-length Text Infilling for Discrete Diffusion Models
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [new 207] PLD: A Choice-Theoretic List-Wise Knowledge Distillation
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **简介: 该论文属于知识蒸馏任务，旨在提升模型压缩效果。通过引入PLD方法，利用教师模型的完整分类排名进行知识迁移，优化学生模型性能。**

- **链接: [http://arxiv.org/pdf/2506.12542v1](http://arxiv.org/pdf/2506.12542v1)**
...
>
---
#### [new 208] Metis-RISE: RL Incentivizes and SFT Enhances Multimodal Reasoning Model Learning
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于多模态推理任务，旨在解决模型推理能力不足与训练效率低的问题。提出Metis-RISE方法，结合强化学习与微调提升模型性能。**

- **链接: [http://arxiv.org/pdf/2506.13056v1](http://arxiv.org/pdf/2506.13056v1)**

> **作者:** Haibo Qiu; Xiaohan Lan; Fanfan Liu; Xiaohu Sun; Delian Ruan; Peng Shi; Lin Ma
>
> **备注:** Project Page: https://github.com/MM-Thinking/Metis-RISE
>
> **摘要:** Recent advancements in large language models (LLMs) have witnessed a surge in the development of advanced reasoning paradigms, which are now being integrated into multimodal large language models (MLLMs). However, existing approaches often fall short: methods solely employing reinforcement learning (RL) can struggle with sample inefficiency and activating entirely absent reasoning capabilities, while conventional pipelines that initiate with a cold-start supervised fine-tuning (SFT) phase before RL may restrict the model's exploratory capacity and face suboptimal convergence. In this work, we introduce \textbf{Metis-RISE} (\textbf{R}L \textbf{I}ncentivizes and \textbf{S}FT \textbf{E}nhances) for multimodal reasoning model learning. Unlike conventional approaches, Metis-RISE distinctively omits an initial SFT stage, beginning instead with an RL phase (e.g., using a Group Relative Policy Optimization variant) to incentivize and activate the model's latent reasoning capacity. Subsequently, the targeted SFT stage addresses two key challenges identified during RL: (1) \textit{inefficient trajectory sampling} for tasks where the model possesses but inconsistently applies correct reasoning, which we tackle using self-distilled reasoning trajectories from the RL model itself; and (2) \textit{fundamental capability absence}, which we address by injecting expert-augmented knowledge for prompts where the model entirely fails. This strategic application of RL for incentivization followed by SFT for enhancement forms the core of Metis-RISE, leading to two versions of our MLLMs (7B and 72B parameters). Evaluations on the OpenCompass Multimodal Reasoning Leaderboard demonstrate that both models achieve state-of-the-art performance among similar-sized models, with the 72B version ranking fourth overall.
>
---
#### [new 209] Zero-shot denoising via neural compression: Theoretical and algorithmic framework
- **分类: eess.IV; cs.CV; cs.IT; math.IT**

- **简介: 该论文属于图像去噪任务，解决无训练样本的零样本去噪问题。提出ZS-NCD框架，利用神经压缩技术直接在单张噪声图像上训练，避免过拟合并取得优异性能。**

- **链接: [http://arxiv.org/pdf/2506.12693v1](http://arxiv.org/pdf/2506.12693v1)**
...
>
---
#### [replaced 010] VIViT: Variable-Input Vision Transformer Framework for 3D MR Image Segmentation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.08693v2](http://arxiv.org/pdf/2505.08693v2)**
...
>
---
#### [replaced 014] Video Depth Anything: Consistent Depth Estimation for Super-Long Videos
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.12375v3](http://arxiv.org/pdf/2501.12375v3)**
...
>
> **摘要:** Depth Anything has achieved remarkable success in monocular depth estimation with strong generalization ability. However, it suffers from temporal inconsistency in videos, hindering its practical applications. Various methods have been proposed to alleviate this issue by leveraging video generation models or introducing priors from optical flow and camera poses. Nonetheless, these methods are only applicable to short videos (< 10 seconds) and require a trade-off between quality and computational efficiency. We propose Video Depth Anything for high-quality, consistent depth estimation in super-long videos (over several minutes) without sacrificing efficiency. We base our model on Depth Anything V2 and replace its head with an efficient spatial-temporal head. We design a straightforward yet effective temporal consistency loss by constraining the temporal depth gradient, eliminating the need for additional geometric priors. The model is trained on a joint dataset of video depth and unlabeled images, similar to Depth Anything V2. Moreover, a novel key-frame-based strategy is developed for long video inference. Experiments show that our model can be applied to arbitrarily long videos without compromising quality, consistency, or generalization ability. Comprehensive evaluations on multiple video benchmarks demonstrate that our approach sets a new state-of-the-art in zero-shot video depth estimation. We offer models of different scales to support a range of scenarios, with our smallest model capable of real-time performance at 30 FPS.
>
---
#### [replaced 015] Agentic 3D Scene Generation with Spatially Contextualized VLMs
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2505.20129v2](http://arxiv.org/pdf/2505.20129v2)**
...
>
---
#### [replaced 016] Imagine, Verify, Execute: Memory-Guided Agentic Exploration with Vision-Language Models
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [replaced 017] SurgBench: A Unified Large-Scale Benchmark for Surgical Video Analysis
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.07603v2](http://arxiv.org/pdf/2506.07603v2)**
...
>
---
#### [replaced 020] A Robust Real-Time Lane Detection Method with Fog-Enhanced Feature Fusion for Foggy Conditions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.06121v5](http://arxiv.org/pdf/2504.06121v5)**
...
>
---
#### [replaced 024] Structureless VIO
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 025] Foundation Models in Medical Imaging -- A Review and Outlook
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.09095v3](http://arxiv.org/pdf/2506.09095v3)**
...
>
---
#### [replaced 033] Inherently Faithful Attention Maps for Vision Transformers
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.08915v2](http://arxiv.org/pdf/2506.08915v2)**
...
>
---
#### [replaced 036] Autonomous Computer Vision Development with Agentic AI
- **分类: cs.CV; cs.AI; cs.MA**

- **链接: [http://arxiv.org/pdf/2506.11140v2](http://arxiv.org/pdf/2506.11140v2)**
...
>
---
#### [replaced 037] EmbodiedGen: Towards a Generative 3D World Engine for Embodied Intelligence
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 038] Towards End-to-End Neuromorphic Voxel-based 3D Object Reconstruction Without Physical Priors
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.00741v3](http://arxiv.org/pdf/2501.00741v3)**
...
>
---
#### [replaced 039] Transformers without Normalization
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 045] Learning Coherent Matrixized Representation in Latent Space for Volumetric 4D Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.13238v3](http://arxiv.org/pdf/2403.13238v3)**
...
>
---
#### [replaced 056] VGR: Visual Grounded Reasoning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 057] Segment Concealed Objects with Incomplete Supervision
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.08955v2](http://arxiv.org/pdf/2506.08955v2)**
...
>
---
#### [replaced 059] VideoDeepResearch: Long Video Understanding With Agentic Tool Using
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 060] Test-time Contrastive Concepts for Open-world Semantic Segmentation with Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.05061v3](http://arxiv.org/pdf/2407.05061v3)**
...
>
---
#### [replaced 063] FAMSeg: Fetal Femur and Cranial Ultrasound Segmentation Using Feature-Aware Attention and Mamba Enhancement
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.07431v2](http://arxiv.org/pdf/2506.07431v2)**
...
>
---
#### [replaced 068] Enhancing Logits Distillation with Plug\&Play Kendall's $τ$ Ranking Loss
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2409.17823v2](http://arxiv.org/pdf/2409.17823v2)**
...
>
---
#### [replaced 069] Retrieval-Augmented Dynamic Prompt Tuning for Incomplete Multimodal Learning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.01120v2](http://arxiv.org/pdf/2501.01120v2)**
...
>
---
#### [replaced 072] Bokeh Diffusion: Defocus Blur Control in Text-to-Image Diffusion Models
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.08434v4](http://arxiv.org/pdf/2503.08434v4)**

> **作者:** Armando Fortes; Tianyi Wei; Shangchen Zhou; Xingang Pan
>
> **备注:** Project page: https://atfortes.github.io/projects/bokeh-diffusion/
>
...
>
---
#### [replaced 075] MoH: Multi-Head Attention as Mixture-of-Head Attention
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.11842v2](http://arxiv.org/pdf/2410.11842v2)**
...
>
---
#### [replaced 078] Improving Surgical Risk Prediction Through Integrating Automated Body Composition Analysis: a Retrospective Trial on Colectomy Surgery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.11996v2](http://arxiv.org/pdf/2506.11996v2)**

> **作者:** Hanxue Gu; Yaqian Chen; Jisoo Lee; Diego Schaps; Regina Woody; Roy Colglazier; Maciej A. Mazurowski; Christopher Mantyh
>
...
>
---
#### [replaced 079] Distill CLIP (DCLIP): Enhancing Image-Text Retrieval via Cross-Modal Transformer Distillation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 080] Physics-informed DeepCT: Sinogram Wavelet Decomposition Meets Masked Diffusion
- **分类: eess.IV; cs.CV; physics.med-ph**

- **链接: [http://arxiv.org/pdf/2501.09935v2](http://arxiv.org/pdf/2501.09935v2)**
...
>
---
#### [replaced 081] LATTE: Learning to Think with Vision Specialists
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.05479v3](http://arxiv.org/pdf/2412.05479v3)**
...
>
---
#### [replaced 084] Inst3D-LMM: Instance-Aware 3D Scene Understanding with Multi-modal Instruction Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.00513v2](http://arxiv.org/pdf/2503.00513v2)**

> **作者:** Hanxun Yu; Wentong Li; Song Wang; Junbo Chen; Jianke Zhu
>
> **备注:** CVPR2025, Code Link: https://github.com/hanxunyu/Inst3D-LMM
>
> **摘要:** Despite encouraging progress in 3D scene understanding, it remains challenging to develop an effective Large Multi-modal Model (LMM) that is capable of understanding and reasoning in complex 3D environments. Most previous methods typically encode 3D point and 2D image features separately, neglecting interactions between 2D semantics and 3D object properties, as well as the spatial relationships within the 3D environment. This limitation not only hinders comprehensive representations of 3D scene, but also compromises training and inference efficiency. To address these challenges, we propose a unified Instance-aware 3D Large Multi-modal Model (Inst3D-LMM) to deal with multiple 3D scene understanding tasks simultaneously. To obtain the fine-grained instance-level visual tokens, we first introduce a novel Multi-view Cross-Modal Fusion (MCMF) module to inject the multi-view 2D semantics into their corresponding 3D geometric features. For scene-level relation-aware tokens, we further present a 3D Instance Spatial Relation (3D-ISR) module to capture the intricate pairwise spatial relationships among objects. Additionally, we perform end-to-end multi-task instruction tuning simultaneously without the subsequent task-specific fine-tuning. Extensive experiments demonstrate that our approach outperforms the state-of-the-art methods across 3D scene understanding, reasoning and grounding tasks. Source code is available at https://github.com/hanxunyu/Inst3D-LMM
>
---
#### [replaced 085] Learning-based 3D Reconstruction in Autonomous Driving: A Comprehensive Survey
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 086] Diffusion-Based Depth Inpainting for Transparent and Reflective Objects
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.08567v2](http://arxiv.org/pdf/2410.08567v2)**
...
>
---
#### [replaced 087] Robust Flower Cluster Matching Using The Unscented Transform
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 088] Improving Generalization in MRI-Based Deep Learning Models for Total Knee Replacement Prediction
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.19203v5](http://arxiv.org/pdf/2504.19203v5)**
...
>
---
#### [replaced 089] Blockchain and Biometrics: Survey, GDPR Elements, and Future Directions
- **分类: cs.CV; cs.CR; cs.DC; cs.LG**

- **链接: [http://arxiv.org/pdf/2302.10883v3](http://arxiv.org/pdf/2302.10883v3)**

> **作者:** Mahdi Ghafourian; Ruben Vera-Rodriguez; Julian Fierrez; Bilgesu Sumer; Ruben Tolosana; Aythami Moralez; Els Kindt
>
...
>
---
#### [replaced 092] Zero-Shot Temporal Interaction Localization for Egocentric Videos
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 093] BiFold: Bimanual Cloth Folding with Language Guidance
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 096] Multiverse Through Deepfakes: The MultiFakeVerse Dataset of Person-Centric Visual and Conceptual Manipulations
- **分类: cs.MM; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.00868v2](http://arxiv.org/pdf/2506.00868v2)**
...
>
---
#### [replaced 097] Video Understanding with Large Language Models: A Survey
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 100] Efficient Unsupervised Shortcut Learning Detection and Mitigation in Transformers
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2501.00942v2](http://arxiv.org/pdf/2501.00942v2)**

> **作者:** Lukas Kuhn; Sari Sadiya; Jorg Schlotterer; Florian Buettner; Christin Seifert; Gemma Roig
>
...
>
---
#### [replaced 101] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 102] XYZ-IBD: A High-precision Bin-picking Dataset for Object 6D Pose Estimation Capturing Real-world Industrial Complexity
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.00599v2](http://arxiv.org/pdf/2506.00599v2)**
...
>
---
#### [replaced 124] AirIO: Learning Inertial Odometry with Enhanced IMU Feature Observability
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [replaced 125] Unifying Specialized Visual Encoders for Video Language Models
...
>
---
#### [replaced 126] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
- **分类: cs.CV; cs.LG; eess.IV; math.AT; math.GT; 55N31, 68T45; I.2.10; I.3.7; I.4.5**

- **链接: [http://arxiv.org/pdf/2412.16619v4](http://arxiv.org/pdf/2412.16619v4)**
