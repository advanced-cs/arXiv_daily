...
>
---
#### [new 006] HeartBench: Probing Core Dimensions of Anthropomorphic Intelligence in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出HeartBench，用于评估大语言模型在情感、文化与伦理方面的拟人智能。旨在解决中文语境下相关评估框架缺失的问题，通过构建标准化评测体系提升AI的人类对齐性。**

- **链接: [https://arxiv.org/pdf/2512.21849v1](https://arxiv.org/pdf/2512.21849v1)**
...
>
---
#### [new 015] Bridging the Copyright Gap: Do Large Vision-Language Models Recognize and Respect Copyrighted Content?
- **分类: cs.CL; cs.AI; cs.CR; cs.CY**

- **简介: 该论文属于版权合规任务，旨在解决LVLMs在处理受版权保护内容时识别与尊重不足的问题。通过构建基准数据集并评估模型表现，提出防御框架以降低侵权风险。**

- **链接: [https://arxiv.org/pdf/2512.21871v1](https://arxiv.org/pdf/2512.21871v1)**

> **作者:** Naen Xu; Jinghuai Zhang; Changjiang Li; Hengyu An; Chunyi Zhou; Jun Wang; Boyu Xu; Yuyuan Li; Tianyu Du; Shouling Ji
>
> **备注:** AAAI 2026 (Oral)
>
> **摘要:** Large vision-language models (LVLMs) have achieved remarkable advancements in multimodal reasoning tasks. However, their widespread accessibility raises critical concerns about potential copyright infringement. Will LVLMs accurately recognize and comply with copyright regulations when encountering copyrighted content (i.e., user input, retrieved documents) in the context? Failure to comply with copyright regulations may lead to serious legal and ethical consequences, particularly when LVLMs generate responses based on copyrighted materials (e.g., retrieved book experts, news reports). In this paper, we present a comprehensive evaluation of various LVLMs, examining how they handle copyrighted content -- such as book excerpts, news articles, music lyrics, and code documentation when they are presented as visual inputs. To systematically measure copyright compliance, we introduce a large-scale benchmark dataset comprising 50,000 multimodal query-content pairs designed to evaluate how effectively LVLMs handle queries that could lead to copyright infringement. Given that real-world copyrighted content may or may not include a copyright notice, the dataset includes query-content pairs in two distinct scenarios: with and without a copyright notice. For the former, we extensively cover four types of copyright notices to account for different cases. Our evaluation reveals that even state-of-the-art closed-source LVLMs exhibit significant deficiencies in recognizing and respecting the copyrighted content, even when presented with the copyright notice. To solve this limitation, we introduce a novel tool-augmented defense framework for copyright compliance, which reduces infringement risks in all scenarios. Our findings underscore the importance of developing copyright-aware LVLMs to ensure the responsible and lawful use of copyrighted content.
>
---
#### [new 016] Five Years of SciCap: What We Learned and Future Directions for Scientific Figure Captioning
...
>
---
#### [new 017] Broken Words, Broken Performance: Effect of Tokenization on Performance of LLMs
- **分类: cs.CL**

- **简介: 该论文研究tokenization对LLM性能的影响，属于自然语言处理任务。解决自然词被分割导致性能下降的问题，提出惩罚函数量化tokenization质量。**

- **链接: [https://arxiv.org/pdf/2512.21933v1](https://arxiv.org/pdf/2512.21933v1)**
...
>
---
#### [new 023] Detecting AI-Generated Paraphrases in Bengali: A Comparative Study of Zero-Shot and Fine-Tuned Transformers
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于AI生成文本检测任务，旨在解决 Bengali 语言中区分人类与AI生成文本的问题。通过比较零样本和微调的Transformer模型，提升检测准确率。**

- **链接: [https://arxiv.org/pdf/2512.21709v1](https://arxiv.org/pdf/2512.21709v1)**
...
>
---
#### [new 026] Rethinking Sample Polarity in Reinforcement Learning with Verifiable Rewards
- **分类: cs.CL**

- **简介: 该论文属于强化学习任务，研究样本极性对RLVR训练的影响，提出A3PO方法优化优势分配，提升推理能力。**

- **链接: [https://arxiv.org/pdf/2512.21625v1](https://arxiv.org/pdf/2512.21625v1)**

> **作者:** Xinyu Tang; Yuliang Zhan; Zhixun Li; Wayne Xin Zhao; Zhenduo Zhang; Zujie Wen; Zhiqiang Zhang; Jun Zhou
>
> **摘要:** Large reasoning models (LRMs) are typically trained using reinforcement learning with verifiable reward (RLVR) to enhance their reasoning abilities. In this paradigm, policies are updated using both positive and negative self-generated rollouts, which correspond to distinct sample polarities. In this paper, we provide a systematic investigation into how these sample polarities affect RLVR training dynamics and behaviors. We find that positive samples sharpen existing correct reasoning patterns, while negative samples encourage exploration of new reasoning paths. We further explore how adjusting the advantage values of positive and negative samples at both the sample level and the token level affects RLVR training. Based on these insights, we propose an Adaptive and Asymmetric token-level Advantage shaping method for Policy Optimization, namely A3PO, that more precisely allocates advantage signals to key tokens across different polarities. Experiments across five reasoning benchmarks demonstrate the effectiveness of our approach.
>
---
#### [new 027] SWE-RM: Execution-free Feedback For Software Engineering Agents
- **分类: cs.CL**

- **简介: 该论文属于软件工程代理任务，解决执行反馈不足的问题。通过构建SWE-RM奖励模型，提升代理在测试时缩放和强化学习中的表现。**

- **链接: [https://arxiv.org/pdf/2512.21919v1](https://arxiv.org/pdf/2512.21919v1)**

> **作者:** KaShun Shum; Binyuan Hui; Jiawei Chen; Lei Zhang; X. W.; Jiaxi Yang; Yuzhen Huang; Junyang Lin; Junxian He
>
> **备注:** 21 pages
>
> **摘要:** Execution-based feedback like unit testing is widely used in the development of coding agents through test-time scaling (TTS) and reinforcement learning (RL). This paradigm requires scalable and reliable collection of unit test cases to provide accurate feedback, and the resulting feedback is often sparse and cannot effectively distinguish between trajectories that are both successful or both unsuccessful. In contrast, execution-free feedback from reward models can provide more fine-grained signals without depending on unit test cases. Despite this potential, execution-free feedback for realistic software engineering (SWE) agents remains underexplored. Aiming to develop versatile reward models that are effective across TTS and RL, however, we observe that two verifiers with nearly identical TTS performance can nevertheless yield very different results in RL. Intuitively, TTS primarily reflects the model's ability to select the best trajectory, but this ability does not necessarily generalize to RL. To address this limitation, we identify two additional aspects that are crucial for RL training: classification accuracy and calibration. We then conduct comprehensive controlled experiments to investigate how to train a robust reward model that performs well across these metrics. In particular, we analyze the impact of various factors such as training data scale, policy mixtures, and data source composition. Guided by these investigations, we introduce SWE-RM, an accurate and robust reward model adopting a mixture-of-experts architecture with 30B total parameters and 3B activated during inference. SWE-RM substantially improves SWE agents on both TTS and RL performance. For example, it increases the accuracy of Qwen3-Coder-Flash from 51.6% to 62.0%, and Qwen3-Coder-Max from 67.0% to 74.6% on SWE-Bench Verified using TTS, achieving new state-of-the-art performance among open-source models.
>
---
#### [new 028] CricBench: A Multilingual Benchmark for Evaluating LLMs in Cricket Analytics
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出CricBench，一个用于评估大语言模型在板球分析中表现的多语言基准。解决LLMs在体育数据分析中的领域适应性问题，通过构建高质量数据集并测试多种模型性能。**

- **链接: [https://arxiv.org/pdf/2512.21877v1](https://arxiv.org/pdf/2512.21877v1)**
...
>
---
#### [new 029] Enabling Conversational Behavior Reasoning Capabilities in Full-Duplex Speech
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于对话系统任务，旨在解决全双工对话中的行为推理问题。通过构建图-思想框架，建模对话因果关系，实现意图与言语行为的预测与解释。**

- **链接: [https://arxiv.org/pdf/2512.21706v1](https://arxiv.org/pdf/2512.21706v1)**
...
>
---
#### [new 030] Self-attention vector output similarities reveal how machines pay attention
- **分类: cs.CL**

- **简介: 该论文研究自注意力机制在自然语言处理中的信息处理方式，旨在量化其学习过程。通过分析BERT-12架构，揭示不同注意力头关注的语义特征及相似性分布规律。**

- **链接: [https://arxiv.org/pdf/2512.21956v1](https://arxiv.org/pdf/2512.21956v1)**
...
>
---
#### [new 031] An Information Theoretic Perspective on Agentic System Design
- **分类: cs.LG; cs.AI; cs.CL; cs.IT**

- **简介: 该论文研究agentic系统设计，解决压缩与预测模型选择对性能影响的问题。通过信息论方法评估压缩质量，发现增大压缩器更有效，可提升效率并降低成本。**

- **链接: [https://arxiv.org/pdf/2512.21720v1](https://arxiv.org/pdf/2512.21720v1)**
...
>
---
#### [new 037] MotionTeller: Multi-modal Integration of Wearable Time-Series with LLMs for Health and Behavioral Understanding
- **分类: cs.LG; cs.AI; cs.CL; cs.HC**

- **简介: 该论文提出MotionTeller，将可穿戴设备的生理信号与大语言模型结合，生成自然语言行为摘要。任务是将时间序列数据转化为文本，解决如何从传感器数据中提取有意义的行为描述问题。工作包括构建数据集、设计模型框架并验证效果。**

- **链接: [https://arxiv.org/pdf/2512.21506v1](https://arxiv.org/pdf/2512.21506v1)**
...
>
---
#### [new 038] Perplexity-Aware Data Scaling Law: Perplexity Landscapes Predict Performance for Continual Pre-training
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于持续预训练任务，旨在解决数据利用率低的问题。通过构建感知困惑度的缩放定律，预测模型性能并选择高价值数据。**

- **链接: [https://arxiv.org/pdf/2512.21515v1](https://arxiv.org/pdf/2512.21515v1)**
...
>
---
#### [new 039] Unifying Learning Dynamics and Generalization in Transformers Scaling Law
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究Transformer模型的泛化与学习动态，解决Scaling Law理论基础不足的问题。通过ODE建模和SGD分析，揭示计算资源与泛化误差的关系，提出不同阶段的误差衰减规律。**

- **链接: [https://arxiv.org/pdf/2512.22088v1](https://arxiv.org/pdf/2512.22088v1)**
...
#### [replaced 001] A Causal Lens for Evaluating Faithfulness Metrics
- **分类: cs.CL; cs.AI; cs.LG; stat.ME**

- **简介: 该论文属于模型可解释性任务，旨在评估自然语言解释的忠实性。提出因果诊断框架，通过生成真实与不真实解释对来测试不同度量方法，发现连续指标更有效但易受噪声影响。**

- **链接: [https://arxiv.org/pdf/2502.18848v3](https://arxiv.org/pdf/2502.18848v3)**
...
>
---
#### [replaced 002] Advancing Expert Specialization for Better MoE
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，针对MoE模型中专家重叠和路由不均衡问题，提出两种损失函数以增强专家专业化，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2505.22323v4](https://arxiv.org/pdf/2505.22323v4)**
...
>
---
#### [replaced 003] Toward building next-generation Geocoding systems: a systematic review
- **分类: cs.SE; cs.CL; cs.IR**

- **简介: 该论文属于地理编码系统研究，旨在提升下一代地理编码系统的性能。通过分析技术需求、工作流程和方法局限，提出改进方向与评估策略。**

- **链接: [https://arxiv.org/pdf/2503.18888v2](https://arxiv.org/pdf/2503.18888v2)**
...
>
---
#### [replaced 007] TCM-Eval: An Expert-Level Dynamic and Extensible Benchmark for Traditional Chinese Medicine
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决TCM领域缺乏标准化基准和高质量数据的问题。通过构建TCM-Eval基准和ZhiMingTang模型，提升LLM在TCM中的应用效果。**

- **链接: [https://arxiv.org/pdf/2511.07148v2](https://arxiv.org/pdf/2511.07148v2)**
...
>
---
#### [replaced 011] Research on a hybrid LSTM-CNN-Attention model for text-based web content classification
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于文本分类任务，旨在提升网页内容的分类效果。通过融合LSTM、CNN和注意力机制，结合GloVe嵌入，有效捕捉文本的语法和语义特征，提高分类性能。**

- **链接: [https://arxiv.org/pdf/2512.18475v2](https://arxiv.org/pdf/2512.18475v2)**

> **作者:** Mykola Kuz; Ihor Lazarovych; Mykola Kozlenko; Mykola Pikuliak; Andrii Kvasniuk
>
> **备注:** 10 pages, 5 figures, 2 tables. Published by Radio Electronics Computer Science Control 2025
>
...
>
---
#### [replaced 012] FineFreq: A Multilingual Character Frequency Dataset from Web-Scale Text
- **分类: cs.CL**

- **简介: 该论文介绍FineFreq，一个覆盖1900多种语言的多语言字符频率数据集，解决语言分析与跨语言研究问题。工作包括从大规模文本中提取字符频率，保留多语言特征，并提供结构化格式供分析使用。**

- **链接: [https://arxiv.org/pdf/2512.09701v2](https://arxiv.org/pdf/2512.09701v2)**
...
>
---
#### [replaced 013] Generative Adversarial Reasoner: Enhancing LLM Reasoning with Adversarial Reinforcement Learning
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理中的推理增强任务，旨在解决LLM在数学推理中的错误问题。通过对抗强化学习联合训练模型与判别器，提升推理质量与准确性。**

- **链接: [https://arxiv.org/pdf/2512.16917v2](https://arxiv.org/pdf/2512.16917v2)**
...
>
---
#### [replaced 014] ToTRL: Unlock LLM Tree-of-Thoughts Reasoning Potential through Puzzles Solving
- **分类: cs.CL**

- **简介: 该论文提出ToTRL框架，通过谜题游戏训练大模型发展树状思维能力，解决传统链式推理效率低、冗长的问题。**

- **链接: [https://arxiv.org/pdf/2505.12717v2](https://arxiv.org/pdf/2505.12717v2)**
...
>
---
#### [replaced 015] GroupDebate: Enhancing the Efficiency of Multi-Agent Debate Using Group Discussion
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多智能体辩论任务，旨在降低token成本并提升效率。通过分组讨论减少总tokens消耗，同时提高准确性。**

- **链接: [https://arxiv.org/pdf/2409.14051v2](https://arxiv.org/pdf/2409.14051v2)**

> **作者:** Tongxuan Liu; Xingyu Wang; Weizhe Huang; Wenjiang Xu; Yuting Zeng; Lei Jiang; Hailong Yang; Jing Li
>
> **备注:** Accepted by AAMAS 2026
>
> **摘要:** In recent years, Large Language Models (LLMs) have demonstrated remarkable capabilities across diverse NLP tasks. Extensive research has explored how to enhance the logical reasoning abilities such as Chain-of-Thought, Chain-of-Thought with Self-Consistency, Tree-Of-Thoughts, and multi-agent debates. In the context of multi-agent debates, significant performance improvements can be achieved with an increasing number of agents and debate rounds. However, the escalation in the number of agents and debate rounds can drastically raise the tokens cost of debates, thereby limiting the scalability of the multi-agent debate technique. To better harness the advantages of multi-agent debates in logical reasoning tasks, this paper proposes a method to significantly reduce token cost in multi-agent debates. This approach involves dividing all agents into multiple debate groups, with agents engaging in debates within their respective groups and sharing interim debate results between groups. Comparative experiments across multiple datasets have demonstrated that this method can reduce the total tokens by up to 51.7% during debates and while potentially enhancing accuracy by as much as 25%. Our method significantly enhances the performance and efficiency of interactions in the multi-agent debate.
>
---
#### [replaced 016] Thinking Forward and Backward: Multi-Objective Reinforcement Learning for Retrieval-Augmented Reasoning
- **分类: cs.CL; cs.AI; cs.IR**

- **简介: 该论文属于问答任务，解决复杂推理中RAG效果有限的问题。提出Bi-RAR框架，通过双向评估中间步骤提升推理质量。**

- **链接: [https://arxiv.org/pdf/2511.09109v3](https://arxiv.org/pdf/2511.09109v3)**
...
>
---
#### [replaced 017] Bidirectional Mamba for Single-Cell Data: Efficient Context Learning with Biological Fidelity
- **分类: cs.CL; cs.LG; q-bio.GN**

- **简介: 该论文提出GeneMamba，解决单细胞数据的高效分析问题，通过双向状态空间模型实现线性复杂度，提升计算效率与生物准确性。**

- **链接: [https://arxiv.org/pdf/2504.16956v2](https://arxiv.org/pdf/2504.16956v2)**
...
>
---
#### [replaced 018] AnesSuite: A Comprehensive Benchmark and Dataset Suite for Anesthesiology Reasoning in LLMs
- **分类: cs.CL**

- **简介: 该论文属于医疗推理任务，旨在提升大语言模型在麻醉学领域的推理能力。提出AnesSuite数据集和基准，以及基线模型Morpheus，解决专业领域推理不足的问题。**

- **链接: [https://arxiv.org/pdf/2504.02404v3](https://arxiv.org/pdf/2504.02404v3)**

> **作者:** Xiang Feng; Wentao Jiang; Zengmao Wang; Yong Luo; Pingbo Xu; Baosheng Yu; Hua Jin; Bo Du; Jing Zhang
>
> **备注:** 44 pages, 12 figures, 24 tables
>
...
>
---
#### [replaced 019] Step-DeepResearch Technical Report
- **分类: cs.CL**

- **简介: 该论文属于深度研究任务，旨在解决LLM在开放性研究中的不足。提出Step-DeepResearch框架，提升规划与报告能力，并建立ADR-Bench评估中文场景。**

- **链接: [https://arxiv.org/pdf/2512.20491v3](https://arxiv.org/pdf/2512.20491v3)**
...
>
---
#### [replaced 023] External Hippocampus: Topological Cognitive Maps for Guiding Large Language Model Reasoning
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出External Hippocampus框架，用于解决小模型多步推理中的认知停滞问题。通过构建拓扑认知图，实现高效推理导航，无需额外训练。**

- **链接: [https://arxiv.org/pdf/2512.18190v3](https://arxiv.org/pdf/2512.18190v3)**
...
>
---
#### [replaced 024] Trusted Uncertainty in Large Language Models: A Unified Framework for Confidence Calibration and Risk-Controlled Refusal
- **分类: cs.CL**

- **简介: 该论文提出UniCR框架，解决语言模型在回答时的不确定性问题，通过融合多种证据校准置信度并控制风险，提升模型的可靠性与可信度。**

- **链接: [https://arxiv.org/pdf/2509.01455v2](https://arxiv.org/pdf/2509.01455v2)**
...
>
---
#### [replaced 025] LIBERO-Plus: In-depth Robustness Analysis of Vision-Language-Action Models
...
>
---
#### [replaced 026] BARD: budget-aware reasoning distillation
- **分类: cs.CL**

- **简介: 该论文提出BARD框架，解决长链式推理蒸馏中计算资源浪费问题，通过两阶段训练实现推理能力与计算预算的平衡控制。**

- **链接: [https://arxiv.org/pdf/2511.01470v2](https://arxiv.org/pdf/2511.01470v2)**
...
>
---
#### [replaced 027] Adaptive Focus Memory for Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出AFM，解决多轮对话中上下文管理问题，通过动态分配记忆精度，提升关键约束的保留与应用效果。**

- **链接: [https://arxiv.org/pdf/2511.12712v3](https://arxiv.org/pdf/2511.12712v3)**
...
>
---
#### [replaced 028] ControlAudio: Tackling Text-Guided, Timing-Indicated and Intelligible Audio Generation via Progressive Diffusion Modeling
...
>
---
#### [replaced 034] MobileWorld: Benchmarking Autonomous Mobile Agents in Agent-User Interactive and MCP-Augmented Environments
- **分类: cs.CL**

- **简介: 该论文提出MobileWorld基准，解决现有基准不足的问题，通过真实任务和多应用流程评估自主移动代理，提升评测挑战性与实用性。**

- **链接: [https://arxiv.org/pdf/2512.19432v2](https://arxiv.org/pdf/2512.19432v2)**
...
>
---
#### [replaced 035] Coherence in the brain unfolds across separable temporal regimes
- **分类: q-bio.NC; cs.CL**

- **简介: 该论文研究语言理解中大脑协同处理长期语境与事件边界的能力，通过分析神经信号揭示其不同机制，属于认知神经科学任务，旨在解析语言连贯性的神经基础。**

- **链接: [https://arxiv.org/pdf/2512.20481v3](https://arxiv.org/pdf/2512.20481v3)**
...
>
---
#### [replaced 036] DySK-Attn: A Framework for Efficient, Real-Time Knowledge Updating in Large Language Models via Dynamic Sparse Knowledge Attention
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于知识更新任务，旨在解决LLM知识静态、过时的问题。提出DySK-Attn框架，通过动态知识图谱和稀疏注意力机制，实现高效实时知识整合。**

- **链接: [https://arxiv.org/pdf/2508.07185v2](https://arxiv.org/pdf/2508.07185v2)**
...
>
---
#### [replaced 037] SpidR: Learning Fast and Stable Linguistic Units for Spoken Language Models Without Supervision
...
>
---
#### [replaced 038] X-Boundary: Establishing Exact Safety Boundary to Shield LLMs from Multi-Turn Jailbreaks without Compromising Usability
...
>
---
#### [replaced 039] Computational Economics in Large Language Models: Exploring Model Behavior and Incentive Design under Resource Constraints
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型在资源受限下的效率问题。通过引入计算经济学框架，优化模型计算分配，提升效率与透明度。**

- **链接: [https://arxiv.org/pdf/2508.10426v2](https://arxiv.org/pdf/2508.10426v2)**
...
>
---
#### [replaced 040] The Cultural Gene of Large Language Models: A Study on the Impact of Cross-Corpus Training on Model Values and Biases
- **分类: cs.CL**

- **简介: 论文研究LLM的文化基因，分析跨语料训练对模型价值观和偏见的影响。任务是评估模型文化倾向，解决模型可能存在的文化霸权问题。工作包括构建文化探测数据集，比较东西方模型，计算文化对齐指数。**

- **链接: [https://arxiv.org/pdf/2508.12411v3](https://arxiv.org/pdf/2508.12411v3)**
...
>
---
#### [replaced 041] StepFun-Formalizer: Unlocking the Autoformalization Potential of LLMs through Knowledge-Reasoning Fusion
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自动形式化任务，旨在提升LLMs将自然语言数学表述转化为形式语言的准确性。通过融合知识与推理能力，构建数据集并优化模型，取得SOTA性能。**

- **链接: [https://arxiv.org/pdf/2508.04440v3](https://arxiv.org/pdf/2508.04440v3)**
...
>
---
#### [replaced 042] Unveiling the Learning Mind of Language Models: A Cognitive Framework and Empirical Study
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，旨在探讨大语言模型的学习能力。通过构建认知框架并进行实证研究，分析模型在不同学习维度的表现，提出一个评估基准以提升模型的适应性。**

- **链接: [https://arxiv.org/pdf/2506.13464v3](https://arxiv.org/pdf/2506.13464v3)**
...
>
---
#### [replaced 046] CC-GSEO-Bench: A Content-Centric Benchmark for Measuring Source Influence in Generative Search Engines
- **分类: cs.CL**

- **简介: 该论文提出CC-GSEO-Bench，用于评估生成式搜索引擎中来源文章的影响。任务是量化源内容对合成答案的影响力，解决内容创作者在GSE中的可见性问题。工作包括构建数据集和定义影响维度。**

- **链接: [https://arxiv.org/pdf/2509.05607v2](https://arxiv.org/pdf/2509.05607v2)**
