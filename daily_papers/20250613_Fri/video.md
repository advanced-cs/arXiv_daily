...
- **简介: 该论文属于对抗样本生成任务，旨在解决传统CAPTCHA易受深度学习攻击的问题。提出UAC框架，生成高质量对抗样本，支持定向与非定向攻击。**
...
- **简介: 该论文属于医学图像分类任务，旨在比较CNN与ViT在银屑病图像识别中的表现，结果表明ViT在小模型中表现更优。**
...
- **简介: 该论文属于深度伪造图像检测任务，旨在评估VLMs在无监督情况下检测深度伪造的能力。研究发现VLMs尚不可靠，但可辅助人工检测。**
...
- **简介: 该论文属于人脸识别公平性评估任务，旨在解决现有指标难以检测分布尾部细微偏差的问题。提出CEI指标，可分析真假分数分布，提升偏见检测能力。**
...
- **链接: [http://arxiv.org/pdf/2506.10344v1](http://arxiv.org/pdf/2506.10344v1)**
...
- **简介: 该论文属于图像生成任务，旨在从WiFi信道状态信息（CSI）生成高分辨率图像。通过预训练的潜在扩散模型，直接映射CSI到潜在空间并生成图像，提高了效率和质量。**
...
- **简介: 该论文属于未成年人检测任务，旨在解决数据分布偏移和儿童样本不足的问题，提出多任务模型并引入改进的损失函数与采样策略。**
...
- **简介: 该论文属于皮肤癌分类任务，旨在提升深度学习模型的准确性和可靠性。通过迁移学习和不确定性量化，评估不同模型性能并优化预测可信度。**
...
- **简介: 该论文提出MedSeg-R，解决医学图像分割中依赖显式指令和缺乏推理能力的问题，通过多模态大语言模型生成精准分割掩码。**
...
- **简介: 该论文属于航空制造中的误差评估任务，旨在解决CAD模型在制造与测量中的误差分析问题。提出HEA-MM框架，实现全局、部件和特征层级的误差分析。**
...
- **简介: 该论文属于场景文本检索任务，解决传统方法依赖框标注和查询类型单一的问题。提出MSTAR模型，实现无框检索并支持多类型查询。**
...
- **简介: 该论文属于医学图像分析任务，旨在解决原型方法在可视化与临床解释上的不足。提出PiPViT模型，通过视觉可解释原型提升Retinal OCT图像分类的透明度与准确性。**
...
- **简介: 该论文提出VRBench，用于评估大模型在长叙事视频中的多步骤推理能力，解决现有评估忽略时间推理和过程有效性的不足。**
...
- **简介: 该论文属于医疗文本生成任务，旨在解决SOAP笔记手动编写耗时问题。提出一种弱监督多模态框架，利用有限输入生成结构化临床笔记。**
...
- **简介: 该论文提出SymmFlow，统一解决图像生成、分割和分类任务，通过对称流匹配实现双向一致性和高效采样。**
...
- **简介: 该论文属于农业产量预测任务，旨在解决复杂环境因素下的精准预报问题。通过融合多源数据构建模型，提升加州70余种作物的县级别产量预测精度。**
...
- **链接: [http://arxiv.org/pdf/2506.10712v1](http://arxiv.org/pdf/2506.10712v1)**
...
- **简介: 该论文属于表面太阳辐射反演任务，旨在解决山区因积雪变化导致的反射率估算问题。通过注意力机制模型，从卫星序列中隐式学习表面反射率，提升辐射估算精度。**
...
- **简介: 该论文属于深度伪造检测任务，旨在解决传统方法效率低、模型庞大的问题。提出一种轻量级CNN结合SE块的模型，提升检测效果并减少资源消耗。**
...
- **简介: 该论文提出ViCrit任务，解决VLMs视觉感知不足的问题。通过训练模型识别图像描述中的细微错误，提升其视觉理解能力。**
...
- **简介: 该论文属于自然语言处理与计算机视觉交叉领域，旨在解释Transformer架构的机制并提升其性能。通过图像处理框架，深入分析自注意力机制及组件作用，提出改进方法以增强模型准确性与鲁棒性。**
...
- **简介: 该论文属于参考遥感图像分割任务，旨在解决标注依赖高和场景复杂的问题。提出PSLG-SAM框架，分两阶段实现精准分割。**
...
- **简介: 该论文属于CAD生成任务，解决局部几何可控性问题。通过生成几何指令并结合大语言模型，实现用户指定区域的精准修改。**
...
>
---
#### [new 069] RoCA: Robust Cross-Domain End-to-End Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文属于自动驾驶任务，解决跨域泛化问题。提出RoCA框架，通过概率建模提升模型在不同城市环境中的适应能力。**

- **链接: [http://arxiv.org/pdf/2506.10145v1](http://arxiv.org/pdf/2506.10145v1)**
...
>
---
#### [new 074] Pisces: An Auto-regressive Foundation Model for Image Understanding and Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Pisces，一个自回归多模态基础模型，解决图像理解和生成任务中的统一建模难题。通过分离视觉编码和优化训练策略，提升两者的性能。**

- **链接: [http://arxiv.org/pdf/2506.10395v1](http://arxiv.org/pdf/2506.10395v1)**
...
>
---
#### [new 092] UrbanSense:AFramework for Quantitative Analysis of Urban Streetscapes leveraging Vision Large Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于城市街道景观分析任务，旨在解决传统方法主观性强、难以标准化的问题。通过构建数据集和开发视觉语言模型框架，实现城市风格的定量比较与分析。**

- **链接: [http://arxiv.org/pdf/2506.10342v1](http://arxiv.org/pdf/2506.10342v1)**
...
>
---
#### [new 093] Attention, Please! Revisiting Attentive Probing for Masked Image Modeling
- **分类: cs.CV**

- **简介: 该论文属于自监督学习任务，旨在解决线性探针在MIM模型评估中的不足。通过引入高效注意力探针（EP），提升模型评估效率与性能。**

- **链接: [http://arxiv.org/pdf/2506.10178v1](http://arxiv.org/pdf/2506.10178v1)**
...
>
---
#### [new 100] Edit360: 2D Image Edits to 3D Assets from Any Angle
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于3D内容生成任务，解决多视角一致的3D编辑问题。提出Edit360框架，实现任意视角的2D编辑到3D资产的扩展。**

- **链接: [http://arxiv.org/pdf/2506.10507v1](http://arxiv.org/pdf/2506.10507v1)**
...
>
---
#### [new 103] Semi-Tensor-Product Based Convolutional Neural Networks
- **分类: eess.SY; cs.AI; cs.CV; cs.SY**

- **简介: 该论文属于图像和信号识别任务，旨在解决传统卷积中因填充引入的噪声问题。提出基于半张量积的卷积方法，构建新型CNN模型。**

- **链接: [http://arxiv.org/pdf/2506.10407v1](http://arxiv.org/pdf/2506.10407v1)**

> **作者:** Daizhan Cheng
>
> **摘要:** The semi-tensor product (STP) of vectors is a generalization of conventional inner product of vectors, which allows the factor vectors to of different dimensions. This paper proposes a domain-based convolutional product (CP). Combining domain-based CP with STP of vectors, a new CP is proposed. Since there is no zero or any other padding, it can avoid the junk information caused by padding. Using it, the STP-based convolutional neural network (CNN) is developed. Its application to image and third order signal identifications is considered.
>
---
#### [new 104] Transformer IMU Calibrator: Dynamic On-body IMU Calibration for Inertial Motion Capture
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于惯性运动捕捉任务，解决IMU动态校准问题。通过Transformer模型实现实时估计坐标漂移和测量偏移，无需显式校准流程。**

- **链接: [http://arxiv.org/pdf/2506.10580v1](http://arxiv.org/pdf/2506.10580v1)**
...
>
---
#### [new 105] EmbodiedGen: Towards a Generative 3D World Engine for Embodied Intelligence
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 109] Burn After Reading: Do Multimodal Large Language Models Truly Capture Order of Events in Image Sequences?
- **分类: cs.CL; cs.CV**

- **简介: 该论文属于多模态时间推理任务，旨在评估MLLM在图像序列中的事件顺序理解能力。提出TempVS基准，测试模型在事件关系、句子和图像排序上的表现。**
...
>
---
#### [new 110] Rethinking Brain Tumor Segmentation from the Frequency Domain Perspective
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在提升脑肿瘤增强区域的分割精度。通过引入频率域分析方法，设计了FDD、ALC和FDCA模块，显著提高了分割效果。**

- **链接: [http://arxiv.org/pdf/2506.10142v1](http://arxiv.org/pdf/2506.10142v1)**
...
>
---
#### [new 115] EQ-TAA: Equivariant Traffic Accident Anticipation via Diffusion-Based Accident Video Synthesis
...
>
---
#### [new 116] HER2 Expression Prediction with Flexible Multi-Modal Inputs via Dynamic Bidirectional Reconstruction
- **分类: cs.MM; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于乳腺癌HER2表达预测任务，解决单/双模态数据不匹配问题，通过动态重建与融合提升预测精度。**

- **链接: [http://arxiv.org/pdf/2506.10006v1](http://arxiv.org/pdf/2506.10006v1)**
...
>
---
#### [new 124] Energy Aware Camera Location Search Algorithm for Increasing Precision of Observation in Automated Manufacturing
- **分类: eess.SY; cs.CV; cs.SY; 93C85 (Primary), 93B52 (Secondary)**

- **简介: 该论文属于自动化制造中的视觉伺服任务，旨在提升眼手配置下的观测精度。通过优化相机位置，减少图像噪声，提高观测准确性。**

- **链接: [http://arxiv.org/pdf/2506.10251v1](http://arxiv.org/pdf/2506.10251v1)**

> **作者:** Rongfei Li; Francis Assadian
>
> **备注:** 35 pages, 24 figures, Journal, Published in: Applied Sciences, 2024, vol. 14, article 9140. For published version, see this http URL: https://doi.org/10.3390/app14199140
>
...
>
---
#### [new 125] Eye, Robot: Learning to Look to Act with a BC-RL Perception-Action Loop
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 126] A Navigation Framework Utilizing Vision-Language Models
...
>
---
#### [new 127] Prompt-Guided Latent Diffusion with Predictive Class Conditioning for 3D Prostate MRI Generation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像生成任务，旨在解决医疗数据稀缺问题。通过提出CCELLA方法，实现高效、高质量的3D前列腺MRI生成。**

- **链接: [http://arxiv.org/pdf/2506.10230v1](http://arxiv.org/pdf/2506.10230v1)**
...
>
---
#### [new 131] Geometric Regularity in Deterministic Sampling of Diffusion-based Generative Models
- **分类: cs.LG; cs.CV; stat.ML**

- **简介: 该论文研究扩散生成模型的采样轨迹几何规律，揭示其低维子空间特性及“飞镖”形状，提出动态规划优化采样时间调度，提升生成效果。**

- **链接: [http://arxiv.org/pdf/2506.10177v1](http://arxiv.org/pdf/2506.10177v1)**
...
#### [replaced 001] Spike-TBR: a Noise Resilient Neuromorphic Event Representation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04817v2](http://arxiv.org/pdf/2506.04817v2)**
...
>
---
#### [replaced 002] TDS-CLIP: Temporal Difference Side Network for Efficient VideoAction Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2408.10688v2](http://arxiv.org/pdf/2408.10688v2)**

> **作者:** Bin Wang; Wentong Li; Wenqian Wang; Mingliang Gao; Runmin Cong; Wei Zhang
>
...
>
---
#### [replaced 003] Tile Classification Based Viewport Prediction with Multi-modal Fusion Transformer
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2309.14704v4](http://arxiv.org/pdf/2309.14704v4)**
...
- **链接: [http://arxiv.org/pdf/2505.22654v2](http://arxiv.org/pdf/2505.22654v2)**

> **作者:** Ce Zhang; Kaixin Ma; Tianqing Fang; Wenhao Yu; Hongming Zhang; Zhisong Zhang; Yaqi Xie; Katia Sycara; Haitao Mi; Dong Yu
>
> **备注:** Changes from v1: Uploaded code link and fixed minor typos
>
...
>
---
#### [replaced 005] Video-CoT: A Comprehensive Dataset for Spatiotemporal Understanding of Videos Based on Chain-of-Thought
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08817v3](http://arxiv.org/pdf/2506.08817v3)**
...
>
---
#### [replaced 010] What Changed and What Could Have Changed? State-Change Counterfactuals for Procedure-Aware Video Representation Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.21055v3](http://arxiv.org/pdf/2503.21055v3)**
...
>
---
#### [replaced 011] AR-RAG: Autoregressive Retrieval Augmentation for Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.06962v2](http://arxiv.org/pdf/2506.06962v2)**
...
>
---
#### [replaced 012] Enhancing Glass Defect Detection with Diffusion Models: Addressing Imbalanced Datasets in Manufacturing Quality Control
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.03134v2](http://arxiv.org/pdf/2505.03134v2)**
...
>
---
#### [replaced 013] Expert Race: A Flexible Routing Strategy for Scaling Diffusion Transformer with Mixture of Experts
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.16057v3](http://arxiv.org/pdf/2503.16057v3)**

> **作者:** Yike Yuan; Ziyu Wang; Zihao Huang; Defa Zhu; Xun Zhou; Jingyi Yu; Qiyang Min
>
> **摘要:** Diffusion models have emerged as mainstream framework in visual generation. Building upon this success, the integration of Mixture of Experts (MoE) methods has shown promise in enhancing model scalability and performance. In this paper, we introduce Race-DiT, a novel MoE model for diffusion transformers with a flexible routing strategy, Expert Race. By allowing tokens and experts to compete together and select the top candidates, the model learns to dynamically assign experts to critical tokens. Additionally, we propose per-layer regularization to address challenges in shallow layer learning, and router similarity loss to prevent mode collapse, ensuring better expert utilization. Extensive experiments on ImageNet validate the effectiveness of our approach, showcasing significant performance gains while promising scaling properties.
>
---
#### [replaced 014] Simultaneous Localization and Affordance Prediction of Tasks from Egocentric Video
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 015] MMME: A Spontaneous Multi-Modal Micro-Expression Dataset Enabling Visual-Physiological Fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.09834v2](http://arxiv.org/pdf/2506.09834v2)**
...
>
---
#### [replaced 016] AgentThink: A Unified Framework for Tool-Augmented Chain-of-Thought Reasoning in Vision-Language Models for Autonomous Driving
...
>
---
#### [replaced 017] Peer-Ranked Precision: Creating a Foundational Dataset for Fine-Tuning Vision Models from DataSeeds' Annotated Imagery
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05673v3](http://arxiv.org/pdf/2506.05673v3)**
...
>
---
#### [replaced 020] InceptionMamba: An Efficient Hybrid Network with Large Band Convolution and Bottleneck Mamba
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08735v2](http://arxiv.org/pdf/2506.08735v2)**
...
>
---
#### [replaced 021] DeepVideo-R1: Video Reinforcement Fine-Tuning via Difficulty-aware Regressive GRPO
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.07464v2](http://arxiv.org/pdf/2506.07464v2)**
...
>
---
#### [replaced 022] Aesthetics Without Semantics
- **分类: cs.CV; q-bio.NC; stat.CO**

- **链接: [http://arxiv.org/pdf/2505.05331v2](http://arxiv.org/pdf/2505.05331v2)**

> **作者:** C. Alejandro Parraga; Olivier Penacchio; Marcos Muňoz Gonzalez; Bogdan Raducanu; Xavier Otazu
>
...
>
---
#### [replaced 025] ViC-Bench: Benchmarking Visual-Interleaved Chain-of-Thought Capability in MLLMs with Free-Style Intermediate State Representations
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.14404v2](http://arxiv.org/pdf/2505.14404v2)**
...
>
---
#### [replaced 032] Urban1960SatSeg: Unsupervised Semantic Segmentation of Mid-20$^{th}$ century Urban Landscapes with Satellite Imageries
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.09476v2](http://arxiv.org/pdf/2506.09476v2)**
...
>
---
#### [replaced 035] Reinforcing Multimodal Understanding and Generation with Dual Self-rewards
- **分类: cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07963v2](http://arxiv.org/pdf/2506.07963v2)**
...
>
---
#### [replaced 040] Towards Reliable Identification of Diffusion-based Image Manipulations
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05466v2](http://arxiv.org/pdf/2506.05466v2)**
...
>
---
#### [replaced 041] Glimpse: Generalized Locality for Scalable and Robust CT
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2401.00816v3](http://arxiv.org/pdf/2401.00816v3)**

> **作者:** AmirEhsan Khorashadizadeh; Valentin Debarnot; Tianlin Liu; Ivan Dokmanić
>
...
>
---
#### [replaced 042] Mitigating Object Hallucination in Large Vision-Language Models via Image-Grounded Guidance
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2402.08680v2](http://arxiv.org/pdf/2402.08680v2)**

> **作者:** Linxi Zhao; Yihe Deng; Weitong Zhang; Quanquan Gu
>
> **备注:** 25 pages, 13 figures, 25 tables
>
...
>
---
#### [replaced 045] GPT4RoI: Instruction Tuning Large Language Model on Region-of-Interest
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2307.03601v5](http://arxiv.org/pdf/2307.03601v5)**

> **作者:** Shilong Zhang; Peize Sun; Shoufa Chen; Min Xiao; Wenqi Shao; Wenwei Zhang; Yu Liu; Kai Chen; Ping Luo
>
> **备注:** ECCV2024-Workshop, Camera-ready
>
...
>
---
#### [replaced 046] High Performance Space Debris Tracking in Complex Skylight Backgrounds with a Large-Scale Dataset
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.02614v3](http://arxiv.org/pdf/2506.02614v3)**
...
>
---
#### [replaced 047] Towards Holistic Visual Quality Assessment of AI-Generated Videos: A LLM-Based Multi-Dimensional Evaluation Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04715v2](http://arxiv.org/pdf/2506.04715v2)**
...
>
---
#### [replaced 048] Visually Descriptive Language Model for Vector Graphics Reasoning
- **分类: cs.CL; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2404.06479v5](http://arxiv.org/pdf/2404.06479v5)**
...
>
---
#### [replaced 052] CompMarkGS: Robust Watermarking for Compressed 3D Gaussian Splatting
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.12836v5](http://arxiv.org/pdf/2503.12836v5)**
...
>
---
#### [replaced 055] CapST: Leveraging Capsule Networks and Temporal Attention for Accurate Model Attribution in Deep-fake Videos
- **分类: cs.CV; acmart**

- **链接: [http://arxiv.org/pdf/2311.03782v4](http://arxiv.org/pdf/2311.03782v4)**

> **作者:** Wasim Ahmad; Yan-Tsung Peng; Yuan-Hao Chang; Gaddisa Olani Ganfure; Sarwar Khan
>
