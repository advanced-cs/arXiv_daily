...
#### [new 001] VQ-Seg: Vector-Quantized Token Perturbation for Semi-Supervised Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于半监督医学图像分割任务，旨在解决现有方法依赖敏感超参数dropout的问题。提出VQ-Seg，利用向量量化实现可控的特征扰动，提升分割效果。**

- **链接: [https://arxiv.org/pdf/2601.10124v1](https://arxiv.org/pdf/2601.10124v1)**

> **作者:** Sicheng Yang; Zhaohu Xing; Lei Zhu
>
> **备注:** Accepted by NeurIPS 2025
>
> **摘要:** Consistency learning with feature perturbation is a widely used strategy in semi-supervised medical image segmentation. However, many existing perturbation methods rely on dropout, and thus require a careful manual tuning of the dropout rate, which is a sensitive hyperparameter and often difficult to optimize and may lead to suboptimal regularization. To overcome this limitation, we propose VQ-Seg, the first approach to employ vector quantization (VQ) to discretize the feature space and introduce a novel and controllable Quantized Perturbation Module (QPM) that replaces dropout. Our QPM perturbs discrete representations by shuffling the spatial locations of codebook indices, enabling effective and controllable regularization. To mitigate potential information loss caused by quantization, we design a dual-branch architecture where the post-quantization feature space is shared by both image reconstruction and segmentation tasks. Moreover, we introduce a Post-VQ Feature Adapter (PFA) to incorporate guidance from a foundation model (FM), supplementing the high-level semantic information lost during quantization. Furthermore, we collect a large-scale Lung Cancer (LC) dataset comprising 828 CT scans annotated for central-type lung carcinoma. Extensive experiments on the LC dataset and other public benchmarks demonstrate the effectiveness of our method, which outperforms state-of-the-art approaches. Code available at: https://github.com/script-Yang/VQ-Seg.
>
---
#### [new 002] CURVE: A Benchmark for Cultural and Multilingual Long Video Reasoning
- **分类: cs.CV**

- **简介: 该论文提出CURVE基准，解决多文化、多语言视频推理问题。针对现有数据偏西方化和语言单一的问题，构建了跨区域、多语言的高质量视频数据集，并设计复杂推理任务，推动视频模型对文化语境的理解。**

- **链接: [https://arxiv.org/pdf/2601.10649v1](https://arxiv.org/pdf/2601.10649v1)**
...
>
---
#### [new 003] Transition Matching Distillation for Fast Video Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视频生成任务，旨在解决扩散模型推理速度慢的问题。通过TMD框架，将多步扩散模型压缩为少步生成器，提升效率同时保持质量。**

- **链接: [https://arxiv.org/pdf/2601.09881v1](https://arxiv.org/pdf/2601.09881v1)**
...
>
---
#### [new 004] LaViT: Aligning Latent Visual Thoughts for Multi-modal Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态推理任务，旨在解决视觉注意力与语言输出不一致的问题。提出LaViT框架，对齐视觉隐含思想，提升视觉基础能力。**

- **链接: [https://arxiv.org/pdf/2601.10129v1](https://arxiv.org/pdf/2601.10129v1)**

> **作者:** Linquan Wu; Tianxiang Jiang; Yifei Dong; Haoyu Yang; Fengji Zhang; Shichaang Meng; Ai Xuan; Linqi Song; Jacky Keung
>
> **摘要:** Current multimodal latent reasoning often relies on external supervision (e.g., auxiliary images), ignoring intrinsic visual attention dynamics. In this work, we identify a critical Perception Gap in distillation: student models frequently mimic a teacher's textual output while attending to fundamentally divergent visual regions, effectively relying on language priors rather than grounded perception. To bridge this, we propose LaViT, a framework that aligns latent visual thoughts rather than static embeddings. LaViT compels the student to autoregressively reconstruct the teacher's visual semantics and attention trajectories prior to text generation, employing a curriculum sensory gating mechanism to prevent shortcut learning. Extensive experiments show that LaViT significantly enhances visual grounding, achieving up to +16.9% gains on complex reasoning tasks and enabling a compact 3B model to outperform larger open-source variants and proprietary models like GPT-4o.
>
---
#### [new 005] Unleashing the Capabilities of Large Vision-Language Models for Intelligent Perception of Roadside Infrastructure
- **分类: cs.CV**

- **简介: 该论文属于智能道路设施感知任务，旨在提升大视觉语言模型在城市基础设施识别中的准确性与专业合规性。通过领域适应框架和知识推理机制，提高检测与属性识别性能。**

- **链接: [https://arxiv.org/pdf/2601.10551v1](https://arxiv.org/pdf/2601.10551v1)**

> **作者:** Luxuan Fu; Chong Liu; Bisheng Yang; Zhen Dong
>
> **摘要:** Automated perception of urban roadside infrastructure is crucial for smart city management, yet general-purpose models often struggle to capture the necessary fine-grained attributes and domain rules. While Large Vision Language Models (VLMs) excel at open-world recognition, they often struggle to accurately interpret complex facility states in compliance with engineering standards, leading to unreliable performance in real-world applications. To address this, we propose a domain-adapted framework that transforms VLMs into specialized agents for intelligent infrastructure analysis. Our approach integrates a data-efficient fine-tuning strategy with a knowledge-grounded reasoning mechanism. Specifically, we leverage open-vocabulary fine-tuning on Grounding DINO to robustly localize diverse assets with minimal supervision, followed by LoRA-based adaptation on Qwen-VL for deep semantic attribute reasoning. To mitigate hallucinations and enforce professional compliance, we introduce a dual-modality Retrieval-Augmented Generation (RAG) module that dynamically retrieves authoritative industry standards and visual exemplars during inference. Evaluated on a comprehensive new dataset of urban roadside scenes, our framework achieves a detection performance of 58.9 mAP and an attribute recognition accuracy of 95.5%, demonstrating a robust solution for intelligent infrastructure monitoring.
>
---
#### [new 006] Handling Missing Modalities in Multimodal Survival Prediction for Non-Small Cell Lung Cancer
- **分类: cs.CV; cs.AI; cs.MM**

- **简介: 该论文属于多模态生存预测任务，解决NSCLC中缺失模态的问题。通过融合CT、WSI和临床数据，提出一种对缺失模态鲁棒的框架，提升生存预测效果。**

- **链接: [https://arxiv.org/pdf/2601.10386v1](https://arxiv.org/pdf/2601.10386v1)**
...
>
---
#### [new 009] CoF-T2I: Video Models as Pure Visual Reasoners for Text-to-Image Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出CoF-T2I模型，将视频生成中的链式帧推理应用于文本到图像生成，解决T2I中缺乏明确推理过程的问题。通过渐进视觉优化提升生成质量。**

- **链接: [https://arxiv.org/pdf/2601.10061v1](https://arxiv.org/pdf/2601.10061v1)**
...
>
---
#### [new 013] Lunar-G2R: Geometry-to-Reflectance Learning for High-Fidelity Lunar BRDF Estimation
- **分类: cs.CV**

- **简介: 该论文属于行星表面反射率估计任务，旨在解决 lunar regolith 反射率建模问题。通过几何到反射率的学习框架，直接从地形数据预测空间变化的 BRDF 参数，提升渲染真实感。**

- **链接: [https://arxiv.org/pdf/2601.10449v1](https://arxiv.org/pdf/2601.10449v1)**
...
>
---
#### [new 015] Breaking the Limits of Open-Weight CLIP: An Optimization Framework for Self-supervised Fine-tuning of CLIP
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于多模态表示学习任务，旨在提升开放权重CLIP模型在多个下游任务上的性能。针对直接微调导致性能下降的问题，提出TuneCLIP框架，通过优化策略实现高效适应。**

- **链接: [https://arxiv.org/pdf/2601.09859v1](https://arxiv.org/pdf/2601.09859v1)**
...
>
---
#### [new 018] Optimizing Multimodal LLMs for Egocentric Video Understanding: A Solution for the HD-EPIC VQA Challenge
- **分类: cs.CV; cs.MM; eess.IV**

- **简介: 该论文针对egocentric视频理解任务，解决HD-EPIC VQA挑战中的复杂问答问题。通过优化多模态大模型，提升准确率至41.6%。**

- **链接: [https://arxiv.org/pdf/2601.10228v1](https://arxiv.org/pdf/2601.10228v1)**
...
>
> **摘要:** Multimodal Large Language Models (MLLMs) struggle with complex video QA benchmarks like HD-EPIC VQA due to ambiguous queries/options, poor long-range temporal reasoning, and non-standardized outputs. We propose a framework integrating query/choice pre-processing, domain-specific Qwen2.5-VL fine-tuning, a novel Temporal Chain-of-Thought (T-CoT) prompting for multi-step reasoning, and robust post-processing. This system achieves 41.6% accuracy on HD-EPIC VQA, highlighting the need for holistic pipeline optimization in demanding video understanding. Our code, fine-tuned models are available at https://github.com/YoungSeng/Egocentric-Co-Pilot.
>
---
#### [new 019] FlowAct-R1: Towards Interactive Humanoid Video Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于交互式人形视频生成任务，解决高保真与实时性矛盾的问题。提出FlowAct-R1框架，采用分块扩散策略和优化技术，实现低延迟、高帧率的实时交互视频生成。**

- **链接: [https://arxiv.org/pdf/2601.10103v1](https://arxiv.org/pdf/2601.10103v1)**
...
>
---
#### [new 020] DanQing: An Up-to-Date Large-Scale Chinese Vision-Language Pre-training Dataset
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出DanQing，一个大规模高质量中文图文预训练数据集，旨在解决中文视觉-语言预训练数据不足的问题。**

- **链接: [https://arxiv.org/pdf/2601.10305v1](https://arxiv.org/pdf/2601.10305v1)**
...
>
> **摘要:** Vision-Language Pre-training (VLP) models demonstrate strong performance across various downstream tasks by learning from large-scale image-text pairs through contrastive pretraining. The release of extensive English image-text datasets (e.g., COYO-700M and LAION-400M) has enabled widespread adoption of models such as CLIP and SigLIP in tasks including cross-modal retrieval and image captioning. However, the advancement of Chinese vision-language pretraining has substantially lagged behind, due to the scarcity of high-quality Chinese image-text data. To address this gap, we develop a comprehensive pipeline for constructing a high-quality Chinese cross-modal dataset. As a result, we propose DanQing, which contains 100 million image-text pairs collected from Common Crawl. Different from existing datasets, DanQing is curated through a more rigorous selection process, yielding superior data quality. Moreover, DanQing is primarily built from 2024-2025 web data, enabling models to better capture evolving semantic trends and thus offering greater practical utility. We compare DanQing with existing datasets by continual pre-training of the SigLIP2 model. Experimental results show that DanQing consistently achieves superior performance across a range of Chinese downstream tasks, including zero-shot classification, cross-modal retrieval, and LMM-based evaluations. To facilitate further research in Chinese vision-language pre-training, we will open-source the DanQing dataset under the Creative Common CC-BY 4.0 license.
>
---
#### [new 021] OT-Drive: Out-of-Distribution Off-Road Traversable Area Segmentation via Optimal Transport
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于自动驾驶中的分割任务，解决OOD场景下分割性能下降的问题。提出OT-Drive框架，通过最优传输实现多模态融合，提升分割效果。**

- **链接: [https://arxiv.org/pdf/2601.09952v1](https://arxiv.org/pdf/2601.09952v1)**
...
>
---
#### [new 023] ReaMIL: Reasoning- and Evidence-Aware Multiple Instance Learning for Whole-Slide Histopathology
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出ReaMIL，用于全切片病理分析的多实例学习方法，解决如何高效选择关键证据区域的问题。通过引入轻量选择头，在保证性能的同时减少所需tiles数量。**

- **链接: [https://arxiv.org/pdf/2601.10073v1](https://arxiv.org/pdf/2601.10073v1)**
...
>
---
#### [new 024] Attend to what I say: Highlighting relevant content on slides
- **分类: cs.CV**

- **简介: 该论文属于多媒体内容理解任务，旨在解决演讲中语音与幻灯片内容不同步的问题。通过分析语音并匹配幻灯片内容，自动突出显示相关区域，提升听众理解效果。**

- **链接: [https://arxiv.org/pdf/2601.10244v1](https://arxiv.org/pdf/2601.10244v1)**
...
>
> **摘要:** Accurately localizing 3D objects like pedestrians, cyclists, and other vehicles is essential in Autonomous Driving. To ensure high detection performance, Autonomous Vehicles complement RGB cameras with LiDAR sensors, but effectively combining these data sources for 3D object detection remains challenging. We propose LCF3D, a novel sensor fusion framework that combines a 2D object detector on RGB images with a 3D object detector on LiDAR point clouds. By leveraging multimodal fusion principles, we compensate for inaccuracies in the LiDAR object detection network. Our solution combines two key principles: (i) late fusion, to reduce LiDAR False Positives by matching LiDAR 3D detections with RGB 2D detections and filtering out unmatched LiDAR detections; and (ii) cascade fusion, to recover missed objects from LiDAR by generating new 3D frustum proposals corresponding to unmatched RGB detections. Experiments show that LCF3D is beneficial for domain generalization, as it turns out to be successful in handling different sensor configurations between training and testing domains. LCF3D achieves significant improvements over LiDAR-based methods, particularly for challenging categories like pedestrians and cyclists in the KITTI dataset, as well as motorcycles and bicycles in nuScenes. Code can be downloaded from: https://github.com/CarloSgaravatti/LCF3D.
>
---
#### [new 028] DW-DGAT: Dynamically Weighted Dual Graph Attention Network for Neurodegenerative Disease Diagnosis
- **分类: cs.CV**

- **简介: 该论文属于神经退行性疾病诊断任务，旨在解决多模态数据高维、异构及类别不平衡问题。提出DW-DGAT模型，融合数据并提取多尺度特征，提升诊断效果。**

- **链接: [https://arxiv.org/pdf/2601.10001v1](https://arxiv.org/pdf/2601.10001v1)**
...
>
---
#### [new 029] InfoSculpt: Sculpting the Latent Space for Generalized Category Discovery
- **分类: cs.CV**

- **简介: 该论文属于广义类别发现任务，旨在从大规模未标记数据中分类已知和新类别。提出InfoSculpt框架，通过信息瓶颈原理优化潜在空间，分离类别信息与噪声。**

- **链接: [https://arxiv.org/pdf/2601.10098v1](https://arxiv.org/pdf/2601.10098v1)**
...
>
---
#### [new 042] V-Zero: Self-Improving Multimodal Reasoning with Zero Annotation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于多模态推理任务，旨在解决依赖人工标注数据的问题。通过自监督方法，利用未标注图像进行模型优化，提升视觉语言模型性能。**

- **链接: [https://arxiv.org/pdf/2601.10094v1](https://arxiv.org/pdf/2601.10094v1)**
...
>
---
#### [new 043] Urban Socio-Semantic Segmentation with Vision-Language Reasoning
- **分类: cs.CV; cs.AI; cs.CY**

- **简介: 该论文属于城市语义分割任务，解决社会语义实体识别问题。提出SocioSeg数据集和SocioReasoner框架，通过视觉-语言推理实现更准确的分割。**

- **链接: [https://arxiv.org/pdf/2601.10477v1](https://arxiv.org/pdf/2601.10477v1)**
...
>
---
#### [new 044] Global Context Compression with Interleaved Vision-Text Transformation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉-文本模型任务，旨在解决文本压缩与推理效率问题。提出VIST2模型，在预填充和推理阶段均压缩文本，提升速度并降低资源消耗。**

- **链接: [https://arxiv.org/pdf/2601.10378v1](https://arxiv.org/pdf/2601.10378v1)**
...
>
---
#### [new 045] UniHash: Unifying Pointwise and Pairwise Hashing Paradigms for Seen and Unseen Category Retrieval
- **分类: cs.CV**

- **简介: 该论文提出UniHash，解决图像检索中seen和unseen类别平衡问题，通过融合点对式与成对式学习，提升检索性能。**

- **链接: [https://arxiv.org/pdf/2601.09828v1](https://arxiv.org/pdf/2601.09828v1)**
...
>
---
#### [new 046] CoMoVi: Co-Generation of 3D Human Motions and Realistic Videos
- **分类: cs.CV**

- **简介: 该论文属于生成3D人体动作和视频的任务，解决两者耦合生成的问题。提出CoMoVi框架，通过双分支扩散模型同步生成动作与视频，并构建了相关数据集。**

- **链接: [https://arxiv.org/pdf/2601.10632v1](https://arxiv.org/pdf/2601.10632v1)**
...
>
---
#### [new 047] BikeActions: An Open Platform and Benchmark for Cyclist-Centric VRU Action Recognition
- **分类: cs.CV**

- **简介: 该论文提出BikeActions平台和数据集，解决VRU行为识别问题，通过多模态数据提升 cyclists 的动作理解。**

- **链接: [https://arxiv.org/pdf/2601.10521v1](https://arxiv.org/pdf/2601.10521v1)**
...
>
---
#### [new 048] Inference-time Physics Alignment of Video Generative Models with Latent World Models
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决生成视频违反物理规律的问题。通过引入潜世界模型作为奖励，优化推理阶段的生成策略，提升视频的物理合理性。**

- **链接: [https://arxiv.org/pdf/2601.10553v1](https://arxiv.org/pdf/2601.10553v1)**
...
>
---
#### [new 049] Hierarchical Refinement of Universal Multimodal Attacks on Vision-Language Models
- **分类: cs.CV; cs.MM**

- **简介: 该论文属于视觉-语言模型的对抗攻击任务，旨在解决样本特定攻击计算成本高的问题。提出HRA框架，通过层级优化提升通用扰动效果。**

- **链接: [https://arxiv.org/pdf/2601.10313v1](https://arxiv.org/pdf/2601.10313v1)**
...
>
---
#### [new 050] An analytic theory of convolutional neural network inverse problems solvers
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究监督卷积神经网络在成像逆问题中的理论分析，旨在揭示其工作原理。通过MMSE估计器建立解析模型，解决黑箱问题。**

- **链接: [https://arxiv.org/pdf/2601.10334v1](https://arxiv.org/pdf/2601.10334v1)**
...
>
---
#### [new 051] mergetune: Continued fine-tuning of vision-language models
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言模型的微调任务，解决微调过程中知识遗忘问题。提出MERGETUNE方法，通过继续微调恢复预训练知识，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.10497v1](https://arxiv.org/pdf/2601.10497v1)**
...
>
---
#### [new 052] SRAW-Attack: Space-Reweighted Adversarial Warping Attack for SAR Target Recognition
- **分类: cs.CV; eess.IV**

- **简介: 该论文属于SAR目标识别任务，旨在解决DNN模型对对抗样本的脆弱性问题。提出SRAW攻击方法，通过空间变形生成隐蔽且有效的对抗样本。**

- **链接: [https://arxiv.org/pdf/2601.10324v1](https://arxiv.org/pdf/2601.10324v1)**
...
>
---
#### [new 053] Adversarial Evasion Attacks on Computer Vision using SHAP Values
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于计算机视觉安全任务，旨在研究利用SHAP值的对抗性逃避攻击。通过量化输入重要性，生成更鲁棒的误分类攻击，解决模型在梯度隐藏场景下的脆弱性问题。**

- **链接: [https://arxiv.org/pdf/2601.10587v1](https://arxiv.org/pdf/2601.10587v1)**
...
>
---
#### [new 054] SVII-3D: Advancing Roadside Infrastructure Inventory with Decimeter-level 3D Localization and Comprehension from Sparse Street Imagery
- **分类: cs.CV**

- **简介: 该论文属于智能城市基础设施数字化任务，旨在解决稀疏图像下定位不准和状态理解不足的问题。通过融合检测与注意力机制、几何优化及多模态模型，实现高精度3D定位与状态诊断。**

- **链接: [https://arxiv.org/pdf/2601.10535v1](https://arxiv.org/pdf/2601.10535v1)**

> **作者:** Chong Liu; Luxuan Fu; Yang Jia; Zhen Dong; Bisheng Yang
>
> **摘要:** The automated creation of digital twins and precise asset inventories is a critical task in smart city construction and facility lifecycle management. However, utilizing cost-effective sparse imagery remains challenging due to limited robustness, inaccurate localization, and a lack of fine-grained state understanding. To address these limitations, SVII-3D, a unified framework for holistic asset digitization, is proposed. First, LoRA fine-tuned open-set detection is fused with a spatial-attention matching network to robustly associate observations across sparse views. Second, a geometry-guided refinement mechanism is introduced to resolve structural errors, achieving precise decimeter-level 3D localization. Third, transcending static geometric mapping, a Vision-Language Model agent leveraging multi-modal prompting is incorporated to automatically diagnose fine-grained operational states. Experiments demonstrate that SVII-3D significantly improves identification accuracy and minimizes localization errors. Consequently, this framework offers a scalable, cost-effective solution for high-fidelity infrastructure digitization, effectively bridging the gap between sparse perception and automated intelligent maintenance.
>
---
#### [new 055] Disentangled Concept Representation for Text-to-image Person Re-identification
- **分类: cs.CV**

- **简介: 该论文属于文本到图像行人重识别任务，解决跨模态对齐与细粒度区分问题。提出DiCo框架，通过解耦概念表示提升检索精度与可解释性。**

- **链接: [https://arxiv.org/pdf/2601.10053v1](https://arxiv.org/pdf/2601.10053v1)**
...
>
---
#### [new 056] Alterbute: Editing Intrinsic Attributes of Objects in Images
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出Alterbute，用于图像中物体固有属性编辑的任务。解决如何在保持物体身份和场景上下文的同时，修改颜色、纹理等属性的问题。通过引入VNE和放松训练目标实现有效编辑。**

- **链接: [https://arxiv.org/pdf/2601.10714v1](https://arxiv.org/pdf/2601.10714v1)**

> **作者:** Tal Reiss; Daniel Winter; Matan Cohen; Alex Rav-Acha; Yael Pritch; Ariel Shamir; Yedid Hoshen
>
> **备注:** Project page is available at https://talreiss.github.io/alterbute/
>
...
>
---
#### [new 061] Jordan-Segmentable Masks: A Topology-Aware definition for characterizing Binary Image Segmentation
- **分类: cs.CV; math.AT; math.NA**

- **简介: 该论文属于图像分割任务，旨在解决传统评估指标无法准确反映分割结果拓扑结构的问题。提出“Jordan-segmentable mask”概念，通过数字拓扑方法评估分割的结构一致性。**

- **链接: [https://arxiv.org/pdf/2601.10577v1](https://arxiv.org/pdf/2601.10577v1)**
...
>
---
#### [new 062] UEOF: A Benchmark Dataset for Underwater Event-Based Optical Flow
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于视觉感知任务，旨在解决水下光学流估计难题。通过构建首个合成水下事件数据集UEOF，提供真实光照条件下的光流、深度和运动真值，推动水下事件相机算法的发展。**

- **链接: [https://arxiv.org/pdf/2601.10054v1](https://arxiv.org/pdf/2601.10054v1)**
...
>
---
#### [new 064] Enhancing Visual In-Context Learning by Multi-Faceted Fusion
- **分类: cs.CV**

- **简介: 该论文属于视觉上下文学习任务，旨在解决单一提示信息不足的问题。通过多分支融合方法增强模型的上下文理解与推理能力。**

- **链接: [https://arxiv.org/pdf/2601.10107v1](https://arxiv.org/pdf/2601.10107v1)**
...
>
---
#### [new 065] Beyond Inpainting: Unleash 3D Understanding for Precise Camera-Controlled Video Generation
- **分类: cs.CV; cs.GR**

- **简介: 该论文属于视频生成任务，旨在解决精确控制相机轨迹的同时保持内容一致的问题。提出DepthDirector框架，结合深度信息实现更高质量的视频重渲染。**

- **链接: [https://arxiv.org/pdf/2601.10214v1](https://arxiv.org/pdf/2601.10214v1)**
...
>
---
#### [new 066] See Less, Drive Better: Generalizable End-to-End Autonomous Driving via Foundation Models Stochastic Patch Selection
- **分类: cs.CV; cs.LG; cs.RO**

- **简介: 该论文属于自动驾驶任务，解决模型在分布外场景下的泛化问题。通过随机遮蔽特征块，提升策略的鲁棒性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.10707v1](https://arxiv.org/pdf/2601.10707v1)**
...
>
---
#### [new 067] Thinking Like Van Gogh: Structure-Aware Style Transfer via Flow-Guided 3D Gaussian Splatting
- **分类: cs.CV; cs.GR; cs.LG**

- **简介: 该论文属于3D风格迁移任务，旨在解决传统方法忽视几何结构的问题。提出一种基于流场引导的3D高斯点云方法，实现更真实的后印象派风格表达。**

- **链接: [https://arxiv.org/pdf/2601.10075v1](https://arxiv.org/pdf/2601.10075v1)**
...
>
---
#### [new 068] ViSIL: Unified Evaluation of Information Loss in Multimodal Video Captioning
- **分类: cs.CV; cs.AI; cs.HC**

- **简介: 该论文属于多模态视频摘要任务，旨在解决传统评估指标无法量化跨模态信息覆盖的问题。提出ViSIL评分，通过信息理论衡量视频信息损失，实现统一评估。**

- **链接: [https://arxiv.org/pdf/2601.09851v1](https://arxiv.org/pdf/2601.09851v1)**
...
>
---
#### [new 069] ROMA: Real-time Omni-Multimodal Assistant with Interactive Streaming Understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 070] ChartComplete: A Taxonomy-based Inclusive Chart Dataset
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于图表理解任务，旨在解决现有数据集覆盖图表类型有限的问题。工作是提出一个基于分类体系的全面图表数据集ChartComplete，涵盖30种图表类型。**

- **链接: [https://arxiv.org/pdf/2601.10462v1](https://arxiv.org/pdf/2601.10462v1)**
...
>
---
#### [new 071] A Safety Report on GPT-5.2, Gemini 3 Pro, Qwen3-VL, Doubao 1.8, Grok 4.1 Fast, Nano Banana Pro, and Seedream 4.5
...
>
---
#### [new 072] Multi-Agent Cooperative Learning for Robust Vision-Language Alignment under OOD Concepts
- **分类: cs.MA; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于视觉-语言对齐任务，解决OOD概念下的跨模态对齐崩溃问题。提出MACL框架，通过多智能体协作提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.09746v1](https://arxiv.org/pdf/2601.09746v1)**
...
>
---
#### [new 073] Cell Behavior Video Classification Challenge, a benchmark for computer vision methods in time-lapse microscopy
- **分类: eess.IV; cs.CV; q-bio.QM**

- **简介: 该论文属于视频分类任务，旨在解决显微镜视频中细胞行为的自动识别问题。通过组织挑战赛，评估了多种方法在建模细胞形状、运动及时空特征上的效果。**

- **链接: [https://arxiv.org/pdf/2601.10250v1](https://arxiv.org/pdf/2601.10250v1)**
...
>
---
#### [new 077] MHub.ai: A Simple, Standardized, and Reproducible Platform for AI Models in Medical Imaging
- **分类: cs.AI; cs.CV; cs.ET; cs.LG; cs.SE**

- **简介: 该论文提出MHub.ai平台，解决医学影像AI模型标准化与可重复性问题，通过容器化封装模型，提供统一接口和参考数据，支持多种模态任务。**

- **链接: [https://arxiv.org/pdf/2601.10154v1](https://arxiv.org/pdf/2601.10154v1)**
...
>
> **摘要:** Artificial intelligence (AI) has the potential to transform medical imaging by automating image analysis and accelerating clinical research. However, research and clinical use are limited by the wide variety of AI implementations and architectures, inconsistent documentation, and reproducibility issues. Here, we introduce MHub.ai, an open-source, container-based platform that standardizes access to AI models with minimal configuration, promoting accessibility and reproducibility in medical imaging. MHub.ai packages models from peer-reviewed publications into standardized containers that support direct processing of DICOM and other formats, provide a unified application interface, and embed structured metadata. Each model is accompanied by publicly available reference data that can be used to confirm model operation. MHub.ai includes an initial set of state-of-the-art segmentation, prediction, and feature extraction models for different modalities. The modular framework enables adaptation of any model and supports community contributions. We demonstrate the utility of the platform in a clinical use case through comparative evaluation of lung segmentation models. To further strengthen transparency and reproducibility, we publicly release the generated segmentations and evaluation metrics and provide interactive dashboards that allow readers to inspect individual cases and reproduce or extend our analysis. By simplifying model use, MHub.ai enables side-by-side benchmarking with identical execution commands and standardized outputs, and lowers the barrier to clinical translation.
>
---
#### [new 078] EditEmoTalk: Controllable Speech-Driven 3D Facial Animation with Continuous Expression Editing
- **分类: cs.MM; cs.CV**

- **简介: 该论文属于语音驱动的3D面部动画任务，旨在解决情感控制不连续的问题。提出EditEmoTalk框架，通过连续情绪编辑实现更自然的面部表情生成。**

- **链接: [https://arxiv.org/pdf/2601.10000v1](https://arxiv.org/pdf/2601.10000v1)**
...
>
---
#### [new 079] Process-Guided Concept Bottleneck Model
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出PG-CBM，解决CBMs在科学领域中因监督稀疏而效果不佳的问题，通过引入领域因果机制提升模型的可解释性和准确性。**

- **链接: [https://arxiv.org/pdf/2601.10562v1](https://arxiv.org/pdf/2601.10562v1)**
...
>
---
#### [new 080] The Algorithmic Gaze: An Audit and Ethnography of the LAION-Aesthetics Predictor Model
- **分类: cs.HC; cs.AI; cs.CV**

- **简介: 该论文属于AI伦理研究任务，旨在揭示视觉生成模型中审美评估的偏见。通过审计与民族志分析，发现LAION-Aesthetics Predictor模型存在文化与性别偏见，呼吁更包容的评价体系。**

- **链接: [https://arxiv.org/pdf/2601.09896v1](https://arxiv.org/pdf/2601.09896v1)**
...
#### [replaced 001] Semi-Tensor-Product Based Convolutional Neural Networks
- **分类: eess.SY; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.10407v3](https://arxiv.org/pdf/2506.10407v3)**
...
>
---
#### [replaced 004] Depth Edge Alignment Loss: DEALing with Depth in Weakly Supervised Semantic Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.17702v2](https://arxiv.org/pdf/2509.17702v2)**
...
>
---
#### [replaced 005] SPATIALGEN: Layout-guided 3D Indoor Scene Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.14981v4](https://arxiv.org/pdf/2509.14981v4)**
...
>
---
#### [replaced 006] TBC: A Target-Background Contrast Metric for Low-Altitude Infrared and Visible Image Fusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.15211v2](https://arxiv.org/pdf/2512.15211v2)**
...
>
---
#### [replaced 009] SPARK: Scalable Real-Time Point Cloud Aggregation with Multi-View Self-Calibration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.08414v2](https://arxiv.org/pdf/2601.08414v2)**

> **作者:** Chentian Sun
>
> **备注:** 10 pages, 1 figures, submitted to Trans on Image Processing. v2: Minor revision; removed several experimental results due to further verification
>
...
>
---
#### [replaced 010] SERA-H: Beyond Native Sentinel Spatial Limits for High-Resolution Canopy Height Mapping
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.18128v2](https://arxiv.org/pdf/2512.18128v2)**
...
>
---
#### [replaced 011] Towards Understanding Deep Learning Model in Image Recognition via Coverage Test
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.08814v2](https://arxiv.org/pdf/2505.08814v2)**
...
>
---
#### [replaced 012] STEP3-VL-10B Technical Report
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.09668v2](https://arxiv.org/pdf/2601.09668v2)**
...
>
---
#### [replaced 013] Encoder-Only Image Registration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.00451v3](https://arxiv.org/pdf/2509.00451v3)**

> **作者:** Xiang Chen; Renjiu Hu; Jinwei Zhang; Yuxi Zhang; Xinyao Yu; Min Liu; Yaonan Wang; Hang Zhang
>
...
>
---
#### [replaced 014] SageAttention3: Microscaling FP4 Attention for Inference and An Exploration of 8-Bit Training
- **分类: cs.LG; cs.AI; cs.AR; cs.CV; cs.PF**

- **链接: [https://arxiv.org/pdf/2505.11594v3](https://arxiv.org/pdf/2505.11594v3)**

> **作者:** Jintao Zhang; Jia Wei; Pengle Zhang; Xiaoming Xu; Haofeng Huang; Haoxu Wang; Kai Jiang; Jianfei Chen; Jun Zhu
>
...
>
---
#### [replaced 017] Decorrelation Speeds Up Vision Transformers
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.14657v3](https://arxiv.org/pdf/2510.14657v3)**

> **作者:** Kieran Carrigg; Rob van Gastel; Melda Yeghaian; Sander Dalm; Faysal Boughorbel; Marcel van Gerven
>
> **备注:** 20 pages, 12 figures, CVC 2026 camera-ready version
>
...
>
---
#### [replaced 021] GreedyPixel: Fine-Grained Black-Box Adversarial Attack Via Greedy Algorithm
- **分类: cs.CV; cs.CR; cs.LG**

- **链接: [https://arxiv.org/pdf/2501.14230v4](https://arxiv.org/pdf/2501.14230v4)**
...
>
---
#### [replaced 022] YOLO26: Key Architectural Enhancements and Performance Benchmarking for Real-Time Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.25164v3](https://arxiv.org/pdf/2509.25164v3)**
...
>
---
#### [replaced 023] RS2-SAM2: Customized SAM2 for Referring Remote Sensing Image Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.07266v4](https://arxiv.org/pdf/2503.07266v4)**
...
>
---
#### [replaced 024] Beautiful Images, Toxic Words: Understanding and Addressing Offensive Text in Generated Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.05066v4](https://arxiv.org/pdf/2502.05066v4)**

> **作者:** Aditya Kumar; Tom Blanchard; Adam Dziedzic; Franziska Boenisch
>
> **备注:** Accepted at AAAI 2026 (AI Alignment Track)
>
...
>
---
#### [replaced 025] Human-inspired Global-to-Parallel Multi-scale Encoding for Lightweight Vision Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.08190v2](https://arxiv.org/pdf/2601.08190v2)**
...
>
---
#### [replaced 034] RealCamo: Boosting Real Camouflage Synthesis with Layout Controls and Textual-Visual Guidance
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22974v3](https://arxiv.org/pdf/2512.22974v3)**
...
>
---
#### [replaced 035] Bayesian Monocular Depth Refinement via Neural Radiance Fields
- **分类: cs.CV; cs.GR; cs.LG; cs.RO**

- **简介: 该论文属于单目深度估计任务，旨在提升深度图的几何细节。通过结合NeRF与贝叶斯融合，改进深度估计精度。**

- **链接: [https://arxiv.org/pdf/2601.03869v2](https://arxiv.org/pdf/2601.03869v2)**

> **作者:** Arun Muthukkumar
>
> **备注:** IEEE 8th International Conference on Algorithms, Computing and Artificial Intelligence (ACAI 2025)
>
...
>
---
#### [replaced 036] UrbanNav: Learning Language-Guided Urban Navigation from Web-Scale Human Trajectories
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于语言引导的都市导航任务，解决真实城市环境中基于自然语言指令的导航问题。通过大规模网络视频数据训练，构建了UrbanNav框架，提升导航鲁棒性和泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.09607v2](https://arxiv.org/pdf/2512.09607v2)**

> **作者:** Yanghong Mei; Yirong Yang; Longteng Guo; Qunbo Wang; Ming-Ming Yu; Xingjian He; Wenjun Wu; Jing Liu
>
> **备注:** 9 pages, 5 figures, accepted to AAAI 2026. Project page:https://github.com/CASIA-IVA-Lab/UrbanNav
>
...
>
---
#### [replaced 037] EfficientFSL: Enhancing Few-Shot Classification via Query-Only Tuning in Vision Transformers
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.08499v2](https://arxiv.org/pdf/2601.08499v2)**

> **作者:** Wenwen Liao; Hang Ruan; Jianbo Yu; Bing Song; YuansongWang; Xiaofeng Yang
>
...
>
---
#### [replaced 042] Fusionista2.0: Efficiency Retrieval System for Large-Scale Datasets
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.12255v2](https://arxiv.org/pdf/2511.12255v2)**

> **作者:** Huy M. Le; Dat Tien Nguyen; Phuc Binh Nguyen; Gia Bao Le Tran; Phu Truong Thien; Cuong Dinh; Minh Nguyen; Nga Nguyen; Thuy T. N. Nguyen; Tan Nhat Nguyen; Binh T. Nguyen
>
> **摘要:** The Video Browser Showdown (VBS) challenges systems to deliver accurate results under strict time constraints. To meet this demand, we present Fusionista2.0, a streamlined video retrieval system optimized for speed and usability. All core modules were re-engineered for efficiency: preprocessing now relies on ffmpeg for fast keyframe extraction, optical character recognition uses Vintern-1B-v3.5 for robust multilingual text recognition, and automatic speech recognition employs faster-whisper for real-time transcription. For question answering, lightweight vision-language models provide quick responses without the heavy cost of large models. Beyond these technical upgrades, Fusionista2.0 introduces a redesigned user interface with improved responsiveness, accessibility, and workflow efficiency, enabling even non-expert users to retrieve relevant content rapidly. Evaluations demonstrate that retrieval time was reduced by up to 75% while accuracy and user satisfaction both increased, confirming Fusionista2.0 as a competitive and user-friendly system for large-scale video search.
>
---
#### [replaced 043] High-Quality 3D Head Reconstruction from Any Single Portrait Image
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.08516v3](https://arxiv.org/pdf/2503.08516v3)**
...
>
---
#### [replaced 052] JOGS: Joint Optimization of Pose Estimation and 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.26117v2](https://arxiv.org/pdf/2510.26117v2)**
...
>
---
#### [replaced 053] Unveiling and Bridging the Functional Perception Gap in MLLMs: Atomic Visual Alignment and Hierarchical Evaluation via PET-Bench
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02737v2](https://arxiv.org/pdf/2601.02737v2)**
...
>
> **摘要:** While Multimodal Large Language Models (MLLMs) have demonstrated remarkable proficiency in tasks such as abnormality detection and report generation for anatomical modalities, their capability in functional imaging remains largely unexplored. In this work, we identify and quantify a fundamental functional perception gap: the inability of current vision encoders to decode functional tracer biodistribution independent of morphological priors. Identifying Positron Emission Tomography (PET) as the quintessential modality to investigate this disconnect, we introduce PET-Bench, the first large-scale functional imaging benchmark comprising 52,308 hierarchical QA pairs from 9,732 multi-site, multi-tracer PET studies. Extensive evaluation of 19 state-of-the-art MLLMs reveals a critical safety hazard termed the Chain-of-Thought (CoT) hallucination trap. We observe that standard CoT prompting, widely considered to enhance reasoning, paradoxically decouples linguistic generation from visual evidence in PET, producing clinically fluent but factually ungrounded diagnoses. To resolve this, we propose Atomic Visual Alignment (AVA), a simple fine-tuning strategy that enforces the mastery of low-level functional perception prior to high-level diagnostic reasoning. Our results demonstrate that AVA effectively bridges the perception gap, transforming CoT from a source of hallucination into a robust inference tool and improving diagnostic accuracy by up to 14.83%. Code and data are available at https://github.com/yezanting/PET-Bench.
>
---
#### [replaced 054] Wavelet-based Multi-View Fusion of 4D Radar Tensor and Camera for Robust 3D Object Detection
- **分类: cs.CV; eess.SP**

- **链接: [https://arxiv.org/pdf/2512.22972v2](https://arxiv.org/pdf/2512.22972v2)**
...
>
---
#### [replaced 055] Smooth Operator: Smooth Verifiable Reward Activates Spatial Reasoning Ability of Vision-Language Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.07695v2](https://arxiv.org/pdf/2601.07695v2)**
...
>
---
#### [replaced 056] Symmetrization Weighted Binary Cross-Entropy: Modeling Perceptual Asymmetry for Human-Consistent Neural Edge Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2501.13365v3](https://arxiv.org/pdf/2501.13365v3)**
...
>
---
#### [replaced 057] Lifelong Domain Adaptive 3D Human Pose Estimation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.23860v2](https://arxiv.org/pdf/2512.23860v2)**
...
>
---
#### [replaced 060] Normalize Filters! Classical Wisdom for Deep Vision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.04401v5](https://arxiv.org/pdf/2506.04401v5)**
...
>
---
#### [replaced 061] GANeXt: A Fully ConvNeXt-Enhanced Generative Adversarial Network for MRI- and CBCT-to-CT Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.19336v2](https://arxiv.org/pdf/2512.19336v2)**

> **作者:** Siyuan Mei; Yan Xia; Fuxin Fan; Andreas Maier
>
...
>
---
#### [replaced 062] Semantic Misalignment in Vision-Language Models under Perceptual Degradation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.08355v2](https://arxiv.org/pdf/2601.08355v2)**
...
>
---
#### [replaced 065] Generative Adversarial Gumbel MCTS for Abstract Visual Composition Generation
...
>
---
#### [replaced 066] Cross-Modal Fine-Tuning of 3D Convolutional Foundation Models for ADHD Classification with Low-Rank Adaptation
- **分类: eess.IV; cs.CV; cs.LG; physics.med-ph**

- **链接: [https://arxiv.org/pdf/2511.06163v2](https://arxiv.org/pdf/2511.06163v2)**

> **作者:** Jyun-Ping Kao; Shinyeong Rho; Shahar Lazarev; Hyun-Hae Cho; Fangxu Xing; Taehoon Shin; C. -C. Jay Kuo; Jonghye Woo
>
> **备注:** Accepted for presentation at the IEEE International Symposium on Biomedical Imaging (ISBI) 2026
>
