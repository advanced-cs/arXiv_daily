...
>
---
#### [new 007] Dynamic Visual-semantic Alignment for Zero-shot Learning with Ambiguous Labels
- **分类: cs.CV**

- **简介: 该论文属于零样本学习任务，旨在解决标签模糊和噪声问题。提出DVSA框架，通过视觉-语义对齐和动态标签消歧提升模型性能。**

- **链接: [https://arxiv.org/pdf/2604.17710](https://arxiv.org/pdf/2604.17710)**
...
>
---
#### [new 008] Hybrid Multi-Dimensional MRI Prostate Cancer Detection via Hadamard Network-Based Bias Correction and Residual Networks
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于前列腺癌检测任务，旨在解决MRI图像中强度不均匀问题并提升AI检测效果。提出HBR-Net-18框架，结合Hadamard网络和ResNet-18实现更准确的病变识别。**

- **链接: [https://arxiv.org/pdf/2604.17107](https://arxiv.org/pdf/2604.17107)**
...
>
---
#### [new 015] GS-STVSR: Ultra-Efficient Continuous Spatio-Temporal Video Super-Resolution via 2D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于视频超分辨率任务，解决连续时空超分辨率问题。提出GS-STVSR框架，通过2D高斯点云实现高效视频提升，提升速度与质量。**

- **链接: [https://arxiv.org/pdf/2604.18047](https://arxiv.org/pdf/2604.18047)**
...
>
---
#### [new 022] Physics-Informed Tracking (PIT)
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Physics-Informed Tracking (PIT)，用于视频中单粒子跟踪。解决传统方法依赖标签或物理模型的问题，通过结合神经网络与物理约束实现精准跟踪。**

- **链接: [https://arxiv.org/pdf/2604.16895](https://arxiv.org/pdf/2604.16895)**
...
>
---
#### [new 023] Ego-InBetween: Generating Object State Transitions in Ego-Centric Videos
- **分类: cs.CV**

- **简介: 该论文属于视觉状态转换生成任务，旨在解决从第一视角生成物体状态变化中间帧的问题。提出EgoIn框架，结合多步推理与辅助监督，提升生成序列的语义与视觉一致性。**

- **链接: [https://arxiv.org/pdf/2604.17749](https://arxiv.org/pdf/2604.17749)**
...
>
---
#### [new 024] AutoVQA-G: Self-Improving Agentic Framework for Automated Visual Question Answering and Grounding Annotation
- **分类: cs.CV**

- **简介: 该论文提出AutoVQA-G，解决VQA-G数据生成中的数据质量与验证问题，通过迭代优化提升视觉问答的准确性。**

- **链接: [https://arxiv.org/pdf/2604.17488](https://arxiv.org/pdf/2604.17488)**
...
>
---
#### [new 031] Re$^2$MoGen: Open-Vocabulary Motion Generation via LLM Reasoning and Physics-Aware Refinement
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 032] UniGeo: Unifying Geometric Guidance for Camera-Controllable Image Editing via Video Models
- **分类: cs.CV**

- **简介: 该论文属于图像编辑任务，旨在解决相机可控图像生成中的几何一致性问题。通过统一的几何引导机制，提升生成图像的结构稳定性和视觉质量。**

- **链接: [https://arxiv.org/pdf/2604.17565](https://arxiv.org/pdf/2604.17565)**
...
>
---
#### [new 039] Infrastructure-Centric World Models: Bridging Temporal Depth and Spatial Breadth for Roadside Perception
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 040] Spike-NVPT: Learning Robust Visual Prompts via Bio-Inspired Temporal Filtering and Discretization
- **分类: cs.CV**

- **简介: 该论文属于视觉模型微调任务，旨在解决预训练模型对输入噪声敏感的问题。提出Spike-NVPT方法，通过生物启发的时序过滤和离散化提升鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.18284](https://arxiv.org/pdf/2604.18284)**
...
>
---
#### [new 052] Towards Generalizable Deepfake Image Detection with Vision Transformers
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **简介: 该论文属于深度伪造图像检测任务，旨在解决现有方法泛化能力差的问题。通过集成微调的视觉Transformer模型，提升检测效果，在DF-Wild数据集上取得优异成绩。**

- **链接: [https://arxiv.org/pdf/2604.17376](https://arxiv.org/pdf/2604.17376)**
...
>
---
#### [new 063] Mitigating Multimodal Hallucination via Phase-wise Self-reward
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 071] Is SAM3 ready for pathology segmentation?
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分割任务，旨在评估SAM3在病理图像分割中的能力。通过系统实验，分析其在不同监督设置下的表现，揭示其局限性并提出领域适应建议。**
...
>
---
#### [new 072] A Lightweight Transformer for Pain Recognition from Brain Activity
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于疼痛识别任务，旨在通过脑活动数据实现自动化疼痛评估。提出一种轻量级Transformer模型，融合多模态fNIRS特征，提升识别性能并保持计算效率。**
...
>
---
#### [new 080] Towards Symmetry-sensitive Pose Estimation: A Rotation Representation for Symmetric Object Classes
- **分类: cs.CV; math.GT**

- **简介: 该论文属于6D姿态估计任务，旨在解决对称物体的方位模糊问题。通过提出SARR旋转表示，提升姿态估计精度，无需3D模型即可有效工作。**

- **链接: [https://arxiv.org/pdf/2604.18208](https://arxiv.org/pdf/2604.18208)**
...
>
---
#### [new 105] OneVL: One-Step Latent Reasoning and Planning with Vision-Language Explanation
...
>
---
#### [new 109] NTIRE 2026 Rip Current Detection and Segmentation (RipDetSeg) Challenge Report
- **分类: cs.CV**

- **简介: 该论文属于 rip 电流检测与分割任务，旨在解决自动识别危险近岸流的问题。通过构建多样化数据集和挑战赛，评估并提升相关算法性能。**

- **链接: [https://arxiv.org/pdf/2604.17070](https://arxiv.org/pdf/2604.17070)**
...
>
---
#### [new 131] One-Step Diffusion with Inverse Residual Fields for Unsupervised Industrial Anomaly Detection
- **分类: cs.CV**

- **简介: 该论文属于无监督工业异常检测任务，旨在解决扩散模型推理速度慢的问题。提出OSD-IRF方法，通过逆残差场实现单步检测，提升效率并保持性能。**

- **链接: [https://arxiv.org/pdf/2604.18393](https://arxiv.org/pdf/2604.18393)**
...
>
---
#### [new 132] Medical Image Understanding Improves Survival Prediction via Visual Instruction Tuning
- **分类: cs.CV**

- **简介: 该论文属于医学图像理解任务，旨在提升生存预测准确性。通过视觉指令调优，结合CT图像与报告，构建视觉-文本表示，优化生存预测模型。**

- **链接: [https://arxiv.org/pdf/2604.18250](https://arxiv.org/pdf/2604.18250)**
...
>
---
#### [new 139] From Clinical Intent to Clinical Model: An Autonomous Coding-Agent Framework for Clinician-driven AI Development
- **分类: cs.CV**

- **简介: 该论文提出一种自主编码代理框架，用于临床医生驱动的AI开发。解决传统协作模式中沟通耗时、理解偏差的问题，通过自然语言交互直接生成临床AI模型。**
...
>
---
#### [new 145] Adaptive Forensic Feature Refinement via Intrinsic Importance Perception
- **分类: cs.CV**

- **简介: 该论文属于合成图像检测任务，旨在解决跨分布泛化问题。提出I2P框架，通过感知内在重要性，优化VFM适应策略，提升检测性能同时保持预训练结构。**
...
>
---
#### [new 146] Fringe Projection Based Vision Pipeline for Autonomous Hard Drive Disassembly
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 163] Operationalizing Fairness in Text-to-Image Models: A Survey of Bias, Fairness Audits and Mitigation Strategies
- **分类: cs.CV; cs.LG; cs.MM**

- **简介: 该论文属于文本到图像生成领域的公平性研究，旨在解决模型中的偏见问题。通过系统综述，梳理偏见类型与公平性概念，提出新的公平性操作框架。**

- **链接: [https://arxiv.org/pdf/2604.16516](https://arxiv.org/pdf/2604.16516)**
...
>
---
#### [new 165] The First Challenge on Mobile Real-World Image Super-Resolution at NTIRE 2026: Benchmark Results and Method Overview
- **分类: cs.CV**

- **简介: 该论文介绍NTIRE 2026移动真实图像超分辨率挑战，解决低分辨率图像恢复问题，提出高效模型并评估性能。**

- **链接: [https://arxiv.org/pdf/2604.17306](https://arxiv.org/pdf/2604.17306)**
...
>
---
#### [new 167] DuQuant++: Fine-grained Rotation Enhances Microscaling FP4 Quantization
...
>
---
#### [new 172] A High-Accuracy Optical Music Recognition Method Based on Bottleneck Residual Convolutions
...
>
---
#### [new 181] A Survey of Spatial Memory Representations for Efficient Robot Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 186] From Handwriting to Structured Data: Benchmarking AI Digitisation of Handwritten Forms
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究多模态大语言模型在手写表单数字化中的应用，解决手动数字化效率低、成本高的问题。通过基准测试，评估模型在复杂手写表单上的性能，并优化提示提升效果。**

- **链接: [https://arxiv.org/pdf/2604.16504](https://arxiv.org/pdf/2604.16504)**
...
>
---
#### [new 190] UGD: An Unsupervised Geometric Distance for Evaluating Real-world Noisy Point Cloud Denoising
- **分类: cs.CV; cs.GR**

- **简介: 该论文属于点云去噪任务，解决真实场景中缺乏干净点云导致的评估难题。提出UGD方法，仅基于噪声点云实现无监督评估。**

- **链接: [https://arxiv.org/pdf/2604.16976](https://arxiv.org/pdf/2604.16976)**
...
>
> **摘要:** This paper presents a comprehensive review of the NTIRE 2026 Low Light Image Enhancement Challenge, highlighting the proposed solutions and final results. The objective of this challenge is to identify effective networks capable of producing clearer and visually compelling images in diverse and challenging conditions by learning representative visual cues with the purpose of restoring information loss due to low-contrast and noisy images. A total of 195 participants registered for the first track and 153 for the second track of the competition, and 22 teams ultimately submitted valid entries. This paper thoroughly evaluates the state-of-the-art advances in (joint denoising and) low-light image enhancement, showcasing the significant progress in the field, while leveraging samples of our novel dataset.
>
---
#### [new 201] Topology-Aware Layer Pruning for Large Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于模型压缩任务，旨在解决LVLMs计算成本高的问题。通过拓扑感知方法进行层剪枝，保留关键表示转换，提升模型效率。**

- **链接: [https://arxiv.org/pdf/2604.16502](https://arxiv.org/pdf/2604.16502)**
...
>
---
#### [new 204] SmoGVLM: A Small, Graph-enhanced Vision-Language Model
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 210] Channel Attention-Guided Cross-Modal Knowledge Distillation for Referring Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于 referring image segmentation 任务，旨在解决大模型部署受限问题。提出一种通道注意力引导的跨模态知识蒸馏方法，提升学生模型性能同时不增加参数。**

- **链接: [https://arxiv.org/pdf/2604.16806](https://arxiv.org/pdf/2604.16806)**
...
>
---
#### [new 213] Attention-ResUNet for Automated Fetal Head Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分割任务，旨在解决超声图像中胎儿头部自动分割的问题。提出Attention-ResUNet模型，结合残差学习与多尺度注意力机制，提升分割精度与可解释性。**

- **链接: [https://arxiv.org/pdf/2604.18148](https://arxiv.org/pdf/2604.18148)**
...
>
---
#### [new 223] DOSE: Data Selection for Multi-Modal LLMs via Off-the-Shelf Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 224] UDM-GRPO: Stable and Efficient Group Relative Policy Optimization for Uniform Discrete Diffusion Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出UDM-GRPO框架，将强化学习应用于统一离散扩散模型，解决训练不稳定和性能提升有限的问题。通过优化动作定义和轨迹重构，提升生成任务效果。**
...
>
---
#### [new 225] Towards Joint Quantization and Token Pruning of Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型优化任务，旨在解决低比特推理下的计算成本问题。通过联合量化与令牌剪枝，提升模型效率与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.17320](https://arxiv.org/pdf/2604.17320)**
...
>
---
#### [new 226] From Heads to Neurons: Causal Attribution and Steering in Multi-Task Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 240] Bridging Coarse and Fine Recognition: A Hybrid Approach for Open-Ended Multi-Granularity Object Recognition in Interactive Educational Games
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多粒度物体识别任务，旨在解决大模型与CLIP在细粒度和泛化能力上的不足。通过融合两者，提出HyMOR框架，提升多模态游戏中的物体感知准确性。**

- **链接: [https://arxiv.org/pdf/2604.16785](https://arxiv.org/pdf/2604.16785)**
...
>
---
#### [new 241] SemLT3D: Semantic-Guided Expert Distillation for Camera-only Long-Tailed 3D Object Detection
- **分类: cs.CV**

- **简介: 该论文属于3D目标检测任务，旨在解决相机-only方法中长尾分布不平衡问题。通过语义引导的专家蒸馏框架，提升罕见类别的检测性能。**

- **链接: [https://arxiv.org/pdf/2604.18476](https://arxiv.org/pdf/2604.18476)**
...
>
---
#### [new 247] Privacy-Preserving Semantic Segmentation without Key Management
- **分类: cs.CV; cs.CR**

- **简介: 该论文属于隐私保护任务，解决图像分割中隐私泄露问题。通过为每个客户端和图像使用独立密钥加密，实现加密下的模型训练与推理。**

- **链接: [https://arxiv.org/pdf/2604.16523](https://arxiv.org/pdf/2604.16523)**
...
>
---
#### [new 248] AVRT: Audio-Visual Reasoning Transfer through Single-Modality Teachers
...
>
---
#### [new 256] Dual-stream Spatio-Temporal GCN-Transformer Network for 3D Human Pose Estimation
- **分类: cs.CV**

- **简介: 该论文属于3D人体姿态估计任务，旨在解决传统方法忽略局部骨骼关系和通道信息交互的问题。提出MixTGFormer网络，融合时空特征，提升姿态估计精度。**

- **链接: [https://arxiv.org/pdf/2604.17688](https://arxiv.org/pdf/2604.17688)**
...
>
---
#### [new 259] Conditional Evidence Reconstruction and Decomposition for Interpretable Multimodal Diagnosis
- **分类: cs.CV**

- **简介: 该论文属于多模态诊断任务，解决不完全模态下的疾病诊断问题。提出CERD框架，通过重建缺失模态和分解诊断证据，提升模型的可解释性与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.17030](https://arxiv.org/pdf/2604.17030)**
...
>
---
#### [new 260] MedProbeBench: Systematic Benchmarking at Deep Evidence Integration for Expert-level Medical Guideline
- **分类: cs.CV**

- **简介: 该论文属于医疗指南生成任务，旨在解决现有基准无法评估深度证据整合的问题。提出MedProbeBench及评估框架，用于评测模型在多步骤证据整合和专家级判断上的能力。**

- **链接: [https://arxiv.org/pdf/2604.18418](https://arxiv.org/pdf/2604.18418)**
...
>
---
#### [new 261] OmniHuman: A Large-scale Dataset and Benchmark for Human-Centric Video Generation
- **分类: cs.CV**

- **简介: 该论文提出OmniHuman数据集和基准，解决人本视频生成中的数据不足问题，通过多层级标注和评估体系提升生成质量。**

- **链接: [https://arxiv.org/pdf/2604.18326](https://arxiv.org/pdf/2604.18326)**
...
>
---
#### [new 262] ScenarioControl: Vision-Language Controllable Vectorized Latent Scenario Generation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 263] Medial Axis Aware Learning of Signed Distance Functions
- **分类: cs.CV; cs.CG; cs.GR; cs.LG; math.NA**

- **简介: 该论文属于三维重建任务，旨在解决从点云中精确计算符号距离函数（SDF）的问题。通过考虑中轴线，提出一种变分方法，并利用神经网络实现。**

- **链接: [https://arxiv.org/pdf/2604.16512](https://arxiv.org/pdf/2604.16512)**
...
>
---
#### [new 264] DGSSM: Diffusion guided state-space models for multimodal salient object detection
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于多模态显著目标检测任务，旨在解决模型难以同时捕捉长程依赖和精细结构的问题。提出DGSSM框架，结合扩散模型与状态空间模型，提升边界精度。**

- **链接: [https://arxiv.org/pdf/2604.17585](https://arxiv.org/pdf/2604.17585)**
...
>
---
#### [new 269] Generative Semantic Communication via Alternating Dual-Domain Posterior Sampling
- **分类: cs.CV; cs.IT; eess.SP**

- **简介: 该论文属于语义通信任务，旨在提升无线图像传输的感知质量。针对现有方法无法保持数据分布的问题，提出ADDPS算法，通过交替域后验采样优化解码过程。**

- **链接: [https://arxiv.org/pdf/2604.16796](https://arxiv.org/pdf/2604.16796)**
...
>
---
#### [new 281] SAND: The Challenge on Speech Analysis for Neurodegenerative Disease Assessment
...
>
---
#### [new 282] ICAT: Incident-Case-Grounded Adaptive Testing for Physical-Risk Prediction in Embodied World Models
...
>
---
#### [new 288] ST-$π$: Structured SpatioTemporal VLA for Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 289] MM-JudgeBias: A Benchmark for Evaluating Compositional Biases in MLLM-as-a-Judge
...
>
---
#### [new 290] Deep Hierarchical Knowledge Loss for Fault Intensity Diagnosis
...
>
---
#### [new 293] Visual-RRT: Finding Paths toward Visual-Goals via Differentiable Rendering
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 294] ReFineVLA: Multimodal Reasoning-Aware Generalist Robotic Policies via Teacher-Guided Fine-Tuning
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 298] Brain-CLIPLM: Decoding Compressed Semantic Representations in EEG for Language Reconstruction
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 301] SynopticBench: Evaluating Vision-Language Models on Generating Weather Forecast Discussions of the Future
...
>
---
#### [new 302] Disentangled Robot Learning via Separate Forward and Inverse Dynamics Pretraining
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 303] More Than Meets the Eye: Measuring the Semiotic Gap in Vision-Language Models via Semantic Anchorage
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 304] BrainMem: Brain-Inspired Evolving Memory for Embodied Agent Task Planning
...
>
---
#### [new 307] Video-Robin: Autoregressive Diffusion Planning for Intent-Grounded Video-to-Music Generation
...
>
---
#### [new 308] VIDS: A Verified Imaging Dataset Standard for Medical AI
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出VIDS标准，解决医学影像数据集缺乏统一验证框架的问题。定义了数据结构、标注溯源等21项验证规则，提升数据质量与可复现性。**

- **链接: [https://arxiv.org/pdf/2604.17525](https://arxiv.org/pdf/2604.17525)**

> **作者:** Joan S. Muthu; John Shalen
>
> **备注:** 11 pages, 3 figures, 5 tables
>
> **摘要:** Medical imaging AI development is fundamentally dependent on annotated datasets, yet no existing standard provides machine-enforceable validation across dataset structure, annotation provenance, quality documentation, and ML readiness within a single framework. DICOM standardizes image acquisition, storage, and communication at the individual study level. BIDS organizes neuroimaging research datasets with consistent naming conventions. Neither addresses the curation layer, viz., who annotated what, when, with what tool, and to what quality standard. This paper presents VIDS (Verified Imaging Dataset Standard), an open specification that defines folder layout, file naming, annotation provenance schemas, quality documentation, and 21 machine-enforceable validation rules across two compliance profiles. VIDS uses NIfTI as a canonical working format while preserving full DICOM metadata in sidecars for traceability, and supports export to any downstream ML framework (nnU-Net, MONAI, COCO, flat NIfTI) without loss of provenance. Twenty-two compliance dimensions are defined and four major public datasets -- LIDC-IDRI, BraTS, CheXpert, and the Medical Segmentation Decathlon -- are benchmarked against these dimensions. Even widely used datasets satisfy only 20--39% of these dimensions, with provenance and quality documentation as the largest systematic gaps. LIDC-Hybrid-100 is released as a 100-subject VIDS-compliant reference CT dataset with consensus segmentation masks from four radiologist annotations (mean pairwise Dice 0.7765), validating 21/21 on the Full compliance profile. VIDS is fully open source: the specification is CC BY 4.0, all tools are Apache 2.0, the reference validator is available on PyPI (pip install vids-validator), and LIDC-Hybrid-100 is published on Zenodo (this https URL).
>
---
#### [new 309] Learned Nonlocal Feature Matching and Filtering for RAW Image Denoising
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于RAW图像去噪任务，旨在解决传统方法依赖人工设计、现代方法参数过多的问题。提出一种结合非局部特征匹配与过滤的可学习网络，提升去噪效果并减少参数量。**

- **链接: [https://arxiv.org/pdf/2604.17453](https://arxiv.org/pdf/2604.17453)**
...
>
---
#### [new 312] Real-Time Cellist Postural Evaluation With On-Device Computer Vision
- **分类: cs.HC; cs.CV**

- **简介: 该论文属于姿势评估任务，旨在解决初学者缺乏实时反馈的问题。通过优化移动端计算机视觉，开发了实时反馈系统，提升练习效果。**

- **链接: [https://arxiv.org/pdf/2604.17530](https://arxiv.org/pdf/2604.17530)**
...
>
---
#### [new 316] SignDPO: Multi-level Direct Preference Optimisation for Skeleton-based Gloss-free Sign Language Translation
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 323] Rewind-IL: Online Failure Detection and State Respawning for Imitation Learning
...
>
---
#### [new 324] Privatar: Scalable Privacy-preserving Multi-user VR via Secure Offloading
- **分类: cs.CR; cs.AR; cs.CV; eess.SY**

- **简介: 该论文属于多用户虚拟现实任务，解决计算负载高和隐私泄露问题。通过安全卸载技术Privatar，实现高效且隐私保护的多人VR体验。**

- **链接: [https://arxiv.org/pdf/2604.17476](https://arxiv.org/pdf/2604.17476)**
...
>
---
#### [replaced 002] PLUME: Latent Reasoning Based Universal Multimodal Embedding
- **分类: cs.CV**
...
>
---
#### [replaced 003] StableMTL: Repurposing Latent Diffusion Models for Multi-Task Learning from Partially Annotated Synthetic Datasets
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.08013](https://arxiv.org/pdf/2506.08013)**

> **作者:** Anh-Quan Cao; Ivan Lopes; Raoul de Charette
>
> **备注:** Accepted at CVPR 2026. Code is at this https URL
>
...
>
---
#### [replaced 004] Bidirectional Learning of Facial Action Units and Expressions via Structured Semantic Mapping across Heterogeneous Datasets
- **分类: cs.CV**
...
>
> **备注:** The source code and models will be publicly available at this https URL
>
...
>
---
#### [replaced 005] TrianguLang: Geometry-Aware Semantic Consensus for Pose-Free 3D Localization
- **分类: cs.CV**
...
>
> **备注:** Tables updated with current results, typographical errors fixed
>
...
>
---
#### [replaced 006] Architecture-Agnostic Modality-Isolated Gated Fusion for Robust Multi-Modal Prostate MRI Segmentation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 009] Unleashing Spatial Reasoning in Multimodal Large Language Models via Textual Representation Guided Reasoning
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 010] CamPVG: Camera-Controlled Panoramic Video Generation with Epipolar-Aware Diffusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.19979](https://arxiv.org/pdf/2509.19979)**
...
>
---
#### [replaced 011] SMILE-UHURA Challenge -- Small Vessel Segmentation at Mesoscopic Scale from Ultra-High Resolution 7T Magnetic Resonance Angiograms
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2411.09593](https://arxiv.org/pdf/2411.09593)**
...
>
---
#### [replaced 013] EmoVerse: A MLLMs-Driven Emotion Representation Dataset for Interpretable Visual Emotion Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.12554](https://arxiv.org/pdf/2511.12554)**
...
>
---
#### [replaced 015] DualToken: Towards Unifying Visual Understanding and Generation with Dual Visual Vocabularies
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 021] Adaptive Quantized Planetary Crater Detection System for Autonomous Space Exploration
...
>
---
#### [replaced 024] Understanding Counting Mechanisms in Large Language and Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.17699](https://arxiv.org/pdf/2511.17699)**
...
>
---
#### [replaced 026] TinySR: Pruning Diffusion for Real-World Image Super-Resolution
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.17434](https://arxiv.org/pdf/2508.17434)**
...
>
---
#### [replaced 027] QuadSync: Quadrifocal Tensor Synchronization via Tucker Decomposition
- **分类: cs.CV; math.NA; math.OC**

- **链接: [https://arxiv.org/pdf/2602.22639](https://arxiv.org/pdf/2602.22639)**

> **作者:** Daniel Miao; Gilad Lerman; Joe Kileel
>
> **备注:** 30 pages, accepted to CVPR 2026 as an Oral Presentation. Complementary code can be found at this http URL
>
...
>
---
#### [replaced 028] Noise Injection: Improving Out-of-Distribution Generalization for Limited Size Datasets
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.03855](https://arxiv.org/pdf/2511.03855)**
...
>
---
#### [replaced 033] Vision Language Models are Biased
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2505.23941](https://arxiv.org/pdf/2505.23941)**

> **作者:** An Vo; Khai-Nguyen Nguyen; Mohammad Reza Taesiri; Vy Tuong Dang; Anh Totti Nguyen; Daeyoung Kim
>
> **备注:** Code and qualitative examples are available at: this http URL
>
...
>
---
#### [replaced 034] OVOD-Agent: A Markov-Bandit Framework for Proactive Visual Reasoning and Self-Evolving Detection
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21064](https://arxiv.org/pdf/2511.21064)**
...
>
---
#### [replaced 035] VLN-NF: Feasibility-Aware Vision-and-Language Navigation with False-Premise Instructions
...
>
---
#### [replaced 036] ViT$^3$: Unlocking Test-Time Training in Vision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01643](https://arxiv.org/pdf/2512.01643)**
...
>
---
#### [replaced 037] CROC: Evaluating and Training T2I Metrics with Pseudo- and Human-Labeled Contrastive Robustness Checks
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 038] GeoRC: A Benchmark for Geolocation Reasoning Chains
...
>
---
#### [replaced 039] Context Matters: Peer-Aware Student Behavioral Engagement Measurement via VLM Action Parsing and LLM Sequence Classification
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 040] Vision-Braille: A Curriculum Learning Toolkit and Braille-Chinese Corpus for Braille Translation
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 046] When Visuals Aren't the Problem: Evaluating Vision-Language Models on Misleading Data Visualizations
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 047] OpenVLThinkerV2: A Generalist Multimodal Reasoning Model for Multi-domain Visual Tasks
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 048] DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.05449](https://arxiv.org/pdf/2602.05449)**

> **作者:** Chang Zou; Changlin Li; Yang Li; Patrol Li; Jianbing Wu; Xiao He; Songtao Liu; Zhao Zhong; Kailin Huang; Linfeng Zhang
>
> **备注:** 18 pages, 8 figures; cvpr2026 paper
>
...
>
---
#### [replaced 052] Dehaze-then-Splat: Generative Dehazing with Physics-Informed 3D Gaussian Splatting for Smoke-Free Novel View Synthesis
- **分类: cs.CV**
...
>
---
#### [replaced 055] OD3: Optimization-free Dataset Distillation for Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.01942](https://arxiv.org/pdf/2506.01942)**
...
>
---
#### [replaced 056] Compressing then Matching: An Efficient Pre-training Paradigm for Multimodal Embedding
- **分类: cs.CV; cs.IR**

- **链接: [https://arxiv.org/pdf/2511.08480](https://arxiv.org/pdf/2511.08480)**
...
>
---
#### [replaced 059] Reading Recognition in the Wild
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.24848](https://arxiv.org/pdf/2505.24848)**
...
>
---
#### [replaced 060] ScienceBoard: Evaluating Multimodal Autonomous Agents in Realistic Scientific Workflows
...
>
---
#### [replaced 063] FlowCoMotion: Text-to-Motion Generation via Token-Latent Flow Modeling
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 064] ToLL: Topological Layout Learning with Asymmetric Cross-View Structural Distillation for 3D Scene Graph Generation Pretraining
- **分类: cs.CV**
...
>
---
#### [replaced 066] LLaMA-XR: A Novel Framework for Radiology Report Generation using LLaMA and QLoRA Fine Tuning
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.03178](https://arxiv.org/pdf/2506.03178)**
...
>
---
#### [replaced 067] NullFace: Training-Free Localized Face Anonymization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.08478](https://arxiv.org/pdf/2503.08478)**

> **作者:** Han-Wei Kung; Tuomas Varanka; Terence Sim; Nicu Sebe
>
> **备注:** Accepted to the 2026 International Conference on Automatic Face and Gesture Recognition (FG)
>
...
>
---
#### [replaced 068] ProfVLM: A lightweight video-language model for multi-view proficiency estimation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 069] GeoArena: Evaluating Open-World Geographic Reasoning in Large Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 070] Error as Signal: Stiffness-Aware Diffusion Sampling via Embedded Runge-Kutta Guidance
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 071] AIM 2025 Rip Current Segmentation (RipSeg) Challenge Report
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.13401](https://arxiv.org/pdf/2508.13401)**
...
>
> **备注:** Challenge report paper from AIM Workshop at ICCV 2025
>
...
>
---
#### [replaced 074] TextTIGER: Text-based Intelligent Generation with Entity Prompt Refinement for Text-to-Image Generation
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 075] MMErroR: A Benchmark for Erroneous Reasoning in Vision-Language Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.03331](https://arxiv.org/pdf/2601.03331)**
...
>
---
#### [replaced 076] Unified Multimodal Brain Decoding via Cross-Subject Soft-ROI Fusion
- **分类: cs.LG; cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2512.20249](https://arxiv.org/pdf/2512.20249)**
...
>
---
#### [replaced 077] Render-of-Thought: Rendering Textual Chain-of-Thought as Images for Visual Latent Reasoning
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 078] SegWithU: Uncertainty as Perturbation Energy for Single-Forward-Pass Risk-Aware Medical Image Segmentation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2604.15271](https://arxiv.org/pdf/2604.15271)**
...
>
---
#### [replaced 079] FoleyDirector: Fine-Grained Temporal Steering for Video-to-Audio Generation via Structured Scripts
- **分类: cs.SD; cs.CV**
...
>
---
#### [replaced 084] Pref-GRPO: Pairwise Preference Reward-based GRPO for Stable Text-to-Image Reinforcement Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.20751](https://arxiv.org/pdf/2508.20751)**

> **作者:** Yibin Wang; Zhimin Li; Yuhang Zang; Yujie Zhou; Jiazi Bu; Chunyu Wang; Qinglin Lu; Cheng Jin; Jiaqi Wang
>
> **备注:** Project Page: this https URL
>
> **摘要:** Recent advancements highlight the importance of GRPO-based reinforcement learning methods and benchmarking in enhancing text-to-image (T2I) generation. However, current methods using pointwise reward models (RM) for scoring generated images are susceptible to reward hacking. We reveal that this happens when minimal score differences between images are amplified after normalization, creating illusory advantages that drive the model to over-optimize for trivial gains, ultimately destabilizing the image generation process. To address this, we propose Pref-GRPO, a pairwise preference reward-based GRPO method that shifts the optimization objective from score maximization to preference fitting, ensuring more stable training. In Pref-GRPO, images are pairwise compared within each group using preference RM, and the win rate is used as the reward signal. Extensive experiments demonstrate that PREF-GRPO differentiates subtle image quality differences, providing more stable advantages and mitigating reward hacking. Additionally, existing T2I benchmarks are limited by coarse evaluation criteria, hindering comprehensive model assessment. To solve this, we introduce UniGenBench, a unified T2I benchmark comprising 600 prompts across 5 main themes and 20 subthemes. It evaluates semantic consistency through 10 primary and 27 sub-criteria, leveraging MLLM for benchmark construction and evaluation. Our benchmarks uncover the strengths and weaknesses of both open and closed-source T2I models and validate the effectiveness of Pref-GRPO.
>
---
#### [replaced 085] Phantom: Physics-Infused Video Generation via Joint Modeling of Visual and Latent Physical Dynamics
- **分类: cs.CV**
...
>
---
#### [replaced 086] Preparation of Fractal-Inspired Computational Architectures for Automated Neural Design Exploration
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.07329](https://arxiv.org/pdf/2511.07329)**
...
>
---
#### [replaced 087] EgoEsportsQA: An Egocentric Video Benchmark for Perception and Reasoning in Esports
...
>
---
#### [replaced 088] Navigating Distribution Shifts in Medical Image Analysis: A Survey
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2411.05824](https://arxiv.org/pdf/2411.05824)**

> **作者:** Zixian Su; Jingwei Guo; Xi Yang; Qiufeng Wang; Frans Coenen; Amir Hussain; Kaizhu Huang
>
...
>
---
#### [replaced 089] TimeColor: Flexible Reference Colorization via Temporal Concatenation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.00296](https://arxiv.org/pdf/2601.00296)**
...
>
---
#### [replaced 092] Bridging the Ex-Vivo to In-Vivo Gap: Synthetic Priors for Monocular Depth Estimation in Specular Surgical Environments
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 093] Driving in Corner Case: A Real-World Adversarial Closed-Loop Evaluation Platform for End-to-End Autonomous Driving
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 094] Integrating Feature Selection and Machine Learning for Nitrogen Assessment in Grapevine Leaves using In-Field Hyperspectral Imaging
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.17869](https://arxiv.org/pdf/2507.17869)**
...
>
---
#### [replaced 096] Sub-metre Lunar DEM Generation and Validation from Chandrayaan-2 OHRC Multi-View Imagery Using an Open-Source Pipeline
- **分类: cs.CV**
...
>
---
#### [replaced 097] PowerCLIP: Powerset Alignment for Contrastive Pre-Training
- **分类: cs.CV**
...
>
---
#### [replaced 098] Are We Using the Right Benchmark: An Evaluation Framework for Visual Token Compression Methods
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.07143](https://arxiv.org/pdf/2510.07143)**
...
>
---
#### [replaced 100] Ouroboros: Single-step Diffusion Models for Cycle-consistent Forward and Inverse Rendering
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.14461](https://arxiv.org/pdf/2508.14461)**
...
>
---
#### [replaced 101] Uni-MMMU: A Massive Multi-discipline Multimodal Unified Benchmark
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.13759](https://arxiv.org/pdf/2510.13759)**
...
>
---
#### [replaced 102] VIDEOP2R: Video Understanding from Perception to Reasoning
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.11113](https://arxiv.org/pdf/2511.11113)**
...
>
---
#### [replaced 109] SpatialStack: Layered Geometry-Language Fusion for 3D VLM Spatial Reasoning
- **分类: cs.CV**
...
>
---
#### [replaced 110] Sculpting the Vector Space: Towards Efficient Multi-Vector Visual Document Retrieval via Prune-then-Merge Framework
...
>
---
#### [replaced 114] VLM-3R: Vision-Language Models Augmented with Instruction-Aligned 3D Reconstruction
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 117] Mammo-FM: Breast-specific foundational model for Integrated Mammographic Diagnosis, Prognosis, and Reporting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00198](https://arxiv.org/pdf/2512.00198)**
...
>
---
#### [replaced 118] MegaRAG: Multimodal Knowledge Graph-Based Retrieval Augmented Generation
...
>
---
#### [replaced 119] Self-Correcting Text-to-Video Generation with Misalignment Detection and Localized Refinement
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 122] 2D or 3D: Who Governs Salience in VLA Models? -- Tri-Stage Token Pruning Framework with Modality Salience Awareness
...
>
---
#### [replaced 123] Mechanisms of Multimodal Synchronization: Insights from Decoder-Based Video-Text-to-Speech Synthesis
...
>
---
#### [replaced 130] InternScenes: A Large-scale Simulatable Indoor Scene Dataset with Realistic Layouts
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 131] What's Left Unsaid? Detecting and Correcting Misleading Omissions in Multimodal News Previews
- **分类: cs.CV; cs.SI**
...
>
---
#### [replaced 135] Beyond the Failures: Rethinking Foundation Models in Pathology
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23807](https://arxiv.org/pdf/2510.23807)**
...
>
---
#### [replaced 136] LLaVA-Octopus: Unlocking Instruction-Driven Adaptive Projector Fusion for Video Understanding
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2501.05067](https://arxiv.org/pdf/2501.05067)**

> **作者:** Boyuan Sun; Jiaxing Zhao; Xiang Chen; Xihan Wei; Qibin Hou
>
> **备注:** 18 pages, 10 figures
>
...
>
---
#### [replaced 137] A deep learning pipeline for PAM50 subtype classification using histopathology images and multi-objective patch selection
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 138] Dual-End Consistency Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.10764](https://arxiv.org/pdf/2602.10764)**
...
>
---
#### [replaced 143] Generating Attribution Reports for Manipulated Facial Images: A Dataset and Baseline
- **分类: cs.CV; cs.AI**
...
>
> **备注:** Accepted to ACL 2026 (Main Conference). This version includes camera-ready revisions and updated experimental results
>
...
>
---
#### [replaced 146] Removing Motion Artifact in MRI by Using a Perceptual Loss Driven Deep Learning Framework
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.10439](https://arxiv.org/pdf/2604.10439)**

> **作者:** Ziheng Guo; Danqun Zheng; Shuai Li; Chengwei Chen; Boyang Pan; Xuezhou Li; Ziqin Yu; Langdi Zhong; Chenwei Shao; Yun Bian; Nan-Jie Gong
>
> **备注:** 7 figrues, 6 tables
>
> **摘要:** Purpose: Deep learning-based MRI artifact correction methods often demonstrate poor generalization to clinical data. This limitation largely stems from the inability of deep learning models in reliably distinguishing motion artifacts from true anatomical structures, due to insufficient awareness of artifact characteristics. To address this challenge, we proposed PERCEPT-Net, a deep learning framework that enhances structure preserving and suppresses artifact through dedicated perceptual this http URL: PERCEPT-Net is built on a residual U-Net backbone and incorporates three auxiliary components. The first multi-scale recovery module is designed to preserve both global anatomical context and fine structural details, while the second dual attention mechanisms further improve performance by prioritizing clinically relevant features. At the core of the framework is the third Motion Perceptual Loss (MPL), an artifact-aware perceptual supervision strategy that learns generalized representations of MRI motion artifacts, enabling the model to effectively suppress them while maintaining anatomical fidelity. The model is trained on a hybrid dataset comprising both real and simulated paired volumes, and its performance is validated on a prospective test set using a combination of quantitative metrics and qualitative assessments by experienced this http URL: PERCEPT-Net outperformed state-of-the-art methods on clinical data. Ablation studies identified the Motion Perceptual Loss as the primary contributor to this performance, yielding significant improvements in structural consistency and tissue contrast, as reflected by higher SSIM and PSNR values. These findings were further corroborated by radiologist evaluations, which demonstrated significantly higher diagnostic confidence in the corrected volumes.
>
---
#### [replaced 147] ADAPT: Benchmarking Commonsense Planning under Unspecified Affordance Constraints
...
>
---
#### [replaced 148] Joint Distillation for Fast Likelihood Evaluation and Sampling in Flow-based Models
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02636](https://arxiv.org/pdf/2512.02636)**
...
>
---
#### [replaced 149] MUSEG: Reinforcing Video Temporal Understanding via Timestamp-Aware Multi-Segment Grounding
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 150] Hydra: Unifying Document Retrieval and Generation in a Single Vision-Language Model
...
> **作者:** Athos Georgiou
>
> **备注:** 21 pages, 4 figures, 10 tables, 1 algorithm. v3: two-scale release (4B, 0.8B); bitwise generation-equivalence (426/426 LM tensors at 4B); peak VRAM -62.7% at 4B, -59.1% at 0.8B; GritLM joint-training ablation; Qwen2.5-Omni-3B omni extension. Models: this http URL
>
...
>
---
#### [replaced 153] AWPD: Frequency Shield Network for Agnostic Watermark Presence Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2603.06723](https://arxiv.org/pdf/2603.06723)**

> **作者:** Xiang Ao; Yilin Du; Zidan Wang; Mengru Chen; Siyang Lu
>
...
>
---
#### [replaced 154] Graph neural network for colliding particles with an application to sea ice floe modeling
- **分类: cs.LG; cs.AI; cs.CV; physics.comp-ph**

- **链接: [https://arxiv.org/pdf/2602.16213](https://arxiv.org/pdf/2602.16213)**

> **作者:** Ruibiao Zhu
>
> **备注:** Zhu, R. Graph Neural Network for Colliding Particles with an Application to Sea Ice Floe Modeling. Arab J Sci Eng (2026). this https URL
>
...
>
---
#### [replaced 155] COREY: Entropy-Guided Runtime Chunk Scheduling for Selective Scan Kernels
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 157] Enabling Stroke-Level Structural Analysis of Hieroglyphic Scripts without Language-Specific Priors
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 162] RA-RRG: Multimodal Retrieval-Augmented Radiology Report Generation with Key Phrase Extraction
...
>
---
#### [replaced 168] VideoThinker: Building Agentic VideoLLMs with LLM-Guided Tool Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.15724](https://arxiv.org/pdf/2601.15724)**
...
>
---
#### [replaced 171] MVAD: A Benchmark Dataset for Multimodal AI-Generated Video-Audio Detection
- **分类: cs.CV**
...
>
---
#### [replaced 172] High-Resolution Visual Reasoning via Multi-Turn Grounding-Based Reinforcement Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.05920](https://arxiv.org/pdf/2507.05920)**
...
>
---
#### [replaced 173] FrameVGGT: Geometry-Aligned Frame-Level Memory for Bounded Streaming VGGT
- **分类: cs.CV**
...
>
---
#### [replaced 177] AvatarPointillist: AutoRegressive 4D Gaussian Avatarization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.04787](https://arxiv.org/pdf/2604.04787)**
