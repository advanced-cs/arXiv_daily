...
#### [new 001] M3Net: A Macro-to-Meso-to-Micro Clinical-inspired Hierarchical 3D Network for Pulmonary Nodule Classification
- **分类: cs.CV**

- **简介: 该论文属于肺结节分类任务，旨在解决CT图像中良恶性结节准确分类的问题。提出M3Net模型，融合多尺度上下文信息，提升分类性能与可解释性。**

- **链接: [https://arxiv.org/pdf/2605.12570](https://arxiv.org/pdf/2605.12570)**
...
>
---
#### [new 002] Phy-CoSF: Physics-Guided Continuous Spectral Fields Reconstruction and Super-Resolution for Snapshot Compressive Imaging
- **分类: cs.CV**

- **简介: 该论文属于高光谱成像任务，解决CASSI系统中连续光谱重建与超分辨率问题，提出Phy-CoSF框架实现高保真光谱合成。**

- **链接: [https://arxiv.org/pdf/2605.13583](https://arxiv.org/pdf/2605.13583)**
...
>
> **摘要:** Geospatial foundation models (GFMs) have been proposed as generalizable backbones for disaster response, land-cover mapping, food-security monitoring, and other high-stakes Earth-observation tasks. Yet the published work about these models does not give reviewers or users enough information to tell which model fits a given task. We argue that nobody knows what the current state of the art is in geospatial foundation models. The methods may be useful, but the GFM literature does not standardize evaluations, training and testing protocols, released weights, or pretraining controls well enough for anyone to compare or rank them. In a 152-paper audit, we find 46 cross-paper disagreements of at least 10 points for the same model, benchmark, and protocol; 94/126 papers with extractable pretraining data use a configuration no other paper uses; and 39% of GFM papers release no model weights. This lack of community standards can be solved. We propose six concrete expectations: named-license weight release, shared core evaluations, copied-versus-rerun baseline annotations, variance reporting, one shared evaluation harness, and data-vs-architecture-vs-algorithm controls. These gaps are a coordination failure, not a fault of any individual lab; the authors of this paper, like many others in the GFM community, have contributed to them. Rather than just critiquing the community, we aim to provide concrete steps toward a shared understanding of how to innovate GFMs.
>
---
#### [new 004] Learning to See What You Need: Gaze Attention for Multimodal Large Language Models
- **分类: cs.CV**

- **简介: 该论文属于多模态语言模型任务，旨在解决模型注意力分散和计算冗余问题。通过引入Gaze Attention机制，实现对视觉区域的精准关注，提升效率与效果。**

- **链接: [https://arxiv.org/pdf/2605.13080](https://arxiv.org/pdf/2605.13080)**
...
>
---
#### [new 005] CRePE: Curved Ray Expectation Positional Encoding for Unified-Camera-Controlled Video Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视频生成任务，解决相机控制下的位置编码问题。针对传统方法在广角和鱼眼镜头下的局限性，提出CRePE，实现统一相机模型兼容的位置编码，提升生成视频的几何感知与稳定性。**

- **链接: [https://arxiv.org/pdf/2605.12938](https://arxiv.org/pdf/2605.12938)**
...
>
---
#### [new 017] Rethinking Graph Convolution for 2D-to-3D Hand Pose Lifting
- **分类: cs.CV**

- **简介: 该论文属于3D手部姿态估计任务，旨在提升2D到3D手部姿态的准确性。通过对比图卷积与自注意力机制，发现自注意力更有效，并提出基于骨架约束的图注意力网络。**

- **链接: [https://arxiv.org/pdf/2605.13604](https://arxiv.org/pdf/2605.13604)**
...
>
---
#### [new 020] MedCore: Boundary-Preserving Medical Core Pruning for MedSAM
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分割任务，旨在解决医学分割模型参数过大且压缩可能损害边界精度的问题。提出MedCore框架，通过结构化剪枝保留关键结构，提升模型效率与边界保真度。**

- **链接: [https://arxiv.org/pdf/2605.13688](https://arxiv.org/pdf/2605.13688)**
...
>
---
#### [new 021] Reducing Bias and Variance: Generative Semantic Guidance and Bi-Layer Ensemble for Image Clustering
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像聚类任务，旨在解决传统方法依赖预定义词汇和忽视方差问题。提出GSEC框架，通过生成语义引导和双层集成减少偏差与方差。**
...
>
---
#### [new 030] Training Long-Context Vision-Language Models Effectively with Generalization Beyond 128K Context
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型任务，旨在解决长文本上下文建模问题。通过系统研究长文本预训练方法，提出MMProLong模型，提升长文档理解与跨任务泛化能力。**

- **链接: [https://arxiv.org/pdf/2605.13831](https://arxiv.org/pdf/2605.13831)**
...
>
---
#### [new 036] STAR: Semantic-Temporal Adaptive Representation Learning for Few-Shot Action Recognition
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于少样本动作识别任务，解决语义-时序对齐不足和多尺度时序建模问题，提出STAR框架提升模型性能。**

- **链接: [https://arxiv.org/pdf/2605.13202](https://arxiv.org/pdf/2605.13202)**
...
>
---
#### [new 043] Pareto-Guided Optimal Transport for Multi-Reward Alignment
- **分类: cs.CV**

- **简介: 该论文属于文本到图像生成任务，旨在解决多奖励模型对齐问题。针对现有方法易受奖励欺骗及平衡冲突目标困难的问题，提出PG-OT框架，提升多奖励协同效果。**

- **链接: [https://arxiv.org/pdf/2605.13155](https://arxiv.org/pdf/2605.13155)**
...
>
---
#### [new 044] HarmoGS: Robust 3D Gaussian Splatting in the Wild via Conflict-Aware Gradient Harmonization
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，解决野外场景中3D高斯泼溅的不稳定问题。通过引入语义一致性掩码和梯度协调策略，提升重建质量。**

- **链接: [https://arxiv.org/pdf/2605.13073](https://arxiv.org/pdf/2605.13073)**
...
>
---
#### [new 047] M2Retinexformer: Multi-Modal Retinexformer for Low-Light Image Enhancement
- **分类: cs.CV**

- **简介: 该论文属于低光图像增强任务，旨在解决复杂退化问题。通过引入多模态信息（深度、亮度、语义）改进Retinexformer，提升增强效果。**

- **链接: [https://arxiv.org/pdf/2605.12556](https://arxiv.org/pdf/2605.12556)**
...
>
---
#### [new 054] ReTool-Video: Recursive Tool-Using Video Agents with Meta-Augmented Tool Grounding
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频理解任务，旨在解决视频推理中工具空间粗略和动作空间扁平的问题。通过构建细粒度工具库和递归工具使用方法，提升视频理解的稳定性与效果。**

- **链接: [https://arxiv.org/pdf/2605.13228](https://arxiv.org/pdf/2605.13228)**
...
>
---
#### [new 055] MambaPanoptic: A Vision Mamba-based Structured State Space Framework for Panoptic Segmentation
- **分类: cs.CV**

- **简介: 该论文提出MambaPanoptic，用于全景分割任务，解决长距离依赖、多尺度特征和高效预测难题。通过MambaFPN和特征精修模块提升性能。**
...
>
---
#### [new 084] Fast and Compact Graph Cuts for the Boykov-Kolmogorov Algorithm
- **分类: cs.CV; cs.DS**

- **简介: 该论文研究最小s-t割问题，针对Boykov-Kolmogorov算法进行优化，提出更高效的fcBK算法，提升计算速度与内存效率。**

- **链接: [https://arxiv.org/pdf/2605.13402](https://arxiv.org/pdf/2605.13402)**
...
>
> **摘要:** Computing a minimum $s$-$t$ cut in a graph is a solution to a wide range of computer vision problems, and is often done using the Boykov-Kolmogorov (BK) algorithm. In this paper, we revisit the BK algorithm from both a theoretical and practical point of view. We improve the analysis of the time complexity of the BK algorithm to $O(mn|C|)$ and propose a new algorithm, the fast and compact BK (fcBK) algorithm, with a time complexity of $O(m|C|)$, where $m$, $n$, and $|C|$ are the number of edges, number of vertices, and the capacity of the cut, respectively. We additionally propose a compact graph representation that allows our implementation to find a minimum $s$-$t$ cut in a graph with upwards of $10^9$ vertices and $10^{10}$ edges on a machine with 128 GB of memory. We find our implementation of the BK algorithm to be the fastest available implementation of the BK algorithm when evaluating on a comprehensive set of benchmark datasets, highlighting the importance of memory-efficient implementations. We make our implementations publicly available for further research and implementation development within minimum $s$-$t$ cut algorithms.
>
---
#### [new 085] VideoSEAL: Mitigating Evidence Misalignment in Agentic Long Video Understanding by Decoupling Answer Authority
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于长视频问答任务，解决证据错位问题。通过解耦规划与答案权威，提升答案准确性和证据对齐度。**

- **链接: [https://arxiv.org/pdf/2605.12571](https://arxiv.org/pdf/2605.12571)**
...
>
---
#### [new 089] KamonBench: A Grammar-Based Dataset for Evaluating Compositional Factor Recovery in Vision-Language Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出KamonBench，一个用于评估视觉-语言模型组合因子恢复的基准数据集。任务是解决稀疏组合视觉识别中的因子恢复问题，通过合成图像与结构化描述进行评估。**

- **链接: [https://arxiv.org/pdf/2605.13322](https://arxiv.org/pdf/2605.13322)**
...
>
---
#### [new 090] Unlocking Patch-Level Features for CLIP-Based Class-Incremental Learning
- **分类: cs.CV**

- **简介: 该论文属于类增量学习任务，旨在解决模型在持续学习新类别时的灾难性遗忘问题。通过引入语义引导的局部特征对齐方法，提升模型识别能力。**

- **链接: [https://arxiv.org/pdf/2605.13835](https://arxiv.org/pdf/2605.13835)**
...
>
---
#### [new 094] Characterizing Universal Object Representations Across Vision Models
- **分类: cs.CV; cs.LG; q-bio.NC**

- **简介: 该论文研究深度学习模型的视觉表征一致性问题，通过分解模型相似性结构，识别出普遍存在的视觉维度，探讨其与生物视觉的相关性。**

- **链接: [https://arxiv.org/pdf/2605.13675](https://arxiv.org/pdf/2605.13675)**
...
>
---
#### [new 095] PreFIQs: Face Image Quality Is What Survives Pruning
- **分类: cs.CV**

- **简介: 该论文属于人脸图像质量评估任务，解决如何无监督地评估人脸图像对自动识别系统的有用性。提出PreFIQs框架，通过模型剪枝后嵌入差异衡量图像质量。**

- **链接: [https://arxiv.org/pdf/2605.13396](https://arxiv.org/pdf/2605.13396)**
...
>
---
#### [new 101] OmniLiDAR: A Unified Diffusion Framework for Multi-Domain 3D LiDAR Generation
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出OmniLiDAR，解决多领域3D LiDAR生成问题，通过统一框架实现跨域可控生成。**

- **链接: [https://arxiv.org/pdf/2605.13815](https://arxiv.org/pdf/2605.13815)**
...
>
---
#### [new 108] Just Ask for a Table: A Thirty-Token User Prompt Defeats Sponsored Recommendations in Twelve LLMs
- **分类: cs.CV**

- **简介: 该论文属于AI伦理与安全领域，旨在解决LLM在推荐中受赞助影响的问题。通过设计特定提示，有效降低推荐率，提升公平性。**

- **链接: [https://arxiv.org/pdf/2605.12772](https://arxiv.org/pdf/2605.12772)**
...
>
---
#### [new 125] Robust and Explainable Bicuspid Aortic Valve Diagnosis Using Stacked Ensembles on Echocardiography
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在解决Bicuspid Aortic Valve（BAV）与Tricuspid Aortic Valve（TAV）的自动诊断问题。通过集成学习方法，利用超声心动图视频实现准确、可解释的分类。**

- **链接: [https://arxiv.org/pdf/2605.13730](https://arxiv.org/pdf/2605.13730)**
...
>
---
#### [new 126] LoREnc: Low-Rank Encryption for Securing Foundation Models and LoRA Adapters
- **分类: cs.CR; cs.CV; cs.LG**

- **简介: 该论文属于模型安全任务，旨在解决基础模型和LoRA适配器的知识产权泄露问题。提出LoREnc框架，通过低秩截断和补偿实现无需训练的保护。**

- **链接: [https://arxiv.org/pdf/2605.13163](https://arxiv.org/pdf/2605.13163)**

> **作者:** Beomjin Ahn; Jungmin Kwon; Chanyong Jung; Jaewook Chung
>
> **备注:** Accepted to ICIP 2026
>
> **摘要:** Foundation models and low-rank adapters enable efficient on-device generative AI but raise risks such as intellectual property leakage and model recovery attacks. Existing defenses are often impractical because they require retraining or access to the original dataset. We propose LoREnc, a training-free framework that secures both FMs and adapters via spectral truncation and compensation. LoREnc suppresses dominant low-rank components of FM weights, compensates for the missing information in authorized adapters, and further applies orthogonal reparameterization to obscure structural fingerprints of the protected adapter. Unauthorized users produce structurally collapsed outputs, while authorized users recover exact performance. Experiments demonstrate that LoREnc provides strong protection against model recovery with under 1% computational overhead.
>
---
#### [new 127] Taming the Long Tail: Rebalancing Adversarial Training via Adaptive Perturbation
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于对抗训练任务，解决长尾数据下模型脆弱性和类别不平衡问题。提出RobustLT框架，通过自适应调整扰动提升模型鲁棒性与平衡性。**

- **链接: [https://arxiv.org/pdf/2605.13395](https://arxiv.org/pdf/2605.13395)**
...
>
---
#### [new 136] Action Emergence from Streaming Intent
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于自动驾驶任务，旨在解决动作生成问题。提出Streaming Intent方法，通过场景推理生成符合意图的驾驶动作，提升路径规划的多样性和可控性。**
...
>
---
#### [new 140] Utility-Oriented Visual Evidence Selection for Multimodal Retrieval-Augmented Generation
...
>
---
#### [new 143] A General Bézier Tree Encoding Counterfactual Framework for Retinal-Vessel-Mediated Disease Analysis
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学图像分析任务，旨在解决血管结构与疾病关系的因果验证问题。提出BTECF框架，通过贝塞尔树编码实现对视网膜血管结构的可控生成与干预。**

- **链接: [https://arxiv.org/pdf/2605.13015](https://arxiv.org/pdf/2605.13015)**
...
>
---
#### [new 144] Generative Motion In-betweening by Diffusion over Continuous Implicit Representations
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于运动插值任务，旨在解决关键帧信息保留和运动连续性问题。通过结合隐式神经表示与扩散模型，从稀疏关键帧生成高质量、多样化的运动。**

- **链接: [https://arxiv.org/pdf/2605.12778](https://arxiv.org/pdf/2605.12778)**
...
>
---
#### [new 145] Towards Long-horizon Embodied Agents with Tool-Aligned Vision-Language-Action Models
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文属于机器人控制任务，旨在解决长时序任务中VLA模型的局限性。通过分层结构和工具对齐训练，提升任务成功率和执行精度。**

- **链接: [https://arxiv.org/pdf/2605.13119](https://arxiv.org/pdf/2605.13119)**
...
>
---
#### [new 146] DocAtlas: Multilingual Document Understanding Across 80+ Languages
...
>
---
#### [new 147] CiteVQA: Benchmarking Evidence Attribution for Trustworthy Document Intelligence
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 152] DeepFilters: Scattering-Aware Pupil Engineering with Learned Digital Filter Reconstruction for Extended Depth of Field Microscopy
- **分类: physics.optics; cs.CV**

- **简介: 该论文属于显微成像任务，旨在解决散射组织中深度扩展的问题。通过联合优化瞳孔滤波器和数字滤波网络，实现更广的焦深和深层信号恢复。**

- **链接: [https://arxiv.org/pdf/2605.13619](https://arxiv.org/pdf/2605.13619)**
...
>
---
#### [replaced 003] (Sparse) Attention to the Details: Preserving Spectral Fidelity in ML-based Weather Forecasting Models
...
>
---
#### [replaced 006] Improving Classifier-Free Guidance of Flow Matching via Manifold Projection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.21892](https://arxiv.org/pdf/2601.21892)**
...
>
---
#### [replaced 007] CoWorld-VLA: Thinking in a Multi-Expert World Model for Autonomous Driving
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2605.10426](https://arxiv.org/pdf/2605.10426)**
...
>
---
#### [replaced 008] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09479](https://arxiv.org/pdf/2508.09479)**

> **作者:** Xuejun Huang; Xinyi Liu; Yi Wan; Zhi Zheng; Bin Zhang; Mingtao Xiong; Yingying Pei; Yongjun Zhang
>
> **备注:** AAAI 2026. Code is available at this https URL
>
> **摘要:** Three-dimensional scene reconstruction from sparse-view satellite images is a long-standing and challenging task. While 3D Gaussian Splatting (3DGS) and its variants have recently attracted attention for its high efficiency, existing methods remain unsuitable for satellite images due to incompatibility with rational polynomial coefficient (RPC) models and limited generalization capability. Recent advances in generalizable 3DGS approaches show potential, but they perform poorly on multi-temporal sparse satellite images due to limited geometric constraints, transient objects, and radiometric inconsistencies. To address these limitations, we propose SkySplat, a novel self-supervised framework that integrates the RPC model into the generalizable 3DGS pipeline, enabling more effective use of sparse geometric cues for improved reconstruction. SkySplat relies only on RGB images and radiometric-robust relative height supervision, thereby eliminating the need for ground-truth height maps. Key components include a Cross-Self Consistency Module (CSCM), which mitigates transient object interference via consistency-based masking, and a multi-view consistency aggregation strategy that refines reconstruction results. Compared to per-scene optimization methods, SkySplat achieves an 86 times speedup over EOGS with higher accuracy. It also outperforms generalizable 3DGS baselines, reducing MAE from 13.18 m to 1.80 m on the DFC19 dataset significantly, and demonstrates strong cross-dataset generalization on the MVS3D benchmark. The is available at this https URL
>
---
#### [replaced 009] TMPO: Trajectory Matching Policy Optimization for Diverse and Efficient Diffusion Alignment
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2605.10983](https://arxiv.org/pdf/2605.10983)**

> **作者:** Jiaming Li; Chenyu Zhu; Nanxi Yi; Youjun Bao; Li Sun; Quanying Lv; Xiang Fang; Daizong Liu; Jianjun Li; Kun He; Bowen Zhou; Zhiyuan Ma
>
...
>
---
#### [replaced 014] Efficient Geometry-Controlled High-Resolution Satellite Image Synthesis
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2605.04557](https://arxiv.org/pdf/2605.04557)**
...
>
---
#### [replaced 016] Energy Scaling Laws for Diffusion Models: Quantifying Compute in Image Generation
- **分类: cs.LG; cs.CV; cs.CY**

- **链接: [https://arxiv.org/pdf/2511.17031](https://arxiv.org/pdf/2511.17031)**
...
>
---
#### [replaced 019] Aligning Forest and Trees in Images & Long Captions for Visually Grounded Understanding
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.02977](https://arxiv.org/pdf/2602.02977)**
...
>
---
#### [replaced 020] Beyond Localization: A Comprehensive Diagnosis of Perspective-Conditioned Spatial Reasoning in MLLMs from Omnidirectional Images
- **分类: cs.CV**
...
>
> **备注:** Under review at ACM MM 2026. Corresponding author: Wai Keung Wong (this http URL@polyu.this http URL). 10pages, 4 figures
>
...
>
---
#### [replaced 021] StreamGaze: Gaze-Guided Temporal Reasoning and Proactive Understanding in Streaming Videos
...
>
---
#### [replaced 022] SS3D: End2End Self-Supervised 3D from Web Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.22686](https://arxiv.org/pdf/2604.22686)**
...
>
---
#### [replaced 023] Deep Delta Learning
...
>
---
#### [replaced 024] Kiwi-Edit: Versatile Video Editing via Instruction and Reference Guidance
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 025] Auditing Sybil: Explaining Deep Lung Cancer Risk Prediction Through Generative Interventional Attributions
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.02560](https://arxiv.org/pdf/2602.02560)**
...
>
---
#### [replaced 026] Aquatic Neuromorphic Optical Flow
- **分类: cs.CV; eess.IV**
...
>
> **备注:** This work is under review. Project page: this https URL
>
...
>
---
#### [replaced 027] Skill-Conditioned Visual Geolocation for Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2604.09025](https://arxiv.org/pdf/2604.09025)**

> **作者:** Chenjie Yang; Yutian Jiang; Yutong Deng; Chenyu Wu
>
...
>
---
#### [replaced 028] Is SAM3 ready for pathology segmentation?
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 029] UniCustom: Unified Visual Conditioning for Multi-Reference Image Generation
- **分类: cs.CV**
...
>
> **备注:** Accepted to CVPR 2026. Revised version with corrected AU-PRO evaluation and recomputed metrics
>
> **摘要:** Detecting visual anomalies in industrial inspection often requires training with only a few normal images per category. Recent few-shot methods achieve strong results employing foundation-model features, but typically rely on memory banks, auxiliary datasets, or multi-modal tuning of vision-language models. We therefore question whether such complexity is necessary given the feature representations of vision foundation models. To answer this question, we introduce SubspaceAD, a training-free method, that operates in two simple stages. First, patch-level features are extracted from a small set of normal images by a frozen DINOv2 backbone. Second, a Principal Component Analysis (PCA) model is fit to these features to estimate the low-dimensional subspace of normal variations. At inference, anomalies are detected via the reconstruction residual with respect to this subspace, producing interpretable and statistically grounded anomaly scores. Despite its simplicity, SubspaceAD achieves state-of-the-art performance across one-shot and few-shot settings without training, prompt tuning, or memory banks. In the one-shot anomaly detection setting, SubspaceAD achieves image-level and pixel-level AUROC of 97.1% and 97.5% on the MVTec-AD dataset, and 93.2% and 98.2% on the VisA dataset, respectively, surpassing prior state-of-the-art results. Code and demo are available at this https URL.
>
---
#### [replaced 032] Topo-R1: Detecting Topological Anomalies via Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 039] Compact 3D Gaussian Splatting For Dense Visual SLAM
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于视觉SLAM任务，旨在解决3D高斯溅射方法内存占用高、训练慢的问题。通过减少高斯椭球数量和参数大小，提升效率并保持重建质量。**

- **链接: [https://arxiv.org/pdf/2403.11247](https://arxiv.org/pdf/2403.11247)**
...
>
---
#### [replaced 040] Guidestar-Free Adaptive Optics with Asymmetric Apertures
- **分类: eess.IV; cs.CV**
...
>
---
#### [replaced 041] From Pixels to BFS: High Maze Accuracy Does Not Imply Visual Planning
- **分类: cs.LG; cs.CV**
...
>
---
#### [replaced 042] SpectralTrain: A Universal Framework for Hyperspectral Image Classification
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.16084](https://arxiv.org/pdf/2511.16084)**

> **作者:** Meihua Zhou; Liping Yu; Xinyu Tong; Wai Kin Fung; Ruiguo Hu; Jiarui Zhao; Wenzhuo Liu; Nan Wan
>
...
>
---
#### [replaced 043] Agentic AI for Remote Sensing: Technical Challenges and Research Directions
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.24919](https://arxiv.org/pdf/2604.24919)**
...
>
> **备注:** 25 pages, 10 figures; corrected typos and citations
>
...
>
---
#### [replaced 045] Revisit What You See: Revealing Visual Semantics in Vision Tokens to Guide LVLM Decoding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 046] Breaking Down and Building Up: Mixture of Skill-Based Vision-and-Language Navigation Agents
...
>
---
#### [replaced 047] Adapting Vision-Language Models for Neutrino Event Classification in High-Energy Physics
...
>
---
#### [replaced 048] LENS: Multi-level Evaluation of Multimodal Reasoning with Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.15616](https://arxiv.org/pdf/2505.15616)**
...
>
---
#### [replaced 049] The Multi-View Paradigm Shift in MRI Radiomics: Predicting MGMT Methylation in Glioblastoma
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.22331](https://arxiv.org/pdf/2512.22331)**
...
>
---
#### [replaced 058] Reasoning to Edit: Hypothetical Instruction-Based Image Editing with Visual Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.01908](https://arxiv.org/pdf/2507.01908)**
...
>
---
#### [replaced 059] ALAM: Algebraically Consistent Latent Action Model for Vision-Language-Action Models
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文提出ALAM模型，解决VLA模型中动作数据稀缺的问题。通过视频学习结构化潜在动作，提升策略生成效果。**
...
>
---
#### [replaced 060] DeCo-DETR: Decoupled Cognition DETR for efficient Open-Vocabulary Object Detection
- **分类: cs.CV**
...
>
---
#### [replaced 061] Ilov3Splat: Instance-Level Open-Vocabulary 3D Scene Understanding in Gaussian Splatting
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2605.04506](https://arxiv.org/pdf/2605.04506)**
...
>
---
#### [replaced 063] PairDropGS: Paired Dropout-Induced Consistency Regularization for Sparse-View Gaussian Splatting
- **分类: cs.CV**
...
>
---
#### [replaced 071] ReLIC-SGG: Relation Lattice Completion for Open-Vocabulary Scene Graph Generation
- **分类: cs.CV**
...
>
> **备注:** Some errors in the experimental sections
>
...
>
---
#### [replaced 074] VIP: Visual-guided Prompt Evolution for Efficient Dense Vision-Language Inference
- **分类: cs.CV**
...
>
> **备注:** Accepted by ICML2026. Code is available at this https URL
>
...
>
---
#### [replaced 075] Cross-Modal-Domain Generalization Through Semantically Aligned Discrete Representations
- **分类: cs.CV**
...
>
> **备注:** Added missing affiliation for co-author R. Younis and Z. Ahmadi
>
...
>
---
#### [replaced 076] sketch2symm: Symmetry-aware sketch-to-shape generation via semantic bridging
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.11303](https://arxiv.org/pdf/2510.11303)**
...
>
---
#### [replaced 079] When Backdoors Meet Partial Observability: Attacking Real-World Reinforcement Learning
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于强化学习安全任务，解决真实环境中后门攻击问题。针对部分可观测场景，提出DGBA框架，通过视觉触发和优势中毒策略实现有效攻击。**

- **链接: [https://arxiv.org/pdf/2601.14104](https://arxiv.org/pdf/2601.14104)**

> **作者:** Tairan Huang; Qingqing Ye; Yulin Jin; Jiawei Lian; Yaxin Xiao; Yi Wang; Haibo Hu
>
> **摘要:** Backdoor attacks can cause reinforcement learning (RL) policies to behave normally under clean inputs while executing malicious behaviors when triggers are present. Existing RL backdoor attacks are primarily studied in simulation and often assume that attackers can reliably manipulate the observations driving policy decisions. This assumption becomes fragile in real-world deployment, where RL policies commonly rely on multimodal observations. Attackers can manipulate visual inputs through physical triggers, but auxiliary states such as LiDAR and odometry signals remain uncontrollable and vary across trajectories. We study this overlooked challenge and propose a diffusion-guided backdoor attack framework (DGBA) for real-world RL. DGBA uses small printable visual patches as triggers and learns a stochastic trigger distribution via conditional diffusion to maintain consistent attack activation under varying uncontrollable states. We further introduce an advantage-based poisoning strategy that injects triggers only at decision-critical training states. Experiments on a physical TurtleBot3 platform show that DGBA consistently outperforms prior RL backdoor attacks while preserving normal task performance. Demo videos and code are available in the supplementary material.
>
---
#### [replaced 080] GeomHair: Reconstruction of Hair Strands from Colorless 3D Scans
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.05376](https://arxiv.org/pdf/2505.05376)**
...
>
> **备注:** Accepted to IEEE Transactions on Dependable and Secure Computing 2026
>
...
>
---
#### [replaced 087] A Mimetic Detector for Adversarial Image Perturbations
- **分类: cs.CV**
...
> **作者:** Johnny Corbino
>
> **备注:** v2: extended Table 1 with results for order $k=8$; minor revisions for clarity
>
...
>
---
#### [replaced 088] Prototype-Based Test-Time Adaptation of Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 092] PersonalAlign: Hierarchical Implicit Intent Alignment for Personalized GUI Agent with Long-Term User-Centric Records
- **分类: cs.AI; cs.CV; cs.HC; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.09636](https://arxiv.org/pdf/2601.09636)**

> **作者:** Yibo Lyu; Gongwei Chen; Rui Shao; Weili Guan; Liqiang Nie
>
> **备注:** Accepted to ACL26 Main
>
...
>
---
#### [replaced 093] ZeD-MAP: Bundle Adjustment Guided Zero-Shot Depth Maps for Real-Time Aerial Imaging
- **分类: cs.CV; cs.LG; cs.RO**

- **简介: 该论文属于实时航空影像深度重建任务，解决大尺度、低纹理等挑战，通过结合扩散模型与束调整技术，实现高精度、实时的三维地图生成。**
...
>
---
#### [replaced 094] The Joint Gromov Wasserstein Objective for Multiple Object Matching
- **分类: cs.CV; q-bio.BM**

- **链接: [https://arxiv.org/pdf/2511.16868](https://arxiv.org/pdf/2511.16868)**
...
>
---
#### [replaced 095] Exploring Multimodal LMMs for Online Episodic Memory Question Answering on the Edge
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.22455](https://arxiv.org/pdf/2602.22455)**
...
>
---
#### [replaced 096] Fashion130K: An E-commerce Fashion Dataset for Outfit Generation with Unified Multi-modal Condition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.10127](https://arxiv.org/pdf/2605.10127)**
...
>
---
#### [replaced 100] When Diffusion Breaks Constraints: Sequential Autoregressive Generation with RL and MCTS
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 101] Leveraging Multimodal Large Language Models for All-in-One Image Restoration via a Mixture of Frequency Experts
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.11444](https://arxiv.org/pdf/2605.11444)**

> **作者:** Eunho Lee; Rei Kawakami; Youngbae Hwang
>
...
>
---
#### [replaced 108] Simulation-Ready Cluttered Scene Estimation via Physics-aware Joint Shape and Pose Optimization
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于真实到仿真场景重建任务，解决杂乱环境中物体形状与位姿估计问题。提出联合优化方法，结合物理约束与结构稀疏性，提升重建精度与效率。**
...
>
---
#### [replaced 109] MCLR: Improving Conditional Modeling via Inter-Class Likelihood-Ratio Maximization and Unifying Classifier-Free Guidance with Alignment Objectives
- **分类: cs.LG; cs.AI; cs.CV**
...
>
---
#### [replaced 113] Robotic Manipulation by Imitating Generated Videos Without Physical Demonstrations
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文提出RIGVid系统，通过模仿AI生成视频实现机器人操作，解决无需物理演示的复杂任务控制问题。工作包括视频生成、过滤、姿态跟踪与迁移。**

- **链接: [https://arxiv.org/pdf/2507.00990](https://arxiv.org/pdf/2507.00990)**
