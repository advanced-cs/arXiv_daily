...
- **简介: 该论文任务为跨语言和文体的认知扭曲检测，解决多语言场景下的心理 distress 早期识别问题，通过分析荷兰青少年论坛文本，验证领域适应方法在跨语言/文体场景中的有效性。**
...
- **简介: 论文介绍BioASQ 2024挑战，聚焦生物医学语义索引与问答，新增多语言临床实体识别及嵌套NER任务，评估37支团队700+提交，推动领域技术进步。**
...
- **简介: 该论文采用案例推理方法，利用TF-IDF与余弦相似度自动推荐信息工程实践题目的标题，解决实践题目生成难题，通过测试验证了系统有效性。**
...
- **简介: 该论文研究利用语言模型生成K-12教育中的多项选择题（MCQ），旨在降低人工制卷成本与不一致性。通过对比中型模型（Gemma）与大模型（GPT-3.5），评估七种结构化提示策略，发现结合思维链与顺序设计可显著提升中型模型性能。**
...
- **简介: 论文针对开放式文本生成中平衡连贯性与多样性的挑战，提出GUARD方法，通过Glocal不确定性框架结合全局/局部熵信号，降低计算成本，提升生成效率与质量。**
...
- **简介: 论文提出KG-CQR，用于RAG系统检索任务，解决复杂查询上下文丢失问题，通过结构化关系提取KG子图增强查询表示，提升检索效果。**
...
- **简介: 论文提出工业级LLM基准测试CAMB，用于评估民用航空维护领域的模型性能，解决缺乏专用评估工具的问题，通过实验验证效果并开源。**
...
- **简介: 该论文提出EASI-RAG敏捷方法，解决工业中小企业部署检索增强生成（RAG）工具的资源与技术难题，通过结构化流程与案例验证，实现快速高效部署及迭代优化。**
...
- **链接: [http://arxiv.org/pdf/2508.20893v1](http://arxiv.org/pdf/2508.20893v1)**
...
- **简介: 本文研究句子关系抽取任务，提出基于胶囊网络的动态路由方法，解决模型性能差异问题。通过重新表征提升匹配度，发现Wikidata标签噪声影响性能。**
...
- **链接: [http://arxiv.org/pdf/2508.20973v1](http://arxiv.org/pdf/2508.20973v1)**
...
- **简介: 该论文针对隐含仇恨言论检测任务，解决传统方法依赖显性词汇的局限，通过微调通用LLM嵌入模型（如Stella、E5等）实现跨数据集的高精度检测，取得F1-macro得分显著提升。**
...
- **简介: 该论文介绍BioASQ 2025挑战，聚焦生物医学语义索引与问答，新增多语言临床摘要、嵌套实体链接、心内科编码等任务，评估系统性能以推动领域技术进步。**
...
- **简介: 该论文构建ConspirED数据集，用于识别阴谋论认知特征及评估LLM对阴谋论输入的鲁棒性，以应对AI生成虚假信息。**
...
- **简介: 论文针对长上下文LLM的推理问题，提出JERR框架，通过图结构和MCTS增强关系推理，提升性能和可解释性。**
...
- **简介: 论文针对ASR中命名实体纠正问题，提出利用语音特征检索候选实体并生成注释的方法，有效解决词形差异导致的错误，提升实体准确性。**
...
- **简介: 该论文提出UI-Bench，首个评估AI文本到应用工具设计能力的基准，通过专家对比测试10种工具，300个网站和4000+判断，建立可复现标准并发布框架与排行榜。**
...
- **链接: [http://arxiv.org/pdf/2508.20333v1](http://arxiv.org/pdf/2508.20333v1)**
...
- **简介: 论文提出GDS代理，用于解决LLMs处理大规模图数据的不足，通过整合图算法工具、MCP服务器及新基准测试，提升图推理能力。**
...
- **简介: 论文针对LLM的有害RL微调问题，提出TokenBuncher防御机制，通过抑制模型响应不确定性，阻止RL利用奖励信号驱动有害行为，并通过熵奖励和Token Noiser实现有效防护，验证其在多个模型和算法上的有效性。**
...
- **简介: 该论文通过系统综述评估生成式AI（如LLMs）在医学基因组学中的应用，分析其在基因组变异识别、医学影像分析等方面的作用及整合多模态数据的挑战，为临床应用提供指导。**
...
- **简介: 该论文提出统一语言理论，结合贝叶斯模型与性选择解释语言进化，整合构造语法，涵盖语用、语法、语义，通过统一结构实现快速处理，解决语言多样性和认知连续性问题。**
...
>
---
#### [new 069] OLMoASR: Open Models and Data for Training Robust Speech Recognition Models
...
#### [replaced 001] GLProtein: Global-and-Local Structure Aware Protein Representation Learning
- **分类: cs.LG; cs.AI; cs.CL; q-bio.BM**

- **链接: [http://arxiv.org/pdf/2506.06294v2](http://arxiv.org/pdf/2506.06294v2)**
...
>
---
#### [replaced 002] Entropy-Memorization Law: Evaluating Memorization Difficulty of Data in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.06056v2](http://arxiv.org/pdf/2507.06056v2)**
...
>
---
#### [replaced 003] WideSearch: Benchmarking Agentic Broad Info-Seeking
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.07999v2](http://arxiv.org/pdf/2508.07999v2)**
...
>
---
#### [replaced 004] CoMoE: Contrastive Representation for Mixture-of-Experts in Parameter-Efficient Fine-tuning
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17553v2](http://arxiv.org/pdf/2505.17553v2)**
...
>
---
#### [replaced 005] SoAy: A Solution-based LLM API-using Methodology for Academic Information Seeking
- **分类: cs.CL; cs.AI; cs.SE**

- **链接: [http://arxiv.org/pdf/2405.15165v2](http://arxiv.org/pdf/2405.15165v2)**
...
>
---
#### [replaced 008] Network Formation and Dynamics Among Multi-LLMs
- **分类: cs.SI; cs.AI; cs.CL; cs.MA**

- **链接: [http://arxiv.org/pdf/2402.10659v5](http://arxiv.org/pdf/2402.10659v5)**

> **作者:** Marios Papachristou; Yuan Yuan
>
...
>
---
#### [replaced 009] Bridging Compositional and Distributional Semantics: A Survey on Latent Semantic Geometry via AutoEncoder
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.20083v3](http://arxiv.org/pdf/2506.20083v3)**
...
>
---
#### [replaced 010] AraHealthQA 2025: The First Shared Task on Arabic Health Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.20047v2](http://arxiv.org/pdf/2508.20047v2)**
...
>
---
#### [replaced 011] RLMR: Reinforcement Learning with Mixed Rewards for Creative Writing
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.18642v2](http://arxiv.org/pdf/2508.18642v2)**
...
>
---
#### [replaced 012] Enhancing Natural Language Inference Performance with Knowledge Graph for COVID-19 Automated Fact-Checking in Indonesian Language
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2409.00061v3](http://arxiv.org/pdf/2409.00061v3)**
...
>
---
#### [replaced 013] Seeing is Believing: Emotion-Aware Audio-Visual Language Modeling for Expressive Speech Generation
...
>
---
#### [replaced 014] Explainability of Text Processing and Retrieval Methods: A Survey
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2212.07126v2](http://arxiv.org/pdf/2212.07126v2)**
...
>
---
#### [replaced 015] NLKI: A lightweight Natural Language Knowledge Integration Framework for Improving Small VLMs in Commonsense VQA Tasks
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.19724v2](http://arxiv.org/pdf/2508.19724v2)**
...
>
---
#### [replaced 016] Humans Perceive Wrong Narratives from AI Reasoning Texts
- **分类: cs.HC; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.16599v2](http://arxiv.org/pdf/2508.16599v2)**
...
>
---
#### [replaced 017] Relative Drawing Identification Complexity is Invariant to Modality in Vision-Language Models
...
>
---
#### [replaced 020] DART: Distilling Autoregressive Reasoning to Silent Thought
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.11752v2](http://arxiv.org/pdf/2506.11752v2)**
...
>
---
#### [replaced 021] A Highly Clean Recipe Dataset with Ingredient States Annotation for State Probing Task
- **分类: cs.MM; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.17232v2](http://arxiv.org/pdf/2507.17232v2)**
...
>
---
#### [replaced 022] The Ramon Llull's Thinking Machine for Automated Ideation
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19200v2](http://arxiv.org/pdf/2508.19200v2)**
...
>
---
#### [replaced 023] Improving the quality of Web-mined Parallel Corpora of Low-Resource Languages using Debiasing Heuristics
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.19074v2](http://arxiv.org/pdf/2502.19074v2)**
...
>
---
#### [replaced 027] OLKAVS: An Open Large-Scale Korean Audio-Visual Speech Dataset
...
>
---
#### [replaced 028] Dynamic Context Compression for Efficient RAG
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.22931v2](http://arxiv.org/pdf/2507.22931v2)**
...
>
---
#### [replaced 029] Exploring Typographic Visual Prompts Injection Threats in Cross-Modality Generation Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 030] SpecVLM: Enhancing Speculative Decoding of Video LLMs via Verifier-Guided Token Pruning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 031] Continuously Steering LLMs Sensitivity to Contextual Knowledge with Proxy Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19720v2](http://arxiv.org/pdf/2508.19720v2)**
...
>
---
#### [replaced 032] Anemoi: A Semi-Centralized Multi-agent System Based on Agent-to-Agent Communication MCP server from Coral Protocol
- **分类: cs.MA; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.17068v2](http://arxiv.org/pdf/2508.17068v2)**
...
>
---
#### [replaced 033] Neither Valid nor Reliable? Investigating the Use of LLMs as Judges
- **分类: cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2508.18076v2](http://arxiv.org/pdf/2508.18076v2)**
...
>
---
#### [replaced 036] Steering Towards Fairness: Mitigating Political Bias in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.08846v2](http://arxiv.org/pdf/2508.08846v2)**
...
>
---
#### [replaced 037] Probing Pre-Trained Language Models for Cross-Cultural Differences in Values
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2203.13722v3](http://arxiv.org/pdf/2203.13722v3)**

> **作者:** Arnav Arora; Lucie-Aimée Kaffee; Isabelle Augenstein
>
> **备注:** Accepted to C3NLP, EACL 2023: https://aclanthology.org/2023.c3nlp-1.12/
>
...
>
---
#### [replaced 038] Safeguard Fine-Tuned LLMs Through Pre- and Post-Tuning Model Merging
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2412.19512v3](http://arxiv.org/pdf/2412.19512v3)**
...
>
---
#### [replaced 039] CoCoTen: Detecting Adversarial Inputs to Large Language Models through Latent Space Features of Contextual Co-occurrence Tensors
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.02997v3](http://arxiv.org/pdf/2508.02997v3)**
...
>
---
#### [replaced 040] Adversarial Manipulation of Reasoning Models using Internal Representations
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.03167v2](http://arxiv.org/pdf/2507.03167v2)**
...
>
---
#### [replaced 043] Are formal and functional linguistic mechanisms dissociated in language models?
- **分类: cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2503.11302v4](http://arxiv.org/pdf/2503.11302v4)**
...
>
---
#### [replaced 046] Forewarned is Forearmed: Pre-Synthesizing Jailbreak-like Instructions to Enhance LLM Safety Guardrail to Potential Attacks
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.20038v2](http://arxiv.org/pdf/2508.20038v2)**
