...
- **简介: 该论文属于EEG到图像生成任务，旨在解决从EEG信号中准确解码视觉表示的问题。提出五阶段框架提升图像质量和语义对齐。**
...
- **简介: 该论文属于植物表型分析任务，旨在解决传统方法的主观性和不一致性问题。通过构建TomatoMAP数据集，提供多角度、多姿态的图像及精细标注，支持深度学习模型进行自动表型分析。**
...
- **简介: 该论文属于多视角立体（MVS）任务，旨在解决纹理缺失和反光区域的深度估计问题。通过融合单目先验信息提升MVS性能。**
...
- **简介: 该论文属于医学图像翻译任务，解决CBCT到MDCT转换中的阴影伪影问题。通过结合Schrödinger Bridge与条件扩散模型，实现更精确的图像生成。**
...
- **链接: [http://arxiv.org/pdf/2507.10893v1](http://arxiv.org/pdf/2507.10893v1)**
...
- **简介: 该论文属于图像处理任务，解决模糊图像中圆检测与拟合问题。提出3C-FBI算法，结合边缘采样和卷积密度估计，实现高精度与实时性。**
...
- **简介: 该论文属于图像生成任务，旨在解决森林火灾烟雾数据不足的问题。通过引入掩码引导的生成框架和新损失函数，提升烟雾图像的逼真度与多样性，增强检测效果。**
...
- **简介: 该论文属于空间问答任务，解决复杂仓库场景下的空间理解问题。提出一种数据高效的方法，构建具备强空间推理能力的LLM代理系统，提升对象检索、计数和距离估计的准确性与效率。**
...
- **简介: 该论文属于低光照图像增强任务，解决传统方法忽略语义信息和特征特性的不足，提出CWNet模型，结合因果推理与小波变换提升增强效果。**
...
- **简介: 该论文属于情感识别任务，解决多模态数据不完整的问题。提出MCULoRA方法，通过解耦模态组合信息和动态调整训练比例，提升模型性能。**
...
- **简介: 该论文属于热红外图像中的自动目标检测与识别任务，针对数据少、环境复杂等问题，提出改进的YOLOatr模型，实现高精度实时检测。**
...
- **简介: 该论文属于人脸修复任务，解决身份不确定性问题。通过引入身份注入模块和对齐学习，提升修复结果的身份一致性与质量。**
...
- **简介: 该论文属于个性化开放词汇语义分割任务，解决用户自定义文本（如“我的杯子”）的精准分割问题。通过文本提示调优和负掩码提议提升性能。**
...
- **简介: 该论文属于医学图像分割任务，解决语言引导分割中对配对文本的依赖问题。提出ProLearn框架，通过语义原型近似减少对文本的依赖。**
...
- **简介: 该论文属于目标检测任务，解决高分辨率卫星图像中对象检测问题。通过结合Transformer与CNN，提出GLOD架构，提升检测精度与效率。**
...
- **简介: 该论文属于血管几何建模任务，解决传统方法在复杂结构生成上的局限性。提出HUG-VAS模型，结合NURBS与扩散生成模型，实现精确的主动脉几何合成与编辑。**
...
- **简介: 该论文属于图像分类任务，旨在解决柑橘病害识别中标注数据不足的问题。通过引入聚类引导的多层对比学习方法，提升模型性能。**
...
- **简介: 该论文属于3D视觉定位任务，解决多锚点查询中的目标分离和视角差异导致的空间描述不一致问题。提出ViewSRD框架，通过多视角分解与交互实现精准的3D物体定位。**
...
- **简介: 该论文属于航天器实时分割任务，旨在解决空间维修中自主检测数据不足的问题。研究构建了64k张标注数据集，并优化YOLO模型以提升实时分割性能。**
...
- **简介: 该论文属于道路病害识别任务，旨在解决GPR图像中RSD自动识别难题。通过构建高质量数据集并提出交叉验证策略，提升识别准确率，减少人工检测工作量。**
...
- **简介: 该论文属于深度估计任务，旨在解决传统方法成本高、泛化能力差的问题。通过研究大规模数据和深度学习模型，探索构建鲁棒的深度基础模型。**
...
>
---
#### [new 050] Sparse Fine-Tuning of Transformers for Generative Tasks
- **分类: cs.CV**
...
- **简介: 该论文属于图像理解任务，旨在解决关键点精准识别问题。提出KptLLM++模型，通过多模态融合和结构化推理实现通用关键点理解。**
...
- **简介: 该论文属于3D内容编辑任务，旨在解决Gaussian Splatting中局部3D编辑不精确的问题。提出RoMaP框架，结合3D掩码和正则化损失实现精准的部件级编辑。**
...
- **简介: 该论文属于文本到图像生成任务，解决角色一致性问题。通过点追踪注意力和自适应标记合并，提升前后景细节的一致性。**
...
- **简介: 该论文属于长视频生成任务，旨在解决缺乏全面叙事评估基准的问题。提出NarrLV基准，通过量化叙事单元和设计评估指标，提升对模型叙事能力的评价准确性。**
...
- **简介: 该论文属于图像去雾任务，旨在解决Transformer模型计算成本高、频域与空域耦合弱的问题。提出DGFDNet框架，结合频域与空域信息，提升去雾效果与实时性。**
...
- **简介: 该论文属于视觉Transformer任务，解决固定计算预算导致的部署效率问题。提出ThinkingViT，通过动态调整计算量提升模型灵活性与效率。**
...
- **简介: 该论文属于图像分类任务，旨在解决 jellyfish 种类识别问题。通过融合深度学习与传统机器学习方法，构建高效分类模型，提升识别准确率。**
...
>
---
#### [new 067] AGFS-Tractometry: A Novel Atlas-Guided Fine-Scale Tractometry Approach for Enhanced Along-Tract Group Statistical Comparison Using Diffusion MRI Tractography
- **分类: q-bio.QM; cs.CV; cs.LG; eess.IV; stat.ME**

- **简介: 该论文属于脑白质研究任务，旨在提升扩散MRI纤维追踪的组间统计分析。提出AGFS-Tractometry方法，解决局部白质差异检测问题，通过模板和非参数检验实现更精确的比较。**

- **链接: [http://arxiv.org/pdf/2507.10601v1](http://arxiv.org/pdf/2507.10601v1)**
...
>
---
#### [new 068] A Simple Baseline for Stable and Plastic Neural Networks
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于持续学习任务，解决模型在连续任务中遗忘与适应的平衡问题。提出RDBP方法，结合ReLUDown和梯度调度，提升模型稳定性与适应性。**

- **链接: [http://arxiv.org/pdf/2507.10637v1](http://arxiv.org/pdf/2507.10637v1)**
...
>
---
#### [new 069] SFATTI: Spiking FPGA Accelerator for Temporal Task-driven Inference -- A Case Study on MNIST
- **分类: cs.NE; cs.CV**

- **简介: 该论文属于边缘计算中的图像识别任务，旨在解决低功耗、低延迟的神经网络推理问题。研究使用Spiker+框架生成SNN加速器，优化MNIST手写数字识别。**

- **链接: [http://arxiv.org/pdf/2507.10561v1](http://arxiv.org/pdf/2507.10561v1)**
...
>
---
#### [new 070] Latent Space Consistency for Sparse-View CT Reconstruction
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于CT图像重建任务，解决稀疏视角X-ray重建3D CT的问题。通过引入跨模态对比学习，实现2D与3D潜在空间对齐，提升重建质量。**

- **链接: [http://arxiv.org/pdf/2507.11152v1](http://arxiv.org/pdf/2507.11152v1)**

> **作者:** Duoyou Chen; Yunqing Chen; Can Zhang; Zhou Wang; Cheng Chen; Ruoxiu Xiao
>
> **备注:** ACMMM2025 Accepted
>
> **摘要:** Computed Tomography (CT) is a widely utilized imaging modality in clinical settings. Using densely acquired rotational X-ray arrays, CT can capture 3D spatial features. However, it is confronted with challenged such as significant time consumption and high radiation exposure. CT reconstruction methods based on sparse-view X-ray images have garnered substantial attention from researchers as they present a means to mitigate costs and risks. In recent years, diffusion models, particularly the Latent Diffusion Model (LDM), have demonstrated promising potential in the domain of 3D CT reconstruction. Nonetheless, due to the substantial differences between the 2D latent representation of X-ray modalities and the 3D latent representation of CT modalities, the vanilla LDM is incapable of achieving effective alignment within the latent space. To address this issue, we propose the Consistent Latent Space Diffusion Model (CLS-DM), which incorporates cross-modal feature contrastive learning to efficiently extract latent 3D information from 2D X-ray images and achieve latent space alignment between modalities. Experimental results indicate that CLS-DM outperforms classical and state-of-the-art generative models in terms of standard voxel-level metrics (PSNR, SSIM) on the LIDC-IDRI and CTSpine1K datasets. This methodology not only aids in enhancing the effectiveness and economic viability of sparse X-ray reconstructed CT but can also be generalized to other cross-modal transformation tasks, such as text-to-image synthesis. We have made our code publicly available at https://anonymous.4open.science/r/CLS-DM-50D6/ to facilitate further research and applications in other domains.
>
---
#### [new 071] HANS-Net: Hyperbolic Convolution and Adaptive Temporal Attention for Accurate and Generalizable Liver and Tumor Segmentation in CT Imaging
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决肝癌CT图像中准确且泛化分割的问题。提出HANS-Net框架，结合多种技术提升分割精度与鲁棒性。**

- **链接: [http://arxiv.org/pdf/2507.11325v1](http://arxiv.org/pdf/2507.11325v1)**
...
>
---
#### [new 072] Comparative Analysis of Vision Transformers and Traditional Deep Learning Approaches for Automated Pneumonia Detection in Chest X-Rays
- **分类: eess.IV; cs.AI; cs.CV; cs.NE**

- **简介: 该论文属于医学图像分类任务，旨在解决肺炎自动检测问题。对比了传统方法与Vision Transformers，发现Cross-ViT在准确率和召回率上表现更优。**

- **链接: [http://arxiv.org/pdf/2507.10589v1](http://arxiv.org/pdf/2507.10589v1)**
...
>
---
#### [new 075] Can Multimodal Foundation Models Understand Schematic Diagrams? An Empirical Study on Information-Seeking QA over Scientific Papers
- **分类: cs.CL; cs.CV**

- **简介: 该论文属于多模态理解任务，旨在评估模型解读科学文献中示意图的能力。研究构建了MISS-QA基准，测试18个模型的表现，并分析其优缺点。**
...
>
---
#### [new 076] Learning to Tune Like an Expert: Interpretable and Scene-Aware Navigation via MLLM Reasoning and CVAE-Based Adaptation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 077] Stochastic Entanglement Configuration for Constructive Entanglement Topologies in Quantum Machine Learning with Application to Cardiac MRI
- **分类: quant-ph; cs.CV; cs.ET; cs.LG**

- **简介: 该论文属于量子机器学习任务，旨在解决固定纠缠拓扑限制模型性能的问题。通过随机生成纠缠配置，提升心脏MRI分类准确率。**

- **链接: [http://arxiv.org/pdf/2507.11401v1](http://arxiv.org/pdf/2507.11401v1)**
...
>
---
#### [new 080] Spatial Reasoners for Continuous Variables in Any Domain
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于空间推理任务，解决在任意领域对连续变量进行推理的问题。工作是开发了一个开源框架Spatial Reasoners，简化生成模型的推理过程。**

- **链接: [http://arxiv.org/pdf/2507.10768v1](http://arxiv.org/pdf/2507.10768v1)**

> **作者:** Bart Pogodzinski; Christopher Wewer; Bernt Schiele; Jan Eric Lenssen
>
> **备注:** For the project documentation see https://spatialreasoners.github.io/ . The SRM project website is available at https://geometric-rl.mpi-inf.mpg.de/srm/ . The work was published on ICML 2025 CODEML workshop
>
...
>
---
#### [new 081] rt-RISeg: Real-Time Model-Free Robot Interactive Segmentation for Active Instance-Level Object Understanding
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 082] Whom to Respond To? A Transformer-Based Model for Multi-Party Social Robot Interaction
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 083] Teach Me Sign: Stepwise Prompting LLM for Sign Language Production
...
>
---
#### [new 084] U-RWKV: Lightweight medical image segmentation with direction-adaptive RWKV
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医疗图像分割任务，旨在解决资源受限环境下模型性能与效率的平衡问题。提出U-RWKV框架，结合方向自适应和阶段自适应模块，提升分割效果与计算效率。**

- **链接: [http://arxiv.org/pdf/2507.11415v1](http://arxiv.org/pdf/2507.11415v1)**
...
>
---
#### [new 085] All Eyes, no IMU: Learning Flight Attitude from Vision Alone
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 086] TRAN-D: 2D Gaussian Splatting-based Sparse-view Transparent Object Depth Reconstruction via Physics Simulation for Scene Update
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 087] Vision Language Action Models in Robotic Manipulation: A Systematic Review
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 088] NavComposer: Composing Language Instructions for Navigation Trajectories through Action-Scene-Object Modularization
- **分类: cs.AI; cs.CL; cs.CV**

- **简介: 该论文属于语言引导导航任务，解决指令生成质量与数量不足的问题。提出NavComposer框架，通过模块化重组语义实体生成高质量指令，并引入NavInstrCritic进行无标注评估。**
...
>
---
#### [new 089] Deep Equilibrium models for Poisson Imaging Inverse problems via Mirror Descent
- **分类: math.OC; cs.CV; 65K10, 65J22, 94A08, 47N10**

- **简介: 该论文属于图像重建任务，解决Poison逆问题。通过引入基于镜像下降的DEQ模型，提升重建效果并减少对初始化和超参数的依赖。**

- **链接: [http://arxiv.org/pdf/2507.11461v1](http://arxiv.org/pdf/2507.11461v1)**
...
>
---
#### [new 090] First-Order Error Matters: Accurate Compensation for Quantized Large Language Models
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **简介: 该论文属于模型压缩任务，解决量化误差补偿问题。提出FOEM方法，通过引入一阶梯度项提升量化精度，显著提升模型性能。**
...
>
---
#### [new 091] Flows and Diffusions on the Neural Manifold
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于生成模型任务，解决权重空间学习问题。通过梯度流匹配统一轨迹推断方法，提升权重生成与初始化效果。**

- **链接: [http://arxiv.org/pdf/2507.10623v1](http://arxiv.org/pdf/2507.10623v1)**
...
#### [replaced 001] AnnoPage Dataset: Dataset of Non-Textual Elements in Documents with Fine-Grained Categorization
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.22526v2](http://arxiv.org/pdf/2503.22526v2)**
...
>
---
#### [replaced 007] Learning and Transferring Better with Depth Information in Visual Reinforcement Learning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 008] Similarity Memory Prior is All You Need for Medical Image Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00585v3](http://arxiv.org/pdf/2507.00585v3)**

> **作者:** Hao Tang; Zhiqing Guo; Liejun Wang; Chao Liu
>
...
>
---
#### [replaced 009] Robustifying 3D Perception via Least-Squares Graphs for Multi-Agent Object Tracking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.04762v2](http://arxiv.org/pdf/2507.04762v2)**
...
>
---
#### [replaced 010] PAN-Crafter: Learning Modality-Consistent Alignment for PAN-Sharpening
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.23367v2](http://arxiv.org/pdf/2505.23367v2)**

> **作者:** Jeonghyeok Do; Sungpyo Kim; Geunhyuk Youk; Jaehyup Lee; Munchurl Kim
>
> **备注:** ICCV 2025 (camera-ready version). Please visit our project page https://kaist-viclab.github.io/PAN-Crafter_site
>
...
>
---
#### [replaced 013] Zero-Shot Hyperspectral Pansharpening Using Hysteresis-Based Tuning for Spectral Quality Control
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2505.16658v2](http://arxiv.org/pdf/2505.16658v2)**
...
>
---
#### [replaced 014] ProactiveVideoQA: A Comprehensive Benchmark Evaluating Proactive Interactions in Video Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09313v2](http://arxiv.org/pdf/2507.09313v2)**
...
>
---
#### [replaced 015] Localizing Before Answering: A Hallucination Evaluation Benchmark for Grounded Medical Multimodal LLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.00744v4](http://arxiv.org/pdf/2505.00744v4)**
...
>
---
#### [replaced 016] IM-LUT: Interpolation Mixing Look-Up Tables for Image Super-Resolution
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09923v2](http://arxiv.org/pdf/2507.09923v2)**
...
>
---
#### [replaced 017] CLA: Latent Alignment for Online Continual Self-Supervised Learning
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.10434v2](http://arxiv.org/pdf/2507.10434v2)**

> **作者:** Giacomo Cignoni; Andrea Cossu; Alexandra Gomez-Villa; Joost van de Weijer; Antonio Carta
>
> **备注:** Accepted at CoLLAs 2025 conference (oral)
>
...
>
---
#### [replaced 020] MVCTrack: Boosting 3D Point Cloud Tracking via Multimodal-Guided Virtual Cues
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 021] View Invariant Learning for Vision-Language Navigation in Continuous Environments
...
>
---
#### [replaced 022] Longitudinal Study of Facial Biometrics at the BEZ: Temporal Variance Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.06858v2](http://arxiv.org/pdf/2507.06858v2)**
...
>
---
#### [replaced 023] FlowAlign: Trajectory-Regularized, Inversion-Free Flow-based Image Editing
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.23145v3](http://arxiv.org/pdf/2505.23145v3)**
...
>
---
#### [replaced 029] Prompt4Trust: A Reinforcement Learning Prompt Augmentation Framework for Clinically-Aligned Confidence Calibration in Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.09279v2](http://arxiv.org/pdf/2507.09279v2)**
...
>
---
#### [replaced 033] petBrain: A New Pipeline for Amyloid, Tau Tangles and Neurodegeneration Quantification Using PET and MRI
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03217v2](http://arxiv.org/pdf/2506.03217v2)**
...
>
---
#### [replaced 040] FA-Seg: A Fast and Accurate Diffusion-Based Method for Open-Vocabulary Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23323v3](http://arxiv.org/pdf/2506.23323v3)**
...
>
---
#### [replaced 041] HiM2SAM: Enhancing SAM2 with Hierarchical Motion Estimation and Memory Optimization towards Long-term Tracking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07603v2](http://arxiv.org/pdf/2507.07603v2)**
...
>
---
#### [replaced 042] Graph-based Multi-Modal Interaction Lightweight Network for Brain Tumor Segmentation (GMLN-BTS) in Edge Iterative MRI Lesion Localization System (EdgeIMLocSys)
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09995v2](http://arxiv.org/pdf/2507.09995v2)**
...
>
---
#### [replaced 049] Recognizing Surgical Phases Anywhere: Few-Shot Test-time Adaptation and Task-graph Guided Refinement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.20254v2](http://arxiv.org/pdf/2506.20254v2)**
...
>
---
#### [replaced 050] Supercharging Floorplan Localization with Semantic Rays
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.09291v2](http://arxiv.org/pdf/2507.09291v2)**

> **作者:** Yuval Grader; Hadar Averbuch-Elor
>
> **备注:** Accepted at ICCV 2025. https://tau-vailab.github.io/SemRayLoc/
>
...
>
---
#### [replaced 051] What Demands Attention in Urban Street Scenes? From Scene Understanding towards Road Safety: A Survey of Vision-driven Datasets and Studies
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.06513v2](http://arxiv.org/pdf/2507.06513v2)**
...
>
---
#### [replaced 052] A Comprehensive Library for Benchmarking Multi-class Visual Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2406.03262v4](http://arxiv.org/pdf/2406.03262v4)**
...
>
---
#### [replaced 055] Intervening in Black Box: Concept Bottleneck Model for Enhancing Human Neural Network Mutual Understanding
- **分类: cs.CV; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.22803v2](http://arxiv.org/pdf/2506.22803v2)**
...
>
---
#### [replaced 058] EECD-Net: Energy-Efficient Crack Detection with Spiking Neural Networks and Gated Attention
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04526v3](http://arxiv.org/pdf/2506.04526v3)**

> **作者:** Shuo Zhang
>
> **备注:** After further careful review and additional checks, we have identified multiple issues in our experimental results and data analysis that significantly affect the validity and reliability of our findings. We believe that these issues are substantial enough to compromise the scientific integrity of the manuscript
>
...
>
---
#### [replaced 061] Stronger, Steadier & Superior: Geometric Consistency in Depth VFM Forges Domain Generalized Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.12753v3](http://arxiv.org/pdf/2504.12753v3)**
