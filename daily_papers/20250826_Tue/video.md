...
- **简介: 论文提出Sketchpose方法，用于细胞分割任务，解决完全标注数据稀缺问题。通过部分标注数据训练距离图预测模型，实现高效 frugal、transfer 和常规学习，保持高分割精度并降低标注成本。**
...
- **链接: [http://arxiv.org/pdf/2508.17216v1](http://arxiv.org/pdf/2508.17216v1)**
...
- **简介: 论文提出SegEarth-OV框架，解决遥感图像中无标注开放词汇语义分割问题。通过SimFeatUp恢复细节和Global Bias Alleviation提升局部语义精度，结合AlignEarth实现光学与SAR图像间的知识迁移，显著优于现有方法。**
...
- **简介: 该论文属于3D室内场景生成任务，旨在解决现有方法难以实现精细物体布局的问题。提出Hierarchical Layout Generation（HLG）方法，通过分层细化策略从大尺度家具到小物件逐步构建真实、结构合理的3D场景。**
...
- **简介: 该论文针对食物图像到文本的匹配任务，提出F4-ITS框架，通过双向特征融合与基于食材的重排序机制提升检索精度，无需训练即可显著优于基线模型。**
...
- **简介: 论文提出基于Mamba架构的异常检测方法，用于大规模点云场景中的开放集分割任务，解决户外场景中训练数据外异常对象识别问题，提升现有方法性能。**
...
- **简介: 该论文提出UniSino，一个用于CT sinogram标准化的基础模型，解决因欠采样和噪声导致的图像伪影问题。通过在投影域直接建模物理特性，实现跨多种欠采样场景的通用增强，提升重建质量与鲁棒性。**
...
- **简介: 论文提出CountLoop框架，解决扩散模型在高实例场景下难以精确控制物体数量的问题。通过迭代生成与多模态代理评估反馈，实现高精度计数（达98%）和高质量图像生成，优于现有方法。**
...
- **简介: 论文属于 underwater image enhancement 任务，旨在提升复杂水下场景中的图像质量。通过融合 VGG19 和 ResNet50 的深度特征，提出统一模型进行多尺度增强，并用 PSNR、UCIQE 等指标量化评估效果，同时给出模型优化与硬件选型建议以提升实用性。**
...
- **简介: 论文提出CAVIA框架，解决长视频问答中推理与视觉感知脱节问题。通过闭环协调机制，使视觉提取动态适应查询需求，提升准确率并避免冗余计算。**
...
- **简介: 论文提出细粒度片段检索（FFR）任务，解决长对话中分散语义内容难以精准召回的问题。构建MLDR数据集与真实场景测试集，设计F2RVLM模型，通过两阶段训练和难度感知采样提升检索精度与连贯性。**
...
- **简介: 论文提出Visual-CoG，用于文本到图像生成任务，解决现有模型在多属性和模糊提示下表现不佳的问题。通过三阶段引导机制与阶段奖励，提升生成过程的可控性和准确性。**
...
- **简介: 论文提出PTMA模型解决在线动作检测中因视角变化导致泛化能力差的问题。通过概率建模和时序掩码注意力机制，提取跨视角不变特征，提升帧级视频分析性能，在多个数据集上达到最优效果。**
...
- **链接: [http://arxiv.org/pdf/2508.16975v1](http://arxiv.org/pdf/2508.16975v1)**
...
- **简介: 该论文属于阿尔茨海默病预测任务，旨在通过联合学习ADAS-Cog全局分数及其13个子分数来提升模型可解释性。作者提出多任务学习框架，融合MRI与临床数据，发现部分子分数（如Q1、Q4、Q8）对全局分数影响显著，但存在预测不稳定问题，归因于临床特征主导。**
...
- **简介: 论文提出FVP框架，通过4D视觉预训练提升机器人3D视觉表示能力，解决2D预训练忽视3D世界的问题。在12个真实操作任务中显著提高成功率，适用于多种编码器和数据集。**
...
- **简介: 论文提出基于扩散模型的3D手物交互重建方法，通过几何引导优化物体形状与手部姿态，解决单目图像下物体几何重建质量低、交互不真实的问题。引入多模态几何约束确保物理合理性与鲁棒性。**
...
- **简介: 该论文针对医学图像分割中罕见异常样本不足的问题，提出DiffAug框架。通过文本引导的扩散模型生成异常图像，并用潜空间分割网络自动验证质量，提升小病灶检测准确率，实现高效、高质量的数据增强。**
...
- **简介: 该论文提出MTNet，用于RGBT跟踪任务，解决多模态特征交互受限和模板不变问题。通过模态感知网络和Transformer融合机制增强特征表示，并设计三叉预测头与动态更新策略提升定位精度与鲁棒性。**
...
- **链接: [http://arxiv.org/pdf/2508.17117v1](http://arxiv.org/pdf/2508.17117v1)**
...
- **链接: [http://arxiv.org/pdf/2508.17849v1](http://arxiv.org/pdf/2508.17849v1)**
...
- **链接: [http://arxiv.org/pdf/2508.18238v1](http://arxiv.org/pdf/2508.18238v1)**
...
- **简介: 该论文提出TemCoCo框架，解决视频多模态融合中帧间不一致的问题。通过视觉-语义协同与时间一致性机制，提升融合视频的视觉保真度、语义准确性和时序稳定性。**
...
>
---
#### [new 068] SEER-VAR: Semantic Egocentric Environment Reasoner for Vehicle Augmented Reality
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 073] CE-RS-SBCIT A Novel Channel Enhanced Hybrid CNN Transformer with Residual, Spatial, and Boundary-Aware Learning for Brain Tumor MRI Analysis
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对脑肿瘤MRI图像分析任务，解决传统CNN和Transformer在计算成本高、对微小对比变化敏感及纹理不一致等问题。提出CE-RS-SBCIT框架，融合残差、空间学习与边界感知机制，提升分类精度，达到98.30%准确率。**

- **链接: [http://arxiv.org/pdf/2508.17128v1](http://arxiv.org/pdf/2508.17128v1)**
...
>
---
#### [new 074] CMFDNet: Cross-Mamba and Feature Discovery Network for Polyp Segmentation
- **分类: cs.CV**

- **简介: 该论文提出CMFDNet用于结肠息肉分割任务，解决息肉形状多样、边界模糊及小尺寸息肉易漏检的问题。通过跨扫描解码器、多分支结构和特征发现模块提升分割精度。**

- **链接: [http://arxiv.org/pdf/2508.17729v1](http://arxiv.org/pdf/2508.17729v1)**
...
>
---
#### [new 094] Language-Guided Temporal Token Pruning for Efficient VideoLLM Processing
- **分类: cs.CV**

- **简介: 论文提出Language-Guided Temporal Token Pruning（LGTTP），用于高效处理长视频的视觉语言模型。针对注意力机制计算复杂度高的问题，LGTTP根据查询中的时间线索自适应剪枝视频帧，保留关键时序信息，显著降低计算量并保持高精度。**

- **链接: [http://arxiv.org/pdf/2508.17686v1](http://arxiv.org/pdf/2508.17686v1)**
...
>
---
#### [new 108] MedRepBench: A Comprehensive Benchmark for Medical Report Interpretation
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 111] A Lightweight Convolution and Vision Transformer integrated model with Multi-scale Self-attention Mechanism
- **分类: cs.CV; cs.NE**

- **简介: 论文提出SAEViT模型，解决ViT计算复杂度高、局部特征弱的问题。通过稀疏注意力模块、通道交互前馈网络和嵌入深度可分离卷积的金字塔结构，在保持高性能的同时显著降低计算量，适用于高效视觉任务。**

- **链接: [http://arxiv.org/pdf/2508.16884v1](http://arxiv.org/pdf/2508.16884v1)**
...
>
---
#### [new 117] M3DMap: Object-aware Multimodal 3D Mapping for Dynamic Environments
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 122] AIM 2025 Low-light RAW Video Denoising Challenge: Dataset, Methods and Results
- **分类: cs.CV; eess.IV**

- **简介: 论文聚焦低光RAW视频去噪任务，解决在曝光时间受限下如何利用时域冗余并适应传感器噪声的问题。作者构建了756段多传感器视频数据集，组织挑战赛评估方法性能，提交方案均需保留拜耳格式并输出第10帧。**

- **链接: [http://arxiv.org/pdf/2508.16830v1](http://arxiv.org/pdf/2508.16830v1)**
...
>
---
#### [new 130] Align 3D Representation and Text Embedding for 3D Content Personalization
- **分类: cs.CV**

- **简介: 该论文属于3D内容个性化任务，旨在解决现有方法依赖昂贵重训练的问题。作者提出Invert3D框架，通过建立3D表示与文本嵌入的对齐，实现基于自然语言的高效3D内容个性化。**

- **链接: [http://arxiv.org/pdf/2508.16932v1](http://arxiv.org/pdf/2508.16932v1)**
...
>
---
#### [new 133] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 134] Edge-Enhanced Vision Transformer Framework for Accurate AI-Generated Image Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于AI生成图像检测任务，旨在解决传统方法忽视细微结构不一致且计算资源消耗大的问题。作者提出结合微调ViT与新型边缘处理模块的框架，通过分析边缘差异图方差提升检测精度，实现高效准确的图像真伪识别。**

- **链接: [http://arxiv.org/pdf/2508.17877v1](http://arxiv.org/pdf/2508.17877v1)**
...
>
---
#### [new 135] Delta-SVD: Efficient Compression for Personalized Text-to-Image Models
- **分类: cs.CV**

- **简介: 论文提出Delta-SVD方法，用于压缩个性化文生图模型的微调参数。针对DreamBooth导致的存储开销问题，利用低秩结构实现高效压缩，保持生成质量，支持即插即用和在线重建。**

- **链接: [http://arxiv.org/pdf/2508.16863v1](http://arxiv.org/pdf/2508.16863v1)**
...
>
---
#### [new 149] No Pixel Left Behind: A Detail-Preserving Architecture for Robust High-Resolution AI-Generated Image Detection
- **分类: cs.CV**

- **简介: 论文提出HiDA-Net框架，解决高分辨率AI生成图像检测中因下采样导致细节丢失的问题。通过局部特征聚合与全局信息融合，保留全部像素信息，并引入细粒度定位和压缩噪声分离模块，提升检测鲁棒性。**

- **链接: [http://arxiv.org/pdf/2508.17346v1](http://arxiv.org/pdf/2508.17346v1)**
...
>
---
#### [new 183] WebMMU: A Benchmark for Multimodal Multilingual Website Understanding and Code Generation
- **分类: cs.CV**

- **简介: 论文提出WebMMU基准，评估模型在多模态、多语言网站理解与代码生成任务中的能力。针对现有模型在复杂推理、元素定位和功能保持上的不足，该工作统一了视觉问答、代码编辑和设计转代码三类任务，推动未来网页智能代理的发展。**

- **链接: [http://arxiv.org/pdf/2508.16763v1](http://arxiv.org/pdf/2508.16763v1)**
...
>
---
#### [new 190] Towards Optimal Convolutional Transfer Learning Architectures for Breast Lesion Classification and ACL Tear Detection
- **分类: cs.CV; cs.LG; 68T45**

- **简介: 该论文研究医学图像分类任务，旨在解决小样本下模型性能受限问题。通过对比不同CNN架构与预训练方式，发现ResNet50结合部分解冻和1D卷积分类器效果最优，AUC达0.9969（ACL撕裂）和0.9641（乳腺病变）。未证实RadImageNet优于ImageNet预训练。**

- **链接: [http://arxiv.org/pdf/2508.17567v1](http://arxiv.org/pdf/2508.17567v1)**
...
>
---
#### [new 195] Transformer-Based Neural Network for Transient Detection without Image Subtraction
- **分类: cs.CV; astro-ph.IM**

- **简介: 论文提出基于Transformer的神经网络，用于天文图像中瞬变源的准确分类，解决传统CNN方法依赖复杂差分成像的问题。该模型直接分析搜索图与模板图，无需图像减法，提升效率与精度，在DES数据集上达97.4%准确率。**

- **链接: [http://arxiv.org/pdf/2508.16844v1](http://arxiv.org/pdf/2508.16844v1)**
...
>
---
#### [new 196] Deep Learning Architectures for Medical Image Denoising: A Comparative Study of CNN-DAE, CADTra, and DCMIEDNet
- **分类: eess.IV; cs.CV**

- **简介: 论文研究医学图像去噪任务，针对MRI脑图像受噪声影响的问题，比较CNN-DAE、CADTra和DCMIEDNet三种深度学习模型。结果表明：DCMIEDNet在低噪声下表现最优，CADTra在高噪声下更鲁棒，均显著优于传统方法。**

- **链接: [http://arxiv.org/pdf/2508.17223v1](http://arxiv.org/pdf/2508.17223v1)**
...
>
---
#### [new 201] Predicting brain tumour enhancement from non-contrast MR imaging with artificial intelligence
- **分类: eess.IV; cs.CV; q-bio.QM**

- **简介: 该论文属于医学影像AI任务，旨在用非增强MRI预测脑肿瘤增强情况，解决钆对比剂使用受限问题。作者构建深度学习模型，在多中心数据上训练并验证，性能优于放射科医生，可作为筛查工具减少钆依赖。**

- **链接: [http://arxiv.org/pdf/2508.16650v1](http://arxiv.org/pdf/2508.16650v1)**
...
>
---
#### [new 202] SEAM: Semantically Equivalent Across Modalities Benchmark for Vision-Language Models
- **分类: cs.AI; cs.CV**

- **简介: 论文提出SEAM基准，用于评估视觉语言模型在跨模态下的一致性推理能力。解决现有评估中因任务差异和信息不对称导致的混淆问题。通过四类语义等价的图文对，发现视觉模态普遍落后于语言模态，且跨模态一致性低，主要受文本分词和视觉幻觉影响。**

- **链接: [http://arxiv.org/pdf/2508.18179v1](http://arxiv.org/pdf/2508.18179v1)**

> **作者:** Zhenwei Tang; Difan Jiao; Blair Yang; Ashton Anderson
>
> **备注:** COLM 2025
>
> **摘要:** Evaluating whether vision-language models (VLMs) reason consistently across representations is challenging because modality comparisons are typically confounded by task differences and asymmetric information. We introduce SEAM, a benchmark that pairs semantically equivalent inputs across four domains that have existing standardized textual and visual notations. By employing distinct notation systems across modalities, in contrast to OCR-based image-text pairing, SEAM provides a rigorous comparative assessment of the textual-symbolic and visual-spatial reasoning capabilities of VLMs. Across 21 contemporary models, we observe systematic modality imbalance: vision frequently lags language in overall performance, despite the problems containing semantically equivalent information, and cross-modal agreement is relatively low. Our error analysis reveals two main drivers: textual perception failures from tokenization in domain notation and visual perception failures that induce hallucinations. We also show that our results are largely robust to visual transformations. SEAM establishes a controlled, semantically equivalent setting for measuring and improving modality-agnostic reasoning.
>
---
#### [new 203] Towards Trustworthy Breast Tumor Segmentation in Ultrasound using Monte Carlo Dropout and Deep Ensembles for Epistemic Uncertainty Estimation
- **分类: eess.IV; cs.CV**

- **简介: 论文针对乳腺超声图像肿瘤分割任务，解决模型在数据不一致和域偏移下的不确定性问题。通过改进Residual Encoder U-Net，结合蒙特卡洛Dropout与深度集成方法量化认知不确定性，提升分割可靠性与临床可信度。**

- **链接: [http://arxiv.org/pdf/2508.17768v1](http://arxiv.org/pdf/2508.17768v1)**
...
>
---
#### [new 204] Negative Shanshui: Real-time Interactive Ink Painting Synthesis
...
>
---
#### [new 207] Generating Synthetic Contrast-Enhanced Chest CT Images from Non-Contrast Scans Using Slice-Consistent Brownian Bridge Diffusion Network
- **分类: eess.IV; cs.CV; physics.med-ph**

- **简介: 该论文属于医学图像生成任务，旨在通过非对比CT扫描生成高质量对比增强CT血管造影图像，以减少对比剂使用风险。作者提出基于切片一致布朗桥扩散模型的新方法，在保持3D解剖一致性的同时高效生成图像，并通过预处理和数据集构建验证其有效性。**

- **链接: [http://arxiv.org/pdf/2508.16897v1](http://arxiv.org/pdf/2508.16897v1)**
...
>
---
#### [new 208] Optimizing Grasping in Legged Robots: A Deep Learning Approach to Loco-Manipulation
...
>
---
#### [new 211] Neural Proteomics Fields for Super-resolved Spatial Proteomics Prediction
- **分类: q-bio.QM; cs.AI; cs.CV**

- **简介: 论文提出神经蛋白场（NPF）模型，解决测序空间蛋白质组学（seq-SP）的低分辨率问题。通过连续空间建模和组织特异性特征提取，实现超分辨率重建，性能优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.17389v1](http://arxiv.org/pdf/2508.17389v1)**
...
>
---
#### [new 218] VGGSounder: Audio-Visual Evaluations for Foundation Models
...
>
---
#### [new 219] TuningIQA: Fine-Grained Blind Image Quality Assessment for Livestreaming Camera Tuning
- **分类: eess.IV; cs.CV; cs.MM**

- **简介: 论文提出TuningIQA，解决直播摄像头调参中粗粒度图像质量评估不足的问题。构建FGLive-10K数据集，设计细粒度BIQA模型，实现更精准的摄像头参数优化。**

- **链接: [http://arxiv.org/pdf/2508.17965v1](http://arxiv.org/pdf/2508.17965v1)**
...
>
---
#### [new 220] UM3: Unsupervised Map to Map Matching
- **分类: cs.LG; cs.CV**

- **简介: 论文提出UM3框架，解决无监督地图匹配任务中缺乏标注数据、特征稀疏和可扩展性差的问题。通过伪坐标增强特征判别力、自适应融合特征与几何相似性，并设计分块后处理机制，实现高效高精度的地图对齐。**

- **链接: [http://arxiv.org/pdf/2508.16874v1](http://arxiv.org/pdf/2508.16874v1)**
...
>
---
#### [new 221] MDD: A Dataset for Text-and-Music Conditioned Duet Dance Generation
- **分类: cs.GR; cs.CV; cs.MM; cs.SD**
...
>
---
#### [new 222] Egocentric Instruction-oriented Affordance Prediction via Large Multimodal Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 223] Scene-Agnostic Traversability Labeling and Estimation via a Multimodal Self-supervised Framework
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 226] Hyperbolic Multimodal Representation Learning for Biological Taxonomies
...
>
---
#### [new 227] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
- **分类: cs.GR; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于稀疏视图表面重建任务，旨在解决输入视角极稀疏时几何恢复不准确的问题。提出MeshSplat框架，利用高斯点渲染（2DGS）作为桥梁，结合像素对齐的2DGS预测和新损失函数，提升重建精度与泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.17811v1](http://arxiv.org/pdf/2508.17811v1)**
...
>
---
#### [new 230] Citizen Centered Climate Intelligence: Operationalizing Open Tree Data for Urban Cooling and Eco-Routing in Indian Cities
...
>
---
#### [new 233] Multimodal Medical Endoscopic Image Analysis via Progressive Disentangle-aware Contrastive Learning
- **分类: eess.IV; cs.CV**

- **简介: 论文提出一种多模态医学内镜图像分析方法，用于喉部肿瘤分割。针对单模态成像信息不足的问题，设计Align-Disentangle-Fusion框架，通过多尺度对齐和渐进解耦学习，有效融合WLI与NBI图像特征，提升分割精度。**

- **链接: [http://arxiv.org/pdf/2508.16882v1](http://arxiv.org/pdf/2508.16882v1)**
...
>
---
#### [new 234] MaRVL-QA: A Benchmark for Mathematical Reasoning over Visual Landscapes
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文提出MaRVL-QA基准，用于评估多模态大模型在数学和空间推理方面的能力。针对模型在图像中进行深度数学推理的不足，设计了拓扑计数和变换识别两个任务，通过严谨函数生成数据，揭示当前模型仍依赖浅层启发式方法。**

- **链接: [http://arxiv.org/pdf/2508.17180v1](http://arxiv.org/pdf/2508.17180v1)**
...
>
---
#### [new 235] GWM: Towards Scalable Gaussian World Models for Robotic Manipulation
...
>
---
#### [new 236] Analysis of Transferability Estimation Metrics for Surgical Phase Recognition
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 论文针对外科手术阶段识别任务，解决如何在无目标数据标签情况下评估预训练模型迁移性能的问题。通过基准测试三种迁移性估计指标，发现LogME表现最优，提出模型选择建议与未来方向。**

- **链接: [http://arxiv.org/pdf/2508.16730v1](http://arxiv.org/pdf/2508.16730v1)**
...
>
---
#### [replaced 002] Hadamard Attention Recurrent Transformer: A Strong Baseline for Stereo Matching Transformer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.01023v5](http://arxiv.org/pdf/2501.01023v5)**
...
>
---
#### [replaced 003] FaceCrafter: Identity-Conditional Diffusion with Disentangled Control over Facial Pose, Expression, and Emotion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.15313v2](http://arxiv.org/pdf/2505.15313v2)**
...
>
---
#### [replaced 004] Adversarial Generation and Collaborative Evolution of Safety-Critical Scenarios for Autonomous Vehicles
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.14527v2](http://arxiv.org/pdf/2508.14527v2)**
...
>
---
#### [replaced 005] HOSt3R: Keypoint-free Hand-Object 3D Reconstruction from RGB images
...
>
---
#### [replaced 006] OmniCache: A Trajectory-Oriented Global Perspective on Training-Free Cache Reuse for Diffusion Transformer Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.16212v2](http://arxiv.org/pdf/2508.16212v2)**
...
>
---
#### [replaced 007] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.17288v4](http://arxiv.org/pdf/2502.17288v4)**
...
>
---
#### [replaced 008] BEHAVIOR Robot Suite: Streamlining Real-World Whole-Body Manipulation for Everyday Household Activities
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**
...
>
---
#### [replaced 009] FastTracker: Real-Time and Accurate Visual Tracking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.14370v2](http://arxiv.org/pdf/2508.14370v2)**
...
>
---
#### [replaced 010] E-4DGS: High-Fidelity Dynamic Reconstruction from the Multi-view Event Cameras
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09912v2](http://arxiv.org/pdf/2508.09912v2)**
...
>
---
#### [replaced 011] MedLoRD: A Medical Low-Resource Diffusion Model for High-Resolution 3D CT Image Synthesis
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.13211v2](http://arxiv.org/pdf/2503.13211v2)**
...
>
---
#### [replaced 015] Vivid-VR: Distilling Concepts from Text-to-Video Diffusion Transformer for Photorealistic Video Restoration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.14483v2](http://arxiv.org/pdf/2508.14483v2)**
...
>
---
#### [replaced 016] Intern-S1: A Scientific Multimodal Foundation Model
- **分类: cs.LG; cs.CL; cs.CV**
...
>
---
#### [replaced 017] Supervising 3D Talking Head Avatars with Analysis-by-Audio-Synthesis
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.13386v3](http://arxiv.org/pdf/2504.13386v3)**
...
>
---
#### [replaced 018] EPFL-Smart-Kitchen-30: Densely annotated cooking dataset with 3D kinematics to challenge video and language models
- **分类: cs.CV; cs.AI; cs.LG; q-bio.OT**

- **链接: [http://arxiv.org/pdf/2506.01608v2](http://arxiv.org/pdf/2506.01608v2)**
...
>
---
#### [replaced 019] ExtraGS: Geometric-Aware Trajectory Extrapolation with Uncertainty-Guided Generative Priors
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15529v2](http://arxiv.org/pdf/2508.15529v2)**
...
>
---
#### [replaced 024] Towards Identifiable Unsupervised Domain Translation: A Diversified Distribution Matching Approach
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2401.09671v3](http://arxiv.org/pdf/2401.09671v3)**

> **作者:** Sagar Shrestha; Xiao Fu
>
> **摘要:** Unsupervised domain translation (UDT) aims to find functions that convert samples from one domain (e.g., sketches) to another domain (e.g., photos) without changing the high-level semantic meaning (also referred to as ``content''). The translation functions are often sought by probability distribution matching of the transformed source domain and target domain. CycleGAN stands as arguably the most representative approach among this line of work. However, it was noticed in the literature that CycleGAN and variants could fail to identify the desired translation functions and produce content-misaligned translations. This limitation arises due to the presence of multiple translation functions -- referred to as ``measure-preserving automorphism" (MPA) -- in the solution space of the learning criteria. Despite awareness of such identifiability issues, solutions have remained elusive. This study delves into the core identifiability inquiry and introduces an MPA elimination theory. Our analysis shows that MPA is unlikely to exist, if multiple pairs of diverse cross-domain conditional distributions are matched by the learning function. Our theory leads to a UDT learner using distribution matching over auxiliary variable-induced subsets of the domains -- other than over the entire data domains as in the classical approaches. The proposed framework is the first to rigorously establish translation identifiability under reasonable UDT settings, to our best knowledge. Experiments corroborate with our theoretical claims.
>
---
#### [replaced 025] T*: Re-thinking Temporal Search for Long-Form Video Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.02259v3](http://arxiv.org/pdf/2504.02259v3)**
...
>
---
#### [replaced 029] WetCat: Enabling Automated Skill Assessment in Wet-Lab Cataract Surgery Videos
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08896v2](http://arxiv.org/pdf/2506.08896v2)**

> **作者:** Negin Ghamsarian; Raphael Sznitman; Klaus Schoeffmann; Jens Kowal
>
> **备注:** 7 pages, 6 figures, Accepted at ACMMM25
>
...
>
---
#### [replaced 032] CNeuroMod-THINGS, a densely-sampled fMRI dataset for visual neuroscience
- **分类: q-bio.NC; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09024v3](http://arxiv.org/pdf/2507.09024v3)**
...
>
---
#### [replaced 033] High-Throughput Low-Cost Segmentation of Brightfield Microscopy Live Cell Images
- **分类: q-bio.QM; cs.AI; cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2508.14106v2](http://arxiv.org/pdf/2508.14106v2)**
...
>
---
#### [replaced 045] Boosting Temporal Sentence Grounding via Causal Inference
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.04958v2](http://arxiv.org/pdf/2507.04958v2)**
...
>
---
#### [replaced 046] Leveraging the Power of MLLMs for Gloss-Free Sign Language Translation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 047] Integrating Clinical Knowledge Graphs and Gradient-Based Neural Systems for Enhanced Melanoma Diagnosis via the 7-Point Checklist
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2407.16822v3](http://arxiv.org/pdf/2407.16822v3)**
...
>
---
#### [replaced 053] Beyond Blur: A Fluid Perspective on Generative Diffusion Models
- **分类: cs.GR; cs.CV; cs.LG; I.2.6; I.4.10; I.4.8**

- **链接: [http://arxiv.org/pdf/2506.16827v2](http://arxiv.org/pdf/2506.16827v2)**

> **作者:** Grzegorz Gruszczynski; Jakub Meixner; Michal Jan Wlodarczyk; Przemyslaw Musialski
>
> **备注:** ICCV 2025 main conference, 8 pages paper, 20 pages appendix, 24 figures, supplementary pseudocode in appendix, https://iccv.thecvf.com/virtual/2025/poster/1176
>
...
>
---
#### [replaced 058] Hessian-Based Lightweight Neural Network HessNet for State-of-the-Art Brain Vessel Segmentation on a Minimal Training Dataset
- **分类: eess.IV; cs.CV; I.4.6; I.5.4; J.3**

- **链接: [http://arxiv.org/pdf/2508.15660v2](http://arxiv.org/pdf/2508.15660v2)**
...
>
---
#### [replaced 061] Using Visual Anomaly Detection for Task Execution Monitoring
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 062] FractMorph: A Fractional Fourier-Based Multi-Domain Transformer for Deformable Image Registration
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12445v2](http://arxiv.org/pdf/2508.12445v2)**
...
>
---
#### [replaced 063] Field Matching: an Electrostatic Paradigm to Generate and Transfer Data
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.02367v3](http://arxiv.org/pdf/2502.02367v3)**
...
>
---
#### [replaced 066] Addressing Text Embedding Leakage in Diffusion-based Image Editing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.04715v4](http://arxiv.org/pdf/2412.04715v4)**
...
>
---
#### [replaced 067] BRISC: Annotated Dataset for Brain Tumor Segmentation and Classification with Swin-HAFNet
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.14318v3](http://arxiv.org/pdf/2506.14318v3)**
...
>
---
#### [replaced 068] Continual Learning for Generative AI: From LLMs to MLLMs and Beyond
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13045v4](http://arxiv.org/pdf/2506.13045v4)**
...
>
---
#### [replaced 070] HeteroTune: Efficient Federated Learning for Large Heterogeneous Models
...
>
---
#### [replaced 071] Exponentially Weighted Instance-Aware Repeat Factor Sampling for Long-Tailed Object Detection Model Training in Unmanned Aerial Vehicles Surveillance Scenarios
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.21893v2](http://arxiv.org/pdf/2503.21893v2)**
...
>
---
#### [replaced 075] Unsupervised Urban Tree Biodiversity Mapping from Street-Level Imagery Using Spatially-Aware Visual Clustering
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.13814v3](http://arxiv.org/pdf/2508.13814v3)**
...
>
---
#### [replaced 079] TPA: Temporal Prompt Alignment for Fetal Congenital Heart Defect Classification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15298v2](http://arxiv.org/pdf/2508.15298v2)**
...
>
---
#### [replaced 080] PainFormer: a Vision Foundation Model for Automatic Pain Assessment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.01571v3](http://arxiv.org/pdf/2505.01571v3)**
...
>
---
#### [replaced 083] Bridging Clear and Adverse Driving Conditions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.13592v2](http://arxiv.org/pdf/2508.13592v2)**
...
>
---
#### [replaced 084] CleverDistiller: Simple and Spatially Consistent Cross-modal Distillation
...
>
---
#### [replaced 085] A Multimodal Handover Failure Detection Dataset and Baselines
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 086] Beyond Label Semantics: Language-Guided Action Anatomy for Few-shot Action Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.16287v2](http://arxiv.org/pdf/2507.16287v2)**
...
>
---
#### [replaced 087] FetchBot: Learning Generalizable Object Fetching in Cluttered Scenes via Zero-Shot Sim2Real
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 088] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15376v2](http://arxiv.org/pdf/2508.15376v2)**
...
>
---
#### [replaced 090] Physical Autoregressive Model for Robotic Manipulation without Action Pretraining
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09822v2](http://arxiv.org/pdf/2508.09822v2)**
...
>
---
#### [replaced 091] MoCHA-former: Moiré-Conditioned Hybrid Adaptive Transformer for Video Demoiréing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.14423v3](http://arxiv.org/pdf/2508.14423v3)**

> **作者:** Jeahun Sung; Changhyun Roh; Chanho Eom; Jihyong Oh
>
> **备注:** Please visit our project page at https://cmlab-korea.github.io/MoCHA-former/
>
...
>
---
#### [replaced 092] Side Effects of Erasing Concepts from Diffusion Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15124v2](http://arxiv.org/pdf/2508.15124v2)**
...
>
---
#### [replaced 095] Orchid: Image Latent Diffusion for Joint Appearance and Geometry Generation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.13087v2](http://arxiv.org/pdf/2501.13087v2)**
...
>
---
#### [replaced 099] CurveFlow: Curvature-Guided Flow Matching for Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15093v2](http://arxiv.org/pdf/2508.15093v2)**
...
>
---
#### [replaced 100] SVGCraft: Beyond Single Object Text-to-SVG Synthesis with Comprehensive Canvas Layout
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2404.00412v2](http://arxiv.org/pdf/2404.00412v2)**

> **作者:** Ayan Banerjee; Nityanand Mathur; Josep Lladós; Umapada Pal; Anjan Dutta
>
...
>
---
#### [replaced 101] Baltimore Atlas: FreqWeaver Adapter for Semi-supervised Ultra-high Spatial Resolution Land Cover Classification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.15565v2](http://arxiv.org/pdf/2506.15565v2)**
...
>
---
#### [replaced 104] Pixel Perfect MegaMed: A Megapixel-Scale Vision-Language Foundation Model for Generating High Resolution Medical Images
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.12698v2](http://arxiv.org/pdf/2507.12698v2)**
...
>
---
#### [replaced 105] Odo: Depth-Guided Diffusion for Identity-Preserving Body Reshaping
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.13065v2](http://arxiv.org/pdf/2508.13065v2)**
...
>
---
#### [replaced 106] Controllable Hybrid Captioner for Improved Long-form Video Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.17047v2](http://arxiv.org/pdf/2507.17047v2)**
...
>
---
#### [replaced 107] A Survey on the Safety and Security Threats of Computer-Using Agents: JARVIS or Ultron?
...
>
---
#### [replaced 108] BoxFusion: Reconstruction-Free Open-Vocabulary 3D Object Detection via Real-Time Multi-View Box Fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.15610v3](http://arxiv.org/pdf/2506.15610v3)**
...
>
---
#### [replaced 111] FlowDubber: Movie Dubbing with LLM-based Semantic-aware Learning and Flow Matching based Voice Enhancing
...
>
---
#### [replaced 112] A Sobel-Gradient MLP Baseline for Handwritten Character Recognition
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.11902v2](http://arxiv.org/pdf/2508.11902v2)**
...
>
---
#### [replaced 113] Architectural Co-Design for Zero-Shot Anomaly Detection: Decoupling Representation and Dynamically Fusing Features in CLIP
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.07819v3](http://arxiv.org/pdf/2508.07819v3)**
...
>
---
#### [replaced 116] Advancing Marine Research: UWSAM Framework and UIIS10K Dataset for Precise Underwater Instance Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.15581v3](http://arxiv.org/pdf/2505.15581v3)**

> **作者:** Hua Li; Shijie Lian; Zhiyuan Li; Runmin Cong; Chongyi Li; Laurence T. Yang; Weidong Zhang; Sam Kwong
>
...
>
---
#### [replaced 117] Diffusing the Blind Spot: Uterine MRI Synthesis with Diffusion Models
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07903v2](http://arxiv.org/pdf/2508.07903v2)**
...
>
---
#### [replaced 118] Seeing the Trees for the Forest: Rethinking Weakly-Supervised Medical Visual Grounding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.15123v2](http://arxiv.org/pdf/2505.15123v2)**
...
>
---
#### [replaced 119] Image Augmentation Agent for Weakly Supervised Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.20439v4](http://arxiv.org/pdf/2412.20439v4)**
