...
- **简介: 该论文属于图像风格迁移任务，旨在解决现有模型在处理复杂风格和高分辨率输入时效率低的问题。提出PyramidStyler框架，结合金字塔位置编码和强化学习，提升效果与速度。**
...
- **链接: [http://arxiv.org/pdf/2510.02001v1](http://arxiv.org/pdf/2510.02001v1)**
...
- **简介: 该论文属于行人搜索任务，解决检测与重识别特征冲突问题。提出DiffPS框架，利用扩散模型先验知识提升定位与特征融合效果。**
...
- **链接: [http://arxiv.org/pdf/2510.02287v1](http://arxiv.org/pdf/2510.02287v1)**
...
- **简介: 该论文属于医学图像处理任务，旨在减少CT检查中对比剂的使用。通过统一的多任务扩散框架，同时生成合成CT图像和分割血管结构，提升诊断准确性。**
...
- **简介: 该论文属于图像运动去模糊任务，解决扩散模型推理慢和保真度低的问题，提出FideDiff模型实现高效高保真去模糊。**
...
- **简介: 该论文属于生物特征识别任务，旨在解决小规模农场猪只识别问题。通过耳静脉模式和机器学习实现非侵入式、低成本的混合品种猪识别。**
...
- **简介: 该论文属于3D语义分割任务，解决2D到3D特征迁移中的噪声与几何一致性矛盾。提出GeoPurify框架，利用几何先验提升数据效率。**
...
- **简介: 该论文属于语义分割任务，解决无标签客户端数据的联邦学习问题。提出FRIEREN框架，结合视觉语言模型提升分割性能。**
...
- **链接: [http://arxiv.org/pdf/2510.01686v1](http://arxiv.org/pdf/2510.01686v1)**
...
- **简介: 该论文属于动物行为分析任务，解决传统观察方法效率低的问题。通过无人机与机器学习结合，实现多物种行为的自动化监测与分析。**
...
- **简介: 该论文属于长视频生成任务，解决长期依赖和误差累积问题。提出MemoryPack和Direct Forcing方法，提升视频时序一致性和可靠性。**
...
- **链接: [http://arxiv.org/pdf/2510.01546v1](http://arxiv.org/pdf/2510.01546v1)**
...
- **简介: 该论文属于图像生成任务，解决低分辨率图像生成质量不佳的问题。通过提出NoiseShift方法，调整噪声水平以适应不同分辨率，提升生成效果。**
...
- **简介: 该论文属于历史城市扩张分析任务，旨在解决1970年前法国缺乏全国性数字城市边界数据的问题。通过开发深度学习管道，从历史地图中提取城市区域，生成首个公开的国家尺度城市边界数据集。**
...
- **简介: 该论文属于面部表情分析任务，旨在解决FACS覆盖有限和人工标注成本高的问题。提出DFE框架，通过RVQ-VAE学习可解释的面部表达编码，实现更精确的面部行为捕捉。**
...
- **简介: 该论文属于多模态视觉任务，旨在解决MLLM在视觉任务中依赖间接表示的问题。提出PaDT框架，直接生成文本和视觉输出，提升检测、分割等任务性能。**
...
- **简介: 该论文属于场景实例顺序预测任务，解决传统方法依赖昂贵输入和高计算成本的问题。提出InstaFormer网络，仅需RGB图像即可在一次前向传播中输出所有实例的遮挡和深度顺序。**
...
- **链接: [http://arxiv.org/pdf/2510.01559v1](http://arxiv.org/pdf/2510.01559v1)**
...
- **简介: 该论文属于多模态推理任务，旨在提升视觉语言模型的推理能力。通过构建包含25万张图像的合成数据集，提供思考过程与答案，用于训练和评估模型。**
...
>
---
#### [new 068] VLA-R1: Enhancing Reasoning in Vision-Language-Action Models
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 075] Data Selection for Fine-tuning Vision Language Models via Cross Modal Alignment Trajectories
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于数据高效学习任务，解决LVLMs训练数据冗余问题。通过分析跨模态注意力轨迹，提出XMAS方法有效减少数据量并提升训练效率。**

- **链接: [http://arxiv.org/pdf/2510.01454v1](http://arxiv.org/pdf/2510.01454v1)**
...
>
---
#### [new 079] On the Role of Domain Experts in Creating Effective Tutoring Systems
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于教育AI任务，旨在解决如何有效利用领域专家知识构建辅导系统的问题。通过XAI技术和专家设定的课程设计，提升 tutoring 系统的适应性和效率。**

- **链接: [http://arxiv.org/pdf/2510.01432v1](http://arxiv.org/pdf/2510.01432v1)**
...
>
---
#### [new 083] DisCo-Layout: Disentangling and Coordinating Semantic and Physical Refinement in a Multi-Agent Framework for 3D Indoor Layout Synthesis
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于3D室内布局生成任务，解决传统方法泛化能力差和优化不足的问题。提出DisCo-Layout框架，分离并协调语义与物理优化，提升布局质量。**
...
>
---
#### [new 086] ZK-WAGON: Imperceptible Watermark for Image Generation Models using ZK-SNARKs
- **分类: cs.CR; cs.AI; cs.CV**

- **简介: 该论文属于图像生成模型水印任务，解决合成媒体的版权与真实性问题。通过ZK-SNARKs技术实现不可见水印嵌入，保护模型隐私并验证图像来源。**

- **链接: [http://arxiv.org/pdf/2510.01967v1](http://arxiv.org/pdf/2510.01967v1)**

> **作者:** Aadarsh Anantha Ramakrishnan; Shubham Agarwal; Selvanayagam S; Kunwar Singh
>
> **备注:** Accepted at AI-ML Systems 2025, Bangalore, India, https://www.aimlsystems.org/2025/
>
...
>
---
#### [new 087] Ultra-Efficient Decoding for End-to-End Neural Compression and Reconstruction
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于图像压缩与重建任务，旨在解决神经压缩中解码器计算复杂度高的问题。通过引入低秩表示和矢量量化，实现高效解码。**

- **链接: [http://arxiv.org/pdf/2510.01407v1](http://arxiv.org/pdf/2510.01407v1)**

> **作者:** Ethan G. Rogers; Cheng Wang
>
> **备注:** 5 pages, 4 figures, NeurIPS 2025 Workshop MLForSys
>
> **摘要:** Image compression and reconstruction are crucial for various digital applications. While contemporary neural compression methods achieve impressive compression rates, the adoption of such technology has been largely hindered by the complexity and large computational costs of the convolution-based decoders during data reconstruction. To address the decoder bottleneck in neural compression, we develop a new compression-reconstruction framework based on incorporating low-rank representation in an autoencoder with vector quantization. We demonstrated that performing a series of computationally efficient low-rank operations on the learned latent representation of images can efficiently reconstruct the data with high quality. Our approach dramatically reduces the computational overhead in the decoding phase of neural compression/reconstruction, essentially eliminating the decoder compute bottleneck while maintaining high fidelity of image outputs.
>
---
#### [new 088] Equilibrium Matching: Generative Modeling with Implicit Energy-Based Models
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出Equilibrium Matching（EqM），属于生成模型任务，旨在解决传统生成模型的非平衡动态问题。通过学习隐式能量景观的平衡梯度，实现优化采样，提升生成效果并扩展应用范围。**

- **链接: [http://arxiv.org/pdf/2510.02300v1](http://arxiv.org/pdf/2510.02300v1)**
...
>
---
#### [new 089] GFSR-Net: Guided Focus via Segment-Wise Relevance Network for Interpretable Deep Learning in Medical Imaging
- **分类: eess.IV; cs.CV; physics.data-an**

- **简介: 该论文属于医学图像分析任务，旨在解决深度学习模型缺乏可解释性的问题。通过引入GFSR-Net，利用少量人工标注引导模型关注关键区域，提升诊断可靠性与透明度。**

- **链接: [http://arxiv.org/pdf/2510.01919v1](http://arxiv.org/pdf/2510.01919v1)**
...
>
---
#### [new 090] ActiveUMI: Robotic Manipulation with Active Perception from Robot-Free Human Demonstrations
- **分类: cs.RO; cs.CV**

- **简介: 该论文提出ActiveUMI系统，用于将人类操作员的视觉注意力与机器人操作结合，解决复杂双臂操作任务的迁移问题。通过便携式VR设备和传感器控制器，实现高质量数据收集与学习。**
...
>
---
#### [new 091] Measurement-Guided Consistency Model Sampling for Inverse Problems
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于图像重建任务，解决扩散模型在逆问题中采样慢的问题，提出一种基于测量一致性的高效采样方法，提升重建质量与效率。**

- **链接: [http://arxiv.org/pdf/2510.02208v1](http://arxiv.org/pdf/2510.02208v1)**
...
>
---
#### [new 099] Development and Evaluation of an AI-Driven Telemedicine System for Prenatal Healthcare
- **分类: cs.HC; cs.CV; eess.IV**

- **简介: 该论文属于医疗AI任务，旨在解决低资源地区产前超声检查不足的问题。通过开发AI辅助系统，帮助助产士获取关键胎儿图像，并由专家远程分析，提升产前护理可及性。**

- **链接: [http://arxiv.org/pdf/2510.01194v1](http://arxiv.org/pdf/2510.01194v1)**
...
>
---
#### [new 101] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于3D人体动画任务，解决松散衣物物理动态建模难题。通过结合材料点法模拟与3D高斯点云渲染，提升动画真实性和鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.01619v1](http://arxiv.org/pdf/2510.01619v1)**

> **作者:** Changmin Lee; Jihyun Lee; Tae-Kyun Kim
>
> **备注:** Accepted to NeurIPS 2025
>
> **摘要:** While there has been significant progress in the field of 3D avatar creation from visual observations, modeling physically plausible dynamics of humans with loose garments remains a challenging problem. Although a few existing works address this problem by leveraging physical simulation, they suffer from limited accuracy or robustness to novel animation inputs. In this work, we present MPMAvatar, a framework for creating 3D human avatars from multi-view videos that supports highly realistic, robust animation, as well as photorealistic rendering from free viewpoints. For accurate and robust dynamics modeling, our key idea is to use a Material Point Method-based simulator, which we carefully tailor to model garments with complex deformations and contact with the underlying body by incorporating an anisotropic constitutive model and a novel collision handling algorithm. We combine this dynamics modeling scheme with our canonical avatar that can be rendered using 3D Gaussian Splatting with quasi-shadowing, enabling high-fidelity rendering for physically realistic animations. In our experiments, we demonstrate that MPMAvatar significantly outperforms the existing state-of-the-art physics-based avatar in terms of (1) dynamics modeling accuracy, (2) rendering accuracy, and (3) robustness and efficiency. Additionally, we present a novel application in which our avatar generalizes to unseen interactions in a zero-shot manner-which was not achievable with previous learning-based methods due to their limited simulation generalizability. Our project page is at: https://KAISTChangmin.github.io/MPMAvatar/
>
---
#### [new 102] Uncovering Semantic Selectivity of Latent Groups in Higher Visual Cortex with Mutual Information-Guided Diffusion
- **分类: q-bio.NC; cs.CV; cs.LG**

- **简介: 该论文属于神经科学与人工智能交叉任务，旨在揭示高级视觉皮层中神经群体的语义选择性。通过MIG-Vis方法，利用扩散模型可视化潜在子空间的语义特征，解决如何分布和组织视觉信息的问题。**

- **链接: [http://arxiv.org/pdf/2510.02182v1](http://arxiv.org/pdf/2510.02182v1)**
...
>
---
#### [new 103] Test-Time Anchoring for Discrete Diffusion Posterior Sampling
- **分类: cs.LG; cs.CV; stat.ML**

- **简介: 该论文属于图像恢复任务，解决如何在不重新训练模型的情况下，利用预训练离散扩散模型进行后验采样。工作包括提出APS方法，提升采样效果。**

- **链接: [http://arxiv.org/pdf/2510.02291v1](http://arxiv.org/pdf/2510.02291v1)**
...
> **备注:** Preprint
>
> **摘要:** We study the problem of posterior sampling using pretrained discrete diffusion foundation models, aiming to recover images from noisy measurements without retraining task-specific models. While diffusion models have achieved remarkable success in generative modeling, most advances rely on continuous Gaussian diffusion. In contrast, discrete diffusion offers a unified framework for jointly modeling categorical data such as text and images. Beyond unification, discrete diffusion provides faster inference, finer control, and principled training-free Bayesian inference, making it particularly well-suited for posterior sampling. However, existing approaches to discrete diffusion posterior sampling face severe challenges: derivative-free guidance yields sparse signals, continuous relaxations limit applicability, and split Gibbs samplers suffer from the curse of dimensionality. To overcome these limitations, we introduce Anchored Posterior Sampling (APS) for masked diffusion foundation models, built on two key innovations -- quantized expectation for gradient-like guidance in discrete embedding space, and anchored remasking for adaptive decoding. Our approach achieves state-of-the-art performance among discrete diffusion samplers across linear and nonlinear inverse problems on the standard benchmarks. We further demonstrate the benefits of our approach in training-free stylization and text-guided editing.
>
---
#### [new 104] The Reasoning Boundary Paradox: How Reinforcement Learning Constrains Language Models
...
>
---
#### [new 105] Towards Photonic Band Diagram Generation with Transformer-Latent Diffusion Models
- **分类: physics.optics; cs.CV**

- **简介: 该论文属于光子学任务，旨在解决光子带结构计算效率低的问题。通过结合Transformer和扩散模型，实现高效生成光子带图。**

- **链接: [http://arxiv.org/pdf/2510.01749v1](http://arxiv.org/pdf/2510.01749v1)**

> **作者:** Valentin Delchevalerie; Nicolas Roy; Arnaud Bougaham; Alexandre Mayer; Benoît Frénay; Michaël Lobet
>
> **摘要:** Photonic crystals enable fine control over light propagation at the nanoscale, and thus play a central role in the development of photonic and quantum technologies. Photonic band diagrams (BDs) are a key tool to investigate light propagation into such inhomogeneous structured materials. However, computing BDs requires solving Maxwell's equations across many configurations, making it numerically expensive, especially when embedded in optimization loops for inverse design techniques, for example. To address this challenge, we introduce the first approach for BD generation based on diffusion models, with the capacity to later generalize and scale to arbitrary three dimensional structures. Our method couples a transformer encoder, which extracts contextual embeddings from the input structure, with a latent diffusion model to generate the corresponding BD. In addition, we provide insights into why transformers and diffusion models are well suited to capture the complex interference and scattering phenomena inherent to photonics, paving the way for new surrogate modeling strategies in this domain.
>
---
#### [new 106] JaneEye: A 12-nm 2K-FPS 18.9-$μ$J/Frame Event-based Eye Tracking Accelerator
...
>
> **备注:** Our dataset is available at https://zenodo.org/records/16812932 , our code is available at https://github.com/DIAGNijmegen/beetle , and our benchmark is available at https://beetle.grand-challenge.org/
>
...
>
---
#### [new 109] VENTURA: Adapting Image Diffusion Models for Unified Task Conditioned Navigation
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于视觉导航任务，解决机器人根据自然语言指令安全导航的问题。通过微调图像扩散模型生成路径掩码，实现高效路径规划与任务执行。**
...
>
---
#### [new 110] An Efficient Quality Metric for Video Frame Interpolation Based on Motion-Field Divergence
- **分类: eess.IV; cs.CV; cs.MM**

- **简介: 该论文属于视频帧插值任务，解决现有质量评估指标在时间一致性上的不足。提出PSNR_DIV，通过运动场发散加权提升评估效果，兼具高效与准确。**

- **链接: [http://arxiv.org/pdf/2510.01361v1](http://arxiv.org/pdf/2510.01361v1)**
...
>
---
#### [new 111] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
- **分类: cs.GR; cs.CV; 68U05, 68T45 (Primary) 68T07, 68-04 (Secondary); I.2.10; I.3.3; I.3.5; I.3.7; I.4.5; I.4.6; I.4.8; I.4.10**

- **简介: 该论文属于3D场景重建任务，解决ROIs细节不足与模型过大问题。通过对象引导策略提升局部质量并减少模型规模。**

- **链接: [http://arxiv.org/pdf/2510.01978v1](http://arxiv.org/pdf/2510.01978v1)**

> **作者:** Quoc-Anh Bui; Gilles Rougeron; Géraldine Morin; Simone Gasparini
>
> **备注:** 4 pages, 3 figures, 2 tables
>
> **摘要:** We tackle the challenge of efficiently reconstructing 3D scenes with high detail on objects of interest. Existing 3D Gaussian Splatting (3DGS) methods allocate resources uniformly across the scene, limiting fine detail to Regions Of Interest (ROIs) and leading to inflated model size. We propose ROI-GS, an object-aware framework that enhances local details through object-guided camera selection, targeted Object training, and seamless integration of high-fidelity object of interest reconstructions into the global scene. Our method prioritizes higher resolution details on chosen objects while maintaining real-time performance. Experiments show that ROI-GS significantly improves local quality (up to 2.96 dB PSNR), while reducing overall model size by $\approx 17\%$ of baseline and achieving faster training for a scene with a single object of interest, outperforming existing methods.
>
---
#### [new 112] SpurBreast: A Curated Dataset for Investigating Spurious Correlations in Real-world Breast MRI Classification
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在解决深度学习模型因虚假相关性导致的泛化问题。研究构建了包含虚假特征的SpurBreast数据集，并提供基准数据集进行对比分析。**

- **链接: [http://arxiv.org/pdf/2510.02109v1](http://arxiv.org/pdf/2510.02109v1)**
...
>
---
#### [replaced 005] Enhancing Corpus Callosum Segmentation in Fetal MRI via Pathology-Informed Domain Randomization
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.20475v2](http://arxiv.org/pdf/2508.20475v2)**
...
>
---
#### [replaced 006] Sparkle: Mastering Basic Spatial Capabilities in Vision Language Models Elicits Generalization to Spatial Reasoning
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 007] Segmentor-Guided Counterfactual Fine-Tuning for Locally Coherent and Targeted Image Synthesis
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.24913v2](http://arxiv.org/pdf/2509.24913v2)**
...
>
---
#### [replaced 008] RS-OOD: A Vision-Language Augmented Framework for Out-of-Distribution Detection in Remote Sensing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.02273v2](http://arxiv.org/pdf/2509.02273v2)**
...
>
---
#### [replaced 009] Patch-Level Kernel Alignment for Dense Self-Supervised Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.05606v2](http://arxiv.org/pdf/2509.05606v2)**
...
>
---
#### [replaced 010] Diffusion Model as a Noise-Aware Latent Reward Model for Step-Level Preference Optimization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.01051v5](http://arxiv.org/pdf/2502.01051v5)**
...
>
---
#### [replaced 011] Multi-Domain Brain Vessel Segmentation Through Feature Disentanglement
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.00665v2](http://arxiv.org/pdf/2510.00665v2)**
...
>
---
#### [replaced 012] SoftCFG: Uncertainty-guided Stable Guidance for Visual Autoregressive Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.00996v2](http://arxiv.org/pdf/2510.00996v2)**
...
>
---
#### [replaced 013] GARLIC: GAussian Representation LearnIng for spaCe partitioning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24608v2](http://arxiv.org/pdf/2505.24608v2)**
...
>
---
#### [replaced 015] Causal-Adapter: Taming Text-to-Image Diffusion for Faithful Counterfactual Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.24798v2](http://arxiv.org/pdf/2509.24798v2)**
...
>
---
#### [replaced 018] How Can Time Series Analysis Benefit From Multiple Modalities? A Survey and Outlook
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.11835v4](http://arxiv.org/pdf/2503.11835v4)**
...
>
---
#### [replaced 019] Interior Object Geometry via Fitted Frames
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.14357v3](http://arxiv.org/pdf/2407.14357v3)**
...
>
---
#### [replaced 020] RGS-DR: Deferred Reflections and Residual Shading in 2D Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.18468v4](http://arxiv.org/pdf/2504.18468v4)**
...
>
---
#### [replaced 021] Post-hoc Probabilistic Vision-Language Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.06014v4](http://arxiv.org/pdf/2412.06014v4)**
...
>
---
#### [replaced 022] VITA: Vision-to-Action Flow Matching Policy
...
>
---
#### [replaced 024] DiffCut: Catalyzing Zero-Shot Semantic Segmentation with Diffusion Features and Recursive Normalized Cut
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2406.02842v4](http://arxiv.org/pdf/2406.02842v4)**
...
>
---
#### [replaced 025] There and Back Again: On the relation between Noise and Image Inversions in Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2410.23530v4](http://arxiv.org/pdf/2410.23530v4)**
...
>
---
#### [replaced 026] A Survey on Dynamic Neural Networks: from Computer Vision to Multi-modal Sensor Fusion
- **分类: cs.CV; 68T45; I.4.0; I.2.10**

- **链接: [http://arxiv.org/pdf/2501.07451v2](http://arxiv.org/pdf/2501.07451v2)**

> **作者:** Fabio Montello; Ronja Güldenring; Simone Scardapane; Lazaros Nalpantidis
>
> **备注:** Under review at Image and Vision Computing
>
...
>
---
#### [replaced 027] PlaceIt3D: Language-Guided Object Placement in Real 3D Scenes
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 028] Feature Representation Transferring to Lightweight Models via Perception Coherence
- **分类: stat.ML; cs.AI; cs.CV; cs.LG; math.PR**

- **链接: [http://arxiv.org/pdf/2505.06595v2](http://arxiv.org/pdf/2505.06595v2)**
...
>
---
#### [replaced 029] SCoT: Unifying Consistency Models and Rectified Flows via Straight-Consistent Trajectories
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.16972v4](http://arxiv.org/pdf/2502.16972v4)**
...
>
---
#### [replaced 030] Landcover classification and change detection using remote sensing and machine learning: a case study of Western Fiji
- **分类: cs.CV; cs.AI; stat.AP**

- **链接: [http://arxiv.org/pdf/2509.13388v2](http://arxiv.org/pdf/2509.13388v2)**
...
>
---
#### [replaced 031] Accelerating Targeted Hard-Label Adversarial Attacks in Low-Query Black-Box Settings
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.16313v2](http://arxiv.org/pdf/2505.16313v2)**

> **作者:** Arjhun Swaminathan; Mete Akgün
>
> **备注:** This paper contains 10 pages, 8 figures and 8 tables. For associated supplementary code, see https://github.com/mdppml/TEA
>
...
>
---
#### [replaced 032] EyePCR: A Comprehensive Benchmark for Fine-Grained Perception, Knowledge Comprehension and Clinical Reasoning in Ophthalmic Surgery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.15596v2](http://arxiv.org/pdf/2509.15596v2)**
...
>
---
#### [replaced 035] Development of a Mobile Application for at-Home Analysis of Retinal Fundus Images
- **分类: cs.HC; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16814v2](http://arxiv.org/pdf/2509.16814v2)**
...
>
---
#### [replaced 036] UltraUPConvNet: A UPerNet- and ConvNeXt-Based Multi-Task Network for Ultrasound Tissue Segmentation and Disease Prediction
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.11108v2](http://arxiv.org/pdf/2509.11108v2)**
...
>
---
#### [replaced 037] Audio-Enhanced Vision-Language Modeling with Latent Space Broadening for High Quality Data Expansion
...
>
---
#### [replaced 038] TrimTokenator: Towards Adaptive Visual Token Pruning for Large Multimodal Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.00320v2](http://arxiv.org/pdf/2509.00320v2)**
...
>
---
#### [replaced 039] One-Step Residual Shifting Diffusion for Image Super-Resolution via Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.13358v3](http://arxiv.org/pdf/2503.13358v3)**
...
>
---
#### [replaced 040] Poutine: Vision-Language-Trajectory Pre-Training and Reinforcement Learning Post-Training Enable Robust End-to-End Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 041] VideoGen-of-Thought: Step-by-step generating multi-shot video with minimal manual intervention
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2412.02259v3](http://arxiv.org/pdf/2412.02259v3)**
...
>
> **备注:** Code: https://github.com/DuNGEOnmassster/VideoGen-of-Thought.git; Webpage: https://cheliosoops.github.io/VGoT/
>
...
- **链接: [http://arxiv.org/pdf/2508.01875v2](http://arxiv.org/pdf/2508.01875v2)**
...
>
---
#### [replaced 046] Semantic and Visual Crop-Guided Diffusion Models for Heterogeneous Tissue Synthesis in Histopathology
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17847v2](http://arxiv.org/pdf/2509.17847v2)**
...
>
---
#### [replaced 047] Hierarchical place recognition with omnidirectional images and curriculum learning-based loss functions
...
>
---
#### [replaced 053] Equivariant Splitting: Self-supervised learning from incomplete data
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.00929v2](http://arxiv.org/pdf/2510.00929v2)**
...
>
---
#### [replaced 054] NeoARCADE: Robust Calibration for Distance Estimation to Support Assistive Drones for the Visually Impaired
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 055] CAMILA: Context-Aware Masking for Image Editing with Language Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.19731v2](http://arxiv.org/pdf/2509.19731v2)**
...
>
---
#### [replaced 056] RIFLE: Removal of Image Flicker-Banding via Latent Diffusion Enhancement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.24644v3](http://arxiv.org/pdf/2509.24644v3)**
...
>
---
#### [replaced 059] Momentum-SAM: Sharpness Aware Minimization without Computational Overhead
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2401.12033v3](http://arxiv.org/pdf/2401.12033v3)**

> **作者:** Marlon Becker; Frederick Altrock; Benjamin Risse
>
> **摘要:** The recently proposed optimization algorithm for deep neural networks Sharpness Aware Minimization (SAM) suggests perturbing parameters before gradient calculation by a gradient ascent step to guide the optimization into parameter space regions of flat loss. While significant generalization improvements and thus reduction of overfitting could be demonstrated, the computational costs are doubled due to the additionally needed gradient calculation, making SAM unfeasible in case of limited computationally capacities. Motivated by Nesterov Accelerated Gradient (NAG) we propose Momentum-SAM (MSAM), which perturbs parameters in the direction of the accumulated momentum vector to achieve low sharpness without significant computational overhead or memory demands over SGD or Adam. We evaluate MSAM in detail and reveal insights on separable mechanisms of NAG, SAM and MSAM regarding training optimization and generalization. Code is available at https://github.com/MarlonBecker/MSAM.
>
---
#### [replaced 060] DiCache: Let Diffusion Model Determine Its Own Cache
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.17356v2](http://arxiv.org/pdf/2508.17356v2)**

> **作者:** Jiazi Bu; Pengyang Ling; Yujie Zhou; Yibin Wang; Yuhang Zang; Dahua Lin; Jiaqi Wang
>
> **备注:** Project Page: https://bujiazi.github.io/dicache.github.io/ Code: https://github.com/Bujiazi/DiCache
>
...
>
---
#### [replaced 061] Temporal Overlapping Prediction: A Self-supervised Pre-training Method for LiDAR Moving Object Segmentation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 062] SUPER-Net: Trustworthy Image Segmentation via Uncertainty Propagation in Encoder-Decoder Networks
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2111.05978v4](http://arxiv.org/pdf/2111.05978v4)**

> **作者:** Giuseppina Carannante; Nidhal C. Bouaynaya; Dimah Dera; Hassan M. Fathallah-Shaykh; Ghulam Rasool
>
> **备注:** Accepted in Pattern Recognition. This is the author's accepted manuscript. Licensed under CC BY-NC-ND. The Version of Record is available at https://doi.org/10.1016/j.patcog.2025.112503
>
...
>
---
#### [replaced 065] Does Bigger Mean Better? Comparitive Analysis of CNNs and Biomedical Vision Language Modles in Medical Diagnosis
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.00411v2](http://arxiv.org/pdf/2510.00411v2)**
...
>
---
#### [replaced 066] Normal-Abnormal Guided Generalist Anomaly Detection
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.00495v2](http://arxiv.org/pdf/2510.00495v2)**
...
>
---
#### [replaced 067] NeRAF: 3D Scene Infused Neural Radiance and Acoustic Fields
...
>
---
#### [replaced 068] Towards Methane Detection Onboard Satellites
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.00626v2](http://arxiv.org/pdf/2509.00626v2)**
...
>
---
#### [replaced 069] L4P: Towards Unified Low-Level 4D Vision Perception
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.13078v3](http://arxiv.org/pdf/2502.13078v3)**
...
>
---
#### [replaced 070] Using KL-Divergence to Focus Frequency Information in Low-Light Image Enhancement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.13083v2](http://arxiv.org/pdf/2509.13083v2)**
...
>
---
#### [replaced 071] What Makes a Good Dataset for Knowledge Distillation?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.12817v2](http://arxiv.org/pdf/2411.12817v2)**
...
>
---
#### [replaced 072] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
- **分类: cs.CV; cs.CE**

- **链接: [http://arxiv.org/pdf/2509.25075v2](http://arxiv.org/pdf/2509.25075v2)**
...
>
---
#### [replaced 075] LLaVAShield: Safeguarding Multimodal Multi-Turn Dialogues in Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.25896v2](http://arxiv.org/pdf/2509.25896v2)**
...
>
---
#### [replaced 076] HAMLET: Switch your Vision-Language-Action Model into a History-Aware Policy
- **分类: cs.RO; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.00695v2](http://arxiv.org/pdf/2510.00695v2)**
...
>
---
#### [replaced 077] Autoregressive Adversarial Post-Training for Real-Time Interactive Video Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.09350v2](http://arxiv.org/pdf/2506.09350v2)**
...
>
---
#### [replaced 078] Learning to Weight Parameters for Training Data Attribution
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05647v2](http://arxiv.org/pdf/2506.05647v2)**
