...
- **简介: 论文提出CurDKV方法，通过CUR分解实现基于价值的KV缓存压缩，解决大语言模型推理中内存和延迟问题。该方法以值向量为核心，提升压缩精度与生成速度，优于现有技术。**
...
>
---
#### [new 010] Translate, then Detect: Leveraging Machine Translation for Cross-Lingual Toxicity Classification
- **分类: cs.CL**
...
- **简介: 论文提出利用大语言模型（LLMs）辅助心理语言学规范研究的方法，解决人工评分获取困难的问题。通过验证和优化模型，提高预测准确性，并提供软件框架与实践指导。**
...
- **简介: 该论文属于多模态对齐任务，旨在解决大语言模型与训练数据语言先验冲突的问题。提出Decoupled Proxy Alignment方法，通过引入代理模型和动态损失调整，提升视觉-语言对齐效果。**
...
- **简介: 该论文提出OmniGEC，一个多语言银标准语料库，用于语法错误修正任务。旨在解决多语言GEC数据不足问题，通过三种来源构建数据集，并用大模型微调取得SOTA结果。**
...
- **简介: 该论文提出Delta-KD方法，解决知识蒸馏中学生模型与教师模型表示空间不一致的问题。通过保留教师模型微调过程中的分布偏移，提升学生模型性能，属于大语言模型压缩任务。**
...
- **简介: 论文提出SparseDoctor，一种基于对比学习增强的LoRA-MoE架构的稀疏医疗大语言模型，旨在提升医疗问答效率。通过自动路由和专家记忆队列机制，降低训练成本并提高性能，在多个医学基准测试中优于现有模型。属于医疗领域的大语言模型优化任务。**
...
- **链接: [http://arxiv.org/pdf/2509.15027v1](http://arxiv.org/pdf/2509.15027v1)**
...
- **简介: 论文提出ModernBERT专利预训练模型，解决专利文本处理中通用模型表现不佳的问题。通过优化架构与大量专利语料预训练，提升专利分类任务性能，实现更快推理速度。**
...
- **简介: 论文提出Llama-Mimi，一种统一建模语音语义与声学特征的模型，解决语音生成中语义与声学信息融合问题。采用单一解码器处理交织的语义和声学标记，提升语音一致性与说话人身份保留能力，并引入LLM评估生成质量。**
...
- **简介: 该论文提出Empathy-R1框架，用于长文本心理支持任务，解决现有模型缺乏情感推理与心理支持结构的问题。结合共情链与强化学习，提升回复质量与可解释性，基于中文数据集进行训练与评估。**
...
- **简介: 该论文综述了在线毒性内容检测的研究，总结140篇文献，分析数据集、挑战及机器学习方法，提出改进分类模型和内容管理的建议，旨在提升平台毒性内容的识别与治理能力。**
...
- **链接: [http://arxiv.org/pdf/2509.14545v1](http://arxiv.org/pdf/2509.14545v1)**
...
- **简介: 该论文提出FURINA，一种无需路由器的MoE-LoRA方法，解决现有方法因离散路由器无法合并到主模型的问题。通过自路由机制和专家选择损失，实现动态路由，提升性能并消除推理开销。属于参数高效微调任务。**
...
- **简介: 论文提出利用大语言模型（LLMs）内部层表示检测幻觉的新方法，改进传统探测技术，通过动态组合内部层提升性能，并在多个基准上验证有效性，解决幻觉检测的可靠性与泛化问题。**
...
- **简介: 该论文提出Causal-Counterfactual RAG框架，旨在改进传统RAG在因果推理和反事实分析中的不足。通过引入因果图与反事实推理，提升生成答案的准确性与可解释性，解决静态知识限制与上下文完整性问题。**
...
- **简介: 论文研究了幻灯片检索任务，旨在解决多模态信息检索中的效率与效果问题。通过对比多种方法，如ColPali、BM25融合及视觉语言模型生成字幕等，评估其检索性能、存储和运行效率，为实际应用提供优化方案。**
...
- **简介: 论文研究大语言模型在处理隐性与显性文本信息抽取任务中的表现，通过对比实验分析隐性文本对模型的影响，并利用LoRA微调提升其隐性信息抽取能力。属于自然语言处理中的信息抽取任务，旨在解决隐性关系识别难题。**
...
- **简介: 该论文属于问答系统任务，旨在提升电商客服回答的准确性和相关性。提出结合知识图谱与检索增强生成的方法，融合结构化子图与文档信息，实现更准确、连贯的回答，提升事实准确率和用户满意度。**
...
>
---
#### [new 065] Shutdown Resistance in Large Language Models
- **分类: cs.CL; cs.AI**
...
- **简介: 该论文研究生成式AI在在线旅行规划中的影响，通过随机实验比较积极、中性和无语气设计对用户参与度和购买行为的影响。旨在探讨AI语气如何影响用户体验与消费决策，为设计更具说服力的AI界面提供依据。**
...
>
---
#### [new 069] TableDART: Dynamic Adaptive Multi-Modal Routing for Table Understanding
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 论文提出TableDART，解决表格理解中多模态信息融合问题。通过动态路由机制选择文本、图像或融合路径，避免冗余与冲突，无需全量微调多模态模型，提升性能。属于表格理解任务。**

- **链接: [http://arxiv.org/pdf/2509.14671v1](http://arxiv.org/pdf/2509.14671v1)**
...
>
---
#### [new 077] An Evaluation-Centric Paradigm for Scientific Visualization Agents
- **分类: cs.HC; cs.CL; cs.GR**

- **简介: 该论文提出一个以评估为中心的范式，用于科学可视化智能体。旨在解决缺乏全面评估基准的问题，通过分析评估类型与挑战，并提供概念验证示例，推动建立促进智能体自我优化的评估基准。**

- **链接: [http://arxiv.org/pdf/2509.15160v1](http://arxiv.org/pdf/2509.15160v1)**
...
>
---
#### [new 078] TDRM: Smooth Reward Models with Temporal Difference for LLM RL and Inference
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出TDRM方法，通过时间差分正则化提升奖励模型的时序一致性，解决LLM强化学习中奖励模型不稳定问题。实验表明其提升数据效率和策略质量，适用于多种大语言模型。属于强化学习与语言模型对齐任务。**

- **链接: [http://arxiv.org/pdf/2509.15110v1](http://arxiv.org/pdf/2509.15110v1)**
...
>
---
#### [new 079] FCPE: A Fast Context-based Pitch Estimation Model
- **分类: cs.SD; cs.CL**
...
>
---
#### [new 080] MARIC: Multi-Agent Reasoning for Image Classification
...
>
---
#### [new 081] Mind the Gap: Data Rewriting for Stable Off-Policy Supervised Fine-Tuning
- **分类: cs.LG; cs.CL**

- **简介: 论文提出一种数据重写框架，解决大语言模型监督微调中的策略差距问题。通过保留正确样本、重写错误样本，主动缩小策略差距，提升训练稳定性与效果，优于现有方法。属于离线策略微调任务。**

- **链接: [http://arxiv.org/pdf/2509.15157v1](http://arxiv.org/pdf/2509.15157v1)**
...
>
---
#### [new 082] Spatial Audio Motion Understanding and Reasoning
...
>
---
#### [new 086] Masked Diffusion Models as Energy Minimization
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文将掩码扩散模型（MDMs）解释为离散最优传输中的能量最小化问题，证明三种能量形式在MDMs下等价，并提出基于Beta分布的调度方法，提升采样效率。属于生成模型理论分析与优化任务。**

- **链接: [http://arxiv.org/pdf/2509.13866v1](http://arxiv.org/pdf/2509.13866v1)**
...
>
---
#### [new 092] From Capabilities to Performance: Evaluating Key Functional Properties of LLM Architectures in Penetration Testing
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文评估LLM在渗透测试中的性能，研究不同架构的功能特性对任务效果的影响。通过增强五大能力，提升模块化代理在复杂任务中的表现，解决其可靠性与效率问题。**

- **链接: [http://arxiv.org/pdf/2509.14289v1](http://arxiv.org/pdf/2509.14289v1)**
...
>
---
#### [new 093] SynParaSpeech: Automated Synthesis of Paralinguistic Datasets for Speech Generation and Understanding
- **分类: eess.AS; cs.CL; I.2.7**

- **简介: 该论文提出SynParaSpeech框架，自动化生成大规模副语言数据集，解决现有数据集资源不足、标注不准确等问题，推动语音生成与理解研究。**

- **链接: [http://arxiv.org/pdf/2509.14946v1](http://arxiv.org/pdf/2509.14946v1)**
...
>
---
#### [new 094] Understanding the Thinking Process of Reasoning Models: A Perspective from Schoenfeld's Episode Theory
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文将Schoenfeld的Episode理论应用于大语言模型的推理过程分析，构建了一个细粒度标注数据集，用于研究模型推理结构，旨在提升对其认知机制的理解与可控性。**

- **链接: [http://arxiv.org/pdf/2509.14662v1](http://arxiv.org/pdf/2509.14662v1)**
...
>
---
#### [new 095] ToolSample: Dual Dynamic Sampling Methods with Curriculum Learning for RL-based Tool Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出DSCL框架，针对基于强化学习的工具学习任务，解决因简单样本过多导致的训练效率低下问题。通过奖励动态采样和任务动态课程学习，提升模型性能，实验证明其在BFCLv3上表现优异。**

- **链接: [http://arxiv.org/pdf/2509.14718v1](http://arxiv.org/pdf/2509.14718v1)**
...
>
---
#### [new 096] DeKeyNLU: Enhancing Natural Language to SQL Generation through Task Decomposition and Keyword Extraction
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言到SQL生成（NL2SQL）任务，旨在解决LLM在任务分解与关键词提取中的不准确问题。提出DeKeyNLU数据集和DeKeySQL流水线，通过精细标注与模块化设计提升SQL生成精度。**

- **链接: [http://arxiv.org/pdf/2509.14507v1](http://arxiv.org/pdf/2509.14507v1)**
...
>
---
#### [new 097] LLM Jailbreak Detection for (Almost) Free!
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文提出一种几乎无额外计算成本的LLM越狱检测方法FJD，通过分析输出分布差异和温度缩放提升检测效果，属于安全检测任务，旨在解决越狱攻击问题。**

- **链接: [http://arxiv.org/pdf/2509.14558v1](http://arxiv.org/pdf/2509.14558v1)**
...
>
---
#### [new 098] Frame Sampling Strategies Matter: A Benchmark for small vision language models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 099] FedMentor: Domain-Aware Differential Privacy for Heterogeneous Federated LLMs in Mental Health
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 论文提出FedMentor框架，在联邦学习中结合LoRA与领域感知差分隐私，解决心理健康等敏感领域大模型微调中的隐私与性能平衡问题，提升安全性和模型效果。**

- **链接: [http://arxiv.org/pdf/2509.14275v1](http://arxiv.org/pdf/2509.14275v1)**
...
#### [replaced 001] DeDisCo at the DISRPT 2025 Shared Task: A System for Discourse Relation Classification
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.11498v3](http://arxiv.org/pdf/2509.11498v3)**
...
>
---
#### [replaced 002] QA-LIGN: Aligning LLMs through Constitutionally Decomposed QA
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.08123v3](http://arxiv.org/pdf/2506.08123v3)**
...
>
---
#### [replaced 003] Evaluation and Facilitation of Online Discussions in the LLM Era: A Survey
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.01513v3](http://arxiv.org/pdf/2503.01513v3)**
...
>
---
#### [replaced 004] Middo: Model-Informed Dynamic Data Optimization for Enhanced LLM Fine-Tuning via Closed-Loop Learning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.21589v2](http://arxiv.org/pdf/2508.21589v2)**
...
>
---
#### [replaced 005] ALIGNS: Unlocking nomological networks in psychological measurement through a large language model
- **分类: cs.CL; cs.AI; cs.LG; stat.ME; I.2.6; J.4; I.5.1; H.3.3; H.2.8**

- **链接: [http://arxiv.org/pdf/2509.09723v2](http://arxiv.org/pdf/2509.09723v2)**
...
>
---
#### [replaced 006] mdok of KInIT: Robustly Fine-tuned LLM for Binary and Multiclass AI-Generated Text Detection
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.01702v2](http://arxiv.org/pdf/2506.01702v2)**

> **作者:** Dominik Macko
>
> **备注:** 1st rank in both subtasks of the Voight-Kampff Generative AI Detection 2025 shared task (PAN@CLEF 2025)
>
> **摘要:** The large language models (LLMs) are able to generate high-quality texts in multiple languages. Such texts are often not recognizable by humans as generated, and therefore present a potential of LLMs for misuse (e.g., plagiarism, spams, disinformation spreading). An automated detection is able to assist humans to indicate the machine-generated texts; however, its robustness to out-of-distribution data is still challenging. This notebook describes our mdok approach in robust detection, based on fine-tuning smaller LLMs for text classification. It is applied to both subtasks of Voight-Kampff Generative AI Detection 2025, providing remarkable performance (1st rank) in both, the binary detection as well as the multiclass classification of various cases of human-AI collaboration.
>
---
#### [replaced 007] MovieCORE: COgnitive REasoning in Movies
...
>
---
#### [replaced 008] Enhancing Logical Reasoning in Language Models via Symbolically-Guided Monte Carlo Process Supervision
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.20415v2](http://arxiv.org/pdf/2505.20415v2)**
...
>
---
#### [replaced 009] ImpRAG: Retrieval-Augmented Generation with Implicit Queries
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02279v2](http://arxiv.org/pdf/2506.02279v2)**
...
>
---
#### [replaced 010] Mind the Inclusivity Gap: Multilingual Gender-Neutral Translation Evaluation with mGeNTE
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2501.09409v3](http://arxiv.org/pdf/2501.09409v3)**
...
>
---
#### [replaced 013] Assistant-Guided Mitigation of Teacher Preference Bias in LLM-as-a-Judge
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.19176v3](http://arxiv.org/pdf/2505.19176v3)**

> **作者:** Zhuo Liu; Moxin Li; Xun Deng; Qifan Wang; Fuli Feng
>
> **备注:** Under review
>
> **摘要:** LLM-as-a-Judge employs large language models (LLMs), such as GPT-4, to evaluate the quality of LLM-generated responses, gaining popularity for its cost-effectiveness and strong alignment with human evaluations. However, training proxy judge models using evaluation data generated by powerful teacher models introduces a critical yet previously overlooked issue: teacher preference bias, where the proxy judge model learns a biased preference for responses from the teacher model. To tackle this problem, we propose a novel setting that incorporates an additional assistant model, which is not biased toward the teacher model's responses, to complement the training data. Building on this setup, we introduce AGDe-Judge, a three-stage framework designed to debias from both the labels and feedbacks in the training data. Extensive experiments demonstrate that AGDe-Judge effectively reduces teacher preference bias while maintaining strong performance across six evaluation benchmarks. Code is available at https://github.com/Liuz233/AGDe-Judge.
>
---
#### [replaced 014] Select to Know: An Internal-External Knowledge Self-Selection Framework for Domain-Specific Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.15213v2](http://arxiv.org/pdf/2508.15213v2)**
...
>
---
#### [replaced 017] Dense Video Understanding with Gated Residual Tokenization
...
>
---
#### [replaced 018] A Survey of Reinforcement Learning for Large Reasoning Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.08827v2](http://arxiv.org/pdf/2509.08827v2)**
...
>
> **备注:** Fixed typos; added missing and recent citations (114 -> 117 pages)
>
...
>
---
#### [replaced 019] Unpacking Ambiguity: The Interaction of Polysemous Discourse Markers and Non-DM Signals
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.16748v2](http://arxiv.org/pdf/2507.16748v2)**
...
>
---
#### [replaced 020] Mechanistic Understanding and Mitigation of Language Confusion in English-Centric Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16538v2](http://arxiv.org/pdf/2505.16538v2)**
...
>
---
#### [replaced 021] Extracting memorized pieces of (copyrighted) books from open-weight language models
...
>
---
#### [replaced 022] Exploring Data and Parameter Efficient Strategies for Arabic Dialect Identifications
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.13775v2](http://arxiv.org/pdf/2509.13775v2)**
...
>
---
#### [replaced 027] SMART: Simulated Students Aligned with Item Response Theory for Question Difficulty Prediction
- **分类: cs.CL; cs.CY; cs.LG**
...
>
> **备注:** 7 pages, 3 figures, accepted by CIKM 2025
>
...
>
---
#### [replaced 032] Audited Reasoning Refinement: Fine-Tuning Language Models via LLM-Guided Step-Wise Evaluation and Correction
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.12476v2](http://arxiv.org/pdf/2509.12476v2)**

> **作者:** Sumanta Bhattacharyya; Sara Riazi; Pedram Rooshenas
>
...
>
---
#### [replaced 033] Diverse, not Short: A Length-Controlled Data Selection Strategy for Improving Response Diversity of Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16245v3](http://arxiv.org/pdf/2505.16245v3)**
...
>
---
#### [replaced 037] Noise Supervised Contrastive Learning and Feature-Perturbed for Anomalous Sound Detection
- **分类: cs.SD; cs.CL**
...
>
---
#### [replaced 038] Exact Coset Sampling for Quantum Lattice Algorithms
- **分类: quant-ph; cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2509.12341v2](http://arxiv.org/pdf/2509.12341v2)**
...
>
---
#### [replaced 039] Unsupervised Concept Vector Extraction for Bias Control in LLMs
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 046] "What's Up, Doc?": Analyzing How Users Seek Health Information in Large-Scale Conversational AI Datasets
- **分类: cs.CL; cs.AI; cs.CY**

- **链接: [http://arxiv.org/pdf/2506.21532v2](http://arxiv.org/pdf/2506.21532v2)**
...
>
---
#### [replaced 047] Unlocking Legal Knowledge: A Multilingual Dataset for Judicial Summarization in Switzerland
- **分类: cs.CL; cs.AI; cs.LG; 68T50; I.2; I.7**

- **链接: [http://arxiv.org/pdf/2410.13456v3](http://arxiv.org/pdf/2410.13456v3)**
...
- **链接: [http://arxiv.org/pdf/2407.20271v5](http://arxiv.org/pdf/2407.20271v5)**
...
>
---
#### [replaced 050] MedVAL: Toward Expert-Level Medical Text Validation with Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.03152v4](http://arxiv.org/pdf/2507.03152v4)**
...
>
---
#### [replaced 051] Pluralistic Alignment for Healthcare: A Role-Driven Framework
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.10685v2](http://arxiv.org/pdf/2509.10685v2)**
...
>
---
#### [replaced 052] DSPC: Dual-Stage Progressive Compression Framework for Efficient Long-Context Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.13723v2](http://arxiv.org/pdf/2509.13723v2)**
...
>
---
#### [replaced 053] METAL: A Multi-Agent Framework for Chart Generation with Test-Time Scaling
