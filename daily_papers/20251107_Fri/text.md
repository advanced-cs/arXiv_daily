...
>
---
#### [new 011] RAGalyst: Automated Human-Aligned Agentic Evaluation for Domain-Specific RAG
- **分类: cs.CL; cs.AI**

- **简介: 论文提出RAGalyst，一种自动化、人对齐的智能体评估框架，解决领域特异性RAG系统评估缺乏可靠标准的问题。通过生成高质量合成QA数据并优化LLM评判指标，实现与人工标注高度相关，揭示不同场景下的性能权衡。**

- **链接: [http://arxiv.org/pdf/2511.04502v1](http://arxiv.org/pdf/2511.04502v1)**

> **作者:** Joshua Gao; Quoc Huy Pham; Subin Varghese; Silwal Saurav; Vedhus Hoskere
>
> **摘要:** Retrieval-Augmented Generation (RAG) is a critical technique for grounding Large Language Models (LLMs) in factual evidence, yet evaluating RAG systems in specialized, safety-critical domains remains a significant challenge. Existing evaluation frameworks often rely on heuristic-based metrics that fail to capture domain-specific nuances and other works utilize LLM-as-a-Judge approaches that lack validated alignment with human judgment. This paper introduces RAGalyst, an automated, human-aligned agentic framework designed for the rigorous evaluation of domain-specific RAG systems. RAGalyst features an agentic pipeline that generates high-quality, synthetic question-answering (QA) datasets from source documents, incorporating an agentic filtering step to ensure data fidelity. The framework refines two key LLM-as-a-Judge metrics-Answer Correctness and Answerability-using prompt optimization to achieve a strong correlation with human annotations. Applying this framework to evaluate various RAG components across three distinct domains (military operations, cybersecurity, and bridge engineering), we find that performance is highly context-dependent. No single embedding model, LLM, or hyperparameter configuration proves universally optimal. Additionally, we provide an analysis on the most common low Answer Correctness reasons in RAG. These findings highlight the necessity of a systematic evaluation framework like RAGalyst, which empowers practitioners to uncover domain-specific trade-offs and make informed design choices for building reliable and effective RAG systems. RAGalyst is available on our Github.
>
---
#### [new 012] RIDE: Difficulty Evolving Perturbation with Item Response Theory for Mathematical Reasoning
- **分类: cs.CL**

- **简介: 论文提出RIDE框架，利用项目反应理论（IRT）生成难度可控的数学问题扰动，评估LLM真实推理能力，解决现有扰动方法生成劣质问题与难度评估不足的问题，显著降低先进模型性能，验证评估有效性。**

- **链接: [http://arxiv.org/pdf/2511.04120v1](http://arxiv.org/pdf/2511.04120v1)**
...
>
---
#### [new 013] Improving the Performance of Radiology Report De-identification with Large-Scale Training and Benchmarking Against Cloud Vendor Methods
- **分类: cs.CL**

- **简介: 该论文致力于放射科报告的隐私保护任务，通过大规模多模态数据微调Transformer模型，提升PHI识别精度，并超越商业云服务。新增AGE类别，验证合成PHI稳定性，建立新基准。**

- **链接: [http://arxiv.org/pdf/2511.04079v1](http://arxiv.org/pdf/2511.04079v1)**
...
>
---
#### [new 014] Logit-Entropy Adaptive Stopping Heuristic for Efficient Chain-of-Thought Reasoning
- **分类: cs.CL**

- **简介: 该论文提出LEASH，一种无训练的自适应停止启发式方法，用于优化Chain-of-Thought推理。通过监测熵斜率与logit边际变化，在保持合理准确率下，减少30%-35%生成token与27%延迟。**

- **链接: [http://arxiv.org/pdf/2511.04654v1](http://arxiv.org/pdf/2511.04654v1)**
...
>
---
#### [new 015] CantoASR: Prosody-Aware ASR-LALM Collaboration for Low-Resource Cantonese
- **分类: cs.CL; cs.SD**
...
>
---
#### [new 016] PLLuM: A Family of Polish Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 论文提出PLLuM，首个大规模开源波兰语大语言模型家族，解决英语主导下波兰语AI支持不足问题，构建了140B词语料、专用指令与偏好数据集，并设计负责任AI框架，提升语言文化适配性与安全性。**

- **链接: [http://arxiv.org/pdf/2511.03823v1](http://arxiv.org/pdf/2511.03823v1)**
...
>
> **摘要:** Large Language Models (LLMs) play a central role in modern artificial intelligence, yet their development has been primarily focused on English, resulting in limited support for other languages. We present PLLuM (Polish Large Language Model), the largest open-source family of foundation models tailored specifically for the Polish language. Developed by a consortium of major Polish research institutions, PLLuM addresses the need for high-quality, transparent, and culturally relevant language models beyond the English-centric commercial landscape. We describe the development process, including the construction of a new 140-billion-token Polish text corpus for pre-training, a 77k custom instructions dataset, and a 100k preference optimization dataset. A key component is a Responsible AI framework that incorporates strict data governance and a hybrid module for output correction and safety filtering. We detail the models' architecture, training procedures, and alignment techniques for both base and instruction-tuned variants, and demonstrate their utility in a downstream task within public administration. By releasing these models publicly, PLLuM aims to foster open research and strengthen sovereign AI technologies in Poland.
>
---
#### [new 017] If I Could Turn Back Time: Temporal Reframing as a Historical Reasoning Task for LLMs
- **分类: cs.CL**

- **简介: 该论文研究大语言模型（LLMs）的时序推理能力，任务是模拟1940年背景回答挪威语历史 trivia 问题。通过多语言提示与LLM-as-judge评估，发现英文提示效果更优，大模型表现更好，测试了DeepSeek-R1、Llama3.1等主流模型。**

- **链接: [http://arxiv.org/pdf/2511.04432v1](http://arxiv.org/pdf/2511.04432v1)**

> **作者:** Lars Bungum; Charles Yijia Huang; Abeer Kashar
>
> **备注:** 8 pages, 1 figure, 3 tables, submitted to aconference
>
> **摘要:** In this study, we experiment with the ability of LLMs to do temporal reasoning. Using a Norwegian book from 1940 containing trivia questions, we prompt the LLMs to answer the questions as if it were 1940. We also pose the questions in both English and Norwegian. Correct answers are often presented as sentences, and grading is done by means of LLM-as-judge, with sampled checks by a native speaker. Prompting in English consistently gave better results than in Norwegian, an unexpected result. In contrast, using larger LLMs improved results. We tested the DeepSeek-R1, Gemma3, Qwen3, and Llama3.1 model families, and also the largest available LLM especially crafted for Norwegian.
>
---
#### [new 018] OUNLP at TSAR 2025 Shared Task: Multi-Round Text Simplifier via Code Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文面向可读性控制的文本简化任务，发现源与目标CEFR等级差影响简化效果，提出两种多轮简化方法（MRS-Rule与MRS-Joint），基于GPT-4o生成，提升简化质量，系统在TSAR 2025中排名第7。**

- **链接: [http://arxiv.org/pdf/2511.04495v1](http://arxiv.org/pdf/2511.04495v1)**
...
>
---
#### [new 028] BAPPA: Benchmarking Agents, Plans, and Pipelines for Automated Text-to-SQL Generation
- **分类: cs.CL; cs.AI; cs.DB; cs.MA**

- **简介: 该论文面向文本到SQL生成任务，针对大模型在复杂数据库模式下生成SQL效果差的问题，提出并 benchmark 三种多智能体流水线，发现规划-编码管道显著提升小模型性能，最高提升4个百分点。**

- **链接: [http://arxiv.org/pdf/2511.04153v1](http://arxiv.org/pdf/2511.04153v1)**

> **作者:** Fahim Ahmed; Md Mubtasim Ahasan; Jahir Sadik Monon; Muntasir Wahed; M Ashraful Amin; A K M Mahbubur Rahman; Amin Ahsan Ali
>
> **摘要:** Text-to-SQL systems provide a natural language interface that can enable even laymen to access information stored in databases. However, existing Large Language Models (LLM) struggle with SQL generation from natural instructions due to large schema sizes and complex reasoning. Prior work often focuses on complex, somewhat impractical pipelines using flagship models, while smaller, efficient models remain overlooked. In this work, we explore three multi-agent LLM pipelines, with systematic performance benchmarking across a range of small to large open-source models: (1) Multi-agent discussion pipeline, where agents iteratively critique and refine SQL queries, and a judge synthesizes the final answer; (2) Planner-Coder pipeline, where a thinking model planner generates stepwise SQL generation plans and a coder synthesizes queries; and (3) Coder-Aggregator pipeline, where multiple coders independently generate SQL queries, and a reasoning agent selects the best query. Experiments on the Bird-Bench Mini-Dev set reveal that Multi-Agent discussion can improve small model performance, with up to 10.6% increase in Execution Accuracy for Qwen2.5-7b-Instruct seen after three rounds of discussion. Among the pipelines, the LLM Reasoner-Coder pipeline yields the best results, with DeepSeek-R1-32B and QwQ-32B planners boosting Gemma 3 27B IT accuracy from 52.4% to the highest score of 56.4%. Codes are available at https://github.com/treeDweller98/bappa-sql.
>
---
#### [new 029] Computational Turing Test Reveals Systematic Differences Between Human and AI Language
- **分类: cs.CL; cs.MA; cs.SI**

- **简介: 该论文提出一种计算图灵测试框架，用于系统评估大语言模型生成文本与人类语言的差异，解决LLM模拟人类行为缺乏可靠验证工具的问题。通过多维度指标对比九种模型，发现其在情感表达上仍显著偏离人类，且优化拟真度会牺牲语义保真度。**

- **链接: [http://arxiv.org/pdf/2511.04195v1](http://arxiv.org/pdf/2511.04195v1)**
...
>
---
#### [new 030] Divide, Cache, Conquer: Dichotomic Prompting for Efficient Multi-Label LLM-Based Classification
- **分类: cs.CL**

- **简介: 该论文提出一种分治式提示方法，将多标签分类拆解为一系列二元决策，结合缓存优化提升LLM推理效率。通过LLM蒸馏标注数据，微调小模型，在情感分析等任务上实现高效高精度分类。**

- **链接: [http://arxiv.org/pdf/2511.03830v1](http://arxiv.org/pdf/2511.03830v1)**
...
>
---
#### [new 031] Trustworthy LLM-Mediated Communication: Evaluating Information Fidelity in LLM as a Communicator (LAAC) Framework in Multiple Application Domains
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出LAAC框架，将LLM作为可信通信中介，解决AI生成内容导致的信息失真问题。通过三维度评估（意图捕捉、可复现性、响应完整性），验证其在多场景下的信息保真度，揭示部署前需解决的信任缺口。**

- **链接: [http://arxiv.org/pdf/2511.04184v1](http://arxiv.org/pdf/2511.04184v1)**
...
>
---
#### [new 037] RUST-BENCH: Benchmarking LLM Reasoning on Unstructured Text within Structured Tables
- **分类: cs.CL; cs.AI; cs.DB; cs.IR; cs.LG**

- **简介: 论文提出RUST-BENCH基准，评估LLM在真实复杂表格（含非结构化文本）上的多跳推理能力，解决现有基准过于简化的问题，揭示当前模型在异构表结构与长文本推理中的短板。**

- **链接: [http://arxiv.org/pdf/2511.04491v1](http://arxiv.org/pdf/2511.04491v1)**

> **作者:** Nikhil Abhyankar; Purvi Chaurasia; Sanchit Kabra; Ananya Srivastava; Vivek Gupta; Chandan K. Reddy
>
> **摘要:** Existing tabular reasoning benchmarks mostly test models on small, uniform tables, underrepresenting the complexity of real-world data and giving an incomplete view of Large Language Models' (LLMs) reasoning abilities. Real tables are long, heterogeneous, and domain-specific, mixing structured fields with free text and requiring multi-hop reasoning across thousands of tokens. To address this gap, we introduce RUST-BENCH, a benchmark of 7966 questions from 2031 real-world tables spanning two domains: i) RB-Science (NSF grant records) and ii) RB-Sports (NBA statistics). Unlike prior work, RUST-BENCH evaluates LLMs jointly across scale, heterogeneity, domain specificity, and reasoning complexity. Experiments with open-source and proprietary models show that LLMs struggle with heterogeneous schemas and complex multi-hop inference, revealing persistent weaknesses in current architectures and prompting strategies. RUST-BENCH establishes a challenging new testbed for advancing tabular reasoning research.
>
---
#### [new 038] GRDD+: An Extended Greek Dialectal Dataset with Cross-Architecture Fine-tuning Evaluation
- **分类: cs.CL**

- **简介: 论文构建了目前规模最大、方言最丰富的希腊语方言数据集GRDD+（637万词，10种方言），并首次在多种LLM架构上进行微调实验，评估高质量方言数据对大模型性能的影响。**

- **链接: [http://arxiv.org/pdf/2511.03772v1](http://arxiv.org/pdf/2511.03772v1)**
...
>
---
#### [new 047] Towards Scalable Meta-Learning of near-optimal Interpretable Models via Synthetic Model Generations
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文面向可解释模型的元学习任务，解决传统决策树训练成本高的问题，提出通过合成近优决策树生成预训练数据，结合MetaTree架构，实现高效、可扩展的元学习，性能媲美真实数据训练。**

- **链接: [http://arxiv.org/pdf/2511.04000v1](http://arxiv.org/pdf/2511.04000v1)**

> **作者:** Kyaw Hpone Myint; Zhe Wu; Alexandre G. R. Day; Giri Iyengar
>
> **备注:** 9 pages, 3 figures, Neurips 2025 GenAI in Finance Workshop
>
> **摘要:** Decision trees are widely used in high-stakes fields like finance and healthcare due to their interpretability. This work introduces an efficient, scalable method for generating synthetic pre-training data to enable meta-learning of decision trees. Our approach samples near-optimal decision trees synthetically, creating large-scale, realistic datasets. Using the MetaTree transformer architecture, we demonstrate that this method achieves performance comparable to pre-training on real-world data or with computationally expensive optimal decision trees. This strategy significantly reduces computational costs, enhances data generation flexibility, and paves the way for scalable and efficient meta-learning of interpretable decision tree models.
>
---
#### [new 048] Multi-Agent Collaborative Framework For Math Problem Generation
- **分类: cs.MA; cs.CL; cs.HC; I.2.11; I.2.6; K.3.1**

- **简介: 该论文提出一种多智能体协作框架，用于自动生成数学问题，解决传统模型难以精确控制问题难度与认知需求的问题。通过多智能体迭代优化，提升生成题目的相关性、清晰度与难度匹配度，增强教育内容的可控性与教学价值。**

- **链接: [http://arxiv.org/pdf/2511.03958v1](http://arxiv.org/pdf/2511.03958v1)**
...
>
---
#### [new 054] DR. WELL: Dynamic Reasoning and Learning with Symbolic World Model for Embodied LLM-Based Multi-Agent Collaboration
- **分类: cs.AI; cs.CL; cs.LG; cs.MA**

- **简介: DR. WELL提出一种神经符号框架，用于多智能体协作规划，解决轨迹级协调易失败问题。通过符号化角色协商与动态世界模型，实现可复用、可同步的高层规划，提升任务完成率与效率。**

- **链接: [http://arxiv.org/pdf/2511.04646v1](http://arxiv.org/pdf/2511.04646v1)**
...
>
> **摘要:** Quantization plays a crucial role in accelerating the inference of large-scale models, and rotational matrices have been shown to effectively improve quantization performance by smoothing outliers. However, end-to-end fine-tuning of rotational optimization algorithms incurs high computational costs and is prone to overfitting. To address this challenge, we propose an efficient distribution-aware rotational calibration method, DartQuant, which reduces the complexity of rotational optimization by constraining the distribution of the activations after rotation. This approach also effectively reduces reliance on task-specific losses, thereby mitigating the risk of overfitting. Additionally, we introduce the QR-Orth optimization scheme, which replaces expensive alternating optimization with a more efficient solution. In a variety of model quantization experiments, DartQuant demonstrates superior performance. Compared to existing methods, it achieves 47$\times$ acceleration and 10$\times$ memory savings for rotational optimization on a 70B model. Furthermore, it is the first to successfully complete rotational calibration for a 70B model on a single 3090 GPU, making quantization of large language models feasible in resource-constrained environments. Code is available at https://github.com/CAS-CLab/DartQuant.git.
>
---
#### [new 057] LLMs and Cultural Values: the Impact of Prompt Language and Explicit Cultural Framing
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究LLMs在不同语言与文化框架下对文化价值观的响应，揭示其虽能受提示影响，但严重偏向荷、德、美、日等国价值观，未能真实反映全球文化多样性，属于文化对齐与偏见检测任务。**

- **链接: [http://arxiv.org/pdf/2511.03980v1](http://arxiv.org/pdf/2511.03980v1)**
...
>
---
#### [new 059] Large language models replicate and predict human cooperation across experiments in game theory
- **分类: cs.AI; cs.CL; cs.GT; cs.MA**

- **简介: 该论文研究大语言模型（LLMs）在博弈论实验中模拟人类合作行为的能力，解决LLM与人类决策对齐问题。通过系统提示框架，发现Llama能高保真复制人类非理性合作，Qwen趋近纳什均衡，无需个性提示即可实现群体行为模拟，并生成新实验假设。**

- **链接: [http://arxiv.org/pdf/2511.04500v1](http://arxiv.org/pdf/2511.04500v1)**
...
>
---
#### [new 060] VeriCoT: Neuro-symbolic Chain-of-Thought Validation via Logical Consistency Checks
- **分类: cs.AI; cs.CL**

- **简介: 论文提出VeriCoT，用于验证大模型链式推理的逻辑一致性。通过将推理步骤转为一阶逻辑并自动验证，识别错误推理，提升答案可信度，并用于自反思、微调等任务，增强推理准确性与可靠性。**

- **链接: [http://arxiv.org/pdf/2511.04662v1](http://arxiv.org/pdf/2511.04662v1)**
...
>
---
#### [new 061] MIDI-LLM: Adapting Large Language Models for Text-to-MIDI Music Generation
...
>
---
#### [new 062] Sub-exponential Growth in Online Word Usage: A Piecewise Power-Law Model
- **分类: physics.soc-ph; cs.CL; cs.CY; stat.AP**

- **简介: 该论文提出分段幂律模型，揭示在线词频增长中普遍存在的次指数扩散模式，解决传统S型模型无法准确描述的复杂增长曲线问题。通过分析十亿级博客数据，证实α可表征沟通偏好，提供统一的扩散分析框架。**

- **链接: [http://arxiv.org/pdf/2511.04106v1](http://arxiv.org/pdf/2511.04106v1)**
...
>
---
#### [new 063] Jr. AI Scientist and Its Risk Report: Autonomous Scientific Exploration from a Baseline Paper
...
>
---
#### [new 064] How Different Tokenization Algorithms Impact LLMs and Transformer Models for Binary Code Analysis
- **分类: cs.AI; cs.CL; cs.CR; cs.LG**

- **简介: 该论文研究不同分词算法对二进制代码分析中LLM和Transformer模型的影响，解决assembly代码分词未被充分探索的问题，通过评估分词效率与语义表征，优化下游任务（如函数签名预测）的性能。**

- **链接: [http://arxiv.org/pdf/2511.03825v1](http://arxiv.org/pdf/2511.03825v1)**
...
#### [replaced 001] Latent learning: episodic memory complements parametric learning by enabling flexible reuse of experiences
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.16189v2](http://arxiv.org/pdf/2509.16189v2)**
...
>
---
#### [replaced 002] Reasoning Models Hallucinate More: Factuality-Aware Reinforcement Learning for Large Reasoning Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24630v2](http://arxiv.org/pdf/2505.24630v2)**
...
>
---
#### [replaced 003] TurBLiMP: A Turkish Benchmark of Linguistic Minimal Pairs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.13487v2](http://arxiv.org/pdf/2506.13487v2)**
...
>
---
#### [replaced 008] Mathematics with large language models as provers and verifiers
- **分类: cs.CL; cs.AI; cs.LG; cs.LO**

- **链接: [http://arxiv.org/pdf/2510.12829v3](http://arxiv.org/pdf/2510.12829v3)**
...
>
---
#### [replaced 012] TathyaNyaya and FactLegalLlama: Advancing Factual Judgment Prediction and Explanation in the Indian Legal Context
- **分类: cs.CL; cs.AI; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.04737v2](http://arxiv.org/pdf/2504.04737v2)**
...
>
---
#### [replaced 013] NyayaRAG: Realistic Legal Judgment Prediction with RAG under the Indian Common Law System
- **分类: cs.CL; cs.AI; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.00709v2](http://arxiv.org/pdf/2508.00709v2)**
...
>
---
#### [replaced 014] Control Barrier Function for Aligning Large Language Models
- **分类: cs.CL; cs.AI; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2511.03121v2](http://arxiv.org/pdf/2511.03121v2)**

> **作者:** Yuya Miyaoka; Masaki Inoue
>
> **备注:** This work is an extenede version of arXiv:2408.15625 and has been submitted to the IEEE for possible publication
>
...
>
---
#### [replaced 019] Distillation versus Contrastive Learning: How to Train Your Rerankers
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2507.08336v3](http://arxiv.org/pdf/2507.08336v3)**
...
>
---
#### [replaced 020] Balancing Quality and Variation: Spam Filtering Distorts Data Label Distributions
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.08217v2](http://arxiv.org/pdf/2509.08217v2)**
...
>
---
#### [replaced 021] LiveSearchBench: An Automatically Constructed Benchmark for Retrieval and Reasoning over Dynamic Knowledge
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2511.01409v2](http://arxiv.org/pdf/2511.01409v2)**
...
>
---
#### [replaced 022] Hierarchical Retrieval with Evidence Curation for Open-Domain Financial Question Answering on Standardized Documents
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.20368v3](http://arxiv.org/pdf/2505.20368v3)**
...
>
---
#### [replaced 023] Findings of the Fourth Shared Task on Multilingual Coreference Resolution: Can LLMs Dethrone Traditional Approaches?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.17796v2](http://arxiv.org/pdf/2509.17796v2)**
...
>
---
#### [replaced 024] XL-DURel: Finetuning Sentence Transformers for Ordinal Word-in-Context Classification
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.14578v2](http://arxiv.org/pdf/2507.14578v2)**
...
>
---
#### [replaced 025] Decomposed Prompting: Probing Multilingual Linguistic Structure Knowledge in Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2402.18397v2](http://arxiv.org/pdf/2402.18397v2)**
...
>
---
#### [replaced 028] Compression Hacking: A Supplementary Perspective on Informatics Properties of Language Models from Geometric Distortion
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17793v3](http://arxiv.org/pdf/2505.17793v3)**
...
>
---
#### [replaced 031] VISTA Score: Verification In Sequential Turn-based Assessment
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.27052v2](http://arxiv.org/pdf/2510.27052v2)**
...
>
---
#### [replaced 032] Robustness in Large Language Models: A Survey of Mitigation Strategies and Evaluation Metrics
- **分类: cs.CL; cs.AI; cs.LG; 68T07, 68T05, 62C10, 90C31; I.2.6; I.2.7; B.8.1; H.3.3**

- **链接: [http://arxiv.org/pdf/2505.18658v2](http://arxiv.org/pdf/2505.18658v2)**

> **作者:** Pankaj Kumar; Subhankar Mishra
>
> **备注:** Accepted at TMLR
>
> **摘要:** Large Language Models (LLMs) have emerged as a promising cornerstone for the development of natural language processing (NLP) and artificial intelligence (AI). However, ensuring the robustness of LLMs remains a critical challenge. To address these challenges and advance the field, this survey provides a comprehensive overview of current studies in this area. First, we systematically examine the nature of robustness in LLMs, including its conceptual foundations, the importance of consistent performance across diverse inputs, and the implications of failure modes in real-world applications. Next, we analyze the sources of non-robustness, categorizing intrinsic model limitations, data-driven vulnerabilities, and external adversarial factors that compromise reliability. Following this, we review state-of-the-art mitigation strategies, and then we discuss widely adopted benchmarks, emerging metrics, and persistent gaps in assessing real-world reliability. Finally, we synthesize findings from existing surveys and interdisciplinary studies to highlight trends, unresolved issues, and pathways for future research.
>
---
#### [replaced 033] RPRO: Ranked Preference Reinforcement Optimization for Enhancing Medical QA and Diagnostic Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.00974v2](http://arxiv.org/pdf/2509.00974v2)**

> **作者:** Chia-Hsuan Hsu; Jun-En Ding; Hsin-Ling Hsu; Chun-Chieh Liao; Fang-Ming Hung; Feng Liu
>
...
>
---
#### [replaced 034] What Are They Talking About? A Benchmark of Knowledge-Grounded Discussion Summarization
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.12474v3](http://arxiv.org/pdf/2505.12474v3)**

> **作者:** Weixiao Zhou; Junnan Zhu; Gengyao Li; Xianfu Cheng; Xinnian Liang; Feifei Zhai; Zhoujun Li
>
> **备注:** Accepted to AACL-IJCNLP 2025 Main
>
...
>
---
#### [replaced 035] DAMRO: Dive into the Attention Mechanism of LVLM to Reduce Object Hallucination
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 036] On Multilingual Encoder Language Model Compression for Low-Resource Languages
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16956v2](http://arxiv.org/pdf/2505.16956v2)**

> **作者:** Daniil Gurgurov; Michal Gregor; Josef van Genabith; Simon Ostermann
>
> **备注:** Accepted to SRW AACL
>
...
>
---
#### [replaced 037] Memorization in Large Language Models in Medicine: Prevalence, Characteristics, and Implications
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.08604v2](http://arxiv.org/pdf/2509.08604v2)**
...
>
---
#### [replaced 038] VERA: Variational Inference Framework for Jailbreaking Large Language Models
- **分类: cs.CR; cs.CL; cs.LG; stat.ML**

- **链接: [http://arxiv.org/pdf/2506.22666v2](http://arxiv.org/pdf/2506.22666v2)**
...
>
---
#### [replaced 039] FinEval-KR: A Financial Domain Evaluation Framework for Large Language Models' Knowledge and Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.21591v3](http://arxiv.org/pdf/2506.21591v3)**
...
>
---
#### [replaced 043] Homogeneous Keys, Heterogeneous Values: Exploiting Local KV Cache Asymmetry for Long-Context LLMs
- **分类: cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2506.05410v2](http://arxiv.org/pdf/2506.05410v2)**
