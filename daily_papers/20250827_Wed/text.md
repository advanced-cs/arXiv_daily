...
- **简介: 该论文针对大型视觉-语言模型（LVLMs）多语言能力不平衡问题，提出PLAST方法，通过精准调整语言特定浅层神经元实现高效多语言增强，在MM-Bench等任务中提升性能且仅调优14%参数。**
...
- **简介: 论文针对自动提示优化任务，提出DistillPrompt方法，通过多阶段整合任务信息并运用蒸馏、压缩和聚合操作，有效提升提示效果，在文本分类和生成任务中优于现有方法。**
...
>
---
#### [new 008] EMMM, Explain Me My Model! Explainable Machine Generated Text Detection in Dialogues
- **分类: cs.CL**
...
- **简介: 该论文针对广告标题生成中质量与多样性不足的问题，提出DIVER框架，通过多阶段多目标优化（结合SFT与RL）及语义-风格数据生成，提升标题质量与多样性，实测提升广告价值和点击率。**
...
- **简介: 该论文针对大语言模型在整合外部知识时难以兼顾忠实性与表达性的矛盾，提出Collaborative Decoding框架，通过动态融合知识与内部概率、知识感知重排序机制，提升输出的可信度与自然度。**
...
- **链接: [http://arxiv.org/pdf/2508.18819v1](http://arxiv.org/pdf/2508.18819v1)**
...
- **简介: 论文研究医疗对话中医生意图轨迹的分类与分析，构建首个细粒度数据集，揭示SOAP转换模式，提升对话总结性能。**
...
- **简介: 该论文针对自注意力机制中注意力噪声问题（如特殊标记权重过重），提出Integral Transformer通过积分信号去噪，保留关键标记贡献，并验证其在语言建模任务中优于现有方法，提升模型性能。**
...
- **链接: [http://arxiv.org/pdf/2508.18473v1](http://arxiv.org/pdf/2508.18473v1)**
...
- **链接: [http://arxiv.org/pdf/2508.18740v1](http://arxiv.org/pdf/2508.18740v1)**
...
- **简介: 该论文针对语音转文本中领域术语生成难题，提出基于注意力机制的概率估计方法，通过转换注意力权重和课程学习提升检索准确率，并创建新数据集，实验显示显著提升术语识别精度。**
...
- **简介: 论文评估传统可读性指标（如FKGL）在plain language summarization中的有效性，发现其与人类判断相关性低，而语言模型表现更优，建议采用LMs进行评估。**
...
- **链接: [http://arxiv.org/pdf/2508.18407v1](http://arxiv.org/pdf/2508.18407v1)**
...
- **简介: 该论文针对多模态链式推理（MCoT）中提示示例选择不足的问题，提出结合模型感知难度与样本复杂性的提示课程方法，通过平衡难度采样提升推理性能。**
...
- **链接: [http://arxiv.org/pdf/2508.18929v1](http://arxiv.org/pdf/2508.18929v1)**
...
- **简介: 论文提出可控对话主题检测任务，旨在通过用户偏好数据实现对话主题的自动识别与分级分类，解决传统意图检测的刚性问题，提升对话分析的灵活性和用户定制能力。**
...
- **简介: 该论文提出利用大语言模型辅助的内容分析方法（LACA），解决计算教育研究中处理大规模定性数据的难题，通过实证验证其在CER中的应用价值。**
...
- **简介: 该论文研究LLMs在重排任务中的可靠性，针对有限数据与低透明度问题，分析不同训练方法对语义理解的影响，通过小规模数据集验证模型推理能力及可解释性。**
...
- **简介: 该论文研究基于LLM的文本数据重建攻击对差分隐私（DP）文本净化的双刃剑效应，揭示其在破坏隐私与提升质量间的矛盾，并提出利用LLM作为后处理步骤优化隐私保护的方案。**
...
- **简介: 该论文针对大语言模型在双系统认知任务中长推理链效率低的问题，提出CAC-CoT方法，通过限制连接词生成简洁推理链，提升系统1任务性能，同时保持系统2任务准确性。**
...
- **简介: 该论文研究使用声明式语言（5GL）在跨领域系统设计中解决多团队协作的需求统一问题，以96-Eyes项目为例，展示如何形式化需求以提高透明度和可追溯性，并探讨实际应用中的挑战。**
...
- **简介: 该论文针对创意写作中主观质量与客观约束的平衡问题，提出RLMR方法，通过动态混合奖励结合主观评价与约束验证模型，动态调整权重以提升两者。实验表明其在指令遵循和写作质量上均优于现有方法。**
...
>
---
#### [new 069] Optimal Sparsity of Mixture-of-Experts Language Models for Reasoning Tasks
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 论文研究混合专家（MoE）模型在推理任务中的稀疏性优化，探讨参数配置对记忆与推理能力的影响，发现过度稀疏导致推理性能下降，通过系统实验验证参数设置与超参数对模型表现的作用。**

- **链接: [http://arxiv.org/pdf/2508.18672v1](http://arxiv.org/pdf/2508.18672v1)**
...
>
---
#### [new 070] The Ramon Llull's Thinking Machine for Automated Ideation
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出基于Ramon Llull框架的现代AI系统，通过主题、领域、方法三轴组合，利用提示工程从文献中提取元素，生成多样化且文献支持的科研创意，实现人机协作的自动化构想。**

- **链接: [http://arxiv.org/pdf/2508.19200v1](http://arxiv.org/pdf/2508.19200v1)**
...
>
---
#### [new 071] StepWiser: Stepwise Generative Judges for Wiser Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文针对多步推理中中间步骤逻辑验证问题，提出生成式法官StepWiser，通过强化学习训练，以生成思考过程提升判断准确性与泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.19229v1](http://arxiv.org/pdf/2508.19229v1)**
...
>
---
#### [new 072] Toward Responsible ASR for African American English Speakers: A Scoping Review of Bias and Equity in Speech Technology
...
>
---
#### [new 073] Building Self-Evolving Agents via Experience-Driven Lifelong Learning: A Framework and Benchmark
- **分类: cs.AI; cs.CL**

- **简介: 论文提出基于经验驱动的终身学习（ELL）框架，构建能持续进化自主智能体，解决动态环境中适应性不足问题。通过StuLife基准模拟大学生全流程，评估记忆、技能迁移与自我驱动能力，探索上下文工程对AGI的推动作用。**

- **链接: [http://arxiv.org/pdf/2508.19005v1](http://arxiv.org/pdf/2508.19005v1)**
...
#### [replaced 001] ChatGPT Doesn't Trust Chargers Fans: Guardrail Sensitivity in Context
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2407.06866v3](http://arxiv.org/pdf/2407.06866v3)**

> **作者:** Victoria R. Li; Yida Chen; Naomi Saphra
>
> **摘要:** While the biases of language models in production are extensively documented, the biases of their guardrails have been neglected. This paper studies how contextual information about the user influences the likelihood of an LLM to refuse to execute a request. By generating user biographies that offer ideological and demographic information, we find a number of biases in guardrail sensitivity on GPT-3.5. Younger, female, and Asian-American personas are more likely to trigger a refusal guardrail when requesting censored or illegal information. Guardrails are also sycophantic, refusing to comply with requests for a political position the user is likely to disagree with. We find that certain identity groups and seemingly innocuous information, e.g., sports fandom, can elicit changes in guardrail sensitivity similar to direct statements of political ideology. For each demographic category and even for American football team fandom, we find that ChatGPT appears to infer a likely political ideology and modify guardrail behavior accordingly.
>
---
#### [replaced 002] DLLMQuant: Quantizing Diffusion-based Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.14090v2](http://arxiv.org/pdf/2508.14090v2)**
...
>
---
#### [replaced 003] sudoLLM: On Multi-role Alignment of Language Models
- **分类: cs.CL; cs.CR; I.2.7**

- **链接: [http://arxiv.org/pdf/2505.14607v3](http://arxiv.org/pdf/2505.14607v3)**
...
>
---
#### [replaced 004] Adapting Large Language Models to Log Analysis with Interpretable Domain Knowledge
- **分类: cs.CL; cs.SE**

- **链接: [http://arxiv.org/pdf/2412.01377v2](http://arxiv.org/pdf/2412.01377v2)**
...
>
---
#### [replaced 006] Can Pruning Improve Reasoning? Revisiting Long-CoT Compression with Capability in Mind for Better Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.14582v2](http://arxiv.org/pdf/2505.14582v2)**
...
>
---
#### [replaced 007] Retrieval Enhanced Feedback via In-context Neural Error-book
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.16313v2](http://arxiv.org/pdf/2508.16313v2)**
...
>
---
#### [replaced 008] Truth or Twist? Optimal Model Selection for Reliable Label Flipping Evaluation in LLM-based Counterfactuals
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.13972v2](http://arxiv.org/pdf/2505.13972v2)**
...
>
---
#### [replaced 009] Evaluating Scoring Bias in LLM-as-a-Judge
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.22316v3](http://arxiv.org/pdf/2506.22316v3)**
...
>
---
#### [replaced 010] Weakly-Supervised 3D Visual Grounding based on Visual Language Alignment
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 011] LLM-Enhanced Linear Autoencoders for Recommendation
- **分类: cs.IR; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.13500v2](http://arxiv.org/pdf/2508.13500v2)**
...
>
---
#### [replaced 012] Debate-to-Detect: Reformulating Misinformation Detection as a Real-World Debate with Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.18596v4](http://arxiv.org/pdf/2505.18596v4)**
...
>
---
#### [replaced 017] Bridging the Editing Gap in LLMs: FineEdit for Precise and Targeted Text Modifications
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.13358v3](http://arxiv.org/pdf/2502.13358v3)**
...
>
---
#### [replaced 018] Less Is More? Examining Fairness in Pruned Large Language Models for Summarising Opinions
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.17610v2](http://arxiv.org/pdf/2508.17610v2)**
...
>
---
#### [replaced 021] EMO-Reasoning: Benchmarking Emotional Reasoning Capabilities in Spoken Dialogue Systems
- **分类: cs.CL; eess.AS**

- **链接: [http://arxiv.org/pdf/2508.17623v2](http://arxiv.org/pdf/2508.17623v2)**
...
>
---
#### [replaced 022] NVIDIA Nemotron Nano 2: An Accurate and Efficient Hybrid Mamba-Transformer Reasoning Model
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.14444v3](http://arxiv.org/pdf/2508.14444v3)**
...
>
---
#### [replaced 026] Mind the (Language) Gap: Towards Probing Numerical and Cross-Lingual Limits of LVLMs
...
>
---
#### [replaced 027] Dream to Chat: Model-based Reinforcement Learning on Dialogues with User Belief Modeling
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.16876v2](http://arxiv.org/pdf/2508.16876v2)**
...
>
---
#### [replaced 033] SDGO: Self-Discrimination-Guided Optimization for Consistent Safety in Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.15648v2](http://arxiv.org/pdf/2508.15648v2)**
...
>
---
#### [replaced 034] SKA-Bench: A Fine-Grained Benchmark for Evaluating Structured Knowledge Understanding of LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.17178v2](http://arxiv.org/pdf/2507.17178v2)**
...
>
---
#### [replaced 035] Collaborative Evaluation of Deepfake Text with Deliberation-Enhancing Dialogue Systems
- **分类: cs.CL; cs.AI; cs.HC**

- **链接: [http://arxiv.org/pdf/2503.04945v2](http://arxiv.org/pdf/2503.04945v2)**

> **作者:** Jooyoung Lee; Xiaochen Zhu; Georgi Karadzhov; Tom Stafford; Andreas Vlachos; Dongwon Lee
>
> **备注:** 15; To appear in ICWSM 2026 (https://www.icwsm.org/2026/)
>
...
>
---
#### [replaced 036] From Intents to Conversations: Generating Intent-Driven Dialogues with Contrastive Learning for Multi-Turn Classification
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2411.14252v2](http://arxiv.org/pdf/2411.14252v2)**

> **作者:** Junhua Liu; Yong Keat Tan; Bin Fu; Kwan Hui Lim
>
> **备注:** Accepted to Proceedings of CIKM 2025
>
...
>
---
#### [replaced 037] Accelerate Parallelizable Reasoning via Parallel Decoding within One Sequence
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.20533v4](http://arxiv.org/pdf/2503.20533v4)**

> **作者:** Yijiong Yu
>
> **备注:** Our code is available in https://github.com/yuyijiong/parallel-decoding-in-one-sequence
>
...
>
---
#### [replaced 038] Large Language Models Badly Generalize across Option Length, Problem Types, and Irrelevant Noun Replacements
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.12459v2](http://arxiv.org/pdf/2502.12459v2)**
...
>
---
#### [replaced 039] Krul: Efficient State Restoration for Multi-turn Conversations with Dynamic Cross-layer KV Sharing
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.08045v2](http://arxiv.org/pdf/2507.08045v2)**
...
>
---
#### [replaced 040] Fingerprint Vector: Enabling Scalable and Efficient Model Fingerprint Transfer via Vector Addition
- **分类: cs.CR; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2409.08846v3](http://arxiv.org/pdf/2409.08846v3)**
...
>
---
#### [replaced 041] TL-Training: A Task-Feature-Based Framework for Training Large Language Models in Tool Use
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2412.15495v2](http://arxiv.org/pdf/2412.15495v2)**
...
>
---
#### [replaced 047] ELSPR: Evaluator LLM Training Data Self-Purification on Non-Transitive Preferences via Tournament Graph Reconstruction
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17691v2](http://arxiv.org/pdf/2505.17691v2)**
