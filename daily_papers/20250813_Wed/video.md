...
- **简介: 论文提出一种无需用户提示的零样本物体层堆栈生成方法CObL，通过扩散模型构建遮挡有序的物体层，实现对现实场景的泛化重建。**
...
- **简介: 论文提出ColorGPT，利用预训练LLMs解决颜色推荐问题，通过多模态分析提升建议准确性和多样性。**
...
- **简介: 本文提出基于方向性曲率的图像伪影分类与量化框架，通过ATR指标及两阶段系统实现高精度评估，R² 0.892，RMSE 5.17 DMOS。**
...
- **简介: 论文提出基于伪全局融合的跨视图网络，解决LiDAR场景识别中欧几里得距离建模不足的问题，通过几何建模与特征空间结构优化提升复杂环境下的性能。**
...
- **简介: 论文提出一种基于层次视觉提示学习的视频实例分割方法，解决持续学习中类别保持和新类别遗忘问题，通过帧级任务提示和梯度修正，及视频级上下文解码器实现。**
...
- **简介: 论文提出一种分两阶段优化的图像水印学习方法（HiWL），通过建立共用潜在空间与分离水印表示，解决现有方法在不可见性、鲁棒性及广泛适用性方面的局限，实现高效且通用的水印嵌入与提取。**
...
- **简介: 论文提出VLM-3D框架，通过端到端训练融合视觉-语言模型与低秩适配技术，解决开放世界3D感知中新类别识别难题，采用联合语义-几何损失优化边界框预测，提升nuScenes数据集上的感知准确率12.8%。**
...
- **简介: 论文提出一种无参考（NR）视频质量评估模型CBAND，基于深度学习嵌入统计，显著提升带状伪影评估性能，解决现有数据集缺乏时间动态的不足，并开源数据库与代码。**
...
- **简介: 论文提出通过FLIPNET解决盲面修复中扩散先验适应性问题，采用双模式切换整合BFR特征与真实图像，提升修复质量与真实性。**
...
- **链接: [http://arxiv.org/pdf/2508.08923v1](http://arxiv.org/pdf/2508.08923v1)**
...
- **链接: [http://arxiv.org/pdf/2508.08811v1](http://arxiv.org/pdf/2508.08811v1)**
...
- **简介: 论文提出一种多尺度量化方法MSQ，解决传统离散帧序列在多尺度运动建模和组合灵活性方面的不足，通过空间-时间多尺度编码与令牌生成，实现运动编辑与条件生成，提升生成效果。**
...
- **简介: 论文提出TransMiter，一种无需反向传播的轻量级适配器，实现跨模型高效知识迁移，提升弱到强VLM性能，计算开销小且补充少量标注数据可进一步优化。**
...
- **简介: 论文提出Yan框架，构建互动视频生成基础，涵盖模拟、生成与编辑三阶段，通过压缩3D-VAE、多模态建模及多粒度编辑技术，实现跨域风格迁移与实时交互。**
...
- **简介: 论文提出基于超类信息的表示解耦方法，通过梯度引导注意力分离相关与无关特征，无需源样本标注即可提升域泛化鲁棒性。**
...
- **简介: 论文提出一种基于光场视差信息的轻量化深度估计方法，解决传统CNN模型高计算成本与噪声鲁棒性不足问题，通过定向随机游走算法提升深度图一致性，实现高效鲁棒的光场深度估计。**
...
- **链接: [http://arxiv.org/pdf/2508.08937v1](http://arxiv.org/pdf/2508.08937v1)**
...
- **简介: 该论文提出结构感知的双解码器U-Net SharpXR，用于低剂量儿科胸片去噪，解决噪声干扰下细节保留问题，通过Laplacian引导和可学习融合模块提升诊断精度。**
...
- **简介: 论文提出一种多智能体框架MAViS，解决长序列视频生成中辅助能力差、视觉质量低及表达受限问题，通过分阶段协作（脚本撰写、镜头设计等）并遵循3E原则优化输出，实现高质叙事视频生成，支持多模态输出（视频+音乐）。**
...
- **简介: 本文提出基于深度学习的面部活体检测模型，针对深度伪造等高级攻击，通过融合纹理与反射特性提升检测精度，实验表明其在五大数据集上平均准确率达99.9%，并揭示攻击行为模式。**
...
- **简介: 论文提出自监督方法解决手持视频去模糊问题，利用清晰线索生成配对数据并约束空间一致性，提升真实场景下的去模糊效果。**
...
- **简介: 论文针对低光图像增强中互组件残差（ICR）问题，提出IRetinex模型通过减少残差和特征相似性检测提升效果。**
...
- **简介: 论文提出一种统一空间-时间轻量级Transformer框架UniSTFormer，解决传统方法参数多、计算成本高及可扩展性差的问题，通过整合空间与时间建模至单个注意力模块，减少冗余计算，并引入多尺度池化融合模块提升局部与全局运动捕捉能力，实验显示其在准确率与效率间取得平衡。**
...
>
---
#### [new 075] DiffPhysCam: Differentiable Physics-Based Camera Simulation for Inverse Rendering and Embodied AI
...
>
---
#### [new 076] Efficient motion-based metrics for video frame interpolation
- **分类: eess.IV; cs.CV**

- **简介: 本文提出基于运动场发散的高效视频帧插值质量评估指标，提升计算效率并关联感知评分。**

- **链接: [http://arxiv.org/pdf/2508.09078v1](http://arxiv.org/pdf/2508.09078v1)**
...
>
---
#### [new 077] Preprocessing Algorithm Leveraging Geometric Modeling for Scale Correction in Hyperspectral Images for Improved Unmixing Performance
...
>
---
#### [new 078] Variational volume reconstruction with the Deep Ritz Method
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 论文提出基于Deep Ritz方法的变分体积重建方案，解决稀疏噪声切片数据重建难题，通过结合回归损失与Cahn-Hilliard能量，利用神经网络离散相场和蒙特卡洛积分优化，实现高效高精度重建。**

- **链接: [http://arxiv.org/pdf/2508.08309v1](http://arxiv.org/pdf/2508.08309v1)**
...
>
---
#### [new 082] Improving Facial Rig Semantics for Tracking and Retargeting
- **分类: cs.GR; cs.CV**

- **简介: 论文提出通过微调追踪器骨架提升面部语义，解决跨骨架追踪时控制失真问题，利用隐式微分处理非不同的iable黑箱，增强重定向效果。**

- **链接: [http://arxiv.org/pdf/2508.08429v1](http://arxiv.org/pdf/2508.08429v1)**
...
>
---
#### [new 083] EndoAgent: A Memory-Guided Reflective Agent for Intelligent Endoscopic Vision-to-Decision Reasoning
...
>
---
#### [new 084] STELAR-VISION: Self-Topology-Aware Efficient Learning for Aligned Reasoning in Vision
- **分类: cs.AI; cs.CV**

- **简介: 该论文提出STELAR-VISION框架，针对视觉-语言模型在复杂任务中输出冗长、依赖链式思维的问题，通过TopoAug合成数据增强与Frugal Learning优化，提升推理效率与泛化能力，实现准确率提升及对大模型的超越。**

- **链接: [http://arxiv.org/pdf/2508.08688v1](http://arxiv.org/pdf/2508.08688v1)**
...
>
---
#### [new 085] OpenCUA: Open Foundations for Computer-Use Agents
- **分类: cs.AI; cs.CV**

- **简介: 论文提出OpenCUA框架，解决计算机使用代理（CUA）开放性问题，通过注释基础设施、AgentNet数据集和可扩展流水线实现跨平台任务自动化，突破现有模型限制并开源资源推动研究。**

- **链接: [http://arxiv.org/pdf/2508.09123v1](http://arxiv.org/pdf/2508.09123v1)**
...
>
---
#### [new 086] Frequency-Assisted Adaptive Sharpening Scheme Considering Bitrate and Quality Tradeoff
- **分类: eess.IV; cs.CV; cs.MM**

- **简介: 论文提出一种基于频率的自适应锐化方案，解决视频质量与带宽成本的权衡问题，通过CNN和高频特征预测最佳锐化级别。**

- **链接: [http://arxiv.org/pdf/2508.08854v1](http://arxiv.org/pdf/2508.08854v1)**
...
>
---
#### [new 087] Multi-level Collaborative Distillation Meets Global Workspace Model: A Unified Framework for OCIL
- **分类: cs.LG; cs.CV**

- **简介: 论文提出基于全局工作空间模型的多级协作蒸馏框架，解决OCIL中内存约束下的稳定性与新任务适应性问题，通过融合学生参数和定期分发GWM增强一致性，平衡稳定性和适应性。**

- **链接: [http://arxiv.org/pdf/2508.08677v1](http://arxiv.org/pdf/2508.08677v1)**
...
>
---
#### [new 093] Training-Free Text-Guided Color Editing with Multi-Modal Diffusion Transformer
- **分类: cs.GR; cs.AI; cs.CV**

- **简介: 论文提出训练免调色编辑方法ColorCtrl，利用多模态扩散变压器（MM-DiT）的注意力机制，通过分离结构与颜色实现精准色域编辑，解决传统方法在颜色控制与物理一致性上的不足，实验表明其在图像与视频领域均表现优异。**

- **链接: [http://arxiv.org/pdf/2508.09131v1](http://arxiv.org/pdf/2508.09131v1)**
...
#### [replaced 001] HypeVPR: Exploring Hyperbolic Space for Perspective to Equirectangular Visual Place Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04764v2](http://arxiv.org/pdf/2506.04764v2)**
...
>
---
#### [replaced 002] Half-Physics: Enabling Kinematic 3D Human Model with Physical Interactions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23778v2](http://arxiv.org/pdf/2507.23778v2)**
...
>
---
#### [replaced 003] See the Forest and the Trees: A Synergistic Reasoning Framework for Knowledge-Based Visual Question Answering
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.17659v2](http://arxiv.org/pdf/2507.17659v2)**

> **作者:** Junjie Wang; Yunhan Tang; Yijie Wang; Zhihao Yuan; Huan Wang; Yangfan He; Bin Li
>
> **备注:** Paper withdrawn by authors. A critical bug in our data processing script (process_data.py, line 152) caused an incorrect indexing operation, leading to systematic data omission. This error invalidates the performance benchmarks in Table 2 and the conclusions, leaving the paper's central claim unsupported. We apologize to the research community for this error
>
...
>
---
#### [replaced 014] Decoupled Functional Evaluation of Autonomous Driving Models via Feature Map Quality Scoring
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07552v2](http://arxiv.org/pdf/2508.07552v2)**

> **作者:** Ludan Zhang; Sihan Wang; Yuqi Dai; Shuofei Qiao; Qinyue Luo; Lei He
>
...
>
---
#### [replaced 018] LM-MCVT: A Lightweight Multi-modal Multi-view Convolutional-Vision Transformer Approach for 3D Object Recognition
- **分类: cs.CV; cs.RO**

- **链接: [http://arxiv.org/pdf/2504.19256v2](http://arxiv.org/pdf/2504.19256v2)**
...
>
---
#### [replaced 019] Stand-In: A Lightweight and Plug-and-Play Identity Control for Video Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07901v2](http://arxiv.org/pdf/2508.07901v2)**
...
>
---
#### [replaced 020] Un-EVIMO: Unsupervised Event-Based Independent Motion Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2312.00114v2](http://arxiv.org/pdf/2312.00114v2)**
...
>
---
#### [replaced 021] GPSMamba: A Global Phase and Spectral Prompt-guided Mamba for Infrared Image Super-Resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.18998v3](http://arxiv.org/pdf/2507.18998v3)**
...
>
---
#### [replaced 022] On the Reliability of Vision-Language Models Under Adversarial Frequency-Domain Perturbations
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.22398v2](http://arxiv.org/pdf/2507.22398v2)**
...
>
---
#### [replaced 023] Efficient Annotation of Medieval Charters
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2306.14071v2](http://arxiv.org/pdf/2306.14071v2)**

> **作者:** Anguelos Nicolaou; Daniel Luger; Franziska Decker; Nicolas Renet; Vincent Christlein; Georg Vogeler
>
> **摘要:** Diplomatics, the analysis of medieval charters, is a major field of research in which paleography is applied. Annotating data, if performed by laymen, needs validation and correction by experts. In this paper, we propose an effective and efficient annotation approach for charter segmentation, essentially reducing it to object detection. This approach allows for a much more efficient use of the paleographer's time and produces results that can compete and even outperform pixel-level segmentation in some use cases. Further experiments shed light on how to design a class ontology in order to make the best use of annotators' time and effort. Exploiting the presence of calibration cards in the image, we further annotate the data with the physical length in pixels and train regression neural networks to predict it from image patches.
>
---
#### [replaced 024] Gotta Hear Them All: Towards Sound Source Aware Audio Generation
...
>
> **备注:** Paper submitted as part of the A&A Special Issue `Euclid Quick Data Release (Q1)', 34 pages, 26 figures
>
...
>
---
#### [replaced 029] Zero-Shot Generalization of Vision-Based RL Without Data Augmentation
...
>
---
#### [replaced 030] Follow-Your-Shape: Shape-Aware Image Editing via Trajectory-Guided Region Control
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.08134v2](http://arxiv.org/pdf/2508.08134v2)**
...
>
---
#### [replaced 031] Adversarial Video Promotion Against Text-to-Video Retrieval
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.06964v2](http://arxiv.org/pdf/2508.06964v2)**
...
>
---
#### [replaced 032] REDUCIO! Generating 1K Video within 16 Seconds using Extremely Compressed Motion Latents
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.13552v3](http://arxiv.org/pdf/2411.13552v3)**
...
>
---
#### [replaced 034] Triad: Empowering LMM-based Anomaly Detection with Vision Expert-guided Visual Tokenizer and Manufacturing Process
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.13184v2](http://arxiv.org/pdf/2503.13184v2)**
...
>
---
#### [replaced 035] StyleTailor: Towards Personalized Fashion Styling via Hierarchical Negative Feedback
...
>
---
#### [replaced 036] IRL-VLA: Training an Vision-Language-Action Policy via Reward World Model
- **分类: cs.AI; cs.CV; cs.RO**
...
>
---
#### [replaced 037] When Imitation Learning Outperforms Reinforcement Learning in Surgical Action Planning
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.05011v2](http://arxiv.org/pdf/2507.05011v2)**
...
>
---
#### [replaced 038] LayLens: Improving Deepfake Understanding through Simplified Explanations
- **分类: cs.MM; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.10066v2](http://arxiv.org/pdf/2507.10066v2)**

> **作者:** Abhijeet Narang; Parul Gupta; Liuyijia Su; Abhinav Dhall
>
> **备注:** Accepted to ACM ICMI 2025 Demos
>
...
>
---
#### [replaced 039] MUG: Pseudo Labeling Augmented Audio-Visual Mamba Network for Audio-Visual Video Parsing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.01384v2](http://arxiv.org/pdf/2507.01384v2)**
...
>
---
#### [replaced 040] CulturalFrames: Assessing Cultural Expectation Alignment in Text-to-Image Models and Evaluation Metrics
...
>
---
#### [replaced 043] HiMat: DiT-based Ultra-High Resolution SVBRDF Generation
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2508.07011v2](http://arxiv.org/pdf/2508.07011v2)**
...
>
---
#### [replaced 048] AMFT: Aligning LLM Reasoners by Meta-Learning the Optimal Imitation-Exploration Balance
...
>
---
#### [replaced 049] A Data-driven Loss Weighting Scheme across Heterogeneous Tasks for Image Denoising
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2301.06081v3](http://arxiv.org/pdf/2301.06081v3)**
...
>
---
#### [replaced 050] FUTransUNet-GradCAM: A Hybrid Transformer-U-Net with Self-Attention and Explainable Visualizations for Foot Ulcer Segmentation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03758v2](http://arxiv.org/pdf/2508.03758v2)**
...
>
---
#### [replaced 053] Context as Memory: Scene-Consistent Interactive Long Video Generation with Memory Retrieval
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03141v2](http://arxiv.org/pdf/2506.03141v2)**

> **作者:** Jiwen Yu; Jianhong Bai; Yiran Qin; Quande Liu; Xintao Wang; Pengfei Wan; Di Zhang; Xihui Liu
>
> **备注:** SIGGRAPH Asia 2025, Project Page: https://context-as-memory.github.io/
>
...
>
---
#### [replaced 054] From Pixels to Tokens: Revisiting Object Hallucinations in Large Vision-Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 055] Mjölnir: A Deep Learning Parametrization Framework for Global Lightning Flash Density
- **分类: cs.LG; cs.AI; cs.CV; physics.ao-ph**

- **链接: [http://arxiv.org/pdf/2504.19822v3](http://arxiv.org/pdf/2504.19822v3)**

> **作者:** Minjong Cheon
>
> **备注:** After an internal review, we found that the current version does not meet our intended academic standards due to incomplete descriptions and insufficient detail in key sections. No revised manuscript can be prepared in the near future. To ensure academic quality, we withdraw this version and plan to resubmit when the work is substantially improved
>
...
>
---
#### [replaced 056] Argus Inspection: Do Multimodal Large Language Models Possess the Eye of Panoptes?
...
>
---
#### [replaced 057] A Survey on All-in-One Image Restoration: Taxonomy, Evaluation and Future Trends
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2410.15067v3](http://arxiv.org/pdf/2410.15067v3)**
...
>
---
#### [replaced 059] Zero-shot Emotion Annotation in Facial Images Using Large Multimodal Models: Benchmarking and Prospects for Multi-Class, Multi-Frame Approaches
- **分类: cs.CV; cs.AI; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.12454v2](http://arxiv.org/pdf/2502.12454v2)**
...
>
---
#### [replaced 061] ViStoryBench: Comprehensive Benchmark Suite for Story Visualization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24862v3](http://arxiv.org/pdf/2505.24862v3)**

> **作者:** Cailin Zhuang; Ailin Huang; Wei Cheng; Jingwei Wu; Yaoqi Hu; Jiaqi Liao; Hongyuan Wang; Xinyao Liao; Weiwei Cai; Hengyuan Xu; Xuanyang Zhang; Xianfang Zeng; Zhewei Huang; Gang Yu; Chi Zhang
>
...
>
---
#### [replaced 062] Omni-Effects: Unified and Spatially-Controllable Visual Effects Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.07981v2](http://arxiv.org/pdf/2508.07981v2)**
...
>
---
#### [replaced 063] VisionUnite: A Vision-Language Foundation Model for Ophthalmology Enhanced with Clinical Knowledge
...
>
---
#### [replaced 064] Mitigating Hallucination in Large Vision-Language Models via Adaptive Attention Calibration
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 065] Memory Storyboard: Leveraging Temporal Segmentation for Streaming Self-Supervised Learning from Egocentric Videos
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.12254v3](http://arxiv.org/pdf/2501.12254v3)**
...
>
---
#### [replaced 066] SEAgent: Self-Evolving Computer Use Agent with Autonomous Learning from Experience
...
>
---
#### [replaced 067] SynFER: Towards Boosting Facial Expression Recognition with Synthetic Data
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.09865v3](http://arxiv.org/pdf/2410.09865v3)**
...
>
---
#### [replaced 068] Understanding Dynamic Scenes in Ego Centric 4D Point Clouds
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07251v2](http://arxiv.org/pdf/2508.07251v2)**
...
>
---
#### [replaced 069] How Does Bilateral Ear Symmetry Affect Deep Ear Features?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.04614v2](http://arxiv.org/pdf/2508.04614v2)**
...
>
---
#### [replaced 070] DreamStory: Open-Domain Story Visualization by LLM-Guided Multi-Subject Consistent Diffusion
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2407.12899v3](http://arxiv.org/pdf/2407.12899v3)**
...
>
---
#### [replaced 072] Unsupervised Document and Template Clustering using Multimodal Embeddings
...
>
---
#### [replaced 073] SoftHGNN: Soft Hypergraph Neural Networks for General Visual Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.15325v2](http://arxiv.org/pdf/2505.15325v2)**
...
>
---
#### [replaced 074] From Slow Bidirectional to Fast Autoregressive Video Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.07772v3](http://arxiv.org/pdf/2412.07772v3)**

> **作者:** Tianwei Yin; Qiang Zhang; Richard Zhang; William T. Freeman; Fredo Durand; Eli Shechtman; Xun Huang
>
> **备注:** Project Page: https://causvid.github.io/
>
...
>
---
#### [replaced 075] Cut2Next: Generating Next Shot via In-Context Tuning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.08244v2](http://arxiv.org/pdf/2508.08244v2)**
...
>
---
#### [replaced 078] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.06424v2](http://arxiv.org/pdf/2412.06424v2)**
...
>
---
#### [replaced 079] CrossWordBench: Evaluating the Reasoning Capabilities of LLMs and LVLMs with Controllable Puzzle Generation
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [replaced 080] WSI-LLaVA: A Multimodal Large Language Model for Whole Slide Image
- **分类: cs.CV; cs.CL**
