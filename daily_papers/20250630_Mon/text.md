...
- **简介: 该论文属于自然语言处理中的时间理解与列表构建任务，旨在解决大语言模型在时间关联和列表生成上的不足，提出TLQA基准进行评估。**
...
- **简介: 该论文属于评估任务，旨在检测大语言模型在道德决策中的偏见。通过构建基于ERG理论的道德困境数据集，分析模型对不同需求层级和身份的响应差异。**
...
- **简介: 该论文属于数学证明生成任务，旨在解决LLM生成证明质量评估问题。构建了OPC数据集，并研究了自然语言与形式化证明差异、答案准确性与证明有效性关系及最佳选择策略。**
...
- **简介: 该论文提出GraphLAMA方法，解决图语言模型在少量标注数据下的高效适应问题，通过参数微调提升准确率和推理速度。**
...
- **简介: 该论文提出MDC-R，为Minecraft对话语料添加指代和指示参考标注，解决对话中指代理解问题，提升对话分析资源。**
...
>
---
#### [new 014] Large Language Models as symbolic DNA of cultural dynamics
- **分类: cs.CL; cs.AI; cs.CY**
...
>
---
#### [new 016] Digital Gatekeepers: Exploring Large Language Model's Role in Immigration Decisions
- **分类: cs.CL; cs.AI**
...
- **简介: 该论文研究GPT-2在动词变位任务中的机制，通过实验定位负责主谓一致的网络模块，探索其结构与性能关系。**
...
- **简介: 该论文属于自然语言处理中的分类任务，旨在解决社交媒体上仇恨言论检测问题。通过对比XLNet和BERT模型，验证了XLNet在检测和分类 offensive language 上的优越性。**
...
- **链接: [http://arxiv.org/pdf/2506.21623v1](http://arxiv.org/pdf/2506.21623v1)**
...
>
---
#### [new 037] Reinforcement Learning Fine-Tuning of Language Model for Instruction Following and Math Reasoning
- **分类: cs.CL; cs.AI**
...
- **简介: 该论文属于多模态语言模型任务，旨在解决语音交互中性能下降问题。通过引入自适应专家学习框架DeepTalk，提升语音生成效果并降低延迟。**
...
- **简介: 该论文属于语音语言模型评估任务，旨在解决现有基准不适用于语音对话的问题。通过构建真实语音数据集和设计查询感知评估方法，提升语音模型的评价准确性。**
...
- **简介: 该论文介绍VIDEE系统，旨在帮助非专家用户进行文本分析。解决传统文本分析需专业知识的问题，通过智能代理实现分解、执行与评估的协作流程。**
...
- **链接: [http://arxiv.org/pdf/2506.22403v1](http://arxiv.org/pdf/2506.22403v1)**
...
- **简介: 该论文研究机器翻译中的语言特征（MTese），比较LLMs与NMTs在中英新闻文本中的表现，通过特征分析和分类任务识别其差异。**
...
- **简介: 该论文属于自然语言处理中的公共意见模拟任务，旨在评估DeepSeek等大模型在不同国家社会议题上的表现，揭示其文化与人口偏差。**
...
- **简介: 该论文属于知识图谱构建任务，旨在解决法律文本中人蛇网络结构化难题。通过引入CORE-KG框架，提升实体与关系抽取的准确性与一致性。**
...
>
---
#### [new 061] DAPFAM: A Domain-Aware Patent Retrieval Dataset Aggregated at the Family Level
- **分类: cs.CL; cs.IR**
...
- **简介: 该论文提出BTF基准，用于评估AI在历史事件上的预测能力，解决缺乏真实、可重复预测环境的问题。**
...
- **简介: 该论文属于自然语言处理任务，解决LLM在QA基准测试中因记忆数据导致的评估失真问题。提出LastingBench框架，通过扰动和重写泄漏点来削弱记忆效应，提升基准长期有效性。**
...
- **简介: 该论文属于安全攻击任务，旨在解决LLM防御漏洞问题。通过融合token和prompt级方法，提升越狱攻击效果并突破现有防御机制。**
...
>
---
#### [new 072] From General Reasoning to Domain Expertise: Uncovering the Limits of Generalization in Large Language Models
- **分类: cs.CL; cs.AI; cs.CY**
...
>
---
#### [new 073] Overview of the ClinIQLink 2025 Shared Task on Medical Question-Answering
- **分类: cs.CL; cs.AI; cs.IR; I.2.7**

- **简介: 该论文介绍ClinIQLink 2025共享任务，旨在评估大语言模型在医学问答中的表现，解决医疗领域问答准确性问题，提供多样化题型数据并进行自动评分与专家审核。**

- **链接: [http://arxiv.org/pdf/2506.21597v1](http://arxiv.org/pdf/2506.21597v1)**

> **作者:** Brandon Colelough; Davis Bartels; Dina Demner-Fushman
>
> **备注:** 10 pages, 5 figures
>
> **摘要:** In this paper, we present an overview of ClinIQLink, a shared task, collocated with the 24th BioNLP workshop at ACL 2025, designed to stress-test large language models (LLMs) on medically-oriented question answering aimed at the level of a General Practitioner. The challenge supplies 4,978 expert-verified, medical source-grounded question-answer pairs that cover seven formats: true/false, multiple choice, unordered list, short answer, short-inverse, multi-hop, and multi-hop-inverse. Participating systems, bundled in Docker or Apptainer images, are executed on the CodaBench platform or the University of Maryland's Zaratan cluster. An automated harness (Task 1) scores closed-ended items by exact match and open-ended items with a three-tier embedding metric. A subsequent physician panel (Task 2) audits the top model responses.
>
---
#### [new 074] Structured Attention Matters to Multimodal LLMs in Document Understanding
- **分类: cs.CL; cs.AI; cs.IR**

- **简介: 该论文属于文档理解任务，解决MLLMs因输入格式导致的性能问题。通过结构化编码提升模型注意力效率，增强问答性能。**

- **链接: [http://arxiv.org/pdf/2506.21600v1](http://arxiv.org/pdf/2506.21600v1)**
...
>
---
#### [new 075] Reasoning Isn't Enough: Examining Truth-Bias and Sycophancy in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的事实检测任务，旨在解决LLMs在判断真假时的偏差问题。研究比较了推理与非推理模型，发现其存在真理偏见和奉承倾向。**

- **链接: [http://arxiv.org/pdf/2506.21561v1](http://arxiv.org/pdf/2506.21561v1)**
...
>
---
#### [new 076] Sequential Diagnosis with Language Models
- **分类: cs.CL**

- **简介: 该论文属于医疗诊断任务，旨在解决AI在复杂临床情境下的诊断准确性与成本问题。通过构建序列诊断基准和MAI-DxO系统，提升诊断精度并降低医疗成本。**

- **链接: [http://arxiv.org/pdf/2506.22405v1](http://arxiv.org/pdf/2506.22405v1)**
...
>
---
#### [new 077] The Consistency Hypothesis in Uncertainty Quantification for Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理中的不确定性量化任务，旨在提升大语言模型输出的可信度。通过验证一致性假设，提出新的无数据黑盒方法来估计置信度。**

- **链接: [http://arxiv.org/pdf/2506.21849v1](http://arxiv.org/pdf/2506.21849v1)**
...
>
---
#### [new 081] IndexTTS2: A Breakthrough in Emotionally Expressive and Duration-Controlled Auto-Regressive Zero-Shot Text-to-Speech
- **分类: cs.CL; cs.AI; cs.SD; eess.AS**
...
>
---
#### [new 082] BioPars: A Pretrained Biomedical Large Language Model for Persian Biomedical Text Mining
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于生物医学文本挖掘任务，旨在解决波斯语医学问答问题。提出BioPars模型并构建了相关数据集，评估其在知识获取、理解与推理方面的能力。**

- **链接: [http://arxiv.org/pdf/2506.21567v1](http://arxiv.org/pdf/2506.21567v1)**
...
>
---
#### [new 085] ANUBHUTI: A Comprehensive Corpus For Sentiment Analysis In Bangla Regional Languages
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于情感分析任务，旨在解决孟加拉语地区方言数据不足的问题。通过构建ANUBHUTI数据集，实现对四种方言的多类别主题和多标签情感标注。**

- **链接: [http://arxiv.org/pdf/2506.21686v1](http://arxiv.org/pdf/2506.21686v1)**
...
>
---
#### [new 086] Evaluation of LLM-based Strategies for the Extraction of Food Product Information from Online Shops
- **分类: cs.CL; cs.IR; cs.LG**

- **简介: 该论文属于信息提取任务，旨在解决从在线商店食品页面中自动提取结构化信息的问题。通过比较直接和间接的LLM方法，评估其准确性、效率和成本。**

- **链接: [http://arxiv.org/pdf/2506.21585v1](http://arxiv.org/pdf/2506.21585v1)**
...
>
---
#### [new 093] Refining Czech GEC: Insights from a Multi-Experiment Approach
- **分类: cs.CL**

- **简介: 该论文属于语法错误纠正任务，旨在提升捷克语GEC系统的性能。通过多实验方法优化模型结构与数据生成策略，提高了纠错效果与效率。**

- **链接: [http://arxiv.org/pdf/2506.22402v1](http://arxiv.org/pdf/2506.22402v1)**
...
>
---
#### [new 105] COOCO -- Common Objects Out-of-Context -- Semantic Violation in Scenes: Investigating Multimodal Context in Referential Communication
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 106] Can Video Large Multimodal Models Think Like Doubters-or Double-Down: A Study on Defeasible Video Entailment
...
>
---
#### [new 107] The Automated LLM Speedrunning Benchmark: Reproducing NanoGPT Improvements
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于AI科学再现任务，旨在评估LLM复现研究成果的能力。通过构建基准测试，发现当前模型在已有创新复现上存在困难。**

- **链接: [http://arxiv.org/pdf/2506.22419v1](http://arxiv.org/pdf/2506.22419v1)**
...
>
---
#### [new 108] Robust and Efficient Autoregressive Speech Synthesis with Dynamic Chunk-wise Prediction Policy
...
>
---
#### [new 109] ARAG: Agentic Retrieval Augmented Generation for Personalized Recommendation
- **分类: cs.IR; cs.AI; cs.CL; cs.MA; I.2.11; I.2.7; H.3.3**

- **简介: 该论文属于个性化推荐任务，旨在解决动态场景下用户偏好捕捉不足的问题。提出ARAG框架，通过多智能体协作提升推荐效果。**

- **链接: [http://arxiv.org/pdf/2506.21931v1](http://arxiv.org/pdf/2506.21931v1)**
...
>
---
#### [new 110] GenEscape: Hierarchical Multi-Agent Generation of Escape Room Puzzles
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 113] CitySim: Modeling Urban Behaviors and City Dynamics with Large-Scale LLM-Driven Agent Simulation
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出CitySim，用于模拟城市中人类行为与动态。属于城市行为建模任务，解决传统方法难以模拟复杂意图和适应行为的问题，通过大语言模型驱动的智能体实现更真实的模拟。**

- **链接: [http://arxiv.org/pdf/2506.21805v1](http://arxiv.org/pdf/2506.21805v1)**

> **作者:** Nicolas Bougie; Narimasa Watanabe
>
> **摘要:** Modeling human behavior in urban environments is fundamental for social science, behavioral studies, and urban planning. Prior work often rely on rigid, hand-crafted rules, limiting their ability to simulate nuanced intentions, plans, and adaptive behaviors. Addressing these challenges, we envision an urban simulator (CitySim), capitalizing on breakthroughs in human-level intelligence exhibited by large language models. In CitySim, agents generate realistic daily schedules using a recursive value-driven approach that balances mandatory activities, personal habits, and situational factors. To enable long-term, lifelike simulations, we endow agents with beliefs, long-term goals, and spatial memory for navigation. CitySim exhibits closer alignment with real humans than prior work, both at micro and macro levels. Additionally, we conduct insightful experiments by modeling tens of thousands of agents and evaluating their collective behaviors under various real-world scenarios, including estimating crowd density, predicting place popularity, and assessing well-being. Our results highlight CitySim as a scalable, flexible testbed for understanding and forecasting urban phenomena.
>
---
#### [new 114] Towards Fair Rankings: Leveraging LLMs for Gender Bias Detection and Measurement
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决性别偏见检测与评估问题。通过引入LLM构建新的公平性度量CWEx，并构建标注数据集MSMGenderBias以提升排名系统的公平性。**

- **链接: [http://arxiv.org/pdf/2506.22372v1](http://arxiv.org/pdf/2506.22372v1)**
...
>
---
#### [replaced 002] ACORD: An Expert-Annotated Retrieval Dataset for Legal Contract Drafting
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2501.06582v3](http://arxiv.org/pdf/2501.06582v3)**
...
>
---
#### [replaced 003] Collective Reasoning Among LLMs: A Framework for Answer Validation Without Ground Truth
- **分类: stat.AP; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.20758v2](http://arxiv.org/pdf/2502.20758v2)**

> **作者:** Seyed Pouyan Mousavi Davoudi; Amin Gholami Davodi; Alireza Amiri-Margavi; Mahdi Jafari
>
> **备注:** 7pages
>
...
>
---
#### [replaced 014] Leveraging Online Olympiad-Level Math Problems for LLMs Training and Contamination-Resistant Evaluation
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.14275v2](http://arxiv.org/pdf/2501.14275v2)**
...
>
---
#### [replaced 020] Robust Detection of Watermarks for Large Language Models Under Human Edits
- **分类: stat.ME; cs.CL; cs.LG; math.ST; stat.ML; stat.TH**

- **链接: [http://arxiv.org/pdf/2411.13868v2](http://arxiv.org/pdf/2411.13868v2)**
...
>
---
#### [replaced 021] Llama See, Llama Do: A Mechanistic Perspective on Contextual Entrainment and Distraction in LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.09338v2](http://arxiv.org/pdf/2505.09338v2)**
...
>
---
#### [replaced 022] Bias-Augmented Consistency Training Reduces Biased Reasoning in Chain-of-Thought
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2403.05518v3](http://arxiv.org/pdf/2403.05518v3)**
...
>
---
#### [replaced 031] Introducing MAPO: Momentum-Aided Gradient Descent Prompt Optimization
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.19499v3](http://arxiv.org/pdf/2410.19499v3)**
...
>
---
#### [replaced 035] End-to-End Long Document Summarization using Gradient Caching
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.01805v2](http://arxiv.org/pdf/2501.01805v2)**

> **作者:** Rohit Saxena; Hao Tang; Frank Keller
>
> **备注:** Accepted to Transactions of the Association for Computational Linguistics (TACL 2025); Pre MIT Press version
>
...
>
---
#### [replaced 036] LLM as GNN: Graph Vocabulary Learning for Text-Attributed Graph Foundation Models
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.03313v2](http://arxiv.org/pdf/2503.03313v2)**
...
>
---
#### [replaced 037] Plant in Cupboard, Orange on Rably, Inat Aphone. Benchmarking Incremental Learning of Situation and Language Model using a Text-Simulated Situated Environment
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.11733v3](http://arxiv.org/pdf/2502.11733v3)**

> **作者:** Jonathan Jordan; Sherzod Hakimov; David Schlangen
>
> **备注:** Accepted at The 28th International Conference of Text, Speech and Dialogue (TSD2025)
>
...
>
---
#### [replaced 038] STAIR: Improving Safety Alignment with Introspective Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.02384v2](http://arxiv.org/pdf/2502.02384v2)**
...
>
> **摘要:** Ensuring the safety and harmlessness of Large Language Models (LLMs) has become equally critical as their performance in applications. However, existing safety alignment methods typically suffer from safety-performance trade-offs and the susceptibility to jailbreak attacks, primarily due to their reliance on direct refusals for malicious queries. In this paper, we propose STAIR, a novel framework that integrates SafeTy Alignment with Itrospective Reasoning. We enable LLMs to identify safety risks through step-by-step analysis by self-improving chain-of-thought (CoT) reasoning with safety awareness. STAIR first equips the model with a structured reasoning capability and then advances safety alignment via iterative preference optimization on step-level reasoning data generated using our newly proposed Safety-Informed Monte Carlo Tree Search (SI-MCTS). We further train a process reward model on this data to guide test-time searches for improved responses. Extensive experiments show that STAIR effectively mitigates harmful outputs while better preserving helpfulness, compared to instinctive alignment strategies. With test-time scaling, STAIR achieves a safety performance comparable to Claude-3.5 against popular jailbreak attacks. Relevant resources in this work are available at https://github.com/thu-ml/STAIR.
>
---
#### [replaced 039] Eye of Judgement: Dissecting the Evaluation of Russian-speaking LLMs with POLLUX
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24616v3](http://arxiv.org/pdf/2505.24616v3)**
...
>
---
#### [replaced 040] Oldies but Goldies: The Potential of Character N-grams for Romanian Texts
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.15650v2](http://arxiv.org/pdf/2506.15650v2)**

> **作者:** Dana Lupsa; Sanda-Maria Avram; Radu Lupsa
>
...
>
---
#### [replaced 049] ScienceBoard: Evaluating Multimodal Autonomous Agents in Realistic Scientific Workflows
- **分类: cs.AI; cs.CL; cs.CV; cs.HC**
...
>
---
#### [replaced 050] EUR-USD Exchange Rate Forecasting Based on Information Fusion with Large Language Models and Deep Learning Methods
- **分类: q-fin.CP; cs.AI; cs.CE; cs.CL**

- **链接: [http://arxiv.org/pdf/2408.13214v2](http://arxiv.org/pdf/2408.13214v2)**
...
>
---
#### [replaced 054] Time is On My Side: Dynamics of Talk-Time Sharing in Video-chat Conversations
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.20474v2](http://arxiv.org/pdf/2506.20474v2)**
...
>
---
#### [replaced 055] ChunkKV: Semantic-Preserving KV Cache Compression for Efficient Long-Context LLM Inference
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.00299v3](http://arxiv.org/pdf/2502.00299v3)**
...
>
---
#### [replaced 056] MMBoundary: Advancing MLLM Knowledge Boundary Awareness through Reasoning Step Confidence Calibration
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23224v3](http://arxiv.org/pdf/2505.23224v3)**
