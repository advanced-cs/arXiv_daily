...
#### [new 001] Type-Less yet Type-Aware Inductive Link Prediction with Pretrained Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识图谱的链接预测任务，解决新实体出现时类型信息不足的问题。通过引入预训练语言模型增强节点表示，提出TyleR方法提升预测效果。**

- **链接: [http://arxiv.org/pdf/2509.26224v1](http://arxiv.org/pdf/2509.26224v1)**
...
>
> **摘要:** Factuality assesses the extent to which a language utterance relates to real-world information; it determines whether utterances correspond to facts, possibilities, or imaginary situations, and as such, it is instrumental for fact checking. Factuality is a complex notion that relies on multiple linguistic signals, and has been studied in various disciplines. We present a complex, multi-faceted annotation scheme of factuality that combines concepts from a variety of previous works. We developed the scheme for Hebrew, but we trust that it can be adapted to other languages. We also present a set of almost 5,000 sentences in the domain of parliamentary discourse that we manually annotated according to this scheme. We report on inter-annotator agreement, and experiment with various approaches to automatically predict (some features of) the scheme, in order to extend the annotation to a large corpus.
>
---
#### [new 003] Generative Value Conflicts Reveal LLM Priorities
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于模型对齐任务，旨在解决LLM在价值冲突下的优先级问题。通过生成冲突场景评估模型价值观，发现开放任务中模型更倾向个人价值，并提出系统提示提升对齐效果。**

- **链接: [http://arxiv.org/pdf/2509.25369v1](http://arxiv.org/pdf/2509.25369v1)**
...
>
---
#### [new 004] CliniBench: A Clinical Outcome Prediction Benchmark for Generative and Encoder-Based Language Models
- **分类: cs.CL**

- **简介: 该论文属于医疗诊断预测任务，旨在比较生成模型与编码器模型在临床数据中的表现，验证编码器模型更优，并探索增强策略提升生成模型效果。**

- **链接: [http://arxiv.org/pdf/2509.26136v1](http://arxiv.org/pdf/2509.26136v1)**
...
>
---
#### [new 005] Text-Based Approaches to Item Alignment to Content Standards in Large-Scale Reading & Writing Tests
- **分类: cs.CL**

- **简介: 该论文属于自动化测试题目对齐任务，旨在解决人工对齐耗时且主观的问题。通过微调小语言模型进行项目与内容标准的自动对齐，并比较不同模型性能。**

- **链接: [http://arxiv.org/pdf/2509.26431v1](http://arxiv.org/pdf/2509.26431v1)**
...
>
---
#### [new 006] Limited Preference Data? Learning Better Reward Model with Latent Space Synthesis
- **分类: cs.CL**

- **简介: 该论文属于奖励模型优化任务，解决偏好数据稀缺问题。通过在潜在空间合成偏好数据，提升奖励模型性能，方法更高效且效果更好。**

- **链接: [http://arxiv.org/pdf/2509.26074v1](http://arxiv.org/pdf/2509.26074v1)**
...
>
---
#### [new 007] BatonVoice: An Operationalist Framework for Enhancing Controllable Speech Synthesis with Linguistic Intelligence from LLMs
- **分类: cs.CL**

- **简介: 该论文属于语音合成任务，解决如何有效利用LLM的语言智能实现可控语音生成。提出BatonVoice框架，将指令理解与语音生成分离，提升控制能力与跨语言泛化性能。**

- **链接: [http://arxiv.org/pdf/2509.26514v1](http://arxiv.org/pdf/2509.26514v1)**
...
>
> **摘要:** The rise of Large Language Models (LLMs) is reshaping multimodel models, with speech synthesis being a prominent application. However, existing approaches often underutilize the linguistic intelligence of these models, typically failing to leverage their powerful instruction-following capabilities. This limitation hinders the model's ability to follow text instructions for controllable Text-to-Speech~(TTS). To address this, we propose a new paradigm inspired by ``operationalism'' that decouples instruction understanding from speech generation. We introduce BatonVoice, a framework where an LLM acts as a ``conductor'', understanding user instructions and generating a textual ``plan'' -- explicit vocal features (e.g., pitch, energy). A separate TTS model, the ``orchestra'', then generates the speech from these features. To realize this component, we develop BatonTTS, a TTS model trained specifically for this task. Our experiments demonstrate that BatonVoice achieves strong performance in controllable and emotional speech synthesis, outperforming strong open- and closed-source baselines. Notably, our approach enables remarkable zero-shot cross-lingual generalization, accurately applying feature control abilities to languages unseen during post-training. This demonstrates that objectifying speech into textual vocal features can more effectively unlock the linguistic intelligence of LLMs.
>
---
#### [new 008] Overthinking Reduction with Decoupled Rewards and Curriculum Data Scheduling
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，解决模型“过度思考”问题，通过新框架DECS减少冗余推理，提升效率且不损失性能。**

- **链接: [http://arxiv.org/pdf/2509.25827v1](http://arxiv.org/pdf/2509.25827v1)**
...
>
---
#### [new 016] The Silent Judge: Unacknowledged Shortcut Bias in LLM-as-a-Judge
- **分类: cs.CL**

- **简介: 该论文属于模型评估任务，研究LLM作为评判者时存在的隐性偏见问题。通过实验发现其受提示中的表面线索影响，导致判断不准确。**

- **链接: [http://arxiv.org/pdf/2509.26072v1](http://arxiv.org/pdf/2509.26072v1)**
...
>
---
#### [new 017] Automatic Fact-checking in English and Telugu
- **分类: cs.CL**

- **简介: 该论文属于事实核查任务，旨在解决虚假信息验证难题。通过构建双语数据集并测试大语言模型的分类与解释能力，提升多语言环境下的事实核查效果。**

- **链接: [http://arxiv.org/pdf/2509.26415v1](http://arxiv.org/pdf/2509.26415v1)**

> **作者:** Ravi Kiran Chikkala; Tatiana Anikina; Natalia Skachkova; Ivan Vykopal; Rodrigo Agerri; Josef van Genabith
>
> **摘要:** False information poses a significant global challenge, and manually verifying claims is a time-consuming and resource-intensive process. In this research paper, we experiment with different approaches to investigate the effectiveness of large language models (LLMs) in classifying factual claims by their veracity and generating justifications in English and Telugu. The key contributions of this work include the creation of a bilingual English-Telugu dataset and the benchmarking of different veracity classification approaches based on LLMs.
>
---
#### [new 018] Latent Thinking Optimization: Your Latent Reasoning Language Model Secretly Encodes Reward Signals in its Latent Thoughts
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决LLM在潜空间中思考不可解释和难以监督的问题。通过构建潜奖励模型优化潜思考过程，提升模型推理准确性与可靠性。**

- **链接: [http://arxiv.org/pdf/2509.26314v1](http://arxiv.org/pdf/2509.26314v1)**
...
>
---
#### [new 021] Calibrating Verbalized Confidence with Self-Generated Distractors
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型置信度校准任务，旨在解决模型输出的置信度不准确问题。通过引入DINCO方法，提升模型置信度估计的可靠性。**

- **链接: [http://arxiv.org/pdf/2509.25532v1](http://arxiv.org/pdf/2509.25532v1)**
...
>
---
#### [new 027] The Hunger Game Debate: On the Emergence of Over-Competition in Multi-Agent Systems
- **分类: cs.CL**

- **简介: 该论文属于多智能体系统研究，探讨竞争导致的过激行为问题。通过实验框架HATE分析竞争对协作与任务的影响，并提出优化方案。**

- **链接: [http://arxiv.org/pdf/2509.26126v1](http://arxiv.org/pdf/2509.26126v1)**
...
>
---
#### [new 029] Bringing Emerging Architectures to Sequence Labeling in NLP
- **分类: cs.CL**

- **简介: 该论文研究将新兴架构应用于NLP序列标注任务，探讨其在不同语言和复杂任务中的适应性与效果。**

- **链接: [http://arxiv.org/pdf/2509.25918v1](http://arxiv.org/pdf/2509.25918v1)**
...
>
---
#### [new 030] Vocabulary Customization for Efficient Domain-Specific LLM Deployment
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决领域特定语言模型部署中的词汇不匹配问题，通过扩展预训练词汇表提升效率与性能。**

- **链接: [http://arxiv.org/pdf/2509.26124v1](http://arxiv.org/pdf/2509.26124v1)**
...
>
---
#### [new 041] End-to-End Aspect-Guided Review Summarization at Scale
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于产品评论摘要任务，旨在生成基于用户反馈的简洁、可解释的评论摘要。通过结合方面情感分析与引导式摘要，提升摘要质量与实用性。**

- **链接: [http://arxiv.org/pdf/2509.26103v1](http://arxiv.org/pdf/2509.26103v1)**
...
>
---
#### [new 047] DyFlow: Dynamic Workflow Framework for Agentic Reasoning
- **分类: cs.CL**

- **简介: 该论文属于智能代理系统任务，旨在解决复杂推理任务中流程设计不足的问题。提出DyFlow框架，动态生成和调整推理流程，提升跨任务泛化能力。**

- **链接: [http://arxiv.org/pdf/2509.26062v1](http://arxiv.org/pdf/2509.26062v1)**
...
>
---
#### [new 049] dParallel: Learnable Parallel Decoding for dLLMs
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决dLLMs并行解码效率低的问题。通过引入dParallel方法，显著减少解码步骤，提升速度。**

- **链接: [http://arxiv.org/pdf/2509.26488v1](http://arxiv.org/pdf/2509.26488v1)**
...
>
---
#### [new 050] Aligning Multilingual Reasoning with Verifiable Semantics from a High-Resource Expert Model
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多语言推理任务，旨在解决LLM在非英语语言中性能不足的问题。通过引入基于语义验证的强化学习框架，提升模型跨语言推理能力。**

- **链接: [http://arxiv.org/pdf/2509.25543v1](http://arxiv.org/pdf/2509.25543v1)**
...
>
---
#### [new 056] Adaptive Planning for Multi-Attribute Controllable Summarization with Monte Carlo Tree Search
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多属性可控摘要任务，解决属性间依赖导致的约束难以满足问题。提出PACO框架，利用MCTS自适应规划属性控制顺序，实现高效多属性控制。**

- **链接: [http://arxiv.org/pdf/2509.26435v1](http://arxiv.org/pdf/2509.26435v1)**
...
>
---
#### [new 057] OceanGym: A Benchmark Environment for Underwater Embodied Agents
...
>
---
#### [new 058] RAGferee: Building Contextual Reward Models for Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于RAG任务，解决现有奖励模型在判断生成回答的准确性、相关性等方面不足的问题。通过构建专用偏好数据集并训练上下文感知的奖励模型，提升RAG系统的性能。**

- **链接: [http://arxiv.org/pdf/2509.26011v1](http://arxiv.org/pdf/2509.26011v1)**
...
>
---
#### [new 062] ReTAG: Retrieval-Enhanced, Topic-Augmented Graph-Based Global Sensemaking
- **分类: cs.CL**

- **简介: 该论文属于问答任务，解决全局理解问题。提出ReTAG框架，通过检索和主题增强构建子图，提升回答质量并降低推理时间。**

- **链接: [http://arxiv.org/pdf/2509.25814v1](http://arxiv.org/pdf/2509.25814v1)**
...
>
---
#### [new 069] The Rise of AfricaNLP: Contributions, Contributors, and Community Impact (2005-2025)
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理领域，旨在分析非洲NLP的发展历程、贡献及社区影响，通过量化研究揭示其演进与关键参与者。**

- **链接: [http://arxiv.org/pdf/2509.25477v1](http://arxiv.org/pdf/2509.25477v1)**
...
>
---
#### [new 072] Finetune Once: Decoupling General & Domain Learning with Dynamic Boosted Annealing
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理领域，解决大模型微调效率低的问题。提出DBA方法，通过动态调整训练步骤提升性能，减少计算资源消耗。**

- **链接: [http://arxiv.org/pdf/2509.26242v1](http://arxiv.org/pdf/2509.26242v1)**
...
>
---
#### [new 073] Personalized Scientific Figure Caption Generation: An Empirical Study on Author-Specific Writing Style Transfer
- **分类: cs.CL; cs.CV**

- **简介: 该论文属于科学图表标题生成任务，旨在解决如何根据作者风格生成个性化标题的问题。通过利用作者资料和元数据，提升模型的个性化能力，同时平衡风格匹配与标题质量。**

- **链接: [http://arxiv.org/pdf/2509.25817v1](http://arxiv.org/pdf/2509.25817v1)**
...
>
---
#### [new 074] IMProofBench: Benchmarking AI on Research-Level Mathematical Proof Generation
- **分类: cs.CL**

- **简介: 该论文属于数学证明生成任务，旨在评估大语言模型在研究级数学问题上的表现。针对现有基准不足，作者构建了IMProofBench，包含39个专家设计的问题，支持人工与自动评估，并模拟真实研究环境进行测试。**

- **链接: [http://arxiv.org/pdf/2509.26076v1](http://arxiv.org/pdf/2509.26076v1)**
...
>
---
#### [new 080] MGen: Millions of Naturally Occurring Generics in Context
- **分类: cs.CL**

- **简介: 该论文提出MGen数据集，包含400万条自然发生的泛化句，用于研究泛化表达的计算分析，解决泛化句数据不足的问题。**

- **链接: [http://arxiv.org/pdf/2509.26160v1](http://arxiv.org/pdf/2509.26160v1)**
...
>
---
#### [new 086] Self-Rewarding Rubric-Based Reinforcement Learning for Open-Ended Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于开放性推理任务，旨在提升语言模型的推理能力。通过自评机制和少量教师数据，实现高效训练并超越现有模型表现。**

- **链接: [http://arxiv.org/pdf/2509.25534v1](http://arxiv.org/pdf/2509.25534v1)**
...
>
---
#### [new 099] IRIS: Intrinsic Reward Image Synthesis
- **分类: cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文属于文本到图像生成任务，解决缺乏人类偏好数据的问题。通过内在奖励机制提升模型生成质量。**

- **链接: [http://arxiv.org/pdf/2509.25562v1](http://arxiv.org/pdf/2509.25562v1)**
...
>
---
#### [new 100] Probing the Critical Point (CritPt) of AI Reasoning: a Frontier Physics Research Benchmark
- **分类: cs.AI; cond-mat.other; cs.CL; hep-th; quant-ph**

- **简介: 该论文提出CritPt基准，用于评估AI在前沿物理研究中的推理能力，解决AI与物理研究需求不匹配的问题，通过设计复杂任务测试模型表现。**

- **链接: [http://arxiv.org/pdf/2509.26574v1](http://arxiv.org/pdf/2509.26574v1)**
...
>
---
#### [new 101] Causal Autoencoder-like Generation of Feedback Fuzzy Cognitive Maps with an LLM Agent
- **分类: cs.AI; cs.CL; cs.HC; cs.IR**

- **简介: 该论文属于解释性AI任务，旨在通过LLM生成可解释的反馈模糊认知图（FCM），解决黑箱模型难以理解的问题。工作包括利用LLM实现FCM的文本编码与重建。**

- **链接: [http://arxiv.org/pdf/2509.25593v1](http://arxiv.org/pdf/2509.25593v1)**
...
>
---
#### [new 102] STAC: When Innocent Tools Form Dangerous Chains to Jailbreak LLM Agents
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于AI安全领域，解决LLM代理工具使用中的链式攻击问题。提出STAC框架，通过多步骤工具调用实现隐蔽攻击，验证了现有代理的高脆弱性，并提出新的防御方法。**

- **链接: [http://arxiv.org/pdf/2509.25624v1](http://arxiv.org/pdf/2509.25624v1)**
...
>
---
#### [new 103] Fingerprinting LLMs via Prompt Injection
- **分类: cs.CR; cs.CL**

- **简介: 该论文属于模型溯源任务，旨在解决后处理导致的模型来源难以识别问题。提出LLMPrint方法，通过提示注入构建鲁棒指纹，实现高效准确的模型验证。**

- **链接: [http://arxiv.org/pdf/2509.25448v1](http://arxiv.org/pdf/2509.25448v1)**
...
>
---
#### [new 104] VLM-FO1: Bridging the Gap Between High-Level Reasoning and Fine-Grained Perception in VLMs
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于视觉语言模型任务，解决高阶推理与细粒度感知不匹配的问题。提出VLM-FO1框架，通过特征检索提升视觉区域理解能力。**

- **链接: [http://arxiv.org/pdf/2509.25916v1](http://arxiv.org/pdf/2509.25916v1)**

> **作者:** Peng Liu; Haozhan Shen; Chunxin Fang; Zhicheng Sun; Jiajia Liao; Tiancheng Zhao
>
> **备注:** 22 pages
>
> **摘要:** Vision-Language Models (VLMs) excel at high-level scene understanding but falter on fine-grained perception tasks requiring precise localization. This failure stems from a fundamental mismatch, as generating exact numerical coordinates is a challenging task for language-centric architectures. In this paper, we introduce VLM-FO1, a novel framework that overcomes this limitation by reframing object-centric perception from a brittle coordinate generation problem into a robust feature retrieval task. Our method operates as a plug-and-play module that integrates with any pre-trained VLM. It leverages a Hybrid Fine-grained Region Encoder (HFRE), featuring a dual vision encoder, to generate powerful region tokens rich in both semantic and spatial detail. A token-based referencing system then enables the LLM to seamlessly reason about and ground language in these specific visual regions. Experiments show that VLM-FO1 achieves state-of-the-art performance across a diverse suite of benchmarks, demonstrating exceptional capabilities in object grounding, region generational understanding, and visual region reasoning. Crucially, our two-stage training strategy ensures that these perception gains are achieved without compromising the base model's general visual understanding capabilities. VLM-FO1 establishes an effective and flexible paradigm for building perception-aware VLMs, bridging the gap between high-level reasoning and fine-grained visual grounding.
>
---
#### [new 105] Game-Time: Evaluating Temporal Dynamics in Spoken Language Models
- **分类: eess.AS; cs.AI; cs.CL**

- **简介: 该论文属于对话系统任务，旨在解决语音语言模型在时间动态性上的不足。通过构建Game-Time基准，评估模型在时间管理与同步响应方面的能力。**

- **链接: [http://arxiv.org/pdf/2509.26388v1](http://arxiv.org/pdf/2509.26388v1)**
...
>
---
#### [new 106] Rotation Control Unlearning: Quantifying and Controlling Continuous Unlearning for LLM with The Cognitive Rotation Space
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于机器学习安全任务，解决连续删除数据时模型性能下降问题。提出RCU方法，通过旋转空间控制遗忘程度，减少累积误差。**

- **链接: [http://arxiv.org/pdf/2509.25743v1](http://arxiv.org/pdf/2509.25743v1)**
...
>
---
#### [new 107] A Multimodal LLM Approach for Visual Question Answering on Multiparametric 3D Brain MRI
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于医学视觉问答任务，旨在解决3D脑部MRI多模态数据的问答问题。提出mpLLM模型，融合多模态信息并生成医学相关问答数据。**

- **链接: [http://arxiv.org/pdf/2509.25889v1](http://arxiv.org/pdf/2509.25889v1)**
...
>
---
#### [new 120] Your Agent May Misevolve: Emergent Risks in Self-evolving LLM Agents
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于AI安全研究，探讨自进化大语言模型代理的潜在风险，分析模型、记忆、工具和流程中的意外演化问题，提出安全改进方向。**

- **链接: [http://arxiv.org/pdf/2509.26354v1](http://arxiv.org/pdf/2509.26354v1)**
...
>
---
#### [new 121] A Formal Comparison Between Chain-of-Thought and Latent Thought
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，比较Chain-of-Thought与Latent Thought的推理机制，分析其效率与适用场景，为模型选择提供指导。**

- **链接: [http://arxiv.org/pdf/2509.25239v1](http://arxiv.org/pdf/2509.25239v1)**
...
>
> **摘要:** Reinforcement Learning (RL) has shown remarkable success in enhancing the reasoning capabilities of Large Language Models (LLMs). Process-Supervised RL (PSRL) has emerged as a more effective paradigm compared to outcome-based RL. However, existing PSRL approaches suffer from limited exploration efficiency, both in terms of branching positions and sampling. In this paper, we introduce a novel PSRL framework (AttnRL), which enables efficient exploration for reasoning models. Motivated by preliminary observations that steps exhibiting high attention scores correlate with reasoning behaviors, we propose to branch from positions with high values. Furthermore, we develop an adaptive sampling strategy that accounts for problem difficulty and historical batch size, ensuring that the whole training batch maintains non-zero advantage values. To further improve sampling efficiency, we design a one-step off-policy training pipeline for PSRL. Extensive experiments on multiple challenging mathematical reasoning benchmarks demonstrate that our method consistently outperforms prior approaches in terms of performance and sampling and training efficiency.
>
---
#### [new 129] Spectral Logit Sculpting: Adaptive Low-Rank Logit Transformation for Controlled Text Generation
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于文本生成任务，旨在解决LLM推理可靠性问题。提出SLS方法，通过动态调整logits提升生成质量，无需更新模型参数。**

- **链接: [http://arxiv.org/pdf/2509.25204v1](http://arxiv.org/pdf/2509.25204v1)**
...
>
---
#### [new 130] Lita: Light Agent Uncovers the Agentic Coding Capabilities of LLMs
- **分类: cs.AI; cs.CL; cs.LG; cs.PL; cs.SE**

- **简介: 该论文属于编程任务，旨在解决代码代理设计复杂、依赖人工干预的问题。提出Lita框架，实现轻量自动化评估，提升效率并揭示LLMs真实编码能力。**

- **链接: [http://arxiv.org/pdf/2509.25873v1](http://arxiv.org/pdf/2509.25873v1)**

> **作者:** Hankun Dai; Maoquan Wang; Mengnan Qi; Yikai Zhang; Zijian Jin; Yongqiang Yao; Yufan Huang; Shengyu Fu; Elsie Nallipogu
>
> **摘要:** Large language models (LLMs) are increasingly being applied to programming tasks, ranging from single-turn code completion to autonomous agents. Current code agent designs frequently depend on complex, hand-crafted workflows and tool sets. However, this reliance on elaborate scaffolding presents several challenges: agent performance becomes overly dependent on prompt tuning and custom design choices, heavy human intervention obscures a model's true underlying capabilities, and intricate pipelines are costly to build and maintain. Furthermore, optimizing complex task prompts increases the risk of data leakage. Currently, when introducing new models, LLM providers like OpenAI and Anthropic often publish benchmark scores to demonstrate their models' coding proficiency, but keep their proprietary evaluation frameworks confidential. To address these limitations, we introduce Lita (Lite Agent), which operationalizes liteness, a principle of minimizing manual design while retaining the essential elements of a fully autonomous agent. Lita enables a more faithful and unified evaluation without elaborate scaffolding. Experiments on the Aider Polyglot and SWE-Bench with frontier models demonstrate that Lita achieves competitive or superior performance compared to workflow-based and agentic baselines. Crucially, Lita also consumes fewer tokens and requires significantly less design effort. Our results suggest that Lita is sufficient to reveal the underlying coding competence of modern LLMs. Finally, we propose the Agent Complexity Law: the performance gap between agents of varying complexity, from simple to sophisticated designs, will shrink as the core model improves, ultimately converging to a negligible difference.
>
---
#### [new 131] DeepJSONEval: Benchmarking Complex Nested JSON Data Mining for Large Language Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于结构化数据生成任务，旨在解决LLMs在复杂嵌套JSON数据提取与理解上的不足，提出DeepJSONEval基准测试以评估模型能力。**

- **链接: [http://arxiv.org/pdf/2509.25922v1](http://arxiv.org/pdf/2509.25922v1)**
...
>
---
#### [new 134] Adaptive Test-Time Reasoning via Reward-Guided Dual-Phase Search
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于语言模型推理任务，解决传统方法效率低的问题，通过分阶段搜索和动态预算分配提升准确性和计算效率。**

- **链接: [http://arxiv.org/pdf/2509.25420v1](http://arxiv.org/pdf/2509.25420v1)**
...
>
---
#### [new 135] Ferret-UI Lite: Lessons from Building Small On-Device GUI Agents
- **分类: cs.CV; cs.CL; cs.LG**

- **简介: 该论文属于GUI交互任务，旨在解决小模型在设备端有效操作GUI的问题。通过构建小型GUI代理Ferret-UI Lite，结合多种优化技术提升性能。**
...
>
---
#### [new 136] Toxicity in Online Platforms and AI Systems: A Survey of Needs, Challenges, Mitigations, and Future Directions
...
>
---
#### [new 137] The AI Productivity Index (APEX)
- **分类: econ.GN; cs.AI; cs.CL; cs.HC; q-fin.EC**

- **简介: 该论文提出APEX，一个评估前沿AI模型执行高经济价值知识工作的基准。解决AI研究中缺乏经济相关能力测试的问题，涵盖四个领域，评估23个模型表现。**

- **链接: [http://arxiv.org/pdf/2509.25721v1](http://arxiv.org/pdf/2509.25721v1)**
...
>
---
#### [new 138] Rethinking Parameter Sharing for LLM Fine-Tuning with Multiple LoRAs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，解决多LoRA参数共享问题。提出ALoRA和Fed-ALoRA，通过共享B矩阵提升多任务和联邦学习性能。**

- **链接: [http://arxiv.org/pdf/2509.25414v1](http://arxiv.org/pdf/2509.25414v1)**
...
>
---
#### [new 139] Can VLM Pseudo-Labels Train a Time-Series QA Model That Outperforms the VLM?
...
>
---
#### [new 140] Importance Sampling for Multi-Negative Multimodal Direct Preference Optimization
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [new 143] FinCap: Topic-Aligned Captions for Short-Form Financial YouTube Videos
...
>
---
#### [replaced 006] VerlTool: Towards Holistic Agentic Reinforcement Learning with Tool Use
- **分类: cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.01055v2](http://arxiv.org/pdf/2509.01055v2)**
...
>
---
#### [replaced 007] GIM: Improved Interpretability for Large Language Models
- **分类: cs.CL; cs.LG; 68T07; I.2.0; I.2.7**

- **链接: [http://arxiv.org/pdf/2505.17630v2](http://arxiv.org/pdf/2505.17630v2)**
...
>
---
#### [replaced 008] Static Word Embeddings for Sentence Semantic Representation
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.04624v2](http://arxiv.org/pdf/2506.04624v2)**
...
>
---
#### [replaced 009] Regularizing Learnable Feature Extraction for Automatic Speech Recognition
- **分类: eess.AS; cs.CL; cs.LG; cs.SD**
...
>
---
#### [replaced 010] FAN: Fourier Analysis Networks
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2410.02675v5](http://arxiv.org/pdf/2410.02675v5)**
...
>
---
#### [replaced 014] A quantitative analysis of semantic information in deep representations of text and images
- **分类: cs.CL; cs.LG; physics.comp-ph**

- **链接: [http://arxiv.org/pdf/2505.17101v2](http://arxiv.org/pdf/2505.17101v2)**
...
>
---
#### [replaced 019] Mind the Value-Action Gap: Do LLMs Act in Alignment with Their Values?
- **分类: cs.HC; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2501.15463v4](http://arxiv.org/pdf/2501.15463v4)**
...
>
---
#### [replaced 020] Using Knowledge Graphs to harvest datasets for efficient CLIP model training
- **分类: cs.CV; cs.CL; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.02746v3](http://arxiv.org/pdf/2505.02746v3)**
...
>
---
#### [replaced 021] Explore-Execute Chain: Towards an Efficient Structured Reasoning Paradigm
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **链接: [http://arxiv.org/pdf/2509.23946v2](http://arxiv.org/pdf/2509.23946v2)**
...
>
---
#### [replaced 022] Wolf Hidden in Sheep's Conversations: Toward Harmless Data-Based Backdoor Attacks for Jailbreaking Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17601v4](http://arxiv.org/pdf/2505.17601v4)**
...
>
---
#### [replaced 025] VSSFlow: Unifying Video-conditioned Sound and Speech Generation via Joint Learning
...
>
---
#### [replaced 026] The Impact of Language Mixing on Bilingual LLM Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.15849v2](http://arxiv.org/pdf/2507.15849v2)**
...
>
---
#### [replaced 027] Collaborative Gym: A Framework for Enabling and Evaluating Human-Agent Collaboration
- **分类: cs.AI; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2412.15701v4](http://arxiv.org/pdf/2412.15701v4)**
...
>
---
#### [replaced 028] Object Detection with Multimodal Large Vision-Language Models: An In-depth Review
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19294v2](http://arxiv.org/pdf/2508.19294v2)**
...
>
---
#### [replaced 029] A Position Paper on the Automatic Generation of Machine Learning Leaderboards
- **分类: cs.CL; stat.ME**

- **链接: [http://arxiv.org/pdf/2505.17465v2](http://arxiv.org/pdf/2505.17465v2)**
...
>
---
#### [replaced 032] GraphSearch: An Agentic Deep Searching Workflow for Graph Retrieval-Augmented Generation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.22009v2](http://arxiv.org/pdf/2509.22009v2)**
...
>
---
#### [replaced 033] TableRAG: A Retrieval Augmented Generation Framework for Heterogeneous Document Reasoning
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2506.10380v2](http://arxiv.org/pdf/2506.10380v2)**

> **作者:** Xiaohan Yu; Pu Jian; Chong Chen
>
> **备注:** Accepted by EMNLP 2025. Codes are available at https://github.com/yxh-y/TableRAG/tree/main
>
> **摘要:** Retrieval-Augmented Generation (RAG) has demonstrated considerable effectiveness in open-domain question answering. However, when applied to heterogeneous documents, comprising both textual and tabular components, existing RAG approaches exhibit critical limitations. The prevailing practice of flattening tables and chunking strategies disrupts the intrinsic tabular structure, leads to information loss, and undermines the reasoning capabilities of LLMs in multi-hop, global queries. To address these challenges, we propose TableRAG, an SQL-based framework that unifies textual understanding and complex manipulations over tabular data. TableRAG iteratively operates in four steps: context-sensitive query decomposition, text retrieval, SQL programming and execution, and compositional intermediate answer generation. We also develop HeteQA, a novel benchmark designed to evaluate the multi-hop heterogeneous reasoning capabilities. Experimental results demonstrate that TableRAG consistently outperforms existing baselines on both public datasets and our HeteQA, establishing a new state-of-the-art for heterogeneous document question answering. We release TableRAG at https://github.com/yxh-y/TableRAG/tree/main.
>
---
#### [replaced 034] Agent-as-Judge for Factual Summarization of Long Narratives
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2501.09993v3](http://arxiv.org/pdf/2501.09993v3)**
...
>
---
#### [replaced 035] Aristotle: Mastering Logical Reasoning with A Logic-Complete Decompose-Search-Resolve Framework
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2412.16953v2](http://arxiv.org/pdf/2412.16953v2)**
...
>
---
#### [replaced 037] PAME-AI: Patient Messaging Creation and Optimization using Agentic AI
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.24263v2](http://arxiv.org/pdf/2509.24263v2)**
...
>
---
#### [replaced 038] SoMi-ToM: Evaluating Multi-Perspective Theory of Mind in Embodied Social Interactions
...
>
---
#### [replaced 039] Value Profiles for Encoding Human Variation
- **分类: cs.CL; cs.AI; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.15484v2](http://arxiv.org/pdf/2503.15484v2)**
...
>
---
#### [replaced 041] Watermark under Fire: A Robustness Evaluation of LLM Watermarking
- **分类: cs.CR; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.13425v4](http://arxiv.org/pdf/2411.13425v4)**

> **作者:** Jiacheng Liang; Zian Wang; Lauren Hong; Shouling Ji; Ting Wang
>
> **备注:** 25 pages. Accepted by The 2025 Conference on Empirical Methods in Natural Language Processing (EMNLP 2025)
>
...
>
---
#### [replaced 042] Where Fact Ends and Fairness Begins: Redefining AI Bias Evaluation through Cognitive Biases
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.05849v3](http://arxiv.org/pdf/2502.05849v3)**
...
>
---
#### [replaced 045] Structured Agent Distillation for Large Language Model
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.13820v2](http://arxiv.org/pdf/2505.13820v2)**
...
>
---
#### [replaced 046] BEDTime: A Unified Benchmark for Automatically Describing Time Series
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.05215v2](http://arxiv.org/pdf/2509.05215v2)**
...
>
---
#### [replaced 047] Experience-Guided Reflective Co-Evolution of Prompts and Heuristics for Automatic Algorithm Design
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.24509v2](http://arxiv.org/pdf/2509.24509v2)**
...
>
---
#### [replaced 048] Hardware-Aware Parallel Prompt Decoding for Memory-Efficient Acceleration of LLM Inference
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2405.18628v3](http://arxiv.org/pdf/2405.18628v3)**
...
>
---
#### [replaced 052] MindVL: Towards Efficient and Effective Training of Multimodal Large Language Models on Ascend NPUs
- **分类: cs.CV; cs.AI; cs.CL; eess.IV**

- **链接: [http://arxiv.org/pdf/2509.11662v3](http://arxiv.org/pdf/2509.11662v3)**
...
>
---
#### [replaced 056] AudioTrust: Benchmarking the Multifaceted Trustworthiness of Audio Large Language Models
...
>
---
#### [replaced 057] v1: Learning to Point Visual Tokens for Multimodal Grounded Reasoning
- **分类: cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18842v2](http://arxiv.org/pdf/2505.18842v2)**
...
>
---
#### [replaced 058] Resisting Contextual Interference in RAG via Parametric-Knowledge Reinforcement
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2506.05154v3](http://arxiv.org/pdf/2506.05154v3)**
...
>
---
#### [replaced 059] QuestA: Expanding Reasoning Capacity in LLMs via Question Augmentation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.13266v3](http://arxiv.org/pdf/2507.13266v3)**
...
>
---
#### [replaced 063] The Ever-Evolving Science Exam
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.16514v3](http://arxiv.org/pdf/2507.16514v3)**
...
>
---
#### [replaced 066] SelfReflect: Can LLMs Communicate Their Internal Answer Distribution?
- **分类: cs.CL; cs.AI; cs.LG; stat.ML**

- **链接: [http://arxiv.org/pdf/2505.20295v3](http://arxiv.org/pdf/2505.20295v3)**
...
>
---
#### [replaced 067] Reinforcement Fine-Tuning Naturally Mitigates Forgetting in Continual Post-Training
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.05386v3](http://arxiv.org/pdf/2507.05386v3)**
...
>
---
#### [replaced 068] DocHPLT: A Massively Multilingual Document-Level Translation Dataset
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.13079v2](http://arxiv.org/pdf/2508.13079v2)**
...
- **链接: [http://arxiv.org/pdf/2505.18128v3](http://arxiv.org/pdf/2505.18128v3)**
...
>
---
#### [replaced 070] AutoJudge: Judge Decoding Without Manual Annotation
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.20039v2](http://arxiv.org/pdf/2504.20039v2)**
...
>
---
#### [replaced 071] Painless Activation Steering: An Automated, Lightweight Approach for Post-Training Large Language Models
- **分类: cs.CL; cs.AI; cs.LG; stat.ML; I.2.6; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.22739v2](http://arxiv.org/pdf/2509.22739v2)**
...
>
---
#### [replaced 072] K-DeCore: Facilitating Knowledge Transfer in Continual Structured Knowledge Reasoning via Knowledge Decoupling
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.16929v4](http://arxiv.org/pdf/2509.16929v4)**
...
>
---
#### [replaced 073] Exploring the Impact of Data Quantity on ASR in Extremely Low-resource Languages
...
>
---
#### [replaced 074] FlowRL: Matching Reward Distributions for LLM Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.15207v2](http://arxiv.org/pdf/2509.15207v2)**
...
>
---
#### [replaced 075] MASLegalBench: Benchmarking Multi-Agent Systems in Deductive Legal Reasoning
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.24922v2](http://arxiv.org/pdf/2509.24922v2)**
...
>
---
#### [replaced 076] SAFE-SQL: Self-Augmented In-Context Learning with Fine-grained Example Selection for Text-to-SQL
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.11438v3](http://arxiv.org/pdf/2502.11438v3)**
...
>
---
#### [replaced 077] FANformer: Improving Large Language Models Through Effective Periodicity Modeling
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.21309v3](http://arxiv.org/pdf/2502.21309v3)**
...
>
---
#### [replaced 078] Cut the Deadwood Out: Backdoor Purification via Guided Module Substitution
- **分类: cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2412.20476v2](http://arxiv.org/pdf/2412.20476v2)**
...
>
---
#### [replaced 080] Taming the Tri-Space Tension: ARC-Guided Hallucination Modeling and Control for Text-to-Image Generation
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.04946v3](http://arxiv.org/pdf/2507.04946v3)**

> **作者:** Jianjiang Yang; Ziyan Huang; Yanshu li; Da Peng; Huaiyuan Yao
>
...
>
---
#### [replaced 081] Recent Advances in Large Langauge Model Benchmarks against Data Contamination: From Static to Dynamic Evaluation
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.17521v2](http://arxiv.org/pdf/2502.17521v2)**
...
>
> **备注:** Github Link: https://github.com/SeekingDream/Static-to-Dynamic-LLMEval
>
> **摘要:** Data contamination has received increasing attention in the era of large language models (LLMs) due to their reliance on vast Internet-derived training corpora. To mitigate the risk of potential data contamination, LLM benchmarking has undergone a transformation from static to dynamic benchmarking. In this work, we conduct an in-depth analysis of existing static to dynamic benchmarking methods aimed at reducing data contamination risks. We first examine methods that enhance static benchmarks and identify their inherent limitations. We then highlight a critical gap-the lack of standardized criteria for evaluating dynamic benchmarks. Based on this observation, we propose a series of optimal design principles for dynamic benchmarking and analyze the limitations of existing dynamic benchmarks. This survey provides a concise yet comprehensive overview of recent advancements in data contamination research, offering valuable insights and a clear guide for future research efforts. We maintain a GitHub repository to continuously collect both static and dynamic benchmarking methods for LLMs. The repository can be found at this link.
>
---
#### [replaced 082] Inducing Dyslexia in Vision Language Models
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.24597v2](http://arxiv.org/pdf/2509.24597v2)**
...
>
---
#### [replaced 085] Value-Guided Search for Efficient Chain-of-Thought Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17373v2](http://arxiv.org/pdf/2505.17373v2)**
...
>
---
#### [replaced 086] Chat-Driven Text Generation and Interaction for Person Retrieval
- **分类: cs.CL; I.2.7; I.4.9**

- **链接: [http://arxiv.org/pdf/2509.12662v2](http://arxiv.org/pdf/2509.12662v2)**

> **作者:** Zequn Xie; Chuxin Wang; Sihang Cai; Yeqiang Wang; Shulei Wang; Tao Jin
>
> **备注:** Accepted to EMNLP 2025 Main Conference. 13 pages, 3 figures
>
...
>
---
#### [replaced 087] Speculating LLMs' Chinese Training Data Pollution from Their Tokens
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.17771v2](http://arxiv.org/pdf/2508.17771v2)**
...
>
---
#### [replaced 088] Voting or Consensus? Decision-Making in Multi-Agent Debate
- **分类: cs.MA; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2502.19130v4](http://arxiv.org/pdf/2502.19130v4)**
...
>
---
#### [replaced 089] Agentar-Scale-SQL: Advancing Text-to-SQL through Orchestrated Test-Time Scaling
- **分类: cs.CL; cs.DB**

- **链接: [http://arxiv.org/pdf/2509.24403v2](http://arxiv.org/pdf/2509.24403v2)**
...
>
---
#### [replaced 090] A Survey on Code Generation with LLM-based Agents
- **分类: cs.SE; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.00083v2](http://arxiv.org/pdf/2508.00083v2)**
...
>
---
#### [replaced 091] MaskSQL: Safeguarding Privacy for LLM-Based Text-to-SQL via Abstraction
- **分类: cs.CR; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.23459v2](http://arxiv.org/pdf/2509.23459v2)**
...
>
---
#### [replaced 092] Scaling RL to Long Videos
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.07966v4](http://arxiv.org/pdf/2507.07966v4)**
...
>
---
#### [replaced 095] Efficient Context Selection for Long-Context QA: No Tuning, No Iteration, Just Adaptive-$k$
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2506.08479v3](http://arxiv.org/pdf/2506.08479v3)**
...
>
---
#### [replaced 096] ELEPHANT: Measuring and understanding social sycophancy in LLMs
- **分类: cs.CL; cs.AI; cs.CY**
