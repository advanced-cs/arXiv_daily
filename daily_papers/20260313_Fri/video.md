...
#### [new 001] Attend Before Attention: Efficient and Scalable Video Understanding via Autoregressive Gazing
- **分类: cs.CV**

- **简介: 该论文属于视频理解任务，解决长视频处理效率低的问题。提出AutoGaze模块，通过选择关键区域减少冗余，提升模型速度与效果。**

- **链接: [https://arxiv.org/pdf/2603.12254](https://arxiv.org/pdf/2603.12254)**
...
>
---
#### [new 008] TornadoNet: Real-Time Building Damage Detection with Ordinal Supervision
- **分类: cs.CV**

- **简介: 该论文提出TornadoNet，用于实时建筑损毁检测，解决灾后快速评估问题。通过对比CNN与Transformer模型，探索有序监督对损毁等级估计的影响。**

- **链接: [https://arxiv.org/pdf/2603.11557](https://arxiv.org/pdf/2603.11557)**
...
>
---
#### [new 019] Nyxus: A Next Generation Image Feature Extraction Library for the Big Data and AI Era
- **分类: cs.CV; q-bio.QM**

- **简介: 该论文介绍Nyxus，一个用于处理大数据和AI时代的图像特征提取库。任务是解决大规模图像数据处理效率和特征可比性问题，通过提供可扩展、跨平台的特征提取工具实现高效分析。**

- **链接: [https://arxiv.org/pdf/2603.12016](https://arxiv.org/pdf/2603.12016)**
...
>
---
#### [new 020] Continual Learning with Vision-Language Models via Semantic-Geometry Preservation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于持续学习任务，旨在解决预训练视觉-语言模型在新任务中出现的灾难性遗忘问题。通过保留跨模态语义几何结构，提升模型稳定性与迁移能力。**
...
>
---
#### [new 021] DriveXQA: Cross-modal Visual Question Answering for Adverse Driving Scene Understanding
- **分类: cs.CV**

- **简介: 该论文属于多模态视觉问答任务，旨在解决自动驾驶中异常驾驶场景理解问题。构建了DriveXQA数据集，并提出MVX-LLM模型融合多传感器信息。**

- **链接: [https://arxiv.org/pdf/2603.11380](https://arxiv.org/pdf/2603.11380)**
...
>
---
#### [new 025] BiGain: Unified Token Compression for Joint Generation and Classification
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出BiGain框架，解决扩散模型中生成与分类任务的加速问题。通过频率分离机制，提升分类性能同时保持生成质量。**

- **链接: [https://arxiv.org/pdf/2603.12240](https://arxiv.org/pdf/2603.12240)**
...
>
---
#### [new 026] OSCBench: Benchmarking Object State Change in Text-to-Video Generation
...
>
---
#### [new 027] Frequency-Modulated Visual Restoration for Matryoshka Large Multimodal Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 039] EndoCoT: Scaling Endogenous Chain-of-Thought Reasoning in Diffusion Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 040] InstantHDR: Single-forward Gaussian Splatting for High Dynamic Range 3D Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于HDR 3D重建任务，解决多曝光LDR图像生成HDR场景的问题。提出InstantHDR网络，实现单次前向传播的高效HDR重建。**
...
>
---
#### [new 045] EVATok: Adaptive Length Video Tokenization for Efficient Visual Autoregressive Generation
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决传统视频分词方法效率低的问题。提出EVATok框架，实现自适应长度的视频分词，提升生成效率与质量。**

- **链接: [https://arxiv.org/pdf/2603.12267](https://arxiv.org/pdf/2603.12267)**
...
>
---
#### [new 047] Locating Demographic Bias at the Attention-Head Level in CLIP's Vision Encoder
- **分类: cs.CV; cs.AI; cs.CY**

- **简介: 该论文属于公平性审计任务，旨在定位CLIP视觉编码器中的性别和年龄偏见。通过分析注意力头，发现性别偏见可局部化，而年龄偏见更分散。**

- **链接: [https://arxiv.org/pdf/2603.11793](https://arxiv.org/pdf/2603.11793)**
...
>
---
#### [new 050] SPEGC: Continual Test-Time Adaptation via Semantic-Prompt-Enhanced Graph Clustering for Medical Image Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分割任务，解决域差距导致的模型适应问题。提出SPEGC方法，通过语义提示增强图聚类实现持续测试时自适应，提升模型在新域中的性能。**

- **链接: [https://arxiv.org/pdf/2603.11492](https://arxiv.org/pdf/2603.11492)**
...
>
---
#### [new 051] Detect Anything in Real Time: From Single-Prompt Segmentation to Multi-Class Detection
- **分类: cs.CV**

- **简介: 该论文属于目标检测任务，解决多类别实时检测问题。通过优化结构，将单提示分割模型转化为多类检测框架，提升速度并保持精度。**

- **链接: [https://arxiv.org/pdf/2603.11441](https://arxiv.org/pdf/2603.11441)**
...
>
---
#### [new 052] A Two-Stage Dual-Modality Model for Facial Emotional Expression Recognition
- **分类: cs.CV**

- **简介: 该论文属于面部情感表达识别任务，解决视频中多表情分类问题。提出两阶段双模态模型，融合视听信息提升识别效果。**
...
>
---
#### [new 053] Beyond Convolution: A Taxonomy of Structured Operators for Learning-Based Image Processing
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像处理领域，旨在解决传统卷积操作的局限性。通过提出五类结构化算子，扩展或替代卷积，提升模型对图像结构的建模能力。**
...
>
---
#### [new 054] Multimodal classification of Radiation-Induced Contrast Enhancements and tumor recurrence using deep learning
- **分类: cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在区分胶质母细胞瘤治疗后的肿瘤复发与放射性对比增强。通过引入多模态深度学习模型RICE-NET，结合MRI和放疗剂量数据，提高了分类准确性。**
...
>
---
#### [new 057] Senna-2: Aligning VLM and End-to-End Driving Policy for Consistent Decision Making and Planning
- **分类: cs.CV**

- **简介: 该论文属于自动驾驶任务，解决VLM与E2E驾驶策略的双系统一致性问题。通过三阶段训练提升决策与规划的一致性，增强驾驶安全与效率。**

- **链接: [https://arxiv.org/pdf/2603.11219](https://arxiv.org/pdf/2603.11219)**
...
>
---
#### [new 059] CrossEarth-SAR: A SAR-Centric and Billion-Scale Geospatial Foundation Model for Domain Generalizable Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文提出CrossEarth-SAR，一个用于SAR图像跨域语义分割的百亿级基础模型，解决传感器和区域差异导致的泛化问题。通过新架构和大规模数据集提升分割性能。**

- **链接: [https://arxiv.org/pdf/2603.12008](https://arxiv.org/pdf/2603.12008)**
...
>
---
#### [new 061] Paper Title: LoV3D: Grounding Cognitive Prognosis Reasoning in Longitudinal 3D Brain MRI via Regional Volume Assessments
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出LoV3D，用于纵向3D脑部MRI的认知预后推理，解决疾病进展评估中的诊断准确性和解释性问题。通过区域体积分析实现精准诊断与总结。**

- **链接: [https://arxiv.org/pdf/2603.12071](https://arxiv.org/pdf/2603.12071)**
...
>
---
#### [new 071] DeepHistoViT: An Interpretable Vision Transformer Framework for Histopathological Cancer Classification
- **分类: cs.CV**

- **简介: 该论文属于癌症分类任务，旨在解决手动病理分析效率低、误差大的问题。提出DeepHistoViT框架，利用视觉Transformer进行自动分类并提升可解释性。**

- **链接: [https://arxiv.org/pdf/2603.11403](https://arxiv.org/pdf/2603.11403)**
...
>
---
#### [new 072] O3N: Omnidirectional Open-Vocabulary Occupancy Prediction
...
>
---
#### [new 073] Derain-Agent: A Plug-and-Play Agent Framework for Rainy Image Restoration
- **分类: cs.CV**

- **简介: 该论文属于图像去雨任务，解决现有模型无法适应复杂退化问题导致的残留伪影和质量不一致问题。提出Derain-Agent框架，通过动态规划和自适应强度调节提升去雨效果。**

- **链接: [https://arxiv.org/pdf/2603.11866](https://arxiv.org/pdf/2603.11866)**
...
>
---
#### [new 074] Coarse-Guided Visual Generation via Weighted h-Transform Sampling
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉生成任务，旨在解决从低质量参考生成高质量图像的问题。提出一种基于h-变换的引导方法，提升生成质量与引导效果。**
...
>
---
#### [new 092] Learning to Assist: Physics-Grounded Human-Human Control via Multi-Agent Reinforcement Learning
...
>
---
#### [new 093] SoulX-LiveAct: Towards Hour-Scale Real-Time Human Animation with Neighbor Forcing and ConvKV Memory
- **分类: cs.CV**

- **简介: 该论文属于实时人类动画生成任务，解决长时序生成中的稳定性与效率问题。提出Neighbor Forcing和ConvKV记忆机制，提升生成质量与推理效率。**
...
>
---
#### [new 098] PicoSAM3: Real-Time In-Sensor Region-of-Interest Segmentation
- **分类: cs.CV**

- **简介: 该论文提出PicoSAM3，用于实时传感器端目标分割任务，解决边缘设备上低延迟、高隐私需求的问题。通过轻量化设计与知识蒸馏提升性能。**

- **链接: [https://arxiv.org/pdf/2603.11917](https://arxiv.org/pdf/2603.11917)**
...
>
---
#### [new 099] Cross-Resolution Attention Network for High-Resolution PM2.5 Prediction
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于环境预测任务，解决高分辨率PM2.5预测问题。提出CRAN-PM模型，融合多分辨率数据，提升预测精度与效率。**

- **链接: [https://arxiv.org/pdf/2603.11725](https://arxiv.org/pdf/2603.11725)**
...
>
---
#### [new 100] SVLL: Staged Vision-Language Learning for Physically Grounded Embodied Task Planning
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 101] LatentGeo: Learnable Auxiliary Constructions in Latent Space for Multimodal Geometric Reasoning
- **分类: cs.CV**

- **简介: 该论文属于多模态几何推理任务，旨在解决辅助几何构造的表示问题。提出LatentGeo框架，通过学习连续潜在表示来内化构造，提升几何推理性能。**

- **链接: [https://arxiv.org/pdf/2603.12166](https://arxiv.org/pdf/2603.12166)**
...
>
---
#### [new 102] FBCIR: Balancing Cross-Modal Focuses in Composed Image Retrieval
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像检索任务，针对CIR模型在复杂场景下准确率下降的问题，提出FBCIR方法分析模态焦点不平衡，并设计数据增强提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2603.11520](https://arxiv.org/pdf/2603.11520)**
...
>
---
#### [new 116] HomeSafe-Bench: Evaluating Vision-Language Models on Unsafe Action Detection for Embodied Agents in Household Scenarios
- **分类: cs.CV; cs.AI; cs.CR**

- **简介: 该论文属于安全检测任务，旨在解决家庭场景中实体代理的危险行为识别问题。提出HomeSafe-Bench基准和HD-Guard架构，提升实时安全性评估效果。**
...
>
---
#### [new 121] Spatial-TTT: Streaming Visual-based Spatial Intelligence with Test-Time Training
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出Spatial-TTT，解决视频流中长期空间理解问题。通过测试时训练和混合架构，提升模型对3D空间信息的捕捉与组织能力。**

- **链接: [https://arxiv.org/pdf/2603.12255](https://arxiv.org/pdf/2603.12255)**
...
>
---
#### [new 122] SemiTooth: a Generalizable Semi-supervised Framework for Multi-Source Tooth Segmentation
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决多源CBCT数据中标注数据不足和一致性差的问题。提出SemiTooth框架，利用多教师-多学生结构进行半监督学习，提升分割效果。**

- **链接: [https://arxiv.org/pdf/2603.11616](https://arxiv.org/pdf/2603.11616)**
...
>
---
#### [new 124] InSpatio-WorldFM: An Open-Source Real-Time Generative Frame Model
- **分类: cs.CV**

- **简介: 该论文提出InSpatio-WorldFM，一种实时生成框架模型，解决传统视频世界模型延迟高的问题。通过独立生成帧和多视角一致性机制，实现低延迟的时空推理。**
...
>
---
#### [new 125] Single-View Rolling-Shutter SfM
- **分类: cs.CV; math.AG**

- **简介: 该论文属于视觉重建任务，解决单视角滚动快门SfM问题。通过分析几何特性，探讨从单张图像中恢复运动与场景参数的可行性及限制。**

- **链接: [https://arxiv.org/pdf/2603.11888](https://arxiv.org/pdf/2603.11888)**

> **作者:** Sofía Errázuriz Muñoz; Kim Kiehn; Petr Hruby; Kathlén Kohn
>
> **摘要:** Rolling-shutter (RS) cameras are ubiquitous, but RS SfM (structure-from-motion) has not been fully solved yet. This work suggests an approach to remedy this: We characterize RS single-view geometry of observed world points or lines. Exploiting this geometry, we describe which motion and scene parameters can be recovered from a single RS image and systematically derive minimal reconstruction problems. We evaluate several representative cases with proof-of-concept solvers, highlighting both feasibility and practical limitations.
>
---
#### [new 126] ActiveFreq: Integrating Active Learning and Frequency Domain Analysis for Interactive Segmentation
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在减少用户交互并提高分割精度。通过结合主动学习和频域分析，提出ActiveFreq框架，有效识别关键误标区域并提升特征提取能力。**

- **链接: [https://arxiv.org/pdf/2603.11498](https://arxiv.org/pdf/2603.11498)**
...
>
---
#### [new 129] Deep Learning-based Assessment of the Relation Between the Third Molar and Mandibular Canal on Panoramic Radiographs using Local, Centralized, and Federated Learning
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在评估下颌第三磨牙与下颌管的关系。通过比较局部、集中和联邦学习方法，解决多中心数据协作中的隐私问题，提升自动分类准确性。**

- **链接: [https://arxiv.org/pdf/2603.11850](https://arxiv.org/pdf/2603.11850)**
...
>
---
#### [new 131] Prediction of Grade, Gender, and Academic Performance of Children and Teenagers from Handwriting Using the Sigma-Lognormal Model
- **分类: cs.HC; cs.CV**

- **简介: 该论文研究儿童手写动态与年级、性别及学业成绩的关系，通过手写特征预测学生属性，解决儿童发展特征分析问题。**
...
>
---
#### [new 132] Dr. SHAP-AV: Decoding Relative Modality Contributions via Shapley Attribution in Audio-Visual Speech Recognition
...
>
---
#### [new 133] Prototype-Based Knowledge Guidance for Fine-Grained Structured Radiology Reporting
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于医学影像报告生成任务，旨在解决结构化报告中细粒度决策困难的问题。通过引入自由文本信息构建知识库，提升模型对罕见细节的识别能力。**

- **链接: [https://arxiv.org/pdf/2603.11938](https://arxiv.org/pdf/2603.11938)**
...
>
---
#### [new 134] OmniForcing: Unleashing Real-time Joint Audio-Visual Generation
...
>
---
#### [new 137] Attention Gathers, MLPs Compose: A Causal Analysis of an Action-Outcome Circuit in VideoViT
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究视频分类模型如何隐式表征动作结果，解决模型可解释性问题。通过机制可解释方法，揭示注意力与MLP在因果推理中的分工，为构建可信AI提供支持。**

- **链接: [https://arxiv.org/pdf/2603.11142](https://arxiv.org/pdf/2603.11142)**
...
>
---
#### [new 138] Automated Detection of Malignant Lesions in the Ovary Using Deep Learning Models and XAI
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在解决卵巢癌检测准确率低的问题。通过深度学习模型和XAI技术，构建并评估了多种网络结构，以提高诊断准确性。**

- **链接: [https://arxiv.org/pdf/2603.11818](https://arxiv.org/pdf/2603.11818)**
...
>
---
#### [new 140] SciMDR: Benchmarking and Advancing Scientific Multimodal Document Reasoning
...
>
---
#### [new 141] CRAFT: A Tendon-Driven Hand with Hybrid Hard-Soft Compliance
...
>
---
#### [new 142] Shadowless Projection Mapping for Tabletop Workspaces with Synthetic Aperture Projector
- **分类: cs.HC; cs.CV; cs.GR**

- **简介: 该论文属于投影映射任务，解决投影阴影和计算延迟问题。通过合成孔径投影系统实现无阴影、低延迟的桌面增强现实，优化空间分辨率并减少投影感。**

- **链接: [https://arxiv.org/pdf/2603.11551](https://arxiv.org/pdf/2603.11551)**
...
>
---
#### [new 143] RADAR: Closed-Loop Robotic Data Generation via Semantic Planning and Autonomous Causal Environment Reset
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 144] Catalogue Grounded Multimodal Attribution for Museum Video under Resource and Regulatory Constraints
- **分类: cs.MM; cs.CV; cs.LG**

- **简介: 该论文属于多媒体元数据生成任务，旨在解决博物馆视频缺乏可搜索元数据的问题。通过自动化流程，从视频中提取并匹配艺术作品信息，提升档案可发现性。**
...
>
---
#### [new 145] SaPaVe: Towards Active Perception and Manipulation in Vision-Language-Action Models for Robotics
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 146] TinyNav: End-to-End TinyML for Real-Time Autonomous Navigation on Microcontrollers
...
>
---
#### [new 147] Real-time Rendering-based Surgical Instrument Tracking via Evolutionary Optimization
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 148] A Diffeomorphism Groupoid and Algebroid Framework for Discontinuous Image Registration
- **分类: math.GR; cs.CV**

- **简介: 该论文属于图像配准任务，旨在解决传统方法在处理不连续滑动时的局限性。通过引入微分同胚群胚和代数结构，构建新的数学框架以有效处理不连续变形。**
...
>
---
#### [new 149] GPT4o-Receipt: A Dataset and Human Study for AI-Generated Document Forensics
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于AI生成文档检测任务，旨在解决人类与模型在识别AI生成收据上的差异问题。通过构建数据集和实验，发现人类虽能察觉视觉异常，但检测效果不如模型。**

- **链接: [https://arxiv.org/pdf/2603.11442](https://arxiv.org/pdf/2603.11442)**
...
>
> **备注:** 18 pages, 23 figures, Conference on Computer Vision and Pattern Recognition 2026
>
...
>
---
#### [replaced 002] Towards Highly Transferable Vision-Language Attack via Semantic-Augmented Dynamic Contrastive Interaction
- **分类: cs.CV**
...
>
---
#### [replaced 003] LoC-Path: Learning to Compress for Pathology Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05391](https://arxiv.org/pdf/2512.05391)**
...
>
---
#### [replaced 005] GOT-JEPA: Generic Object Tracking with Model Adaptation and Occlusion Handling using Joint-Embedding Predictive Architecture
...
>
> **备注:** Accepted by IEEE Transactions on Circuits and Systems for Video Technology (TCSVT). This research focuses on learning model adaptation for adverse and dynamic environments, as well as fine-grained occlusion perception for tracking
>
...
>
---
#### [replaced 010] Contrastive Diffusion Guidance for Spatial Inverse Problems
- **分类: cs.CV; cs.LG; eess.SP**

- **链接: [https://arxiv.org/pdf/2509.26489](https://arxiv.org/pdf/2509.26489)**
...
>
---
#### [replaced 011] NeuralOS: Towards Simulating Operating Systems via Neural Generative Models
...
>
---
#### [replaced 012] Lifelong Imitation Learning with Multimodal Latent Replay and Incremental Adjustment
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 013] BLOCK: An Open-Source Bi-Stage MLLM Character-to-Skin Pipeline for Minecraft
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 016] More Than Memory Savings: Zeroth-Order Optimization Mitigates Forgetting in Continual Learning
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.21019](https://arxiv.org/pdf/2510.21019)**
...
>
---
#### [replaced 017] ReSplat: Learning Recurrent Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.08575](https://arxiv.org/pdf/2510.08575)**
...
>
---
#### [replaced 018] Embed-RL: Reinforcement Learning for Reasoning-Driven Multimodal Embeddings
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.13823](https://arxiv.org/pdf/2602.13823)**
...
>
---
#### [replaced 019] ManiVID-3D: Generalizable View-Invariant Reinforcement Learning for Robotic Manipulation via Disentangled 3D Representations
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 020] Efficient Construction of Implicit Surface Models From a Single Image for Motion Generation
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 021] GTR-Bench: Evaluating Geo-Temporal Reasoning in Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.07791](https://arxiv.org/pdf/2510.07791)**

> **作者:** Qinghongbing Xie; Zhaoyuan Xia; Feng Zhu; Lijun Gong; Ziyue Li; Rui Zhao; Long Zeng
>
> **备注:** ICLR 2026, 31 pages, 20 figures
>
...
>
---
#### [replaced 022] Beyond Description: Cognitively Benchmarking Fine-Grained Action for Embodied Agents
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 023] Conditional Unbalanced Optimal Transport Maps: An Outlier-Robust Framework for Conditional Generative Modeling
- **分类: cs.LG; cs.CV**
...
>
---
#### [replaced 026] UniFField: A Generalizable Unified Neural Feature Field for Visual, Semantic, and Spatial Uncertainties in Any Scene
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [replaced 027] ECHOSAT: Estimating Canopy Height Over Space And Time
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.21421](https://arxiv.org/pdf/2602.21421)**
...
>
---
#### [replaced 028] X-GS: An Extensible Open Framework for Perceiving and Thinking via 3D Gaussian Splatting
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 032] Pyramidal Patchification Flow for Visual Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.23543](https://arxiv.org/pdf/2506.23543)**
...
>
---
#### [replaced 033] Evaluating Generative Models via One-Dimensional Code Distributions
- **分类: cs.CV**
...
>
---
#### [replaced 035] Think with 3D: Geometric Imagination Grounded Spatial Reasoning from Limited Views
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 038] Contact-Aware Refinement of Human Pose Pseudo-Ground Truth via Bioimpedance Sensing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.04862](https://arxiv.org/pdf/2512.04862)**
...
>
---
#### [replaced 039] Capturing Temporal Dynamics in Large-Scale Canopy Tree Height Estimation
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2501.19328](https://arxiv.org/pdf/2501.19328)**
...
>
---
#### [replaced 040] Head-wise Adaptive Rotary Positional Encoding for Fine-Grained Image Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.10489](https://arxiv.org/pdf/2510.10489)**
...
>
---
#### [replaced 041] TextFlux: An OCR-Free DiT Model for High-Fidelity Multilingual Scene Text Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.17778](https://arxiv.org/pdf/2505.17778)**

> **作者:** Yu Xie; Jielei Zhang; Pengyu Chen; Weihang Wang; Longwen Gao; Peiyi Li; Qian Qiao; Zhouhui Lian
>
> **备注:** Accepted to Eurographics 2026 (Computer Graphics Forum)
>
...
>
---
#### [replaced 042] Multi-Paradigm Collaborative Adversarial Attack Against Multi-Modal Large Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 043] Weakly Supervised Teacher-Student Framework with Progressive Pseudo-mask Refinement for Gland Segmentation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 046] Image Segmentation via Variational Model Based Tailored UNet: A Deep Variational Framework
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.05806](https://arxiv.org/pdf/2505.05806)**
...
>
---
#### [replaced 047] KnowVal: A Knowledge-Augmented and Value-Guided Autonomous Driving System
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 048] FastLightGen: Fast and Light Video Generation with Fewer Steps and Parameters
- **分类: cs.CV**
...
>
---
#### [replaced 049] Understanding and Optimizing Attention-Based Sparse Matching for Diverse Local Features
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.08430](https://arxiv.org/pdf/2602.08430)**

> **作者:** Qiang Wang
>
> **备注:** v2: add results with RaCo,RDD,DaD and Air-to-Ground benchmark
>
...
>
---
#### [replaced 052] On the Reliability of Cue Conflict and Beyond
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 053] Geometric Autoencoder for Diffusion Models
- **分类: cs.CV**
...
>
---
#### [replaced 054] InvAD: Inversion-based Reconstruction-Free Anomaly Detection with Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.05662](https://arxiv.org/pdf/2504.05662)**

> **作者:** Shunsuke Sakai; Xiangteng He; Chunzhi Gu; Leonid Sigal; Tatsuhito Hasegawa
>
> **备注:** Accepted to CVPR2026. Project page: this https URL
>
...
>
---
#### [replaced 055] Radiative-Structured Neural Operator for Continuous Spectral Super-Resolution
- **分类: eess.IV; cs.CV**
...
>
---
#### [replaced 056] TrajPred: Trajectory-Conditioned Joint Embedding Prediction for Surgical Instrument-Tissue Interaction Recognition in Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 057] Topologically Stable Hough Transform
- **分类: cs.CG; cs.CV**
...
>
---
#### [replaced 058] SignSparK: Efficient Multilingual Sign Language Production via Sparse Keyframe Learning
- **分类: cs.CV**
...
>
---
#### [replaced 059] The Orthogonal Vulnerabilities of Generative AI Watermarks: A Comparative Empirical Benchmark of Spatial and Latent Provenance
- **分类: cs.CR; cs.CV**
...
>
---
#### [replaced 060] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.19297](https://arxiv.org/pdf/2509.19297)**
...
> **备注:** Project Page: this https URL, Code: this https URL
>
> **摘要:** Feed-forward 3D Gaussian Splatting (3DGS) has emerged as a highly effective solution for novel view synthesis. Existing methods predominantly rely on a \emph{pixel-aligned} Gaussian prediction paradigm, where each 2D pixel is mapped to a 3D Gaussian. We rethink this widely adopted formulation and identify several inherent limitations: it renders the reconstructed 3D models heavily dependent on the number of input views, leads to view-biased density distributions, and introduces alignment errors, particularly when source views contain occlusions or low texture. To address these challenges, we introduce VolSplat, a new multi-view feed-forward paradigm that replaces pixel alignment with voxel-aligned Gaussians. By directly predicting Gaussians from a predicted 3D voxel grid, it overcomes pixel alignment's reliance on error-prone 2D feature matching, ensuring robust multi-view consistency. Furthermore, it enables adaptive control over density based on 3D scene complexity, yielding more faithful Gaussians, improved geometric consistency, and enhanced novel-view rendering quality. Experiments on widely used benchmarks demonstrate that VolSplat achieves state-of-the-art performance, while producing more plausible and view-consistent results. The video results, code and trained models are available on our project page: this https URL.
>
---
#### [replaced 061] Estimating Canopy Height at Scale
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2406.01076](https://arxiv.org/pdf/2406.01076)**

> **作者:** Jan Pauls; Max Zimmer; Una M. Kelly; Martin Schwartz; Sassan Saatchi; Philippe Ciais; Sebastian Pokutta; Martin Brandt; Fabian Gieseke
>
> **备注:** ICML Camera-Ready, 17 pages, 14 figures, 7 tables
>
> **摘要:** We propose a framework for global-scale canopy height estimation based on satellite data. Our model leverages advanced data preprocessing techniques, resorts to a novel loss function designed to counter geolocation inaccuracies inherent in the ground-truth height measurements, and employs data from the Shuttle Radar Topography Mission to effectively filter out erroneous labels in mountainous regions, enhancing the reliability of our predictions in those areas. A comparison between predictions and ground-truth labels yields an MAE / RMSE of 2.43 / 4.73 (meters) overall and 4.45 / 6.72 (meters) for trees taller than five meters, which depicts a substantial improvement compared to existing global-scale maps. The resulting height map as well as the underlying framework will facilitate and enhance ecological analyses at a global scale, including, but not limited to, large-scale forest and biomass monitoring.
>
---
#### [replaced 062] LaST-VLA: Thinking in Latent Spatio-Temporal Space for Vision-Language-Action in Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.01928](https://arxiv.org/pdf/2603.01928)**
...
>
---
#### [replaced 063] JOPP-3D: Joint Open Vocabulary Semantic Segmentation on Point Clouds and Panoramas
- **分类: cs.CV**
...
>
---
#### [replaced 064] EXPLORE-Bench: Egocentric Scene Prediction with Long-Horizon Reasoning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 067] The Coherence Trap: When MLLM-Crafted Narratives Exploit Manipulated Visual Contexts
- **分类: cs.CV**
...
>
---
#### [replaced 068] Defending Unauthorized Model Merging via Dual-Stage Weight Protection
- **分类: cs.CV; cs.CR**

- **链接: [https://arxiv.org/pdf/2511.11851](https://arxiv.org/pdf/2511.11851)**

> **作者:** Wei-Jia Chen; Min-Yen Tsai; Cheng-Yi Lee; Chia-Mu Yu
>
> **备注:** Accepted at CVPR 2026, updated
>
...
>
---
#### [replaced 069] Less is More: Decoder-Free Masked Modeling for Efficient Skeleton Representation Learning
- **分类: cs.CV**
...
>
---
#### [replaced 070] See4D: Pose-Free 4D Generation via Auto-Regressive Video Inpainting
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2510.26796](https://arxiv.org/pdf/2510.26796)**
...
>
> **备注:** Eurographics2026; 26 pages; 21 figures; 3 tables; project page: this https URL
>
...
>
---
#### [replaced 071] DriveCritic: Towards Context-Aware, Human-Aligned Evaluation for Autonomous Driving with Vision-Language Models
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 072] SIMSPINE: A Biomechanics-Aware Simulation Framework for 3D Spine Motion Annotation and Benchmarking
- **分类: cs.CV**
...
>
---
#### [replaced 073] SOTA: Self-adaptive Optimal Transport for Zero-Shot Classification with Multiple Foundation Models
- **分类: cs.CV**
...
>
---
#### [replaced 078] Adaptive Dual-Constrained Line Aggregation for Robust Generic and Wireframe Line Segment Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.19742](https://arxiv.org/pdf/2508.19742)**

> **作者:** Chenguang Liu; Chisheng Wang; Huilin Chen; Chuanhua Zhu; Qingquan Li
>
...
>
---
#### [replaced 081] SGG-R$^{\rm 3}$: From Next-Token Prediction to End-to-End Unbiased Scene Graph Generation
- **分类: cs.CV**
...
>
---
#### [replaced 084] AceVFI: A Comprehensive Survey of Advances in Video Frame Interpolation
- **分类: cs.CV**
...
>
---
#### [replaced 092] ReasonMap: Towards Fine-Grained Visual Reasoning from Transit Maps
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 093] PuzLM: Solving Jigsaw Puzzles with Sequence-to-Sequence Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.06315](https://arxiv.org/pdf/2511.06315)**

> **作者:** Gur Elkin; Ofir Itzhak Shahar; Ohad Ben-Shahar
>
> **摘要:** Square jigsaw puzzles are typically solved by visually matching piece images to recover the original layout. This work introduces PuzLM, an alternative perspective that recasts jigsaw reassembly as a discrete sequence-to-sequence (Seq2Seq) problem, inspired by natural language representations. We design an efficient puzzle quantization procedure that transforms each piece into a short sequence of discrete tokens, enabling the direct application of standard Seq2Seq language models as powerful jigsaw solvers. Our approach demonstrates that accurate puzzle reconstruction can be achieved through purely symbolic reasoning over discrete representations, improving state-of-the-art performance even on puzzles with eroded boundaries or missing pieces.
>
---
