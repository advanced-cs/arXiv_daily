...
- **简介: 该论文针对多模态大语言模型中的遗漏与虚构幻觉问题，指出现有方法错误归因于单一原因。作者通过实验发现二者成因不同，提出视觉语义注意力势场框架及校准方法，有效减少遗漏而不增加虚构，为幻觉缓解提供新方向。**
...
- **简介: 该论文针对长尾视觉识别任务，提出平衡信息瓶颈（BIB）与混合BIB（MBIB）方法，通过损失重平衡、自蒸馏及多层知识融合，提升模型在长尾数据上的表示学习与分类性能，达到SOTA效果。**
...
- **简介: 该论文系统分析MLLMs在具身环境中的空间理解局限性，提出MulSeT基准测试，从数据与架构角度揭示性能瓶颈，提出通过数据扩展与架构优化提升空间推理能力。**
...
- **简介: 该论文提出DevilSight框架，解决单目视频人体Avatar重建中动态细节不足和视角生成不真实的问题。通过虚拟视角生成增强监督信号，并结合物理身份微调与高分辨率去噪策略，提升重建质量与一致性。**
...
- **简介: 论文提出一种语言引导的生成式视觉系统，用于工业轮廓检测，解决传统方法在噪声和材料变异性下的不足。系统包含数据预处理、条件GAN生成和视觉-语言模型优化，通过对比实验验证其有效性。**
...
- **简介: 该论文提出AgroSense系统，通过融合土壤图像分析与营养数据，解决传统土壤分析效率低、不适应实时决策的问题。构建了包含图像分类和结构化数据分析的深度学习框架，实现高精度作物推荐，提升精准农业的智能化水平。**
...
- **简介: 该论文提出Uniferum，一种整合多源监督信号的3D CT视觉-语言模型，解决临床场景中模型判别精度不足及数据异构问题。通过统一标注格式与分割掩码，提升模型在CT-RATE基准的AUROC 7%，并展现跨数据集零样本泛化能力。**
...
- **简介: 该论文提出算法可持续性评估框架，解决深度学习模型训练高能耗与性能平衡问题。设计FMS和ASC双指标，构建多任务基准测试，推动绿色AI从理论到实践转化。**
...
- **简介: 该论文聚焦开放词汇场景图生成任务，解决现有评估指标受限和弱监督数据质量差的问题，提出无参考评估方法及基于区域提示调优的高质量合成数据生成技术，提升模型泛化能力。**
...
- **简介: 该论文针对3D手部姿态估计中的不确定性建模不足问题，提出结合关节相关性的参数化方法，通过概率分布和单层线性层提升模型准确性和不确定性建模能力。**
...
- **简介: 论文提出LightVLM，通过金字塔token合并和KV缓存压缩，加速大型多模态模型推理，提升吞吐量并减少延迟，适用于长序列生成，保持高性能的同时显著提升效率。**
...
- **简介: 该论文提出MOSAIC框架，解决多主体个性化图像生成中的身份保真与语义一致性问题。通过语义对应对齐和特征解耦，引入SemAlign-MS数据集及两种损失函数，支持4+参考主体，实现高保真合成。**
...
- **简介: 该论文针对视觉Transformer自监督学习中硬负样本应用不足的问题，提出通过合成负样本提升表示学习效果，实验验证了其在DeiT-S和Swin-T模型上的有效性。**
...
- **简介: 该论文提出MetaSSL框架，针对半监督医学图像分割中忽略标签噪声和像素异质性的问题，设计空间异构损失函数，通过动态权重分配提升分割性能，适用于多种SSL方法。**
...
- **简介: 论文提出MorphGen方法，通过形态学引导的表示学习解决计算病理学中因WSI异质性导致的单域泛化问题，结合图像、增强和核分割掩码，利用监督对比学习和SWA提升模型对域移变的鲁棒性。**
...
- **简介: 该论文提出Scaffold Diffusion模型，利用离散扩散语言模型生成空间连贯的稀疏多类3D体素结构，解决内存扩展和类别不平衡问题，在高稀疏度数据上实现真实结构生成。**
...
- **简介: 该论文针对点云压缩任务，解决现有方法处理全局结构与局部上下文信息时缺乏交互的问题。提出PVINet，通过并行提取全局体素特征与局部点特征，并引入条件稀疏卷积实现跨模态特征交互，提升压缩效率与重建质量。**
...
- **简介: 本文通过八个示意图详细解析RT-DETRv2架构，解决现有资料难以理解的问题，阐明各组件协作机制，助力研究者深入理解模型工作原理。**
...
- **简介: 该论文提出基于强化学习的协作蒸馏与自学习框架，解决轻量模型在红外-可见光图像融合中的高质量融合难题，通过生成挑战样本和动态调整教师指导，提升学生模型性能。**
...
- **简介: 该论文提出混合模型SUFERNOBWA，结合Swin Transformer和U-Net解决卫星图像去雾问题，通过复合损失函数提升结构边界与像素精度，实验验证其在RICE和SateHaze1K数据集上的优越性能。**
...
- **简介: 论文提出TRUST框架，解决跨设备超声图像风格迁移问题，通过双流和TR模块提升下游任务性能。**
...
- **简介: 论文提出TeRA框架，通过两阶段训练策略，结合解码器蒸馏与文本控制扩散模型，解决文本驱动3D人像生成中效率低、定制化不足的问题，提升生成质量与速度。**
...
- **链接: [http://arxiv.org/pdf/2509.01373v1](http://arxiv.org/pdf/2509.01373v1)**
...
- **简介: 论文提出基于计算机视觉与神经网络的珠宝自动识别与分层描述方法，解决翻译者需快速获取珠宝信息的问题，通过构建数据库及模型评估提升描述准确性。**
...
>
---
#### [new 065] RiverScope: High-Resolution River Masking Dataset
- **分类: cs.CV**

- **简介: 该论文提出RiverScope高分辨率河流掩码数据集，解决窄/含沙河流监测难题。通过专家标注与多传感器对齐，建立全球基准，提升河流宽度估计精度，支持多模态水文建模与可持续管理。**

- **链接: [http://arxiv.org/pdf/2509.02451v1](http://arxiv.org/pdf/2509.02451v1)**
...
>
---
#### [new 071] Enhancing Fairness in Skin Lesion Classification for Medical Diagnosis Using Prune Learning
...
>
---
#### [new 072] VideoRewardBench: Comprehensive Evaluation of Multimodal Reward Models for Video Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出VideoRewardBench，首个全面评估视频理解多模态奖励模型的基准，解决现有基准问题少、维度单一、模型覆盖不足。构建1563样本数据集，评估28种MRMs，揭示RL训练不必然提升泛化，推理扩展对部分模型有效，帧数变化影响不同模型。任务为多模态模型评估，提升视频理解MRMs评价标准。**

- **链接: [http://arxiv.org/pdf/2509.00484v1](http://arxiv.org/pdf/2509.00484v1)**
...
>
---
#### [new 076] Deep Learning-Driven Multimodal Detection and Movement Analysis of Objects in Culinary
- **分类: cs.CV; cs.AI**

- **简介: 论文提出多模态检测与运动分析系统，整合YOLOv8、LSTM和ASR数据，驱动LLM预测食谱并生成烹饪步骤，解决复杂厨房环境下的自动化烹饪指导问题。**

- **链接: [http://arxiv.org/pdf/2509.00033v1](http://arxiv.org/pdf/2509.00033v1)**
...
>
---
#### [new 077] NoiseCutMix: A Novel Data Augmentation Approach by Mixing Estimated Noise in Diffusion Models
- **分类: cs.CV**

- **简介: 该论文提出NoiseCutMix方法，通过混合扩散模型中不同类别的估计噪声，解决传统CutMix导致的图像边界不自然问题，实现高质量多类别特征融合的数据增强任务。**

- **链接: [http://arxiv.org/pdf/2509.00378v1](http://arxiv.org/pdf/2509.00378v1)**
...
>
---
#### [new 078] Generalizable Self-supervised Monocular Depth Estimation with Mixture of Low-Rank Experts for Diverse Endoscopic Scenes
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出自监督单目深度估计方法，解决内窥镜场景中光照与特征多样性导致的深度估计泛化难题。通过动态低秩专家混合模块与自监督框架，提升模型在不同场景下的适应性与准确性。**

- **链接: [http://arxiv.org/pdf/2509.01206v1](http://arxiv.org/pdf/2509.01206v1)**
...
>
---
#### [new 079] A High-Accuracy Fast Hough Transform with Linear-Log-Cubed Computational Complexity for Arbitrary-Shaped Images
- **分类: cs.CV**

- **简介: 该论文提出FHT2SP算法，解决Hough变换在计算效率与精度间的平衡问题。通过结合超像素方法扩展至任意形状图像，实现近优复杂度O(wh ln³w)与常数级误差控制。**

- **链接: [http://arxiv.org/pdf/2509.00231v1](http://arxiv.org/pdf/2509.00231v1)**
...
>
---
#### [new 084] An End-to-End Framework for Video Multi-Person Pose Estimation
- **分类: cs.CV**

- **简介: 该论文针对视频多人姿态估计任务，解决传统方法分离时空维度、效率低及跨帧匹配不准确的问题。提出VEPE框架，通过时空Transformer组件和实例一致性机制，实现端到端优化，提升推理效率300%。**

- **链接: [http://arxiv.org/pdf/2509.01095v1](http://arxiv.org/pdf/2509.01095v1)**
...
>
---
#### [new 085] Activation Steering Meets Preference Optimization: Defense Against Jailbreaks in Vision Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出SPO-VLM框架，通过两阶段结合激活引导与偏好优化，解决视觉语言模型对抗攻击（如jailbreak）问题，提升安全性同时保持视觉理解能力。**

- **链接: [http://arxiv.org/pdf/2509.00373v1](http://arxiv.org/pdf/2509.00373v1)**
...
>
---
#### [new 086] Multimodal Deep Learning for Phyllodes Tumor Classification from Ultrasound and Clinical Data
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出多模态深度学习框架，融合超声图像与临床数据，解决Phyllodes肿瘤术前分类困难问题，通过双分支网络与类感知采样提升诊断准确率，减少不必要的手术。**

- **链接: [http://arxiv.org/pdf/2509.00213v1](http://arxiv.org/pdf/2509.00213v1)**
...
>
---
#### [new 090] SemaMIL: Semantic Reordering with Retrieval-Guided State Space Modeling for Whole Slide Image Classification
- **分类: cs.CV**

- **简介: 论文提出SemaMIL方法，针对全切片图像分类任务，解决传统MIL方法忽略上下文关系、Transformer计算量大及SSM可解释性差的问题。通过语义重排与检索引导的状态空间建模，提升分类准确率并降低计算成本。**

- **链接: [http://arxiv.org/pdf/2509.00442v1](http://arxiv.org/pdf/2509.00442v1)**
...
>
---
#### [new 091] A Data-Centric Approach to Pedestrian Attribute Recognition: Synthetic Augmentation via Prompt-driven Diffusion Models
- **分类: cs.CV**

- **简介: 该论文针对行人属性识别任务中数据不足导致的属性识别困难，提出数据为中心的方法，通过提示驱动的扩散模型生成合成数据，提升模型对欠代表属性的识别能力及零样本泛化性能，无需修改模型结构。**

- **链接: [http://arxiv.org/pdf/2509.02099v1](http://arxiv.org/pdf/2509.02099v1)**
...
>
---
#### [new 094] PointSlice: Accurate and Efficient Slice-Based Representation for 3D Object Detection from Point Clouds
- **分类: cs.CV**

- **简介: 该论文提出PointSlice方法，用于3D点云物体检测，解决体素（精度高但慢）与柱状（速度快但准）方法的效率-精度矛盾。通过切片为2D数据、引入SIN网络保持垂直关系，实现高精度与高效检测，在Waymo等数据集上验证了优势。**

- **链接: [http://arxiv.org/pdf/2509.01487v1](http://arxiv.org/pdf/2509.01487v1)**
...
>
---
#### [new 106] Domain Adaptation-Based Crossmodal Knowledge Distillation for 3D Semantic Segmentation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 107] Prior-Guided Residual Diffusion: Calibrated and Efficient Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文提出PGRD框架，解决医学图像分割中分布建模不准确问题，通过先验引导残差扩散与深度监督，提升校准与效率，超越多种基线方法。**

- **链接: [http://arxiv.org/pdf/2509.01330v1](http://arxiv.org/pdf/2509.01330v1)**
...
>
---
#### [new 108] CSFMamba: Cross State Fusion Mamba Operator for Multimodal Remote Sensing Image Classification
- **分类: cs.CV**

- **简介: 该论文提出CSFMamba网络，解决多模态遥感图像分类中传统方法计算复杂度高、长距离依赖建模困难的问题。通过结合CNN与Mamba，设计跨状态融合模块，实现HSI与LiDAR模态高效融合，降低训练负担并提升分类性能。**

- **链接: [http://arxiv.org/pdf/2509.00677v1](http://arxiv.org/pdf/2509.00677v1)**
...
>
---
#### [new 113] Image Quality Enhancement and Detection of Small and Dense Objects in Industrial Recycling Processes
- **分类: cs.CV; eess.IV**

- **简介: 该论文聚焦工业场景中小密集物体检测与图像质量提升任务，解决噪声环境下目标检测困难及图像降噪问题。通过构建含10k图像的数据集，评估监督深度学习方法，提出轻量全连接卷积网络模型，优化检测精度与计算效率。**

- **链接: [http://arxiv.org/pdf/2509.01332v1](http://arxiv.org/pdf/2509.01332v1)**
...
>
---
#### [new 116] Do Video Language Models Really Know Where to Look? Diagnosing Attention Failures in Video Language Models
- **分类: cs.CV; cs.CL; cs.LG**

- **简介: 该论文针对视频语言模型的关键帧选择问题，通过实证分析揭示现有视觉编码器在定位重要视频帧上的局限性，指出需改进关键帧识别技术以提升模型效率与准确性。**

- **链接: [http://arxiv.org/pdf/2509.01167v1](http://arxiv.org/pdf/2509.01167v1)**
...
>
---
#### [new 120] A Modality-agnostic Multi-task Foundation Model for Human Brain Imaging
- **分类: cs.CV**

- **简介: 该论文提出BrainFM模型，解决跨模态脑影像任务泛化难题。通过"轻度-严重"生成与"真实-合成"混合训练策略，实现对模态、对比度、分辨率等变化的鲁棒性，支持图像合成、分割、距离估计等五项任务，适用于CT和MRI等多种模态。**

- **链接: [http://arxiv.org/pdf/2509.00549v1](http://arxiv.org/pdf/2509.00549v1)**
...
>
---
#### [new 124] Towards High-Fidelity, Identity-Preserving Real-Time Makeup Transfer: Decoupling Style Generation
- **分类: cs.CV**

- **简介: 该论文提出实时虚拟试妆框架，解决高保真、身份保持与时间一致性问题。通过分离化妆掩码提取与图形渲染，结合伪数据训练及定制损失函数，提升透明度与颜色保真度，实现跨姿态、肤色的稳定妆容迁移。**

- **链接: [http://arxiv.org/pdf/2509.02445v1](http://arxiv.org/pdf/2509.02445v1)**
...
>
> **备注:** 10 pages, 5 figures. Numan Saeed is the corresponding author. Salma Hassan and Shahad Hardan contributed equally to this work. Project page: https://hecktor25.grand-challenge.org/
>
...
>
---
#### [new 127] Ensemble-Based Event Camera Place Recognition Under Varying Illumination
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 128] TransForSeg: A Multitask Stereo ViT for Joint Stereo Segmentation and 3D Force Estimation in Catheterization
...
>
---
#### [new 137] C-DiffDet+: Fusing Global Scene Context with Generative Denoising for High-Fidelity Object Detection
- **分类: cs.CV**

- **简介: 论文针对细粒度物体检测中全局场景上下文利用不足的问题，提出C-DiffDet+，通过Context-Aware Fusion模块融合全局信息与局部特征，提升检测精度。**

- **链接: [http://arxiv.org/pdf/2509.00578v1](http://arxiv.org/pdf/2509.00578v1)**
...
>
---
#### [new 138] See No Evil: Adversarial Attacks Against Linguistic-Visual Association in Referring Multi-Object Tracking Systems
- **分类: cs.CV; cs.CR**

- **简介: 该论文针对Referring Multi-Object Tracking（RMOT）系统的安全漏洞，提出VEIL框架，通过对抗攻击破坏语言-视觉关联，导致跟踪ID切换与终止，验证了其在Refer-KITTI数据集上的有效性，强调需加强RMOT系统的安全性设计。**

- **链接: [http://arxiv.org/pdf/2509.02028v1](http://arxiv.org/pdf/2509.02028v1)**
...
>
---
#### [new 139] Identity-Preserving Text-to-Video Generation via Training-Free Prompt, Image, and Guidance Enhancement
- **分类: cs.CV; cs.MM**

- **简介: 论文提出训练免费框架TPIGE，通过提示、图像和时空引导增强，解决身份保持文本到视频生成中的数据稀缺和高成本问题，提升生成质量。**

- **链接: [http://arxiv.org/pdf/2509.01362v1](http://arxiv.org/pdf/2509.01362v1)**
...
>
---
#### [new 140] M3Ret: Unleashing Zero-shot Multimodal Medical Image Retrieval via Self-Supervision
- **分类: cs.CV; cs.LG**

- **简介: 论文提出M3Ret，解决多模态医学图像零样本检索问题。通过自监督学习统一编码器，跨模态对齐，泛化至未见模态，超越现有方法。**

- **链接: [http://arxiv.org/pdf/2509.01360v1](http://arxiv.org/pdf/2509.01360v1)**

> **作者:** Che Liu; Zheng Jiang; Chengyu Fang; Heng Guo; Yan-Jie Zhou; Jiaqi Qu; Le Lu; Minfeng Xu
>
> **备注:** Technical Report
>
> **摘要:** Medical image retrieval is essential for clinical decision-making and translational research, relying on discriminative visual representations. Yet, current methods remain fragmented, relying on separate architectures and training strategies for 2D, 3D, and video-based medical data. This modality-specific design hampers scalability and inhibits the development of unified representations. To enable unified learning, we curate a large-scale hybrid-modality dataset comprising 867,653 medical imaging samples, including 2D X-rays and ultrasounds, RGB endoscopy videos, and 3D CT scans. Leveraging this dataset, we train M3Ret, a unified visual encoder without any modality-specific customization. It successfully learns transferable representations using both generative (MAE) and contrastive (SimDINO) self-supervised learning (SSL) paradigms. Our approach sets a new state-of-the-art in zero-shot image-to-image retrieval across all individual modalities, surpassing strong baselines such as DINOv3 and the text-supervised BMC-CLIP. More remarkably, strong cross-modal alignment emerges without paired data, and the model generalizes to unseen MRI tasks, despite never observing MRI during pretraining, demonstrating the generalizability of purely visual self-supervision to unseen modalities. Comprehensive analyses further validate the scalability of our framework across model and data sizes. These findings deliver a promising signal to the medical imaging community, positioning M3Ret as a step toward foundation models for visual SSL in multimodal medical image understanding.
>
---
#### [new 141] SurgLLM: A Versatile Large Multimodal Model with Spatial Focus and Temporal Awareness for Surgical Video Understanding
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出SurgLLM框架，针对手术视频理解任务中的视觉感知不足和时间意识不足问题，通过空间聚焦与时间感知增强，结合多模态预训练与动态集成，提升多任务性能。**

- **链接: [http://arxiv.org/pdf/2509.00357v1](http://arxiv.org/pdf/2509.00357v1)**
...
>
---
#### [new 149] MSA2-Net: Utilizing Self-Adaptive Convolution Module to Extract Multi-Scale Information in Medical Image Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MSA2-Net，通过自适应卷积模块动态调整卷积核大小，提升多尺度特征提取，解决医学图像分割中模型泛化不足问题，取得高Dice系数。**

- **链接: [http://arxiv.org/pdf/2509.01498v1](http://arxiv.org/pdf/2509.01498v1)**
...
>
---
#### [new 157] Street-Level Geolocalization Using Multimodal Large Language Models and Retrieval-Augmented Generation
- **分类: cs.CV; cs.AI**

- **简介: 论文提出基于多模态大语言模型与检索增强生成的街级地理定位方法，解决传统方法在社交媒体图像处理中的挑战，通过构建向量数据库和检索增强查询，实现高精度定位且无需微调，提升可扩展性。**

- **链接: [http://arxiv.org/pdf/2509.01341v1](http://arxiv.org/pdf/2509.01341v1)**
...
>
---
#### [new 166] CascadeFormer: A Family of Two-stage Cascading Transformers for Skeleton-based Human Action Recognition
- **分类: cs.CV**

- **简介: 本文提出CascadeFormer，一种基于两阶段级联Transformer的骨骼动作识别框架，通过预训练与微调结合，提升动作分类性能，适用于Penn Action N-UCLA和NTU RGB+D 60等数据集。**

- **链接: [http://arxiv.org/pdf/2509.00692v1](http://arxiv.org/pdf/2509.00692v1)**
...
>
---
#### [new 167] Novel Category Discovery with X-Agent Attention for Open-Vocabulary Semantic Segmentation
- **分类: cs.CV**

- **简介: 论文提出X-Agent框架，针对开放词汇语义分割中领域差异导致的潜在类别建模难题，通过跨模态注意力机制优化潜在语义动态，提升其显著性，实现SOTA性能。**

- **链接: [http://arxiv.org/pdf/2509.01275v1](http://arxiv.org/pdf/2509.01275v1)**
...
>
---
#### [new 168] Iterative Low-rank Network for Hyperspectral Image Denoising
- **分类: cs.CV**

- **简介: 论文提出ILRNet，结合模型驱动与数据驱动方法，通过秩最小化模块和迭代优化，在高光谱图像去噪中有效利用低秩性，保留细节，实现先进性能。**

- **链接: [http://arxiv.org/pdf/2509.00356v1](http://arxiv.org/pdf/2509.00356v1)**
...
>
---
#### [new 169] Seeing More, Saying More: Lightweight Language Experts are Dynamic Video Token Compressors
- **分类: cs.CV**

- **简介: 该论文提出LangDC，通过轻量语言模型动态调整视频标记压缩比，基于语义密度优化效率，减少FLOPs并保持性能。**

- **链接: [http://arxiv.org/pdf/2509.00969v1](http://arxiv.org/pdf/2509.00969v1)**
...
>
---
#### [new 170] Target-Oriented Single Domain Generalization
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出Target-Oriented Single Domain Generalization（TO-SDG）任务，解决单源域模型在目标域分布偏移下的性能崩溃问题。通过文本描述引导模型泛化，设计STAR模块融合视觉-语言模型，调整特征空间以增强目标域适应性。**

- **链接: [http://arxiv.org/pdf/2509.00351v1](http://arxiv.org/pdf/2509.00351v1)**
...
>
---
#### [new 171] Multi-Representation Adapter with Neural Architecture Search for Efficient Range-Doppler Radar Object Detection
- **分类: cs.CV**

- **简介: 该论文提出一种基于多表示与神经架构搜索的雷达目标检测模型，通过特征交换与融合模块提升效率与精度，在RADDet和CARRADA数据集上达到新SOTA。**

- **链接: [http://arxiv.org/pdf/2509.01280v1](http://arxiv.org/pdf/2509.01280v1)**

> **作者:** Zhiwei Lin; Weicheng Zheng; Yongtao Wang
>
> **备注:** Accepted by ICANN 2025
>
> **摘要:** Detecting objects efficiently from radar sensors has recently become a popular trend due to their robustness against adverse lighting and weather conditions compared with cameras. This paper presents an efficient object detection model for Range-Doppler (RD) radar maps. Specifically, we first represent RD radar maps with multi-representation, i.e., heatmaps and grayscale images, to gather high-level object and fine-grained texture features. Then, we design an additional Adapter branch, an Exchanger Module with two modes, and a Primary-Auxiliary Fusion Module to effectively extract, exchange, and fuse features from the multi-representation inputs, respectively. Furthermore, we construct a supernet with various width and fusion operations in the Adapter branch for the proposed model and employ a One-Shot Neural Architecture Search method to further improve the model's efficiency while maintaining high performance. Experimental results demonstrate that our model obtains favorable accuracy and efficiency trade-off. Moreover, we achieve new state-of-the-art performance on RADDet and CARRADA datasets with mAP@50 of 71.9 and 57.1, respectively.
>
---
#### [new 172] A Unified Low-level Foundation Model for Enhancing Pathology Image Quality
- **分类: cs.CV**

- **简介: 该论文提出LPFM，解决病理图像低级增强难题，统一处理超分、去噪、去模糊及虚拟染色等任务。通过对比预训练编码器与条件扩散模型，实现跨任务适配，显著提升图像质量指标。**

- **链接: [http://arxiv.org/pdf/2509.01071v1](http://arxiv.org/pdf/2509.01071v1)**
...
>
---
#### [new 175] OmniReason: A Temporal-Guided Vision-Language-Action Framework for Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文提出OmniReason框架，解决自动驾驶中时空推理不足问题。通过构建大规模VLA数据集和集成稀疏时间记忆模块与解释生成器的Agent架构，提升动态场景下的决策与可解释性。**

- **链接: [http://arxiv.org/pdf/2509.00789v1](http://arxiv.org/pdf/2509.00789v1)**
...
>
---
#### [new 185] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
- **分类: cs.CV**

- **简介: 该论文提出UPGS框架，通过统一优化相机姿态与3D高斯参数，解决动态场景重建中的运动模糊问题，采用三阶段训练策略提升重建质量与姿态精度。**

- **链接: [http://arxiv.org/pdf/2509.00831v1](http://arxiv.org/pdf/2509.00831v1)**
...
>
---
#### [new 186] Surface Defect Detection with Gabor Filter Using Reconstruction-Based Blurring U-Net-ViT
- **分类: cs.CV**

- **简介: 论文提出基于Gabor滤波器与重构型模糊U-Net-ViT模型的表面缺陷检测方法，解决纹理缺陷检测中噪声干扰与边界模糊问题。通过融合局部特征提取与全局建模，结合噪声抑制损失和纹理增强策略，提升多纹理数据集下的检测精度，实现平均AUC达0.939。**

- **链接: [http://arxiv.org/pdf/2509.00827v1](http://arxiv.org/pdf/2509.00827v1)**
...
>
---
#### [new 187] Decoupling Bidirectional Geometric Representations of 4D cost volume with 2D convolution
- **分类: cs.CV**

- **简介: 该论文针对立体匹配任务，解决传统方法在移动设备效率低及病态区域性能差的问题。提出DBStereo，通过2D卷积解耦4D成本体积的几何特征，设计轻量双向聚合模块，实现实时高精度匹配，超越现有方法。**

- **链接: [http://arxiv.org/pdf/2509.02415v1](http://arxiv.org/pdf/2509.02415v1)**
...
>
---
#### [new 193] LLaVA-Critic-R1: Your Critic Model is Secretly a Strong Policy Model
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出LLaVA-Critic-R1，通过强化学习将批评模型与策略模型统一，解决传统分离问题，实现生成与评估双优，超越专用推理模型。**

- **链接: [http://arxiv.org/pdf/2509.00676v1](http://arxiv.org/pdf/2509.00676v1)**

> **作者:** Xiyao Wang; Chunyuan Li; Jianwei Yang; Kai Zhang; Bo Liu; Tianyi Xiong; Furong Huang
>
> **摘要:** In vision-language modeling, critic models are typically trained to evaluate outputs -- assigning scalar scores or pairwise preferences -- rather than to generate responses. This separation from policy models, which produce the responses, is so entrenched that critics are rarely considered for direct policy use. In this work, we challenge this convention. We propose to reorganize preference-labeled critic datasets into verifiable training signals and perform reinforcement learning directly on a base generative model, producing LLaVA-Critic-R1, a multimodal critic trained to optimize preference judgments while retaining full generation ability. Surprisingly, LLaVA-Critic-R1 emerges not only as a top-performing critic but also as a competitive policy model -- matching or surpassing specialized reasoning VLMs trained with in-domain data across 26 visual reasoning and understanding benchmarks, with an average gain of +5.7% over its base model (Qwen-2.5-VL-7B). Extending this approach to existing strong reasoning VLMs yields LLaVA-Critic-R1+, which further advances policy performance without sacrificing critic quality, achieving a SoTA performance of 71.9 on MMMU at the 7B scale. Finally, we show that the enhanced critic ability benefits inference: applying self-critique at test time yields an average +13.8% improvement on five representative reasoning tasks without additional training. Our results reveal that RL training on critic data can produce a unified model excelling at both evaluation and generation, offering a simple path toward scalable, self-improving multimodal systems.
>
---
#### [new 194] Multi-Focused Video Group Activities Hashing
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出STVH和M-STVH方法，解决视频组活动检索中缺乏活动粒度的问题。STVH通过时空框架建模个体与群体交互，M-STVH引入多焦点学习整合活动语义与视觉特征，提升检索效率。**

- **链接: [http://arxiv.org/pdf/2509.00490v1](http://arxiv.org/pdf/2509.00490v1)**
...
>
---
#### [new 197] FastVGGT: Training-Free Acceleration of Visual Geometry Transformer
- **分类: cs.CV**

- **简介: 该论文针对3D视觉几何建模中长序列输入的推理效率低问题，提出FastVGGT方法，通过训练无关的token合并策略加速VGGT模型，减少冗余计算并保持重建能力，在1000张图像输入下实现4倍速度提升。**

- **链接: [http://arxiv.org/pdf/2509.02560v1](http://arxiv.org/pdf/2509.02560v1)**
...
>
---
#### [new 208] Latent Gene Diffusion for Spatial Transcriptomics Completion
- **分类: cs.CV**

- **简介: 该论文提出LGDiST，一种参考无关的潜在基因扩散模型，解决ST数据缺失问题。通过利用上下文基因构建生物意义的潜在空间，提升基因表达补全和预测性能。**

- **链接: [http://arxiv.org/pdf/2509.01864v1](http://arxiv.org/pdf/2509.01864v1)**
...
>
---
#### [new 215] Towards Early Detection: AI-Based Five-Year Forecasting of Breast Cancer Risk Using Digital Breast Tomosynthesis Imaging
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文提出基于深度学习的乳腺癌五年前瞻性风险预测框架，利用数字乳腺断层扫描数据，结合DINOv2编码器与累积危险层，解决传统模型效果有限及未整合DBT影像的问题，测试集AUROC达0.80。**

- **链接: [http://arxiv.org/pdf/2509.00900v1](http://arxiv.org/pdf/2509.00900v1)**
...
>
---
#### [new 219] Manipulation as in Simulation: Enabling Accurate Geometry Perception in Robots
...
>
---
#### [new 220] Articulated Object Estimation in the Wild
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 221] Protocol for Clustering 4DSTEM Data for Phase Differentiation in Glasses
- **分类: cond-mat.mtrl-sci; cs.CV; cs.LG**

- **简介: 该论文提出基于4D-STEM数据的聚类分析方法，解决相变材料纳米级异质性解析难题。通过PCA降维、t-SNE/UMAP验证及k-means聚类，识别出四类化学结构特征，揭示Ge-Sb-Te合金的局部成分与结构差异，为理解其相变机制提供新框架。**

- **链接: [http://arxiv.org/pdf/2509.00943v1](http://arxiv.org/pdf/2509.00943v1)**

> **作者:** Mridul Kumar; Yevgeny Rakita
>
> **摘要:** Phase-change materials (PCMs) such as Ge-Sb-Te alloys are widely used in non-volatile memory applications due to their rapid and reversible switching between amorphous and crystalline states. However, their functional properties are strongly governed by nanoscale variations in composition and structure, which are challenging to resolve using conventional techniques. Here, we apply unsupervised machine learning to 4-dimensional scanning transmission electron microscopy (4D-STEM) data to identify compositional and structural heterogeneity in Ge-Sb-Te. After preprocessing and dimensionality reduction with principal component analysis (PCA), cluster validation was performed with t-SNE and UMAP, followed by k-means clustering optimized through silhouette scoring. Four distinct clusters were identified which were mapped back to the diffraction data. Elemental intensity histograms revealed chemical signatures change across clusters, oxygen and germanium enrichment in Cluster 1, tellurium in Cluster 2, antimony in Cluster 3, and germanium again in Cluster 4. Furthermore, averaged diffraction patterns from these clusters confirmed structural variations. Together, these findings demonstrate that clustering analysis can provide a powerful framework for correlating local chemical and structural features in PCMs, offering deeper insights into their intrinsic heterogeneity.
>
---
#### [new 222] GS-TG: 3D Gaussian Splatting Accelerator with Tile Grouping for Reducing Redundant Sorting while Preserving Rasterization Efficiency
- **分类: cs.AR; cs.CV**

- **简介: 该论文提出GS-TG加速器，通过瓦片分组减少3D-GS渲染冗余排序，同时保持光栅化效率，解决实时应用FPS不足问题，实现1.54倍加速。**

- **链接: [http://arxiv.org/pdf/2509.00911v1](http://arxiv.org/pdf/2509.00911v1)**
...
>
---
#### [new 223] AutoDrive-R$^2$: Incentivizing Reasoning and Self-Reflection Capacity for VLA Model in Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 226] Chronotome: Real-Time Topic Modeling for Streaming Embedding Spaces
- **分类: cs.HC; cs.CL; cs.CV; cs.LG**

- **简介: 该论文提出Chronotome工具，解决时间序列数据语义变化捕捉难题，通过结合力导向投影与流式聚类，实现流式嵌入空间的实时主题建模与时空可视化分析。**

- **链接: [http://arxiv.org/pdf/2509.01051v1](http://arxiv.org/pdf/2509.01051v1)**
...
>
---
#### [new 228] Unifi3D: A Study on 3D Representations for Generation and Reconstruction in a Common Framework
- **分类: cs.GR; cs.CV; cs.LG**

- **简介: 该论文提出统一框架评估3D表示方法（如体素、点云等）在生成与重建中的表现，解决方法多样且缺乏系统评估的问题。通过比较质量、效率及泛化能力，揭示重建误差对性能的关键影响，为应用选择合适模型提供建议。**

- **链接: [http://arxiv.org/pdf/2509.02474v1](http://arxiv.org/pdf/2509.02474v1)**
...
>
---
#### [new 229] A-FloPS: Accelerating Diffusion Sampling with Adaptive Flow Path Sampler
- **分类: cs.LG; cs.CV; 68T07, 60H10, 65C30; I.2.6; G.1.7**

- **简介: 论文提出A-FloPS框架，通过重新参数化扩散模型采样轨迹为流匹配形式，并结合自适应速度分解，提升采样效率与质量。解决了扩散模型计算成本高的问题，在低NFE下实现高效生成，适用于图像生成等任务。**

- **链接: [http://arxiv.org/pdf/2509.00036v1](http://arxiv.org/pdf/2509.00036v1)**
...
>
---
#### [new 230] MultiStream-LLM: Bridging Modalities for Robust Sign Language Translation
- **分类: cs.CL; cs.CV**

- **简介: 该论文提出MultiStream-LLM框架，通过分离处理连续手语、手指拼写和唇读，融合后生成翻译，解决高速手指拼写和非手动线索整合问题，提升翻译准确性。**

- **链接: [http://arxiv.org/pdf/2509.00030v1](http://arxiv.org/pdf/2509.00030v1)**
...
>
---
#### [new 231] EgoTouch: On-Body Touch Input Using AR/VR Headset Cameras
...
>
---
#### [new 232] Lightning Fast Caching-based Parallel Denoising Prediction for Accelerating Talking Head Generation
- **分类: cs.GR; cs.AI; cs.CV**

- **简介: 该论文针对说话头像生成中推理速度慢的问题，提出LightningCP与DFA方法，通过缓存静态特征、并行预测及优化注意力机制，显著提升生成效率同时保持视频质量。**

- **链接: [http://arxiv.org/pdf/2509.00052v1](http://arxiv.org/pdf/2509.00052v1)**
...
>
---
#### [new 233] DCA: Graph-Guided Deep Embedding Clustering for Brain Atlases
- **分类: q-bio.NC; cs.AI; cs.CV**

- **简介: 论文提出DCA框架，通过图引导的深度嵌入聚类生成个体化脑图谱，解决传统图谱灵活性差、分辨率低的问题。结合预训练自编码器与空间正则化，提升功能同质性与空间连续性，并建立基准平台验证效果，优于现有方法。**

- **链接: [http://arxiv.org/pdf/2509.01426v1](http://arxiv.org/pdf/2509.01426v1)**
...
>
---
#### [new 234] Integrated Multivariate Segmentation Tree for the Analysis of Heterogeneous Credit Data in Small and Medium-Sized Enterprises
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出IMST框架，解决中小企业信用评估中异构数据（财务+文本）处理难题。通过矩阵分解、Lasso回归和多变量分割树提升准确率至88.9%，优于传统模型。**

- **链接: [http://arxiv.org/pdf/2509.00550v1](http://arxiv.org/pdf/2509.00550v1)**
...
>
---
#### [new 235] Reinforcement Learning of Dolly-In Filming Using a Ground-Based Robot
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [new 238] Embodied Spatial Intelligence: from Implicit Scene Modeling to Spatial Reasoning
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 239] Scale, Don't Fine-tune: Guiding Multimodal LLMs for Efficient Visual Place Recognition at Test-Time
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出一种无需微调的视觉场所识别方法，通过测试时扩展和结构化提示，利用多模态大模型的视觉-语言对齐能力，实现高效跨域识别与实时适应，显著提升计算效率。**

- **链接: [http://arxiv.org/pdf/2509.02129v1](http://arxiv.org/pdf/2509.02129v1)**

> **作者:** Jintao Cheng; Weibin Li; Jiehao Luo; Xiaoyu Tang; Zhijian He; Jin Wu; Yao Zou; Wei Zhang
>
> **摘要:** Visual Place Recognition (VPR) has evolved from handcrafted descriptors to deep learning approaches, yet significant challenges remain. Current approaches, including Vision Foundation Models (VFMs) and Multimodal Large Language Models (MLLMs), enhance semantic understanding but suffer from high computational overhead and limited cross-domain transferability when fine-tuned. To address these limitations, we propose a novel zero-shot framework employing Test-Time Scaling (TTS) that leverages MLLMs' vision-language alignment capabilities through Guidance-based methods for direct similarity scoring. Our approach eliminates two-stage processing by employing structured prompts that generate length-controllable JSON outputs. The TTS framework with Uncertainty-Aware Self-Consistency (UASC) enables real-time adaptation without additional training costs, achieving superior generalization across diverse environments. Experimental results demonstrate significant improvements in cross-domain VPR performance with up to 210$\times$ computational efficiency gains.
>
---
#### [new 240] Hybrid Perception and Equivariant Diffusion for Robust Multi-Node Rebar Tying
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 241] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出GRMM，解决传统3DMM分辨率低、神经方法速度慢的问题，通过残差几何与外观组件提升细节，实现实时高保真面部建模与表情控制。**

- **链接: [http://arxiv.org/pdf/2509.02141v1](http://arxiv.org/pdf/2509.02141v1)**
...
>
---
#### [new 242] VerlTool: Towards Holistic Agentic Reinforcement Learning with Tool Use
- **分类: cs.AI; cs.CL; cs.CV**

- **简介: 论文提出VerlTool框架，解决ARLT中工具整合碎片化、同步瓶颈及跨领域扩展问题，通过统一工具管理、异步执行与模块化设计提升效率，支持多模态多任务强化学习。**

- **链接: [http://arxiv.org/pdf/2509.01055v1](http://arxiv.org/pdf/2509.01055v1)**
...
>
---
#### [new 243] From Data to Decision: A Multi-Stage Framework for Class Imbalance Mitigation in Optical Network Failure Analysis
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出多阶段框架，解决光网络故障分析中的类别不平衡问题，通过比较预处理、处理及后处理方法，评估其在故障检测与识别中的效果，找出不同场景下的最优策略。**

- **链接: [http://arxiv.org/pdf/2509.00057v1](http://arxiv.org/pdf/2509.00057v1)**
...
>
---
#### [new 247] Galaxea Open-World Dataset and G0 Dual-System VLA Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 248] Robix: A Unified Model for Robot Interaction, Reasoning and Planning
...
>
---
#### [new 254] OpenTie: Open-vocabulary Sequential Rebar Tying System
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 255] IntrinsicReal: Adapting IntrinsicAnything from Synthetic to Real Objects
- **分类: cs.GR; cs.CV**

- **简介: 论文提出IntrinsicReal框架，解决合成到真实域的内在图像分解任务中的域差距问题。通过双伪标签策略微调IntrinsicAnything，提升真实数据上的albedo估计性能。**

- **链接: [http://arxiv.org/pdf/2509.00777v1](http://arxiv.org/pdf/2509.00777v1)**
...
>
---
#### [new 258] Efficient Pyramidal Analysis of Gigapixel Images on a Decentralized Modest Computer Cluster
- **分类: cs.DC; cs.CV**

- **简介: 论文提出PyramidAI技术，通过分层分析和负载均衡，高效处理超大图像，减少计算成本并缩短分析时间。**

- **链接: [http://arxiv.org/pdf/2509.02440v1](http://arxiv.org/pdf/2509.02440v1)**
...
>
---
#### [new 260] Energy Efficient Exact and Approximate Systolic Array Architecture for Matrix Multiplication
- **分类: cs.AR; cs.CV**

- **简介: 该论文设计用于矩阵乘法的节能流水线阵列，结合精确与近似处理单元，实现高能效与输出质量，适用于图像处理任务。**

- **链接: [http://arxiv.org/pdf/2509.00778v1](http://arxiv.org/pdf/2509.00778v1)**
...
#### [replaced 001] SPGrasp: Spatiotemporal Prompt-driven Grasp Synthesis in Dynamic Scenes
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 002] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
- **分类: cs.CV; cs.AI; cs.GR; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.10462v2](http://arxiv.org/pdf/2501.10462v2)**
...
>
---
#### [replaced 003] Reconstructing Tornadoes in 3D with Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.18677v2](http://arxiv.org/pdf/2506.18677v2)**

> **作者:** Adam Yang; Nadula Kadawedduwa; Tianfu Wang; Sunny Sharma; Emily F. Wisinski; Jhayron S. Pérez-Carrasquilla; Kyle J. C. Hall; Dean Calhoun; Jonathan Starfeldt; Timothy P. Canty; Maria Molina; Christopher Metzler
>
...
>
---
#### [replaced 004] FLAIR: Frequency- and Locality-Aware Implicit Neural Representations
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.13544v3](http://arxiv.org/pdf/2508.13544v3)**
...
>
---
#### [replaced 005] Removing Averaging: Personalized Lip-Sync Driven Characters Based on Identity Adapter
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.06397v2](http://arxiv.org/pdf/2503.06397v2)**

> **作者:** Yanyu Zhu; Lichen Bai; Jintao Xu; Hai-tao Zheng
>
...
>
---
#### [replaced 008] ELV-Halluc: Benchmarking Semantic Aggregation Hallucinations in Long Video Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.21496v2](http://arxiv.org/pdf/2508.21496v2)**
...
>
---
#### [replaced 009] Aligning Moments in Time using Video Queries
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15439v2](http://arxiv.org/pdf/2508.15439v2)**

> **作者:** Yogesh Kumar; Uday Agarwal; Manish Gupta; Anand Mishra
>
> **备注:** 11 pages, 4 figures, accepted at ICCV 2025
>
...
>
---
#### [replaced 010] DiffDecompose: Layer-Wise Decomposition of Alpha-Composited Images via Diffusion Transformers
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.21541v3](http://arxiv.org/pdf/2505.21541v3)**
...
>
---
#### [replaced 016] GPI-Net: Gestalt-Guided Parallel Interaction Network via Orthogonal Geometric Consistency for Robust Point Cloud Registration
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.14452v2](http://arxiv.org/pdf/2507.14452v2)**
...
>
---
#### [replaced 017] Lightweight Joint Optimization of General-Purpose Vision-Language Models and Retrievers for Medical Diagnosis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.17394v2](http://arxiv.org/pdf/2508.17394v2)**
...
>
---
#### [replaced 020] Depth3DLane: Monocular 3D Lane Detection via Depth Prior Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.18325v2](http://arxiv.org/pdf/2504.18325v2)**

> **作者:** Dongxin Lyu; Han Huang; Cheng Tan; Zimu Li
>
> **备注:** Submitting to AAAI2025
>
...
>
---
#### [replaced 021] OCR Hinders RAG: Evaluating the Cascading Impact of OCR on Retrieval-Augmented Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.02592v4](http://arxiv.org/pdf/2412.02592v4)**
...
>
---
#### [replaced 022] NOCTIS: Novel Object Cyclic Threshold based Instance Segmentation
- **分类: cs.CV; cs.AI; I.2; I.4; I.5**

- **链接: [http://arxiv.org/pdf/2507.01463v2](http://arxiv.org/pdf/2507.01463v2)**

> **作者:** Max Gandyra; Alessandro Santonicola; Michael Beetz
>
> **备注:** 10 pages, 3 figures, 5 tables, ICLR 2026 preprint
>
...
>
---
#### [replaced 025] OSMLoc: Single Image-Based Visual Localization in OpenStreetMap with Fused Geometric and Semantic Guidance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.08665v3](http://arxiv.org/pdf/2411.08665v3)**
...
>
---
#### [replaced 026] FreqSelect: Frequency-Aware fMRI-to-Image Reconstruction
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.12552v2](http://arxiv.org/pdf/2505.12552v2)**

> **作者:** Junliang Ye; Lei Wang; Md Zakir Hossain
>
> **备注:** Accepted at the British Machine Vision Conference (BMVC 2025)
>
...
>
---
#### [replaced 029] A Large-scale Benchmark on Geological Fault Delineation Models: Domain Shift, Training Dynamics, Generalizability, Evaluation and Inferential Behavior
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.08585v2](http://arxiv.org/pdf/2505.08585v2)**
...
>
---
#### [replaced 030] A multi-task neural network for atypical mitosis recognition under domain shift
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.21035v2](http://arxiv.org/pdf/2508.21035v2)**
...
>
---
#### [replaced 033] BusterX: MLLM-Powered AI-Generated Video Forgery Detection and Explanation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.12620v5](http://arxiv.org/pdf/2505.12620v5)**
...
>
---
#### [replaced 036] SC-Diff: 3D Shape Completion with Latent Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.12470v2](http://arxiv.org/pdf/2403.12470v2)**

> **作者:** Simon Schaefer; Juan D. Galvis; Xingxing Zuo; Stefan Leutengger
>
> **备注:** 13 pages
>
...
>
---
#### [replaced 037] CoViPAL: Layer-wise Contextualized Visual Token Pruning for Large Vision-Language Models
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.17243v2](http://arxiv.org/pdf/2508.17243v2)**
...
>
---
#### [replaced 038] Sim-to-Real Reinforcement Learning for Vision-Based Dexterous Manipulation on Humanoids
...
>
---
#### [replaced 039] Flip Learning: Weakly Supervised Erase to Segment Nodules in Breast Ultrasound
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.20685v3](http://arxiv.org/pdf/2503.20685v3)**
...
>
---
#### [replaced 052] A Survey on Vision-Language-Action Models for Embodied AI
...
>
---
#### [replaced 053] Occlusion Robustness of CLIP for Military Vehicle Classification
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.20760v2](http://arxiv.org/pdf/2508.20760v2)**
...
>
---
#### [replaced 055] A Data-Free Analytical Quantization Scheme for Deep Learning Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.07391v2](http://arxiv.org/pdf/2412.07391v2)**

> **作者:** Ahmed Luqman; Khuzemah Qazi; Murray Patterson; Malik Jehan Khan; Imdadullah Khan
>
...
>
---
#### [replaced 056] Towards Human-Level 3D Relative Pose Estimation: Generalizable, Training-Free, with Single Reference
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2406.18453v2](http://arxiv.org/pdf/2406.18453v2)**
...
>
---
#### [replaced 063] Demographic-aware fine-grained classification of pediatric wrist fractures
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.12964v4](http://arxiv.org/pdf/2507.12964v4)**
...
>
---
#### [replaced 067] Temporal Preference Optimization for Long-Form Video Understanding
...
>
---
#### [replaced 068] DIO: Refining Mutual Information and Causal Chain to Enhance Machine Abstract Reasoning Ability
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15387v3](http://arxiv.org/pdf/2508.15387v3)**
...
>
---
#### [replaced 069] Diagnosing Reliability in Text-Guided Medical Image Editing
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.01921v4](http://arxiv.org/pdf/2506.01921v4)**
...
>
---
#### [replaced 070] Accelerating Diffusion Sampling via Exploiting Local Transition Coherence
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.09675v2](http://arxiv.org/pdf/2503.09675v2)**
...
>
---
#### [replaced 073] StylizedGS: Controllable Stylization for 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.05220v3](http://arxiv.org/pdf/2404.05220v3)**

> **作者:** Dingxi Zhang; Yu-Jie Yuan; Zhuoxun Chen; Fang-Lue Zhang; Zhenliang He; Shiguang Shan; Lin Gao
>
> **备注:** [TPAMI 2025] Project Page: https://kristen-z.github.io/stylizedgs/
>
...
>
---
#### [replaced 079] Efficient and Privacy-Protecting Background Removal for 2D Video Streaming using iPhone 15 Pro Max LiDAR
- **分类: eess.IV; cs.CV; cs.MM; 68T45, 68U10; I.4.6; I.4.8; H.5.1; I.2.10**

- **链接: [http://arxiv.org/pdf/2508.20250v2](http://arxiv.org/pdf/2508.20250v2)**
...
>
---
#### [replaced 080] FedMVP: Federated Multimodal Visual Prompt Tuning for Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.20860v2](http://arxiv.org/pdf/2504.20860v2)**
...
>
---
#### [replaced 084] Pathology-Aware Adaptive Watermarking for Text-Driven Medical Image Synthesis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.08346v2](http://arxiv.org/pdf/2503.08346v2)**
...
>
---
#### [replaced 085] A versatile foundation model for cine cardiac magnetic resonance image analysis tasks
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.00679v2](http://arxiv.org/pdf/2506.00679v2)**
...
>
---
#### [replaced 088] SequencePAR: Understanding Pedestrian Attributes via A Sequence Generation Paradigm
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2312.01640v2](http://arxiv.org/pdf/2312.01640v2)**

> **作者:** Jiandong Jin; Xiao Wang; Yin Lin; Chenglong Li; Lili Huang; Aihua Zheng; Jin Tang
>
> **备注:** Accepted by Pattern Recognition 2025
>
...
>
---
#### [replaced 089] TPA: Temporal Prompt Alignment for Fetal Congenital Heart Defect Classification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15298v4](http://arxiv.org/pdf/2508.15298v4)**
...
>
---
#### [replaced 090] Structuring GUI Elements through Vision Language Models: Towards Action Space Generation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.16271v2](http://arxiv.org/pdf/2508.16271v2)**
...
>
---
#### [replaced 095] IC-Custom: Diverse Image Customization via In-Context Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.01926v2](http://arxiv.org/pdf/2507.01926v2)**
...
>
---
#### [replaced 103] Micro-splatting: Multistage Isotropy-informed Covariance Regularization Optimization for High-Fidelity 3D Gaussian Splatting
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.05740v2](http://arxiv.org/pdf/2504.05740v2)**
...
>
---
#### [replaced 104] A Hybrid Fully Convolutional CNN-Transformer Model for Inherently Interpretable Disease Detection from Retinal Fundus Images
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.08481v4](http://arxiv.org/pdf/2504.08481v4)**

> **作者:** Kerol Djoumessi; Samuel Ofosu Mensah; Philipp Berens
>
> **备注:** Accepted at the Workshop on Interpretability of Machine Intelligence in Medical Image Computing (IMIMIC) at MICCAI 2025 for oral presentation
>
...
>
---
#### [replaced 109] StoryReasoning Dataset: Using Chain-of-Thought for Scene Understanding and Grounded Story Generation
- **分类: cs.CV; cs.CL; I.2.10; I.2.7**

- **链接: [http://arxiv.org/pdf/2505.10292v2](http://arxiv.org/pdf/2505.10292v2)**
...
>
---
#### [replaced 110] Fine-grained Image Quality Assessment for Perceptual Image Restoration
- **分类: eess.IV; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2508.14475v2](http://arxiv.org/pdf/2508.14475v2)**
...
>
---
#### [replaced 111] Detecting Visual Information Manipulation Attacks in Augmented Reality: A Multimodal Semantic Reasoning Approach
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.20356v4](http://arxiv.org/pdf/2507.20356v4)**
...
>
---
#### [replaced 114] ACD-CLIP: Decoupling Representation and Dynamic Fusion for Zero-Shot Anomaly Detection
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.07819v4](http://arxiv.org/pdf/2508.07819v4)**

> **作者:** Ke Ma; Jun Long; Hongxiao Fei; Liujie Hua; Yiran Qian; Zhen Dai; Yueyi Luo
>
> **备注:** 4 pages, 1 reference, 3 figures
>
...
>
---
#### [replaced 115] MSC: A Marine Wildlife Video Dataset with Grounded Segmentation and Clip-Level Captioning
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2508.04549v3](http://arxiv.org/pdf/2508.04549v3)**
...
>
---
#### [replaced 118] R-4B: Incentivizing General-Purpose Auto-Thinking Capability in MLLMs via Bi-Mode Annealing and Reinforce Learning
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.21113v2](http://arxiv.org/pdf/2508.21113v2)**
...
>
---
#### [replaced 125] Exploiting Diffusion Prior for Task-driven Image Restoration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.22459v2](http://arxiv.org/pdf/2507.22459v2)**

> **作者:** Jaeha Kim; Junghun Oh; Kyoung Mu Lee
>
> **备注:** Accepted to ICCV 2025. Code is available at https://github.com/JaehaKim97/EDTR
>
...
>
---
#### [replaced 134] SpatialViz-Bench: An MLLM Benchmark for Spatial Visualization
- **分类: cs.CV; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2507.07610v4](http://arxiv.org/pdf/2507.07610v4)**
...
>
---
#### [replaced 137] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.15737v2](http://arxiv.org/pdf/2505.15737v2)**
...
>
---
#### [replaced 138] So-Fake: Benchmarking and Explaining Social Media Image Forgery Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18660v2](http://arxiv.org/pdf/2505.18660v2)**
...
>
---
#### [replaced 139] Multimodal Conditional 3D Face Geometry Generation
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2407.01074v2](http://arxiv.org/pdf/2407.01074v2)**

> **作者:** Christopher Otto; Prashanth Chandran; Sebastian Weiss; Markus Gross; Gaspard Zoss; Derek Bradley
>
> **备注:** Added more evaluation since the first version. Accepted to SMI 2025. Computers & Graphics
>
...
>
---
#### [replaced 140] KRETA: A Benchmark for Korean Reading and Reasoning in Text-Rich VQA Attuned to Diverse Visual Contexts
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19944v2](http://arxiv.org/pdf/2508.19944v2)**
...
>
---
#### [replaced 141] CF3: Compact and Fast 3D Feature Fields
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.05254v3](http://arxiv.org/pdf/2508.05254v3)**
...
>
---
#### [replaced 144] Memory-Efficient Personalization of Text-to-Image Diffusion Models via Selective Optimization Strategies
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.10029v2](http://arxiv.org/pdf/2507.10029v2)**

> **作者:** Seokeon Choi; Sunghyun Park; Hyoungwoo Park; Jeongho Kim; Sungrack Yun
>
> **备注:** Accepted to ICCV 2025 LIMIT Workshop (4-page short paper). Extended version in preparation
>
...
>
---
#### [replaced 148] Does Acceleration Cause Hidden Instability in Vision Language Models? Uncovering Instance-Level Divergence Through a Large-Scale Empirical Study
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.06794v4](http://arxiv.org/pdf/2503.06794v4)**
...
>
---
#### [replaced 154] DivScene: Towards Open-Vocabulary Object Navigation with Large Vision Language Models in Diverse Scenes
...
>
---
#### [replaced 155] Street Gaussians without 3D Object Tracker
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.05548v4](http://arxiv.org/pdf/2412.05548v4)**
...
>
---
#### [replaced 157] MultiverSeg: Scalable Interactive Segmentation of Biomedical Imaging Datasets with In-Context Guidance
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2412.15058v2](http://arxiv.org/pdf/2412.15058v2)**

> **作者:** Hallee E. Wong; Jose Javier Gonzalez Ortiz; John Guttag; Adrian V. Dalca
>
> **备注:** Accepted by ICCV 2025. Project Website: https://multiverseg.csail.mit.edu Keywords: interactive segmentation, in-context learning, medical image analysis, biomedical imaging, image annotation, visual prompting
>
...
>
---
#### [replaced 158] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00554v3](http://arxiv.org/pdf/2507.00554v3)**
...
>
---
#### [replaced 159] Towards Efficient and Accurate Spiking Neural Networks via Adaptive Bit Allocation
- **分类: cs.NE; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.23717v2](http://arxiv.org/pdf/2506.23717v2)**
...
>
---
#### [replaced 162] Gaussian Mixture Flow Matching Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.05304v3](http://arxiv.org/pdf/2504.05304v3)**
