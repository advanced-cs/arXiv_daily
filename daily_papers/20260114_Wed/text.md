...
#### [new 001] Fine-Mem: Fine-Grained Feedback Alignment for Long-Horizon Memory Management
- **分类: cs.CL**

- **简介: 该论文属于长周期任务中的记忆管理问题，旨在解决奖励稀疏和信用分配无效的问题。提出Fine-Mem框架，通过分块奖励和证据锚定方法，提升记忆操作的准确性与长期效用。**

- **链接: [https://arxiv.org/pdf/2601.08435v1](https://arxiv.org/pdf/2601.08435v1)**
...
>
---
#### [new 002] Explaining Generalization of AI-Generated Text Detectors Through Linguistic Analysis
- **分类: cs.CL**

- **简介: 该论文属于AI文本检测任务，旨在解决模型泛化能力不足的问题。通过语言分析，研究不同生成条件下的检测性能差异，并探索影响泛化的语言特征。**

- **链接: [https://arxiv.org/pdf/2601.07974v1](https://arxiv.org/pdf/2601.07974v1)**
...
>
---
#### [new 005] Med-CoReasoner: Reducing Language Disparities in Medical Reasoning via Language-Informed Co-Reasoning
- **分类: cs.CL**

- **简介: 该论文属于多语言医疗推理任务，旨在解决本地语言推理能力弱于英语的问题。提出Med-CoReasoner框架，通过中英并行推理与知识融合提升多语言医疗推理性能。**

- **链接: [https://arxiv.org/pdf/2601.08267v1](https://arxiv.org/pdf/2601.08267v1)**
...
>
---
#### [new 010] User-Oriented Multi-Turn Dialogue Generation with Tool Use at scale
- **分类: cs.CL**

- **简介: 该论文属于对话生成任务，旨在解决多轮工具使用对话生成的规模与真实性问题。通过用户导向的模拟框架，生成更真实、长轮次的对话数据。**

- **链接: [https://arxiv.org/pdf/2601.08225v1](https://arxiv.org/pdf/2601.08225v1)**

> **作者:** Jungho Cho; Minbyul Jeong; Sungrae Park
>
> **摘要:** The recent paradigm shift toward large reasoning models (LRMs) as autonomous agents has intensified the demand for sophisticated, multi-turn tool-use capabilities. Yet, existing datasets and data-generation approaches are limited by static, predefined toolsets that cannot scale to the complexity of open-ended human-agent collaboration. To address this, we initially developed a framework for automated task-oriented multi-turn dialogue generation at scale, utilizing an LRM-based simulator to dynamically generate high-value, domain-specific tools to solve specified tasks. However, we observe that a purely task-oriented design often results in "solely task-solving" trajectories, where the agent completes the objective with minimal interaction, failing to generate the high turn-count conversations seen in realistic scenarios. To bridge this gap, we shift toward a user-oriented simulation paradigm. By decoupling task generation from a dedicated user simulator that mimics human behavioral rules - such as incremental request-making and turn-by-turn feedback - we facilitate more authentic, extended multi-turn dialogues that reflect the iterative nature of real-world problem solving. Our generation pipeline operates as a versatile, plug-and-play module capable of initiating generation from any state, ensuring high scalability in producing extended tool-use data. Furthermore, by facilitating multiple task completions within a single trajectory, it yields a high-density dataset that reflects the multifaceted demands of real-world human-agent interaction.
>
---
#### [new 011] A Parallel Cross-Lingual Benchmark for Multimodal Idiomaticity Understanding
- **分类: cs.CL**

- **简介: 该论文提出XMPIE，一个跨语言、多模态的潜在习语数据集，用于评估NLP系统在多语言和多模态下的习语理解能力。任务为多模态习语理解，解决习语在不同语言和模态间的迁移与共享问题。**

- **链接: [https://arxiv.org/pdf/2601.08645v1](https://arxiv.org/pdf/2601.08645v1)**
...
>
---
#### [new 015] RAGShaper: Eliciting Sophisticated Agentic RAG Skills via Automated Data Synthesis
- **分类: cs.CL**

- **简介: 该论文提出RAGShaper，解决RAG代理训练数据不足问题，通过自动化数据合成提升代理在复杂环境中的鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.08699v1](https://arxiv.org/pdf/2601.08699v1)**

> **作者:** Zhengwei Tao; Bo Li; Jialong Wu; Guochen Yan; Huanyao Zhang; Jiahao Xu; Haitao Mi; Wentao Zhang
>
> **摘要:** Agentic Retrieval-Augmented Generation (RAG) empowers large language models to autonomously plan and retrieve information for complex problem-solving. However, the development of robust agents is hindered by the scarcity of high-quality training data that reflects the noise and complexity of real-world retrieval environments. Conventional manual annotation is unscalable and often fails to capture the dynamic reasoning strategies required to handle retrieval failures. To bridge this gap, we introduce RAGShaper, a novel data synthesis framework designed to automate the construction of RAG tasks and robust agent trajectories. RAGShaper incorporates an InfoCurator to build dense information trees enriched with adversarial distractors spanning Perception and Cognition levels. Furthermore, we propose a constrained navigation strategy that forces a teacher agent to confront these distractors, thereby eliciting trajectories that explicitly demonstrate error correction and noise rejection. Comprehensive experiments confirm that models trained on our synthesized corpus significantly outperform existing baselines, exhibiting superior robustness in noise-intensive and complex retrieval tasks.
>
---
#### [new 016] Ministral 3
- **分类: cs.CL**

- **简介: 该论文介绍Ministral 3系列参数高效语言模型，解决计算和内存受限场景下的语言处理问题，通过级联蒸馏方法训练不同规模模型，支持图像理解。**

- **链接: [https://arxiv.org/pdf/2601.08584v1](https://arxiv.org/pdf/2601.08584v1)**
...
>
> **备注:** Release page: https://mistral.ai/news/mistral-3 ; Models available at https://huggingface.co/collections/mistralai/ministral-3
>
> **摘要:** We introduce the Ministral 3 series, a family of parameter-efficient dense language models designed for compute and memory constrained applications, available in three model sizes: 3B, 8B, and 14B parameters. For each model size, we release three variants: a pretrained base model for general-purpose use, an instruction finetuned, and a reasoning model for complex problem-solving. In addition, we present our recipe to derive the Ministral 3 models through Cascade Distillation, an iterative pruning and continued training with distillation technique. Each model comes with image understanding capabilities, all under the Apache 2.0 license.
>
---
#### [new 017] sui-1: Grounded and Verifiable Long-Form Summarization
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于摘要生成任务，旨在解决长文本摘要缺乏可验证性的问题。提出sui-1模型，生成带引用的摘要，使用户能追溯每项陈述来源。**

- **链接: [https://arxiv.org/pdf/2601.08472v1](https://arxiv.org/pdf/2601.08472v1)**
...
>
---
#### [new 023] Silence the Judge: Reinforcement Learning with Self-Verifier via Latent Geometric Clustering
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于强化学习任务，旨在解决LLM训练中依赖外部验证器导致的高成本和低效率问题。通过引入基于潜在空间几何的内在奖励机制，提升训练效率与模型性能。**

- **链接: [https://arxiv.org/pdf/2601.08427v1](https://arxiv.org/pdf/2601.08427v1)**
...
>
---
#### [new 030] To Retrieve or To Think? An Agentic Approach for Context Evolution
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识密集型推理任务，旨在解决传统方法冗余检索导致效率低下的问题。提出ACE框架，通过动态决策优化上下文演化，提升准确率并减少计算开销。**

- **链接: [https://arxiv.org/pdf/2601.08747v1](https://arxiv.org/pdf/2601.08747v1)**
...
>
---
#### [new 033] ExpSeek: Self-Triggered Experience Seeking for Web Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于Web代理任务，解决经验干预适应性差的问题。提出ExpSeek，通过熵阈值主动寻求经验，提升代理性能。**

- **链接: [https://arxiv.org/pdf/2601.08605v1](https://arxiv.org/pdf/2601.08605v1)**
...
>
---
#### [new 034] How Order-Sensitive Are LLMs? OrderProbe for Deterministic Structural Reconstruction
- **分类: cs.CL**

- **简介: 该论文研究LLMs在结构重建任务中的表现，解决其对输入顺序敏感性的问题。通过OrderProbe基准测试，评估模型恢复固定结构的能力。**

- **链接: [https://arxiv.org/pdf/2601.08626v1](https://arxiv.org/pdf/2601.08626v1)**
...
>
---
#### [new 035] Cross-Cultural Expert-Level Art Critique Evaluation with Vision-Language Models
- **分类: cs.CL**

- **简介: 该论文属于跨文化艺术评价任务，旨在解决VLMs在文化意义理解上的不足。通过三阶段框架评估模型，提升文化理解准确性并诊断文化差距。**

- **链接: [https://arxiv.org/pdf/2601.07984v1](https://arxiv.org/pdf/2601.07984v1)**
...
>
---
#### [new 036] Nationality and Region Prediction from Names: A Comparative Study of Neural Models and Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于国籍与地区预测任务，旨在解决传统模型在低频和相似国籍识别上的不足。通过比较神经模型与大语言模型，验证了LLMs在知识利用上的优势。**

- **链接: [https://arxiv.org/pdf/2601.08692v1](https://arxiv.org/pdf/2601.08692v1)**
...
>
---
#### [new 037] PATS: Personality-Aware Teaching Strategies with Large Language Model Tutors
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于教育技术任务，旨在解决LLM tutors与学生个性不匹配的问题。通过构建教学策略与人格类型的关联，调整教学方法以提升效果。**

- **链接: [https://arxiv.org/pdf/2601.08402v1](https://arxiv.org/pdf/2601.08402v1)**
...
>
---
#### [new 038] BenchOverflow: Measuring Overflow in Large Language Models via Plain-Text Prompts
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于模型可靠性研究，解决LLM输出过长的问题。通过设计测试方法，分析不同模型的溢出现象，提出轻量级缓解方案。**

- **链接: [https://arxiv.org/pdf/2601.08490v1](https://arxiv.org/pdf/2601.08490v1)**

> **作者:** Erin Feiglin; Nir Hutnik; Raz Lapid
>
> **备注:** Accepted at TMLR 2026
>
> **摘要:** We investigate a failure mode of large language models (LLMs) in which plain-text prompts elicit excessive outputs, a phenomenon we term Overflow. Unlike jailbreaks or prompt injection, Overflow arises under ordinary interaction settings and can lead to elevated serving cost, latency, and cross-user performance degradation, particularly when scaled across many requests. Beyond usability, the stakes are economic and environmental: unnecessary tokens increase per-request cost and energy consumption, compounding into substantial operational spend and carbon footprint at scale. Moreover, Overflow represents a practical vector for compute amplification and service degradation in shared environments. We introduce BenchOverflow, a model-agnostic benchmark of nine plain-text prompting strategies that amplify output volume without adversarial suffixes or policy circumvention. Using a standardized protocol with a fixed budget of 5000 new tokens, we evaluate nine open- and closed-source models and observe pronounced rightward shifts and heavy tails in length distributions. Cap-saturation rates (CSR@1k/3k/5k) and empirical cumulative distribution functions (ECDFs) quantify tail risk; within-prompt variance and cross-model correlations show that Overflow is broadly reproducible yet heterogeneous across families and attack vectors. A lightweight mitigation-a fixed conciseness reminder-attenuates right tails and lowers CSR for all strategies across the majority of models. Our findings position length control as a measurable reliability, cost, and sustainability concern rather than a stylistic quirk. By enabling standardized comparison of length-control robustness across models, BenchOverflow provides a practical basis for selecting deployments that minimize resource waste and operating expense, and for evaluating defenses that curb compute amplification without eroding task performance.
>
---
#### [new 039] STAGE: A Benchmark for Knowledge Graph Construction, Question Answering, and In-Script Role-Playing over Movie Screenplays
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出STAGE基准，用于电影剧本的叙事理解任务，解决模型构建连贯故事世界并进行多任务推理的问题。**

- **链接: [https://arxiv.org/pdf/2601.08510v1](https://arxiv.org/pdf/2601.08510v1)**
...
>
> **摘要:** Large language models often solve complex reasoning tasks more effectively with Chain-of-Thought (CoT), but at the cost of long, low-bandwidth token sequences. Humans, by contrast, often reason softly by maintaining a distribution over plausible next steps. Motivated by this, we propose Multiplex Thinking, a stochastic soft reasoning mechanism that, at each thinking step, samples K candidate tokens and aggregates their embeddings into a single continuous multiplex token. This preserves the vocabulary embedding prior and the sampling dynamics of standard discrete generation, while inducing a tractable probability distribution over multiplex rollouts. Consequently, multiplex trajectories can be directly optimized with on-policy reinforcement learning (RL). Importantly, Multiplex Thinking is self-adaptive: when the model is confident, the multiplex token is nearly discrete and behaves like standard CoT; when it is uncertain, it compactly represents multiple plausible next steps without increasing sequence length. Across challenging math reasoning benchmarks, Multiplex Thinking consistently outperforms strong discrete CoT and RL baselines from Pass@1 through Pass@1024, while producing shorter sequences. The code and checkpoints are available at https://github.com/GMLR-Penn/Multiplex-Thinking.
>
---
#### [new 044] CLaS-Bench: A Cross-Lingual Alignment and Steering Benchmark
- **分类: cs.CL**

- **简介: 该论文提出CLaS-Bench，用于评估多语言大模型的语种控制与语义相关性，解决跨语言调整方法的量化问题。**

- **链接: [https://arxiv.org/pdf/2601.08331v1](https://arxiv.org/pdf/2601.08331v1)**
...
>
---
#### [new 046] WISE-Flow: Workflow-Induced Structured Experience for Self-Evolving Conversational Service Agents
- **分类: cs.CL**

- **简介: 该论文提出WISE-Flow框架，解决对话系统在新任务中易出错、重复失败的问题。通过流程化经验提升代理的自进化能力。**

- **链接: [https://arxiv.org/pdf/2601.08158v1](https://arxiv.org/pdf/2601.08158v1)**
...
>
---
#### [new 047] A Human-Centric Pipeline for Aligning Large Language Models with Chinese Medical Ethics
- **分类: cs.CL**

- **简介: 该论文属于医疗伦理对齐任务，旨在解决大语言模型在中文医疗场景下的伦理对齐问题。通过构建基准和引入评估框架，提升模型的伦理决策能力。**

- **链接: [https://arxiv.org/pdf/2601.07954v1](https://arxiv.org/pdf/2601.07954v1)**

> **作者:** Haoan Jin; Han Ying; Jiacheng Ji; Hanhui Xu; Mengyue Wu
>
...
>
---
#### [new 050] Towards Principled Design of Mixture-of-Experts Language Models under Memory and Inference Constraints
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理中的模型设计任务，旨在解决MoE架构在内存和推理约束下的优化问题。通过分析总参数和专家稀疏性，提出优化设计原则。**

- **链接: [https://arxiv.org/pdf/2601.08215v1](https://arxiv.org/pdf/2601.08215v1)**

> **作者:** Seng Pei Liew; Kenta Shinzato; Yuyang Dong
>
> **备注:** 10 pages, 5 figures
>
> **摘要:** Modern Mixture-of-Experts (MoE) language models are designed based on total parameters (memory footprint) and active parameters (inference cost). However, we find these two factors alone are insufficient to describe an optimal architecture. Through a systematic study, we demonstrate that MoE performance is primarily determined by total parameters ($N_{total}$) and expert sparsity ($s:=n_{exp}/n_{topk}$). Moreover, $n_{exp}$ and $n_{topk}$ do not "cancel out" within the sparsity ratio; instead, a larger total number of experts slightly penalizes performance by forcing a reduction in core model dimensions (depth and width) to meet memory constraints. This motivates a simple principle for MoE design which maximizes $N_{total}$ while minimizing $s$ (maximizing $n_{topk}$) and $n_{exp}$ under the given constraints. Our findings provide a robust framework for resolving architectural ambiguity and guiding MoE design.
>
---
#### [new 051] Discovery and Reinforcement of Tool-Integrated Reasoning Chains via Rollout Trees
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决长链推理中工具集成的问题。提出DART框架，通过强化学习自动发现并强化工具使用路径，提升模型推理能力。**

- **链接: [https://arxiv.org/pdf/2601.08274v1](https://arxiv.org/pdf/2601.08274v1)**

> **作者:** Kun Li; Zenan Xu; Junan Li; Zengrui Jin; Jinghao Deng; Zexuan Qiu; Bo Zhou
>
> **摘要:** Tool-Integrated Reasoning has emerged as a key paradigm to augment Large Language Models (LLMs) with computational capabilities, yet integrating tool-use into long Chain-of-Thought (long CoT) remains underexplored, largely due to the scarcity of training data and the challenge of integrating tool-use without compromising the model's intrinsic long-chain reasoning. In this paper, we introduce DART (Discovery And Reinforcement of Tool-Integrated Reasoning Chains via Rollout Trees), a reinforcement learning framework that enables spontaneous tool-use during long CoT reasoning without human annotation. DART operates by constructing dynamic rollout trees during training to discover valid tool-use opportunities, branching out at promising positions to explore diverse tool-integrated trajectories. Subsequently, a tree-based process advantage estimation identifies and credits specific sub-trajectories where tool invocation positively contributes to the solution, effectively reinforcing these beneficial behaviors. Extensive experiments on challenging benchmarks like AIME and GPQA-Diamond demonstrate that DART significantly outperforms existing methods, successfully harmonizing tool execution with long CoT reasoning.
>
---
#### [new 052] Get away with less: Need of source side data curation to build parallel corpus for low resource Machine Translation
- **分类: cs.CL**

- **简介: 该论文属于机器翻译任务，旨在解决低资源语言数据不足的问题。通过源端数据筛选框架LALITA，提升平行语料质量，减少训练数据需求并提高翻译效果。**

- **链接: [https://arxiv.org/pdf/2601.08629v1](https://arxiv.org/pdf/2601.08629v1)**
...
>
---
#### [new 053] QuantEval: A Benchmark for Financial Quantitative Tasks in Large Language Models
- **分类: cs.CL**

- **简介: 该论文提出QuantEval，用于评估大语言模型在量化金融任务中的表现，解决现有评估碎片化问题，涵盖知识问答、数学推理和策略编码，并引入真实回测框架。**

- **链接: [https://arxiv.org/pdf/2601.08689v1](https://arxiv.org/pdf/2601.08689v1)**
...
>
---
#### [new 054] Calibration Is Not Enough: Evaluating Confidence Estimation Under Language Variations
- **分类: cs.CL**

- **简介: 该论文属于语言模型置信度评估任务，解决现有方法在语言变化下的可靠性问题。提出新框架，评估置信度的鲁棒性、稳定性与敏感性。**

- **链接: [https://arxiv.org/pdf/2601.08064v1](https://arxiv.org/pdf/2601.08064v1)**
...
>
---
#### [new 062] Lessons from the Field: An Adaptable Lifecycle Approach to Applied Dialogue Summarization
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于对话摘要任务，旨在解决动态环境下生成高质量摘要的挑战。通过案例研究，提出适应性生命周期方法，探讨评估、优化、数据瓶颈及供应商锁定等问题。**

- **链接: [https://arxiv.org/pdf/2601.08682v1](https://arxiv.org/pdf/2601.08682v1)**
...
>
---
#### [new 066] Generation-Augmented Generation: A Plug-and-Play Framework for Private Knowledge Injection in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于知识注入任务，旨在解决私有领域知识在大模型中的高效注入问题。提出GAG框架，通过生成增强生成方式实现可靠、可扩展的知识注入。**

- **链接: [https://arxiv.org/pdf/2601.08209v1](https://arxiv.org/pdf/2601.08209v1)**
...
>
---
#### [new 067] DYCP: Dynamic Context Pruning for Long-Form Dialogue with LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于长对话任务，解决LLM响应延迟和质量下降问题，提出DyCP方法实现动态上下文管理，提升效率与准确性。**

- **链接: [https://arxiv.org/pdf/2601.07994v1](https://arxiv.org/pdf/2601.07994v1)**
...
>
---
#### [new 074] Cultural Compass: A Framework for Organizing Societal Norms to Detect Violations in Human-AI Conversations
- **分类: cs.CY; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理中的文化规范检测任务，旨在解决AI在跨文化对话中违反社会规范的问题。提出一种规范分类框架，用于评估模型的规范遵循情况。**

- **链接: [https://arxiv.org/pdf/2601.07973v1](https://arxiv.org/pdf/2601.07973v1)**
...
- **简介: 该论文提出APEX-SWE，评估AI在软件工程中的生产力。解决AI模型执行实际软件任务的能力问题，通过集成与可观测性任务进行评估。**

- **链接: [https://arxiv.org/pdf/2601.08806v1](https://arxiv.org/pdf/2601.08806v1)**
...
>
---
#### [new 081] PosIR: Position-Aware Heterogeneous Information Retrieval Benchmark
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决位置偏差问题。通过构建PosIR基准，分析模型对相关信息位置的敏感性，揭示其在长文本中的位置偏好。**

- **链接: [https://arxiv.org/pdf/2601.08363v1](https://arxiv.org/pdf/2601.08363v1)**

> **作者:** Ziyang Zeng; Dun Zhang; Yu Yan; Xu Sun; Yudong Zhou; Yuqing Yang
>
> **备注:** This research is driven by a strong academic interest, and we welcome further exchange and discussion with peers
>
...
>
---
#### [new 082] When KV Cache Reuse Fails in Multi-Agent Systems: Cross-Candidate Interaction is Crucial for LLM Judges
- **分类: cs.MA; cs.CL**

- **简介: 该论文研究多智能体系统中KV缓存重用对LLM评判器的影响，指出其可能导致判断不一致。任务为提升推理效率，解决缓存重用引发的评判偏差问题，通过实验与分析提出风险评估方法。**

- **链接: [https://arxiv.org/pdf/2601.08343v1](https://arxiv.org/pdf/2601.08343v1)**

> **作者:** Sichu Liang; Zhenglin Wang; Jiajia Chu; Pengfei Xia; Hui Zang; Deyu Zhou
>
> **摘要:** Multi-agent LLM systems routinely generate multiple candidate responses that are aggregated by an LLM judge. To reduce the dominant prefill cost in such pipelines, recent work advocates KV cache reuse across partially shared contexts and reports substantial speedups for generation agents. In this work, we show that these efficiency gains do not transfer uniformly to judge-centric inference. Across GSM8K, MMLU, and HumanEval, we find that reuse strategies that are effective for execution agents can severely perturb judge behavior: end-task accuracy may appear stable, yet the judge's selection becomes highly inconsistent with dense prefill. We quantify this risk using Judge Consistency Rate (JCR) and provide diagnostics showing that reuse systematically weakens cross-candidate attention, especially for later candidate blocks. Our ablation further demonstrates that explicit cross-candidate interaction is crucial for preserving dense-prefill decisions. Overall, our results identify a previously overlooked failure mode of KV cache reuse and highlight judge-centric inference as a distinct regime that demands dedicated, risk-aware system design.
>
---
#### [new 083] Parallel Context-of-Experts Decoding for Retrieval Augmented Generation
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于检索增强生成任务，解决多文档推理与速度之间的矛盾。提出Pced框架，通过并行专家解码实现跨文档交互，提升推理能力且不依赖注意力机制。**

- **链接: [https://arxiv.org/pdf/2601.08670v1](https://arxiv.org/pdf/2601.08670v1)**

> **作者:** Giulio Corallo; Paolo Papotti
>
> **摘要:** Retrieval Augmented Generation faces a trade-off: concatenating documents in a long prompt enables multi-document reasoning but creates prefill bottlenecks, while encoding document KV caches separately offers speed but breaks cross-document interaction. We propose Parallel Context-of-Experts Decoding (Pced), a training-free framework that shifts evidence aggregation from the attention mechanism to the decoding. Pced treats retrieved documents as isolated "experts", synchronizing their predictions via a novel retrieval-aware contrastive decoding rule that weighs expert logits against the model prior. This approach recovers cross-document reasoning capabilities without constructing a shared attention across documents.
>
---
#### [new 084] Sliced-Wasserstein Distribution Alignment Loss Improves the Ultra-Low-Bit Quantization of Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于模型量化任务，旨在解决低比特量化导致的性能下降问题。通过引入切片Wasserstein损失函数，对齐全精度与量化模型的分布，提升量化后模型的性能。**

- **链接: [https://arxiv.org/pdf/2601.07878v1](https://arxiv.org/pdf/2601.07878v1)**

> **作者:** Deyu Cao; Yixin Yin; Samin Aref
>
> **备注:** Post-peer-review accepted manuscript, 17 pages including the supplementary information
>
...
>
---
#### [new 085] Asymptotic Universal Alignment: A New Alignment Framework via Test-Time Scaling
- **分类: cs.LG; cs.AI; cs.CL; cs.GT**

- **简介: 该论文研究大语言模型的对齐问题，旨在通过测试时扩展实现通用对齐。提出$(k,f(k))$-鲁棒对齐和渐近通用对齐概念，设计多玩家博弈框架，确保输出多样性并达到最优收敛率。**

- **链接: [https://arxiv.org/pdf/2601.08777v1](https://arxiv.org/pdf/2601.08777v1)**
...
>
---
#### [new 089] MemoBrain: Executive Memory as an Agentic Brain for Reasoning
- **分类: cs.AI; cs.CL; cs.IR**

- **简介: 该论文提出MemoBrain，解决工具增强代理中长期推理的上下文过载问题。通过构建依赖感知记忆，优化推理轨迹，提升任务一致性与效率。属于机器学习中的推理优化任务。**

- **链接: [https://arxiv.org/pdf/2601.08079v1](https://arxiv.org/pdf/2601.08079v1)**

> **作者:** Hongjin Qian; Zhao Cao; Zheng Liu
>
> **备注:** Our codes are in https://github.com/qhjqhj00/MemoBrain
>
> **摘要:** Complex reasoning in tool-augmented agent frameworks is inherently long-horizon, causing reasoning traces and transient tool artifacts to accumulate and strain the bounded working context of large language models. Without explicit memory mechanisms, such accumulation disrupts logical continuity and undermines task alignment. This positions memory not as an auxiliary efficiency concern, but as a core component for sustaining coherent, goal-directed reasoning over long horizons. We propose MemoBrain, an executive memory model for tool-augmented agents that constructs a dependency-aware memory over reasoning steps, capturing salient intermediate states and their logical relations. Operating as a co-pilot alongside the reasoning agent, MemoBrain organizes reasoning progress without blocking execution and actively manages the working context. Specifically, it prunes invalid steps, folds completed sub-trajectories, and preserves a compact, high-salience reasoning backbone under a fixed context budget. Together, these mechanisms enable explicit cognitive control over reasoning trajectories rather than passive context accumulation. We evaluate MemoBrain on challenging long-horizon benchmarks, including GAIA, WebWalker, and BrowseComp-Plus, demonstrating consistent improvements over strong baselines.
>
---
#### [new 090] Rewarding the Rare: Uniqueness-Aware RL for Creative Problem Solving in LLMs
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，解决LLMs在复杂推理中探索不足的问题。通过奖励独特策略提升解的多样性与质量。**

- **链接: [https://arxiv.org/pdf/2601.08763v1](https://arxiv.org/pdf/2601.08763v1)**
...
>
---
#### [new 091] Exploiting DINOv3-Based Self-Supervised Features for Robust Few-Shot Medical Image Segmentation
...
#### [replaced 001] Vocabulary Expansion of Large Language Models via Kullback-Leibler-Based Self-Distillation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型优化任务，解决小语料下词汇扩展问题。通过KL散度自蒸馏方法，提升模型对新术语的适应能力。**

- **链接: [https://arxiv.org/pdf/2508.15807v2](https://arxiv.org/pdf/2508.15807v2)**
...
>
---
#### [replaced 002] VMMU: A Vietnamese Multitask Multimodal Understanding and Reasoning Benchmark
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出VMMU基准，用于评估视觉语言模型在越南语多模态任务中的理解与推理能力。旨在解决多模态融合与跨语言推理问题，涵盖7个任务，验证模型的多模态整合能力。**

- **链接: [https://arxiv.org/pdf/2508.13680v3](https://arxiv.org/pdf/2508.13680v3)**
...
>
---
#### [replaced 003] Pushing on Multilingual Reasoning Models with Language-Mixed Chain-of-Thought
- **分类: cs.CL**

- **简介: 该论文属于多语言推理任务，旨在提升模型在非英语语言中的推理能力。通过引入语言混合的思维链方法，训练并优化了多个模型，取得了显著性能提升。**

- **链接: [https://arxiv.org/pdf/2510.04230v2](https://arxiv.org/pdf/2510.04230v2)**
...
>
---
#### [replaced 006] SAC: A Framework for Measuring and Inducing Personality Traits in LLMs with Dynamic Intensity Control
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文属于自然语言处理中的个性建模任务，旨在解决LLMs个性表达缺乏精细控制的问题。通过扩展MPI并引入SAC框架，实现对16种人格特质的动态强度控制。**

- **链接: [https://arxiv.org/pdf/2506.20993v2](https://arxiv.org/pdf/2506.20993v2)**

> **作者:** Adithya Chittem; Aishna Shrivastava; Sai Tarun Pendela; Jagat Sesh Challa; Dhruv Kumar
>
> **备注:** Accepted into 18th Edition of International Conference on Agents and Artificial Intelligence (ICAART)
>
...
>
---
#### [replaced 007] A Vision for Multisensory Intelligence: Sensing, Science, and Synergy
...
>
---
#### [replaced 008] Maximizing Local Entropy Where It Matters: Prefix-Aware Localized LLM Unlearning
- **分类: cs.CL**

- **简介: 该论文属于机器学习中的模型遗忘任务，旨在有效删除LLM中的敏感信息同时保持模型性能。提出PALU框架，通过局部熵最大化实现精准遗忘。**

- **链接: [https://arxiv.org/pdf/2601.03190v2](https://arxiv.org/pdf/2601.03190v2)**
...
>
---
#### [replaced 009] Format as a Prior: Quantifying and Analyzing Bias in LLMs for Heterogeneous Data
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决LLMs在处理异构数据时的格式偏差问题。通过实证分析，研究了偏差成因并提出减少偏差的方法。**

- **链接: [https://arxiv.org/pdf/2508.15793v3](https://arxiv.org/pdf/2508.15793v3)**
...
>
---
#### [replaced 011] Generating Text from Uniform Meaning Representation
- **分类: cs.CL**

- **简介: 论文研究从多语言统一语义表示（UMR）生成文本的任务，解决如何利用有限的UMR数据进行有效文本生成的问题。工作包括基线方法、转换管道和模型微调，取得良好效果。**

- **链接: [https://arxiv.org/pdf/2502.11973v3](https://arxiv.org/pdf/2502.11973v3)**

> **作者:** Emma Markle; Reihaneh Iranmanesh; Shira Wein
>
> **备注:** Published and Outstanding Paper Award recipient at IJCNLP-AACL 2025
>
...
>
---
#### [replaced 012] Generalization to Political Beliefs from Fine-Tuning on Sports Team Preferences
- **分类: physics.soc-ph; cs.CL**

- **简介: 该论文研究模型微调后行为的泛化问题，探讨体育团队偏好微调如何影响政治信念。属于模型行为泛化任务，旨在理解微调数据与无关行为变化的关系。**

- **链接: [https://arxiv.org/pdf/2601.04369v2](https://arxiv.org/pdf/2601.04369v2)**
...
>
---
#### [replaced 013] PRISM: Self-Pruning Intrinsic Selection Method for Training-Free Multimodal Data Selection
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 017] Foundations of LLM Knowledge Materialization: Termination, Reproducibility, Robustness
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识提取任务，研究LLM知识结构化过程的终止性、可复现性和鲁棒性。通过实验分析不同因素对知识提取的影响。**

- **链接: [https://arxiv.org/pdf/2510.06780v3](https://arxiv.org/pdf/2510.06780v3)**

> **作者:** Luca Giordano; Simon Razniewski
>
> **备注:** Accepted and published in Findings of EACL 2026
>
...
>
---
#### [replaced 018] Dialogue Response Prefetching Based on Semantic Similarity and Prediction Confidence of Language Model
- **分类: cs.CL**

- **简介: 该论文属于对话系统任务，旨在减少用户感知延迟。通过预测用户完整话语并评估语义相似性和预测置信度，决定是否进行响应预取。**

- **链接: [https://arxiv.org/pdf/2508.04403v2](https://arxiv.org/pdf/2508.04403v2)**

> **作者:** Kiyotada Mori; Seiya Kawano; Angel Fernando Garcia Contreras; Koichiro Yoshino
>
> **备注:** Corrected typographical errors, including the number of subjects in the response evaluation experiment
>
...
>
---
#### [replaced 019] On the Entropy Calibration of Language Models
- **分类: cs.CL; cs.AI; cs.LG; stat.ML**

- **简介: 该论文研究语言模型的熵校准问题，旨在解决模型生成文本熵与日志损失不匹配的问题。通过理论分析和实验验证，探讨模型规模对校准的影响，并证明在特定条件下可提升质量而不增加损失。**

- **链接: [https://arxiv.org/pdf/2511.11966v2](https://arxiv.org/pdf/2511.11966v2)**
...
>
---
#### [replaced 020] The Evolution of Thought: Tracking LLM Overthinking via Reasoning Dynamics Analysis
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM过拟合问题。通过分析推理动态，提出RCPD方法，在保证精度的前提下减少token使用。**

- **链接: [https://arxiv.org/pdf/2508.17627v2](https://arxiv.org/pdf/2508.17627v2)**

> **作者:** Zihao Wei; Liang Pang; Jiahao Liu; Wenjie Shi; Jingcheng Deng; Shicheng Xu; Zenghao Duan; Fei Sun; Huawei Shen; Xueqi Cheng
>
...
>
---
#### [replaced 021] ES-Mem: Event Segmentation-Based Memory for Long-Term Dialogue Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于对话系统任务，旨在解决长对话中记忆碎片化和检索不准确的问题。提出ES-Mem框架，通过事件分割和分层记忆结构提升记忆的连贯性与定位精度。**

- **链接: [https://arxiv.org/pdf/2601.07582v2](https://arxiv.org/pdf/2601.07582v2)**
...
>
---
#### [replaced 022] VocalBench: Benchmarking the Vocal Conversational Abilities for Speech Interaction Models
- **分类: cs.CL**

- **简介: 该论文属于语音交互模型评估任务，旨在解决现有评价体系缺乏真实场景和全面比较的问题。提出VocalBench基准，涵盖24k实例，评估语音对话能力。**

- **链接: [https://arxiv.org/pdf/2505.15727v3](https://arxiv.org/pdf/2505.15727v3)**
...
>
---
#### [replaced 023] Align-GRAG: Anchor and Rationale Guided Dual Alignment for Graph Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于知识增强的生成任务，旨在解决大模型幻觉和过时知识问题。提出Align-GRAG框架，通过锚点和理由引导的对齐机制，提升图结构与语言语义的一致性。**

- **链接: [https://arxiv.org/pdf/2505.16237v3](https://arxiv.org/pdf/2505.16237v3)**
...
>
---
#### [replaced 029] Hacking Neural Evaluation Metrics with Single Hub Text
- **分类: cs.CL**

- **简介: 该论文属于文本评估任务，旨在解决神经评估指标的可靠性问题。通过生成单个对抗性文本，验证评估指标的脆弱性，并证明其在多语言对中的泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.16323v2](https://arxiv.org/pdf/2512.16323v2)**

> **作者:** Hiroyuki Deguchi; Katsuki Chousa; Yusuke Sakai
>
> **备注:** Accepted at EACL2026 main
>
...
>
---
#### [replaced 030] Information Capacity: Evaluating the Efficiency of Large Language Models via Text Compression
- **分类: cs.AI; cs.CL; eess.SP**

- **简介: 该论文属于自然语言处理领域，旨在解决大语言模型效率评估问题。提出“信息容量”指标，结合文本压缩与计算复杂度，评估模型效率。**

- **链接: [https://arxiv.org/pdf/2511.08066v5](https://arxiv.org/pdf/2511.08066v5)**
...
>
---
#### [replaced 031] Compliance-to-Code: Enhancing Financial Compliance Checking via Code Generation
- **分类: cs.CL**

- **简介: 该论文属于金融合规自动化任务，旨在解决中文金融法规转换为可执行代码的难题。通过构建首个大规模中文合规数据集，提升模型对法规的理解与代码生成能力。**

- **链接: [https://arxiv.org/pdf/2505.19804v3](https://arxiv.org/pdf/2505.19804v3)**
...
>
---
#### [replaced 032] Whose Facts Win? LLM Source Preferences under Knowledge Conflicts
- **分类: cs.CL**

- **简介: 该论文研究LLM在知识冲突下的来源偏好问题，属于自然语言处理中的可信度研究任务。通过实验发现LLM更信任权威来源，但偏好可被重复信息改变。提出方法减少重复偏差，保持大部分原始偏好。**

- **链接: [https://arxiv.org/pdf/2601.03746v2](https://arxiv.org/pdf/2601.03746v2)**
...
>
---
#### [replaced 033] Focus, Merge, Rank: Improved Question Answering Based on Semi-structured Knowledge Bases
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于问答任务，解决多跳问题。提出FocusedRetriever框架，结合知识库与文本，提升答案准确率。**

- **链接: [https://arxiv.org/pdf/2505.09246v2](https://arxiv.org/pdf/2505.09246v2)**
...
>
---
#### [replaced 034] Arctic-Text2SQL-R1: Simple Rewards, Strong Reasoning in Text-to-SQL
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本到SQL生成任务，旨在提升复杂查询的SQL生成准确性。提出一种基于执行正确性的强化学习框架，无需复杂奖励机制，实现高效且准确的SQL生成。**

- **链接: [https://arxiv.org/pdf/2505.20315v2](https://arxiv.org/pdf/2505.20315v2)**

> **作者:** Zhewei Yao; Guoheng Sun; Lukasz Borchmann; Gaurav Nuti; Zheyu Shen; Minghang Deng; Bohan Zhai; Hao Zhang; Ang Li; Yuxiong He
>
...
>
---
#### [replaced 035] Generative Digital Twins: Vision-Language Simulation Models for Executable Industrial Systems
...
>
---
#### [replaced 036] DeKeyNLU: Enhancing Natural Language to SQL Generation through Task Decomposition and Keyword Extraction
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言到SQL生成任务，旨在解决LLMs在任务分解和关键词提取中的不足。提出DeKeyNLU数据集和DeKeySQL框架，提升SQL生成准确率。**

- **链接: [https://arxiv.org/pdf/2509.14507v2](https://arxiv.org/pdf/2509.14507v2)**
...
>
> **摘要:** Natural Language to SQL (NL2SQL) provides a new model-centric paradigm that simplifies database access for non-technical users by converting natural language queries into SQL commands. Recent advancements, particularly those integrating Retrieval-Augmented Generation (RAG) and Chain-of-Thought (CoT) reasoning, have made significant strides in enhancing NL2SQL performance. However, challenges such as inaccurate task decomposition and keyword extraction by LLMs remain major bottlenecks, often leading to errors in SQL generation. While existing datasets aim to mitigate these issues by fine-tuning models, they struggle with over-fragmentation of tasks and lack of domain-specific keyword annotations, limiting their effectiveness. To address these limitations, we present DeKeyNLU, a novel dataset which contains 1,500 meticulously annotated QA pairs aimed at refining task decomposition and enhancing keyword extraction precision for the RAG pipeline. Fine-tuned with DeKeyNLU, we propose DeKeySQL, a RAG-based NL2SQL pipeline that employs three distinct modules for user question understanding, entity retrieval, and generation to improve SQL generation accuracy. We benchmarked multiple model configurations within DeKeySQL RAG pipeline. Experimental results demonstrate that fine-tuning with DeKeyNLU significantly improves SQL generation accuracy on both BIRD (62.31% to 69.10%) and Spider (84.2% to 88.7%) dev datasets.
>
---
#### [replaced 037] Hallucinate at the Last in Long Response Generation: A Case Study on Long Document Summarization
- **分类: cs.CL**

- **简介: 该论文研究长文本摘要生成任务，关注模型在生成长文本时后半部分易出现幻觉的问题，分析其成因并探索缓解方法。**

- **链接: [https://arxiv.org/pdf/2505.15291v3](https://arxiv.org/pdf/2505.15291v3)**
...
>
---
#### [replaced 038] Stuffed Mamba: Oversized States Lead to the Inability to Forget
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，研究RNN模型在长文本中的遗忘问题。针对Mamba模型无法有效遗忘早期信息的问题，分析了状态大小与训练长度的关系，揭示了其性能局限。**

- **链接: [https://arxiv.org/pdf/2410.07145v4](https://arxiv.org/pdf/2410.07145v4)**
...
>
---
#### [replaced 039] Instructions are all you need: Self-supervised Reinforcement Learning for Instruction Following
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于指令遵循任务，解决多约束指令难以执行的问题。提出一种无需外部监督的自监督强化学习框架，通过指令生成奖励信号和伪标签，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2510.14420v3](https://arxiv.org/pdf/2510.14420v3)**
...
>
---
#### [replaced 044] MRAG-Suite: A Diagnostic Evaluation Platform for Visual Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于视觉检索增强生成任务，旨在解决现有评估体系无法有效区分查询难度和歧义的问题。提出MRAG-Suite平台及诊断工具MM-RAGChecker，提升Visual RAG系统的准确性与可靠性。**

- **链接: [https://arxiv.org/pdf/2509.24253v3](https://arxiv.org/pdf/2509.24253v3)**

> **作者:** Yuelyu Ji; Wuwei Lan; Patrick NG
>
...
>
---
#### [replaced 045] KaLM: Knowledge-aligned Autoregressive Language Modeling via Dual-view Knowledge Graph Contrastive Learning
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出KaLM，解决LLMs与知识图谱对齐问题，通过双视角知识图对比学习和三元组补全语言建模，提升知识驱动任务性能。**

- **链接: [https://arxiv.org/pdf/2412.04948v2](https://arxiv.org/pdf/2412.04948v2)**
...
>
---
#### [replaced 047] Measuring and Fostering Peace through Machine Learning and Artificial Intelligence
- **分类: cs.CL; cs.CY; cs.LG**

- **简介: 该论文属于情感分析与社会影响研究，旨在通过AI测量和平度并促进和平交流。工作包括构建模型分析新闻与社交媒体内容，并开发工具提供实时反馈。**

- **链接: [https://arxiv.org/pdf/2601.05232v2](https://arxiv.org/pdf/2601.05232v2)**
...
>
> **备注:** 6 pages, 4 figures, corrected typos, minor edits
>
...
>
---
#### [replaced 048] Multi-Personality Generation of LLMs at Decoding-time
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型多个性生成任务，解决传统方法成本高、灵活性差的问题。提出MPG框架，通过解码阶段控制多个性，提升生成质量与效率。**

- **链接: [https://arxiv.org/pdf/2511.01891v3](https://arxiv.org/pdf/2511.01891v3)**
...
>
---
#### [replaced 049] Are My Optimized Prompts Compromised? Exploring Vulnerabilities of LLM-based Optimizers
- **分类: cs.LG; cs.AI; cs.CL; cs.CR**

- **简介: 该论文属于安全任务，研究LLM提示优化中的漏洞。解决反馈攻击问题，通过实验分析并提出防御方法。**

- **链接: [https://arxiv.org/pdf/2510.14381v2](https://arxiv.org/pdf/2510.14381v2)**

> **作者:** Andrew Zhao; Reshmi Ghosh; Vitor Carvalho; Emily Lawton; Keegan Hines; Gao Huang; Jack W. Stokes
>
> **备注:** Proceedings of the 19th Conference of the European Chapter of the Association for Computational Linguistics (EACL 2026)
>
...
>
---
#### [replaced 052] IndRegBias: A Dataset for Studying Indian Regional Biases in English and Code-Mixed Social Media Comments
- **分类: cs.CL; cs.CY; cs.SI**

- **简介: 该论文属于自然语言处理中的偏见检测任务，旨在解决印度地区偏见识别问题。作者构建了IndRegBias数据集，并评估了模型在不同策略下的检测效果。**

- **链接: [https://arxiv.org/pdf/2601.06477v2](https://arxiv.org/pdf/2601.06477v2)**
...
>
---
#### [replaced 053] Are Emotions Arranged in a Circle? Geometric Analysis of Emotion Representations via Hyperspherical Contrastive Learning
- **分类: cs.CL**

- **简介: 该论文属于情感表示学习任务，旨在探讨心理环形模型在语言模型中的适用性。通过对比学习构建圆形情感表示，分析其优劣及与传统方法的权衡。**

- **链接: [https://arxiv.org/pdf/2601.06575v2](https://arxiv.org/pdf/2601.06575v2)**
...
>
---
#### [replaced 054] UNCAP: Uncertainty-Guided Neurosymbolic Planning Using Natural Language Communication for Cooperative Autonomous Vehicles
...
>
---
#### [replaced 055] Can Large Language Models Identify Implicit Suicidal Ideation? An Empirical Evaluation
- **分类: cs.CL**

- **简介: 该论文属于心理健康与自然语言处理交叉任务，旨在评估大语言模型识别隐性自杀意念和提供支持性回应的能力。研究构建了新数据集并测试了多个模型，发现现有模型存在明显不足。**

- **链接: [https://arxiv.org/pdf/2502.17899v3](https://arxiv.org/pdf/2502.17899v3)**
...
>
---
#### [replaced 056] Theoretical Foundations of Prompt Engineering: From Heuristics to Expressivity
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于理论研究任务，旨在解析提示工程的机制。通过将提示视为外部程序，分析Transformer模型如何通过提示实现不同计算，解决提示与模型行为关系的理论问题。**

- **链接: [https://arxiv.org/pdf/2512.12688v2](https://arxiv.org/pdf/2512.12688v2)**

> **作者:** Dongseok Kim; Hyoungsun Choi; Mohamed Jismy Aashik Rasool; Gisung Oh
>
> **备注:** Revised for clarity and correctness; improved exposition and fixed minor issues
>
...
>
---
#### [replaced 057] Principled Design of Interpretable Automated Scoring for Large-Scale Educational Assessments
- **分类: cs.CL**

- **简介: 该论文属于教育评估任务，旨在解决自动化评分的可解释性问题。提出FGTI四原则，并构建AnalyticScore框架，提升评分透明度与准确性。**

- **链接: [https://arxiv.org/pdf/2511.17069v2](https://arxiv.org/pdf/2511.17069v2)**

> **作者:** Yunsung Kim; Mike Hardy; Joseph Tey; Candace Thille; Chris Piech
>
> **备注:** 21 pages, 5 figures (Extended discussion, added details, error fixes)
>
