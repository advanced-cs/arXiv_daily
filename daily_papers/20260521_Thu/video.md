...
#### [new 001] ELEMENT: Multi-Modal Retinal Vessel Segmentation Based on a Coupled Region Growing and Machine Learning Approach
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决视网膜血管自动分割问题。提出ELEMENT框架，结合区域生长与机器学习，提升分割精度与效率。**

- **链接: [https://arxiv.org/pdf/2605.20458](https://arxiv.org/pdf/2605.20458)**
...
>
---
#### [new 002] ProtoPathway: Biologically Structured Prototype-Pathway Fusion for Multimodal Cancer Survival Prediction
- **分类: cs.CV; q-bio.QM; q-bio.TO**

- **简介: 该论文提出ProtoPathway，用于多模态癌症生存预测任务，融合病理图像与基因表达数据，通过生物结构化表示提升模型可解释性与效率。**

- **链接: [https://arxiv.org/pdf/2605.21454](https://arxiv.org/pdf/2605.21454)**
...
>
---
#### [new 014] OlmoEarth v1.1: A more efficient family of OlmoEarth models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于模型优化任务，旨在降低OlmoEarth模型的计算成本。通过改进模型结构，在保持性能的同时减少训练和推理时的资源消耗。**

- **链接: [https://arxiv.org/pdf/2605.20804](https://arxiv.org/pdf/2605.20804)**
...
>
---
#### [new 024] NeuroQA: A Large-Scale Image-Grounded Benchmark for 3D Brain MRI Understanding
...
>
---
#### [new 025] Grounding Driving VLA via Inverse Kinematics
...
>
---
#### [new 026] Towards UAV Detection in the Real World: A New Multispectral Dataset UAVNet-MS and a New Method
- **分类: cs.CV**

- **简介: 该论文属于小目标检测任务，旨在解决低对比度下无人机识别难题。提出UAVNet-MS数据集和MFDNet方法，提升无人机检测精度。**

- **链接: [https://arxiv.org/pdf/2605.20963](https://arxiv.org/pdf/2605.20963)**
...
>
---
#### [new 028] VISTA: Technical Report for the Ego4D Short-Term Object Interaction Anticipation at EgoVis 2026
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对Ego4D短时物体交互预测任务，提出VISTA模型，通过结合空间检测与时间上下文，预测未来人-物交互信息。**

- **链接: [https://arxiv.org/pdf/2605.20901](https://arxiv.org/pdf/2605.20901)**
...
>
---
#### [new 034] Oracle Supervision Transfers for Hyperparameter Prediction in Model-Based Image Denoising
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像去噪任务，解决超参数预测的瓶颈问题。通过迁移学习，将源配置的Oracle监督转移到目标配置，减少对目标标签的依赖。**

- **链接: [https://arxiv.org/pdf/2605.20479](https://arxiv.org/pdf/2605.20479)**
...
>
---
#### [new 035] VIHD: Visual Intervention-based Hallucination Detection for Medical Visual Question Answering
- **分类: cs.CV**

- **简介: 该论文属于医学视觉问答任务，解决模型生成幻觉问题。通过视觉干预方法检测幻觉，提升诊断可靠性。**
...
>
---
#### [new 038] CHOIR: Contact-aware 4D Hand-Object Interaction Reconstruction
- **分类: cs.CV**

- **简介: 该论文提出CHOIR框架，解决单目视频中手物交互的4D重建问题，通过接触信息耦合手与物体，提升重建精度和一致性。**
...
>
---
#### [new 041] SAM-Sode: Towards Faithful Explanations for Tiny Bacteria Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于目标检测中的可解释性任务，旨在解决微小细菌检测中解释不清晰的问题。提出SAM-Sode框架，通过几何提示和双约束机制提升解释的准确性和逻辑性。**

- **链接: [https://arxiv.org/pdf/2605.21186](https://arxiv.org/pdf/2605.21186)**
...
>
---
#### [new 054] Latent Dynamics for Full Body Avatar Animation
- **分类: cs.CV; cs.GR**

- **简介: 该论文属于人体动画生成任务，解决松散衣物等动态元素难以由姿态单独驱动的问题。通过引入动态潜在变量和Transformer解码器，提升动画质量和时间一致性。**

- **链接: [https://arxiv.org/pdf/2605.21478](https://arxiv.org/pdf/2605.21478)**
...
>
---
#### [new 064] AIGaitor: Privacy-preserving and cloud-free motion analysis for everyone, using edge computing
- **分类: cs.CV**

- **简介: 该论文提出AIGaitor，解决运动分析的隐私和成本问题，通过边缘计算在手机上实现无标记单目动作捕捉与深度学习分析。**

- **链接: [https://arxiv.org/pdf/2605.21421](https://arxiv.org/pdf/2605.21421)**
...
>
---
#### [new 092] RelWitness: Open-Vocabulary 3D Scene Graph Generation with Visual-Geometric Relation Witnesses
- **分类: cs.CV**

- **简介: 该论文属于3D场景图生成任务，解决开放词汇下关系标注不全的问题。提出RelWitness框架，利用视觉几何线索构建关系证据，提升未见关系识别与场景描述准确性。**
...
>
---
#### [new 095] VersusQ: Pairwise Margin Reasoning for Generalizable Video Quality Assessment
- **分类: cs.CV**

- **简介: 该论文属于视频质量评估任务，解决现有方法依赖绝对评分导致跨域泛化差的问题。提出VersusQ框架，通过视频对比较捕捉感知差异，提升模型泛化能力和细粒度排序性能。**

- **链接: [https://arxiv.org/pdf/2605.21130](https://arxiv.org/pdf/2605.21130)**
...
>
---
#### [new 096] Stream3D: Sequential Multi-View 3D Generation via Evidential Memory
- **分类: cs.CV**

- **简介: 该论文提出Stream3D，解决单视角3D生成在长视频流中时间不一致的问题。通过维护证据记忆，实现高效、稳定的多视角3D生成。**

- **链接: [https://arxiv.org/pdf/2605.21472](https://arxiv.org/pdf/2605.21472)**
...
>
---
#### [new 106] Draw2Think: Harnessing Geometry Reasoning through Constraint Engine Interaction
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 109] ConceptSeg-R1: Segment Any Concept via Meta-Reinforcement Learning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于概念分割任务，旨在解决现有方法对概念理解不足的问题。提出ConceptSeg-R1框架，通过元强化学习实现跨领域的概念分割。**

- **链接: [https://arxiv.org/pdf/2605.20385](https://arxiv.org/pdf/2605.20385)**
...
>
---
#### [new 113] GSA-YOLO: A High-Efficiency Framework via Structured Sparsity and Adaptive Knowledge Distillation for Real-Time X-ray Security Inspection
- **分类: cs.CV**

- **简介: 该论文提出GSA-YOLO，用于实时X射线安检中的物品检测任务，解决精度与速度的平衡问题，通过结构稀疏和自适应知识蒸馏提升效率与准确率。**

- **链接: [https://arxiv.org/pdf/2605.20669](https://arxiv.org/pdf/2605.20669)**
...
>
> **摘要:** In this report, we present our champion solutions for the Natural Language Queries and GoalStep tracks of the Ego4D Episodic Memory Challenge at CVPR 2026. Both tracks require accurately localizing temporal segments from long untrimmed egocentric videos. To address these tasks, we propose a reranking-based framework that effectively leverages the strong video-language reasoning capability of multimodal large language model (MLLM) while preserving the efficiency and candidate recall of conventional localization pipelines. Specifically, we first obtain a set of candidate segments from existing localization model OSGNet, and then employ MLLM to select the segment that best matches the given query, thereby refining the final prediction. Ultimately, our method achieved first place in both the Natural Language Queries and GoalStep tracks. Our code can be found at this https URL.
>
---
#### [new 122] RePCM: Region-Specific and Phenotype-Adaptive Bi-Ventricular Cardiac Motion Synthesis
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于心脏运动合成任务，旨在从单帧推断完整周期的双心室运动。针对传统方法过度平滑的问题，提出RePCM模型，通过区域感知和表型自适应机制，提升区域动态的保真度。**

- **链接: [https://arxiv.org/pdf/2605.21237](https://arxiv.org/pdf/2605.21237)**
...
>
---
#### [new 132] Lighting-aware Unified Model for Instance Segmentation
- **分类: cs.CV**

- **简介: 该论文属于实例分割任务，旨在解决光照变化导致的分割性能下降问题。提出Lighting Convolutional-Attention模块，提升分割鲁棒性。**

- **链接: [https://arxiv.org/pdf/2605.20436](https://arxiv.org/pdf/2605.20436)**

> **作者:** Qisai Liu; Alloy Das; Zhanhong Jiang; Joshua R. Waite; Aditya Balu; Adarsh Krishnamurthy; Soumik Sarkar
>
> **摘要:** Foundation models like the Segment Anything Model (SAM) demonstrate impressive zero-shot generalization but frequently degrade under diverse real-world illumination, particularly for instance segmentation. In this work, we address this limitation by developing \textit{Lighting Convolutional-Attention (\lca{})}, an adapter module that enhances segmentation robustness without fine-tuning the heavy backbone. \lca{} employs a dual-branch architecture to process RGB features alongside contrast maps, enabling physically motivated sensitivity to structural changes rather than illumination artifacts. We optimize \lca{} through a pairwise training strategy, introducing a targeted loss term that explicitly penalizes discrepancies between clean images and their corresponding illumination variants. To evaluate and support this architecture, we conduct a comprehensive empirical study across multiple existing benchmarks and present a novel Unity-based synthetic dataset specifically designed to accurately replicate complex real-world lighting conditions. Extensive experimental results demonstrate that our approach successfully bridges the domain gap, delivering superior lighting-robust segmentation.
>
---
#### [new 133] Goodbye Drift: Anchored Tree Sampling for Long-Horizon Video-to-Video Generation
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决长时视频生成中的漂移和连续性问题。提出Anchored Tree Sampling（ATS）方法，通过树状结构减少漂移，提升生成质量与稳定性。**

- **链接: [https://arxiv.org/pdf/2605.20476](https://arxiv.org/pdf/2605.20476)**
...
>
---
#### [new 136] WildRoadBench: A Wild Aerial Road-Damage Grounding Benchmark for Vision-Language Models and Autonomous Agents
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出WildRoadBench，用于评估视觉语言模型和自主代理在真实空中道路损伤定位任务中的性能，解决跨模态定位与自主决策问题。**

- **链接: [https://arxiv.org/pdf/2605.20306](https://arxiv.org/pdf/2605.20306)**
...
>
---
#### [new 143] Faster or Stronger: Towards Flexible Visual Place Recognition via Weighted Aggregation and Token Pruning
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 144] Regulating Anatomy-Aware Rewards via Trajectory-Integral Feedback for Volumetric Computed Tomography Analysis
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分析任务，旨在解决3D CT分析中模型优化目标与临床准确性不匹配的问题。通过引入CABS和TIF-GRPO框架，提升异常检测的临床可靠性。**

- **链接: [https://arxiv.org/pdf/2605.20277](https://arxiv.org/pdf/2605.20277)**
...
>
---
#### [new 147] Activation-Free Backbones for Image Recognition: Polynomial Alternatives within MetaFormer-Style Vision Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像识别任务，旨在解决传统视觉模型中非线性激活函数的必要性问题。通过设计无激活的多项式替代模块，提升模型性能与效率。**

- **链接: [https://arxiv.org/pdf/2605.20839](https://arxiv.org/pdf/2605.20839)**
...
>
---
#### [new 148] You Don't Need Attention: Gated Convolutional Modeling for Watch-Based Fall Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于可穿戴设备跌倒检测任务，解决传统方法依赖注意力机制导致计算开销大、定位不精确的问题。提出Gated-CNN模型，通过门控卷积提升检测效率与准确率。**

- **链接: [https://arxiv.org/pdf/2605.20275](https://arxiv.org/pdf/2605.20275)**

> **作者:** Sana Alamgeer; Ronish Kumar; Awatif Yasmin; Muhammad Irshad; Anne H. H. Ngu
>
> **摘要:** Existing deep learning approaches for wearable fall detection systems rely on self-attention mechanisms that impose quadratic computational overhead, distributing weights across all time steps. This global weight distribution impairs the precise localization of the brief impact signatures that characterize falls within short, fixed-length windows. To overcome this challenge, we propose Gated-CNN, a lightweight dual-stream architecture that processes accelerometer and gyroscope streams through independent one-dimensional convolutional feature extractors, followed by (i) a sigmoid gating module that selectively suppresses uninformative background activations while amplifying fall-discriminative features, (ii) a global average pooling layer that compresses each stream into a compact fixed-length descriptor, and (iii) a shared classification head that fuses both descriptors for binary fall prediction. For offline evaluation, we evaluate the model across five wrist-mounted inertial measurement unit (IMU) datasets, achieving average F1-scores of 93%, 93%, 90%, 91%, and 90% on SmartFallMM, WEDA-Fall, FallAllD, UMAFall, and UP-Fall, outperforming Transformer baselines. For real-time evaluation, we deployed the model on a Google Pixel Watch 3 and tested across 12 participants. The model achieves an average F1-score of 97% and an accuracy of 98% with zero missed falls, showing that sigmoid gating offers a more structurally aligned and computationally efficient alternative to attention for commodity smartwatch-based fall detection.
>
---
#### [new 149] Linear-DPO: Linear Direct Preference Optimization for Diffusion and Flow-Matching Generative Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于文本到图像生成任务，解决DPO在该任务中的效果问题。提出Linear-DPO，改进优化目标，提升生成质量。**

- **链接: [https://arxiv.org/pdf/2605.21123](https://arxiv.org/pdf/2605.21123)**
...
>
---
#### [new 160] Learning to Think in Physics: Breaking Shortcut Learning in Scientific Diffusion via Representation Alignment
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于物理信息扩散模型任务，解决中间表示约束不足导致的捷径学习问题。通过REPA-P框架对齐中间特征与物理状态，提升模型精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2605.20780](https://arxiv.org/pdf/2605.20780)**
...
>
---
#### [new 164] The Yes-Man Syndrome: Benchmarking Abstention in Embodied Robotic Agents
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 165] Automatic Discovery of Disease Subgroups by Contrasting with Healthy Controls
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于医学子群发现任务，旨在通过对比健康人与患者，识别由病理因素驱动的疾病亚群。提出Deep UCSL方法，利用深度学习和优化策略提升子群质量。**

- **链接: [https://arxiv.org/pdf/2605.21301](https://arxiv.org/pdf/2605.21301)**
...
>
---
#### [new 166] Mechanistic Interpretability for Learning Assurance of a Vision-Based Landing System
...
>
---
#### [new 167] FedCritic: Serverless Federated Critic Learning-based Resource Allocation for Multi-Cell OFDMA in 6G
- **分类: cs.LG; cs.AI; cs.CV; cs.NI**

- **简介: 论文提出FedCritic，用于6G多小区OFDMA中的资源分配任务，解决干扰耦合和QoS约束下的联合调度与功率控制问题。通过去中心化框架提升网络性能与稳定性。**

- **链接: [https://arxiv.org/pdf/2605.21418](https://arxiv.org/pdf/2605.21418)**
...
>
---
#### [new 168] FusionCell: Cross-Attentive Fusion of Layout Geometry and Netlist Topology for Standard-Cell Performance Prediction
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出FusionCell，解决标准单元性能预测问题，融合布局几何与网表拓扑，提升预测精度与速度。**

- **链接: [https://arxiv.org/pdf/2605.20287](https://arxiv.org/pdf/2605.20287)**
...
>
---
#### [new 169] Efficient Table QA via TableGrid Navigation and Progressive Inference Prompting
- **分类: cs.IR; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于表格问答任务，解决LLM在处理表格数据时的精准检索与多步推理问题。提出TGN和PIP框架，提升问答效果并可用于小模型微调。**

- **链接: [https://arxiv.org/pdf/2605.20254](https://arxiv.org/pdf/2605.20254)**
...
>
---
#### [new 170] Retrieval-Augmented Long-Context Translation for Cultural Image Captioning: Gators submission for AmericasNLP 2026 shared task
...
>
---
#### [new 171] HyperBones: Realtime Bone-driven Neural Garment Simulation with Hypernetwork Conditioning
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于实时服装模拟任务，解决物理逼真与计算效率的矛盾。提出一种基于神经网络的动态服装模拟方法，实现高效且真实的服装动画。**
...
>
---
#### [new 174] Manga109-v2026: Revisiting Manga109 Annotations for Modern Manga Understanding
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 175] Conflict-Aware Additive Guidance for Flow Models under Compositional Rewards
...
>
---
#### [new 179] SUGAR: A Scalable Human-Video-Driven Generalizable Humanoid Loco-Manipulation Learning Framework
...
>
---
#### [new 180] Tippett-minimum Fusion of Representation-space Diffusion Models for Multi-Encoder Out-of-Distribution Detection
- **分类: cs.LG; cs.AI; cs.CV; stat.AP; stat.ML**

- **简介: 该论文属于异常检测任务，解决多编码器在分布偏移下的分布外检测问题。通过融合各编码器的表示空间扩散模型，提出EncMin2L方法，提升检测效果并降低参数成本。**

- **链接: [https://arxiv.org/pdf/2605.20502](https://arxiv.org/pdf/2605.20502)**
...
>
---
#### [new 181] Winfree Oscillatory Neural Network
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出Winfree振荡神经网络（WONN），用于图像识别和逻辑推理任务，解决传统模型参数效率低的问题。通过结构化振荡动力学实现高效表示学习。**

- **链接: [https://arxiv.org/pdf/2605.20922](https://arxiv.org/pdf/2605.20922)**
...
>
---
#### [new 184] Local-sensitive connectivity filter (ls-cf): A post-processing unsupervised improvement of the frangi, hessian and vesselness filters for multimodal vessel segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在提升血管分割效果。针对Frangi等滤波器的不足，提出LS-CF方法，增强血管连续性，改善分割结果。**

- **链接: [https://arxiv.org/pdf/2605.21251](https://arxiv.org/pdf/2605.21251)**
...
>
---
#### [new 186] Variance Reduction for Expectations with Diffusion Teachers
- **分类: cs.LG; cs.AI; cs.CV; stat.CO; stat.ML**

- **简介: 该论文针对扩散模型在下游任务中的梯度估计问题，提出CARV框架以降低方差。通过分层蒙特卡洛估计和重要性采样提升计算效率。任务为文本到3D生成与数据归属。**
...
>
---
#### [replaced 003] How Well Do Vision-Language Models Understand Sequential Driving Scenes? A Sensitivity Study
- **分类: cs.CV**
...
>
---
#### [replaced 004] DeformMaster: An Interactive Physics-Neural World Model for Deformable Objects from Videos
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 007] Multi-needle Localization for Pelvic Seed Implant Brachytherapy based on Tip-handle Detection and Matching
- **分类: cs.CV; physics.med-ph**

- **链接: [https://arxiv.org/pdf/2509.17931](https://arxiv.org/pdf/2509.17931)**
...
>
---
#### [replaced 008] Spectral structural distortion reveals redundant neurons in neural networks
- **分类: cs.LG; cs.CV**
...
>
> **备注:** Withdrawn by the authors because the current manuscript is incomplete and should not be cited in its present form
>
...
>
---
#### [replaced 012] E2GS: Event Enhanced Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2406.14978](https://arxiv.org/pdf/2406.14978)**

> **作者:** Hiroyuki Deguchi; Mana Masuda; Takuya Nakabayashi; Hideo Saito
>
> **备注:** 7pages, Accepted at ICIP 2024
>
> **摘要:** Event cameras, known for their high dynamic range, absence of motion blur, and low energy usage, have recently found a wide range of applications thanks to these attributes. In the past few years, the field of event-based 3D reconstruction saw remarkable progress, with the Neural Radiance Field (NeRF) based approach demonstrating photorealistic view synthesis results. However, the volume rendering paradigm of NeRF necessitates extensive training and rendering times. In this paper, we introduce Event Enhanced Gaussian Splatting (E2GS), a novel method that incorporates event data into Gaussian Splatting, which has recently made significant advances in the field of novel view synthesis. Our E2GS effectively utilizes both blurry images and event data, significantly improving image deblurring and producing high-quality novel view synthesis. Our comprehensive experiments on both synthetic and real-world datasets demonstrate our E2GS can generate visually appealing renderings while offering faster training and rendering speed (140 FPS). Our code is available at this https URL.
>
---
#### [replaced 013] NeRF-based Spacecraft Reconstruction from Monocular Imagery Under Illumination Variability and Pose Uncertainty
- **分类: cs.CV**
...
>
> **备注:** Accepted to CVPR 2026. 31 pages
>
...
>
---
#### [replaced 016] Before the Body Moves: Learning Anticipatory Joint Intent for Language-Conditioned Humanoid Control
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 017] Fill the GAP: A Granular Alignment Paradigm for Visual Reasoning in Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 020] SMILE-UHURA Challenge -- Small Vessel Segmentation at Mesoscopic Scale from Ultra-High Resolution 7T Magnetic Resonance Angiograms
...
>
---
#### [replaced 021] Task-conditioned probing of instruction-tuned multimodal LLMs: Region-specific brain alignment patterns under naturalistic stimuli
...
>
---
#### [replaced 024] Self-Refining Video Sampling
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.18577](https://arxiv.org/pdf/2601.18577)**
...
>
---
#### [replaced 025] Affordance-R1: Reinforcement Learning for Generalizable Affordance Reasoning in Multimodal Large Language Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 036] Delta Forcing: Trust Region Steering for Interactive Autoregressive Video Generation
...
>
---
#### [replaced 037] AI-Powered Facial Mask Removal Is Not Suitable For Identification
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 040] Beyond Attention Scores: SVD-Based Vision Token Pruning for Efficient Vision-Language Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 042] ResNet-50 with Class Reweighting and Anatomy-Guided Temporal Decoding for Gastrointestinal Video Analysis
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 043] World-R1: Reinforcing 3D Constraints for Text-to-Video Generation
- **分类: cs.CV**
...
>
---
#### [replaced 045] CAD-Free Learning of Spacecraft Pose Estimators via NeRF-Based Augmentations
- **分类: cs.CV**
...
>
---
#### [replaced 048] Multimodal Fusion for Sim2real Transfer in Visual Reinforcement Learning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 049] Query-Calibrated Segmental Admission for Descriptor-Agnostic LiDAR Loop Closure in Repetitive Environments
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 050] ShowMak3r: Compositional TV Show Reconstruction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.19584](https://arxiv.org/pdf/2504.19584)**

> **作者:** Sangmin Kim; Seunguk Do; Daeun Lee; Jaesik Park
>
> **备注:** Project page : this https URL
>
...
>
---
#### [replaced 054] Parameters as Experts: Adapting Vision Models with Dynamic Parameter Routing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.06862](https://arxiv.org/pdf/2602.06862)**
...
>
---
#### [replaced 055] Q-DiT4SR: Exploration of Detail-Preserving Diffusion Transformer Quantization for Real-World Image Super-Resolution
- **分类: cs.CV**
...
>
> **备注:** Accepted to ICML 2026. Our code and models will be available at this https URL
>
...
>
---
#### [replaced 056] Explainable AI: Context-Aware Layer-Wise Integrated Gradients for Explaining Transformer Models
...
>
---
#### [replaced 057] RadProPoser: Probabilistic Radar Tensor Human Pose Estimation That Knows Its Limits
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.03578](https://arxiv.org/pdf/2508.03578)**

> **作者:** Jonas Leo Mueller; Lukas Engel; Eva Dorschky; Daniel Krauss; Ingrid Ullmann; Martin Vossiek; Bjoern M. Eskofier
>
> **备注:** Accepted at IJCNN 2026 (WCCI, Maastricht)
>
...
>
---
#### [replaced 058] Rebalancing Reference Frame Dominance to Improve Motion in Image-to-Video Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 061] UCSF-PDGM-VQA: Visual Question Answering dataset for brain tumor MRI interpretation
...
>
---
#### [replaced 067] FedHPro: Federated Hyper-Prototype Learning via Gradient Matching
- **分类: cs.CV**
...
>
> **备注:** 23 pages, ICML 2026 Camera-ready Version
>
...
>
---
#### [replaced 070] JoyAI-Image: Awaking Spatial Intelligence in Unified Multimodal Understanding and Generation
...
>
---
#### [replaced 073] LIFT and PLACE: A Simple, Stable, and Effective Knowledge Distillation Framework for Lightweight Diffusion Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 074] When Fairness Metrics Disagree: Evaluating the Reliability of Demographic Fairness Assessment in Machine Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2604.15038](https://arxiv.org/pdf/2604.15038)**
...
>
---
#### [replaced 075] Exploring Deep Learning and Ultra-Widefield Imaging for Diabetic Retinopathy and Macular Edema
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 076] Segment Anything with Robust Uncertainty-Accuracy Correlation
- **分类: cs.CV**
...
>
---
#### [replaced 077] PerpetualWonder: Long-Horizon Action-Conditioned 4D Scene Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.04876](https://arxiv.org/pdf/2602.04876)**

> **作者:** Jiahao Zhan; Zizhang Li; Hong-Xing Yu; Jiajun Wu
>
> **备注:** Project website: this https URL
>
> **摘要:** We introduce PerpetualWonder, a hybrid generative simulator that enables long-horizon, action-conditioned 4D scene generation from a single image. Current works fail at this task because their physical state is decoupled from their visual representation, which prevents generative refinements to update the underlying physics for subsequent interactions. PerpetualWonder solves this by introducing the first true closed-loop system. It features a novel unified representation that creates a bidirectional link between the physical state and visual primitives, allowing generative refinements to correct both the dynamics and appearance. It also introduces a robust update mechanism that gathers supervision from multiple viewpoints to resolve optimization ambiguity. Experiments demonstrate that from a single image, PerpetualWonder can successfully simulate complex, multi-step interactions from long-horizon actions, maintaining physical plausibility and visual consistency.
>
---
#### [replaced 078] Physics-Grounded Monocular Vehicle Distance Estimation Using Standardized License Plate Typography
- **分类: cs.CV; eess.IV**
...
>
---
#### [replaced 079] VeraRetouch: A Lightweight Fully Differentiable Framework for Multi-Task Reasoning Photo Retouching
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.27375](https://arxiv.org/pdf/2604.27375)**
...
>
---
#### [replaced 082] FineBench: Benchmarking and Enhancing Vision-Language Models for Fine-grained Human Activity Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 083] MeshTailor: Cutting Seams via Generative Mesh Traversal
- **分类: cs.GR; cs.CV**
...
>
---
#### [replaced 086] FineVision: Open Data Is All You Need
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.17269](https://arxiv.org/pdf/2510.17269)**
...
>
---
#### [replaced 091] Lance: Unified Multimodal Modeling by Multi-Task Synergy
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2605.18678](https://arxiv.org/pdf/2605.18678)**
...
>
> **备注:** Technical report for the NTIRE 2026 Efficient Low-Light Image Enhancement Challenge (CVPR 2026 Workshops), 3rd place solution
>
