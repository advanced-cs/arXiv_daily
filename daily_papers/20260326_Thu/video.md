...
#### [new 001] 3D-LLDM: Label-Guided 3D Latent Diffusion Model for Improving High-Resolution Synthetic MR Imaging in Hepatic Structure Segmentation
- **分类: cs.CV**

- **简介: 该论文提出3D-LLDM模型，用于生成高质量肝脏结构的合成MRI数据，解决医学影像数据不足的问题，提升肝癌分割效果。**

- **链接: [https://arxiv.org/pdf/2603.23845](https://arxiv.org/pdf/2603.23845)**
...
>
---
#### [new 004] Memory-Augmented Vision-Language Agents for Persistent and Semantically Consistent Object Captioning
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言任务，解决多视角下物体描述不一致问题。提出一种记忆增强的视觉-语言代理，统一处理数据关联、物体描述和探索策略，提升描述的一致性和持久性。**
...
>
---
#### [new 005] IJmond Industrial Smoke Segmentation Dataset
- **分类: cs.CV**

- **简介: 该论文介绍了一个工业烟雾分割数据集，用于图像分割任务，旨在提高烟雾检测与分析的准确性。**

- **链接: [https://arxiv.org/pdf/2603.23754](https://arxiv.org/pdf/2603.23754)**

> **作者:** Yen-Chia Hsu; Despoina Touska
>
> **摘要:** This report describes a dataset for industrial smoke segmentation, published on a figshare repository (this https URL). The dataset is licensed under CC BY 4.0.
>
---
#### [new 006] EndoVGGT: GNN-Enhanced Depth Estimation for Surgical 3D Reconstruction
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于手术3D重建任务，旨在解决软组织变形导致的几何不连续问题。提出EndoVGGT框架，利用DeGAT模块动态建模特征空间，提升重建精度与泛化能力。**
...
>
---
#### [new 010] An Adapter-free Fine-tuning Approach for Tuning 3D Foundation Models
- **分类: cs.CV**

- **简介: 该论文属于3D模型微调任务，解决低数据下过拟合和效率问题。提出MCFT方法，在不增加参数的情况下提升性能。**

- **链接: [https://arxiv.org/pdf/2603.23730](https://arxiv.org/pdf/2603.23730)**
...
>
---
#### [new 020] VERIA: Verification-Centric Multimodal Instance Augmentation for Long-Tailed 3D Object Detection
- **分类: cs.CV**

- **简介: 该论文属于3D目标检测任务，解决长尾分布数据中罕见类别样本不足的问题。通过VERIA框架生成多样化且符合真实统计的RGB-LiDAR实例，提升检测效果。**

- **链接: [https://arxiv.org/pdf/2603.24294](https://arxiv.org/pdf/2603.24294)**
...
>
---
#### [new 021] POLY-SIM: Polyglot Speaker Identification with Missing Modality Grand Challenge 2026 Evaluation Plan
- **分类: cs.CV**

- **简介: 该论文属于多模态说话人识别任务，旨在解决缺失模态和跨语言条件下的识别问题。工作包括设计挑战赛框架、数据集和基线模型，推动更鲁棒的系统发展。**
...
>
---
#### [new 038] Video-Only ToM: Enhancing Theory of Mind in Multimodal Large Language Models
- **分类: cs.CV**

- **简介: 该论文属于多模态理论心智任务，旨在提升大语言模型在纯视觉输入下的心智推理能力。通过引入VisionToM框架，增强模型对视觉信息的理解与推理，改善问答性能和解释准确性。**

- **链接: [https://arxiv.org/pdf/2603.24484](https://arxiv.org/pdf/2603.24484)**
...
>
---
#### [new 045] AdvSplat: Adversarial Attacks on Feed-Forward Gaussian Splatting Models
- **分类: cs.CV**

- **简介: 该论文属于3D重建安全领域，旨在研究对抗攻击对前馈3D高斯点云模型的影响。通过设计攻击方法，验证模型的脆弱性并提出防御方向。**

- **链接: [https://arxiv.org/pdf/2603.23686](https://arxiv.org/pdf/2603.23686)**
...
>
---
#### [new 048] Accelerating Diffusion-based Video Editing via Heterogeneous Caching: Beyond Full Computing at Sampled Denoising Timestep
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频编辑任务，旨在解决扩散模型计算效率低的问题。通过HetCache框架，减少冗余注意力操作，提升加速效果。**

- **链接: [https://arxiv.org/pdf/2603.24260](https://arxiv.org/pdf/2603.24260)**
...
>
---
#### [new 055] The Gait Signature of Frailty: Transfer Learning based Deep Gait Models for Scalable Frailty Assessment
- **分类: cs.CV**

- **简介: 该论文属于 frailty 评估任务，旨在解决临床评估主观、难扩展的问题。通过深度学习和迁移学习，利用步态数据提升评估的准确性与可扩展性。**
...
>
---
#### [new 056] Refining time-space traffic diagrams: A neighborhood-adaptive linear regression method
- **分类: cs.CV**

- **简介: 该论文属于交通数据细化任务，解决低分辨率时间-空间交通图的问题。提出一种基于邻域自适应线性回归的细化方法，提升交通数据精度。**

- **链接: [https://arxiv.org/pdf/2603.24312](https://arxiv.org/pdf/2603.24312)**
...
>
---
#### [new 057] Towards Real-World Document Parsing via Realistic Scene Synthesis and Document-Aware Training
- **分类: cs.CV**

- **简介: 该论文属于文档解析任务，旨在解决传统方法在非标准场景下的结构不准确问题。通过合成数据与结构感知训练，提升模型的准确性与鲁棒性。**
...
>
---
#### [new 060] MoCHA: Denoising Caption Supervision for Motion-Text Retrieval
- **分类: cs.CV**

- **简介: 该论文针对运动-文本检索任务，解决标注文本的多样性带来的嵌入方差问题。提出MoCHA框架，通过文本标准化减少方差，提升检索性能。**
...
>
---
#### [new 061] FilterGS: Traversal-Free Parallel Filtering and Adaptive Shrinking for Large-Scale LoD 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于3D渲染任务，解决大场景下LoD Gaussian Splatting的效率问题。提出FilterGS，通过并行过滤和自适应收缩减少冗余，提升渲染速度。**

- **链接: [https://arxiv.org/pdf/2603.23891](https://arxiv.org/pdf/2603.23891)**
...
>
---
#### [new 062] Leave No Stone Unturned: Uncovering Holistic Audio-Visual Intrinsic Coherence for Deepfake Detection
- **分类: cs.CV**

- **简介: 该论文属于深度伪造检测任务，旨在解决现有方法依赖单一模态或特定生成器的问题。提出HAVIC模型，利用音频视频内在一致性进行检测，并构建了HiFi-AVDF数据集。**

- **链接: [https://arxiv.org/pdf/2603.23960](https://arxiv.org/pdf/2603.23960)**
...
>
---
#### [new 063] A^3: Towards Advertising Aesthetic Assessment
- **分类: cs.CV**

- **简介: 该论文提出A^3框架，解决广告图像评估缺乏客观标准的问题。通过理论、数据集、模型和基准，实现广告美学的自动化评估与分析。**
...
>
---
#### [new 066] Anti-I2V: Safeguarding your photos from malicious image-to-video generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像到视频生成的防御任务，旨在解决恶意生成虚假视频的问题。提出Anti-I2V方法，在多个域中优化防御效果，提升对扩散模型的抵抗能力。**

- **链接: [https://arxiv.org/pdf/2603.24570](https://arxiv.org/pdf/2603.24570)**
...
>
---
#### [new 067] VOLMO: Versatile and Open Large Models for Ophthalmology
- **分类: cs.CV; cs.ET**

- **简介: 该论文提出VOLMO，一个用于眼科的多模态大模型框架，解决眼科诊断效率低的问题，通过预训练、微调和临床推理三阶段提升疾病筛查与管理能力。**
...
>
---
#### [new 068] The role of spatial context and multitask learning in the detection of organic and conventional farming systems based on Sentinel-2 time series
- **分类: cs.CV**

- **简介: 该论文属于农业分类任务，旨在区分有机与传统农作系统。通过Sentinel-2数据和Vision Transformer模型，研究空间上下文和多任务学习的影响。**

- **链接: [https://arxiv.org/pdf/2603.24552](https://arxiv.org/pdf/2603.24552)**
...
>
---
#### [new 071] RS-SSM: Refining Forgotten Specifics in State Space Model for Video Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文属于视频语义分割任务，解决状态空间模型在压缩过程中遗忘特定信息的问题。提出RS-SSM方法，通过CwAP和FGIR补全遗忘的时空细节，提升分割精度。**
...
>
---
#### [new 074] B-MoE: A Body-Part-Aware Mixture-of-Experts "All Parts Matter" Approach to Micro-Action Recognition
- **分类: cs.CV**

- **简介: 该论文属于动作识别任务，解决微动作识别难题。提出B-MoE框架，通过体部位感知专家系统提升识别效果。**
...
>
---
#### [new 075] OmniWeaving: Towards Unified Video Generation with Free-form Composition and Reasoning
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决开放源代码模型在统一视频生成上的不足。提出OmniWeaving模型，实现多模态组合与推理，提升视频创作能力。**
...
>
---
#### [new 078] ScrollScape: Unlocking 32K Image Generation With Video Diffusion Priors
- **分类: cs.CV**

- **简介: 该论文提出ScrollScape，解决极端宽高比图像生成中的结构失效问题。通过视频扩散先验，实现32K分辨率的高质量图像生成。**
...
>
---
#### [new 083] M3T: Discrete Multi-Modal Motion Tokens for Sign Language Production
- **分类: cs.CV**

- **简介: 该论文属于手语生成任务，解决非手动特征整合难题。提出SMPL-FX和M3T模型，提升手语生成质量与准确性。**

- **链接: [https://arxiv.org/pdf/2603.23617](https://arxiv.org/pdf/2603.23617)**
...
>
---
#### [new 086] Le MuMo JEPA: Multi-Modal Self-Supervised Representation Learning with Learnable Fusion Tokens
- **分类: cs.CV**

- **简介: 该论文属于多模态自监督表示学习任务，旨在融合不同传感器数据提升视觉表征。通过引入可学习的融合令牌，实现高效多模态特征提取与统一表示。**
...
>
---
#### [new 091] SynMVCrowd: A Large Synthetic Benchmark for Multi-view Crowd Counting and Localization
- **分类: cs.CV**

- **简介: 该论文提出SynMVCrowd基准，用于多视角人群计数与定位任务。针对现有数据集规模小、评估不实际的问题，构建大规模合成数据集，并提出强基线模型，提升跨场景迁移性能。**

- **链接: [https://arxiv.org/pdf/2603.23956](https://arxiv.org/pdf/2603.23956)**
...
>
---
#### [new 106] RVLM: Recursive Vision-Language Models with Adaptive Depth
- **分类: cs.CV**

- **简介: 该论文提出RVLM，解决医学AI可解释性和推理深度不足的问题。通过迭代生成代码实现可审计诊断，并利用RRouter动态调整推理深度。属于医学视觉语言模型任务。**

- **链接: [https://arxiv.org/pdf/2603.24224](https://arxiv.org/pdf/2603.24224)**
...
>
---
#### [new 117] Positive-First Most Ambiguous: A Simple Active Learning Criterion for Interactive Retrieval of Rare Categories
- **分类: cs.CV; cs.HC; cs.IR**

- **简介: 该论文属于细粒度视觉检索任务，解决罕见类别在不平衡数据中的检索问题。提出PF-MA主动学习方法，提升检索效率与用户满意度。**
...
>
---
#### [new 118] Chitrakshara: A Large Multilingual Multimodal Dataset for Indian languages
...
>
---
#### [new 123] Modeling Spatiotemporal Neural Frames for High Resolution Brain Dynamic
- **分类: eess.IV; cs.CV; q-bio.NC**

- **简介: 该论文属于多模态神经成像任务，旨在通过EEG重建高质量fMRI，解决fMRI高成本和采样不规则问题，提出一种具有时空一致性的重构框架。**
...
>
---
#### [new 126] ORACLE: Orchestrate NPC Daily Activities using Contrastive Learning with Transformer-CVAE
...
>
---
#### [new 127] Attack Assessment and Augmented Identity Recognition for Human Skeleton Data
- **分类: cs.LG; cs.CR; cs.CV**

- **简介: 该论文属于人体骨骼数据身份识别任务，解决小数据集下模型对对抗攻击的脆弱性问题。通过引入生成对抗网络增强数据，提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2603.24232](https://arxiv.org/pdf/2603.24232)**
...
>
---
#### [new 132] Bio-Inspired Event-Based Visual Servoing for Ground Robots
- **分类: cs.RO; cs.CV**
...
#### [replaced 001] Knot-10:A Tightness-Stratified Benchmark for Real-World Knot Classification with Topological Difficulty Analysis
- **分类: cs.CV**
...
>
---
#### [replaced 002] OSMDA: OpenStreetMap-based Domain Adaptation for Remote Sensing VLMs
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 003] Evaluating Image Editing with LLMs: A Comprehensive Benchmark and Intermediate-Layer Probing Approach
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.19775](https://arxiv.org/pdf/2603.19775)**

> **作者:** Shiqi Gao; Zitong Xu; Kang Fu; Huiyu Duan; Xiongkuo Min; Jia wang
>
...
>
---
#### [replaced 004] DanQing: An Up-to-Date Large-Scale Chinese Vision-Language Pre-training Dataset
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.10305](https://arxiv.org/pdf/2601.10305)**
...
>
---
#### [replaced 005] EdgeCrafter: Compact ViTs for Edge Dense Prediction via Task-Specialized Distillation
- **分类: cs.CV**
...
>
---
#### [replaced 006] E0: Enhancing Generalization and Fine-Grained Control in VLA Models via Tweedie Discrete Diffusion
...
>
---
#### [replaced 011] HybridSplat: Fast Reflection-baked Gaussian Tracing using Hybrid Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08334](https://arxiv.org/pdf/2512.08334)**

> **作者:** Chang Liu; Hongliang Yuan; Lianghao Zhang; Sichao Wang; Jianwei Guo; Shi-Sheng Huang
>
> **备注:** The authors have decided to withdraw this manuscript to undergo a comprehensive revision of the methodology and data analysis. The current version no longer accurately reflects the final scope and quality of our ongoing research
>
...
>
---
#### [replaced 012] Learning Cross-View Object Correspondence via Cycle-Consistent Mask Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.18996](https://arxiv.org/pdf/2602.18996)**

> **作者:** Shannan Yan; Leqi Zheng; Keyu Lv; Jingchen Ni; Hongyang Wei; Jiajun Zhang; Guangting Wang; Jing Lyu; Chun Yuan; Fengyun Rao
>
> **备注:** The paper has been accepted to CVPR 2026 main track
>
...
>
---
#### [replaced 013] Continual GUI Agents
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.20732](https://arxiv.org/pdf/2601.20732)**
...
>
---
#### [replaced 014] Establishing Stochastic Object Models from Noisy Data via Ambient Measurement-Integrated Diffusion
- **分类: cs.GR; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.14187](https://arxiv.org/pdf/2512.14187)**

> **作者:** Xiaoning Lei; Jianwei Sun; Wenhao Cai; Xichen Xu; Yanshu Wang; Hu Gao
>
...
>
---
#### [replaced 015] SLARM: Streaming and Language-Aligned Reconstruction Model for Dynamic Scenes
- **分类: cs.CV**
...
>
---
#### [replaced 016] Language Models Can Explain Visual Features via Steering
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 017] Prime and Reach: Synthesising Body Motion for Gaze-Primed Object Reach
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16456](https://arxiv.org/pdf/2512.16456)**
...
>
---
#### [replaced 018] Latent Diffusion Inversion Requires Understanding the Latent Space
- **分类: cs.LG; cs.CV**
...
>
---
#### [replaced 019] Pixel-level Scene Understanding in One Token: Visual States Need What-is-Where Composition
...
>
---
#### [replaced 020] Ontology-Guided Diffusion for Zero-Shot Visual Sim2Real Transfer
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 021] TikZilla: Scaling Text-to-TikZ with High-Quality Data and Reinforcement Learning
...
>
---
#### [replaced 022] Principled Steering via Null-space Projection for Jailbreak Defense in Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 023] Unified Diffusion VLA: Vision-Language-Action Model via Joint Discrete Denoising Diffusion Process
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 024] SPARE: Self-distillation for PARameter-Efficient Removal
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.07058](https://arxiv.org/pdf/2602.07058)**

> **作者:** Natnael Mola; Leonardo S. B. Pereira; Carolina R. Kelsch; Luis H. Arribas; Juan C. S. M. Avedillo
>
...
>
---
#### [replaced 025] MimiCAT: Mimic with Correspondence-Aware Cascade-Transformer for Category-Free 3D Pose Transfer
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2511.18370](https://arxiv.org/pdf/2511.18370)**
...
>
---
#### [replaced 026] From Panel to Pixel: Zoom-In Vision-Language Pretraining from Biomedical Scientific Literature
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.02566](https://arxiv.org/pdf/2512.02566)**
...
>
---
#### [replaced 027] OpenEarthAgent: A Unified Framework for Tool-Augmented Geospatial Agents
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.17665](https://arxiv.org/pdf/2602.17665)**
...
>
---
#### [replaced 028] VCBench: A Streaming Counting Benchmark for Spatial-Temporal State Maintenance in Long Videos
- **分类: cs.CV**
...
>
---
#### [replaced 029] DepthFocus: Controllable Depth Estimation for See-Through Scenes
- **分类: cs.CV**
...
>
---
#### [replaced 030] Let it Snow! Animating 3D Gaussian Scenes with Dynamic Weather Effects via Physics-Guided Score Distillation
- **分类: cs.GR; cs.CV**
...
>
> **备注:** 10 pages, 7 figures, supplementary included CVPR2026 PVUW
>
...
>
---
#### [replaced 033] Blink: Dynamic Visual Token Resolution for Enhanced Multimodal Understanding
- **分类: cs.CV**
...
>
---
#### [replaced 034] Morph: A Motion-free Physics Optimization Framework for Human Motion Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.14951](https://arxiv.org/pdf/2411.14951)**
...
>
---
#### [replaced 035] RestoreVAR: Visual Autoregressive Generation for All-in-One Image Restoration
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.18047](https://arxiv.org/pdf/2505.18047)**
...
>
---
#### [replaced 043] Scan Clusters, Not Pixels: A Cluster-Centric Paradigm for Efficient Ultra-high-definition Image Restoration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.21917](https://arxiv.org/pdf/2602.21917)**
...
>
---
#### [replaced 047] Phased DMD: Few-step Distribution Matching Distillation via Score Matching within Subintervals
- **分类: cs.CV**
...
>
---
#### [replaced 050] KINESIS: Motion Imitation for Human Musculoskeletal Locomotion
...
>
---
#### [replaced 051] NeXT-IMDL: Build Benchmark for NeXT-Generation Image Manipulation Detection & Localization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23374](https://arxiv.org/pdf/2512.23374)**

> **作者:** Yifei Li; Haoyuan He; Yu Zheng; Bingyao Yu; Wenzhao Zheng; Lei Chen; Jie Zhou; Jiwen Lu
>
> **备注:** Duplicate experiment results in Table 3 (Set-1 & Set-2)
>
...
>
---
#### [replaced 052] DriveXQA: Cross-modal Visual Question Answering for Adverse Driving Scene Understanding
- **分类: cs.CV**
...
>
> **备注:** Accepted to CVPR DriveX Workshop. Dataset and Code: this https URL
>
...
>
---
#### [replaced 053] PoseDriver: A Unified Approach to Multi-Category Skeleton Detection for Autonomous Driving
- **分类: cs.CV; cs.HC**
...
>
---
#### [replaced 054] AGORA: Adversarial Generation Of Real-time Animatable 3D Gaussian Head Avatars
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06438](https://arxiv.org/pdf/2512.06438)**
...
>
---
#### [replaced 055] PAM: A Pose-Appearance-Motion Engine for Sim-to-Real HOI Video Generation
- **分类: cs.CV**
...
>
---
#### [replaced 056] DarkDriving: A Real-World Day and Night Aligned Dataset for Autonomous Driving in the Dark Environment
- **分类: cs.CV; cs.DB**
...
>
---
#### [replaced 057] Adapting Point Cloud Analysis via Multimodal Bayesian Distribution Learning
- **分类: cs.CV**
...
>
---
#### [replaced 058] Thinking with Geometry: Active Geometry Integration for Spatial Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.06037](https://arxiv.org/pdf/2602.06037)**
...
>
---
#### [replaced 059] FOCUS: Optimal Control for Multi-Entity World Modeling in Text-to-Image Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.02315](https://arxiv.org/pdf/2510.02315)**
...
>
---
#### [replaced 060] TopoSculpt: Betti-Steered Topological Sculpting of 3D Fine-grained Tubular Shapes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.03938](https://arxiv.org/pdf/2509.03938)**
...
>
---
#### [replaced 061] SASNet: Spatially-Adaptive Sinusoidal Networks for INRs
- **分类: cs.CV**
...
>
> **备注:** CVPR2027, 10 pages, 10 figures, suppl included
>
...
>
---
#### [replaced 062] Explainable embeddings with Distance Explainer
...
>
---
#### [replaced 065] ShapBPT: Image Feature Attributions Using Data-Aware Binary Partition Trees
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.07047](https://arxiv.org/pdf/2602.07047)**

> **作者:** Muhammad Rashid; Elvio G. Amparore; Enrico Ferrari; Damiano Verda
>
> **备注:** Presented at AAAI-26 conference and published in Proceedings of the The Fortieth AAAI Conference on Artificial Intelligence (AAAI-26)
>
...
>
---
#### [replaced 066] Knowledge Priors for Identity-Disentangled Open-Set Privacy-Preserving Video FER
- **分类: cs.CV**
...
>
---
#### [replaced 067] From Feature Learning to Spectral Basis Learning: A Unifying and Flexible Framework for Efficient and Robust Shape Matching
- **分类: cs.CV**
...
>
---
#### [replaced 068] Fast3Dcache: Training-free 3D Geometry Synthesis Acceleration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22533](https://arxiv.org/pdf/2511.22533)**
...
>
---
#### [replaced 069] EditMGT: Unleashing Potentials of Masked Generative Transformers in Image Editing
- **分类: cs.CV; cs.MM; eess.IV**

- **链接: [https://arxiv.org/pdf/2512.11715](https://arxiv.org/pdf/2512.11715)**
...
>
---
#### [replaced 070] ExpPortrait: Expressive Portrait Generation via Personalized Representation
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2602.19900](https://arxiv.org/pdf/2602.19900)**
...
>
> **备注:** Findings of CVPR 2026 - Code at: this https URL
>
...
>
---
#### [replaced 075] Dual-Teacher Distillation with Subnetwork Rectification for Black-Box Domain Adaptation
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 076] ChordEdit: One-Step Low-Energy Transport for Image Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.19083](https://arxiv.org/pdf/2602.19083)**
...
>
---
#### [replaced 077] WorldMesh: Generating Navigable Multi-Room 3D Scenes via Mesh-Conditioned Image Diffusion
- **分类: cs.CV**
...
>
---
#### [replaced 078] Pro-Pose: Unpaired Full-Body Portrait Synthesis via Canonical UV Maps
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17143](https://arxiv.org/pdf/2512.17143)**
...
>
---
#### [replaced 079] CADC: Content Adaptive Diffusion-Based Generative Image Compression
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.21591](https://arxiv.org/pdf/2602.21591)**
...
>
---
#### [replaced 080] Neu-PiG: Neural Preconditioned Grids for Fast Dynamic Surface Reconstruction on Long Sequences
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.22212](https://arxiv.org/pdf/2602.22212)**
...
>
---
#### [replaced 081] Group Editing : Edit Multiple Images in One Go
- **分类: cs.CV**
...
>
---
#### [replaced 086] Identity as Presence: Towards Appearance and Voice Personalized Joint Audio-Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.17889](https://arxiv.org/pdf/2603.17889)**

> **作者:** Yingjie Chen; Shilun Lin; Cai Xing; Binxin Yang; Long Zhou; Qixin Yan; Wenjing Wang; Dingming Liu; Hao Liu; Chen Li; Jing Lyu
>
...
>
---
#### [replaced 087] Phrase-Instance Alignment for Generalized Referring Segmentation
...
>
---
#### [replaced 088] One Patch to Caption Them All: A Unified Zero-Shot Captioning Framework
- **分类: cs.CV**
...
>
---
#### [replaced 089] Natural Adversaries: Fuzzing Autonomous Vehicles with Realistic Roadside Object Placements
- **分类: cs.CV; cs.SE**
