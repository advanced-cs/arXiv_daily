...
>
---
#### [new 055] Detection Fire in Camera RGB-NIR
- **分类: cs.CV**

- **简介: 该论文属于火灾检测任务，旨在解决夜间红外摄像机中误检人工光源为火源的问题。通过构建NIR数据集、提出两阶段模型和Patched-YOLO提升检测精度。**

- **链接: [https://arxiv.org/pdf/2512.23594v1](https://arxiv.org/pdf/2512.23594v1)**
...
>
---
#### [new 056] EgoReAct: Egocentric Video-Driven 3D Human Reaction Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出EgoReAct，解决从第一视角视频生成3D对齐人体反应的问题。通过构建HRD数据集，实现实时、逼真且空间一致的反应生成。**

- **链接: [https://arxiv.org/pdf/2512.22808v1](https://arxiv.org/pdf/2512.22808v1)**
...
>
---
#### [new 057] Unbiased Visual Reasoning with Controlled Visual Inputs
...
>
---
#### [new 068] HY-Motion 1.0: Scaling Flow Matching Models for Text-To-Motion Generation
- **分类: cs.CV; cs.AI; cs.GR**

- **简介: 该论文属于文本到动作生成任务，旨在解决从文本生成高质量3D人类动作的问题。工作包括构建大规模模型，采用全面训练策略提升生成效果。**

- **链接: [https://arxiv.org/pdf/2512.23464v1](https://arxiv.org/pdf/2512.23464v1)**
...
>
> **摘要:** We present HY-Motion 1.0, a series of state-of-the-art, large-scale, motion generation models capable of generating 3D human motions from textual descriptions. HY-Motion 1.0 represents the first successful attempt to scale up Diffusion Transformer (DiT)-based flow matching models to the billion-parameter scale within the motion generation domain, delivering instruction-following capabilities that significantly outperform current open-source benchmarks. Uniquely, we introduce a comprehensive, full-stage training paradigm -- including large-scale pretraining on over 3,000 hours of motion data, high-quality fine-tuning on 400 hours of curated data, and reinforcement learning from both human feedback and reward models -- to ensure precise alignment with the text instruction and high motion quality. This framework is supported by our meticulous data processing pipeline, which performs rigorous motion cleaning and captioning. Consequently, our model achieves the most extensive coverage, spanning over 200 motion categories across 6 major classes. We release HY-Motion 1.0 to the open-source community to foster future research and accelerate the transition of 3D human motion generation models towards commercial maturity.
>
---
#### [new 069] DreamOmni3: Scribble-based Editing and Generation
- **分类: cs.CV**

- **简介: 该论文提出DreamOmni3，解决图像编辑与生成中文本描述不足的问题，通过结合文本、图像和手绘草图实现更灵活的编辑。**

- **链接: [https://arxiv.org/pdf/2512.22525v1](https://arxiv.org/pdf/2512.22525v1)**
...
>
---
#### [new 070] VideoScaffold: Elastic-Scale Visual Hierarchies for Streaming Video Understanding in MLLMs
...
>
---
#### [new 093] Towards Integrating Uncertainty for Domain-Agnostic Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像分割任务，旨在提升模型在不同领域中的泛化能力。通过引入不确定性量化，研究其对模型性能的改善效果，并构建了基准测试平台。**

- **链接: [https://arxiv.org/pdf/2512.23427v1](https://arxiv.org/pdf/2512.23427v1)**
...
>
> **摘要:** This paper presents JavisGPT, the first unified multimodal large language model (MLLM) for Joint Audio-Video (JAV) comprehension and generation. JavisGPT adopts a concise encoder-LLM-decoder architecture, featuring a SyncFusion module for spatio-temporal audio-video fusion and synchrony-aware learnable queries to bridge a pretrained JAV-DiT generator. This design enables temporally coherent video-audio understanding and generation from multimodal instructions. We design an effective three-stage training pipeline consisting of multimodal pretraining, audio-video fine-tuning, and large-scale instruction-tuning, to progressively build multimodal comprehension and generation from existing vision-language models. To support this, we further construct JavisInst-Omni, a high-quality instruction dataset with over 200K GPT-4o-curated audio-video-text dialogues that span diverse and multi-level comprehension and generation scenarios. Extensive experiments on JAV comprehension and generation benchmarks show that JavisGPT outperforms existing MLLMs, particularly in complex and temporally synchronized settings.
>
---
#### [new 095] RealX3D: A Physically-Degraded 3D Benchmark for Multi-view Visual Restoration and Reconstruction
- **分类: cs.CV; cs.MM**

- **简介: 该论文提出RealX3D，一个用于多视角视觉修复与重建的物理退化基准。解决真实环境下重建质量下降的问题，通过收集多种退化数据并构建高质量标注数据集进行评估。**

- **链接: [https://arxiv.org/pdf/2512.23437v1](https://arxiv.org/pdf/2512.23437v1)**
...
>
> **备注:** Accepted by AAAI2026 (Project page: https://correr-zhou.github.io/IdentityStory)
>
> **摘要:** Recent visual generative models enable story generation with consistent characters from text, but human-centric story generation faces additional challenges, such as maintaining detailed and diverse human face consistency and coordinating multiple characters across different images. This paper presents IdentityStory, a framework for human-centric story generation that ensures consistent character identity across multiple sequential images. By taming identity-preserving generators, the framework features two key components: Iterative Identity Discovery, which extracts cohesive character identities, and Re-denoising Identity Injection, which re-denoises images to inject identities while preserving desired context. Experiments on the ConsiStory-Human benchmark demonstrate that IdentityStory outperforms existing methods, particularly in face consistency, and supports multi-character combinations. The framework also shows strong potential for applications such as infinite-length story generation and dynamic character composition.
>
---
#### [new 103] With Great Context Comes Great Prediction Power: Classifying Objects via Geo-Semantic Scene Graphs
- **分类: cs.CV**

- **简介: 该论文属于目标分类任务，旨在解决忽略场景上下文导致识别效果不佳的问题。通过构建地理语义图，融合几何与语义信息，提升分类准确率。**

- **链接: [https://arxiv.org/pdf/2512.23024v1](https://arxiv.org/pdf/2512.23024v1)**
...
>
---
#### [new 105] Envision: Embodied Visual Planning via Goal-Imagery Video Diffusion
- **分类: cs.CV**

- **简介: 该论文属于视觉规划任务，旨在解决机器人操作中目标对齐和空间一致性问题。提出Envision框架，通过扩散模型生成符合目标的视频轨迹。**

- **链接: [https://arxiv.org/pdf/2512.22626v1](https://arxiv.org/pdf/2512.22626v1)**
...
>
---
#### [new 107] GVSynergy-Det: Synergistic Gaussian-Voxel Representations for Multi-View 3D Object Detection
- **分类: cs.CV**

- **简介: 该论文属于多视角3D目标检测任务，解决图像中准确定位3D物体的问题。提出GVSynergy-Det框架，结合高斯与体素表示，提升检测精度。**

- **链接: [https://arxiv.org/pdf/2512.23176v1](https://arxiv.org/pdf/2512.23176v1)**

> **作者:** Yi Zhang; Yi Wang; Lei Yao; Lap-Pui Chau
>
> **备注:** 11 pages, 5 figures
>
> **摘要:** Image-based 3D object detection aims to identify and localize objects in 3D space using only RGB images, eliminating the need for expensive depth sensors required by point cloud-based methods. Existing image-based approaches face two critical challenges: methods achieving high accuracy typically require dense 3D supervision, while those operating without such supervision struggle to extract accurate geometry from images alone. In this paper, we present GVSynergy-Det, a novel framework that enhances 3D detection through synergistic Gaussian-Voxel representation learning. Our key insight is that continuous Gaussian and discrete voxel representations capture complementary geometric information: Gaussians excel at modeling fine-grained surface details while voxels provide structured spatial context. We introduce a dual-representation architecture that: 1) adapts generalizable Gaussian Splatting to extract complementary geometric features for detection tasks, and 2) develops a cross-representation enhancement mechanism that enriches voxel features with geometric details from Gaussian fields. Unlike previous methods that either rely on time-consuming per-scene optimization or utilize Gaussian representations solely for depth regularization, our synergistic strategy directly leverages features from both representations through learnable integration, enabling more accurate object localization. Extensive experiments demonstrate that GVSynergy-Det achieves state-of-the-art results on challenging indoor benchmarks, significantly outperforming existing methods on both ScanNetV2 and ARKitScenes datasets, all without requiring any depth or dense 3D geometry supervision (e.g., point clouds or TSDF).
>
---
#### [new 108] Improved cystic hygroma detection from prenatal imaging using ultrasound-specific self-supervised representation learning
- **分类: cs.CV; eess.IV**

- **简介: 该论文属于医学图像分析任务，旨在提升孕早期超声中囊性淋巴管瘤的自动检测。针对标注数据少的问题，采用自监督预训练方法提高模型性能。**

- **链接: [https://arxiv.org/pdf/2512.22730v1](https://arxiv.org/pdf/2512.22730v1)**
...
>
---
#### [new 109] GeCo: A Differentiable Geometric Consistency Metric for Video Generation
- **分类: cs.CV**

- **简介: 该论文提出GeCo，用于视频生成中的几何一致性评估，解决静态场景中变形和遮挡不一致问题，通过融合运动残差和深度先验生成一致性图。**

- **链接: [https://arxiv.org/pdf/2512.22274v1](https://arxiv.org/pdf/2512.22274v1)**
...
>
---
#### [new 117] LECalib: Line-Based Event Camera Calibration
- **分类: cs.CV**

- **简介: 该论文属于相机标定任务，解决事件相机校准效率低、依赖人工的问题。通过检测事件流中的线条特征，提出一种无需人工标定物的校准方法。**

- **链接: [https://arxiv.org/pdf/2512.22441v1](https://arxiv.org/pdf/2512.22441v1)**
...
>
---
#### [new 118] SuperiorGAT: Graph Attention Networks for Sparse LiDAR Point Cloud Reconstruction in Autonomous Systems
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于点云重建任务，解决LiDAR因遮挡导致的点云稀疏问题。提出SuperiorGAT框架，通过图注意力机制实现高精度重建。**

- **链接: [https://arxiv.org/pdf/2512.22439v1](https://arxiv.org/pdf/2512.22439v1)**
...
>
---
#### [new 133] Bridging Cognitive Gap: Hierarchical Description Learning for Artistic Image Aesthetics Assessment
- **分类: cs.CV**

- **简介: 该论文属于艺术图像美学评估任务，旨在解决数据稀缺和模型碎片化问题。提出RAD数据集和ArtQuant框架，提升美学判断准确性与效率。**

- **链接: [https://arxiv.org/pdf/2512.23413v1](https://arxiv.org/pdf/2512.23413v1)**
...
>
---
#### [new 146] SonoVision: A Computer Vision Approach for Helping Visually Challenged Individuals Locate Objects with the Help of Sound Cues
- **分类: cs.CV**

- **简介: 论文提出SonoVision，一款帮助视障人士通过声音定位物体的手机应用。属于辅助技术任务，解决视障者独立定位物体的问题，采用计算机视觉和声音提示实现物体检测与方向反馈。**

- **链接: [https://arxiv.org/pdf/2512.22449v1](https://arxiv.org/pdf/2512.22449v1)**
...
>
---
#### [new 147] Toward Stable Semi-Supervised Remote Sensing Segmentation via Co-Guidance and Co-Fusion
- **分类: cs.CV**

- **简介: 该论文属于遥感图像语义分割任务，旨在解决伪标签漂移问题。通过引入双学生架构和语义协同引导机制，提升模型稳定性与分割精度。**

- **链接: [https://arxiv.org/pdf/2512.23035v1](https://arxiv.org/pdf/2512.23035v1)**
...
>
---
#### [new 151] ByteLoom: Weaving Geometry-Consistent Human-Object Interactions through Progressive Curriculum Learning
- **分类: cs.CV; cs.GR; cs.LG**

- **简介: 该论文属于人-物交互视频生成任务，解决多视角一致性差和依赖精细手部标注的问题。提出ByteLoom框架，结合DiT与3D物体输入，提升生成视频的几何一致性与真实性。**

- **链接: [https://arxiv.org/pdf/2512.22854v1](https://arxiv.org/pdf/2512.22854v1)**
...
>
---
#### [new 152] Multimodal Interpretation of Remote Sensing Images: Dynamic Resolution Input Strategy and Multi-scale Vision-Language Alignment Mechanism
- **分类: cs.CV**

- **简介: 该论文属于多模态遥感图像理解任务，旨在解决固定分辨率效率不足和单尺度对齐语义层次缺失的问题。提出DRIS和MS-VLAM框架，提升语义理解和计算效率。**

- **链接: [https://arxiv.org/pdf/2512.23243v1](https://arxiv.org/pdf/2512.23243v1)**
...
>
---
#### [new 153] OmniAgent: Audio-Guided Active Perception Agent for Omnimodal Audio-Video Understanding
- **分类: cs.CV**

- **简介: 该论文提出OmniAgent，解决音频-视频理解中的跨模态对齐问题。通过动态音频引导的感知机制，实现更精细的多模态推理。**

- **链接: [https://arxiv.org/pdf/2512.23646v1](https://arxiv.org/pdf/2512.23646v1)**

> **作者:** Keda Tao; Wenjie Du; Bohan Yu; Weiqiang Wang; Jian Liu; Huan Wang
>
> **备注:** Website:https://kd-tao.github.io/OmniAgent/
>
> **摘要:** Omnimodal large language models have made significant strides in unifying audio and visual modalities; however, they often lack the fine-grained cross-modal understanding and have difficulty with multimodal alignment. To address these limitations, we introduce OmniAgent, a fully audio-guided active perception agent that dynamically orchestrates specialized tools to achieve more fine-grained audio-visual reasoning. Unlike previous works that rely on rigid, static workflows and dense frame-captioning, this paper demonstrates a paradigm shift from passive response generation to active multimodal inquiry. OmniAgent employs dynamic planning to autonomously orchestrate tool invocation on demand, strategically concentrating perceptual attention on task-relevant cues. Central to our approach is a novel coarse-to-fine audio-guided perception paradigm, which leverages audio cues to localize temporal events and guide subsequent reasoning. Extensive empirical evaluations on three audio-video understanding benchmarks demonstrate that OmniAgent achieves state-of-the-art performance, surpassing leading open-source and proprietary models by substantial margins of 10% - 20% accuracy.
>
---
#### [new 154] Task-oriented Learnable Diffusion Timesteps for Universal Few-shot Learning of Dense Tasks
- **分类: cs.CV**

- **简介: 该论文属于密集预测任务，旨在解决少样本学习中扩散时间步选择不优的问题。提出TTS和TFC模块，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2512.23210v1](https://arxiv.org/pdf/2512.23210v1)**
...
>
---
#### [new 167] YOLO-Master: MOE-Accelerated with Specialized Transformers for Enhanced Real-time Detection
- **分类: cs.CV**

- **简介: 该论文属于实时目标检测任务，旨在解决传统方法计算资源分配不合理的问题。提出YOLO-Master，通过动态计算分配提升检测性能与效率。**

- **链接: [https://arxiv.org/pdf/2512.23273v1](https://arxiv.org/pdf/2512.23273v1)**
...
>
---
#### [new 168] CLIP-Joint-Detect: End-to-End Joint Training of Object Detectors with Contrastive Vision-Language Supervision
- **分类: cs.CV**

- **简介: 该论文属于目标检测任务，旨在解决传统检测器对类别不平衡和标签噪声敏感的问题。通过引入对比视觉-语言监督，提出CLIP-Joint-Detect框架，提升检测性能。**

- **链接: [https://arxiv.org/pdf/2512.22969v1](https://arxiv.org/pdf/2512.22969v1)**
...
>
---
#### [new 172] LiveTalk: Real-Time Multimodal Interactive Video Diffusion via Improved On-Policy Distillation
- **分类: cs.CV**

- **简介: 该论文属于实时多模态交互视频生成任务，解决扩散模型实时性不足的问题。通过改进的策略蒸馏方法提升模型效率与质量，构建了实时交互系统LiveTalk。**

- **链接: [https://arxiv.org/pdf/2512.23576v1](https://arxiv.org/pdf/2512.23576v1)**
...
>
---
#### [new 182] Mesquite MoCap: Democratizing Real-Time Motion Capture with Affordable, Bodyworn IoT Sensors and WebXR SLAM
- **分类: cs.MM; cs.CV**

- **简介: 该论文提出Mesquite系统，解决低成本实时运动捕捉问题。通过物联网传感器和WebXR技术实现跨平台、低延迟的运动数据采集与可视化。**

- **链接: [https://arxiv.org/pdf/2512.22690v1](https://arxiv.org/pdf/2512.22690v1)**
...
>
---
#### [new 189] Machine Learning-Assisted Vocal Cord Ultrasound Examination: Project VIPR
- **分类: cs.LG; cs.CE; cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在解决VCUS检查依赖操作者的问题。通过机器学习自动识别声带并区分正常与声带麻痹图像。**

- **链接: [https://arxiv.org/pdf/2512.23177v1](https://arxiv.org/pdf/2512.23177v1)**
...
>
---
#### [new 193] LLM-Guided Exemplar Selection for Few-Shot Wearable-Sensor Human Activity Recognition
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 194] Instruction-Following Evaluation of Large Vision-Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 195] SmartSnap: Proactive Evidence Seeking for Self-Verifying Agents
...
>
---
#### [new 207] HiSciBench: A Hierarchical Multi-disciplinary Benchmark for Scientific Intelligence from Reading to Discovery
- **分类: cs.AI; cs.CV**

- **简介: 该论文提出HiSciBench，一个用于评估科学智能的分层多学科基准，解决现有基准碎片化问题，涵盖从阅读到发现的科学流程。**

- **链接: [https://arxiv.org/pdf/2512.22899v1](https://arxiv.org/pdf/2512.22899v1)**
...
>
---
#### [new 209] Interpretable Gallbladder Ultrasound Diagnosis: A Lightweight Web-Mobile Software Platform with Real-Time XAI
- **分类: cs.SE; cs.CV**

- **简介: 该论文属于医学图像诊断任务，旨在解决胆囊疾病早期准确检测问题。通过集成轻量级深度学习模型和XAI技术，实现快速、可解释的 ultrasound 诊断。**

- **链接: [https://arxiv.org/pdf/2512.23033v1](https://arxiv.org/pdf/2512.23033v1)**

> **作者:** Fuyad Hasan Bhoyan; Prashanta Sarker; Parsia Noor Ethila; Md. Emon Hossain; Md Kaviul Hossain; Md Humaion Kabir Mehedi
>
> **摘要:** Early and accurate detection of gallbladder diseases is crucial, yet ultrasound interpretation is challenging. To address this, an AI-driven diagnostic software integrates our hybrid deep learning model MobResTaNet to classify ten categories, nine gallbladder disease types and normal directly from ultrasound images. The system delivers interpretable, real-time predictions via Explainable AI (XAI) visualizations, supporting transparent clinical decision-making. It achieves up to 99.85% accuracy with only 2.24M parameters. Deployed as web and mobile applications using HTML, CSS, JavaScript, Bootstrap, and Flutter, the software provides efficient, accessible, and trustworthy diagnostic support at the point of care
>
---
#### [new 210] SwinCCIR: An end-to-end deep network for Compton camera imaging reconstruction
- **分类: eess.IV; cs.CV; nucl-ex**

- **简介: 该论文提出SwinCCIR，用于解决康普顿相机成像中的伪影和变形问题，通过端到端深度学习框架提升成像质量。**

- **链接: [https://arxiv.org/pdf/2512.22766v1](https://arxiv.org/pdf/2512.22766v1)**

> **作者:** Minghao Dong; Xinyang Luo; Xujian Ouyang; Yongshun Xiao
>
> **备注:** 10 pages, 7 figures
>
> **摘要:** Compton cameras (CCs) are a kind of gamma cameras which are designed to determine the directions of incident gammas based on the Compton scatter. However, the reconstruction of CCs face problems of severe artifacts and deformation due to the fundamental reconstruction principle of back-projection of Compton cones. Besides, a part of systematic errors originated from the performance of devices are hard to remove through calibration, leading to deterioration of imaging quality. Iterative algorithms and deep-learning based methods have been widely used to improve reconstruction. But most of them are optimization based on the results of back-projection. Therefore, we proposed an end-to-end deep learning framework, SwinCCIR, for CC imaging. Through adopting swin-transformer blocks and a transposed convolution-based image generation module, we established the relationship between the list-mode events and the radioactive source distribution. SwinCCIR was trained and validated on both simulated and practical dataset. The experimental results indicate that SwinCCIR effectively overcomes problems of conventional CC imaging, which are expected to be implemented in practical applications.
>
---
#### [new 211] MEGA-PCC: A Mamba-based Efficient Approach for Joint Geometry and Attribute Point Cloud Compression
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于点云压缩任务，解决几何与属性联合压缩中的效率与复杂性问题。提出MEGA-PCC框架，实现端到端压缩与优化。**

- **链接: [https://arxiv.org/pdf/2512.22463v1](https://arxiv.org/pdf/2512.22463v1)**
...
>
> **摘要:** Temporally aware image representations are crucial for capturing disease progression in 3D volumes of longitudinal medical datasets. However, recent state-of-the-art self-supervised learning approaches like Masked Autoencoding (MAE), despite their strong representation learning capabilities, lack temporal awareness. In this paper, we propose STAMP (Stochastic Temporal Autoencoder with Masked Pretraining), a Siamese MAE framework that encodes temporal information through a stochastic process by conditioning on the time difference between the 2 input volumes. Unlike deterministic Siamese approaches, which compare scans from different time points but fail to account for the inherent uncertainty in disease evolution, STAMP learns temporal dynamics stochastically by reframing the MAE reconstruction loss as a conditional variational inference objective. We evaluated STAMP on two OCT and one MRI datasets with multiple visits per patient. STAMP pretrained ViT models outperformed both existing temporal MAE methods and foundation models on different late stage Age-Related Macular Degeneration and Alzheimer's Disease progression prediction which require models to learn the underlying non-deterministic temporal dynamics of the diseases.
>
---
#### [new 214] A unified framework for detecting point and collective anomalies in operating system logs via collaborative transformers
- **分类: cs.LG; cs.AI; cs.CV; cs.NI; cs.OS**

- **简介: 该论文属于日志异常检测任务，旨在解决单模态方法忽略多模态信息、多模态方法无法处理模态交互的问题。提出CoLog框架，利用协同Transformer和多头注意力进行多模态融合，提升异常检测效果。**

- **链接: [https://arxiv.org/pdf/2512.23380v1](https://arxiv.org/pdf/2512.23380v1)**
...
>
---
#### [new 216] Fairness Evaluation of Risk Estimation Models for Lung Cancer Screening
- **分类: cs.LG; cs.AI; cs.CV; cs.CY; eess.IV**

- **简介: 该论文属于医疗AI公平性评估任务，旨在检测肺癌风险模型在不同人群中的性能差异，分析潜在不公平偏差。**

- **链接: [https://arxiv.org/pdf/2512.22242v1](https://arxiv.org/pdf/2512.22242v1)**

> **作者:** Shaurya Gaur; Michel Vitale; Alessa Hering; Johan Kwisthout; Colin Jacobs; Lena Philipp; Fennie van der Graaf
>
> **备注:** Accepted for publication at the Journal of Machine Learning for Biomedical Imaging (MELBA) https://melba-journal.org/2025:025
>
...
>
---
#### [replaced 004] Training-Free Diffusion Priors for Text-to-Image Generation via Optimization-based Visual Inversion
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 005] D$^{2}$-VPR: A Parameter-efficient Visual-foundation-model-based Visual Place Recognition Method via Knowledge Distillation and Deformable Aggregation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.12528v4](https://arxiv.org/pdf/2511.12528v4)**
...
>
---
#### [replaced 006] Re-Visible Dual-Domain Self-Supervised Deep Unfolding Network for MRI Reconstruction
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2501.03737v2](https://arxiv.org/pdf/2501.03737v2)**
...
>
---
#### [replaced 007] Age-Defying Face Recognition with Transformer-Enhanced Loss
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.02198v4](https://arxiv.org/pdf/2412.02198v4)**

> **作者:** Pritesh Prakash; Anoop Kumar Rai
>
...
>
---
#### [replaced 008] Efficient and Robust Video Defense Framework against 3D-field Personalized Talking Face
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21019v2](https://arxiv.org/pdf/2512.21019v2)**

> **作者:** Rui-qing Sun; Xingshan Yao; Tian Lan; Jia-Ling Shi; Chen-Hao Cui; Hui-Yang Zhao; Zhijing Wu; Chen Yang; Xian-Ling Mao
>
...
>
> **摘要:** Hyperspectral images (HSIs) often suffer from diverse and unknown degradations during imaging, leading to severe spectral and spatial distortions. Existing HSI restoration methods typically rely on specific degradation assumptions, limiting their effectiveness in complex scenarios. In this paper, we propose \textbf{MP-HSIR}, a novel multi-prompt framework that effectively integrates spectral, textual, and visual prompts to achieve universal HSI restoration across diverse degradation types and intensities. Specifically, we develop a prompt-guided spatial-spectral transformer, which incorporates spatial self-attention and a prompt-guided dual-branch spectral self-attention. Since degradations affect spectral features differently, we introduce spectral prompts in the local spectral branch to provide universal low-rank spectral patterns as prior knowledge for enhancing spectral reconstruction. Furthermore, the text-visual synergistic prompt fuses high-level semantic representations with fine-grained visual features to encode degradation information, thereby guiding the restoration process. Extensive experiments on 9 HSI restoration tasks, including all-in-one scenarios, generalization tests, and real-world cases, demonstrate that MP-HSIR not only consistently outperforms existing all-in-one methods but also surpasses state-of-the-art task-specific approaches across multiple tasks. The code and models are available at https://github.com/ZhehuiWu/MP-HSIR.
>
---
#### [replaced 016] RefineVAD: Semantic-Guided Feature Recalibration for Weakly Supervised Video Anomaly Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13204v2](https://arxiv.org/pdf/2511.13204v2)**

> **作者:** Junhee Lee; ChaeBeen Bang; MyoungChul Kim; MyeongAh Cho
>
> **备注:** Accepted to AAAI 2026
>
> **摘要:** Weakly-Supervised Video Anomaly Detection aims to identify anomalous events using only video-level labels, balancing annotation efficiency with practical applicability. However, existing methods often oversimplify the anomaly space by treating all abnormal events as a single category, overlooking the diverse semantic and temporal characteristics intrinsic to real-world anomalies. Inspired by how humans perceive anomalies, by jointly interpreting temporal motion patterns and semantic structures underlying different anomaly types, we propose RefineVAD, a novel framework that mimics this dual-process reasoning. Our framework integrates two core modules. The first, Motion-aware Temporal Attention and Recalibration (MoTAR), estimates motion salience and dynamically adjusts temporal focus via shift-based attention and global Transformer-based modeling. The second, Category-Oriented Refinement (CORE), injects soft anomaly category priors into the representation space by aligning segment-level features with learnable category prototypes through cross-attention. By jointly leveraging temporal dynamics and semantic structure, explicitly models both "how" motion evolves and "what" semantic category it resembles. Extensive experiments on WVAD benchmark validate the effectiveness of RefineVAD and highlight the importance of integrating semantic context to guide feature refinement toward anomaly-relevant patterns.
>
---
#### [replaced 017] ReSemAct: Advancing Fine-Grained Robotic Manipulation via Semantic Structuring and Affordance Refinement
...
>
---
#### [replaced 018] Breaking the Vicious Cycle: Coherent 3D Gaussian Splatting from Sparse and Motion-Blurred Views
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.10369v2](https://arxiv.org/pdf/2512.10369v2)**
...
>
---
#### [replaced 020] ViC-Bench: Benchmarking Visual-Interleaved Chain-of-Thought Capability in MLLMs with Free-Style Intermediate State Representations
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.14404v3](https://arxiv.org/pdf/2505.14404v3)**
...
>
---
#### [replaced 022] ICONS: Influence Consensus for Vision-Language Data Selection
...
>
---
#### [replaced 023] Seeing Isn't Believing: Context-Aware Adversarial Patch Synthesis via Conditional GAN
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.22836v2](https://arxiv.org/pdf/2509.22836v2)**

> **作者:** Roie Kazoom; Alon Goldberg; Hodaya Cohen; Ofer Hadar
>
...
>
---
#### [replaced 024] Fully Automated Deep Learning Based Glenoid Bone Loss Measurement and Severity Stratification on 3D CT in Shoulder Instability
- **分类: cs.CV; cs.AI; q-bio.QM**

- **链接: [https://arxiv.org/pdf/2511.14083v2](https://arxiv.org/pdf/2511.14083v2)**
...
>
---
#### [replaced 025] CLIP Based Region-Aware Feature Fusion for Automated BBPS Scoring in Colonoscopy Images
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.20374v2](https://arxiv.org/pdf/2512.20374v2)**
...
>
---
#### [replaced 026] RefAV: Towards Planning-Centric Scenario Mining
...
>
---
#### [replaced 027] BootOOD: Self-Supervised Out-of-Distribution Detection via Synthetic Sample Exposure under Neural Collapse
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.13539v2](https://arxiv.org/pdf/2511.13539v2)**

> **作者:** Yuanchao Wang; Tian Qin; Eduardo Valle; Bruno Abrahao
>
> **备注:** 10 pages
>
> **摘要:** Out-of-distribution (OOD) detection is critical for deploying image classifiers in safety-sensitive environments, yet existing detectors often struggle when OOD samples are semantically similar to the in-distribution (ID) classes. We present BootOOD, a fully self-supervised OOD detection framework that bootstraps exclusively from ID data and is explicitly designed to handle semantically challenging OOD samples. BootOOD synthesizes pseudo-OOD features through simple transformations of ID representations and leverages Neural Collapse (NC), where ID features cluster tightly around class means with consistent feature norms. Unlike prior approaches that aim to constrain OOD features into subspaces orthogonal to the collapsed ID means, BootOOD introduces a lightweight auxiliary head that performs radius-based classification on feature norms. This design decouples OOD detection from the primary classifier and imposes a relaxed requirement: OOD samples are learned to have smaller feature norms than ID features, which is easier to satisfy when ID and OOD are semantically close. Experiments on CIFAR-10, CIFAR-100, and ImageNet-200 show that BootOOD outperforms prior post-hoc methods, surpasses training-based methods without outlier exposure, and is competitive with state-of-the-art outlier-exposure approaches while maintaining or improving ID accuracy.
>
---
#### [replaced 028] Video Event Reasoning and Prediction by Fusing World Knowledge from LLMs with Vision Foundation Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.05822v3](https://arxiv.org/pdf/2507.05822v3)**
...
>
---
#### [replaced 029] WiSE-OD: Benchmarking Robustness in Infrared Object Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.18925v2](https://arxiv.org/pdf/2507.18925v2)**

> **作者:** Heitor R. Medeiros; Atif Belal; Masih Aminbeidokhti; Eric Granger; Marco Pedersoli
>
> **备注:** WACV 2026: IEEE/CVF Winter Conf. on Applications of Computer Vision, Tucson, USA
>
...
>
---
#### [replaced 030] VisionDirector: Vision-Language Guided Closed-Loop Refinement for Generative Image Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.19243v2](https://arxiv.org/pdf/2512.19243v2)**
...
>
---
#### [replaced 031] Visual Explanation via Similar Feature Activation for Metric Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.01636v4](https://arxiv.org/pdf/2506.01636v4)**
...
>
---
#### [replaced 032] CogStream: Context-guided Streaming Video Question Answering
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2506.10516v3](https://arxiv.org/pdf/2506.10516v3)**
...
>
---
#### [replaced 033] Knot Forcing: Taming Autoregressive Video Diffusion Models for Real-time Infinite Interactive Portrait Animation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21734v2](https://arxiv.org/pdf/2512.21734v2)**

> **作者:** Steven Xiao; Xindi Zhang; Dechao Meng; Qi Wang; Peng Zhang; Bang Zhang
>
> **备注:** Project Page: https://humanaigc.github.io/knot_forcing_demo_page/
>
> **摘要:** Real-time portrait animation is essential for interactive applications such as virtual assistants and live avatars, requiring high visual fidelity, temporal coherence, ultra-low latency, and responsive control from dynamic inputs like reference images and driving signals. While diffusion-based models achieve strong quality, their non-causal nature hinders streaming deployment. Causal autoregressive video generation approaches enable efficient frame-by-frame generation but suffer from error accumulation, motion discontinuities at chunk boundaries, and degraded long-term consistency. In this work, we present a novel streaming framework named Knot Forcing for real-time portrait animation that addresses these challenges through three key designs: (1) a chunk-wise generation strategy with global identity preservation via cached KV states of the reference image and local temporal modeling using sliding window attention; (2) a temporal knot module that overlaps adjacent chunks and propagates spatio-temporal cues via image-to-video conditioning to smooth inter-chunk motion transitions; and (3) A "running ahead" mechanism that dynamically updates the reference frame's temporal coordinate during inference, keeping its semantic context ahead of the current rollout frame to support long-term coherence. Knot Forcing enables high-fidelity, temporally consistent, and interactive portrait animation over infinite sequences, achieving real-time performance with strong visual stability on consumer-grade GPUs.
>
---
#### [replaced 034] OmniDrive-R1: Reinforcement-driven Interleaved Multi-modal Chain-of-Thought for Trustworthy Vision-Language Autonomous Driving
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.14044v2](https://arxiv.org/pdf/2512.14044v2)**

> **作者:** Zhenguo Zhang; Haohan Zheng; Yishen Wang; Le Xu; Tianchen Deng; Xuefeng Chen; Qu Chen; Bo Zhang; Wuxiong Huang
>
...
>
---
#### [replaced 035] Class Incremental Medical Image Segmentation via Prototype-Guided Calibration and Dual-Aligned Distillation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.07749v2](https://arxiv.org/pdf/2511.07749v2)**
...
>
---
#### [replaced 039] MergeMix: A Unified Augmentation Paradigm for Visual and Multi-Modal Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23479v2](https://arxiv.org/pdf/2510.23479v2)**
...
>
---
#### [replaced 040] Learning Spatial Decay for Vision Transformers
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09525v2](https://arxiv.org/pdf/2508.09525v2)**
...
>
---
#### [replaced 041] Reward Forcing: Efficient Streaming Video Generation with Rewarded Distribution Matching Distillation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.04678v2](https://arxiv.org/pdf/2512.04678v2)**
...
>
---
#### [replaced 043] Enhance Multi-Scale Spatial-Temporal Coherence for Configurable Video Anomaly Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2305.07328v2](https://arxiv.org/pdf/2305.07328v2)**

> **作者:** Kai Cheng; Xinzhe Li; Lijuan Che
>
...
>
---
#### [replaced 044] MVInverse: Feed-forward Multi-view Inverse Rendering in Seconds
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21003v2](https://arxiv.org/pdf/2512.21003v2)**

> **作者:** Xiangzuo Wu; Chengwei Ren; Jun Zhou; Xiu Li; Yuan Liu
>
> **备注:** 21 pages, 17 figures, 5 tables, project page: https://maddog241.github.io/mvinverse-page/
>
...
>
---
#### [replaced 045] UltraBoneUDF: Self-supervised Bone Surface Reconstruction from Ultrasound Based on Neural Unsigned Distance Functions
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2505.17912v4](https://arxiv.org/pdf/2505.17912v4)**
...
>
---
#### [replaced 047] When Deepfake Detection Meets Graph Neural Network:a Unified and Lightweight Learning Framework
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.05526v2](https://arxiv.org/pdf/2508.05526v2)**
...
>
---
#### [replaced 048] Multi-Focused Video Group Activities Hashing
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.00490v3](https://arxiv.org/pdf/2509.00490v3)**

> **作者:** Zhongmiao Qi; Yan Jiang; Bolin Zhang; Chong Wang; Lijun Guo; Pengjiang Qian; Jiangbo Qian
>
...
>
---
#### [replaced 053] Cross-modal Full-mode Fine-grained Alignment for Text-to-Image Person Retrieval
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.13754v2](https://arxiv.org/pdf/2509.13754v2)**

> **作者:** Hao Yin; Xin Man; Feiyu Chen; Jie Shao; Heng Tao Shen
>
> **备注:** accepted by ACM Transactions on Multimedia Computing Communications and Applications in December 2025
>
...
>
---
#### [replaced 054] Robust Polyp Detection and Diagnosis through Compositional Prompt-Guided Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2502.17951v2](https://arxiv.org/pdf/2502.17951v2)**

> **作者:** Jia Yu; Yan Zhu; Peiyao Fu; Tianyi Chen; Junbo Huang; Quanlin Li; Pinghong Zhou; Zhihua Wang; Fei Wu; Shuo Wang; Xian Yang
>
> **摘要:** Colorectal cancer (CRC) is a significant global health concern, and early detection through screening plays a critical role in reducing mortality. While deep learning models have shown promise in improving polyp detection, classification, and segmentation, their generalization across diverse clinical environments, particularly with out-of-distribution (OOD) data, remains a challenge. Multi-center datasets like PolypGen have been developed to address these issues, but their collection is costly and time-consuming. Traditional data augmentation techniques provide limited variability, failing to capture the complexity of medical images. Diffusion models have emerged as a promising solution for generating synthetic polyp images, but the image generation process in current models mainly relies on segmentation masks as the condition, limiting their ability to capture the full clinical context. To overcome these limitations, we propose a Progressive Spectrum Diffusion Model (PSDM) that integrates diverse clinical annotations-such as segmentation masks, bounding boxes, and colonoscopy reports-by transforming them into compositional prompts. These prompts are organized into coarse and fine components, allowing the model to capture both broad spatial structures and fine details, generating clinically accurate synthetic images. By augmenting training data with PSDM-generated samples, our model significantly improves polyp detection, classification, and segmentation. For instance, on the PolypGen dataset, PSDM increases the F1 score by 2.12% and the mean average precision by 3.09%, demonstrating superior performance in OOD scenarios and enhanced generalization.
>
---
#### [replaced 055] UniPR-3D: Towards Universal Visual Place Recognition with Visual Geometry Grounded Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21078v2](https://arxiv.org/pdf/2512.21078v2)**
...
>
---
#### [replaced 056] MatDecompSDF: High-Fidelity 3D Shape and PBR Material Decomposition from Multi-View Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.04749v3](https://arxiv.org/pdf/2507.04749v3)**
...
>
---
#### [replaced 060] Timepoint-Specific Benchmarking of Deep Learning Models for Glioblastoma Follow-Up MRI
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.18595v2](https://arxiv.org/pdf/2511.18595v2)**
...
>
> **备注:** Accepted by NeurIPS Workshop on Next Practices in Video Generation and Evaluation (Short Paper Track), Project Page: https://lhmd.top/drivegen3d
>
...
>
---
#### [replaced 063] Fine-Tuned Vision Transformers Capture Complex Wheat Spike Morphology for Volume Estimation from RGB Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.18060v2](https://arxiv.org/pdf/2506.18060v2)**
...
>
---
#### [replaced 066] MambaIO: Global-Coordinate Inertial Odometry for Pedestrians via Multi-Scale Frequency-Decoupled Modeling
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 067] RadMamba: Efficient Human Activity Recognition through Radar-based Micro-Doppler-Oriented Mamba State-Space Model
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2504.12039v3](https://arxiv.org/pdf/2504.12039v3)**

> **作者:** Yizhuo Wu; Francesco Fioranelli; Chang Gao
>
> **备注:** Accepted to the IEEE Transactions on Radar Systems (T-RS)
>
...
>
---
#### [replaced 068] ReCamDriving: LiDAR-Free Camera-Controlled Novel Trajectory Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.03621v2](https://arxiv.org/pdf/2512.03621v2)**
...
>
---
#### [replaced 069] Towards Generalisable Foundation Models for Brain MRI
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23415v2](https://arxiv.org/pdf/2510.23415v2)**
...
>
---
#### [replaced 070] GRAN-TED: Generating Robust, Aligned, and Nuanced Text Embedding for Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.15560v2](https://arxiv.org/pdf/2512.15560v2)**
...
>
---
#### [replaced 071] InfSplign: Inference-Time Spatial Alignment of Text-to-Image Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.17851v2](https://arxiv.org/pdf/2512.17851v2)**

> **作者:** Sarah Rastegar; Violeta Chatalbasheva; Sieger Falkena; Anuj Singh; Yanbo Wang; Tejas Gokhale; Hamid Palangi; Hadi Jamali-Rad
>
> **摘要:** Text-to-image (T2I) diffusion models generate high-quality images but often fail to capture the spatial relations specified in text prompts. This limitation can be traced to two factors: lack of fine-grained spatial supervision in training data and inability of text embeddings to encode spatial semantics. We introduce InfSplign, a training-free inference-time method that improves spatial alignment by adjusting the noise through a compound loss in every denoising step. Proposed loss leverages different levels of cross-attention maps extracted from the backbone decoder to enforce accurate object placement and a balanced object presence during sampling. The method is lightweight, plug-and-play, and compatible with any diffusion backbone. Our comprehensive evaluations on VISOR and T2I-CompBench show that InfSplign establishes a new state-of-the-art (to the best of our knowledge), achieving substantial performance gains over the strongest existing inference-time baselines and even outperforming the fine-tuning-based methods. Codebase is available at GitHub.
>
---
#### [replaced 072] Omni-Weather: Unified Multimodal Foundation Model for Weather Generation and Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21643v2](https://arxiv.org/pdf/2512.21643v2)**
...
>
---
#### [replaced 073] SPIDER: Spatial Image CorresponDence Estimator for Robust Calibration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.17750v2](https://arxiv.org/pdf/2511.17750v2)**
...
>
---
#### [replaced 074] ZeBROD: Zero-Retraining Based Recognition and Object Detection Framework
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.04888v3](https://arxiv.org/pdf/2512.04888v3)**
...
>
> **备注:** This manuscript was first submitted to the AI Open (Elsevier Journal). The preprint version was posted to arXiv afterwards to facilitate open access and community feedback
>
...
>
---
#### [replaced 077] MACE-Dance: Motion-Appearance Cascaded Experts for Music-Driven Dance Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.18181v2](https://arxiv.org/pdf/2512.18181v2)**
...
>
---
#### [replaced 080] Learning to Refocus with Video Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.19823v3](https://arxiv.org/pdf/2512.19823v3)**
...
>
---
#### [replaced 083] Geometric Disentanglement of Text Embeddings for Subject-Consistent Text-to-Image Generation using A Single Prompt
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16443v2](https://arxiv.org/pdf/2512.16443v2)**
...
>
---
#### [replaced 084] LidarDM: Generative LiDAR Simulation in a Generated World
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 085] RiemanLine: Riemannian Manifold Representation of 3D Lines for Factor Graph Optimization
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 092] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
- **分类: cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2507.05859v4](https://arxiv.org/pdf/2507.05859v4)**

> **作者:** Wenkang Zhang; Yan Zhao; Qiang Wang; Zhixin Xu; Li Song; Zhengxue Cheng
>
> **备注:** code:https://github.com/Mr-Zwkid/D-FCGS
>
