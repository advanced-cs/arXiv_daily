...
- **链接: [http://arxiv.org/pdf/2510.16704v1](http://arxiv.org/pdf/2510.16704v1)**
...
- **简介: 该论文提出SSL4RL框架，旨在解决视觉-语言模型推理中视觉证据利用不足及强化学习奖励不可靠的问题。通过将自监督学习任务转化为可验证的密集奖励信号，实现无需人工标注的高效强化学习微调，提升多模态模型在视觉与视觉-语言任务中的表现。**
...
- **简介: 该论文研究3D场景中的具身问答，旨在解决现有3D大模型在场景-物体推理上的不足。提出SCENECOT方法和SCENECOT-185K数据集，实现基于多模态线索的链式思维推理，提升问答的准确性和可解释性。**
...
- **链接: [http://arxiv.org/pdf/2510.17529v1](http://arxiv.org/pdf/2510.17529v1)**
...
- **简介: 该论文研究图像分类与检索任务，旨在通过构建图像及类别的代表模型提升性能。作者提出基于图注意力网络（GAT）自编码器的方法，利用图像间相似性构建图结构，学习上下文感知的隐表示，并通过比较代表模型实现分类与检索。**
...
- **简介: 该论文研究文本生成3D资产任务，旨在解决现有方法生成结果缺乏结构和交互性的问题。作者提出ShapeCraft框架，利用图结构的形状程序表示，通过多LLM代理协同实现结构化、带纹理且可交互的3D建模。**
...
- **简介: 该论文探究图像转视频（I2V）模型能否模拟行人动态。属于视觉生成与运动建模交叉任务，旨在验证DiT类模型在拥挤场景中生成真实行人轨迹的能力。作者通过关键帧条件生成视频，并用轨迹指标定量评估其动力学合理性。**
...
- **简介: 该论文聚焦图像编辑的物理真实性评估，提出PICABench基准和PICAEval评测协议，系统衡量编辑结果在光学、力学等方面的合理性，并构建PICA-100K数据集探索基于视频学习物理规律的方法。**
...
- **简介: 该论文提出一种自监督深度学习框架，用于脑卒中取栓术中C臂机的自动定位。通过回归预训练任务提升骨骼关键点分类性能，旨在实现从骨盆到头部的自动化C臂轨迹优化，提高手术效率与安全性。**
...
- **简介: 该论文研究不同报告模式对放射科医生阅片行为的影响。通过眼动追踪和对照实验，比较自由文本、结构化报告和AI辅助结构化报告在诊断准确率、效率及用户体验上的差异，探讨其临床应用价值。**
...
- **简介: 该论文研究零售场景中的缺货检测（OOS）任务，提出OOS-DSD方法，基于YOLOv8引入产品分割和深度估计辅助任务，利用伪标签深度数据与归一化策略提升检测精度，显著优于现有方法。**
...
- **简介: 该论文属于视觉几何任务，旨在高效获取密集特征匹配。作者利用AV1压缩视频中的运动矢量，生成亚像素级对应点和短轨迹，通过余弦一致性筛选，在降低计算开销的同时实现密集匹配，验证了其在SfM中作为高效前端的可行性。**
...
- **链接: [http://arxiv.org/pdf/2510.16837v1](http://arxiv.org/pdf/2510.16837v1)**
...
- **简介: 该论文针对多模态大模型中视觉token过多导致的效率问题，提出VisionSelector——一种轻量、可学习的端到端视觉token压缩框架，通过可微Top-K和课程退火策略实现自适应关键token选择，在低保留率下显著提升性能与推理速度。**
...
- **简介: 该论文研究物理世界中对抗性服装对目标检测器的攻击，旨在检验现有防御方法在面对大尺寸、自然外观的对抗补丁时的有效性。作者设计了一套可攻破多种防御模型的对抗服装，在物理与数字场景下均取得高攻击成功率。**
...
- **简介: 该论文研究3D资产外观迁移任务，解决几何差异大时迁移失败的问题。提出GuideFlow3D，利用预训练直通流模型，通过可微损失函数在采样中引入优化引导，提升纹理与细节迁移效果，并采用GPT系统评估质量。**
...
- **简介: 该论文研究签名伪造检测任务，旨在提升模型在不同数据集间的泛化能力。针对跨数据集性能下降问题，比较了基于原始图像和壳预处理的两种方法，发现前者整体表现更优，后者具改进潜力。**
...
- **简介: 该论文研究视觉主导的4D占用预测与规划任务，旨在解决现有世界模型冗余建模静态背景、动态预测误差累积的问题。提出IR-WM，通过隐式残差建模当前状态变化，并结合对齐模块抑制误差积累，提升预测与规划性能。**
...
- **链接: [http://arxiv.org/pdf/2510.16196v1](http://arxiv.org/pdf/2510.16196v1)**
...
- **简介: 该论文提出UKANFormer模型，用于珊瑚礁语义分割任务，旨在解决标签噪声下的高精度生态制图问题。通过融合Kolmogorov-Arnold网络与Transformer结构，提升边界细节和全局语义提取能力，在低质标注下实现更优分割性能。**
...
- **简介: 该论文聚焦于具身智能体的场景理解任务，旨在解决多模态模型缺乏细粒度视觉-文本对齐的问题。作者提出ESCA框架，通过自监督训练的SGClip模型生成场景图，实现像素级视觉内容与语义的结构化对齐，提升智能体在复杂环境中的感知与推理能力。**
...
- **简介: 该论文提出Class-N-Diff模型，属于医学图像生成与分类任务。针对传统生成模型在皮肤癌诊断中类别控制不足的问题，将分类器嵌入扩散模型，实现分类引导的图像生成，提升合成图像质量与诊断性能。**
...
- **简介: 该论文提出一种基于机器视觉的手术照明系统，属智能医疗设备任务。针对传统照明需手动调节导致疲劳与光照不稳问题，采用YOLOv11检测术区蓝色标记，通过舵机自动调控LED光照位置，实现精准、稳定、免手动的照明，提升手术安全性与效率。**
...
- **链接: [http://arxiv.org/pdf/2510.16410v1](http://arxiv.org/pdf/2510.16410v1)**
...
- **简介: 该论文针对图像恢复中纹理细节重建不足的问题，提出WaMaIR框架。通过多尺度小波卷积扩大感受野，Mamba通道模块建模长程依赖，并设计多尺度纹理损失增强细节，提升恢复效果与计算效率。**
...
- **简介: 该论文提出主动式场景分解与重建任务，利用第一视角视频中的人-物交互线索，在动态环境中在线优化相机位姿、物体实例分割与场景建模。结合高斯点阵技术，实现高保真、可编辑的实时动态场景重建，克服静态方法的歧义性。**
...
- **简介: 该论文针对稀疏视角下3D高斯点阵渲染的过拟合问题，提出更强的初始化方法。通过改进SfM、自初始化和点云正则化，提升新视角渲染质量，验证了初始化在性能上的主导作用。**
...
- **简介: 该论文针对超高清图像生成中注意力计算复杂和缺乏高分辨率训练数据的问题，提出Scale-DiT框架，采用分层局部注意力与低分辨率全局引导，实现高效、连贯的4K图像生成，无需额外高分辨率训练数据。**
...
>
> **备注:** https://github.com/wu33learn/MIRAD
>
...
>
---
#### [new 063] Benchmarking Out-of-Distribution Detection for Plankton Recognition: A Systematic Evaluation of Advanced Methods in Marine Ecological Monitoring
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对浮游生物识别中分布外（OoD）检测问题，构建了基于DYB-PlanktonNet的OoD基准，系统评估22种先进方法，发现ViM性能最优，为实际生态监测提供可靠算法参考，是该领域首次大规模系统性评测。**

- **链接: [http://arxiv.org/pdf/2510.17179v1](http://arxiv.org/pdf/2510.17179v1)**
...
>
---
#### [new 064] Aria Gen 2 Pilot Dataset
- **分类: cs.CV; cs.AI; cs.HC; cs.LG; cs.RO**

- **简介: 该论文发布了一个基于Aria Gen 2眼镜的公开第一人称多模态数据集（A2PD），旨在推动智能眼镜感知技术发展。数据集包含五种日常场景，提供原始传感器数据与感知算法输出，支持对用户自身、环境及交互的理解。**
...
>
---
#### [new 065] CausalMamba: Scalable Conditional State Space Models for Neural Causal Inference
- **分类: cs.CV**

- **简介: 该论文提出CausalMamba，用于fMRI神经因果推断。针对BOLD信号混杂和计算复杂问题，分两步：先恢复神经活动，再用条件Mamba模型推断因果图。相比传统方法，精度更高，可发现认知任务中的动态脑网络重组。**

- **链接: [http://arxiv.org/pdf/2510.17318v1](http://arxiv.org/pdf/2510.17318v1)**
...
>
---
#### [new 066] StripRFNet: A Strip Receptive Field and Shape-Aware Network for Road Damage Detection
- **分类: cs.CV**

- **简介: 该论文属道路损伤检测任务，旨在解决细长裂缝和小尺度损伤识别难的问题。作者提出StripRFNet网络，通过形状感知、条带感受野和小尺度增强模块，提升检测精度与效率，在RDD2022数据集上取得最优性能。**

- **链接: [http://arxiv.org/pdf/2510.16115v1](http://arxiv.org/pdf/2510.16115v1)**
...
>
---
#### [new 067] Foundation Models in Medical Image Analysis: A Systematic Review and Meta-Analysis
- **分类: cs.CV; cs.AI; physics.med-ph**

- **简介: 该论文属系统综述与元分析任务，旨在整合医学图像领域基础模型的研究进展。它分类梳理架构与应用，分析数据使用趋势，探讨挑战及解决方案，推动基础模型在临床的可靠集成与转化。**

- **链接: [http://arxiv.org/pdf/2510.16973v1](http://arxiv.org/pdf/2510.16973v1)**
...
>
---
#### [new 068] GSPlane: Concise and Accurate Planar Reconstruction via Structured Representation
- **分类: cs.CV**

- **简介: 该论文属3D场景重建任务，旨在解决高斯点阵难以精确重建平面区域的问题。提出GSPlane方法，引入平面先验与动态高斯重分类，优化几何精度与网格结构，在保持渲染质量的同时提升平面重建的准确性与规整性。**

- **链接: [http://arxiv.org/pdf/2510.17095v1](http://arxiv.org/pdf/2510.17095v1)**
...
>
---
#### [new 069] Cost Savings from Automatic Quality Assessment of Generated Images
- **分类: cs.CV; I.4.9**

- **简介: 该论文针对生成图像质量评估成本高的问题，提出用自动预过滤机制减少人工审核工作量。通过建立成本节约估算公式，并在背景修复任务中验证，采用AutoML实现51.61%的成本降低。**

- **链接: [http://arxiv.org/pdf/2510.16179v1](http://arxiv.org/pdf/2510.16179v1)**
...
>
---
#### [new 070] Elastic ViTs from Pretrained Models without Retraining
- **分类: cs.CV**

- **简介: 该论文研究预训练视觉Transformer的弹性推理，解决固定模型尺寸导致部署不灵活的问题。提出SnapViT，一种无需重训练的结构化剪枝方法，通过梯度与结构相关性分析，实现跨计算预算的自适应推理，支持无标签、免微调的高效模型压缩。**

- **链接: [http://arxiv.org/pdf/2510.17700v1](http://arxiv.org/pdf/2510.17700v1)**
...
>
---
#### [new 071] Expose Camouflage in the Water: Underwater Camouflaged Instance Segmentation and Dataset
- **分类: cs.CV**

- **简介: 该论文研究水下伪装实例分割（UCIS）任务，旨在解决水下环境颜色失真、低对比度导致的伪装物体分割难题。作者构建了首个水下伪装数据集UCIS4K，并提出UCIS-SAM网络，通过通道优化、频域融合和多尺度特征聚合模块提升分割精度。**

- **链接: [http://arxiv.org/pdf/2510.17585v1](http://arxiv.org/pdf/2510.17585v1)**
...
>
---
#### [new 072] A Deep Learning Framework for Real-Time Image Processing in Medical Diagnostics: Enhancing Accuracy and Speed in Clinical Applications
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出一种用于实时医学图像分析的深度学习框架，旨在提升诊断准确性和计算效率。针对传统方法在精度、速度和鲁棒性上的不足，融合U-Net、EfficientNet和Transformer模型，结合模型压缩与硬件加速，实现多模态图像快速处理，并支持临床系统集成与结果可视化。**

- **链接: [http://arxiv.org/pdf/2510.16611v1](http://arxiv.org/pdf/2510.16611v1)**
...
>
---
#### [new 073] BARL: Bilateral Alignment in Representation and Label Spaces for Semi-Supervised Volumetric Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文研究半监督医学图像分割，旨在减少标注成本的同时保持性能。针对现有方法忽略特征空间对齐的问题，提出BARL框架，通过双分支协同学习，在标签和特征空间同时进行对齐，提升分割精度与一致性。**

- **链接: [http://arxiv.org/pdf/2510.16863v1](http://arxiv.org/pdf/2510.16863v1)**
...
>
---
#### [new 074] From Mannequin to Human: A Pose-Aware and Identity-Preserving Video Generation Framework for Lifelike Clothing Display
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出“从假人到真人”视频生成任务，旨在将假人试衣视频转化为逼真的人体穿着视频。为解决头身动作错位与身份漂移问题，作者设计了姿态感知的头编码器、像素空间镜像损失和分布感知适配器，在保持身份与服装一致性的同时提升视频质量。**

- **链接: [http://arxiv.org/pdf/2510.16833v1](http://arxiv.org/pdf/2510.16833v1)**
...
>
---
#### [new 075] KineDiff3D: Kinematic-Aware Diffusion for Category-Level Articulated Object Shape Reconstruction and Generation
- **分类: cs.CV**

- **简介: 该论文研究类别级可动物体的三维重建与生成，解决因部件运动导致的结构多样性难题。提出KineDiff3D框架，结合变分自编码器、扩散模型与优化模块，实现从单视图输入恢复完整形状并估计位姿与关节参数。**

- **链接: [http://arxiv.org/pdf/2510.17137v1](http://arxiv.org/pdf/2510.17137v1)**
...
>
---
#### [new 076] Facial Expression-based Parkinson's Disease Severity Diagnosis via Feature Fusion and Adaptive Class Balancing
- **分类: cs.CV**

- **简介: 该论文研究帕金森病（PD）严重程度的面部表情识别诊断。针对现有方法依赖单一表情、忽略类别不平衡及仅做二分类的问题，提出多特征融合与自适应类别平衡方法，提升PD多阶段分类性能。**

- **链接: [http://arxiv.org/pdf/2510.17373v1](http://arxiv.org/pdf/2510.17373v1)**
...
>
---
#### [new 077] Res-Bench: Benchmarking the Robustness of Multimodal Large Language Models to Dynamic Resolution Input
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 078] M2H: Multi-Task Learning with Efficient Window-Based Cross-Task Attention for Monocular Spatial Perception
- **分类: cs.CV; cs.LG; cs.RO**

- **简介: 该论文提出M2H框架，面向单目图像的多任务空间感知（语义分割、深度、边缘、法向估计），解决多任务间特征互补与计算效率平衡问题。设计窗口化跨任务注意力模块，在轻量ViT骨干上实现高效特征交互，支持实时部署，验证于3D场景构建应用。**
...
>
---
#### [new 079] Region in Context: Text-condition Image editing with Human-like semantic reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究文本引导的图像编辑任务，旨在解决局部编辑导致的语义不一致问题。提出“Region in Context”框架，通过全局场景描述与局部区域描述的双重语言对齐，实现兼顾整体语境与局部细节的协调编辑。**

- **链接: [http://arxiv.org/pdf/2510.16772v1](http://arxiv.org/pdf/2510.16772v1)**
...
>
---
#### [new 080] Multilingual Text-to-Image Person Retrieval via Bidirectional Relation Reasoning and Aligning
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究多语言文本到图像行人检索（TIPR），解决跨模态异构与语言单一问题。提出Bi-IRRA框架，通过双向隐式关系推理和多维度全局对齐，实现跨语言跨模态的细粒度匹配，并构建多语言基准数据集。**

- **链接: [http://arxiv.org/pdf/2510.17685v1](http://arxiv.org/pdf/2510.17685v1)**

> **作者:** Min Cao; Xinyu Zhou; Ding Jiang; Bo Du; Mang Ye; Min Zhang
>
> **备注:** Final version published in IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI). Xplore link: https://ieeexplore.ieee.org/document/11199360
>
...
>
---
#### [new 081] UltraCUA: A Foundation Model for Computer Use Agents with Hybrid Action
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 082] MUG-V 10B: High-efficiency Training Pipeline for Large Video Generation Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦大规模视频生成模型训练效率问题，提出MUG-V 10B训练框架，优化数据、模型、训练和基础设施四方面，提升训练效率与性能，开源完整代码与模型，支持高效多节点扩展。**

- **链接: [http://arxiv.org/pdf/2510.17519v1](http://arxiv.org/pdf/2510.17519v1)**
...
>
> **备注:** Technical Report; Project Page: \href{https://github.com/Shopee-MUG/MUG-V}
>
...
>
---
#### [new 083] Click, Predict, Trust: Clinician-in-the-Loop AI Segmentation for Lung Cancer CT-Based Prognosis within the Knowledge-to-Action Framework
- **分类: cs.CV; F.2.2; I.2.7**

- **简介: 该论文聚焦肺癌CT图像分割与预后预测，旨在提升临床采纳度。提出医生参与的AI框架，结合VNet模型与半监督学习，优化分割精度、放射组学稳定性及临床信任，推动可信赖AI在医疗中的应用。**

- **链接: [http://arxiv.org/pdf/2510.17039v1](http://arxiv.org/pdf/2510.17039v1)**
...
>
---
#### [new 084] Cataract-LMM: Large-Scale, Multi-Source, Multi-Task Benchmark for Deep Learning in Surgical Video Analysis
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文构建了一个大规模、多中心、多任务的白内障手术视频数据集Cataract-LMM，涵盖手术阶段、器械分割、交互追踪和技能评分四类标注，旨在解决现有数据缺乏多样性和标注深度的问题，推动手术AI的泛化能力研究。**

- **链接: [http://arxiv.org/pdf/2510.16371v1](http://arxiv.org/pdf/2510.16371v1)**
...
>
---
#### [new 085] Instance-Aware Pseudo-Labeling and Class-Focused Contrastive Learning for Weakly Supervised Domain Adaptive Segmentation of Electron Microscopy
- **分类: cs.CV**

- **简介: 该论文研究弱监督域自适应电子显微图像分割，旨在利用稀疏点标注缓解域偏移问题。提出实例感知伪标签与类聚焦对比学习方法，通过多任务框架联合优化分割与中心检测，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2510.16450v1](http://arxiv.org/pdf/2510.16450v1)**
...
>
---
#### [new 086] HumanCM: One Step Human Motion Prediction
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究人体运动预测任务，旨在解决现有扩散模型推理步数多、效率低的问题。作者提出HumanCM，基于一致性模型实现单步生成，采用Transformer架构建模时空依赖，在保持高精度的同时显著提升推理速度。**

- **链接: [http://arxiv.org/pdf/2510.16709v1](http://arxiv.org/pdf/2510.16709v1)**
...
>
---
#### [new 087] Raindrop GS: A Benchmark for 3D Gaussian Splatting under Raindrop Conditions
- **分类: cs.CV**

- **简介: 该论文针对雨滴干扰下的3D高斯点阵（3DGS）重建问题，提出RaindropGS基准，解决真实雨滴导致的位姿估计与初始化难题。工作包括构建真实数据集、设计完整评估流程，并分析各模块性能瓶颈。**

- **链接: [http://arxiv.org/pdf/2510.17719v1](http://arxiv.org/pdf/2510.17719v1)**
...
>
---
#### [new 088] Fair and Interpretable Deepfake Detection in Videos
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视频深度伪造检测任务，旨在解决现有方法存在的偏见、缺乏可解释性和时序信息建模不足的问题。作者提出一种公平且可解释的检测框架，结合时序特征学习、概念提取和基于人群的数据增强，提升检测性能与公平性。**

- **链接: [http://arxiv.org/pdf/2510.17264v1](http://arxiv.org/pdf/2510.17264v1)**
...
>
---
#### [new 089] OpenLVLM-MIA: A Controlled Benchmark Revealing the Limits of Membership Inference Attacks on Large Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对视觉语言模型的成员推断攻击评估问题，发现现有高攻击成功率源于数据分布偏差。为此，作者构建了可控基准OpenLVLM-MIA，平衡成员与非成员分布，提供真实标签。实验表明，在无偏条件下，现有方法性能退化至随机水平，揭示当前MIA的局限性。**

- **链接: [http://arxiv.org/pdf/2510.16295v1](http://arxiv.org/pdf/2510.16295v1)**
...
>
---
#### [new 090] Uncovering Brain-Like Hierarchical Patterns in Vision-Language Models through fMRI-Based Neural Encoding
- **分类: cs.CV**

- **简介: 该论文研究视觉-语言模型（VLM）是否具有类脑分层处理机制。通过fMRI神经编码，分析CLIP和METER中人工神经元与人脑神经活动的对应关系，揭示其在多模态信息处理、功能冗余、激活极性及架构影响方面的类脑特性。**

- **链接: [http://arxiv.org/pdf/2510.16870v1](http://arxiv.org/pdf/2510.16870v1)**
...
>
---
#### [new 091] SPLite Hand: Sparsity-Aware Lightweight 3D Hand Pose Estimation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究3D手部姿态估计任务，旨在解决边缘设备上模型效率与精度平衡问题。提出SPLite框架，结合稀疏卷积、轻量解码器和量化训练，在保持精度的同时显著提升推理速度与能效。**

- **链接: [http://arxiv.org/pdf/2510.16396v1](http://arxiv.org/pdf/2510.16396v1)**
...
>
---
#### [new 092] Unsupervised Monocular Road Segmentation for Autonomous Driving via Scene Geometry
- **分类: cs.CV**

- **简介: 该论文研究无监督单目道路分割，旨在无需标注数据实现自动驾驶中的道路识别。利用场景几何生成弱标签，并通过时序一致性优化分割结果，在Cityscapes上达到82% IoU，验证了结合几何与时间信息的有效性。**

- **链接: [http://arxiv.org/pdf/2510.16790v1](http://arxiv.org/pdf/2510.16790v1)**
...
>
---
#### [new 093] Stroke2Sketch: Harnessing Stroke Attributes for Training-Free Sketch Generation
- **分类: cs.CV**

- **简介: 该论文研究无需训练的草图生成任务，旨在解决参考风格中笔画属性（如粗细、形变）精确迁移与语义结构保持的问题。提出Stroke2Sketch框架，通过跨图像笔画注意力、自适应对比增强和语义聚焦注意力，实现高质量风格化草图生成。**

- **链接: [http://arxiv.org/pdf/2510.16319v1](http://arxiv.org/pdf/2510.16319v1)**
...
>
---
#### [new 094] iDETEX: Empowering MLLMs for Intelligent DETailed EXplainable IQA
- **分类: cs.CV**

- **简介: 该论文聚焦图像质量评估（IQA）任务，旨在实现细粒度、可解释的评价。提出iDETEX模型，统一完成质量定位、感知与描述，通过离线增强、数据混合与在线优化策略提升多任务性能，在ViDA-UGC基准上达到最优效果。**

- **链接: [http://arxiv.org/pdf/2510.17332v1](http://arxiv.org/pdf/2510.17332v1)**
...
>
---
#### [new 095] Segmentation as A Plug-and-Play Capability for Frozen Multimodal LLMs
- **分类: cs.CV**

- **简介: 该论文研究多模态大模型的分割能力扩展，旨在不破坏模型原有泛化性的前提下实现像素级分割。提出LENS方法，通过冻结主干模型并添加轻量可训练头，利用注意力图提取关键点特征，实现即插即用的高效分割。**

- **链接: [http://arxiv.org/pdf/2510.16785v1](http://arxiv.org/pdf/2510.16785v1)**
...
>
---
#### [new 096] DuetMatch: Harmonizing Semi-Supervised Brain MRI Segmentation via Decoupled Branch Optimization
- **分类: cs.CV**

- **简介: 该论文研究半监督脑MRI分割，解决标注数据少导致的训练不稳定问题。提出DuetMatch框架，通过解耦编码器与解码器的异步优化、解耦Dropout扰动、配对CutMix互指导及一致性匹配，提升模型鲁棒性与分割性能。**

- **链接: [http://arxiv.org/pdf/2510.16146v1](http://arxiv.org/pdf/2510.16146v1)**
...
>
---
#### [new 097] ObjectTransforms for Uncertainty Quantification and Reduction in Vision-Based Perception for Autonomous Vehicles
- **分类: cs.CV**

- **简介: 该论文针对自动驾驶中视觉感知的不确定性问题，提出ObjectTransforms方法。通过训练时对象级颜色扰动与扩散模型生成数据增强，提升模型鲁棒性；推理时利用对象扰动的检测分数方差量化不确定性，有效过滤误检、召回漏检，提高检测性能。**

- **链接: [http://arxiv.org/pdf/2510.16118v1](http://arxiv.org/pdf/2510.16118v1)**

> **作者:** Nishad Sahu; Shounak Sural; Aditya Satish Patil; Ragunathan; Rajkumar
>
...
>
---
#### [new 098] Enhancing Rotated Object Detection via Anisotropic Gaussian Bounding Box and Bhattacharyya Distance
- **分类: cs.CV**

- **简介: 该论文针对旋转目标检测中方向敏感问题，提出基于各向异性高斯边界框和巴塔恰里亚距离的损失函数，提升检测精度与鲁棒性，适用于遥感、自动驾驶等场景。**

- **链接: [http://arxiv.org/pdf/2510.16445v1](http://arxiv.org/pdf/2510.16445v1)**
...
>
---
#### [new 099] 4DSegStreamer: Streaming 4D Panoptic Segmentation via Dual Threads
- **分类: cs.CV**

- **简介: 该论文研究4D流式全景分割任务，旨在实现实时、细粒度的动态场景感知。为解决高帧率下实时性与精度的平衡问题，提出4DSegStreamer框架，采用双线程系统，分别进行运动预测和帧间推理，提升效率与鲁棒性，并在多个数据集上验证了有效性。**

- **链接: [http://arxiv.org/pdf/2510.17664v1](http://arxiv.org/pdf/2510.17664v1)**
...
>
---
#### [new 100] Beyond Real Faces: Synthetic Datasets Can Achieve Reliable Recognition Performance without Privacy Compromise
- **分类: cs.CV**

- **简介: 该论文研究合成人脸数据在面部识别中的可行性，旨在解决真实数据带来的隐私问题。通过评估25个合成数据集并实验验证，表明高质量合成数据可达到甚至超越真实数据的识别性能，同时有效保护隐私、缓解偏见，为面部识别提供安全合规替代方案。**

- **链接: [http://arxiv.org/pdf/2510.17372v1](http://arxiv.org/pdf/2510.17372v1)**
...
>
---
#### [new 101] An RGB-D Image Dataset for Lychee Detection and Maturity Classification for Robotic Harvesting
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 102] Context-Aware Pseudo-Label Scoring for Zero-Shot Video Summarization
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究零样本视频摘要，旨在解决现有方法依赖标注或敏感于提示模板的问题。提出上下文感知的伪标签评分框架，利用少量真实标注生成自适应评分准则，并结合场景上下文提升摘要的连贯性与显著性。**

- **链接: [http://arxiv.org/pdf/2510.17501v1](http://arxiv.org/pdf/2510.17501v1)**
...
>
---
#### [new 103] Video Reasoning without Training
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文研究视频推理任务，旨在减少大模型推理过程中的计算开销。通过分析输出熵，提出V-Reason方法，在无需训练的情况下优化推理行为，提升准确性并显著降低输出长度。**

- **链接: [http://arxiv.org/pdf/2510.17045v1](http://arxiv.org/pdf/2510.17045v1)**
...
>
---
#### [new 104] CARE: Contrastive Alignment for ADL Recognition from Event-Triggered Sensor Streams
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究事件触发传感器流中的日常活动识别任务，旨在解决现有方法在时空表征融合上的不足。提出CARE框架，通过序列-图像对比对齐和联合优化，实现抗噪、空间感知且判别性强的端到端学习，显著提升识别性能与鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.16988v1](http://arxiv.org/pdf/2510.16988v1)**
...
>
---
#### [new 105] Do Satellite Tasks Need Special Pretraining?
- **分类: cs.CV**

- **简介: 该论文探讨遥感任务是否需要专用预训练模型。作者通过构建小规模基准测试，比较通用视觉模型与针对遥感图像设计的iBOT模型性能，发现专用预训练在ViT-B规模下未带来一致提升，质疑了专用基础模型的必要性。**

- **链接: [http://arxiv.org/pdf/2510.17014v1](http://arxiv.org/pdf/2510.17014v1)**
...
>
---
#### [new 106] Enhancing Compositional Reasoning in CLIP via Reconstruction and Alignment of Text Descriptions
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对视觉-语言模型在组合推理上的不足，提出READ方法，通过添加文本描述的重建与对齐辅助目标，增强CLIP模型对词语关系和句式变化的理解，在多个基准上达到最优性能。**

- **链接: [http://arxiv.org/pdf/2510.16540v1](http://arxiv.org/pdf/2510.16540v1)**
...
>
---
#### [new 107] EndoCIL: A Class-Incremental Learning Framework for Endoscopic Image Classification
- **分类: cs.CV**

- **简介: 该论文研究内窥镜图像分类中的类增量学习任务，旨在解决模型持续学习新类别时的灾难性遗忘问题。作者提出EndoCIL框架，通过样本重放、平衡损失和梯度校准策略，有效缓解域差异与类别不平衡，提升模型稳定性和泛化性。**

- **链接: [http://arxiv.org/pdf/2510.17200v1](http://arxiv.org/pdf/2510.17200v1)**
...
>
---
#### [new 108] Rethinking Nighttime Image Deraining via Learnable Color Space Transformation
- **分类: cs.CV**

- **简介: 该论文研究夜间图像去雨任务，旨在解决夜间雨天场景中光照与雨水耦合导致的去雨难题。作者构建了高质量数据集HQ-NightRain，并提出CST-Net网络，通过可学习的颜色空间转换和隐式光照引导，增强夜间去雨效果。**

- **链接: [http://arxiv.org/pdf/2510.17440v1](http://arxiv.org/pdf/2510.17440v1)**
...
>
---
#### [new 109] Glyph: Scaling Context Windows via Visual-Text Compression
...
>
---
#### [new 110] GACO-CAD: Geometry-Augmented and Conciseness-Optimized CAD Model Generation from Single Image
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究从单张图像生成可编辑CAD模型的任务，旨在解决现有模型几何推理弱、建模步骤冗长的问题。提出GACO-CAD框架，通过引入几何先验和强化学习优化，提升三维重建精度与代码简洁性。**

- **链接: [http://arxiv.org/pdf/2510.17157v1](http://arxiv.org/pdf/2510.17157v1)**
...
>
---
#### [new 111] RefAtomNet++: Advancing Referring Atomic Video Action Recognition using Semantic Retrieval based Multi-Trajectory Mamba
- **分类: cs.CV; cs.MM; cs.RO; eess.IV**

- **简介: 该论文研究指代表性原子级视频动作识别（RAVAR），旨在根据语言描述精确定位特定人的细粒度动作。作者提出RefAtomNet++模型，通过多轨迹Mamba和多层次语义对齐机制提升跨模态理解，在RefAVA++数据集上实现新SOTA。**
...
>
---
#### [new 112] Automatic Classification of Circulating Blood Cell Clusters based on Multi-channel Flow Cytometry Imaging
- **分类: cs.CV**

- **简介: 该论文针对循环血细胞簇（CCC）图像自动分析难题，提出一种基于多通道流式细胞成像的两步计算框架：先用改进YOLOv11模型分类细胞簇与非簇，再结合多通道荧光叠加识别簇内细胞类型，实现高精度自动分析。**

- **链接: [http://arxiv.org/pdf/2510.17716v1](http://arxiv.org/pdf/2510.17716v1)**
...
>
---
#### [new 113] ConsistEdit: Highly Consistent and Precise Training-free Visual Editing
- **分类: cs.CV**

- **简介: 该论文研究无需训练的视觉编辑任务，旨在解决现有方法在编辑强度与源一致性间的权衡问题。作者基于MM-DiT架构提出ConsistEdit，通过视觉注意力控制、掩码引导融合和查询-键-值差异化操作，实现高一致性和精细可控的图像与视频编辑。**

- **链接: [http://arxiv.org/pdf/2510.17803v1](http://arxiv.org/pdf/2510.17803v1)**
...
>
---
#### [new 114] One Dinomaly2 Detect Them All: A Unified Framework for Full-Spectrum Unsupervised Anomaly Detection
- **分类: cs.CV**

- **简介: 该论文提出Dinomaly2，旨在解决无监督异常检测中多类模型性能不足及方法碎片化问题。它构建了一个统一框架，通过简约设计实现跨模态、跨任务的全谱异常检测，在多种场景下达到先进性能。**

- **链接: [http://arxiv.org/pdf/2510.17611v1](http://arxiv.org/pdf/2510.17611v1)**
...
>
---
#### [new 115] SparseVILA: Decoupling Visual Sparsity for Efficient VLM Inference
- **分类: cs.CV**

- **简介: 该论文针对视觉语言模型（VLM）推理效率低的问题，提出SparseVILA框架，通过解耦预填充与解码阶段的视觉稀疏性，在不损失性能的前提下显著加速推理，实现训练免费、架构通用的高效多模态推理。**

- **链接: [http://arxiv.org/pdf/2510.17777v1](http://arxiv.org/pdf/2510.17777v1)**
...
>
---
#### [new 116] Prominence-Aware Artifact Detection and Dataset for Image Super-Resolution
- **分类: cs.CV; cs.LG**

- **简介: 该论文聚焦图像超分辨率中的伪影检测任务，提出应关注伪影对人眼感知的显著性。作者构建了含1302个伪影样本及显著性评分的数据集，并训练轻量模型生成显著性热图，实现更精准的伪影检测，推动感知导向的SR质量评估。**

- **链接: [http://arxiv.org/pdf/2510.16752v1](http://arxiv.org/pdf/2510.16752v1)**
...
>
---
#### [new 117] EMRRG: Efficient Fine-Tuning Pre-trained X-ray Mamba Networks for Radiology Report Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究X射线医学报告生成任务，旨在解决现有模型对视觉基础模型和高效微调技术探索不足的问题。作者提出EMRRG框架，采用预训练Mamba网络与部分LoRA微调，结合SSM视觉骨干和混合解码LLM，实现高效准确的报告生成。**

- **链接: [http://arxiv.org/pdf/2510.16776v1](http://arxiv.org/pdf/2510.16776v1)**
...
>
---
#### [new 118] IAD-GPT: Advancing Visual Knowledge in Multimodal Large Language Model for Industrial Anomaly Detection
- **分类: cs.CV**

- **简介: 该论文针对工业异常检测中缺乏细粒度描述与多轮交互的问题，提出IAD-GPT模型，结合图像与文本语义，通过异常提示生成、文本引导增强和多掩码融合模块，提升多模态大模型在异常检测与分割任务中的视觉定位与语言理解能力。**

- **链接: [http://arxiv.org/pdf/2510.16036v1](http://arxiv.org/pdf/2510.16036v1)**
...
>
---
#### [new 119] Boosting Fidelity for Pre-Trained-Diffusion-Based Low-Light Image Enhancement via Condition Refinement
- **分类: cs.CV**

- **简介: 该论文针对预训练扩散模型在低光照图像增强中内容保真度不足的问题，提出通过条件潜变量优化与双向交互机制提升重建细节。方法引入潜变量细化流程，结合生成先验，在保持视觉真实感的同时显著提高保真度，且可即插即用。**

- **链接: [http://arxiv.org/pdf/2510.17105v1](http://arxiv.org/pdf/2510.17105v1)**
...
>
---
#### [new 120] LightGlueStick: a Fast and Robust Glue for Joint Point-Line Matching
- **分类: cs.CV**

- **简介: 该论文针对点线联合匹配任务，解决现有方法计算量大、难部署的问题。提出轻量级模型LightGlueStick，引入注意力线消息传递机制，提升效率与性能，实现实时匹配，适用于边缘设备。**

- **链接: [http://arxiv.org/pdf/2510.16438v1](http://arxiv.org/pdf/2510.16438v1)**
...
>
---
#### [new 121] Scaling Laws for Deepfake Detection
- **分类: cs.CV**

- **简介: 该论文研究深度伪造检测的扩展规律，构建了包含51个真实图像域和102种生成方法的大规模数据集ScaleDF，发现检测误差随数据规模呈幂律下降，揭示了数据多样性对检测性能的关键作用。**

- **链接: [http://arxiv.org/pdf/2510.16320v1](http://arxiv.org/pdf/2510.16320v1)**
...
>
---
#### [new 122] When One Moment Isn't Enough: Multi-Moment Retrieval with Cross-Moment Interactions
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究多时刻检索（MMR）任务，解决单时刻检索无法覆盖查询对应多个视频片段的问题。作者构建了QV-M²数据集，提出FlashMMR框架，通过多时刻后验证模块优化边界，提升多时刻定位性能。**

- **链接: [http://arxiv.org/pdf/2510.17218v1](http://arxiv.org/pdf/2510.17218v1)**
...
>
---
#### [new 123] Intelligent Communication Mixture-of-Experts Boosted-Medical Image Segmentation Foundation Model
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦医学图像分割任务，旨在解决现有微调方法在高层特征表达和预训练权重结构完整性上的不足。提出IC-MoE模型，通过混合专家架构与语义引导对比学习，增强特征表示并保持权重结构完整。**

- **链接: [http://arxiv.org/pdf/2510.17684v1](http://arxiv.org/pdf/2510.17684v1)**
...
>
---
#### [new 124] Nearest-Class Mean and Logits Agreement for Wildlife Open-Set Recognition
- **分类: cs.CV**

- **简介: 该论文研究野生动物开放集识别（OSR），旨在分类已知物种并拒绝未知物种。提出一种无需重训练的后处理方法，通过比较最近类均值与分类头输出的一致性来检测未知类，在两个数据集上表现优异。**

- **链接: [http://arxiv.org/pdf/2510.17338v1](http://arxiv.org/pdf/2510.17338v1)**
...
>
---
#### [new 125] Cerberus: Real-Time Video Anomaly Detection via Cascaded Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 126] SDPA++: A General Framework for Self-Supervised Denoising with Patch Aggregation
- **分类: cs.CV**

- **简介: 该论文针对OCT图像去噪中缺乏配对训练数据的问题，提出SDPA++自监督框架。通过自融合生成伪标签，结合patch聚合训练去噪模型，在无真实干净图像情况下有效提升图像质量，适用于临床实际场景。**

- **链接: [http://arxiv.org/pdf/2510.16702v1](http://arxiv.org/pdf/2510.16702v1)**
...
>
---
#### [new 127] Data-Centric AI for Tropical Agricultural Mapping: Challenges, Strategies and Scalable Solutions
- **分类: cs.CV**

- **简介: 该论文聚焦热带农业遥感制图，针对数据质量差、标注成本高和模型泛化难等问题，提出以数据为中心的AI方法。通过综述并构建包含9种成熟技术的数据处理流程，提升模型鲁棒性与可扩展性，解决传统方法在复杂热带环境下的局限。**

- **链接: [http://arxiv.org/pdf/2510.16207v1](http://arxiv.org/pdf/2510.16207v1)**
...
>
---
#### [new 128] CaMiT: A Time-Aware Car Model Dataset for Classification and Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出CaMiT数据集，面向细粒度车型分类与生成任务，解决视觉模型在时间演化下的适应性问题。工作包括构建含时标的大规模车型数据集，设计时间增量学习方法提升跨年识别鲁棒性，并探索时序感知图像生成。**

- **链接: [http://arxiv.org/pdf/2510.17626v1](http://arxiv.org/pdf/2510.17626v1)**
...
>
---
#### [new 129] One-step Diffusion Models with Bregman Density Ratio Matching
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文聚焦于加速扩散模型生成，提出Di-Bregman框架，将蒸馏过程统一为基于Bregman散度的密度比匹配。该方法理论清晰，提升了一步生成图像质量，实现了高效单步采样。**

- **链接: [http://arxiv.org/pdf/2510.16983v1](http://arxiv.org/pdf/2510.16983v1)**
...
>
---
#### [new 130] ZSPAPrune: Zero-Shot Prompt-Aware Token Pruning for Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视觉-语言模型中的视觉令牌剪枝任务，旨在降低推理成本。针对现有方法忽略文本提示指导的问题，提出ZSPAPrune方法，通过提示感知的层级剪枝，平衡任务相关性与信息多样性，在大幅剪枝下保持高性能。**

- **链接: [http://arxiv.org/pdf/2510.17197v1](http://arxiv.org/pdf/2510.17197v1)**
...
>
---
#### [new 131] A Comprehensive Survey on World Models for Embodied AI
- **分类: cs.CV**

- **简介: 该论文属于综述任务，旨在系统梳理具身智能中的世界模型。它提出统一框架，从功能、时序建模与空间表示三方面分类，整理数据集与评测指标，比较前沿模型，并指出长时序一致性、计算效率与物理合理性的核心挑战。**

- **链接: [http://arxiv.org/pdf/2510.16732v1](http://arxiv.org/pdf/2510.16732v1)**
...
>
---
#### [new 132] Contrail-to-Flight Attribution Using Ground Visible Cameras and Flight Surveillance Data
- **分类: cs.CV**

- **简介: 该论文致力于解决飞行轨迹与观测到的凝结尾迹的匹配问题。通过结合地面相机图像和飞行数据，提出一个模块化框架，实现高时空分辨率下的尾迹归因，为非CO₂气候影响研究提供验证工具。**

- **链接: [http://arxiv.org/pdf/2510.16891v1](http://arxiv.org/pdf/2510.16891v1)**
...
>
---
#### [new 133] Joint Multi-Condition Representation Modelling via Matrix Factorisation for Visual Place Recognition
- **分类: cs.CV**

- **简介: 该论文研究视觉地点识别中的多参考条件问题，旨在提升不同外观和视角下的定位性能。提出一种无需训练、基于矩阵分解的联合表示方法，实现轻量化的残差匹配，并构建多视角基准SotonMV，显著提升召回率。**

- **链接: [http://arxiv.org/pdf/2510.17739v1](http://arxiv.org/pdf/2510.17739v1)**
...
>
---
#### [new 134] VM-BeautyNet: A Synergistic Ensemble of Vision Transformer and Mamba for Facial Beauty Prediction
- **分类: cs.CV**

- **简介: 该论文研究面部美感预测任务，旨在解决现有模型难以兼顾全局特征与计算效率的问题。提出VM-BeautyNet，融合视觉Transformer与Mamba模型，结合二者优势，在SCUT-FBP5500数据集上取得最优性能，并通过可视化验证了特征互补性。**

- **链接: [http://arxiv.org/pdf/2510.16220v1](http://arxiv.org/pdf/2510.16220v1)**
...
>
---
#### [new 135] Investigating Adversarial Robustness against Preprocessing used in Blackbox Face Recognition
- **分类: cs.CV**

- **简介: 该论文研究黑盒人脸识别系统中预处理对对抗攻击的影响，发现不同人脸检测模型显著降低攻击成功率。作者提出一种预处理不变的输入变换方法，提升对抗样本迁移性，强调预处理在对抗鲁棒性中的关键作用。**

- **链接: [http://arxiv.org/pdf/2510.17169v1](http://arxiv.org/pdf/2510.17169v1)**
...
>
---
#### [new 136] Integrating BIM and UAV-based photogrammetry for Automated 3D Structure Model Segmentation
- **分类: cs.CV**

- **简介: 该论文针对3D点云中结构部件分割依赖人工、耗时易错的问题，提出一种融合BIM与无人机摄影测量的机器学习框架，实现基础设施模型的自动分割，提升精度与效率。**

- **链接: [http://arxiv.org/pdf/2510.17609v1](http://arxiv.org/pdf/2510.17609v1)**
...
>
---
#### [new 137] MT-Video-Bench: A Holistic Video Understanding Benchmark for Evaluating Multimodal LLMs in Multi-Turn Dialogues
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MT-Video-Bench，针对多模态大模型在视频理解中的多轮对话能力进行评估。旨在解决现有基准局限于单轮问答的问题，构建包含987个多轮对话的综合评测集，覆盖六大核心能力，推动多模态模型在真实交互场景中的发展。**

- **链接: [http://arxiv.org/pdf/2510.17722v1](http://arxiv.org/pdf/2510.17722v1)**
...
>
---
#### [new 138] $\mathcal{V}isi\mathcal{P}runer$: Decoding Discontinuous Cross-Modal Dynamics for Efficient Multimodal LLMs
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 139] Pursuing Minimal Sufficiency in Spatial Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视觉-语言模型中的空间推理任务，旨在解决因2D预训练导致3D理解不足和冗余信息干扰的问题。作者提出MSSR框架，通过感知与推理双代理协同构建最小充分信息集，提升推理准确性和可解释性。**

- **链接: [http://arxiv.org/pdf/2510.16688v1](http://arxiv.org/pdf/2510.16688v1)**
...
>
---
#### [new 140] Structured Interfaces for Automated Reasoning with 3D Scene Graphs
...
>
---
#### [new 141] RL makes MLLMs see better than SFT
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究多模态大模型（MLLM）中视觉编码器的训练影响，发现强化学习（RL）比监督微调（SFT）更优。通过分析揭示RL能生成更强、定位更准的视觉表征，并提出高效方法PIVOT，显著提升视觉编码器性能。**

- **链接: [http://arxiv.org/pdf/2510.16333v1](http://arxiv.org/pdf/2510.16333v1)**
...
>
---
#### [new 142] Beyond RGB: Leveraging Vision Transformers for Thermal Weapon Segmentation
- **分类: cs.CV; 68T07, 68U10, 68U35; I.2.10; I.4.8; I.4.9**

- **简介: 该论文研究热成像下的武器分割任务，旨在解决RGB方法在低光和遮挡条件下失效的问题。作者基于Vision Transformers在自建热成像数据集上评估四种架构，验证其在精度与速度间的权衡，提升复杂环境下的武器检测鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.16913v1](http://arxiv.org/pdf/2510.16913v1)**
...
>
---
#### [new 143] Exploring The Missing Semantics In Event Modality
- **分类: cs.CV**

- **简介: 该论文研究事件相机的语义缺失问题，属事件到视频重建（E2V）任务。针对现有方法忽略语义信息的问题，提出Semantic-E2VID框架，通过跨模态对齐和语义感知融合，引入SAM模型的语义知识，提升重建视频的语义细节与质量。**

- **链接: [http://arxiv.org/pdf/2510.17347v1](http://arxiv.org/pdf/2510.17347v1)**
...
>
---
#### [new 144] From Pixels to People: Satellite-Based Mapping and Quantification of Riverbank Erosion and Lost Villages in Bangladesh
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦河流侵蚀导致的村庄消失问题，利用卫星图像与Segment Anything Model（SAM）构建首个孟加拉国消逝村落标注数据集，提出融合颜色分析与SAM微调的方法，精准分割水陆边界，量化土地损失，助力灾害监测与政策制定。**

- **链接: [http://arxiv.org/pdf/2510.17198v1](http://arxiv.org/pdf/2510.17198v1)**
...
>
---
#### [new 145] DiffusionX: Efficient Edge-Cloud Collaborative Image Generation with Multi-Round Prompt Evolution
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对扩散模型生成图像计算量大、提示词需多轮迭代的问题，提出DiffusionX框架，通过端侧轻量模型预览与云侧大模型精修协同，结合噪声预测器动态分配计算，实现高效图文生成。**

- **链接: [http://arxiv.org/pdf/2510.16326v1](http://arxiv.org/pdf/2510.16326v1)**

> **作者:** Yi Wei; Shunpu Tang; Liang Zhao; Qiangian Yang
>
...
>
---
#### [new 146] Fit for Purpose? Deepfake Detection in the Real World
- **分类: cs.CV**

- **简介: 该论文聚焦深伪检测在现实政治场景中的有效性，旨在解决现有模型在实验室数据上表现良好但难以泛化到真实社交平台政治深伪内容的问题。作者构建首个基于真实政治深伪事件的基准，评估了学术、政府和工业界的主流检测工具，发现其普遍性能不足，尤其对视频类深伪易受简单篡改影响，凸显构建具政治语境的检测框架的必要性。**

- **链接: [http://arxiv.org/pdf/2510.16556v1](http://arxiv.org/pdf/2510.16556v1)**
...
>
---
#### [new 147] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
- **分类: cs.CV**

- **简介: 该论文属6D物体位姿估计任务，旨在解决纹理缺失与光照变化下的位姿估计难题。作者提出GS2POSE，结合高斯点阵与位姿优化，通过可微渲染与颜色参数更新，提升估计精度。**

- **链接: [http://arxiv.org/pdf/2510.16777v1](http://arxiv.org/pdf/2510.16777v1)**
...
>
---
#### [new 148] CrossRay3D: Geometry and Distribution Guidance for Efficient Multimodal 3D Detection
- **分类: cs.CV**

- **简介: 该论文研究多模态3D目标检测，针对稀疏跨模态检测器中token表征质量低的问题，提出CrossRay3D方法。通过几何与分布引导的稀疏选择器和位置编码，提升小物体检测与模态对齐，实现高效、鲁棒的3D检测。**

- **链接: [http://arxiv.org/pdf/2510.15991v1](http://arxiv.org/pdf/2510.15991v1)**
...
>
---
#### [new 149] Frugal Federated Learning for Violence Detection: A Comparison of LoRA-Tuned VLMs and Personalized CNNs
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文研究联邦学习下的暴力检测任务，比较LoRA微调的视觉语言模型与个性化小型3D CNN的性能。重点解决非IID数据下模型准确性、能耗与碳排放的权衡问题，提出兼顾效率与推理能力的混合部署方案。**

- **链接: [http://arxiv.org/pdf/2510.17651v1](http://arxiv.org/pdf/2510.17651v1)**
...
>
---
#### [new 150] PRISMM-Bench: A Benchmark of Peer-Review Grounded Multimodal Inconsistencies
- **分类: cs.CV**

- **简介: 该论文提出PRISMM-Bench，首个基于真实同行评审标记的多模态不一致性基准，旨在评估大模型在科学论文中跨文本、图表、公式等模态识别与修正不一致性的能力，解决现有基准忽略真实复杂性及选择偏差问题。**

- **链接: [http://arxiv.org/pdf/2510.16505v1](http://arxiv.org/pdf/2510.16505v1)**
...
>
---
#### [new 151] Visual Autoregressive Models Beat Diffusion Models on Inference Time Scaling
- **分类: cs.CV**

- **简介: 该论文研究图像生成任务，旨在解决扩散模型难以通过推理时搜索提升性能的问题。作者提出利用离散序列特性的视觉自回归模型，结合束搜索显著提升生成质量，小模型即可超越大扩散模型，表明架构对推理优化至关重要。**

- **链接: [http://arxiv.org/pdf/2510.16751v1](http://arxiv.org/pdf/2510.16751v1)**
...
>
---
#### [new 152] Demeter: A Parametric Model of Crop Plant Morphology from the Real World
- **分类: cs.CV**

- **简介: 该论文提出Demeter，一种面向作物植物形态的参数化3D模型，旨在解决现有模型难以表达植物拓扑多样性与形态变化的问题。通过构建真实大豆植株数据集，实现对植物结构、运动、形变的建模与仿真。**

- **链接: [http://arxiv.org/pdf/2510.16377v1](http://arxiv.org/pdf/2510.16377v1)**
...
>
---
#### [new 153] Embody 3D: A Large-scale Multimodal Motion and Behavior Dataset
- **分类: cs.CV**

- **简介: 该论文构建了一个大规模多模态3D运动与行为数据集Embody 3D，包含439人共500小时的3D动作、手势、交互及对话数据。旨在支持虚拟化身、人机交互等研究，提供了带文本标注和音频的精细动作追踪数据。**

- **链接: [http://arxiv.org/pdf/2510.16258v1](http://arxiv.org/pdf/2510.16258v1)**
...
>
---
#### [new 154] GOOD: Training-Free Guided Diffusion Sampling for Out-of-Distribution Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对OOD检测中生成样本语义不稳定、多样性不足的问题，提出无需训练的GOOD框架，通过图像级和特征级双层引导扩散模型，生成更可控、多样的OOD样本，并提升检测性能。**

- **链接: [http://arxiv.org/pdf/2510.17131v1](http://arxiv.org/pdf/2510.17131v1)**
...
>
---
#### [new 155] Conditional Synthetic Live and Spoof Fingerprint Generation
- **分类: cs.CV**

- **简介: 该论文属生物特征合成任务，旨在解决指纹数据采集的隐私与成本问题。作者提出基于StyleGAN和CycleGAN的条件生成方法，合成高分辨率活体与多材质假指纹图像，构建了两个大规模合成数据库，并验证了生成质量、识别性能及隐私保护性。**

- **链接: [http://arxiv.org/pdf/2510.17035v1](http://arxiv.org/pdf/2510.17035v1)**
...
>
---
#### [new 156] MultiVerse: A Multi-Turn Conversation Benchmark for Evaluating Large Vision and Language Models
- **分类: cs.CV**

- **简介: 该论文针对现有单轮或多轮视觉-语言对话评测不足，提出MultiVerse多轮对话基准，涵盖484任务、647对话，结合GPT-4o自动评估37个维度，评估18个大模型，揭示当前模型在复杂多轮交互中表现有限，强调上下文学习的重要性。**

- **链接: [http://arxiv.org/pdf/2510.16641v1](http://arxiv.org/pdf/2510.16641v1)**
...
>
> **备注:** Project website: https://passing2961.github.io/multiverse-project-page/
>
...
>
---
#### [new 157] ArmFormer: Lightweight Transformer Architecture for Real-Time Multi-Class Weapon Segmentation and Classification
- **分类: cs.CV; cs.AI; 68T07; I.2.10; I.5.4; I.4.6**

- **简介: 该论文针对实时多类别武器检测中精度与效率难以兼顾的问题，提出一种轻量级Transformer模型ArmFormer，结合CBAM与MixVisionTransformer，在实现像素级武器分割的同时，兼顾高精度与低计算开销，适用于边缘设备部署。**

- **链接: [http://arxiv.org/pdf/2510.16854v1](http://arxiv.org/pdf/2510.16854v1)**
...
>
---
#### [new 158] Where, Not What: Compelling Video LLMs to Learn Geometric Causality for 3D-Grounding
- **分类: cs.CV**

- **简介: 该论文研究多模态3D指代任务，旨在解决视觉语言模型因依赖2D语义导致的3D定位偏差问题。提出W2R2框架，通过解耦“是什么”与“在哪里”的表征学习，强化几何因果关系，提升3D定位精度。**

- **链接: [http://arxiv.org/pdf/2510.17034v1](http://arxiv.org/pdf/2510.17034v1)**
...
>
---
#### [new 159] Watch Where You Move: Region-aware Dynamic Aggregation and Excitation for Gait Recognition
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究步态识别任务，旨在解决现有方法对动态运动区域建模不足的问题。提出GaitRDAE框架，通过自动搜索运动区域并自适应分配时序尺度与注意力，提升复杂条件下的识别精度。**

- **链接: [http://arxiv.org/pdf/2510.16541v1](http://arxiv.org/pdf/2510.16541v1)**
...
>
---
#### [new 160] Closed-Loop Transfer for Weakly-supervised Affordance Grounding
- **分类: cs.CV**

- **简介: 该论文研究弱监督功能推理定位，旨在通过外视角交互图像（图像级标注）指导内视角场景中的功能区域定位。提出LoopTrans框架，实现内外视角间闭环知识双向迁移，结合跨模态定位与去噪知识蒸馏，提升复杂场景（如人体遮挡）下的定位性能。**

- **链接: [http://arxiv.org/pdf/2510.17384v1](http://arxiv.org/pdf/2510.17384v1)**
...
>
---
#### [new 161] CharDiff: A Diffusion Model with Character-Level Guidance for License Plate Image Restoration
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对低质量车牌图像恢复任务，提出CharDiff模型。通过字符级先验与OCR引导，结合区域掩码注意力机制（CHARM），实现精准字符定位与去噪，在真实场景下降幅28%的字符错误率，显著提升恢复效果与识别精度。**

- **链接: [http://arxiv.org/pdf/2510.17330v1](http://arxiv.org/pdf/2510.17330v1)**
...
>
---
#### [new 162] VIPAMIN: Visual Prompt Initialization via Embedding Selection and Subspace Expansion
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究视觉提示调优任务，旨在解决现有方法在自监督模型上提示专业化不足和表示空间受限的问题。作者提出VIPAMIN，通过语义对齐的嵌入选择和子空间扩展来初始化视觉提示，提升小样本和复杂任务下的适应性能。**

- **链接: [http://arxiv.org/pdf/2510.16446v1](http://arxiv.org/pdf/2510.16446v1)**
...
>
---
#### [new 163] Personalized Image Filter: Mastering Your Photographic Style
- **分类: cs.CV**

- **简介: 该论文研究图像风格迁移任务，旨在解决现有方法难以学习摄影概念且破坏内容的问题。作者提出个性化图像滤波器（PIF），结合文本到图像扩散模型与文本反转技术，有效提取并迁移参考图像的摄影风格。**

- **链接: [http://arxiv.org/pdf/2510.16791v1](http://arxiv.org/pdf/2510.16791v1)**
...
>
---
#### [new 164] FineVision: Open Data Is All You Need
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦视觉语言模型的数据构建任务，旨在解决公开数据集碎片化与污染问题。作者提出FineVision，一个经自动化与人工协同清洗、去重、去污染的2400万样本开源数据集，并统一多源标注与动作空间，显著提升模型性能，推动数据驱动VLM研究。**

- **链接: [http://arxiv.org/pdf/2510.17269v1](http://arxiv.org/pdf/2510.17269v1)**
...
>
---
#### [new 165] TokenAR: Multiple Subject Generation via Autoregressive Token-level enhancement
- **分类: cs.CV**

- **简介: 该论文研究多主体图像生成任务，解决自回归模型中参考身份混淆问题。提出TokenAR框架，通过令牌索引嵌入、指令令牌注入和身份-令牌解耦策略，提升身份一致性和背景重建质量，并发布大规模多参考数据集InstructAR。**

- **链接: [http://arxiv.org/pdf/2510.16332v1](http://arxiv.org/pdf/2510.16332v1)**
...
>
---
#### [new 166] An empirical study of the effect of video encoders on Temporal Video Grounding
- **分类: cs.CV**

- **简介: 该论文研究视频编码器对时序视频定位任务的影响，旨在解决因长期使用固定视频表征导致的模型过拟合问题。作者在多个基准上采用不同类型的视频编码器提取特征，通过实验分析其对性能的影响，并发现特征间的互补性。**

- **链接: [http://arxiv.org/pdf/2510.17007v1](http://arxiv.org/pdf/2510.17007v1)**
...
>
---
#### [new 167] Optimizing DINOv2 with Registers for Face Anti-Spoofing
- **分类: cs.CV**

- **简介: 该论文针对人脸识别中的活体检测问题，提出基于DINOv2加寄存器的方法，用于区分真实人脸与照片攻击。通过增强特征泛化性并抑制注意力扰动，提升对细微差异的捕捉能力，有效检测面部欺骗攻击。**

- **链接: [http://arxiv.org/pdf/2510.17201v1](http://arxiv.org/pdf/2510.17201v1)**
...
>
---
#### [new 168] HYDRA: HYbrid knowledge Distillation and spectral Reconstruction Algorithm for high channel hyperspectral camera applications
- **分类: cs.CV**

- **简介: 该论文研究高通道数下的光谱重建任务，旨在从自然图像恢复高光谱图像。针对现有方法在高通道下泛化能力不足的问题，提出HYDRA框架，结合知识蒸馏与多尺度注意力，提升重建精度与推理速度，实现SOTA性能。**

- **链接: [http://arxiv.org/pdf/2510.16664v1](http://arxiv.org/pdf/2510.16664v1)**
...
>
---
#### [new 169] Uniworld-V2: Reinforce Image Editing with Diffusion Negative-aware Finetuning and MLLM Implicit Feedback
- **分类: cs.CV**

- **简介: 该论文聚焦指令式图像编辑任务，旨在解决模型过拟合与缺乏通用奖励信号的问题。作者提出UniWorld-V2，通过扩散负感知微调和无需训练的MLLM隐式反馈，实现高效策略优化，提升泛化能力，在多个基准上达到SOTA。**

- **链接: [http://arxiv.org/pdf/2510.16888v1](http://arxiv.org/pdf/2510.16888v1)**
...
>
---
#### [new 170] StretchySnake: Flexible SSM Training Unlocks Action Recognition Across Spatio-Temporal Scales
- **分类: cs.CV**

- **简介: 该论文聚焦视频动作识别任务，旨在解决现有模型在不同时空分辨率下性能下降的问题。作者提出StretchySnake，通过灵活采样和动态插值训练SSM，实现跨时空尺度的自适应，显著提升模型在长短视频上的识别精度与鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.16209v1](http://arxiv.org/pdf/2510.16209v1)**
...
>
---
#### [new 171] SHIELD: Suppressing Hallucinations In LVLM Encoders via Bias and Vulnerability Defense
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对视觉-语言模型中的物体幻觉问题，首次指出视觉编码器存在统计偏差、固有偏差和脆弱性三类问题，提出无需训练的框架SHIELD，通过重加权、噪声注入和对抗解码抑制幻觉，有效提升多模型泛化性能。**

- **链接: [http://arxiv.org/pdf/2510.16596v1](http://arxiv.org/pdf/2510.16596v1)**
...
>
---
#### [new 172] Xiaoice: Training-Free Video Understanding via Self-Supervised Spatio-Temporal Clustering of Semantic Features
...
>
---
#### [new 173] Person Re-Identification via Generalized Class Prototypes
- **分类: cs.CV; eess.IV**

- **简介: 该论文属于行人重识别任务，旨在解决类代表选择不佳的问题。作者提出一种广义类原型方法，超越传统使用类中心的方法，通过灵活选择每类的代表性特征，在多个模型上提升性能。**

- **链接: [http://arxiv.org/pdf/2510.17043v1](http://arxiv.org/pdf/2510.17043v1)**
...
>
---
#### [new 174] Designing a Convolutional Neural Network for High-Accuracy Oral Cavity Squamous Cell Carcinoma (OCSCC) Detection
- **分类: cs.CV**

- **简介: 该论文致力于OCSCC早期检测，利用CNN进行图像识别，并设计硬件采集高质图像。通过不同分辨率图像测试模型精度，发现分辨率与准确率呈对数关系，开发应用实现开放访问。**

- **链接: [http://arxiv.org/pdf/2510.16235v1](http://arxiv.org/pdf/2510.16235v1)**
...
>
---
#### [new 175] Towards 3D Objectness Learning in an Open World
- **分类: cs.CV**

- **简介: 该论文研究开放世界下的3D物体性学习，旨在检测3D场景中所有物体（含训练时未见的新类别）。提出OP3Det方法，无需文本提示，结合2D先验与3D几何信息，通过跨模态专家混合机制实现类无关检测，在开放和封闭世界均显著提升性能。**

- **链接: [http://arxiv.org/pdf/2510.17686v1](http://arxiv.org/pdf/2510.17686v1)**
...
>
---
#### [new 176] On the Provable Importance of Gradients for Language-Assisted Image Clustering
- **分类: cs.CV**

- **简介: 该论文研究语言辅助图像聚类（LaIC），旨在利用文本语义提升无监督图像聚类效果。核心问题是从未标注文本中筛选与图像语义相关的正向名词。作者提出基于梯度的过滤框架GradNorm，理论证明其有效性并验证其优越性能。**

- **链接: [http://arxiv.org/pdf/2510.16335v1](http://arxiv.org/pdf/2510.16335v1)**
...
>
---
#### [new 177] iWatchRoadv2: Pothole Detection, Geospatial Mapping, and Intelligent Road Governance
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出iWatchRoadv2，属智能交通与城市治理任务，旨在解决印度道路坑洼检测与维护难题。作者构建真实数据集，改进YOLO模型实现精准检测，结合GPS与OCR实现坑洼定位与可视化，并通过系统自动告警与承包商联动，推动道路养护的自动化与透明化管理。**

- **链接: [http://arxiv.org/pdf/2510.16375v1](http://arxiv.org/pdf/2510.16375v1)**
...
>
---
#### [new 178] Enrich and Detect: Video Temporal Grounding with Multimodal LLMs
- **分类: cs.CV; cs.MM**

- **简介: 该论文研究视频时序定位任务，旨在精确定位视频中与自然语言描述对应的时间片段。提出ED-VTG方法，利用多模态大模型先增强查询语句，再通过轻量解码器预测时间边界，并采用多实例学习抑制噪声，显著提升零样本和全监督下的定位性能。**

- **链接: [http://arxiv.org/pdf/2510.17023v1](http://arxiv.org/pdf/2510.17023v1)**
...
>
---
#### [new 179] PAGE-4D: Disentangled Pose and Geometry Estimation for 4D Perception
- **分类: cs.CV**

- **简介: 该论文聚焦4D动态场景感知任务，旨在解决现有3D模型在动态环境中性能下降的问题。作者提出PAGE-4D模型，通过动态感知聚合器解耦静态与动态信息，实现无需后处理的相机位姿估计、深度预测和点云重建。**

- **链接: [http://arxiv.org/pdf/2510.17568v1](http://arxiv.org/pdf/2510.17568v1)**
...
>
---
#### [new 180] DeepDetect: Learning All-in-One Dense Keypoints
- **分类: cs.CV**

- **简介: 该论文属于计算机视觉中的关键点检测任务，旨在解决传统与现有学习方法在密度、重复性及语义理解上的不足。作者提出DeepDetect，融合多种检测器生成真值掩码，训练轻量模型以实现高密度、强鲁棒的关键点检测。**

- **链接: [http://arxiv.org/pdf/2510.17422v1](http://arxiv.org/pdf/2510.17422v1)**
...
>
---
#### [new 181] Automated C-Arm Positioning via Conformal Landmark Localization
- **分类: cs.CV**

- **简介: 该论文研究自动C臂定位，解决手动操作导致辐射暴露和延迟问题。提出基于X射线图像的自主导航方法，通过共形预测校准不确定性，结合概率损失与骨骼姿态正则化，实现解剖标志点的准确3D定位。**

- **链接: [http://arxiv.org/pdf/2510.16160v1](http://arxiv.org/pdf/2510.16160v1)**
...
>
---
#### [new 182] Conveying Meaning through Gestures: An Investigation into Semantic Co-Speech Gesture Generation
- **分类: cs.HC; cs.CV**

- **简介: 该论文研究面向语义的伴随语音手势生成任务，旨在探讨语义信息对手势生成中意义传达的影响。作者对比了两种模型AQ-GT与AQ-GT-a，在概念传达和拟人性方面进行用户评估，发现语义增强提升泛化能力但未提高拟人度。**

- **链接: [http://arxiv.org/pdf/2510.17599v1](http://arxiv.org/pdf/2510.17599v1)**
...
>
---
#### [new 183] Taming Modality Entanglement in Continual Audio-Visual Segmentation
- **分类: cs.MM; cs.AI; cs.CV**

- **简介: 该论文提出持续音频-视觉分割任务，解决多模态语义漂移与共现混淆问题。设计基于碰撞的多模态回放框架，通过模态一致样本选择和混淆类增强回放，提升细粒度持续学习性能。**

- **链接: [http://arxiv.org/pdf/2510.17234v1](http://arxiv.org/pdf/2510.17234v1)**
...
>
---
#### [new 184] Botany-Bot: Digital Twin Monitoring of Occluded and Underleaf Plant Structures with Gaussian Splats
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 185] Beyond Fixed Anchors: Precisely Erasing Concepts with Sibling Exclusive Counterparts
- **分类: cs.AI; cs.CV**

- **简介: 该论文针对文本到图像扩散模型中的概念擦除任务，解决固定锚点导致的概念复现与侵蚀问题。提出SELECT框架，通过因果追踪识别兄弟互斥概念作为动态锚点，实现精准擦除与概念保留。**

- **链接: [http://arxiv.org/pdf/2510.16342v1](http://arxiv.org/pdf/2510.16342v1)**
...
>
---
#### [new 186] From Spatial to Actions: Grounding Vision-Language-Action Model in Spatial Foundation Priors
...
>
---
#### [new 187] ISO/IEC-Compliant Match-on-Card Face Verification with Short Binary Templates
- **分类: cs.CR; cs.AI; cs.CV; 68T10, 68T45, 94A60; I.4.8; I.5.4; I.2.10**

- **简介: 该论文研究符合ISO/IEC标准的卡上人脸验证，解决模板安全与传输效率问题。提出短二值模板（64/128位）和固定长度通信协议，实现快速、防信息泄露的卡内匹配，兼顾安全性、速度与隐私。**

- **链接: [http://arxiv.org/pdf/2510.16078v1](http://arxiv.org/pdf/2510.16078v1)**
...
>
---
#### [new 188] Needles in the Landscape: Semi-Supervised Pseudolabeling for Archaeological Site Discovery under Label Scarcity
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属考古遗址发现任务，解决标注稀缺下的正样本稀疏问题。提出半监督正-无标记学习方法，结合动态伪标签与CRF优化，提升语义分割模型在不平衡数据下的性能，实现大范围未标注景观中遗址的高效识别。**

- **链接: [http://arxiv.org/pdf/2510.16814v1](http://arxiv.org/pdf/2510.16814v1)**
...
>
---
#### [new 189] Filtering of Small Components for Isosurface Generation
- **分类: cs.GR; cs.CV; I.3**

- **简介: 该论文针对医学扫描数据生成等值面时存在大量干扰性小区域的问题，提出通过简单预滤波去除这些小成分的方法，以提升可视化质量，实验验证了其有效性。属于等值面生成中的噪声过滤任务。**

- **链接: [http://arxiv.org/pdf/2510.16684v1](http://arxiv.org/pdf/2510.16684v1)**
...
>
---
#### [new 190] Detecting streaks in smart telescopes images with Deep Learning
- **分类: astro-ph.IM; cs.CV**

- **简介: 该论文针对卫星在天文图像中产生的条纹干扰问题，研究并改进深度学习方法，用于检测智能望远镜拍摄的原始数据中的条纹。属于图像处理任务，旨在提升天文观测数据质量。**

- **链接: [http://arxiv.org/pdf/2510.17540v1](http://arxiv.org/pdf/2510.17540v1)**
...
>
---
#### [new 191] Unlocking Off-the-Grid Sparse Recovery with Unlimited Sensing: Simultaneous Super-Resolution in Time and Amplitude
- **分类: cs.IT; cs.CV; eess.SP; math.IT**

- **简介: 该论文研究离格稀疏信号恢复，解决传统数字采样中强弱信号幅度差异导致的信息丢失问题。基于无界传感框架，提出模编码方法，在低比特量化下实现时间和幅度的联合超分辨率，提升测量精度，并在飞行时间成像中验证了有效性。**

- **链接: [http://arxiv.org/pdf/2510.16948v1](http://arxiv.org/pdf/2510.16948v1)**
...
>
---
#### [new 192] Time-Embedded Algorithm Unrolling for Computational MRI
- **分类: eess.IV; cs.AI; cs.CV; cs.LG; physics.med-ph**

- **简介: 该论文研究计算磁共振成像（MRI）中的图像重建任务，旨在解决传统算法展开方法因共享网络导致的伪影或模糊问题。作者提出时间嵌入的算法展开框架，引入迭代依赖的可学习神经网络与参数，有效抑制伪影与噪声，提升重建质量。**

- **链接: [http://arxiv.org/pdf/2510.16321v1](http://arxiv.org/pdf/2510.16321v1)**
...
>
---
#### [new 193] Latent Spaces Beyond Synthesis: From GANs to Diffusion Models
- **分类: cs.LG; cs.CV; cs.CY**

- **简介: 该论文探讨生成模型内部表征的演变，区分“严格”与“宽泛”意义上的合成，通过分析GANs、VAEs到扩散模型的架构变化，揭示扩散模型如何分散表征负担，挑战统一潜在空间假设，主张将生成AI理解为特化过程的涌现配置。**

- **链接: [http://arxiv.org/pdf/2510.17383v1](http://arxiv.org/pdf/2510.17383v1)**
...
>
---
#### [new 194] MILES: Modality-Informed Learning Rate Scheduler for Balancing Multimodal Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究多模态学习中的模态过拟合问题，提出一种基于模态使用率动态调整学习率的调度方法MILES，以平衡各模态的学习速度。在四种任务上验证了其提升多模态及单模态性能的有效性。**

- **链接: [http://arxiv.org/pdf/2510.17394v1](http://arxiv.org/pdf/2510.17394v1)**
...
>
---
#### [new 195] Domain Generalizable Continual Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究领域通用的持续学习（DGCL），旨在解决模型在连续学习不同域任务时的泛化与遗忘问题。提出自适应域变换（DoT）方法，解耦语义与域信息，提升跨域持续学习性能，兼容多种训练范式，兼具高效性与轻量化。**

- **链接: [http://arxiv.org/pdf/2510.16914v1](http://arxiv.org/pdf/2510.16914v1)**
...
>
---
#### [new 196] NEBULA: Do We Evaluate Vision-Language-Action Agents Correctly?
...
- **链接: [http://arxiv.org/pdf/2510.16263v1](http://arxiv.org/pdf/2510.16263v1)**
...
>
---
#### [new 197] Patronus: Safeguarding Text-to-Image Models against White-Box Adversaries
- **分类: cs.CR; cs.CV**

- **简介: 该论文针对文本到图像模型在白盒攻击下的安全问题，提出名为Patronus的防御框架。通过内部监控器和抗微调机制，防止恶意输入生成有害内容，同时保持对正常内容的生成性能。**

- **链接: [http://arxiv.org/pdf/2510.16581v1](http://arxiv.org/pdf/2510.16581v1)**
...
>
---
#### [new 198] From Preferences to Prejudice: The Role of Alignment Tuning in Shaping Social Bias in Video Diffusion Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 199] Lung Cancer Classification from CT Images Using ResNet
- **分类: eess.IV; cs.AI; cs.CV; cs.LG; I.4.0; I.4.9**

- **简介: 该论文属医学图像分类任务，旨在解决肺癌CT图像多分类问题。作者基于ResNet50模型，添加自定义层并优化超参数，在LC25000数据集上实现三类分类，准确率达98.8%，显著提升性能。**

- **链接: [http://arxiv.org/pdf/2510.16310v1](http://arxiv.org/pdf/2510.16310v1)**
...
>
---
#### [new 200] ZACH-ViT: A Zero-Token Vision Transformer with ShuffleStrides Data Augmentation for Robust Lung Ultrasound Classification
- **分类: cs.LG; cs.CV**

- **简介: 该论文针对肺部超声视频中区分心源性肺水肿与非心源性病变的分类任务，解决因图像异质性导致的自动化分类难题。作者提出ZACH-ViT模型（无位置编码和[CLS] token）和ShuffleStrides数据增强，提升小样本下模型鲁棒性与泛化能力。**

- **链接: [http://arxiv.org/pdf/2510.17650v1](http://arxiv.org/pdf/2510.17650v1)**
...
>
> **备注:** 14 pages, 6 figures, 2 tables. Primary subject: cs.LG (Machine Learning) Cross-listed to: cs.CV (Computer Vision and Pattern Recognition), eess.IV (Image and Video Processing). Code available at: https://github.com/Bluesman79/ZACH-ViT Installation: pip install zachvit Paper licensed under CC BY-NC-ND 4.0. Code released under Apache 2.0 License
>
...
>
---
#### [new 201] ImaGGen: Zero-Shot Generation of Co-Speech Semantic Gestures Grounded in Language and Image Input
- **分类: cs.HC; cs.CV**

- **简介: 该论文研究共语手势生成任务，旨在解决现有方法仅生成节奏性手势而缺乏语义表达的问题。提出ImaGGen系统，结合语言与图像输入，通过视觉分析和语义匹配生成具语义的象征性/指示性手势，并验证其在提升沟通理解上的有效性。**

- **链接: [http://arxiv.org/pdf/2510.17617v1](http://arxiv.org/pdf/2510.17617v1)**
...
>
---
#### [new 202] DINO-CVA: A Multimodal Goal-Conditioned Vision-to-Action Model for Autonomous Catheter Navigation
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 203] End-to-end Listen, Look, Speak and Act
...
>
---
#### [new 204] Seeing but Not Believing: Probing the Disconnect Between Visual Attention and Answer Correctness in VLMs
- **分类: cs.AI; cs.CV**

- **简介: 该论文研究视觉语言模型（VLM）在视觉问答中“看到但不信”的现象，即模型注意到证据却未能正确作答。通过分析注意力机制，发现深层网络能定位证据，但未有效利用。据此提出无需训练的干预方法，显式强化证据区域，提升多类VLM的准确性。**

- **链接: [http://arxiv.org/pdf/2510.17771v1](http://arxiv.org/pdf/2510.17771v1)**
...
>
---
#### [new 205] VERA-V: Variational Inference Framework for Jailbreaking Vision-Language Models
...
>
---
#### [new 206] FedPURIN: Programmed Update and Reduced INformation for Sparse Personalized Federated Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究个性化联邦学习中的通信效率问题，提出FedPURIN框架，通过整数规划选择关键参数并结合稀疏聚合，减少通信开销，同时保持模型性能，适用于异构数据下的边缘智能系统。**

- **链接: [http://arxiv.org/pdf/2510.16065v1](http://arxiv.org/pdf/2510.16065v1)**
...
>
---
#### [new 207] DiffVLA++: Bridging Cognitive Reasoning and End-to-End Driving through Metric-Guided Alignment
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 208] Fly-CL: A Fly-Inspired Framework for Enhancing Efficient Decorrelation and Reduced Training Time in Pre-trained Model-based Continual Representation Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究持续表征学习任务，旨在缓解预训练模型中的多共线性问题以减少灾难性遗忘。受果蝇嗅觉回路启发，提出Fly-CL框架，显著降低训练时间并保持高性能，理论与实验验证了其有效性和高效性。**

- **链接: [http://arxiv.org/pdf/2510.16877v1](http://arxiv.org/pdf/2510.16877v1)**
...
>
---
#### [new 209] Matricial Free Energy as a Gaussianizing Regularizer: Enhancing Autoencoders for Gaussian Code Generation
- **分类: cs.LG; cs.CV; stat.ML**

- **简介: 该论文提出基于矩阵自由能的正则化方法，旨在使自编码器生成高斯分布的隐变量。通过奇异值优化，使代码矩阵接近i.i.d.高斯随机矩阵特性，提升生成代码的泛化性，并应用于欠定逆问题。**

- **链接: [http://arxiv.org/pdf/2510.17120v1](http://arxiv.org/pdf/2510.17120v1)**
...
>
---
#### [new 210] MIRAGE: Agentic Framework for Multimodal Misinformation Detection with Web-Grounded Reasoning
...
>
---
#### [new 211] Shape-aware Inertial Poser: Motion Tracking for Humans with Diverse Shapes Using Sparse Inertial Sensors
- **分类: cs.GR; cs.CV**

- **简介: 该论文研究稀疏惯性传感器的人体运动捕捉，解决不同体型（如儿童）导致的IMU加速度变化带来的泛化难题。提出Shape-aware Inertial Poser（SAIP），首次考虑体型差异，通过回归模型补偿体型影响，并设计体型估计方法，实现跨体型精准动作捕捉。**

- **链接: [http://arxiv.org/pdf/2510.17101v1](http://arxiv.org/pdf/2510.17101v1)**
...
#### [replaced 001] Grounded Reinforcement Learning for Visual Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23678v2](http://arxiv.org/pdf/2505.23678v2)**
...
>
---
#### [replaced 002] Improvement of Spiking Neural Network with Bit Planes and Color Models
- **分类: cs.CV; cs.NE; eess.IV**

- **链接: [http://arxiv.org/pdf/2410.08229v4](http://arxiv.org/pdf/2410.08229v4)**

> **作者:** Nhan T. Luu; Duong T. Luu; Nam N. Pham; Thang C. Truong
>
> **备注:** 2024 IEEE 16th International Conference on Computational Intelligence and Communication Networks (CICN)
>
...
>
---
#### [replaced 003] Hierarchical Material Recognition from Local Appearance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.22911v3](http://arxiv.org/pdf/2505.22911v3)**
...
>
---
#### [replaced 004] FetalCLIP: A Visual-Language Foundation Model for Fetal Ultrasound Image Analysis
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.14807v3](http://arxiv.org/pdf/2502.14807v3)**
...
>
---
#### [replaced 009] Infinity Parser: Layout Aware Reinforcement Learning for Scanned Document Parsing
...
>
---
#### [replaced 010] AI-Generated Video Detection via Perceptual Straightening
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.00583v2](http://arxiv.org/pdf/2507.00583v2)**
...
>
---
#### [replaced 011] MotionGPT3: Human Motion as a Second Modality
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 015] STANCE: Motion Coherent Video Generation Via Sparse-to-Dense Anchored Encoding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.14588v2](http://arxiv.org/pdf/2510.14588v2)**
...
>
---
#### [replaced 016] WaveFormer: A Lightweight Transformer Model for sEMG-based Gesture Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.11168v3](http://arxiv.org/pdf/2506.11168v3)**

> **作者:** Yanlong Chen; Mattia Orlandi; Pierangelo Maria Rapa; Simone Benatti; Luca Benini; Yawei Li
>
> **备注:** 6 pages, 3 figures, accepted to IEEE EMBS Conference on Neural Engineering (NER) 2025. Code and data are available at https://github.com/ForeverBlue816/WaveFormer
>
...
>
---
#### [replaced 017] Auto-Connect: Connectivity-Preserving RigFormer with Direct Preference Optimization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.11430v3](http://arxiv.org/pdf/2506.11430v3)**
...
>
---
#### [replaced 022] Video-SafetyBench: A Benchmark for Safety Evaluation of Video LVLMs
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 023] Mysteries of the Deep: Role of Intermediate Representations in Out of Distribution Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.05782v2](http://arxiv.org/pdf/2510.05782v2)**
...
>
---
#### [replaced 024] ActAlign: Zero-Shot Fine-Grained Video Classification via Language-Guided Sequence Alignment
- **分类: cs.CV; cs.LG; cs.MM; I.2.10; I.2.7**

- **链接: [http://arxiv.org/pdf/2506.22967v3](http://arxiv.org/pdf/2506.22967v3)**
...
>
---
#### [replaced 025] AutoLungDx: A Hybrid Deep Learning Approach for Early Lung Cancer Diagnosis Using 3D Res-U-Net, YOLOv5, and Vision Transformers
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2305.00046v4](http://arxiv.org/pdf/2305.00046v4)**
...
>
---
#### [replaced 026] MSDM: Generating Task-Specific Pathology Images with a Multimodal Conditioned Diffusion Model for Cell and Nuclei Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.09121v2](http://arxiv.org/pdf/2510.09121v2)**
...
- **链接: [http://arxiv.org/pdf/2510.03550v2](http://arxiv.org/pdf/2510.03550v2)**
...
>
---
#### [replaced 031] Geometry and Perception Guided Gaussians for Multiview-consistent 3D Generation from a Single Image
- **分类: cs.CV; 68; I.4.0**

- **链接: [http://arxiv.org/pdf/2506.21152v3](http://arxiv.org/pdf/2506.21152v3)**
...
>
---
#### [replaced 032] SegDAC: Improving Visual Reinforcement Learning by Extracting Dynamic Objectc-Centric Representations from Pretrained Vision Models
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**

- **链接: [http://arxiv.org/pdf/2508.09325v2](http://arxiv.org/pdf/2508.09325v2)**
...
>
---
#### [replaced 033] Jasmine: Harnessing Diffusion Prior for Self-supervised Depth Estimation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.15905v3](http://arxiv.org/pdf/2503.15905v3)**
...
>
---
#### [replaced 034] Fine-Grained Classification: Connecting Metadata via Cross-Contrastive Pre-Training
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.20322v2](http://arxiv.org/pdf/2504.20322v2)**

> **作者:** Sumit Mamtani; Yash Thesia
>
> **备注:** 5 pages, 4 figures. Accepted at IEEE ISCMI 2025
>
> **摘要:** Fine-grained visual classification aims to recognize objects belonging to many subordinate categories of a supercategory, where appearance alone often fails to distinguish highly similar classes. We propose a unified framework that integrates image, text, and metadata via cross-contrastive pre-training. We first align the three modality encoders in a shared embedding space and then fine-tune the image and metadata encoders for classification. On NABirds, our approach improves over the baseline by 7.83% and achieves 84.44% top-1 accuracy, outperforming strong multimodal methods.
>
---
#### [replaced 035] Interpretable Decision-Making for End-to-End Autonomous Driving
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**

- **链接: [http://arxiv.org/pdf/2508.18898v2](http://arxiv.org/pdf/2508.18898v2)**
...
>
---
#### [replaced 036] Nexus: An Omni-Perceptive And -Interactive Model for Language, Audio, And Vision
...
>
---
#### [replaced 037] Enhancing Test Time Adaptation with Few-shot Guidance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2409.01341v3](http://arxiv.org/pdf/2409.01341v3)**
...
>
---
#### [replaced 038] Free$^2$Guide: Training-Free Text-to-Video Alignment using Image LVLM
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.17041v2](http://arxiv.org/pdf/2411.17041v2)**

> **作者:** Jaemin Kim; Bryan Sangwoo Kim; Jong Chul Ye
>
...
>
---
#### [replaced 042] Eye-for-an-eye: Appearance Transfer with Semantic Correspondence in Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2406.07008v2](http://arxiv.org/pdf/2406.07008v2)**

> **作者:** Sooyeon Go; Kyungmook Choi; Minjung Shin; Youngjung Uh
>
> **备注:** project page : https://sooyeon-go.github.io/eye_for_an_eye/
>
...
>
---
#### [replaced 043] SpectraLift: Physics-Guided Spectral-Inversion Network for Self-Supervised Hyperspectral Image Super-Resolution
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.13339v2](http://arxiv.org/pdf/2507.13339v2)**
...
>
---
#### [replaced 044] VimoRAG: Video-based Retrieval-augmented 3D Motion Generation for Motion Language Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 047] DitHub: A Modular Framework for Incremental Open-Vocabulary Object Detection
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.09271v3](http://arxiv.org/pdf/2503.09271v3)**
...
>
---
#### [replaced 053] Privacy-Preserving Visual Localization with Event Cameras
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2212.03177v3](http://arxiv.org/pdf/2212.03177v3)**

> **作者:** Junho Kim; Young Min Kim; Ramzi Zahreddine; Weston A. Welge; Gurunandan Krishnan; Sizhuo Ma; Jian Wang
>
> **备注:** Published in IEEE Transactions on Image Processing (TIP)
>
...
>
---
#### [replaced 054] Aesthetics is Cheap, Show me the Text: An Empirical Evaluation of State-of-the-Art Generative Models for OCR
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15085v3](http://arxiv.org/pdf/2507.15085v3)**
...
>
---
#### [replaced 055] Is Artificial Intelligence Generated Image Detection a Solved Problem?
- **分类: cs.CV; cs.CR**

- **链接: [http://arxiv.org/pdf/2505.12335v2](http://arxiv.org/pdf/2505.12335v2)**
...
>
---
#### [replaced 056] Morpheus: Benchmarking Physical Reasoning of Video Generative Models with Real Physical Experiments
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.02918v2](http://arxiv.org/pdf/2504.02918v2)**
...
>
---
#### [replaced 057] Tag-Enriched Multi-Attention with Large Language Models for Cross-Domain Sequential Recommendation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.09224v2](http://arxiv.org/pdf/2510.09224v2)**
...
>
---
#### [replaced 058] G$^{2}$D: Boosting Multimodal Learning with Gradient-Guided Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.21514v3](http://arxiv.org/pdf/2506.21514v3)**
...
>
---
#### [replaced 059] SoPo: Text-to-Motion Generation Using Semi-Online Preference Optimization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.05095v3](http://arxiv.org/pdf/2412.05095v3)**
...
>
---
#### [replaced 064] Periodontal Bone Loss Analysis via Keypoint Detection With Heuristic Post-Processing
- **分类: q-bio.TO; cs.AI; cs.CV; I.2.1; I.2.10; J.3**

- **链接: [http://arxiv.org/pdf/2503.13477v3](http://arxiv.org/pdf/2503.13477v3)**
...
>
---
#### [replaced 065] Generate, but Verify: Reducing Hallucination in Vision-Language Models with Retrospective Resampling
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.13169v3](http://arxiv.org/pdf/2504.13169v3)**

> **作者:** Tsung-Han Wu; Heekyung Lee; Jiaxin Ge; Joseph E. Gonzalez; Trevor Darrell; David M. Chan
>
> **备注:** Accepted to NeurIPS 2025; Project Page: https://reverse-vlm.github.io
>
...
>
---
#### [replaced 068] Knowledge-based Visual Question Answer with Multimodal Processing, Retrieval and Filtering
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.14605v2](http://arxiv.org/pdf/2510.14605v2)**
...
>
---
#### [replaced 069] RoboRefer: Towards Spatial Referring with Reasoning in Vision-Language Models for Robotics
- **分类: cs.RO; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04308v2](http://arxiv.org/pdf/2506.04308v2)**
...
>
---
#### [replaced 070] Accurate and Efficient Low-Rank Model Merging in Core Space
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.17786v3](http://arxiv.org/pdf/2509.17786v3)**
...
>
---
#### [replaced 071] Dolphin v1.0 Technical Report
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.25748v3](http://arxiv.org/pdf/2509.25748v3)**
...
>
> **摘要:** Ultrasound is crucial in modern medicine but faces challenges like operator dependence, image noise, and real-time scanning, hindering AI integration. While large multimodal models excel in other medical imaging areas, they struggle with ultrasound's complexities. To address this, we introduce Dolphin v1.0 (V1) and its reasoning-augmented version, Dolphin R1-the first large-scale multimodal ultrasound foundation models unifying diverse clinical tasks in a single vision-language framework.To tackle ultrasound variability and noise, we curated a 2-million-scale multimodal dataset, combining textbook knowledge, public data, synthetic samples, and general corpora. This ensures robust perception, generalization, and clinical adaptability.The Dolphin series employs a three-stage training strategy: domain-specialized pretraining, instruction-driven alignment, and reinforcement-based refinement. Dolphin v1.0 delivers reliable performance in classification, detection, regression, and report generation. Dolphin R1 enhances diagnostic inference, reasoning transparency, and interpretability through reinforcement learning with ultrasound-specific rewards.Evaluated on U2-Bench across eight ultrasound tasks, Dolphin R1 achieves a U2-score of 0.5835-over twice the second-best model (0.2968) setting a new state of the art. Dolphin v1.0 also performs competitively, validating the unified framework. Comparisons show reasoning-enhanced training significantly improves diagnostic accuracy, consistency, and interpretability, highlighting its importance for high-stakes medical AI.
>
---
#### [replaced 072] Vision Mamba for Permeability Prediction of Porous Media
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14516v2](http://arxiv.org/pdf/2510.14516v2)**
...
>
---
#### [replaced 075] The Shape of Attraction in UMAP: Exploring the Embedding Forces in Dimensionality Reduction
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.09101v3](http://arxiv.org/pdf/2503.09101v3)**
...
>
---
#### [replaced 076] Learning Cocoercive Conservative Denoisers via Helmholtz Decomposition for Poisson Inverse Problems
- **分类: cs.CV; cs.LG; math.FA; math.OC; 94A08, 47H10, 47J26, 46N10, 47N10**

- **链接: [http://arxiv.org/pdf/2505.08909v2](http://arxiv.org/pdf/2505.08909v2)**

> **作者:** Deliang Wei; Peng Chen; Haobo Xu; Jiale Yao; Fang Li; Tieyong Zeng
>
> **备注:** 31 pages. This paper has been accepted by NeurIPs 2025
>
...
>
---
#### [replaced 077] Text-controlled Motion Mamba: Text-Instructed Temporal Grounding of Human Motion
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2404.11375v2](http://arxiv.org/pdf/2404.11375v2)**
...
>
---
#### [replaced 078] HOI-Dyn: Learning Interaction Dynamics for Human-Object Motion Diffusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.01737v3](http://arxiv.org/pdf/2507.01737v3)**
...
>
---
#### [replaced 079] The 1st Solution for 7th LSVOS RVOS Track: SaSaSa2VA
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.16972v2](http://arxiv.org/pdf/2509.16972v2)**
...
>
---
#### [replaced 080] GeoReasoner: Geo-localization with Reasoning in Street Views using a Large Vision-Language Model
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2406.18572v3](http://arxiv.org/pdf/2406.18572v3)**

> **作者:** Ling Li; Yu Ye; Yao Zhou; Wei Zeng
>
...
>
---
#### [replaced 083] ASCD: Attention-Steerable Contrastive Decoding for Reducing Hallucination in MLLM
...
>
---
#### [replaced 084] Learning Generalizable Shape Completion with SIM(3) Equivariance
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.26631v2](http://arxiv.org/pdf/2509.26631v2)**
...
>
---
#### [replaced 085] Learning to Detect Unknown Jailbreak Attacks in Large Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.15430v2](http://arxiv.org/pdf/2510.15430v2)**
...
>
---
#### [replaced 088] PartSDF: Part-Based Implicit Neural Representation for Composite 3D Shape Parametrization and Optimization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.12985v3](http://arxiv.org/pdf/2502.12985v3)**
...
>
---
#### [replaced 089] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.10809v4](http://arxiv.org/pdf/2504.10809v4)**
...
>
---
#### [replaced 095] CReFT-CAD: Boosting Orthographic Projection Reasoning for CAD via Reinforcement Fine-Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.00568v2](http://arxiv.org/pdf/2506.00568v2)**
...
>
---
#### [replaced 096] Seeing in the Dark: A Teacher-Student Framework for Dark Video Action Recognition via Knowledge Distillation and Contrastive Learning
- **分类: cs.CV; cs.AI; cs.HC; cs.LG; cs.MM; Artificial intelligence, Computer vision, Machine learning, Deep
  learning, Human-computer Interaction; I.2; I.2.9; I.2.10; I.3.3; I.4.5**

- **链接: [http://arxiv.org/pdf/2502.03724v2](http://arxiv.org/pdf/2502.03724v2)**
...
>
---
#### [replaced 097] VisualLens: Personalization through Task-Agnostic Visual History
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.16034v2](http://arxiv.org/pdf/2411.16034v2)**
...
>
---
#### [replaced 099] Beyond Uncertainty Quantification: Learning Uncertainty for Trust-Informed Neural Network Decisions - A Case Study in COVID-19 Classification
- **分类: eess.IV; cs.AI; cs.CV; 68T07**

- **链接: [http://arxiv.org/pdf/2410.02805v2](http://arxiv.org/pdf/2410.02805v2)**
...
>
---
#### [replaced 102] ELIP: Enhanced Visual-Language Foundation Models for Image Retrieval
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.15682v3](http://arxiv.org/pdf/2502.15682v3)**
...
>
---
#### [replaced 105] Towards Better & Faster Autoregressive Image Generation: From the Perspective of Entropy
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.09012v2](http://arxiv.org/pdf/2510.09012v2)**
...
>
---
#### [replaced 106] Indoor Heat Estimation from a Single Visible-Light Panorama
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.06973v2](http://arxiv.org/pdf/2502.06973v2)**

> **作者:** Guanzhou Ji; Sriram Narayanan; Azadeh Sawyer; Srinivasa Narasimhan
>
> **备注:** ISVC'25, Selected for Oral Presentation
>
...
>
---
#### [replaced 107] Robust Pan-Cancer Mitotic Figure Detection with YOLOv12
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.02593v4](http://arxiv.org/pdf/2509.02593v4)**

> **作者:** Raphaël Bourgade; Guillaume Balezo; Hana Feki; Lily Monier; Matthieu Blons; Alice Blondel; Delphine Loussouarn; Anne Vincent-Salomon; Thomas Walter
>
...
>
---
#### [replaced 108] MIRROR: Multi-Modal Pathological Self-Supervised Representation Learning via Modality Alignment and Retention
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2503.00374v4](http://arxiv.org/pdf/2503.00374v4)**
...
>
---
#### [replaced 109] Grounding Language with Vision: A Conditional Mutual Information Calibrated Decoding Strategy for Reducing Hallucinations in LVLMs
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 110] DARIL: When Imitation Learning outperforms Reinforcement Learning in Surgical Action Planning
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.05011v3](http://arxiv.org/pdf/2507.05011v3)**
...
>
---
#### [replaced 111] Agentic Design of Compositional Machines
...
>
---
#### [replaced 112] From Cradle to Cane: A Two-Pass Framework for High-Fidelity Lifespan Face Aging
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.20977v2](http://arxiv.org/pdf/2506.20977v2)**

> **作者:** Tao Liu; Dafeng Zhang; Gengchen Li; Shizhuo Liu; Yongqi Song; Senmao Li; Shiqi Yang; Boqian Li; Kai Wang; Yaxing Wang
>
> **备注:** 32 pages, 12 figures, NeurIPS 2025 Poster
>
...
>
---
#### [replaced 115] ZeST: an LLM-based Zero-Shot Traversability Navigation for Unknown Environments
- **分类: cs.RO; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.19131v2](http://arxiv.org/pdf/2508.19131v2)**
...
>
---
#### [replaced 122] VisuRiddles: Fine-grained Perception is a Primary Bottleneck for Multimodal Large Language Models in Abstract Visual Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.02537v2](http://arxiv.org/pdf/2506.02537v2)**
...
>
---
#### [replaced 123] Latent Diffusion Model without Variational Autoencoder
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.15301v2](http://arxiv.org/pdf/2510.15301v2)**
...
>
---
#### [replaced 124] ImpMIA: Leveraging Implicit Bias for Membership Inference Attack under Realistic Scenarios
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.10625v2](http://arxiv.org/pdf/2510.10625v2)**
...
>
---
#### [replaced 127] VGGSounder: Audio-Visual Evaluations for Foundation Models
...
>
---
#### [replaced 128] GEM: Empowering MLLM for Grounded ECG Understanding with Time Series and Images
...
>
---
#### [replaced 129] FireANTs: Adaptive Riemannian Optimization for Multi-Scale Diffeomorphic Matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.01249v4](http://arxiv.org/pdf/2404.01249v4)**
