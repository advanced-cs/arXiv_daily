...
#### [new 001] AnimationBench: Are Video Models Good at Character-Centric Animation?
- **分类: cs.CV**

- **简介: 该论文提出AnimationBench，针对动画生成任务，解决现有基准无法有效评估动画风格的问题，通过设计多维评价体系提升评估准确性。**

- **链接: [https://arxiv.org/pdf/2604.15299](https://arxiv.org/pdf/2604.15299)**
...
>
---
#### [new 002] FSDETR: Frequency-Spatial Feature Enhancement for Small Object Detection
- **分类: cs.CV**

- **简介: 该论文属于小目标检测任务，旨在解决特征退化、遮挡和背景干扰问题。提出FSDETR框架，结合空间与频率特征增强，提升检测性能。**

- **链接: [https://arxiv.org/pdf/2604.14884](https://arxiv.org/pdf/2604.14884)**

> **作者:** Jianchao Huang; Fengming Zhang; Haibo Zhu; Tao Yan
>
> **备注:** 6 pages, 6 figures,accepted to IJCNN 2026
>
> **摘要:** Small object detection remains a significant challenge due to feature degradation from downsampling, mutual occlusion in dense clusters, and complex background interference. To address these issues, this paper proposes FSDETR, a frequency-spatial feature enhancement framework built upon the RT-DETR baseline. By establishing a collaborative modeling mechanism, the method effectively leverages complementary structural information. Specifically, a Spatial Hierarchical Attention Block (SHAB) captures both local details and global dependencies to strengthen semantic representation. Furthermore, to mitigate occlusion in dense scenes, the Deformable Attention-based Intra-scale Feature Interaction (DA-AIFI) focuses on informative regions via dynamic sampling. Finally, the Frequency-Spatial Feature Pyramid Network (FSFPN) integrates frequency filtering with spatial edge extraction via the Cross-domain Frequency-Spatial Block (CFSB) to preserve fine-grained details. Experimental results show that with only 14.7M parameters, FSDETR achieves 13.9% APS on VisDrone 2019 and 48.95% AP50 tiny on TinyPerson, showing strong performance on small-object benchmarks. The code and models are available at this https URL.
>
---
#### [new 003] Why Do Vision Language Models Struggle To Recognize Human Emotions?
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于情感识别任务，探讨VLM在情绪识别上的不足。指出数据长尾和时间信息缺失是主要问题，并提出采样策略与上下文增强方法改进性能。**

- **链接: [https://arxiv.org/pdf/2604.15280](https://arxiv.org/pdf/2604.15280)**
...
>
---
#### [new 004] RaTA-Tool: Retrieval-based Tool Selection with Multimodal Large Language Models
...
>
---
#### [new 005] TurboTalk: Progressive Distillation for One-Step Audio-Driven Talking Avatar Generation
...
>
---
#### [new 006] MM-WebAgent: A Hierarchical Multimodal Web Agent for Webpage Generation
...
>
---
#### [new 007] NG-GS: NeRF-Guided 3D Gaussian Splatting Segmentation
- **分类: cs.CV**

- **简介: 该论文属于3D场景分割任务，旨在解决3DGS中因高斯离散表示导致的边界模糊问题。通过引入RBF插值和NeRF优化，提升分割边界质量。**

- **链接: [https://arxiv.org/pdf/2604.14706](https://arxiv.org/pdf/2604.14706)**
...
>
---
#### [new 010] Zero-Ablation Overstates Register Content Dependence in DINO Vision Transformers
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究视觉Transformer中注册器（registers）的功能重要性，通过零消融实验发现其过度强调注册器内容依赖。工作包括对比多种替换控制方法，验证性能变化原因。任务为模型解释与评估。**

- **链接: [https://arxiv.org/pdf/2604.14433](https://arxiv.org/pdf/2604.14433)**
...
>
---
#### [new 011] SegWithU: Uncertainty as Perturbation Energy for Single-Forward-Pass Risk-Aware Medical Image Segmentation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出SegWithU，用于医学图像分割的不确定性建模，解决单次前向传播下不确定性估计不足的问题，通过引入轻量级不确定头，提升分割可靠性。**
...
>
---
#### [new 012] AD4AD: Benchmarking Visual Anomaly Detection Models for Safer Autonomous Driving
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉异常检测任务，旨在提升自动驾驶安全性。解决自动驾驶系统在遇到未训练异常情况时的可靠性问题，通过基准测试多种VAD方法，评估其性能与效率。**

- **链接: [https://arxiv.org/pdf/2604.15291](https://arxiv.org/pdf/2604.15291)**
...
>
---
#### [new 016] DharmaOCR: Specialized Small Language Models for Structured OCR that outperform Open-Source and Commercial Baselines
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 017] Chain-of-Glimpse: Search-Guided Progressive Object-Grounded Reasoning for Video Understanding
- **分类: cs.CV**

- **简介: 该论文提出Chain-of-Glimpse框架，解决视频理解中对象变化带来的挑战，通过搜索引导的逐步推理，提升多步骤决策的准确性与可解释性。**
...
>
---
#### [new 018] OmniLight: One Model to Rule All Lighting Conditions
- **分类: cs.CV**

- **简介: 该论文属于图像恢复任务，解决不良光照条件下的阴影去除与光照归一化问题。提出OmniLight模型，通过WD-MoE结构提升跨数据集的泛化能力。**

- **链接: [https://arxiv.org/pdf/2604.15170](https://arxiv.org/pdf/2604.15170)**
...
>
---
#### [new 022] Data Synthesis Improves 3D Myotube Instance Segmentation
- **分类: cs.CV**

- **简介: 该论文属于3D实例分割任务，解决缺乏标注数据的生物医学分割问题。通过几何驱动的数据合成，训练模型实现精准分割。**

- **链接: [https://arxiv.org/pdf/2604.14720](https://arxiv.org/pdf/2604.14720)**
...
>
> **摘要:** Myotubes are multinucleated muscle fibers serving as key model systems for studying muscle physiology, disease mechanisms, and drug responses. Mechanistic studies and drug screening thereby rely on quantitative morphological readouts such as diameter, length, and branching degree, which in turn require precise three-dimensional instance segmentation. Yet established pretrained biomedical segmentation models fail to generalize to this domain due to the absence of large annotated myotube datasets. We introduce a geometry-driven synthesis pipeline that models individual myotubes via polynomial centerlines, locally varying radii, branching structures, and ellipsoidal end caps derived from real microscopy observations. Synthetic volumes are rendered with realistic noise, optical artifacts, and CycleGAN-based Domain Adaptation (DA). A compact 3D U-Net with self-supervised encoder pretraining, trained exclusively on synthetic data, achieves a mean IPQ of 0.22 on real data, significantly outperforming three established zero-shot segmentation models, demonstrating that biophysics-driven synthesis enables effective instance segmentation in annotation-scarce biomedical domains.
>
---
#### [new 023] MetaDent: Labeling Clinical Images for Vision-Language Models in Dentistry
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MetaDent，解决牙科影像中视觉-语言模型缺乏细粒度标注数据的问题。构建了大规模牙科图像数据集与标注框架，评估VLM性能并公开资源以促进研究。**

- **链接: [https://arxiv.org/pdf/2604.14866](https://arxiv.org/pdf/2604.14866)**
...
>
---
#### [new 024] Integrating Object Detection, LiDAR-Enhanced Depth Estimation, and Segmentation Models for Railway Environments
- **分类: cs.CV**

- **简介: 该论文属于铁路环境中的障碍物检测任务，解决同时检测障碍物和估计距离的问题。整合了目标检测、分割和深度估计模型，提升场景感知能力。**

- **链接: [https://arxiv.org/pdf/2604.14781](https://arxiv.org/pdf/2604.14781)**
...
>
---
#### [new 025] AIM: Asymmetric Information Masking for Visual Question Answering Continual Learning
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 039] LeapAlign: Post-Training Flow Matching Models at Any Generation Step by Building Two-Step Trajectories
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，解决流匹配模型对齐人类偏好时的梯度传播问题。提出LeapAlign方法，通过构建两步轨迹实现高效、稳定的模型微调。**

- **链接: [https://arxiv.org/pdf/2604.15311](https://arxiv.org/pdf/2604.15311)**
...
>
---
#### [new 040] An Analysis of Regularization and Fokker-Planck Residuals in Diffusion Models for Image Generation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像生成任务，研究扩散模型中正则化与Fokker-Planck残差的关系。针对传统方法计算成本高且效果有限的问题，提出轻量级正则化方法，以降低计算开销并保持生成质量。**

- **链接: [https://arxiv.org/pdf/2604.15171](https://arxiv.org/pdf/2604.15171)**
...
>
---
#### [new 043] Towards Design Compositing
- **分类: cs.CV**

- **简介: 该论文属于图形设计任务，解决输入元素视觉不协调问题。提出GIST方法，在不修改现有流程的情况下提升设计的视觉和谐与美感。**

- **链接: [https://arxiv.org/pdf/2604.14605](https://arxiv.org/pdf/2604.14605)**
...
>
> **摘要:** This paper presents the NTIRE 2026 image super-resolution ($\times$4) challenge, one of the associated competitions of the NTIRE 2026 Workshop at CVPR 2026. The challenge aims to reconstruct high-resolution (HR) images from low-resolution (LR) inputs generated through bicubic downsampling with a $\times$4 scaling factor. The objective is to develop effective super-resolution solutions and analyze recent advances in the field. To reflect the evolving objectives of image super-resolution, the challenge includes two tracks: (1) a restoration track, which emphasizes pixel-wise fidelity and ranks submissions based on PSNR; and (2) a perceptual track, which focuses on visual realism and evaluates results using a perceptual score. A total of 194 participants registered for the challenge, with 31 teams submitting valid entries. This report summarizes the challenge design, datasets, evaluation protocol, main results, and methods of participating teams. The challenge provides a unified benchmark and offers insights into current progress and future directions in image super-resolution.
>
---
#### [new 048] Crowdsourcing of Real-world Image Annotation via Visual Properties
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像标注任务，旨在解决语义鸿沟问题。通过整合多技术，提出一种基于视觉属性的众包标注方法，以减少主观性并提升标注质量。**

- **链接: [https://arxiv.org/pdf/2604.14449](https://arxiv.org/pdf/2604.14449)**
...
>
---
#### [new 053] Prompt-to-Gesture: Measuring the Capabilities of Image-to-Video Deictic Gesture Generation
- **分类: cs.CV**

- **简介: 该论文属于手势生成任务，旨在解决手势数据稀缺问题。通过图像到视频的生成技术，创建真实且多样的指示性手势数据集，提升下游任务性能。**

- **链接: [https://arxiv.org/pdf/2604.14953](https://arxiv.org/pdf/2604.14953)**
...
> **备注:** Project Page: this https URL ; Code: this https URL
>
> **摘要:** We introduce HY-World 2.0, a multi-modal world model framework that advances our prior project HY-World 1.0. HY-World 2.0 accommodates diverse input modalities, including text prompts, single-view images, multi-view images, and videos, and produces 3D world representations. With text or single-view image inputs, the model performs world generation, synthesizing high-fidelity, navigable 3D Gaussian Splatting (3DGS) scenes. This is achieved through a four-stage method: a) Panorama Generation with HY-Pano 2.0, b) Trajectory Planning with WorldNav, c) World Expansion with WorldStereo 2.0, and d) World Composition with WorldMirror 2.0. Specifically, we introduce key innovations to enhance panorama fidelity, enable 3D scene understanding and planning, and upgrade WorldStereo, our keyframe-based view generation model with consistent memory. We also upgrade WorldMirror, a feed-forward model for universal 3D prediction, by refining model architecture and learning strategy, enabling world reconstruction from multi-view images or videos. Also, we introduce WorldLens, a high-performance 3DGS rendering platform featuring a flexible engine-agnostic architecture, automatic IBL lighting, efficient collision detection, and training-rendering co-design, enabling interactive exploration of 3D worlds with character support. Extensive experiments demonstrate that HY-World 2.0 achieves state-of-the-art performance on several benchmarks among open-source approaches, delivering results comparable to the closed-source model Marble. We release all model weights, code, and technical details to facilitate reproducibility and support further research on 3D world models.
>
---
#### [new 059] CMTM: Cross-Modal Token Modulation for Unsupervised Video Object Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视频对象分割任务，解决无监督场景下如何有效融合外观与运动信息的问题。提出跨模态token调制方法，增强两者交互，提升分割性能。**

- **链接: [https://arxiv.org/pdf/2604.14630](https://arxiv.org/pdf/2604.14630)**
...
>
---
#### [new 068] Quality-Aware Calibration for AI-Generated Image Detection in the Wild
- **分类: cs.CV**

- **简介: 该论文属于AI生成图像检测任务，解决真实场景中因图像多次处理导致检测结果不一致的问题。通过整合近似重复图像并考虑质量因素，提升检测可靠性。**

- **链接: [https://arxiv.org/pdf/2604.15027](https://arxiv.org/pdf/2604.15027)**
...
>
---
#### [new 069] Switch-KD: Visual-Switch Knowledge Distillation for Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言模型压缩任务，旨在解决多模态知识蒸馏中的对齐问题。提出Switch-KD框架，通过视觉切换和动态损失提升知识迁移效果。**

- **链接: [https://arxiv.org/pdf/2604.14629](https://arxiv.org/pdf/2604.14629)**
...
>
---
#### [new 070] Prompt-Guided Image Editing with Masked Logit Nudging in Visual Autoregressive Models
- **分类: cs.CV**

- **简介: 该论文属于图像编辑任务，解决根据文本提示修改图像的问题。提出Masked Logit Nudging方法，通过引导模型预测与源图对齐，实现精准编辑。**

- **链接: [https://arxiv.org/pdf/2604.14591](https://arxiv.org/pdf/2604.14591)**
...
>
---
#### [new 074] VisPCO: Visual Token Pruning Configuration Optimization via Budget-Aware Pareto-Frontier Learning for Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉语言模型优化任务，解决视觉token剪枝配置不优的问题。提出VisPCO框架，通过帕累托优化自动寻找最佳剪枝配置，提升模型效率与精度平衡。**

- **链接: [https://arxiv.org/pdf/2604.15188](https://arxiv.org/pdf/2604.15188)**
...
>
---
#### [new 075] Beyond Independent Frames: Latent Attention Masked Autoencoders for Multi-View Echocardiography
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出LAMAE模型，解决多视角超声心动图的表示学习问题，通过引入潜在注意力机制，提升心脏功能的全面重建与跨人群迁移能力。**

- **链接: [https://arxiv.org/pdf/2604.15096](https://arxiv.org/pdf/2604.15096)**
...
>
---
#### [new 076] Flow of Truth: Proactive Temporal Forensics for Image-to-Video Generation
- **分类: cs.CV**

- **简介: 该论文属于图像到视频生成的时序取证任务，旨在解决视频中像素随时间流动的追踪问题。提出“Flow of Truth”框架，通过学习像素运动模式实现有效时序分析。**
...
>
---
#### [new 084] HAMSA: Scanning-Free Vision State Space Models via SpectralPulseNet
- **分类: cs.CV; cs.LG; eess.IV**

- **简介: 该论文提出HAMSA，一种无需扫描的视觉状态空间模型，解决传统方法计算复杂和效率低的问题。通过频域操作和创新机制，提升速度与性能。**

- **链接: [https://arxiv.org/pdf/2604.14724](https://arxiv.org/pdf/2604.14724)**
...
>
---
#### [new 085] Class Unlearning via Depth-Aware Removal of Forget-Specific Directions
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于机器学习中的类遗忘任务，旨在有效移除模型中特定类别的知识，同时保持其他类别性能。提出DAMP方法，通过投影修正权重，实现精准遗忘与保留。**
...
>
---
#### [new 090] Open-Set Vein Biometric Recognition with Deep Metric Learning
- **分类: cs.CV**

- **简介: 该论文属于开放集静脉生物识别任务，解决传统方法在扩展性和新用户适应上的不足。通过深度度量学习，提升识别准确率并有效区分已注册用户与未知攻击者。**

- **链接: [https://arxiv.org/pdf/2604.14874](https://arxiv.org/pdf/2604.14874)**
...
>
---
#### [new 093] GlobalSplat: Efficient Feed-Forward 3D Gaussian Splatting via Global Scene Tokens
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，旨在解决传统方法在效率与精度间的平衡问题。提出GlobalSplat框架，通过全局场景编码实现高效、紧凑的3D高斯溅射。**

- **链接: [https://arxiv.org/pdf/2604.15284](https://arxiv.org/pdf/2604.15284)**
...
>
---
#### [new 096] HRDexDB: A Large-Scale Dataset of Dexterous Human and Robotic Hand Grasps
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 099] Rethinking Patient Education as Multi-turn Multi-modal Interaction
...
>
---
#### [new 100] STEP-Parts: Geometric Partitioning of Boundary Representations for Large-Scale CAD Processing
- **分类: cs.GR; cs.AI; cs.CV; cs.LG**

- **简介: 该论文提出STEP-Parts，用于从CAD数据中提取几何实例分割，解决传统方法丢失拓扑信息的问题。通过保留原始面对应关系，实现稳定且高效的分割。**
...
>
---
#### [new 101] Reasoning Dynamics and the Limits of Monitoring Modality Reliance in Vision-Language Models
...
>
---
#### [new 102] OpenMobile: Building Open Mobile Agents with Task and Trajectory Synthesis
...
>
---
#### [new 103] Robustness of Vision Foundation Models to Common Perturbations
- **分类: cs.CR; cs.CV**

- **简介: 该论文研究视觉基础模型在常见图像扰动下的鲁棒性，旨在评估其对编辑操作的敏感度。通过提出鲁棒性指标并分析模型表现，发现多数模型不鲁棒，并提出改进方法。**

- **链接: [https://arxiv.org/pdf/2604.14973](https://arxiv.org/pdf/2604.14973)**
...
>
---
#### [new 104] When Fairness Metrics Disagree: Evaluating the Reliability of Demographic Fairness Assessment in Machine Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于机器学习公平性评估任务，旨在解决不同公平性指标间结论不一致的问题。通过多指标分析，发现公平性评估结果差异大，提出FDI量化不一致性。**
...
>
---
#### [new 105] The Cost of Language: Centroid Erasure Exposes and Exploits Modal Competition in Multimodal Language Models
...
>
---
#### [new 106] Vision-Based Safe Human-Robot Collaboration with Uncertainty Guarantees
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 107] A deep learning framework for glomeruli segmentation with boundary attention
- **分类: q-bio.TO; cs.CV; cs.LG**

- **简介: 该论文属于医学图像分割任务，旨在解决肾小球边界分割不准确的问题。提出一种基于U-Net的模型，引入边界注意力机制，提升分割精度。**

- **链接: [https://arxiv.org/pdf/2604.14263](https://arxiv.org/pdf/2604.14263)**
...
>
---
#### [new 108] Knowing When Not to Answer: Evaluating Abstention in Multimodal Reasoning Systems
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 109] Neuro-Oracle: A Trajectory-Aware Agentic RAG Framework for Interpretable Epilepsy Surgical Prognosis
...
>
---
#### [new 110] Step-level Denoising-time Diffusion Alignment with Multiple Objectives
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于扩散模型对齐任务，解决多目标平衡问题。提出MSDDA框架，在无需微调的情况下，精确实现多目标扩散模型对齐。**

- **链接: [https://arxiv.org/pdf/2604.14379](https://arxiv.org/pdf/2604.14379)**
...
>
---
#### [new 111] ADAPT: Benchmarking Commonsense Planning under Unspecified Affordance Constraints
...
>
---
#### [new 112] ControlFoley: Unified and Controllable Video-to-Audio Generation with Cross-Modal Conflict Handling
...
>
---
#### [new 113] CooperDrive: Enhancing Driving Decisions Through Cooperative Perception
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 114] FAIR Universe Weak Lensing ML Uncertainty Challenge: Handling Uncertainties and Distribution Shifts for Precision Cosmology
- **分类: astro-ph.CO; cs.AI; cs.CV; physics.data-an**

- **简介: 该论文属于弱引力透镜领域的机器学习任务，旨在解决数据有限和分布偏移问题。通过构建基准数据集，推动ML方法在处理系统误差和提升数据效率方面的应用。**

- **链接: [https://arxiv.org/pdf/2604.14451](https://arxiv.org/pdf/2604.14451)**
...
>
> **备注:** Accepted by ACL Findings 2026. Project page: this https URL
>
...
>
---
#### [replaced 004] JoyVASA: Portrait and Animal Image Animation with Diffusion-Based Audio-Driven Facial Dynamics and Head Motion Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.09209](https://arxiv.org/pdf/2411.09209)**

> **作者:** Xuyang Cao; Guoxin Wang; Sheng Shi; Jun Zhao; Yang Yao; Jintao Fei; Minyu Gao; Pei Xie
>
> **摘要:** Audio-driven portrait animation has made significant advances with diffusion-based models, improving video quality and lipsync accuracy. However, the increasing complexity of these models has led to inefficiencies in training and inference, as well as constraints on video length and inter-frame continuity. In this paper, we propose JoyVASA, a diffusion-based method for generating facial dynamics and head motion in audio-driven facial animation. Specifically, in the first stage, we introduce a decoupled facial representation framework that separates dynamic facial expressions from static 3D facial representations. This decoupling allows the system to generate longer videos by combining any static 3D facial representation with dynamic motion sequences. Then, in the second stage, a diffusion transformer is trained to generate motion sequences directly from audio cues, independent of character identity. Finally, a generator trained in the first stage uses the 3D facial representation and the generated motion sequences as inputs to render high-quality animations. With the decoupled facial representation and the identity-independent motion generation process, JoyVASA extends beyond human portraits to animate animal faces seamlessly. The model is trained on a hybrid dataset of private Chinese and public English data, enabling multilingual support. Experimental results validate the effectiveness of our approach. Future work will focus on improving real-time performance and refining expression control, further expanding the applications in portrait animation. The code is available at: this https URL.
>
---
#### [replaced 005] C2W-Tune: Cavity-to -Wall Transfer Learning for Thin Atrial Wall Segmentation in 3D Late Gadolinium-enhanced Magnetic Resonance
- **分类: cs.CV**
...
>
---
#### [replaced 006] V-Reflection: Transforming MLLMs from Passive Observers to Active Interrogators
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 007] TwinOR: Photorealistic Digital Twins of Dynamic Operating Rooms for Embodied AI Research
- **分类: cs.CV; cs.RO**
...
>
> **备注:** Accepted to CVPR Findings 2026. Project Page: this https URL
>
...
>
---
#### [replaced 010] Counting Without Numbers and Finding Without Words
...
>
---
#### [replaced 013] VGGT-Segmentor: Geometry-Enhanced Cross-View Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 014] POP: Prefill-Only Pruning for Efficient Large Model Inference
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [replaced 015] KnowRL: Exploring Knowledgeable Reinforcement Learning for Factuality
...
>
---
#### [replaced 016] Label-efficient underwater species classification with logistic regression on frozen foundation model embeddings
- **分类: cs.CV**
...
>
> **备注:** v2. New methodology, instead of semi supervised now focused on linear separability. Methodological updates, performance upgrades. The concept is still the same, but the experimental setup and the implementation details have changed
>
...
>
---
#### [replaced 017] 3AM: 3egment Anything with Geometric Consistency in Videos
- **分类: cs.CV**
...
>
---
#### [replaced 018] Diagnosing and Improving Diffusion Models by Estimating the Optimal Loss Value
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **链接: [https://arxiv.org/pdf/2506.13763](https://arxiv.org/pdf/2506.13763)**

> **作者:** Yixian Xu; Shengjie Luo; Liwei Wang; Di He; Chang Liu
>
> **备注:** 33 pages, 12 figures, 9 tables. ICLR 2026 Camera Ready version
>
...
>
---
#### [replaced 019] CaptionQA: Is Your Caption as Useful as the Image Itself?
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21025](https://arxiv.org/pdf/2511.21025)**
...
>
---
#### [replaced 025] Improving Prostate Gland Segmentation Using Transformer based Architectures
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.14844](https://arxiv.org/pdf/2506.14844)**

> **作者:** Shatha Abudalou Yasin Yilmaz Yoganand Balagurunathan
>
...
>
---
#### [replaced 026] LLMOrbit: A Circular Taxonomy of Large Language Models -From Scaling Walls to Agentic AI Systems
- **分类: cs.LG; cs.AI; cs.CV; cs.MA; eess.IV**

- **链接: [https://arxiv.org/pdf/2601.14053](https://arxiv.org/pdf/2601.14053)**
...
>
---
#### [replaced 027] Visual Enhanced Depth Scaling for Multimodal Latent Reasoning
- **分类: cs.CV**
...
>
---
#### [replaced 028] WaveSFNet: A Wavelet-Based Codec and Spatial--Frequency Dual-Domain Gating Network for Spatiotemporal Prediction
- **分类: cs.CV**
...
>
---
#### [replaced 029] 3D Conditional Image Synthesis of Left Atrial LGE MRI from Composite Semantic Masks
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.04588](https://arxiv.org/pdf/2601.04588)**
...
>
---
#### [replaced 030] Multi-Frequency Local Plasticity for Visual Representation Learning
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 031] SegviGen: Repurposing 3D Generative Model for Part Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 032] All Changes May Have Invariant Principles: Improving Ever-Shifting Harmful Meme Detection via Design Concept Reproduction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.04567](https://arxiv.org/pdf/2601.04567)**

> **作者:** Ziyou Jiang; Mingyang Li; Junjie Wang; Yuekai Huang; Jie Huang; Zhiyuan Chang; Zhaoyang Li; Qing Wang
>
> **备注:** 19 pages, 11 figures, 9 tables accepted by ACL 2026 main conference
>
...
>
---
#### [replaced 033] To See or To Please: Uncovering Visual Sycophancy and Split Beliefs in VLMs
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 034] GSNR: Graph Smooth Null-Space Representation for Inverse Problems
- **分类: cs.CV; eess.IV; math.OC**

- **链接: [https://arxiv.org/pdf/2602.20328](https://arxiv.org/pdf/2602.20328)**

> **作者:** Romario Gualdrón-Hurtado; Roman Jacome; Rafael S. Suarez; Henry Arguello
>
> **备注:** Accepted to The IEEE/CVF Conference on Computer Vision and Pattern Recognition 2026 (CVPR 2026)
>
...
>
---
#### [replaced 035] Precision Synthesis of Multi-Tracer PET via VLM-Modulated Rectified Flow for Stratifying Mild Cognitive Impairment
- **分类: cs.CV**
...
>
> **备注:** Added supplementary material
>
...
>
---
#### [replaced 036] SLQ: Bridging Modalities via Shared Latent Queries for Retrieval with Frozen MLLMs
- **分类: cs.CV**
...
>
---
#### [replaced 039] Large Vision Model-Guided Masked Low-Rank Approximation for Ground-Roll Attenuation
- **分类: cs.CV**
...
>
---
#### [replaced 041] HERMES: KV Cache as Hierarchical Memory for Efficient Streaming Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 044] PAGE-4D: Disentangled Pose and Geometry Estimation for VGGT-4D Perception
- **分类: cs.CV**
...
>
---
#### [replaced 045] DocVAL: Validated Chain-of-Thought Distillation for Grounded Document VQA
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 046] Geometric Context Transformer for Streaming 3D Reconstruction
- **分类: cs.CV**
...
>
---
#### [replaced 047] One RL to See Them All: Visual Triple Unified Reinforcement Learning
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 048] Latent Wavelet Diffusion For Ultra-High-Resolution Image Synthesis
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2506.00433](https://arxiv.org/pdf/2506.00433)**
...
>
---
#### [replaced 049] One Token per Highly Selective Frame: Towards Extreme Compression for Long Video Understanding
- **分类: cs.CV**
...
>
> **备注:** Appear in the proceedings of NeurIPS 2025
>
...
>
---
#### [replaced 050] Revisiting Compositionality in Dual-Encoder Vision-Language Models: The Role of Inference
...
>
---
#### [replaced 051] PixelDiT: Pixel Diffusion Transformers for Image Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.20645](https://arxiv.org/pdf/2511.20645)**
...
>
---
#### [replaced 052] You Only Judge Once: Multi-response Reward Modeling in a Single Forward Pass
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 053] ArrowGEV: Grounding Events in Video via Learning the Arrow of Time
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.06559](https://arxiv.org/pdf/2601.06559)**
...
>
---
#### [replaced 054] VisRet: Visualization Improves Knowledge-Intensive Text-to-Image Retrieval
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 055] Estimating the Diameter at Breast Height of Trees in a Forest from RGB
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.03093](https://arxiv.org/pdf/2505.03093)**
...
>
---
#### [replaced 059] An Optimal Transport-driven Approach for Cultivating Latent Space in Online Incremental Learning
- **分类: cs.LG; cs.CV**
...
>
---
#### [replaced 063] SAM3-I: Segment Anything with Instructions
- **分类: cs.CV**
...
>
---
#### [replaced 064] Geoparsing: Diagram Parsing for Plane and Solid Geometry with a Unified Formal Language
- **分类: cs.CV**
...
>
---
#### [replaced 068] Few-Shot Left Atrial Wall Segmentation in 3D LGE MRI via Meta-Learning
- **分类: cs.CV**
...
>
---
#### [replaced 069] ModuSeg: Decoupling Object Discovery and Semantic Retrieval for Training-Free Weakly Supervised Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 070] FADPNet: Frequency-Aware Dual-Path Network for Face Super-Resolution
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.14121](https://arxiv.org/pdf/2506.14121)**

> **作者:** Siyu Xu; Wenjie Li; Guangwei Gao; Jian Yang; Guo-Jun Qi; Chia-Wen Lin
>
> **备注:** 12 pages, 10 figures, 8 tales
>
...
>
---
#### [replaced 071] GAMBIT: A Gamified Jailbreak Framework for Multimodal Large Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 072] The Spectrascapes Dataset: Street-view imagery beyond the visible captured using a mobile platform
- **分类: cs.CV; cs.LG**
