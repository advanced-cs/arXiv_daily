...
#### [new 001] MVAFormer: RGB-based Multi-View Spatio-Temporal Action Recognition with Transformer
- **分类: cs.CV**

- **简介: 论文提出MVAFormer，面向时空动作识别（STAR）任务，解决多视角下因遮挡导致的动作识别难题。通过保留空间信息的Transformer视图协同模块，分离同/异视角自注意力，提升多视角动作序列识别精度。**

- **链接: [http://arxiv.org/pdf/2511.02473v1](http://arxiv.org/pdf/2511.02473v1)**

> **作者:** Taiga Yamane; Satoshi Suzuki; Ryo Masumura; Shotaro Tora
>
> **备注:** Selected as Best Industry Paper Award at ICIP2024
>
> **摘要:** Multi-view action recognition aims to recognize human actions using multiple camera views and deals with occlusion caused by obstacles or crowds. In this task, cooperation among views, which generates a joint representation by combining multiple views, is vital. Previous studies have explored promising cooperation methods for improving performance. However, since their methods focus only on the task setting of recognizing a single action from an entire video, they are not applicable to the recently popular spatio-temporal action recognition~(STAR) setting, in which each person's action is recognized sequentially. To address this problem, this paper proposes a multi-view action recognition method for the STAR setting, called MVAFormer. In MVAFormer, we introduce a novel transformer-based cooperation module among views. In contrast to previous studies, which utilize embedding vectors with lost spatial information, our module utilizes the feature map for effective cooperation in the STAR setting, which preserves the spatial information. Furthermore, in our module, we divide the self-attention for the same and different views to model the relationship between multiple views effectively. The results of experiments using a newly collected dataset demonstrate that MVAFormer outperforms the comparison baselines by approximately $4.4$ points on the F-measure.
>
---
#### [new 002] UniChange: Unifying Change Detection with Multimodal Large Language Model
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 003] TAUE: Training-free Noise Transplant and Cultivation Diffusion Model
- **分类: cs.CV; cs.AI; cs.GR; cs.LG**

- **简介: TAUE提出一种无训练的噪声移植与培育扩散模型，解决文本生成图像中缺乏多层可控性的问题，通过中间潜变量移植实现前景、背景与整体层的语义一致生成，无需微调即可实现高质量分层图像合成。**

- **链接: [http://arxiv.org/pdf/2511.02580v1](http://arxiv.org/pdf/2511.02580v1)**

> **作者:** Daichi Nagai; Ryugo Morita; Shunsuke Kitada; Hitoshi Iyatomi
>
> **备注:** 13 pages, 8 figures, 3 tables. The first two authors contributed equally. Project Page: https://iyatomilab.github.io/TAUE
>
...
>
---
#### [new 004] Collaborative Attention and Consistent-Guided Fusion of MRI and PET for Alzheimer's Disease Diagnosis
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向阿尔茨海默病诊断，解决多模态MRI与PET融合中忽视模态特异性特征及分布偏差问题，提出协作注意力与一致性引导融合框架，通过可学习参数补偿与分布对齐，提升诊断性能。**

- **链接: [http://arxiv.org/pdf/2511.02228v1](http://arxiv.org/pdf/2511.02228v1)**
...
>
---
#### [new 005] Estimation of Segmental Longitudinal Strain in Transesophageal Echocardiography by Deep Learning
- **分类: cs.CV; cs.AI; eess.IV**

- **简介: 该论文提出首个基于深度学习的自动管道autoStrain，用于经食管超声心动图中左室节段纵向应变的估算，解决人工依赖高、效率低的问题，通过合成数据训练TeeTracker与TeeFlow模型，实现高精度运动估计与临床验证。**

- **链接: [http://arxiv.org/pdf/2511.02210v1](http://arxiv.org/pdf/2511.02210v1)**
...
>
---
#### [new 011] A Cognitive Process-Inspired Architecture for Subject-Agnostic Brain Visual Decoding
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出VCFlow架构，面向无受试者特异性训练的脑视觉解码任务，解决跨被试泛化难题。通过模拟视觉皮层腹背通路并引入对比学习，实现快速、高泛化性的视觉重建，仅牺牲7%精度即可在10秒内生成视频。**

- **链接: [http://arxiv.org/pdf/2511.02565v1](http://arxiv.org/pdf/2511.02565v1)**
...
>
---
#### [new 012] Unsupervised Learning for Industrial Defect Detection: A Case Study on Shearographic Data
- **分类: cs.CV**

- **简介: 该论文面向工业剪切散斑图像的无监督异常检测任务，旨在解决依赖标注数据的问题。通过对比三种无监督模型，提出学生-教师模型在缺陷分类与定位上表现最优，且能有效应对形变干扰，提升检测实用性。**

- **链接: [http://arxiv.org/pdf/2511.02541v1](http://arxiv.org/pdf/2511.02541v1)**
...
>
---
#### [new 013] Forecasting Future Anatomies: Longitudianl Brain Mri-to-Mri Prediction
- **分类: cs.CV; cs.LG; q-bio.NC**

- **简介: 该论文提出基于深度学习的纵向脑MRI图像预测任务，旨在从基线MRI预测数年后个体全脑结构变化，以揭示神经退行性病变模式。评估了五种模型，实现高保真 voxel-level 预测，并在多队列验证了泛化能力。**

- **链接: [http://arxiv.org/pdf/2511.02558v1](http://arxiv.org/pdf/2511.02558v1)**
...
>
---
#### [new 014] Are Euler angles a useful rotation parameterisation for pose estimation with Normalizing Flows?
- **分类: cs.CV**

- **简介: 该论文研究在正态流模型中使用欧拉角进行姿态估计的可行性，旨在解决因传感器限制或物体对称性导致的姿态不确定性问题，对比其与复杂参数化方法的性能优劣。**

- **链接: [http://arxiv.org/pdf/2511.02277v1](http://arxiv.org/pdf/2511.02277v1)**
...
>
---
#### [new 023] Monocular absolute depth estimation from endoscopy via domain-invariant feature learning and latent consistency
- **分类: cs.CV**

- **简介: 该论文致力于内窥镜单目绝对深度估计，解决合成与真实内窥镜图像间域差距问题，提出域不变特征学习与潜在一致性约束方法，提升深度估计精度，无需依赖图像风格迁移。**

- **链接: [http://arxiv.org/pdf/2511.02247v1](http://arxiv.org/pdf/2511.02247v1)**
...
>
---
#### [new 025] Dynamic Reflections: Probing Video Representations with Text Alignment
- **分类: cs.CV**

- **简介: 该论文首次系统研究视频-文本表征对齐，探明视觉丰富性与文本多样性对对齐效果的影响，提出参数化缩放定律，并揭示对齐能力与视频理解性能的关联，为零样本评估时空表征提供新方法。**

- **链接: [http://arxiv.org/pdf/2511.02767v1](http://arxiv.org/pdf/2511.02767v1)**
...
>
---
#### [new 026] Adapting General-Purpose Foundation Models for X-ray Ptychography in Low-Data Regimes
- **分类: cs.CV**

- **简介: 该论文针对X射线叠层成像的低数据场景，构建PtychoBench基准，比较SFT与ICL两种适配策略，发现视觉任务适合SFT+ICL融合，文本任务则ICL更优，揭示任务模态决定最优适配路径。**

- **链接: [http://arxiv.org/pdf/2511.02503v1](http://arxiv.org/pdf/2511.02503v1)**
...
>
---
#### [new 027] MM-UNet: Morph Mamba U-shaped Convolutional Networks for Retinal Vessel Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 论文提出MM-UNet，用于视网膜血管分割任务，解决细小分支结构与形态多变带来的分割难题。通过Morph Mamba卷积与反向状态引导模块，提升拓扑感知与边界精度，在DRIVE和STARE数据集上显著提升F1分数。**

- **链接: [http://arxiv.org/pdf/2511.02193v1](http://arxiv.org/pdf/2511.02193v1)**
...
>
---
#### [new 031] Medical Report Generation: A Hierarchical Task Structure-Based Cross-Modal Causal Intervention Framework
- **分类: cs.CV**

- **简介: 该论文针对医学报告生成任务，提出HTSC-CIF框架，通过分层任务分解解决领域知识不足、跨模态对齐差和偏差关联三大问题，引入因果干预提升生成质量与可解释性。**

- **链接: [http://arxiv.org/pdf/2511.02271v1](http://arxiv.org/pdf/2511.02271v1)**
...
>
---
#### [new 032] iFlyBot-VLA Technical Report
...
>
---
#### [new 033] Object Detection as an Optional Basis: A Graph Matching Network for Cross-View UAV Localization
- **分类: cs.CV**

- **简介: 该论文提出一种基于图匹配网络的跨视角无人机定位方法，利用目标检测提取显著物体，构建图结构建模图像间关系，解决无GNSS环境下异构影像（如无人机与卫星图）匹配难题，实现高精度定位。**

- **链接: [http://arxiv.org/pdf/2511.02489v1](http://arxiv.org/pdf/2511.02489v1)**
...
>
---
#### [new 040] Autobiasing Event Cameras for Flickering Mitigation
- **分类: cs.CV**

- **简介: 该论文提出一种自主调优事件相机偏置的机制，解决光照闪烁（25–500 Hz）导致的性能下降问题。基于CNN检测闪烁并动态调整偏置，无需额外硬件。实验表明，其显著提升人脸检测准确率与图像质量，梯度指标降低超38%。**

- **链接: [http://arxiv.org/pdf/2511.02180v1](http://arxiv.org/pdf/2511.02180v1)**
...
>
---
#### [new 041] The Urban Vision Hackathon Dataset and Models: Towards Image Annotations and Accurate Vision Models for Indian Traffic
- **分类: cs.CV**

- **简介: 该论文发布首个印度交通图像数据集UVH-26，解决全球数据集不适配印度复杂交通场景的问题。通过众包标注180万框，训练YOLO/DETR模型，显著提升检测精度，推动新兴国家智能交通系统发展。**

- **链接: [http://arxiv.org/pdf/2511.02563v1](http://arxiv.org/pdf/2511.02563v1)**
...
>
---
#### [new 046] AI-Generated Image Detection: An Empirical Study and Future Research Directions
- **分类: cs.CV; cs.GT**

- **简介: 该论文针对AI生成图像检测任务，解决现有方法评估不统一、泛化差、可解释性不足的问题，构建标准化基准，系统评估十种前沿方法，提出多维度评估指标与可解释性分析，推动鲁棒、可泛化检测技术发展。**

- **链接: [http://arxiv.org/pdf/2511.02791v1](http://arxiv.org/pdf/2511.02791v1)**
...
>
---
#### [new 047] RxnCaption: Reformulating Reaction Diagram Parsing as Visual Prompt Guided Captioning
- **分类: cs.CV**

- **简介: 论文提出RxnCaption框架，将化学反应图解析转为视觉提示引导的图像描述任务，通过BIVP策略用分子框和索引引导LVLMs生成文本描述，构建了11k规模数据集，显著提升解析性能。**

- **链接: [http://arxiv.org/pdf/2511.02384v1](http://arxiv.org/pdf/2511.02384v1)**
...
>
---
#### [new 050] Keeping it Local, Tiny and Real: Automated Report Generation on Edge Computing Devices for Mechatronic-Based Cognitive Systems
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 051] From the Laboratory to Real-World Application: Evaluating Zero-Shot Scene Interpretation on Edge Devices for Mobile Robotics
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 058] OLATverse: A Large-scale Real-world Object Dataset with Precise Lighting Control
- **分类: cs.CV; cs.GR**

- **简介: 论文提出OLATverse，一个包含900万张真实物体图像的大规模数据集，旨在解决逆渲染与重光照方法依赖合成数据、泛化性差的问题，提供精确控光、多视角、高保真真实物体数据及配套标注，构建首个真实物体基准。**

- **链接: [http://arxiv.org/pdf/2511.02483v1](http://arxiv.org/pdf/2511.02483v1)**
...
>
---
#### [new 059] SAIL-RL: Guiding MLLMs in When and How to Think via Dual-Reward RL Tuning
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 060] M3PD Dataset: Dual-view Photoplethysmography (PPG) Using Front-and-rear Cameras of Smartphones in Lab and Clinical Settings
- **分类: cs.CV**

- **简介: 该论文提出M3PD数据集，首次公开双视角手机PPG数据，用于提升心血管患者心率监测准确性；并构建F3Mamba模型，融合面部与指尖视频，显著降低运动与光照干扰下的心率误差。**

- **链接: [http://arxiv.org/pdf/2511.02349v1](http://arxiv.org/pdf/2511.02349v1)**
...
>
---
#### [new 071] TWIST2: Scalable, Portable, and Holistic Humanoid Data Collection System
...
>
---
#### [new 075] Opto-Electronic Convolutional Neural Network Design Via Direct Kernel Optimization
- **分类: eess.IV; cs.CV**

- **简介: 该论文针对光电卷积神经网络设计难题，提出两阶段优化策略：先训练电子CNN，再通过核优化实现超表面光学前端，显著降低计算开销并提升精度，在单目深度估计中准确率翻倍。**

- **链接: [http://arxiv.org/pdf/2511.02065v1](http://arxiv.org/pdf/2511.02065v1)**
...
>
---
#### [replaced 002] Dual-Stream Diffusion for World-Model Augmented Vision-Language-Action Model
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 003] WXSOD: A Benchmark for Robust Salient Object Detection in Adverse Weather Conditions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12250v2](http://arxiv.org/pdf/2508.12250v2)**

> **作者:** Quan Chen; Xiong Yang; Bolun Zheng; Rongfeng Lu; Xiaokai Yang; Qianyu Zhang; Yu Liu; Xiaofei Zhou
>
> **备注:** Under review
>
...
>
---
#### [replaced 006] Learning with Category-Equivariant Architectures for Human Activity Recognition
- **分类: cs.CV; cs.AI; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2511.01139v2](http://arxiv.org/pdf/2511.01139v2)**
...
>
---
#### [replaced 007] CGF-DETR: Cross-Gated Fusion DETR for Enhanced Pneumonia Detection in Chest X-rays
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2511.01730v2](http://arxiv.org/pdf/2511.01730v2)**

> **作者:** Yefeng Wu; Yuchen Song; Ling Wu; Shan Wan; Yecheng Zhao
>
...
>
---
#### [replaced 008] Mobile Robotic Multi-View Photometric Stereo
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 011] MultiSoundGen: Video-to-Audio Generation for Multi-Event Scenarios via SlowFast Contrastive Audio-Visual Pretraining and Direct Preference Optimization
...
>
---
#### [replaced 012] CWSSNet: Hyperspectral Image Classification Enhanced by Wavelet Domain Convolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.09163v2](http://arxiv.org/pdf/2509.09163v2)**
...
>
---
#### [replaced 013] Understanding Ice Crystal Habit Diversity with Self-Supervised Learning
- **分类: physics.ao-ph; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.07688v3](http://arxiv.org/pdf/2509.07688v3)**

> **作者:** Joseph Ko; Hariprasath Govindarajan; Fredrik Lindsten; Vanessa Przybylo; Kara Sulia; Marcus van Lier-Walqui; Kara Lamb
>
> **备注:** Accepted to NeurIPS 2025 Workshop: Tackling Climate Change with Machine Learning
>
...
>
---
#### [replaced 014] Real-Time Neural Video Compression with Unified Intra and Inter Coding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14431v4](http://arxiv.org/pdf/2510.14431v4)**
...
>
---
#### [replaced 015] Joint Lossless Compression and Steganography for Medical Images via Large Language Models
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.01782v3](http://arxiv.org/pdf/2508.01782v3)**

> **作者:** Pengcheng Zheng; Xiaorong Pu; Kecheng Chen; Jiaxin Huang; Meng Yang; Bai Feng; Yazhou Ren; Jianan Jiang; Chaoning Zhang; Yang Yang; Heng Tao Shen
>
...
>
---
#### [replaced 018] DIsoN: Decentralized Isolation Networks for Out-of-Distribution Detection in Medical Imaging
- **分类: cs.CV; cs.LG; I.2.11; I.4.9; I.4.9; J.3; I.2.0**

- **链接: [http://arxiv.org/pdf/2506.09024v2](http://arxiv.org/pdf/2506.09024v2)**
...
>
---
#### [replaced 019] FitPro: A Zero-Shot Framework for Interactive Text-based Pedestrian Retrieval in Open World
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16674v2](http://arxiv.org/pdf/2509.16674v2)**
...
>
---
#### [replaced 020] Light Future: Multimodal Action Frame Prediction via InstructPix2Pix
...
>
---
#### [replaced 024] Can MLLMs Read the Room? A Multimodal Benchmark for Verifying Truthfulness in Multi-Party Social Interactions
...
>
---
#### [replaced 025] Research on Expressway Congestion Warning Technology Based on YOLOv11-DIoU and GRU-Attention
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.13361v2](http://arxiv.org/pdf/2509.13361v2)**
...
>
---
#### [replaced 026] Visual Program Distillation with Template-Based Augmentation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 030] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.11878v2](http://arxiv.org/pdf/2510.11878v2)**
...
>
---
#### [replaced 031] Uniworld-V2: Reinforce Image Editing with Diffusion Negative-aware Finetuning and MLLM Implicit Feedback
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.16888v3](http://arxiv.org/pdf/2510.16888v3)**
...
>
---
#### [replaced 032] InternSVG: Towards Unified SVG Tasks with Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.11341v2](http://arxiv.org/pdf/2510.11341v2)**
...
>
---
#### [replaced 033] Breaking Down Monocular Ambiguity: Exploiting Temporal Evolution for 3D Lane Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.20525v2](http://arxiv.org/pdf/2504.20525v2)**
...
>
---
#### [replaced 036] Genie Envisioner: A Unified World Foundation Platform for Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 037] Dual-level Progressive Hardness-Aware Reweighting for Cross-View Geo-Localization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.27181v3](http://arxiv.org/pdf/2510.27181v3)**
...
>
---
#### [replaced 038] Latent Zoning Network: A Unified Principle for Generative Modeling, Representation Learning, and Classification
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **链接: [http://arxiv.org/pdf/2509.15591v2](http://arxiv.org/pdf/2509.15591v2)**
...
>
---
#### [replaced 039] A Practical Investigation of Spatially-Controlled Image Generation with Transformers
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15724v2](http://arxiv.org/pdf/2507.15724v2)**

> **作者:** Guoxuan Xia; Harleen Hanspal; Petru-Daniel Tudosiu; Shifeng Zhang; Sarah Parisot
>
> **备注:** TMLR https://openreview.net/forum?id=loT6xhgLYK
>
...
>
---
#### [replaced 040] Progressive Growing of Patch Size: Curriculum Learning for Accelerated and Improved Medical Image Segmentation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.23241v2](http://arxiv.org/pdf/2510.23241v2)**
...
>
---
#### [replaced 041] ID-Composer: Multi-Subject Video Synthesis with Hierarchical Identity Preservation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2511.00511v2](http://arxiv.org/pdf/2511.00511v2)**
...
>
---
#### [replaced 042] CrossRay3D: Geometry and Distribution Guidance for Efficient Multimodal 3D Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.15991v3](http://arxiv.org/pdf/2510.15991v3)**
...
>
---
#### [replaced 043] Label tree semantic losses for rich multi-class medical image segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15777v2](http://arxiv.org/pdf/2507.15777v2)**
...
>
---
#### [replaced 044] Weakly Supervised Object Segmentation by Background Conditional Divergence
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.22505v2](http://arxiv.org/pdf/2506.22505v2)**

> **作者:** Hassan Baker; Matthew S. Emigh; Austin J. Brockmeier
>
> **备注:** Published in TMLR: https://openreview.net/forum?id=2JJZhfGvMW
>
...
>
---
#### [replaced 048] ThinkMorph: Emergent Properties in Multimodal Interleaved Chain-of-Thought Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.27492v2](http://arxiv.org/pdf/2510.27492v2)**
...
>
---
#### [replaced 049] Towards Predicting Any Human Trajectory In Context
...
>
---
#### [replaced 050] WeCKD: Weakly-supervised Chained Distillation Network for Efficient Multimodal Medical Imaging
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14668v2](http://arxiv.org/pdf/2510.14668v2)**
...
>
---
#### [replaced 051] Real World Federated Learning with a Knowledge Distilled Transformer for Cardiac CT Imaging
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2407.07557v3](http://arxiv.org/pdf/2407.07557v3)**

> **作者:** Malte Tölle; Philipp Garthe; Clemens Scherer; Jan Moritz Seliger; Andreas Leha; Nina Krüger; Stefan Simm; Simon Martin; Sebastian Eble; Halvar Kelm; Moritz Bednorz; Florian André; Peter Bannas; Gerhard Diller; Norbert Frey; Stefan Groß; Anja Hennemuth; Lars Kaderali; Alexander Meyer; Eike Nagel; Stefan Orwat; Moritz Seiffert; Tim Friede; Tim Seidler; Sandy Engelhardt
>
> **摘要:** Federated learning is a renowned technique for utilizing decentralized data while preserving privacy. However, real-world applications often face challenges like partially labeled datasets, where only a few locations have certain expert annotations, leaving large portions of unlabeled data unused. Leveraging these could enhance transformer architectures ability in regimes with small and diversely annotated sets. We conduct the largest federated cardiac CT analysis to date (n=8,104) in a real-world setting across eight hospitals. Our two-step semi-supervised strategy distills knowledge from task-specific CNNs into a transformer. First, CNNs predict on unlabeled data per label type and then the transformer learns from these predictions with label-specific heads. This improves predictive accuracy and enables simultaneous learning of all partial labels across the federation, and outperforms UNet-based models in generalizability on downstream tasks. Code and model weights are made openly available for leveraging future cardiac CT analysis.
>
---
...
>
---
#### [replaced 053] OmniEarth-Bench: Towards Holistic Evaluation of Earth's Six Spheres and Cross-Spheres Interactions with Multimodal Observational Earth Data
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.23522v2](http://arxiv.org/pdf/2505.23522v2)**
...
>
---
#### [replaced 055] FreeArt3D: Training-Free Articulated Object Generation using 3D Diffusion
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2510.25765v2](http://arxiv.org/pdf/2510.25765v2)**

> **作者:** Chuhao Chen; Isabella Liu; Xinyue Wei; Hao Su; Minghua Liu
>
> **备注:** Project Page: https://czzzzh.github.io/FreeArt3D Code: https://github.com/CzzzzH/FreeArt3D
>
...
>
---
#### [replaced 056] DiffVLA++: Bridging Cognitive Reasoning and End-to-End Driving through Metric-Guided Alignment
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 057] RoMA: Scaling up Mamba-based Foundation Models for Remote Sensing
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.10392v2](http://arxiv.org/pdf/2503.10392v2)**
...
>
---
#### [replaced 063] Talk2Event: Grounded Understanding of Dynamic Scenes from Event Cameras
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 064] Parameterized Prompt for Incremental Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.27316v2](http://arxiv.org/pdf/2510.27316v2)**
