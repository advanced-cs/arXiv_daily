...
>
---
#### [new 003] From Ranking to Selection: A Simple but Efficient Dynamic Passage Selector for Retrieval Augmented Generation
- **分类: cs.CL; cs.AI**
...
- **简介: 论文综述38项NLP研究，系统梳理认知扭曲（CD）检测与分类任务，揭示领域碎片化问题，提出整合性术语表与任务框架，推动可复现研究。**
...
- **简介: 论文提出用户导向的主观排行榜（USL），通过定制化奖励模型（CRMs）解决传统客观基准无法满足个性化需求的问题，CRMs仅需4B参数即可超越主流模型，展现广泛适应性。**
...
- **链接: [http://arxiv.org/pdf/2508.09957v1](http://arxiv.org/pdf/2508.09957v1)**
...
- **简介: 论文评估大型语言模型在印度法律领域的作用，分析其在法律起草、问题发现等任务中的表现，发现LLM在特定场景下优于人类，但存在研究准确性不足的问题，强调人类专家在复杂推理中的不可替代性。**
...
- **链接: [http://arxiv.org/pdf/2508.09786v1](http://arxiv.org/pdf/2508.09786v1)**
...
- **链接: [http://arxiv.org/pdf/2508.09716v1](http://arxiv.org/pdf/2508.09716v1)**
...
- **链接: [http://arxiv.org/pdf/2508.09403v1](http://arxiv.org/pdf/2508.09403v1)**
...
>
---
#### [new 038] Sample More to Think Less: Group Filtered Policy Optimization for Concise Reasoning
- **分类: cs.CL; cs.LG**
...
- **简介: 论文提出多维度评估框架，系统比较LLM对齐技术，解决现有方法比较不足问题，通过实验验证有效性。**
...
- **简介: 该论文提出BigCharts-R1，通过构建真实图表数据集并结合强化学习优化模型，解决现有VLM在图表理解中的数据质量差和泛化能力不足问题，实现图表推理的突破。**
...
- **简介: 论文提出Contextual Integrity Verification（CIV）架构，通过加密签名与注意力掩码保障LLM推理安全，抵御提示注入攻击，实现零攻击成功率的同时保持高token相似度和模型性能，为轻量级安全加固提供方案。**
...
- **链接: [http://arxiv.org/pdf/2508.09294v1](http://arxiv.org/pdf/2508.09294v1)**
...
- **链接: [http://arxiv.org/pdf/2502.14910v3](http://arxiv.org/pdf/2502.14910v3)**
...
- **链接: [http://arxiv.org/pdf/2504.01137v2](http://arxiv.org/pdf/2504.01137v2)**
...
>
---
#### [replaced 009] Shifting Perspectives: Steering Vectors for Robust Bias Mitigation in LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.05371v2](http://arxiv.org/pdf/2503.05371v2)**
...
>
---
#### [replaced 010] Benchmarking LLMs' Mathematical Reasoning with Unseen Random Variables Questions
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.11790v4](http://arxiv.org/pdf/2501.11790v4)**
...
>
---
#### [replaced 011] Analyzing Finetuning Representation Shift for Multimodal LLMs Steering
...
>
---
#### [replaced 012] Exploring Scaling Laws for EHR Foundation Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.22964v2](http://arxiv.org/pdf/2505.22964v2)**
...
>
---
#### [replaced 015] Is Chain-of-Thought Reasoning of LLMs a Mirage? A Data Distribution Lens
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.01191v3](http://arxiv.org/pdf/2508.01191v3)**
...
>
---
#### [replaced 016] LogicCat: A Chain-of-Thought Text-to-SQL Benchmark for Complex Reasoning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.18744v2](http://arxiv.org/pdf/2505.18744v2)**
...
>
---
#### [replaced 020] DefenderBench: A Toolkit for Evaluating Language Agents in Cybersecurity Environments
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.00739v3](http://arxiv.org/pdf/2506.00739v3)**
...
>
---
#### [replaced 021] Memp: Exploring Agent Procedural Memory
- **分类: cs.CL; cs.AI; cs.LG; cs.MA**

- **链接: [http://arxiv.org/pdf/2508.06433v2](http://arxiv.org/pdf/2508.06433v2)**
...
>
---
#### [replaced 022] Rethinking Domain-Specific LLM Benchmark Construction: A Comprehensiveness-Compactness Approach
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.07353v2](http://arxiv.org/pdf/2508.07353v2)**
...
>
---
#### [replaced 025] ChineseHarm-Bench: A Chinese Harmful Content Detection Benchmark
- **分类: cs.CL; cs.AI; cs.CR; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.10960v3](http://arxiv.org/pdf/2506.10960v3)**
...
>
---
#### [replaced 026] Discrete Neural Algorithmic Reasoning
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2402.11628v3](http://arxiv.org/pdf/2402.11628v3)**

> **作者:** Gleb Rodionov; Liudmila Prokhorenkova
>
...
>
---
#### [replaced 027] Explaining Caption-Image Interactions in CLIP Models with Second-Order Attributions
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 028] MLLM-CBench:A Comprehensive Benchmark for Continual Instruction Tuning of Multimodal LLMs with Chain-of-Thought Reasoning Analysis
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.08275v2](http://arxiv.org/pdf/2508.08275v2)**
...
>
---
#### [replaced 029] A Survey on Parallel Text Generation: From Parallel Decoding to Diffusion Language Models
- **分类: cs.CL; cs.AI; cs.DC; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2508.08712v2](http://arxiv.org/pdf/2508.08712v2)**
...
>
---
#### [replaced 030] Beyond Memorization: Assessing Semantic Generalization in Large Language Models Using Phrasal Constructions
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.04661v2](http://arxiv.org/pdf/2501.04661v2)**
...
>
---
#### [replaced 031] Towards Safer Pretraining: Analyzing and Filtering Harmful Content in Webscale datasets for Responsible LLMs
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.02009v3](http://arxiv.org/pdf/2505.02009v3)**
...
>
---
#### [replaced 032] RocketKV: Accelerating Long-Context LLM Inference via Two-Stage KV Cache Compression
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.14051v3](http://arxiv.org/pdf/2502.14051v3)**
...
>
---
#### [replaced 033] Teaching Large Language Models to Maintain Contextual Faithfulness via Synthetic Tasks and Reinforcement Learning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.16483v2](http://arxiv.org/pdf/2505.16483v2)**
...
>
> **备注:** ACL 2025 Workshop KnowFM (Oral Presentation)
>
...
- **链接: [http://arxiv.org/pdf/2508.07976v2](http://arxiv.org/pdf/2508.07976v2)**
...
>
---
#### [replaced 035] Improving Multimodal Large Language Models Using Continual Learning
...
>
---
#### [replaced 036] Capabilities of GPT-5 on Multimodal Medical Reasoning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.08224v2](http://arxiv.org/pdf/2508.08224v2)**
...
>
---
#### [replaced 037] EmoVoice: LLM-based Emotional Text-To-Speech Model with Freestyle Text Prompting
- **分类: eess.AS; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2504.12867v4](http://arxiv.org/pdf/2504.12867v4)**
...
>
---
#### [replaced 038] GTPO and GRPO-S: Token and Sequence-Level Reward Shaping with Policy Entropy
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.04349v3](http://arxiv.org/pdf/2508.04349v3)**
...
>
---
#### [replaced 039] GTPO: Trajectory-Based Policy Optimization in Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.03772v2](http://arxiv.org/pdf/2508.03772v2)**
...
>
---
#### [replaced 040] LUMA: A Benchmark Dataset for Learning from Uncertain and Multimodal Data
...
>
---
#### [replaced 041] Leveraging Audio and Text Modalities in Mental Health: A Study of LLMs Performance
...
>
---
#### [replaced 042] Robo-Instruct: Simulator-Augmented Instruction Alignment For Finetuning Code LLMs
...
>
---
#### [replaced 043] Efficient Inference for Large Reasoning Models: A Survey
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.23077v3](http://arxiv.org/pdf/2503.23077v3)**
...
>
---
#### [replaced 045] FlexCTC: GPU-powered CTC Beam Decoding With Advanced Contextual Abilities
...
>
---
#### [replaced 046] InfoCausalQA:Can Models Perform Non-explicit Causal Reasoning Based on Infographic?
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.06220v2](http://arxiv.org/pdf/2508.06220v2)**
...
>
---
#### [replaced 049] MedRep: Medical Concept Representation for General Electronic Health Record Foundation Models
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.08329v2](http://arxiv.org/pdf/2504.08329v2)**
