...
- **简介: 该论文属于阿尔茨海默病诊断任务，旨在解决早期诊断效率低和模型能耗高的问题。提出FasterSNN模型，结合生物神经元与多尺度注意机制，提升诊断效率与稳定性。**
...
- **简介: 该论文属于建筑立面分割任务，旨在提升墙体和窗户的自动分割精度与泛化能力。通过多模态语义引导模型SAAF实现高效准确的分割。**
...
- **简介: 该论文属于多目标跟踪任务，解决单智能体感知不足的问题，通过图信号处理融合多车信息，提升跟踪精度。**
...
- **链接: [http://arxiv.org/pdf/2506.09066v1](http://arxiv.org/pdf/2506.09066v1)**
...
- **简介: 该论文属于医学视觉问答任务，旨在解决数据集临床复杂性和视觉多样性不足的问题。通过构建Kvasir-VQA-x1数据集，提升模型的推理能力和鲁棒性。**
...
- **链接: [http://arxiv.org/pdf/2506.09417v1](http://arxiv.org/pdf/2506.09417v1)**
...
- **简介: 该论文属于点云属性压缩任务，旨在提升概率估计精度。通过引入广义高斯熵模型和动态似然区间调整，优化了压缩性能。**
...
- **简介: 该论文属于自动驾驶任务，旨在解决恶劣条件下多模态大模型的链式推理评估问题。构建了AD^2-Bench基准，包含5.4k标注数据，用于提升模型的推理能力。**
...
- **简介: 该论文属于3D医学视觉-语言理解任务，旨在解决2D方法在3D解剖结构理解上的不足。提出HSENet框架，结合双3D编码器和空间打包器，提升诊断文本生成与问答性能。**
...
- **简介: 该论文属于远程感知图像描述任务，旨在解决模型计算成本高和忽略细粒度结构特征的问题。通过轻量Transformer和边缘感知策略提升性能。**
...
- **简介: 该论文属于4D内容生成任务，旨在解决高质量3D动画生成难题。提出AnimateAnyMesh框架，实现文本驱动的任意网格动画生成。**
...
- **简介: 该论文属于视频生成任务，旨在解决视频扩散模型微调中的语义一致性问题。提出CREPA方法，通过跨帧表示对齐提升视频质量与连贯性。**
...
- **简介: 该论文属于视频理解任务，旨在解决合成数据质量低的问题。通过姿态迁移生成高质量合成视频数据，提升动作识别性能并扩展少样本数据集。**
...
>
---
#### [new 047] Urban1960SatSeg: Unsupervised Semantic Segmentation of Mid-20$^{th}$ century Urban Landscapes with Satellite Imageries
- **分类: cs.CV**
...
- **简介: 该论文属于视觉语言模型的多模态推理任务，旨在解决空间推理能力不足的问题。通过引入绘图操作增强模型的空间理解与分析能力。**
...
- **简介: 该论文属于医疗视觉-语言模型安全任务，旨在解决模型对有害查询的防御问题。通过合成临床示例提升安全性，同时保持性能。**
...
- **简介: 该论文属于非接触式健康监测任务，旨在解决高海拔环境下日常护理中rPPG的稳定性问题，通过构建数据集并融合RGB与IR视频提升监测精度。**
...
- **链接: [http://arxiv.org/pdf/2506.09784v1](http://arxiv.org/pdf/2506.09784v1)**
...
- **简介: 该论文属于微表情识别任务，旨在解决微表情持续时间短、强度低导致的识别难题。通过多先验融合网络和渐进式训练策略提升识别准确率。**
...
- **简介: 该论文属于多模态行人重识别任务，旨在解决单一模型处理多种查询模态的问题。工作包括构建OR-Bench数据集和提出ReID5o框架。**
...
- **简介: 该论文属于无监督域适应任务，解决医学图像分割中目标域标签缺失的问题。提出SRPL-SFDA方法，通过SAM生成可靠伪标签提升分割性能。**
...
>
---
#### [new 066] Seedance 1.0: Exploring the Boundaries of Video Generation Models
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决模型在指令遵循、运动合理性与视觉质量间的平衡问题。提出Seedance 1.0，通过多源数据、高效架构和优化训练提升生成质量与速度。**

- **链接: [http://arxiv.org/pdf/2506.09113v1](http://arxiv.org/pdf/2506.09113v1)**
...
>
---
#### [new 067] Inverting Black-Box Face Recognition Systems via Zero-Order Optimization in Eigenface Space
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于模型逆向任务，旨在仅通过相似度分数重建人脸图像。工作是提出DarkerBB方法，在PCA特征空间中进行零阶优化，实现高效高精度的图像重建。**

- **链接: [http://arxiv.org/pdf/2506.09777v1](http://arxiv.org/pdf/2506.09777v1)**

> **作者:** Anton Razzhigaev; Matvey Mikhalchuk; Klim Kireev; Igor Udovichenko; Andrey Kuznetsov; Aleksandr Petiushko
>
> **摘要:** Reconstructing facial images from black-box recognition models poses a significant privacy threat. While many methods require access to embeddings, we address the more challenging scenario of model inversion using only similarity scores. This paper introduces DarkerBB, a novel approach that reconstructs color faces by performing zero-order optimization within a PCA-derived eigenface space. Despite this highly limited information, experiments on LFW, AgeDB-30, and CFP-FP benchmarks demonstrate that DarkerBB achieves state-of-the-art verification accuracies in the similarity-only setting, with competitive query efficiency.
>
---
#### [new 068] HAIF-GS: Hierarchical and Induced Flow-Guided Gaussian Splatting for Dynamic Scene
- **分类: cs.CV**

- **简介: 该论文属于动态3D场景重建任务，解决动态场景中3D高斯点云的结构化与时间一致性问题。通过引入锚点驱动的变形机制提升重建质量与效率。**

- **链接: [http://arxiv.org/pdf/2506.09518v1](http://arxiv.org/pdf/2506.09518v1)**
...
>
---
#### [new 072] CheckManual: A New Challenge and Benchmark for Manual-based Appliance Manipulation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 073] HadaNorm: Diffusion Transformer Quantization through Mean-Centered Transformations
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于模型压缩任务，旨在解决扩散模型在资源受限设备上的部署问题。通过提出HadaNorm方法，有效降低量化误差，提升压缩效率。**

- **链接: [http://arxiv.org/pdf/2506.09932v1](http://arxiv.org/pdf/2506.09932v1)**
...
>
---
#### [new 077] Reasoning Models Are More Easily Gaslighted Than You Think
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于模型鲁棒性研究，探讨推理模型在面对误导性输入时的脆弱性。通过实验和新基准测试，揭示顶级模型在保持正确答案上的不足。**

- **链接: [http://arxiv.org/pdf/2506.09677v1](http://arxiv.org/pdf/2506.09677v1)**
...
>
---
#### [new 078] Text-Aware Image Restoration with Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于图像修复任务，旨在解决文本区域修复中的误生成问题。提出TAIR方法和SA-Text数据集，提升文本恢复准确性。**

- **链接: [http://arxiv.org/pdf/2506.09993v1](http://arxiv.org/pdf/2506.09993v1)**
...
>
---
#### [new 079] PlayerOne: Egocentric World Simulator
- **分类: cs.CV**

- **简介: 该论文提出PlayerOne，属于 egocentric 世界模拟任务，解决真实场景下人体动作与环境一致的视频生成问题。通过多阶段训练和运动注入机制实现精准控制与场景一致性。**

- **链接: [http://arxiv.org/pdf/2506.09995v1](http://arxiv.org/pdf/2506.09995v1)**
...
>
---
#### [new 080] CausalVQA: A Physically Grounded Causal Reasoning Benchmark for Video Models
- **分类: cs.CV; cs.AI; I.2.10; I.4.8**

- **简介: 该论文提出CausalVQA，一个用于视频问答的因果推理基准，解决视频理解中因果关系的问题。通过五类问题评估模型对物理世界的理解与预测能力。**

- **链接: [http://arxiv.org/pdf/2506.09943v1](http://arxiv.org/pdf/2506.09943v1)**
...
>
---
#### [new 082] DGAE: Diffusion-Guided Autoencoder for Efficient Latent Representation Learning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像生成任务，旨在解决高压缩下自动编码器的稳定性与效率问题。提出DGAE，利用扩散模型提升解码器性能，实现更小的潜在空间和更好效果。**

- **链接: [http://arxiv.org/pdf/2506.09644v1](http://arxiv.org/pdf/2506.09644v1)**
...
>
---
#### [new 088] Marrying Autoregressive Transformer and Diffusion with Multi-Reference Autoregression
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在结合自回归Transformer与扩散模型。通过提出TransDiff框架及MRAR方法，提升生成质量与速度。**

- **链接: [http://arxiv.org/pdf/2506.09482v1](http://arxiv.org/pdf/2506.09482v1)**
...
>
---
#### [new 089] Vectorized Region Based Brush Strokes for Artistic Rendering
- **分类: cs.CV; I.3.3; I.5**

- **简介: 该论文属于艺术渲染任务，旨在解决生成符合艺术原则的笔触组合问题。通过语义引导和参数计算，实现高质量的区域化绘画生成。**

- **链接: [http://arxiv.org/pdf/2506.09969v1](http://arxiv.org/pdf/2506.09969v1)**

> **作者:** Jeripothula Prudviraj; Vikram Jamwal
>
> **摘要:** Creating a stroke-by-stroke evolution process of a visual artwork tries to bridge the emotional and educational gap between the finished static artwork and its creation process. Recent stroke-based painting systems focus on capturing stroke details by predicting and iteratively refining stroke parameters to maximize the similarity between the input image and the rendered output. However, these methods often struggle to produce stroke compositions that align with artistic principles and intent. To address this, we explore an image-to-painting method that (i) facilitates semantic guidance for brush strokes in targeted regions, (ii) computes the brush stroke parameters, and (iii) establishes a sequence among segments and strokes to sequentially render the final painting. Experimental results on various input image types, such as face images, paintings, and photographic images, show that our method aligns with a region-based painting strategy while rendering a painting with high fidelity and superior stroke quality.
>
---
#### [new 090] Hearing Hands: Generating Sounds from Physical Interactions in 3D Scenes
- **分类: cs.CV**

- **简介: 该论文属于音频生成任务，旨在预测人手与3D场景交互时产生的声音。通过训练模型将手部动作映射到音频，实现交互式声音生成。**

- **链接: [http://arxiv.org/pdf/2506.09989v1](http://arxiv.org/pdf/2506.09989v1)**
...
>
---
#### [new 093] FlagEvalMM: A Flexible Framework for Comprehensive Multimodal Model Evaluation
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 094] AngleRoCL: Angle-Robust Concept Learning for Physically View-Invariant T2I Adversarial Patches
- **分类: cs.CV**

- **简介: 该论文属于目标检测防御任务，解决T2I生成对抗补丁在不同视角下的鲁棒性问题。提出AngleRoCL方法提升补丁的视角鲁棒性。**

- **链接: [http://arxiv.org/pdf/2506.09538v1](http://arxiv.org/pdf/2506.09538v1)**
...
>
---
#### [new 097] CHIP: A multi-sensor dataset for 6D pose estimation of chairs in industrial settings
- **分类: cs.CV**

- **简介: 该论文提出CHIP数据集，用于工业场景下椅子的6D位姿估计，解决真实工业环境中位姿估计方法评估不足的问题。**

- **链接: [http://arxiv.org/pdf/2506.09699v1](http://arxiv.org/pdf/2506.09699v1)**
...
>
---
#### [new 100] Consistent Story Generation with Asymmetry Zigzag Sampling
- **分类: cs.CV**

- **简介: 该论文属于视觉故事生成任务，旨在解决多图间主体一致性问题。提出一种无需训练的zigzag采样策略，通过异构提示和视觉共享提升连贯性。**

- **链接: [http://arxiv.org/pdf/2506.09612v1](http://arxiv.org/pdf/2506.09612v1)**
...
>
---
#### [new 101] A High-Quality Dataset and Reliable Evaluation for Interleaved Image-Text Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态生成任务，旨在解决现有数据集质量不足导致的图像文本交错生成问题。提出InterSyn数据集和SynJudge评估模型，提升生成质量与评估可靠性。**

- **链接: [http://arxiv.org/pdf/2506.09427v1](http://arxiv.org/pdf/2506.09427v1)**
...
>
---
#### [new 104] AtmosMJ: Revisiting Gating Mechanism for AI Weather Forecasting Beyond the Year Scale
- **分类: cs.LG; cs.AI; cs.CV; physics.ao-ph**

- **简介: 该论文属于天气预报任务，旨在解决长期稳定预测难题。通过提出AtmosMJ模型，在标准经纬度网格上实现500天稳定预报，验证了高效架构设计的重要性。**

- **链接: [http://arxiv.org/pdf/2506.09733v1](http://arxiv.org/pdf/2506.09733v1)**
...
>
---
#### [new 105] DCIRNet: Depth Completion with Iterative Refinement for Dexterous Grasping of Transparent and Reflective Objects
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 106] From Intention to Execution: Probing the Generalization Boundaries of Vision-Language-Action Models
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 107] Fluoroscopic Shape and Pose Tracking of Catheters with Custom Radiopaque Markers
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 108] LPO: Towards Accurate GUI Agent Interaction via Location Preference Optimization
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于GUI交互任务，旨在解决空间定位不准确的问题。提出LPO方法，通过位置偏好优化提升交互精度。**

- **链接: [http://arxiv.org/pdf/2506.09373v1](http://arxiv.org/pdf/2506.09373v1)**
...
>
---
#### [new 109] The RSNA Lumbar Degenerative Imaging Spine Classification (LumbarDISC) Dataset
- **分类: eess.IV; cs.CV**

- **简介: 该论文介绍了一个用于腰椎退行性病变分类的公开数据集，旨在促进医学影像与机器学习研究，提升临床效率。**

- **链接: [http://arxiv.org/pdf/2506.09162v1](http://arxiv.org/pdf/2506.09162v1)**
...
>
---
#### [new 111] Low-Rank Augmented Implicit Neural Representation for Unsupervised High-Dimensional Quantitative MRI Reconstruction
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学影像重建任务，旨在解决高维qMRI快速重建问题。通过引入低秩和连续先验，提出LoREIN框架提升重建精度与效率。**

- **链接: [http://arxiv.org/pdf/2506.09100v1](http://arxiv.org/pdf/2506.09100v1)**
...
>
---
#### [new 112] Exploring Image Transforms derived from Eye Gaze Variables for Progressive Autism Diagnosis
- **分类: eess.IV; cs.AI; cs.CV; cs.HC; cs.LG**

- **简介: 该论文属于 Autism Diagnosis 任务，旨在解决传统诊断方法耗时且成本高的问题。通过结合迁移学习与眼动图像变换，提出一种高效、隐私保护的 ASD 诊断方法。**

- **链接: [http://arxiv.org/pdf/2506.09065v1](http://arxiv.org/pdf/2506.09065v1)**
...
>
---
#### [new 115] Foundation Models in Medical Imaging -- A Review and Outlook
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学影像领域，探讨基础模型在病理学、放射学和眼科中的应用，解决如何利用无标签数据提升模型性能的问题，综述了模型架构、自监督学习及适应策略。**

- **链接: [http://arxiv.org/pdf/2506.09095v1](http://arxiv.org/pdf/2506.09095v1)**
...
>
---
#### [new 116] An Explainable Deep Learning Framework for Brain Stroke and Tumor Progression via MRI Interpretation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在早期检测脑肿瘤和中风。通过深度学习模型分析MRI图像，实现准确诊断与分期。**

- **链接: [http://arxiv.org/pdf/2506.09161v1](http://arxiv.org/pdf/2506.09161v1)**
...
>
---
#### [new 119] DAVSP: Safety Alignment for Large Vision-Language Models via Deep Aligned Visual Safety Prompt
- **分类: cs.CR; cs.CV**

- **简介: 该论文属于视觉语言模型安全对齐任务，旨在抵御恶意查询同时保持正常输入性能。提出DAVSP方法，通过视觉安全提示和深度对齐技术提升模型安全性。**

- **链接: [http://arxiv.org/pdf/2506.09353v1](http://arxiv.org/pdf/2506.09353v1)**
...
>
---
#### [new 120] WD-DETR: Wavelet Denoising-Enhanced Real-Time Object Detection Transformer for Robot Perception with Event Cameras
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 121] Athena: Enhancing Multimodal Reasoning with Data-efficient Process Reward Models
...
>
---
#### [new 122] V-JEPA 2: Self-Supervised Video Models Enable Understanding, Prediction and Planning
...
>
---
#### [new 123] Perception Characteristics Distance: Measuring Stability and Robustness of Perception System in Dynamic Conditions under a Certain Decision Rule
...
>
---
#### [new 124] UAD: Unsupervised Affordance Distillation for Generalization in Robotic Manipulation
...
>
---
#### [new 125] VideoMat: Extracting PBR Materials from Video Diffusion Models
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于材质生成任务，旨在从文本或图像生成高质量PBR材质。通过视频扩散模型和渲染技术，提取并优化材质属性以兼容3D工具。**

- **链接: [http://arxiv.org/pdf/2506.09665v1](http://arxiv.org/pdf/2506.09665v1)**
...
>
> **摘要:** We introduce the Deformable Gaussian Splats Large Reconstruction Model (DGS-LRM), the first feed-forward method predicting deformable 3D Gaussian splats from a monocular posed video of any dynamic scene. Feed-forward scene reconstruction has gained significant attention for its ability to rapidly create digital replicas of real-world environments. However, most existing models are limited to static scenes and fail to reconstruct the motion of moving objects. Developing a feed-forward model for dynamic scene reconstruction poses significant challenges, including the scarcity of training data and the need for appropriate 3D representations and training paradigms. To address these challenges, we introduce several key technical contributions: an enhanced large-scale synthetic dataset with ground-truth multi-view videos and dense 3D scene flow supervision; a per-pixel deformable 3D Gaussian representation that is easy to learn, supports high-quality dynamic view synthesis, and enables long-range 3D tracking; and a large transformer network that achieves real-time, generalizable dynamic scene reconstruction. Extensive qualitative and quantitative experiments demonstrate that DGS-LRM achieves dynamic scene reconstruction quality comparable to optimization-based methods, while significantly outperforming the state-of-the-art predictive dynamic reconstruction method on real-world examples. Its predicted physically grounded 3D deformation is accurate and can readily adapt for long-range 3D tracking tasks, achieving performance on par with state-of-the-art monocular video 3D tracking methods.
>
---
#### [new 131] A Cytology Dataset for Early Detection of Oral Squamous Cell Carcinoma
- **分类: eess.IV; cs.CV; q-bio.TO**

- **简介: 该论文属于医学图像分析任务，旨在解决口腔鳞状细胞癌早期检测问题。通过构建首个大规模多中心口腔细胞学数据集，推动AI辅助诊断发展。**

- **链接: [http://arxiv.org/pdf/2506.09661v1](http://arxiv.org/pdf/2506.09661v1)**
...
>
---
#### [new 132] SILK: Smooth InterpoLation frameworK for motion in-betweening A Simplified Computational Approach
- **分类: cs.GR; cs.CV; cs.LG**

- **简介: 该论文属于运动插值任务，旨在简化动画生成过程。提出一种基于Transformer的框架，通过数据优化提升插值效果，减少模型复杂度。**

- **链接: [http://arxiv.org/pdf/2506.09075v1](http://arxiv.org/pdf/2506.09075v1)**
...
>
---
#### [new 135] Enhancing Human-Robot Collaboration: A Sim2Real Domain Adaptation Algorithm for Point Cloud Segmentation in Industrial Environments
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 004] ByteMorph: Benchmarking Instruction-Guided Image Editing with Non-Rigid Motions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03107v2](http://arxiv.org/pdf/2506.03107v2)**
...
>
---
#### [replaced 010] GIQ: Benchmarking 3D Geometric Reasoning of Vision Foundation Models with Simulated and Real Polyhedra
- **分类: cs.CV; 68T45; I.5.4; I.2.10; I.3.5**

- **链接: [http://arxiv.org/pdf/2506.08194v2](http://arxiv.org/pdf/2506.08194v2)**
...
>
---
#### [replaced 013] ClimateViz: A Benchmark for Statistical Reasoning and Fact Verification on Scientific Charts
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 014] ContentV: Efficient Training of Video Generation Models with Limited Compute
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05343v2](http://arxiv.org/pdf/2506.05343v2)**
...
>
---
#### [replaced 015] Vision Transformers Don't Need Trained Registers
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.08010v2](http://arxiv.org/pdf/2506.08010v2)**
...
>
---
#### [replaced 019] HRTR: A Single-stage Transformer for Fine-grained Sub-second Action Segmentation in Stroke Rehabilitation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.02472v2](http://arxiv.org/pdf/2506.02472v2)**
...
>
---
#### [replaced 020] SkipVAR: Accelerating Visual Autoregressive Modeling via Adaptive Frequency-Aware Skipping
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08908v2](http://arxiv.org/pdf/2506.08908v2)**
...
>
---
#### [replaced 021] MVTamperBench: Evaluating Robustness of Vision-Language Models
- **分类: cs.CV; 68T37, 68T05, 68Q32, 68T45, 94A08, 68T40, 68Q85; I.2.10; I.2.7; I.5.4; I.4.9; I.4.8; H.5.1**

- **链接: [http://arxiv.org/pdf/2412.19794v5](http://arxiv.org/pdf/2412.19794v5)**
...
>
---
#### [replaced 024] ImageChain: Advancing Sequential Image-to-Text Reasoning in Multimodal Large Language Models
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 025] ReSpace: Text-Driven 3D Scene Synthesis and Editing with Preference Alignment
- **分类: cs.CV; I.2.10; I.2.7**

- **链接: [http://arxiv.org/pdf/2506.02459v2](http://arxiv.org/pdf/2506.02459v2)**
...
>
---
#### [replaced 030] Zero-Shot Temporal Interaction Localization for Egocentric Videos
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 033] Unseen Visual Anomaly Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2406.01078v4](http://arxiv.org/pdf/2406.01078v4)**

> **作者:** Han Sun; Yunkang Cao; Hao Dong; Olga Fink
>
> **备注:** 8 pages excluding supplementary
>
...
>
---
#### [replaced 037] EMMA: Efficient Visual Alignment in Multi-Modal LLMs
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 038] SpikeSMOKE: Spiking Neural Networks for Monocular 3D Object Detection with Cross-Scale Gated Coding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07737v2](http://arxiv.org/pdf/2506.07737v2)**
...
>
---
#### [replaced 039] Diffusion-based Adversarial Purification from the Perspective of the Frequency Domain
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.01267v3](http://arxiv.org/pdf/2505.01267v3)**
...
>
---
#### [replaced 040] RecipeGen: A Step-Aligned Multimodal Benchmark for Real-World Recipe Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.06733v3](http://arxiv.org/pdf/2506.06733v3)**
...
>
---
#### [replaced 043] TSVC:Tripartite Learning with Semantic Variation Consistency for Robust Image-Text Retrieval
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.10935v2](http://arxiv.org/pdf/2501.10935v2)**
...
>
---
#### [replaced 045] Human-like object concept representations emerge naturally in multimodal large language models
...
>
---
#### [replaced 049] Enhancing Low-Cost Video Editing with Lightweight Adaptors and Temporal-Aware Inversion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.04606v4](http://arxiv.org/pdf/2501.04606v4)**

> **作者:** Yangfan He; Sida Li; Jianhui Wang; Kun Li; Xinyuan Song; Xinhang Yuan; Keqin Li; Kuan Lu; Menghao Huo; Jingqun Tang; Yi Xin; Jiaqi Chen; Miao Zhang; Xueqian Wang
>
> **摘要:** Recent advancements in text-to-image (T2I) generation using diffusion models have enabled cost-effective video-editing applications by leveraging pre-trained models, eliminating the need for resource-intensive training. However, the frame-independence of T2I generation often results in poor temporal consistency. Existing methods address this issue through temporal layer fine-tuning or inference-based temporal propagation, but these approaches suffer from high training costs or limited temporal coherence. To address these challenges, we propose a General and Efficient Adapter (GE-Adapter) that integrates temporal-spatial and semantic consistency with Baliteral DDIM inversion. This framework introduces three key components: (1) Frame-based Temporal Consistency Blocks (FTC Blocks) to capture frame-specific features and enforce smooth inter-frame transitions via temporally-aware loss functions; (2) Channel-dependent Spatial Consistency Blocks (SCD Blocks) employing bilateral filters to enhance spatial coherence by reducing noise and artifacts; and (3) Token-based Semantic Consistency Module (TSC Module) to maintain semantic alignment using shared prompt tokens and frame-specific tokens. Our method significantly improves perceptual quality, text-image alignment, and temporal coherence, as demonstrated on the MSR-VTT dataset. Additionally, it achieves enhanced fidelity and frame-to-frame coherence, offering a practical solution for T2V editing.
>
---
#### [replaced 050] Question-Aware Gaussian Experts for Audio-Visual Question Answering
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.04459v3](http://arxiv.org/pdf/2503.04459v3)**

> **作者:** Hongyeob Kim; Inyoung Jung; Dayoon Suh; Youjia Zhang; Sangmin Lee; Sungeun Hong
>
> **备注:** CVPR 2025. Code is available at https://github.com/AIM-SKKU/QA-TIGER
>
...
>
---
#### [replaced 051] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
- **分类: cs.CV; 68U05 (Primary) 68T45 (Secondary); I.3.3; I.3.7; I.3.5**

- **链接: [http://arxiv.org/pdf/2408.12894v2](http://arxiv.org/pdf/2408.12894v2)**

> **作者:** Yunji Seo; Young Sun Choi; Hyun Seung Son; Youngjung Uh
>
> **备注:** Project page: https://3dgs-flod.github.io/flod/
>
...
>
---
#### [replaced 052] Toward Reliable AR-Guided Surgical Navigation: Interactive Deformation Modeling with Data-Driven Biomechanics and Prompts
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 055] The Efficacy of Semantics-Preserving Transformations in Self-Supervised Learning for Medical Ultrasound
- **分类: eess.IV; cs.CV; cs.LG; I.2.10; I.4.9; J.3**

- **链接: [http://arxiv.org/pdf/2504.07904v2](http://arxiv.org/pdf/2504.07904v2)**
...
>
---
#### [replaced 061] Do Multiple Instance Learning Models Transfer?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.09022v2](http://arxiv.org/pdf/2506.09022v2)**
...
>
---
#### [replaced 062] Video2BEV: Transforming Drone Videos to BEVs for Video-based Geo-localization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.13610v3](http://arxiv.org/pdf/2411.13610v3)**
...
>
---
#### [replaced 063] MedChat: A Multi-Agent Framework for Multimodal Diagnosis with Large Language Models
- **分类: cs.MA; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.07400v2](http://arxiv.org/pdf/2506.07400v2)**

> **作者:** Philip R. Liu; Sparsh Bansal; Jimmy Dinh; Aditya Pawar; Ramani Satishkumar; Shail Desai; Neeraj Gupta; Xin Wang; Shu Hu
>
> **备注:** 7 pages, 6 figures. Accepted to the 2025 IEEE 8th International Conference on Multimedia Information Processing and Retrieval (MIPR)
>
...
>
---
#### [replaced 064] Rethinking Cross-Modal Interaction in Multimodal Diffusion Transformers
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07986v2](http://arxiv.org/pdf/2506.07986v2)**

> **作者:** Zhengyao Lv; Tianlin Pan; Chenyang Si; Zhaoxi Chen; Wangmeng Zuo; Ziwei Liu; Kwan-Yee K. Wong
>
> **备注:** Project Page: https://vchitect.github.io/TACA/
>
...
>
---
#### [replaced 065] Geometric deep learning for local growth prediction on abdominal aortic aneurysm surfaces
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.08729v2](http://arxiv.org/pdf/2506.08729v2)**
...
>
---
#### [replaced 068] Do Large Vision-Language Models Distinguish between the Actual and Apparent Features of Illusions?
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 072] Decoupling the Image Perception and Multimodal Reasoning for Reasoning Segmentation with Digital Twin Representations
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.07943v2](http://arxiv.org/pdf/2506.07943v2)**

> **作者:** Yizhen Li; Dell Zhang; Xuelong Li; Yiqing Shen
>
> **备注:** This work was submitted without the consent of all co-authors. We request withdrawal until all parties agree
>
...
>
---
#### [replaced 073] Technical Report for Ego4D Long-Term Action Anticipation Challenge 2025
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.02550v2](http://arxiv.org/pdf/2506.02550v2)**
...
>
---
#### [replaced 074] DeepMultiConnectome: Deep Multi-Task Prediction of Structural Connectomes Directly from Diffusion MRI Tractography
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.22685v2](http://arxiv.org/pdf/2505.22685v2)**

> **作者:** Marcus J. Vroemen; Yuqian Chen; Yui Lo; Tengfei Xue; Weidong Cai; Fan Zhang; Josien P. W. Pluim; Lauren J. O'Donnell
>
...
>
---
#### [replaced 075] Towards a Sampling Theory for Implicit Neural Representations
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2405.18410v2](http://arxiv.org/pdf/2405.18410v2)**

> **作者:** Mahrokh Najaf; Gregory Ongie
>
> **备注:** IEEE Asilomar 2024
>
...
>
> **摘要:** Artificial intelligence (AI) has become a fundamental tool for assisting clinicians in analyzing ophthalmic images, such as optical coherence tomography (OCT). However, developing AI models often requires extensive annotation, and existing models tend to underperform on independent, unseen data. Foundation models (FMs), large AI models trained on vast unlabeled datasets, have shown promise in overcoming these challenges. Nonetheless, available FMs for ophthalmology lack extensive validation, especially for segmentation tasks, and focus on a single imaging modality. In this context, we propose MIRAGE, a novel multimodal FM for the analysis of OCT and scanning laser ophthalmoscopy (SLO) images. Additionally, we propose a new evaluation benchmark with OCT/SLO classification and segmentation tasks. The comparison with general and specialized FMs and segmentation methods shows the superiority of MIRAGE in both types of tasks, highlighting its suitability as a basis for the development of robust AI systems for retinal OCT image analysis. Both MIRAGE and the evaluation benchmark are publicly available: https://github.com/j-morano/MIRAGE.
>
---
#### [replaced 078] Genesis: Multimodal Driving Scene Generation with Spatio-Temporal and Cross-Modal Consistency
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07497v2](http://arxiv.org/pdf/2506.07497v2)**
...
>
---
#### [replaced 079] Using Shapley interactions to understand how models use structure
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 087] Video-CoT: A Comprehensive Dataset for Spatiotemporal Understanding of Videos Based on Chain-of-Thought
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08817v2](http://arxiv.org/pdf/2506.08817v2)**
