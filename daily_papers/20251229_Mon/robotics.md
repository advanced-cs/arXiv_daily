...
>
---
#### [new 012] Aerial World Model for Long-horizon Visual Generation and Navigation in 3D Space
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于无人机导航任务，解决长距离视觉生成与导航中缺乏语义理解的问题。提出ANWM模型，通过预测未来视觉并结合语义评估轨迹，提升导航成功率。**

- **链接: [https://arxiv.org/pdf/2512.21887v1](https://arxiv.org/pdf/2512.21887v1)**
...
>
---
#### [new 013] HELP: Hierarchical Embodied Language Planner for Household Tasks
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属于家庭任务规划领域，解决复杂场景下语言指令的执行问题。提出HELP架构，利用LLM分层处理子任务，提升规划能力，并进行实际测试。**

- **链接: [https://arxiv.org/pdf/2512.21723v1](https://arxiv.org/pdf/2512.21723v1)**
...
>
---
#### [new 020] SymDrive: Realistic and Controllable Driving Simulator via Symmetric Auto-regressive Online Restoration
- **分类: cs.CV; cs.RO**
...
#### [replaced 001] RoboCade: Gamifying Robot Data Collection
- **分类: cs.RO**

- **简介: 该论文提出RoboCade平台，通过游戏化方式解决机器人数据收集成本高、参与度低的问题，提升数据规模与质量。**

- **链接: [https://arxiv.org/pdf/2512.21235v2](https://arxiv.org/pdf/2512.21235v2)**
...
>
---
#### [replaced 002] How Robot Dogs See the Unseeable: Improving Visual Interpretability via Peering for Exploratory Robots
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 003] Think, Act, Learn: A Framework for Autonomous Robotic Agents using Closed-Loop Large Language Models
- **分类: cs.RO; cs.HC**

- **简介: 该论文提出T-A-L框架，解决机器人在动态环境中任务规划适应性差的问题。通过闭环机制，使机器人自主学习并优化策略，提升任务成功率和泛化能力。**

- **链接: [https://arxiv.org/pdf/2507.19854v2](https://arxiv.org/pdf/2507.19854v2)**
...
>
---
#### [replaced 004] Research on Dead Reckoning Algorithm for Self-Propelled Pipeline Robots in Three-Dimensional Complex Pipelines
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于管道定位任务，旨在解决复杂管道中传统定位方法失效的问题。通过设计自推进机器人，结合惯性导航与轮式里程计，利用扩展卡尔曼滤波提高定位精度。**

- **链接: [https://arxiv.org/pdf/2512.17215v2](https://arxiv.org/pdf/2512.17215v2)**

> **作者:** Yan Gao; Jiliang Wang; Minghan Wang; Xiaohua Chen; Demin Chen; Zhiyong Ren; Tian-Yun Huang
>
> **备注:** The paper needs further revision
>
...
>
---
#### [replaced 007] Design and Research of a Self-Propelled Pipeline Robot Based on Force Analysis and Dynamic Simulation
- **分类: cs.RO**

- **简介: 该论文属于管道机器人设计任务，旨在解决传统机器人爬升失败和通过性差的问题。通过力分析与动态仿真优化设计，实现复杂管道的稳定运行。**

- **链接: [https://arxiv.org/pdf/2512.17212v2](https://arxiv.org/pdf/2512.17212v2)**

> **作者:** Yan Gao; Jiliang Wang; Ming Cheng; Tianyun Huang
>
> **备注:** The article needs further revision
>
...
>
---
#### [replaced 008] LIBERO-Plus: In-depth Robustness Analysis of Vision-Language-Action Models
...
>
---
#### [replaced 009] Super-LIO: A Robust and Efficient LiDAR-Inertial Odometry System with a Compact Mapping Strategy
- **分类: cs.RO**

- **简介: 该论文属于LiDAR-Inertial Odometry任务，旨在解决资源受限平台上的高效精准定位问题。提出Super-LIO系统，采用紧凑的OctVox地图结构和HKNN策略，提升计算效率与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2509.05723v2](https://arxiv.org/pdf/2509.05723v2)**
...
>
---
#### [replaced 010] FAR-AVIO: Fast and Robust Schur-Complement Based Acoustic-Visual-Inertial Fusion Odometry with Sensor Calibration
- **分类: cs.RO**

- **简介: 该论文属于水下定位任务，解决视觉-惯性里程计在复杂环境下的精度与实时性问题。提出FAR-AVIO框架，结合声学信息，提升定位准确性和计算效率。**

- **链接: [https://arxiv.org/pdf/2512.20355v2](https://arxiv.org/pdf/2512.20355v2)**
...
>
---
#### [replaced 011] Transformer Driven Visual Servoing for Fabric Texture Matching Using Dual-Arm Manipulator
- **分类: cs.RO**

- **简介: 该论文属于视觉伺服任务，旨在解决双臂机械臂对布料纹理匹配的精准对齐问题。通过结合Transformer和阻抗控制，实现布料的精确放置与展平。**

- **链接: [https://arxiv.org/pdf/2511.21203v4](https://arxiv.org/pdf/2511.21203v4)**
...
>
---
#### [replaced 012] Motus: A Unified Latent Action World Model
...
>
---
#### [replaced 013] Compliant Residual DAgger: Improving Real-World Contact-Rich Manipulation with Human Corrections
- **分类: cs.RO; cs.LG**

- **简介: 该论文属于机器人操控任务，解决真实世界中高接触操作的DAgger方法问题。提出CR-DAgger，通过人类修正提升策略性能，显著提高成功率。**

- **链接: [https://arxiv.org/pdf/2506.16685v5](https://arxiv.org/pdf/2506.16685v5)**

> **作者:** Xiaomeng Xu; Yifan Hou; Chendong Xin; Zeyi Liu; Shuran Song
>
...
>
---
#### [replaced 014] UniTacHand: Unified Spatio-Tactile Representation for Human to Robotic Hand Skill Transfer
- **分类: cs.RO**

- **简介: 该论文属于机器人技能迁移任务，解决人类与机器人触觉数据不匹配的问题。通过统一的触觉表示，实现人类到机器人的零样本触觉策略迁移。**

- **链接: [https://arxiv.org/pdf/2512.21233v2](https://arxiv.org/pdf/2512.21233v2)**
...
>
---
#### [replaced 015] RoboSafe: Safeguarding Embodied Agents via Executable Safety Logic
...
>
---
#### [replaced 016] Learning collision risk proactively from naturalistic driving data at scale
- **分类: cs.RO; cs.LG**

- **简介: 该论文属于交通事故预警任务，旨在主动识别潜在碰撞风险。通过分析真实驾驶数据，提出GSSM模型，无需标注即可准确预测碰撞，提升自动驾驶安全性。**

- **链接: [https://arxiv.org/pdf/2505.13556v4](https://arxiv.org/pdf/2505.13556v4)**

> **作者:** Yiru Jiao; Simeon C. Calvert; Sander van Cranenburgh; Hans van Lint
>
> **备注:** Equation (15) in the previous versions was wrong, which has been corrected since v4
>
...
>
---
#### [replaced 017] Planar Juggling of a Devil-Stick using Discrete VHCs
- **分类: eess.SY; cs.RO**

- **简介: 该论文研究平面玩火棍的稳定杂技问题，通过离散虚拟完整约束设计控制策略，实现稳定控制。属于控制工程领域，解决杂技动作的稳定性问题。**

- **链接: [https://arxiv.org/pdf/2509.08085v2](https://arxiv.org/pdf/2509.08085v2)**

> **作者:** Aakash Khandelwal; Ranjan Mukherjee
>
> **备注:** 9 pages, 7 figures; this is an extended version of the article published in the IEEE Control Systems Letters
>
