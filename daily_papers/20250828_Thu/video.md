...
>
---
#### [new 005] Controllable Skin Synthesis via Lesion-Focused Vector Autoregression Model
- **分类: cs.CV**
...
- **简介: 该论文针对协同感知中BEV丢失3D结构信息的问题，提出点级token和CoPLOT框架，通过语义排序、频率增强模型和邻到自对齐，优化结构信息保留与跨代理协作，实验证明效果更优。**
...
- **简介: 本文针对多目标光纤光谱处理中的天空背景减法问题，提出基于互信息网络的SMI模型，利用所有纤维光谱数据，通过特征提取与增量训练网络，有效建模环境，提升蓝端背景估计精度，并在LAMOST上验证。**
...
- **简介: 该论文针对长尾视觉识别中的类别难度差异问题，提出DQRoute框架，通过难度感知优化与动态专家融合，结合自适应损失加权和分布式路由，提升稀有难类性能。**
...
- **简介: 该论文解决未剪裁体育视频中快速微妙动作转换的细粒度定位问题，提出基于图神经网络的无监督方法，预训练ASTGCN并设计ADM指标，实现高效准确的动作边界检测，适用于实时嵌入式系统。**
...
- **简介: 该论文针对文本引导的运动生成任务，解决语言描述与运动语义对齐不足及生成效率低的问题，提出TAPO框架与MotionFLUX模型，通过偏好优化和高效流匹配实现高质量实时运动合成。**
...
- **简介: 图像去噪任务，解决泛化能力不足问题，提出迭代动态滤波网络，动态生成内核，提升效果与效率。**
...
- **简介: 论文提出CVBench，用于评估多模态模型跨视频推理能力，解决现有模型在跨视频场景下表现不足的问题，通过三层次任务和多模型测试揭示了模型在上下文保留与实体歧义处理上的瓶颈。**
...
- **简介: 该论文旨在通过整合心脏MRI影像与电子健康记录，提升MACE生存预测的准确性与可解释性。PRISM框架利用自监督学习提取时空视觉特征，并结合医学文本提示，实现对风险因素的细粒度识别与多数据集验证。**
...
- **简介: 论文研究单目3D物体检测的泛化问题，提出可微分NMS增强遮挡鲁棒性，探索深度等变骨干提升泛化，分析大物体噪声敏感性，引入分割方法，并数学分析相机高度泛化。**
...
- **简介: 论文针对体育场景下的风格化标题生成任务，解决现有模型缺乏领域术语导致描述不自然的问题，提出两阶段微调LVLM流程，提升生成效果并应用于实战。**
...
- **简介: 论文针对分布偏移下的模型校准问题，提出无需目标域信息的框架，通过频域低通滤波和梯度校正提升鲁棒性。**
...
- **简介: 论文针对深度伪造检测的泛化能力不足问题，提出基于面部基础模型和度量学习的框架，通过自监督预训练、多数据集微调及三元组损失优化，提升模型对真实与伪造视频的区分能力。**
...
- **简介: 论文提出Sat2Flow，从卫星图像生成结构一致的OD流量，解决依赖辅助数据和拓扑敏感问题，采用多核编码器与排列感知扩散框架，结合对比训练与等变训练确保拓扑鲁棒性。**
...
- **简介: 论文评估生成式视觉-语言模型（VLMs）的地理定位能力，发现其在社交媒体风格图像上准确率达61%，但对普通街景效果差，揭示隐私风险，呼吁关注其社会影响。**
...
- **简介: 该论文针对车载系统计算受限问题，提出ODAL框架通过分布式架构结合视觉基础模型实现车内物体检测与定位，并引入ODALbench评估指标，验证轻量化模型经微调后在精度与鲁棒性上优于主流模型。**
...
- **简介: 论文针对光场显著目标检测任务，解决现有方法忽略提示信息与频域分析导致的小目标被噪声干扰问题，提出SPLF-SAM模型，通过多尺度特征嵌入和自适应过滤模块提升检测效果。**
...
- **链接: [http://arxiv.org/pdf/2508.19895v1](http://arxiv.org/pdf/2508.19895v1)**
...
- **简介: 该论文提出实时AI绘画协作系统，解决传统系统无法融合底层几何特征与高层语义的问题，通过多阶段生成整合形式与上下文意图，实现低延迟多人协同创作。**
...
- **链接: [http://arxiv.org/pdf/2508.20063v1](http://arxiv.org/pdf/2508.20063v1)**
...
- **简介: 论文针对AMD进展分类与预测任务，通过融合CNN网络和模型集成提升分类性能，并提出补丁自编码器生成未来OCT图像用于进展判断，旨在优化眼底病变监测与治疗方案制定。**
...
- **简介: 论文研究视觉语言模型在生物识别中的公平性问题，通过评估三个模型在平衡数据集上的表现，揭示其对不同族裔、性别等群体的偏差差异。**
...
- **简介: 该论文通过多光谱LiDAR与深度学习模型提取城市和郊区树点，解决复杂环境下的树木识别问题，评估SPT等模型，提升提取精度。**
...
- **简介: 该论文针对杂草检测任务，解决阴影偏差和数据稀缺问题，提出半监督框架通过伪标签和诊断工具提升模型鲁棒性与召回率。**
...
- **简介: 该论文针对医疗图像异常检测任务，解决领域差异与原型坍塌问题，提出结合可训练编码器、原型引导重建及多样性损失的统一框架，提升表示质量与定位精度。**
...
- **简介: 该论文针对行人过街意图预测任务，解决自动驾驶中判断行人是否即将过马路的问题。提出TrajFusionNet模型，融合序列轨迹与视觉信息，通过双分支结构实现高效预测，取得最佳性能。**
...
>
---
#### [new 066] Self-supervised structured object representation learning
- **分类: cs.CV**

- **简介: 该论文提出自监督结构化物体表示方法，通过语义分组、实例分离与层次结构，结合ProtoScale模块在多尺度捕捉视觉元素，保留全场景上下文以提升密集预测性能，优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.19864v1](http://arxiv.org/pdf/2508.19864v1)**
...
>
---
#### [new 067] TTF-VLA: Temporal Token Fusion via Pixel-Attention Integration for Vision-Language-Action Models
...
>
---
#### [new 072] The Return of Structural Handwritten Mathematical Expression Recognition
- **分类: cs.CV**

- **简介: 论文研究结构化手写数学表达式识别，解决符号与轨迹对齐不足的问题，提出自动标注系统和模块化结构识别方法，结合多模型优化，实现可解释的识别与错误分析。**

- **链接: [http://arxiv.org/pdf/2508.19773v1](http://arxiv.org/pdf/2508.19773v1)**
...
>
---
#### [new 082] FlowDet: Overcoming Perspective and Scale Challenges in Real-Time End-to-End Traffic Detection
- **分类: cs.CV; cs.AI; I.4.8; I.2.10; I.5.1**

- **简介: 本文提出FlowDet，用于实时交通检测，解决透视与尺度挑战。通过Geometric Deformable Unit和Scale-Aware Attention模块优化DETR架构，建立Intersection-Flow-5k数据集，在测试集上提升AP 1.5%并降低计算量63.2%。**

- **链接: [http://arxiv.org/pdf/2508.19565v1](http://arxiv.org/pdf/2508.19565v1)**
...
>
---
#### [new 083] KRETA: A Benchmark for Korean Reading and Reasoning in Text-Rich VQA Attuned to Diverse Visual Contexts
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 084] Hyperspectral Sensors and Autonomous Driving: Technologies, Limitations, and Opportunities
- **分类: cs.CV; cs.ET**

- **简介: 该论文评估高光谱成像（HSI）在自动驾驶中的应用潜力，分析其技术优势、商业化瓶颈及数据集局限，旨在推动HSI在ADAS/AD中的实用化研究。**

- **链接: [http://arxiv.org/pdf/2508.19905v1](http://arxiv.org/pdf/2508.19905v1)**
...
>
---
#### [new 093] DATR: Diffusion-based 3D Apple Tree Reconstruction Framework with Sparse-View
- **分类: cs.RO; cs.CV**

- **简介: 本文提出DATR框架，解决稀疏视角下苹果树3D重建难题。通过两阶段方法：首阶段用传感器生成树掩码过滤背景，第二阶段结合扩散模型与大重建模型实现高精度重建，利用合成数据训练，提升效率360倍，适用于农业数字孪生系统。**
...
>
---
#### [new 094] MovieCORE: COgnitive REasoning in Movies
...
>
---
#### [new 097] AT-CXR: Uncertainty-Aware Agentic Triage for Chest X-rays
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 论文提出AT-CXR，一种考虑不确定性的胸片分诊代理系统，通过估计置信度与分布拟合，结合规则与LLM路由设计，在准确性、选择性预测及低延迟上超越现有方法，满足临床实际需求。**

- **链接: [http://arxiv.org/pdf/2508.19322v1](http://arxiv.org/pdf/2508.19322v1)**
...
>
---
#### [new 101] 11Plus-Bench: Demystifying Multimodal LLM Spatial Reasoning with Cognitive-Inspired Analysis
...
>
---
#### [new 102] Mind the Third Eye! Benchmarking Privacy Awareness in MLLM-powered Smartphone Agents
- **分类: cs.CR; cs.CV**

- **简介: 论文评估基于MLLM的智能手机代理的隐私意识，通过构建7138个场景的基准测试，发现多数代理隐私保护不足，闭源代理表现优于开源，Gemini 2.0-flash RA达67%。**

- **链接: [http://arxiv.org/pdf/2508.19493v1](http://arxiv.org/pdf/2508.19493v1)**
...
>
---
#### [replaced 003] MTS-Net: Dual-Enhanced Positional Multi-Head Self-Attention for 3D CT Diagnosis of May-Thurner Syndrome
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2406.04680v2](http://arxiv.org/pdf/2406.04680v2)**
...
>
---
#### [replaced 004] Time-Aware One Step Diffusion Network for Real-World Image Super-Resolution
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.16557v2](http://arxiv.org/pdf/2508.16557v2)**
...
>
---
#### [replaced 005] ZoomEye: Enhancing Multimodal LLMs with Human-Like Zooming Capabilities through Tree-Based Image Exploration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.16044v3](http://arxiv.org/pdf/2411.16044v3)**
...
>
---
#### [replaced 012] DIO: Refining Mutual Information and Causal Chain to Enhance Machine Abstract Reasoning Ability
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15387v2](http://arxiv.org/pdf/2508.15387v2)**
...
>
---
#### [replaced 013] FaceEditTalker: Controllable Talking Head Generation with Facial Attribute Editing
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.22141v2](http://arxiv.org/pdf/2505.22141v2)**
...
>
---
#### [replaced 014] On Domain-Adaptive Post-Training for Multimodal Large Language Models
- **分类: cs.CL; cs.CV; cs.LG**
...
>
---
#### [replaced 015] Explain Before You Answer: A Survey on Compositional Visual Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.17298v2](http://arxiv.org/pdf/2508.17298v2)**
...
>
> **备注:** Project Page: https://github.com/pokerme7777/Compositional-Visual-Reasoning-Survey
>
...
>
---
#### [replaced 018] Analysis and Synthesis Denoisers for Forward-Backward Plug-and-Play Algorithms
...
>
---
#### [replaced 019] TraceNet: Segment one thing efficiently
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2406.14874v3](http://arxiv.org/pdf/2406.14874v3)**
...
>
---
#### [replaced 023] Solving Inverse Problems using Diffusion with Iterative Colored Renoising
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.17468v4](http://arxiv.org/pdf/2501.17468v4)**
...
>
---
#### [replaced 026] ReCLIP++: Learn to Rectify the Bias of CLIP for Unsupervised Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2408.06747v3](http://arxiv.org/pdf/2408.06747v3)**
...
>
---
#### [replaced 030] Deep Learning in Mild Cognitive Impairment Diagnosis using Eye Movements and Image Content in Visual Memory Tasks
- **分类: cs.HC; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23016v2](http://arxiv.org/pdf/2506.23016v2)**
...
>
---
#### [replaced 031] R-TPT: Improving Adversarial Robustness of Vision-Language Models through Test-Time Prompt Tuning
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.11195v2](http://arxiv.org/pdf/2504.11195v2)**

> **作者:** Lijun Sheng; Jian Liang; Zilei Wang; Ran He
>
> **备注:** CVPR 2025 (Corrected the results on the Aircraft dataset)
>
...
>
---
#### [replaced 032] SegQuant: A Semantics-Aware and Generalizable Quantization Framework for Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.14811v4](http://arxiv.org/pdf/2507.14811v4)**
...
>
---
#### [replaced 037] FastMesh: Efficient Artistic Mesh Generation via Component Decoupling
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.19188v2](http://arxiv.org/pdf/2508.19188v2)**
...
>
---
#### [replaced 038] UltraRay: Introducing Full-Path Ray Tracing in Physics-Based Ultrasound Simulation
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2501.05828v3](http://arxiv.org/pdf/2501.05828v3)**
...
>
---
#### [replaced 039] DVM-SLAM: Decentralized Visual Monocular Simultaneous Localization and Mapping for Multi-Agent Systems
- **分类: cs.RO; cs.CV; cs.MA**

- **链接: [http://arxiv.org/pdf/2503.04126v2](http://arxiv.org/pdf/2503.04126v2)**
...
>
---
#### [replaced 040] Heat Diffusion Models -- Interpixel Attention Mechanism
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.19600v3](http://arxiv.org/pdf/2504.19600v3)**
...
>
---
#### [replaced 041] InternVL3.5: Advancing Open-Source Multimodal Models in Versatility, Reasoning, and Efficiency
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.18265v2](http://arxiv.org/pdf/2508.18265v2)**
...
>
---
#### [replaced 044] Evaluating Text-to-Image and Text-to-Video Synthesis with a Conditional Fréchet Distance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.21721v2](http://arxiv.org/pdf/2503.21721v2)**
...
>
---
#### [replaced 047] Cross-Modal Geometric Hierarchy Fusion: An Implicit-Submap Driven Framework for Resilient 3D Place Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.14243v3](http://arxiv.org/pdf/2506.14243v3)**

> **作者:** Xiaohui Jiang; Haijiang Zhu; Chade Li; Fulin Tang; Ning An
>
...
>
---
#### [replaced 050] Exploring Typographic Visual Prompts Injection Threats in Cross-Modality Generation Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 051] GIMS: Image Matching System Based on Adaptive Graph Construction and Graph Neural Network
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.18221v2](http://arxiv.org/pdf/2412.18221v2)**

> **作者:** Xianfeng Song; Yi Zou; Zheng Shi; Zheng Liu
>
> **摘要:** Feature-based image matching has extensive applications in computer vision. Keypoints detected in images can be naturally represented as graph structures, and Graph Neural Networks (GNNs) have been shown to outperform traditional deep learning techniques. Consequently, the paradigm of image matching via GNNs has gained significant prominence in recent academic research. In this paper, we first introduce an innovative adaptive graph construction method that utilizes a filtering mechanism based on distance and dynamic threshold similarity. This method dynamically adjusts the criteria for incorporating new vertices based on the characteristics of existing vertices, allowing for the construction of more precise and robust graph structures while avoiding redundancy. We further combine the vertex processing capabilities of GNNs with the global awareness capabilities of Transformers to enhance the model's representation of spatial and feature information within graph structures. This hybrid model provides a deeper understanding of the interrelationships between vertices and their contributions to the matching process. Additionally, we employ the Sinkhorn algorithm to iteratively solve for optimal matching results. Finally, we validate our system using extensive image datasets and conduct comprehensive comparative experiments. Experimental results demonstrate that our system achieves an average improvement of 3.8x-40.3x in overall matching performance. Additionally, the number of vertices and edges significantly impacts training efficiency and memory usage; therefore, we employ multi-GPU technology to accelerate the training process. Our code is available at https://github.com/songxf1024/GIMS.
>
---
#### [replaced 052] DreamActor-H1: High-Fidelity Human-Product Demonstration Video Generation via Motion-designed Diffusion Transformers
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.10568v2](http://arxiv.org/pdf/2506.10568v2)**
...
>
---
#### [replaced 053] Pseudo-Simulation for Autonomous Driving
...
>
---
#### [replaced 054] HumanSense: From Multimodal Perception to Empathetic Context-Aware Responses through Reasoning MLLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10576v2](http://arxiv.org/pdf/2508.10576v2)**
...
>
---
#### [replaced 055] TAGS: 3D Tumor-Adaptive Guidance for SAM
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17096v2](http://arxiv.org/pdf/2505.17096v2)**

> **作者:** Sirui Li; Linkai Peng; Zheyuan Zhang; Gorkem Durak; Ulas Bagci
>
> **备注:** Accepted by ICCV-APAH
>
...
>
---
#### [replaced 056] Robust Single-Stage Fully Sparse 3D Object Detection via Detachable Latent Diffusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03252v2](http://arxiv.org/pdf/2508.03252v2)**
...
>
---
#### [replaced 057] EnvInjection: Environmental Prompt Injection Attack to Multi-modal Web Agents
...
>
---
#### [replaced 058] HAMoBE: Hierarchical and Adaptive Mixture of Biometric Experts for Video-based Person ReID
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.05038v2](http://arxiv.org/pdf/2508.05038v2)**
...
>
---
#### [replaced 059] DeepForest: Sensing Into Self-Occluding Volumes of Vegetation With Aerial Imaging
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2502.02171v4](http://arxiv.org/pdf/2502.02171v4)**
...
>
---
#### [replaced 060] Personalized MR-Informed Diffusion Models for 3D PET Image Reconstruction
- **分类: physics.med-ph; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03804v2](http://arxiv.org/pdf/2506.03804v2)**
...
>
---
#### [replaced 063] Know "No" Better: A Data-Driven Approach for Enhancing Negation Awareness in CLIP
- **分类: cs.CV; cs.CL**
