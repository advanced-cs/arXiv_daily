...
>
---
#### [new 003] M$^3$Eval: Multi-Modal Memory Evaluation through Cognitively-Grounded Video Tasks
...
>
---
#### [new 004] 3DThinkVLA: Endowing Vision-Language-Action Models with Latent 3D Priors via 3D-Thinking-Guided Co-training
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 011] MAOAM: Unified Object and Material Selection with Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文提出MAOAM，解决图像编辑中对象与材质选择问题，通过融合视觉语言模型实现文本和点击交互的统一选择。**

- **链接: [https://arxiv.org/pdf/2606.04880](https://arxiv.org/pdf/2606.04880)**
...
>
---
#### [new 017] A Cookbook of 3D Vision: Data, Learning Paradigms, and Application
- **分类: cs.CV**

- **简介: 该论文属于3D视觉领域，旨在解决数据表示与学习范式碎片化问题，通过构建统一的分类体系，整合几何表示、数据集、框架与应用。**

- **链接: [https://arxiv.org/pdf/2606.04291](https://arxiv.org/pdf/2606.04291)**
...
>
---
#### [new 019] XSSR: Cross-Domain Self-Supervised Representative Selection for Efficient Annotation in Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，解决跨域标注成本高的问题。提出XSSR框架，通过自监督选择代表性样本，减少标注工作量并保持分割性能。**

- **链接: [https://arxiv.org/pdf/2606.04301](https://arxiv.org/pdf/2606.04301)**
...
>
---
#### [new 022] VT-3DAD: Cross-Category 3D Anomaly Detection via Visual-Text Normal Space Alignment
- **分类: cs.CV**

- **简介: 该论文属于跨类别3D异常检测任务，解决少量正常样本下识别未知点云是否属于目标类别的问题。提出VT-3DAD框架，通过视觉与文本对齐提升检测性能。**

- **链接: [https://arxiv.org/pdf/2606.04369](https://arxiv.org/pdf/2606.04369)**
...
>
---
#### [new 023] Recent Advances and Trends in Learning-based 3D Representations
- **分类: cs.CV**

- **简介: 该论文聚焦3D表示方法的演进，分析从传统到神经和基于基元的表示，解决如何高效构建和应用3D/4D数据的问题。**

- **链接: [https://arxiv.org/pdf/2606.04871](https://arxiv.org/pdf/2606.04871)**
...
>
---
#### [new 029] Answer Self-Consistency with Margin-Triggered Question Re-Arbitration for the CVPR 2026 VidLLMs Challenge
- **分类: cs.CV**

- **简介: 该论文针对视频视觉关系推理任务，提出ASC-MQRA框架以提升答案一致性。通过多轮推理和低置信度样本重审，提升模型准确性。**

- **链接: [https://arxiv.org/pdf/2606.04323](https://arxiv.org/pdf/2606.04323)**
...
>
---
#### [new 036] Geometry-Aware Distillation for Prompt Tuning Biomedical Vision-Language Models
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于医学视觉-语言模型的微调任务，旨在解决有限监督下类别关系被忽略导致的性能不稳定问题。提出OGKD框架，通过注入类别关系结构提升模型准确性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2606.04922](https://arxiv.org/pdf/2606.04922)**
...
>
---
#### [new 041] StrokeTimer: Robust Representation Learning for Ischemic Stroke Onset-Time Estimation from Non-contrast CT
- **分类: cs.CV**

- **简介: 该论文属于急性缺血性卒中发病时间估计任务，旨在解决临床中发病时间不确定的问题。通过提出StrokeTimer框架，利用自监督和对比学习方法，提升NCCT图像中微小缺血变化的识别能力。**

- **链接: [https://arxiv.org/pdf/2606.04722](https://arxiv.org/pdf/2606.04722)**
...
>
---
#### [new 043] Video2LoRA: Parametric Video Internalization for Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 055] Physics-Informed Video Generation via Mixture-of-Experts Latent Alignment
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决视频物理合理性不足的问题。通过引入物理结构的潜在引导，提升生成视频的物理可信度。**

- **链接: [https://arxiv.org/pdf/2606.04737](https://arxiv.org/pdf/2606.04737)**
...
>
---
#### [new 065] Do Foundation Models See Biology? Evaluating Attention Coherence with Spatial Transcriptomics in Glioblastoma
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在评估基础模型的注意力机制是否反映真实生物学特征。通过空间转录组数据验证模型注意力与生物学的一致性，揭示其学习到的是多基因程序而非单个分子事件。**

- **链接: [https://arxiv.org/pdf/2606.04764](https://arxiv.org/pdf/2606.04764)**
...
>
---
#### [new 072] CIPER: A Unified Framework for Cross-view Image-retrieval and Pose-estimation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 075] Stateful Visual Encoders for Vision-Language Models
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [new 076] Multi-Granularity 3D Kidney Lesion Characterization from CT Volumes
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分析任务，旨在实现肾脏病变的多粒度3D特征描述。针对现有方法仅在患者或器官层面预测的问题，提出LesionDETR模型，进行病变级预测，提升报告生成精度。**

- **链接: [https://arxiv.org/pdf/2606.04365](https://arxiv.org/pdf/2606.04365)**
...
>
---
#### [new 077] Who Needs Labels? Adapting Vision Foundation Models With the Metadata You Already Have
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于领域自适应任务，解决标签稀缺场景下的模型适应问题。提出FINO方法，利用元数据进行无监督模型适配，提升模型在科学领域的性能。**

- **链接: [https://arxiv.org/pdf/2606.05107](https://arxiv.org/pdf/2606.05107)**
...
>
---
#### [new 094] BreastGPT: A Multimodal Large Language Model for the Full Spectrum of Breast Cancer Clinical Routine
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 097] Plan, Watch, Recover: A Benchmark and Architectures for Proactive Procedural Assistance
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于主动程序辅助任务，解决用户偏离步骤时的实时指导问题。提出EgoProactive数据集和Pro²Bench基准，设计解耦架构与训练方法，提升干预质量和恢复能力。**

- **链接: [https://arxiv.org/pdf/2606.04970](https://arxiv.org/pdf/2606.04970)**
...
>
---
#### [new 098] Z-FLoc: Zero-Shot Floorplan Localization via Geometric Primitives
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 099] Benchmarking Living-Screen-Native GUI Agents on Short-Video Platforms
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 102] Measuring Model Robustness via Fisher Information: Spectral Bounds, Theoretical Guarantees, and Practical Algorithms
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于模型鲁棒性评估任务，旨在解决现有方法依赖攻击且缺乏解释性的问题。提出基于FIM谱范数的鲁棒性度量，理论分析并设计高效算法，验证其与对抗脆弱性的强相关性。**

- **链接: [https://arxiv.org/pdf/2606.04767](https://arxiv.org/pdf/2606.04767)**
...
>
---
#### [new 103] Activation Steering of Video Generation Models via Reduced-Order Linear Optimal Control
- **分类: cs.LG; cs.AI; cs.CV; eess.SY; math.OC**

- **简介: 该论文属于文本到视频生成任务，旨在解决生成内容有害的问题。通过LA-LQR方法实现精准、低侵入的激活控制，提升视频安全性与质量。**

- **链接: [https://arxiv.org/pdf/2606.04775](https://arxiv.org/pdf/2606.04775)**
...
>
---
#### [new 104] TGSD: Topology-Guided State-Space Diffusion for EEG Spatial Super-Resolution
- **分类: eess.SP; cs.CV**

- **简介: 该论文属于EEG空间超分辨率任务，旨在解决低密度EEG缺失通道信息的问题。通过引入拓扑引导的扩散框架TGSD，结合空间先验与条件扩散生成缺失信号，提升重建精度与分类性能。**
...
>
---
#### [new 105] Can Generalist Agents Automate Data Curation?
...
>
---
#### [new 106] Toward Multi-Domain and Long-Tailed Quantization via Feature Alignment and Scaling
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于模型量化任务，解决多领域和长尾分布下的量化问题。提出EmaQ及EmaQ-LT方法，通过特征对齐和缩放提升量化性能。**

- **链接: [https://arxiv.org/pdf/2606.04920](https://arxiv.org/pdf/2606.04920)**
...
>
---
#### [new 107] Drift-Augmented Scoring: Text-Derived Noise Robustness for Zero-Shot Audio-Language Classification
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 113] Echo-Infinity: Learning Evolving Memory for Real-Time Infinite Video Generation
- **分类: cs.MM; cs.CV; cs.GR**

- **简介: 该论文提出Echo-Infinity，解决实时无限视频生成问题。通过可学习的动态记忆机制和统一相对RoPE方案，实现高效、高质量视频生成。**

- **链接: [https://arxiv.org/pdf/2606.04527](https://arxiv.org/pdf/2606.04527)**
...
>
---
#### [new 115] Instant-Fold: In-Context Imitation Learning for Deformable Object Manipulation
...
>
---
#### [new 116] Fine-grained Fragment Retrieval in Multi-modal Long-form Dialogues
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 002] Efficient Brood Cell Detection in Layer Trap Nests for Bees and Wasps: Balancing Labeling Effort and Species Coverage
- **分类: cs.CV**
...
>
---
#### [replaced 003] Can VLMs Predict Future States? Bootstrapping World Models from Inverse Dynamics
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 004] ShareVerse: Multi-Agent Consistent Video Generation for Shared World Modeling
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 009] PaCX-MAE: Physiology-Augmented Chest X-Ray Masked Autoencoder
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2606.01537](https://arxiv.org/pdf/2606.01537)**
...
>
---
#### [replaced 013] From Segments to Scenes: Temporal Understanding for Agentic Autonomous Driving via Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.05277](https://arxiv.org/pdf/2512.05277)**
...
>
---
#### [replaced 015] Exposing Blindspots: Cultural Bias Evaluation in Generative Image Models
- **分类: cs.CV**
...
>
> **备注:** 28 pages, 8 figures. Accepted at IASEAI 2026. Huichan Seo, Sieun Choi, and Minki Hong contributed equally
>
...
>
---
#### [replaced 018] Revisiting Model Stitching In the Foundation Model Era
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 019] Hierarchical Self-Supervised Adversarial Training for Robust Vision Models in Histopathology
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.10629](https://arxiv.org/pdf/2503.10629)**

> **作者:** Hashmat Shadab Malik; Shahina Kunhimon; Muzammal Naseer; Fahad Shahbaz Khan; Salman Khan
>
> **备注:** Accepted at 28th International Conference On Medical Image Computing And Computer Assisted Intervention (MICCAI 2025)
>
...
>
---
#### [replaced 020] Flash-GRPO: Efficient Alignment for Video Diffusion via One-Step Policy Optimization
- **分类: cs.CV**
...
>
---
#### [replaced 021] EvoPrompt: Guided Prompt Evolution for Vision-Language Models Adaptation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2603.09493](https://arxiv.org/pdf/2603.09493)**

> **作者:** Enming Zhang; Jiayang Li; Yanlong Wang; Yanru Wu; Zhenyu Liu; Yang Li
>
...
>
---
#### [replaced 022] Bad Seeing or Bad Thinking? Rewarding Perception for Multimodal Reasoning
- **分类: cs.AI; cs.CV**
...
>
> **备注:** Accepted by ICML 2026 as Oral
>
...
>
---
#### [replaced 027] High-Quality Entity Segmentation and Grounding
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 028] Venus-DeFakerOne: Unified Fake Image Detection & Localization
- **分类: cs.CV**
...
>
---
#### [replaced 035] Spatial Transcriptomics as Images for Large-Scale Pretraining
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 036] Scalable Event Cloud Network for Event-based Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.20803](https://arxiv.org/pdf/2412.20803)**

> **作者:** Hongwei Ren; Fei Ma; Xiaopeng Lin; Yuetong Fang; Hongxiang Huang; Yue Zhou; Yulong Huang; Haotian Fu; Ziyi Yang; Youxin Jiang; Xiangqian Wu; Bojun Cheng
>
> **备注:** ICML2026 Oral
>
> **摘要:** Event cameras are biologically inspired sensors garnering significant attention from both industry and academia. Mainstream methods favor frame and voxel representations, which reach a satisfactory performance while introducing time-consuming transformations, bulky models, and sacrificing fine-grained temporal information. Alternatively, Point Cloud representation demonstrates promise in addressing the mentioned weaknesses, but it has limited scalability in abstracting features of higher spatial resolution and longer temporal sequence events. In this paper, we propose a Scalable Network named SECNet to leverage Event Cloud representation. SECNet integrates polarity at the structural level by innovating the Event-based Group and Sampling module rather than only at the input level. To accommodate the surge in the number of events, SECNet embraces feature extraction in the frequency domain via the Fourier this http URL approach not only substantially extinguishes the explosion of Multiply Accumulate Operations but also effectively abstracts spatio-temporal features. We conducted extensive experiments on \textbf{ten} event-based datasets, and substantiate the scalability, effectiveness, and efficiency of SECNet. Our code will be available at: this https URL.
>
---
#### [replaced 037] Dynamic Content Moderation in Livestreams: Combining Supervised Classification with MLLM-Boosted Similarity Matching
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.03553](https://arxiv.org/pdf/2512.03553)**
...
>
---
#### [replaced 040] SAM 3D: 3Dfy Anything in Images
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.16624](https://arxiv.org/pdf/2511.16624)**
...
>
---
#### [replaced 041] Platonic Transformers: A Solid Choice For Equivariance
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2510.03511](https://arxiv.org/pdf/2510.03511)**
...
>
---
#### [replaced 042] ViewMask-1-to-3: Multi-View Consistent Image Generation via Multimodal Discrete Diffusion Models
- **分类: cs.CV**
...
> **备注:** Accepted by ICML 2026
>
> **摘要:** Motivated by discrete diffusion's success in language-vision modeling, we explore its potential for multi-view generation, a task dominated by continuous approaches. We introduce ViewMask-1-to-3, formulating multi-view generation as a discrete sequence modeling problem where each viewpoint is represented as visual tokens from MAGVIT-v2. Through discrete diffusion via masked token prediction, our approach enables progressive multi-view generation via iterative token unmasking, unifying language and vision in a shared token space. Importantly, simple random masking combined with self-attention naturally encourages cross-view consistency without specialized architectures or 3D geometric priors. Our method outperforms the baseline on the GSO and 3D-FUTURE benchmarks, ranking first on average across standard image metrics, and achieving a 10.6% higher IoU than continuous diffusion models on 3D-FUTURE. Furthermore, the proposed framework can be naturally extended to support text-to-image generation and multimodal understanding, highlighting its potential toward a more unified paradigm for multimodal understanding and generation.
>
---
#### [replaced 043] P$^2$-DPO: Grounding Hallucination in Perceptual Processing via Calibration Direct Preference Optimization
...
>
---
#### [replaced 044] Towards Evaluating the Robustness of Visual State Space Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2406.09407](https://arxiv.org/pdf/2406.09407)**

> **作者:** Hashmat Shadab Malik; Fahad Shamshad; Muzammal Naseer; Karthik Nandakumar; Fahad Shahbaz Khan; Salman Khan
>
> **备注:** Accepted at The 5th Workshop of Adversarial Machine Learning on Computer Vision (CVPRW 2025)
>
...
>
---
#### [replaced 047] Toward Trustworthy Portrait Editing: Evaluation of Demographic Misrepresentation in I2I Models
- **分类: cs.CV**
...
>
> **备注:** 22 pages, 10 figures. Minki Hong and Sieun Choi contributed equally
>
...
>
---
#### [replaced 048] On-the-fly Repulsion in the Contextual Space for Rich Diversity in Diffusion Transformers
- **分类: cs.CV; cs.AI; cs.GR; cs.LG**
...
>
---
#### [replaced 051] Rebalancing Reference Frame Dominance to Improve Motion in Image-to-Video Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 052] AAD-1: Asymmetric Adversarial Distillation for One-Step Autoregressive Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2606.03972](https://arxiv.org/pdf/2606.03972)**
...
>
---
#### [replaced 054] Transferable Multi-Bit Watermarking Across Frozen Diffusion Models via Latent Consistency Bridges
- **分类: cs.CV**
...
>
> **备注:** Accepted for publication at the IEEE International Conference on Robot and Human Interactive Communication (RO-MAN 2026). 6 pages, 3 figures, 1 table
>
...
>
---
#### [replaced 060] Vision Transformers and Convolutional Neural Networks for Land Use Scene Classification
- **分类: cs.CV**
...
>
---
#### [replaced 061] HyperDiT: Hyper-Connected Transformers for High-Fidelity Pixel-Space Diffusion
- **分类: cs.CV**
...
>
---
#### [replaced 062] R3G: A Reasoning-Retrieval-Reranking Framework for Vision-Centric Answer Generation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 065] The Mechanistic Emergence of Symbol Grounding in Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 075] Shifting the Breaking Point of Flow Matching for Multi-Instance Editing
- **分类: cs.CV**
...
>
---
#### [replaced 076] StateVLM: A State-Aware Vision-Language Model for Robotic Affordance Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.03927](https://arxiv.org/pdf/2605.03927)**
...
>
---
#### [replaced 079] GGT-100K: Generative Ground Truth for Generalizable Real-World Image Restoration
- **分类: cs.CV**
...
>
---
#### [replaced 080] TrajTok: Learning Trajectory Tokens enables better Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.22779](https://arxiv.org/pdf/2602.22779)**
...
>
> **备注:** Accepted to the International Conference on Machine Learning (ICML) 2026. To appear in the Proceedings of Machine Learning Research (PMLR). 9 pages
>
