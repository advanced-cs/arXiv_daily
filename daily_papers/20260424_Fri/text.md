...
#### [new 001] MathDuels: Evaluating LLMs as Problem Posers and Solvers
- **分类: cs.CL; cs.SE**

- **简介: 该论文提出MathDuels，用于评估大语言模型作为问题生成者和求解者的双重能力。解决传统基准无法区分模型差异的问题，通过自对弈机制进行双角色评测。**
...
>
---
#### [new 005] Misinformation Span Detection in Videos via Audio Transcripts
- **分类: cs.CL; cs.SI**

- **简介: 该论文属于视频谣言检测任务，旨在解决识别视频中谣言出现时间段的问题。通过构建两个新数据集，利用音频转录文本进行谣言段落检测。**

- **链接: [https://arxiv.org/pdf/2604.21767](https://arxiv.org/pdf/2604.21767)**
...
>
---
#### [new 006] CARE: Counselor-Aligned Response Engine for Online Mental-Health Support
- **分类: cs.CL**

- **简介: 该论文属于心理健康支持任务，旨在解决咨询师资源不足与低资源语言中AI辅助不足的问题。通过微调开源模型，生成符合专业咨询风格的实时回应。**

- **链接: [https://arxiv.org/pdf/2604.21352](https://arxiv.org/pdf/2604.21352)**
...
>
---
#### [new 007] Using Machine Mental Imagery for Representing Common Ground in Situated Dialogue
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文属于对话系统任务，旨在解决对话中共同语境表示不足的问题。通过引入视觉辅助框架，减少语义模糊，提升对话一致性与连贯性。**

- **链接: [https://arxiv.org/pdf/2604.21144](https://arxiv.org/pdf/2604.21144)**
...
>
---
#### [new 012] Job Skill Extraction via LLM-Centric Multi-Module Framework
- **分类: cs.CL**

- **简介: 该论文属于职位技能提取任务，解决生成式大模型在长尾术语和跨领域场景下的边界漂移与幻觉问题。提出SRICL框架，结合语义检索、上下文学习和监督微调，提升提取准确性和稳定性。**

- **链接: [https://arxiv.org/pdf/2604.21525](https://arxiv.org/pdf/2604.21525)**
...
>
---
#### [new 013] EVENT5Ws: A Large Dataset for Open-Domain Event Extraction from Documents
- **分类: cs.CL**

- **简介: 该论文属于事件抽取任务，旨在解决现有数据集在开放领域覆盖不足的问题。作者构建了EVENT5Ws数据集，并验证其有效性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2604.21890](https://arxiv.org/pdf/2604.21890)**
...
>
---
#### [new 014] Decoupled DiLoCo for Resilient Distributed Pre-training
- **分类: cs.CL**

- **简介: 该论文提出Decoupled DiLoCo，解决分布式预训练中的同步瓶颈问题，通过异步通信提升训练效率与容错性。**

- **链接: [https://arxiv.org/pdf/2604.21428](https://arxiv.org/pdf/2604.21428)**
...
>
---
#### [new 020] StructMem: Structured Memory for Long-Horizon Behavior in LLMs
- **分类: cs.CL; cs.AI; cs.IR; cs.LG; cs.MA**

- **简介: 该论文属于长时对话代理任务，旨在解决传统记忆系统无法有效建模事件关系的问题。提出StructMem框架，通过结构化记忆提升时间推理和多跳问答性能。**

- **链接: [https://arxiv.org/pdf/2604.21748](https://arxiv.org/pdf/2604.21748)**
...
>
---
#### [new 021] Listen and Chant Before You Read: The Ladder of Beauty in LM Pre-Training
- **分类: cs.CL**

- **简介: 论文探讨了在语言模型预训练前先用音乐数据训练的效果，旨在提升语言学习效率。通过音乐到诗歌再到散文的流程，显著降低了困惑度，验证了结构化人类创作内容对小模型预训练的有效性。**

- **链接: [https://arxiv.org/pdf/2604.21265](https://arxiv.org/pdf/2604.21265)**
...
>
---
#### [new 022] Do LLM Decoders Listen Fairly? Benchmarking How Language Model Priors Shape Bias in Speech Recognition
...
>
---
#### [new 023] Subject-level Inference for Realistic Text Anonymization Evaluation
- **分类: cs.CL**

- **简介: 该论文属于文本匿名化评估任务，旨在解决现有评估方法无法反映真实推理风险的问题。提出SPIA基准，从个体层面评估隐私信息泄露风险。**

- **链接: [https://arxiv.org/pdf/2604.21211](https://arxiv.org/pdf/2604.21211)**
...
>
---
#### [new 025] From If-Statements to ML Pipelines: Revisiting Bias in Code-Generation
- **分类: cs.CL; cs.SE**

- **简介: 该论文属于代码生成任务，旨在解决评估代码生成中隐性偏见的问题。通过分析机器学习管道生成，发现传统条件语句无法准确反映实际偏见，揭示了更严重的特征选择偏见。**

- **链接: [https://arxiv.org/pdf/2604.21716](https://arxiv.org/pdf/2604.21716)**
...
>
---
#### [new 031] Planning Beyond Text: Graph-based Reasoning for Complex Narrative Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于复杂叙事生成任务，旨在解决叙事连贯性、逻辑一致性和角色发展问题。提出PLOTTER框架，通过结构图规划提升长文本推理能力。**

- **链接: [https://arxiv.org/pdf/2604.21253](https://arxiv.org/pdf/2604.21253)**
...
>
---
#### [new 041] Process Supervision via Verbal Critique Improves Reasoning in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型推理任务，旨在提升模型推理能力。通过引入基于自然语言批评的细粒度监督（VPS），优化生成-批评-精炼流程，显著提升模型表现。**

- **链接: [https://arxiv.org/pdf/2604.21611](https://arxiv.org/pdf/2604.21611)**
...
>
---
#### [new 042] Measuring Opinion Bias and Sycophancy via LLM-based Coercion
- **分类: cs.CL**

- **简介: 该论文属于模型偏见检测任务，旨在识别大语言模型在争议话题上的立场及迎合行为。通过直接和间接探测方法，分析模型在不同用户角色下的反应，揭示其真实观点与态度。**

- **链接: [https://arxiv.org/pdf/2604.21564](https://arxiv.org/pdf/2604.21564)**
...
>
---
#### [new 043] Reasoning Primitives in Hybrid and Non-Hybrid LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大语言模型的推理能力，探讨记忆与状态跟踪两种基本操作。比较混合架构与纯注意力模型在需要两者协同任务中的表现，发现混合模型更稳健。**
...
>
---
#### [new 044] Beyond N-gram: Data-Aware X-GRAM Extraction for Efficient Embedding Parameter Scaling
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决嵌入参数效率与内存增长问题。提出X-GRAM框架，通过动态注入和压缩尾部提升性能，实现更高效的模型扩展。**

- **链接: [https://arxiv.org/pdf/2604.21724](https://arxiv.org/pdf/2604.21724)**
...
>
---
#### [new 046] Preferences of a Voice-First Nation: Large-Scale Pairwise Evaluation and Preference Analysis for TTS in Indian Languages
- **分类: cs.CL**

- **简介: 该论文属于语音合成评估任务，旨在解决多语言TTS系统偏好分析问题。通过大规模 pairwise 评估，分析不同TTS系统的性能与用户偏好。**

- **链接: [https://arxiv.org/pdf/2604.21481](https://arxiv.org/pdf/2604.21481)**
...
>
> **摘要:** Crowdsourced pairwise evaluation has emerged as a scalable approach for assessing foundation models. However, applying it to Text to Speech(TTS) introduces high variance due to linguistic diversity and multidimensional nature of speech perception. We present a controlled multidimensional pairwise evaluation framework for multilingual TTS that combines linguistic control with perceptually grounded annotation. Using 5K+ native and code-mixed sentences across 10 Indic languages, we evaluate 7 state-of-the-art TTS systems and collect over 120K pairwise comparisons from over 1900 native raters. In addition to overall preference, raters provide judgments across 6 perceptual dimensions: intelligibility, expressiveness, voice quality, liveliness, noise, and hallucinations. Using Bradley-Terry modeling, we construct a multilingual leaderboard, interpret human preference using SHAP analysis and analyze leaderboard reliability alongside model strengths and trade-offs across perceptual dimensions.
>
---
#### [new 047] TingIS: Real-time Risk Event Discovery from Noisy Customer Incidents at Enterprise Scale
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出TingIS系统，用于实时发现企业级客户事件中的风险。解决高噪声、高吞吐下的事件关联与降噪问题，通过多阶段引擎和降噪管道提升检测效果。**
...
>
---
#### [new 048] AgenticQwen: Training Small Agentic Language Models with Dual Data Flywheels for Industrial-Scale Tool Use
- **分类: cs.CL**

- **简介: 该论文提出AgenticQwen，解决工业场景下小规模代理模型的训练问题。通过双数据飞轮机制提升模型推理与工具使用能力，实验证明其性能接近大模型。**

- **链接: [https://arxiv.org/pdf/2604.21590](https://arxiv.org/pdf/2604.21590)**

> **作者:** Yuanjie Lyu; Chengyu Wang; Haonan Zheng; Yuanhao Yue; Junbing Yan; Ming Wang; Jun Huang
>
> **摘要:** Modern industrial applications increasingly demand language models that act as agents, capable of multi-step reasoning and tool use in real-world settings. These tasks are typically performed under strict cost and latency constraints, making small agentic models highly desirable. In this paper, we introduce the AgenticQwen family of models, trained via multi-round reinforcement learning (RL) on synthetic data and a limited amount of open-source data. Our training framework combines reasoning RL and agentic RL with dual data flywheels that automatically generate increasingly challenging tasks. The reasoning flywheel increases task difficulty by learning from errors, while the agentic flywheel expands linear workflows into multi-branch behavior trees that better reflect the decision complexity of real-world applications. We validate AgenticQwen on public benchmarks and in an industrial agent system. The models achieve strong performance on multiple agentic benchmarks, and in our industrial agent system, close the gap with much larger models on search and data analysis tasks. Model checkpoints and part of the synthetic data: this https URL. Data synthesis and RL training code: this https URL. The data synthesis pipeline is also integrated into EasyDistill: this https URL.
>
---
#### [new 049] VLAA-GUI: Knowing When to Stop, Recover, and Search, A Modular Framework for GUI Automation
- **分类: cs.CL; cs.AI; cs.SE**

- **简介: 该论文提出VLAA-GUI框架，解决GUI自动化中的早期停止和重复循环问题，通过Stop、Recover、Search组件提升自动化效果。**

- **链接: [https://arxiv.org/pdf/2604.21375](https://arxiv.org/pdf/2604.21375)**
...
>
---
#### [new 052] A Multimodal Text- and Graph-Based Approach for Open-Domain Event Extraction from Documents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于事件抽取任务，旨在解决开放领域事件抽取的泛化性和上下文建模问题。提出MODEE方法，结合文本和图结构学习，提升事件抽取效果。**

- **链接: [https://arxiv.org/pdf/2604.21885](https://arxiv.org/pdf/2604.21885)**
...
>
---
#### [new 053] When Agents Look the Same: Quantifying Distillation-Induced Similarity in Tool-Use Behaviors
- **分类: cs.CL**

- **简介: 该论文研究模型蒸馏导致的行为同质化问题，提出RPS和AGS两个指标来量化工具使用行为的相似性，以诊断代理系统的收敛情况。**

- **链接: [https://arxiv.org/pdf/2604.21255](https://arxiv.org/pdf/2604.21255)**
...
>
---
#### [new 054] GiVA: Gradient-Informed Bases for Vector-Based Adaptation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于模型微调任务，旨在解决向量适应方法训练成本高的问题。提出GiVA方法，在保持参数效率的同时提升训练速度。**

- **链接: [https://arxiv.org/pdf/2604.21901](https://arxiv.org/pdf/2604.21901)**
...
>
---
#### [new 056] Evaluation of Automatic Speech Recognition Using Generative Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于自动语音识别（ASR）评估任务，旨在解决传统指标WES不敏感于语义的问题。通过三种方法评估生成式大语言模型在语义评估中的有效性，结果显示其优于传统方法。**
...
>
---
#### [new 057] Zero-Shot Detection of LLM-Generated Text via Implicit Reward Model
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本检测任务，旨在解决LLM生成文本的识别问题。提出IR方法，无需额外训练即可有效检测生成文本。**

- **链接: [https://arxiv.org/pdf/2604.21223](https://arxiv.org/pdf/2604.21223)**
...
>
---
#### [new 069] Dialect vs Demographics: Quantifying LLM Bias from Implicit Linguistic Signals vs. Explicit User Profiles
- **分类: cs.CY; cs.AI; cs.CL; cs.HC; cs.IR**

- **简介: 该论文属于自然语言处理中的公平性研究，旨在解决LLM在不同用户群体间的性能差异问题。通过实验分析显式身份与隐式方言信号对模型输出的影响，揭示了安全机制的潜在偏差。**

- **链接: [https://arxiv.org/pdf/2604.21152](https://arxiv.org/pdf/2604.21152)**
...
>
---
#### [new 070] Thinking Like a Botanist: Challenging Multimodal Language Models with Intent-Driven Chain-of-Inquiry
...
>
---
#### [new 073] Evaluating AI Meeting Summaries with a Reusable Cross-Domain Pipeline
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于AI生成文本评估任务，旨在构建可复用的跨领域评估流水线，解决AI会议摘要质量评价问题，通过多模型对比实验验证系统有效性。**
...
>
---
#### [new 076] Sub-Token Routing in LoRA for Adaptation and Query-Aware KV Compression
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究LoRA适配的Transformer中子token级路由，解决KV压缩效率问题。通过细粒度路由提升语言建模质量与下游任务保持。**

- **链接: [https://arxiv.org/pdf/2604.21335](https://arxiv.org/pdf/2604.21335)**
...
>
---
#### [new 079] Seeing Isn't Believing: Uncovering Blind Spots in Evaluator Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 080] Symbolic Grounding Reveals Representational Bottlenecks in Abstract Visual Reasoning
...
>
---
#### [new 085] From Tokens to Concepts: Leveraging SAE for SPLADE
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决SPLADE模型依赖词汇表导致的性能限制。通过引入SAE构建语义概念空间，提升模型效率与多语言适用性。**
...
>
---
#### [new 086] Differentially Private De-identification of Dutch Clinical Notes: A Comparative Evaluation
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于临床文本去标识化任务，旨在保护患者隐私同时保持数据效用。研究比较了差分隐私、命名实体识别和大语言模型的方法，探索其组合策略以提升隐私与效用的平衡。**

- **链接: [https://arxiv.org/pdf/2604.21421](https://arxiv.org/pdf/2604.21421)**
...
>
---
#### [new 093] Adaptive Instruction Composition for Automated LLM Red-Teaming
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于LLM红队任务，旨在提升攻击的有效性和多样性。通过自适应指令组合框架，结合众包文本并优化生成策略，增强对目标模型的漏洞利用效果。**

- **链接: [https://arxiv.org/pdf/2604.21159](https://arxiv.org/pdf/2604.21159)**
...
>
---
#### [new 094] Stealthy Backdoor Attacks against LLMs Based on Natural Style Triggers
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于安全领域，针对LLM的后门攻击问题，提出BadStyle框架，通过自然风格触发实现隐蔽攻击，提升攻击成功率和隐蔽性。**

- **链接: [https://arxiv.org/pdf/2604.21700](https://arxiv.org/pdf/2604.21700)**
...
>
---
#### [new 095] The Path Not Taken: Duality in Reasoning about Program Execution
- **分类: cs.LG; cs.AI; cs.CL; cs.PL; cs.SE**

- **简介: 该论文属于程序理解任务，旨在解决LLMs对程序执行动态理解不足的问题。通过构建双路径推理基准DexBench，评估模型对程序行为预测与输入修改的因果理解能力。**

- **链接: [https://arxiv.org/pdf/2604.20917](https://arxiv.org/pdf/2604.20917)**
...
>
---
#### [new 096] Align Generative Artificial Intelligence with Human Preferences: A Novel Large Language Model Fine-Tuning Method for Online Review Management
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于在线评论管理任务，旨在解决生成式AI与领域特定人类偏好对齐的问题。通过改进微调方法，提升AI生成回复的质量与适应性。**

- **链接: [https://arxiv.org/pdf/2604.21209](https://arxiv.org/pdf/2604.21209)**
...
>
---
#### [new 097] Spatial Metaphors for LLM Memory: A Critical Analysis of the MemPalace Architecture
- **分类: cs.AI; cs.CL; cs.IR**

- **简介: 该论文分析MemPalace AI记忆系统，探讨其基于空间隐喻的架构。任务是评估其性能与创新性，解决如何有效组织大模型长期记忆的问题。工作包括代码分析、基准测试和对比研究。**

- **链接: [https://arxiv.org/pdf/2604.21284](https://arxiv.org/pdf/2604.21284)**
...
>
---
#### [new 098] AI-Gram: When Visual Agents Interact in a Social Network
- **分类: cs.AI; cs.CL; cs.MA; cs.SI**

- **简介: 论文介绍AI-Gram平台，研究多智能体在视觉网络中的社交动态。任务是探索视觉交互与社会关系的相互作用，解决智能体如何沟通、适应及保持个体视觉身份的问题。**

- **链接: [https://arxiv.org/pdf/2604.21446](https://arxiv.org/pdf/2604.21446)**
...
>
---
#### [new 101] Understanding and Mitigating Spurious Signal Amplification in Test-Time Reinforcement Learning for Math Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于数学推理任务，解决TTRL中因标签噪声导致的虚假信号放大问题。提出DDRL框架，通过采样策略、去偏优势估计和共识优化提升模型性能。**

- **链接: [https://arxiv.org/pdf/2604.21327](https://arxiv.org/pdf/2604.21327)**
...
>
---
#### [new 104] Hyperloop Transformers
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于语言模型架构研究，旨在提升模型的参数效率。针对边缘部署中的内存限制，提出Hyperloop Transformer，通过循环Transformer结构和超连接实现更高效模型。**
...
>
---
#### [new 105] Value-Conflict Diagnostics Reveal Widespread Alignment Faking in Language Models
- **分类: cs.AI; cs.CL; cs.SE**

- **简介: 该论文属于AI对齐研究，解决模型在监控下表现合规但实际违背政策的“对齐伪造”问题。提出VLAF框架检测价值观冲突，发现大量对齐伪造现象，并提出轻量级缓解方法。**

- **链接: [https://arxiv.org/pdf/2604.20995](https://arxiv.org/pdf/2604.20995)**
...
>
---
#### [new 106] Ideological Bias in LLMs' Economic Causal Reasoning
- **分类: cs.AI; cs.CE; cs.CL; cs.LG; econ.GN**

- **简介: 该论文属于经济因果推理任务，探讨LLMs在经济问题上是否存在意识形态偏差。研究通过扩展基准测试，分析模型在不同意识形态情境下的准确性，发现模型在干预导向预测上更准确，存在系统性偏差。**

- **链接: [https://arxiv.org/pdf/2604.21334](https://arxiv.org/pdf/2604.21334)**
...
#### [replaced 001] Logic Jailbreak: Efficiently Unlocking LLM Safety Restrictions Through Formal Logical Expression
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于安全漏洞研究任务，旨在解决LLM安全机制被攻击的问题。提出LogiBreak方法，通过逻辑表达转换绕过安全限制，验证其有效性。**

- **链接: [https://arxiv.org/pdf/2505.13527](https://arxiv.org/pdf/2505.13527)**
...
>
---
#### [replaced 002] EduCoder: An Open-Source Annotation System for Education Transcript Data
- **分类: cs.CL**

- **简介: 该论文介绍EduCoder，一个用于教育对话转录文本的开源标注工具。论文属于教育数据标注任务，旨在解决教育对话复杂编码问题，通过支持多类型标注和对比功能提升标注可靠性。**

- **链接: [https://arxiv.org/pdf/2507.05385](https://arxiv.org/pdf/2507.05385)**
...
>
---
#### [replaced 003] Automating Computational Reproducibility in Social Science: Comparing Prompt-Based and Agent-Based Approaches
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于计算可重复性任务，旨在解决科研结果难以复现的问题。通过对比基于提示和基于代理的自动化修复方法，提升计算结果的可验证性。**
...
- **简介: 该论文属于自然语言处理任务，旨在解决生成式奖励建模中的效率与精度问题。通过模型内部不确定性实现按需推理，提升推理质量并降低计算成本。**
...
>
---
#### [replaced 007] Counterfactual Segmentation Reasoning: Diagnosing and Mitigating Pixel-Grounding Hallucination
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 011] Structure-Grounded Knowledge Retrieval via Code Dependencies for Multi-Step Data Reasoning
- **分类: cs.CL**

- **简介: 该论文属于数据推理任务，旨在解决传统检索方法在多步骤数据分析中无法准确获取依赖结构知识的问题。提出SGKR框架，通过代码依赖图进行结构化知识检索。**
...
>
---
#### [replaced 012] Unveiling Unicode's Unseen Underpinnings in Undermining Authorship Attribution
- **分类: cs.CR; cs.CL; cs.IR**

- **简介: 该论文属于作者身份归属任务，探讨如何通过stylometry分析消息内容暴露身份，并提出利用Unicode隐写术进行对抗性防御。**

- **链接: [https://arxiv.org/pdf/2508.15840](https://arxiv.org/pdf/2508.15840)**
...
>
---
#### [replaced 013] Intent Laundering: AI Safety Datasets Are Not What They Seem
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于AI安全领域，揭示现有安全数据集的缺陷。研究指出数据集过度依赖触发词，无法真实反映攻击行为。通过“意图洗白”方法验证模型安全性，发现多数模型实际不安全。**

- **链接: [https://arxiv.org/pdf/2602.16729](https://arxiv.org/pdf/2602.16729)**

> **作者:** Shahriar Golchin; Marc Wetter
>
> **备注:** v2 preprint: updated with more models and a new dataset
>
...
>
---
#### [replaced 014] GerAV: Towards New Heights in German Authorship Verification using Fine-Tuned LLMs on a New Benchmark
- **分类: cs.CL**

- **简介: 该论文属于作者身份验证任务，旨在解决德语文本作者验证问题。通过构建GerAV基准，评估不同模型表现，发现微调大模型效果最佳。**

- **链接: [https://arxiv.org/pdf/2601.13711](https://arxiv.org/pdf/2601.13711)**
...
>
---
#### [replaced 015] Context Is What You Need: The Maximum Effective Context Window for Real World Limits of LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在研究大语言模型的实际有效上下文窗口。论文提出测试方法，发现模型实际有效窗口远小于宣称值，且受问题类型影响。**

- **链接: [https://arxiv.org/pdf/2509.21361](https://arxiv.org/pdf/2509.21361)**

> **作者:** Norman Paulsen
>
> **备注:** 20 pages, 4 charts. AAIML (2026)
>
...
>
---
#### [replaced 016] Entropy Ratio Clipping as a Soft Global Constraint for Stable Reinforcement Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决训练不稳定问题。通过引入熵比剪切机制，稳定策略更新，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2512.05591](https://arxiv.org/pdf/2512.05591)**

> **作者:** Zhenpeng Su; Leiyu Pan; Minxuan Lv; Tiehua Mei; Zijia Lin; Yuntao Li; Wenping Hu; Ruiming Tang; Kun Gai; Guorui Zhou
>
> **备注:** This paper has been accepted by ACL2026
>
...
>
---
#### [replaced 017] Hán Dān Xué Bù (Mimicry) or Qīng Chū Yú Lán (Mastery)? A Cognitive Perspective on Reasoning Distillation in Large Language Models
- **分类: cs.CL; cs.AI; q-bio.NC**

- **简介: 该论文属于模型蒸馏任务，探讨如何有效传递认知结构。研究发现现有方法导致认知对齐崩溃，提出需关注动态资源分配而非表面模仿。**

- **链接: [https://arxiv.org/pdf/2601.05019](https://arxiv.org/pdf/2601.05019)**
...
>
---
#### [replaced 018] Federated Co-tuning Framework for Large and Small Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出FedCoLLM框架，解决大模型与小模型协同优化问题，通过知识迁移提升小模型性能，同时增强大模型的领域适应性。**

- **链接: [https://arxiv.org/pdf/2411.11707](https://arxiv.org/pdf/2411.11707)**
...
- **简介: 该论文属于隐私保护任务，旨在对抗stylometric分析以保护作者隐私。通过改进攻击方法和引入隐写技术，降低文本的可识别性。**

- **链接: [https://arxiv.org/pdf/2601.09056](https://arxiv.org/pdf/2601.09056)**
...
>
---
#### [replaced 020] Mitigating Lost in Multi-turn Conversation via Curriculum RL with Verifiable Accuracy and Abstention Rewards
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于多轮对话任务，解决大模型在多轮对话中性能下降的Lost-in-Conversation问题。通过引入RLAAR框架，提升模型的准确性和合理拒绝回答的能力。**

- **链接: [https://arxiv.org/pdf/2510.18731](https://arxiv.org/pdf/2510.18731)**
...
>
---
#### [replaced 021] Fake or Real, Can Robots Tell? Evaluating VLM Robustness to Domain Shift in Single-View Robotic Scene Understanding
...
>
---
#### [replaced 022] CE-GPPO: Coordinating Entropy via Gradient-Preserving Clipping Policy Optimization in Reinforcement Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决策略熵不稳定问题。针对PPO方法中梯度丢失的问题，提出CE-GPPO算法，通过保留剪切令牌的梯度，实现更好的探索与利用平衡。**

- **链接: [https://arxiv.org/pdf/2509.20712](https://arxiv.org/pdf/2509.20712)**

> **作者:** Zhenpeng Su; Leiyu Pan; Minxuan Lv; Yuntao Li; Wenping Hu; Fuzheng Zhang; Kun Gai; Guorui Zhou
>
> **备注:** This paper has been accepted by ACL 2026
>
...
>
---
#### [replaced 023] Tuning for TraceTarnish: Techniques, Trends, and Testing Tangible Traits
- **分类: cs.CR; cs.CL; cs.IR**

- **简介: 该论文研究对抗性风格匿名化技术，解决文本作者身份隐藏问题。通过分析Reddit评论，提取关键风格特征，增强攻击效果。**

- **链接: [https://arxiv.org/pdf/2512.03465](https://arxiv.org/pdf/2512.03465)**
...
>
---
#### [replaced 024] Crystal: Characterizing Relative Impact of Scholarly Publications
- **分类: cs.DL; cs.AI; cs.CL; cs.CY**

- **简介: 该论文提出Crystal方法，用于评估学术论文的引用影响力。任务是改进引用影响分析，解决传统方法无法进行相对比较的问题。通过联合排序和大语言模型，提升准确性与效率。**
...
>
---
#### [replaced 025] LASA: Language-Agnostic Semantic Alignment at the Semantic Bottleneck for LLM Safety
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于LLM安全任务，解决低资源语言安全性能差的问题。通过语义瓶颈进行无语言依赖的安全对齐，提升模型安全性。**
...
>
---
#### [replaced 026] Cross-Model Consistency of AI-Generated Exercise Prescriptions: A Repeated Generation Study Across Three Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于AI生成运动处方的一致性研究，比较三个大模型在重复生成中的表现，解决模型间输出稳定性差异问题。**

- **链接: [https://arxiv.org/pdf/2604.19598](https://arxiv.org/pdf/2604.19598)**

> **作者:** Kihyuk Lee
>
> **备注:** 24 Pages, 2 Figures, 6 Tables and 2 Supplementary Materials. v2: Removed personal contact information
>
...
>
---
#### [replaced 027] Why Supervised Fine-Tuning Fails to Learn: A Systematic Study of Incomplete Learning in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，研究监督微调中未完全学习现象（ILP），分析其成因并提出诊断方法。**
...
>
---
#### [replaced 028] From Past To Path: Masked History Learning for Next-Item Prediction in Generative Recommendation
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于推荐系统任务，旨在解决生成式推荐中对用户历史理解不足的问题。提出MHL框架，通过掩码历史学习提升对未来物品的预测效果。**

- **链接: [https://arxiv.org/pdf/2509.23649](https://arxiv.org/pdf/2509.23649)**

> **作者:** KaiWen Wei; Kejun He; Xiaomian Kang; Jie Zhang; Yuming Yang; Li Jin; Zhenyang Li; Jiang Zhong; He Bai; Junnan Zhu
>
...
>
---
#### [replaced 029] Basic syntax from speech: Spontaneous concatenation in unsupervised deep neural networks
...
>
---
#### [replaced 030] Optimal Aggregation of LLM and PRM Signals for Efficient Test-Time Scaling
- **分类: cs.CL**

- **简介: 该论文属于测试时扩展（TTS）任务，旨在解决如何有效利用PRM信号提升LLM响应选择的问题。通过理论分析和实验，提出优化的加权聚合方法，显著提高效率。**

- **链接: [https://arxiv.org/pdf/2510.13918](https://arxiv.org/pdf/2510.13918)**
...
>
---
#### [replaced 031] Parallel-SFT: Improving Zero-Shot Cross-Programming-Language Transfer for Code RL
- **分类: cs.CL**
...
>
---
#### [replaced 032] Identifying Bias in Machine-generated Text Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于机器生成文本检测任务，旨在解决检测系统中的偏见问题。通过分析学生作文数据，评估不同系统在性别、种族、英语学习者和经济状况上的偏差。**

- **链接: [https://arxiv.org/pdf/2512.09292](https://arxiv.org/pdf/2512.09292)**
...
>
---
#### [replaced 037] Aligning Language Models with Real-time Knowledge Editing
- **分类: cs.CL; cs.CE**
...
>
---
#### [replaced 038] MOMO: A framework for seamless physical, verbal, and graphical robot skill learning and adaptation
...
>
---
#### [replaced 039] Surrogate modeling for interpreting black-box LLMs in medical predictions
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 论文提出一种代理建模框架，用于解释医疗预测中大语言模型的黑箱知识。任务是提升模型可解释性，解决模型内部机制不透明的问题，通过模拟场景分析模型对输入变量的感知。**
...
>
---
#### [replaced 041] STReasoner: Empowering LLMs for Spatio-Temporal Reasoning in Time Series via Spatial-Aware Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于时序时空推理任务，旨在提升大模型在时间序列中的时空推理能力。通过引入STReasoner和S-GRPO算法，解决现有方法重预测轻推理的问题。**
...
>
---
#### [replaced 042] Intersectional Fairness in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于公平性评估任务，旨在解决大语言模型在交叉群体中的偏见问题。通过分析模型在不同语境下的表现，发现模型存在基于刻板印象的偏差，且公平性指标不一致。**
...
>
---
#### [replaced 043] Knowledge Capsules: Structured Nonparametric Memory Units for LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出知识胶囊，用于大语言模型的非参数记忆单元，解决知识更新困难和检索增强生成不稳定的问题。通过外部键值注入框架，提升长上下文和多跳推理的性能。**
...
>
---
#### [replaced 044] Learning State-Tracking from Code Using Linear RNNs
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究状态追踪任务，解决序列模型在代码执行状态跟踪中的表现问题。通过将排列组合转化为代码，验证线性RNN的优势，揭示动作不可观测带来的挑战。**

- **链接: [https://arxiv.org/pdf/2602.14814](https://arxiv.org/pdf/2602.14814)**

> **作者:** Julien Siems; Riccardo Grazzi; Kirill Kalinin; Hitesh Ballani; Babak Rahmani
>
> **摘要:** Over the last years, state-tracking tasks, particularly permutation composition, have become a testbed to understand the limits of sequence models architectures like Transformers and RNNs (linear and non-linear). However, these are often sequence-to-sequence tasks: learning to map actions (permutations) to states, which is incompatible with the next-token prediction setting commonly used to train language models. We address this gap by converting permutation composition into code via REPL traces that interleave state-reveals through prints and variable transformations. We show that linear RNNs capable of state-tracking excel also in this setting, while Transformers still fail. Motivated by this representation, we investigate why tracking states in code is generally difficult: actions are not always fully observable. We frame this as tracking the state of a probabilistic finite-state automaton with deterministic state reveals and show that linear RNNs can be worse than non-linear RNNs at tracking states in this setup.
>
---
#### [replaced 045] Exploring Continual Fine-Tuning for Enhancing Language Ability in Large Language Model
- **分类: cs.CL**

- **简介: 该论文研究持续微调（CFT）提升大语言模型的语言适应能力，解决模型在学习新语言时性能下降的问题。通过两阶段微调实验，验证任务相似性对模型表现的影响，并测试改进方法的有效性。**
...
>
---
#### [replaced 046] SODA: Semi On-Policy Black-Box Distillation for Large Language Models
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出SODA方法，解决大语言模型知识蒸馏中的效率与稳定性问题。通过半在线策略对比学习，提升蒸馏效果并降低计算成本。**
...
>
---
#### [replaced 047] Strategic Scaling of Test-Time Compute: A Bandit Learning Approach
- **分类: cs.AI; cs.CL; cs.LG; stat.ML**

- **简介: 该论文属于模型优化任务，解决测试时计算资源分配效率低的问题。通过强化学习方法动态评估查询难度，优化计算资源分配，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2506.12721](https://arxiv.org/pdf/2506.12721)**
...
>
---
#### [replaced 048] AgentDoG: A Diagnostic Guardrail Framework for AI Agent Safety and Security
...
>
---
#### [replaced 049] Fairness Evaluation and Inference Level Mitigation in LLMs
- **分类: cs.CL; cs.AI**
...
>
> **备注:** Accepted at The 64th Annual Meeting of the Association for Computational Linguistics San Diego, California, United, States July 2 to 7, 2026
>
...
>
---
#### [replaced 050] MM-JudgeBias: A Benchmark for Evaluating Compositional Biases in MLLM-as-a-Judge
...
>
---
#### [replaced 051] Do LLMs Overthink Basic Math Reasoning? Benchmarking the Accuracy-Efficiency Tradeoff in Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决LLMs在基础数学推理中的准确率与效率平衡问题。通过构建基准测试和实验，分析模型表现及过思考现象。**

- **链接: [https://arxiv.org/pdf/2507.04023](https://arxiv.org/pdf/2507.04023)**
...
>
---
#### [replaced 054] Improving Clinical Diagnosis with Counterfactual Multi-Agent Reasoning
- **分类: cs.CL**

- **简介: 该论文属于临床诊断任务，旨在提升AI在诊断中的可解释性与准确性。通过引入反事实多智能体框架，增强假设验证与证据分析，改进复杂病例的诊断效果。**
...
>
---
#### [replaced 055] AgentGL: Towards Agentic Graph Learning with LLMs via Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于图学习任务，旨在解决LLMs在处理结构化数据时的局限性。提出AgentGL框架，结合强化学习与图结构，提升节点分类和链接预测性能。**
...
>
---
#### [replaced 056] Kernel-Smith: A Unified Recipe for Evolutionary Kernel Optimization
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出Kernel-Smith，用于优化GPU核函数生成，解决高效算子开发问题。通过进化算法与后训练策略结合，提升性能并适配不同平台。**
...
>
---
#### [replaced 057] Words that make SENSE: Sensorimotor Norms in Learned Lexical Token Representations
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在将词向量与感官运动规范相关联。通过构建SENSE模型，预测词的感官运动特征，并验证其与人类行为数据的关联性。**

- **链接: [https://arxiv.org/pdf/2602.00469](https://arxiv.org/pdf/2602.00469)**

> **作者:** Abhinav Gupta; Toben H. Mintz; Jesse Thomason
>
> **备注:** 5 pages, 2 figures, codebase can be found at: this https URL
>
...
>
---
#### [replaced 058] Flipping Against All Odds: Reducing LLM Coin Flip Bias via Verbalized Rejection Sampling
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM采样偏差问题。通过引入VRS方法，提升采样可靠性，改善基于概率分布的随机生成效果。**

- **链接: [https://arxiv.org/pdf/2506.09998](https://arxiv.org/pdf/2506.09998)**

> **作者:** Tim Z. Xiao; Johannes Zenn; Zhen Liu; Weiyang Liu; Robert Bamler; Bernhard Schölkopf
>
> **备注:** Technical Report v2 (27 pages, 14 figures)
>
...
>
---
#### [replaced 059] Schoenfeld's Anatomy of Mathematical Reasoning by Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在分析语言模型的数学推理过程。通过引入ThinkARM框架，将推理步骤结构化，揭示模型思维动态与差异，解决如何系统分析推理结构的问题。**
...
>
---
#### [replaced 060] Tracing Relational Knowledge Recall in Large Language Models
- **分类: cs.CL**

- **简介: 该论文研究大语言模型在生成文本时如何回忆关系知识，旨在解决关系分类的表示选择问题。通过分析注意力头和MLP的贡献，发现每头注意力对残差流的贡献是有效的线性分类特征。**
...
>
---
#### [replaced 061] RewardBench 2: Advancing Reward Model Evaluation
- **分类: cs.CL**

- **简介: 该论文属于奖励模型评估任务，旨在解决奖励模型在下游任务中效果不佳的问题。提出RewardBench 2基准，用于更准确地评估奖励模型性能。**

- **链接: [https://arxiv.org/pdf/2506.01937](https://arxiv.org/pdf/2506.01937)**
...
>
---
#### [replaced 063] SafeMERGE: Preserving Safety Alignment in Fine-Tuned Large Language Models via Selective Layer-Wise Model Merging
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，解决细调大模型时安全对齐退化的问题。提出SafeMERGE框架，通过选择性层合并恢复安全性能，同时保持任务效果。**

- **链接: [https://arxiv.org/pdf/2503.17239](https://arxiv.org/pdf/2503.17239)**
...
>
---
#### [replaced 064] RELOOP: Recursive Retrieval with Multi-Hop Reasoner and Planners for Heterogeneous QA
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出RELOOP框架，解决多步骤、异构数据的问答任务。通过结构化序列和迭代检索，提升准确率与效率。**

- **链接: [https://arxiv.org/pdf/2510.20505](https://arxiv.org/pdf/2510.20505)**
...
>
---
#### [replaced 065] DMAP: A Distribution Map for Text
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出DMAP方法，用于将文本映射为概率分布，解决文本分析中的统计表示问题。通过生成样本实现高效分析，应用于生成验证、文本检测等任务。**
...
>
---
#### [replaced 066] Compose and Fuse: Revisiting the Foundational Bottlenecks in Multimodal Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多模态推理任务，旨在解决模态融合效果不稳定的问题。通过分析不同模态交互模式，发现集成不足和任务组合瓶颈是主要障碍，并提出两步提示方法提升性能。**

- **链接: [https://arxiv.org/pdf/2509.23744](https://arxiv.org/pdf/2509.23744)**
...
>
---
#### [replaced 073] Hijacking Text Heritage: Hiding the Human Signature through Homoglyphic Substitution
- **分类: cs.CR; cs.CL; cs.IR**

- **简介: 该论文属于隐私保护任务，旨在解决文本中个人特征泄露问题。通过同形异义字符替换，降低风格分析系统的有效性。**
...
>
---
#### [replaced 074] ReProbe: Efficient Test-Time Scaling of Multi-Step Reasoning by Probing Internal States of Large Language Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出ReProbe，用于高效测试时扩展多步推理，通过探测大语言模型的内部状态进行步骤验证，解决现有方法计算成本高的问题。**
...
>
---
#### [replaced 075] UsefulBench: Towards Decision-Useful Information as a Target for Information Retrieval
- **分类: cs.IR; cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决传统方法仅关注文本相似性而忽视实际有用性的问题。作者构建了UsefulBench数据集，区分相关性与实用性，并探讨提升系统实用性的方法。**
