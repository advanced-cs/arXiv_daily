...
- **简介: 该论文属于图像复原任务，旨在解决低光照图像中高频细节恢复与噪声抑制的问题。论文对比了SwinIR模型与轻量级CNN的性能与效率，发现CNN在复原效果接近SwinIR的同时，具有显著更低的计算开销和更快的训练收敛速度，适用于资源受限的实际场景。**
...
- **简介: 该论文属于视觉-语言模型（VLM）中的机器遗忘任务，旨在解决模型在推理过程中可能泄露训练阶段记忆的敏感信息问题。作者提出了一种名为CAGUL的轻量级框架，利用跨模态注意力机制识别并修改对输出影响较小的视觉标记，从而避免敏感信息泄露，同时保持模型原有性能。**
...
- **简介: 该论文属于自动化排版设计任务，旨在解决在广告和网页布局中自动放置文本框的问题。研究比较了多种模型，包括基于Transformer的方法和视觉语言模型（VLM），在Crello数据集上进行评估，发现Transformer模型表现更优，尤其在处理外观信息丰富的布局时。论文强调了任务专用架构的优势，并指出了当前方法在小文本或密集布局中的局限性。**
...
- **简介: 该论文属于人体姿态估计任务，旨在解决基于事件相机的高效实时姿态估计问题。作者提出了GraphEnet，一种基于图神经网络的新方法，利用事件相机数据的稀疏性，结合线性事件表示和置信度池化策略，实现高频率的2D人体姿态估计。这是首次将图神经网络应用于事件数据进行姿态估计。**
...
- **简介: 该论文属于视频超分辨率任务，旨在解决多模态条件下生成高分辨率视频的问题。现有方法局限于文本到视频生成，未充分利用多种条件。论文提出了UniMMVSR，首个融合文本、图像和视频多模态条件的级联视频超分框架，优化条件注入与训练策略，显著提升视频质量和多模态一致性。**
...
- **简介: 该论文属于图像编辑任务，旨在解决文本生成模型在物体精确定位和拖动编辑上的局限性。作者提出InstructUDrag框架，结合文本指令与物体拖动，通过双分支结构实现高精度物体移动和语义编辑，提升了图像编辑的灵活性与质量。**
...
- **简介: 该论文属于3D渲染任务，旨在解决大规模场景中3D高斯点渲染的走样问题。提出了PrismGS框架，通过多尺度监督和尺寸正则化提升渲染质量，有效缓解纹理闪烁和锯齿边缘问题，实现高保真、稳定的大规模城市场景渲染。**
...
- **简介: 该论文属于科学视频推理任务，旨在解决当前多模态模型在复杂科学视频理解中的不足。作者构建了包含1000道多选题的SciVideoBench，覆盖25个学科，评估模型的高级认知能力，发现现有模型表现不佳，指出改进方向。**
...
- **简介: 该论文属于视频生成任务，旨在解决从任意时空补丁生成完整视频的问题。现有方法因因果VAE导致时间模糊，难以精确控制。论文提出VideoCanvas框架，通过零填充和时序RoPE插值实现空间与时间解耦控制，无需新增参数，提升了生成效果，统一了多种视频生成任务，并构建了新基准VideoCanvasBench。**
...
- **简介: 该论文属于自动驾驶中的视频生成任务，旨在解决高保真、多视角视频生成与场景理解问题。作者提出CVD-STORM模型，结合空间-时间重建VAE与扩散模型，提升生成质量与4D重建能力，并通过高斯溅射解码器增强几何信息表达。**
...
- **简介: 该论文属于图像处理任务，旨在解决现有图像润色方法依赖大量配对数据且不可解释的问题。作者提出RetouchLLM，一种无需训练的白盒图像润色系统，通过视觉批评和代码生成模块，实现高分辨率图像的可解释、多步骤润色，支持自然语言交互，提升调整的可控性与适应性。**
...
- **简介: 该论文属于图文检索任务，旨在解决跨模态推理不透明、难以遵循复杂指令的问题。作者提出CIR-CoT模型，通过引入可解释的思维链推理，提升检索准确性和透明度，并构建了新的标注数据。**
...
- **简介: 该论文属于视频生成任务，旨在解决现有视频补间技术难以生成复杂运动、缺乏用户控制的问题。论文提出MultiCOIN框架，支持多种用户控制方式，如深度过渡、轨迹和文本提示，采用Diffusion Transformer架构和双分支生成器设计，实现精细的视频插值生成。**
...
- **简介: 该论文属于图像处理任务，旨在提升图像分析与计算机视觉中的特征提取与图像增强效果。作者提出一种模块化框架，整合了灰度量化、色彩增强、图像锐化、双向变换流水线及几何特征提取。通过分步强度转换、色彩空间调整、卷积核锐化及边缘检测等方法，实现图像的高效处理与特征识别，应用于如台球杆定位等场景。**
...
- **简介: 该论文属于图像与视频编辑任务，旨在解决多模态大语言模型（MLLM）与扩散模型整合不足、视频编辑数据稀缺的问题。论文提出了InstructX框架，通过分析MLLM设计选择，实现图像和视频编辑的统一建模，有效提升了编辑性能。**
...
- **简介: 该论文属于三维场景重建任务，旨在解决驾驶场景中因相机配置变化和稀疏视角导致的泛化能力与重建精度不足问题。论文提出XYZCylinder模型，通过统一圆柱相机建模与特征提升方法，实现更优的前馈重建效果。**
...
>
---
#### [new 045] RePainter: Empowering E-commerce Object Removal via Spatial-matting Reinforcement Learning
- **分类: cs.CV**
...
- **简介: 该论文属于文本检测任务，旨在解决动漫场景中文本检测效果差的问题。现有数据集多针对自然或文档场景，而动漫文本风格多样、排列不规则，易与符号混淆。论文构建了大规模动漫文本数据集AnimeText，包含735K图像和4.2M标注文本块，提供分层标注和困难负样本，提升了模型在复杂动漫场景中的检测性能。**
...
- **简介: 该论文属于图像重建任务，旨在解决成像逆问题中收敛速度与重建质量难以兼顾的问题。作者提出RISP方法，结合重启动量加速与基于得分的图像先验，在非凸先验下理论证明了更快的收敛速度，并通过实验验证其有效性。**
...
- **简介: 该论文属于图像分类任务，旨在解决CapsNet计算速度慢的问题。作者提出了Quick-CapsNet（QCN），通过减少胶囊数量提升计算效率，实现更快的推理速度，适用于实时应用。在多个数据集上验证了QCN的速度优势，并通过改进解码器提升性能。**
...
- **链接: [http://arxiv.org/pdf/2510.07828v1](http://arxiv.org/pdf/2510.07828v1)**
...
- **链接: [http://arxiv.org/pdf/2510.07654v1](http://arxiv.org/pdf/2510.07654v1)**
...
- **简介: 该论文属于视频生成任务，旨在解决图像到视频生成中的灵活点轨迹控制问题。论文提出FlexTraj框架，采用基于点的统一运动表示，通过序列拼接方式注入轨迹条件，实现高效可控的视频生成，支持多种应用如动作控制、运动插值等。**
...
>
---
#### [new 059] Real-Time Motion-Controllable Autoregressive Video Diffusion
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决实时运动可控视频生成中的延迟和质量下降问题。作者提出了AR-Drag，一种基于强化学习的自回归视频扩散模型，支持多样化的运动控制，提升了生成速度与视觉质量。**

- **链接: [http://arxiv.org/pdf/2510.08131v1](http://arxiv.org/pdf/2510.08131v1)**
...
>
---
#### [new 060] Physics-Driven Spatiotemporal Modeling for AI-Generated Video Detection
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于AI生成视频检测任务，旨在解决AI生成视频难以检测的问题。论文提出了一种基于物理驱动的检测方法NSG-VD，通过建模时空概率流守恒原理，利用Normalized Spatiotemporal Gradient（NSG）统计量和最大均值差异（MMD）进行检测，理论分析和实验验证了其优越性能。**

- **链接: [http://arxiv.org/pdf/2510.08073v1](http://arxiv.org/pdf/2510.08073v1)**
...
>
---
#### [new 061] Enhancing Visual Prompting through Expanded Transformation Space and Overfitting Mitigation
- **分类: cs.CV**

- **简介: 该论文属于视觉提示（Visual Prompting）任务，旨在解决现有方法在表达能力和过拟合方面的局限性。作者提出ACAVP方法，结合仿射、颜色和加法变换增强表达性，并引入TrivialAugment缓解过拟合，提升了图像分类性能和鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.07823v1](http://arxiv.org/pdf/2510.07823v1)**
...
>
---
#### [new 062] Random Window Augmentations for Deep Learning Robustness in CT and Liver Tumor Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分析任务，旨在提升CT影像中肝脏肿瘤分割的深度学习模型鲁棒性。论文指出直接应用自然图像增强方法会导致CT图像出现伪影和泛化能力差的问题，提出了一种基于CT图像灰度分布的“随机窗口增强”方法，增强了模型对对比度变化的适应能力，提升了分割效果。**

- **链接: [http://arxiv.org/pdf/2510.08116v1](http://arxiv.org/pdf/2510.08116v1)**
...
>
---
#### [new 063] Have We Scene It All? Scene Graph-Aware Deep Point Cloud Compression
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于点云压缩任务，旨在解决3D点云数据在带宽受限下的高效传输问题。论文提出一种基于语义场景图的深度压缩框架，通过语义感知编码和折叠式解码实现高保真重建，显著减少数据量并支持多机器人应用。**
...
>
---
#### [new 064] D2RA: Dual Domain Regeneration Attack
- **分类: cs.CV**

- **简介: 该论文属于图像水印攻击任务，旨在解决现有水印方法在对抗攻击下鲁棒性不足的问题。作者提出D2RA，一种无需训练、基于单张图像的攻击方法，通过在互补表示空间中投影图像来抑制水印信号，从而降低水印可检测性，同时保持视觉质量。**

- **链接: [http://arxiv.org/pdf/2510.07538v1](http://arxiv.org/pdf/2510.07538v1)**

> **作者:** Pragati Shuddhodhan Meshram; Varun Chandrasekaran
>
> **摘要:** The growing use of generative models has intensified the need for watermarking methods that ensure content attribution and provenance. While recent semantic watermarking schemes improve robustness by embedding signals in latent or frequency representations, we show they remain vulnerable even under resource-constrained adversarial settings. We present D2RA, a training-free, single-image attack that removes or weakens watermarks without access to the underlying model. By projecting watermarked images onto natural priors across complementary representations, D2RA suppresses watermark signals while preserving visual fidelity. Experiments across diverse watermarking schemes demonstrate that our approach consistently reduces watermark detectability, revealing fundamental weaknesses in current designs. Our code is available at https://github.com/Pragati-Meshram/DAWN.
>
---
#### [new 065] Video-STAR: Reinforcing Open-Vocabulary Action Recognition with Tools
- **分类: cs.CV**

- **简介: 该论文属于开放词汇动作识别任务，旨在解决细粒度动作区分和跨模态幻觉问题。论文提出Video-STAR框架，通过子动作分解和工具增强的强化学习，实现更精准的跨模态匹配与推理，提升动作识别的鲁棒性和泛化能力。**

- **链接: [http://arxiv.org/pdf/2510.08480v1](http://arxiv.org/pdf/2510.08480v1)**
...
>
---
#### [new 068] IsoSignVid2Aud: Sign Language Video to Audio Conversion without Text Intermediaries
...
>
---
#### [new 069] SPICE: Simple and Practical Image Clarification and Enhancement
- **分类: cs.CV**

- **简介: 该论文属于图像增强任务，旨在解决低光和雾霾等恶劣条件下图像质量差的问题。作者提出了一种简单高效的图像滤波方法，通过模拟低光或雾霾条件并设计逆滤波器来减少失真，从而提升图像清晰度。实验表明该方法在处理极暗和雾霾图像方面优于现有技术。**

- **链接: [http://arxiv.org/pdf/2510.08358v1](http://arxiv.org/pdf/2510.08358v1)**

> **作者:** Alexander Belyaev; Pierre-Alain Fayolle; Michael Cohen
>
> **备注:** 5 pages, 8 figures
>
> **摘要:** We introduce a simple and efficient method to enhance and clarify images. More specifically, we deal with low light image enhancement and clarification of hazy imagery (hazy/foggy images, images containing sand dust, and underwater images). Our method involves constructing an image filter to simulate low-light or hazy conditions and deriving approximate reverse filters to minimize distortions in the enhanced images. Experimental results show that our approach is highly competitive and often surpasses state-of-the-art techniques in handling extremely dark images and in enhancing hazy images. A key advantage of our approach lies in its simplicity: Our method is implementable with just a few lines of MATLAB code.
>
---
#### [new 070] RASALoRE: Region Aware Spatial Attention with Location-based Random Embeddings for Weakly Supervised Anomaly Detection in Brain MRI Scans
- **分类: cs.CV**

- **简介: 该论文属于弱监督异常检测任务，旨在解决脑部MRI扫描中缺乏像素级标注的问题。作者提出了RASALoRE框架，结合区域感知的空间注意力机制与位置随机嵌入，实现高效、精准的异常检测。**

- **链接: [http://arxiv.org/pdf/2510.08052v1](http://arxiv.org/pdf/2510.08052v1)**
...
>
---
#### [new 073] MONKEY: Masking ON KEY-Value Activation Adapter for Personalization
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在解决个性化扩散模型中主体与文本提示融合不足的问题。通过改进IP-Adapter，利用自动生成的掩码在二次推理中限制图像令牌仅保留主体，使文本提示更准确地影响背景生成，提升了生成图像与提示及源图的一致性。**

- **链接: [http://arxiv.org/pdf/2510.07656v1](http://arxiv.org/pdf/2510.07656v1)**
...
>
---
#### [new 074] Improving Temporal Understanding Logic Consistency in Video-Language Models via Attention Enhancement
- **分类: cs.CV; cs.AI; cs.MM**

- **简介: 该论文属于视频-语言模型任务，旨在解决模型在时序理解上的逻辑不一致问题。作者通过可解释性分析发现，问题源于跨模态注意力机制难以区分不同时间戳的视频内容。为此，他们提出了一种注意力增强方法TCAS，提升模型对时间信息的分辨能力，从而改善时序逻辑一致性，并在相关任务上验证了方法有效性。**

- **链接: [http://arxiv.org/pdf/2510.08138v1](http://arxiv.org/pdf/2510.08138v1)**
...
>
---
#### [new 079] Controllable Video Synthesis via Variational Inference
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频生成任务，旨在解决现有模型输入格式固定、难以兼顾用户对视频内容不同粒度控制的问题。通过变分推断方法，结合多模型约束，实现对指定元素的高可控性与未指定部分的多样性生成，提升了生成视频的可控性、多样性和3D一致性。**

- **链接: [http://arxiv.org/pdf/2510.07670v1](http://arxiv.org/pdf/2510.07670v1)**

> **作者:** Haoyi Duan; Yunzhi Zhang; Yilun Du; Jiajun Wu
>
> **备注:** Project page: https://video-synthesis-variational.github.io/
>
...
>
---
#### [new 080] RayFusion: Ray Fusion Enhanced Collaborative Visual Perception
- **分类: cs.CV**

- **简介: 该论文属于自动驾驶中的协同视觉感知任务，旨在解决相机感知系统深度估计不准确的问题。通过提出RayFusion方法，利用射线占用信息减少冗余和误检，提升检测性能。实验表明其方法优于现有模型。**

- **链接: [http://arxiv.org/pdf/2510.08017v1](http://arxiv.org/pdf/2510.08017v1)**
...
>
> **摘要:** Collaborative visual perception methods have gained widespread attention in the autonomous driving community in recent years due to their ability to address sensor limitation problems. However, the absence of explicit depth information often makes it difficult for camera-based perception systems, e.g., 3D object detection, to generate accurate predictions. To alleviate the ambiguity in depth estimation, we propose RayFusion, a ray-based fusion method for collaborative visual perception. Using ray occupancy information from collaborators, RayFusion reduces redundancy and false positive predictions along camera rays, enhancing the detection performance of purely camera-based collaborative perception systems. Comprehensive experiments show that our method consistently outperforms existing state-of-the-art models, substantially advancing the performance of collaborative visual perception. The code is available at https://github.com/wangsh0111/RayFusion.
>
---
#### [new 081] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
- **分类: cs.CV**

- **简介: 该论文属于动态3D高斯重建任务，旨在解决低帧率RGB视频重建中大帧间运动带来的不确定性问题。通过结合事件相机的高帧率和运动轨迹约束，提出DEGS框架，利用事件流估计运动先验，指导动态高斯变形场优化，实现更准确的3D重建。**

- **链接: [http://arxiv.org/pdf/2510.07752v1](http://arxiv.org/pdf/2510.07752v1)**
...
>
---
#### [new 082] Latent Harmony: Synergistic Unified UHD Image Restoration via Latent Space Regularization and Controllable Refinement
- **分类: cs.CV**

- **简介: 该论文属于图像超高清修复任务，旨在解决计算效率与高频细节保留的权衡问题。提出Latent Harmony框架，通过潜空间正则化与可控优化，结合LH-VAE与HF-LoRA，提升UHD图像修复质量，兼顾真实感与细节还原。**

- **链接: [http://arxiv.org/pdf/2510.07961v1](http://arxiv.org/pdf/2510.07961v1)**
...
>
---
#### [new 083] Demystifying Deep Learning-based Brain Tumor Segmentation with 3D UNets and Explainable AI (XAI): A Comparative Analysis
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在提升脑肿瘤分割的准确性和可解释性。研究比较了UNet、ResUNet和AttUNet模型，结合XAI技术增强模型决策理解。结果显示ResUNet性能最佳，推荐其用于未来临床评估。**

- **链接: [http://arxiv.org/pdf/2510.07785v1](http://arxiv.org/pdf/2510.07785v1)**
...
>
---
#### [new 084] ReSplat: Learning Recurrent Gaussian Splats
- **分类: cs.CV**

- **简介: 该论文属于三维重建任务，旨在解决单次前向传递限制高斯泼溅模型性能的问题。提出了ReSplat，一种递归高斯泼溅模型，通过迭代优化3D高斯分布，无需显式计算梯度。利用渲染误差作为反馈信号，提升模型泛化能力，并引入紧凑重建模型减少计算开销，实现高效渲染。**

- **链接: [http://arxiv.org/pdf/2510.08575v1](http://arxiv.org/pdf/2510.08575v1)**
...
>
---
#### [new 085] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，旨在解决极端姿态下人脸解析标注数据不足的问题。通过结合RGB图像和初始分割图的3D高斯泼溅模型，实现多视角一致性的标签优化，生成多样姿态训练数据，提升模型在极端姿态下的解析准确性。**

- **链接: [http://arxiv.org/pdf/2510.08096v1](http://arxiv.org/pdf/2510.08096v1)**
...
>
---
#### [new 092] MaizeStandCounting (MaSC): Automated and Accurate Maize Stand Counting from UAV Imagery Using Image Processing and Deep Learning
- **分类: cs.CV**

- **简介: 该论文属于农业图像处理与深度学习任务，旨在解决人工统计玉米出苗数效率低、易出错的问题。作者提出了MaSC算法，利用轻量级YOLOv9模型检测玉米幼苗，并通过图像分割实现行间计数，支持无人机拍摄的拼接图像和视频帧两种输入模式，验证了其高效性与准确性。**

- **链接: [http://arxiv.org/pdf/2510.07580v1](http://arxiv.org/pdf/2510.07580v1)**
...
>
---
#### [new 101] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
- **分类: cs.CV**

- **简介: 该论文属于三维重建任务，旨在解决单目图像序列的实时高质量重建问题。论文提出ARTDECO框架，结合SLAM与前馈模型优势，通过3D基础模型与高斯解码器实现高效、高保真的实时重建。**

- **链接: [http://arxiv.org/pdf/2510.08551v1](http://arxiv.org/pdf/2510.08551v1)**
...
>
---
#### [new 102] Kontinuous Kontext: Continuous Strength Control for Instruction-based Image Editing
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像编辑任务，旨在解决基于文本指令的图像编辑中缺乏对编辑强度细粒度控制的问题。作者提出了Kontinuous Kontext模型，通过引入可调节的标量编辑强度输入，实现从无修改到完全修改的连续控制。该方法扩展了现有模型，并训练了一个轻量级投影网络来映射标量和指令到调制空间，实现了统一的强度调节机制。**

- **链接: [http://arxiv.org/pdf/2510.08532v1](http://arxiv.org/pdf/2510.08532v1)**

> **作者:** Rishubh Parihar; Or Patashnik; Daniil Ostashev; R. Venkatesh Babu; Daniel Cohen-Or; Kuan-Chieh Wang
>
> **备注:** Project Page: https://snap-research.github.io/kontinuouskontext/
>
> **摘要:** Instruction-based image editing offers a powerful and intuitive way to manipulate images through natural language. Yet, relying solely on text instructions limits fine-grained control over the extent of edits. We introduce Kontinuous Kontext, an instruction-driven editing model that provides a new dimension of control over edit strength, enabling users to adjust edits gradually from no change to a fully realized result in a smooth and continuous manner. Kontinuous Kontext extends a state-of-the-art image editing model to accept an additional input, a scalar edit strength which is then paired with the edit instruction, enabling explicit control over the extent of the edit. To inject this scalar information, we train a lightweight projector network that maps the input scalar and the edit instruction to coefficients in the model's modulation space. For training our model, we synthesize a diverse dataset of image-edit-instruction-strength quadruplets using existing generative models, followed by a filtering stage to ensure quality and consistency. Kontinuous Kontext provides a unified approach for fine-grained control over edit strength for instruction driven editing from subtle to strong across diverse operations such as stylization, attribute, material, background, and shape changes, without requiring attribute-specific training.
>
---
#### [new 103] Gaze on the Prize: Shaping Visual Attention with Return-Guided Contrastive Learning
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 104] Biology-driven assessment of deep learning super-resolution imaging of the porosity network in dentin
- **分类: cs.LG; cs.CV; q-bio.TO**

- **简介: 该论文属于图像超分辨率重建任务，旨在解决牙本质孔隙网络成像中分辨率与视场之间的矛盾。作者应用多种深度学习超分辨率模型，提升低分辨率图像质量，并通过生物学驱动的评估方法分析模型在保留孔隙结构和连通性方面的表现，从而优化牙齿孔隙网络的成像效果。**

- **链接: [http://arxiv.org/pdf/2510.08407v1](http://arxiv.org/pdf/2510.08407v1)**
...
>
---
#### [new 105] MLLM4TS: Leveraging Vision and Multimodal Language Models for General Time-Series Analysis
- **分类: cs.LG; cs.AI; cs.CV; cs.DB**

- **简介: 该论文属于时间序列分析任务，旨在解决多变量时间序列中复杂时序依赖和跨通道交互的建模难题。论文提出MLLM4TS框架，将时间序列可视化为图像，结合视觉与语言模型，融合细粒度时序信息与全局上下文，实现高效的预测与生成任务。**

- **链接: [http://arxiv.org/pdf/2510.07513v1](http://arxiv.org/pdf/2510.07513v1)**
...
>
---
#### [new 106] Curriculum Learning with Synthetic Data for Enhanced Pulmonary Nodule Detection in Chest Radiographs
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在提升胸部X光片中肺结节检测效果，特别是对小尺寸、低亮度和对比度的结节。通过结合课程学习与扩散模型生成的合成数据增强，使用Faster R-CNN与FPN结构训练模型，并在多个难度等级上验证性能提升。**

- **链接: [http://arxiv.org/pdf/2510.07681v1](http://arxiv.org/pdf/2510.07681v1)**
...
>
---
#### [new 107] Test-Time Matching: Unlocking Compositional Reasoning in Multimodal Models
...
>
---
#### [new 108] IntentionVLA: Generalizable and Efficient Embodied Intention Reasoning for Human-Robot Interaction
...
>
---
#### [new 109] Spectral Prefiltering of Neural Fields
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于神经场表示与优化任务，旨在解决神经场在固定分辨率下难以高效实现多尺度滤波的问题。论文提出一种频域预滤波方法，通过解析调制傅里叶特征实现卷积滤波，支持多种参数化滤波器，并使用单样本蒙特卡洛估计训练，提升了训练与推理效率及滤波效果。**

- **链接: [http://arxiv.org/pdf/2510.08394v1](http://arxiv.org/pdf/2510.08394v1)**

> **作者:** Mustafa B. Yaldiz; Ishit Mehta; Nithin Raghavan; Andreas Meuleman; Tzu-Mao Li; Ravi Ramamoorthi
>
> **备注:** 16 pages, 10 figures, to be published in Siggraph Asia 2025, Website: https://myaldiz.info/assets/spnf
>
...
>
---
#### [new 110] How to Teach Large Multimodal Models New Skills
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文研究如何在不遗忘原有能力的前提下，逐步微调大型多模态模型（LMMs）以学习新技能。通过监控多个模型家族的八项基准任务，发现微调后的能力损失可部分恢复，并提出两种微调策略：仅更新自注意力投影层，或仅更新MLP的Gate&Up部分而冻结Down投影，有效平衡学习与遗忘。**

- **链接: [http://arxiv.org/pdf/2510.08564v1](http://arxiv.org/pdf/2510.08564v1)**
...
>
---
#### [new 111] X2Video: Adapting Diffusion Models for Multimodal Controllable Neural Video Rendering
- **分类: cs.GR; cs.CV; 68U05; I.3.3; I.3.6**

- **简介: 该论文属于视频生成任务，旨在解决生成长序列、时序一致且可多模控制的高质量视频问题。作者提出了X2Video，通过扩展图像生成模型XRGB，引入混合自注意力、掩码交叉注意力和递归采样方法，实现基于内在属性和多模态输入的视频编辑与生成。**

- **链接: [http://arxiv.org/pdf/2510.08530v1](http://arxiv.org/pdf/2510.08530v1)**
...
>
---
#### [new 114] Deep Learning Based Approach to Enhanced Recognition of Emotions and Behavioral Patterns of Autistic Children
- **分类: cs.LG; cs.AI; cs.CV; cs.HC**

- **简介: 该论文属于情感与行为识别任务，旨在解决自闭症儿童早期情感与行为模式理解不足的问题。通过纵向监测其情绪与行为，建立基础认知，提出针对性技术干预框架，促进个性化教育和技能发展。**

- **链接: [http://arxiv.org/pdf/2510.07320v1](http://arxiv.org/pdf/2510.07320v1)**
...
>
---
#### [new 115] MMM: Quantum-Chemical Molecular Representation Learning for Combinatorial Drug Recommendation
- **分类: cs.LG; cs.AI; cs.CV; I.2.6; I.5.1**

- **简介: 该论文属于药物推荐任务，旨在解决药物组合中的药物相互作用风险问题。作者提出MMM框架，结合量子化学电子密度信息与图神经网络，学习药物分子的三维表示，以更准确预测药物相互作用，提升临床用药安全性。**

- **链接: [http://arxiv.org/pdf/2510.07910v1](http://arxiv.org/pdf/2510.07910v1)**
...
>
---
#### [new 116] Scalable Offline Metrics for Autonomous Driving
- **分类: cs.RO; cs.CV**

- **简介: 论文研究自动驾驶中离线评估指标的可扩展性问题，旨在解决离线评估与在线实际表现之间的差距。作者通过仿真与真实场景实验，提出基于认知不确定性的新离线指标，显著提升与在线表现的相关性，改进现有评估方法效果。**
...
>
---
#### [new 117] FlowLensing: Simulating Gravitational Lensing with Flow Matching
- **分类: astro-ph.IM; cs.CV**

- **简介: 该论文属于图像仿真任务，旨在解决传统引力透镜模拟方法速度慢的问题。作者提出FlowLensing，一种基于扩散变换器的高效模型，可快速生成高保真强引力透镜图像，支持暗物质研究，尤其适用于大规模宇宙巡天中的暗物质子结构探测。**

- **链接: [http://arxiv.org/pdf/2510.07878v1](http://arxiv.org/pdf/2510.07878v1)**
...
>
---
#### [new 118] AI-Driven Radiology Report Generation for Traumatic Brain Injuries
- **分类: eess.IV; cs.AI; cs.CV; cs.LG; 68T07, 68U10; I.2.10; I.2.7; I.4.5**

- **简介: 该论文属于医学影像分析与自然语言处理交叉任务，旨在解决创伤性脑损伤诊断中影像解读效率与报告生成的挑战。作者提出一种结合AC-BiFPN与Transformer的新模型，实现颅脑创伤影像的多尺度特征提取与诊断报告自动生成。实验表明其在诊断准确性和报告质量上优于传统CNN模型。**

- **链接: [http://arxiv.org/pdf/2510.08498v1](http://arxiv.org/pdf/2510.08498v1)**
...
>
---
#### [new 119] SViM3D: Stable Video Material Diffusion for Single Image 3D Generation
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于3D生成与材料建模任务，旨在解决从单张图像生成可重光照、视角一致的物理材质3D资产问题。论文提出SViM3D框架，扩展视频扩散模型以联合生成PBR材质参数与表面法线，实现高质量的3D重建与编辑。**

- **链接: [http://arxiv.org/pdf/2510.08271v1](http://arxiv.org/pdf/2510.08271v1)**
...
>
---
#### [new 120] Team Xiaomi EV-AD VLA: Learning to Navigate Socially Through Proactive Risk Perception -- Technical Report for IROS 2025 RoboSense Challenge Social Navigation Track
...
>
---
#### [new 121] NovaFlow: Zero-Shot Manipulation via Actionable Flow from Generated Videos
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文属于机器人操控任务，旨在解决零样本跨平台操作问题。提出NovaFlow框架，通过生成视频并提取可操作的3D对象流，实现无需示例或特定训练的机器人动作规划，支持刚性与可变形物体操作，验证于Franka机械臂和Spot四足机器人上。**
...
>
---
#### [new 122] DexNDM: Closing the Reality Gap for Dexterous In-Hand Rotation via Joint-Wise Neural Dynamics Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 123] R2RGEN: Real-to-Real 3D Data Generation for Spatially Generalized Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 124] NavSpace: How Navigation Agents Follow Spatial Intelligence Instructions
...
>
---
#### [new 125] MultiFair: Multimodal Balanced Fairness-Aware Medical Classification with Dual-Level Gradient Modulation
...
>
---
#### [new 128] ConCuR: Conciseness Makes State-of-the-Art Kernel Generation
...
>
---
#### [new 131] Reinforcing Diffusion Models by Direct Group Preference Optimization
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于强化学习与扩散模型结合的任务，旨在解决扩散模型难以应用策略梯度方法的问题。现有方法依赖低效的随机策略，导致训练缓慢。作者提出DGPO算法，直接基于群体偏好优化，无需策略梯度，支持高效确定性采样，显著提升训练速度与性能。**

- **链接: [http://arxiv.org/pdf/2510.08425v1](http://arxiv.org/pdf/2510.08425v1)**
...
#### [replaced 001] GazeProphet: Software-Only Gaze Prediction for VR Foveated Rendering
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.13546v2](http://arxiv.org/pdf/2508.13546v2)**
...
>
---
#### [replaced 002] H3DE-Net: Efficient and Accurate 3D Landmark Detection in Medical Imaging
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.14221v2](http://arxiv.org/pdf/2502.14221v2)**
...
>
---
#### [replaced 003] TIGeR: Tool-Integrated Geometric Reasoning in Vision-Language Models for Robotics
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 008] ManipGPT: Is Affordance Segmentation by Large Vision Models Enough for Articulated Object Manipulation?
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 009] SiLVR: Scalable Lidar-Visual Radiance Field Reconstruction with Uncertainty Quantification
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 010] Product of Experts for Visual Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.08894v2](http://arxiv.org/pdf/2506.08894v2)**
...
>
---
#### [replaced 011] Q-CLIP: Unleashing the Power of Vision-Language Models for Video Quality Assessment through Unified Cross-Modal Adaptation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.06092v2](http://arxiv.org/pdf/2508.06092v2)**

> **作者:** Yachun Mi; Yu Li; Yanting Li; Chen Hui; Tong Zhang; Zhixuan Li; Chenyue Song; Wei Yang Bryan Lim; Shaohui Liu
>
...
>
---
#### [replaced 012] Explaining raw data complexity to improve satellite onboard processing
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.06858v2](http://arxiv.org/pdf/2510.06858v2)**
...
>
---
#### [replaced 013] Play to Generalize: Learning to Reason Through Game Play
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 014] Empowering Lightweight MLLMs with Reasoning via Long CoT SFT
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.03321v2](http://arxiv.org/pdf/2509.03321v2)**
...
>
---
#### [replaced 015] AlignCAT: Visual-Linguistic Alignment of Category and Attribute for Weakly Supervised Visual Grounding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03201v2](http://arxiv.org/pdf/2508.03201v2)**
...
>
---
#### [replaced 016] Attention based End to end network for Offline Writer Identification on Word level data
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2404.07602v2](http://arxiv.org/pdf/2404.07602v2)**
...
>
---
#### [replaced 017] Efficient Multi Subject Visual Reconstruction from fMRI Using Aligned Representations
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.01670v2](http://arxiv.org/pdf/2505.01670v2)**
...
>
---
#### [replaced 020] Revisiting Reweighted Risk for Calibration: AURC, Focal, and Inverse Focal Loss
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23463v4](http://arxiv.org/pdf/2505.23463v4)**
...
>
---
#### [replaced 023] HIVTP: A Training-Free Method to Improve VLMs Efficiency via Hierarchical Visual Token Pruning Using Middle-Layer-Based Importance Score
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23663v2](http://arxiv.org/pdf/2509.23663v2)**
...
>
---
#### [replaced 024] Equilibrium Matching: Generative Modeling with Implicit Energy-Based Models
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.02300v2](http://arxiv.org/pdf/2510.02300v2)**
...
>
---
#### [replaced 025] Deblurring in the Wild: A Real-World Image Deblurring Dataset from Smartphone High-Speed Videos
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.19445v4](http://arxiv.org/pdf/2506.19445v4)**
...
>
---
#### [replaced 026] MAMBO: High-Resolution Generative Approach for Mammography Images
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.08677v3](http://arxiv.org/pdf/2506.08677v3)**
...
>
---
#### [replaced 028] CORE-3D: Context-aware Open-vocabulary Retrieval by Embeddings in 3D
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.24528v2](http://arxiv.org/pdf/2509.24528v2)**

> **作者:** Mohamad Amin Mirzaei; Pantea Amoie; Ali Ekhterachian; Matin Mirzababaei; Babak Khalaj
>
> **备注:** 9 pages, 4 figures, submitted for ICLR 2026 conference
>
...
>
---
#### [replaced 029] Rethinking Decoders for Transformer-based Semantic Segmentation: A Compression Perspective
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.03033v4](http://arxiv.org/pdf/2411.03033v4)**

> **作者:** Qishuai Wen; Chun-Guang Li
>
> **备注:** NeurIPS2024. Code:https://github.com/QishuaiWen/DEPICT/
>
> **摘要:** State-of-the-art methods for Transformer-based semantic segmentation typically adopt Transformer decoders that are used to extract additional embeddings from image embeddings via cross-attention, refine either or both types of embeddings via self-attention, and project image embeddings onto the additional embeddings via dot-product. Despite their remarkable success, these empirical designs still lack theoretical justifications or interpretations, thus hindering potentially principled improvements. In this paper, we argue that there are fundamental connections between semantic segmentation and compression, especially between the Transformer decoders and Principal Component Analysis (PCA). From such a perspective, we derive a white-box, fully attentional DEcoder for PrIncipled semantiC segemenTation (DEPICT), with the interpretations as follows: 1) the self-attention operator refines image embeddings to construct an ideal principal subspace that aligns with the supervision and retains most information; 2) the cross-attention operator seeks to find a low-rank approximation of the refined image embeddings, which is expected to be a set of orthonormal bases of the principal subspace and corresponds to the predefined classes; 3) the dot-product operation yields compact representation for image embeddings as segmentation masks. Experiments conducted on dataset ADE20K find that DEPICT consistently outperforms its black-box counterpart, Segmenter, and it is light weight and more robust.
>
---
#### [replaced 030] MInDI-3D: Iterative Deep Learning in 3D for Sparse-view Cone Beam Computed Tomography
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09616v2](http://arxiv.org/pdf/2508.09616v2)**
...
>
---
#### [replaced 031] Video-LMM Post-Training: A Deep Dive into Video Reasoning with Large Multimodal Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.05034v3](http://arxiv.org/pdf/2510.05034v3)**
...
>
---
#### [replaced 032] Coefficients-Preserving Sampling for Reinforcement Learning with Flow Matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.05952v3](http://arxiv.org/pdf/2509.05952v3)**
...
>
---
#### [replaced 033] BRIGHT: A globally distributed multimodal building damage assessment dataset with very-high-resolution for all-weather disaster response
...
>
---
#### [replaced 034] SaFeR-VLM: Toward Safety-aware Fine-grained Reasoning in Multimodal Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.06871v2](http://arxiv.org/pdf/2510.06871v2)**
...
>
---
#### [replaced 037] Targetless LiDAR-Camera Calibration with Neural Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.04597v2](http://arxiv.org/pdf/2504.04597v2)**
...
>
---
#### [replaced 038] Domain Generalization in-the-Wild: Disentangling Classification from Domain-Aware Representations
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.21769v2](http://arxiv.org/pdf/2508.21769v2)**
...
>
---
#### [replaced 039] Can Vision Language Models Infer Human Gaze Direction? A Controlled Study
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 040] Context Matters: Learning Global Semantics via Object-Centric Representation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.05674v2](http://arxiv.org/pdf/2510.05674v2)**
...
>
---
#### [replaced 041] UNIDOC-BENCH: A Unified Benchmark for Document-Centric Multimodal RAG
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 045] VisionTS++: Cross-Modal Time Series Foundation Model with Continual Pre-trained Vision Backbones
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.04379v2](http://arxiv.org/pdf/2508.04379v2)**
...
>
---
#### [replaced 046] MAViS: A Multi-Agent Framework for Long-Sequence Video Storytelling
- **分类: cs.CV; cs.AI; cs.MA**

- **链接: [http://arxiv.org/pdf/2508.08487v4](http://arxiv.org/pdf/2508.08487v4)**
...
>
---
#### [replaced 047] CAST: Contrastive Adaptation and Distillation for Semi-Supervised Instance Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.21904v4](http://arxiv.org/pdf/2505.21904v4)**
...
>
---
#### [replaced 048] Condition Weaving Meets Expert Modulation: Towards Universal and Controllable Image Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.17364v2](http://arxiv.org/pdf/2508.17364v2)**

> **作者:** Guoqing Zhang; Xingtong Ge; Lu Shi; Xin Zhang; Muqing Xue; Wanru Xu; Yigang Cen; Jian Zhang
>
...
>
---
#### [replaced 052] How We Won BraTS-SSA 2025: Brain Tumor Segmentation in the Sub-Saharan African Population Using Segmentation-Aware Data Augmentation and Model Ensembling
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.03568v2](http://arxiv.org/pdf/2510.03568v2)**
...
>
> **备注:** Brain Tumor Segmentation Challenge, International Medical Image Computing and Computer Assisted Intervention (MICCAI) Conference, 11 Pages, 2 Figures, 2 Tables
>
...
>
---
#### [replaced 053] Towards Methane Detection Onboard Satellites
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.00626v3](http://arxiv.org/pdf/2509.00626v3)**
...
>
---
#### [replaced 054] PRVR: Partially Relevant Video Retrieval
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2208.12510v2](http://arxiv.org/pdf/2208.12510v2)**

> **作者:** Xianke Chen; Daizong Liu; Xun Yang; Xirong Li; Jianfeng Dong; Meng Wang; Xun Wang
>
> **备注:** Accepted by TPAMI. The paper's homepage is https://github.com/HuiGuanLab/ms-sl-pp
>
...
>
---
#### [replaced 055] ThinkGeo: Evaluating Tool-Augmented Agents for Remote Sensing Tasks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23752v2](http://arxiv.org/pdf/2505.23752v2)**
...
>
---
#### [replaced 059] DiffEye: Diffusion-Based Continuous Eye-Tracking Data Generation Conditioned on Natural Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16767v2](http://arxiv.org/pdf/2509.16767v2)**
...
>
---
#### [replaced 060] MAESTRO: Masked AutoEncoders for Multimodal, Multitemporal, and Multispectral Earth Observation Data
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10894v2](http://arxiv.org/pdf/2508.10894v2)**
...
>
---
#### [replaced 061] PointAD+: Learning Hierarchical Representations for Zero-shot 3D Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.03277v4](http://arxiv.org/pdf/2509.03277v4)**
...
>
---
#### [replaced 062] Prompt-guided Representation Disentanglement for Action Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.21783v2](http://arxiv.org/pdf/2509.21783v2)**
...
>
---
#### [replaced 067] Zebra-CoT: A Dataset for Interleaved Vision Language Reasoning
...
>
---
#### [replaced 071] Maintaining Performance with Less Data
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2208.02007v2](http://arxiv.org/pdf/2208.02007v2)**
...
>
---
#### [replaced 072] Controllable Hybrid Captioner for Improved Long-form Video Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.17047v3](http://arxiv.org/pdf/2507.17047v3)**
...
>
---
#### [replaced 073] Human Action Recognition from Point Clouds over Time
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.05506v3](http://arxiv.org/pdf/2510.05506v3)**
...
>
---
#### [replaced 074] Think With Videos For Agentic Long-Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 075] FireGNN: Neuro-Symbolic Graph Neural Networks with Trainable Fuzzy Rules for Interpretable Medical Image Classification
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.10510v2](http://arxiv.org/pdf/2509.10510v2)**

> **作者:** Prajit Sengupta; Islem Rekik
>
> **备注:** Accepted at NeurIPS 2025 Conference (Workshop Track), San Diego, USA
>
...
>
---
#### [replaced 079] Modality-Balancing Preference Optimization of Large Multimodal Models by Adversarial Negative Mining
