...
>
---
#### [new 018] Knowledge-based learning in Text-RAG and Image-RAG
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态医学图像分析任务，旨在解决疾病检测中的幻觉问题。通过对比文本和图像RAG方法，利用外部知识提升模型准确性与可靠性。**

- **链接: [https://arxiv.org/pdf/2601.08226v1](https://arxiv.org/pdf/2601.08226v1)**
...
>
---
#### [new 019] Developing Predictive and Robust Radiomics Models for Chemotherapy Response in High-Grade Serous Ovarian Carcinoma
- **分类: cs.CV**

- **简介: 该论文属于医学影像分析任务，旨在预测卵巢癌患者对新辅助化疗的反应。通过整合特征选择方法，提升模型的预测准确性与稳健性。**

- **链接: [https://arxiv.org/pdf/2601.08455v1](https://arxiv.org/pdf/2601.08455v1)**
...
>
---
#### [new 028] An Explainable Two Stage Deep Learning Framework for Pericoronitis Assessment in Panoramic Radiographs Using YOLOv8 and ResNet-50
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学影像分析任务，旨在解决全景X光片中智齿周围炎的自动评估问题。通过两阶段深度学习框架实现定位、分类与可解释性分析。**

- **链接: [https://arxiv.org/pdf/2601.08401v1](https://arxiv.org/pdf/2601.08401v1)**
...
>
---
#### [new 029] TP-Blend: Textual-Prompt Attention Pairing for Precise Object-Style Blending in Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG; cs.MM**

- **简介: 该论文提出TP-Blend，用于解决扩散模型中同时引入新物体和新风格的精确融合问题，通过双提示注意力机制实现高效、高质量的图像编辑。**

- **链接: [https://arxiv.org/pdf/2601.08011v1](https://arxiv.org/pdf/2601.08011v1)**
...
>
---
#### [new 037] Route, Retrieve, Reflect, Repair: Self-Improving Agentic Framework for Visual Detection and Linguistic Reasoning in Medical Imaging
- **分类: cs.CV**

- **简介: 该论文提出R^4框架，解决医学影像中视觉检测与语言推理的可靠性问题。通过分解任务为路由、检索、反思和修复四个代理，提升模型的准确性和安全性。**

- **链接: [https://arxiv.org/pdf/2601.08192v1](https://arxiv.org/pdf/2601.08192v1)**
...
>
---
#### [new 038] Sesame Plant Segmentation Dataset: A YOLO Formatted Annotated Dataset
- **分类: cs.CV**

- **简介: 该论文提出一个用于芝麻植物分割的YOLO格式数据集，解决农业中精准检测与分析芝麻植物的问题，通过像素级分割提升检测精度。**

- **链接: [https://arxiv.org/pdf/2601.07970v1](https://arxiv.org/pdf/2601.07970v1)**

> **作者:** Sunusi Ibrahim Muhammad; Ismail Ismail Tijjani; Saadatu Yusuf Jumare; Fatima Isah Jibrin
>
> **备注:** Presented at International Conference on Computing and advance in Information Technology(ICCAIT2025) The dataset is available at kaggle : https://www.kaggle.com/datasets/ismailismailtijjani/sesame-plant-detection-dataset
>
...
>
---
#### [new 041] GI-Bench: A Panoramic Benchmark Revealing the Knowledge-Experience Dissociation of Multimodal Large Language Models in Gastrointestinal Endoscopy Against Clinical Standards
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学影像分析任务，旨在评估多模态大语言模型在胃肠镜检查中的表现。通过构建GI-Bench基准，对比模型与人类医生在多个临床流程中的表现，揭示其知识与经验的差异。**

- **链接: [https://arxiv.org/pdf/2601.08183v1](https://arxiv.org/pdf/2601.08183v1)**
...
>
---
#### [new 043] Reasoning Matters for 3D Visual Grounding
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于3D视觉定位任务，旨在解决现有模型推理能力不足的问题。通过构建自动合成数据管道并训练增强推理能力的LLM，提升了3D视觉定位效果。**

- **链接: [https://arxiv.org/pdf/2601.08811v1](https://arxiv.org/pdf/2601.08811v1)**
...
>
---
#### [new 044] CoMa: Contextual Massing Generation with Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于建筑概念设计任务，旨在解决建筑体量生成的自动化问题。通过引入数据集和视觉-语言模型，实现基于功能和环境的体量生成。**

- **链接: [https://arxiv.org/pdf/2601.08464v1](https://arxiv.org/pdf/2601.08464v1)**

> **作者:** Evgenii Maslov; Valentin Khrulkov; Anastasia Volkova; Anton Gusarov; Andrey Kuznetsov; Ivan Oseledets
>
> **备注:** Code and dataset will be released later
>
...
>
---
#### [new 051] IGAN: A New Inception-based Model for Stable and High-Fidelity Image Synthesis Using Generative Adversarial Networks
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出IGAN模型，解决GAN训练不稳定和生成质量低的问题，通过改进网络结构提升图像合成的稳定性和质量。**

- **链接: [https://arxiv.org/pdf/2601.08332v1](https://arxiv.org/pdf/2601.08332v1)**
...
>
---
#### [new 052] UM-Text: A Unified Multimodal Model for Image Understanding
- **分类: cs.CV**

- **简介: 该论文提出UM-Text，解决图像中基于自然语言指令的视觉文本编辑问题。通过统一多模态模型，实现风格一致的文本生成与布局设计。**

- **链接: [https://arxiv.org/pdf/2601.08321v1](https://arxiv.org/pdf/2601.08321v1)**
...
>
---
#### [new 053] Second-order Gaussian directional derivative representations for image high-resolution corner detection
- **分类: cs.CV**

- **简介: 该论文属于图像处理任务，旨在解决高分辨率角点检测中的相邻角点干扰问题。通过引入二阶高斯方向导数滤波器，提出新的角点检测方法，提升检测精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.08182v1](https://arxiv.org/pdf/2601.08182v1)**
...
>
---
#### [new 054] Source-Free Domain Adaptation for Geospatial Point Cloud Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文属于点云语义分割任务，解决地理数据域适应问题。针对无源域数据的情况，提出LoGo框架，通过局部全局一致性机制提升模型在目标域的性能。**

- **链接: [https://arxiv.org/pdf/2601.08375v1](https://arxiv.org/pdf/2601.08375v1)**
...
>
---
#### [new 059] SPARK: Scalable Real-Time Point Cloud Aggregation with Multi-View Self-Calibration
- **分类: cs.CV**

- **简介: 该论文提出SPARK框架，解决多相机实时点云融合与自标定问题，通过几何感知和置信度驱动策略提升精度与稳定性。**

- **链接: [https://arxiv.org/pdf/2601.08414v1](https://arxiv.org/pdf/2601.08414v1)**
...
>
---
#### [new 070] 3DGS-Drag: Dragging Gaussians for Intuitive Point-Based 3D Editing
- **分类: cs.CV**

- **简介: 该论文属于3D内容编辑任务，解决3D场景中直观拖拽编辑困难的问题。提出3DGS-Drag框架，结合几何变形与扩散指导，实现高效、精准的3D点云编辑。**

- **链接: [https://arxiv.org/pdf/2601.07963v1](https://arxiv.org/pdf/2601.07963v1)**
...
>
---
#### [new 071] 3AM: Segment Anything with Geometric Consistency in Videos
- **分类: cs.CV**

- **简介: 该论文提出3AM，解决视频目标分割中视角变化导致的几何不一致问题。通过融合3D特征与SAM2，提升分割一致性与准确性。**

- **链接: [https://arxiv.org/pdf/2601.08831v1](https://arxiv.org/pdf/2601.08831v1)**
...
>
---
#### [new 093] Decoder Generates Manufacturable Structures: A Framework for 3D-Printable Object Synthesis
- **分类: cs.CV**

- **简介: 该论文属于3D打印结构生成任务，旨在解决生成可制造3D对象的问题。工作是提出一种基于解码器的框架，生成符合制造约束的几何结构。**

- **链接: [https://arxiv.org/pdf/2601.08015v1](https://arxiv.org/pdf/2601.08015v1)**

> **作者:** Abhishek Kumar
>
> **备注:** 8 pages, 3 figures, 1 table. Presents a constraint-aware neural decoder for generating 3D-printable objects with 96.8% manufacturability rate
>
...
>
---
#### [new 094] Edge-Optimized Multimodal Learning for UAV Video Understanding via BLIP-2
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于无人机视频理解任务，解决大模型计算成本高与无人机边缘算力有限的矛盾。通过集成YOLO模型和优化BLIP-2，提升多任务处理能力。**

- **链接: [https://arxiv.org/pdf/2601.08408v1](https://arxiv.org/pdf/2601.08408v1)**
...
>
---
#### [new 100] ViDoRe V3: A Comprehensive Evaluation of Retrieval Augmented Generation in Complex Real-World Scenarios
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于多模态检索增强生成任务，旨在解决复杂真实场景下的信息检索与生成问题。工作包括构建多语言、多类型数据集，并评估现有模型在视觉元素处理等方面的性能。**

- **链接: [https://arxiv.org/pdf/2601.08620v1](https://arxiv.org/pdf/2601.08620v1)**
...
>
---
#### [new 101] Keyframe-based Dense Mapping with the Graph of View-Dependent Local Maps
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于三维重建任务，解决环境地图构建问题。提出基于关键帧的密集映射方法，利用RGB-D数据更新局部NDT地图，提升精度并支持全局优化。**

- **链接: [https://arxiv.org/pdf/2601.08520v1](https://arxiv.org/pdf/2601.08520v1)**

> **作者:** Krzysztof Zielinski; Dominik Belter
>
> **备注:** Accepted in ICRA 2020
>
> **摘要:** In this article, we propose a new keyframe-based mapping system. The proposed method updates local Normal Distribution Transform maps (NDT) using data from an RGB-D sensor. The cells of the NDT are stored in 2D view-dependent structures to better utilize the properties and uncertainty model of RGB-D cameras. This method naturally represents an object closer to the camera origin with higher precision. The local maps are stored in the pose graph which allows correcting global map after loop closure detection. We also propose a procedure that allows merging and filtering local maps to obtain a global map of the environment. Finally, we compare our method with Octomap and NDT-OM and provide example applications of the proposed mapping method.
>
---
#### [new 102] M3CoTBench: Benchmark Chain-of-Thought of MLLMs in Medical Image Understanding
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像理解任务，旨在解决现有基准忽视推理过程的问题。提出M3CoTBench基准，评估MLLMs的CoT推理正确性、效率等，推动可解释的医疗AI发展。**

- **链接: [https://arxiv.org/pdf/2601.08758v1](https://arxiv.org/pdf/2601.08758v1)**

> **作者:** Juntao Jiang; Jiangning Zhang; Yali Bi; Jinsheng Bai; Weixuan Liu; Weiwei Jin; Zhucun Xue; Yong Liu; Xiaobin Hu; Shuicheng Yan
>
> **备注:** 40 pages, 8 pages
>
> **摘要:** Chain-of-Thought (CoT) reasoning has proven effective in enhancing large language models by encouraging step-by-step intermediate reasoning, and recent advances have extended this paradigm to Multimodal Large Language Models (MLLMs). In the medical domain, where diagnostic decisions depend on nuanced visual cues and sequential reasoning, CoT aligns naturally with clinical thinking processes. However, Current benchmarks for medical image understanding generally focus on the final answer while ignoring the reasoning path. An opaque process lacks reliable bases for judgment, making it difficult to assist doctors in diagnosis. To address this gap, we introduce a new M3CoTBench benchmark specifically designed to evaluate the correctness, efficiency, impact, and consistency of CoT reasoning in medical image understanding. M3CoTBench features 1) a diverse, multi-level difficulty dataset covering 24 examination types, 2) 13 varying-difficulty tasks, 3) a suite of CoT-specific evaluation metrics (correctness, efficiency, impact, and consistency) tailored to clinical reasoning, and 4) a performance analysis of multiple MLLMs. M3CoTBench systematically evaluates CoT reasoning across diverse medical imaging tasks, revealing current limitations of MLLMs in generating reliable and clinically interpretable reasoning, and aims to foster the development of transparent, trustworthy, and diagnostically accurate AI systems for healthcare. Project page at https://juntaojianggavin.github.io/projects/M3CoTBench/.
>
---
#### [new 103] Training-Free Distribution Adaptation for Diffusion Models via Maximum Mean Discrepancy Guidance
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于分布适应任务，解决扩散模型生成样本与目标数据不匹配的问题。提出MMD Guidance方法，在无需重新训练的情况下，通过最大均值差异引导生成样本对齐目标分布。**

- **链接: [https://arxiv.org/pdf/2601.08379v1](https://arxiv.org/pdf/2601.08379v1)**
...
>
---
#### [new 104] Region of interest detection for efficient aortic segmentation
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决胸主动脉分割计算成本高、效率低的问题。通过引入ROI检测模型，提升分割效率与准确性。**

- **链接: [https://arxiv.org/pdf/2601.08683v1](https://arxiv.org/pdf/2601.08683v1)**
...
>
---
#### [new 112] VLingNav: Embodied Navigation with Adaptive Reasoning and Visual-Assisted Linguistic Memory
- **分类: cs.RO; cs.CV**

- **简介: 该论文提出VLingNav，解决具身导航中缺乏推理和持久记忆的问题，通过自适应思维链和视觉辅助语言记忆模块提升导航性能。**

- **链接: [https://arxiv.org/pdf/2601.08665v1](https://arxiv.org/pdf/2601.08665v1)**
...
>
---
#### [new 113] TRACE: Reconstruction-Based Anomaly Detection in Ensemble and Time-Dependent Simulations
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于异常检测任务，旨在解决高维时间依赖模拟数据中的异常识别问题。通过对比2D和3D卷积自编码器，分析时空上下文对检测效果的影响。**

- **链接: [https://arxiv.org/pdf/2601.08659v1](https://arxiv.org/pdf/2601.08659v1)**
...
>
---
#### [new 117] VULCA-Bench: A Multicultural Vision-Language Benchmark for Evaluating Cultural Understanding
- **分类: cs.CL; cs.CV**

- **简介: 该论文提出VULCA-Bench，属于视觉-语言模型的文化理解评估任务，旨在解决现有基准对文化深层解读能力评价不足的问题。工作包括构建多文化数据集及五层评估框架。**

- **链接: [https://arxiv.org/pdf/2601.07986v1](https://arxiv.org/pdf/2601.07986v1)**
...
>
---
#### [replaced 002] CausAdv: A Causal-based Framework for Detecting Adversarial Examples
- **分类: cs.LG; cs.AI; cs.CV; stat.ME; stat.ML**

- **链接: [https://arxiv.org/pdf/2411.00839v2](https://arxiv.org/pdf/2411.00839v2)**
...
>
---
#### [replaced 003] A Vision for Multisensory Intelligence: Sensing, Science, and Synergy
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **简介: 该论文提出多感官人工智能的研究愿景，旨在解决AI与人类感官融合的问题，通过感知、科学和协同三个方向推动技术发展。**

- **链接: [https://arxiv.org/pdf/2601.04563v3](https://arxiv.org/pdf/2601.04563v3)**
...
>
---
#### [replaced 007] Your Super Resolution Model is not Enough for Tackling Real-World Scenarios
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.06387v2](https://arxiv.org/pdf/2509.06387v2)**

> **作者:** Dongsik Yoon; Jongeun Kim
>
> **备注:** To appear in the Workshop on Efficient Computing under Limited Resources: Visual Computing (ECLR) at ICCV 2025
>
...
>
---
#### [replaced 008] Apollo: Unified Multi-Task Audio-Video Joint Generation
...
>
---
#### [replaced 009] SemiETPicker: Fast and Label-Efficient Particle Picking for CryoET Tomography Using Semi-Supervised Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.22454v2](https://arxiv.org/pdf/2510.22454v2)**
...
>
---
#### [replaced 010] PRISM: Self-Pruning Intrinsic Selection Method for Training-Free Multimodal Data Selection
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文提出PRISM，解决视觉指令调优中的数据冗余问题，通过训练-free方法提升效率与性能。属于多模态数据选择任务。**

- **链接: [https://arxiv.org/pdf/2502.12119v3](https://arxiv.org/pdf/2502.12119v3)**
...
>
---
#### [replaced 011] Comparative validation of surgical phase recognition, instrument keypoint estimation, and instrument instance segmentation in endoscopy: Results of the PhaKIR 2024 challenge
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.16559v2](https://arxiv.org/pdf/2507.16559v2)**
...
>
---
#### [replaced 017] Tuning-free Visual Effect Transfer across Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.07833v2](https://arxiv.org/pdf/2601.07833v2)**

> **作者:** Maxwell Jones; Rameen Abdal; Or Patashnik; Ruslan Salakhutdinov; Sergey Tulyakov; Jun-Yan Zhu; Kuan-Chieh Jackson Wang
>
> **备注:** Project Page: https://tuningfreevisualeffects-maker.github.io/Tuning-free-Visual-Effect-Transfer-across-Videos-Project-Page/
>
...
>
---
#### [replaced 020] Learning-based Multi-View Stereo: A Survey
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2408.15235v3](https://arxiv.org/pdf/2408.15235v3)**
...
>
---
#### [replaced 023] MOGO: Residual Quantized Hierarchical Causal Transformer for High-Quality and Real-Time 3D Human Motion Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2506.05952v3](https://arxiv.org/pdf/2506.05952v3)**
...
>
---
#### [replaced 024] PINGS-X: Physics-Informed Normalized Gaussian Splatting with Axes Alignment for Efficient Super-Resolution of 4D Flow MRI
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.11048v2](https://arxiv.org/pdf/2511.11048v2)**
...
>
> **备注:** Accepted to NeurIPS 2025 ; Project page: https://bigcileng.github.io/bilateral-driving ; Code: https://github.com/BigCiLeng/bilateral-driving
>
...
>
---
#### [replaced 027] ClimateIQA: A New Dataset and Benchmark to Advance Vision-Language Models in Meteorology Anomalies Analysis
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2406.09838v4](https://arxiv.org/pdf/2406.09838v4)**

> **作者:** Jian Chen; Peilin Zhou; Yining Hua; Dading Chong; Meng Cao; Yaowei Li; Wei Chen; Bing Zhu; Junwei Liang; Zixuan Yuan
>
...
>
---
#### [replaced 028] Perceptual Region-Driven Infrared-Visible Co-Fusion for Extreme Scene Enhancement
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06400v2](https://arxiv.org/pdf/2512.06400v2)**

> **作者:** Jing Tao; Yonghong Zong; Banglei Guan; Pengju Sun; Taihang Lei; Yang Shanga; Qifeng Yu
>
> **备注:** The paper has been accepted and officially published by OPTICS AND LASER TECHNOLOGY
>
...
>
---
#### [replaced 029] MixGRPO: Unlocking Flow-based GRPO Efficiency with Mixed ODE-SDE
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.21802v3](https://arxiv.org/pdf/2507.21802v3)**
...
>
---
#### [replaced 030] MDReID: Modality-Decoupled Learning for Any-to-Any Multi-Modal Object Re-Identification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23301v2](https://arxiv.org/pdf/2510.23301v2)**
...
>
---
#### [replaced 031] Ground What You See: Hallucination-Resistant MLLMs via Caption Feedback, Diversity-Aware Sampling, and Conflict Regularization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.06224v2](https://arxiv.org/pdf/2601.06224v2)**
...
>
---
#### [replaced 032] GSAlign: Geometric and Semantic Alignment Network for Aerial-Ground Person Re-Identification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.22268v2](https://arxiv.org/pdf/2510.22268v2)**
...
>
---
#### [replaced 035] Visually Prompted Benchmarks Are Surprisingly Fragile
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.17875v2](https://arxiv.org/pdf/2512.17875v2)**
...
>
---
#### [replaced 036] Cascading multi-agent anomaly detection in surveillance systems via vision-language models and embedding-based classification
- **分类: cs.CV; cs.MA**

- **链接: [https://arxiv.org/pdf/2601.06204v2](https://arxiv.org/pdf/2601.06204v2)**

> **作者:** Tayyab Rehman; Giovanni De Gasperis; Aly Shmahell
>
> **备注:** Author email changed, Acknowlegement changes
>
...
>
---
#### [replaced 037] MVGGT: Multimodal Visual Geometry Grounded Transformer for Multiview 3D Referring Expression Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.06874v2](https://arxiv.org/pdf/2601.06874v2)**

> **作者:** Changli Wu; Haodong Wang; Jiayi Ji; Yutian Yao; Chunsai Du; Jihua Kang; Yanwei Fu; Liujuan Cao
>
> **备注:** Project Website: https://sosppxo.github.io/mvggt.github.io/
>
...
>
---
#### [replaced 038] TrackNetV5: Residual-Driven Spatio-Temporal Refinement and Motion Direction Decoupling for Fast Object Tracking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02789v4](https://arxiv.org/pdf/2512.02789v4)**
...
>
---
#### [replaced 042] Divergence-Based Similarity Function for Multi-View Contrastive Learning
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.06560v3](https://arxiv.org/pdf/2507.06560v3)**

> **作者:** Jae Hyoung Jeon; Cheolsu Lim; Myungjoo Kang
>
> **备注:** 9 pages, 5 figures. Code: https://github.com/Jeon789/DSF
>
...
>
---
#### [replaced 043] SpatialActor: Exploring Disentangled Spatial Representations for Robust Robotic Manipulation
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于机器人操作任务，旨在解决空间理解不足问题。提出SpatialActor框架，分离语义与几何，提升操作精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2511.09555v2](https://arxiv.org/pdf/2511.09555v2)**
...
>
---
#### [replaced 044] A Diff-Attention Aware State Space Fusion Model for Remote Sensing Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.16665v2](https://arxiv.org/pdf/2504.16665v2)**
...
>
---
#### [replaced 048] Reconstruct, Inpaint, Test-Time Finetune: Dynamic Novel-view Synthesis from Monocular Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.12646v2](https://arxiv.org/pdf/2507.12646v2)**

> **作者:** Kaihua Chen; Tarasha Khurana; Deva Ramanan
>
> **备注:** NeurIPS 2025. Project page: https://cog-nvs.github.io/
>
...
>
---
#### [replaced 049] HiFi-Mamba: Dual-Stream W-Laplacian Enhanced Mamba for High-Fidelity MRI Reconstruction
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09179v2](https://arxiv.org/pdf/2508.09179v2)**
...
>
---
#### [replaced 050] A Pre-trained Foundation Model Framework for Multiplanar MRI Classification of Extramural Vascular Invasion and Mesorectal Fascia Invasion in Rectal Cancer
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2505.18058v2](https://arxiv.org/pdf/2505.18058v2)**

> **作者:** Yumeng Zhang; Shruti Atul Mali; Danial Khan; Sina Amirrajab; Eduardo Ibor-Crespo; Ana Jimenez-Pastor; Gloria Ribas; Silvia Flor-Arnal; Marta Zerunian; Christophe Aube; Luis Marti-Bonmati; Zohaib Salahuddin; Philippe Lambin
>
...
>
---
#### [replaced 051] ViewMorpher3D: A 3D-aware Diffusion Framework for Multi-Camera Novel View Synthesis in Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.07540v2](https://arxiv.org/pdf/2601.07540v2)**
...
>
---
#### [replaced 052] Latent Reconstruction from Generated Data for Multimodal Misinformation Detection
- **分类: cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2504.06010v3](https://arxiv.org/pdf/2504.06010v3)**
...
>
---
#### [replaced 053] Two-Stream Thermal Imaging Fusion for Enhanced Time of Birth Detection in Neonatal Care
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.03244v3](https://arxiv.org/pdf/2503.03244v3)**
...
>
---
#### [replaced 054] PI3DETR: Parametric Instance Detection of 3D Point Cloud Edges With a Geometry-Aware 3DETR
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.03262v2](https://arxiv.org/pdf/2509.03262v2)**
...
>
---
#### [replaced 055] RGS-SLAM: Robust Gaussian Splatting SLAM with One-Shot Dense Initialization
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出RGS-SLAM，解决SLAM中稠密初始化问题。通过一阶段三角化生成高斯种子，提升定位与重建精度，实现实时映射。**

- **链接: [https://arxiv.org/pdf/2601.00705v2](https://arxiv.org/pdf/2601.00705v2)**
...
>
---
#### [replaced 056] UNCAP: Uncertainty-Guided Neurosymbolic Planning Using Natural Language Communication for Cooperative Autonomous Vehicles
- **分类: cs.RO; cs.CL; cs.CV; cs.MA**

- **简介: 该论文属于自动驾驶协同规划任务，解决多车通信效率与安全问题。提出UNCAP方法，通过自然语言通信并考虑感知不确定性，提升协作可靠性与安全性。**

- **链接: [https://arxiv.org/pdf/2510.12992v2](https://arxiv.org/pdf/2510.12992v2)**
...
>
---
#### [replaced 057] PathoSyn: Imaging-Pathology MRI Synthesis via Disentangled Deviation Diffusion
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.23130v2](https://arxiv.org/pdf/2512.23130v2)**
...
>
---
#### [replaced 058] FoldNet: Learning Generalizable Closed-Loop Policy for Garment Folding via Keypoint-Driven Asset and Demonstration Synthesis
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于机器人服装折叠任务，解决数据生成困难和策略鲁棒性问题。通过关键点驱动的合成数据和模仿学习，提升折叠成功率。**

- **链接: [https://arxiv.org/pdf/2505.09109v3](https://arxiv.org/pdf/2505.09109v3)**
...
>
---
#### [replaced 059] Real-Time LiDAR Point Cloud Densification for Low-Latency Spatial Data Transmission
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于三维重建任务，旨在解决LiDAR点云稀疏和实时处理问题。通过融合多传感器数据，提出一种快速点云加密方法，实现实时高精度深度图生成。**

- **链接: [https://arxiv.org/pdf/2601.01210v2](https://arxiv.org/pdf/2601.01210v2)**
