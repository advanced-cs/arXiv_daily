...
#### [new 001] Talk, Snap, Complain: Validation-Aware Multimodal Expert Framework for Fine-Grained Customer Grievances
- **分类: cs.CL**

- **简介: 该论文针对细粒度客户投诉分析任务，解决单模态方法难以处理文本与图像协同信息的问题。提出VALOR框架，通过多专家推理和语义对齐机制融合多模态对话内容，提升复杂投诉场景下的分类准确性。**

- **链接: [https://arxiv.org/pdf/2511.14693v1](https://arxiv.org/pdf/2511.14693v1)**
...
>
---
#### [new 010] ConInstruct: Evaluating Large Language Models on Conflict Detection and Resolution in Instructions
- **分类: cs.CL**

- **简介: 该论文提出ConInstruct基准，用于评估大语言模型在指令冲突检测与解决上的能力。针对现有研究忽视冲突指令的问题，作者构建数据集并测试模型表现，发现多数模型能准确检测冲突但很少主动提示用户，揭示了当前LLMs在处理复杂指令时的关键短板。**

- **链接: [https://arxiv.org/pdf/2511.14342v1](https://arxiv.org/pdf/2511.14342v1)**
...
>
> **摘要:** Rare diseases affect hundreds of millions worldwide, yet diagnosis often spans years. Convectional pipelines decouple noisy evidence extraction from downstream inferential diagnosis, and general/medical large language models (LLMs) face scarce real world electronic health records (EHRs), stale domain knowledge, and hallucinations. We assemble a large, domain specialized clinical corpus and a clinician validated reasoning set, and develop RareSeek R1 via staged instruction tuning, chain of thought learning, and graph grounded retrieval. Across multicenter EHR narratives and public benchmarks, RareSeek R1 attains state of the art accuracy, robust generalization, and stability under noisy or overlapping phenotypes. Augmented retrieval yields the largest gains when narratives pair with prioritized variants by resolving ambiguity and aligning candidates to mechanisms. Human studies show performance on par with experienced physicians and consistent gains in assistive use. Notably, transparent reasoning highlights decisive non phenotypic evidence (median 23.1%, such as imaging, interventions, functional tests) underpinning many correct diagnoses. This work advances a narrative first, knowledge integrated reasoning paradigm that shortens the diagnostic odyssey and enables auditable, clinically translatable decision support.
>
---
#### [new 024] Quadratic Term Correction on Heaps' Law
- **分类: cs.CL**

- **简介: 论文研究Heaps定律在词类型与词频关系中的改进，提出用对数尺度下的二次项修正原幂律模型。通过20部英文作品数据验证，线性系数略大于1，二次系数约-0.02，表明曲线轻微凹陷，且用“带替换取球”模型解释其负伪方差特性。**

- **链接: [https://arxiv.org/pdf/2511.14683v1](https://arxiv.org/pdf/2511.14683v1)**
...
>
---
#### [new 025] AraLingBench A Human-Annotated Benchmark for Evaluating Arabic Linguistic Capabilities of Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出AraLingBench，一个用于评估大语言模型阿拉伯语语言能力的基准测试。针对当前模型在阿拉伯语理解上依赖记忆而非真正掌握语法和句法的问题，研究者设计了150道专家标注的选择题，覆盖五个语言学类别，揭示了模型在深层语言理解上的不足，并提供诊断工具促进阿拉伯语LLM的发展。**

- **链接: [https://arxiv.org/pdf/2511.14295v1](https://arxiv.org/pdf/2511.14295v1)**
...
>
---
#### [new 026] Mitigating Label Length Bias in Large Language Models
- **分类: cs.CL**

- **简介: 论文研究大语言模型在多标签预测中的长度偏差问题，提出NCC方法通过全标签级归一化与校准来缓解该偏差，提升准确率与可靠性，适用于多项选择题等任务。**

- **链接: [https://arxiv.org/pdf/2511.14385v1](https://arxiv.org/pdf/2511.14385v1)**

> **作者:** Mario Sanz-Guerrero; Katharina von der Wense
>
> **备注:** Accepted to AACL 2025 (Main)
>
> **摘要:** Large language models (LLMs) are powerful zero- and few-shot learners. However, when predicting over a set of candidate options, LLMs suffer from label biases, and existing calibration methods overlook biases arising from multi-token class labels. We tackle an issue we call label length bias, where labels of different lengths are treated inconsistently, even after standard length normalization. To mitigate it, we propose normalized contextual calibration (NCC), an effective method that normalizes and calibrates predictions at the full-label level. NCC achieves statistically significant improvements over prior approaches across multiple datasets and models, with gains of up to 10% F1. Moreover, NCC extends bias mitigation to broader tasks such as multiple-choice question answering. Our analysis shows that, when combined with in-context learning, NCC is less sensitive to few-shot example selection, requires fewer examples for competitive performance, and produces more reliable confidence estimates. These findings highlight the importance of mitigating full-label biases to improve the performance and robustness of LLM-based methods, particularly in real-world applications where class labels naturally consist of multiple tokens.
>
---
#### [new 027] LiveRAG: A diverse Q&A dataset with varying difficulty level for RAG evaluation
- **分类: cs.CL; cs.IR**

- **简介: 论文提出LiveRAG基准数据集，用于系统评估检索增强生成（RAG）问答系统。它包含895个合成问题，附带难度和区分度评分，帮助区分不同系统性能，推动RAG研究发展。**

- **链接: [https://arxiv.org/pdf/2511.14531v1](https://arxiv.org/pdf/2511.14531v1)**
...
>
---
#### [new 036] Enhancing Agentic Autonomous Scientific Discovery with Vision-Language Model Capabilities
...
>
---
#### [new 037] Leveraging Digitized Newspapers to Collect Summarization Data in Low-Resource Languages
- **分类: cs.CL**

- **简介: 论文提出利用报纸头版预告（Front-Page Teasers）自动收集低资源语言的多文档摘要数据，解决高质量摘要数据稀缺问题。方法适用于多种语言，已应用于希伯来语，构建首个希伯来语多文档摘要数据集HEBTEASESUM。**

- **链接: [https://arxiv.org/pdf/2511.14598v1](https://arxiv.org/pdf/2511.14598v1)**

> **作者:** Noam Dahan; Omer Kidron; Gabriel Stanovsky
>
> **摘要:** High quality summarization data remains scarce in under-represented languages. However, historical newspapers, made available through recent digitization efforts, offer an abundant source of untapped, naturally annotated data. In this work, we present a novel method for collecting naturally occurring summaries via Front-Page Teasers, where editors summarize full length articles. We show that this phenomenon is common across seven diverse languages and supports multi-document summarization. To scale data collection, we develop an automatic process, suited to varying linguistic resource levels. Finally, we apply this process to a Hebrew newspaper title, producing HEBTEASESUM, the first dedicated multi-document summarization dataset in Hebrew.
>
---
#### [new 038] Entropy-Guided Reasoning Compression
- **分类: cs.CL**

- **简介: 该论文针对大模型推理链过长的问题，提出熵引导的压缩方法。通过平衡熵变化与任务性能，在保持准确率的同时将推理长度压缩至20%。**

- **链接: [https://arxiv.org/pdf/2511.14258v1](https://arxiv.org/pdf/2511.14258v1)**
...
>
---
#### [new 039] MedBench v4: A Robust and Scalable Benchmark for Evaluating Chinese Medical Language Models, Multimodal Models, and Intelligent Agents
- **分类: cs.CL**

- **简介: 该论文提出MedBench v4，一个面向中文医疗大模型、多模态模型和智能体的可扩展评估基准，解决现有评估体系无法反映真实临床流程与安全约束的问题。通过超70万专家标注任务，多轮评审与LLM评分机制，系统评估15个前沿模型，揭示基础模型在多模态推理与安全上的不足，并证明智能体架构能显著提升临床可用性。**

- **链接: [https://arxiv.org/pdf/2511.14439v1](https://arxiv.org/pdf/2511.14439v1)**
...
>
---
#### [new 045] Examining the Metrics for Document-Level Claim Extraction in Czech and Slovak
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究文档级主张提取的评估方法，旨在解决现有评价指标在处理捷克语和斯洛伐克语非正式文本时的不足。作者提出基于对齐评分的评估框架，比较模型与人工标注的主张集合，以提升评估准确性，并强调需关注主张的原子性、可验证性和去上下文化等关键属性。**

- **链接: [https://arxiv.org/pdf/2511.14566v1](https://arxiv.org/pdf/2511.14566v1)**
...
>
---
#### [new 046] Knowledge-Grounded Agentic Large Language Models for Multi-Hazard Understanding from Reconnaissance Reports
- **分类: cs.CL; cs.AI**

- **简介: 论文提出MoRA-RAG框架，解决灾后报告中多灾害理解难题。通过知识增强的代理检索机制和验证循环，提升LLM在非结构化报告中的准确性与可靠性，实现更可信的灾害分析。**

- **链接: [https://arxiv.org/pdf/2511.14010v1](https://arxiv.org/pdf/2511.14010v1)**
...
>
---
#### [new 049] PRISM: Prompt-Refined In-Context System Modelling for Financial Retrieval
- **分类: cs.AI; cs.CE; cs.CL; cs.IR**

- **简介: 论文提出PRISM框架，用于金融文档检索任务，解决从长篇财务文件中精准提取相关信息的问题。通过精炼系统提示、上下文学习和轻量多智能体系统协同工作，实现高效准确的文档与段落排序。**

- **链接: [https://arxiv.org/pdf/2511.14130v1](https://arxiv.org/pdf/2511.14130v1)**
...
>
---
#### [new 050] Scaling Patterns in Adversarial Alignment: Evidence from Multi-LLM Jailbreak Experiments
- **分类: cs.LG; cs.AI; cs.CL; cs.CR; cs.MA**

- **简介: 论文研究多大语言模型间对抗性 jailbreak 的规模效应，解决“大模型是否能系统性突破小模型安全防护”问题。通过6000+次交互实验，发现攻击者与目标模型的相对大小显著影响危害程度，且攻击者自身对齐程度可有效抑制有害输出。**

- **链接: [https://arxiv.org/pdf/2511.13788v1](https://arxiv.org/pdf/2511.13788v1)**
...
>
---
#### [new 058] DataSage: Multi-agent Collaboration for Insight Discovery with External Knowledge Retrieval, Multi-role Debating, and Multi-path Reasoning
- **分类: cs.AI; cs.CL; cs.MA**

- **简介: 论文提出DataSage框架，用于自动化数据洞察发现任务。针对现有方法知识利用不足、分析浅层和代码错误问题，引入外部知识检索、多角色辩论和多路径推理机制，显著提升洞察质量与准确性。**

- **链接: [https://arxiv.org/pdf/2511.14299v1](https://arxiv.org/pdf/2511.14299v1)**
...
>
---
#### [new 059] O3SLM: Open Weight, Open Data, and Open Vocabulary Sketch-Language Model
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 002] VisAidMath: Benchmarking Visual-Aided Mathematical Reasoning
...
>
---
#### [replaced 003] Patent Language Model Pretraining with ModernBERT
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.14926v3](https://arxiv.org/pdf/2509.14926v3)**
...
>
---
#### [replaced 004] Artificial intelligence contribution to translation industry: looking back and forward
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2411.19855v4](https://arxiv.org/pdf/2411.19855v4)**

> **作者:** Mohammed Q. Shormani; Yehia A. Al-Sohbani
>
...
>
---
#### [replaced 005] AI use in American newspapers is widespread, uneven, and rarely disclosed
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2510.18774v2](https://arxiv.org/pdf/2510.18774v2)**
...
>
---
#### [replaced 006] KnowCoder-A1: Incentivizing Agentic Reasoning Capability with Outcome Supervision for KBQA
- **分类: cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2510.25101v2](https://arxiv.org/pdf/2510.25101v2)**
...
>
---
#### [replaced 007] Who Gets the Reward, Who Gets the Blame? Evaluation-Aligned Training Signals for Multi-LLM Agents
- **分类: cs.MA; cs.AI; cs.CL; cs.GT**

- **链接: [https://arxiv.org/pdf/2511.10687v2](https://arxiv.org/pdf/2511.10687v2)**

> **作者:** Chih-Hsuan Yang; Tanwi Mallick; Le Chen; Krishnan Raghavan; Azton Wells; Amal Gueroudji; Ian T. Foster; Rajeev Thakur
>
> **备注:** Withdrawing temporarily to coordinate revisions with co-authors. A revised version will be resubmitted
>
...
>
---
#### [replaced 010] GenRecal: Generation after Recalibration from Large to Small Vision-Language Models
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2506.15681v2](https://arxiv.org/pdf/2506.15681v2)**
...
>
---
#### [replaced 011] FinVet: A Collaborative Framework of RAG and External Fact-Checking Agents for Financial Misinformation Detection
- **分类: cs.IR; cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2510.11654v2](https://arxiv.org/pdf/2510.11654v2)**
...
>
---
#### [replaced 012] Predicting the Performance of Black-box LLMs through Self-Queries
- **分类: cs.LG; cs.CL**

- **链接: [https://arxiv.org/pdf/2501.01558v3](https://arxiv.org/pdf/2501.01558v3)**

> **作者:** Dylan Sam; Marc Finzi; J. Zico Kolter
>
> **备注:** NeurIPS 2025
>
> **摘要:** As large language models (LLMs) are increasingly relied on in AI systems, predicting when they make mistakes is crucial. While a great deal of work in the field uses internal representations to interpret model behavior, these representations are inaccessible when given solely black-box access through an API. In this paper, we extract features of LLMs in a black-box manner by using follow-up prompts and taking the probabilities of different responses as representations to train reliable predictors of model behavior. We demonstrate that training a linear model on these low-dimensional representations produces reliable and generalizable predictors of model performance at the instance level (e.g., if a particular generation correctly answers a question). Remarkably, these can often outperform white-box linear predictors that operate over a model's hidden state or the full distribution over its vocabulary. In addition, we demonstrate that these extracted features can be used to evaluate more nuanced aspects of a language model's state. For instance, they can be used to distinguish between a clean version of GPT-4o-mini and a version that has been influenced via an adversarial system prompt that answers question-answering tasks incorrectly or introduces bugs into generated code. Furthermore, they can reliably distinguish between different model architectures and sizes, enabling the detection of misrepresented models provided through an API (e.g., identifying if GPT-3.5 is supplied instead of GPT-4o-mini).
>
---
#### [replaced 013] Can Machines Think Like Humans? A Behavioral Evaluation of LLM Agents in Dictator Games
- **分类: cs.CL; cs.AI; cs.CY; cs.LG; econ.GN**

- **链接: [https://arxiv.org/pdf/2410.21359v3](https://arxiv.org/pdf/2410.21359v3)**
...
>
---
#### [replaced 014] MoM: Linear Sequence Modeling with Mixture-of-Memories
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2502.13685v4](https://arxiv.org/pdf/2502.13685v4)**
...
> **备注:** 252 pages
>
> **摘要:** With a focus on natural language processing (NLP) and the role of large language models (LLMs), we explore the intersection of machine learning, deep learning, and artificial intelligence. As artificial intelligence continues to revolutionize fields from healthcare to finance, NLP techniques such as tokenization, text classification, and entity recognition are essential for processing and understanding human language. This paper discusses advanced data preprocessing techniques and the use of frameworks like Hugging Face for implementing transformer-based models. Additionally, it highlights challenges such as handling multilingual data, reducing bias, and ensuring model robustness. By addressing key aspects of data processing and model fine-tuning, this work aims to provide insights into deploying effective and ethically sound AI solutions.
>
---
#### [replaced 017] Are We Asking the Right Questions? On Ambiguity in Natural Language Queries for Tabular Data Analysis
- **分类: cs.AI; cs.CL; cs.DB; cs.HC**

- **链接: [https://arxiv.org/pdf/2511.04584v3](https://arxiv.org/pdf/2511.04584v3)**
...
>
---
#### [replaced 018] Crossing Borders: A Multimodal Challenge for Indian Poetry Translation and Image Generation
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 019] Evaluating Large Language Models for Diacritic Restoration in Romanian Texts: A Comparative Study
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.13182v2](https://arxiv.org/pdf/2511.13182v2)**
...
>
---
#### [replaced 020] Evaluation of OpenAI o1: Opportunities and Challenges of AGI
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2409.18486v3](https://arxiv.org/pdf/2409.18486v3)**
...
>
---
#### [replaced 021] MiroThinker: Pushing the Performance Boundaries of Open-Source Research Agents via Model, Context, and Interactive Scaling
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.11793v2](https://arxiv.org/pdf/2511.11793v2)**
...
>
---
#### [replaced 024] Hidden in the Noise: Unveiling Backdoors in Audio LLMs Alignment through Latent Acoustic Pattern Triggers
...
>
---
#### [replaced 025] NAIST Academic Travelogue Dataset
- **分类: cs.CL; cs.AI; cs.DL**

- **链接: [https://arxiv.org/pdf/2305.11444v2](https://arxiv.org/pdf/2305.11444v2)**

> **作者:** Hiroki Ouchi; Hiroyuki Shindo; Shoko Wakamiya; Yuki Matsuda; Naoya Inoue; Shohei Higashiyama; Satoshi Nakamura; Taro Watanabe
>
> **备注:** Updated version with revised manuscript
>
...
>
---
#### [replaced 026] O-Mem: Omni Memory System for Personalized, Long Horizon, Self-Evolving Agents
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.13593v2](https://arxiv.org/pdf/2511.13593v2)**
...
>
---
#### [replaced 027] OptScale: Probabilistic Optimality for Inference-time Scaling
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2506.22376v3](https://arxiv.org/pdf/2506.22376v3)**
...
>
---
#### [replaced 028] Continuous sentiment scores for literary and multilingual contexts
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2508.14620v2](https://arxiv.org/pdf/2508.14620v2)**
...
>
---
#### [replaced 029] In-context Language Learning for Endangered Languages in Speech Recognition
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.20445v4](https://arxiv.org/pdf/2505.20445v4)**
...
>
---
#### [replaced 030] Beyond Benchmark: LLMs Evaluation with an Anthropomorphic and Value-oriented Roadmap
- **分类: cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2508.18646v2](https://arxiv.org/pdf/2508.18646v2)**
...
>
---
#### [replaced 031] OpeNLGauge: An Explainable Metric for NLG Evaluation with Open-Weights LLMs
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2503.11858v3](https://arxiv.org/pdf/2503.11858v3)**
...
>
---
#### [replaced 032] GraphInstruct: Empowering Large Language Models with Graph Understanding and Reasoning Capability
- **分类: cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2403.04483v4](https://arxiv.org/pdf/2403.04483v4)**
...
>
---
#### [replaced 035] LLM-as-a-Grader: Practical Insights from Large Language Model for Short-Answer and Report Evaluation
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.10819v2](https://arxiv.org/pdf/2511.10819v2)**
...
>
---
#### [replaced 036] LocalBench: Benchmarking LLMs on County-Level Local Knowledge and Reasoning
- **分类: cs.CL; cs.AI; cs.CY**

- **链接: [https://arxiv.org/pdf/2511.10459v2](https://arxiv.org/pdf/2511.10459v2)**
...
>
---
#### [replaced 037] EvoLM: In Search of Lost Language Model Training Dynamics
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.16029v2](https://arxiv.org/pdf/2506.16029v2)**
...
>
---
#### [replaced 038] PromptGuard at BLP-2025 Task 1: A Few-Shot Classification Framework Using Majority Voting and Keyword Similarity for Bengali Hate Speech Detection
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.09771v2](https://arxiv.org/pdf/2510.09771v2)**
...
>
---
#### [replaced 039] CoSense-LLM: Semantics at the Edge with Cost- and Uncertainty-Aware Cloud-Edge Cooperation
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2510.19670v3](https://arxiv.org/pdf/2510.19670v3)**
...
>
---
#### [replaced 040] Scaling Textual Gradients via Sampling-Based Momentum
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2506.00400v3](https://arxiv.org/pdf/2506.00400v3)**

> **作者:** Zixin Ding; Junyuan Hong; Zhan Shi; Jiachen T. Wang; Zinan Lin; Li Yin; Meng Liu; Zhangyang Wang; Yuxin Chen
>
...
>
---
#### [replaced 041] Model Editing as a Double-Edged Sword: Steering Agent Ethical Behavior Toward Beneficence or Harm
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2506.20606v2](https://arxiv.org/pdf/2506.20606v2)**

> **作者:** Baixiang Huang; Zhen Tan; Haoran Wang; Zijie Liu; Dawei Li; Ali Payani; Huan Liu; Tianlong Chen; Kai Shu
>
> **备注:** AAAI 2026 Oral. 14 pages (including appendix), 11 figures. Code, data, results, and additional resources are available at: https://model-editing.github.io
>
...
>
---
#### [replaced 042] MajinBook: An open catalogue of digital world literature with likes
- **分类: cs.CL; cs.CY; stat.OT**

- **链接: [https://arxiv.org/pdf/2511.11412v2](https://arxiv.org/pdf/2511.11412v2)**
...
>
---
#### [replaced 045] ACoRN: Noise-Robust Abstractive Compression in Retrieval-Augmented Language Models
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2504.12673v2](https://arxiv.org/pdf/2504.12673v2)**
...
>
---
#### [replaced 046] Do Retrieval Augmented Language Models Know When They Don't Know?
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.01476v3](https://arxiv.org/pdf/2509.01476v3)**
...
>
---
#### [replaced 047] Scaling Latent Reasoning via Looped Language Models
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2510.25741v4](https://arxiv.org/pdf/2510.25741v4)**
...
>
---
#### [replaced 048] Theories of "Sexuality" in Natural Language Processing Bias Research
- **分类: cs.CY; cs.CL**

- **链接: [https://arxiv.org/pdf/2506.22481v2](https://arxiv.org/pdf/2506.22481v2)**

> **作者:** Jacob Hobbs
>
> **备注:** 17 pages, 6 tables, 1 figure, undergraduate senior thesis, submitted to The Spectra: The Virginia Engineering and Science Research Journal
>
...
>
---
#### [replaced 049] AgentArmor: Enforcing Program Analysis on Agent Runtime Trace to Defend Against Prompt Injection
- **分类: cs.CR; cs.AI; cs.CL; cs.LG; cs.SE**

- **链接: [https://arxiv.org/pdf/2508.01249v3](https://arxiv.org/pdf/2508.01249v3)**
...
>
---
#### [replaced 050] SpecEdge: Scalable Edge-Assisted Serving Framework for Interactive LLMs
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.17052v2](https://arxiv.org/pdf/2505.17052v2)**
...
>
---
#### [replaced 053] IntelliProof: An Argumentation Network-based Conversational Helper for Organized Reflection
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.04528v2](https://arxiv.org/pdf/2511.04528v2)**
...
>
---
#### [replaced 054] Iris: Integrating Language into Diffusion-based Monocular Depth Estimation
...
>
---
#### [replaced 055] Spark-Prover-X1: Formal Theorem Proving Through Diverse Data Training
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.13043v2](https://arxiv.org/pdf/2511.13043v2)**
...
>
---
#### [replaced 056] SpiderGen: Towards Procedure Generation For Carbon Life Cycle Assessments with Generative AI
- **分类: cs.CL; cs.CY**

- **链接: [https://arxiv.org/pdf/2511.10684v2](https://arxiv.org/pdf/2511.10684v2)**
...
>
---
#### [replaced 057] IPAD: Inverse Prompt for AI Detection - A Robust and Interpretable LLM-Generated Text Detector
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2502.15902v3](https://arxiv.org/pdf/2502.15902v3)**
...
>
---
#### [replaced 058] MCTSr-Zero: Self-Reflective Psychological Counseling Dialogues Generation via Principles and Adaptive Exploration
- **分类: cs.CL; cs.AI; cs.CY**

- **链接: [https://arxiv.org/pdf/2505.23229v2](https://arxiv.org/pdf/2505.23229v2)**

> **作者:** Hao Lu; Yanchi Gu; Haoyuan Huang; Yulin Zhou; Ningxin Zhu; Chen Li
>
> **备注:** 48 pages, 3 figures. Accepted in AAAI-2026 (Main Technical Track). For code and model, see this https://github.com/JianChengXingYun/Mctsr-Zero
>
