...
#### [new 001] FreeOrbit4D: Training-Free Arbitrary Camera Redirection for Monocular Videos via Geometry-Complete 4D Reconstruction
- **分类: cs.CV; cs.AI; cs.GR**

- **简介: 该论文属于单目视频相机重定向任务，解决大角度视角变化下的几何模糊与时间不一致问题。提出FreeOrbit4D框架，通过4D重建生成完整几何结构引导视频生成。**

- **链接: [https://arxiv.org/pdf/2601.18993v1](https://arxiv.org/pdf/2601.18993v1)**

> **作者:** Wei Cao; Hao Zhang; Fengrui Tian; Yulun Wu; Yingying Li; Shenlong Wang; Ning Yu; Yaoyao Liu
>
> **备注:** 14 pages, 10 figures
>
> **摘要:** Camera redirection aims to replay a dynamic scene from a single monocular video under a user-specified camera trajectory. However, large-angle redirection is inherently ill-posed: a monocular video captures only a narrow spatio-temporal view of a dynamic 3D scene, providing highly partial observations of the underlying 4D world. The key challenge is therefore to recover a complete and coherent representation from this limited input, with consistent geometry and motion. While recent diffusion-based methods achieve impressive results, they often break down under large-angle viewpoint changes far from the original trajectory, where missing visual grounding leads to severe geometric ambiguity and temporal inconsistency. To address this, we present FreeOrbit4D, an effective training-free framework that tackles this geometric ambiguity by recovering a geometry-complete 4D proxy as structural grounding for video generation. We obtain this proxy by decoupling foreground and background reconstructions: we unproject the monocular video into a static background and geometry-incomplete foreground point clouds in a unified global space, then leverage an object-centric multi-view diffusion model to synthesize multi-view images and reconstruct geometry-complete foreground point clouds in canonical object space. By aligning the canonical foreground point cloud to the global scene space via dense pixel-synchronized 3D--3D correspondences and projecting the geometry-complete 4D proxy onto target camera viewpoints, we provide geometric scaffolds that guide a conditional video diffusion model. Extensive experiments show that FreeOrbit4D produces more faithful redirected videos under challenging large-angle trajectories, and our geometry-complete 4D proxy further opens a potential avenue for practical applications such as edit propagation and 4D data generation. Project page and code will be released soon.
>
---
#### [new 002] GeoDiff3D: Self-Supervised 3D Scene Generation with Geometry-Constrained 2D Diffusion Guidance
- **分类: cs.CV**

- **简介: 该论文提出GeoDiff3D，解决3D场景生成中的结构建模不足和依赖标注数据的问题。通过自监督学习和几何约束的2D扩散模型，实现高效高质量的3D场景生成。**

- **链接: [https://arxiv.org/pdf/2601.19785v1](https://arxiv.org/pdf/2601.19785v1)**
...
>
---
#### [new 017] Pareto-Guided Optimization for Uncertainty-Aware Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，解决不确定性分布不均导致的训练不稳定问题。通过区域课程策略和帕累托一致性损失，提升分割精度与稳定性。**

- **链接: [https://arxiv.org/pdf/2601.19365v1](https://arxiv.org/pdf/2601.19365v1)**
...
>
> **摘要:** Robust 3D hand reconstruction in egocentric vision is challenging due to depth ambiguity, self-occlusion, and complex hand-object interactions. Prior methods mitigate these issues by scaling training data or adding auxiliary cues, but they often struggle in unseen contexts. We present EgoHandICL, the first in-context learning (ICL) framework for 3D hand reconstruction that improves semantic alignment, visual consistency, and robustness under challenging egocentric conditions. EgoHandICL introduces complementary exemplar retrieval guided by vision-language models (VLMs), an ICL-tailored tokenizer for multimodal context, and a masked autoencoder (MAE)-based architecture trained with hand-guided geometric and perceptual objectives. Experiments on ARCTIC and EgoExo4D show consistent gains over state-of-the-art methods. We also demonstrate real-world generalization and improve EgoVLM hand-object interaction reasoning by using reconstructed hands as visual prompts. Code and data: https://github.com/Nicous20/EgoHandICL
>
---
#### [new 020] Unveiling Perceptual Artifacts: A Fine-Grained Benchmark for Interpretable AI-Generated Image Detection
- **分类: cs.CV**

- **简介: 该论文属于AI生成图像检测任务，旨在解决现有方法依赖不可解释特征的问题。提出X-AIGD基准，提供细粒度标注以提升模型可解释性。**

- **链接: [https://arxiv.org/pdf/2601.19430v1](https://arxiv.org/pdf/2601.19430v1)**
...
>
---
#### [new 025] ScenePilot-Bench: A Large-Scale Dataset and Benchmark for Evaluation of Vision-Language Models in Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文提出ScenePilot-Bench，用于评估视觉-语言模型在自动驾驶中的表现。解决自动驾驶中多模态理解与决策问题，通过大规模数据集和多维度评测框架提升模型安全性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.19582v1](https://arxiv.org/pdf/2601.19582v1)**
...
>
---
#### [new 040] Bridging Information Asymmetry: A Hierarchical Framework for Deterministic Blind Face Restoration
- **分类: cs.CV**

- **简介: 该论文属于图像修复任务，解决盲态人脸恢复中的信息不对称问题。提出Pref-Restore框架，通过增强输入密度和修剪输出分布实现确定性恢复。**

- **链接: [https://arxiv.org/pdf/2601.19506v1](https://arxiv.org/pdf/2601.19506v1)**
...
>
---
#### [new 048] m2sv: A Scalable Benchmark for Map-to-Street-View Spatial Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出m2sv基准，解决地图到街景的空间推理问题。通过对比地图与街景图像，评估模型的空间对齐能力，发现现有模型表现远低于人类。**

- **链接: [https://arxiv.org/pdf/2601.19099v1](https://arxiv.org/pdf/2601.19099v1)**

> **作者:** Yosub Shin; Michael Buriek; Igor Molybog
>
> **摘要:** Vision--language models (VLMs) achieve strong performance on many multimodal benchmarks but remain brittle on spatial reasoning tasks that require aligning abstract overhead representations with egocentric views. We introduce m2sv, a scalable benchmark for map-to-street-view spatial reasoning that asks models to infer camera viewing direction by aligning a north-up overhead map with a Street View image captured at the same real-world intersection. We release m2sv-20k, a geographically diverse benchmark with controlled ambiguity, along with m2sv-sft-11k, a curated set of structured reasoning traces for supervised fine-tuning. Despite strong performance on existing multimodal benchmarks, the best evaluated VLM achieves only 65.2% accuracy on m2sv, far below the human baseline of 95%. While supervised fine-tuning and reinforcement learning yield consistent gains, cross-benchmark evaluations reveal limited transfer. Beyond aggregate accuracy, we systematically analyze difficulty in map-to-street-view reasoning using both structural signals and human effort, and conduct an extensive failure analysis of adapted open models. Our findings highlight persistent gaps in geometric alignment, evidence aggregation, and reasoning consistency, motivating future work on grounded spatial reasoning across viewpoints.
>
---
#### [new 049] CLIP-Guided Unsupervised Semantic-Aware Exposure Correction
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像曝光校正任务，解决真实图像无标签及语义信息缺失导致的色偏和细节丢失问题。提出一种无监督方法，融合语义信息并利用CLIP生成伪标签进行训练。**

- **链接: [https://arxiv.org/pdf/2601.19129v1](https://arxiv.org/pdf/2601.19129v1)**
...
>
---
#### [new 052] Towards Gold-Standard Depth Estimation for Tree Branches in UAV Forestry: Benchmarking Deep Stereo Matching Methods
- **分类: cs.CV; cs.RO; eess.IV**

- **简介: 该论文属于深度估计任务，旨在解决UAV林业中植被密集环境下的深度估计问题。通过评估多种立体匹配方法，提出DEFOM为新的基准。**

- **链接: [https://arxiv.org/pdf/2601.19461v1](https://arxiv.org/pdf/2601.19461v1)**
...
>
---
#### [new 053] GTFMN: Guided Texture and Feature Modulation Network for Low-Light Image Enhancement and Super-Resolution
- **分类: cs.CV**

- **简介: 该论文属于低光图像增强与超分辨率任务，旨在解决低光照下图像质量差和分辨率低的问题。提出GTFMN网络，通过分离光照估计与纹理恢复实现图像提升。**

- **链接: [https://arxiv.org/pdf/2601.19157v1](https://arxiv.org/pdf/2601.19157v1)**
...
>
---
#### [new 067] Contrastive Spectral Rectification: Test-Time Defense towards Zero-shot Adversarial Robustness of CLIP
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言模型的对抗鲁棒性研究，旨在解决CLIP模型在零样本场景下对对抗样本的脆弱性问题。提出一种高效测试时防御方法CSR，通过频谱对比修正提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.19210v1](https://arxiv.org/pdf/2601.19210v1)**
...
>
---
#### [new 068] Glance and Focus Reinforcement for Pan-cancer Screening
- **分类: cs.CV**

- **简介: 该论文属于癌症筛查任务，解决CT影像中微小病灶定位与分割难题。提出GF-Screen框架，结合强化学习实现高效精准筛查。**

- **链接: [https://arxiv.org/pdf/2601.19103v1](https://arxiv.org/pdf/2601.19103v1)**
...
>
---
#### [new 075] Query-Guided Spatial-Temporal-Frequency Interaction for Music Audio-Visual Question Answering
- **分类: cs.CV**

- **简介: 该论文属于音频-视觉问答任务，旨在解决音频与视觉信息融合不足的问题。提出QSTar方法，结合时空频特征和问题引导，提升多模态理解能力。**

- **链接: [https://arxiv.org/pdf/2601.19821v1](https://arxiv.org/pdf/2601.19821v1)**
...
>
---
#### [new 076] Youtu-VL: Unleashing Visual Potential via Unified Vision-Language Supervision
- **分类: cs.CV**

- **简介: 该论文提出Youtu-VL，解决VLMs在保留细粒度视觉信息上的不足，通过统一视觉语言监督提升多模态理解能力。属于多模态任务。**

- **链接: [https://arxiv.org/pdf/2601.19798v1](https://arxiv.org/pdf/2601.19798v1)**
...
>
> **摘要:** Despite the significant advancements represented by Vision-Language Models (VLMs), current architectures often exhibit limitations in retaining fine-grained visual information, leading to coarse-grained multimodal comprehension. We attribute this deficiency to a suboptimal training paradigm inherent in prevailing VLMs, which exhibits a text-dominant optimization bias by conceptualizing visual signals merely as passive conditional inputs rather than supervisory targets. To mitigate this, we introduce Youtu-VL, a framework leveraging the Vision-Language Unified Autoregressive Supervision (VLUAS) paradigm, which fundamentally shifts the optimization objective from ``vision-as-input'' to ``vision-as-target.'' By integrating visual tokens directly into the prediction stream, Youtu-VL applies unified autoregressive supervision to both visual details and linguistic content. Furthermore, we extend this paradigm to encompass vision-centric tasks, enabling a standard VLM to perform vision-centric tasks without task-specific additions. Extensive empirical evaluations demonstrate that Youtu-VL achieves competitive performance on both general multimodal tasks and vision-centric tasks, establishing a robust foundation for the development of comprehensive generalist visual agents.
>
---
#### [new 077] EPAS: Efficient Training with Progressive Activation Sharing
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出EPAS方法，解决Transformer训练中冗余QK激活的问题，通过渐进式共享提升训练和推理效率。属于模型优化任务。**

- **链接: [https://arxiv.org/pdf/2601.19089v1](https://arxiv.org/pdf/2601.19089v1)**
...
>
---
#### [new 078] Bridging Visual and Wireless Sensing: A Unified Radiation Field for 3D Radio Map Construction
- **分类: cs.NI; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于3D无线电图构建任务，旨在解决传统方法无法有效融合视觉与无线感知的问题。通过提出URF-GS框架，实现高精度、高效的数据融合与信号预测。**

- **链接: [https://arxiv.org/pdf/2601.19216v1](https://arxiv.org/pdf/2601.19216v1)**
...
>
---
#### [new 079] GUIGuard: Toward a General Framework for Privacy-Preserving GUI Agents
- **分类: cs.CR; cs.AI; cs.CV**

- **简介: 该论文提出GUIGuard框架，解决GUI代理中的隐私泄露问题，通过三阶段流程实现隐私保护与任务执行。属于隐私保护任务。**

- **链接: [https://arxiv.org/pdf/2601.18842v1](https://arxiv.org/pdf/2601.18842v1)**
...
>
---
#### [new 080] Optimized $k$-means color quantization of digital images in machine-based and human perception-based colorspaces
- **分类: eess.IV; cs.CV; stat.AP**

- **简介: 该论文研究k-means在不同颜色空间中的图像量化效果，旨在优化颜色量化质量。任务是评估不同颜色空间对k-means量化性能的影响。工作包括在多种颜色空间进行实验，并分析不同量化级别下的表现。**

- **链接: [https://arxiv.org/pdf/2601.19117v1](https://arxiv.org/pdf/2601.19117v1)**
...
>
---
#### [new 081] Benchmarking Multimodal Large Language Models for Missing Modality Completion in Product Catalogues
- **分类: cs.MM; cs.CV; cs.IR**

- **简介: 该论文属于多模态生成任务，旨在解决电商产品信息缺失问题。通过构建基准测试，评估MLLMs在图像与文本补全中的表现，并探索优化方法。**

- **链接: [https://arxiv.org/pdf/2601.19750v1](https://arxiv.org/pdf/2601.19750v1)**
...
>
---
#### [new 086] NavFormer: IGRF Forecasting in Moving Coordinate Frames
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于IGRF预测任务，解决传感器姿态变化带来的误差问题，通过旋转不变特征和SPD模块实现稳定预测。**

- **链接: [https://arxiv.org/pdf/2601.18800v1](https://arxiv.org/pdf/2601.18800v1)**
...
>
---
#### [new 087] LocationAgent: A Hierarchical Agent for Image Geolocation via Decoupling Strategy and Evidence from Parametric Knowledge
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于图像地理定位任务，旨在解决模型在开放场景中因知识不足导致的错误推理问题。提出LocationAgent，通过分层推理和外部证据验证提升定位准确性。**

- **链接: [https://arxiv.org/pdf/2601.19155v1](https://arxiv.org/pdf/2601.19155v1)**
...
>
---
#### [replaced 003] Parameter-Efficient MoE LoRA for Few-Shot Multi-Style Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.11236v3](https://arxiv.org/pdf/2511.11236v3)**
...
>
---
#### [replaced 004] Federated Joint Learning for Domain and Class Generalization
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.12253v2](https://arxiv.org/pdf/2601.12253v2)**
...
>
---
#### [replaced 005] Probing Deep into Temporal Profile Makes the Infrared Small Target Detector Much Better
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.12766v4](https://arxiv.org/pdf/2506.12766v4)**
...
>
---
#### [replaced 006] iFSQ: Improving FSQ for Image Generation with 1 Line of Code
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.17124v2](https://arxiv.org/pdf/2601.17124v2)**
...
>
> **备注:** Technical Report; Fixed eq.7 & 8 and corresponding content
>
...
>
---
#### [replaced 007] Beyond Memorization: Selective Learning for Copyright-Safe Diffusion Model Training
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11194v2](https://arxiv.org/pdf/2512.11194v2)**
...
>
---
#### [replaced 008] Knowledge-enhanced Pretraining for Vision-language Pathology Foundation Model on Cancer Diagnosis
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2412.13126v2](https://arxiv.org/pdf/2412.13126v2)**
...
>
> **备注:** V2: fixed typos, updated experimental results, added ablation
>
...
>
---
#### [replaced 011] Supervising 3D Talking Head Avatars with Analysis-by-Audio-Synthesis
- **分类: cs.GR; cs.CV**

- **链接: [https://arxiv.org/pdf/2504.13386v4](https://arxiv.org/pdf/2504.13386v4)**
...
>
---
#### [replaced 012] Extensions on Low-complexity DCT Approximations for Larger Blocklengths Based on Minimal Angle Similarity
- **分类: eess.IV; cs.CV; eess.SP; math.NA; stat.ME**

- **链接: [https://arxiv.org/pdf/2410.15244v2](https://arxiv.org/pdf/2410.15244v2)**

> **作者:** A. P. Radünz; L. Portella; R. S. Oliveira; F. M. Bayer; R. J. Cintra
>
> **备注:** Clarified methodology; 27 pages, 6 figures, 5 tables
>
> **摘要:** The discrete cosine transform (DCT) is a central tool for image and video coding because it can be related to the Karhunen-Loève transform (KLT), which is the optimal transform in terms of retained transform coefficients and data decorrelation. In this paper, we introduce 16-, 32-, and 64-point low-complexity DCT approximations by minimizing individually the angle between the rows of the exact DCT matrix and the matrix induced by the approximate transforms. According to some classical figures of merit, the proposed transforms outperformed the approximations for the DCT already known in the literature. Fast algorithms were also developed for the low-complexity transforms, asserting a good balance between the performance and its computational cost. Practical applications in image encoding showed the relevance of the transforms in this context. In fact, the experiments showed that the proposed transforms had better results than the known approximations in the literature for the cases of 16, 32, and 64 blocklength.
>
---
#### [replaced 013] Universal Multi-Domain Translation via Diffusion Routers
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.03252v3](https://arxiv.org/pdf/2510.03252v3)**
...
>
---
#### [replaced 014] Geometry-Grounded Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.17835v2](https://arxiv.org/pdf/2601.17835v2)**
...
>
---
#### [replaced 018] Vlaser: Vision-Language-Action Model with Synergistic Embodied Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.11027v2](https://arxiv.org/pdf/2510.11027v2)**
...
>
---
#### [replaced 019] MLVTG: Mamba-Based Feature Alignment and LLM-Driven Purification for Multi-Modal Video Temporal Grounding
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2506.08512v2](https://arxiv.org/pdf/2506.08512v2)**

> **作者:** Zhiyi Zhu; Xiaoyu Wu; Zihao Liu; Linlin Yang
>
> **摘要:** Video Temporal Grounding (VTG), which aims to localize video clips corresponding to natural language queries, is a fundamental yet challenging task in video understanding. Existing Transformer-based methods often suffer from redundant attention and suboptimal multi-modal alignment. To address these limitations, we propose MLVTG, a novel framework that integrates two key modules: MambaAligner and LLMRefiner. MambaAligner uses stacked Vision Mamba blocks as a backbone instead of Transformers to model temporal dependencies and extract robust video representations for multi-modal alignment. LLMRefiner leverages the specific frozen layer of a pre-trained Large Language Model (LLM) to implicitly transfer semantic priors, enhancing multi-modal alignment without fine-tuning. This dual alignment strategy, temporal modeling via structured state-space dynamics and semantic purification via textual priors, enables more precise localization. Extensive experiments on QVHighlights, Charades-STA, and TVSum demonstrate that MLVTG achieves state-of-the-art performance and significantly outperforms existing baselines.
>
---
#### [replaced 020] AI-generated data contamination erodes pathological variability and diagnostic reliability
...
>
---
#### [replaced 023] Leveraging Convolutional and Graph Networks for an Unsupervised Remote Sensing Labelling Tool
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.00506v2](https://arxiv.org/pdf/2508.00506v2)**

> **作者:** Tulsi Patel; Mark W. Jones; Thomas Redfern
>
> **备注:** Accepted for Taylor and Francis, Annals of GIS * Video supplement demonstrating feature-space exploration and interactive labelling is available at: https://youtu.be/GZl1ebZJgEA and is archived at https://doi.org/10.5281/zenodo.16676591
>
...
>
---
#### [replaced 024] Astra: General Interactive World Model with Autoregressive Denoising
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.08931v3](https://arxiv.org/pdf/2512.08931v3)**

> **作者:** Yixuan Zhu; Jiaqi Feng; Wenzhao Zheng; Yuan Gao; Xin Tao; Pengfei Wan; Jie Zhou; Jiwen Lu
>
> **备注:** Accepted in ICLR 2026. Code is available at: https://github.com/EternalEvan/Astra
>
...
>
---
#### [replaced 025] Purrception: Variational Flow Matching for Vector-Quantized Image Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.01478v2](https://arxiv.org/pdf/2510.01478v2)**
...
>
---
#### [replaced 026] Self-Evolving Vision-Language Models for Image Quality Assessment via Voting and Ranking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.25787v4](https://arxiv.org/pdf/2509.25787v4)**
...
>
---
#### [replaced 027] Atomic Depth Estimation From Noisy Electron Microscopy Data Via Deep Learning
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.17046v2](https://arxiv.org/pdf/2601.17046v2)**

> **作者:** Matan Leibovich; Mai Tan; Ramon Manzorro-Ureba; Adria Marcos-Morales; Sreyas Mohan; Peter A. Crozier; Carlos Fernandez-Granda
>
...
>
---
#### [replaced 028] ReVision: A Dataset and Baseline VLM for Privacy-Preserving Task-Oriented Visual Instruction Rewriting
...
>
---
#### [replaced 029] MV-S2V: Multi-View Subject-Consistent Video Generation
- **分类: cs.CV; cs.AI; cs.GR**

- **链接: [https://arxiv.org/pdf/2601.17756v2](https://arxiv.org/pdf/2601.17756v2)**
...
>
---
#### [replaced 030] DiVE-k: Differential Visual Reasoning for Fine-grained Image Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18305v2](https://arxiv.org/pdf/2511.18305v2)**
...
>
---
#### [replaced 031] Omni-AVSR: Towards Unified Multimodal Speech Recognition with Large Language Models
...
>
---
#### [replaced 032] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.09239v2](https://arxiv.org/pdf/2508.09239v2)**
...
>
---
#### [replaced 037] MindCine: Multimodal EEG-to-Video Reconstruction with Large-Scale Pretrained Models
- **分类: cs.CV; cs.HC; cs.MM**

- **链接: [https://arxiv.org/pdf/2601.18192v2](https://arxiv.org/pdf/2601.18192v2)**
...
>
---
#### [replaced 038] NegoCollab: A Common Representation Negotiation Approach for Heterogeneous Collaborative Perception
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.27647v2](https://arxiv.org/pdf/2510.27647v2)**

> **作者:** Congzhang Shao; Quan Yuan; Guiyang Luo; Yue Hu; Danni Wang; Yilin Liu; Rui Pan; Bo Chen; Jinglin Li
>
> **备注:** 22 pages, Accepted by NeurIPS 2025
>
...
>
---
#### [replaced 039] LangForce: Bayesian Decomposition of Vision Language Action Models via Latent Action Queries
...
>
---
#### [replaced 040] An Efficient and Explainable KAN Framework for Wireless Radiation Field Prediction
- **分类: cs.NI; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.11656v2](https://arxiv.org/pdf/2601.11656v2)**
...
>
---
#### [replaced 044] Learning Video Generation for Robotic Manipulation with Collaborative Trajectory Control
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.01943v3](https://arxiv.org/pdf/2506.01943v3)**

> **作者:** Xiao Fu; Xintao Wang; Xian Liu; Jianhong Bai; Runsen Xu; Pengfei Wan; Di Zhang; Dahua Lin
>
> **备注:** ICLR 2026. Project Page: https://fuxiao0719.github.io/projects/robomaster/
>
...
>
---
#### [replaced 045] The Script is All You Need: An Agentic Framework for Long-Horizon Dialogue-to-Cinematic Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.17737v2](https://arxiv.org/pdf/2601.17737v2)**
...
>
---
#### [replaced 046] SeNeDiF-OOD: Semantic Nested Dichotomy Fusion for Out-of-Distribution Detection Methodology in Open-World Classification. A Case Study on Monument Style Classification
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.18739v2](https://arxiv.org/pdf/2601.18739v2)**
...
>
---
#### [replaced 047] A Gift from the Integration of Discriminative and Diffusion-based Generative Learning: Boundary Refinement Remote Sensing Semantic Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.01573v2](https://arxiv.org/pdf/2507.01573v2)**

> **作者:** Hao Wang; Keyan Hu; Xin Guo; Haifeng Li; Chao Tao
>
> **备注:** Accepted for publication in IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)
>
...
>
---
#### [replaced 048] Streaming-dLLM: Accelerating Diffusion LLMs via Suffix Pruning and Dynamic Decoding
...
>
---
#### [replaced 053] Equi-RO: A 4D mmWave Radar Odometry via Equivariant Networks
- **分类: cs.RO; cs.CV**

- **简介: 该论文提出Equi-RO，一种基于等变网络的4D毫米波雷达里程计方法，用于GPS拒收环境中的定位问题。通过处理雷达数据提升位姿估计精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2509.20674v2](https://arxiv.org/pdf/2509.20674v2)**
...
>
---
#### [replaced 054] Scaling Foundation Models for Radar Scene Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21105v2](https://arxiv.org/pdf/2511.21105v2)**
...
>
---
#### [replaced 058] ForensicHub: A Unified Benchmark & Codebase for All-Domain Fake Image Detection and Localization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.11003v3](https://arxiv.org/pdf/2505.11003v3)**

> **作者:** Bo Du; Xuekang Zhu; Xiaochen Ma; Chenfan Qu; Kaiwen Feng; Zhe Yang; Chi-Man Pun; Jian Liu; Ji-Zhe Zhou
>
> **备注:** NeurIPS 2025 DB Track Paper. Code available at: https://github.com/scu-zjz/ForensicHub
>
...
>
---
#### [replaced 059] PyCAT4: A Hierarchical Vision Transformer-based Framework for 3D Human Pose Estimation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2508.02806v2](https://arxiv.org/pdf/2508.02806v2)**
...
>
---
#### [replaced 060] Watermark-based Attribution of AI-Generated Content
...
>
---
#### [replaced 061] Diffusion models for multivariate subsurface generation and efficient probabilistic inversion
- **分类: cs.CV; cs.LG; physics.geo-ph; stat.AP**

- **链接: [https://arxiv.org/pdf/2507.15809v4](https://arxiv.org/pdf/2507.15809v4)**

> **作者:** Roberto Miele; Niklas Linde
>
> **备注:** 35 p., 16 figs. This updated version corrects an error with the analysis of the denoising scores' magnitudes in the results section. The discussion and conclusions of our study remain unchanged. The scores' trends were erroneously reported with inverted time-step order, now fixed in Figure 5a and b (now with the correct increasing trends) and in the corresponding analysis in the Results section
>
...
>
---
#### [replaced 062] Semantic-aware Random Convolution and Source Matching for Domain Generalization in Medical Image Segmentation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.01510v2](https://arxiv.org/pdf/2512.01510v2)**
...
>
---
#### [replaced 063] Generation then Reconstruction: Accelerating Masked Autoregressive Models via Two-Stage Sampling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.17171v2](https://arxiv.org/pdf/2510.17171v2)**
...
>
---
#### [replaced 064] Moonworks Lunara Aesthetic Dataset
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.07941v3](https://arxiv.org/pdf/2601.07941v3)**
...
>
---
#### [replaced 065] Epistemic-aware Vision-Language Foundation Model for Fetal Ultrasound Interpretation
- **分类: cs.CV; cs.AI; cs.IR; cs.MM**

- **链接: [https://arxiv.org/pdf/2510.12953v3](https://arxiv.org/pdf/2510.12953v3)**
...
>
---
#### [replaced 066] JointDiff: Bridging Continuous and Discrete in Multi-Agent Trajectory Generation
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.22522v2](https://arxiv.org/pdf/2509.22522v2)**
...
>
---
#### [replaced 073] Human Cognitive Benchmarks Reveal Foundational Visual Gaps in MLLMs
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 074] GaNI: Global and Near Field Illumination Aware Neural Inverse Rendering
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2403.15651v4](https://arxiv.org/pdf/2403.15651v4)**

> **作者:** Jiaye Wu; Saeed Hadadan; Geng Lin; Matthias Zwicker; David Jacobs; Roni Sengupta
>
> **备注:** This paper is still in the process of improving, a revised version may be released in the future
>
...
>
---
#### [replaced 075] KOCOBrain: Kuramoto-Guided Graph Network for Uncovering Structure-Function Coupling in Adolescent Prenatal Drug Exposure
- **分类: q-bio.NC; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.11018v2](https://arxiv.org/pdf/2601.11018v2)**
...
>
---
#### [replaced 077] Adaptive Multimodal Person Recognition: A Robust Framework for Handling Missing Modalities
...
>
---
#### [replaced 078] ResMatching: Noise-Resilient Computational Super-Resolution via Guided Conditional Flow Matching
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.26601v3](https://arxiv.org/pdf/2510.26601v3)**

> **作者:** Anirban Ray; Vera Galinova; Florian Jug
>
> **备注:** 5 pages, 4 figures; Accepted to IEEE ISBI 2026
>
