...
#### [new 001] Gender-Neutral Machine Translation Strategies in Practice
- **分类: cs.CL**
...
>
---
#### [new 002] CKD-EHR:Clinical Knowledge Distillation for Electronic Health Records
- **分类: cs.CL**
...
>
---
#### [new 003] RATTENTION: Towards the Minimal Sliding Window Size in Local-Global Attention Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决局部-全局注意力模型中窗口大小与效率的权衡问题。通过引入RATTENTION机制，实现更小窗口下的高性能和高效率。**
...
>
---
#### [new 004] CC-LEARN: Cohort-based Consistency Learning
- **分类: cs.CL**
...
>
---
#### [new 005] From Chat to Checkup: Can Large Language Models Assist in Diabetes Prediction?
- **分类: cs.CL**

- **简介: 该论文属于医疗预测任务，旨在探索大型语言模型在糖尿病预测中的应用，通过对比不同模型和提示方法，评估其有效性。**
...
>
---
#### [new 006] Memory Tokens: Large Language Models Can Generate Reversible Sentence Embeddings
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决文本重建问题。通过引入记忆令牌，使大语言模型能无损恢复原始文本，无需修改模型参数。**
...
>
---
#### [new 007] Identifying social isolation themes in NVDRS text narratives using topic modeling and text-classification methods
- **分类: cs.CL**
...
>
---
#### [new 008] Approximating Language Model Training Data from Weights
- **分类: cs.CL**

- **简介: 该论文属于模型逆向任务，旨在从模型权重中近似训练数据。通过梯度方法从公共语料库中选择匹配数据，提升模型性能。**
...
>
---
#### [new 009] Targeted Lexical Injection: Unlocking Latent Cross-Lingual Alignment in Lugha-Llama via Early-Layer LoRA Fine-Tuning
...
>
---
#### [new 010] GenRecal: Generation after Recalibration from Large to Small Vision-Language Models
- **分类: cs.CL**

- **简介: 该论文属于视觉语言模型知识蒸馏任务，旨在解决大模型到小模型的迁移问题。提出GenRecal框架，通过特征对齐实现跨架构的知识迁移。**
...
>
---
#### [new 011] SPARE: Single-Pass Annotation with Reference-Guided Evaluation for Automatic Process Supervision and Reward Modelling
- **分类: cs.CL; cs.AI; cs.LG**
...
>
---
#### [new 012] WikiMixQA: A Multimodal Benchmark for Question Answering over Tables and Charts
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出WikiMixQA，一个用于评估表格和图表跨模态推理的基准，解决长文本多模态理解问题。**
...
>
---
#### [new 013] Modeling the One-to-Many Property in Open-Domain Dialogue with LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于开放域对话任务，旨在解决对话响应多样性不足的问题。通过分解生成与选择两阶段工作，提升响应多样性与质量。**
...
>
---
#### [new 014] The Compositional Architecture of Regret in Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究大语言模型中的后悔机制，解决数据缺失、层选择和神经元分析问题，提出新方法提升模型可靠性。**
...
>
---
#### [new 015] CrEst: Credibility Estimation for Contexts in LLMs via Weak Supervision
- **分类: cs.CL; cs.LG**
...
>
---
#### [new 016] Understanding GUI Agent Localization Biases through Logit Sharpness
- **分类: cs.CL**

- **简介: 该论文属于GUI代理定位任务，旨在解决模型定位偏差问题。通过提出评估框架和PSS指标，提升模型的可靠性与可解释性。**
...
>
---
#### [new 017] MDBench: A Synthetic Multi-Document Reasoning Benchmark Generated with Knowledge Guidance
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出MDBench，一个用于评估大语言模型多文档推理能力的合成基准。旨在解决多文档推理评估不足的问题，通过知识引导生成挑战性数据集。**
...
>
---
#### [new 018] Research on Graph-Retrieval Augmented Generation Based on Historical Text Knowledge Graphs
- **分类: cs.CL**

- **简介: 该论文属于历史文本分析任务，旨在解决大模型在历史知识上的领域空白。通过构建知识图谱与生成模型结合的Graph RAG框架，提升历史关系抽取效果。**
...
>
---
#### [new 019] Cohort Discovery: A Survey on LLM-Assisted Clinical Trial Recruitment
- **分类: cs.CL; cs.AI**
...
>
---
#### [new 020] Learning-Time Encoding Shapes Unlearning in LLMs
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型可解释性与知识管理任务，旨在解决LLMs中后训练知识删除问题。研究发现，学习阶段的知识编码方式显著影响知识删除效果。**
...
>
---
#### [new 021] AgentGroupChat-V2: Divide-and-Conquer Is What LLM-Based Multi-Agent System Need
- **分类: cs.CL**
...
>
---
#### [new 022] RE-IMAGINE: Symbolic Benchmark Synthesis for Reasoning Evaluation
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出RE-IMAGINE框架，用于评估大语言模型的推理能力，解决其是否依赖统计记忆而非真实推理的问题。通过生成不同层次的推理问题，验证模型在数学、代码和逻辑任务中的表现。**
...
>
---
#### [new 023] Semantically-Aware Rewards for Open-Ended R1 Training in Free-Form Generation
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于开放生成任务，旨在解决长文本评价难题。提出PrefBERT模型，通过语义奖励提升GRPO训练效果。**
...
>
---
#### [new 024] DiscoSG: Towards Discourse-Level Text Scene Graph Parsing through Iterative Graph Refinement
- **分类: cs.CL**

- **简介: 该论文提出Discourse-level文本场景图解析任务（DiscoSG），解决多句描述生成碎片化图的问题。通过迭代图优化方法，提升解析效果与效率。**
...
>
---
#### [new 025] Adverse Event Extraction from Discharge Summaries: A New Dataset, Annotation Scheme, and Initial Findings
- **分类: cs.CL**

- **简介: 该论文属于医疗文本中的不良事件抽取任务，旨在解决老年患者病历中不良事件识别难题。研究构建了新数据集并提出标注方案，评估了多种模型性能。**
...
>
---
#### [new 026] ProtoReasoning: Prototypes as the Foundation for Generalizable Reasoning in LLMs
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升大语言模型的推理能力。通过引入原型表示，增强模型在不同领域的泛化能力。**
...
>
---
#### [new 027] Revisiting Compositional Generalization Capability of Large Language Models Considering Instruction Following Ability
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言生成任务，旨在解决大语言模型在遵循指令和组合泛化能力上的不足。通过构建Ordered CommonGen基准，评估模型按指定顺序生成句子的能力。**
...
>
---
#### [new 028] SciVer: Evaluating Foundation Models for Multimodal Scientific Claim Verification
- **分类: cs.CL**

- **简介: 该论文属于多模态科学陈述验证任务，旨在评估基础模型在科学文献中的推理能力。研究构建了SciVer基准，并测试了多个模型，发现其与人类存在显著差距。**
...
>
---
#### [new 029] Leaky Thoughts: Large Reasoning Models Are Not Private Thinkers
- **分类: cs.CL; cs.AI; cs.CR**

- **简介: 该论文属于隐私安全任务，研究大模型推理过程中的数据泄露问题。工作揭示了推理轨迹可能泄露敏感信息，并指出增加推理步骤会加剧泄露风险。**
...
>
---
#### [new 030] COSMMIC: Comment-Sensitive Multimodal Multilingual Indian Corpus for Summarization and Headline Generation
- **分类: cs.CL**

- **简介: 该论文属于多模态多语言摘要生成任务，旨在解决印度语言资源不足的问题。研究构建了COSMMIC数据集，融合文本、图像和用户评论，提升摘要质量。**
...
>
---
#### [new 031] Minding the Politeness Gap in Cross-cultural Communication
- **分类: cs.CL; cs.CY**

- **简介: 该论文属于自然语言处理中的跨文化交际研究，旨在解决不同英语使用者对强度词理解差异的问题。通过实验和计算模型分析，发现差异源于字面意义与表达成本的权衡。**
...
>
---
#### [new 032] A Comparative Study of Task Adaptation Techniques of Large Language Models for Identifying Sustainable Development Goals
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本分类任务，旨在识别可持续发展目标。研究比较了不同大语言模型及适应技术的效果，发现优化后的小型模型可与大型模型媲美。**
...
>
---
#### [new 033] Context-Informed Grounding Supervision
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决模型生成缺乏外部上下文依据的问题。通过引入CINGS方法，在训练中结合上下文监督，提升模型生成的准确性与一致性。**
...
>
---
#### [new 034] Improving Dialogue Discourse Parsing through Discourse-aware Utterance Clarification
- **分类: cs.CL; cs.AI**
...
>
---
#### [new 035] Oldies but Goldies: The Potential of Character N-grams for Romanian Texts
- **分类: cs.CL**

- **简介: 该论文属于作者身份归属任务，旨在解决罗马尼亚文本的作者识别问题。通过使用字符n-gram特征和多种机器学习方法进行分类，发现ANN模型表现最佳。**
...
>
---
#### [new 036] DeVisE: Behavioral Testing of Medical Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于医疗大模型评估任务，旨在解决现有评价方法无法区分真实医学推理与表面模式的问题。通过构建包含真实和合成数据的ICU出院记录数据集，测试模型对人口统计和生命体征变化的反应，以评估其临床理解能力。**
...
>
---
#### [new 037] Lost in Variation? Evaluating NLI Performance in Basque and Spanish Geographical Variants
- **分类: cs.CL**

- **简介: 该论文研究NLI任务中语言变体（如巴斯克语和西班牙语方言）的处理能力，通过构建平行数据集并实验分析模型表现，揭示语言差异对模型性能的影响。**
...
>
---
#### [new 038] Thunder-DeID: Accurate and Efficient De-identification Framework for Korean Court Judgments
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的去标识化任务，旨在解决韩国法院判决书在公开时的个人隐私保护问题。研究构建了首个标注数据集，提出PII分类体系，并开发了端到端深度学习模型。**
...
>
---
#### [new 039] From Model to Classroom: Evaluating Generated MCQs for Portuguese with Narrative and Difficulty Concerns
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的MCQ生成任务，旨在解决生成高质量、符合难度和叙事要求的葡萄牙语阅读理解题问题。研究评估了生成题目的质量和可靠性。**
...
>
---
#### [new 040] Gender Inclusivity Fairness Index (GIFI): A Multilevel Framework for Evaluating Gender Diversity in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的公平性评估任务，旨在解决大语言模型在性别包容性上的偏差问题。研究提出GIFI框架，评估模型对多种性别的处理能力。**
...
>
---
#### [new 041] Thunder-Tok: Minimizing Tokens per Word in Tokenizing Korean Texts for Generative Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的分词任务，旨在减少韩语文本的token数量以提高模型效率。通过规则预分词和熵选择算法优化分词效果。**
...
>
---
#### [new 042] MinosEval: Distinguishing Factoid and Non-Factoid for Tailored Open-Ended QA Evaluation with LLMs
- **分类: cs.CL**

- **简介: 该论文属于开放问答评估任务，旨在解决LLMs回答质量评价不准确的问题。提出MinosEval方法，区分事实性和非事实性问题，采用不同策略提升评估效果。**
...
>
---
#### [new 043] TopClustRAG at SIGIR 2025 LiveRAG Challenge
- **分类: cs.CL**

- **简介: 该论文属于问答任务，解决大规模网络语料下的端到端问答问题。通过混合检索与聚类方法提升答案的多样性、相关性和真实性。**
...
>
---
#### [new 044] ConLID: Supervised Contrastive Learning for Low-Resource Language Identification
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于语言识别任务，旨在解决低资源语言在领域外数据上表现差的问题。通过监督对比学习方法，提升模型的泛化能力。**
...
>
---
#### [new 045] SANSKRITI: A Comprehensive Benchmark for Evaluating Language Models' Knowledge of Indian Culture
- **分类: cs.CL**

- **简介: 该论文属于文化理解任务，旨在评估语言模型对印度文化的掌握。提出SANSKRITI数据集，涵盖28个地区文化信息，测试模型在区域文化上的表现。**
...
>
---
#### [new 046] PhantomHunter: Detecting Unseen Privately-Tuned LLM-Generated Text via Family-Aware Learning
- **分类: cs.CL; cs.CY**
...
>
---
#### [new 047] PredGen: Accelerated Inference of Large Language Models through Input-Time Speculation for Real-Time Speech Interaction
...
>
---
#### [new 048] Emergence of Primacy and Recency Effect in Mamba: A Mechanistic Point of View
- **分类: cs.CL**

- **简介: 该论文研究Mamba模型中的记忆机制，通过primacy和recency效应分析信息保留与遗忘。任务是理解语言模型的记忆行为，解决如何区分长期与短期记忆的问题，通过实验揭示三种关键机制。**
...
>
---
#### [new 049] Combining Constrained and Unconstrained Decoding via Boosting: BoostCD and Its Application to Information Extraction
- **分类: cs.CL**

- **简介: 该论文属于信息抽取任务，解决约束解码质量低的问题。提出BoostCD方法，结合有约束和无约束解码，提升输出质量。**
...
>
---
#### [new 050] Enhancing Hyperbole and Metaphor Detection with Their Bidirectional Dynamic Interaction and Emotion Knowledge
- **分类: cs.CL; cs.LG**
...
>
---
#### [new 051] Lessons from Training Grounded LLMs with Verifiable Rewards
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升大语言模型的回答准确性和可信度。通过强化学习和内部推理优化模型的引用和拒绝能力，显著改善了生成结果的可靠性。**
...
>
---
#### [new 052] AutoRule: Reasoning Chain-of-thought Extracted Rule-based Rewards Improve Preference Learning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决人工规则工程耗时的问题，提出AutoRule自动提取规则生成奖励，提升偏好学习效果。**
...
>
---
#### [new 053] ETS: Open Vocabulary Electroencephalography-To-Text Decoding and Sentiment Classification
- **分类: cs.LG; cs.CL; cs.HC**

- **简介: 该论文属于脑机接口任务，旨在解决开放词汇的EEG到文本解码和情感分类问题。通过融合EEG与眼动数据，提出ETS框架，提升解码准确性和情感识别效果。**
...
>
---
#### [new 054] video-SALMONN 2: Captioning-Enhanced Audio-Visual Large Language Models
...
>
---
#### [new 055] Detecting Narrative Shifts through Persistent Structures: A Topological Analysis of Media Discourse
- **分类: cs.SI; cs.CL; physics.soc-ph; 55U10**

- **简介: 该论文属于文本分析任务，旨在检测媒体话语中的叙事转变。通过拓扑方法分析事件对公共讨论的影响，识别语义结构变化。**
...
>
---
#### [new 056] SemIRNet: A Semantic Irony Recognition Network for Multimodal Sarcasm Detection
...
>
---
#### [new 057] Dense SAE Latents Are Features, Not Bugs
- **分类: cs.LG; cs.AI; cs.CL**
...
>
---
#### [new 058] Hypothesis Testing for Quantifying LLM-Human Misalignment in Multiple Choice Settings
- **分类: cs.CY; cs.CL; cs.LG**

- **简介: 该论文属于社会科学研究任务，旨在解决LLM与人类行为不一致的问题。通过假设检验框架，评估语言模型在多选调查中的模拟效果，发现其在不同群体中表现不佳。**
...
>
---
#### [new 059] Capturing Polysemanticity with PRISM: A Multi-Concept Feature Description Framework
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于神经网络可解释性任务，解决特征描述中单义性假设带来的问题。提出PRISM框架，用于捕捉多义特征，提升描述准确性与全面性。**
...
>
---
#### [new 060] Argus Inspection: Do Multimodal Large Language Models Possess the Eye of Panoptes?
...
>
---
#### [new 061] Embodied Web Agents: Bridging Physical-Digital Realms for Integrated Agent Intelligence
...
>
---
#### [new 062] When and How Unlabeled Data Provably Improve In-Context Learning
- **分类: cs.LG; cs.AI; cs.CL; math.OC**

- **简介: 该论文研究半监督学习中的上下文学习问题，探讨未标记数据如何提升模型性能。通过理论分析和实验验证，提出利用多层Transformer结构有效整合未标记数据的方法。**
...
>
---
#### [new 064] Factorized RVQ-GAN For Disentangled Speech Tokenization
...
>
---
#### [new 065] SonicVerse: Multi-Task Learning for Music Feature-Informed Captioning
...
>
---
#### [new 066] Assembly of Experts: Linear-time construction of the Chimera LLM variants with emergent and adaptable behaviors
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于模型优化任务，旨在高效构建大语言模型变体。通过线性时间方法组装专家模型，提升性能并减少资源消耗。**
...
>
---
#### [new 067] LoX: Low-Rank Extrapolation Robustifies LLM Safety Against Fine-tuning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于模型安全任务，旨在解决细调削弱大语言模型安全性的难题。通过LoX方法增强模型对细调攻击的鲁棒性。**
...
>
---
#### [new 068] Revisiting Reinforcement Learning for LLM Reasoning from A Cross-Domain Perspective
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习与大语言模型推理任务，旨在解决跨领域推理中奖励信号不足的问题。研究构建了Guru数据集，并验证了不同领域对RL训练的响应差异。**
...
>
---
#### [new 069] An accurate and revised version of optical character recognition-based speech synthesis using LabVIEW
...
>
---
#### [new 070] Cost-Efficient Serving of LLM Agents via Test-Time Plan Caching
- **分类: cs.DC; cs.AI; cs.CL; cs.LG; cs.PF**

- **简介: 该论文属于LLM代理服务优化任务，旨在降低复杂工作流中的高昂成本。通过测试时计划缓存技术，提取并复用结构化计划模板，提升效率。**
...
>
---
#### [new 071] Identifying economic narratives in large text corpora -- An integrated approach using Large Language Models
- **分类: econ.GN; cs.CL; q-fin.EC**

- **简介: 该论文属于经济叙事识别任务，旨在解决传统方法在语义理解上的不足。研究采用大语言模型GPT-4o提取经济叙事，并与专家标注对比验证效果。**
...
#### [replaced 001] Fractured Chain-of-Thought Reasoning
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**
...
>
---
#### [replaced 002] Aug2Search: Enhancing Facebook Marketplace Search with LLM-Generated Synthetic Data Augmentation
- **分类: cs.IR; cs.CL**
...
>
---
#### [replaced 003] Alleviating Distribution Shift in Synthetic Data for Machine Translation Quality Estimation
- **分类: cs.CL**
...
>
---
#### [replaced 004] Thunder-NUBench: A Benchmark for LLMs' Sentence-Level Negation Understanding
- **分类: cs.CL**
...
>
---
#### [replaced 005] SemVink: Advancing VLMs' Semantic Understanding of Optical Illusions via Visual Global Thinking
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 006] Ring-lite: Scalable Reasoning via C3PO-Stabilized Reinforcement Learning for LLMs
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 007] UD-English-CHILDES: A Collected Resource of Gold and Silver Universal Dependencies Trees for Child Language Interactions
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 008] Enhancing Goal-oriented Proactive Dialogue Systems via Consistency Reflection and Correction
- **分类: cs.CL**
...
>
---
#### [replaced 009] TSLFormer: A Lightweight Transformer Model for Turkish Sign Language Recognition Using Skeletal Landmarks
- **分类: cs.CL; eess.IV**
...
>
---
#### [replaced 010] A Systematic Survey of Natural Language Processing for the Greek Language
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 011] PsychBench: A comprehensive and professional benchmark for evaluating the performance of LLM-assisted psychiatric clinical practice
...
>
---
#### [replaced 012] Adding Chocolate to Mint: Mitigating Metric Interference in Machine Translation
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 014] HiURE: Hierarchical Exemplar Contrastive Learning for Unsupervised Relation Extraction
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 015] Multi-Agent Language Models: Advancing Cooperation, Coordination, and Adaptation
...
>
---
#### [replaced 016] BriefMe: A Legal NLP Benchmark for Assisting with Legal Briefs
- **分类: cs.CL**
...
>
---
#### [replaced 017] Router-R1: Teaching LLMs Multi-Round Routing and Aggregation via Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.LG**
...
>
---
#### [replaced 018] Interchangeable Token Embeddings for Extendable Vocabulary and Alpha-Equivalence
...
>
---
#### [replaced 019] I-MCTS: Enhancing Agentic AutoML via Introspective Monte Carlo Tree Search
- **分类: cs.CL**
...
>
---
#### [replaced 020] Large Language Models for Automated Literature Review: An Evaluation of Reference Generation, Abstract Writing, and Review Composition
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 021] RadioRAG: Online Retrieval-augmented Generation for Radiology Question Answering
- **分类: cs.CL; cs.AI; cs.LG**
...
>
---
#### [replaced 022] REVOLVE: Optimizing AI Systems by Tracking Response Evolution in Textual Optimization
...
>
---
#### [replaced 023] Dynamic Acoustic Model Architecture Optimization in Training for ASR
- **分类: cs.CL**
...
>
---
#### [replaced 024] An Effective Incorporating Heterogeneous Knowledge Curriculum Learning for Sequence Labeling
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 025] ALPS: Attention Localization and Pruning Strategy for Efficient Alignment of Large Language Models
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 026] Math Neurosurgery: Isolating Language Models' Math Reasoning Abilities Using Only Forward Passes
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 027] PEDANTIC: A Dataset for the Automatic Examination of Definiteness in Patent Claims
- **分类: cs.CL**
...
>
---
#### [replaced 028] Too Big to Think: Capacity, Memorization, and Generalization in Pre-Trained Transformers
- **分类: cs.LG; cs.AI; cs.CL**
...
>
---
#### [replaced 029] The Avengers: A Simple Recipe for Uniting Smaller Language Models to Challenge Proprietary Giants
- **分类: cs.CL**
...
>
---
#### [replaced 030] Breaking Bad Molecules: Are MLLMs Ready for Structure-Level Molecular Detoxification?
- **分类: cs.AI; cs.CL**
...
>
---
#### [replaced 031] LLäMmlein: Transparent, Compact and Competitive German-Only Language Models from Scratch
- **分类: cs.CL; cs.AI; cs.LG**
...
>
---
#### [replaced 032] Bi-VLDoc: Bidirectional Vision-Language Modeling for Visually-Rich Document Understanding
...
>
---
#### [replaced 033] Perspective Transition of Large Language Models for Solving Subjective Tasks
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 034] Robust Utility-Preserving Text Anonymization Based on Large Language Models
- **分类: cs.CL**
...
>
---
#### [replaced 035] OM4OV: Leveraging Ontology Matching for Ontology Versioning
...
>
---
#### [replaced 036] Entropy-based Exploration Conduction for Multi-step Reasoning
- **分类: cs.AI; cs.CL**
...
>
---
#### [replaced 037] Lean Workbook: A large-scale Lean problem set formalized from natural language math problems
- **分类: cs.CL**
...
>
---
#### [replaced 038] ChemHAS: Hierarchical Agent Stacking for Enhancing Chemistry Tools
- **分类: cs.LG; cs.AI; cs.CL**
...
>
---
#### [replaced 039] Can LLMs Ask Good Questions?
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 040] A Guide to Misinformation Detection Data and Evaluation
...
>
---
#### [replaced 041] Wait, We Don't Need to "Wait"! Removing Thinking Tokens Improves Reasoning Efficiency
- **分类: cs.CL**
...
>
---
#### [replaced 042] Seewo's Submission to MLC-SLM: Lessons learned from Speech Reasoning Language Models
...
>
---
#### [replaced 043] BIS Reasoning 1.0: The First Large-Scale Japanese Benchmark for Belief-Inconsistent Syllogistic Reasoning
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 045] GRAM: A Generative Foundation Reward Model for Reward Generalization
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 046] CODESYNC: Synchronizing Large Language Models with Dynamic Code Evolution at Scale
...
>
---
#### [replaced 047] Efficiently Building a Domain-Specific Large Language Model from Scratch: A Case Study of a Classical Chinese Large Language Model
- **分类: cs.CL**
...
>
---
#### [replaced 048] J4R: Learning to Judge with Equivalent Initial State Group Relative Policy Optimization
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 049] Aligning AI Research with the Needs of Clinical Coding Workflows: Eight Recommendations Based on US Data Analysis and Critical Review
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 050] TransXSSM: A Hybrid Transformer State Space Model with Unified Rotary Position Embedding
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 051] GreekBarBench: A Challenging Benchmark for Free-Text Legal Reasoning and Citations
- **分类: cs.CL**
...
>
---
#### [replaced 052] Efficient Long CoT Reasoning in Small Language Models
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 053] How much do language models memorize?
- **分类: cs.CL**
...
>
---
#### [replaced 054] AIn't Nothing But a Survey? Using Large Language Models for Coding German Open-Ended Survey Responses on Survey Motivation
...
>
---
#### [replaced 055] Probabilistic Aggregation and Targeted Embedding Optimization for Collective Moral Reasoning in Large Language Models
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 056] Pap2Pat: Benchmarking Outline-Guided Long-Text Patent Generation with Patent-Paper Pairs
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 057] LaMP-Cap: Personalized Figure Caption Generation With Multimodal Figure Profiles
- **分类: cs.CL; cs.AI**
