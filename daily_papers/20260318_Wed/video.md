...
#### [new 001] Mostly Text, Smart Visuals: Asymmetric Text-Visual Pruning for Large Vision-Language Models
...
>
---
#### [new 002] Sparse but not Simpler: A Multi-Level Interpretability Analysis of Vision Transformers
- **分类: cs.CV**

- **简介: 该论文属于视觉Transformer的可解释性研究，旨在探讨结构稀疏性是否提升模型可解释性。通过多层级框架IMPACT评估，发现稀疏模型未显著提高可解释性。**
...
>
---
#### [new 003] NanoGS: Training-Free Gaussian Splat Simplification
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出NanoGS，解决3D高斯点云简化问题，通过无需训练的局部合并方法降低存储和传输成本，保持场景质量。**

- **链接: [https://arxiv.org/pdf/2603.16103](https://arxiv.org/pdf/2603.16103)**
...
>
---
#### [new 004] ACPV-Net: All-Class Polygonal Vectorization for Seamless Vector Map Generation from Aerial Imagery
- **分类: cs.CV**

- **简介: 该论文提出ACPV-Net解决从航拍图像生成完整矢量地图的问题，旨在实现所有地物类别的无缝矢量表达。**

- **链接: [https://arxiv.org/pdf/2603.16616](https://arxiv.org/pdf/2603.16616)**
...
>
---
#### [new 006] An approximate graph elicits detonation lattice
- **分类: cs.CV; cs.LG; physics.comp-ph; physics.data-an**

- **简介: 该论文属于 detonation cell 分割任务，旨在解决传统方法在3D压力数据中精确提取细胞结构的难题。提出一种基于图论的无监督算法，实现高效分割与量化。**

- **链接: [https://arxiv.org/pdf/2603.16524](https://arxiv.org/pdf/2603.16524)**
...
>
---
#### [new 028] WorldCam: Interactive Autoregressive 3D Gaming Worlds with Camera Pose as a Unifying Geometric Representation
- **分类: cs.CV**

- **简介: 该论文提出WorldCam，解决3D游戏世界中动作控制与长期一致性问题，通过相机位姿统一建模，提升交互体验。**

- **链接: [https://arxiv.org/pdf/2603.16871](https://arxiv.org/pdf/2603.16871)**
...
>
---
#### [new 035] Demystifing Video Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视频生成中的推理机制，挑战传统观点，提出扩散过程中的链式步骤（CoS）为新机制，并分析了推理行为及模型结构，旨在提升视频模型的推理能力。**
...
>
---
#### [new 053] ModTrack: Sensor-Agnostic Multi-View Tracking via Identity-Informed PHD Filtering with Covariance Propagation
- **分类: cs.CV**

- **简介: 该论文提出ModTrack，解决多视角多目标跟踪问题，通过模块化设计实现跨模态、传感器无关的跟踪，提升精度与泛化能力。**
...
>
---
#### [new 064] UMO: Unified In-Context Learning Unlocks Motion Foundation Model Priors
- **分类: cs.CV**

- **简介: 该论文提出UMO，解决如何将单任务运动生成模型应用于多种跨模态任务的问题。通过统一框架实现高效适配，支持多项新任务。**

- **链接: [https://arxiv.org/pdf/2603.15975](https://arxiv.org/pdf/2603.15975)**
...
>
---
#### [new 072] VIGOR: VIdeo Geometry-Oriented Reward for Temporal Generative Alignment
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决视频扩散模型几何不一致问题。通过引入基于几何的奖励模型和采样策略，提升视频生成的时空一致性与鲁棒性。**
...
>
---
#### [new 073] FSMC-Pose: Frequency and Spatial Fusion with Multiscale Self-calibration for Cattle Mounting Pose Estimation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于牲畜姿态估计任务，旨在解决复杂环境中奶牛交配姿态的准确估计问题。提出FSMC-Pose框架，结合频率-空间融合与多尺度自校准，提升精度并降低计算成本。**

- **链接: [https://arxiv.org/pdf/2603.16596](https://arxiv.org/pdf/2603.16596)**
...
>
---
#### [new 083] Evo-Retriever: LLM-Guided Curriculum Evolution with Viewpoint-Pathway Collaboration for Multimodal Document Retrieval
- **分类: cs.CV**

- **简介: 该论文属于多模态文档检索任务，解决跨模态嵌入不一致问题。提出Evo-Retriever框架，结合多视角对齐与双向对比学习，提升检索效果。**

- **链接: [https://arxiv.org/pdf/2603.16455](https://arxiv.org/pdf/2603.16455)**
...
>
---
#### [new 089] Semantic One-Dimensional Tokenizer for Image Reconstruction and Generation
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在解决传统视觉分词器在语义表达上的不足。提出SemTok，将2D图像压缩为具有高语义的1D令牌，提升图像重建与生成效果。**

- **链接: [https://arxiv.org/pdf/2603.16373](https://arxiv.org/pdf/2603.16373)**
...
>
---
#### [new 090] Unlearning for One-Step Generative Models via Unbalanced Optimal Transport
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于生成模型的去遗忘任务，解决一阶段生成模型的安全性问题。提出UOT-Unlearn框架，通过不平衡最优传输实现目标类别的有效遗忘与生成质量保持。**

- **链接: [https://arxiv.org/pdf/2603.16489](https://arxiv.org/pdf/2603.16489)**
...
>
---
#### [new 095] HGP-Mamba: Integrating Histology and Generated Protein Features for Mamba-based Multimodal Survival Risk Prediction
- **分类: cs.CV**

- **简介: 该论文属于癌症生存风险预测任务，旨在解决蛋白质标记与组织病理图像联合分析的难题。通过融合生成的蛋白特征和组织学信息，提出HGP-Mamba框架提升预测效果。**
...
>
---
#### [new 102] FEEL (Force-Enhanced Egocentric Learning): A Dataset for Physical Action Understanding
...
>
---
#### [new 116] How to Utilize Complementary Vision-Text Information for 2D Structure Understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 120] S-VAM: Shortcut Video-Action Model by Self-Distilling Geometric and Semantic Foresight
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 121] STARK: Spatio-Temporal Attention for Representation of Keypoints for Continuous Sign Language Recognition
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 122] DriveFix: Spatio-Temporally Coherent Driving Scene Restoration
- **分类: cs.CV**

- **简介: 该论文提出DriveFix，解决自动驾驶中4D场景重建的时空一致性问题。通过多视角恢复框架，提升场景重建与新视角合成效果。**

- **链接: [https://arxiv.org/pdf/2603.16306](https://arxiv.org/pdf/2603.16306)**
...
>
---
#### [new 132] InViC: Intent-aware Visual Cues for Medical Visual Question Answering
- **分类: cs.CV**

- **简介: 该论文属于医学视觉问答任务，旨在解决模型依赖语言先验而非视觉证据的问题。提出InViC框架，通过引入意图感知的视觉提示增强图像信息利用。**

- **链接: [https://arxiv.org/pdf/2603.16372](https://arxiv.org/pdf/2603.16372)**
...
>
---
#### [new 133] Rationale Matters: Learning Transferable Rubrics via Proxy-Guided Critique for VLMReward Models
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型的奖励模型任务，旨在提升生成奖励模型的可迁移性与一致性。通过引入代理验证机制，优化中间评价标准，提高评估准确性。**
...
>
---
#### [new 154] SignNav: Leveraging Signage for Semantic Visual Navigation in Large-Scale Indoor Environments
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 155] Do Not Leave a Gap: Hallucination-Free Object Concealment in Vision-Language Models
- **分类: cs.CR; cs.CV**

- **简介: 该论文属于视觉-语言模型安全任务，解决对象隐藏中的幻觉问题。通过背景一致性重构，有效隐藏目标对象并减少错误生成。**

- **链接: [https://arxiv.org/pdf/2603.15940](https://arxiv.org/pdf/2603.15940)**
...
>
---
#### [new 160] 3D tomography of exchange phase in a Si/SiGe quantum dot device
- **分类: cond-mat.mes-hall; cs.CV; quant-ph**

- **简介: 该论文属于量子计算领域，旨在解决提取自旋量子比特交换相互作用系数的问题。通过三维相位重建和优化，提升量子器件的控制精度与可靠性。**
...
>
---
#### [new 161] vAccSOL: Efficient and Transparent AI Vision Offloading for Mobile Robots
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 162] AsgardBench - Evaluating Visually Grounded Interactive Planning Under Minimal Feedback
...
#### [replaced 001] From Image Generation to Infrastructure Design: a Multi-agent Pipeline for Street Design Generation
- **分类: cs.AI; cs.CV; cs.CY; cs.HC**

- **链接: [https://arxiv.org/pdf/2509.05469](https://arxiv.org/pdf/2509.05469)**
...
>
---
#### [replaced 002] ERGO: Efficient High-Resolution Visual Understanding for Vision-Language Models
...
>
---
#### [replaced 003] $χ_{0}$: Resource-Aware Robust Manipulation via Taming Distributional Inconsistencies
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 006] AgriPath: A Systematic Exploration of Architectural Trade-offs for Crop Disease Classification
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 007] Learning through Creation: A Hash-Free Framework for On-the-Fly Category Discovery
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.13858](https://arxiv.org/pdf/2603.13858)**

> **作者:** Bohan Zhang; Weidong Tang; Zhixiang Chi; Yi Jin; Zhenbo Li; Yang Wang; Yanan Wu
>
> **备注:** Accepted to CVPR 2026 Findings. Code available at this https URL
>
...
>
---
#### [replaced 008] Exploring the Underwater World Segmentation without Extra Training
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.07923](https://arxiv.org/pdf/2511.07923)**
...
>
---
#### [replaced 009] SARMAE: Masked Autoencoder for SAR Representation Learning
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.16635](https://arxiv.org/pdf/2512.16635)**

> **作者:** Danxu Liu; Di Wang; Hebaixu Wang; Haoyang Chen; Wentao Jiang; Yilin Cheng; Haonan Guo; Wei Cui; Jing Zhang
>
> **备注:** The paper is accepted by CVPR 2026! Code and models will be available at this https URL
>
...
>
---
#### [replaced 012] Omni Survey for Multimodality Analysis in Visual Object Tracking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.13000](https://arxiv.org/pdf/2508.13000)**
...
>
---
#### [replaced 014] FlowMotion: Training-Free Flow Guidance for Video Motion Transfer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.06289](https://arxiv.org/pdf/2603.06289)**
...
>
---
#### [replaced 015] MARIS: Marine Open-Vocabulary Instance Segmentation with Geometric Enhancement and Semantic Alignment
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.15398](https://arxiv.org/pdf/2510.15398)**
...
>
---
#### [replaced 016] WorldVLM: Combining World Model Forecasting and Vision-Language Reasoning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 017] Think3D: Thinking with Space for Spatial Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.13029](https://arxiv.org/pdf/2601.13029)**
...
>
---
#### [replaced 019] LibraGen: Playing a Balance Game in Subject-Driven Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.13506](https://arxiv.org/pdf/2603.13506)**
...
>
---
#### [replaced 025] Fast-FoundationStereo: Real-Time Zero-Shot Stereo Matching
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 026] LeAD-M3D: Leveraging Asymmetric Distillation for Real-Time Monocular 3D Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05663](https://arxiv.org/pdf/2512.05663)**
...
>
> **备注:** Johannes Meier and Jonathan Michel - both authors contributed equally. Project page: this https URL
>
...
>
---
#### [replaced 029] Flexible and Efficient Spatio-Temporal Transformer for Sequential Visual Place Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.04282](https://arxiv.org/pdf/2510.04282)**

> **作者:** Yu Kiu; Chao Chen; Ge Jin; Chen Feng
>
...
>
---
#### [replaced 036] Exposing Blindspots: Cultural Bias Evaluation in Generative Image Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.20042](https://arxiv.org/pdf/2510.20042)**
...
>
> **备注:** 28 pages, 8 figures. Accepted at IASEAI 2026
>
...
>
---
#### [replaced 037] SineProject: Machine Unlearning for Stable Vision Language Alignment
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18444](https://arxiv.org/pdf/2511.18444)**
...
>
---
#### [replaced 038] DiG: Differential Grounding for Enhancing Fine-Grained Perception in Multimodal Large Language Model
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.12633](https://arxiv.org/pdf/2512.12633)**
...
>
---
#### [replaced 039] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.09881](https://arxiv.org/pdf/2510.09881)**
...
>
---
#### [replaced 040] Med-DualLoRA: Local Adaptation of Foundation Models for 3D Cardiac MRI
- **分类: cs.CV**
...
>
---
#### [replaced 055] Towards Clinical Practice in CT-Based Pulmonary Disease Screening: An Efficient and Reliable Framework
- **分类: eess.IV; cs.CV**
...
>
---
#### [replaced 056] Can Multimodal LLMs See Science Instruction? Benchmarking Pedagogical Reasoning in K-12 Classroom Videos
- **分类: cs.CY; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.18466](https://arxiv.org/pdf/2602.18466)**
...
>
---
#### [replaced 059] CountLoop: Training-Free High-Instance Image Generation via Iterative Agent Guidance
- **分类: cs.CV**
...
>
---
#### [replaced 060] TennisExpert: Towards Expert-Level Analytical Sports Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.13397](https://arxiv.org/pdf/2603.13397)**
...
>
---
#### [replaced 061] Few-Shot Video Object Segmentation in X-Ray Angiography Using Local Matching and Spatio-Temporal Consistency Loss
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.00988](https://arxiv.org/pdf/2601.00988)**
...
>
---
#### [replaced 067] CloSE: A Geometric Shape-Agnostic Cloth State Representation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 068] Learning Topology-Driven Multi-Subspace Fusion for Grassmannian Deep Network
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.08628](https://arxiv.org/pdf/2511.08628)**
...
>
---
#### [replaced 069] Make it SING: Analyzing Semantic Invariants in Classifiers
- **分类: cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2603.14610](https://arxiv.org/pdf/2603.14610)**
...
>
---
#### [replaced 072] CARE: A Molecular-Guided Foundation Model with Adaptive Region Modeling for Whole Slide Image Analysis
- **分类: cs.CV**
...
>
---
#### [replaced 073] EmoStory: Emotion-Aware Story Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.10349](https://arxiv.org/pdf/2603.10349)**

> **作者:** Jingyuan Yang; Rucong Chen; Weibin Luo; Hui Huang
>
> **备注:** accepted to ICME
>
...
>
---
#### [replaced 076] 3M-TI: High-Quality Mobile Thermal Imaging via Calibration-free Multi-Camera Cross-Modal Diffusion
- **分类: cs.CV; physics.optics**

- **链接: [https://arxiv.org/pdf/2511.19117](https://arxiv.org/pdf/2511.19117)**

> **作者:** Minchong Chen; Xiaoyun Yuan; Junzhe Wan; Jianing Zhang; Jun Zhang
>
> **备注:** Accepted by CVPR 2026, Code: this https URL, Project page: this https URL
>
...
>
---
#### [replaced 080] DiFlowDubber: Discrete Flow Matching for Automated Video Dubbing via Cross-Modal Alignment and Synchronization
...
>
---
#### [replaced 081] BridgeShape: Latent Diffusion Schrödinger Bridge for 3D Shape Completion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.23205](https://arxiv.org/pdf/2506.23205)**

> **作者:** Dequan Kong; Honghua Chen; Zhe Zhu; Mingqiang Wei
>
...
>
---
#### [replaced 082] Overview of the CXR-LT 2026 Challenge: Multi-Center Long-Tailed and Zero Shot Chest X-ray Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.22092](https://arxiv.org/pdf/2602.22092)**

> **作者:** Hexin Dong; Yi Lin; Pengyu Zhou; Xuan Zhong Feng; Alan Clint Legasto; Mingquan Lin; Hao Chen; Yuzhe Yang; George Shih; Yifan Peng
>
...
>
---
#### [replaced 083] TempCore: Are Video QA Benchmarks Temporally Grounded? A Frame Selection Sensitivity Analysis and Benchmark
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 084] DKDS: A Benchmark Dataset of Degraded Kuzushiji Documents with Seals for Detection and Binarization
- **分类: cs.CV**
...
>
---
#### [replaced 087] IMAIA: Interactive Maps AI Assistant for Travel Planning and Geo-Spatial Intelligence
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.06993](https://arxiv.org/pdf/2507.06993)**
...
>
---
#### [replaced 088] WildCap: Facial Albedo Capture in the Wild via Hybrid Inverse Rendering
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2512.11237](https://arxiv.org/pdf/2512.11237)**
...
>
---
#### [replaced 095] V-JEPA 2.1: Unlocking Dense Features in Video Self-Supervised Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.14482](https://arxiv.org/pdf/2603.14482)**
...
>
---
#### [replaced 098] Closed-Loop Action Chunks with Dynamic Corrections for Training-Free Diffusion Policy
...
>
---
#### [replaced 099] From Geometric Mimicry to Comprehensive Generation: A Context-Informed Multimodal Diffusion Model for Urban Morphology Synthesis
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 102] MASS: MoErging through Adaptive Subspace Selection
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2504.05342](https://arxiv.org/pdf/2504.05342)**
...
>
---
#### [replaced 104] Fillerbuster: Unified Generative Scene Completion Model for Casual Captures
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2502.05175](https://arxiv.org/pdf/2502.05175)**
...
>
---
#### [replaced 107] Topology-Preserving Data Augmentation for Ring-Type Polygon Annotations
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2603.14764](https://arxiv.org/pdf/2603.14764)**

> **作者:** Sudip Laudari; Sang Hun Baek
>
> **备注:** 10 pages, 6 figures
>
> **摘要:** Geometric data augmentation is widely used in segmentation pipelines and typically assumes that polygon annotations represent simply connected regions. However, in structured domains such as architectural floorplan analysis, ring-type regions are often encoded as a single cyclic polygon chain connecting outer and inner boundaries. During augmentation, clipping operations may remove intermediate vertices and disrupt this cyclic connectivity, breaking the structural relationship between the boundaries. In this work, we introduce an order-preserving polygon augmentation strategy that performs transformations in mask space and then projects surviving vertices back into index-space to restore adjacency relations. This repair maintains the original traversal order of the polygon and preserves topological consistency with minimal computational overhead. Experiments demonstrate that the approach reliably restores connectivity, achieving near-perfect Cyclic Adjacency Preservation (CAP) across both single and compound augmentations.
>
---
#### [replaced 108] GeoBridge: A Semantic-Anchored Multi-View Foundation Model Bridging Images and Text for Geo-Localization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02697](https://arxiv.org/pdf/2512.02697)**
...
>
---
#### [replaced 112] DefVINS: Visual-Inertial Odometry for Deformable Scenes
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 117] AIA: Rethinking Architecture Decoupling Strategy In Unified Multimodal Model
- **分类: cs.CV**
...
>
---
#### [replaced 120] FreeGaussian: Annotation-free Control of Articulated Objects via 3D Gaussian Splats with Flow Derivatives
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2410.22070](https://arxiv.org/pdf/2410.22070)**
...
>
---
#### [replaced 123] Vision-Language Models for Infrared Industrial Sensing in Additive Manufacturing Scene Description
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 124] Representing Beauty: Towards a Participatory but Objective Latent Aesthetics
- **分类: cs.CY; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.02869](https://arxiv.org/pdf/2510.02869)**
