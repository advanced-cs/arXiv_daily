...
#### [new 001] Multimodal Task Interference: A Benchmark and Analysis of History-Target Mismatch in Multimodal LLMs
- **分类: cs.CL**

- **简介: 该论文研究多模态大模型中的任务干扰问题，旨在评估不同模态任务切换对性能的影响。通过构建基准测试，分析了模态、推理和答案格式不匹配的影响。**

- **链接: [https://arxiv.org/pdf/2603.18425](https://arxiv.org/pdf/2603.18425)**

> **作者:** Masayuki Kawarada; Tatsuya Ishigaki; Hiroya Takamura
>
> **摘要:** Task interference, the performance degradation caused by task switches within a single conversation, has been studied exclusively in text-only settings despite the growing prevalence of multimodal dialogue systems. We introduce a benchmark for evaluating this phenomenon in multimodal LLMs, covering six tasks across text and vision with systematic variation of history-target along three axes: modality mismatch, reasoning mismatch, and answer format mismatch. Experiments on both open-weights and proprietary models reveal that task interference is highly directional: switching from text-only to image-based targets causes severe performance drops, while the reverse transition yields minimal degradation. Interference is further amplified when mismatches co-occur across multiple dimensions, and is driven most strongly by modality differences, followed by answer format, while reasoning requirement shifts cause minimal degradation.
>
---
#### [new 002] GRAFITE: Generative Regression Analysis Framework for Issue Tracking and Evaluation
- **分类: cs.CL**

- **简介: 该论文提出GRAFITE，一个持续评估大语言模型的平台，用于检测模型性能退化。任务是模型评估，解决基准数据污染导致的性能虚高问题，通过用户反馈和QA测试进行 regression 检测。**

- **链接: [https://arxiv.org/pdf/2603.18173](https://arxiv.org/pdf/2603.18173)**
...
>
---
#### [new 004] TARo: Token-level Adaptive Routing for LLM Test-time Alignment
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出TARo，解决LLM推理对齐问题，通过token级自适应路由提升推理性能，适用于多种任务。**

- **链接: [https://arxiv.org/pdf/2603.18411](https://arxiv.org/pdf/2603.18411)**
...
>
---
#### [new 012] UGID: Unified Graph Isomorphism for Debiasing Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的去偏任务，旨在解决大语言模型中的社会偏见问题。提出UGID框架，在内部表示层面进行去偏，通过图结构约束注意力和隐藏状态，有效减少偏见迁移。**

- **链接: [https://arxiv.org/pdf/2603.19144](https://arxiv.org/pdf/2603.19144)**
...
>
---
#### [new 015] From Noise to Signal: When Outliers Seed New Topics
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于动态主题建模任务，旨在识别异常值作为新兴主题的早期信号。通过构建时间分类体系，区分不同文档在主题形成中的角色，提升弱信号检测精度。**

- **链接: [https://arxiv.org/pdf/2603.18358](https://arxiv.org/pdf/2603.18358)**
...
>
---
#### [new 017] Optimal Splitting of Language Models from Mixtures to Specialized Domains
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言模型训练任务，解决多领域模型优化问题。提出一种方法，通过计算资源分配提升模型性能，实现更高效的预训练与专业化。**

- **链接: [https://arxiv.org/pdf/2603.19149](https://arxiv.org/pdf/2603.19149)**
...
>
---
#### [new 025] PowerFlow: Unlocking the Dual Nature of LLMs via Principled Distribution Matching
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出PowerFlow，解决LLMs无监督微调中的分布匹配问题，通过调整分布形状提升逻辑推理与创造性。**
...
>
---
#### [new 052] Beyond Accuracy: An Explainability-Driven Analysis of Harmful Content Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于有害内容检测任务，旨在解决模型预测逻辑不透明的问题。通过分析RoBERTa模型的可解释性，揭示其在边界情况下的局限性。**

- **链接: [https://arxiv.org/pdf/2603.18015](https://arxiv.org/pdf/2603.18015)**
...
>
---
#### [new 059] Progressive Training for Explainable Citation-Grounded Dialogue: Reducing Hallucination to Zero in English-Hindi LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识增强对话任务，旨在解决多语言对话系统中的幻觉问题。通过渐进式训练和引用机制，提升模型的可解释性和准确性。**

- **链接: [https://arxiv.org/pdf/2603.18911](https://arxiv.org/pdf/2603.18911)**
...
>
---
#### [new 060] Mi:dm K 2.5 Pro
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出Mi:dm K 2.5 Pro，解决企业级多步骤推理与长文本理解问题，通过优化数据和训练方法提升模型性能。**
...
>
---
#### [new 061] Agentic Framework for Political Biography Extraction
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文属于信息提取任务，旨在解决政治人物传记数据自动提取难题。通过构建合成-编码框架，利用大语言模型提升提取效率与准确性。**

- **链接: [https://arxiv.org/pdf/2603.18010](https://arxiv.org/pdf/2603.18010)**
...
>
---
#### [new 062] ProKWS: Personalized Keyword Spotting via Collaborative Learning of Phonemes and Prosody
...
>
---
#### [new 063] RewardFlow: Topology-Aware Reward Propagation on State Graphs for Agentic RL with Large Language Models
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于强化学习任务，旨在解决大语言模型在代理推理中因奖励稀疏导致的优化难题。提出RewardFlow方法，通过状态图拓扑结构进行奖励传播，提升奖励密度与训练效率。**
...
>
---
#### [new 068] CausalRM: Causal-Theoretic Reward Modeling for RLHF from Observational User Feedbacks
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文属于强化学习任务，旨在解决RLHF中奖励建模的噪声和偏差问题。通过引入CausalRM框架，利用观察性用户反馈训练无偏奖励模型。**

- **链接: [https://arxiv.org/pdf/2603.18736](https://arxiv.org/pdf/2603.18736)**
...
>
---
#### [new 069] Are complicated loss functions necessary for teaching LLMs to reason?
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于语言模型训练任务，旨在提升LLMs的推理能力。通过分析GRPO方法，发现其部分组件非必要，提出简化版本RGRA，验证其在数学基准上的有效性。**

- **链接: [https://arxiv.org/pdf/2603.18756](https://arxiv.org/pdf/2603.18756)**
...
>
---
#### [new 072] Detection Is Cheap, Routing Is Learned: Why Refusal-Based Alignment Evaluation Fails
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于AI对齐评估任务，探讨模型如何从概念检测到行为策略的路由机制。研究指出当前评估方法忽略路由环节，通过实验揭示路由机制对行为的直接影响。**
...
>
---
#### [new 073] PCOV-KWS: Multi-task Learning for Personalized Customizable Open Vocabulary Keyword Spotting
- **分类: eess.AS; cs.AI; cs.CL; cs.SD**
...
>
---
#### [new 074] FinTradeBench: A Financial Reasoning Benchmark for LLMs
- **分类: cs.CE; cs.AI; cs.CL; cs.IR; q-fin.CP**

- **简介: 该论文提出FinTradeBench，一个评估金融推理能力的基准，解决LLMs在财务决策中的不足，整合公司基本面和交易信号进行多维度测试。**
...
>
---
#### [new 080] Reasoning over mathematical objects: on-policy reward modeling and test time aggregation
- **分类: cs.AI; cs.CL**

- **简介: 该论文聚焦数学对象推理任务，解决现有模型在复杂表达式推导上的不足。通过构建数据集、优化训练方法和测试时聚合，提升模型在数学、物理等领域的推理能力。**

- **链接: [https://arxiv.org/pdf/2603.18886](https://arxiv.org/pdf/2603.18886)**
...
>
> **摘要:** The ability to precisely derive mathematical objects is a core requirement for downstream STEM applications, including mathematics, physics, and chemistry, where reasoning must culminate in formally structured expressions. Yet, current LM evaluations of mathematical and scientific reasoning rely heavily on simplified answer formats such as numerical values or multiple choice options due to the convenience of automated assessment. In this paper we provide three contributions for improving reasoning over mathematical objects: (i) we build and release training data and benchmarks for deriving mathematical objects, the Principia suite; (ii) we provide training recipes with strong LLM-judges and verifiers, where we show that on-policy judge training boosts performance; (iii) we show how on-policy training can also be used to scale test-time compute via aggregation. We find that strong LMs such as Qwen3-235B and o3 struggle on Principia, while our training recipes can bring significant improvements over different LLM backbones, while simultaneously improving results on existing numerical and MCQA tasks, demonstrating cross-format generalization of reasoning abilities.
>
---
#### [new 081] myMNIST: Benchmark of PETNN, KAN, and Classical Deep Learning Models for Burmese Handwritten Digit Recognition
...
>
---
#### [new 082] SpecForge: A Flexible and Efficient Open-Source Training Framework for Speculative Decoding
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决大模型推理延迟高的问题。通过提出SpecForge框架，提升推测解码训练效率，并发布高质量的草案模型以加速推理。**

- **链接: [https://arxiv.org/pdf/2603.18567](https://arxiv.org/pdf/2603.18567)**
...
>
---
#### [new 085] Impact of automatic speech recognition quality on Alzheimer's disease detection from spontaneous speech: a reproducible benchmark study with lexical modeling and statistical validation
- **分类: q-bio.QM; cs.CL; cs.LG**

- **简介: 该论文属于阿尔茨海默病检测任务，研究ASR质量对基于自发言语的诊断影响。通过 lexical 特征和机器学习模型，验证高质量ASR的重要性。**

- **链接: [https://arxiv.org/pdf/2603.18239](https://arxiv.org/pdf/2603.18239)**
...
>
---
#### [new 090] HISR: Hindsight Information Modulated Segmental Process Rewards For Multi-turn Agentic Reinforcement Learning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于多轮代理强化学习任务，旨在解决稀疏奖励和信用分配不准确的问题。提出HISR方法，通过回顾信息调节分段奖励，提升信用分配可靠性。**

- **链接: [https://arxiv.org/pdf/2603.18683](https://arxiv.org/pdf/2603.18683)**
...
>
---
#### [replaced 003] From Binary to Bilingual: How the National Weather Service is Using Artificial Intelligence to Develop a Comprehensive Translation Program
- **分类: cs.CL; cs.AI; cs.CY; cs.HC**

- **简介: 该论文属于多语言翻译任务，旨在解决非英语用户获取天气信息的问题。通过AI技术开发自动化翻译系统，提升翻译效率与准确性。**

- **链接: [https://arxiv.org/pdf/2510.14369](https://arxiv.org/pdf/2510.14369)**

> **作者:** Joseph E. Trujillo-Falcon; Monica L. Bozeman; Liam E. Llewellyn; Samuel T. Halvorson; Meryl Mizell; Stuti Deshpande; Bob Manning; Chris Rohrbach; Ian Blaylock; Angel Montanez; Todd Fagin
>
...
>
---
#### [replaced 004] Probing Cultural Signals in Large Language Models through Author Profiling
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于文化偏见分析任务，旨在检测大语言模型中的文化信号。通过作者画像评估模型在零样本场景下的性别和族裔推断能力，发现模型存在系统性文化对齐偏差，并提出公平性指标进行量化分析。**
...
>
---
#### [replaced 007] AJAR: Adaptive Jailbreak Architecture for Red-teaming
- **分类: cs.CR; cs.CL**

- **简介: 该论文属于LLM安全评估任务，解决多轮攻击与代理运行时的适配问题。提出AJAR框架，集成多种攻击方法，提升攻击成功率并支持策略切换与回滚。**

- **链接: [https://arxiv.org/pdf/2601.10971](https://arxiv.org/pdf/2601.10971)**

> **作者:** Yipu Dou; Wang Yang
>
> **备注:** 7 pages, 3 figures. Code and data available at this https URL
>
...
>
---
#### [replaced 010] SQLBench: A Comprehensive Evaluation for Text-to-SQL Capabilities of Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于Text-to-SQL任务，旨在解决LLM在该任务中的评估不足问题。构建新数据集并设计五项评估任务，全面分析LLM性能，提出优化方案。**

- **链接: [https://arxiv.org/pdf/2403.02951](https://arxiv.org/pdf/2403.02951)**
...
>
---
#### [replaced 012] StoryBox: Collaborative Multi-Agent Simulation for Hybrid Bottom-Up Long-Form Story Generation Using Large Language Models
- **分类: cs.CL; cs.MA**

- **简介: 该论文属于长篇故事生成任务，旨在解决传统方法结构僵化的问题。通过多智能体模拟实现自底向上的故事生成，使情节自然发展，提升故事的连贯性与吸引力。**

- **链接: [https://arxiv.org/pdf/2510.11618](https://arxiv.org/pdf/2510.11618)**

> **作者:** Zehao Chen; Rong Pan; Haoran Li
>
> **备注:** Accepted by AAAI 2026. Project: this https URL
>
...
>
---
#### [replaced 013] SIA: A Synthesize-Inject-Align Framework for Knowledge-Grounded and Secure E-commerce Search LLMs with Industrial Deployment
- **分类: cs.CL**

- **简介: 该论文属于电商搜索任务，旨在解决大模型知识幻觉和安全漏洞问题。提出SIA框架，通过合成、注入和对齐提升模型的知识性和安全性。**
...
>
---
#### [replaced 014] Farther the Shift, Sparser the Representation: Analyzing OOD Mechanisms in LLMs
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 015] DUAL-Bench: Measuring Over-Refusal and Robustness in Vision-Language Models
- **分类: cs.CL**

- **简介: 该论文属于视觉语言模型安全任务，旨在解决过早拒绝与安全完成问题。提出DUAL-Bench基准，评估模型在双用途场景下的安全表现。**

- **链接: [https://arxiv.org/pdf/2510.10846](https://arxiv.org/pdf/2510.10846)**

> **作者:** Kaixuan Ren; Preslav Nakov; Usman Naseem
>
> **备注:** 26pages, 13 figures, Preprint
>
...
>
---
#### [replaced 016] ClinicalTrialsHub: Bridging Registries and Literature for Comprehensive Clinical Trial Access
- **分类: cs.CL; cs.AI; cs.HC; cs.IR**

- **简介: 该论文提出ClinicalTrialsHub，解决临床试验数据整合与获取问题。通过提取PubMed信息，增强数据可访问性，提升83.8%，服务于医疗决策。**

- **链接: [https://arxiv.org/pdf/2512.08193](https://arxiv.org/pdf/2512.08193)**

> **作者:** Jiwoo Park; Ruoqi Liu; Avani Jagdale; Andrew Srisuwananukorn; Jing Zhao; Lang Li; Ping Zhang; Sachin Kumar
>
> **摘要:** We present ClinicalTrialsHub, an interactive search-focused platform that consolidates all data from this http URL and augments it by automatically extracting and structuring trial-relevant information from PubMed research articles. Our system effectively increases access to structured clinical trial data by 83.8% compared to relying on this http URL alone, with potential to make access easier for patients, clinicians, researchers, and policymakers, advancing evidence-based medicine. ClinicalTrialsHub uses large language models such as GPT-5.1 and Gemini-3-Pro to enhance accessibility. The platform automatically parses full-text research articles to extract structured trial information, translates user queries into structured database searches, and provides an attributed question-answering system that generates evidence-grounded answers linked to specific source sentences. We demonstrate its utility through a user study involving clinicians, clinical researchers, and PhD students of pharmaceutical sciences and nursing, and a systematic automatic evaluation of its information extraction and question answering capabilities.
>
---
#### [replaced 017] DSPO: Stable and Efficient Policy Optimization for Agentic Search and Reasoning
- **分类: cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决大模型在复杂任务中代理能力不足的问题。提出DSPO算法，通过序列优化和动态采样过滤提升训练效果，实现高效搜索与推理。**

- **链接: [https://arxiv.org/pdf/2510.09255](https://arxiv.org/pdf/2510.09255)**
...
>
---
#### [replaced 018] Auditing Black-Box LLM APIs with a Rank-Based Uniformity Test
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于模型安全任务，解决黑盒LLM API行为篡改检测问题。通过秩次均匀性检验，验证API与真实模型行为一致性，提升检测效果。**

- **链接: [https://arxiv.org/pdf/2506.06975](https://arxiv.org/pdf/2506.06975)**
...
>
---
#### [replaced 019] CMV-Fuse: Cross Modal-View Fusion of AMR, Syntax, and Knowledge Representations for Aspect Based Sentiment Analysis
- **分类: cs.CL**

- **简介: 该论文属于情感分析任务，旨在解决传统方法仅依赖单一语言视角的问题。提出CMV-Fuse框架，融合多种语言表示，提升情感分析效果。**

- **链接: [https://arxiv.org/pdf/2512.06679](https://arxiv.org/pdf/2512.06679)**
...
>
---
#### [replaced 020] AdaSwitch: Balancing Exploration and Guidance in Knowledge Distillation via Adaptive Switching
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识蒸馏任务，旨在解决小模型性能提升中的探索与引导平衡问题。通过自适应切换机制，结合在线和离线策略，提高模型准确性与推理能力。**
...
>
---
#### [replaced 021] Steering Awareness: Detecting Activation Steering from Within
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究激活扰动检测问题，探讨模型是否能感知并识别被注入的扰动向量。任务属于模型安全评估领域，旨在验证激活扰动是否可被检测。工作包括测试模型的感知能力，发现其可有效检测扰动但不增强安全性。**
...
>
---
#### [replaced 022] A technology-oriented mapping of the language and translation industry: Analysing stakeholder values and their potential implication for translation pedagogy
- **分类: cs.CL; cs.HC**

- **简介: 该论文属于行业分析任务，探讨自动化背景下语言服务行业价值构建与协商问题。通过访谈分析，揭示技术与人类价值的互动关系及其对翻译教育的影响。**
...
>
---
#### [replaced 023] Infherno: End-to-end Agent-based FHIR Resource Synthesis from Free-form Clinical Notes
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于临床数据整合任务，旨在将自由文本的临床笔记转化为结构化的FHIR资源。针对现有方法泛化能力差的问题，提出端到端框架Infherno，利用LLM代理等技术提升准确性与一致性。**

- **链接: [https://arxiv.org/pdf/2507.12261](https://arxiv.org/pdf/2507.12261)**

> **作者:** Johann Frei; Nils Feldhus; Lisa Raithel; Roland Roller; Alexander Meyer; Frank Kramer
>
> **备注:** EACL 2026 System Demonstrations | Code: this https URL | Demo: this https URL
>
...
>
---
#### [replaced 024] Social Simulacra in the Wild: AI Agent Communities on Moltbook
- **分类: cs.CL**
...
>
> **备注:** Preprint: 13 pages, 4 figures, 5 tables
>
...
>
---
#### [replaced 025] Rule-Based Explanations for Retrieval-Augmented LLM Systems
- **分类: cs.CL**

- **简介: 该论文属于解释性AI任务，旨在为检索增强的大型语言模型提供基于规则的解释。通过生成规则说明输出来源，解决模型可解释性问题。**

- **链接: [https://arxiv.org/pdf/2510.22689](https://arxiv.org/pdf/2510.22689)**
...
>
---
#### [replaced 030] HopChain: Multi-Hop Data Synthesis for Generalizable Vision-Language Reasoning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 031] Zipper-LoRA: Dynamic Parameter Decoupling for Speech-LLM based Multilingual Speech Recognition
- **分类: cs.CL; cs.SD**
...
>
---
#### [replaced 032] Transformers Remember First, Forget Last: Dual-Process Interference in LLMs
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文研究LLMs在冲突信息下的记忆保留机制，属于认知科学与AI交叉任务。通过实验发现LLMs表现出早期记忆优先的干扰模式，揭示其与人类记忆的不同。**
...
>
---
#### [replaced 033] Fin-R1: A Large Language Model for Financial Reasoning through Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文提出Fin-R1，一个用于金融推理的大型语言模型，解决金融数据碎片化、推理不透明和应用迁移弱的问题。通过构建高质量数据集并采用监督微调和强化学习进行训练。**

- **链接: [https://arxiv.org/pdf/2503.16252](https://arxiv.org/pdf/2503.16252)**

> **作者:** Zhaowei Liu; Xin Guo; Zhi Yang; Fangqi Lou; Lingfeng Zeng; Jinyi Niu; Mengping Li; Qi Qi; Zhiqiang Liu; Yiyang Han; Dongpo Cheng; Ronghao Chen; Huacan Wang; Xingdong Feng; Huixia Judy Wang; Chengchun Shi; Liwen Zhang
>
...
>
---
#### [replaced 034] Redundancy-as-Masking: Formalizing the Artificial Age Score (AAS) to Model Memory Aging in Generative AI
- **分类: cs.CL; cs.AI; cs.IT; cs.LG**

- **简介: 该论文属于人工智能领域，研究生成式AI的记忆老化问题。提出AAS度量模型记忆随时间的退化，通过实验验证其有效性。**

- **链接: [https://arxiv.org/pdf/2510.01242](https://arxiv.org/pdf/2510.01242)**

> **作者:** Seyma Yaman Kayadibi
>
> **备注:** 37 pages, 17 figures. Includes theoretical development and mathematical proofs of the Artificial Age Score (AAS), with empirical illustrations via ChatGPT-based memory recall experiments
>
...
>
---
#### [replaced 038] If Probable, Then Acceptable? Understanding Conditional Acceptability Judgments in Large Language Models
- **分类: cs.CL**

- **简介: 该论文研究大语言模型对条件句可接受性的判断，探讨其如何基于概率和语义进行推理，旨在理解模型与人类判断的差异。**

- **链接: [https://arxiv.org/pdf/2510.08388](https://arxiv.org/pdf/2510.08388)**

> **作者:** Jasmin Orth; Philipp Mondorf; Barbara Plank
>
> **备注:** EACL 2026 Main, 23 pages, 12 figures
>
...
>
---
#### [replaced 039] LLM-Augmented Changepoint Detection: A Framework for Ensemble Detection and Automated Explanation
- **分类: cs.CL**
...
> **作者:** Fabian Lukassen; Christoph Weisser; Michael Schlee; Manish Kumar; Anton Thielmann; Benjamin Saefken; Alexander Silbersdorff; Thomas Kneib
>
...
>
---
#### [replaced 040] Simulation to Rules: A Dual-VLM Framework for Formal Visual Planning
...
>
---
#### [replaced 041] CeRA: Breaking the Linear Ceiling of Low-Rank Adaptation via Manifold Expansion
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出CeRA，解决LoRA在复杂任务中因线性约束导致的性能瓶颈，通过引入结构化机制提升参数效率，适用于低秩微调任务。**
...
>
---
#### [replaced 042] RAISE: Enhancing Scientific Reasoning in LLMs via Step-by-Step Retrieval
- **分类: cs.CL**

- **简介: 该论文提出RAISE框架，用于增强大模型的科学推理能力。针对科学推理中长链逻辑和领域知识更新的问题，通过分步检索提升推理效果。**

- **链接: [https://arxiv.org/pdf/2506.08625](https://arxiv.org/pdf/2506.08625)**
...
>
---
#### [replaced 043] Vulnerability of LLMs' Stated Beliefs? LLMs Belief Resistance Check Through Strategic Persuasive Conversation Interventions
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，研究LLMs在说服下的信念稳定性问题。通过实验分析不同说服策略的影响，探讨提升模型抗说服能力的方法。**

- **链接: [https://arxiv.org/pdf/2601.13590](https://arxiv.org/pdf/2601.13590)**

> **作者:** Fan Huang; Haewoon Kwak; Jisun An
>
> **备注:** Updated new models and minor revisions
>
...
>
---
#### [replaced 044] Omnilingual SONAR: Cross-Lingual and Cross-Modal Sentence Embeddings Bridging Massively Multilingual Text and Speech
- **分类: cs.CL**

- **简介: 该论文提出OmniSONAR，解决跨语言、跨模态句子嵌入问题，支持数千种语言的文本、语音等多模态数据，在多个任务中取得最佳效果。**
...
>
---
#### [replaced 045] When Only the Final Text Survives: Implicit Execution Tracing for Multi-Agent Attribution
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出IET框架，解决多智能体系统中无法追踪责任的问题。通过嵌入信号实现文本级归属和交互拓扑重建，提升系统可审计性。**
...
>
---
#### [replaced 046] LMEB: Long-horizon Memory Embedding Benchmark
- **分类: cs.CL**

- **简介: 该论文提出LMEB基准，用于评估长时记忆检索能力。解决现有基准未覆盖长时、碎片化记忆任务的问题，涵盖多种记忆类型和任务，评估多个模型表现。**
...
>
---
#### [replaced 047] CausalARC: Abstract Reasoning with Causal World Models
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出CausalARC，用于低数据和分布外推理任务，通过因果世界模型解决抽象推理问题。**

- **链接: [https://arxiv.org/pdf/2509.03636](https://arxiv.org/pdf/2509.03636)**
...
>
---
#### [replaced 048] Prompt Architecture Determines Reasoning Quality: A Variable Isolation Study on the Car Wash Problem
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究语言模型在“汽车清洗问题”中的推理能力，通过变量隔离实验，探索不同提示架构对推理质量的影响。**

- **链接: [https://arxiv.org/pdf/2602.21814](https://arxiv.org/pdf/2602.21814)**
...
>
---
#### [replaced 049] DeSTA2.5-Audio: Toward General-Purpose Large Audio Language Model with Self-Generated Cross-Modal Alignment
- **分类: eess.AS; cs.CL; cs.SD**
...
>
---
#### [replaced 050] SynBullying: A Multi LLM Synthetic Conversational Dataset for Cyberbullying Detection
- **分类: cs.AI; cs.CL; cs.CY**

- **简介: 该论文提出SynBullying，一个用于网络欺凌检测的多LLM合成对话数据集，解决真实数据收集难题。通过模拟对话，提供结构化、上下文标注和细粒度标签，提升检测效果。**

- **链接: [https://arxiv.org/pdf/2511.11599](https://arxiv.org/pdf/2511.11599)**
...
>
---
#### [replaced 051] Efficient Reasoning with Balanced Thinking
- **分类: cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 052] Large Language Models Hallucination: A Comprehensive Survey
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理领域，旨在解决大语言模型幻觉问题。通过分析幻觉成因、检测与缓解方法，提出系统性解决方案，提升模型可靠性。**

- **链接: [https://arxiv.org/pdf/2510.06265](https://arxiv.org/pdf/2510.06265)**
...
>
---
#### [replaced 053] HiFi-KPI: A Dataset for Hierarchical KPI Extraction from Earnings Filings
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出HiFi-KPI数据集，解决财报中KPI提取问题，支持多任务评估，提升跨公司KPI识别准确性。**
...
>
---
#### [replaced 054] PlainQAFact: Retrieval-augmented Factual Consistency Evaluation Metric for Biomedical Plain Language Summarization
- **分类: cs.CL**

- **简介: 该论文属于生物医学领域普通语言摘要任务，旨在解决大模型生成内容的事实一致性评估问题。提出PlainQAFact方法，提升对扩展解释内容的评估效果。**

- **链接: [https://arxiv.org/pdf/2503.08890](https://arxiv.org/pdf/2503.08890)**

> **作者:** Zhiwen You; Yue Guo
>
> **备注:** Accepted by Journal of Biomedical Informatics
>
...
>
---
#### [replaced 055] The Flexibility Trap: Why Arbitrary Order Limits Reasoning Potential in Diffusion Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于语言模型研究任务，探讨扩散语言模型在任意顺序生成中的推理局限性。工作指出当前方法因过度依赖顺序灵活性而限制推理能力，并提出简化策略提升效果。**

- **链接: [https://arxiv.org/pdf/2601.15165](https://arxiv.org/pdf/2601.15165)**
...
>
---
#### [replaced 056] The Geometry of Dialogue: Graphing Language Models to Reveal Synergistic Teams for Multi-Agent Collaboration
- **分类: cs.CL; cs.AI; cs.MA**

- **简介: 该论文属于多智能体协作任务，旨在解决如何自动组建高效语言模型团队的问题。通过构建语言模型图并应用社区检测，发现功能协同的模型群组。**

- **链接: [https://arxiv.org/pdf/2510.26352](https://arxiv.org/pdf/2510.26352)**

> **作者:** Kotaro Furuya; Yuichi Kitagawa
>
> **备注:** Accepted at the AAAI-26 Workshop on LLM-based Multi-Agent Systems: Towards Responsible, Reliable, and Scalable Agentic Systems (LaMAS 2026) as an oral presentation
>
