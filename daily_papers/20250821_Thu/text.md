...
- **简介: 论文提出混合Mamba-Transformer模型，用于高效推理任务，通过替换自注意力层提升速度，预训练并压缩模型，实现高吞吐和准确性。**
...
- **简介: 论文研究LLM在IPP任务中区分自动生成文本的能力，发现其表现差源于隐含的领土意识未被表达，提出Cognitive Surgery框架唤醒该意识，提升三类LLM在IPP场景下的准确率。**
...
- **链接: [http://arxiv.org/pdf/2508.14056v1](http://arxiv.org/pdf/2508.14056v1)**
...
- **链接: [http://arxiv.org/pdf/2508.14782v1](http://arxiv.org/pdf/2508.14782v1)**
...
- **简介: 论文针对文学和多语言文本的情感分析，解决传统方法在隐喻、低资源语言及细粒度分析中的不足，提出基于概念向量投影的连续评分方法，有效捕捉情感变化，优于现有工具。**
...
- **简介: 该论文研究微调大语言模型中的数据记忆风险，提出多层隐私保护框架，通过实验验证四种方法有效降低隐私泄露，同时保持模型性能。**
...
- **链接: [http://arxiv.org/pdf/2508.14828v1](http://arxiv.org/pdf/2508.14828v1)**
...
>
---
#### [new 023] Contrastive Analysis of Constituent Order Preferences Within Adverbial Roles in English and Chinese News: A Large-Language-Model-Driven Approach
- **分类: cs.CL**
...
- **简介: 该论文针对EHRs长噪声问题，比较RAG与长上下文输入在临床推理中的性能，设计三类任务测试LLM，证明RAG能以更少token实现接近甚至超越长上下文的效果。**
...
>
---
#### [new 038] DPad: Efficient Diffusion Language Models with Suffix Dropout
- **分类: cs.CL; cs.LG**
...
- **简介: 论文针对工具增强LLM中错误API调用问题，提出行为对齐检索器（BAR），通过对比学习生成行为一致的示范，减少错误调用，提升效率与成本效益。**
...
- **简介: 论文任务为评估LLM代码生成的稳定性，解决如何量化结构一致性问题，采用结构熵与AST分析，提出Jensen-Shannon散度和结构交叉熵两种指标，无参考依赖，验证模型鲁棒性。**
...
- **简介: 该论文针对LLM优化中的标注依赖与任务适用性限制，提出DuPO框架，通过双学习分解任务输入并构建对偶任务重构未知部分，实现无标注自监督优化，提升翻译、数学推理等多任务性能。**
...
- **简介: 论文提出MahaTTS-v2，解决多语言TTS覆盖不足问题，通过结合Wav2Vec2.0、语言模型和条件流模型，在印度语言上训练，提升多语言语音合成能力。**
...
- **简介: 该论文通过fMRI研究比较专家与中级提示工程师的大脑功能连接差异，揭示提示工程技能的神经标志物，旨在探索人类与LLM交互的神经认知基础及优化人机接口的设计依据。**
...
- **链接: [http://arxiv.org/pdf/2508.02091v2](http://arxiv.org/pdf/2508.02091v2)**
...
- **链接: [http://arxiv.org/pdf/2508.10142v2](http://arxiv.org/pdf/2508.10142v2)**
...
>
---
#### [replaced 012] Beyond Pass@1: Self-Play with Variational Problem Synthesis Sustains RLVR
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.14029v2](http://arxiv.org/pdf/2508.14029v2)**
...
>
---
#### [replaced 015] Social Debiasing for Fair Multi-modal LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2408.06569v2](http://arxiv.org/pdf/2408.06569v2)**
...
- **链接: [http://arxiv.org/pdf/2502.02329v2](http://arxiv.org/pdf/2502.02329v2)**
...
>
---
#### [replaced 018] Input Time Scaling
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.13654v2](http://arxiv.org/pdf/2508.13654v2)**
...
>
---
#### [replaced 019] TASER: Table Agents for Schema-guided Extraction and Recommendation
- **分类: cs.AI; cs.CL; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.13404v2](http://arxiv.org/pdf/2508.13404v2)**

> **作者:** Nicole Cho; Kirsty Fielding; William Watson; Sumitra Ganesh; Manuela Veloso
>
> **备注:** Withdrawn due to missing key sections in the paper
>
...
>
---
#### [replaced 020] Source2Synth: Synthetic Data Generation and Curation Grounded in Real Data Sources
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2409.08239v2](http://arxiv.org/pdf/2409.08239v2)**
...
>
---
#### [replaced 021] Is neural semantic parsing good at ellipsis resolution, or isn't it?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.00121v3](http://arxiv.org/pdf/2508.00121v3)**
...
>
---
#### [replaced 022] Retrieval-Augmented Semantic Parsing: Improving Generalization with Lexical Knowledge
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2412.10207v3](http://arxiv.org/pdf/2412.10207v3)**
...
>
---
#### [replaced 023] Enhancing Depression-Diagnosis-Oriented Chat with Psychological State Tracking
...
>
---
#### [replaced 024] Chain of Correction for Full-text Speech Recognition with Large Language Models
- **分类: cs.CL; eess.AS**

- **链接: [http://arxiv.org/pdf/2504.01519v2](http://arxiv.org/pdf/2504.01519v2)**
...
>
---
#### [replaced 025] FMSD-TTS: Few-shot Multi-Speaker Multi-Dialect Text-to-Speech Synthesis for Ü-Tsang, Amdo and Kham Speech Dataset Generation
...
>
---
#### [replaced 026] RotBench: Evaluating Multimodal Large Language Models on Identifying Image Rotation
...
>
---
#### [replaced 029] Task-Oriented Automatic Fact-Checking with Frame-Semantics
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2501.13288v3](http://arxiv.org/pdf/2501.13288v3)**
...
>
---
#### [replaced 030] ChuLo: Chunk-Level Key Information Representation for Long Document Understanding
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.11119v5](http://arxiv.org/pdf/2410.11119v5)**
...
>
---
#### [replaced 031] CRED-SQL: Enhancing Real-world Large Scale Database Text-to-SQL Parsing through Cluster Retrieval and Execution Description
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.12769v3](http://arxiv.org/pdf/2508.12769v3)**
...
>
---
#### [replaced 034] Each to Their Own: Exploring the Optimal Embedding in RAG
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.17442v2](http://arxiv.org/pdf/2507.17442v2)**
...
>
---
#### [replaced 039] From Autonomy to Agency: Agentic Vehicles for Human-Centered Mobility Systems
...
>
---
#### [replaced 040] Applying Text Embedding Models for Efficient Analysis in Labeled Property Graphs
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2507.10772v3](http://arxiv.org/pdf/2507.10772v3)**
...
>
---
#### [replaced 041] Enhancing Temporal Sensitivity of Large Language Model for Recommendation with Counterfactual Tuning
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [http://arxiv.org/pdf/2507.03047v2](http://arxiv.org/pdf/2507.03047v2)**
