...
>
---
#### [new 037] Deep Learning-based 3D Oral Cavity Reconstruction Using 2D Intraoral Images
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于3D重建任务，旨在解决传统口腔扫描方法成本高、不适等问题。通过十张2D图像实现3D模型重建，使用深度学习方法提高效率与便捷性。**

- **链接: [https://arxiv.org/pdf/2606.05998](https://arxiv.org/pdf/2606.05998)**
...
>
---
#### [new 044] Thinking with Imagination: Agentic Visual Spatial Reasoning with World Simulators
- **分类: cs.CV**

- **简介: 该论文属于视觉空间推理任务，旨在解决VLM在空间推理中的局限性。通过引入世界模拟器和主动想象机制，提升模型的推理能力。**

- **链接: [https://arxiv.org/pdf/2606.06476](https://arxiv.org/pdf/2606.06476)**
...
>
---
#### [new 045] HomeWorld: A Unified Floorplan-to-Furnished Framework for Generating Controllable, Densely Interactive Whole-Home Scenes
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于室内场景生成任务，旨在解决复杂布局与数据稀缺导致的生成困难。提出统一框架，分阶段生成可控制、高交互的全屋场景。**

- **链接: [https://arxiv.org/pdf/2606.06390](https://arxiv.org/pdf/2606.06390)**
...
>
---
#### [new 058] Towards One-to-Many Temporal Grounding
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频文本匹配任务，解决一到多时间定位问题。提出新基准和评估指标，构建数据集，并设计奖励函数提升模型性能。**

- **链接: [https://arxiv.org/pdf/2606.06294](https://arxiv.org/pdf/2606.06294)**

> **作者:** Qi Xu; Yue Tan; Shihao Chen; Jiahao Meng; Anna Wang; Shunping Ji; Hao Fei; Jason Li
>
> **备注:** Accepted to ICML'26
>
> **摘要:** Temporal Grounding (TG) aims to localize video segments corresponding to a textual query. Prior research predominantly focuses on single-segment retrieval. Real-world scenarios, however, often require localizing multiple disjoint segments for a single query -- a setting we term One-to-Many Temporal Grounding (OMTG). Previous state-of-the-art MLLMs, optimized for one-to-one settings, struggle in this context, often yielding near-zero scores due to a lack of event cardinality perception. To bridge this gap, we present a systematic solution with three key contributions. First, we establish the first comprehensive OMTG benchmark, introducing Count Accuracy (C-Acc) and Effective Temporal F1 (EtF1) as evaluation metrics. Second, we curate a high-quality OMTG dataset comprising 56k samples through a sophisticated construction pipeline. Third, we develop novel temporal and caption reward functions specifically designed for OMTG. In particular, the caption reward leverages Chain-of-Thought reasoning over dense video captions to explicitly guide policy optimization toward both preciseness and completeness. Extensive experiments show our model achieves a new state-of-the-art EtF1 of 43.65\% on OMTG Bench, outperforming Gemini 2.5 Pro and Seed-1.8 by 15.85\% and 15.61\%, respectively.
>
---
#### [new 059] ReSAGE-PAR: Representational Similarity Assessment for Generative Expansion in Pedestrian Attribute Recognition
- **分类: cs.CV**

- **简介: 该论文属于行人属性识别任务，解决数据多样性不足和生成幻觉问题。通过生成-评分-自动标注流程，提升数据集质量与模型性能。**

- **链接: [https://arxiv.org/pdf/2606.06020](https://arxiv.org/pdf/2606.06020)**
...
>
> **摘要:** Despite generating increasingly photorealistic images, text-to-image (T2I) models still exhibit localized, subtle, and structurally complex failures. Diagnosing these failures requires instance-level feedback that answers where a defect occurs, what type it is, why it is defective, and its importance to overall image quality. While recent dense-feedback methods move beyond scalar supervision, their heatmap-centric representations still formulate diagnosis as pixel-field regression, making it difficult to localize variable-cardinality defects and bind semantic reasons to individual failures. To address this representation bottleneck, we propose Structured Defect Grounding (SDG), which casts T2I diagnosis as structured set prediction by modeling each defect as a (location, type, reason, importance) tuple. To make this formulation trainable and measurable, we introduce SDG-30K, a 30K-image dataset with box-grounded annotations across four modern T2I generators, together with a dedicated evaluation protocol, SDG-Eval. Building on this structured representation, we further present a diagnosis-to-alignment framework in which a Vision-Language Model (VLM) serves as the SDG detector, and BoxFlow-GRPO converts predicted defect sets into box-derived, importance-weighted spatial rewards for diffusion model alignment. Extensive experiments show that our SDG detector outperforms leading proprietary VLMs on structured defect grounding, while SDG-guided rewards consistently improve T2I alignment and support localized image refinement. These results establish SDG as a unified, instance-level interface for diagnosing, evaluating, and enhancing modern generative models.
>
---
#### [new 068] Would you still call this Dax? Novel Visual References in VLMs and Humans
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 069] LongSpace: Exploring Long-Horizon Spatial Memory from Perception to Recall in Video
...
>
---
#### [new 070] UniPixie: Unified and Probabilistic 3D Physics Learning via Flow Matching
- **分类: cs.CV**

- **简介: 该论文提出UNIPIXIE，解决物理属性预测中的不确定性问题，通过学习连续分布生成多样且物理合理的材料属性，提升预测精度与通用性。**

- **链接: [https://arxiv.org/pdf/2606.05399](https://arxiv.org/pdf/2606.05399)**
...
>
---
#### [new 085] ATT-CR: Adaptive Triangular Transformer for Cloud Removal
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于遥感图像云去除任务，旨在解决Transformer方法计算复杂度高和云像素干扰问题。提出ATT-CR模型，包含TAN和FSGM，降低计算成本并提升去云效果。**

- **链接: [https://arxiv.org/pdf/2606.05999](https://arxiv.org/pdf/2606.05999)**
...
>
---
#### [new 086] Comparison of Deep Learning Frameworks For Rice Disease Mapping From UAV Multispectral Imaging
- **分类: cs.CV**

- **简介: 该论文属于水稻病害分割任务，旨在通过UAV多光谱图像识别细菌性条斑病。比较了多种深度学习模型的性能，发现U-Net++ with EfficientNet-B3表现最佳。**

- **链接: [https://arxiv.org/pdf/2606.06359](https://arxiv.org/pdf/2606.06359)**
...
>
---
#### [new 097] RhymeFlow: Training-Free Acceleration for Video Generation with Asynchronous Denoising Flow Scheduling
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决DiT模型推理慢、计算成本高的问题。通过稀疏关键帧 denoising 和轨迹投影，实现加速与质量平衡。**

- **链接: [https://arxiv.org/pdf/2606.06309](https://arxiv.org/pdf/2606.06309)**
...
>
---
#### [new 114] Learning Visual Spatial Planning from Symbolic State via Modality-Gap-Aware Self-Distillation
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于视觉空间规划任务，解决视觉与符号规划间的模态差距问题。通过两阶段自蒸馏框架提升模型的视觉状态恢复和规划能力。**

- **链接: [https://arxiv.org/pdf/2606.06076](https://arxiv.org/pdf/2606.06076)**
...
>
---
#### [new 115] What Objects Enable, Not What They Are: Functional Latent Spaces for Affordance Reasoning
- **分类: cs.LG; cs.AI; cs.CV; cs.RO**

- **简介: 该论文属于机器人规划任务，旨在解决现有系统依赖外观而非功能的问题。通过构建功能潜在空间A4D，提升对象功能推理的泛化能力。**

- **链接: [https://arxiv.org/pdf/2606.05533](https://arxiv.org/pdf/2606.05533)**
...
>
---
#### [new 120] GS-NFS: Bandwidth-adaptive Streaming of Dynamic Gaussian Splats and Point Clouds
- **分类: cs.MM; cs.CV; cs.GR; cs.NI**

- **简介: 该论文属于3D视频流任务，解决动态3D高斯点云压缩效率低的问题。提出GS-NFS，通过GPU并行加速压缩与解压，提升速度且保持质量。**

- **链接: [https://arxiv.org/pdf/2606.05650](https://arxiv.org/pdf/2606.05650)**
...
>
---
#### [replaced 002] FATE: Focal-modulated Attention Encoder for Multivariate Time-series Forecasting
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2408.11336](https://arxiv.org/pdf/2408.11336)**
...
>
---
#### [replaced 003] Drive-KD: Multi-Teacher Distillation for VLMs in Autonomous Driving
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.21288](https://arxiv.org/pdf/2601.21288)**

> **作者:** Weitong Lian; Zecong Tang; Haoran Li; Tianjian Gao; Yifei Wang; Zixu Wang; Lingyi Meng; Tengju Ru; Zhejun Cui; Yichen Zhu; Hangshuo Cao; Qi Kang; Tianxing Chen; Kaixuan Wang; Yu Zhang
>
...
>
---
#### [replaced 006] RAPTOR+: A Visually Grounded Vision-Language Framework to Improve Clinical Trust and Auditability in Automated Cancer Referral Processing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.25956](https://arxiv.org/pdf/2605.25956)**

> **作者:** Sofiat Abioye; Ufaq Khan; Shazad Ashraf; Anusha Jose; Adam Byfield; Lukman Akanbi; Muhammad Bilal
>
...
>
---
#### [replaced 009] Attention, May I Have Your Decision? Localizing Generative Choices in Diffusion Models
- **分类: cs.CV**
...
>
---
#### [replaced 010] Latent Implicit Visual Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21218](https://arxiv.org/pdf/2512.21218)**
...
>
---
#### [replaced 011] Image Generators are Generalist Vision Learners
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 012] HiDe: Rethinking The Zoom-IN method in High Resolution MLLMs via Hierarchical Decoupling
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 013] Clustering Guided Domain-Specific Pretrained Foundation Model for Very High-Resolution Arctic Remote Sensing
- **分类: cs.CV**
...
>
---
#### [replaced 014] Facial-R1: Aligning Reasoning and Recognition for Facial Emotion Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.10254](https://arxiv.org/pdf/2511.10254)**

> **作者:** Jiulong Wu; Yucheng Shen; Lingyong Yan; Haixin Sun; Deguo Xia; Jizhou Huang; Min Cao
>
> **备注:** Withdrawn by the authors due to pending intellectual property considerations. The authors have determined that the current version contains material that should not have been publicly disseminated at this stage
>
...
>
---
#### [replaced 015] Test-Time Training for Visual Foresight Vision-Language-Action Models
- **分类: cs.CV; cs.LG; cs.RO**

- **简介: 该论文属于视觉-语言-动作模型任务，旨在解决VF-VLA在分布外数据下的脆弱性问题。通过测试时训练和自适应更新机制提升模型鲁棒性。**
...
>
> **备注:** Accepted at ICML 2026 Workshop on Continual Adaptation at Scale (CATS)
>
...
>
---
#### [replaced 016] Explainable Action Form Assessment by Exploiting Multimodal Chain-of-Thoughts Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.15153](https://arxiv.org/pdf/2512.15153)**

> **作者:** Mengshi Qi; Yeteng Wu; Wulian Yun; Xianlin Zhang; Huadong Ma
>
...
>
---
#### [replaced 021] Self-supervised Feature Disentanglement and Augmentation Network for One-class Face Anti-spoofing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.22929](https://arxiv.org/pdf/2503.22929)**
...
>
> **备注:** This manuscript has been withdrawn by the authors. It reproduced the methodology of Gardinazzi et al., arXiv:2410.11042, without citation, and utilized code and data from the associated repository (this http URL) without disclosure or violate the MIT License. A revised future version with full attribution may be prepared. For any feedback, please contact Pengcheng Zheng
>
...
>
---
#### [replaced 024] BareBones: Benchmarking Zero-Shot Geometric Comprehension in VLMs
- **分类: cs.CV**
...
>
---
#### [replaced 025] When Preference Labels Fall Short: Aligning Diffusion Models from Real Data
- **分类: cs.CV**
...
>
---
#### [replaced 032] Can Language Models Learn to Listen?
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2308.10897](https://arxiv.org/pdf/2308.10897)**
...
>
---
#### [replaced 033] Active Video Perception: Iterative Evidence Seeking for Agentic Long Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 034] Beyond False Stability: High-Noise Drift Gating for Test-Time Adversarial Defenses in Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2606.03730](https://arxiv.org/pdf/2606.03730)**
...
> **备注:** Project page: this http URL
>
> **摘要:** We address the problem of generating a 3D-consistent, navigable environment that is spatially grounded: a simulation of a real location. Existing video generative models can produce a plausible sequence that is consistent with a text (T2V) or image (I2V) prompt. However, the capability to reconstruct the real world under arbitrary weather conditions and dynamic object configurations is essential for downstream applications including autonomous driving and robotics simulation. To this end, we present CityRAG, a video generative model that leverages large corpora of geo-registered data as context to ground generation to the physical scene, while maintaining learned priors for complex motion and appearance changes. CityRAG relies on temporally unaligned training data, which teaches the model to semantically disentangle the underlying scene from its transient attributes. Our experiments demonstrate that CityRAG can generate coherent minutes-long, physically grounded video sequences, maintain weather and lighting conditions over thousands of frames, achieve loop closure, and navigate complex trajectories to reconstruct real-world geography.
>
---
#### [replaced 037] BrainExplore: Large-Scale Discovery of Interpretable Visual Representations in the Human Brain
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08560](https://arxiv.org/pdf/2512.08560)**
...
>
---
#### [replaced 038] MAVEN A Multi-Agent Framework for Multicultural Text-to-Video Generation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 045] StereoPolicy: Improving Robotic Manipulation Policies via Stereo Perception
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于机器人操作任务，旨在解决单目视觉缺乏深度信息的问题。通过引入立体视觉，提升机器人在复杂场景中的几何推理能力。**
...
>
---
#### [replaced 046] ClothTransformer: Unified Latent-Space Transformers for Scalable Cloth Simulation
- **分类: cs.GR; cs.CV**
...
>
---
#### [replaced 051] PathWISE: Multi-Agent Cancer Pathway Triaging Ontology Learning from Clinical Flowcharts
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.25970](https://arxiv.org/pdf/2605.25970)**

> **作者:** Sofiat Abioye; Ufaq Khan; Shazad Ashraf; Mohammed Adil Butt; Andrew D. Beggs; Adam Byfield; Anusha Jose; Junaid Qadir; Muhammad Bilal
>
...
>
---
#### [replaced 052] Brain-CLIPLM: Semantic Compression for EEG-to-Text Decoding
...
>
---
#### [replaced 059] OmniEgo-R$^2$: A Routed Reasoning Framework for the 1st Cross-Domain EgoCross Challenge at CVPR 2026
- **分类: cs.CV**
...
>
---
#### [replaced 063] The Mirage of Performance Gains: Why Contrastive Decoding Fails to Mitigate Object Hallucinations in MLLMs?
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [replaced 064] HOLO: Homography-Guided Pose Estimator Network for Fine-Grained Visual Localization on SD Maps
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.02730](https://arxiv.org/pdf/2601.02730)**
...
>
---
#### [replaced 065] Toward Trustworthy Portrait Editing: Evaluation of Demographic Misrepresentation in I2I Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.16149](https://arxiv.org/pdf/2602.16149)**

> **作者:** Huichan Seo; Minki Hong; Sieun Choi; Jihie Kim; Jean Oh
>
> **备注:** 22 pages, 10 figures. Huichan Seo, Minki Hong and Sieun Choi contributed equally
>
...
>
---
#### [replaced 066] OpenWebRL: Demystifying Online Multi-turn Reinforcement Learning for Visual Web Agents
...
>
---
#### [replaced 067] Vision Hopfield Memory Networks
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **链接: [https://arxiv.org/pdf/2603.25157](https://arxiv.org/pdf/2603.25157)**

> **作者:** Jianfeng Wang; Amine M'Charrak; Luk Koska; Xiangtao Wang; Daniel Petriceanu; Ruizhi Wang; Michael Bumbar; Luca Pinchetti; Thomas Lukasiewicz
>
...
>
---
#### [replaced 071] VOLD: Reasoning Transfer from LLMs to Vision-Language Models via On-Policy Distillation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23497](https://arxiv.org/pdf/2510.23497)**
...
>
---
#### [replaced 074] SalsaAgent: A multimodal embodied language model for interactive dance generation
- **分类: cs.CV**
...
>
---
#### [replaced 075] EgoAdapt: A Multi-Scene Egocentric Adaptation Method for CVPR 2026 HD-EPIC VQA Challenge
- **分类: cs.CV**
