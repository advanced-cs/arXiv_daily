...
#### [new 001] AdaPlanBench: Evaluating Adaptive Planning in Large Language Model Agents under World and User Constraints
- **分类: cs.CL**

- **简介: 该论文属于语言模型规划任务，旨在解决在动态约束下进行自适应规划的问题。提出AdaPlanBench基准，评估LLM在逐步揭示的约束下是否能有效规划与重规划。**

- **链接: [https://arxiv.org/pdf/2606.05622](https://arxiv.org/pdf/2606.05622)**
...
>
---
#### [new 005] LatentSkill: From In-Context Textual Skills to In-Weight Latent Skills for LLM Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出LatentSkill，将文本技能转换为权重空间的LoRA适配器，解决LLM代理中技能注入效率低、暴露风险高的问题。**

- **链接: [https://arxiv.org/pdf/2606.06087](https://arxiv.org/pdf/2606.06087)**
...
>
---
#### [new 006] AURA: Intent-Directed Probing for Implicit-Need Surfacing in Situated LLM Agents
- **分类: cs.CL**

- **简介: 该论文提出AURA系统，用于情境化查询中隐含需求的识别。解决传统工具使用代理仅回答字面问题的问题，通过生成意图框架提升隐含需求覆盖。**

- **链接: [https://arxiv.org/pdf/2606.05557](https://arxiv.org/pdf/2606.05557)**

> **作者:** Yang Li; Jiaxiang Liu; Jiang Cai; Mingkun Xu
>
> **备注:** Submitted to EMNLP 2026. Code, simulator, and benchmark: this https URL
>
> **摘要:** A situated query like "where is Lin Wei?" often encodes more than its literal content: the user may also want to know whether Lin Wei is free, in a good mood, or worth interrupting now. Standard tool-use agents answer the literal question and stop. AURA inserts an inference step between scene perception and tool use that produces an IntentFrame: a structured estimate of the implicit need with a scalar gap score that controls per-query probe budget and tool selection. On a 100-query four-scene implicit-intent benchmark, AURA improves implicit-need coverage over ReAct-style probing (Delta = +0.07, p < 10^-6); three of four scenes are individually significant, the gain reproduces on a second backbone, and a prompt ablation attributes the lift to gap calibration rather than answer memorisation. On factual lookup the controller trades raw accuracy for 82% fewer probes and zero forbidden-tool violations on a privacy-sensitive slice; scope conditions are detailed in Limitations. Code, simulator, and benchmark are released at this https URL.
>
---
#### [new 007] ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在评估角色扮演语言代理是否随剧情发展保持角色一致性。研究提出ArcANE基准，测试模型在不同情节阶段的反应是否符合角色心理轨迹。**

- **链接: [https://arxiv.org/pdf/2606.05553](https://arxiv.org/pdf/2606.05553)**

> **作者:** Woojung Song; Nalim Kim; Sangjun Song; Chaewon Heo; Jongwon Lim; Yohan Jo
>
> **摘要:** Role-playing language agents (RPLAs) should play characters whose values and behavior evolve as the story progresses, not maintain a fixed persona. Existing benchmarks measure factual recall at a given chapter, not whether responses align with the character's psychological trajectory, especially in scenarios the source text never explores. We introduce ArcANE (Arc-Aware Narrative Evaluation), an automatically constructed benchmark spanning 17 novels and 80 principal characters. A Character Arc segments the narrative into phases along a psychological axis, and each probe poses the same scenario across phases, spanning both situations within the source text and situations beyond it. Across six models and six context modes, conditioning on the Character Arc tops every other context strategy on every model, and the gap is largest on scenarios outside the source text where retrieval has nothing to find. We further fine-tune open-weight models on the same data to obtain ArcANE-8B/32B, which widen the Arc advantage even more on scenarios outside the source text.
>
---
#### [new 008] The Generator-Eraser Paradox: Community Guidelines for Responsible LLM-Assisted Dialect Resource Creation
- **分类: cs.CL**

- **简介: 该论文探讨LLM在方言资源建设中的双刃剑效应，提出12条社区指南以平衡技术应用与语言多样性保护，属于自然语言处理中的伦理与文化保护任务。**

- **链接: [https://arxiv.org/pdf/2606.06004](https://arxiv.org/pdf/2606.06004)**
...
>
---
#### [new 009] ProSPy: A Profiling-Driven SQL-Python Agentic Framework for Enterprise Text-to-SQL
- **分类: cs.CL**

- **简介: 该论文提出ProSPy框架，解决企业级Text-to-SQL任务中的复杂问题，通过SQL与Python结合提升准确性和鲁棒性。**

- **链接: [https://arxiv.org/pdf/2606.05836](https://arxiv.org/pdf/2606.05836)**
...
>
---
#### [new 011] From Scoring to Explanations: Evaluating SHAP and LLM Rationales for Rubric-based Teaching Quality Assessment
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于教育评估任务，旨在解决自动评分模型解释性不足的问题。通过结合SHAP和LLM生成的解释，评估模型在评分任务中的表现与解释可靠性。**

- **链接: [https://arxiv.org/pdf/2606.05180](https://arxiv.org/pdf/2606.05180)**
...
>
---
#### [new 016] Towards Truly Multilingual ASR: Generalizing Code-Switching ASR to Unseen Language Pairs
- **分类: cs.CL; eess.AS**
...
>
---
#### [new 017] Human Adults and LLMs as Scientists: Who Benefits from Active Exploration?
- **分类: cs.CL**

- **简介: 该论文属于因果推理任务，研究成人与LLMs在主动探索中对合取与析取因果规则的识别能力。解决成人存在合取劣势的问题，通过实验对比人类与模型的表现。**

- **链接: [https://arxiv.org/pdf/2606.06464](https://arxiv.org/pdf/2606.06464)**
...
>
---
#### [new 029] LANTERN: Layered Archival and Temporal Episodic Retrieval Network for Long-Context LLM Conversations
- **分类: cs.CL; cs.IR**

- **简介: 该论文提出LANTERN，解决长对话中信息丢失问题，通过记忆层恢复关键细节，提升模型准确性。**

- **链接: [https://arxiv.org/pdf/2606.05182](https://arxiv.org/pdf/2606.05182)**

> **作者:** Rahul Subramani
>
> **摘要:** Large language models discard critical details when conversation history is compacted to fit within finite context windows. We present LANTERN (Layered Archival aNd Temporal Episodic Retrieval Network), a lightweight memory layer that proactively archives every conversation turn and restores relevant details after compaction via hybrid retrieval -- requiring zero LLM calls and adding fewer than 25ms of latency per turn. On 94 real multi-turn conversations (1,894 ground-truth facts, human-validated at kappa=0.81), LANTERN-Rerank recovers 78.3% of verifiable facts lost to compaction, significantly outperforming a faithful reimplementation of MemGPT's LLM-driven extraction and multi-query search pipeline (72.4%; Wilcoxon p<0.0001, 95% CI [+3.1, +8.6] pp, d=0.43) at a fraction of the inference cost. Even without the reranker, base LANTERN matches or exceeds this LLM-driven baseline (p=0.005) using zero LLM calls. When four production LLMs answer fact-bearing questions using LANTERN-restored context, accuracy improves by 8.4 percentage points on average (Wilcoxon p<0.05 for each model individually), demonstrating that the recovered context is useful across diverse model architectures. We release the full evaluation framework -- paired significance tests, failure analysis, fact-type stratification, and compaction robustness analysis -- to support reproducibility and future work.
>
---
#### [new 030] EGTR-Review: Efficient Evidence-Grounded Scientific Peer Review Generation via Multi-Agent Teacher Distillation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于科学同行评审生成任务，旨在解决LLM生成评论缺乏证据支持和溯源的问题。提出EGTR-Review框架，通过多智能体教师蒸馏提升评论的准确性和可追溯性。**

- **链接: [https://arxiv.org/pdf/2606.06025](https://arxiv.org/pdf/2606.06025)**
...
>
---
#### [new 031] Large Language Models are Perplexed by some Political Parties
- **分类: cs.CL**

- **简介: 论文研究LLMs在政治文本上的公平性问题，通过困惑度评估模型对不同政党的文本处理差异。任务属于模型公平性分析，解决LLMs是否存在政治偏见的问题，工作包括实验与数据分析。**

- **链接: [https://arxiv.org/pdf/2606.05937](https://arxiv.org/pdf/2606.05937)**
...
>
---
#### [new 032] The Tell-Tale Norm: $\ell_2$ Magnitude as a Signal for Reasoning Dynamics in Large Language Models
- **分类: cs.CL**

- **简介: 该论文研究LLM推理动态，提出l2范数作为推理强度的内在信号，设计三种基于l2范数的推理优化方法，提升模型推理性能。**

- **链接: [https://arxiv.org/pdf/2606.06188](https://arxiv.org/pdf/2606.06188)**
...
>
---
#### [new 033] MASF: A Multi-Model Adaptive Selection Framework for Abstractive Text summarization
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本摘要任务，旨在解决单一模型导致的摘要质量不稳定问题。通过集成多个模型并引入自适应选择机制，提升摘要的准确性和鲁棒性。**

- **链接: [https://arxiv.org/pdf/2606.05494](https://arxiv.org/pdf/2606.05494)**
...
>
---
#### [new 034] ComplexityMT: Benchmarking the Interaction Between Text Complexity and Machine Translation
- **分类: cs.CL**

- **简介: 该论文属于机器翻译任务，旨在研究文本复杂度与机器翻译之间的相互影响。通过CEFR等级评估翻译难度和文本复杂度变化，分析不同语言中的翻译效果。**

- **链接: [https://arxiv.org/pdf/2606.05421](https://arxiv.org/pdf/2606.05421)**
...
>
---
#### [new 035] Beyond Alignment: Value Diversity as a Collective Property in Multicultural Agent Systems
- **分类: cs.CL; cs.CY**

- **简介: 该论文属于多智能体系统研究，旨在解决文化多样性评估问题。提出价值多样性作为系统级评价指标，通过分析不同文化背景代理的响应差异，揭示现有系统在多样性上的不足。**

- **链接: [https://arxiv.org/pdf/2606.05985](https://arxiv.org/pdf/2606.05985)**
...
>
---
#### [new 046] Analysis of the Neglect-Zero Effect in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，研究LLMs是否表现出人类的“忽略零效应”认知偏差。通过结构启动实验，分析LLMs是否忽略空集导致的真命题，结果表明LLMs可能不存在此效应。**

- **链接: [https://arxiv.org/pdf/2606.05864](https://arxiv.org/pdf/2606.05864)**
...
>
---
#### [new 055] LLMs Can Leak Training Data But Do They Want To? A Propensity-Aware Evaluation of Memorization in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型隐私研究任务，旨在解决模型是否无意泄露训练数据的问题。通过提出PropMe框架和SimpleTrace工具，评估模型在不同场景下的记忆能力与倾向性，发现模型在非对抗场景下泄露较少。**

- **链接: [https://arxiv.org/pdf/2606.06286](https://arxiv.org/pdf/2606.06286)**
...
>
---
#### [new 056] CollabBench: Benchmarking and Unleashing Collaborative Ability of LLMs with Diverse Players via Proactive Engagement
- **分类: cs.CL; cs.AI; cs.CY; cs.LG**

- **简介: 该论文提出CollabBench，用于评估和训练LLMs在合作游戏中的协作能力。解决LLMs与人类有效协作的问题，通过模拟多样玩家行为和协同训练方法提升合作效果。**

- **链接: [https://arxiv.org/pdf/2606.05793](https://arxiv.org/pdf/2606.05793)**
...
>
---
#### [new 058] Reducing Hallucinations in Complex Question Answering using Simple Graph-based Retrieval-Augmented Generation (long version)
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于问答任务，旨在解决大语言模型的幻觉问题。通过引入轻量级图结构增强检索生成系统，提升答案的准确性和真实性。**

- **链接: [https://arxiv.org/pdf/2606.05901](https://arxiv.org/pdf/2606.05901)**
...
>
---
#### [new 067] EMBER: Efficient Memory via Budgeted Evidence Retention for Long-Horizon Agents
- **分类: cs.CL**

- **简介: 该论文属于长期记忆任务，解决在有限内存预算下如何保留关键证据的问题。工作是提出EMBER模型，通过学习策略高效保留源证据，提升检索效果。**

- **链接: [https://arxiv.org/pdf/2606.05894](https://arxiv.org/pdf/2606.05894)**
...
>
---
#### [new 072] Improving Answer Extraction in Context-based Question Answering Systems Using LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于问答系统任务，旨在解决复杂查询下答案提取不准确的问题。通过微调预训练模型，提升其上下文理解和答案生成能力。**

- **链接: [https://arxiv.org/pdf/2606.06197](https://arxiv.org/pdf/2606.06197)**
...
>
---
#### [new 075] Improving Heart-Focused Medical Question Answering in LLMs via Variance-Aware Rubric Rewards with GRPO
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗问答任务，旨在提升大模型在心脏医学领域的问答能力。针对数据隐私和效率问题，提出一种基于评分体系的GRPO优化方法，显著提升了模型准确率和F1值。**

- **链接: [https://arxiv.org/pdf/2606.05174](https://arxiv.org/pdf/2606.05174)**
...
>
---
#### [new 076] FiLM-Based Speaker Conditioning of a SpeechLLM for Pathological Speech Recognition
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [new 077] Revising Context, Shifting Simulated Stance: Auditing LLM-Based Stance Simulation in Online Discussions
- **分类: cs.CL; cs.MM; cs.SI**

- **简介: 该论文属于自然语言处理中的立场模拟任务，旨在评估大模型在不同语境下模拟用户立场的敏感性。通过对比文本与多模态策略，分析立场变化情况，揭示模型在在线观点动态模拟中的潜力与风险。**

- **链接: [https://arxiv.org/pdf/2606.06443](https://arxiv.org/pdf/2606.06443)**
...
>
---
#### [new 078] Using Large Language Models to Support High Volume Application Review for an Undergraduate Research Program
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决本科生科研项目申请材料评估效率低的问题。通过开发基于大语言模型的工具，自动评分并生成评语，提升评审效率。**

- **链接: [https://arxiv.org/pdf/2606.05564](https://arxiv.org/pdf/2606.05564)**
...
>
---
#### [new 082] Reinforcement Learning Elicits Contextual Learning of Unseen Language Translation
- **分类: cs.CL**

- **简介: 该论文属于语言翻译任务，旨在解决低资源语言翻译问题。通过强化学习，模型学习利用上下文语言知识，而非记忆特定语言，提升未见语言的翻译效果。**

- **链接: [https://arxiv.org/pdf/2606.06428](https://arxiv.org/pdf/2606.06428)**
...
>
---
#### [new 083] Better Literary Translation: A Multi-Aspect Data Generation and LLM Training Approach
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文学翻译任务，解决数据稀缺与表达平衡问题。通过多方面生成数据并优化模型训练，提升翻译质量。**

- **链接: [https://arxiv.org/pdf/2606.05924](https://arxiv.org/pdf/2606.05924)**
...
>
---
#### [new 088] ReverseEOL: Improving Training-free Text Embeddings via Text Reversal in Decoder-only LLMs
- **分类: cs.CL**

- **简介: 该论文属于文本嵌入任务，旨在解决decoder-only LLMs生成的嵌入表示不全面问题。通过引入文本反转机制，增强嵌入的表征能力。**

- **链接: [https://arxiv.org/pdf/2606.05858](https://arxiv.org/pdf/2606.05858)**
...
>
---
#### [new 103] Narrative Knowledge Weaver: Narrative-Centric Retrieval-Augmented Reasoning for Long-Form Text Understanding
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出Narrative Knowledge Weaver，用于长文本理解中的叙事推理任务。解决传统方法无法有效处理故事世界中复杂关系的问题，通过整合多种证据和结构进行精准推理。**

- **链接: [https://arxiv.org/pdf/2606.05724](https://arxiv.org/pdf/2606.05724)**
...
>
---
#### [new 105] OneReason Technical Report
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于推荐系统任务，旨在提升生成式推荐模型的推理能力。针对模型难以激活推理能力的问题，提出OneReason框架，增强感知与认知机制。**

- **链接: [https://arxiv.org/pdf/2606.06260](https://arxiv.org/pdf/2606.06260)**
...
>
---
#### [new 106] The Self-Correction Illusion: LLMs Correct Others but Not Themselves
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究LLM在不同角色标签下自我纠错能力的差异，属于自然语言处理中的错误修正任务。通过实验发现，模型更愿意纠正外部来源的错误而非自身生成的内容，提出一种无需训练的提示结构干预方法。**

- **链接: [https://arxiv.org/pdf/2606.05976](https://arxiv.org/pdf/2606.05976)**
...
>
---
#### [new 110] Almieyar-Oryx-BloomBench: A Bilingual Multimodal Benchmark for Cognitively Informed Evaluation of Vision-Language Models
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出BloomBench，一个用于评估视觉语言模型认知能力的双语多模态基准。旨在解决现有评估无法全面诊断模型推理能力的问题，通过系统化任务检测不同认知层次的表现。**

- **链接: [https://arxiv.org/pdf/2606.05531](https://arxiv.org/pdf/2606.05531)**
...
>
---
#### [new 114] Agents' Last Exam
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出ALE基准，用于评估AI代理在长期、经济价值高的真实任务中的表现。旨在解决AI成果与实际应用间的差距，通过持续更新的任务池促进AI的实际影响力。**

- **链接: [https://arxiv.org/pdf/2606.05405](https://arxiv.org/pdf/2606.05405)**
...
>
---
#### [new 118] Would you still call this Dax? Novel Visual References in VLMs and Humans
- **分类: cs.CV; cs.CL**

- **简介: 该论文研究视觉语言模型在遇到新视觉概念时的泛化能力，旨在解决模型与人类在处理新概念时的差异问题。通过构建NVRD数据集，对比模型与人类的表现。**

- **链接: [https://arxiv.org/pdf/2606.05409](https://arxiv.org/pdf/2606.05409)**

> **作者:** Ada Defne Tür; Gaurav Kamath; Joyce Chai; Siva Reddy; Benno Krojer
>
> **摘要:** Vision-language models (VLMs), like human learners, are frequently exposed to new visual concepts, but how they map novel visual references to language after exposure remains largely underexplored, particularly when those references contradict prior knowledge from pre-training. To study this, we present the Novel Visual References Dataset (NVRD): 19,176 images spanning 90 visual concepts across different levels of visual novelty, each with up to 20 increasingly perturbed versions of the original object to probe generalization. Unlike prior work on visual augmentations of familiar concepts, NVRD comprises entirely novel, open-ended stimuli constructed from scratch, mirroring how humans encounter genuinely new concepts. We evaluate 3 open- and 2 closed-source models alongside 2,400 human judgments for direct human-model comparison, and find that (i) models struggle to acquire novel concepts in-context when they contradict prior knowledge, and (ii) while models and humans show correlated sensitivity to visual perturbations, models significantly overgeneralize, extending learned labels to stimuli that humans reject. We contribute NVRD as a corpus and benchmark for research on visual concept learning in both humans and machines.
>
---
#### [new 119] Learning What to Forget: Improving LLM Unlearning via Learned Token-Level Importance
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于机器学习中的模型遗忘任务，旨在提升语言模型的遗忘效果。通过分析保留目标与遗忘损失的冲突，提出ATWU框架，实现无需外部监督的token级遗忘识别。**

- **链接: [https://arxiv.org/pdf/2606.06320](https://arxiv.org/pdf/2606.06320)**
...
>
---
#### [new 120] Continual Learning Bench: Evaluating Frontier AI Systems in Real-World Stateful Environments
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出CL-Bench基准，用于评估AI系统在真实世界状态环境中的持续学习能力。解决缺乏高质量基准的问题，通过多领域任务测试模型的学习效果。**

- **链接: [https://arxiv.org/pdf/2606.05661](https://arxiv.org/pdf/2606.05661)**
...
>
---
#### [new 129] MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出MLEvolve，解决机器学习算法自动发现中的长期优化问题，通过自进化框架提升搜索效率和泛化能力。**

- **链接: [https://arxiv.org/pdf/2606.06473](https://arxiv.org/pdf/2606.06473)**
...
>
---
#### [new 130] On Advantage Estimates for Max@K Policy Gradients
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，解决稀疏奖励下探索困难的问题。通过设计新的基线方法，提升max@K目标的策略梯度估计效果。**

- **链接: [https://arxiv.org/pdf/2606.06080](https://arxiv.org/pdf/2606.06080)**
...
>
---
#### [new 131] Unsupervised Skill Discovery for Agentic Data Analysis
- **分类: cs.AI; cs.CL; cs.LG; cs.MA**

- **简介: 该论文属于数据分析师代理技能发现任务，解决无监督下有效技能发现的问题。提出DataCOPE框架，通过验证器引导实现技能提炼，提升分析性能。**

- **链接: [https://arxiv.org/pdf/2606.06416](https://arxiv.org/pdf/2606.06416)**
...
>
---
#### [new 142] LeanMarathon: Toward Reliable AI Co-Mathematicians through Long-Horizon Lean Autoformalization
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于AI数学证明任务，旨在解决长周期自动形式化中的可靠性问题。提出LeanMarathon系统，通过多智能体协作确保数学理论的准确性和一致性。**

- **链接: [https://arxiv.org/pdf/2606.05400](https://arxiv.org/pdf/2606.05400)**
...
>
---
#### [new 143] Retrospective Harness Optimization: Improving LLM Agents via Self-Preference over Trajectory Rollouts
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出RHO方法，用于优化AI代理的技能组合，解决缺乏标注数据的问题。通过历史轨迹自监督训练，提升代理性能。**

- **链接: [https://arxiv.org/pdf/2606.05922](https://arxiv.org/pdf/2606.05922)**
...
>
---
#### [new 146] Asuka-Bench: Benchmarking Code Agents on Underspecified User Intent and Multi-Round Refinement
- **分类: cs.SE; cs.CL**

- **简介: 该论文提出Asuka-Bench，用于评估代码代理在用户意图不明确和多轮优化中的表现。解决真实场景下代码生成的挑战，通过多轮交互测试模型能力。**

- **链接: [https://arxiv.org/pdf/2606.05920](https://arxiv.org/pdf/2606.05920)**
...
>
---
#### [new 153] Harnessing Generalist Agents for Contextualized Time Series
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出TimeClaw框架，解决时间序列在复杂上下文中的建模问题。通过整合时间工具、能力进化和多模态记忆，提升时间推理能力。属于时间序列分析任务。**

- **链接: [https://arxiv.org/pdf/2606.05404](https://arxiv.org/pdf/2606.05404)**
...
>
---
#### [replaced 002] Linear Probes Detect Task Format, Not Reasoning Mode in Language Model Hidden States
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型可解释性研究，旨在解决线性探测是否能反映推理模式的问题。通过实验发现，探测结果主要受任务格式影响，而非计算结构。**

- **链接: [https://arxiv.org/pdf/2606.02907](https://arxiv.org/pdf/2606.02907)**
...
>
---
#### [replaced 003] CLFEC: A New Task for Unified Linguistic and Factual Error Correction in paragraph-level Chinese Professional Writing
- **分类: cs.CL**

- **简介: 该论文提出CLFEC任务，解决中文专业写作中语言与事实错误联合修正问题。构建多领域数据集，研究LLM修正方法，探索统一修正的有效性。**
...
>
---
#### [replaced 004] How Do Document Parsers Break? Auditing Structural Vulnerability in Document Intelligence
- **分类: cs.CL**

- **简介: 该论文属于文档智能任务，旨在解决DLA管道的结构脆弱性问题。通过提出ProSA框架，分析结构损失和故障传播，提升鲁棒性评估的准确性。**
...
>
---
#### [replaced 005] The Silent Thought: Modeling Internal Cognition in Full-Duplex Spoken Dialogue Models via Latent Reasoning
- **分类: eess.AS; cs.CL**
...
>
---
#### [replaced 006] Calibrated Surprise: An Information-Theoretic Account of Creative Quality
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理中的文本质量评估任务，旨在解决创意写作质量缺乏理论依据的问题。通过信息论提出“校准惊喜”作为评价标准，利用互信息衡量文本质量。**
...
>
---
#### [replaced 010] What Makes Two Language Models Think Alike?
- **分类: cs.CL**

- **简介: 该论文属于模型比较任务，旨在探究不同语言模型为何相似。通过分析模型层的神经活动与语言特征的关系，揭示模型相似性的驱动因素。**

- **链接: [https://arxiv.org/pdf/2406.12620](https://arxiv.org/pdf/2406.12620)**

> **作者:** Louis Jalouzot; Christophe Pallier; Emmanuel Chemla; Yair Lakretz
>
> **备注:** 25 pages, 13 figures
>
> **摘要:** Do architectural and training differences influence the way models represent and process language? Traditional similarity metrics tell us whether two models share a similar representational geometry, but they cannot explain why. Here, we propose a new, simple, approach to address this question. This approach maps neural activity in each model layer onto a set of interpretable linguistic features and quantifies how much each of them drives similarities and differences between models. We use this approach to compare 43 language models across 10 families, including decoder Transformers, State-Space Models, and Recurrent Neural Networks. We find that model-level similarity is driven most strongly by release date, a proxy for general LLM development, and model family, suggesting that linguistic signatures are not primarily shaped by scale or architecture class. Overall, our approach provides a way to link theoretically-motivated symbolic descriptions to neural representations and can readily be extended to other domains such as speech and vision, and to other neural systems such as biological brains.
>
---
#### [replaced 011] Filter, Then Reweight: Rethinking Optimization Granularity in On-Policy Distillation
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于语言模型优化任务，解决OPD中监督信号选择问题。提出FiRe-OPD方法，通过过滤和加权机制提升训练效果。**

- **链接: [https://arxiv.org/pdf/2606.02684](https://arxiv.org/pdf/2606.02684)**
...
>
---
#### [replaced 014] Correcting Prompt Dependence in LLM Benchmarks: A Bayesian Hierarchical Model with Embedding-Space Clustering
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，解决LLM基准评估中因提示相关性导致的性能误判问题，提出贝叶斯分层模型结合嵌入空间聚类，提升评估可靠性。**

- **链接: [https://arxiv.org/pdf/2510.05709](https://arxiv.org/pdf/2510.05709)**
...
>
---
#### [replaced 015] Topics as Proxies for Sociodemographics: How Conversational Context Affects LLM Answers
- **分类: cs.CL**

- **简介: 该论文属于人工智能伦理任务，研究LLM在高风险场景中因对话上下文导致的输出差异问题。通过分析对话主题与社会人口特征的关系，发现对话主题是主要影响因素。**
...
>
---
#### [replaced 016] Reasoning Models Don't Just Think Longer, They Move Differently
- **分类: cs.CL; cs.LG; stat.ML**

- **简介: 该论文研究推理模型在不同任务中的生成轨迹，解决如何区分模型计算时长与内部路径差异的问题。通过分析代码、数学和布尔满足问题，发现推理训练影响修正后的轨迹几何结构。**
...
>
---
#### [replaced 017] Ontology-Constrained Neural Reasoning in Enterprise Agentic Systems: A Neurosymbolic Architecture for Domain-Grounded AI Agents
- **分类: cs.AI; cs.CL; cs.SE**

- **简介: 该论文属于企业智能系统任务，解决LLM的幻觉、领域漂移和合规性问题。通过神经符号架构和本体约束推理，提升代理的准确性和一致性。**

- **链接: [https://arxiv.org/pdf/2604.00555](https://arxiv.org/pdf/2604.00555)**

> **作者:** Thanh Luong Tuan; Abhijit Sanyal
>
> **备注:** 24 pages, 6 tables, 6 figures, 1 algorithm, 65 references. Replication study: 1,800 runs (600 per model) across 5 regulated industries (3 English, 2 Vietnamese) and 3 LLMs (Claude Sonnet 4, Qwen 2.5 72B, Gemma 4 26B). v3 changes: deep-review trim from 34pp. Code and data: this https URL
>
...
>
---
#### [replaced 018] SUPERNOVA: Eliciting General Reasoning in LLMs with Reinforcement Learning on Natural Instructions
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出SUPERNOVA框架，解决RLVR在非STEM领域数据不足的问题，通过自然指令数据提升模型推理能力。**
...
>
> **备注:** 23 Pages; 2-column format; 10 figures
>
...
>
---
#### [replaced 019] Toward Culturally Aligned LLMs through Ontology-Guided Multi-Agent Reasoning
- **分类: cs.CL; cs.AI; cs.IR; cs.MA; cs.SI**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM文化对齐问题。通过构建文化本体和多智能体推理，提升模型输出的文化一致性与透明度。**

- **链接: [https://arxiv.org/pdf/2601.21700](https://arxiv.org/pdf/2601.21700)**

> **作者:** Wonduk Seo; Wonseok Choi; Junseo Koh; Juhyeon Lee; Hyunjin An; Minhyeong Yu; Jian Park; Qingshan Zhou; Seunghyun Lee; Yi Bu
>
> **备注:** Accepted by ICML 2026 Regular Track
>
> **摘要:** Large Language Models (LLMs) increasingly support culturally sensitive decision making, yet often exhibit misalignment due to skewed pretraining data and the absence of structured value representations. Existing methods can steer outputs, but often lack demographic grounding and treat values as independent, unstructured signals, reducing consistency and interpretability. We propose OG-MAR, an Ontology-Guided Multi-Agent Reasoning framework. OG-MAR summarizes respondent-specific values from the World Values Survey (WVS) and constructs a global cultural ontology by eliciting relations over a fixed taxonomy via competency questions. At inference time, it retrieves ontology-consistent relations and demographically similar profiles to instantiate multiple value-persona agents, whose outputs are synthesized by a judgment agent that enforces ontology consistency and demographic proximity. Experiments on regional social-survey benchmarks across four LLM backbones show that OG-MAR improves cultural alignment and robustness over competitive baselines, while producing more transparent reasoning traces.
>
---
#### [replaced 020] From Out-of-Distribution Detection to Hallucination Detection: A Geometric View
- **分类: cs.AI; cs.CL**
...
>
---
#### [replaced 027] Ask Only When Needed: Proactive Retrieval from Memory and Skills for Experience-Driven Lifelong Agents
- **分类: cs.CL**

- **简介: 该论文提出ProactAgent，解决在线终身学习代理在长期任务中何时检索经验的问题。通过主动检索和策略优化，提升任务成功率和效率。**
...
>
---
#### [replaced 028] Pitfalls of Evaluating Language Models with Open Benchmarks
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的模型评估任务，旨在解决开放基准测试中的数据泄露问题。通过构建作弊模型验证风险，并提出防护策略。**

- **链接: [https://arxiv.org/pdf/2507.00460](https://arxiv.org/pdf/2507.00460)**

> **作者:** Md. Najib Hasan; Md Mahadi Hassan Sibat; Mohammad Fakhruddin Babar; Souvika Sarkar; Monowar Hasan; Santu Karmaker
>
> **备注:** After further review, we found that the core contribution and methodology substantially overlap with previously published work. As a result, the manuscript does not provide a sufficiently distinct or original contribution in its current form. To avoid repetition in the literature and prevent possible confusion for readers, we believe withdrawal is the most appropriate action
>
...
>
---
#### [replaced 029] Maximizing Mutual Information Between Prompt and Response Improves LLM Performance With No Additional Data
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理领域，旨在提升大语言模型性能。针对依赖外部数据的问题，提出MIPO方法，通过最大化提示与响应的互信息实现模型自优化，无需额外数据。**
...
>
---
#### [replaced 032] Argument Collapse: LLMs Flatten Long-Form Public Debate
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究了大语言模型在生成公共辩论文章时出现的“论点坍缩”现象，分析其导致论点趋同的问题。任务属于自然语言生成领域，旨在探讨LLMs在公共辩论中的表现及局限性。**
...
>
---
#### [replaced 033] ChartAttack: Testing the Vulnerability of LLMs to Malicious Prompting in Chart Generation
- **分类: cs.CL**

- **简介: 该论文属于多模态语言模型安全任务，旨在检测并评估LLMs在图表生成中的漏洞。通过提出ChartAttack框架和AttackViz数据集，验证了恶意提示对图表解释的误导性影响，并探索了提升模型鲁棒性的方法。**
...
>
---
#### [replaced 036] When Gradients Collide: Failure Modes of Multi-Objective Prompt Optimization for LLM Judges
- **分类: cs.CL; cs.AI; cs.LG; cs.MA; cs.SE**

- **简介: 该论文研究多目标提示优化中的失败模式，针对LLM法官的定制化问题，探讨文本梯度方法在多个评价标准下的优化挑战。**
...
>
---
#### [replaced 038] Scaling few-shot spoken word classification with generative meta-continual learning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语音分类任务，解决大规模少样本语音词识别问题。通过GeMCL算法实现高效学习，提升模型在1000类中的泛化能力。**
...
>
---
#### [replaced 039] Rethinking Meeting Effectiveness: A Benchmark and Framework for Temporal Fine-grained Automatic Meeting Effectiveness Evaluation
- **分类: cs.CL**

- **简介: 该论文属于会议有效性评估任务，旨在解决传统方法无法捕捉讨论动态的问题。提出基于时间细粒度的评估框架，并构建了相关数据集与自动评估系统。**
...
>
---
#### [replaced 042] Active Video Perception: Iterative Evidence Seeking for Agentic Long Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于长视频理解任务，旨在解决视频中稀疏线索难以提取的问题。提出AVP框架，通过迭代感知机制高效获取相关证据，提升准确率并减少计算资源消耗。**

- **链接: [https://arxiv.org/pdf/2512.05774](https://arxiv.org/pdf/2512.05774)**
...
>
---
#### [replaced 043] SenseJudge: Human-Centric Preference-Driven Judgment Framework
- **分类: cs.CL**

- **简介: 该论文提出SenseJudge框架，解决LLM判断中忽视用户偏好和适应性差的问题，通过定制化和真实数据提升判断效果。**

- **链接: [https://arxiv.org/pdf/2606.03189](https://arxiv.org/pdf/2606.03189)**
...
>
---
#### [replaced 044] Dynamic Coordination Strategy Selection for Enterprise Multi-Agent Systems
- **分类: cs.MA; cs.AI; cs.CL**

- **简介: 该论文属于企业多智能体系统协调策略研究，旨在解决如何动态选择协调策略的问题。通过实验评估不同策略在多种任务中的表现，提出动态路由作为默认方案。**

- **链接: [https://arxiv.org/pdf/2606.00804](https://arxiv.org/pdf/2606.00804)**

> **作者:** Thanh Luong Tuan
>
> **备注:** 13 pages, 4 appendix. Code and data: this https URL
>
...
>
---
#### [replaced 045] Macro: Enhancing Multilingual Counterfactual Explanations through Alignment-as-Preference Optimization
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的可解释性任务，旨在解决多语言反事实解释生成中有效性和最小性的平衡问题。通过引入Macro框架，利用偏好优化提升解释质量。**
...
>
---
#### [replaced 046] Do MLLMs Capture How Interfaces Guide User Behavior? A Benchmark for Multimodal UI/UX Design Understanding
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于UI/UX设计理解任务，旨在解决MLLMs对界面如何影响用户行为理解不足的问题。工作中构建了WiserUI-Bench基准，并验证模型在预测有效界面和解释设计效果上的局限性。**

- **链接: [https://arxiv.org/pdf/2505.05026](https://arxiv.org/pdf/2505.05026)**

> **作者:** Jaehyun Jeon; Min Soo Kim; Jang Han Yoon; Sumin Shim; Yejin Choi; Hanbin Kim; Dae Hyun Kim; Youngjae Yu
>
> **备注:** ACL 2026 Main. Our code and dataset: this https URL
>
...
>
---
#### [replaced 047] Explainability of Large Language Models: Opportunities and Challenges toward Generating Trustworthy Explanations
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的可解释性研究，旨在解决大语言模型预测机制不透明和产生错误的问题。工作包括综述解释方法、实验分析医疗与自动驾驶领域，并探讨信任影响。**

- **链接: [https://arxiv.org/pdf/2510.17256](https://arxiv.org/pdf/2510.17256)**
...
>
---
#### [replaced 050] Towards Generalization of Block Attention via Automatic Segmentation and Block Distillation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决块注意力机制在长文本中的应用难题。通过自动分割和块蒸馏方法，提升块注意力的性能与效率。**
...
>
---
#### [replaced 051] CLASH: Evaluating Language Models on Judging High-Stakes Dilemmas from Multiple Perspectives
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于价值决策研究任务，旨在解决AI在高风险困境中的多视角判断问题。构建了CLASH数据集，评估语言模型在复杂价值冲突中的表现。**

- **链接: [https://arxiv.org/pdf/2504.10823](https://arxiv.org/pdf/2504.10823)**
...
>
---
#### [replaced 054] InfoDensity: Rewarding Information-Dense Traces for Efficient Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，解决大模型推理冗余问题。通过分析推理轨迹的熵值，提出InfoDensity框架，提升推理效率与质量。**

- **链接: [https://arxiv.org/pdf/2603.17310](https://arxiv.org/pdf/2603.17310)**
...
>
---
#### [replaced 057] AgentDisCo: Towards Disentanglement and Collaboration in Open-ended Deep Research Agents
- **分类: cs.IR; cs.CL; cs.MA; cs.MM**

- **简介: 该论文提出AgentDisCo，解决深度研究中的信息探索与利用问题，通过生成器与评论者协同工作，提升研究效率与质量。**
...
>
---
#### [replaced 058] Divide-Prompt-Refine: a Training-Free, Structure-Aware Framework for Biomedical Abstract Generation
- **分类: cs.CL**

- **简介: 该论文属于生物医学摘要生成任务，解决无摘要文章的摘要生成问题。提出DPR-BAG框架，无需训练即可生成结构化、事实一致的摘要。**
...
>
---
#### [replaced 059] Brain-CLIPLM: Semantic Compression for EEG-to-Text Decoding
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文属于EEG-to-text解码任务，旨在解决低信噪比下自然语言恢复困难的问题。提出Brain-CLIPLM框架，通过语义压缩和锚点引导实现更准确的句子重建。**
...
>
---
#### [replaced 062] Ask or Assume? Uncertainty-Aware Clarification-Seeking in Coding Agents
- **分类: cs.CL**

- **简介: 该论文属于代码生成任务，解决LLM在指令不明确时无法有效澄清的问题。通过多智能体框架提升模型的不确定性感知与提问能力，提高任务解决率。**

- **链接: [https://arxiv.org/pdf/2603.26233](https://arxiv.org/pdf/2603.26233)**

> **作者:** Nicholas Edwards; Sebastian Schuster
>
> **备注:** 18 pages, 7 figures; added experiments evaluating open-weight models (Kimi K2.6), expanded related work, and included dataset validation details
>
...
>
---
#### [replaced 063] Learning Self-Correction in Vision-Language Models via Rollout Augmentation
- **分类: cs.CV; cs.CL; cs.LG**

- **简介: 该论文属于视觉语言模型的推理任务，旨在解决自纠正学习困难的问题。通过提出Octopus框架，增强自纠正能力，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.08503](https://arxiv.org/pdf/2602.08503)**
...
>
---
#### [replaced 064] Do Transformers Need Three Projections? Systematic Study of QKV Variants
- **分类: cs.LG; cs.AI; cs.CL; cs.PF**

- **简介: 该论文研究Transformer中QKV投影的作用，探讨投影共享对模型性能的影响，旨在优化内存使用，提升边缘设备推理效率。**
...
>
---
#### [replaced 065] The Mirage of Performance Gains: Why Contrastive Decoding Fails to Mitigate Object Hallucinations in MLLMs?
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文属于多模态大语言模型任务，旨在解决对象幻觉问题。研究指出对比解码策略无法有效缓解幻觉，其性能提升源于误导因素。**

- **链接: [https://arxiv.org/pdf/2504.10020](https://arxiv.org/pdf/2504.10020)**
...
>
---
#### [replaced 066] Activation-Informed Pareto-Guided Low-Rank Compression for Efficient LLM/VLM
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型压缩任务，旨在解决LLM/VLM部署中的内存和计算挑战。提出一种基于激活信息的低秩压缩框架，通过多目标优化提升压缩效率与精度。**

- **链接: [https://arxiv.org/pdf/2510.05544](https://arxiv.org/pdf/2510.05544)**
...
>
---
#### [replaced 067] OpenWebRL: Demystifying Online Multi-turn Reinforcement Learning for Visual Web Agents
...
>
---
#### [replaced 068] Converted, Not Equivalent: Benchmarking Codebase Conversion via Observational Equivalence
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于代码库转换任务，旨在解决转换后代码语义不符的问题。通过构建T2J-Bench基准，从接口、数值和行为三方面评估转换质量，揭示了现有系统自检机制的不足。**
...
>
---
#### [replaced 069] A Survey on Diffusion Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 本文综述扩散语言模型（DLM），探讨其在自然语言处理中的应用。旨在解决传统自回归模型的效率与上下文捕捉问题，分析DLM的原理、技术及优化方法。**

- **链接: [https://arxiv.org/pdf/2508.10875](https://arxiv.org/pdf/2508.10875)**
...
>
---
#### [replaced 070] Semi-Offline Reinforcement Learning for Optimized Text Generation
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决在线与离线RL之间探索与成本的平衡问题。提出半离线RL框架，优化文本生成效果。**

- **链接: [https://arxiv.org/pdf/2306.09712](https://arxiv.org/pdf/2306.09712)**

> **作者:** Changyu Chen; Xiting Wang; Yiqiao Jin; Victor Ye Dong; Li Dong; Jie Cao; Yi Liu; Rui Yan
>
> **备注:** In Proceedings of the 40th International Conference on Machine Learning (ICML 2023)
>
> **摘要:** In reinforcement learning (RL), there are two major settings for interacting with the environment: online and offline. Online methods explore the environment at significant time cost, and offline methods efficiently obtain reward signals by sacrificing exploration capability. We propose semi-offline RL, a novel paradigm that smoothly transits from offline to online settings, balances exploration capability and training cost, and provides a theoretical foundation for comparing different RL settings. Based on the semi-offline formulation, we present the RL setting that is optimal in terms of optimization cost, asymptotic error, and overfitting error bound. Extensive experiments show that our semi-offline approach is efficient and yields comparable or often better performance compared with state-of-the-art methods.
>
---
#### [replaced 071] The Cylindrical Representation Hypothesis for Language Model Steering
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型控制（ steering）不稳定的问题。提出Cylindrical Representation Hypothesis，解释概念激活的不确定性。**

- **链接: [https://arxiv.org/pdf/2605.01844](https://arxiv.org/pdf/2605.01844)**
...
>
---
#### [replaced 073] IatroBench: Pre-Registered Evidence of Iatrogenic Harm from AI Safety Measures
- **分类: cs.AI; cs.CL; cs.CY; cs.LG**

- **简介: 该论文属于AI安全评估任务，旨在检测AI在医疗场景中因安全措施导致的伤害差异。通过实验发现模型对医患身份的响应存在偏差，揭示了AI系统在信息披露上的潜在问题。**
