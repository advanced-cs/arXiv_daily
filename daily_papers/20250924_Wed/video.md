...
- **简介: 该论文针对人脸伪造检测任务，旨在解决伪造技术快速演进导致检测模型易过时的问题。提出DevFD方法，采用MoE架构结合LoRA子空间，通过Real-LoRA和正交Fake-LoRAs实现持续学习，提升模型适应新伪造类型的能力并防止遗忘。**
...
- **简介: 该论文提出Hyper-Bagel，一个统一的加速框架，用于多模态理解和生成任务。针对多模态内容处理中的计算开销问题，采用分治策略和多阶段蒸馏，实现了显著的速度提升，同时保持高质量输出。**
...
- **简介: 该论文属于AI与遥感应用任务，旨在解决小岛屿国家建筑结构数据缺失问题。通过对比不同AI模型，从卫星图像中自动推断屋顶属性，提升城市韧性。**
...
- **简介: 该论文提出MLF-4DRCNet，用于自动驾驶中的3D目标检测任务。针对4D雷达点云稀疏且噪声大的问题，通过点、场景和候选框三级多模态融合，结合雷达与相机信息，提升了检测性能，达到与LiDAR相当的效果。**
...
- **简介: 该论文提出GeoRemover，针对图像编辑中的对象移除任务，旨在解决现有方法无法有效去除目标物体及其因果视觉伪影（如阴影和反射）的问题。作者设计了一个几何感知的两阶段框架，分别处理几何移除和外观渲染，通过引入偏好驱动的目标函数提升效果，并在两个基准上取得了SOTA性能。**
...
- **简介: 该论文提出TinyEcoWeedNet，用于实时无人机杂草检测。针对边缘设备资源受限的问题，采用结构化剪枝、量化训练和TensorRT加速，显著减小模型体积并提升推理速度，在保证精度的同时实现高效部署。**
...
- **链接: [http://arxiv.org/pdf/2509.18715v1](http://arxiv.org/pdf/2509.18715v1)**
...
- **简介: 该论文提出FixingGS，针对3D高斯泼溅（3DGS）在稀疏视角下重建质量差的问题，通过无训练的得分蒸馏方法提升多视角一致性与细节完整性，有效去除伪影并优化欠约束区域。**
...
- **简介: 该论文针对LSVOS Challenge中的MOSEv2任务，研究复杂半监督视频目标分割问题。通过改进SeC框架，探索其长期记忆与概念感知记忆能力，有效应对遮挡与干扰物挑战，最终在测试集上取得39.89%的JF分数，排名榜首。**
...
- **简介: 该论文提出MoCrop，一种无需训练的运动感知自适应裁剪模块，用于高效视频动作识别。利用H.264中的运动矢量定位运动密集区域，在压缩域中实现高精度、低计算成本的裁剪，适用于多种模型，提升效率与泛化性。**
...
- **简介: 该论文综述了计算机视觉中的可解释人工智能（xAI）方法，针对深度学习模型的“黑箱”问题，介绍了四种代表性技术：显著图、概念瓶颈模型、基于原型的方法和混合方法，分析其机制与优缺点，为未来研究提供指导。**
...
- **简介: 该论文提出YOLO-LAN，一种基于YOLO的结肠镜息肉检测方法，旨在提升息肉检测精度。通过优化损失函数（M2IoU）、数据增强和负样本训练，实现高mAP表现，在Kvasir-seg和NeoPolyp数据集上优于现有方法，具有临床应用潜力。**
...
- **链接: [http://arxiv.org/pdf/2509.18190v1](http://arxiv.org/pdf/2509.18190v1)**
...
- **简介: 该论文提出BridgeSplat，用于可变形术中导航任务。通过将CT数据与实时3D重建结合，解决手术视频与体积数据对齐问题。方法利用高斯点和网格形变联合优化，实现CT的动态更新。**
...
- **简介: 该论文提出了V-SenseDrive，一个保护隐私的多模态驾驶行为数据集，用于提升道路安全与驾驶行为建模。针对发展中国家数据不足和隐私问题，采集了巴基斯坦真实道路环境下的视频与传感器数据，实现正常、激进和风险驾驶行为的分类研究。**
...
- **简介: 该论文研究少样本类增量学习（C2FSCIL）任务，旨在提升模型在少量样本下对粗细粒度类别的识别能力。提出将特征提取器嵌入双曲空间，并引入双曲对比损失和全连接层，结合最大熵分布生成增强特征，有效提升分类性能。**
...
- **简介: 该论文聚焦肺栓塞（PE）分割任务，旨在评估不同模型在CTPA图像中的性能。作者构建了一个490例标注数据集，系统比较了9种CNN和ViT架构，并分析了预训练与分割效果的关系，发现3D U-Net结合ResNet表现最佳，同时揭示了远端栓塞分割的挑战。**
...
- **简介: 该论文提出VolSplat，针对3D高斯溅射（3DGS）在新视角合成中的局限性，如视图依赖和对齐误差。通过引入体素对齐的高斯预测方法，替代传统像素对齐方式，提升了重建的几何一致性和渲染质量，实现了更鲁棒、可扩展的多视角3D重建框架。**
...
- **链接: [http://arxiv.org/pdf/2509.18683v1](http://arxiv.org/pdf/2509.18683v1)**
...
- **简介: 该论文提出Lavida-O，一种统一的多模态掩码扩散模型，用于图像理解和生成。相比现有方法，它支持对象定位、高分辨率图像合成等新能力，并通过规划和自反思提升生成效果，实现了多项任务的SOTA性能。**
...
- **简介: 该论文针对人体运动理解中的时空热图压缩问题，提出一种对抗优化的VQ-GAN框架，结合密集运动标记化，有效减少重建伪影并提升运动表示效率。**
...
- **简介: 该论文提出Prima，首个基于大规模临床MRI数据的神经影像视觉语言模型。旨在缓解医疗系统压力，提升诊断效率与公平性。通过22万例MRI训练，在30K测试中实现92.0的平均AUC，支持可解释诊断与优先级排序。**
...
- **简介: 该论文聚焦音频-视觉分割（AVS）任务，针对音频与视觉模态在高频域的矛盾问题，提出FAVS框架，包含FDED和SCMC两个模块，通过频域分解与重构提升多模态一致性与性能。**
...
>
---
#### [new 065] Citrus-V: Advancing Medical Foundation Models with Unified Medical Image Grounding for Clinical Reasoning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 066] HyPSAM: Hybrid Prompt-driven Segment Anything Model for RGB-Thermal Salient Object Detection
- **分类: cs.CV**

- **简介: 该论文提出HyPSAM，用于RGB-热成像显著目标检测（RGB-T SOD）。针对多模态特征融合不足和数据稀缺问题，设计了动态融合网络DFNet和优化网络P2RNet，结合SAM实现高精度检测与边界优化。**

- **链接: [http://arxiv.org/pdf/2509.18738v1](http://arxiv.org/pdf/2509.18738v1)**
...
>
---
#### [new 067] SmartWilds: Multimodal Wildlife Monitoring Dataset
- **分类: cs.CV**

- **简介: 论文提出SmartWilds，一个多模态野生动物监测数据集，整合无人机图像、相机陷阱和生物声学数据，用于环境监测与物种保护研究，旨在推动多模态AI在生态保护中的应用。**

- **链接: [http://arxiv.org/pdf/2509.18894v1](http://arxiv.org/pdf/2509.18894v1)**
...
>
---
#### [new 084] The Photographer Eye: Teaching Multimodal Large Language Models to See and Critique like Photographers
- **分类: cs.CV**

- **简介: 该论文聚焦于提升多模态大语言模型（MLLMs）的审美视觉理解能力。针对现有模型在图像美学分析中的不足，作者构建了专业数据集PhotoCritique，提出模型PhotoEye和基准PhotoBench，以实现更专业的摄影美学理解和评价。**

- **链接: [http://arxiv.org/pdf/2509.18582v1](http://arxiv.org/pdf/2509.18582v1)**
...
>
---
#### [new 085] RSVG-ZeroOV: Exploring a Training-Free Framework for Zero-Shot Open-Vocabulary Visual Grounding in Remote Sensing Images
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出RSVG-ZeroOV，一种无需训练的框架，用于遥感图像的零样本开放词汇视觉定位。通过冻结的基础模型，结合跨注意力、扩散模型和注意力进化模块，实现高效、可扩展的解决方案，解决了现有方法依赖高质量数据和微调的问题。**

- **链接: [http://arxiv.org/pdf/2509.18711v1](http://arxiv.org/pdf/2509.18711v1)**
...
>
---
#### [new 110] Weakly Supervised Food Image Segmentation using Vision Transformers and Segment Anything Model
- **分类: cs.CV**

- **简介: 该论文提出一种弱监督食品图像分割方法，结合ViT的注意力机制和SAM的零样本能力，利用CAM生成提示生成分割掩码。在无需像素标注的情况下，在FoodSeg103数据集上实现mIoU 0.54，旨在加速食品图像标注任务。**

- **链接: [http://arxiv.org/pdf/2509.19028v1](http://arxiv.org/pdf/2509.19028v1)**
...
>
---
#### [new 111] A Single Image Is All You Need: Zero-Shot Anomaly Localization Without Training Data
- **分类: cs.CV; cs.AI; cs.LG; eess.IV; 62H35, 68T07, 62M40, 68T45; I.2.6; I.2.10; I.4.6; I.4.8; I.5.1; I.5.4**

- **简介: 该论文提出SSDnet，用于零样本图像异常定位任务。无需训练数据，通过单张图像自重建学习图像先验，利用感知损失和数据增强方法实现鲁棒异常检测，在多个数据集上优于现有方法。**

- **链接: [http://arxiv.org/pdf/2509.18354v1](http://arxiv.org/pdf/2509.18354v1)**
...
>
---
#### [new 113] RS3DBench: A Comprehensive Benchmark for 3D Spatial Perception in Remote Sensing
- **分类: cs.CV**

- **简介: 该论文提出RS3DBench，一个用于遥感图像3D空间感知的综合基准。针对现有数据缺乏深度信息和对齐问题，构建了54,951对配准的遥感图像与深度图，并引入基于稳定扩散的深度估计模型，推动地理AI发展。**

- **链接: [http://arxiv.org/pdf/2509.18897v1](http://arxiv.org/pdf/2509.18897v1)**
...
>
---
#### [new 116] A Kernel Space-based Multidimensional Sparse Model for Dynamic PET Image Denoising
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对动态PET图像去噪任务，提出基于核空间的多维稀疏模型（KMDS-Net），利用帧间空间相关性和帧内结构一致性，结合神经网络实现自适应参数优化，提升了短时帧图像质量。**

- **链接: [http://arxiv.org/pdf/2509.18801v1](http://arxiv.org/pdf/2509.18801v1)**
...
>
---
#### [new 123] HadaSmileNet: Hadamard fusion of handcrafted and deep-learning features for enhancing facial emotion recognition of genuine smiles
- **分类: cs.CV**

- **简介: 该论文提出HadaSmileNet，用于提升真实微笑的面部情感识别。针对深度学习与手工特征融合效率低的问题，采用Hadamard乘法直接融合Transformer特征和D-Marker特征，实现高效且准确的识别，在多个数据集上取得最优性能。**

- **链接: [http://arxiv.org/pdf/2509.18550v1](http://arxiv.org/pdf/2509.18550v1)**
...
>
---
#### [new 125] Human-Interpretable Uncertainty Explanations for Point Cloud Registration
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 126] Does Embodiment Matter to Biomechanics and Function? A Comparative Analysis of Head-Mounted and Hand-Held Assistive Devices for Individuals with Blindness and Low Vision
- **分类: cs.HC; cs.CV; K.4.2; H.5.2; I.3.6**

- **简介: 该论文研究了盲人及低视力者使用头戴式与手持式视觉辅助设备（Seeing AI）在日常任务中的功能与生物力学差异。通过运动捕捉分析，比较了两种设备在任务时间、成功率及身体动作等方面的性能，旨在优化辅助技术设计以提升用户体验和物理可持续性。**

- **链接: [http://arxiv.org/pdf/2509.18391v1](http://arxiv.org/pdf/2509.18391v1)**
...
>
---
#### [new 134] Text Slider: Efficient and Plug-and-Play Continuous Concept Control for Image/Video Synthesis via LoRA Adapters
- **分类: cs.GR; cs.AI; cs.CV; cs.LG; cs.MM**

- **简介: 该论文提出Text Slider，一种基于LoRA的轻量级框架，用于图像/视频生成中的连续概念控制。旨在解决现有方法训练耗时、内存大且难以适配不同模型的问题，实现了高效、灵活的多概念控制。**

- **链接: [http://arxiv.org/pdf/2509.18831v1](http://arxiv.org/pdf/2509.18831v1)**
...
>
---
#### [new 135] Towards Robust LiDAR Localization: Deep Learning-based Uncertainty Estimation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 136] Prompt Optimization Meets Subspace Representation Learning for Few-shot Out-of-Distribution Detection
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文聚焦于少样本下分布外（OOD）检测任务，旨在提升AI系统在开放环境中的可靠性。针对现有方法依赖softmax概率的不足，提出结合上下文优化与子空间学习的新框架，利用特征嵌入增强ID-OOD可分性，实现高性能检测。**

- **链接: [http://arxiv.org/pdf/2509.18111v1](http://arxiv.org/pdf/2509.18111v1)**
...
>
---
#### [new 143] Semantic-Aware Particle Filter for Reliable Vineyard Robot Localisation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 144] Localized PCA-Net Neural Operators for Scalable Solution Reconstruction of Elliptic PDEs
- **分类: cs.LG; cs.CV**

- **简介: 该论文针对椭圆型PDE求解中的高维解场计算开销问题，提出基于局部PCA-Net的神经算子框架。通过将解场分块处理、局部降维并结合CNN优化，显著降低计算复杂度，提升效率，同时保持高精度。**

- **链接: [http://arxiv.org/pdf/2509.18110v1](http://arxiv.org/pdf/2509.18110v1)**
...
>
---
#### [new 145] MiniCPM-V 4.5: Cooking Efficient MLLMs via Architecture, Data, and Training Recipe
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出MiniCPM-V 4.5，针对多模态大模型（MLLMs）的训练与推理效率瓶颈问题，通过优化架构、数据策略和训练方法，实现了高效且高性能的8B参数模型，在多个基准测试中超越了更大规模模型。**

- **链接: [http://arxiv.org/pdf/2509.18154v1](http://arxiv.org/pdf/2509.18154v1)**
...
>
> **备注:** Project Website: https://github.com/OpenBMB/MiniCPM-V
>
> **摘要:** Multimodal Large Language Models (MLLMs) are undergoing rapid progress and represent the frontier of AI development. However, their training and inference efficiency have emerged as a core bottleneck in making MLLMs more accessible and scalable. To address the challenges, we present MiniCPM-V 4.5, an 8B parameter model designed for high efficiency and strong performance. We introduce three core improvements in model architecture, data strategy and training method: a unified 3D-Resampler model architecture for highly compact encoding over images and videos, a unified learning paradigm for document knowledge and text recognition without heavy data engineering, and a hybrid reinforcement learning strategy for proficiency in both short and long reasoning modes. Comprehensive experimental results in OpenCompass evaluation show that MiniCPM-V 4.5 surpasses widely used proprietary models such as GPT-4o-latest, and significantly larger open-source models such as Qwen2.5-VL 72B. Notably, the strong performance is achieved with remarkable efficiency. For example, on the widely adopted VideoMME benchmark, MiniCPM-V 4.5 achieves state-of-the-art performance among models under 30B size, using just 46.7\% GPU memory cost and 8.7\% inference time of Qwen2.5-VL 7B.
>
---
#### [new 146] Category-Level Object Shape and Pose Estimation in Less Than a Millisecond
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 003] LaMP-Cap: Personalized Figure Caption Generation With Multimodal Figure Profiles
...
>
---
#### [replaced 004] DWTGS: Rethinking Frequency Regularization for Sparse-view 3D Gaussian Splatting
- **分类: cs.CV; eess.IV; eess.SP**
...
>
---
#### [replaced 005] Is Pre-training Truly Better Than Meta-Learning?
...
>
---
#### [replaced 006] Clothing agnostic Pre-inpainting Virtual Try-ON
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17654v2](http://arxiv.org/pdf/2509.17654v2)**
...
>
---
#### [replaced 007] LaV-CoT: Language-Aware Visual CoT with Multi-Aspect Reward Optimization for Real-World Multilingual VQA
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.10026v2](http://arxiv.org/pdf/2509.10026v2)**

> **作者:** Jing Huang; Zhiya Tan; Shutao Gong; Fanwei Zeng; Joey Tianyi Zhou; Jianshu Li
>
...
>
> **备注:** NeurIPS2025 Spotlight. 12 Pages, 9 figures
>
...
>
---
#### [replaced 010] Split Matching for Inductive Zero-shot Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.05023v3](http://arxiv.org/pdf/2505.05023v3)**
...
>
---
#### [replaced 011] Foresight: Adaptive Layer Reuse for Accelerated and High-Quality Text-to-Video Generation
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.00329v2](http://arxiv.org/pdf/2506.00329v2)**
...
>
---
#### [replaced 014] Visual Instruction Pretraining for Domain-Specific Foundation Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17562v2](http://arxiv.org/pdf/2509.17562v2)**
...
>
---
#### [replaced 015] Towards Interpretable and Efficient Attention: Compressing All by Contracting a Few
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16875v2](http://arxiv.org/pdf/2509.16875v2)**
...
>
---
#### [replaced 016] L2M-Reg: Building-level Uncertainty-aware Registration of Outdoor LiDAR Point Clouds and Semantic 3D City Models
- **分类: cs.CV; cs.RO; eess.IV**
...
>
---
#### [replaced 017] CrossEarth: Geospatial Vision Foundation Model for Domain Generalizable Remote Sensing Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.22629v3](http://arxiv.org/pdf/2410.22629v3)**
...
>
---
#### [replaced 019] Your Turn: At Home Turning Angle Estimation for Parkinson's Disease Severity Assessment
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2408.08182v4](http://arxiv.org/pdf/2408.08182v4)**
...
>
---
#### [replaced 020] Min: Mixture of Noise for Pre-Trained Model-Based Class-Incremental Learning
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.16738v2](http://arxiv.org/pdf/2509.16738v2)**

> **作者:** Kai Jiang; Zhengyan Shi; Dell Zhang; Hongyuan Zhang; Xuelong Li
>
> **备注:** Accepted by NeurIPS 2025. Code is available at https://github.com/ASCIIJK/MiN-NeurIPS2025
>
...
>
---
#### [replaced 021] SimToken: A Simple Baseline for Referring Audio-Visual Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17537v2](http://arxiv.org/pdf/2509.17537v2)**

> **作者:** Dian Jin; Yanghao Zhou; Jinxing Zhou; Jiaqi Ma; Ruohao Guo; Dan Guo
>
> **备注:** Project page: https://github.com/DianJin-HFUT/SimToken
>
...
>
---
#### [replaced 022] Exploring Model Kinship for Merging Large Language Models
...
>
---
#### [replaced 023] PointAD+: Learning Hierarchical Representations for Zero-shot 3D Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.03277v2](http://arxiv.org/pdf/2509.03277v2)**
...
>
---
#### [replaced 024] Joint Memory Frequency and Computing Frequency Scaling for Energy-efficient DNN Inference
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17970v2](http://arxiv.org/pdf/2509.17970v2)**
...
>
---
#### [replaced 025] Image Segmentation and Classification of E-waste for Training Robots for Waste Segregation
- **分类: cs.CV; cs.AI; I.2.10**

- **链接: [http://arxiv.org/pdf/2506.07122v2](http://arxiv.org/pdf/2506.07122v2)**

> **作者:** Prakriti Tripathi
>
> **备注:** 3 pages, 2 figures, submitted to 2025 5th International Conference on AI-ML-Systems (AIMLSystems)
>
...
>
---
#### [replaced 026] Adaptive Fast-and-Slow Visual Program Reasoning for Long-Form VideoQA
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17743v2](http://arxiv.org/pdf/2509.17743v2)**

> **作者:** Chenglin Li; Feng Han; Feng Tao; Ruilin Li; Qianglong Chen; Jingqi Tong; Yin Zhang; Jiaqi Wang
>
...
>
---
#### [replaced 027] Hierarchical Neural Semantic Representation for 3D Semantic Correspondence
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17431v2](http://arxiv.org/pdf/2509.17431v2)**
...
>
---
#### [replaced 028] AvatarShield: Visual Reinforcement Learning for Human-Centric Synthetic Video Detection
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.15173v3](http://arxiv.org/pdf/2505.15173v3)**
...
>
---
#### [replaced 029] Large Language Models Implicitly Learn to See and Hear Just By Reading
...
>
---
#### [replaced 030] Development and validation of an AI foundation model for endoscopic diagnosis of esophagogastric junction adenocarcinoma: a cohort and deep learning study
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17660v2](http://arxiv.org/pdf/2509.17660v2)**
...
>
> **备注:** Accepted to eClinicalMedicine, Part of The Lancet Discovery Science
>
...
>
---
#### [replaced 031] DOTA: Distributional Test-Time Adaptation of Vision-Language Models
...
>
---
#### [replaced 032] Athena: Enhancing Multimodal Reasoning with Data-efficient Process Reward Models
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 033] WaveFormer: A Lightweight Transformer Model for sEMG-based Gesture Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.11168v2](http://arxiv.org/pdf/2506.11168v2)**
...
>
---
#### [replaced 036] Mitigating Hallucination in Large Vision-Language Models through Aligning Attention Distribution to Information Flow
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.14257v3](http://arxiv.org/pdf/2505.14257v3)**
...
>
---
#### [replaced 037] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16423v2](http://arxiv.org/pdf/2509.16423v2)**
...
>
---
#### [replaced 038] A Chain-of-thought Reasoning Breast Ultrasound Dataset Covering All Histopathology Categories
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17046v2](http://arxiv.org/pdf/2509.17046v2)**
...
>
---
#### [replaced 039] DATA: Domain-And-Time Alignment for High-Quality Feature Fusion in Collaborative Perception
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.18237v2](http://arxiv.org/pdf/2507.18237v2)**
...
>
---
#### [replaced 040] JL1-CD: A New Benchmark for Remote Sensing Change Detection and a Robust Multi-Teacher Knowledge Distillation Framework
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.13407v4](http://arxiv.org/pdf/2502.13407v4)**
...
>
---
#### [replaced 048] MediSyn: A Generalist Text-Guided Latent Diffusion Model For Diverse Medical Image Synthesis
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 049] A Rigorous Behavior Assessment of CNNs Using a Data-Domain Sampling Regime
- **分类: cs.LG; cs.CV; cs.HC**

- **链接: [http://arxiv.org/pdf/2507.03866v2](http://arxiv.org/pdf/2507.03866v2)**

> **作者:** Shuning Jiang; Wei-Lun Chao; Daniel Haehn; Hanspeter Pfister; Jian Chen
>
> **备注:** This is a preprint of a paper that has been accepted for publication at IEEE VIS 2025. The final version may be different upon publication. 9 pages main text, 11 pages supplementary contents, 37 figures
>
...
>
---
#### [replaced 050] Uncertainty-Aware Information Pursuit for Interpretable and Reliable Medical Image Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.16742v2](http://arxiv.org/pdf/2506.16742v2)**
...
>
---
#### [replaced 051] ZoDIAC: Zoneout Dropout Injection Attention Calculation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2206.14263v3](http://arxiv.org/pdf/2206.14263v3)**

> **作者:** Zanyar Zohourianshahzadi; Terrance E. Boult; Jugal K. Kalita
>
...
>
---
#### [replaced 054] Improving Image Captioning Descriptiveness by Ranking and LLM-based Fusion
...
>
---
#### [replaced 055] Variational Bayes Gaussian Splatting
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2410.03592v2](http://arxiv.org/pdf/2410.03592v2)**

> **作者:** Toon Van de Maele; Ozan Catal; Alexander Tschantz; Christopher L. Buckley; Tim Verbelen
>
> **摘要:** Recently, 3D Gaussian Splatting has emerged as a promising approach for modeling 3D scenes using mixtures of Gaussians. The predominant optimization method for these models relies on backpropagating gradients through a differentiable rendering pipeline, which struggles with catastrophic forgetting when dealing with continuous streams of data. To address this limitation, we propose Variational Bayes Gaussian Splatting (VBGS), a novel approach that frames training a Gaussian splat as variational inference over model parameters. By leveraging the conjugacy properties of multivariate Gaussians, we derive a closed-form variational update rule, allowing efficient updates from partial, sequential observations without the need for replay buffers. Our experiments show that VBGS not only matches state-of-the-art performance on static datasets, but also enables continual learning from sequentially streamed 2D and 3D data, drastically improving performance in this setting.
>
---
#### [replaced 056] UltraBoneUDF: Self-supervised Bone Surface Reconstruction from Ultrasound Based on Neural Unsigned Distance Functions
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17912v3](http://arxiv.org/pdf/2505.17912v3)**
...
>
---
#### [replaced 057] MEGS$^{2}$: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.07021v2](http://arxiv.org/pdf/2509.07021v2)**
...
>
---
#### [replaced 058] Do It Yourself: Learning Semantic Correspondence from Pseudo-Labels
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05312v3](http://arxiv.org/pdf/2506.05312v3)**

> **作者:** Olaf Dünkel; Thomas Wimmer; Christian Theobalt; Christian Rupprecht; Adam Kortylewski
>
> **备注:** ICCV 2025. Project page: https://genintel.github.io/DIY-SC
>
...
>
---
#### [replaced 061] Latent Beam Diffusion Models for Generating Visual Sequences
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.20429v3](http://arxiv.org/pdf/2503.20429v3)**
...
>
---
#### [replaced 064] SAM-DCE: Addressing Token Uniformity and Semantic Over-Smoothing in Medical Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16886v2](http://arxiv.org/pdf/2509.16886v2)**
...
>
---
#### [replaced 065] Rethinking Evaluation of Infrared Small Target Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16888v2](http://arxiv.org/pdf/2509.16888v2)**

> **作者:** Youwei Pang; Xiaoqi Zhao; Lihe Zhang; Huchuan Lu; Georges El Fakhri; Xiaofeng Liu; Shijian Lu
>
> **备注:** NeurIPS 2025; Evaluation Toolkit: https://github.com/lartpang/PyIRSTDMetrics; Correct a few typos
>
...
>
---
#### [replaced 068] Without Paired Labeled Data: End-to-End Self-Supervised Learning for Drone-view Geo-Localization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.11381v4](http://arxiv.org/pdf/2502.11381v4)**
...
>
---
#### [replaced 069] Enhancing Video-Based Robot Failure Detection Using Task Knowledge
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 070] PromptEnhancer: A Simple Approach to Enhance Text-to-Image Models via Chain-of-Thought Prompt Rewriting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.04545v5](http://arxiv.org/pdf/2509.04545v5)**
...
>
---
#### [replaced 075] LongLLaVA: Scaling Multi-modal LLMs to 1000 Images Efficiently via a Hybrid Architecture
...
>
---
#### [replaced 076] Disentangle and Regularize: Sign Language Production with Articulator-Based Disentanglement and Channel-Aware Regularization
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.06610v3](http://arxiv.org/pdf/2504.06610v3)**
...
>
---
#### [replaced 077] Diffusion-Based Action Recognition Generalizes to Untrained Domains
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.08908v3](http://arxiv.org/pdf/2509.08908v3)**
...
>
---
#### [replaced 078] Large Vision-Language Model Alignment and Misalignment: A Survey Through the Lens of Explainability
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 079] LRQ-DiT: Log-Rotation Post-Training Quantization of Diffusion Transformers for Image and Video Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03485v3](http://arxiv.org/pdf/2508.03485v3)**
...
>
---
#### [replaced 080] SparseDiT: Token Sparsification for Efficient Diffusion Transformer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.06028v2](http://arxiv.org/pdf/2412.06028v2)**
...
>
---
#### [replaced 082] ViSpec: Accelerating Vision-Language Models with Vision-Aware Speculative Decoding
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 083] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17083v2](http://arxiv.org/pdf/2509.17083v2)**
...
- **链接: [http://arxiv.org/pdf/2509.16727v2](http://arxiv.org/pdf/2509.16727v2)**
...
>
---
#### [replaced 085] Class-wise Balancing Data Replay for Federated Class-Incremental Learning
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07712v2](http://arxiv.org/pdf/2507.07712v2)**
...
>
---
#### [replaced 086] Gaussian Herding across Pens: An Optimal Transport Perspective on Global Gaussian Reduction for 3DGS
- **分类: cs.CV; I.4.5**

- **链接: [http://arxiv.org/pdf/2506.09534v2](http://arxiv.org/pdf/2506.09534v2)**
...
>
---
#### [replaced 087] CaKE: Circuit-aware Editing Enables Generalizable Knowledge Learners
...
>
---
#### [replaced 088] SCoT: Straight Consistent Trajectory for Pre-Trained Diffusion Model Distillations
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.16972v3](http://arxiv.org/pdf/2502.16972v3)**
...
>
---
#### [replaced 089] REACT: Real-time Efficiency and Accuracy Compromise for Tradeoffs in Scene Graph Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.16116v3](http://arxiv.org/pdf/2405.16116v3)**

> **作者:** Maëlic Neau; Paulo E. Santos; Anne-Gwenn Bosser; Cédric Buche; Akihiro Sugimoto
>
> **备注:** Accepted at the 2025 British Machine Vision Conference (BMVC)
>
...
>
---
#### [replaced 090] LD-ViCE: Latent Diffusion Model for Video Counterfactual Explanations
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.08422v2](http://arxiv.org/pdf/2509.08422v2)**
...
>
---
#### [replaced 091] EMMA: End-to-End Multimodal Model for Autonomous Driving
...
>
---
#### [replaced 092] Handling Multiple Hypotheses in Coarse-to-Fine Dense Image Matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.08805v2](http://arxiv.org/pdf/2509.08805v2)**
...
>
---
#### [replaced 095] LookAhead Tuning: Safer Language Models via Partial Answer Previews
...
>
---
#### [replaced 096] StableGuard: Towards Unified Copyright Protection and Tamper Localization in Latent Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17993v2](http://arxiv.org/pdf/2509.17993v2)**
...
>
---
#### [replaced 097] Multi-scale Temporal Prediction via Incremental Generation and Multi-agent Collaboration
- **分类: cs.CV; 68T45; I.2.10**

- **链接: [http://arxiv.org/pdf/2509.17429v2](http://arxiv.org/pdf/2509.17429v2)**
...
>
---
#### [replaced 098] Multimodal Medical Image Classification via Synergistic Learning Pre-training
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.17492v2](http://arxiv.org/pdf/2509.17492v2)**
...
>
---
#### [replaced 099] AHA - Predicting What Matters Next: Online Highlight Detection Without Looking Ahead
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.16421v2](http://arxiv.org/pdf/2509.16421v2)**
