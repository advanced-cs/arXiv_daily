...
#### [new 001] Vision-Conditioned Variational Bayesian Last Layer Dynamics Models
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决环境变化下系统行为预测问题。通过视觉条件的变分贝叶斯模型实现动态适应，提升控制性能。**

- **链接: [https://arxiv.org/pdf/2601.09178v1](https://arxiv.org/pdf/2601.09178v1)**
...
>
---
#### [new 009] CLARE: Continual Learning for Vision-Language-Action Models via Autonomous Adapter Routing and Expansion
- **分类: cs.RO; cs.LG**

- **简介: 该论文提出CLARE，解决机器人视觉-语言-动作模型的持续学习问题，无需存储旧数据，通过自适应扩展和路由机制实现任务连续学习。**

- **链接: [https://arxiv.org/pdf/2601.09512v1](https://arxiv.org/pdf/2601.09512v1)**
...
>
---
#### [new 014] Sim2real Image Translation Enables Viewpoint-Robust Policies from Fixed-Camera Datasets
...
>
---
#### [new 015] Vision Foundation Models for Domain Generalisable Cross-View Localisation in Planetary Ground-Aerial Robotic Teams
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 016] Residual Cross-Modal Fusion Networks for Audio-Visual Navigation
- **分类: cs.CV; cs.AI; cs.RO**
...
#### [replaced 001] SAC Flow: Sample-Efficient Reinforcement Learning of Flow-Based Policies via Velocity-Reparameterized Sequential Modeling
- **分类: cs.RO; cs.LG**

- **简介: 该论文属于强化学习任务，旨在解决流式策略训练不稳定的问题。通过重新参数化速度网络，提出两种稳定架构，实现高效端到端训练。**

- **链接: [https://arxiv.org/pdf/2509.25756v3](https://arxiv.org/pdf/2509.25756v3)**
...
>
---
#### [replaced 008] JuggleRL: Mastering Ball Juggling with a Quadrotor via Deep Reinforcement Learning
- **分类: cs.RO**

- **简介: 该论文研究空中机器人进行球类杂技的任务，解决在不确定环境下精准控制的问题。提出JuggleRL系统，通过深度强化学习实现高效、稳定的球拍击打与持续杂技。**

- **链接: [https://arxiv.org/pdf/2509.24892v2](https://arxiv.org/pdf/2509.24892v2)**
...
>
---
#### [replaced 009] Tackling the Kidnapped Robot Problem via Sparse Feasible Hypothesis Sampling and Reliable Batched Multi-Stage Inference
- **分类: cs.RO**

- **简介: 该论文属于机器人定位任务，解决 kidnapped robot problem（KRP）问题，通过稀疏采样和多阶段推理实现高效可靠全局定位。**

- **链接: [https://arxiv.org/pdf/2511.01219v5](https://arxiv.org/pdf/2511.01219v5)**
...
>
---
#### [replaced 010] Ensemble-Based Event Camera Place Recognition Under Varying Illumination
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 011] SPARK: Safe Protective and Assistive Robot Kit
- **分类: cs.RO; eess.SY**

- **简介: 该论文提出SPARK，一个用于人形机器人安全控制的基准工具包，解决人形机器人在复杂环境中的安全问题。通过模块化控制框架和仿真测试，提升系统安全性与性能平衡。**

- **链接: [https://arxiv.org/pdf/2502.03132v3](https://arxiv.org/pdf/2502.03132v3)**
...
>
---
#### [replaced 012] Large Multimodal Models for Embodied Intelligent Driving: The Next Frontier in Self-Driving?
- **分类: cs.RO; cs.AI**

- **简介: 论文探讨了将大型多模态模型与深度强化学习结合，用于增强具身智能驾驶的决策能力。旨在解决传统模块化设计在开放场景中的不足，通过融合语义理解和实时策略优化，提升自动驾驶性能。**

- **链接: [https://arxiv.org/pdf/2601.08434v2](https://arxiv.org/pdf/2601.08434v2)**
...
>
---
#### [replaced 015] AURASeg: Attention Guided Upsampling with Residual Boundary-Assistive Refinement for Drivable-Area Segmentation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 016] Learning on the Fly: Rapid Policy Adaptation via Differentiable Simulation
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决模拟到现实的迁移难题。通过在线自适应学习框架，快速调整策略以应对未见扰动。**

- **链接: [https://arxiv.org/pdf/2508.21065v2](https://arxiv.org/pdf/2508.21065v2)**
...
>
---
#### [replaced 017] Do What You Say: Steering Vision-Language-Action Models via Runtime Reasoning-Action Alignment Verification
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属于机器人指令执行任务，解决VLA模型中推理与动作不一致的问题。通过运行时验证和选择最佳动作序列，提升模型在OOD场景下的鲁棒性与行为组合能力。**

- **链接: [https://arxiv.org/pdf/2510.16281v2](https://arxiv.org/pdf/2510.16281v2)**
...
>
---
#### [replaced 018] Shape-Space Graphs: Fast and Collision-Free Path Planning for Soft Robots
- **分类: cs.RO**

- **简介: 该论文属于路径规划任务，解决软体机器人在复杂环境中的碰撞避免问题。通过构建形状空间图，实现快速、节能的路径生成。**

- **链接: [https://arxiv.org/pdf/2510.03547v2](https://arxiv.org/pdf/2510.03547v2)**
