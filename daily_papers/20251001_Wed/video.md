...
>
---
#### [new 003] AttentionViG: Cross-Attention-Based Dynamic Neighbor Aggregation in Vision GNNs
...
- **简介: 该论文属于图像生成任务，旨在解决subject-driven生成中效率与质量的矛盾。提出EchoGen框架，利用VAR模型实现高效且高质量的视觉回声生成。**
...
- **简介: 该论文属于人机交互任务，解决无监督物体分割问题。通过利用人类叙述进行弱监督学习，提出WISH模型实现手部物体分割，无需精细标注。**
...
- **简介: 该论文属于室内场景重建任务，解决多视角依赖导致的重建质量下降问题，通过引入图像平面解码框架提升视图不变性。**
...
- **简介: 该论文属于文档视觉问答任务，旨在降低大型模型Donut的计算成本。通过知识蒸馏和可解释性分析，提出Donut-MINT模型，在保持性能的同时减少推理时间和内存占用。**
...
- **简介: 该论文属于文本到图像生成任务，旨在解决文本与图像对齐问题。提出TPO框架，无需配对图像数据即可实现对齐。**
...
- **链接: [http://arxiv.org/pdf/2509.26641v1](http://arxiv.org/pdf/2509.26641v1)**
...
- **简介: 该论文属于工业异常检测任务，解决现有方法依赖文本提示、缺乏统一视觉框架的问题。提出PatchEAD框架，实现无需训练的跨模型异常检测。**
...
- **简介: 该论文属于面部表情分类任务，旨在解决高维图像数据的复杂性问题。通过融合深度学习与传统特征提取方法，并使用UMAP进行降维，提升分类性能。**
...
- **简介: 该论文属于数据增强任务，旨在解决数据集偏差问题。通过自动化生成边缘案例，提升模型鲁棒性，优于传统方法。**
...
- **简介: 该论文属于模型压缩任务，解决扩散模型部署中的高计算需求问题。提出QuaRTZ方法，在4-bit量化下保留纹理细节，提升量化效率。**
...
- **简介: 该论文属于植物病害分类任务，旨在准确识别槟榔叶病害。通过集成CBAM模块的轻量CNN模型，提升分类性能并实现可解释性分析。**
...
- **链接: [http://arxiv.org/pdf/2509.26618v1](http://arxiv.org/pdf/2509.26618v1)**
...
- **简介: 该论文属于时间序列预测任务，解决传统方法分割破坏时间连贯性的问题。提出EntroPE框架，通过熵引导动态分块保持时间结构，提升预测精度与效率。**
...
- **简介: 该论文属于人体网格恢复任务，解决从单张RGB图像恢复3D人体姿态和形状的问题。提出SO(3)扩散模型，生成符合2D观测的姿势分布。**
...
- **简介: 该论文属于多模态语言模型评估任务，旨在解决人类中心场景理解评估不足的问题。提出Human-MME基准，涵盖多样化场景、多维评估和高质量标注，提升模型对人类相关场景的理解能力。**
...
- **简介: 该论文属于数据集蒸馏任务，旨在解决传统方法冗余和扩展性差的问题。提出GSDD，用稀疏高斯表示替代像素级表示，提升效率与性能。**
...
- **简介: 该论文属于多模态媒体篡改检测任务，旨在解决全局不一致问题。通过扩展DGM4数据集，引入FG-BG不匹配样本，提升检测模型对全局错误的识别能力。**
...
- **简介: 该论文属于虚拟试衣任务，解决非试衣区域边界伪影问题。提出ART-VITON框架，通过测量引导的扩散模型实现无伪影合成。**
...
- **简介: 该论文属于三维重建任务，解决高分辨率局部细节重建问题。通过动态增加高斯密度，在指定区域实现高效细节重建。**
...
- **简介: 该论文属于多模态虚假信息检测任务，解决全局场景不一致问题。通过分割引导评分增强模型对前景背景错位的识别能力。**
...
- **链接: [http://arxiv.org/pdf/2509.25731v1](http://arxiv.org/pdf/2509.25731v1)**
...
- **简介: 该论文属于多模态多类别异常检测任务，解决现有方法碎片化和重建误差问题。提出UniMMAD框架，利用MoE驱动特征解压缩实现高效准确的异常检测。**
...
- **简介: 该论文属于视频摘要的可解释性研究，旨在生成合理的文本解释。通过扩展框架并引入SOTA模型，提出评估解释合理性的方法，以验证解释的忠实性与合理性之间的关系。**
...
- **简介: 该论文属于视觉语言模型行为控制任务，旨在解决现有方法依赖模型内部或用户指令的问题。通过生成通用视觉输入实现模型行为引导，无需访问模型内部。**
...
- **简介: 该论文属于视觉语言推理任务，解决现有方法依赖不可靠注意力图的问题。提出AIMCoT框架，通过主动信息获取和动态注意力切换提升推理效果。**
...
- **简介: 该论文属于小语言模型优化任务，解决其在边缘设备上性能不足的问题。通过后训练管道提升模型精度，实现高效部署。**
...
- **链接: [http://arxiv.org/pdf/2509.25927v1](http://arxiv.org/pdf/2509.25927v1)**
...
>
---
#### [new 064] New Fourth-Order Grayscale Indicator-Based Telegraph Diffusion Model for Image Despeckling
- **分类: cs.CV**

- **简介: 该论文属于图像去噪任务，解决传统模型引入块状伪影的问题，提出一种四阶非线性PDE模型，结合扩散与波特性，提升去噪效果。**

- **链接: [http://arxiv.org/pdf/2509.26010v1](http://arxiv.org/pdf/2509.26010v1)**
...
>
---
#### [new 065] Text-to-Scene with Large Reasoning Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于文本到场景生成任务，解决复杂几何和指令遵循问题。工作包括引入Reason-3D模型，结合大推理模型进行物体检索与布局优化。**

- **链接: [http://arxiv.org/pdf/2509.26091v1](http://arxiv.org/pdf/2509.26091v1)**
...
>
---
#### [new 068] A Deep Learning Approach for Spatio-Temporal Forecasting of InSAR Ground Deformation in Eastern Ireland
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于地表形变预测任务，旨在解决高分辨率土地沉降预测难题。通过提出多模态时空变换器模型，融合动态与静态数据，提升长期预测精度。**

- **链接: [http://arxiv.org/pdf/2509.25393v1](http://arxiv.org/pdf/2509.25393v1)**
...
>
---
#### [new 072] Self-Supervised Anatomical Consistency Learning for Vision-Grounded Medical Report Generation
- **分类: cs.CV**

- **简介: 该论文属于医学影像报告生成任务，解决依赖专家标注和病理分布偏差的问题。提出SS-ACL框架，通过自监督学习实现解剖一致性对齐，提升报告准确性与可解释性。**

- **链接: [http://arxiv.org/pdf/2509.25963v1](http://arxiv.org/pdf/2509.25963v1)**

> **作者:** Longzhen Yang; Zhangkai Ni; Ying Wen; Yihang Liu; Lianghua He; Heng Tao Shen
>
> **摘要:** Vision-grounded medical report generation aims to produce clinically accurate descriptions of medical images, anchored in explicit visual evidence to improve interpretability and facilitate integration into clinical workflows. However, existing methods often rely on separately trained detection modules that require extensive expert annotations, introducing high labeling costs and limiting generalizability due to pathology distribution bias across datasets. To address these challenges, we propose Self-Supervised Anatomical Consistency Learning (SS-ACL) -- a novel and annotation-free framework that aligns generated reports with corresponding anatomical regions using simple textual prompts. SS-ACL constructs a hierarchical anatomical graph inspired by the invariant top-down inclusion structure of human anatomy, organizing entities by spatial location. It recursively reconstructs fine-grained anatomical regions to enforce intra-sample spatial alignment, inherently guiding attention maps toward visually relevant areas prompted by text. To further enhance inter-sample semantic alignment for abnormality recognition, SS-ACL introduces a region-level contrastive learning based on anatomical consistency. These aligned embeddings serve as priors for report generation, enabling attention maps to provide interpretable visual evidence. Extensive experiments demonstrate that SS-ACL, without relying on expert annotations, (i) generates accurate and visually grounded reports -- outperforming state-of-the-art methods by 10\% in lexical accuracy and 25\% in clinical efficacy, and (ii) achieves competitive performance on various downstream visual tasks, surpassing current leading visual foundation models by 8\% in zero-shot visual grounding.
>
---
#### [new 073] Point2RBox-v3: Self-Bootstrapping from Point Annotations via Integrated Pseudo-Label Refinement and Utilization
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于定向目标检测任务，解决弱监督下点标注伪标签质量与利用率低的问题。提出PLA和PGDM-Loss，提升模型在稀疏与密集场景的性能。**

- **链接: [http://arxiv.org/pdf/2509.26281v1](http://arxiv.org/pdf/2509.26281v1)**
...
>
---
#### [new 074] V-HUB: A Visual-Centric Humor Understanding Benchmark for Video LLMs
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 075] Generalized Fine-Grained Category Discovery with Multi-Granularity Conceptual Experts
- **分类: cs.CV**

- **简介: 该论文属于细粒度类别发现任务，解决未知类别识别与数量估计问题。提出MGCE框架，通过多粒度概念专家协作提升分类精度。**

- **链接: [http://arxiv.org/pdf/2509.26227v1](http://arxiv.org/pdf/2509.26227v1)**
...
>
---
#### [new 076] LMOD+: A Comprehensive Multimodal Dataset and Benchmark for Developing and Evaluating Multimodal Large Language Models in Ophthalmology
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在解决眼科疾病诊断数据不足的问题。构建了大规模多模态数据集LMOD+，扩展了任务范围并评估了多种模型性能。**

- **链接: [http://arxiv.org/pdf/2509.25620v1](http://arxiv.org/pdf/2509.25620v1)**
...
>
---
#### [new 079] AttriGen: Automated Multi-Attribute Annotation for Blood Cell Datasets
- **分类: cs.CV; cs.AI; cs.LG; 60G35, 62M10, 62P35, 65C20, 68T45, 68U10, 92C35, 92C40, 92C42, 93E10; I.4; I.4.8; I.4.9; I.4.10; I.2; I.2.6; I.2.10; J.3; C.2.4; C.3;
  H.2.8; H.3.4; H.3.5; I.2.4; I.5; I.5.1; I.5.4; K.6.1**

- **简介: 该论文属于计算机视觉中的多属性分类任务，旨在解决细胞显微图像中多属性标注不足的问题。通过结合CNN和ViT模型，实现高效准确的自动标注。**

- **链接: [http://arxiv.org/pdf/2509.26185v1](http://arxiv.org/pdf/2509.26185v1)**
...
>
---
#### [new 084] EasyOcc: 3D Pseudo-Label Supervision for Fully Self-Supervised Semantic Occupancy Prediction Models
- **分类: cs.CV**

- **简介: 该论文属于语义占据预测任务，解决自监督学习中标签缺失问题。通过生成3D伪标签和利用时序信息，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2509.26087v1](http://arxiv.org/pdf/2509.26087v1)**
...
>
---
#### [new 085] FishNet++: Analyzing the capabilities of Multimodal Large Language Models in marine biology
- **分类: cs.CV**

- **简介: 该论文属于海洋生物学与多模态语言模型的交叉任务，旨在解决鱼类识别准确率低的问题。通过构建FishNet++基准，提升模型在该领域的表现。**

- **链接: [http://arxiv.org/pdf/2509.25564v1](http://arxiv.org/pdf/2509.25564v1)**
...
>
---
#### [new 090] MotionRAG: Motion Retrieval-Augmented Image-to-Video Generation
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决视频中真实运动生成困难的问题。通过引入MotionRAG框架，利用检索增强技术提升运动真实性。**

- **链接: [http://arxiv.org/pdf/2509.26391v1](http://arxiv.org/pdf/2509.26391v1)**
...
>
---
#### [new 091] DiffCamera: Arbitrary Refocusing on Images
- **分类: cs.CV**

- **简介: 该论文属于图像处理任务，解决图像拍摄后无法调整焦距的问题。通过提出DiffCamera模型，实现对已拍图像的任意焦点和模糊程度的重新聚焦。**

- **链接: [http://arxiv.org/pdf/2509.26599v1](http://arxiv.org/pdf/2509.26599v1)**

> **作者:** Yiyang Wang; Xi Chen; Xiaogang Xu; Yu Liu; Hengshuang Zhao
>
> **摘要:** The depth-of-field (DoF) effect, which introduces aesthetically pleasing blur, enhances photographic quality but is fixed and difficult to modify once the image has been created. This becomes problematic when the applied blur is undesirable~(e.g., the subject is out of focus). To address this, we propose DiffCamera, a model that enables flexible refocusing of a created image conditioned on an arbitrary new focus point and a blur level. Specifically, we design a diffusion transformer framework for refocusing learning. However, the training requires pairs of data with different focus planes and bokeh levels in the same scene, which are hard to acquire. To overcome this limitation, we develop a simulation-based pipeline to generate large-scale image pairs with varying focus planes and bokeh levels. With the simulated data, we find that training with only a vanilla diffusion objective often leads to incorrect DoF behaviors due to the complexity of the task. This requires a stronger constraint during training. Inspired by the photographic principle that photos of different focus planes can be linearly blended into a multi-focus image, we propose a stacking constraint during training to enforce precise DoF manipulation. This constraint enhances model training by imposing physically grounded refocusing behavior that the focusing results should be faithfully aligned with the scene structure and the camera conditions so that they can be combined into the correct multi-focus image. We also construct a benchmark to evaluate the effectiveness of our refocusing model. Extensive experiments demonstrate that DiffCamera supports stable refocusing across a wide range of scenes, providing unprecedented control over DoF adjustments for photography and generative AI applications.
>
---
#### [new 092] Infrastructure Sensor-enabled Vehicle Data Generation using Multi-Sensor Fusion for Proactive Safety Applications at Work Zone
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 095] K-Prism: A Knowledge-Guided and Prompt Integrated Universal Medical Image Segmentation Model
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分割任务，旨在解决现有模型碎片化问题。通过整合语义先验、上下文知识和交互反馈，提出K-Prism框架，实现通用分割。**

- **链接: [http://arxiv.org/pdf/2509.25594v1](http://arxiv.org/pdf/2509.25594v1)**
...
>
---
#### [new 096] Multi-View Camera System for Variant-Aware Autonomous Vehicle Inspection and Defect Detection
- **分类: cs.CV**

- **简介: 该论文属于自动驾驶车辆检测任务，解决多视角下车型识别与缺陷检测问题。通过多摄像头系统结合深度学习模型，实现高效准确的车辆质量控制。**

- **链接: [http://arxiv.org/pdf/2509.26454v1](http://arxiv.org/pdf/2509.26454v1)**
...
>
---
#### [new 101] SAGE: Spatial-visual Adaptive Graph Exploration for Visual Place Recognition
- **分类: cs.CV**

- **简介: 该论文属于视觉定位任务，解决VPR中的外观、视角和环境变化问题。提出SAGE方法，通过空间-视觉自适应图探索提升识别性能。**

- **链接: [http://arxiv.org/pdf/2509.25723v1](http://arxiv.org/pdf/2509.25723v1)**
...
>
---
#### [new 102] DeepFake Detection in Dyadic Video Calls using Point of Gaze Tracking
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于深度伪造检测任务，旨在解决视频会议中实时深度伪造攻击问题。通过分析眼神轨迹特征，提出一种基于生物特征的检测方法，实现82%的准确率。**

- **链接: [http://arxiv.org/pdf/2509.25503v1](http://arxiv.org/pdf/2509.25503v1)**
...
>
---
#### [new 103] Logo-VGR: Visual Grounded Reasoning for Open-world Logo Recognition
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于开放世界logo识别任务，解决传统方法依赖大量品牌数据的问题。提出Logo-VGR模型，通过对比学习和领域知识增强多模态推理能力，实现高效泛化。**

- **链接: [http://arxiv.org/pdf/2509.25811v1](http://arxiv.org/pdf/2509.25811v1)**
...
>
---
#### [new 104] Cat: Post-training quantization error reduction via cluster-based affine transformation
- **分类: cs.CV**

- **简介: 该论文属于模型压缩任务，解决低比特量化导致的精度下降问题。通过提出基于聚类的仿射变换方法（CAT），提升量化模型与全精度模型的一致性。**

- **链接: [http://arxiv.org/pdf/2509.26277v1](http://arxiv.org/pdf/2509.26277v1)**
...
>
---
#### [new 105] LUMA: Low-Dimension Unified Motion Alignment with Dual-Path Anchoring for Text-to-Motion Diffusion Model
- **分类: cs.CV**

- **简介: 该论文属于文本到动作生成任务，解决语义错位和运动伪影问题。提出LUMA模型，结合双路径锚定增强语义对齐与频率域补充信号。**

- **链接: [http://arxiv.org/pdf/2509.25304v1](http://arxiv.org/pdf/2509.25304v1)**
...
>
---
#### [new 107] MetaChest: Generalized few-shot learning of patologies from chest X-rays
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分类任务，解决少量标注数据下的病理识别问题。提出MetaChest数据集，并对比了迁移学习与ProtoNet方法的效果。**

- **链接: [http://arxiv.org/pdf/2509.25590v1](http://arxiv.org/pdf/2509.25590v1)**
...
>
---
#### [new 108] A Multi-purpose Tracking Framework for Salmon Welfare Monitoring in Challenging Environments
- **分类: cs.CV; I.4.8; I.4.9**

- **简介: 该论文属于目标跟踪任务，旨在解决水下鲑鱼福利监测中的跟踪难题。通过提出多用途跟踪框架，提升复杂环境下的跟踪精度与自动化水平。**

- **链接: [http://arxiv.org/pdf/2509.25969v1](http://arxiv.org/pdf/2509.25969v1)**
...
>
---
#### [new 111] Geometric Learning of Canonical Parameterizations of $2D$-curves
- **分类: cs.CV; math.DG; 53Z50 (Primary), 53A04 (Secondary), 53C10, 58B99**

- **简介: 该论文属于计算机视觉任务，解决对称性处理问题。通过几何方法构建鲁棒的特征表示，避免数据增强，提升分类性能。**

- **链接: [http://arxiv.org/pdf/2509.26070v1](http://arxiv.org/pdf/2509.26070v1)**
...
>
---
#### [new 122] TTT3R: 3D Reconstruction as Test-Time Training
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，解决模型在超出训练长度时性能下降的问题。通过引入TTT3R方法，提升模型长度泛化能力。**

- **链接: [http://arxiv.org/pdf/2509.26645v1](http://arxiv.org/pdf/2509.26645v1)**
...
>
---
#### [new 123] ProfVLM: A Lightweight Video-Language Model for Multi-View Proficiency Estimation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 124] Bayesian Transformer for Pan-Arctic Sea Ice Concentration Mapping and Uncertainty Estimation using Sentinel-1, RCM, and AMSR2 Data
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于海冰浓度制图任务，旨在解决海冰特征细微、模型不确定性和数据异质性问题，提出一种融合多源数据的贝叶斯Transformer模型，提升SIC地图和不确定性估计精度。**

- **链接: [http://arxiv.org/pdf/2509.25437v1](http://arxiv.org/pdf/2509.25437v1)**
...
>
---
#### [new 125] Continuous Space-Time Video Super-Resolution with 3D Fourier Fields
- **分类: cs.CV**

- **简介: 该论文属于视频超分辨率任务，旨在解决视频在空间和时间上的清晰度提升问题。通过引入3D视频傅里叶场（VFF）模型，实现更高效、连贯的视频重建。**

- **链接: [http://arxiv.org/pdf/2509.26325v1](http://arxiv.org/pdf/2509.26325v1)**
...
>
---
#### [new 126] Robust Visual Localization in Compute-Constrained Environments by Salient Edge Rendering and Weighted Hamming Similarity
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 127] Using Images from a Video Game to Improve the Detection of Truck Axles
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于目标检测任务，旨在解决真实数据收集成本高的问题。通过使用游戏中的合成图像训练CNN模型，有效提升了卡车轴的检测性能。**

- **链接: [http://arxiv.org/pdf/2509.25644v1](http://arxiv.org/pdf/2509.25644v1)**
...
>
---
#### [new 128] Go with Your Gut: Scaling Confidence for Autoregressive Image Generation
- **分类: cs.CV**

- **简介: 该论文属于自回归图像生成任务，解决中间结果不完整导致的测试时缩放应用困难问题。提出ScalingAR框架，通过token熵优化生成过程，提升效果并减少计算消耗。**

- **链接: [http://arxiv.org/pdf/2509.26376v1](http://arxiv.org/pdf/2509.26376v1)**

> **作者:** Harold Haodong Chen; Xianfeng Wu; Wen-Jie Shu; Rongjin Guo; Disen Lan; Harry Yang; Ying-Cong Chen
>
> **备注:** Code: https://github.com/EnVision-Research/ScalingAR
>
...
>
---
#### [new 133] Attention over Scene Graphs: Indoor Scene Representations Toward CSAI Classification
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于室内场景分类任务，旨在解决复杂场景理解和敏感内容分析问题。提出ASGRA框架，通过场景图和图注意力网络提升分类效果与可解释性。**

- **链接: [http://arxiv.org/pdf/2509.26457v1](http://arxiv.org/pdf/2509.26457v1)**
...
>
---
#### [new 137] Skip-It? Theoretical Conditions for Layer Skipping in Vision-Language Models
...
>
---
#### [new 138] IRIS: Intrinsic Reward Image Synthesis
...
>
---
#### [new 139] Personalized Scientific Figure Caption Generation: An Empirical Study on Author-Specific Writing Style Transfer
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 140] Vector sketch animation generation with differentialable motion trajectories
- **分类: cs.GR; cs.AI; cs.CV**

- **简介: 该论文属于视频草图动画生成任务，解决视频帧间一致性问题。提出DMT表示法，通过可微多项式轨迹提升语义连贯性与稳定性。**

- **链接: [http://arxiv.org/pdf/2509.25857v1](http://arxiv.org/pdf/2509.25857v1)**
...
>
---
#### [new 143] GastroViT: A Vision Transformer Based Ensemble Learning Approach for Gastrointestinal Disease Classification with Grad CAM & SHAP Visualization
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分类任务，旨在准确识别胃肠道疾病。通过集成预训练视觉Transformer模型，并结合XAI方法提升模型可解释性，以提高诊断可靠性。**

- **链接: [http://arxiv.org/pdf/2509.26502v1](http://arxiv.org/pdf/2509.26502v1)**
...
>
---
#### [new 145] Scaling Up Temporal Domain Generalization via Temporal Experts Averaging
...
>
---
#### [new 148] Clarification as Supervision: Reinforcement Learning for Vision-Language Interfaces
...
>
---
#### [new 149] ExoPredicator: Learning Abstract Models of Dynamic Worlds for Robot Planning
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于机器人长期规划任务，解决动态世界中内生与外生过程协同变化的问题，提出联合学习符号状态和因果过程的框架。**

- **链接: [http://arxiv.org/pdf/2509.26255v1](http://arxiv.org/pdf/2509.26255v1)**
...
>
---
#### [new 150] Annotation-Efficient Active Test-Time Adaptation with Conformal Prediction
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **简介: 该论文属于测试时自适应任务，解决领域偏移下标注效率低的问题。提出CPATTA方法，利用置信区间提升数据选择效率，显著提高模型性能。**

- **链接: [http://arxiv.org/pdf/2509.25692v1](http://arxiv.org/pdf/2509.25692v1)**

> **作者:** Tingyu Shi; Fan Lyu; Shaoliang Peng
>
> **摘要:** Active Test-Time Adaptation (ATTA) improves model robustness under domain shift by selectively querying human annotations at deployment, but existing methods use heuristic uncertainty measures and suffer from low data selection efficiency, wasting human annotation budget. We propose Conformal Prediction Active TTA (CPATTA), which first brings principled, coverage-guaranteed uncertainty into ATTA. CPATTA employs smoothed conformal scores with a top-K certainty measure, an online weight-update algorithm driven by pseudo coverage, a domain-shift detector that adapts human supervision, and a staged update scheme balances human-labeled and model-labeled data. Extensive experiments demonstrate that CPATTA consistently outperforms the state-of-the-art ATTA methods by around 5% in accuracy. Our code and datasets are available at https://github.com/tingyushi/CPATTA.
>
---
#### [new 151] Saliency Guided Longitudinal Medical Visual Question Answering
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于医学视觉问答任务，解决纵向影像变化分析问题。通过结合显著性引导和对齐机制，提升模型对病变区域的关注与解释能力。**

- **链接: [http://arxiv.org/pdf/2509.25374v1](http://arxiv.org/pdf/2509.25374v1)**
...
>
---
#### [new 159] MR$^2$-Bench: Going Beyond Matching to Reasoning in Multimodal Retrieval
- **分类: cs.IR; cs.CV**

- **简介: 该论文属于多模态检索任务，旨在解决现有基准缺乏深度推理评估的问题。提出MR$^2$-Bench，包含需逻辑、空间和因果推理的多样化任务与数据。**

- **链接: [http://arxiv.org/pdf/2509.26378v1](http://arxiv.org/pdf/2509.26378v1)**
...
>
---
#### [new 165] dVLA: Diffusion Vision-Language-Action Model with Multimodal Chain-of-Thought
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 168] InfMasking: Unleashing Synergistic Information by Contrastive Multimodal Interactions
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于多模态表示学习任务，旨在解决如何有效捕捉模态间协同信息的问题。通过InfMasking方法，增强模态间的协同作用，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2509.25270v1](http://arxiv.org/pdf/2509.25270v1)**
...
>
---
#### [new 169] Optimizing Indoor Environmental Quality in Smart Buildings Using Deep Learning
- **分类: cs.LG; cs.AI; cs.CV; 60G35, 62M10, 62P35, 65C20, 68T45, 68U10, 92C35, 92C40, 92C42, 93E10; C.2.1; C.2.4; C.3; H.2.8; H.3.4; H.3.5; I.2; I.2.4; I.2.6; I.2.11;
  I.4.8; I.5.1; I.5.4; I.5.1; I.5.2; I.5; J.3; K.6.1**

- **简介: 该论文属于智能建筑环境优化任务，旨在通过深度学习提升室内环境质量与能源效率。研究对比了LSTM、GRU和CNN-LSTM模型，用于预测CO₂、温湿度等参数，以支持更高效的HVAC控制。**

- **链接: [http://arxiv.org/pdf/2509.26187v1](http://arxiv.org/pdf/2509.26187v1)**
...
#### [replaced 001] Keep It Real: Challenges in Attacking Compression-Based Adversarial Purification
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2508.05489v2](http://arxiv.org/pdf/2508.05489v2)**
...
>
---
#### [replaced 002] MixGRPO: Unlocking Flow-based GRPO Efficiency with Mixed ODE-SDE
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.21802v2](http://arxiv.org/pdf/2507.21802v2)**
...
>
---
#### [replaced 003] A Large Scale Analysis of Gender Biases in Text-to-Image Generative Models
- **分类: cs.CV; cs.CY**
...
>
---
#### [replaced 004] Towards autonomous photogrammetric forest inventory using a lightweight under-canopy robotic drone
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 005] Seeing Through Deception: Uncovering Misleading Creator Intent in Multimodal News with Vision-Language Models
- **分类: cs.CV; cs.CL; cs.MM**
...
>
---
#### [replaced 010] Dynamic Novel View Synthesis in High Dynamic Range
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.21853v2](http://arxiv.org/pdf/2509.21853v2)**
...
>
---
#### [replaced 011] VerlTool: Towards Holistic Agentic Reinforcement Learning with Tool Use
...
>
---
#### [replaced 012] Unified Multimodal Model as Auto-Encoder
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.09666v2](http://arxiv.org/pdf/2509.09666v2)**
...
>
---
#### [replaced 020] StPR: Spatiotemporal Preservation and Routing for Exemplar-Free Video Class-Incremental Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.13997v2](http://arxiv.org/pdf/2505.13997v2)**
...
>
---
#### [replaced 024] Quantized Visual Geometry Grounded Transformer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.21302v2](http://arxiv.org/pdf/2509.21302v2)**
...
>
---
#### [replaced 025] U-MAN: U-Net with Multi-scale Adaptive KAN Network for Medical Image Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.22444v2](http://arxiv.org/pdf/2509.22444v2)**
...
>
---
#### [replaced 026] Investigating Long-term Training for Remote Sensing Object Detection
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2407.15143v4](http://arxiv.org/pdf/2407.15143v4)**

> **作者:** JongHyun Park; Yechan Kim; Moongu Jeon
>
> **备注:** Accepted to Machine Vision and Applications (MVA)
>
...
>
---
#### [replaced 027] AVCD: Mitigating Hallucinations in Audio-Visual Large Language Models through Contrastive Decoding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.20862v2](http://arxiv.org/pdf/2505.20862v2)**
...
>
---
#### [replaced 028] FameMind: Frame-Interleaved Video Reasoning via Reinforcement Learning
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.24008v2](http://arxiv.org/pdf/2509.24008v2)**
...
>
---
#### [replaced 035] PHASE-Net: Physics-Grounded Harmonic Attention System for Efficient Remote Photoplethysmography Measurement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.24850v2](http://arxiv.org/pdf/2509.24850v2)**
...
>
---
#### [replaced 036] How Do Large Vision-Language Models See Text in Image? Unveiling the Distinctive Role of OCR Heads
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.15865v2](http://arxiv.org/pdf/2505.15865v2)**
...
>
---
#### [replaced 037] Unified Cross-Modal Image Synthesis with Hierarchical Mixture of Product-of-Experts
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2410.19378v2](http://arxiv.org/pdf/2410.19378v2)**
...
>
---
#### [replaced 038] tenSVD algorithm for compression
- **分类: stat.CO; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.21686v2](http://arxiv.org/pdf/2505.21686v2)**
...
>
---
#### [replaced 039] VSSFlow: Unifying Video-conditioned Sound and Speech Generation via Joint Learning
...
>
---
#### [replaced 040] Deep Taxonomic Networks for Unsupervised Hierarchical Prototype Discovery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23602v2](http://arxiv.org/pdf/2509.23602v2)**

> **作者:** Zekun Wang; Ethan Haarer; Tianyi Zhu; Zhiyi Dai; Christopher J. MacLellan
>
> **备注:** NeurIPS 2025
>
...
>
---
#### [replaced 041] EditScore: Unlocking Online RL for Image Editing via High-Fidelity Reward Modeling
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23909v2](http://arxiv.org/pdf/2509.23909v2)**

> **作者:** Xin Luo; Jiahao Wang; Chenyuan Wu; Shitao Xiao; Xiyan Jiang; Defu Lian; Jiajun Zhang; Dong Liu; Zheng liu
>
> **备注:** Code, Models and benchmark will be publicly available at https://github.com/VectorSpaceLab/EditScore
>
...
>
---
#### [replaced 042] Object Detection with Multimodal Large Vision-Language Models: An In-depth Review
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 050] HumanVideo-MME: Benchmarking MLLMs for Human-Centric Video Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.04909v2](http://arxiv.org/pdf/2507.04909v2)**
...
>
---
#### [replaced 051] Texture Vector-Quantization and Reconstruction Aware Prediction for Generative Super-Resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23774v2](http://arxiv.org/pdf/2509.23774v2)**
...
>
---
#### [replaced 052] Decoupled Classifier-Free Guidance for Counterfactual Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.14399v4](http://arxiv.org/pdf/2506.14399v4)**
...
>
---
#### [replaced 053] SoMi-ToM: Evaluating Multi-Perspective Theory of Mind in Embodied Social Interactions
...
>
---
#### [replaced 054] UFO: A Unified Approach to Fine-grained Visual Perception via Open-ended Language Interface
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.01342v3](http://arxiv.org/pdf/2503.01342v3)**

> **作者:** Hao Tang; Chenwei Xie; Haiyang Wang; Xiaoyi Bao; Tingyu Weng; Pandeng Li; Yun Zheng; Liwei Wang
>
> **摘要:** Generalist models have achieved remarkable success in both language and vision-language tasks, showcasing the potential of unified modeling. However, effectively integrating fine-grained perception tasks like detection and segmentation into these models remains a significant challenge. This is primarily because these tasks often rely heavily on task-specific designs and architectures that can complicate the modeling process. To address this challenge, we present \ours, a framework that \textbf{U}nifies \textbf{F}ine-grained visual perception tasks through an \textbf{O}pen-ended language interface. By transforming all perception targets into the language space, \ours unifies object-level detection, pixel-level segmentation, and image-level vision-language tasks into a single model. Additionally, we introduce a novel embedding retrieval approach that relies solely on the language interface to support segmentation tasks. Our framework bridges the gap between fine-grained perception and vision-language tasks, significantly simplifying architectural design and training strategies while achieving comparable or superior performance to methods with intricate task-specific designs. After multi-task training on five standard visual perception datasets, \ours outperforms the previous state-of-the-art generalist models by 12.3 mAP on COCO instance segmentation and 3.3 mIoU on ADE20K semantic segmentation. Furthermore, our method seamlessly integrates with existing MLLMs, effectively combining fine-grained perception capabilities with their advanced language abilities, thereby enabling more challenging tasks such as reasoning segmentation. Code and models are available at https://github.com/nnnth/UFO.
>
---
#### [replaced 055] BoundMatch: Boundary detection applied to semi-supervised segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.23519v4](http://arxiv.org/pdf/2503.23519v4)**
...
>
---
#### [replaced 056] Developing Generalist Foundation Models from a Multimodal Dataset for 3D Computed Tomography
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.17834v4](http://arxiv.org/pdf/2403.17834v4)**
...
>
---
#### [replaced 057] Taming Diffusion Transformer for Efficient Mobile Video Generation in Seconds
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2507.13343v2](http://arxiv.org/pdf/2507.13343v2)**
...
>
---
#### [replaced 060] SPARE: Symmetrized Point-to-Plane Distance for Robust Non-Rigid 3D Registration
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2405.20188v3](http://arxiv.org/pdf/2405.20188v3)**

> **作者:** Yuxin Yao; Bailin Deng; Junhui Hou; Juyong Zhang
>
> **备注:** Accepted to IEEE Transactions on Pattern Analysis and Machine Intelligence
>
...
>
---
#### [replaced 061] Spatial Reasoning with Vision-Language Models in Ego-Centric Multi-View Scenes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.06266v2](http://arxiv.org/pdf/2509.06266v2)**
...
>
---
#### [replaced 062] VITA: Zero-Shot Value Functions via Test-Time Adaptation of Vision-Language Models
- **分类: cs.CV; cs.AI; I.2.6; I.2.9; I.2.10**

- **链接: [http://arxiv.org/pdf/2506.10085v2](http://arxiv.org/pdf/2506.10085v2)**
...
>
---
#### [replaced 063] MindVL: Towards Efficient and Effective Training of Multimodal Large Language Models on Ascend NPUs
...
>
---
#### [replaced 064] FoundBioNet: A Foundation-Based Model for IDH Genotyping of Glioma from Multi-Parametric MRI
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.06756v2](http://arxiv.org/pdf/2508.06756v2)**
...
>
---
#### [replaced 065] Max-Sliced Wasserstein Distance and its use for GANs
- **分类: cs.LG; cs.CV; stat.ML**

- **链接: [http://arxiv.org/pdf/1904.05877v2](http://arxiv.org/pdf/1904.05877v2)**
...
>
---
#### [replaced 068] iVISPAR -- An Interactive Visual-Spatial Reasoning Benchmark for VLMs
...
>
---
#### [replaced 069] ViewSpatial-Bench: Evaluating Multi-perspective Spatial Localization in Vision-Language Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 070] PathoHR: Hierarchical Reasoning for Vision-Language Models in Pathology
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.06105v2](http://arxiv.org/pdf/2509.06105v2)**
...
>
---
#### [replaced 071] tCURLoRA: Tensor CUR Decomposition Based Low-Rank Parameter Adaptation and Its Application in Medical Image Segmentation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2501.02227v3](http://arxiv.org/pdf/2501.02227v3)**

> **作者:** Guanghua He; Wangang Cheng; Hancan Zhu; Xiaohao Cai; Gaohang Yu
>
> **备注:** Accepted to MICCAI 2025. The final version of record is published in Springer LNCS
>
...
>
---
#### [replaced 072] Video models are zero-shot learners and reasoners
...
>
---
#### [replaced 073] VIMD: Monocular Visual-Inertial Motion and Depth Estimation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 078] v1: Learning to Point Visual Tokens for Multimodal Grounded Reasoning
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 079] BoxDreamer: Dreaming Box Corners for Generalizable Object Pose Estimation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.07955v2](http://arxiv.org/pdf/2504.07955v2)**
...
>
---
#### [replaced 087] A Culturally-diverse Multilingual Multimodal Video Benchmark & Model
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 090] Modeling Saliency Dataset Bias
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.10169v2](http://arxiv.org/pdf/2505.10169v2)**

> **作者:** Matthias Kümmerer; Harneet Singh Khanuja; Matthias Bethge
>
...
>
---
#### [replaced 091] OrthoLoC: UAV 6-DoF Localization and Calibration Using Orthographic Geodata
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 092] LiDAR-BIND-T: Improved and Temporally Consistent Sensor Modality Translation and Fusion for Robotic Applications
...
>
---
#### [replaced 095] FM-SIREN & FM-FINER: Nyquist-Informed Frequency Multiplier for Implicit Neural Representation with Periodic Activation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23438v2](http://arxiv.org/pdf/2509.23438v2)**
...
>
---
#### [replaced 096] Image-Conditioned 3D Gaussian Splat Quantization
- **分类: cs.CV; cs.AI; cs.GR**

- **链接: [http://arxiv.org/pdf/2508.15372v2](http://arxiv.org/pdf/2508.15372v2)**
...
>
---
#### [replaced 102] LargeAD: Large-Scale Cross-Sensor Data Pretraining for Autonomous Driving
...
>
---
#### [replaced 103] Causality-guided Prompt Learning for Vision-language Models via Visual Granulation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.03803v3](http://arxiv.org/pdf/2509.03803v3)**
...
>
---
#### [replaced 107] Teaching Metric Distance to Discrete Autoregressive Language Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.02379v3](http://arxiv.org/pdf/2503.02379v3)**
...
>
---
#### [replaced 108] Octic Vision Transformers: Quicker ViTs Through Equivariance
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.15441v4](http://arxiv.org/pdf/2505.15441v4)**
...
>
---
#### [replaced 109] QuantSparse: Comprehensively Compressing Video Diffusion Transformer with Model Quantization and Attention Sparsification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.23681v2](http://arxiv.org/pdf/2509.23681v2)**
...
>
---
#### [replaced 110] YOLO26: Key Architectural Enhancements and Performance Benchmarking for Real-Time Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.25164v2](http://arxiv.org/pdf/2509.25164v2)**
...
>
---
#### [replaced 116] Is It Certainly a Deepfake? Reliability Analysis in Detection & Generation Ecosystem
- **分类: cs.AI; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.17550v2](http://arxiv.org/pdf/2509.17550v2)**

> **作者:** Neslihan Kose; Anthony Rhodes; Umur Aybars Ciftci; Ilke Demir
>
> **备注:** The paper was submitted without the knowledge of co-authors and approval of the co-authors' institutes. It will be resubmitted later when the approvals are taken
>
...
>
---
#### [replaced 117] DecAlign: Hierarchical Cross-Modal Alignment for Decoupled Multimodal Representation Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.11892v2](http://arxiv.org/pdf/2503.11892v2)**
...
>
---
#### [replaced 118] Scaling RL to Long Videos
- **分类: cs.CV; cs.AI; cs.CL**
