...
#### [new 001] PsychePass: Calibrating LLM Therapeutic Competence via Trajectory-Anchored Tournaments
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于心理医疗领域，旨在解决LLM治疗能力评估不稳定的问题。通过轨迹锚定的对战框架，提升评估的稳定性和可靠性。**

- **链接: [https://arxiv.org/pdf/2601.20330v1](https://arxiv.org/pdf/2601.20330v1)**
...
>
---
#### [new 002] FastWhisper: Adaptive Self-knowledge Distillation for Real-time Automatic Speech Recognition
...
>
---
#### [new 005] Hopes and Fears -- Emotion Distribution in the Topic Landscape of Finnish Parliamentary Speech 2000-2020
- **分类: cs.CL**

- **简介: 该论文属于情感分析任务，旨在研究芬兰议会演讲中不同议题的情感分布。通过分析2000至2020年的演讲内容，揭示话题与情感之间的关联，填补了该领域的研究空白。**

- **链接: [https://arxiv.org/pdf/2601.20424v1](https://arxiv.org/pdf/2601.20424v1)**
...
>
---
#### [new 008] Me-Agent: A Personalized Mobile Agent with Two-Level User Habit Learning for Enhanced Interaction
- **分类: cs.CL**

- **简介: 该论文属于个性化移动代理任务，旨在解决用户指令模糊、缺乏历史学习和个性化处理的问题。提出Me-Agent，通过两层用户习惯学习提升个性化交互能力。**

- **链接: [https://arxiv.org/pdf/2601.20162v1](https://arxiv.org/pdf/2601.20162v1)**
...
>
---
#### [new 011] P2S: Probabilistic Process Supervision for General-Domain Reasoning Question Answering
- **分类: cs.CL**

- **简介: 该论文属于通用领域推理问答任务，旨在解决缺乏可验证奖励信号的问题。提出P2S框架，通过概率方式提供细粒度过程奖励，提升模型推理能力。**

- **链接: [https://arxiv.org/pdf/2601.20649v1](https://arxiv.org/pdf/2601.20649v1)**

> **作者:** Wenlin Zhong; Chengyuan Liu; Yiquan Wu; Bovin Tan; Changlong Sun; Yi Wang; Xiaozhong Liu; Kun Kuang
>
> **摘要:** While reinforcement learning with verifiable rewards (RLVR) has advanced LLM reasoning in structured domains like mathematics and programming, its application to general-domain reasoning tasks remains challenging due to the absence of verifiable reward signals. To this end, methods like Reinforcement Learning with Reference Probability Reward (RLPR) have emerged, leveraging the probability of generating the final answer as a reward signal. However, these outcome-focused approaches neglect crucial step-by-step supervision of the reasoning process itself. To address this gap, we introduce Probabilistic Process Supervision (P2S), a novel self-supervision framework that provides fine-grained process rewards without requiring a separate reward model or human-annotated reasoning steps. During reinforcement learning, P2S synthesizes and filters a high-quality reference reasoning chain (gold-CoT). The core of our method is to calculate a Path Faithfulness Reward (PFR) for each reasoning step, which is derived from the conditional probability of generating the gold-CoT's suffix, given the model's current reasoning prefix. Crucially, this PFR can be flexibly integrated with any outcome-based reward, directly tackling the reward sparsity problem by providing dense guidance. Extensive experiments on reading comprehension and medical Question Answering benchmarks show that P2S significantly outperforms strong baselines.
>
---
#### [new 012] Improving Diffusion Language Model Decoding through Joint Search in Generation Order and Token Space
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言模型解码任务，旨在解决当前方法仅依赖单一生成轨迹的问题。通过联合搜索生成顺序和词元空间，提升解码效果。**

- **链接: [https://arxiv.org/pdf/2601.20339v1](https://arxiv.org/pdf/2601.20339v1)**
...
>
---
#### [new 013] AgentIF-OneDay: A Task-level Instruction-Following Benchmark for General AI Agents in Daily Scenarios
- **分类: cs.CL**

- **简介: 该论文提出AgentIF-OneDay基准，用于评估AI代理在日常任务中的表现，解决现有评测缺乏任务多样性的问题。工作包括设计多类任务及评价体系。**

- **链接: [https://arxiv.org/pdf/2601.20613v1](https://arxiv.org/pdf/2601.20613v1)**
...
>
---
#### [new 014] Improving X-Codec-2.0 for Multi-Lingual Speech: 25 Hz Latent Rate and 24 kHz Sampling
- **分类: cs.CL; cs.SD**
...
>
---
#### [new 027] LinguaMap: Which Layers of LLMs Speak Your Language and How to Tune Them?
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于多语言模型优化任务，旨在解决语言控制不足的问题。通过分析模型层结构，提出仅微调末尾层的方法，提升多语言一致性，同时减少计算资源消耗。**

- **链接: [https://arxiv.org/pdf/2601.20009v1](https://arxiv.org/pdf/2601.20009v1)**
...
>
---
#### [new 038] SpeechMapper: Speech-to-text Embedding Projector for LLMs
- **分类: cs.CL**

- **简介: 该论文提出SpeechMapper，解决语音到文本嵌入的高效整合问题。通过预训练和少量微调，提升模型泛化能力，降低计算成本。任务为语音-语言模型融合。**

- **链接: [https://arxiv.org/pdf/2601.20417v1](https://arxiv.org/pdf/2601.20417v1)**
...
>
---
#### [new 041] QueerGen: How LLMs Reflect Societal Norms on Gender and Sexuality in Sentence Completion Tasks
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文属于自然语言处理中的偏见分析任务，旨在探究LLMs如何反映社会性别与性取向规范，通过句子补全任务分析模型生成文本中的情感、尊重度等偏差。**

- **链接: [https://arxiv.org/pdf/2601.20731v1](https://arxiv.org/pdf/2601.20731v1)**

> **作者:** Mae Sosto; Delfina Sol Martinez Pandiani; Laura Hollink
>
> **摘要:** This paper examines how Large Language Models (LLMs) reproduce societal norms, particularly heterocisnormativity, and how these norms translate into measurable biases in their text generations. We investigate whether explicit information about a subject's gender or sexuality influences LLM responses across three subject categories: queer-marked, non-queer-marked, and the normalized "unmarked" category. Representational imbalances are operationalized as measurable differences in English sentence completions across four dimensions: sentiment, regard, toxicity, and prediction diversity. Our findings show that Masked Language Models (MLMs) produce the least favorable sentiment, higher toxicity, and more negative regard for queer-marked subjects. Autoregressive Language Models (ARLMs) partially mitigate these patterns, while closed-access ARLMs tend to produce more harmful outputs for unmarked subjects. Results suggest that LLMs reproduce normative social assumptions, though the form and degree of bias depend strongly on specific model characteristics, which may redistribute, but not eliminate, representational harms.
>
---
#### [new 042] Towards a Mechanistic Understanding of Large Reasoning Models: A Survey of Training, Inference, and Failures
- **分类: cs.CL**

- **简介: 该论文属于机制理解任务，旨在解析大型推理模型的训练、推理及故障机制，解决黑盒性能与透明性之间的差距，通过综述现有研究提出未来研究方向。**

- **链接: [https://arxiv.org/pdf/2601.19928v1](https://arxiv.org/pdf/2601.19928v1)**

> **作者:** Yi Hu; Jiaqi Gu; Ruxin Wang; Zijun Yao; Hao Peng; Xiaobao Wu; Jianhui Chen; Muhan Zhang; Liangming Pan
>
> **摘要:** Reinforcement learning (RL) has catalyzed the emergence of Large Reasoning Models (LRMs) that have pushed reasoning capabilities to new heights. While their performance has garnered significant excitement, exploring the internal mechanisms driving these behaviors has become an equally critical research frontier. This paper provides a comprehensive survey of the mechanistic understanding of LRMs, organizing recent findings into three core dimensions: 1) training dynamics, 2) reasoning mechanisms, and 3) unintended behaviors. By synthesizing these insights, we aim to bridge the gap between black-box performance and mechanistic transparency. Finally, we discuss under-explored challenges to outline a roadmap for future mechanistic studies, including the need for applied interpretability, improved methodologies, and a unified theoretical framework.
>
---
#### [new 043] Simulating Complex Multi-Turn Tool Calling Interactions in Stateless Execution Environments
- **分类: cs.CL; cs.AI; cs.SE**

- **简介: 该论文属于自然语言处理任务，解决多轮工具调用对话生成问题。针对无状态环境下的数据生成不足，提出DiGiT-TC方法，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.19914v1](https://arxiv.org/pdf/2601.19914v1)**
...
>
---
#### [new 044] Rewarding Intellectual Humility Learning When Not To Answer In Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型的幻觉问题。通过设计可验证奖励机制，鼓励模型在不确定时拒绝回答，提升可靠性。**

- **链接: [https://arxiv.org/pdf/2601.20126v1](https://arxiv.org/pdf/2601.20126v1)**
...
>
---
#### [new 045] Beyond Speedup -- Utilizing KV Cache for Sampling and Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于大模型推理任务，旨在提升采样与推理效率。通过利用KV缓存作为轻量表示，减少计算开销，实现快速推理和准确采样。**

- **链接: [https://arxiv.org/pdf/2601.20326v1](https://arxiv.org/pdf/2601.20326v1)**
...
>
---
#### [new 046] Persona Prompting as a Lens on LLM Social Reasoning
- **分类: cs.CL**

- **简介: 该论文研究Persona Prompting对LLM社会推理的影响，旨在提升 hate speech 检测的解释质量。通过实验发现PP在分类上有帮助，但降低解释质量并无法缓解偏见。**

- **链接: [https://arxiv.org/pdf/2601.20757v1](https://arxiv.org/pdf/2601.20757v1)**

> **作者:** Jing Yang; Moritz Hechtbauer; Elisabeth Khalilov; Evelyn Luise Brinkmann; Vera Schmitt; Nils Feldhus
>
> **备注:** 9 Pages, EACL main
>
> **摘要:** For socially sensitive tasks like hate speech detection, the quality of explanations from Large Language Models (LLMs) is crucial for factors like user trust and model alignment. While Persona prompting (PP) is increasingly used as a way to steer model towards user-specific generation, its effect on model rationales remains underexplored. We investigate how LLM-generated rationales vary when conditioned on different simulated demographic personas. Using datasets annotated with word-level rationales, we measure agreement with human annotations from different demographic groups, and assess the impact of PP on model bias and human alignment. Our evaluation across three LLMs results reveals three key findings: (1) PP improving classification on the most subjective task (hate speech) but degrading rationale quality. (2) Simulated personas fail to align with their real-world demographic counterparts, and high inter-persona agreement shows models are resistant to significant steering. (3) Models exhibit consistent demographic biases and a strong tendency to over-flag content as harmful, regardless of PP. Our findings reveal a critical trade-off: while PP can improve classification in socially-sensitive tasks, it often comes at the cost of rationale quality and fails to mitigate underlying biases, urging caution in its application.
>
---
#### [new 047] Unit-Based Agent for Semi-Cascaded Full-Duplex Dialogue Systems
- **分类: cs.CL; cs.HC**

- **简介: 该论文属于对话系统任务，旨在解决全双工对话中的复杂交互问题。通过分解对话为最小单元，实现独立处理与状态转换，构建了一个高效的半级联系统。**

- **链接: [https://arxiv.org/pdf/2601.20230v1](https://arxiv.org/pdf/2601.20230v1)**
...
>
---
#### [new 048] "Newspaper Eat" Means "Not Tasty": A Taxonomy and Benchmark for Coded Languages in Real-World Chinese Online Reviews
- **分类: cs.CL; cs.HC**

- **简介: 该论文研究中文在线评论中的编码语言，提出CodedLang数据集和七类分类体系，解决编码语言识别与理解问题。**

- **链接: [https://arxiv.org/pdf/2601.19932v1](https://arxiv.org/pdf/2601.19932v1)**
...
>
---
#### [new 049] VERGE: Formal Refinement and Guidance Engine for Verifiable LLM Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出VERGE框架，解决LLM逻辑正确性问题。通过结合LLM与SMT求解器，实现验证引导的推理，提升高风险领域推理的可信度。**

- **链接: [https://arxiv.org/pdf/2601.20055v1](https://arxiv.org/pdf/2601.20055v1)**

> **作者:** Vikash Singh; Darion Cassel; Nathaniel Weir; Nick Feng; Sam Bayless
>
> **摘要:** Despite the syntactic fluency of Large Language Models (LLMs), ensuring their logical correctness in high-stakes domains remains a fundamental challenge. We present a neurosymbolic framework that combines LLMs with SMT solvers to produce verification-guided answers through iterative refinement. Our approach decomposes LLM outputs into atomic claims, autoformalizes them into first-order logic, and verifies their logical consistency using automated theorem proving. We introduce three key innovations: (1) multi-model consensus via formal semantic equivalence checking to ensure logic-level alignment between candidates, eliminating the syntactic bias of surface-form metrics, (2) semantic routing that directs different claim types to appropriate verification strategies: symbolic solvers for logical claims and LLM ensembles for commonsense reasoning, and (3) precise logical error localization via Minimal Correction Subsets (MCS), which pinpoint the exact subset of claims to revise, transforming binary failure signals into actionable feedback. Our framework classifies claims by their logical status and aggregates multiple verification signals into a unified score with variance-based penalty. The system iteratively refines answers using structured feedback until acceptance criteria are met or convergence is achieved. This hybrid approach delivers formal guarantees where possible and consensus verification elsewhere, advancing trustworthy AI. With the GPT-OSS-120B model, VERGE demonstrates an average performance uplift of 18.7% at convergence across a set of reasoning benchmarks compared to single-pass approaches.
>
---
#### [new 050] Stingy Context: 18:1 Hierarchical Code Compression for LLM Auto-Coding
- **分类: cs.CL; cs.AI; cs.SE**

- **简介: 该论文属于LLM自动编码任务，解决上下文过长问题。提出Stingy Context压缩方法，实现18:1的token缩减，保持任务准确性。**

- **链接: [https://arxiv.org/pdf/2601.19929v1](https://arxiv.org/pdf/2601.19929v1)**
...
>
---
#### [new 051] CE-RM: A Pointwise Generative Reward Model Optimized via Two-Stage Rollout and Unified Criteria
- **分类: cs.CL**

- **简介: 该论文属于自然语言生成的评估任务，旨在解决传统方法在强化学习中的效果不足问题。提出CE-RM-4B模型，通过两阶段滚动和统一标准优化，提升生成质量。**

- **链接: [https://arxiv.org/pdf/2601.20327v1](https://arxiv.org/pdf/2601.20327v1)**
...
>
---
#### [new 062] Evaluating Large Language Models for Abstract Evaluation Tasks: An Empirical Study
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本评估任务，研究LLMs在学术摘要评价中的表现，探讨其与人类评审的一致性及可靠性。**

- **链接: [https://arxiv.org/pdf/2601.19925v1](https://arxiv.org/pdf/2601.19925v1)**
...
>
---
#### [new 063] Text-to-State Mapping for Non-Resolution Reasoning: The Contradiction-Preservation Principle
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，解决文本到形式状态映射问题。提出文本到状态映射函数φ及矛盾保留原则，保持语义模糊性，提升语言模型推理能力。**

- **链接: [https://arxiv.org/pdf/2601.19933v1](https://arxiv.org/pdf/2601.19933v1)**
...
>
---
#### [new 064] OPT-Engine: Benchmarking the Limits of LLMs in Optimization Modeling via Complexity Scaling
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出OPT-ENGINE基准框架，用于评估大语言模型在优化建模中的能力。旨在解决模型在复杂任务中的泛化能力和瓶颈问题。**

- **链接: [https://arxiv.org/pdf/2601.19924v1](https://arxiv.org/pdf/2601.19924v1)**
...
>
---
#### [new 065] Mem2ActBench: A Benchmark for Evaluating Long-Term Memory Utilization in Task-Oriented Autonomous Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出Mem2ActBench，用于评估任务导向代理的长期记忆应用能力。解决现有基准无法测试主动记忆使用的问题，通过构建数据集和任务，验证当前系统在参数定位上的不足。**

- **链接: [https://arxiv.org/pdf/2601.19935v1](https://arxiv.org/pdf/2601.19935v1)**
...
>
---
#### [new 066] MiLorE-SSL: Scaling Multilingual Capabilities in Self-Supervised Models without Forgetting
- **分类: cs.CL; eess.AS**
...
>
---
#### [new 067] CascadeMind at SemEval-2026 Task 4: A Hybrid Neuro-Symbolic Cascade for Narrative Similarity
- **分类: cs.CL**

- **简介: 该论文属于SemEval-2026任务4，解决叙事相似性问题。提出混合神经符号系统，结合神经网络与符号分析，提升叙事比较准确性。**

- **链接: [https://arxiv.org/pdf/2601.19931v1](https://arxiv.org/pdf/2601.19931v1)**
...
>
---
#### [new 071] SDUs DAISY: A Benchmark for Danish Culture
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出一个丹麦文化基准数据集SDUs DAISY，用于评估对丹麦文化遗产的理解。任务是构建包含741个问答对的高质量数据集，涵盖从古代到现代的多领域文化内容。**

- **链接: [https://arxiv.org/pdf/2601.19930v1](https://arxiv.org/pdf/2601.19930v1)**
...
>
---
#### [new 078] Spark: Strategic Policy-Aware Exploration via Dynamic Branching for Long-Horizon Agentic Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出Spark框架，解决长周期智能体学习中的资源浪费与样本质量低问题，通过关键状态分支实现高效探索。**

- **链接: [https://arxiv.org/pdf/2601.20209v1](https://arxiv.org/pdf/2601.20209v1)**
...
>
---
#### [new 079] Harder Is Better: Boosting Mathematical Reasoning via Difficulty-Aware GRPO and Multi-Aspect Question Reformulation
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于数学推理任务，旨在解决现有方法对难题关注不足的问题。提出MathForge框架，结合难度感知的GRPO和多方面题目重写策略，提升模型推理能力。**

- **链接: [https://arxiv.org/pdf/2601.20614v1](https://arxiv.org/pdf/2601.20614v1)**

> **作者:** Yanqi Dai; Yuxiang Ji; Xiao Zhang; Yong Wang; Xiangxiang Chu; Zhiwu Lu
>
> **备注:** Accepted for ICLR 2026
>
> **摘要:** Reinforcement Learning with Verifiable Rewards (RLVR) offers a robust mechanism for enhancing mathematical reasoning in large models. However, we identify a systematic lack of emphasis on more challenging questions in existing methods from both algorithmic and data perspectives, despite their importance for refining underdeveloped capabilities. Algorithmically, widely used Group Relative Policy Optimization (GRPO) suffers from an implicit imbalance where the magnitude of policy updates is lower for harder questions. Data-wise, augmentation approaches primarily rephrase questions to enhance diversity without systematically increasing intrinsic difficulty. To address these issues, we propose a two-dual MathForge framework to improve mathematical reasoning by targeting harder questions from both perspectives, which comprises a Difficulty-Aware Group Policy Optimization (DGPO) algorithm and a Multi-Aspect Question Reformulation (MQR) strategy. Specifically, DGPO first rectifies the implicit imbalance in GRPO via difficulty-balanced group advantage estimation, and further prioritizes harder questions by difficulty-aware question-level weighting. Meanwhile, MQR reformulates questions across multiple aspects to increase difficulty while maintaining the original gold answer. Overall, MathForge forms a synergistic loop: MQR expands the data frontier, and DGPO effectively learns from the augmented data. Extensive experiments show that MathForge significantly outperforms existing methods on various mathematical reasoning tasks. The code and augmented data are all available at https://github.com/AMAP-ML/MathForge.
>
---
#### [new 080] Training Reasoning Models on Saturated Problems via Failure-Prefix Conditioning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决LLM在饱和问题上训练停滞的问题。通过失败前缀条件化方法，提升模型从罕见错误中学习的能力，增强训练效果。**

- **链接: [https://arxiv.org/pdf/2601.20829v1](https://arxiv.org/pdf/2601.20829v1)**
...
>
---
#### [new 081] PathWise: Planning through World Model for Automated Heuristic Design via Self-Evolving LLMs
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自动化启发式设计任务，解决传统框架在组合优化问题中生成启发式方法效率低、缺乏推理的问题。提出PathWise框架，通过状态感知规划提升启发式生成效果。**

- **链接: [https://arxiv.org/pdf/2601.20539v1](https://arxiv.org/pdf/2601.20539v1)**
...
>
---
#### [new 082] What's the plan? Metrics for implicit planning in LLMs and their application to rhyme generation and question answering
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究语言模型的隐式规划能力，通过 rhyme 生成和问答任务验证方法有效性，发现小型模型也具备此能力，为 AI 安全提供参考。**

- **链接: [https://arxiv.org/pdf/2601.20164v1](https://arxiv.org/pdf/2601.20164v1)**
...
>
---
#### [new 085] One Word is Enough: Minimal Adversarial Perturbations for Neural Text Ranking
- **分类: cs.IR; cs.CL; cs.LG**

- **简介: 该论文研究神经文本排序模型的鲁棒性问题，提出一种仅需修改一个词的对抗攻击方法，以提升目标文档排名。**

- **链接: [https://arxiv.org/pdf/2601.20283v1](https://arxiv.org/pdf/2601.20283v1)**
...
>
---
#### [new 086] CtrlCoT: Dual-Granularity Chain-of-Thought Compression for Controllable Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出CtrlCoT，解决链式思维压缩问题，通过双粒度方法提升推理效率与准确性。**

- **链接: [https://arxiv.org/pdf/2601.20467v1](https://arxiv.org/pdf/2601.20467v1)**
...
>
---
#### [new 087] Scaling Medical Reasoning Verification via Tool-Integrated Reinforcement Learning
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于医疗推理验证任务，解决大模型在临床应用中的事实准确性问题。通过引入迭代强化学习框架，结合外部知识检索，提升验证效果并减少资源消耗。**

- **链接: [https://arxiv.org/pdf/2601.20221v1](https://arxiv.org/pdf/2601.20221v1)**

> **作者:** Hang Zhang; Ruheng Wang; Yuelyu Ji; Mingu Kwak; Xizhi Wu; Chenyu Li; Li Zhang; Wenqi Shi; Yifan Peng; Yanshan Wang
>
> **摘要:** Large language models have achieved strong performance on medical reasoning benchmarks, yet their deployment in clinical settings demands rigorous verification to ensure factual accuracy. While reward models offer a scalable approach for reasoning trace verification, existing methods face two limitations: they produce only scalar reward values without explicit justification, and they rely on single-pass retrieval that precludes adaptive knowledge access as verification unfolds. We introduce $\method$, an agentic framework that addresses these limitations by training medical reasoning verifiers to iteratively query external medical corpora during evaluation. Our approach combines tool-augmented verification with an iterative reinforcement learning paradigm that requires only trace-level supervision, alongside an adaptive curriculum mechanism that dynamically adjusts training data distribution. Across four medical reasoning benchmarks, $\method$ achieves substantial gains over existing methods, improving MedQA accuracy by 23.5% and MedXpertQA by 32.0% relative to the base generator in particular. Crucially, $\method$ demonstrates an $\mathbf{8\times}$ reduction in sampling budget requirement compared to prior reward model baselines. These findings establish that grounding verification in dynamically retrieved evidence offers a principled path toward more reliable medical reasoning systems.
>
---
#### [new 088] Insight Agents: An LLM-Based Multi-Agent System for Data Insights
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出Insight Agents系统，解决电商卖家数据利用困难的问题。基于LLM的多智能体系统，实现高效数据洞察与决策支持。**

- **链接: [https://arxiv.org/pdf/2601.20048v1](https://arxiv.org/pdf/2601.20048v1)**
...
>
---
#### [new 089] LLM-AutoDP: Automatic Data Processing via LLM Agents for Model Fine-tuning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于模型微调中的数据处理任务，旨在解决低质量数据影响模型性能的问题。提出LLM-AutoDP框架，利用LLM自动生成优化数据处理策略，提升效果与效率。**

- **链接: [https://arxiv.org/pdf/2601.20375v1](https://arxiv.org/pdf/2601.20375v1)**
...
>
---
#### [new 092] Gap-K%: Measuring Top-1 Prediction Gap for Detecting Pretraining Data
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于预训练数据检测任务，旨在解决LLM预训练数据隐私问题。提出Gap-K%方法，通过分析模型预测与目标token的差异来检测数据。**

- **链接: [https://arxiv.org/pdf/2601.19936v1](https://arxiv.org/pdf/2601.19936v1)**
...
>
---
#### [new 093] Evolutionary Strategies lead to Catastrophic Forgetting in LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于持续学习任务，研究ES在LLMs中的遗忘问题。工作包括分析ES的遗忘曲线，对比GRPO，发现ES更新更密集且范数更大，导致显著遗忘。**

- **链接: [https://arxiv.org/pdf/2601.20861v1](https://arxiv.org/pdf/2601.20861v1)**
...
>
---
#### [new 094] RIR-Mega-Speech: A Reverberant Speech Corpus with Comprehensive Acoustic Metadata and Reproducible Evaluation
...
>
---
#### [new 095] Look in the Middle: Structural Anchor Pruning for Scalable Visual RAG Indexing
...
>
---
#### [new 096] HE-SNR: Uncovering Latent Logic via Entropy for Guiding Mid-Training on SWE-BENCH
- **分类: cs.LG; cs.CL; cs.SE**

- **简介: 该论文属于软件工程与大语言模型领域，旨在解决中训练阶段评估指标不足的问题。提出HE-SNR指标，通过熵分析提升模型性能预测能力。**

- **链接: [https://arxiv.org/pdf/2601.20255v1](https://arxiv.org/pdf/2601.20255v1)**
...
>
---
#### [new 097] TABED: Test-Time Adaptive Ensemble Drafting for Robust Speculative Decoding in LVLMs
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于大模型推理加速任务，解决LVLMs中推测解码的鲁棒性问题。提出TABED方法，通过动态集成多份 drafts 提高速度与稳定性。**

- **链接: [https://arxiv.org/pdf/2601.20357v1](https://arxiv.org/pdf/2601.20357v1)**
...
#### [replaced 001] Cochain: Balancing Insufficient and Excessive Collaboration in LLM Agent Workflows
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM代理工作流中协作不足与过度的问题。提出Cochain框架，通过知识图谱和提示树提升协作效率。**

- **链接: [https://arxiv.org/pdf/2505.10936v2](https://arxiv.org/pdf/2505.10936v2)**
...
>
---
#### [replaced 002] Quantifying Speaker Embedding Phonological Rule Interactions in Accented Speech Synthesis
- **分类: cs.CL**

- **简介: 该论文研究语音合成中发音规则与说话人嵌入的交互，旨在提升方言和口音控制的可解释性。通过设计新指标评估规则与嵌入的相互作用，增强合成语音的真实性。**

- **链接: [https://arxiv.org/pdf/2601.14417v2](https://arxiv.org/pdf/2601.14417v2)**
...
>
---
#### [replaced 008] Reasoning in the Dark: Interleaved Vision-Text Reasoning in Latent Space
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 009] RPO-RAG: Aligning Small LLMs with Relation-aware Preference Optimization for Knowledge Graph Question Answering
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识图谱问答任务，旨在提升小规模语言模型的推理能力。针对现有方法在路径采样和对齐上的不足，提出RPO-RAG框架，优化知识检索与生成过程。**

- **链接: [https://arxiv.org/pdf/2601.19225v2](https://arxiv.org/pdf/2601.19225v2)**
...
>
---
#### [replaced 013] Closing the Data-Efficiency Gap Between Autoregressive and Masked Diffusion LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究知识微调任务，解决arLLMs依赖数据增强和易受反转诅咒的问题。通过引入掩码微调，提升模型知识注入效果，缩小与dLLMs的差距。**

- **链接: [https://arxiv.org/pdf/2510.09885v3](https://arxiv.org/pdf/2510.09885v3)**
...
>
---
#### [replaced 014] ColorConceptBench: A Benchmark for Probabilistic Color-Concept Understanding in Text-to-Image Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 017] COMMUNITYNOTES: A Dataset for Exploring the Helpfulness of Fact-Checking Explanations
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出COMMUNITYNOTES数据集，解决社区解释帮助性评估问题。通过预测解释的有用性和原因，提升事实核查系统效果。**

- **链接: [https://arxiv.org/pdf/2510.24810v2](https://arxiv.org/pdf/2510.24810v2)**
...
>
---
#### [replaced 018] Reducing Hallucinations in Language Model-based SPARQL Query Generation Using Post-Generation Memory Retrieval
- **分类: cs.CL**

- **简介: 该论文属于自然语言到SPARQL查询生成任务，旨在解决LLM生成KG元素时的幻觉问题。通过引入PGMR框架，使用记忆检索修正URI，提升查询准确性和安全性。**

- **链接: [https://arxiv.org/pdf/2502.13369v3](https://arxiv.org/pdf/2502.13369v3)**

> **作者:** Aditya Sharma; Christopher J. Pal; Amal Zouaq
>
> **摘要:** The ability to generate SPARQL queries from natural language questions is crucial for ensuring efficient and accurate retrieval of structured data from knowledge graphs (KG). While large language models (LLMs) have been widely adopted for SPARQL query generation, they are often susceptible to hallucinations and out-of-distribution errors when generating KG elements, such as Uniform Resource Identifiers (URIs), based on opaque internal parametric knowledge. We propose PGMR (Post-Generation Memory Retrieval), a modular framework where the LLM produces an intermediate query using natural language placeholders for URIs, and a non-parametric memory module is subsequently employed to retrieve and resolve the correct KG URIs. PGMR significantly enhances query correctness (SQM) across various LLMs, datasets, and distribution shifts, while achieving the near-complete suppression of URI hallucinations. Critically, we demonstrate PGMR's superior safety and robustness: a retrieval confidence threshold enables PGMR to effectively refuse to answer queries that lack support, and the retriever proves highly resilient to memory noise, maintaining strong performance even when the non-parametric memory size is scaled up to 9 times with irrelevant, distracting entities.
>
---
#### [replaced 019] Rewarding Doubt: A Reinforcement Learning Approach to Calibrated Confidence Expression of Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型置信度校准任务，旨在解决模型回答事实性问题时无法准确表达信心的问题。通过强化学习方法，使模型生成答案时同步输出校准的置信度。**

- **链接: [https://arxiv.org/pdf/2503.02623v5](https://arxiv.org/pdf/2503.02623v5)**
...
>
---
#### [replaced 020] Epistemic Constitutionalism Or: how to avoid coherence bias
- **分类: cs.AI; cs.CL; cs.CY**

- **简介: 该论文属于AI伦理与认知研究任务，旨在解决大模型中的信念形成偏误问题。提出建立显性、可争议的AI认知宪法，以规范其信念生成与表达机制。**

- **链接: [https://arxiv.org/pdf/2601.14295v2](https://arxiv.org/pdf/2601.14295v2)**
...
>
---
#### [replaced 021] Look Back to Reason Forward: Revisitable Memory for Long-Context LLM Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于长文本问答任务，解决长上下文信息丢失与推理不足问题。提出ReMemR1框架，结合记忆检索与多级奖励机制，提升模型对长距离证据的利用能力。**

- **链接: [https://arxiv.org/pdf/2509.23040v2](https://arxiv.org/pdf/2509.23040v2)**
...
>
---
#### [replaced 022] LLMs versus the Halting Problem: Revisiting Program Termination Prediction
- **分类: cs.CL; cs.AI; cs.PL**

- **简介: 论文探讨了大语言模型在程序终止性预测任务中的表现，旨在解决自动验证工具在处理不可判定问题时的局限。研究评估了LLMs在C程序上的终止预测能力，发现其效果良好但存在局限。**

- **链接: [https://arxiv.org/pdf/2601.18987v2](https://arxiv.org/pdf/2601.18987v2)**
...
>
---
#### [replaced 023] In-context Language Learning for Endangered Languages in Speech Recognition
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语音识别任务，研究如何让大语言模型通过上下文学习掌握濒危低资源语言。工作包括实验验证文本样本对性能的影响及概率方法的优势。**

- **链接: [https://arxiv.org/pdf/2505.20445v5](https://arxiv.org/pdf/2505.20445v5)**
...
>
---
#### [replaced 024] Marriage Discourse on Chinese Social Media: An LLM-assisted Analysis
- **分类: econ.GN; cs.CL**

- **简介: 该论文分析中国社交媒体上的婚姻话题，使用大语言模型研究情感与道德元素，旨在理解婚姻下降背后的社会态度。**

- **链接: [https://arxiv.org/pdf/2512.23609v2](https://arxiv.org/pdf/2512.23609v2)**
...
>
---
#### [replaced 025] LLM Prompt Duel Optimizer: Efficient Label-Free Prompt Optimization
- **分类: cs.CL; stat.ML**

- **简介: 该论文属于自然语言处理中的提示优化任务，解决无标签数据下的提示优化问题。提出PDO框架，利用LLM判断的偏好反馈高效选择最优提示。**

- **链接: [https://arxiv.org/pdf/2510.13907v2](https://arxiv.org/pdf/2510.13907v2)**
...
>
---
#### [replaced 026] Library Hallucinations in LLMs: Risk Analysis Grounded in Developer Queries
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于自然语言处理任务，研究LLM生成代码时的库幻觉问题。通过实验分析不同提示对幻觉率的影响，揭示系统性漏洞并提出缓解方向。**

- **链接: [https://arxiv.org/pdf/2509.22202v2](https://arxiv.org/pdf/2509.22202v2)**
...
>
---
#### [replaced 029] HOMURA: Taming the Sand-Glass for Time-Constrained LLM Translation via Reinforcement Learning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于机器翻译任务，旨在解决时间约束下的翻译长度控制问题。通过引入Sand-Glass基准和HOMURA框架，实现语义与时间的平衡优化。**

- **链接: [https://arxiv.org/pdf/2601.10187v2](https://arxiv.org/pdf/2601.10187v2)**
...
>
---
#### [replaced 030] WaveSP-Net: Learnable Wavelet-Domain Sparse Prompt Tuning for Speech Deepfake Detection
...
>
---
#### [replaced 031] Summaries as Centroids for Interpretable and Scalable Text Clustering
- **分类: cs.CL; cs.LG; stat.ML**

- **简介: 该论文提出k-NLPmeans和k-LLMmeans，用于可解释且可扩展的文本聚类，解决传统方法难以生成人类可读聚类中心的问题。**

- **链接: [https://arxiv.org/pdf/2502.09667v4](https://arxiv.org/pdf/2502.09667v4)**
...
>
---
#### [replaced 032] LogogramNLP: Comparing Visual and Textual Representations of Ancient Logographic Writing Systems for NLP
...
>
---
#### [replaced 033] Beyond Correctness: Evaluating Subjective Writing Preferences Across Cultures
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的偏好学习任务，旨在解决模型在主观写作偏好上的评估问题。通过构建跨文化写作偏好数据集，对比不同模型的性能，发现当前方法主要关注客观错误而非主观质量。**

- **链接: [https://arxiv.org/pdf/2510.14616v2](https://arxiv.org/pdf/2510.14616v2)**

> **作者:** Shuangshuang Ying; Yunwen Li; Xingwei Qu; Xin Li; Sheng Jin; Minghao Liu; Zhoufutu Wen; Xeron Du; Tianyu Zheng; Yichi Zhang; Letian Ni; Yuyang Cheng; Zhenzhu Yang; Qiguang Chen; Jingzhe Ding; Shengda Long; Wangchunshu Zhou; Jiazhan Feng; Wanjun Zhong; Libo Qin; Ge Zhang; Wenhao Huang; Wanxiang Che; Chenghua Lin
>
...
>
---
#### [replaced 037] Structure-Aware Decoding Mechanisms for Complex Entity Extraction with Large-Scale Language Models
- **分类: cs.CL**

- **简介: 该论文属于复杂实体抽取任务，旨在解决嵌套与重叠实体的语义完整性和结构一致性问题。提出结构感知解码方法，结合候选跨度生成和结构注意力建模，提升抽取精度。**

- **链接: [https://arxiv.org/pdf/2512.13980v2](https://arxiv.org/pdf/2512.13980v2)**
...
>
---
#### [replaced 038] Demystifying the Slash Pattern in Attention: The Role of RoPE
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究注意力机制中的斜线模式，分析其成因。属于自然语言处理任务，解决LLM中SDHs出现的问题，通过理论与实证分析揭示RoPE的作用。**

- **链接: [https://arxiv.org/pdf/2601.08297v2](https://arxiv.org/pdf/2601.08297v2)**

> **作者:** Yuan Cheng; Fengzhuo Zhang; Yunlong Hou; Cunxiao Du; Chao Du; Tianyu Pang; Aixin Sun; Zhuoran Yang
>
> **摘要:** Large Language Models (LLMs) often exhibit slash attention patterns, where attention scores concentrate along the $Δ$-th sub-diagonal for some offset $Δ$. These patterns play a key role in passing information across tokens. But why do they emerge? In this paper, we demystify the emergence of these Slash-Dominant Heads (SDHs) from both empirical and theoretical perspectives. First, by analyzing open-source LLMs, we find that SDHs are intrinsic to models and generalize to out-of-distribution prompts. To explain the intrinsic emergence, we analyze the queries, keys, and Rotary Position Embedding (RoPE), which jointly determine attention scores. Our empirical analysis reveals two characteristic conditions of SDHs: (1) Queries and keys are almost rank-one, and (2) RoPE is dominated by medium- and high-frequency components. Under these conditions, queries and keys are nearly identical across tokens, and interactions between medium- and high-frequency components of RoPE give rise to SDHs. Beyond empirical evidence, we theoretically show that these conditions are sufficient to ensure the emergence of SDHs by formalizing them as our modeling assumptions. Particularly, we analyze the training dynamics of a shallow Transformer equipped with RoPE under these conditions, and prove that models trained via gradient descent exhibit SDHs. The SDHs generalize to out-of-distribution prompts.
>
---
#### [replaced 039] Attention Projection Mixing with Exogenous Anchors
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决跨层注意力投影的结构冲突问题。提出ExoFormer，通过外部锚点实现更稳定的注意力混合，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.08131v3](https://arxiv.org/pdf/2601.08131v3)**
...
>
---
#### [replaced 040] Diagnosing Vision Language Models' Perception by Leveraging Human Methods for Color Vision Deficiencies
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 041] PEARL: Self-Evolving Assistant for Time Management with Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于时间管理任务，解决日历冲突自动决策问题。提出PEARL框架，通过强化学习优化语言代理，提升日程安排准确性。**

- **链接: [https://arxiv.org/pdf/2601.11957v2](https://arxiv.org/pdf/2601.11957v2)**
...
>
---
#### [replaced 042] PLawBench: A Rubric-Based Benchmark for Evaluating LLMs in Real-World Legal Practice
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文提出PLawBench，用于评估大语言模型在真实法律场景中的表现。针对现有基准不足，设计三类任务，涵盖法律咨询、案例分析和文书生成，以细粒度评估模型的法律推理能力。**

- **链接: [https://arxiv.org/pdf/2601.16669v2](https://arxiv.org/pdf/2601.16669v2)**
...
>
---
#### [replaced 043] Rethinking Creativity Evaluation: A Critical Analysis of Existing Creativity Evaluations
- **分类: cs.CL**

- **简介: 该论文属于创造力评估任务，旨在解决现有评估方法不一致的问题。通过分析四种指标在不同领域的表现，揭示其局限性，并呼吁更可靠的评估框架。**

- **链接: [https://arxiv.org/pdf/2508.05470v4](https://arxiv.org/pdf/2508.05470v4)**
...
>
---
#### [replaced 044] Are LLMs Really Not Knowledgeable? Mining the Submerged Knowledge in LLMs' Memory
- **分类: cs.CL**

- **简介: 该论文属于知识问答任务，旨在解决LLMs在QA中因幻觉和不确定性导致的性能问题。研究发现LLMs保留了大量未被利用的正确知识，并提出新指标评估其潜在知识。**

- **链接: [https://arxiv.org/pdf/2412.20846v2](https://arxiv.org/pdf/2412.20846v2)**
...
>
---
#### [replaced 045] CTC-DRO: Robust Optimization for Reducing Language Disparities in Speech Recognition
...
>
---
#### [replaced 046] Zero-Shot Stance Detection in the Wild: Dynamic Target Generation and Multi-Target Adaptation
- **分类: cs.CL**

- **简介: 该论文提出零样本立场检测任务，解决真实场景中目标动态变化的问题。构建中文数据集，设计评估指标，探索模型微调策略，提升多目标识别与立场判断效果。**

- **链接: [https://arxiv.org/pdf/2601.19802v2](https://arxiv.org/pdf/2601.19802v2)**
...
>
---
#### [replaced 047] Common to Whom? Regional Cultural Commonsense and LLM Bias in India
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的文化常识评估任务，旨在解决国家内部文化常识区域差异问题。通过构建印度区域文化常识基准Indica，分析大模型在不同地区的偏差。**

- **链接: [https://arxiv.org/pdf/2601.15550v2](https://arxiv.org/pdf/2601.15550v2)**

> **作者:** Sangmitra Madhusudan; Trush Shashank More; Steph Buongiorno; Renata Dividino; Jad Kabbara; Ali Emami
>
> **摘要:** Existing cultural commonsense benchmarks treat nations as monolithic, assuming uniform practices within national boundaries. But does cultural commonsense hold uniformly within a nation, or does it vary at the sub-national level? We introduce Indica, the first benchmark designed to test LLMs' ability to address this question, focusing on India - a nation of 28 states, 8 union territories, and 22 official languages. We collect human-annotated answers from five Indian regions (North, South, East, West, and Central) across 515 questions spanning 8 domains of everyday life, yielding 1,630 region-specific question-answer pairs. Strikingly, only 39.4% of questions elicit agreement across all five regions, demonstrating that cultural commonsense in India is predominantly regional, not national. We evaluate eight state-of-the-art LLMs and find two critical gaps: models achieve only 13.4%-20.9% accuracy on region-specific questions, and they exhibit geographic bias, over-selecting Central and North India as the "default" (selected 30-40% more often than expected) while under-representing East and West. Beyond India, our methodology provides a generalizable framework for evaluating cultural commonsense in any culturally heterogeneous nation, from question design grounded in anthropological taxonomy, to regional data collection, to bias measurement.
>
---
#### [replaced 048] Grounding or Guessing? Visual Signals for Detecting Hallucinations in Sign Language Translation
- **分类: cs.CL**

- **简介: 该论文属于符号语言翻译任务，旨在解决模型生成与视觉证据不符的幻觉问题。通过引入基于视觉信号的可靠性度量，提升幻觉检测效果。**

- **链接: [https://arxiv.org/pdf/2510.18439v2](https://arxiv.org/pdf/2510.18439v2)**
...
>
---
#### [replaced 049] The Imitation Game: Turing Machine Imitator is Length Generalizable Reasoner
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的推理任务，旨在解决Transformer模型在长序列上的泛化能力问题。通过模仿图灵机的推理过程，提出TAIL方法提升模型的长度泛化能力。**

- **链接: [https://arxiv.org/pdf/2507.13332v3](https://arxiv.org/pdf/2507.13332v3)**
...
>
---
#### [replaced 050] First is Not Really Better Than Last: Evaluating Layer Choice and Aggregation Strategies in Language Model Data Influence Estimation
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究语言模型中数据影响估计任务，解决如何选择层和聚合策略问题。工作包括证明首层非最优，中层更优，并提出新评估方法与指标。**

- **链接: [https://arxiv.org/pdf/2511.04715v2](https://arxiv.org/pdf/2511.04715v2)**
...
>
---
#### [replaced 051] LEGO-Eval: Towards Fine-Grained Evaluation on Synthesizing 3D Embodied Environments with Tool Augmentation
- **分类: cs.CL**

- **简介: 该论文属于3D场景生成任务，旨在解决生成场景与细粒度指令对齐不足的问题。提出LEGO-Eval评估框架和LEGO-Bench基准，提升场景-指令对齐评估准确性。**

- **链接: [https://arxiv.org/pdf/2511.03001v2](https://arxiv.org/pdf/2511.03001v2)**
...
>
---
#### [replaced 056] Mind the Gap: The Divergence Between Human and LLM-Generated Tasks
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于人机行为对比研究，旨在探讨人类与LLM生成任务的差异。通过实验发现，人类任务受心理因素影响，而LLM生成任务缺乏社会性与物理性，存在核心认知差距。**

- **链接: [https://arxiv.org/pdf/2508.00282v3](https://arxiv.org/pdf/2508.00282v3)**
...
>
---
#### [replaced 057] From Text to Talk: Audio-Language Model Needs Non-Autoregressive Joint Training
- **分类: cs.CL**

- **简介: 该论文提出TtT框架，解决多模态对话系统中音频与文本生成的联合训练问题，通过结合自回归文本和非自回归音频扩散模型，提升生成效果。**

- **链接: [https://arxiv.org/pdf/2509.20072v3](https://arxiv.org/pdf/2509.20072v3)**
...
>
---
#### [replaced 058] Mechanism of Task-oriented Information Removal in In-context Learning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究In-context Learning（ICL）机制，聚焦于信息移除过程。通过分析隐藏状态，揭示ICL如何通过选择性移除冗余信息提升任务准确性。**

- **链接: [https://arxiv.org/pdf/2509.21012v3](https://arxiv.org/pdf/2509.21012v3)**

> **作者:** Hakaze Cho; Haolin Yang; Gouki Minegishi; Naoya Inoue
>
> **备注:** 87 pages, 90 figures, 7 tables, ICLR 2026 Camera-ready
>
...
>
---
#### [replaced 059] Elastic Attention: Test-time Adaptive Sparsity Ratios for Efficient Transformers
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，解决长文本场景下Transformer模型计算效率低的问题。提出Elastic Attention方法，动态调整注意力稀疏性，提升推理效率。**

- **链接: [https://arxiv.org/pdf/2601.17367v2](https://arxiv.org/pdf/2601.17367v2)**
...
>
---
#### [replaced 060] Confidence intervals for forced alignment boundaries using model ensembles
...
>
---
#### [replaced 061] Dual-objective Language Models: Training Efficiency Without Overfitting
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决模型训练效率与过拟合之间的平衡问题。通过结合自回归和掩码扩散目标，提升模型性能并减少过拟合风险。**

- **链接: [https://arxiv.org/pdf/2512.14549v2](https://arxiv.org/pdf/2512.14549v2)**
...
>
---
#### [replaced 062] AdaReasoner: Dynamic Tool Orchestration for Iterative Visual Reasoning
...
>
---
#### [replaced 063] Strategic Dialogue Assessment: The Crooked Path to Innocence
- **分类: cs.CL**

- **简介: 该论文属于对话分析任务，旨在解决 adversarial 场景下语言策略理解的问题。提出 SDA 框架和 CPD 数据集，评估 LLM 的战略语言能力。**

- **链接: [https://arxiv.org/pdf/2506.01195v3](https://arxiv.org/pdf/2506.01195v3)**

> **作者:** Anshun Asher Zheng; Junyi Jessy Li; David I. Beaver
>
> **备注:** 53 pages. Title changed. Accepted by Dialogue and Discourse 17(1)
>
...
>
---
#### [replaced 064] Emotionally Charged, Logically Blurred: AI-driven Emotional Framing Impairs Human Fallacy Detection
- **分类: cs.CL**

- **简介: 该论文属于认知与AI交叉任务，研究情感框架如何影响逻辑谬误识别。通过LLM生成情感化谬误文本，发现情感会降低人类检测谬误的能力。**

- **链接: [https://arxiv.org/pdf/2510.09695v2](https://arxiv.org/pdf/2510.09695v2)**

> **作者:** Yanran Chen; Lynn Greschner; Roman Klinger; Michael Klenk; Steffen Eger
>
> **备注:** EACL 2026 Main Camera-ready; typo fixed
>
...
>
---
#### [replaced 068] S$^3$-Attention:Attention-Aligned Endogenous Retrieval for Memory-Bounded Long-Context Inference
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出S3-Attention框架，解决长文本推理中的内存和噪声效率问题。通过稀疏编码和倒排索引，实现高效记忆受限的上下文处理。**

- **链接: [https://arxiv.org/pdf/2601.17702v2](https://arxiv.org/pdf/2601.17702v2)**
...
>
---
#### [replaced 069] Mask-GCG: Are All Tokens in Adversarial Suffixes Necessary for Jailbreak Attacks?
- **分类: cs.CL; cs.AI; cs.CR**

- **简介: 该论文属于安全领域，研究如何优化对抗后缀以提升越狱攻击效率。针对现有方法冗余问题，提出Mask-GCG，通过标记重要token减少计算量，提升攻击效率。**

- **链接: [https://arxiv.org/pdf/2509.06350v2](https://arxiv.org/pdf/2509.06350v2)**
