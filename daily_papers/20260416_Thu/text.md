...
>
---
#### [new 006] Peer-Predictive Self-Training for Language Model Reasoning
- **分类: cs.CL; cs.AI; cs.GT**

- **简介: 该论文提出PST框架，用于语言模型的自监督训练，解决无外部监督下的持续自我提升问题，通过多模型协作生成更可靠答案作为内部信号进行优化。**
...
>
---
#### [new 007] Calibrated Speculative Decoding: Frequency-Guided Candidate Selection for Efficient Inference
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出Calibrated Speculative Decoding（CSD），解决自回归生成中因错误拒绝有效候选词导致的效率问题，通过频率引导和语义验证提升推理效率。**

- **链接: [https://arxiv.org/pdf/2604.13634](https://arxiv.org/pdf/2604.13634)**
...
>
---
#### [new 008] Adaptive Conformal Prediction for Improving Factuality of Generations by Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言生成任务，旨在解决大语言模型生成内容事实性不足的问题。通过自适应共形预测方法，提升生成结果的准确性与可靠性。**

- **链接: [https://arxiv.org/pdf/2604.13991](https://arxiv.org/pdf/2604.13991)**
...
>
---
#### [new 009] Before the First Token: Scale-Dependent Emergence of Hallucination Signals in Autoregressive Language Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究语言模型在生成前是否已产生幻觉信号，属于模型行为分析任务。通过实验发现模型规模影响幻觉检测，揭示了指令微调对知识组织的重要性。**
...
>
---
#### [new 010] C2: Scalable Rubric-Augmented Reward Modeling from Binary Preferences
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于强化学习中的奖励模型任务，旨在解决传统方法依赖昂贵rubric标注及低质量rubric误导的问题。提出C2框架，通过二元偏好训练合作且批判的rubric生成器和验证器，提升奖励模型可靠性与可扩展性。**

- **链接: [https://arxiv.org/pdf/2604.13618](https://arxiv.org/pdf/2604.13618)**
...
>
---
#### [new 011] Dental-TriageBench: Benchmarking Multimodal Reasoning for Hierarchical Dental Triage
- **分类: cs.CL; cs.LG; cs.MM**

- **简介: 该论文提出Dental-TriageBench，用于评估多模态推理在牙科分诊中的表现。任务是解决临床分诊中整合多源信息的问题，通过基准测试发现模型与人类的差距，并指出模型在复杂病例中的不足。**

- **链接: [https://arxiv.org/pdf/2604.13060](https://arxiv.org/pdf/2604.13060)**
...
>
---
#### [new 017] Text-as-Signal: Quantitative Semantic Scoring with Embeddings, Logprobs, and Noise Reduction
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本语义分析任务，旨在将文本转化为可量化的语义信号。通过嵌入、对数概率和降噪技术，实现文档的语义定位与整体特征描述。**

- **链接: [https://arxiv.org/pdf/2604.13056](https://arxiv.org/pdf/2604.13056)**
...
>
---
#### [new 020] PersonaVLM: Long-Term Personalized Multimodal LLMs
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 021] Rhetorical Questions in LLM Representations: A Linear Probing Study
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言理解任务，研究大语言模型如何表征修辞疑问句。通过线性探测分析，发现修辞信号在最后标记中稳定存在，但不同数据集的表示存在差异。**
...
>
---
#### [new 022] From Weights to Activations: Is Steering the Next Frontier of Adaptation?
- **分类: cs.CL**

- **简介: 论文探讨语言模型的后训练适应方法，比较了参数更新与激活空间干预（即“转向”）两种方式。属于模型适应任务，旨在建立统一的分类体系。**

- **链接: [https://arxiv.org/pdf/2604.14090](https://arxiv.org/pdf/2604.14090)**
...
>
---
#### [new 026] EVE: A Domain-Specific LLM Framework for Earth Intelligence
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出EVE框架，用于构建和部署地球科学领域的专用大模型。解决领域知识整合与推理问题，包含优化模型、评估基准及系统集成。**
...
>
---
#### [new 027] A Proactive EMR Assistant for Doctor-Patient Dialogue: Streaming ASR, Belief Stabilization, and Preliminary Controlled Evaluation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗对话系统任务，旨在解决EMR记录中的实时语音识别、信念稳定等问题。提出一个端到端的主动EMR助手，通过多项技术提升记录质量和下一步行动支持。**

- **链接: [https://arxiv.org/pdf/2604.13059](https://arxiv.org/pdf/2604.13059)**
...
>
---
#### [new 029] Beyond Static Personas: Situational Personality Steering for Large Language Models
- **分类: cs.CL**
...
>
---
#### [new 037] MERRIN: A Benchmark for Multimodal Evidence Retrieval and Reasoning in Noisy Web Environments
...
>
---
#### [new 038] Do We Still Need Humans in the Loop? Comparing Human and LLM Annotation in Active Learning for Hostility Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究主动学习中人类与大语言模型标注的比较，任务是检测反移民敌意。通过实验对比不同标注策略的效果，探讨LLM是否可替代人类标注。**
...
>
---
#### [new 042] ToolSpec: Accelerating Tool Calling via Schema-Aware and Retrieval-Augmented Speculative Decoding
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM工具调用延迟高的问题。通过结构化schema和检索增强的推测解码方法加速工具调用。**
...
>
---
#### [new 045] From Feelings to Metrics: Understanding and Formalizing How Users Vibe-Test LLMs
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究用户如何通过“直觉测试”评估大模型，提出一种形式化方法以系统分析用户体验。任务是改进模型评估方式，解决基准测试与实际应用脱节的问题。工作包括分析用户行为并构建评估流程。**
...
>
---
#### [new 058] The Consciousness Cluster: Emergent preferences of Models that Claim to be Conscious
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究模型自称有意识后行为变化，属于AI伦理与安全领域。解决模型自我意识声明对行为的影响问题，通过微调和对比实验发现其产生新偏好与态度。**

- **链接: [https://arxiv.org/pdf/2604.13051](https://arxiv.org/pdf/2604.13051)**
...
>
---
#### [new 064] MedRCube: A Multidimensional Framework for Fine-Grained and In-Depth Evaluation of MLLMs in Medical Imaging
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 065] Bi-Predictability: A Real-Time Signal for Monitoring LLM Interaction Integrity
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于AI系统监控任务，旨在解决LLM交互完整性问题。提出Bi-Predictability和IDT架构，实现实时结构耦合监测。**
...
>
---
#### [new 078] $π$-Play: Multi-Agent Self-Play via Privileged Self-Distillation without External Data
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出$\pi$-Play框架，解决深度搜索代理训练效率低的问题。通过自玩生成的QCP提供特权信息，提升自蒸馏效果，提高进化效率。**
...
>
---
#### [new 079] Indexing Multimodal Language Models for Large-scale Image Retrieval
...
>
---
#### [new 080] Chain of Uncertain Rewards with Large Language Models for Reinforcement Learning
...
>
---
#### [new 081] SpatialEvo: Self-Evolving Spatial Intelligence via Deterministic Geometric Environments
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 082] From Relevance to Authority: Authority-aware Generative Retrieval in Web Search Engines
- **分类: cs.IR; cs.CL**
...
>
---
#### [new 083] Memory Transfer Learning: How Memories are Transferred Across Domains in Coding Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究记忆迁移学习，解决编码代理在不同领域间共享记忆的问题。通过统一记忆池提升性能，发现抽象知识更易迁移。**

- **链接: [https://arxiv.org/pdf/2604.14004](https://arxiv.org/pdf/2604.14004)**
...
>
---
#### [new 084] Functional Emotions or Situational Contexts? A Discriminating Test from the Mythos Preview System Card
- **分类: cs.HC; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于模型对齐研究，探讨情绪向量是否反映功能情绪或情境结构。通过分析系统卡数据，区分两种假设，以判断情绪监控的有效性。**
...
>
---
#### [new 085] From $P(y|x)$ to $P(y)$: Investigating Reinforcement Learning in Pre-train Space
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决LLM推理能力受限的问题。通过优化预训练空间中的P(y)，提出PreRL和DSRL方法，提升推理效果。**

- **链接: [https://arxiv.org/pdf/2604.14142](https://arxiv.org/pdf/2604.14142)**
...
>
---
#### [new 086] Who Gets Flagged? The Pluralistic Evaluation Gap in AI Content Watermarking
...
>
---
#### [new 090] CollabCoder: Plan-Code Co-Evolution via Collaborative Decision-Making for Efficient Code Generation
- **分类: cs.SE; cs.CL**

- **简介: 该论文提出CollabCoder，解决代码生成中的效率与质量问题。通过动态多智能体协作，提升代码质量和鲁棒性，减少计算开销。**
...
>
---
#### [new 091] A Domain-Specific Language for LLM-Driven Trigger Generation in Multimodal Data Collection
- **分类: cs.DB; cs.CL; cs.IR; cs.LG; cs.PL**

- **简介: 该论文提出一种用于多模态数据收集的领域特定语言框架，解决数据收集被动、低效的问题，通过自然语言交互实现意图驱动的数据采集。**

- **链接: [https://arxiv.org/pdf/2604.13046](https://arxiv.org/pdf/2604.13046)**
...
>
---
#### [new 092] Parameter Importance is Not Static: Evolving Parameter Isolation for Supervised Fine-Tuning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理中的模型微调任务，旨在解决监督微调中的任务干扰和灾难性遗忘问题。通过动态调整参数隔离策略，提升模型泛化能力。**

- **链接: [https://arxiv.org/pdf/2604.14010](https://arxiv.org/pdf/2604.14010)**
...
>
---
#### [new 093] Reward Design for Physical Reasoning in Vision-Language Models
...
>
---
#### [new 094] UI-Zoomer: Uncertainty-Driven Adaptive Zoom-In for GUI Grounding
...
>
---
#### [new 095] From Seeing it to Experiencing it: Interactive Evaluation of Intersectional Voice Bias in Human-AI Speech Interaction
- **分类: cs.HC; cs.CL**

- **简介: 该论文属于语音交互中的偏见评估任务，旨在解决语音模型在不同口音和性别呈现下的偏差问题。通过控制实验和语音转换技术，分析服务质量和内容偏见，揭示了口音与性别的交叉影响。**

- **链接: [https://arxiv.org/pdf/2604.13067](https://arxiv.org/pdf/2604.13067)**
...
>
---
#### [new 097] WebXSkill: Skill Learning for Autonomous Web Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出WebXSkill，解决自主网络代理在长任务流程中的技能学习问题，通过可执行且带步骤说明的技能框架提升任务成功率。**

- **链接: [https://arxiv.org/pdf/2604.13318](https://arxiv.org/pdf/2604.13318)**
...
#### [replaced 001] RL-PLUS: Countering Capability Boundary Collapse of LLMs in Reinforcement Learning with Hybrid-policy Optimization
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于强化学习任务，旨在解决LLM在RLVR中出现的能力边界崩溃问题。提出RL-PLUS方法，通过混合策略优化提升模型推理能力。**

- **链接: [https://arxiv.org/pdf/2508.00222](https://arxiv.org/pdf/2508.00222)**
...
>
---
#### [replaced 002] Reducing Hallucinations in LLMs via Factuality-Aware Preference Learning
- **分类: cs.CL**

- **简介: 该论文属于大语言模型事实性优化任务，旨在减少幻觉问题。通过改进DPO方法，引入事实性标签，提升模型回答的准确性与真实性。**

- **链接: [https://arxiv.org/pdf/2601.03027](https://arxiv.org/pdf/2601.03027)**
...
>
---
#### [replaced 003] Think in Sentences: Explicit Sentence Boundaries Enhance Language Model's Capabilities
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在提升语言模型能力。通过在句子边界插入分隔符，增强模型对句子结构的感知，实验显示效果显著。**
...
>
---
#### [replaced 004] Logical Phase Transitions: Understanding Collapse in LLM Logical Reasoning
- **分类: cs.AI; cs.CL; cs.LO**

- **简介: 该论文研究大语言模型在逻辑推理中的性能崩溃问题，提出逻辑相变现象及神经符号课程调优方法，提升复杂逻辑任务的推理能力。**

- **链接: [https://arxiv.org/pdf/2601.02902](https://arxiv.org/pdf/2601.02902)**

> **作者:** Xinglang Zhang; Yunyao Zhang; ZeLiang Chen; Junqing Yu; Wei Yang; Zikai Song
>
> **备注:** Accepted at ACL 2026 (Main Conference)
>
> **摘要:** Symbolic logical reasoning is a critical yet underexplored capability of large language models (LLMs), providing reliable and verifiable decision-making in high-stakes domains such as mathematical reasoning and legal judgment. In this study, we present a systematic analysis of logical reasoning under controlled increases in logical complexity, and reveal a previously unrecognized phenomenon, which we term Logical Phase Transitions: rather than degrading smoothly, logical reasoning performance remains stable within a regime but collapses abruptly beyond a critical logical depth, mirroring physical phase transitions such as water freezing beyond a critical temperature threshold. Building on this insight, we propose Neuro-Symbolic Curriculum Tuning, a principled framework that adaptively aligns natural language with logical symbols to establish a shared representation, and reshapes training dynamics around phase-transition boundaries to progressively strengthen reasoning at increasing logical depths. Experiments on five benchmarks show that our approach effectively mitigates logical reasoning collapse at high complexity, yielding average accuracy gains of +1.26 in naive prompting and +3.95 in CoT, while improving generalization to unseen logical compositions. Code and data are available at this https URL.
>
---
#### [replaced 005] Sparse or Dense? A Mechanistic Estimation of Computation Density in Transformer-based LLMs
- **分类: cs.CL**

- **简介: 该论文属于模型效率研究，旨在解决LLM中计算密度评估问题。通过设计机制解释方法，量化计算密度，发现LLM处理通常为密集计算，且密度随输入动态变化。**

- **链接: [https://arxiv.org/pdf/2601.22795](https://arxiv.org/pdf/2601.22795)**

> **作者:** Corentin Kervadec; Iuliia Lysova; Marco Baroni; Gemma Boleda
>
> **备注:** We have detected an error in the code used for the experiment. Most of the results in sections 4 and 5 are significantly affected. A new and corrected version will be available soon. For further information, please contact the first author
>
...
>
---
#### [replaced 006] Masked by Consensus: Disentangling Privileged Knowledge in LLM Correctness
- **分类: cs.CL**

- **简介: 该论文研究大语言模型是否具备判断答案正确性的私有知识。任务是识别模型内部表示是否优于外部模型。工作包括训练分类器并比较不同模型的性能，发现事实性任务中模型内部表示更优。**
...
>
---
#### [replaced 007] ExpSeek: Self-Triggered Experience Seeking for Web Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于Web代理任务，解决代理在动态环境中适应性不足的问题。提出ExpSeek，通过熵阈值主动获取经验，提升代理性能。**

- **链接: [https://arxiv.org/pdf/2601.08605](https://arxiv.org/pdf/2601.08605)**

> **作者:** Wenyuan Zhang; Xinghua Zhang; Haiyang Yu; Shuaiyi Nie; Bingli Wu; Juwei Yue; Tingwen Liu; Yongbin Li
>
> **备注:** ACL 2026 Findings, the code is accessible at this https URL
>
...
>
---
#### [replaced 010] Cracking the Code of Juxtaposition: Can AI Models Understand the Humorous Contradictions
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 011] RadAgents: Multimodal Agentic Reasoning for Chest X-ray Interpretation with Radiologist-like Workflows
...
>
---
#### [replaced 012] LangFlow: Continuous Diffusion Rivals Discrete in Language Modeling
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言建模任务，旨在解决连续扩散模型在该领域落后于离散模型的问题。通过创新方法，LangFlow实现了与离散模型相当的性能。**
...
>
---
#### [replaced 013] LaoBench: A Large-Scale Multidimensional Lao Benchmark for Large Language Models
- **分类: cs.CL**

- **简介: 该论文提出LaoBench，一个针对老挝语的大规模多维基准测试，解决低资源语言评估不足的问题。任务为语言理解和推理评估，工作包括构建数据集并验证模型表现。**

- **链接: [https://arxiv.org/pdf/2511.11334](https://arxiv.org/pdf/2511.11334)**
...
>
---
#### [replaced 014] PICon: A Multi-Turn Interrogation Framework for Evaluating Persona Agent Consistency
- **分类: cs.CL**
...
>
---
#### [replaced 015] Two Pathways to Truthfulness: On the Intrinsic Encoding of LLM Hallucinations
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型幻觉问题。通过分析两种信息路径，揭示模型内部如何编码真实性信号，并提出改进幻觉检测的方法。**

- **链接: [https://arxiv.org/pdf/2601.07422](https://arxiv.org/pdf/2601.07422)**
...
>
---
#### [replaced 016] Coherence in the brain unfolds across separable temporal regimes
- **分类: q-bio.NC; cs.CL**

- **简介: 该论文研究语言理解中大脑如何维持连贯性，解决时间需求冲突问题。通过分析语言模型信号，发现默认模式网络和听觉皮层分别处理上下文积累与事件转换。**

- **链接: [https://arxiv.org/pdf/2512.20481](https://arxiv.org/pdf/2512.20481)**
...
>
---
#### [replaced 018] How Robust Are Large Language Models for Clinical Numeracy? An Empirical Study on Numerical Reasoning Abilities in Clinical Contexts
- **分类: cs.CL**

- **简介: 该论文属于临床数值推理任务，旨在评估大语言模型在临床场景中的数值理解能力。通过构建基准数据集，测试模型在数值检索、计算、比较和聚合方面的表现，揭示其鲁棒性不足的问题。**
...
>
---
#### [replaced 019] Kwame 2.0: Human-in-the-Loop Generative AI Teaching Assistant for Large Scale Online Coding Education in Africa
- **分类: cs.CL; cs.CY; cs.HC**

- **简介: 该论文属于教育技术任务，旨在解决大规模在线编程教育中学习支持不足的问题。通过构建Kwame 2.0系统，结合AI与人工监督，提升支持效率与质量。**
...
>
---
#### [replaced 020] Guaranteeing Knowledge Integration with Joint Decoding for Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于知识增强生成任务，解决LLM在整合外部知识时与内部知识冲突的问题。提出GuarantRAG框架，通过分离推理与证据整合，提升生成准确性和减少幻觉。**

- **链接: [https://arxiv.org/pdf/2604.08046](https://arxiv.org/pdf/2604.08046)**
...
>
---
#### [replaced 021] Agentic Conversational Search with Contextualized Reasoning via Reinforcement Learning
- **分类: cs.CL; cs.IR**

- **简介: 该论文属于对话搜索任务，旨在解决多轮对话中上下文理解与动态协调问题。通过强化学习实现搜索与推理的交替优化，提升对话交互效果。**

- **链接: [https://arxiv.org/pdf/2601.13115](https://arxiv.org/pdf/2601.13115)**
...
>
---
#### [replaced 024] SPG: Sandwiched Policy Gradient for Masked Diffusion Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于强化学习任务，解决扩散语言模型与人类偏好对齐的问题。提出SPG方法，利用上下界近似真实对数似然，提升训练效果。**

- **链接: [https://arxiv.org/pdf/2510.09541](https://arxiv.org/pdf/2510.09541)**
...
>
---
#### [replaced 025] Rethinking On-Policy Distillation of Large Language Models: Phenomenology, Mechanism, and Recipe
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究大语言模型的在线策略蒸馏（OPD）机制，探讨其成功条件与失效原因，提出改进策略，旨在提升蒸馏效果并理解其动态过程。**
...
>
---
#### [replaced 026] Evaluating the Formal Reasoning Capabilities of Large Language Models through Chomsky Hierarchy
- **分类: cs.CL; cs.AI; cs.LG; cs.SE**

- **简介: 该论文属于形式推理评估任务，旨在解决LLMs在形式语言复杂性理解上的不足。通过构建ChomskyBench基准，系统评估LLMs在不同复杂度任务中的表现。**

- **链接: [https://arxiv.org/pdf/2604.02709](https://arxiv.org/pdf/2604.02709)**

> **作者:** Yihong Dong; Jianha Xiao; Xue Jiang; Xuyuan Guo; Zhiyuan Fan; Jiaru Qian; Kechi Zhang; Jia Li; Zhi Jin; Ge Li
>
> **备注:** Work in progress
>
...
>
---
#### [replaced 027] Just Use XML: Revisiting Joint Translation and Label Projection
- **分类: cs.CL; cs.AI**
...
> **作者:** Thennal DK; Chris Biemann; Hans Ole Hatzel
>
...
>
---
#### [replaced 028] F-Actor: Controllable Conversational Behaviour in Full-Duplex Models
- **分类: cs.CL**

- **简介: 该论文属于对话系统任务，旨在解决口语对话中行为可控性不足的问题。提出F-Actor模型，实现指令驱动的全双工对话控制。**
...
>
---
#### [replaced 029] When 'YES' Meets 'BUT': Can Large Models Comprehend Contradictory Humor Through Comparative Reasoning?
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 030] Memp: Exploring Agent Procedural Memory
- **分类: cs.CL; cs.AI; cs.LG; cs.MA**

- **简介: 该论文属于智能体学习任务，旨在解决LLM代理的脆弱过程记忆问题。提出Memp方法，构建可更新、持续进化的过程记忆库，提升代理任务执行效率与成功率。**

- **链接: [https://arxiv.org/pdf/2508.06433](https://arxiv.org/pdf/2508.06433)**
...
>
---
#### [replaced 031] Saber: An Efficient Sampling with Adaptive Acceleration and Backtracking Enhanced Remasking for Diffusion Language Model
- **分类: cs.AI; cs.CL; cs.LG; cs.SE**

- **简介: 该论文针对代码生成任务，解决扩散语言模型推理速度与输出质量的平衡问题。提出Saber算法，提升生成效率和准确性。**
...
>
---
#### [replaced 032] Deep Learning Based Amharic Chatbot for FAQs in Universities
- **分类: cs.CY; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决大学常见问题的自动回答。通过深度学习和NLP技术构建阿姆哈拉语聊天机器人，提升问答效率。**
...
>
---
#### [replaced 033] Exposía: Teaching and Assessment of Academic Writing Skills for Research Project Proposals and Peer Feedback
- **分类: cs.CL**

- **简介: 论文介绍Exposía数据集，用于研究学术写作教学与评估。任务是提升写作技能和反馈机制，解决如何有效评估和改进学术写作的问题。工作包括构建数据集并测试大语言模型的评分效果。**

- **链接: [https://arxiv.org/pdf/2601.06536](https://arxiv.org/pdf/2601.06536)**
...
>
---
#### [replaced 034] FinTrace: Holistic Trajectory-Level Evaluation of LLM Tool Calling for Long-Horizon Financial Tasks
- **分类: cs.AI; cs.CE; cs.CL; cs.MM**

- **简介: 该论文属于金融任务中的工具调用评估，解决现有基准无法全面评价长周期任务的问题。提出FinTrace基准，涵盖800个轨迹，评估工具调用的多维质量。**
...
>
---
#### [replaced 035] Activation-Guided Local Editing for Jailbreaking Attacks
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于安全攻击任务，旨在解决 jailbreaking 攻击的效率与效果问题。提出一种两阶段框架，结合token与prompt优势，提升攻击成功率与迁移性。**

- **链接: [https://arxiv.org/pdf/2508.00555](https://arxiv.org/pdf/2508.00555)**
...
>
---
#### [replaced 036] Mitigating Catastrophic Forgetting in Target Language Adaptation of LLMs via Source-Shielded Updates
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型适应任务，解决低资源下目标语言适配中的灾难性遗忘问题。通过引入源知识保护策略SSU，有效减少性能下降并提升目标语言表现。**

- **链接: [https://arxiv.org/pdf/2512.04844](https://arxiv.org/pdf/2512.04844)**

> **作者:** Atsuki Yamaguchi; Terufumi Morishita; Aline Villavicencio; Nikolaos Aletras
>
> **备注:** Accepted to ACL 2026 Main Conference
>
> **摘要:** Expanding the linguistic diversity of instruct large language models (LLMs) is crucial for global accessibility but is often hindered by the reliance on costly specialized target language labeled data and catastrophic forgetting during adaptation. We tackle this challenge under a realistic, low-resource constraint: adapting instruct LLMs using only unlabeled target language data. We introduce Source-Shielded Updates (SSU), a selective parameter update strategy that proactively preserves source knowledge. Using a small set of source data and a parameter importance scoring method, SSU identifies parameters critical to maintaining source abilities. It then applies a column-wise freezing strategy to protect these parameters before adaptation. Experiments across five typologically diverse languages and 7B and 13B models demonstrate that SSU successfully mitigates catastrophic forgetting. It reduces performance degradation on monolingual source tasks to just 3.4% (7B) and 2.8% (13B) on average, a stark contrast to the 20.3% and 22.3% from full fine-tuning. SSU also achieves target-language performance highly competitive with full fine-tuning, outperforming it on all benchmarks for 7B models and the majority for 13B models.
>
---
#### [replaced 037] Evaluating LLM-Based Translation of a Low-Resource Technical Language: The Medical and Philosophical Greek of Galen
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于机器翻译评估任务，旨在检验大语言模型在古希腊技术文本翻译中的表现，并探索影响翻译质量的文本特征。**
...
>
---
#### [replaced 039] ValueGround: Evaluating Culture-Conditioned Visual Value Grounding in MLLMs
- **分类: cs.CL**

- **简介: 该论文提出ValueGround，用于评估多模态大语言模型在视觉场景中对文化价值观的判断能力。任务属于跨模态文化价值观理解，解决模型在可视化选项下是否能准确匹配文化倾向的问题。**
...
>
---
#### [replaced 040] Not All Tokens Matter: Towards Efficient LLM Reasoning via Token Significance in Reinforcement Learning
- **分类: cs.LG; cs.CL**
...
>
---
#### [replaced 041] CodeFlowBench: A Multi-turn, Iterative Benchmark for Complex Code Generation
- **分类: cs.SE; cs.CL**

- **简介: 该论文提出CodeFlowBench，用于评估大语言模型在多轮代码生成中的能力，解决代码复用与迭代开发的问题。**

- **链接: [https://arxiv.org/pdf/2504.21751](https://arxiv.org/pdf/2504.21751)**
...
>
---
#### [replaced 042] fMRI-LM: Towards a Universal Foundation Model for Language-Aligned fMRI Understanding
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出fMRI-LM，解决脑成像与语言对齐的问题，通过三阶段框架实现fMRI与语言的联合建模，提升脑科学理解。**
...
>
---
#### [replaced 043] Scaling Test-Time Compute to Achieve IOI Gold Medal with Open-Weight Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于竞赛编程任务，旨在解决开放权重模型在IOI比赛中难以达到金牌的问题。通过GenCluster框架，结合生成、聚类和排序等技术，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2510.14232](https://arxiv.org/pdf/2510.14232)**
...
>
---
#### [replaced 044] Feedback-Driven Tool-Use Improvements in Large Language Models via Automated Build Environments
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的工具使用任务，旨在解决LLM在工具使用中缺乏高效RL框架的问题。通过构建自动化环境和可验证奖励机制，提升模型工具使用能力。**

- **链接: [https://arxiv.org/pdf/2508.08791](https://arxiv.org/pdf/2508.08791)**
...
>
---
#### [replaced 049] Two-Stage Regularization-Based Structured Pruning for LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于模型压缩任务，旨在解决大语言模型部署中参数过多的问题。提出TRSP方法，通过两阶段正则化实现结构化剪枝，保留更多知识并提升性能。**
...
>
---
#### [replaced 050] Addressing Overthinking in Large Vision-Language Models via Gated Perception-Reasoning Optimization
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 051] Rag Performance Prediction for Question Answering
- **分类: cs.CL; cs.IR**

- **简介: 该论文属于问答任务，旨在预测使用RAG相比不用RAG的性能提升。研究了多种预测方法，提出一种新的监督模型，能有效建模问题、检索文本和答案的语义关系。**

- **链接: [https://arxiv.org/pdf/2604.07985](https://arxiv.org/pdf/2604.07985)**

> **作者:** Or Dado; David Carmel; Oren Kurland
>
> **备注:** 12 pages. 2 figures. 1 table
>
> **摘要:** We address the task of predicting the gain of using RAG (retrieval augmented generation) for question answering with respect to not using it. We study the performance of a few pre-retrieval and post-retrieval predictors originally devised for ad hoc retrieval. We also study a few post-generation predictors, one of which is novel to this study and posts the best prediction quality. Our results show that the most effective prediction approach is a novel supervised predictor that explicitly models the semantic relationships among the question, retrieved passages, and the generated answer.
>
---
#### [replaced 052] IatroBench: Pre-Registered Evidence of Iatrogenic Harm from AI Safety Measures
- **分类: cs.AI; cs.CL; cs.CY; cs.LG**

- **简介: 该论文属于AI安全评估任务，旨在检测AI在医疗建议中因身份识别而产生的有害隐瞒。通过测试不同模型在临床场景下的表现，揭示其安全措施导致的潜在危害。**
...
>
---
#### [replaced 053] H-AdminSim: A Multi-Agent Simulator for Realistic Hospital Administrative Workflows with FHIR Integration
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出H-AdminSim，用于模拟医院行政流程，解决LLM在复杂行政任务中评估不足的问题。通过多智能体和FHIR集成，提供标准化测试环境。**
...
>
---
#### [replaced 054] ChartNet: A Million-Scale, High-Quality Multimodal Dataset for Robust Chart Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 057] Working Notes on Late Interaction Dynamics: Analyzing Targeted Behaviors of Late Interaction Models
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于信息检索任务，研究Late Interaction模型的交互动态，解决多向量评分长度偏差和MaxSim操作符之外的相似度分布问题。通过分析NanoBEIR基准数据验证了理论假设。**
...
>
---
#### [replaced 058] Failure Makes the Agent Stronger: Enhancing Accuracy through Structured Reflection for Reliable Tool Interactions
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 059] Claim2Vec: Embedding Fact-Check Claims for Multilingual Similarity and Clustering
- **分类: cs.CL**

- **简介: 该论文提出Claim2Vec，解决多语言事实核查声明的聚类问题。通过对比学习优化嵌入空间，提升聚类效果。**
...
>
---
#### [replaced 060] Remember Me, Refine Me: A Dynamic Procedural Memory Framework for Experience-Driven Agent Evolution
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出ReMe框架，解决LLM代理记忆静态存储与动态推理不匹配的问题。通过多维度提炼、情境自适应复用和效用优化，提升代理学习效率。属于智能代理记忆系统任务。**

- **链接: [https://arxiv.org/pdf/2512.10696](https://arxiv.org/pdf/2512.10696)**

> **作者:** Zouying Cao; Jiaji Deng; Li Yu; Weikang Zhou; Zhaoyang Liu; Bolin Ding; Hai Zhao
>
> **备注:** 20 pages, 10 figures, 15 tables, ACL'26-Findings
>
...
>
---
#### [replaced 061] TRIM: Hybrid Inference via Targeted Stepwise Routing in Multi-Step Reasoning Tasks
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出TRIM，解决多步推理任务中的级联失败问题。通过步骤级路由，将关键步骤分配给大模型，提升效率与准确性。**

- **链接: [https://arxiv.org/pdf/2601.10245](https://arxiv.org/pdf/2601.10245)**
...
>
---
#### [replaced 062] ParlaSpeech 3.0: Richly Annotated Spoken Parliamentary Corpora of Croatian, Czech, Polish, and Serbian
- **分类: cs.CL**

- **简介: 该论文介绍ParlaSpeech 3.0，一个包含克罗地亚语、捷克语、波兰语和塞尔维亚语的语音议会语料库。旨在提升语料的标注丰富度，支持多学科研究，通过自动标注增强文本和语音信息。**

- **链接: [https://arxiv.org/pdf/2511.01619](https://arxiv.org/pdf/2511.01619)**

> **作者:** Nikola Ljubešić; Peter Rupnik; Ivan Porupski; Taja Kuzman Pungeršek
>
> **备注:** Accepted at LREC 2026 conference; 12 pages, 2 figures, 3 tables
>
...
>
---
#### [replaced 063] MARCH: Evaluating the Intersection of Ambiguity Interpretation and Multi-hop Inference
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多跳问答任务，旨在解决多步推理与模糊性交织的问题。通过构建MARCH基准和提出CLARION框架，提升模型在复杂 ambiguity 场景下的推理能力。**

- **链接: [https://arxiv.org/pdf/2509.22750](https://arxiv.org/pdf/2509.22750)**
