...
- **简介: 该论文研究大语言模型压缩，旨在解决结构化剪枝中性能下降、权重合并低效和恢复机制缺失问题。提出CoMe方法，通过通道敏感性度量、基于拼接的层融合与分层蒸馏，实现高效压缩，在减少30%参数时保留83%原模型精度。**
...
- **链接: [http://arxiv.org/pdf/2510.15761v1](http://arxiv.org/pdf/2510.15761v1)**
...
- **链接: [http://arxiv.org/pdf/2510.15611v1](http://arxiv.org/pdf/2510.15611v1)**
...
- **简介: 该论文针对微小型无人机（MAV）动作识别任务，解决单一视觉模型难以捕捉复杂时空特征的问题。提出MAVR-Net框架，融合RGB、光流和分割掩码多视图数据，引入跨视图注意力与对齐损失，提升识别鲁棒性与精度。**
...
- **简介: 该论文聚焦先天性心脏病产前诊断，针对数据稀少、模态单一问题，构建首个公开多模态数据集CARDIUM，融合超声图像与临床记录，并提出跨模态Transformer模型，显著提升检测性能。**
...
- **简介: 该论文研究微表情识别任务，旨在解决因数据稀缺导致的模型泛化能力差问题。提出相位感知时序增强方法，将微表情分为 onset-to-apex 和 apex-to-offset 两阶段生成动态图像，增强运动多样性，提升识别性能。**
...
- **简介: 该论文研究开放词汇语义分割（OVSS），旨在解决现有方法缺乏空间关系理解的问题。作者提出RelateSeg，首次引入神经符号空间推理，通过一阶逻辑建模空间关系，结合模糊逻辑实现端到端学习，提升多物体场景的分割性能。**
...
- **简介: 该论文针对指令化视频编辑因缺乏高质量大规模数据而受限的问题，提出Ditto框架，通过融合图像编辑与视频生成，结合高效模型和智能代理，构建百万级合成数据集Ditto-1M，并训练出性能优越的Editto模型，显著提升指令跟随能力。**
...
- **简介: 该论文针对文本生成视频中质量依赖精确提示的问题，提出VISTA——一种测试时自改进的多智能体系统。它通过分解用户意图、迭代优化提示、多维度评测与反馈，显著提升视频质量与意图对齐。**
...
- **链接: [http://arxiv.org/pdf/2510.15564v1](http://arxiv.org/pdf/2510.15564v1)**
...
- **简介: 该论文研究多模态行人重识别，解决现有方法不支持任意模态查询组合的问题。提出FlexiReID框架，采用自适应混合专家机制和跨模态融合模块，支持七种检索模式，并构建新数据集CIRS-PEDES进行评测。**
...
- **简介: 该论文聚焦多模态大模型的跨模态一致性评估，提出XModBench基准，涵盖三模态六种组合的细粒度评测。旨在揭示模型在不同模态输入下的推理偏差与不一致问题，推动更均衡的跨模态理解发展。**
...
- **简介: 该论文研究深度学习在组织病理学基础模型训练中的可重复性问题，针对超参数选择与数据增强策略开展实验，分析其对模型性能和再现性的影响，并提出提升可重复性的实用建议。**
...
- **简介: 该论文针对全切片图像分类中现有方法难以捕捉全局依赖的问题，提出傅里叶变换多实例学习（FFT-MIL），通过频域分支提取低频全局上下文，与空间特征融合，提升分类性能。**
...
- **链接: [http://arxiv.org/pdf/2510.15673v1](http://arxiv.org/pdf/2510.15673v1)**
...
- **简介: 该论文属于图像生成控制任务，旨在解决生成模型内部机制难以理解与调控的问题。作者提出通过替换生成网络中的激活函数为可调参数的激活函数，使用户能通过调节参数直接干预生成过程，实现对输出的可控性，并在StyleGAN2和BigGAN上验证了方法有效性。**
...
- **链接: [http://arxiv.org/pdf/2510.15342v1](http://arxiv.org/pdf/2510.15342v1)**
...
- **简介: 该论文针对人脸识别模型中的系统性偏见问题，提出无需属性标签的“潜在特征对齐”（LFA）方法，通过发现可解释的潜在方向来识别语义一致的子群体，提升模型审计能力，无需依赖人工标注属性。**
...
- **简介: 该论文提出无人机视频-文本检索（DVTR）任务，针对无人机视频的高空视角、结构相似性和语义复杂性问题，设计多语义自适应挖掘方法（MSAM），通过细粒度图文交互与目标区域特征融合，提升跨模态检索性能。**
...
- **简介: 该论文研究 underwater open-vocabulary 实例分割任务，旨在解决现有方法难以识别新类别及水下图像退化、语义错位的问题。提出 MARIS 基准和包含几何增强与语义对齐的统一框架，提升水下场景中对可见与不可见类别的分割性能。**
...
- **简介: 该论文针对图像生成模型发展快但现有基准滞后的难题，提出ECHO框架，通过分析社交媒体中的真实使用案例构建动态评测基准，解决了传统 benchmarks 难以反映新能力的问题，并用于评估GPT-4o等模型。**
...
- **简介: 该论文针对多视角3D目标检测中深度预测质量差、跨视图一致性不足等问题，提出FreqPDE方法。通过频率感知的空间编码、跨视图尺度不变深度预测和位置深度编码，提升3D检测性能，无需依赖密集LiDAR监督。**
...
- **简介: 该论文针对LoRA适配器数量庞大导致的选择困难问题，提出一种基于子模优化的框架LoRAverse，旨在从海量适配器中检索出既相关又多样化的组合，提升扩散模型个性化生成的效果与效率。**
...
- **简介: 该论文提出Cortical-SSM，用于EEG/ECoG运动想象信号分类任务，旨在解决生理伪迹干扰和现有模型难以捕捉细粒度依赖的问题。作者设计了一种融合时、空、频域依赖的深度状态空间模型，并在多个数据集上验证了其优越性能。**
...
- **简介: 该论文属图像生成与数据增强任务，旨在解决生成数据时图像保真度与多样性难以平衡的问题。作者提出一种显著概念感知的生成框架，通过解耦关键特征与无关属性，提升生成图像的质量与多样性，增强下游模型鲁棒性。**
...
- **简介: 该论文面向目标检测的数据增强任务，解决生成模型在内容位置错位和语义泄露问题。提出ReCon框架，通过区域引导校正和区域对齐注意力机制，在扩散过程中提升生成图像的语义一致性与质量。**
...
>
---
#### [new 068] Shakti-VLMs: Scalable Vision-Language Models for Enterprise AI
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 077] Unimedvl: Unifying Medical Multimodal Understanding And Generation Through Observation-Knowledge-Analysis
- **分类: cs.CV**

- **简介: 该论文提出UniMedVL，旨在统一医疗多模态理解与生成任务。针对现有模型割裂处理理解与生成的问题，构建观察-知识-分析框架，通过新数据集、课程学习和统一架构，实现图文双向协同，提升多模态医疗诊断性能。**

- **链接: [http://arxiv.org/pdf/2510.15710v1](http://arxiv.org/pdf/2510.15710v1)**
...
>
---
#### [new 078] CuSfM: CUDA-Accelerated Structure-from-Motion
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 079] Learning to Detect Unknown Jailbreak Attacks in Large Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对大视觉语言模型的未知越狱攻击检测问题，提出名为LoD的通用框架。通过任务导向的安全表征学习与无监督攻击分类，提升对未知攻击的检测准确率与效率。**

- **链接: [http://arxiv.org/pdf/2510.15430v1](http://arxiv.org/pdf/2510.15430v1)**
...
>
---
#### [new 085] Post-Processing Methods for Improving Accuracy in MRI Inpainting
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对MRI图像中肿瘤区域影响自动化分析的问题，研究图像修复任务。通过模型集成与后处理（如滤波、直方图匹配）结合轻量U-Net优化，提升修复结果的解剖合理性和精度，增强临床可用性。**

- **链接: [http://arxiv.org/pdf/2510.15282v1](http://arxiv.org/pdf/2510.15282v1)**
...
>
---
#### [new 090] An Empirical Study on MC Dropout--Based Uncertainty--Error Correlation in 2D Brain Tumor Segmentation
- **分类: cs.LG; cs.CV; eess.IV**

- **简介: 该论文研究2D脑肿瘤分割中MC Dropout不确定性与分割误差的关系。针对MRI图像，分析不同数据增强下不确定性对边界错误的指示能力。实验表明其相关性弱，提示需改进不确定性估计方法。**

- **链接: [http://arxiv.org/pdf/2510.15541v1](http://arxiv.org/pdf/2510.15541v1)**

> **作者:** Saumya B
>
> **备注:** Code and results available at https://github.com/Saumya4321/mc-dropout-boundary-correlation
>
...
>
---
#### [new 094] RankSEG-RMA: An Efficient Segmentation Algorithm via Reciprocal Moment Approximation
- **分类: stat.ML; cs.CV; cs.LG**

- **简介: 该论文研究语义分割任务，旨在解决现有方法无法直接优化IoU和Dice指标且计算复杂的问题。作者提出RankSEG-RMA，通过倒数矩近似降低计算复杂度至O(d)，并支持非重叠分割，实现高效、高性能分割。**

- **链接: [http://arxiv.org/pdf/2510.15362v1](http://arxiv.org/pdf/2510.15362v1)**
...
>
---
#### [new 097] Neural Posterior Estimation for Cataloging Astronomical Images from the Legacy Survey of Space and Time
- **分类: astro-ph.IM; cs.CV; stat.AP; 85A35 (Primary), 62F15 (Secondary)**

- **简介: 该论文针对天文图像星表构建这一病态问题，提出采用神经后验估计（NPE）方法，结合深度学习实现高效、准确的光源检测与属性推断，并在模拟数据上优于传统方法，具备良好校准性。**

- **链接: [http://arxiv.org/pdf/2510.15315v1](http://arxiv.org/pdf/2510.15315v1)**
...
>
---
#### [new 098] Scaling Beyond Context: A Survey of Multimodal Retrieval-Augmented Generation for Document Understanding
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 099] Context-aware deep learning using individualized prior information reduces false positives in disease risk prediction and longitudinal health assessment
- **分类: cs.AI; cs.CV**

- **简介: 该论文提出一种结合个体化历史信息的上下文感知深度学习模型，用于疾病风险预测和长期健康评估。旨在减少仅用单次就诊数据导致的假阳性问题，提升特异性，同时保持高敏感性，尤其适用于低发病率人群的长期监测。**

- **链接: [http://arxiv.org/pdf/2510.15591v1](http://arxiv.org/pdf/2510.15591v1)**
...
>
---
#### [replaced 002] Self-supervised Multi-future Occupancy Forecasting for Autonomous Driving
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 005] DCMIL: A Progressive Representation Learning of Whole Slide Images for Cancer Prognosis Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14403v2](http://arxiv.org/pdf/2510.14403v2)**
...
>
---
#### [replaced 006] CLOVER: Context-aware Long-term Object Viewpoint- and Environment- Invariant Representation Learning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 007] MSCloudCAM: Cross-Attention with Multi-Scale Context for Multispectral Cloud Segmentation
- **分类: cs.CV; cs.AI; cs.LG; F.2.2; I.2.7**

- **链接: [http://arxiv.org/pdf/2510.10802v2](http://arxiv.org/pdf/2510.10802v2)**
...
>
---
#### [replaced 008] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.12292v2](http://arxiv.org/pdf/2504.12292v2)**

> **作者:** Liam Schoneveld; Zhe Chen; Davide Davoli; Jiapeng Tang; Saimon Terazawa; Ko Nishino; Matthias Nießner
>
> **备注:** For video demonstrations and additional materials please see https://nlml.github.io/sheap/
>
> **摘要:** Accurate, real-time 3D reconstruction of human heads from monocular images and videos underlies numerous visual applications. As 3D ground truth data is hard to come by at scale, previous methods have sought to learn from abundant 2D videos in a self-supervised manner. Typically, this involves the use of differentiable mesh rendering, which is effective but faces limitations. To improve on this, we propose SHeaP (Self-supervised Head Geometry Predictor Learned via 2D Gaussians). Given a source image, we predict a 3DMM mesh and a set of Gaussians that are rigged to this mesh. We then reanimate this rigged head avatar to match a target frame, and backpropagate photometric losses to both the 3DMM and Gaussian prediction networks. We find that using Gaussians for rendering substantially improves the effectiveness of this self-supervised approach. Training solely on 2D data, our method surpasses existing self-supervised approaches in geometric evaluations on the NoW benchmark for neutral faces and a new benchmark for non-neutral expressions. Our method also produces highly expressive meshes, outperforming state-of-the-art in emotion classification.
>
---
#### [replaced 009] Exploring and Leveraging Class Vectors for Classifier Editing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.11268v2](http://arxiv.org/pdf/2510.11268v2)**
...
>
---
#### [replaced 010] KGAlign: Joint Semantic-Structural Knowledge Encoding for Multimodal Fake News Detection
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 011] Point or Line? Using Line-based Representation for Panoptic Symbol Spotting in CAD Drawings
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23395v3](http://arxiv.org/pdf/2505.23395v3)**
...
>
---
#### [replaced 012] NFIG: Autoregressive Image Generation with Next-Frequency Prediction
- **分类: cs.CV; cs.AI; 68T07; I.2.10; I.2.6**

- **链接: [http://arxiv.org/pdf/2503.07076v4](http://arxiv.org/pdf/2503.07076v4)**
...
>
---
#### [replaced 013] Leveraging Learning Bias for Noisy Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07441v3](http://arxiv.org/pdf/2508.07441v3)**
...
>
---
#### [replaced 014] FASTopoWM: Fast-Slow Lane Segment Topology Reasoning with Latent World Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23325v3](http://arxiv.org/pdf/2507.23325v3)**
...
>
---
#### [replaced 015] Improving Clinical Dataset Condensation with Mode Connectivity-based Trajectory Surrogates
- **分类: cs.LG; cs.CV; cs.DB**

- **链接: [http://arxiv.org/pdf/2510.05805v2](http://arxiv.org/pdf/2510.05805v2)**
...
>
---
#### [replaced 016] Vision-Centric Activation and Coordination for Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14349v2](http://arxiv.org/pdf/2510.14349v2)**
...
>
---
#### [replaced 017] X$^{2}$-Gaussian: 4D Radiative Gaussian Splatting for Continuous-time Tomographic Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.21779v2](http://arxiv.org/pdf/2503.21779v2)**

> **作者:** Weihao Yu; Yuanhao Cai; Ruyi Zha; Zhiwen Fan; Chenxin Li; Yixuan Yuan
>
> **备注:** Project Page: https://x2-gaussian.github.io/
>
> **摘要:** Four-dimensional computed tomography (4D CT) reconstruction is crucial for capturing dynamic anatomical changes but faces inherent limitations from conventional phase-binning workflows. Current methods discretize temporal resolution into fixed phases with respiratory gating devices, introducing motion misalignment and restricting clinical practicality. In this paper, We propose X$^2$-Gaussian, a novel framework that enables continuous-time 4D-CT reconstruction by integrating dynamic radiative Gaussian splatting with self-supervised respiratory motion learning. Our approach models anatomical dynamics through a spatiotemporal encoder-decoder architecture that predicts time-varying Gaussian deformations, eliminating phase discretization. To remove dependency on external gating devices, we introduce a physiology-driven periodic consistency loss that learns patient-specific breathing cycles directly from projections via differentiable optimization. Extensive experiments demonstrate state-of-the-art performance, achieving a 9.93 dB PSNR gain over traditional methods and 2.25 dB improvement against prior Gaussian splatting techniques. By unifying continuous motion modeling with hardware-free period learning, X$^2$-Gaussian advances high-fidelity 4D CT reconstruction for dynamic clinical imaging. Code is publicly available at: https://x2-gaussian.github.io/.
>
---
#### [replaced 018] CADE 2.5 - ZeResFDG: Frequency-Decoupled, Rescaled and Zero-Projected Guidance for SD/SDXL Latent Diffusion Models
- **分类: cs.CV; 68T07, 68U10; I.2.10; I.4.8; I.4.9**

- **链接: [http://arxiv.org/pdf/2510.12954v2](http://arxiv.org/pdf/2510.12954v2)**
...
>
---
#### [replaced 019] Where MLLMs Attend and What They Rely On: Explaining Autoregressive Token Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.22496v2](http://arxiv.org/pdf/2509.22496v2)**
...
>
---
#### [replaced 020] Conformal Risk Control for Pulmonary Nodule Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.20167v2](http://arxiv.org/pdf/2412.20167v2)**
...
>
---
#### [replaced 021] PAD: Phase-Amplitude Decoupling Fusion for Multi-Modal Land Cover Classification
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [http://arxiv.org/pdf/2504.19136v3](http://arxiv.org/pdf/2504.19136v3)**
...
>
---
#### [replaced 022] CoUn: Empowering Machine Unlearning via Contrastive Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.16391v2](http://arxiv.org/pdf/2509.16391v2)**
...
>
---
#### [replaced 023] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
- **分类: cs.GR; cs.CV; 68U05, 68T45 (Primary) 68T07, 68-04 (Secondary); I.2.10; I.3.3; I.3.5; I.3.7; I.4.5; I.4.6; I.4.8; I.4.10**

- **链接: [http://arxiv.org/pdf/2510.01978v2](http://arxiv.org/pdf/2510.01978v2)**
...
>
---
#### [replaced 024] Universal Vessel Segmentation for Multi-Modality Retinal Images
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.06987v4](http://arxiv.org/pdf/2502.06987v4)**
...
>
---
#### [replaced 025] YOLOE: Real-Time Seeing Anything
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.07465v2](http://arxiv.org/pdf/2503.07465v2)**
...
>
---
#### [replaced 026] Skull-stripping induces shortcut learning in MRI-based Alzheimer's disease classification
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.15831v4](http://arxiv.org/pdf/2501.15831v4)**
...
>
---
#### [replaced 027] AppCopilot: Toward General, Accurate, Long-Horizon, and Efficient Mobile Agent
...
>
---
#### [replaced 028] VITA-VLA: Efficiently Teaching Vision-Language Models to Act via Action Expert Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.09607v2](http://arxiv.org/pdf/2510.09607v2)**
...
>
---
#### [replaced 029] D-TPT: Dimensional Entropy Maximization for Calibrating Test-Time Prompt Tuning in Vision-Language Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.09473v2](http://arxiv.org/pdf/2510.09473v2)**
...
>
---
#### [replaced 030] MLFM: Multi-Layered Feature Maps for Richer Language Understanding in Zero-Shot Semantic Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 033] First-order State Space Model for Lightweight Image Super-resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.08458v2](http://arxiv.org/pdf/2509.08458v2)**
...
>
---
#### [replaced 034] On the Interaction of Compressibility and Adversarial Robustness
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **链接: [http://arxiv.org/pdf/2507.17725v2](http://arxiv.org/pdf/2507.17725v2)**
...
>
---
#### [replaced 035] Scope: Selective Cross-modal Orchestration of Visual Perception Experts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.12974v2](http://arxiv.org/pdf/2510.12974v2)**
...
>
---
#### [replaced 038] MotionScript: Natural Language Descriptions for Expressive 3D Human Motions
...
>
---
#### [replaced 039] Foundation Model-Driven Classification of Atypical Mitotic Figures with Domain-Aware Training Strategies
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.02601v2](http://arxiv.org/pdf/2509.02601v2)**
...
>
---
#### [replaced 040] Identity-GRPO: Optimizing Multi-Human Identity-preserving Video Generation via Reinforcement Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14256v2](http://arxiv.org/pdf/2510.14256v2)**
...
>
---
#### [replaced 041] General-Purpose Robotic Navigation via LVLM-Orchestrated Perception, Reasoning, and Acting
...
>
---
#### [replaced 042] Perception Before Reasoning: Two-Stage Reinforcement Learning for Visual Reasoning in Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.13031v2](http://arxiv.org/pdf/2509.13031v2)**
...
>
---
#### [replaced 043] CHROME: Clothed Human Reconstruction with Occlusion-Resilience and Multiview-Consistency from a Single Image
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.15671v2](http://arxiv.org/pdf/2503.15671v2)**
...
>
---
#### [replaced 045] V2X-Radar: A Multi-modal Dataset with 4D Radar for Cooperative Perception
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.10962v3](http://arxiv.org/pdf/2411.10962v3)**
...
>
---
#### [replaced 046] Bolt3D: Generating 3D Scenes in Seconds
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.14445v2](http://arxiv.org/pdf/2503.14445v2)**
...
>
> **备注:** ICCV 2025. Project page: https://szymanowiczs.github.io/bolt3d
>
> **摘要:** We present a latent diffusion model for fast feed-forward 3D scene generation. Given one or more images, our model Bolt3D directly samples a 3D scene representation in less than seven seconds on a single GPU. We achieve this by leveraging powerful and scalable existing 2D diffusion network architectures to produce consistent high-fidelity 3D scene representations. To train this model, we create a large-scale multiview-consistent dataset of 3D geometry and appearance by applying state-of-the-art dense 3D reconstruction techniques to existing multiview image datasets. Compared to prior multiview generative models that require per-scene optimization for 3D reconstruction, Bolt3D reduces the inference cost by a factor of up to 300 times.
>
---
#### [replaced 047] Refer to Any Segmentation Mask Group With Vision-Language Prompts
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.05342v2](http://arxiv.org/pdf/2506.05342v2)**
...
>
---
#### [replaced 048] Elevating Visual Perception in Multimodal LLMs with Visual Embedding Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.09585v3](http://arxiv.org/pdf/2412.09585v3)**
...
>
---
#### [replaced 049] ChronoEdit: Towards Temporal Reasoning for Image Editing and World Simulation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.04290v2](http://arxiv.org/pdf/2510.04290v2)**
...
>
---
#### [replaced 050] Hyperbolic Dataset Distillation
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24623v2](http://arxiv.org/pdf/2505.24623v2)**
...
>
---
#### [replaced 051] Muddit: Liberating Generation Beyond Text-to-Image with a Unified Discrete Diffusion Model
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23606v3](http://arxiv.org/pdf/2505.23606v3)**
...
>
---
#### [replaced 052] Dataset Distillation for Super-Resolution without Class Labels and Pre-trained Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.14777v2](http://arxiv.org/pdf/2509.14777v2)**

> **作者:** Sunwoo Cho; Yejin Jung; Nam Ik Cho; Jae Woong Soh
>
> **备注:** code : https://github.com/sunwoocho/SRDD
>
...
>
---
#### [replaced 053] TAS: A Transit-Aware Strategy for Embodied Navigation with Non-Stationary Targets
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 054] Normal-Abnormal Guided Generalist Anomaly Detection
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.00495v3](http://arxiv.org/pdf/2510.00495v3)**
...
>
---
#### [replaced 055] TopoStreamer: Temporal Lane Segment Topology Reasoning in Autonomous Driving
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.00709v4](http://arxiv.org/pdf/2507.00709v4)**
...
>
---
#### [replaced 056] PaddleOCR-VL: Boosting Multilingual Document Parsing via a 0.9B Ultra-Compact Vision-Language Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14528v2](http://arxiv.org/pdf/2510.14528v2)**
...
>
---
#### [replaced 057] SIRI-Bench: Challenging VLMs' Spatial Intelligence through Complex Reasoning Tasks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.14512v3](http://arxiv.org/pdf/2506.14512v3)**
...
>
---
#### [replaced 058] HumorDB: Can AI understand graphical humor?
- **分类: cs.CV; cs.AI; I.5.4**

- **链接: [http://arxiv.org/pdf/2406.13564v3](http://arxiv.org/pdf/2406.13564v3)**
...
>
---
#### [replaced 059] From Language to Locomotion: Retargeting-free Humanoid Control via Motion Latent Guidance
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 060] VerlTool: Towards Holistic Agentic Reinforcement Learning with Tool Use
...
>
---
#### [replaced 061] PrefixKV: Adaptive Prefix KV Cache is What Vision Instruction-Following Models Need for Efficient Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.03409v4](http://arxiv.org/pdf/2412.03409v4)**
...
>
---
#### [replaced 062] UniMamba: Unified Spatial-Channel Representation Learning with Group-Efficient Mamba for LiDAR-based 3D Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.12009v3](http://arxiv.org/pdf/2503.12009v3)**
...
>
---
#### [replaced 063] Learning Unified Representations from Heterogeneous Data for Robust Heart Rate Modeling
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.21785v2](http://arxiv.org/pdf/2508.21785v2)**
...
>
---
#### [replaced 064] CCD: Mitigating Hallucinations in Radiology MLLMs via Clinical Contrastive Decoding
...
>
---
#### [replaced 067] BSGS: Bi-stage 3D Gaussian Splatting for Camera Motion Deblurring
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.12493v2](http://arxiv.org/pdf/2510.12493v2)**
...
>
---
#### [replaced 068] Towards Reliable and Holistic Visual In-Context Learning Prompt Selection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.25989v2](http://arxiv.org/pdf/2509.25989v2)**
...
>
---
#### [replaced 069] FG-CLIP 2: A Bilingual Fine-grained Vision-Language Alignment Model
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.10921v2](http://arxiv.org/pdf/2510.10921v2)**
...
>
---
#### [replaced 075] WebInject: Prompt Injection Attack to Web Agents
...
>
---
#### [replaced 076] iLRM: An Iterative Large 3D Reconstruction Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23277v2](http://arxiv.org/pdf/2507.23277v2)**
...
>
---
#### [replaced 077] Diffusion Models are Efficient Data Generators for Human Mesh Recovery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.11111v3](http://arxiv.org/pdf/2403.11111v3)**
...
>
---
#### [replaced 080] CoDS: Enhancing Collaborative Perception in Heterogeneous Scenarios via Domain Separation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13432v2](http://arxiv.org/pdf/2510.13432v2)**
...
>
---
#### [replaced 081] A Multimodal Deep Learning Approach for White Matter Shape Prediction in Diffusion MRI Tractography
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.18400v3](http://arxiv.org/pdf/2504.18400v3)**
...
>
---
#### [replaced 082] Genie Envisioner: A Unified World Foundation Platform for Robotic Manipulation
- **分类: cs.RO; cs.CV**
