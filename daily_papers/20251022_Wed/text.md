...
>
---
#### [new 003] MTraining: Distributed Dynamic Sparse Attention for Efficient Ultra-Long Context Training
...
- **简介: 该论文提出KrishokBondhu，一个面向孟加拉语农民的语音农业咨询系统。基于检索增强生成（RAG）技术，整合权威农业文本，通过电话提供实时、上下文相关的专家级建议，解决农民获取农技信息难的问题。**
...
- **简介: 该论文研究多模态大模型中将文本转为图像输入的效率问题，旨在减少解码器token使用。通过在长文本检索和摘要任务中实验，发现文本作图可节省近半token且不损性能，实现高效输入压缩。**
...
- **简介: 该论文研究GPT-2中影响文学风格生成的神经元，通过激活分析与消融实验揭示部分关联文学文本的神经元移除后反提升生成质量，挑战了相关性即因果的假设，揭示了神经网络中机制解释与实际生成间的差距。**
...
- **链接: [http://arxiv.org/pdf/2510.18561v1](http://arxiv.org/pdf/2510.18561v1)**
...
- **链接: [http://arxiv.org/pdf/2510.18257v1](http://arxiv.org/pdf/2510.18257v1)**
...
- **简介: 该论文旨在揭示AI在美国报纸新闻中的使用情况。研究通过AI检测工具Pangram分析18.6万篇文章，发现约9%含AI生成内容，多见于地方媒体和评论文章，且极少披露。研究呼吁加强透明度与编辑规范。**
...
- **简介: 该论文研究如何用大语言模型预测《龙与地下城》玩家行动并生成Avrae机器人指令。通过对比推理模型与指令模型，发现指令模型已足够胜任，且提示设计的细微变化显著影响结果。**
...
- **简介: 该论文研究低资源语言（如爱尔兰语）的机器翻译领域自适应问题，提出SemiAdapt和SemiLoRA方法，基于半监督学习提升参数高效微调性能，使小规模训练接近或超越全模型微调效果，降低计算门槛，促进低资源语言研究。**
...
- **简介: 该论文属自然语言处理任务，旨在解决大模型提示工程依赖专业知识的问题。作者提出一种自适应选择提示技术的方法，通过构建任务聚类与提示技术关联的知识库，实现基于任务描述自动生成功能性提示，提升非专家用户的使用效果。**
...
- **简介: 该论文聚焦于智能编程代理任务，旨在解决大模型在动态开发环境中执行代码生成与交互的可靠性问题。作者提出KAT-Coder，通过多阶段训练提升推理、规划与工具使用能力，并开源了32B模型KAT-Dev。**
...
- **简介: 该论文研究大语言模型如何分层使用深度进行预测，提出“先猜测后 refinement”的框架。通过分析中间表示，揭示模型早期依赖高频词猜测，随层数加深逐步修正，进而提升理解与生成的准确性。**
...
- **简介: 该论文提出Topoformer，通过空间查询与重加权在Transformer中引入脑相似的拓扑结构，提升模型可解释性。应用于 sentiment 分类和 BERT 架构，保持性能同时实现语言表征的拓扑组织，并与人脑语言网络对齐。**
...
>
---
#### [new 039] WebSeer: Training Deeper Search Agents through Reinforcement Learning with Self-Reflection
- **分类: cs.CL**
...
- **简介: 该论文提出SimBA框架，旨在简化大模型基准测试分析。针对现有基准数据复杂、难解读的问题，利用性能矩阵进行模型与数据集关联分析，发现代表性子集，并用其预测模型表现，实现高效模型评估与数据集验证。**
...
- **简介: 该论文属于模型可解释性任务，旨在解决Transformer中特征解释主观性强的问题。作者提出并自动提取基于规则的描述（如skip-gram、 absence、counting规则），用于客观刻画注意力层中SAE特征的行为，提升对模型机制的理解。**
...
- **简介: 该论文针对开放域任务中思维链（CoT）效果有限的问题，提出概念思维链（CoCT）新范式。通过先标记概念再生成内容，提升大模型在情感支持等开放任务中的深度思考能力，实验表明其优于多种现有方法。**
...
- **简介: 该论文研究手语翻译中的幻觉问题，即模型生成无视觉依据的文本。提出一种基于视觉信号的可靠性度量方法，量化解码器对视觉信息的依赖程度，用于检测幻觉，提升翻译可信度。**
...
- **简介: 该论文研究大语言模型对知识编辑植入事实的“信念深度”。提出评估框架，衡量植入知识的泛化性、鲁棒性和表征相似性。发现合成文档微调（SDF）效果较好，但与常识冲突的知识仍脆弱。推动知识编辑的可靠应用。**
...
>
---
#### [new 070] Position: LLM Watermarking Should Align Stakeholders' Incentives for Practical Adoption
- **分类: cs.CR; cs.CL**

- **简介: 该论文探讨大语言模型水印技术落地难的问题，指出核心在于利益相关方激励不一致。作者分析三类水印方法，提出应设计激励对齐、面向特定场景的方案，并以情境水印（ICW）为例，倡导推动实用化水印技术发展。**

- **链接: [http://arxiv.org/pdf/2510.18333v1](http://arxiv.org/pdf/2510.18333v1)**
...
>
---
#### [new 071] HouseTour: A Virtual Real Estate A(I)gent
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 072] Grasp Any Region: Towards Precise, Contextual Pixel Understanding for Multimodal LLMs
...
>
---
#### [new 073] Zero-Shot Vehicle Model Recognition via Text-Based Retrieval-Augmented Generation
...
>
---
#### [new 074] CodeRL+: Improving Code Generation via Reinforcement with Execution Semantics Alignment
- **分类: cs.SE; cs.AI; cs.CL**

- **简介: 该论文属代码生成任务，旨在解决模型生成代码的功能正确性与文本学习间的语义鸿沟。提出CodeRL+，通过执行语义对齐增强强化学习，利用变量级执行轨迹提供细粒度学习信号，提升代码正确率与泛化能力。**

- **链接: [http://arxiv.org/pdf/2510.18471v1](http://arxiv.org/pdf/2510.18471v1)**
...
>
---
#### [new 075] PLAGUE: Plug-and-play framework for Lifelong Adaptive Generation of Multi-turn Exploits
- **分类: cs.CR; cs.AI; cs.CL; cs.LG; cs.MA**

- **简介: 该论文提出PLAGUE框架，针对多轮对话中大模型易受隐蔽恶意指令攻击的问题，通过模拟终身学习代理，分阶段优化攻击流程，显著提升多轮越狱攻击的成功率，用于评估模型安全性。**

- **链接: [http://arxiv.org/pdf/2510.17947v1](http://arxiv.org/pdf/2510.17947v1)**
...
>
---
#### [new 079] Retaining by Doing: The Role of On-Policy Data in Mitigating Forgetting
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究语言模型后训练中的灾难性遗忘问题，比较微调与强化学习的遗忘模式。发现强化学习因使用on-policy数据，能更好保留旧知识，且性能不降。提出利用近似on-policy数据可有效缓解遗忘。**

- **链接: [http://arxiv.org/pdf/2510.18874v1](http://arxiv.org/pdf/2510.18874v1)**
...
>
---
#### [new 082] The Impact of Image Resolution on Biomedical Multimodal Large Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 083] Saber: An Efficient Sampling with Adaptive Acceleration and Backtracking Enhanced Remasking for Diffusion Language Model
- **分类: cs.AI; cs.CL; cs.LG; cs.SE**

- **简介: 该论文针对扩散语言模型在代码生成中推理速度与质量难以兼顾的问题，提出无需训练的采样算法Saber，通过自适应加速和回溯重掩码机制，在提升生成质量的同时显著加快推理速度。**

- **链接: [http://arxiv.org/pdf/2510.18165v1](http://arxiv.org/pdf/2510.18165v1)**
...
>
---
#### [new 084] Probabilistic Modeling of Intentions in Socially Intelligent LLM Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究多轮社交对话中LLM智能体的意图建模，旨在解决意图不明确下的交互问题。提出概率化意图建模框架，动态更新对对方意图的信念分布，提升对话策略适应性，在SOTOPIA任务中显著优于基线。**

- **链接: [http://arxiv.org/pdf/2510.18476v1](http://arxiv.org/pdf/2510.18476v1)**
...
>
---
#### [new 085] BreakFun: Jailbreaking LLMs via Schema Exploitation
- **分类: cs.CR; cs.AI; cs.CL; 68T50, 68T05, 68M07; I.2.7; I.2.6; K.6.5**

- **简介: 该论文研究大语言模型（LLM）因遵循结构化模式而产生的漏洞，提出BreakFun攻击方法，通过“特洛伊模式”诱导模型生成有害内容，并设计防御机制Adversarial Prompt Deconstruction进行缓解，揭示模型结构性弱点及应对策略。**

- **链接: [http://arxiv.org/pdf/2510.17904v1](http://arxiv.org/pdf/2510.17904v1)**
...
>
---
#### [replaced 002] Towards Greater Leverage: Scaling Laws for Efficient Mixture-of-Experts Language Models
- **分类: cs.CL; I.2.7**

- **链接: [http://arxiv.org/pdf/2507.17702v4](http://arxiv.org/pdf/2507.17702v4)**
...
>
---
#### [replaced 003] Semantic Agreement Enables Efficient Open-Ended LLM Cascades
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.21837v2](http://arxiv.org/pdf/2509.21837v2)**
...
>
---
#### [replaced 004] CoDial: Interpretable Task-Oriented Dialogue Systems Through Dialogue Flow Alignment
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02264v2](http://arxiv.org/pdf/2506.02264v2)**
...
>
---
#### [replaced 005] Discovering Properties of Inflectional Morphology in Neural Emergent Communication
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.05843v2](http://arxiv.org/pdf/2508.05843v2)**
...
>
---
#### [replaced 008] Segment Policy Optimization: Effective Segment-Level Credit Assignment in RL for Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23564v2](http://arxiv.org/pdf/2505.23564v2)**
...
>
---
#### [replaced 012] Soundness-Aware Level: A Microscopic Signature that Predicts LLM Reasoning Potential
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.15216v2](http://arxiv.org/pdf/2510.15216v2)**
...
>
---
#### [replaced 015] SpecExit: Accelerating Large Reasoning Model via Speculative Exit
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.24248v2](http://arxiv.org/pdf/2509.24248v2)**
...
>
---
#### [replaced 016] The Translation Barrier Hypothesis: Multilingual Generation with Large Language Models Suffers from Implicit Translation Failure
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.22724v2](http://arxiv.org/pdf/2506.22724v2)**
...
>
> **备注:** 23 pages - Nominated for Outstanding Paper award at EMNLP 2025
>
...
>
---
#### [replaced 020] Introducing Spotlight: A Novel Approach for Generating Captivating Key Information from Documents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.10935v3](http://arxiv.org/pdf/2509.10935v3)**
...
>
---
#### [replaced 025] Is Implicit Knowledge Enough for LLMs? A RAG Approach for Tree-based Structures
- **分类: cs.CL; cs.AI; cs.IR; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.10806v2](http://arxiv.org/pdf/2510.10806v2)**

> **作者:** Mihir Gupte; Paolo Giusto; Ramesh S
>
> **备注:** Waiting for Conference Response
>
> **摘要:** Large Language Models (LLMs) are adept at generating responses based on information within their context. While this ability is useful for interacting with structured data like code files, another popular method, Retrieval-Augmented Generation (RAG), retrieves relevant documents to augment the model's in-context learning. However, it is not well-explored how to best represent this retrieved knowledge for generating responses on structured data, particularly hierarchical structures like trees. In this work, we propose a novel bottom-up method to linearize knowledge from tree-like structures (like a GitHub repository) by generating implicit, aggregated summaries at each hierarchical level. This approach enables the knowledge to be stored in a knowledge base and used directly with RAG. We then compare our method to using RAG on raw, unstructured code, evaluating the accuracy and quality of the generated responses. Our results show that while response quality is comparable across both methods, our approach generates over 68% fewer documents in the retriever, a significant gain in efficiency. This finding suggests that leveraging implicit, linearized knowledge may be a highly effective and scalable strategy for handling complex, hierarchical data structures.
>
---
#### [replaced 026] Improving the fact-checking performance of language models by relying on their entailment ability
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.15050v3](http://arxiv.org/pdf/2505.15050v3)**
...
>
---
#### [replaced 027] Patent Language Model Pretraining with ModernBERT
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.14926v2](http://arxiv.org/pdf/2509.14926v2)**
...
>
---
#### [replaced 028] EvaLearn: Quantifying the Learning Capability and Efficiency of LLMs via Sequential Problem Solving
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.02672v3](http://arxiv.org/pdf/2506.02672v3)**

> **作者:** Shihan Dou; Ming Zhang; Chenhao Huang; Jiayi Chen; Feng Chen; Shichun Liu; Yan Liu; Chenxiao Liu; Cheng Zhong; Zongzhang Zhang; Tao Gui; Chao Xin; Chengzhi Wei; Lin Yan; Yonghui Wu; Qi Zhang; Xuanjing Huang
>
> **备注:** Accepted by NeurIPS 2025. 47 pages, 24 figures
>
...
>
---
#### [replaced 029] DrunkAgent: Stealthy Memory Corruption in LLM-Powered Recommender Agents
- **分类: cs.CR; cs.CL; cs.IR; cs.MA**

- **链接: [http://arxiv.org/pdf/2503.23804v3](http://arxiv.org/pdf/2503.23804v3)**

> **作者:** Shiyi Yang; Zhibo Hu; Xinshu Li; Chen Wang; Tong Yu; Xiwei Xu; Liming Zhu; Lina Yao
>
...
>
---
#### [replaced 030] Offline Policy Evaluation of Multi-Turn LLM Health Coaching with Real Users
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.17173v2](http://arxiv.org/pdf/2510.17173v2)**
...
>
---
#### [replaced 031] Ontology-Enhanced Knowledge Graph Completion using Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.20643v2](http://arxiv.org/pdf/2507.20643v2)**
...
>
---
#### [replaced 034] DCAD-2000: A Multilingual Dataset across 2000+ Languages with Data Cleaning as Anomaly Detection
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.11546v4](http://arxiv.org/pdf/2502.11546v4)**
...
>
---
#### [replaced 035] VITA-Audio: Fast Interleaved Cross-Modal Token Generation for Efficient Large Speech-Language Model
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.03739v2](http://arxiv.org/pdf/2505.03739v2)**
...
>
> **备注:** Training and Inference Codes: https://github.com/VITA-MLLM/VITA-Audio
>
> **摘要:** With the growing requirement for natural human-computer interaction, speech-based systems receive increasing attention as speech is one of the most common forms of daily communication. However, the existing speech models still experience high latency when generating the first audio token during streaming, which poses a significant bottleneck for deployment. To address this issue, we propose VITA-Audio, an end-to-end large speech model with fast audio-text token generation. Specifically, we introduce a lightweight Multiple Cross-modal Token Prediction (MCTP) module that efficiently generates multiple audio tokens within a single model forward pass, which not only accelerates the inference but also significantly reduces the latency for generating the first audio in streaming scenarios. In addition, a four-stage progressive training strategy is explored to achieve model acceleration with minimal loss of speech quality. To our knowledge, VITA-Audio is the first multi-modal large language model capable of generating audio output during the first forward pass, enabling real-time conversational capabilities with minimal latency. VITA-Audio is fully reproducible and is trained on open-source data only. Experimental results demonstrate that our model achieves an inference speedup of 3~5x at the 7B parameter scale, but also significantly outperforms open-source models of similar model size on multiple benchmarks for automatic speech recognition (ASR), text-to-speech (TTS), and spoken question answering (SQA) tasks.
>
---
#### [replaced 036] Correct-Detect: Balancing Performance and Ambiguity Through the Lens of Coreference Resolution in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.14456v2](http://arxiv.org/pdf/2509.14456v2)**
...
>
---
#### [replaced 037] Sparse Feature Coactivation Reveals Causal Semantic Modules in Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.18141v2](http://arxiv.org/pdf/2506.18141v2)**
...
>
---
#### [replaced 038] HauntAttack: When Attack Follows Reasoning as a Shadow
- **分类: cs.CR; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.07031v3](http://arxiv.org/pdf/2506.07031v3)**
...
>
---
#### [replaced 039] R-Horizon: How Far Can Your Large Reasoning Model Really Go in Breadth and Depth?
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.08189v2](http://arxiv.org/pdf/2510.08189v2)**
...
>
---
#### [replaced 040] A$^2$FM: An Adaptive Agent Foundation Model for Tool-Aware Hybrid Reasoning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.12838v3](http://arxiv.org/pdf/2510.12838v3)**
...
>
---
#### [replaced 041] Think Silently, Think Fast: Dynamic Latent Compression of LLM Reasoning Chains
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16552v5](http://arxiv.org/pdf/2505.16552v5)**
...
>
---
#### [replaced 042] Understanding Reinforcement Learning for Model Training, and future directions with GRAPE
- **分类: cs.CL; cs.AI; cs.LG; 68T07, 68T05, 62M45, 68T50, 90C40; I.2.6; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.04501v2](http://arxiv.org/pdf/2509.04501v2)**
...
>
---
#### [replaced 043] FALCON: Fine-grained Activation Manipulation by Contrastive Orthogonal Unalignment for Large Language Model
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.01472v3](http://arxiv.org/pdf/2502.01472v3)**
...
>
---
#### [replaced 046] Evaluating Program Semantics Reasoning with Type Inference in System F
- **分类: cs.CL; cs.PL; cs.SE**

- **链接: [http://arxiv.org/pdf/2509.23686v2](http://arxiv.org/pdf/2509.23686v2)**
...
>
---
#### [replaced 047] Can we Evaluate RAGs with Synthetic Data?
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.11758v2](http://arxiv.org/pdf/2508.11758v2)**
...
>
---
#### [replaced 048] SafeSearch: Do Not Trade Safety for Utility in LLM Search Agents
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.17017v2](http://arxiv.org/pdf/2510.17017v2)**
...
>
---
#### [replaced 053] Text Takes Over: A Study of Modality Bias in Multimodal Intent Detection
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.16122v3](http://arxiv.org/pdf/2508.16122v3)**
...
>
---
#### [replaced 054] A Survey of Process Reward Models: From Outcome Signals to Process Supervisions for Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.08049v2](http://arxiv.org/pdf/2510.08049v2)**
...
>
---
#### [replaced 055] Learning to Interpret Weight Differences in Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.05092v3](http://arxiv.org/pdf/2510.05092v3)**
...
>
---
#### [replaced 056] DanmakuTPPBench: A Multi-modal Benchmark for Temporal Point Process Modeling and Understanding
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.18411v2](http://arxiv.org/pdf/2505.18411v2)**
...
>
---
#### [replaced 058] IASC: Interactive Agentic System for ConLangs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2510.07591v2](http://arxiv.org/pdf/2510.07591v2)**
...
>
---
#### [replaced 059] SimBench: Benchmarking the Ability of Large Language Models to Simulate Human Behaviors
- **分类: cs.CL; cs.AI; cs.CY; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.17516v2](http://arxiv.org/pdf/2510.17516v2)**
...
>
---
#### [replaced 060] WHAT-IF: Exploring Branching Narratives by Meta-Prompting Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2412.10582v3](http://arxiv.org/pdf/2412.10582v3)**
...
>
---
#### [replaced 062] Generating Individual Travel Diaries Using Large Language Models Informed by Census and Land-Use Data
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.09710v2](http://arxiv.org/pdf/2509.09710v2)**
...
>
---
#### [replaced 065] Multi-Agent Collaboration via Evolving Orchestration
- **分类: cs.CL; cs.AI; cs.MA**

- **链接: [http://arxiv.org/pdf/2505.19591v2](http://arxiv.org/pdf/2505.19591v2)**
...
> **备注:** accepted at NeurIPS 2025
>
> **摘要:** Large language models (LLMs) have achieved remarkable results across diverse downstream tasks, but their monolithic nature restricts scalability and efficiency in complex problem-solving. While recent research explores multi-agent collaboration among LLMs, most approaches rely on static organizational structures that struggle to adapt as task complexity and agent numbers grow, resulting in coordination overhead and inefficiencies. To this end, we propose a puppeteer-style paradigm for LLM-based multi-agent collaboration, where a centralized orchestrator ("puppeteer") dynamically directs agents ("puppets") in response to evolving task states. This orchestrator is trained via reinforcement learning to adaptively sequence and prioritize agents, enabling flexible and evolvable collective reasoning. Experiments on closed- and open-domain scenarios show that this method achieves superior performance with reduced computational costs. Analyses further reveal that the key improvements consistently stem from the emergence of more compact, cyclic reasoning structures under the orchestrator's evolution. Our code is available at https://github.com/OpenBMB/ChatDev/tree/puppeteer.
>
---
#### [replaced 066] Think With Videos For Agentic Long-Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 069] Infinity Parser: Layout Aware Reinforcement Learning for Scanned Document Parsing
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 070] From Unaligned to Aligned: Scaling Multilingual LLMs with Multi-Way Parallel Corpora
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.14045v4](http://arxiv.org/pdf/2505.14045v4)**
