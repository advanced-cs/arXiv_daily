...
#### [new 001] PanDA: Unsupervised Domain Adaptation for Multimodal 3D Panoptic Segmentation in Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文属于多模态3D语义分割任务，旨在解决域适应问题。针对单传感器退化和伪标签不完整的问题，提出PanDA框架，通过异构增强和双专家伪标签优化提升模型泛化能力。**

- **链接: [https://arxiv.org/pdf/2604.19379](https://arxiv.org/pdf/2604.19379)**
...
>
---
#### [new 006] CityRAG: Stepping Into a City via Spatially-Grounded Video Generation
- **分类: cs.CV**

- **简介: 该论文提出CityRAG，解决生成物理一致、可导航的现实场景视频问题。通过地理注册数据增强场景真实性，实现长时序、复杂轨迹的视频生成。**
...
>
---
#### [new 007] How Far Are Video Models from True Multimodal Reasoning?
- **分类: cs.CV**

- **简介: 该论文属于视频理解任务，旨在评估视频模型在多模态推理上的能力。针对现有基准不足，提出CLVG-Bench和AVE，揭示SOTA模型在逻辑生成上的短板。**

- **链接: [https://arxiv.org/pdf/2604.19193](https://arxiv.org/pdf/2604.19193)**
...
>
---
#### [new 052] PLaMo 2.1-VL Technical Report
- **分类: cs.CV; cs.AI**

- **简介: 本文介绍轻量级视觉语言模型PLaMo 2.1-VL，用于边缘设备的视觉问答和视觉定位任务，解决工厂分析与设施检测问题，通过合成数据和日语资源提升性能。**

- **链接: [https://arxiv.org/pdf/2604.19324](https://arxiv.org/pdf/2604.19324)**
...
>
---
#### [new 061] Toward Clinically Acceptable Chest X-ray Report Generation: A Qualitative Retrospective Pilot Study of CXRMate-2
- **分类: cs.CV**

- **简介: 该论文属于胸部X光报告生成任务，旨在提升模型生成报告的临床可用性。通过改进模型结构和评估方法，验证其接近放射科医生水平的可行性。**

- **链接: [https://arxiv.org/pdf/2604.18967](https://arxiv.org/pdf/2604.18967)**
...
>
---
#### [new 071] Benchmarking Vision Foundation Models for Domain-Generalizable Face Anti-Spoofing
- **分类: cs.CV**

- **简介: 该论文属于人脸活体检测任务，旨在解决跨域泛化问题。通过基准测试15个预训练模型，提出一种高效且鲁棒的视觉基础模型方案。**

- **链接: [https://arxiv.org/pdf/2604.19196](https://arxiv.org/pdf/2604.19196)**
...
>
---
#### [new 073] EfficientPENet: Real-Time Depth Completion from Sparse LiDAR via Lightweight Multi-Modal Fusion
- **分类: cs.CV**

- **简介: 该论文提出EfficientPENet，解决实时深度补全问题，通过轻量多模态融合提升效率与精度，适用于嵌入式平台。**

- **链接: [https://arxiv.org/pdf/2604.18790](https://arxiv.org/pdf/2604.18790)**
...
>
---
#### [new 078] Geometric Decoupling: Diagnosing the Structural Instability of Latent
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像生成任务，旨在解决隐空间脆弱性问题。通过几何分析，揭示生成过程中的结构不稳定原因，提出几何解耦方法诊断可靠性。**

- **链接: [https://arxiv.org/pdf/2604.18804](https://arxiv.org/pdf/2604.18804)**

> **作者:** Yuanbang Liang; Zhengwen Chen; Yu-Kun Lai
>
> **摘要:** Latent Diffusion Models (LDMs) achieve high-fidelity synthesis but suffer from latent space brittleness, causing discontinuous semantic jumps during editing. We introduce a Riemannian framework to diagnose this instability by analyzing the generative Jacobian, decomposing geometry into \textit{Local Scaling} (capacity) and \textit{Local Complexity} (curvature). Our study uncovers a \textbf{``Geometric Decoupling"}: while curvature in normal generation functionally encodes image detail, OOD generation exhibits a functional decoupling where extreme curvature is wasted on unstable semantic boundaries rather than perceptible details. This geometric misallocation identifies ``Geometric Hotspots" as the structural root of instability, providing a robust intrinsic metric for diagnosing generative reliability.
>
---
#### [new 079] Multi-Domain Learning with Global Expert Mapping
- **分类: cs.CV**

- **简介: 该论文属于多领域学习任务，旨在解决模型在不同数据分布下的泛化问题。提出GEM框架，通过全局调度替代传统路由机制，提升专家网络的专精能力与性能。**

- **链接: [https://arxiv.org/pdf/2604.18842](https://arxiv.org/pdf/2604.18842)**
...
>
---
#### [new 081] Learning to Credit the Right Steps: Objective-aware Process Optimization for Visual Generation
- **分类: cs.CV**

- **简介: 该论文属于视觉生成任务，解决GRPO中奖励分配粗略的问题。提出OTCA框架，通过时间与目标感知的信用分配，提升生成质量。**
...
>
---
#### [new 082] Feasibility of Indoor Frame-Wise Lidar Semantic Segmentation via Distillation from Visual Foundation Model
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 083] MMControl: Unified Multi-Modal Control for Joint Audio-Video Generation
- **分类: cs.CV**

- **简介: 该论文属于多模态生成任务，旨在解决音频视频联合生成中的可控性不足问题。提出MMControl框架，实现视觉与音频的联合控制，提升生成质量与一致性。**
...
>
---
#### [new 086] Unposed-to-3D: Learning Simulation-Ready Vehicles from Real-World Images
- **分类: cs.CV**

- **简介: 该论文属于3D资产生成任务，旨在解决从真实图像中生成符合仿真要求的3D车辆模型的问题。通过两阶段方法，实现无姿态图像的3D重建与场景适配。**

- **链接: [https://arxiv.org/pdf/2604.19257](https://arxiv.org/pdf/2604.19257)**
...
>
---
#### [new 095] LLM-as-Judge Framework for Evaluating Tone-Induced Hallucination in Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉语言模型评估任务，旨在解决语气诱导幻觉问题。通过构建基准数据集，分析模型在不同语气强度下的幻觉表现。**
...
>
---
#### [new 096] EgoSelf: From Memory to Personalized Egocentric Assistant
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出EgoSelf系统，解决个性化自指助手的长期数据整合问题。通过构建图交互记忆和预测任务，提升用户行为预测准确性。**
...
>
---
#### [new 101] Mind2Drive: Predicting Driver Intentions from EEG in Real-world On-Road Driving
...
>
---
#### [new 108] Generalization at the Edge of Stability
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **简介: 该论文属于机器学习领域，研究神经网络在稳定边缘的泛化问题。通过将优化器建模为随机动力系统，提出“sharpness dimension”概念，分析泛化性能与Hessian谱的关系，揭示混沌区域的复杂性。**

- **链接: [https://arxiv.org/pdf/2604.19740](https://arxiv.org/pdf/2604.19740)**
...
>
---
#### [new 109] Chat2Workflow: A Benchmark for Generating Executable Visual Workflows with Natural Language
...
>
---
#### [new 110] Guiding Distribution Matching Distillation with Gradient-Based Reinforcement Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于生成任务，解决少步生成中质量与速度的平衡问题。提出GDMD框架，通过梯度引导提升蒸馏效果，实现更高质量的生成结果。**

- **链接: [https://arxiv.org/pdf/2604.19009](https://arxiv.org/pdf/2604.19009)**
...
>
---
#### [new 111] RDP LoRA: Geometry-Driven Identification for Parameter-Efficient Adaptation in Large Language Models
...
>
---
#### [new 112] SAGE: Training-Free Semantic Evidence Composition for Edge-Cloud Inference under Hard Uplink Budgets
- **分类: cs.LG; cs.CV; eess.SP**

- **简介: 该论文属于边缘-云推理任务，解决在上行带宽受限下如何高效传输信息的问题。提出SAGE方法，结合重要性过滤与语义多样性采样，提升推理精度。**

- **链接: [https://arxiv.org/pdf/2604.19623](https://arxiv.org/pdf/2604.19623)**
...
>
---
#### [new 113] Robust Continual Unlearning against Knowledge Erosion and Forgetting Reversal
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于机器学习任务，解决持续去遗忘中的知识衰退和遗忘反转问题，提出SAFER框架以保持模型稳定性。**

- **链接: [https://arxiv.org/pdf/2604.19108](https://arxiv.org/pdf/2604.19108)**
...
>
---
#### [new 114] A Controlled Benchmark of Visual State-Space Backbones with Domain-Shift and Boundary Analysis for Remote-Sensing Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于遥感图像分割任务，旨在比较视觉状态空间模型的性能。通过控制实验，分析编码器效果、域适应性和边界识别问题。**

- **链接: [https://arxiv.org/pdf/2604.18721](https://arxiv.org/pdf/2604.18721)**
...
>
---
#### [new 116] Concept Inconsistency in Dermoscopic Concept Bottleneck Models: A Rough-Set Analysis of the Derm7pt Dataset
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究皮肤镜CBM中的概念不一致问题，通过粗糙集分析Derm7pt数据集，识别并解决概念与诊断的矛盾，提升模型准确性和可解释性。**

- **链接: [https://arxiv.org/pdf/2604.19323](https://arxiv.org/pdf/2604.19323)**
...
>
---
#### [new 117] Rethinking Dataset Distillation: Hard Truths about Soft Labels
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于数据蒸馏任务，探讨为何软标签下随机基线表现优异，提出新方法CA2D提升效率。**

- **链接: [https://arxiv.org/pdf/2604.18811](https://arxiv.org/pdf/2604.18811)**
...
>
---
#### [new 118] VLA Foundry: A Unified Framework for Training Vision-Language-Action Models
...
>
---
#### [replaced 002] Bridging Semantics and Geometry: A Decoupled LVLM-SAM Framework for Reasoning Segmentation in Optical Remote Sensing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.19302](https://arxiv.org/pdf/2512.19302)**
...
>
---
#### [replaced 005] Memory Over Maps: 3D Object Localization Without Reconstruction
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 010] Centralized Copy-Paste: Enhanced Data Augmentation Strategy for Wildland Fire Semantic Segmentation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.06321](https://arxiv.org/pdf/2507.06321)**

> **作者:** Joon Tai Kim; Tianle Chen; Ziyu Dong; Nishanth Kunchala; Alexander Guller; Daniel Ospina Acero; Roger Williams; Mrinal Kumar
>
> **备注:** 16 pages, 5 figures; published in AIAA SciTech Forum 2026, Paper 2026-1763
>
...
>
---
#### [replaced 011] UDM-GRPO: Stable and Efficient Group Relative Policy Optimization for Uniform Discrete Diffusion Models
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 012] From Verbatim to Gist: Distilling Pyramidal Multimodal Memory via Semantic Information Bottleneck for Long-Horizon Video Agents
...
>
---
#### [replaced 013] OmniGen2: Towards Instruction-Aligned Multimodal Generation
...
>
---
#### [replaced 014] VLM-3R: Vision-Language Models Augmented with Instruction-Aligned 3D Reconstruction
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 019] LPO: Towards Accurate GUI Agent Interaction via Location Preference Optimization
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.09373](https://arxiv.org/pdf/2506.09373)**
...
>
---
#### [replaced 024] MESA: A Training-Free Multi-Exemplar Deep Framework for Restoring Ancient Inscription Textures
- **分类: cs.CV; cs.AI; cs.GR**

- **链接: [https://arxiv.org/pdf/2604.17390](https://arxiv.org/pdf/2604.17390)**

> **作者:** Vasileios Toulatzis; Sofia Theodoridou; Ioannis Fudos
>
...
>
---
#### [replaced 025] A Survey on MLLM-based Visually Rich Document Understanding: Methods, Challenges, and Emerging Trends
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.09861](https://arxiv.org/pdf/2507.09861)**

> **作者:** Yihao Ding; Siwen Luo; Yue Dai; Yanbei Jiang; Zechuan Li; Qiang Sun; Geoffrey Martin; Wei Liu; Yifan Peng
>
> **备注:** Accepted at ACL 2026 Findings
>
> **摘要:** Visually Rich Document Understanding (VRDU) has become a pivotal area of research, driven by the need to automatically interpret documents that contain intricate visual, textual, and structural elements. Recently, Multimodal Large Language Models (MLLMs) have demonstrated significant promise in this domain, including both OCR-based and OCR-free approaches for information extraction from document images. This survey reviews recent advances in MLLM-based VRDU, highlighting emerging trends and promising research directions with a focus on two key aspects: (1) techniques for representing and integrating textual, visual, and layout features; (2) training paradigms, including pretraining, instruction tuning, and training strategies. Moreover, we address challenges such as data scarcity, handling multi-page and multilingual documents, and integrating emerging trends such as Retrieval-Augmented Generation and agentic frameworks. Our analysis offers a roadmap for advancing MLLM-based VRDU toward more scalable, reliable, and adaptable systems.
>
---
#### [replaced 026] Unsupervised Local Plasticity in a Multi-Frequency VisNet Hierarchy
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 027] Ensembling Pruned Attention Heads For Uncertainty-Aware Efficient Transformers
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.18358](https://arxiv.org/pdf/2510.18358)**
...
>
---
#### [replaced 028] DuQuant++: Fine-grained Rotation Enhances Microscaling FP4 Quantization
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 029] Bridging Time and Space: Decoupled Spatio-Temporal Alignment for Video Grounding
- **分类: cs.CV**
...
>
---
#### [replaced 030] Weakly supervised framework for wildlife detection and counting in challenging Arctic environments: a case study on caribou (Rangifer tarandus)
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.18891](https://arxiv.org/pdf/2601.18891)**

> **作者:** Ghazaleh Serati; Samuel Foucher; Jerome Theau
>
> **备注:** 30 pages, 8 figures, published in Frontiers in Ecology and Evolution
>
...
>
---
#### [replaced 031] PuzzleWorld: A Benchmark for Multimodal, Open-Ended Reasoning in Puzzlehunts
...
>
---
#### [replaced 032] OmniParser V2: Structured-Points-of-Thought for Unified Visual Text Parsing and Its Generality to Multimodal Large Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 033] Geometry-Aware CLIP Retrieval via Local Cross-Modal Alignment and Steering
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 034] CLIPoint3D: Language-Grounded Few-Shot Unsupervised 3D Point Cloud Domain Adaptation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.20409](https://arxiv.org/pdf/2602.20409)**
...
>
---
#### [replaced 035] How to Teach Large Multimodal Models New Skills
- **分类: cs.AI; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.08564](https://arxiv.org/pdf/2510.08564)**
...
>
---
#### [replaced 041] AD-Copilot: A Vision-Language Assistant for Industrial Anomaly Detection via Visual In-context Comparison
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2603.13779](https://arxiv.org/pdf/2603.13779)**
...
>
---
#### [replaced 043] Weakly-Supervised Referring Video Object Segmentation through Text Supervision
- **分类: cs.CV**
...
>
---
#### [replaced 045] MM-JudgeBias: A Benchmark for Evaluating Compositional Biases in MLLM-as-a-Judge
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [replaced 046] VDPP: Video Depth Post-Processing for Speed and Scalability
- **分类: cs.CV**
...
>
> **备注:** 8 pages, 6 figures. Accepted to CVPR 2026 ECV Workshop. Project page: this https URL
>
...
>
---
#### [replaced 047] Q-Mask: Query-driven Causal Masks for Text Anchoring in OCR-Oriented Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 048] Memorize When Needed: Decoupled Memory Control for Spatially Consistent Long-Horizon Video Generation
- **分类: cs.CV**
...
>
---
#### [replaced 049] KG-ViP: Bridging Knowledge Grounding and Visual Perception in Multi-modal LLMs for Visual Question Answering
- **分类: cs.CV**
...
>
---
#### [replaced 050] ORSIFlow: Saliency-Guided Rectified Flow for Optical Remote Sensing Salient Object Detection
- **分类: cs.CV**
...
>
---
#### [replaced 051] Mammo-FM: Breast-specific foundational model for Integrated Mammographic Diagnosis, Prognosis, and Reporting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00198](https://arxiv.org/pdf/2512.00198)**

> **作者:** Shantanu Ghosh; Vedant Parthesh Joshi; Rayan Syed; Param Budhraja; Aya Kassem; Katelyn C. Morrison; Alex Tang; Ho Cheung Aiden Wong; Abhishek Varshney; Payel Basak; Weicheng Dai; Judy Wawira Gichoya; Hari M. Trivedi; Imon Banerjee; Shyam Visweswaran; Clare B. Poynton; Kayhan Batmanghelich
>
...
>
---
#### [replaced 052] 3D Foundation Model for Generalizable Disease Detection in Head Computed Tomography
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2502.02779](https://arxiv.org/pdf/2502.02779)**
...
>
---
#### [replaced 054] SMART-Ship: A Comprehensive Synchronized Multi-modal Aligned Remote Sensing Targets Dataset and Benchmark for Berthed Ships Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.02384](https://arxiv.org/pdf/2508.02384)**
...
>
---
#### [replaced 055] BARD: Bridging AutoRegressive and Diffusion Vision-Language Models Via Highly Efficient Progressive Block Merging and Stage-Wise Distillation
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 059] MultiWorld: Scalable Multi-Agent Multi-View Video World Models
- **分类: cs.CV**
...
>
---
#### [replaced 060] ViDoRe V3: A Comprehensive Evaluation of Retrieval Augmented Generation in Complex Real-World Scenarios
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.08620](https://arxiv.org/pdf/2601.08620)**
...
>
---
#### [replaced 065] ORCA: An Agentic Reasoning Framework for Hallucination and Adversarial Robustness in Vision-Language Models
- **分类: cs.CV; cs.AI; cs.MA**
...
>
---
#### [replaced 069] Fine-tuning DeepSeek-OCR-2 for Molecular Structure Recognition
...
>
> **备注:** Accepted to CVPR 2026, with appendix
>
...
>
---
#### [replaced 073] Realistic Handwritten Multi-Digit Writer (MDW) Number Recognition Challenges
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.00676](https://arxiv.org/pdf/2512.00676)**
...
>
---
#### [replaced 074] A deep learning pipeline for PAM50 subtype classification using histopathology images and multi-objective patch selection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2604.01798](https://arxiv.org/pdf/2604.01798)**

> **作者:** Arezoo Borji; Gernot Kronreif; Bernhard Angermayr; Francisco Mario Calisto; Ali Abbasian Ardakani; Wolfgang Birkfellner; Inna Servetnyk; Yinyin Yuan; Sepideh Hatamikia
>
...
>
---
#### [replaced 075] Recurrent Video Masked Autoencoders
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.13684](https://arxiv.org/pdf/2512.13684)**
...
>
---
#### [replaced 076] Text Slider: Efficient and Plug-and-Play Continuous Concept Control for Image/Video Synthesis via LoRA Adapters
- **分类: cs.GR; cs.AI; cs.CV; cs.LG; cs.MM**

- **链接: [https://arxiv.org/pdf/2509.18831](https://arxiv.org/pdf/2509.18831)**

> **作者:** Pin-Yen Chiu; I-Sheng Fang; Jun-Cheng Chen
>
> **备注:** Accepted by WACV 2026. We provide more experimental results on the train-free version of our algorithm. Project page: this https URL Code: this https URL
>
...
>
---
#### [replaced 077] Cloning Deterministic Worlds: The Critical Role of Latent Geometry in Long-Horizon World Models
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.26782](https://arxiv.org/pdf/2510.26782)**
...
>
---
#### [replaced 078] TFusionOcc: T-Primitive Based Object-Centric Multi-Sensor Fusion Framework for 3D Occupancy Prediction
...
>
---
#### [replaced 079] LAMP: Lift Image-Editing as General 3D Priors for Open-world Manipulation
- **分类: cs.CV**
...
>
---
#### [replaced 080] AnchorSeg: Language Grounded Query Banks for Reasoning Segmentation
- **分类: cs.CV**
