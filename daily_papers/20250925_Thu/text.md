...
- **链接: [http://arxiv.org/pdf/2509.19343v1](http://arxiv.org/pdf/2509.19343v1)**
...
- **简介: 该论文属于自然语言处理中的性别偏见检测任务，旨在揭示多语言大模型在低资源语言（如波斯语）中的性别刻板印象。研究提出了一种基于模板的探测方法和DS-GSI指标，评估了四款主流模型在四个语义领域的性别偏差，发现波斯语中偏见更严重，尤其体现在体育领域。**
...
- **简介: 该论文针对大语言模型生成过程中计算成本高的问题，提出了一种基于流水线并行的自推测解码方法（PPSD）。通过将草案和验证阶段重叠执行，提高了推理效率。实验表明，PPSD在多个基准测试中实现了2.01x~3.81x的加速效果。**
...
- **简介: 该论文针对BERTopic在社交媒体数据上生成过多重叠主题的问题，提出结合大语言模型进行主题合并的框架，提升主题多样性和一致性。**
...
- **链接: [http://arxiv.org/pdf/2509.20209v1](http://arxiv.org/pdf/2509.20209v1)**
...
- **简介: 该论文研究了基于大语言模型的实体匹配任务中置信度校准问题。针对RoBERTa模型在实体匹配中的轻微过度自信问题，采用温度缩放、蒙特卡洛Dropout和集成方法进行对比实验，发现温度缩放可有效降低预期校准误差最高达23.83%。**
...
- **链接: [http://arxiv.org/pdf/2509.20086v1](http://arxiv.org/pdf/2509.20086v1)**
...
- **简介: 该论文针对数学推理中偏好学习效果差的问题，提出Future Policy Aware (FPA)方法，通过未来策略预估实现主动正则化，减少有用token的过惩罚，提升DPO等算法在MATH和GSM8K上的性能。**
...
- **简介: 该论文提出TriSPrompt，用于多模态谣言检测任务，旨在解决真实场景中模态缺失的问题。通过引入三种提示（MA、MM、MV），提升模型对不完整数据的适应能力与检测性能。**
...
- **链接: [http://arxiv.org/pdf/2509.20074v1](http://arxiv.org/pdf/2509.20074v1)**
...
- **简介: 该论文综述了2020-2025年间基于大语言模型（LLM）的临床试验匹配方法，旨在解决患者与试验手动匹配效率低的问题。研究分析了31篇文献，比较不同模型和策略的效果，指出GPT-4表现最佳，并探讨了数据隐私、成本及公平性等挑战。**
...
- **简介: 该论文研究像素级语言模型在语义任务中的不确定性，涉及18种语言和7种文字。通过多种方法分析发现，像素模型低估了不确定性，且受文字系统影响。集成学习在实体识别和问答任务中表现更优。**
...
- **简介: 该论文提出了KT的负责任AI评估方法及风险缓解技术，旨在确保AI服务的安全与可靠。通过建立符合国内环境的风险分类体系和实用工具，系统识别并管理AI全生命周期中的风险，并发布实时拦截有害输出的安全工具SafetyGuard，推动国内AI生态安全发展。**
...
- **简介: 该论文提出一种名为“思考增强预训练”（TPT）的方法，旨在提高大语言模型预训练的数据效率。通过向文本数据中自动添加推理轨迹，增加训练数据的信息量，使高质量token更易学习。实验表明，TPT显著提升了多种模型在不同数据条件下的性能，数据效率提高3倍。**
...
- **链接: [http://arxiv.org/pdf/2509.19858v1](http://arxiv.org/pdf/2509.19858v1)**
...
- **简介: 该论文提出一个基于规则的Ge'ez语言形态合成器，旨在解决其复杂的形态结构和资源匮乏问题。通过生成表层词形，系统在1,102个动词测试中达到97.4%的性能，为后续NLP研究奠定基础。**
...
- **简介: 该论文提出通过模型合并实现大语言模型的个性调节任务，旨在解决现有方法难以捕捉人类特质连续性和多维性的问题。作者构建了“个性向量”，通过权重差值和合并方式，无需额外训练即可控制模型表现出特定人格特质，并验证了其可组合性和泛化性。**
...
- **链接: [http://arxiv.org/pdf/2509.20004v1](http://arxiv.org/pdf/2509.20004v1)**
...
- **简介: 该论文提出EmbeddingGemma，一种轻量级文本嵌入模型，基于Gemma架构。通过编码器-解码器初始化和几何嵌入蒸馏等方法，在保证性能的同时显著降低参数规模，适用于低延迟场景。**
...
>
---
#### [new 056] Feeding Two Birds or Favoring One? Adequacy-Fluency Tradeoffs in Evaluation and Meta-Evaluation of Machine Translation
...
- **简介: 该论文提出RoadMind，一个自监督框架，旨在提升大语言模型对地理空间数据（如道路网络）的推理能力。针对灾害响应中的空间理解需求，利用OpenStreetMap数据训练模型，显著优于现有基线方法。属于灾难响应中的地理AI任务。**
...
- **简介: 该论文属于多语言NLP任务，旨在解决语言类型学特征高维稀疏导致距离度量效果差的问题。提出结合特征选择与填充的优化方法，生成紧凑且可解释的特征表示，提升跨语言建模性能。**
...
>
---
#### [new 071] LLMs4All: A Review on Large Language Models for Research and Applications in Academic Disciplines
- **分类: cs.CL**

- **简介: 该论文综述了大语言模型（LLMs）在多个学术领域的应用与影响，涵盖人文、经济和科学工程等学科。任务是探讨LLMs如何推动研究与实践，并分析其局限与挑战。论文旨在为研究人员提供LLMs跨学科应用的洞察与参考。**

- **链接: [http://arxiv.org/pdf/2509.19580v1](http://arxiv.org/pdf/2509.19580v1)**
...
>
---
#### [new 072] A Pipeline to Assess Merging Methods via Behavior and Internals
- **分类: cs.CL**

- **简介: 该论文提出一个评估语言模型合并方法的综合管道，结合行为表现和内部机制分析。任务是模型合并方法评估，旨在解决现有研究仅关注行为表现的问题，通过实验展示了合并对模型性能及语言能力的影响差异。**

- **链接: [http://arxiv.org/pdf/2509.19476v1](http://arxiv.org/pdf/2509.19476v1)**
...
>
---
#### [new 079] Mahānāma: A Unique Testbed for Literary Entity Discovery and Linking
- **分类: cs.CL**

- **简介: 该论文提出Mahānāma，首个大规模梵语实体发现与链接（EDL）数据集，用于解决文学文本中实体消歧难题。基于《摩诃婆罗多》，包含109K实体提及和5.5K唯一实体，评估显示现有模型在复杂语境下表现不佳，为文学领域实体解析提供新基准。**

- **链接: [http://arxiv.org/pdf/2509.19844v1](http://arxiv.org/pdf/2509.19844v1)**
...
>
---
#### [new 084] Federation of Agents: A Semantics-Aware Communication Fabric for Large-Scale Agentic AI
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出Federation of Agents（FoA），一种面向大规模智能体协作的语义感知通信框架。通过引入版本化能力向量（VCVs）和三项关键技术（语义路由、动态任务分解、智能聚类），实现异构AI代理的高效协同，解决多代理系统中静态协调不足的问题，提升复杂任务处理效率与扩展性。**

- **链接: [http://arxiv.org/pdf/2509.20175v1](http://arxiv.org/pdf/2509.20175v1)**
...
>
---
#### [new 090] PromptCoT 2.0: Scaling Prompt Synthesis for Large Language Model Reasoning
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出PromptCoT 2.0，用于提升大语言模型的推理能力。针对高质量训练数据不足的问题，采用EM框架合成更难、更多样的问题，并支持自博弈和监督微调两种训练方式，显著提升了模型在数学与编程任务中的表现。**

- **链接: [http://arxiv.org/pdf/2509.19894v1](http://arxiv.org/pdf/2509.19894v1)**
...
>
---
#### [new 091] Cognitive Load Limits in Large Language Models: Benchmarking Multi-Hop Reasoning
- **分类: cs.AI; cs.CL; cs.LG; I.2.7; I.2.6**

- **简介: 该论文研究大语言模型在多跳推理任务中的认知负荷限制，提出计算认知负荷理论，并设计ICE基准测试。通过实验揭示了模型在动态复杂环境下的性能脆弱性，强调认知负荷对推理失败的影响，为评估AI系统鲁棒性提供新方法。**

- **链接: [http://arxiv.org/pdf/2509.19517v1](http://arxiv.org/pdf/2509.19517v1)**
...
>
---
#### [new 092] VCRL: Variance-based Curriculum Reinforcement Learning for Large Language Models
- **分类: cs.LG; cs.CL**

- **简介: 该论文针对大语言模型在数学推理任务中的强化学习问题，提出VCRL方法。通过分析样本难度与奖励方差的关系，构建基于方差的课程学习框架，动态调整训练难度，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2509.19803v1](http://arxiv.org/pdf/2509.19803v1)**
...
>
---
#### [new 093] Failure Modes of Maximum Entropy RLHF
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究最大熵RLHF的失效模式，探讨SimPO与最大熵强化学习的关系。通过实验发现最大熵RL在在线RLHF中存在过优化和不稳定问题，对比分析了在线/离线设置下参考自由方法的挑战。**

- **链接: [http://arxiv.org/pdf/2509.20265v1](http://arxiv.org/pdf/2509.20265v1)**
...
>
---
#### [new 094] Human-AI Narrative Synthesis to Foster Shared Understanding in Civic Decision-Making
- **分类: cs.HC; cs.CL**

- **简介: 该论文属于人机协作叙事生成任务，旨在解决社区反馈信息量大、难以形成共识的问题。作者开发了StoryBuilder系统，将社区意见转化为第一人称故事，并通过实验验证其在促进理解和信任方面的有效性。**

- **链接: [http://arxiv.org/pdf/2509.19643v1](http://arxiv.org/pdf/2509.19643v1)**
...
>
---
#### [new 096] UserRL: Training Interactive User-Centric Agent via Reinforcement Learning
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出UserRL框架，通过强化学习训练用户中心智能体。任务是提升多轮交互能力，解决用户多样性与动态性带来的挑战。工作包括设计奖励机制、轨迹评分，并验证不同用户模拟器对训练效果的影响。**

- **链接: [http://arxiv.org/pdf/2509.19736v1](http://arxiv.org/pdf/2509.19736v1)**
...
>
---
#### [new 097] Advancing Speech Summarization in Multi-modal LLMs with Reinforcement Learning
- **分类: eess.AS; cs.AI; cs.CL**

- **简介: 该论文聚焦语音摘要任务，旨在提升多模态大模型（MLLMs）的语音摘要能力。针对开源MLLMs性能落后的问题，提出一种多阶段强化学习训练框架，显著提升了摘要效果，缩小了与文本模型的差距。**

- **链接: [http://arxiv.org/pdf/2509.19631v1](http://arxiv.org/pdf/2509.19631v1)**
...
>
---
#### [new 098] Embodied AI: From LLMs to World Models
...
#### [replaced 001] LLMs Reproduce Stereotypes of Sexual and Gender Minorities
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2501.05926v3](http://arxiv.org/pdf/2501.05926v3)**
...
>
---
#### [replaced 004] Urania: Differentially Private Insights into AI Use
...
>
---
#### [replaced 005] Localized LoRA: A Structured Low-Rank Approximation for Efficient Fine-Tuning
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.00236v2](http://arxiv.org/pdf/2506.00236v2)**

> **作者:** Babak Barazandeh; Subhabrata Majumdar; Om Rajyaguru; George Michailidis
>
...
>
---
#### [replaced 006] Enhancing RAG Efficiency with Adaptive Context Compression
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.22931v3](http://arxiv.org/pdf/2507.22931v3)**
...
>
---
#### [replaced 007] Resource-Efficient Adaptation of Large Language Models for Text Embeddings via Prompt Engineering and Contrastive Fine-tuning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.22729v2](http://arxiv.org/pdf/2507.22729v2)**
...
>
---
#### [replaced 013] Online Process Reward Leanring for Agentic Reinforcement Learning
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.19199v2](http://arxiv.org/pdf/2509.19199v2)**
...
>
---
#### [replaced 014] Culture is Everywhere: A Call for Intentionally Cultural Evaluation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.01301v2](http://arxiv.org/pdf/2509.01301v2)**
...
>
---
#### [replaced 015] Advancing Expert Specialization for Better MoE
- **分类: cs.CL; cs.SE; 68T07; I.2.7**

- **链接: [http://arxiv.org/pdf/2505.22323v2](http://arxiv.org/pdf/2505.22323v2)**

> **作者:** Hongcan Guo; Haolang Lu; Guoshun Nan; Bolun Chu; Jialin Zhuang; Yuan Yang; Wenhao Che; Sicong Leng; Qimei Cui; Xudong Jiang
>
> **备注:** 33pages, 6figures(Accepted by Neurips 2026 Oral)
>
...
>
---
#### [replaced 016] DyePack: Provably Flagging Test Set Contamination in LLMs Using Backdoors
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23001v5](http://arxiv.org/pdf/2505.23001v5)**
...
>
---
#### [replaced 019] A GEN AI Framework for Medical Note Generation
...
>
---
#### [replaced 020] Patterns in the Transition From Founder-Leadership to Community Governance of Open Source
...
>
---
#### [replaced 021] DISCO Balances the Scales: Adaptive Domain- and Difficulty-Aware Reinforcement Learning on Imbalanced Data
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.15074v3](http://arxiv.org/pdf/2505.15074v3)**
...
>
---
#### [replaced 022] OmniSpatial: Towards Comprehensive Spatial Reasoning Benchmark for Vision Language Models
...
>
---
#### [replaced 023] CogAtom: From Cognitive Atoms to Olympiad-level Mathematical Reasoning in Large Language Models
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.17318v2](http://arxiv.org/pdf/2509.17318v2)**
...
>
---
#### [replaced 024] Interdisciplinary Research in Conversation: A Case Study in Computational Morphology for Language Documentation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.10644v2](http://arxiv.org/pdf/2509.10644v2)**
...
>
---
#### [replaced 025] Evading Toxicity Detection with ASCII-art: A Benchmark of Spatial Attacks on Moderation Systems
- **分类: cs.CL; cs.AI; cs.CR**

- **链接: [http://arxiv.org/pdf/2409.18708v5](http://arxiv.org/pdf/2409.18708v5)**
...
>
---
#### [replaced 026] Safe-SAIL: Towards a Fine-grained Safety Landscape of Large Language Models via Sparse Autoencoder Interpretation Framework
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.18127v2](http://arxiv.org/pdf/2509.18127v2)**
...
>
---
#### [replaced 027] BAP v2: An Enhanced Task Framework for Instruction Following in Minecraft Dialogues
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2501.10836v3](http://arxiv.org/pdf/2501.10836v3)**
...
>
---
#### [replaced 029] SAFE: Improving LLM Systems using Sentence-Level In-generation Attribution
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2505.12621v2](http://arxiv.org/pdf/2505.12621v2)**

> **作者:** João Eduardo Batista; Emil Vatai; Mohamed Wahib
>
> **备注:** 30 pages (9 pages of content, 5 pages of references, 16 pages of supplementary material), 7 figures, 13 tables
>
...
>
---
#### [replaced 030] Large Language Models for Multilingual Previously Fact-Checked Claim Detection
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.02737v3](http://arxiv.org/pdf/2503.02737v3)**
...
>
> **摘要:** In our era of widespread false information, human fact-checkers often face the challenge of duplicating efforts when verifying claims that may have already been addressed in other countries or languages. As false information transcends linguistic boundaries, the ability to automatically detect previously fact-checked claims across languages has become an increasingly important task. This paper presents the first comprehensive evaluation of large language models (LLMs) for multilingual previously fact-checked claim detection. We assess seven LLMs across 20 languages in both monolingual and cross-lingual settings. Our results show that while LLMs perform well for high-resource languages, they struggle with low-resource languages. Moreover, translating original texts into English proved to be beneficial for low-resource languages. These findings highlight the potential of LLMs for multilingual previously fact-checked claim detection and provide a foundation for further research on this promising application of LLMs.
>
---
#### [replaced 031] From Query to Logic: Ontology-Driven Multi-Hop Reasoning in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.01424v2](http://arxiv.org/pdf/2508.01424v2)**
...
>
---
#### [replaced 032] Date Fragments: A Hidden Bottleneck of Tokenization for Temporal Reasoning
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.16088v3](http://arxiv.org/pdf/2505.16088v3)**
...
>
---
#### [replaced 033] Scent of Knowledge: Optimizing Search-Enhanced Reasoning with Information Foraging
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2505.09316v2](http://arxiv.org/pdf/2505.09316v2)**
...
>
---
#### [replaced 034] VisualTrap: A Stealthy Backdoor Attack on GUI Agents via Visual Grounding Manipulation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.06899v2](http://arxiv.org/pdf/2507.06899v2)**
...
>
---
#### [replaced 035] Safeguarding Privacy of Retrieval Data against Membership Inference Attacks: Is This Query Too Close to Home?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.22061v2](http://arxiv.org/pdf/2505.22061v2)**

> **作者:** Yujin Choi; Youngjoo Park; Junyoung Byun; Jaewook Lee; Jinseong Park
>
> **备注:** Accepted for EMNLP findings
>
...
>
---
#### [replaced 036] Efficient Fine-Tuning of Large Language Models for Automated Medical Documentation
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2409.09324v3](http://arxiv.org/pdf/2409.09324v3)**
...
>
---
#### [replaced 038] Redemption Score: A Multi-Modal Evaluation Framework for Image Captioning via Distributional, Perceptual, and Linguistic Signal Triangulation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 039] Detecting Token-Level Hallucinations Using Variance Signals: A Reference-Free Approach
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.04137v2](http://arxiv.org/pdf/2507.04137v2)**
...
>
---
#### [replaced 040] Triangulating LLM Progress through Benchmarks, Games, and Cognitive Tests
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.14359v4](http://arxiv.org/pdf/2502.14359v4)**
...
>
---
#### [replaced 041] Expanding the WMT24++ Benchmark with Rumantsch Grischun, Sursilvan, Sutsilvan, Surmiran, Puter, and Vallader
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.03148v2](http://arxiv.org/pdf/2509.03148v2)**
...
>
> **备注:** WMT25 (Open Language Data Initiative Shared Task)
>
...
>
---
#### [replaced 044] The Medium Is Not the Message: Deconfounding Document Embeddings via Linear Concept Erasure
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.01234v3](http://arxiv.org/pdf/2507.01234v3)**
...
>
---
#### [replaced 045] CLOSP: A Unified Semantic Space for SAR, MSI, and Text in Remote Sensing
...
>
---
#### [replaced 048] Robust Training of Neural Networks at Arbitrary Precision and Sparsity
...
>
---
#### [replaced 049] CNS-Obsidian: A Neurosurgical Vision-Language Model Built From Scientific Publications
- **分类: cs.AI; cs.CL; cs.HC**

- **链接: [http://arxiv.org/pdf/2502.19546v4](http://arxiv.org/pdf/2502.19546v4)**
...
>
---
#### [replaced 051] Benchmarking Contextual and Paralinguistic Reasoning in Speech-LLMs: A Case Study with In-the-Wild Data
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.16589v2](http://arxiv.org/pdf/2509.16589v2)**
...
>
---
#### [replaced 052] Meeseeks: A Feedback-Driven, Iterative Self-Correction Benchmark evaluating LLMs' Instruction Following Capability
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.21625v5](http://arxiv.org/pdf/2504.21625v5)**
...
>
---
#### [replaced 054] LegalSearchLM: Rethinking Legal Case Retrieval as Legal Elements Generation
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2505.23832v2](http://arxiv.org/pdf/2505.23832v2)**
...
>
---
#### [replaced 055] From Unaligned to Aligned: Scaling Multilingual LLMs with Multi-Way Parallel Corpora
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.14045v3](http://arxiv.org/pdf/2505.14045v3)**
...
>
---
#### [replaced 056] SciRerankBench: Benchmarking Rerankers Towards Scientific Retrieval-Augmented Generated LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.08742v2](http://arxiv.org/pdf/2508.08742v2)**
...
>
---
#### [replaced 057] How Well Can Reasoning Models Identify and Recover from Unhelpful Thoughts?
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.10979v2](http://arxiv.org/pdf/2506.10979v2)**
...
>
---
#### [replaced 058] Unifying Text Semantics and Graph Structures for Temporal Text-attributed Graphs with Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.14411v3](http://arxiv.org/pdf/2503.14411v3)**
...
>
---
#### [replaced 059] Citrus-V: Advancing Medical Foundation Models with Unified Medical Image Grounding for Clinical Reasoning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 060] AAPO: Enhancing the Reasoning Capabilities of LLMs with Advantage Momentum
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.14264v2](http://arxiv.org/pdf/2505.14264v2)**
...
>
---
#### [replaced 061] LASER: Stratified Selective Sampling for Instruction Tuning with Dedicated Scoring Strategy
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.22157v3](http://arxiv.org/pdf/2505.22157v3)**
...
>
---
#### [replaced 062] Macroeconomic Forecasting with Large Language Models
- **分类: econ.EM; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2407.00890v4](http://arxiv.org/pdf/2407.00890v4)**

> **作者:** Andrea Carriero; Davide Pettenuzzo; Shubhranshu Shekhar
>
> **摘要:** This paper presents a comparative analysis evaluating the accuracy of Large Language Models (LLMs) against traditional macro time series forecasting approaches. In recent times, LLMs have surged in popularity for forecasting due to their ability to capture intricate patterns in data and quickly adapt across very different domains. However, their effectiveness in forecasting macroeconomic time series data compared to conventional methods remains an area of interest. To address this, we conduct a rigorous evaluation of LLMs against traditional macro forecasting methods, using as common ground the FRED-MD database. Our findings provide valuable insights into the strengths and limitations of LLMs in forecasting macroeconomic time series, shedding light on their applicability in real-world scenarios
>
---
#### [replaced 063] MAPEX: A Multi-Agent Pipeline for Keyphrase Extraction
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.18813v2](http://arxiv.org/pdf/2509.18813v2)**
...
>
---
#### [replaced 064] Inverse Reinforcement Learning with Dynamic Reward Scaling for LLM Alignment
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.18991v4](http://arxiv.org/pdf/2503.18991v4)**
...
>
---
#### [replaced 068] Soft Tokens, Hard Truths
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.19170v2](http://arxiv.org/pdf/2509.19170v2)**
...
>
---
#### [replaced 069] GraphEQA: Using 3D Semantic Scene Graphs for Real-time Embodied Question Answering
...
>
---
#### [replaced 070] Stepwise Guided Policy Optimization: Coloring your Incorrect Reasoning in GRPO
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.11595v2](http://arxiv.org/pdf/2505.11595v2)**
...
>
---
#### [replaced 073] Charting a Decade of Computational Linguistics in Italy: The CLiC-it Corpus
- **分类: cs.CL; 68T50; I.2.7**

- **链接: [http://arxiv.org/pdf/2509.19033v2](http://arxiv.org/pdf/2509.19033v2)**
...
>
---
#### [replaced 074] Unifying Symbolic Music Arrangement: Track-Aware Reconstruction and Structured Tokenization
...
>
---
#### [replaced 078] When Long Helps Short: How Context Length in Supervised Fine-tuning Affects Behavior of Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.18762v2](http://arxiv.org/pdf/2509.18762v2)**

> **作者:** Yingming Zheng; Hanqi Li; Kai Yu; Lu Chen
>
> **备注:** There are some problems with the institute requirements so we have to withdraw now and submit after all procedures have been done
>
...
>
---
#### [replaced 083] Augmenting Multi-Agent Communication with State Delta Trajectory
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.19209v2](http://arxiv.org/pdf/2506.19209v2)**
