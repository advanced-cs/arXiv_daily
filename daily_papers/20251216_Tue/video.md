...
>
---
#### [new 003] Open-World Deepfake Attribution via Confidence-Aware Asymmetric Learning
- **分类: cs.CV**

- **简介: 该论文面向开放世界深度伪造归因（OW-DFA）任务，解决现有方法因置信度偏差导致伪标签不可靠、且需预设未知伪造类型数量的问题。提出置信感知非对称学习（CAL）框架，含置信感知一致性正则化与非对称置信强化，并引入动态原型剪枝策略自动估计未知类数量。**

- **链接: [https://arxiv.org/pdf/2512.12667v1](https://arxiv.org/pdf/2512.12667v1)**

> **作者:** Haiyang Zheng; Nan Pu; Wenjing Li; Teng Long; Nicu Sebe; Zhun Zhong
>
> **备注:** Accepted by AAAI2026
>
> **摘要:** The proliferation of synthetic facial imagery has intensified the need for robust Open-World DeepFake Attribution (OW-DFA), which aims to attribute both known and unknown forgeries using labeled data for known types and unlabeled data containing a mixture of known and novel types. However, existing OW-DFA methods face two critical limitations: 1) A confidence skew that leads to unreliable pseudo-labels for novel forgeries, resulting in biased training. 2) An unrealistic assumption that the number of unknown forgery types is known *a priori*. To address these challenges, we propose a Confidence-Aware Asymmetric Learning (CAL) framework, which adaptively balances model confidence across known and novel forgery types. CAL mainly consists of two components: Confidence-Aware Consistency Regularization (CCR) and Asymmetric Confidence Reinforcement (ACR). CCR mitigates pseudo-label bias by dynamically scaling sample losses based on normalized confidence, gradually shifting the training focus from high- to low-confidence samples. ACR complements this by separately calibrating confidence for known and novel classes through selective learning on high-confidence samples, guided by their confidence gap. Together, CCR and ACR form a mutually reinforcing loop that significantly improves the model's OW-DFA performance. Moreover, we introduce a Dynamic Prototype Pruning (DPP) strategy that automatically estimates the number of novel forgery types in a coarse-to-fine manner, removing the need for unrealistic prior assumptions and enhancing the scalability of our methods to real-world OW-DFA scenarios. Extensive experiments on the standard OW-DFA benchmark and a newly extended benchmark incorporating advanced manipulations demonstrate that CAL consistently outperforms previous methods, achieving new state-of-the-art performance on both known and novel forgery attribution.
>
---
#### [new 004] Reasoning Within the Mind: Dynamic Multimodal Interleaving in Latent Space
- **分类: cs.CV; cs.CL**

- **简介: 该论文属多模态推理任务，旨在解决现有MLLMs依赖显式分步推理、感知-推理交互不稳定及计算开销大等问题。提出DMLR框架：通过置信度引导的隐空间策略优化与动态视觉特征注入，实现隐式、动态的视觉-文本交织推理。**

- **链接: [https://arxiv.org/pdf/2512.12623v1](https://arxiv.org/pdf/2512.12623v1)**
...
>
---
#### [new 010] Smartphone monitoring of smiling as a behavioral proxy of well-being in everyday life
- **分类: cs.CV**

- **简介: 该论文属行为感知任务，旨在解决主观幸福感测量易受回忆偏差和负担重的难题。作者利用智能手机被动录制视频，通过深度学习量化自然状态下的微笑强度，发现其与幸福感、活动量、光照显著相关，验证了微笑作为客观行为代理的有效性。**

- **链接: [https://arxiv.org/pdf/2512.11905v1](https://arxiv.org/pdf/2512.11905v1)**
...
>
---
#### [new 017] Calibrating Uncertainty for Zero-Shot Adversarial CLIP
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对零样本CLIP模型在对抗攻击下不确定性校准失效（过度自信）的问题，提出一种新型对抗微调方法：将CLIP输出重参数化为Dirichlet分布的浓度参数，联合优化预测准确率与不确定性对齐，从而在保持零样本性能的同时提升鲁棒性与可靠性。**

- **链接: [https://arxiv.org/pdf/2512.12997v1](https://arxiv.org/pdf/2512.12997v1)**
...
>
---
#### [new 029] Cognitive-YOLO: LLM-Driven Architecture Synthesis from First Principles of Data for Object Detection
- **分类: cs.CV**

- **简介: 该论文属AI模型设计任务，旨在解决手工设计与NAS方法效率低、成本高的问题。提出Cognitive-YOLO框架：基于数据内在特性（如尺度分布、场景密度）分析，由LLM结合RAG推理生成NADL架构描述，并编译为可部署模型，实现高效、高性能检测器自动合成。**

- **链接: [https://arxiv.org/pdf/2512.12281v1](https://arxiv.org/pdf/2512.12281v1)**
...
>
---
#### [new 030] Content Adaptive based Motion Alignment Framework for Learned Video Compression
- **分类: cs.CV; cs.AI**

- **简介: 该论文属神经视频压缩任务，旨在解决通用端到端框架缺乏内容自适应导致压缩性能欠佳的问题。提出内容自适应运动对齐框架（CAMA），含三部分：两阶段光流引导形变扭曲、多参考质量感知失真加权、训练无关的运动驱动帧下采样。**

- **链接: [https://arxiv.org/pdf/2512.12936v1](https://arxiv.org/pdf/2512.12936v1)**
...
>
---
#### [new 038] Lighting in Motion: Spatiotemporal HDR Lighting Estimation
- **分类: cs.CV**

- **简介: 该论文提出LiMo方法，解决动态场景中高精度、高分辨率HDR光照估计任务。它利用扩散模型，结合多曝光镜面/漫反射球渲染、新几何位置条件及可微渲染，实现时空一致的光照重建，在空间控制与精度上达SOTA。**

- **链接: [https://arxiv.org/pdf/2512.13597v1](https://arxiv.org/pdf/2512.13597v1)**
...
>
---
#### [new 039] ADHint: Adaptive Hints with Difficulty Priors for Reinforcement Learning
- **分类: cs.CV; cs.LG**

- **简介: 该论文属强化学习（RL）中提示增强推理任务，旨在解决现有提示引导RL方法忽略难度导致训练不稳定、过度模仿的问题。提出ADHint框架：基于样本难度自适应调度提示比例、一致性梯度调制保留提示、结合 rollout 难度后验估计优势值，提升推理与泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.13095v1](https://arxiv.org/pdf/2512.13095v1)**
...
>
---
#### [new 040] Pseudo-Label Refinement for Robust Wheat Head Segmentation via Two-Stage Hybrid Training
- **分类: cs.CV**

- **简介: 该论文面向小麦穗图像语义分割任务，旨在提升模型在标注数据有限下的鲁棒性。提出两阶段混合自训练框架：以SegFormer（MiT-B4）为基干，结合伪标签迭代优化与强数据增强，通过师生循环逐步提升精度并充分利用数据。**

- **链接: [https://arxiv.org/pdf/2512.11874v1](https://arxiv.org/pdf/2512.11874v1)**
...
>
---
#### [new 041] A Hybrid Deep Learning Framework for Emotion Recognition in Children with Autism During NAO Robot-Mediated Interaction
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 042] LitePT: Lighter Yet Stronger Point Transformer
- **分类: cs.CV**

- **简介: 该论文面向3D点云理解任务，旨在解决现有模型计算冗余与空间信息丢失问题。提出LitePT：早期用轻量卷积提取几何特征，后期用注意力捕获语义；引入无训练的PointROPE位置编码。模型更小、更快、更省内存，性能媲美或超越SOTA。**

- **链接: [https://arxiv.org/pdf/2512.13689v1](https://arxiv.org/pdf/2512.13689v1)**
...
>
---
#### [new 047] GenieDrive: Towards Physics-Aware Driving World Model with 4D Occupancy Guided Video Generation
- **分类: cs.CV**

- **简介: 该论文提出GenieDrive，解决驾驶视频生成中物理不一致问题。任务是物理感知的驾驶世界建模。工作包括：1）生成4D占用作为物理基础；2）设计轻量VAE编码为三平面；3）引入MCA建模控制影响；4）用多视图注意力引导视频生成，提升可控性、一致性与物理合理性。**

- **链接: [https://arxiv.org/pdf/2512.12751v1](https://arxiv.org/pdf/2512.12751v1)**
...
>
---
#### [new 048] Vision-Enhanced Large Language Models for High-Resolution Image Synthesis and Multimodal Data Interpretation
- **分类: cs.CV**

- **简介: 该论文提出一种视觉增强大语言模型框架，解决高分辨率图像合成与多模态数据理解难题。通过引入校正流机制、双向令牌化策略及噪声感知学习算法，提升生成质量与效率，在图像清晰度和计算开销上显著优于扩散模型。**

- **链接: [https://arxiv.org/pdf/2512.12595v1](https://arxiv.org/pdf/2512.12595v1)**
...
>
---
#### [new 051] SPDMark: Selective Parameter Displacement for Robust Video Watermarking
- **分类: cs.CV; cs.CR; cs.LG**

- **简介: 该论文提出SPDMark，一种面向视频扩散模型的生成式水印方法，旨在解决现有视频水印在不可感知性、鲁棒性与效率上难以兼顾的问题。通过LoRA实现密钥驱动的层参数选择性位移，并联合训练水印嵌入与提取模块，支持帧级定位与抗时序篡改。**

- **链接: [https://arxiv.org/pdf/2512.12090v1](https://arxiv.org/pdf/2512.12090v1)**
...
>
---
#### [new 052] ShowTable: Unlocking Creative Table Visualization with Collaborative Reflection and Refinement
- **分类: cs.CV**

- **简介: 该论文提出“创意表格可视化”新任务，旨在生成既忠实又美观的表格信息图。为解决现有模型在数据-视觉映射、推理与规划上的不足，作者设计ShowTable流水线，融合MLLM（推理与纠错）与扩散模型（高保真生成），并构建训练数据与TableVisBench基准（800实例、5维度）。**

- **链接: [https://arxiv.org/pdf/2512.13303v1](https://arxiv.org/pdf/2512.13303v1)**

> **作者:** Zhihang Liu; Xiaoyi Bao; Pandeng Li; Junjie Zhou; Zhaohe Liao; Yefei He; Kaixun Jiang; Chen-Wei Xie; Yun Zheng; Hongtao Xie
>
> **备注:** project page: https://lntzm.github.io/showtable-page/
>
...
>
---
#### [new 053] Recurrent Video Masked Autoencoders
- **分类: cs.CV**

- **简介: 该论文提出RVM模型，属视频表征学习任务，旨在高效建模时空结构。它用循环Transformer聚合帧特征，通过掩码像素重建学习，无需知识蒸馏即在动作识别、目标跟踪等任务上达SOTA，兼具图像级几何理解能力，并支持长时序线性计算。**

- **链接: [https://arxiv.org/pdf/2512.13684v1](https://arxiv.org/pdf/2512.13684v1)**

> **作者:** Daniel Zoran; Nikhil Parthasarathy; Yi Yang; Drew A Hudson; Joao Carreira; Andrew Zisserman
>
> **摘要:** We present Recurrent Video Masked-Autoencoders (RVM): a novel video representation learning approach that uses a transformer-based recurrent neural network to aggregate dense image features over time, effectively capturing the spatio-temporal structure of natural video data. RVM learns via an asymmetric masked prediction task requiring only a standard pixel reconstruction objective. This design yields a highly efficient ``generalist'' encoder: RVM achieves competitive performance with state-of-the-art video models (e.g. VideoMAE, V-JEPA) on video-level tasks like action recognition and point/object tracking, while also performing favorably against image models (e.g. DINOv2) on tasks that test geometric and dense spatial understanding. Notably, RVM achieves strong performance in the small-model regime without requiring knowledge distillation, exhibiting up to 30x greater parameter efficiency than competing video masked autoencoders. Moreover, we demonstrate that RVM's recurrent nature allows for stable feature propagation over long temporal horizons with linear computational cost, overcoming some of the limitations of standard spatio-temporal attention-based architectures. Finally, we use qualitative visualizations to highlight that RVM learns rich representations of scene semantics, structure, and motion.
>
---
#### [new 054] POLAR: A Portrait OLAT Dataset and Generative Framework for Illumination-Aware Face Modeling
- **分类: cs.CV**

- **简介: 该论文面向人脸重打光任务，解决光照数据稀缺与物理不一致问题。提出POLAR——大规模物理校准OLAT数据集，并构建POLARNet流式生成模型，实现单图驱动、方向感知、身份保持的可控重打光，形成数据与模型互促的闭环框架。**

- **链接: [https://arxiv.org/pdf/2512.13192v1](https://arxiv.org/pdf/2512.13192v1)**
...
>
---
#### [new 055] Contextual Peano Scan and Fast Image Segmentation Using Hidden and Evidential Markov Chains
- **分类: cs.CV; math.ST; stat.AP**

- **简介: 该论文属图像分割任务，旨在提升无监督分割精度与效率。提出融合上下文Peano扫描（CPS）与证据隐马尔可夫链（HEMC）的新模型HEMC-CPS，结合SEM参数估计与MPM推断，实现快速准确分割，并拓展至多维/多源空间数据。**

- **链接: [https://arxiv.org/pdf/2512.11939v1](https://arxiv.org/pdf/2512.11939v1)**
...
>
---
#### [new 060] D3D-VLP: Dynamic 3D Vision-Language-Planning Model for Embodied Grounding and Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 061] I-Scene: 3D Instance Models are Implicit Generalizable Spatial Learners
- **分类: cs.CV**

- **简介: 该论文提出I-Scene，将预训练3D实例生成器重编程为场景级空间学习器，解决交互式3D场景生成中泛化能力弱的问题。它摒弃数据集依赖的监督，改用模型中心的空间监督，在视图中心空间中直接学习几何关系（如邻近、支撑、对称），实现对未见布局和新物体组合的泛化。**

- **链接: [https://arxiv.org/pdf/2512.13683v1](https://arxiv.org/pdf/2512.13683v1)**

> **作者:** Lu Ling; Yunhao Ge; Yichen Sheng; Aniket Bera
>
> **摘要:** Generalization remains the central challenge for interactive 3D scene generation. Existing learning-based approaches ground spatial understanding in limited scene dataset, restricting generalization to new layouts. We instead reprogram a pre-trained 3D instance generator to act as a scene level learner, replacing dataset-bounded supervision with model-centric spatial supervision. This reprogramming unlocks the generator transferable spatial knowledge, enabling generalization to unseen layouts and novel object compositions. Remarkably, spatial reasoning still emerges even when the training scenes are randomly composed objects. This demonstrates that the generator's transferable scene prior provides a rich learning signal for inferring proximity, support, and symmetry from purely geometric cues. Replacing widely used canonical space, we instantiate this insight with a view-centric formulation of the scene space, yielding a fully feed-forward, generalizable scene generator that learns spatial relations directly from the instance model. Quantitative and qualitative results show that a 3D instance generator is an implicit spatial learner and reasoner, pointing toward foundation models for interactive 3D scene understanding and generation. Project page: https://luling06.github.io/I-Scene-project/
>
---
#### [new 062] CoRA: A Collaborative Robust Architecture with Hybrid Fusion for Efficient Perception
- **分类: cs.CV**

- **简介: 该论文面向协同感知任务，解决现有中间融合方法在通信不良时因数据错位导致性能骤降的问题。提出CoRA架构：结合特征级融合（保性能）与目标级校正（抗位姿误差），实现低通信量下的高鲁棒性与高精度。**

- **链接: [https://arxiv.org/pdf/2512.13191v1](https://arxiv.org/pdf/2512.13191v1)**
...
>
---
#### [new 063] Forging a Dynamic Memory: Retrieval-Guided Continual Learning for Generalist Medical Foundation Models
- **分类: cs.CV**

- **简介: 该论文面向医学多模态持续学习任务，解决模型在跨模态域迁移中难以兼顾细粒度特征保留与域间对齐的难题。提出检索增强的动态知识蒸馏框架，结合自建1800万样本医学检索库与新构建的MGTIL基准，实现SOTA性能。**

- **链接: [https://arxiv.org/pdf/2512.13072v1](https://arxiv.org/pdf/2512.13072v1)**

> **作者:** Zizhi Chen; Yizhen Gao; Minghao Han; Yizhou Liu; Zhaoyu Chen; Dingkang Yang; Lihua Zhang
>
> **摘要:** Multimodal biomedical Vision-Language Models (VLMs) exhibit immense potential in the field of Continual Learning (CL). However, they confront a core dilemma: how to preserve fine-grained intra-modality features while bridging the significant domain gap across different modalities. To address this challenge, we propose a comprehensive framework. Leveraging our 18-million multimodal and comprehensive medical retrieval database derived from PubMed scientific papers, we pioneer the integration of Retrieval-Augmented Generation (RAG) into CL. Specifically, we employ a multi-modal, multi-layer RAG system that provides real-time guidance for model fine-tuning through dynamic, on-demand knowledge retrieval. Building upon this, we introduce a dynamic knowledge distillation framework. This framework precisely resolves the aforementioned core dilemma by dynamically modulating the importance of the parameter space, the granularity of the distilled knowledge, and the data distribution of the reference dataset in accordance with the required level of detail. To thoroughly validate the clinical value of our strategy, we have designed a more rigorous \textbf{M}edical Generalist Task Incremental Learning (MGTIL) benchmark. This benchmark is engineered to simultaneously evaluate the model's capacity for adaptation to significant domain shifts, retention of subtle intra-domain features, and real-time learning of novel and complex medical tasks. Extensive experimental results demonstrate that our proposed method achieves state-of-the-art (SOTA) performance across all metrics. The code is provided in the supplementary materials.
>
---
#### [new 064] Towards Interactive Intelligence for Digital Humans
- **分类: cs.CV; cs.CL; cs.GR; cs.HC**

- **简介: 该论文提出“交互智能”新范式，旨在解决数字人缺乏个性表达、自适应交互与自我进化能力的问题。作者构建端到端框架Mio，含五大模块，实现认知推理与多模态具身的实时融合，并建立新基准评估体系。**

- **链接: [https://arxiv.org/pdf/2512.13674v1](https://arxiv.org/pdf/2512.13674v1)**
...
>
---
#### [new 068] AgentIAD: Tool-Augmented Single-Agent for Industrial Anomaly Detection
- **分类: cs.CV**

- **简介: 该论文面向工业异常检测（IAD）任务，解决小缺陷漏检与缺乏正常样本参照的问题。提出AgentIAD单智能体框架，集成Perceptive Zoomer和Comparative Retriever工具，通过多阶段视觉检查、强化学习训练，实现高精度（97.62%）且可解释的异常识别。**

- **链接: [https://arxiv.org/pdf/2512.13671v1](https://arxiv.org/pdf/2512.13671v1)**

> **作者:** Junwen Miao; Penghui Du; Yi Liu; Yu Wang; Yan Wang
>
> **摘要:** Industrial anomaly detection (IAD) is difficult due to the scarcity of normal reference samples and the subtle, localized nature of many defects. Single-pass vision-language models (VLMs) often overlook small abnormalities and lack explicit mechanisms to compare against canonical normal patterns. We propose AgentIAD, a tool-driven agentic framework that enables multi-stage visual inspection. The agent is equipped with a Perceptive Zoomer (PZ) for localized fine-grained analysis and a Comparative Retriever (CR) for querying normal exemplars when evidence is ambiguous. To teach these inspection behaviors, we construct structured perceptive and comparative trajectories from the MMAD dataset and train the model in two stages: supervised fine-tuning followed by reinforcement learning. A two-part reward design drives this process: a perception reward that supervises classification accuracy, spatial alignment, and type correctness, and a behavior reward that encourages efficient tool use. Together, these components enable the model to refine its judgment through step-wise observation, zooming, and verification. AgentIAD achieves a new state-of-the-art 97.62% classification accuracy on MMAD, surpassing prior MLLM-based approaches while producing transparent and interpretable inspection traces.
>
---
#### [new 069] VLCache: Computing 2% Vision Tokens and Reusing 98% for Vision-Language Inference
- **分类: cs.CV**

- **简介: 该论文提出VLCache，属视觉-语言模型推理加速任务，旨在解决重复多模态输入导致的冗余计算问题。通过复用KV缓存与编码器缓存，结合误差分析和动态层感知重计算策略，实现高精度、低token计算（仅2–5%）的高效推理。**

- **链接: [https://arxiv.org/pdf/2512.12977v1](https://arxiv.org/pdf/2512.12977v1)**
...
>
---
#### [new 070] MineTheGap: Automatic Mining of Biases in Text-to-Image Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属AI公平性与可解释性任务，旨在自动发现文本到图像模型中的隐性偏见。提出MineTheGap方法，利用遗传算法优化提示词，并基于新偏差评分机制识别易引发偏见的模糊提示，从而暴露模型在种族、职业等维度的歧视性输出。**

- **链接: [https://arxiv.org/pdf/2512.13427v1](https://arxiv.org/pdf/2512.13427v1)**
...
>
---
#### [new 074] SneakPeek: Future-Guided Instructional Streaming Video Generation
- **分类: cs.CV**

- **简介: 该论文属 instructional video generation 任务，旨在解决长序列多步操作中视频生成的时序不一致与可控性差问题。提出 SneakPeek 框架：融合预测性因果建模、未来引导的自强制推理与多提示条件控制，实现高一致性、可交互的流式教学视频生成。**

- **链接: [https://arxiv.org/pdf/2512.13019v1](https://arxiv.org/pdf/2512.13019v1)**
...
>
> **摘要:** Instructional video generation is an emerging task that aims to synthesize coherent demonstrations of procedural activities from textual descriptions. Such capability has broad implications for content creation, education, and human-AI interaction, yet existing video diffusion models struggle to maintain temporal consistency and controllability across long sequences of multiple action steps. We introduce a pipeline for future-driven streaming instructional video generation, dubbed SneakPeek, a diffusion-based autoregressive framework designed to generate precise, stepwise instructional videos conditioned on an initial image and structured textual prompts. Our approach introduces three key innovations to enhance consistency and controllability: (1) predictive causal adaptation, where a causal model learns to perform next-frame prediction and anticipate future keyframes; (2) future-guided self-forcing with a dual-region KV caching scheme to address the exposure bias issue at inference time; (3) multi-prompt conditioning, which provides fine-grained and procedural control over multi-step instructions. Together, these components mitigate temporal drift, preserve motion consistency, and enable interactive video generation where future prompt updates dynamically influence ongoing streaming video generation. Experimental results demonstrate that our method produces temporally coherent and semantically faithful instructional videos that accurately follow complex, multi-step task descriptions.
>
---
#### [new 075] Unified Interactive Multimodal Moment Retrieval via Cascaded Embedding-Reranking and Temporal-Aware Score Fusion
- **分类: cs.CV; cs.AI; cs.IR**

- **简介: 该论文面向多模态视频时刻检索任务，解决跨模态噪声、时序建模不连贯及手动模态选择三大问题。提出统一框架：级联嵌入-重排序、时序感知打分（指数衰减+束搜索）、Agent引导的查询分解与自适应融合。**

- **链接: [https://arxiv.org/pdf/2512.12935v1](https://arxiv.org/pdf/2512.12935v1)**
...
>
---
#### [new 077] Feature Aggregation for Efficient Continual Learning of Complex Facial Expressions
- **分类: cs.CV**

- **简介: 该论文面向持续学习下的面部表情识别（FER）任务，旨在解决模型在学习新表情（如复合表情）时遗忘旧知识（如基本表情）的灾难性遗忘问题。提出融合卷积特征与动作单元（AUs）的轻量级贝叶斯高斯混合模型（BGMM），无需重训练即可高效适应新表达。**

- **链接: [https://arxiv.org/pdf/2512.12277v1](https://arxiv.org/pdf/2512.12277v1)**
...
>
---
#### [new 078] RecTok: Reconstruction Distillation along Rectified Flow
- **分类: cs.CV**

- **简介: 该论文属视觉生成任务，旨在解决高维视觉tokenizer因语义贫乏导致生成质量下降的问题。提出RecTok方法，通过流语义蒸馏与重建对齐蒸馏，将视觉基础模型语义注入流匹配的前向轨迹，提升高维潜在空间的语义丰富性与重建/生成性能。**

- **链接: [https://arxiv.org/pdf/2512.13421v1](https://arxiv.org/pdf/2512.13421v1)**
...
>
---
#### [new 079] A Graph Attention Network-Based Framework for Reconstructing Missing LiDAR Beams
- **分类: cs.CV; cs.AI**

- **简介: 该论文属点云修复任务，旨在解决LiDAR垂直波束因硬件老化或环境干扰导致的整列丢失问题。提出基于图注意力网络（GAT）的单帧重建框架，将点云建模为保持波束序的邻域图，直接回归缺失点的z坐标，仅依赖原始几何信息，无需图像或时序数据。**

- **链接: [https://arxiv.org/pdf/2512.12410v1](https://arxiv.org/pdf/2512.12410v1)**
...
>
---
#### [new 080] UAGLNet: Uncertainty-Aggregated Global-Local Fusion Network with Cooperative CNN-Transformer for Building Extraction
- **分类: cs.CV**

- **简介: 该论文面向遥感图像建筑提取任务，解决现有方法因特征金字塔鸿沟与全局-局部融合不足导致的提取不准、模糊问题。提出UAGLNet：含CNN-Transformer协同编码器、中间交互块、全局-局部融合模块及不确定性聚合解码器，显式建模像素级不确定性以提升精度。**

- **链接: [https://arxiv.org/pdf/2512.12941v1](https://arxiv.org/pdf/2512.12941v1)**

> **作者:** Siyuan Yao; Dongxiu Liu; Taotao Li; Shengjie Li; Wenqi Ren; Xiaochun Cao
>
> **备注:** IEEE TGRS
>
> **摘要:** Building extraction from remote sensing images is a challenging task due to the complex structure variations of the buildings. Existing methods employ convolutional or self-attention blocks to capture the multi-scale features in the segmentation models, while the inherent gap of the feature pyramids and insufficient global-local feature integration leads to inaccurate, ambiguous extraction results. To address this issue, in this paper, we present an Uncertainty-Aggregated Global-Local Fusion Network (UAGLNet), which is capable to exploit high-quality global-local visual semantics under the guidance of uncertainty modeling. Specifically, we propose a novel cooperative encoder, which adopts hybrid CNN and transformer layers at different stages to capture the local and global visual semantics, respectively. An intermediate cooperative interaction block (CIB) is designed to narrow the gap between the local and global features when the network becomes deeper. Afterwards, we propose a Global-Local Fusion (GLF) module to complementarily fuse the global and local representations. Moreover, to mitigate the segmentation ambiguity in uncertain regions, we propose an Uncertainty-Aggregated Decoder (UAD) to explicitly estimate the pixel-wise uncertainty to enhance the segmentation accuracy. Extensive experiments demonstrate that our method achieves superior performance to other state-of-the-art methods. Our code is available at https://github.com/Dstate/UAGLNet
>
---
#### [new 081] CausalCLIP: Causally-Informed Feature Disentanglement and Filtering for Generalizable Detection of Generated Images
- **分类: cs.CV**

- **简介: 该论文面向生成图像检测任务，解决现有方法因特征纠缠导致跨模型泛化能力差的问题。提出CausalCLIP框架，基于因果推断建模生成过程，通过Gumbel-Softmax掩码与HSIC约束实现因果/非因果特征解耦与过滤，显著提升对未知生成模型的检测泛化性。**

- **链接: [https://arxiv.org/pdf/2512.13285v1](https://arxiv.org/pdf/2512.13285v1)**
...
>
---
#### [new 082] mmWEAVER: Environment-Specific mmWave Signal Synthesis from a Photo and Activity Description
- **分类: cs.CV; cs.LG**

- **简介: 该论文属信号合成任务，旨在解决mmWave雷达数据稀缺、仿真昂贵问题。提出mmWEAVER框架，用隐式神经表示（INR）建模环境特定的复数mmWave信号，结合RGB-D图像与文本描述驱动的超网络实现高效、高保真合成，在 realism、下游任务性能和速度上均显著提升。**

- **链接: [https://arxiv.org/pdf/2512.11894v1](https://arxiv.org/pdf/2512.11894v1)**
...
>
---
#### [new 084] Explainable Adversarial-Robust Vision-Language-Action Model for Robotic Manipulation
...
>
---
#### [new 085] Automated User Identification from Facial Thermograms with Siamese Networks
- **分类: cs.CV; cs.CR**

- **简介: 该论文属生物特征识别任务，旨在解决基于热成像的非接触式用户身份识别问题。工作包括：分析红外波段适用性、提出热相机性能要求、设计Siamese网络模型，并在自建数据集上验证达80%准确率；还探讨了可见光-红外融合方案。**

- **链接: [https://arxiv.org/pdf/2512.13361v1](https://arxiv.org/pdf/2512.13361v1)**
...
>
> **摘要:** The article analyzes the use of thermal imaging technologies for biometric identification based on facial thermograms. It presents a comparative analysis of infrared spectral ranges (NIR, SWIR, MWIR, and LWIR). The paper also defines key requirements for thermal cameras used in biometric systems, including sensor resolution, thermal sensitivity, and a frame rate of at least 30 Hz. Siamese neural networks are proposed as an effective approach for automating the identification process. In experiments conducted on a proprietary dataset, the proposed method achieved an accuracy of approximately 80%. The study also examines the potential of hybrid systems that combine visible and infrared spectra to overcome the limitations of individual modalities. The results indicate that thermal imaging is a promising technology for developing reliable security systems.
>
---
#### [new 086] Harmonizing Generalization and Specialization: Uncertainty-Informed Collaborative Learning for Semi-supervised Medical Image Segmentation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文面向半监督医学图像分割任务，旨在解决基础模型在小样本/罕见病灶下泛化与专业化失衡问题。提出不确定性感知的协同学习框架UnCoL，融合冻结基础模型（提供通用知识）与自适应教师模型（捕获任务特异性），并用预测不确定性动态调控伪标签学习。**

- **链接: [https://arxiv.org/pdf/2512.13101v1](https://arxiv.org/pdf/2512.13101v1)**

> **作者:** Wenjing Lu; Yi Hong; Yang Yang
>
> **备注:** This work has been submitted to the IEEE TMI for possible publication
>
> **摘要:** Vision foundation models have demonstrated strong generalization in medical image segmentation by leveraging large-scale, heterogeneous pretraining. However, they often struggle to generalize to specialized clinical tasks under limited annotations or rare pathological variations, due to a mismatch between general priors and task-specific requirements. To address this, we propose Uncertainty-informed Collaborative Learning (UnCoL), a dual-teacher framework that harmonizes generalization and specialization in semi-supervised medical image segmentation. Specifically, UnCoL distills both visual and semantic representations from a frozen foundation model to transfer general knowledge, while concurrently maintaining a progressively adapting teacher to capture fine-grained and task-specific representations. To balance guidance from both teachers, pseudo-label learning in UnCoL is adaptively regulated by predictive uncertainty, which selectively suppresses unreliable supervision and stabilizes learning in ambiguous regions. Experiments on diverse 2D and 3D segmentation benchmarks show that UnCoL consistently outperforms state-of-the-art semi-supervised methods and foundation model baselines. Moreover, our model delivers near fully supervised performance with markedly reduced annotation requirements.
>
---
#### [new 087] STARCaster: Spatio-Temporal AutoRegressive Video Diffusion for Identity- and View-Aware Talking Portraits
- **分类: cs.CV**

- **简介: 该论文提出STARCaster，一种身份与视角感知的时空自回归视频扩散模型，解决语音驱动肖像动画和自由视角说话人合成任务。它通过软身份约束、隐式3D建模、解耦学习和自强制训练，提升运动多样性、身份保真度与视图一致性。**

- **链接: [https://arxiv.org/pdf/2512.13247v1](https://arxiv.org/pdf/2512.13247v1)**

> **作者:** Foivos Paraperas Papantoniou; Stathis Galanakis; Rolandos Alexandros Potamias; Bernhard Kainz; Stefanos Zafeiriou
>
> **备注:** Project page: https://foivospar.github.io/STARCaster/
>
> **摘要:** This paper presents STARCaster, an identity-aware spatio-temporal video diffusion model that addresses both speech-driven portrait animation and free-viewpoint talking portrait synthesis, given an identity embedding or reference image, within a unified framework. Existing 2D speech-to-video diffusion models depend heavily on reference guidance, leading to limited motion diversity. At the same time, 3D-aware animation typically relies on inversion through pre-trained tri-plane generators, which often leads to imperfect reconstructions and identity drift. We rethink reference- and geometry-based paradigms in two ways. First, we deviate from strict reference conditioning at pre-training by introducing softer identity constraints. Second, we address 3D awareness implicitly within the 2D video domain by leveraging the inherent multi-view nature of video data. STARCaster adopts a compositional approach progressing from ID-aware motion modeling, to audio-visual synchronization via lip reading-based supervision, and finally to novel view animation through temporal-to-spatial adaptation. To overcome the scarcity of 4D audio-visual data, we propose a decoupled learning approach in which view consistency and temporal coherence are trained independently. A self-forcing training scheme enables the model to learn from longer temporal contexts than those generated at inference, mitigating the overly static animations common in existing autoregressive approaches. Comprehensive evaluations demonstrate that STARCaster generalizes effectively across tasks and identities, consistently surpassing prior approaches in different benchmarks.
>
---
#### [new 088] FysicsWorld: A Unified Full-Modality Benchmark for Any-to-Any Understanding, Generation, and Reasoning
- **分类: cs.CV**

- **简介: 该论文提出FysicsWorld——首个支持图像、视频、音频、文本任意双向输入输出的全模态统一基准，旨在解决现有评测在模态覆盖、交互方式和跨模态协同上的不足。工作包括构建16任务/3268样本数据集、提出CMCS数据筛选策略，并评估30+模型，揭示其理解、生成与推理短板。**

- **链接: [https://arxiv.org/pdf/2512.12756v1](https://arxiv.org/pdf/2512.12756v1)**
...
>
> **摘要:** Despite rapid progress in multimodal large language models (MLLMs) and emerging omni-modal architectures, current benchmarks remain limited in scope and integration, suffering from incomplete modality coverage, restricted interaction to text-centric outputs, and weak interdependence and complementarity among modalities. To bridge these gaps, we introduce FysicsWorld, the first unified full-modality benchmark that supports bidirectional input-output across image, video, audio, and text, enabling comprehensive any-to-any evaluation across understanding, generation, and reasoning. FysicsWorld encompasses 16 primary tasks and 3,268 curated samples, aggregated from over 40 high-quality sources and covering a rich set of open-domain categories with diverse question types. We also propose the Cross-Modal Complementarity Screening (CMCS) strategy integrated in a systematic data construction framework that produces omni-modal data for spoken interaction and fusion-dependent cross-modal reasoning. Through a comprehensive evaluation of over 30 state-of-the-art baselines, spanning MLLMs, modality-specific models, unified understanding-generation models, and omni-modal language models, FysicsWorld exposes the performance disparities and limitations across models in understanding, generation, and reasoning. Our benchmark establishes a unified foundation and strong baselines for evaluating and advancing next-generation full-modality architectures.
>
---
#### [new 089] Microscopic Vehicle Trajectory Datasets from UAV-collected Video for Heterogeneous, Area-Based Urban Traffic
- **分类: cs.CV**

- **简介: 该论文属交通数据集构建任务，旨在解决传统路边视频在混杂城市交通中因遮挡、视角受限导致轨迹提取困难的问题。作者利用无人机采集六处印度城区微观车辆轨迹数据，含位置、速度、加速度等，30Hz高精度，开源供仿真、安全与行为研究。**

- **链接: [https://arxiv.org/pdf/2512.11898v1](https://arxiv.org/pdf/2512.11898v1)**
...
>
---
#### [new 092] Learning Common and Salient Generative Factors Between Two Image Datasets
- **分类: cs.CV**

- **简介: 该论文提出“对比分析（CA）”任务，旨在从两个图像数据集中分离共享的生成因子（common）与各自特有的生成因子（salient）。它设计了一种适用于GAN和扩散模型的新框架，仅依赖数据集标签（无属性监督），通过定制化损失实现因子解耦，并在多类数据上验证了分离效果与生成质量。**

- **链接: [https://arxiv.org/pdf/2512.12800v1](https://arxiv.org/pdf/2512.12800v1)**
...
>
---
#### [new 096] LeafTrackNet: A Deep Learning Framework for Robust Leaf Tracking in Top-Down Plant Phenotyping
- **分类: cs.CV**

- **简介: 该论文属植物表型分析中的叶级目标跟踪任务，旨在解决复杂作物（如油菜）在真实场景下长期、鲁棒的单叶追踪难题。作者构建了大规模油菜叶跟踪数据集CanolaTrack，并提出LeafTrackNet框架，融合YOLOv10检测与MobileNetV3嵌入，通过记忆关联实现高精度跟踪，性能显著优于现有方法。**

- **链接: [https://arxiv.org/pdf/2512.13130v1](https://arxiv.org/pdf/2512.13130v1)**
...
>
> **摘要:** Accurately learning high-frequency signals is a challenge in computer vision and graphics, as neural networks often struggle with these signals due to spectral bias or optimization difficulties. While current techniques like Fourier encodings have made great strides in improving performance, there remains scope for improvement when presented with high-frequency information. This paper introduces Queried-Convolutions (Qonvolutions), a simple yet powerful modification using the neighborhood properties of convolution. Qonvolution convolves a low-frequency signal with queries (such as coordinates) to enhance the learning of intricate high-frequency signals. We empirically demonstrate that Qonvolutions enhance performance across a variety of high-frequency learning tasks crucial to both the computer vision and graphics communities, including 1D regression, 2D super-resolution, 2D image regression, and novel view synthesis (NVS). In particular, by combining Gaussian splatting with Qonvolutions for NVS, we showcase state-of-the-art performance on real-world complex scenes, even outperforming powerful radiance field models on image quality.
>
---
#### [new 098] A Domain-Adapted Lightweight Ensemble for Resource-Efficient Few-Shot Plant Disease Classification
- **分类: cs.CV**

- **简介: 该论文面向资源受限环境下的植物病害细粒度分类任务，解决小样本、低算力场景中准确率与效率难以兼顾的问题。提出轻量级域自适应集成框架：融合MobileNetV2/V3特征，经注意力增强Bi-LSTM分类，在PlantVillage和田间数据上实现高精度、低计算（40MB/1.12GFLOPs）的少样本诊断。**

- **链接: [https://arxiv.org/pdf/2512.13428v1](https://arxiv.org/pdf/2512.13428v1)**
...
>
---
#### [new 107] From Tokens to Photons: Test-Time Physical Prompting for Vison-Language Models
- **分类: cs.CV**

- **简介: 该论文提出MVP框架，将视觉语言模型（VLM）的测试时自适应（TTA）从数字token层面延伸至物理光子层面，利用ISO、快门速度、光圈等相机参数作为“物理提示”，通过多视角物理采集、源亲和度选择、低熵过滤与硬投票聚合，提升VLM在真实传感器环境中的鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.12571v1](https://arxiv.org/pdf/2512.12571v1)**
...
>
---
#### [new 108] Schrodinger Audio-Visual Editor: Object-Level Audiovisual Removal
...
>
---
#### [new 109] Audio-Visual Camera Pose Estimationn with Passive Scene Sounds and In-the-Wild Video
- **分类: cs.CV**

- **简介: 该论文研究音频-视觉联合的相机相对位姿估计任务，旨在解决视觉方法在运动模糊、遮挡等退化条件下的失效问题。作者提出融合声源方向谱与双耳嵌入的轻量音频-视觉框架，提升真实视频中位姿估计的精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.12165v1](https://arxiv.org/pdf/2512.12165v1)**
...
>
---
#### [new 110] A Semantically Enhanced Generative Foundation Model Improves Pathological Image Synthesis
- **分类: cs.CV; cs.AI**

- **简介: 该论文属病理图像生成任务，旨在解决临床AI因标注数据稀缺、隐私受限导致的训练瓶颈。作者提出CRAFTS模型，首创病理领域文本到图像生成基础模型，通过相关性调控对齐框架抑制语义漂移与形态幻觉，生成30类癌症高质量图像，并支持可控合成与下游任务性能提升。**

- **链接: [https://arxiv.org/pdf/2512.13164v1](https://arxiv.org/pdf/2512.13164v1)**
...
>
---
#### [new 111] GTR-Turbo: Merged Checkpoint is Secretly a Free Teacher for Agentic VLM Training
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向多模态智能体的强化学习训练任务，解决多步RL中稀疏奖励与长程信用分配难题。提出GTR-Turbo方法：通过合并训练过程中的模型检查点，构造无需额外训练或查询的“免费教师”，用于监督微调或软蒸馏，显著提升性能并降低计算开销。**

- **链接: [https://arxiv.org/pdf/2512.13043v1](https://arxiv.org/pdf/2512.13043v1)**
...
>
---
#### [new 112] Unified Control for Inference-Time Guidance of Denoising Diffusion Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文聚焦扩散模型推理时的无训练引导任务，旨在提升生成结果与下游目标的对齐效率。提出统一框架UniCoDe，融合采样法与梯度法优势，在采样中引入局部梯度信号，兼顾奖励对齐与先验保真，提升采样效率与性能权衡。**

- **链接: [https://arxiv.org/pdf/2512.12339v1](https://arxiv.org/pdf/2512.12339v1)**
...
>
---
#### [new 113] Cross-Level Sensor Fusion with Object Lists via Transformer for 3D Object Detection
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 122] IMILIA: interpretable multiple instance learning for inflammation prediction in IBD from H&E whole slide images
- **分类: cs.CV**

- **简介: 该论文提出IMILIA框架，面向IBD病理诊断任务，解决H&E全切片图像中炎症存在性预测及可解释性分析问题。工作包括：构建MIL炎症预测模型，并集成HistoPLUS（免疫细胞检测/分类）与EpiSeg（上皮分割）模块，实现高精度预测（AUC最高0.99）与生物合理归因。**

- **链接: [https://arxiv.org/pdf/2512.13440v1](https://arxiv.org/pdf/2512.13440v1)**
...
>
---
#### [new 132] DynaPURLS: Dynamic Refinement of Part-aware Representations for Skeleton-based Zero-Shot Action Recognition
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向骨架零样本动作识别任务，解决静态语义对齐导致的域偏移与细粒度知识迁移难问题。提出DynaPURLS框架：利用大语言模型生成多粒度文本描述，自适应划分关节点建模局部动态，并在推理时动态精调文本特征，结合置信度感知记忆库提升泛化性。**

- **链接: [https://arxiv.org/pdf/2512.11941v1](https://arxiv.org/pdf/2512.11941v1)**
...
>
---
#### [new 136] MPath: Multimodal Pathology Report Generation from Whole Slide Images
- **分类: cs.CV; cs.LG**

- **简介: 该论文属医学图像到文本生成任务，旨在解决从全切片图像（WSI）自动生成临床病理报告的难题。作者提出MPath框架，用视觉前缀提示机制将CONCH+Titan提取的WSI特征注入冻结的BioBART语言模型，无需端到端多模态预训练，提升生成的准确性与可解释性。**

- **链接: [https://arxiv.org/pdf/2512.11906v1](https://arxiv.org/pdf/2512.11906v1)**
...
>
---
#### [new 140] Soul: Breathe Life into Digital Human for High-fidelity Long-term Multimodal Animation
- **分类: cs.CV**

- **简介: 该论文提出Soul框架，解决高保真、长时程数字人多模态动画生成任务。针对数据稀缺与长期一致性难题，构建百万级标注数据集Soul-1M和评测基准Soul-Bench；基于Wan2.2-5B，融合音频注入、阈值感知码本替换等技术，实现精准唇动同步、表情生动与身份稳定。**

- **链接: [https://arxiv.org/pdf/2512.13495v1](https://arxiv.org/pdf/2512.13495v1)**
...
>
---
#### [new 144] MMDrive: Interactive Scene Understanding Beyond Vision with Multi-representational Fusion
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 152] Beyond the Visible: Disocclusion-Aware Editing via Proxy Dynamic Graphs
- **分类: cs.CV**

- **简介: 该论文面向图像到视频生成任务，解决用户难以控制视频最终帧中新显露（disoccluded）区域内容的问题。提出无需训练的Proxy Dynamic Graph（PDG），分离运动控制与外观合成：用户编辑PDG指定运动，再手动编辑disocclusion区域外观，结合可见性信息在隐空间融合，实现可控、可预测的 articulated 视频生成。**

- **链接: [https://arxiv.org/pdf/2512.13392v1](https://arxiv.org/pdf/2512.13392v1)**
...
>
---
#### [new 153] Ego-EXTRA: video-language Egocentric Dataset for EXpert-TRAinee assistance
- **分类: cs.CV**

- **简介: 该论文提出Ego-EXTRA——首个面向专家-学徒协作的视频-语言自拍数据集，旨在解决现有模型在真实场景中提供专业级实时辅助能力不足的问题。作者构建50小时未脚本化自拍视频及15k+视觉问答对，建立新基准，评估多模态大模型，并开源数据集。**

- **链接: [https://arxiv.org/pdf/2512.13238v1](https://arxiv.org/pdf/2512.13238v1)**
...
>
---
#### [new 155] Few-Step Distillation for Text-to-Image Generation: A Practical Guide
- **分类: cs.CV**

- **简介: 该论文研究文本到图像（T2I）生成中的扩散模型蒸馏任务，旨在解决现有蒸馏方法在开放文本提示下效果不佳的问题。作者系统适配并比较多种蒸馏技术于FLUX.1-lite教师模型，提出统一框架、识别关键障碍，并给出输入缩放、架构与超参等实用指南，开源代码与模型。**

- **链接: [https://arxiv.org/pdf/2512.13006v1](https://arxiv.org/pdf/2512.13006v1)**

> **作者:** Yifan Pu; Yizeng Han; Zhiwei Tang; Jiasheng Tang; Fan Wang; Bohan Zhuang; Gao Huang
>
> **摘要:** Diffusion distillation has dramatically accelerated class-conditional image synthesis, but its applicability to open-ended text-to-image (T2I) generation is still unclear. We present the first systematic study that adapts and compares state-of-the-art distillation techniques on a strong T2I teacher model, FLUX.1-lite. By casting existing methods into a unified framework, we identify the key obstacles that arise when moving from discrete class labels to free-form language prompts. Beyond a thorough methodological analysis, we offer practical guidelines on input scaling, network architecture, and hyperparameters, accompanied by an open-source implementation and pretrained student models. Our findings establish a solid foundation for deploying fast, high-fidelity, and resource-efficient diffusion generators in real-world T2I applications. Code is available on github.com/alibaba-damo-academy/T2I-Distill.
>
---
#### [new 156] MetaTPT: Meta Test-time Prompt Tuning for Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属视觉-语言模型测试时适应任务，旨在解决VLMs（如CLIP）在域偏移下零-shot性能下降问题。提出MetaTPT框架：通过元学习联合优化自监督辅助任务与提示调优，动态学习样本级增强，提升测试时提示的鲁棒性与泛化性。**

- **链接: [https://arxiv.org/pdf/2512.12268v1](https://arxiv.org/pdf/2512.12268v1)**
...
>
---
#### [new 161] LongVie 2: Multimodal Controllable Ultra-Long Video World Model
- **分类: cs.CV**

- **简介: 该论文提出LongVie 2，一种多模态可控超长视频世界模型，旨在解决视频生成中可控性、长时视觉质量与时间一致性三大挑战。通过三阶段训练（多模态引导、退化感知训练、历史上下文引导）及新基准LongVGenBench，实现长达5分钟的高质量连续视频生成。**

- **链接: [https://arxiv.org/pdf/2512.13604v1](https://arxiv.org/pdf/2512.13604v1)**
...
>
> **摘要:** Building video world models upon pretrained video generation systems represents an important yet challenging step toward general spatiotemporal intelligence. A world model should possess three essential properties: controllability, long-term visual quality, and temporal consistency. To this end, we take a progressive approach-first enhancing controllability and then extending toward long-term, high-quality generation. We present LongVie 2, an end-to-end autoregressive framework trained in three stages: (1) Multi-modal guidance, which integrates dense and sparse control signals to provide implicit world-level supervision and improve controllability; (2) Degradation-aware training on the input frame, bridging the gap between training and long-term inference to maintain high visual quality; and (3) History-context guidance, which aligns contextual information across adjacent clips to ensure temporal consistency. We further introduce LongVGenBench, a comprehensive benchmark comprising 100 high-resolution one-minute videos covering diverse real-world and synthetic environments. Extensive experiments demonstrate that LongVie 2 achieves state-of-the-art performance in long-range controllability, temporal coherence, and visual fidelity, and supports continuous video generation lasting up to five minutes, marking a significant step toward unified video world modeling.
>
---
#### [new 162] Feedforward 3D Editing via Text-Steerable Image-to-3D
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Steer3D方法，解决图像生成3D模型后难以用文本编辑的问题。它将ControlNet思想适配到图像到3D任务中，通过两阶段训练（flow-matching + DPO）实现前馈式文本可控3D编辑，在保真度、一致性与速度上均优于现有方法。**

- **链接: [https://arxiv.org/pdf/2512.13678v1](https://arxiv.org/pdf/2512.13678v1)**

> **作者:** Ziqi Ma; Hongqiao Chen; Yisong Yue; Georgia Gkioxari
>
> **备注:** https://glab-caltech.github.io/steer3d/
>
> **摘要:** Recent progress in image-to-3D has opened up immense possibilities for design, AR/VR, and robotics. However, to use AI-generated 3D assets in real applications, a critical requirement is the capability to edit them easily. We present a feedforward method, Steer3D, to add text steerability to image-to-3D models, which enables editing of generated 3D assets with language. Our approach is inspired by ControlNet, which we adapt to image-to-3D generation to enable text steering directly in a forward pass. We build a scalable data engine for automatic data generation, and develop a two-stage training recipe based on flow-matching training and Direct Preference Optimization (DPO). Compared to competing methods, Steer3D more faithfully follows the language instruction and maintains better consistency with the original 3D asset, while being 2.4x to 28.5x faster. Steer3D demonstrates that it is possible to add a new modality (text) to steer the generation of pretrained image-to-3D generative models with 100k data. Project website: https://glab-caltech.github.io/steer3d/
>
---
#### [new 163] KlingAvatar 2.0 Technical Report
- **分类: cs.CV**

- **简介: 该论文属于长时高清虚拟人视频生成任务，旨在解决现有方法在长视频中易出现时序漂移、质量下降和提示跟随弱等问题。提出KlingAvatar 2.0：采用时空级联框架（先生成低分辨率关键帧，再上采样为高分辨连贯子片段），并引入Co-Reasoning Director与Negative Director增强跨模态指令对齐与负向控制。**

- **链接: [https://arxiv.org/pdf/2512.13313v1](https://arxiv.org/pdf/2512.13313v1)**

> **作者:** Kling Team; Jialu Chen; Yikang Ding; Zhixue Fang; Kun Gai; Yuan Gao; Kang He; Jingyun Hua; Boyuan Jiang; Mingming Lao; Xiaohan Li; Hui Liu; Jiwen Liu; Xiaoqiang Liu; Yuan Liu; Shun Lu; Yongsen Mao; Yingchao Shao; Huafeng Shi; Xiaoyu Shi; Peiqin Sun; Songlin Tang; Pengfei Wan; Chao Wang; Xuebo Wang; Haoxian Zhang; Yuanxing Zhang; Yan Zhou
>
> **备注:** 14 pages, 7 figures
>
> **摘要:** Avatar video generation models have achieved remarkable progress in recent years. However, prior work exhibits limited efficiency in generating long-duration high-resolution videos, suffering from temporal drifting, quality degradation, and weak prompt following as video length increases. To address these challenges, we propose KlingAvatar 2.0, a spatio-temporal cascade framework that performs upscaling in both spatial resolution and temporal dimension. The framework first generates low-resolution blueprint video keyframes that capture global semantics and motion, and then refines them into high-resolution, temporally coherent sub-clips using a first-last frame strategy, while retaining smooth temporal transitions in long-form videos. To enhance cross-modal instruction fusion and alignment in extended videos, we introduce a Co-Reasoning Director composed of three modality-specific large language model (LLM) experts. These experts reason about modality priorities and infer underlying user intent, converting inputs into detailed storylines through multi-turn dialogue. A Negative Director further refines negative prompts to improve instruction alignment. Building on these components, we extend the framework to support ID-specific multi-character control. Extensive experiments demonstrate that our model effectively addresses the challenges of efficient, multimodally aligned long-form high-resolution video generation, delivering enhanced visual clarity, realistic lip-teeth rendering with accurate lip synchronization, strong identity preservation, and coherent multimodal instruction following.
>
---
#### [new 164] CoRe3D: Collaborative Reasoning as a Foundation for 3D Intelligence
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出CoRe3D框架，面向3D理解与生成任务，解决现有方法缺乏显式推理机制、语义-空间对齐弱的问题。它构建空间锚定的推理表示，联合语义链式推理与结构化空间推理，实现语言意图到3D内容的可解释、一致、精准映射。**

- **链接: [https://arxiv.org/pdf/2512.12768v1](https://arxiv.org/pdf/2512.12768v1)**
...
>
---
#### [new 165] MindDrive: A Vision-Language-Action Model for Autonomous Driving via Online Reinforcement Learning
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 166] TCLeaf-Net: a transformer-convolution framework with global-local attention for robust in-field lesion-level plant leaf disease detection
- **分类: cs.CV**

- **简介: 该论文属植物叶片病害检测任务，旨在解决田间复杂背景、域偏移和病变样本少导致的鲁棒性差问题。工作包括构建病变级数据集Daylily-Leaf，并提出TCLeaf-Net模型，融合全局-局部注意力与多尺度对齐机制，提升检测精度与泛化性。**

- **链接: [https://arxiv.org/pdf/2512.12357v1](https://arxiv.org/pdf/2512.12357v1)**
...
>
---
#### [new 167] Scaling Up AI-Generated Image Detection via Generator-Aware Prototypes
- **分类: cs.CV**

- **简介: 该论文属AI生成图像检测任务，旨在解决多源生成器下检测器性能先升后降的“Benefit then Conflict”困境。作者提出Generator-Aware Prototype Learning（GAPL）框架：通过学习生成器感知的伪造原型缓解数据异质性，并采用LoRA两阶段训练突破预训练编码器瓶颈，提升泛化性与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.12982v1](https://arxiv.org/pdf/2512.12982v1)**
...
>
---
#### [new 168] StegaVAR: Privacy-Preserving Video Action Recognition via Steganographic Domain Analysis
- **分类: cs.CV**

- **简介: 该论文属视频动作识别（VAR）任务，旨在解决隐私泄露问题。提出StegaVAR框架，首次在隐写域直接进行VAR：将动作视频隐写嵌入普通视频，保持时空特征完整与传输隐蔽性；设计STeP和CroDA模块提升隐写域分析能力。**

- **链接: [https://arxiv.org/pdf/2512.12586v1](https://arxiv.org/pdf/2512.12586v1)**
...
>
---
#### [new 172] Unlocking Generalization in Polyp Segmentation with DINO Self-Attention "keys"
- **分类: cs.CV**

- **简介: 该论文属医学图像分割任务，旨在解决结直肠癌筛查中 polyp 分割模型泛化性差、依赖复杂专用架构的问题。提出利用 DINO 自监督 ViT 的自注意力“key”特征，结合轻量卷积解码器，提升跨中心、少样本场景下的泛化性能，超越 nnU-Net 等 SOTA 方法。**

- **链接: [https://arxiv.org/pdf/2512.13376v1](https://arxiv.org/pdf/2512.13376v1)**
...
>
---
#### [new 173] MRD: Using Physically Based Differentiable Rendering to Probe Vision Models for 3D Scene Understanding
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出MRD方法，利用物理可微渲染生成模型“元像”（物理不同但激活相同），以探测视觉模型对3D场景属性（如形状、材质）的隐式理解。属模型可解释性任务，旨在揭示模型是否及如何编码三维物理信息。**

- **链接: [https://arxiv.org/pdf/2512.12307v1](https://arxiv.org/pdf/2512.12307v1)**
...
>
---
#### [new 176] Heart Disease Prediction using Case Based Reasoning (CBR)
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于医疗诊断预测任务，旨在提升心脏病预测精度。针对传统经验诊断准确率低的问题，研究比较了模糊逻辑、神经网络和CBR三种智能方法，最终选用CBR模型；经数据预处理与划分，CBR在测试集上达97.95%准确率，并分析了性别及烟酒因素的影响。**

- **链接: [https://arxiv.org/pdf/2512.13078v1](https://arxiv.org/pdf/2512.13078v1)**
...
>
---
#### [new 182] DiG: Differential Grounding for Enhancing Fine-Grained Perception in Multimodal Large Language Model
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出DiG（Differential Grounding）方法，旨在提升多模态大语言模型（MLLM）的细粒度视觉感知与空间推理能力。通过设计差异定位代理任务、3D渲染生成可控图像对、结合课程学习优化训练，显著提升模型在RefCOCO等基准上的表现。**

- **链接: [https://arxiv.org/pdf/2512.12633v1](https://arxiv.org/pdf/2512.12633v1)**

> **作者:** Zhou Tao; Shida Wang; Yongxiang Hua; Haoyu Cao; Linli Xu
>
> **摘要:** Multimodal Large Language Models have achieved impressive performance on a variety of vision-language tasks, yet their fine-grained visual perception and precise spatial reasoning remain limited. In this work, we introduce DiG (Differential Grounding), a novel proxy task framework where MLLMs learn fine-grained perception by identifying and localizing all differences between similar image pairs without prior knowledge of their number. To support scalable training, we develop an automated 3D rendering-based data generation pipeline that produces high-quality paired images with fully controllable discrepancies. To address the sparsity of difference signals, we further employ curriculum learning that progressively increases complexity from single to multiple differences, enabling stable optimization. Extensive experiments demonstrate that DiG significantly improves model performance across a variety of visual perception benchmarks and that the learned fine-grained perception skills transfer effectively to standard downstream tasks, including RefCOCO, RefCOCO+, RefCOCOg, and general multimodal perception benchmarks. Our results highlight differential grounding as a scalable and robust approach for advancing fine-grained visual reasoning in MLLMs.
>
---
#### [new 183] Animus3D: Text-driven 3D Animation via Motion Score Distillation
- **分类: cs.CV; cs.GR; cs.LG**

- **简介: 该论文提出Animus3D，解决文本驱动3D动画中运动微弱、抖动及失真问题。通过 Motion Score Distillation（MSD）、LoRA增强视频扩散模型、外观保持噪声估计、时空正则化及运动细化模块，实现高质量、高保真、高分辨率的3D资产文本驱动动画。**

- **链接: [https://arxiv.org/pdf/2512.12534v1](https://arxiv.org/pdf/2512.12534v1)**
...
>
---
#### [new 184] DA-SSL: self-supervised domain adaptor to leverage foundational models in turbt histopathology slides
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出DA-SSL方法，解决病理基础模型（PFM）在TURBT膀胱癌组织切片上因域偏移导致性能下降的问题；不微调PFM，而是通过自监督域适配器对齐特征；用于预测新辅助化疗响应，提升MIL模型在临床难任务中的表现。**

- **链接: [https://arxiv.org/pdf/2512.13600v1](https://arxiv.org/pdf/2512.13600v1)**
...
>
---
#### [new 186] Transform Trained Transformer: Accelerating Naive 4K Video Generation Over 10$\times$
- **分类: cs.CV**

- **简介: 该论文面向4K视频生成任务，解决全注意力Transformer在高分辨率下计算爆炸导致的效率瓶颈。提出T3方法，通过多尺度窗口注意力与分层阻塞设计，在不改预训练模型结构前提下，实现“注意力模式”轻量改造，加速超10倍且提升质量。**

- **链接: [https://arxiv.org/pdf/2512.13492v1](https://arxiv.org/pdf/2512.13492v1)**

> **作者:** Jiangning Zhang; Junwei Zhu; Teng Hu; Yabiao Wang; Donghao Luo; Weijian Cao; Zhenye Gan; Xiaobin Hu; Zhucun Xue; Chengjie Wang
>
> **备注:** Project page: https://zhangzjn.github.io/projects/T3-Video
>
> **摘要:** Native 4K (2160$\times$3840) video generation remains a critical challenge due to the quadratic computational explosion of full-attention as spatiotemporal resolution increases, making it difficult for models to strike a balance between efficiency and quality. This paper proposes a novel Transformer retrofit strategy termed $\textbf{T3}$ ($\textbf{T}$ransform $\textbf{T}$rained $\textbf{T}$ransformer) that, without altering the core architecture of full-attention pretrained models, significantly reduces compute requirements by optimizing their forward logic. Specifically, $\textbf{T3-Video}$ introduces a multi-scale weight-sharing window attention mechanism and, via hierarchical blocking together with an axis-preserving full-attention design, can effect an "attention pattern" transformation of a pretrained model using only modest compute and data. Results on 4K-VBench show that $\textbf{T3-Video}$ substantially outperforms existing approaches: while delivering performance improvements (+4.29$\uparrow$ VQA and +0.08$\uparrow$ VTC), it accelerates native 4K video generation by more than 10$\times$. Project page at https://zhangzjn.github.io/projects/T3-Video
>
---
#### [new 187] TARA: Simple and Efficient Time Aware Retrieval Adaptation of MLLMs for Video Understanding
- **分类: cs.CV; cs.IR**

- **简介: 该论文面向视频-文本检索任务，解决现有模型缺乏时间感知能力的问题。提出TARA方法，无需视频数据即可将多模态大语言模型（MLLMs）高效适配为时间感知的视频-文本嵌入模型，并构建新基准评估时间敏感性，同时提升否定理解与动词/副词理解能力。**

- **链接: [https://arxiv.org/pdf/2512.13511v1](https://arxiv.org/pdf/2512.13511v1)**
...
>
---
#### [new 190] ALERT Open Dataset and Input-Size-Agnostic Vision Transformer for Driver Activity Recognition using IR-UWB
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文面向驾驶员分心行为识别（DAR）任务，解决IR-UWB雷达数据缺乏大规模真实数据集及ViT难以适配非标准输入尺寸两大问题。提出ALERT公开数据集（10,220样本）和输入尺寸无关ViT（ISA-ViT），融合时频域特征，精度提升22.68%。**

- **链接: [https://arxiv.org/pdf/2512.12206v1](https://arxiv.org/pdf/2512.12206v1)**
...
>
---
#### [new 191] Thermal RGB Fusion for Micro-UAV Wildfire Perimeter Tracking with Minimal Comms
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向微小型无人机群在带宽受限下的野火火场边界跟踪任务，解决GPS退化、通信受限与实时性挑战。提出热红外与RGB图像融合方法：热图粗提取高温区域，RGB图增强边缘并抑制误检；采用规则级融合与Douglas-Peucker简化边界；集成惯性反馈与低延迟嵌入式优化。**

- **链接: [https://arxiv.org/pdf/2512.12199v1](https://arxiv.org/pdf/2512.12199v1)**
...
>
---
#### [new 198] From Particles to Fields: Reframing Photon Mapping with Continuous Gaussian Photon Fields
- **分类: cs.CV; cs.GR**

- **简介: 该论文属渲染任务，旨在解决传统 photon mapping 多视角渲染效率低、重复计算的问题。提出高斯光子场（GPF），将离散光子建模为可学习的连续各向异性高斯场，通过多视角监督优化，实现高效、可微、重用的辐射度估计。**

- **链接: [https://arxiv.org/pdf/2512.12459v1](https://arxiv.org/pdf/2512.12459v1)**
...
>
---
#### [new 200] AI-Augmented Pollen Recognition in Optical and Holographic Microscopy for Veterinary Imaging
- **分类: cs.CV; cs.LG**

- **简介: 该论文属多模态医学图像识别任务，旨在解决DIHM图像中因噪声与伪影导致的花粉自动识别性能差问题。作者构建双模态数据集，对比YOLOv8s/MobileNetV3L在光学与DIHM图像上的表现，提出WGAN-SN生成合成DIHM图像进行数据增强，显著提升检测与分类精度。**

- **链接: [https://arxiv.org/pdf/2512.12101v1](https://arxiv.org/pdf/2512.12101v1)**
...
>
---
#### [new 201] Fast 2DGS: Efficient Image Representation with Deep Gaussian Prior
- **分类: cs.CV**

- **简介: 该论文属图像表示任务，旨在解决2D高斯泼溅（2DGS）初始高斯配置效率低、收敛慢的问题。提出Fast-2DGS框架：引入轻量级“深度高斯先验”网络预测空间分布，结合属性回归网络估计高斯属性，实现单次前向+微调的高效高质量重建。**

- **链接: [https://arxiv.org/pdf/2512.12774v1](https://arxiv.org/pdf/2512.12774v1)**
...
>
---
#### [new 202] M4Human: A Large-Scale Multimodal mmWave Radar Benchmark for Human Mesh Reconstruction
- **分类: cs.CV**

- **简介: 该论文面向人体网格重建（HMR）任务，旨在解决视觉方法受遮挡、光照和隐私限制的问题。作者构建了大规模多模态毫米波雷达基准M4Human（661K帧），含高分辨率雷达、RGB、深度及真值3D网格标注，并建立单模态与多模态基准。**

- **链接: [https://arxiv.org/pdf/2512.12378v1](https://arxiv.org/pdf/2512.12378v1)**
...
>
---
#### [new 203] V-REX: Benchmarking Exploratory Visual Reasoning via Chain-of-Questions
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出V-REX基准，面向多步探索式视觉推理任务，解决现有VLMs在开放、复杂视觉推理中缺乏可评估中间推理路径的问题。工作包括构建Chain-of-Questions（CoQ）形式的挑战性基准与评估协议，分别评测模型的“规划”（选问题链）与“执行”（答问题链）能力。**

- **链接: [https://arxiv.org/pdf/2512.11995v1](https://arxiv.org/pdf/2512.11995v1)**
...
>
---
#### [new 207] SLIM-VDB: A Real-Time 3D Probabilistic Semantic Mapping Framework
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 208] Self-Supervised Ultrasound Representation Learning for Renal Anomaly Prediction in Prenatal Imaging
- **分类: eess.IV; cs.CV**

- **简介: 该论文属医学图像分类任务，旨在解决产前超声中肾异常诊断依赖操作者、图像质量差的问题。作者提出超声自监督基础模型USF-MAE，基于969张二维超声图进行二类/多类肾异常分类，并在AUC和F1上显著优于DenseNet-169；结合Score-CAM提升可解释性。**

- **链接: [https://arxiv.org/pdf/2512.13434v1](https://arxiv.org/pdf/2512.13434v1)**
...
>
---
#### [new 211] Reassessing the Role of Supervised Fine-Tuning: An Empirical Study in VLM Reasoning
- **分类: cs.LG; cs.CL; cs.CV**

- **简介: 该论文属VLM推理任务，旨在重评监督微调（SFT）在推理能力提升中的作用。针对“RL优于SFT”的主流观点，作者通过控制变量实验发现：SFT在小模型、小数据、跨模态场景下更有效，且存在RL奖励欺骗问题，主张SFT与RL应互补协作。**

- **链接: [https://arxiv.org/pdf/2512.12690v1](https://arxiv.org/pdf/2512.12690v1)**
...
>
---
#### [new 212] Soft Decision Tree classifier: explainable and extendable PyTorch implementation
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于可解释机器学习任务，旨在解决传统决策树缺乏可微性与表达能力不足的问题。作者基于PyTorch实现了软决策树（SDT）及其带短期记忆的变体（SM-SDT），验证其在模拟与临床数据上的分类性能与可解释性，并开源代码。**

- **链接: [https://arxiv.org/pdf/2512.11833v1](https://arxiv.org/pdf/2512.11833v1)**
...
>
---
#### [new 213] Leveraging Compression to Construct Transferable Bitrate Ladders
- **分类: eess.IV; cs.CV**

- **简介: 该论文属视频编码优化任务，旨在解决传统逐视频构建凸包码率阶梯计算开销大的问题。提出一种基于压缩过程分析与源视频感知特征的ML方法，精准预测VMAF分数，构建可迁移的每镜头码率阶梯，并在多编码设置下验证其性能。**

- **链接: [https://arxiv.org/pdf/2512.12952v1](https://arxiv.org/pdf/2512.12952v1)**
...
>
---
#### [new 215] On-Device Continual Learning for Unsupervised Visual Anomaly Detection in Dynamic Manufacturing
- **分类: cs.LG; cs.CV**

- **简介: 该论文面向动态制造场景下的无监督视觉异常检测（VAD）任务，解决小批量生产中模型需快速更新、边缘设备资源受限及标注数据稀缺三大挑战。提出轻量级端侧持续学习方法，改进PatchCore，引入k-中心增量核心集更新，实现高效在线适应。**

- **链接: [https://arxiv.org/pdf/2512.13497v1](https://arxiv.org/pdf/2512.13497v1)**
...
>
---
#### [new 219] Benchmarking Tesla's Traffic Light and Stop Sign Control: Field Dataset and Behavior Insights
...
>
---
#### [new 220] AutoMV: An Automatic Multi-Agent System for Music Video Generation
...
>
---
#### [new 221] V-Rex: Real-Time Streaming Video LLM Acceleration via Dynamic KV Cache Retrieval
- **分类: eess.IV; cs.AI; cs.AR; cs.CV; cs.MM**

- **简介: 该论文面向流式视频大语言模型（LLM）实时推理任务，解决其KV缓存持续增长导致的内存、计算与能效瓶颈问题。提出软硬协同加速器V-Rex，含无训练动态KV检索算法ReSV和低开销硬件引擎DRE，在边缘设备实现高帧率、高能效、低损推理。**

- **链接: [https://arxiv.org/pdf/2512.12284v1](https://arxiv.org/pdf/2512.12284v1)**
...
>
---
#### [new 222] Image Diffusion Preview with Consistency Solver
- **分类: cs.LG; cs.CV**

- **简介: 该论文属图像生成任务，旨在解决扩散模型预览阶段质量低、与最终结果不一致的问题。提出基于线性多步法的轻量可训练一致性求解器ConsistencySolver，用强化学习优化，实现少步高质量预览，兼顾效率与一致性。**

- **链接: [https://arxiv.org/pdf/2512.13592v1](https://arxiv.org/pdf/2512.13592v1)**
...
>
---
#### [new 229] Semantic search for 100M+ galaxy images using AI-generated captions
- **分类: astro-ph.IM; cs.AI; cs.CV; cs.LG**

- **简介: 该论文提出AION-Search，解决天文图像海量无标签数据难以语义检索的问题。利用VLM生成图像描述，对比对齐多模态天文基础模型，实现1.4亿星系图像的零样本语义搜索，并引入VLM重排序提升罕见现象召回率。**

- **链接: [https://arxiv.org/pdf/2512.11982v1](https://arxiv.org/pdf/2512.11982v1)**
...
>
---
#### [new 231] RoboTracer: Mastering Spatial Trace with Reasoning in Vision-Language Models for Robotics
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 232] VoroLight: Learning Quality Volumetric Voronoi Meshes from General Inputs
- **分类: cs.CG; cs.CV; cs.GR; cs.LG; math.OC**

- **简介: 该论文提出VoroLight，一种基于可微Voronoi网格的3D形状重建方法。任务是生成高质量、水密、拓扑一致的体素Voronoi网格。它解决从图像、点云等多源输入重建鲁棒三维几何的问题，通过三阶段可微框架实现表面初始化、质量优化与体积分割。**

- **链接: [https://arxiv.org/pdf/2512.12984v1](https://arxiv.org/pdf/2512.12984v1)**
...
>
---
#### [new 233] Federated Learning with Feedback Alignment
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属联邦学习任务，旨在解决非IID数据导致的本地模型漂移问题。提出FLFA框架，用全局模型权重作共享反馈矩阵指导本地反向传播，缓解漂移、提升收敛性，无额外通信开销。**

- **链接: [https://arxiv.org/pdf/2512.12762v1](https://arxiv.org/pdf/2512.12762v1)**
...
>
---
#### [new 234] Towards Unified Co-Speech Gesture Generation via Hierarchical Implicit Periodicity Learning
...
>
---
#### [new 235] Tackling Snow-Induced Challenges: Safe Autonomous Lane-Keeping with Robust Reinforcement Learning
...
>
---
#### [new 239] Pre-training vision models for the classification of alerts from wide-field time-domain surveys
- **分类: astro-ph.IM; cs.CV**

- **简介: 该论文属天文图像分类任务，旨在提升时域巡天警报的自动分类性能。针对传统定制CNN效率低、需从头训练的问题，作者尝试用ImageNet和Galaxy Zoo数据预训练标准视觉模型，发现后者效果更优，且推理更快、更省资源。**

- **链接: [https://arxiv.org/pdf/2512.11957v1](https://arxiv.org/pdf/2512.11957v1)**
...
>
---
#### [new 240] Aion: Towards Hierarchical 4D Scene Graphs with Temporal Flow Dynamics
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 241] ReGlove: A Soft Pneumatic Glove for Activities of Daily Living Assistance via Wrist-Mounted Vision
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 242] Quantum Implicit Neural Representations for 3D Scene Reconstruction and Novel View Synthesis
- **分类: quant-ph; cs.AI; cs.CV**

- **简介: 该论文提出Q-NeRF，一种量子-经典混合神经辐射场框架，旨在解决隐式神经表示（INR）中经典网络的谱偏差问题。它用量子隐式表示网络（QIREN）替代Nerfacto中的密度/辐射预测模块，提升高频细节与视图相关外观建模能力，在有限资源下实现有竞争力的3D场景重建与新视角合成。**

- **链接: [https://arxiv.org/pdf/2512.12683v1](https://arxiv.org/pdf/2512.12683v1)**
...
>
---
#### [new 243] On the Design of One-step Diffusion via Shortcutting Flow Paths
- **分类: cs.LG; cs.CV**

- **简介: 该论文聚焦于一步扩散模型设计，旨在解耦理论推导与实现细节以明晰设计空间。提出统一框架，为shortcut模型提供理论支撑并分离组件选择，进而改进模型，在ImageNet-256上以无预训练、蒸馏或课程学习达成FID50k=2.85新SOTA。**

- **链接: [https://arxiv.org/pdf/2512.11831v1](https://arxiv.org/pdf/2512.11831v1)**
...
>
---
#### [new 244] Navigation Around Unknown Space Objects Using Visible-Thermal Image Fusion
- **分类: cs.RO; cs.CV**
...
#### [replaced 001] MusicInfuser: Making Video Diffusion Listen and Dance
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2503.14505v2](https://arxiv.org/pdf/2503.14505v2)**
...
>
---
#### [replaced 005] Coherent Multi-Agent Trajectory Forecasting in Team Sports with CausalTraj
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18248v2](https://arxiv.org/pdf/2511.18248v2)**
...
>
---
#### [replaced 006] Ctrl-Crash: Controllable Diffusion for Realistic Car Crashes
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 007] DPBridge: Latent Diffusion Bridge for Dense Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.20506v4](https://arxiv.org/pdf/2412.20506v4)**
...
>
---
#### [replaced 008] YawDD+: Frame-level Annotations for Accurate Yawn Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11446v2](https://arxiv.org/pdf/2512.11446v2)**
...
>
---
#### [replaced 009] Instance-Adaptive Keypoint Learning with Local-to-Global Geometric Aggregation for Category-Level Object Pose Estimation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.15134v4](https://arxiv.org/pdf/2504.15134v4)**
...
>
---
#### [replaced 010] LocoMamba: Vision-Driven Locomotion via End-to-End Deep Reinforcement Learning with Mamba
...
>
---
#### [replaced 011] Counting Hallucinations in Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.13080v2](https://arxiv.org/pdf/2510.13080v2)**
...
>
---
#### [replaced 012] DEAR: Dataset for Evaluating the Aesthetics of Rendering
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.05209v2](https://arxiv.org/pdf/2512.05209v2)**
...
>
---
#### [replaced 013] Towards Efficient and Effective Multi-Camera Encoding for End-to-End Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.10947v2](https://arxiv.org/pdf/2512.10947v2)**

> **作者:** Jiawei Yang; Ziyu Chen; Yurong You; Yan Wang; Yiming Li; Yuxiao Chen; Boyi Li; Boris Ivanovic; Marco Pavone; Yue Wang
>
> **备注:** Project Page: https://jiawei-yang.github.io/Flex/
>
...
>
---
#### [replaced 016] MSG-Loc: Multi-Label Likelihood-based Semantic Graph Matching for Object-Level Global Localization
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 017] MODEST: Multi-Optics Depth-of-Field Stereo Dataset
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2511.20853v2](https://arxiv.org/pdf/2511.20853v2)**
...
>
---
#### [replaced 018] U-NetMN and SegNetMN: Modified U-Net and SegNet models for bimodal SAR image segmentation
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2506.05444v2](https://arxiv.org/pdf/2506.05444v2)**
...
>
---
#### [replaced 021] A Self-Conditioned Representation Guided Diffusion Model for Realistic Text-to-LiDAR Scene Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.19004v2](https://arxiv.org/pdf/2511.19004v2)**
...
>
---
#### [replaced 026] FACM: Flow-Anchored Consistency Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.03738v2](https://arxiv.org/pdf/2507.03738v2)**
...
>
---
#### [replaced 029] TC-LoRA: Temporally Modulated Conditional LoRA for Adaptive Diffusion Control
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.09561v2](https://arxiv.org/pdf/2510.09561v2)**

> **作者:** Minkyoung Cho; Ruben Ohana; Christian Jacobsen; Adityan Jothi; Min-Hung Chen; Z. Morley Mao; Ethem Can
>
> **备注:** Project Page: https://minkyoungcho.github.io/tc-lora/; NeurIPS 2025 Workshop on SPACE in Vision, Language, and Embodied AI (SpaVLE); 10 pages
>
...
>
---
#### [replaced 034] dots.ocr: Multilingual Document Layout Parsing in a Single Vision-Language Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02498v3](https://arxiv.org/pdf/2512.02498v3)**
...
>
---
#### [replaced 035] VisualCloze: A Universal Image Generation Framework via Visual In-Context Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.07960v3](https://arxiv.org/pdf/2504.07960v3)**

> **作者:** Zhong-Yu Li; Ruoyi Du; Juncheng Yan; Le Zhuo; Qilong Wu; Zhen Li; Peng Gao; Zhanyu Ma; Ming-Ming Cheng
>
...
>
---
#### [replaced 042] An Overall Real-Time Mechanism for Classification and Quality Evaluation of Rice
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2502.13764v4](https://arxiv.org/pdf/2502.13764v4)**

> **作者:** Wanke Xia; Ruoxin Peng; Haoqi Chu; Xinlei Zhu; Zhiyu Yang; Yiting Zhao; Lili Yang
>
> **备注:** Accepted at AAAI 2026 Workshop (AgriAI)
>
...
>
---
#### [replaced 043] Rethinking Long-tailed Dataset Distillation: A Uni-Level Framework with Unbiased Recovery and Relabeling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18858v2](https://arxiv.org/pdf/2511.18858v2)**
...
>
---
#### [replaced 044] GMFVAD: Using Grained Multi-modal Feature to Improve Video Anomaly Detection
- **分类: cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2510.20268v2](https://arxiv.org/pdf/2510.20268v2)**

> **作者:** Guangyu Dai; Dong Chen; Siliang Tang; Yueting Zhuang
>
> **备注:** Accepted for publication in the Proceedings of the ICONIP 2025
>
...
>
---
#### [replaced 045] Color Bind: Exploring Color Perception in Text-to-Image Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.19791v3](https://arxiv.org/pdf/2508.19791v3)**
...
>
---
#### [replaced 046] Towards Physically Executable 3D Gaussian for Embodied Navigation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.21307v2](https://arxiv.org/pdf/2510.21307v2)**
...
>
---
#### [replaced 047] LLaVA-OneVision-1.5: Fully Open Framework for Democratized Multimodal Training
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23661v3](https://arxiv.org/pdf/2509.23661v3)**
...
>
> **备注:** Project page : https://cvlab-kaist.github.io/3DScenePrompt/
>
> **摘要:** We present 3DScenePrompt, a framework that generates the next video chunk from arbitrary-length input while enabling precise camera control and preserving scene consistency. Unlike methods conditioned on a single image or a short clip, we employ dual spatio-temporal conditioning that reformulates context-view referencing across the input video. Our approach conditions on both temporally adjacent frames for motion continuity and spatially adjacent content for scene consistency. However, when generating beyond temporal boundaries, directly using spatially adjacent frames would incorrectly preserve dynamic elements from the past. We address this by introducing a 3D scene memory that represents exclusively the static geometry extracted from the entire input video. To construct this memory, we leverage dynamic SLAM with our newly introduced dynamic masking strategy that explicitly separates static scene geometry from moving elements. The static scene representation can then be projected to any target viewpoint, providing geometrically consistent warped views that serve as strong 3D spatial prompts while allowing dynamic regions to evolve naturally from temporal context. This enables our model to maintain long-range spatial coherence and precise camera control without sacrificing computational efficiency or motion realism. Extensive experiments demonstrate that our framework significantly outperforms existing methods in scene consistency, camera controllability, and generation quality. Project page : https://cvlab-kaist.github.io/3DScenePrompt/
>
---
#### [replaced 050] Learning Group Actions In Disentangled Latent Image Representations
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.04015v2](https://arxiv.org/pdf/2512.04015v2)**
...
>
---
#### [replaced 051] DiffPose-Animal: A Language-Conditioned Diffusion Framework for Animal Pose Estimation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.08783v2](https://arxiv.org/pdf/2508.08783v2)**
...
>
---
#### [replaced 052] CleanDIFT: Diffusion Features without Noise
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.03439v3](https://arxiv.org/pdf/2412.03439v3)**

> **作者:** Nick Stracke; Stefan Andreas Baumann; Kolja Bauer; Frank Fundel; Björn Ommer
>
> **备注:** for the project page and code, view https://compvis.github.io/cleandift/
>
> **摘要:** Internal features from large-scale pre-trained diffusion models have recently been established as powerful semantic descriptors for a wide range of downstream tasks. Works that use these features generally need to add noise to images before passing them through the model to obtain the semantic features, as the models do not offer the most useful features when given images with little to no noise. We show that this noise has a critical impact on the usefulness of these features that cannot be remedied by ensembling with different random noises. We address this issue by introducing a lightweight, unsupervised fine-tuning method that enables diffusion backbones to provide high-quality, noise-free semantic features. We show that these features readily outperform previous diffusion features by a wide margin in a wide variety of extraction setups and downstream tasks, offering better performance than even ensemble-based methods at a fraction of the cost.
>
---
#### [replaced 053] Instance-Level Composed Image Retrieval
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.25387v2](https://arxiv.org/pdf/2510.25387v2)**
...
>
---
#### [replaced 056] PoreTrack3D: A Benchmark for Dynamic 3D Gaussian Splatting in Pore-Scale Facial Trajectory Tracking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02648v2](https://arxiv.org/pdf/2512.02648v2)**
...
>
---
#### [replaced 057] MotionEdit: Benchmarking and Learning Motion-Centric Image Editing
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 论文提出MotionEdit任务：基于视频提取高保真动作变化图像对，解决现有编辑模型难以精准操控主体动作的问题；构建MotionEdit-Bench基准并提出MotionNFT微调方法，显著提升扩散模型的动作编辑精度与保真度。**

- **链接: [https://arxiv.org/pdf/2512.10284v2](https://arxiv.org/pdf/2512.10284v2)**

> **作者:** Yixin Wan; Lei Ke; Wenhao Yu; Kai-Wei Chang; Dong Yu
>
> **备注:** Technical Report. We propose MotionEdit, a dataset and benchmark for motion-centric image editing. We also introduce MotionNFT, a reward training framework to improve existing models with motion-aware guidance. Github: https://github.com/elainew728/motion-edit/
>
...
>
---
#### [replaced 058] KNN-MMD: Cross Domain Wireless Sensing via Local Distribution Alignment
- **分类: cs.CV; cs.AI; eess.SP**

- **链接: [https://arxiv.org/pdf/2412.04783v5](https://arxiv.org/pdf/2412.04783v5)**
...
>
---
#### [replaced 061] Beyond Classification Accuracy: Neural-MedBench and the Need for Deeper Reasoning Benchmarks
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.22258v3](https://arxiv.org/pdf/2509.22258v3)**
...
>
---
#### [replaced 062] HybridSplat: Fast Reflection-baked Gaussian Tracing using Hybrid Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08334v2](https://arxiv.org/pdf/2512.08334v2)**

> **作者:** Chang Liu; Hongliang Yuan; Lianghao Zhang; Sichao Wang; Jianwei Guo; Shi-Sheng Huang
>
> **备注:** Project URL: https://aetheryne.github.io/HybridSplat/
>
...
>
---
#### [replaced 063] Learning to Pose Problems: Reasoning-Driven and Solver-Adaptive Data Synthesis for Large Reasoning Models
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.09907v3](https://arxiv.org/pdf/2511.09907v3)**
...
>
---
#### [replaced 064] Normalize Filters! Classical Wisdom for Deep Vision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.04401v4](https://arxiv.org/pdf/2506.04401v4)**
...
>
---
#### [replaced 065] FastVID: Dynamic Density Pruning for Fast Video Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.11187v3](https://arxiv.org/pdf/2503.11187v3)**
...
>
---
#### [replaced 066] Conditional Representation Learning for Customized Tasks
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.04564v2](https://arxiv.org/pdf/2510.04564v2)**
...
>
---
#### [replaced 069] Equivariant Splitting: Self-supervised learning from incomplete data
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.00929v4](https://arxiv.org/pdf/2510.00929v4)**
...
>
---
#### [replaced 070] CineBrain: A Large-Scale Multi-Modal Brain Dataset During Naturalistic Audiovisual Narrative Processing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.06940v2](https://arxiv.org/pdf/2503.06940v2)**

> **作者:** Jianxiong Gao; Yichang Liu; Baofeng Yang; Jianfeng Feng; Yanwei Fu
>
> **备注:** Project Page: https://jianxgao.github.io/CineBrain
>
> **摘要:** Most research decoding brain signals into images, often using them as priors for generative models, has focused only on visual content. This overlooks the brain's natural ability to integrate auditory and visual information, for instance, sound strongly influences how we perceive visual scenes. To investigate this, we propose a new task of reconstructing continuous video stimuli from multimodal brain signals recorded during audiovisual stimulation. To enable this, we introduce CineBrain, the first large-scale dataset that synchronizes fMRI and EEG during audiovisual viewing, featuring six hours of \textit{The Big Bang Theory} episodes for cross-modal alignment. We also conduct the first systematic exploration of combining fMRI and EEG for video reconstruction and present CineSync, a framework for reconstructing dynamic video using a Multi-Modal Fusion Encoder and a Neural Latent Decoder. CineSync achieves state-of-the-art performance in dynamic reconstruction, leveraging the complementary strengths of fMRI and EEG to improve visual fidelity. Our analysis shows that auditory cortical activations enhance decoding accuracy, highlighting the role of auditory input in visual perception. Project Page: https://jianxgao.github.io/CineBrain.
>
---
#### [replaced 071] LookAhead Tuning: Safer Language Models via Partial Answer Previews
- **分类: cs.CL; cs.AI; cs.CV; cs.LG; cs.MM**

- **简介: 该论文属于大语言模型安全微调任务，旨在解决微调导致安全对齐退化的问题。提出LookAhead Tuning方法，通过在训练数据中引入部分答案前缀预览，轻量级保持模型原始安全机制，兼顾下游性能与安全性。**

- **链接: [https://arxiv.org/pdf/2503.19041v3](https://arxiv.org/pdf/2503.19041v3)**
...
>
---
#### [replaced 072] DualMap: Online Open-Vocabulary Semantic Mapping for Natural Language Navigation in Dynamic Changing Scenes
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 073] ViCO: A Training Strategy towards Semantic Aware Dynamic High-Resolution
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.12793v2](https://arxiv.org/pdf/2510.12793v2)**
...
>
---
#### [replaced 076] CoordAR: One-Reference 6D Pose Estimation of Novel Objects via Autoregressive Coordinate Map Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.12919v3](https://arxiv.org/pdf/2511.12919v3)**
...
>
---
#### [replaced 077] OUGS: Active View Selection via Object-aware Uncertainty Estimation in 3DGS
- **分类: cs.CV; cs.CG; cs.GR; cs.HC**

- **链接: [https://arxiv.org/pdf/2511.09397v2](https://arxiv.org/pdf/2511.09397v2)**
...
>
---
#### [replaced 078] PD-Diag-Net: Clinical-Priors guided Network on Brain MRI for Auxiliary Diagnosis of Parkinson's Disease
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23719v3](https://arxiv.org/pdf/2509.23719v3)**
...
>
> **备注:** WACV25 accepted. https://github.com/NVIDIA-Medtech/NV-Generate-CTMR
>
> **摘要:** Medical imaging analysis faces challenges such as data scarcity, high annotation costs, and privacy concerns. This paper introduces the Medical AI for Synthetic Imaging (MAISI), an innovative approach using the diffusion model to generate synthetic 3D computed tomography (CT) images to address those challenges. MAISI leverages the foundation volume compression network and the latent diffusion model to produce high-resolution CT images (up to a landmark volume dimension of 512 x 512 x 768 ) with flexible volume dimensions and voxel spacing. By incorporating ControlNet, MAISI can process organ segmentation, including 127 anatomical structures, as additional conditions and enables the generation of accurately annotated synthetic images that can be used for various downstream tasks. Our experiment results show that MAISI's capabilities in generating realistic, anatomically accurate images for diverse regions and conditions reveal its promising potential to mitigate challenges using synthetic data.
>
---
#### [replaced 085] Accelerated Rotation-Invariant Convolution for UAV Image Segmentation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 088] CapeNext: Rethinking and Refining Dynamic Support Information for Category-Agnostic Pose Estimation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13102v2](https://arxiv.org/pdf/2511.13102v2)**

> **作者:** Yu Zhu; Dan Zeng; Shuiwang Li; Qijun Zhao; Qiaomu Shen; Bo Tang
>
> **摘要:** Recent research in Category-Agnostic Pose Estimation (CAPE) has adopted fixed textual keypoint description as semantic prior for two-stage pose matching frameworks. While this paradigm enhances robustness and flexibility by disentangling the dependency of support images, our critical analysis reveals two inherent limitations of static joint embedding: (1) polysemy-induced cross-category ambiguity during the matching process(e.g., the concept "leg" exhibiting divergent visual manifestations across humans and furniture), and (2) insufficient discriminability for fine-grained intra-category variations (e.g., posture and fur discrepancies between a sleeping white cat and a standing black cat). To overcome these challenges, we propose a new framework that innovatively integrates hierarchical cross-modal interaction with dual-stream feature refinement, enhancing the joint embedding with both class-level and instance-specific cues from textual description and specific images. Experiments on the MP-100 dataset demonstrate that, regardless of the network backbone, CapeNext consistently outperforms state-of-the-art CAPE methods by a large margin.
>
---
#### [replaced 089] Task-Specific Distance Correlation Matching for Few-Shot Action Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11340v2](https://arxiv.org/pdf/2512.11340v2)**

> **作者:** Fei Long; Yao Zhang; Jiaming Lv; Jiangtao Xie; Peihua Li
>
> **备注:** 9 pages. 4 figures, conference;Accepted by AAAI 2026
>
...
>
---
#### [replaced 092] Virtual Multiplex Staining for Histological Images using a Marker-wise Conditioned Diffusion Model
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.14681v3](https://arxiv.org/pdf/2508.14681v3)**
...
>
---
#### [replaced 098] WholeBodyVLA: Towards Unified Latent VLA for Whole-Body Loco-Manipulation Control
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 099] How PARTs assemble into wholes: Learning the relative composition of images
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.03682v2](https://arxiv.org/pdf/2506.03682v2)**
...
>
---
#### [replaced 102] BlurDM: A Blur Diffusion Model for Image Deblurring
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.03979v2](https://arxiv.org/pdf/2512.03979v2)**

> **作者:** Jin-Ting He; Fu-Jen Tsai; Yan-Tsung Peng; Min-Hung Chen; Chia-Wen Lin; Yen-Yu Lin
>
> **备注:** NeurIPS 2025. Project Page: https://jin-ting-he.github.io/Blur-Diffusion-Model/
>
...
>
---
#### [replaced 105] Unlocking the Potential of Difficulty Prior in RL-based Multimodal Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.13261v2](https://arxiv.org/pdf/2505.13261v2)**
...
>
---
#### [replaced 111] EfficientFlow: Efficient Equivariant Flow Policy Learning for Embodied AI
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**
...
>
---
#### [replaced 112] Deploying Rapid Damage Assessments from sUAS Imagery for Disaster Response
- **分类: cs.CV; cs.AI; cs.CY**

- **链接: [https://arxiv.org/pdf/2511.03132v3](https://arxiv.org/pdf/2511.03132v3)**

> **作者:** Thomas Manzini; Priyankari Perali; Robin R. Murphy
>
> **备注:** 6 pages, 4 figures, 1 table. Appearing in IAAI'26
>
...
>
---
#### [replaced 113] Automatic Calibration of a Multi-Camera System with Limited Overlapping Fields of View for 3D Surgical Scene Reconstruction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2501.16221v3](https://arxiv.org/pdf/2501.16221v3)**
...
>
---
#### [replaced 116] CAST-Phys: Contactless Affective States Through Physiological signals Database
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.06080v2](https://arxiv.org/pdf/2507.06080v2)**
...
>
---
#### [replaced 117] PanDx: AI-assisted Early Detection of Pancreatic Ductal Adenocarcinoma on Contrast-enhanced CT
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.10068v3](https://arxiv.org/pdf/2503.10068v3)**

> **作者:** Han Liu; Riqiang Gao; Eileen Krieg; Sasa Grbic
>
...
>
---
#### [replaced 118] Repulsor: Accelerating Generative Modeling with a Contrastive Memory Bank
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.08648v2](https://arxiv.org/pdf/2512.08648v2)**
...
>
---
#### [replaced 119] RefBench-PRO: Perceptual and Reasoning Oriented Benchmark for Referring Expression Comprehension
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.06276v2](https://arxiv.org/pdf/2512.06276v2)**

> **作者:** Tianyi Gao; Hao Li; Han Fang; Xin Wei; Xiaodong Dong; Hongbo Sun; Ye Yuan; Zhongjiang He; Jinglin Xu; Jingmin Xin; Hao Sun
>
> **摘要:** Referring Expression Comprehension (REC) is a vision-language task that localizes a specific image region based on a textual description. Existing REC benchmarks primarily evaluate perceptual capabilities and lack interpretable scoring mechanisms, which cannot reveal the grounding capability of Multi-modal Large Language Model (MLLM) across different cognitive abilities. To address this limitation, we introduce RefBench-PRO, a comprehensive REC benchmark, which decomposes referring expressions into two core dimensions, i.e., perception and reasoning, and further subdivides them into six progressively challenging tasks, such as attribute, position, interaction, commonsense, relation and reject. We also develop a fully automated data-generation pipeline that produces diverse referring expressions across these six sub-dimensions. Furthermore, We propose Ref-R1, an RL-based learning scheme, which incorporates Dynamic IoU-based GRPO to improve localization accuracy under increasingly complex reasoning conditions, establishing a stronger baseline for REC. Extensive experiments demonstrate that our RefBench-PRO enables interpretable evaluation of MLLM on referring expression comprehension, presenting greater challenges in both perception and reasoning.
>
---
#### [replaced 120] TAPVid-360: Tracking Any Point in 360 from Narrow Field of View Video
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21946v2](https://arxiv.org/pdf/2511.21946v2)**
...
>
---
#### [replaced 121] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.11574v2](https://arxiv.org/pdf/2509.11574v2)**
...
>
---
#### [replaced 122] Camera Calibration via Circular Patterns: A Comprehensive Framework with Detection Uncertainty and Unbiased Projection Model
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 123] IPR-1: Interactive Physical Reasoner
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.15407v2](https://arxiv.org/pdf/2511.15407v2)**

> **作者:** Mingyu Zhang; Lifeng Zhuo; Tianxi Tan; Guocan Xie; Xian Nie; Yan Li; Renjie Zhao; Zizhu He; Ziyu Wang; Jiting Cai; Yong-Lu Li
>
> **备注:** 13 pages of main text and 19 pages of appendices. Project page: https://mybearyzhang.github.io/ipr-1
>
...
>
---
#### [replaced 126] PANDA -- Patch And Distribution-Aware Augmentation for Long-Tailed Exemplar-Free Continual Learning
- **分类: cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2511.09791v3](https://arxiv.org/pdf/2511.09791v3)**
...
>
---
#### [replaced 127] Segmenting Visuals With Querying Words: Language Anchors For Semi-Supervised Image Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2506.13925v3](https://arxiv.org/pdf/2506.13925v3)**
...
>
---
#### [replaced 138] CHIMERA: Adaptive Cache Injection and Semantic Anchor Prompting for Zero-shot Image Morphing with Morphing-oriented Metrics
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.07155v3](https://arxiv.org/pdf/2512.07155v3)**
