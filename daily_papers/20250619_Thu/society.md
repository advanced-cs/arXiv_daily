...
- **简介: 该论文属于人工智能伦理研究，探讨如何应对AI带来的重大挑战。旨在解决AGI爆发前的准备问题，提出当前可采取的措施以应对潜在风险。**
...
- **简介: 该论文属于算法审计任务，研究Uber算法对司机收入和工作分配的影响。通过分析150万次行程数据，发现动态定价后司机收入减少、不稳定性增加，揭示了平台经济中的不平等问题。**
