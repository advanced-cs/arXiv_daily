...
>
---
#### [new 006] 4DLangVGGT: 4D Language-Visual Geometry Grounded Transformer
- **分类: cs.CV**

- **简介: 该论文提出4DLangVGGT，首个基于Transformer的4D语言-视觉几何接地框架，旨在解决现有4D语义场方法依赖逐场景优化、泛化差的问题。通过联合建模时空几何与语言对齐，实现跨场景通用性与高效部署。**

- **链接: [https://arxiv.org/pdf/2512.05060v1](https://arxiv.org/pdf/2512.05060v1)**
...
>
---
#### [new 008] Order Matters: 3D Shape Generation from Sequential VR Sketches
- **分类: cs.CV**

- **简介: 该论文研究从时序VR草图生成3D形状，解决现有方法忽略笔画顺序导致设计意图丢失的问题。提出VRSketch2Shape框架，包含新数据集、自动合成管线和时序感知的生成模型，提升几何精度与真实草图泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.04761v1](https://arxiv.org/pdf/2512.04761v1)**
...
>
---
#### [new 009] Stable Single-Pixel Contrastive Learning for Semantic and Geometric Tasks
- **分类: cs.CV**

- **简介: 该论文研究像素级表征学习，旨在同时捕捉语义与几何信息。提出稳定的单像素对比损失方法，实现无需动量教师-学生机制的跨图像精确点匹配，在合成2D/3D环境中验证了有效性。**

- **链接: [https://arxiv.org/pdf/2512.04970v1](https://arxiv.org/pdf/2512.04970v1)**
...
>
---
#### [new 013] Light-X: Generative 4D Video Rendering with Camera and Illumination Control
- **分类: cs.CV**

- **简介: 该论文属于4D视频生成任务，旨在解决单目视频中相机视角与光照联合控制时的光照保真度与时间一致性权衡问题。提出Light-X框架，通过解耦几何与光照信号，并构建合成数据集Light-Syn，实现高质量、可控的动态场景渲染。**

- **链接: [https://arxiv.org/pdf/2512.05115v1](https://arxiv.org/pdf/2512.05115v1)**
...
>
---
#### [new 014] Refaçade: Editing Object with Given Reference Texture
- **分类: cs.CV**

- **简介: 该论文提出“物体重纹理”任务，旨在将参考物体的局部纹理迁移到目标物体。为解决现有方法因结构干扰导致控制性差的问题，作者提出Refaçade，通过纹理移除网络和拼图打乱策略，实现对图像和视频中纹理的精准可控编辑。**

- **链接: [https://arxiv.org/pdf/2512.04534v1](https://arxiv.org/pdf/2512.04534v1)**
...
>
---
#### [new 021] PhyVLLM: Physics-Guided Video Language Model with Motion-Appearance Disentanglement
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视频语言模型中的物理动态理解任务，旨在解决现有模型因依赖外观匹配而缺乏物理推理能力的问题。作者提出PhyVLLM，通过双分支编码器解耦运动与外观，引入Neural ODE建模连续物理动态，并采用自监督学习避免依赖物理标注，提升了模型在物理推理和通用视频理解上的表现。**

- **链接: [https://arxiv.org/pdf/2512.04532v1](https://arxiv.org/pdf/2512.04532v1)**
...
>
---
#### [new 022] Balanced Few-Shot Episodic Learning for Accurate Retinal Disease Diagnosis
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究少样本视网膜疾病诊断，解决数据稀缺与类别不平衡问题。提出平衡的少样本学习框架，结合均衡采样、针对性增强与预训练编码器，在RFMiD数据集上提升罕见病诊断准确率与公平性。**

- **链接: [https://arxiv.org/pdf/2512.04967v1](https://arxiv.org/pdf/2512.04967v1)**
...
>
---
#### [new 023] MAFNet:Multi-frequency Adaptive Fusion Network for Real-time Stereo Matching
- **分类: cs.CV**

- **简介: 该论文研究实时立体匹配任务，旨在解决现有方法计算开销大、非局部上下文建模不足的问题。提出MAFNet，通过频域分解与自适应融合，仅用2D卷积实现高效高精度视差估计。**

- **链接: [https://arxiv.org/pdf/2512.04358v1](https://arxiv.org/pdf/2512.04358v1)**
...
>
---
#### [new 027] VideoSSM: Autoregressive Long Video Generation with Hybrid State-Space Memory
- **分类: cs.CV**

- **简介: 该论文研究长视频生成任务，旨在解决自回归扩散模型中因累积误差导致的时序不一致问题。作者提出VideoSSM，结合状态空间模型与局部上下文窗口，统一长短时记忆，提升长程一致性与交互性，实现高效稳定的分钟级视频生成。**

- **链接: [https://arxiv.org/pdf/2512.04519v1](https://arxiv.org/pdf/2512.04519v1)**

> **作者:** Yifei Yu; Xiaoshan Wu; Xinting Hu; Tao Hu; Yangtian Sun; Xiaoyang Lyu; Bo Wang; Lin Ma; Yuewen Ma; Zhongrui Wang; Xiaojuan Qi
>
> **摘要:** Autoregressive (AR) diffusion enables streaming, interactive long-video generation by producing frames causally, yet maintaining coherence over minute-scale horizons remains challenging due to accumulated errors, motion drift, and content repetition. We approach this problem from a memory perspective, treating video synthesis as a recurrent dynamical process that requires coordinated short- and long-term context. We propose VideoSSM, a Long Video Model that unifies AR diffusion with a hybrid state-space memory. The state-space model (SSM) serves as an evolving global memory of scene dynamics across the entire sequence, while a context window provides local memory for motion cues and fine details. This hybrid design preserves global consistency without frozen, repetitive patterns, supports prompt-adaptive interaction, and scales in linear time with sequence length. Experiments on short- and long-range benchmarks demonstrate state-of-the-art temporal consistency and motion stability among autoregressive video generator especially at minute-scale horizons, enabling content diversity and interactive prompt-based control, thereby establishing a scalable, memory-aware framework for long video generation.
>
---
#### [new 028] Self-Paced and Self-Corrective Masked Prediction for Movie Trailer Generation
- **分类: cs.CV**

- **简介: 该论文研究电影预告片生成任务，旨在解决传统“先选后排”方法的误差累积问题。提出自步长自修正掩码预测（SSMP）方法，通过双向上下文建模与渐进式自我纠正，实现高质量预告片生成。**

- **链接: [https://arxiv.org/pdf/2512.04426v1](https://arxiv.org/pdf/2512.04426v1)**
...
>
---
#### [new 034] VideoMem: Enhancing Ultra-Long Video Understanding via Adaptive Memory Management
- **分类: cs.CV**

- **简介: 该论文研究超长视频理解任务，旨在解决现有视觉语言模型因上下文长度限制和长期记忆效率低导致的性能下降问题。提出VideoMem框架，通过自适应内存管理和渐进式训练算法提升长视频信息保留与推理能力。**

- **链接: [https://arxiv.org/pdf/2512.04540v1](https://arxiv.org/pdf/2512.04540v1)**
...
>
---
#### [new 042] DraCo: Draft as CoT for Text-to-Image Preview and Rare Concept Generation
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于文本到图像生成任务，旨在解决现有方法在语义对齐和罕见概念生成上的不足。提出DraCo框架，通过低分辨率草图作为视觉化思维链，结合模型自身理解进行验证与选择性修正，提升生成质量。**

- **链接: [https://arxiv.org/pdf/2512.05112v1](https://arxiv.org/pdf/2512.05112v1)**
...
>
---
#### [new 051] Denoise to Track: Harnessing Video Diffusion Priors for Robust Correspondence
- **分类: cs.CV**

- **简介: 该论文属于视频点跟踪任务，旨在解决无监督条件下建立跨帧像素对应关系的问题。作者提出HeFT框架，利用预训练视频扩散模型的注意力头与低频特征进行零样本跟踪，通过特征选择和一致性验证提升性能，实现了接近有监督方法的精度。**

- **链接: [https://arxiv.org/pdf/2512.04619v1](https://arxiv.org/pdf/2512.04619v1)**
...
>
---
#### [new 058] ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning
- **分类: cs.CV**

- **简介: 该论文研究多模态奖励模型的优化，旨在解决现有模型在视觉对齐、细粒度验证和工具使用上的不足。提出ARM-Thinker，通过代理式工具调用实现可验证的视觉推理，并引入ARMBench-VL进行评测，显著提升了准确性和可解释性。**

- **链接: [https://arxiv.org/pdf/2512.05111v1](https://arxiv.org/pdf/2512.05111v1)**
...
>
---
#### [new 062] Plug-and-Play Image Restoration with Flow Matching: A Continuous Viewpoint
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究图像恢复任务，旨在提升插件式流匹配（PnP-Flow）模型的性能与理论理解。作者提出其连续视角下的SDE模型，揭示误差来源并指导优化策略，通过调节步长、正则化网络和加速推理提升效果，在多种图像恢复任务中取得优越表现。**

- **链接: [https://arxiv.org/pdf/2512.04283v1](https://arxiv.org/pdf/2512.04283v1)**
...
>
---
#### [new 065] Contact-Aware Refinement of Human Pose Pseudo-Ground Truth via Bioimpedance Sensing
- **分类: cs.CV**

- **简介: 该论文针对自接触场景下3D人体姿态估计不准的问题，提出融合视觉与生物阻抗传感的框架BioTUCH，利用皮肤接触信号优化姿态重建。通过新采集的数据集验证，提升了11.7%的精度，并开发了用于数据采集的小型可穿戴传感器。**

- **链接: [https://arxiv.org/pdf/2512.04862v1](https://arxiv.org/pdf/2512.04862v1)**
...
>
---
#### [new 067] Beyond Flicker: Detecting Kinematic Inconsistencies for Generalizable Deepfake Video Detection
- **分类: cs.CV**

- **简介: 该论文属于深度伪造视频检测任务，旨在提升模型对未见伪造方法的泛化能力。针对现有方法忽略面部运动自然依赖关系的问题，提出合成具有运动不一致性的训练视频，通过操纵面部关键点运动基元引入生物力学异常，增强检测器对复杂伪造的识别能力。**

- **链接: [https://arxiv.org/pdf/2512.04175v1](https://arxiv.org/pdf/2512.04175v1)**
...
>
---
#### [new 073] UniTS: Unified Time Series Generative Model for Remote Sensing
- **分类: cs.CV**

- **简介: 该论文提出UniTS模型，旨在统一解决遥感时间序列中的多个任务（如去云、重建、变化检测与预测）。针对现有方法任务专用、缺乏统一建模的问题，设计了基于流匹配的生成框架，结合条件注入与时空调制机制，并构建新数据集，显著提升多任务性能。**

- **链接: [https://arxiv.org/pdf/2512.04461v1](https://arxiv.org/pdf/2512.04461v1)**
...
>
---
#### [new 079] Infrared UAV Target Tracking with Dynamic Feature Refinement and Global Contextual Attention Knowledge Distillation
- **分类: cs.CV**

- **简介: 该论文研究红外无人机目标跟踪任务，旨在解决弱特征和复杂背景下跟踪难的问题。提出SiamDFF网络，结合动态特征融合与全局上下文注意力知识蒸馏，通过增强关键区域特征和提升模型关注度，实现高效准确的红外无人机跟踪。**

- **链接: [https://arxiv.org/pdf/2512.04581v1](https://arxiv.org/pdf/2512.04581v1)**
...
>
---
#### [new 080] Joint 3D Geometry Reconstruction and Motion Generation for 4D Synthesis from a Single Image
- **分类: cs.CV**

- **简介: 该论文研究从单张图像生成动态4D场景，解决现有方法中几何与运动分离导致的时空不一致问题。提出MoRe4D框架，联合进行3D几何重建与运动生成，并构建大规模轨迹数据集TrajScene-60K，实现高质量、多视角一致的4D合成。**

- **链接: [https://arxiv.org/pdf/2512.05044v1](https://arxiv.org/pdf/2512.05044v1)**

> **作者:** Yanran Zhang; Ziyi Wang; Wenzhao Zheng; Zheng Zhu; Jie Zhou; Jiwen Lu
>
> **备注:** 18 Pages
>
> **摘要:** Generating interactive and dynamic 4D scenes from a single static image remains a core challenge. Most existing generate-then-reconstruct and reconstruct-then-generate methods decouple geometry from motion, causing spatiotemporal inconsistencies and poor generalization. To address these, we extend the reconstruct-then-generate framework to jointly perform Motion generation and geometric Reconstruction for 4D Synthesis (MoRe4D). We first introduce TrajScene-60K, a large-scale dataset of 60,000 video samples with dense point trajectories, addressing the scarcity of high-quality 4D scene data. Based on this, we propose a diffusion-based 4D Scene Trajectory Generator (4D-STraG) to jointly generate geometrically consistent and motion-plausible 4D point trajectories. To leverage single-view priors, we design a depth-guided motion normalization strategy and a motion-aware module for effective geometry and dynamics integration. We then propose a 4D View Synthesis Module (4D-ViSM) to render videos with arbitrary camera trajectories from 4D point track representations. Experiments show that MoRe4D generates high-quality 4D scenes with multi-view consistency and rich dynamic details from a single image. Code: https://github.com/Zhangyr2022/MoRe4D.
>
---
#### [new 081] LaFiTe: A Generative Latent Field for 3D Native Texturing
- **分类: cs.CV**

- **简介: 该论文研究3D原生纹理生成，旨在解决现有方法因缺乏有效隐式表示而导致的纹理质量不足问题。提出LaFiTe框架，通过学习稀疏隐式颜色场，结合VAE与流模型，实现高保真、无缝的3D表面纹理生成。**

- **链接: [https://arxiv.org/pdf/2512.04786v1](https://arxiv.org/pdf/2512.04786v1)**
...
>
---
#### [new 083] Counterfeit Answers: Adversarial Forgery against OCR-Free Document Visual Question Answering
- **分类: cs.CV**

- **简介: 该论文研究OCR-Free文档视觉问答（DocVQA）的对抗攻击，旨在通过视觉不可见的篡改诱导模型输出错误答案。作者提出新型伪造攻击算法，针对Pix2Struct和Donut等先进模型进行攻击验证，揭示当前系统脆弱性，呼吁加强防御机制。**

- **链接: [https://arxiv.org/pdf/2512.04554v1](https://arxiv.org/pdf/2512.04554v1)**
...
>
---
#### [new 084] Live Avatar: Streaming Real-time Audio-Driven Avatar Generation with Infinite Length
- **分类: cs.CV**

- **简介: 该论文聚焦实时音频驱动的无限长度虚拟形象生成任务，解决扩散模型在长序列生成中的自回归延迟与视觉不一致问题。提出TPP并行推理、RSFM时序校准与自强制蒸馏方法，实现高保真、低延迟的流式生成，首次在5卡上达到20FPS端到端性能。**

- **链接: [https://arxiv.org/pdf/2512.04677v1](https://arxiv.org/pdf/2512.04677v1)**
...
>
---
#### [new 085] FASTer: Toward Efficient Autoregressive Vision Language Action Modeling via neural Action Tokenization
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 088] Real-time Cricket Sorting By Sex
- **分类: cs.CV; q-bio.QM**

- **简介: 该论文针对食用蟋蟀养殖中缺乏自动分性问题，提出一种基于树莓派5和轻量YOLOv8模型的实时分选系统，结合计算机视觉与机械控制，实现低成本、高精度的活体蟋蟀雌雄自动分拣，提升养殖效率与可持续性。**

- **链接: [https://arxiv.org/pdf/2512.04311v1](https://arxiv.org/pdf/2512.04311v1)**
...
>
---
#### [new 089] MindDrive: An All-in-One Framework Bridging World Models and Vision-Language Model for End-to-End Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文面向端到端自动驾驶，解决轨迹生成与决策不协同的问题。提出MindDrive框架，融合世界模型与视觉语言模型，实现“情境模拟-候选生成-多目标权衡”的推理流程，兼顾轨迹质量与可解释决策，提升安全性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.04441v1](https://arxiv.org/pdf/2512.04441v1)**
...
>
---
#### [new 090] Equivariant Symmetry-Aware Head Pose Estimation for Fetal MRI
- **分类: cs.CV**

- **简介: 该论文针对胎儿MRI中头部运动导致的2D切片定位难题，提出E(3)-Pose方法，属于6自由度头位姿估计任务。它通过显式建模旋转等变性与解剖对称性，解决临床数据中因对称结构、低分辨率和噪声引起的姿态模糊问题，实现快速、鲁棒的自适应切片定位。**

- **链接: [https://arxiv.org/pdf/2512.04890v1](https://arxiv.org/pdf/2512.04890v1)**
...
>
---
#### [new 093] SAM3-I: Segment Anything with Instructions
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，旨在解决现有SAM3模型仅能处理简单名词短语提示、难以理解复杂自然语言指令的问题。作者提出SAM3-I，通过指令感知的级联适应机制，实现对复杂指令的理解与分割，并构建了多层级指令数据集，兼顾概念分割与指令跟随能力。**

- **链接: [https://arxiv.org/pdf/2512.04585v1](https://arxiv.org/pdf/2512.04585v1)**
...
>
---
#### [new 109] Tokenizing Buildings: A Transformer for Layout Synthesis
- **分类: cs.CV; cs.GR; cs.LG**

- **简介: 该论文属于建筑布局生成任务，旨在解决BIM场景中异构建筑元素的统一表征问题。作者提出Small Building Model（SBM），通过序列化房间特征并设计统一嵌入模块，结合Transformer实现高保真房间表示与自回归布局生成，提升了生成质量与语义检索能力。**

- **链接: [https://arxiv.org/pdf/2512.04832v1](https://arxiv.org/pdf/2512.04832v1)**
...
>
---
#### [new 110] E3AD: An Emotion-Aware Vision-Language-Action Model for Human-Centric End-to-End Autonomous Driving
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究端到端自动驾驶任务，解决现有模型忽视乘客情绪导致舒适性不足的问题。提出E3AD框架，融合语言指令与情绪感知（VAD模型）及双路径空间推理，提升驾驶行为与人类意图的一致性。**

- **链接: [https://arxiv.org/pdf/2512.04733v1](https://arxiv.org/pdf/2512.04733v1)**
...
>
---
#### [new 113] Splannequin: Freezing Monocular Mannequin-Challenge Footage with Dual-Detection Splatting
- **分类: cs.CV**

- **简介: 该论文研究从单目“假人挑战”视频生成高保真冻结3D场景。针对动态高斯溅射中因稀疏监督导致的鬼影与模糊问题，提出Splannequin方法，通过双态检测与时间锚定机制，提升视觉质量，实现用户可选的瞬时静态渲染。**

- **链接: [https://arxiv.org/pdf/2512.05113v1](https://arxiv.org/pdf/2512.05113v1)**

> **作者:** Hao-Jen Chien; Yi-Chuan Huang; Chung-Ho Wu; Wei-Lun Chao; Yu-Lun Liu
>
> **备注:** WACV 2025. Project page: https://chien90190.github.io/splannequin/
>
...
>
---
#### [new 114] ReflexFlow: Rethinking Learning Objective for Exposure Bias Alleviation in Flow Matching
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于生成模型任务，旨在解决Flow Matching中的曝光偏差问题。作者提出ReflexFlow，通过抗漂移校正和频率补偿改进学习目标，缓解训练与推理差异，提升生成质量，适用于各类Flow Matching框架。**

- **链接: [https://arxiv.org/pdf/2512.04904v1](https://arxiv.org/pdf/2512.04904v1)**
...
>
---
#### [new 115] SDG-Track: A Heterogeneous Observer-Follower Framework for High-Resolution UAV Tracking on Embedded Platforms
- **分类: cs.CV**

- **简介: 该论文研究无人机实时跟踪任务，解决嵌入式平台上高分辨率与高速度的冲突。提出SDG-Track框架，采用异构Observer-Follower结构，结合稀疏检测与光流追踪，并设计无需训练的双空间恢复机制应对遮挡和干扰，实现高效精准跟踪。**

- **链接: [https://arxiv.org/pdf/2512.04883v1](https://arxiv.org/pdf/2512.04883v1)**

> **作者:** Jiawen Wen; Yu Hu; Suixuan Qiu; Jinshan Huang; Xiaowen Chu
>
> **备注:** https://github.com/Jeffry-wen/SDG-Track
>
...
>
---
#### [new 116] 6 Fingers, 1 Kidney: Natural Adversarial Medical Images Reveal Critical Weaknesses of Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文针对视觉-语言模型在罕见解剖结构上的性能下降问题，构建了包含自然对抗性解剖的医学图像基准AdversarialAnatomyBench。研究发现现有模型在非典型解剖图像上准确率显著下降，揭示其对解剖先验的强依赖和泛化缺陷。**

- **链接: [https://arxiv.org/pdf/2512.04238v1](https://arxiv.org/pdf/2512.04238v1)**
...
>
---
#### [new 123] The changing surface of the world's roads
- **分类: physics.soc-ph; cs.AI; cs.CV; cs.CY**

- **简介: 该论文属遥感与基础设施监测任务，旨在解决全球道路表面信息缺失问题。作者利用深度学习分析卫星影像，构建首个全球多时相道路铺装与宽度数据集，揭示发展动态、经济连通性及气候脆弱性，为可持续发展提供高分辨率物理基础设施评估工具。**

- **链接: [https://arxiv.org/pdf/2512.04092v1](https://arxiv.org/pdf/2512.04092v1)**
...
>
---
#### [new 125] TV2TV: A Unified Framework for Interleaved Language and Video Generation
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出TV2TV框架，属于视频生成任务，旨在解决复杂语义推理与高精度控制问题。通过语言与视频交织生成，结合语言模型推理能力，提升生成质量与可控性。**

- **链接: [https://arxiv.org/pdf/2512.05103v1](https://arxiv.org/pdf/2512.05103v1)**
...
>
---
#### [new 126] The Universal Weight Subspace Hypothesis
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出“通用权重子空间假设”，揭示不同任务下深度神经网络收敛至共享的低维谱子空间。通过分析1100余模型，发现少数主方向即可捕获主要权重方差，表明网络共用稀疏子空间。此发现有助于模型复用与高效训练。**

- **链接: [https://arxiv.org/pdf/2512.05117v1](https://arxiv.org/pdf/2512.05117v1)**
...
>
---
#### [new 127] Hardware-aware Neural Architecture Search of Early Exiting Networks on Edge Accelerators
- **分类: cs.CC; cs.AR; cs.CV**

- **简介: 该论文研究面向边缘加速器的早退神经网络结构搜索，解决在资源受限下模型效率与精度平衡问题。提出硬件感知的NAS框架，联合优化早退点位置与量化策略，显著降低计算开销。**

- **链接: [https://arxiv.org/pdf/2512.04705v1](https://arxiv.org/pdf/2512.04705v1)**
...
>
---
#### [new 129] Studying Various Activation Functions and Non-IID Data for Machine Learning Model Robustness
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究激活函数与非独立同分布（非IID）数据对机器学习模型鲁棒性的影响，属于模型鲁棒性提升任务。提出一种改进的对抗训练方法，在集中式和联邦学习环境中提升模型自然与鲁棒准确性，并探讨数据共享对非IID问题的缓解作用。**

- **链接: [https://arxiv.org/pdf/2512.04264v1](https://arxiv.org/pdf/2512.04264v1)**
...
>
---
#### [new 130] Deep infant brain segmentation from multi-contrast MRI
- **分类: cs.LG; cs.CV; eess.IV**

- **简介: 该论文属医学图像分割任务，旨在解决婴幼儿脑部MRI因成像限制导致的分割难题。作者提出BabySeg框架，采用域随机化和多扫描特征融合，实现对多样MRI协议的鲁棒分割，适用于不同年龄和临床场景，精度高且速度快。**

- **链接: [https://arxiv.org/pdf/2512.05114v1](https://arxiv.org/pdf/2512.05114v1)**
...
>
---
#### [new 132] Shared Multi-modal Embedding Space for Face-Voice Association
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 133] Human-Centred Evaluation of Text-to-Image Generation Models for Self-expression of Mental Distress: A Dataset Based on GPT-4o
- **分类: q-bio.NC; cs.CL; cs.CV; cs.CY; cs.HC**

- **简介: 该论文聚焦文本到图像生成模型在心理健康表达中的应用，旨在解决国际学生因语言文化障碍难以表达心理困扰的问题。通过GPT-4o生成图像并由用户评估，构建了首个含人工评分的多模态心理表达数据集，探索提示设计对表达效果的影响。**

- **链接: [https://arxiv.org/pdf/2512.04087v1](https://arxiv.org/pdf/2512.04087v1)**
...
>
---
#### [new 134] STeP-Diff: Spatio-Temporal Physics-Informed Diffusion Models for Mobile Fine-Grained Pollution Forecasting
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究细粒度空气污染预测任务，解决移动传感器数据不完整及时变性问题。提出STeP-Diff模型，结合物理约束与扩散模型，利用DeepONet和PDE正则化，提升预测精度。**

- **链接: [https://arxiv.org/pdf/2512.04385v1](https://arxiv.org/pdf/2512.04385v1)**
...
>
---
#### [new 135] Efficient Spatially-Variant Convolution via Differentiable Sparse Kernel Complex
- **分类: cs.GR; cs.CV**

- **简介: 该论文研究图像中复杂核的高效空间可变成像卷积。针对传统方法计算昂贵或精度不足的问题，提出可微稀疏核分解框架，实现高效、高保真卷积，支持非凸核与空间变化滤波，适用于移动端与实时渲染。**

- **链接: [https://arxiv.org/pdf/2512.04556v1](https://arxiv.org/pdf/2512.04556v1)**
...
>
---
#### [replaced 004] Multimodal Markup Document Models for Graphic Design Completion
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [https://arxiv.org/pdf/2409.19051v2](https://arxiv.org/pdf/2409.19051v2)**
...
>
---
#### [replaced 011] ViRectify: A Challenging Benchmark for Video Reasoning Correction with Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01424v3](https://arxiv.org/pdf/2512.01424v3)**
...
>
---
#### [replaced 012] Flowing Backwards: Improving Normalizing Flows via Reverse Representation Alignment
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22345v2](https://arxiv.org/pdf/2511.22345v2)**
...
>
---
#### [replaced 013] There is No VAE: End-to-End Pixel-Space Generative Modeling via Self-Supervised Pre-training
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.12586v2](https://arxiv.org/pdf/2510.12586v2)**
...
>
---
#### [replaced 014] Sliding-Window Merging for Compacting Patch-Redundant Layers in LLMs
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.19159v4](https://arxiv.org/pdf/2502.19159v4)**
...
>
---
#### [replaced 016] Open-Set Domain Adaptation Under Background Distribution Shift: Challenges and A Provably Efficient Solution
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01152v2](https://arxiv.org/pdf/2512.01152v2)**
...
>
---
#### [replaced 017] Integrating Skeleton Based Representations for Robust Yoga Pose Classification Using Deep Learning Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.00572v2](https://arxiv.org/pdf/2512.00572v2)**
...
>
---
#### [replaced 018] ROGR: Relightable 3D Objects using Generative Relighting
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2510.03163v3](https://arxiv.org/pdf/2510.03163v3)**
...
>
---
#### [replaced 019] Dual-branch Prompting for Multimodal Machine Translation
- **分类: cs.CV; cs.CL**

- **简介: 该论文研究多模态机器翻译，旨在提升模型对视觉噪声的鲁棒性。提出D2P-MMT框架，利用扩散模型生成重构图像替代原始图像，通过双分支提示学习和分布对齐损失，增强跨模态交互并缓解训练与推理差异。**

- **链接: [https://arxiv.org/pdf/2507.17588v2](https://arxiv.org/pdf/2507.17588v2)**
...
>
---
#### [replaced 020] EoS-FM: Can an Ensemble of Specialist Models act as a Generalist Feature Extractor?
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21523v2](https://arxiv.org/pdf/2511.21523v2)**
...
>
---
#### [replaced 021] Beyond Description: Cognitively Benchmarking Fine-Grained Action for Embodied Agents
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 022] JarvisEvo: Towards a Self-Evolving Photo Editing Agent with Synergistic Editor-Evaluator Optimization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.23002v2](https://arxiv.org/pdf/2511.23002v2)**
...
>
---
#### [replaced 027] Efficient stereo matching on embedded GPUs with zero-means cross correlation
- **分类: cs.CV; cs.AR**

- **链接: [https://arxiv.org/pdf/2212.00476v2](https://arxiv.org/pdf/2212.00476v2)**

> **作者:** Qiong Chang; Aolong Zha; Weimin Wang; Xin Liu; Masaki Onishi; Lei Lei; Meng Joo Er; Tsutomu Maruyama
>
...
>
---
#### [replaced 028] Detection of AI Deepfake and Fraud in Online Payments Using GAN-Based Models
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [https://arxiv.org/pdf/2501.07033v2](https://arxiv.org/pdf/2501.07033v2)**
...
>
---
#### [replaced 030] SpaceMind: Camera-Guided Modality Fusion for Spatial Reasoning in Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.23075v2](https://arxiv.org/pdf/2511.23075v2)**
...
>
---
#### [replaced 031] Average Calibration Losses for Reliable Uncertainty in Medical Image Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.03942v3](https://arxiv.org/pdf/2506.03942v3)**
...
>
---
#### [replaced 032] MMHOI: Modeling Complex 3D Multi-Human Multi-Object Interactions
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.07828v3](https://arxiv.org/pdf/2510.07828v3)**
...
>
---
#### [replaced 033] TempR1: Improving Temporal Understanding of MLLMs via Temporal-Aware Multi-Task Reinforcement Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.03963v2](https://arxiv.org/pdf/2512.03963v2)**
...
>
---
#### [replaced 034] VRWKV-Editor: Reducing quadratic complexity in transformer-based video editing
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.25998v3](https://arxiv.org/pdf/2509.25998v3)**
...
>
---
#### [replaced 035] XAI-Driven Skin Disease Classification: Leveraging GANs to Augment ResNet-50 Performance
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.00626v2](https://arxiv.org/pdf/2512.00626v2)**
...
>
---
#### [replaced 036] Jina-VLM: Small Multilingual Vision Language Model
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文提出Jina-VLM，一种2.4B参数的多语言视觉语言模型，旨在提升多语言视觉问答性能。通过SigLIP2视觉编码器与Qwen3语言模型结合，支持任意分辨率图像输入，在保持优秀文本能力的同时实现SOTA多语言VQA表现，并开源模型与代码。**

- **链接: [https://arxiv.org/pdf/2512.04032v2](https://arxiv.org/pdf/2512.04032v2)**

> **作者:** Andreas Koukounas; Georgios Mastrapas; Florian Hönicke; Sedigheh Eslami; Guillaume Roncari; Scott Martens; Han Xiao
>
> **备注:** 18 pages, 1-7 main content, 13-18 appendix for tables and dataset
>
...
>
---
#### [replaced 037] DE-KAN: A Kolmogorov Arnold Network with Dual Encoder for accurate 2D Teeth Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18533v2](https://arxiv.org/pdf/2511.18533v2)**
...
>
---
#### [replaced 041] SAGE: Spatial-visual Adaptive Graph Exploration for Visual Place Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.25723v2](https://arxiv.org/pdf/2509.25723v2)**
...
>
---
#### [replaced 042] A lightweight detector for real-time detection of remote sensing images
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.17147v2](https://arxiv.org/pdf/2511.17147v2)**
...
>
---
#### [replaced 045] Surface-Based Visibility-Guided Uncertainty for Continuous Active 3D Neural Reconstruction
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2405.02568v3](https://arxiv.org/pdf/2405.02568v3)**

> **作者:** Hyunseo Kim; Hyeonseo Yang; Taekyung Kim; YoonSung Kim; Minsu Lee; Jin-Hwa Kim; Byoung-Tak Zhang
>
> **备注:** The main claims are the same as in the previous version, but the naming and explanations have been changed. Accepted at AAAI 2026 Artificial Intelligence with Biased or Scarce Data workshop
>
...
>
---
#### [replaced 048] MORPH: PDE Foundation Models with Arbitrary Data Modality
- **分类: cs.CV; cs.AI; cs.LG; physics.comp-ph**

- **链接: [https://arxiv.org/pdf/2509.21670v3](https://arxiv.org/pdf/2509.21670v3)**
...
>
---
#### [replaced 049] GigaBrain-0: A World Model-Powered Vision-Language-Action Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 052] WeatherPrompt: Multi-modality Representation Learning for All-Weather Drone Visual Geo-Localization
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 053] Downscaling climate projections to 1 km with single-image super resolution
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.21399v2](https://arxiv.org/pdf/2509.21399v2)**
...
>
---
#### [replaced 056] Bootstrap Dynamic-Aware 3D Visual Representation for Scalable Robot Learning
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 060] SYNTHIA: Novel Concept Design with Affordance Composition
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2502.17793v4](https://arxiv.org/pdf/2502.17793v4)**
...
>
---
#### [replaced 061] Changes in Gaza: DINOv3-Powered Multi-Class Change Detection for Damage Assessment in Conflict Zones
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.19035v2](https://arxiv.org/pdf/2511.19035v2)**

> **作者:** Kai Zheng; Zhenkai Wu; Fupeng Wei; Miaolan Zhou; Kai Lie; Haitao Guo; Lei Ding; Wei Zhang; Hang-Cheng Dong
>
...
>
---
#### [replaced 062] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.13547v2](https://arxiv.org/pdf/2412.13547v2)**

> **作者:** Ankit Dhiman; Tao Lu; R Srinath; Emre Arslan; Angela Xing; Yuanbo Xiangli; R Venkatesh Babu; Srinath Sridhar
>
> **备注:** Project page: https://ivl.cs.brown.edu/research/turbo-gs
>
> **摘要:** Novel-view synthesis is an important problem in computer vision with applications in 3D reconstruction, mixed reality, and robotics. Recent methods like 3D Gaussian Splatting (3DGS) have become the preferred method for this task, providing high-quality novel views in real time. However, the training time of a 3DGS model is slow, often taking 30 minutes for a scene with 200 views. In contrast, our goal is to reduce the optimization time by training for fewer steps while maintaining high rendering quality. Specifically, we combine the guidance from both the position error and the appearance error to achieve a more effective densification. To balance the rate between adding new Gaussians and fitting old Gaussians, we develop a convergence-aware budget control mechanism. Moreover, to make the densification process more reliable, we selectively add new Gaussians from mostly visited regions. With these designs, we reduce the Gaussian optimization steps to one-third of the previous approach while achieving a comparable or even better novel view rendering quality. To further facilitate the rapid fitting of 4K resolution images, we introduce a dilation-based rendering technique. Our method, Turbo-GS, speeds up optimization for typical scenes and scales well to high-resolution (4K) scenarios on standard datasets. Through extensive experiments, we show that our method is significantly faster in optimization than other methods while retaining quality. Project page: https://ivl.cs.brown.edu/research/turbo-gs.
>
---
#### [replaced 063] TraceTrans: Translation and Spatial Tracing for Surgical Prediction
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.22379v4](https://arxiv.org/pdf/2510.22379v4)**
...
>
---
#### [replaced 064] Collaborative Face Experts Fusion in Video Generation: Boosting Identity Consistency Across Large Face Poses
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09476v3](https://arxiv.org/pdf/2508.09476v3)**

> **作者:** Yuji Wang; Moran Li; Xiaobin Hu; Ran Yi; Jiangning Zhang; Chengming Xu; Weijian Cao; Yabiao Wang; Chengjie Wang; Lizhuang Ma
>
> **备注:** \href{https://rain152.github.io/CoFE/}{Project page}
>
...
>
---
#### [replaced 065] BOP-ASK: Object-Interaction Reasoning for Vision-Language Models
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 066] ENTIRE: Learning-based Volume Rendering Time Prediction
- **分类: cs.GR; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2501.12119v2](https://arxiv.org/pdf/2501.12119v2)**
...
>
---
#### [replaced 067] MILR: Improving Multimodal Image Generation via Test-Time Latent Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.22761v2](https://arxiv.org/pdf/2509.22761v2)**
...
>
---
#### [replaced 068] Consistency-based Abductive Reasoning over Perceptual Errors of Multiple Pre-trained Models in Novel Environments
- **分类: cs.AI; cs.CV; cs.LG; cs.LO**

- **链接: [https://arxiv.org/pdf/2505.19361v4](https://arxiv.org/pdf/2505.19361v4)**
