...
>
---
#### [new 005] SGMAGNet: A Baseline Model for 3D Cloud Phase Structure Reconstruction on a New Passive Active Satellite Benchmark
...
- **简介: 该论文提出UNIV，一种统一的红外与可见光基础模型。针对多模态感知性能不足的问题，设计了跨模态对比学习和双知识保留机制，并构建了大规模可见-红外数据集MVIP，提升了红外任务性能且不损害可见光任务效果。**
...
- **简介: 该论文聚焦于视频中的群体活动检测（GAD）任务，旨在识别群体成员并分类其集体行为。现有方法依赖视觉特征，缺乏语义推理能力。为此，作者提出LIR-GAD框架，利用多模态大语言模型（MLLM），引入<ACT>和<GROU P>特殊标记，并设计MDAF模块融合视觉与语言信息，提升GAD的性能与可解释性。**
...
- **简介: 该论文提出Diff-Feat，用于多标签分类任务。通过从预训练的扩散Transformer模型中提取并融合图像和文本中间特征，解决多模态表征学习问题。实验显示其在多个数据集上达到SOTA性能。**
...
- **简介: 该论文提出Rasa框架，用于基于全切片图像（WSI）的生存分析任务。旨在解决WSI特征噪声大、数据有限的问题，通过引入病理报告文本辅助自蒸馏方法，提升模型对关键预后特征的捕捉能力，并采用风险感知混合策略增强训练效果。**
...
- **简介: 该论文提出LC-SLab，一种面向大范围土地覆盖分类的基于对象的深度学习框架，旨在解决稀疏实地标签下传统方法导致的地图碎片化和噪声问题。通过输入级图神经网络聚合与输出级后处理结合，提升了分类准确性和地图连贯性。**
...
- **简介: 该论文研究多视图聚类任务，针对视图间部分对齐导致性能下降的问题，提出基于因果学习的CauMVC模型。通过因果建模与变分自编码器，提取不变特征并设计对比正则化，提升聚类效果。**
...
- **简介: 该论文提出一种自监督真实世界图像去噪框架——盲点引导扩散（Blind-Spot Guided Diffusion），旨在解决传统盲点网络局部细节丢失和扩散模型难以自监督的问题，通过双分支扩散结构实现高效去噪。**
...
- **简介: 该论文聚焦伪装目标检测（COD）任务，旨在解决传统RGB方法在复杂环境下性能受限的问题。作者构建了首个面向多光谱伪装目标检测的基准数据集MCOD，包含真实场景、精细标注及挑战属性，推动多光谱技术在COD中的应用研究。**
...
- **简介: 该论文针对多模态奖励模型（MRM）开发缺乏系统指导的问题，通过全面实验分析各关键组件，提出了高效强大的基线模型BaseReward，并验证其在多个基准和实际强化学习任务中的优越性能。**
...
- **简介: 该论文研究3D视觉定位（3DVG）任务，旨在通过文本提示在3D场景中定位物体。针对现有方法依赖场景训练和大量标注数据的问题，提出GVR框架，将3DVG转化为2D视图检索任务，实现零样本学习，无需3D标注和逐场景训练，达到SOTA性能。**
...
- **简介: 该论文属于肺结节诊断任务，旨在解决多模态模型因标注数据稀缺和过拟合导致的性能受限问题。作者提出基于自监督学习的多模态联合嵌入预测架构（JEPA），利用未标注的CT影像和电子健康记录进行预训练，在内部队列中表现优于其他模型，但在外部队列中效果欠佳，并通过合成环境分析了其局限性。**
...
- **简介: 该论文针对显著性目标检测（SOD）任务中评估方法对物体尺寸敏感的问题，提出了一种尺寸不变的评估框架SIEva和优化方法SIOpt，有效缓解了大尺寸物体主导评估结果的偏差问题。**
...
- **简介: 该论文提出CBPNet，针对边缘设备上持续学习的可塑性损失问题，通过引入高效CBP模块，利用未充分利用参数恢复模型学习能力，在多个基准测试中取得优异效果。**
...
- **简介: 该论文提出RACap，用于轻量级检索增强图像描述生成。针对现有方法在关系建模上的不足，RACap通过挖掘结构化关系语义和识别异构物体，提升语义一致性和关系表达能力，在仅有10.8M参数下取得优异性能。**
...
- **简介: 该论文研究视觉持续学习任务，旨在解决语言引导监督中语义模糊和类内视觉多样性问题。提出MuproCL框架，采用多原型监督与LLM生成上下文感知的语义原型，提升模型鲁棒性与性能。**
...
- **链接: [http://arxiv.org/pdf/2509.15482v1](http://arxiv.org/pdf/2509.15482v1)**
...
- **简介: 该论文提出DAFTED方法，用于心脏高血压诊断任务。针对超声心动图时序数据与表格数据的融合问题，设计解耦非对称融合策略，有效结合多模态信息，在239例患者数据上实现超过90%的AUC性能。**
...
- **链接: [http://arxiv.org/pdf/2509.15342v1](http://arxiv.org/pdf/2509.15342v1)**
...
- **简介: 该论文提出TASAM，用于时序遥感图像分割任务。针对SAM在地形复杂、多尺度和时序变化下的不足，设计了地形感知适配器、时序提示生成器和多尺度融合策略，在无需微调SAM主干的情况下显著提升性能。**
...
- **简介: 该论文提出NeuroRAD-FM，一种针对神经肿瘤学的基座模型。通过分布鲁棒训练解决多中心数据异质性和罕见分子标志物预测难题，提升了分子分类和生存预测的性能与泛化能力。**
...
- **简介: 该论文提出PAN，一种基于摄像头和雷达融合的3D目标检测网络。针对恶劣环境下的实时检测问题，设计了新的骨干网络和自注意力机制，利用雷达优势并优化推理速度，在nuScenes数据集上达到SOTA性能。**
...
- **简介: 该论文针对多智能体体育场景中的轨迹预测任务，旨在解决角色与领域分布差异导致的泛化问题。提出AdaSports-Traj框架，通过角色和领域感知适配器及层次对比学习，实现跨角色和跨领域的轨迹建模。**
...
- **简介: 该论文属于模型解释任务，旨在解决深度学习模型可解释性问题。提出一种基于部件标签的全局解释方法，利用少量标注数据生成可扩展的、人类可理解的模型解释。**
...
>
---
#### [new 063] MEC-Quant: Maximum Entropy Coding for Extremely Low Bit Quantization-Aware Training
- **分类: cs.CV**

- **简介: 该论文针对低比特量化训练中表示偏置问题，提出MEC-Quant方法。通过最大熵编码优化表示结构，提升模型泛化能力，并利用MOE实现端到端训练，在视觉任务中达到或超越全精度模型性能。**

- **链接: [http://arxiv.org/pdf/2509.15514v1](http://arxiv.org/pdf/2509.15514v1)**
...
>
---
#### [new 064] Global Regulation and Excitation via Attention Tuning for Stereo Matching
- **分类: cs.CV**

- **简介: 该论文针对立体匹配任务中迭代方法在纹理缺失、遮挡等困难区域表现不佳的问题，提出GREAT框架。通过三种注意力模块（SA、MA、VA）引入全局上下文与几何信息，提升现有方法性能，在多个基准测试中取得优异结果。**

- **链接: [http://arxiv.org/pdf/2509.15891v1](http://arxiv.org/pdf/2509.15891v1)**
...
>
---
#### [new 072] PCSR: Pseudo-label Consistency-Guided Sample Refinement for Noisy Correspondence Learning
- **分类: cs.CV**

- **简介: 该论文针对跨模态检索任务中图像-文本对存在噪声对应关系的问题，提出PCSR框架。通过伪标签一致性区分干净与噪声样本，并采用自适应优化策略提升模型鲁棒性，在多个数据集上验证了方法有效性。**

- **链接: [http://arxiv.org/pdf/2509.15623v1](http://arxiv.org/pdf/2509.15623v1)**
...
>
---
#### [new 079] GUI-ARP: Enhancing Grounding with Adaptive Region Perception for GUI Agents
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出GUI-ARP，用于提升GUI代理的定位能力。针对高分辨率截图中细粒度定位困难的问题，设计了自适应区域感知与多阶段推理框架，通过两阶段训练实现高效准确的界面元素识别，在多个基准上取得SOTA性能。**

- **链接: [http://arxiv.org/pdf/2509.15532v1](http://arxiv.org/pdf/2509.15532v1)**
...
>
---
#### [new 082] DistillMatch: Leveraging Knowledge Distillation from Vision Foundation Model for Multimodal Image Matching
- **分类: cs.CV; I.4.3; I.5.2**

- **简介: 该论文提出DistillMatch，用于多模态图像匹配任务，旨在解决因模态差异大和标注数据少导致的匹配性能差的问题。通过知识蒸馏从视觉基础模型提取语义特征，并结合V2I-GAN增强泛化能力，提升跨模态匹配效果。**

- **链接: [http://arxiv.org/pdf/2509.16017v1](http://arxiv.org/pdf/2509.16017v1)**

> **作者:** Meng Yang; Fan Fan; Zizhuo Li; Songchu Deng; Yong Ma; Jiayi Ma
>
> **备注:** 10 pages, 4 figures, 3 tables
>
> **摘要:** Multimodal image matching seeks pixel-level correspondences between images of different modalities, crucial for cross-modal perception, fusion and analysis. However, the significant appearance differences between modalities make this task challenging. Due to the scarcity of high-quality annotated datasets, existing deep learning methods that extract modality-common features for matching perform poorly and lack adaptability to diverse scenarios. Vision Foundation Model (VFM), trained on large-scale data, yields generalizable and robust feature representations adapted to data and tasks of various modalities, including multimodal matching. Thus, we propose DistillMatch, a multimodal image matching method using knowledge distillation from VFM. DistillMatch employs knowledge distillation to build a lightweight student model that extracts high-level semantic features from VFM (including DINOv2 and DINOv3) to assist matching across modalities. To retain modality-specific information, it extracts and injects modality category information into the other modality's features, which enhances the model's understanding of cross-modal correlations. Furthermore, we design V2I-GAN to boost the model's generalization by translating visible to pseudo-infrared images for data augmentation. Experiments show that DistillMatch outperforms existing algorithms on public datasets.
>
---
#### [new 083] RangeSAM: Leveraging Visual Foundation Models for Range-View repesented LiDAR segmentation
- **分类: cs.CV**

- **简介: 该论文研究LiDAR点云分割任务，旨在解决传统方法计算成本高、效率低的问题。提出RangeSAM框架，将视觉基础模型SAM2应用于范围图表示的点云分割，通过结构改进优化其性能，实现了高效且准确的3D感知。**

- **链接: [http://arxiv.org/pdf/2509.15886v1](http://arxiv.org/pdf/2509.15886v1)**
...
>
---
#### [new 084] Minimal Semantic Sufficiency Meets Unsupervised Domain Generalization
- **分类: cs.CV**

- **简介: 该论文聚焦无监督域泛化（UDG）任务，旨在提升模型在无类别标签和域标签下的跨域泛化能力。提出MS-UDG方法，通过信息论理论框架学习最小语义充分表征，结合InfoNCE目标与解耦损失，实验证明其优于现有SSL和UDG方法。**

- **链接: [http://arxiv.org/pdf/2509.15791v1](http://arxiv.org/pdf/2509.15791v1)**
...
>
> **摘要:** Reconstructing building floor plans from point cloud data is key for indoor navigation, BIM, and precise measurements. Traditional methods like geometric algorithms and Mask R-CNN-based deep learning often face issues with noise, limited generalization, and loss of geometric details. We propose FloorSAM, a framework that integrates point cloud density maps with the Segment Anything Model (SAM) for accurate floor plan reconstruction from LiDAR data. Using grid-based filtering, adaptive resolution projection, and image enhancement, we create robust top-down density maps. FloorSAM uses SAM's zero-shot learning for precise room segmentation, improving reconstruction across diverse layouts. Room masks are generated via adaptive prompt points and multistage filtering, followed by joint mask and point cloud analysis for contour extraction and regularization. This produces accurate floor plans and recovers room topological relationships. Tests on Giblayout and ISPRS datasets show better accuracy, recall, and robustness than traditional methods, especially in noisy and complex settings. Code and materials: github.com/Silentbarber/FloorSAM.
>
---
#### [new 090] Shedding Light on Depth: Explainability Assessment in Monocular Depth Estimation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究单目深度估计（MDE）模型的可解释性，针对其决策过程缺乏理解的问题，评估了多种特征归因方法，并提出新的评估指标Attribution Fidelity，以提升解释结果的可靠性。**

- **链接: [http://arxiv.org/pdf/2509.15980v1](http://arxiv.org/pdf/2509.15980v1)**
...
>
---
#### [new 097] MaskAttn-SDXL: Controllable Region-Level Text-To-Image Generation
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出MaskAttn-SDXL，用于解决文本到图像生成中多对象的组合失败问题。通过在SDXL模型的UNet中引入区域级门控机制，优化交叉注意力图，减少跨对象干扰，提升空间布局和属性绑定的准确性。**

- **链接: [http://arxiv.org/pdf/2509.15357v1](http://arxiv.org/pdf/2509.15357v1)**
...
>
---
#### [new 103] Which Direction to Choose? An Analysis on the Representation Power of Self-Supervised ViTs in Downstream Tasks
- **分类: cs.CV**

- **简介: 该论文研究自监督ViT在下游任务中的表示能力，探讨未修改的ViT特征在图像分类和分割中的表现。通过对比不同token类型与决策规则，在标准和少样本设置下评估其性能，旨在揭示最优选择及内在表示潜力。**

- **链接: [http://arxiv.org/pdf/2509.15272v1](http://arxiv.org/pdf/2509.15272v1)**
...
>
---
#### [new 104] Efficient Multimodal Dataset Distillation via Generative Models
- **分类: cs.CV**

- **简介: 该论文研究多模态数据集蒸馏任务，旨在高效生成小规模高质量图像-文本数据集。针对现有方法计算成本高、生成样本关联性与多样性不足的问题，提出EDGE方法，通过双向对比损失和多样性损失优化生成模型，并引入文本合成策略，显著提升效率与性能。**

- **链接: [http://arxiv.org/pdf/2509.15472v1](http://arxiv.org/pdf/2509.15472v1)**
...
>
---
#### [new 107] A PCA Based Model for Surface Reconstruction from Incomplete Point Clouds
- **分类: cs.CV**

- **简介: 该论文属于点云表面重建任务，旨在解决不完整点云数据导致的表面结构缺失问题。提出基于PCA的模型，利用PCA估计法向量作为正则化项指导重建，并采用算子分裂法求解，实验表明其优于现有方法。**

- **链接: [http://arxiv.org/pdf/2509.15675v1](http://arxiv.org/pdf/2509.15675v1)**
...
>
---
#### [new 110] Recent Advancements in Microscopy Image Enhancement using Deep Learning: A Survey
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **简介: 该论文综述了深度学习在显微镜图像增强中的最新进展，聚焦超分辨率、重建与去噪等核心领域，总结了当前趋势、应用及挑战，旨在为该领域的研究提供全面参考。**

- **链接: [http://arxiv.org/pdf/2509.15363v1](http://arxiv.org/pdf/2509.15363v1)**
...
>
---
#### [new 111] Dynamic Classifier-Free Diffusion Guidance via Online Feedback
- **分类: cs.LG; cs.CV**

- **简介: 该论文针对文本到图像扩散模型中静态分类器自由引导（CFG）的局限性，提出一种基于在线反馈的动态CFG调度框架。通过实时评估生成质量，为每个时间步选择最优CFG尺度，显著提升了文本对齐、视觉质量和文本渲染效果。**

- **链接: [http://arxiv.org/pdf/2509.16131v1](http://arxiv.org/pdf/2509.16131v1)**
...
>
---
#### [new 112] FedHK-MVFC: Federated Heat Kernel Multi-View Clustering
- **分类: cs.LG; cs.CV; cs.DC; math.AG**

- **简介: 该论文提出FedHK-MVFC，一种结合量子场论与联邦学习的多视图聚类框架，用于隐私保护的医疗数据分析。通过几何感知相似性度量和差分隐私技术，实现跨医院协作聚类，提升精度并降低通信开销。**

- **链接: [http://arxiv.org/pdf/2509.15844v1](http://arxiv.org/pdf/2509.15844v1)**
...
>
---
#### [new 113] PRISM: Probabilistic and Robust Inverse Solver with Measurement-Conditioned Diffusion Prior for Blind Inverse Problems
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文提出PRISM，一种用于盲逆问题的概率鲁棒求解方法。通过引入测量条件扩散先验，无需完全已知前向算子即可有效解决计算成像中的逆问题，实验验证了其在图像去模糊任务中的优越性能。**

- **链接: [http://arxiv.org/pdf/2509.16106v1](http://arxiv.org/pdf/2509.16106v1)**
...
>
---
#### [new 114] The Missing Piece: A Case for Pre-Training in 3D Medical Object Detection
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文聚焦3D医学目标检测任务，旨在探索大规模预训练对提升检测性能的作用。针对现有方法未能充分利用3D信息的问题，作者系统研究了多种预训练方法在检测模型中的应用，发现基于重建的自监督预训练效果最佳。**

- **链接: [http://arxiv.org/pdf/2509.15947v1](http://arxiv.org/pdf/2509.15947v1)**
...
>
---
#### [new 115] CoReVLA: A Dual-Stage End-to-End Autonomous Driving Framework for Long-Tail Scenarios via Collect-and-Refine
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 116] SLaM-DiMM: Shared Latent Modeling for Diffusion Based Missing Modality Synthesis in MRI
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出SLaM-DiMM，一种基于扩散模型的MRI缺失模态生成框架，旨在解决临床中MRI多模态数据不完整的问题。通过共享潜在建模和结构一致性增强机制，实现高质量、解剖合理的模态合成。**

- **链接: [http://arxiv.org/pdf/2509.16019v1](http://arxiv.org/pdf/2509.16019v1)**
...
>
---
#### [new 117] Global Pre-fixing, Local Adjusting: A Simple yet Effective Contrastive Strategy for Continual Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文针对持续学习中的灾难性遗忘问题，提出一种新的对比学习策略GPLASC。通过全局预分配任务间特征空间和局部调整任务内结构，减少任务间的混淆，提升模型的表示能力和泛化性能。**

- **链接: [http://arxiv.org/pdf/2509.15347v1](http://arxiv.org/pdf/2509.15347v1)**

> **作者:** Jia Tang; Xinrui Wang; Songcan Chen
>
> **备注:** The article has been accepted by Frontiers of Computer Science (FCS), with the DOI: {10.1007/s11704-025-50623-6}
>
...
>
---
#### [new 118] DiffusionNFT: Online Diffusion Reinforcement with Forward Process
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出DiffusionNFT，一种针对扩散模型的在线强化学习方法。通过在前向过程中利用流匹配优化模型，解决了传统方法中的采样器限制、前后过程不一致等问题，提升了训练效率和生成质量。**

- **链接: [http://arxiv.org/pdf/2509.16117v1](http://arxiv.org/pdf/2509.16117v1)**
...
>
---
#### [new 119] Kuramoto Orientation Diffusion Models
- **分类: cs.LG; cs.CV; q-bio.NC**

- **简介: 该论文提出一种基于Kuramoto动力学的生成模型，用于处理具有方向特征的图像（如指纹和纹理）。针对传统各向同性扩散方法建模方向模式困难的问题，设计了同步与去同步过程，并引入周期性结构，提升方向密集数据的生成质量。**

- **链接: [http://arxiv.org/pdf/2509.15328v1](http://arxiv.org/pdf/2509.15328v1)**
...
>
---
#### [new 122] MTS-DMAE: Dual-Masked Autoencoder for Unsupervised Multivariate Time Series Representation Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出DMAE，一种用于无监督多变量时间序列（MTS）表征学习的双掩码自编码框架。通过重构掩码值和估计掩码特征的潜在表示，并引入特征对齐约束，学习出时序连贯、语义丰富的表征，在分类、回归和预测任务中表现优异。**

- **链接: [http://arxiv.org/pdf/2509.16078v1](http://arxiv.org/pdf/2509.16078v1)**
...
>
---
#### [new 123] From Data to Diagnosis: A Large, Comprehensive Bone Marrow Dataset and AI Methods for Childhood Leukemia Prediction
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出了一个用于儿童白血病诊断的AI方法及大规模公开骨髓数据集，涵盖细胞检测、分类和诊断预测任务，旨在解决传统人工诊断复杂耗时的问题。**

- **链接: [http://arxiv.org/pdf/2509.15895v1](http://arxiv.org/pdf/2509.15895v1)**

> **作者:** Henning Höfener; Farina Kock; Martina Pontones; Tabita Ghete; David Pfrang; Nicholas Dickel; Meik Kunz; Daniela P. Schacherer; David A. Clunie; Andrey Fedorov; Max Westphal; Markus Metzler
>
...
>
---
#### [new 129] Latent Zoning Network: A Unified Principle for Generative Modeling, Representation Learning, and Classification
- **分类: cs.LG; cs.AI; cs.CV; stat.ML**

- **简介: 该论文提出Latent Zoning Network（LZN），旨在统一解决生成建模、表征学习和分类任务。通过共享高斯潜在空间，LZN实现了多任务协同处理，简化了机器学习流程，并在多个任务上取得优于现有方法的性能。**

- **链接: [http://arxiv.org/pdf/2509.15591v1](http://arxiv.org/pdf/2509.15591v1)**
...
>
---
#### [replaced 002] Deformable Dynamic Convolution for Accurate yet Efficient Spatio-Temporal Traffic Prediction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.11550v2](http://arxiv.org/pdf/2507.11550v2)**
...
>
---
#### [replaced 003] iCBIR-Sli: Interpretable Content-Based Image Retrieval with 2D Slice Embeddings
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [http://arxiv.org/pdf/2501.01642v2](http://arxiv.org/pdf/2501.01642v2)**
...
>
---
#### [replaced 004] OptiScene: LLM-driven Indoor Scene Layout Generation via Scaled Human-aligned Data Synthesis and Multi-Stage Preference Optimization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.07570v2](http://arxiv.org/pdf/2506.07570v2)**
...
>
---
#### [replaced 009] Data-Efficient Learning for Generalizable Surgical Video Understanding
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10215v2](http://arxiv.org/pdf/2508.10215v2)**
...
>
---
#### [replaced 010] OSPO: Object-centric Self-improving Preference Optimization for Text-to-Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.02015v2](http://arxiv.org/pdf/2506.02015v2)**
...
>
---
#### [replaced 011] RSCC: A Large-Scale Remote Sensing Change Caption Dataset for Disaster Events
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 012] Integrating Spatiotemporal Vision Transformer into Digital Twins for High-Resolution Heat Stress Forecasting in Campus Environments
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.09657v2](http://arxiv.org/pdf/2502.09657v2)**
...
>
---
#### [replaced 016] RegionMed-CLIP: A Region-Aware Multimodal Contrastive Learning Pre-trained Model for Medical Image Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.05244v2](http://arxiv.org/pdf/2508.05244v2)**
...
>
---
#### [replaced 017] Sea-ing Through Scattered Rays: Revisiting the Image Formation Model for Realistic Underwater Image Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.15011v2](http://arxiv.org/pdf/2509.15011v2)**
...
>
---
#### [replaced 018] GRE Suite: Geo-localization Inference via Fine-Tuned Vision-Language Models and Enhanced Reasoning Chains
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.18700v3](http://arxiv.org/pdf/2505.18700v3)**
...
>
---
#### [replaced 019] AToken: A Unified Tokenizer for Vision
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2509.14476v2](http://arxiv.org/pdf/2509.14476v2)**
...
>
---
#### [replaced 020] Efficient RAW Image Deblurring with Adaptive Frequency Modulation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24407v4](http://arxiv.org/pdf/2505.24407v4)**
...
>
---
#### [replaced 021] USCTNet: A deep unfolding nuclear-norm optimization solver for physically consistent HSI reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.10651v2](http://arxiv.org/pdf/2509.10651v2)**
...
>
---
#### [replaced 022] DualEdit: Dual Editing for Knowledge Updating in Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.13638v2](http://arxiv.org/pdf/2506.13638v2)**
...
>
---
#### [replaced 025] SCoT: Straight Consistent Trajectory for Pre-Trained Diffusion Model Distillations
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.16972v2](http://arxiv.org/pdf/2502.16972v2)**
...
>
---
#### [replaced 029] cadrille: Multi-modal CAD Reconstruction with Online Reinforcement Learning
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.22914v2](http://arxiv.org/pdf/2505.22914v2)**
...
>
---
#### [replaced 030] LLMs Can Compensate for Deficiencies in Visual Representations
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 033] Examining Deployment and Refinement of the VIOLA-AI Intracranial Hemorrhage Model Using an Interactive NeoMedSys Platform
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.09380v2](http://arxiv.org/pdf/2505.09380v2)**

> **作者:** Qinghui Liu; Jon E. Nesvold; Hanna Raaum; Elakkyen Murugesu; Martin Røvang; Bradley J Maclntosh; Atle Bjørnerud; Karoline Skogen
>
> **备注:** 21 pages, 11 figures, on submission to BMC Methods
>
...
>
---
#### [replaced 034] DAOcc: 3D Object Detection Assisted Multi-Sensor Fusion for 3D Occupancy Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2409.19972v4](http://arxiv.org/pdf/2409.19972v4)**
...
>
---
#### [replaced 035] Set Phasers to Stun: Beaming Power and Control to Mobile Robots with Laser Light
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 036] RGB-Only Supervised Camera Parameter Optimization in Dynamic Scenes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.15123v2](http://arxiv.org/pdf/2509.15123v2)**
...
>
---
#### [replaced 037] RETRO: REthinking Tactile Representation Learning with Material PriOrs
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2505.14319v2](http://arxiv.org/pdf/2505.14319v2)**
...
>
---
#### [replaced 040] Temperature-Driven Robust Disease Detection in Brain and Gastrointestinal Disorders via Context-Aware Adaptive Knowledge Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.06381v2](http://arxiv.org/pdf/2505.06381v2)**
...
>
---
#### [replaced 042] MolParser: End-to-end Visual Recognition of Molecule Structures in the Wild
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.11098v4](http://arxiv.org/pdf/2411.11098v4)**
...
>
---
#### [replaced 043] FLOAT: Generative Motion Latent Flow Matching for Audio-driven Talking Portrait
- **分类: cs.CV; cs.AI; cs.LG; cs.MM; eess.IV**

- **链接: [http://arxiv.org/pdf/2412.01064v5](http://arxiv.org/pdf/2412.01064v5)**
...
>
---
#### [replaced 047] Towards Robust Defense against Customization via Protective Perturbation Resistant to Diffusion-based Purification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.13922v2](http://arxiv.org/pdf/2509.13922v2)**
...
>
---
#### [replaced 048] Generalizable Holographic Reconstruction via Amplitude-Only Diffusion Priors
- **分类: physics.optics; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.12728v2](http://arxiv.org/pdf/2509.12728v2)**
...
>
---
#### [replaced 049] Revealing Human Internal Attention Patterns from Gameplay Analysis for Reinforcement Learning
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.11118v2](http://arxiv.org/pdf/2504.11118v2)**
...
>
---
#### [replaced 050] Are Vision-Language Models Safe in the Wild? A Meme-Based Benchmark Study
...
>
---
#### [replaced 053] SPATIALGEN: Layout-guided 3D Indoor Scene Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.14981v2](http://arxiv.org/pdf/2509.14981v2)**
...
>
---
#### [replaced 054] CrackSCF: Lightweight Cascaded Fusion Network for Robust and Efficient Structural Crack Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2408.12815v4](http://arxiv.org/pdf/2408.12815v4)**
...
>
---
#### [replaced 055] Training A Neural Network For Partially Occluded Road Sign Identification In The Context Of Autonomous Vehicles
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.18177v3](http://arxiv.org/pdf/2503.18177v3)**
...
>
---
#### [replaced 056] RePIC: Reinforced Post-Training for Personalizing Multi-Modal Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.18369v2](http://arxiv.org/pdf/2506.18369v2)**
...
>
---
#### [replaced 057] Advances in Multimodal Adaptation and Generalization: From Traditional Approaches to Foundation Models
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [replaced 058] GPSToken: Gaussian Parameterized Spatially-adaptive Tokenization for Image Representation and Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.01109v2](http://arxiv.org/pdf/2509.01109v2)**
...
>
---
#### [replaced 063] Navigate Beyond Shortcuts: Debiased Learning through the Lens of Neural Collapse
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2405.05587v2](http://arxiv.org/pdf/2405.05587v2)**

> **作者:** Yining Wang; Junjie Sun; Chenyue Wang; Mi Zhang; Min Yang
>
...
>
---
#### [replaced 064] MCGA: Mixture of Codebooks Hyperspectral Reconstruction via Grayscale-Aware Attention
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09885v2](http://arxiv.org/pdf/2507.09885v2)**
...
>
---
#### [replaced 065] Cross-Resolution SAR Target Detection Using Structural Hierarchy Adaptation and Reliable Adjacency Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.08290v2](http://arxiv.org/pdf/2507.08290v2)**

> **作者:** Jiang Qin; Bin Zou; Haolin Li; Lamei Zhang
>
> **备注:** Accepted IEEE TGRS
>
...
>
---
#### [replaced 069] TT-DF: A Large-Scale Diffusion-Based Dataset and Benchmark for Human Body Forgery Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.08437v2](http://arxiv.org/pdf/2505.08437v2)**
...
>
---
#### [replaced 072] Classification of Tents in Street Bazaars Using CNN
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.17946v2](http://arxiv.org/pdf/2506.17946v2)**
...
>
---
#### [replaced 073] A re-calibration method for object detection with multi-modal alignment bias in autonomous driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.16848v3](http://arxiv.org/pdf/2405.16848v3)**
