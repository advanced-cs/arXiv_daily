...
#### [new 001] STABLE: Simulation-Ready Tabletop Layout Generation via a Semantics-Physics Dual System
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 008] Unsupervised 3D Human Pose Estimation via Conditional Multi-view Ancestral Sampling
- **分类: cs.CV**

- **简介: 该论文属于3D人体姿态估计任务，解决单视角下无3D监督的3D姿态估计问题。通过条件多视角祖先采样方法，利用2D扩散模型先验生成合理3D姿态。**

- **链接: [https://arxiv.org/pdf/2605.15583](https://arxiv.org/pdf/2605.15583)**
...
>
---
#### [new 017] DiffVAS: Diffusion-Guided Visual Active Search in Partially Observable Environments
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉主动搜索任务，解决部分可观测环境中多目标搜索问题。提出DiffVAS方法，利用扩散模型重建环境，实现多目标高效搜索。**

- **链接: [https://arxiv.org/pdf/2605.15519](https://arxiv.org/pdf/2605.15519)**
...
>
---
#### [new 029] Minerva-Ego: Spatiotemporal Hints for Egocentric Video Understanding
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出Minerva-Ego基准，用于评估第一人称视频推理任务。解决现有评估仅关注输出、缺乏中间步骤和多模态问题的不足，通过引入时空密集标注的推理轨迹和提示方法提升模型性能。**

- **链接: [https://arxiv.org/pdf/2605.15342](https://arxiv.org/pdf/2605.15342)**
...
>
---
#### [new 030] Learn2Splat: Extending the Horizon of Learned 3DGS Optimization
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，解决传统优化器在3DGS中效率低、收敛慢的问题。提出一种元学习优化器，提升长期稳定性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2605.15760](https://arxiv.org/pdf/2605.15760)**
...
>
---
#### [new 033] LRCP: Low-Rank Compressibility Guided Visual Token Pruning for Efficient LVLMs
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型优化任务，旨在降低视觉token数量以提升效率。通过低秩压缩方法LRCP，有效减少冗余token，保持模型性能。**

- **链接: [https://arxiv.org/pdf/2605.15621](https://arxiv.org/pdf/2605.15621)**
...
>
---
#### [new 036] 3D Segmentation Using Viewpoint-Dependent Spatial Relationships
- **分类: cs.CV**

- **简介: 该论文属于3D场景理解任务，解决视角依赖空间关系识别问题。构建了包含220k样本的视角感知数据集，提升模型对“左/右”等空间指令的分割准确率。**

- **链接: [https://arxiv.org/pdf/2605.15708](https://arxiv.org/pdf/2605.15708)**
...
>
---
#### [new 037] RaPD: Resolution-Agnostic Pixel Diffusion via Semantics-Enriched Implicit Representations
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像生成任务，解决传统模型分辨率固定的问题。提出RaPD，在连续神经场潜空间进行扩散，实现分辨率无关的生成。**

- **链接: [https://arxiv.org/pdf/2605.15908](https://arxiv.org/pdf/2605.15908)**
...
>
---
#### [new 070] Pretraining Objective Matters in Extreme Low-Data FGVC: A Backbone-Controlled Study
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究极端低数据下的细粒度分类任务，探讨预训练目标对模型性能的影响。在固定主干网络情况下，比较不同预训练方法的效果，提出在数据稀缺时应优先选择增强边距的预训练目标。**
...
>
---
#### [new 071] DreamSR: Towards Ultra-High-Resolution Image Super-Resolution via a Receptive-Field Enhanced Diffusion Transformer
- **分类: cs.CV**

- **简介: 该论文属于图像超分辨率任务，旨在解决高分辨率图像生成中的过拟合与细节缺失问题。提出DreamSR模型，通过双分支结构和增强感受野策略，提升局部细节质量与全局一致性。**

- **链接: [https://arxiv.org/pdf/2605.15682](https://arxiv.org/pdf/2605.15682)**
...
>
---
#### [new 072] AnyAct: Towards Human Reenactment of Character Motion From Video
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出AnyAct，解决从非人类角色视频生成人类动作重演的任务。通过稀疏局部运动线索，实现高质量人类动作生成与控制。**
...
>
---
#### [new 093] VideoSeeker: Incentivizing Instance-level Video Understanding via Native Agentic Tool Invocation
- **分类: cs.CV; cs.AI; cs.HC**

- **简介: 该论文提出VideoSeeker，解决视频理解中实例级时空定位问题。通过视觉提示和代理推理，提升模型主动感知能力，实验显示性能显著提升。**

- **链接: [https://arxiv.org/pdf/2605.16079](https://arxiv.org/pdf/2605.16079)**
...
>
---
#### [new 094] Latent Video Prediction Learns Better World Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频建模任务，旨在评估自监督视频模型作为世界模型的鲁棒性。通过系统分析四个模型在五个鲁棒性维度上的表现，验证了潜在预测模型的优势。**

- **链接: [https://arxiv.org/pdf/2605.15618](https://arxiv.org/pdf/2605.15618)**
...
>
---
#### [new 095] ElasticDiT: Efficient Diffusion Transformers via Elastic Architecture and Sparse Attention for High-Resolution Image Generation on Mobile Devices
- **分类: cs.CV**

- **简介: 该论文属于高分辨率图像生成任务，旨在解决移动设备上模型效率与质量的平衡问题。提出ElasticDiT，通过弹性架构和稀疏注意力提升效率，同时保持图像质量。**

- **链接: [https://arxiv.org/pdf/2605.15684](https://arxiv.org/pdf/2605.15684)**
...
>
---
#### [new 099] Probabilistic Dating of Historical Manuscripts via Evidential Deep Regression on Visual Script Features
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于历史手稿年代测定任务，解决如何通过视觉特征精确预测手稿年代的问题。工作包括构建概率深度回归模型，输出预测分布并分解不确定性，提升精度与效率。**

- **链接: [https://arxiv.org/pdf/2605.06475](https://arxiv.org/pdf/2605.06475)**
...
>
---
#### [new 102] Hierarchical and Holistic Open-Vocabulary Functional 3D Scene Graphs for Indoor Spaces
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 107] Mask-Morph Graph U-Net: A Generalisable Mesh-Based Surrogate for Crashworthiness Field Prediction under Large Geometric Variation
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于 crashworthiness 领域的仿真预测任务，旨在解决传统有限元模拟计算成本高、难以用于设计优化的问题。通过提出 MMGUNet 模型，实现高效、可迁移的网格代理建模。**

- **链接: [https://arxiv.org/pdf/2605.15231](https://arxiv.org/pdf/2605.15231)**
...
>
---
#### [new 111] SkiP: When to Skip and When to Refine for Efficient Robot Manipulation
...
>
---
#### [new 112] PhysBrain 1.0 Technical Report
...
>
---
#### [new 122] Highly Detailed and Generalizable Broadleaf Tree Crown Instance Segmentation from UAV Imagery
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 论文提出一种用于无人机影像中阔叶树冠实例分割的深度学习模型，解决复杂阔叶林树冠分割难题。通过大量高质量标注数据训练，实现高精度且泛化能力强的树冠分割。**

- **链接: [https://arxiv.org/pdf/2605.15673](https://arxiv.org/pdf/2605.15673)**
...
>
---
#### [new 124] VCG-Bench: Towards A Unified Visual-Centric Benchmark for Structured Generation and Editing
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 125] WorldVLN: Autoregressive World Action Model for Aerial Vision-Language Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 002] HarmoGS: Robust 3D Gaussian Splatting in the Wild via Conflict-Aware Gradient Harmonization
- **分类: cs.CV**
...
>
---
#### [replaced 003] CG-MLLM: Captioning and Generating 3D content via Multi-modal Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.21798](https://arxiv.org/pdf/2601.21798)**

> **作者:** Junming Huang; Chi Wang; Letian Li; Guangkai Xu; Donglin Huang; Hao Chen; Qiang Dai; Weiwei Xu
>
> **备注:** ICML 2026
>
...
>
---
#### [replaced 004] SFHand: Learning Embodied Manipulation by Streaming Egocentric 3D Hand Forecasting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18127](https://arxiv.org/pdf/2511.18127)**
...
>
---
#### [replaced 007] Structured Analytic Coherent Point Drift for Non-Rigid Point Set Registration
- **分类: cs.LG; cs.CV; stat.ML**

- **链接: [https://arxiv.org/pdf/2605.00934](https://arxiv.org/pdf/2605.00934)**

> **作者:** Wei Feng; Haiyong Zheng
>
> **备注:** Revised version. Supplementary material incorporated as appendices; method, implementation, and experimental details expanded
>
...
>
---
#### [replaced 008] TSBOW -- Traffic Surveillance Benchmark for Occluded Vehicles Under Various Weather Conditions
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.05414](https://arxiv.org/pdf/2602.05414)**
...
>
---
#### [replaced 013] ART: Articulated Reconstruction Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.14671](https://arxiv.org/pdf/2512.14671)**
...
>
---
#### [replaced 014] PhyDetEx: Detecting and Explaining the Physical Plausibility of T2V Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01843](https://arxiv.org/pdf/2512.01843)**
...
>
---
#### [replaced 015] UniShield: An Adaptive Multi-Agent Framework for Unified Forgery Image Detection and Localization
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.03161](https://arxiv.org/pdf/2510.03161)**
...
>
---
#### [replaced 016] CoralLite: μCT Reconstruction of Coral Colonies from Individual Corallites
- **分类: cs.CV**
...
>
> **备注:** Published at Knowledge-Based Systems
>
...
>
---
#### [replaced 018] A Unified View of Score-Based and Drifting Models
- **分类: cs.LG; cs.AI; cs.CV**
...
>
---
#### [replaced 023] Skyra: AI-Generated Video Detection via Grounded Artifact Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.15693](https://arxiv.org/pdf/2512.15693)**

> **作者:** Yifei Li; Wenzhao Zheng; Yanran Zhang; Runze Sun; Yu Zheng; Lei Chen; Jie Zhou; Jiwen Lu
>
> **备注:** Camera Ready Version. Project Page: this https URL
>
...
>
---
#### [replaced 024] Hide to See: Reasoning-prefix Masking for Visual-anchored Thinking in VLM Distillation
...
>
---
#### [replaced 025] Chain-of-Glimpse: Search-Guided Progressive Object-Grounded Reasoning for Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.14692](https://arxiv.org/pdf/2604.14692)**
...
>
---
#### [replaced 026] Fill the GAP: A Granular Alignment Paradigm for Visual Reasoning in Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 029] ICED: Concept-level Machine Unlearning via Interpretable Concept Decomposition
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 030] BFORE: Butterfly-Firefly Optimized Retinex Enhancement for Low-Light Image Quality Improvement
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 034] VideoVerse: Does Your T2V Generator Have World Model Capability to Synthesize Videos?
- **分类: cs.CV**
...
>
---
#### [replaced 035] From Pairs to Sequences: Track-Aware Policy Gradients for Keypoint Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.20630](https://arxiv.org/pdf/2602.20630)**
...
>
---
#### [replaced 038] Hestia: Voxel-Face-Aware Hierarchical Next-Best-View Acquisition for Efficient 3D Reconstruction
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 043] SynthRender and IRIS: Open-Source Framework and Dataset for Bidirectional Sim-Real Transfer in Industrial Object Perception
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.21141](https://arxiv.org/pdf/2602.21141)**
...
>
---
#### [replaced 044] Self-Supervised Learning by Curvature Alignment
- **分类: cs.LG; cs.CV; stat.ML**

- **链接: [https://arxiv.org/pdf/2511.17426](https://arxiv.org/pdf/2511.17426)**

> **作者:** Benyamin Ghojogh; M.Hadi Sepanj; Paul Fieguth
>
> **备注:** A shorter version of this paper has been published in: Journal of Computational Vision and Imaging Systems, Vol. 11, No. 1, Special Issue: Proceedings of CVIS 2025
>
...
>
---
#### [replaced 045] RealRep: Generalized SDR-to-HDR Conversion via Attribute-Disentangled Representation Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.07322](https://arxiv.org/pdf/2505.07322)**
...
>
---
#### [replaced 055] AnchorRoute: Human Motion Synthesis with Interval-Routed Sparse Contro
- **分类: cs.GR; cs.CV; cs.LG**
...
>
---
#### [replaced 056] Rethinking Cross-Dose PET Denoising: Mitigating Averaging Effects via Residual Noise Learning
- **分类: cs.CV**
...
>
---
#### [replaced 057] VideoGameBench: Can Vision-Language Models complete popular video games?
...
>
---
#### [replaced 058] COCO-Inpaint: A Benchmark for Detecting and Localizing Inpainting-Based Image Manipulations
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2504.18361](https://arxiv.org/pdf/2504.18361)**

> **作者:** Haozhen Yan; Yan Hong; Jiahui Zhan; Suning Lang; Yikun Ji; Huijia Zhu; Jun Lan; Jianfu Zhang
>
...
>
---
#### [replaced 068] G$^2$TR: Generation-Guided Visual Token Reduction for Separate-Encoder Unified Multimodal Models
- **分类: cs.CV**
...
>
---
#### [replaced 069] Autoguided Online Data Curation for Diffusion Model Training
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.15267](https://arxiv.org/pdf/2509.15267)**
...
>
---
#### [replaced 070] DGS-Net: Distillation-Guided Gradient Surgery for CLIP Fine-Tuning in AI-Generated Image Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13108](https://arxiv.org/pdf/2511.13108)**
...
>
---
#### [replaced 071] Preprocessing Algorithm Leveraging Geometric Modeling for Scale Correction in Hyperspectral Images for Improved Unmixing Performance
- **分类: eess.IV; cs.CV; eess.SP**

- **链接: [https://arxiv.org/pdf/2508.08431](https://arxiv.org/pdf/2508.08431)**
...
>
---
#### [replaced 072] Decoupling Semantics and Fingerprints: A Universal Representation for AI-Generated Image Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.07074](https://arxiv.org/pdf/2605.07074)**

> **作者:** Zhiyuan Wang; Yanxiang Chen; Pengcheng Zhao; Yunfeng Diao; Xin Liao
>
...
>
---
#### [replaced 073] Grounded Reinforcement Learning for Visual Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.23678](https://arxiv.org/pdf/2505.23678)**
...
>
---
#### [replaced 074] Region-Grounded Report Generation for 3D Medical Imaging: A Fine-Grained Dataset and Graph-Enhanced Framework
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 075] Overlap-aware segmentation for topological reconstruction of obscured objects
- **分类: hep-ex; astro-ph.IM; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.06194](https://arxiv.org/pdf/2510.06194)**
...
>
---
#### [replaced 076] Unlocking Complex Visual Generation via Closed-Loop Verified Reasoning
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 077] CLOVER: Closed-Loop Value Estimation and Ranking for End-to-End Autonomous Driving Planning
- **分类: cs.RO; cs.AI; cs.CV**
