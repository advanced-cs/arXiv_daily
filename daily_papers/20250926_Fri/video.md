...
- **简介: 该论文提出WAVECLIP，一种基于小波分块的自适应分辨率CLIP模型。它通过多级小波分解替代传统分块嵌入，实现从粗到细的图像处理，并在推理时动态选择计算精度，提升效率。**
...
- **简介: 该论文属于计算机视觉与自然语言处理交叉任务，旨在解决CNN依赖表面特征的问题。提出利用视觉-语言模型自动生成语义注意力图，并通过辅助损失对齐模型注意力，提升决策的可靠性和认知合理性。**
...
- **简介: 该论文提出SD3.5-Flash，一种高效的少量步骤图像生成蒸馏框架，旨在解决生成模型在消费级设备上部署的计算瓶颈问题。通过分布引导蒸馏、时间步共享和优化量化等方法，实现了高质量且内存高效的图像生成。**
...
- **简介: 该论文研究跨视角地理定位任务，旨在解决因无人机视角变化导致的跨域泛化差和全局-局部特征不一致问题。提出EGS框架，采用E(2)-Steerable CNN提取鲁棒特征，并构建含虚拟超节点的图结构以增强全局-局部一致性，实验证明方法在多个基准上达到新性能高度。**
...
- **简介: 该论文属于图像质量评估与感知优化任务，旨在研究感知优化目标与IQA指标之间的不对称性。工作包括系统分析发现，用于IQA的高保真度指标不一定适合优化，且判别器设计对优化效果有重要影响。**
...
- **简介: 该论文针对视觉问答任务中多步推理能力不足的问题，提出SQ-InstructBLIP框架。通过生成图像感知的子问题和子答案，提升推理性能，解决了LLM无法利用细粒度视觉信息及黑盒机制难以复现的问题。**
...
- **简介: 该论文针对红外小目标检测任务，提出DENet方法，旨在解决目标易与背景融合、特征对齐难的问题。通过双路径结构，分别利用全局-局部注意力增强语义和多尺度边缘细节，提升检测精度与鲁棒性。**
...
- **简介: 该论文提出Decipher-MR，一种面向3D MRI的视觉-语言基础模型。针对MRI数据复杂且稀缺的问题，通过大规模自监督学习与报告引导文本监督，构建通用表征，支持多种临床任务，提升模型泛化性与适应性。**
...
- **简介: 该论文针对离线签名验证任务，尤其关注跨写作者的泛化问题。提出一种基于对称正定矩阵黎曼几何的准合成数据生成方法，通过黎曼高斯混合模型生成正负样本，减少对真实数据依赖，提升验证性能。**
...
- **简介: 该论文提出Neptune-X，针对海上目标检测任务中数据稀缺和泛化性差的问题。工作包括：构建多模态生成模型X-to-Maritime、设计双向对象-水注意模块，并引入属性相关主动采样方法，提升检测性能。**
...
- **简介: 该论文研究边缘设备模型部署中的数据高效训练问题，属于主动学习与知识蒸馏任务。针对边缘计算资源有限、需频繁更新模型的挑战，提出基于高置信度和多样性的流式数据选择策略，以减少传输成本并提升小模型质量。**
...
- **简介: 该论文提出KD-SS算法，用于植物点云的子采样，解决现有方法依赖特定物种或传感器、需降采样的问题。实现了高分辨率跨模态植物器官分割，适用于多种植物和传感器数据。**
...
- **简介: 该论文针对视频时序推理任务，解决现有模型推理过程与视频动态不一致的问题。提出MOSS-ChatV框架，采用基于DTW的过程奖励强化学习方法，结合自建标注数据集MOSS-Video，提升了多架构模型的推理一致性与稳定性。**
...
- **简介: 该论文研究联邦领域泛化（FDG）任务，旨在解决客户端领域偏移导致的模型适应性差的问题。提出FedDSPG方法，通过生成领域特定软提示（DSPs），提升模型在未知领域的泛化能力，实验表明其性能优于现有方法。**
...
- **简介: 该论文是一篇综述，旨在梳理手术场景图（SG）的研究进展。它系统分析了SG在手术中的应用、方法演进及面临的“数据鸿沟”问题，并探讨未来方向，强调SG在提升手术安全与智能化中的关键作用。**
...
- **简介: 该论文针对图像分割任务中数据划分导致的评估偏差问题，提出两种新方法：Iterative Pixel Stratification（IPS）和Wasserstein-Driven Evolutionary Stratification（WDES）。其中WDES通过遗传算法优化数据分布相似性，实验表明其在多种分割任务中能生成更具代表性的数据划分，提升模型评估的稳定性与准确性。**
...
- **简介: 该论文提出SlideMamba，结合Mamba和GNN用于数字病理学中的WSI表示学习。通过熵权重策略融合局部与全局信息，提升基因融合与突变预测性能，解决传统方法在空间依赖建模上的不足。**
...
- **简介: 该论文聚焦图像合成任务，旨在解决复杂光照和高分辨率下物体插入不真实的问题。提出SHINE框架，无需训练即可实现高质量、物理合理的图像合成，并构建新数据集ComplexCompo进行评估。**
...
- **简介: 该论文针对多模态推理模型在长链式推理数据不足和强化学习不稳定的问题，提出了方差感知采样方法，发布了大规模高质量数据集，并开源了模型与代码，提升了多模态推理性能。**
...
- **简介: 该论文针对视觉问答（VQA）任务，旨在解决模型因训练数据偏差导致的泛化能力不足问题。提出IOG-VQA模型，结合对象交互自注意力机制与GAN去偏框架，提升模型对视觉上下文的理解和鲁棒性，有效应对数据偏差问题。**
...
- **链接: [http://arxiv.org/pdf/2509.21008v1](http://arxiv.org/pdf/2509.21008v1)**
...
- **简介: 该论文研究视频大语言模型中的提示引导采样安全性问题，提出首个黑盒投毒攻击PoisonVID，通过优化通用扰动破坏采样机制，实验证明其在三种先进模型上攻击成功率高达82%-99%，强调需改进采样策略。**
...
- **链接: [http://arxiv.org/pdf/2509.20427v1](http://arxiv.org/pdf/2509.20427v1)**
...
- **简介: 该论文研究了量化对CLIP模型性能与可靠性的影响，任务涉及视觉-语言模型的高效部署。论文系统评估了量化在准确率之外的可靠性指标（如校准、OOD检测），发现量化可提升部分模型的可靠性，并提出量化感知训练方法以兼顾效率与性能。**
...
- **简介: 该论文提出Mammo-CLIP Dissect，一种用于分析乳腺X光视觉模型所学概念的可解释性框架。旨在揭示深度学习模型在临床任务中的概念学习机制，解决模型如何捕捉医学领域知识的问题，并通过对比不同训练方式对概念学习的影响，提供模型可解释性的新视角。**
...
- **简介: 该论文提出基于Prithvi-EO Vision Transformer的Sentinel-3基础模型，用于海洋颜色监测。任务是改进海洋生态数据处理，解决标签数据稀缺问题。通过预训练和微调，模型在叶绿素浓度估算和初级生产力评估中表现良好，展示了其在小样本和空间细节捕捉上的优势。**

- **链接: [http://arxiv.org/pdf/2509.21273v1](http://arxiv.org/pdf/2509.21273v1)**
...
>
---
#### [new 068] Region-of-Interest Augmentation for Mammography Classification under Patient-Level Cross-Validation
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对乳腺X光分类任务，旨在解决数据分辨率低和样本量小的问题。提出了一种轻量级的感兴趣区域（ROI）增强策略，在训练阶段通过随机裁剪ROI提升模型性能，无需额外标签或结构修改。**

- **链接: [http://arxiv.org/pdf/2509.20585v1](http://arxiv.org/pdf/2509.20585v1)**
...
>
---
#### [new 069] Recov-Vision: Linking Street View Imagery and Vision-Language Models for Post-Disaster Recovery
- **分类: cs.CV**

- **简介: 该论文提出FacadelTrack，结合街景影像与视觉-语言模型，解决灾后建筑占用状态评估问题。通过链接街景视频与地块，提取可解释属性，实现高精度、可审计的占用判断，提升灾后恢复效率与资源分配公平性。**

- **链接: [http://arxiv.org/pdf/2509.20628v1](http://arxiv.org/pdf/2509.20628v1)**
...
>
---
#### [new 074] InstructVTON: Optimal Auto-Masking and Natural-Language-Guided Interactive Style Control for Inpainting-Based Virtual Try-On
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出InstructVTON，一种基于图像修复的虚拟试衣系统。它通过自然语言指令和视觉语言模型实现自动掩码生成与风格控制，解决了传统掩码方法难以处理复杂穿衣场景的问题，提升了交互体验并兼容现有模型。**

- **链接: [http://arxiv.org/pdf/2509.20524v1](http://arxiv.org/pdf/2509.20524v1)**
...
>
---
#### [new 076] TABLET: A Large-Scale Dataset for Robust Visual Table Understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 077] Beyond the Individual: Introducing Group Intention Forecasting with SHOT Dataset
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出“群体意图预测”（GIF）任务，旨在通过分析个体行为和互动预测群体共同目标的形成。为此，构建了首个大规模篮球视频数据集SHOT，并设计了GIFT框架，用于建模群体动态并预测意图涌现。**

- **链接: [http://arxiv.org/pdf/2509.20715v1](http://arxiv.org/pdf/2509.20715v1)**
...
>
---
#### [new 078] Hunyuan3D-Omni: A Unified Framework for Controllable Generation of 3D Assets
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Hunyuan3D-Omni，一个统一的可控3D资产生成框架。针对现有方法缺乏细粒度跨模态控制的问题，它支持图像、点云、骨骼姿态等多种条件输入，提升生成精度与鲁棒性，适用于游戏、影视等生产场景。**

- **链接: [http://arxiv.org/pdf/2509.21245v1](http://arxiv.org/pdf/2509.21245v1)**
...
>
---
#### [new 079] The Unwinnable Arms Race of AI Image Detection
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究AI图像生成与检测之间的对抗，探讨在何种条件下检测器处于劣势。分析数据维度和复杂度的影响，发现中等复杂度数据最利于检测，而过于简单或复杂的数据降低检测效果。**

- **链接: [http://arxiv.org/pdf/2509.21135v1](http://arxiv.org/pdf/2509.21135v1)**
...
>
---
#### [new 080] Real-Time Object Detection Meets DINOv3
- **分类: cs.CV**

- **简介: 该论文针对实时目标检测任务，旨在提升性能与成本的平衡。作者将DINOv3特征引入DEIM框架，提出DEIMv2，覆盖多种模型规模，实现更优的检测精度与参数效率，在多个尺度上取得SOTA结果。**

- **链接: [http://arxiv.org/pdf/2509.20787v1](http://arxiv.org/pdf/2509.20787v1)**
...
>
---
#### [new 081] SCRA-VQA: Summarized Caption-Rerank for Augmented Large Language Models in Visual Question Answering
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对知识驱动的视觉问答（KB-VQA）任务，提出SCRA-VQA方法。为解决图像描述信息冗余及LLM理解不足的问题，利用预训练模型生成并优化图像描述，提升LLM对VQA任务的理解与推理能力，无需端到端训练。**

- **链接: [http://arxiv.org/pdf/2509.20871v1](http://arxiv.org/pdf/2509.20871v1)**
...
>
---
#### [new 089] Fast-SEnSeI: Lightweight Sensor-Independent Cloud Masking for On-board Multispectral Sensors
- **分类: cs.CV; cs.AI; cs.LG; cs.PF**

- **简介: 该论文提出Fast-SEnSeI，一种轻量、传感器无关的云分割编码模块，用于多光谱传感器的星上处理。旨在解决现有模型依赖特定传感器配置的问题，通过灵活输入光谱波段，结合CPU-FPGA混合架构，实现高效准确的云分割。**

- **链接: [http://arxiv.org/pdf/2509.20991v1](http://arxiv.org/pdf/2509.20991v1)**
...
>
---
#### [new 092] A Unified Framework for Diffusion Model Unlearning with f-Divergence
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出一种基于$f$-散度的统一框架，用于扩散模型的遗忘学习。针对现有文本到图像模型遗忘方法依赖MSE的问题，研究不同$f$-散度对收敛性和遗忘效果的影响，提供灵活选择策略以平衡遗忘强度与概念保留。**

- **链接: [http://arxiv.org/pdf/2509.21167v1](http://arxiv.org/pdf/2509.21167v1)**
...
>
---
#### [new 093] Visual Authority and the Rhetoric of Health Misinformation: A Multimodal Analysis of Social Media Videos
...
>
---
#### [new 094] FHRFormer: A Self-supervised Transformer Approach for Fetal Heart Rate Inpainting and Forecasting
- **分类: cs.LG; cs.AI; cs.CE; cs.CV**

- **简介: 该论文提出FHRFormer，一种自监督Transformer方法，用于胎儿心率（FHR）信号的缺失值填补与预测。针对FHR监测中因传感器位移导致的数据缺失问题，传统插值方法难以保留信号特征，本文通过捕捉空间和频率信息实现更鲁棒的信号重建，支持AI风险算法研究与应用。**

- **链接: [http://arxiv.org/pdf/2509.20852v1](http://arxiv.org/pdf/2509.20852v1)**
...
>
---
#### [new 095] MASt3R-Fusion: Integrating Feed-Forward Visual Model with IMU, GNSS for High-Functionality SLAM
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 096] ShortCheck: Checkworthiness Detection of Multilingual Short-Form Videos
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 097] Joint Flow Trajectory Optimization For Feasible Robot Motion Generation from Video Demonstrations
...
>
---
#### [new 098] CHARM: Control-point-based 3D Anime Hairstyle Auto-Regressive Modeling
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出CHARM，一种基于控制点的3D动漫发型生成框架。针对传统方法效率低、难编辑的问题，设计了高效参数化表示，并构建大规模数据集AnimeHair，结合自回归模型实现高质量发型生成与重建。**

- **链接: [http://arxiv.org/pdf/2509.21114v1](http://arxiv.org/pdf/2509.21114v1)**
...
>
---
#### [new 103] RadAgents: Multimodal Agentic Reasoning for Chest X-ray Interpretation with Radiologist-like Workflows
...
>
---
#### [new 104] Efficient Construction of Implicit Surface Models From a Single Image for Motion Generation
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 105] FERD: Fairness-Enhanced Data-Free Robustness Distillation
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出FERD框架，属于数据无关的鲁棒性蒸馏任务。旨在解决学生模型在不同类别间鲁棒性差异大的问题。通过调整对抗样本的比例和分布，提升整体鲁棒性和公平性，实验验证了其有效性。**

- **链接: [http://arxiv.org/pdf/2509.20793v1](http://arxiv.org/pdf/2509.20793v1)**
...
>
---
#### [new 106] Differential-Integral Neural Operator for Long-Term Turbulence Forecasting
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出一种用于长期湍流预测的微分-积分神经算子（DINO），旨在解决现有深度学习方法在长期预测中误差累积和物理保真度低的问题。通过分解局部微分与全局积分操作，DINO提升了预测稳定性与准确性。**

- **链接: [http://arxiv.org/pdf/2509.21196v1](http://arxiv.org/pdf/2509.21196v1)**
...
>
---
#### [new 107] SLAM-Free Visual Navigation with Hierarchical Vision-Language Perception and Coarse-to-Fine Semantic Topological Planning
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 110] VC-Agent: An Interactive Agent for Customized Video Dataset Collection
- **分类: cs.AI; cs.CV**

- **简介: 该论文提出VC-Agent，一个用于定制化视频数据集收集的交互式智能体。针对互联网视频数据收集耗时费力的问题，VC-Agent通过理解用户查询和反馈，结合多模态大模型与新颖过滤策略，实现高效、个性化的视频检索与扩展。**

- **链接: [http://arxiv.org/pdf/2509.21291v1](http://arxiv.org/pdf/2509.21291v1)**
...
>
---
#### [new 114] Human-like Navigation in a World Built for Humans
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 117] CaTS-Bench: Can Language Models Describe Numeric Time Series?
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出CaTS-Bench，一个面向时序描述任务的基准，旨在解决现有数据集过于简单、缺乏真实性和上下文的问题。工作包括构建大规模真实数据集、设计生成描述的流水线，并引入新的评估指标，推动时序分析与基础模型的结合研究。**

- **链接: [http://arxiv.org/pdf/2509.20823v1](http://arxiv.org/pdf/2509.20823v1)**
...
>
---
#### [new 118] Sparse Representations Improve Adversarial Robustness of Neural Network Classifiers
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究图像分类任务中神经网络对抗鲁棒性问题，提出使用稀疏主成分分析（SPCA）作为特征提取方法。通过理论分析与实验验证，证明SPCA能降低对抗扰动的影响，在保持精度的同时提升模型鲁棒性。**

- **链接: [http://arxiv.org/pdf/2509.21130v1](http://arxiv.org/pdf/2509.21130v1)**
...
>
---
#### [new 119] KeyWorld: Key Frame Reasoning Enables Effective and Efficient World Models
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 120] RAM-NAS: Resource-aware Multiobjective Neural Architecture Search Method for Robot Vision Tasks
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 121] SceneWeaver: All-in-One 3D Scene Synthesis with an Extensible and Self-Reflective Agent
...
>
---
#### [new 122] Optimal Transport Based Hyperspectral Unmixing for Highly Mixed Observations
- **分类: eess.IV; cs.CV; stat.AP**

- **简介: 该论文提出一种基于最优传输的高光谱解混方法，用于处理高度混合数据。通过将最优传输作为正则化项，约束丰度分布接近目标狄利克雷分布，提升了端元估计的准确性，并展示了其在无监督深度学习中的有效性。**

- **链接: [http://arxiv.org/pdf/2509.20417v1](http://arxiv.org/pdf/2509.20417v1)**
...
#### [replaced 001] TempSamp-R1: Effective Temporal Sampling with Reinforcement Fine-Tuning for Video LLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.18056v2](http://arxiv.org/pdf/2509.18056v2)**
...
>
---
#### [replaced 002] EC-Diffuser: Multi-Object Manipulation via Entity-Centric Behavior Generation
...
>
---
#### [replaced 003] NoHumansRequired: Autonomous High-Quality Image Editing Triplet Mining
...
>
---
#### [replaced 007] LadderMIL: Multiple Instance Learning with Coarse-to-Fine Self-Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.02707v4](http://arxiv.org/pdf/2502.02707v4)**

> **作者:** Shuyang Wu; Yifu Qiu; Ines P. Nearchou; Sandrine Prost; Jonathan A. Fallowfield; Hideki Ueno; Hitoshi Tsuda; David J. Harrison; Hakan Bilen; Timothy J. Kendall
>
...
>
---
#### [replaced 010] Why Settle for One? Text-to-ImageSet Generation and Evaluation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.23275v2](http://arxiv.org/pdf/2506.23275v2)**
...
>
---
#### [replaced 011] MMSI-Bench: A Benchmark for Multi-Image Spatial Intelligence
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 012] Buffer-free Class-Incremental Learning with Out-of-Distribution Detection
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23412v2](http://arxiv.org/pdf/2505.23412v2)**
...
>
---
#### [replaced 013] LazyDrag: Enabling Stable Drag-Based Editing on Multi-Modal Diffusion Transformers via Explicit Correspondence
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.12203v2](http://arxiv.org/pdf/2509.12203v2)**
...
>
---
#### [replaced 014] Radar-Guided Polynomial Fitting for Metric Depth Estimation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.17182v2](http://arxiv.org/pdf/2503.17182v2)**
...
>
---
#### [replaced 015] GVDepth: Zero-Shot Monocular Depth Estimation for Ground Vehicles based on Probabilistic Cue Fusion
...
>
---
#### [replaced 018] Autoregressive Image Generation with Randomized Parallel Decoding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.10568v2](http://arxiv.org/pdf/2503.10568v2)**
...
>
---
#### [replaced 019] OmniScene: Attention-Augmented Multimodal 4D Scene Understanding for Autonomous Driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.19973v2](http://arxiv.org/pdf/2509.19973v2)**
...
>
---
#### [replaced 020] Odo: Depth-Guided Diffusion for Identity-Preserving Body Reshaping
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.13065v3](http://arxiv.org/pdf/2508.13065v3)**
...
>
---
#### [replaced 021] 3D-MoRe: Unified Modal-Contextual Reasoning for Embodied Question Answering
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.12026v2](http://arxiv.org/pdf/2507.12026v2)**
...
>
---
#### [replaced 022] Failure Makes the Agent Stronger: Enhancing Accuracy through Structured Reflection for Reliable Tool Interactions
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 023] Implicit Neural Representations of Intramyocardial Motion and Strain
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.09004v4](http://arxiv.org/pdf/2509.09004v4)**
...
>
---
#### [replaced 024] On the Perception Bottleneck of VLMs for Chart Understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 025] VideoPASTA: 7K Preference Pairs That Matter for Video-LLM Alignment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.14096v3](http://arxiv.org/pdf/2504.14096v3)**
...
>
---
#### [replaced 026] CONSIGN: Conformal Segmentation Informed by Spatial Groupings via Decomposition
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.14113v2](http://arxiv.org/pdf/2505.14113v2)**
...
>
---
#### [replaced 027] D2-Mamba: Dual-Scale Fusion and Dual-Path Scanning with SSMs for Shadow Removal
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12750v3](http://arxiv.org/pdf/2508.12750v3)**
...
>
---
#### [replaced 030] HermesFlow: Seamlessly Closing the Gap in Multimodal Understanding and Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.12148v2](http://arxiv.org/pdf/2502.12148v2)**
...
>
> **摘要:** The remarkable success of the autoregressive paradigm has made significant advancement in Multimodal Large Language Models (MLLMs), with powerful models like Show-o, Transfusion and Emu3 achieving notable progress in unified image understanding and generation. For the first time, we uncover a common phenomenon: the understanding capabilities of MLLMs are typically stronger than their generative capabilities, with a significant gap between the two. Building on this insight, we propose HermesFlow, a simple yet general framework designed to seamlessly bridge the gap between understanding and generation in MLLMs. Specifically, we take the homologous data as input to curate homologous preference data of both understanding and generation. Through Pair-DPO and self-play iterative optimization, HermesFlow effectively aligns multimodal understanding and generation using homologous preference data. Extensive experiments demonstrate the significant superiority of our approach over prior methods, particularly in narrowing the gap between multimodal understanding and generation. These findings highlight the potential of HermesFlow as a general alignment framework for next-generation multimodal foundation models. Code: https://github.com/Gen-Verse/HermesFlow
>
---
#### [replaced 031] RIS-LAD: A Benchmark and Model for Referring Low-Altitude Drone Image Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.20920v2](http://arxiv.org/pdf/2507.20920v2)**
...
>
---
#### [replaced 032] Cross-Cancer Knowledge Transfer in WSI-based Prognosis Prediction
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.13482v2](http://arxiv.org/pdf/2508.13482v2)**

> **作者:** Pei Liu; Luping Ji; Jiaxiang Gou; Xiangxiang Zeng
>
> **备注:** 20 pages (11 figures and 6 tables)
>
...
>
---
#### [replaced 033] MMaDA: Multimodal Large Diffusion Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.15809v2](http://arxiv.org/pdf/2505.15809v2)**
...
>
---
#### [replaced 038] Multimodal Deep Learning for Phyllodes Tumor Classification from Ultrasound and Clinical Data
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.00213v2](http://arxiv.org/pdf/2509.00213v2)**
...
>
---
#### [replaced 039] Semantic-Aware Reconstruction Error for Detecting AI-Generated Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09487v2](http://arxiv.org/pdf/2508.09487v2)**
...
>
---
#### [replaced 043] HazeFlow: Revisit Haze Physical Model as ODE and Non-Homogeneous Haze Generation for Real-World Dehazing
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.18190v2](http://arxiv.org/pdf/2509.18190v2)**
...
>
---
#### [replaced 044] Predictive Coding-based Deep Neural Network Fine-tuning for Computationally Efficient Domain Adaptation
- **分类: cs.LG; cs.CV; cs.NE**

- **链接: [http://arxiv.org/pdf/2509.20269v2](http://arxiv.org/pdf/2509.20269v2)**
...
>
---
#### [replaced 047] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2503.06677v4](http://arxiv.org/pdf/2503.06677v4)**
...
>
---
#### [replaced 048] Interpreting ResNet-based CLIP via Neuron-Attention Decomposition
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.19943v2](http://arxiv.org/pdf/2509.19943v2)**
...
>
---
#### [replaced 051] Instance-aware Image Colorization with Controllable Textual Descriptions and Segmentation Masks
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.08705v2](http://arxiv.org/pdf/2505.08705v2)**

> **作者:** Yanru An; Ling Gui; Chunlei Cai; Tianxiao Ye; JIangchao Yao; Guangtao Zhai; Qiang Hu; Xiaoyun Zhang
>
...
>
---
#### [replaced 052] Diff-Reg v2: Diffusion-Based Matching Matrix Estimation for Image Matching and 3D Registration
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.04127v3](http://arxiv.org/pdf/2503.04127v3)**

> **作者:** Qianliang Wu; Haobo Jiang; Yaqing Ding; Lei Luo; Jun Li; Jin Xie; Xiaojun Wu; Jian Yang
>
...
>
---
#### [replaced 053] Neurodynamics-Driven Coupled Neural P Systems for Multi-Focus Image Fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.17704v2](http://arxiv.org/pdf/2509.17704v2)**
...
>
---
#### [replaced 056] MME-VideoOCR: Evaluating OCR-Based Capabilities of Multimodal LLMs in Video Scenarios
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.21333v2](http://arxiv.org/pdf/2505.21333v2)**
...
>
---
#### [replaced 057] DermINO: Hybrid Pretraining for a Versatile Dermatology Foundation Model
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12190v2](http://arxiv.org/pdf/2508.12190v2)**
...
>
---
#### [replaced 058] Robust Pan-Cancer Mitotic Figure Detection with YOLOv12
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.02593v2](http://arxiv.org/pdf/2509.02593v2)**
...
>
---
#### [replaced 062] CNS-Bench: Benchmarking Image Classifier Robustness Under Continuous Nuisance Shifts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.17651v2](http://arxiv.org/pdf/2507.17651v2)**
...
>
---
#### [replaced 063] Online Language Splatting
- **分类: cs.AI; cs.CV; cs.RO**
...
>
---
#### [replaced 064] AdaSVD: Adaptive Singular Value Decomposition for Large Language Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 065] Model Agnostic Defense against Adversarial Patch Attacks on Object Detection in Unmanned Aerial Vehicles
...
>
---
#### [replaced 066] MonSter++: Unified Stereo Matching, Multi-view Stereo, and Real-time Stereo with Monodepth Priors
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.08643v2](http://arxiv.org/pdf/2501.08643v2)**
...
>
---
#### [replaced 068] HUNT: High-Speed UAV Navigation and Tracking in Unstructured Environments via Instantaneous Relative Frames
...
>
---
#### [replaced 075] CLIPin: A Non-contrastive Plug-in to CLIP for Multimodal Semantic Alignment
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.06434v2](http://arxiv.org/pdf/2508.06434v2)**
