...
>
---
#### [new 005] GaussianImage++: Boosted Image Representation and Compression with 2D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属图像表示与压缩任务，旨在解决2D高斯泼溅（GS）方法需过多高斯原语以保真、而隐式神经表示（INRs）训练开销大的问题。提出GaussianImage++：引入失真驱动稠密化、上下文感知高斯滤波、属性分离可学习量化，用更少原语实现高效表示与压缩。**

- **链接: [https://arxiv.org/pdf/2512.19108v1](https://arxiv.org/pdf/2512.19108v1)**
...
>
---
#### [new 024] Spectral Discrepancy and Cross-modal Semantic Consistency Learning for Object Detection in Hyperspectral Image
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向高光谱图像目标检测任务，旨在解决因波段间不一致、噪声和光照干扰导致的类内/类间相似性难题。提出SDCM网络：通过语义一致性学习模块增强波段间特征一致性，光谱门控生成器筛选重要波段，并设计光谱差异感知模块提取像素级光谱特征。**

- **链接: [https://arxiv.org/pdf/2512.18245v1](https://arxiv.org/pdf/2512.18245v1)**
...
>
---
#### [new 029] YolovN-CBi: A Lightweight and Efficient Architecture for Real-Time Detection of Small UAVs
- **分类: cs.CV**

- **简介: 该论文面向小无人机实时检测任务，解决其因尺寸小、速度快、对比度低导致的检测难问题。提出轻量高效模型YolovN-CBi，融合CBAM与BiFPN提升小目标敏感性，并通过知识蒸馏获得更优轻量化模型。**

- **链接: [https://arxiv.org/pdf/2512.18046v1](https://arxiv.org/pdf/2512.18046v1)**
...
>
---
#### [new 030] Efficient Spike-driven Transformer for High-performance Drone-View Geo-Localization
- **分类: cs.CV**

- **简介: 该论文面向无人机视角地理定位（DVGL）任务，旨在解决SNN在该任务中信息丢失与长程依赖建模难的问题。提出首个SNN框架SpikeViMFormer，含轻量脉冲Transformer主干、脉冲选择性注意力（SSA）和脉冲混合状态空间（SHS）模块，并设计HRAL策略优化主干。**

- **链接: [https://arxiv.org/pdf/2512.19365v1](https://arxiv.org/pdf/2512.19365v1)**
...
>
---
#### [new 031] Watch Closely: Mitigating Object Hallucinations in Large Vision-Language Models with Disentangled Decoding
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 032] Building UI/UX Dataset for Dark Pattern Detection and YOLOv12x-based Real-Time Object Recognition Detection System
- **分类: cs.CV**

- **简介: 该论文属计算机视觉任务，旨在解决UI中暗黑模式（误导性设计）的实时检测问题。工作包括：构建含4066张截图、5类标注的公开数据集；提出基于YOLOv12x的实时检测模型，达92.8% mAP@50与40.5 FPS。**

- **链接: [https://arxiv.org/pdf/2512.18269v1](https://arxiv.org/pdf/2512.18269v1)**
...
>
---
#### [new 046] HippMetric: A skeletal-representation-based framework for cross-sectional and longitudinal hippocampal substructural morphometry
- **分类: cs.CV**

- **简介: 该论文提出HippMetric框架，属医学图像分析任务，旨在解决海马亚结构跨被试与纵向形态测量中因解剖变异大、折叠复杂导致的对应关系不稳定问题。它基于骨骼表征（s-rep），构建解剖对齐的可变形坐标系，并生成几何约束的个体化s-rep，提升形态量化精度与一致性。**

- **链接: [https://arxiv.org/pdf/2512.19214v1](https://arxiv.org/pdf/2512.19214v1)**
...
>
---
#### [new 053] Context-Aware Network Based on Multi-scale Spatio-temporal Attention for Action Recognition in Videos
- **分类: cs.CV**

- **简介: 该论文面向视频动作识别任务，旨在解决现有方法忽视动作多粒度特性的问题。提出上下文感知网络（CAN），含多尺度时序线索模块（MTCM）和分组空间线索模块（GSCM），联合建模多尺度时空特征，在多个基准数据集上取得优异性能。**

- **链接: [https://arxiv.org/pdf/2512.18750v1](https://arxiv.org/pdf/2512.18750v1)**
...
>
---
#### [new 066] Plasticine: A Traceable Diffusion Model for Medical Image Translation
- **分类: cs.CV**

- **简介: 该论文提出Plasticine，一种面向医学图像翻译的可追溯扩散模型。任务是跨设备/人群域的图像翻译；解决现有方法忽略像素级空间对应、缺乏临床可解释性的问题；通过融合强度映射与空间形变的端到端扩散框架，实现可追溯的合成。**

- **链接: [https://arxiv.org/pdf/2512.18455v1](https://arxiv.org/pdf/2512.18455v1)**
...
>
---
#### [new 069] Auditing Significance, Metric Choice, and Demographic Fairness in Medical AI Challenges
- **分类: cs.CV; cs.LG**

- **简介: 该论文属医学AI评估任务，旨在解决医疗AI挑战赛排行榜的三大问题：缺乏统计显著性检验、单一指标掩盖临床边界误差、忽视交叉人口统计公平性。作者提出开源工具RankInsight，支持显著性检验、器官适配指标重排序及交叉公平性审计。**

- **链接: [https://arxiv.org/pdf/2512.19091v1](https://arxiv.org/pdf/2512.19091v1)**
...
>
---
#### [new 080] Beyond CLIP: Knowledge-Enhanced Multimodal Transformers for Cross-Modal Alignment in Diabetic Retinopathy Diagnosis
- **分类: cs.CV; cs.AI**

- **简介: 该论文面向糖尿病视网膜病变（DR）诊断任务，解决通用CLIP模型在医学跨模态对齐（图像-文本检索与分级）中性能差的问题。提出知识增强的多模态Transformer框架，融合眼底图像、临床文本和结构化数据，联合优化对比、重建与分类损失，在检索与分级上均显著超越基线。**

- **链接: [https://arxiv.org/pdf/2512.19663v1](https://arxiv.org/pdf/2512.19663v1)**
...
>
---
#### [new 081] Interact2Ar: Full-Body Human-Human Interaction Generation via Autoregressive Diffusion Models
- **分类: cs.CV**

- **简介: 该论文属人机交互生成任务，旨在解决现有方法忽略手部动作、难以建模交互实时性与适应性的问题。提出首个端到端文本驱动的自回归扩散模型Interact2Ar，引入手部专用分支与记忆增强的自回归机制，支持全身体交互生成及多场景扩展。**

- **链接: [https://arxiv.org/pdf/2512.19692v1](https://arxiv.org/pdf/2512.19692v1)**

> **作者:** Pablo Ruiz-Ponce; Sergio Escalera; José García-Rodríguez; Jiankang Deng; Rolandos Alexandros Potamias
>
> **备注:** Project Page: https://pabloruizponce.com/papers/Interact2Ar
>
...
>
---
#### [new 082] AMap: Distilling Future Priors for Ahead-Aware Online HD Map Construction
- **分类: cs.CV**

- **简介: 该论文面向在线高精地图构建任务，解决现有方法“空间向后看”导致前向区域建图不准、威胁行车安全的问题。提出AMap框架，通过“未来知识蒸馏”将未来时序信息压缩至单帧学生模型，实现零开销前向感知增强。**

- **链接: [https://arxiv.org/pdf/2512.19150v1](https://arxiv.org/pdf/2512.19150v1)**
...
>
> **摘要:** Online High-Definition (HD) map construction is pivotal for autonomous driving. While recent approaches leverage historical temporal fusion to improve performance, we identify a critical safety flaw in this paradigm: it is inherently ``spatially backward-looking." These methods predominantly enhance map reconstruction in traversed areas, offering minimal improvement for the unseen road ahead. Crucially, our analysis of downstream planning tasks reveals a severe asymmetry: while rearward perception errors are often tolerable, inaccuracies in the forward region directly precipitate hazardous driving maneuvers. To bridge this safety gap, we propose AMap, a novel framework for Ahead-aware online HD Mapping. We pioneer a ``distill-from-future" paradigm, where a teacher model with privileged access to future temporal contexts guides a lightweight student model restricted to the current frame. This process implicitly compresses prospective knowledge into the student model, endowing it with ``look-ahead" capabilities at zero inference-time cost. Technically, we introduce a Multi-Level BEV Distillation strategy with spatial masking and an Asymmetric Query Adaptation module to effectively transfer future-aware representations to the student's static queries. Extensive experiments on the nuScenes and Argoverse 2 benchmark demonstrate that AMap significantly enhances current-frame perception. Most notably, it outperforms state-of-the-art temporal models in critical forward regions while maintaining the efficiency of single current frame inference.
>
---
#### [new 083] Efficient Zero-Shot Inpainting with Decoupled Diffusion Guidance
- **分类: cs.CV; cs.LG**

- **简介: 该论文聚焦零样本图像修复任务，旨在解决现有方法需反向传播计算梯度导致的高内存与运行开销问题。提出解耦扩散引导新策略，设计高效高斯后验转移，避免对去噪器求导，显著降低推理成本，同时保持高质量重建与观测一致性。**

- **链接: [https://arxiv.org/pdf/2512.18365v1](https://arxiv.org/pdf/2512.18365v1)**
...
>
---
#### [new 084] EcoSplat: Efficiency-controllable Feed-forward 3D Gaussian Splatting from Multi-view Images
- **分类: cs.CV**

- **简介: 该论文属3D场景重建任务，旨在解决现有前馈式3D高斯泼溅方法无法控制输出高斯元数量、易在多视角下产生冗余的问题。提出EcoSplat框架，通过两阶段训练（像素对齐训练+重要性感知微调），实现推理时按需指定高斯元数量的高效可控重建。**

- **链接: [https://arxiv.org/pdf/2512.18692v1](https://arxiv.org/pdf/2512.18692v1)**
...
>
---
#### [new 087] Pyramidal Adaptive Cross-Gating for Multimodal Detection
- **分类: cs.CV**

- **简介: 该论文面向多模态航拍图像目标检测任务，旨在解决现有方法因简单特征融合导致的跨模态噪声干扰与特征金字塔结构破坏问题。提出PACGNet网络，设计对称交叉门控（SCG）和金字塔特征感知门控（PFMG）模块，实现骨干网内深度、层次化、自适应的多模态特征融合。**

- **链接: [https://arxiv.org/pdf/2512.18291v1](https://arxiv.org/pdf/2512.18291v1)**
...
>
---
#### [new 090] MACE-Dance: Motion-Appearance Cascaded Experts for Music-Driven Dance Video Generation
- **分类: cs.CV**

- **简介: 该论文面向音乐驱动的舞蹈视频生成任务，旨在解决现有方法难以兼顾高质量视觉外观与真实人体运动的问题。提出MACE-Dance框架：Motion Expert用BiMamba-Transformer扩散模型生成合理3D舞蹈动作；Appearance Expert基于运动与参考图像合成连贯视频。构建新数据集与评估协议，实现SOTA性能。**

- **链接: [https://arxiv.org/pdf/2512.18181v1](https://arxiv.org/pdf/2512.18181v1)**
...
>
---
#### [new 115] Atlas is Your Perfect Context: One-Shot Customization for Generalizable Foundational Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文面向医学图像分割任务，解决现有交互式基础模型在罕见临床场景下提示依赖强、泛化差的问题。提出AtlasSegFM框架，通过单样本配准生成上下文感知提示，并融合配准与模型预测，实现轻量、即插即用的一次性定制。**

- **链接: [https://arxiv.org/pdf/2512.18176v1](https://arxiv.org/pdf/2512.18176v1)**
...
>
> **摘要:** Despite remarkable progress in Vision-Language Navigation (VLN), existing benchmarks remain confined to fixed, small-scale datasets with naive physical simulation. These shortcomings limit the insight that the benchmarks provide into sim-to-real generalization, and create a significant research gap. Furthermore, task fragmentation prevents unified/shared progress in the area, while limited data scales fail to meet the demands of modern LLM-based pretraining. To overcome these limitations, we introduce VLNVerse: a new large-scale, extensible benchmark designed for Versatile, Embodied, Realistic Simulation, and Evaluation. VLNVerse redefines VLN as a scalable, full-stack embodied AI problem. Its Versatile nature unifies previously fragmented tasks into a single framework and provides an extensible toolkit for researchers. Its Embodied design moves beyond intangible and teleporting "ghost" agents that support full-kinematics in a Realistic Simulation powered by a robust physics engine. We leverage the scale and diversity of VLNVerse to conduct a comprehensive Evaluation of existing methods, from classic models to MLLM-based agents. We also propose a novel unified multi-task model capable of addressing all tasks within the benchmark. VLNVerse aims to narrow the gap between simulated navigation and real-world generalization, providing the community with a vital tool to boost research towards scalable, general-purpose embodied locomotion agents.
>
---
#### [new 119] Decoupled Generative Modeling for Human-Object Interaction Synthesis
- **分类: cs.CV**

- **简介: 该论文属3D人-物交互（HOI）合成任务，旨在解决现有方法依赖人工路点、人与物运动不同步及穿透等问题。提出DecHOI框架，解耦路径规划（轨迹生成器）与动作合成（动作生成器），引入关节动力学判别器提升接触真实感，并支持动态场景下的长序列响应式规划。**

- **链接: [https://arxiv.org/pdf/2512.19049v1](https://arxiv.org/pdf/2512.19049v1)**
...
>
> **摘要:** Recently, the introduction of Chain-of-Thought (CoT) has largely improved the generation ability of unified models. However, it is observed that the current thinking process during generation mainly focuses on the text consistency with the text prompt, ignoring the \textbf{visual context consistency} with the visual reference images during the multi-modal generation, e.g., multi-reference generation. The lack of such consistency results in the failure in maintaining key visual features (like human ID, object attribute, style). To this end, we integrate the visual context consistency into the reasoning of unified models, explicitly motivating the model to sustain such consistency by 1) Adaptive Visual Planning: generating structured visual check list to figure out the visual element of needed consistency keeping, and 2) Iterative Visual Correction: performing self-reflection with the guidance of check lists and refining the generated result in an iterative manner. To achieve this, we use supervised finetuning to teach the model how to plan the visual checking, conduct self-reflection and self-refinement, and use flow-GRPO to further enhance the visual consistency through a customized visual checking reward. The experiments show that our method outperforms both zero-shot unified models and those with text CoTs in multi-modal generation, demonstrating higher visual context consistency.
>
---
#### [new 137] Commercial Vehicle Braking Optimization: A Robust SIFT-Trajectory Approach
- **分类: cs.CV; cs.GR**

- **简介: 该论文属智能驾驶感知任务，旨在解决商用货车AEB系统低速下因CAN信号不准导致的“零速误刹”问题。提出基于SIFT轨迹分析的视觉方案，融合CLAHE增强、KNN-RANSAC匹配、多帧位移统计与双阈值决策，实现运动状态精准分类，显著降低误刹率。**

- **链接: [https://arxiv.org/pdf/2512.18597v1](https://arxiv.org/pdf/2512.18597v1)**
...
>
---
#### [new 138] PEDESTRIAN: An Egocentric Vision Dataset for Obstacle Detection on Pavements
- **分类: cs.CV; cs.LG**

- **简介: 该论文面向行人安全，解决城市人行道障碍物实时检测问题。提出PEDESTRIAN数据集，含340段手机拍摄的 egocentric 视频，覆盖29类常见障碍物，并基于该数据集评估多种SOTA深度学习模型，为障碍物检测提供基准。**

- **链接: [https://arxiv.org/pdf/2512.19190v1](https://arxiv.org/pdf/2512.19190v1)**
...
>
---
#### [new 140] Seeing Beyond the Scene: Analyzing and Mitigating Background Bias in Action Recognition
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究动作识别中的背景偏置问题，即模型依赖背景而非人体动作进行预测。作者系统分析了分类模型、对比学习模型和视频大语言模型的背景偏置现象，提出基于人体分割的输入改进和Prompt调优方法，显著降低背景依赖。**

- **链接: [https://arxiv.org/pdf/2512.17953v1](https://arxiv.org/pdf/2512.17953v1)**
...
>
---
#### [new 143] Neural Implicit Heart Coordinates: 3D cardiac shape reconstruction from sparse segmentations
- **分类: cs.CV; eess.IV**

- **简介: 该论文提出神经隐式心脏坐标（NIHCs），解决稀疏2D分割下患者特异性3D心脏形状重建难题。通过学习标准化解剖坐标系，直接从少量临床分割预测稠密3D分割与高分辨率网格，提升精度、鲁棒性与推理速度。**

- **链接: [https://arxiv.org/pdf/2512.19316v1](https://arxiv.org/pdf/2512.19316v1)**
...
>
---
#### [new 144] Steering Vision-Language Pre-trained Models for Incremental Face Presentation Attack Detection
- **分类: cs.CV**

- **简介: 该论文面向增量式活体检测（PAD）任务，解决隐私约束下无回放数据的持续学习问题。提出SVLP-IL框架，结合多视角提示（MAP）与选择性弹性权重巩固（SEWC），在不存储旧数据前提下缓解灾难性遗忘，提升跨域泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.19022v1](https://arxiv.org/pdf/2512.19022v1)**
...
>
> **摘要:** While Multimodal Large Language Models (MLLMs) have achieved impressive performance on semantic tasks, their spatial intelligence--crucial for robust and grounded AI systems--remains underdeveloped. Existing benchmarks fall short of diagnosing this limitation: they either focus on overly simplified qualitative reasoning or rely on domain-specific indoor data, constrained by the lack of outdoor datasets with verifiable metric ground truth. To bridge this gap, we introduce a large-scale benchmark built from pedestrian-perspective videos captured with synchronized stereo cameras, LiDAR, and IMU/GPS sensors. This dataset provides metrically precise 3D information, enabling the automatic generation of spatial reasoning questions that span a hierarchical spectrum--from qualitative relational reasoning to quantitative metric and kinematic understanding. Evaluations reveal that the performance gains observed in structured indoor benchmarks vanish in open-world settings. Further analysis using synthetic abnormal scenes and blinding tests confirms that current MLLMs depend heavily on linguistic priors instead of grounded visual reasoning. Our benchmark thus provides a principled platform for diagnosing these limitations and advancing physically grounded spatial intelligence.
>
---
#### [new 154] $M^3-Verse$: A "Spot the Difference" Challenge for Large Multimodal Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出$M^3$-Verse基准，面向“找不同”任务，旨在评估大模型对同一空间内两段视频间物体状态变化的动态理解能力。它构建270个室内场景的前后视频对与2932道多维度问题，评测16种LMMs，并提出新基线方法提升多状态感知性能。**

- **链接: [https://arxiv.org/pdf/2512.18735v1](https://arxiv.org/pdf/2512.18735v1)**
...
>
---
#### [new 155] Emotion-Director: Bridging Affective Shortcut in Emotion-Oriented Image Generation
- **分类: cs.CV**

- **简介: 该论文属情感导向图像生成任务，旨在解决现有方法将情绪简单等同于语义的“情感捷径”问题。提出Emotion-Director框架：含MC-Diffusion（融合图文提示+负视觉提示优化）和MC-Agent（多智能体链式概念重写文本提示），提升情绪表达准确性与视觉表现力。**

- **链接: [https://arxiv.org/pdf/2512.19479v1](https://arxiv.org/pdf/2512.19479v1)**
...
>
---
#### [new 162] BabyFlow: 3D modeling of realistic and expressive infant faces
- **分类: cs.CV; cs.AI**

- **简介: 该论文属3D人脸生成任务，旨在解决婴儿面部建模难（数据少、表情多变）问题。提出BabyFlow模型，用归一化流解耦身份与表情，结合跨年龄表情迁移扩充数据，并融合扩散模型生成高保真2D图像与一致3D几何。**

- **链接: [https://arxiv.org/pdf/2512.19560v1](https://arxiv.org/pdf/2512.19560v1)**
...
>
---
#### [new 167] UniMPR: A Unified Framework for Multimodal Place Recognition with Arbitrary Sensor Configurations
- **分类: cs.CV**

- **简介: 该论文面向多模态地点识别任务，旨在解决现有方法难以适配任意传感器组合、模态缺失鲁棒性差及跨配置泛化弱的问题。提出UniMPR统一框架：将多模态数据映射至极坐标BEV空间，通过多分支网络处理任意模态组合，并采用多数据集预训练与自适应标签策略提升泛化与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.18279v1](https://arxiv.org/pdf/2512.18279v1)**
...
>
---
#### [new 168] A 96pJ/Frame/Pixel and 61pJ/Event Anti-UAV System with Hybrid Object Tracking Modes
- **分类: cs.CV**

- **简介: 该论文提出一种低功耗反无人机系统，解决小目标、高速无人机的实时可靠检测问题。通过融合帧式与事件驱动跟踪、自适应模式切换、零跳过MAC神经计算等技术，在40nm工艺下实现96pJ/帧/像素和61pJ/事件的能效，达98.2%识别精度。**

- **链接: [https://arxiv.org/pdf/2512.17939v1](https://arxiv.org/pdf/2512.17939v1)**
...
>
---
#### [new 190] Layout-Aware Text Editing for Efficient Transformation of Academic PDFs to Markdown
...
>
---
#### [new 191] Offline Reinforcement Learning for End-to-End Autonomous Driving
- **分类: cs.RO; cs.CV**

- **简介: 该论文研究端到端自动驾驶任务，旨在解决模仿学习导致的泛化差与安全问题。提出纯视觉、离线强化学习框架，利用专家轨迹构建伪真值作为行为正则化信号，抑制OOD动作过估计，在神经渲染仿真中显著降低碰撞率并提升路径完成率。**

- **链接: [https://arxiv.org/pdf/2512.18662v1](https://arxiv.org/pdf/2512.18662v1)**
...
>
---
#### [new 192] Agent-Based Output Drift Detection for Breast Cancer Response Prediction in a Multisite Clinical Decision Support System
- **分类: cs.AI; cs.CV; cs.MA**

- **简介: 该论文属医疗AI模型监控任务，旨在解决多中心临床决策系统中因数据分布漂移导致的性能下降问题。提出基于智能体的输出漂移检测框架，为各站点部署独立监测代理，比较模型输出与不同参考分布，实验证明其显著优于集中式监控。**

- **链接: [https://arxiv.org/pdf/2512.18450v1](https://arxiv.org/pdf/2512.18450v1)**
...
>
---
#### [new 194] Robotic VLA Benefits from Joint Learning with Motion Image Diffusion
- **分类: cs.RO; cs.CV**

- **简介: 该论文面向机器人视觉-语言-动作（VLA）任务，旨在提升VLA模型的运动推理能力。针对其依赖模仿、缺乏动态预测的问题，提出联合运动图像扩散学习：在VLA架构中增设基于DiT的运动头，预测光流运动图像，并与动作头联合训练，增强时序与物理一致性，不增推理延迟。**

- **链接: [https://arxiv.org/pdf/2512.18007v1](https://arxiv.org/pdf/2512.18007v1)**
...
>
---
#### [new 199] ESearch-R1: Learning Cost-Aware MLLM Agents for Interactive Embodied Search via Reinforcement Learning
- **分类: cs.AI; cs.CV**

- **简介: 该论文面向具身搜索任务，解决模糊指令下代理难以权衡物理探索与人类交互成本的问题。提出ESearch-R1框架，融合问答、记忆检索与导航，并设计HC-GRPO算法，通过分组策略优化实现异构成本（如时间、注意力）与信息增益的联合最小化。**

- **链接: [https://arxiv.org/pdf/2512.18571v1](https://arxiv.org/pdf/2512.18571v1)**
...
>
---
#### [new 201] LoGoPlanner: Localization Grounded Navigation Policy with Metric-aware Visual Geometry
- **分类: cs.RO; cs.CV**

- **简介: 论文提出LoGoPlanner，面向移动机器人在非结构化环境中的端到端导航任务，解决传统模块化方法误差累积与现有端到端方法依赖外部定位、泛化性差的问题。通过度量感知视觉几何骨干、历史场景几何重建与隐式几何引导策略，实现高精度、强泛化的定位-感知-规划一体化。**

- **链接: [https://arxiv.org/pdf/2512.19629v1](https://arxiv.org/pdf/2512.19629v1)**
...
>
---
#### [replaced 003] InterPose: Learning to Generate Human-Object Interactions from Large-Scale Web Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.00767v2](https://arxiv.org/pdf/2509.00767v2)**
...
>
---
#### [replaced 004] ConceptPose: Training-Free Zero-Shot Object Pose Estimation using Concept Vectors
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09056v2](https://arxiv.org/pdf/2512.09056v2)**
...
>
---
#### [replaced 005] TAG-WM: Tamper-Aware Generative Image Watermarking via Diffusion Inversion Sensitivity
- **分类: cs.MM; cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2506.23484v4](https://arxiv.org/pdf/2506.23484v4)**
...
>
---
#### [replaced 013] AIDOVECL: AI-generated Dataset of Outpainted Vehicles for Eye-level Classification and Localization
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2410.24116v2](https://arxiv.org/pdf/2410.24116v2)**

> **作者:** Amir Kazemi; Qurat ul ain Fatima; Volodymyr Kindratenko; Christopher Tessum
>
> **备注:** 34 pages, 10 figures, 5 tables
>
...
>
---
#### [replaced 014] Implementation of neural network operators with applications to remote sensing data
- **分类: math.NA; cs.CV**

- **链接: [https://arxiv.org/pdf/2412.00375v2](https://arxiv.org/pdf/2412.00375v2)**
...
>
---
#### [replaced 015] Learnable Sparsity for Vision Generative Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.02852v2](https://arxiv.org/pdf/2412.02852v2)**

> **作者:** Yang Zhang; Er Jin; Wenzhong Liang; Yanfei Dong; Ashkan Khakzar; Philip Torr; Johannes Stegmaier; Kenji Kawaguchi
>
> **备注:** Project page: https://yangzhang-v5.github.io/EcoDiff
>
...
>
---
#### [replaced 018] OW-Rep: Open World Object Detection with Instance Representation Learning
- **分类: cs.CV; cs.RO**

- **简介: 该论文面向开放世界目标检测（OWOD）任务，解决现有方法忽视未知物体间语义关系的问题。提出OW-Rep框架，引入未知框精修模块和嵌入迁移模块，利用视觉基础模型提升未知物体检测精度与实例嵌入的语义质量。**

- **链接: [https://arxiv.org/pdf/2409.16073v3](https://arxiv.org/pdf/2409.16073v3)**
...
>
---
#### [replaced 022] AdaTooler-V: Adaptive Tool-Use for Images and Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16918v2](https://arxiv.org/pdf/2512.16918v2)**
...
>
---
#### [replaced 025] Continuous Vision-Language-Action Co-Learning with Semantic-Physical Alignment for Behavioral Cloning
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文属行为克隆（BC）任务，旨在解决语言条件操控中因语义-物理失准与物理不连续导致的累积误差、动作不连贯问题。提出CCoL框架，通过视觉-语言-本体感知连续协同学习与双向交叉注意力对齐语义与物理表征，提升动作轨迹平滑性与泛化性。**

- **链接: [https://arxiv.org/pdf/2511.14396v4](https://arxiv.org/pdf/2511.14396v4)**
...
>
---
#### [replaced 029] RegionRAG: Region-level Retrieval-Augmented Generation for Visual Document Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.27261v3](https://arxiv.org/pdf/2510.27261v3)**
...
>
---
#### [replaced 032] AsyMoE: Leveraging Modal Asymmetry for Enhanced Expert Specialization in Large Vision-Language Models
- **分类: cs.CV; cs.RO**

- **简介: 该论文面向多模态大模型（LVLMs）中的MoE架构优化任务，解决视觉与语言模态处理不对称导致的专家泛化差、语言上下文丢失问题。提出AsyMoE架构，含三类专家：模态内、双曲跨模态、证据优先语言专家，显著提升精度并减少参数激活。**

- **链接: [https://arxiv.org/pdf/2509.12715v2](https://arxiv.org/pdf/2509.12715v2)**
...
>
---
#### [replaced 033] A Survey of 3D Reconstruction with Event Cameras
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.08438v3](https://arxiv.org/pdf/2505.08438v3)**
...
>
---
#### [replaced 034] Learning Encoding-Decoding Direction Pairs to Unveil Concepts of Influence in Deep Vision Networks
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23926v2](https://arxiv.org/pdf/2509.23926v2)**
...
>
---
#### [replaced 036] TiViBench: Benchmarking Think-in-Video Reasoning for Video Generative Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13704v2](https://arxiv.org/pdf/2511.13704v2)**
...
>
---
#### [replaced 041] PartNeXt: A Next-Generation Dataset for Fine-Grained and Hierarchical 3D Part Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.20155v2](https://arxiv.org/pdf/2510.20155v2)**
...
>
---
#### [replaced 042] LVAgent: Long Video Understanding by Multi-Round Dynamical Collaboration of MLLM Agents
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.10200v5](https://arxiv.org/pdf/2503.10200v5)**
...
>
---
#### [replaced 045] FocalComm: Hard Instance-Aware Multi-Agent Perception
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.13982v2](https://arxiv.org/pdf/2512.13982v2)**
...
>
---
#### [replaced 046] Task adaptation of Vision-Language-Action model: 1st Place Solution for the 2025 BEHAVIOR Challenge
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**

- **简介: 该论文提出一种视觉-动作策略，解决BEHAVIOR挑战中50个长时程家庭任务（含双臂操作、导航与上下文决策）的具身智能控制问题。基于Pi0.5架构，创新引入相关噪声流匹配、混合层注意力和System 2跟踪，并优化训练与推理流程，最终获冠军。**

- **链接: [https://arxiv.org/pdf/2512.06951v2](https://arxiv.org/pdf/2512.06951v2)**
...
>
---
#### [replaced 047] BRIC: Bridging Kinematic Plans and Physical Control at Test Time
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出BRIC框架，属机器人/具身智能中的长时程人体运动生成任务。旨在解决扩散模型生成的运动在物理控制器执行时因物理不可行导致的执行漂移问题。通过测试时动态适配物理控制器、轻量级信号空间引导扩散模型，并防止技能遗忘，实现一致、物理合理的长期运动生成。**

- **链接: [https://arxiv.org/pdf/2511.20431v3](https://arxiv.org/pdf/2511.20431v3)**
...
>
---
#### [replaced 048] Deep Equilibrium Convolutional Sparse Coding for Hyperspectral Image Denoising
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.15553v2](https://arxiv.org/pdf/2508.15553v2)**
...
>
---
#### [replaced 049] CrossLMM: Decoupling Long Video Sequences from LMMs via Dual Cross-Attention Mechanisms
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.17020v2](https://arxiv.org/pdf/2505.17020v2)**
...
>
---
#### [replaced 050] Vision Language Models are Confused Tourists
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 051] Super Encoding Network: Recursive Association of Multi-Modal Encoders for Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.07576v2](https://arxiv.org/pdf/2506.07576v2)**
...
>
---
#### [replaced 052] RadAgents: Multimodal Agentic Reasoning for Chest X-ray Interpretation with Radiologist-like Workflows
...
>
---
#### [replaced 053] Detailed Aerial Mapping of Photovoltaic Power Plants Through Semantically Significant Keypoints
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.04840v3](https://arxiv.org/pdf/2510.04840v3)**

> **作者:** Viktor Kozák; Jan Chudoba; Libor Přeučil
>
> **备注:** 11 pages, 18 figures. Accepted version of the article - license updated
>
...
>
---
#### [replaced 054] DiffClean: Diffusion-based Makeup Removal for Accurate Age Estimation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.13292v2](https://arxiv.org/pdf/2507.13292v2)**

> **作者:** Ekta Balkrishna Gavas; Sudipta Banerjee; Chinmay Hegde; Nasir Memon
>
> **备注:** Revised version of the older draft with addtional experiments, analysis and code release
>
...
>
---
#### [replaced 055] Arc Gradient Descent: A Mathematically Derived Reformulation of Gradient Descent with Phase-Aware, User-Controlled Step Dynamics
...
>
---
#### [replaced 058] Preserving Topological and Geometric Embeddings for Point Cloud Recovery
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.19121v3](https://arxiv.org/pdf/2507.19121v3)**

> **作者:** Kaiyue Zhou; Zelong Tan; Hongxiao Wang; Ya-Li Li; Shengjin Wang
>
> **备注:** Accepted to AAAI 202
>
...
>
---
#### [replaced 059] Skeleton-Snippet Contrastive Learning with Multiscale Feature Fusion for Action Localization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16504v2](https://arxiv.org/pdf/2512.16504v2)**
...
>
---
#### [replaced 060] 3D Shape Generation: A Survey
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.22678v2](https://arxiv.org/pdf/2506.22678v2)**
...
>
---
#### [replaced 061] Collaborative Representation Learning for Alignment of Tactile, Language, and Vision Modalities
- **分类: cs.RO; cs.CV**

- **简介: 该论文属多模态表征学习任务，旨在解决触觉传感器不标准导致的跨传感器泛化差及触觉-语言-视觉三模态交互不足问题。提出TLV-CoRe方法，含传感器感知调制器、触觉无关解耦学习与统一桥接适配器，并构建RSS评估框架。**

- **链接: [https://arxiv.org/pdf/2511.11512v2](https://arxiv.org/pdf/2511.11512v2)**
...
>
---
#### [replaced 062] TrackNetV5: Residual-Driven Spatio-Temporal Refinement and Motion Direction Decoupling for Fast Object Tracking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02789v2](https://arxiv.org/pdf/2512.02789v2)**
...
>
---
#### [replaced 063] 4D-RGPT: Toward Region-level 4D Understanding via Perceptual Distillation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17012v2](https://arxiv.org/pdf/2512.17012v2)**
...
>
---
#### [replaced 064] Adaptive Frequency Domain Alignment Network for Medical image segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16393v2](https://arxiv.org/pdf/2512.16393v2)**
...
>
---
#### [replaced 065] Advances in Feed-Forward 3D Reconstruction and View Synthesis: A Survey
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.14501v5](https://arxiv.org/pdf/2507.14501v5)**
...
>
---
#### [replaced 068] Xiaomi MiMo-VL-Miloco Technical Report
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17436v2](https://arxiv.org/pdf/2512.17436v2)**
...
>
> **摘要:** We open-source MiMo-VL-Miloco-7B and its quantized variant MiMo-VL-Miloco-7B-GGUF, a pair of home-centric vision-language models that achieve strong performance on both home-scenario understanding and general multimodal reasoning. Built on the MiMo-VL-7B backbone, MiMo-VL-Miloco-7B is specialized for smart-home environments, attaining leading F1 scores on gesture recognition and common home-scenario understanding, while also delivering consistent gains across video benchmarks such as Video-MME, Video-MMMU, and Charades-STA, as well as language understanding benchmarks including MMMU-Pro and MMLU-Pro. In our experiments, MiMo-VL-Miloco-7B outperforms strong closed-source and open-source baselines on home-scenario understanding and several multimodal reasoning benchmarks. To balance specialization and generality, we design a two-stage training pipeline that combines supervised fine-tuning with reinforcement learning based on Group Relative Policy Optimization, leveraging efficient multi-domain data. We further incorporate chain-of-thought supervision and token-budget-aware reasoning, enabling the model to learn knowledge in a data-efficient manner while also performing reasoning efficiently. Our analysis shows that targeted home-scenario training not only enhances activity and gesture understanding, but also improves text-only reasoning with only modest trade-offs on document-centric tasks. Model checkpoints, quantized GGUF weights, and our home-scenario evaluation toolkit are publicly available at https://github.com/XiaoMi/xiaomi-mimo-vl-miloco to support research and deployment in real-world smart-home applications.
>
---
#### [replaced 069] PRISM-Loc: a Lightweight Long-range LiDAR Localization in Urban Environments with Topological Maps
- **分类: cs.RO; cs.CV**

- **简介: 该论文提出PRISM-Loc，面向资源受限平台的城市级LiDAR定位任务，解决大场景下实时性、鲁棒性与轻量化难题。工作包括：构建紧凑拓扑地图、设计基于原始点云的 curb检测与扫描匹配新方法，并在标准数据集和嵌入式平台验证其高效性与高成功率。**

- **链接: [https://arxiv.org/pdf/2506.15849v2](https://arxiv.org/pdf/2506.15849v2)**
...
>
---
#### [replaced 071] Selfi: Self Improving Reconstruction Engine via 3D Geometric Feature Alignment
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2512.08930v2](https://arxiv.org/pdf/2512.08930v2)**
...
>
---
#### [replaced 072] Reproducing and Improving CheXNet: Deep Learning for Chest X-ray Disease Classification
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.06646v2](https://arxiv.org/pdf/2505.06646v2)**
...
>
---
#### [replaced 073] Prompt-Aware Adaptive Elastic Weight Consolidation for Continual Learning in Medical Vision-Language Models
- **分类: cs.MM; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.20732v2](https://arxiv.org/pdf/2511.20732v2)**
...
>
---
#### [replaced 074] No Pose at All: Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.01171v2](https://arxiv.org/pdf/2508.01171v2)**
...
>
---
#### [replaced 075] TOMCAT: Test-time Comprehensive Knowledge Accumulation for Compositional Zero-Shot Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.20162v2](https://arxiv.org/pdf/2510.20162v2)**
...
>
---
#### [replaced 076] OpenHOI: Open-World Hand-Object Interaction Synthesis with Multimodal Large Language Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.18947v2](https://arxiv.org/pdf/2505.18947v2)**

> **作者:** Zhenhao Zhang; Ye Shi; Lingxiao Yang; Suting Ni; Qi Ye; Jingya Wang
>
> **备注:** Accepted by NeurIPS 2025 as Oral
>
...
>
---
#### [replaced 077] Restrictive Hierarchical Semantic Segmentation for Stratified Tooth Layer Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.07984v3](https://arxiv.org/pdf/2512.07984v3)**

> **作者:** Ryan Banks; Camila Lindoni Azevedo; Hongying Tang; Yunpeng Li
>
> **备注:** Incorrect initial draft was submitted by mistake. Method, results and citations are incorrect
>
...
>
---
#### [replaced 078] SSR: Semantic and Spatial Rectification for CLIP-based Weakly Supervised Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01701v2](https://arxiv.org/pdf/2512.01701v2)**
...
>
---
#### [replaced 079] VERDI: VLM-Embedded Reasoning for Autonomous Driving
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文属自动驾驶决策任务，旨在解决现有端到端模型缺乏可解释推理能力、依赖大参数VLM导致部署难的问题。提出VERDI框架，在训练时将VLM的常识推理知识蒸馏至模块化AD模型各阶段，实现轻量、实时、可分解的安全推理。**

- **链接: [https://arxiv.org/pdf/2505.15925v3](https://arxiv.org/pdf/2505.15925v3)**

> **作者:** Bowen Feng; Zhiting Mei; Baiang Li; Julian Ost; Filippo Ghilotti; Roger Girgis; Anirudha Majumdar; Felix Heide
>
...
>
---
#### [replaced 080] Independent Density Estimation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.10067v2](https://arxiv.org/pdf/2512.10067v2)**

> **作者:** Jiahao Liu; Senhao Cao
>
...
>
---
#### [replaced 081] TRACE: Your Diffusion Model is Secretly an Instance Edge Detector
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.07982v3](https://arxiv.org/pdf/2503.07982v3)**
...
>
---
#### [replaced 082] SAMSA 2.0: Prompting Segment Anything with Spectral Angles for Hyperspectral Interactive Medical Image Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.00493v2](https://arxiv.org/pdf/2508.00493v2)**
...
>
---
#### [replaced 088] Vidar: Embodied Video Diffusion Model for Generalist Manipulation
- **分类: cs.LG; cs.AI; cs.CV; cs.RO**

- **简介: 论文提出Vidar，一种面向通用机器人操作的具身视频扩散模型。旨在解决跨机器人本体泛化难、需大量示范数据的问题。工作包括：构建具身视频扩散先验，用750K多视角轨迹持续预训练；设计无标签掩码逆动力学适配器（MIDM），仅需20分钟新机器人演示即可对齐动作空间。**

- **链接: [https://arxiv.org/pdf/2507.12898v4](https://arxiv.org/pdf/2507.12898v4)**
...
>
---
#### [replaced 091] Weakly Supervised Segmentation and Classification of Alpha-Synuclein Aggregates in Brightfield Midbrain Images
- **分类: eess.IV; cs.CV; q-bio.QM**

- **链接: [https://arxiv.org/pdf/2511.16268v2](https://arxiv.org/pdf/2511.16268v2)**
...
>
---
#### [replaced 095] One Perturbation is Enough: On Generating Universal Adversarial Perturbations against Vision-Language Pre-training Models
- **分类: cs.CV; cs.CR**

- **链接: [https://arxiv.org/pdf/2406.05491v4](https://arxiv.org/pdf/2406.05491v4)**

> **作者:** Hao Fang; Jiawei Kong; Wenbo Yu; Bin Chen; Jiawei Li; Hao Wu; Shutao Xia; Ke Xu
>
> **备注:** Accepted by ICCV-2025
>
> **摘要:** Vision-Language Pre-training (VLP) models have exhibited unprecedented capability in many applications by taking full advantage of the multimodal alignment. However, previous studies have shown they are vulnerable to maliciously crafted adversarial samples. Despite recent success, these methods are generally instance-specific and require generating perturbations for each input sample. In this paper, we reveal that VLP models are also vulnerable to the instance-agnostic universal adversarial perturbation (UAP). Specifically, we design a novel Contrastive-training Perturbation Generator with Cross-modal conditions (C-PGC) to achieve the attack. In light that the pivotal multimodal alignment is achieved through the advanced contrastive learning technique, we devise to turn this powerful weapon against themselves, i.e., employ a malicious version of contrastive learning to train the C-PGC based on our carefully crafted positive and negative image-text pairs for essentially destroying the alignment relationship learned by VLP models. Besides, C-PGC fully utilizes the characteristics of Vision-and-Language (V+L) scenarios by incorporating both unimodal and cross-modal information as effective guidance. Extensive experiments show that C-PGC successfully forces adversarial samples to move away from their original area in the VLP model's feature space, thus essentially enhancing attacks across various victim models and V+L tasks. The GitHub repository is available at https://github.com/ffhibnese/CPGC_VLP_Universal_Attacks.
>
---
#### [replaced 096] Online Episodic Memory Visual Query Localization with Egocentric Streaming Object Memory
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.16934v3](https://arxiv.org/pdf/2411.16934v3)**
...
>
> **备注:** in IEEE/CVF Winter Conference on Application of Computer Vision (WACV) 2026
>
...
>
---
#### [replaced 097] From Easy to Hard: Progressive Active Learning Framework for Infrared Small Target Detection with Single Point Supervision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.11154v3](https://arxiv.org/pdf/2412.11154v3)**
...
>
---
#### [replaced 098] Towards Enhanced Image Generation Via Multi-modal Chain of Thought in Unified Generative Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2503.01298v3](https://arxiv.org/pdf/2503.01298v3)**
...
>
---
#### [replaced 099] MAGIC: Few-Shot Mask-Guided Anomaly Inpainting with Prompt Perturbation, Spatially Adaptive Guidance, and Context Awareness
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.02314v4](https://arxiv.org/pdf/2507.02314v4)**

> **作者:** JaeHyuck Choi; MinJun Kim; Je Hyeong Hong
>
> **备注:** 46 pages, 47 figures. Code: https://github.com/SpatialAILab/MAGIC-Anomaly-generation
>
...
>
---
#### [replaced 106] Discrete Diffusion VLA: Bringing Discrete Diffusion to Action Decoding in Vision-Language-Action Policies
- **分类: cs.CV; cs.LG; cs.RO**

- **简介: 该论文提出Discrete Diffusion VLA，属机器人视觉-语言-动作（VLA）策略建模任务。旨在解决现有VLA模型解码碎片化、依赖自回归或外部头、难以统一训练的问题。工作：设计基于离散扩散的统一Transformer解码器，支持自适应顺序解码与重掩码纠错，兼顾预训练先验与并行高效推理。**

- **链接: [https://arxiv.org/pdf/2508.20072v3](https://arxiv.org/pdf/2508.20072v3)**
...
>
---
#### [replaced 110] Chorus: Multi-Teacher Pretraining for Holistic 3D Gaussian Scene Encoding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17817v2](https://arxiv.org/pdf/2512.17817v2)**
...
>
---
#### [replaced 114] VDOT: Efficient Unified Video Creation via Optimal Transport Distillation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06802v3](https://arxiv.org/pdf/2512.06802v3)**
...
>
---
#### [replaced 115] GraphGeo: Multi-Agent Debate Framework for Visual Geo-localization with Heterogeneous Graph Neural Networks
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2511.00908v2](https://arxiv.org/pdf/2511.00908v2)**

> **作者:** Heng Zheng; Yuling Shi; Xiaodong Gu; Haochen You; Zijian Zhang; Lubin Gan; Hao Zhang; Wenjun Huang; Jin Huang
>
> **备注:** This submission has been withdrawn by the authors due to a fundamental error in the methodology that affects the validity of the main results
>
> **摘要:** Visual geo-localization requires extensive geographic knowledge and sophisticated reasoning to determine image locations without GPS metadata. Traditional retrieval methods are constrained by database coverage and quality. Recent Large Vision-Language Models (LVLMs) enable direct location reasoning from image content, yet individual models struggle with diverse geographic regions and complex scenes. Existing multi-agent systems improve performance through model collaboration but treat all agent interactions uniformly. They lack mechanisms to handle conflicting predictions effectively. We propose \textbf{GraphGeo}, a multi-agent debate framework using heterogeneous graph neural networks for visual geo-localization. Our approach models diverse debate relationships through typed edges, distinguishing supportive collaboration, competitive argumentation, and knowledge transfer. We introduce a dual-level debate mechanism combining node-level refinement and edge-level argumentation modeling. A cross-level topology refinement strategy enables co-evolution between graph structure and agent representations. Experiments on multiple benchmarks demonstrate GraphGeo significantly outperforms state-of-the-art methods. Our framework transforms cognitive conflicts between agents into enhanced geo-localization accuracy through structured debate.
>
---
#### [replaced 116] OrthoInsight: Rib Fracture Diagnosis and Report Generation Based on Multi-Modal Large Models
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.13993v3](https://arxiv.org/pdf/2507.13993v3)**

> **作者:** Jinzhi Wang; Jiangbo Zhang; Chenzhan Yu; Zhigang Xiu; Duwei Dai; Ziyu xu; Ningyong Wu; Wenhong Zhao
>
