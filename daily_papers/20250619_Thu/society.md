...
#### [new 001] Misinformation by Omission: The Need for More Environmental Transparency in AI
- **分类: cs.CY**

- **简介: 该论文属于AI环境影响研究任务，旨在解决AI模型透明度不足导致的环境信息误导问题，通过分析误解来源并提出透明度改进建议。**
...
>
---
#### [new 002] Preparing for the Intelligence Explosion
- **分类: cs.CY; cs.AI**

- **简介: 该论文属于人工智能伦理与未来研究任务，探讨如何应对AI快速发展的重大挑战，提出当前需为可能的智能爆炸做好准备。**
...
>
---
#### [new 003] Not Even Nice Work If You Can Get It; A Longitudinal Study of Uber's Algorithmic Pay and Pricing
- **分类: cs.CY; cs.HC**

- **简介: 该论文属于算法审计任务，研究Uber动态定价对司机收入与工作分配的影响，揭示其导致收入下降、不平等加剧等问题。**
...
>
---
#### [new 004] Hypothesis Testing for Quantifying LLM-Human Misalignment in Multiple Choice Settings
...
>
---
#### [new 005] Transit for All: Mapping Equitable Bike2Subway Connection using Region Representation Learning
- **分类: cs.CY; cs.AI; cs.LG**

- **简介: 该论文属于城市交通规划任务，旨在解决低收入和少数族裔社区的公共交通不平等问题。通过构建TFA框架，结合空间计算与需求预测，优化共享单车站点布局以提升可达性。**
...
>
---
#### [new 006] FORTRESS: Frontier Risk Evaluation for National Security and Public Safety
- **分类: cs.CY; cs.LG**

- **简介: 该论文属于安全评估任务，旨在解决大语言模型在国家安全与公共安全方面的风险评估问题。工作包括构建FORTRESS评测集，评估模型的安全性与实用性平衡。**
...
>
---
#### [new 007] Mapping Caregiver Needs to AI Chatbot Design: Strengths and Gaps in Mental Health Support for Alzheimer's and Dementia Caregivers
- **分类: cs.HC; cs.AI; cs.CY**

- **简介: 该论文属于AI辅助心理健康支持任务，旨在解决阿尔茨海默病照料者的需求与AI聊天机器人设计之间的匹配问题。通过访谈分析，提出设计建议。**
...
>
---
#### [new 008] PhantomHunter: Detecting Unseen Privately-Tuned LLM-Generated Text via Family-Aware Learning
- **分类: cs.CL; cs.CY**
...
>
---
#### [new 009] Minding the Politeness Gap in Cross-cultural Communication
- **分类: cs.CL; cs.CY**
...
>
---
#### [new 010] Next-Generation Conflict Forecasting: Unleashing Predictive Patterns through Spatiotemporal Learning
...
>
---
#### [new 011] One-shot Face Sketch Synthesis in the Wild via Generative Diffusion Prior and Instruction Tuning
...
>
---
#### [new 012] Performative Validity of Recourse Explanations
- **分类: stat.ML; cs.CY; cs.LG**

- **简介: 该论文属于算法决策领域，研究 recourse explanations 在群体行为影响下的有效性问题。工作包括分析其失效条件，并建议使用基于因果变量的解释方法。**
...
>
---
#### [replaced 002] Inverted Classroom in der Einführungsveranstaltung Programmierung
- **分类: cs.CY**

- **链接: [http://arxiv.org/pdf/2506.10057v2](http://arxiv.org/pdf/2506.10057v2)**

> **作者:** Ulrich von Zadow; Natalie Kiesler
>
...
>
---
#### [replaced 003] Single-Agent vs. Multi-Agent LLM Strategies for Automated Student Reflection Assessment
...
>
---
#### [replaced 004] Machine Learners Should Acknowledge the Legal Implications of Large Language Models as Personal Data
- **分类: cs.LG; cs.AI; cs.CY**

- **链接: [http://arxiv.org/pdf/2503.01630v2](http://arxiv.org/pdf/2503.01630v2)**
...
>
---
#### [replaced 005] From Street Views to Urban Science: Discovering Road Safety Factors with Multimodal Large Language Models
- **分类: cs.LG; cs.CY**
...
>
---
#### [replaced 006] A Guide to Misinformation Detection Data and Evaluation
...
>
---
#### [replaced 007] AIn't Nothing But a Survey? Using Large Language Models for Coding German Open-Ended Survey Responses on Survey Motivation
