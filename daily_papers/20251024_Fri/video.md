...
>
---
#### [new 003] Evaluating Video Models as Simulators of Multi-Person Pedestrian Trajectories
- **分类: cs.CV**
...
- **简介: 该论文针对鱼眼相机在交通监控中因径向畸变和非均匀分辨率导致的物体检测难题，提出统一的检测流水线。通过预处理与后处理增强检测一致性，并融合多个先进模型提升精度，有效改善了图像边界区域的检测性能，在2025 AI City挑战赛中取得第8名。**
...
- **简介: 该论文提出LDDBM，一种通用模态翻译框架，解决跨模态生成中维度不匹配、假设过强等问题。通过共享潜在空间与对比对齐、预测损失，实现任意模态对的无约束翻译，在3D生成、超分辨率等任务表现优异。**
...
- **简介: 该论文聚焦GUI接地任务，针对现有方法将指令视为静态代理的局限，提出Instruction-as-Reasoning范式，通过多视角指令合成与强化学习优化路径选择，显著提升接地准确率与模型推理能力。**
...
- **简介: 该论文提出Open-o3 Video，面向视频推理任务，解决现有模型缺乏显式时空证据定位的问题。通过构建双数据集并设计冷启动强化学习策略，实现答案与关键时间点、物体及边界框的精准关联，显著提升多基准测试性能，增强推理可解释性与可靠性。**
...
- **简介: 该论文提出AutoScape，用于长时序驾驶场景生成。针对现有方法在长时间视频中几何不一致的问题，提出基于RGB-D扩散模型的键帧生成与插值框架，通过联合建模图像与深度、利用已有几何信息及光流一致性引导，实现20秒以上真实且几何一致的驾驶视频生成，显著提升长时序生成质量。**
...
- **简介: 该论文聚焦生成式图像模型的文化偏见问题，针对文本到图像（T2I）与图像到图像（I2I）编辑任务，构建跨国家、跨时代、多类别评估框架，结合自动指标、文化感知VQA与专家评审，揭示模型默认倾向全球北方现代风格，且I2I编辑易损害文化真实性。研究发布标准化数据与协议，推动可复现的文化偏见评测。**
...
- **简介: 该论文提出COS3D，解决开放词汇3D分割中语言与分割线索融合不足的问题。通过引入协同场（实例场与语言场），设计特征映射与两阶段训练策略，并在推理时采用自适应提示优化，实现高效协同。显著提升分割性能，适用于多种应用场景。**
...
- **简介: 该论文针对3D医学影像中视觉-语言建模的挑战，提出BTB3D模型，通过因果卷积架构实现统一2D/3D训练与推理，生成紧凑且频率感知的体素令牌。解决高分辨率、长序列数据下语义对齐差与解剖细节模糊问题，显著提升报告生成与文本到CT合成性能，验证了精确三维令牌化的重要性。**
...
- **简介: 该论文针对复杂值合成孔径雷达（CV-SAR）图像识别中的数据稀缺与域偏移问题，提出知识引导的轻量级神经网络KINN。通过“压缩-聚合-压缩”架构融合物理先验，提升模型泛化性、可解释性与效率，解决了深度学习在CV-SAR任务中代表性三难困境。**
...
- **简介: 该论文研究生成式AI时代下基于视频基础模型的霹雳舞视频分类任务。针对现有模型多聚焦主流体育项目的问题，探讨了编码器与解码器模型在小众但流行的霹雳舞分类中的适用性，发现编码器模型优于当前先进语言模型，并提供了模型选择与微调解码器的深入分析。**
...
- **简介: 该论文针对少步生成模型中的MeanFlow框架，揭示其优化冲突源于轨迹流匹配与一致性项的负相关。提出α-Flow统一框架，通过渐进式训练缓解冲突，显著提升收敛性与性能，在ImageNet上实现新SOTA。**
...
- **简介: 该论文针对人脸分析系统公平性评估中依赖的性别与种族属性自动推断（DAI）可靠性问题，提出一种可复现的模块化迁移学习管道。通过结合预训练模型与非线性分类头，提升推断准确率与一致性，并引入新鲁棒性指标。在多数据集上验证，显著优于基线，尤其在更难的种族推断任务中。**
...
- **简介: 该论文提出Endoshare，一个开源跨平台工具，用于标准化、去标识化微创手术视频。针对手术视频共享中的格式异构与隐私问题，通过用户中心设计与多阶段测试，实现安全高效管理，提升可用性与采纳度。**
...
>
---
#### [new 035] HoloCine: Holistic Generation of Cinematic Multi-Shot Long Video Narratives
- **分类: cs.CV**
...
- **简介: 该论文提出IB-GAN，一种基于信息瓶颈框架的GAN模型，用于无监督解耦表征学习。通过在生成器中间层约束输入与输出的互信息，实现可解释的解耦表示。实验表明，IB-GAN在解耦性上优于InfoGAN，且在生成样本质量与多样性上超越η-VAEs和InfoGAN。**
...
- **简介: 该论文提出ARGenSeg，一种基于自回归图像生成的图像分割方法。针对现有多模态大模型分割依赖离散表示、难以捕捉细节的问题，利用模型生成像素级视觉令牌并重建图像，实现端到端的密集掩码预测。通过并行化生成策略提升速度，显著优于现有方法。**
...
- **简介: 该论文针对大视觉语言模型中键值缓存（KV Cache）带来的内存瓶颈问题，提出MixKV方法，通过联合优化重要性与多样性，在压缩KV缓存时提升语义覆盖度。实验表明，该方法显著优于现有方法，尤其在极端压缩下表现突出，并可扩展至通用大语言模型。**
...
- **简介: 该论文针对扩散模型生成手绘素描时风格与提示不符的问题，提出StableSketcher框架。通过微调变分自编码器优化隐空间解码，并引入基于视觉问答的强化学习奖励函数，提升文本-图像对齐与语义一致性。同时构建首个包含实例级素描、描述及问答对的数据集SketchDUO。**
...
- **简介: 该论文针对高光谱图像超分辨率任务，解决低空间分辨率导致的边界模糊与混合像元问题。提出SpectraMorph框架，通过物理引导的自监督学习，利用多光谱或全色影像提升高光谱图像空间分辨率。其核心是结构化潜在空间与解混瓶颈，实现可解释重建，且在少波段输入下仍具鲁棒性。**
...
- **链接: [http://arxiv.org/pdf/2510.19840v1](http://arxiv.org/pdf/2510.19840v1)**
...
- **简介: 该论文聚焦视觉常识推理任务，针对数据中的文本与视觉共现及统计偏差问题，提出因果去偏方法。构建VCR-OOD数据集评估泛化能力，通过因果图分析与反事实调整，利用正确答案字典消除预测捷径，提升模型鲁棒性。**
...
- **简介: 该论文提出Cupid方法，解决单图像3D重建任务中姿态与形状联合估计难题。通过在共享3D隐空间中建模姿态与形状分布，采用两阶段流匹配框架，联合生成体素与像素-体素对应关系，实现高精度姿态、形状与纹理重建，显著提升重建质量与视觉保真度。**
...
- **简介: 该论文提出FuzzyDistillViT-MobileNet模型，用于肺癌分类任务。针对传统知识蒸馏中权重固定导致的不确定性处理不足问题，引入模糊逻辑动态调整蒸馏权重，结合视觉变换器与移动网络，提升模型在不同图像域的准确率与实时性。**
...
- **简介: 该论文针对图像到食谱检索任务，解决跨模态表示偏差问题。现有方法因图像仅反映成品而忽略配方中隐含的烹饪细节，导致对细微差异的识别能力弱。作者提出一种因果方法，预测并注入图像中缺失的烹饪元素，以提升跨模态表示的准确性，在单语和多语言多文化数据集上均取得优异效果。**
...
- **简介: 该论文聚焦于细粒度可解释深度伪造分析（XDFA）任务，针对现有方法在视觉上下文感知与图文关联上的不足，提出FiFa框架。通过构建面部概念树实现精细区域标注，设计Artifact-Grounding Explanation任务，并提出统一多任务模型FiFa-MLLM，实现文本解释与视觉掩码的协同生成，显著提升分析的准确性和可解释性。**
...
>
---
#### [new 063] From Far and Near: Perceptual Evaluation of Crowd Representations Across Levels of Detail
- **分类: cs.CV; cs.GR; cs.HC**

- **简介: 该论文研究人群渲染中不同细节层次（LoD）的视觉感知质量，比较几何网格、图像贴图、NeRF和3D高斯四类表示在远近视角下的视觉保真度与性能权衡，旨在指导感知优化的LoD策略设计。**

- **链接: [http://arxiv.org/pdf/2510.20558v1](http://arxiv.org/pdf/2510.20558v1)**
...
>
---
#### [new 073] Conan: Progressive Learning to Reason Like a Detective over Multi-Scale Visual Evidence
- **分类: cs.CV**

- **简介: 该论文聚焦多步视频推理任务，旨在解决现有方法在视觉证据定位与推理一致性上的不足。提出Conan框架，通过构建大规模数据集与多阶段强化学习训练，实现跨帧证据识别、推理与决策的协同优化，显著提升准确率与长视频泛化能力。**

- **链接: [http://arxiv.org/pdf/2510.20470v1](http://arxiv.org/pdf/2510.20470v1)**
...
>
---
#### [new 074] UltraHR-100K: Enhancing UHR Image Synthesis with A Large-Scale High-Quality Dataset
- **分类: cs.CV**

- **简介: 该论文针对超高清文本到图像生成任务，解决缺乏大规模高质量数据集及细节生成不足的问题。提出UltraHR-100K数据集与频率感知后训练方法，通过细节导向采样和频域软正则化，显著提升图像细节质量和整体保真度。**

- **链接: [http://arxiv.org/pdf/2510.20661v1](http://arxiv.org/pdf/2510.20661v1)**

> **作者:** Chen Zhao; En Ci; Yunzhe Xu; Tiehan Fan; Shanyan Guan; Yanhao Ge; Jian Yang; Ying Tai
>
> **备注:** Accepted by NeurIPS 2025
>
> **摘要:** Ultra-high-resolution (UHR) text-to-image (T2I) generation has seen notable progress. However, two key challenges remain : 1) the absence of a large-scale high-quality UHR T2I dataset, and (2) the neglect of tailored training strategies for fine-grained detail synthesis in UHR scenarios. To tackle the first challenge, we introduce \textbf{UltraHR-100K}, a high-quality dataset of 100K UHR images with rich captions, offering diverse content and strong visual fidelity. Each image exceeds 3K resolution and is rigorously curated based on detail richness, content complexity, and aesthetic quality. To tackle the second challenge, we propose a frequency-aware post-training method that enhances fine-detail generation in T2I diffusion models. Specifically, we design (i) \textit{Detail-Oriented Timestep Sampling (DOTS)} to focus learning on detail-critical denoising steps, and (ii) \textit{Soft-Weighting Frequency Regularization (SWFR)}, which leverages Discrete Fourier Transform (DFT) to softly constrain frequency components, encouraging high-frequency detail preservation. Extensive experiments on our proposed UltraHR-eval4K benchmarks demonstrate that our approach significantly improves the fine-grained detail quality and overall fidelity of UHR image generation. The code is available at \href{https://github.com/NJU-PCALab/UltraHR-100k}{here}.
>
---
#### [new 075] FutrTrack: A Camera-LiDAR Fusion Transformer for 3D Multiple Object Tracking
- **分类: cs.CV**

- **简介: 该论文提出FutrTrack，一种基于相机与激光雷达融合的3D多目标跟踪框架。针对单传感器跟踪在遮挡和视角变化下识别不稳定的问题，引入双阶段Transformer融合与轨迹平滑，利用多模态BEV特征实现鲁棒身份关联，在nuScenes上达到74.7 aMOTA，显著提升跟踪精度与一致性。**

- **链接: [http://arxiv.org/pdf/2510.19981v1](http://arxiv.org/pdf/2510.19981v1)**
...
>
---
#### [new 076] TOMCAT: Test-time Comprehensive Knowledge Accumulation for Compositional Zero-Shot Learning
- **分类: cs.CV**

- **简介: 该论文针对组合零样本学习（CZSL）中测试时标签空间分布偏移问题，提出TOMCAT方法。通过在测试时融合文本与视觉模态的无监督知识，动态更新多模态原型，并利用优先队列保存高置信度图像，实现自适应知识累积与语义对齐，显著提升模型在开放与封闭世界下的识别性能。**

- **链接: [http://arxiv.org/pdf/2510.20162v1](http://arxiv.org/pdf/2510.20162v1)**
...
>
---
#### [new 079] OnlineSplatter: Pose-Free Online 3D Reconstruction for Free-Moving Objects
- **分类: cs.CV; cs.AI; I.4.5; I.2.6**

- **简介: 该论文提出OnlineSplatter，解决单目视频中自由运动物体的无姿态3D重建问题。无需相机位姿或深度先验，通过动态高斯场与双键记忆模块，实现在线、高效、高质量的物体中心重建，支持任意运动并保持恒定计算开销。**

- **链接: [http://arxiv.org/pdf/2510.20605v1](http://arxiv.org/pdf/2510.20605v1)**

> **作者:** Mark He Huang; Lin Geng Foo; Christian Theobalt; Ying Sun; De Wen Soh
>
> **备注:** NeurIPS 2025 (Spotlight)
>
> **摘要:** Free-moving object reconstruction from monocular video remains challenging, particularly without reliable pose or depth cues and under arbitrary object motion. We introduce OnlineSplatter, a novel online feed-forward framework generating high-quality, object-centric 3D Gaussians directly from RGB frames without requiring camera pose, depth priors, or bundle optimization. Our approach anchors reconstruction using the first frame and progressively refines the object representation through a dense Gaussian primitive field, maintaining constant computational cost regardless of video sequence length. Our core contribution is a dual-key memory module combining latent appearance-geometry keys with explicit directional keys, robustly fusing current frame features with temporally aggregated object states. This design enables effective handling of free-moving objects via spatial-guided memory readout and an efficient sparsification mechanism, ensuring comprehensive yet compact object coverage. Evaluations on real-world datasets demonstrate that OnlineSplatter significantly outperforms state-of-the-art pose-free reconstruction baselines, consistently improving with more observations while maintaining constant memory and runtime.
>
---
#### [new 080] Improving Predictive Confidence in Medical Imaging via Online Label Smoothing
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对医疗图像分类中深度模型过自信的问题，提出在线标签平滑（OLS）方法。通过动态调整软标签，考虑类别间关系，提升模型预测校准性与准确性，改善特征表示，验证了其在多个架构上的有效性。**

- **链接: [http://arxiv.org/pdf/2510.20011v1](http://arxiv.org/pdf/2510.20011v1)**
...
>
---
#### [new 082] Empower Words: DualGround for Structured Phrase and Sentence-Level Temporal Grounding
- **分类: cs.CV; cs.LG**

- **简介: 该论文聚焦视频时间定位任务，针对现有模型忽视词级语义、依赖全局句子特征的问题，提出DualGround框架。通过双分支结构分离句级与短语级语义，引入角色感知的跨模态交互与联合建模，实现细粒度时空对齐，显著提升在两个基准上的性能。**

- **链接: [http://arxiv.org/pdf/2510.20244v1](http://arxiv.org/pdf/2510.20244v1)**
...
>
---
#### [new 084] Transformed Multi-view 3D Shape Features with Contrastive Learning
- **分类: cs.CV**

- **简介: 该论文聚焦3D形状表示学习任务，针对传统CNN在捕捉形状关系上的局限及对大量标注数据的依赖问题，提出结合视觉变压器（ViT）与对比学习的方法。通过多视角输入，利用ViT提取全局语义并结合对比损失优化局部特征，在ModelNet10上达90.6%准确率，有效提升3D形状识别性能。**

- **链接: [http://arxiv.org/pdf/2510.19955v1](http://arxiv.org/pdf/2510.19955v1)**
...
>
---
#### [new 087] Kinaema: a recurrent sequence model for memory and pose in motion
...
>
---
#### [new 088] Compress to Impress: Efficient LLM Adaptation Using a Single Gradient Step on 100 Samples
...
>
---
#### [new 089] Transferable Black-Box One-Shot Forging of Watermarks via Image Preference Models
- **分类: cs.LG; cs.AI; cs.CR; cs.CV**

- **简介: 该论文研究后处理图像水印的可转移黑盒一键伪造问题。针对水印被恶意盗用至虚假内容的漏洞，提出基于偏好模型的攻击方法，仅需一张水印图即可通过反向传播实现水印移除与伪造，无需了解水印机制，验证了现有水印方案的安全缺陷。**

- **链接: [http://arxiv.org/pdf/2510.20468v1](http://arxiv.org/pdf/2510.20468v1)**
...
> **备注:** NeurIPS 2025
>
> **摘要:** Recent years have seen a surge in interest in digital content watermarking techniques, driven by the proliferation of generative models and increased legal pressure. With an ever-growing percentage of AI-generated content available online, watermarking plays an increasingly important role in ensuring content authenticity and attribution at scale. There have been many works assessing the robustness of watermarking to removal attacks, yet, watermark forging, the scenario when a watermark is stolen from genuine content and applied to malicious content, remains underexplored. In this work, we investigate watermark forging in the context of widely used post-hoc image watermarking. Our contributions are as follows. First, we introduce a preference model to assess whether an image is watermarked. The model is trained using a ranking loss on purely procedurally generated images without any need for real watermarks. Second, we demonstrate the model's capability to remove and forge watermarks by optimizing the input image through backpropagation. This technique requires only a single watermarked image and works without knowledge of the watermarking model, making our attack much simpler and more practical than attacks introduced in related work. Third, we evaluate our proposed method on a variety of post-hoc image watermarking models, demonstrating that our approach can effectively forge watermarks, questioning the security of current watermarking approaches. Our code and further resources are publicly available.
>
---
#### [new 090] FINDER: Feature Inference on Noisy Datasets using Eigenspace Residuals
- **分类: cs.LG; cs.CV; cs.NA; math.NA**

- **简介: 该论文提出FINDER框架，针对低信噪比、小样本等噪声数据下的分类问题。通过将数据视为随机场并映射到希尔伯特空间，利用KLE展开提取随机特征，基于谱分析实现分类。在阿尔茨海默病分期和森林砍伐检测中取得突破性效果。**

- **链接: [http://arxiv.org/pdf/2510.19917v1](http://arxiv.org/pdf/2510.19917v1)**

> **作者:** Trajan Murphy; Akshunna S. Dogra; Hanfeng Gu; Caleb Meredith; Mark Kon; Julio Enrique Castrillion-Candas
>
> **备注:** 30 pages, 11 figures, 8 tables. Code available at https://github.com/MathePhysics/FINDER
>
> **摘要:** ''Noisy'' datasets (regimes with low signal to noise ratios, small sample sizes, faulty data collection, etc) remain a key research frontier for classification methods with both theoretical and practical implications. We introduce FINDER, a rigorous framework for analyzing generic classification problems, with tailored algorithms for noisy datasets. FINDER incorporates fundamental stochastic analysis ideas into the feature learning and inference stages to optimally account for the randomness inherent to all empirical datasets. We construct ''stochastic features'' by first viewing empirical datasets as realizations from an underlying random field (without assumptions on its exact distribution) and then mapping them to appropriate Hilbert spaces. The Kosambi-Karhunen-Lo\'eve expansion (KLE) breaks these stochastic features into computable irreducible components, which allow classification over noisy datasets via an eigen-decomposition: data from different classes resides in distinct regions, identified by analyzing the spectrum of the associated operators. We validate FINDER on several challenging, data-deficient scientific domains, producing state of the art breakthroughs in: (i) Alzheimer's Disease stage classification, (ii) Remote sensing detection of deforestation. We end with a discussion on when FINDER is expected to outperform existing methods, its failure modes, and other limitations.
>
---
#### [new 091] GSWorld: Closed-Loop Photo-Realistic Simulation Suite for Robotic Manipulation
...
>
---
#### [new 094] Real Deep Research for AI, Robotics and Beyond
...
>
---
#### [new 095] Why Prototypes Collapse: Diagnosing and Preventing Partial Collapse in Prototypical Self-Supervised Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文研究自监督学习中的原型坍缩问题，旨在解决多原型趋同导致表征多样性下降的难题。通过解耦编码器与原型的联合优化，提出基于在线EM的高斯混合原型更新策略，实现无显式正则化下的稳定多样原型，提升下游性能。**

- **链接: [http://arxiv.org/pdf/2510.20108v1](http://arxiv.org/pdf/2510.20108v1)**
...
>
---
#### [replaced 004] HumanCM: One Step Human Motion Prediction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.16709v2](http://arxiv.org/pdf/2510.16709v2)**
...
>
---
#### [replaced 005] DragFlow: Unleashing DiT Priors with Region Based Supervision for Drag Editing
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.02253v2](http://arxiv.org/pdf/2510.02253v2)**
...
>
---
#### [replaced 006] PreFM: Online Audio-Visual Event Parsing via Predictive Future Modeling
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23155v2](http://arxiv.org/pdf/2505.23155v2)**
...
>
---
#### [replaced 007] Learning To Defer To A Population With Limited Demonstrations
- **分类: cs.HC; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.19351v2](http://arxiv.org/pdf/2510.19351v2)**
...
>
---
#### [replaced 008] Spatial-DISE: A Unified Benchmark for Evaluating Spatial Reasoning in Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13394v2](http://arxiv.org/pdf/2510.13394v2)**

> **作者:** Xinmiao Huang; Qisong He; Zhenglin Huang; Boxuan Wang; Zhuoyun Li; Guangliang Cheng; Yi Dong; Xiaowei Huang
>
> **备注:** Project Page: https://shinmohuang.github.io/spatialdise_page/
>
...
>
---
#### [replaced 009] Occluded nuScenes: A Multi-Sensor Dataset for Evaluating Perception Robustness in Automated Driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.18552v2](http://arxiv.org/pdf/2510.18552v2)**
...
>
---
#### [replaced 010] ControlFusion: A Controllable Image Fusion Framework with Language-Vision Degradation Prompts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.23356v2](http://arxiv.org/pdf/2503.23356v2)**

> **作者:** Linfeng Tang; Yeda Wang; Zhanchuan Cai; Junjun Jiang; Jiayi Ma
>
> **备注:** Accepted to NeurIPS 2025. The code are available at https://github.com/Linfeng-Tang/ControlFusion
>
...
>
---
#### [replaced 011] FerretNet: Efficient Synthetic Image Detection via Local Pixel Dependencies
- **分类: cs.CV; cs.AI; I.5.1; I.5.2; I.2.10**

- **链接: [http://arxiv.org/pdf/2509.20890v2](http://arxiv.org/pdf/2509.20890v2)**
...
>
---
#### [replaced 012] A Style-Based Profiling Framework for Quantifying the Synthetic-to-Real Gap in Autonomous Driving Datasets
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.10203v2](http://arxiv.org/pdf/2510.10203v2)**
...
>
---
#### [replaced 013] RADAR: A Risk-Aware Dynamic Multi-Agent Framework for LLM Safety Evaluation via Role-Specialized Collaboration
- **分类: cs.AI; cs.CV; cs.LG; cs.MA**

- **链接: [http://arxiv.org/pdf/2509.25271v4](http://arxiv.org/pdf/2509.25271v4)**
...
>
---
#### [replaced 014] Residual Kolmogorov-Arnold Network for Enhanced Deep Learning
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.05500v3](http://arxiv.org/pdf/2410.05500v3)**
...
>
---
#### [replaced 015] Quantization-Aware Neuromorphic Architecture for Efficient Skin Disease Classification on Resource-Constrained Devices
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15958v2](http://arxiv.org/pdf/2507.15958v2)**

> **作者:** Haitian Wang; Xinyu Wang; Yiren Wang; Zichen Geng; Xian Zhang; Yu Zhang; Bo Miao
>
...
>
---
#### [replaced 016] MCIF: Multimodal Crosslingual Instruction-Following Benchmark from Scientific Talks
...
>
---
#### [replaced 017] A Renaissance of Explicit Motion Information Mining from Transformers for Action Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.18705v2](http://arxiv.org/pdf/2510.18705v2)**
...
>
---
#### [replaced 018] Learning Dense Hand Contact Estimation from Imbalanced Data
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.11152v2](http://arxiv.org/pdf/2505.11152v2)**

> **作者:** Daniel Sungho Jung; Kyoung Mu Lee
>
> **备注:** Accepted at NeurIPS 2025. Project page: http://haco-release.github.io
>
...
>
---
#### [replaced 019] EasyOcc: 3D Pseudo-Label Supervision for Fully Self-Supervised Semantic Occupancy Prediction Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.26087v2](http://arxiv.org/pdf/2509.26087v2)**
...
>
---
#### [replaced 022] MARIS: Marine Open-Vocabulary Instance Segmentation with Geometric Enhancement and Semantic Alignment
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.15398v2](http://arxiv.org/pdf/2510.15398v2)**
...
>
---
#### [replaced 023] Video Consistency Distance: Enhancing Temporal Consistency for Image-to-Video Generation via Reward-Based Fine-Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.19193v2](http://arxiv.org/pdf/2510.19193v2)**

> **作者:** Takehiro Aoshima; Yusuke Shinohara; Byeongseon Park
>
> **备注:** 17 pages
>
...
>
> **备注:** Accepted to NeruIPS 2025 D&B Track
>
...
>
---
#### [replaced 027] ViSpec: Accelerating Vision-Language Models with Vision-Aware Speculative Decoding
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 028] LucidFlux: Caption-Free Universal Image Restoration via a Large-Scale Diffusion Transformer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.22414v2](http://arxiv.org/pdf/2509.22414v2)**
...
>
---
#### [replaced 029] Frequency-Dynamic Attention Modulation for Dense Prediction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.12006v4](http://arxiv.org/pdf/2507.12006v4)**
...
>
---
#### [replaced 030] X-Reflect: Cross-Reflection Prompting for Multimodal Recommendation
...
>
---
#### [replaced 031] REOrdering Patches Improves Vision Models
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23751v3](http://arxiv.org/pdf/2505.23751v3)**
...
>
---
#### [replaced 035] mmWalk: Towards Multi-modal Multi-view Walking Assistance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.11520v2](http://arxiv.org/pdf/2510.11520v2)**
...
>
---
#### [replaced 036] Novel Class Discovery for Point Cloud Segmentation via Joint Learning of Causal Representation and Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.13307v2](http://arxiv.org/pdf/2510.13307v2)**
...
>
---
#### [replaced 037] PlantSegNeRF: A few-shot, cross-species method for plant 3D instance point cloud reconstruction via joint-channel NeRF with multi-view image instance matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.00371v2](http://arxiv.org/pdf/2507.00371v2)**
...
>
---
#### [replaced 038] Toward a Vision-Language Foundation Model for Medical Data: Multimodal Dataset and Benchmarks for Vietnamese PET/CT Report Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.24739v2](http://arxiv.org/pdf/2509.24739v2)**
...
>
---
#### [replaced 039] Vision-Centric Activation and Coordination for Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14349v3](http://arxiv.org/pdf/2510.14349v3)**
...
>
---
#### [replaced 040] Roboflow100-VL: A Multi-Domain Object Detection Benchmark for Vision-Language Models
- **分类: cs.CV; cs.CL; cs.LG**
...
>
---
#### [replaced 043] Balanced Token Pruning: Accelerating Vision Language Models Beyond Local Optimization
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.22038v2](http://arxiv.org/pdf/2505.22038v2)**
...
>
---
#### [replaced 044] Revisiting End-to-End Learning with Slide-level Supervision in Computational Pathology
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.02408v2](http://arxiv.org/pdf/2506.02408v2)**

> **作者:** Wenhao Tang; Rong Qin; Heng Fang; Fengtao Zhou; Hao Chen; Xiang Li; Ming-Ming Cheng
>
> **备注:** published on NeurIPS 2025
>
...
>
---
#### [replaced 045] Generative diffusion model surrogates for mechanistic agent-based biological models
- **分类: q-bio.QM; cs.CV; cs.ET; cs.PF**

- **链接: [http://arxiv.org/pdf/2505.09630v3](http://arxiv.org/pdf/2505.09630v3)**
...
>
---
#### [replaced 046] BevSplat: Resolving Height Ambiguity via Feature-Based Gaussian Primitives for Weakly-Supervised Cross-View Localization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.09080v3](http://arxiv.org/pdf/2502.09080v3)**
...
>
---
#### [replaced 047] CBDiff:Conditional Bernoulli Diffusion Models for Image Forgery Localization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.19597v2](http://arxiv.org/pdf/2510.19597v2)**
...
>
---
#### [replaced 048] CALM-PDE: Continuous and Adaptive Convolutions for Latent Space Modeling of Time-dependent PDEs
- **分类: cs.LG; cs.AI; cs.CV; cs.NE; physics.comp-ph**

- **链接: [http://arxiv.org/pdf/2505.12944v2](http://arxiv.org/pdf/2505.12944v2)**

> **作者:** Jan Hagnberger; Daniel Musekamp; Mathias Niepert
>
> **备注:** Accepted for publication at the 39th Conference on Neural Information Processing Systems (NeurIPS) 2025, San Diego, California, USA
>
...
>
---
#### [replaced 049] A Survey on Cache Methods in Diffusion Models: Toward Efficient Multi-Modal Generation
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.19755v2](http://arxiv.org/pdf/2510.19755v2)**
...
>
---
#### [replaced 050] FairGen: Enhancing Fairness in Text-to-Image Diffusion Models via Self-Discovering Latent Directions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.18810v3](http://arxiv.org/pdf/2412.18810v3)**
...
>
---
#### [replaced 051] Identity-Preserving Image-to-Video Generation via Reward-Guided Optimization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.14255v3](http://arxiv.org/pdf/2510.14255v3)**
...
>
---
#### [replaced 052] GenLit: Reformulating Single-Image Relighting as Video Generation
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2412.11224v4](http://arxiv.org/pdf/2412.11224v4)**
...
>
---
#### [replaced 055] SPLite Hand: Sparsity-Aware Lightweight 3D Hand Pose Estimation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.16396v2](http://arxiv.org/pdf/2510.16396v2)**
...
>
---
#### [replaced 056] VT-FSL: Bridging Vision and Text with LLMs for Few-Shot Learning
- **分类: cs.CV; cs.LG; I.4.9**

- **链接: [http://arxiv.org/pdf/2509.25033v3](http://arxiv.org/pdf/2509.25033v3)**
...
>
---
#### [replaced 057] Rebellious Student: A Complementary Learning Framework for Background Feature Enhancement in Hyperspectral Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.18781v2](http://arxiv.org/pdf/2510.18781v2)**
...
>
---
#### [replaced 058] Frequency Cam: Imaging Periodic Signals in Real-Time
- **分类: cs.CV; cs.NE; I.4.0**

- **链接: [http://arxiv.org/pdf/2211.00198v2](http://arxiv.org/pdf/2211.00198v2)**

> **作者:** Bernd Pfrommer
>
> **备注:** 13 pages, 16 figures, one table
>
...
>
---
#### [replaced 059] MODEM: A Morton-Order Degradation Estimation Mechanism for Adverse Weather Image Recovery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17581v2](http://arxiv.org/pdf/2505.17581v2)**
...
>
---
#### [replaced 060] Towards Physical Understanding in Video Generation: A 3D Point Regularization Approach
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.03639v2](http://arxiv.org/pdf/2502.03639v2)**

> **作者:** Yunuo Chen; Junli Cao; Vidit Goel; Sergei Korolev; Chenfanfu Jiang; Jian Ren; Sergey Tulyakov; Anil Kag
>
> **备注:** Project Page: \url{https://snap-research.github.io/PointVidGen/}
>
...
>
---
#### [replaced 061] JaiLIP: Jailbreaking Vision-Language Models via Loss Guided Image Perturbation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.21401v2](http://arxiv.org/pdf/2509.21401v2)**
...
>
---
#### [replaced 062] Mesh-RFT: Enhancing Mesh Generation via Fine-grained Reinforcement Fine-Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.16761v2](http://arxiv.org/pdf/2505.16761v2)**
...
>
---
#### [replaced 063] Structured Spectral Graph Representation Learning for Multi-label Abnormality Analysis from 3D CT Scans
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.10779v2](http://arxiv.org/pdf/2510.10779v2)**
...
>
---
#### [replaced 064] Grounding Language with Vision: A Conditional Mutual Information Calibrated Decoding Strategy for Reducing Hallucinations in LVLMs
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 068] A novel attention mechanism for noise-adaptive and robust segmentation of microtubules in microscopy images
- **分类: q-bio.QM; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07800v2](http://arxiv.org/pdf/2507.07800v2)**
...
>
---
#### [replaced 069] PolyPose: Deformable 2D/3D Registration via Polyrigid Transformations
- **分类: cs.CV; physics.med-ph**

- **链接: [http://arxiv.org/pdf/2505.19256v5](http://arxiv.org/pdf/2505.19256v5)**
...
>
---
#### [replaced 070] Face-Human-Bench: A Comprehensive Benchmark of Face and Human Understanding for Multi-modal Assistants
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 071] FreeGraftor: Training-Free Cross-Image Feature Grafting for Subject-Driven Text-to-Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.15958v3](http://arxiv.org/pdf/2504.15958v3)**
...
>
---
#### [replaced 072] Uncovering Anomalous Events for Marine Environmental Monitoring via Visual Anomaly Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.10750v2](http://arxiv.org/pdf/2510.10750v2)**

> **作者:** Laura Weihl; Stefan H. Bengtson; Nejc Novak; Malte Pedersen
>
...
>
---
#### [replaced 073] FuseUNet: A Multi-Scale Feature Fusion Method for U-like Networks
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.05821v3](http://arxiv.org/pdf/2506.05821v3)**

> **作者:** Quansong He; Xiangde Min; Kaishen Wang; Tao He
>
> **备注:** Updated author information to clarify institutional affiliation. The research was conducted prior to the author joining the University of Maryland
>
...
>
---
#### [replaced 074] Spiking Neural Networks Need High Frequency Information
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18608v4](http://arxiv.org/pdf/2505.18608v4)**
...
>
---
#### [replaced 075] SeG-SR: Integrating Semantic Knowledge into Remote Sensing Image Super-Resolution via Vision-Language Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23010v2](http://arxiv.org/pdf/2505.23010v2)**
...
>
---
#### [replaced 076] VO-DP: Semantic-Geometric Adaptive Diffusion Policy for Vision-Only Robotic Manipulation
...
>
---
#### [replaced 077] SnapMoGen: Human Motion Generation from Expressive Texts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09122v2](http://arxiv.org/pdf/2507.09122v2)**
...
>
---
#### [replaced 078] Text-conditioned State Space Model For Domain-generalized Change Detection Visual Question Answering
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.08974v2](http://arxiv.org/pdf/2508.08974v2)**
...
>
---
#### [replaced 079] VITRIX-CLIPIN: Enhancing Fine-Grained Visual Understanding in CLIP via Instruction Editing Data and Long Captions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.02329v4](http://arxiv.org/pdf/2508.02329v4)**
...
>
---
#### [replaced 080] Epistemic-aware Vision-Language Foundation Model for Fetal Ultrasound Interpretation
- **分类: cs.CV; cs.AI; cs.IR; cs.MM**

- **链接: [http://arxiv.org/pdf/2510.12953v2](http://arxiv.org/pdf/2510.12953v2)**
