...
#### [new 001] An Artificial Intelligence Framework for Measuring Human Spine Aging Using MRI
- **分类: cs.CV**

- **简介: 该论文提出一种基于深度学习的MRI图像分析框架，用于量化脊柱衰老程度。针对脊柱退行性变的年龄评估难题，利用超1.8万例MRI数据，结合聚类算法筛选纯龄相关退变样本，通过消融实验优化模型，构建脊柱年龄差（SAG）指标。结果表明SAG与椎间盘突出、骨赘、椎管狭窄及吸烟、重体力劳动等密切相关，可作为脊柱健康生物标志物。**

- **链接: [https://arxiv.org/pdf/2511.17485v1](https://arxiv.org/pdf/2511.17485v1)**
...
>
---
#### [new 005] Native 3D Editing with Full Attention
- **分类: cs.CV; cs.GR**

- **简介: 该论文针对指令引导的3D编辑任务，解决现有方法在速度、几何一致性与视觉质量上的不足。提出一种原生3D编辑框架，基于大规模多模态数据集，采用3D令牌拼接策略，实现高效、高保真的单次前向编辑，显著提升生成质量与指令遵循能力。**

- **链接: [https://arxiv.org/pdf/2511.17501v1](https://arxiv.org/pdf/2511.17501v1)**
...
>
---
#### [new 006] Sparse Mixture-of-Experts for Multi-Channel Imaging: Are All Channel Interactions Required?
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对多通道图像（如细胞成像、卫星图像）中视觉变换器的计算效率问题，提出MoE-ViT架构。通过稀疏门控专家系统，仅选择关键通道进行跨通道注意力计算，显著降低FLOPs与训练成本，同时保持甚至提升性能，解决了传统方法中全通道交互带来的计算瓶颈。**

- **链接: [https://arxiv.org/pdf/2511.17400v1](https://arxiv.org/pdf/2511.17400v1)**
...
>
---
#### [new 010] EvDiff: High Quality Video with an Event Camera
- **分类: cs.CV**

- **简介: 该论文提出EvDiff，一种基于事件相机的视频生成方法，旨在从单色事件流生成高质量彩色视频。针对事件数据缺乏亮度绝对信息及传统方法感知质量差的问题，提出单步扩散模型与代理训练框架，利用大规模图像数据提升模型能力，实现高保真、高真实感视频生成。**

- **链接: [https://arxiv.org/pdf/2511.17492v1](https://arxiv.org/pdf/2511.17492v1)**
...
>
---
#### [new 016] WorldGen: From Text to Traversable and Interactive 3D Worlds
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出WorldGen系统，旨在将文本描述自动转化为可交互的3D虚拟世界。针对传统3D建模耗时耗力、需专业技能的问题，论文融合大模型推理、程序化生成与扩散模型，实现从文本到几何一致、视觉丰富、实时渲染的可探索世界生成，推动了生成式AI在游戏与沉浸式场景中的应用。**

- **链接: [https://arxiv.org/pdf/2511.16825v1](https://arxiv.org/pdf/2511.16825v1)**
...
>
> **摘要:** We introduce WorldGen, a system that enables the automatic creation of large-scale, interactive 3D worlds directly from text prompts. Our approach transforms natural language descriptions into traversable, fully textured environments that can be immediately explored or edited within standard game engines. By combining LLM-driven scene layout reasoning, procedural generation, diffusion-based 3D generation, and object-aware scene decomposition, WorldGen bridges the gap between creative intent and functional virtual spaces, allowing creators to design coherent, navigable worlds without manual modeling or specialized 3D expertise. The system is fully modular and supports fine-grained control over layout, scale, and style, producing worlds that are geometrically consistent, visually rich, and efficient to render in real time. This work represents a step towards accessible, generative world-building at scale, advancing the frontier of 3D generative AI for applications in gaming, simulation, and immersive social environments.
>
---
#### [new 017] MCMoE: Completing Missing Modalities with Mixture of Experts for Incomplete Multimodal Action Quality Assessment
- **分类: cs.CV**

- **简介: 该论文针对不完整多模态动作质量评估（AQA）中模态缺失导致模型失效的问题，提出MCMoE框架。通过自适应门控模态生成器重建缺失模态，并利用专家混合机制融合单模态知识，实现统一的单阶段训练与跨模态表示学习，显著提升完整与不完整场景下的性能。**

- **链接: [https://arxiv.org/pdf/2511.17397v1](https://arxiv.org/pdf/2511.17397v1)**
...
>
---
#### [new 018] Non-Parametric Probabilistic Robustness: A Conservative Metric with Optimized Perturbation Distributions
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对深度学习模型在输入扰动下的脆弱性问题，提出非参数概率鲁棒性（NPPR）度量。解决现有概率鲁棒性依赖预设扰动分布的不现实假设，通过数据驱动学习优化扰动分布，实现更保守的鲁棒性评估。基于GMM与MLP设计估计器，在多个数据集和模型上验证其有效性。**

- **链接: [https://arxiv.org/pdf/2511.17380v1](https://arxiv.org/pdf/2511.17380v1)**
...
>
---
#### [new 021] Shape-preserving Tooth Segmentation from CBCT Images Using Deep Learning with Semantic and Shape Awareness
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决CBCT图像中因牙间粘连导致的牙齿形状扭曲问题。提出一种融合语义与形状感知的深度学习框架，通过多标签学习和形状约束机制，实现高保真牙齿边界分割，显著提升分割精度与形态完整性。**

- **链接: [https://arxiv.org/pdf/2511.16936v1](https://arxiv.org/pdf/2511.16936v1)**
...
>
---
#### [new 024] SING3R-SLAM: Submap-based Indoor Monocular Gaussian SLAM with 3D Reconstruction Priors
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 030] ATAC: Augmentation-Based Test-Time Adversarial Correction for CLIP
- **分类: cs.CV**

- **简介: 该论文针对CLIP模型在图像-文本匹配任务中对对抗攻击脆弱的问题，提出一种测试时防御方法ATAC。通过在嵌入空间计算增强扰动的漂移向量，利用角度一致性修正特征，实现高效鲁棒性提升，显著优于现有方法，且计算开销极低。**

- **链接: [https://arxiv.org/pdf/2511.17362v1](https://arxiv.org/pdf/2511.17362v1)**
...
>
---
#### [new 031] Parameter-Free Neural Lens Blur Rendering for High-Fidelity Composites
- **分类: cs.CV; cs.AI; cs.GR; eess.IV**

- **简介: 该论文针对混合现实中虚拟物体与真实场景融合时镜头模糊不一致的问题，提出无需相机参数和深度信息的神经模糊渲染方法。通过从RGB图像直接估计圆周模糊（CoC）图，利用线性关系推导虚拟物体的模糊程度，并采用神经重模糊网络生成逼真虚化效果，实现高保真无参合成。**

- **链接: [https://arxiv.org/pdf/2511.17014v1](https://arxiv.org/pdf/2511.17014v1)**
...
>
---
#### [new 032] Neighbor GRPO: Contrastive ODE Policy Optimization Aligns Flow Models
- **分类: cs.CV; cs.LG; eess.IV**

- **简介: 该论文针对流模型对齐中SDE-based GRPO的低效信用分配与高阶求解器不兼容问题，提出无需SDE的Neighbor GRPO。通过扰动初始噪声生成候选轨迹，基于距离优化实现对比学习，保留ODE高效性，结合对称锚点采样与重加权策略，显著提升训练效率与生成质量。**

- **链接: [https://arxiv.org/pdf/2511.16955v1](https://arxiv.org/pdf/2511.16955v1)**
...
>
---
#### [new 033] Learning to Look Closer: A New Instance-Wise Loss for Small Cerebral Lesion Segmentation
- **分类: cs.CV**

- **简介: 该论文针对小脑部病灶分割中传统损失函数忽略小体积病变的问题，提出CC-DiceCE损失函数，基于实例级评估提升小病灶检测率。在nnU-Net框架下验证，显著提高召回率，轻微增加假阳性，优于现有blob损失。**

- **链接: [https://arxiv.org/pdf/2511.17146v1](https://arxiv.org/pdf/2511.17146v1)**
...
>
---
#### [new 034] Align & Invert: Solving Inverse Problems with Diffusion and Flow-based Models via Representational Alignment
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对图像逆问题（如超分辨率、去模糊等），提出通过表示对齐（REPA）将扩散或流模型与预训练自监督编码器（如DINOv2）对齐，以提升重建质量与效率。无需真实标签，利用近似目标特征实现高效高质重建，理论分析揭示其对感知保真度的促进作用，并在多个任务中验证了方法的通用性与优越性。**

- **链接: [https://arxiv.org/pdf/2511.16870v1](https://arxiv.org/pdf/2511.16870v1)**
...
>
---
#### [new 039] SPAGS: Sparse-View Articulated Object Reconstruction from Single State via Planar Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文针对稀疏视图下可动物体3D重建任务，解决传统方法依赖多视角、多阶段观测的问题。提出SPAGS框架，基于单状态稀疏RGB图像，利用平面高斯点云与深度平滑正则化，结合少样本扩散与部件分割优化，实现高保真部件级表面重建。**

- **链接: [https://arxiv.org/pdf/2511.17092v1](https://arxiv.org/pdf/2511.17092v1)**
...
>
---
#### [new 040] Gradient-Driven Natural Selection for Compact 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文针对3D高斯泼溅（3DGS）模型存储与计算开销大的问题，提出一种受自然选择启发的剪枝框架。通过将生存压力建模为作用于透明度的梯度场，利用优化梯度自动决定保留或剪除高斯分布，实现无需人工干预的可学习剪枝。结合有限透明度先验的衰减技术，显著加速选择过程。在15%预算下，PSNR提升超0.6dB，达到当前最优紧凑3DGS性能。**

- **链接: [https://arxiv.org/pdf/2511.16980v1](https://arxiv.org/pdf/2511.16980v1)**
...
>
---
#### [new 041] One-Step Diffusion Transformer for Controllable Real-World Image Super-Resolution
- **分类: cs.CV**

- **简介: 该论文针对真实世界图像超分辨率（Real-ISR）任务，解决多步方法保真度低、单步方法控制灵活性差的问题。提出ODTSR模型，通过噪声混合视觉流与保真度感知对抗训练，实现一次推理下兼顾高保真与可控性，显著提升复杂场景如中文文本图像的超分效果。**

- **链接: [https://arxiv.org/pdf/2511.17138v1](https://arxiv.org/pdf/2511.17138v1)**
...
>
---
#### [new 049] MuM: Multi-View Masked Image Modeling for 3D Vision
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出MuM，一种多视角掩码图像建模方法，用于3D视觉。针对现有自监督学习模型侧重语义而非几何理解的问题，通过扩展掩码自编码器至多视图场景，利用统一掩码和轻量解码器实现更高效、可扩展的3D特征学习，在重建、匹配与位姿估计任务上超越DINOv3和CroCo v2。**

- **链接: [https://arxiv.org/pdf/2511.17309v1](https://arxiv.org/pdf/2511.17309v1)**
...
>
---
#### [new 050] Two Heads Better than One: Dual Degradation Representation for Blind Super-Resolution
- **分类: cs.CV**

- **简介: 该论文针对盲超分辨率（Blind SR）任务，解决真实图像中未知且复杂的退化问题。提出双分支退化提取网络，分别预测模糊与噪声的无监督退化嵌入，使超分网络可差异化处理。通过将退化提取器作为正则化器，利用高低分辨率图像差异提升性能，实现当前最优盲超分辨率效果。**

- **链接: [https://arxiv.org/pdf/2511.16963v1](https://arxiv.org/pdf/2511.16963v1)**
...
>
---
#### [new 051] Loomis Painter: Reconstructing the Painting Process
- **分类: cs.CV**

- **简介: 该论文针对艺术学习中视频教程缺乏交互与个性化的问题，提出Loomis Painter框架，实现跨媒体绘画过程生成。通过语义驱动的风格控制与逆向训练，提升生成结果的时序一致性与风格迁移能力，构建大规模真实绘画数据集并量化创作过程，有效模拟人类创作流程。**

- **链接: [https://arxiv.org/pdf/2511.17344v1](https://arxiv.org/pdf/2511.17344v1)**
...
>
---
#### [new 057] SAM 3: Segment Anything with Concepts
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出SAM 3，解决图像与视频中基于概念提示的可提示概念分割（PCS）任务。通过构建包含400万独特概念标签的高质量数据集，设计共享主干的检测与追踪架构，实现高精度对象检测、分割与跟踪。模型在图像和视频任务上性能翻倍，并开源了SA-Co基准。**

- **链接: [https://arxiv.org/pdf/2511.16719v1](https://arxiv.org/pdf/2511.16719v1)**
...
>
---
#### [new 066] Illustrator's Depth: Monocular Layer Index Prediction for Image Decomposition
- **分类: cs.CV**

- **简介: 该论文提出“Illustrator's Depth”，一种用于图像分解的创造性深度概念，旨在将扁平图像分解为可编辑的有序图层。针对数字内容创作中图像可编辑性难题，通过神经网络从光栅图直接预测层序索引，实现高效图像矢量化、文本生成矢量图、3D浮雕生成与深度感知编辑，推动了可编辑图像分解的新范式。**

- **链接: [https://arxiv.org/pdf/2511.17454v1](https://arxiv.org/pdf/2511.17454v1)**
...
>
> **摘要:** We introduce Illustrator's Depth, a novel definition of depth that addresses a key challenge in digital content creation: decomposing flat images into editable, ordered layers. Inspired by an artist's compositional process, illustrator's depth infers a layer index to each pixel, forming an interpretable image decomposition through a discrete, globally consistent ordering of elements optimized for editability. We also propose and train a neural network using a curated dataset of layered vector graphics to predict layering directly from raster inputs. Our layer index inference unlocks a range of powerful downstream applications. In particular, it significantly outperforms state-of-the-art baselines for image vectorization while also enabling high-fidelity text-to-vector-graphics generation, automatic 3D relief generation from 2D images, and intuitive depth-aware editing. By reframing depth from a physical quantity to a creative abstraction, illustrator's depth prediction offers a new foundation for editable image decomposition.
>
---
#### [new 067] PairHuman: A High-Fidelity Photographic Dataset for Customized Dual-Person Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对个性化双人肖像生成任务，解决缺乏高质量基准数据集的问题。提出PairHuman数据集，包含超10万张高保真双人图像及丰富元信息，并构建DHumanDiff模型，提升面部一致性与个性化生成效果，实验验证其在视觉质量与人类偏好上的优越性。**

- **链接: [https://arxiv.org/pdf/2511.16712v1](https://arxiv.org/pdf/2511.16712v1)**
...
>
---
#### [new 071] REMSA: An LLM Agent for Foundation Model Selection in Remote Sensing
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对遥感领域基础模型选择困难的问题，提出REMSEA——首个基于大语言模型的自动化选型代理。基于自建的RS-FMD数据库与75个专家验证查询场景，通过自然语言理解、约束补全与上下文学习排序，实现高效、透明的模型推荐，显著优于基线方法。**

- **链接: [https://arxiv.org/pdf/2511.17442v1](https://arxiv.org/pdf/2511.17442v1)**
...
>
---
#### [new 077] FisheyeGaussianLift: BEV Feature Lifting for Surround-View Fisheye Camera Perception
- **分类: cs.CV**

- **简介: 该论文针对全景鱼眼相机感知中的非线性畸变、遮挡和深度模糊问题，提出FisheyeGaussianLift框架。通过高斯参数化实现像素到3D空间的可微投影，融合多视角鱼眼图像生成带不确定性的鸟瞰图（BEV）语义分割结果，无需去畸变或透视校正，显著提升复杂场景下的分割精度。**

- **链接: [https://arxiv.org/pdf/2511.17210v1](https://arxiv.org/pdf/2511.17210v1)**
...
>
---
#### [new 091] The Joint Gromov Wasserstein Objective for Multiple Object Matching
- **分类: cs.CV; q-bio.BM**

- **简介: 该论文针对多对象匹配任务，解决传统Gromov-Wasserstein仅能处理成对匹配的局限。提出联合Gromov-Wasserstein（JGW）目标，实现多对一或多对多的同步匹配，支持点云表示，兼具高精度与高效性，在几何形状与生物分子复合物匹配中表现优异。**

- **链接: [https://arxiv.org/pdf/2511.16868v1](https://arxiv.org/pdf/2511.16868v1)**
...
>
---
#### [new 092] A Multi-Stage Optimization Framework for Deploying Learned Image Compression on FPGAs
- **分类: cs.CV**

- **简介: 该论文针对深度学习图像压缩（LIC）在资源受限FPGA上的部署难题，提出多阶段优化框架。通过动态范围感知量化与硬件友好的混合精度搜索、通道剪枝，实现高保真8位整数模型，显著降低计算复杂度并提升性能，优于现有FPGA部署方案。**

- **链接: [https://arxiv.org/pdf/2511.17135v1](https://arxiv.org/pdf/2511.17135v1)**

> **作者:** Jiaxun Fang; Li Chen
>
> **摘要:** Deep learning-based image compression (LIC) has achieved state-of-the-art rate-distortion (RD) performance, yet deploying these models on resource-constrained FPGAs remains a major challenge. This work presents a complete, multi-stage optimization framework to bridge the gap between high-performance floating-point models and efficient, hardware-friendly integer-based implementations. First, we address the fundamental problem of quantization-induced performance degradation. We propose a Dynamic Range-Aware Quantization (DRAQ) method that uses statistically-calibrated activation clipping and a novel weight regularization scheme to counteract the effects of extreme data outliers and large dynamic ranges, successfully creating a high-fidelity 8-bit integer model. Second, building on this robust foundation, we introduce two hardware-aware optimization techniques tailored for FPGAs. A progressive mixed-precision search algorithm exploits FPGA flexibility to assign optimal, non-uniform bit-widths to each layer, minimizing complexity while preserving performance. Concurrently, a channel pruning method, adapted to work with the Generalized Divisive Normalization (GDN) layers common in LIC, removes model redundancy by eliminating inactive channels. Our comprehensive experiments show that the foundational DRAQ method reduces the BD-rate overhead of a GDN-based model from $30\%$ to $6.3\%$. The subsequent hardware-aware optimizations further reduce computational complexity by over $20\%$ with negligible impact on RD performance, yielding a final model that is both state-of-the-art in efficiency and superior in quality to existing FPGA-based LIC implementations.
>
---
#### [new 093] DepthFocus: Controllable Depth Estimation for See-Through Scenes
- **分类: cs.CV**

- **简介: 该论文针对透明场景中多层深度模糊问题，提出DepthFocus——一种可控制深度估计的视觉变换模型。通过引入深度偏好指令，实现对指定深度层的主动感知，解决传统方法仅估计近表面深度的局限。基于50万张合成数据训练，模型在多深度基准上表现优异，具备强泛化能力，推动了类人主动3D感知的发展。**

- **链接: [https://arxiv.org/pdf/2511.16993v1](https://arxiv.org/pdf/2511.16993v1)**
...
>
---
#### [new 094] Video-R4: Reinforcing Text-Rich Video Reasoning with Visual Rumination
- **分类: cs.CV**

- **简介: 该论文针对文本丰富视频理解任务，解决模型因单次扫描遗漏细粒度文本线索导致的幻觉问题。提出Video-R4，通过视觉沉思机制迭代选择帧、局部放大、重编码并更新推理状态，构建两个数据集并设计多阶段学习框架，显著提升视频问答与文档、幻灯片等多场景泛化能力。**

- **链接: [https://arxiv.org/pdf/2511.17490v1](https://arxiv.org/pdf/2511.17490v1)**
...
>
---
#### [new 095] MorphSeek: Fine-grained Latent Representation-Level Policy Optimization for Deformable Image Registration
- **分类: cs.CV**

- **简介: 该论文针对医学图像变形配准任务，解决高维形变空间与稀疏体素监督难题。提出MorphSeek框架，通过潜空间的细粒度策略优化，实现高效、数据驱动的配准，支持粗到精迭代，提升精度与标签效率。**

- **链接: [https://arxiv.org/pdf/2511.17392v1](https://arxiv.org/pdf/2511.17392v1)**
...
>
---
#### [new 105] VLA-4D: Embedding 4D Awareness into Vision-Language-Action Models for SpatioTemporally Coherent Robotic Manipulation
- **分类: cs.CV**

- **简介: 该论文针对视觉-语言-动作模型在机器人操作中时空一致性不足的问题，提出VLA-4D模型。通过引入4D视觉表征与时空动作表示，实现空间平滑、时间连贯的操控。在扩展数据集上进行训练与验证，显著提升复杂任务中的表现。**

- **链接: [https://arxiv.org/pdf/2511.17199v1](https://arxiv.org/pdf/2511.17199v1)**
...
>
---
#### [new 106] Point-Supervised Facial Expression Spotting with Gaussian-Based Instance-Adaptive Intensity Modeling
- **分类: cs.CV**

- **简介: 该论文研究点监督下的人脸表情定位任务（P-FES），旨在仅用每实例一个时间戳标注，解决传统方法依赖密集标注的问题。提出双分支框架：基于高斯分布的自适应强度建模（GIM）实现软伪标签生成，增强强度监督；设计分类分支区分宏/微表情。引入强度感知对比损失，提升特征判别性。**

- **链接: [https://arxiv.org/pdf/2511.16952v1](https://arxiv.org/pdf/2511.16952v1)**
...
>
---
#### [new 109] Continual Alignment for SAM: Rethinking Foundation Models for Medical Image Segmentation in Continual Learning
- **分类: cs.CV**

- **简介: 该论文针对医疗图像分割中的持续学习问题，提出CA-SAM方法。针对机构间数据隐私限制导致无法联合训练的难题，利用SAM模型的零样本先验能力，设计轻量级对齐层以高效适应医学图像，通过自动选择适配模块缓解灾难性遗忘，在九个数据集上实现先进性能。**

- **链接: [https://arxiv.org/pdf/2511.17201v1](https://arxiv.org/pdf/2511.17201v1)**
...
>
---
#### [new 110] Downscaling Intelligence: Exploring Perception and Reasoning Bottlenecks in Small Multimodal Models
- **分类: cs.CV**

- **简介: 该论文研究小规模多模态模型的智能下放问题，旨在解决模型缩小时视觉感知能力显著下降的瓶颈。通过分析发现，语言模型缩小对视觉理解影响远超推理能力。为此提出Extract+Think方法，结合视觉细节提取与分步推理，显著提升小模型的视觉感知与推理性能。**

- **链接: [https://arxiv.org/pdf/2511.17487v1](https://arxiv.org/pdf/2511.17487v1)**
...
>
---
#### [new 111] A lightweight detector for real-time detection of remote sensing images
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对遥感图像中小目标实时检测难题，提出轻量级检测器DMG-YOLO。通过双分支特征提取、多尺度融合与全局-局部特征金字塔网络，有效平衡精度与效率，在保持小模型体积的同时提升检测性能。**

- **链接: [https://arxiv.org/pdf/2511.17147v1](https://arxiv.org/pdf/2511.17147v1)**
...
>
---
#### [new 116] Self-Supervised Learning by Curvature Alignment
- **分类: cs.LG; cs.CV; stat.ML**

- **简介: 该论文提出CurvSSL，一种基于曲率正则化的自监督学习方法，旨在捕捉数据流形的局部几何结构。针对现有方法忽略流形局部几何的问题，通过在投影特征上计算曲率并引入曲率对齐损失，增强视图间一致性与流形弯曲的一致性。实验表明其在MNIST和CIFAR-10上性能优于或相当Barlow Twins和VICReg。**

- **链接: [https://arxiv.org/pdf/2511.17426v1](https://arxiv.org/pdf/2511.17426v1)**
...
>
---
#### [new 117] IndustryNav: Exploring Spatial Reasoning of Embodied Agents in Dynamic Industrial Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 118] OmniLens++: Blind Lens Aberration Correction via Large LensLib Pre-Training and Latent PSF Representation
- **分类: eess.IV; cs.CV; cs.LG; physics.optics**

- **简介: 该论文针对盲镜头像畸变校正任务，解决现有方法泛化能力差、数据难扩展及缺乏光学退化先验的问题。提出OmniLens++框架，通过扩大镜头库多样性并引入潜空间点扩散函数表示（LPR），提升模型对未知畸变的适应能力，实现更优的盲校正性能。**

- **链接: [https://arxiv.org/pdf/2511.17126v1](https://arxiv.org/pdf/2511.17126v1)**
...
>
---
#### [new 119] TP-MDDN: Task-Preferenced Multi-Demand-Driven Navigation with Autonomous Decision-Making
...
>
---
#### [new 120] MobileOcc: A Human-Aware Semantic Occupancy Dataset for Mobile Robots
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 121] Leveraging CVAE for Joint Configuration Estimation of Multifingered Grippers from Point Cloud Data
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 122] Robot Confirmation Generation and Action Planning Using Long-context Q-Former Integrated with Multimodal LLM
...
>
---
#### [new 123] Energy Scaling Laws for Diffusion Models: Quantifying Compute and Carbon Emissions in Image Generation
- **分类: cs.LG; cs.CV; cs.CY**

- **简介: 该论文针对扩散模型图像生成中的高能耗问题，提出基于FLOPs的能源缩放定律，通过分解推理过程量化各组件能耗，验证了去噪步骤主导能耗，并实现跨架构高精度能源预测，为可持续AI部署提供工具。**

- **链接: [https://arxiv.org/pdf/2511.17031v1](https://arxiv.org/pdf/2511.17031v1)**
...
>
---
#### [new 124] Exploring the added value of pretherapeutic MR descriptors in predicting breast cancer pathologic complete response to neoadjuvant chemotherapy
- **分类: physics.med-ph; cs.CV**

- **简介: 该论文属于医学影像与临床预测任务，旨在提升乳腺癌新辅助化疗后病理完全缓解（pCR）的预测精度。研究通过回顾性分析129例患者，结合MRI特征与临床生物标志物，发现非毛刺状边缘和单发病灶是独立预测因子，并证实融合MRI特征可显著提升机器学习模型的预测性能。**

- **链接: [https://arxiv.org/pdf/2511.17158v1](https://arxiv.org/pdf/2511.17158v1)**
...
>
---
#### [new 125] Revisiting Multimodal KV Cache Compression: A Frequency-Domain-Guided Outlier-KV-Aware Approach
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文针对多模态大模型推理中KV缓存过大的问题，提出FlashCache框架。通过频域分析提取主能量成分，识别关键的异常KV对，结合动态预算分配，实现高效压缩。显著降低内存占用与推理延迟，优于现有方法。**

- **链接: [https://arxiv.org/pdf/2511.16786v1](https://arxiv.org/pdf/2511.16786v1)**
...
>
---
#### [new 126] MRI Super-Resolution with Deep Learning: A Comprehensive Survey
- **分类: eess.IV; cs.AI; cs.CV; eess.SP**

- **简介: 该论文综述基于深度学习的磁共振成像超分辨率技术，旨在用低成本低分辨率MRI生成高分辨率图像，以提升诊断准确性。系统梳理了相关方法的理论基础、网络架构与评估体系，提出分类框架，并提供开源资源，推动该领域发展。**

- **链接: [https://arxiv.org/pdf/2511.16854v1](https://arxiv.org/pdf/2511.16854v1)**
...
>
---
#### [new 127] Lost in Translation and Noise: A Deep Dive into the Failure Modes of VLMs on Real-World Tables
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [new 130] Learning Latent Transmission and Glare Maps for Lens Veiling Glare Removal
- **分类: eess.IV; cs.CV; physics.optics**

- **简介: 该论文针对紧凑光学系统中由杂散光散射引起的视场遮蔽眩光问题，提出VeilGen生成模型与DeVeiler恢复网络。通过无监督学习估计潜空间的光学透射与眩光图，实现真实眩光合成与高效去眩光，显著提升图像恢复质量与物理一致性。**

- **链接: [https://arxiv.org/pdf/2511.17353v1](https://arxiv.org/pdf/2511.17353v1)**
...
>
---
#### [new 131] MedImageInsight for Thoracic Cavity Health Classification from Chest X-rays
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文针对胸片诊断中影像量大、放射科医生负担重的问题，提出使用MedImageInsight模型进行胸部腔体健康状态的二分类（正常/异常）。通过微调和特征提取两种方式，验证了模型在真实临床数据上的高效性，实现高准确率分类，支持临床辅助诊断与工作流集成。**

- **链接: [https://arxiv.org/pdf/2511.17043v1](https://arxiv.org/pdf/2511.17043v1)**
...
#### [replaced 001] Deep Learning Analysis of Prenatal Ultrasound for Identification of Ventriculomegaly
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.07827v2](https://arxiv.org/pdf/2511.07827v2)**
...
>
---
#### [replaced 002] DocSLM: A Small Vision-Language Model for Long Multimodal Document Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.11313v3](https://arxiv.org/pdf/2511.11313v3)**
...
>
---
#### [replaced 003] SpotFormer: Multi-Scale Spatio-Temporal Transformer for Facial Expression Spotting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2407.20799v2](https://arxiv.org/pdf/2407.20799v2)**
...
>
---
#### [replaced 004] CleverDistiller: Simple and Spatially Consistent Cross-modal Distillation
...
>
---
#### [replaced 005] TDSNNs: Competitive Topographic Deep Spiking Neural Networks for Visual Cortex Modeling
- **分类: cs.NE; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.04270v2](https://arxiv.org/pdf/2508.04270v2)**
...
>
---
#### [replaced 008] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.21502v2](https://arxiv.org/pdf/2505.21502v2)**
...
>
---
#### [replaced 009] ID-Crafter: VLM-Grounded Online RL for Compositional Multi-Subject Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.00511v3](https://arxiv.org/pdf/2511.00511v3)**
...
>
---
#### [replaced 010] Forecasting Future Anatomies: Longitudinal Brain Mri-to-Mri Prediction
- **分类: cs.CV; cs.LG; q-bio.NC**

- **链接: [https://arxiv.org/pdf/2511.02558v2](https://arxiv.org/pdf/2511.02558v2)**
...
>
---
#### [replaced 011] BeyondFacial: Identity-Preserving Personalized Generation Beyond Facial Close-ups
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.11989v2](https://arxiv.org/pdf/2511.11989v2)**
...
>
---
#### [replaced 013] VSI: Visual Subtitle Integration for Keyframe Selection to enhance Long Video Understanding
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.06869v3](https://arxiv.org/pdf/2508.06869v3)**

> **作者:** Jianxiang He; Meisheng Hong; Jungang Li; Ziyang Chen; Weiyu Guo; Xuming Hu; Hui Xiong
>
...
>
---
#### [replaced 017] Disentangled Concepts Speak Louder Than Words: Explainable Video Action Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.03725v2](https://arxiv.org/pdf/2511.03725v2)**
...
>
---
#### [replaced 020] AV-Lip-Sync+: Leveraging AV-HuBERT to Exploit Multimodal Inconsistency for Deepfake Detection of Frontal Face Videos
...
>
---
#### [replaced 021] Lung-DDPM+: Efficient Thoracic CT Image Synthesis using Diffusion Probabilistic Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09327v2](https://arxiv.org/pdf/2508.09327v2)**

> **作者:** Yifan Jiang; Ahmad Shariftabrizi; Venkata SK. Manem
>
> **备注:** Accepted by Computers in Biology and Medicine (CIBM)
>
...
>
---
#### [replaced 022] LinVideo: A Post-Training Framework towards O(n) Attention in Efficient Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.08318v2](https://arxiv.org/pdf/2510.08318v2)**
...
>
---
#### [replaced 023] Comparative Study of UNet-based Architectures for Liver Tumor Segmentation in Multi-Phase Contrast-Enhanced Computed Tomography
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.25522v3](https://arxiv.org/pdf/2510.25522v3)**
...
>
---
#### [replaced 024] HazeMatching: Dehazing Light Microscopy Images with Guided Conditional Flow Matching
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.22397v5](https://arxiv.org/pdf/2506.22397v5)**
...
>
---
#### [replaced 025] EvoLMM: Self-Evolving Large Multimodal Models with Continuous Rewards
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.16672v2](https://arxiv.org/pdf/2511.16672v2)**
...
>
---
#### [replaced 026] Universal Video Temporal Grounding with Generative Multi-modal Large Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.18883v2](https://arxiv.org/pdf/2506.18883v2)**
...
>
---
#### [replaced 027] One Small Step in Latent, One Giant Leap for Pixels: Fast Latent Upscale Adapter for Your Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.10629v2](https://arxiv.org/pdf/2511.10629v2)**
...
>
---
#### [replaced 028] ORV: 4D Occupancy-centric Robot Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.03079v2](https://arxiv.org/pdf/2506.03079v2)**
...
>
---
#### [replaced 030] The Cooperative Network Architecture: Learning Structured Networks as Representation of Sensory Patterns
- **分类: cs.CV; cs.AI; cs.LG; cs.NE**

- **链接: [https://arxiv.org/pdf/2407.05650v5](https://arxiv.org/pdf/2407.05650v5)**

> **作者:** Pascal J. Sager; Jan M. Deriu; Benjamin F. Grewe; Thilo Stadelmann; Christoph von der Malsburg
>
> **备注:** Accepted at Neural Computation
>
...
>
---
#### [replaced 033] Aligning Vision to Language: Annotation-Free Multimodal Knowledge Graph Construction for Enhanced LLMs Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2503.12972v3](https://arxiv.org/pdf/2503.12972v3)**

> **作者:** Junming Liu; Siyuan Meng; Yanting Gao; Song Mao; Pinlong Cai; Guohang Yan; Yirong Chen; Zilin Bian; Ding Wang; Botian Shi
>
> **备注:** 14 pages, 7 figures, 6 tables; Accepted by ICCV 2025
>
...
>
---
#### [replaced 034] Text2Traffic: A Text-to-Image Generation and Editing Method for Traffic Scenes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.12932v2](https://arxiv.org/pdf/2511.12932v2)**
...
>
---
#### [replaced 035] A Unified Voxel Diffusion Module for Point Cloud 3D Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.16069v2](https://arxiv.org/pdf/2508.16069v2)**
...
>
---
#### [replaced 036] SF-Recon: Simplification-Free Lightweight Building Reconstruction via 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13278v2](https://arxiv.org/pdf/2511.13278v2)**
...
>
---
#### [replaced 037] Supervised Contrastive Learning for Few-Shot AI-Generated Image Detection and Attribution
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.16541v2](https://arxiv.org/pdf/2511.16541v2)**
...
>
---
#### [replaced 038] T2I-RiskyPrompt: A Benchmark for Safety Evaluation, Attack, and Defense on Text-to-Image Model
- **分类: cs.CR; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.22300v2](https://arxiv.org/pdf/2510.22300v2)**
...
>
---
#### [replaced 039] Attention Via Convolutional Nearest Neighbors
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.14137v2](https://arxiv.org/pdf/2511.14137v2)**
...
>
---
#### [replaced 047] From Perception to Reasoning: Deep Thinking Empowers Multimodal Large Language Models
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 048] Model-Agnostic Gender Bias Control for Text-to-Image Generation via Sparse Autoencoder
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.20973v2](https://arxiv.org/pdf/2507.20973v2)**
...
>
---
#### [replaced 055] A statistical method for crack pre-detection in 3D concrete images
- **分类: cs.CV; stat.AP**

- **链接: [https://arxiv.org/pdf/2402.16126v2](https://arxiv.org/pdf/2402.16126v2)**
...
>
---
#### [replaced 056] FinCriticalED: A Visual Benchmark for Financial Fact-Level OCR Evaluation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.14998v2](https://arxiv.org/pdf/2511.14998v2)**
...
>
---
#### [replaced 057] Automated Muscle and Fat Segmentation in Computed Tomography for Comprehensive Body Composition Analysis
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2502.09779v4](https://arxiv.org/pdf/2502.09779v4)**
...
>
> **备注:** Accepted for publication at the Journal of Machine Learning for Biomedical Imaging (MELBA) https://melba-journal.org/2025:026
>
...
>
---
#### [replaced 060] Semantic-ICP: Iterative Closest Point for Non-rigid Multi-Organ Point Cloud Registration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.00972v3](https://arxiv.org/pdf/2503.00972v3)**

> **作者:** Wanwen Chen; Qi Zeng; Carson Studders; Jamie J. Y. Kwon; Emily H. T. Pang; Eitan Prisman; Septimiu E. Salcudean
>
...
>
---
#### [replaced 061] PhyBlock: A Progressive Benchmark for Physical Understanding and Planning via 3D Block Assembly
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 065] Performance of Conformal Prediction in Capturing Aleatoric Uncertainty
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.05826v2](https://arxiv.org/pdf/2509.05826v2)**
...
>
---
#### [replaced 066] ResMatching: Noise-Resilient Computational Super-Resolution via Guided Conditional Flow Matching
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.26601v2](https://arxiv.org/pdf/2510.26601v2)**
...
>
---
#### [replaced 069] Behind the Screens: Uncovering Bias in AI-Driven Video Interview Assessments Using Counterfactuals
- **分类: cs.HC; cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2505.12114v2](https://arxiv.org/pdf/2505.12114v2)**
...
>
---
#### [replaced 072] Automated Interpretable 2D Video Extraction from 3D Echocardiography
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.15946v2](https://arxiv.org/pdf/2511.15946v2)**

> **作者:** Milos Vukadinovic; Hirotaka Ieki; Yuki Sahashi; David Ouyang; Bryan He
>
...
>
---
#### [replaced 073] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
- **分类: cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2503.06677v5](https://arxiv.org/pdf/2503.06677v5)**
...
>
---
#### [replaced 074] Resolving Sentiment Discrepancy for Multimodal Sentiment Detection via Semantics Completion and Decomposition
...
>
---
#### [replaced 075] Weakly Supervised Pneumonia Localization from Chest X-Rays Using Deep Neural Network and Grad-CAM Explanations
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.00456v3](https://arxiv.org/pdf/2511.00456v3)**
...
>
---
#### [replaced 076] FAR: Function-preserving Attention Replacement for IMC-friendly Inference
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.21535v3](https://arxiv.org/pdf/2505.21535v3)**

> **作者:** Yuxin Ren; Maxwell D Collins; Miao Hu; Huanrui Yang
>
> **备注:** 12 pages main paper, 6 figures
>
...
>
---
#### [replaced 077] PaddleOCR-VL: Boosting Multilingual Document Parsing via a 0.9B Ultra-Compact Vision-Language Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.14528v3](https://arxiv.org/pdf/2510.14528v3)**
...
>
---
#### [replaced 078] VLA-Pruner: Temporal-Aware Dual-Level Visual Token Pruning for Efficient Vision-Language-Action Inference
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.16449v2](https://arxiv.org/pdf/2511.16449v2)**
