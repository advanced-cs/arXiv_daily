...
>
---
#### [new 003] SALAD: Achieve High-Sparsity Attention via Efficient Linear Attention Tuning for Video Diffusion Transformer
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决视频扩散Transformer中因长序列导致的计算延迟问题。提出SALAD方法，通过引入轻量级线性注意力分支，实现高稀疏性与高效推理。**

- **链接: [https://arxiv.org/pdf/2601.16515v1](https://arxiv.org/pdf/2601.16515v1)**
...
>
> **摘要:** Modern Vision-Language Models (VLMs) remain poorly characterized in multi-step visual interactions, particularly in how they integrate perception, memory, and action over long horizons. We introduce VisGym, a gymnasium of 17 environments for evaluating and training VLMs. The suite spans symbolic puzzles, real-image understanding, navigation, and manipulation, and provides flexible controls over difficulty, input representation, planning horizon, and feedback. We also provide multi-step solvers that generate structured demonstrations, enabling supervised finetuning. Our evaluations show that all frontier models struggle in interactive settings, achieving low success rates in both the easy (46.6%) and hard (26.0%) configurations. Our experiments reveal notable limitations: models struggle to effectively leverage long context, performing worse with an unbounded history than with truncated windows. Furthermore, we find that several text-based symbolic tasks become substantially harder once rendered visually. However, explicit goal observations, textual feedback, and exploratory demonstrations in partially observable or unknown-dynamics settings for supervised finetuning yield consistent gains, highlighting concrete failure modes and pathways for improving multi-step visual decision-making. Code, data, and models can be found at: https://visgym.github.io/.
>
---
#### [new 022] Affinity Contrastive Learning for Skeleton-based Human Activity Understanding
- **分类: cs.CV**

- **简介: 该论文属于骨架动作理解任务，解决特征区分度不足问题。提出ACLNet，通过亲和力对比学习提升特征空间的区分能力。**

- **链接: [https://arxiv.org/pdf/2601.16694v1](https://arxiv.org/pdf/2601.16694v1)**
...
>
---
#### [new 030] AnyView: Synthesizing Any Novel View in Dynamic Scenes
...
>
---
#### [new 031] VISTA-PATH: An interactive foundation model for pathology image segmentation and quantitative analysis in computational pathology
- **分类: cs.CV**

- **简介: 该论文属于病理图像分割任务，旨在解决传统模型与病理学不匹配的问题。提出VISTA-PATH模型，结合视觉上下文和专家反馈，实现精准多类分割，并提升临床分析效果。**

- **链接: [https://arxiv.org/pdf/2601.16451v1](https://arxiv.org/pdf/2601.16451v1)**

> **作者:** Peixian Liang; Songhao Li; Shunsuke Koga; Yutong Li; Zahra Alipour; Yucheng Tang; Daguang Xu; Zhi Huang
>
> **摘要:** Accurate semantic segmentation for histopathology image is crucial for quantitative tissue analysis and downstream clinical modeling. Recent segmentation foundation models have improved generalization through large-scale pretraining, yet remain poorly aligned with pathology because they treat segmentation as a static visual prediction task. Here we present VISTA-PATH, an interactive, class-aware pathology segmentation foundation model designed to resolve heterogeneous structures, incorporate expert feedback, and produce pixel-level segmentation that are directly meaningful for clinical interpretation. VISTA-PATH jointly conditions segmentation on visual context, semantic tissue descriptions, and optional expert-provided spatial prompts, enabling precise multi-class segmentation across heterogeneous pathology images. To support this paradigm, we curate VISTA-PATH Data, a large-scale pathology segmentation corpus comprising over 1.6 million image-mask-text triplets spanning 9 organs and 93 tissue classes. Across extensive held-out and external benchmarks, VISTA-PATH consistently outperforms existing segmentation foundation models. Importantly, VISTA-PATH supports dynamic human-in-the-loop refinement by propagating sparse, patch-level bounding-box annotation feedback into whole-slide segmentation. Finally, we show that the high-fidelity, class-aware segmentation produced by VISTA-PATH is a preferred model for computational pathology. It improve tissue microenvironment analysis through proposed Tumor Interaction Score (TIS), which exhibits strong and significant associations with patient survival. Together, these results establish VISTA-PATH as a foundation model that elevates pathology image segmentation from a static prediction to an interactive and clinically grounded representation for digital pathology. Source code and demo can be found at https://github.com/zhihuanglab/VISTA-PATH.
>
---
#### [new 032] Domain-invariant Mixed-domain Semi-supervised Medical Image Segmentation with Clustered Maximum Mean Discrepancy Alignment
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，解决混合领域下标注稀缺与域差异问题。提出一种结合数据增强和域对齐的方法，提升分割性能。**

- **链接: [https://arxiv.org/pdf/2601.16954v1](https://arxiv.org/pdf/2601.16954v1)**
...
>
---
#### [new 036] CER-HV: A CER-Based Human-in-the-Loop Framework for Cleaning Datasets Applied to Arabic-Script HTR
- **分类: cs.CV**

- **简介: 该论文属于阿拉伯语手写文本识别任务，旨在解决数据集标签错误问题。提出CER-HV框架，结合模型检测与人工验证，提升数据质量并优化识别效果。**

- **链接: [https://arxiv.org/pdf/2601.16713v1](https://arxiv.org/pdf/2601.16713v1)**
...
>
---
#### [new 037] Flow Matching for Probabilistic Monocular 3D Human Pose Estimation
- **分类: cs.CV**

- **简介: 该论文属于单目3D人体姿态估计任务，旨在解决深度模糊导致的3D姿态估计不准确问题。提出FMPose方法，通过流匹配生成更准确的3D姿态分布。**

- **链接: [https://arxiv.org/pdf/2601.16763v1](https://arxiv.org/pdf/2601.16763v1)**
...
>
---
#### [new 045] A Step to Decouple Optimization in 3DGS
- **分类: cs.CV**

- **简介: 该论文属于3DGS优化任务，旨在解决优化过程中的耦合问题。通过解耦更新步骤与梯度，提出改进的优化方法，提升效率与效果。**

- **链接: [https://arxiv.org/pdf/2601.16736v1](https://arxiv.org/pdf/2601.16736v1)**
...
>
---
#### [new 046] LoL: Longer than Longer, Scaling Video Generation to Hour
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频生成任务，解决长视频生成中的sink-collapse问题。通过引入多头RoPE抖动，抑制重复内容，实现高质量长时视频生成。**

- **链接: [https://arxiv.org/pdf/2601.16914v1](https://arxiv.org/pdf/2601.16914v1)**

> **作者:** Justin Cui; Jie Wu; Ming Li; Tao Yang; Xiaojie Li; Rui Wang; Andrew Bai; Yuanhao Ban; Cho-Jui Hsieh
>
> **备注:** preprint
>
> **摘要:** Recent research in long-form video generation has shifted from bidirectional to autoregressive models, yet these methods commonly suffer from error accumulation and a loss of long-term coherence. While attention sink frames have been introduced to mitigate this performance decay, they often induce a critical failure mode we term sink-collapse: the generated content repeatedly reverts to the sink frame, resulting in abrupt scene resets and cyclic motion patterns. Our analysis reveals that sink-collapse originates from an inherent conflict between the periodic structure of Rotary Position Embedding (RoPE) and the multi-head attention mechanisms prevalent in current generative models. To address it, we propose a lightweight, training-free approach that effectively suppresses this behavior by introducing multi-head RoPE jitter that breaks inter-head attention homogenization and mitigates long-horizon collapse. Extensive experiments show that our method successfully alleviates sink-collapse while preserving generation quality. To the best of our knowledge, this work achieves the first demonstration of real-time, streaming, and infinite-length video generation with little quality decay. As an illustration of this robustness, we generate continuous videos up to 12 hours in length, which, to our knowledge, is among the longest publicly demonstrated results in streaming video generation.
>
---
#### [new 047] FeTTL: Federated Template and Task Learning for Multi-Institutional Medical Imaging
- **分类: cs.CV**

- **简介: 该论文属于医疗影像领域的联邦学习任务，旨在解决多机构数据分布差异导致的模型性能下降问题。提出FeTTL框架，通过联合学习模板和任务模型来对齐数据分布。**

- **链接: [https://arxiv.org/pdf/2601.16302v1](https://arxiv.org/pdf/2601.16302v1)**
...
>
---
#### [new 055] Embedding -based Crop Type Classification in the Groundnut Basin of Senegal
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于作物类型分类任务，旨在解决小农户地区卫星遥感方法不适用的问题。通过评估TESSERA等嵌入方法，提升分类准确性与适用性。**

- **链接: [https://arxiv.org/pdf/2601.16900v1](https://arxiv.org/pdf/2601.16900v1)**
...
>
---
#### [new 058] Learning Domain Knowledge in Multimodal Large Language Models through Reinforcement Fine-Tuning
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 063] Calibrated Probabilistic Interpolation for GEDI Biomass
- **分类: cs.LG; cs.CE; cs.CV**

- **简介: 该论文属于遥感数据插值任务，解决GEDI生物质数据在异质景观中的不确定性问题。提出ANPs模型，通过局部上下文和空间协方差函数实现校准的预测区间。**

- **链接: [https://arxiv.org/pdf/2601.16834v1](https://arxiv.org/pdf/2601.16834v1)**
...
>
---
#### [new 064] Beyond Superficial Unlearning: Sharpness-Aware Robust Erasure of Hallucinations in Multimodal LLMs
...
>
---
#### [replaced 002] FUSAR-KLIP: Towards Multimodal Foundation Models for Remote Sensing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23927v4](https://arxiv.org/pdf/2509.23927v4)**
...
>
---
#### [replaced 003] GAMMA: Generalizable Alignment via Multi-task and Manipulation-Augmented Training for AI-Generated Image Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.10250v2](https://arxiv.org/pdf/2509.10250v2)**
...
>
---
#### [replaced 004] CoreEditor: Consistent 3D Editing via Correspondence-constrained Diffusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.11603v2](https://arxiv.org/pdf/2508.11603v2)**
...
>
---
#### [replaced 005] Towards contrast- and pathology-agnostic clinical fetal brain MRI segmentation using SynthSeg
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2504.10244v2](https://arxiv.org/pdf/2504.10244v2)**

> **作者:** Ziyao Shang; Misha Kaandorp; Kelly Payette; Marina Fernandez Garcia; Roxane Licandro; Georg Langs; Jordina Aviles Verdera; Jana Hutter; Bjoern Menze; Gregor Kasprian; Meritxell Bach Cuadra; Andras Jakab
>
> **备注:** 29 pages, 12 figures
>
> **摘要:** Magnetic resonance imaging (MRI) has played a crucial role in fetal neurodevelopmental research. Structural annotations of MR images are an important step for quantitative analysis of the developing human brain, with Deep Learning providing an automated alternative for this otherwise tedious manual process. However, segmentation performances of Convolutional Neural Networks often suffer from domain shift, where the network fails when applied to subjects that deviate from the distribution with which it is trained on. In this work, we aim to train networks capable of automatically segmenting fetal brain MRIs with a wide range of domain shifts pertaining to differences in subject physiology and acquisition environments, in particular shape-based differences commonly observed in pathological cases. We introduce a novel data-driven train-time sampling strategy that seeks to fully exploit the diversity of a given training dataset to enhance the domain generalizability of the trained networks. We adapted our sampler, together with other existing data augmentation techniques, to the SynthSeg framework, a generator that utilizes domain randomization to generate diverse training data. We ran thorough experimentations and ablation studies on a wide range of training/testing data to test the validity of the approaches. Our networks achieved notable improvements in the segmentation quality on testing subjects with intense anatomical abnormalities (p < 1e-4), though at the cost of a slighter decrease in performance in cases with fewer abnormalities. Our work also lays the foundation for future works on creating and adapting data-driven sampling strategies for other training pipelines.
>
---
#### [replaced 006] A Novel Deep Hybrid Framework with Ensemble-Based Feature Optimization for Robust Real-Time Human Activity Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.18695v3](https://arxiv.org/pdf/2508.18695v3)**
...
>
---
#### [replaced 007] SAMRI: Segment Anything Model for MRI
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.26635v2](https://arxiv.org/pdf/2510.26635v2)**
...
>
---
#### [replaced 008] A Multi-Stage Hybrid Framework for Automated Interpretation of Multi-View Engineering Drawings Using Vision Language Model
- **分类: cs.CV; cs.AI; cs.IR**

- **链接: [https://arxiv.org/pdf/2510.21862v2](https://arxiv.org/pdf/2510.21862v2)**

> **作者:** Muhammad Tayyab Khan; Zane Yong; Lequn Chen; Wenhe Feng; Nicholas Yew Jin Tan; Seung Ki Moon
>
> **备注:** This draft has been accepted in the 13th International Conference on Industrial Engineering and Applications (ICIEA 2026)
>
...
>
---
#### [replaced 009] Beyond the LUMIR challenge: The pathway to foundational registration models
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2505.24160v2](https://arxiv.org/pdf/2505.24160v2)**
...
>
---
#### [replaced 010] IBISAgent: Reinforcing Pixel-Level Visual Reasoning in MLLMs for Universal Biomedical Object Referring and Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.03054v2](https://arxiv.org/pdf/2601.03054v2)**
...
>
---
#### [replaced 011] VOCAL: Visual Odometry via ContrAstive Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.00243v2](https://arxiv.org/pdf/2507.00243v2)**
...
>
---
#### [replaced 014] NFL-BA: Near-Field Light Bundle Adjustment for SLAM in Dynamic Lighting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.13176v4](https://arxiv.org/pdf/2412.13176v4)**
...
>
---
#### [replaced 017] Coupled Physics-Gated Adaptation: Spatially Decoding Volumetric Photochemical Conversion in Complex 3D-Printed Objects
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.19913v2](https://arxiv.org/pdf/2511.19913v2)**
...
>
---
#### [replaced 018] CardioMOD-Net: A Modal Decomposition-Neural Network Framework for Diagnosis and Prognosis of HFpEF from Echocardiography Cine Loops
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.01176v2](https://arxiv.org/pdf/2601.01176v2)**
...
>
---
#### [replaced 019] OmniView: An All-Seeing Diffusion Model for 3D and 4D View Synthesis
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.10940v2](https://arxiv.org/pdf/2512.10940v2)**
...
>
---
#### [replaced 022] Intelligent Systems in Neuroimaging: Pioneering AI Techniques for Brain Tumor Detection
- **分类: cs.CV; cs.AI; cs.CY**

- **链接: [https://arxiv.org/pdf/2511.17655v2](https://arxiv.org/pdf/2511.17655v2)**
...
>
---
#### [replaced 024] Bootstrapping, autonomous testing, and initialization system for Si/Si$_x$Ge$_{1-x}$ multi-quantum-dot devices
- **分类: cond-mat.mes-hall; cs.CV; cs.ET; quant-ph**

- **链接: [https://arxiv.org/pdf/2412.07676v4](https://arxiv.org/pdf/2412.07676v4)**
...
>
> **备注:** 13 pages, 6 figures, 3 pages of supplemental material
>
...
>
---
#### [replaced 025] Efficient Multi-scale Masked Autoencoders with Hybrid-Attention Mechanism for Breast Lesion Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.07157v4](https://arxiv.org/pdf/2503.07157v4)**

> **作者:** Hung Q. Vo; Pengyu Yuan; Zheng Yin; Kelvin K. Wong; Chika F. Ezeana; Son T. Ly; Hien V. Nguyen; Stephen T. C. Wong
>
...
>
---
#### [replaced 026] Are We Using the Right Benchmark: An Evaluation Framework for Visual Token Compression Methods
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.07143v2](https://arxiv.org/pdf/2510.07143v2)**
...
>
> **备注:** Code: https://github.com/Chenfei-Liao/VTC-Bench; Project Page: https://chenfei-liao.github.io/VTC-Bench-Page/
>
...
>
---
#### [replaced 027] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.10072v3](https://arxiv.org/pdf/2505.10072v3)**
...
>
---
#### [replaced 030] MoE-Enhanced Multi-Domain Feature Selection and Fusion for Fast Map-Free Trajectory Prediction
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.02368v2](https://arxiv.org/pdf/2512.02368v2)**

> **作者:** Wenyi Xiong; Jian Chen; Ziheng Qi; Wenhua Chen
>
...
>
---
#### [replaced 031] GazeD: Context-Aware Diffusion for Accurate 3D Gaze Estimation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.12948v2](https://arxiv.org/pdf/2601.12948v2)**

> **作者:** Riccardo Catalini; Davide Di Nucci; Guido Borghi; Davide Davoli; Lorenzo Garattoni; Gianpiero Francesca; Yuki Kawana; Roberto Vezzani
>
> **备注:** Accepted at 3DV 2026. Project page: https://aimagelab.ing.unimore.it/go/gazed
>
...
>
---
#### [replaced 032] FoldNet: Learning Generalizable Closed-Loop Policy for Garment Folding via Keypoint-Driven Asset and Demonstration Synthesis
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 033] MapAnything: Universal Feed-Forward Metric 3D Reconstruction
...
>
---
#### [replaced 034] Self-supervised Learning of Echocardiographic Video Representations via Online Cluster Distillation
- **分类: cs.CV; cs.AI; cs.CY; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.11777v3](https://arxiv.org/pdf/2506.11777v3)**
...
>
---
#### [replaced 035] Revisiting the Ordering of Channel and Spatial Attention: A Comprehensive Study on Sequential and Parallel Designs
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.07310v2](https://arxiv.org/pdf/2601.07310v2)**
...
>
---
#### [replaced 036] DeepShield: Fortifying Deepfake Video Detection with Local and Global Forgery Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.25237v2](https://arxiv.org/pdf/2510.25237v2)**

> **作者:** Yinqi Cai; Jichang Li; Zhaolun Li; Weikai Chen; Rushi Lan; Xi Xie; Xiaonan Luo; Guanbin Li
>
> **备注:** ICCV 2025. Code is available at https://github.com/lijichang/DeepShield
>
...
>
---
#### [replaced 039] T-LoRA: Single Image Diffusion Model Customization Without Overfitting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.05964v2](https://arxiv.org/pdf/2507.05964v2)**
...
>
---
#### [replaced 040] UniFGVC: Universal Training-Free Few-Shot Fine-Grained Vision Classification via Attribute-Aware Multimodal Retrieval
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.04136v2](https://arxiv.org/pdf/2508.04136v2)**
...
>
---
#### [replaced 041] Markovian Reeb Graphs for Simulating Spatiotemporal Patterns of Life
- **分类: cs.CV; cs.CE; cs.LG; cs.SI**

- **链接: [https://arxiv.org/pdf/2510.03152v2](https://arxiv.org/pdf/2510.03152v2)**
...
>
---
#### [replaced 042] FantasyVLN: Unified Multimodal Chain-of-Thought Reasoning for Vision-Language Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 043] UltraFlwr -- An Efficient Federated Surgical Object Detection Framework
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.15161v2](https://arxiv.org/pdf/2503.15161v2)**
...
>
---
#### [replaced 045] Pretraining Frame Preservation in Autoregressive Video Memory Compression
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23851v3](https://arxiv.org/pdf/2512.23851v3)**

> **作者:** Lvmin Zhang; Shengqu Cai; Muyang Li; Chong Zeng; Beijia Lu; Anyi Rao; Song Han; Gordon Wetzstein; Maneesh Agrawala
>
> **备注:** Additional Results: https://lllyasviel.github.io/pfp_gitpage/
>
...
>
---
#### [replaced 046] Scribble-Supervised Medical Image Segmentation with Dynamic Teacher Switching and Hierarchical Consistency
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.14563v3](https://arxiv.org/pdf/2601.14563v3)**
...
>
---
#### [replaced 047] The Spatial Blindspot of Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.09954v2](https://arxiv.org/pdf/2601.09954v2)**
...
>
> **备注:** Work done as part of the EleutherAI SOAR Program
>
...
>
---
#### [replaced 048] Language-Guided and Motion-Aware Gait Representation for Generalizable Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.11931v2](https://arxiv.org/pdf/2601.11931v2)**
...
>
---
#### [replaced 049] Adaptive Multimodal Person Recognition: A Robust Framework for Handling Missing Modalities
...
>
---
#### [replaced 050] From Neck to Head: Bio-Impedance Sensing for Head Pose Estimation
- **分类: cs.CV; eess.SP**

- **链接: [https://arxiv.org/pdf/2507.12884v2](https://arxiv.org/pdf/2507.12884v2)**
