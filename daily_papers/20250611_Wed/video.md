...
- **简介: 该论文属于视觉语言模型任务，旨在解决对象幻觉问题。通过提出SECOND方法，利用多尺度视觉信息提升图像理解准确性。**
...
- **链接: [http://arxiv.org/pdf/2506.09040v1](http://arxiv.org/pdf/2506.09040v1)**
...
- **简介: 该论文属于目标检测任务，旨在解决小目标检测性能差的问题。通过改进的数据增强方法提升检测效果。**
...
- **链接: [http://arxiv.org/pdf/2506.08949v1](http://arxiv.org/pdf/2506.08949v1)**
...
- **简介: 该论文属于3D场景渲染任务，解决大规模场景新视角合成问题。提出TraGraph-GS方法，通过轨迹图实现高效空间划分与纹理增强，提升渲染质量与效率。**
...
- **简介: 该论文属于遥感图像语义分割任务，旨在解决标注数据稀缺的问题。通过多教师知识蒸馏与融合方法，提升半监督学习效果。**
...
- **简介: 该论文属于高光谱图像分类任务，旨在解决数据高维、样本稀疏和光谱冗余导致的过拟合问题。提出STNet网络，通过空间-光谱Transformer模块实现有效特征提取与融合。**
...
- **简介: 该论文属于3D重建与渲染任务，旨在解决神经辐射场采样效率低的问题。通过概率引导采样和新损失函数提升关键区域的渲染精度。**
...
- **简介: 该论文属于文本到图像生成任务，解决classifier-free guidance计算成本高的问题。提出Step AG方法，在少量去噪步骤中应用引导，提升效率并保持生成质量。**
...
- **简介: 该论文属于医学视频分析任务，旨在解决湿实验白内障手术技能评估自动化问题。研究构建了WetCat数据集，包含高质量手术视频及详细标注，支持客观、高效的技能评估。**
...
- **简介: 该论文属于虚拟代理评估任务，旨在解决现有基准的局限性。提出OmniBench和OmniEval，构建多维评估体系，提升虚拟代理性能评估效率与全面性。**
...
- **简介: 该论文属于运动预测任务，解决自动驾驶中多模态轨迹预测问题。提出TrajFlow框架，实现单次推理生成多个合理轨迹，并提升预测精度与效率。**
...
- **简介: 该论文属于视频伪造定位任务，解决小片段伪造内容的精准定位问题。提出一种上下文感知对比学习框架，提升伪造片段的识别与定位能力。**
...
- **链接: [http://arxiv.org/pdf/2506.08887v1](http://arxiv.org/pdf/2506.08887v1)**
...
- **简介: 该论文属于视频理解任务，旨在解决视频中时空细节理解困难的问题。提出Video-CoT数据集和基准，包含大量问答对与思维链标注，以推动视频分析技术发展。**
...
- **简介: 该论文属于文本到图像生成任务，旨在解决模型与文化期望不匹配的问题。通过构建CulturalFrames基准，评估模型在文化表达上的表现，并揭示现有评估指标的不足。**
...
- **链接: [http://arxiv.org/pdf/2506.08796v1](http://arxiv.org/pdf/2506.08796v1)**
...
- **简介: 该论文属于图像分类任务，旨在解决传统卷积网络在空间建模和全局上下文捕捉上的不足。提出InceptionMamba架构，结合带状卷积与瓶颈Mamba模块，提升模型性能与效率。**
...
- **简介: 该论文属于模型鲁棒性与公平性任务，旨在解决对抗训练中类别间鲁棒性不均的问题。通过自适应调整软标签平滑度提升公平性。**
...
- **简介: 该论文属于图像处理任务，解决多相机颜色一致性问题。提出NPM模型，通过物理建模实现跨设备的raw图像映射，提升色彩一致性与适应性。**
...
- **简介: 该论文属于图像处理任务，旨在解决真实场景下反射去除问题。提出OpenRR-1k数据集，包含1000对高质量图像，用于提升算法在复杂环境中的鲁棒性。**
...
>
---
#### [new 072] Jamais Vu: Exposing the Generalization Gap in Supervised Semantic Correspondence
- **分类: cs.CV**

- **简介: 该论文属于语义对应任务，旨在解决监督方法在泛化能力上的不足。通过引入3D空间和新数据集，提升模型在未见关键点上的表现。**

- **链接: [http://arxiv.org/pdf/2506.08220v1](http://arxiv.org/pdf/2506.08220v1)**
...
>
---
#### [new 073] RoboSwap: A GAN-driven Video Diffusion Framework For Unsupervised Robot Arm Swapping
- **分类: cs.CV**

- **简介: 该论文提出RoboSwap，解决机器人手臂视频交换问题，通过结合GAN和扩散模型，在无配对数据下实现跨平台机器人学习。**

- **链接: [http://arxiv.org/pdf/2506.08632v1](http://arxiv.org/pdf/2506.08632v1)**
...
>
---
#### [new 074] SkipVAR: Accelerating Visual Autoregressive Modeling via Adaptive Frequency-Aware Skipping
- **分类: cs.CV**

- **简介: 该论文属于视觉自回归建模任务，旨在解决生成过程中的计算冗余问题。通过引入自适应跳过策略提升效率，同时保持模型质量。**

- **链接: [http://arxiv.org/pdf/2506.08908v1](http://arxiv.org/pdf/2506.08908v1)**
...
>
---
#### [new 081] Hyperbolic Dual Feature Augmentation for Open-Environment
- **分类: cs.CV**

- **简介: 该论文属于开放环境下的特征增强任务，旨在解决传统方法仅处理已见类的问题。提出双特征增强方法，在双曲空间中同时增强已见和未见类特征。**

- **链接: [http://arxiv.org/pdf/2506.08906v1](http://arxiv.org/pdf/2506.08906v1)**
...
>
---
#### [new 083] HunyuanVideo-HOMA: Generic Human-Object Interaction in Multimodal Driven Human Animation
- **分类: cs.CV**

- **简介: 该论文属于人-物交互视频生成任务，解决数据依赖强、泛化性差等问题，提出HunyuanVideo-HOMA框架提升可控性与真实性。**

- **链接: [http://arxiv.org/pdf/2506.08797v1](http://arxiv.org/pdf/2506.08797v1)**
...
>
---
#### [new 089] ATAS: Any-to-Any Self-Distillation for Enhanced Open-Vocabulary Dense Prediction
- **分类: cs.CV**

- **简介: 该论文属于开放词汇密集预测任务，旨在解决CLIP模型在细粒度区域理解上的不足。通过ATAS方法提升语义连贯性和视觉-语言对齐，无需额外模块或标注数据。**

- **链接: [http://arxiv.org/pdf/2506.08678v1](http://arxiv.org/pdf/2506.08678v1)**
...
>
---
#### [new 090] Convergence of Spectral Principal Paths: How Deep Networks Distill Linear Representations from Noisy Inputs
- **分类: cs.CV**

- **简介: 该论文研究深度网络如何从噪声输入中提炼线性表示，提出SPP框架，解决AI透明性与鲁棒性问题。**

- **链接: [http://arxiv.org/pdf/2506.08543v1](http://arxiv.org/pdf/2506.08543v1)**
...
>
---
#### [new 091] Seeing Voices: Generating A-Roll Video from Audio with Mirage
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于音频到视频生成任务，旨在解决如何根据音频生成高质量视频的问题。工作包括提出Mirage模型，实现从音频生成逼真视频的统一方法。**

- **链接: [http://arxiv.org/pdf/2506.08279v1](http://arxiv.org/pdf/2506.08279v1)**
...
>
---
#### [new 093] Using Satellite Images And Self-supervised Machine Learning Networks To Detect Water Hidden Under Vegetation
- **分类: cs.CV**

- **简介: 该论文属于遥感图像分割任务，旨在无需人工标注的情况下检测植被下的水体。通过自监督学习和集成方法提升模型性能。**

- **链接: [http://arxiv.org/pdf/2506.08214v1](http://arxiv.org/pdf/2506.08214v1)**
...
>
---
#### [new 094] MedMoE: Modality-Specialized Mixture of Experts for Medical Vision-Language Understanding
- **分类: cs.CV**

- **简介: 该论文属于医疗视觉-语言理解任务，旨在解决不同医学影像模态特征提取不匹配的问题。提出MedMoE框架，通过专家路由机制实现模态专用特征学习。**

- **链接: [http://arxiv.org/pdf/2506.08356v1](http://arxiv.org/pdf/2506.08356v1)**
...
>
---
#### [new 099] MOSAIC-F: A Framework for Enhancing Students' Oral Presentation Skills through Personalized Feedback
- **分类: cs.HC; cs.AI; cs.CV**

- **简介: 该论文属于教育技术任务，旨在提升学生口头表达能力。通过整合多模态数据与AI生成个性化反馈，解决传统评估方式单一的问题。**

- **链接: [http://arxiv.org/pdf/2506.08634v1](http://arxiv.org/pdf/2506.08634v1)**
...
>
---
#### [new 100] Normalized Radon Cumulative Distribution Transforms for Invariance and Robustness in Optimal Transport Based Image Classification
- **分类: math.NA; cs.CV; cs.IT; cs.NA; math.IT**

- **简介: 该论文属于图像分类任务，解决在小数据和非仿射变形下的分类问题。提出改进的R-CDT特征提取器，增强分类的鲁棒性与不变性。**

- **链接: [http://arxiv.org/pdf/2506.08761v1](http://arxiv.org/pdf/2506.08761v1)**
...
>
---
#### [new 101] FEDTAIL: Federated Long-Tailed Domain Generalization with Sharpness-Guided Gradient Matching
- **分类: cs.AI; cs.CV; cs.LG; I.2.6; C.1.4; D.1.3; I.5.1; H.3.4; I.2.10; I.4.0; I.4.1; I.4.2;
  I.4.6; I.4.7; I.4.8; I.4.9; I.4.10; I.5.1; I.5.2; I.5.4; J.2; I.2.11; I.2.10**

- **简介: 该论文属于领域自适应任务，解决长尾分布和优化冲突问题。提出FedTAIL框架，通过梯度对齐和动态加权提升模型泛化能力。**

- **链接: [http://arxiv.org/pdf/2506.08518v1](http://arxiv.org/pdf/2506.08518v1)**
...
>
---
#### [new 104] VIKI-R: Coordinating Embodied Multi-Agent Cooperation via Reinforcement Learning
...
>
> **摘要:** While current AI illustration tools can generate high-quality images from text prompts, they rarely reveal the step-by-step procedure that human artists follow. We present SakugaFlow, a four-stage pipeline that pairs diffusion-based image generation with a large-language-model tutor. At each stage, novices receive real-time feedback on anatomy, perspective, and composition, revise any step non-linearly, and branch alternative versions. By exposing intermediate outputs and embedding pedagogical dialogue, SakugaFlow turns a black-box generator into a scaffolded learning environment that supports both creative exploration and skills acquisition.
>
---
#### [new 118] Surgeons Awareness, Expectations, and Involvement with Artificial Intelligence: a Survey Pre and Post the GPT Era
- **分类: cs.CY; cs.CV**

- **简介: 该论文属于医疗AI领域，研究 surgeons 对AI的认知、期望与参与度变化，分析AI在手术中的应用现状与挑战。**

- **链接: [http://arxiv.org/pdf/2506.08258v1](http://arxiv.org/pdf/2506.08258v1)**
...
>
---
#### [new 121] Aligning Proteins and Language: A Foundation Model for Protein Retrieval
- **分类: q-bio.BM; cs.AI; cs.CE; cs.CV; cs.LG**

- **简介: 该论文属于蛋白质检索任务，旨在通过结构与语义对齐，提升蛋白质功能解析。工作包括构建数据集、设计CLIP风格模型，并在多个数据库上验证效果。**

- **链接: [http://arxiv.org/pdf/2506.08023v1](http://arxiv.org/pdf/2506.08023v1)**
...
>
---
#### [new 124] Neural-Augmented Kelvinlet: Real-Time Soft Tissue Deformation with Multiple Graspers
...
>
---
#### [new 125] Instruction-Tuned Video-Audio Models Elucidate Functional Specialization in the Brain
- **分类: q-bio.NC; cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文属于脑机接口任务，旨在提升多模态语言模型与大脑活动的对齐。通过指令微调模型，增强其在视频和音频任务中的表征能力，实现更精确的脑功能解析。**

- **链接: [http://arxiv.org/pdf/2506.08277v1](http://arxiv.org/pdf/2506.08277v1)**
...
>
---
#### [new 126] PhyBlock: A Progressive Benchmark for Physical Understanding and Planning via 3D Block Assembly
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 002] MedVersa: A Generalist Foundation Model for Medical Image Interpretation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.07988v2](http://arxiv.org/pdf/2405.07988v2)**

> **作者:** Hong-Yu Zhou; Julián Nicolás Acosta; Subathra Adithan; Suvrankar Datta; Eric J. Topol; Pranav Rajpurkar
>
> **备注:** Technical study
>
> **摘要:** Current medical AI systems are often limited to narrow applications, hindering widespread adoption. We present MedVersa, a generalist foundation model trained on tens of millions of compiled medical instances. MedVersa unlocks generalist learning from multimodal inputs and outputs, representing the first example of a generalist model reaching competitive performance with leading specialized solutions across a variety of medical imaging scenarios. MedVersa achieves state-of-the-art performance in nine tasks, sometimes outperforming counterparts by over 10%. Radiologist evaluation shows MedVersa-generated reports get superior performance in 95% of normal studies, while matching or exceeding human reports in 71% of cases overall. User studies showed notable reductions in report writing time and discrepancies with the use of MedVersa. Our findings underscore the value of flexible, multimodal AI systems in advancing medical image interpretation and supporting clinical expertise.
>
---
...
>
---
#### [replaced 007] EAM: Enhancing Anything with Diffusion Transformers for Blind Super-Resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.05209v2](http://arxiv.org/pdf/2505.05209v2)**

> **作者:** Haizhen Xie; Kunpeng Du; Qiangyu Yan; Sen Lu; Jianhong Han; Hanting Chen; Hailin Hu; Jie Hu
>
> **备注:** The company audit did not pass, there are some mistake in paper
>
...
>
---
#### [replaced 008] xGen-MM-Vid (BLIP-3-Video): You Only Need 32 Tokens to Represent a Video Even in VLMs
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.16267v2](http://arxiv.org/pdf/2410.16267v2)**

> **作者:** Michael S. Ryoo; Honglu Zhou; Shrikant Kendre; Can Qin; Le Xue; Manli Shu; Jongwoo Park; Kanchana Ranasinghe; Silvio Savarese; Ran Xu; Caiming Xiong; Juan Carlos Niebles
>
...
>
---
#### [replaced 009] SnapGen-V: Generating a Five-Second Video within Five Seconds on a Mobile Device
- **分类: cs.CV; cs.AI; cs.LG; cs.PF**

- **链接: [http://arxiv.org/pdf/2412.10494v2](http://arxiv.org/pdf/2412.10494v2)**
...
>
> **备注:** https://snap-research.github.io/snapgen-v/
>
...
>
---
#### [replaced 010] Human-like object concept representations emerge naturally in multimodal large language models
- **分类: cs.AI; cs.CL; cs.CV; cs.HC; cs.LG**

- **链接: [http://arxiv.org/pdf/2407.01067v2](http://arxiv.org/pdf/2407.01067v2)**
...
>
---
#### [replaced 011] CASE: Contrastive Activation for Saliency Estimation
- **分类: cs.CV; cs.LG; I.2.6; I.5.1; I.5.5; I.2.10**

- **链接: [http://arxiv.org/pdf/2506.07327v2](http://arxiv.org/pdf/2506.07327v2)**
...
>
---
#### [replaced 014] Fighting Fire with Fire (F3): A Training-free and Efficient Visual Adversarial Example Purification Method in LVLMs
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.01064v2](http://arxiv.org/pdf/2506.01064v2)**
...
>
---
#### [replaced 015] Meta-Adaptive Prompt Distillation for Few-Shot Visual Question Answering
- **分类: cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.06905v2](http://arxiv.org/pdf/2506.06905v2)**
...
>
---
#### [replaced 016] SpatialReasoner: Towards Explicit and Generalizable 3D Spatial Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.20024v2](http://arxiv.org/pdf/2504.20024v2)**
...
>
---
#### [replaced 021] Dual Attention Residual U-Net for Accurate Brain Ultrasound Segmentation in IVH Detection
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17683v2](http://arxiv.org/pdf/2505.17683v2)**
...
>
---
#### [replaced 026] Zero-Shot Gaze-based Volumetric Medical Image Segmentation
- **分类: cs.CV; cs.AI; I.2.1**

- **链接: [http://arxiv.org/pdf/2505.15256v2](http://arxiv.org/pdf/2505.15256v2)**
...
>
---
#### [replaced 027] TRAVEL: Training-Free Retrieval and Alignment for Vision-and-Language Navigation
...
>
---
#### [replaced 032] Delving into RL for Image Generation with CoT: A Study on DPO vs. GRPO
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.17017v2](http://arxiv.org/pdf/2505.17017v2)**
...
>
---
#### [replaced 033] ATI: Any Trajectory Instruction for Controllable Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.22944v3](http://arxiv.org/pdf/2505.22944v3)**
...
>
---
#### [replaced 034] Estimation of Head Motion in Structural MRI and its Impact on Cortical Thickness Measurements in Retrospective Data
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23916v2](http://arxiv.org/pdf/2505.23916v2)**
...
>
---
#### [replaced 035] A Survey of the Self Supervised Learning Mechanisms for Vision Transformers
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2408.17059v5](http://arxiv.org/pdf/2408.17059v5)**
...
>
---
#### [replaced 037] RAVEN: Query-Guided Representation Alignment for Question Answering over Audio, Video, Embedded Sensors, and Natural Language
- **分类: cs.CL; cs.CV; cs.LG; cs.MM**

- **链接: [http://arxiv.org/pdf/2505.17114v2](http://arxiv.org/pdf/2505.17114v2)**
...
>
---
#### [replaced 038] Flexible Tool Selection through Low-dimensional Attribute Alignment of Vision and Language
- **分类: cs.CV; cs.AI; cs.CL; q-bio.NC**

- **链接: [http://arxiv.org/pdf/2505.22146v2](http://arxiv.org/pdf/2505.22146v2)**
...
>
---
#### [replaced 039] RecipeGen: A Step-Aligned Multimodal Benchmark for Real-World Recipe Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.06733v2](http://arxiv.org/pdf/2506.06733v2)**
...
>
---
#### [replaced 040] ArchiLense: A Framework for Quantitative Analysis of Architectural Styles Based on Vision Large Language Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.07739v2](http://arxiv.org/pdf/2506.07739v2)**
...
>
---
#### [replaced 043] Just Project! Multi-Channel Despeckling, the Easy Way
- **分类: cs.CV; eess.SP**
...
>
---
#### [replaced 044] SpatialLLM: A Compound 3D-Informed Design towards Spatially-Intelligent Large Multimodal Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.00788v3](http://arxiv.org/pdf/2505.00788v3)**

> **作者:** Wufei Ma; Luoxin Ye; Celso M de Melo; Jieneng Chen; Alan Yuille
>
...
>
---
#### [replaced 045] Lingshu: A Generalist Foundation Model for Unified Multimodal Medical Understanding and Reasoning
- **分类: cs.CL; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07044v2](http://arxiv.org/pdf/2506.07044v2)**
...
>
---
#### [replaced 046] NaturalBench: Evaluating Vision-Language Models on Natural Adversarial Samples
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2410.14669v4](http://arxiv.org/pdf/2410.14669v4)**
...
>
> **备注:** Accepted to NeurIPS 24; We open-source our dataset at: https://huggingface.co/datasets/BaiqiL/NaturalBench ; Project page at: https://linzhiqiu.github.io/papers/naturalbench/
>
> **摘要:** Vision-language models (VLMs) have made significant progress in recent visual-question-answering (VQA) benchmarks that evaluate complex visio-linguistic reasoning. However, are these models truly effective? In this work, we show that VLMs still struggle with natural images and questions that humans can easily answer, which we term natural adversarial samples. We also find it surprisingly easy to generate these VQA samples from natural image-text corpora using off-the-shelf models like CLIP and ChatGPT. We propose a semi-automated approach to collect a new benchmark, NaturalBench, for reliably evaluating VLMs with 10,000 human-verified VQA samples. Crucially, we adopt a $\textbf{vision-centric}$ design by pairing each question with two images that yield different answers, preventing blind solutions from answering without using the images. This makes NaturalBench more challenging than previous benchmarks that can be solved with commonsense priors. We evaluate 53 state-of-the-art VLMs on NaturalBench, showing that models like LLaVA-OneVision, Cambrian-1, Llama3.2-Vision, Molmo, Qwen2-VL, and even GPT-4o lag 50%-70% behind human performance (over 90%). We analyze why NaturalBench is hard from two angles: (1) Compositionality: Solving NaturalBench requires diverse visio-linguistic skills, including understanding attribute bindings, object relationships, and advanced reasoning like logic and counting. To this end, unlike prior work that uses a single tag per sample, we tag each NaturalBench sample with 1 to 8 skill tags for fine-grained evaluation. (2) Biases: NaturalBench exposes severe biases in VLMs, as models often choose the same answer regardless of the image. Lastly, we apply our benchmark curation method to diverse data sources, including long captions (over 100 words) and non-English languages like Chinese and Hindi, highlighting its potential for dynamic evaluations of VLMs.
>
---
#### [replaced 047] ARGUS: Hallucination and Omission Evaluation in Video-LLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.07371v2](http://arxiv.org/pdf/2506.07371v2)**
...
>
---
#### [replaced 048] Noninvasive precision modulation of high-level neural population activity via natural vision perturbations
- **分类: q-bio.NC; cs.CV; cs.NE**

- **链接: [http://arxiv.org/pdf/2506.05633v2](http://arxiv.org/pdf/2506.05633v2)**
...
>
---
#### [replaced 051] TinyLLaVA-Video: Towards Smaller LMMs for Video Understanding with Group Resampler
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.15513v2](http://arxiv.org/pdf/2501.15513v2)**
...
>
---
#### [replaced 056] From Pixels to Predicates: Learning Symbolic World Models via Pretrained Vision-Language Models
...
>
---
#### [replaced 057] A Culturally-Aware Benchmark for Person Re-Identification in Modest Attire
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2412.18874v2](http://arxiv.org/pdf/2412.18874v2)**
...
>
---
#### [replaced 059] Cracking the Code of Hallucination in LVLMs with Vision-aware Head Divergence
- **分类: cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2412.13949v3](http://arxiv.org/pdf/2412.13949v3)**
...
>
---
#### [replaced 060] Revisiting Reweighted Risk for Calibration: AURC, Focal Loss, and Inverse Focal Loss
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23463v2](http://arxiv.org/pdf/2505.23463v2)**
...
>
---
#### [replaced 061] StereoVAE: A lightweight stereo-matching system using embedded GPUs
...
>
---
#### [replaced 062] Adaptive path planning for efficient object search by UAVs in agricultural fields
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 063] Mixture of Decoding: An Attention-Inspired Adaptive Decoding Strategy to Mitigate Hallucinations in Large Vision-Language Models
- **分类: cs.CL; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17061v3](http://arxiv.org/pdf/2505.17061v3)**
