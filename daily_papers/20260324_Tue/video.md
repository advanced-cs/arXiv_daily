...
#### [new 001] The Dual Mechanisms of Spatial Reasoning in Vision-Language Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究视觉语言模型中的空间推理机制，解决如何在模型中计算物体与空间关系的问题。工作揭示了两种机制，并强调视觉编码器在空间推理中的核心作用。**

- **链接: [https://arxiv.org/pdf/2603.22278](https://arxiv.org/pdf/2603.22278)**
...
>
---
#### [new 002] WorldCache: Content-Aware Caching for Accelerated Video World Models
...
>
---
#### [new 009] Cross-Scenario Deraining Adaptation with Unpaired Data: Superpixel Structural Priors and Multi-Stage Pseudo-Rain Synthesis
- **分类: cs.CV; cs.AI; cs.GR; cs.LG; cs.MM**

- **简介: 该论文属于图像去雨任务，解决深度学习模型在未见场景中的性能下降问题。通过无配对数据和结构先验，生成伪雨数据提升模型泛化能力。**

- **链接: [https://arxiv.org/pdf/2603.21661](https://arxiv.org/pdf/2603.21661)**
...
>
---
#### [new 012] STAC: Plug-and-Play Spatio-Temporal Aware Cache Compression for Streaming 3D Reconstruction
- **分类: cs.CV; cs.GR; eess.IV**

- **简介: 该论文属于实时流式3D重建任务，解决长期时间一致性与内存效率问题。提出STAC框架，通过时空感知的缓存压缩技术，显著降低内存占用并提升推理速度。**
...
>
---
#### [new 013] Camera-Agnostic Pruning of 3D Gaussian Splats via Descriptor-Based Beta Evidence
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于3D重建任务，解决相机依赖的3D高斯点云剪枝问题。提出一种基于描述符的无相机剪枝方法，通过统计证据模型实现高效剪枝。**

- **链接: [https://arxiv.org/pdf/2603.21933](https://arxiv.org/pdf/2603.21933)**
...
>
---
#### [new 014] Premier: Personalized Preference Modulation with Learnable User Embedding in Text-to-Image Generation
- **分类: cs.CV**

- **简介: 该论文属于文本到图像生成任务，旨在解决个性化偏好捕捉不足的问题。通过引入可学习的用户嵌入和偏好适配器，实现更精准的风格控制与输出对齐。**
...
>
---
#### [new 015] Memory-Efficient Fine-Tuning Diffusion Transformers via Dynamic Patch Sampling and Block Skipping
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于文本到图像生成任务，旨在解决扩散Transformer模型微调时内存消耗大的问题。通过动态块采样和跳过机制，减少内存使用，提升部署可行性。**

- **链接: [https://arxiv.org/pdf/2603.20755](https://arxiv.org/pdf/2603.20755)**
...
>
---
#### [new 018] Omni-WorldBench: Towards a Comprehensive Interaction-Centric Evaluation for World Models
- **分类: cs.CV**

- **简介: 该论文属于世界模型评估任务，旨在解决现有基准缺乏对交互响应能力评估的问题。提出Omni-WorldBench，包含提示套件和代理评估框架，全面评价4D世界模型的交互能力。**

- **链接: [https://arxiv.org/pdf/2603.22212](https://arxiv.org/pdf/2603.22212)**
...
>
> **摘要:** Video--based world models have emerged along two dominant paradigms: video generation and 3D reconstruction. However, existing evaluation benchmarks either focus narrowly on visual fidelity and text--video alignment for generative models, or rely on static 3D reconstruction metrics that fundamentally neglect temporal dynamics. We argue that the future of world modeling lies in 4D generation, which jointly models spatial structure and temporal evolution. In this paradigm, the core capability is interactive response: the ability to faithfully reflect how interaction actions drive state transitions across space and time. Yet no existing benchmark systematically evaluates this critical dimension. To address this gap, we propose Omni--WorldBench, a comprehensive benchmark specifically designed to evaluate the interactive response capabilities of world models in 4D settings. Omni--WorldBench comprises two key components: Omni--WorldSuite, a systematic prompt suite spanning diverse interaction levels and scene types; and Omni--Metrics, an agent-based evaluation framework that quantifies world modeling capabilities by measuring the causal impact of interaction actions on both final outcomes and intermediate state evolution trajectories. We conduct extensive evaluations of 18 representative world models across multiple paradigms. Our analysis reveals critical limitations of current world models in interactive response, providing actionable insights for future research. Omni-WorldBench will be publicly released to foster progress in interactive 4D world modeling.
>
---
#### [new 019] When Negation Is a Geometry Problem in Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言模型任务，解决CLIP在理解否定语句上的不足。通过分析嵌入空间中的否定方向，提出无需微调的干预方法提升其否定理解能力。**

- **链接: [https://arxiv.org/pdf/2603.20554](https://arxiv.org/pdf/2603.20554)**
...
>
> **摘要:** We present daVinci-MagiHuman, an open-source audio-video generative foundation model for human-centric generation. daVinci-MagiHuman jointly generates synchronized video and audio using a single-stream Transformer that processes text, video, and audio within a unified token sequence via self-attention only. This single-stream design avoids the complexity of multi-stream or cross-attention architectures while remaining easy to optimize with standard training and inference infrastructure. The model is particularly strong in human-centric scenarios, producing expressive facial performance, natural speech-expression coordination, realistic body motion, and precise audio-video synchronization. It supports multilingual spoken generation across Chinese (Mandarin and Cantonese), English, Japanese, Korean, German, and French. For efficient inference, we combine the single-stream backbone with model distillation, latent-space super-resolution, and a Turbo VAE decoder, enabling generation of a 5-second 256p video in 2 seconds on a single H100 GPU. In automatic evaluation, daVinci-MagiHuman achieves the highest visual quality and text alignment among leading open models, along with the lowest word error rate (14.60%) for speech intelligibility. In pairwise human evaluation, it achieves win rates of 80.0% against Ovi 1.1 and 60.9% against LTX 2.3 over 2000 comparisons. We open-source the complete model stack, including the base model, the distilled model, the super-resolution model, and the inference codebase.
>
---
#### [new 022] DGRNet: Disagreement-Guided Refinement for Uncertainty-Aware Brain Tumor Segmentation
- **分类: cs.CV**

- **简介: 该论文属于脑肿瘤分割任务，解决单模型不确定性量化不足和未充分利用放射报告信息的问题。提出DGRNet，通过多视角分歧和文本引导优化提升分割精度与不确定性估计。**

- **链接: [https://arxiv.org/pdf/2603.21086](https://arxiv.org/pdf/2603.21086)**
...
>
---
#### [new 023] EARTalking: End-to-end GPT-style Autoregressive Talking Head Synthesis with Frame-wise Control
...
>
---
#### [new 026] Test-Time Adaptation via Cache Personalization for Facial Expression Recognition in Videos
- **分类: cs.CV**

- **简介: 该论文属于视频面部表情识别任务，旨在解决跨个体分布变化下的模型个性化问题。提出TTA-CaP方法，通过缓存机制实现高效无梯度的模型适应。**
...
>
---
#### [new 027] When Models Judge Themselves: Unsupervised Self-Evolution for Multimodal Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态推理任务，旨在解决依赖标注数据的问题。提出无监督自进化框架，通过自一致性信号和相对优势优化提升模型性能。**
...
>
---
#### [new 028] PiLoT: Neural Pixel-to-3D Registration for UAV-based Ego and Target Geo-localization
- **分类: cs.CV**

- **简介: 该论文提出PiLoT，解决无人机自定位与目标定位问题。通过视频流与三维地图的神经注册，实现高效、精准的定位，克服传统方法在无GNSS环境下的不足。**
...
>
---
#### [new 029] LRC-WeatherNet: LiDAR, RADAR, and Camera Fusion Network for Real-time Weather-type Classification in Autonomous Driving
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出LRC-WeatherNet，融合LiDAR、RADAR和相机数据，解决自动驾驶中恶劣天气分类问题，提升感知可靠性。**

- **链接: [https://arxiv.org/pdf/2603.21987](https://arxiv.org/pdf/2603.21987)**
...
>
---
#### [new 043] Remote Sensing Image Dehazing: A Systematic Review of Progress, Challenges, and Prospects
- **分类: cs.CV**

- **简介: 该论文属于遥感图像去雾任务，解决 haze、fog 和薄云导致的图像质量下降问题。综述了去雾方法的发展，进行了大量实验评估与分析。**

- **链接: [https://arxiv.org/pdf/2603.20289](https://arxiv.org/pdf/2603.20289)**
...
>
---
#### [new 047] GeoFlow: Real-Time Fine-Grained Cross-View Geolocalization via Iterative Flow Prediction
- **分类: cs.CV**

- **简介: 该论文提出GeoFlow，解决GPS拒止环境下实时精确定位问题。通过轻量级框架和迭代算法，实现高效准确的跨视角地理定位。**

- **链接: [https://arxiv.org/pdf/2603.21943](https://arxiv.org/pdf/2603.21943)**
...
>
---
#### [new 050] Parameter-efficient Prompt Tuning and Hierarchical Textual Guidance for Few-shot Whole Slide Image Classification
- **分类: cs.CV**

- **简介: 该论文属于少样本全切片图像分类任务，旨在解决标注成本高和信息损失问题。提出参数高效的提示调优方法和软层次文本引导策略，提升分类性能并减少参数量。**

- **链接: [https://arxiv.org/pdf/2603.21504](https://arxiv.org/pdf/2603.21504)**
...
>
---
#### [new 052] Revisiting Weakly-Supervised Video Scene Graph Generation via Pair Affinity Learning
- **分类: cs.CV**

- **简介: 该论文属于弱监督视频场景图生成任务，解决无边界框标注下的关系识别问题。通过引入对偶亲和力学习，提升模型对互动关系的识别能力。**

- **链接: [https://arxiv.org/pdf/2603.21559](https://arxiv.org/pdf/2603.21559)**
...
>
---
#### [new 060] DCG-Net: Dual Cross-Attention with Concept-Value Graph Reasoning for Interpretable Medical Diagnosis
- **分类: cs.CV**

- **简介: 该论文属于医学诊断任务，旨在解决深度学习模型可解释性不足的问题。提出DCG-Net框架，结合双注意力机制和概念图推理，提升诊断准确性与解释性。**

- **链接: [https://arxiv.org/pdf/2603.20325](https://arxiv.org/pdf/2603.20325)**

> **作者:** Getamesay Dagnaw; Xuefei Yin; Muhammad Hassan Maqsood; Yanming Zhu; Alan Wee-Chung Liew
>
> **摘要:** Deep learning models have achieved strong performance in medical image analysis, but their internal decision processes remain difficult to interpret. Concept Bottleneck Models (CBMs) partially address this limitation by structuring predictions through human-interpretable clinical concepts. However, existing CBMs typically overlook the contextual dependencies among concepts. To address these issues, we propose an end-to-end interpretable framework \emph{DCG-Net} that integrates multimodal alignment with structured concept reasoning. DCG-Net introduces a Dual Cross-Attention module that replaces cosine similarity matching with bidirectional attention between visual tokens and canonicalized textual concept-value prototypes, enabling spatially localized evidence attribution. To capture the relational structure inherent to clinical concepts, we develop a Parametric Concept Graph initialized with Positive Pointwise Mutual Information priors and refined through sparsity-controlled message passing. This formulation models inter-concept dependencies in a manner consistent with clinical domain knowledge. Experiments on white blood cell morphology and skin lesion diagnosis demonstrate that DCG-Net achieves state-of-the-art classification performance while producing clinically interpretable diagnostic explanations.
>
---
#### [new 061] Climate Prompting: Generating the Madden-Julian Oscillation using Video Diffusion and Low-Dimensional Conditioning
- **分类: cs.CV**

- **简介: 该论文属于气候建模任务，旨在通过视频扩散模型生成MJO序列，解决传统理论与高分辨率数据间的差距，通过低维条件控制实现MJO过程的解析。**

- **链接: [https://arxiv.org/pdf/2603.21856](https://arxiv.org/pdf/2603.21856)**

> **作者:** Sulian Thual; Feiyang Cai; Jingjing Wang; Feng Luo
>
> **摘要:** Generative Deep Learning is a powerful tool for modeling of the Madden-Julian oscillation (MJO) in the tropics, yet its relationship to traditional theoretical frameworks remains poorly understood. Here we propose a video diffusion model, trained on atmospheric reanalysis, to synthetize long MJO sequences conditioned on key low-dimensional metrics. The generated MJOs capture key features including composites, power spectra and multiscale structures including convectively coupled waves, despite some bias. We then prompt the model to generate more tractable MJOs based on intentionally idealized low-dimensional conditionings, for example a perpetual MJO, an isolated modulation by seasons and/or the El Nino-Southern Oscillation, and so on. This enables deconstructing the underlying processes and identifying physical drivers. The present approach provides a practical framework for bridging the gap between low-dimensional MJO theory and high-resolution atmospheric complexity and will help tropical atmosphere prediction.
>
---
#### [new 062] A Multihead Continual Learning Framework for Fine-Grained Fashion Image Retrieval with Contrastive Learning and Exponential Moving Average Distillation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于细粒度服装图像检索任务，解决动态场景下新属性出现时的持续学习问题。提出MCL-FIR框架，结合对比学习与EMA蒸馏，实现高效准确的增量学习。**

- **链接: [https://arxiv.org/pdf/2603.20648](https://arxiv.org/pdf/2603.20648)**
...
>
---
#### [new 063] Repurposing Geometric Foundation Models for Multi-view Diffusion
- **分类: cs.CV**

- **简介: 该论文属于多视角生成任务，解决单视图生成与多视图一致性之间的矛盾。通过利用几何基础模型的特征空间作为潜在空间，提升多视角扩散模型的性能与效率。**

- **链接: [https://arxiv.org/pdf/2603.22275](https://arxiv.org/pdf/2603.22275)**
...
>
---
#### [new 064] Privacy-Preserving Federated Action Recognition via Differentially Private Selective Tuning and Efficient Communication
- **分类: cs.CV**

- **简介: 该论文属于视频动作识别任务，解决联邦学习中的模型暴露和通信开销问题。提出FedDP-STECAR框架，通过差分隐私选择性微调和高效通信，提升隐私保护与训练效率。**

- **链接: [https://arxiv.org/pdf/2603.21305](https://arxiv.org/pdf/2603.21305)**
...
>
---
#### [new 067] Incentivizing Generative Zero-Shot Learning via Outcome-Reward Reinforcement Learning with Visual Cues
- **分类: cs.CV**

- **简介: 该论文属于零样本学习任务，旨在解决生成模型合成特征任务无关及类间视觉差异不足的问题。提出RLVC框架，通过强化学习与视觉提示提升生成能力，实现更优分类效果。**

- **链接: [https://arxiv.org/pdf/2603.21138](https://arxiv.org/pdf/2603.21138)**
...
>
---
#### [new 074] PEARL: Geometry Aligns Semantics for Training-Free Open-Vocabulary Semantic Segmentation
- **分类: cs.CV**

- **简介: 该论文提出PEARL方法，解决训练-free 开放词汇语义分割任务中的跨模态对齐问题，通过几何对齐和文本引导的传播实现高效分割。**

- **链接: [https://arxiv.org/pdf/2603.21528](https://arxiv.org/pdf/2603.21528)**
...
>
---
#### [new 075] PAM: A Pose-Appearance-Motion Engine for Sim-to-Real HOI Video Generation
- **分类: cs.CV**

- **简介: 该论文属于手-物体交互视频生成任务，旨在解决现有方法在姿态、外观和动态生成上的碎片化问题，提出PAM统一框架实现可控HOI视频生成。**
...
>
---
#### [new 079] End-to-End Training for Unified Tokenization and Latent Denoising
- **分类: cs.CV; cs.AI; cs.GR; cs.LG**

- **简介: 该论文提出UNITE模型，解决传统扩散模型需分阶段训练的问题。通过统一的生成编码器实现tokenization和latent denoising的一阶段联合训练，提升生成质量。**

- **链接: [https://arxiv.org/pdf/2603.22283](https://arxiv.org/pdf/2603.22283)**
...
>
---
#### [new 096] When Minor Edits Matter: LLM-Driven Prompt Attack for Medical VLM Robustness in Ultrasound
- **分类: cs.CV**

- **简介: 该论文属于医疗视觉语言模型的鲁棒性研究，旨在解决模型对微小提示攻击的脆弱性问题。通过LLM生成对抗性提示，评估SOTA模型的漏洞与失败模式。**

- **链接: [https://arxiv.org/pdf/2603.21047](https://arxiv.org/pdf/2603.21047)**
...
>
---
#### [new 159] One Pool Is Not Enough: Multi-Cluster Memory for Practical Test-Time Adaptation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于测试时适应任务，解决单簇记忆在非独立同分布测试流中的适应性问题。提出多簇记忆框架，通过聚类提升适应效果。**

- **链接: [https://arxiv.org/pdf/2603.21135](https://arxiv.org/pdf/2603.21135)**
...
>
---
#### [new 160] No Dense Tensors Needed: Fully Sparse Object Detection on Event-Camera Voxel Grids
- **分类: cs.CV**

- **简介: 该论文属于目标检测任务，解决事件相机数据处理效率低的问题，提出SparseVoxelDet，实现全稀疏处理，提升计算与存储效率。**

- **链接: [https://arxiv.org/pdf/2603.21638](https://arxiv.org/pdf/2603.21638)**
...
>
---
#### [new 161] Transparent Fragments Contour Estimation via Visual-Tactile Fusion for Autonomous Reassembly
...
>
---
#### [new 162] JANUS: A Lightweight Framework for Jailbreaking Text-to-Image Models via Distribution Optimization
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于文本生成图像模型的破解任务，旨在解决安全过滤机制失效问题。提出JANUS框架，通过分布优化实现高效破解，提升攻击成功率。**
...
>
---
#### [new 169] Monocular Models are Strong Learners for Multi-View Human Mesh Recovery
- **分类: cs.CV**

- **简介: 该论文属于多视角人体网格重建任务，旨在解决现有方法依赖标定或泛化能力差的问题。提出无需多视角训练数据的框架，利用单视角模型作为先验进行优化，提升重建性能。**
...
>
---
#### [new 170] FluidGaussian: Propagating Simulation-Based Uncertainty Toward Functionally-Intelligent 3D Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，旨在解决现有方法忽视物理交互与功能性的缺陷。提出FluidGaussian，结合流体模拟评估表面质量，提升重建的物理合理性。**
...
>
---
#### [new 179] Text-Image Conditioned 3D Generation
- **分类: cs.CV**

- **简介: 该论文属于3D生成任务，旨在解决单一模态条件下的生成局限性。通过结合文本与图像信息，提升生成的灵活性和准确性。**

- **链接: [https://arxiv.org/pdf/2603.21295](https://arxiv.org/pdf/2603.21295)**
...
>
---
#### [new 199] Two Experts Are Better Than One Generalist: Decoupling Geometry and Appearance for Feed-Forward 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于3D建模任务，旨在解决单次前向传播生成高质量3D高斯表示的问题。通过分离几何估计与外观合成，提出2Xplat框架，提升重建效果。**
...
>
> **备注:** Project page: $\href{this https URL}{URL}$
>
...
>
---
#### [new 200] Predictive Regularization Against Visual Representation Degradation in Multimodal Large Language Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于多模态语言模型任务，解决视觉表征退化问题。通过预测性正则化方法，提升模型的视觉理解能力。**

- **链接: [https://arxiv.org/pdf/2603.20808](https://arxiv.org/pdf/2603.20808)**
...
>
---
#### [new 201] Positional Segmentor-Guided Counterfactual Fine-Tuning for Spatially Localized Image Synthesis
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像生成任务，旨在解决现有方法无法实现局部结构修改的问题。通过改进Seg-CFT，提出Pos-Seg-CFT，实现更精确的区域控制。**

- **链接: [https://arxiv.org/pdf/2603.21213](https://arxiv.org/pdf/2603.21213)**
...
>
---
#### [new 213] FeatDistill: A Feature Distillation Enhanced Multi-Expert Ensemble Framework for Robust AI-generated Image Detection
- **分类: cs.CV; cs.MM**

- **简介: 该论文属于AI生成图像检测任务，旨在解决深度伪造图像在真实场景中的鲁棒检测问题。通过多专家集成与特征蒸馏方法，提升检测的泛化能力和稳定性。**

- **链接: [https://arxiv.org/pdf/2603.21939](https://arxiv.org/pdf/2603.21939)**
...
>
---
#### [new 228] LPNSR: Prior-Enhanced Diffusion Image Super-Resolution via LR-Guided Noise Prediction
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像超分辨率任务，旨在解决扩散模型在推理效率与重建质量间的矛盾。通过引入LR引导的噪声预测和预上采样网络，提升模型性能。**
...
>
---
#### [new 229] FreeArtGS: Articulated Gaussian Splatting Under Free-moving Scenario
...
>
---
#### [new 230] MS-CustomNet: Controllable Multi-Subject Customization with Hierarchical Relational Semantics
- **分类: cs.CV**

- **简介: 该论文属于多主体图像生成任务，旨在解决多主体场景中精细控制其关系与位置的问题。提出MS-CustomNet框架，实现用户对多主体布局的显式控制。**

- **链接: [https://arxiv.org/pdf/2603.21136](https://arxiv.org/pdf/2603.21136)**
...
>
---
#### [new 242] Many Dialects, Many Languages, One Cultural Lens: Evaluating Multilingual VLMs for Bengali Culture Understanding Across Historically Linked Languages and Regional Dialects
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 243] Anatomical Prior-Driven Framework for Autonomous Robotic Cardiac Ultrasound Standard View Acquisition
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 251] Your Robot Will Feel You Now: Empathy in Robots and Embodied Agents
...
>
---
#### [new 252] Attention in Space: Functional Roles of VLM Heads for Spatial Reasoning
- **分类: cs.AI; cs.CV**

- **简介: 该论文研究VLM中注意力头在空间推理中的功能，解决空间推理能力不足的问题。通过构建数据集和分析框架，揭示注意力头的分布与作用，提出提升空间理解的方法。**

- **链接: [https://arxiv.org/pdf/2603.20662](https://arxiv.org/pdf/2603.20662)**
...
>
---
#### [new 253] SSAM: Singular Subspace Alignment for Merging Multimodal Large Language Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于多模态模型融合任务，旨在解决不同模态预训练模型合并困难的问题。提出SSAM框架，通过参数空间对齐实现无监督融合，提升多模态处理能力。**

- **链接: [https://arxiv.org/pdf/2603.21584](https://arxiv.org/pdf/2603.21584)**
...
>
---
#### [new 256] A Multidisciplinary AI Board for Multimodal Dementia Characterization and Risk Assessment
- **分类: cs.AI; cs.CV**

- **简介: 该论文提出Cerebra，一个用于多模态痴呆特征分析和风险评估的AI系统，解决临床数据异质性和模型不透明问题，通过多代理协作提升诊断与预测性能。**
...
>
---
#### [new 257] Visual Exclusivity Attacks: Automatic Multimodal Red Teaming via Agentic Planning
- **分类: cs.CR; cs.CV; cs.LG**

- **简介: 该论文属于安全防护任务，旨在解决多模态攻击漏洞问题。提出Visual Exclusivity威胁和MM-Plan框架，通过视觉内容推理实施攻击，验证了前沿模型的安全风险。**

- **链接: [https://arxiv.org/pdf/2603.20198](https://arxiv.org/pdf/2603.20198)**
...
>
---
#### [new 260] PRM-as-a-Judge: A Dense Evaluation Paradigm for Fine-Grained Robotic Auditing
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 263] Unregistered Spectral Image Fusion: Unmixing, Adversarial Learning, and Recoverability
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于遥感图像融合任务，解决未配准HSI与MSI的融合问题。通过联合光谱解混和对抗学习，实现两者超分辨率，并提供理论保障。**
...
>
---
#### [new 264] ToFormer: Towards Large-scale Scenario Depth Completion for Lightweight ToF Camera
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 267] OmniPatch: A Universal Adversarial Patch for ViT-CNN Cross-Architecture Transfer in Semantic Segmentation
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于目标检测与防御任务，旨在解决ViT-CNN跨架构语义分割模型的对抗攻击问题。提出OmniPatch，生成通用对抗补丁以提升攻击的泛化性和跨架构转移能力。**

- **链接: [https://arxiv.org/pdf/2603.20777](https://arxiv.org/pdf/2603.20777)**
...
#### [replaced 001] Go Beyond Earth: Understanding Human Actions and Scenes in Microgravity Environments
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.02845](https://arxiv.org/pdf/2506.02845)**
...
>
> **备注:** 16 pages, 4 figures, code are available at this https URL
>
...
>
---
#### [replaced 002] Explore with Long-term Memory: A Benchmark and Multimodal LLM-based Reinforcement Learning Framework for Embodied Exploration
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.10744](https://arxiv.org/pdf/2601.10744)**

> **作者:** Sen Wang; Bangwei Liu; Zhenkun Gao; Lizhuang Ma; Xuhong Wang; Yuan Xie; Xin Tan
>
> **备注:** Accepted by CVPR 2026
>
> **摘要:** An ideal embodied agent should possess lifelong learning capabilities to handle long-horizon and complex tasks, enabling continuous operation in general environments. This not only requires the agent to accurately accomplish given tasks but also to leverage long-term episodic memory to optimize decision-making. However, existing mainstream one-shot embodied tasks primarily focus on task completion results, neglecting the crucial process of exploration and memory utilization. To address this, we propose Long-term Memory Embodied Exploration (LMEE), which aims to unify the agent's exploratory cognition and decision-making behaviors to promote lifelong learning. We further construct a corresponding dataset and benchmark, LMEE-Bench, incorporating multi-goal navigation and memory-based question answering to comprehensively evaluate both the process and outcome of embodied exploration. To enhance the agent's memory recall and proactive exploration capabilities, we propose MemoryExplorer, a novel method that fine-tunes a multimodal large language model through reinforcement learning to encourage active memory querying. By incorporating a multi-task reward function that includes action prediction, frontier selection, and question answering, our model achieves proactive exploration. Extensive experiments against state-of-the-art embodied exploration models demonstrate that our approach achieves significant advantages in long-horizon embodied tasks. Our dataset and code will be released at this https URL
>
---
#### [replaced 003] StaR-KVQA: Structured Reasoning Traces for Implicit-Knowledge Visual Question Answering
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.06638](https://arxiv.org/pdf/2510.06638)**

> **作者:** Zhihao Wen; Wenkang Wei; Yuan Fang; Xingtong Yu; Hui Zhang; Weicheng Zhu; Xin Zhang
>
> **备注:** 8+3+3 pages, code: this https URL
>
...
>
---
#### [replaced 004] MipSLAM: Alias-Free Gaussian Splatting SLAM
- **分类: cs.CV**
...
>
---
#### [replaced 011] EZ-SP: Fast and Lightweight Superpoint-Based 3D Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00385](https://arxiv.org/pdf/2512.00385)**

> **作者:** Louis Geist; Loic Landrieu; Damien Robert
>
> **备注:** Accepted at ICRA 2026. Camera-ready version with Appendix
>
...
>
> **备注:** 35 pages, 26 figures, change authors' information in page 1
>
...
>
---
#### [replaced 014] Foundation Models for Trajectory Planning in Autonomous Driving: A Review of Progress and Open Challenges
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 024] Unleashing the Potential of All Test Samples: Mean-Shift Guided Test-Time Adaptation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.00462](https://arxiv.org/pdf/2507.00462)**

> **作者:** Jizhou Han; Chenhao Ding; SongLin Dong; Yuhang He; Xinyuan Gao; Yihong Gong
>
> **备注:** Accepted by IEEE TCSVT. This is the author's version which has not been fully edited and content may change prior to final publication
>
...
>
---
#### [replaced 025] Texture Vector-Quantization and Reconstruction Aware Prediction for Generative Super-Resolution
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23774](https://arxiv.org/pdf/2509.23774)**

> **作者:** Qifan Li; Jiale Zou; Jinhua Zhang; Wei Long; Xingyu Zhou; Shuhang Gu
>
...
>
---
#### [replaced 028] Sharing the Learned Knowledge-base to Estimate Convolutional Filter Parameters for Continual Image Restoration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.05421](https://arxiv.org/pdf/2511.05421)**
...
>
---
#### [replaced 029] VideoAuto-R1: Video Auto Reasoning via Thinking Once, Answering Twice
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.05175](https://arxiv.org/pdf/2601.05175)**
...
>
---
#### [replaced 034] Unleashing Video Language Models for Fine-grained HRCT Report Generation
- **分类: cs.CV**
...
>
---
#### [replaced 035] GroundingME: Exposing the Visual Grounding Gap in MLLMs through Multi-Dimensional Evaluation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17495](https://arxiv.org/pdf/2512.17495)**
...
>
---
#### [replaced 036] When Safety Collides: Resolving Multi-Category Harmful Conflicts in Text-to-Image Diffusion via Adaptive Safety Guidance
- **分类: cs.CV**
...
>
---
#### [replaced 037] Downscaling Intelligence: Exploring Perception and Reasoning Bottlenecks in Small Multimodal Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.17487](https://arxiv.org/pdf/2511.17487)**

> **作者:** Mark Endo; Serena Yeung-Levy
>
> **备注:** CVPR 2026, website at this https URL
>
> **摘要:** Scaling up multimodal models has enabled remarkable advances in visual understanding and reasoning, but practical demands call for smaller, efficient systems. In this work, we conduct a principled analysis of downscaling intelligence in multimodal models, examining how reduced large language model (LLM) capacity affects multimodal capabilities. Our initial findings reveal an interesting trend: LLM downscaling disproportionately affects visual capabilities, rather than abilities inherited from the LLM. We then examine whether this drop mainly reflects the expected decline in visual reasoning or a more fundamental loss of perceptual abilities. Isolating the effect of LLM downscaling on perception, we find performance still drops sharply, often matching or exceeding the impact on reasoning. To address this bottleneck, we introduce visual extraction tuning, which explicitly trains the model to extract instruction-relevant visual details consistently across tasks. With these extracted visual details, we then apply step-by-step reasoning to generate answers. Together, these components form our Extract+Think approach, setting a new standard for efficiency and performance in this space.
>
---
#### [replaced 038] SwitchCraft: Training-Free Multi-Event Video Generation with Attention Controls
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.23956](https://arxiv.org/pdf/2602.23956)**
...
>
---
#### [replaced 039] M4-RAG: A Massive-Scale Multilingual Multi-Cultural Multimodal RAG
...
>
---
#### [replaced 040] From Explanations to Architecture: Explainability-Driven CNN Refinement for Brain Tumor Classification in MRI
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.09161](https://arxiv.org/pdf/2506.09161)**

> **作者:** Rajan Das Gupta; Md Imrul Hasan Showmick; Lei Wei; Mushfiqur Rahman Abir; Shanjida Akter; Md. Yeasin Rahat; Md. Jakir Hossen
>
...
>
---
#### [replaced 043] Diffusion Probe: Generated Image Result Prediction Using CNN Probes
- **分类: cs.CV**
...
>
---
#### [replaced 044] Flowception: Temporally Expansive Flow Matching for Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.11438](https://arxiv.org/pdf/2512.11438)**
...
>
---
#### [replaced 047] FideDiff: Efficient Diffusion Model for High-Fidelity Image Motion Deblurring
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.01641](https://arxiv.org/pdf/2510.01641)**
...
>
---
#### [replaced 048] SPKLIP: Aligning Spike Video Streams with Natural Language
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.12656](https://arxiv.org/pdf/2505.12656)**

> **作者:** Yongchang Gao; Meiling Jin; Zhaofei Yu; Tiejun Huang; Guozhang Chen
>
> **备注:** A dataset partitioning error occurred and is being corrected
>
...
>
---
#### [replaced 057] HIFICL: High-Fidelity In-Context Learning for Multimodal Tasks
- **分类: cs.CV**
...
>
---
#### [replaced 058] Learning to Generate Rigid Body Interactions with Video Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.02284](https://arxiv.org/pdf/2510.02284)**

> **作者:** David Romero; Ariana Bermudez; Viacheslav Iablochnikov; Hao Li; Fabio Pizzati; Ivan Laptev
>
...
>
> **备注:** 8 pages. Accepted by CVPR 2026
>
...
>
---
#### [replaced 072] SignSparK: Efficient Multilingual Sign Language Production via Sparse Keyframe Learning
- **分类: cs.CV**
...
>
---
#### [replaced 075] Identity as Presence: Towards Appearance and Voice Personalized Joint Audio-Video Generation
- **分类: cs.CV**
...
>
---
#### [replaced 076] IDSplat: Instance-Decomposed 3D Gaussian Splatting for Driving Scenes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.19235](https://arxiv.org/pdf/2511.19235)**
...
>
---
#### [replaced 077] PaQ-DETR: Learning Pattern and Quality-Aware Dynamic Queries for Object Detection
- **分类: cs.CV**
...
>
> **备注:** 10 pages, 6 figures, Accepted at CVPR2026
>
...
>
---
#### [replaced 078] CompBench: Benchmarking Complex Instruction-guided Image Editing
- **分类: cs.CV**
...
>
---
#### [replaced 079] ReSpace: Text-Driven Autoregressive 3D Indoor Scene Synthesis and Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.02459](https://arxiv.org/pdf/2506.02459)**

> **作者:** Martin JJ. Bucher; Iro Armeni
>
> **备注:** 36 pages, 19 figures, 11 tables (incl. appendix)
>
...
>
---
#### [replaced 080] Intrinsic Image Fusion for Multi-View 3D Material Reconstruction
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.13157](https://arxiv.org/pdf/2512.13157)**

> **作者:** Peter Kocsis; Lukas Höllein; Matthias Nießner
>
> **备注:** Project page: this https URL Video: this https URL
>
> **摘要:** We introduce Intrinsic Image Fusion, a method that reconstructs high-quality physically based materials from multi-view images. Material reconstruction is highly underconstrained and typically relies on analysis-by-synthesis, which requires expensive and noisy path tracing. To better constrain the optimization, we incorporate single-view priors into the reconstruction process. We leverage a diffusion-based material estimator that produces multiple, but often inconsistent, candidate decompositions per view. To reduce the inconsistency, we fit an explicit low-dimensional parametric function to the predictions. We then propose a robust optimization framework using soft per-view prediction selection together with confidence-based soft multi-view inlier set to fuse the most consistent predictions of the most confident views into a consistent parametric material space. Finally, we use inverse path tracing to optimize for the low-dimensional parameters. Our results outperform state-of-the-art methods in material disentanglement on both synthetic and real scenes, producing sharp and clean reconstructions suitable for high-quality relighting.
>
---
#### [replaced 081] MetroGS: Efficient and Stable Reconstruction of Geometrically Accurate High-Fidelity Large-Scale Scenes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.19172](https://arxiv.org/pdf/2511.19172)**

> **作者:** Kehua Chen; Tianlu Mao; Xinzhu Ma; Hao Jiang; Zehao Li; Zihan Liu; Shuqi Gao; Honglong Zhao; Feng Dai; Yucheng Zhang; Zhaoqi Wang
>
> **备注:** Project page: this https URL
>
...
>
---
#### [replaced 082] Frequency-Adaptive Discrete Cosine-ViT-ResNet Architecture for Sparse-Data Vision
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.22701](https://arxiv.org/pdf/2505.22701)**

> **作者:** Ziyue Kang; Weichuan Zhang
>
> **备注:** This manuscript has been withdrawn by the authors following further review. The authors concluded that the current version requires substantial revision to ensure the robustness and reproducibility of the reported results. To avoid possible misunderstanding or overinterpretation, the authors have chosen to withdraw the present version
>
...
>
---
#### [replaced 083] WiFi-GEN: High-Resolution Indoor Imaging from WiFi Signals Using Generative AI
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 084] Enhanced Structured Lasso Pruning with Class-wise Information
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2502.09125](https://arxiv.org/pdf/2502.09125)**

> **作者:** Xiang Liu; Mingchen Li; Xia Li; Leigang Qu; Guansu Wang; Zifan Peng; Yijun Song; Zemin Liu; Linshan Jiang; Jialin Li
>
> **备注:** 11 pages, 3 figures
>
...
>
---
#### [replaced 085] UniStitch: Unifying Semantic and Geometric Features for Image Stitching
- **分类: cs.CV**
...
>
---
#### [replaced 092] What "Not" to Detect: Negation-Aware VLMs via Structured Reasoning and Token Merging
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.13232](https://arxiv.org/pdf/2510.13232)**
...
>
---
#### [replaced 093] FreqEdit: Preserving High-Frequency Features for Robust Multi-Turn Image Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01755](https://arxiv.org/pdf/2512.01755)**
...
>
---
#### [replaced 096] TPCL: Task Progressive Curriculum Learning for Robust Visual Question Answering
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2411.17292](https://arxiv.org/pdf/2411.17292)**

> **作者:** Ahmed Akl; Abdelwahed Khamis; Zhe Wang; Ali Cheraghian; Sara Khalifa; Kewen Wang
>
> **备注:** Our source code is available at this https URL
>
...
>
---
#### [replaced 107] All Patches Matter, More Patches Better: Enhance AI-Generated Image Detection via Panoptic Patch Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.01396](https://arxiv.org/pdf/2504.01396)**

> **作者:** Zheng Yang; Ruoxin Chen; Zhiyuan Yan; Ke-Yue Zhang; Xinghe Fu; Shuang Wu; Xiujun Shu; Taiping Yao; Shouhong Ding; Zequn Qin; Xi Li
>
...
>
---
#### [replaced 121] MPFlow: Multi-modal Posterior-Guided Flow Matching for Zero-Shot MRI Reconstruction
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 124] HERE: Hierarchical Active Exploration of Radiance Field with Epistemic Uncertainty Minimization
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 133] DAGE: Dual-Stream Architecture for Efficient and Fine-Grained Geometry Estimation
- **分类: cs.CV**
...
>
---
#### [replaced 134] Continual Learning with Vision-Language Models via Semantic-Geometry Preservation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2603.12055](https://arxiv.org/pdf/2603.12055)**
...
>
---
#### [replaced 135] Towards Unified World Models for Visual Navigation via Memory-Augmented Planning and Foresight
...
>
---
#### [replaced 139] From Synthetic Scenes to Real Performance: Enhancing Spatial Reasoning in VLMs
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 140] LoGoColor: Local-Global 3D Colorization for 360° Scenes
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09278](https://arxiv.org/pdf/2512.09278)**
...
>
---
#### [replaced 141] ObjectForesight: Predicting Future 3D Object Trajectories from Human Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.05237](https://arxiv.org/pdf/2601.05237)**
...
>
> **备注:** Accepted to ICLR 2026. Camera ready version
>
...
>
---
#### [replaced 146] CausalCLIP: Causally-Informed Feature Disentanglement and Filtering for Generalizable Detection of Generated Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.13285](https://arxiv.org/pdf/2512.13285)**
...
>
---
#### [replaced 147] Scene-VLM: Multimodal Video Scene Segmentation via Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21778](https://arxiv.org/pdf/2512.21778)**
...
>
---
#### [replaced 153] No Need For Real Anomaly: MLLM Empowered Zero-Shot Video Anomaly Detection
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 154] Audio-sync Video Instance Editing with Granularity-Aware Mask Refiner
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.10571](https://arxiv.org/pdf/2512.10571)**
...
>
---
#### [replaced 155] UniDrive-WM: Unified Understanding, Planning and Generation World Model For Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.04453](https://arxiv.org/pdf/2601.04453)**
...
>
---
#### [replaced 158] From Scale to Speed: Adaptive Test-Time Scaling for Image Editing
...
>
---
#### [replaced 162] Real-Time Long Horizon Air Quality Forecasting via Group-Relative Policy Optimization
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.22169](https://arxiv.org/pdf/2511.22169)**
...
>
---
#### [replaced 167] VIRD: View-Invariant Representation through Dual-Axis Transformation for Cross-View Pose Estimation
- **分类: cs.CV**
...
>
---
#### [replaced 169] HPE-CogVLM: Advancing Vision Language Models with a Head Pose Grounding Task
...
>
---
#### [replaced 170] CrowdGaussian: Reconstructing High-Fidelity 3D Gaussians for Human Crowd from a Single Image
- **分类: cs.CV**
...
>
---
#### [replaced 171] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.01583](https://arxiv.org/pdf/2412.01583)**

> **作者:** Ziyang Yan; Yihua Shao; Minwen Liao; Siyu Chen; Nan Wang; Muyuan Lin; Jenq-Neng Hwang; Hao Zhao; Fabio Remondino; Lei Li
>
> **备注:** Accepted by WACV 2026, Project Page: this https URL
>
