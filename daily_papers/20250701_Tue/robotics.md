...
- **简介: 该论文属于视觉惯性里程计任务，旨在解决事件相机噪声影响地图点质量的问题。通过体素地图管理，提升状态估计精度与效率。**
...
- **简介: 该论文属于农业机器人任务，解决半自主双臂机器人在葡萄园中的采摘问题。提出一种分层二次规划控制架构，实现复杂任务的高效执行与人机协作。**
...
- **简介: 该论文属于机器人控制任务，旨在解决四足机器人在室内环境中运行时的噪音问题。通过优化步态和控制策略，实现降噪效果。**
...
- **简介: 该论文属于工业机器人误差补偿任务，旨在提升轨迹精度。通过结合物理模型与深度学习，提出SPI-BoTER方法，在小样本下实现高精度误差补偿。**
...
- **简介: 该论文研究单机器人重构连接积木的问题，旨在实现从起始到目标形状的高效转换。工作包括实现并评估一种基于直方图的算法及两种启发式方法。**
...
> **作者:** Zeyu Han; Mengchi Cai; Chaoyi Chen; Qingwen Meng; Guangwei Wang; Ying Liu; Qing Xu; Jianqiang Wang; Keqiang Li
>
...
- **链接: [http://arxiv.org/pdf/2506.23919v1](http://arxiv.org/pdf/2506.23919v1)**
...
- **简介: 该论文属于建模任务，旨在解决软体机器人液压系统中体积-流量-压力关系的复杂非线性问题。通过数据驱动方法，构建简洁高效的模型以提升实时应用性能。**
...
- **简介: 该论文属于多机器人系统任务，解决机器人在充电时破坏网络连通性的问题。通过设计混合系统模型和能量感知的网络结构，确保覆盖性能与能量约束。**
...
- **简介: 该论文属于路径规划任务，解决机器人路径中可通行空间优化问题。提出PTOPP方法，通过检测通道提升路径规划的效率与最优性。**
...
- **简介: 该论文属于机器人操作任务，旨在解决VLMs缺乏对物理前提理解的问题。提出PAC Bench基准，评估模型在物体属性、可操作性和约束方面的物理理解能力。**
...
- **简介: 该论文属于远程操作任务，解决无触觉反馈下的运动控制问题，通过优化算法生成无碰撞轨迹并抑制液体晃动。**
...
- **链接: [http://arxiv.org/pdf/2506.24046v1](http://arxiv.org/pdf/2506.24046v1)**
...
>
---
#### [new 052] Innovative Research on IoT Architecture and Robotic Operating Platforms: Applications of Large Language Models and Generative AI
...
>
---
#### [replaced 013] AsymDex: Asymmetry and Relative Coordinates for RL-based Bimanual Dexterity
- **分类: cs.RO**
...
>
---
#### [replaced 016] Simultaneous Multi-Robot Motion Planning with Projected Diffusion Models
- **分类: cs.RO; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.03607v2](http://arxiv.org/pdf/2502.03607v2)**
...
>
---
#### [replaced 017] Skill-Nav: Enhanced Navigation with Versatile Quadrupedal Locomotion via Waypoint Interface
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2506.21853v2](http://arxiv.org/pdf/2506.21853v2)**
...
>
---
#### [replaced 018] Planning under Uncertainty to Goal Distributions
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2011.04782v3](http://arxiv.org/pdf/2011.04782v3)**

> **作者:** Adam Conkey; Tucker Hermans
>
...
>
---
#### [replaced 019] Diffusion Models for Robotic Manipulation: A Survey
- **分类: cs.RO; stat.ML**

- **链接: [http://arxiv.org/pdf/2504.08438v2](http://arxiv.org/pdf/2504.08438v2)**

> **作者:** Rosa Wolf; Yitian Shi; Sheng Liu; Rania Rayyes
>
> **备注:** 28 pages, 2 figure, 9 tables
>
...
>
---
#### [replaced 020] Multi Layered Autonomy and AI Ecologies in Robotic Art Installations
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.02606v3](http://arxiv.org/pdf/2506.02606v3)**
...
>
---
#### [replaced 021] Low-Cost Infrared Vision Systems for Improved Safety of Emergency Vehicle Operations Under Low-Visibility Conditions
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 022] Ego-Foresight: Self-supervised Learning of Agent-Aware Representations for Improved RL
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2407.01570v2](http://arxiv.org/pdf/2407.01570v2)**
...
>
---
#### [replaced 023] CBAGAN-RRT: Convolutional Block Attention Generative Adversarial Network for Sampling-Based Path Planning
- **分类: cs.RO; cs.CV; cs.LG**
...
>
---
#### [replaced 026] Adaptive Domain Modeling with Language Models: A Multi-Agent Approach to Task Planning
- **分类: cs.AI; cs.RO**

- **链接: [http://arxiv.org/pdf/2506.19592v2](http://arxiv.org/pdf/2506.19592v2)**
...
>
---
#### [replaced 027] ReactEMG: Zero-Shot, Low-Latency Intent Detection via sEMG
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2506.19815v3](http://arxiv.org/pdf/2506.19815v3)**
