...
#### [new 001] DeTracker: Motion-decoupled Vehicle Detection and Tracking in Unstabilized Satellite Videos
- **分类: cs.CV; eess.IV**

- **简介: 该论文属于多目标跟踪任务，解决不稳定卫星视频中目标跟踪困难的问题。提出DeTracker框架，通过运动解耦和时序特征融合提升跟踪性能。**

- **链接: [https://arxiv.org/pdf/2601.09240v1](https://arxiv.org/pdf/2601.09240v1)**
...
>
---
#### [new 002] Reading or Reasoning? Format Decoupled Reinforcement Learning for Document OCR
...
>
---
#### [new 011] Residual Cross-Modal Fusion Networks for Audio-Visual Navigation
- **分类: cs.CV; cs.AI; cs.RO**

- **简介: 该论文属于音频-视觉导航任务，旨在解决多模态融合中的单模态主导和信息退化问题。提出CRFN网络，通过残差交互实现互补建模与对齐，提升跨域泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.08868v1](https://arxiv.org/pdf/2601.08868v1)**
...
>
---
#### [new 012] Exploring Reliable Spatiotemporal Dependencies for Efficient Visual Tracking
- **分类: cs.CV**

- **简介: 该论文属于视觉跟踪任务，旨在解决轻量级跟踪器性能不足的问题。通过引入可靠时序依赖和密集采样，提升跟踪效果与效率。**

- **链接: [https://arxiv.org/pdf/2601.09078v1](https://arxiv.org/pdf/2601.09078v1)**
...
>
---
#### [new 013] Learning Domain-Invariant Representations for Cross-Domain Image Registration via Scene-Appearance Disentanglement
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于跨域图像配准任务，解决域间强度差异导致的配准难题。提出SAR-Net框架，通过场景与外观解耦实现域不变表示，提升配准精度与效率。**

- **链接: [https://arxiv.org/pdf/2601.08875v1](https://arxiv.org/pdf/2601.08875v1)**
...
>
---
#### [new 016] STEP3-VL-10B Technical Report
- **分类: cs.CV**

- **简介: 该论文提出STEP3-VL-10B，解决多模态模型效率与性能平衡问题，通过预训练和强化学习提升推理能力，实现高效且强大的多模态任务处理。**

- **链接: [https://arxiv.org/pdf/2601.09668v1](https://arxiv.org/pdf/2601.09668v1)**
...
>
---
#### [new 023] GlovEgo-HOI: Bridging the Synthetic-to-Real Gap for Industrial Egocentric Human-Object Interaction Detection
- **分类: cs.CV**

- **简介: 该论文属于工业场景下的自指人类-物体交互检测任务，旨在解决标注数据不足的问题。通过合成数据与扩散过程生成真实PPE增强数据，并提出GlovEgo-Net模型提升检测效果。**

- **链接: [https://arxiv.org/pdf/2601.09528v1](https://arxiv.org/pdf/2601.09528v1)**
...
>
---
#### [new 030] AquaFeat+: an Underwater Vision Learning-based Enhancement Method for Object Detection, Classification, and Tracking
- **分类: cs.CV**

- **简介: 该论文属于 underwater vision 任务，解决水下视频分析中因光照、颜色失真和浑浊导致的视觉质量差问题。提出AquaFeat+方法，提升目标检测、分类和跟踪性能。**

- **链接: [https://arxiv.org/pdf/2601.09652v1](https://arxiv.org/pdf/2601.09652v1)**
...
>
---
#### [new 035] Sim2real Image Translation Enables Viewpoint-Robust Policies from Fixed-Camera Datasets
- **分类: cs.CV; cs.AI; cs.RO**

- **简介: 该论文属于视觉导航任务，解决机器人操作中因摄像头视角变化导致的策略脆弱问题。通过MANGO方法实现模拟到现实的图像翻译，提升策略的视角鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.09605v1](https://arxiv.org/pdf/2601.09605v1)**
...
>
> **备注:** Project page: https://yuci-gpt.github.io/TAG-MoE/
>
...
>
---
#### [new 040] Towards Robust Cross-Dataset Object Detection Generalization under Domain Specificity
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于目标检测任务，研究跨数据集泛化问题。针对领域特定性，分析不同数据集间迁移性能差异，提出开放标签评估方法以区分领域偏移与标签不匹配。**

- **链接: [https://arxiv.org/pdf/2601.09497v1](https://arxiv.org/pdf/2601.09497v1)**
...
>
---
#### [new 041] CogRail: Benchmarking VLMs in Cognitive Intrusion Perception for Intelligent Railway Transportation Systems
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于铁路安全领域，解决潜在入侵目标的感知问题。通过构建CogRail基准，评估并优化视觉语言模型，提升其时空推理能力。**

- **链接: [https://arxiv.org/pdf/2601.09613v1](https://arxiv.org/pdf/2601.09613v1)**
...
>
---
#### [new 045] Identifying Models Behind Text-to-Image Leaderboards
- **分类: cs.CV; cs.CR; cs.LG**

- **简介: 该论文属于文本到图像模型安全研究，解决匿名化 leaderboard 的漏洞问题。通过分析图像嵌入空间，实现模型去匿名化，揭示安全缺陷并提出区分度指标。**

- **链接: [https://arxiv.org/pdf/2601.09647v1](https://arxiv.org/pdf/2601.09647v1)**
...
>
---
#### [new 051] Bias Detection and Rotation-Robustness Mitigation in Vision-Language Models and Generative Image Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态AI研究，旨在解决视觉语言模型和生成模型在图像旋转等变换下的鲁棒性与公平性问题。通过数据增强和模型优化，提升模型的稳定性与公平性。**

- **链接: [https://arxiv.org/pdf/2601.08860v1](https://arxiv.org/pdf/2601.08860v1)**
...
>
> **摘要:** Vision-Language Models (VLMs) and generative image models have achieved remarkable performance across multimodal tasks, yet their robustness and fairness under input transformations remain insufficiently explored. This work investigates bias propagation and robustness degradation in state-of-the-art vision-language and generative models, with a particular focus on image rotation and distributional shifts. We analyze how rotation-induced perturbations affect model predictions, confidence calibration, and demographic bias patterns. To address these issues, we propose rotation-robust mitigation strategies that combine data augmentation, representation alignment, and model-level regularization. Experimental results across multiple datasets demonstrate that the proposed methods significantly improve robustness while reducing bias amplification without sacrificing overall performance. This study highlights critical limitations of current multimodal systems and provides practical mitigation techniques for building more reliable and fair AI models.
>
---
#### [new 052] Detail Loss in Super-Resolution Models Based on the Laplacian Pyramid and Repeated Upscaling and Downscaling Process
- **分类: cs.CV**

- **简介: 该论文属于图像超分辨率任务，旨在提升图像的高频率细节。提出基于拉普拉斯金字塔的细节损失和重复缩放过程，以增强细节表现。**

- **链接: [https://arxiv.org/pdf/2601.09410v1](https://arxiv.org/pdf/2601.09410v1)**
...
>
---
#### [new 063] SSVP: Synergistic Semantic-Visual Prompting for Industrial Zero-Shot Anomaly Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于工业零样本异常检测任务，旨在解决单视觉主干模型在语义泛化与细粒度区分上的不足。提出SSVP方法，融合多视觉编码，提升模型感知能力。**

- **链接: [https://arxiv.org/pdf/2601.09147v1](https://arxiv.org/pdf/2601.09147v1)**
...
>
---
#### [new 080] OpenVoxel: Training-Free Grouping and Captioning Voxels for Open-Vocabulary 3D Scene Understanding
- **分类: cs.CV**

- **简介: 该论文提出OpenVoxel，用于开放词汇3D场景理解任务，解决稀疏体素分组与描述问题。通过视觉语言模型直接进行文本搜索，无需训练，提升复杂引用表达分割性能。**

- **链接: [https://arxiv.org/pdf/2601.09575v1](https://arxiv.org/pdf/2601.09575v1)**
...
>
---
#### [new 083] LLMs can Compress LLMs: Adaptive Pruning by Agents
...
>
---
#### [new 084] DriftGuard: A Hierarchical Framework for Concept Drift Detection and Remediation in Supply Chain Forecasting
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于供应链预测任务，解决概念漂移问题。提出DriftGuard框架，实现漂移检测、诊断和自动修正，提升预测准确性与投资回报。**

- **链接: [https://arxiv.org/pdf/2601.08928v1](https://arxiv.org/pdf/2601.08928v1)**
...
>
---
#### [new 085] Learning Whole-Body Human-Humanoid Interaction from Human-Human Demonstrations
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文属于人形机器人交互任务，解决HHoI数据稀缺问题。通过PAIR生成物理一致数据，再用D-STAR实现同步协作，提升交互能力。**

- **链接: [https://arxiv.org/pdf/2601.09518v1](https://arxiv.org/pdf/2601.09518v1)**
...
>
---
#### [new 086] Toward Understanding Unlearning Difficulty: A Mechanistic Perspective and Circuit-Guided Difficulty Metric
...
>
---
#### [new 087] Comprehensive Machine Learning Benchmarking for Fringe Projection Profilometry with Photorealistic Synthetic Data
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于三维重建任务，旨在解决FPP中数据不足和基准不完善的问题。通过生成合成数据集并对比不同模型，揭示了直接映射的局限性。**

- **链接: [https://arxiv.org/pdf/2601.08900v1](https://arxiv.org/pdf/2601.08900v1)**
...
>
---
#### [new 088] GOUHFI 2.0: A Next-Generation Toolbox for Brain Segmentation and Cortex Parcellation at Ultra-High Field MRI
- **分类: eess.IV; cs.CV; physics.med-ph**

- **简介: 该论文属于脑分割与皮层划分任务，旨在解决UHF-MRI数据自动分割效果不佳的问题。作者开发了GOUHFI 2.0工具，提升分割与皮层划分的准确性。**

- **链接: [https://arxiv.org/pdf/2601.09006v1](https://arxiv.org/pdf/2601.09006v1)**
...
>
---
#### [new 089] PersonalAlign: Hierarchical Implicit Intent Alignment for Personalized GUI Agent with Long-Term User-Centric Records
- **分类: cs.AI; cs.CV; cs.HC; cs.LG**

- **简介: 该论文提出PersonalAlign任务，解决GUI代理在长周期用户记录中理解隐式意图的问题。通过构建AndroidIntent基准和HIM-Agent模型，提升代理的个性化与主动性表现。**

- **链接: [https://arxiv.org/pdf/2601.09636v1](https://arxiv.org/pdf/2601.09636v1)**
...
>
---
#### [new 090] W-DUALMINE: Reliability-Weighted Dual-Expert Fusion With Residual Correlation Preservation for Medical Image Fusion
- **分类: eess.IV; cs.CV; math.NA**

- **简介: 该论文属于医学图像融合任务，旨在解决全局相似性与局部结构保真之间的矛盾。提出W-DUALMINE框架，通过双专家策略和残差融合提升融合效果。**

- **链接: [https://arxiv.org/pdf/2601.08920v1](https://arxiv.org/pdf/2601.08920v1)**
...
>
---
#### [new 095] Multimodal Signal Processing For Thermo-Visible-Lidar Fusion In Real-time 3D Semantic Mapping
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于实时3D语义建图任务，旨在解决复杂环境下SLAM的语义不足问题。通过融合热成像与可见光、LiDAR数据，提升地图的语义信息，用于灾害评估等应用。**

- **链接: [https://arxiv.org/pdf/2601.09578v1](https://arxiv.org/pdf/2601.09578v1)**

> **作者:** Jiajun Sun; Yangyi Ou; Haoyuan Zheng; Chao yang; Yue Ma
>
> **备注:** 5 pages,7 figures. Under review
>
> **摘要:** In complex environments, autonomous robot navigation and environmental perception pose higher requirements for SLAM technology. This paper presents a novel method for semantically enhancing 3D point cloud maps with thermal information. By first performing pixel-level fusion of visible and infrared images, the system projects real-time LiDAR point clouds onto this fused image stream. It then segments heat source features in the thermal channel to instantly identify high temperature targets and applies this temperature information as a semantic layer on the final 3D map. This approach generates maps that not only have accurate geometry but also possess a critical semantic understanding of the environment, making it highly valuable for specific applications like rapid disaster assessment and industrial preventive maintenance.
>
---
## 更新

#### [replaced 001] Image-to-Brain Signal Generation for Visual Prosthesis with CLIP Guided Multimodal Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.00787v4](https://arxiv.org/pdf/2509.00787v4)**

> **作者:** Ganxi Xu; Zhao-Rong Lai; Yuting Tang; Yonghao Song; Guoxu Zhou; Boyu wang; Jian Zhu; Jinyi Long
>
...
>
---
#### [replaced 002] AQ-PCDSys: An Adaptive Quantized Planetary Crater Detection System for Autonomous Space Exploration
- **分类: cs.LG; cs.AI; cs.CV; cs.ET; eess.SY**

- **链接: [https://arxiv.org/pdf/2508.18025v2](https://arxiv.org/pdf/2508.18025v2)**
...
>
---
#### [replaced 006] A Multi-Mode Structured Light 3D Imaging System with Multi-Source Information Fusion for Underwater Pipeline Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11354v2](https://arxiv.org/pdf/2512.11354v2)**
...
>
---
#### [replaced 009] An Attention Infused Deep Learning System with Grad-CAM Visualization for Early Screening of Glaucoma
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.17808v2](https://arxiv.org/pdf/2505.17808v2)**
...
>
---
#### [replaced 010] GenView++: Unifying Adaptive View Generation and Quality-Driven Supervision for Contrastive Representation Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23770v2](https://arxiv.org/pdf/2509.23770v2)**
...
>
---
#### [replaced 011] Ensemble-Based Event Camera Place Recognition Under Varying Illumination
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于视觉定位任务，解决事件相机在光照变化下的位置识别问题。提出一种融合多源信息的集成方法，提升识别鲁棒性。**

- **链接: [https://arxiv.org/pdf/2509.01968v2](https://arxiv.org/pdf/2509.01968v2)**
...
>
---
#### [replaced 012] GroupNL: Low-Resource and Robust CNN Design over Cloud and Device
- **分类: cs.CV; cs.AI; cs.DC**

- **链接: [https://arxiv.org/pdf/2506.12335v2](https://arxiv.org/pdf/2506.12335v2)**
...
>
---
#### [replaced 015] FigEx2: Visual-Conditioned Panel Detection and Captioning for Scientific Compound Figures
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 018] Analysis of Quantum Image Representations for Supervised Classification
- **分类: quant-ph; cs.AI; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.22039v2](https://arxiv.org/pdf/2507.22039v2)**
...
>
---
#### [replaced 019] SlumpGuard: An AI-Powered Real-Time System for Automated Concrete Slump Prediction via Video Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.10171v4](https://arxiv.org/pdf/2507.10171v4)**

> **作者:** Youngmin Kim; Giyeong Oh; Kwangsoo Youm; Youngjae Yu
>
> **备注:** Accepted to Automation in Construction. Our project page: https://winston1214.github.io/SlumpGuard/
>
...
>
---
#### [replaced 024] Hidden Monotonicity: Explaining Deep Neural Networks via their DC Decomposition
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.07700v2](https://arxiv.org/pdf/2601.07700v2)**
...
>
---
#### [replaced 025] Deep Hybrid Model for Region of Interest Detection in Omnidirectional Videos
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.18856v3](https://arxiv.org/pdf/2511.18856v3)**

> **作者:** Sana Alamgeer; Mylene Farias; Marcelo Carvalho
>
> **备注:** I need to withdraw this as it contains some confidential information related to FAPESP funding agency
>
...
>
---
#### [replaced 026] Boosting Adversarial Transferability with Low-Cost Optimization via Maximin Expected Flatness
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2405.16181v3](https://arxiv.org/pdf/2405.16181v3)**

> **作者:** Chunlin Qiu; Ang Li; Yiheng Duan; Shenyi Zhang; Yuanjie Zhang; Lingchen Zhao; Qian Wang
>
> **备注:** Accepted by IEEE T-IFS
>
...
>
---
#### [replaced 027] Scaling Remote Sensing Foundation Models: Data Domain Tradeoffs at the Peta-Scale
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23903v2](https://arxiv.org/pdf/2512.23903v2)**
...
>
---
#### [replaced 029] ProfVLM: A Lightweight Video-Language Model for Multi-View Proficiency Estimation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 032] DyDiT++: Diffusion Transformers with Timestep and Spatial Dynamics for Efficient Visual Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.06803v4](https://arxiv.org/pdf/2504.06803v4)**
...
>
---
#### [replaced 033] Weakly Supervised Concept Learning with Class-Level Priors for Interpretable Medical Diagnosis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.01131v2](https://arxiv.org/pdf/2511.01131v2)**
...
>
---
#### [replaced 034] Know Yourself Better: Diverse Object-Related Features Improve Open Set Recognition
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2404.10370v2](https://arxiv.org/pdf/2404.10370v2)**
...
>
---
#### [replaced 035] Self-Paced Learning for Images of Antinuclear Antibodies
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.21519v2](https://arxiv.org/pdf/2511.21519v2)**
...
>
---
#### [replaced 036] VideoAR: Autoregressive Video Generation via Next-Frame & Scale Prediction
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.05966v2](https://arxiv.org/pdf/2601.05966v2)**

> **作者:** Longbin Ji; Xiaoxiong Liu; Junyuan Shang; Shuohuan Wang; Yu Sun; Hua Wu; Haifeng Wang
>
> **备注:** Project page: https://ernie-research.github.io/VideoAR/
>
...
>
---
#### [replaced 039] Prompting4Debugging: Red-Teaming Text-to-Image Diffusion Models by Finding Problematic Prompts
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 040] MHLA: Restoring Expressivity of Linear Attention via Token-Level Multi-Head
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.07832v2](https://arxiv.org/pdf/2601.07832v2)**
...
>
---
#### [replaced 041] Tracking and Understanding Object Transformations
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.04678v2](https://arxiv.org/pdf/2511.04678v2)**
...
>
---
#### [replaced 042] FeatInv: Spatially resolved mapping from feature space to input space using conditional diffusion models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.21032v2](https://arxiv.org/pdf/2505.21032v2)**

> **作者:** Nils Neukirch; Johanna Vielhaben; Nils Strodthoff
>
> **备注:** Version published by Transactions on Machine Learning Research in 2025 (TMLR ISSN 2835-8856) at https://openreview.net/forum?id=UtE1YnPNgZ. 32 pages, 27 figures. This work builds on an earlier manuscript (arXiv:2505.21032) and crucially extends it. Code is available at https://github.com/AI4HealthUOL/FeatInv
>
...
>
---
#### [replaced 043] JoyAvatar-Flash: Real-time and Infinite Audio-Driven Avatar Generation with Autoregressive Diffusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11423v2](https://arxiv.org/pdf/2512.11423v2)**
...
>
---
#### [replaced 044] Pain in 3D: Generating Controllable Synthetic Faces for Automated Pain Assessment
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.16727v4](https://arxiv.org/pdf/2509.16727v4)**
...
>
---
#### [replaced 045] Comprehensive language-image pre-training for 3D medical image understanding
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.15042v2](https://arxiv.org/pdf/2510.15042v2)**

> **作者:** Tassilo Wald; Ibrahim Ethem Hamamci; Yuan Gao; Sam Bond-Taylor; Harshita Sharma; Maximilian Ilse; Cynthia Lo; Olesya Melnichenko; Anton Schwaighofer; Noel C. F. Codella; Maria Teodora Wetscherek; Klaus H. Maier-Hein; Panagiotis Korfiatis; Valentina Salvatelli; Javier Alvarez-Valle; Fernando Pérez-García
>
...
>
---
#### [replaced 046] Prototypical Contrastive Learning-based CLIP Fine-tuning for Object Re-identification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2310.17218v3](https://arxiv.org/pdf/2310.17218v3)**
...
>
---
#### [replaced 047] LC4-DViT: Land-cover Creation for Land-cover Classification with Deformable Vision Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22812v2](https://arxiv.org/pdf/2511.22812v2)**
...
>
---
#### [replaced 048] GI-Bench: A Panoramic Benchmark Revealing the Knowledge-Experience Dissociation of Multimodal Large Language Models in Gastrointestinal Endoscopy Against Clinical Standards
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.08183v2](https://arxiv.org/pdf/2601.08183v2)**
...
>
---
#### [replaced 049] Tuning-free Visual Effect Transfer across Videos
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.07833v3](https://arxiv.org/pdf/2601.07833v3)**
...
>
---
#### [replaced 050] AURASeg: Attention Guided Upsampling with Residual Boundary-Assistive Refinement for Drivable-Area Segmentation
- **分类: cs.RO; cs.CV**

- **简介: 该论文提出AURASeg，用于地面区域分割任务，解决边界精度不足和特征表示有限的问题，通过引入边界增强模块和注意力上采样结构提升分割效果。**

- **链接: [https://arxiv.org/pdf/2510.21536v3](https://arxiv.org/pdf/2510.21536v3)**
...
>
---
#### [replaced 051] Hierarchical Fusion of Local and Global Visual Features with Mixture-of-Experts for Remote Sensing Image Scene Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.27155v2](https://arxiv.org/pdf/2510.27155v2)**
...
>
---
#### [replaced 052] SPOT!: Map-Guided LLM Agent for Unsupervised Multi-CCTV Dynamic Object Tracking
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.20975v2](https://arxiv.org/pdf/2512.20975v2)**

> **作者:** Yujin Roh; Inho Jake Park; Chigon Hwang
>
...
>
---
#### [replaced 053] GeoMotionGPT: Geometry-Aligned Motion Understanding with Large Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.07632v2](https://arxiv.org/pdf/2601.07632v2)**
...
>
---
#### [replaced 054] ViSTA: Visual Storytelling using Multi-modal Adapters for Text-to-Image Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.12198v2](https://arxiv.org/pdf/2506.12198v2)**
...
>
---
#### [replaced 057] Decoupling Continual Semantic Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.05065v2](https://arxiv.org/pdf/2508.05065v2)**
...
>
---
#### [replaced 058] Large-scale modality-invariant foundation models for brain MRI analysis: Application to lesion segmentation
- **分类: eess.IV; cs.AI; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.11311v2](https://arxiv.org/pdf/2511.11311v2)**
...
>
---
#### [replaced 059] Universal Few-Shot Spatial Control for Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.07530v2](https://arxiv.org/pdf/2509.07530v2)**
...
>
---
#### [replaced 060] Beyond the Last Frame: Process-aware Evaluation for Generative Video Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.24952v2](https://arxiv.org/pdf/2512.24952v2)**
...
>
---
#### [replaced 061] egoEMOTION: Egocentric Vision and Physiological Signals for Emotion and Personality Recognition in Real-World Tasks
- **分类: cs.CV; cs.HC**

- **链接: [https://arxiv.org/pdf/2510.22129v2](https://arxiv.org/pdf/2510.22129v2)**
...
>
---
#### [replaced 062] A Multi-Stage Deep Learning Framework with PKCP-MixUp Augmentation for Pediatric Liver Tumor Diagnosis Using Multi-Phase Contrast-Enhanced CT
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.19478v2](https://arxiv.org/pdf/2511.19478v2)**
