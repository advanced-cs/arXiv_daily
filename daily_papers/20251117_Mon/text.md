...
#### [new 001] Evaluating Open-Weight Large Language Models for Structured Data Extraction from Narrative Medical Reports Across Multiple Use Cases and Languages
- **分类: cs.CL; cs.AI**

- **简介: 该论文评估15个开源大语言模型在从叙事医学报告提取结构化数据的任务上，覆盖6种疾病使用案例和多语言。在荷兰、英国、捷克机构测试，比较6种提示策略。发现小到中型通用模型性能接近大型模型，提示图和few-shot提升13%，任务复杂性比模型大小影响更大。**

- **链接: [https://arxiv.org/pdf/2511.10658v1](https://arxiv.org/pdf/2511.10658v1)**
...
>
---
#### [new 008] Cognitively-Inspired Episodic Memory Architectures for Accurate and Efficient Character AI
- **分类: cs.CL; cs.AI; cs.HC; cs.LG**

- **简介: 该论文解决历史人物对话系统中响应深度与延迟的权衡问题。提出认知启发的叙事记忆架构，通过离线数据增强和高效检索，将传记转化为丰富记忆，实现0.52s响应。在GPT-3.5/3上显著优于传统RAG，适用于教育与博物馆应用。**

- **链接: [https://arxiv.org/pdf/2511.10652v1](https://arxiv.org/pdf/2511.10652v1)**
...
>
---
#### [new 009] W2S-AlignTree: Weak-to-Strong Inference-Time Alignment for Large Language Models via Monte Carlo Tree Search
- **分类: cs.CL**

- **简介: 该论文解决LLM推理时对齐问题，提出W2S-AlignTree框架。利用蒙特卡洛树搜索和弱到强泛化，通过弱模型实时信号引导强模型生成，实现细粒度控制，无需修改参数，显著提升摘要等任务性能。**

- **链接: [https://arxiv.org/pdf/2511.11518v1](https://arxiv.org/pdf/2511.11518v1)**
...
>
---
#### [new 010] Leveraging Parameter Space Symmetries for Reasoning Skill Transfer in LLMs
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文解决LLM技能转移中任务算术的负面干扰问题，提出利用Transformer参数空间对称性（排列、旋转、缩放）对齐模型，成功将推理技能转移至非推理模型，实验优于标准方法。**

- **链接: [https://arxiv.org/pdf/2511.10850v1](https://arxiv.org/pdf/2511.10850v1)**
...
>
---
#### [new 011] CardioEmbed: Domain-Specialized Text Embeddings for Clinical Cardiology
- **分类: cs.CL; cs.LG**

- **简介: 该论文解决心脏病学临床应用中嵌入模型效果不佳问题，通过在心脏病学教科书语料上训练CardioEmbed模型（对比学习），实现99.60%检索准确率，优于MedTE 15.94个百分点。**

- **链接: [https://arxiv.org/pdf/2511.10930v1](https://arxiv.org/pdf/2511.10930v1)**
...
>
---
#### [new 012] When Data is the Algorithm: A Systematic Study and Curation of Preference Optimization Datasets
- **分类: cs.CL; cs.AI**

- **简介: 论文系统分析开源偏好优化数据集，解决缺乏质量标注和系统比较的问题。通过Magpie框架标注样本，揭示数据集差异；创建更小的UltraMix混合数据集，性能优于单个数据集。**

- **链接: [https://arxiv.org/pdf/2511.10985v1](https://arxiv.org/pdf/2511.10985v1)**
...
>
---
#### [new 013] "As Eastern Powers, I will veto." : An Investigation of Nation-level Bias of Large Language Models in International Relations
- **分类: cs.CL**

- **简介: 论文聚焦LLMs在国际关系中的国家偏见问题，开发评估框架测试五常国家。揭示偏见多维性及上下文依赖性，提出检索增强与反思去偏框架，有效降低偏见并提升性能。**

- **链接: [https://arxiv.org/pdf/2511.10695v1](https://arxiv.org/pdf/2511.10695v1)**
...
>
---
#### [new 015] $π$-Attention: Periodic Sparse Transformers for Efficient Long-Context Modeling
- **分类: cs.CL; cs.AI**

- **简介: 论文提出π-Attention周期稀疏Transformer，解决Transformer长上下文建模的二次复杂度问题。通过环形局部邻域和π步跳实现线性复杂度，实验显示比RingAttention低8.3%困惑度，GPU使用减少50%。**

- **链接: [https://arxiv.org/pdf/2511.10696v1](https://arxiv.org/pdf/2511.10696v1)**
...
>
---
#### [new 020] Forecasting Spoken Language Development in Children with Cochlear Implants Using Preimplantation MRI
- **分类: cs.CL; cs.LG**

- **简介: 该论文利用预植入MRI脑部特征，通过深度迁移学习（DTL）预测儿童人工耳蜗植入后的语言发展。DTL模型准确率达92.39%，显著优于传统机器学习，解决了语言改善预测不可靠的问题。**

- **链接: [https://arxiv.org/pdf/2511.10669v1](https://arxiv.org/pdf/2511.10669v1)**
...
>
---
#### [new 023] TEDxTN: A Three-way Speech Translation Corpus for Code-Switched Tunisian Arabic - English
- **分类: cs.CL; cs.AI**

- **简介: 论文提出TEDxTN，首个公开的突尼斯阿拉伯语-英语语音翻译语料库，解决阿拉伯方言数据稀缺问题。收集108个TEDx演讲（25小时，含代码切换），提供注释指南和基线系统结果，推动突尼斯方言自然语言处理研究。**

- **链接: [https://arxiv.org/pdf/2511.10780v1](https://arxiv.org/pdf/2511.10780v1)**
...
>
---
#### [new 028] From Fact to Judgment: Investigating the Impact of Task Framing on LLM Conviction in Dialogue Systems
- **分类: cs.CL**

- **简介: 该论文研究LLM在对话系统中作为裁判的可靠性，通过对比直接事实查询与对话判断任务（如“陈述正确”vs“说话者正确”），并添加反驳扰动，发现任务框架导致平均确信度变化9.24%，揭示对话框架对模型判断的关键影响。**

- **链接: [https://arxiv.org/pdf/2511.10871v1](https://arxiv.org/pdf/2511.10871v1)**
...
>
---
#### [new 029] MajinBook: An open catalogue of digital world literature with likes
- **分类: cs.CL; cs.CY; stat.OT**

- **简介: 论文构建MajinBook，一个开放语料库，通过链接影子图书馆与Goodreads数据，创建539,000+英语书籍高精度语料库，解决传统语料库偏差，支持计算社会科学和文化分析。**

- **链接: [https://arxiv.org/pdf/2511.11412v1](https://arxiv.org/pdf/2511.11412v1)**
...
>
---
#### [new 030] Modeling and Predicting Multi-Turn Answer Instability in Large Language Models
- **分类: cs.CL**

- **简介: 论文研究LLM多轮交互答案不稳定性。测试"Think again"提示使准确率显著下降（如Gemini 1.5 Flash降10%）。用马尔可夫链建模准确率动态，预测平稳准确率比初始低8%。提出平稳准确率作为稳健性指标，揭示模型脆弱性。**

- **链接: [https://arxiv.org/pdf/2511.10688v1](https://arxiv.org/pdf/2511.10688v1)**
...
>
---
#### [new 034] Studies with impossible languages falsify LMs as models of human language
- **分类: cs.CL**

- **简介: 论文审查文献，驳斥Futrell和Mahowald观点：语言模型（LMs）学习已证实语言和许多不可能语言难度相似，困难源于语言复杂性而非LMs缺陷；LMs缺失人类语言习得的归纳偏差，无法作为人类语言的完整模型。**

- **链接: [https://arxiv.org/pdf/2511.11389v1](https://arxiv.org/pdf/2511.11389v1)**
...
>
> **摘要:** According to Futrell and Mahowald [arXiv:2501.17047], both infants and language models (LMs) find attested languages easier to learn than impossible languages that have unnatural structures. We review the literature and show that LMs often learn attested and many impossible languages equally well. Difficult to learn impossible languages are simply more complex (or random). LMs are missing human inductive biases that support language acquisition.
>
---
#### [new 035] A methodological analysis of prompt perturbations and their effect on attack success rates
- **分类: cs.CL**

- **简介: 论文研究LLM对齐方法（SFT、DPO、RLHF）对提示攻击敏感度的影响。通过统计分析证明小提示修改显著改变攻击成功率（ASR），指出现有攻击基准可能不足。贡献在于系统化评估不同对齐方法的ASR敏感性。**

- **链接: [https://arxiv.org/pdf/2511.10686v1](https://arxiv.org/pdf/2511.10686v1)**
...
>
---
#### [new 037] Continual Learning of Domain Knowledge from Human Feedback in Text-to-SQL
- **分类: cs.CL; cs.AI; cs.DB**

- **简介: 论文解决Text-to-SQL任务中LLMs对数据库模式和隐性知识的不足。提出人类反馈驱动的持续学习框架，将知识提炼至结构化记忆，实验表明记忆增强代理显著提升查询准确率并减少错误。**

- **链接: [https://arxiv.org/pdf/2511.10674v1](https://arxiv.org/pdf/2511.10674v1)**
...
>
---
#### [new 038] PRBench: Large-Scale Expert Rubrics for Evaluating High-Stakes Professional Reasoning
- **分类: cs.CL; cs.CY**

- **简介: PRBench解决高风险专业领域（法律、金融）推理评估问题，引入大规模专家评分基准。创建1,100任务和19,356评分标准，由182名专业人士开发。评估显示顶级模型得分低（金融0.39，法律0.37），暴露推理缺陷。**

- **链接: [https://arxiv.org/pdf/2511.11562v1](https://arxiv.org/pdf/2511.11562v1)**
...
>
---
#### [new 042] Evaluating LLM Understanding via Structured Tabular Decision Simulations
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 论文提出Structured Tabular Decision Simulations (STaDS)框架，评估LLM真实理解能力而非仅准确性。通过15个决策场景测试9个模型，发现模型跨领域一致性差、准确但不忠实，强调需超越准确性的全局理解评估协议。**

- **链接: [https://arxiv.org/pdf/2511.10667v1](https://arxiv.org/pdf/2511.10667v1)**
...
>
---
#### [new 043] From Proof to Program: Characterizing Tool-Induced Reasoning Hallucinations in Large Language Models
- **分类: cs.CL; cs.LO; cs.SE**

- **简介: 该论文研究工具增强语言模型（TaLMs）的推理幻觉问题。揭示工具使用导致模型依赖输出而非真实推理（TIM现象），开发PYMATH基准量化推理退化；提出偏好优化框架提升推理深度与准确率。**

- **链接: [https://arxiv.org/pdf/2511.10899v1](https://arxiv.org/pdf/2511.10899v1)**
...
>
---
#### [new 044] Towards Fine-Grained Code-Switch Speech Translation with Semantic Space Alignment
...
>
---
#### [new 055] DiscoX: Benchmarking Discourse-Level Translation task in Expert Domains
- **分类: cs.CL; cs.AI**

- **简介: 论文针对专业领域话语级翻译评估不足的问题，提出DiscoX基准测试（200个专业文本，7领域）和Metric-S评估系统。实验表明先进LLMs仍落后于人类专家，验证了任务难度。**

- **链接: [https://arxiv.org/pdf/2511.10984v1](https://arxiv.org/pdf/2511.10984v1)**
...
> **备注:** 36 pages
>
> **摘要:** The evaluation of discourse-level translation in expert domains remains inadequate, despite its centrality to knowledge dissemination and cross-lingual scholarly communication. While these translations demand discourse-level coherence and strict terminological precision, current evaluation methods predominantly focus on segment-level accuracy and fluency. To address this limitation, we introduce DiscoX, a new benchmark for discourse-level and expert-level Chinese-English translation. It comprises 200 professionally-curated texts from 7 domains, with an average length exceeding 1700 tokens. To evaluate performance on DiscoX, we also develop Metric-S, a reference-free system that provides fine-grained automatic assessments across accuracy, fluency, and appropriateness. Metric-S demonstrates strong consistency with human judgments, significantly outperforming existing metrics. Our experiments reveal a remarkable performance gap: even the most advanced LLMs still trail human experts on these tasks. This finding validates the difficulty of DiscoX and underscores the challenges that remain in achieving professional-grade machine translation. The proposed benchmark and evaluation system provide a robust framework for more rigorous evaluation, facilitating future advancements in LLM-based translation.
>
---
#### [new 056] NOVA: An Agentic Framework for Automated Histopathology Analysis and Discovery
- **分类: cs.CL; cs.AI**

- **简介: NOVA框架解决病理学分析自动化问题，通过AI生成Python代码将科学查询转化为分析管道，集成49个领域工具。使用SlideQuest基准测试（90个病理学问题）评估，NOVA优于基线，并在案例研究中关联形态学与PAM50亚型。**

- **链接: [https://arxiv.org/pdf/2511.11324v1](https://arxiv.org/pdf/2511.11324v1)**
...
>
---
#### [new 065] Faithful Summarization of Consumer Health Queries: A Cross-Lingual Framework with LLMs
- **分类: cs.CL**

- **简介: 该论文解决消费者健康查询摘要的忠实性问题，提出跨语言框架融合TextRank与医学实体识别及LLMs。微调LLaMA-2-7B模型于双语数据集，显著提升质量与忠实性指标，人类评估显示80%摘要保留关键医疗信息。**

- **链接: [https://arxiv.org/pdf/2511.10768v1](https://arxiv.org/pdf/2511.10768v1)**
...
>
> **摘要:** Summarizing consumer health questions (CHQs) can ease communication in healthcare, but unfaithful summaries that misrepresent medical details pose serious risks. We propose a framework that combines TextRank-based sentence extraction and medical named entity recognition with large language models (LLMs) to enhance faithfulness in medical text summarization. In our experiments, we fine-tuned the LLaMA-2-7B model on the MeQSum (English) and BanglaCHQ-Summ (Bangla) datasets, achieving consistent improvements across quality (ROUGE, BERTScore, readability) and faithfulness (SummaC, AlignScore) metrics, and outperforming zero-shot baselines and prior systems. Human evaluation further shows that over 80\% of generated summaries preserve critical medical information. These results highlight faithfulness as an essential dimension for reliable medical summarization and demonstrate the potential of our approach for safer deployment of LLMs in healthcare contexts.
>
---
#### [new 066] Multimodal Peer Review Simulation with Actionable To-Do Recommendations for Community-Aware Manuscript Revisions
- **分类: cs.CL**

- **简介: 论文提出多模态同行评审模拟系统，解决现有文本输入限制和反馈不行动导向问题。通过多模态LLMs整合文本视觉信息、RAG增强上下文，生成Action:Objective格式待办事项，提供社区感知的修订指导，无缝集成学术写作平台。**

- **链接: [https://arxiv.org/pdf/2511.10902v1](https://arxiv.org/pdf/2511.10902v1)**

> **作者:** Mengze Hong; Di Jiang; Weiwei Zhao; Yawen Li; Yihang Wang; Xinyuan Luo; Yanjie Sun; Chen Jason Zhang
>
> **摘要:** While large language models (LLMs) offer promising capabilities for automating academic workflows, existing systems for academic peer review remain constrained by text-only inputs, limited contextual grounding, and a lack of actionable feedback. In this work, we present an interactive web-based system for multimodal, community-aware peer review simulation to enable effective manuscript revisions before paper submission. Our framework integrates textual and visual information through multimodal LLMs, enhances review quality via retrieval-augmented generation (RAG) grounded in web-scale OpenReview data, and converts generated reviews into actionable to-do lists using the proposed Action:Objective[\#] format, providing structured and traceable guidance. The system integrates seamlessly into existing academic writing platforms, providing interactive interfaces for real-time feedback and revision tracking. Experimental results highlight the effectiveness of the proposed system in generating more comprehensive and useful reviews aligned with expert standards, surpassing ablated baselines and advancing transparent, human-centered scholarly assistance.
>
---
#### [new 067] Guarding the Meaning: Self-Supervised Training for Semantic Robustness in Guard Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 论文针对LLM安全中guard models对语义保留改写敏感的问题，提出自监督训练框架。通过改写集和偏斜感知聚合策略，减少语义变异性58%，提升基准准确率2.5%，改善模型校准。**

- **链接: [https://arxiv.org/pdf/2511.10665v1](https://arxiv.org/pdf/2511.10665v1)**
...
>
---
#### [new 068] LaoBench: A Large-Scale Multidimensional Lao Benchmark for Large Language Models
- **分类: cs.CL**

- **简介: 该论文提出LaoBench，首个大规模多维老挝语基准数据集，解决LLMs在低资源东南亚语言评估缺失问题。含17,000+样本，覆盖知识应用、K12教育和双语翻译，通过专家与自动化验证构建，用于评估模型在老挝语的理解与推理能力。**

- **链接: [https://arxiv.org/pdf/2511.11334v1](https://arxiv.org/pdf/2511.11334v1)**
...
>
---
#### [new 070] Sabiá: Um Chatbot de Inteligência Artificial Generativa para Suporte no Dia a Dia do Ensino Superior
- **分类: cs.CL**

- **简介: 该论文提出Sabiá聊天机器人，基于GenAI和RAG技术解决高等教育日常信息碎片化问题。通过测试多个模型，选定Gemini 2.0 Flash（质量速度优）和Gemma 3n（开源性能佳）作为核心组件。**

- **链接: [https://arxiv.org/pdf/2511.10787v1](https://arxiv.org/pdf/2511.10787v1)**
...
>
---
#### [new 074] Co-EPG: A Framework for Co-Evolution of Planning and Grounding in Autonomous GUI Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文针对GUI自动化任务，解决规划与接地协同不足及过度依赖合成数据问题。提出Co-EPG框架，通过自迭代训练建立正反馈循环：规划模型探索策略生成数据优化接地模型，优化接地提供更好奖励，三次迭代即超越现有方法，无需外部数据。**

- **链接: [https://arxiv.org/pdf/2511.10705v1](https://arxiv.org/pdf/2511.10705v1)**

> **作者:** Yuan Zhao; Hualei Zhu; Tingyu Jiang; Shen Li; Xiaohang Xu; Hao Henry Wang
>
> **备注:** Accepted by AAAI 2026
>
> **摘要:** Graphical User Interface (GUI) task automation constitutes a critical frontier in artificial intelligence research. While effective GUI agents synergistically integrate planning and grounding capabilities, current methodologies exhibit two fundamental limitations: (1) insufficient exploitation of cross-model synergies, and (2) over-reliance on synthetic data generation without sufficient utilization. To address these challenges, we propose Co-EPG, a self-iterative training framework for Co-Evolution of Planning and Grounding. Co-EPG establishes an iterative positive feedback loop: through this loop, the planning model explores superior strategies under grounding-based reward guidance via Group Relative Policy Optimization (GRPO), generating diverse data to optimize the grounding model. Concurrently, the optimized Grounding model provides more effective rewards for subsequent GRPO training of the planning model, fostering continuous improvement. Co-EPG thus enables iterative enhancement of agent capabilities through self-play optimization and training data distillation. On the Multimodal-Mind2Web and AndroidControl benchmarks, our framework outperforms existing state-of-the-art methods after just three iterations without requiring external data. The agent consistently improves with each iteration, demonstrating robust self-enhancement capabilities. This work establishes a novel training paradigm for GUI agents, shifting from isolated optimization to an integrated, self-driven co-evolution approach.
>
---
#### [new 075] DocLens : A Tool-Augmented Multi-Agent Framework for Long Visual Document Understanding
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 077] On-Device Fine-Tuning via Backprop-Free Zeroth-Order Optimization
- **分类: cs.LG; cs.CL**

- **简介: 论文针对边缘AI设备端微调的内存瓶颈问题，提出内存高效零阶优化(MeZO)。该方法通过前向评估估计梯度，避免存储中间激活，允许更大模型在设备内存中运行。理论分析与实验验证表明，MeZO在内存约束下精度更高，但需更长微调时间。**

- **链接: [https://arxiv.org/pdf/2511.11362v1](https://arxiv.org/pdf/2511.11362v1)**
...
>
---
#### [new 082] S2D-ALIGN: Shallow-to-Deep Auxiliary Learning for Anatomically-Grounded Radiology Report Generation
...
>
---
#### [new 083] PISanitizer: Preventing Prompt Injection to Long-Context LLMs via Prompt Sanitization
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 论文提出PISanitizer，针对长上下文LLMs的提示注入攻击问题。通过识别并净化高注意力注入token，使攻击指令自陷困境，有效防御攻击且保持模型效用。**

- **链接: [https://arxiv.org/pdf/2511.10720v1](https://arxiv.org/pdf/2511.10720v1)**
...
>
---
#### [new 084] Building the Web for Agents: A Declarative Framework for Agent-Web Interaction
- **分类: cs.HC; cs.AI; cs.CL; cs.CY; cs.MA**

- **简介: 论文提出VOIX框架解决AI代理与Web交互的脆弱性问题。通过<tool>和<context>标签声明式定义网站能力，实现可靠、隐私保护交互。开发者测试中快速构建功能应用。**

- **链接: [https://arxiv.org/pdf/2511.11287v1](https://arxiv.org/pdf/2511.11287v1)**
...
>
---
#### [new 086] The Map of Misbelief: Tracing Intrinsic and Extrinsic Hallucinations Through Attention Patterns
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文解决LLM幻觉检测任务，区分外在与内在幻觉。提出基于注意力的评估框架和聚合策略，提升检测性能。实验证明，其方法对内在幻觉更有效，而采样方法仅适用于外在幻觉。**

- **链接: [https://arxiv.org/pdf/2511.10837v1](https://arxiv.org/pdf/2511.10837v1)**
...
>
---
#### [new 087] Discovering Meaningful Units with Visually Grounded Semantics from Image Captions
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 088] Language-Aided State Estimation
- **分类: eess.SY; cs.CL**

- **简介: 该论文针对物理系统状态估计任务，解决利用人类自然语言观察（如社交平台数据）作为感知代理的问题。提出Language-Aided Particle Filter (LAPF)，通过自然语言处理结构化语言数据并融入粒子滤波更新步骤，应用于灌溉渠水位估计并验证有效性。**

- **链接: [https://arxiv.org/pdf/2511.11285v1](https://arxiv.org/pdf/2511.11285v1)**
...
>
> **摘要:** Natural language data, such as text and speech, have become readily available through social networking services and chat platforms. By leveraging human observations expressed in natural language, this paper addresses the problem of state estimation for physical systems, in which humans act as sensing agents. To this end, we propose a Language-Aided Particle Filter (LAPF), a particle filter framework that structures human observations via natural language processing and incorporates them into the update step of the state estimation. Finally, the LAPF is applied to the water level estimation problem in an irrigation canal and its effectiveness is demonstrated.
>
---
#### [new 089] Optimizing Mixture of Block Attention
- **分类: cs.LG; cs.CL**

- **简介: 论文优化Mixture of Block Attention (MoBA)用于LLMs长上下文高效处理。解决MoBA设计原理不清和GPU实现低效问题。通过统计模型分析路由精度，提出小块大小与key卷积改进；开发FlashMoBA CUDA内核，实现14.7倍速度提升，性能匹配密集注意力基线。**

- **链接: [https://arxiv.org/pdf/2511.11571v1](https://arxiv.org/pdf/2511.11571v1)**
...
>
---
#### [new 090] Aligning Machiavellian Agents: Behavior Steering via Test-Time Policy Shaping
- **分类: cs.AI; cs.CL**

- **简介: 论文解决AI代理在动态环境中偏离人类价值观的问题，提出测试时策略塑造技术，利用场景-动作属性分类器精确控制伦理行为，无需重训练。在MACHIAVELLI基准测试中验证其有效性。**

- **链接: [https://arxiv.org/pdf/2511.11551v1](https://arxiv.org/pdf/2511.11551v1)**
...
#### [replaced 001] FakeZero: Real-Time, Privacy-Preserving Misinformation Detection for Facebook and X
- **分类: cs.CR; cs.CL**

- **链接: [https://arxiv.org/pdf/2510.25932v2](https://arxiv.org/pdf/2510.25932v2)**

> **作者:** Soufiane Essahli; Oussama Sarsar; Ahmed Bentajer; Anas Motii; Imane Fouad
>
...
>
---
#### [replaced 002] Consolidating and Developing Benchmarking Datasets for the Nepali Natural Language Understanding Tasks
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2411.19244v3](https://arxiv.org/pdf/2411.19244v3)**
...
>
---
#### [replaced 003] Bot Meets Shortcut: How Can LLMs Aid in Handling Unknown Invariance OOD Scenarios?
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.08455v3](https://arxiv.org/pdf/2511.08455v3)**
...
>
---
#### [replaced 004] Enhancing the Medical Context-Awareness Ability of LLMs via Multifaceted Self-Refinement Learning
- **分类: cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2511.10067v2](https://arxiv.org/pdf/2511.10067v2)**
...
>
---
#### [replaced 007] ModernBERT or DeBERTaV3? Examining Architecture and Data Influence on Transformer Encoder Models Performance
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2504.08716v2](https://arxiv.org/pdf/2504.08716v2)**

> **作者:** Wissam Antoun; Benoît Sagot; Djamé Seddah
>
> **备注:** Published as a conference paper at IJCNLP-AACL 2025
>
> **摘要:** Pretrained transformer-encoder models like DeBERTaV3 and ModernBERT introduce architectural advancements aimed at improving efficiency and performance. Although the authors of ModernBERT report improved performance over DeBERTaV3 on several benchmarks, the lack of disclosed training data and the absence of comparisons using a shared dataset make it difficult to determine whether these gains are due to architectural improvements or differences in training data. In this work, we conduct a controlled study by pretraining ModernBERT on the same dataset as CamemBERTaV2, a DeBERTaV3 French model, isolating the effect of model design. Our results show that the previous model generation remains superior in sample efficiency and overall benchmark performance, with ModernBERT's primary advantage being its support for long context, faster training, and inference speed. However, the new proposed model still provides meaningful architectural improvements compared to earlier models such as BERT and RoBERTa. Additionally, we observe that high-quality pre-training data accelerates convergence but does not significantly improve final performance, suggesting potential benchmark saturation. These findings show the importance of disentangling pretraining data from architectural innovations when evaluating transformer models.
>
---
#### [replaced 008] CyPortQA: Benchmarking Multimodal Large Language Models for Cyclone Preparedness in Port Operation
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2508.15846v2](https://arxiv.org/pdf/2508.15846v2)**
...
>
---
#### [replaced 009] Computational Analysis of Gender Depiction in the Comedias of Calderón de la Barca
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2411.03895v2](https://arxiv.org/pdf/2411.03895v2)**

> **作者:** Allison Keith; Antonio Rojas Castro; Hanno Ehrlicher; Kerstin Jung; Sebastian Padó
>
...
>
---
#### [replaced 010] Res-Bench: Benchmarking the Robustness of Multimodal Large Language Models to Dynamic Resolution Input
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 011] Latent Principle Discovery for Language Model Self-Improvement
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.16927v2](https://arxiv.org/pdf/2505.16927v2)**
...
>
---
#### [replaced 012] Adapt-Pruner: Adaptive Structural Pruning for Efficient Small Language Model Training
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2502.03460v3](https://arxiv.org/pdf/2502.03460v3)**
...
>
---
#### [replaced 013] Efficient Reasoning via Thought-Training and Thought-Free Inference
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.03408v2](https://arxiv.org/pdf/2511.03408v2)**
...
>
---
#### [replaced 014] Transformer Copilot: Learning from The Mistake Log in LLM Fine-tuning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.16270v2](https://arxiv.org/pdf/2505.16270v2)**
...
>
---
#### [replaced 015] Text2SQL-Flow: A Robust SQL-Aware Data Augmentation Framework for Text-to-SQL
- **分类: cs.CL; cs.DB**

- **链接: [https://arxiv.org/pdf/2511.10192v2](https://arxiv.org/pdf/2511.10192v2)**
...
>
---
#### [replaced 016] Identifying and Analyzing Performance-Critical Tokens in Large Language Models
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2401.11323v4](https://arxiv.org/pdf/2401.11323v4)**

> **作者:** Yu Bai; Heyan Huang; Cesare Spinoso-Di Piano; Marc-Antoine Rondeau; Sanxing Chen; Yang Gao; Jackie Chi Kit Cheung
>
> **备注:** AAAI 2026
>
> **摘要:** In-context learning (ICL) has emerged as an effective solution for few-shot learning with large language models (LLMs). However, how LLMs leverage demonstrations to specify a task and learn a corresponding computational function through ICL is underexplored. Drawing from the way humans learn from content-label mappings in demonstrations, we categorize the tokens in an ICL prompt into content, stopword, and template tokens. Our goal is to identify the types of tokens whose representations directly influence LLM's performance, a property we refer to as being performance-critical. By ablating representations from the attention of the test example, we find that the representations of informative content tokens have less influence on performance compared to template and stopword tokens, which contrasts with the human attention to informative words. We give evidence that the representations of performance-critical tokens aggregate information from the content tokens. Moreover, we demonstrate experimentally that lexical meaning, repetition, and structural cues are the main distinguishing characteristics of these tokens. Our work sheds light on how large language models learn to perform tasks from demonstrations and deepens our understanding of the roles different types of tokens play in large language models.
>
---
#### [replaced 017] Survey in Characterization of Semantic Change
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2402.19088v4](https://arxiv.org/pdf/2402.19088v4)**
...
>
---
#### [replaced 018] Format as a Prior: Quantifying and Analyzing Bias in LLMs for Heterogeneous Data
- **分类: cs.CL; cs.LG**

- **链接: [https://arxiv.org/pdf/2508.15793v2](https://arxiv.org/pdf/2508.15793v2)**
...
>
---
#### [replaced 019] BanglaTalk: Towards Real-Time Speech Assistance for Bengali Regional Dialects
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.06188v2](https://arxiv.org/pdf/2510.06188v2)**
...
>
---
#### [replaced 020] HI-TransPA: Hearing Impairments Translation Personal Assistant
...
>
---
#### [replaced 021] Beyond the Surface: Probing the Ideological Depth of Large Language Models
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2508.21448v2](https://arxiv.org/pdf/2508.21448v2)**
...
>
---
#### [replaced 022] Thinker: Training LLMs in Hierarchical Thinking for Deep Search via Multi-Turn Interaction
- **分类: cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2511.07943v2](https://arxiv.org/pdf/2511.07943v2)**
...
>
---
#### [replaced 024] Wage Sentiment Indices Derived from Survey Comments via Large Language Models
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2509.00290v2](https://arxiv.org/pdf/2509.00290v2)**
...
>
---
#### [replaced 025] $\textit{New News}$: System-2 Fine-tuning for Robust Integration of New Knowledge
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.01812v3](https://arxiv.org/pdf/2505.01812v3)**
...
>
---
#### [replaced 026] Scaling Latent Reasoning via Looped Language Models
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2510.25741v3](https://arxiv.org/pdf/2510.25741v3)**
...
>
---
#### [replaced 027] DomainCQA: Crafting Knowledge-Intensive QA from Domain-Specific Charts
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2503.19498v5](https://arxiv.org/pdf/2503.19498v5)**
...
>
---
#### [replaced 028] CO-VADA: A Confidence-Oriented Voice Augmentation Debiasing Approach for Fair Speech Emotion Recognition
- **分类: eess.AS; cs.CL**
...
>
---
#### [replaced 029] Q2E: Query-to-Event Decomposition for Zero-Shot Multilingual Text-to-Video Retrieval
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 030] Benchmarking Retrieval-Augmented Large Language Models in Biomedical NLP: Application, Robustness, and Self-Awareness
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2405.08151v3](https://arxiv.org/pdf/2405.08151v3)**

> **作者:** Mingchen Li; Zaifu Zhan; Han Yang; Yongkang Xiao; Jiatan Huang; Rui Zhang
>
> **摘要:** Large language models (LLM) have demonstrated remarkable capabilities in various biomedical natural language processing (NLP) tasks, leveraging the demonstration within the input context to adapt to new tasks. However, LLM is sensitive to the selection of demonstrations. To address the hallucination issue inherent in LLM, retrieval-augmented LLM (RAL) offers a solution by retrieving pertinent information from an established database. Nonetheless, existing research work lacks rigorous evaluation of the impact of retrieval-augmented large language models on different biomedical NLP tasks. This deficiency makes it challenging to ascertain the capabilities of RAL within the biomedical domain. Moreover, the outputs from RAL are affected by retrieving the unlabeled, counterfactual, or diverse knowledge that is not well studied in the biomedical domain. However, such knowledge is common in the real world. Finally, exploring the self-awareness ability is also crucial for the RAL system. So, in this paper, we systematically investigate the impact of RALs on 5 different biomedical tasks (triple extraction, link prediction, classification, question answering, and natural language inference). We analyze the performance of RALs in four fundamental abilities, including unlabeled robustness, counterfactual robustness, diverse robustness, and negative awareness. To this end, we proposed an evaluation framework to assess the RALs' performance on different biomedical NLP tasks and establish four different testbeds based on the aforementioned fundamental abilities. Then, we evaluate 3 representative LLMs with 3 different retrievers on 5 tasks over 9 datasets.
>
---
#### [replaced 031] First-Order Error Matters: Accurate Compensation for Quantized Large Language Models
...
>
> **摘要:** Large language models (LLMs) have demonstrated remarkable performance across a wide range of tasks, yet the majority of high-performing models remain closed-source or partially open, limiting transparency and reproducibility. In this work, we introduce Instella, a family of fully open three billion parameter language models trained entirely on openly available data and codebase. Powered by AMD Instinct MI300X GPUs, Instella is developed through large-scale pre-training, general-purpose instruction tuning, and alignment with human preferences. Despite using substantially fewer pre-training tokens than many contemporaries, Instella achieves state-of-the-art results among fully open models and is competitive with leading open-weight models of comparable size. We further release two specialized variants: Instella-Long, capable of handling context lengths up to 128K tokens, and Instella-Math, a reasoning-focused model enhanced through supervised fine-tuning and reinforcement learning on mathematical tasks. Together, these contributions establish Instella as a transparent, performant, and versatile alternative for the community, advancing the goal of open and reproducible language modeling research.
>
---
#### [replaced 034] Intelligence per Watt: Measuring Intelligence Efficiency of Local AI
- **分类: cs.DC; cs.AI; cs.CL; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.07885v2](https://arxiv.org/pdf/2511.07885v2)**
...
>
---
#### [replaced 035] DreamRunner: Fine-Grained Compositional Story-to-Video Generation with Retrieval-Augmented Motion Adaptation
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 036] Figurative Archive: an open dataset and web-based application for the study of metaphor
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2503.00444v4](https://arxiv.org/pdf/2503.00444v4)**
...
>
---
#### [replaced 044] Re-FRAME the Meeting Summarization SCOPE: Fact-Based Summarization and Personalization via Questions
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.15901v2](https://arxiv.org/pdf/2509.15901v2)**
