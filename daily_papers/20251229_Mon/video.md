...
>
---
#### [new 011] GPF-Net: Gated Progressive Fusion Learning for Polyp Re-Identification
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于结肠镜息肉重识别任务，旨在解决小目标细节信息丢失的问题。提出Gated Progressive Fusion网络，通过多层特征融合提升识别效果。**

- **链接: [https://arxiv.org/pdf/2512.21476v1](https://arxiv.org/pdf/2512.21476v1)**

> **作者:** Suncheng Xiang; Xiaoyang Wang; Junjie Jiang; Hejia Wang; Dahong Qian
>
> **备注:** Work in progress
>
> **摘要:** Colonoscopic Polyp Re-Identification aims to match the same polyp from a large gallery with images from different views taken using different cameras, which plays an important role in the prevention and treatment of colorectal cancer in computer-aided diagnosis. However, the coarse resolution of high-level features of a specific polyp often leads to inferior results for small objects where detailed information is important. To address this challenge, we propose a novel architecture, named Gated Progressive Fusion network, to selectively fuse features from multiple levels using gates in a fully connected way for polyp ReID. On the basis of it, a gated progressive fusion strategy is introduced to achieve layer-wise refinement of semantic information through multi-level feature interactions. Experiments on standard benchmarks show the benefits of the multimodal setting over state-of-the-art unimodal ReID models, especially when combined with the specialized multimodal fusion strategy.
>
---
#### [new 012] Yume-1.5: A Text-Controlled Interactive World Generation Model
- **分类: cs.CV**

- **简介: 该论文属于交互式世界生成任务，旨在解决生成模型参数大、推理慢及缺乏文本控制的问题。提出新框架实现从文本或图像生成实时、连续且可交互的虚拟世界。**

- **链接: [https://arxiv.org/pdf/2512.22096v1](https://arxiv.org/pdf/2512.22096v1)**

> **作者:** Xiaofeng Mao; Zhen Li; Chuanhao Li; Xiaojie Xu; Kaining Ying; Tong He; Jiangmiao Pang; Yu Qiao; Kaipeng Zhang
>
> **摘要:** Recent approaches have demonstrated the promise of using diffusion models to generate interactive and explorable worlds. However, most of these methods face critical challenges such as excessively large parameter sizes, reliance on lengthy inference steps, and rapidly growing historical context, which severely limit real-time performance and lack text-controlled generation capabilities. To address these challenges, we propose \method, a novel framework designed to generate realistic, interactive, and continuous worlds from a single image or text prompt. \method achieves this through a carefully designed framework that supports keyboard-based exploration of the generated worlds. The framework comprises three core components: (1) a long-video generation framework integrating unified context compression with linear attention; (2) a real-time streaming acceleration strategy powered by bidirectional attention distillation and an enhanced text embedding scheme; (3) a text-controlled method for generating world events. We have provided the codebase in the supplementary material.
>
---
#### [new 013] AutoPP: Towards Automated Product Poster Generation and Optimization
- **分类: cs.CV; cs.IR; cs.LG**

- **简介: 该论文提出AutoPP，解决产品海报自动化生成与优化问题。通过设计模块和渲染模块生成海报，并利用在线反馈优化CTR，提升效果。**

- **链接: [https://arxiv.org/pdf/2512.21921v1](https://arxiv.org/pdf/2512.21921v1)**
...
>
---
#### [new 018] Learning Association via Track-Detection Matching for Multi-Object Tracking
- **分类: cs.CV**

- **简介: 该论文属于多目标跟踪任务，解决如何高效准确地关联视频帧中的目标问题。提出TDLP方法，通过链接预测实现帧间关联，提升跟踪性能。**

- **链接: [https://arxiv.org/pdf/2512.22105v1](https://arxiv.org/pdf/2512.22105v1)**
...
>
---
#### [new 019] AstraNav-World: World Model for Foresight Control and Consistency
- **分类: cs.CV**

- **简介: 该论文提出AstraNav-World，用于具身导航任务，解决动态环境中未来状态与动作序列的同步预测问题。通过统一的概率框架，结合视觉与动作生成，提升导航准确性与可靠性。**

- **链接: [https://arxiv.org/pdf/2512.21714v1](https://arxiv.org/pdf/2512.21714v1)**
...
>
---
#### [new 020] Patch-Discontinuity Mining for Generalized Deepfake Detection
- **分类: cs.CV**

- **简介: 该论文属于深度伪造检测任务，旨在解决现有方法在未知伪造模式下性能下降的问题。通过迁移学习和特征增强策略，提出GenDF框架，提升检测泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.22027v1](https://arxiv.org/pdf/2512.22027v1)**
...
>
---
#### [new 024] MAI-UI Technical Report: Real-World Centric Foundation GUI Agents
- **分类: cs.CV**

- **简介: 该论文提出MAI-UI，解决GUI代理在真实环境中的部署问题，通过数据管道、协同系统和在线强化学习提升性能，实现高效交互与隐私保护。**

- **链接: [https://arxiv.org/pdf/2512.22047v1](https://arxiv.org/pdf/2512.22047v1)**
...
>
> **摘要:** The development of GUI agents could revolutionize the next generation of human-computer interaction. Motivated by this vision, we present MAI-UI, a family of foundation GUI agents spanning the full spectrum of sizes, including 2B, 8B, 32B, and 235B-A22B variants. We identify four key challenges to realistic deployment: the lack of native agent-user interaction, the limits of UI-only operation, the absence of a practical deployment architecture, and brittleness in dynamic environments. MAI-UI addresses these issues with a unified methodology: a self-evolving data pipeline that expands the navigation data to include user interaction and MCP tool calls, a native device-cloud collaboration system routes execution by task state, and an online RL framework with advanced optimizations to scale parallel environments and context length. MAI-UI establishes new state-of-the-art across GUI grounding and mobile navigation. On grounding benchmarks, it reaches 73.5% on ScreenSpot-Pro, 91.3% on MMBench GUI L2, 70.9% on OSWorld-G, and 49.2% on UI-Vision, surpassing Gemini-3-Pro and Seed1.8 on ScreenSpot-Pro. On mobile GUI navigation, it sets a new SOTA of 76.7% on AndroidWorld, surpassing UI-Tars-2, Gemini-2.5-Pro and Seed1.8. On MobileWorld, MAI-UI obtains 41.7% success rate, significantly outperforming end-to-end GUI models and competitive with Gemini-3-Pro based agentic frameworks. Our online RL experiments show significant gains from scaling parallel environments from 32 to 512 (+5.2 points) and increasing environment step budget from 15 to 50 (+4.3 points). Finally, the native device-cloud collaboration system improves on-device performance by 33%, reduces cloud model calls by over 40%, and preserves user privacy.
>
---
#### [new 025] Fixed-Threshold Evaluation of a Hybrid CNN-ViT for AI-Generated Image Detection Across Photos and Art
- **分类: cs.CV**

- **简介: 该论文属于AI生成图像检测任务，解决传统方法在部署时的阈值调整和鲁棒性评估问题。通过固定阈值评估协议，验证混合CNN-ViT模型在不同后处理下的性能。**

- **链接: [https://arxiv.org/pdf/2512.21512v1](https://arxiv.org/pdf/2512.21512v1)**
...
>
---
#### [new 030] Intelligent recognition of GPR road hidden defect images based on feature fusion and attention mechanism
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于GPR图像缺陷检测任务，旨在解决传统方法依赖人工、效率低和准确性差的问题。提出MCGA-Net模型，结合特征融合与注意力机制，提升检测精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2512.21452v1](https://arxiv.org/pdf/2512.21452v1)**
...
>
---
#### [new 044] A Tool Bottleneck Framework for Clinically-Informed and Interpretable Medical Image Understanding
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出TBF框架，解决医学图像理解中工具组合效果差的问题，通过神经网络融合工具输出，提升准确性和可解释性。**

- **链接: [https://arxiv.org/pdf/2512.21414v1](https://arxiv.org/pdf/2512.21414v1)**
...
>
---
#### [new 045] Data relativistic uncertainty framework for low-illumination anime scenery image enhancement
- **分类: cs.CV; cs.LG; cs.MM**

- **简介: 该论文属于低光照动漫场景图像增强任务，解决数据稀缺与光照不确定性问题。构建了多样化数据集，提出DRU框架，利用不确定性信息提升模型性能。**

- **链接: [https://arxiv.org/pdf/2512.21944v1](https://arxiv.org/pdf/2512.21944v1)**
...
>
---
#### [new 053] StreamAvatar: Streaming Diffusion Models for Real-Time Interactive Human Avatars
- **分类: cs.CV; cs.AI; cs.HC**

- **简介: 该论文属于实时交互数字人生成任务，解决扩散模型在流式传输中的效率与互动性问题。通过自回归适配框架和关键组件，实现高质量、实时的全身动作生成。**

- **链接: [https://arxiv.org/pdf/2512.22065v1](https://arxiv.org/pdf/2512.22065v1)**
...
>
> **备注:** Project page: https://streamavatar.github.io
>
...
>
---
#### [new 060] Scalable Class-Incremental Learning Based on Parametric Neural Collapse
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于增量学习任务，解决模型在新增类别时的过拟合和遗忘问题。提出SCL-PNC方法，通过动态ETF框架和知识蒸馏实现高效扩展与特征对齐。**

- **链接: [https://arxiv.org/pdf/2512.21845v1](https://arxiv.org/pdf/2512.21845v1)**
...
>
---
#### [new 067] Contrastive Graph Modeling for Cross-Domain Few-Shot Medical Image Segmentation
- **分类: cs.CV**

- **简介: 该论文属于跨域小样本医学图像分割任务，旨在解决标注数据稀缺和域间性能下降的问题。提出C-Graph框架，通过图结构建模和对比学习提升分割效果。**

- **链接: [https://arxiv.org/pdf/2512.21683v1](https://arxiv.org/pdf/2512.21683v1)**
...
>
---
#### [new 068] Scalable Deep Subspace Clustering Network
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于子空间聚类任务，旨在解决传统方法计算复杂度高的问题。通过引入近似方法和联合优化，提出SDSNet框架，实现线性复杂度的高效聚类。**

- **链接: [https://arxiv.org/pdf/2512.21434v1](https://arxiv.org/pdf/2512.21434v1)**
...
>
---
#### [new 069] UniPercept: Towards Unified Perceptual-Level Image Understanding across Aesthetics, Quality, Structure, and Texture
- **分类: cs.CV**

- **简介: 该论文提出UniPercept-Bench，解决多模态大语言模型在感知级图像理解上的不足。通过构建数据集和训练模型，提升图像美学、质量、结构和纹理的感知理解能力。**

- **链接: [https://arxiv.org/pdf/2512.21675v1](https://arxiv.org/pdf/2512.21675v1)**
...
>
> **摘要:** Multimodal large language models (MLLMs) have achieved remarkable progress in visual understanding tasks such as visual grounding, segmentation, and captioning. However, their ability to perceive perceptual-level image features remains limited. In this work, we present UniPercept-Bench, a unified framework for perceptual-level image understanding across three key domains: Aesthetics, Quality, Structure and Texture. We establish a hierarchical definition system and construct large-scale datasets to evaluate perceptual-level image understanding. Based on this foundation, we develop a strong baseline UniPercept trained via Domain-Adaptive Pre-Training and Task-Aligned RL, enabling robust generalization across both Visual Rating (VR) and Visual Question Answering (VQA) tasks. UniPercept outperforms existing MLLMs on perceptual-level image understanding and can serve as a plug-and-play reward model for text-to-image generation. This work defines Perceptual-Level Image Understanding in the era of MLLMs and, through the introduction of a comprehensive benchmark together with a strong baseline, provides a solid foundation for advancing perceptual-level multimodal image understanding.
>
---
#### [new 070] RAPTOR: Real-Time High-Resolution UAV Video Prediction with Efficient Video Attention
- **分类: cs.CV**

- **简介: 该论文提出RAPTOR模型，解决高分辨率视频预测中实时性与质量的矛盾，适用于无人机安全导航。**

- **链接: [https://arxiv.org/pdf/2512.21710v1](https://arxiv.org/pdf/2512.21710v1)**
...
>
---
#### [new 071] Scene-VLM: Multimodal Video Scene Segmentation via Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于视频场景分割任务，解决传统方法依赖视觉、缺乏语义理解的问题。提出Scene-VLM框架，融合多模态信息实现更准确的场景划分。**

- **链接: [https://arxiv.org/pdf/2512.21778v1](https://arxiv.org/pdf/2512.21778v1)**
...
>
---
#### [new 072] SVBench: Evaluation of Video Generation Models on Social Reasoning
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决模型在社会推理上的不足。提出SVBench基准，评估模型在社会认知方面的表现。**

- **链接: [https://arxiv.org/pdf/2512.21507v1](https://arxiv.org/pdf/2512.21507v1)**
...
>
---
#### [new 076] Fixed-Budget Parameter-Efficient Training with Frozen Encoders Improves Multimodal Chest X-Ray Classification
- **分类: cs.CV**

- **简介: 该论文研究多模态胸部X光分类任务，旨在降低计算成本。通过参数高效训练方法，在固定参数预算下提升模型性能，验证了冻结编码器的有效性。**

- **链接: [https://arxiv.org/pdf/2512.21508v1](https://arxiv.org/pdf/2512.21508v1)**
...
>
---
#### [new 091] Five Years of SciCap: What We Learned and Future Directions for Scientific Figure Captioning
- **分类: cs.CL; cs.AI; cs.CV; cs.HC**

- **简介: 该论文属于科学图表标题生成任务，旨在提升科学论文中图表描述的准确性与质量。研究团队构建了大规模图表示例集，评估生成与作者撰写标题的效果，并提出未来研究方向。**

- **链接: [https://arxiv.org/pdf/2512.21789v1](https://arxiv.org/pdf/2512.21789v1)**

> **作者:** Ting-Hao K. Huang; Ryan A. Rossi; Sungchul Kim; Tong Yu; Ting-Yao E. Hsu; Ho Yin; Ng; C. Lee Giles
>
...
>
---
#### [new 092] Dynamic Feedback Engines: Layer-Wise Control for Self-Regulating Continual Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于持续学习任务，旨在解决灾难性遗忘问题。通过动态反馈机制，根据各层熵值调节模型，提升泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.21743v1](https://arxiv.org/pdf/2512.21743v1)**
...
>
---
#### [new 093] Robustness and Scalability Of Machine Learning for Imbalanced Clinical Data in Emergency and Critical Care
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于医疗预测任务，解决急诊和重症监护中数据不平衡问题。通过评估多种模型的鲁棒性和可扩展性，提出高效且稳定的XGBoost方法。**

- **链接: [https://arxiv.org/pdf/2512.21602v1](https://arxiv.org/pdf/2512.21602v1)**
...
>
---
#### [new 094] Global-Graph Guided and Local-Graph Weighted Contrastive Learning for Unified Clustering on Incomplete and Noise Multi-View Data
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于多视角聚类任务，旨在解决不完整和噪声数据中的样本稀少和错误配对问题。通过全局图引导和局部图加权对比学习，提升聚类效果。**

- **链接: [https://arxiv.org/pdf/2512.21516v1](https://arxiv.org/pdf/2512.21516v1)**
...
>
---
#### [new 095] Missing Pattern Tree based Decision Grouping and Ensemble for Deep Incomplete Multi-View Clustering
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于不完全多视图聚类任务，旨在解决不一致缺失模式导致的视图对利用不足问题。提出TreeEIC框架，通过缺失模式树分组和集成学习提升聚类性能。**

- **链接: [https://arxiv.org/pdf/2512.21510v1](https://arxiv.org/pdf/2512.21510v1)**
...
>
---
#### [new 096] A Graph-Augmented knowledge Distillation based Dual-Stream Vision Transformer with Region-Aware Attention for Gastrointestinal Disease Classification with Explainable AI
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于胃肠道疾病分类任务，旨在解决医学影像准确分类难题。提出一种基于知识蒸馏的双流视觉Transformer模型，提升诊断准确性与可解释性。**

- **链接: [https://arxiv.org/pdf/2512.21372v1](https://arxiv.org/pdf/2512.21372v1)**
...
>
---
#### [replaced 004] Computerized Assessment of Motor Imitation for Distinguishing Autism in Video (CAMI-2DNet)
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2501.08609v2](https://arxiv.org/pdf/2501.08609v2)**
...
>
---
#### [replaced 006] DAVE: A VLM Vision Encoder for Document Understanding and Web Agents
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17221v2](https://arxiv.org/pdf/2512.17221v2)**
...
>
---
#### [replaced 007] UltraShape 1.0: High-Fidelity 3D Shape Generation via Scalable Geometric Refinement
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2512.21185v2](https://arxiv.org/pdf/2512.21185v2)**
...
>
---
#### [replaced 008] D2Pruner: Debiased Importance and Structural Diversity for MLLM Token Pruning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.19443v2](https://arxiv.org/pdf/2512.19443v2)**
...
>
---
#### [replaced 009] Efficient Vision Mamba for MRI Super-Resolution via Hybrid Selective Scanning
- **分类: cs.CV; physics.med-ph**

- **链接: [https://arxiv.org/pdf/2512.19676v2](https://arxiv.org/pdf/2512.19676v2)**
...
>
---
#### [replaced 010] How Robot Dogs See the Unseeable: Improving Visual Interpretability via Peering for Exploratory Robots
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于视觉感知任务，旨在解决遮挡下机器人视觉理解困难的问题。通过模仿昆虫的“窥视”动作，结合信号处理与大模型，提升机器人在部分遮挡下的感知能力。**

- **链接: [https://arxiv.org/pdf/2511.16262v2](https://arxiv.org/pdf/2511.16262v2)**
...
>
---
#### [replaced 012] TICON: A Slide-Level Tile Contextualizer for Histopathology Representation Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21331v2](https://arxiv.org/pdf/2512.21331v2)**
...
>
---
#### [replaced 013] Copyright Infringement Detection in Text-to-Image Diffusion Models via Differential Privacy
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23022v3](https://arxiv.org/pdf/2509.23022v3)**
...
>
---
#### [replaced 014] Non-Contrast CT Esophageal Varices Grading through Clinical Prior-Enhanced Multi-Organ Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.19415v2](https://arxiv.org/pdf/2512.19415v2)**
...
>
---
#### [replaced 015] Open-World Deepfake Attribution via Confidence-Aware Asymmetric Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.12667v2](https://arxiv.org/pdf/2512.12667v2)**
...
>
---
#### [replaced 016] Visual Explanation via Similar Feature Activation for Metric Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.01636v3](https://arxiv.org/pdf/2506.01636v3)**
...
>
---
#### [replaced 017] Multi-Part Object Representations via Graph Structures and Co-Part Discovery
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.18192v2](https://arxiv.org/pdf/2512.18192v2)**
...
>
---
#### [replaced 018] SIFThinker: Spatially-Aware Image Focus for Visual Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.06259v5](https://arxiv.org/pdf/2508.06259v5)**
...
>
---
#### [replaced 019] Chain-of-Evidence Multimodal Reasoning for Few-shot Temporal Action Localization
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2504.13460v5](https://arxiv.org/pdf/2504.13460v5)**
...
>
---
#### [replaced 022] S$^2$Edit: Text-Guided Image Editing with Precise Semantic and Spatial Control
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.04584v2](https://arxiv.org/pdf/2507.04584v2)**
...
>
---
#### [replaced 023] Dynamic LRP-Based Pruning for CNNs in Data-Scarce Transfer Learning: Suppressing Cascading Accuracy Degradation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.10861v2](https://arxiv.org/pdf/2511.10861v2)**
...
>
---
#### [replaced 024] GCVAMD: A Modified CausalVAE Model for Causal Age-related Macular Degeneration Risk Factor Detection and Prediction
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.02781v3](https://arxiv.org/pdf/2510.02781v3)**
...
>
---
#### [replaced 030] HiStream: Efficient High-Resolution Video Generation via Redundancy-Eliminated Streaming
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21338v2](https://arxiv.org/pdf/2512.21338v2)**
...
>
---
#### [replaced 031] LIBERO-Plus: In-depth Robustness Analysis of Vision-Language-Action Models
- **分类: cs.RO; cs.CL; cs.CV**

- **简介: 该论文属于视觉-语言-动作模型的鲁棒性分析任务，旨在揭示模型在真实环境中的脆弱性。通过引入七种扰动因素，发现模型对部分因素极度敏感，且对语言指令不敏感，挑战了高基准分数代表真实能力的假设。**

- **链接: [https://arxiv.org/pdf/2510.13626v3](https://arxiv.org/pdf/2510.13626v3)**
...
>
---
#### [replaced 034] Learning to Sense for Driving: Joint Optics-Sensor-Model Co-Design for Semantic Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.20815v2](https://arxiv.org/pdf/2512.20815v2)**
...
>
---
#### [replaced 041] DynaMix: Generalizable Person Re-identification via Dynamic Relabeling and Mixed Data Sampling
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.19067v2](https://arxiv.org/pdf/2511.19067v2)**

> **作者:** Timur Mamedov; Anton Konushin; Vadim Konushin
>
> **备注:** Neurocomputing Volume 669, 7 March 2026, 132446
>
...
>
---
#### [replaced 044] SlowFast-SCI: Slow-Fast Deep Unfolding Learning for Spectral Compressive Imaging
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.16509v2](https://arxiv.org/pdf/2509.16509v2)**

> **作者:** Haijin Zeng; Xuan Lu; Yurong Zhang; Qiangqiang Shen; Guoqing Chao; Li Jiang; Yongyong Chen
>
> **备注:** 10 pages
>
...
>
---
#### [replaced 045] RoadSceneVQA: Benchmarking Visual Question Answering in Roadside Perception Systems for Intelligent Transportation System
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.18286v2](https://arxiv.org/pdf/2511.18286v2)**
...
>
> **备注:** 10 pages, 6 figures, accepted by AAAI 2026. The model is also called Dream, to the other me in the world forever
>
...
>
---
#### [replaced 046] X-Boundary: Establishing Exact Safety Boundary to Shield LLMs from Multi-Turn Jailbreaks without Compromising Usability
- **分类: cs.CR; cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文属于大模型安全防护任务，旨在解决多轮越狱攻击防御问题。通过建立精确的安全边界，提升防御效果同时保持模型可用性。**

- **链接: [https://arxiv.org/pdf/2502.09990v3](https://arxiv.org/pdf/2502.09990v3)**

> **作者:** Xiaoya Lu; Dongrui Liu; Yi Yu; Luxin Xu; Jing Shao
>
> **摘要:** Despite the rapid development of safety alignment techniques for LLMs, defending against multi-turn jailbreaks is still a challenging task. In this paper, we conduct a comprehensive comparison, revealing that some existing defense methods can improve the robustness of LLMs against multi-turn jailbreaks but compromise usability, i.e., reducing general capabilities or causing the over-refusal problem. From the perspective of mechanism interpretability of LLMs, we discover that these methods fail to establish a boundary that exactly distinguishes safe and harmful feature representations. Therefore, boundary-safe representations close to harmful representations are inevitably disrupted, leading to a decline in usability. To address this issue, we propose X-Boundary to push harmful representations away from boundary-safe representations and obtain an exact distinction boundary. In this way, harmful representations can be precisely erased without disrupting safe ones. Experimental results show that X-Boundary achieves state-of-the-art defense performance against multi-turn jailbreaks, while reducing the over-refusal rate by about 20% and maintaining nearly complete general capability. Furthermore, we theoretically prove and empirically verify that X-Boundary can accelerate the convergence process during training. Please see our code at: https://github.com/AI45Lab/X-Boundary.
>
---
#### [replaced 047] RoboSafe: Safeguarding Embodied Agents via Executable Safety Logic
- **分类: cs.AI; cs.CV; cs.RO**

- **简介: 该论文属于机器人安全任务，解决 embodied agents 在复杂环境中因危险指令产生不安全行为的问题。提出 RoboSafe，结合推理机制实现动态安全防护。**

- **链接: [https://arxiv.org/pdf/2512.21220v2](https://arxiv.org/pdf/2512.21220v2)**
...
>
---
#### [replaced 048] SemanticGen: Video Generation in Semantic Space
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.20619v3](https://arxiv.org/pdf/2512.20619v3)**
...
>
---
#### [replaced 049] MatDecompSDF: High-Fidelity 3D Shape and PBR Material Decomposition from Multi-View Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.04749v2](https://arxiv.org/pdf/2507.04749v2)**
...
>
---
#### [replaced 050] Degradation-Aware Metric Prompting for Hyperspectral Image Restoration
- **分类: cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2512.20251v2](https://arxiv.org/pdf/2512.20251v2)**
