...
#### [new 001] Dynamic Context Evolution for Scalable Synthetic Data Generation
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言生成任务，解决跨批次模式崩溃问题。提出动态上下文演化（DCE）方法，通过自评估采样、语义记忆和自适应提示演化提升生成数据多样性。**

- **链接: [https://arxiv.org/pdf/2604.07147](https://arxiv.org/pdf/2604.07147)**
...
>
---
#### [new 002] State-of-the-Art Arabic Language Modeling with Sparse MoE Fine-Tuning and Chain-of-Thought Distillation
- **分类: cs.CL**

- **简介: 该论文提出阿拉伯语大语言模型Arabic-DeepSeek-R1，解决低资源语言性能不足问题。通过稀疏MoE架构和思维链蒸馏，提升阿拉伯语任务表现，超越现有系统。**

- **链接: [https://arxiv.org/pdf/2604.06421](https://arxiv.org/pdf/2604.06421)**
...
>
---
#### [new 007] Invisible Influences: Investigating Implicit Intersectional Biases through Persona Engineering in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，旨在解决大语言模型中隐性交叉偏见的动态检测问题。通过提出BADx指标，评估不同角色下偏见的放大与变化。**

- **链接: [https://arxiv.org/pdf/2604.06213](https://arxiv.org/pdf/2604.06213)**
...
>
---
#### [new 011] Are Non-English Papers Reviewed Fairly? Language-of-Study Bias in NLP Peer Reviews
- **分类: cs.CL**

- **简介: 该论文研究NLP领域同行评审中的语言偏见问题，属于偏见检测任务。通过构建数据集和模型，分析非英语论文面临的不公平评价，提出解决方法以促进公平评审。**

- **链接: [https://arxiv.org/pdf/2604.07119](https://arxiv.org/pdf/2604.07119)**
...
>
---
#### [new 017] LLM-based Schema-Guided Extraction and Validation of Missing-Person Intelligence from Heterogeneous Data Sources
- **分类: cs.CL; cs.AI; cs.IR; cs.LG**

- **简介: 该论文属于信息提取任务，旨在解决从异构数据中准确提取失踪人员信息的问题。提出Guardian Parser Pack系统，结合规则与LLM提升提取质量与一致性。**

- **链接: [https://arxiv.org/pdf/2604.06571](https://arxiv.org/pdf/2604.06571)**
...
>
---
#### [new 033] Distributional Open-Ended Evaluation of LLM Cultural Value Alignment Based on Value Codebook
- **分类: cs.CL; cs.AI; cs.CY; cs.LG**

- **简介: 该论文属于语言模型文化价值对齐任务，解决现有评估基准的局限性。提出DOVE框架，通过分布比较评估模型生成文本与人类文本的对齐程度。**
...
>
---
#### [new 037] Environmental, Social and Governance Sentiment Analysis on Slovene News: A Novel Dataset and Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于ESG情感分析任务，旨在解决小公司和新兴市场ESG评级不足的问题。研究构建了首个公开的斯洛文尼亚语ESG情感数据集，并测试了多种模型的性能。**

- **链接: [https://arxiv.org/pdf/2604.06826](https://arxiv.org/pdf/2604.06826)**
...
>
---
#### [new 038] To Lie or Not to Lie? Investigating The Biased Spread of Global Lies by LLMs
- **分类: cs.CL**

- **简介: 该论文属于信息传播研究任务，旨在解决LLMs在多语言和多国家中生成和传播虚假信息的问题。通过构建GlobalLies数据集，分析虚假信息的分布特征及现有防护措施的不足。**

- **链接: [https://arxiv.org/pdf/2604.06552](https://arxiv.org/pdf/2604.06552)**
...
>
---
#### [new 048] FMI@SU ToxHabits: Evaluating LLMs Performance on Toxic Habit Extraction in Spanish Clinical Texts
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于命名实体识别任务，旨在检测西班牙语临床文本中的有害习惯实体。研究对比了多种大模型方法，发现GPT-4.1在少量样本提示下表现最佳。**

- **链接: [https://arxiv.org/pdf/2604.06403](https://arxiv.org/pdf/2604.06403)**
...
>
> **摘要:** The paper presents an approach for the recognition of toxic habits named entities in Spanish clinical texts. The approach was developed for the ToxHabits Shared Task. Our team participated in subtask 1, which aims to detect substance use and abuse mentions in clinical case reports and classify them in four categories (Tobacco, Alcohol, Cannabis, and Drug). We explored various methods of utilizing LLMs for the task, including zero-shot, few-shot, and prompt optimization, and found that GPT-4.1's few-shot prompting performed the best in our experiments. Our method achieved an F1 score of 0.65 on the test set, demonstrating a promising result for recognizing named entities in languages other than English.
>
---
#### [new 049] CCD-CBT: Multi-Agent Therapeutic Interaction for CBT Guided by Cognitive Conceptualization Diagram
- **分类: cs.CL**

- **简介: 该论文属于心理治疗对话生成任务，旨在解决传统CBT模拟缺乏动态性和信息不对称的问题。提出CCD-CBT框架，通过动态重建认知概念图和信息不对称交互提升治疗效果。**

- **链接: [https://arxiv.org/pdf/2604.06551](https://arxiv.org/pdf/2604.06551)**

> **作者:** Chang Liu; Changsheng Ma; Yongfeng Tao; Bin Hu; Minqiang Yang
>
> **摘要:** Large language models show potential for scalable mental-health support by simulating Cognitive Behavioral Therapy (CBT) counselors. However, existing methods often rely on static cognitive profiles and omniscient single-agent simulation, failing to capture the dynamic, information-asymmetric nature of real therapy. We introduce CCD-CBT, a multi-agent framework that shifts CBT simulation along two axes: 1) from a static to a dynamically reconstructed Cognitive Conceptualization Diagram (CCD), updated by a dedicated Control Agent, and 2) from omniscient to information-asymmetric interaction, where the Therapist Agent must reason from inferred client states. We release CCDCHAT, a synthetic multi-turn CBT dataset generated under this framework. Evaluations with clinical scales and expert therapists show that models fine-tuned on CCDCHAT outperform strong baselines in both counseling fidelity and positive-affect enhancement, with ablations confirming the necessity of dynamic CCD guidance and asymmetric agent design. Our work offers a new paradigm for building theory-grounded, clinically-plausible conversational agents.
>
---
#### [new 050] Context-Aware Dialectal Arabic Machine Translation with Interactive Region and Register Selection
- **分类: cs.CL**

- **简介: 该论文属于阿拉伯语方言机器翻译任务，旨在解决现有系统将方言统一为标准阿拉伯语、缺乏用户控制的问题。通过构建数据增强管道和微调模型，实现方言与社会语域的可控生成。**

- **链接: [https://arxiv.org/pdf/2604.06456](https://arxiv.org/pdf/2604.06456)**
...
>
> **摘要:** We present SemEval-2026 Task 9, a shared task on online polarization detection, covering 22 languages and comprising over 110K annotated instances. Each data instance is multi-labeled with the presence of polarization, polarization type, and polarization manifestation. Participants were asked to predict labels in three sub-tasks: (1) detecting the presence of polarization, (2) identifying the type of polarization, and (3) recognizing the polarization manifestation. The three tasks attracted over 1,000 participants worldwide and more than 10k submission on Codabench. We received final submissions from 67 teams and 73 system description papers. We report the baseline results and analyze the performance of the best-performing systems, highlighting the most common approaches and the most effective methods across different subtasks and languages. The dataset of this task is publicly available.
>
---
#### [new 071] Continuous Interpretive Steering for Scalar Diversity
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决大语言模型中语用推理的分级评估问题。提出Continuous Interpretive Steering方法和GraSD数据集，以系统分析模型的语用敏感性。**

- **链接: [https://arxiv.org/pdf/2604.07006](https://arxiv.org/pdf/2604.07006)**

> **作者:** Ye-eun Cho
>
> **摘要:** Pragmatic inference is inherently graded. Different lexical items give rise to pragmatic enrichment to different degrees. Scalar implicature exemplifies this property through scalar diversity, where implicature strength varies across scalar items. However, evaluations of pragmatic inference in large language models (LLMs) often rely on prompt-based manipulations. Beyond prompt-level effects, this study introduces Continuous Interpretive Steering (CIS), a method that probes graded pragmatic interpretation by treating activation-level steering strength as a continuous experimental variable. To support this analysis, this study introduces a new dataset, GraSD, which encodes graded scalar diversity. Experiments on four LLMs show that uniform activation steering increases pragmatic interpretations globally but collapses item-level variation, whereas graded activation steering yields differentiated interpretive shifts aligned with scalar diversity grades. It indicates that graded sensitivity is encoded in the representation space and can be systematically recovered through controlled intervention. Together, CIS and GraSD provide a principled framework for evaluating graded pragmatic sensitivity in LLMs.
>
---
#### [new 072] Team Fusion@ SU@ BC8 SympTEMIST track: transformer-based approach for symptom recognition and linking
- **分类: cs.CL; cs.AI**

- **简介: 该论文针对SympTEMIST任务，提出基于Transformer的方法解决症状命名实体识别和链接问题，通过微调模型并结合知识库提升准确率。**

- **链接: [https://arxiv.org/pdf/2604.06424](https://arxiv.org/pdf/2604.06424)**
...
>
---
#### [new 073] Select-then-Solve: Paradigm Routing as Inference-Time Optimization for LLM Agents
- **分类: cs.CL**

- **简介: 该论文研究LLM代理的推理范式选择问题，通过比较多种推理方法，提出一种基于路由的选择机制以提升性能。**

- **链接: [https://arxiv.org/pdf/2604.06753](https://arxiv.org/pdf/2604.06753)**
...
>
---
#### [new 077] Corpora deduplication or duplication in Natural Language Processing of few resourced languages ? A case of study: The Mexico's Nahuatl
- **分类: cs.CL**

- **简介: 论文研究在资源有限语言（如纳瓦特尔语）中，通过数据复制提升NLP效果。属于数据增强任务，旨在解决语料不足问题，通过增量复制扩展语料库并验证其有效性。**

- **链接: [https://arxiv.org/pdf/2604.07015](https://arxiv.org/pdf/2604.07015)**
...
>
---
#### [new 079] TelcoAgent-Bench: A Multilingual Benchmark for Telecom AI Agents
- **分类: cs.CL**

- **简介: 该论文属于电信AI代理评估任务，旨在解决多语言环境下代理的意图识别、流程对齐与稳定性问题，提出TelcoAgent-Bench框架进行量化评估。**

- **链接: [https://arxiv.org/pdf/2604.06209](https://arxiv.org/pdf/2604.06209)**
...
>
---
#### [new 082] The Illusion of Stochasticity in LLMs
- **分类: cs.CL; cs.LG**

- **简介: 论文探讨LLMs在随机采样中的不足，属于模型可靠性研究。指出LLMs无法准确从特定分布中采样，影响其作为智能体的性能。**

- **链接: [https://arxiv.org/pdf/2604.06543](https://arxiv.org/pdf/2604.06543)**
...
>
---
#### [new 083] ValueGround: Evaluating Culture-Conditioned Visual Value Grounding in MLLMs
- **分类: cs.CL**

- **简介: 该论文提出ValueGround，用于评估多模态大语言模型在视觉场景中理解文化价值观的能力。任务是跨模态的文化价值判断，解决现有评估仅限文本的问题。工作包括构建基准数据集并测试模型表现。**
...
>
---
#### [new 090] To Adapt or not to Adapt, Rethinking the Value of Medical Knowledge-Aware Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于医疗领域语言模型研究，旨在评估临床专用模型是否优于通用模型。通过对比实验和新基准测试，发现临床模型在英语任务中优势不明显，但在西班牙语中表现更好。**

- **链接: [https://arxiv.org/pdf/2604.06854](https://arxiv.org/pdf/2604.06854)**
...
>
---
#### [new 091] Beyond Facts: Benchmarking Distributional Reading Comprehension in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于分布阅读理解任务，旨在评估大语言模型推断分布知识的能力。研究构建了Text2DistBench基准，用于测试模型对评论中情感比例和主题频率等分布信息的理解。**
...
>
---
#### [new 094] WRAP++: Web discoveRy Amplified Pretraining
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出WRAP++，解决单文档预训练知识不足的问题，通过发现跨文档关系并生成联合问答，增强事实知识的关联性与数据规模。**

- **链接: [https://arxiv.org/pdf/2604.06829](https://arxiv.org/pdf/2604.06829)**
...
>
---
#### [new 107] The Illusion of Superposition? A Principled Analysis of Latent Thinking in Language Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言模型研究任务，探讨 latent CoT 中的超位置现象。通过三种训练方式分析模型是否利用超位置，发现仅从头训练的模型表现出超位置，其他方式则未使用。**

- **链接: [https://arxiv.org/pdf/2604.06374](https://arxiv.org/pdf/2604.06374)**
...
>
---
#### [new 108] Scientific Knowledge-driven Decoding Constraints Improving the Reliability of LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决LLMs的幻觉问题。通过引入科学知识约束，提升模型生成的可靠性与准确性。**

- **链接: [https://arxiv.org/pdf/2604.06603](https://arxiv.org/pdf/2604.06603)**
...
>
---
#### [new 114] Benchmarking LLM Tool-Use in the Wild
- **分类: cs.HC; cs.AI; cs.CL**

- **简介: 该论文属于大语言模型工具使用任务，旨在解决真实用户行为复杂性带来的挑战。工作包括提出WildToolBench基准，揭示模型在实际交互中的不足。**

- **链接: [https://arxiv.org/pdf/2604.06185](https://arxiv.org/pdf/2604.06185)**
...
>
---
#### [new 120] Transformer See, Transformer Do: Copying as an Intermediate Step in Learning Analogical Reasoning
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究如何通过Transformer模型实现类比推理，解决人工智能在类比推理上的不足。通过引入复制任务提升模型性能，验证了其在新字母集上的泛化能力。**

- **链接: [https://arxiv.org/pdf/2604.06501](https://arxiv.org/pdf/2604.06501)**
...
>
---
#### [new 121] Specializing Large Models for Oracle Bone Script Interpretation via Component-Grounded Multimodal Knowledge Augmentation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 124] Appear2Meaning: A Cross-Cultural Benchmark for Structured Cultural Metadata Inference from Images
...
>
---
#### [new 125] Weakly Supervised Distillation of Hallucination Signals into Transformer Representations
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于 hallucination 检测任务，旨在无需外部验证即可在模型内部检测幻觉。通过弱监督框架构建数据集，并训练多种探针模型进行检测。**

- **链接: [https://arxiv.org/pdf/2604.06277](https://arxiv.org/pdf/2604.06277)**
...
>
---
#### [new 128] Code Sharing In Prediction Model Research: A Scoping Review
- **分类: cs.SE; cs.AI; cs.CL**

- **简介: 该论文属于代码共享研究任务，旨在解决预测模型研究中代码可重复性不足的问题。通过综述分析，评估当前代码共享现状及质量，为TRIPOD-Code指南提供依据。**

- **链接: [https://arxiv.org/pdf/2604.06212](https://arxiv.org/pdf/2604.06212)**
...
>
---
#### [new 132] Video-guided Machine Translation with Global Video Context
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 133] On the Price of Privacy for Language Identification and Generation
- **分类: cs.LG; cs.CL; cs.CR; cs.DS**

- **简介: 该论文研究隐私成本在语言识别与生成中的影响，解决在隐私保护下模型性能下降的问题。提出算法并建立理论界限，表明近似DP下隐私成本可忽略，纯DP下成本为指数衰减因子。**

- **链接: [https://arxiv.org/pdf/2604.07238](https://arxiv.org/pdf/2604.07238)**
...
>
---
#### [new 134] SHAPE: Stage-aware Hierarchical Advantage via Potential Estimation for LLM Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出SHAPE框架，用于提升大语言模型的推理能力。针对现有方法无法区分有效进展与冗余输出的问题，SHAPE通过分阶段优势估计和层级信用分配，提高推理效率并减少token消耗。**

- **链接: [https://arxiv.org/pdf/2604.06636](https://arxiv.org/pdf/2604.06636)**
...
>
---
#### [new 135] From Perception to Autonomous Computational Modeling: A Multi-Agent Approach
- **分类: cs.CE; cs.CL; cs.MA**

- **简介: 该论文提出一种多智能体框架，用于自主完成从工程部件感知到有限元分析的计算流程，解决工程分析自动化问题。**
...
>
---
#### [new 136] Geometric Properties of the Voronoi Tessellation in Latent Semantic Manifolds of Large Language Models
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究大语言模型潜在语义流形中的Voronoi镶嵌几何特性，解决模型表示的可解释性问题，通过实验分析几何结构与性能的关系，并提出改进方法。**

- **链接: [https://arxiv.org/pdf/2604.06767](https://arxiv.org/pdf/2604.06767)**
...
>
---
#### [new 137] LLM Spirals of Delusion: A Benchmarking Audit Study of AI Chatbot Interfaces
- **分类: cs.HC; cs.AI; cs.CL**

- **简介: 该论文属于AI安全审计任务，旨在评估聊天机器人在真实对话中的行为表现。研究对比了不同接口下LLM的行为，揭示模型安全性与接口环境、政策调整密切相关。**

- **链接: [https://arxiv.org/pdf/2604.06188](https://arxiv.org/pdf/2604.06188)**
...
>
---
#### [replaced 002] PEARL: Self-Evolving Assistant for Time Management with Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于时间管理任务，解决日程冲突自动决策问题。通过引入基准测试和强化学习框架PEARL，提升语言代理在长期日程冲突中的决策能力。**

- **链接: [https://arxiv.org/pdf/2601.11957](https://arxiv.org/pdf/2601.11957)**
...
>
---
#### [replaced 003] Exploring Natural Language-Based Strategies for Efficient Number Learning in Children through Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.LG; cs.MA**

- **简介: 该论文属于儿童数字学习任务，旨在研究语言指导如何影响强化学习中的数字构建。通过设计有效课程和语言指令，提升学习效率与泛化能力。**

- **链接: [https://arxiv.org/pdf/2410.08334](https://arxiv.org/pdf/2410.08334)**

> **作者:** Tirthankar Mittra
>
> **摘要:** In this paper, we build a reinforcement learning framework to study how children compose numbers using base-ten blocks. Studying numerical cognition in toddlers offers a powerful window into the learning process itself, because numbers sit at the intersection of language, logic, perception, and culture. Specifically, we utilize state of the art (SOTA) reinforcement learning algorithms and neural network architectures to understand how variations in linguistic instructions can affect the learning process. Our results also show that instructions providing explicit action guidance are a more effective learning signal for RL agents to construct numbers. Furthermore, we identify an effective curriculum for ordering numerical-composition examples during training, resulting in faster convergence and improved generalization to unseen data. These findings highlight the role of language and multi-modal signals in numerical cognition and provide hypotheses for designing effective instructional strategies for early childhood education.
>
---
#### [replaced 004] FBS: Modeling Native Parallel Reading inside a Transformer
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出FBS模型，解决Transformer推理效率问题，通过引入PAW、CH和SG模块，提升并行阅读能力，改善质量与效率平衡。**

- **链接: [https://arxiv.org/pdf/2601.21708](https://arxiv.org/pdf/2601.21708)**

> **作者:** Tongxi Wang
>
> **备注:** Accept to ACL2026 as findings
>
...
>
---
#### [replaced 005] LongWriter-Zero: Mastering Ultra-Long Text Generation via Reinforcement Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于长文本生成任务，旨在解决模型生成超长文本时质量下降的问题。通过强化学习方法，无需依赖标注数据，提升生成文本的长度与质量。**
...
>
---
#### [replaced 006] Telling Speculative Stories to Help Humans Imagine the Harms of Healthcare AI
- **分类: cs.CL**

- **简介: 该论文属于AI伦理研究任务，旨在解决医疗AI潜在危害认知不足的问题。通过生成用户故事和促进讨论，帮助人们更全面地想象AI可能带来的影响。**

- **链接: [https://arxiv.org/pdf/2510.14718](https://arxiv.org/pdf/2510.14718)**

> **作者:** Xingmeng Zhao; Tongnian Wang; Dan Schumacher; Veronica Rammouz; Anthony Rios
>
> **备注:** 8 pages main + Appendix; Accepted to ACL Findings 2026
>
...
>
---
#### [replaced 007] What Do AI Agents Talk About? Discourse and Architectural Constraints in the First AI-Only Social Network
- **分类: cs.CL**

- **简介: 该论文研究AI代理在社交网络中的对话模式，分析其主题、情感和互动特征，揭示其生成机制，提出架构约束通信框架。任务属于AI对话分析，解决代理行为理解问题。**
...
>
---
#### [replaced 008] Graph Representation-based Model Poisoning on the Heterogeneous Internet of Agents
- **分类: cs.NI; cs.CL**

- **简介: 该论文属于安全任务，针对IoA中的模型中毒攻击问题，提出一种基于图表示的攻击方法GRMP，通过构造特征相关图生成恶意更新，降低模型性能并逃避检测。**

- **链接: [https://arxiv.org/pdf/2511.07176](https://arxiv.org/pdf/2511.07176)**

> **作者:** Hanlin Cai; Houtianfu Wang; Haofan Dong; Kai Li; Sai Zou; Ozgur B. Akan
>
> **备注:** This paper has been accepted by the IEEE 22nd International Wireless Communications & Mobile Computing Conference (IWCMC 2026, Shanghai, China)
>
...
>
---
#### [replaced 020] A Multilingual Dataset and Empirical Validation for the Mutual Reinforcement Effect in Information Extraction
- **分类: cs.CL**

- **简介: 该论文研究信息抽取中的互增强效应（MRE），解决多语言环境下MRE验证不足的问题。构建了多语言数据集MMM，并验证了76%的子集存在MRE，证明其跨语言有效性。**
...
>
---
#### [replaced 021] Mitigating Hallucination on Hallucination in RAG via Ensemble Voting
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，针对RAG中的“幻觉幻觉”问题，提出VOTE-RAG框架，通过集成投票机制提升生成准确性。**
...
>
---
#### [replaced 027] Region-R1: Reinforcing Query-Side Region Cropping for Multi-Modal Re-Ranking
...
>
---
#### [replaced 028] Daily and Weekly Periodicity in Large Language Model Performance and Its Implications for Research
- **分类: stat.AP; cs.AI; cs.CL; physics.ed-ph**

- **简介: 该论文属于模型性能分析任务，旨在验证LLM性能是否随时间变化。研究发现GPT-4o在固定条件下存在日周周期性波动，挑战了时间不变性假设。**

- **链接: [https://arxiv.org/pdf/2602.15889](https://arxiv.org/pdf/2602.15889)**

> **作者:** Paul Tschisgale; Peter Wulff
>
> **备注:** The Supplementary Information can be found in the OSF repository cited in the Data Availability Statement
>
> **摘要:** Large language models (LLMs) are increasingly used in research as both tools and objects of study. Much of this work assumes that LLM performance under fixed conditions (identical model snapshot, hyperparameters, and prompt) is time-invariant, meaning that average output quality remains stable over time; otherwise, reliability and reproducibility would be compromised. To test the assumption of time invariance, we conducted a longitudinal study of GPT-4o's average performance under fixed conditions. The LLM was queried to solve the same physics task ten times every three hours over approximately three months. Spectral (Fourier) analysis of the resulting time series revealed substantial periodic variability, accounting for about 20% of total variance. The observed periodic patterns are consistent with interacting daily and weekly rhythms. These findings challenge the assumption of time invariance and carry important implications for research involving LLMs.
>
---
#### [replaced 029] Contrastive Decoding Mitigates Score Range Bias in LLM-as-a-Judge
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理中的评价任务，针对LLM作为评分器时存在的分数范围偏差问题，提出通过对比解码方法进行缓解。**

- **链接: [https://arxiv.org/pdf/2510.18196](https://arxiv.org/pdf/2510.18196)**
...
>
---
#### [replaced 030] StoryScope: Investigating idiosyncrasies in AI fiction
- **分类: cs.CL**

- **简介: 该论文属于AI生成文本检测任务，旨在区分AI与人类创作的虚构故事。通过分析叙事结构特征，提出StoryScope工具，实现高效检测与作者归属。**
...
>
---
#### [replaced 031] Mismatch Aware Guidance for Robust Emotion Control in Auto-Regressive TTS Models
- **分类: cs.CL**

- **简介: 该论文属于文本到语音合成任务，解决风格与内容不匹配导致的语音不自然问题，提出自适应CFG方案提升情感表达同时保持语音质量。**
...
>
> **备注:** Re-submitted to Interspeech 2026 (with updates) -- Updates to be released upon approval
>
...
>
---
#### [replaced 034] Self-Distilled RLVR
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，解决自蒸馏导致的信息泄露与训练不稳定问题，提出RLSD结合RLVR与自蒸馏，提升训练稳定性和效果。**

- **链接: [https://arxiv.org/pdf/2604.03128](https://arxiv.org/pdf/2604.03128)**
...
>
---
#### [replaced 035] Between Help and Harm: An Evaluation of Mental Health Crisis Handling by LLMs
- **分类: cs.CL; cs.CY**

- **简介: 论文评估LLMs在心理健康危机处理中的表现，属于安全与伦理任务。解决危机识别与响应不准确的问题，构建了分类体系、数据集和评估方法，并测试了多个模型的响应安全性。**

- **链接: [https://arxiv.org/pdf/2509.24857](https://arxiv.org/pdf/2509.24857)**
...
>
> **备注:** Accepted for publication in JMIR Mental Health. DOI: https://doi.org/10.2196/88435
>
...
>
---
#### [replaced 036] Improved Evidence Extraction and Metrics for Document Inconsistency Detection with LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文档不一致检测任务，旨在提升LLMs在证据提取上的能力。通过引入新指标和框架，提高检测效果。**

- **链接: [https://arxiv.org/pdf/2601.02627](https://arxiv.org/pdf/2601.02627)**
...
>
---
#### [replaced 037] JoyAI-LLM Flash: Advancing Mid-Scale LLMs with Token Efficiency
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出JoyAI-LLM Flash，解决中等规模语言模型在性能与令牌效率间的平衡问题。通过MoE架构、FiberPO算法和稀疏化设计提升效率与效果。**

- **链接: [https://arxiv.org/pdf/2604.03044](https://arxiv.org/pdf/2604.03044)**
...
>
> **摘要:** We introduce JoyAI-LLM Flash, an efficient Mixture-of-Experts (MoE) language model designed to redefine the trade-off between strong performance and token efficiency in the sub-50B parameter regime. JoyAI-LLM Flash is pretrained on a massive corpus of 20 trillion tokens and further optimized through a rigorous post-training pipeline, including supervised fine-tuning (SFT), Direct Preference Optimization (DPO), and large-scale reinforcement learning (RL) across diverse environments. To improve token efficiency, JoyAI-LLM Flash strategically balances \emph{thinking} and \emph{non-thinking} cognitive modes and introduces FiberPO, a novel RL algorithm inspired by fibration theory that decomposes trust-region maintenance into global and local components, providing unified multi-scale stability control for LLM policy optimization. To enhance architectural sparsity, the model comprises 48B total parameters while activating only 2.7B parameters per forward pass, achieving a substantially higher sparsity ratio than contemporary industry leading models of comparable scale. To further improve inference throughput, we adopt a joint training-inference co-design that incorporates dense Multi-Token Prediction (MTP) and Quantization-Aware Training (QAT). We release the checkpoints for both JoyAI-LLM-48B-A3B Base and its post-trained variants on Hugging Face to support the open-source community.
>
---
#### [replaced 038] What Makes an Ideal Quote? Recommending "Unexpected yet Rational" Quotations via Novelty
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于 quotation recommendation 任务，旨在解决现有系统忽视语义和审美价值的问题。通过引入新颖性与语义一致性，提出 NovelQR 框架提升推荐效果。**

- **链接: [https://arxiv.org/pdf/2602.22220](https://arxiv.org/pdf/2602.22220)**

> **作者:** Bowei Zhang; Jin Xiao; Guanglei Yue; Qianyu He; Yanghua Xiao; Deqing Yang; Jiaqing Liang
>
> **备注:** Accepted to ACL 2026 main conference ; Code available at <this https URL
>
...
>
---
#### [replaced 039] VisCoder2: Building Multi-Language Visualization Coding Agents
- **分类: cs.SE; cs.AI; cs.CL; cs.PL**

- **简介: 该论文属于可视化编码任务，旨在解决多语言支持不足、执行不可靠及缺乏迭代修正的问题。构建了大规模数据集和基准测试，提出VisCoder2模型，提升代码生成与调试能力。**

- **链接: [https://arxiv.org/pdf/2510.23642](https://arxiv.org/pdf/2510.23642)**
...
>
---
#### [replaced 040] Large Language Models for Outpatient Referral: Problem Definition, Benchmarking and Challenges
- **分类: cs.CL; cs.AI**

- **简介: 论文探讨了大语言模型在门诊转诊任务中的应用，旨在解决评估标准缺失的问题。通过构建静态与动态评估框架，分析模型能力与局限性。**
...
>
> **摘要:** Large language models (LLMs) are increasingly applied to outpatient referral tasks across healthcare systems. However, there is a lack of standardized evaluation criteria to assess their effectiveness, particularly in dynamic, interactive scenarios. In this study, we systematically examine the capabilities and limitations of LLMs in managing tasks within Intelligent Outpatient Referral (IOR) systems and propose a comprehensive evaluation framework specifically designed for such systems. This framework comprises two core tasks: static evaluation, which focuses on evaluating the ability of predefined outpatient referrals, and dynamic evaluation, which evaluates capabilities of refining outpatient referral recommendations through iterative dialogues. Our findings suggest that LLMs offer limited advantages over BERT-like models, but show promise in asking effective questions during interactive dialogues.
>
---
#### [replaced 041] How to Evaluate Speech Translation with Source-Aware Neural MT Metrics
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语音翻译任务，旨在解决传统评估方法忽略源信息的问题。通过引入源感知的神经机器翻译指标，利用ASR转录和反向翻译生成文本代理，提升评估准确性。**

- **链接: [https://arxiv.org/pdf/2511.03295](https://arxiv.org/pdf/2511.03295)**

> **作者:** Mauro Cettolo; Marco Gaido; Matteo Negri; Sara Papi; Luisa Bentivogli
>
> **备注:** Main additions with respect to v2: Section 5.5 "Low-Resource Evaluation", Section 5.6 "Validation against Human Judgments", two instances of XLR-Segmenter: XLR-SimAlign and XLR-LaBSE, per-language analyses
>
> **摘要:** Automatic evaluation of ST systems is typically performed by comparing translation hypotheses with one or more reference translations. While effective to some extent, this approach inherits the limitation of reference-based evaluation that ignores valuable information from the source input. In MT, recent progress has shown that neural metrics incorporating the source text achieve stronger correlation with human judgments. Extending this idea to ST, however, is not trivial because the source is audio rather than text, and reliable transcripts or alignments between source and references are often unavailable. In this work, we conduct the first systematic study of source-aware metrics for ST, with a particular focus on real-world operating conditions where source transcripts are not available. We explore two complementary strategies for generating textual proxies of the input audio, ASR transcripts, and back-translations of the reference translation, and introduce a novel two-step cross-lingual re-segmentation algorithm to address the alignment mismatch between synthetic sources and reference translations. Our experiments, carried out on two ST benchmarks covering 79 language pairs and six ST systems with diverse architectures and performance levels, show that ASR transcripts constitute a more reliable synthetic source than back-translations when word error rate is below 20%, while back-translations always represent a computationally cheaper but still effective alternative. The robustness of these findings is further confirmed by experiments on a low-resource language pair (Bemba-English) and by a direct validation against human quality judgments. Furthermore, our cross-lingual re-segmentation algorithm enables robust use of source-aware MT metrics in ST evaluation, paving the way toward more accurate and principled evaluation methodologies for speech translation.
>
---
#### [replaced 042] One Life to Learn: Inferring Symbolic World Models for Stochastic Environments from Unguided Exploration
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于符号世界建模任务，旨在解决在复杂随机环境中无监督学习动态模型的问题。工作包括提出OneLife框架，通过条件程序规则建模环境，并验证其有效性。**

- **链接: [https://arxiv.org/pdf/2510.12088](https://arxiv.org/pdf/2510.12088)**

> **作者:** Zaid Khan; Archiki Prasad; Elias Stengel-Eskin; Jaemin Cho; Mohit Bansal
>
> **备注:** Accepted to ICLR 2026. Project page: this https URL 44 pages
>
...
>
---
#### [replaced 043] Compressible Softmax-Attended Language under Incompressible Attention
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究Transformer模型中注意力机制的可压缩性，分析softmax注意力的特征，揭示其数据属性而非框架特性。**
...
>
---
#### [replaced 045] The Rise of AfricaNLP: A Survey of Contributions, Contributors, Community Impact, and Bibliometric Analysis
- **分类: cs.CL**

- **简介: 该论文属于文献综述任务，旨在分析非洲NLP研究进展与贡献。通过数据统计与工具开发，揭示研究趋势与关键因素。**
