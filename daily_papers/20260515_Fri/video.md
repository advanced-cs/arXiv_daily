...
#### [new 001] A Picture is Worth a Thousand Words? An Empirical Study of Aggregation Strategies for Visual Financial Document Retrieval
- **分类: cs.CV; cs.AI; cs.IR**

- **简介: 该论文属于视觉金融文档检索任务，研究单向量聚合是否丢失关键信息。通过实验发现聚合导致语义细节丢失，根源是全局纹理主导。**

- **链接: [https://arxiv.org/pdf/2605.14581](https://arxiv.org/pdf/2605.14581)**

> **作者:** Ho Hung Lim; Yi Yang
>
> **备注:** Accepted to Findings of ACL 2026
>
> **摘要:** Visual RAG has offered an alternative to traditional RAG. It treats documents as images and uses vision encoders to obtain vision patch tokens. However, hundreds of patch tokens per document create retrieval and storage challenges in a vector database. Practical deployment requires aggregating them into a single vector. This raises a critical question: does single-vector aggregation lose key information in financial documents? We develop a diagnostic benchmark using financial documents where changes in single digits can lead to significant semantic shifts. Our experiments show that single-vector aggregation collapses different documents with almost identical vectors. Metrics show that the patch level detects semantic changes, and confirm that aggregation obscures these details. We identify global texture dominance as the root cause. Our findings are consistent across model scales, retrieval-optimized embeddings, and multiple mitigation strategies, highlighting significant risks for single-vector visual document retrieval in financial applications.
>
---
#### [new 002] HASTE: Training-Free Video Diffusion Acceleration via Head-Wise Adaptive Sparse Attention
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频生成任务，解决视频扩散模型中注意力机制计算效率低的问题。通过引入自适应稀疏注意力机制，提升推理速度并保持视频质量。**

- **链接: [https://arxiv.org/pdf/2605.14513](https://arxiv.org/pdf/2605.14513)**
...
>
---
#### [new 006] TERRA-CD: Multi-Temporal Framework for Multi-class and Semantic Change Detection
- **分类: cs.CV**

- **简介: 该论文属于变化检测任务，旨在解决城市植被监测数据不足的问题。提出TERRA-CD数据集，包含多时相遥感图像及多种标注方案，用于多类与语义变化检测研究。**

- **链接: [https://arxiv.org/pdf/2605.14651](https://arxiv.org/pdf/2605.14651)**
...
>
---
#### [new 032] Causal Forcing++: Scalable Few-Step Autoregressive Diffusion Distillation for Real-Time Interactive Video Generation
- **分类: cs.CV**

- **简介: 该论文属于实时交互视频生成任务，解决少步自回归初始化瓶颈问题。提出Causal Forcing++，通过因果一致性蒸馏提升效率与质量。**

- **链接: [https://arxiv.org/pdf/2605.15141](https://arxiv.org/pdf/2605.15141)**
...
>
---
#### [new 033] SToRe3D: Sparse Token Relevance in ViTs for Efficient Multi-View 3D Object Detection
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 038] Vision-Core Guided Contrastive Learning for Balanced Multi-modal Prognosis Prediction of Stroke
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态医学预测任务，旨在解决缺血性中风预后预测中的多模态融合不足问题。通过引入三模态融合和视觉引导的对比学习方法提升预测性能。**

- **链接: [https://arxiv.org/pdf/2605.14710](https://arxiv.org/pdf/2605.14710)**
...
>
---
#### [new 039] CoRDS: Coreset-based Representative and Diverse Selection for Streaming Video Understanding
- **分类: cs.CV**

- **简介: 该论文属于视频理解任务，解决流式视频记忆压缩问题。通过核心集选择方法，提升保留信息的代表性和多样性，优于传统启发式方法。**

- **链接: [https://arxiv.org/pdf/2605.14310](https://arxiv.org/pdf/2605.14310)**
...
>
---
#### [new 046] InsightTok: Improving Text and Face Fidelity in Discrete Tokenization for Autoregressive Image Generation
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在解决离散分词器在文本和人脸生成中的保真度问题。通过引入感知损失提升文本和人脸的重建质量。**

- **链接: [https://arxiv.org/pdf/2605.14333](https://arxiv.org/pdf/2605.14333)**
...
>
---
#### [new 048] Warp-as-History: Generalizable Camera-Controlled Video Generation from One Training Video
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决相机控制视频生成问题。提出Warp-as-History方法，无需训练即可让模型跟随指定摄像机轨迹，提升生成视频的视觉质量和运动动态。**

- **链接: [https://arxiv.org/pdf/2605.15182](https://arxiv.org/pdf/2605.15182)**
...
>
---
#### [new 049] Towards Real-Time Autonomous Navigation: Transformer-Based Catheter Tip Tracking in Fluoroscopy
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像处理任务，旨在解决实时导管尖端跟踪问题，以支持自主血栓切除导航。通过设计多线程跟踪框架，提升在低对比度等复杂条件下的跟踪精度。**

- **链接: [https://arxiv.org/pdf/2605.14253](https://arxiv.org/pdf/2605.14253)**
...
>
---
#### [new 060] Mitigating Mask Prior Drift and Positional Attention Collapse in Large Diffusion Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型任务，针对长文本生成中的重复生成和视觉定位退化问题，提出无需训练的掩码先验抑制和单调RoPE缩放方法。**
...
>
---
#### [new 061] ArcGate: Adaptive Arctangent Gated Activation
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出ArcGate激活函数，用于提升深度网络的非线性与鲁棒性。解决传统激活函数固定形状适应性差的问题，通过可学习参数实现自适应调整，在遥感任务中表现出色。**

- **链接: [https://arxiv.org/pdf/2605.14518](https://arxiv.org/pdf/2605.14518)**
...
>
---
#### [new 062] Hierarchical Image Tokenization for Multi-Scale Image Super Resolution
- **分类: cs.CV**

- **简介: 该论文属于图像超分辨率任务，解决传统方法在多尺度生成和模型复杂度上的问题。提出Hierarchical Image Tokenization和Direct Preference Optimization，提升模型灵活性与效率。**

- **链接: [https://arxiv.org/pdf/2605.14891](https://arxiv.org/pdf/2605.14891)**
...
>
---
#### [new 064] Beyond Instance-Level Self-Supervision in 3D Multi-Modal Medical Imaging
- **分类: cs.CV**

- **简介: 该论文属于多模态医学影像任务，旨在解决传统自监督方法忽略解剖结构空间一致性的问题。通过利用跨实例的拓扑一致性进行预训练，提升模型在分割和分类任务中的性能与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2605.14654](https://arxiv.org/pdf/2605.14654)**
...
>
---
#### [new 067] Exploring Vision-Language Models for Online Signature Verification: A Zero-Shot Capability Study
- **分类: cs.CV**

- **简介: 该论文属于在线签名验证任务，探索视觉语言模型在零样本情况下的性能，解决生物特征识别中的Forgery检测问题，通过转换数据并引入评分协议进行评估。**

- **链接: [https://arxiv.org/pdf/2605.14845](https://arxiv.org/pdf/2605.14845)**
...
>
---
#### [new 075] Does Synthetic Layered Design Data Benefit Layered Design Decomposition?
- **分类: cs.CV**

- **简介: 该论文属于图像分解任务，旨在解决层设计编辑难题。通过构建合成数据集，验证合成数据对分解效果的提升，探索其在实际系统中的应用潜力。**

- **链接: [https://arxiv.org/pdf/2605.15167](https://arxiv.org/pdf/2605.15167)**
...
>
---
#### [new 078] Denoising-GS: Gaussian Splatting with Spatial-aware Denoising
- **分类: cs.CV; cs.GR; cs.LG**

- **简介: 该论文属于三维重建任务，旨在解决3DGS中因初始化稀疏导致的噪声问题。通过引入空间感知的去噪框架，提升新视角合成的精度与结构完整性。**

- **链接: [https://arxiv.org/pdf/2605.14880](https://arxiv.org/pdf/2605.14880)**
...
>
---
#### [new 079] CalibAnyView: Beyond Single-View Camera Calibration in the Wild
- **分类: cs.CV**

- **简介: 该论文提出CalibAnyView，解决多视角相机标定问题，通过建模跨视角几何一致性，实现更准确的相机参数估计。**

- **链接: [https://arxiv.org/pdf/2605.14615](https://arxiv.org/pdf/2605.14615)**
...
>
---
#### [new 080] CreFlow: Corrective Reflow for Sparse-Reward Embodied Video Diffusion RL
- **分类: cs.CV**

- **简介: 该论文属于具身视频生成强化学习任务，解决稀疏奖励下视频生成违反物理约束的问题。提出CreFlow框架，结合约束奖励和修正重流损失，提升任务执行成功率。**

- **链接: [https://arxiv.org/pdf/2605.14274](https://arxiv.org/pdf/2605.14274)**
...
>
---
#### [new 089] Deep Image Segmentation via Discriminant Feature Learning
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像分割任务，旨在解决边界不准确的问题。提出DDA损失函数，通过判别分析提升特征区分性，增强分割精度和边界清晰度。**

- **链接: [https://arxiv.org/pdf/2605.14609](https://arxiv.org/pdf/2605.14609)**
...
>
---
#### [new 090] DUET: Dual-Paradigm Adaptive Expert Triage with Single-cell Inductive Prior for Spatial Transcriptomics Prediction
- **分类: cs.CV**

- **简介: 该论文提出DUET框架，解决从组织病理图像推断空间转录组数据的问题，结合单细胞数据提升预测准确性。**

- **链接: [https://arxiv.org/pdf/2605.14104](https://arxiv.org/pdf/2605.14104)**
...
>
---
#### [new 108] Quantitative Video World Model Evaluation for Geometric-Consistency
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频生成评估任务，解决生成视频几何一致性评价问题。提出PDI-Bench框架，通过3D重建和几何残差分析，定量评估生成视频的物理合理性。**

- **链接: [https://arxiv.org/pdf/2605.15185](https://arxiv.org/pdf/2605.15185)**
...
>
---
#### [new 109] MiVE: Multiscale Vision-language features for reference-guided video Editing
- **分类: cs.CV**

- **简介: 该论文属于参考引导视频编辑任务，旨在解决跨模态对齐与细节保留问题。通过多尺度视觉语言特征融合，提升编辑精度与效果。**
...
>
---
#### [new 110] SceneParser: Hierarchical Scene Parsing for Visual Semantics Understanding
- **分类: cs.CV**

- **简介: 该论文提出SceneParser，属于视觉语义理解任务，旨在解决场景中对象、部件与功能间结构依赖关系的解析问题。通过构建层次化表示和基准数据集，提升场景交互理解能力。**

- **链接: [https://arxiv.org/pdf/2605.14923](https://arxiv.org/pdf/2605.14923)**
...
>
---
#### [new 116] VGGT-Edit: Feed-forward Native 3D Scene Editing with Residual Field Prediction
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出VGGT-Edit，解决3D场景编辑中动态指令响应与结构一致性问题，通过深度同步文本注入和残差变换实现高效、高质量的3D编辑。**
...
>
---
#### [new 117] GeoVista: Visually Grounded Active Perception for Ultra-High-Resolution Remote Sensing Understanding
- **分类: cs.CV**

- **简介: 该论文提出GeoVista，解决超高清遥感图像理解中的全局感知与证据追踪问题，通过规划驱动的主动感知框架提升模型效率与准确性。**

- **链接: [https://arxiv.org/pdf/2605.14475](https://arxiv.org/pdf/2605.14475)**
...
>
---
#### [new 123] EARL: Towards a Unified Analysis-Guided Reinforcement Learning Framework for Egocentric Interaction Reasoning and Pixel Grounding
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 124] On the Cultural Anachronism and Temporal Reasoning in Vision Language Models
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于视觉语言模型任务，旨在解决文化时代错位问题。通过构建基准数据集，评估模型在历史文物上的时间推理能力，揭示现有模型的不足。**

- **链接: [https://arxiv.org/pdf/2605.15071](https://arxiv.org/pdf/2605.15071)**
...
>
---
#### [new 125] SteerSeg: Attention Steering for Reasoning Video Segmentation
- **分类: cs.CV**

- **简介: 该论文属于视频分割任务，解决视频中基于自然语言的物体定位问题。针对注意力图模糊的问题，提出SteerSeg框架，通过调整注意力分布提升定位精度。**

- **链接: [https://arxiv.org/pdf/2605.14908](https://arxiv.org/pdf/2605.14908)**
...
>
---
#### [new 126] MonoPRIO: Adaptive Prior Conditioning for Unified Monocular 3D Object Detection
- **分类: cs.CV**

- **简介: 该论文提出MonoPRIO，解决单目3D目标检测中尺度和深度不确定的问题，通过自适应先验条件提升检测性能。**

- **链接: [https://arxiv.org/pdf/2605.14781](https://arxiv.org/pdf/2605.14781)**
...
>
---
#### [new 155] Understanding Imbalanced Forgetting in Rehearsal-Based Class-Incremental Learning
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于类增量学习任务，解决模型在持续学习中出现的类别遗忘不均衡问题。通过分析梯度级干扰因素，提出预测遗忘程度的系数，为缓解遗忘差异提供方向。**

- **链接: [https://arxiv.org/pdf/2605.14785](https://arxiv.org/pdf/2605.14785)**
...
>
---
#### [new 158] Video2GUI: Synthesizing Large-Scale Interaction Trajectories for Generalized GUI Agent Pretraining
- **分类: cs.CL; cs.AI; cs.CV; cs.LG**

- **简介: 该论文提出Video2GUI框架，解决GUI代理训练数据不足问题。通过自动化提取视频中的交互轨迹，构建大规模数据集WildGUI，提升GUI代理性能。属于GUI代理预训练任务。**

- **链接: [https://arxiv.org/pdf/2605.14747](https://arxiv.org/pdf/2605.14747)**
...
>
---
#### [new 159] Bad Seeing or Bad Thinking? Rewarding Perception for Vision-Language Reasoning
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于视觉语言推理任务，解决VLM中感知与推理协同不足的问题。通过引入强化学习框架和模态信用分配机制，提升感知准确性与推理效果。**

- **链接: [https://arxiv.org/pdf/2605.14054](https://arxiv.org/pdf/2605.14054)**
...
>
---
#### [new 164] Vision-Based Runtime Monitoring under Varying Specifications using Semantic Latent Representations
...
>
---
#### [new 167] To See is Not to Learn: Protecting Multimodal Data from Unauthorized Fine-Tuning of Large Vision-Language Model
- **分类: cs.CR; cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文属于数据保护任务，旨在解决未经授权的大型视觉语言模型微调问题。提出MMGuard，通过注入扰动干扰模型学习，实现对多模态数据的主动防护。**

- **链接: [https://arxiv.org/pdf/2605.14291](https://arxiv.org/pdf/2605.14291)**
...
>
---
#### [new 168] Octopus: History-Free Gradient Orthogonalization for Continual Learning in Multimodal Large Language Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于持续学习任务，旨在解决多模态大语言模型中的灾难性遗忘问题。提出Octopus框架，通过无历史梯度正交化方法实现有效知识更新。**

- **链接: [https://arxiv.org/pdf/2605.14938](https://arxiv.org/pdf/2605.14938)**
...
>
---
#### [new 169] Covariance-aware sampling for Diffusion Models
- **分类: stat.ML; cs.CV; cs.LG**

- **简介: 该论文属于扩散模型采样任务，旨在提升少步数下的采样质量。通过建模逆过程协方差，提出一种改进的采样方法，仅需少量额外计算即可超越现有方法。**

- **链接: [https://arxiv.org/pdf/2605.13910](https://arxiv.org/pdf/2605.13910)**
...
>
---
#### [new 170] Action-Inspired Generative Models
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出一种生成模型框架AGMs，解决桥接匹配中路径质量不均的问题。通过引入轻量级势能函数V_φ，优化生成质量，提升精度与覆盖度。**

- **链接: [https://arxiv.org/pdf/2605.14631](https://arxiv.org/pdf/2605.14631)**
...
>
---
#### [new 171] IntentVLA: Short-Horizon Intent Modeling for Aliased Robot Manipulation
...
>
---
#### [new 174] Learning Direct Control Policies with Flow Matching for Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 175] GeoViSTA: Geospatial Vision-Tabular Transformer for Multimodal Environment Representation
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出GeoViSTA模型，解决地理环境与社会经济数据融合问题，通过联合建模图像和表格数据，提升环境推理能力。**

- **链接: [https://arxiv.org/pdf/2605.14406](https://arxiv.org/pdf/2605.14406)**
...
>
---
#### [new 176] DiffusionOPD: A Unified Perspective of On-Policy Distillation in Diffusion Models
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出DiffusionOPD，解决扩散模型多任务训练中的干扰与遗忘问题。通过在线策略蒸馏实现高效多任务学习。**

- **链接: [https://arxiv.org/pdf/2605.15055](https://arxiv.org/pdf/2605.15055)**
...
>
---
#### [new 177] Before the Body Moves: Learning Anticipatory Joint Intent for Language-Conditioned Humanoid Control
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 178] Masked Autoencoders with Limited Data: Does It Work? A Fine-Grained Bioacoustics Case Study
...
>
---
#### [replaced 002] One Token Per Frame: Reconsidering Visual Bandwidth in World Models for VLA Policy
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2605.07931](https://arxiv.org/pdf/2605.07931)**

> **作者:** Zuojin Tang; Shengchao Yuan; Xiaoxin Bai; Zhiyuan Jing; De Ma; Gang Pan; Bin Liu
>
...
>
---
#### [replaced 004] SD-ReID: View-aware Stable Diffusion for Aerial-Ground Person Re-Identification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.09549](https://arxiv.org/pdf/2504.09549)**

> **作者:** Yuhao Wang; Xiang Hu; Lixin Wang; Pingping Zhang; Huchuan Lu
>
> **备注:** This work is accepted by IEEE TIP 2026. More modifications may performed
>
...
>
---
#### [replaced 005] CoCoEdit: Content-Consistent Image Editing via Region Regularized Reinforcement Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.14068](https://arxiv.org/pdf/2602.14068)**
...
>
---
#### [replaced 006] Neural Field Thermal Tomography: A Differentiable Physics Framework for Non-Destructive Evaluation
...
>
---
#### [replaced 007] OpenTrack3D: Towards Accurate and Generalizable Open-Vocabulary 3D Instance Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.03532](https://arxiv.org/pdf/2512.03532)**
...
>
---
#### [replaced 008] RAM-W600: A Multi-Task Wrist Dataset and Benchmark for Rheumatoid Arthritis
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.05193](https://arxiv.org/pdf/2507.05193)**
...
>
---
#### [replaced 009] The Potential of Convolutional Neural Networks for Cancer Detection
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2412.17155](https://arxiv.org/pdf/2412.17155)**
...
>
---
#### [replaced 010] Seeing Through the Brain: New Insights from Decoding Visual Stimuli with fMRI
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.16196](https://arxiv.org/pdf/2510.16196)**

> **作者:** Zheng Huang; Enpei Zhang; Weikang Qiu; Yinghao Cai; Carl Yang; Elynn Chen; Xiang Zhang; Rex Ying; Dawei Zhou; Yujun Yan
>
...
>
---
#### [replaced 011] MoCapAnything V2: End-to-End Motion Capture for Arbitrary Skeletons
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.28130](https://arxiv.org/pdf/2604.28130)**
...
>
---
#### [replaced 012] Boosting Omni-Modal Language Models: Staged Post-Training with Visually Debiased Evaluation
...
>
---
#### [replaced 013] SCOOTER: A Human Evaluation Framework for Unrestricted Adversarial Examples
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.07776](https://arxiv.org/pdf/2507.07776)**
...
>
---
#### [replaced 018] FlowInOne:Unifying Multimodal Generation as Image-in, Image-out Flow Matching
- **分类: cs.CV**
...
>
> **摘要:** Multimodal generation has long been dominated by text-driven pipelines where language dictates vision but cannot reason or create within it. We challenge this paradigm by asking whether all modalities, including textual descriptions, spatial layouts, and editing instructions, can be unified into a single visual representation. We present FlowInOne, a framework that reformulates multimodal generation as a purely visual flow, converting all inputs into visual prompts and enabling a clean image-in, image-out pipeline governed by a single flow matching model. This vision-centric formulation naturally eliminates cross-modal alignment bottlenecks, noise scheduling, and task-specific architectural branches, unifying text-to-image generation, layout-guided editing, and visual instruction following under one coherent paradigm. To support this, we introduce VisPrompt-5M, a large-scale dataset of 5 million visual prompt pairs spanning diverse tasks including physics-aware force dynamics and trajectory prediction, alongside VP-Bench, a rigorously curated benchmark assessing instruction faithfulness, spatial precision, visual realism, and content consistency. Extensive experiments demonstrate that FlowInOne achieves state-of-the-art performance across all unified generation tasks, surpassing both open-source models and competitive commercial systems, establishing a new foundation for fully vision-centric generative modeling where perception and creation coexist within a single continuous visual space. Our code and models are released on this https URL
>
---
#### [replaced 019] Overcoming Dynamics-Blindness: Training-Free Pace-and-Path Correction for VLA Models
...
>
---
#### [replaced 020] Action Emergence from Streaming Intent
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 021] Rethinking Event-Based Object Dtection through Representation-Level Temporal Aggregation and Model-Level Hypergraph Reasoning
- **分类: cs.CV**
...
>
---
#### [replaced 022] IPR-1: Interactive Physical Reasoner
...
>
> **备注:** 13 pages of main text and 20 pages of appendices. Project page: this https URL
>
...
>
---
#### [replaced 023] G-SHARP: Gaussian Surgical Hardware Accelerated Real-time Pipeline
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02482](https://arxiv.org/pdf/2512.02482)**

> **作者:** Vishwesh Nath; Javier G. Tejero; Aravind S. Kumar; Ruilong Li; Filippo Filicori; Mahdi Azizian; Sean D. Huver
>
...
>
---
#### [replaced 024] SuperF: Neural Implicit Fields for Multi-Image Super-Resolution
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.09115](https://arxiv.org/pdf/2512.09115)**

> **作者:** Sander Riisøen Jyhne; Christian Igel; Morten Goodwin; Per-Arne Andersen; Serge Belongie; Nico Lang
>
> **备注:** Published at ICLR 2026, Project website: this https URL, 23 pages, 13 figures, 8 table
>
...
>
---
#### [replaced 029] MobileEgo Anywhere: Open Infrastructure for long horizon egocentric data on commodity hardware
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出MobileEgo Anywhere框架，解决长时序自指数据收集问题。通过手机硬件实现长时间、高精度的自指数据采集与处理，促进视觉语言动作模型发展。**
...
>
---
#### [replaced 039] Training-Free Inference for High-Resolution Sinogram Completion
- **分类: cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2506.08809](https://arxiv.org/pdf/2506.08809)**
...
>
---
#### [replaced 042] The Multi-View Paradigm Shift in MRI Radiomics: Predicting MGMT Methylation in Glioblastoma
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 053] MultiMat: Multimodal Program Synthesis for Procedural Materials using Large Multimodal Models
- **分类: cs.CV**
...
>
---
#### [replaced 054] HERO: Hierarchical Extrapolation and Refresh for Efficient World Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.17588](https://arxiv.org/pdf/2508.17588)**

> **作者:** Quanjian Song; Xinyu Wang; Donghao Zhou; Jingyu Lin; Cunjian Chen; Yue Ma
>
...
>
---
#### [replaced 057] RAPO++: Cross-Stage Prompt Optimization for Text-to-Video Generation via Data Alignment and Test-Time Scaling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.20206](https://arxiv.org/pdf/2510.20206)**
...
>
> **备注:** arXiv admin note: text overlap with arXiv:2504.11739
>
...
>
---
#### [replaced 058] REVISOR: Beyond Textual Reflection, Towards Multimodal Introspective Reasoning in Long-Form Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13026](https://arxiv.org/pdf/2511.13026)**
...
>
---
#### [replaced 059] Learning Multimodal Embeddings for Traffic Accident Prediction and Causal Estimation
- **分类: cs.LG; cs.CV; cs.SI**

- **链接: [https://arxiv.org/pdf/2512.02920](https://arxiv.org/pdf/2512.02920)**

> **作者:** Ziniu Zhang; Minxuan Duan; Haris N. Koutsopoulos; Hongyang R. Zhang
>
> **备注:** 17 pages. Appeared in KDD 2026
>
...
>
---
#### [replaced 060] MindVLA-U1: VLA Beats VA with Unified Streaming Architecture for Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 061] LangPrecip: Language-Aware Multimodal Precipitation Nowcasting
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22317](https://arxiv.org/pdf/2512.22317)**

> **作者:** Xudong Ling; Chaorong Li; Tianxi Huang; Qian Dong; Guiduo Duan
>
...
>
---
#### [replaced 062] Mixture Prototype Flow Matching for Open-Set Supervised Anomaly Detection
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 063] Do-Undo Bench: Reversibility for Action Understanding in Image Generation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.13609](https://arxiv.org/pdf/2512.13609)**

> **作者:** Shweta Mahajan; Shreya Kadambi; Hoang Le; Rajeev Yasarla; Apratim Bhattacharyya; Munawar Hayat; Fatih Porikli
>
> **备注:** Project page: this https URL
>
...
>
---
#### [replaced 067] DocScope: Benchmarking Verifiable Reasoning for Trustworthy Long-Document Understanding
- **分类: cs.CL; cs.CV**

- **简介: 该论文提出DocScope，用于评估模型在长文档上的可信推理能力。任务是验证模型能否生成可追溯的推理过程，解决现有评估方法不足的问题，通过结构化轨迹预测和多阶段评估实现。**
...
>
---
#### [replaced 068] V2M-Zero: Zero-Pair Time-Aligned Video-to-Music Generation
...
>
---
#### [replaced 069] R-DMesh: Video-Guided 3D Animation via Rectified Dynamic Mesh Flow
- **分类: cs.CV; cs.GR; cs.LG**
...
>
---
#### [replaced 070] Dual Ascent Diffusion for Inverse Problems
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2505.17353](https://arxiv.org/pdf/2505.17353)**
...
>
---
#### [replaced 076] From Local Matches to Global Masks: Template-Guided Instance Detection and Segmentation in Open-World Scenes
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 079] Hunyuan3D 2.0: Scaling Diffusion Models for High Resolution Textured 3D Assets Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2501.12202](https://arxiv.org/pdf/2501.12202)**
...
>
---
#### [replaced 087] GenExam: A Multidisciplinary Text-to-Image Exam
- **分类: cs.CV**
