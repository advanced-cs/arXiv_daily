...
- **链接: [http://arxiv.org/pdf/2506.18697v1](http://arxiv.org/pdf/2506.18697v1)**
...
- **简介: 该论文属于机器人导航任务，旨在解决极端环境中安全可靠导航问题。通过融合快速学习与物理模型，提升安全性与适应性。**
...
- **简介: 该论文研究多旋翼无人机紧密编队飞行任务，解决气动干扰导致的不稳定问题，提出L1 KNODE-DW MPC控制框架，提升轨迹跟踪与适应能力。**
...
- **简介: 该论文属于SLAM任务，解决动态干扰和点云噪声问题。提出ADA-DPM方法，通过动态分割、重要性评分和图卷积模块提升定位精度与鲁棒性。**
...
- **简介: 该论文属于高精度目标跟踪任务，解决GPS拒止环境下的自主导航问题。提出NOVA框架，仅使用立体相机和IMU实现高速、安全的目标跟踪与避障。**
...
- **简介: 该论文属于触觉传感任务，旨在解决基于标记的立体视觉触觉传感器的几何重建问题，提出多项改进方法以提高精度。**
...
- **简介: 该论文属于机器人铺层自动化任务，旨在解决铺层计划在不同条件下性能不佳的问题。通过融合专家知识与数据驱动方法优化计划，提升效率和鲁棒性。**
...
- **简介: 该论文属于语言驱动抓取检测任务，旨在解决复杂指令理解和无监督适应新场景的问题。提出GraspMAS多智能体系统，提升抓取决策效果。**
...
- **简介: 该论文属于机器人规划任务，解决云模型依赖问题，通过知识蒸馏将大模型压缩为小模型，实现在设备端高效运行。**
...
- **简介: 该论文属于多机器人任务分配任务，解决施工环境中动态协调问题。融合数字孪生、整数规划和大语言模型，实现自适应任务分配与调度优化。**
...
- **简介: 该论文属于人机交互任务，旨在提升机器人透明度与用户感知。通过镜像眼设计，使机器人能直观反映关注区域，增强用户对机器人状态的理解与互动体验。**
...
- **链接: [http://arxiv.org/pdf/2506.18526v1](http://arxiv.org/pdf/2506.18526v1)**
...
- **简介: 该论文属于教育技术任务，旨在解决如何通过教学机器人提升儿童学习效果的问题。研究引入交互式强化学习模型，让机器人与儿童互动学习，结果显示教学机器人能有效提高知识保留率。**
...
- **简介: 该论文属于人机交互任务，探讨LLM驱动的机器人与聊天机器人在CBT中的效果差异。研究比较两者在时间推移下的参与度和披露深度，发现机器人条件下的参与度和亲密感随时间增加，而聊天机器人则下降。**
...
- **简介: 该论文属于无人机视觉跟踪任务，解决空中目标高效跟踪问题。融合深度学习与KCF提升检测效率，采用强化学习优化控制策略。**
...
>
---
#### [new 042] Integrating Maneuverable Planning and Adaptive Control for Robot Cart-Pushing under Disturbances
- **分类: cs.RO**
...
- **简介: 该论文属于机器人变形物体操作任务，解决目标形状获取难题。提出DefFusionNet，利用扩散模型生成多样化的目标形状，提升操作灵活性与实用性。**
...
- **简介: 该论文属于机器人触觉手势识别任务，旨在通过电子皮肤实现机器人对触摸动作的识别与理解，解决人机交互中的触觉输入问题。**
...
- **简介: 该论文属于机器人自主学习任务，旨在解决开放性学习中的目标生成、技能获取与环境适应问题。提出H-GRAIL架构，集成内在动机与学习机制，实现自主探索与任务解决。**
...
- **链接: [http://arxiv.org/pdf/2506.17991v1](http://arxiv.org/pdf/2506.17991v1)**
...
>
---
#### [new 067] SWA-SOP: Spatially-aware Window Attention for Semantic Occupancy Prediction in Autonomous Driving
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 068] Crowdsourcing Ubiquitous Indoor Localization with Non-Cooperative Wi-Fi Ranging
- **分类: cs.HC; cs.NI; cs.RO**

- **简介: 该论文属于室内定位任务，解决传统方法部署困难的问题。提出PeepLoc系统，利用现有Wi-Fi设备和基础设施，通过非合作测距和人群数据实现高效定位。**

- **链接: [http://arxiv.org/pdf/2506.18317v1](http://arxiv.org/pdf/2506.18317v1)**
...
>
---
#### [replaced 004] Context-Aware Human Behavior Prediction Using Multimodal Large Language Models: Challenges and Insights
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.00839v2](http://arxiv.org/pdf/2504.00839v2)**

> **作者:** Yuchen Liu; Lino Lerch; Luigi Palmieri; Andrey Rudenko; Sebastian Koch; Timo Ropinski; Marco Aiello
>
> **备注:** Accepted at IEEE International Conference on Robot and Human Interactive Communication (RO-MAN), 2025
>
> **摘要:** Predicting human behavior in shared environments is crucial for safe and efficient human-robot interaction. Traditional data-driven methods to that end are pre-trained on domain-specific datasets, activity types, and prediction horizons. In contrast, the recent breakthroughs in Large Language Models (LLMs) promise open-ended cross-domain generalization to describe various human activities and make predictions in any context. In particular, Multimodal LLMs (MLLMs) are able to integrate information from various sources, achieving more contextual awareness and improved scene understanding. The difficulty in applying general-purpose MLLMs directly for prediction stems from their limited capacity for processing large input sequences, sensitivity to prompt design, and expensive fine-tuning. In this paper, we present a systematic analysis of applying pre-trained MLLMs for context-aware human behavior prediction. To this end, we introduce a modular multimodal human activity prediction framework that allows us to benchmark various MLLMs, input variations, In-Context Learning (ICL), and autoregressive techniques. Our evaluation indicates that the best-performing framework configuration is able to reach 92.8% semantic similarity and 66.1% exact label accuracy in predicting human behaviors in the target frame.
>
---
#### [replaced 005] Diffusion-based learning of contact plans for agile locomotion
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2403.03639v5](http://arxiv.org/pdf/2403.03639v5)**
...
>
---
#### [replaced 007] DriveSuprim: Towards Precise Trajectory Selection for End-to-End Planning
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 008] OWMM-Agent: Open World Mobile Manipulation With Multi-modal Agentic Data Synthesis
- **分类: cs.RO; cs.AI; I.2.4; I.2.9; I.2.10**

- **链接: [http://arxiv.org/pdf/2506.04217v2](http://arxiv.org/pdf/2506.04217v2)**
...
>
---
#### [replaced 009] Accurate Simulation and Parameter Identification of Deformable Linear Objects using Discrete Elastic Rods in Generalized Coordinates
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2310.00911v2](http://arxiv.org/pdf/2310.00911v2)**

> **作者:** Qi Jing Chen; Quang-Cuong Pham
>
...
>
---
#### [replaced 010] Active Fine-Tuning of Multi-Task Policies
- **分类: cs.LG; cs.RO**

- **链接: [http://arxiv.org/pdf/2410.05026v3](http://arxiv.org/pdf/2410.05026v3)**
...
>
---
#### [replaced 011] Autonomous Navigation of Quadrupeds Using Coverage Path Planning with Morphological Skeleton Map
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2504.17880v2](http://arxiv.org/pdf/2504.17880v2)**
...
>
---
#### [replaced 012] HybridVLA: Collaborative Diffusion and Autoregression in a Unified Vision-Language-Action Model
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 013] Trajectory Prediction for Autonomous Driving: Progress, Limitations, and Future Directions
...
>
---
#### [replaced 014] Learning Accurate Whole-body Throwing with High-frequency Residual Policy and Pullback Tube Acceleration
- **分类: cs.RO; 68T40, 93C85, 70E60; I.2.9; I.2.10; I.2.8**

- **链接: [http://arxiv.org/pdf/2506.16986v2](http://arxiv.org/pdf/2506.16986v2)**
...
>
---
#### [replaced 015] Learning Aerodynamics for the Control of Flying Humanoid Robots
- **分类: cs.RO; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.00305v2](http://arxiv.org/pdf/2506.00305v2)**
...
>
---
#### [replaced 023] G3Flow: Generative 3D Semantic Flow for Pose-aware and Generalizable Object Manipulation
...
>
---
#### [replaced 024] SALT: A Flexible Semi-Automatic Labeling Tool for General LiDAR Point Clouds with Cross-Scene Adaptability and 4D Consistency
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 025] Object State Estimation Through Robotic Active Interaction for Biological Autonomous Drilling
- **分类: cs.RO; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2503.04043v3](http://arxiv.org/pdf/2503.04043v3)**

> **作者:** Xiaofeng Lin; Enduo Zhao; Saúl Alexis Heredia Pérez; Kanako Harada
>
> **备注:** 6 pages, 5 figures, accepted by RA-L. Please refer to the DOI to access the accepted version
>
...
>
---
#### [replaced 029] LoopSR: Looping Sim-and-Real for Lifelong Policy Adaptation of Legged Robots
- **分类: cs.RO; cs.LG**

- **链接: [http://arxiv.org/pdf/2409.17992v2](http://arxiv.org/pdf/2409.17992v2)**
