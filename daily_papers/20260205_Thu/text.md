...
>
---
#### [new 005] Reinforced Attention Learning
...
>
> **摘要:** Semantic textual similarity (STS) plays a crucial role in many natural language processing tasks. While extensively studied in high-resource languages, STS remains challenging for under-resourced languages such as Slovak. This paper presents a comparative evaluation of sentence-level STS methods applied to Slovak, including traditional algorithms, supervised machine learning models, and third-party deep learning tools. We trained several machine learning models using outputs from traditional algorithms as features, with feature selection and hyperparameter tuning jointly guided by artificial bee colony optimization. Finally, we evaluated several third-party tools, including fine-tuned model by CloudNLP, OpenAI's embedding models, GPT-4 model, and pretrained SlovakBERT model. Our findings highlight the trade-offs between different approaches.
>
---
#### [new 016] Less Finetuning, Better Retrieval: Rethinking LLM Adaptation for Biomedical Retrievers via Synthetic Data and Model Merging
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于生物医学检索任务，旨在提升通用大模型在特定领域的检索效果。通过合成数据和模型融合，增强模型性能，解决领域适应性不足的问题。**

- **链接: [https://arxiv.org/pdf/2602.04731v1](https://arxiv.org/pdf/2602.04731v1)**
...
>
---
#### [new 020] Model-Dowser: Data-Free Importance Probing to Mitigate Catastrophic Forgetting in Multimodal Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决多模态大模型微调中的灾难性遗忘问题。提出Model-Dowser方法，通过重要性评估实现高效微调。**

- **链接: [https://arxiv.org/pdf/2602.04509v1](https://arxiv.org/pdf/2602.04509v1)**
...
>
---
#### [new 023] When Silence Is Golden: Can LLMs Learn to Abstain in Temporal QA and Beyond?
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于时间问答任务，旨在解决LLMs不承认不确定性的缺陷。通过结合思维链监督与强化学习，提升模型在时间推理中的拒绝回答能力。**

- **链接: [https://arxiv.org/pdf/2602.04755v1](https://arxiv.org/pdf/2602.04755v1)**
...
>
---
#### [new 030] RexBERT: Context Specialized Bidirectional Encoders for E-commerce
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出RexBERT，针对电商语义设计的双向编码器。解决通用模型在电商领域效果不佳的问题，通过专用数据集和预训练方法提升性能。**

- **链接: [https://arxiv.org/pdf/2602.04605v1](https://arxiv.org/pdf/2602.04605v1)**

> **作者:** Rahul Bajaj; Anuj Garg
>
> **备注:** Blog: https://huggingface.co/blog/thebajajra/rexbert-encoders Models: https://huggingface.co/collections/thebajajra/rexbert Ecom-niverse Dataset: https://huggingface.co/datasets/thebajajra/Ecom-niverse
>
...
>
---
#### [new 031] The Missing Half: Unveiling Training-time Implicit Safety Risks Beyond Deployment
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于AI安全领域，研究训练阶段的隐式安全风险，揭示模型因内部激励产生的有害行为。通过分类与实验，提出风险框架并分析其影响。**

- **链接: [https://arxiv.org/pdf/2602.04196v1](https://arxiv.org/pdf/2602.04196v1)**
...
>
---
#### [new 032] Beyond Many-Shot Translation: Scaling In-Context Demonstrations For Low-Resource Machine Translation
- **分类: cs.CL**

- **简介: 该论文属于低资源机器翻译任务，旨在解决数据稀缺问题。通过扩展上下文学习，探索不同语料对模型性能的影响，发现更多上下文未必带来更好效果。**

- **链接: [https://arxiv.org/pdf/2602.04764v1](https://arxiv.org/pdf/2602.04764v1)**
...
>
---
#### [new 041] Expert Selections In MoE Models Reveal (Almost) As Much As Text
- **分类: cs.CL; cs.CR**

- **简介: 该论文研究MoE模型中专家选择的文本重建问题，属于安全与隐私任务。通过分析专家选择泄露的信息，提出方法恢复文本，揭示其敏感性。**

- **链接: [https://arxiv.org/pdf/2602.04105v1](https://arxiv.org/pdf/2602.04105v1)**
...
>
---
#### [new 042] On the Credibility of Evaluating LLMs using Survey Questions
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文属于大语言模型评估任务，探讨用问卷调查评估LLM价值观的可信度。研究指出现有方法存在偏差，提出新指标自相关距离，并建议改进提示和解码策略。**

- **链接: [https://arxiv.org/pdf/2602.04033v1](https://arxiv.org/pdf/2602.04033v1)**
...
>
---
#### [new 043] Fine-Grained Activation Steering: Steering Less, Achieving More
- **分类: cs.CL**

- **简介: 该论文属于语言模型行为调控任务，旨在解决块级激活干预效率低的问题。通过分解激活为细粒度原子单元，提出AUSteer方法，实现更精准有效的控制。**

- **链接: [https://arxiv.org/pdf/2602.04428v1](https://arxiv.org/pdf/2602.04428v1)**
...
>
---
#### [new 045] ReFRAME or Remain: Unsupervised Lexical Semantic Change Detection with Frame Semantics
- **分类: cs.CL**

- **简介: 该论文属于词汇语义变化检测任务，旨在解决现有方法可解释性差的问题。提出基于框架语义的无监督方法，有效检测语义变化，并具有更高可解释性。**

- **链接: [https://arxiv.org/pdf/2602.04514v1](https://arxiv.org/pdf/2602.04514v1)**
...
>
---
#### [new 051] Revisiting Prompt Sensitivity in Large Language Models for Text Classification: The Role of Prompt Underspecification
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于文本分类任务，研究大语言模型对提示的敏感性。指出提示不明确是导致敏感性的主要原因，并通过实验分析不同提示的影响。**

- **链接: [https://arxiv.org/pdf/2602.04297v1](https://arxiv.org/pdf/2602.04297v1)**
...
>
---
#### [new 052] DementiaBank-Emotion: A Multi-Rater Emotion Annotation Corpus for Alzheimer's Disease Speech (Version 1.0)
- **分类: cs.CL; cs.SD**
...
>
---
#### [new 068] A Domain-Specific Curated Benchmark for Entity and Document-Level Relation Extraction
- **分类: cs.CL**

- **简介: 该论文提出GutBrainIE基准，解决生物医学信息抽取任务中的数据不足与质量低问题，通过人工标注提升实体和关系抽取的准确性。**

- **链接: [https://arxiv.org/pdf/2602.04320v1](https://arxiv.org/pdf/2602.04320v1)**
...
>
---
#### [new 074] Identifying Intervenable and Interpretable Features via Orthogonality Regularization
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决语言模型中特征可解释性问题。通过正交性约束，分离出可干预的语义特征，提升模型的可解释性与模块化。**

- **链接: [https://arxiv.org/pdf/2602.04718v1](https://arxiv.org/pdf/2602.04718v1)**
...
>
---
#### [new 075] SpatiaLab: Can Vision-Language Models Perform Spatial Reasoning in the Wild?
...
>
---
#### [new 080] Delving into Muon and Beyond: Deep Analysis and Extensions
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究优化算法，聚焦Muon及其扩展。通过谱视角分析其机制，对比不同参数设置下的优化效果，旨在理解Muon与Adam的关系及性能差异。**

- **链接: [https://arxiv.org/pdf/2602.04669v1](https://arxiv.org/pdf/2602.04669v1)**
...
>
---
#### [new 081] Speaker-Aware Simulation Improves Conversational Speech Recognition
...
>
---
#### [new 082] Overstating Attitudes, Ignoring Networks: LLM Biases in Simulating Misinformation Susceptibility
- **分类: cs.SI; cs.AI; cs.CL**

- **简介: 该论文属于社会科学研究任务，旨在检验LLM在模拟虚假信息易感性时的偏差。研究发现LLM过度强调态度影响，忽视社交网络因素，存在系统性偏差。**

- **链接: [https://arxiv.org/pdf/2602.04674v1](https://arxiv.org/pdf/2602.04674v1)**
...
>
---
#### [new 083] From Assumptions to Actions: Turning LLM Reasoning into Uncertainty-Aware Planning for Embodied Agents
- **分类: cs.AI; cs.CL; cs.MA**

- **简介: 该论文属于多智能体强化学习任务，旨在解决环境中不确定性下的规划问题。提出PCE框架，将LLM推理转化为结构化决策树，减少通信依赖，提升任务效率与可信度。**

- **链接: [https://arxiv.org/pdf/2602.04326v1](https://arxiv.org/pdf/2602.04326v1)**
...
>
---
#### [new 086] HybridQuestion: Human-AI Collaboration for Identifying High-Impact Research Questions
- **分类: cs.HC; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于科学问题识别任务，旨在解决AI能否提出有影响力的科研问题。通过人机协作方法，结合AI的数据处理能力和人类判断，筛选出未来科学突破和问题。**

- **链接: [https://arxiv.org/pdf/2602.03849v1](https://arxiv.org/pdf/2602.03849v1)**
...
>
---
#### [new 087] BASS: Benchmarking Audio LMs for Musical Structure and Semantic Reasoning
- **分类: cs.SD; cs.CL**
...
>
---
#### [new 088] Training Data Efficiency in Multimodal Process Reward Models
- **分类: cs.LG; cs.CL; cs.MM**

- **简介: 该论文研究多模态过程奖励模型（MPRMs）的训练数据效率问题，旨在减少对大规模标注数据的依赖。通过分析梯度更新因素，提出BIS方法，在少量数据下达到或超越全量数据效果。**

- **链接: [https://arxiv.org/pdf/2602.04145v1](https://arxiv.org/pdf/2602.04145v1)**
...
>
---
#### [new 091] RAPO: Risk-Aware Preference Optimization for Generalizable Safe Reasoning
- **分类: cs.LG; cs.AI; cs.CL; cs.CR; math.OC**

- **简介: 该论文属于大模型安全任务，解决LRMs在面对复杂攻击时安全推理泛化不足的问题。提出RAPO框架，增强模型对安全风险的适应性识别与处理能力。**

- **链接: [https://arxiv.org/pdf/2602.04224v1](https://arxiv.org/pdf/2602.04224v1)**
...
>
---
#### [new 092] Beyond Static Cropping: Layer-Adaptive Visual Localization and Decoding Enhancement
...
>
---
#### [new 093] Scaling In-Context Online Learning Capability of LLMs via Cross-Episode Meta-RL
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于强化学习任务，旨在解决LLMs在在线决策中难以有效利用上下文交互经验的问题。通过引入ORBIT框架，提升模型的元强化学习能力，实现更优的在线学习效果。**

- **链接: [https://arxiv.org/pdf/2602.04089v1](https://arxiv.org/pdf/2602.04089v1)**
...
>
---
#### [new 094] Subliminal Effects in Your Data: A General Mechanism via Log-Linearity
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文属于自然语言处理领域，旨在解决数据对模型行为影响的机制问题。通过提出LLS方法，揭示数据集如何引发模型的隐性行为，如语言转换和角色扮演。**

- **链接: [https://arxiv.org/pdf/2602.04863v1](https://arxiv.org/pdf/2602.04863v1)**
...
>
---
#### [new 095] Rethinking Perplexity: Revealing the Impact of Input Length on Perplexity Evaluation in LLMs
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理领域，旨在解决LLMs评估中输入长度对困惑度影响的问题。通过构建LengthBenchmark框架，分析不同评估协议下的模型表现，揭示长度偏差对公平比较的影响。**

- **链接: [https://arxiv.org/pdf/2602.04099v1](https://arxiv.org/pdf/2602.04099v1)**
...
>
---
#### [new 096] Benchmarking Automatic Speech Recognition for Indian Languages in Agricultural Contexts
...
>
---
#### [new 097] Empirical-MCTS: Continuous Agent Evolution via Dual-Experience Monte Carlo Tree Search
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出Empirical-MCTS，解决LLM推理中经验积累不足的问题，通过双循环框架实现持续学习与优化。**

- **链接: [https://arxiv.org/pdf/2602.04248v1](https://arxiv.org/pdf/2602.04248v1)**
...
>
---
#### [new 098] Horizon-LM: A RAM-Centric Architecture for LLM Training
- **分类: cs.OS; cs.CL; cs.DC**

- **简介: 该论文提出Horizon-LM，解决大模型训练中GPU内存瓶颈问题。通过CPU主控、GPU计算的架构，实现内存高效训练，提升单机训练规模与效率。**

- **链接: [https://arxiv.org/pdf/2602.04816v1](https://arxiv.org/pdf/2602.04816v1)**
...
>
---
#### [new 099] Frontend Token Enhancement for Token-Based Speech Recognition
- **分类: cs.SD; cs.CL; eess.AS**
...
>
---
#### [new 100] Stroke Lesions as a Rosetta Stone for Language Model Interpretability
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于语言模型可解释性研究，通过脑损伤与语言症状映射，评估语言模型的扰动效果，验证其行为是否符合人类语言处理机制。**

- **链接: [https://arxiv.org/pdf/2602.04074v1](https://arxiv.org/pdf/2602.04074v1)**
...
#### [replaced 001] CreditAudit: 2$^\text{nd}$ Dimension for LLM Evaluation and Selection
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出CreditAudit，用于大语言模型的评估与选择，解决模型在实际部署中的稳定性问题。通过多场景评估，提供二维评价体系，辅助精准部署。**

- **链接: [https://arxiv.org/pdf/2602.02515v2](https://arxiv.org/pdf/2602.02515v2)**
...
>
---
#### [replaced 002] Hebrew Diacritics Restoration using Visual Representation
- **分类: cs.CL**

- **简介: 该论文属于希伯来语元音符号恢复任务，旨在解决无元音文本的准确发音和语义歧义问题。提出DiVRit系统，通过视觉表示进行零样本分类，提升恢复效果。**

- **链接: [https://arxiv.org/pdf/2510.26521v3](https://arxiv.org/pdf/2510.26521v3)**
...
>
---
#### [replaced 003] Representation-Aware Unlearning via Activation Signatures: From Suppression to Knowledge-Signature Erasure
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于知识擦除任务，解决LLM中真实知识删除与行为抑制混淆的问题。提出KIF框架，通过激活签名实现有效擦除，兼顾效果与性能。**

- **链接: [https://arxiv.org/pdf/2601.10566v3](https://arxiv.org/pdf/2601.10566v3)**
...
>
---
#### [replaced 004] Semantics as a Shield: Label Disguise Defense (LDD) against Prompt Injection in LLM Sentiment Classification
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本分类任务，针对大语言模型的提示注入攻击问题，提出LDD防御方法，通过语义伪装标签提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2511.21752v2](https://arxiv.org/pdf/2511.21752v2)**
...
>
---
#### [replaced 005] ToxiTwitch: Toward Emote-Aware Hybrid Moderation for Live Streaming Platforms
- **分类: cs.CL; cs.SI**

- **简介: 该论文属于内容安全任务，旨在解决直播平台中的有害行为检测问题。通过结合语言模型与传统分类器，提出ToxiTwitch系统，提升毒性检测效果。**

- **链接: [https://arxiv.org/pdf/2601.15605v2](https://arxiv.org/pdf/2601.15605v2)**
...
>
---
#### [replaced 008] Integrating Fine-Grained Audio-Visual Evidence for Robust Multimodal Emotion Reasoning
...
>
---
#### [replaced 009] Reading Between the Lines: Combining Pause Dynamics and Semantic Coherence for Automated Assessment of Thought Disorder
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于精神疾病自动化评估任务，旨在解决传统临床评估方法的不足。通过结合停顿动态和语义连贯性，提升对思维障碍的预测性能。**

- **链接: [https://arxiv.org/pdf/2507.13551v2](https://arxiv.org/pdf/2507.13551v2)**
...
>
---
#### [replaced 010] Look Back to Reason Forward: Revisitable Memory for Long-Context LLM Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于长文本问答任务，解决长距离信息检索与多步推理问题。提出ReMemR1模型，通过记忆检索与多级奖励机制提升模型对长上下文的理解能力。**

- **链接: [https://arxiv.org/pdf/2509.23040v3](https://arxiv.org/pdf/2509.23040v3)**
...
>
---
#### [replaced 011] OmniRAG-Agent: Agentic Omnimodal Reasoning for Low-Resource Long Audio-Video Question Answering
- **分类: cs.CL**

- **简介: 该论文属于多模态问答任务，解决低资源下长音频视频问答的问题。提出OmniRAG-Agent，通过检索增强生成和代理循环提升回答效果。**

- **链接: [https://arxiv.org/pdf/2602.03707v2](https://arxiv.org/pdf/2602.03707v2)**
...
>
---
#### [replaced 012] AERO: Autonomous Evolutionary Reasoning Optimization via Endogenous Dual-Loop Feedback
- **分类: cs.CL**

- **简介: 该论文提出AERO框架，解决LLM依赖标注数据和外部验证的问题，通过自监督机制实现自主推理优化。属于自然语言处理任务。**

- **链接: [https://arxiv.org/pdf/2602.03084v2](https://arxiv.org/pdf/2602.03084v2)**
...
>
---
#### [replaced 013] Vicarious Offense and Noise Audit of Offensive Speech Classifiers: Unifying Human and Machine Disagreement on What is Offensive
- **分类: cs.CL; cs.CY; cs.LG**

- **简介: 该论文属于内容 moderation 任务，研究机器与人类在识别仇恨言论上的分歧。通过噪声审计和新数据集，揭示了Moderation 结果的不一致及政治倾向的影响。**

- **链接: [https://arxiv.org/pdf/2301.12534v5](https://arxiv.org/pdf/2301.12534v5)**

> **作者:** Tharindu Cyril Weerasooriya; Sujan Dutta; Tharindu Ranasinghe; Marcos Zampieri; Christopher M. Homan; Ashiqur R. KhudaBukhsh
>
> **备注:** Accepted at EMNLP 2023
>
> **摘要:** Offensive speech detection is a key component of content moderation. However, what is offensive can be highly subjective. This paper investigates how machine and human moderators disagree on what is offensive when it comes to real-world social web political discourse. We show that (1) there is extensive disagreement among the moderators (humans and machines); and (2) human and large-language-model classifiers are unable to predict how other human raters will respond, based on their political leanings. For (1), we conduct a noise audit at an unprecedented scale that combines both machine and human responses. For (2), we introduce a first-of-its-kind dataset of vicarious offense. Our noise audit reveals that moderation outcomes vary wildly across different machine moderators. Our experiments with human moderators suggest that political leanings combined with sensitive issues affect both first-person and vicarious offense. The dataset is available through https://github.com/Homan-Lab/voiced.
>
---
#### [replaced 014] Bridging the Knowledge-Prediction Gap in LLMs on Multiple-Choice Questions
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决LLMs在多项选择题中知识与预测不一致的问题。通过分析隐藏表示，提出KAPPA方法对齐知识与预测子空间，减少知识-预测差距。**

- **链接: [https://arxiv.org/pdf/2509.23782v3](https://arxiv.org/pdf/2509.23782v3)**
...
>
---
#### [replaced 015] Beyond Forgetting: Machine Unlearning Elicits Controllable Side Behaviors and Capabilities
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究机器遗忘中的表示误导方法，探讨其引发的可控行为和能力提升。属于模型遗忘任务，解决如何通过操控表示实现可控行为与能力增强的问题。**

- **链接: [https://arxiv.org/pdf/2601.21702v2](https://arxiv.org/pdf/2601.21702v2)**
...
>
---
#### [replaced 016] Latent Chain-of-Thought as Planning: Decoupling Reasoning from Verbalization
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出PLaT框架，将隐式推理建模为规划过程，解决LLM推理效率与多样性问题，通过解耦推理与文本生成提升可扩展性。**

- **链接: [https://arxiv.org/pdf/2601.21358v2](https://arxiv.org/pdf/2601.21358v2)**
...
>
---
#### [replaced 017] DEBATE: A Large-Scale Benchmark for Evaluating Opinion Dynamics in Role-Playing LLM Agents
- **分类: cs.CL**

- **简介: 该论文属于多智能体模拟任务，旨在解决角色扮演大语言模型在模拟意见动态时的不真实问题。提出DEBATE基准，评估并改进模型与人类互动的一致性。**

- **链接: [https://arxiv.org/pdf/2510.25110v3](https://arxiv.org/pdf/2510.25110v3)**
...
>
---
#### [replaced 018] Why Steering Works: Toward a Unified View of Language Model Parameter Dynamics
...
>
---
#### [replaced 021] ResT: Reshaping Token-Level Policy Gradients for Tool-Use Large Language Models
- **分类: cs.CL**

- **简介: 该论文针对工具使用大型语言模型的策略优化问题，提出ResT方法，通过调整token权重降低策略梯度方差，提升训练效率与稳定性。**

- **链接: [https://arxiv.org/pdf/2509.21826v2](https://arxiv.org/pdf/2509.21826v2)**
...
>
---
#### [replaced 022] When Avatars Have Personality: Effects on Engagement and Communication in Immersive Medical Training
- **分类: cs.HC; cs.CL**

- **简介: 该论文属于医疗VR训练任务，旨在提升虚拟患者的人际交互能力。通过整合LLM构建有个性的虚拟患者，解决VR在培养沟通技能上的不足。**

- **链接: [https://arxiv.org/pdf/2509.14132v2](https://arxiv.org/pdf/2509.14132v2)**

> **作者:** Julia S. Dollis; Iago A. Brito; Fernanda B. Färber; Pedro S. F. B. Ribeiro; Gustavo H. W. Barbosa; Andressa A. Bastos; Rafael T. Sousa; Arlindo R. Galvão Filho
>
...
>
---
#### [replaced 025] Fine-tuned LLM-based Code Migration Framework
- **分类: cs.SE; cs.CL; cs.LO**

- **简介: 该论文属于代码迁移任务，解决SQL系统迁移中的语法映射和兼容性问题，通过融合微调大语言模型提升迁移精度与效率。**

- **链接: [https://arxiv.org/pdf/2512.13515v2](https://arxiv.org/pdf/2512.13515v2)**
...
>
---
#### [replaced 029] DPO Unchained: Your Training Algorithm is Secretly Disentangled in Human Choice Theory
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文探讨DPO在人类选择理论下的泛化与优化，属于强化学习任务，旨在解决ML算法与人类偏好对齐的问题，提出更广泛的规范框架。**

- **链接: [https://arxiv.org/pdf/2507.07855v3](https://arxiv.org/pdf/2507.07855v3)**

> **作者:** Wenxuan Zhou; Shujian Zhang; Brice Magdalou; John Lambert; Ehsan Amid; Richard Nock; Andrew Hard
>
> **摘要:** Normative theories allow one to elicit key parts of a ML algorithm from first principles, which is crucial at a time of championed scrutiny for ML work. Direct Preference Optimization (DPO) cleverly bypasses reward modeling by making an explicit link with a specific normative model of human choice. Our paper elevates this connection to the full generality of DPO's normative framework. Getting there requires reworking human choice theory's textbook path for a better RLHF/ML fit. It elevates the connection to a remarkably broad viewpoint on preference optimization, considering the current panorama of DPO follow-ups. It also unveils unexpected riches for ML, chief among which the support for non-convex losses, the fact that any compliant ML analytical choice can be embedded with any human choice model, and a normative framework's umbrella wide enough to safeguard DPO's extensions (margins, length correction, ...). A toy experiment ``far away'' from the DPO crowd is given.
>
---
#### [replaced 030] Guarding the Guardrails: A Taxonomy-Driven Approach to Jailbreak Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于 jailbreak 检测任务，旨在解决 LLM 安全问题。提出一种层次化分类体系，分析攻击策略，构建多语言数据集，提升检测效果。**

- **链接: [https://arxiv.org/pdf/2510.13893v2](https://arxiv.org/pdf/2510.13893v2)**

> **作者:** Francesco Giarrusso; Olga E. Sorokoletova; Vincenzo Suriani; Daniele Nardi
>
> **备注:** 2nd Conference on International Association for Safe & Ethical AI (IASEAI 2026), 24-26 February 2026, UNESCO House, Paris, France
>
...
>
---
#### [replaced 031] BanglaIPA: Towards Robust Text-to-IPA Transcription with Contextual Rewriting in Bengali
- **分类: cs.CL**

- **简介: 该论文属于文本到IPA转写任务，旨在解决 Bengali 语言中缺乏鲁棒的 IPA 转写系统问题。提出 BanglaIPA 系统，结合字符和词级对齐，提升方言和数字处理能力。**

- **链接: [https://arxiv.org/pdf/2601.01778v2](https://arxiv.org/pdf/2601.01778v2)**

> **作者:** Jakir Hasan; Shrestha Datta; Md Saiful Islam; Shubhashis Roy Dipta; Ameya Debnath
>
> **备注:** Accepted at LoResLM workshop, EACL 2026
>
...
>
---
#### [replaced 032] Persuade Me if You Can: A Framework for Evaluating Persuasion Effectiveness and Susceptibility Among Large Language Models
- **分类: cs.CL; cs.AI; cs.LG; cs.MA**

- **简介: 该论文属于AI安全与伦理任务，旨在评估大语言模型的说服力和易受说服性。工作包括提出PMIYC框架，自动测试模型在多轮对话中的表现，并验证其有效性。**

- **链接: [https://arxiv.org/pdf/2503.01829v3](https://arxiv.org/pdf/2503.01829v3)**

> **作者:** Nimet Beyza Bozdag; Shuhaib Mehri; Gokhan Tur; Dilek Hakkani-Tür
>
> **备注:** Updated to match the NeurIPS MTI-LLM Workshop format. Content remains consistent with the original version, with structural refinements, expanded explanations, and an extended appendix including additional results
>
...
>
---
#### [replaced 033] Breaking the MoE LLM Trilemma: Dynamic Expert Clustering with Structured Compression
- **分类: cs.CL; cs.AI; cs.DC; cs.LG; cs.NE**

- **简介: 该论文属于自然语言处理领域，旨在解决MoE LLM的负载不平衡、参数冗余和通信开销问题。通过动态专家聚类和结构压缩，提升模型效率与性能。**

- **链接: [https://arxiv.org/pdf/2510.02345v2](https://arxiv.org/pdf/2510.02345v2)**
...
>
---
#### [replaced 040] Language models can learn implicit multi-hop reasoning, but only if they have lots of training data
- **分类: cs.CL**

- **简介: 该论文研究语言模型的隐式多跳推理能力，探讨其在不同训练数据量下的表现及模型深度需求。任务属于自然语言处理中的推理问题。**

- **链接: [https://arxiv.org/pdf/2505.17923v2](https://arxiv.org/pdf/2505.17923v2)**
...
>
---
#### [replaced 041] Scaling Agents for Computer Use
...
>
---
#### [replaced 044] Diversity or Precision? A Deep Dive into Next Token Prediction
- **分类: cs.CL**

- **简介: 论文探讨如何通过调整预训练模型的token分布来优化强化学习的探索空间，属于语言模型优化任务。旨在解决RL训练中探索效率低的问题，提出一种结合精度与多样性的新预训练目标。**

- **链接: [https://arxiv.org/pdf/2512.22955v2](https://arxiv.org/pdf/2512.22955v2)**
...
>
---
#### [replaced 045] WAXAL: A Large-Scale Multilingual African Language Speech Corpus
...
>
---
#### [replaced 046] Asynchronous Reasoning: Training-Free Interactive Thinking LLMs
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM交互性差的问题。通过利用位置嵌入，使模型能异步思考与响应，提升实时性。**

- **链接: [https://arxiv.org/pdf/2512.10931v2](https://arxiv.org/pdf/2512.10931v2)**
...
>
---
#### [replaced 047] ROSA-Tuning: Enhancing Long-Context Modeling via Suffix Matching
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决长文本建模中计算效率与上下文覆盖不足的问题。提出ROSA-Tuning方法，通过检索与回忆机制提升模型对长上下文的处理能力，同时保持高效计算。**

- **链接: [https://arxiv.org/pdf/2602.02499v2](https://arxiv.org/pdf/2602.02499v2)**
...
>
---
#### [replaced 048] Self-Improving Pretraining: using post-trained models to pretrain better models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在提升大模型生成内容的安全性、事实性和质量。通过引入强化学习机制，利用后训练模型优化预训练过程，提高生成结果的可靠性。**

- **链接: [https://arxiv.org/pdf/2601.21343v2](https://arxiv.org/pdf/2601.21343v2)**
...
>
---
#### [replaced 051] Content Anonymization for Privacy in Long-form Audio
- **分类: cs.SD; cs.CL**
...
>
---
#### [replaced 052] Beyond Tokens: Semantic-Aware Speculative Decoding for Efficient Inference by Probing Internal States
- **分类: cs.CL; cs.PF**

- **简介: 该论文属于自然语言处理任务，解决LLM推理延迟高的问题。提出SemanticSpec框架，通过语义序列验证替代传统token级验证，提升推理效率。**

- **链接: [https://arxiv.org/pdf/2602.03708v2](https://arxiv.org/pdf/2602.03708v2)**
...
>
---
#### [replaced 053] Multiple Choice Learning of Low-Rank Adapters for Language Modeling
- **分类: cs.LG; cs.AI; cs.CL; stat.ML**

- **简介: 该论文属于语言建模任务，旨在解决生成多样且合理句子延续的问题。提出LoRA-MCL方法，通过多重选择学习和低秩适配提升生成多样性与相关性。**

- **链接: [https://arxiv.org/pdf/2507.10419v2](https://arxiv.org/pdf/2507.10419v2)**
...
>
---
#### [replaced 056] Scaling Multiagent Systems with Process Rewards
- **分类: cs.AI; cs.CL; cs.ET; cs.MA**

- **简介: 该论文属于多智能体系统优化任务，解决多智能体协同中的信用分配与样本效率问题。提出MAPPA方法，通过每步过程奖励提升训练效果，实验验证其在数学和数据分析任务中的有效性。**

- **链接: [https://arxiv.org/pdf/2601.23228v2](https://arxiv.org/pdf/2601.23228v2)**
...
>
---
#### [replaced 057] DeVisE: Behavioral Testing of Medical Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于医疗大模型行为测试任务，旨在检验模型是否具备真实医学推理能力。通过构建对抗样本，分析模型对人口统计和生命体征变化的响应，揭示现有评估指标的不足。**

- **链接: [https://arxiv.org/pdf/2506.15339v2](https://arxiv.org/pdf/2506.15339v2)**
...
>
---
#### [replaced 058] MIRROR: A Multi-Agent Framework with Iterative Adaptive Revision and Hierarchical Retrieval for Optimization Modeling in Operations Research
- **分类: cs.CL**

- **简介: 该论文属于运筹优化建模任务，旨在解决自然语言到数学模型自动转换的准确性问题。提出MIRROR框架，结合迭代修正和分层检索，提升建模效率与可靠性。**

- **链接: [https://arxiv.org/pdf/2602.03318v2](https://arxiv.org/pdf/2602.03318v2)**
...
>
---
#### [replaced 059] DeepAgent: A General Reasoning Agent with Scalable Toolsets
- **分类: cs.AI; cs.CL; cs.IR; cs.LG**

- **简介: 该论文提出DeepAgent，一个能自主推理、发现工具并执行任务的智能代理。解决真实场景中长周期交互和工具使用问题，通过记忆压缩和强化学习策略提升性能。**

- **链接: [https://arxiv.org/pdf/2510.21618v2](https://arxiv.org/pdf/2510.21618v2)**
...
>
---
#### [replaced 060] PersoBench: Benchmarking Personalized Response Generation in Large Language Models
- **分类: cs.CL**

- **简介: 该论文提出PersoBench，用于评估大语言模型在角色对话中的个性化生成能力。解决个性化响应不足的问题，通过自动化框架进行多维度评估。**

- **链接: [https://arxiv.org/pdf/2410.03198v2](https://arxiv.org/pdf/2410.03198v2)**

> **作者:** Saleh Afzoon; Zahra Jamali; Usman Naseem; Amin Beheshti
>
...
>
---
#### [replaced 063] Explainable Sentiment Analysis with DeepSeek-R1: Performance, Efficiency, and Few-Shot Learning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于情感分析任务，旨在解决大模型在准确性、效率和可解释性间的平衡问题。通过对比测试DeepSeek-R1与GPT-4o，验证其在少量样本下的高效性能和可解释性。**

- **链接: [https://arxiv.org/pdf/2503.11655v5](https://arxiv.org/pdf/2503.11655v5)**
...
>
---
#### [replaced 064] Group-Adaptive Adversarial Learning for Robust Fake News Detection Against Malicious Comments
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于虚假新闻检测任务，旨在解决恶意评论导致的误分类问题。提出AdComment框架，通过自适应对抗训练提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2510.09712v2](https://arxiv.org/pdf/2510.09712v2)**
...
>
---
#### [replaced 065] Almost Clinical: Linguistic properties of synthetic electronic health records
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在评估合成电子健康记录的语料质量与临床适用性。研究分析了不同临床文本中的语言特征，揭示了合成数据的潜力与局限。**

- **链接: [https://arxiv.org/pdf/2601.01171v2](https://arxiv.org/pdf/2601.01171v2)**

> **作者:** Serge Sharoff; John Baker; David Francis Hunt; Alan Simpson
>
> **摘要:** This study evaluates the linguistic and clinical suitability of synthetic electronic health records in mental health. First, we describe the rationale and the methodology for creating the synthetic corpus. Second, we examine expressions of agency, modality, and information flow across four clinical genres (Assessments, Correspondence, Referrals and Care plans) with the aim to understand how LLMs grammatically construct medical authority and patient agency through linguistic choices. While LLMs produce coherent, terminology-appropriate texts that approximate clinical practice, systematic divergences remain, including registerial shifts, insufficient clinical specificity, and inaccuracies in medication use and diagnostic procedures. The results show both the potential and limitations of synthetic corpora for enabling large-scale linguistic research otherwise impossible with genuine patient records.
>
---
#### [replaced 066] Addressing Data Imbalance in Transformer-Based Multi-Label Emotion Detection with Weighted Loss
- **分类: cs.CL**

- **简介: 该论文属于多标签情感检测任务，旨在解决数据不平衡问题。通过引入加权损失函数，提升模型在少数情感类别上的表现。**

- **链接: [https://arxiv.org/pdf/2507.11384v3](https://arxiv.org/pdf/2507.11384v3)**
...
>
---
#### [replaced 067] Beyond Correctness: Rewarding Faithful Reasoning in Retrieval-Augmented Generation
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的检索增强生成任务，旨在解决模型推理过程不忠实的问题。通过引入VERITAS框架，提升推理的可信度与任务性能。**

- **链接: [https://arxiv.org/pdf/2510.13272v2](https://arxiv.org/pdf/2510.13272v2)**
...
>
---
#### [replaced 071] Open-Source Multimodal Moxin Models with Moxin-VLM and Moxin-VLA
- **分类: cs.CL; cs.CV; cs.LG**
...
>
---
#### [replaced 074] Learning Domain Knowledge in Multimodal Large Language Models through Reinforcement Fine-Tuning
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 077] MapCoder-Lite: Distilling Multi-Agent Coding into a Single Small LLM
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出MapCoder-Lite，解决多智能体代码生成在小型模型上的效率与效果问题，通过知识蒸馏和优化策略，提升小模型的代码生成能力。**

- **链接: [https://arxiv.org/pdf/2509.17489v2](https://arxiv.org/pdf/2509.17489v2)**
