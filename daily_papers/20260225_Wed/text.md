...
>
---
#### [new 008] ConceptRM: The Quest to Mitigate Alert Fatigue through Consensus-Based Purity-Driven Data Cleaning for Reflection Modelling
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于异常检测任务，旨在解决警报疲劳问题。通过构建高质量语料训练反射模型，有效过滤虚假警报，采用共识驱动的数据清洗方法提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.20166v1](https://arxiv.org/pdf/2602.20166v1)**
...
>
---
#### [new 009] How communicatively optimal are exact numeral systems? Once more on lexicon size and morphosyntactic complexity
- **分类: cs.CL**

- **简介: 论文探讨 numeral 系统的交际效率，分析词库大小与形态复杂性的平衡。任务是评估语言的数值系统是否最优，解决为何许多语言效率低于预期的问题。工作包括数据分析和形式变异标注。**

- **链接: [https://arxiv.org/pdf/2602.20372v1](https://arxiv.org/pdf/2602.20372v1)**
...
>
> **摘要:** Recent research argues that exact recursive numeral systems optimize communicative efficiency by balancing a tradeoff between the size of the numeral lexicon and the average morphosyntactic complexity (roughly length in morphemes) of numeral terms. We argue that previous studies have not characterized the data in a fashion that accounts for the degree of complexity languages display. Using data from 52 genetically diverse languages and an annotation scheme distinguishing between predictable and unpredictable allomorphy (formal variation), we show that many of the world's languages are decisively less efficient than one would expect. We discuss the implications of our findings for the study of numeral systems and linguistic evolution more generally.
>
---
#### [new 010] Stop-Think-AutoRegress: Language Modeling with Latent Diffusion Planning
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出STAR-LDM，将潜在扩散规划与自回归生成结合，解决语言生成中的全局语义规划问题，提升叙事连贯性和常识推理能力。**

- **链接: [https://arxiv.org/pdf/2602.20528v1](https://arxiv.org/pdf/2602.20528v1)**
...
>
---
#### [new 011] Blackbird Language Matrices: A Framework to Investigate the Linguistic Competence of Language Models
- **分类: cs.CL**

- **简介: 论文提出Blackbird Language Matrices任务，用于研究语言模型的语法能力。通过结构化多级问题，检验模型对语言对象、模式及错误的识别能力。**

- **链接: [https://arxiv.org/pdf/2602.20966v1](https://arxiv.org/pdf/2602.20966v1)**
...
>
---
#### [new 020] Talking to Yourself: Defying Forgetting in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，解决大模型微调中的灾难性遗忘问题。通过自生成对话数据进行自增强，提升模型性能并防止知识丢失。**

- **链接: [https://arxiv.org/pdf/2602.20162v1](https://arxiv.org/pdf/2602.20162v1)**
...
>
---
#### [new 021] CAMEL: Confidence-Gated Reflection for Reward Modeling
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出CAMEL框架，用于改进奖励建模任务。针对现有方法效率与可解释性之间的权衡，CAMEL通过置信度筛选减少计算开销，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.20670v1](https://arxiv.org/pdf/2602.20670v1)**

> **作者:** Zirui Zhu; Hailun Xu; Yang Luo; Yong Liu; Kanchan Sarkar; Kun Xu; Yang You
>
> **备注:** Preprint. 13 pages
>
> **摘要:** Reward models play a fundamental role in aligning large language models with human preferences. Existing methods predominantly follow two paradigms: scalar discriminative preference models, which are efficient but lack interpretability, and generative judging models, which offer richer reasoning at the cost of higher computational overhead. We observe that the log-probability margin between verdict tokens strongly correlates with prediction correctness, providing a reliable proxy for instance difficulty without additional inference cost. Building on this insight, we propose CAMEL, a confidence-gated reflection framework that performs a lightweight single-token preference decision first and selectively invokes reflection only for low-confidence instances. To induce effective self-correction, we train the model via reinforcement learning with counterfactual prefix augmentation, which exposes the model to diverse initial verdicts and encourages genuine revision. Empirically, CAMEL achieves state-of-the-art performance on three widely used reward-model benchmarks with 82.9% average accuracy, surpassing the best prior model by 3.2% and outperforming 70B-parameter models using only 14B parameters, while establishing a strictly better accuracy-efficiency Pareto frontier.
>
---
#### [new 022] What Makes a Good Query? Measuring the Impact of Human-Confusing Linguistic Features on LLM Performance
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，旨在研究查询特征对大模型幻觉的影响。通过分析22维查询特征，识别出导致幻觉风险的查询类型，为优化查询提供依据。**

- **链接: [https://arxiv.org/pdf/2602.20300v1](https://arxiv.org/pdf/2602.20300v1)**
...
>
---
#### [new 027] Don't Ignore the Tail: Decoupling top-K Probabilities for Efficient Language Model Distillation
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言模型压缩任务，旨在解决传统KL散度在知识蒸馏中忽略低概率词的问题。通过提出一种关注尾部概率的新散度方法，提升蒸馏效果。**

- **链接: [https://arxiv.org/pdf/2602.20816v1](https://arxiv.org/pdf/2602.20816v1)**
...
>
---
#### [new 028] Adaptive Text Anonymization: Learning Privacy-Utility Trade-offs via Prompt Optimization
- **分类: cs.CL**

- **简介: 该论文提出自适应文本匿名化任务，解决隐私与效用平衡问题。通过提示优化框架自动生成匿名化策略，提升不同场景下的效果与灵活性。**

- **链接: [https://arxiv.org/pdf/2602.20743v1](https://arxiv.org/pdf/2602.20743v1)**
...
>
---
#### [new 029] Personal Information Parroting in Language Models
- **分类: cs.CL; cs.AI; cs.CR; cs.LG**

- **简介: 该论文研究语言模型中个人隐私信息的复述问题，旨在检测并减少模型对PI的 memorization。通过开发检测工具，分析不同模型的复述情况，发现模型规模和预训练时间与复述率正相关。**

- **链接: [https://arxiv.org/pdf/2602.20580v1](https://arxiv.org/pdf/2602.20580v1)**
...
>
---
#### [new 030] Exa-PSD: a new Persian sentiment analysis dataset on Twitter
- **分类: cs.CL**

- **简介: 该论文属于情感分析任务，旨在解决波斯语社交媒体数据缺乏的问题。作者构建了Exa-PSD数据集，包含12,000条标注的波斯语推文，用于提升波斯语情感分析效果。**

- **链接: [https://arxiv.org/pdf/2602.20892v1](https://arxiv.org/pdf/2602.20892v1)**

> **作者:** Seyed Himan Ghaderi; Saeed Sarbazi Azad; Mohammad Mehdi Jaziriyan; Ahmad Akbari
>
> **备注:** This is the original submitted (preprint) version of a paper published in Language Resources and Evaluation. The final published version is available at Springer via DOI: https://doi.org/10.1007/s10579-025-09886-5
>
...
>
---
#### [new 034] MedCLIPSeg: Probabilistic Vision-Language Adaptation for Data-Efficient and Generalizable Medical Image Segmentation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 035] PreScience: A Benchmark for Forecasting Scientific Contributions
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出PreScience基准，用于预测科学贡献。任务包括合作者预测、文献选择、成果生成和影响预测，旨在评估AI在科学创新中的能力。**

- **链接: [https://arxiv.org/pdf/2602.20459v1](https://arxiv.org/pdf/2602.20459v1)**
...
>
---
#### [new 039] SpecMind: Cognitively Inspired, Interactive Multi-Turn Framework for Postcondition Inference
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于程序验证任务，旨在解决手动编写规格困难的问题。提出SpecMind框架，通过多轮交互提升后置条件生成的准确性与完整性。**

- **链接: [https://arxiv.org/pdf/2602.20610v1](https://arxiv.org/pdf/2602.20610v1)**
...
>
---
#### [new 040] An artificial intelligence framework for end-to-end rare disease phenotyping from clinical notes using large language models
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于罕见病表型分析任务，旨在解决人工标注耗时、难以扩展的问题。提出RARE-PHENIX框架，整合文本提取、标准化和优先级排序，提升表型准确性与临床一致性。**

- **链接: [https://arxiv.org/pdf/2602.20324v1](https://arxiv.org/pdf/2602.20324v1)**
...
>
---
#### [new 041] MoBiQuant: Mixture-of-Bits Quantization for Token-Adaptive Elastic LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出MoBiQuant，解决弹性大语言模型量化中的精度切换问题，通过调整权重精度适应不同计算资源。**

- **链接: [https://arxiv.org/pdf/2602.20191v1](https://arxiv.org/pdf/2602.20191v1)**
...
>
---
#### [new 042] SELAUR: Self Evolving LLM Agent via Uncertainty-aware Rewards
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出SELAUR框架，解决LLM在决策任务中的探索效率与稳定性问题。通过引入不确定性信号优化奖励设计，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.21158v1](https://arxiv.org/pdf/2602.21158v1)**
...
>
---
#### [new 043] Exploring Anti-Aging Literature via ConvexTopics and Large Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于文本主题建模任务，旨在解决传统方法在可重复性和可解释性上的不足。通过改进凸优化聚类算法，提取稳定且细粒度的衰老相关主题。**

- **链接: [https://arxiv.org/pdf/2602.20224v1](https://arxiv.org/pdf/2602.20224v1)**
...
>
---
#### [new 046] Multi-Vector Index Compression in Any Modality
...
>
---
#### [new 047] GATES: Self-Distillation under Privileged Context with Consensus Gating
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究文档驱动的问答任务，解决无监督下的知识蒸馏问题。通过共识门控机制，利用多个推理轨迹提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.20574v1](https://arxiv.org/pdf/2602.20574v1)**
...
>
---
#### [new 048] An Expert Schema for Evaluating Large Language Model Errors in Scholarly Question-Answering Systems
- **分类: cs.HC; cs.CL**

- **简介: 该论文属于评估任务，旨在解决LLM在学术问答中的可靠性问题。通过与专家合作，识别20种错误模式，构建评估框架，提升专家对LLM输出的评价效果。**

- **链接: [https://arxiv.org/pdf/2602.21059v1](https://arxiv.org/pdf/2602.21059v1)**
...
>
---
#### [new 051] Inner Speech as Behavior Guides: Steerable Imitation of Diverse Behaviors for Human-AI coordination
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于人机协作任务，旨在解决AI行为多样性与可操控性问题。提出MIMIC框架，通过语言引导实现行为精细控制。**

- **链接: [https://arxiv.org/pdf/2602.20517v1](https://arxiv.org/pdf/2602.20517v1)**
...
>
---
#### [new 054] RMIT-ADM+S at the MMU-RAG NeurIPS 2025 Competition
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文介绍RMIT-ADM+S系统，用于文本到文本任务，解决复杂研究任务的高效生成问题。提出R2RAG架构，动态调整检索策略，提升效果并节省资源。**

- **链接: [https://arxiv.org/pdf/2602.20735v1](https://arxiv.org/pdf/2602.20735v1)**
...
>
> **备注:** 34 pages. Project page: https://github.com/google-deepmind/superhuman/tree/main/aletheia
>
...
>
---
#### [new 056] VAUQ: Vision-Aware Uncertainty Quantification for LVLM Self-Evaluation
...
>
---
#### [new 057] Protein Language Models Diverge from Natural Language: Comparative Analysis and Improved Inference
- **分类: cs.LG; cs.AI; cs.CL; q-bio.BM**

- **简介: 该论文研究蛋白质语言模型与自然语言的差异，解决模型在蛋白质任务中的效率与准确性问题。通过对比分析和改进推理方法，提升非结构属性预测性能。**

- **链接: [https://arxiv.org/pdf/2602.20449v1](https://arxiv.org/pdf/2602.20449v1)**
...
>
---
#### [new 058] A Benchmark for Deep Information Synthesis
- **分类: cs.AI; cs.CL; cs.IR; cs.LG**

- **简介: 该论文提出DEEPSYNTH基准，用于评估语言模型在多源信息合成与推理任务中的表现，解决现有评测不足的问题。**

- **链接: [https://arxiv.org/pdf/2602.21143v1](https://arxiv.org/pdf/2602.21143v1)**
...
>
---
#### [replaced 003] INSURE-Dial: A Phase-Aware Conversational Dataset & Benchmark for Compliance Verification and Phase Detection
- **分类: cs.CL**

- **简介: 该论文提出INSURE-Dial，一个用于合规验证和阶段检测的对话数据集与基准，解决医疗电话任务中的自动化审计问题。**

- **链接: [https://arxiv.org/pdf/2602.18448v2](https://arxiv.org/pdf/2602.18448v2)**
...
>
---
#### [replaced 004] Anatomy of Capability Emergence: Scale-Invariant Representation Collapse and Top-Down Reorganization in Neural Networks
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究神经网络能力涌现的机制，分析了不同规模模型在多个任务中的表征演化，揭示了表征坍塌和自上而下重组现象，旨在理解能力形成的几何特征与边界条件。**

- **链接: [https://arxiv.org/pdf/2602.15997v3](https://arxiv.org/pdf/2602.15997v3)**

> **作者:** Jayadev Billa
>
> **备注:** 26 pages, 16 tables, 8 figures, 7 appendix pages. v3: Added causal freeze experiment, hidden learning probing analysis, bootstrap CIs, metric robustness ablation, and expanded discussion
>
...
>
---
#### [replaced 005] HoloLLM: Multisensory Foundation Model for Language-Grounded Human Sensing and Reasoning
...
>
---
#### [replaced 006] K-Function: Joint Pronunciation Transcription and Feedback for Evaluating Kids Language Function
...
>
---
#### [replaced 007] Everything is Plausible: Investigating the Impact of LLM Rationales on Human Notions of Plausibility
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文属于认知研究任务，探讨LLM生成的推理如何影响人类对常识答案的可信度判断。通过实验分析，发现人类和LLM的判断均受LLM推理的影响。**

- **链接: [https://arxiv.org/pdf/2510.08091v2](https://arxiv.org/pdf/2510.08091v2)**
...
>
---
#### [replaced 008] BabyLM Turns 4 and Goes Multilingual: Call for Papers for the 2026 BabyLM Workshop
- **分类: cs.CL**

- **简介: 该论文是关于BabyLM研讨会的征稿通知，旨在促进认知建模与语言模型预训练的结合。任务涉及多语言预训练，解决小数据集和高效训练问题，开展相关研究工作。**

- **链接: [https://arxiv.org/pdf/2602.20092v2](https://arxiv.org/pdf/2602.20092v2)**
...
>
---
#### [replaced 012] Intent Laundering: AI Safety Datasets Are Not What They Seem
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于AI安全领域，揭示现有安全数据集的缺陷。通过分析发现数据集过度依赖触发词，无法真实反映攻击行为。研究提出“意图洗白”方法，验证模型安全性不足。**

- **链接: [https://arxiv.org/pdf/2602.16729v2](https://arxiv.org/pdf/2602.16729v2)**
...
>
---
#### [replaced 013] Towards Scalable Oversight via Partitioned Human Supervision
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于AI监督任务，解决如何在缺乏真实标签情况下评估和训练AI系统的问题。通过互补标签构建可扩展的监督框架，实现高效AI训练与优化。**

- **链接: [https://arxiv.org/pdf/2510.22500v2](https://arxiv.org/pdf/2510.22500v2)**
...
>
---
#### [replaced 014] SWE-Master: Unleashing the Potential of Software Engineering Agents via Post-Training
- **分类: cs.SE; cs.CL**

- **简介: 该论文提出SWE-Master，一个用于提升软件工程代理性能的后训练框架，解决如何有效构建软件工程代理的问题。通过系统优化方法，提升其解决长期任务的能力。**

- **链接: [https://arxiv.org/pdf/2602.03411v2](https://arxiv.org/pdf/2602.03411v2)**

> **作者:** Huatong Song; Lisheng Huang; Shuang Sun; Jinhao Jiang; Ran Le; Daixuan Cheng; Guoxin Chen; Yiwen Hu; Zongchao Chen; Yiming Jia; Wayne Xin Zhao; Yang Song; Tao Zhang; Ji-Rong Wen
>
...
>
---
#### [replaced 015] Games That Teach, Chats That Convince: Comparing Interactive and Static Formats for Persuasive Learning
- **分类: cs.HC; cs.AI; cs.CL; cs.ET**

- **简介: 该论文属于人机交互与教育技术领域，比较互动与静态信息传递方式对学习和说服效果的影响。研究通过实验分析不同格式（文章、聊天机器人、文字游戏）在相同内容下的表现，揭示了主观体验与实际学习结果间的差异。**

- **链接: [https://arxiv.org/pdf/2602.17905v2](https://arxiv.org/pdf/2602.17905v2)**
...
>
---
#### [replaced 016] Understanding the Ability of LLMs to Handle Character-Level Perturbation
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，研究LLMs对字符级扰动的鲁棒性。通过引入拼写错误、字符乱序和不可见字符等扰动，分析LLMs如何保持性能，揭示其架构优势与潜在风险。**

- **链接: [https://arxiv.org/pdf/2510.14365v3](https://arxiv.org/pdf/2510.14365v3)**
...
>
---
#### [replaced 017] HSSBench: Benchmarking Humanities and Social Sciences Ability for Multimodal Large Language Models
...
>
---
#### [replaced 018] Towards Efficient Agents: A Co-Design of Inference Architecture and System
- **分类: cs.CL**

- **简介: 该论文属于人工智能任务，旨在解决大语言模型代理的效率问题。通过设计AgentInfer框架，优化推理架构与系统，提升代理在复杂任务中的执行效率。**

- **链接: [https://arxiv.org/pdf/2512.18337v2](https://arxiv.org/pdf/2512.18337v2)**
...
>
---
#### [replaced 019] Hearing the Order: Investigating Position Bias in Large Audio-Language Models
- **分类: cs.SD; cs.CL**
...
>
---
#### [replaced 020] Language Modeling and Understanding Through Paraphrase Generation and Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究语言模型的语义理解，通过分解 paraphrase 类型提升模型性能。任务是解决语义等价识别问题，工作包括提出分解方法并验证其在检测中的效果。**

- **链接: [https://arxiv.org/pdf/2602.08274v3](https://arxiv.org/pdf/2602.08274v3)**

> **作者:** Jan Philip Wahle
>
> **备注:** PhD Thesis (Dissertation), University of Göttingen Germany, 2025. 186 pages
>
...
>
---
#### [replaced 021] How Well Can LLM Agents Simulate End-User Security and Privacy Attitudes and Behaviors?
- **分类: cs.CY; cs.AI; cs.CL; cs.CR**

- **简介: 该论文属于安全与隐私研究任务，旨在评估LLM代理模拟用户安全态度和行为的能力。通过构建基准测试，分析不同模型和策略的表现，发现现有模型仍有提升空间。**

- **链接: [https://arxiv.org/pdf/2602.18464v2](https://arxiv.org/pdf/2602.18464v2)**
...
>
---
#### [replaced 022] Latent Thinking Optimization: Your Latent Reasoning Language Model Secretly Encodes Reward Signals in Its Latent Thoughts
- **分类: cs.CL**

- **简介: 该论文属于语言模型优化任务，旨在解决 latent thinking 可解释性与可靠性问题。通过构建潜在奖励模型，提升模型推理过程的准确性与效率。**

- **链接: [https://arxiv.org/pdf/2509.26314v3](https://arxiv.org/pdf/2509.26314v3)**
...
>
---
#### [replaced 023] A Parallel Cross-Lingual Benchmark for Multimodal Idiomaticity Understanding
- **分类: cs.CL**

- **简介: 该论文提出XMPIE，一个跨语言、多模态的潜在习语基准数据集，用于评估多语言和多模态习语理解能力，解决习语理解和文化迁移问题。**

- **链接: [https://arxiv.org/pdf/2601.08645v2](https://arxiv.org/pdf/2601.08645v2)**
...
>
---
#### [replaced 024] Nacrith: Neural Lossless Compression via Ensemble Context Modeling and High-Precision CDF Coding
- **分类: cs.IT; cs.CL**

- **简介: 该论文提出Nacrith，一种基于Transformer的无损压缩系统，解决自然语言文本压缩问题，通过改进CDF精度、预测模型和编码方式，实现高效压缩。**

- **链接: [https://arxiv.org/pdf/2602.19626v2](https://arxiv.org/pdf/2602.19626v2)**
...
>
---
#### [replaced 025] The Single-Multi Evolution Loop for Self-Improving Model Collaboration Systems
- **分类: cs.CL**

- **简介: 该论文研究模型协作系统，旨在提升效率并保留协作优势。通过知识蒸馏和进化循环，使模型自我优化，降低计算成本。**

- **链接: [https://arxiv.org/pdf/2602.05182v2](https://arxiv.org/pdf/2602.05182v2)**
...
>
---
#### [replaced 026] A Simple and Efficient Jailbreak Method Exploiting LLMs' Helpfulness
- **分类: cs.CR; cs.CL**

- **简介: 该论文属于安全漏洞研究任务，旨在解决LLMs在学习型查询下的安全问题。提出HILL方法，通过重构提问方式成功绕过安全机制，揭示了模型安全措施的缺陷。**

- **链接: [https://arxiv.org/pdf/2509.14297v2](https://arxiv.org/pdf/2509.14297v2)**
...
>
---
#### [replaced 029] What If We Allocate Test-Time Compute Adaptively?
- **分类: cs.CL**

- **简介: 该论文属于推理任务，解决测试阶段计算资源分配效率问题。提出一种基于验证器引导的自适应框架，通过动态调整推理路径提升性能。**

- **链接: [https://arxiv.org/pdf/2602.01070v3](https://arxiv.org/pdf/2602.01070v3)**
...
>
---
#### [replaced 035] Causal Claims in Economics
- **分类: econ.GN; cs.CL; cs.IR; cs.SI; stat.ME**

- **简介: 该论文属于自然语言处理任务，旨在解决经济论文中因果主张的结构化表示问题。通过构建证据标注的主张图，分析因果关系的演变及其对学术影响力的影响。**

- **链接: [https://arxiv.org/pdf/2501.06873v2](https://arxiv.org/pdf/2501.06873v2)**

> **作者:** Prashant Garg; Thiemo Fetzer
>
> **备注:** Data, code, prompts, and workflow documentation are publicly available at our GitHub repository: https://github.com/prashgarg/CausalClaimsInEconomics
>
> **摘要:** As economics scales, a key bottleneck is representing what papers claim in a comparable, aggregable form. We introduce evidence-annotated claim graphs that map each paper into a directed network of standardized economic concepts (nodes) and stated relationships (edges), with each edge labeled by evidentiary basis, including whether it is supported by causal inference designs or by non-causal evidence. Using a structured multi-stage AI workflow, we construct claim graphs for 44,852 economics papers from 1980-2023. The share of causal edges rises from 7.7% in 1990 to 31.7% in 2020. Measures of causal narrative structure and causal novelty are positively associated with top-five publication and long-run citations, whereas non-causal counterparts are weakly related or negative.
>
---
#### [replaced 036] Coupling Experts and Routers in Mixture-of-Experts via an Auxiliary Loss
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，解决MoE模型中路由器与专家不匹配的问题。提出ERC损失函数，增强路由器决策与专家能力的耦合，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2512.23447v2](https://arxiv.org/pdf/2512.23447v2)**
...
>
---
#### [replaced 041] Complexity-aware fine-tuning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于模型微调任务，旨在提升特定领域性能。通过熵值识别复杂数据，仅对复杂数据进行推理，减少数据使用量并提高效果。**

- **链接: [https://arxiv.org/pdf/2506.21220v4](https://arxiv.org/pdf/2506.21220v4)**
...
>
---
#### [replaced 042] Language Models use Lookbacks to Track Beliefs
- **分类: cs.CL**

- **简介: 该论文研究语言模型如何跟踪角色信念，属于理论心理（ToM）研究任务。解决LM如何表示与现实不同的信念问题，通过构建数据集并分析其lookback机制实现信念追踪。**

- **链接: [https://arxiv.org/pdf/2505.14685v3](https://arxiv.org/pdf/2505.14685v3)**
...
>
> **备注:** 38 pages, 50 figures. Code and data at https://belief.baulab.info/
>
...
>
---
#### [replaced 043] Should We Still Pretrain Encoders with Masked Language Modeling?
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，探讨MLM与CLM预训练方法的优劣。通过大量实验比较两者效果，提出混合训练策略以提升性能。**

- **链接: [https://arxiv.org/pdf/2507.00994v3](https://arxiv.org/pdf/2507.00994v3)**
...
>
---
#### [replaced 044] LUMI: Unsupervised Intent Clustering with Multiple Pseudo-Labels
- **分类: cs.CL; cs.IR**

- **简介: 该论文属于短文本聚类任务，解决传统方法标签单一和相似度处理不连续的问题。通过多伪标签增强文本相似性，提升聚类效果。**

- **链接: [https://arxiv.org/pdf/2510.14640v3](https://arxiv.org/pdf/2510.14640v3)**
...
>
---
#### [replaced 045] ATTS: Asynchronous Test-Time Scaling via Conformal Prediction
- **分类: cs.CL**

- **简介: 该论文提出ATTS框架，解决大语言模型测试时缩放的高延迟问题，通过异步推理和分类算法实现并行与串行缩放，提升效率并保持精度。**

- **链接: [https://arxiv.org/pdf/2509.15148v3](https://arxiv.org/pdf/2509.15148v3)**

> **作者:** Jing Xiong; Qiujiang Chen; Fanghua Ye; Zhongwei Wan; Chuanyang Zheng; Chenyang Zhao; Hui Shen; Hanbo Li; Chaofan Tao; Haochen Tan; Haoli Bai; Lifeng Shang; Lingpeng Kong; Ngai Wong
>
...
>
---
#### [replaced 046] LD-MoLE: Learnable Dynamic Routing for Mixture of LoRA Experts
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型优化任务，旨在解决传统MoE路由方法依赖人工调参和固定专家分配的问题。提出LD-MoLE，实现动态、自适应的专家分配机制。**

- **链接: [https://arxiv.org/pdf/2509.25684v2](https://arxiv.org/pdf/2509.25684v2)**
...
>
---
#### [replaced 047] UI-Venus-1.5 Technical Report
...
>
---
#### [replaced 048] EAMET: Robust Massive Model Editing via Embedding Alignment Optimization
- **分类: cs.CL**

- **简介: 该论文属于模型编辑任务，旨在解决大规模知识更新中嵌入对齐不足导致的编辑效果下降问题。通过优化关键与残差嵌入空间，提升编辑可靠性。**

- **链接: [https://arxiv.org/pdf/2505.11876v4](https://arxiv.org/pdf/2505.11876v4)**
...
>
---
#### [replaced 049] RooseBERT: A New Deal For Political Language Modelling
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出RooseBERT，用于政治话语分析。针对政治语言的特殊性，解决传统模型在政治辩论分析中的不足，通过领域预训练提升任务性能。**

- **链接: [https://arxiv.org/pdf/2508.03250v3](https://arxiv.org/pdf/2508.03250v3)**
...
>
---
#### [replaced 050] OckBench: Measuring the Efficiency of LLM Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决LLM在推理和编码中token效率低的问题。通过构建OckBench基准，同时评估模型的准确性和token效率，揭示现有模型效率未优化的现状。**

- **链接: [https://arxiv.org/pdf/2511.05722v2](https://arxiv.org/pdf/2511.05722v2)**
...
>
---
#### [replaced 051] Anatomy of Unlearning: The Dual Impact of Fact Salience and Model Fine-Tuning
- **分类: cs.CL**

- **简介: 该论文研究机器遗忘任务，解决模型遗忘不准确问题。提出DUAL基准，分析预训练与微调模型在遗忘中的差异，提升遗忘效果与稳定性。**

- **链接: [https://arxiv.org/pdf/2602.19612v2](https://arxiv.org/pdf/2602.19612v2)**
...
>
---
#### [replaced 052] What Matters For Safety Alignment?
- **分类: cs.CL; cs.AI; cs.CR**

- **简介: 该论文属于AI安全对齐研究，旨在评估影响大模型安全性的因素。通过实验分析模型特性与攻击方法，提出提升安全性的优化建议。**

- **链接: [https://arxiv.org/pdf/2601.03868v2](https://arxiv.org/pdf/2601.03868v2)**

> **作者:** Xing Li; Hui-Ling Zhen; Lihao Yin; Xianzhi Yu; Zhenhua Dong; Mingxuan Yuan
>
> **备注:** Added more commercial model results, majority voting scores, and theoretical analysis in v2
>
...
>
---
#### [replaced 053] TimeOmni-1: Incentivizing Complex Reasoning with Time Series in Large Language Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出TimeOmni-1模型，解决时间序列推理问题。针对现有数据和任务不足，构建TSR-Suite，包含多种推理任务，提升模型在因果发现和预测上的表现。**

- **链接: [https://arxiv.org/pdf/2509.24803v3](https://arxiv.org/pdf/2509.24803v3)**
