...
- **简介: 该论文针对腿式机器人状态估计中噪声协方差与运动学参数难以准确设定的问题，提出一种双层优化框架，在闭环估计中联合标定噪声协方差与运动学参数，提升状态估计精度与不确定性校准效果。**
...
- **简介: 该论文研究双阿克曼转向机器人的安全精准操控问题，提出基于Soft Actor-Critic的深度强化学习框架，结合HER与CrossQ提升避障与效率，实现无需专家示范的自主导航。**
...
- **简介: 该论文提出sqrtVINS，属视觉-惯性导航任务，旨在解决嵌入式系统中VINS的数值不稳定与效率低问题。作者设计基于Cholesky分解的平方根滤波器和快速动态初始化方法，提升稳定性与速度，实现在极端条件下的高效鲁棒运行。**
...
- **简介: 该论文研究自动驾驶中人机控制权交接问题，针对固定时间交接策略的不足，提出一种基于博弈论的自适应过渡框架。通过动态调整控制权，结合驾驶员轨迹跟踪能力，优化交接过程，提升稳定性并降低驾驶负荷。**
...
- **简介: 该论文提出ManiAgent，一种面向通用机器人操作的智能体框架，旨在解决VLA模型在复杂推理与长任务规划中的局限。通过多智能体协作实现环境感知、子任务分解与动作生成，显著提升操作成功率，并支持高效数据收集。**
...
- **简介: 该论文研究激光雷达里程计任务，旨在解决传统方法因子图误差累积导致轨迹抖动和注册退化的问题。提出FORM方法，采用固定滞后平滑与修复性建图，在单次迭代地图中实现高效、实时、高精度的位姿估计与地图优化。**
...
- **简介: 该论文提出Ctrl-World，一种可控制的生成式世界模型，用于机器人操作。旨在解决通用策略在新场景中评估与改进难的问题，通过多视角预测与精细动作控制，实现长时程一致的虚拟仿真，支持策略评估与训练数据增广。**
...
- **简介: 该论文研究未知环境中旋翼失效的四旋翼飞行控制。针对旋翼故障导致的失衡问题，提出融合故障检测与诊断的非线性模型预测控制器、感知优化规划器及专用硬件平台，实现复杂环境下的自主飞行。**
...
- **简介: 该论文研究四旋翼飞行器的精确控制问题，提出基于双四元数的非线性模型预测控制（DQ-NMPC）方法，解决其欠驱动、强耦合动力学带来的控制挑战，实现更优的轨迹跟踪性能和高动态飞行能力。**
...
- **简介: 该论文针对动态环境中机器人导航的适应性与语义理解问题，提出GRIP框架，融合网格化感知、共现感知规划与混合策略执行，提升长视野任务的成功率与路径效率，并实现仿真到现实的迁移。**
...
- **简介: 该论文研究自动驾驶安全决策问题，提出一种基于博弈论的风险感知强化学习框架GTR2L。通过建模交互行为与风险、动态调整预测时域和不确定性感知安全机制，提升复杂交通环境下的安全性与效率。**
...
- **简介: 该论文研究轮腿机器人混合运动控制任务，旨在解决复杂地形下运动适应性与能耗平衡问题。提出ATRos框架，基于强化学习实现无需预设步态的轮腿协同控制，提升地形适应性与能效，验证于仿真与实机实验。**
...
- **简介: 该论文研究双人形机器人交互运动控制，解决单机器人框架忽略交互动态导致动作不协调的问题。提出Harmanoid框架，通过接触感知重定向和交互驱动控制，实现真实、协调的双机器人全身互动运动模仿。**
...
- **链接: [http://arxiv.org/pdf/2510.09786v1](http://arxiv.org/pdf/2510.09786v1)**
...
- **简介: 该论文综述机器人触觉感知中的数据表示问题，旨在明确数据表示在感知流程中的作用，归纳了六种常用数据结构，分析硬件、表示形式与高层计算的关系，并提供根据任务、硬件和所需信息选择合适表示方法的指导。**
...
- **简介: 该论文研究仿真到真实环境的机器人操作策略迁移，旨在解决因物理参数不确定导致的迁移困难。提出Phys2Real方法，融合视觉语言模型先验与在线交互数据，实现动态参数估计与策略优化，提升复杂操作任务的成功率。**
...
- **链接: [http://arxiv.org/pdf/2510.11534v1](http://arxiv.org/pdf/2510.11534v1)**
...
- **简介: 该论文针对仿真学习中接触密集型策略在不同初始条件下性能方差大的问题，提出Refinery框架，通过贝叶斯优化微调和高斯混合模型采样，提升策略鲁棒性与成功率，并实现多步骤装配的可靠 chaining。**
...
- **简介: 该论文提出Real2USD系统，旨在将真实场景转换为通用场景描述（USD）语言，以支持LLM在机器人任务中的推理。工作包括利用四足机器人采集数据构建室内环境的USD表示，并结合Gemini实现场景理解与规划，验证了USD在多任务中的通用性。**
...
- **简介: 该论文研究机器人跟随人任务，解决动态密集环境中因遮挡导致的跟随困难。提出自适应轨迹采样方法和预测感知控制算法，生成社会合规轨迹并主动避障，提升跟随的平滑性、安全性与鲁棒性。**
...
- **简介: 该论文研究机器人操作中的表征学习任务，旨在从无标签多模态数据中自动发现分层操作概念。提出HiMaCon框架，结合跨模态相关性和多时间尺度预测，学习可迁移的操作原语，提升策略在复杂任务中的泛化能力。**
...
- **简介: 该论文提出并开发了一种面向深海自主的新型认知遥控框架DINOS-R，旨在解决传统AUV控制架构缺乏灵活性与智能性的问题。通过融合符号推理、机器学习与反应式行为，实现可解释、可复用且适应多平台的任务规划与执行，并在Sentry AUV上验证了其有效性。**
...
>
---
#### [new 066] LLM-HBT: Dynamic Behavior Tree Construction for Adaptive Coordination in Heterogeneous Robots
- **分类: cs.RO**

- **简介: 该论文提出LLM-HBT框架，解决异构多机器人系统在动态环境中适应性与鲁棒性不足的问题。通过大语言模型动态构建行为树，结合任务分配、故障检测与协同更新机制，实现高效协作。验证表明其在成功率与扩展性上优于基线方法。**

- **链接: [http://arxiv.org/pdf/2510.09963v1](http://arxiv.org/pdf/2510.09963v1)**
...
>
---
#### [new 067] Ego-Vision World Model for Humanoid Contact Planning
- **分类: cs.RO; cs.AI; cs.SY; eess.SY**

- **简介: 该论文研究人形机器人主动利用物理接触的规划任务，解决传统方法在接触复杂性和样本效率上的不足。提出结合学习世界模型与采样式MPC的框架，基于离线数据训练，在隐空间预测未来状态，实现高效多任务接触规划，并在真实机器人上验证。**

- **链接: [http://arxiv.org/pdf/2510.11682v1](http://arxiv.org/pdf/2510.11682v1)**
...
>
---
#### [new 068] A Faster and More Reliable Middleware for Autonomous Driving Systems
- **分类: cs.RO; cs.SY; eess.SY; C.3; D.4.1; D.4.4; D.4.8; I.2.9**

- **简介: 该论文针对自动驾驶系统中ROS 2中间件传输延迟高的问题，提出Sensor-in-Memory（SIM）共享内存传输方法。SIM通过零拷贝、锁-free双缓冲和数据新鲜优先机制，显著降低感知到控制的延迟，提升系统响应速度与安全性。**

- **链接: [http://arxiv.org/pdf/2510.11448v1](http://arxiv.org/pdf/2510.11448v1)**
...
>
---
#### [new 080] OmniSAT: Compact Action Token, Faster Auto Regression
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 084] DKPMV: Dense Keypoints Fusion from Multi-View RGB Frames for 6D Pose Estimation of Textureless Objects
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 085] Reinforcement Fine-Tuning of Flow-Matching Policies for Vision-Language-Action Models
- **分类: cs.LG; cs.RO**

- **简介: 该论文研究视觉-语言-动作（VLA）模型的强化微调，旨在解决传统策略梯度在流匹配模型中因策略比计算困难导致的不可行问题。提出Flow Policy Optimization（FPO）算法，实现高效稳定的在线强化学习微调。**

- **链接: [http://arxiv.org/pdf/2510.09976v1](http://arxiv.org/pdf/2510.09976v1)**
...
>
---
#### [new 086] REACT3D: Recovering Articulations for Interactive Physical 3D Scenes
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 087] MonoSE(3)-Diffusion: A Monocular SE(3) Diffusion Framework for Robust Camera-to-Robot Pose Estimation
- **分类: cs.CV; cs.RO**
...
#### [replaced 001] StarIO: A Lightweight Inertial Odometry for Nonlinear Motion
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2507.16121v2](http://arxiv.org/pdf/2507.16121v2)**

> **作者:** Shanshan Zhang; Siyue Wang; Qi Zhang Liqin Wu; Tianshui Wen; Ziheng Zhou; Xuemin Hong; Lingxiang Zheng; Yu Yang
>
...
>
---
#### [replaced 002] ASTREA: Introducing Agentic Intelligence for Orbital Thermal Autonomy
- **分类: cs.RO; cs.AI; cs.LG; cs.MA; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2509.13380v2](http://arxiv.org/pdf/2509.13380v2)**
...
>
---
#### [replaced 003] Product Digital Twin Supporting End-of-life Phase of Electric Vehicle Batteries Utilizing Product-Process-Resource Asset Network
- **分类: cs.RO; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2510.02167v2](http://arxiv.org/pdf/2510.02167v2)**
...
>
---
#### [replaced 006] Differentiable Particle Optimization for Fast Sequential Manipulation
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2510.07674v2](http://arxiv.org/pdf/2510.07674v2)**
...
>
---
#### [replaced 007] TTF-VLA: Temporal Token Fusion via Pixel-Attention Integration for Vision-Language-Action Models
...
>
---
#### [replaced 008] {S\textsuperscript{2}M\textsuperscript{2}}: Scalable Stereo Matching Model for Reliable Depth Estimation
...
>
---
#### [replaced 011] Policy Contrastive Decoding for Robotic Foundation Models
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2505.13255v3](http://arxiv.org/pdf/2505.13255v3)**
...
>
---
#### [replaced 012] Precise Mobile Manipulation of Small Everyday Objects
...
>
---
#### [replaced 013] VendiRL: A Framework for Self-Supervised Reinforcement Learning of Diversely Diverse Skills
- **分类: cs.LG; cs.AI; cs.RO**

- **链接: [http://arxiv.org/pdf/2509.02930v2](http://arxiv.org/pdf/2509.02930v2)**
...
>
---
#### [replaced 014] Accurate and Noise-Tolerant Extraction of Routine Logs in Robotic Process Automation (Extended Version)
- **分类: cs.RO; cs.SE**

- **链接: [http://arxiv.org/pdf/2510.08118v2](http://arxiv.org/pdf/2510.08118v2)**
...
>
---
#### [replaced 015] Efficient Navigation in Unknown Indoor Environments with Vision-Language Models
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2510.04991v2](http://arxiv.org/pdf/2510.04991v2)**
...
>
---
#### [replaced 016] DualTHOR: A Dual-Arm Humanoid Simulation Platform for Contingency-Aware Planning
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2506.16012v2](http://arxiv.org/pdf/2506.16012v2)**
...
>
---
#### [replaced 018] Guiding Energy-Efficient Locomotion through Impact Mitigation Rewards
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2510.09543v2](http://arxiv.org/pdf/2510.09543v2)**
...
>
---
#### [replaced 019] Data Scaling Laws in Imitation Learning for Robotic Manipulation
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2410.18647v3](http://arxiv.org/pdf/2410.18647v3)**
...
>
---
#### [replaced 020] Multi-Modal Manipulation via Multi-Modal Policy Consensus
- **分类: cs.RO; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.23468v2](http://arxiv.org/pdf/2509.23468v2)**
...
>
---
#### [replaced 021] MLLM-Fabric: Multimodal Large Language Model-Driven Robotic Framework for Fabric Sorting and Selection
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.04351v2](http://arxiv.org/pdf/2507.04351v2)**
...
>
---
#### [replaced 022] NaviMaster: Learning a Unified Policy for GUI and Embodied Navigation Tasks
- **分类: cs.RO; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.02046v2](http://arxiv.org/pdf/2508.02046v2)**
...
>
---
#### [replaced 023] Failure Prediction at Runtime for Generative Robot Policies
- **分类: cs.RO; cs.AI; cs.LG; I.2.6; I.2.8; I.2.9; I.2.10**

- **链接: [http://arxiv.org/pdf/2510.09459v2](http://arxiv.org/pdf/2510.09459v2)**
...
>
---
#### [replaced 024] DexGarmentLab: Dexterous Garment Manipulation Environment with Generalizable Policy
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 025] IONext: Unlocking the Next Era of Inertial Odometry
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 026] Motion Tracks: A Unified Representation for Human-Robot Transfer in Few-Shot Imitation Learning
- **分类: cs.RO; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2501.06994v2](http://arxiv.org/pdf/2501.06994v2)**

> **作者:** Juntao Ren; Priya Sundaresan; Dorsa Sadigh; Sanjiban Choudhury; Jeannette Bohg
>
> **摘要:** Teaching robots to autonomously complete everyday tasks remains a challenge. Imitation Learning (IL) is a powerful approach that imbues robots with skills via demonstrations, but is limited by the labor-intensive process of collecting teleoperated robot data. Human videos offer a scalable alternative, but it remains difficult to directly train IL policies from them due to the lack of robot action labels. To address this, we propose to represent actions as short-horizon 2D trajectories on an image. These actions, or motion tracks, capture the predicted direction of motion for either human hands or robot end-effectors. We instantiate an IL policy called Motion Track Policy (MT-pi) which receives image observations and outputs motion tracks as actions. By leveraging this unified, cross-embodiment action space, MT-pi completes tasks with high success given just minutes of human video and limited additional robot demonstrations. At test time, we predict motion tracks from two camera views, recovering 6DoF trajectories via multi-view synthesis. MT-pi achieves an average success rate of 86.5% across 4 real-world tasks, outperforming state-of-the-art IL baselines which do not leverage human data or our action space by 40%, and generalizes to scenarios seen only in human videos. Code and videos are available on our website https://portal-cornell.github.io/motion_track_policy/.
>
---
#### [replaced 027] Model Predictive Inferential Control of Neural State-Space Models for Autonomous Vehicle Motion Planning
- **分类: cs.RO; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2310.08045v5](http://arxiv.org/pdf/2310.08045v5)**
...
>
---
#### [replaced 028] PCHands: PCA-based Hand Pose Synergy Representation on Manipulators with N-DoF
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2508.07945v2](http://arxiv.org/pdf/2508.07945v2)**
...
>
---
#### [replaced 031] EROAS: 3D Efficient Reactive Obstacle Avoidance System for Autonomous Underwater Vehicles using 2.5D Forward-Looking Sonar
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2411.05516v2](http://arxiv.org/pdf/2411.05516v2)**

> **作者:** Pruthviraj Mane; Allen Jacob George; Rajini Makam; Subhash Gurikar; Rudrashis Majumder; Suresh Sundaram
>
> **备注:** Submitted to IEEE Journal of Ocean Engineering
>
...
>
---
#### [replaced 032] ORN-CBF: Learning Observation-conditioned Residual Neural Control Barrier Functions via Hypernetworks
- **分类: cs.RO; cs.LG; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2509.16614v2](http://arxiv.org/pdf/2509.16614v2)**
...
>
---
#### [replaced 033] Contrastive Representation Regularization for Vision-Language-Action Models
- **分类: cs.RO; cs.LG**

- **链接: [http://arxiv.org/pdf/2510.01711v2](http://arxiv.org/pdf/2510.01711v2)**
...
>
---
#### [replaced 034] Goal-Based Vision-Language Driving
...
>
---
#### [replaced 037] A Synthetic Dataset for Manometry Recognition in Robotic Applications
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [replaced 038] Holistic Evaluation of Multimodal LLMs on Spatial Intelligence
...
>
---
#### [replaced 039] Effect of Performance Feedback Timing on Motor Learning for a Surgical Training Task
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2508.17830v2](http://arxiv.org/pdf/2508.17830v2)**
...
>
---
#### [replaced 040] Robust and Safe Multi-Agent Reinforcement Learning with Communication for Autonomous Vehicles: From Simulation to Hardware
- **分类: cs.RO; cs.MA**

- **链接: [http://arxiv.org/pdf/2506.00982v2](http://arxiv.org/pdf/2506.00982v2)**
...
>
---
#### [replaced 041] HoMeR: Learning In-the-Wild Mobile Manipulation via Hybrid Imitation and Whole-Body Control
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2506.01185v2](http://arxiv.org/pdf/2506.01185v2)**
...
>
---
#### [replaced 043] Autonomous UAV Flight Navigation in Confined Spaces: A Reinforcement Learning Approach
- **分类: cs.RO; cs.AI; cs.LG; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2508.16807v2](http://arxiv.org/pdf/2508.16807v2)**
...
>
---
#### [replaced 045] TinyIO: Lightweight Reparameterized Inertial Odometry
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2507.15293v2](http://arxiv.org/pdf/2507.15293v2)**

> **作者:** Shanshan Zhang; Siyue Wang; Liqin Wu; Qi Zhang; Tianshui Wen; Ziheng Zhou; Ao Peng; Xuemin Hong; Lingxiang Zheng; Yu Yang
>
...
>
---
#### [replaced 046] RoHOI: Robustness Benchmark for Human-Object Interaction Detection
...
>
---
#### [replaced 050] SVN-ICP: Uncertainty Estimation of ICP-based LiDAR Odometry using Stein Variational Newton
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2509.08069v2](http://arxiv.org/pdf/2509.08069v2)**
...
>
---
#### [replaced 051] TriVLA: A Triple-System-Based Unified Vision-Language-Action Model with Episodic World Modeling for General Robot Control
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2507.01424v3](http://arxiv.org/pdf/2507.01424v3)**
