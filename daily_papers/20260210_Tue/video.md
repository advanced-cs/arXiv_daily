...
>
---
#### [new 003] VideoVeritas: AI-Generated Video Detection via Perception Pretext Reinforcement Learning
- **分类: cs.CV**

- **简介: 该论文属于视频检测任务，旨在解决AI生成视频的检测问题。通过引入感知预训练强化学习方法，提升检测性能。**

- **链接: [https://arxiv.org/pdf/2602.08828v1](https://arxiv.org/pdf/2602.08828v1)**
...
>
> **摘要:** The growing capability of video generation poses escalating security risks, making reliable detection increasingly essential. In this paper, we introduce VideoVeritas, a framework that integrates fine-grained perception and fact-based reasoning. We observe that while current multi-modal large language models (MLLMs) exhibit strong reasoning capacity, their granular perception ability remains limited. To mitigate this, we introduce Joint Preference Alignment and Perception Pretext Reinforcement Learning (PPRL). Specifically, rather than directly optimizing for detection task, we adopt general spatiotemporal grounding and self-supervised object counting in the RL stage, enhancing detection performance with simple perception pretext tasks. To facilitate robust evaluation, we further introduce MintVid, a light yet high-quality dataset containing 3K videos from 9 state-of-the-art generators, along with a real-world collected subset that has factual errors in content. Experimental results demonstrate that existing methods tend to bias towards either superficial reasoning or mechanical analysis, while VideoVeritas achieves more balanced performance across diverse benchmarks.
>
---
#### [new 004] Analysis of Converged 3D Gaussian Splatting Solutions: Density Effects and Prediction Limit
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究3D高斯溅射的结构特性，分析密度对参数的影响，提出密度感知策略以提升训练稳定性。任务为3D重建与渲染优化。**

- **链接: [https://arxiv.org/pdf/2602.08909v1](https://arxiv.org/pdf/2602.08909v1)**

> **作者:** Zhendong Wang; Cihan Ruan; Jingchuan Xiao; Chuqing Shi; Wei Jiang; Wei Wang; Wenjie Liu; Nam Ling
>
> **摘要:** We investigate what structure emerges in 3D Gaussian Splatting (3DGS) solutions from standard multi-view optimization. We term these Rendering-Optimal References (RORs) and analyze their statistical properties, revealing stable patterns: mixture-structured scales and bimodal radiance across diverse scenes. To understand what determines these parameters, we apply learnability probes by training predictors to reconstruct RORs from point clouds without rendering supervision. Our analysis uncovers fundamental density-stratification. Dense regions exhibit geometry-correlated parameters amenable to render-free prediction, while sparse regions show systematic failure across architectures. We formalize this through variance decomposition, demonstrating that visibility heterogeneity creates covariance-dominated coupling between geometric and appearance parameters in sparse regions. This reveals the dual character of RORs: geometric primitives where point clouds suffice, and view synthesis primitives where multi-view constraints are essential. We provide density-aware strategies that improve training robustness and discuss architectural implications for systems that adaptively balance feed-forward prediction and rendering-based refinement.
>
---
#### [new 005] Raster2Seq: Polygon Sequence Generation for Floorplan Reconstruction
- **分类: cs.CV**

- **简介: 该论文提出Raster2Seq，用于将位图楼层平面图转换为结构化矢量表示。解决复杂楼层平面生成问题，通过序列到序列模型生成带语义的多边形序列。**

- **链接: [https://arxiv.org/pdf/2602.09016v1](https://arxiv.org/pdf/2602.09016v1)**

> **作者:** Hao Phung; Hadar Averbuch-Elor
>
> **备注:** Code: https://anonymous.4open.science/r/Raster2Seq-BE73/
>
> **摘要:** Reconstructing a structured vector-graphics representation from a rasterized floorplan image is typically an important prerequisite for computational tasks involving floorplans such as automated understanding or CAD workflows. However, existing techniques struggle in faithfully generating the structure and semantics conveyed by complex floorplans that depict large indoor spaces with many rooms and a varying numbers of polygon corners. To this end, we propose Raster2Seq, framing floorplan reconstruction as a sequence-to-sequence task in which floorplan elements--such as rooms, windows, and doors--are represented as labeled polygon sequences that jointly encode geometry and semantics. Our approach introduces an autoregressive decoder that learns to predict the next corner conditioned on image features and previously generated corners using guidance from learnable anchors. These anchors represent spatial coordinates in image space, hence allowing for effectively directing the attention mechanism to focus on informative image regions. By embracing the autoregressive mechanism, our method offers flexibility in the output format, enabling for efficiently handling complex floorplans with numerous rooms and diverse polygon structures. Our method achieves state-of-the-art performance on standard benchmarks such as Structure3D, CubiCasa5K, and Raster2Graph, while also demonstrating strong generalization to more challenging datasets like WAFFLE, which contain diverse room structures and complex geometric variations.
>
---
#### [new 006] Fair Context Learning for Evidence-Balanced Test-Time Adaptation in Vision-Language Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视觉-语言模型的测试时适应任务，旨在解决分布偏移下的性能下降问题。提出FCL框架，通过公平性约束提升模型鲁棒性。**

- **链接: [https://arxiv.org/pdf/2602.07027v1](https://arxiv.org/pdf/2602.07027v1)**
...
>
---
#### [new 007] XAI-CLIP: ROI-Guided Perturbation Framework for Explainable Medical Image Segmentation in Multimodal Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分割任务，旨在提升模型的可解释性。针对现有XAI方法计算成本高、解释不准确的问题，提出XAI-CLIP框架，通过多模态嵌入引导区域扰动，提高分割精度与解释清晰度。**

- **链接: [https://arxiv.org/pdf/2602.07017v1](https://arxiv.org/pdf/2602.07017v1)**
...
>
---
#### [new 015] VFace: A Training-Free Approach for Diffusion-Based Video Face Swapping
- **分类: cs.CV**

- **简介: 该论文提出VFace，一种无需训练的视频人脸替换方法，解决视频中人脸替换的时序一致性和视觉质量问题。通过频谱注意力插值、目标结构引导和流引导时序平滑技术实现高质量替换。**

- **链接: [https://arxiv.org/pdf/2602.07835v1](https://arxiv.org/pdf/2602.07835v1)**
...
>
---
#### [new 016] WiFlow: A Lightweight WiFi-based Continuous Human Pose Estimation Network with Spatio-Temporal Feature Decoupling
- **分类: cs.CV**

- **简介: 该论文提出WiFlow，解决WiFi信号下连续人体姿态估计问题。通过编码器-解码器结构与时空特征解耦，提升精度并降低计算成本。**

- **链接: [https://arxiv.org/pdf/2602.08661v1](https://arxiv.org/pdf/2602.08661v1)**
...
>
---
#### [new 017] Deep Learning-Based Fixation Type Prediction for Quality Assurance in Digital Pathology
- **分类: cs.CV**

- **简介: 该论文属于数字病理学中的质量控制任务，旨在解决固定类型标注错误的问题。通过深度学习模型，利用低分辨率图像快速预测固定类型，提升检测效率与准确性。**

- **链接: [https://arxiv.org/pdf/2602.08652v1](https://arxiv.org/pdf/2602.08652v1)**
...
>
---
#### [new 023] GOT-Edit: Geometry-Aware Generic Object Tracking via Online Model Editing
- **分类: cs.CV; cs.AI; cs.LG; cs.MM; eess.IV**

- **简介: 该论文属于通用目标跟踪任务，旨在解决2D跟踪方法在遮挡和杂乱场景下性能不足的问题。通过引入几何感知的在线模型编辑方法，提升跟踪的鲁棒性与准确性。**

- **链接: [https://arxiv.org/pdf/2602.08550v1](https://arxiv.org/pdf/2602.08550v1)**
...
>
> **摘要:** Human perception for effective object tracking in a 2D video stream arises from the implicit use of prior 3D knowledge combined with semantic reasoning. In contrast, most generic object tracking (GOT) methods primarily rely on 2D features of the target and its surroundings while neglecting 3D geometric cues, which makes them susceptible to partial occlusion, distractors, and variations in geometry and appearance. To address this limitation, we introduce GOT-Edit, an online cross-modality model editing approach that integrates geometry-aware cues into a generic object tracker from a 2D video stream. Our approach leverages features from a pre-trained Visual Geometry Grounded Transformer to enable geometric cue inference from only a few 2D images. To tackle the challenge of seamlessly combining geometry and semantics, GOT-Edit performs online model editing with null-space constrained updates that incorporate geometric information while preserving semantic discrimination, yielding consistently better performance across diverse scenarios. Extensive experiments on multiple GOT benchmarks demonstrate that GOT-Edit achieves superior robustness and accuracy, particularly under occlusion and clutter, establishing a new paradigm for combining 2D semantics with 3D geometric reasoning for generic object tracking.
>
---
#### [new 024] SpatialReward: Bridging the Perception Gap in Online RL for Image Editing via Explicit Spatial Reasoning
- **分类: cs.CV**

- **简介: 该论文属于图像编辑任务，解决在线强化学习中奖励信号不足的问题。提出SpatialReward模型，通过显式空间推理提升评估准确性。**

- **链接: [https://arxiv.org/pdf/2602.07458v1](https://arxiv.org/pdf/2602.07458v1)**
...
>
---
#### [new 046] MAU-GPT: Enhancing Multi-type Industrial Anomaly Understanding via Anomaly-aware and Generalist Experts Adaptation
- **分类: cs.CV; cs.AI; eess.IV**

- **简介: 该论文聚焦工业异常检测任务，解决数据覆盖不足与模型泛化能力差的问题。构建了MAU-Set数据集，并提出MAU-GPT模型，提升多类型异常理解与推理能力。**

- **链接: [https://arxiv.org/pdf/2602.07011v1](https://arxiv.org/pdf/2602.07011v1)**
...
>
---
#### [new 055] Grow with the Flow: 4D Reconstruction of Growing Plants with Gaussian Flow Fields
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，解决植物生长过程的4D建模问题。提出高斯流场表示，模拟植物随时间变化的几何与外观，实现更精确的生长动态建模。**

- **链接: [https://arxiv.org/pdf/2602.08958v1](https://arxiv.org/pdf/2602.08958v1)**
...
>
> **摘要:** Modeling the time-varying 3D appearance of plants during their growth poses unique challenges: unlike many dynamic scenes, plants generate new geometry over time as they expand, branch, and differentiate. Recent motion modeling techniques are ill-suited to this problem setting. For example, deformation fields cannot introduce new geometry, and 4D Gaussian splatting constrains motion to a linear trajectory in space and time and cannot track the same set of Gaussians over time. Here, we introduce a 3D Gaussian flow field representation that models plant growth as a time-varying derivative over Gaussian parameters -- position, scale, orientation, color, and opacity -- enabling nonlinear and continuous-time growth dynamics. To initialize a sufficient set of Gaussian primitives, we reconstruct the mature plant and learn a process of reverse growth, effectively simulating the plant's developmental history in reverse. Our approach achieves superior image quality and geometric accuracy compared to prior methods on multi-view timelapse datasets of plant growth, providing a new approach for appearance modeling of growing 3D structures.
>
---
#### [new 056] WorldArena: A Unified Benchmark for Evaluating Perception and Functional Utility of Embodied World Models
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出WorldArena，一个统一的基准，用于评估具身世界模型的感知质量和功能实用性，解决当前评估碎片化问题，通过多维指标全面衡量模型性能。**

- **链接: [https://arxiv.org/pdf/2602.08971v1](https://arxiv.org/pdf/2602.08971v1)**
...
>
---
#### [new 059] CAE-AV: Improving Audio-Visual Learning via Cross-modal Interactive Enrichment
- **分类: cs.CV**

- **简介: 该论文属于音频-视觉学习任务，旨在解决模态不对齐问题。提出CAE-AV框架，通过两个模块缓解不对齐，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.08309v1](https://arxiv.org/pdf/2602.08309v1)**
...
>
---
#### [new 080] Modeling 3D Pedestrian-Vehicle Interactions for Vehicle-Conditioned Pose Forecasting
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于3D行人姿态预测任务，旨在解决自动驾驶中行人与车辆交互的准确预测问题。通过引入车辆信息和改进模型结构，提升预测精度。**

- **链接: [https://arxiv.org/pdf/2602.08962v1](https://arxiv.org/pdf/2602.08962v1)**
...
>
---
#### [new 090] MotionCrafter: Dense Geometry and Motion Reconstruction with a 4D VAE
- **分类: cs.CV; cs.AI; cs.CG; cs.LG**

- **简介: 论文提出MotionCrafter，用于从单目视频中联合重建4D几何和密集运动。解决的是单目视频的几何与运动重建问题，通过新型4D VAE提升重建质量。**

- **链接: [https://arxiv.org/pdf/2602.08961v1](https://arxiv.org/pdf/2602.08961v1)**
...
>
> **摘要:** We introduce MotionCrafter, a video diffusion-based framework that jointly reconstructs 4D geometry and estimates dense motion from a monocular video. The core of our method is a novel joint representation of dense 3D point maps and 3D scene flows in a shared coordinate system, and a novel 4D VAE to effectively learn this representation. Unlike prior work that forces the 3D value and latents to align strictly with RGB VAE latents-despite their fundamentally different distributions-we show that such alignment is unnecessary and leads to suboptimal performance. Instead, we introduce a new data normalization and VAE training strategy that better transfers diffusion priors and greatly improves reconstruction quality. Extensive experiments across multiple datasets demonstrate that MotionCrafter achieves state-of-the-art performance in both geometry reconstruction and dense scene flow estimation, delivering 38.64% and 25.0% improvements in geometry and motion reconstruction, respectively, all without any post-optimization. Project page: https://ruijiezhu94.github.io/MotionCrafter_Page
>
---
#### [new 091] Process-of-Thought Reasoning for Videos
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频理解任务，旨在解决视频中多步、时间定位的推理问题。提出PoT框架，通过结构化推理步骤提升准确性和可解释性。**

- **链接: [https://arxiv.org/pdf/2602.07689v1](https://arxiv.org/pdf/2602.07689v1)**
...
>
---
#### [new 092] Rolling Sink: Bridging Limited-Horizon Training and Open-Ended Testing in Autoregressive Video Diffusion
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决AR视频扩散模型在长视频测试时的视觉退化问题。通过提出Rolling Sink方法，在不增加训练成本的情况下提升长视频生成质量。**

- **链接: [https://arxiv.org/pdf/2602.07775v1](https://arxiv.org/pdf/2602.07775v1)**

> **作者:** Haodong Li; Shaoteng Liu; Zhe Lin; Manmohan Chandraker
>
> **备注:** Figure PDFs were compressed to 150 dpi to comply with arXiv's submission size limit. Project page: https://rolling-sink.github.io/
>
...
>
---
#### [new 093] MosaicThinker: On-Device Visual Spatial Reasoning for Embodied AI via Iterative Construction of Space Representation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉空间推理任务，旨在解决 embodied AI 在跨帧空间关系推理中的不足。通过构建全局语义地图增强小模型的推理能力。**

- **链接: [https://arxiv.org/pdf/2602.07082v1](https://arxiv.org/pdf/2602.07082v1)**
...
>
---
#### [new 094] FlashVID: Efficient Video Large Language Models via Training-free Tree-based Spatiotemporal Token Merging
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于视频理解任务，旨在解决VLLMs计算效率低的问题。通过引入FlashVID框架，实现无需训练的时空特征压缩，提升模型处理长视频的能力。**

- **链接: [https://arxiv.org/pdf/2602.08024v1](https://arxiv.org/pdf/2602.08024v1)**
...
>
---
#### [new 101] WorldEdit: Towards Open-World Image Editing with a Knowledge-Informed Benchmark
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像编辑任务，旨在解决隐式指令编辑难题。通过构建WorldEdit数据集和两阶段训练框架，提升模型对因果逻辑的理解与执行能力。**

- **链接: [https://arxiv.org/pdf/2602.07095v1](https://arxiv.org/pdf/2602.07095v1)**
...
>
---
#### [new 110] OneVision-Encoder: Codec-Aligned Sparsity as a Foundational Principle for Multimodal Intelligence
- **分类: cs.CV**

- **简介: 该论文提出OneVision-Encoder，解决视觉理解任务中的效率与精度矛盾问题。通过码率对齐的稀疏编码，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.08683v1](https://arxiv.org/pdf/2602.08683v1)**
...
>
---
#### [new 111] Picasso: Holistic Scene Reconstruction with Physics-Constrained Sampling
- **分类: cs.CV; cs.AI; cs.RO; eess.SY**

- **简介: 该论文属于场景重建任务，解决物体姿态与形状估计中的物理合理性问题。通过引入物理约束的采样方法，提升重建结果的物理可信度和一致性。**

- **链接: [https://arxiv.org/pdf/2602.08058v1](https://arxiv.org/pdf/2602.08058v1)**
...
>
---
#### [new 112] Semantic-Deviation-Anchored Multi-Branch Fusion for Unsupervised Anomaly Detection and Localization in Unstructured Conveyor-Belt Coal Scenes
- **分类: cs.CV**

- **简介: 该论文属于无监督异常检测与定位任务，针对煤场 conveyor-belt 场景中异物检测难题，提出多分支融合方法提升检测精度。**

- **链接: [https://arxiv.org/pdf/2602.07694v1](https://arxiv.org/pdf/2602.07694v1)**
...
>
---
#### [new 122] OMNI-Dent: Towards an Accessible and Explainable AI Framework for Automated Dental Diagnosis
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医疗诊断任务，旨在解决AI在牙科诊断中缺乏解释性和数据效率的问题。工作是提出OMNI-Dent框架，结合临床推理与视觉语言模型，实现无需专业微调的牙齿评估。**

- **链接: [https://arxiv.org/pdf/2602.07041v1](https://arxiv.org/pdf/2602.07041v1)**
...
>
---
#### [new 131] Addressing data annotation scarcity in Brain Tumor Segmentation on 3D MRI scan Using a Semi-Supervised Teacher-Student Framework
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于脑肿瘤分割任务，解决标注数据稀缺问题。提出半监督师生框架，通过不确定性伪标签和信心课程提升分割效果。**

- **链接: [https://arxiv.org/pdf/2602.08797v1](https://arxiv.org/pdf/2602.08797v1)**
...
>
---
#### [new 132] Revisiting [CLS] and Patch Token Interaction in Vision Transformers
- **分类: cs.CV**

- **简介: 该论文研究视觉Transformer中[CLS]令牌与补丁令牌的交互问题，旨在提升密集预测任务的性能。通过设计专门处理路径优化两者计算流程，提升补丁表示质量，同时保持分类准确率。**

- **链接: [https://arxiv.org/pdf/2602.08626v1](https://arxiv.org/pdf/2602.08626v1)**
...
>
---
#### [new 137] Learning Self-Correction in Vision-Language Models via Rollout Augmentation
- **分类: cs.CV; cs.CL; cs.LG**

- **简介: 该论文属于视觉语言模型的推理任务，解决自纠正学习困难的问题。通过提出Octopus框架，增强自纠正能力，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.08503v1](https://arxiv.org/pdf/2602.08503v1)**
...
>
---
#### [new 138] PhysDrape: Learning Explicit Forces and Collision Constraints for Physically Realistic Garment Draping
- **分类: cs.CV**

- **简介: 该论文属于服装布料模拟任务，旨在解决物理真实布料褶皱中的碰撞处理问题。通过结合神经网络与物理约束，实现更真实的布料模拟。**

- **链接: [https://arxiv.org/pdf/2602.08020v1](https://arxiv.org/pdf/2602.08020v1)**
...
>
---
#### [new 139] E-VAds: An E-commerce Short Videos Understanding Benchmark for MLLMs
- **分类: cs.CV**

- **简介: 该论文属于视频理解任务，旨在解决电商短视频中商业意图推理不足的问题。提出E-VAds基准和RL推理模型，提升电商视频理解性能。**

- **链接: [https://arxiv.org/pdf/2602.08355v1](https://arxiv.org/pdf/2602.08355v1)**
...
>
---
#### [new 140] PTB-XL-Image-17K: A Large-Scale Synthetic ECG Image Dataset with Comprehensive Ground Truth for Deep Learning-Based Digitization
- **分类: cs.CV**

- **简介: 该论文属于ECG图像数字化任务，旨在解决缺乏大规模带标注数据的问题。作者构建了PTB-XL-Image-17K数据集，包含17,271张合成ECG图像及多类型标注，支持信号提取与评估。**

- **链接: [https://arxiv.org/pdf/2602.07446v1](https://arxiv.org/pdf/2602.07446v1)**
...
>
---
#### [new 141] Thinking in Structures: Evaluating Spatial Intelligence through Reasoning on Constrained Manifolds
- **分类: cs.CV**

- **简介: 该论文提出SSI-Bench，用于评估视觉语言模型在受约束的三维结构上的空间推理能力，旨在解决现有基准过于宽松的问题。**

- **链接: [https://arxiv.org/pdf/2602.07864v1](https://arxiv.org/pdf/2602.07864v1)**
...
>
---
#### [new 156] Contactless estimation of continuum displacement and mechanical compressibility from image series using a deep learning based framework
- **分类: cs.CV**

- **简介: 该论文属于图像位移与材料压缩性估计任务，解决非接触式机械属性测量问题。通过深度学习框架，高效准确地从图像序列中估计位移和压缩性。**

- **链接: [https://arxiv.org/pdf/2602.07065v1](https://arxiv.org/pdf/2602.07065v1)**

> **作者:** A. N. Maria Antony; T. Richter; E. Gladilin
>
> **备注:** 14 Pages, 8 Figures Note: Supplentary information (ancillary file) attached as .pdf
>
> **摘要:** Contactless and non-invasive estimation of mechanical properties of physical media from optical observations is of interest for manifold engineering and biomedical applications, where direct physical measurements are not possible. Conventional approaches to the assessment of image displacement and non-contact material probing typically rely on time-consuming iterative algorithms for non-rigid image registration and constitutive modelling using discretization and iterative numerical solving techniques, such as Finite Element Method (FEM) and Finite Difference Method (FDM), which are not suitable for high-throughput data processing. Here, we present an efficient deep learning based end-to-end approach for the estimation of continuum displacement and material compressibility directly from the image series. Based on two deep neural networks for image registration and material compressibility estimation, this framework outperforms conventional approaches in terms of efficiency and accuracy. In particular, our experimental results show that the deep learning model trained on a set of reference data can accurately determine the material compressibility even in the presence of substantial local deviations of the mapping predicted by image registration from the reference displacement field. Our findings suggest that the remarkable accuracy of the deep learning end-to-end model originates from its ability to assess higher-order cognitive features, such as the vorticity of the vector field, rather than conventional local features of the image displacement.
>
---
#### [new 157] A Comparative Study of Adversarial Robustness in CNN and CNN-ANFIS Architectures
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像分类任务，研究CNN与CNN-ANFIS架构在对抗攻击下的鲁棒性。对比分析不同模型在多个数据集上的表现，探讨神经模糊增强对鲁棒性的效果。**

- **链接: [https://arxiv.org/pdf/2602.07028v1](https://arxiv.org/pdf/2602.07028v1)**

> **作者:** Kaaustaaub Shankar; Bharadwaj Dogga; Kelly Cohen
>
> **备注:** Accepted to NAFIPS 2026
>
> **摘要:** Convolutional Neural Networks (CNNs) achieve strong image classification performance but lack interpretability and are vulnerable to adversarial attacks. Neuro-fuzzy hybrids such as DCNFIS replace fully connected CNN classifiers with Adaptive Neuro-Fuzzy Inference Systems (ANFIS) to improve interpretability, yet their robustness remains underexplored. This work compares standard CNNs (ConvNet, VGG, ResNet18) with their ANFIS-augmented counterparts on MNIST, Fashion-MNIST, CIFAR-10, and CIFAR-100 under gradient-based (PGD) and gradient-free (Square) attacks. Results show that ANFIS integration does not consistently improve clean accuracy and has architecture-dependent effects on robustness: ResNet18-ANFIS exhibits improved adversarial robustness, while VGG-ANFIS often underperforms its baseline. These findings suggest that neuro-fuzzy augmentation can enhance robustness in specific architectures but is not universally beneficial.
>
---
#### [new 158] Shifting the Breaking Point of Flow Matching for Multi-Instance Editing
- **分类: cs.CV**

- **简介: 该论文属于图像编辑任务，旨在解决多实例编辑中语义干扰问题。通过引入实例解耦注意力机制，实现独立且局部的编辑。**

- **链接: [https://arxiv.org/pdf/2602.08749v1](https://arxiv.org/pdf/2602.08749v1)**
...
>
---
#### [new 163] Human Identification at a Distance: Challenges, Methods and Results on the Competition HID 2025
- **分类: cs.CV**

- **简介: 该论文属于人体远距离识别任务，解决传统生物特征难以获取的问题，通过分析HID 2025竞赛数据，探讨步态识别方法并提升识别准确率。**

- **链接: [https://arxiv.org/pdf/2602.07565v1](https://arxiv.org/pdf/2602.07565v1)**
...
>
---
#### [new 166] MUFASA: A Multi-Layer Framework for Slot Attention
- **分类: cs.CV**

- **简介: 该论文提出MUFASA框架，解决无监督对象分割任务中信息利用不充分的问题。通过多层特征融合，提升对象表示效果，改善分割性能。**

- **链接: [https://arxiv.org/pdf/2602.07544v1](https://arxiv.org/pdf/2602.07544v1)**

> **作者:** Sebastian Bock; Leonie Schüßler; Krishnakant Singh; Simone Schaub-Meyer; Stefan Roth
>
> **备注:** Authors Sebastian Bock and Leonie Schüßler contributed equally. Project page: https://leonieschuessler.github.io/mufasa/
>
> **摘要:** Unsupervised object-centric learning (OCL) decomposes visual scenes into distinct entities. Slot attention is a popular approach that represents individual objects as latent vectors, called slots. Current methods obtain these slot representations solely from the last layer of a pre-trained vision transformer (ViT), ignoring valuable, semantically rich information encoded across the other layers. To better utilize this latent semantic information, we introduce MUFASA, a lightweight plug-and-play framework for slot attention-based approaches to unsupervised object segmentation. Our model computes slot attention across multiple feature layers of the ViT encoder, fully leveraging their semantic richness. We propose a fusion strategy to aggregate slots obtained on multiple layers into a unified object-centric representation. Integrating MUFASA into existing OCL methods improves their segmentation results across multiple datasets, setting a new state of the art while simultaneously improving training convergence with only minor inference overhead.
>
---
#### [new 167] From Correspondence to Actions: Human-Like Multi-Image Spatial Reasoning in Multi-modal Large Language Models
- **分类: cs.CV**

- **简介: 该论文属于多图像空间推理任务，旨在解决多视图信息整合难题。提出HATCH框架，通过显式对齐和视角转换动作提升模型表现。**

- **链接: [https://arxiv.org/pdf/2602.08735v1](https://arxiv.org/pdf/2602.08735v1)**

> **作者:** Masanari Oi; Koki Maeda; Ryuto Koike; Daisuke Oba; Nakamasa Inoue; Naoaki Okazaki
>
> **摘要:** While multimodal large language models (MLLMs) have made substantial progress in single-image spatial reasoning, multi-image spatial reasoning, which requires integration of information from multiple viewpoints, remains challenging. Cognitive studies suggest that humans address such tasks through two mechanisms: cross-view correspondence, which identifies regions across different views that correspond to the same physical locations, and stepwise viewpoint transformation, which composes relative viewpoint changes sequentially. However, existing studies incorporate these mechanisms only partially and often implicitly, without explicit supervision for both. We propose Human-Aware Training for Cross-view correspondence and viewpoint cHange (HATCH), a training framework with two complementary objectives: (1) Patch-Level Spatial Alignment, which encourages patch representations to align across views for spatially corresponding regions, and (2) Action-then-Answer Reasoning, which requires the model to generate explicit viewpoint transition actions before predicting the final answer. Experiments on three benchmarks demonstrate that HATCH consistently outperforms baselines of comparable size by a clear margin and achieves competitive results against much larger models, while preserving single-image reasoning capabilities.
>
---
#### [new 168] Continuity-driven Synergistic Diffusion with Neural Priors for Ultra-Sparse-View CBCT Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于CBCT图像重建任务，旨在解决超稀疏视角下图像质量差的问题。通过引入神经先验和协同扩散策略，提升重建图像的连续性和一致性。**

- **链接: [https://arxiv.org/pdf/2602.07980v1](https://arxiv.org/pdf/2602.07980v1)**

> **作者:** Junlin Wang; Jiancheng Fang; Peng Peng; Shaoyu Wang; Qiegen Liu
>
> **摘要:** The clinical application of cone-beam computed tomography (CBCT) is constrained by the inherent trade-off between radiation exposure and image quality. Ultra-sparse angular sampling, employed to reduce dose, introduces severe undersampling artifacts and inter-slice inconsistencies, compromising diagnostic reliability. Existing reconstruction methods often struggle to balance angular continuity with spatial detail fidelity. To address these challenges, we propose a Continuity-driven Synergistic Diffusion with Neural priors (CSDN) for ultra-sparse-view CBCT reconstruction. Neural priors are introduced as a structural foundation to encode a continuous threedimensional attenuation representation, enabling the synthesis of physically consistent dense projections from ultra-sparse measurements. Building upon this neural-prior-based initialization, a synergistic diffusion strategy is developed, consisting of two collaborative refinement paths: a Sinogram Refinement Diffusion (Sino-RD) process that restores angular continuity and a Digital Radiography Refinement Diffusion (DR-RD) process that enforces inter-slice consistency from the projection image perspective. The outputs of the two diffusion paths are adaptively fused by the Dual-Projection Reconstruction Fusion (DPRF) module to achieve coherent volumetric reconstruction. Extensive experiments demonstrate that the proposed CSDN effectively suppresses artifacts and recovers fine textures under ultra-sparse-view conditions, outperforming existing state-of-the-art techniques.
>
---
#### [new 169] SynSacc: A Blender-to-V2E Pipeline for Synthetic Neuromorphic Eye-Movement Data and Sim-to-Real Spiking Model Training
- **分类: cs.CV**

- **简介: 该论文属于眼动分类任务，旨在解决传统相机运动模糊问题。通过Blender生成合成数据，训练SNN模型提升分类准确性与效率。**

- **链接: [https://arxiv.org/pdf/2602.08726v1](https://arxiv.org/pdf/2602.08726v1)**
...
>
---
#### [new 170] SoulX-FlashHead: Oracle-guided Generation of Infinite Real-time Streaming Talking Heads
- **分类: cs.CV**

- **简介: 该论文属于音频驱动的面部生成任务，旨在解决高保真与低延迟之间的平衡问题。提出SoulX-FlashHead框架，实现实时、无限长视频生成。**

- **链接: [https://arxiv.org/pdf/2602.07449v1](https://arxiv.org/pdf/2602.07449v1)**
...
>
> **摘要:** Despite rapid progress in Multimodal Large Language Models (MLLMs), visual spatial reasoning remains unreliable when correct answers depend on how a scene would appear under unseen or alternative viewpoints. Recent work addresses this by augmenting reasoning with world models for visual imagination, but questions such as when imagination is actually necessary, how much of it is beneficial, and when it becomes harmful, remain poorly understood. In practice, indiscriminate imagination can increase computation and even degrade performance by introducing misleading evidence. In this work, we present an in-depth analysis of test-time visual imagination as a controllable resource for spatial reasoning. We study when static visual evidence is sufficient, when imagination improves reasoning, and how excessive or unnecessary imagination affects accuracy and efficiency. To support this analysis, we introduce AVIC, an adaptive test-time framework with world models that explicitly reasons about the sufficiency of current visual evidence before selectively invoking and scaling visual imagination. Across spatial reasoning benchmarks (SAT, MMSI) and an embodied navigation benchmark (R2R), our results reveal clear scenarios where imagination is critical, marginal, or detrimental, and show that selective control can match or outperform fixed imagination strategies with substantially fewer world-model calls and language tokens. Overall, our findings highlight the importance of analyzing and controlling test-time imagination for efficient and reliable spatial reasoning.
>
---
#### [new 175] PISCO: Precise Video Instance Insertion with Sparse Control
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出PISCO，解决视频中精确实例插入任务，通过稀疏关键帧控制实现精准时空定位与场景一致性。**

- **链接: [https://arxiv.org/pdf/2602.08277v1](https://arxiv.org/pdf/2602.08277v1)**
...
>
---
#### [new 182] ViCA: Efficient Multimodal LLMs with Vision-Only Cross-Attention
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于多模态大模型任务，旨在解决视觉处理计算开销大的问题。提出ViCA架构，通过稀疏交叉注意力减少视觉计算，提升效率。**

- **链接: [https://arxiv.org/pdf/2602.07574v1](https://arxiv.org/pdf/2602.07574v1)**
...
>
---
#### [new 191] TeleBoost: A Systematic Alignment Framework for High-Fidelity, Controllable, and Robust Video Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频生成任务，旨在提升生成视频的准确性、连贯性和可控性。通过系统化后训练框架，解决长时序稳定性与反馈弱的问题。**

- **链接: [https://arxiv.org/pdf/2602.07595v1](https://arxiv.org/pdf/2602.07595v1)**
...
>
---
#### [new 198] Modality Gap-Driven Subspace Alignment Training Paradigm For Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.MM**

- **简介: 该论文属于多模态学习任务，旨在解决模态间隙问题。通过分析模态间隙几何特性，提出ReAlign和ReVision方法，实现高效对齐与模型扩展。**

- **链接: [https://arxiv.org/pdf/2602.07026v1](https://arxiv.org/pdf/2602.07026v1)**
...
>
> **摘要:** Despite the success of multimodal contrastive learning in aligning visual and linguistic representations, a persistent geometric anomaly, the Modality Gap, remains: embeddings of distinct modalities expressing identical semantics occupy systematically offset regions. Prior approaches to bridge this gap are largely limited by oversimplified isotropic assumptions, hindering their application in large-scale scenarios. In this paper, we address these limitations by precisely characterizing the geometric shape of the modality gap and leveraging it for efficient model scaling. First, we propose the Fixed-frame Modality Gap Theory, which decomposes the modality gap within a frozen reference frame into stable biases and anisotropic residuals. Guided by this precise modeling, we introduce ReAlign, a training-free modality alignment strategy. Utilizing statistics from massive unpaired data, ReAlign aligns text representation into the image representation distribution via a three-step process comprising Anchor, Trace, and Centroid Alignment, thereby explicitly rectifying geometric misalignment. Building on ReAlign, we propose ReVision, a scalable training paradigm for Multimodal Large Language Models (MLLMs). ReVision integrates ReAlign into the pretraining stage, enabling the model to learn the distribution of visual representations from unpaired text before visual instruction tuning, without the need for large-scale, high-quality image-text pairs. Our framework demonstrates that statistically aligned unpaired data can effectively substitute for expensive image-text pairs, offering a robust path for the efficient scaling of MLLMs.
>
---
#### [new 199] Fine-R1: Make Multi-modal LLMs Excel in Fine-Grained Visual Recognition by Chain-of-Thought Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对细粒度视觉识别任务，提出Fine-R1模型，通过思维链和三元组增强优化，提升多模态大语言模型的识别能力。**

- **链接: [https://arxiv.org/pdf/2602.07605v1](https://arxiv.org/pdf/2602.07605v1)**
...
>
---
#### [new 204] UrbanGraphEmbeddings: Learning and Evaluating Spatially Grounded Multimodal Embeddings for Urban Science
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出UGData和UGE，解决城市环境多模态嵌入对齐问题，通过空间结构增强城市理解任务性能。**

- **链接: [https://arxiv.org/pdf/2602.08342v1](https://arxiv.org/pdf/2602.08342v1)**

> **作者:** Jie Zhang; Xingtong Yu; Yuan Fang; Rudi Stouffs; Zdravko Trivic
>
> **摘要:** Learning transferable multimodal embeddings for urban environments is challenging because urban understanding is inherently spatial, yet existing datasets and benchmarks lack explicit alignment between street-view images and urban structure. We introduce UGData, a spatially grounded dataset that anchors street-view images to structured spatial graphs and provides graph-aligned supervision via spatial reasoning paths and spatial context captions, exposing distance, directionality, connectivity, and neighborhood context beyond image content. Building on UGData, we propose UGE, a two-stage training strategy that progressively and stably aligns images, text, and spatial structures by combining instruction-guided contrastive learning with graph-based spatial encoding. We finally introduce UGBench, a comprehensive benchmark to evaluate how spatially grounded embeddings support diverse urban understanding tasks -- including geolocation ranking, image retrieval, urban perception, and spatial grounding. We develop UGE on multiple state-of-the-art VLM backbones, including Qwen2-VL, Qwen2.5-VL, Phi-3-Vision, and LLaVA1.6-Mistral, and train fixed-dimensional spatial embeddings with LoRA tuning. UGE built upon Qwen2.5-VL-7B backbone achieves up to 44% improvement in image retrieval and 30% in geolocation ranking on training cities, and over 30% and 22% gains respectively on held-out cities, demonstrating the effectiveness of explicit spatial grounding for spatially intensive urban tasks.
>
---
#### [new 205] Guidestar-Free Adaptive Optics with Asymmetric Apertures
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于自适应光学任务，解决无引导星波前校正问题。通过非对称孔径和机器学习，实现无需引导星的实时波前传感与校正。**

- **链接: [https://arxiv.org/pdf/2602.07029v1](https://arxiv.org/pdf/2602.07029v1)**
...
>
---
#### [new 206] Prism: Spectral-Aware Block-Sparse Attention
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文属于自然语言处理任务，解决长序列注意力机制效率低的问题。通过分析粗粒度注意力的缺陷，提出Prism方法，提升块选择效率并保持精度。**

- **链接: [https://arxiv.org/pdf/2602.08426v1](https://arxiv.org/pdf/2602.08426v1)**
...
>
---
#### [new 217] Dexterous Manipulation Policies from RGB Human Videos via 4D Hand-Object Trajectory Reconstruction
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于机器人操作任务，解决多指机械手抓取与操作难题。通过RGB视频学习灵活操作策略，无需设备辅助，提升训练数据多样性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.09013v1](https://arxiv.org/pdf/2602.09013v1)**
...
>
> **摘要:** Foundation models, including Large Language Models (LLMs), Multimodal Large Language Models (MLLMs), Image Generative Models (i.e, Text-to-Image Models and Image-Editing Models), and Video Generative Models, have become essential tools with broad applications across various domains such as law, medicine, education, finance, science, and beyond. As these models see increasing real-world deployment, ensuring their reliability and responsibility has become critical for academia, industry, and government. This survey addresses the reliable and responsible development of foundation models. We explore critical issues, including bias and fairness, security and privacy, uncertainty, explainability, and distribution shift. Our research also covers model limitations, such as hallucinations, as well as methods like alignment and Artificial Intelligence-Generated Content (AIGC) detection. For each area, we review the current state of the field and outline concrete future research directions. Additionally, we discuss the intersections between these areas, highlighting their connections and shared challenges. We hope our survey fosters the development of foundation models that are not only powerful but also ethical, trustworthy, reliable, and socially responsible.
>
---
#### [new 226] Self-Supervised Bootstrapping of Action-Predictive Embodied Reasoning
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**

- **简介: 该论文属于视觉-语言-动作（VLA）模型任务，旨在解决传统方法依赖固定模板导致的推理效率低问题。提出R&B-EnCoRe框架，通过自监督方式提升动作预测的推理能力。**

- **链接: [https://arxiv.org/pdf/2602.08167v1](https://arxiv.org/pdf/2602.08167v1)**
...
>
---
#### [new 227] Exploring Polarimetric Properties Preservation during Reconstruction of PolSAR images using Complex-valued Convolutional Neural Networks
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于极化SAR图像重建任务，旨在解决复杂值数据处理问题，通过复数卷积自编码器实现极化特性保留的图像压缩与重建。**

- **链接: [https://arxiv.org/pdf/2602.07094v1](https://arxiv.org/pdf/2602.07094v1)**
...
>
---
#### [new 231] Do MLLMs Really See It: Reinforcing Visual Attention in Multimodal LLMs
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于多模态大语言模型任务，旨在解决视觉注意力不稳定问题。通过强化学习引入区域级视觉奖励，提升模型的视觉聚焦与推理能力。**

- **链接: [https://arxiv.org/pdf/2602.08241v1](https://arxiv.org/pdf/2602.08241v1)**

> **作者:** Siqu Ou; Tianrui Wan; Zhiyuan Zhao; Junyu Gao; Xuelong Li
>
> **摘要:** While chain-of-thought (CoT) reasoning has substantially improved multimodal large language models (MLLMs) on complex reasoning tasks, existing approaches largely rely on long textual reasoning trajectories and provide limited mechanisms for learning stable visual attention policies. Our analysis shows that current MLLMs exhibit weak visual focus: early-stage visual misalignment is rarely corrected during subsequent reasoning, leading to error propagation and failed inferences. We argue that this limitation stems from inadequate credit assignment for visual attention during training. To address this issue, we propose SAYO, a visual reasoning model trained with a reinforcement learning (RL) framework that introduces a region-level visual attention-based reward. This reward explicitly aligns optimization signals with visually grounded reasoning steps, enabling the model to learn more reliable attention behaviors. Extensive experiments across multiple multimodal benchmarks demonstrate that SAYO consistently improves performance on diverse reasoning and perception tasks.
>
---
#### [new 232] GEBench: Benchmarking Image Generation Models as GUI Environments
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于GUI生成任务，旨在解决现有基准在评估GUI状态转换和时间连贯性上的不足。提出GEBench基准及GE-Score指标，用于系统评估动态交互与时间一致性。**

- **链接: [https://arxiv.org/pdf/2602.09007v1](https://arxiv.org/pdf/2602.09007v1)**
...
>
> **摘要:** Multimodal Large Language Models (MLLMs) have significantly advanced embodied AI, and using them to benchmark robotic intelligence has become a pivotal trend. However, existing frameworks remain predominantly confined to single-arm manipulation, failing to capture the spatio-temporal coordination required for bimanual tasks like lifting a heavy pot. To address this, we introduce BiManiBench, a hierarchical benchmark evaluating MLLMs across three tiers: fundamental spatial reasoning, high-level action planning, and low-level end-effector control. Our framework isolates unique bimanual challenges, such as arm reachability and kinematic constraints, thereby distinguishing perceptual hallucinations from planning failures. Analysis of over 30 state-of-the-art models reveals that despite high-level reasoning proficiency, MLLMs struggle with dual-arm spatial grounding and control, frequently resulting in mutual interference and sequencing errors. These findings suggest the current paradigm lacks a deep understanding of mutual kinematic constraints, highlighting the need for future research to focus on inter-arm collision-avoidance and fine-grained temporal sequencing.
>
---
#### [new 238] Condition Errors Refinement in Autoregressive Image Generation with Diffusion Loss
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于图像生成任务，解决条件误差问题。通过理论分析和OT方法优化条件分布，提升生成稳定性与质量。**

- **链接: [https://arxiv.org/pdf/2602.07022v1](https://arxiv.org/pdf/2602.07022v1)**
...
>
---
#### [new 239] Dynamic Black-hole Emission Tomography with Physics-informed Neural Fields
- **分类: gr-qc; astro-ph.IM; cs.CV**

- **简介: 该论文属于动态三维黑洞成像任务，旨在解决稀疏观测下重建黑洞周围气体动态分布的问题。提出PI-DEF方法，结合物理约束与神经渲染，提升重建精度。**

- **链接: [https://arxiv.org/pdf/2602.08029v1](https://arxiv.org/pdf/2602.08029v1)**
...
>
---
#### [replaced 002] MetaCluster: Enabling Deep Compression of Kolmogorov-Arnold Network
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2510.19105v2](https://arxiv.org/pdf/2510.19105v2)**
...
>
---
#### [replaced 003] MOTION: ML-Assisted On-Device Low-Latency Motion Recognition
- **分类: cs.CV; cs.AI; cs.HC**

- **链接: [https://arxiv.org/pdf/2512.00008v3](https://arxiv.org/pdf/2512.00008v3)**
...
>
---
#### [replaced 018] CostNav: A Navigation Benchmark for Real-World Economic-Cost Evaluation of Physical AI Agents
- **分类: cs.AI; cs.CE; cs.CV; cs.LG; cs.RO**

- **简介: 该论文提出CostNav，一个评估物理AI代理经济成本的导航基准，解决真实世界商业可行性问题。通过整合实际数据，揭示现有导航方法在经济上不可行。**

- **链接: [https://arxiv.org/pdf/2511.20216v3](https://arxiv.org/pdf/2511.20216v3)**
...
>
---
#### [replaced 019] Virtual Community: An Open World for Humans, Robots, and Society
- **分类: cs.CV; cs.CL; cs.RO**

- **简介: 该论文提出Virtual Community平台，用于研究人与机器人在开放世界中的共存与协作。任务是解决人机社会互动中的高阶规划与低阶控制问题，通过构建仿真环境和挑战任务进行评估。**

- **链接: [https://arxiv.org/pdf/2508.14893v3](https://arxiv.org/pdf/2508.14893v3)**

> **作者:** Qinhong Zhou; Hongxin Zhang; Xiangye Lin; Zheyuan Zhang; Yutian Chen; Wenjun Liu; Zunzhe Zhang; Sunli Chen; Lixing Fang; Qiushi Lyu; Xinyu Sun; Jincheng Yang; Zeyuan Wang; Bao Chi Dang; Zhehuan Chen; Daksha Ladia; Quang Vinh Dang; Jiageng Liu; Chuang Gan
>
...
>
---
#### [replaced 020] Neural-Augmented Kelvinlet for Real-Time Soft Tissue Deformation Modeling
- **分类: cs.GR; cs.CV; cs.LG; cs.RO**

- **简介: 该论文属于手术仿真任务，解决软组织实时变形建模问题。通过融合物理先验与神经网络，提升预测准确性和物理合理性。**

- **链接: [https://arxiv.org/pdf/2506.08043v3](https://arxiv.org/pdf/2506.08043v3)**
...
>
---
#### [replaced 021] MomaGraph: State-Aware Unified Scene Graphs with Vision-Language Model for Embodied Task Planning
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出MomaGraph，解决家庭环境中移动操作机器人任务规划问题，构建统一场景图表示，整合空间与功能关系，并提供数据集和评估基准。**

- **链接: [https://arxiv.org/pdf/2512.16909v2](https://arxiv.org/pdf/2512.16909v2)**
...
>
---
#### [replaced 022] Building Egocentric Procedural AI Assistant: Methods, Benchmarks, and Challenges
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13261v2](https://arxiv.org/pdf/2511.13261v2)**
...
>
---
#### [replaced 023] Forest canopy height estimation from satellite RGB imagery using large-scale airborne LiDAR-derived training data and monocular depth estimation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.06503v2](https://arxiv.org/pdf/2602.06503v2)**
...
>
---
#### [replaced 024] Open-Set Domain Adaptation Under Background Distribution Shift: Challenges and A Provably Efficient Solution
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.01152v3](https://arxiv.org/pdf/2512.01152v3)**
...
>
---
#### [replaced 025] DeltaSpace: A Semantic-aligned Feature Space for Flexible Text-guided Image Editing
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2310.08785v3](https://arxiv.org/pdf/2310.08785v3)**
...
>
---
#### [replaced 026] UniReason 1.0: A Unified Reasoning Framework for World Knowledge Aligned Image Generation and Editing
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.02437v3](https://arxiv.org/pdf/2602.02437v3)**
...
>
---
#### [replaced 030] Differentially Private Adaptation of Diffusion Models via Noisy Aggregated Embeddings
- **分类: cs.CV; cs.CR; cs.LG**

- **链接: [https://arxiv.org/pdf/2411.14639v4](https://arxiv.org/pdf/2411.14639v4)**
...
>
---
#### [replaced 031] ImageRAG: Dynamic Image Retrieval for Reference-Guided Image Generation
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2502.09411v2](https://arxiv.org/pdf/2502.09411v2)**

> **作者:** Rotem Shalev-Arkushin; Rinon Gal; Amit H. Bermano; Ohad Fried
>
> **摘要:** Diffusion models enable high-quality and diverse visual content synthesis. However, they struggle to generate rare or unseen concepts. To address this challenge, we explore the usage of Retrieval-Augmented Generation (RAG) with image generation models. We propose ImageRAG, a method that dynamically retrieves relevant images based on a given text prompt, and uses them as context to guide the generation process. Prior approaches that used retrieved images to improve generation, trained models specifically for retrieval-based generation. In contrast, ImageRAG leverages the capabilities of existing image conditioning models, and does not require RAG-specific training. Our approach is highly adaptable and can be applied across different model types, showing significant improvement in generating rare and fine-grained concepts using different base models. Our project page is available at: https://rotem-shalev.github.io/ImageRAG
>
---
#### [replaced 032] Revisiting Transformers with Insights from Image Filtering and Boosting
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.10371v2](https://arxiv.org/pdf/2506.10371v2)**
...
>
---
#### [replaced 035] LatentLens: Revealing Highly Interpretable Visual Tokens in LLMs
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.00462v2](https://arxiv.org/pdf/2602.00462v2)**
...
>
---
#### [replaced 036] PALM: A Dataset and Baseline for Learning Multi-subject Hand Prior
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.05403v3](https://arxiv.org/pdf/2511.05403v3)**
...
>
---
#### [replaced 039] Approximating Signed Distance Fields With Sparse Ellipsoidal Radial Basis Function Networks: A Dynamic Multi-Objective Optimization Strategy
- **分类: cs.GR; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2505.02350v4](https://arxiv.org/pdf/2505.02350v4)**

> **作者:** Bobo Lian; Zidong Wang; Dandan Wang; Chenjian Wu; Minxin Chen
>
...
>
---
#### [replaced 040] Generalist Foundation Models from a Multimodal Dataset for 3D Computed Tomography
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2403.17834v5](https://arxiv.org/pdf/2403.17834v5)**
...
>
---
#### [replaced 041] Breaking Scale Anchoring: Frequency Representation Learning for Accurate High-Resolution Inference from Low-Resolution Training
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.05132v2](https://arxiv.org/pdf/2512.05132v2)**

> **作者:** Wenshuo Wang; Fan Zhang
>
> **备注:** Accepted as a poster paper at ICLR 2026
>
...
>
---
#### [replaced 042] Reproducible Benchmarking for Lung Nodule Detection and Malignancy Classification Across Multiple Low-Dose CT Datasets
- **分类: cs.CV; cs.AI; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2405.04605v5](https://arxiv.org/pdf/2405.04605v5)**
...
>
---
#### [replaced 046] RealSR-R1: Reinforcement Learning for Real-World Image Super-Resolution with Vision-Language Chain-of-Thought
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.16796v3](https://arxiv.org/pdf/2506.16796v3)**
...
>
---
#### [replaced 047] SIMSHIFT: A Benchmark for Adapting Neural Surrogates to Distribution Shifts
- **分类: cs.LG; cs.CV; physics.comp-ph**

- **链接: [https://arxiv.org/pdf/2506.12007v2](https://arxiv.org/pdf/2506.12007v2)**
...
>
---
#### [replaced 051] Generating metamers of human scene understanding
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.11675v2](https://arxiv.org/pdf/2601.11675v2)**
...
>
---
#### [replaced 052] Moonworks Lunara Aesthetic Dataset
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.07941v4](https://arxiv.org/pdf/2601.07941v4)**

> **作者:** Yan Wang; Sayeef Abdullah; Partho Hassan; Sabit Hassan
>
> **摘要:** The dataset spans diverse artistic styles, including regionally grounded aesthetics from the Middle East, Northern Europe, East Asia, and South Asia, alongside general categories such as sketch and oil painting. All images are generated using the Moonworks Lunara model and intentionally crafted to embody distinct, high-quality aesthetic styles, yielding a first-of-its-kind dataset with substantially higher aesthetic scores, exceeding even aesthetics-focused datasets, and general-purpose datasets by a larger margin. Each image is accompanied by a human-refined prompt and structured annotations that jointly describe salient objects, attributes, relationships, and stylistic cues. Unlike large-scale web-derived datasets that emphasize breadth over precision, the Lunara Aesthetic Dataset prioritizes aesthetic quality, stylistic diversity, and licensing transparency, and is released under the Apache 2.0 license to support research and unrestricted academic and commercial use.
>
---
#### [replaced 053] Sequential Attention-based Sampling for Histopathological Analysis
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.05077v4](https://arxiv.org/pdf/2507.05077v4)**

> **作者:** Tarun G; Naman Malpani; Gugan Thoppe; Sridharan Devarajan
>
> **备注:** Accepted at NeurIPS 2025. This version matches the camera-ready copy
>
> **摘要:** Deep neural networks are increasingly applied in automated histopathology. Yet, whole-slide images (WSIs) are often acquired at gigapixel sizes, rendering them computationally infeasible to analyze entirely at high resolution. Diagnostic labels are largely available only at the slide-level, because expert annotation of images at a finer (patch) level is both laborious and expensive. Moreover, regions with diagnostic information typically occupy only a small fraction of the WSI, making it inefficient to examine the entire slide at full resolution. Here, we propose SASHA -- Sequential Attention-based Sampling for Histopathological Analysis -- a deep reinforcement learning approach for efficient analysis of histopathological images. First, SASHA learns informative features with a lightweight hierarchical, attention-based multiple instance learning (MIL) model. Second, SASHA samples intelligently and zooms selectively into a small fraction (10-20\%) of high-resolution patches to achieve reliable diagnoses. We show that SASHA matches state-of-the-art methods that analyze the WSI fully at high resolution, albeit at a fraction of their computational and memory costs. In addition, it significantly outperforms competing, sparse sampling methods. We propose SASHA as an intelligent sampling model for medical imaging challenges that involve automated diagnosis with exceptionally large images containing sparsely informative features. Model implementation is available at: https://github.com/coglabiisc/SASHA.
>
---
#### [replaced 054] OmniHD-Scenes: A Next-Generation Multimodal Dataset for Autonomous Driving
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.10734v5](https://arxiv.org/pdf/2412.10734v5)**
...
>
---
#### [replaced 055] Residual Vector Quantization For Communication-Efficient Multi-Agent Perception
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于多智能体协同感知任务，解决通信带宽限制问题。提出ReVQom方法，通过残差向量量化压缩特征，降低传输负载，提升通信效率。**

- **链接: [https://arxiv.org/pdf/2509.21464v2](https://arxiv.org/pdf/2509.21464v2)**

> **作者:** Dereje Shenkut; B. V. K Vijaya Kumar
>
> **备注:** Accepted at ICASSP 2026. 5 pages
>
...
>
---
#### [replaced 056] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.10152v2](https://arxiv.org/pdf/2510.10152v2)**

> **作者:** Yecong Wan; Mingwen Shao; Renlong Wu; Wangmeng Zuo
>
> **备注:** ICLR 2026 Project Page https://yecongwan.github.io/Color3D/
>
...
>
---
#### [replaced 062] ManiVID-3D: Generalizable View-Invariant Reinforcement Learning for Robotic Manipulation via Disentangled 3D Representations
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于机器人操作任务，解决视觉强化学习在视角变化下的泛化问题。通过学习视图不变的3D表示，提升策略在不同视角下的鲁棒性。**

- **链接: [https://arxiv.org/pdf/2509.11125v2](https://arxiv.org/pdf/2509.11125v2)**
...
>
---
#### [replaced 063] Cognitive Edge Device (CED) for Real-Time Environmental Monitoring in Aquatic Ecosystems
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2401.06157v3](https://arxiv.org/pdf/2401.06157v3)**
...
>
> **备注:** Accepted by Nature Reviews Methods Primers
>
...
>
---
#### [replaced 068] Can NeRFs See without Cameras?
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2505.22441v3](https://arxiv.org/pdf/2505.22441v3)**
...
>
---
#### [replaced 069] FlashKAT: Understanding and Addressing Performance Bottlenecks in the Kolmogorov-Arnold Transformer
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2505.13813v3](https://arxiv.org/pdf/2505.13813v3)**
...
>
---
#### [replaced 070] Robust Image Stitching with Optimal Plane
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.05903v2](https://arxiv.org/pdf/2508.05903v2)**
...
>
---
#### [replaced 071] Through the Perspective of LiDAR: A Feature-Enriched and Uncertainty-Aware Annotation Pipeline for Terrestrial Point Cloud Segmentation
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于点云语义分割任务，解决人工标注成本高的问题。提出一种融合特征和不确定性的半自动标注流程，构建了Mangrove3D数据集，并分析了数据效率与特征重要性。**

- **链接: [https://arxiv.org/pdf/2510.06582v3](https://arxiv.org/pdf/2510.06582v3)**
...
>
---
#### [replaced 072] GTAvatar: Bridging Gaussian Splatting and Texture Mapping for Relightable and Editable Gaussian Avatars
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2512.09162v2](https://arxiv.org/pdf/2512.09162v2)**

> **作者:** Kelian Baert; Mae Younes; Francois Bourel; Marc Christie; Adnane Boukhayma
>
> **备注:** Eurographics 2026 Project page: https://kelianb.github.io/GTAvatar/
>
...
>
---
#### [replaced 073] Paper Copilot: Tracking the Evolution of Peer Review in AI Conferences
- **分类: cs.CV; cs.AI; cs.DL; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.13201v2](https://arxiv.org/pdf/2510.13201v2)**

> **作者:** Jing Yang; Qiyao Wei; Jiaxin Pei
>
> **备注:** ICLR 2026. https://papercopilot.com/
>
...
>
---
#### [replaced 074] BEAT: Visual Backdoor Attacks on VLM-based Embodied Agents via Contrastive Trigger Learning
- **分类: cs.AI; cs.CL; cs.CV**

- **简介: 该论文研究视觉后门攻击问题，针对基于VLM的具身智能体提出BEAT框架，通过对比触发学习实现高效攻击，提升攻击成功率并保持正常任务性能。**

- **链接: [https://arxiv.org/pdf/2510.27623v2](https://arxiv.org/pdf/2510.27623v2)**
...
>
---
#### [replaced 075] EgoLife: Towards Egocentric Life Assistant
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.03803v3](https://arxiv.org/pdf/2503.03803v3)**
...
>
> **备注:** This version corrects the author affiliation to reflect the accurate institutional information at the time of publication. No technical content of the paper has been changed
>
...
>
---
#### [replaced 081] VisionReasoner: Unified Reasoning-Integrated Visual Perception via Reinforcement Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.12081v5](https://arxiv.org/pdf/2505.12081v5)**
...
>
---
#### [replaced 082] Benchmarking Large Language Models for Geolocating Colonial Virginia Land Grants
- **分类: cs.LG; cs.AI; cs.CL; cs.CV; cs.IR**

- **简介: 论文属于历史地理信息提取任务，旨在将殖民时期弗吉尼亚土地特许状转化为地理坐标。通过测试大语言模型，评估其在准确性和成本效益上的表现。**

- **链接: [https://arxiv.org/pdf/2508.08266v2](https://arxiv.org/pdf/2508.08266v2)**
...
>
---
#### [replaced 083] GrndCtrl: Grounding World Models via Self-Supervised Reward Alignment
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**

- **简介: 该论文属于视觉导航任务，解决世界模型缺乏几何接地的问题。通过自监督奖励对齐方法GrndCtrl，提升模型的空间一致性和导航稳定性。**

- **链接: [https://arxiv.org/pdf/2512.01952v2](https://arxiv.org/pdf/2512.01952v2)**
...
>
---
#### [replaced 084] A Survey on Class-Agnostic Counting: Advancements from Reference-Based to Open-World Text-Guided Approaches
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2501.19184v4](https://arxiv.org/pdf/2501.19184v4)**
...
>
> **备注:** Preprint version of an article accepted ad Elsevier's CVIU
>
...
>
---
#### [replaced 085] ComfyBench: Benchmarking LLM-based Agents in ComfyUI for Autonomously Designing Collaborative AI Systems
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 该论文提出ComfyBench，用于评估LLM代理自主设计协作AI系统的能力，解决自主构建复杂AI系统的问题。**

- **链接: [https://arxiv.org/pdf/2409.01392v3](https://arxiv.org/pdf/2409.01392v3)**
...
>
---
#### [replaced 086] On Geometry-Enhanced Parameter-Efficient Fine-Tuning for 3D Scene Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.22444v3](https://arxiv.org/pdf/2505.22444v3)**
...
>
---
#### [replaced 087] Constructing the Umwelt: Cognitive Planning through Belief-Intent Co-Evolution
- **分类: cs.CV; cs.AI; cs.LG; cs.NE; cs.RO**

- **简介: 该论文属于自主驾驶任务，旨在解决高精度环境重建依赖问题。提出MBCWM架构，通过信念与意图协同进化实现认知规划，提升系统自主性与适应性。**

- **链接: [https://arxiv.org/pdf/2511.05540v3](https://arxiv.org/pdf/2511.05540v3)**

> **作者:** Shiyao Sang
>
> **备注:** 12 pages, 8 figures. A paradigm shift from reconstructing the world to understanding it: planning through Belief-Intent Co-Evolution
>
...
>
---
#### [replaced 088] Q-Hawkeye: Reliable Visual Policy Optimization for Image Quality Assessment
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.22920v2](https://arxiv.org/pdf/2601.22920v2)**
...
>
---
#### [replaced 091] G2P: Gaussian-to-Point Attribute Alignment for Boundary-Aware 3D Semantic Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.03510v2](https://arxiv.org/pdf/2601.03510v2)**
...
>
---
#### [replaced 093] WeTok: Powerful Discrete Tokenization for High-Fidelity Visual Reconstruction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.05599v3](https://arxiv.org/pdf/2508.05599v3)**

> **作者:** Shaobin Zhuang; Yiwei Guo; Canmiao Fu; Zhipeng Huang; Zeyue Tian; Xiaohui Li; Fangyikang Wang; Ying Zhang; Chen Li; Yali Wang
>
> **备注:** 32 pages, 15 figures, 39 tables
>
...
>
---
#### [replaced 098] GO-MLVTON: Garment Occlusion-Aware Multi-Layer Virtual Try-On with Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.13524v3](https://arxiv.org/pdf/2601.13524v3)**
...
>
---
#### [replaced 099] PAL-Net: A Point-Wise CNN with Patch-Attention for 3D Facial Landmark Localization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.00910v2](https://arxiv.org/pdf/2510.00910v2)**
...
>
> **备注:** Published in Informatics in Medicine Unlocked. Code available at: https://github.com/Ali5hadman/PAL-Net-A-Point-Wise-CNN-with-Patch-Attention
>
...
>
---
#### [replaced 102] SpecPrune-VLA: Accelerating Vision-Language-Action Models via Action-Aware Self-Speculative Pruning
- **分类: cs.CV; cs.AI; cs.RO**

- **简介: 该论文属于视觉-语言-动作模型加速任务，解决现有方法忽略全局上下文导致性能下降的问题。提出SpecPrune-VLA，通过两级剪枝提升推理速度。**

- **链接: [https://arxiv.org/pdf/2509.05614v2](https://arxiv.org/pdf/2509.05614v2)**
...
>
---
#### [replaced 103] ReasonEdit: Editing Vision-Language Models using Human Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.02408v3](https://arxiv.org/pdf/2602.02408v3)**
...
>
---
#### [replaced 104] DiGAN: Diffusion-Guided Attention Network for Early Alzheimer's Disease Detection
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.03881v2](https://arxiv.org/pdf/2602.03881v2)**
...
>
---
#### [replaced 108] Task-Conditioned Probing Reveals Brain-Alignment Patterns in Instruction-Tuned Multimodal LLMs
- **分类: q-bio.NC; cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文研究IT-MLLMs在任务条件下的脑对齐模式，旨在解决指令微调是否影响模型与大脑活动的对齐问题。通过fMRI数据评估模型表现，发现IT模型在任务相关表示上优于其他模型。**

- **链接: [https://arxiv.org/pdf/2506.08277v2](https://arxiv.org/pdf/2506.08277v2)**
...
>
---
#### [replaced 117] SegQuant: A Semantics-Aware and Generalizable Quantization Framework for Diffusion Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.14811v5](https://arxiv.org/pdf/2507.14811v5)**
...
>
---
#### [replaced 118] Vision-Centric 4D Occupancy Forecasting and Planning via Implicit Residual World Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.16729v3](https://arxiv.org/pdf/2510.16729v3)**
...
>
---
#### [replaced 119] HyPlaneHead: Rethinking Tri-plane-like Representations in Full-Head Image Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.16748v2](https://arxiv.org/pdf/2509.16748v2)**

> **作者:** Heyuan Li; Kenkun Liu; Lingteng Qiu; Qi Zuo; Keru Zheng; Zilong Dong; Xiaoguang Han
>
> **备注:** Accepted by NeurIPS 2025. Project page: https://lhyfst.github.io/hyplanehead/
>
...
>
---
#### [replaced 120] Explainable Cross-Disease Reasoning for Cardiovascular Risk Assessment from Low-Dose Computed Tomography
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.06625v4](https://arxiv.org/pdf/2511.06625v4)**
...
>
---
#### [replaced 121] Towards Spatio-Temporal Extrapolation of Phase-Field Simulations with Convolution-Only Neural Networks
- **分类: cs.CE; cs.AI; cs.CV; cs.LG; math.NA**

- **链接: [https://arxiv.org/pdf/2601.04510v2](https://arxiv.org/pdf/2601.04510v2)**
...
>
---
#### [replaced 122] You Only Pose Once: A Minimalist's Detection Transformer for Monocular RGB Category-level 9D Multi-Object Pose Estimation
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出YOPO方法，解决单目RGB图像中多目标类别级9D位姿估计问题，通过统一检测与位姿估计实现高效端到端训练。**

- **链接: [https://arxiv.org/pdf/2508.14965v2](https://arxiv.org/pdf/2508.14965v2)**
...
>
---
#### [replaced 123] Towards Effective and Efficient Context-aware Nucleus Detection in Histopathology Whole Slide Images
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2503.05678v2](https://arxiv.org/pdf/2503.05678v2)**

> **作者:** Zhongyi Shui; Honglin Li; Yunlong Zhang; Yuxuan Sun; Yiwen Ye; Pingyi Chen; Ruizhe Guo; Lei Cui; Chenglu Zhu; Lin Yang
>
...
>
---
#### [replaced 124] Improving Efficiency of Diffusion Models via Multi-Stage Framework and Tailored Multi-Decoder Architectures
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2312.09181v4](https://arxiv.org/pdf/2312.09181v4)**

> **作者:** Huijie Zhang; Yifu Lu; Ismail Alkhouri; Saiprasad Ravishankar; Dogyoon Song; Qing Qu
>
> **备注:** The IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR) 2024
>
> **摘要:** Diffusion models, emerging as powerful deep generative tools, excel in various applications. They operate through a two-steps process: introducing noise into training samples and then employing a model to convert random noise into new samples (e.g., images). However, their remarkable generative performance is hindered by slow training and sampling. This is due to the necessity of tracking extensive forward and reverse diffusion trajectories, and employing a large model with numerous parameters across multiple timesteps (i.e., noise levels). To tackle these challenges, we present a multi-stage framework inspired by our empirical findings. These observations indicate the advantages of employing distinct parameters tailored to each timestep while retaining universal parameters shared across all time steps. Our approach involves segmenting the time interval into multiple stages where we employ custom multi-decoder U-net architecture that blends time-dependent models with a universally shared encoder. Our framework enables the efficient distribution of computational resources and mitigates inter-stage interference, which substantially improves training efficiency. Extensive numerical experiments affirm the effectiveness of our framework, showcasing significant training and sampling efficiency enhancements on three state-of-the-art diffusion models, including large-scale latent diffusion models. Furthermore, our ablation studies illustrate the impact of two important components in our framework: (i) a novel timestep clustering algorithm for stage division, and (ii) an innovative multi-decoder U-net architecture, seamlessly integrating universal and customized hyperparameters.
>
---
#### [replaced 125] Shallow Diffuse: Robust and Invisible Watermarking through Low-Dimensional Subspaces in Diffusion Models
- **分类: cs.LG; cs.CR; cs.CV**

- **链接: [https://arxiv.org/pdf/2410.21088v4](https://arxiv.org/pdf/2410.21088v4)**
...
>
---
#### [replaced 126] MACD: Model-Aware Contrastive Decoding via Counterfactual Data
- **分类: cs.AI; cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.01740v2](https://arxiv.org/pdf/2602.01740v2)**
...
>
---
#### [replaced 127] CAF-Mamba: Mamba-Based Cross-Modal Adaptive Attention Fusion for Multimodal Depression Detection
- **分类: cs.CV; cs.CY; cs.HC**

- **链接: [https://arxiv.org/pdf/2601.21648v2](https://arxiv.org/pdf/2601.21648v2)**
...
>
---
#### [replaced 137] Simultaneous Tactile-Visual Perception for Learning Multimodal Robot Manipulation
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于机器人操作任务，旨在解决多模态感知与学习框架整合难题。提出TacThru传感器和TacThru-UMI框架，实现精准、适应性强的机器人操作。**

- **链接: [https://arxiv.org/pdf/2512.09851v2](https://arxiv.org/pdf/2512.09851v2)**
...
>
---
#### [replaced 138] Targetless LiDAR-Camera Calibration with Neural Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.04597v3](https://arxiv.org/pdf/2504.04597v3)**

> **作者:** Haebeom Jung; Namtae Kim; Jungwoo Kim; Jaesik Park
>
> **备注:** IEEE RA-L 2026. Project page: https://zang09.github.io/tlc-calib-site
>
