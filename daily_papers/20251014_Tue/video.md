...
- **简介: 该论文研究3D物体指代定位任务，旨在通过自然语言描述精确定位3D场景中的目标物体。针对现有方法仅建模两两关系、忽略多物体间高阶关联的问题，提出从二元到N元关系的渐进式学习框架B2N3D，引入分组监督损失和多模态网络，提升复杂语义下的定位精度。**
...
- **简介: 该论文属船舶感知任务，旨在提升内河航道的海上态势感知能力。针对AIS系统易受合作性限制的问题，提出融合高分辨率卫星图像与AIS轨迹数据的框架，采用YOLOv11模型实现船舶类型、数量、状态等多特征识别，并验证了方法在检测暗船与跨区域应用中的有效性。**
...
- **简介: 该论文提出AndesVL，一种面向移动端的多模态大语言模型，解决云基模型因规模大难以部署在边缘设备的问题。基于Qwen3架构，设计0.6B至4B参数的高效模型，在多种视觉-语言任务中实现与同规模模型相当或更优性能。**
...
- **简介: 该论文提出CerS-Path系统，旨在提升宫颈病理诊断的准确性和泛化能力。通过自监督预训练和多模态增强，构建宫颈特异性模型，支持八项诊断功能，显著提升罕见癌分类与临床适用性。**
...
- **简介: 该论文研究图像质量评估任务，旨在解决基于推理的强化学习模型虽性能好但耗能高、延迟大的问题。提出RALI算法，通过对比学习直接对齐图像与文本表征，去除推理过程和大模型依赖，在降低95%开销的同时保持良好泛化能力。**
...
- **简介: 该论文聚焦多语言视觉-语言模型的跨模态对齐任务，旨在解决现有方法忽视嵌入空间全局拓扑结构的问题。作者提出ToMCLIP框架，引入基于持续同调的拓扑对齐损失，提升多语言表征的结构一致性与下游性能。**
...
- **简介: 该论文属于视频目标分割任务，旨在提升复杂真实场景下的长时序分割鲁棒性与泛化能力。工作包括组织LSVOS 2025挑战赛，推出新赛道MOSEv2以评估密集小物体、遮挡、消失重现实景，采用J&Ḟ指标，并总结基于LLM/MLLM和记忆传播的前沿方法。**
...
- **简介: 该论文针对TIPS术后预后预测难题，提出多中心数据集MultiTIPS和多模态框架，解决传统方法在标注负担、泛化性及单终点评估上的局限，实现生存、并发症和门脉压力的综合预测。**
...
- **简介: 该论文研究单视图下无类别限制的物体6D位姿、尺寸与形状联合估计，旨在摆脱对模板或CAD模型的依赖。作者提出统一框架，融合2D视觉特征与3D点云，通过改进Transformer和并行解码器实现实时、高精度预测，并在多数据集上验证了卓越的零样本泛化能力。**
...
- **链接: [http://arxiv.org/pdf/2510.11417v1](http://arxiv.org/pdf/2510.11417v1)**
...
- **简介: 该论文研究视觉定位任务，旨在通过文本描述定位图像中的目标物体。为解决现有方法计算开销大、依赖迭代的问题，提出简单高效的新基线FSVG，引入基于相似度的特征选择机制，直接融合语言与视觉模态，提升效率与精度。**
...
- **简介: 该论文针对多模态大模型在细粒度视觉问答中易产生幻觉的问题，提出一种类人检索增强生成框架HuLiRAG。通过“什么—哪里—重加权”级联策略，结合开放词汇检测、SAM掩码与自适应重加权，提升视觉定位与推理一致性，增强生成可信度。**
...
- **简介: 该论文研究实时高分辨率图像增强，旨在兼顾性能与效率。提出LLF-LUT++网络，结合拉普拉斯金字塔、3D LUT与局部滤波，在提升画质的同时实现快速推理，4K图像处理仅需13ms。**
...
- **简介: 该论文研究沙特手语（SSL）翻译任务，旨在解决SSL数据少导致模型性能低的问题。作者构建新数据集，探索在T5模型上利用美国手语（ASL）数据预训练以提升SSL翻译效果，实验证明跨语言迁移显著提高性能。**
...
- **简介: 该论文针对稀疏航拍图像中正射镶嵌图生成的难题，提出Ortho-Fuse框架。通过中间光流估计合成过渡图像，增加特征匹配，降低对图像重叠率的要求，提升作物健康图的重建质量。**
...
- **简介: 该论文针对多模态大模型在强化学习中推理链与答案不一致的问题，提出答案一致性强化学习（ACRE）。通过打乱选项并校验前后答案一致性，增强模型推理连贯性，在视频与数学推理任务上优于GRPO基线。**
...
- **简介: 该论文聚焦深伪视频的视觉真实感评估任务，旨在模拟人类对深伪真实性的主观感知。提出DREAM基准，包含多质量深伪视频数据集、大规模人类标注的真实感评分与文本描述，并评测16种方法，推动深伪真实感自动评估研究。**
...
- **简介: 该论文研究医学图像分割任务，旨在解决边缘模糊和背景噪声导致的分割不准确问题。提出EEMS模型，通过边缘增强、多尺度提示生成与自适应门控融合机制，提升分割精度与鲁棒性。**
...
- **简介: 该论文研究图像分割任务，旨在解决模型依赖虚假相关性导致的泛化问题。作者提出一种人机协同框架，利用人类反馈作为干预信号，纠正模型错误，推动其学习语义特征，提升跨域鲁棒性和数据效率。**
...
- **简介: 该论文研究杂草分类任务，旨在解决标注数据稀缺下的精准识别问题。提出一种结合一致性正则化与相似性学习的深度半监督方法，利用少量标注和大量未标注数据，提升模型性能与鲁棒性。**
...
- **简介: 该论文针对3D胸部CT多标签异常分类任务，解决现有方法难以捕捉长距离依赖和泛化性差的问题。提出一种2.5D图学习框架，将CT切片三元组构图为结构图，利用谱图卷积建模层间依赖，在多个数据集上实现良好泛化。**
...
- **简介: 该论文研究无人机影像中的荔枝果实检测任务，旨在解决小目标、遮挡和模型轻量化问题。提出YOLOv11-Litchi模型，引入多尺度残差模块、轻量特征融合和遮挡检测头，提升检测精度与效率，适用于复杂果园环境的精准农业应用。**
...
- **简介: 该论文聚焦于基于2D图像的反射建模，旨在提升高斯点阵化中的材质推断准确性。通过多视角一致性材质推理与光线追踪环境建模，解决了光照混叠与间接光照问题，实现了更真实的渲染效果。**
...
- **简介: 该论文提出Vlaser，旨在解决视觉-语言模型推理与具身动作控制间的鸿沟。通过构建Vlaser-6M数据集，实现高阶推理与低阶控制的协同，提升具身智能体在空间推理、任务规划等任务中的表现，并优化VLM到VLA的迁移效果。**
...
- **简介: 该论文属于医学图像分析任务，旨在自动检测和分割脑肿瘤。通过比较逻辑回归、CNN、ResNet等分类模型，并采用U-Net和EfficientDet进行分割与检测，提升MRI肿瘤识别的准确性和效率。**
...
- **链接: [http://arxiv.org/pdf/2510.10993v1](http://arxiv.org/pdf/2510.10993v1)**
...
>
---
#### [new 067] DocReward: A Document Reward Model for Structuring and Stylizing
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文提出DocReward，旨在解决现有文档生成代理忽视视觉结构与风格的问题。通过构建含11.7万对文档的多领域数据集DocPair，训练能评估文档结构与风格质量的奖励模型，显著优于GPT-4o和GPT-5，在生成任务中更有效引导生成专业化文档。**

- **链接: [http://arxiv.org/pdf/2510.11391v1](http://arxiv.org/pdf/2510.11391v1)**
...
>
---
#### [new 068] Are Video Models Emerging as Zero-Shot Learners and Reasoners in Medical Imaging?
- **分类: cs.CV**

- **简介: 该论文研究通用视频大模型在未接触医学数据的情况下，能否零样本迁移至医学图像任务。作者将其应用于器官分割、去噪、超分辨和运动预测，验证了其在无微调情况下仍具强泛化能力，尤其在4D CT运动预测中表现优异，揭示了视频模型作为医学基础模型的潜力。**

- **链接: [http://arxiv.org/pdf/2510.10254v1](http://arxiv.org/pdf/2510.10254v1)**
...
>
---
#### [new 069] SaFiRe: Saccade-Fixation Reiteration with Mamba for Referring Image Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究指代表达图像分割（RIS），旨在解决复杂语境下的指代歧义问题。针对现有方法局限于简单表达式，提出SaFiRe框架，模拟人类先全局理解后细节精炼的认知过程，结合Mamba模型实现高效多轮优化，并构建新基准aRefCOCO验证方法有效性。**

- **链接: [http://arxiv.org/pdf/2510.10160v1](http://arxiv.org/pdf/2510.10160v1)**
...
>
---
#### [new 070] Q-Adapter: Visual Query Adapter for Extracting Textually-related Features in Video Captioning
- **分类: cs.CV**

- **简介: 该论文针对视频描述生成任务，解决大规模多模态模型微调效率低的问题。提出Q-Adapter，通过在视觉编码器中引入可学习查询令牌和门控机制，实现高效参数微调，提升文本相关特征提取能力，在少参数下达到先进性能。**

- **链接: [http://arxiv.org/pdf/2510.10022v1](http://arxiv.org/pdf/2510.10022v1)**
...
>
---
#### [new 071] Semi-disentangled spatiotemporal implicit neural representations of longitudinal neuroimaging data for trajectory classification
- **分类: cs.CV**

- **简介: 该论文针对纵向脑成像数据离散采样导致的建模难题，提出一种半解耦时空隐式神经表示方法，将个体MRI数据建模为连续函数，实现全脑衰老轨迹分类，显著提升不规则采样下的分类准确率。**

- **链接: [http://arxiv.org/pdf/2510.09936v1](http://arxiv.org/pdf/2510.09936v1)**
...
>
---
#### [new 074] Ordinal Scale Traffic Congestion Classification with Multi-Modal Vision-Language and Motion Analysis
- **分类: cs.CV**

- **简介: 该论文研究交通拥堵等级分类任务，旨在解决现有方法难以兼顾语义理解与动态变化的问题。作者提出多模态框架，融合视觉语言推理、目标检测与运动分析，实现1至5级有序分类，并提升准确率与可解释性。**

- **链接: [http://arxiv.org/pdf/2510.10342v1](http://arxiv.org/pdf/2510.10342v1)**
...
>
---
#### [new 075] FACE: Faithful Automatic Concept Extraction
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于可解释AI任务，旨在解决自动概念提取方法与模型决策不一致的问题。作者提出FACE框架，结合NMF与KL散度正则化，引入分类器监督，提升概念解释的忠实性，并验证了其在多个数据集上的优越性。**

- **链接: [http://arxiv.org/pdf/2510.11675v1](http://arxiv.org/pdf/2510.11675v1)**
...
>
> **摘要:** A key challenge in ischemic stroke diagnosis using medical imaging is the accurate localization of the occluded vessel. Current machine learning methods in focus primarily on lesion segmentation, with limited work on vessel localization. In this study, we introduce Stroke Locus Net, an end-to-end deep learning pipeline for detection, segmentation, and occluded vessel localization using only MRI scans. The proposed system combines a segmentation branch using nnUNet for lesion detection with an arterial atlas for vessel mapping and identification, and a generation branch using pGAN to synthesize MRA images from MRI. Our implementation demonstrates promising results in localizing occluded vessels on stroke-affected T1 MRI scans, with potential for faster and more informed stroke diagnosis.
>
---
#### [new 079] Scalable Face Security Vision Foundation Model for Deepfake, Diffusion, and Spoofing Detection
- **分类: cs.CV; cs.AI; I.4.10; I.2.10; I.5.0**

- **简介: 该论文聚焦人脸安全任务，旨在提升模型在深伪、扩散生成和伪造检测中的泛化能力。提出自监督预训练框架FS-VFM，通过3C学习目标联合建模局部模式与全局语义，并设计轻量适配器FS-Adapter实现高效迁移。**

- **链接: [http://arxiv.org/pdf/2510.10663v1](http://arxiv.org/pdf/2510.10663v1)**
...
>
> **摘要:** Multimodal Large Language Models (MLLMs) hold promise for accelerating scientific discovery by interpreting complex experimental procedures. However, their true capabilities are poorly understood, as existing benchmarks neglect the fine-grained and long-horizon nature of authentic laboratory work, especially in wet-lab settings. To bridge this gap, we introduce ExpVid, the first benchmark designed to systematically evaluate MLLMs on scientific experiment videos. Curated from peer-reviewed video publications, ExpVid features a new three-level task hierarchy that mirrors the scientific process: (1) Fine-grained Perception of tools, materials, and actions; (2) Procedural Understanding of step order and completeness; and (3) Scientific Reasoning that connects the full experiment to its published conclusions. Our vision-centric annotation pipeline, combining automated generation with multi-disciplinary expert validation, ensures that tasks require visual grounding. We evaluate 19 leading MLLMs on ExpVid and find that while they excel at coarse-grained recognition, they struggle with disambiguating fine details, tracking state changes over time, and linking experimental procedures to scientific outcomes. Our results reveal a notable performance gap between proprietary and open-source models, particularly in high-order reasoning. ExpVid not only provides a diagnostic tool but also charts a roadmap for developing MLLMs capable of becoming trustworthy partners in scientific experimentation.
>
---
#### [new 084] DreamMakeup: Face Makeup Customization using Latent Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文提出DreamMakeup，属虚拟化妆定制任务，旨在解决现有方法在可控性、定制化和身份保持上的不足。作者基于扩散模型，利用早期停止的DDIM反演，实现无需训练的高保真化妆编辑，支持图像、颜色和文本等多种条件输入。**

- **链接: [http://arxiv.org/pdf/2510.10918v1](http://arxiv.org/pdf/2510.10918v1)**
...
>
---
#### [new 087] CoPRS: Learning Positional Prior from Chain-of-Thought for Reasoning Segmentation
- **分类: cs.CV; cs.MM**

- **简介: 该论文研究指代表达的推理分割任务，旨在提升模型的可解释性与语义精度。提出CoPRS模型，通过多模态思维链生成可学习的热图作为位置先验，建立语言推理与分割的清晰关联，实现更精准、可诊断的掩码生成。**

- **链接: [http://arxiv.org/pdf/2510.11173v1](http://arxiv.org/pdf/2510.11173v1)**
...
>
---
#### [new 088] Task-Aware Resolution Optimization for Visual Large Language Models
- **分类: cs.CV; cs.CL**

- **简介: 该论文针对视觉大语言模型（VLLM）在不同任务中分辨率固定的局限，研究任务对分辨率的需求，提出结合图像复杂度与模型不确定性的分辨率选择公式，并设计高效微调方法适配最优分辨率，提升多任务性能。**

- **链接: [http://arxiv.org/pdf/2510.09822v1](http://arxiv.org/pdf/2510.09822v1)**
...
>
---
#### [new 089] Towards Fast and Scalable Normal Integration using Continuous Components
- **分类: cs.CV**

- **简介: 该论文研究表面法向积分任务，旨在高效重建大尺寸深度图。为解决现有方法计算慢的问题，提出将法向积分转化为连续组件的相对尺度估计，通过减少优化变量并设计组件合并策略，实现快速、可扩展的深度恢复，显著提升速度与规模适应性。**

- **链接: [http://arxiv.org/pdf/2510.11508v1](http://arxiv.org/pdf/2510.11508v1)**
...
>
---
#### [new 105] NV3D: Leveraging Spatial Shape Through Normal Vector-based 3D Object Detection
- **分类: cs.CV; cs.AI; cs.LG; I.2.6; I.2.9; I.2.10; I.4.8; I.4.10; I.5.1; I.5.4**

- **简介: 该论文研究自动驾驶中的3D物体检测任务，旨在解决多模态方法特征对齐难和局部特征提取不足的问题。提出NV3D模型，利用体素邻域的法向量特征增强空间形状表达，引入两种采样策略减少计算量，并通过注意力机制融合特征，在KITTI数据集上显著提升检测性能。**

- **链接: [http://arxiv.org/pdf/2510.11632v1](http://arxiv.org/pdf/2510.11632v1)**
...
>
---
#### [new 106] Massive Activations are the Key to Local Detail Synthesis in Diffusion Transformers
- **分类: cs.CV**

- **简介: 该论文研究扩散Transformer（DiT）中的大规模激活（MAs），揭示其对局部细节生成的关键作用。提出无需训练的细节引导（DG）方法，通过破坏MAs构建退化模型，提升细节保真度，可与分类器无关引导结合，显著增强DiT的细粒度生成质量。**

- **链接: [http://arxiv.org/pdf/2510.11538v1](http://arxiv.org/pdf/2510.11538v1)**
...
>
---
#### [new 109] Denoising Diffusion as a New Framework for Underwater Images
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对水下图像质量差、现有数据集多样性不足的问题，提出基于去噪扩散模型扩展数据集，并结合ControlNet提升图像质量，以改善海洋生态系统研究中的图像增强效果。**

- **链接: [http://arxiv.org/pdf/2510.09934v1](http://arxiv.org/pdf/2510.09934v1)**
...
>
---
#### [new 112] When Images Speak Louder: Mitigating Language Bias-induced Hallucinations in VLMs through Cross-Modal Guidance
- **分类: cs.CV**

- **简介: 该论文针对视觉-语言模型（VLM）因语言偏见导致的幻觉问题，提出一种无需训练的跨模态引导（CMG）解码方法，通过削弱图像-语言注意力来增强视觉感知，有效缓解幻觉，提升模型在多模态理解任务中的准确性。**

- **链接: [http://arxiv.org/pdf/2510.10466v1](http://arxiv.org/pdf/2510.10466v1)**
...
>
---
#### [new 113] From Detection to Mitigation: Addressing Bias in Deep Learning Models for Chest X-Ray Diagnosis
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对胸片诊断中深度学习模型的性别、年龄和种族偏见问题，提出一种检测与缓解框架。通过将CNN末层替换为XGBoost分类器，提升公平性并保持性能，方法通用且高效，结合主动学习进一步降低偏见。**

- **链接: [http://arxiv.org/pdf/2510.10822v1](http://arxiv.org/pdf/2510.10822v1)**

> **作者:** Clemence Mottez; Louisa Fay; Maya Varma; Sophie Ostmeier; Curtis Langlotz
>
> **备注:** Preprint of an article published in Pacific Symposium on Biocomputing \c{opyright} 2026 World Scientific Publishing Co., Singapore, http://psb.stanford.edu/
>
...
>
---
#### [new 114] HccePose(BF): Predicting Front \& Back Surfaces to Construct Ultra-Dense 2D-3D Correspondences for Pose Estimation
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究物体位姿估计任务，旨在解决现有方法仅预测物体前表面3D坐标导致信息利用不充分的问题。作者提出预测前后表面并密集采样中间点，构建超密集2D-3D对应，并设计HCCE编码提升精度，显著提高了位姿估计性能。**

- **链接: [http://arxiv.org/pdf/2510.10177v1](http://arxiv.org/pdf/2510.10177v1)**
...
>
---
#### [new 119] EvoCAD: Evolutionary CAD Code Generation with Vision Language Models
- **分类: cs.CV; cs.AI; cs.NE**

- **简介: 该论文提出EvoCAD，结合视觉语言模型与进化算法生成CAD代码。任务是生成拓扑正确的3D CAD模型，解决现有方法在结构合理性与语义相似性评估上的不足，引入基于欧拉特征的新指标，提升生成质量与可评估性。**

- **链接: [http://arxiv.org/pdf/2510.11631v1](http://arxiv.org/pdf/2510.11631v1)**

> **作者:** Tobias Preintner; Weixuan Yuan; Adrian König; Thomas Bäck; Elena Raponi; Niki van Stein
>
> **备注:** Accepted to IEEE ICTAI 2025
>
> **摘要:** Combining large language models with evolutionary computation algorithms represents a promising research direction leveraging the remarkable generative and in-context learning capabilities of LLMs with the strengths of evolutionary algorithms. In this work, we present EvoCAD, a method for generating computer-aided design (CAD) objects through their symbolic representations using vision language models and evolutionary optimization. Our method samples multiple CAD objects, which are then optimized using an evolutionary approach with vision language and reasoning language models. We assess our method using GPT-4V and GPT-4o, evaluating it on the CADPrompt benchmark dataset and comparing it to prior methods. Additionally, we introduce two new metrics based on topological properties defined by the Euler characteristic, which capture a form of semantic similarity between 3D objects. Our results demonstrate that EvoCAD outperforms previous approaches on multiple metrics, particularly in generating topologically correct objects, which can be efficiently evaluated using our two novel metrics that complement existing spatial metrics.
>
---
#### [new 120] Text-Enhanced Panoptic Symbol Spotting in CAD Drawings
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究CAD图纸中的全景符号识别任务，旨在解决现有方法忽略文本标注和几何元素间关系建模不足的问题。作者提出融合文本与几何信息的统一框架，采用Transformer结合类型感知注意力机制，提升符号识别精度与鲁棒性。**

- **链接: [http://arxiv.org/pdf/2510.11091v1](http://arxiv.org/pdf/2510.11091v1)**
...
>
> **摘要:** With the recent emergence of revolutionary autonomous agentic systems, research community is witnessing a significant shift from traditional static, passive, and domain-specific AI agents toward more dynamic, proactive, and generalizable agentic AI. Motivated by the growing interest in agentic AI and its potential trajectory toward AGI, we present a comprehensive survey on Agentic Multimodal Large Language Models (Agentic MLLMs). In this survey, we explore the emerging paradigm of agentic MLLMs, delineating their conceptual foundations and distinguishing characteristics from conventional MLLM-based agents. We establish a conceptual framework that organizes agentic MLLMs along three fundamental dimensions: (i) Agentic internal intelligence functions as the system's commander, enabling accurate long-horizon planning through reasoning, reflection, and memory; (ii) Agentic external tool invocation, whereby models proactively use various external tools to extend their problem-solving capabilities beyond their intrinsic knowledge; and (iii) Agentic environment interaction further situates models within virtual or physical environments, allowing them to take actions, adapt strategies, and sustain goal-directed behavior in dynamic real-world scenarios. To further accelerate research in this area for the community, we compile open-source training frameworks, training and evaluation datasets for developing agentic MLLMs. Finally, we review the downstream applications of agentic MLLMs and outline future research directions for this rapidly evolving field. To continuously track developments in this rapidly evolving field, we will also actively update a public repository at https://github.com/HJYao00/Awesome-Agentic-MLLMs.
>
---
#### [new 122] How many samples to label for an application given a foundation model? Chest X-ray classification study
- **分类: cs.CV; 68T07 (Primary) 68T45, 62H30, 62P10 (Secondary)**

- **简介: 该论文研究胸部X光分类任务，旨在确定使用基础模型时所需的最少标注样本数。通过拟合幂律学习曲线，利用少量样本预测模型最终性能，从而降低标注成本。**

- **链接: [http://arxiv.org/pdf/2510.11553v1](http://arxiv.org/pdf/2510.11553v1)**
...
>
---
#### [new 158] Human Uncertainty-Aware Data Selection and Automatic Labeling in Visual Question Answering
- **分类: cs.CV**

- **简介: 该论文针对视觉问答中人类标注不确定性问题，提出HaDola框架，通过数据筛选与自动标注，减少对昂贵标注的依赖，提升模型准确性和校准性，实现更高效的小样本训练。**

- **链接: [http://arxiv.org/pdf/2510.11295v1](http://arxiv.org/pdf/2510.11295v1)**
...
>
---
#### [new 176] UniFlow: A Unified Pixel Flow Tokenizer for Visual Understanding and Generation
- **分类: cs.CV**

- **简介: 该论文提出UniFlow，一种统一的像素流 tokenizer，旨在解决视觉理解与生成任务间的性能权衡。通过自适应自蒸馏和轻量级像素流解码器，实现语义保留与高保真重建，兼顾理解与生成性能。**

- **链接: [http://arxiv.org/pdf/2510.10575v1](http://arxiv.org/pdf/2510.10575v1)**
...
>
---
#### [new 178] Constructive Distortion: Improving MLLMs with Attention-Guided Image Warping
- **分类: cs.CV; cs.LG**

- **简介: 该论文针对多模态大模型在复杂场景中遗漏细节和空间关系的问题，提出AttWarp方法。利用模型跨模态注意力，在测试时对图像进行非均匀拉伸，增强关键区域分辨率，提升细粒度理解与推理能力，无需修改模型结构。**

- **链接: [http://arxiv.org/pdf/2510.09741v1](http://arxiv.org/pdf/2510.09741v1)**
...
>
---
#### [new 179] Dynamic Gaussian Splatting from Defocused and Motion-blurred Monocular Videos
- **分类: cs.CV**

- **简介: 该论文研究从含焦外虚化和运动模糊的单目视频生成动态高斯点阵。针对现有方法难以同时处理两类模糊的问题，提出一种统一框架，通过模糊预测网络估计逐像素模糊核，并引入动态高斯稠密化与未见视图约束，提升新视角合成质量。**

- **链接: [http://arxiv.org/pdf/2510.10691v1](http://arxiv.org/pdf/2510.10691v1)**
...
>
---
#### [new 180] DISC-GAN: Disentangling Style and Content for Cluster-Specific Synthetic Underwater Image Generation
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出DISC-GAN，用于合成逼真 underwater 图像。针对不同水域风格差异大、传统生成模型难建模的问题，采用聚类划分风格域，结合风格-内容解耦和AdaIN，实现簇特定的高质量图像生成。**

- **链接: [http://arxiv.org/pdf/2510.10782v1](http://arxiv.org/pdf/2510.10782v1)**
...
>
---
#### [new 186] DEMO: Disentangled Motion Latent Flow Matching for Fine-Grained Controllable Talking Portrait Synthesis
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究音频驱动的说话人头视频生成，旨在实现精细运动控制。提出DEMO框架，通过解耦运动隐空间与流匹配模型，分别控制唇部、头部姿态和眼神，提升视频真实感与时序连贯性。**

- **链接: [http://arxiv.org/pdf/2510.10650v1](http://arxiv.org/pdf/2510.10650v1)**

> **作者:** Peiyin Chen; Zhuowei Yang; Hui Feng; Sheng Jiang; Rui Yan
>
> **备注:** 5 pages
>
> **摘要:** Audio-driven talking-head generation has advanced rapidly with diffusion-based generative models, yet producing temporally coherent videos with fine-grained motion control remains challenging. We propose DEMO, a flow-matching generative framework for audio-driven talking-portrait video synthesis that delivers disentangled, high-fidelity control of lip motion, head pose, and eye gaze. The core contribution is a motion auto-encoder that builds a structured latent space in which motion factors are independently represented and approximately orthogonalized. On this disentangled motion space, we apply optimal-transport-based flow matching with a transformer predictor to generate temporally smooth motion trajectories conditioned on audio. Extensive experiments across multiple benchmarks show that DEMO outperforms prior methods in video realism, lip-audio synchronization, and motion fidelity. These results demonstrate that combining fine-grained motion disentanglement with flow-based generative modeling provides a powerful new paradigm for controllable talking-head video synthesis.
>
---
#### [new 187] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
- **分类: cs.CV**

- **简介: 该论文聚焦3D高斯点阵的几何表征优化，旨在提升新视角合成与表面重建精度。针对几何不准确和多视角不对齐问题，提出视图对齐方法，引入边缘感知、可见性建模、法向约束和深度特征一致性，显著提升几何质量与渲染效果。**

- **链接: [http://arxiv.org/pdf/2510.11473v1](http://arxiv.org/pdf/2510.11473v1)**
...
>
---
#### [new 194] REACT3D: Recovering Articulations for Interactive Physical 3D Scenes
- **分类: cs.CV; cs.RO**

- **简介: 该论文致力于将静态3D场景转化为可交互的物理场景，解决标注成本高的问题。提出REACT3D框架，实现开合物体检测、关节推断、几何补全与场景集成，支持零样本生成，提升可交互3D场景构建的可扩展性。**

- **链接: [http://arxiv.org/pdf/2510.11340v1](http://arxiv.org/pdf/2510.11340v1)**
...
>
> **摘要:** Walking assistance in extreme or complex environments remains a significant challenge for people with blindness or low vision (BLV), largely due to the lack of a holistic scene understanding. Motivated by the real-world needs of the BLV community, we build mmWalk, a simulated multi-modal dataset that integrates multi-view sensor and accessibility-oriented features for outdoor safe navigation. Our dataset comprises 120 manually controlled, scenario-categorized walking trajectories with 62k synchronized frames. It contains over 559k panoramic images across RGB, depth, and semantic modalities. Furthermore, to emphasize real-world relevance, each trajectory involves outdoor corner cases and accessibility-specific landmarks for BLV users. Additionally, we generate mmWalkVQA, a VQA benchmark with over 69k visual question-answer triplets across 9 categories tailored for safe and informed walking assistance. We evaluate state-of-the-art Vision-Language Models (VLMs) using zero- and few-shot settings and found they struggle with our risk assessment and navigational tasks. We validate our mmWalk-finetuned model on real-world datasets and show the effectiveness of our dataset for advancing multi-modal walking assistance.
>
---
#### [new 199] SNAP: Towards Segmenting Anything in Any Point Cloud
- **分类: cs.CV**

- **简介: 该论文研究3D点云交互式分割任务，旨在解决现有方法领域受限、交互方式单一及跨域负迁移问题。提出SNAP模型，支持点和文本提示，融合多域数据训练与域自适应归一化，实现跨域泛化，支持全景与开放词汇分割。**

- **链接: [http://arxiv.org/pdf/2510.11565v1](http://arxiv.org/pdf/2510.11565v1)**
...
>
---
#### [new 200] DKPMV: Dense Keypoints Fusion from Multi-View RGB Frames for 6D Pose Estimation of Textureless Objects
- **分类: cs.CV; cs.RO**

- **简介: 该论文针对无纹理物体的6D姿态估计任务，解决多视角RGB方法因缺乏深度信息导致性能受限的问题。提出DKPMV，通过稠密关键点融合与三阶段优化策略，结合注意力聚合和对称性感知训练，在无深度输入下实现高精度姿态估计。**

- **链接: [http://arxiv.org/pdf/2510.10933v1](http://arxiv.org/pdf/2510.10933v1)**

> **作者:** Jiahong Chen; Jinghao Wang; Zi Wang; Ziwen Wang; Banglei Guan; Qifeng Yu
>
> **备注:** 12 pages, 9 figures, submitted to ICRA 2026
>
> **摘要:** 6D pose estimation of textureless objects is valuable for industrial robotic applications, yet remains challenging due to the frequent loss of depth information. Current multi-view methods either rely on depth data or insufficiently exploit multi-view geometric cues, limiting their performance. In this paper, we propose DKPMV, a pipeline that achieves dense keypoint-level fusion using only multi-view RGB images as input. We design a three-stage progressive pose optimization strategy that leverages dense multi-view keypoint geometry information. To enable effective dense keypoint fusion, we enhance the keypoint network with attentional aggregation and symmetry-aware training, improving prediction accuracy and resolving ambiguities on symmetric objects. Extensive experiments on the ROBI dataset demonstrate that DKPMV outperforms state-of-the-art multi-view RGB approaches and even surpasses the RGB-D methods in the majority of cases. The code will be available soon.
>
---
#### [new 201] LikePhys: Evaluating Intuitive Physics Understanding in Video Diffusion Models via Likelihood Preference
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦视频扩散模型的直观物理理解评估任务，旨在解决生成视频中物理正确性与视觉外观难解耦的问题。作者提出无需训练的LikePhys方法，基于去噪目标构建似然代理，通过物理合理与不合理视频对的偏好评估模型物理理解能力，并构建基准进行系统评测。**

- **链接: [http://arxiv.org/pdf/2510.11512v1](http://arxiv.org/pdf/2510.11512v1)**
...
>
---
#### [new 202] MS-Mix: Unveiling the Power of Mixup for Multimodal Sentiment Analysis
- **分类: cs.CV; cs.LG**

- **简介: 该论文研究多模态情感分析（MSA）中的数据增强问题，提出MS-Mix框架。针对传统Mixup导致的语义混乱，设计情感感知采样、强度引导混合与情感对齐损失，提升模型泛化能力，在多个基准上显著优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.11579v1](http://arxiv.org/pdf/2510.11579v1)**
...
>
---
#### [new 203] Complementary and Contrastive Learning for Audio-Visual Segmentation
- **分类: cs.CV**

- **简介: 该论文研究音频-视觉分割任务，旨在通过音频信号生成对应物体的像素级分割图。针对现有方法在跨模态互补和时序建模上的不足，提出CCFormer框架，结合早期融合、多查询Transformer和双模对比学习，提升分割性能，在多个数据集上达到最优。**

- **链接: [http://arxiv.org/pdf/2510.10051v1](http://arxiv.org/pdf/2510.10051v1)**
...
>
---
#### [new 210] Post Processing of image segmentation using Conditional Random Fields
- **分类: cs.CV**

- **简介: 该论文属于图像分割后处理任务，旨在解决卫星图像因特征质量低导致分割结果模糊的问题。作者通过比较多种条件随机场（CRF）模型，寻找能提升分割清晰度的最佳方案，并在低质卫星图与高质航拍图上验证其效果。**

- **链接: [http://arxiv.org/pdf/2510.09833v1](http://arxiv.org/pdf/2510.09833v1)**

> **作者:** Aashish Dhawan; Pankaj Bodani; Vishal Garg
>
> **摘要:** The output of image the segmentation process is usually not very clear due to low quality features of Satellite images. The purpose of this study is to find a suitable Conditional Random Field (CRF) to achieve better clarity in a segmented image. We started with different types of CRFs and studied them as to why they are or are not suitable for our purpose. We evaluated our approach on two different datasets - Satellite imagery having low quality features and high quality Aerial photographs. During the study we experimented with various CRFs to find which CRF gives the best results on images and compared our results on these datasets to show the pitfalls and potentials of different approaches.
>
---
#### [new 211] GIR-Bench: Versatile Benchmark for Generating Images with Reasoning
- **分类: cs.CV**

- **简介: 该论文提出GIR-Bench，旨在评估多模态模型在图像生成中的推理能力。针对理解与生成的对齐问题，构建了三个评测子集，分别考察一致性、文本到图像生成的逻辑约束遵循及编辑中的多步推理，推动更可靠的统一模型发展。**

- **链接: [http://arxiv.org/pdf/2510.11026v1](http://arxiv.org/pdf/2510.11026v1)**
...
>
---
#### [new 212] Semantic Visual Anomaly Detection and Reasoning in AI-Generated Images
- **分类: cs.CV**

- **简介: 该论文聚焦AI生成图像中的语义异常检测与归因，旨在提升内容可信度。提出AnomReason基准和AnomAgent构建方法，通过多智能体 pipeline 生成带推理的结构化标注，推动可解释深度伪造检测与生成模型语义合理性评估。**

- **链接: [http://arxiv.org/pdf/2510.10231v1](http://arxiv.org/pdf/2510.10231v1)**
...
>
---
#### [new 219] Where on Earth? A Vision-Language Benchmark for Probing Model Geolocation Skills Across Scales
- **分类: cs.CV**

- **简介: 该论文提出EarthWhere基准，评估视觉-语言模型在开放世界中的图像地理定位能力，涵盖国家和街道两级任务，衡量最终定位精度与中间推理过程，揭示模型性能、区域偏差及推理有效性问题。**

- **链接: [http://arxiv.org/pdf/2510.10880v1](http://arxiv.org/pdf/2510.10880v1)**
...
>
---
#### [new 227] Generalisation of automatic tumour segmentation in histopathological whole-slide images across multiple cancer types
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文研究通用肿瘤分割任务，旨在解决不同癌症类型间模型泛化问题。作者基于多癌种数据训练单一深度学习模型，并在多种癌症和外部数据中验证其性能，结果表明该模型具有高泛化能力，分割精度稳定，无需为每种癌症单独建模。**

- **链接: [http://arxiv.org/pdf/2510.11182v1](http://arxiv.org/pdf/2510.11182v1)**
...
>
> **摘要:** Deep learning is expected to aid pathologists by automating tasks such as tumour segmentation. We aimed to develop one universal tumour segmentation model for histopathological images and examine its performance in different cancer types. The model was developed using over 20 000 whole-slide images from over 4 000 patients with colorectal, endometrial, lung, or prostate carcinoma. Performance was validated in pre-planned analyses on external cohorts with over 3 000 patients across six cancer types. Exploratory analyses included over 1 500 additional patients from The Cancer Genome Atlas. Average Dice coefficient was over 80% in all validation cohorts with en bloc resection specimens and in The Cancer Genome Atlas cohorts. No loss of performance was observed when comparing the universal model with models specialised on single cancer types. In conclusion, extensive and rigorous evaluations demonstrate that generic tumour segmentation by a single model is possible across cancer types, patient populations, sample preparations, and slide scanners.
>
---
#### [new 228] Decomposer Networks: Deep Component Analysis and Synthesis
- **分类: cs.LG; cs.CV; cs.IT; cs.NE; math.IT**

- **简介: 该论文提出分解器网络（DecompNet），属于表示学习任务，旨在实现输入的可解释成分分解。通过引入各分支间的残差竞争机制，解决传统自编码器缺乏语义分解能力的问题，实现了更稀疏、语义明确的成分分析与合成。**

- **链接: [http://arxiv.org/pdf/2510.09825v1](http://arxiv.org/pdf/2510.09825v1)**

> **作者:** Mohsen Joneidi
>
> **备注:** 13 Pages, 4 figures
>
> **摘要:** We propose the Decomposer Networks (DecompNet), a semantic autoencoder that factorizes an input into multiple interpretable components. Unlike classical autoencoders that compress an input into a single latent representation, the Decomposer Network maintains N parallel branches, each assigned a residual input defined as the original signal minus the reconstructions of all other branches. By unrolling a Gauss--Seidel style block-coordinate descent into a differentiable network, DecompNet enforce explicit competition among components, yielding parsimonious, semantically meaningful representations. We situate our model relative to linear decomposition methods (PCA, NMF), deep unrolled optimization, and object-centric architectures (MONet, IODINE, Slot Attention), and highlight its novelty as the first semantic autoencoder to implement an all-but-one residual update rule.
>
---
#### [new 229] Generative Latent Video Compression
- **分类: eess.IV; cs.CV**

- **简介: 该论文研究感知视频压缩任务，旨在解决传统方法在率-失真-感知权衡中易产生闪烁伪影的问题。作者提出GLVC框架，利用预训练连续tokenizer将视频映射到感知对齐的潜在空间，并设计适配潜在域的编解码结构，实现更优的压缩性能与时间一致性。**

- **链接: [http://arxiv.org/pdf/2510.09987v1](http://arxiv.org/pdf/2510.09987v1)**
...
>
---
#### [new 230] BitMar: Low-Bit Multimodal Fusion with Episodic Memory for Edge Devices
- **分类: cs.CL; cs.AI; cs.CV; 68T50; I.2.7**

- **简介: 该论文研究面向边缘设备的多模态图文生成任务，解决模型因高精度参数难以部署的问题。提出BitMar，采用1.58位量化编码器、类人情景记忆机制和滑动窗口注意力，在低资源下实现高效生成与理解。**

- **链接: [http://arxiv.org/pdf/2510.10560v1](http://arxiv.org/pdf/2510.10560v1)**
...
>
---
#### [new 233] Deep Neural Networks Inspired by Differential Equations
- **分类: cs.LG; cs.AI; cs.CV; cs.NA; math.NA; A.1; I.2; I.4**

- **简介: 该论文综述了受微分方程启发的深度神经网络，旨在提升模型的理论理解、可解释性与泛化能力。工作包括分析基于常微分方程和随机微分方程的模型结构、正则化方法，并进行数值比较，探讨未来研究方向。**

- **链接: [http://arxiv.org/pdf/2510.09685v1](http://arxiv.org/pdf/2510.09685v1)**
...
>
---
#### [new 244] SuperEx: Enhancing Indoor Mapping and Exploration using Non-Line-of-Sight Perception
- **分类: cs.RO; cs.CV**

- **简介: 该论文属机器人探索与建图任务，旨在解决传统方法因仅依赖可视信息导致效率低的问题。作者提出SuperEx框架，利用单光子LiDAR的非视距感知能力，通过物理与数据联合驱动方法预测遮挡区域结构，提升建图精度与探索效率。**
...
>
---
#### [new 245] Text Prompt Injection of Vision Language Models
- **分类: cs.CL; cs.CV**

- **简介: 该论文研究视觉语言模型的安全问题，针对文本提示注入攻击展开工作。提出一种高效算法，实验证明其能有效误导大模型，且对计算资源需求低，适用于大规模模型的攻击测试。**
...
>
---
#### [new 246] SecureWebArena: A Holistic Security Evaluation Benchmark for LVLM-based Web Agents
- **分类: cs.CR; cs.CV**

- **简介: 该论文针对基于大视觉语言模型的网页代理安全评估不足的问题，构建了首个综合性基准SecureWebArena，包含多样化环境、攻击向量和多层级评估协议，系统评测了9种LVLM的安全性，揭示了模型专业化与安全间的权衡。**

- **链接: [http://arxiv.org/pdf/2510.10073v1](http://arxiv.org/pdf/2510.10073v1)**
...
>
---
#### [new 247] Evaluating Reasoning Faithfulness in Medical Vision-Language Models using Multimodal Perturbations
- **分类: cs.CL; cs.CV**

- **简介: 该论文聚焦医疗视觉-语言模型的推理可信度评估，旨在解决模型解释与真实决策不一致的问题。作者提出基于多模态扰动的评测框架，在胸片问答任务中评估推理链的临床保真度、因果归因和置信校准，发现答案准确率与解释质量脱节，专有模型在归因和保真上表现更优。**
...
>
---
#### [new 248] Into the Unknown: Towards using Generative Models for Sampling Priors of Environment Uncertainty for Planning in Configuration Spaces
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 249] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
- **分类: eess.IV; cs.CV; cs.MM; I.4; I.5**

- **简介: 该论文研究3D高斯人类化身的高效压缩，旨在解决低比特率下高质量重建问题。提出先验引导框架，分离外观与运动建模，共享 canonical 高斯化身，用94参数编码动作，实现高压缩比与高保真渲染。**

- **链接: [http://arxiv.org/pdf/2510.10492v1](http://arxiv.org/pdf/2510.10492v1)**
...
>
---
#### [new 250] On the Optimal Representation Efficiency of Barlow Twins: An Information-Geometric Interpretation
- **分类: cs.LG; cs.CV; cs.IT; math.IT; math.ST; stat.ML; stat.TH; 68T07, 62B11, 94A17, 53B12; I.2.6; I.5.1; G.3; H.1.1**

- **简介: 该论文属于自监督学习理论分析任务，旨在解决不同方法表征效率缺乏统一衡量的问题。作者提出信息几何框架，定义表征效率，并证明Barlow Twins在特定条件下可实现最优效率。**

- **链接: [http://arxiv.org/pdf/2510.10980v1](http://arxiv.org/pdf/2510.10980v1)**
...
>
---
#### [new 253] Comparative Evaluation of Neural Network Architectures for Generalizable Human Spatial Preference Prediction in Unseen Built Environments
- **分类: cs.CE; cs.CV; cs.LG; cs.MA**

- **简介: 该论文属于空间偏好预测任务，旨在解决模型在未见建筑环境中泛化能力不足的问题。作者比较了图神经网络、卷积神经网络和前馈神经网络在合成数据上的表现，评估其跨布局的预测性能，以提升人类行为建模的通用性。**

- **链接: [http://arxiv.org/pdf/2510.10954v1](http://arxiv.org/pdf/2510.10954v1)**
...
>
---
#### [new 260] Cross-Sensor Touch Generation
- **分类: cs.RO; cs.CV**
...
- **链接: [http://arxiv.org/pdf/2510.09817v1](http://arxiv.org/pdf/2510.09817v1)**
...
>
---
#### [new 261] SpikeGrasp: A Benchmark for 6-DoF Grasp Pose Detection from Stereo Spike Streams
- **分类: cs.RO; cs.CV**

- **简介: 该论文研究6自由度抓取位姿检测任务，提出SpikeGrasp框架，直接处理双目脉冲相机的异步事件流，通过类脑的脉冲神经网络迭代优化抓取假设，避免显式点云重建，在杂乱和无纹理场景中表现更优。**
...
>
---
#### [new 262] QeRL: Beyond Efficiency -- Quantization-enhanced Reinforcement Learning for LLMs
- **分类: cs.LG; cs.CL; cs.CV**

- **简介: 该论文提出QeRL框架，针对大语言模型强化学习（RL）中资源消耗大的问题，结合NVFP4量化与LoRA技术，提升训练效率并引入量化噪声增强探索能力，实现更快、更优的RL训练。**

- **链接: [http://arxiv.org/pdf/2510.11696v1](http://arxiv.org/pdf/2510.11696v1)**
...
>
---
#### [new 263] VisRAG 2.0: Evidence-Guided Multi-Image Reasoning in Visual Retrieval-Augmented Generation
- **分类: cs.CL; cs.CV**

- **简介: 该论文研究视觉检索增强生成（VRAG）任务，旨在解决多图像证据感知与整合弱导致的推理错误问题。提出EVisRAG框架和RS-GRPO训练方法，提升模型跨图像证据定位与推理能力，在多图像问答中显著提升准确率。**
...
>
---
#### [replaced 003] Context Guided Transformer Entropy Modeling for Video Compression
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2508.01852v2](http://arxiv.org/pdf/2508.01852v2)**

> **作者:** Junlong Tong; Wei Zhang; Yaohui Jin; Xiaoyu Shen
>
> **备注:** ICCV 2025. This is an update to the camera-ready version
>
...
>
---
#### [replaced 004] OSCAR: One-Step Diffusion Codec Across Multiple Bit-rates
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.16091v5](http://arxiv.org/pdf/2505.16091v5)**
...
>
---
#### [replaced 005] MGPATH: Vision-Language Model with Multi-Granular Prompt Learning for Few-Shot WSI Classification
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.07409v4](http://arxiv.org/pdf/2502.07409v4)**
...
>
---
#### [replaced 006] MM-HELIX: Boosting Multimodal Long-Chain Reflective Reasoning with Holistic Platform and Adaptive Hybrid Policy Optimization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.08540v2](http://arxiv.org/pdf/2510.08540v2)**
...
>
---
#### [replaced 007] SyncHuman: Synchronizing 2D and 3D Generative Models for Single-view Human Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.07723v2](http://arxiv.org/pdf/2510.07723v2)**
...
>
---
#### [replaced 008] TTF-VLA: Temporal Token Fusion via Pixel-Attention Integration for Vision-Language-Action Models
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**

- **链接: [http://arxiv.org/pdf/2508.19257v2](http://arxiv.org/pdf/2508.19257v2)**
...
>
---
#### [replaced 009] FSFSplatter: Build Surface and Novel Views with Sparse-Views within 2min
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2510.02691v2](http://arxiv.org/pdf/2510.02691v2)**
...
>
---
#### [replaced 010] NEP: Autoregressive Image Editing via Next Editing Token Prediction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.06044v2](http://arxiv.org/pdf/2508.06044v2)**
...
>
---
#### [replaced 011] Pure-Pass: Fine-Grained, Adaptive Masking for Dynamic Token-Mixing Routing in Lightweight Image Super-Resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.01997v2](http://arxiv.org/pdf/2510.01997v2)**

> **作者:** Junyu Wu; Jie Liu; Jie Tang; Gangshan Wu
>
...
>
---
#### [replaced 012] {S\textsuperscript{2}M\textsuperscript{2}}: Scalable Stereo Matching Model for Reliable Depth Estimation
- **分类: cs.CV; cs.AI; cs.RO**

- **链接: [http://arxiv.org/pdf/2507.13229v4](http://arxiv.org/pdf/2507.13229v4)**
...
>
---
#### [replaced 013] Automated detection of underdiagnosed medical conditions via opportunistic imaging
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2409.11686v5](http://arxiv.org/pdf/2409.11686v5)**
...
>
---
#### [replaced 014] Learning Diffusion Models with Flexible Representation Guidance
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.08980v2](http://arxiv.org/pdf/2507.08980v2)**

> **作者:** Chenyu Wang; Cai Zhou; Sharut Gupta; Zongyu Lin; Stefanie Jegelka; Stephen Bates; Tommi Jaakkola
>
> **备注:** NeurIPS 2025; Also Oral at ICML 2025 FM4LS workshop
>
...
>
---
#### [replaced 015] Towards Robust and Realible Multimodal Fake News Detection with Incomplete Modality
- **分类: cs.MM; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.05839v2](http://arxiv.org/pdf/2510.05839v2)**
...
>
---
#### [replaced 016] GI-NAS: Boosting Gradient Inversion Attacks Through Adaptive Neural Architecture Search
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2405.20725v4](http://arxiv.org/pdf/2405.20725v4)**
...
>
---
#### [replaced 017] A Comprehensive Survey on Knowledge Distillation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.12067v2](http://arxiv.org/pdf/2503.12067v2)**
...
>
---
#### [replaced 021] Multi-Scale Attention and Gated Shifting for Fine-Grained Event Spotting in Videos
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.07381v2](http://arxiv.org/pdf/2507.07381v2)**

> **作者:** Hao Xu; Sam Wells; Mohamed Reda Bouadjenek; Richard Dazeley; Sunil Aryal
>
...
>
---
#### [replaced 022] MarkPlugger: Generalizable Watermark Framework for Latent Diffusion Models without Retraining
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.05607v2](http://arxiv.org/pdf/2404.05607v2)**

> **作者:** Guokai Zhang; Lanjun Wang; Yuting Su; An-An Liu
>
> **备注:** IEEE Transactions on Multimedia 2025
>
...
>
---
#### [replaced 027] Go Beyond Earth: Understanding Human Actions and Scenes in Microgravity Environments
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.02845v3](http://arxiv.org/pdf/2506.02845v3)**
...
>
---
#### [replaced 028] OmniSAM: Omnidirectional Segment Anything Model for UDA in Panoramic Semantic Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.07098v3](http://arxiv.org/pdf/2503.07098v3)**
...
>
---
#### [replaced 039] Concept Retrieval -- What and How?
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.07058v2](http://arxiv.org/pdf/2510.07058v2)**
...
>
---
#### [replaced 040] HAVIR: HierArchical Vision to Image Reconstruction using CLIP-Guided Versatile Diffusion
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.03122v2](http://arxiv.org/pdf/2510.03122v2)**
...
>
---
#### [replaced 048] Evaluating YOLO Architectures: Implications for Real-Time Vehicle Detection in Urban Environments of Bangladesh
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.05652v2](http://arxiv.org/pdf/2509.05652v2)**

> **作者:** Ha Meem Hossain; Pritam Nath; Mahitun Nesa Mahi; Imtiaz Uddin; Ishrat Jahan Eiste; Syed Nasibur Rahman Ratul; Md Naim Uddin Mozumdar; Asif Mohammed Saad; MD Tamim Hossain
>
...
>
---
#### [replaced 049] Open Vocabulary Multi-Label Video Classification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.09073v2](http://arxiv.org/pdf/2407.09073v2)**
...
>
---
#### [replaced 050] Muddit: Liberating Generation Beyond Text-to-Image with a Unified Discrete Diffusion Model
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23606v2](http://arxiv.org/pdf/2505.23606v2)**
...
>
---
#### [replaced 056] Audio Does Matter: Importance-Aware Multi-Granularity Fusion for Video Moment Retrieval
...
>
---
#### [replaced 057] Revisit What You See: Disclose Language Prior in Vision Tokens for LVLM Decoding
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2506.09522v2](http://arxiv.org/pdf/2506.09522v2)**
...
>
---
#### [replaced 058] Error Propagation Mechanisms and Compensation Strategies for Quantized Diffusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12094v2](http://arxiv.org/pdf/2508.12094v2)**
...
>
---
#### [replaced 059] SWIFT: Semantic Watermarking for Image Forgery Thwarting
- **分类: cs.CR; cs.AI; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2407.18995v2](http://arxiv.org/pdf/2407.18995v2)**

> **作者:** Gautier Evennou; Vivien Chappelier; Ewa Kijak; Teddy Furon
>
> **备注:** Accepted at IEEE WIFS 2024; Code released at : https://github.com/gautierevn/swift_watermarking
>
...
>
---
#### [replaced 060] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
- **分类: cs.GR; cs.CV; cs.DC; I.3.6; I.3.2; D.1.3**

- **链接: [http://arxiv.org/pdf/2505.24796v2](http://arxiv.org/pdf/2505.24796v2)**
...
>
---
#### [replaced 064] Investigating VLM Hallucination from a Cognitive Psychology Perspective: A First Step Toward Interpretation with Intriguing Observations
- **分类: cs.CV; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.03123v2](http://arxiv.org/pdf/2507.03123v2)**

> **作者:** Xiangrui Liu; Man Luo; Agneet Chatterjee; Hua Wei; Chitta Baral; Yezhou Yang
>
...
>
---
#### [replaced 065] DA$^2$: Depth Anything in Any Direction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.26618v2](http://arxiv.org/pdf/2509.26618v2)**
...
>
---
#### [replaced 066] DexGarmentLab: Dexterous Garment Manipulation Environment with Generalizable Policy
- **分类: cs.RO; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.11032v3](http://arxiv.org/pdf/2505.11032v3)**
...
>
---
#### [replaced 067] DeRIS: Decoupling Perception and Cognition for Enhanced Referring Image Segmentation through Loopback Synergy
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.01738v2](http://arxiv.org/pdf/2507.01738v2)**
...
>
---
#### [replaced 068] MultiCOIN: Multi-Modal COntrollable Video INbetweening
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.08561v2](http://arxiv.org/pdf/2510.08561v2)**
...
>
---
#### [replaced 069] IONext: Unlocking the Next Era of Inertial Odometry
- **分类: cs.CV; cs.RO**

- **链接: [http://arxiv.org/pdf/2507.17089v2](http://arxiv.org/pdf/2507.17089v2)**

> **作者:** Shanshan Zhang; Qi Zhang; Siyue Wang; Tianshui Wen; Liqin Wu; Ziheng Zhou; Xuemin Hong; Ao Peng; Lingxiang Zheng; Yu Yang
>
...
>
---
#### [replaced 073] SANA-Video: Efficient Video Generation with Block Linear Diffusion Transformer
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.24695v2](http://arxiv.org/pdf/2509.24695v2)**
...
>
---
#### [replaced 075] One Stone with Two Birds: A Null-Text-Null Frequency-Aware Diffusion Models for Text-Guided Image Inpainting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.08273v3](http://arxiv.org/pdf/2510.08273v3)**
...
>
---
#### [replaced 076] OmniVCus: Feedforward Subject-driven Video Customization with Multimodal Control Conditions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23361v2](http://arxiv.org/pdf/2506.23361v2)**
...
>
---
#### [replaced 077] Jigsaw-R1: A Study of Rule-based Visual Reinforcement Learning with Jigsaw Puzzles
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.23590v3](http://arxiv.org/pdf/2505.23590v3)**
...
>
---
#### [replaced 078] Latent Harmony: Synergistic Unified UHD Image Restoration via Latent Space Regularization and Controllable Refinement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.07961v2](http://arxiv.org/pdf/2510.07961v2)**
...
>
---
#### [replaced 079] Prompt4Trust: A Reinforcement Learning Prompt Augmentation Framework for Clinically-Aligned Confidence Calibration in Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.09279v4](http://arxiv.org/pdf/2507.09279v4)**
...
>
---
#### [replaced 080] SMC++: Masked Learning of Unsupervised Video Semantic Compression
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2406.04765v2](http://arxiv.org/pdf/2406.04765v2)**
...
>
---
#### [replaced 083] The Visual Iconicity Challenge: Evaluating Vision-Language Models on Sign Language Form-Meaning Mapping
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.08482v2](http://arxiv.org/pdf/2510.08482v2)**
...
>
---
#### [replaced 084] CLIP-IN: Enhancing Fine-Grained Visual Understanding in CLIP via Instruction Editing Data and Long Captions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.02329v3](http://arxiv.org/pdf/2508.02329v3)**
...
>
---
#### [replaced 087] STAR: A Benchmark for Astronomical Star Fields Super-Resolution
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.16385v2](http://arxiv.org/pdf/2507.16385v2)**
...
>
---
#### [replaced 088] SliceFine: The Universal Winning-Slice Hypothesis for Pretrained Networks
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2510.08513v2](http://arxiv.org/pdf/2510.08513v2)**
...
>
---
#### [replaced 089] Goal-Based Vision-Language Driving
- **分类: cs.CV; cs.AI; cs.LG; cs.MM; cs.RO; I.2.6; I.2.9; I.2.10; C.3.3**

- **链接: [http://arxiv.org/pdf/2507.23042v2](http://arxiv.org/pdf/2507.23042v2)**
...
>
---
#### [replaced 090] Video-LMM Post-Training: A Deep Dive into Video Reasoning with Large Multimodal Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.05034v4](http://arxiv.org/pdf/2510.05034v4)**
...
>
---
#### [replaced 094] CURE: Concept Unlearning via Orthogonal Representation Editing in Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.12677v2](http://arxiv.org/pdf/2505.12677v2)**
...
>
---
#### [replaced 098] FMANet: A Novel Dual-Phase Optical Flow Approach with Fusion Motion Attention Network for Robust Micro-expression Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.07810v2](http://arxiv.org/pdf/2510.07810v2)**
...
>
---
#### [replaced 108] Tokenizing Motion: A Generative Approach for Scene Dynamics Compression
- **分类: cs.CV; eess.IV; I.4; I.5**

- **链接: [http://arxiv.org/pdf/2410.09768v2](http://arxiv.org/pdf/2410.09768v2)**
...
>
---
#### [replaced 109] Q-Router: Agentic Video Quality Assessment with Expert Model Routing and Artifact Localization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.08789v2](http://arxiv.org/pdf/2510.08789v2)**
...
>
---
#### [replaced 114] VaseVQA-3D: Benchmarking 3D VLMs on Ancient Greek Pottery
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.04479v2](http://arxiv.org/pdf/2510.04479v2)**
...
>
---
#### [replaced 115] TAG-WM: Tamper-Aware Generative Image Watermarking via Diffusion Inversion Sensitivity
- **分类: cs.MM; cs.CV; eess.IV; I.3.3; I.4.9**

- **链接: [http://arxiv.org/pdf/2506.23484v3](http://arxiv.org/pdf/2506.23484v3)**
...
>
---
#### [replaced 119] Holistic Evaluation of Multimodal LLMs on Spatial Intelligence
- **分类: cs.CV; cs.CL; cs.LG; cs.MM; cs.RO**

- **链接: [http://arxiv.org/pdf/2508.13142v2](http://arxiv.org/pdf/2508.13142v2)**
...
>
---
#### [replaced 123] Free-Lunch Color-Texture Disentanglement for Stylized Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.14275v3](http://arxiv.org/pdf/2503.14275v3)**
...
>
---
#### [replaced 124] MMHOI: Modeling Complex 3D Multi-Human Multi-Object Interactions
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.07828v2](http://arxiv.org/pdf/2510.07828v2)**

> **作者:** Kaen Kogashi; Anoop Cherian; Meng-Yu Jennifer Kuo
>
> **备注:** The paper is being withdrawn because it requires additional administrative review and approval from the authors' organization prior to publication
>
...
>
---
#### [replaced 125] ViFusionTST: Deep Fusion of Time-Series Image Representations from Load Signals for Early Bed-Exit Prediction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.22498v3](http://arxiv.org/pdf/2506.22498v3)**
...
>
---
#### [replaced 126] Cryo-RL: automating prostate cancer cryoablation planning with reinforcement learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.04886v2](http://arxiv.org/pdf/2509.04886v2)**
...
>
---
#### [replaced 127] Concept Steerers: Leveraging K-Sparse Autoencoders for Test-Time Controllable Generations
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.19066v3](http://arxiv.org/pdf/2501.19066v3)**
...
>
---
#### [replaced 128] Learning Shared Representations from Unpaired Data
- **分类: cs.CV; cs.LG; stat.ML**

- **链接: [http://arxiv.org/pdf/2505.21524v2](http://arxiv.org/pdf/2505.21524v2)**
...
>
---
#### [replaced 134] CoRGI: Verified Chain-of-Thought Reasoning with Post-hoc Visual Grounding
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.00378v2](http://arxiv.org/pdf/2508.00378v2)**

> **作者:** Shixin Yi; Lin Shang
>
> **备注:** Preparing for AAAI 2026(rejected), Multimodal Reasoning
>
...
>
---
#### [replaced 139] RoHOI: Robustness Benchmark for Human-Object Interaction Detection
- **分类: cs.CV; cs.HC; cs.RO; eess.IV**

- **链接: [http://arxiv.org/pdf/2507.09111v3](http://arxiv.org/pdf/2507.09111v3)**
...
>
---
#### [replaced 142] One More Glance with Sharp Eyes: Rethinking Lightweight Captioning as a Practical Visual Specialist
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.21451v2](http://arxiv.org/pdf/2508.21451v2)**
...
>
---
#### [replaced 143] Vision-Language Cross-Attention for Real-Time Autonomous Driving
- **分类: cs.CV; cs.AI; cs.LG; cs.RO; I.4.8; I.2.10; I.2.6; C.3.3; I.4.9**

- **链接: [http://arxiv.org/pdf/2507.23064v3](http://arxiv.org/pdf/2507.23064v3)**
...
>
---
#### [replaced 144] Does Reinforcement Learning Really Incentivize Reasoning Capacity in LLMs Beyond the Base Model?
- **分类: cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.13837v3](http://arxiv.org/pdf/2504.13837v3)**
...
>
---
#### [replaced 152] Shifting AI Efficiency From Model-Centric to Data-Centric Compression
- **分类: cs.CL; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.19147v3](http://arxiv.org/pdf/2505.19147v3)**
...
>
---
#### [replaced 153] A Vision-Based Shared-Control Teleoperation Scheme for Controlling the Robotic Arm of a Four-Legged Robot
- **分类: cs.RO; cs.CV; cs.LG; cs.SY; eess.SY**

- **链接: [http://arxiv.org/pdf/2508.14994v2](http://arxiv.org/pdf/2508.14994v2)**
...
>
---
#### [replaced 154] Evaluation of Deformable Image Registration under Alignment-Regularity Trade-off
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.07185v4](http://arxiv.org/pdf/2503.07185v4)**
...
>
---
#### [replaced 155] GeoVLM-R1: Reinforcement Fine-Tuning for Improved Remote Sensing Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.25026v2](http://arxiv.org/pdf/2509.25026v2)**
...
>
---
#### [replaced 156] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation and Reconstruction
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2411.14384v5](http://arxiv.org/pdf/2411.14384v5)**
