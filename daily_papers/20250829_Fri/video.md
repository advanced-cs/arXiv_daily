...
- **简介: 论文针对因果视频问答任务，解决高阶推理与可解释性不足问题，提出模块化框架，通过自然语言因果链作为中间表示，提升模型性能与可解释性。**
...
- **简介: 论文任务为心脏运动估计，解决传统方法因强度损失忽略解剖结构的问题，提出基于形状引导的贝叶斯循环深度网络，通过时空特征与后验模型实现精准分割与运动预测，并计算不确定性。**
...
- **简介: 该论文针对显著物体检测中细节丢失、边缘模糊及单模融合不足的问题，提出动态不确定性图卷积与多模态协作融合网络，提升复杂场景下边缘清晰度与背景鲁棒性。**
...
- **简介: 该论文针对视频扩散模型的采样效率问题，提出POSE框架，通过两阶段对抗蒸馏减少采样步骤，实现单步生成高质量视频，提升语义与帧一致性，降低延迟100倍。**
...
- **简介: 该论文针对LiDAR点云压缩任务，解决稀疏几何细节导致的高效压缩难题。提出双模块框架：几何重密集化模块重构稀疏特征，跨尺度传播模块通过多级占用线索引导特征共享，实现紧凑表征与实时压缩，实验达26FPS与先进压缩比。**
...
- **简介: 论文针对神经视频压缩中的码率控制问题，提出动态路由框架，结合实时调整与联合优化策略，实现可变比特率下的高效压缩，实验显示优于现有方法。**
...
- **简介: 该论文针对手术工具2D关键点检测任务，解决小规模医疗数据过拟合问题，采用预训练VLM结合LoRA微调与指令提示数据集，实现低资源场景下更优检测性能。**
...
- **链接: [http://arxiv.org/pdf/2508.20754v1](http://arxiv.org/pdf/2508.20754v1)**
...
- **简介: 该论文研究多模态LLM处理图像任务的内部机制，通过探针框架分析各层功能，揭示视觉接地、语义推理和输出生成的分阶段结构，并验证其对模型架构的依赖性。**
...
- **简介: 论文任务是从正面图像生成完整3D头像，解决后脑结构缺失问题。提出AvatarBack框架，通过SSG生成伪图像和ASA对齐策略，提升后脑重建质量，保持正面细节。**
...
- **简介: 论文通过反事实分析框架，解决计算机视觉模型的可解释性、公平性和因果分析问题，提出CAVLI、ASAC等方法，用于检测和缓解分类器及生成模型中的偏差。**
...
- **简介: 论文任务为生成情感表达的虚拟人物视频。解决现有方法在情感控制、动作自然度及数据集实用性方面的不足，提出EmoCAST框架，包含情感文本模块与音频注意力模块，并构建情感数据集优化模型性能。**
...
- **简介: 论文针对3D生成中数据稀缺问题，利用视频中的常识先验（如多视角一致性与语义信息），提出Droplet3D数据集与模型，通过视频监督提升生成内容的空间一致性与语义合理性，并扩展至场景级应用。**
...
- **简介: 本文针对高性能网络轻量化不足的问题，提出E-ConvNeXt，通过整合CSPNet、优化结构及通道注意力，显著降低复杂度并提升效率，在ImageNet和目标检测中表现优异。**
...
- **简介: 该论文解决对抗攻击下的不可见水印鲁棒性测试任务，针对黑盒与米色盒场景设计攻击方法：基于VAE的适应性攻击与扩散模型结合，实现高精度水印移除且保留学术图像质量。**
...
- **简介: 论文针对手写体合成任务，解决传统方法在建模长程依赖和忽视频率信息的问题。提出FW-GAN框架，采用相位感知Wave-MLP生成器与频率引导判别器，结合频率分布损失，生成风格一致的高质量手写体，提升低资源手写识别系统的数据有效性。**
...
- **简介: 该论文针对医疗影像中域移位导致的细胞分裂检测性能下降问题，提出基于Mamba的VM-UNet架构与染色增强方法，在MIDOG挑战中验证了其有效性。**
...
- **简介: 论文提出FusionCounting框架，结合可见-红外图像融合与人群计数，通过多任务学习减少标注依赖，采用动态损失和对抗训练提升性能，解决拥挤场景下的融合与计数问题。**
...
- **简介: 该论文针对无监督3D物体检测中依赖人工标注的问题，提出数据级LiDAR-相机融合框架，通过双向融合与动态优化提升伪框质量，实验显示在nuScenes数据集上mAP提升28.4%。**
...
- **简介: 论文提出通过手机摄像头图像估算BMI的任务，解决传统方法不可用问题，利用大规模数据集训练模型，优化数据过滤，实现高精度估计并部署至移动设备。**
...
- **简介: 论文提出多视角3D点跟踪方法，解决单目跟踪的深度模糊与遮挡问题及多摄像头方法的高成本问题。通过少量相机直接预测3D对应，融合多视角特征并采用Transformer更新，实现鲁棒跟踪，在合成和真实数据上取得良好效果。**
...
- **简介: 论文针对医学图像分割任务，解决基础模型特征迁移的精度与可扩展性问题，提出Dino U-Net架构，通过融合DINOv3语义特征与低级细节，并设计FAPM模块提升特征保真度，实验证明其优于现有方法且可扩展性强。**
...
- **简介: 该论文针对实时深度伪造检测的高计算成本问题，提出SFMFNet网络，通过融合空间频率特征与多尺度注意力机制，在保持高精度的同时实现高效检测。**
...
- **简介: 该论文旨在解决合成图像意图检测问题，通过构建多模态数据集S-HArM（包含9576个图像-文本对）及三种提示策略，探索意图感知的合成图像检测方法，验证多模态引导数据提升泛化能力。**
...
- **简介: 论文提出音频引导的多模态视觉编辑框架，解决复杂场景下文本指导不足的问题，通过预训练编码器对齐音频与文本，结合噪声分支和自适应补丁选择提升编辑效果。**
...
>
---
#### [new 067] Adam SLAM - the last mile of camera calibration with 3DGS
- **分类: cs.CV**

- **简介: 该论文旨在改进相机校准以提升视图合成质量。通过3DGS模型反向传播新型视图颜色损失，微调相机参数，解决校准误差对重建质量的影响，实现平均PSNR提升0.4 dB。**

- **链接: [http://arxiv.org/pdf/2508.20526v1](http://arxiv.org/pdf/2508.20526v1)**
...
>
---
#### [new 077] SKGE-SWIN: End-To-End Autonomous Vehicle Waypoint Prediction and Navigation Using Skip Stage Swin Transformer
...
>
---
#### [new 081] SeqVLM: Proposal-Guided Multi-View Sequences Reasoning via VLM for Zero-Shot 3D Visual Grounding
- **分类: cs.CV; cs.AI**

- **简介: 本文提出SeqVLM框架，解决零样本3D视觉定位中单视角推理受限与上下文缺失问题。通过多视角图像与3D语义提案结合，利用动态调度机制提升VLM推理效率，在ScanRefer和Nr3D数据集上取得SOTA性能。**

- **链接: [http://arxiv.org/pdf/2508.20758v1](http://arxiv.org/pdf/2508.20758v1)**
...
>
> **摘要:** Mitotic figures (MFs) are relevant biomarkers in tumor grading. Differentiating atypical MFs (AMFs) from normal MFs (NMFs) remains difficult, as manual annotation is time-consuming and subjective. In this work an ensemble of ConvNeXtBase models was trained with AUCMEDI and extend with a rule-based refinement (RBR) module. On the MIDOG25 preliminary test set, the ensemble achieved a balanced accuracy of 84.02%. While the RBR increased specificity, it reduced sensitivity and overall performance. The results show that deep ensembles perform well for AMF classification. RBR can increase specific metrics but requires further research.
>
---
#### [new 084] A multi-task neural network for atypical mitosis recognition under domain shift
- **分类: cs.CV**

- **简介: 该论文提出基于多任务学习的神经网络，用于在领域转移下识别异常有丝分裂，通过辅助任务帮助模型聚焦目标对象，提升分类性能。**

- **链接: [http://arxiv.org/pdf/2508.21035v1](http://arxiv.org/pdf/2508.21035v1)**
...
>
---
#### [new 085] Enhancing Mamba Decoder with Bidirectional Interaction in Multi-Task Dense Prediction
- **分类: cs.CV**

- **简介: 该论文针对多任务密集预测中的跨任务交互与计算效率矛盾，提出双向交互Mamba（BIM），通过BI-Scan和MS-Scan机制实现高效跨任务信息传递与多尺度建模，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2508.20376v1](http://arxiv.org/pdf/2508.20376v1)**
...
>
---
#### [new 088] More Reliable Pseudo-labels, Better Performance: A Generalized Approach to Single Positive Multi-label Learning
- **分类: cs.CV**

- **简介: 论文研究单正样本多标签学习，解决传统方法因缺失标签导致的不准确与噪声问题，提出GPR Loss和DAMP技术，构建AEVLP框架，在四个数据集上取得SOTA结果。**

- **链接: [http://arxiv.org/pdf/2508.20381v1](http://arxiv.org/pdf/2508.20381v1)**
...
>
---
#### [new 091] MedNet-PVS: A MedNeXt-Based Deep Learning Model for Automated Segmentation of Perivascular Spaces
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出基于MedNeXt-L-k5的深度学习模型，解决脑部血管周围空间（PVS）自动分割任务，针对手动分割效率低和现有模型泛化差的问题，通过多数据集训练与跨扫描仪验证，证明其在T1w/T2w MRI中有效性，但未超越nnU-Net。**

- **链接: [http://arxiv.org/pdf/2508.20256v1](http://arxiv.org/pdf/2508.20256v1)**
...
>
---
#### [new 093] Looking Beyond the Obvious: A Survey on Abstract Concept Recognition for Video Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文聚焦视频中抽象概念识别任务，解决机器识别如正义、自由等非直观概念的问题。作者综述了相关任务与数据集，总结长期研究趋势，强调基础模型在多模态时代对抽象理解的重要性。**

- **链接: [http://arxiv.org/pdf/2508.20765v1](http://arxiv.org/pdf/2508.20765v1)**
...
>
---
#### [new 094] COMETH: Convex Optimization for Multiview Estimation and Tracking of Humans
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 095] PointDGRWKV: Generalizing RWKV-like Architecture to Unseen Domains for Point Cloud Classification
- **分类: cs.CV**

- **简介: 该论文针对点云分类中的领域泛化问题，提出PointDGRWKV框架，通过自适应几何token shift和跨域键特征对齐模块，解决RWKV在未见领域中的空间扭曲与注意力漂移问题，保持线性效率并提升泛化性能。**

- **链接: [http://arxiv.org/pdf/2508.20835v1](http://arxiv.org/pdf/2508.20835v1)**
...
>
---
#### [new 096] Veritas: Generalizable Deepfake Detection via Pattern-Aware Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 论文针对深度伪造检测的通用性不足问题，提出HydraFake数据集和Veritas模型，通过模式感知推理与两阶段训练提升跨领域检测能力。**

- **链接: [http://arxiv.org/pdf/2508.21048v1](http://arxiv.org/pdf/2508.21048v1)**
...
>
---
#### [new 097] Pref-GRPO: Pairwise Preference Reward-based GRPO for Stable Text-to-Image Reinforcement Learning
- **分类: cs.CV**

- **简介: 该论文针对文本到图像强化学习中奖励模型易引发奖励黑客导致训练不稳定的问题，提出基于成对偏好奖励的Pref-GRPO方法，通过比较图像对优化偏好拟合，并引入UniGenBench统一基准评估模型性能。**

- **链接: [http://arxiv.org/pdf/2508.20751v1](http://arxiv.org/pdf/2508.20751v1)**

> **作者:** Yibin Wang; Zhimin Li; Yuhang Zang; Yujie Zhou; Jiazi Bu; Chunyu Wang; Qinglin Lu; Cheng Jin; Jiaqi Wang
>
> **备注:** Project Page: https://codegoat24.github.io/UnifiedReward/Pref-GRPO
>
...
>
---
#### [new 100] UltraEar: a multicentric, large-scale database combining ultra-high-resolution computed tomography and clinical data for ear diseases
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文构建多中心、大规模耳科疾病数据库，整合超高分辨率CT与临床数据，解决耳部疾病诊断研究的数据匮乏问题，为AI开发、教育及多机构协作提供高精度参考资源。**

- **链接: [http://arxiv.org/pdf/2508.20141v1](http://arxiv.org/pdf/2508.20141v1)**
...
>
---
#### [new 102] GUARD: Guideline Upholding Test through Adaptive Role-play and Jailbreak Diagnostics for LLMs
- **分类: cs.CL; cs.AI; cs.CV**

- **简介: 论文提出GUARD方法，用于评估LLM是否遵循伦理指南，通过自动生成违规问题和jailbreak诊断，验证模型合规性，并在多模型上验证效果。**
...
>
---
#### [new 103] The Role of Teacher Calibration in Knowledge Distillation
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于知识蒸馏任务，解决教师校准误差影响学生性能的问题，提出通过校准教师模型提升蒸馏效果，适用于多类任务。**

- **链接: [http://arxiv.org/pdf/2508.20224v1](http://arxiv.org/pdf/2508.20224v1)**
...
>
---
#### [new 107] Efficient and Privacy-Protecting Background Removal for 2D Video Streaming using iPhone 15 Pro Max LiDAR
- **分类: eess.IV; cs.CV; cs.MM; 68T45, 68U10; I.4.6; I.4.8; H.5.1; I.2.10**

- **简介: 论文研究基于iPhone 15 Pro Max LiDAR的高效隐私保护背景去除技术，解决传统方法对光照依赖的问题，通过GPU加速与实时处理提升2D视频流效率。**

- **链接: [http://arxiv.org/pdf/2508.20250v1](http://arxiv.org/pdf/2508.20250v1)**
...
>
---
#### [new 110] SPGrasp: Spatiotemporal Prompt-driven Grasp Synthesis in Dynamic Scenes
...
>
---
#### [new 111] Is the medical image segmentation problem solved? A survey of current developments and future directions
- **分类: eess.IV; cs.CV; cs.HC; cs.LG**

- **简介: 该论文对医学图像分割的进展与挑战进行综述，探讨当前模型是否解决核心问题及现存差距，分析七大方向（如学习方法、多模态整合等），并提供持续更新的文献资源库。**

- **链接: [http://arxiv.org/pdf/2508.20139v1](http://arxiv.org/pdf/2508.20139v1)**
...
>
---
#### [new 114] Unleashing Uncertainty: Efficient Machine Unlearning for Generative AI
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文针对生成式AI的机器去学习任务，解决高效删除敏感类别数据的问题。提出SAFEMax方法，通过信息论原理最大化生成熵，阻止不恰当类别的去噪过程，并调控早期扩散步骤平衡遗忘与保留，提升效率。**

- **链接: [http://arxiv.org/pdf/2508.20773v1](http://arxiv.org/pdf/2508.20773v1)**
...
>
---
#### [new 115] Mixture of Contexts for Long Video Generation
- **分类: cs.GR; cs.AI; cs.CV**

- **简介: 论文针对长视频生成中的长上下文记忆问题，提出Mixture of Contexts（MoC）模块，通过动态选择关键片段与锚点实现高效信息检索，解决扩散模型扩展时的计算瓶颈，提升长序列生成效率与一致性。**

- **链接: [http://arxiv.org/pdf/2508.21058v1](http://arxiv.org/pdf/2508.21058v1)**
...
>
---
#### [replaced 004] InterAct-Video: Reasoning-Rich Video QA for Urban Traffic
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.14743v3](http://arxiv.org/pdf/2507.14743v3)**

> **作者:** Joseph Raj Vishal; Divesh Basina; Rutuja Patil; Manas Srinivas Gowda; Katha Naik; Yezhou Yang; Bharatesh Chakravarthi
>
...
>
---
#### [replaced 005] A Sobel-Gradient MLP Baseline for Handwritten Character Recognition
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.11902v3](http://arxiv.org/pdf/2508.11902v3)**
...
>
---
#### [replaced 006] TAG-WM: Tamper-Aware Generative Image Watermarking via Diffusion Inversion Sensitivity
- **分类: cs.MM; cs.CV; eess.IV; I.3.3; I.4.9**

- **链接: [http://arxiv.org/pdf/2506.23484v2](http://arxiv.org/pdf/2506.23484v2)**

> **作者:** Yuzhuo Chen; Zehua Ma; Han Fang; Weiming Zhang; Nenghai Yu
>
> **备注:** Camera-ready version for ICCV 2025. Adds GitHub link; acknowledgments; appendix. Abstract and Figure 1 updated for clarity
>
...
>
---
#### [replaced 007] MIDAS: Multimodal Interactive Digital-humAn Synthesis via Real-time Autoregressive Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.19320v2](http://arxiv.org/pdf/2508.19320v2)**
...
>
---
#### [replaced 008] Pixel Motion as Universal Representation for Robot Control
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 009] Disentangled World Models: Learning to Transfer Semantic Knowledge from Distracting Videos for Reinforcement Learning
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.08751v2](http://arxiv.org/pdf/2503.08751v2)**
...
>
---
#### [replaced 010] Unlearning Concepts from Text-to-Video Diffusion Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2407.14209v2](http://arxiv.org/pdf/2407.14209v2)**

> **作者:** Shiqi Liu; Yihua Tan
>
...
>
---
#### [replaced 011] Improving Fine-Grained Control via Aggregation of Multiple Diffusion Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2410.01262v4](http://arxiv.org/pdf/2410.01262v4)**
...
>
---
#### [replaced 014] DSO: Aligning 3D Generators with Simulation Feedback for Physical Soundness
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.22677v2](http://arxiv.org/pdf/2503.22677v2)**
...
>
---
#### [replaced 017] Interact-Custom: Customized Human Object Interaction Image Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.19575v2](http://arxiv.org/pdf/2508.19575v2)**
...
>
---
#### [replaced 018] Seeing is Believing: Emotion-Aware Audio-Visual Language Modeling for Expressive Speech Generation
...
>
---
#### [replaced 019] Diffusion Models for Image Restoration and Enhancement: A Comprehensive Survey
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2308.09388v2](http://arxiv.org/pdf/2308.09388v2)**
...
>
---
#### [replaced 020] ZIM: Zero-Shot Image Matting for Anything
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.00626v2](http://arxiv.org/pdf/2411.00626v2)**
...
>
> **摘要:** The recent segmentation foundation model, Segment Anything Model (SAM), exhibits strong zero-shot segmentation capabilities, but it falls short in generating fine-grained precise masks. To address this limitation, we propose a novel zero-shot image matting model, called ZIM, with two key contributions: First, we develop a label converter that transforms segmentation labels into detailed matte labels, constructing the new SA1B-Matte dataset without costly manual annotations. Training SAM with this dataset enables it to generate precise matte masks while maintaining its zero-shot capability. Second, we design the zero-shot matting model equipped with a hierarchical pixel decoder to enhance mask representation, along with a prompt-aware masked attention mechanism to improve performance by enabling the model to focus on regions specified by visual prompts. We evaluate ZIM using the newly introduced MicroMat-3K test set, which contains high-quality micro-level matte labels. Experimental results show that ZIM outperforms existing methods in fine-grained mask generation and zero-shot generalization. Furthermore, we demonstrate the versatility of ZIM in various downstream tasks requiring precise masks, such as image inpainting and 3D NeRF. Our contributions provide a robust foundation for advancing zero-shot matting and its downstream applications across a wide range of computer vision tasks. The code is available at https://github.com/naver-ai/ZIM.
>
---
#### [replaced 021] Relative Drawing Identification Complexity is Invariant to Modality in Vision-Language Models
- **分类: cs.CV; cs.CL; I.2.7; I.2.10**

- **链接: [http://arxiv.org/pdf/2505.10583v2](http://arxiv.org/pdf/2505.10583v2)**
...
>
---
#### [replaced 023] CogNav: Cognitive Process Modeling for Object Goal Navigation with LLMs
...
>
---
#### [replaced 024] Visual Perturbation and Adaptive Hard Negative Contrastive Learning for Compositional Reasoning in Vision-Language Models
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.15576v2](http://arxiv.org/pdf/2505.15576v2)**
...
>
---
#### [replaced 025] Enhancing Document VQA Models via Retrieval-Augmented Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.18984v2](http://arxiv.org/pdf/2508.18984v2)**
...
>
---
#### [replaced 028] Model-based Multi-object Visual Tracking: Identification and Standard Model Limitations
- **分类: eess.SY; cs.CV; cs.SY**

- **链接: [http://arxiv.org/pdf/2508.13647v2](http://arxiv.org/pdf/2508.13647v2)**

> **作者:** Jan Krejčí; Oliver Kost; Yuxuan Xia; Lennart Svensson; Ondřej Straka
>
> **备注:** Accepted for publication in 2025 28th International Conference on Information Fusion (FUSION)
>
...
>
---
#### [replaced 029] When Memory Becomes a Vulnerability: Towards Multi-turn Jailbreak Attacks against Text-to-Image Generation Systems
- **分类: cs.CV; cs.CR**

- **链接: [http://arxiv.org/pdf/2504.20376v2](http://arxiv.org/pdf/2504.20376v2)**
...
>
> **备注:** This work proposes a multi-turn jailbreak attack against real-world chat-based T2I generation systems that intergrate memory mechanism. It also constructed a simulation system, with considering three industrial-grade memory mechanisms, 7 kinds of safety filters (both input and output)
>
...
>
---
#### [replaced 030] OLKAVS: An Open Large-Scale Korean Audio-Visual Speech Dataset
...
>
---
#### [replaced 034] Exploring Typographic Visual Prompts Injection Threats in Cross-Modality Generation Models
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2503.11519v3](http://arxiv.org/pdf/2503.11519v3)**
...
>
---
#### [replaced 035] Language-to-Space Programming for Training-Free 3D Visual Grounding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.01401v4](http://arxiv.org/pdf/2502.01401v4)**
...
>
---
#### [replaced 038] CVBench: Evaluating Cross-Video Synergies for Complex Multimodal Understanding and Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.19542v2](http://arxiv.org/pdf/2508.19542v2)**
...
>
---
#### [replaced 039] Robust ID-Specific Face Restoration via Alignment Learning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.10943v2](http://arxiv.org/pdf/2507.10943v2)**

> **作者:** Yushun Fang; Lu Liu; Xiang Gao; Qiang Hu; Ning Cao; Jianghe Cui; Gang Chen; Xiaoyun Zhang
>
> **备注:** PRCV2025 Accepted
>
...
>
---
#### [replaced 040] RSRNav: Reasoning Spatial Relationship for Image-Goal Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 041] L2RW+: A Comprehensive Benchmark Towards Privacy-Preserved Visible-Infrared Person Re-Identification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.12232v2](http://arxiv.org/pdf/2503.12232v2)**

> **作者:** Yan Jiang; Hao Yu; Mengting Wei; Zhaodong Sun; Haoyu Chen; Xu Cheng; Guoying Zhao
>
> **备注:** Extended Version of L2RW. We extend it from image to video data
>
...
>
---
#### [replaced 042] Probabilistic Modeling of Jailbreak on Multimodal LLMs: From Quantification to Application
- **分类: cs.CR; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.06989v4](http://arxiv.org/pdf/2503.06989v4)**
...
>
---
#### [replaced 046] Video-LevelGauge: Investigating Contextual Positional Bias in Large Video Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.19650v2](http://arxiv.org/pdf/2508.19650v2)**
...
>
---
#### [replaced 049] Leadership Assessment in Pediatric Intensive Care Unit Team Training
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24389v2](http://arxiv.org/pdf/2505.24389v2)**
...
>
---
#### [replaced 050] HSM: Hierarchical Scene Motifs for Multi-Scale Indoor Scene Generation
- **分类: cs.GR; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.16848v2](http://arxiv.org/pdf/2503.16848v2)**

> **作者:** Hou In Derek Pun; Hou In Ivan Tam; Austin T. Wang; Xiaoliang Huo; Angel X. Chang; Manolis Savva
>
> **备注:** 28 pages with 10 figures and 6 tables; improved method with wall and ceiling support regions and extra evaluation
>
...
>
---
#### [replaced 051] WikiAutoGen: Towards Multi-Modal Wikipedia-Style Article Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.19065v2](http://arxiv.org/pdf/2503.19065v2)**
