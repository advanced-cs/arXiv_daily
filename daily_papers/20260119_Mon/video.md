...
#### [new 001] Think-Clip-Sample: Slow-Fast Frame Selection for Video Understanding
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频理解任务，解决长视频处理中的计算效率和帧选择问题。提出TCS框架，通过多查询推理和剪辑级快慢采样提升性能并减少计算成本。**

- **链接: [https://arxiv.org/pdf/2601.11359v1](https://arxiv.org/pdf/2601.11359v1)**

> **作者:** Wenhui Tan; Ruihua Song; Jiaze Li; Jianzhong Ju; Zhenbo Luo
>
> **备注:** Accepted by ICASSP2026
>
> **摘要:** Recent progress in multi-modal large language models (MLLMs) has significantly advanced video understanding. However, their performance on long-form videos remains limited by computational constraints and suboptimal frame selection. We present Think-Clip-Sample (TCS), a training-free framework that enhances long video understanding through two key components: (i) Multi-Query Reasoning, which generates multiple queries to capture complementary aspects of the question and video; and (ii) Clip-level Slow-Fast Sampling, which adaptively balances dense local details and sparse global context. Extensive experiments on MLVU, LongVideoBench, and VideoMME demonstrate that TCS consistently improves performance across different MLLMs, boosting up to 6.9% accuracy, and is capable of achieving comparable accuracy with 50% fewer inference time cost, highlighting both efficiency and efficacy of TCS on long video understanding.
>
---
#### [new 002] Image-Text Knowledge Modeling for Unsupervised Multi-Scenario Person Re-Identification
- **分类: cs.CV**

- **简介: 该论文提出一种无监督多场景行人重识别方法（UMS-ReID），通过图像-文本知识建模（ITKM）解决跨场景识别问题，提升模型泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.11243v1](https://arxiv.org/pdf/2601.11243v1)**
...
>
---
#### [new 003] MMedExpert-R1: Strengthening Multimodal Medical Reasoning via Domain-Specific Adaptation and Clinical Guideline Reinforcement
- **分类: cs.CV**

- **简介: 该论文属于多模态医学推理任务，旨在解决MedVLM在临床推理中的不足。通过构建高质量数据集和引入领域适配与指南强化方法，提升模型的多专科诊断能力。**

- **链接: [https://arxiv.org/pdf/2601.10949v1](https://arxiv.org/pdf/2601.10949v1)**
...
>
---
#### [new 004] Assessing Building Heat Resilience Using UAV and Street-View Imagery with Coupled Global Context Vision Transformer
- **分类: cs.CV**

- **简介: 该论文属于城市热风险评估任务，旨在解决如何有效评估建筑热暴露问题。通过融合无人机和街景图像，利用机器学习模型分析建筑属性与热风险的关系。**

- **链接: [https://arxiv.org/pdf/2601.11357v1](https://arxiv.org/pdf/2601.11357v1)**

> **作者:** Steffen Knoblauch; Ram Kumar Muthusamy; Hao Li; Iddy Chazua; Benedcto Adamu; Innocent Maholi; Alexander Zipf
>
> **摘要:** Climate change is intensifying human heat exposure, particularly in densely built urban centers of the Global South. Low-cost construction materials and high thermal-mass surfaces further exacerbate this risk. Yet scalable methods for assessing such heat-relevant building attributes remain scarce. We propose a machine learning framework that fuses openly available unmanned aerial vehicle (UAV) and street-view (SV) imagery via a coupled global context vision transformer (CGCViT) to learn heat-relevant representations of urban structures. Thermal infrared (TIR) measurements from HotSat-1 are used to quantify the relationship between building attributes and heat-associated health risks. Our dual-modality cross-view learning approach outperforms the best single-modality models by up to $9.3\%$, demonstrating that UAV and SV imagery provide valuable complementary perspectives on urban structures. The presence of vegetation surrounding buildings (versus no vegetation), brighter roofing (versus darker roofing), and roofing made of concrete, clay, or wood (versus metal or tarpaulin) are all significantly associated with lower HotSat-1 TIR values. Deployed across the city of Dar es Salaam, Tanzania, the proposed framework illustrates how household-level inequalities in heat exposure - often linked to socio-economic disadvantage and reflected in building materials - can be identified and addressed using machine learning. Our results point to the critical role of localized, data-driven risk assessment in shaping climate adaptation strategies that deliver equitable outcomes.
>
---
#### [new 005] IDDR-NGP: Incorporating Detectors for Distractor Removal with Instant Neural Radiance Field
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出IDDR-NGP方法，用于去除3D场景中的多种干扰物，如雪片、花瓣等。通过结合隐式3D表示与2D检测器，实现高效场景重建。**

- **链接: [https://arxiv.org/pdf/2601.11030v1](https://arxiv.org/pdf/2601.11030v1)**
...
>
---
#### [new 008] Medical SAM3: A Foundation Model for Universal Prompt-Driven Medical Image Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学图像分割任务，旨在解决领域差异大、结构复杂等问题。通过微调SAM3模型，提升其在医学影像中的分割性能。**

- **链接: [https://arxiv.org/pdf/2601.10880v1](https://arxiv.org/pdf/2601.10880v1)**
...
>
---
#### [new 009] SME-YOLO: A Real-Time Detector for Tiny Defect Detection on PCB Surfaces
- **分类: cs.CV**

- **简介: 该论文属于目标检测任务，旨在解决PCB表面微小缺陷检测难题。通过改进损失函数、上采样模块和注意力机制，提升检测精度和细节保留能力。**

- **链接: [https://arxiv.org/pdf/2601.11402v1](https://arxiv.org/pdf/2601.11402v1)**
...
>
---
#### [new 025] A Unified 3D Object Perception Framework for Real-Time Outside-In Multi-Camera Systems
- **分类: cs.CV**

- **简介: 该论文属于3D目标感知与多目标多相机跟踪任务，解决静态摄像头网络中因遮挡和异构布局带来的挑战，提出优化框架提升实时性与稳定性。**

- **链接: [https://arxiv.org/pdf/2601.10819v1](https://arxiv.org/pdf/2601.10819v1)**
...
>
---
#### [new 027] Vision-as-Inverse-Graphics Agent via Interleaved Multimodal Reasoning
- **分类: cs.CV; cs.AI; cs.GR**

- **简介: 该论文提出VIGA，解决视觉逆图形重建问题，通过多模态推理实现场景编辑与重构，提升单次任务性能。**

- **链接: [https://arxiv.org/pdf/2601.11109v1](https://arxiv.org/pdf/2601.11109v1)**
...
>
---
#### [new 028] Democratizing planetary-scale analysis: An ultra-lightweight Earth embedding database for accurate and flexible global land monitoring
- **分类: cs.CV**

- **简介: 该论文属于地球观测任务，旨在解决全球尺度分析的计算与存储难题。通过构建轻量级地球嵌入数据库ESD，实现高效、准确的全球土地监测。**

- **链接: [https://arxiv.org/pdf/2601.11183v1](https://arxiv.org/pdf/2601.11183v1)**
...
>
---
#### [new 037] PhysRVG: Physics-Aware Unified Reinforcement Learning for Video Generative Models
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决传统模型忽视物理规律的问题。通过引入物理感知的强化学习方法，提升视频生成的物理真实性。**

- **链接: [https://arxiv.org/pdf/2601.11087v1](https://arxiv.org/pdf/2601.11087v1)**

> **作者:** Qiyuan Zhang; Biao Gong; Shuai Tan; Zheng Zhang; Yujun Shen; Xing Zhu; Yuyuan Li; Kelu Yao; Chunhua Shen; Changqing Zou
>
> **摘要:** Physical principles are fundamental to realistic visual simulation, but remain a significant oversight in transformer-based video generation. This gap highlights a critical limitation in rendering rigid body motion, a core tenet of classical mechanics. While computer graphics and physics-based simulators can easily model such collisions using Newton formulas, modern pretrain-finetune paradigms discard the concept of object rigidity during pixel-level global denoising. Even perfectly correct mathematical constraints are treated as suboptimal solutions (i.e., conditions) during model optimization in post-training, fundamentally limiting the physical realism of generated videos. Motivated by these considerations, we introduce, for the first time, a physics-aware reinforcement learning paradigm for video generation models that enforces physical collision rules directly in high-dimensional spaces, ensuring the physics knowledge is strictly applied rather than treated as conditions. Subsequently, we extend this paradigm to a unified framework, termed Mimicry-Discovery Cycle (MDcycle), which allows substantial fine-tuning while fully preserving the model's ability to leverage physics-grounded feedback. To validate our approach, we construct new benchmark PhysRVGBench and perform extensive qualitative and quantitative experiments to thoroughly assess its effectiveness.
>
---
#### [new 038] One Model, Many Behaviors: Training-Induced Effects on Out-of-Distribution Detection
- **分类: cs.CV**

- **简介: 该论文属于OOD检测任务，研究训练策略对检测性能的影响。发现ID准确率与OOD性能非单调相关，强调训练方法与检测器的协同作用。**

- **链接: [https://arxiv.org/pdf/2601.10836v1](https://arxiv.org/pdf/2601.10836v1)**
...
>
---
#### [new 039] Bio-inspired fine-tuning for selective transfer learning in image classification
- **分类: cs.CV**

- **简介: 该论文属于图像分类任务，旨在解决域差异导致的迁移学习效果不佳问题。提出BioTune方法，通过进化优化选择冻结层并调整学习率，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.11235v1](https://arxiv.org/pdf/2601.11235v1)**
...
>
---
#### [new 040] ShapeR: Robust Conditional 3D Shape Generation from Casual Captures
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于3D形状生成任务，解决从非理想数据中生成高质量3D形状的问题。通过融合多模态信息和增强训练策略，提升生成鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.11514v1](https://arxiv.org/pdf/2601.11514v1)**
...
>
> **备注:** Project Page: http://facebookresearch.github.io/ShapeR Video: https://www.youtube.com/watch?v=EbY30KAA55I
>
...
>
---
#### [new 041] Heterogeneous Uncertainty-Guided Composed Image Retrieval with Fine-Grained Probabilistic Learning
- **分类: cs.CV**

- **简介: 该论文属于图像检索任务，解决CIR中的不确定性问题。提出HUG框架，通过细粒度概率学习提升模型鲁棒性与区分能力。**

- **链接: [https://arxiv.org/pdf/2601.11393v1](https://arxiv.org/pdf/2601.11393v1)**
...
>
---
#### [new 044] Your One-Stop Solution for AI-Generated Video Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于AI生成视频检测任务，旨在解决现有数据集和基准不足的问题。工作包括构建覆盖31个模型、44万视频的基准AIGVDBench，并进行深入分析与评估。**

- **链接: [https://arxiv.org/pdf/2601.11035v1](https://arxiv.org/pdf/2601.11035v1)**
...
>
---
#### [new 045] Map2Thought: Explicit 3D Spatial Reasoning via Metric Cognitive Maps
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Map2Thought，用于3D视觉语言模型的显式空间推理。解决3D理解中的可解释性问题，通过构建度量认知图和认知思维链，提升推理准确性与可解释性。**

- **链接: [https://arxiv.org/pdf/2601.11442v1](https://arxiv.org/pdf/2601.11442v1)**

> **作者:** Xiangjun Gao; Zhensong Zhang; Dave Zhenyu Chen; Songcen Xu; Long Quan; Eduardo Pérez-Pellitero; Youngkyoon Jang
>
> **摘要:** We propose Map2Thought, a framework that enables explicit and interpretable spatial reasoning for 3D VLMs. The framework is grounded in two key components: Metric Cognitive Map (Metric-CogMap) and Cognitive Chain-of-Thought (Cog-CoT). Metric-CogMap provides a unified spatial representation by integrating a discrete grid for relational reasoning with a continuous, metric-scale representation for precise geometric understanding. Building upon the Metric-CogMap, Cog-CoT performs explicit geometric reasoning through deterministic operations, including vector operations, bounding-box distances, and occlusion-aware appearance order cues, producing interpretable inference traces grounded in 3D structure. Experimental results show that Map2Thought enables explainable 3D understanding, achieving 59.9% accuracy using only half the supervision, closely matching the 60.9% baseline trained with the full dataset. It consistently outperforms state-of-the-art methods by 5.3%, 4.8%, and 4.0% under 10%, 25%, and 50% training subsets, respectively, on the VSI-Bench.
>
---
#### [new 046] ATATA: One Algorithm to Align Them All
- **分类: cs.CV**

- **简介: 该论文提出ATATA算法，解决多模态样本结构对齐问题。通过联合运输方法提升生成效率与质量，适用于图像、视频和3D生成任务。**

- **链接: [https://arxiv.org/pdf/2601.11194v1](https://arxiv.org/pdf/2601.11194v1)**
...
>
---
#### [new 047] Generative Scenario Rollouts for End-to-End Autonomous Driving
- **分类: cs.CV**

- **简介: 该论文提出GeRo框架，用于端到端自动驾驶中的生成式场景模拟。解决传统方法依赖稀疏轨迹标注的问题，通过语言条件生成实现长期规划与多智能体协调，提升驾驶性能。**

- **链接: [https://arxiv.org/pdf/2601.11475v1](https://arxiv.org/pdf/2601.11475v1)**
...
>
---
#### [new 053] CTest-Metric: A Unified Framework to Assess Clinical Validity of Metrics for CT Report Generation
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 056] KOCOBrain: Kuramoto-Guided Graph Network for Uncovering Structure-Function Coupling in Adolescent Prenatal Drug Exposure
- **分类: q-bio.NC; cs.CV**

- **简介: 该论文提出KOCOBrain，用于分析青少年产前药物暴露对脑结构与功能连接的影响，解决神经影像中结构-功能耦合的识别问题。**

- **链接: [https://arxiv.org/pdf/2601.11018v1](https://arxiv.org/pdf/2601.11018v1)**
...
>
---
#### [new 062] Line-based Event Preprocessing: Towards Low-Energy Neuromorphic Computer Vision
- **分类: cs.NE; cs.AI; cs.CV; eess.IV**

- **简介: 该论文属于计算机视觉任务，旨在解决神经形态视觉的高能耗问题。通过线基事件预处理，降低能量消耗并提升分类效率。**

- **链接: [https://arxiv.org/pdf/2601.10742v1](https://arxiv.org/pdf/2601.10742v1)**
...
>
---
#### [replaced 003] Collaborative Representation Learning for Alignment of Tactile, Language, and Vision Modalities
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 006] Video-Browser: Towards Agentic Open-web Video Browsing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23044v2](https://arxiv.org/pdf/2512.23044v2)**

> **作者:** Zhengyang Liang; Yan Shu; Xiangrui Liu; Minghao Qin; Kaixin Liang; Nicu Sebe; Zheng Liu; Lizi Liao
>
...
>
---
#### [replaced 007] TriDF: Triplane-Accelerated Density Fields for Few-Shot Remote Sensing Novel View Synthesis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.13347v3](https://arxiv.org/pdf/2503.13347v3)**

> **作者:** Jiaming Kang; Keyan Chen; Zhengxia Zou; Zhenwei Shi
>
> **备注:** Corrected metadata formatting
>
...
>
---
#### [replaced 008] Better Language Models Exhibit Higher Visual Alignment
...
>
---
#### [replaced 011] FOF-X: Towards Real-time Detailed Human Reconstruction from a Single Image
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.05961v4](https://arxiv.org/pdf/2412.05961v4)**
...
>
---
#### [replaced 012] SAM-pose2seg: Pose-Guided Human Instance Segmentation in Crowds
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.08982v2](https://arxiv.org/pdf/2601.08982v2)**
...
>
---
#### [replaced 013] Beyond Feature Mapping GAP: Integrating Real HDRTV Priors for Superior SDRTV-to-HDRTV Conversion
- **分类: eess.IV; cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2411.10775v3](https://arxiv.org/pdf/2411.10775v3)**

> **作者:** Gang He; Kepeng Xu; Li Xu; Siqi Wang; Wenxin Yu; Xianyun Wu
>
...
>
---
#### [replaced 014] SENSE: Self-Supervised Neural Embeddings for Spatial Ensembles
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11145v2](https://arxiv.org/pdf/2512.11145v2)**

> **作者:** Hamid Gadirov; Lennard Manuel; Steffen Frey
>
> **备注:** Journal of Mathematics and Computer Science
>
...
>
---
#### [replaced 015] Zero-Shot Transfer Capabilities of the Sundial Foundation Model for Leaf Area Index Forecasting
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.20004v2](https://arxiv.org/pdf/2511.20004v2)**

> **作者:** Peining Zhang; Hongchen Qin; Haochen Zhang; Ziqi Guo; Guiling Wang; Jinbo Bi
>
> **备注:** 6 pages, 5 figures, AAAI 2026 AgriAI workshop
>
...
>
---
#### [replaced 016] MoLAN: A Unified Modality-Aware Noise Dynamic Editing Framework for Multimodal Sentiment Analysis
...
>
---
#### [replaced 017] FFP-300K: Scaling First-Frame Propagation for Generalizable Video Editing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.01720v3](https://arxiv.org/pdf/2601.01720v3)**
...
>
---
#### [replaced 018] A Safety Report on GPT-5.2, Gemini 3 Pro, Qwen3-VL, Grok 4.1 Fast, Nano Banana Pro, and Seedream 4.5
...
>
---
#### [replaced 019] MINGLE: VLMs for Semantically Complex Region Detection in Urban Scenes
- **分类: cs.CV; cs.CY**

- **链接: [https://arxiv.org/pdf/2509.13484v3](https://arxiv.org/pdf/2509.13484v3)**

> **作者:** Liu Liu; Alexandra Kudaeva; Marco Cipriano; Fatimeh Al Ghannam; Freya Tan; Gerard de Melo; Andres Sevtsuk
>
> **备注:** 13 pages, 4 figures Updated with the camera-ready version after acceptance
>
...
>
---
#### [replaced 022] V2X-Radar: A Multi-modal Dataset with 4D Radar for Cooperative Perception
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.10962v5](https://arxiv.org/pdf/2411.10962v5)**
...
>
---
#### [replaced 023] FiCo-ITR: bridging fine-grained and coarse-grained image-text retrieval for comparative performance analysis
- **分类: cs.IR; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2407.20114v3](https://arxiv.org/pdf/2407.20114v3)**
...
>
---
#### [replaced 024] Power to the Clients: Federated Learning in a Dictatorship Setting
...
>
---
#### [replaced 025] 3D latent diffusion models for parameterizing and history matching multiscenario facies systems
- **分类: physics.geo-ph; cs.CV**

- **链接: [https://arxiv.org/pdf/2508.16621v2](https://arxiv.org/pdf/2508.16621v2)**

> **作者:** Guido Di Federico; Louis J. Durlofsky
>
> **备注:** Text and Figures updated to reflect the journal version of the paper
>
...
>
---
#### [replaced 026] UIKA: Fast Universal Head Avatar from Pose-Free Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.07603v2](https://arxiv.org/pdf/2601.07603v2)**
...
>
---
#### [replaced 033] A Classification-Aware Super-Resolution Framework for Ship Targets in SAR Imagery
- **分类: cs.CV; cs.AI; eess.IV**

- **链接: [https://arxiv.org/pdf/2508.06407v2](https://arxiv.org/pdf/2508.06407v2)**
...
>
---
#### [replaced 036] ViSTA: Visual Storytelling using Multi-modal Adapters for Text-to-Image Diffusion Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.12198v3](https://arxiv.org/pdf/2506.12198v3)**
...
>
---
#### [replaced 039] NanoSD: Edge Efficient Foundation Model for Real Time Image Restoration
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.09823v2](https://arxiv.org/pdf/2601.09823v2)**

> **作者:** Subhajit Sanyal; Srinivas Soumitri Miriyala; Akshay Janardan Bankar; Manjunath Arveti; Sowmya Vajrala; Shreyas Pandith; Sravanth Kodavanti; Abhishek Ameta; Harshit; Amit Satish Unde
>
...
>
---
#### [replaced 040] Evaluating Foundation Models' 3D Understanding Through Multi-View Correspondence Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11574v2](https://arxiv.org/pdf/2512.11574v2)**
...
>
---
#### [replaced 041] Image2Garment: Simulation-ready Garment Generation from a Single Image
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.09658v2](https://arxiv.org/pdf/2601.09658v2)**
...
>
---
#### [replaced 042] SceneFoundry: Generating Interactive Infinite 3D Worlds
...
>
---
#### [replaced 043] MERGETUNE: Continued fine-tuning of vision-language models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.10497v2](https://arxiv.org/pdf/2601.10497v2)**
