...
#### [new 001] Black-Box On-Policy Distillation of Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出生成对抗蒸馏（GAD），解决黑盒环境下大模型无内部参数访问时的策略蒸馏问题，通过对抗训练使学生模型模仿教师输出，实现高效、自适应的在线策略蒸馏。**

- **链接: [https://arxiv.org/pdf/2511.10643v1](https://arxiv.org/pdf/2511.10643v1)**
...
>
---
#### [new 030] Reasoning About Intent for Ambiguous Requests
- **分类: cs.CL; cs.AI**

- **简介: 该论文面向模糊用户请求的意图理解任务，提出通过强化学习生成多解释-答案对，提升模型对歧义请求的覆盖度与透明度，解决单一解释导致的误解与安全风险。**

- **链接: [https://arxiv.org/pdf/2511.10453v1](https://arxiv.org/pdf/2511.10453v1)**
...
>
---
#### [new 034] Local Hybrid Retrieval-Augmented Document QA
- **分类: cs.CL**

- **简介: 该论文提出一种本地化混合检索增强问答系统，解决企业隐私与性能不可兼得的难题。通过结合语义与关键词检索，在离线环境下利用消费级硬件实现高精度问答，适用于法律、医疗等敏感领域。**

- **链接: [https://arxiv.org/pdf/2511.10297v1](https://arxiv.org/pdf/2511.10297v1)**
...
>
---
#### [new 044] LocalBench: Benchmarking LLMs on County-Level Local Knowledge and Reasoning
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 论文提出LocalBench，首个评估LLMs在县一级本地知识与推理能力的基准，解决现有评测忽视细粒度地方性问题。涵盖1.4万+问答对，揭示模型在本地叙事与数值推理上表现极差，且规模与检索未必提升性能。**

- **链接: [https://arxiv.org/pdf/2511.10459v1](https://arxiv.org/pdf/2511.10459v1)**

> **作者:** Zihan Gao; Yifei Xu; Jacob Thebault-Spieker
>
> **摘要:** Large language models (LLMs) have been widely evaluated on macro-scale geographic tasks, such as global factual recall, event summarization, and regional reasoning. Yet, their ability to handle hyper-local knowledge remains poorly understood. This gap is increasingly consequential as real-world applications, from civic platforms to community journalism, demand AI systems that can reason about neighborhood-specific dynamics, cultural narratives, and local governance. Existing benchmarks fall short in capturing this complexity, often relying on coarse-grained data or isolated references. We present LocalBench, the first benchmark designed to systematically evaluate LLMs on county-level local knowledge across the United States. Grounded in the Localness Conceptual Framework, LocalBench includes 14,782 validated question-answer pairs across 526 U.S. counties in 49 states, integrating diverse sources such as Census statistics, local subreddit discourse, and regional news. It spans physical, cognitive, and relational dimensions of locality. Using LocalBench, we evaluate 13 state-of-the-art LLMs under both closed-book and web-augmented settings. Our findings reveal critical limitations: even the best-performing models reach only 56.8% accuracy on narrative-style questions and perform below 15.5% on numerical reasoning. Moreover, larger model size and web augmentation do not guarantee better performance, for example, search improves Gemini's accuracy by +13.6%, but reduces GPT-series performance by -11.4%. These results underscore the urgent need for language models that can support equitable, place-aware AI systems: capable of engaging with the diverse, fine-grained realities of local communities across geographic and cultural contexts.
>
---
#### [new 045] HI-TransPA: Hearing Impairments Translation Personal Assistant
...
>
---
#### [new 053] TARG: Training-Free Adaptive Retrieval Gating for Efficient RAG
- **分类: cs.CL**

- **简介: TARG提出一种无训练的自适应检索门控机制，基于基座模型的简短草稿预测不确定性，动态决定是否检索，显著减少70-90%检索开销，同时保持或提升RAG准确性。**

- **链接: [https://arxiv.org/pdf/2511.09803v1](https://arxiv.org/pdf/2511.09803v1)**
...
>
---
#### [new 068] Enhancing the Medical Context-Awareness Ability of LLMs via Multifaceted Self-Refinement Learning
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出MuSeR方法，通过多维度自评估与自修正，提升LLMs在医疗场景中的上下文感知能力，解决其对用户身份、病史等关键信息缺失的响应不足问题，并在HealthBench上实现SOTA。**

- **链接: [https://arxiv.org/pdf/2511.10067v1](https://arxiv.org/pdf/2511.10067v1)**
...
>
---
#### [new 071] Compensating Distribution Drifts in Class-incremental Learning of Pre-trained Vision Transformers
...
>
---
#### [new 072] Towards Blind and Low-Vision Accessibility of Lightweight VLMs and Custom LLM-Evals
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 073] Music Flamingo: Scaling Music Understanding in Audio Language Models
- **分类: eess.AS; cs.CL**
...
>
---
#### [new 074] Rethinking the Reliability of Multi-agent System: A Perspective from Byzantine Fault Tolerance
- **分类: cs.MA; cs.AI; cs.CL**

- **简介: 该论文探讨LLM代理在多智能体系统中的可靠性，提出CP-WBFT共识机制，利用LLM的反思与判别能力，在高拜占庭故障率下显著提升系统稳定性，解决传统代理可靠性不足问题。**

- **链接: [https://arxiv.org/pdf/2511.10400v1](https://arxiv.org/pdf/2511.10400v1)**
...
>
---
#### [new 075] ProgRAG: Hallucination-Resistant Progressive Retrieval and Reasoning over Knowledge Graphs
- **分类: cs.AI; cs.CL**

- **简介: ProgRAG面向多跳知识图谱问答任务，解决LLM检索与推理易幻觉的问题，通过分解问题、渐进式路径扩展与不确定性剪枝，优化证据检索与上下文构造，提升推理可靠性。**

- **链接: [https://arxiv.org/pdf/2511.10240v1](https://arxiv.org/pdf/2511.10240v1)**
...
>
---
#### [new 078] AgentEvolver: Towards Efficient Self-Evolving Agent System
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: AgentEvolver提出一种自进化智能体系统，解决传统RL代理依赖人工数据、探索低效与样本利用率低的问题。通过自提问、自导航与自归因机制，实现无监督任务生成、高效探索与奖励优化，提升学习效率与适应性。**

- **链接: [https://arxiv.org/pdf/2511.10395v1](https://arxiv.org/pdf/2511.10395v1)**
...
>
> **摘要:** Autonomous agents powered by large language models (LLMs) have the potential to significantly enhance human productivity by reasoning, using tools, and executing complex tasks in diverse environments. However, current approaches to developing such agents remain costly and inefficient, as they typically require manually constructed task datasets and reinforcement learning (RL) pipelines with extensive random exploration. These limitations lead to prohibitively high data-construction costs, low exploration efficiency, and poor sample utilization. To address these challenges, we present AgentEvolver, a self-evolving agent system that leverages the semantic understanding and reasoning capabilities of LLMs to drive autonomous agent learning. AgentEvolver introduces three synergistic mechanisms: (i) self-questioning, which enables curiosity-driven task generation in novel environments, reducing dependence on handcrafted datasets; (ii) self-navigating, which improves exploration efficiency through experience reuse and hybrid policy guidance; and (iii) self-attributing, which enhances sample efficiency by assigning differentiated rewards to trajectory states and actions based on their contribution. By integrating these mechanisms into a unified framework, AgentEvolver enables scalable, cost-effective, and continual improvement of agent capabilities. Preliminary experiments indicate that AgentEvolver achieves more efficient exploration, better sample utilization, and faster adaptation compared to traditional RL-based baselines.
>
---
## 更新

#### [replaced 001] The Markovian Thinker: Architecture-Agnostic Linear Scaling of Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2510.06557v3](https://arxiv.org/pdf/2510.06557v3)**
...
>
---
#### [replaced 002] Graph of Attacks with Pruning: Optimizing Stealthy Jailbreak Prompt Generation for Enhanced LLM Content Moderation
- **分类: cs.CR; cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2501.18638v3](https://arxiv.org/pdf/2501.18638v3)**
...
>
---
#### [replaced 003] Test Set Quality in Multilingual LLM Evaluation
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2508.02635v2](https://arxiv.org/pdf/2508.02635v2)**
...
>
---
#### [replaced 004] A Critical Review of the Need for Knowledge-Centric Evaluation of Quranic Recitation
- **分类: cs.CL; cs.AI; cs.SD**
...
>
---
#### [replaced 005] Neural Correlates of Language Models Are Specific to Human Language
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2510.03156v2](https://arxiv.org/pdf/2510.03156v2)**
...
>
---
#### [replaced 010] Test-Time Reinforcement Learning for GUI Grounding via Region Consistency
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 011] Guess or Recall? Training CNNs to Classify and Localize Memorization in LLMs
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2508.02573v2](https://arxiv.org/pdf/2508.02573v2)**
...
>
---
#### [replaced 014] Unique Hard Attention: A Tale of Two Sides
- **分类: cs.LG; cs.CC; cs.CL; cs.FL**

- **链接: [https://arxiv.org/pdf/2503.14615v3](https://arxiv.org/pdf/2503.14615v3)**
...
>
---
#### [replaced 015] Enhanced Suicidal Ideation Detection from Social Media Using a CNN-BiLSTM Hybrid Model
- **分类: cs.CL; cs.AI; cs.CY**

- **链接: [https://arxiv.org/pdf/2501.11094v2](https://arxiv.org/pdf/2501.11094v2)**
...
>
---
#### [replaced 018] FHIR-AgentBench: Benchmarking LLM Agents for Realistic Interoperable EHR Question Answering
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.19319v2](https://arxiv.org/pdf/2509.19319v2)**
...
>
---
#### [replaced 019] Backdoor Attacks Against Speech Language Models
...
>
---
#### [replaced 022] Beyond the 80/20 Rule: High-Entropy Minority Tokens Drive Effective Reinforcement Learning for LLM Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.01939v2](https://arxiv.org/pdf/2506.01939v2)**
...
>
---
#### [replaced 027] In Good GRACEs: Principled Teacher Selection for Knowledge Distillation
- **分类: cs.LG; cs.CL**

- **链接: [https://arxiv.org/pdf/2511.02833v2](https://arxiv.org/pdf/2511.02833v2)**
...
>
---
#### [replaced 028] Xiaoice: Training-Free Video Understanding via Self-Supervised Spatio-Temporal Clustering of Semantic Features
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 029] Mitigating Multimodal Hallucinations via Gradient-based Self-Reflection
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 033] Investigating CoT Monitorability in Large Reasoning Models
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.08525v2](https://arxiv.org/pdf/2511.08525v2)**

> **作者:** Shu Yang; Junchao Wu; Xilin Gong; Xuansheng Wu; Derek Wong; Ninhao Liu; Di Wang
>
...
>
---
#### [replaced 034] Beyond Perplexity: Let the Reader Select Retrieval Summaries via Spectrum Projection Score
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2508.05909v2](https://arxiv.org/pdf/2508.05909v2)**

> **作者:** Zhanghao Hu; Qinglin Zhu; Siya Qi; Yulan He; Hanqi Yan; Lin Gui
>
> **备注:** Accepted by AAAI 2026 Oral. Project link: https://zhanghao-aaai2026-sps.github.io/AAAI2026-SPS/
>
...
>
---
#### [replaced 035] Retrieval-Augmented Generation in Medicine: A Scoping Review of Technical Implementations, Clinical Applications, and Ethical Considerations
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.05901v2](https://arxiv.org/pdf/2511.05901v2)**
...
>
---
#### [replaced 038] FactReasoner: A Probabilistic Approach to Long-Form Factuality Assessment for Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [https://arxiv.org/pdf/2502.18573v3](https://arxiv.org/pdf/2502.18573v3)**
...
>
---
#### [replaced 040] Chain-of-Lure: A Universal Jailbreak Attack Framework using Unconstrained Synthetic Narratives
- **分类: cs.CR; cs.CL**

- **链接: [https://arxiv.org/pdf/2505.17519v2](https://arxiv.org/pdf/2505.17519v2)**
...
>
---
#### [replaced 043] Captions Speak Louder than Images: Generalizing Foundation Models for E-commerce from High-quality Multimodal Instruction Data
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [https://arxiv.org/pdf/2410.17337v2](https://arxiv.org/pdf/2410.17337v2)**
...
>
---
#### [replaced 044] PsychCounsel-Bench: Evaluating the Psychology Intelligence of Large Language Models
- **分类: cs.AI; cs.CL**

- **链接: [https://arxiv.org/pdf/2510.01611v4](https://arxiv.org/pdf/2510.01611v4)**
...
>
---
#### [replaced 045] R1-Compress: Long Chain-of-Thought Compression via Chunk Compression and Search
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2505.16838v2](https://arxiv.org/pdf/2505.16838v2)**

> **作者:** Yibo Wang; Haotian Luo; Huanjin Yao; Tiansheng Huang; Haiying He; Rui Liu; Naiqiang Tan; Jiaxing Huang; Xiaochun Cao; Dacheng Tao; Li Shen
>
> **备注:** Accepted by NeurIPS FoRLM Workshop
>
...
>
---
#### [replaced 046] Thinking Forward and Backward: Multi-Objective Reinforcement Learning for Retrieval-Augmented Reasoning
- **分类: cs.CL; cs.AI; cs.IR**

- **链接: [https://arxiv.org/pdf/2511.09109v2](https://arxiv.org/pdf/2511.09109v2)**

> **作者:** Wenda Wei; Yu-An Liu; Ruqing Zhang; Jiafeng Guo; Lixin Su; Shuaiqiang Wang; Dawei Yin; Maarten de Rijke; Xueqi Cheng
>
> **摘要:** Retrieval-augmented generation (RAG) has proven to be effective in mitigating hallucinations in large language models, yet its effectiveness remains limited in complex, multi-step reasoning scenarios. Recent efforts have incorporated search-based interactions into RAG, enabling iterative reasoning with real-time retrieval. Most approaches rely on outcome-based supervision, offering no explicit guidance for intermediate steps. This often leads to reward hacking and degraded response quality. We propose Bi-RAR, a novel retrieval-augmented reasoning framework that evaluates each intermediate step jointly in both forward and backward directions. To assess the information completeness of each step, we introduce a bidirectional information distance grounded in Kolmogorov complexity, approximated via language model generation probabilities. This quantification measures both how far the current reasoning is from the answer and how well it addresses the question. To optimize reasoning under these bidirectional signals, we adopt a multi-objective reinforcement learning framework with a cascading reward structure that emphasizes early trajectory alignment. Empirical results on seven question answering benchmarks demonstrate that Bi-RAR surpasses previous methods and enables efficient interaction and reasoning with the search engine during training and inference.
>
---
#### [replaced 047] Information Capacity: Evaluating the Efficiency of Large Language Models via Text Compression
- **分类: cs.AI; cs.CL; eess.SP**

- **链接: [https://arxiv.org/pdf/2511.08066v3](https://arxiv.org/pdf/2511.08066v3)**
...
>
---
#### [replaced 048] Retrieval-Augmented Generation for Reliable Interpretation of Radio Regulations
- **分类: cs.IR; cs.AI; cs.CL; cs.LG; eess.SP**

- **链接: [https://arxiv.org/pdf/2509.09651v2](https://arxiv.org/pdf/2509.09651v2)**

> **作者:** Zakaria El Kassimi; Fares Fourati; Mohamed-Slim Alouini
>
> **备注:** 12 pages, 7 figures, AI4NextG @ NeurIPS 2025
>
...
>
---
#### [replaced 051] From Capabilities to Performance: Evaluating Key Functional Properties of LLM Architectures in Penetration Testing
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.14289v3](https://arxiv.org/pdf/2509.14289v3)**
...
>
---
#### [replaced 052] FlowMM: Cross-Modal Information Flow Guided KV Cache Merging for Efficient Multimodal Context Inference
- **分类: cs.CL**

- **链接: [https://arxiv.org/pdf/2511.05534v2](https://arxiv.org/pdf/2511.05534v2)**
...
>
---
#### [replaced 053] Why Do Open-Source LLMs Struggle with Data Analysis? A Systematic Empirical Study
- **分类: cs.CL; cs.AI; cs.IR; cs.LG; cs.MA**

- **链接: [https://arxiv.org/pdf/2506.19794v5](https://arxiv.org/pdf/2506.19794v5)**
