...
#### [new 001] VERM: Leveraging Foundation Models to Create a Virtual Eye for Efficient 3D Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 002] SORS: A Modular, High-Fidelity Simulator for Soft Robots
- **分类: cs.RO**

- **简介: 该论文提出SORS——一个基于能量法和有限元的高保真软体机器人仿真器，旨在解决现有仿真器在大变形、不可压缩材料与复杂接触下的精度低、扩展性差问题；通过模块化设计、SQP接触优化及多实验验证，提升仿真到实物的迁移能力。**

- **链接: [https://arxiv.org/pdf/2512.15994v1](https://arxiv.org/pdf/2512.15994v1)**
...
>
---
#### [new 007] PolaRiS: Scalable Real-to-Sim Evaluations for Generalist Robot Policies
- **分类: cs.RO; cs.LG**

- **简介: 该论文属机器人策略评估任务，旨在解决真实世界评估耗时、不可复现及仿真与现实存在域偏移的问题。作者提出PolaRiS框架，利用神经重建将真实场景视频转为交互式仿真环境，并通过仿真数据协同训练实现零样本迁移评估，显著提升仿真评估与真实性能的相关性。**

- **链接: [https://arxiv.org/pdf/2512.16881v1](https://arxiv.org/pdf/2512.16881v1)**
...
>
---
#### [new 011] A Formal Modular Synthesis Approach for the Coordination of 3-D Robotic Construction with Multi-robots
- **分类: cs.RO; cs.FL; cs.MA; eess.SY**

- **简介: 该论文属多机器人协同建造任务，旨在解决多移动机器人自主构建预定义3D结构的协调控制问题。基于监督控制理论，提出形式化模块化综合方法，从单机器人与目标结构模型中自动合成正确性可保证的反应式控制器（监督器），并支持复制部署以实现协同建造。**

- **链接: [https://arxiv.org/pdf/2512.16555v1](https://arxiv.org/pdf/2512.16555v1)**

> **作者:** Marcelo Rosa; José E. R. Cury; Fabio L. Baldissera
>
> **摘要:** In this paper, we deal with the problem of coordinating multiple robots to build 3-D structures. This problem consists of a set of mobile robots that interact with each other in order to autonomously build a predefined 3-D structure. Our approach is based on Supervisory Control Theory, and it allows us to synthesize from models that represent a single robot and the target structure a correct-by-construction reactive controller, called supervisor. When this supervisor is replicated for the other robots, then the target structure can be completed by all robots
>
---
#### [new 012] ReinforceGen: Hybrid Skill Policies with Automated Data Generation and Reinforcement Learning
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文针对长时程机器人操作任务，提出ReinforceGen系统：先通过任务分解、自动生成数据、模仿学习与运动规划构建初始策略，再用强化学习在线微调各模块。在Robosuite上达80%成功率，显著提升性能。**

- **链接: [https://arxiv.org/pdf/2512.16861v1](https://arxiv.org/pdf/2512.16861v1)**
...
>
---
#### [new 015] ManiLong-Shot: Interaction-Aware One-Shot Imitation Learning for Long-Horizon Manipulation
- **分类: cs.RO**

- **简介: 该论文提出ManiLong-Shot，解决现有单样本模仿学习（OSIL）难以处理长时程操作任务的问题。它将长任务分解为交互感知的基元序列，利用VLM或规则识别关键交互区域与对应关系，预测末端位姿。在仿真与真实机器人上验证了其泛化性与实用性。**

- **链接: [https://arxiv.org/pdf/2512.16302v1](https://arxiv.org/pdf/2512.16302v1)**
...
>
---
#### [new 019] SWIFT-Nav: Stability-Aware Waypoint-Level TD3 with Fuzzy Arbitration for UAV Navigation in Cluttered Environments
- **分类: cs.RO**

- **简介: 该论文面向无人机在杂乱动态环境中的导航任务，旨在解决路径规划的稳定性、实时性与安全性难题。提出SWIFT-Nav框架：融合TD3强化学习（含优先经验回放与衰减探索）、模糊逻辑安全门控，以及多目标奖励塑形，在保证实时响应的同时提升轨迹平滑性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2512.16027v1](https://arxiv.org/pdf/2512.16027v1)**
...
>
---
#### [new 021] A2VISR: An Active and Adaptive Ground-Aerial Localization System Using Visual Inertial and Single-Range Fusion
- **分类: cs.RO**

- **简介: 该论文提出A2VISR系统，解决无人机在遮挡、烟雾等复杂环境下视觉定位易失效的问题。通过地面车辆主动旋转红外相机跟踪无人机、融合单点测距与IMU/光流，设计自适应加权滑动窗估计算法，实现鲁棒实时定位（RMSE≈0.09m）。**

- **链接: [https://arxiv.org/pdf/2512.16367v1](https://arxiv.org/pdf/2512.16367v1)**
...
>
---
#### [new 025] Towards Closing the Domain Gap with Event Cameras
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 028] MomaGraph: State-Aware Unified Scene Graphs with Vision-Language Model for Embodied Task Planning
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 029] DVGT: Driving Visual Geometry Transformer
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 030] Driving in Corner Case: A Real-World Adversarial Closed-Loop Evaluation Platform for End-to-End Autonomous Driving
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 031] GeoPredict: Leveraging Predictive Kinematics and 3D Gaussian Geometry for Precise VLA Manipulation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 032] Privacy-Aware Sharing of Raw Spatial Sensor Data for Cooperative Perception
- **分类: cs.NI; cs.RO**

- **简介: 该论文属隐私保护下的协同感知任务，旨在解决车辆间共享原始空间传感器数据引发的隐私泄露问题。作者提出SHARP框架，在保障感知精度的同时最小化隐私泄漏，并探讨了实现该框架需解决的跨领域开放问题。**
...
>
---
#### [new 033] R4: Retrieval-Augmented Reasoning for Vision-Language Models in 4D Spatio-Temporal Space
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 034] Flowing from Reasoning to Motion: Learning 3D Hand Trajectory Prediction from Egocentric Human Interaction Videos
- **分类: cs.CV; cs.AI; cs.RO**
...
#### [replaced 001] VLG-Loc: Vision-Language Global Localization from Labeled Footprint Maps
- **分类: cs.RO**

- **简介: 该论文提出VLG-Loc，属机器人全局定位任务，旨在解决仅用带名称和面积的简略足迹地图（无几何/外观细节）实现鲁棒定位的难题。方法利用视觉语言模型匹配观测图像与地图地标，并在蒙特卡洛框架中评估位姿似然，融合视觉与扫描定位提升性能。**

- **链接: [https://arxiv.org/pdf/2512.12793v2](https://arxiv.org/pdf/2512.12793v2)**

> **作者:** Mizuho Aoki; Kohei Honda; Yasuhiro Yoshimura; Takeshi Ishita; Ryo Yonetani
>
> **备注:** v2: Updated the citation of SparseLoc from an arXiv preprint to its published version in the IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)
>
...
>
---
#### [replaced 002] Dual-Channel Tomographic Tactile Skin with Pneumatic Pressure Sensing for Improved Force Estimation
- **分类: cs.RO; eess.SP**

- **简介: 该论文提出双通道触觉皮肤，融合EIT（定位）与气压传感（力估计），解决EIT触觉皮肤力估计不准、校准复杂的问题。通过位置感知校正方法，仅单次标定即可实现空间一致的多接触力估计，兼顾高精度、易标定与大范围扩展性。**

- **链接: [https://arxiv.org/pdf/2503.13036v2](https://arxiv.org/pdf/2503.13036v2)**

> **作者:** Haofeng Chen; Jiri Kubik; Bedrich Himmel; Matej Hoffmann; Hyosang Lee
>
...
>
---
#### [replaced 003] Provable Ordering and Continuity in Vision-Language Pretraining for Generalizable Embodied Agents
...
>
---
#### [replaced 004] Transformer Driven Visual Servoing and Dual Arm Impedance Control for Fabric Texture Matching
- **分类: cs.RO**

- **简介: 该论文属于机器人视觉伺服与柔顺控制交叉任务，旨在解决双臂机器人对齐放置织物并匹配表面纹理的难题。提出Transformer驱动的视觉伺服与双臂阻抗控制融合方法，引入DEAM模块提升位姿差预测精度，仅用合成图像训练即实现真实场景零样本部署。**

- **链接: [https://arxiv.org/pdf/2511.21203v3](https://arxiv.org/pdf/2511.21203v3)**
...
>
---
#### [replaced 005] Expert Switching for Robust AAV Landing: A Dual-Detector Framework in Simulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 006] Long-Horizon Visual Imitation Learning via Plan and Code Reflection
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文面向长时序视觉模仿学习任务，旨在解决复杂动作序列中时空关系建模难的问题。提出含计划与代码双反射模块的框架：先生成动作计划并反思其时空一致性，再生成代码并反思其与计划的一致性。同时构建新基准LongVILBench进行评估。**

- **链接: [https://arxiv.org/pdf/2509.05368v3](https://arxiv.org/pdf/2509.05368v3)**
...
>
---
#### [replaced 007] "I am here for you": How relational conversational AI appeals to adolescents, especially those who are socially and emotionally vulnerable
- **分类: cs.HC; cs.AI; cs.RO**

- **简介: 该论文属人机交互与青少年心理安全交叉研究，旨在探究对话风格对青少年AI依赖的影响。通过284组亲子实验，比较关系型（拟人化）与透明型（强调非人类）聊天机器人回应方式，发现关系型更易引发青少年信任与情感亲近，尤受社交情绪脆弱者青睐，提示其潜在安全风险。**

- **链接: [https://arxiv.org/pdf/2512.15117v2](https://arxiv.org/pdf/2512.15117v2)**

> **作者:** Pilyoung Kim; Yun Xie; Sujin Yang
>
> **备注:** I updated a title
>
...
>
---
#### [replaced 008] Self-localization on a 3D map by fusing global and local features from a monocular camera
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 009] Unleashing Humanoid Reaching Potential via Real-world-Ready Skill Space
- **分类: cs.RO**

- **简介: 该论文属机器人控制任务，旨在解决人形机器人在真实世界中大范围三维可达性差、sim2real迁移难的问题。提出Real-world-Ready Skill Space（R2S2），构建经实机调优与验证的技能库，嵌入统一隐空间，并训练高层规划器采样技能，实现零样本sim2real目标到达。**

- **链接: [https://arxiv.org/pdf/2505.10918v2](https://arxiv.org/pdf/2505.10918v2)**
...
>
---
#### [replaced 010] D2E: Scaling Vision-Action Pretraining on Desktop Data for Transfer to Embodied AI
...
>
> **备注:** project page: https://suyuz1.github.io/Survery/
>
...
>
---
#### [replaced 013] Robust Finetuning of Vision-Language-Action Robot Policies via Parameter Merging
- **分类: cs.RO; cs.AI**

- **简介: 该论文属机器人策略微调任务，旨在解决通用视觉语言动作策略在少量新任务数据上微调时易过拟合、丢失泛化能力的问题。提出参数插值合并法，将微调模型与预训练模型权重融合，兼顾新任务鲁棒性与原有通用能力。**

- **链接: [https://arxiv.org/pdf/2512.08333v2](https://arxiv.org/pdf/2512.08333v2)**
