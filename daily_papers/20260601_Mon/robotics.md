...
>
---
#### [new 003] Wall-OSS-0.5 Technical Report
- **分类: cs.RO**

- **简介: 该论文属于机器人学习任务，旨在解决VLA预训练是否能直接生成可执行行为的问题。工作包括构建Wall-OSS-0.5模型，并验证其零样本和微调后的机器人性能。**
...
>
---
#### [new 004] LiftNav: Path Planning via Semantic Lifting in TSDF-Guided Gaussian Splatting
...
>
---
#### [new 007] Surface Constraint Policy for Learning Surface-Constrained and Dynamically Feasible Robot Skills
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，旨在解决复杂曲面约束下的动作生成问题。通过引入表面约束策略，结合人类示范与视觉感知，生成符合几何约束且动态可行的运动指令。**

- **链接: [https://arxiv.org/pdf/2605.31321](https://arxiv.org/pdf/2605.31321)**
...
>
---
#### [new 017] AR Forcing: Towards Long-Horizon Robot Navigation World Model
- **分类: cs.RO**

- **简介: 该论文属于机器人导航任务，解决长时程预测中的分布偏移问题。通过AR Forcing策略，在训练中引入自回归机制，提升模型在复杂环境下的鲁棒性与轨迹准确性。**

- **链接: [https://arxiv.org/pdf/2605.31314](https://arxiv.org/pdf/2605.31314)**
...
>
---
#### [new 021] ELAN4D: Embodiment-Centric 4D Supervision for Vision-Language-Action Models via Plug-and-Play Adaptation
- **分类: cs.RO**

- **简介: 该论文属于视觉-语言-动作模型任务，旨在解决机器人操作中策略泛化能力不足的问题。通过引入4D关键点轨迹监督，提升策略的鲁棒性与泛化性。**

- **链接: [https://arxiv.org/pdf/2605.30484](https://arxiv.org/pdf/2605.30484)**
...
>
---
#### [new 050] WristCompass: Kinematic Coupling as a Learnable Visual Concept for Ego-Camera Orientation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 051] Prior Availability in Industrial Visual Sim-to-Real: A Review of CAD-Guided and CAD-Unavailable Regimes
...
>
---
#### [new 052] Multi-Turn Multi-Agent Dialogue for Collaborative Reconstruction Improves VLM Performance on Spatial Reasoning, But Only Barely
- **分类: cs.CL; cs.RO**
...
>
---
#### [new 053] Probing Collision Grounding in Vision-Language Models for Safe Human-Robot Collaboration
...
>
---
#### [new 054] NTR: Neural Token Reconstruction for Scene Token Bottleneck in End-to-End Driving
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 055] Triangle Splatting SLAM
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 056] DisPlace: Discriminative Place Projections for Multi-Reference Visual Place Recognition
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 057] BOKBO (Best of K Bad Options): Calibrated Abstention for VLA Policies
- **分类: cs.LG; cs.RO**

- **简介: 该论文属于视觉-语言-动作（VLA）策略任务，解决K样本推理中的安全执行问题。提出BOKBO方法，实现安全拒绝，确保执行违规率的有限样本保证。**

- **链接: [https://arxiv.org/pdf/2605.30660](https://arxiv.org/pdf/2605.30660)**
...
>
---
#### [new 058] PInVerify: An Offline Embodied Benchmark for Active Instance Verification
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 002] Notes-to-Self: Scratchpad Augmented VLAs for Memory Dependent Manipulation Tasks
- **分类: cs.RO**

- **简介: 该论文研究记忆依赖的操纵任务，旨在解决VLAs在长序列任务中缺乏记忆的问题。通过引入语言便签，增强模型的空间和时间记忆能力，提升任务泛化性能。**

- **链接: [https://arxiv.org/pdf/2602.21013](https://arxiv.org/pdf/2602.21013)**
...
>
---
#### [replaced 005] Mixture of Horizons in Action Chunking
...
>
---
#### [replaced 006] LiteViLNet: Lightweight Vision-LiDAR Fusion Network for Efficient Road Segmentation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 009] Multi-Robot Box Transport over Different Surfaces with Decentralized Role-based Proportional Control
- **分类: cs.RO**

- **简介: 该论文研究多机器人协同搬运任务，解决不同表面条件下物体运输的挑战。提出R2P2方法，通过角色分配和比例控制实现有效协作。**
...
>
> **备注:** Accepted for presentation at the 2026 ASME IDETC-CIE
>
...
>
---
#### [replaced 010] Hyper-DP3: Frequency-Aware Right-Sizing of 3D Diffusion Policies for Visuomotor Control
- **分类: cs.RO**

- **简介: 该论文属于机器人视觉控制任务，解决3D扩散策略的效率问题。通过频率分析，提出轻量级HDP3模型，实现高效低延迟的行动生成。**
...
>
---
#### [replaced 011] SpaCeFormer: Fast Proposal-Free Open-Vocabulary 3D Instance Segmentation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 012] DGSG-Mind: Dynamic 3D Gaussian Scene Graphs for Long-Term Scene Understanding and Grounding
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 013] AnySlot: Goal-Conditioned Vision-Language-Action Policies for Zero-Shot Slot-Level Placement
- **分类: cs.RO**

- **简介: 该论文属于视觉-语言-动作策略任务，解决零样本槽位精准放置问题。提出AnySlot框架，通过显式空间目标提升放置精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.10432](https://arxiv.org/pdf/2604.10432)**

> **作者:** Zhaofeng Hu; Sifan Zhou; Qinbo Zhang; Rongtao Xu; Qi Su; Jorge Mendez-Mendz; Ci-Jyun Liang
>
...
>
---
#### [replaced 016] UniLab: A Heterogeneous Architecture for Robot RL Beyond GPU-Dominant Paradigms
- **分类: cs.RO**

- **简介: 该论文提出UniLab，解决机器人强化学习中GPU依赖过重的问题。通过CPU与GPU协同架构提升训练效率，支持多平台运行。**
...
>
---
#### [replaced 017] Collaborative Navigation and Exploration with $β$-Sparse Gaussian Processes
- **分类: cs.RO**

- **简介: 该论文属于多机器人协同导航任务，解决未知环境中信息传输与计算限制的问题。提出β-Sparse Gaussian Processes模型，实现高效地图点选择与探索策略，降低通信负担并优化路径。**
...
>
---
#### [replaced 018] Cross-Entropy Optimization of Physically Grounded Task and Motion Plans
- **分类: cs.RO**

- **简介: 该论文属于机器人任务与运动规划领域，解决传统方法忽略动力学和接触问题导致计划不可靠的问题。通过GPU加速物理模拟和交叉熵优化，生成考虑环境交互的高效运动计划。**

- **链接: [https://arxiv.org/pdf/2512.11571](https://arxiv.org/pdf/2512.11571)**
...
>
---
#### [replaced 019] SKETCH: Semantic Key-Point Conditioning for Long-Horizon Vessel Trajectory Prediction
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于船舶轨迹预测任务，旨在解决长时 horizon 预测中方向不一致和轨迹不合理的问题。通过引入语义关键点条件模型，提升预测精度与合理性。**

- **链接: [https://arxiv.org/pdf/2601.18537](https://arxiv.org/pdf/2601.18537)**
...
>
---
#### [replaced 020] Meta-Adaptive Beam Search Planning for Transformer-Based Reinforcement Learning Control of UAVs with Overhead Manipulators under Flight Disturbances
- **分类: cs.RO**

- **简介: 该论文属于无人机控制任务，解决无人机与机械臂协同运动中因扰动导致的轨迹跟踪问题。提出基于Transformer的强化学习框架，结合自适应束搜索规划，提升控制稳定性与精度。**
...
>
> **备注:** The paper will be reworked significantly
>
...
>
---
#### [replaced 021] Motion Tracking with Muscles: Predictive Control of a Parametric Musculoskeletal Canine Model
- **分类: cs.RO**

- **简介: 该论文属于肌肉骨骼建模与运动控制任务，旨在解决犬类运动模拟中的肌力激活预测问题。通过构建参数化模型并结合运动捕捉数据，提升控制框架的收敛性。**

- **链接: [https://arxiv.org/pdf/2506.23768](https://arxiv.org/pdf/2506.23768)**
...
>
---
#### [replaced 022] Safety-Critical Adaptive Impedance Control via Nonsmooth Control Barrier Functions under State and Input Constraints
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于机器人安全控制任务，解决机器人在不确定环境下的安全交互问题。通过非平滑控制屏障函数和自适应方法，确保关节状态安全并实现鲁棒阻抗跟踪。**
...
>
---
#### [replaced 023] Learning Generalizable Robot Policy with Human Demonstration Video as a Prompt
- **分类: cs.RO**

- **简介: 该论文属于机器人学习任务，旨在解决传统方法依赖大量人工操作数据的问题。通过人类示范视频直接生成通用机器人策略，无需新数据或微调。**

- **链接: [https://arxiv.org/pdf/2505.20795](https://arxiv.org/pdf/2505.20795)**
...
>
---
#### [replaced 027] LangMap: A Human-Verified Benchmark for Hierarchical Open-Vocabulary Goal Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 031] TIC-VLA: A Think-in-Control Vision-Language-Action Model for Robot Navigation in Dynamic Environments
- **分类: cs.RO**

- **简介: 该论文提出TIC-VLA模型，解决动态环境中机器人遵循语言指令并实时控制的问题。通过引入延迟感知机制，提升导航性能。**

- **链接: [https://arxiv.org/pdf/2602.02459](https://arxiv.org/pdf/2602.02459)**
...
>
---
#### [replaced 032] EBuddy: a workflow orchestrator for industrial human-machine collaboration
- **分类: cs.RO**

- **简介: 该论文提出EBuddy，一种用于工业人机协作的语音引导工作流协调器，解决专家知识难以规模化和执行质量下降的问题。通过有限状态机实现可解释的决策框架，提升协作效率与一致性。**
