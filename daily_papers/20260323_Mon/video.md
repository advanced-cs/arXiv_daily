...
>
---
#### [new 009] Wildfire Spread Scenarios: Increasing Sample Diversity of Segmentation Diffusion Models with Training-Free Methods
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，旨在提高扩散模型生成样本的多样性。通过训练-free方法，如粒子引导和聚类技术，提升样本多样性，同时保持图像质量。**

- **链接: [https://arxiv.org/pdf/2603.20188](https://arxiv.org/pdf/2603.20188)**
...
>
---
#### [new 011] One Model, Two Minds: Task-Conditioned Reasoning for Unified Image Quality and Aesthetic Assessment
- **分类: cs.CV**

- **简介: 该论文属于图像质量与审美评估任务，解决统一模型中任务不匹配问题，提出TATAR框架，通过任务条件推理和不对称奖励提升性能。**

- **链接: [https://arxiv.org/pdf/2603.19779](https://arxiv.org/pdf/2603.19779)**
...
>
---
#### [new 012] SurfaceXR: Fusing Smartwatch IMUs and Egocentric Hand Pose for Seamless Surface Interactions
- **分类: cs.CV; cs.HC; cs.LG**

- **简介: 论文提出SurfaceXR，融合智能手表IMU与手部姿态数据，解决XR中手势疲劳和精度低的问题，提升表面交互的准确性与稳定性。**

- **链接: [https://arxiv.org/pdf/2603.19529](https://arxiv.org/pdf/2603.19529)**
...
>
---
#### [new 017] VideoSeek: Long-Horizon Video Agent with Tool-Guided Seeking
...
>
---
#### [new 018] ReXInTheWild: A Unified Benchmark for Medical Photograph Understanding
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出ReXInTheWild基准，用于评估视觉-语言模型在医学图像理解中的表现。任务涉及医学图像与文本的多模态分析，解决现有模型在医学内容理解上的不足。**

- **链接: [https://arxiv.org/pdf/2603.19517](https://arxiv.org/pdf/2603.19517)**
...
>
---
#### [new 034] LagerNVS: Latent Geometry for Fully Neural Real-time Novel View Synthesis
- **分类: cs.CV**

- **简介: 该论文提出LagerNVS，用于实时新视角合成任务，通过3D感知的潜在特征提升性能，解决传统方法依赖3D重建的问题。**
...
>
---
#### [new 035] Dual-Domain Representation Alignment: Bridging 2D and 3D Vision via Geometry-Aware Architecture Search
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉模型优化任务，旨在解决大模型推理成本高和进化搜索效率低的问题。提出EvoNAS框架，结合双域知识蒸馏与分布式评估，提升模型精度与效率。**

- **链接: [https://arxiv.org/pdf/2603.19563](https://arxiv.org/pdf/2603.19563)**
...
>
---
#### [new 042] Diffusion-Based Makeup Transfer with Facial Region-Aware Makeup Features
- **分类: cs.CV**

- **简介: 该论文属于人脸妆容迁移任务，旨在解决现有方法无法有效捕捉妆容风格及缺乏区域控制的问题。通过构建面部区域感知的妆容特征，提升妆容迁移的精度与可控性。**
...
>
---
#### [new 051] RAM: Recover Any 3D Human Motion in-the-Wild
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出RAM，用于解决户外多人3D人体运动重建任务，通过融合跟踪、预测与特征融合，提升鲁棒性和准确性。**
...
>
---
#### [new 055] MME-CoF-Pro: Evaluating Reasoning Coherence in Video Generative Models with Text and Visual Hints
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决视频生成模型推理一致性评估问题。提出MME-CoF-Pro基准，通过不同提示方式评估模型的推理连贯性。**

- **链接: [https://arxiv.org/pdf/2603.20194](https://arxiv.org/pdf/2603.20194)**
...
>
---
#### [new 062] DynFlowDrive: Flow-Based Dynamic World Modeling for Autonomous Driving
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 063] Gastric-X: A Multimodal Multi-Phase Benchmark Dataset for Advancing Vision-Language Models in Gastric Cancer Analysis
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出Gastric-X数据集，用于胃癌分析的多模态视觉语言模型研究，解决医疗诊断中数据不足的问题，涵盖多种医学数据和任务。**
...
>
---
#### [new 064] Cov2Pose: Leveraging Spatial Covariance for Direct Manifold-aware 6-DoF Object Pose Estimation
- **分类: cs.CV**

- **简介: 该论文属于6-DoF物体位姿估计任务，解决直接方法精度不足的问题。提出基于空间协方差的连续表示和流形感知网络，提升位姿回归性能。**
...
>
---
#### [new 067] Learning Hierarchical Orthogonal Prototypes for Generalized Few-Shot 3D Point Cloud Segmentation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于3D点云分割任务，解决少样本下新类别适应与基础类性能保持的矛盾。提出HOP3D框架，通过层次正交原型和熵正则化实现高效适应。**

- **链接: [https://arxiv.org/pdf/2603.19788](https://arxiv.org/pdf/2603.19788)**
...
>
---
#### [new 070] ReLi3D: Relightable Multi-view 3D Reconstruction with Disentangled Illumination
- **分类: cs.CV; cs.GR**

- **简介: 该论文提出ReLi3D，解决多视角3D重建中几何、材质与光照分离的问题。通过统一管道同时重建完整3D资产，实现快速且可调光的3D生成。**

- **链接: [https://arxiv.org/pdf/2603.19753](https://arxiv.org/pdf/2603.19753)**
...
>
---
#### [new 071] FlashCap: Millisecond-Accurate Human Motion Capture via Flashing LEDs and Event-Based Vision
- **分类: cs.CV**

- **简介: 该论文提出FlashCap系统，解决高精度运动时间捕捉问题。构建了多模态数据集FlashMotion，提出ResPose方法，提升运动估计精度与时间准确性。**

- **链接: [https://arxiv.org/pdf/2603.19770](https://arxiv.org/pdf/2603.19770)**
...
>
---
#### [new 072] Evaluating Image Editing with LLMs: A Comprehensive Benchmark and Intermediate-Layer Probing Approach
- **分类: cs.CV**

- **简介: 该论文属于文本引导图像编辑任务，旨在解决评估方法不足的问题。提出TIEdit基准和EditProbe评估方法，提升评价的可靠性与感知一致性。**
...
>
---
#### [new 073] WorldAgents: Can Foundation Image Models be Agents for 3D World Models?
- **分类: cs.CV**

- **简介: 该论文属于3D世界建模任务，探讨2D基础图像模型是否具备3D世界建模能力。通过设计多代理框架，验证并提升了模型生成3D一致场景的能力。**

- **链接: [https://arxiv.org/pdf/2603.19708](https://arxiv.org/pdf/2603.19708)**
...
>
---
#### [new 077] dinov3.seg: Open-Vocabulary Semantic Segmentation with DINOv3
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于开放词汇语义分割任务，解决模型在未见类别上的泛化能力问题。通过设计专用架构、融合全局与局部特征、早期和后期优化视觉表示，提升分割精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2603.19531](https://arxiv.org/pdf/2603.19531)**
...
>
---
#### [new 083] Pedestrian Crossing Intent Prediction via Psychological Features and Transformer Fusion
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 086] Adaptive Greedy Frame Selection for Long Video Understanding
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 087] X-World: Controllable Ego-Centric Multi-Camera World Models for Scalable End-to-End Driving
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出X-World，用于自动驾驶的可控多摄像头世界建模，解决真实道路测试成本高、场景覆盖有限的问题。通过生成多视角视频实现稳定、可控制的仿真环境。**
...
>
---
#### [new 096] Can Large Multimodal Models Inspect Buildings? A Hierarchical Benchmark for Structural Pathology Reasoning
- **分类: cs.CV**

- **简介: 该论文属于建筑结构病理推理任务，旨在解决LMM在建筑检测中的定位精度不足问题。通过构建基准测试平台DefectBench，评估LMM的多维能力，并验证其在无监督情况下的可行性。**

- **链接: [https://arxiv.org/pdf/2603.20148](https://arxiv.org/pdf/2603.20148)**
...
>
---
#### [new 097] Physion-Eval: Evaluating Physical Realism in Generated Video via Human Reasoning
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在评估生成视频的物理真实性。通过构建专家推理基准，揭示当前模型在物理约束上的缺陷。**

- **链接: [https://arxiv.org/pdf/2603.19607](https://arxiv.org/pdf/2603.19607)**
...
>
---
#### [new 098] Instruction-Free Tuning of Large Vision Language Models for Medical Instruction Following
- **分类: cs.CV**

- **简介: 该论文属于医疗视觉语言模型的微调任务，旨在解决医学领域指令数据稀缺的问题。通过无需指令的微调方法，利用图像描述对进行训练，提升模型的指令遵循能力。**
...
>
---
#### [new 108] ParallelVLM: Lossless Video-LLM Acceleration with Visual Alignment Aware Parallel Speculative Decoding
- **分类: cs.CV**

- **简介: 该论文属于视频理解任务，旨在解决Video-LLM解码效率低的问题。提出ParallelVLM框架，通过并行推测解码和视觉对齐策略提升加速效果。**
...
>
---
#### [new 122] Transformers are Stateless Differentiable Neural Computers
...
>
---
#### [new 123] Significance-Gain Pair Encoding for LLMs: A Statistical Alternative to Frequency-Based Subword Merging
...
>
---
#### [new 124] Teaching an Agent to Sketch One Part at a Time
- **分类: cs.AI; cs.CV; cs.GR; cs.LG**

- **简介: 该论文属于文本到矢量草图生成任务，旨在解决生成过程的可解释性和可控性问题。通过结构化部分数据和视觉反馈，提升草图生成的局部编辑能力。**

- **链接: [https://arxiv.org/pdf/2603.19500](https://arxiv.org/pdf/2603.19500)**
...
>
---
#### [new 125] Subspace Kernel Learning on Tensor Sequences
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出UKTL框架，用于处理多模态张量序列的核学习任务，解决复杂交互与计算效率问题，通过子空间比较和不确定性加权提升模型性能与可解释性。**

- **链接: [https://arxiv.org/pdf/2603.19546](https://arxiv.org/pdf/2603.19546)**
...
>
---
#### [new 132] Beyond Single Tokens: Distilling Discrete Diffusion Models via Discrete MMD
- **分类: cs.LG; cs.CV; stat.ML**

- **简介: 该论文属于模型压缩任务，解决离散扩散模型难以蒸馏的问题。提出D-MMD方法，提升蒸馏后的生成质量与多样性。**

- **链接: [https://arxiv.org/pdf/2603.20155](https://arxiv.org/pdf/2603.20155)**
...
>
---
#### [replaced 003] G2HFNet: GeoGran-Aware Hierarchical Feature Fusion Network for Salient Object Detection in Optical Remote Sensing Images
- **分类: cs.CV**
...
>
---
#### [replaced 004] CompAgent: An Agentic Framework for Visual Compliance Verification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.00171](https://arxiv.org/pdf/2511.00171)**

> **作者:** Rahul Ghosh; Baishali Chaudhury; Hari Prasanna Das; Meghana Ashok; Ryan Razkenari; Long Chen; Sungmin Hong; Chun-Hao Liu
>
...
>
---
#### [replaced 005] CARES: Context-Aware Resolution Selector for VLMs
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.19496](https://arxiv.org/pdf/2510.19496)**
...
>
---
#### [replaced 006] IRIS: A Real-World Benchmark for Inverse Recovery and Identification of Physical Dynamic Systems from Monocular Video
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 009] Medical Image Spatial Grounding with Semantic Sampling
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2603.14579](https://arxiv.org/pdf/2603.14579)**
...
>
---
#### [replaced 015] Pseudo-Simulation for Autonomous Driving
...
>
---
#### [replaced 018] LED Benchmark: Diagnosing Structural Layout Errors for Document Layout Analysis
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.23295](https://arxiv.org/pdf/2507.23295)**

> **作者:** Inbum Heo; Taewook Hwang; Jeesu Jung; Sangkeun Jung
>
> **备注:** This work has been substantially revised, including updates to the title and content. The revised version is available as arXiv:2603.17265
>
...
>
---
#### [replaced 019] A$^2$-Edit: Precise Reference-Guided Image Editing of Arbitrary Objects and Ambiguous Masks
- **分类: cs.CV**
...
>
---
#### [replaced 021] ZOO-Prune: Training-Free Token Pruning via Zeroth-Order Gradient Estimation in Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.24837](https://arxiv.org/pdf/2509.24837)**
...
>
---
#### [replaced 022] Think and Answer ME: Benchmarking and Exploring Multi-Entity Reasoning Grounding in Remote Sensing
- **分类: cs.CV**
...
>
---
#### [replaced 023] Locally-Supervised Global Image Restoration
- **分类: cs.CV; math.NA**

- **链接: [https://arxiv.org/pdf/2511.01998](https://arxiv.org/pdf/2511.01998)**
...
>
---
#### [replaced 025] Generative Blocks World: Moving Things Around in Pictures
- **分类: cs.GR; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.20703](https://arxiv.org/pdf/2506.20703)**

> **作者:** Vaibhav Vavilala; Seemandhar Jain; Rahul Vasanth; D.A. Forsyth; Anand Bhattad
>
> **备注:** ICLR 2026 34 pages, 25 figures, 4 tables
>
...
>
---
#### [replaced 030] Exploring Disentangled and Controllable Human Image Synthesis: From End-to-End to Stage-by-Stage
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.19486](https://arxiv.org/pdf/2503.19486)**
...
>
> **备注:** A new version with additional experiments
>
...
>
---
#### [replaced 031] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2501.13558](https://arxiv.org/pdf/2501.13558)**
...
>
---
#### [replaced 032] Generalized Hand-Object Pose Estimation with Occlusion Awareness
- **分类: cs.CV**
...
>
---
#### [replaced 033] ReLaX: Reasoning with Latent Exploration for Large Reasoning Models
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.07558](https://arxiv.org/pdf/2512.07558)**
...
>
---
#### [replaced 034] Matryoshka Gaussian Splatting
- **分类: cs.CV; cs.GR**
...
>
---
#### [replaced 035] SRGS: Super-Resolution 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2404.10318](https://arxiv.org/pdf/2404.10318)**
...
>
---
#### [replaced 037] GazeShift: Unsupervised Gaze Estimation and Dataset for VR
- **分类: cs.CV**
...
>
---
#### [replaced 040] CycleCap: Improving VLMs Captioning Performance via Self-Supervised Cycle Consistency Fine-Tuning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.18282](https://arxiv.org/pdf/2603.18282)**

> **作者:** Marios Krestenitis; Christos Tzelepis; Konstantinos Ioannidis; Stefanos Vrochidis; Ioannis Kompatsiaris; Georgios Tzimiropoulos; Shaogang Gong; Ioannis Patras
>
...
>
---
#### [replaced 043] AC-Foley: Reference-Audio-Guided Video-to-Audio Synthesis with Acoustic Transfer
...
>
---
#### [replaced 046] SASNet: Spatially-Adaptive Sinusoidal Networks for INRs
- **分类: cs.CV**
...
>
> **备注:** CVPR2027, 10 pages, 10 figures
>
...
>
---
#### [replaced 047] Uncertainty-Aware Counterfactual Traffic Signal Control with Predictive Safety and Starvation-Avoidance Constraints Using Vision-Based Sensing
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.07784](https://arxiv.org/pdf/2602.07784)**
...
>
---
#### [replaced 048] VirPro: Visual-referred Probabilistic Prompt Learning for Weakly-Supervised Monocular 3D Detection
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 050] SpikeGrasp: A Benchmark for 6-DoF Grasp Pose Detection from Stereo Spike Streams
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 051] CageDroneRF: A Large-Scale RF Benchmark and Toolkit for Drone Perception
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 052] VR-Thinker: Boosting Video Reward Models through Thinking-with-Image Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.10518](https://arxiv.org/pdf/2510.10518)**

> **作者:** Qunzhong Wang; Jie Liu; Jiajun Liang; Yilei Jiang; Yuanxing Zhang; Yaozhi Zheng; Xintao Wang; Pengfei Wan; Xiangyu Yue; Jiaheng Liu
>
...
>
---
#### [replaced 053] Superclass-Guided Representation Disentanglement for Spurious Correlation Mitigation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2508.08570](https://arxiv.org/pdf/2508.08570)**
...
>
---
#### [replaced 054] A Multi-Agent Perception-Action Alliance for Efficient Long Video Reasoning
- **分类: cs.CV; cs.MA**
...
>
---
#### [replaced 055] Multimodal Continual Instruction Tuning with Dynamic Gradient Guidance
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.15164](https://arxiv.org/pdf/2511.15164)**
...
>
---
#### [replaced 056] Tinted Frames: Question Framing Blinds Vision-Language Models
- **分类: cs.CV**
...
>
---
#### [replaced 062] PoseMaster: A Unified 3D Native Framework for Stylized Pose Generation
- **分类: cs.CV**
...
>
---
#### [replaced 063] EgoSpot:Egocentric Multimodal Control for Hands-Free Mobile Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 064] Points-to-3D: Structure-Aware 3D Generation with Point Cloud Priors
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 065] Mash, Spread, Slice! Learning to Manipulate Object States via Visual Spatial Progress
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 066] Stand-In: A Lightweight and Plug-and-Play Identity Control for Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.07901](https://arxiv.org/pdf/2508.07901)**
