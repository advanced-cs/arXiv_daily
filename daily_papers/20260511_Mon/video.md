...
>
---
#### [new 004] Tracing the Arrow of Time: Diagnosing Temporal Information Flow in Video-LLMs
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 005] MedVIGIL: Evaluating Trustworthy Medical VLMs Under Broken Visual Evidence
- **分类: cs.CV**

- **简介: 该论文属于医疗视觉-语言模型评估任务，旨在解决模型在证据失效时仍给出错误答案的问题。通过构建评估集并引入临床专家标注，提出MedVIGIL基准进行模型审计。**
...
>
---
#### [new 008] Flow-OPD: On-Policy Distillation for Flow Matching Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于文本到图像生成任务，解决多任务对齐中的奖励稀疏和梯度干扰问题。提出Flow-OPD框架，通过策略蒸馏提升模型性能。**
...
>
---
#### [new 009] Disambiguating 2D-3D Correspondences in Gaussian Splatting-based Feature Fields for Visual Localization
- **分类: cs.CV**

- **简介: 该论文属于视觉定位任务，解决GSFF在2D-3D匹配中的歧义问题。通过拆分高斯并利用属性增强对应一致性，提升定位精度与稳定性。**

- **链接: [https://arxiv.org/pdf/2605.07351](https://arxiv.org/pdf/2605.07351)**
...
>
---
#### [new 028] TriP: A Triangle Puzzle Approach to Robust Translation Averaging
- **分类: cs.CV; cs.RO; math.NA**

- **简介: 该论文属于视觉定位任务，解决翻译平均问题。提出TriP方法，通过三角形几何实现鲁棒的相机位置恢复，具有高效和可扩展性。**

- **链接: [https://arxiv.org/pdf/2605.07143](https://arxiv.org/pdf/2605.07143)**

> **作者:** Zhekai Fan; Wanze Li; Jinxin Wang; Yunpeng Shi
>
> **摘要:** Translation averaging aims to recover camera locations from pairwise relative translation directions and is a fundamental component of global Structure-from-Motion pipelines. The problem is challenging because direction measurements contain no distance information, making the estimation problem highly ill-conditioned and highly sensitive to corrupted observations. In this paper, we propose TriP, a triangle-based framework for robust translation averaging. TriP first infers local relative edge scales from triangle geometry, and then synchronizes the scales of overlapping triangles in the logarithmic domain to recover globally consistent edge lengths and camera locations. By leveraging higher-order consistency across triangles, the proposed method is robust to adversarial, cycle-consistent, and other structured corruptions. In addition, TriP avoids the collapse issue without requiring any extra anti-collapse constraints, since log-scale synchronization excludes the degenerate zero-scale solution by construction. These structural advantages enable a particularly strong theory for exact location recovery. On the practical side, TriP is fully parallelizable, computationally efficient, and naturally scalable to graphs with millions of cameras. Moreover, it outperforms all previous translation averaging methods by a large margin on both synthetic and real datasets.
>
---
#### [new 029] EditTransfer++: Toward Faithful and Efficient Visual-Prompt-Guided Image Editing
- **分类: cs.CV**

- **简介: 该论文属于视觉提示引导的图像编辑任务，旨在解决现有方法在忠实性和效率上的不足。通过结构化训练和条件压缩策略，提升编辑准确性与速度。**

- **链接: [https://arxiv.org/pdf/2605.07455](https://arxiv.org/pdf/2605.07455)**
...
>
---
#### [new 030] DVD: Discrete Voxel Diffusion for 3D Generation and Editing
- **分类: cs.CV; cs.LG**

- **简介: 该论文提出DVD，用于3D生成与编辑的离散体素扩散框架，解决稀疏体素生成和编辑问题，通过离散建模提升可解释性和效率。**

- **链接: [https://arxiv.org/pdf/2605.07971](https://arxiv.org/pdf/2605.07971)**

> **作者:** Zhengrui Xiang; Jiaqi Wu; Fupeng Sun; Heliang Zheng; Yingzhen Li
>
> **摘要:** We introduce Discrete Voxel Diffusion (DVD), a discrete diffusion framework to generate, assess, and edit sparse voxels for SLat (Structured LATent) based 3D generative pipelines. Although discrete diffusion has not generally displaced continuous diffusion in image-like generation, we show that it can be an effective first-stage prior for sparse voxel scaffolds. By treating voxel occupancy as a native discrete variable, DVD avoids continuous-to-discrete thresholding and provides a simple framework for voxel generation, uncertainty estimation, and editing. Beyond quality gains, DVD provides more interpretable generation dynamics through explicit categorical modeling. Furthermore, we leverage the predictive entropy as a robust uncertainty metric to identify ambiguous voxel regions and complicated samples, facilitating tasks such as data filtering and quality assessment. Finally, we propose a lightweight fine-tuning strategy using block-structured perturbation patterns. This approach empowers the model to inpaint and edit voxels within a single sampling round, requiring negligible auxiliary computation and no additional model evaluations.
>
---
#### [new 031] Towards multi-modal forgery representation learning for AI-generated video detection and localization
- **分类: cs.CV**

- **简介: 该论文属于AI生成视频检测任务，旨在解决单模态检测不足和细粒度时间定位问题。通过多模态架构实现视频伪造的检测与定位。**

- **链接: [https://arxiv.org/pdf/2605.07232](https://arxiv.org/pdf/2605.07232)**
...
>
---
#### [new 040] ChartREG++: Towards Benchmarking and Improving Chart Referring Expression Grounding under Diverse referring clues and Multi-Target Referring
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 041] LensVLM: Selective Context Expansion for Compressed Visual Representation of Text
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出LensVLM，解决视觉语言模型在文本压缩下的准确率下降问题。通过选择性扩展相关区域，提升压缩场景下的性能。属于视觉语言模型任务。**

- **链接: [https://arxiv.org/pdf/2605.07019](https://arxiv.org/pdf/2605.07019)**
...
>
---
#### [new 050] One Token Per Frame: Reconsidering Visual Bandwidth in World Models for VLA Policy
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉-语言-动作（VLA）任务，解决世界模型参数化问题。通过引入OneWM-VLA，用单个语义token压缩视觉信息，提升长时序任务性能。**

- **链接: [https://arxiv.org/pdf/2605.07931](https://arxiv.org/pdf/2605.07931)**
...
>
---
#### [new 103] InterLV-Search: Benchmarking Interleaved Multimodal Agentic Search
...
>
---
#### [new 106] From Clouds to Hallucinations: Atmospheric Retrieval Hijacking in Remote Sensing Vision-Language RAG
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多模态RAG任务，旨在解决遥感视觉-语言系统中证据检索阶段的攻击问题。提出CloudWeb攻击方法，通过修改输入图像注入虚假天气证据，影响最终生成结果。**

- **链接: [https://arxiv.org/pdf/2605.07273](https://arxiv.org/pdf/2605.07273)**
...
>
---
#### [new 129] Real-IAD MVN: A Multi-View Normal Vector Dataset and Benchmark for High-Fidelity Industrial Anomaly Detection
- **分类: cs.CV**

- **简介: 该论文属于工业异常检测任务，解决几何缺陷检测难题。通过构建多视角法向量数据集Real-IAD-MVN，提升微小缺陷的检测效果。**

- **链接: [https://arxiv.org/pdf/2605.07149](https://arxiv.org/pdf/2605.07149)**
...
>
---
#### [new 143] Neurosymbolic Framework for Concept-Driven Logical Reasoning in Skeleton-Based Human Action Recognition
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于骨架动作识别任务，旨在解决模型不可解释的问题。通过神经符号框架，将动作识别转化为基于概念的逻辑推理，提升可解释性。**

- **链接: [https://arxiv.org/pdf/2605.07140](https://arxiv.org/pdf/2605.07140)**
...
>
---
#### [new 147] TimeLesSeg: Unified Contrast-Agnostic Cross-Sectional and Longitudinal MS Lesion Segmentation via a Stochastic Generative Model
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于多发性硬化症病灶分割任务，旨在解决跨截面与纵向数据分割不一致及对比度敏感的问题。提出TimeLesSeg框架，通过生成模型实现统一分割与对比度无关的准确分割。**

- **链接: [https://arxiv.org/pdf/2605.07955](https://arxiv.org/pdf/2605.07955)**
...
>
---
#### [new 164] Do Joint Audio-Video Generation Models Understand Physics?
...
>
---
#### [replaced 003] DualResolution Residual Architecture with Artifact Suppression for Melanocytic Lesion Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.06816](https://arxiv.org/pdf/2508.06816)**
...
>
---
#### [replaced 005] Think Before You Drive: World Model-Inspired Multimodal Grounding for Autonomous Vehicles
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 011] Bridging Restoration and Generation Manifolds in One-Step Diffusion for Real-World Super-Resolution
- **分类: cs.CV; eess.IV**
...
>
---
#### [replaced 012] Metric Unreliability in Multimodal Machine Unlearning: A Systematic Analysis and Principled Unified Score
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2605.02206](https://arxiv.org/pdf/2605.02206)**
...
>
---
#### [replaced 013] Dino U-Net: Exploiting High-Fidelity Dense Features from Foundation Models for Medical Image Segmentation
- **分类: cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2508.20909](https://arxiv.org/pdf/2508.20909)**

> **作者:** Haoyue Li; Yifan Gao; Feng Yuan; Xiaosong Wang; Xin Gao
>
> **备注:** MICCAI 2026
>
...
>
---
#### [replaced 016] Automatic Image-Level Morphological Trait Annotation for Organismal Images
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 019] NS-Net: Decoupling CLIP Semantic Information through NULL-Space for Generalizable AI-Generated Image Detection
- **分类: cs.CV**
...
>
---
#### [replaced 020] DeCo-DETR: Decoupled Cognition DETR for efficient Open-Vocabulary Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.02753](https://arxiv.org/pdf/2604.02753)**
...
>
---
#### [replaced 026] InterCoG: Towards Spatially Precise Image Editing with Interleaved Chain-of-Grounding Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.01586](https://arxiv.org/pdf/2603.01586)**
...
>
---
#### [replaced 030] Deeply Dual Supervised learning for melanoma recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.01994](https://arxiv.org/pdf/2508.01994)**
...
>
---
#### [replaced 039] Adapting Vision-Language Models for Neutrino Event Classification in High-Energy Physics
- **分类: cs.LG; cs.AI; cs.CV; hep-ex**

- **链接: [https://arxiv.org/pdf/2509.08461](https://arxiv.org/pdf/2509.08461)**

> **作者:** Dikshant Sagar; Kaiwen Yu; Alejandro Yankelevich; Jianming Bian; Pierre Baldi
>
> **备注:** Accepted for publication in Communications Physics (Nature Portfolio)
>
...
> **作者:** Chenjun Li
>
> **备注:** This article is withdrawn because the experimental results and analysis require substantial revision. The current version should not be cited as a reliable representation of the work
>
...
>
---
#### [replaced 054] Learning to Pose Problems: Reasoning-Driven and Solver-Adaptive Data Synthesis
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.09907](https://arxiv.org/pdf/2511.09907)**

> **作者:** Yongxian Wei; Yilin Zhao; Zixuan Hu; Li Shen; Xinrui Chen; Runxi Cheng; Sinan Du; Hao Yu; Chun Yuan; Dian Li
>
...
>
---
#### [replaced 055] Modality Gap-Driven Subspace Alignment Training Paradigm For Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [https://arxiv.org/pdf/2602.07026](https://arxiv.org/pdf/2602.07026)**

> **作者:** Xiaomin Yu; Yi Xin; Yuhui Zhang; Wenjie Zhang; Chonghan Liu; Hanzhen Zhao; Chen Liu; Xiaoxing Hu; Ziyue Qiao; Hao Tang; Xiaobin Hu; Chengwei Qin; Hui Xiong; Yu Qiao; Shuicheng Yan
>
...
>
---
#### [replaced 056] DisCo-FLoc: Semantic-Free Floorplan Localization via $SE(2)$-Aware Contrastive Disambiguation
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于视觉楼层定位任务，解决因结构重复导致的定位模糊问题。提出DisCo-FLoc方法，通过几何对比去歧义，无需语义信息即可提升定位精度。**

- **链接: [https://arxiv.org/pdf/2601.01822](https://arxiv.org/pdf/2601.01822)**

> **作者:** Ping Zhong; Shiyong Meng; Bolei Chen; Tao Zou; Chaoxu Mu; Jianxin Wang
>
...
>
---
#### [replaced 057] Multimodal Latent Reasoning via Hierarchical Visual Cues Injection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.05359](https://arxiv.org/pdf/2602.05359)**
...
>
---
#### [replaced 058] Clinically Aware Synthetic Image Generation for Concept Coverage in Chest X-ray Models
- **分类: cs.CV; cs.HC**

- **链接: [https://arxiv.org/pdf/2603.15525](https://arxiv.org/pdf/2603.15525)**

> **作者:** Amy Rafferty; Rishi Ramaesh; Ajitha Rajan
>
> **摘要:** Deep learning models for chest X-ray diagnosis are constrained by limited coverage of clinically meaningful concept combinations in publicly available training datasets. While synthetic image generation has been explored to increase data diversity, existing methods rarely enforce clinical or anatomical constraints, limiting utility for improving model reliability. We propose CARPA, a clinically aware and anatomically grounded framework for synthetic chest X-ray generation that applies targeted perturbations to clinical concept vectors while preserving anatomical structure. By producing anatomically faithful synthetic images with controlled concept insertions and deletions, CARPA expands clinically relevant concept coverage. We evaluate CARPA across seven backbone architectures by fine-tuning models on synthetic subsets and testing on a held-out MIMIC-CXR benchmark. Compared to prior concept perturbation approaches, fine-tuning on CARPA-generated images consistently improves precision-recall performance, reduces predictive uncertainty, and improves model calibration. Structural and semantic analyses demonstrate high anatomical fidelity, strong concept alignment, and low semantic uncertainty. Evaluation by two expert radiologists further confirms realism and clinical agreement. Together, these results show that anatomically grounded concept perturbations enable more effective use of synthetic data, improving both performance and reliability of chest X-ray classification models and supporting safer clinical deployment.
>
---
#### [replaced 059] Contrast-X: A Multi-Modal Contrast Image Synthesis Benchmark and Universal Modality Flow Matching
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.15884](https://arxiv.org/pdf/2601.15884)**

> **作者:** Yifan Chen; Fei Yin; Hao Chen; Jia Wu; Chao Li
>
> **摘要:** Contrast-enhanced imaging is central to oncologic diagnosis, but contrast agents can be contraindicated for many of the patients who need them most. Synthesizing contrast scans from non-contrast inputs is the natural response. Two obstacles stand in the way: no benchmark provides paired contrast data with lesion-level evaluation, and no single model handles the arbitrary missing patterns seen in practice. We introduce Contrast-X, a benchmark of paired contrast-enhanced and non-contrast imaging spanning 10 organs in CT (1{,}526 patients) and multi-phase breast DCE-MRI (1116 patients). Every case carries radiologist-verified phase labels and tumor masks. We further propose FlowMI, a single model that handles arbitrary subsets of available modalities through a unified multi-modal latent space and flow matching. We benchmark a range of missing-modality configurations, reporting standard image-quality metrics, radiologist reader studies, and downstream lesion analysis on the synthesized scans. We further evaluate cross-organ generalization to test whether the model has learned a transferable contrast-enhancement operation. Dataset, code, and leaderboard will be released. Our code are available at this https URL.
>
---
#### [replaced 060] Retina-RAG: Retrieval-Augmented Vision-Language Modeling for Joint Retinal Diagnosis and Clinical Report Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2605.06173](https://arxiv.org/pdf/2605.06173)**
...
>
---
#### [replaced 066] Lossy Common Information in a Learnable Gray-Wyner Network
...
>
---
#### [replaced 067] Pretty Good Measurement for Radiomics: A Quantum-Inspired Multi-Class Classifier for Lung Cancer Subtyping and Prostate Cancer Risk Stratification
- **分类: cs.CV; quant-ph**

- **链接: [https://arxiv.org/pdf/2603.00223](https://arxiv.org/pdf/2603.00223)**
...
>
---
#### [replaced 074] DKDS: A Benchmark Dataset of Degraded Kuzushiji Documents with Seals for Detection and Binarization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.09117](https://arxiv.org/pdf/2511.09117)**

> **作者:** Rui-Yang Ju; Kohei Yamashita; Hirotaka Kameko; Shinsuke Mori
>
> **备注:** IJDAR 2026 (ICDAR-IJDAR Track)
>
...
>
---
#### [replaced 077] A Unified and Controllable Framework for Layered Image Generation with Visual Effects
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.15507](https://arxiv.org/pdf/2601.15507)**
...
>
---
#### [replaced 078] AGILE: Hand-Object Interaction Reconstruction from Video via Agentic Generation
- **分类: cs.CV; cs.GR; cs.RO**

- **简介: 该论文提出AGILE框架，解决单目视频中手物交互重建问题。通过生成式方法和鲁棒跟踪策略，提升几何准确性与物理合理性，适用于机器人和VR应用。**
...
>
---
#### [replaced 079] GraphFusion3D: Dynamic Graph Attention Convolution with Adaptive Cross-Modal Transformer for 3D Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02991](https://arxiv.org/pdf/2512.02991)**

> **作者:** Md Sohag Mia; Md Nahid Hasan; Muhammad Abdullah Adnan
>
...
>
---
#### [replaced 084] Motion-o: Trajectory-Grounded Video Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2603.18856](https://arxiv.org/pdf/2603.18856)**
...
>
---
#### [replaced 087] VISD: Enhancing Video Reasoning via Structured Self-Distillation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 088] Multispectral Indices for Wildfire Management
- **分类: eess.IV; cs.CV; physics.geo-ph**

- **链接: [https://arxiv.org/pdf/2309.01751](https://arxiv.org/pdf/2309.01751)**

> **作者:** Afonso Oliveira; João P. Matos-Carvalho; Filipe Moutinho; Nuno Fachada
>
> **备注:** The peer-reviewed version of this paper is published in Frontiers in Remote Sensing at this https URL. This version is typeset by the authors and differs only in pagination and typographical detail
>
> **摘要:** The increasing frequency and severity of wildfires necessitates advanced methods for effective surveillance and management, as traditional ground-based techniques often struggle to adapt to rapidly changing fire behavior and environmental conditions. This study investigates the use of multispectral aerial and satellite imagery for wildfire management through an assessment of current literature and two practical case studies. We evaluate several multispectral indices for their ability to extract environmental features critical for analyzing wildfire behavior, including vegetation, water bodies, and artificial structures. Our results highlight NVDI for vegetation, MNDWI for water features, and MSR for artificial structures as particularly effective for segmentation and feature extraction. The application of these indices enhances wildfire data processing and supports improved monitoring, risk assessment, and response strategies, demonstrating the potential of multispectral imagery to complement traditional wildfire monitoring and management approaches.
>
---
#### [replaced 089] Physics-Based Benchmarking Metrics for Multimodal Synthetic Images
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.15204](https://arxiv.org/pdf/2511.15204)**
...
>
---
#### [replaced 090] Direction-Flipped Influence Audits Reveal Hidden Structure in Moral Choices of LLMs
...
>
---
#### [replaced 091] A Step to Decouple Optimization in 3DGS
- **分类: cs.CV**
...
>
---
#### [replaced 092] LR-SGS: Robust LiDAR-Reflectance-Guided Salient Gaussian Splatting for Self-Driving Scene Reconstruction
- **分类: cs.CV; cs.AI**
