...
>
---
#### [new 003] Where, What, Why: Toward Explainable 3D-GS Watermarking
- **分类: cs.CV**

- **简介: 该论文属于3D水印任务，解决如何在保持视觉质量的同时实现鲁棒水印嵌入的问题。提出一种框架，分离写入位置与质量保持，提升水印鲁棒性与可解释性。**
...
>
---
#### [new 006] MEGC2026: Micro-Expression Grand Challenge on Visual Question Answering
- **分类: cs.CV; cs.MM**

- **简介: 该论文属于微表情分析任务，旨在提升视觉问答中微表情的理解与检测。通过ME-VQA和ME-LVQA两个任务，解决短时和长时视频中的微表情识别问题。**

- **链接: [https://arxiv.org/pdf/2603.08927](https://arxiv.org/pdf/2603.08927)**
...
>
---
#### [new 007] RiO-DETR: DETR for Real-time Oriented Object Detection
- **分类: cs.CV**

- **简介: 该论文属于实时旋转目标检测任务，解决传统DETR在处理旋转边界框时的定向依赖、角度周期性及搜索空间过大问题，通过创新设计提升检测效率与准确性。**

- **链接: [https://arxiv.org/pdf/2603.09411](https://arxiv.org/pdf/2603.09411)**
...
>
---
#### [new 010] Reviving ConvNeXt for Efficient Convolutional Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于图像生成任务，旨在提升扩散模型的效率。通过改进ConvNeXt结构，提出FCDM模型，在减少计算量和训练步骤的同时保持性能。**

- **链接: [https://arxiv.org/pdf/2603.09408](https://arxiv.org/pdf/2603.09408)**
...
>
---
#### [new 016] The Patrologia Graeca Corpus: OCR, Annotation, and Open Release of Noisy Nineteenth-Century Polytonic Greek Editions
- **分类: cs.CV**

- **简介: 该论文属于OCR与语言资源构建任务，解决十九世纪希腊语版面复杂、字体退化的文本识别问题。通过定制化流程实现高精度OCR，并构建六百万词的标注语料库。**

- **链接: [https://arxiv.org/pdf/2603.09470](https://arxiv.org/pdf/2603.09470)**
...
>
---
#### [new 021] Point Cloud as a Foreign Language for Multi-modal Large Language Model
- **分类: cs.CV**

- **简介: 该论文属于多模态大语言模型任务，旨在解决3D数据与语言理解的语义对齐问题。提出SAGE模型，直接处理点云数据，提升3D理解效果与计算效率。**

- **链接: [https://arxiv.org/pdf/2603.09173](https://arxiv.org/pdf/2603.09173)**
...
>
---
#### [new 038] Stepping VLMs onto the Court: Benchmarking Spatial Intelligence in Sports
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型的空间智能任务，旨在提升VLM在体育场景中的空间理解能力。研究构建了CourtSI数据集和评估基准，验证了现有模型的不足，并通过微调提升了性能。**

- **链接: [https://arxiv.org/pdf/2603.09896](https://arxiv.org/pdf/2603.09896)**
...
>
---
#### [new 039] YOLO-NAS-Bench: A Surrogate Benchmark with Self-Evolving Predictors for YOLO Architecture Search
- **分类: cs.CV**

- **简介: 该论文属于目标检测领域的神经架构搜索任务，旨在解决评估成本高和缺乏专用基准的问题。构建了YOLO-NAS-Bench基准，并设计自进化机制提升预测器性能。**

- **链接: [https://arxiv.org/pdf/2603.09405](https://arxiv.org/pdf/2603.09405)**
...
>
---
#### [new 040] MA-EgoQA: Question Answering over Egocentric Videos from Multiple Embodied Agents
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MA-EgoQA任务，解决多具身智能体视频问答问题。旨在提升系统对多视角视频的协同理解与记忆构建能力。**
...
>
---
#### [new 041] Transformer-Based Multi-Region Segmentation and Radiomic Analysis of HR-pQCT Imaging
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在解决 osteoporosis 诊断中忽略软组织的问题。通过自动分割 HR-pQCT 图像并提取放射组学特征，提升诊断准确性。**
...
>
---
#### [new 042] Test-time Ego-Exo-centric Adaptation for Action Anticipation via Multi-Label Prototype Growing and Dual-Clue Consistency
- **分类: cs.CV**

- **简介: 该论文属于Ego-Exo适应任务，旨在解决测试阶段模型适应目标视角的问题。提出DCPGN网络，通过多标签原型增长和双线索一致性提升动作预测效果。**
...
>
---
#### [new 046] VarSplat: Uncertainty-aware 3D Gaussian Splatting for Robust RGB-D SLAM
- **分类: cs.CV**

- **简介: 该论文属于RGB-D SLAM任务，旨在解决低纹理、透明或复杂反射场景下的定位与建图问题。通过引入不确定性感知的3D高斯点云渲染方法，提升系统鲁棒性。**

- **链接: [https://arxiv.org/pdf/2603.09673](https://arxiv.org/pdf/2603.09673)**

> **作者:** Anh Thuan Tran; Jana Kosecka
>
> **备注:** Accepted to CVPR 2026
>
> **摘要:** Simultaneous Localization and Mapping (SLAM) with 3D Gaussian Splatting (3DGS) enables fast, differentiable rendering and high-fidelity reconstruction across diverse real-world scenes. However, existing 3DGS-SLAM approaches handle measurement reliability implicitly, making pose estimation and global alignment susceptible to drift in low-texture regions, transparent surfaces, or areas with complex reflectance properties. To this end, we introduce VarSplat, an uncertainty-aware 3DGS-SLAM system that explicitly learns per-splat appearance variance. By using the law of total variance with alpha compositing, we then render differentiable per-pixel uncertainty map via efficient, single-pass rasterization. This map guides tracking, submap registration, and loop detection toward focusing on reliable regions and contributes to more stable optimization. Experimental results on Replica (synthetic) and TUM-RGBD, ScanNet, and ScanNet++ (real-world) show that VarSplat improves robustness and achieves competitive or superior tracking, mapping, and novel view synthesis rendering compared to existing studies for dense RGB-D SLAM.
>
---
#### [new 047] A saccade-inspired approach to image classification using visiontransformer attention maps
- **分类: cs.CV**

- **简介: 论文提出一种受眼动启发的图像分类方法，利用Vision Transformer的注意力图聚焦关键区域。任务为图像分类，解决如何提升模型效率与性能的问题。**
...
>
---
#### [new 048] A Guideline-Aware AI Agent for Zero-Shot Target Volume Auto-Delineation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于放射治疗中的靶区自动勾画任务，旨在解决传统深度学习模型依赖标注数据、难以适应指南更新的问题。提出OncoAgent框架，无需训练即可根据指南生成三维靶区，提升合规性和可解释性。**

- **链接: [https://arxiv.org/pdf/2603.09448](https://arxiv.org/pdf/2603.09448)**
...
>
---
#### [new 059] SVG-EAR: Parameter-Free Linear Compensation for Sparse Video Generation via Error-aware Routing
- **分类: cs.CV**

- **简介: 该论文针对视频生成任务中的注意力计算效率问题，提出SVG-EAR方法，在不增加训练成本的情况下，通过聚类补偿提升稀疏注意力的准确性与效率。**

- **链接: [https://arxiv.org/pdf/2603.08982](https://arxiv.org/pdf/2603.08982)**
...
>
---
#### [new 063] Granulon: Awakening Pixel-Level Visual Encoders with Adaptive Multi-Granularity Semantics for MLLM
- **分类: cs.CV**

- **简介: 该论文提出Granulon，解决MLLM中视觉编码器在多粒度语义理解上的不足。通过自适应粒度控制与聚合模块，提升视觉理解精度与一致性。**

- **链接: [https://arxiv.org/pdf/2603.08800](https://arxiv.org/pdf/2603.08800)**
...
>
---
#### [new 069] When to Lock Attention: Training-Free KV Control in Video Diffusion
- **分类: cs.CV; cs.AI; cs.ET; eess.IV**

- **简介: 该论文属于视频编辑任务，解决背景一致性与前景质量提升的矛盾。提出KV-Lock框架，通过动态调节关键值锁定和引导尺度，提升生成质量与背景稳定性。**

- **链接: [https://arxiv.org/pdf/2603.09657](https://arxiv.org/pdf/2603.09657)**
...
>
---
#### [new 076] TubeMLLM: A Foundation Model for Topology Knowledge Exploration in Vessel-like Anatomy
- **分类: cs.CV**

- **简介: 该论文提出TubeMLLM，解决医学管状结构拓扑建模问题，通过融合语言与视觉信息提升拓扑感知能力。**
...
>
---
#### [new 080] MedKCO: Medical Vision-Language Pretraining via Knowledge-Driven Cognitive Orchestration
- **分类: cs.CV**

- **简介: 该论文属于医学视觉-语言预训练任务，旨在解决模型同时学习简单与复杂概念导致的特征表示不佳问题。提出MedKCO方法，通过知识驱动的课程设计和自适应对比损失提升性能。**

- **链接: [https://arxiv.org/pdf/2603.09101](https://arxiv.org/pdf/2603.09101)**
...
>
---
#### [new 081] ReCoSplat: Autoregressive Feed-Forward Gaussian Splatting Using Render-and-Compare
- **分类: cs.CV**

- **简介: 该论文提出ReCoSplat，解决在线新视角合成问题，通过自回归高斯点云渲染与对比模块，提升重建稳定性与长序列处理能力。**

- **链接: [https://arxiv.org/pdf/2603.09968](https://arxiv.org/pdf/2603.09968)**
...
>
---
#### [new 082] GeoAlignCLIP: Enhancing Fine-Grained Vision-Language Alignment in Remote Sensing via Multi-Granular Consistency Learning
- **分类: cs.CV**

- **简介: 该论文属于遥感视觉-语言对齐任务，旨在解决现有模型难以捕捉细粒度信息的问题。提出GeoAlignCLIP框架，通过多粒度语义对齐和一致性学习提升模型性能。**

- **链接: [https://arxiv.org/pdf/2603.09566](https://arxiv.org/pdf/2603.09566)**
...
>
---
#### [new 083] FrameDiT: Diffusion Transformer with Frame-Level Matrix Attention for Efficient Video Generation
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决扩散模型在建模复杂时空动态时的效率与效果平衡问题。提出Matrix Attention机制，提升视频生成的时空一致性与质量。**
...
>
---
#### [new 084] FetalAgents: A Multi-Agent System for Fetal Ultrasound Image and Video Analysis
- **分类: cs.CV; cs.MA**

- **简介: 该论文提出FetalAgents，一个用于胎儿超声图像和视频分析的多智能体系统，解决自动化分析中准确性和全流程适应性的平衡问题。**

- **链接: [https://arxiv.org/pdf/2603.09733](https://arxiv.org/pdf/2603.09733)**
...
>
---
#### [new 088] X-GS: An Extensible Open Framework Unifying 3DGS Architectures with Downstream Multimodal Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 089] Streaming Autoregressive Video Generation via Diagonal Distillation
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，解决实时流式生成中模型效率与质量的平衡问题。通过提出Diagonal Distillation方法，提升视频生成速度与运动连贯性。**
...
>
---
#### [new 090] WikiCLIP: An Efficient Contrastive Baseline for Open-domain Visual Entity Recognition
- **分类: cs.CV**

- **简介: 该论文属于开放域视觉实体识别任务，旨在提升模型性能并降低计算成本。提出WikiCLIP框架，利用语言模型嵌入和视觉引导知识适配器，实现高效准确的实体识别。**
...
>
---
#### [new 091] Physics-Driven 3D Gaussian Rendering for Zero-Shot MRI Super-Resolution
- **分类: cs.CV**

- **简介: 该论文属于MRI超分辨率任务，旨在解决高分辨率MRI获取时间长和运动伪影的问题。提出一种基于物理驱动的3D高斯渲染方法，平衡数据需求与计算效率。**

- **链接: [https://arxiv.org/pdf/2603.09621](https://arxiv.org/pdf/2603.09621)**
...
>
---
#### [new 103] WS-Net: Weak-Signal Representation Learning and Gated Abundance Reconstruction for Hyperspectral Unmixing via State-Space and Weak Signal Attention Fusion
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于高光谱解混任务，旨在解决弱信号被掩盖导致的估计不准确问题。提出WS-Net框架，结合状态空间建模和弱信号注意力机制，提升弱端元识别精度。**

- **链接: [https://arxiv.org/pdf/2603.09037](https://arxiv.org/pdf/2603.09037)**
...
>
---
#### [new 110] Open-World Motion Forecasting
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 114] CIGPose: Causal Intervention Graph Neural Network for Whole-Body Pose Estimation
- **分类: cs.CV**

- **简介: 该论文提出CIGPose框架，解决全身姿态估计中因视觉上下文导致的不真实预测问题。通过因果干预模块和图神经网络提升模型鲁棒性与准确性。**
...
>
---
#### [new 115] EXPLORE-Bench: Egocentric Scene Prediction with Long-Horizon Reasoning
...
>
---
#### [new 116] Distributed Convolutional Neural Networks for Object Recognition
- **分类: cs.CV**

- **简介: 该论文属于目标识别任务，旨在解决正类特征提取与区分问题。提出一种新型损失函数，使分布式CNN仅学习正类特征，提升识别效果。**

- **链接: [https://arxiv.org/pdf/2603.09220](https://arxiv.org/pdf/2603.09220)**
...
>
---
#### [new 117] DISPLAY: Directable Human-Object Interaction Video Generation via Sparse Motion Guidance and Multi-Task Auxiliary
- **分类: cs.CV**

- **简介: 该论文属于人-物交互视频生成任务，旨在解决现有方法控制性差、物理一致性不足的问题。提出DISPLAY框架，使用稀疏运动引导和多任务辅助训练，提升生成视频的精度与可控性。**

- **链接: [https://arxiv.org/pdf/2603.09883](https://arxiv.org/pdf/2603.09883)**
...
>
---
#### [new 118] Agentic AI as a Network Control-Plane Intelligence Layer for Federated Learning over 6G
- **分类: cs.CV**

- **简介: 该论文属于联邦学习任务，旨在解决6G网络中分布式学习的效率与可靠性问题。通过引入代理AI作为控制层，优化客户端选择、资源分配等过程，提升系统性能。**
...
>
---
#### [new 119] AutoViVQA: A Large-Scale Automatically Constructed Dataset for Vietnamese Visual Question Answering
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于越南语视觉问答任务，旨在提升多模态模型的性能。通过构建大规模数据集并探索基于Transformer的模型，解决语言与视觉信息融合及评估指标对齐问题。**
...
>
---
#### [new 122] Prune Redundancy, Preserve Essence: Vision Token Compression in VLMs via Synergistic Importance-Diversity
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型优化任务，旨在解决视觉令牌冗余问题。提出PruneSID方法，通过语义聚类和非极大值抑制实现高效压缩，提升计算效率并保持性能。**
...
>
---
#### [new 126] $M^2$-Occ: Resilient 3D Semantic Occupancy Prediction for Autonomous Driving with Incomplete Camera Inputs
- **分类: cs.CV; cs.RO; eess.IV**
...
>
---
#### [new 127] ProGS: Towards Progressive Coding for 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于3D数据压缩任务，旨在解决3DGS数据存储和传输效率低的问题。提出ProGS方法，通过八叉树结构实现渐进式编码，提升压缩效率与视觉质量。**

- **链接: [https://arxiv.org/pdf/2603.09703](https://arxiv.org/pdf/2603.09703)**
...
>
---
#### [new 128] What is Missing? Explaining Neurons Activated by Absent Concepts
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于可解释AI任务，旨在解决XAI方法难以揭示神经元对缺失概念的激活问题。通过改进 attribution 和特征可视化方法，识别并解释模型中由概念缺失引发的激活。**
...
>
---
#### [new 129] Context-Nav: Context-Driven Exploration and Viewpoint-Aware 3D Spatial Reasoning for Instance Navigation
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 130] Ego: Embedding-Guided Personalization of Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉语言模型个性化任务，旨在解决模型通用性不足的问题。通过提取视觉token作为概念记忆，实现高效个性化，无需额外训练。**
...
>
---
#### [new 131] GIIM: Graph-based Learning of Inter- and Intra-view Dependencies for Multi-view Medical Image Diagnosis
- **分类: cs.CV**

- **简介: 该论文属于多视角医学图像诊断任务，旨在解决现有方法忽略视图内与视图间依赖关系及数据不完整的问题。提出GIIM模型，通过图学习同时建模这些关系，提升诊断准确性与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2603.09446](https://arxiv.org/pdf/2603.09446)**
...
>
---
#### [new 137] Chain of Event-Centric Causal Thought for Physically Plausible Video Generation
- **分类: cs.CV**

- **简介: 该论文属于物理合理视频生成任务，旨在解决视频生成中物理现象描述单一、缺乏因果连贯性的问题。通过构建事件链和跨模态提示机制，提升视频的物理合理性与动态连贯性。**
...
>
---
#### [new 148] Performance Analysis of Edge and In-Sensor AI Processors: A Comparative Review
- **分类: cs.AR; cs.CV; cs.LG**

- **简介: 论文属于边缘AI处理器性能分析任务，旨在比较不同架构在低功耗场景下的表现，通过基准测试揭示其优劣。**

- **链接: [https://arxiv.org/pdf/2603.08725](https://arxiv.org/pdf/2603.08725)**
...
>
---
#### [new 149] The Coupling Within: Flow Matching via Distilled Normalizing Flows
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于生成模型任务，解决流模型训练中的耦合问题。通过蒸馏预训练的归一化流模型，提升学生模型性能。**

- **链接: [https://arxiv.org/pdf/2603.09014](https://arxiv.org/pdf/2603.09014)**
...
>
---
#### [new 150] SurgCalib: Gaussian Splatting-Based Hand-Eye Calibration for Robot-Assisted Minimally Invasive Surgery
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 151] DRIFT: Dual-Representation Inter-Fusion Transformer for Automated Driving Perception with 4D Radar Point Clouds
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 152] NLiPsCalib: An Efficient Calibration Framework for High-Fidelity 3D Reconstruction of Curved Visuotactile Sensors
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 153] Association of Radiologic PPFE Change with Mortality in Lung Cancer Screening Cohorts
- **分类: q-bio.QM; cs.CV; eess.IV; stat.AP**

- **简介: 该论文属于医学影像分析任务，旨在探讨PPFE进展与肺癌筛查人群死亡率的关系。通过分析CT数据，发现PPFE进展独立关联死亡率和不良临床结局。**
...
>
---
#### [new 154] Reading, Not Thinking: Understanding and Bridging the Modality Gap When Text Becomes Pixels in Multimodal LLMs
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 155] BEACON: Language-Conditioned Navigation Affordance Prediction under Occlusion
...
>
---
#### [new 156] CycleULM: A unified label-free deep learning framework for ultrasound localisation microscopy
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出CycleULM，解决超分辨超声成像中标签稀缺和域差距问题，通过无标签学习提升成像质量与处理效率。**

- **链接: [https://arxiv.org/pdf/2603.09840](https://arxiv.org/pdf/2603.09840)**
...
>
---
#### [new 159] From Data Statistics to Feature Geometry: How Correlations Shape Superposition
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文研究神经网络中特征叠加现象，探讨相关特征如何通过叠加形成结构。任务为解释超完备基的形成机制，解决传统模型对相关特征处理不足的问题。工作包括提出BOWS框架，验证相关特征可产生建设性干扰。**

- **链接: [https://arxiv.org/pdf/2603.09972](https://arxiv.org/pdf/2603.09972)**
...
>
---
#### [new 160] An accurate flatness measure to estimate the generalization performance of CNN models
- **分类: cs.LG; cs.CV; cs.NE**

- **简介: 该论文属于深度学习领域，旨在解决CNN模型泛化性能评估问题。提出一种精确的平坦度度量方法，考虑了卷积结构特性，可有效评估和比较模型泛化能力。**

- **链接: [https://arxiv.org/pdf/2603.09016](https://arxiv.org/pdf/2603.09016)**
...
>
---
#### [new 161] Robust Provably Secure Image Steganography via Latent Iterative Optimization
- **分类: cs.CR; cs.CV**

- **简介: 该论文属于图像隐写任务，旨在提升隐写的安全性与鲁棒性。通过潜在空间迭代优化，增强在压缩等场景下的消息提取准确性，同时保持可证明安全。**

- **链接: [https://arxiv.org/pdf/2603.09348](https://arxiv.org/pdf/2603.09348)**
...
>
---
#### [replaced 002] Personalized Feature Translation for Expression Recognition: An Efficient Source-Free Domain Adaptation Method
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.09202](https://arxiv.org/pdf/2508.09202)**

> **作者:** Masoumeh Sharafi; Soufiane Belharbi; Muhammad Osama Zeeshan; Houssem Ben Salem; Ali Etemad; Alessandro Lameiras Koerich; Marco Pedersoli; Simon Bacon; Eric Granger
>
...
>
---
#### [replaced 003] PnLCalib: Sports Field Registration via Points and Lines Optimization
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2404.08401](https://arxiv.org/pdf/2404.08401)**

> **作者:** Marc Gutiérrez-Pérez; Antonio Agudo
>
> **备注:** Extended version of "No Bells, Just Whistles: Sports Field Registration Leveraging Geometric Properties"
>
...
>
---
#### [replaced 004] Bootstrap Dynamic-Aware 3D Visual Representation for Scalable Robot Learning
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 005] Automated Coral Spawn Monitoring for Reef Restoration: The Coral Spawn and Larvae Imaging Camera System (CSLICS)
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 006] Who Made This? Fake Detection and Source Attribution with Diffusion Features
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.27602](https://arxiv.org/pdf/2510.27602)**
...
>
---
#### [replaced 007] Energy-Aware Spike Budgeting for Continual Learning in Spiking Neural Networks for Neuromorphic Vision
- **分类: cs.NE; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2602.12236](https://arxiv.org/pdf/2602.12236)**
...
>
---
#### [replaced 008] v-HUB: A Benchmark for Video Humor Understanding from Vision and Sound
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 009] EasyText: Controllable Diffusion Transformer for Multilingual Text Rendering
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.24417](https://arxiv.org/pdf/2505.24417)**
...
>
---
#### [replaced 010] M4-SAR: A Multi-Resolution, Multi-Polarization, Multi-Scene, Multi-Source Dataset and Benchmark for optical-SAR Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.10931](https://arxiv.org/pdf/2505.10931)**
...
>
---
#### [replaced 011] You Only Pose Once: A Minimalist's Detection Transformer for Monocular RGB Category-level 9D Multi-Object Pose Estimation
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 012] Pathwise Test-Time Correction for Autoregressive Long Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.05871](https://arxiv.org/pdf/2602.05871)**

> **作者:** Xunzhi Xiang; Zixuan Duan; Guiyu Zhang; Haiyu Zhang; Zhe Gao; Junta Wu; Shaofeng Zhang; Tengfei Wang; Qi Fan; Chunchao Guo
>
> **摘要:** Distilled autoregressive diffusion models facilitate real-time short video synthesis but suffer from severe error accumulation during long-sequence generation. While existing Test-Time Optimization (TTO) methods prove effective for images or short clips, we identify that they fail to mitigate drift in extended sequences due to unstable reward landscapes and the hypersensitivity of distilled parameters. To overcome these limitations, we introduce Test-Time Correction (TTC), a training-free alternative. Specifically, TTC utilizes the initial frame as a stable reference anchor to calibrate intermediate stochastic states along the sampling trajectory. Extensive experiments demonstrate that our method seamlessly integrates with various distilled models, extending generation lengths with negligible overhead while matching the quality of resource-intensive training-based methods on 30-second benchmarks.
>
---
#### [replaced 013] TIMotion: Temporal and Interactive Framework for Efficient Human-Human Motion Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2408.17135](https://arxiv.org/pdf/2408.17135)**
...
>
---
#### [replaced 015] Fairness-Aware Fine-Tuning of Vision-Language Models for Medical Glaucoma Diagnosis
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2512.03477](https://arxiv.org/pdf/2512.03477)**

> **作者:** Zijian Gu; Yuxi Liu; Zhenhao Zhang; Song Wang
>
> **备注:** AMIA 2026 Amplify Informatics Conference (Poster), Denver, CO, May 18-21, 2026. 10 pages, 3 tables
>
...
>
---
#### [replaced 016] WebAccessVL: Violation-Aware VLM for Web Accessibility
...
>
---
#### [replaced 017] Unveiling the Potential of iMarkers: Invisible Fiducial Markers for Advanced Robotics
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 018] PlaneCycle: Training-Free 2D-to-3D Lifting of Foundation Models Without Adapters
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 019] High-Fidelity Medical Shape Generation via Skeletal Latent Diffusion
- **分类: cs.CV**
...
>
---
#### [replaced 020] SlowBA: An efficiency backdoor attack towards VLM-based GUI agents
...
>
---
#### [replaced 021] Making Training-Free Diffusion Segmentors Scale with the Generative Power
- **分类: cs.CV**
...
>
---
#### [replaced 022] Mitigating Long-Tail Bias in HOI Detection via Adaptive Diversity Cache
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.18811](https://arxiv.org/pdf/2511.18811)**

> **作者:** Yuqiu Jiang; Xiaozhen Qiao; Yifan Chen; Ye Zheng; Zhe Sun; Xuelong Li
>
...
>
---
#### [replaced 023] Proper Body Landmark Subset Enables More Accurate and 5X Faster Recognition of Isolated Signs in LIBRAS
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.24887](https://arxiv.org/pdf/2510.24887)**
...
>
---
#### [replaced 026] When Robots Obey the Patch: Universal Transferable Patch Attacks on Vision-Language-Action Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.21192](https://arxiv.org/pdf/2511.21192)**
...
>
---
#### [replaced 027] AVGGT: Rethinking Global Attention for Accelerating VGGT
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.02541](https://arxiv.org/pdf/2512.02541)**
...
>
---
#### [replaced 028] Taming Preference Mode Collapse via Directional Decoupling Alignment in Diffusion Reinforcement Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.24146](https://arxiv.org/pdf/2512.24146)**
...
>
---
#### [replaced 029] MARRS: Masked Autoregressive Unit-based Reaction Synthesis
- **分类: cs.CV**
...
>
---
#### [replaced 030] CLEAR-Mamba:Towards Accurate, Adaptive and Trustworthy Multi-Sequence Ophthalmic Angiography Classification
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.20601](https://arxiv.org/pdf/2601.20601)**
...
>
---
#### [replaced 031] B-DENSE: Branching For Dense Ensemble Network Supervision Efficiency
- **分类: cs.LG; cs.AI; cs.CV; cs.NE**

- **链接: [https://arxiv.org/pdf/2602.15971](https://arxiv.org/pdf/2602.15971)**

> **作者:** Cherish Puniani; Tushar Kumar; Arnav Bendre; Gaurav Kumar; Shree Singhi
>
> **备注:** 11 pages, 5 figures, 4 algorithms and 2 tables. ICLR DeLTa 2026
>
...
>
---
#### [replaced 032] Self-Attention And Beyond the Infinite: Towards Linear Transformers with Infinite Self-Attention
- **分类: cs.CV**
...
>
---
#### [replaced 033] Video2LoRA: Unified Semantic-Controlled Video Generation via Per-Reference-Video LoRA
- **分类: cs.CV**
...
>
---
#### [replaced 034] SPAN: Spatial-Projection Alignment for Monocular 3D Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.06702](https://arxiv.org/pdf/2511.06702)**
...
>
---
#### [replaced 035] Kuramoto Orientation Diffusion Models
- **分类: cs.LG; cs.CV; q-bio.NC**

- **链接: [https://arxiv.org/pdf/2509.15328](https://arxiv.org/pdf/2509.15328)**
...
>
---
#### [replaced 036] VOIC: Visible-Occluded Integrated Guidance for 3D Semantic Scene Completion
- **分类: cs.CV**
...
>
---
#### [replaced 037] Monocular Normal Estimation via Shading Sequence Estimation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 040] Real-Time Neural Video Compression with Unified Intra and Inter Coding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.14431](https://arxiv.org/pdf/2510.14431)**
...
>
---
#### [replaced 043] MediRound: Multi-Round Entity-Level Reasoning Segmentation in Medical Images
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 044] VirtueBench: Evaluating Trustworthiness under Uncertainty in Long Video Understanding
- **分类: cs.CV**
...
>
---
#### [replaced 048] Image Compression Using Novel View Synthesis Priors
...
>
---
#### [replaced 049] From Spatial to Actions: Grounding Vision-Language-Action Model in Spatial Foundation Priors
...
>
---
#### [replaced 050] SODA: Sensitivity-Oriented Dynamic Acceleration for Diffusion Transformer
- **分类: cs.CV**
...
>
---
#### [replaced 051] NavSpace: How Navigation Agents Follow Spatial Intelligence Instructions
...
>
---
#### [replaced 052] Image Captioning via Compact Bidirectional Architecture
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 053] Learning Encoding-Decoding Direction Pairs to Unveil Concepts of Influence in Deep Vision Networks
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.23926](https://arxiv.org/pdf/2509.23926)**

> **作者:** Alexandros Doumanoglou; Kurt Driessens; Dimitrios Zarpalas
>
> **备注:** 80 Pages. The paper's abstract was shortened to fit the character limit. Accepted at TMLR
>
...
>
---
#### [replaced 054] Class Visualizations and Activation Atlases for Enhancing Interpretability in Deep Learning-Based Computational Pathology
- **分类: cs.CV**
...
>
---
#### [replaced 055] Zooming In on Fakes: A Novel Dataset for Localized AI-Generated Image Detection with Forgery Amplification Approach
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.11922](https://arxiv.org/pdf/2504.11922)**
...
> **作者:** Kabir Thayani
>
> **备注:** Introduced auxiliary InfoNCE objective to reverse dimensional collapse. Expanded experiments to DINOv2 teacher and CIFAR-100 dataset. 3 pages, 3 figures, 2 tables
>
...
>
---
#### [replaced 061] Audio-Visual World Models: Towards Multisensory Imagination in Sight and Sound
...
>
---
#### [replaced 064] Pri4R: Learning World Dynamics for Vision-Language-Action Models with Privileged 4D Representation
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 065] Pretraining Frame Preservation for Lightweight Autoregressive Video History Embedding
- **分类: cs.CV**
...
>
---
#### [replaced 066] Deep Expert Injection for Anchoring Retinal VLMs with Domain-Specific Knowledge
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 069] Exploiting the Final Component of Generator Architectures for AI-Generated Image Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.20461](https://arxiv.org/pdf/2601.20461)**
...
>
---
#### [replaced 075] VocSegMRI: Multimodal Learning for Precise Vocal Tract Segmentation in Real-time MRI
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.13767](https://arxiv.org/pdf/2509.13767)**
...
>
---
#### [replaced 076] Exploring Single Domain Generalization of LiDAR-based Semantic Segmentation under Imperfect Labels
...
>
---
#### [replaced 077] EgoCross: Benchmarking Multimodal Large Language Models for Cross-Domain Egocentric Video Question Answering
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2508.10729](https://arxiv.org/pdf/2508.10729)**
...
>
---
#### [replaced 078] StructBiHOI: Structured Articulation Modeling for Long--Horizon Bimanual Hand--Object Interaction Generation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 079] IMSE: Intrinsic Mixture of Spectral Experts Fine-tuning for Test-Time Adaptation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 080] Latent Equivariant Operators for Robust Object Recognition: Promises and Challenges
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 081] A Survey on Wi-Fi Sensing Generalizability: Taxonomy, Techniques, Datasets, and Future Research Prospects
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.08008](https://arxiv.org/pdf/2503.08008)**

> **作者:** Fei Wang; Tingting Zhang; Wei Xi; Han Ding; Ge Wang; Di Zhang; Yuanhao Cui; Fan Liu; Jinsong Han; Jie Xu; Tony Xiao Han
>
> **备注:** Accepted for publication in IEEE Communications Surveys & Tutorials 2026
>
...
>
---
#### [replaced 082] OptiRoulette Optimizer: A New Stochastic Meta-Optimizer for up to 5.3x Faster Convergence
- **分类: cs.LG; cs.AI; cs.CV; cs.NE**
...
>
---
#### [replaced 083] V-Attack: Targeting Disentangled Value Features for Controllable Adversarial Attacks on LVLMs
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.20223](https://arxiv.org/pdf/2511.20223)**
...
>
---
#### [replaced 084] CuriousBot: Interactive Mobile Exploration via Actionable 3D Relational Object Graph
...
>
---
#### [replaced 085] Improving Large Vision-Language Models' Understanding for Flow Field Data
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.18311](https://arxiv.org/pdf/2507.18311)**
...
>
---
#### [replaced 088] LLaVAShield: Safeguarding Multimodal Multi-Turn Dialogues in Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.25896](https://arxiv.org/pdf/2509.25896)**
...
>
---
#### [replaced 089] N-gram Injection into Transformers for Dynamic Language Model Adaptation in Handwritten Text Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.03930](https://arxiv.org/pdf/2603.03930)**

> **作者:** Florent Meyer; Laurent Guichard; Yann Soullard; Denis Coquenet; Guillaume Gravier; Bertrand Coüasnon
>
> **备注:** Fix order of authors
>
