...
- **简介: 该论文属于视频监控任务，旨在检测视频中的静止物体。通过对比两种背景减除方法，提出改进的静止目标检测方案。**
...
- **简介: 该论文属于多模态模型任务，旨在解决大模型内存占用高的问题。通过引入低精度专家机制，提出MoTE方法，在保持性能的同时降低内存消耗。**
...
- **简介: 该论文属于单目3D人体姿态估计任务，旨在解决关节遮挡和快速运动下姿态不合理的问题。通过构建图卷积结构和注意力机制，融合关节与骨骼特征，提升姿态估计的准确性。**
...
>
---
#### [new 021] I Speak and You Find: Robust 3D Visual Grounding with Noisy and Ambiguous Speech Inputs
- **分类: cs.CV**
...
- **简介: 该论文属于3D场景识别任务，解决点云密度不一致和几何表示脆弱的问题。提出一种基于弹性点的隐式表示，融合鸟瞰图与3D片段信息，提升识别鲁棒性与效率。**
...
- **简介: 该论文属于图像地理定位任务，旨在解决传统方法依赖黑箱决策和数据多样性不足的问题。通过构建新数据集并引入GLOBE模型提升定位与推理能力。**
...
- **简介: 该论文属于文档视觉问答任务，解决多模态文档理解问题。提出SimpleDoc框架，通过双线索检索和迭代优化提升问答效果。**
...
- **简介: 该论文属于模型压缩任务，旨在提升深度学习模型在资源受限设备上的部署效果。通过结合知识蒸馏与积分梯度进行数据增强，提高学生模型的性能与效率。**
...
- **简介: 该论文属于风格迁移任务，解决颜色与风格耦合问题。提出CDST方法，分离颜色与风格，实现无需调优的通用风格迁移。**
...
- **链接: [http://arxiv.org/pdf/2506.14471v1](http://arxiv.org/pdf/2506.14471v1)**
...
- **简介: 该论文属于文本到图像生成任务，旨在解决高计算成本与生成质量的平衡问题。通过智能路由不同模型，优化资源分配，提升效率与质量。**
...
- **简介: 该论文属于传感器标定任务，旨在提高相机与LiDAR的外参校准精度。通过迭代扩散框架优化初始参数，提升校准效果。**
...
- **链接: [http://arxiv.org/pdf/2506.14541v1](http://arxiv.org/pdf/2506.14541v1)**
...
- **简介: 该论文属于Ego-HOI检测任务，解决第三人称视角忽略的自指视角交互问题。构建了Ego-HOIBench数据集，并提出HGIR方法提升检测效果。**
...
- **简介: 该论文属于红外与可见光图像融合任务，旨在解决传统方法在非欧空间中无法准确捕捉语义相似性的问题。提出GrFormer模型，利用Grassmann流形构建注意力机制，实现多尺度语义融合。**
...
- **简介: 该论文研究一shot子集选择任务，旨在降低深度学习训练成本。通过对比传统信息提取器与基础模型，提出RAM-APL方法提升细粒度图像数据子集选择效果。**
...
>
---
#### [new 078] VL-GenRM: Enhancing Vision-Language Verification via Vision Experts and Iterative Training
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 079] BRISC: Annotated Dataset for Brain Tumor Segmentation and Classification with Swin-HAFNet
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于脑肿瘤分割与分类任务，旨在解决数据不足问题。作者构建了BRISC数据集，并提出Swin-HAFNet模型进行实验，取得较高分割精度。**

- **链接: [http://arxiv.org/pdf/2506.14318v1](http://arxiv.org/pdf/2506.14318v1)**
...
>
---
#### [new 080] GAF: Gaussian Action Field as a Dvnamic World Model for Robotic Mlanipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 081] ImmerseGen: Agent-Guided Immersive World Generation with Alpha-Textured Proxies
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于3D场景生成任务，旨在解决VR中高复杂度建模与视觉真实感不足的问题。提出ImmerseGen框架，通过轻量代理和纹理合成实现高效、逼真的沉浸式环境生成。**

- **链接: [http://arxiv.org/pdf/2506.14315v1](http://arxiv.org/pdf/2506.14315v1)**
...
>
---
#### [new 082] Latent Anomaly Detection: Masked VQ-GAN for Unsupervised Segmentation in Medical CBCT
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决ONJ患者数据标注不足的问题。通过提出两阶段的无监督训练方法，实现异常区域的自动识别与分割。**

- **链接: [http://arxiv.org/pdf/2506.14209v1](http://arxiv.org/pdf/2506.14209v1)**
...
>
---
#### [new 083] A large-scale heterogeneous 3D magnetic resonance brain imaging dataset for self-supervised learning
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.14432v1](http://arxiv.org/pdf/2506.14432v1)**
...
>
---
#### [new 085] Busting the Paper Ballot: Voting Meets Adversarial Machine Learning
- **分类: cs.CR; cs.CV; cs.LG**

- **简介: 该论文属于机器学习安全领域，研究选举计票中的模型漏洞。通过构建数据集、测试模型并生成对抗样本，揭示了ML在投票系统中的安全隐患。**

- **链接: [http://arxiv.org/pdf/2506.14582v1](http://arxiv.org/pdf/2506.14582v1)**
...
>
---
#### [new 087] Reliable Noninvasive Glucose Sensing via CNN-Based Spectroscopy
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于非侵入式血糖监测任务，旨在解决传统方法的局限性。通过CNN和光电二极管结合AI技术，实现高精度、低成本的连续血糖检测。**

- **链接: [http://arxiv.org/pdf/2506.13819v1](http://arxiv.org/pdf/2506.13819v1)**
...
> **备注:** 27p, 2figs, 3tabs
>
> **摘要:** The Brain Tumor Segmentation (BraTS) cluster of challenges has significantly advanced brain tumor image analysis by providing large, curated datasets and addressing clinically relevant tasks. However, despite its success and popularity, algorithms and models developed through BraTS have seen limited adoption in both scientific and clinical communities. To accelerate their dissemination, we introduce BraTS orchestrator, an open-source Python package that provides seamless access to state-of-the-art segmentation and synthesis algorithms for diverse brain tumors from the BraTS challenge ecosystem. Available on GitHub (https://github.com/BrainLesion/BraTS), the package features intuitive tutorials designed for users with minimal programming experience, enabling both researchers and clinicians to easily deploy winning BraTS algorithms for inference. By abstracting the complexities of modern deep learning, BraTS orchestrator democratizes access to the specialized knowledge developed within the BraTS community, making these advances readily available to broader neuro-radiology and neuro-oncology audiences.
>
---
#### [new 089] Déjà Vu: Efficient Video-Language Query Engine with Learning-based Inter-Frame Computation Reuse
- **分类: cs.DC; cs.CV**

- **简介: 该论文属于视频语言查询任务，旨在解决视频语言模型计算效率低的问题。通过重用帧间计算提升性能，实现高效视频分析。**

- **链接: [http://arxiv.org/pdf/2506.14107v1](http://arxiv.org/pdf/2506.14107v1)**
...
>
---
#### [new 093] Train Once, Forget Precisely: Anchored Optimization for Efficient Post-Hoc Unlearning
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于机器学习中的后验遗忘任务，旨在高效移除模型中特定信息的影响。提出FAMR框架，通过优化实现精准遗忘，无需重新训练。**

- **链接: [http://arxiv.org/pdf/2506.14515v1](http://arxiv.org/pdf/2506.14515v1)**
...
>
---
#### [replaced 003] Benchmarking Vision, Language, & Action Models in Procedurally Generated, Open Ended Action Environments
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.05540v2](http://arxiv.org/pdf/2505.05540v2)**

> **作者:** Pranav Guruprasad; Yangyue Wang; Sudipta Chowdhury; Harshvardhan Sikka; Paul Pu Liang
>
...
>
---
#### [replaced 004] Learning Spatially Adaptive $\ell_1$-Norms Weights for Convolutional Synthesis Regularization
- **分类: cs.LG; cs.CV; math.OC**

- **链接: [http://arxiv.org/pdf/2503.09483v3](http://arxiv.org/pdf/2503.09483v3)**

> **作者:** Andreas Kofler; Luca Calatroni; Christoph Kolbitsch; Kostas Papafitsoros
>
> **备注:** Accepted for publication in the proceedings of the EUSIPCO 2025 conference
>
...
>
---
#### [replaced 008] MSVIT: Improving Spiking Vision Transformer Using Multi-scale Attention Fusion
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.14719v2](http://arxiv.org/pdf/2505.14719v2)**
...
>
---
#### [replaced 009] ClearDepth: Enhanced Stereo Perception of Transparent Objects for Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 012] VideoPDE: Unified Generative PDE Solving via Video Inpainting Diffusion Models
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13754v2](http://arxiv.org/pdf/2506.13754v2)**

> **作者:** Edward Li; Zichen Wang; Jiahe Huang; Jeong Joon Park
>
> **备注:** Project page: https://videopde.github.io/
>
...
>
---
#### [replaced 013] Efficient multi-view training for 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.12727v2](http://arxiv.org/pdf/2506.12727v2)**
...
>
---
#### [replaced 014] Mouse Lockbox Dataset: Behavior Recognition for Mice Solving Lockboxes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.15408v3](http://arxiv.org/pdf/2505.15408v3)**
...
>
---
#### [replaced 015] H$^3$DP: Triply-Hierarchical Diffusion Policy for Visuomotor Learning
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 019] Self-Supervised Enhancement for Depth from a Lightweight ToF Sensor with Monocular Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.13444v2](http://arxiv.org/pdf/2506.13444v2)**
...
>
---
#### [replaced 020] Hanfu-Bench: A Multimodal Benchmark on Cross-Temporal Cultural Understanding and Transcreation
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 023] AgentCPM-GUI: Building Mobile-Use Agents with Reinforcement Fine-Tuning
...
>
---
#### [replaced 024] Infinity: Scaling Bitwise AutoRegressive Modeling for High-Resolution Image Synthesis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.04431v2](http://arxiv.org/pdf/2412.04431v2)**

> **作者:** Jian Han; Jinlai Liu; Yi Jiang; Bin Yan; Yuqi Zhang; Zehuan Yuan; Bingyue Peng; Xiaobing Liu
>
> **备注:** 17 pages, 14 figures
>
> **摘要:** We present Infinity, a Bitwise Visual AutoRegressive Modeling capable of generating high-resolution, photorealistic images following language instruction. Infinity redefines visual autoregressive model under a bitwise token prediction framework with an infinite-vocabulary tokenizer & classifier and bitwise self-correction mechanism, remarkably improving the generation capacity and details. By theoretically scaling the tokenizer vocabulary size to infinity and concurrently scaling the transformer size, our method significantly unleashes powerful scaling capabilities compared to vanilla VAR. Infinity sets a new record for autoregressive text-to-image models, outperforming top-tier diffusion models like SD3-Medium and SDXL. Notably, Infinity surpasses SD3-Medium by improving the GenEval benchmark score from 0.62 to 0.73 and the ImageReward benchmark score from 0.87 to 0.96, achieving a win rate of 66%. Without extra optimization, Infinity generates a high-quality 1024x1024 image in 0.8 seconds, making it 2.6x faster than SD3-Medium and establishing it as the fastest text-to-image model. Models and codes will be released to promote further exploration of Infinity for visual generation and unified tokenizer modeling.
>
---
#### [replaced 025] BiggerGait: Unlocking Gait Recognition with Layer-wise Representations from Large Vision Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.18132v3](http://arxiv.org/pdf/2505.18132v3)**
...
>
---
#### [replaced 026] Hardware-Rasterized Ray-Based Gaussian Splatting
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2503.18682v2](http://arxiv.org/pdf/2503.18682v2)**
...
>
---
#### [replaced 027] MMedAgent-RL: Optimizing Multi-Agent Collaboration for Multimodal Medical Reasoning
...
>
---
#### [replaced 028] NGD-SLAM: Towards Real-Time Dynamic SLAM without GPU
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 029] HKD4VLM: A Progressive Hybrid Knowledge Distillation Framework for Robust Multimodal Hallucination and Factuality Detection in VLMs
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2506.13038v2](http://arxiv.org/pdf/2506.13038v2)**
...
>
---
#### [replaced 030] FlagEvalMM: A Flexible Framework for Comprehensive Multimodal Model Evaluation
...
>
---
#### [replaced 031] A dataset of high-resolution plantar pressures for gait analysis across varying footwear and walking speeds
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2502.17244v3](http://arxiv.org/pdf/2502.17244v3)**
...
>
---
#### [replaced 032] 3D Hand Mesh-Guided AI-Generated Malformed Hand Refinement with Hand Pose Transformation via Diffusion Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.12680v2](http://arxiv.org/pdf/2506.12680v2)**
...
>
---
#### [replaced 033] SmartWay: Enhanced Waypoint Prediction and Backtracking for Zero-Shot Vision-and-Language Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 034] CSVQA: A Chinese Multimodal Benchmark for Evaluating STEM Reasoning Capabilities of VLMs
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24120v2](http://arxiv.org/pdf/2505.24120v2)**
...
>
---
#### [replaced 038] Image Corruption-Inspired Membership Inference Attacks against Large Vision-Language Models
- **分类: cs.CV; cs.CR**

- **链接: [http://arxiv.org/pdf/2506.12340v2](http://arxiv.org/pdf/2506.12340v2)**
...
>
---
#### [replaced 041] Unified Source-Free Domain Adaptation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2403.07601v3](http://arxiv.org/pdf/2403.07601v3)**
...
>
---
#### [replaced 042] ONEBench to Test Them All: Sample-Level Benchmarking Over Open-Ended Capabilities
...
>
---
#### [replaced 043] FlowAlign: Trajectory-Regularized, Inversion-Free Flow-based Image Editing
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.23145v2](http://arxiv.org/pdf/2505.23145v2)**
...
>
---
#### [replaced 044] Language and Planning in Robotic Navigation: A Multilingual Evaluation of State-of-the-Art Models
...
>
---
#### [replaced 045] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
- **分类: cs.MM; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.13196v2](http://arxiv.org/pdf/2502.13196v2)**
...
>
---
#### [replaced 048] Patho-R1: A Multimodal Reinforcement Learning-Based Pathology Expert Reasoner
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.11404v3](http://arxiv.org/pdf/2505.11404v3)**
...
>
---
#### [replaced 049] MSDNet: Multi-Scale Decoder for Few-Shot Semantic Segmentation via Transformer-Guided Prototyping
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2409.11316v4](http://arxiv.org/pdf/2409.11316v4)**
...
>
---
#### [replaced 050] SeqPE: Transformer with Sequential Position Encoding
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**
...
>
---
#### [replaced 051] Inherently Faithful Attention Maps for Vision Transformers
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.08915v3](http://arxiv.org/pdf/2506.08915v3)**
...
>
---
#### [replaced 057] FigCaps-HF: A Figure-to-Caption Generative Framework and Benchmark with Human Feedback
...
>
---
#### [replaced 061] ProbRadarM3F: mmWave Radar based Human Skeletal Pose Estimation with Probability Map Guided Multi-Format Feature Fusion
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.05164v3](http://arxiv.org/pdf/2405.05164v3)**

> **作者:** Bing Zhu; Zixin He; Weiyi Xiong; Guanhua Ding; Tao Huang; Wei Chen; Wei Xiang
>
...
>
---
#### [replaced 062] Knowledge Bridger: Towards Training-free Missing Modality Completion
- **分类: cs.LG; cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2502.19834v5](http://arxiv.org/pdf/2502.19834v5)**
...
>
---
#### [replaced 063] SDTrack: A Baseline for Event-based Tracking via Spiking Neural Networks
- **分类: cs.NE; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.08703v2](http://arxiv.org/pdf/2503.08703v2)**
...
>
---
#### [replaced 064] Navigating the Digital World as Humans Do: Universal Visual Grounding for GUI Agents
...
>
---
#### [replaced 065] A Survey on Personalized Content Synthesis with Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2405.05538v4](http://arxiv.org/pdf/2405.05538v4)**
...
>
---
#### [replaced 066] A Simple Baseline with Single-encoder for Referring Image Segmentation
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2408.15521v3](http://arxiv.org/pdf/2408.15521v3)**
...
>
---
#### [replaced 067] An Open-Source Software Toolkit & Benchmark Suite for the Evaluation and Adaptation of Multimodal Action Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.09172v2](http://arxiv.org/pdf/2506.09172v2)**

> **作者:** Pranav Guruprasad; Yangyue Wang; Sudipta Chowdhury; Jaewoo Song; Harshvardhan Sikka
>
