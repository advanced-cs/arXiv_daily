...
- **链接: [http://arxiv.org/pdf/2508.12766v1](http://arxiv.org/pdf/2508.12766v1)**
...
- **简介: 论文提出Odo方法，用于身份保持的体形重塑任务，解决现有方法导致比例失真和背景不一致的问题。工作包括构建1.8万张图像的大规模数据集，并设计基于扩散模型的端到端方法，结合UNet与ControlNet实现精准体形调整。**
...
- **简介: 论文提出TiP4GEN框架，解决文本生成360°沉浸式动态全景场景的问题。通过双分支生成模型和几何对齐重建模型，实现细粒度控制与运动丰富、几何一致的4D全景场景生成。**
...
- **简介: 论文提出USDRL框架，用于骨架动作理解任务，解决现有方法缺乏可扩展性和泛化能力的问题。通过多粒度特征去相关和多视角一致性训练，显著提升多种动作理解任务的性能。**
...
- **简介: 论文研究图像到图的转换方法，用于皮肤镜图像的图级异常检测任务。解决如何构建有效的图像衍生图表示以提升GNN在异常检测中的性能问题。通过系统评估多种分割、边构建和特征组合策略，发现颜色特征效果最佳，结合形状与纹理特征进一步提升检测性能。**
...
- **简介: 该论文解决3D场景理解中的特征提升问题，即如何将图像特征（如DINO、CLIP）高效准确地映射到基于点的3D表示。提出一种统一的稀疏线性逆问题求解方法，结合两种正则化策略稳定结果并提升语义一致性，实现分钟级高质量特征提升。**
...
- **链接: [http://arxiv.org/pdf/2508.12736v1](http://arxiv.org/pdf/2508.12736v1)**
...
- **简介: 该论文提出DualFit，一种两阶段虚拟试衣方法，解决现有技术难以保留服装细节（如logo）的问题。第一阶段通过光流对齐衣物与人体，第二阶段融合 warped 衣服与人体区域，保留关键细节并修复接缝处，实现高保真试衣效果。**
...
- **简介: 论文提出SpotVLM，一种云边协同的实时视觉语言模型框架，通过上下文传递机制利用延迟但准确的云端大模型输出指导边缘小模型推理，解决云延迟波动下的实时性与准确性难题。**
...
- **简介: 该论文提出GazeDETR模型，用于 gaze detection 任务，解决传统方法中头定位与注视点预测耦合的问题。通过双解码器分离学习，分别利用局部和全局信息提升精度，在多个数据集上达到最优效果。**
...
- **链接: [http://arxiv.org/pdf/2508.12813v1](http://arxiv.org/pdf/2508.12813v1)**
...
- **简介: 论文提出NCA-WSS方法，利用神经细胞自动机实现白细胞的弱监督分割，解决标注数据稀缺问题。通过分类特征图直接生成分割掩码，无需重新训练，显著优于现有弱监督方法。**
...
- **简介: 该论文提出RealTalk框架，用于生成具情感的逼真说话人脸。解决现有方法情感表达不准确、难控制及身份易丢失的问题。通过VAE和ResNet生成情感面部特征，结合新设计的三平面注意力NeRF实现高保真合成。**
...
- **简介: 该论文提出Motion2Motion框架，解决跨骨骼拓扑动画迁移问题。通过少量目标骨架示例和稀疏骨对应关系，实现无需训练的高效运动转移，适用于相似与跨物种骨骼场景。**
...
- **简介: 论文提出基于深度学习的CCTV系统，用于自动检测消防通道内的吸烟行为。针对低光照和复杂环境挑战，改进YOLOv8模型，提升检测准确率与实时性，实现公共安全监控与合规管理。**
...
- **链接: [http://arxiv.org/pdf/2508.11864v1](http://arxiv.org/pdf/2508.11864v1)**
...
- **简介: 论文提出MOON模型，基于生成式多模态大语言模型解决电商产品理解中的多图多文对齐难题，通过MoE模块、语义区域检测和负采样策略提升表示学习效果，并构建MBE基准测试。**
...
- **简介: 论文提出ViT-EnsembleAttack，针对视觉Transformer的对抗攻击转移性弱的问题，通过模型对抗增强和自动重加权提升ensemble攻击效果，显著增强ViT上的对抗样本迁移能力。**
...
- **简介: 该论文提出UniUGG，首个统一的3D理解与生成框架。解决3D任务整合难题，通过几何-语义编码和空间解码器实现高质量3D生成与视觉问答，提升空间理解能力。**
...
- **简介: 该论文研究脑肿瘤分割任务，旨在解决标注数据稀缺和类别不平衡问题。通过引入生成对抗网络合成MRI数据，与真实数据混合训练U-Net模型，发现40%真实+60%合成数据可改善整体边界分割，但区域精度仍不足。**
...
- **简介: 该论文提出DEEP-SEA模型，用于水下图像增强任务，解决光照散射、浑浊导致的图像模糊与色偏问题。通过双频自注意力机制提升低频结构和高频细节，显著改善水下视觉质量，助力生态监测与自主导航。**
...
- **简介: 该论文属于3D目标检测任务，旨在解决相机与激光雷达模态信息融合不足的问题。提出CMF-IoU框架，通过多阶段跨模态融合、伪点生成、双分支增强和IoU联合预测，提升检测精度。**
...
- **简介: 该论文属于皮肤癌分类任务，旨在提升医学图像中恶性与非恶性病变的识别准确率。通过结合CNN、Transformer与CKAN模型，实现局部特征提取、全局依赖建模及非线性特征融合，显著提高分类性能与泛化能力。**
...
- **简介: 该论文提出UniDCF，一个用于牙颌面硬组织多模态重建的统一框架，解决现有模型单组织、单模态限制问题。通过点云与多视角图像融合及去噪模块，提升几何精度与临床效率，显著缩短设计时间并提高可接受度。**
...
>
---
#### [new 064] Omni Survey for Multimodality Analysis in Visual Object Tracking
- **分类: cs.CV**

- **简介: 论文聚焦多模态视觉目标跟踪（MMVOT）任务，系统梳理数据收集、模态对齐、模型设计与评估四大挑战，分类现有方法并分析数据集分布特征，探讨多模态是否始终优于单模态跟踪。**

- **链接: [http://arxiv.org/pdf/2508.13000v1](http://arxiv.org/pdf/2508.13000v1)**
...
>
---
#### [new 065] In vivo 3D ultrasound computed tomography of musculoskeletal tissues with generative neural physics
- **分类: cs.CV; 65N21, 92C55, 68T07**

- **简介: 该论文属于医学成像任务，旨在解决超声CT因强散射导致的图像失真问题。作者提出一种融合生成网络与物理信息神经模拟的框架，实现快速、高保真三维超声成像，可定量映射肌肉和骨骼的声学特性。**

- **链接: [http://arxiv.org/pdf/2508.12226v1](http://arxiv.org/pdf/2508.12226v1)**
...
>
---
#### [new 071] Superpixel-informed Continuous Low-Rank Tensor Representation for Multi-Dimensional Data Recovery
- **分类: cs.CV**

- **简介: 该论文提出SCTR框架，用于多维数据恢复任务，解决传统低秩张量方法因假设全局低秩和离散网格限制而效果不佳的问题。通过超像素建模和异构低秩分解，提升表达能力和适应性，实现更精确的数据恢复。**

- **链接: [http://arxiv.org/pdf/2508.12261v1](http://arxiv.org/pdf/2508.12261v1)**

> **作者:** Zhizhou Wang; Ruijing Zheng; Zhenyu Wu; Jianli Wang
>
...
>
---
#### [new 072] SlimComm: Doppler-Guided Sparse Queries for Bandwidth-Efficient Cooperative 3-D Perception
- **分类: cs.CV**

- **简介: 论文提出SlimComm框架，解决车联网中BEV特征传输带宽过大的问题。通过融合雷达多普勒信息与稀疏查询机制，仅传输关键区域特征，显著降低带宽消耗，同时保持感知精度。**

- **链接: [http://arxiv.org/pdf/2508.13007v1](http://arxiv.org/pdf/2508.13007v1)**
...
>
---
#### [new 073] SRMA-Mamba: Spatial Reverse Mamba Attention Network for Pathological Liver Segmentation in MRI Volumes
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对MRI中肝硬化病灶的3D分割任务，提出SRMA-Mamba网络。通过空间反向注意力模块和基于解剖结构的Mamba模块，有效建模三维空间关系，提升分割精度与可解释性。**

- **链接: [http://arxiv.org/pdf/2508.12410v1](http://arxiv.org/pdf/2508.12410v1)**
...
>
---
#### [new 080] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
- **分类: cs.CV; cs.LG**

- **简介: 论文提出ComplicitSplat，一种基于3D高斯溅射的黑盒攻击方法，通过视角特异性伪装在场景中嵌入对抗内容，使下游检测器在特定视角下误检，无需模型架构或权重信息。该工作揭示了3DGS在安全关键应用中的新风险。**

- **链接: [http://arxiv.org/pdf/2508.11854v1](http://arxiv.org/pdf/2508.11854v1)**
...
>
> **摘要:** As 3D Gaussian Splatting (3DGS) gains rapid adoption in safety-critical tasks for efficient novel-view synthesis from static images, how might an adversary tamper images to cause harm? We introduce ComplicitSplat, the first attack that exploits standard 3DGS shading methods to create viewpoint-specific camouflage - colors and textures that change with viewing angle - to embed adversarial content in scene objects that are visible only from specific viewpoints and without requiring access to model architecture or weights. Our extensive experiments show that ComplicitSplat generalizes to successfully attack a variety of popular detector - both single-stage, multi-stage, and transformer-based models on both real-world capture of physical objects and synthetic scenes. To our knowledge, this is the first black-box attack on downstream object detectors using 3DGS, exposing a novel safety risk for applications like autonomous navigation and other mission-critical robotic systems.
>
---
#### [new 081] Design and Validation of a Responsible Artificial Intelligence-based System for the Referral of Diabetic Retinopathy Patients
- **分类: cs.CV; cs.AI**

- **简介: 论文提出RAIS-DR系统，用于糖尿病视网膜病变筛查任务，解决AI模型因数据质量差和偏见导致的临床应用障碍。通过整合伦理原则与高效卷积模型，提升检测准确性和公平性，显著优于现有系统。**

- **链接: [http://arxiv.org/pdf/2508.12506v1](http://arxiv.org/pdf/2508.12506v1)**
...
>
---
#### [new 085] Labels or Input? Rethinking Augmentation in Multimodal Hate Detection
...
>
---
#### [new 088] Vision-G1: Towards General Vision Language Reasoning with Multi-Domain Data Curation
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 089] Towards Understanding 3D Vision: the Role of Gaussian Curvature
- **分类: cs.CV**

- **简介: 论文研究3D视觉中高斯曲率的作用，旨在解决深度学习方法缺乏显式几何建模的问题。工作包括：证明高斯曲率能紧凑描述3D表面、揭示其在现有方法中的隐式使用、提出作为几何先验提升重建质量，并探索其作为无监督立体匹配指标的潜力。**

- **链接: [http://arxiv.org/pdf/2508.11825v1](http://arxiv.org/pdf/2508.11825v1)**
...
>
---
#### [new 097] Simple o3: Towards Interleaved Vision-Language Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 论文提出Simple o3框架，解决多模态大模型在视觉语言推理中链式思维能力不足的问题。通过监督微调整合动态视觉操作与语言推理，构建高质量数据集，提升模型细粒度感知和聚焦关键区域的能力。**

- **链接: [http://arxiv.org/pdf/2508.12109v1](http://arxiv.org/pdf/2508.12109v1)**
...
>
---
#### [new 100] CTFlow: Video-Inspired Latent Flow Matching for 3D CT Synthesis
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出CTFlow，用于从临床报告生成3D CT图像。解决如何在保持内存效率的同时生成连贯、多样且与文本对齐的完整CT体积问题。工作包括设计潜空间、文本编码及自回归生成策略，并在多个指标上优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.12900v1](http://arxiv.org/pdf/2508.12900v1)**
...
>
---
#### [new 106] EVTP-IVS: Effective Visual Token Pruning For Unifying Instruction Visual Segmentation In Multi-Modal Large Language Models
...
>
---
#### [new 109] Precise Action-to-Video Generation Through Visual Action Prompts
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 114] AdaRing: Towards Ultra-Light Vision-Language Adaptation via Cross-Layer Tensor Ring Decomposition
- **分类: cs.CV; cs.AI**

- **简介: 论文提出AdaRing框架，通过跨层张量环分解实现视觉语言模型的超轻量适配，解决现有方法压缩率低和表达能力弱的问题，显著减少训练参数并提升性能。**

- **链接: [http://arxiv.org/pdf/2508.11870v1](http://arxiv.org/pdf/2508.11870v1)**
...
>
---
#### [new 115] Region-Level Context-Aware Multimodal Understanding
- **分类: cs.CV; cs.AI**

- **简介: 论文提出Region-level Context-aware Multimodal Understanding（RCMU）任务，解决MLLMs忽视区域文本上下文的问题。通过RCVIT方法、RCMU数据集和RC& P-Bench评估框架，提升模型对图像区域与文本信息的融合能力，实现在多任务上的显著性能提升。**

- **链接: [http://arxiv.org/pdf/2508.12263v1](http://arxiv.org/pdf/2508.12263v1)**
...
>
---
#### [new 118] OpenMoCap: Rethinking Optical Motion Capture under Real-world Occlusion
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对真实场景下光学动捕因标记遮挡导致性能下降的问题，提出CMU-Occlu数据集和OpenMoCap模型，通过真实遮挡模拟与标记-关节链推理机制，提升遮挡环境下的动作捕捉鲁棒性。**

- **链接: [http://arxiv.org/pdf/2508.12610v1](http://arxiv.org/pdf/2508.12610v1)**
...
>
---
#### [new 119] IPGPhormer: Interpretable Pathology Graph-Transformer for Survival Analysis
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出IPGPhormer，用于癌症生存分析任务，解决现有方法在建模空间关系与缺乏可解释性方面的不足。通过图Transformer架构捕捉肿瘤微环境特征并提供细胞级和组织级可解释性，提升预测准确性和临床实用性。**

- **链接: [http://arxiv.org/pdf/2508.12381v1](http://arxiv.org/pdf/2508.12381v1)**
...
>
---
#### [new 120] Real-Time Sign Language Gestures to Speech Transcription using Deep Learning
- **分类: cs.CV**

- **简介: 该论文属于自然语言处理与计算机视觉交叉任务，旨在解决聋哑人群与健听人群间的沟通障碍问题。通过CNN模型实时识别手语手势并转换为语音和文本，提升无障碍交流效率。**

- **链接: [http://arxiv.org/pdf/2508.12713v1](http://arxiv.org/pdf/2508.12713v1)**
...
>
---
#### [new 121] Separating Knowledge and Perception with Procedural Data
- **分类: cs.CV; cs.AI; I.5.1**

- **简介: 论文提出用程序生成数据训练表示模型，并通过视觉记忆库在无需微调的情况下完成视觉相似性、分类和语义分割任务。解决了真实数据与模型性能之间的依赖问题，实现了知识与感知的分离，且性能接近真实数据训练模型。**

- **链接: [http://arxiv.org/pdf/2508.11697v1](http://arxiv.org/pdf/2508.11697v1)**
...
>
---
#### [new 131] MBMamba: When Memory Buffer Meets Mamba for Structure-Aware Image Deblurring
- **分类: cs.CV**

- **简介: 论文提出MBMamba，用于图像去模糊任务。针对Mamba架构因扁平扫描导致局部信息遗忘和通道冗余的问题，设计记忆缓冲机制保留历史信息，并引入Ising启发的正则化损失保持图像结构，提升去模糊效果且不增加计算复杂度。**

- **链接: [http://arxiv.org/pdf/2508.12346v1](http://arxiv.org/pdf/2508.12346v1)**
...
>
---
#### [new 134] EgoLoc: A Generalizable Solution for Temporal Interaction Localization in Egocentric Videos
- **分类: cs.CV**

- **简介: 论文提出EgoLoc，解决自摄像机视频中手-物体交互时刻定位问题（TIL），无需对象掩码或类别标注，通过手部动态引导采样和视觉语言模型实现零样本泛化，提升混合现实与机器人操作的精度。**

- **链接: [http://arxiv.org/pdf/2508.12349v1](http://arxiv.org/pdf/2508.12349v1)**
...
>
---
#### [new 135] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
- **分类: cs.CV**

- **简介: 该论文针对3D高斯点绘图（3DGS）中重建质量不足的问题，改进了稀疏化流程：提出边缘感知评分选择候选点、长轴分割减少几何失真，并设计防过拟合技术提升渲染保真度，实现更高质量且无额外开销的实时渲染。**

- **链接: [http://arxiv.org/pdf/2508.12313v1](http://arxiv.org/pdf/2508.12313v1)**

> **作者:** Xiaobin Deng; Changyu Diao; Min Li; Ruohan Yu; Duanqing Xu
>
> **备注:** Project page: https://xiaobin2001.github.io/improved-gs-web
>
...
>
---
#### [new 138] Preserve and Sculpt: Manifold-Aligned Fine-tuning of Vision-Language Models for Few-Shot Learning
- **分类: cs.CV**

- **简介: 论文提出MPS-Tuning方法，用于少样本图像分类任务，解决现有微调方法忽略数据分布几何结构导致语义表示失真的问题。通过保持特征流形的拓扑结构并增强类别可分性，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2508.12877v1](http://arxiv.org/pdf/2508.12877v1)**
...
>
---
#### [new 147] VideoAVE: A Multi-Attribute Video-to-Text Attribute Value Extraction Dataset and Benchmark Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 148] Neural Rendering for Sensor Adaptation in 3D Object Detection
- **分类: cs.CV**

- **简介: 论文研究自动驾驶中不同摄像头设置导致的3D目标检测性能下降问题。提出CamShift数据集和基于神经渲染的传感器适配方法，提升模型在跨传感器场景下的鲁棒性与数据复用效率。**

- **链接: [http://arxiv.org/pdf/2508.12695v1](http://arxiv.org/pdf/2508.12695v1)**
...
>
---
#### [new 153] Dextr: Zero-Shot Neural Architecture Search with Singular Value Decomposition and Extrinsic Curvature
- **分类: cs.CV**

- **简介: 该论文提出Dextr，一种无需标签数据的零样本神经架构搜索代理，通过奇异值分解和外曲率联合建模网络收敛性、泛化性和表达能力，实现高效准确的性能预测。**

- **链接: [http://arxiv.org/pdf/2508.12977v1](http://arxiv.org/pdf/2508.12977v1)**
...
>
---
#### [new 156] Breaking Reward Collapse: Adaptive Reinforcement for Open-ended Medical Reasoning with Enhanced Semantic Discrimination
- **分类: cs.CV**

- **简介: 论文提出ARMed框架，解决开放医学视觉问答中奖励衰减问题。通过监督微调和自适应语义奖励提升模型推理质量，在六项基准上显著改善准确率与泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.12957v1](http://arxiv.org/pdf/2508.12957v1)**
...
>
---
#### [new 157] MixCache: Mixture-of-Cache for Video Diffusion Transformer Acceleration
- **分类: cs.GR; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.12691v1](http://arxiv.org/pdf/2508.12691v1)**
...
>
---
#### [new 162] Artificial Intelligence in Rural Healthcare Delivery: Bridging Gaps and Enhancing Equity through Innovation
- **分类: cs.CY; cs.AI; cs.CV**

- **简介: 该论文属于综述任务，旨在解决农村医疗资源匮乏问题。通过系统回顾2019–2024年109项研究，分析AI（如MFMs、LLMs）在提升农村医疗可及性、效率和公平性中的作用，提出需克服基础设施、数据质量和伦理挑战，并建议加强跨学科合作与政策支持。**
...
>
---
#### [new 163] E3RG: Building Explicit Emotion-driven Empathetic Response Generation System with Multimodal Large Language Model
...
>
---
#### [new 168] Express4D: Expressive, Friendly, and Extensible 4D Facial Motion Generation Benchmark
- **分类: cs.GR; cs.CV**

- **简介: 论文提出Express4D，一个用于文本驱动4D面部表情生成的基准数据集，解决现有数据集缺乏细腻表达描述和昂贵采集设备的问题。使用通用设备和LLM生成指令收集数据，支持精细控制与模型训练。**

- **链接: [http://arxiv.org/pdf/2508.12438v1](http://arxiv.org/pdf/2508.12438v1)**
...
>
---
#### [new 169] Grounding Actions in Camera Space: Observation-Centric Vision-Language-Action Policy
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 170] A Shift in Perspective on Causality in Domain Generalization
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 论文探讨因果建模在域泛化任务中的作用，旨在解决其在实际应用中效果存疑的问题。作者重新审视相关理论，提出更细致的因果性与泛化关系解释，并提供交互式演示验证观点。**

- **链接: [http://arxiv.org/pdf/2508.12798v1](http://arxiv.org/pdf/2508.12798v1)**
...
>
---
#### [new 172] On the Importance of Behavioral Nuances: Amplifying Non-Obvious Motor Noise Under True Empirical Considerations May Lead to Briefer Assays and Faster Classification Processes
...
>
---
#### [new 173] Anatomic Feature Fusion Model for Diagnosing Calcified Pulmonary Nodules on Chest X-Ray
- **分类: eess.IV; cs.CV**

- **简介: 该论文针对胸部X光片中钙化肺结节的诊断任务，解决医生视觉评估差异大、解剖结构干扰等问题。通过融合原始图像与结构抑制图像特征，提升钙化分类准确率，模型准确率达86.52%。**

- **链接: [http://arxiv.org/pdf/2508.12562v1](http://arxiv.org/pdf/2508.12562v1)**
...
>
---
#### [new 176] iTrace: Click-Based Gaze Visualization on the Apple Vision Pro
- **分类: cs.HC; cs.CV**

- **简介: 该论文提出iTrace系统，解决Apple Vision Pro无法直接获取眼动数据的问题。通过点击方式提取 gaze 信息，生成动态热图，用于分析个体与群体注意力模式，适用于教育、设计、营销等领域研究。**

- **链接: [http://arxiv.org/pdf/2508.12268v1](http://arxiv.org/pdf/2508.12268v1)**
...
>
---
#### [new 181] Point upsampling networks for single-photon sensing
- **分类: physics.optics; cs.CV**

- **简介: 该论文针对单光子成像中点云稀疏且空间分布不均的问题，提出点上采样网络框架。通过状态空间模型、多路径扫描机制和自适应上采样模块，提升点云密度并减少畸变，实现高精度、低噪声的重建效果。**

- **链接: [http://arxiv.org/pdf/2508.12986v1](http://arxiv.org/pdf/2508.12986v1)**
...
>
---
#### [new 183] DermINO: Hybrid Pretraining for a Versatile Dermatology Foundation Model
- **分类: eess.IV; cs.CV**

- **简介: 该论文提出DermNIO，一个用于皮肤病学的通用基础模型，解决现有AI模型依赖大量标注数据、任务单一及泛化能力差的问题。通过混合预训练框架提升多任务性能与鲁棒性，在20个数据集上超越现有方法，并在临床诊断中显著优于人类医生。**

- **链接: [http://arxiv.org/pdf/2508.12190v1](http://arxiv.org/pdf/2508.12190v1)**
...
>
---
#### [new 185] Temporal and Rotational Calibration for Event-Centric Multi-Sensor Systems
...
>
---
#### [new 186] Vitamin N: Benefits of Different Forms of Public Greenery for Urban Health
- **分类: cs.CY; cs.AI; cs.CV**
...
>
---
#### [new 187] Contrastive Regularization over LoRA for Multimodal Biomedical Image Incremental Learning
- **分类: cs.LG; cs.AI; cs.CV; cs.MM**

- **简介: 该论文研究多模态生物医学图像增量学习任务，旨在解决知识遗忘和跨模态知识迁移问题。提出MSLoRA-CR方法，通过微调特定模态的LoRA模块并引入对比正则化，实现高效知识保留与共享，优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.11673v1](http://arxiv.org/pdf/2508.11673v1)**
...
>
---
#### [new 189] PROD: Palpative Reconstruction of Deformable Objects through Elastostatic Signed Distance Functions
- **分类: cs.RO; cs.CV**
...
#### [replaced 001] Unified Multimodal Understanding and Generation Models: Advances, Challenges, and Opportunities
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.02567v5](http://arxiv.org/pdf/2505.02567v5)**
...
>
---
#### [replaced 002] Quadratic Gaussian Splatting: High Quality Surface Reconstruction with Second-order Geometric Primitives
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2411.16392v4](http://arxiv.org/pdf/2411.16392v4)**
...
>
---
#### [replaced 005] AFR-CLIP: Enhancing Zero-Shot Industrial Anomaly Detection with Stateless-to-Stateful Anomaly Feature Rectification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.12910v3](http://arxiv.org/pdf/2503.12910v3)**

> **作者:** Jingyi Yuan; Chenqiang Gao; Pengyu Jie; Xuan Xia; Shangri Huang; Wanquan Liu
>
> **备注:** There was some citation error in the last version. So please read the 3rd version
>
...
>
---
#### [replaced 006] Hyperspectral Image Generation with Unmixing Guided Diffusion Model
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2506.02601v2](http://arxiv.org/pdf/2506.02601v2)**
...
>
---
#### [replaced 007] LeAdQA: LLM-Driven Context-Aware Temporal Grounding for Video Question Answering
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.14784v2](http://arxiv.org/pdf/2507.14784v2)**
...
>
---
#### [replaced 008] ICE-Bench: A Unified and Comprehensive Benchmark for Image Creating and Editing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.14482v2](http://arxiv.org/pdf/2503.14482v2)**

> **作者:** Yulin Pan; Xiangteng He; Chaojie Mao; Zhen Han; Zeyinzi Jiang; Jingfeng Zhang; Yu Liu
>
> **备注:** 17 pages. Accepted by ICCV 2025
>
...
>
---
#### [replaced 009] PSScreen: Partially Supervised Multiple Retinal Disease Screening
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10549v2](http://arxiv.org/pdf/2508.10549v2)**
...
>
---
#### [replaced 010] Novel Object 6D Pose Estimation with a Single Reference View
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 014] Object Fidelity Diffusion for Remote Sensing Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10801v2](http://arxiv.org/pdf/2508.10801v2)**
...
>
---
#### [replaced 029] TimeMachine: Fine-Grained Facial Age Editing with Identity Preservation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.11284v2](http://arxiv.org/pdf/2508.11284v2)**
...
>
---
#### [replaced 030] ForensicsSAM: Toward Robust and Unified Image Forgery Detection and Localization Resisting to Adversarial Attack
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07402v2](http://arxiv.org/pdf/2508.07402v2)**
...
>
---
#### [replaced 031] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.08331v3](http://arxiv.org/pdf/2412.08331v3)**
...
>
---
#### [replaced 032] Diving into the Fusion of Monocular Priors for Generalized Stereo Matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.14414v2](http://arxiv.org/pdf/2505.14414v2)**
...
>
---
#### [replaced 033] Boosting Active Defense Persistence: A Two-Stage Defense Framework Combining Interruption and Poisoning Against Deepfake
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07795v2](http://arxiv.org/pdf/2508.07795v2)**
...
>
---
#### [replaced 034] Adaptively Clustering Neighbor Elements for Image-Text Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2301.01955v4](http://arxiv.org/pdf/2301.01955v4)**

> **作者:** Zihua Wang; Xu Yang; Hanwang Zhang; Haiyang Xu; Ming Yan; Fei Huang; Yu Zhang
>
> **备注:** This work has been accepted by IEEE Transactions on Multimedia
>
...
>
---
#### [replaced 035] Mapping the Unseen: Unified Promptable Panoptic Mapping with Dynamic Labeling using Foundation Models
...
>
---
#### [replaced 036] Automated Black-box Prompt Engineering for Personalized Text-to-Image Generation
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 042] GeoSAM: Fine-tuning SAM with Multi-Modal Prompts for Mobility Infrastructure Segmentation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2311.11319v4](http://arxiv.org/pdf/2311.11319v4)**
...
>
---
#### [replaced 044] From One Single Sketch to 3D Detailed Face Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2502.17852v2](http://arxiv.org/pdf/2502.17852v2)**
...
>
---
#### [replaced 045] Towards an Explainable Comparison and Alignment of Feature Embeddings
- **分类: cs.LG; cs.AI; cs.CV; math.SP**

- **链接: [http://arxiv.org/pdf/2506.06231v3](http://arxiv.org/pdf/2506.06231v3)**
...
>
---
#### [replaced 048] Interpretable Oracle Bone Script Decipherment through Radical and Pictographic Analysis with LVLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10113v2](http://arxiv.org/pdf/2508.10113v2)**
...
>
---
#### [replaced 049] V-RoAst: Visual Road Assessment. Can VLM be a Road Safety Assessor Using the iRAP Standard?
- **分类: cs.CV; cs.AI; cs.ET**

- **链接: [http://arxiv.org/pdf/2408.10872v5](http://arxiv.org/pdf/2408.10872v5)**
...
>
---
#### [replaced 050] Cognitive-Inspired Hierarchical Attention Fusion With Visual and Textual for Cross-Domain Sequential Recommendation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.15085v4](http://arxiv.org/pdf/2504.15085v4)**
...
>
---
#### [replaced 053] Re:Verse -- Can Your VLM Read a Manga?
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 054] D-CODA: Diffusion for Coordinated Dual-Arm Data Augmentation
...
>
---
#### [replaced 055] NextStep-1: Toward Autoregressive Image Generation with Continuous Tokens at Scale
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10711v2](http://arxiv.org/pdf/2508.10711v2)**
...
>
> **备注:** Code: https://github.com/stepfun-ai/NextStep-1
>
> **摘要:** Prevailing autoregressive (AR) models for text-to-image generation either rely on heavy, computationally-intensive diffusion models to process continuous image tokens, or employ vector quantization (VQ) to obtain discrete tokens with quantization loss. In this paper, we push the autoregressive paradigm forward with NextStep-1, a 14B autoregressive model paired with a 157M flow matching head, training on discrete text tokens and continuous image tokens with next-token prediction objectives. NextStep-1 achieves state-of-the-art performance for autoregressive models in text-to-image generation tasks, exhibiting strong capabilities in high-fidelity image synthesis. Furthermore, our method shows strong performance in image editing, highlighting the power and versatility of our unified approach. To facilitate open research, we will release our code and models to the community.
>
---
#### [replaced 056] Differentiable Room Acoustic Rendering with Multi-View Vision Priors
- **分类: cs.CV; cs.SD**
...
>
---
#### [replaced 057] HQ-OV3D: A High Box Quality Open-World 3D Detection Framework based on Diffision Model
...
>
---
#### [replaced 058] MicroMIL: Graph-Based Multiple Instance Learning for Context-Aware Diagnosis with Microscopic Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.21604v3](http://arxiv.org/pdf/2407.21604v3)**

> **作者:** JongWoo Kim; Bryan Wong; Huazhu Fu; Willmer Rafell Quiñones; Young Sin Ko; MunYong Yi
>
...
>
---
#### [replaced 059] Towards Consumer-Grade Cybersickness Prediction: Multi-Model Alignment for Real-Time Vision-Only Inference
- **分类: cs.CV; cs.HC**

- **链接: [http://arxiv.org/pdf/2501.01212v3](http://arxiv.org/pdf/2501.01212v3)**
...
>
---
#### [replaced 062] Communicate Less, Synthesize the Rest: Latency-aware Intent-based Generative Semantic Multicasting with Diffusion Models
...
>
---
#### [replaced 063] SafePLUG: Empowering Multimodal LLMs with Pixel-Level Insight and Temporal Grounding for Traffic Accident Understanding
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.06763v2](http://arxiv.org/pdf/2508.06763v2)**
...
>
---
#### [replaced 064] LoRA-based methods on Unet for transfer learning in Subarachnoid Hematoma Segmentation
- **分类: eess.IV; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.01772v2](http://arxiv.org/pdf/2508.01772v2)**
...
>
---
#### [replaced 065] Reasoning and Learning a Perceptual Metric for Self-Training of Reflective Objects in Bin-Picking with a Low-cost Camera
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 066] Attention to the Burstiness in Visual Prompt Tuning!
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.22908v2](http://arxiv.org/pdf/2506.22908v2)**

> **作者:** Yuzhu Wang; Manni Duan; Shu Kong
>
> **备注:** ICCV 2025; v2: camera ready
>
...
>
---
#### [replaced 067] Learn 3D VQA Better with Active Selection and Reannotation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.04630v2](http://arxiv.org/pdf/2507.04630v2)**

> **作者:** Shengli Zhou; Yang Liu; Feng Zheng
>
> **备注:** 13 pages, 16 figures, accepted by ACM MM 2025
>
...
>
---
#### [replaced 068] RT-Cache: Training-Free Retrieval for Real-Time Manipulation
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**
...
>
---
#### [replaced 073] FormCoach: Lift Smarter, Not Harder
- **分类: cs.CV; cs.HC**

- **链接: [http://arxiv.org/pdf/2508.07501v2](http://arxiv.org/pdf/2508.07501v2)**
...
>
---
#### [replaced 074] Optimization of Prompt Learning via Multi-Knowledge Representation for Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2404.10357v3](http://arxiv.org/pdf/2404.10357v3)**

> **作者:** Enming Zhang; Bingke Zhu; Yingying Chen; Qinghai Miao; Ming Tang; Jinqiao Wang
>
...
>
---
#### [replaced 075] Translation of Text Embedding via Delta Vector to Suppress Strongly Entangled Content in Text-to-Image Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10407v2](http://arxiv.org/pdf/2508.10407v2)**
...
>
---
#### [replaced 082] Diffusion Based Ambiguous Image Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.05977v2](http://arxiv.org/pdf/2504.05977v2)**
...
>
---
#### [replaced 083] Unified and Semantically Grounded Domain Adaptation for Medical Image Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.08660v2](http://arxiv.org/pdf/2508.08660v2)**
...
>
---
#### [replaced 084] Affordance-R1: Reinforcement Learning for Generalizable Affordance Reasoning in Multimodal Large Language Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 085] FMCE-Net++: Feature Map Convergence Evaluation and Training
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.06109v2](http://arxiv.org/pdf/2508.06109v2)**
...
>
> **摘要:** Zero-shot and prompt-based models have excelled at visual reasoning tasks by leveraging large-scale natural image corpora, but they often fail on sparse and domain-specific scientific image data. We introduce Zenesis, a no-code interactive computer vision platform designed to reduce data readiness bottlenecks in scientific imaging workflows. Zenesis integrates lightweight multimodal adaptation for zero-shot inference on raw scientific data, human-in-the-loop refinement, and heuristic-based temporal enhancement. We validate our approach on Focused Ion Beam Scanning Electron Microscopy (FIB-SEM) datasets of catalyst-loaded membranes. Zenesis outperforms baselines, achieving an average accuracy of 0.947, Intersection over Union (IoU) of 0.858, and Dice score of 0.923 on amorphous catalyst samples; and 0.987 accuracy, 0.857 IoU, and 0.923 Dice on crystalline samples. These results represent a significant performance gain over conventional methods such as Otsu thresholding and standalone models like the Segment Anything Model (SAM). Zenesis enables effective image segmentation in domains where annotated datasets are limited, offering a scalable solution for scientific discovery.
>
---
#### [replaced 090] CPCL: Cross-Modal Prototypical Contrastive Learning for Weakly Supervised Text-based Person Retrieval
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2401.10011v3](http://arxiv.org/pdf/2401.10011v3)**
...
>
---
#### [replaced 091] Visual Perception Engine: Fast and Flexible Multi-Head Inference for Robotic Vision Tasks
- **分类: cs.RO; cs.AI; cs.CV; cs.LG**
...
>
---
#### [replaced 092] Benchmarking Federated Learning for Semantic Datasets: Federated Scene Graph Generation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.10436v2](http://arxiv.org/pdf/2412.10436v2)**
...
>
---
#### [replaced 096] On Delta-Homology Analogy: Memory as Structured Trajectories
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2303.04203v2](http://arxiv.org/pdf/2303.04203v2)**

> **作者:** Xin Li
>
> **摘要:** We introduce the \emph{delta-homology analogy}, which formalizes memory as a set of sparse, topologically irreducible attractors. A \emph{Dirac delta-like memory trace} \( \delta_\gamma \) is identified with a nontrivial homology generator \( [\gamma] \in H_1(\mathcal{Z}) \) on a latent manifold of cognitive states. Such traces are sharply localized along reproducible topological cycles and are only activated when inference trajectories complete a full cycle. They encode minimal, path-dependent memory units that cannot be synthesized from local features alone. Based on the analogy, we propose a topological framework for memory and inference grounded in the structure of spike-timing dynamics and persistent homology. Starting from the observation that polychronous neural groups (PNGs) encode reproducible, time-locked spike sequences shaped by axonal delays and synaptic plasticity, we construct \emph{spatiotemporal complexes} whose temporally consistent transitions define chain complexes over which robust activation cycles emerge. These activation loops are abstracted into \emph{cell posets}, enabling a compact and causally ordered representation of neural activity with overlapping and compositional memory traces.
>
---
#### [replaced 097] Flexible Tool Selection through Low-dimensional Attribute Alignment of Vision and Language
...
>
---
#### [replaced 098] SLAG: Scalable Language-Augmented Gaussian Splatting
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 099] DualResolution Residual Architecture with Artifact Suppression for Melanocytic Lesion Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.06816v2](http://arxiv.org/pdf/2508.06816v2)**
...
>
---
#### [replaced 100] OMGM: Orchestrate Multiple Granularities and Modalities for Efficient Multimodal Retrieval
- **分类: cs.IR; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.07879v2](http://arxiv.org/pdf/2505.07879v2)**

> **作者:** Wei Yang; Jingjing Fu; Rui Wang; Jinyu Wang; Lei Song; Jiang Bian
>
> **备注:** Accepted to ACL 2025 Main Conference; Codes available at: https://github.com/ChaoLinAViy/OMGM
>
...
>
---
#### [replaced 101] PixelPonder: Dynamic Patch Adaptation for Enhanced Multi-Conditional Text-to-Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.06684v2](http://arxiv.org/pdf/2503.06684v2)**
...
>
---
#### [replaced 102] AugLift: Boosting Generalization in Lifting-based 3D Human Pose Estimation
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.07112v2](http://arxiv.org/pdf/2508.07112v2)**
...
>
---
#### [replaced 103] TRIDE: A Text-assisted Radar-Image weather-aware fusion network for Depth Estimation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.08038v2](http://arxiv.org/pdf/2508.08038v2)**
...
>
---
#### [replaced 104] VesselRW: Weakly Supervised Subcutaneous Vessel Segmentation via Learned Random Walk Propagation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.06819v2](http://arxiv.org/pdf/2508.06819v2)**
...
>
---
#### [replaced 105] Mammo-SAE: Interpreting Breast Cancer Concept Learning with Sparse Autoencoders
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.15227v2](http://arxiv.org/pdf/2507.15227v2)**

> **作者:** Krishna Kanth Nakka
>
> **备注:** Accepted at Deep Breast Imaging workshop, MICCAI 2025
>
...
>
---
#### [replaced 106] LoRA-Edit: Controllable First-Frame-Guided Video Editing via Mask-Aware LoRA Fine-Tuning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.10082v4](http://arxiv.org/pdf/2506.10082v4)**
...
>
---
#### [replaced 109] Planner-Refiner: Dynamic Space-Time Refinement for Vision-Language Alignment in Videos
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07330v2](http://arxiv.org/pdf/2508.07330v2)**
...
>
---
#### [replaced 113] VSF: Simple, Efficient, and Effective Negative Guidance in Few-Step Image Generation Models By Value Sign Flip
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.10931v2](http://arxiv.org/pdf/2508.10931v2)**
...
>
---
#### [replaced 116] InterAnimate: Taming Region-aware Diffusion Model for Realistic Human Interaction Animation
- **分类: cs.CV; cs.HC**

- **链接: [http://arxiv.org/pdf/2504.10905v2](http://arxiv.org/pdf/2504.10905v2)**
...
>
---
#### [replaced 117] InsightX Agent: An LMM-based Agentic Framework with Integrated Tools for Reliable X-ray NDT Analysis
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.14899v2](http://arxiv.org/pdf/2507.14899v2)**
...
>
---
#### [replaced 118] Research Challenges and Progress in the End-to-End V2X Cooperative Autonomous Driving Competition
...
>
---
#### [replaced 119] Inverse Bridge Matching Distillation
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2502.01362v2](http://arxiv.org/pdf/2502.01362v2)**

> **作者:** Nikita Gushchin; David Li; Daniil Selikhanovych; Evgeny Burnaev; Dmitry Baranchuk; Alexander Korotin
>
> **摘要:** Learning diffusion bridge models is easy; making them fast and practical is an art. Diffusion bridge models (DBMs) are a promising extension of diffusion models for applications in image-to-image translation. However, like many modern diffusion and flow models, DBMs suffer from the problem of slow inference. To address it, we propose a novel distillation technique based on the inverse bridge matching formulation and derive the tractable objective to solve it in practice. Unlike previously developed DBM distillation techniques, the proposed method can distill both conditional and unconditional types of DBMs, distill models in a one-step generator, and use only the corrupted images for training. We evaluate our approach for both conditional and unconditional types of bridge matching on a wide set of setups, including super-resolution, JPEG restoration, sketch-to-image, and other tasks, and show that our distillation technique allows us to accelerate the inference of DBMs from 4x to 100x and even provide better generation quality than used teacher model depending on particular setup. We provide the code at https://github.com/ngushchin/IBMD
>
---
