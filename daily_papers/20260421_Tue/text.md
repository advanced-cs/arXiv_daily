...
>
---
#### [new 005] Revisiting a Pain in the Neck: A Semantic Reasoning Benchmark for Language Models
- **分类: cs.CL**

- **简介: 该论文提出SemanticQA，用于评估语言模型在语义短语处理任务中的表现，解决语义理解与推理问题，涵盖多种词汇现象并测试不同模型。**
...
>
---
#### [new 010] Latent Abstraction for Retrieval-Augmented Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出LAnR框架，解决RAG系统效率与整合问题。通过统一编码、检索与生成，提升事实性与效率。**

- **链接: [https://arxiv.org/pdf/2604.17866](https://arxiv.org/pdf/2604.17866)**
...
>
---
#### [new 040] PRISMA: Preference-Reinforced Self-Training Approach for Interpretable Emotionally Intelligent Negotiation Dialogues
- **分类: cs.CL**

- **简介: 该论文提出PRISMA系统，解决情感智能对话中的可解释性问题，通过情感感知策略提升谈判效果。**

- **链接: [https://arxiv.org/pdf/2604.18354](https://arxiv.org/pdf/2604.18354)**
...
>
---
#### [new 045] QU-NLP at QIAS 2026: Multi-Stage QLoRA Fine-Tuning for Arabic Islamic Inheritance Reasoning
- **分类: cs.CL**

- **简介: 该论文属于阿拉伯语伊斯兰继承推理任务，旨在提升大模型在法律推理中的表现。通过多阶段QLoRA微调，提高模型在继承案例中的准确性和效率。**

- **链接: [https://arxiv.org/pdf/2604.16396](https://arxiv.org/pdf/2604.16396)**
...
>
---
#### [new 087] Answer Only as Precisely as Justified: Calibrated Claim-Level Specificity Control for Agentic Systems
- **分类: cs.CL**

- **简介: 该论文属于人工智能领域，解决agentic系统过度精确的问题。通过引入CSS方法，分解回答为声明，控制每条声明的精确度，提升系统可靠性与实用性。**
...
>
---
#### [new 088] x1: Learning to Think Adaptively Across Languages and Cultures
- **分类: cs.CL**

- **简介: 该论文属于多语言推理任务，旨在解决语言选择对推理效果的影响问题。研究提出x1模型，通过自适应选择语言提升跨语言和文化任务的推理能力。**

- **链接: [https://arxiv.org/pdf/2604.16917](https://arxiv.org/pdf/2604.16917)**
...
>
---
#### [new 090] TLoRA: Task-aware Low Rank Adaptation of Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出TLoRA，解决大语言模型参数高效微调问题。通过任务感知的初始化和资源分配，提升模型性能并减少可训练参数。**

- **链接: [https://arxiv.org/pdf/2604.18124](https://arxiv.org/pdf/2604.18124)**
...
>
---
#### [new 100] GSQ: Highly-Accurate Low-Precision Scalar Quantization for LLMs via Gumbel-Softmax Sampling
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型量化任务，旨在解决低精度量化与模型精度之间的平衡问题。提出GSQ方法，在保持兼容性的同时提升量化模型的准确性。**
...
>
---
#### [new 108] FLiP: Towards understanding and interpreting multimodal multilingual sentence embeddings
- **分类: cs.CL; cs.SD**
...
>
---
#### [new 109] Negative Advantage Is a Double-Edged Sword: Calibrating Advantage in GRPO for Deep Search
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于深度搜索任务，针对GRPO训练中的优势分配问题，提出CalibAdv方法以提升模型性能与训练稳定性。**
...
>
---
#### [new 110] Where is the Mind? Persona Vectors and LLM Individuation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于人工智能伦理任务，探讨大语言模型是否具有心智。通过分析人格向量和实例结构，提出三种可能的解释，以解决模型个体化问题。**
...
>
---
#### [new 130] Cat-DPO: Category-Adaptive Safety Alignment
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大模型安全对齐任务，旨在解决模型在不同危害类别中安全性和帮助性不平衡的问题。提出Cat-DPO算法，为每个类别设置自适应安全边界，提升整体安全性与一致性。**

- **链接: [https://arxiv.org/pdf/2604.17299](https://arxiv.org/pdf/2604.17299)**
...
>
---
#### [new 152] JudgeMeNot: Personalizing Large Language Models to Emulate Judicial Reasoning in Hebrew
- **分类: cs.CL; cs.CY**

- **简介: 该论文属于自然语言处理任务，旨在解决个性化大语言模型的问题。通过合成监督数据，实现对法官推理的高效个性化，提升模型在低资源环境下的表现。**

- **链接: [https://arxiv.org/pdf/2604.18041](https://arxiv.org/pdf/2604.18041)**
...
>
---
#### [new 153] ComPASS: Towards Personalized Agentic Social Support via Tool-Augmented Companionship
- **分类: cs.CL**

- **简介: 该论文属于情感交互任务，旨在提升智能代理的个性化社会支持能力。通过引入外部工具，增强响应质量，解决现有系统在内容和形式上的局限性。**

- **链接: [https://arxiv.org/pdf/2604.18356](https://arxiv.org/pdf/2604.18356)**
...
>
---
#### [new 175] ArgBench: Benchmarking LLMs on Computational Argumentation Tasks
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于计算论证任务，旨在评估大语言模型的论证能力。构建了首个基准测试，涵盖33个数据集，分析模型在多种论证任务中的表现。**

- **链接: [https://arxiv.org/pdf/2604.17366](https://arxiv.org/pdf/2604.17366)**
...
>
---
#### [new 176] Evaluating Adaptive Personalization of Educational Readings with Simulated Learners
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文属于教育技术领域，旨在评估自适应个性化阅读的效果。通过构建知识本体和模拟学习者，测试不同学科中的适应性阅读效果，解决如何提升学习成效的问题。**

- **链接: [https://arxiv.org/pdf/2604.16744](https://arxiv.org/pdf/2604.16744)**

> **作者:** Ryan T. Woo; Anmol Rao; Aryan Keluskar; Yinong Chen
>
> **摘要:** We present a framework for evaluating adaptive personalization of educational reading materials with theory-grounded simulated learners. The system builds a learning-objective and knowledge-component ontology from open textbooks, curates it in a browser-based Ontology Atlas, labels textbook chunks with ontology entities, and generates aligned reading-assessment pairs. Simulated readers learn from passages through a Construction-Integration-inspired memory model with DIME-style reader factors, KREC-style misconception revision, and an open New Dale-Chall readability signal. Answers are produced by score-based option selection over the learner's explicit memory state, while BKT drives adaptation. Across three sampled subject ontologies and matched cohorts of 50 simulated learners per condition, adaptive reading significantly improved outcomes in computer science, yielded smaller positive but inconclusive gains in inorganic chemistry, and was neutral to slightly negative in general biology.
>
---
#### [new 177] HiRAS: A Hierarchical Multi-Agent Framework for Paper-to-Code Generation and Execution
- **分类: cs.CL**

- **简介: 该论文属于论文到代码生成任务，旨在解决现有方法在实验复现中的协调不足与评估局限。提出HiRAS框架，通过分层多智能体协作提升性能，并引入改进的评估协议P2C-Ex。**
...
>
---
#### [new 200] Knowing When to Quit: A Principled Framework for Dynamic Abstention in LLM Reasoning
- **分类: cs.LG; cs.CL; stat.ML**

- **简介: 该论文属于语言模型推理任务，解决LLM生成冗长错误响应的问题。提出动态弃权机制，在推理过程中提前终止低效路径，提升效率与准确性。**
...
>
---
#### [new 203] VIBE: Voice-Induced open-ended Bias Evaluation for Large Audio-Language Models via Real-World Speech
...
>
---
#### [new 204] Navigating the Conceptual Multiverse
- **分类: cs.HC; cs.CL; cs.CY**

- **简介: 该论文提出概念多宇宙系统，解决语言模型输出缺乏透明决策的问题。通过交互式框架让用户检查、修改并验证决策过程，提升问题理解与推理能力。任务属于自然语言处理中的可解释性研究。**
...
>
---
#### [new 208] MARA: A Multimodal Adaptive Retrieval-Augmented Framework for Document Question Answering
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于多模态文档问答任务，旨在解决现有方法在处理复杂多模态文档时检索不准确、证据选择固定的问题。提出MARA框架，通过查询自适应机制提升检索与生成效果。**

- **链接: [https://arxiv.org/pdf/2604.16313](https://arxiv.org/pdf/2604.16313)**
...
>
---
#### [new 212] Precise Debugging Benchmark: Is Your Model Debugging or Regenerating?
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于代码调试任务，旨在评估大模型在调试中的精确性。提出PDB框架，通过合成错误生成基准，发现模型常过度修复，精度不足。**
...
>
---
#### [new 220] ICLAD: In-Context Learning with Comparison-Guidance for Audio Deepfake Detection
...
>
---
#### [new 221] Enabling AI ASICs for Zero Knowledge Proof
- **分类: cs.AR; cs.CL; cs.CR; cs.DS; cs.PL**

- **简介: 该论文属于优化零知识证明任务，解决ZKP计算成本高的问题。通过MORPH框架，将ZKP算子适配AI ASIC，提升TPU性能。**

- **链接: [https://arxiv.org/pdf/2604.17808](https://arxiv.org/pdf/2604.17808)**
...
>
---
#### [new 236] The Geometric Canary: Predicting Steerability and Detecting Drift via Representational Stability
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于语言模型部署任务，解决模型可控性预测与结构退化检测问题。通过几何稳定性分析，提出监督与非监督方法分别评估模型可控性和监测结构变化。**
...
>
---
#### [new 245] OneVL: One-Step Latent Reasoning and Planning with Vision-Language Explanation
...
>
---
#### [new 248] Characterizing Model-Native Skills
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于模型行为干预任务，旨在解决传统技能表征依赖人工定义的问题。通过从模型内部激活中恢复可解释的基，实现更有效的行为调控。**

- **链接: [https://arxiv.org/pdf/2604.17614](https://arxiv.org/pdf/2604.17614)**
...
>
---
#### [new 250] NIM4-ASR: Towards Efficient, Robust, and Customizable Real-Time LLM-Based ASR
- **分类: eess.AS; cs.CL; cs.SD**
...
>
---
#### [new 263] ClawEnvKit: Automatic Environment Generation for Claw-Like Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出ClawEnvKit，解决手动构建爪型智能体环境效率低的问题，通过自动化生成多样化验证环境，提升训练与评估效率。**
...
>
---
#### [new 264] Aligning Language Models for Lyric-to-Melody Generation with Rule-Based Musical Constraints
- **分类: cs.SD; cs.CL; eess.AS**
...
>
---
#### [new 265] Medical thinking with multiple images
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于医学多图推理任务，旨在解决临床诊断中跨图像证据整合的问题。研究构建了MedThinkVQA数据集，并分析了模型在多图理解与综合上的表现及瓶颈。**

- **链接: [https://arxiv.org/pdf/2604.16506](https://arxiv.org/pdf/2604.16506)**
...
>
> **摘要:** Large language models perform well on many medical QA benchmarks, but real clinical reasoning often requires integrating evidence across multiple images rather than interpreting a single view. We introduce MedThinkVQA, an expert-annotated benchmark for thinking with multiple images, where models must interpret each image, combine cross-view evidence, and answer diagnostic questions with intermediate supervision and step-level evaluation. The dataset contains 8,067 cases, including 720 test cases, with an average of 6.62 images per case, substantially denser than prior work, whose expert-level benchmarks use at most 1.43 images per case. On the test set, the best closed-source models, Claude-4.6-Opus, Gemini-3-Pro, and GPT-5.2-xhigh, reach only 57.2%, 55.3%, and 54.9% accuracy, while GPT-5-mini and GPT-5-nano reach 39.7% and 30.8%. Strong open-source models lag behind, led by Qwen3.5-397B-A17B at 52.2% and Qwen3.5-27B at 50.6%. Further analysis identifies grounded multi-image reasoning as the main bottleneck: models often fail to extract, align, and compose evidence across views before higher-level inference can help. Providing expert single-image cues and cross-image summaries improves performance, whereas replacing them with self-generated intermediates reduces accuracy. Step-level analysis shows that over 70% of errors arise from image reading and cross-view integration. Scaling results further show that additional inference-time computation helps only when visual grounding is already reliable; when early evidence extraction is weak, longer reasoning yields limited or unstable gains and can amplify misread cues. These results suggest that the key challenge is not reasoning length alone, but reliable mechanisms for grounding, aligning, and composing distributed evidence across real-world multimodal clinical inputs.
>
---
#### [new 266] A multimodal and temporal foundation model for virtual patient representations at healthcare system scale
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出Apollo模型，解决医疗数据整合与患者全貌建模问题，通过多模态时间序列数据构建虚拟患者表示，支持疾病预测与检索任务。**
...
>
---
#### [new 270] Safety, Security, and Cognitive Risks in State-Space Models: A Systematic Threat Analysis with Spectral, Stateful, and Capacity Attacks
- **分类: cs.CR; cs.AI; cs.CL; cs.LG; math.OC**

- **简介: 该论文研究SSM在安全、隐私和认知方面的风险，提出攻击方法并评估其影响，属于安全分析任务。**

- **链接: [https://arxiv.org/pdf/2604.16424](https://arxiv.org/pdf/2604.16424)**
...
>
---
#### [replaced 002] Cognitive Alpha Mining via LLM-Driven Code-Based Evolution
- **分类: cs.CL**
...
>
---
#### [replaced 003] SeLaR: Selective Latent Reasoning in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型推理任务，旨在解决CoT方法中因离散采样导致的表达力不足问题。提出SeLaR框架，通过熵门机制和对比正则化提升推理稳定性与多样性。**

- **链接: [https://arxiv.org/pdf/2604.08299](https://arxiv.org/pdf/2604.08299)**
...
>
---
#### [replaced 011] StealthGraph: Exposing Domain-Specific Risks in LLMs through Knowledge-Graph-Guided Harmful Prompt Generation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于LLM安全研究任务，旨在解决隐性有害提示检测难题。通过知识图谱生成领域相关提示，并进行模糊重写，提升提示的隐性和真实性。**

- **链接: [https://arxiv.org/pdf/2601.04740](https://arxiv.org/pdf/2601.04740)**
...
>
---
#### [replaced 012] Plausibility as Commonsense Reasoning: Humans Succeed, Large Language Models Do not
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究语言模型在歧义句理解中的常识推理能力，对比人类与大语言模型对土耳其语相对从句结构的偏好。任务为语法歧义解析，旨在验证模型是否像人类一样利用常识判断句意。**
...
>
---
#### [replaced 013] A Goal Without a Plan Is Just a Wish: Efficient and Effective Global Planner Training for Long-Horizon Agent Tasks
- **分类: cs.CL**

- **简介: 该论文针对长周期智能体任务中的全局规划问题，提出EAGLET方法，通过两步训练提升规划能力，解决LLM代理的低效与幻觉问题，实现更高效准确的执行。**

- **链接: [https://arxiv.org/pdf/2510.05608](https://arxiv.org/pdf/2510.05608)**
...
>
---
#### [replaced 014] OPeRA: A Dataset of Observation, Persona, Rationale, and Action for Evaluating LLMs on Human Online Shopping Behavior Simulation
- **分类: cs.CL; cs.HC**

- **简介: 该论文提出OPERA数据集，用于评估LLMs在模拟用户在线购物行为上的表现。任务是行为预测，解决真实用户行为模拟的评估难题，通过收集观察、人格、理由和动作数据建立基准。**

- **链接: [https://arxiv.org/pdf/2506.05606](https://arxiv.org/pdf/2506.05606)**
...
>
---
#### [replaced 017] Reasoning-Based Refinement of Unsupervised Text Clusters with LLMs
- **分类: cs.CL; cs.AI; cs.CY; cs.LG**

- **简介: 该论文属于文本聚类任务，旨在解决无监督聚类结果不连贯、冗余的问题。通过LLM进行语义验证与重构，提升聚类质量和可解释性。**

- **链接: [https://arxiv.org/pdf/2604.07562](https://arxiv.org/pdf/2604.07562)**

> **作者:** Tunazzina Islam
>
> **备注:** Accepted to the Findings of the 64th Annual Meeting of the Association for Computational Linguistics (ACL 2026). Camera-ready
>
...
>
---
#### [replaced 018] Privacy-R1: Privacy-Aware Multi-LLM Agent Collaboration via Reinforcement Learning
- **分类: cs.CR; cs.CL**

- **简介: 该论文属于隐私保护任务，解决用户查询中敏感信息与模型性能的平衡问题。提出Privacy-R1框架，通过强化学习动态路由文本，兼顾隐私与任务效果。**

- **链接: [https://arxiv.org/pdf/2510.16054](https://arxiv.org/pdf/2510.16054)**
...
>
---
#### [replaced 019] The Illusion of Insight in Reasoning Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文研究推理模型是否具有“顿悟”现象，分析了中段推理变化对性能的影响，发现这类变化罕见且效果有限，提出通过外部触发提升准确性。任务为模型推理机制分析。**

- **链接: [https://arxiv.org/pdf/2601.00514](https://arxiv.org/pdf/2601.00514)**
...
>
---
#### [replaced 020] Unleashing Spatial Reasoning in Multimodal Large Language Models via Textual Representation Guided Reasoning
- **分类: cs.CV; cs.CL**
...
>
> **备注:** Accepted to ACL 2026. 22 pages, 6 figures, 10 tables. Project page: this https URL
>
...
>
---
#### [replaced 021] Is Agentic RAG worth it? An experimental comparison of RAG approaches
- **分类: cs.CL**

- **简介: 该论文属于信息检索与生成任务，旨在比较"增强型"RAG与"代理型"RAG的优劣，分析其在不同场景下的表现与成本，为实际应用提供选择依据。**

- **链接: [https://arxiv.org/pdf/2601.07711](https://arxiv.org/pdf/2601.07711)**
...
>
---
#### [replaced 022] Human-Centered Supervision for Sentiment Analysis in Telugu: A Systematic Inquiry Beyond Accuracy
- **分类: cs.CL**

- **简介: 该论文属于情感分析任务，针对低资源语言Telugu，解决数据稀缺与模型可解释性问题。构建了TeSent数据集，引入人类理由监督，提升模型对齐与公平性。**

- **链接: [https://arxiv.org/pdf/2508.01486](https://arxiv.org/pdf/2508.01486)**
...
>
---
#### [replaced 024] Persona-E$^2$: A Human-Grounded Dataset for Personality-Shaped Emotional Responses to Textual Events
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文提出Persona-E$^2$数据集，解决情感反应与个性关联的问题，通过标注人格特质研究读者情绪变化。**
...
>
---
#### [replaced 027] LIFT the Veil for the Truth: Principal Weights Emerge after Rank Reduction for Reasoning-Focused Supervised Fine-Tuning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于大模型微调任务，旨在解决全量微调计算成本高和稀疏微调效果差的问题。提出LIFT方法，通过低秩近似识别关键权重，仅更新前5%主权重，提升效率与性能。**

- **链接: [https://arxiv.org/pdf/2506.00772](https://arxiv.org/pdf/2506.00772)**
...
>
---
#### [replaced 028] Deep-Reporter: Deep Research for Grounded Multimodal Long-Form Generation
- **分类: cs.CL; cs.AI; cs.IR**

- **简介: 该论文提出Deep-Reporter，解决多模态长文本生成任务中的事实准确性和内容整合问题，通过搜索、合成与上下文管理实现高质量多模态报告生成。**
...
>
> **备注:** 41 pages, 6 figures, 8 tables. Code available at this https URL. v2: corrected typos and updated experimental results
>
...
>
---
#### [replaced 029] End-to-end Listen, Look, Speak and Act
...
>
---
#### [replaced 034] IUQ: Interrogative Uncertainty Quantification for Long-Form Large Language Model Generation
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言生成任务，旨在解决长文本生成中的不确定性量化问题。提出IUQ框架，通过一致性与忠实性评估模型输出的可靠性。**
...
>
---
#### [replaced 035] Beyond URLs: Metadata Diversity and Position for Efficient LLM Pretraining
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究如何通过多样化元数据提升大语言模型预训练效率，解决单一元数据（如URL）效果有限的问题，提出元数据拼接与可学习元标记等方法。**

- **链接: [https://arxiv.org/pdf/2511.21613](https://arxiv.org/pdf/2511.21613)**
...
>
---
#### [replaced 040] Language Models Don't Know What You Want: Evaluating Personalization in Deep Research Needs Real Users
- **分类: cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决DR系统缺乏用户理解的问题。提出MySQA个性化代理，通过用户兴趣建模和行动建议提升个性化体验，并强调真实用户反馈的重要性。**
...
>
---
#### [replaced 043] Don't Adapt Small Language Models for Tools; Adapt Tool Schemas to the Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决小模型在工具使用中的schema误配问题。通过调整工具模式以匹配模型预训练知识，提升工具使用准确性。**

- **链接: [https://arxiv.org/pdf/2510.07248](https://arxiv.org/pdf/2510.07248)**
...
>
---
#### [replaced 044] CHIMERA: A Knowledge Base of Scientific Idea Recombinations for Research Analysis and Ideation
- **分类: cs.CL**

- **简介: 该论文提出CHIMERA知识库，用于记录科学概念重组实例。任务是分析科学创新中的重组模式，解决跨领域研究方向生成问题。通过自动提取文献中的重组案例，构建大规模数据集并应用于模型训练。**

- **链接: [https://arxiv.org/pdf/2505.20779](https://arxiv.org/pdf/2505.20779)**
...
>
---
#### [replaced 045] The Landscape of Agentic Reinforcement Learning for LLMs: A Survey
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于Agentic RL领域，旨在解决LLM作为自主决策代理的转型问题。通过分类和综述，提出核心能力与应用框架，推动通用AI代理发展。**

- **链接: [https://arxiv.org/pdf/2509.02547](https://arxiv.org/pdf/2509.02547)**
...
>
> **备注:** Published on Transactions on Machine Learning Research: this https URL
>
...
>
---
#### [replaced 048] Scaling Beyond Context: A Survey of Multimodal Retrieval-Augmented Generation for Document Understanding
- **分类: cs.CL; cs.CV**

- **简介: 该论文属于文档理解任务，旨在解决传统方法在结构丢失和上下文建模上的不足，通过多模态检索增强生成技术实现更全面的文档智能。**

- **链接: [https://arxiv.org/pdf/2510.15253](https://arxiv.org/pdf/2510.15253)**
...
>
> **备注:** Accepted by ACL2026 Main Conference; Project is available at this https URL
>
...
>
---
#### [replaced 049] MedRedFlag: Investigating how LLMs Redirect Misconceptions in Real-World Health Communication
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗问答任务，旨在解决LLMs在处理含错误前提的健康问题时无法正确引导的问题。研究构建了MedRedFlag数据集，并对比了LLMs与医生的回答，发现LLMs存在安全缺陷。**
...
>
---
#### [replaced 050] MetFuse: Figurative Fusion between Metonymy and Metaphor
- **分类: cs.CL**

- **简介: 该论文提出MetFuse，解决自然语言中隐喻与转喻共现的融合问题，构建了首个相关数据集，用于提升两者分类效果。**
...
>
---
#### [replaced 051] Compositional Steering of Large Language Models with Steering Tokens
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，解决多行为同时控制问题。提出组合引导令牌，实现对大模型的多目标有效引导。**

- **链接: [https://arxiv.org/pdf/2601.05062](https://arxiv.org/pdf/2601.05062)**
...
>
---
#### [replaced 052] Semantic-Space Exploration and Exploitation in RLVR for LLM Reasoning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，解决LLM推理中探索与利用的平衡问题。通过分析隐状态空间，提出VERL方法提升性能。**
...
>
---
#### [replaced 053] Task Matters: Knowledge Requirements Shape LLM Responses to Context-Memory Conflict
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究LLM在任务中处理上下文与记忆冲突的问题，属于自然语言处理领域。它探讨不同任务对知识依赖程度的影响，提出诊断框架分析冲突原因及影响。**

- **链接: [https://arxiv.org/pdf/2506.06485](https://arxiv.org/pdf/2506.06485)**
...
>
---
#### [replaced 054] CAPC-CG: A Large-Scale, Expert-Directed LLM-Annotated Corpus of Adaptive Policy Communication in China
- **分类: cs.CL; cs.CE; cs.CY**

- **简介: 该论文介绍CAPC-CG语料库，用于中国政策沟通的多语言NLP研究。任务是构建标注数据集，解决政策文本分析问题，完成语料收集、标注与模型基准测试。**
...
>
---
#### [replaced 058] Toward Consistent World Models with Multi-Token Prediction and Latent Semantic Enhancement
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于语言模型任务，旨在解决LLM内部世界模型的一致性问题。通过改进多标记预测方法，减少结构幻觉，提升表示对齐与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2604.06155](https://arxiv.org/pdf/2604.06155)**

> **作者:** Qimin Zhong; Hao Liao; Haiming Qin; Mingyang Zhou; Rui Mao; Wei Chen; Naipeng Chao
>
> **备注:** Accepted by ACL 2026 Main Conference. 21 pages, 3 figures, 7 tables
>
...
>
---
#### [replaced 059] Alexandria: A Multi-Domain Dialectal Arabic Machine Translation Dataset for Culturally Inclusive and Linguistically Diverse LLMs
- **分类: cs.CL**

- **简介: 该论文提出Alexandria数据集，用于改进阿拉伯语方言机器翻译。解决方言翻译效果差的问题，涵盖13国11领域，提供细粒度方言信息和性别标注，助力LLMs训练与评估。**

- **链接: [https://arxiv.org/pdf/2601.13099](https://arxiv.org/pdf/2601.13099)**
...
>
---
#### [replaced 061] Empowering Multi-Turn Tool-Integrated Agentic Reasoning with Group Turn Policy Optimization
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于多轮工具集成推理任务，解决现有强化学习方法在复杂交互中训练效果差的问题。提出GTPO算法，通过细粒度奖励、回报优势估计和自监督奖励塑造提升性能。**

- **链接: [https://arxiv.org/pdf/2511.14846](https://arxiv.org/pdf/2511.14846)**
...
>
---
#### [replaced 064] CROC: Evaluating and Training T2I Metrics with Pseudo- and Human-Labeled Contrastive Robustness Checks
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于文本到图像生成的评估任务，解决现有评估指标鲁棒性不足的问题。提出CROC框架，生成伪标签数据并训练新指标CROCScore，提升评估准确性。**

- **链接: [https://arxiv.org/pdf/2505.11314](https://arxiv.org/pdf/2505.11314)**

> **作者:** Christoph Leiter; Yuki M. Asano; Margret Keuper; Steffen Eger
>
> **备注:** pre-MIT Press publication version; Accepted at TACL
>
...
>
---
#### [replaced 065] FaithLens: Detecting and Explaining Faithfulness Hallucination
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出FaithLens，用于检测并解释大语言模型中的忠实性幻觉问题。属于自然语言处理中的可信度评估任务，旨在提升模型输出的可靠性。**

- **链接: [https://arxiv.org/pdf/2512.20182](https://arxiv.org/pdf/2512.20182)**
...
>
---
#### [replaced 066] GeoRC: A Benchmark for Geolocation Reasoning Chains
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出GeoRC基准，用于评估视觉语言模型的地理推理链。解决VLM在解释预测依据上的不足，通过专家标注数据评估模型表现。**

- **链接: [https://arxiv.org/pdf/2601.21278](https://arxiv.org/pdf/2601.21278)**
...
>
---
#### [replaced 067] Large Language Models Are Bad Dice Players: LLMs Struggle to Generate Random Numbers from Statistical Distributions
- **分类: cs.CL**

- **简介: 该论文属于语言模型评估任务，研究LLMs生成随机数的能力。发现LLMs在统计采样上存在严重缺陷，需依赖外部工具以确保准确性。**

- **链接: [https://arxiv.org/pdf/2601.05414](https://arxiv.org/pdf/2601.05414)**
...
>
---
#### [replaced 070] Evalet: Evaluating Large Language Models through Functional Fragmentation
- **分类: cs.HC; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理中的模型评估任务，旨在解决LLM评价结果不透明的问题。通过功能碎片化方法，分析输出片段的语用功能，提升评估的可解释性与准确性。**

- **链接: [https://arxiv.org/pdf/2509.11206](https://arxiv.org/pdf/2509.11206)**

> **作者:** Tae Soo Kim; Heechan Lee; Yoonjoo Lee; Joseph Seering; Juho Kim
>
> **备注:** The first two authors hold equal contribution. Presented at CHI 2026
>
...
>
---
#### [replaced 071] ConsistRM: Improving Generative Reward Models via Consistency-Aware Self-Training
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于强化学习任务，旨在解决生成式奖励模型（GRMs）依赖人工标注数据和训练不稳定的问题。提出ConsistRM框架，通过一致性感知奖励提升模型稳定性与效果。**

- **链接: [https://arxiv.org/pdf/2604.07484](https://arxiv.org/pdf/2604.07484)**
...
>
---
#### [replaced 072] An Exploration of Mamba for Speech Self-Supervised Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文探讨Mamba在语音自监督学习中的应用，旨在解决长序列建模和实时语音处理问题。通过构建基于Mamba的HuBERT模型，验证其在语音识别和特征提取上的有效性。**

- **链接: [https://arxiv.org/pdf/2506.12606](https://arxiv.org/pdf/2506.12606)**
...
>
---
#### [replaced 073] AttnTrace: Contextual Attribution of Prompt Injection and Knowledge Corruption
- **分类: cs.CL; cs.CR**

- **简介: 该论文提出AttnTrace，用于高效准确地追踪长文本中影响模型输出的关键内容，解决上下文追溯问题。**
...
>
---
#### [replaced 074] NOSE: Neural Olfactory-Semantic Embedding with Tri-Modal Orthogonal Contrastive Learning
- **分类: cs.CL**

- **简介: 该论文提出NOSE框架，解决嗅觉多模态表示学习问题，通过对齐分子、受体和语言模态，提升模型的生物合理性和语义可解释性。**
...
>
---
#### [replaced 076] Follow the Path: Reasoning over Knowledge Graph Paths to Improve Large Language Model Factuality
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识密集型任务，旨在提升大语言模型的准确性。通过将推理路径与知识图谱对齐，改进模型的推理轨迹，增强其事实性。**

- **链接: [https://arxiv.org/pdf/2505.11140](https://arxiv.org/pdf/2505.11140)**
...
>
---
#### [replaced 077] OpenVLThinkerV2: A Generalist Multimodal Reasoning Model for Multi-domain Visual Tasks
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文提出G²RPO方法，解决多模态模型在不同视觉任务中的训练不稳定和感知与推理平衡问题，构建了高效通用的多模态模型OpenVLThinkerV2。**

- **链接: [https://arxiv.org/pdf/2604.08539](https://arxiv.org/pdf/2604.08539)**
...
>
---
#### [replaced 078] CreditDecoding: Accelerating Parallel Decoding in Diffusion Large Language Models with Trace Credit
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本生成任务，解决dLLMs并行解码效率低的问题。通过引入Trace Credit提升正确但低置信度token的置信度，实现加速与性能提升。**
...
>
---
#### [replaced 079] Merging Triggers, Breaking Backdoors: Defensive Poisoning for Instruction-Tuned Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于模型安全任务，解决指令调优语言模型的后门攻击问题。提出MB-Defense框架，通过防御性污染和后门中和提升模型鲁棒性。**
...
>
---
#### [replaced 080] CAMO: An Agentic Framework for Automated Causal Discovery from Micro Behaviors to Macro Emergence in LLM Agent Simulations
- **分类: cs.AI; cs.CL; cs.CY**

- **简介: 该论文提出CAMO框架，用于从LLM代理模拟中自动发现微观行为到宏观涌现的因果机制，解决因果关系不明确的问题。**
...
>
---
#### [replaced 086] Pseudo2Real: Task Arithmetic for Pseudo-Label Correction in Automatic Speech Recognition
- **分类: eess.AS; cs.CL**
...
>
---
#### [replaced 087] Oblivion: Self-Adaptive Agentic Memory Control through Decay-Driven Activation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大模型记忆控制任务，旨在解决长期交互中的记忆干扰与延迟问题。提出Oblivion框架，通过衰减驱动的遗忘机制实现自适应记忆管理。**
...
>
> **备注:** 30 pages, 6 figures, and 17 tables. The source code is available at this https URL
>
...
- **简介: 该论文属于知识图谱构建任务，旨在解决KG与下游应用脱节的问题。通过强化学习优化KG结构，提升RAG系统的问答性能。**

- **链接: [https://arxiv.org/pdf/2510.15339](https://arxiv.org/pdf/2510.15339)**
...
>
---
#### [replaced 089] LOGICAL-COMMONSENSEQA: A Benchmark for Logical Commonsense Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出LOGICAL-COMMONSENSEQA，用于逻辑常识推理任务。解决传统基准单一标签评估的局限性，通过逻辑运算符构建多陈述推理问题，评估模型在不同推理类型上的表现。**

- **链接: [https://arxiv.org/pdf/2601.16504](https://arxiv.org/pdf/2601.16504)**
...
>
---
#### [replaced 094] XQ-MEval: A Dataset with Cross-lingual Parallel Quality for Benchmarking Translation Metrics
- **分类: cs.CL**

- **简介: 该论文属于机器翻译评估任务，旨在解决跨语言评分偏差问题。通过构建XQ-MEval数据集，进行翻译质量评估实验，提出归一化策略提升多语言评估公平性。**
...
>
---
#### [replaced 095] BASIL: Bayesian Assessment of Sycophancy in LLMs
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于AI伦理任务，旨在解决LLMs中sycophancy问题。通过构建贝叶斯框架，区分sycophancy与理性行为，提出度量方法并验证其有效性。**

- **链接: [https://arxiv.org/pdf/2508.16846](https://arxiv.org/pdf/2508.16846)**
...
>
---
#### [replaced 096] Multimodal Policy Internalization for Conversational Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出Multimodal Policy Internalization（MPI），解决多模态对话系统中策略复杂、难以遵循的问题。通过TriMPI框架，将策略内化到模型参数中，提升政策遵循能力。**

- **链接: [https://arxiv.org/pdf/2510.09474](https://arxiv.org/pdf/2510.09474)**
...
>
---
#### [replaced 097] Missing-by-Design: Certifiable Modality Deletion for Revocable Multimodal Sentiment Analysis
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出MBD框架，解决多模态情感分析中敏感数据的可撤销删除问题，通过结构化表示学习和参数修改实现隐私保护与任务性能平衡。**
...
>
---
#### [replaced 098] How Should We Enhance the Safety of Large Reasoning Models: An Empirical Study
- **分类: cs.CL**

- **简介: 该论文属于模型安全增强任务，旨在解决大推理模型安全性不足的问题。通过实验证明，直接蒸馏安全响应效果有限，需针对性改进数据蒸馏过程，并发现简短推理也能有效提升安全性能。**

- **链接: [https://arxiv.org/pdf/2505.15404](https://arxiv.org/pdf/2505.15404)**
...
>
---
#### [replaced 101] More Than Sum of Its Parts: Deciphering Intent Shifts in Multimodal Hate Speech Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多模态仇恨言论检测任务，旨在解决隐晦仇恨言论识别难题。通过构建H-VLI基准和提出ARCADE框架，提升模型对多模态交互中隐含意图的捕捉能力。**

- **链接: [https://arxiv.org/pdf/2603.21298](https://arxiv.org/pdf/2603.21298)**

> **作者:** Runze Sun; Yu Zheng; Zexuan Xiong; Zhongjin Qu; Lei Chen; Jie Zhou; Jiwen Lu
>
...
>
---
#### [replaced 104] Enhance-then-Balance Modality Collaboration for Robust Multimodal Sentiment Analysis
- **分类: cs.CL**

- **简介: 该论文属于多模态情感分析任务，旨在解决模态间不平衡问题。通过增强弱模态并协调模态贡献，提升模型鲁棒性与融合效果。**
...
>
---
#### [replaced 105] ImpRIF: Stronger Implicit Reasoning Leads to Better Complex Instruction Following
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在提升模型对复杂指令的理解与执行能力。针对隐式推理问题，提出ImpRIF方法，通过构建可验证的推理图进行训练，显著提升模型表现。**

- **链接: [https://arxiv.org/pdf/2602.21228](https://arxiv.org/pdf/2602.21228)**
...
>
---
#### [replaced 106] PRL: Prompts from Reinforcement Learning
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出PRL方法，解决LLMs中有效提示工程的问题，通过强化学习自动生成提示，提升文本分类、简化和摘要任务性能。**

- **链接: [https://arxiv.org/pdf/2505.14412](https://arxiv.org/pdf/2505.14412)**
...
>
---
#### [replaced 107] Evidence-Augmented Policy Optimization with Reward Co-Evolution for Long-Context Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于长文本推理任务，解决RL在长上下文场景中奖励稀疏的问题。提出EAPO方法，通过增强证据提取和奖励模型协同进化提升推理性能。**

- **链接: [https://arxiv.org/pdf/2601.10306](https://arxiv.org/pdf/2601.10306)**
...
>
---
#### [replaced 108] SkillX: Automatically Constructing Skill Knowledge Bases for Agents
- **分类: cs.CL; cs.AI; cs.IR; cs.LG; cs.MA**

- **简介: 该论文提出SkillX框架，解决LLM代理学习效率低的问题。通过构建可复用的技能知识库，提升代理在不同环境中的任务成功率和效率。属于智能代理学习任务。**
...
>
---
#### [replaced 112] Establishing a Scale for Kullback-Leibler Divergence in Language Models Across Various Settings
- **分类: cs.CL**

- **简介: 该论文属于语言模型分析任务，旨在建立跨不同设置的KL散度统一尺度。通过log-likelihood空间分析，解决模型比较与学习轨迹理解问题。**

- **链接: [https://arxiv.org/pdf/2505.15353](https://arxiv.org/pdf/2505.15353)**
...
>
---
#### [replaced 113] Triples and Knowledge-Infused Embeddings for Clustering and Classification of Scientific Documents
- **分类: cs.CL; cs.AI; cs.DL**

- **简介: 该论文研究科学文献的聚类与分类任务，探讨结构化知识是否提升模型性能。实验对比了不同文本表示和嵌入方法，发现纯文本表现最佳，结构化三元组效果有限。**

- **链接: [https://arxiv.org/pdf/2601.08841](https://arxiv.org/pdf/2601.08841)**
...
>
---
#### [replaced 116] On the Predictive Power of Representation Dispersion in Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究语言模型的表示分散性与文本预测能力的关系，属于自然语言处理任务。旨在解决模型性能评估与优化问题，通过分析分散性提升模型效果。**

- **链接: [https://arxiv.org/pdf/2506.24106](https://arxiv.org/pdf/2506.24106)**
...
>
---
#### [replaced 117] STRIDE-ED: A Strategy-Grounded Stepwise Reasoning Framework for Empathetic Dialogue Systems
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于情感对话系统任务，旨在解决现有方法在情感策略和多阶段推理上的不足。提出STRIDE-ED框架，结合策略引导的深度推理和高质量数据训练，提升对话的情感共鸣与准确性。**
...
>
---
#### [replaced 120] Render-of-Thought: Rendering Textual Chain-of-Thought as Images for Visual Latent Reasoning
- **分类: cs.CL; cs.CV**

- **简介: 该论文提出RoT框架，将文本推理过程转化为图像，解决LLM推理冗余和可解释性差的问题。属于视觉-语言推理任务，通过图像显式化推理链，提升效率与可分析性。**
...
>
---
#### [replaced 121] Less Noise, More Voice: Reinforcement Learning for Reasoning via Instruction Purification
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决LLM推理中因噪声提示导致的探索效率低问题。通过去除干扰词并利用净化过程提升训练效率。**

- **链接: [https://arxiv.org/pdf/2601.21244](https://arxiv.org/pdf/2601.21244)**

> **作者:** Yiju Guo; Tianyi Hu; Zexu Sun; Yankai Lin
>
> **备注:** Accepted at ACL 2026, camera-ready version
>
...
>
---
#### [replaced 124] EduRABSA: An Education Review Dataset for Aspect-based Sentiment Analysis Tasks
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出EduRABSA，首个公开的教育评论方面情感分析数据集，解决教育领域数据稀缺问题，支持多任务ABSAC研究。**

- **链接: [https://arxiv.org/pdf/2508.17008](https://arxiv.org/pdf/2508.17008)**

> **作者:** Yan Cathy Hua; Paul Denny; Jörg Wicker; Katerina Taskova
>
> **备注:** V2: Added more detailed dataset statistics
>
...
>
---
#### [replaced 125] SERM: Self-Evolving Relevance Model with Agent-Driven Learning from Massive Query Streams
- **分类: cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决动态查询流中相关性模型泛化能力不足的问题。通过引入自进化机制和多智能体框架，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.09515](https://arxiv.org/pdf/2601.09515)**
...
>
---
#### [replaced 126] Stable Language Guidance for Vision-Language-Action Models
- **分类: cs.RO; cs.CL**
...
>
---
#### [replaced 127] Pearmut: Human Evaluation of Translation Made Trivial
- **分类: cs.CL; cs.HC**

- **简介: 该论文提出Pearmut，一个轻量级平台，用于简化多语言机器翻译的人工评估，解决人工评估复杂、耗时的问题。**

- **链接: [https://arxiv.org/pdf/2601.02933](https://arxiv.org/pdf/2601.02933)**
...
>
---
#### [replaced 128] Emergent Structured Representations Support Flexible In-Context Inference in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大语言模型的上下文推理机制，探讨其是否依赖结构化表示。通过分析模型内部处理过程，发现中间层形成稳定的概念子空间，并验证其在推理中的关键作用。**

- **链接: [https://arxiv.org/pdf/2602.07794](https://arxiv.org/pdf/2602.07794)**
...
>
---
#### [replaced 129] TSVer: A Benchmark for Fact Verification Against Time-Series Evidence
- **分类: cs.CL**

- **简介: 该论文提出TSVer，一个用于时间序列事实验证的基准数据集，解决真实世界事实核查中时间与数值推理的问题。**

- **链接: [https://arxiv.org/pdf/2511.01101](https://arxiv.org/pdf/2511.01101)**

> **作者:** Marek Strong; Andreas Vlachos
>
> **备注:** Published at EMNLP 2025. v2 includes a revised version of the dataset
>
...
>
---
#### [replaced 130] User-Assistant Bias in LLMs
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文研究LLM中用户-助手角色偏见问题，属于模型偏差分析任务。通过构建基准测试，分析不同模型的偏见倾向，并探索如何控制这种偏见。**

- **链接: [https://arxiv.org/pdf/2508.15815](https://arxiv.org/pdf/2508.15815)**
...
>
---
#### [replaced 131] LogicDiff: Logic-Guided Denoising Improves Zero-Shot Reasoning in Masked Diffusion Language Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理任务，针对掩码扩散语言模型在零样本推理中的性能问题，提出LogicDiff方法，通过逻辑角色引导解掩码提升推理效果。**
...
>
---
#### [replaced 132] Retrieval as Generation: A Unified Framework with Self-Triggered Information Planning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于问答任务，解决传统检索增强生成中检索与生成分离的问题。提出GRIP框架，通过生成引导检索，实现端到端的检索决策与信息整合。**
...
>
---
#### [replaced 133] FOREVER: Forgetting Curve-Inspired Memory Replay for Language Model Continual Learning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于持续学习任务，旨在解决语言模型在连续学习中出现的灾难性遗忘问题。提出FOREVER框架，基于遗忘曲线优化记忆回放策略，提升模型稳定性。**

- **链接: [https://arxiv.org/pdf/2601.03938](https://arxiv.org/pdf/2601.03938)**
...
>
---
#### [replaced 134] MoCo: A One-Stop Shop for Model Collaboration Research
- **分类: cs.CL**

- **简介: 该论文提出MoCo，一个用于模型协作研究的Python库，解决模型协同效率与比较问题，集成多种协作方法和数据集，验证协作策略的有效性。**

- **链接: [https://arxiv.org/pdf/2601.21257](https://arxiv.org/pdf/2601.21257)**

> **作者:** Shangbin Feng; Yuyang Bai; Ziyuan Yang; Yike Wang; Zhaoxuan Tan; Jiajie Yan; Zhenyu Lei; Wenxuan Ding; Weijia Shi; Haojin Wang; Zhenting Qi; Yuru Jiang; Heng Wang; Chengsong Huang; Yu Fei; Jihan Yao; Yilun Du; Luke Zettlemoyer; Yejin Choi; Yulia Tsvetkov
>
> **备注:** Moco is available at this https URL
>
> **摘要:** Advancing beyond single monolithic language models (LMs), recent research increasingly recognizes the importance of model collaboration, where multiple LMs collaborate, compose, and complement each other. Existing research on this topic has mostly been disparate and disconnected, from different research communities, and lacks rigorous comparison. To consolidate existing research and establish model collaboration as a school of thought, we present MoCo: a one-stop Python library of executing, benchmarking, and comparing model collaboration algorithms at scale. MoCo features 26 model collaboration methods, spanning diverse levels of cross-model information exchange such as routing, text, logit, and model parameters. MoCo integrates 25 evaluation datasets spanning reasoning, QA, code, safety, and more, while users could flexibly bring their own data. Extensive experiments with MoCo demonstrate that most collaboration strategies outperform models without collaboration in 61.0% of (model, data) settings on average, with the most effective methods outperforming by up to 25.8%. We further analyze the scaling of model collaboration strategies, the training/inference efficiency of diverse methods, highlight that the collaborative system solves problems where single LMs struggle, and discuss future work in model collaboration, all made possible by MoCo. We envision MoCo as a valuable toolkit to facilitate and turbocharge the quest for an open, modular, decentralized, and collaborative AI future.
>
---
#### [replaced 135] ReTraceQA: Evaluating Reasoning Traces of Small Language Models in Commonsense Question Answering
- **分类: cs.CL**

- **简介: 该论文属于常识推理任务，旨在解决现有评估仅关注答案正确性而忽视推理过程的问题。工作包括构建ReTraceQA基准，引入过程级评估，揭示SLMs性能可能被高估。**

- **链接: [https://arxiv.org/pdf/2510.09351](https://arxiv.org/pdf/2510.09351)**
...
>
---
#### [replaced 136] Information Representation Fairness in Long-Document Embeddings: The Peculiar Interaction of Positional and Language Bias
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究长文档嵌入中的信息表示公平性问题，针对位置和语言偏差提出评估框架与注意力校准方法，以提升后段内容的可发现性。**

- **链接: [https://arxiv.org/pdf/2601.16934](https://arxiv.org/pdf/2601.16934)**

> **作者:** Elias Schuhmacher; Andrianos Michail; Juri Opitz; Rico Sennrich; Simon Clematide
>
> **备注:** To appear in ACL2026 (findings)
>
...
>
---
#### [replaced 137] Maximizing Local Entropy Where It Matters: Prefix-Aware Localized LLM Unlearning
- **分类: cs.CL**

- **简介: 该论文属于机器遗忘任务，旨在从大语言模型中删除敏感信息同时保持模型性能。提出PALU框架，通过局部熵最大化有效实现遗忘，减少对整体性能的影响。**

- **链接: [https://arxiv.org/pdf/2601.03190](https://arxiv.org/pdf/2601.03190)**
...
>
---
#### [replaced 138] M2-Verify: A Large-Scale Multidomain Benchmark for Checking Multimodal Claim Consistency
- **分类: cs.CL**
...
>
---
#### [replaced 139] Towards Intrinsic Interpretability of Large Language Models:A Survey of Design Principles and Architectures
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于可解释AI任务，旨在解决LLM透明性不足的问题。通过系统综述，提出五种内在可解释性设计范式，推动模型可信与安全应用。**
...
>
---
#### [replaced 140] How Language Models Conflate Logical Validity with Plausibility: A Representational Analysis of Content Effects
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，研究LLMs中逻辑有效性与合理性混淆的现象。通过分析模型内部表示，揭示其机制并提出去偏方法，提升推理准确性。**

- **链接: [https://arxiv.org/pdf/2510.06700](https://arxiv.org/pdf/2510.06700)**
...
>
---
#### [replaced 141] ResearchBench: Benchmarking LLMs in Scientific Discovery via Inspiration-Based Task Decomposition
- **分类: cs.CL; cs.AI; cs.CE**

- **简介: 该论文属于科学发现任务，旨在解决LLMs在高质量研究假设生成上的评估问题。通过构建基准测试，涵盖灵感检索、假设生成与排序等子任务，验证LLMs的科学创新能力。**

- **链接: [https://arxiv.org/pdf/2503.21248](https://arxiv.org/pdf/2503.21248)**
...
>
---
#### [replaced 142] Cognitive Chain-of-Thought (CoCoT): Structured Multimodal Reasoning about Social Situations
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文提出CoCoT框架，用于结构化多模态社会推理任务，解决视觉与语言结合的社会情境理解问题，通过感知、情境推断和规范应用三阶段提升模型推理能力。**

- **链接: [https://arxiv.org/pdf/2507.20409](https://arxiv.org/pdf/2507.20409)**
...
>
---
#### [replaced 143] Parallel Test-Time Scaling for Latent Reasoning Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究如何在连续空间中实现并行测试时缩放，解决 latent reasoning 模型无法有效应用 TTS 的问题。通过引入采样策略和聚合模型，提升推理效率。**

- **链接: [https://arxiv.org/pdf/2510.07745](https://arxiv.org/pdf/2510.07745)**

> **作者:** Runyang You; Yongqi Li; Meng Liu; Wenjie Wang; Liqiang Nie; Wenjie Li
>
> **备注:** Accepted at ACL 2026 Main Conference
>
> **摘要:** Parallel test-time scaling (TTS) is a pivotal approach for enhancing large language models (LLMs), typically by sampling multiple token-based chains-of-thought in parallel and aggregating outcomes through voting or search. Recent advances in latent reasoning, where intermediate reasoning unfolds in continuous vector spaces, offer a more efficient alternative to explicit Chain-of-Thought, yet whether such latent models can similarly benefit from parallel TTS remains open, mainly due to the absence of sampling mechanisms in continuous space, and the lack of probabilistic signals for advanced trajectory aggregation. This work enables parallel TTS for latent reasoning models by addressing the above issues. For sampling, we introduce two uncertainty-inspired stochastic strategies: Monte Carlo Dropout and Additive Gaussian Noise. For aggregation, we design a Latent Reward Model (LatentRM) trained with step-wise contrastive objective to score and guide latent reasoning. Extensive experiments and visualization analyses show that both sampling strategies scale effectively with compute and exhibit distinct exploration dynamics, while LatentRM enables effective trajectory selection. Together, our explorations open a new direction for scalable inference in continuous spaces. Code and checkpoints released at this https URL
>
---
#### [replaced 144] MT-OSC: Path for LLMs that Get Lost in Multi-Turn Conversation
- **分类: cs.CL**

- **简介: 该论文提出MT-OSC，解决多轮对话中LLMs性能下降的问题。通过压缩对话历史，减少token数量，提升效率与准确性。属于自然语言处理中的多轮对话任务。**
...
>
---
#### [replaced 147] Measuring Social Bias in Vision-Language Models with Face-Only Counterfactuals from Real Photos
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于社会偏见检测任务，旨在解决视觉-语言模型中因视觉混淆导致的偏见评估问题。通过构建面部属性可控的反事实图像数据集，评估模型在不同任务中的偏见表现。**

- **链接: [https://arxiv.org/pdf/2601.06931](https://arxiv.org/pdf/2601.06931)**
...
>
---
#### [replaced 150] Arch: An AI-Native Hardware Description Language for Register-Transfer Clocked Hardware Design
- **分类: cs.PL; cs.CL**

- **简介: 该论文提出Arch，一种面向寄存器传输时序硬件设计的AI原生硬件描述语言，解决传统HDL易出错的问题，通过类型系统和AI生成实现更安全的硬件设计。**
...
>
---
#### [replaced 151] BRIDGE the Gap: Mitigating Bias Amplification in Automated Scoring of English Language Learners via Inter-group Data Augmentation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于教育评估任务，旨在解决自动化评分中对英语学习者（ELL）的偏差放大问题。通过生成合成数据提升公平性，同时保持评分性能。**
...
>
> **备注:** 15 pages, 1 figure. Accepted as a full paper at AIED 2026
>
...
>
---
#### [replaced 152] ControlAudio: Tackling Text-Guided, Timing-Indicated and Intelligible Audio Generation via Progressive Diffusion Modeling
...
>
---
#### [replaced 156] Common Corpus: The Largest Collection of Ethical Data for LLM Pre-Training
- **分类: cs.CL**

- **简介: 该论文介绍了一个名为Common Corpus的大型开放数据集，用于LLM预训练。旨在解决数据合法性与多样性问题，通过收集合法、多语言和代码数据，支持开放科学研究。**
...
>
---
#### [replaced 157] Matrix: Peer-to-Peer Multi-Agent Synthetic Data Generation Framework
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出Matrix框架，解决多智能体合成数据生成中的中心化瓶颈和灵活性不足问题，实现去中心化、高效的数据生成。**

- **链接: [https://arxiv.org/pdf/2511.21686](https://arxiv.org/pdf/2511.21686)**
...
>
---
#### [replaced 163] Evaluating Robustness of Large Language Models Against Multilingual Typographical Errors
- **分类: cs.CL**

- **简介: 该论文研究多语言大模型对拼写错误的鲁棒性问题，提出MulTypo生成算法，评估18个模型在多项任务中的表现，发现拼写错误显著影响性能，尤其在生成和推理任务中。**
...
>
---
#### [replaced 164] ODUTQA-MDC: A Task for Open-Domain Underspecified Tabular QA with Multi-turn Dialogue-based Clarification
- **分类: cs.CL; cs.DB; cs.IR; cs.MA**

- **简介: 该论文提出ODUTQA-MDC任务，解决开放域表式问答中的模糊表达问题。构建了基准数据集和动态澄清接口，并提出多智能体框架MAIC-TQA进行交互澄清与答案优化。**
...
>
> **备注:** This paper has been accepted by ACL 2026 (main conference)
>
...
>
---
#### [replaced 167] Two-Stage Regularization-Based Structured Pruning for LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于模型压缩任务，旨在解决大语言模型部署困难的问题。通过两阶段正则化结构化剪枝方法TRSP，提升模型性能与效率，无需重新训练。**

- **链接: [https://arxiv.org/pdf/2505.18232](https://arxiv.org/pdf/2505.18232)**
...
>
---
#### [replaced 168] ZoFia: Zero-Shot Fake News Detection with Entity-Guided Retrieval and Multi-LLM Interaction
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于虚假新闻检测任务，旨在解决LLM在时间敏感新闻中的知识局限和事实幻觉问题。提出ZoFia框架，通过实体引导检索和多LLM协作提升检测效果。**
...
>
---
#### [replaced 169] LoRA on the Go: Instance-level Dynamic LoRA Selection and Merging
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出LoGo框架，解决多任务下LoRA适配器动态选择与合并问题，无需额外训练即可提升性能。**

- **链接: [https://arxiv.org/pdf/2511.07129](https://arxiv.org/pdf/2511.07129)**

> **作者:** Seungeon Lee; Soumi Das; Manish Gupta; Krishna P. Gummadi
>
> **备注:** Accepted as a main conference paper in ACL 2026
>
...
>
---
#### [replaced 170] Instruction Data Selection via Answer Divergence
- **分类: cs.CL**
...
>
---
#### [replaced 171] ToMMeR -- Efficient Entity Mention Detection from Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于实体提及检测任务，旨在高效识别文本中指向实体的片段。提出轻量模型ToMMeR，实现高召回率和低误报，验证了语言模型早期层中存在结构化实体表示。**

- **链接: [https://arxiv.org/pdf/2510.19410](https://arxiv.org/pdf/2510.19410)**

> **作者:** Victor Morand; Nadi Tomeh; Josiane Mothe; Benjamin Piwowarski
>
> **备注:** Accepted at ACL2026 - Code: this https URL
>
...
>
---
#### [replaced 172] From Domains to Instances: Dual-Granularity Data Synthesis for LLM Unlearning
- **分类: cs.CL; cs.AI; cs.CR; cs.LG**

- **简介: 该论文属于机器学习中的模型遗忘任务，旨在解决现有基准无法准确反映模型遗忘范围的问题。提出BiForget框架，通过模型自身生成高质量遗忘数据，提升遗忘效果与效率。**

- **链接: [https://arxiv.org/pdf/2601.04278](https://arxiv.org/pdf/2601.04278)**

> **作者:** Xiaoyu Xu; Minxin Du; Zitong Li; Zi Liang; Zhibiao Guo; Shiyu Zhang; Peizhao Hu; Qingqing Ye; Haibo Hu
>
> **备注:** ACL 2026 (Findings), accepted to appear
>
...
>
---
#### [replaced 173] Sculpting the Vector Space: Towards Efficient Multi-Vector Visual Document Retrieval via Prune-then-Merge Framework
- **分类: cs.CL; cs.CV; cs.IR**

- **简介: 该论文属于视觉文档检索任务，旨在解决多向量方法压缩效率与特征保真之间的矛盾。提出Prune-then-Merge框架，先剪枝后合并，提升检索效率与精度。**

- **链接: [https://arxiv.org/pdf/2602.19549](https://arxiv.org/pdf/2602.19549)**
...
>
---
#### [replaced 174] From Fragments to Facts: A Curriculum-Driven DPO Approach for Generating Hindi News Veracity Explanations
- **分类: cs.CL**

- **简介: 该论文属于新闻真实性解释生成任务，旨在解决低资源语言如印地语在虚假信息检测中的不足。通过结合DPO与课程学习，提升生成解释的准确性和一致性。**

- **链接: [https://arxiv.org/pdf/2507.05179](https://arxiv.org/pdf/2507.05179)**

> **作者:** Pulkit Bansal; Raghvendra Kumar; Shakti Singh; Adam Jatowt; Sriparna Saha
>
...
>
---
#### [replaced 178] Revisiting Entropy in Reinforcement Learning for Large Reasoning Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于强化学习任务，旨在解决LLM在RLVR训练中熵崩溃问题。通过分析熵动态，提出Positive-Advantage Reweighting方法有效调控熵，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2511.05993](https://arxiv.org/pdf/2511.05993)**
...
>
---
#### [replaced 179] Bielik Guard: Efficient Polish Language Safety Classifiers for LLM Content Moderation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于内容安全分类任务，旨在解决波兰语LLM内容审核问题。提出Bielik Guard模型，通过微调实现高效准确的五类安全内容分类。**

- **链接: [https://arxiv.org/pdf/2602.07954](https://arxiv.org/pdf/2602.07954)**
...
>
---
#### [replaced 180] Lizard: An Efficient Linearization Framework for Large Language Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出Lizard框架，解决Transformer模型在长序列下的计算和内存瓶颈问题，通过子二次注意力机制提升效率，实现高性能的线性化架构。**

- **链接: [https://arxiv.org/pdf/2507.09025](https://arxiv.org/pdf/2507.09025)**

> **作者:** Chien Van Nguyen; Huy Nguyen; Ruiyi Zhang; Hanieh Deilamsalehy; Puneet Mathur; Viet Dac Lai; Haoliang Wang; Jayakumar Subramanian; Ryan A. Rossi; Trung Bui; Nikos Vlassis; Franck Dernoncourt; Thien Huu Nguyen
>
> **备注:** ACL 2026 (Main)
>
...
>
---
#### [replaced 181] How Training Data Shapes the Use of Parametric and In-Context Knowledge in Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究语言模型如何利用参数化知识和上下文知识，探讨训练数据对知识使用的影响，旨在优化模型的知识整合能力。**

- **链接: [https://arxiv.org/pdf/2510.02370](https://arxiv.org/pdf/2510.02370)**

> **作者:** Minsung Kim; Dong-Kyum Kim; Jea Kwon; Nakyeong Yang; Kyomin Jung; Meeyoung Cha
>
> **备注:** 16 pages
>
> **摘要:** Large language models leverage both parametric knowledge acquired during pretraining and in-context knowledge provided at inference time. Crucially, when these sources conflict, models arbitrate based on their internal confidence, preferring parametric knowledge for high-confidence facts while deferring to context for less familiar ones. However, the training conditions that give rise to these fundamental behaviors remain unclear. Here we conduct controlled experiments using synthetic corpora to identify the specific data properties that shape knowledge utilization. Our results reveal a counterintuitive finding: the robust, balanced use of both knowledge sources is an emergent property that requires the co-occurrence of three factors typically considered detrimental, including (i) intra-document repetition, (ii) a moderate degree of intra-document inconsistency, and (iii) a skewed knowledge distribution. We further show that these dynamics arise in real-world language model pretraining and analyze how post-training procedures reshape arbitration strategies. Together, our findings provide empirical guidance for designing training data that supports the reliable integration of parametric and in-context knowledge in language models.
>
---
#### [replaced 182] Budget-Aware Anytime Reasoning with LLM-Synthesized Preference Data
- **分类: cs.CL**

- **简介: 该论文研究在计算预算有限情况下大语言模型的推理行为，旨在提升推理效率与质量。提出 anytime 理论框架和评估指标，通过合成偏好数据优化模型推理过程。**

- **链接: [https://arxiv.org/pdf/2601.11038](https://arxiv.org/pdf/2601.11038)**

> **作者:** Xuanming Zhang; Shwan Ashrafi; Aziza Mirsaidova; Amir H. Rezaeian; Miguel Ballesteros; Lydia B. Chilton; Zhou Yu; Dan Roth
>
> **备注:** ACL 2026 Findings, 13 pages, 3 figures, 1 table
>
> **摘要:** We study the reasoning behavior of large language models (LLMs) under limited computation budgets. In such settings, producing useful partial solutions quickly is often more practical than exhaustive reasoning, which incurs high inference costs. Many real-world tasks, such as trip planning, require models to deliver the best possible output within a fixed reasoning budget. We introduce an anytime reasoning framework and the Anytime Index, a metric that quantifies how effectively solution quality improves as reasoning tokens increase. To further enhance efficiency, we propose an inference-time self-improvement method using LLM-synthesized preference data, where models learn from their own reasoning comparisons to produce better intermediate solutions. Experiments on NaturalPlan (Trip), AIME, and GPQA datasets show consistent gains across Grok-3, GPT-oss, GPT-4.1/4o, and LLaMA models, improving both reasoning quality and efficiency under budget constraints.
>
---
#### [replaced 183] Writing-RL: Advancing Long-form Writing via Adaptive Curriculum Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于长文本生成任务，旨在解决传统训练方法在长文本写作中的局限性。提出Writing-RL框架，通过自适应课程强化学习提升写作能力。**

- **链接: [https://arxiv.org/pdf/2506.05760](https://arxiv.org/pdf/2506.05760)**

> **作者:** Xuanyu Lei; Chenliang Li; Yuning Wu; Kaiming Liu; Weizhou Shen; Peng Li; Ming Yan; Fei Huang; Ya-Qin Zhang; Yang Liu
>
...
>
---
#### [replaced 186] LTRR: Learning To Rank Retrievers for LLMs
- **分类: cs.CL; cs.IR**

- **简介: 该论文属于信息检索任务，解决RAG系统中单一检索器性能不足的问题，通过学习排序方法动态选择最优检索器，提升问答效果。**

- **链接: [https://arxiv.org/pdf/2506.13743](https://arxiv.org/pdf/2506.13743)**

> **作者:** To Eun Kim; Fernando Diaz
>
> **备注:** SIGIR 2026; SIGIR 2025 LiveRAG Spotlight; Code: this https URL
>
...
>
---
#### [replaced 187] The MediaSpin Dataset: Post-Publication News Headline Edits Annotated for Media Bias
- **分类: cs.CL**

- **简介: 该论文提出MediaSpin数据集，用于研究新闻标题编辑中的媒体偏见。任务是检测和分析媒体偏见，通过标注标题修改来揭示语言框架与偏见关系。**
...
>
---
#### [replaced 188] VLM-3R: Vision-Language Models Augmented with Instruction-Aligned 3D Reconstruction
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出VLM-3R，解决2D模型在3D场景理解上的不足，通过单目视频和3D重建指令微调，提升空间与时间推理能力。**
...
>
---
#### [replaced 191] Multimodal Sentiment Analysis with Missing Modality: A Knowledge-Transfer Approach
...
>
---
#### [replaced 192] Personalizing Student-Agent Interactions Using Log-Contextualized Retrieval-Augmented Generation (RAG)
- **分类: cs.CL**

- **简介: 该论文属于教育技术任务，旨在解决学生与智能代理对话中的个性化问题。通过LC-RAG方法提升对话相关性与可信度，增强学生批判性思维。**

- **链接: [https://arxiv.org/pdf/2505.17238](https://arxiv.org/pdf/2505.17238)**
...
>
> **备注:** Peer reviewed; appeared in the International Conference on Artificial Intelligence in Education (AIED25) Workshop on Epistemics and Decision-Making in AI-Supported Education
>
...
>
---
#### [replaced 201] Closing the Modality Reasoning Gap for Speech Large Language Models
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [replaced 205] Rethinking Jailbreak Detection of Large Vision Language Models with Representational Contrastive Scoring
- **分类: cs.CR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于安全检测任务，旨在解决LVLM对多模态越狱攻击的检测问题。通过分析模型内部表示，提出RCS框架提升检测效果。**

- **链接: [https://arxiv.org/pdf/2512.12069](https://arxiv.org/pdf/2512.12069)**

> **作者:** Peichun Hua; Hao Li; Shanghao Shi; Zhiyuan Yu; Ning Zhang
>
> **备注:** To appear at ACL 2026 main
>
...
>
---
#### [replaced 206] SFTMix: Elevating Language Model Instruction Tuning with Mixup Recipe
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于语言模型指令微调任务，旨在提升模型遵循指令的能力。提出SFTMix方法，通过Mixup技术增强训练效果，无需高质量数据集。**

- **链接: [https://arxiv.org/pdf/2410.05248](https://arxiv.org/pdf/2410.05248)**
...
>
---
#### [replaced 214] Explanation Bias is a Product: Revealing the Hidden Lexical and Position Preferences in Post-Hoc Feature Attribution
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究解释偏差问题，属于模型解释任务。旨在揭示特征归因方法中的词汇和位置偏好，通过评估指标分析不同模型的偏差表现。**

- **链接: [https://arxiv.org/pdf/2512.11108](https://arxiv.org/pdf/2512.11108)**
...
>
---
#### [replaced 215] On the Rejection Criterion for Proxy-based Test-time Alignment
- **分类: cs.CL**

- **简介: 该论文属于测试时对齐任务，旨在解决大模型生成不一致的问题。通过改进拒绝准则，提升对齐效果。**
...
>
---
#### [replaced 220] LEAF: Knowledge Distillation of Text Embedding Models with Teacher-Aligned Representations
- **分类: cs.IR; cs.CL; cs.LG**

- **简介: 该论文提出LEAF框架，用于文本嵌入模型的知识蒸馏。任务是提升文本表示的效率与性能，解决模型大小与效果之间的平衡问题。通过教师模型对齐，使学生模型具备更强的检索能力和鲁棒性。**

- **链接: [https://arxiv.org/pdf/2509.12539](https://arxiv.org/pdf/2509.12539)**
...
>
---
#### [replaced 221] WeatherArchive-Bench: Benchmarking Retrieval-Augmented Reasoning for Historical Weather Archives
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出WeatherArchive-Bench，用于评估历史天气档案的检索增强生成系统。任务包括文档检索和脆弱性评估，解决历史文本处理与社会响应分析难题。**

- **链接: [https://arxiv.org/pdf/2510.05336](https://arxiv.org/pdf/2510.05336)**

> **作者:** Yongan Yu; Xianda Du; Qingchen Hu; Jiahao Liang; Jingwei Ni; Dan Qiang; Kaiyu Huang; Grant McKenzie; Renee Sieber; Fengran Mo
>
> **备注:** accepted to the Resource Track of SIGIR 2026
>
...
>
---
#### [replaced 222] Annotating Dimensions of Social Perception in Text: A Sentence-Level Dataset of Warmth and Competence
- **分类: cs.CL**

- **简介: 该论文属于社会感知维度标注任务，旨在解决NLP中缺乏句子级温暖与能力标注数据的问题。作者构建了首个相关数据集，并评估了大语言模型的识别能力。**
...
>
---
#### [replaced 223] PrefixMemory-Tuning: Modernizing Prefix-Tuning by Decoupling the Prefix from Attention
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于参数高效微调任务，旨在解决Prefix-Tuning在现代大模型中效果有限的问题。通过将前缀模块移出注意力头，提升表达能力，提出PrefixMemory-Tuning方法。**

- **链接: [https://arxiv.org/pdf/2506.13674](https://arxiv.org/pdf/2506.13674)**
...
>
---
#### [replaced 224] From Implicit to Explicit: Token-Efficient Logical Supervision for Mathematical Reasoning in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于数学推理任务，旨在解决大语言模型逻辑推理能力不足的问题。通过提出FSLR框架，提升模型对逻辑关系的理解，实现更高效、准确的推理。**

- **链接: [https://arxiv.org/pdf/2601.03682](https://arxiv.org/pdf/2601.03682)**
...
>
---
#### [replaced 225] REFLEX: Self-Refining Explainable Fact-Checking via Verdict-Anchored Style Control
- **分类: cs.CL**
...
> **作者:** Chuyi Kong; Gao Wei; Jing Ma; Hongzhan Lin; Yuxi Sun
>
> **备注:** 29 pages
>
...
>
---
#### [replaced 226] Who Gets Which Message? Auditing Demographic Bias in LLM-Generated Targeted Text
- **分类: cs.CL; cs.AI; cs.CY; cs.LG**

- **简介: 该论文研究LLM在生成定向文本时是否存在人口统计偏差，属于公平性审计任务。通过实验分析不同模型在年龄和性别上的内容差异，揭示潜在的刻板印象，旨在提升生成系统的透明度与公平性。**

- **链接: [https://arxiv.org/pdf/2601.17172](https://arxiv.org/pdf/2601.17172)**

> **作者:** Tunazzina Islam
>
> **备注:** Accepted at Findings of the 64th Annual Meeting of the Association for Computational Linguistics (ACL 2026). Camera-ready
>
...
>
---
#### [replaced 227] Stop Tracking Me! Proactive Defense Against Attribute Inference Attack in LLMs
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于隐私保护任务，旨在防御LLMs中的属性推断攻击。通过结合细粒度匿名化和优化策略，有效降低属性推断准确率，提升隐私安全性。**

- **链接: [https://arxiv.org/pdf/2602.11528](https://arxiv.org/pdf/2602.11528)**
...
>
---
#### [replaced 228] DynaWeb: Model-Based Reinforcement Learning of Web Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出DynaWeb，解决web agent训练效率低的问题，通过模型预测网页表示进行模拟交互，提升强化学习效果。**

- **链接: [https://arxiv.org/pdf/2601.22149](https://arxiv.org/pdf/2601.22149)**

> **作者:** Hang Ding; Peidong Liu; Junqiao Wang; Ziwei Ji; Meng Cao; Rongzhao Zhang; Lynn Ai; Eric Yang; Tianyu Shi; Lei Yu
>
> **摘要:** The development of autonomous web agents, powered by Large Language Models (LLMs) and reinforcement learning (RL), represents a significant step towards general-purpose AI assistants. However, training these agents is severely hampered by the challenges of interacting with the live internet, which is inefficient, costly, and fraught with risks. Model-based reinforcement learning (MBRL) offers a promising solution by learning a world model of the environment to enable simulated interaction. This paper introduces DynaWeb, a novel MBRL framework that trains web agents through interacting with a web world model trained to predict naturalistic web page representations given agent actions. This model serves as a synthetic web environment where an agent policy can dream by generating vast quantities of rollout action trajectories for efficient online reinforcement learning. Beyond free policy rollouts, DynaWeb incorporates real expert trajectories from training data, which are randomly interleaved with on-policy rollouts during training to improve stability and sample efficiency. Experiments conducted on the challenging WebArena and WebVoyager benchmarks demonstrate that DynaWeb consistently and significantly improves the performance of state-of-the-art open-source web agent models. Our findings establish the viability of training web agents through imagination, offering a scalable and efficient way to scale up online agentic RL.
>
---
#### [replaced 229] What Makes AI Research Replicable? Executable Knowledge Graphs as Scientific Knowledge Representations
- **分类: cs.CL; cs.AI; cs.LG; cs.MA; cs.SE**

- **简介: 该论文属于AI研究可复现任务，旨在解决代码生成不足和知识表示缺失的问题。提出可执行知识图谱（xKG），整合文献中的代码与技术细节，提升AI研究自动化复现效果。**

- **链接: [https://arxiv.org/pdf/2510.17795](https://arxiv.org/pdf/2510.17795)**
...
>
---
#### [replaced 230] LiveFact: A Dynamic, Time-Aware Benchmark for LLM-Driven Fake News Detection
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于虚假新闻检测任务，针对静态基准无法应对时间变化和数据污染的问题，提出动态基准LiveFact，评估模型在动态信息下的推理能力。**
...
>
> **备注:** ACL 2026 Main; Homepage at this https URL
>
...
>
---
#### [replaced 231] SpidR-Adapt: A Universal Speech Representation Model for Few-Shot Adaptation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语音表示学习任务，旨在解决低资源语言适应问题。通过元学习和优化框架，提升模型在少量数据下的表现。**

- **链接: [https://arxiv.org/pdf/2512.21204](https://arxiv.org/pdf/2512.21204)**
...
>
---
#### [replaced 234] Learning to Retrieve User History and Generate User Profiles for Personalized Persuasiveness Prediction
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于个性化说服力预测任务，旨在通过用户历史信息生成用户画像以提升预测效果。针对现有方法缺乏系统框架的问题，提出一种上下文感知的用户画像框架，包含查询生成器和摘要模块，有效提升预测性能。**

- **链接: [https://arxiv.org/pdf/2601.05654](https://arxiv.org/pdf/2601.05654)**

> **作者:** Sejun Park; Yoonah Park; Jongwon Lim; Yohan Jo
>
> **备注:** This paper has been accepted for publication at Findings of ACL 2026
>
...
>
---
#### [replaced 237] Scaling External Knowledge Input Beyond Context Windows of LLMs via Multi-Agent Collaboration
- **分类: cs.CL**

- **简介: 该论文属于知识增强任务，旨在解决LLMs上下文窗口限制导致的外部知识输入不足问题。通过多智能体协作框架\ExtAgents，实现高效、可扩展的知识集成。**

- **链接: [https://arxiv.org/pdf/2505.21471](https://arxiv.org/pdf/2505.21471)**

> **作者:** Zijun Liu; Zhennan Wan; Peng Li; Ming Yan; Fei Huang; Yang Liu
>
> **备注:** Accepted to ACL 2026. 31 pages, 10 figures. Code and data are available at this https URL
>
...
>
---
#### [replaced 238] ADAPT: Benchmarking Commonsense Planning under Unspecified Affordance Constraints
...
>
---
#### [replaced 244] SpeechMedAssist: Efficiently and Effectively Adapting Speech Language Models for Medical Consultation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗对话任务，解决医学咨询中语音数据不足和模型效率低的问题。提出SpeechMedAssist，通过两阶段训练减少对语音数据的依赖，提升模型效果与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.04638](https://arxiv.org/pdf/2601.04638)**
...
>
---
#### [replaced 247] When Helpers Become Hazards: A Benchmark for Analyzing Multimodal LLM-Powered Safety in Daily Life
- **分类: cs.CL**

- **简介: 该论文属于多模态安全评估任务，旨在分析MLLM在日常生活中生成内容的安全性。提出SaLAD基准和评估框架，解决模型识别危险行为能力不足的问题。**

- **链接: [https://arxiv.org/pdf/2601.04043](https://arxiv.org/pdf/2601.04043)**
...
>
---
#### [replaced 248] AutoRubric: Rubric-Based Generative Rewards for Faithful Multimodal Reasoning
- **分类: cs.CL**

- **简介: 该论文属于多模态推理任务，旨在解决MLLM在复杂推理中因仅奖励最终答案而产生的虚假推理问题。工作是提出AutoRubric框架，通过自动生成的评分标准奖励提升推理的准确性与真实性。**

- **链接: [https://arxiv.org/pdf/2510.14738](https://arxiv.org/pdf/2510.14738)**
...
>
---
#### [replaced 253] Macaron: Controlled, Human-Written Benchmark for Multilingual and Multicultural Reasoning via Template-Filling
- **分类: cs.CL**

- **简介: 该论文提出Macaron基准，用于多语言多文化推理任务。解决现有数据集在文化背景推理上的不足，通过模板生成控制推理类型和文化因素的问题，覆盖多种语言和文化。**

- **链接: [https://arxiv.org/pdf/2602.10732](https://arxiv.org/pdf/2602.10732)**
...
>
---
#### [replaced 254] Enabling Stroke-Level Structural Analysis of Hieroglyphic Scripts without Language-Specific Priors
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决 hieroglyphs 结构分析问题。提出 HieroSA 框架，无需语言先验知识，自动提取字符笔画结构，提升对象形文字的理解能力。**

- **链接: [https://arxiv.org/pdf/2601.05508](https://arxiv.org/pdf/2601.05508)**
...
>
---
#### [replaced 258] Do LLMs Encode Functional Importance of Reasoning Tokens?
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型中推理令牌功能重要性编码的问题。通过贪心剪枝方法，识别并删除对模型似然影响最小的推理令牌，以生成更高效的推理链。**

- **链接: [https://arxiv.org/pdf/2601.03066](https://arxiv.org/pdf/2601.03066)**

> **作者:** Janvijay Singh; Dilek Hakkani-Tür
>
> **备注:** Updated after ACL Main 2026 acceptance; 25 pages, 8 figures, 4 tables;
>
...
>
---
#### [replaced 259] MoRI: Learning Motivation-Grounded Reasoning for Scientific Ideation in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于科学创意生成任务，旨在解决现有模型缺乏科学推理的问题。提出MoRI框架，通过监督微调和强化学习，使模型从研究动机到方法论进行合理推理，提升创意的技术深度和科学性。**

- **链接: [https://arxiv.org/pdf/2603.19044](https://arxiv.org/pdf/2603.19044)**
...
>
---
#### [replaced 260] SpiralThinker: Latent Reasoning through an Iterative Process with Text-Latent Interleaving
- **分类: cs.CL**

- **简介: 该论文提出SpiralThinker，解决 latent reasoning 的稳定性与文本推理融合问题，通过迭代更新和对齐机制提升推理性能。**

- **链接: [https://arxiv.org/pdf/2511.08983](https://arxiv.org/pdf/2511.08983)**
...
>
---
#### [replaced 261] Mechanistic Decoding of Cognitive Constructs in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于AI可解释性研究，旨在解析LLMs中复杂情绪的内部机制。通过构建框架，分析社会比较嫉妒的心理结构，揭示其因果关系并实现情绪干预。**
...
>
---
#### [replaced 262] DiffCoT: Diffusion-styled Chain-of-Thought Reasoning in LLMs
- **分类: cs.CL**

- **简介: 该论文属于多步推理任务，解决CoT推理中的错误累积问题。提出DiffCoT框架，通过扩散机制实现推理步骤的生成与修正。**

- **链接: [https://arxiv.org/pdf/2601.03559](https://arxiv.org/pdf/2601.03559)**
...
>
---
#### [replaced 271] LVLMs and Humans Ground Differently in Referential Communication
- **分类: cs.CL; cs.AI; cs.HC**

- **简介: 该论文研究人与LVLMs在指称沟通中的共同基础差异，旨在解决AI与人类有效协作的问题。通过实验分析不同配对的沟通表现。**

- **链接: [https://arxiv.org/pdf/2601.19792](https://arxiv.org/pdf/2601.19792)**
...
>
---
#### [replaced 272] Finding Culture-Sensitive Neurons in Vision-Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究视觉语言模型中文化敏感神经元的识别与作用，旨在提升模型对文化相关输入的理解能力。通过实验验证了文化敏感神经元的存在及其重要性，并提出一种新的选择方法。**

- **链接: [https://arxiv.org/pdf/2510.24942](https://arxiv.org/pdf/2510.24942)**
...
>
---
#### [replaced 273] Lil: Less is Less When Applying Post-Training Sparse-Attention Algorithms in Long-Decode Stage
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于自然语言处理任务，针对长解码阶段的推理效率问题，提出稀疏注意力算法导致信息丢失进而增加复杂度的现象，并通过早停策略优化性能。**

- **链接: [https://arxiv.org/pdf/2601.03043](https://arxiv.org/pdf/2601.03043)**
...
>
---
#### [replaced 274] Position: Multimodal Large Language Models Can Significantly Advance Scientific Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 论文探讨多模态大语言模型在科学推理中的应用，旨在解决跨领域泛化和多模态感知不足的问题。提出研究路线图，分析挑战并给出建议。任务属于科学推理与AI结合的研究。**

- **链接: [https://arxiv.org/pdf/2502.02871](https://arxiv.org/pdf/2502.02871)**

> **作者:** Yibo Yan; Shen Wang; Jiahao Huo; Jingheng Ye; Zhendong Chu; Xuming Hu; Philip S. Yu; Carla Gomes; Bart Selman; Qingsong Wen
>
> **备注:** Accepted by The 64th Annual Meeting of the Association for Computational Linguistics (ACL 2026, Findings)
>
> **摘要:** Scientific reasoning, the process through which humans apply logic, evidence, and critical thinking to explore and interpret scientific phenomena, is essential in advancing knowledge reasoning across diverse fields. However, despite significant progress, current scientific reasoning models still struggle with generalization across domains and often fall short of multimodal perception. Multimodal Large Language Models (MLLMs), which integrate text, images, and other modalities, present an exciting opportunity to overcome these limitations and enhance scientific reasoning. Therefore, this position paper argues that MLLMs can significantly advance scientific reasoning across disciplines such as mathematics, physics, chemistry, and biology. First, we propose a four-stage research roadmap of scientific reasoning capabilities, and highlight the current state of MLLM applications in scientific reasoning, noting their ability to integrate and reason over diverse data types. Second, we summarize the key challenges that remain obstacles to achieving MLLM's full potential. To address these challenges, we propose actionable insights and suggestions for the future. Overall, our work offers a novel perspective on MLLM integration with scientific reasoning, providing the LLM community with a valuable vision for achieving Artificial General Intelligence (AGI).
>
---
#### [replaced 275] LLM Hypnosis: Exploiting User Feedback for Unauthorized Knowledge Injection to All Users
- **分类: cs.CL; cs.CR; cs.LG**

- **简介: 该论文研究语言模型因用户反馈导致的漏洞，属于安全与隐私任务。解决用户反馈被滥用以注入错误知识的问题，通过实验验证攻击可行性。**

- **链接: [https://arxiv.org/pdf/2507.02850](https://arxiv.org/pdf/2507.02850)**

> **作者:** Almog Hilel; Riddhi Bhagwat; Idan Shenfeld; Jacob Andreas; Leshem Choshen
>
...
>
---
#### [replaced 276] VEFX-Bench: A Holistic Benchmark for Generic Video Editing and Visual Effects
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于视频编辑任务，旨在解决缺乏大规模标注数据和标准化评估的问题。工作包括构建VEFX-Dataset、提出VEFX-Reward模型，并发布VEFX-Bench基准。**

- **链接: [https://arxiv.org/pdf/2604.16272](https://arxiv.org/pdf/2604.16272)**

> **作者:** Xiangbo Gao; Sicong Jiang; Bangya Liu; Xinghao Chen; Minglai Yang; Siyuan Yang; Mingyang Wu; Jiongze Yu; Qi Zheng; Haozhi Wang; Jiayi Zhang; Jie Yang; Zihan Wang; Qing Yin; Zhengzhong Tu
>
...
>
---
#### [replaced 277] Bridging the Culture Gap: A Framework for LLM-Driven Socio-Cultural Localization of Math Word Problems in Low-Resource Languages
- **分类: cs.CL**

- **简介: 该论文属于多语言数学问题本地化任务，旨在解决低资源语言中因文化实体缺失导致的数学推理能力评估偏差问题。通过构建包含本土实体的数学题数据集，提升模型的跨文化适应性。**

- **链接: [https://arxiv.org/pdf/2508.14913](https://arxiv.org/pdf/2508.14913)**
...
>
---
#### [replaced 278] BengaliMoralBench: A Benchmark for Auditing Moral Reasoning in Large Language Models within Bengali Language and Culture
- **分类: cs.CL**

- **简介: 该论文属于伦理评估任务，旨在解决多语言大模型在孟加拉语文化中的道德推理问题。构建了BengaliMoralBench基准，涵盖五个道德领域，评估模型的文化适应性与道德合理性。**

- **链接: [https://arxiv.org/pdf/2511.03180](https://arxiv.org/pdf/2511.03180)**

> **作者:** Shahriyar Zaman Ridoy; Azmine Toushik Wasi; Koushik Ahamed Tonmoy; Taki Hasan Rafi; Dong-Kyu Chae
>
...
>
---
#### [replaced 279] ToxiFrench: Benchmarking and Enhancing Language Models via CoT Fine-Tuning for French Toxicity Detection
- **分类: cs.CL; cs.AI; cs.CY**

- **简介: 该论文属于法语毒性检测任务，旨在解决法语数据不足和模型效果不佳的问题。作者构建了ToxiFrench数据集，并提出CoT微调方法提升模型性能。**

- **链接: [https://arxiv.org/pdf/2508.11281](https://arxiv.org/pdf/2508.11281)**

> **作者:** Axel Delaval; Shujian Yang; Haicheng Wang; Han Qiu; Jialiang Lu
>
> **备注:** 22 pages, 5 figures, 11 tables. This paper introduces TOXIFRENCH, a benchmark of 53,622 comments for French toxicity detection. It proposes a Chain-of-Thought fine-tuning method with a dynamic weighted loss. The fine-tuned 4B model (Qwen3-4B) achieves state-of-the-art performance, outperforming larger models like GPT-4o and DeepSeek-R1
>
...
>
---
#### [replaced 280] Structure-Aware Diversity Pursuit as an AI Safety Strategy against Homogenization
- **分类: cs.AI; cs.CL; cs.CY**

- **简介: 该论文属于AI安全领域，旨在解决生成模型导致的多样性丧失问题。提出结构感知的多样性追求策略，以缓解同质化现象。**
...
>
---
#### [replaced 281] LiveCLKTBench: Towards Reliable Evaluation of Cross-Lingual Knowledge Transfer in Multilingual LLMs
- **分类: cs.CL; cs.AI**
...
>
> **摘要:** Tibetan is a low-resource language with limited parallel speech corpora spanning its three major dialects (Ü-Tsang, Amdo, and Kham), limiting progress in speech modeling. To address this issue, we propose TMD-TTS, a unified Tibetan multi-dialect text-to-speech (TTS) framework that synthesizes parallel dialectal speech from explicit dialect labels. Our method features a dialect fusion module and a Dialect-Specialized Dynamic Routing Network (DSDR-Net) to capture fine-grained acoustic and linguistic variations across dialects. Extensive objective and subjective evaluations demonstrate that TMD-TTS significantly outperforms baselines in dialectal expressiveness. We further validate the quality and utility of the synthesized speech through a challenging Speech-to-Speech Dialect Conversion (S2SDC) task.
>
---
#### [replaced 284] Reinforced Efficient Reasoning via Semantically Diverse Exploration
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于大语言模型推理任务，旨在提升推理的多样性和效率。提出ROSE方法，通过语义熵和ε探索增强多样性，优化优势估计提高效率。**

- **链接: [https://arxiv.org/pdf/2601.05053](https://arxiv.org/pdf/2601.05053)**
