...
>
---
#### [new 005] The Art That Poses Back: Assessing AI Pastiches after Contemporary Artworks
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 009] KCLarity at SemEval-2026 Task 6: Encoder and Zero-Shot Approaches to Political Evasion Detection
- **分类: cs.CL**

- **简介: 该论文参与SemEval-2026政治话语模糊与回避分类任务，研究两种建模方法，解决政治话语清晰度和回避检测问题。**
...
>
---
#### [new 010] RouteGoT: Node-Adaptive Routing for Cost-Efficient Graph of Thoughts Reasoning
- **分类: cs.CL**

- **简介: 该论文提出RouteGoT，解决图结构推理中的成本效率问题，通过节点自适应路由提升准确率并降低token消耗。**

- **链接: [https://arxiv.org/pdf/2603.05818](https://arxiv.org/pdf/2603.05818)**
...
>
---
#### [new 016] Confidence Before Answering: A Paradigm Shift for Efficient LLM Uncertainty Estimation
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决LLM不确定性估计问题。提出CoCA框架，通过先输出置信度再生成答案的方式，提升模型的校准性和不确定性判断能力。**
...
>
> **备注:** Submitted to ACL 2026 Demo Track. 10 pages, 6 figures. Code and documentation are available at: this https URL
>
...
>
---
#### [new 029] Abductive Reasoning with Syllogistic Forms in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于人工智能推理任务，旨在研究大语言模型在类比推理中的表现，通过转换三段论数据集进行验证，分析其在归纳推理中的偏差及改进方向。**

- **链接: [https://arxiv.org/pdf/2603.06428](https://arxiv.org/pdf/2603.06428)**
...
>
---
#### [new 035] Cultural Perspectives and Expectations for Generative AI: A Global Survey Approach
- **分类: cs.CL; cs.AI**

- **简介: 论文通过全球调查研究GenAI对文化的表现，探讨文化定义及代表方式。属于文化与AI交叉任务，解决如何合理呈现文化的问题，工作包括数据收集与分析、定义提炼及提出建议。**

- **链接: [https://arxiv.org/pdf/2603.05723](https://arxiv.org/pdf/2603.05723)**
...
>
---
#### [new 037] ViewFusion: Structured Spatial Thinking Chains for Multi-View Reasoning
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 038] Let's Talk, Not Type: An Oral-First Multi-Agent Architecture for Guaraní
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决AI系统对口语语言支持不足的问题。提出口头优先的多智能体架构，以尊重原住民语言实践和数据主权。**
...
>
---
#### [new 043] NERdME: a Named Entity Recognition Dataset for Indexing Research Artifacts in Code Repositories
- **分类: cs.CL**

- **简介: 该论文属于命名实体识别任务，旨在解决代码仓库中实现细节信息提取困难的问题。通过构建NERdME数据集，提升对README文件中实体的识别与链接能力。**

- **链接: [https://arxiv.org/pdf/2603.05750](https://arxiv.org/pdf/2603.05750)**
...
>
---
#### [new 045] Beyond Rows to Reasoning: Agentic Retrieval for Multimodal Spreadsheet Understanding and Editing
- **分类: cs.CL**

- **简介: 该论文提出BRTR框架，解决企业电子表格的多模态理解与编辑问题，通过迭代工具调用提升多步骤推理能力。**

- **链接: [https://arxiv.org/pdf/2603.06503](https://arxiv.org/pdf/2603.06503)**
...
>
---
#### [new 048] A Causal Graph Approach to Oppositional Narrative Analysis
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于反对性叙事分析任务，旨在解决传统方法依赖预定义本体和存在偏见的问题。工作包括构建实体交互图并引入因果估计，提升分类效果。**
...
>
---
#### [new 053] Proof-of-Guardrail in AI Agents and What (Not) to Trust from It
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 该论文属于AI安全任务，解决开发者虚假宣传安全措施的问题。提出“proof-of-guardrail”系统，通过可信执行环境生成可验证的加密证明，确保 guardrail 执行的完整性。**

- **链接: [https://arxiv.org/pdf/2603.05786](https://arxiv.org/pdf/2603.05786)**

> **作者:** Xisen Jin; Michael Duan; Qin Lin; Aaron Chan; Zhenglun Chen; Junyi Du; Xiang Ren
>
> **备注:** 8 pages
>
> **摘要:** As AI agents become widely deployed as online services, users often rely on an agent developer's claim about how safety is enforced, which introduces a threat where safety measures are falsely advertised. To address the threat, we propose proof-of-guardrail, a system that enables developers to provide cryptographic proof that a response is generated after a specific open-source guardrail. To generate proof, the developer runs the agent and guardrail inside a Trusted Execution Environment (TEE), which produces a TEE-signed attestation of guardrail code execution verifiable by any user offline. We implement proof-of-guardrail for OpenClaw agents and evaluate latency overhead and deployment cost. Proof-of-guardrail ensures integrity of guardrail execution while keeping the developer's agent private, but we also highlight a risk of deception about safety, for example, when malicious developers actively jailbreak the guardrail. Code and demo video: this https URL
>
---
#### [new 054] Autonomous Algorithm Discovery for Ptychography via Evolutionary LLM Reasoning
- **分类: cs.CE; cs.AI; cs.CL; math.NA**

- **简介: 该论文属于图像重建任务，旨在解决手动设计正则化函数的问题。通过结合大语言模型与进化算法，自动发现新型正则化方法，提升成像质量。**

- **链接: [https://arxiv.org/pdf/2603.05696](https://arxiv.org/pdf/2603.05696)**

> **作者:** Xiangyu Yin; Ming Du; Junjing Deng; Zhi Yang; Yimo Han; Yi Jiang
>
> **摘要:** Ptychography is a computational imaging technique widely used for high-resolution materials characterization, but high-quality reconstructions often require the use of regularization functions that largely remain manually designed. We introduce Ptychi-Evolve, an autonomous framework that uses large language models (LLMs) to discover and evolve novel regularization algorithms. The framework combines LLM-driven code generation with evolutionary mechanisms, including semantically-guided crossover and mutation. Experiments on three challenging datasets (X-ray integrated circuits, low-dose electron microscopy of apoferritin, and multislice imaging with crosstalk artifacts) demonstrate that discovered regularizers outperform conventional reconstructions, achieving up to +0.26 SSIM and +8.3~dB PSNR improvements. Besides, Ptychi-Evolve records algorithm lineage and evolution metadata, enabling interpretable and reproducible analysis of discovered regularizers.
>
---
#### [new 055] Imagine How To Change: Explicit Procedure Modeling for Change Captioning
...
>
---
#### [new 056] Test-Time Adaptation via Many-Shot Prompting: Benefits, Limits, and Pitfalls
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理领域，研究测试时适应方法。针对大模型在推理时的性能优化问题，通过实证分析多种提示策略的效果与局限。**
...
>
---
#### [new 057] CBR-to-SQL: Rethinking Retrieval-based Text-to-SQL using Case-based Reasoning in the Healthcare Domain
- **分类: cs.IR; cs.AI; cs.CL**

- **简介: 该论文属于自然语言到SQL的生成任务，解决医疗领域中SQL翻译难题。通过引入基于案例推理的框架CBR-to-SQL，提升准确性和鲁棒性。**
...
>
---
#### [new 058] Aligning the True Semantics: Constrained Decoupling and Distribution Sampling for Cross-Modal Alignment
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于跨模态对齐任务，旨在解决传统方法忽略非语义信息及模态差异导致的对齐偏差问题。提出CDDS算法，通过约束解耦和分布采样实现更准确的语义对齐。**

- **链接: [https://arxiv.org/pdf/2603.05566](https://arxiv.org/pdf/2603.05566)**
...
>
---
#### [new 059] The EpisTwin: A Knowledge Graph-Grounded Neuro-Symbolic Architecture for Personal AI
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出EpisTwin，解决个人AI数据碎片化问题，通过知识图谱与神经符号系统实现跨应用数据整合与推理。**

- **链接: [https://arxiv.org/pdf/2603.06290](https://arxiv.org/pdf/2603.06290)**
...
>
---
#### [new 061] Do Compact SSL Backbones Matter for Audio Deepfake Detection? A Controlled Study with RAPTOR
...
>
---
#### [new 062] COLD-Steer: Steering Large Language Models via In-Context One-step Learning Dynamics
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出COLD-Steer，用于在不重新训练的情况下高效控制大语言模型行为，解决样本效率与信号捕捉之间的矛盾。**

- **链接: [https://arxiv.org/pdf/2603.06495](https://arxiv.org/pdf/2603.06495)**
...
>
---
#### [new 065] SAHOO: Safeguarded Alignment for High-Order Optimization Objectives in Recursive Self-Improvement
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出SAHOO框架，解决递归自我改进中的对齐漂移问题。通过三个机制监控和控制漂移，提升代码生成、数学推理等任务的性能。**

- **链接: [https://arxiv.org/pdf/2603.06333](https://arxiv.org/pdf/2603.06333)**
...
>
---
#### [new 066] NOBLE: Accelerating Transformers with Nonlinear Low-Rank Branches
- **分类: cs.LG; cs.AI; cs.CL; cs.NE**

- **简介: 该论文提出NOBLE，一种加速Transformer的架构改进方法，解决训练效率问题。通过添加非线性低秩分支提升性能，减少训练步骤和时间。**

- **链接: [https://arxiv.org/pdf/2603.06492](https://arxiv.org/pdf/2603.06492)**
...
>
---
#### [new 067] RACAS: Controlling Diverse Robots With a Single Agentic System
...
>
---
#### [new 068] Contrastive-to-Self-Supervised: A Two-Stage Framework for Script Similarity Learning
...
>
---
#### [replaced 003] Co-Layout: LLM-driven Co-optimization for Interior Layout
...
>
---
#### [replaced 004] AfriMTEB and AfriE5: Benchmarking and Adapting Text Embedding Models for African Languages
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决非洲语言文本嵌入模型不足的问题。通过构建AfriMTEB基准和适配的AfriE5模型，提升非洲语言的文本表示能力。**

- **链接: [https://arxiv.org/pdf/2510.23896](https://arxiv.org/pdf/2510.23896)**
...
>
---
#### [replaced 005] Do LLMs Really Know What They Don't Know? Internal States Mainly Reflect Knowledge Recall Rather Than Truthfulness
- **分类: cs.CL**

- **简介: 该论文属于大模型可信性研究，旨在解决 hallucination 检测问题。通过分析模型内部状态，区分不同类型的幻觉，发现多数幻觉与事实回忆机制相似，难以检测。**
...
>
> **备注:** Accepted for a poster session at this http URL at MIT 2026
>
...
>
---
#### [replaced 009] Restoring Exploration after Post-Training: Latent Exploration Decoding for Large Reasoning Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于推理模型优化任务，解决后训练导致的探索能力下降问题。提出LED方法，通过中间层熵值选择探索路径，提升模型准确性。**
...
>
---
#### [replaced 013] Both Ends Count! Just How Good are LLM Agents at "Text-to-Big SQL"?
- **分类: cs.DB; cs.CL; cs.IR**

- **简介: 该论文研究"Text-to-Big SQL"任务，解决传统文本到SQL评估在大数据场景下的不足。通过引入新指标，评估LLM代理在大数据中的效率与成本。**
...
>
---
#### [replaced 014] Creating a Hybrid Rule and Neural Network Based Semantic Tagger using Silver Standard Data: the PyMUSAS framework for Multilingual Semantic Annotation
- **分类: cs.CL**

- **简介: 该论文属于语义标注任务，旨在解决USAS框架在多语言和大规模评估中的不足。通过构建银标准数据集，结合规则系统与神经网络模型提升语义标注效果。**

- **链接: [https://arxiv.org/pdf/2601.09648](https://arxiv.org/pdf/2601.09648)**
...
>
> **备注:** 12 pages, 2 figures, accepted to LREC 2026
>
...
>
---
#### [replaced 015] How Reliable is Language Model Micro-Benchmarking?
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型评估任务，探讨微基准测试的可靠性。研究解决微基准能否准确排序模型的问题，发现小样本难以可靠比较模型性能，提出元评估方法分析样本量与可靠性关系。**

- **链接: [https://arxiv.org/pdf/2510.08730](https://arxiv.org/pdf/2510.08730)**
...
>
---
#### [replaced 016] COMI: Coarse-to-fine Context Compression via Marginal Information Gain
- **分类: cs.CL**

- **简介: 该论文提出COMI，一种用于长文本压缩的框架，解决LLM在长上下文场景中的计算效率和冗余问题，通过优化语义相关性和多样性提升压缩效果。**
...
>
---
#### [replaced 019] RM-R1: Reward Modeling as Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于强化学习中的奖励建模任务，旨在提升模型对人类偏好的对齐能力。通过引入推理机制，提出ReasRMs模型，增强奖励模型的可解释性与性能。**

- **链接: [https://arxiv.org/pdf/2505.02387](https://arxiv.org/pdf/2505.02387)**
...
>
---
#### [replaced 020] Sentiment Analysis of Citations in Scientific Articles Using ChatGPT: Identifying Potential Biases and Conflicts of Interest
- **分类: cs.DL; cs.CL**

- **简介: 该论文属于情感分析任务，旨在通过ChatGPT分析科学文章中的引用情感，识别潜在偏见和利益冲突，提升科学文献评估的客观性。**

- **链接: [https://arxiv.org/pdf/2404.01800](https://arxiv.org/pdf/2404.01800)**

> **作者:** Walid Hariri
>
> **摘要:** Scientific articles play a crucial role in advancing knowledge and informing research directions. One key aspect of evaluating scientific articles is the analysis of citations, which provides insights into the impact and reception of the cited works. This article introduces the innovative use of large language models, particularly ChatGPT, for comprehensive sentiment analysis of citations within scientific articles. By leveraging advanced natural language processing (NLP) techniques, ChatGPT can discern the nuanced positivity or negativity of citations, offering insights into the reception and impact of cited works. Furthermore, ChatGPT's capabilities extend to detecting potential biases and conflicts of interest in citations, enhancing the objectivity and reliability of scientific literature evaluation. This study showcases the transformative potential of artificial intelligence (AI)-powered tools in enhancing citation analysis and promoting integrity in scholarly research.
>
---
#### [replaced 021] Towards Autonomous Mathematics Research
- **分类: cs.LG; cs.AI; cs.CL; cs.CY**

- **简介: 该论文属于AI辅助数学研究任务，旨在解决从竞赛到科研的过渡问题。工作包括开发Aletheia系统，实现自主生成、验证和修订数学证明，并完成多项研究里程碑。**

- **链接: [https://arxiv.org/pdf/2602.10177](https://arxiv.org/pdf/2602.10177)**

> **作者:** Tony Feng; Trieu H. Trinh; Garrett Bingham; Dawsen Hwang; Yuri Chervonyi; Junehyuk Jung; Joonkyung Lee; Carlo Pagano; Sang-hyun Kim; Federico Pasqualotto; Sergei Gukov; Jonathan N. Lee; Junsu Kim; Kaiying Hou; Golnaz Ghiasi; Yi Tay; YaGuang Li; Chenkai Kuang; Yuan Liu; Hanzhao Lin; Evan Zheran Liu; Nigamaa Nayakanti; Xiaomeng Yang; Heng-Tze Cheng; Demis Hassabis; Koray Kavukcuoglu; Quoc V. Le; Thang Luong
>
> **备注:** 42 pages, updated with summary of FirstProof results. Accompanied blog post this https URL
>
...
>
> **备注:** The changes over version 2 are that we cleaned up the last paragraph on color-coding at the end of section 2. Also, for section 6.1 we added a reference to followup work of the authors, and other minor edits in that section
>
...
>
---
#### [replaced 025] Just-In-Time Objectives: A General Approach for Specialized AI Interactions
- **分类: cs.HC; cs.AI; cs.CL**

- **简介: 该论文提出“即时目标”方法，解决LLM在无明确指令时生成通用结果的问题。通过观察用户行为自动推断目标，优化AI系统以生成定制化工具和响应。**

- **链接: [https://arxiv.org/pdf/2510.14591](https://arxiv.org/pdf/2510.14591)**
...
>
---
#### [replaced 028] Transforming Science with Large Language Models: A Survey on AI-assisted Scientific Discovery, Experimentation, Content Generation, and Evaluation
...
>
---
#### [replaced 029] MERLIN: Multi-Stage Curriculum Alignment for Multilingual Encoder-LLM Integration in Cross-Lingual Reasoning
- **分类: cs.CL**

- **简介: 该论文属于跨语言推理任务，旨在解决低资源语言中大模型推理能力不足的问题。提出MERLIN框架，通过多阶段课程对齐和少量权重调整，提升模型在低资源语言上的表现。**

- **链接: [https://arxiv.org/pdf/2509.08105](https://arxiv.org/pdf/2509.08105)**
...
>
---
#### [replaced 030] VLMQ: Token Saliency-Driven Post-Training Quantization for Vision-language Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 031] DETECT: Determining Ease and Textual Clarity of German Text Simplifications
- **分类: cs.CL**

- **简介: 该论文属于文本简化评估任务，解决德国语料评估指标不足的问题。提出DETECT，通过合成数据训练，全面评估简化文本的简洁性、意义保留和流畅性。**

- **链接: [https://arxiv.org/pdf/2510.22212](https://arxiv.org/pdf/2510.22212)**
...
>
---
#### [replaced 032] Fine-Tuning and Evaluating Conversational AI for Agricultural Advisory
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于农业咨询任务，旨在解决大模型推荐不准确、建议泛化的问题。通过微调和构建混合架构，提升事实准确性与对话质量。**

- **链接: [https://arxiv.org/pdf/2603.03294](https://arxiv.org/pdf/2603.03294)**

> **作者:** Sanyam Singh; Naga Ganesh; Vineet Singh; Lakshmi Pedapudi; Ritesh Kumar; SSP Jyothi; Archana Karanam; Waseem Pasha; Ekta Kumari; C. Yashoda; Mettu Vijaya Rekha Reddy; Shesha Phani Debbesa; Chandan Dash
>
...
>
---
#### [replaced 035] Simulating Meaning, Nevermore! Introducing ICR: A Semiotic-Hermeneutic Metric for Evaluating Meaning in LLM Text Summaries
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 038] Goldfish: Monolingual Language Models for 350 Languages
- **分类: cs.CL**

- **简介: 该论文提出Goldfish，针对350种低资源语言的单语语言模型，解决多语种模型在语法生成上的不足。通过训练小规模单语模型，提升语言建模效果。**
...
>
---
#### [replaced 044] Agri-Query: A Case Study on RAG vs. Long-Context LLMs for Cross-Lingual Technical Question Answering
- **分类: cs.CL**

- **简介: 该论文属于跨语言技术问答任务，旨在解决信息检索与生成中的“针在 haystack”挑战。通过比较RAG与长上下文LLMs，评估其在农业机械手册中的表现。**

- **链接: [https://arxiv.org/pdf/2508.18093](https://arxiv.org/pdf/2508.18093)**
...
>
> **备注:** 15 pages, 4 figures. Dataset and code are available at this https URL
>
...
>
---
#### [replaced 052] CMRAG: Co-modality-based visual document retrieval and question answering
- **分类: cs.CL**

- **简介: 该论文属于视觉文档问答任务，解决多模态文档中信息利用不充分的问题。提出CMRAG框架，融合文本与图像信息提升检索与生成效果。**

- **链接: [https://arxiv.org/pdf/2509.02123](https://arxiv.org/pdf/2509.02123)**

> **作者:** Wang Chen; Wenhan Yu; Guanqiang Qi; Weikang Li; Yang Li; Lei Sha; Deguo Xia; Jizhou Huang
>
> **备注:** Published at ICLR 2026 Workshop on Multimodal Intelligence
>
...
>
---
#### [replaced 053] Automated Coding of Communication Data Using ChatGPT: Consistency Across Subgroups
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决AI在通信数据编码中的一致性问题。研究验证了ChatGPT在不同群体间编码的一致性，证明其适用于大规模协作评估。**
...
>
---
#### [replaced 054] Maximizing Asynchronicity in Event-based Neural Networks
...
>
---
#### [replaced 057] Critical Confabulation: Can LLMs Hallucinate for Social Good?
- **分类: cs.CL**

- **简介: 该论文探讨LLMs在社会正义背景下的幻觉生成能力，属于自然语言处理任务。旨在解决历史记录缺失问题，通过可控幻觉重建被忽视的历史叙事。**

- **链接: [https://arxiv.org/pdf/2511.07722](https://arxiv.org/pdf/2511.07722)**

> **作者:** Peiqi Sui; Eamon Duede; Hoyt Long; Richard Jean So
>
> **备注:** ICLR2026 Camera Ready. 27 pages, 5 figures, 11 tables
>
> **摘要:** LLMs hallucinate, yet some confabulations can have social affordances if carefully bounded. We propose critical confabulation (inspired by critical fabulation from literary and social theory), the use of LLM hallucinations to "fill-in-the-gap" for omissions in archives due to social and political inequality, and reconstruct divergent yet evidence-bound narratives for history's ``hidden figures''. We simulate these gaps with an open-ended narrative cloze task: asking LLMs to generate a masked event in a character-centric timeline sourced from a novel corpus of unpublished texts. We evaluate audited (for data contamination), fully-open models (the OLMo-2 family) and unaudited open-weight and proprietary baselines under a range of prompts designed to elicit controlled and useful hallucinations. Our findings validate LLMs' foundational narrative understanding capabilities to perform critical confabulation, and show how controlled and well-specified hallucinations can support LLM applications for knowledge production without collapsing speculation into a lack of historical accuracy and fidelity.
>
---
#### [replaced 058] Mitigating Content Effects on Reasoning in Language Models through Fine-Grained Activation Steering
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理中的推理任务，旨在解决大语言模型中的内容偏见问题。通过激活调控技术，提升模型推理的准确性与公平性。**
