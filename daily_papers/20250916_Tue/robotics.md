...
- **简介: 论文提出一种远程线驱动机制，用于在恶劣环境中远程操控移动机器人。该机制基于解耦关节串联结构，通过实验验证其可行性，解决了传统线驱动系统未应用于远程移动机器人的问题。**
...
- **简介: 论文提出PaiP，一种基于多模态触觉感知的实时闭环规划框架，用于解决未知柜体内堆叠物体导致的视觉遮挡和狭窄空间运动规划问题，通过交互特征生成操作成本图优化路径规划。**
...
- **链接: [http://arxiv.org/pdf/2509.11433v1](http://arxiv.org/pdf/2509.11433v1)**
...
- **链接: [http://arxiv.org/pdf/2509.11791v1](http://arxiv.org/pdf/2509.11791v1)**
...
- **简介: 论文提出量子深度强化学习（QDRL）用于人形机器人导航任务，解决传统RL在高维复杂环境中参数需求大、学习效率低的问题。采用混合量子-经典框架，提升学习效率，实验显示量子SAC比经典SAC在更少步骤内取得更高回报。**
...
- **简介: 该论文提出RoVerFly，一种基于强化学习的四旋翼飞行器控制框架，用于解决不同负载配置下的轨迹跟踪问题。通过任务和领域随机化训练，实现跨负载设置的零样本泛化，无需控制器切换或调参。**
...
- **简介: 论文提出基于神经符号TAMP的持续学习框架，解决动态拆解场景中机器人感知鲁棒性不足问题。通过多模态感知交叉验证与双向推理流程，提升系统适应性与任务成功率。**
...
- **链接: [http://arxiv.org/pdf/2509.11865v1](http://arxiv.org/pdf/2509.11865v1)**
...
- **简介: 论文提出一种基于正交数字编码的可扩展柔性触觉传感架构，解决现有传感器在大规模覆盖、高灵敏度和实时性方面的瓶颈问题。通过分布式节点并行传输技术，实现低延迟、高通量的压力分布重建，适用于类人皮肤触觉感知的智能机器人系统。**
...
- **简介: 该论文提出一种模块化机器人框架，用于改进内窥镜操作。旨在解决手动控制导致的疲劳与操作困难问题，设计了夹持、推进机制及用户界面，并通过数学建模与实验验证其性能。属于医疗机器人设计任务。**
...
- **链接: [http://arxiv.org/pdf/2509.11740v1](http://arxiv.org/pdf/2509.11740v1)**
...
- **简介: 论文提出CORB-Planner，一种基于强化学习的轨迹规划框架，用于高速无人机飞行。解决跨平台部署难题，通过安全走廊表示和SDCQ算法实现快速、鲁棒的实时路径规划，适用于多种无人机配置。**
...
- **简介: 论文提出一种结合OpenStreetMap先验信息的自适应LiDAR扫描控制方法，用于提升机器人定位鲁棒性。通过动态调整扫描速度，提高稀疏区域观测效率，减少轨迹误差，适用于复杂环境下的高精度定位任务。**
...
- **简介: 该论文提出VHD框架，解决轨迹规划中固定时间跨度导致的长度不匹配问题。通过学习预测任务特定时间跨度，提升路径规划成功率与效率，适用于迷宫导航与机械臂控制等任务。**
...
- **链接: [http://arxiv.org/pdf/2509.11025v1](http://arxiv.org/pdf/2509.11025v1)**
...
- **简介: 该论文综述了基于LiDAR的自主无人机技术，涵盖设计、感知、规划与控制。旨在总结其发展现状，分析应用与挑战，为未来研究提供方向。**
...
- **简介: 该论文提出FR-Net，解决四足机器人在复杂地形中跌倒恢复的问题。通过质量-接触预测网络，从有限传感器输入估计质量分布和接触状态，实现安全有效的恢复策略，并在仿真与真实环境中验证其泛化能力。**
...
- **简介: 论文提出SafeDiver方案，利用AUV和USV协同实现潜水员高效通信。通过多智能体强化学习控制AUV协作移动，并结合USV中继节点，解决水下通信可靠性与速度问题。属于水下通信任务。**
...
- **简介: 该论文提出基于智能体的仿真模型，用于协调无人机群在物联网环境中的电池充电问题。通过机器学习分析仿真结果，优化大规模无人机任务效率，应用于智慧农业场景。**
...
>
---
#### [new 067] InternScenes: A Large-scale Simulatable Indoor Scene Dataset with Realistic Layouts
- **分类: cs.CV; cs.RO**
...
#### [replaced 001] GraspMolmo: Generalizable Task-Oriented Grasping via Large-Scale Synthetic Data Generation
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2505.13441v3](http://arxiv.org/pdf/2505.13441v3)**
...
>
---
#### [replaced 003] Towards Autonomous In-situ Soil Sampling and Mapping in Large-Scale Agricultural Environments
- **分类: cs.RO; cs.ET**

- **链接: [http://arxiv.org/pdf/2506.05653v2](http://arxiv.org/pdf/2506.05653v2)**
...
>
---
#### [replaced 004] SmallPlan: Leverage Small Language Models for Sequential Path Planning with Simulation-Powered, LLM-Guided Distillation
- **分类: cs.RO; cs.CL**
...
>
---
#### [replaced 007] Gait-Conditioned Reinforcement Learning with Multi-Phase Curriculum for Humanoid Locomotion
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2505.20619v3](http://arxiv.org/pdf/2505.20619v3)**
...
>
---
#### [replaced 008] Intramuscular microelectrode arrays enable highly-accurate neural decoding of hand movements
...
>
---
#### [replaced 009] Tracailer: An Efficient Trajectory Planner for Tractor-Trailer Robots in Unstructured Environments
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2502.19832v2](http://arxiv.org/pdf/2502.19832v2)**
...
>
---
#### [replaced 011] UnIRe: Unsupervised Instance Decomposition for Dynamic Urban Scene Reconstruction
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 019] Motion Blender Gaussian Splatting for Dynamic Scene Reconstruction
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 020] Real-time Photorealistic Mapping for Situational Awareness in Robot Teleoperation
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2509.06433v2](http://arxiv.org/pdf/2509.06433v2)**
...
>
---
#### [replaced 021] Semantic Exploration and Dense Mapping of Complex Environments using Ground Robots Equipped with LiDAR and Panoramic Camera
- **分类: cs.RO; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.22880v2](http://arxiv.org/pdf/2505.22880v2)**
...
>
---
#### [replaced 024] Control Barrier Functions via Minkowski Operations for Safe Navigation among Polytopic Sets
- **分类: cs.RO; math.OC**

- **链接: [http://arxiv.org/pdf/2504.00364v3](http://arxiv.org/pdf/2504.00364v3)**
...
>
---
#### [replaced 026] Search-TTA: A Multimodal Test-Time Adaptation Framework for Visual Search in the Wild
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2505.11350v2](http://arxiv.org/pdf/2505.11350v2)**
...
>
---
#### [replaced 027] Acrobotics: A Generalist Approach to Quadrupedal Robots' Parkour
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2509.02727v2](http://arxiv.org/pdf/2509.02727v2)**
...
>
---
#### [replaced 028] COSMO-Bench: A Benchmark for Collaborative SLAM Optimization
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2508.16731v2](http://arxiv.org/pdf/2508.16731v2)**
...
>
---
#### [replaced 031] Gaussian path model library for intuitive robot motion programming by demonstration
- **分类: cs.RO**

- **链接: [http://arxiv.org/pdf/2509.10007v2](http://arxiv.org/pdf/2509.10007v2)**
...
>
---
#### [replaced 032] Learning Precise Affordances from Egocentric Videos for Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 033] Eye, Robot: Learning to Look to Act with a BC-RL Perception-Action Loop
- **分类: cs.RO; cs.CV**
