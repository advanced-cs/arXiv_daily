...
>
---
#### [new 004] Explainable Computer Vision Framework for Automated Pore Detection and Criticality Assessment in Additive Manufacturing
- **分类: cs.CV; cs.AI; cs.CE; cs.LG**

- **简介: 该论文属于缺陷检测任务，旨在解决增材制造中孔隙缺陷的自动识别与评估问题。通过构建可解释的视觉框架，提取孔隙特征并分析其关键性。**

- **链接: [https://arxiv.org/pdf/2602.03883v1](https://arxiv.org/pdf/2602.03883v1)**
...
>
---
#### [new 005] Vision-aligned Latent Reasoning for Multi-modal Large Language Model
- **分类: cs.CV**

- **简介: 该论文属于多模态大语言模型任务，解决长步骤推理中视觉信息衰减问题。提出VaLR框架，通过生成对齐的潜在标记提升推理能力。**

- **链接: [https://arxiv.org/pdf/2602.04476v1](https://arxiv.org/pdf/2602.04476v1)**
...
>
---
#### [new 008] Natural Language Instructions for Scene-Responsive Human-in-the-Loop Motion Planning in Autonomous Driving using Vision-Language-Action Models
...
>
---
#### [new 015] When LLaVA Meets Objects: Token Composition for Vision-Language-Models
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型任务，旨在减少模型对视觉令牌的依赖。通过引入多级视觉特征，提出Mask-LLaVA框架，在保持性能的同时降低计算需求。**

- **链接: [https://arxiv.org/pdf/2602.04864v1](https://arxiv.org/pdf/2602.04864v1)**
...
>
---
#### [new 016] DiMo: Discrete Diffusion Modeling for Motion Generation and Understanding
- **分类: cs.CV**

- **简介: 该论文提出DiMo，一种用于动作生成与理解的离散扩散框架，解决文本与动作双向交互问题。通过统一模型实现文本到动作、动作到文本及无文本动作生成，提升动作质量与控制能力。**

- **链接: [https://arxiv.org/pdf/2602.04188v1](https://arxiv.org/pdf/2602.04188v1)**
...
>
---
#### [new 021] SPOT-Occ: Sparse Prototype-guided Transformer for Camera-based 3D Occupancy Prediction
...
>
---
#### [new 022] PerpetualWonder: Long-Horizon Action-Conditioned 4D Scene Generation
- **分类: cs.CV**

- **简介: 该论文提出PerpetualWonder，解决从单图生成长期、动作条件的4D场景问题。通过闭环系统和统一表示，实现物理与视觉的一致性更新。**

- **链接: [https://arxiv.org/pdf/2602.04876v1](https://arxiv.org/pdf/2602.04876v1)**

> **作者:** Jiahao Zhan; Zizhang Li; Hong-Xing Yu; Jiajun Wu
>
> **备注:** Project website: https://johnzhan2023.github.io/PerpetualWonder/
>
...
>
---
#### [new 023] SparVAR: Exploring Sparsity in Visual AutoRegressive Modeling for Training-Free Acceleration
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于视觉自回归建模任务，旨在解决高分辨率生成中的计算效率问题。提出SparVAR框架，通过利用注意力稀疏性实现训练-free 加速，提升生成速度并保持图像质量。**

- **链接: [https://arxiv.org/pdf/2602.04361v1](https://arxiv.org/pdf/2602.04361v1)**
...
>
---
#### [new 024] LitS: A novel Neighborhood Descriptor for Point Clouds
- **分类: cs.CV**

- **简介: 该论文提出LitS，一种新型点云邻域描述子，用于准确表征点云局部几何结构，解决邻域信息提取问题。**

- **链接: [https://arxiv.org/pdf/2602.04838v1](https://arxiv.org/pdf/2602.04838v1)**
...
>
---
#### [new 025] JOintGS: Joint Optimization of Cameras, Bodies and 3D Gaussians for In-the-Wild Monocular Reconstruction
- **分类: cs.CV**

- **简介: 该论文提出JOintGS，解决单目视频中人体3D重建任务，联合优化相机参数、人体姿态和3D高斯表示，提升重建质量与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2602.04317v1](https://arxiv.org/pdf/2602.04317v1)**
...
>
---
#### [new 040] SLUM-i: Semi-supervised Learning for Urban Mapping of Informal Settlements and Data Quality Benchmarking
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于城市非正式住区的半监督分割任务，旨在解决标注稀缺和数据质量差的问题。提出新框架提升模型性能与跨域迁移能力。**

- **链接: [https://arxiv.org/pdf/2602.04525v1](https://arxiv.org/pdf/2602.04525v1)**
...
>
---
#### [new 043] DMS2F-HAD: A Dual-branch Mamba-based Spatial-Spectral Fusion Network for Hyperspectral Anomaly Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于高光谱异常检测任务，旨在解决传统方法在捕捉光谱依赖性和计算效率上的不足。提出DMS2F-HAD模型，通过双分支Mamba结构高效融合空间与光谱特征，提升检测精度与速度。**

- **链接: [https://arxiv.org/pdf/2602.04102v1](https://arxiv.org/pdf/2602.04102v1)**
...
>
---
#### [new 048] ImmuVis: Hyperconvolutional Foundation Model for Imaging Mass Cytometry
- **分类: cs.CV**

- **简介: 该论文提出ImmuVis，解决IMC图像分析中标记集可变的问题。通过自适应卷积实现高效建模，适用于不同标记组合，提升分类与虚拟染色性能。**

- **链接: [https://arxiv.org/pdf/2602.04585v1](https://arxiv.org/pdf/2602.04585v1)**
...
>
---
#### [new 060] JSynFlow: Japanese Synthesised Flowchart Visual Question Answering Dataset built with Large Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出JSynFlow，一个用于日语流程图视觉问答的合成数据集，解决流程图理解任务中的数据不足问题，利用大语言模型生成高质量QA对。**

- **链接: [https://arxiv.org/pdf/2602.04142v1](https://arxiv.org/pdf/2602.04142v1)**
...
>
---
#### [new 068] S-MUSt3R: Sliding Multi-view 3D Reconstruction
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 072] Fine-tuning Pre-trained Vision-Language Models in a Human-Annotation-Free Manner
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉-语言模型的微调任务，旨在解决无监督适应问题。提出CoFT框架，通过双模型协作和双提示策略，实现无需人工标注的数据高效微调。**

- **链接: [https://arxiv.org/pdf/2602.04337v1](https://arxiv.org/pdf/2602.04337v1)**
...
>
---
#### [new 073] Entropy-Aware Structural Alignment for Zero-Shot Handwritten Chinese Character Recognition
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于零样本手写汉字识别任务，旨在解决字符结构信息利用不足的问题。提出熵感知结构对齐网络，通过信息理论建模提升识别效果。**

- **链接: [https://arxiv.org/pdf/2602.03913v1](https://arxiv.org/pdf/2602.03913v1)**
...
>
---
#### [new 074] PEPR: Privileged Event-based Predictive Regularization for Domain Generalization
- **分类: cs.CV**

- **简介: 该论文属于域泛化任务，旨在提升模型在不同域下的鲁棒性。通过引入事件相机作为特权信息，提出PEPR方法，使RGB模型在不损失语义信息的情况下增强泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.04583v1](https://arxiv.org/pdf/2602.04583v1)**
...
>
---
#### [new 075] DiGAN: Diffusion-Guided Attention Network for Early Alzheimer's Disease Detection
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于阿尔茨海默病早期检测任务，旨在解决结构脑变化细微且时间不规则的问题。提出DiGAN模型，结合扩散模型与注意力机制，提升检测效果。**

- **链接: [https://arxiv.org/pdf/2602.03881v1](https://arxiv.org/pdf/2602.03881v1)**
...
>
---
#### [new 080] SpatiaLab: Can Vision-Language Models Perform Spatial Reasoning in the Wild?
- **分类: cs.CV; cs.CE; cs.CL; cs.LG**

- **简介: 论文提出SpatiaLab基准，评估视觉语言模型在真实场景中的空间推理能力。针对现有模型在空间关系、深度感知等任务上的不足，该工作构建了包含多种空间任务的评测集，揭示了模型与人类表现的显著差距。**

- **链接: [https://arxiv.org/pdf/2602.03916v1](https://arxiv.org/pdf/2602.03916v1)**
...
>
---
#### [new 081] DRMOT: A Dataset and Framework for RGBD Referring Multi-Object Tracking
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出DRMOT任务，解决RGB数据下多目标跟踪的3D语义理解与遮挡问题，构建DRSet数据集并设计DRTrack框架融合RGB、深度和语言信息。**

- **链接: [https://arxiv.org/pdf/2602.04692v1](https://arxiv.org/pdf/2602.04692v1)**
...
>
---
#### [new 082] AGILE: Hand-Object Interaction Reconstruction from Video via Agentic Generation
...
>
---
#### [new 083] Light Forcing: Accelerating Autoregressive Video Diffusion via Sparse Attention
- **分类: cs.CV**

- **简介: 该论文针对视频生成任务中的注意力机制效率问题，提出Light Forcing方法，通过稀疏注意力提升自回归视频生成的效率与质量。**

- **链接: [https://arxiv.org/pdf/2602.04789v1](https://arxiv.org/pdf/2602.04789v1)**
...
>
---
#### [new 084] Laminating Representation Autoencoders for Efficient Diffusion
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在解决扩散模型在高维特征上计算成本高的问题。通过引入FlatDINO压缩特征表示，减少计算量并提升效率。**

- **链接: [https://arxiv.org/pdf/2602.04873v1](https://arxiv.org/pdf/2602.04873v1)**

> **作者:** Ramón Calvo-González; François Fleuret
>
> **摘要:** Recent work has shown that diffusion models can generate high-quality images by operating directly on SSL patch features rather than pixel-space latents. However, the dense patch grids from encoders like DINOv2 contain significant redundancy, making diffusion needlessly expensive. We introduce FlatDINO, a variational autoencoder that compresses this representation into a one-dimensional sequence of just 32 continuous tokens -an 8x reduction in sequence length and 48x compression in total dimensionality. On ImageNet 256x256, a DiT-XL trained on FlatDINO latents achieves a gFID of 1.80 with classifier-free guidance while requiring 8x fewer FLOPs per forward pass and up to 4.5x fewer FLOPs per training step compared to diffusion on uncompressed DINOv2 features. These are preliminary results and this work is in progress.
>
---
#### [new 085] VideoBrain: Learning Adaptive Frame Sampling for Long Video Understanding
- **分类: cs.CV**

- **简介: 该论文提出VideoBrain，解决长视频理解中帧采样效率与信息保留的矛盾。通过自适应采样策略，提升模型性能并减少帧数。属于视觉-语言模型任务。**

- **链接: [https://arxiv.org/pdf/2602.04094v1](https://arxiv.org/pdf/2602.04094v1)**
...
>
---
#### [new 086] Toward Reliable and Explainable Nail Disease Classification: Leveraging Adversarial Training and Grad-CAM Visualization
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于图像分类任务，旨在解决 nail disease 识别问题。通过训练 CNN 模型并结合对抗训练和 SHAP 可解释性方法，提升分类准确性和可靠性。**

- **链接: [https://arxiv.org/pdf/2602.04820v1](https://arxiv.org/pdf/2602.04820v1)**
...
>
---
#### [new 087] VISTA-Bench: Do Vision-Language Models Really Understand Visualized Text as Well as Pure Text?
- **分类: cs.CV**

- **简介: 该论文属于视觉语言模型研究，旨在解决VLM在处理可视化文本与纯文本时表现差异的问题。通过构建VISTA-Bench基准，对比分析模型在两种输入下的性能差异。**

- **链接: [https://arxiv.org/pdf/2602.04802v1](https://arxiv.org/pdf/2602.04802v1)**
...
>
> **摘要:** Vision-Language Models (VLMs) have achieved impressive performance in cross-modal understanding across textual and visual inputs, yet existing benchmarks predominantly focus on pure-text queries. In real-world scenarios, language also frequently appears as visualized text embedded in images, raising the question of whether current VLMs handle such input requests comparably. We introduce VISTA-Bench, a systematic benchmark from multimodal perception, reasoning, to unimodal understanding domains. It evaluates visualized text understanding by contrasting pure-text and visualized-text questions under controlled rendering conditions. Extensive evaluation of over 20 representative VLMs reveals a pronounced modality gap: models that perform well on pure-text queries often degrade substantially when equivalent semantic content is presented as visualized text. This gap is further amplified by increased perceptual difficulty, highlighting sensitivity to rendering variations despite unchanged semantics. Overall, VISTA-Bench provides a principled evaluation framework to diagnose this limitation and to guide progress toward more unified language representations across tokenized text and pixels. The source dataset is available at https://github.com/QingAnLiu/VISTA-Bench.
>
---
#### [new 088] Understanding Degradation with Vision Language Model
- **分类: cs.CV**

- **简介: 该论文聚焦于图像退化理解任务，解决VLM在参数物理建模上的不足。提出DU-VLM模型，实现退化类型、参数的联合预测，并构建了DU-110k数据集，提升图像修复效果。**

- **链接: [https://arxiv.org/pdf/2602.04565v1](https://arxiv.org/pdf/2602.04565v1)**
...
>
---
#### [new 092] Self-evolving Embodied AI
- **分类: cs.ET; cs.CV**

- **简介: 该论文提出自进化具身AI，解决动态环境中智能体适应性不足的问题，通过自更新记忆、自适应环境等机制实现持续进化。**

- **链接: [https://arxiv.org/pdf/2602.04411v1](https://arxiv.org/pdf/2602.04411v1)**
...
>
---
#### [new 093] WebAccessVL: Making an Accessible Web via Violation-Conditioned VLM
- **分类: cs.HC; cs.AI; cs.CV**

- **简介: 该论文属于Web可访问性任务，旨在解决WCAG2违规问题。通过训练VLM自动修正HTML代码，有效减少违规数量并保持视觉一致性。**

- **链接: [https://arxiv.org/pdf/2602.03850v1](https://arxiv.org/pdf/2602.03850v1)**
...
>
---
#### [new 094] PromptSplit: Revealing Prompt-Level Disagreement in Generative Models
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出PromptSplit，用于检测生成模型在提示层面的行为差异。任务是分析不同提示下模型行为的不一致，解决如何识别导致模型分歧的提示问题。工作包括构建联合表示、计算核协方差矩阵并进行降维分析。**

- **链接: [https://arxiv.org/pdf/2602.04009v1](https://arxiv.org/pdf/2602.04009v1)**
...
>
---
#### [new 095] To What Extent Do Token-Level Representations from Pathology Foundation Models Improve Dense Prediction?
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于病理学图像分割任务，旨在评估不同病理基础模型在密集预测中的表现与适应策略。通过构建基准测试，分析模型在多种数据集上的性能与稳定性。**

- **链接: [https://arxiv.org/pdf/2602.03887v1](https://arxiv.org/pdf/2602.03887v1)**
...
>
---
#### [new 100] Beyond the Vehicle: Cooperative Localization by Fusing Point Clouds for GPS-Challenged Urban Scenarios
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 101] Towards Next-Generation SLAM: A Survey on 3DGS-SLAM Focusing on Performance, Robustness, and Future Directions
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 102] Quantile Transfer for Reliable Operating Point Selection in Visual Place Recognition
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 103] Sounding Highlights: Dual-Pathway Audio Encoders for Audio-Visual Video Highlight Detection
...
>
---
#### [new 104] Efficient Long-Horizon Vision-Language-Action Models via Static-Dynamic Disentanglement
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 105] REDistill: Robust Estimator Distillation for Balancing Robustness and Efficiency
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于知识蒸馏任务，解决教师模型预测不可靠的问题。提出REDistill框架，采用鲁棒统计方法提升学生模型的准确性和泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.04677v1](https://arxiv.org/pdf/2602.04677v1)**
...
>
---
#### [new 106] Adaptive Prompt Elicitation for Text-to-Image Generation
- **分类: cs.HC; cs.AI; cs.CV**

- **简介: 该论文属于文本到图像生成任务，旨在解决用户输入模糊、难以与模型对齐的问题。提出APE方法，通过交互式视觉查询帮助用户优化提示，提升生成效果。**

- **链接: [https://arxiv.org/pdf/2602.04713v1](https://arxiv.org/pdf/2602.04713v1)**
...
>
---
#### [new 107] Investigating Disability Representations in Text-to-Image Models
- **分类: cs.CL; cs.CV; cs.CY; cs.HC**

- **简介: 该论文属于AI伦理研究任务，旨在解决文本生成图像模型中残疾人群体表征不公问题。通过分析模型输出，评估不同提示对残疾形象的影响。**

- **链接: [https://arxiv.org/pdf/2602.04687v1](https://arxiv.org/pdf/2602.04687v1)**
...
>
---
#### [new 110] VLS: Steering Pretrained Robot Policies via Vision-Language Models
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 111] SEIS: Subspace-based Equivariance and Invariance Scores for Neural Representations
- **分类: cs.LG; cs.CV**

- **简介: 该论文提出SEIS方法，用于分析神经网络在几何变换下的特征表示，区分等变性与不变性。任务是评估特征的空间结构保持情况，解决现有方法无法深入分析内部表示的问题。**

- **链接: [https://arxiv.org/pdf/2602.04054v1](https://arxiv.org/pdf/2602.04054v1)**
...
>
---
#### [new 114] Representation Geometry as a Diagnostic for Out-of-Distribution Robustness
- **分类: cs.LG; cs.CV; math.DG; math.GN**

- **简介: 该论文属于机器学习任务，解决分布偏移下模型鲁棒性评估问题。通过分析嵌入的几何结构，提出诊断框架以预测模型的OOD性能。**

- **链接: [https://arxiv.org/pdf/2602.03951v1](https://arxiv.org/pdf/2602.03951v1)**
...
>
---
#### [new 115] Reinforced Attention Learning
- **分类: cs.CL; cs.CV; cs.LG**

- **简介: 该论文属于多模态语言模型优化任务，旨在解决后训练中感知能力提升有限的问题。提出RAL框架，通过优化注意力分布提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.04884v1](https://arxiv.org/pdf/2602.04884v1)**
...
- **链接: [https://arxiv.org/pdf/2511.16940v2](https://arxiv.org/pdf/2511.16940v2)**
...
>
---
#### [replaced 002] Robust automatic brain vessel segmentation in 3D CTA scans using dynamic 4D-CTA data
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00391v2](https://arxiv.org/pdf/2602.00391v2)**
...
>
---
#### [replaced 003] Two-chart Beltrami Optimization for Distortion-Controlled Spherical Bijection with Application to Brain Surface Registration
- **分类: cs.GR; cs.CV; cs.LG; math.AG**

- **链接: [https://arxiv.org/pdf/2602.01589v2](https://arxiv.org/pdf/2602.01589v2)**
...
>
---
#### [replaced 004] Integrating Fine-Grained Audio-Visual Evidence for Robust Multimodal Emotion Reasoning
- **分类: cs.MM; cs.CL; cs.CV**

- **简介: 该论文属于多模态情感推理任务，旨在解决MLLM在细粒度感知和跨模态融合上的不足。提出SABER-LLM框架与数据集，提升复杂情感动态的解析能力。**

- **链接: [https://arxiv.org/pdf/2601.18321v2](https://arxiv.org/pdf/2601.18321v2)**

> **作者:** Zhixian Zhao; Wenjie Tian; Lei Xie
>
...
>
---
#### [replaced 005] Thermal Imaging-based Real-time Fall Detection using Motion Flow and Attention-enhanced Convolutional Recurrent Architecture
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.16479v2](https://arxiv.org/pdf/2509.16479v2)**
...
>
---
#### [replaced 006] AI-Generated Video Detection via Perceptual Straightening
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.00583v4](https://arxiv.org/pdf/2507.00583v4)**

> **作者:** Christian Internò; Robert Geirhos; Markus Olhofer; Sunny Liu; Barbara Hammer; David Klindt
>
> **备注:** NeurIPS 2025 (https://openreview.net/forum?id=LsmUgStXby)
>
...
>
---
#### [replaced 007] Causal-Adapter: Taming Text-to-Image Diffusion for Faithful Counterfactual Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.24798v5](https://arxiv.org/pdf/2509.24798v5)**

> **作者:** Lei Tong; Zhihua Liu; Chaochao Lu; Dino Oglic; Tom Diethe; Philip Teare; Sotirios A. Tsaftaris; Chen Jin
>
> **备注:** Project Page: https://leitong02.github.io/causaladapter/
>
...
>
---
#### [replaced 008] DGS-Net: Distillation-Guided Gradient Surgery for CLIP Fine-Tuning in AI-Generated Image Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.13108v2](https://arxiv.org/pdf/2511.13108v2)**
...
>
---
#### [replaced 009] AccidentSim: Generating Vehicle Collision Videos with Physically Realistic Collision Trajectories from Real-World Accident Reports
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2503.20654v3](https://arxiv.org/pdf/2503.20654v3)**
...
>
---
#### [replaced 010] Unlocking Past Information: Temporal Embeddings in Cooperative Bird's Eye View Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2401.14325v2](https://arxiv.org/pdf/2401.14325v2)**

> **作者:** Dominik Rößle; Jeremias Gerner; Klaus Bogenberger; Daniel Cremers; Stefanie Schmidtner; Torsten Schön
>
> **备注:** Copyright 2024 IEEE. This is the accepted version of the paper. In 2024 IEEE Intelligent Vehicles Symposium (IV), pp. 2220-2225. Official paper available at https://doi.org/10.1109/IV55156.2024.10588608
>
> **摘要:** Accurate and comprehensive semantic segmentation of Bird's Eye View (BEV) is essential for ensuring safe and proactive navigation in autonomous driving. Although cooperative perception has exceeded the detection capabilities of single-agent systems, prevalent camera-based algorithms in cooperative perception neglect valuable information derived from historical observations. This limitation becomes critical during sensor failures or communication issues as cooperative perception reverts to single-agent perception, leading to degraded performance and incomplete BEV segmentation maps. This paper introduces TempCoBEV, a temporal module designed to incorporate historical cues into current observations, thereby improving the quality and reliability of BEV map segmentations. We propose an importance-guided attention architecture to effectively integrate temporal information that prioritizes relevant properties for BEV map segmentation. TempCoBEV is an independent temporal module that seamlessly integrates into state-of-the-art camera-based cooperative perception models. We demonstrate through extensive experiments on the OPV2V dataset that TempCoBEV performs better than non-temporal models in predicting current and future BEV map segmentations, particularly in scenarios involving communication failures. We show the efficacy of TempCoBEV and its capability to integrate historical cues into the current BEV map, improving predictions under optimal communication conditions by up to 2% and under communication failures by up to 19%. The code is available at https://github.com/cvims/TempCoBEV
>
---
#### [replaced 011] Adaptive Knowledge Transferring with Switching Dual-Student Framework for Semi-Supervised Medical Image Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.24366v2](https://arxiv.org/pdf/2510.24366v2)**

> **作者:** Hoang-Thien Nguyen; Thanh-Huy Nguyen; Ba-Thinh Lam; Vi Vu; Bach X. Nguyen; Jianhua Xing; Tianyang Wang; Xingjian Li; Min Xu
>
> **备注:** The paper is published at Pattern Recognition Journal
>
...
>
---
#### [replaced 012] StainNet: Scaling Self-Supervised Foundation Models on Immunohistochemistry and Special Stains for Computational Pathology
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.10326v2](https://arxiv.org/pdf/2512.10326v2)**
...
>
---
#### [replaced 013] Geometry-aware 4D Video Generation for Robot Manipulation
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [replaced 014] Finding Optimal Video Moment without Training: Gaussian Boundary Optimization for Weakly Supervised Video Grounding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.03071v2](https://arxiv.org/pdf/2602.03071v2)**
...
>
---
#### [replaced 015] Beyond Global Scanning: Adaptive Visual State Space Modeling for Salient Object Detection in Optical Remote Sensing Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.10542v5](https://arxiv.org/pdf/2508.10542v5)**

> **作者:** Mengyu Ren; Yutong Li; Hua Li; Chuhong Wang; Runmin Cong
>
...
>
---
#### [replaced 016] UniReason 1.0: A Unified Reasoning Framework for World Knowledge Aligned Image Generation and Editing
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.02437v2](https://arxiv.org/pdf/2602.02437v2)**
...
>
---
#### [replaced 017] Why Steering Works: Toward a Unified View of Language Model Parameter Dynamics
- **分类: cs.CL; cs.AI; cs.CV; cs.IR; cs.LG**

- **简介: 该论文属于语言模型控制任务，旨在统一理解不同控制方法的效果。通过分析偏好与效用的权衡，提出新的控制方法SPLIT，提升控制效果同时保持生成质量。**

- **链接: [https://arxiv.org/pdf/2602.02343v2](https://arxiv.org/pdf/2602.02343v2)**
...
>
---
#### [replaced 030] Simulating the Visual World with Artificial Intelligence: A Roadmap
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.08585v3](https://arxiv.org/pdf/2511.08585v3)**
...
>
---
#### [replaced 031] MAMBO-G: Magnitude-Aware Mitigation for Boosted Guidance
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.03442v3](https://arxiv.org/pdf/2508.03442v3)**
...
>
---
#### [replaced 032] BioTamperNet: Affinity-Guided State-Space Model Detecting Tampered Biomedical Images
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.01435v2](https://arxiv.org/pdf/2602.01435v2)**
...
>
---
#### [replaced 033] Detecting 3D Line Segments for 6DoF Pose Estimation with Limited Data
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.12090v2](https://arxiv.org/pdf/2601.12090v2)**

> **作者:** Matej Mok; Lukáš Gajdošech; Michal Mesároš; Martin Madaras; Viktor Kocur
>
> **备注:** 8 pages, Accepted to VISAPP 2026 as Position Paper
>
...
>
---
#### [replaced 034] InfoTok: Adaptive Discrete Video Tokenizer via Information-Theoretic Compression
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.16975v2](https://arxiv.org/pdf/2512.16975v2)**
...
>
---
#### [replaced 037] RF-DETR: Neural Architecture Search for Real-Time Detection Transformers
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.09554v2](https://arxiv.org/pdf/2511.09554v2)**

> **作者:** Isaac Robinson; Peter Robicheaux; Matvei Popov; Deva Ramanan; Neehar Peri
>
> **备注:** This work has been accepted to the International Conference on Learning Representations (ICLR) 2026. Project Page: https://rfdetr.roboflow.com/
>
...
>
---
#### [replaced 038] QuantVSR: Low-Bit Post-Training Quantization for Real-World Video Super-Resolution
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.04485v2](https://arxiv.org/pdf/2508.04485v2)**

> **作者:** Bowen Chai; Zheng Chen; Libo Zhu; Wenbo Li; Yong Guo; Yulun Zhang
>
> **备注:** Accepted to AAAI 2026. Code is available at: https://github.com/bowenchai/QuantVSR
>
...
>
---
#### [replaced 039] VEAttack: Downstream-agnostic Vision Encoder Attack against Large Vision Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.17440v2](https://arxiv.org/pdf/2505.17440v2)**
...
>
---
#### [replaced 040] ZipLoRA: Any Subject in Any Style by Effectively Merging LoRAs
- **分类: cs.CV; cs.GR; cs.LG**

- **链接: [https://arxiv.org/pdf/2311.13600v2](https://arxiv.org/pdf/2311.13600v2)**

> **作者:** Viraj Shah; Nataniel Ruiz; Forrester Cole; Erika Lu; Svetlana Lazebnik; Yuanzhen Li; Varun Jampani
>
> **备注:** Project page: https://ziplora.github.io
>
> **摘要:** Methods for finetuning generative models for concept-driven personalization generally achieve strong results for subject-driven or style-driven generation. Recently, low-rank adaptations (LoRA) have been proposed as a parameter-efficient way of achieving concept-driven personalization. While recent work explores the combination of separate LoRAs to achieve joint generation of learned styles and subjects, existing techniques do not reliably address the problem; they often compromise either subject fidelity or style fidelity. We propose ZipLoRA, a method to cheaply and effectively merge independently trained style and subject LoRAs in order to achieve generation of any user-provided subject in any user-provided style. Experiments on a wide range of subject and style combinations show that ZipLoRA can generate compelling results with meaningful improvements over baselines in subject and style fidelity while preserving the ability to recontextualize. Project page: https://ziplora.github.io
>
---
#### [replaced 041] Vid-LLM: A Compact Video-based 3D Multimodal LLM with Reconstruction-Reasoning Synergy
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.24385v2](https://arxiv.org/pdf/2509.24385v2)**
...
>
---
#### [replaced 044] Color Matters: Demosaicing-Guided Color Correlation Training for Generalizable AI-Generated Image Detection
- **分类: cs.CV; cs.CR**

- **链接: [https://arxiv.org/pdf/2601.22778v2](https://arxiv.org/pdf/2601.22778v2)**
...
>
---
#### [replaced 045] EAG3R: Event-Augmented 3D Geometry Estimation for Dynamic and Extreme-Lighting Scenes
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.00771v2](https://arxiv.org/pdf/2512.00771v2)**
...
>
---
#### [replaced 048] RAD: Region-Aware Diffusion Models for Image Inpainting
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2412.09191v4](https://arxiv.org/pdf/2412.09191v4)**
...
>
---
#### [replaced 049] LoVR: A Benchmark for Long Video Retrieval in Multimodal Contexts
- **分类: cs.CV; cs.IR**

- **链接: [https://arxiv.org/pdf/2505.13928v4](https://arxiv.org/pdf/2505.13928v4)**

> **作者:** Qifeng Cai; Hao Liang; Zhaoyang Han; Hejun Dong; Meiyi Qiang; Ruichuan An; Quanqing Xu; Bin Cui; Wentao Zhang
>
...
>
---
#### [replaced 050] Past- and Future-Informed KV Cache Policy with Salience Estimation in Autoregressive Video Diffusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.21896v3](https://arxiv.org/pdf/2601.21896v3)**
...
>
---
#### [replaced 051] Investigating Redundancy in Multimodal Large Language Models with Multiple Vision Encoders
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.03262v3](https://arxiv.org/pdf/2507.03262v3)**
...
>
---
#### [replaced 052] CLEAR-Mamba:Towards Accurate, Adaptive and Trustworthy Multi-Sequence Ophthalmic Angiography Classification
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.20601v2](https://arxiv.org/pdf/2601.20601v2)**
...
>
---
#### [replaced 053] Quasi-Medial Distance Field (Q-MDF): A Robust Method for Approximating and Discretizing Neural Medial Axes
- **分类: cs.CV; cs.GR**

- **链接: [https://arxiv.org/pdf/2410.17774v2](https://arxiv.org/pdf/2410.17774v2)**

> **作者:** Jiayi Kong; Chen Zong; Jun Luo; Shiqing Xin; Fei Hou; Hanqing Jiang; Chen Qian; Ying He
>
...
>
---
#### [replaced 054] Consistent Supervised-Unsupervised Alignment for Generalized Category Discovery
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.04725v3](https://arxiv.org/pdf/2507.04725v3)**
...
>
---
#### [replaced 058] Revisiting the Evaluation of Deep Neural Networks for Pedestrian Detection
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2511.10308v2](https://arxiv.org/pdf/2511.10308v2)**
...
>
---
#### [replaced 061] Image Corruption-Inspired Membership Inference Attacks against Large Vision-Language Models
- **分类: cs.CV; cs.CR**

- **链接: [https://arxiv.org/pdf/2506.12340v3](https://arxiv.org/pdf/2506.12340v3)**
...
>
---
#### [replaced 062] DeepVideo-R1: Video Reinforcement Fine-Tuning via Difficulty-aware Regressive GRPO
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2506.07464v5](https://arxiv.org/pdf/2506.07464v5)**
...
>
---
#### [replaced 063] Multi-Cue Anomaly Detection and Localization under Data Contamination
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.22913v2](https://arxiv.org/pdf/2601.22913v2)**
...
>
---
#### [replaced 064] Beyond Global Alignment: Fine-Grained Motion-Language Retrieval via Pyramidal Shapley-Taylor Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.21904v3](https://arxiv.org/pdf/2601.21904v3)**
...
>
---
#### [replaced 065] Think3D: Thinking with Space for Spatial Reasoning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.13029v2](https://arxiv.org/pdf/2601.13029v2)**
...
>
---
#### [replaced 066] Personalized Image Generation via Human-in-the-loop Bayesian Optimization
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.02388v2](https://arxiv.org/pdf/2602.02388v2)**
...
>
---
#### [replaced 067] Invariance on Manifolds: Understanding Robust Visual Representations for Place Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00841v2](https://arxiv.org/pdf/2602.00841v2)**
...
>
---
#### [replaced 068] UNO: Unifying One-stage Video Scene Graph Generation via Object-Centric Visual Representation Learning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2509.06165v5](https://arxiv.org/pdf/2509.06165v5)**
...
>
---
#### [replaced 069] CogFlow: Bridging Perception and Reasoning through Knowledge Internalization for Visual Mathematical Problem Solving
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.01874v2](https://arxiv.org/pdf/2601.01874v2)**
...
>
---
#### [replaced 070] OCRVerse: Towards Holistic OCR in End-to-End Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.21639v2](https://arxiv.org/pdf/2601.21639v2)**
...
>
---
#### [replaced 071] Weight Space Correlation Analysis: Quantifying Feature Utilization in Deep Learning Models
- **分类: cs.CV; cs.LG; eess.IV**

- **链接: [https://arxiv.org/pdf/2512.13144v2](https://arxiv.org/pdf/2512.13144v2)**
...
>
---
#### [replaced 072] Less Precise Can Be More Reliable: A Systematic Evaluation of Quantization's Impact on CLIP Beyond Accuracy
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2509.21173v4](https://arxiv.org/pdf/2509.21173v4)**

> **作者:** Aymen Bouguerra; Daniel Montoya; Alexandra Gomez-Villa; Chokri Mraidha; Fabio Arnez
>
> **备注:** Preprint
>
...
>
---
#### [replaced 073] Event2Vec: Processing Neuromorphic Events Directly by Representations in Vector Space
- **分类: cs.CV; cs.NE**

- **链接: [https://arxiv.org/pdf/2504.15371v4](https://arxiv.org/pdf/2504.15371v4)**
...
>
---
#### [replaced 074] MixGRPO: Unlocking Flow-based GRPO Efficiency with Mixed ODE-SDE
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.21802v5](https://arxiv.org/pdf/2507.21802v5)**

> **作者:** Junzhe Li; Yutao Cui; Tao Huang; Yinping Ma; Chun Fan; Miles Yang; Zhao Zhong; Liefeng Bo
>
...
>
---
#### [replaced 075] Open-Source Multimodal Moxin Models with Moxin-VLM and Moxin-VLA
- **分类: cs.CL; cs.CV; cs.LG**

- **简介: 该论文介绍开源多模态模型Moxin，解决LLM开放性不足问题，提出Moxin-VLM、Moxin-VLA等变体，提升视觉语言等任务性能。**

- **链接: [https://arxiv.org/pdf/2512.22208v2](https://arxiv.org/pdf/2512.22208v2)**
...
>
---
#### [replaced 076] LiDAR-based 3D Change Detection at City Scale
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 077] From Consistency to Complementarity: Aligned and Disentangled Multi-modal Learning for Time Series Understanding and Reasoning
- **分类: cs.LG; cs.AI; cs.CL; cs.CV**

- **简介: 该论文属于时间序列理解与推理任务，解决多模态（数值与视觉）对齐与解耦问题，提出MADI模型提升时间序列分析效果。**

- **链接: [https://arxiv.org/pdf/2601.21436v2](https://arxiv.org/pdf/2601.21436v2)**
...
>
---
#### [replaced 078] Learning Domain Knowledge in Multimodal Large Language Models through Reinforcement Fine-Tuning
- **分类: cs.CL; cs.CV**

- **简介: 该论文属于多模态语言模型领域，旨在解决领域知识融入不足的问题。通过强化学习微调，将领域知识直接整合到优化目标中，提升模型在遥感和医学等领域的性能。**

- **链接: [https://arxiv.org/pdf/2601.16419v2](https://arxiv.org/pdf/2601.16419v2)**
