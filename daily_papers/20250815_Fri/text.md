...
- **简介: 论文提出HiFACTMix，针对Hinglish语境下的事实验证问题，构建1500条政治声明数据集并设计图神经网络模型，融合多语言上下文与证据语义对齐技术，实现多语言、代码混合场景下的事实核查。**
...
- **简介: 论文提出Semantic Bridge框架，通过AMR驱动的图合成生成可控多跳推理问题，解决领域稀疏数据下高质量问答对匮乏问题，实现复杂路径构建与质量提升。**
...
- **简介: 论文提出通过提取并匹配LLM的诱导偏置优化提示词，提升分类和排序的Likert评分。**
...
- **简介: 论文研究LLM辅助的健康虚假信息劫持攻击，分析其对其他LLMs的影响及检测效果。任务为检测与分析虚假信息传播，解决LLM生成恶意内容的防范问题，通过对比攻击手法与社交媒体虚假信息，评估标准机器学习方法的检测能力。**
...
- **简介: 论文提出欧洲深度推理布线（eDIF）框架，旨在通过GPU集群与NNsight API实现大型语言模型的远程可解释性研究，解决跨区域基础设施普及难题，评估平台性能与用户参与度，识别下载延迟等瓶颈。**
...
- **简介: 论文提出ICE框架，针对扩散LLMs的双向注意力机制，设计在位提示策略，通过信心感知提前退出降低计算开销，实现准确率提升17.29%且速度加快4.12倍。**
...
- **简介: 论文研究可解释性与隐私在NLP的交叉，探讨其矛盾及共存可能性，提出实用建议。**
...
- **简介: 论文提出两阶段微调方法，通过监督学习与强化学习结合，使Qwen3 14B在韩语推理任务中实现自然思考，解决模型在韩语语境下的性能瓶颈，最终提升数学和编程等高级任务表现。**
...
- **链接: [http://arxiv.org/pdf/2508.10246v1](http://arxiv.org/pdf/2508.10246v1)**
...
- **简介: 本文提出FreLLM4Rec，通过G-LPF与TFM平衡语义与协作信息，解决LLM推荐中协作信号衰减问题，提升NDCG@10 8%。**
...
- **简介: 论文提出GG Explore框架，解决知识密集环境下问题与线索导向的矛盾，通过引导图实现结构化语义探索，提升效率与准确性，优于SOTA。**
...
- **链接: [http://arxiv.org/pdf/2508.10032v1](http://arxiv.org/pdf/2508.10032v1)**
...
>
---
#### [new 043] Latent Fusion Jailbreak: Blending Harmful and Harmless Representations to Elicit Unsafe LLM Outputs
...
- **简介: 论文利用大语言模型（LLM）预测高风险患者BPRS评分，解决临床评估效率低问题，通过零样本学习提升准确性，支持多语言及纵向数据整合。**
...
- **链接: [http://arxiv.org/pdf/2508.10000v1](http://arxiv.org/pdf/2508.10000v1)**
...
- **简介: 论文提出基于LLM与人工的混合框架MDH，用于评估和检测破解商用黑盒LLMs的有害提示，解决现有数据集不足及检测准确性问题，并提出D-Attack和DH-CoT策略。**
...
- **链接: [http://arxiv.org/pdf/2508.10007v1](http://arxiv.org/pdf/2508.10007v1)**
...
- **简介: 论文提出计算经济学框架，通过激励机制优化LLM在资源约束下的效率与可解释性，实现帕累托前沿模型。**
...
- **简介: 论文提出DOTABLER框架，针对表格为中心的文档解析任务，解决表面任务不足导致的语义关联缺失问题，通过自定义数据集和领域微调实现表与上下文的深层语义解析，提升表格-上下文关联分析性能。**
...
- **简介: 论文研究大型语言模型嵌入的语义结构，揭示其低维特性及对齐特征影响，表明语义信息与人类评分相似，通过分析反义词方向投影与3D子空间关系，提出考虑语义结构避免副作用的方法。**
...
>
---
#### [new 065] Psyche-R1: Towards Reliable Psychological LLMs through Unified Empathy, Expertise, and Reasoning
- **分类: cs.CL**
...
>
---
#### [new 069] A Survey on Diffusion Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 论文综述扩散语言模型（DLMs），分析其发展、性能及挑战，涵盖基础原理、最新模型、推理优化及多模态扩展，提出未来研究方向。**

- **链接: [http://arxiv.org/pdf/2508.10875v1](http://arxiv.org/pdf/2508.10875v1)**
...
>
---
#### [new 070] Cross-Prompt Encoder for Low-Performing Languages
- **分类: cs.CL**

- **简介: 论文提出Cross-Prompt Encoder（XPE）和双软提示机制，针对低性能语言优化模型，解决跨语言迁移不足问题，通过多源训练捕捉跨语言抽象模式，提升适应性。**

- **链接: [http://arxiv.org/pdf/2508.10352v1](http://arxiv.org/pdf/2508.10352v1)**
...
>
---
#### [new 073] Detecting and explaining postpartum depression in real-time with generative artificial intelligence
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出一种基于生成式AI的实时产后抑郁检测系统，结合NLP、ML与LLM，通过树状模型解释预测结果，实现90%以上准确率，解决黑箱问题，支持快速干预。**

- **链接: [http://arxiv.org/pdf/2508.10025v1](http://arxiv.org/pdf/2508.10025v1)**
...
>
---
#### [new 074] Reverse Physician-AI Relationship: Full-process Clinical Diagnosis Driven by a Large Language Model
- **分类: cs.AI; cs.CE; cs.CL**

- **简介: 论文提出DxDirector-7B模型，让AI自主驱动全过程临床诊断，解决传统AI仅辅助的问题，提升效率并减少医生负担。**

- **链接: [http://arxiv.org/pdf/2508.10492v1](http://arxiv.org/pdf/2508.10492v1)**
...
>
---
#### [new 075] Personalized Product Search Ranking: A Multi-Task Learning Approach with Tabular and Non-Tabular Data
- **分类: cs.IR; cs.AI; cs.CL; cs.LG**

- **简介: 本文提出多任务学习框架，融合表格与非表格数据优化个性化商品搜索排名，利用预训练TinyBERT嵌入及新型采样技术，提升模型性能。**

- **链接: [http://arxiv.org/pdf/2508.09636v1](http://arxiv.org/pdf/2508.09636v1)**
...
>
---
#### [new 076] Searching for Privacy Risks in LLM Agents via Simulation
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 论文提出一种基于模拟的搜索框架，用于识别LLM代理中的隐私风险，解决动态对话中恶意攻击与防御策略难以手动发现的问题，通过LLMs优化并行搜索，发现攻击从简单到复杂、防御从规则到状态机的演化，验证其跨场景实用性。**

- **链接: [http://arxiv.org/pdf/2508.10880v1](http://arxiv.org/pdf/2508.10880v1)**
...
>
---
#### [new 077] Stabilizing Long-term Multi-turn Reinforcement Learning with Gated Rewards
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 论文针对软件工程中长期多轮强化学习的奖励稀疏性问题，提出Gated Reward Accumulation方法，通过门控机制仅在高层奖励达标时累积即时奖励，提升任务完成率和修改率，避免奖励错位导致的政策退化。**

- **链接: [http://arxiv.org/pdf/2508.10548v1](http://arxiv.org/pdf/2508.10548v1)**
...
>
---
#### [new 078] Nested-ReFT: Efficient Reinforcement Learning for Large Language Model Fine-Tuning via Off-Policy Rollouts
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 论文提出Nested-ReFT框架，通过离策略推演减少大型语言模型微调的计算成本，实现高效强化学习，提升数学基准下的性能。**

- **链接: [http://arxiv.org/pdf/2508.10123v1](http://arxiv.org/pdf/2508.10123v1)**
...
>
---
#### [new 079] Improving OCR for Historical Texts of Multiple Languages
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 080] Diversity First, Quality Later: A Two-Stage Assumption for Language Model Alignment
- **分类: cs.AI; cs.CL**

- **简介: 论文提出语言模型对齐任务中两阶段假设，分别依赖多样性与高质量数据，通过实验验证其有效性。**

- **链接: [http://arxiv.org/pdf/2508.10530v1](http://arxiv.org/pdf/2508.10530v1)**
...
>
---
#### [new 081] Memory-Augmented Transformers: A Systematic Review from Neuroscience Principles to Technical Solutions
- **分类: cs.LG; cs.CL**

- **简介: 论文综述Memory-Augmented Transformers，结合神经科学原理（如动态记忆、选择性注意）与工程进展，解决Transformer在长期上下文、持续学习和知识整合的局限，提出统一框架并分析核心内存操作，提出分层缓冲、惊喜门控等解决方案。**

- **链接: [http://arxiv.org/pdf/2508.10824v1](http://arxiv.org/pdf/2508.10824v1)**
...
>
---
#### [new 082] Pass@k Training for Adaptively Balancing Exploration and Exploitation of Large Reasoning Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 论文提出Pass@k训练方法，通过调整奖励指标平衡大型推理模型的探索与利用，分析其优势并探索优势函数设计。**

- **链接: [http://arxiv.org/pdf/2508.10751v1](http://arxiv.org/pdf/2508.10751v1)**
...
>
---
#### [new 083] Amazon Nova AI Challenge -- Trusted AI: Advancing secure, AI-assisted software development
- **分类: cs.AI; cs.CL; I.2.7; I.2.6; E.0**

- **简介: 论文描述亚马逊发起的AI安全挑战，旨在提升AI辅助软件开发的安全性，通过对抗性竞赛与数据集，团队开发了基于推理的安全对齐、模型守则等技术，推动AI安全研究。**

- **链接: [http://arxiv.org/pdf/2508.10108v1](http://arxiv.org/pdf/2508.10108v1)**
...
>
---
#### [new 085] CorrectNav: Self-Correction Flywheel Empowers Vision-Language-Action Navigation Model
...
>
---
#### [new 086] Context Misleads LLMs: The Role of Context Filtering in Maintaining Safe Alignment of LLMs
- **分类: cs.CR; cs.AI; cs.CL**

- **简介: 论文提出Context Filtering模型，通过过滤不信任上下文识别真实意图，提升LLMs安全性的同时保持帮助性，有效降低jailbreak攻击成功率88%，并适用于所有LLMs。**

- **链接: [http://arxiv.org/pdf/2508.10031v1](http://arxiv.org/pdf/2508.10031v1)**
...
#### [replaced 001] Performance of GPT-5 Frontier Models in Ophthalmology Question Answering
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.09956v2](http://arxiv.org/pdf/2508.09956v2)**
...
>
---
#### [replaced 004] Knowledge-based Consistency Testing of Large Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2407.12830v3](http://arxiv.org/pdf/2407.12830v3)**
...
>
> **摘要:** In this work, we systematically expose and measure the inconsistency and knowledge gaps of Large Language Models (LLMs). Specifically, we propose an automated testing framework (called KonTest) which leverages a knowledge graph to construct test cases. KonTest probes and measures the inconsistencies in the LLM's knowledge of the world via a combination of semantically-equivalent queries and test oracles (metamorphic or ontological oracle). KonTest further mitigates knowledge gaps via a weighted LLM model ensemble. Using four state-of-the-art LLMs (Falcon, Gemini, GPT3.5, and Llama2), we show that KonTest generates 19.2% error inducing inputs (1917 errors from 9979 test inputs). It also reveals a 16.5% knowledge gap across all tested LLMs. A mitigation method informed by KonTest's test suite reduces LLM knowledge gap by 32.48%. Our ablation study further shows that GPT3.5 is not suitable for knowledge-based consistency testing because it is only 60%-68% effective in knowledge construction.
>
---
#### [replaced 005] Meanings are like Onions: a Layered Approach to Metaphor Processing
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.10354v2](http://arxiv.org/pdf/2507.10354v2)**
...
>
---
#### [replaced 006] Echoes of Automation: The Increasing Use of LLMs in Newsmaking
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.06445v2](http://arxiv.org/pdf/2508.06445v2)**
...
>
---
#### [replaced 007] The Illusion of Progress: Re-evaluating Hallucination Detection in LLMs
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.08285v2](http://arxiv.org/pdf/2508.08285v2)**

> **作者:** Denis Janiak; Jakub Binkowski; Albert Sawczyn; Bogdan Gabrys; Ravid Shwartz-Ziv; Tomasz Kajdanowicz
>
...
>
---
#### [replaced 008] BiasGym: Fantastic LLM Biases and How to Find (and Remove) Them
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.08855v2](http://arxiv.org/pdf/2508.08855v2)**
...
>
---
#### [replaced 009] MAPS: A Multilingual Benchmark for Global Agent Performance and Security
- **分类: cs.DB; cs.CL; cs.CR**

- **链接: [http://arxiv.org/pdf/2505.15935v2](http://arxiv.org/pdf/2505.15935v2)**
...
>
---
#### [replaced 010] Sample-efficient LLM Optimization with Reset Replay
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.06412v2](http://arxiv.org/pdf/2508.06412v2)**
...
>
---
#### [replaced 011] LED-Merging: Mitigating Safety-Utility Conflicts in Model Merging with Location-Election-Disjoint
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.16770v2](http://arxiv.org/pdf/2502.16770v2)**
...
>
---
#### [replaced 012] Measuring Diversity in Synthetic Datasets
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2502.08512v3](http://arxiv.org/pdf/2502.08512v3)**
...
>
---
#### [replaced 013] Evaluation of Cultural Competence of Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 014] A New Query Expansion Approach via Agent-Mediated Dialogic Inquiry
- **分类: cs.IR; cs.CL; cs.LG; cs.MA**

- **链接: [http://arxiv.org/pdf/2502.08557v3](http://arxiv.org/pdf/2502.08557v3)**
...
>
---
#### [replaced 016] TikZero: Zero-Shot Text-Guided Graphics Program Synthesis
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 017] LAPO: Internalizing Reasoning Efficiency via Length-Adaptive Policy Optimization
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.15758v2](http://arxiv.org/pdf/2507.15758v2)**
...
>
---
#### [replaced 018] Swedish Whispers; Leveraging a Massive Speech Corpus for Swedish Speech Recognition
...
>
---
#### [replaced 019] Re:Verse -- Can Your VLM Read a Manga?
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 020] CAPTURe: Evaluating Spatial Reasoning in Vision Language Models via Occluded Object Counting
...
>
---
#### [replaced 021] MedRep: Medical Concept Representation for General Electronic Health Record Foundation Models
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.08329v3](http://arxiv.org/pdf/2504.08329v3)**
...
>
---
#### [replaced 022] Prompt Attacks Reveal Superficial Knowledge Removal in Unlearning Methods
...
>
---
#### [replaced 023] Building Instruction-Tuning Datasets from Human-Written Instructions with Open-Weight Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2503.23714v2](http://arxiv.org/pdf/2503.23714v2)**
...
>
---
#### [replaced 025] Marco-Voice Technical Report
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [replaced 026] iFairy: the First 2-bit Complex LLM with All Parameters in $\{\pm1, \pm i\}$
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.05571v2](http://arxiv.org/pdf/2508.05571v2)**
...
>
---
#### [replaced 027] A Detailed Factor Analysis for the Political Compass Test: Navigating Ideologies of Large Language Models
...
>
---
#### [replaced 028] Improved Personalized Headline Generation via Denoising Fake Interests from Implicit Feedback
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.07178v2](http://arxiv.org/pdf/2508.07178v2)**
...
>
---
#### [replaced 029] FreeKV: Boosting KV Cache Retrieval for Efficient LLM Inference
- **分类: cs.LG; cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.13109v2](http://arxiv.org/pdf/2505.13109v2)**

> **作者:** Guangda Liu; Chengwei Li; Zhenyu Ning; Minyi Guo; Jieru Zhao
>
...
>
---
#### [replaced 030] CodeJudgeBench: Benchmarking LLM-as-a-Judge for Coding Tasks
- **分类: cs.CL; cs.AI; cs.SE**

- **链接: [http://arxiv.org/pdf/2507.10535v2](http://arxiv.org/pdf/2507.10535v2)**
...
>
---
#### [replaced 031] Columbo: Expanding Abbreviated Column Names for Tabular Data Using Large Language Models
- **分类: cs.CL; cs.DB**

- **链接: [http://arxiv.org/pdf/2508.09403v2](http://arxiv.org/pdf/2508.09403v2)**
...
>
---
#### [replaced 032] ToolACE-R: Model-aware Iterative Training and Adaptive Refinement for Tool Learning
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2504.01400v2](http://arxiv.org/pdf/2504.01400v2)**
...
>
---
#### [replaced 033] CoTAL: Human-in-the-Loop Prompt Engineering for Generalizable Formative Assessment Scoring
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.02323v3](http://arxiv.org/pdf/2504.02323v3)**
...
>
---
#### [replaced 035] This Candidate is [MASK]. Prompt-based Sentiment Extraction and Reference Letters
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2410.16325v2](http://arxiv.org/pdf/2410.16325v2)**
...
>
---
#### [replaced 036] TextQuests: How Good are LLMs at Text-Based Video Games?
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.23701v3](http://arxiv.org/pdf/2507.23701v3)**
...
>
---
#### [replaced 040] Curse of High Dimensionality Issue in Transformer for Long-context Modeling
- **分类: cs.CL; cs.LG; stat.ML**

- **链接: [http://arxiv.org/pdf/2505.22107v4](http://arxiv.org/pdf/2505.22107v4)**
