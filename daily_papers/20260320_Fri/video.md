...
>
---
#### [new 011] Counting Circuits: Mechanistic Interpretability of Visual Reasoning in Large Vision-Language Models
- **分类: cs.CV; cs.AI**

- **简介: 该论文研究视觉语言模型的计数机制，解决其视觉推理能力不足的问题。通过实验和分析，提出新方法并验证计数对整体推理的提升作用。**

- **链接: [https://arxiv.org/pdf/2603.18523](https://arxiv.org/pdf/2603.18523)**
...
>
---
#### [new 022] Cubic Discrete Diffusion: Discrete Visual Generation on High-Dimensional Representation Tokens
- **分类: cs.CV**

- **简介: 该论文提出CubiD，解决高维离散生成问题，通过细粒度掩码实现高效视觉生成，提升语义丰富性。**

- **链接: [https://arxiv.org/pdf/2603.19232](https://arxiv.org/pdf/2603.19232)**
...
>
---
#### [new 051] myMNIST: Benchmark of PETNN, KAN, and Classical Deep Learning Models for Burmese Handwritten Digit Recognition
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于缅甸手写数字识别任务，旨在评估多种模型在myMNIST数据集上的表现，解决模型性能比较问题。工作包括基准测试与结果分析。**
...
>
---
#### [new 057] TAU-R1: Visual Language Model for Traffic Anomaly Understanding
- **分类: cs.CV**

- **简介: 该论文属于交通异常理解任务，旨在解决TAU缺乏基准和方法的问题。提出TAU-R1框架及Roundabout-TAU数据集，提升异常分类与推理性能。**

- **链接: [https://arxiv.org/pdf/2603.19098](https://arxiv.org/pdf/2603.19098)**
...
>
---
#### [new 060] Motion-o: Trajectory-Grounded Video Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频理解任务，解决物体运动轨迹推理问题。提出Motion-o模型，通过显式轨迹建模和MCoT路径提升视频推理能力。**
...
>
> **摘要:** Models that bridge vision and language, such as CLIP, are key components of multimodal AI, yet their large-scale, uncurated training data introduce severe social and spurious biases. Existing post-hoc debiasing methods often operate directly in the dense CLIP embedding space, where bias and task-relevant information are highly entangled. This entanglement limits their ability to remove bias without degrading semantic fidelity. In this work, we propose Sparse Embedding Modulation (SEM), a post-hoc, zero-shot debiasing framework that operates in a Sparse Autoencoder (SAE) latent space. By decomposing CLIP text embeddings into disentangled features, SEM identifies and modulates bias-relevant neurons while preserving query-relevant ones. This enables more precise, non-linear interventions. Across four benchmark datasets and two CLIP backbones, SEM achieves substantial fairness gains in retrieval and zero-shot classification. Our results demonstrate that sparse latent representations provide an effective foundation for post-hoc debiasing of vision-language models.
>
---
#### [new 072] Click-to-Ask: An AI Live Streaming Assistant with Offline Copywriting and Online Interactive QA
- **分类: cs.CV**

- **简介: 该论文提出Click-to-Ask系统，用于直播电商。解决实时互动与内容准备效率问题，通过离线生成文案和在线问答响应提升直播效果。**

- **链接: [https://arxiv.org/pdf/2603.18649](https://arxiv.org/pdf/2603.18649)**
...
>
---
#### [new 074] Generation Models Know Space: Unleashing Implicit 3D Priors for Scene Understanding
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 075] Training-Free Sparse Attention for Fast Video Generation via Offline Layer-Wise Sparsity Profiling and Online Bidirectional Co-Clustering
- **分类: cs.CV**

- **简介: 该论文属于视频生成任务，旨在解决稀疏注意力机制在推理效率与质量间的平衡问题。提出SVOO框架，通过离线层级稀疏性分析和在线双向聚类实现高效视频生成。**
...
>
---
#### [new 076] CycleCap: Improving VLMs Captioning Performance via Self-Supervised Cycle Consistency Fine-Tuning
- **分类: cs.CV**

- **简介: 该论文属于图像描述生成任务，旨在解决VLMs生成描述不准确或幻觉的问题。通过引入CycleCap方法，利用循环一致性进行自监督微调，提升生成质量。**

- **链接: [https://arxiv.org/pdf/2603.18282](https://arxiv.org/pdf/2603.18282)**
...
>
---
#### [new 084] FUMO: Prior-Modulated Diffusion for Single Image Reflection Removal
- **分类: cs.CV**

- **简介: 该论文属于单图像反射去除任务，旨在解决真实场景中反射强度变化和结构纠缠的问题。提出FUMO模型，通过先验调制和分阶段训练提升去反射效果。**

- **链接: [https://arxiv.org/pdf/2603.19036](https://arxiv.org/pdf/2603.19036)**

> **作者:** Telang Xu; Chaoyang Zhang; Guangtao Zhai; Xiaohong Liu
>
> **摘要:** Single image reflection removal (SIRR) is challenging in real scenes, where reflection strength varies spatially and reflection patterns are tightly entangled with transmission structures. This paper presents a diffusion model with prior modulation framework (FUMO) that introduces explicit guidance signals to improve spatial controllability and structural faithfulness. Two priors are extracted directly from the mixed image, an intensity prior that estimates spatial reflection severity and a high-frequency prior that captures detail-sensitive responses via multi-scale residual aggregation. We propose a coarse-to-fine training paradigm. In the first stage, these cues are combined to gate the conditional residual injections, focusing the conditioning on regions that are both reflection-dominant and structure-sensitive. In the second stage, a fine-grained refinement network corrects local misalignment and sharpens fine details in the image space. Experiments conducted on both standard benchmarks and challenging images in the wild demonstrate competitive quantitative results and consistently improved perceptual quality. The code is released at this https URL.
>
---
#### [new 085] ARIADNE: A Perception-Reasoning Synergy Framework for Trustworthy Coronary Angiography Analysis
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出ARIADNE框架，解决冠脉血管分割中拓扑结构不连贯的问题。通过感知与推理结合，提升病变检测的准确性与可靠性。**

- **链接: [https://arxiv.org/pdf/2603.19169](https://arxiv.org/pdf/2603.19169)**
...
>
---
#### [new 089] SAMA: Factorized Semantic Anchoring and Motion Alignment for Instruction-Guided Video Editing
- **分类: cs.CV**

- **简介: 该论文提出SAMA框架，用于指令引导的视频编辑任务，解决语义修改与运动保持的平衡问题。通过语义锚定和运动对齐，提升模型的鲁棒性和泛化能力。**

- **链接: [https://arxiv.org/pdf/2603.19228](https://arxiv.org/pdf/2603.19228)**
...
>
---
#### [new 091] Fast and Generalizable NeRF Architecture Selection for Satellite Scene Reconstruction
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于卫星场景重建任务，解决NeRF训练耗时长、部署难的问题。提出PreSCAN框架，通过轻量特征预测NeRF质量，显著提升效率与部署性能。**

- **链接: [https://arxiv.org/pdf/2603.18306](https://arxiv.org/pdf/2603.18306)**
...
>
---
#### [new 106] Towards Interpretable Foundation Models for Retinal Fundus Images
- **分类: cs.CV; cs.LG; stat.CO**

- **简介: 该论文属于医学图像分析任务，旨在解决基础模型可解释性不足的问题。提出Dual-IFM模型，通过局部证据图和全局投影实现可解释性，提升医疗影像的可靠性。**
...
>
---
#### [new 120] Ontology-Guided Diffusion for Zero-Shot Visual Sim2Real Transfer
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉sim2real迁移任务，旨在解决真实数据稀缺导致的模拟到现实转换难题。通过结构化知识表示和符号规划，提升图像真实性。**

- **链接: [https://arxiv.org/pdf/2603.18719](https://arxiv.org/pdf/2603.18719)**
...
>
---
#### [new 132] NavTrust: Benchmarking Trustworthiness for Embodied Navigation
...
>
---
#### [new 133] REST: Receding Horizon Explorative Steiner Tree for Zero-Shot Object-Goal Navigation
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 134] Cross-Modal Rationale Transfer for Explainable Humanitarian Classification on Social Media
- **分类: cs.CL; cs.CV**

- **简介: 该论文属于多模态分类任务，旨在解决危机信息分类透明度低的问题。通过跨模态推理提取文本和图像的解释性依据，提升分类可解释性。**

- **链接: [https://arxiv.org/pdf/2603.18611](https://arxiv.org/pdf/2603.18611)**
...
>
---
#### [new 138] DriveVLM-RL: Neuroscience-Inspired Reinforcement Learning with Vision-Language Models for Safe and Deployable Autonomous Driving
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [new 141] Elastic Weight Consolidation Done Right for Continual Learning
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于持续学习任务，旨在解决EWC方法中权重重要性估计不准确的问题。通过分析发现EWC的缺陷，并提出Logits Reversal改进方法，提升性能。**
...
>
---
#### [new 142] UEPS: Robust and Efficient MRI Reconstruction
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于MRI重建任务，解决深度模型在域转移下的鲁棒性问题。提出UEPS架构，通过独立重建、渐进分辨率和稀疏注意力提升性能与效率。**

- **链接: [https://arxiv.org/pdf/2603.18572](https://arxiv.org/pdf/2603.18572)**
...
>
---
#### [new 144] Few-shot Acoustic Synthesis with Multimodal Flow Matching
...
>
---
#### [new 145] Epistemic Generative Adversarial Networks
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于生成模型任务，旨在解决GAN输出多样性不足的问题。通过引入Dempster-Shafer理论和改进生成器结构，提升生成样本的多样性与不确定性建模能力。**

- **链接: [https://arxiv.org/pdf/2603.18348](https://arxiv.org/pdf/2603.18348)**
...
>
> **备注:** 69 pages, 68 figures, 30 tables
>
...
>
---
#### [replaced 003] Video Anomaly Detection with Semantics-Aware Information Bottleneck
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2506.02535](https://arxiv.org/pdf/2506.02535)**
...
>
---
#### [replaced 006] A Multi-Agent Perception-Action Alliance for Efficient Long Video Reasoning
- **分类: cs.CV; cs.MA**

- **链接: [https://arxiv.org/pdf/2603.14052](https://arxiv.org/pdf/2603.14052)**
...
>
---
#### [replaced 009] Iris: Bringing Real-World Priors into Diffusion Model for Monocular Depth Estimation
- **分类: cs.CV**
...
>
---
#### [replaced 013] Embedding Physical Reasoning into Diffusion-Based Shadow Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.06174](https://arxiv.org/pdf/2512.06174)**

> **作者:** Shilin Hu; Jingyi Xu; Akshat Dave; Dimitris Samaras; Hieu Le
>
> **备注:** Project page: this https URL
>
> **摘要:** Generating realistic shadows for inserted objects requires reasoning about scene geometry and illumination. However, most existing methods operate purely in image space, leaving the physical relationship between objects, lighting, and shadows to be learned implicitly, often resulting in misaligned or implausible shadows. We instead ground shadow generation in the physics of shadow formation. Given a composite image and an object mask, we recover approximate scene geometry and estimate a dominant light direction to derive a physics-grounded shadow estimate via geometric reasoning. While coarse, this estimate provides a spatial anchor for shadow placement. Because illumination cannot always be uniquely inferred from a single image, we predict confidence scores for both lighting and shadow cues and use them to regulate their influence during generation. These cues, shadow mask, light direction, and their confidences, condition a diffusion-based generator that refines the estimate into a realistic shadow. Experiments on DESOBAV2 show that our method improves both shadow realism and localization, achieving 23% lower shadow-region RMSE and 30% lower shadow-region BER over prior state-of-the-art.
>
---
#### [replaced 014] HyperAlign: Hyperbolic Entailment Cones for Adaptive Text-to-Image Alignment Assessment
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.04614](https://arxiv.org/pdf/2601.04614)**
...
>
---
#### [replaced 015] Seeing Beyond the Image: ECG and Anatomical Knowledge-Guided Myocardial Scar Segmentation from Late Gadolinium-Enhanced Images
- **分类: cs.CV; cs.AI**
...
>
> **备注:** ISBI 2026 (oral presentation)
>
...
>
---
#### [replaced 016] Mobile-VideoGPT: Fast and Accurate Model for Mobile Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.21782](https://arxiv.org/pdf/2503.21782)**
...
>
---
#### [replaced 017] MLLM-based Textual Explanations for Face Comparison
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 020] How to Take a Memorable Picture? Empowering Users with Actionable Feedback
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.21877](https://arxiv.org/pdf/2602.21877)**
...
>
---
#### [replaced 021] PFGNet: A Fully Convolutional Frequency-Guided Peripheral Gating Network for Efficient Spatiotemporal Predictive Learning
- **分类: cs.CV**
...
>
---
#### [replaced 024] A Multicenter Benchmark of Multiple Instance Learning Models for Lymphoma Subtyping from HE-stained Whole Slide Images
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.14640](https://arxiv.org/pdf/2512.14640)**

> **作者:** Rao Muhammad Umer; Daniel Sens; Jonathan Noll; Sohom Dey; Christian Matek; Lukas Wolfseher; Rainer Spang; Ralf Huss; Johannes Raffler; Sarah Reinke; Ario Sadafi; Wolfram Klapper; Katja Steiger; Kristina Schwamborn; Carsten Marr
>
> **备注:** 19 pages
>
...
>
---
#### [replaced 025] Object-Centric Representation Learning for Enhanced 3D Semantic Scene Graph Prediction
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.04714](https://arxiv.org/pdf/2510.04714)**
...
>
---
#### [replaced 028] Is Contrastive Distillation Enough for Learning Comprehensive 3D Representations?
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2412.08973](https://arxiv.org/pdf/2412.08973)**
...
>
---
#### [replaced 029] LucidNFT: LR-Anchored Multi-Reward Preference Optimization for Generative Real-World Super-Resolution
- **分类: cs.CV**
...
>
---
#### [replaced 034] Latent Representations for Visual Proprioception in Inexpensive Robots
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 035] LucidFlux: Caption-Free Photo-Realistic Image Restoration via a Large-Scale Diffusion Transformer
- **分类: cs.CV**
...
>
---
#### [replaced 036] EPOFusion: Exposure aware Progressive Optimization Method for Infrared and Visible Image Fusion
- **分类: cs.CV**
...
>
---
#### [replaced 037] SenseShift6D: Multimodal RGB-D Benchmarking for Robust 6D Pose Estimation across Environment and Sensor Variations
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.05751](https://arxiv.org/pdf/2507.05751)**
...
>
---
#### [replaced 038] Unlocking 3D Affordance Segmentation with 2D Semantic Knowledge
- **分类: cs.CV**
...
>
---
#### [replaced 039] Open-o3-Video: Grounded Video Reasoning with Explicit Spatio-Temporal Evidence
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [https://arxiv.org/pdf/2510.20579](https://arxiv.org/pdf/2510.20579)**
...
>
---
#### [replaced 040] Mixture of Style Experts for Diverse Image Stylization
- **分类: cs.CV**
...
>
---
#### [replaced 041] Improved Convex Decomposition with Ensembling and Negative Primitives
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2405.19569](https://arxiv.org/pdf/2405.19569)**

> **作者:** Vaibhav Vavilala; Florian Kluger; Seemandhar Jain; Bodo Rosenhahn; Anand Bhattad; David Forsyth
>
> **备注:** 3DV 2026 25 pages, 15 figures, 9 tables
>
...
>
---
#### [replaced 042] GenCompositor: Generative Video Compositing with Diffusion Transformer
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.02460](https://arxiv.org/pdf/2509.02460)**
...
>
---
#### [replaced 043] HaltNav: Reactive Visual Halting over Lightweight Topological Priors for Robust Vision-Language Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 044] HopChain: Multi-Hop Data Synthesis for Generalizable Vision-Language Reasoning
- **分类: cs.CV; cs.AI; cs.CL**

- **简介: 该论文属于视觉语言推理任务，旨在解决VLM在细粒度推理中的不足。提出HopChain框架，生成多跳推理数据以提升模型的泛化能力。**
...
>
> **备注:** There is an error in the methods section
>
...
>
---
#### [replaced 046] 1S-DAug: One-Shot Data Augmentation for Robust Few-Shot Generalization
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 047] AsgardBench -- Evaluating Visually Grounded Interactive Planning Under Minimal Feedback
...
>
---
#### [replaced 050] Synergizing Deep Learning and Biological Heuristics for Extreme Long-Tail White Blood Cell Classification
- **分类: cs.CV**
...
>
---
#### [replaced 053] TiROD: Tiny Robotics Dataset and Benchmark for Continual Object Detection
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 054] Is Hierarchical Quantization Essential for Optimal Reconstruction?
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.22244](https://arxiv.org/pdf/2601.22244)**
...
>
---
#### [replaced 055] Expanding mmWave Datasets for Human Pose Estimation with Unlabeled Data and LiDAR Datasets
- **分类: cs.CV**
...
>
---
#### [replaced 060] Bridging the Simulation-to-Reality Gap in Electron Microscope Calibration via VAE-EM Estimation
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 063] TrajBooster: Boosting Humanoid Whole-Body Manipulation via Trajectory-Centric Learning
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 066] QualitEye: Public and Privacy-preserving Gaze Data Quality Verification
- **分类: cs.HC; cs.CR; cs.CV**

- **链接: [https://arxiv.org/pdf/2506.05908](https://arxiv.org/pdf/2506.05908)**
...
>
---
#### [replaced 067] CoPRS: Learning Positional Prior from Chain-of-Thought for Reasoning Segmentation
- **分类: cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2510.11173](https://arxiv.org/pdf/2510.11173)**

> **作者:** Zhenyu Lu; Liupeng Li; Jinpeng Wang; Yan Feng; Bin Chen; Ke Chen; Yaowei Wang
>
> **备注:** Accepted to ICLR 2026. 20 pages, 8 figures, 4 tables
>
...
>
---
#### [replaced 068] Multi-Scale Distillation for RGB-D Anomaly Detection on the PD-REAL Dataset
- **分类: cs.CV**
...
>
---
#### [replaced 071] ELiC: Efficient LiDAR Geometry Compression via Cross-Bit-depth Feature Propagation and Bag-of-Encoders
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2511.14070](https://arxiv.org/pdf/2511.14070)**
...
>
---
#### [replaced 072] Shoe Style-Invariant and Ground-Aware Learning for Dense Foot Contact Estimation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.22184](https://arxiv.org/pdf/2511.22184)**
...
>
---
#### [replaced 073] LiteReality: Graphics-Ready 3D Scene Reconstruction from RGB-D Scans
- **分类: cs.CV; cs.AI; cs.GR**

- **链接: [https://arxiv.org/pdf/2507.02861](https://arxiv.org/pdf/2507.02861)**

> **作者:** Zhening Huang; Xiaoyang Wu; Fangcheng Zhong; Hengshuang Zhao; Matthias Nießner; Joan Lasenby
>
> **备注:** Project Page: this https URL; Video: this https URL Camera-Ready Version
>
...
>
---
#### [replaced 074] Towards Onboard Continuous Change Detection for Floods
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.13751](https://arxiv.org/pdf/2601.13751)**

> **作者:** Daniel Kyselica; Jonáš Herec; Oliver Kutis; Rado Pitoňák
>
> **备注:** 19 pages, 9 figures, accepted at GISTAM 2026
>
...
>
---
#### [replaced 075] GriDiT: Factorized Grid-Based Diffusion for Efficient Long Image Sequence Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21276](https://arxiv.org/pdf/2512.21276)**

> **作者:** Snehal Singh Tomar; Alexandros Graikos; Arjun Krishna; Dimitris Samaras; Klaus Mueller
>
> **备注:** Transactions on ML Research (TMLR) 2026
>
...
>
---
#### [replaced 076] GeoMotionGPT: Geometry-Aligned Motion Understanding with Large Language Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2601.07632](https://arxiv.org/pdf/2601.07632)**
...
>
---
#### [replaced 077] DynamicVis: Dynamic Visual Perception for Efficient Remote Sensing Foundation Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.16426](https://arxiv.org/pdf/2503.16426)**

> **作者:** Keyan Chen; Chenyang Liu; Bowen Chen; Wenyuan Li; Zhengxia Zou; Shijian Lu; Zhenwei Shi
>
...
>
---
#### [replaced 082] A Unified View of Drifting and Score-Based Models
- **分类: cs.LG; cs.AI; cs.CV**
...
>
---
#### [replaced 085] A Re-ranking Method using K-nearest Weighted Fusion for Person Re-identification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.04050](https://arxiv.org/pdf/2509.04050)**

> **作者:** Huy Che; Le-Chuong Nguyen; Gia-Nghia Tran; Dinh-Duy Phan; Vinh-Tiep Nguyen
>
...
>
---
#### [replaced 089] MIPHEI-ViT: Multiplex Immunofluorescence Prediction from H&E Images using ViT Foundation Models
- **分类: cs.CV; q-bio.TO**

- **链接: [https://arxiv.org/pdf/2505.10294](https://arxiv.org/pdf/2505.10294)**

> **作者:** Guillaume Balezo; Roger Trullo; Albert Pla Planas; Etienne Decenciere; Thomas Walter
>
> **备注:** Accepted manuscript, 24 pages, 9 figures, 5 tables. Published in Computers in Biology and Medicine (DOI: this https URL)
>
