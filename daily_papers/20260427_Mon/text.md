...
#### [new 001] Fine-Grained Analysis of Shared Syntactic Mechanisms in Language Models
- **分类: cs.CL**

- **简介: 该论文属于语言模型可解释性研究，旨在探究模型是否共享语法结构的神经机制。通过激活块操作分析填充-空缺和否定极项的处理机制，发现填充-空缺有共享机制，而否定极项没有。**

- **链接: [https://arxiv.org/pdf/2604.22166](https://arxiv.org/pdf/2604.22166)**
...
>
---
#### [new 002] TTS-PRISM: A Perceptual Reasoning and Interpretable Speech Model for Fine-Grained Diagnosis
- **分类: cs.CL; eess.AS**
...
>
---
#### [new 010] Aggregate vs. Personalized Judges in Business Idea Evaluation: Evidence from Expert Disagreement
- **分类: cs.CL**

- **简介: 该论文属于业务创意评估任务，解决专家评价不一致的问题。通过构建数据集并比较聚合与个性化评估方法，发现个性化法官更贴近评估者意见。**

- **链接: [https://arxiv.org/pdf/2604.22517](https://arxiv.org/pdf/2604.22517)**
...
>
---
#### [new 014] ReLeVAnT: Relevance Lexical Vectors for Accurate Legal Text Classification
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于法律文本分类任务，旨在解决传统方法依赖结构化数据的问题。提出ReLeVAnT框架，结合n-gram和浅层网络实现高效准确分类。**

- **链接: [https://arxiv.org/pdf/2604.22292](https://arxiv.org/pdf/2604.22292)**
...
>
---
#### [new 015] Identifying and typifying demographic unfairness in phoneme-level embeddings of self-supervised speech recognition models
- **分类: cs.CL**

- **简介: 该论文属于语音识别公平性研究任务，旨在解决ASR系统对不同说话者群体的不公平问题。通过分析声素嵌入中的随机误差和系统性偏差，提出两种错误类型并探讨其影响。**

- **链接: [https://arxiv.org/pdf/2604.22631](https://arxiv.org/pdf/2604.22631)**
...
>
---
#### [new 016] Dynamically Acquiring Text Content to Enable the Classification of Lesser-known Entities for Real-world Tasks
- **分类: cs.CL**

- **简介: 该论文属于实体分类任务，旨在解决少知名实体分类缺乏任务特定信息的问题。通过动态获取实体描述文本，构建文本分类器。**

- **链接: [https://arxiv.org/pdf/2604.22325](https://arxiv.org/pdf/2604.22325)**

> **作者:** Fahmida Alam; Ellen Riloff
>
> **摘要:** Existing Natural Language Processing (NLP) resources often lack the task-specific information required for real-world problems and provide limited coverage of lesser-known or newly introduced entities. For example, business organizations and health care providers may need to be classified into a variety of different taxonomic schemes for specific application tasks. Our goal is to enable domain experts to easily create a task-specific classifier for entities by providing only entity names and gold labels as training data. Our framework then dynamically acquires descriptive text about each entity, which is subsequently used as the basis for producing a text-based classifier. We propose a novel text acquisition method that leverages both web and large language models (LLMs). We evaluate our proposed framework on two classification problems in distinct domains: (i) classifying organizations into Standard Industrial Classification (SIC) Codes, which categorize organizations based on their business activities; and (ii) classifying healthcare providers into healthcare provider taxonomy codes, which represent a provider's medical specialty and area of practice. Our best-performing model achieved macro-averaged F1-scores of 82.3% and 72.9% on the SIC code and healthcare taxonomy code classification tasks, respectively.
>
---
#### [new 017] RouteLMT: Learned Sample Routing for Hybrid LLM Translation Deployment
- **分类: cs.CL**

- **简介: 该论文属于机器翻译任务，解决大规模LLM部署成本高的问题。提出RouteLMT方法，通过预测大模型对小模型的边际提升来优化路由决策，实现质量与成本的平衡。**

- **链接: [https://arxiv.org/pdf/2604.22520](https://arxiv.org/pdf/2604.22520)**
...
>
---
#### [new 025] Verbal Confidence Saturation in 3-9B Open-Weight Instruction-Tuned LLMs: A Pre-Registered Psychometric Validity Screen
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大模型的语义置信度有效性，测试7个3-9B参数模型在不同提示下的置信度表现，发现其置信度无效且影响任务性能。**

- **链接: [https://arxiv.org/pdf/2604.22215](https://arxiv.org/pdf/2604.22215)**
...
>
---
#### [new 032] Large Language Models Decide Early and Explain Later
- **分类: cs.CL**

- **简介: 该论文研究大语言模型在推理过程中的答案确定时机，旨在减少冗余推理。通过分析中间预测，发现多数情况下答案早期确定，后续推理为解释性内容。工作包括验证这一现象并提出早停策略以降低计算成本。**

- **链接: [https://arxiv.org/pdf/2604.22266](https://arxiv.org/pdf/2604.22266)**
...
>
---
#### [new 033] Lightweight Retrieval-Augmented Generation and Large Language Model-Based Modeling for Scalable Patient-Trial Matching
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于医疗信息检索任务，解决患者与临床试验匹配的问题。通过结合检索增强生成和大模型，提升匹配效率与准确性。**

- **链接: [https://arxiv.org/pdf/2604.22061](https://arxiv.org/pdf/2604.22061)**
...
>
---
#### [new 048] PrivUn: Unveiling Latent Ripple Effects and Shallow Forgetting in Privacy Unlearning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于隐私保护任务，旨在解决大模型中私有信息遗忘不足的问题。通过构建评估框架，揭示现有方法的缺陷，并提出两种改进策略提升遗忘效果。**

- **链接: [https://arxiv.org/pdf/2604.22076](https://arxiv.org/pdf/2604.22076)**
...
>
---
#### [new 053] Zero-Shot Morphological Discovery in Low-Resource Bantu Languages via Cross-Lingual Transfer and Unsupervised Clustering
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于形态学分析任务，旨在解决低资源班图语言的形态特征发现问题。通过跨语言迁移和无监督聚类，自动识别词类和新形态模式。**

- **链接: [https://arxiv.org/pdf/2604.22723](https://arxiv.org/pdf/2604.22723)**
...
>
---
#### [new 056] Evaluating LLM-Based Goal Extraction in Requirements Engineering: Prompting Strategies and Their Limitations
- **分类: cs.SE; cs.AI; cs.CL**

- **简介: 该论文属于需求工程任务，旨在通过LLM提取功能目标。研究探索了提示策略及其局限性，提出链式LLM和反馈机制以提升准确性。**

- **链接: [https://arxiv.org/pdf/2604.22207](https://arxiv.org/pdf/2604.22207)**
...
>
---
#### [new 058] Universal Transformers Need Memory: Depth-State Trade-offs in Adaptive Recursive Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究通用变换器在组合推理任务中的记忆需求，解决其深度与状态的权衡问题。通过实验发现记忆标记对性能至关重要，并提出初始化改进方法提升训练稳定性。**
...
>
---
#### [new 059] Neural Recovery of Historical Lexical Structure in Bantu Languages from Modern Data
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于语言学与人工智能交叉任务，旨在验证神经模型能否从现代数据中恢复历史词汇结构。研究使用Transformer模型分析14种班图语，识别词源候选并验证其与原始班图语的一致性。**

- **链接: [https://arxiv.org/pdf/2604.22730](https://arxiv.org/pdf/2604.22730)**
...
>
---
#### [new 060] Superminds Test: Actively Evaluating Collective Intelligence of Agent Society via Probing Agents
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于人工智能领域，研究agent社会的集体智能。旨在验证大规模agent是否自然产生集体智能，通过设计测试框架进行实验，发现缺乏有效协作与信息整合，表明规模不等于智能。**

- **链接: [https://arxiv.org/pdf/2604.22452](https://arxiv.org/pdf/2604.22452)**
...
>
---
#### [replaced 004] Machine learning and emoji prediction: How much accuracy can MARBERT achieve?
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于emoji预测任务，旨在提升阿拉伯语推文中的emoji预测准确率。研究使用MARBERT模型进行微调，并分析了其在多方言阿拉伯语上的表现。**
...
>
---
#### [replaced 006] Intrinsic Fingerprint of LLMs: Continue Training is NOT All You Need to Steal A Model!
- **分类: cs.CR; cs.CL; cs.LG**

- **简介: 该论文属于模型指纹识别任务，旨在解决LLM版权保护问题。通过分析注意力参数分布，提出一种鲁棒的模型指纹方法，可检测模型抄袭与侵权。**

- **链接: [https://arxiv.org/pdf/2507.03014](https://arxiv.org/pdf/2507.03014)**
...
>
---
#### [replaced 007] Multi-Token Prediction via Self-Distillation
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言模型加速任务，解决单次预测速度慢的问题。通过自蒸馏方法，将预训练模型转换为多标记快速预测模型，提升推理速度且损失小。**

- **链接: [https://arxiv.org/pdf/2602.06019](https://arxiv.org/pdf/2602.06019)**

> **作者:** John Kirchenbauer; Abhimanyu Hans; Brian Bartoldson; Micah Goldblum; Ashwinee Panda; Tom Goldstein
>
> **备注:** 9 pages and 5 figures in the main body
>
...
>
---
#### [replaced 008] VLAA-GUI: Knowing When to Stop, Recover, and Search, A Modular Framework for GUI Automation
- **分类: cs.CL; cs.AI; cs.SE**

- **简介: 该论文提出VLAA-GUI框架，解决GUI自动化中的早期停止和重复循环问题，通过Stop、Recover、Search组件提升自动化效率。**
...
>
---
#### [replaced 009] Asymmetric Goal Drift in Coding Agents Under Value Conflict
- **分类: cs.AI; cs.CL; cs.SE**

- **简介: 该论文研究编码代理在价值冲突下的目标漂移问题，通过实验揭示模型在强价值观冲突时更易违反系统约束，强调环境压力对模型行为的影响。**
...
>
---
#### [replaced 011] PL-MTEB: Polish Massive Text Embedding Benchmark
- **分类: cs.CL**

- **简介: 本文介绍PL-MTEB，一个针对波兰语的文本嵌入基准。解决波兰语文本嵌入评估问题，包含30项任务，涵盖多个NLP类别，并评估了30个模型。**

- **链接: [https://arxiv.org/pdf/2405.10138](https://arxiv.org/pdf/2405.10138)**

> **作者:** Rafał Poświata; Sławomir Dadas; Michał Perełkiewicz
>
> **备注:** Accepted for ACL 2026 Findings
>
> **摘要:** In this paper, we introduce the Polish Massive Text Embedding Benchmark (PL-MTEB), a comprehensive benchmark for text embeddings in the Polish language. PL-MTEB comprises 30 diverse NLP tasks across five categories: classification, clustering, pair classification, information retrieval, and semantic text similarity. Within the scope of this work, we added 12 new Polish-language tasks to MTEB based on existing datasets and prepared two new datasets used to create four clustering tasks. We evaluated 30 publicly available text embedding models, including Polish and multilingual models. We analyzed the results in detail for specific task types and model sizes. We made the prepared datasets, the source code for evaluation, and the obtained results available to the public at this https URL.
>
---
#### [replaced 012] Sensory-Aware Sequential Recommendation via Review-Distilled Representations
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于推荐系统任务，旨在解决传统推荐模型缺乏感官信息的问题。通过从评论中提取感官属性并生成嵌入，增强物品表示，提升推荐效果。**
...
>
---
#### [replaced 013] Logic Jailbreak: Efficiently Unlocking LLM Safety Restrictions Through Formal Logical Expression
- **分类: cs.CL; cs.AI**
...
>
---
#### [replaced 014] "This Wasn't Made for Me": Recentering User Experience and Emotional Impact in the Evaluation of ASR Bias
- **分类: cs.CL**
...
>
---
#### [replaced 015] Precise Debugging Benchmark: Is Your Model Debugging or Regenerating?
- **分类: cs.SE; cs.CL**
...
>
---
#### [replaced 016] From Interpretability to Performance: Optimizing Retrieval Heads for Long-Context Language Models
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升长文本理解能力。通过优化检索头，增强模型在长上下文中的表现。**

- **链接: [https://arxiv.org/pdf/2601.11020](https://arxiv.org/pdf/2601.11020)**

> **作者:** Youmi Ma; Naoaki Okazaki
>
> **备注:** Findings of ACL 2026; Source code available at this https URL
>
...
>
---
#### [replaced 019] How Learning Rate Decay Wastes Your Best Data in Curriculum-Based LLM Pretraining
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理中的预训练任务，解决课程学习与学习率衰减不兼容的问题。通过调整学习率策略和模型平均，提升模型性能。**
...
>
---
#### [replaced 020] LATMiX: Learnable Affine Transformations for Microscaling Quantization of LLMs
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于模型量化任务，解决低比特量化下的精度下降问题。提出LATMiX方法，通过可学习的仿射变换提升微缩格式量化效果。**

- **链接: [https://arxiv.org/pdf/2602.17681](https://arxiv.org/pdf/2602.17681)**
...
>
---
#### [replaced 021] Learning from Natural Language Feedback for Personalized Question Answering
- **分类: cs.CL; cs.AI; cs.IR**

- **简介: 该论文属于个性化问答任务，旨在提升问答系统的个性化效果。针对现有方法依赖弱监督信号的问题，提出VAC框架，用自然语言反馈替代标量奖励，优化模型生成质量。**

- **链接: [https://arxiv.org/pdf/2508.10695](https://arxiv.org/pdf/2508.10695)**
...
>
---
#### [replaced 024] When Models Outthink Their Safety: Unveiling and Mitigating Self-Jailbreak in Large Reasoning Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于AI安全任务，旨在解决大型推理模型中的自我越狱问题。通过提出Chain-of-Guardrail框架，在不损害推理能力的前提下，实现针对特定步骤的安全干预。**

- **链接: [https://arxiv.org/pdf/2510.21285](https://arxiv.org/pdf/2510.21285)**

> **作者:** Yingzhi Mao; Chunkang Zhang; Junxiang Wang; Xinyan Guan; Boxi Cao; Yaojie Lu; Hongyu Lin; Xianpei Han; Le Sun
>
> **备注:** ACL 2026. The first two authors contributed equally. The main text is 9 pages, with an appendix of 28 pages. The paper contains 20 figures and 15 tables
>
...
>
---
#### [replaced 025] NiuTrans.LMT: Toward Inclusive and Scalable Multilingual Machine Translation with LLMs
- **分类: cs.CL**

- **简介: 该论文属于多语言机器翻译任务，旨在解决多语言翻译中方向性能不平衡的问题。提出SD和PMP方法，并开发了LMT模型以提升翻译质量与扩展性。**

- **链接: [https://arxiv.org/pdf/2511.07003](https://arxiv.org/pdf/2511.07003)**
...
>
> **备注:** Accepted to ACL 2026 Main Conference. Models are available at: this https URL
>
...
>
---
#### [replaced 026] LLMs as Assessors: Right for the Right Reason?
- **分类: cs.IR; cs.CL; cs.LG**

- **简介: 论文探讨LLMs作为信息检索评估者的有效性，旨在解决如何判断其是否能替代人类评估的问题。通过分析Wikipedia测试集，评估LLMs在文档和段落层面的判断能力。**

- **链接: [https://arxiv.org/pdf/2601.08919](https://arxiv.org/pdf/2601.08919)**

> **作者:** Sourav Saha; Mandar Mitra; Aditya Dutta
>
...
>
---
#### [replaced 027] Beyond N-gram: Data-Aware X-GRAM Extraction for Efficient Embedding Parameter Scaling
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，解决嵌入参数效率与内存增长问题。提出X-GRAM框架，通过动态令牌注入提升性能，实现模型容量与计算解耦。**

- **链接: [https://arxiv.org/pdf/2604.21724](https://arxiv.org/pdf/2604.21724)**

> **作者:** Yilong Chen; Yanxi Xie; Zitian Gao; He Xin; Yihao Xiao; Jason Klein Liu; Haoming Luo; Yifan Luo; Zhengmao Ye; Tingwen Liu; Xin Zhao; Ran Tao; Bryan Dai
>
...
>
> **备注:** ACL 2026 Main Conference. Our code and data are on this https URL
>
...
>
---
#### [replaced 030] EuropeMedQA Study Protocol: A Multilingual, Multimodal Medical Examination Dataset for Language Model Evaluation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗AI领域，旨在解决多语言和多模态医学考试数据不足的问题。构建了EuropeMedQA数据集，用于评估语言模型的跨语言和视觉推理能力。**
...
>
---
#### [replaced 034] CURA: Clinical Uncertainty Risk Alignment for Language Model-Based Risk Prediction
- **分类: cs.CL**

- **简介: 该论文属于临床风险预测任务，旨在解决语言模型不确定性估计不准确的问题。提出CURA框架，通过校准和协同优化提升风险预测的可靠性。**
...
>
---
#### [replaced 035] Categorical Perception in Large Language Model Hidden States: Structural Warping at Digit-Count Boundaries
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究大语言模型在处理阿拉伯数字时的隐层表示，发现其存在类范畴感知的几何畸变。任务为分析模型内部表征，解决问题是识别结构边界对模型表征的影响。工作包括使用相似性分析验证模型表现。**
...
>
---
#### [replaced 036] NeuronMLP: Efficient LLM Inference via Singular Value Decomposition Compression and Tiling on AWS Trainium
- **分类: cs.CL**

- **简介: 该论文属于大语言模型推理优化任务，旨在解决Trainium加速器上高效推理问题。通过SVD压缩和分块技术优化MLP层，提升推理速度。**

- **链接: [https://arxiv.org/pdf/2510.25977](https://arxiv.org/pdf/2510.25977)**
...
>
---
#### [replaced 037] UR$^2$: Unify RAG and Reasoning through Reinforcement Learning
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出UR$^2$框架，解决RAG与推理融合的问题，通过强化学习动态协调检索与推理，提升模型在多个任务上的性能。**

- **链接: [https://arxiv.org/pdf/2508.06165](https://arxiv.org/pdf/2508.06165)**
...
>
---
#### [replaced 038] Selective Rotary Position Embedding
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出Selective RoPE，解决语言模型中位置信息编码问题，通过输入依赖的旋转机制提升模型性能。**

- **链接: [https://arxiv.org/pdf/2511.17388](https://arxiv.org/pdf/2511.17388)**
...
>
---
#### [replaced 039] The Bitter Lesson of Diffusion Language Models for Agentic Workflows: A Comprehensive Reality Check
- **分类: cs.CL**

- **简介: 该论文属于人工智能领域，研究dLLMs在代理工作流中的有效性。旨在解决dLLMs是否能有效支持代理行为的问题，通过实验发现其存在缺陷，并提出DiffuAgent框架进行评估。**

- **链接: [https://arxiv.org/pdf/2601.12979](https://arxiv.org/pdf/2601.12979)**
...
>
---
#### [replaced 042] Unlocking the Edge deployment and ondevice acceleration of multi-LoRA enabled one-for-all foundational LLM
- **分类: cs.DC; cs.AI; cs.CL**

- **简介: 该论文研究在移动端部署多任务大语言模型，解决内存、延迟和灵活性问题。通过LoRA融合、多流解码和动态预测技术，提升推理效率与性能。**
...
>
---
#### [replaced 043] Why Supervised Fine-Tuning Fails to Learn: A Systematic Study of Incomplete Learning in Large Language Models
- **分类: cs.CL**
...
>
---
#### [replaced 044] One Persona, Many Cues, Different Results: How Sociodemographic Cues Impact LLM Personalization
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的公平性研究任务，旨在解决LLM个性化中因社会人口线索引发的偏差问题。通过对比多种线索对模型响应的影响，揭示单一线索的局限性。**
...
>
---
#### [replaced 045] UNIKIE-BENCH: Benchmarking Large Multimodal Models for Key Information Extraction in Visual Documents
- **分类: cs.CV; cs.CL**

- **简介: 该论文属于关键信息抽取任务，旨在评估大模型在复杂文档中的KIE能力。提出UNIKIE-BENCH基准，解决模型在不同布局和字段下的性能问题。**

- **链接: [https://arxiv.org/pdf/2602.07038](https://arxiv.org/pdf/2602.07038)**
...
>
---
#### [replaced 046] DimABSA: Building Multilingual and Multidomain Datasets for Dimensional Aspect-Based Sentiment Analysis
- **分类: cs.CL**

- **简介: 该论文属于多语言、多领域的情感分析任务，旨在解决传统分类标签无法捕捉细微情感的问题。通过引入连续情感分数，构建了DimABSA数据集，并提出新评估指标cF1。**

- **链接: [https://arxiv.org/pdf/2601.23022](https://arxiv.org/pdf/2601.23022)**
...
>
---
#### [replaced 047] Test-Time Matching: Unlocking Compositional Reasoning in Multimodal Models
- **分类: cs.AI; cs.CL; cs.CV; cs.LG**

- **简介: 该论文属于多模态模型任务，解决 compositional reasoning 能力不足的问题。提出 Test-Time Matching (TTM) 算法，提升模型性能并超越现有基准。**

- **链接: [https://arxiv.org/pdf/2510.07632](https://arxiv.org/pdf/2510.07632)**

> **作者:** Yinglun Zhu; Jiancheng Zhang; Fuzhi Tang
>
> **备注:** To appear at ICLR 2026; extended results to generative multimodal models
>
...
>
---
#### [replaced 048] AdaptEvolve: Improving Efficiency of Evolutionary AI Agents through Adaptive Model Selection
- **分类: cs.CL; cs.AI**

- **简介: 论文提出AdaptEvolve，解决进化AI代理中模型选择的效率与能力平衡问题。通过动态选择LLM，提升计算效率并保持高准确性。任务属于AI代理优化。**

- **链接: [https://arxiv.org/pdf/2602.11931](https://arxiv.org/pdf/2602.11931)**

> **作者:** Pretam Ray; Pratik Prabhanjan Brahma; Zicheng Liu; Emad Barsoum
>
> **备注:** 9 pages, 2 Figues
>
> **摘要:** Evolutionary agentic systems intensify the trade-off between computational efficiency and reasoning capability by repeatedly invoking large language models (LLMs) during inference. This setting raises a central question: how can an agent dynamically select an LLM that is sufficiently capable for the current generation step while remaining computationally efficient? While model cascades offer a practical mechanism for balancing this trade-off, existing routing strategies typically rely on static heuristics or external controllers and do not explicitly account for model uncertainty. We introduce AdaptEvolve: Adaptive LLM Selection for Multi-LLM Evolutionary Refinement within an evolutionary sequential refinement framework that leverages intrinsic generation confidence to estimate real-time solvability. Empirical results show that confidence-driven selection yields a favourable Pareto frontier, reducing total inference cost by an average of 37.9% across benchmarks while retaining 97.5% of the upper-bound accuracy of static large-model baselines. Our code is available at this https URL.
>
---
#### [replaced 049] HACHIMI: Scalable and Controllable Student Persona Generation via Orchestrated Agents
- **分类: cs.CL**
...
>
> **备注:** 46 pages, 7 figures, accepted by ACL 2026. The dataset is available at this https URL
>
