...
#### [new 001] Benchmarking PhD-Level Coding in 3D Geometric Computer Vision
- **分类: cs.CV**

- **简介: 该论文属于3D几何计算机视觉编码任务，旨在评估AI生成复杂代码的能力。提出GeoCodeBench基准，测试模型在几何计算和算法实现上的表现，揭示当前技术与可靠编码间的差距。**

- **链接: [https://arxiv.org/pdf/2603.30038](https://arxiv.org/pdf/2603.30038)**
...
>
---
#### [new 007] Scaling the Long Video Understanding of Multimodal Large Language Models via Visual Memory Mechanism
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频理解任务，旨在解决长视频处理的限制问题。提出FlexMem方法，通过视觉记忆机制实现高效长视频理解。**

- **链接: [https://arxiv.org/pdf/2603.29252](https://arxiv.org/pdf/2603.29252)**
...
>
---
#### [new 011] NeuroBRIDGE: Behavior-Conditioned Koopman Dynamics with Riemannian Alignment for Early Substance Use Initiation Prediction from Longitudinal Functional Connectome
- **分类: cs.CV**

- **简介: 该论文属于早期物质使用启动预测任务，旨在解决静态脑连接无法反映动态变化的问题。提出NeuroBRIDGE框架，结合行为条件的Koopman动力学与时空注意力机制，提升预测效果并提供可解释性。**

- **链接: [https://arxiv.org/pdf/2603.29960](https://arxiv.org/pdf/2603.29960)**
...
>
---
#### [new 013] Not All Frames Are Equal: Complexity-Aware Masked Motion Generation via Motion Spectral Descriptors
- **分类: cs.CV**

- **简介: 该论文属于文本到动作生成任务，旨在解决运动帧处理不均衡的问题。通过引入Motion Spectral Descriptor（MSD），提升复杂动态运动的生成效果。**

- **链接: [https://arxiv.org/pdf/2603.29655](https://arxiv.org/pdf/2603.29655)**
...
>
---
#### [new 014] SHIFT: Stochastic Hidden-Trajectory Deflection for Removing Diffusion-based Watermark
- **分类: cs.CV; cs.CR**

- **简介: 该论文属于水印攻击任务，旨在破解扩散模型中的水印技术。提出SHIFT方法，通过随机扩散重采样干扰生成轨迹，实现高效去水印，无需训练。**
...
>
---
#### [new 015] NeoNet: An End-to-End 3D MRI-Based Deep Learning Framework for Non-Invasive Prediction of Perineural Invasion via Generation-Driven Classification
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于医学影像分析任务，旨在非侵入性预测胆管癌的神经周围浸润（PNI）。通过深度学习框架NeoNet，结合图像分割、生成和分类模块，提升PNI检测准确性。**

- **链接: [https://arxiv.org/pdf/2603.29449](https://arxiv.org/pdf/2603.29449)**
...
>
---
#### [new 018] Multi-Feature Fusion Approach for Generative AI Images Detection
- **分类: cs.CV**

- **简介: 该论文属于生成AI图像检测任务，旨在解决传统方法在区分真实与合成图像时的不足。通过融合多特征空间，提升检测鲁棒性。**

- **链接: [https://arxiv.org/pdf/2603.29788](https://arxiv.org/pdf/2603.29788)**
...
>
---
#### [new 020] End-to-End Image Compression with Segmentation Guided Dual Coding for Wind Turbines
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于图像压缩任务，旨在解决风力发电机叶片缺陷检测中的高效图像传输问题。通过结合分割与双模压缩，提升叶片区域质量并压缩背景，实现高效且无损的图像处理。**

- **链接: [https://arxiv.org/pdf/2603.29927](https://arxiv.org/pdf/2603.29927)**
...
>
---
#### [new 021] LatentPilot: Scene-Aware Vision-and-Language Navigation by Dreaming Ahead with Latent Visual Reasoning
...
>
---
#### [new 037] Unify-Agent: A Unified Multimodal Agent for World-Grounded Image Synthesis
- **分类: cs.CV; cs.MM**

- **简介: 该论文属于图像生成任务，旨在解决长尾和知识密集型概念生成难题。提出Unify-Agent，通过代理流程实现多模态推理与知识检索，提升图像生成质量。**
...
>
---
#### [new 044] Training deep learning based dynamic MR image reconstruction using synthetic fractals
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于动态MRI重建任务，旨在解决临床数据隐私和可用性问题。通过使用合成分形数据训练深度学习模型，实现与真实心脏MRI数据相当的重建效果。**

- **链接: [https://arxiv.org/pdf/2603.29922](https://arxiv.org/pdf/2603.29922)**
...
>
---
#### [new 048] Quantization with Unified Adaptive Distillation to enable multi-LoRA based one-for-all Generative Vision Models on edge
- **分类: cs.CV; cs.AI**

- **简介: 该论文针对边缘设备上多任务生成式AI部署问题，提出一种统一框架，通过动态加载LoRA权重和量化训练策略，实现单模型多任务运行，显著降低内存和延迟。**

- **链接: [https://arxiv.org/pdf/2603.29535](https://arxiv.org/pdf/2603.29535)**
...
>
---
#### [new 049] Assessing Multimodal Chronic Wound Embeddings with Expert Triplet Agreement
- **分类: cs.CV**

- **简介: 该论文属于医学图像与文本融合任务，旨在解决RDEB病例相似性检索问题。通过构建TriDerm框架，融合视觉与文本模态，提升与专家判断的一致性。**
...
>
---
#### [new 058] Abstraction in Style
- **分类: cs.CV**

- **简介: 该论文属于风格迁移任务，解决传统方法难以捕捉深层抽象的问题。提出AiS框架，分离结构抽象与视觉风格，提升风格化表达能力。**

- **链接: [https://arxiv.org/pdf/2603.29924](https://arxiv.org/pdf/2603.29924)**
...
>
---
#### [new 060] OmniRoam: World Wandering via Long-Horizon Panoramic Video Generation
- **分类: cs.CV**

- **简介: 该论文提出OmniRoam，解决全景视频生成任务中的场景完整性和长期一致性问题。通过可控的框架生成高质量、长时序的全景视频。**

- **链接: [https://arxiv.org/pdf/2603.30045](https://arxiv.org/pdf/2603.30045)**
...
>
---
#### [new 072] FOSCU: Feasibility of Synthetic MRI Generation via Duo-Diffusion Models for Enhancement of 3D U-Nets in Hepatic Segmentation
- **分类: cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决数据不足和标注成本高的问题。通过Duo-Diffusion生成合成MRI数据，提升3D U-Net的分割性能。**

- **链接: [https://arxiv.org/pdf/2603.29343](https://arxiv.org/pdf/2603.29343)**
...
>
---
#### [new 082] AutoFormBench: Benchmark Dataset for Automating Form Understanding
- **分类: cs.CV**

- **简介: 该论文属于文档理解任务，旨在解决结构化文档中表单元素检测问题。通过构建AutoFormBench数据集，并对比多种模型性能，提升表单自动化处理能力。**

- **链接: [https://arxiv.org/pdf/2603.29832](https://arxiv.org/pdf/2603.29832)**
...
>
---
#### [new 083] CoRe-DA: Contrastive Regression for Unsupervised Domain Adaptation in Surgical Skill Assessment
- **分类: cs.CV**

- **简介: 该论文属于手术技能评估任务，解决标注数据稀缺和模型泛化能力差的问题。提出CoRe-DA方法，通过对比回归实现无监督域适应，提升跨域性能。**

- **链接: [https://arxiv.org/pdf/2603.29666](https://arxiv.org/pdf/2603.29666)**
...
>
---
#### [new 087] Emotion Diffusion Classifier with Adaptive Margin Discrepancy Training for Facial Expression Recognition
- **分类: cs.CV**

- **简介: 该论文属于面部表情识别任务，旨在提升模型的鲁棒性。针对现有方法易受分布偏移影响的问题，提出EmoDC和AMDiT，增强分类器的判别能力与抗噪性能。**

- **链接: [https://arxiv.org/pdf/2603.29578](https://arxiv.org/pdf/2603.29578)**
...
>
---
#### [new 114] M2H-MX: Multi-Task Dense Visual Perception for Real-Time Monocular Spatial Understanding
- **分类: cs.CV**

- **简介: 该论文提出M2H-MX模型，解决单目实时空间感知问题。通过多任务密集预测，提升深度和语义估计精度，优化单目SLAM系统性能。**
...
>
---
#### [new 115] MAPLE: Multi-Path Adaptive Propagation with Level-Aware Embeddings for Hierarchical Multi-Label Image Classification
- **分类: cs.CV**

- **简介: 该论文属于遥感图像的层次多标签分类任务，解决多路径场景下层次信息利用不足的问题。提出MAPLE框架，融合语义初始化、图结构编码和多模态融合，提升分类效果。**

- **链接: [https://arxiv.org/pdf/2603.29784](https://arxiv.org/pdf/2603.29784)**
...
>
---
#### [new 117] HCLSM: Hierarchical Causal Latent State Machines for Object-Centric World Modeling
...
>
---
#### [new 118] A Comprehensive Information-Decomposition Analysis of Large Vision-Language Models
...
>
---
#### [new 122] IMAGAgent: Orchestrating Multi-Turn Image Editing via Constraint-Aware Planning and Reflection
- **分类: cs.GR; cs.AI; cs.CV; cs.MA**

- **简介: 该论文提出IMAGAgent，解决多轮图像编辑中的语义漂移和结构失真问题。通过计划-执行-反思机制，实现指令解析、工具调度与自修正的协同优化。**

- **链接: [https://arxiv.org/pdf/2603.29602](https://arxiv.org/pdf/2603.29602)**
...
>
---
#### [new 128] AutoWorld: Scaling Multi-Agent Traffic Simulation with Self-Supervised World Models
...
>
---
#### [new 129] CADReasoner: Iterative Program Editing for CAD Reverse Engineering
- **分类: cs.GR; cs.CV; cs.HC**

- **简介: 该论文提出CADReasoner，解决CAD逆向工程中细节缺失问题。通过迭代优化生成高精度CAD程序，融合多模态数据并提升重建准确性。**

- **链接: [https://arxiv.org/pdf/2603.29847](https://arxiv.org/pdf/2603.29847)**
...
>
---
#### [new 133] VectorGym: A Multitask Benchmark for SVG Code Generation, Sketching, and Editing
- **分类: cs.GR; cs.AI; cs.CV**

- **简介: 该论文提出VectorGym，一个用于SVG生成、草图转换和编辑的多任务基准，解决专业设计流程中缺乏真实挑战性数据的问题。**

- **链接: [https://arxiv.org/pdf/2603.29852](https://arxiv.org/pdf/2603.29852)**
...
>
---
#### [replaced 002] GUIDE: Resolving Domain Bias in GUI Agents through Real-Time Web Video Retrieval and Plug-and-Play Annotation
- **分类: cs.AI; cs.CV**
...
>
---
#### [replaced 003] Universal Skeleton Understanding via Differentiable Rendering and MLLMs
- **分类: cs.CV**
...
>
---
#### [replaced 004] SceneDiff: A Benchmark and Method for Multiview Object Change Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.16908](https://arxiv.org/pdf/2512.16908)**
...
>
---
#### [replaced 006] LatentFM: A Latent Flow Matching Approach for Generative Medical Image Segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 007] AGILE: Hand-Object Interaction Reconstruction from Video via Agentic Generation
- **分类: cs.CV; cs.GR; cs.RO**
...
>
---
#### [replaced 008] REN: Anatomically-Informed Mixture-of-Experts for Interstitial Lung Disease Diagnosis
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.04923](https://arxiv.org/pdf/2510.04923)**
...
>
---
#### [replaced 011] CLIP-AUTT: Test-Time Personalization with Action Unit Prompting for Fine-Grained Video Emotion Recognition
- **分类: cs.CV**
...
>
---
#### [replaced 012] Do VLMs Perceive or Recall? Probing Visual Perception vs. Memory with Classic Visual Illusions
- **分类: cs.CV**
...
>
---
#### [replaced 013] ANVIL: Accelerator-Native Video Interpolation via Codec Motion Vector Priors
- **分类: eess.IV; cs.CV**
...
> **作者:** Shibo Liu
>
> **备注:** 12 pages, 4 figures, 10 tables. Submitted to IEEE TCSVT. v2: revised ablation studies, compressed text, expanded abstract abbreviations. Code: this https URL
>
...
>
---
#### [replaced 019] CreatiDesign: A Unified Multi-Conditional Diffusion Transformer for Creative Graphic Design
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.19114](https://arxiv.org/pdf/2505.19114)**

> **作者:** Hui Zhang; Dexiang Hong; Maoke Yang; Yutao Cheng; Zhao Zhang; Weidong Chen; Jie Shao; Xinglong Wu; Zuxuan Wu; Yu-Gang Jiang
>
...
>
---
#### [replaced 020] Unified Multimodal Models as Auto-Encoders
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.09666](https://arxiv.org/pdf/2509.09666)**
...
>
---
#### [replaced 021] Text-guided Fine-Grained Video Anomaly Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.00524](https://arxiv.org/pdf/2511.00524)**

> **作者:** Jihao Gu; Kun Li; He Wang; Kaan Akşit
>
> **备注:** Accepted by CVPR 2026 SVC Workshop
>
> **摘要:** Subtle abnormal events in videos often manifest as weak spatio-temporal cues that are easily overlooked by conventional anomaly detection systems. Existing video anomaly detection approaches typically provide coarse binary anomaly decisions without interpretable evidence, while large vision-language models (LVLMs) can produce textual judgments but lack precise localization of subtle visual signals. To address this gap, we propose Text-guided Fine-Grained Video Anomaly Understanding T-VAU, a framework that grounds subtle anomaly evidence into multimodal reasoning. Specifically, we introduce an Anomaly Heatmap Decoder (AHD) that performs visual-textual feature alignment to extract pixel-level spatio-temporal anomaly heatmaps from intermediate visual representations. We further design a Region-aware Anomaly Encoder (RAE) that converts these heatmaps into structured prompt embeddings, enabling the LVLM to perform anomaly detection, localization, and semantic explanation in a unified reasoning pipeline. To support fine-grained supervision, we construct a target-level fine-grained video-text anomaly dataset derived from ShanghaiTech and UBnormal with detailed annotations of object appearance, localization, and motion trajectories. Extensive experiments demonstrate that T-VAU significantly improves anomaly localization and textual reasoning performance on both benchmarks, achieving strong results in BLEU-4 metrics and Yes/No decision accuracy while providing interpretable pixel-level spatio-temporal evidence for anomaly understanding. The code will be available at this https URL.
>
---
#### [replaced 022] HieraMamba: Video Temporal Grounding via Hierarchical Anchor-Mamba Pooling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.23043](https://arxiv.org/pdf/2510.23043)**
...
>
---
#### [replaced 023] Neuro-Cognitive Reward Modeling for Human-Centered Autonomous Vehicle Control
- **分类: cs.CV**
...
>
---
#### [replaced 024] Catalyst4D: High-Fidelity 3D-to-4D Scene Editing via Dynamic Propagation
- **分类: cs.CV**
...
>
---
#### [replaced 025] Super-Resolved Canopy Height Mapping from Sentinel-2 Time Series Using LiDAR HD Reference Data across Metropolitan France
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 026] Med-CMR: A Fine-Grained Benchmark Integrating Visual Evidence and Clinical Logic for Medical Complex Multimodal Reasoning
- **分类: cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2512.00818](https://arxiv.org/pdf/2512.00818)**
...
>
---
#### [replaced 030] EagleNet: Energy-Aware Fine-Grained Relationship Learning Network for Text-Video Retrieval
- **分类: cs.CV**
...
>
---
#### [replaced 034] VIGiA: Instructional Video Guidance via Dialogue Reasoning and Retrieval
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 035] DeepCoT: Deep Continual Transformers for Real-Time Inference on Data Streams
- **分类: cs.LG; cs.CL; cs.CV**
...
>
---
#### [replaced 038] Scaling Cross-Environment Failure Reasoning Data for Vision-Language Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 039] EarthBridge: A Solution for 4th Multi-modal Aerial View Image Challenge Translation Track
- **分类: cs.CV**
...
>
---
#### [replaced 043] Towards Foundation Models for 3D Scene Understanding: Instance-Aware Self-Supervised Learning for Point Clouds
- **分类: cs.CV**
...
>
---
#### [replaced 044] ALADIN:Attribute-Language Distillation Network for Person Re-Identification
- **分类: cs.CV**
...
>
---
#### [replaced 052] Evidential Neural Radiance Fields
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2602.23574](https://arxiv.org/pdf/2602.23574)**
...
>
---
#### [replaced 053] ResAdapt: Adaptive Resolution for Efficient Multimodal Reasoning
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 054] POVQA: Preference-Optimized Video Question Answering with Rationales for Data Efficiency
- **分类: cs.CV; cs.MM**
...
>
---
#### [replaced 056] TransFIRA: Transfer Learning for Face Image Recognizability Assessment
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.06353](https://arxiv.org/pdf/2510.06353)**
...
>
> **摘要:** Text-driven image and video editing can be naturally cast as inpainting problems, where masked regions are reconstructed to remain consistent with both the observed content and the editing prompt. Recent advances in test-time guidance for diffusion and flow models provide a principled framework for this task; however, existing methods rely on costly vector--Jacobian product (VJP) computations to approximate the intractable guidance term, limiting their practical applicability. Building upon the recent work of Moufad et al. (2025), we provide theoretical insights into their VJP-free approximation and substantially extend their empirical evaluation to large-scale image and video editing benchmarks. Our results demonstrate that test-time guidance alone can achieve performance comparable to, and in some cases surpass, training-based methods.
>
---
#### [replaced 062] MVGGT: Multimodal Visual Geometry Grounded Transformer for Multiview 3D Referring Expression Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.06874](https://arxiv.org/pdf/2601.06874)**
...
>
---
#### [replaced 064] Rethinking Token Pruning for Historical Screenshots in GUI Visual Agents: Semantic, Spatial, and Temporal Perspectives
- **分类: cs.CV**
...
>
> **备注:** this http URL are missing authors and unresolved disputes regarding the author order in the current manuscript. this http URL experimental section lacks detailed experimental data and complete reproducible information, which prevents readers from replicating the work reliably. I need to conduct further experiments and supplement comprehensive data to ensure academic rigor
>
...
>
---
#### [replaced 065] StreetTree: A Large-Scale Global Benchmark for Fine-Grained Tree Species Classification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.19123](https://arxiv.org/pdf/2602.19123)**
...
>
---
#### [replaced 066] ORIC: Benchmarking Object Recognition under Contextual Incongruity in Large Vision-Language Models
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 069] SVBench: Evaluation of Video Generation Models on Social Reasoning
- **分类: cs.CV**
...
>
---
#### [replaced 070] DFM-VLA: Iterative Action Refinement for Robot Manipulation via Discrete Flow Matching
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 071] MathGen: Revealing the Illusion of Mathematical Competence through Text-to-Image Generation
- **分类: cs.CV**
...
>
---
#### [replaced 072] Beyond Boundary Frames: Context-Centric Video Interpolation with Audio-Visual Semantics
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.03590](https://arxiv.org/pdf/2512.03590)**
...
>
---
#### [replaced 073] SGS-Intrinsic: Semantic-Invariant Gaussian Splatting for Sparse-View Indoor Inverse Rendering
- **分类: cs.CV**
...
>
---
#### [replaced 076] When Rubrics Fail: Error Enumeration as Reward in Reference-Free RL Post-Training for Virtual Try-On
- **分类: cs.CV; cs.AI; cs.LG**
...
>
---
#### [replaced 077] Enhancing Eye Feature Estimation from Event Data Streams through Adaptive Inference State Space Modeling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.14077](https://arxiv.org/pdf/2603.14077)**
...
>
> **备注:** 8 pages, 3 figures, 1 tables, accepted to ETRA 2026
>
> **摘要:** Eye feature extraction from event-based data streams can be performed efficiently and with low energy consumption, offering great utility to real-world eye tracking pipelines. However, few eye feature extractors are designed to handle sudden changes in event density caused by the changes between gaze behaviors that vary in their kinematics, leading to degraded prediction performance. In this work, we address this problem by introducing the adaptive inference state space model (AISSM), a novel architecture for feature extraction that is capable of dynamically adjusting the relative weight placed on current versus recent information. This relative weighting is determined via estimates of the signal-to-noise ratio and event density produced by a complementary dynamic confidence network. Lastly, we craft and evaluate a novel learning technique that improves training efficiency. Experimental results demonstrate that the AISSM system outperforms state-of-the-art models for event-based eye feature extraction.
>
---
#### [replaced 078] Multi-Level Knowledge Distillation and Dynamic Self-Supervised Learning for Continual Learning
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2508.12692](https://arxiv.org/pdf/2508.12692)**

> **作者:** Taeheon Kim; San Kim; Minhyuk Seo; Dongjae Jeon; Wonje Jeung; Jonghyun Choi
>
> **备注:** 2nd Place in Class-Incremental with Repetition (CIR) using Unlabeled Data Challenge at 5th CLVISION workshop, CVPR 2024
>
...
>
---
#### [replaced 079] SafeDrive: Fine-Grained Safety Reasoning for End-to-End Driving in a Sparse World
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.18887](https://arxiv.org/pdf/2602.18887)**
...
>
---
#### [replaced 080] Source-Only Cross-Weather LiDAR via Geometry-Aware Point Drop
- **分类: cs.CV**
...
>
---
#### [replaced 082] ReAG: Reasoning-Augmented Generation for Knowledge-based Visual Question Answering
...
>
---
#### [replaced 083] PartNeXt: A Next-Generation Dataset for Fine-Grained and Hierarchical 3D Part Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.20155](https://arxiv.org/pdf/2510.20155)**
...
>
---
#### [replaced 088] AIBench: Evaluating Visual-Logical Consistency in Academic Illustration Generation
- **分类: cs.CV**
...
>
---
#### [replaced 089] JaWildText: A Benchmark for Vision-Language Models on Japanese Scene Text Understanding
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 090] Image-Specific Adaptation of Transformer Encoders for Compute-Efficient Segmentation
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2404.15244](https://arxiv.org/pdf/2404.15244)**
...
>
---
#### [replaced 094] Fine-grained Image Quality Assessment for Perceptual Image Restoration
- **分类: eess.IV; cs.CV; cs.MM**

- **链接: [https://arxiv.org/pdf/2508.14475](https://arxiv.org/pdf/2508.14475)**
...
>
---
#### [replaced 095] How to Train Your Long-Context Visual Document Model
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 096] A Provable Energy-Guided Test-Time Defense Boosting Adversarial Robustness of Large Vision-Language Models
- **分类: cs.CV**
...
>
> **摘要:** Despite the rapid progress in multimodal models and Large Visual-Language Models (LVLM), they remain highly susceptible to adversarial perturbations, raising serious concerns about their reliability in real-world use. While adversarial training has become the leading paradigm for building models that are robust to adversarial attacks, Test-Time Transformations (TTT) have emerged as a promising strategy to boost robustness at inference. In light of this, we propose Energy-Guided Test-Time Transformation (ET3), a lightweight, training-free defense that enhances the robustness by minimizing the energy of the input samples. Our method is grounded in a theory that proves our transformation succeeds in classification under reasonable assumptions. We present extensive experiments demonstrating that ET3 provides a strong defense for classifiers, zero-shot classification with CLIP, and also for boosting the robustness of LVLMs in tasks such as Image Captioning and Visual Question Answering. Code is available at this http URL .
>
---
#### [replaced 097] X-World: Controllable Ego-Centric Multi-Camera World Models for Scalable End-to-End Driving
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2603.19979](https://arxiv.org/pdf/2603.19979)**
...
>
---
#### [replaced 100] AutoWeather4D: Autonomous Driving Video Weather Conversion via G-Buffer Dual-Pass Editing
- **分类: cs.CV**
...
>
---
#### [replaced 101] JoyStreamer: Unlocking Highly Expressive Avatars via Harmonized Text-Audio Conditioning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.00702](https://arxiv.org/pdf/2602.00702)**
...
>
---
#### [replaced 102] BST: Badminton Stroke-type Transformer for Skeleton-based Action Recognition in Racket Sports
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.21085](https://arxiv.org/pdf/2502.21085)**

> **作者:** Jing-Yuan Chang
>
> **备注:** Accepted by CVPRW 2026 - 12th CVsports
>
...
>
---
#### [replaced 106] SecAgent: Efficient Mobile GUI Agent with Semantic Context
- **分类: cs.CV**
...
>
---
#### [replaced 109] Detection of Adversarial Attacks in Robotic Perception
...
>
---
#### [replaced 110] Fast SceneScript: Fast and Accurate Language-Based 3D Scene Understanding via Multi-Token Prediction
- **分类: cs.CV**
...
>
---
#### [replaced 115] JoyStreamer-Flash: Real-time and Infinite Audio-Driven Avatar Generation with Autoregressive Diffusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.11423](https://arxiv.org/pdf/2512.11423)**
...
>
---
#### [replaced 119] Understanding vs. Generation: Navigating Optimization Dilemma in Multimodal Models
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2602.15772](https://arxiv.org/pdf/2602.15772)**

> **作者:** Sen Ye; Mengde Xu; Shuyang Gu; Di He; Liwei Wang; Han Hu
>
> **备注:** Accepted to ICLR2026
>
> **摘要:** Current research in multimodal models faces a key challenge where enhancing generative capabilities often comes at the expense of understanding, and vice versa. We analyzed this trade-off and identify the primary cause might be the potential conflict between generation and understanding, which creates a competitive dynamic within the model. To address this, we propose the Reason-Reflect-Refine (R3) framework. This innovative algorithm re-frames the single-step generation task into a multi-step process of "generate-understand-regenerate". By explicitly leveraging the model's understanding capability during generation, we successfully mitigate the optimization dilemma, achieved stronger generation results and improved understanding ability which are related to the generation process. This offers valuable insights for designing next-generation unified multimodal models. Code is available at this https URL.
>
---
#### [replaced 120] Multi-Modal Representation Learning via Semi-Supervised Rate Reduction for Generalized Category Discovery
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.19910](https://arxiv.org/pdf/2602.19910)**
...
>
---
#### [replaced 121] Seeing Isn't Orienting: A Cognitively Grounded Benchmark Reveals Systematic Orientation Failures in MLLMs Supplementary
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2505.21649](https://arxiv.org/pdf/2505.21649)**

> **作者:** Nazia Tasnim; Keanu Nichols; Yuting Yan; Nicholas Ikechukwu; Elva Zou; Deepti Ghadiyaram; Bryan A. Plummer
>
> **备注:** Previously this version appeared as arXiv:2603.11410 which was submitted as a new work by accident
>
...
>
---
#### [replaced 122] EgoReasoner: Learning Egocentric 4D Reasoning via Task-Adaptive Structured Thinking
- **分类: cs.CV**
...
>
---
#### [replaced 123] AVA-Bench: Atomic Visual Ability Benchmark for Vision Foundation Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.09082](https://arxiv.org/pdf/2506.09082)**

> **作者:** Zheda Mai; Arpita Chowdhury; Zihe Wang; Sooyoung Jeon; Lemeng Wang; Jiacheng Hou; Wei-Lun Chao
>
> **备注:** Accepted by CVPR 2026. The first two authors contribute equally
>
