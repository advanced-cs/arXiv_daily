...
>
---
#### [new 003] Improving Training Efficiency and Reducing Maintenance Costs via Language Specific Model Merging
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理领域，解决多语言模型训练效率低和维护成本高的问题。通过模型合并技术提升训练效率并降低维护成本。**

- **链接: [https://arxiv.org/pdf/2601.16127v1](https://arxiv.org/pdf/2601.16127v1)**
...
>
---
#### [new 007] Can professional translators identify machine-generated text?
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本检测任务，研究专业译者能否识别AI生成的意大利语短篇小说。通过实验分析译者判断依据，探讨AI文本识别的可靠性及影响因素。**

- **链接: [https://arxiv.org/pdf/2601.15828v1](https://arxiv.org/pdf/2601.15828v1)**
...
>
---
#### [new 008] AfriEconQA: A Benchmark Dataset for African Economic Analysis based on World Bank Reports
- **分类: cs.CL**

- **简介: 该论文提出AfriEconQA，一个用于非洲经济分析的基准数据集，解决信息检索与问答任务中的领域知识缺失问题。通过构建高质量QA对，评估IR和RAG系统性能。**

- **链接: [https://arxiv.org/pdf/2601.15297v1](https://arxiv.org/pdf/2601.15297v1)**
...
>
---
#### [new 009] AdversaRiskQA: An Adversarial Factuality Benchmark for High-Risk Domains
- **分类: cs.CL; cs.CY**

- **简介: 该论文属于模型鲁棒性评估任务，旨在解决高风险领域中大语言模型的幻觉问题。提出AdversaRiskQA基准，评估模型对抗性事实性，测试其检测和抵抗虚假信息的能力。**

- **链接: [https://arxiv.org/pdf/2601.15511v1](https://arxiv.org/pdf/2601.15511v1)**
...
>
> **摘要:** We introduce LLM-in-Sandbox, enabling LLMs to explore within a code sandbox (i.e., a virtual computer), to elicit general intelligence in non-code domains. We first demonstrate that strong LLMs, without additional training, exhibit generalization capabilities to leverage the code sandbox for non-code tasks. For example, LLMs spontaneously access external resources to acquire new knowledge, leverage the file system to handle long contexts, and execute scripts to satisfy formatting requirements. We further show that these agentic capabilities can be enhanced through LLM-in-Sandbox Reinforcement Learning (LLM-in-Sandbox-RL), which uses only non-agentic data to train models for sandbox exploration. Experiments demonstrate that LLM-in-Sandbox, in both training-free and post-trained settings, achieves robust generalization spanning mathematics, physics, chemistry, biomedicine, long-context understanding, and instruction following. Finally, we analyze LLM-in-Sandbox's efficiency from computational and system perspectives, and open-source it as a Python package to facilitate real-world deployment.
>
---
#### [new 028] Beyond Marginal Distributions: A Framework to Evaluate the Representativeness of Demographic-Aligned LLMs
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的模型评估任务，旨在解决模型代表性的评价问题。通过分析多变量相关性模式，评估不同对齐方法的优劣。**

- **链接: [https://arxiv.org/pdf/2601.15755v1](https://arxiv.org/pdf/2601.15755v1)**
...
>
---
#### [new 029] Transfer Learning from ImageNet for MEG-Based Decoding of Imagined Speech
...
>
---
#### [new 030] Adapter Fusion for Multilingual Text2Cypher with Linear and Learned Gating
- **分类: cs.CL**

- **简介: 该论文属于多语言Text2Cypher任务，旨在解决多语言支持不足的问题。通过训练语言特定的LoRA适配器并使用融合MLP进行组合，实现高效、可扩展的多语言查询生成。**

- **链接: [https://arxiv.org/pdf/2601.16097v1](https://arxiv.org/pdf/2601.16097v1)**
...
>
---
#### [new 031] Universal Refusal Circuits Across LLMs: Cross-Model Transfer via Trajectory Replay and Concept-Basis Reconstruction
- **分类: cs.CL**

- **简介: 该论文属于安全对齐任务，旨在解决LLM拒绝行为的通用性问题。通过轨迹重放与概念重构，实现跨模型拒绝干预迁移，保持性能的同时提升安全性。**

- **链接: [https://arxiv.org/pdf/2601.16034v1](https://arxiv.org/pdf/2601.16034v1)**
...
>
---
#### [new 032] Common to Whom? Regional Cultural Commonsense and LLM Bias in India
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理中的文化常识评估任务，旨在解决国家内部文化常识区域差异问题。通过构建印度区域文化常识基准Indica，分析大模型在不同地区的偏见与表现。**

- **链接: [https://arxiv.org/pdf/2601.15550v1](https://arxiv.org/pdf/2601.15550v1)**
...
>
---
#### [new 033] Benchmarking LLMs for Pairwise Causal Discovery in Biomedical and Multi-Domain Contexts
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于因果发现任务，旨在评估大语言模型在生物医学等多领域中识别和提取因果关系的能力。通过12个数据集测试13个模型，发现其表现有限。**

- **链接: [https://arxiv.org/pdf/2601.15479v1](https://arxiv.org/pdf/2601.15479v1)**

> **作者:** Sydney Anuyah; Sneha Shajee-Mohan; Ankit-Singh Chauhan; Sunandan Chakraborty
>
> **摘要:** The safe deployment of large language models (LLMs) in high-stakes fields like biomedicine, requires them to be able to reason about cause and effect. We investigate this ability by testing 13 open-source LLMs on a fundamental task: pairwise causal discovery (PCD) from text. Our benchmark, using 12 diverse datasets, evaluates two core skills: 1) \textbf{Causal Detection} (identifying if a text contains a causal link) and 2) \textbf{Causal Extraction} (pulling out the exact cause and effect phrases). We tested various prompting methods, from simple instructions (zero-shot) to more complex strategies like Chain-of-Thought (CoT) and Few-shot In-Context Learning (FICL). The results show major deficiencies in current models. The best model for detection, DeepSeek-R1-Distill-Llama-70B, only achieved a mean score of 49.57\% ($C_{detect}$), while the best for extraction, Qwen2.5-Coder-32B-Instruct, reached just 47.12\% ($C_{extract}$). Models performed best on simple, explicit, single-sentence relations. However, performance plummeted for more difficult (and realistic) cases, such as implicit relationships, links spanning multiple sentences, and texts containing multiple causal pairs. We provide a unified evaluation framework, built on a dataset validated with high inter-annotator agreement ($κ\ge 0.758$), and make all our data, code, and prompts publicly available to spur further research. \href{https://github.com/sydneyanuyah/CausalDiscovery}{Code available here: https://github.com/sydneyanuyah/CausalDiscovery}
>
---
#### [new 034] YuFeng-XGuard: A Reasoning-Centric, Interpretable, and Flexible Guardrail Model for Large Language Models
- **分类: cs.CL**

- **简介: 该论文提出YuFeng-XGuard，解决LLM安全防护问题，通过结构化风险预测和可解释推理实现灵活、高效的安全决策。**

- **链接: [https://arxiv.org/pdf/2601.15588v1](https://arxiv.org/pdf/2601.15588v1)**
...
>
---
#### [new 047] Qwen3-TTS Technical Report
...
>
---
#### [new 048] Replayable Financial Agents: A Determinism-Faithfulness Assurance Harness for Tool-Using LLM Agents
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于金融AI可靠性研究，解决LLM代理在审计回放中不一致的问题。提出DFAH框架，评估确定性和证据一致性，提升金融工具使用代理的可复现性与合规性。**

- **链接: [https://arxiv.org/pdf/2601.15322v1](https://arxiv.org/pdf/2601.15322v1)**

> **作者:** Raffi Khatchadourian
>
> **备注:** 23 pages, 5 figures, 9 tables. Code and data: https://github.com/ibm-client-engineering/output-drift-financial-llms
>
...
>
---
#### [new 049] Even GPT-5.2 Can't Count to Five: The Case for Zero-Error Horizons in Trustworthy LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出零错误范围（ZEH）概念，用于评估大语言模型在无错误情况下能解决的问题范围。旨在揭示模型在简单任务上的缺陷，为安全关键应用提供参考。**

- **链接: [https://arxiv.org/pdf/2601.15714v1](https://arxiv.org/pdf/2601.15714v1)**

> **作者:** Ryoma Sato
>
> **摘要:** We propose Zero-Error Horizon (ZEH) for trustworthy LLMs, which represents the maximum range that a model can solve without any errors. While ZEH itself is simple, we demonstrate that evaluating the ZEH of state-of-the-art LLMs yields abundant insights. For example, by evaluating the ZEH of GPT-5.2, we found that GPT-5.2 cannot even compute the parity of a short string like 11000, and GPT-5.2 cannot determine whether the parentheses in ((((()))))) are balanced. This is surprising given the excellent capabilities of GPT-5.2. The fact that LLMs make mistakes on such simple problems serves as an important lesson when applying LLMs to safety-critical domains. By applying ZEH to Qwen2.5 and conducting detailed analysis, we found that while ZEH correlates with accuracy, the detailed behaviors differ, and ZEH provides clues about the emergence of algorithmic capabilities. Finally, while computing ZEH incurs significant computational cost, we discuss how to mitigate this cost by achieving up to one order of magnitude speedup using tree structures and online softmax.
>
---
#### [new 050] ErrorMap and ErrorAtlas: Charting the Failure Landscape of Large Language Models
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于模型评估任务，旨在解决LLM失败原因不明的问题。提出ErrorMap和ErrorAtlas，分析失败模式，揭示隐藏弱点，指导模型改进。**

- **链接: [https://arxiv.org/pdf/2601.15812v1](https://arxiv.org/pdf/2601.15812v1)**

> **作者:** Shir Ashury-Tahan; Yifan Mai; Elron Bandel; Michal Shmueli-Scheuer; Leshem Choshen
>
> **摘要:** Large Language Models (LLM) benchmarks tell us when models fail, but not why they fail. A wrong answer on a reasoning dataset may stem from formatting issues, calculation errors, or dataset noise rather than weak reasoning. Without disentangling such causes, benchmarks remain incomplete and cannot reliably guide model improvement. We introduce ErrorMap, the first method to chart the sources of LLM failure. It extracts a model's unique "failure signature", clarifies what benchmarks measure, and broadens error identification to reduce blind spots. This helps developers debug models, aligns benchmark goals with outcomes, and supports informed model selection. ErrorMap works on any model or dataset with the same logic. Applying our method to 35 datasets and 83 models we generate ErrorAtlas, a taxonomy of model errors, revealing recurring failure patterns. ErrorAtlas highlights error types that are currently underexplored in LLM research, such as omissions of required details in the output and question misinterpretation. By shifting focus from where models succeed to why they fail, ErrorMap and ErrorAtlas enable advanced evaluation - one that exposes hidden weaknesses and directs progress. Unlike success, typically measured by task-level metrics, our approach introduces a deeper evaluation layer that can be applied globally across models and tasks, offering richer insights into model behavior and limitations. We make the taxonomy and code publicly available with plans to periodically update ErrorAtlas as new benchmarks and models emerge.
>
---
#### [new 051] Evaluating and Achieving Controllable Code Completion in Code LLM
- **分类: cs.SE; cs.CL**

- **简介: 该论文属于代码补全任务，旨在解决LLM在代码补全中指令跟随能力不足的问题。提出C3-Bench基准，评估并提升模型的指令可控性。**

- **链接: [https://arxiv.org/pdf/2601.15879v1](https://arxiv.org/pdf/2601.15879v1)**

> **作者:** Jiajun Zhang; Zeyu Cui; Lei Zhang; Jian Yang; Jiaxi Yang; Qiang Liu; Zilei Wang; Binyuan Hui; Liang Wang; Junyang Lin
>
> **摘要:** Code completion has become a central task, gaining significant attention with the rise of large language model (LLM)-based tools in software engineering. Although recent advances have greatly improved LLMs' code completion abilities, evaluation methods have not advanced equally. Most current benchmarks focus solely on functional correctness of code completions based on given context, overlooking models' ability to follow user instructions during completion-a common scenario in LLM-assisted programming. To address this limitation, we present the first instruction-guided code completion benchmark, Controllable Code Completion Benchmark (C3-Bench), comprising 2,195 carefully designed completion tasks. Through comprehensive evaluation of over 40 mainstream LLMs across C3-Bench and conventional benchmarks, we reveal substantial gaps in instruction-following capabilities between open-source and advanced proprietary models during code completion tasks. Moreover, we develop a straightforward data synthesis pipeline that leverages Qwen2.5-Coder to generate high-quality instruction-completion pairs for supervised fine-tuning (SFT). The resulting model, Qwen2.5-Coder-C3, achieves state-of-the-art performance on C3-Bench. Our findings provide valuable insights for enhancing LLMs' code completion and instruction-following capabilities, establishing new directions for future research in code LLMs. To facilitate reproducibility and foster further research in code LLMs, we open-source all code, datasets, and models.
>
---
#### [new 052] LLM Prompt Evaluation for Educational Applications
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于教育技术领域，旨在解决LLM提示设计与评估问题。通过系统方法比较不同提示模板，提升教育应用中生成内容的质量与适配性。**

- **链接: [https://arxiv.org/pdf/2601.16134v1](https://arxiv.org/pdf/2601.16134v1)**
...
>
---
#### [new 065] Knowledge Graphs are Implicit Reward Models: Path-Derived Signals Enable Compositional Reasoning
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于科学推理任务，旨在提升模型在复杂多步推理中的表现。通过结合知识图谱与强化学习，生成组合性奖励信号，增强模型的推理能力。**

- **链接: [https://arxiv.org/pdf/2601.15160v1](https://arxiv.org/pdf/2601.15160v1)**
...
>
---
#### [new 066] CURE: Curriculum-guided Multi-task Training for Reliable Anatomy Grounded Report Generation
...
>
---
#### [new 069] Towards Automated Kernel Generation in the Era of LLMs
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自动化内核生成任务，旨在解决人工编写高效内核耗时且难以扩展的问题。通过分析LLM和代理系统在内核优化中的应用，梳理现有方法与数据集，提出未来研究方向。**

- **链接: [https://arxiv.org/pdf/2601.15727v1](https://arxiv.org/pdf/2601.15727v1)**
...
>
---
#### [new 070] PRISM: Deriving the Transformer as a Signal-Denoising Operator via Maximum Coding Rate Reduction
- **分类: cs.LG; cs.AI; cs.CL; physics.data-an**

- **简介: 该论文提出Prism模型，通过最大编码率缩减原理构建可解释的Transformer架构，解决模型不可解释性问题，通过几何约束实现功能解耦。**

- **链接: [https://arxiv.org/pdf/2601.15540v1](https://arxiv.org/pdf/2601.15540v1)**
...
>
---
#### [new 071] LLM or Human? Perceptions of Trust and Information Quality in Research Summaries
- **分类: cs.CY; cs.CL**

- **简介: 该论文属于人工智能与学术写作交叉研究，探讨读者对LLM生成摘要的信任与质量评价。通过实验分析读者识别能力及态度影响，揭示AI辅助写作的接受度与规范问题。**

- **链接: [https://arxiv.org/pdf/2601.15556v1](https://arxiv.org/pdf/2601.15556v1)**
...
>
---
#### [new 075] Controlling Long-Horizon Behavior in Language Model Agents with Explicit State Dynamics
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于对话系统任务，旨在解决语言模型代理在长对话中行为不连贯的问题。通过引入显式情感状态动态机制，提升对话的连贯性与恢复能力。**

- **链接: [https://arxiv.org/pdf/2601.16087v1](https://arxiv.org/pdf/2601.16087v1)**
...
>
---
#### [replaced 002] Vision-Language Models Align with Human Neural Representations in Concept Processing
- **分类: cs.CL**

- **简介: 该论文属于视觉-语言模型研究任务，旨在探讨VLMs与人类神经表征的对齐程度。通过实验分析不同架构的VLMs在概念处理中的表现，验证其是否能模仿人类大脑的多模态信息处理机制。**

- **链接: [https://arxiv.org/pdf/2407.17914v3](https://arxiv.org/pdf/2407.17914v3)**
...
>
---
#### [replaced 003] AtomWorld: A Benchmark for Evaluating Spatial Reasoning in Large Language Models on Crystalline Materials
- **分类: cond-mat.mtrl-sci; cs.AI; cs.CL**

- **简介: 该论文提出AtomWorld基准，用于评估大语言模型在晶体材料空间推理任务中的表现。旨在解决模型在结构理解和空间推理上的不足，推动材料研究的自动化发展。**

- **链接: [https://arxiv.org/pdf/2510.04704v3](https://arxiv.org/pdf/2510.04704v3)**
...
>
---
#### [replaced 004] RADLADS: Rapid Attention Distillation to Linear Attention Decoders at Scale
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出RADLADS，将softmax注意力Transformer快速转换为线性注意力解码器模型，解决高效部署大模型的问题。**

- **链接: [https://arxiv.org/pdf/2505.03005v4](https://arxiv.org/pdf/2505.03005v4)**
...
>
---
#### [replaced 007] SCALAR: Scientific Citation-based Live Assessment of Long-context Academic Reasoning
- **分类: cs.CL**

- **简介: 该论文提出SCALAR，用于评估学术写作中的引用基础长文本推理能力。针对长文本理解评估困难的问题，设计了两个任务，无需人工标注即可生成高质量标签，推动模型在该领域的进步。**

- **链接: [https://arxiv.org/pdf/2502.13753v2](https://arxiv.org/pdf/2502.13753v2)**

> **作者:** Renxi Wang; Honglin Mu; Liqun Ma; Lizhi Lin; Yunlong Feng; Timothy Baldwin; Xudong Han; Haonan Li
>
> **摘要:** Long-context understanding has emerged as a critical capability for large language models (LLMs). However, evaluating this ability remains challenging. We present SCALAR, a benchmark designed to assess citation-grounded long-context reasoning in academic writing. SCALAR leverages academic papers and their citation structure to automatically generate high-quality ground-truth labels without human annotation. It features controllable difficulty levels and a dynamic updating mechanism that mitigates data contamination. The benchmark includes two tasks: a multiple-choice QA format and a cloze-style citation prediction. We evaluate a range of state-of-the-art LLMs and find that the multiple-choice task effectively distinguishes model capabilities. While human experts achieve over 90% accuracy, most models struggle. The cloze-style task is even more challenging, with no model exceeding 50% accuracy. SCALAR provides a domain-grounded, continuously updating framework for tracking progress in citation-based long-context understanding.
>
---
#### [replaced 008] Everybody Prune Now: Structured Pruning of LLMs with only Forward Passes
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于模型压缩任务，旨在解决传统结构化剪枝依赖反向传播导致的高内存和计算成本问题。提出Bonsai方法，通过仅前向传播实现高效剪枝。**

- **链接: [https://arxiv.org/pdf/2402.05406v4](https://arxiv.org/pdf/2402.05406v4)**
...
>
---
#### [replaced 010] SPOT: An Annotated French Corpus and Benchmark for Detecting Critical Interventions in Online Conversations
- **分类: cs.CL; cs.CY**

- **简介: 该论文提出SPOT任务，旨在检测在线对话中的关键干预。通过构建法语标注语料库，解决非英语社交媒体中监督学习的挑战。**

- **链接: [https://arxiv.org/pdf/2511.07405v3](https://arxiv.org/pdf/2511.07405v3)**
...
>
---
#### [replaced 011] Gaming the Judge: Unfaithful Chain-of-Thought Can Undermine Agent Evaluation
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于AI评估任务，揭示LLM judges易受agent推理欺骗的问题。通过操纵推理过程，发现可显著提升误判率，提出验证推理证据的必要性。**

- **链接: [https://arxiv.org/pdf/2601.14691v2](https://arxiv.org/pdf/2601.14691v2)**
...
>
---
#### [replaced 012] From Interpretability to Performance: Optimizing Retrieval Heads for Long-Context Language Models
- **分类: cs.CL**

- **简介: 该论文属于语言模型优化任务，旨在提升长文本处理能力。通过设计RetMask方法，利用检索头增强模型性能，验证了机制理解对模型改进的有效性。**

- **链接: [https://arxiv.org/pdf/2601.11020v2](https://arxiv.org/pdf/2601.11020v2)**
...
>
---
#### [replaced 013] Knowing When to Abstain: Medical LLMs Under Clinical Uncertainty
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗问答任务，旨在解决LLMs在临床不确定性下无法有效 abstain 的问题。通过构建基准和评估协议，验证了显式 abstention 选项的重要性。**

- **链接: [https://arxiv.org/pdf/2601.12471v2](https://arxiv.org/pdf/2601.12471v2)**
...
>
---
#### [replaced 014] The GDN-CC Dataset: Automatic Corpus Clarification for AI-enhanced Democratic Citizen Consultations
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决民主咨询数据的标准化问题。通过构建GDN-CC数据集，研究小模型在观点聚类中的应用效果。**

- **链接: [https://arxiv.org/pdf/2601.14944v2](https://arxiv.org/pdf/2601.14944v2)**
...
>
---
#### [replaced 015] Advances in LLMs with Focus on Reasoning, Adaptability, Efficiency and Ethics
- **分类: cs.CL; cs.DB**

- **简介: 该论文属于综述任务，旨在总结LLMs在推理、适应性、效率和伦理方面的进展，解决模型性能与应用限制问题，分析关键技术与未来方向。**

- **链接: [https://arxiv.org/pdf/2506.12365v3](https://arxiv.org/pdf/2506.12365v3)**
...
>
---
#### [replaced 018] BayesianVLA: Bayesian Decomposition of Vision Language Action Models via Latent Action Queries
...
>
---
#### [replaced 019] Monadic Context Engineering
- **分类: cs.AI; cs.CL; cs.FL**

- **简介: 该论文提出Monadic Context Engineering（MCE），解决AI代理架构的复杂性问题，通过函数式编程结构提升系统稳定性与可扩展性。**

- **链接: [https://arxiv.org/pdf/2512.22431v5](https://arxiv.org/pdf/2512.22431v5)**
...
>
> **备注:** 5 Pages, This is the author's version of the work. It is posted here by permission of the AAAS for personal use, not for redistribution. The definitive version was published in Science on January 22, 2026, DOI: 10.1126/science.adz1697
>
...
>
---
#### [replaced 028] Spectral Generative Flow Models: A Physics-Inspired Replacement for Vectorized Large Language Models
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出SGFMs，用于生成任务，解决传统模型的局部性与缺乏物理结构问题，通过物理启发的连续场建模实现更高效、连贯的生成。**

- **链接: [https://arxiv.org/pdf/2601.08893v2](https://arxiv.org/pdf/2601.08893v2)**
...
>
---
#### [replaced 029] ConlangCrafter: Constructing Languages with a Multi-Hop LLM Pipeline
- **分类: cs.CL**

- **简介: 该论文提出ConlangCrafter，用于自动化构建人工语言。任务是实现无需语言学知识的高效、多样化语言生成。工作包括设计多阶段LLM流水线，提升语言一致性和多样性。**

- **链接: [https://arxiv.org/pdf/2508.06094v3](https://arxiv.org/pdf/2508.06094v3)**
...
- **简介: 该论文提出DocPolarBERT，用于文档理解任务，解决传统模型依赖绝对坐标的问题，通过相对极坐标注意力机制提升效果。**

- **链接: [https://arxiv.org/pdf/2507.08606v4](https://arxiv.org/pdf/2507.08606v4)**
...
>
---
#### [replaced 032] Beyond Tokens: Concept-Level Training Objectives for LLMs
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决传统token级训练目标导致模型偏向表面形式的问题。通过引入概念级预测，提升模型对语义的理解与泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.11791v2](https://arxiv.org/pdf/2601.11791v2)**
...
>
---
#### [replaced 033] LLMs Got Rhythm? Hybrid Phonological Filtering for Greek Poetry Rhyme Detection and Generation
- **分类: cs.CL**

- **简介: 论文研究希腊诗歌押韵检测与生成任务，针对LLMs在语音现象上的不足，提出混合系统结合语言模型与音系算法，提升押韵准确性。**

- **链接: [https://arxiv.org/pdf/2601.09631v3](https://arxiv.org/pdf/2601.09631v3)**
...
>
---
#### [replaced 036] GENERator: A Long-Context Generative Genomic Foundation Model
- **分类: cs.CL; q-bio.GN**

- **简介: 该论文提出GENERator，一个用于长片段DNA建模的生成基因组基础模型，解决基因组功能解释和序列设计问题，具备高效生成能力和跨物种应用。**

- **链接: [https://arxiv.org/pdf/2502.07272v4](https://arxiv.org/pdf/2502.07272v4)**
...
>
---
#### [replaced 037] I-MCTS: Enhancing Agentic AutoML via Introspective Monte Carlo Tree Search
- **分类: cs.CL**

- **简介: 该论文属于AutoML任务，旨在解决LLM生成代码多样性低和质量差的问题。提出I-MCTS方法，通过自我反思和LLM评估提升搜索效率与效果。**

- **链接: [https://arxiv.org/pdf/2502.14693v4](https://arxiv.org/pdf/2502.14693v4)**
...
>
---
#### [replaced 038] Who Benefits From Sinus Surgery? Comparing Generative AI and Supervised Machine Learning for Predicting Surgical Outcomes in Chronic Rhinosinusitis
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于医疗决策支持任务，旨在预测慢性鼻窦炎手术效果。通过比较生成式AI与监督学习模型，评估其在术前预测患者术后改善情况的能力，以优化手术选择。**

- **链接: [https://arxiv.org/pdf/2601.13710v2](https://arxiv.org/pdf/2601.13710v2)**
...
>
---
#### [replaced 039] SciArena: An Open Evaluation Platform for Non-Verifiable Scientific Literature-Grounded Tasks
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出SciArena平台，用于评估基础模型在科学文献相关任务中的表现，解决模型评价缺乏社区参与的问题，通过集体智慧进行模型对比与排名。**

- **链接: [https://arxiv.org/pdf/2507.01001v2](https://arxiv.org/pdf/2507.01001v2)**

> **作者:** Yilun Zhao; Kaiyan Zhang; Tiansheng Hu; Sihong Wu; Ronan Le Bras; Charles McGrady; Taira Anderson; Jonathan Bragg; Joseph Chee Chang; Jesse Dodge; Matt Latzke; Yixin Liu; Xiangru Tang; Zihang Wang; Chen Zhao; Hannaneh Hajishirzi; Doug Downey; Arman Cohan
>
> **备注:** NeurIPS 2025 Datasets & Benchmarks Track (Spotlight)
>
> **摘要:** We present SciArena, an open and collaborative platform for evaluating foundation models on scientific literature-grounded tasks. Unlike traditional benchmarks for scientific literature understanding and synthesis, SciArena engages the research community directly, following the Chatbot Arena evaluation approach of community voting on model comparisons. By leveraging collective intelligence, SciArena offers a community-driven evaluation of model performance on open-ended scientific tasks that demand literature-grounded, long-form responses. The platform currently supports 47 foundation models and has collected over 20,000 votes from human researchers across diverse scientific domains. Our analysis of the data collected so far confirms its high quality. We discuss the results and insights based on the model ranking leaderboard. To further promote research in building model-based automated evaluation systems for literature tasks, we release SciArena-Eval, a meta-evaluation benchmark based on collected preference data. It measures the accuracy of models in judging answer quality by comparing their pairwise assessments with human votes. Our experiments highlight the benchmark's challenges and emphasize the need for more reliable automated evaluation methods.
>
---
#### [replaced 040] Do You Feel Comfortable? Detecting Hidden Conversational Escalation in AI Chatbots
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于对话系统任务，旨在解决AI聊天机器人中隐性情绪升级的检测问题。提出GAUGE框架，实时识别对话中的情感变化。**

- **链接: [https://arxiv.org/pdf/2512.06193v4](https://arxiv.org/pdf/2512.06193v4)**
...
>
---
#### [replaced 041] Collaborate, Deliberate, Evaluate: How LLM Alignment Affects Coordinated Multi-Agent Outcomes
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究LLM对齐方法如何影响多智能体协作效果，旨在解决多轮多方协作中的协调问题。通过角色扮演模拟，评估不同对齐策略在协作任务中的表现。**

- **链接: [https://arxiv.org/pdf/2509.05882v2](https://arxiv.org/pdf/2509.05882v2)**
...
>
---
#### [replaced 045] Refusal Steering: Fine-grained Control over LLM Refusal Behaviour for Sensitive Topics
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型控制任务，解决敏感话题拒绝行为的精细调控问题。通过引入LLM-as-a-judge和正则化方法，实现对模型拒绝行为的精准调节。**

- **链接: [https://arxiv.org/pdf/2512.16602v2](https://arxiv.org/pdf/2512.16602v2)**
...
>
---
#### [replaced 046] English K_Quantization of LLMs Does Not Disproportionately Diminish Multilingual Performance
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于模型量化任务，研究量化是否影响多语言性能。通过不同语言的重要性矩阵量化模型，并在多语言数据集上测试，结果表明量化未显著损害多语言表现。**

- **链接: [https://arxiv.org/pdf/2503.03592v4](https://arxiv.org/pdf/2503.03592v4)**

> **作者:** Karl Audun Borgersen; Morten Goodwin
>
> **备注:** 8 pages, 6 figures, v2
>
> **摘要:** For consumer usage of locally deployed LLMs, the GGUF format and k\_quantization are invaluable tools for maintaining the performance of the original model while reducing it to sizes deployable with consumer-grade hardware. The number of bits dedicated to each weight from the original model is reduced based on how important they are thought to be during model inference. This importance is arrived at through the application of an 'importance matrix'-a relatively small text document meant to be representative of the LLM's standard use-cases. In the vast majority of quants available online, this document is primarily written in English. It was therefore an open question whether performance on English language tasks was preserved through the sacrifice of multilingual performance and whether it can be preserved with alternate importance matrices. This article investigates these hypotheses by quantizing Llama3.3 70B on importance matrices written in three languages (English, Norwegian, and Malayalam) and evaluating them on the MixEval dataset in both English and Norwegian. All experiments related to yielded non-significant results indicating that current quantization practices do not disproportionately harm multilingual performance.
>
---
#### [replaced 047] Sense and Sensitivity: Examining the Influence of Semantic Recall on Long Context Code Reasoning
- **分类: cs.CL; cs.LG; cs.SE**

- **简介: 该论文研究代码理解任务，探讨大语言模型是否依赖语义回忆而非模式匹配。通过新任务SemTrace揭示模型在长上下文中的语义回忆缺陷。**

- **链接: [https://arxiv.org/pdf/2505.13353v3](https://arxiv.org/pdf/2505.13353v3)**
...
>
---
#### [replaced 048] Generalization to Political Beliefs from Fine-Tuning on Sports Team Preferences
- **分类: physics.soc-ph; cs.CL**

- **简介: 该论文研究模型微调后行为的泛化问题，探讨在体育团队偏好数据上微调的LLM是否会产生政治信念变化。任务属于模型行为泛化分析，旨在理解微调对模型输出的影响。**

- **链接: [https://arxiv.org/pdf/2601.04369v3](https://arxiv.org/pdf/2601.04369v3)**
...
>
---
#### [replaced 049] Can Language Models Discover Scaling Laws?
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于科学发现任务，旨在解决自动发现模型性能缩放规律的问题。通过构建实验数据集并提出SLDAgent，实现更准确的缩放定律自动发现。**

- **链接: [https://arxiv.org/pdf/2507.21184v5](https://arxiv.org/pdf/2507.21184v5)**

> **作者:** Haowei Lin; Haotian Ye; Wenzheng Feng; Quzhe Huang; Yujun Li; Hubert Lim; Zhengrui Li; Xiangyu Wang; Jianzhu Ma; Yitao Liang; James Zou
>
...
>
---
#### [replaced 050] NLP for Social Good: A Survey and Outlook of Challenges, Opportunities, and Responsible Deployment
- **分类: cs.CL; cs.CY**

- **简介: 该论文属于NLP应用研究，旨在探讨NLP在社会公益中的潜力。分析了九个领域的工作，指出研究不均衡，呼吁跨学科合作与负责任的部署。**

- **链接: [https://arxiv.org/pdf/2505.22327v2](https://arxiv.org/pdf/2505.22327v2)**
...
>
---
#### [replaced 052] R-KV: Redundancy-aware KV Cache Compression for Reasoning Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于模型推理优化任务，解决推理模型中KV缓存过大的问题。提出R-KV方法，通过感知冗余token，显著减少KV缓存占用并提升性能。**

- **链接: [https://arxiv.org/pdf/2505.24133v4](https://arxiv.org/pdf/2505.24133v4)**
...
>
---
#### [replaced 053] Locate, Steer, and Improve: A Practical Survey of Actionable Mechanistic Interpretability in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于模型解释任务，旨在解决LLM决策不透明问题。提出“定位、引导、优化”框架，实现可操作的模型干预与优化。**

- **链接: [https://arxiv.org/pdf/2601.14004v2](https://arxiv.org/pdf/2601.14004v2)**
...
>
---
#### [replaced 054] Competitive Audio-Language Models with Data-Efficient Single-Stage Training on Public Data
...
>
---
#### [replaced 055] FLEx: Language Modeling with Few-shot Language Explanations
- **分类: cs.CL; cs.LG**

- **简介: 该论文提出FLEx方法，用于通过少量语言解释提升语言模型性能。解决模型错误重复问题，通过聚类选择错误示例并生成纠正提示。属于模型优化任务。**

- **链接: [https://arxiv.org/pdf/2601.04157v2](https://arxiv.org/pdf/2601.04157v2)**
...
>
---
#### [replaced 056] GutenOCR: A Grounded Vision-Language Front-End for Documents
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [replaced 057] EfficientXpert: Efficient Domain Adaptation for Large Language Models via Propagation-Aware Pruning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于模型压缩任务，旨在解决大语言模型在领域适应中的效率问题。提出EfficientXpert框架，通过剪枝和低秩适配器实现高效领域适应。**

- **链接: [https://arxiv.org/pdf/2511.19935v2](https://arxiv.org/pdf/2511.19935v2)**

> **作者:** Songlin Zhao; Michael Pitts; Zhuwei Qin
>
> **摘要:** Large language models (LLMs) are increasingly adapted into domain-specific variants for applications in law, healthcare, and finance. Their scale, however, limits deployment in resource-constrained settings, and existing compression approaches often either degrade after domain adaptation or require substantial additional computation. We introduce EfficientXpert, a lightweight framework for domain pruning that integrates ForeSight Mask, a propagation-aware criterion for selecting weights to prune without backpropagation, and Partial Brain Surgeon, an efficient closed-form update for low-rank adapters under a fixed sparsity pattern. With fine-tuning cost comparable to standard LoRA, EfficientXpert converts a general pretrained model into a sparse, domain-adapted expert in a single pruning step. Across health and legal benchmarks, EfficientXpert reaches up to 98 percent of dense performance at 40 percent sparsity, improving over prior pruning baselines while matching LoRA training time and staying within 1 percent of LoRA peak GPU memory in our experiments.
>
---
#### [replaced 058] MEDAL: A Framework for Benchmarking LLMs as Multilingual Open-Domain Dialogue Evaluators
- **分类: cs.CL**

- **简介: 该论文属于对话评估任务，旨在解决现有评估基准静态、单一的问题。通过构建多语言对话评估框架MEDAL，生成多样化对话并进行多维分析，发现先进模型在情感、常识等细节上的评估不足。**

- **链接: [https://arxiv.org/pdf/2505.22777v5](https://arxiv.org/pdf/2505.22777v5)**
...
>
---
#### [replaced 059] Four Over Six: More Accurate NVFP4 Quantization with Adaptive Block Scaling
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于模型量化任务，旨在解决NVFP4量化精度不足导致性能下降的问题。提出Four Over Six方法，通过自适应块缩放减少量化误差，提升模型训练效果。**

- **链接: [https://arxiv.org/pdf/2512.02010v3](https://arxiv.org/pdf/2512.02010v3)**
...
>
---
#### [replaced 060] MMSU: A Massive Multi-task Spoken Language Understanding and Reasoning Benchmark
...
>
---
#### [replaced 061] Codebook-Injected Dialogue Segmentation for Multi-Utterance Constructs Annotation: LLM-Assisted and Gold-Label-Free Evaluation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于对话分割任务，旨在解决标注不一致问题。通过引入代码本方法，提升段落一致性，评估LLM与基线模型效果。**

- **链接: [https://arxiv.org/pdf/2601.12061v2](https://arxiv.org/pdf/2601.12061v2)**

> **作者:** Jinsook Lee; Kirk Vanacore; Zhuqian Zhou; Bakhtawar Ahtisham; Jeanine Grutter; Rene F. Kizilcec
>
...
>
---
#### [replaced 062] Mechanism Shift During Post-training from Autoregressive to Masked Diffusion Language Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究从自回归模型到掩码扩散模型的后训练机制变化，旨在解决模型是否真正获得双向推理能力的问题。通过电路分析，发现模型在结构和语义上发生显著转变。**

- **链接: [https://arxiv.org/pdf/2601.14758v2](https://arxiv.org/pdf/2601.14758v2)**
