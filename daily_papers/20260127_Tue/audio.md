...
#### [new 001] Geneses: Unified Generative Speech Enhancement and Separation
- **分类: cs.SD; eess.AS**

- **简介: 该论文属于语音增强与分离任务，旨在解决多说话人及复杂降噪问题。提出Geneses框架，通过生成方法实现高质量的语音增强与分离。**

- **链接: [https://arxiv.org/pdf/2601.18456v1](https://arxiv.org/pdf/2601.18456v1)**
...
>
---
#### [new 002] Recovering Performance in Speech Emotion Recognition from Discrete Tokens via Multi-Layer Fusion and Paralinguistic Feature Integration
- **分类: eess.AS; cs.LG; cs.SD**

- **简介: 该论文属于语音情感识别任务，解决离散语音标记在量化过程中丢失韵律信息的问题。通过多层融合和声学特征整合，提升离散标记的性能。**

- **链接: [https://arxiv.org/pdf/2601.17085v1](https://arxiv.org/pdf/2601.17085v1)**
...
>
---
#### [new 003] From Human Speech to Ocean Signals: Transferring Speech Large Models for Underwater Acoustic Target Recognition
- **分类: cs.SD; eess.AS**

- **简介: 该论文属于 underwater acoustic target recognition 任务，旨在解决数据少、环境复杂的问题。通过迁移 speech large models，提出 UATR-SLM 框架，实现高效目标识别。**

- **链接: [https://arxiv.org/pdf/2601.18086v1](https://arxiv.org/pdf/2601.18086v1)**
...
>
---
#### [new 004] ToS: A Team of Specialists ensemble framework for Stereo Sound Event Localization and Detection with distance estimation in Video
- **分类: eess.AS; cs.LG; cs.SD; eess.IV; eess.SP**

- **简介: 该论文属于3D声源定位与检测任务，解决视频中声音事件的时空定位及距离估计问题。提出ToS框架，集成三个子网络协同工作，提升性能。**

- **链接: [https://arxiv.org/pdf/2601.17611v1](https://arxiv.org/pdf/2601.17611v1)**
...
>
---
#### [new 005] AmbER$^2$: Dual Ambiguity-Aware Emotion Recognition Applied to Speech and Text
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于情感识别任务，旨在解决情绪识别中的标注和模态歧义问题。提出AmbER$^2$框架，同时建模标注和模态层面的不确定性，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.18010v1](https://arxiv.org/pdf/2601.18010v1)**
...
>
---
#### [new 006] Audio Inpainting in Time-Frequency Domain with Phase-Aware Prior
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于音频修复任务，解决时间-频率域缺失谱列的重建问题。提出基于相位感知先验的方法，优化求解并优于现有方法。**

- **链接: [https://arxiv.org/pdf/2601.18535v1](https://arxiv.org/pdf/2601.18535v1)**
...
>
---
#### [new 007] BickGraphing: Web-Based Application for Visual Inspection of Audio Recordings
- **分类: eess.AS; cs.SD**

- **简介: 该论文介绍BickGraphing，一个用于音频可视化研究的网页工具，解决音频数据直观分析问题，支持波形和频谱查看及交互探索。**

- **链接: [https://arxiv.org/pdf/2601.17014v1](https://arxiv.org/pdf/2601.17014v1)**
...
>
---
#### [new 008] UrgentMOS: Unified Multi-Metric and Preference Learning for Robust Speech Quality Assessment
- **分类: cs.SD**

- **简介: 该论文提出UrgentMOS，用于语音质量评估任务，解决传统方法依赖稀缺MOS数据的问题，通过多指标学习和偏好建模提升模型鲁棒性和泛化能力。**

- **链接: [https://arxiv.org/pdf/2601.18438v1](https://arxiv.org/pdf/2601.18438v1)**
...
>
---
#### [new 009] End-to-End Joint ASR and Speaker Role Diarization with Child-Adult Interactions
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于语音识别与说话人角色分割任务，解决儿童与成人对话的自动转录和角色标注问题。通过统一的端到端框架，提升准确性和效率。**

- **链接: [https://arxiv.org/pdf/2601.17640v1](https://arxiv.org/pdf/2601.17640v1)**
...
>
---
#### [new 010] Window Size Versus Accuracy Experiments in Voice Activity Detectors
...
>
---
#### [new 011] PC-MCL: Patient-Consistent Multi-Cycle Learning with multi-label bias correction for respiratory sound classification
- **分类: eess.AS; cs.AI; cs.LG; cs.SD**

- **简介: 该论文属于呼吸音分类任务，解决患者特异性过拟合和多标签分布偏差问题。提出PC-MCL方法，通过多周期拼接、三标签公式和患者匹配任务提升分类性能。**

- **链接: [https://arxiv.org/pdf/2601.17080v1](https://arxiv.org/pdf/2601.17080v1)**
...
>
---
#### [new 012] OCR-Enhanced Multimodal ASR Can Read While Listening
- **分类: cs.SD; cs.CL; eess.AS**
...
>
---
#### [new 013] The Voice of Equity: A Systematic Evaluation of Bias Mitigation Techniques for Speech-Based Cognitive Impairment Detection Across Architectures and Demographics
...
>
---
#### [new 014] EuleroDec: A Complex-Valued RVQ-VAE for Efficient and Robust Audio Coding
- **分类: cs.SD; cs.LG; eess.AS**

- **简介: 该论文属于音频编码任务，解决相位建模不足的问题。提出一种复值RVQ-VAE模型，保留幅度与相位耦合，提升编码效率和音质。**

- **链接: [https://arxiv.org/pdf/2601.17517v1](https://arxiv.org/pdf/2601.17517v1)**
...
>
---
#### [new 015] OneVoice: One Model, Triple Scenarios-Towards Unified Zero-shot Voice Conversion
- **分类: eess.AS; cs.SD**

- **简介: 该论文提出OneVoice，解决语音转换任务中多场景模型分散的问题，通过统一模型实现语言保留、表达和歌唱场景的零样本转换。**

- **链接: [https://arxiv.org/pdf/2601.18094v1](https://arxiv.org/pdf/2601.18094v1)**
...
>
---
#### [new 016] Learning to Discover: A Generalized Framework for Raga Identification without Forgetting
- **分类: eess.AS; cs.LG**

- **简介: 该论文属于音乐识别任务，旨在解决印度古典音乐中稀有拉格识别问题。针对传统模型遗忘已知拉格的问题，提出一种新框架，结合有标签和无标签音频，实现对未知拉格的发现与分类。**

- **链接: [https://arxiv.org/pdf/2601.18766v1](https://arxiv.org/pdf/2601.18766v1)**
...
>
---
#### [new 017] Spoofing-Aware Speaker Verification via Wavelet Prompt Tuning and Multi-Model Ensembles
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于语音安全任务，旨在防范生成式欺骗攻击。提出一种结合小波提示微调和多模型集成的说话人验证框架，提升音频真实性和身份验证的鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.17557v1](https://arxiv.org/pdf/2601.17557v1)**
...
>
---
#### [new 018] AVMeme Exam: A Multimodal Multilingual Multicultural Benchmark for LLMs' Contextual and Cultural Knowledge and Thinking
...
>
---
#### [new 019] Speech Emotion Recognition with ASR Integration
- **分类: eess.AS; cs.SD**

- **简介: 论文属于语音情感识别任务，旨在解决真实场景下情感识别的挑战。通过整合自动语音识别技术，提升情感识别的鲁棒性和实用性。**

- **链接: [https://arxiv.org/pdf/2601.17901v1](https://arxiv.org/pdf/2601.17901v1)**
...
>
---
#### [new 020] A Dataset for Automatic Vocal Mode Classification
- **分类: cs.SD; cs.LG**

- **简介: 该论文属于语音模式分类任务，旨在解决自动识别歌唱声音模式的问题。研究者构建了一个包含3,752个样本的新型数据集，并提供了基准分类结果。**

- **链接: [https://arxiv.org/pdf/2601.18339v1](https://arxiv.org/pdf/2601.18339v1)**
...
>
---
#### [new 021] dLLM-ASR: A Faster Diffusion LLM-based Framework for Speech Recognition
- **分类: cs.SD; eess.AS**

- **简介: 该论文属于语音识别任务，解决传统LLM-ASR推理慢的问题。提出dLLM-ASR框架，通过自适应去噪和长度感知剪枝提升效率。**

- **链接: [https://arxiv.org/pdf/2601.17902v1](https://arxiv.org/pdf/2601.17902v1)**
...
>
---
#### [new 022] Sink or SWIM: Tackling Real-Time ASR at Scale
- **分类: cs.SD; eess.AS**

- **简介: 该论文提出SWIM系统，解决多用户实时语音识别的扩展性问题。基于Whisper模型，实现高效并行处理，提升多语言、多客户端场景下的准确率与响应速度。**

- **链接: [https://arxiv.org/pdf/2601.17097v1](https://arxiv.org/pdf/2601.17097v1)**
...
>
---
#### [new 023] Neural Multi-Speaker Voice Cloning for Nepali in Low-Resource Settings
- **分类: cs.SD; cs.AI**

- **简介: 该论文属于语音克隆任务，旨在解决 Nepali 语言低资源环境下少样本语音合成问题。通过构建数据集并结合编码器与合成模型，实现高效语音克隆。**

- **链接: [https://arxiv.org/pdf/2601.18694v1](https://arxiv.org/pdf/2601.18694v1)**
...
>
---
#### [new 024] Analytic Incremental Learning For Sound Source Localization With Imbalance Rectification
- **分类: cs.SD; cs.AI**

- **简介: 该论文属于声源定位任务，解决因分布不平衡导致的灾难性遗忘问题。提出GDA和ADIR方法，提升定位精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.18335v1](https://arxiv.org/pdf/2601.18335v1)**
...
>
---
#### [new 025] BanglaRobustNet: A Hybrid Denoising-Attention Architecture for Robust Bangla Speech Recognition
...
>
---
#### [new 026] Efficient Rehearsal for Continual Learning in ASR via Singular Value Tuning
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于自动语音识别（ASR）中的持续学习任务，旨在解决模型在适应新任务时的灾难性遗忘问题。通过SVD调整参数，实现小内存下的高效重放，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.18266v1](https://arxiv.org/pdf/2601.18266v1)**
...
>
---
#### [new 027] SpatialEmb: Extract and Encode Spatial Information for 1-Stage Multi-channel Multi-speaker ASR on Arbitrary Microphone Arrays
- **分类: eess.AS; cs.AI; cs.SD**

- **简介: 该论文属于多说话人语音识别任务，解决传统系统效率低、性能差的问题。提出SpatialEmb模块，直接编码空间信息，提升识别效果。**

- **链接: [https://arxiv.org/pdf/2601.18037v1](https://arxiv.org/pdf/2601.18037v1)**
...
>
---
#### [new 028] SonoEdit: Null-Space Constrained Knowledge Editing for Pronunciation Correction in LLM-Based TTS
- **分类: cs.SD; cs.AI; eess.AS**

- **简介: 该论文属于语音合成任务，解决低资源专有名词发音错误问题。提出SonoEdit方法，在不重新训练模型的情况下，通过参数调整修正特定词汇发音。**

- **链接: [https://arxiv.org/pdf/2601.17086v1](https://arxiv.org/pdf/2601.17086v1)**
...
>
---
#### [new 029] LLM-ForcedAligner: A Non-Autoregressive and Accurate LLM-Based Forced Aligner for Multilingual and Long-Form Speech
- **分类: cs.SD; eess.AS**

- **简介: 该论文提出LLM-ForcedAligner，解决多语言和长语音的强制对齐问题。通过将对齐任务转化为槽位填充，提升准确性和效率。**

- **链接: [https://arxiv.org/pdf/2601.18220v1](https://arxiv.org/pdf/2601.18220v1)**
...
>
---
#### [new 030] Segment Length Matters: A Study of Segment Lengths on Audio Fingerprinting Performance
- **分类: cs.SD; cs.AI; cs.IR; cs.LG; eess.AS**

- **简介: 该论文属于音频指纹任务，研究段长对音频检索性能的影响。通过实验分析不同段长效果，发现短段长（0.5秒）表现更优，并评估了LLM推荐段长的能力。**

- **链接: [https://arxiv.org/pdf/2601.17690v1](https://arxiv.org/pdf/2601.17690v1)**
...
>
---
#### [new 031] VIBEVOICE-ASR Technical Report
- **分类: cs.SD; cs.AI; eess.AS**

- **简介: 该论文提出VibeVoice-ASR，解决长音频中上下文碎片化和多说话人复杂性问题。它实现单次处理60分钟音频，统一语音识别、说话人辨识和时间戳生成，支持多语言和代码切换。**

- **链接: [https://arxiv.org/pdf/2601.18184v1](https://arxiv.org/pdf/2601.18184v1)**
...
>
---
#### [new 032] CaSNet: Compress-and-Send Network Based Multi-Device Speech Enhancement Model for Distributed Microphone Arrays
- **分类: cs.SD; cs.AI; eess.AS**

- **简介: 该论文属于语音增强任务，解决分布式麦克风阵列中数据传输成本高的问题。提出CaSNet，通过压缩特征传输，降低带宽和能耗，同时保持性能。**

- **链接: [https://arxiv.org/pdf/2601.17711v1](https://arxiv.org/pdf/2601.17711v1)**
...
>
---
#### [new 033] Noise-Robust AV-ASR Using Visual Features Both in the Whisper Encoder and Decoder
...
>
---
#### [new 034] Residual Learning for Neural Ambisonics Encoders
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于空间音频编码任务，旨在解决紧凑麦克风阵列的高质量声场捕捉问题。通过残差学习框架结合线性编码器与神经网络，提升编码性能。**

- **链接: [https://arxiv.org/pdf/2601.18322v1](https://arxiv.org/pdf/2601.18322v1)**
...
>
---
#### [new 035] Noise-Robust Contrastive Learning with an MFCC-Conformer For Coronary Artery Disease Detection
- **分类: eess.AS; cs.SD**

- **简介: 该论文属于心血管疾病检测任务，旨在提升心音信号中冠状动脉疾病（CAD）检测的噪声鲁棒性。通过多通道噪声段剔除和MFCC-Conformer模型，提高了实际环境下的检测性能。**

- **链接: [https://arxiv.org/pdf/2601.18295v1](https://arxiv.org/pdf/2601.18295v1)**
...
>
---
#### [new 036] 3DGesPolicy: Phoneme-Aware Holistic Co-Speech Gesture Generation Based on Action Control
...
>
---
#### [new 037] Home Health System Deployment Experience for Geriatric Care Remote Monitoring
- **分类: cs.HC; cs.SD; eess.AS; eess.SY**

- **简介: 论文探讨远程老年护理系统的部署，解决老龄化居家照护中的隐私与实时监测问题。基于Geriatric 4Ms框架，优化硬件、建模和界面，开发LLM辅助方案提升用户体验与系统性能。**

- **链接: [https://arxiv.org/pdf/2601.17608v1](https://arxiv.org/pdf/2601.17608v1)**
...
>
---
#### [new 038] Pisets: A Robust Speech Recognition System for Lectures and Interviews
...
>
---
#### [new 039] Reflecting Twice before Speaking with Empathy: Self-Reflective Alternating Inference for Empathy-Aware End-to-End Spoken Dialogue
- **分类: cs.CL; cs.SD**
...
#### [replaced 001] DISPATCH: Distilling Selective Patches for Speech Enhancement
- **分类: cs.SD; eess.AS**

- **简介: 该论文属于语音增强任务，解决知识蒸馏中学生模型学习无效区域的问题。提出DISPatch框架，选择性地在教师优于学生的区域进行蒸馏，提升学生性能。**

- **链接: [https://arxiv.org/pdf/2509.15922v2](https://arxiv.org/pdf/2509.15922v2)**
...
- **简介: 该论文属于音频深度伪造检测任务，旨在解决真实语音生成带来的安全风险。提出XLSR-MamBo框架，结合Mamba与注意力机制，提升检测效果。**

- **链接: [https://arxiv.org/pdf/2601.02944v2](https://arxiv.org/pdf/2601.02944v2)**
...
>
---
#### [replaced 005] FAC-FACodec: Controllable Zero-Shot Foreign Accent Conversion with Factorized Speech Codec
- **分类: cs.SD**

- **简介: 该论文属于语音处理中的外国口音转换任务，旨在解决现有方法无法控制修改强度的问题。通过引入可调节参数，实现更精确的口音转换与说话人身份保护。**

- **链接: [https://arxiv.org/pdf/2510.10785v2](https://arxiv.org/pdf/2510.10785v2)**
...
>
---
#### [replaced 006] TASU: Text-Only Alignment for Speech Understanding
- **分类: eess.AS**

- **简介: 该论文提出TASU，解决Speech LLMs依赖大量音频-文本数据的问题。通过仅使用未配对文本数据实现跨模态对齐，提升语音理解的泛化能力。**

- **链接: [https://arxiv.org/pdf/2511.03310v2](https://arxiv.org/pdf/2511.03310v2)**
...
>
---
#### [replaced 007] How Far Do SSL Speech Models Listen for Tone? Temporal Focus of Tone Representation under Low-resource Transfer
- **分类: eess.AS; cs.CL**
...
>
---
#### [replaced 008] EMORL-TTS: Reinforcement Learning for Fine-Grained Emotion Control in LLM-based TTS
- **分类: cs.SD**

- **简介: 该论文属于语音合成任务，解决LLM-TTS缺乏细粒度情感控制的问题。通过强化学习结合监督微调，实现情感类别、强度和强调的精确控制。**

- **链接: [https://arxiv.org/pdf/2510.05758v2](https://arxiv.org/pdf/2510.05758v2)**
...
>
---
#### [replaced 009] Probing the Hidden Talent of ASR Foundation Models for L2 English Oral Assessment
...
>
---
#### [replaced 010] RRPO: Robust Reward Policy Optimization for LLM-based Emotional TTS
- **分类: cs.SD; cs.AI; eess.AS**

- **简介: 该论文属于情感文本转语音任务，解决奖励欺骗问题。提出RRPO框架，通过混合正则化提升奖励模型的鲁棒性，改善情感表达与自然度。**

- **链接: [https://arxiv.org/pdf/2512.04552v2](https://arxiv.org/pdf/2512.04552v2)**
...
>
---
#### [replaced 011] Sidon: Fast and Robust Open-Source Multilingual Speech Restoration for Large-scale Dataset Cleansing
- **分类: cs.SD; eess.AS**

- **简介: 该论文提出Sidon，一个快速、开源的多语言语音修复模型，用于清理大规模语音数据集。解决噪声语音质量差的问题，通过特征预测和声码器实现高质量语音合成。**

- **链接: [https://arxiv.org/pdf/2509.17052v3](https://arxiv.org/pdf/2509.17052v3)**

> **作者:** Wataru Nakata; Yuki Saito; Yota Ueda; Hiroshi Saruwatari
>
> **备注:** 5 pages, 1 figures, Accepted to ICASSP 2026
>
...
>
---
#### [replaced 012] Mathematical Foundations of Polyphonic Music Generation via Structural Inductive Bias
- **分类: cs.LG; cs.SD; eess.AS**

- **简介: 该论文属于音乐生成任务，解决AI音乐生成中的“缺失中间”问题，通过结构归纳偏置和数学理论提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.03612v2](https://arxiv.org/pdf/2601.03612v2)**
...
>
---
#### [replaced 013] How Does a Deep Neural Network Look at Lexical Stress in English Words?
...
>
---
#### [replaced 014] U3-xi: Pushing the Boundaries of Speaker Recognition via Incorporating Uncertainty
- **分类: cs.SD**

- **简介: 该论文属于说话人识别任务，旨在解决帧级信息不一致导致的嵌入不可靠问题。通过引入不确定性估计和自适应加权，提升说话人嵌入的可靠性与可解释性。**

- **链接: [https://arxiv.org/pdf/2601.15719v2](https://arxiv.org/pdf/2601.15719v2)**
...
>
---
#### [replaced 015] Adaptable Symbolic Music Infilling with MIDI-RWKV
- **分类: cs.SD; cs.LG; cs.MM; eess.AS**

- **简介: 该论文属于音乐生成任务，旨在解决计算机辅助作曲中的风格适应与多轨音乐补全问题。提出MIDI-RWKV模型，实现高效、可控的音乐创作。**

- **链接: [https://arxiv.org/pdf/2506.13001v2](https://arxiv.org/pdf/2506.13001v2)**

> **作者:** Christian Zhou-Zheng; Philippe Pasquier
>
> **备注:** 31 pages, 15 figures, 17 tables
>
...
>
---
#### [replaced 016] SingMOS-Pro: An Comprehensive Benchmark for Singing Quality Assessment
- **分类: cs.SD; cs.AI; eess.AS**

- **简介: 该论文属于歌唱质量评估任务，旨在解决主观评价成本高、客观指标不全面的问题。提出SingMOS-Pro数据集，扩展标注内容，涵盖歌词、旋律等多方面，提升评估多样性与准确性。**

- **链接: [https://arxiv.org/pdf/2510.01812v3](https://arxiv.org/pdf/2510.01812v3)**
...
>
---
#### [replaced 017] MSF-SER: Enriching Acoustic Modeling with Multi-Granularity Semantics for Speech Emotion Recognition
- **分类: cs.SD**

- **简介: 该论文属于语音情感识别任务，旨在解决传统方法忽视语义层次和情感焦点的问题。通过引入多粒度语义融合，提升情感预测效果。**

- **链接: [https://arxiv.org/pdf/2510.05749v2](https://arxiv.org/pdf/2510.05749v2)**
...
>
---
#### [replaced 018] ARTI-6: Towards Six-dimensional Articulatory Speech Encoding
...
>
---
#### [replaced 019] HeartMuLa: A Family of Open Sourced Music Foundation Models
- **分类: cs.SD**

- **简介: 该论文提出HeartMuLa音乐基础模型家族，解决音乐理解与生成任务，涵盖音频文本对齐、歌词识别、音乐编码及歌曲生成，支持多模态应用。**

- **链接: [https://arxiv.org/pdf/2601.10547v2](https://arxiv.org/pdf/2601.10547v2)**
...
>
---
#### [replaced 020] Diffusion-based Frameworks for Unsupervised Speech Enhancement
- **分类: cs.SD**

- **简介: 该论文属于语音增强任务，解决无监督下的单通道语音增强问题。通过改进扩散模型，显式建模语音和噪声，提升增强效果。**

- **链接: [https://arxiv.org/pdf/2601.09931v2](https://arxiv.org/pdf/2601.09931v2)**
...
>
---
#### [replaced 021] VoXtream: Full-Stream Text-to-Speech with Extremely Low Latency
...
>
---
#### [replaced 022] Sound2Hap: Learning Audio-to-Vibrotactile Haptic Generation from Human Ratings
- **分类: cs.HC; cs.SD; eess.AS**

- **简介: 该论文属于音频到触觉生成任务，解决现有方法在多样化声音上泛化能力差的问题。通过用户研究和深度学习模型Sound2Hap，提升音频-触觉匹配效果。**

- **链接: [https://arxiv.org/pdf/2601.12245v3](https://arxiv.org/pdf/2601.12245v3)**
...
>
---
#### [replaced 023] Sound event localization and classification using WASN in Outdoor Environment
- **分类: cs.SD; cs.LG; eess.AS**

- **简介: 该论文属于声源定位与分类任务，旨在解决单麦克风阵列易受噪声影响及多阵列方法忽略分类的问题。提出多特征与注意力机制的方法，提升定位与分类性能。**

- **链接: [https://arxiv.org/pdf/2403.20130v2](https://arxiv.org/pdf/2403.20130v2)**

> **作者:** Dongzhe Zhang; Jianfeng Chen; Jisheng Bai; Mou Wang; Dongyuan Shi; Qixiang Niu; Alberto Bernardini
>
