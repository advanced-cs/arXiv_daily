...
- **简介: 论文提出EnergyGPT，一个针对能源领域的大型语言模型，通过微调LLaMA 3.1-8B解决通用模型在能源领域表现不足的问题。研究涵盖数据收集、模型微调、评估与部署，验证其在能源相关任务中的优越性能。**
...
- **简介: 该论文研究生成儿童故事中的文化与主题偏见，属于自然语言处理任务。旨在分析大语言模型生成故事中的性别与文化偏见问题，构建数据集并揭示偏见表现，以推动AI创作的公平性与多样性。**
...
- **简介: 该论文提出SAOBP框架，解决Transformer中自注意力机制的定位问题，通过信念传播注入多跳关系，提升小规模模型性能。属于自然语言处理任务，旨在优化注意力分布以增强长距离依赖建模。**
...
- **简介: 该论文提出PersonaFuse框架，旨在提升LLM在社交情感交互中的表现。通过融合人格特质与动态路由网络，使模型适应不同情境下的个性表达，增强情感与社交能力，同时保持推理安全，适用于心理咨询等应用。**
...
- **简介: 论文提出VeriOS-Agent，解决OS代理在不可靠环境中的过度执行问题。通过查询驱动的人机-GUI交互框架，提升任务成功率，实验显示其在不可靠场景下性能提升20.64%。**
...
- **简介: 论文针对中文文本中的性别偏见检测与缓解任务，提出基于高效微调和投票重平衡的方法。通过LoRA微调、构建平衡数据集、多模型投票及多温度采样机制，提升检测与缓解效果，在任务中取得第四名。**
...
- **简介: 该论文属于临床文档摘要任务，旨在解决临床报告冗长、术语复杂导致信息提取困难的问题。研究采用视角感知的迭代自提示方法（PA-ISP）优化大语言模型，提升摘要质量，取得较高BERTscore，表明生成摘要语义准确。**
...
- **简介: 论文提出ALLabel，一种三阶段主动学习框架，用于优化基于大语言模型（LLM）的实体识别任务。通过选择最具信息量的样本构建演示数据，以低成本实现高性能的实体识别，适用于化学、材料科学等领域的科学数据处理。**
...
- **简介: 该论文提出一种新框架，评估LLM通过模式识别和互动反馈学习语言的能力。任务是检验LLM是否能像人类一样通过对话掌握新语言。研究发现LLM难以建立有效对话，但策略与人类相似，为未来模型设计提供新方向。**
...
- **链接: [http://arxiv.org/pdf/2509.07188v1](http://arxiv.org/pdf/2509.07188v1)**
...
- **简介: 该论文提出Parallel-R1，通过强化学习框架实现大语言模型的并行推理能力。解决传统监督微调难以激发探索与泛化的问题，采用渐进课程训练，提升数学任务表现，验证并行思考作为中间探索阶段的有效性。**
...
- **简介: 论文提出基于规则的道德原则框架，用于处理大语言模型生成文本中的不确定性。通过道德心理学和美德伦理定义规则，用Prolog引擎实现，提升生成内容的透明度与信任度。属于自然语言生成中的可解释性任务，解决概率方法不透明、缺乏道德对齐的问题。**
...
- **简介: 该论文属于糖果语言检测任务，旨在自动识别社交媒体中的积极支持性言论。研究采用跨度级训练方法，利用多语言模型XLM-RoBERTa-Large，在GermEval 2025竞赛中取得最佳效果。**
...
- **简介: 该论文提出Astra，一种基于LLM的多智能体系统，用于优化GPU内核性能。旨在解决手动调优耗时的问题，通过协作生成、测试和优化CUDA代码，实现性能提升。实验表明其在SGLang内核上平均提速1.32倍。**
...
- **简介: 该论文提出Spectral NSR框架，结合图谱谱分析与符号推理，解决知识图谱中的可解释推理问题。通过谱域逻辑规则嵌入与扩展机制，提升推理准确性、效率与鲁棒性。**
...
- **简介: 该论文提出Instruction Agent，通过专家演示提升GUI代理处理复杂任务的能力。解决现有代理在新UI元素、长序列动作和个性化路径下的不足，提取并执行步骤指令，提高成功率至60%。属于GUI任务自动化领域。**
...
- **简介: 该论文提出CARE框架，解决大语言模型解码阶段安全与质量的平衡问题。通过实时监控、回滚机制和自我反思干预，实现高效安全输出，提升响应质量与用户体验。**
...
>
---
#### [new 052] ArGen: Auto-Regulation of Generative AI via GRPO and Policy-as-Code
...
- **简介: 该论文提出一种量化Transformer电路行为一致性的方法EICS，用于评估其可信度。属于模型解释任务，解决如何判断电路行为是否可靠的问题，结合她夫理论与因果涌现概念，实现单次白盒计算。**
...
- **链接: [http://arxiv.org/pdf/2509.07163v1](http://arxiv.org/pdf/2509.07163v1)**
...
- **链接: [http://arxiv.org/pdf/2502.07128v2](http://arxiv.org/pdf/2502.07128v2)**
...
>
---
#### [replaced 010] Debatable Intelligence: Benchmarking LLM Judges via Debate Speech Evaluation
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.05062v2](http://arxiv.org/pdf/2506.05062v2)**

> **作者:** Noy Sternlicht; Ariel Gera; Roy Bar-Haim; Tom Hope; Noam Slonim
>
> **备注:** EMNLP 2025. Code: https://github.com/noy-sternlicht/Debatable-Intelligence
>
...
>
---
#### [replaced 011] Language Models Might Not Understand You: Evaluating Theory of Mind via Story Prompting
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.19089v3](http://arxiv.org/pdf/2506.19089v3)**
...
>
---
#### [replaced 014] Persuasion Dynamics in LLMs: Investigating Robustness and Adaptability in Knowledge and Safety with DuET-PD
- **分类: cs.CL; cs.CY**
...
>
---
#### [replaced 015] RSCC: A Large-Scale Remote Sensing Change Caption Dataset for Disaster Events
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 016] Visuospatial Cognitive Assistant
...
>
---
#### [replaced 017] Llama-Nemotron: Efficient Reasoning Models
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.00949v5](http://arxiv.org/pdf/2505.00949v5)**
...
>
---
#### [replaced 021] A Japanese Language Model and Three New Evaluation Benchmarks for Pharmaceutical NLP
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.16661v2](http://arxiv.org/pdf/2505.16661v2)**

> **作者:** Shinnosuke Ono; Issey Sukeda; Takuro Fujii; Kosei Buma; Shunsuke Sasaki
>
...
>
---
#### [replaced 022] LM-Searcher: Cross-domain Neural Architecture Search with LLMs via Unified Numerical Encoding
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.05657v2](http://arxiv.org/pdf/2509.05657v2)**
...
>
---
#### [replaced 023] M-ABSA: A Multilingual Dataset for Aspect-Based Sentiment Analysis
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2502.11824v3](http://arxiv.org/pdf/2502.11824v3)**
...
>
---
#### [replaced 026] TokenSelect: Efficient Long-Context Inference and Length Extrapolation for LLMs via Dynamic Token-Level KV Cache Selection
- **分类: cs.CL; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.02886v3](http://arxiv.org/pdf/2411.02886v3)**
...
>
---
#### [replaced 027] Towards Visuospatial Cognition via Hierarchical Fusion of Visual Experts
- **分类: cs.CV; cs.AI; cs.CL; cs.LG; cs.RO**
...
>
---
#### [replaced 028] FilterRAG: Zero-Shot Informed Retrieval-Augmented Generation to Mitigate Hallucinations in VQA
...
>
---
#### [replaced 029] Localizing Persona Representations in LLMs
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.24539v3](http://arxiv.org/pdf/2505.24539v3)**
...
>
---
#### [replaced 030] The Model Hears You: Audio Language Model Deployments Should Consider the Principle of Least Privilege
...
>
---
#### [replaced 033] Meaning-infused grammar: Gradient Acceptability Shapes the Geometric Representations of Constructions in LLMs
- **分类: cs.CL; cs.AI; 68T50**

- **链接: [http://arxiv.org/pdf/2507.22286v2](http://arxiv.org/pdf/2507.22286v2)**
...
>
---
#### [replaced 034] Modelling Intertextuality with N-gram Embeddings
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.06637v2](http://arxiv.org/pdf/2509.06637v2)**
...
>
---
#### [replaced 035] FinRAGBench-V: A Benchmark for Multimodal RAG with Visual Citation in the Financial Domain
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2505.17471v2](http://arxiv.org/pdf/2505.17471v2)**
...
>
---
#### [replaced 036] Heterogeneous Self-Supervised Acoustic Pre-Training with Local Constraints
- **分类: cs.LG; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.19990v2](http://arxiv.org/pdf/2508.19990v2)**
...
>
---
#### [replaced 040] Beyond One-Size-Fits-All: Inversion Learning for Highly Effective NLG Evaluation Prompts
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2504.21117v2](http://arxiv.org/pdf/2504.21117v2)**

> **作者:** Hanhua Hong; Chenghao Xiao; Yang Wang; Yiqi Liu; Wenge Rong; Chenghua Lin
>
> **备注:** 12 pages, accepted by Transactions of the Association for Computational Linguistics (TACL)
>
...
>
---
#### [replaced 041] MedGellan: LLM-Generated Medical Guidance to Support Physicians
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2507.04431v3](http://arxiv.org/pdf/2507.04431v3)**
...
>
---
#### [replaced 042] No Thoughts Just AI: Biased LLM Hiring Recommendations Alter Human Decision Making and Limit Human Autonomy
...
>
---
#### [replaced 043] PIN: A Knowledge-Intensive Dataset for Paired and Interleaved Multimodal Documents
...
>
---
#### [replaced 044] SFR-DeepResearch: Towards Effective Reinforcement Learning for Autonomously Reasoning Single Agents
- **分类: cs.AI; cs.CL**

- **链接: [http://arxiv.org/pdf/2509.06283v2](http://arxiv.org/pdf/2509.06283v2)**
...
>
---
#### [replaced 045] Enhancing Dialogue Annotation with Speaker Characteristics Leveraging a Frozen LLM
...
>
---
#### [replaced 046] When Large Language Models Meet Speech: A Survey on Integration Approaches
...
>
---
#### [replaced 047] Step-level Verifier-guided Hybrid Test-Time Scaling for Large Language Models
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2507.15512v3](http://arxiv.org/pdf/2507.15512v3)**
...
>
---
#### [replaced 048] MEMOIR: Lifelong Model Editing with Minimal Overwrite and Informed Retention for LLMs
- **分类: cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2506.07899v2](http://arxiv.org/pdf/2506.07899v2)**
...
>
---
#### [replaced 049] Training LLMs to be Better Text Embedders through Bidirectional Reconstruction
- **分类: cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2509.03020v3](http://arxiv.org/pdf/2509.03020v3)**
...
>
---
#### [replaced 050] Probe-Rewrite-Evaluate: A Workflow for Reliable Benchmarks and Quantifying Evaluation Awareness
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.00591v4](http://arxiv.org/pdf/2509.00591v4)**
...
>
---
#### [replaced 051] Measuring Bias or Measuring the Task: Understanding the Brittle Nature of LLM Gender Biases
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2509.04373v2](http://arxiv.org/pdf/2509.04373v2)**
...
>
---
#### [replaced 052] Understanding the Language Model to Solve the Symbolic Multi-Step Reasoning Problem from the Perspective of Buffer Mechanism
- **分类: cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2405.15302v3](http://arxiv.org/pdf/2405.15302v3)**
...
>
---
#### [replaced 054] Bhav-Net: Knowledge Transfer for Cross-Lingual Antonym vs Synonym Distinction via Dual-Space Graph Transformers
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2508.15792v2](http://arxiv.org/pdf/2508.15792v2)**
...
>
---
#### [replaced 055] SemCAFE: When Named Entities make the Difference Assessing Web Source Reliability through Entity-level Analytics
- **分类: cs.CL; cs.CY; cs.LG**
...
>
---
#### [replaced 056] Local Normalization Distortion and the Thermodynamic Formalism of Decoding Strategies for Large Language Models
- **分类: cs.CL; cs.LG; math.DS**

- **链接: [http://arxiv.org/pdf/2503.21929v2](http://arxiv.org/pdf/2503.21929v2)**
...
>
---
#### [replaced 059] CAT: Causal Attention Tuning For Injecting Fine-grained Causal Knowledge into Large Language Models
- **分类: cs.CL; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.01535v2](http://arxiv.org/pdf/2509.01535v2)**
...
>
---
#### [replaced 062] A Systematic Literature Review of Retrieval-Augmented Generation: Techniques, Metrics, and Challenges
- **分类: cs.DL; cs.AI; cs.CL; cs.IR**

- **链接: [http://arxiv.org/pdf/2508.06401v3](http://arxiv.org/pdf/2508.06401v3)**
...
>
---
#### [replaced 063] Are Economists Always More Introverted? Analyzing Consistency in Persona-Assigned LLMs
- **分类: cs.CL**

- **链接: [http://arxiv.org/pdf/2506.02659v2](http://arxiv.org/pdf/2506.02659v2)**
