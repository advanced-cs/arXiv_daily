...
#### [new 001] Wiki Live Challenge: Challenging Deep Research Agents with Expert-Level Wikipedia Articles
- **分类: cs.CL**

- **简介: 该论文属于信息检索与生成任务，旨在解决DRAs评估缺乏专家标准的问题。提出Wiki Live Challenge，使用权威维基文章作为参考，构建评估框架，验证DRAs与人类水平的差距。**

- **链接: [https://arxiv.org/pdf/2602.01590v1](https://arxiv.org/pdf/2602.01590v1)**
...
>
---
#### [new 006] Mechanistic Indicators of Steering Effectiveness in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于模型解释任务，旨在解决激活干预效果的机制理解问题。通过分析熵和KL散度等内部信号，评估激活干预的成功概率。**

- **链接: [https://arxiv.org/pdf/2602.01716v1](https://arxiv.org/pdf/2602.01716v1)**
...
>
---
#### [new 007] Training LLMs for Divide-and-Conquer Reasoning Elevates Test-Time Scalability
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在提升大语言模型的推理能力。针对传统链式思维在复杂问题上的局限性，提出一种基于强化学习的分而治之推理框架，增强模型的测试阶段可扩展性与性能。**

- **链接: [https://arxiv.org/pdf/2602.02477v1](https://arxiv.org/pdf/2602.02477v1)**
...
>
> **摘要:** Large language models (LLMs) have demonstrated strong reasoning capabilities through step-by-step chain-of-thought (CoT) reasoning. Nevertheless, at the limits of model capability, CoT often proves insufficient, and its strictly sequential nature constrains test-time scalability. A potential alternative is divide-and-conquer (DAC) reasoning, which decomposes a complex problem into subproblems to facilitate more effective exploration of the solution. Although promising, our analysis reveals a fundamental misalignment between general-purpose post-training and DAC-style inference, which limits the model's capacity to fully leverage this potential. To bridge this gap and fully unlock LLMs' reasoning capabilities on the most challenging tasks, we propose an end-to-end reinforcement learning (RL) framework to enhance their DAC-style reasoning capacity. At each step, the policy decomposes a problem into a group of subproblems, solves them sequentially, and addresses the original one conditioned on the subproblem solutions, with both decomposition and solution integrated into RL training. Under comparable training, our DAC-style framework endows the model with a higher performance ceiling and stronger test-time scalability, surpassing CoT by 8.6% in Pass@1 and 6.3% in Pass@32 on competition-level benchmarks.
>
---
#### [new 008] Out of the Memory Barrier: A Highly Memory Efficient Training System for LLMs with Million-Token Contexts
- **分类: cs.CL**

- **简介: 该论文属于大语言模型训练任务，旨在解决长上下文训练中的显存瓶颈问题。通过引入OOMB系统，实现高效显存管理，使模型能在单卡上训练超长文本。**

- **链接: [https://arxiv.org/pdf/2602.02108v1](https://arxiv.org/pdf/2602.02108v1)**
...
>
---
#### [new 009] Decouple Searching from Training: Scaling Data Mixing via Model Merging for Large Language Model Pre-training
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型预训练任务，解决数据混合优化问题。提出DeMix框架，通过模型合并预测最佳数据比例，降低搜索成本并提升性能。**

- **链接: [https://arxiv.org/pdf/2602.00747v1](https://arxiv.org/pdf/2602.00747v1)**
...
>
---
#### [new 013] Can Small Language Models Handle Context-Summarized Multi-Turn Customer-Service QA? A Synthetic Data-Driven Comparative Evaluation
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于客服问答任务，研究小语言模型在多轮对话中的表现。通过合成数据评估不同模型的对话连贯性和上下文理解能力，旨在探索小模型在实际应用中的潜力与限制。**

- **链接: [https://arxiv.org/pdf/2602.00665v1](https://arxiv.org/pdf/2602.00665v1)**
...
>
---
#### [new 025] Reward-free Alignment for Conflicting Objectives
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于多目标对齐任务，解决冲突目标下的模型对齐问题。提出RACO框架，在无需奖励模型的情况下，通过梯度裁剪实现更优的帕累托权衡。**

- **链接: [https://arxiv.org/pdf/2602.02495v1](https://arxiv.org/pdf/2602.02495v1)**
...
>
---
#### [new 035] AXE: Low-Cost Cross-Domain Web Structured Information Extraction
- **分类: cs.CL**

- **简介: 该论文提出AXE系统，解决跨领域网页结构化信息提取问题。通过树状结构剪枝和小模型生成，实现高效准确提取。**

- **链接: [https://arxiv.org/pdf/2602.01838v1](https://arxiv.org/pdf/2602.01838v1)**
...
>
---
#### [new 036] Trust in One Round: Confidence Estimation for Large Language Models via Structural Signals
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言模型置信度估计任务，解决模型在不同场景下信心预测不准确的问题。提出结构置信框架，利用多尺度结构信号提升预测效果。**

- **链接: [https://arxiv.org/pdf/2602.00977v1](https://arxiv.org/pdf/2602.00977v1)**
...
>
---
#### [new 038] Logic-Oriented Retriever Enhancement via Contrastive Learning
- **分类: cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决 retriever 在复杂逻辑关系查询上的不足。通过对比学习增强模型逻辑分析能力，提升检索效果。**

- **链接: [https://arxiv.org/pdf/2602.01116v1](https://arxiv.org/pdf/2602.01116v1)**

> **作者:** Wenxuan Zhang; Yuan-Hao Jiang; Changyong Qi; Rui Jia; Yonghe Wu
>
> **备注:** accepted by icassp 2026
>
> **摘要:** Large language models (LLMs) struggle in knowledge-intensive tasks, as retrievers often overfit to surface similarity and fail on queries involving complex logical relations. The capacity for logical analysis is inherent in model representations but remains underutilized in standard training. LORE (Logic ORiented Retriever Enhancement) introduces fine-grained contrastive learning to activate this latent capacity, guiding embeddings toward evidence aligned with logical structure rather than shallow similarity. LORE requires no external upervision, resources, or pre-retrieval analysis, remains index-compatible, and consistently improves retrieval utility and downstream generation while maintaining efficiency. The datasets and code are publicly available at https://github.com/mazehart/Lore-RAG.
>
---
#### [new 039] BBPE16: UTF-16-based byte-level byte-pair encoding for improved multilingual speech recognition
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语音识别任务，解决多语言ASR中tokenization效率低的问题。提出BBPE16，基于UTF-16的字节级BPE，提升跨语言token共享，减少token数量和计算开销。**

- **链接: [https://arxiv.org/pdf/2602.01717v1](https://arxiv.org/pdf/2602.01717v1)**
...
>
---
#### [new 046] DISPO: Enhancing Training Efficiency and Stability in Reinforcement Learning for Large Language Model Mathematical Reasoning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于强化学习任务，旨在提升大语言模型数学推理的训练效率与稳定性。针对现有方法在稳定性和效率间的权衡，提出DISPO算法，通过分离重要性采样权重的上下限，实现更高效的策略更新。**

- **链接: [https://arxiv.org/pdf/2602.00983v1](https://arxiv.org/pdf/2602.00983v1)**
...
>
---
#### [new 055] Large-Scale Terminal Agentic Trajectory Generation from Dockerized Environments
- **分类: cs.CL**

- **简介: 该论文属于终端任务建模，解决大规模高质量终端轨迹生成难题。通过构建Docker环境和验证机制，生成50,733个验证过的轨迹，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2602.01244v1](https://arxiv.org/pdf/2602.01244v1)**
...
>
---
#### [new 056] DecompressionLM: Deterministic, Diagnostic, and Zero-Shot Concept Graph Extraction from Language Models
- **分类: cs.CL**

- **简介: 该论文提出DecompressionLM，解决知识提取中依赖预定义查询的问题，通过无状态方法实现零样本概念图抽取，提升模型知识覆盖与准确性。**

- **链接: [https://arxiv.org/pdf/2602.00377v1](https://arxiv.org/pdf/2602.00377v1)**
...
>
---
#### [new 059] AR-MAP: Are Autoregressive Large Language Models Implicit Teachers for Diffusion Large Language Models?
- **分类: cs.CL**

- **简介: 该论文属于语言模型对齐任务，旨在解决DLLM因ELBO估计导致的高方差问题。通过AR-MAP框架，利用AR-LLMs作为隐式教师提升DLLM对齐效果。**

- **链接: [https://arxiv.org/pdf/2602.02178v1](https://arxiv.org/pdf/2602.02178v1)**
...
>
---
#### [new 060] Quantifying the Gap between Understanding and Generation within Unified Multimodal Models
- **分类: cs.CL**

- **简介: 该论文属于多模态模型研究任务，旨在解决统一模型中理解与生成能力是否真正融合的问题。通过构建基准测试，分析两者间的差距，揭示当前模型仅实现表层统一。**

- **链接: [https://arxiv.org/pdf/2602.02140v1](https://arxiv.org/pdf/2602.02140v1)**
...
>
---
#### [new 061] Kimi K2.5: Visual Agentic Intelligence
- **分类: cs.CL**

- **简介: 该论文提出Kimi K2.5，一个用于提升通用代理智能的多模态模型，解决文本与视觉联合优化问题，并引入Agent Swarm框架提升任务处理效率。**

- **链接: [https://arxiv.org/pdf/2602.02276v1](https://arxiv.org/pdf/2602.02276v1)**
...
>
---
#### [new 072] A Baseline Multimodal Approach to Emotion Recognition in Conversations
...
>
---
#### [new 079] S3-CoT: Self-Sampled Succinct Reasoning Enables Efficient Chain-of-Thought LLMs
- **分类: cs.CL**

- **简介: 该论文属于语言模型优化任务，旨在提升CoT推理效率。通过自采样框架减少冗余推理，实现快速思考模式，无需外部监督数据。**

- **链接: [https://arxiv.org/pdf/2602.01982v1](https://arxiv.org/pdf/2602.01982v1)**
...
>
---
#### [new 088] EverMemBench: Benchmarking Long-Term Interactive Memory in Large Language ModelsEverMemBench: Benchmarking Long-Term Interactive Memory in Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，旨在解决大语言模型的长期交互记忆问题。提出EverMemBench基准，评估模型在多角色、多主题对话中的记忆能力，揭示现有系统的不足。**

- **链接: [https://arxiv.org/pdf/2602.01313v1](https://arxiv.org/pdf/2602.01313v1)**
...
>
---
#### [new 092] From Pragmas to Partners: A Symbiotic Evolution of Agentic High-Level Synthesis
- **分类: cs.CL; cs.AI**

- **简介: 论文探讨AI驱动的硬件设计中HLS的作用，提出其作为优化层的重要性。任务为AI与HLS协同进化，解决工具局限性问题，提出共生分类框架。**

- **链接: [https://arxiv.org/pdf/2602.01401v1](https://arxiv.org/pdf/2602.01401v1)**
...
>
---
#### [new 093] DreamOn: Diffusion Language Models For Code Infilling Beyond Fixed-size Canvas
- **分类: cs.CL**

- **简介: 该论文属于代码补全任务，解决扩散语言模型在固定长度生成上的限制问题。提出DreamOn框架，实现动态可变长度生成，提升代码补全性能。**

- **链接: [https://arxiv.org/pdf/2602.01326v1](https://arxiv.org/pdf/2602.01326v1)**
...
>
---
#### [new 094] MedAraBench: Large-Scale Arabic Medical Question Answering Dataset and Benchmark
- **分类: cs.CL**

- **简介: 该论文提出MedAraBench，一个大规模阿拉伯语医学问答数据集，旨在解决阿拉伯语医疗NLP资源不足的问题。通过构建多领域、多难度的数据集，并评估多种模型性能，以提升多语言模型的临床应用能力。**

- **链接: [https://arxiv.org/pdf/2602.01714v1](https://arxiv.org/pdf/2602.01714v1)**
...
>
> **摘要:** Large Language Models (LLMs) have achieved remarkable success in source code understanding, yet as software systems grow in scale, computational efficiency has become a critical bottleneck. Currently, these models rely on a text-based paradigm that treats source code as a linear sequence of tokens, which leads to a linear increase in context length and associated computational costs. The rapid advancement of Multimodal LLMs (MLLMs) introduces an opportunity to optimize efficiency by representing source code as rendered images. Unlike text, which is difficult to compress without losing semantic meaning, the image modality is inherently suitable for compression. By adjusting resolution, images can be scaled to a fraction of their original token cost while remaining recognizable to vision-capable models. To explore the feasibility of this approach, we conduct the first systematic study on the effectiveness of MLLMs for code understanding. Our experiments reveal that: (1) MLLMs can effectively understand code with substantial token reduction, achieving up to 8x compression; (2) MLLMs can effectively leverage visual cues such as syntax highlighting, improving code completion performance under 4x compression; and (3) Code-understanding tasks like clone detection exhibit exceptional resilience to visual compression, with some compression ratios even slightly outperforming raw text inputs. Our findings highlight both the potential and current limitations of MLLMs in code understanding, which points out a shift toward image-modality code representation as a pathway to more efficient inference.
>
---
#### [new 102] MedSpeak: A Knowledge Graph-Aided ASR Error Correction Framework for Spoken Medical QA
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗语音问答任务，旨在解决ASR识别中医学术语错误的问题。通过结合知识图谱和大模型，提出MedSpeak框架提升术语识别与问答性能。**

- **链接: [https://arxiv.org/pdf/2602.00981v1](https://arxiv.org/pdf/2602.00981v1)**
...
>
---
#### [new 103] APR: Penalizing Structural Redundancy in Large Reasoning Models via Anchor-based Process Rewards
- **分类: cs.CL**

- **简介: 该论文属于大模型推理任务，解决Overthinking问题。通过定义Reasoning Anchor，提出APR方法惩罚冗余推理，提升效率。**

- **链接: [https://arxiv.org/pdf/2602.00760v1](https://arxiv.org/pdf/2602.00760v1)**
...
>
---
#### [new 104] Context Dependence and Reliability in Autoregressive Language Models
- **分类: cs.CL; cs.AI; stat.ML**

- **简介: 该论文属于自然语言处理中的可解释性研究，旨在解决大语言模型中冗余上下文对解释的影响问题。提出RISE方法，提升解释的稳定性和准确性。**

- **链接: [https://arxiv.org/pdf/2602.01378v1](https://arxiv.org/pdf/2602.01378v1)**

> **作者:** Poushali Sengupta; Shashi Raj Pandey; Sabita Maharjan; Frank Eliassen
>
> **摘要:** Large language models (LLMs) generate outputs by utilizing extensive context, which often includes redundant information from prompts, retrieved passages, and interaction history. In critical applications, it is vital to identify which context elements actually influence the output, as standard explanation methods struggle with redundancy and overlapping context. Minor changes in input can lead to unpredictable shifts in attribution scores, undermining interpretability and raising concerns about risks like prompt injection. This work addresses the challenge of distinguishing essential context elements from correlated ones. We introduce RISE (Redundancy-Insensitive Scoring of Explanation), a method that quantifies the unique influence of each input relative to others, minimizing the impact of redundancies and providing clearer, stable attributions. Experiments demonstrate that RISE offers more robust explanations than traditional methods, emphasizing the importance of conditional information for trustworthy LLM explanations and monitoring.
>
---
#### [new 105] CURP: Codebook-based Continuous User Representation for Personalized Generation with LLMs
- **分类: cs.CL**

- **简介: 该论文属于个性化生成任务，旨在解决LLMs中个性化与效率的平衡问题。提出CURP框架，通过用户编码器和原型代码本实现高效个性化生成。**

- **链接: [https://arxiv.org/pdf/2602.00742v1](https://arxiv.org/pdf/2602.00742v1)**
...
>
---
#### [new 108] Omni-RRM: Advancing Omni Reward Modeling via Automatic Rubric-Grounded Preference Synthesis
- **分类: cs.CL**

- **简介: 该论文属于奖励模型任务，旨在解决现有奖励模型依赖人工标注、维度单一的问题。提出Omni-RRM，通过自动化方法生成多模态偏好数据，提升模型对文本、图像、视频和音频的判断能力。**

- **链接: [https://arxiv.org/pdf/2602.00846v1](https://arxiv.org/pdf/2602.00846v1)**
...
>
---
#### [new 109] Detecting AI-Generated Content in Academic Peer Reviews
- **分类: cs.CL; cs.AI; cs.LG; cs.SI**

- **简介: 该论文属于AI生成内容检测任务，旨在解决学术同行评审中AI辅助内容的识别问题。通过分析ICLR和Nature Communications的评审数据，发现AI生成内容在2025年占比显著上升。**

- **链接: [https://arxiv.org/pdf/2602.00319v1](https://arxiv.org/pdf/2602.00319v1)**
...
>
---
#### [new 110] WorldCup Sampling for Multi-bit LLM Watermarking
- **分类: cs.CL; cs.CR**

- **简介: 该论文属于LLM水印任务，旨在解决多比特水印的容量与质量平衡问题。提出WorldCup框架，通过采样机制直接嵌入信息，提升水印性能。**

- **链接: [https://arxiv.org/pdf/2602.01752v1](https://arxiv.org/pdf/2602.01752v1)**
...
>
---
#### [new 123] Steering Vector Fields for Context-Aware Inference-Time Control in Large Language Models
- **分类: cs.CL**

- **简介: 该论文属于大语言模型推理时控制任务，解决传统引导向量可靠性差的问题。提出Steering Vector Fields（SVF），通过上下文相关方向实现更可靠、高效的控制。**

- **链接: [https://arxiv.org/pdf/2602.01654v1](https://arxiv.org/pdf/2602.01654v1)**
...
>
---
#### [new 124] Hermes the Polyglot: A Unified Framework to Enhance Expressiveness for Multimodal Interlingual Subtitling
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于多模态跨语言字幕任务，旨在解决字幕翻译中的语义连贯性、代词和术语翻译及表达力问题。提出Hermes框架，集成三个模块提升翻译质量。**

- **链接: [https://arxiv.org/pdf/2602.00597v1](https://arxiv.org/pdf/2602.00597v1)**
...
>
---
#### [new 125] When Agents "Misremember" Collectively: Exploring the Mandela Effect in LLM-based Multi-Agent Systems
- **分类: cs.CL; cs.AI; cs.CR**

- **简介: 论文研究LLM多智能体系统中的集体记忆偏差问题，提出MANBENCH基准评估并提出缓解策略，旨在提升系统可靠性与伦理安全性。**

- **链接: [https://arxiv.org/pdf/2602.00428v1](https://arxiv.org/pdf/2602.00428v1)**
...
>
---
#### [new 133] A Hierarchical and Attentional Analysis of Argument Structure Constructions in BERT Using Naturalistic Corpora
- **分类: cs.CL**

- **简介: 该论文研究BERT模型对论元结构的处理，通过多维分析方法揭示其层次化表示结构，解决模型如何表征语法构造的问题。**

- **链接: [https://arxiv.org/pdf/2602.00554v1](https://arxiv.org/pdf/2602.00554v1)**

> **作者:** Liu Kaipeng; Wu Ling
>
> **备注:** 14 pages, 5 figures
>
> **摘要:** This study investigates how the Bidirectional Encoder Representations from Transformers model processes four fundamental Argument Structure Constructions. We employ a multi-dimensional analytical framework, which integrates MDS, t-SNE as dimensionality reduction, Generalized Discrimination Value (GDV) as cluster separation metrics, Fisher Discriminant Ratio (FDR) as linear diagnostic probing, and attention mechanism analysis. Our results reveal a hierarchical representational structure. Construction-specific information emerges in early layers, forms maximally separable clusters in middle layers, and is maintained through later processing stages.
>
---
#### [new 134] WildGraphBench: Benchmarking GraphRAG with Wild-Source Corpora
- **分类: cs.CL**

- **简介: 该论文属于知识图谱与问答任务，旨在解决GraphRAG在真实场景下的评估问题。构建了WildGraphBench基准，使用维基百科数据进行多层级问答和摘要任务测试。**

- **链接: [https://arxiv.org/pdf/2602.02053v1](https://arxiv.org/pdf/2602.02053v1)**
...
>
---
#### [new 143] Ebisu: Benchmarking Large Language Models in Japanese Finance
- **分类: cs.CL**

- **简介: 该论文提出Ebisu基准，用于评估日语金融语言理解能力。针对日语金融文本的特殊语言结构和文化背景，设计两个任务，测试模型在隐含承诺识别和金融术语提取方面的表现。**

- **链接: [https://arxiv.org/pdf/2602.01479v1](https://arxiv.org/pdf/2602.01479v1)**
...
>
> **摘要:** Japanese finance combines agglutinative, head-final linguistic structure, mixed writing systems, and high-context communication norms that rely on indirect expression and implicit commitment, posing a substantial challenge for LLMs. We introduce Ebisu, a benchmark for native Japanese financial language understanding, comprising two linguistically and culturally grounded, expert-annotated tasks: JF-ICR, which evaluates implicit commitment and refusal recognition in investor-facing Q&A, and JF-TE, which assesses hierarchical extraction and ranking of nested financial terminology from professional disclosures. We evaluate a diverse set of open-source and proprietary LLMs spanning general-purpose, Japanese-adapted, and financial models. Results show that even state-of-the-art systems struggle on both tasks. While increased model scale yields limited improvements, language- and domain-specific adaptation does not reliably improve performance, leaving substantial gaps unresolved. Ebisu provides a focused benchmark for advancing linguistically and culturally grounded financial NLP. All datasets and evaluation scripts are publicly released.
>
---
#### [new 144] COMI: Coarse-to-fine Context Compression via Marginal Information Gain
- **分类: cs.CL**

- **简介: 该论文提出COMI，一种用于长文本压缩的框架，解决LLM在长上下文场景中的计算效率和冗余问题。通过MIG指标实现粗粒度分组与细粒度合并，提升压缩效果。**

- **链接: [https://arxiv.org/pdf/2602.01719v1](https://arxiv.org/pdf/2602.01719v1)**
...
>
---
#### [new 145] Read As Human: Compressing Context via Parallelizable Close Reading and Skimming
- **分类: cs.CL**

- **简介: 该论文提出RAM框架，用于长文本的上下文压缩，解决LLM在长文本处理中的效率和冗余问题。通过混合阅读策略，提升推理速度与效果。**

- **链接: [https://arxiv.org/pdf/2602.01840v1](https://arxiv.org/pdf/2602.01840v1)**
...
>
---
#### [new 146] Restoring Exploration after Post-Training: Latent Exploration Decoding for Large Reasoning Models
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于大模型推理任务，解决后训练导致的探索能力下降问题。提出LED方法，通过中间层后验熵选择探索路径，提升推理准确率。**

- **链接: [https://arxiv.org/pdf/2602.01698v1](https://arxiv.org/pdf/2602.01698v1)**
...
>
---
#### [new 147] A2Eval: Agentic and Automated Evaluation for Embodied Brain
- **分类: cs.CL**

- **简介: 该论文提出A2Eval，解决具身视觉语言模型评估效率低、成本高的问题。通过自动化框架压缩评估套件，提升评估速度与质量。**

- **链接: [https://arxiv.org/pdf/2602.01640v1](https://arxiv.org/pdf/2602.01640v1)**
...
>
---
#### [new 148] Misconception Diagnosis From Student-Tutor Dialogue: Generate, Retrieve, Rerank
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于教育技术领域，旨在通过学生与导师的对话检测学生误解。工作包括生成、检索和重排序可能的误解，提升检测准确性。**

- **链接: [https://arxiv.org/pdf/2602.02414v1](https://arxiv.org/pdf/2602.02414v1)**
...
>
---
#### [new 173] LEC-KG: An LLM-Embedding Collaborative Framework for Domain-Specific Knowledge Graph Construction -- A Case Study on SDGs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于知识图谱构建任务，旨在解决领域知识图谱从非结构化文本中构建的难题。通过结合大语言模型与知识图嵌入，提出LEC-KG框架，提升关系抽取和结构验证效果。**

- **链接: [https://arxiv.org/pdf/2602.02090v1](https://arxiv.org/pdf/2602.02090v1)**
...
>
---
#### [new 174] RE-TRAC: REcursive TRAjectory Compression for Deep Search Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出Re-TRAC框架，解决深度搜索代理在长上下文中难以回溯、分支和全局规划的问题。通过结构化状态表示实现跨轨迹探索，提升搜索效率与效果。**

- **链接: [https://arxiv.org/pdf/2602.02486v1](https://arxiv.org/pdf/2602.02486v1)**
...
>
> **摘要:** LLM-based deep research agents are largely built on the ReAct framework. This linear design makes it difficult to revisit earlier states, branch into alternative search directions, or maintain global awareness under long contexts, often leading to local optima, redundant exploration, and inefficient search. We propose Re-TRAC, an agentic framework that performs cross-trajectory exploration by generating a structured state representation after each trajectory to summarize evidence, uncertainties, failures, and future plans, and conditioning subsequent trajectories on this state representation. This enables iterative reflection and globally informed planning, reframing research as a progressive process. Empirical results show that Re-TRAC consistently outperforms ReAct by 15-20% on BrowseComp with frontier LLMs. For smaller models, we introduce Re-TRAC-aware supervised fine-tuning, achieving state-of-the-art performance at comparable scales. Notably, Re-TRAC shows a monotonic reduction in tool calls and token usage across rounds, indicating progressively targeted exploration driven by cross-trajectory reflection rather than redundant search.
>
---
#### [new 175] From Latent Signals to Reflection Behavior: Tracing Meta-Cognitive Activation Trajectory in R1-Style LLMs
- **分类: cs.CL**

- **简介: 该论文研究R1风格大模型的自我反思机制，分析其元认知激活轨迹。通过追踪层间激活，揭示从隐含信号到反思行为的结构化过程。**

- **链接: [https://arxiv.org/pdf/2602.01999v1](https://arxiv.org/pdf/2602.01999v1)**
...
>
---
#### [new 176] Jailbreaking LLMs via Calibration
- **分类: cs.CL; cs.AI; cs.CR; cs.LG**

- **简介: 该论文属于安全对齐任务，旨在解决LLM安全机制导致的输出偏差问题。通过建模安全对齐的影响，提出一种新的越狱方法，提升攻击成功率并降低代价。**

- **链接: [https://arxiv.org/pdf/2602.00619v1](https://arxiv.org/pdf/2602.00619v1)**
...
>
---
#### [new 183] Dissecting Outlier Dynamics in LLM NVFP4 Pretraining
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究NVFP4预训练中的异常值动态，旨在解决量化误差导致的损失差距问题。通过分析架构组件，提出HCP补偿机制，提升训练效果。**

- **链接: [https://arxiv.org/pdf/2602.02047v1](https://arxiv.org/pdf/2602.02047v1)**
...
>
---
#### [new 187] OmniCode: A Benchmark for Evaluating Software Engineering Agents
- **分类: cs.SE; cs.AI; cs.CL**

- **简介: 该论文提出OmniCode基准，用于评估软件工程代理。针对现有基准任务狭窄的问题，OmniCode涵盖更广的任务类型和语言，提升代理在真实软件开发中的表现。**

- **链接: [https://arxiv.org/pdf/2602.02262v1](https://arxiv.org/pdf/2602.02262v1)**
...
>
---
#### [new 188] Rethinking Genomic Modeling Through Optical Character Recognition
...
>
---
#### [new 189] Interpreting and Controlling LLM Reasoning through Integrated Policy Gradient
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于模型解释任务，旨在解决LLM推理机制不透明的问题。通过提出IPG框架，实现对推理过程的精准定位与控制。**

- **链接: [https://arxiv.org/pdf/2602.02313v1](https://arxiv.org/pdf/2602.02313v1)**
...
>
---
#### [new 190] SpeechLess: Micro-utterance with Personalized Spatial Memory-aware Assistant in Everyday Augmented Reality
- **分类: cs.HC; cs.CL; cs.ET; cs.IR**

- **简介: 该论文提出SpeechLess，一种基于个性化空间记忆的AR助手，解决公共场合语音交互尴尬和重复表达问题。通过减少用户说话量，提升信息获取效率。**

- **链接: [https://arxiv.org/pdf/2602.00793v1](https://arxiv.org/pdf/2602.00793v1)**
...
>
---
#### [new 191] SPARC-RAG: Adaptive Sequential-Parallel Scaling with Context Management for Retrieval-Augmented Generation
- **分类: cs.IR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于问答任务，解决多跳问题中RAG的上下文污染和效率低问题。提出SPARC-RAG框架，通过统一上下文管理实现高效序列与并行扩展。**

- **链接: [https://arxiv.org/pdf/2602.00083v1](https://arxiv.org/pdf/2602.00083v1)**
...
>
---
#### [new 194] Vision-DeepResearch Benchmark: Rethinking Visual and Textual Search for Multimodal Large Language Models
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**
...
>
---
#### [new 197] Adapting Where It Matters: Depth-Aware Adaptation for Efficient Multilingual Speech Recognition in Low-Resource Languages
...
>
---
#### [new 198] When RAG Hurts: Diagnosing and Mitigating Attention Distraction in Retrieval-Augmented LVLMs
...
>
---
#### [new 199] No Global Plan in Chain-of-Thought: Uncover the Latent Planning Horizon of LLMs
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究LLMs的隐式规划能力，解决CoT中全局规划缺失问题。通过方法Tele-Lens分析隐藏状态，发现模型具有短视规划特性，并验证部分CoT位置可代表整体不确定性。**

- **链接: [https://arxiv.org/pdf/2602.02103v1](https://arxiv.org/pdf/2602.02103v1)**

> **作者:** Liyan Xu; Mo Yu; Fandong Meng; Jie Zhou
>
> **摘要:** This work stems from prior complementary observations on the dynamics of Chain-of-Thought (CoT): Large Language Models (LLMs) is shown latent planning of subsequent reasoning prior to CoT emergence, thereby diminishing the significance of explicit CoT; whereas CoT remains critical for tasks requiring multi-step reasoning. To deepen the understanding between LLM's internal states and its verbalized reasoning trajectories, we investigate the latent planning strength of LLMs, through our probing method, Tele-Lens, applying to hidden states across diverse task domains. Our empirical results indicate that LLMs exhibit a myopic horizon, primarily conducting incremental transitions without precise global planning. Leveraging this characteristic, we propose a hypothesis on enhancing uncertainty estimation of CoT, which we validate that a small subset of CoT positions can effectively represent the uncertainty of the entire path. We further underscore the significance of exploiting CoT dynamics, and demonstrate that automatic recognition of CoT bypass can be achieved without performance degradation. Our code, data and models are released at https://github.com/lxucs/tele-lens.
>
---
#### [new 200] Diffusion LMs Can Approximate Optimal Infilling Lengths Implicitly
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究扩散语言模型的补全任务，解决预设补全长度限制的问题。通过分析噪声估计信号，提出CAL方法，无需训练即可自适应调整最佳补全长度。**

- **链接: [https://arxiv.org/pdf/2602.00476v1](https://arxiv.org/pdf/2602.00476v1)**
...
>
---
#### [new 201] From Associations to Activations: Comparing Behavioral and Hidden-State Semantic Geometry in LLMs
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于自然语言处理领域，研究如何通过行为实验恢复大模型的隐状态语义结构。任务是比较行为数据与隐藏状态的语义几何关系，解决行为数据能否反映模型内部语义的问题。工作包括设计实验、收集数据并进行相似性分析。**

- **链接: [https://arxiv.org/pdf/2602.00628v1](https://arxiv.org/pdf/2602.00628v1)**
...
>
---
#### [new 206] The Gradient-Causal Gap: Why Gradient Importance Fails on Complex Tasks
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究Transformer在算法任务中的梯度与因果重要性关系，揭示梯度重要性在复杂任务中失效的问题，通过实验说明梯度剪枝不可靠。**

- **链接: [https://arxiv.org/pdf/2602.01442v1](https://arxiv.org/pdf/2602.01442v1)**
...
>
---
#### [new 207] Extending Beacon to Hindi: Cultural Adaptation Drives Cross-Lingual Sycophancy
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于自然语言处理任务，研究跨语言对齐问题。通过调整提示文化适应性，发现文化因素显著影响模型的阿谀行为，揭示了英语评估结果可能无法直接推广至其他语言。**

- **链接: [https://arxiv.org/pdf/2602.00046v1](https://arxiv.org/pdf/2602.00046v1)**
...
>
---
#### [new 214] Beyond Output Critique: Self-Correction via Task Distillation
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出SELF-THOUGHT框架，解决LLM自纠错能力不足的问题。通过任务抽象与结构化引导，提升模型推理准确性与鲁棒性，适用于大小模型。**

- **链接: [https://arxiv.org/pdf/2602.00871v1](https://arxiv.org/pdf/2602.00871v1)**
...
>
---
#### [new 217] Unmasking Reasoning Processes: A Process-aware Benchmark for Evaluating Structural Mathematical Reasoning in LLMs
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于数学推理任务，旨在解决现有基准无法准确评估大模型结构推理能力的问题。提出ReasoningMath-Plus基准和HCRS评分方法，以更细致地衡量模型的推理过程。**

- **链接: [https://arxiv.org/pdf/2602.00564v1](https://arxiv.org/pdf/2602.00564v1)**
...
>
---
#### [new 218] C$^2$-Cite: Contextual-Aware Citation Generation for Attributed Large Language Models
- **分类: cs.IR; cs.CL; cs.DL; cs.LG**

- **简介: 该论文属于文本生成任务，解决LLM生成文本时引用不准确的问题。提出C²-Cite框架，提升引用标记与内容的语义对齐，增强引用质量与回答正确性。**

- **链接: [https://arxiv.org/pdf/2602.00004v1](https://arxiv.org/pdf/2602.00004v1)**
...
>
---
#### [new 219] Avenir-Web: Human-Experience-Imitating Multimodal Web Agents with Mixture of Grounding Experts
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出Avenir-Web，解决复杂网页上长期任务执行问题。通过多专家接地、经验模仿规划和自适应记忆，提升网页代理的可靠性与性能。**

- **链接: [https://arxiv.org/pdf/2602.02468v1](https://arxiv.org/pdf/2602.02468v1)**
...
>
---
#### [new 220] Hunt Instead of Wait: Evaluating Deep Data Research on Large Language Models
- **分类: cs.AI; cs.CL; cs.DB; cs.LG**

- **简介: 该论文属于人工智能领域，探讨如何评估大语言模型的自主探索能力。提出DDR任务与基准，解决模型在数据中自主发现洞察的难题。**

- **链接: [https://arxiv.org/pdf/2602.02039v1](https://arxiv.org/pdf/2602.02039v1)**
...
>
---
#### [new 224] Drift-Bench: Diagnosing Cooperative Breakdowns in LLM Agents under Input Faults via Multi-Turn Interaction
- **分类: cs.AI; cs.CL; cs.SE**

- **简介: 该论文提出Drift-Bench，用于诊断LLM代理在输入故障下的协作失效问题，属于agent安全评估任务。通过多轮澄清测试，分析不同故障类型和用户角色的影响。**

- **链接: [https://arxiv.org/pdf/2602.02455v1](https://arxiv.org/pdf/2602.02455v1)**

> **作者:** Han Bao; Zheyuan Zhang; Pengcheng Jing; Zhengqing Yuan; Kaiwen Shi; Yanfang Ye
>
> **备注:** 65 pages, 40 figures
>
> **摘要:** As Large Language Models transition to autonomous agents, user inputs frequently violate cooperative assumptions (e.g., implicit intent, missing parameters, false presuppositions, or ambiguous expressions), creating execution risks that text-only evaluations do not capture. Existing benchmarks typically assume well-specified instructions or restrict evaluation to text-only, single-turn clarification, and thus do not measure multi-turn disambiguation under grounded execution risk. We introduce \textbf{Drift-Bench}, the first diagnostic benchmark that evaluates agentic pragmatics under input faults through multi-turn clarification across state-oriented and service-oriented execution environments. Grounded in classical theories of communication, \textbf{Drift-Bench} provides a unified taxonomy of cooperative breakdowns and employs a persona-driven user simulator with the \textbf{Rise} evaluation protocol. Experiments show substantial performance drops under these faults, with clarification effectiveness varying across user personas and fault types. \MethodName bridges clarification research and agent safety evaluation, enabling systematic diagnosis of failures that can lead to unsafe executions.
>
---
#### [new 225] AI-assisted Protocol Information Extraction For Improved Accuracy and Efficiency in Clinical Trial Workflows
- **分类: cs.IR; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于临床试验协议信息提取任务，旨在解决协议复杂性带来的效率与准确性问题。通过AI-RAG系统提升信息提取精度和工作效率。**

- **链接: [https://arxiv.org/pdf/2602.00052v1](https://arxiv.org/pdf/2602.00052v1)**
...
>
---
#### [new 226] Block removal for large language models through constrained binary optimization
- **分类: cs.LG; cs.AI; cs.CL; quant-ph**

- **简介: 该论文属于模型压缩任务，解决如何有效移除大型语言模型中的Transformer块问题。通过约束二值优化方法，高效找到高质量的块移除方案，提升模型效率。**

- **链接: [https://arxiv.org/pdf/2602.00161v1](https://arxiv.org/pdf/2602.00161v1)**
...
>
---
#### [new 233] IntentCoding: Amplifying User Intent in Code Generation
- **分类: cs.SE; cs.CL; cs.LG**

- **简介: 该论文属于代码生成任务，解决用户意图遵循不足的问题。提出IntentCoding方法，通过增强用户意图影响，提升约束满足和代码正确性。**

- **链接: [https://arxiv.org/pdf/2602.00066v1](https://arxiv.org/pdf/2602.00066v1)**
...
>
---
#### [new 234] From Prompt to Graph: Comparing LLM-Based Information Extraction Strategies in Domain-Specific Ontology Development
- **分类: cs.AI; cs.CL; cs.IR**

- **简介: 该论文属于知识抽取任务，旨在解决领域本体构建中人工成本高的问题。通过比较三种LLM方法，提取领域术语和关系，构建铸造本体。**

- **链接: [https://arxiv.org/pdf/2602.00699v1](https://arxiv.org/pdf/2602.00699v1)**
...
>
---
#### [new 238] EvoMU: Evolutionary Machine Unlearning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出EvoMU，解决机器遗忘中损失函数选择困难的问题。通过进化算法自动搜索最优损失函数，提升遗忘效果。**

- **链接: [https://arxiv.org/pdf/2602.02139v1](https://arxiv.org/pdf/2602.02139v1)**
...
>
---
#### [new 244] LLMs as High-Dimensional Nonlinear Autoregressive Models with Attention: Training, Alignment and Inference
- **分类: cs.LG; cs.AI; cs.CL; eess.SP**

- **简介: 该论文将大语言模型建模为高维非线性自回归模型，研究其训练、对齐与推理过程，解决模型结构不明确的问题，提出数学框架以分析行为与扩展。**

- **链接: [https://arxiv.org/pdf/2602.00426v1](https://arxiv.org/pdf/2602.00426v1)**
...
>
---
#### [replaced 002] FS-DFM: Fast and Accurate Long Text Generation with Few-Step Diffusion Language Models
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文提出FS-DFM，解决长文本生成速度与质量的平衡问题。通过少步扩散模型实现快速生成，保持高质量。**

- **链接: [https://arxiv.org/pdf/2509.20624v3](https://arxiv.org/pdf/2509.20624v3)**
...
>
---
#### [replaced 005] Code over Words: Overcoming Semantic Inertia via Code-Grounded Reasoning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于自然语言处理任务，解决LLMs在动态规则下无法抑制预训练先验的问题。通过代码表示替代描述性文本，提升模型对逻辑约束的遵循能力。**

- **链接: [https://arxiv.org/pdf/2601.18352v2](https://arxiv.org/pdf/2601.18352v2)**
...
>
---
#### [replaced 006] Identity, Cooperation and Framing Effects within Groups of Real and Simulated Humans
- **分类: cs.CL**

- **简介: 该论文属于人工智能与社会行为研究任务，旨在提升LLMs模拟人类行为的准确性。通过深度绑定模型与背景故事，增强身份和情境因素的模拟，以更真实地再现人类在社会困境中的决策过程。**

- **链接: [https://arxiv.org/pdf/2601.16355v2](https://arxiv.org/pdf/2601.16355v2)**
...
>
> **备注:** Camera Ready version for ICLR 2026. https://github.com/Chen-GX/IterResearch
>
...
>
---
#### [replaced 011] SAGE: A Top-Down Bottom-Up Knowledge-Grounded User Simulator for Multi-turn AGent Evaluation
- **分类: cs.CL**

- **简介: 该论文提出SAGE，一种用于多轮对话系统评估的用户模拟框架。旨在解决传统评估方法依赖人工的问题，通过整合业务知识生成更真实的用户交互，提升评估效果。**

- **链接: [https://arxiv.org/pdf/2510.11997v2](https://arxiv.org/pdf/2510.11997v2)**
...
>
---
#### [replaced 012] WUGNECTIVES: Novel Entity Inferences of Language Models from Discourse Connectives
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，研究话语连接词如何反映世界知识。通过构建数据集WUGNECTIVES，评估语言模型对新实体的推理能力，发现模型在不同连接词上的表现差异显著。**

- **链接: [https://arxiv.org/pdf/2510.09556v3](https://arxiv.org/pdf/2510.09556v3)**

> **作者:** Daniel Brubaker; William Sheffield; Junyi Jessy Li; Kanishka Misra
>
> **备注:** 19 pages total, 10 pages main; 8 figures total, 5 figures main; 10 tables total, 4 tables main
>
...
>
---
#### [replaced 013] How Much Do LLMs Hallucinate across Languages? On Realistic Multilingual Estimation of LLM Hallucination
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究多语言大模型的幻觉问题，旨在量化不同语言中的幻觉率。通过训练多语言检测模型和构建跨语言问答数据集，分析幻觉与语言资源、模型大小的关系。**

- **链接: [https://arxiv.org/pdf/2502.12769v4](https://arxiv.org/pdf/2502.12769v4)**
...
>
---
#### [replaced 014] Large Language Models for Scientific Idea Generation: A Creativity-Centered Survey
- **分类: cs.CL**

- **简介: 该论文属于科学创意生成任务，旨在解决自动化生成科学想法的挑战。通过分析LLM方法，探讨其在新颖性与科学有效性间的平衡。**

- **链接: [https://arxiv.org/pdf/2511.07448v2](https://arxiv.org/pdf/2511.07448v2)**
...
>
---
#### [replaced 018] Quokka: Accelerating Program Verification with LLMs via Invariant Synthesis
- **分类: cs.PL; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于程序验证任务，旨在解决自动生成强循环不变量的难题。提出Quokka框架，利用LLMs加速验证，实现高效且准确的不变量合成。**

- **链接: [https://arxiv.org/pdf/2509.21629v2](https://arxiv.org/pdf/2509.21629v2)**
...
>
---
#### [replaced 019] How does a Multilingual LM Handle Multiple Languages?
- **分类: cs.CL; cs.AI**

- **简介: 该论文研究多语言模型在不同语言中的表现，旨在解决低资源语言支持不足的问题。通过语义分析、命名实体识别和跨语言迁移实验，评估模型能力，提升多语言NLP的包容性。**

- **链接: [https://arxiv.org/pdf/2502.04269v2](https://arxiv.org/pdf/2502.04269v2)**

> **作者:** Santhosh Kakarla; Gautama Shastry Bulusu Venkata; Aishwarya Gaddam; Maheedhar Sai Omtri Mohan
>
> **备注:** 10 pages, 8 figures
>
> **摘要:** Multilingual language models have significantly advanced due to rapid progress in natural language processing. Models like BLOOM 1.7B, trained on diverse multilingual datasets, aim to bridge linguistic gaps. However, their effectiveness in capturing linguistic knowledge, particularly for low-resource languages, remains an open question. This study critically examines MLMs capabilities in multilingual understanding, semantic representation, and cross-lingual knowledge transfer. While these models perform well for high-resource languages, they struggle with less-represented ones. Additionally, traditional evaluation methods often overlook their internal syntactic and semantic encoding. This research addresses key limitations through three objectives. First, it assesses semantic similarity by analyzing multilingual word embeddings for consistency using cosine similarity. Second, it examines BLOOM-1.7B and Qwen2 through Named Entity Recognition and sentence similarity tasks to understand their linguistic structures. Third, it explores cross-lingual knowledge transfer by evaluating generalization from high-resource to low-resource languages in sentiment analysis and text classification. By leveraging linguistic probing, performance metrics, and visualizations, this study provides insights into the strengths and limitations of MLMs. The findings aim to enhance multilingual NLP models, ensuring better support for both high- and low-resource languages, thereby promoting inclusivity in language technologies.
>
---
#### [replaced 020] Draft-based Approximate Inference for LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型推理优化任务，旨在解决长上下文处理中的计算与内存效率问题。通过引入小模型预测重要性，提出三种压缩方法提升精度与效率。**

- **链接: [https://arxiv.org/pdf/2506.08373v3](https://arxiv.org/pdf/2506.08373v3)**
...
>
---
#### [replaced 024] Your Latent Reasoning is Secretly Policy Improvement Operator
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究递归模型的性能问题，探讨何时及为何隐式推理提升效果，提出基于强化学习的训练方案，减少无效计算并提升效率。任务为模型优化。**

- **链接: [https://arxiv.org/pdf/2511.16886v3](https://arxiv.org/pdf/2511.16886v3)**
...
- **简介: 该论文介绍A.X K1，一个519B参数的MoE语言模型，解决推理能力与效率平衡问题，通过Think-Fusion训练实现可控推理，提升多场景部署效果。**

- **链接: [https://arxiv.org/pdf/2601.09200v3](https://arxiv.org/pdf/2601.09200v3)**
...
>
---
#### [replaced 026] Enabling Approximate Joint Sampling in Diffusion LMs
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究扩散语言模型中的近似联合采样问题，旨在提升生成文本的准确性与效率。通过引入轻量级采样器，在单次前向传播中实现多token近似联合采样，有效提升生成质量。**

- **链接: [https://arxiv.org/pdf/2509.22738v2](https://arxiv.org/pdf/2509.22738v2)**
...
>
---
#### [replaced 027] BenchPress: A Human-in-the-Loop Annotation System for Rapid Text-to-SQL Benchmark Curation
- **分类: cs.CL; cs.AI; cs.DB; cs.HC**

- **简介: 该论文提出BenchPress系统，用于加速领域特定的文本到SQL基准构建。解决私有数据仓库中人工标注耗时费力的问题，通过人机协作提升标注效率与准确性。**

- **链接: [https://arxiv.org/pdf/2510.13853v2](https://arxiv.org/pdf/2510.13853v2)**
...
>
---
#### [replaced 028] Zero-Shot Stance Detection in the Wild: Dynamic Target Generation and Multi-Target Adaptation
- **分类: cs.CL**

- **简介: 该论文提出零样本立场检测任务，解决真实场景中目标动态变化的问题。构建中文数据集，设计多维评估指标，探索大模型微调策略，提升目标识别与立场检测效果。**

- **链接: [https://arxiv.org/pdf/2601.19802v3](https://arxiv.org/pdf/2601.19802v3)**
...
>
---
#### [replaced 029] Learning the Boundary of Solvability: Aligning LLMs to Detect Unsolvable Problems
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于模型可靠性任务，解决LLM混淆不可解问题与能力不足的问题。通过构建数据集和强化学习框架，提升模型检测不可解问题的能力并增强推理准确性。**

- **链接: [https://arxiv.org/pdf/2512.01661v3](https://arxiv.org/pdf/2512.01661v3)**
...
>
---
#### [replaced 030] On the Effectiveness of Membership Inference in Targeted Data Extraction from Large Language Models
- **分类: cs.LG; cs.CL; cs.CR**

- **简介: 该论文属于隐私安全任务，研究如何通过成员推理攻击从大语言模型中提取训练数据。工作是整合多种MIA技术，评估其在数据提取中的效果。**

- **链接: [https://arxiv.org/pdf/2512.13352v2](https://arxiv.org/pdf/2512.13352v2)**
...
>
---
#### [replaced 031] Entropy Meets Importance: A Unified Head Importance-Entropy Score for Stable and Efficient Transformer Pruning
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于模型压缩任务，旨在解决Transformer模型效率低的问题。通过引入HIES方法，结合重要性与熵值，提升剪枝效果，实现更高效稳定的模型压缩。**

- **链接: [https://arxiv.org/pdf/2510.13832v2](https://arxiv.org/pdf/2510.13832v2)**
...
>
> **备注:** Accepted at FinNLP-2025, EMNLP (Oral Presentation)
>
...
>
---
#### [replaced 036] Understanding the Performance Gap in Preference Learning: A Dichotomy of RLHF and DPO
- **分类: cs.LG; cs.CL**

- **简介: 该论文研究强化学习中RLHF与DPO的性能差异，分析其在不同设定下的表现，揭示两者优劣原因，为方法选择提供依据。**

- **链接: [https://arxiv.org/pdf/2505.19770v3](https://arxiv.org/pdf/2505.19770v3)**

> **作者:** Ruizhe Shi; Minhak Song; Runlong Zhou; Zihan Zhang; Maryam Fazel; Simon S. Du
>
> **备注:** 35 pages, 5 figures. Revision
>
> **摘要:** We present a fine-grained theoretical analysis of the performance gap between reinforcement learning from human feedback (RLHF) and direct preference optimization (DPO) under a representation gap. Our study decomposes this gap into two sources: an explicit representation gap under exact optimization and an implicit representation gap under finite samples. In the exact optimization setting, we characterize how the relative capacities of the reward and policy model classes influence the final policy qualities. We show that RLHF, DPO, or online DPO can outperform one another depending on type of model mis-specifications. Notably, online DPO can outperform both RLHF and standard DPO when the reward and policy model classes are isomorphic and both mis-specified. In the approximate optimization setting, we provide a concrete construction where the ground-truth reward is implicitly sparse and show that RLHF requires significantly fewer samples than DPO to recover an effective reward model, highlighting a statistical advantage of two-stage learning. Together, these results provide a comprehensive understanding of the performance gap between RLHF and DPO under various settings, and offer practical insights into when each method is preferred.
>
---
#### [replaced 037] LLM-Based Multi-Agent Blackboard System for Information Discovery in Data Science
- **分类: cs.MA; cs.AI; cs.CL; cs.IR; cs.LG**

- **简介: 该论文属于数据科学任务，旨在解决大规模数据中信息发现的问题。提出基于LLM的多智能体黑板系统，提升数据检索效率与灵活性。**

- **链接: [https://arxiv.org/pdf/2510.01285v2](https://arxiv.org/pdf/2510.01285v2)**
...
>
---
#### [replaced 038] AutoMonitor-Bench: Evaluating the Reliability of LLM-Based Misbehavior Monitor
- **分类: cs.CL; cs.SE**

- **简介: 该论文属于LLM安全监测任务，旨在评估基于大语言模型的异常行为监测器的可靠性。工作包括构建基准数据集、定义评估指标，并分析监测性能与安全性的平衡。**

- **链接: [https://arxiv.org/pdf/2601.05752v2](https://arxiv.org/pdf/2601.05752v2)**
...
>
---
#### [replaced 044] MedTutor: A Retrieval-Augmented LLM System for Case-Based Medical Education
- **分类: cs.CL**

- **简介: 该论文提出MedTutor系统，属于医学教育任务，旨在解决医学生从病例中高效获取知识的问题。通过RAG技术生成教育内容和试题，提升学习效率。**

- **链接: [https://arxiv.org/pdf/2601.06979v2](https://arxiv.org/pdf/2601.06979v2)**
...
>
---
#### [replaced 045] Efficient Reinforcement Finetuning via Adaptive Curriculum Learning
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于强化学习任务，解决RFT样本和计算效率低的问题，提出AdaRFT方法通过自适应课程学习提升训练效率和准确率。**

- **链接: [https://arxiv.org/pdf/2504.05520v3](https://arxiv.org/pdf/2504.05520v3)**
...
>
---
#### [replaced 048] Check Yourself Before You Wreck Yourself: Selectively Quitting Improves LLM Agent Safety
- **分类: cs.CL**

- **简介: 该论文属于LLM安全任务，旨在提升代理在复杂环境中的安全性。通过引入“退出”机制，减少不确定情况下的风险，实验表明该方法有效提升安全性能且对帮助性影响小。**

- **链接: [https://arxiv.org/pdf/2510.16492v3](https://arxiv.org/pdf/2510.16492v3)**
...
>
---
#### [replaced 049] Unifying Learning Dynamics and Generalization in Transformers Scaling Law
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文研究Transformer模型的泛化与学习动态，解决Scaling Law理论基础不明确的问题，通过ODE分析和SGD训练，建立泛化误差的上界及不同阶段的衰减规律。**

- **链接: [https://arxiv.org/pdf/2512.22088v2](https://arxiv.org/pdf/2512.22088v2)**
...
>
---
#### [replaced 050] AblationBench: Evaluating Automated Planning of Ablations in Empirical AI Research
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出AblationBench，用于评估AI在实验消融设计中的能力，解决自动化科学实验评价难题。通过两个任务测试模型，发现当前模型表现仍低于人类。**

- **链接: [https://arxiv.org/pdf/2507.08038v2](https://arxiv.org/pdf/2507.08038v2)**

> **作者:** Talor Abramovich; Gal Chechik
>
> **备注:** Project page: https://ablation-bench.github.io/
>
...
>
---
#### [replaced 051] GLEAM: Learning to Match and Explain in Cross-View Geo-Localization
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 054] DEBATE: A Large-Scale Benchmark for Role-Playing LLM Agents in Multi-Agent, Long-Form Debates
- **分类: cs.CL**

- **简介: 该论文提出DEBATE基准，用于评估多智能体LLM在长对话中的观点动态真实性。任务是模拟人类群体互动，解决观点变化建模不准确的问题。通过对比真实数据与模型表现，提升模拟的合理性。**

- **链接: [https://arxiv.org/pdf/2510.25110v2](https://arxiv.org/pdf/2510.25110v2)**
...
>
---
#### [replaced 055] Bridging the gap: A comparative exploration of Speech-LLM and end-to-end architecture for multilingual conversational ASR
- **分类: cs.CL; cs.SD; eess.AS**
...
>
---
#### [replaced 056] Using Reinforcement Learning to Train Large Language Models to Explain Human Decisions
- **分类: cs.AI; cs.CL**

- **简介: 该论文属于认知建模任务，旨在解决神经网络模型解释性不足的问题。通过强化学习训练大语言模型，使其既能准确预测人类决策，又能提供自然语言解释。**

- **链接: [https://arxiv.org/pdf/2505.11614v2](https://arxiv.org/pdf/2505.11614v2)**
...
>
---
#### [replaced 057] Teaching LLMs According to Their Aptitude: Adaptive Reasoning for Mathematical Problem Solving
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于数学推理任务，旨在解决LLMs无法自主选择合适推理策略的问题。提出TATA框架，通过适应性数据选择实现模型自主调整推理方式。**

- **链接: [https://arxiv.org/pdf/2502.12022v4](https://arxiv.org/pdf/2502.12022v4)**

> **作者:** Xin Xu; Yan Xu; Tianhao Chen; Yuchen Yan; Chengwu Liu; Zaoyu Chen; Yufei Wang; Yichun Yin; Yasheng Wang; Lifeng Shang; Qun Liu; Lu Yin
>
> **备注:** 8 pages
>
...
>
---
#### [replaced 058] SpatialViz-Bench: A Cognitively-Grounded Benchmark for Diagnosing Spatial Visualization in MLLMs
...
>
---
#### [replaced 059] Learning to Reason in LLMs by Expectation Maximization
- **分类: cs.LG; cs.CL; stat.ML**

- **简介: 该论文属于语言模型推理任务，旨在提升LLMs生成合理推理过程的能力。通过设计有效的采样方案，优化模型生成正确答案的推理路径。**

- **链接: [https://arxiv.org/pdf/2512.20169v2](https://arxiv.org/pdf/2512.20169v2)**
...
>
---
#### [replaced 060] Virtual Community: An Open World for Humans, Robots, and Society
...
>
---
#### [replaced 061] Memento: Towards Proactive Visualization of Everyday Memories with Personal Wearable AR Assistant
- **分类: cs.HC; cs.CL; cs.IR**

- **简介: 该论文提出Memento，一种主动的AR助手，用于记录和关联用户日常记忆与上下文。任务是实现情境感知的主动信息提供，解决传统AR交互短暂性问题，通过长期上下文理解提升用户体验。**

- **链接: [https://arxiv.org/pdf/2601.17622v3](https://arxiv.org/pdf/2601.17622v3)**
...
>
---
#### [replaced 064] Shaping capabilities with token-level data filtering
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于语言模型能力控制任务，旨在减少模型的不良能力。通过过滤预训练数据中的token，有效且经济地实现目标，且效果随模型规模提升。**

- **链接: [https://arxiv.org/pdf/2601.21571v2](https://arxiv.org/pdf/2601.21571v2)**

> **作者:** Neil Rathi; Alec Radford
>
> **备注:** update figure 2
>
> **摘要:** Current approaches to reducing undesired capabilities in language models are largely post hoc, and can thus be easily bypassed by adversaries. A natural alternative is to shape capabilities during pretraining itself. On the proxy task of removing medical capabilities, we show that the simple intervention of filtering pretraining data is highly effective, robust, and inexpensive at scale. Inspired by work on data attribution, we show that filtering tokens is more effective than filtering documents, achieving the same hit to undesired capabilities at a lower cost to benign ones. Training models spanning two orders of magnitude, we then demonstrate that filtering gets more effective with scale: for our largest models, token filtering leads to a 7000x compute slowdown on the forget domain. We also show that models trained with token filtering can still be aligned on the forget domain. Along the way, we introduce a methodology for labeling tokens with sparse autoencoders and distilling cheap, high-quality classifiers. We also demonstrate that filtering can be robust to noisy labels with sufficient pretraining compute.
>
---
#### [replaced 065] When Distance Distracts: Representation Distance Bias in BT-Loss for Reward Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于语言模型对齐任务，针对BT损失函数中因表示距离导致的偏差问题，提出NormBT方法进行优化，提升奖励模型性能。**

- **链接: [https://arxiv.org/pdf/2512.06343v2](https://arxiv.org/pdf/2512.06343v2)**
...
>
---
#### [replaced 066] Less Noise, More Voice: Reinforcement Learning for Reasoning via Instruction Purification
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决LLM推理中因噪声提示导致的探索效率低问题。通过去除干扰令牌并利用净化过程提升训练效率。**

- **链接: [https://arxiv.org/pdf/2601.21244v2](https://arxiv.org/pdf/2601.21244v2)**
...
>
---
#### [replaced 067] Watch and Listen: Understanding Audio-Visual-Speech Moments with Multimodal LLM
- **分类: cs.CL**

- **简介: 该论文属于多模态视频理解任务，旨在解决音频与视觉信息融合不足的问题。提出TriSense模型和TriSense-2M数据集，提升视频时序理解能力。**

- **链接: [https://arxiv.org/pdf/2505.18110v3](https://arxiv.org/pdf/2505.18110v3)**
...
>
---
#### [replaced 068] VisJudge-Bench: Aesthetics and Quality Assessment of Visualizations
...
>
---
#### [replaced 071] PSM: Prompt Sensitivity Minimization via LLM-Guided Black-Box Optimization
- **分类: cs.CR; cs.CL**

- **简介: 该论文属于LLM安全任务，解决系统提示被提取的隐私问题。通过优化方法添加保护层，减少泄露同时保持任务性能。**

- **链接: [https://arxiv.org/pdf/2511.16209v2](https://arxiv.org/pdf/2511.16209v2)**

> **作者:** Huseein Jawad; Nicolas Brunel
>
> **备注:** accepted at the Trustworthy Agentic AI Workshop @ AAAI 2026 (Singapore, Jan 27, 2026). Workshop PDF: https://trustagenticai.github.io/AAAI2026/AAAI-Workshop/20.pdf
>
...
>
---
#### [replaced 072] R-Stitch: Dynamic Trajectory Stitching for Efficient Reasoning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出R-Stitch，解决LLM推理效率问题，通过混合解码框架动态分配计算任务，提升速度并保持精度。**

- **链接: [https://arxiv.org/pdf/2507.17307v5](https://arxiv.org/pdf/2507.17307v5)**
...
>
---
#### [replaced 076] Utility-Diversity Aware Online Batch Selection for LLM Supervised Fine-tuning
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于监督微调任务，解决数据选择效率与效果问题。提出UDS方法，通过核范数和嵌入比较，兼顾数据效用与多样性，提升训练效率与性能。**

- **链接: [https://arxiv.org/pdf/2510.16882v3](https://arxiv.org/pdf/2510.16882v3)**
...
>
---
#### [replaced 077] Mix Data or Merge Models? Balancing the Helpfulness, Honesty, and Harmlessness of Large Language Model via Model Merging
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文属于大语言模型对齐任务，旨在解决Helpfulness、Honesty和Harmlessness三者间的平衡问题。通过比较数据混合与模型合并方法，提出RESM方法提升模型对齐效果。**

- **链接: [https://arxiv.org/pdf/2502.06876v4](https://arxiv.org/pdf/2502.06876v4)**
...
>
> **备注:** arxiv version of NeurIPS2025
>
...
>
---
#### [replaced 078] PAL: Probing Audio Encoders via LLMs -- Audio Information Transfer into LLMs
...
>
> **备注:** 27 pages. Project page: https://github.com/UmeanNever/RankSurprisalRatio
>
...
>
---
#### [replaced 081] Standard-to-Dialect Transfer Trends Differ across Text and Speech: A Case Study on Intent and Topic Classification in German Dialects
- **分类: cs.CL**

- **简介: 该论文研究德语方言与标准语之间的迁移学习，聚焦意图和主题分类任务。对比文本、语音及级联系统的表现，揭示语音设置在方言数据中更优。**

- **链接: [https://arxiv.org/pdf/2510.07890v2](https://arxiv.org/pdf/2510.07890v2)**
...
>
---
#### [replaced 091] From Scores to Steps: Diagnosing and Improving LLM Performance in Evidence-Based Medical Calculations
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于医疗计算任务，旨在解决LLM在医学计算中的信任问题。通过改进评估方法和提出新框架，提升模型的准确性和可解释性。**

- **链接: [https://arxiv.org/pdf/2509.16584v2](https://arxiv.org/pdf/2509.16584v2)**
...
>
---
#### [replaced 096] Stable Signer: Hierarchical Sign Language Generative Model
...
>
---
#### [replaced 099] Can Deep Research Agents Retrieve and Organize? Evaluating the Synthesis Gap with Expert Taxonomies
- **分类: cs.CL**

- **简介: 该论文属于信息组织任务，旨在评估深度研究代理在文献检索与分类能力上的不足。通过构建TaxoBench基准，分析其在检索和结构组织上的缺陷。**

- **链接: [https://arxiv.org/pdf/2601.12369v2](https://arxiv.org/pdf/2601.12369v2)**

> **作者:** Ming Zhang; Jiabao Zhuang; Wenqing Jing; Kexin Tan; Ziyu Kong; Jingyi Deng; Yujiong Shen; Yuhang Zhao; Ning Luo; Renzhe Zheng; Jiahui Lin; Mingqi Wu; Long Ma; Shihan Dou; Tao Gui; Qi Zhang; Xuanjing Huang
>
...
>
---
#### [replaced 100] Retrieval-Augmented Generation for Natural Language Art Provenance Searches in the Getty Provenance Index
- **分类: cs.CL**

- **简介: 该论文属于艺术来源检索任务，旨在解决多语言、碎片化数据搜索困难的问题。通过RAG框架实现自然语言和多语言搜索，提升档案检索效率。**

- **链接: [https://arxiv.org/pdf/2508.19093v2](https://arxiv.org/pdf/2508.19093v2)**
...
>
---
#### [replaced 101] MARS: Co-evolving Dual-System Deep Research via Multi-Agent Reinforcement Learning
- **分类: cs.AI; cs.CL; cs.LG**

- **简介: 该论文提出MARS框架，解决大模型在处理简单任务时的高消耗和知识滞后问题，通过多智能体强化学习优化双系统协同，提升推理效率与准确性。**

- **链接: [https://arxiv.org/pdf/2510.04935v2](https://arxiv.org/pdf/2510.04935v2)**
...
>
---
#### [replaced 107] Future of Work with AI Agents: Auditing Automation and Augmentation Potential across the U.S. Workforce
- **分类: cs.CY; cs.AI; cs.CL; cs.HC; cs.LG**

- **简介: 该论文属于人工智能与劳动关系研究，旨在解决AI agents对工作影响的评估问题。通过构建审计框架和WORKBank数据库，分析任务自动化与增强潜力，识别技术与需求的匹配情况。**

- **链接: [https://arxiv.org/pdf/2506.06576v3](https://arxiv.org/pdf/2506.06576v3)**

> **作者:** Yijia Shao; Humishka Zope; Yucheng Jiang; Jiaxin Pei; David Nguyen; Erik Brynjolfsson; Diyi Yang
>
> **备注:** Preprint, data available at https://futureofwork.saltlab.stanford.edu/
>
...
>
---
#### [replaced 108] Latent Debate: A Surrogate Framework for Interpreting LLM Thinking
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解释大语言模型的内部思维过程及幻觉成因。提出隐式辩论框架，通过分析模型内部隐含的论证信号来实现模型解释和幻觉检测。**

- **链接: [https://arxiv.org/pdf/2512.01909v2](https://arxiv.org/pdf/2512.01909v2)**
...
>
---
#### [replaced 109] When Large Language Models Do Not Work: Online Incivility Prediction through Graph Neural Networks
- **分类: cs.CL; cs.AI; cs.SI**

- **简介: 该论文属于在线不文明行为检测任务，旨在解决现有模型在准确性和效率上的不足。提出一种基于图神经网络的框架，结合文本和关系结构进行预测。**

- **链接: [https://arxiv.org/pdf/2512.07684v2](https://arxiv.org/pdf/2512.07684v2)**
...
>
---
#### [replaced 110] VTC-R1: Vision-Text Compression for Efficient Long-Context Reasoning
- **分类: cs.CL**

- **简介: 该论文属于长文本推理任务，旨在解决大模型推理效率低的问题。通过视觉-文本压缩技术，将推理过程转化为图像，提升效率并保持精度。**

- **链接: [https://arxiv.org/pdf/2601.22069v2](https://arxiv.org/pdf/2601.22069v2)**
...
>
> **摘要:** Long-context reasoning has significantly empowered large language models (LLMs) to tackle complex tasks, yet it introduces severe efficiency bottlenecks due to the computational complexity. Existing efficient approaches often rely on complex additional training or external models for compression, which limits scalability and discards critical fine-grained information. In this paper, we propose VTC-R1, a new efficient reasoning paradigm that integrates vision-text compression into the reasoning process. Instead of processing lengthy textual traces, VTC-R1 renders intermediate reasoning segments into compact images, which are iteratively fed back into vision-language models as "optical memory." We construct a training dataset based on OpenR1-Math-220K achieving 3.4x token compression and fine-tune representative VLMs-Glyph and Qwen3-VL. Extensive experiments on benchmarks such as MATH500, AIME25, AMC23 and GPQA-D demonstrate that VTC-R1 consistently outperforms standard long-context reasoning. Furthermore, our approach significantly improves inference efficiency, achieving 2.7x speedup in end-to-end latency, highlighting its potential as a scalable solution for reasoning-intensive applications. Our code is available at https://github.com/w-yibo/VTC-R1.
>
---
#### [replaced 111] On Group Relative Policy Optimization Collapse in Agent Search: The Lazy Likelihood-Displacement
- **分类: cs.CL**

- **简介: 该论文研究工具集成强化学习中的策略优化崩溃问题，针对GRPO方法的训练不稳定现象，提出LLDS正则化方法以稳定训练并提升性能。**

- **链接: [https://arxiv.org/pdf/2512.04220v2](https://arxiv.org/pdf/2512.04220v2)**

> **作者:** Wenlong Deng; Yushu Li; Boying Gong; Yi Ren; Christos Thrampoulidis; Xiaoxiao Li
>
> **摘要:** Tool-integrated (TI) reinforcement learning (RL) enables large language models (LLMs) to perform multi-step reasoning by interacting with external tools such as search engines and retrievers. Group Relative Policy Optimization (GRPO), exemplified by the recent Search-R1, offers fast convergence and a value-free formulation that makes it appealing for this setting, yet consistently suffers from training collapse. We identify Lazy Likelihood Displacement (LLD), a systematic reduction or stagnation in the likelihood of both correct and incorrect responses, as the core mechanism driving this failure. LLD emerges early and triggers a self-reinforcing LLD Death Spiral, where declining likelihood leads to low-confidence responses, inflating gradients, and ultimately causing collapse. We empirically characterize this process across models on a Search-R1-style, search-integrated question answering task, revealing a consistent three-phase trajectory: early stagnation, steady decay, and accelerated collapse. To address this, we propose a likelihood-preserving regularization LLDS that activates only when a response action's likelihood decreases, and regularizes only the tokens responsible. This fine-grained structure mitigates LLD with minimal interference. Our method stabilizes training, prevents gradient explosion, and yields substantial performance improvements across seven benchmarks, including relative improvements of +45.2% on Qwen2.5-3B and +37.1% on Qwen2.5-7B over vanilla GRPO training. Our results establish LLD as a previously overlooked bottleneck in GRPO-based TIRL and provide a practical path toward stable, scalable training of tool-integrated RL.
>
---
#### [replaced 112] How to Train Your Advisor: Steering Black-Box LLMs with Advisor Models
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文提出Advisor Models，解决黑盒大模型定制化问题。通过小模型生成动态建议，提升大模型性能，实现高效参数优化。**

- **链接: [https://arxiv.org/pdf/2510.02453v2](https://arxiv.org/pdf/2510.02453v2)**

> **作者:** Parth Asawa; Alan Zhu; Abby O'Neill; Matei Zaharia; Alexandros G. Dimakis; Joseph E. Gonzalez
>
...
>
---
#### [replaced 115] LIFT: A Novel Framework for Enhancing Long-Context Understanding of LLMs via Long Input Fine-Tuning
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决长文本理解问题。通过LIFT框架，将长输入微调进模型参数，提升短上下文模型的长文本处理能力。**

- **链接: [https://arxiv.org/pdf/2502.14644v4](https://arxiv.org/pdf/2502.14644v4)**

> **作者:** Yansheng Mao; Yufei Xu; Jiaqi Li; Fanxu Meng; Haotong Yang; Zilong Zheng; Xiyuan Wang; Muhan Zhang
>
> **备注:** 8 pages, 6 figures, preprint
>
...
>
---
#### [replaced 116] Are Large Language Models Sensitive to the Motives Behind Communication?
- **分类: cs.CL; cs.AI; cs.LG**

- **简介: 该论文研究LLM是否能识别信息背后的动机，属于认知建模任务。旨在解决LLM在真实场景中评估信息可信度的问题，通过实验和干预验证其对动机的敏感性。**

- **链接: [https://arxiv.org/pdf/2510.19687v2](https://arxiv.org/pdf/2510.19687v2)**
...
>
---
#### [replaced 117] PaceLLM: Brain-Inspired Large Language Models for Long-Context Understanding
- **分类: q-bio.NC; cs.CL; cs.NE**

- **简介: 该论文提出PaceLLM，解决长文本理解中信息衰减和语义碎片问题，通过模仿大脑工作记忆和皮层模块化，提升模型长上下文性能。**

- **链接: [https://arxiv.org/pdf/2506.17310v2](https://arxiv.org/pdf/2506.17310v2)**
...
>
---
#### [replaced 118] RLKD: Distilling LLMs' Reasoning via Reinforcement Learning
- **分类: cs.CL**

- **简介: 该论文属于模型压缩任务，旨在解决小模型难以有效学习大模型推理结构的问题。提出RLKD框架，通过强化学习和结构奖励模型，使学生模型内化教师的多分支推理结构。**

- **链接: [https://arxiv.org/pdf/2505.16142v4](https://arxiv.org/pdf/2505.16142v4)**
...
>
---
#### [replaced 119] End-to-End Agentic RAG System Training for Traceable Diagnostic Reasoning
- **分类: cs.CL; cs.AI; cs.CV**
...
>
---
#### [replaced 120] Uncertainty-Aware Knowledge Tracing Models
- **分类: cs.LG; cs.CL**

- **简介: 该论文属于知识追踪任务，旨在解决模型在学生选错时预测不准的问题。通过引入预测不确定性，提升模型对错误的识别能力。**

- **链接: [https://arxiv.org/pdf/2509.21514v2](https://arxiv.org/pdf/2509.21514v2)**
...
>
---
#### [replaced 123] Adaptive Testing for LLM Evaluation: A Psychometric Alternative to Static Benchmarks
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于语言模型评估任务，旨在解决传统基准测试效率低、成本高的问题。提出ATLAS框架，通过自适应测试提高评估效率与精度。**

- **链接: [https://arxiv.org/pdf/2511.04689v2](https://arxiv.org/pdf/2511.04689v2)**
...
>
---
#### [replaced 129] Semantic Leakage from Image Embeddings
...
>
---
#### [replaced 130] Beyond Content: How Grammatical Gender Shapes Visual Representation in Text-to-Image Models
- **分类: cs.CL**

- **简介: 该论文研究语言结构对文本生成图像模型的影响，探讨语法性别如何塑造视觉表示。任务属于多模态AI偏见分析，解决语法性别与视觉输出关系的问题，通过跨语言实验验证其影响。**

- **链接: [https://arxiv.org/pdf/2508.03199v4](https://arxiv.org/pdf/2508.03199v4)**
...
>
---
#### [replaced 131] AdaDetectGPT: Adaptive Detection of LLM-Generated Text with Statistical Guarantees
- **分类: cs.CL; cs.AI; cs.LG; stat.ML**

- **简介: 该论文属于文本检测任务，解决区分人类与LLM生成文本的问题。提出AdaDetectGPT，通过自适应学习提升检测性能，并提供统计保障。**

- **链接: [https://arxiv.org/pdf/2510.01268v5](https://arxiv.org/pdf/2510.01268v5)**
...
>
---
#### [replaced 132] Don't Break the Cache: An Evaluation of Prompt Caching for Long-Horizon Agentic Tasks
- **分类: cs.CL**

- **简介: 该论文研究prompt caching在长周期代理任务中的效果，旨在降低API成本和延迟。通过实验对比不同缓存策略，发现合理控制缓存内容能显著提升效率。**

- **链接: [https://arxiv.org/pdf/2601.06007v2](https://arxiv.org/pdf/2601.06007v2)**
...
>
---
#### [replaced 135] CrossCheck-Bench: Diagnosing Compositional Failures in Multimodal Conflict Resolution
- **分类: cs.CL; cs.CV**
...
>
---
#### [replaced 139] Training a Utility-based Retriever Through Shared Context Attribution for Retrieval-Augmented Language Models
- **分类: cs.CL**

- **简介: 该论文属于信息检索任务，旨在解决传统检索器仅关注语义相关性的问题。提出SCARLet框架，通过共享上下文和交互分析提升检索器的实用性，增强生成效果。**

- **链接: [https://arxiv.org/pdf/2504.00573v2](https://arxiv.org/pdf/2504.00573v2)**
...
>
---
#### [replaced 141] Reassessing Active Learning Adoption in Contemporary NLP: A Community Survey
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于自然语言处理领域，旨在探讨主动学习在现实中的应用与挑战。通过社区调查，分析其实施现状、障碍及未来前景，提出缓解策略。**

- **链接: [https://arxiv.org/pdf/2503.09701v4](https://arxiv.org/pdf/2503.09701v4)**
...
>
---
#### [replaced 142] MaiBERT: A Pre-training Corpus and Language Model for Low-Resourced Maithili Language
- **分类: cs.CL**

- **简介: 该论文针对低资源语言Maithili的自然语言理解问题，提出预训练模型maiBERT，通过构建语料库并采用MLM技术进行训练，提升其在新闻分类等任务上的表现。**

- **链接: [https://arxiv.org/pdf/2509.15048v3](https://arxiv.org/pdf/2509.15048v3)**

> **作者:** Sumit Yadav; Raju Kumar Yadav; Utsav Maskey; Gautam Siddharth Kashyap; Ganesh Gautam; Usman Naseem
>
> **备注:** Accepted at EACL LoResLM 2026
>
...
>
---
#### [replaced 143] FreeChunker: A Cross-Granularity Chunking Framework
- **分类: cs.CL**

- **简介: 该论文属于自然语言处理任务，旨在解决RAG系统中固定粒度分块适应性差的问题。提出FreeChunker框架，通过灵活组合句子提升检索效果与效率。**

- **链接: [https://arxiv.org/pdf/2510.20356v2](https://arxiv.org/pdf/2510.20356v2)**

> **作者:** Wenxuan Zhang; Yuan-Hao Jiang; Yang Cao; Yonghe Wu
>
...
>
---
#### [replaced 144] One-Token Rollout: Guiding Supervised Fine-Tuning of LLMs with Policy Gradient
- **分类: cs.CL**

- **简介: 该论文属于大语言模型微调任务，旨在解决SFT泛化能力不足的问题。通过引入OTR算法，将策略梯度应用于微调过程，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2509.26313v2](https://arxiv.org/pdf/2509.26313v2)**
...
>
---
#### [replaced 147] Generalization or Hallucination? Understanding Out-of-Context Reasoning in Transformers
- **分类: cs.CL; cs.LG**

- **简介: 该论文研究Transformer模型在无上下文推理中的泛化与幻觉现象，属于自然语言处理任务。旨在解释模型为何能有效学习新知识却也产生错误信息，通过实验和理论分析揭示其机制。**

- **链接: [https://arxiv.org/pdf/2506.10887v4](https://arxiv.org/pdf/2506.10887v4)**
...
>
---
#### [replaced 150] Paraphrase Types Elicit Prompt Engineering Capabilities
- **分类: cs.CL**

- **简介: 该论文研究语言模型对提示语变化的响应，属于提示工程任务。旨在解决如何通过改写提示提升模型性能的问题。通过系统实验，分析不同语言特征对模型的影响。**

- **链接: [https://arxiv.org/pdf/2406.19898v5](https://arxiv.org/pdf/2406.19898v5)**

> **作者:** Jan Philip Wahle; Terry Ruas; Yang Xu; Bela Gipp
>
> **摘要:** Much of the success of modern language models depends on finding a suitable prompt to instruct the model. Until now, it has been largely unknown how variations in the linguistic expression of prompts affect these models. This study systematically and empirically evaluates which linguistic features influence models through paraphrase types, i.e., different linguistic changes at particular positions. We measure behavioral changes for five models across 120 tasks and six families of paraphrases (i.e., morphology, syntax, lexicon, lexico-syntax, discourse, and others). We also control for other prompt engineering factors (e.g., prompt length, lexical diversity, and proximity to training data). Our results show a potential for language models to improve tasks when their prompts are adapted in specific paraphrase types (e.g., 6.7% median gain in Mixtral 8x7B; 5.5% in LLaMA 3 8B). In particular, changes in morphology and lexicon, i.e., the vocabulary used, showed promise in improving prompts. These findings contribute to developing more robust language models capable of handling variability in linguistic expression.
>
---
#### [replaced 151] Instructional Agents: Reducing Teaching Faculty Workload through Multi-Agent Instructional Design
- **分类: cs.AI; cs.CL**

- **简介: 该论文提出Instructional Agents，一个用于自动化课程设计的多智能体框架，旨在减轻教师工作负担。任务是生成高质量教学材料，解决人力密集型内容制作问题。工作包括设计框架、评估并验证其有效性。**

- **链接: [https://arxiv.org/pdf/2508.19611v3](https://arxiv.org/pdf/2508.19611v3)**

> **作者:** Huaiyuan Yao; Wanpeng Xu; Justin Turnau; Nadia Kellam; Hua Wei
>
> **备注:** Accepted by ECAL'26 main conference; 23 pages, 9 figures
>
...
>
---
#### [replaced 152] SWE-Exp: Experience-Driven Software Issue Resolution
- **分类: cs.SE; cs.CL; cs.LG**

- **简介: 该论文属于软件错误修复任务，旨在解决现有代理缺乏经验积累的问题。通过构建经验库，实现知识复用与持续学习，提升问题解决效率。**

- **链接: [https://arxiv.org/pdf/2507.23361v2](https://arxiv.org/pdf/2507.23361v2)**

> **作者:** Silin Chen; Shaoxin Lin; Yuling Shi; Heng Lian; Xiaodong Gu; Longfei Yun; Dong Chen; Lin Cao; Jiyang Liu; Nu Xia; Qianxiang Wang
>
...
>
---
#### [replaced 153] Stream: Scaling up Mechanistic Interpretability to Long Context in LLMs via Sparse Attention
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于机制可解释性任务，解决长上下文下注意力分析效率低的问题。提出Stream算法，实现高效稀疏注意力分析，提升长文本解释能力。**

- **链接: [https://arxiv.org/pdf/2510.19875v2](https://arxiv.org/pdf/2510.19875v2)**
...
>
---
#### [replaced 154] MEMOIR: Lifelong Model Editing with Minimal Overwrite and Informed Retention for LLMs
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于语言模型持续编辑任务，解决模型在不遗忘旧知识的情况下高效更新新知识的问题。提出MEMOIR框架，通过残差记忆模块实现可靠、可扩展的模型编辑。**

- **链接: [https://arxiv.org/pdf/2506.07899v4](https://arxiv.org/pdf/2506.07899v4)**

> **作者:** Ke Wang; Yiming Qin; Nikolaos Dimitriadis; Alessandro Favero; Pascal Frossard
>
> **备注:** The first two authors contributed equally to this work; Accepted to NeurIPS 2025
>
...
>
---
#### [replaced 160] Diffusion Language Model Inference with Monte Carlo Tree Search
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于文本生成任务，解决扩散语言模型推理中的搜索问题。提出MEDAL框架，结合蒙特卡洛树搜索提升生成质量。**

- **链接: [https://arxiv.org/pdf/2512.12168v2](https://arxiv.org/pdf/2512.12168v2)**
...
>
---
#### [replaced 161] MaPPO: Maximum a Posteriori Preference Optimization with Prior Knowledge
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于语言模型对齐任务，旨在解决如何更有效地将大模型与人类偏好对齐的问题。提出MaPPO方法，结合先验奖励知识优化模型，提升对齐效果。**

- **链接: [https://arxiv.org/pdf/2507.21183v4](https://arxiv.org/pdf/2507.21183v4)**
...
>
---
#### [replaced 162] Mental Health Impacts of AI Companions: Triangulating Social Media Quasi-Experiments, User Perspectives, and Relational Theory
- **分类: cs.HC; cs.AI; cs.CL; cs.CY; stat.AP**

- **简介: 该论文研究AI伴侣对心理健康的影响，通过实验、访谈和理论分析，探讨其利弊并提出设计建议。任务属于心理健康与AI交互研究，解决AI伴侣的心理影响问题，工作包括数据分析和用户调研。**

- **链接: [https://arxiv.org/pdf/2509.22505v2](https://arxiv.org/pdf/2509.22505v2)**
...
>
---
#### [replaced 163] VersatileFFN: Achieving Parameter Efficiency in LLMs via Adaptive Wide-and-Deep Reuse
- **分类: cs.CL**

- **简介: 该论文提出VersatileFFN，解决LLM参数效率问题，通过自适应宽深路径复用参数，提升模型容量而不增加内存。**

- **链接: [https://arxiv.org/pdf/2512.14531v2](https://arxiv.org/pdf/2512.14531v2)**
...
>
---
#### [replaced 166] Inference-Aware Prompt Optimization for Aligning Black-Box Large Language Models
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于大语言模型对齐任务，解决prompt优化与推理策略脱节的问题。提出IAPO框架，联合优化提示和推理规模，提升模型对齐效果。**

- **链接: [https://arxiv.org/pdf/2508.10030v2](https://arxiv.org/pdf/2508.10030v2)**
...
>
---
#### [replaced 167] U-MATH: A University-Level Benchmark for Evaluating Mathematical Skills in LLMs
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出U-MATH基准，用于评估大语言模型的数学能力。针对现有基准不足，构建了1100道大学级题目，涵盖六大学科，包含20%多模态问题，并开发了μ-MATH数据集用于判断解题正确性。**

- **链接: [https://arxiv.org/pdf/2412.03205v4](https://arxiv.org/pdf/2412.03205v4)**

> **作者:** Konstantin Chernyshev; Vitaliy Polshkov; Ekaterina Artemova; Alex Myasnikov; Vlad Stepanov; Alexei Miasnikov; Sergei Tilga
>
> **摘要:** The current evaluation of mathematical skills in LLMs is limited, as existing benchmarks are either relatively small, primarily focus on elementary and high-school problems, or lack diversity in topics. Additionally, the inclusion of visual elements in tasks remains largely under-explored. To address these gaps, we introduce U-MATH, a novel benchmark of 1,100 unpublished open-ended university-level problems sourced from teaching materials. It is balanced across six core subjects, with 20% of multimodal problems. Given the open-ended nature of U-MATH problems, we employ an LLM to judge the correctness of generated solutions. To this end, we release $μ$-MATH, a dataset to evaluate the LLMs' capabilities in judging solutions. Benchmarking leading LLMs reveals marked limitations in multi-modal reasoning, with maximum accuracy reaching 93.1\% on textual tasks but only 58.5\% on visual ones. Furthermore, solution judgment proves challenging, requiring the most advanced models to achieve meaningfully high performance, even still peaking at an imperfect F1-score of 90.1\%.
>
---
#### [replaced 168] Enhancing LLM Reasoning via Non-Human-Like Reasoning Path Preference Optimization
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于增强大语言模型推理任务，解决人类推理路径依赖导致性能受限的问题，提出CGPO方法通过置信度引导非人类推理路径优化。**

- **链接: [https://arxiv.org/pdf/2510.11104v2](https://arxiv.org/pdf/2510.11104v2)**

> **作者:** Junjie Lu; Yuliang Liu; Chaofeng Qu; Wei Shen; Zhouhan Lin; Chuheng Zhang; Min Xu
>
> **备注:** 15 pages
>
...
>
---
#### [replaced 169] Learning to Evolve: Bayesian-Guided Continual Knowledge Graph Embedding
- **分类: cs.CL; cs.LG**

- **简介: 该论文属于知识图谱嵌入任务，解决动态数据更新下的知识演化问题。提出BAKE框架，通过贝叶斯推理和持续聚类，有效防止遗忘并保持语义一致性。**

- **链接: [https://arxiv.org/pdf/2508.02426v3](https://arxiv.org/pdf/2508.02426v3)**
...
>
---
#### [replaced 170] DRIFT: Learning from Abundant User Dissatisfaction in Real-World Preference Learning
- **分类: cs.CL; cs.AI**

- **简介: 该论文属于偏好学习任务，旨在解决真实场景中用户不满信号（DSAT）利用不足的问题。通过DRIFT方法，动态采样正样本并提升模型性能。**

- **链接: [https://arxiv.org/pdf/2510.02341v2](https://arxiv.org/pdf/2510.02341v2)**
...
>
---
#### [replaced 171] A Proof of Learning Rate Transfer under $μ$P
- **分类: stat.ML; cs.AI; cs.CL; cs.LG**

- **简介: 该论文属于理论分析任务，旨在解决学习率迁移问题。研究证明在μP参数化下，宽MLP的最优学习率趋近非零常数，解释了学习率迁移现象。**

- **链接: [https://arxiv.org/pdf/2511.01734v2](https://arxiv.org/pdf/2511.01734v2)**
...
>
---
#### [replaced 172] Mind the Gap: Assessing Wiktionary's Crowd-Sourced Linguistic Knowledge on Morphological Gaps in Two Related Languages
- **分类: cs.CL; cs.CY**

- **简介: 该论文属于计算语言学任务，旨在解决形态缺陷的识别问题。通过分析Wiktionary数据，验证其在拉丁语和意大利语形态缺口上的可靠性，发现部分缺陷词目存在争议。**

- **链接: [https://arxiv.org/pdf/2506.17603v2](https://arxiv.org/pdf/2506.17603v2)**
...
>
---
#### [replaced 173] Mobile-Bench-v2: A More Realistic and Comprehensive Benchmark for VLM-based Mobile Agents
- **分类: cs.CL; cs.AI**

- **简介: 该论文提出Mobile-Bench-v2，用于评估基于视觉语言模型的移动代理。解决现有基准在动态环境、多解任务和噪声处理上的不足，包含多场景评估模块。**

- **链接: [https://arxiv.org/pdf/2505.11891v3](https://arxiv.org/pdf/2505.11891v3)**

> **作者:** Weikai Xu; Zhizheng Jiang; Yuxuan Liu; Pengzhi Gao; Wei Liu; Jian Luan; Yuanchun Li; Yunxin Liu; Bin Wang; Bo An
>
...
>
---
#### [replaced 174] Reward Auditor: Inference on Reward Modeling Suitability in Real-World Perturbed Scenarios
- **分类: cs.CL**

- **简介: 该论文属于模型评估任务，旨在解决奖励模型在真实场景下的可靠性问题。提出Reward Auditor框架，用于检测奖励模型在扰动环境中的系统性漏洞。**

- **链接: [https://arxiv.org/pdf/2512.00920v3](https://arxiv.org/pdf/2512.00920v3)**
...
>
---
#### [replaced 175] Agentic Policy Optimization via Instruction-Policy Co-Evolution
- **分类: cs.LG; cs.AI; cs.CL**

- **简介: 该论文属于强化学习任务，旨在解决静态指令在智能体训练中的局限性。通过引入INSPO框架，实现指令与策略的协同进化，提升智能体的推理能力。**

- **链接: [https://arxiv.org/pdf/2512.01945v2](https://arxiv.org/pdf/2512.01945v2)**
...
>
---
#### [replaced 176] SNAP-UQ: Self-supervised Next-Activation Prediction for Single-Pass Uncertainty in TinyML
- **分类: cs.LG; cs.CL**

- **简介: 该论文提出SNAP-UQ，用于TinyML中的单次通过不确定性估计。通过层间激活预测，实现高效准确的不确定性评估，解决资源受限环境下的模型可靠性问题。**

- **链接: [https://arxiv.org/pdf/2508.12907v2](https://arxiv.org/pdf/2508.12907v2)**
...
>
---
#### [replaced 177] TableMaster: A Recipe to Advance Table Understanding with Language Models
- **分类: cs.CL**

- **简介: 该论文属于表格理解任务，旨在解决语言模型在处理表格数据时的四大挑战。提出TableMaster框架，通过语义增强和自适应推理提升表格理解能力。**

- **链接: [https://arxiv.org/pdf/2501.19378v5](https://arxiv.org/pdf/2501.19378v5)**
...
>
---
#### [replaced 178] CCF: A Context Compression Framework for Efficient Long-Sequence Language Modeling
- **分类: cs.CL**

- **简介: 该论文属于长序列语言建模任务，旨在解决扩展上下文带来的计算与内存效率问题。提出CCF框架，通过结构化压缩提升模型效率与性能。**

- **链接: [https://arxiv.org/pdf/2509.09199v2](https://arxiv.org/pdf/2509.09199v2)**

> **作者:** Wenhao Li; Bangcheng Sun; Weihao Ye; Tianyi Zhang; Daohai Yu; Fei Chao; Rongrong Ji
>
> **备注:** The quality of this paper is low
>
