...
>
---
#### [new 003] Fauna Sprout: A lightweight, approachable, developer-ready humanoid robot
- **分类: cs.RO; cs.AI**

- **简介: 该论文介绍Sprout机器人平台，解决人机共存环境下的安全与可操作性问题。通过轻量化设计和统一软硬件架构，提升开发者部署效率与交互能力。**

- **链接: [https://arxiv.org/pdf/2601.18963v1](https://arxiv.org/pdf/2601.18963v1)**
...
>
---
#### [new 006] Neuromorphic BrailleNet: Accurate and Generalizable Braille Reading Beyond Single Characters through Event-Based Optical Tactile Sensing
- **分类: cs.RO**

- **简介: 该论文属于Braille识别任务，解决传统方法速度慢、计算量大、环境适应性差的问题。提出基于事件的触觉传感系统，实现高效、准确的连续Braille识别。**

- **链接: [https://arxiv.org/pdf/2601.19079v1](https://arxiv.org/pdf/2601.19079v1)**
...
>
---
#### [new 016] Whether We Care, How We Reason: The Dual Role of Anthropomorphism and Moral Foundations in Robot Abuse
- **分类: cs.RO; cs.HC**

- **简介: 该论文属于人机交互研究，探讨机器人被虐待时人们的反应。任务是分析人格化和道德基础如何影响人类对机器人虐待的道德判断，通过混合方法研究验证了两者的作用机制。**

- **链接: [https://arxiv.org/pdf/2601.19826v1](https://arxiv.org/pdf/2601.19826v1)**
...
>
---
#### [new 020] Judgelight: Trajectory-Level Post-Optimization for Multi-Agent Path Finding via Closed-Subwalk Collapsing
- **分类: cs.RO**

- **简介: 该论文属于多智能体路径规划任务，解决学习型方法生成轨迹质量低的问题，提出Judgelight方法通过压缩闭合子路径优化轨迹，降低代价。**

- **链接: [https://arxiv.org/pdf/2601.19388v1](https://arxiv.org/pdf/2601.19388v1)**
...
>
---
#### [new 021] Teaching Machine Learning Fundamentals with LEGO Robotics
- **分类: cs.RO; cs.AI; cs.CY; cs.HC; cs.LG**

- **简介: 该论文属于教育技术任务，旨在通过LEGO机器人教学使青少年理解机器学习。工作包括开发可视化平台和课程，提升学生对算法的理解与兴趣。**

- **链接: [https://arxiv.org/pdf/2601.19376v1](https://arxiv.org/pdf/2601.19376v1)**
...
>
---
#### [new 022] SCOPE: Smooth Convex Optimization for Planned Evolution of Deformable Linear Objects
- **分类: cs.RO; eess.SY**

- **简介: 该论文提出SCOPE框架，用于建模和操作可变形线性物体。针对传统方法计算成本高、速度慢的问题，采用凸近似方法提升效率，同时保持变形的平滑与物理合理性。**

- **链接: [https://arxiv.org/pdf/2601.19742v1](https://arxiv.org/pdf/2601.19742v1)**
...
>
---
#### [new 032] Physical Human-Robot Interaction: A Critical Review of Safety Constraints
- **分类: eess.SY; cs.RO**

- **简介: 论文探讨物理人机交互中的安全约束，分析ISO/TS 15066标准的理论基础与应用影响，旨在提升安全控制设计。任务为安全评估，解决问题为约束的有效性与实施方法。**

- **链接: [https://arxiv.org/pdf/2601.19462v1](https://arxiv.org/pdf/2601.19462v1)**
...
>
---
#### [new 035] Unsupervised Learning of Efficient Exploration: Pre-training Adaptive Policies via Self-Imposed Goals
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于强化学习领域，解决预训练策略在未知任务中的高效探索与适应问题。通过自设目标和元学习方法，提升模型的泛化与适应能力。**

- **链接: [https://arxiv.org/pdf/2601.19810v1](https://arxiv.org/pdf/2601.19810v1)**

> **作者:** Octavio Pappalardo
>
> **备注:** To appear at ICLR 2026
>
> **摘要:** Unsupervised pre-training can equip reinforcement learning agents with prior knowledge and accelerate learning in downstream tasks. A promising direction, grounded in human development, investigates agents that learn by setting and pursuing their own goals. The core challenge lies in how to effectively generate, select, and learn from such goals. Our focus is on broad distributions of downstream tasks where solving every task zero-shot is infeasible. Such settings naturally arise when the target tasks lie outside of the pre-training distribution or when their identities are unknown to the agent. In this work, we (i) optimize for efficient multi-episode exploration and adaptation within a meta-learning framework, and (ii) guide the training curriculum with evolving estimates of the agent's post-adaptation performance. We present ULEE, an unsupervised meta-learning method that combines an in-context learner with an adversarial goal-generation strategy that maintains training at the frontier of the agent's capabilities. On XLand-MiniGrid benchmarks, ULEE pre-training yields improved exploration and adaptation abilities that generalize to novel objectives, environment dynamics, and map structures. The resulting policy attains improved zero-shot and few-shot performance, and provides a strong initialization for longer fine-tuning processes. It outperforms learning from scratch, DIAYN pre-training, and alternative curricula.
>
---
#### [new 036] Safe Exploration via Policy Priors
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于安全强化学习任务，旨在解决在线学习中的安全探索问题。通过利用保守策略作为先验，提出SOOPER方法，在保证安全的同时实现有效探索与最优策略收敛。**

- **链接: [https://arxiv.org/pdf/2601.19612v1](https://arxiv.org/pdf/2601.19612v1)**
...
>
---
#### [new 039] The S3LI Vulcano Dataset: A Dataset for Multi-Modal SLAM in Unstructured Planetary Environments
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 040] How Does Delegation in Social Interaction Evolve Over Time? Navigation with a Robot for Blind People
- **分类: cs.HC; cs.RO**

- **简介: 该论文研究盲人与导航机器人协作的互动演化，旨在解决如何在长期使用中调整用户对机器人依赖程度的问题。通过实验分析用户策略变化，为自适应机器人设计提供依据。**

- **链接: [https://arxiv.org/pdf/2601.19851v1](https://arxiv.org/pdf/2601.19851v1)**

> **作者:** Rayna Hata; Masaki Kuribayashi; Allan Wang; Hironobu Takagi; Chieko Asakawa
>
> **备注:** Pre-print of paper accepted into CHI 2026
>
> **摘要:** Autonomy and independent navigation are vital to daily life but remain challenging for individuals with blindness. Robotic systems can enhance mobility and confidence by providing intelligent navigation assistance. However, fully autonomous systems may reduce users' sense of control, even when they wish to remain actively involved. Although collaboration between user and robot has been recognized as important, little is known about how perceptions of this relationship change with repeated use. We present a repeated exposure study with six blind participants who interacted with a navigation-assistive robot in a real-world museum. Participants completed tasks such as navigating crowds, approaching lines, and encountering obstacles. Findings show that participants refined their strategies over time, developing clearer preferences about when to rely on the robot versus act independently. This work provides insights into how strategies and preferences evolve with repeated interaction and offers design implications for robots that adapt to user needs over time.
>
---
#### [new 041] Toward Learning POMDPs Beyond Full-Rank Actions and State Observability
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文研究如何在部分可观测环境下学习POMDP模型，解决隐藏状态和非全秩动作的问题。通过PSR和张量方法，学习观测和转移矩阵的分块表示，提升模型性能。**

- **链接: [https://arxiv.org/pdf/2601.18930v1](https://arxiv.org/pdf/2601.18930v1)**
...
#### [replaced 001] Constraint-Aware Discrete-Time PID Gain Optimization for Robotic Joint Control Under Actuator Saturation
- **分类: cs.RO**

- **简介: 该论文属于机器人关节控制任务，解决离散时间PID在执行器饱和下的优化问题。通过分析稳定性、抗饱和策略和贝叶斯优化，提升控制性能与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.18639v2](https://arxiv.org/pdf/2601.18639v2)**
...
>
---
#### [replaced 002] xFLIE: Leveraging Actionable Hierarchical Scene Representations for Autonomous Semantic-Aware Inspection Missions
- **分类: cs.RO**

- **简介: 该论文提出xFLIE框架，解决自主语义感知巡检任务中的场景建模与路径规划问题，通过构建3DLSG实现高效环境理解与导航。**

- **链接: [https://arxiv.org/pdf/2412.19571v2](https://arxiv.org/pdf/2412.19571v2)**
...
>
---
#### [replaced 005] Studying the Effect of Explicit Interaction Representations on Learning Scene-level Distributions of Human Trajectories
- **分类: cs.RO**

- **简介: 该论文属于场景中行人轨迹分布建模任务，旨在解决如何有效表示智能体间交互的问题。通过实验比较不同交互表示方式对联合分布学习的影响，发现显式交互能提升性能。**

- **链接: [https://arxiv.org/pdf/2511.04375v2](https://arxiv.org/pdf/2511.04375v2)**
...
>
---
#### [replaced 006] A Riemannian Take on Distance Fields and Geodesic Flows in Robotics
- **分类: cs.RO**

- **简介: 该论文属于机器人学任务，解决非欧几里得空间中的距离场与测地线计算问题。通过求解黎曼eikonal方程，构建神经网络方法实现高效、高维的测地距离场。**

- **链接: [https://arxiv.org/pdf/2412.05197v3](https://arxiv.org/pdf/2412.05197v3)**

> **作者:** Yiming Li; Jiacheng Qiu; Sylvain Calinon
>
> **备注:** 27 pages, 20 figures. International Journal of Robotics Research (IJRR)
>
...
>
---
#### [replaced 007] LangForce: Bayesian Decomposition of Vision Language Action Models via Latent Action Queries
...
>
---
#### [replaced 008] CBMC-V3: A CNS-inspired Control Framework Towards Agile Manipulation with SNN
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决服务领域中机械臂在复杂环境下的敏捷操作问题。提出一种基于SNN的仿生控制框架，提升控制性能。**

- **链接: [https://arxiv.org/pdf/2511.04109v3](https://arxiv.org/pdf/2511.04109v3)**
...
>
---
#### [replaced 009] Equi-RO: A 4D mmWave Radar Odometry via Equivariant Networks
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 010] Automating Box Folding: Sequence Extraction and Ranking Methodologies
- **分类: cs.RO; cs.SE**

- **简介: 该论文属于自动化包装任务，解决盒式结构折叠序列的提取与排序问题。提出方法识别并评估折叠序列，提升系统适应性与可行性。**

- **链接: [https://arxiv.org/pdf/2505.04257v2](https://arxiv.org/pdf/2505.04257v2)**

> **作者:** Giuseppe Fabio Preziosa; Davide Ferloni; Andrea Maria Zanchettin; Marco Faroni; Paolo Rocco
>
> **备注:** Accepted at IFAC ROBOTICS 2025
>
> **摘要:** Box folding represents a crucial challenge for automated packaging systems. This work bridges the gap between existing methods for folding sequence extraction and approaches focused on the adaptability of automated systems to specific box types. An innovative method is proposed to identify and rank folding sequences, enabling the transformation of a box from an initial state to a desired final configuration. The system evaluates and ranks these sequences based on their feasibility and compatibility with available hardware, providing recommendations for real-world implementations. Finally, an illustrative use case is presented, where a robot performs the folding of a box.
>
---
#### [replaced 011] MetaVLA: Unified Meta Co-training For Efficient Embodied Adaption
- **分类: cs.AI; cs.RO**

- **简介: 该论文提出MetaVLA，解决VLA模型泛化能力差、训练成本高的问题，通过元学习实现高效多任务适应。**

- **链接: [https://arxiv.org/pdf/2510.05580v2](https://arxiv.org/pdf/2510.05580v2)**
...
>
---
#### [replaced 012] PneuGelSight: Soft Robotic Vision-Based Proprioception and Tactile Sensing
- **分类: cs.RO**

- **简介: 该论文属于软体机器人感知任务，旨在解决软体机器人缺乏精确触觉和本体感觉的问题。提出PneuGelSight系统，结合视觉实现高精度传感，并建立模拟到现实的迁移方法。**

- **链接: [https://arxiv.org/pdf/2508.18443v2](https://arxiv.org/pdf/2508.18443v2)**

> **作者:** Ruohan Zhang; Uksang Yoo; Yichen Li; Arpit Agarwal; Wenzhen Yuan
>
