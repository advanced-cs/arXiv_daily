...
#### [new 001] BHaRNet: Reliability-Aware Body-Hand Modality Expertized Networks for Fine-grained Skeleton Action Recognition
- **分类: cs.CV**

- **简介: 该论文属于细粒度骨架动作识别任务，解决现有方法忽略手部细节的问题。提出BHaRNet框架，融合多模态信息并增强可靠性，提升在噪声环境下的识别性能。**

- **链接: [https://arxiv.org/pdf/2601.00369v1](https://arxiv.org/pdf/2601.00369v1)**

> **作者:** Seungyeon Cho; Tae-kyun Kim
>
> **备注:** 16 pages; 8 figures. Extension of previous conference paper. Project page: https://github.com/VinnyCSY/BHaRNet
>
...
>
---
#### [new 002] Noise-Robust Tiny Object Localization with Flows
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于目标检测任务，解决tiny object在噪声标注下的定位问题。提出TOLF框架，利用归一化流进行误差建模和不确定性引导优化，提升鲁棒性。**

- **链接: [https://arxiv.org/pdf/2601.00617v1](https://arxiv.org/pdf/2601.00617v1)**
...
>
---
#### [new 003] Towards Syn-to-Real IQA: A Novel Perspective on Reshaping Synthetic Data Distributions
- **分类: cs.CV**

- **简介: 该论文属于图像质量评估任务，解决合成数据泛化能力不足的问题。通过调整数据分布提升模型性能，提出SynDR-IQA框架。**

- **链接: [https://arxiv.org/pdf/2601.00225v1](https://arxiv.org/pdf/2601.00225v1)**

> **作者:** Aobo Li; Jinjian Wu; Yongxu Liu; Leida Li; Weisheng Dong
>
> **备注:** Accepted by NIPS 2025
>
> **摘要:** Blind Image Quality Assessment (BIQA) has advanced significantly through deep learning, but the scarcity of large-scale labeled datasets remains a challenge. While synthetic data offers a promising solution, models trained on existing synthetic datasets often show limited generalization ability. In this work, we make a key observation that representations learned from synthetic datasets often exhibit a discrete and clustered pattern that hinders regression performance: features of high-quality images cluster around reference images, while those of low-quality images cluster based on distortion types. Our analysis reveals that this issue stems from the distribution of synthetic data rather than model architecture. Consequently, we introduce a novel framework SynDR-IQA, which reshapes synthetic data distribution to enhance BIQA generalization. Based on theoretical derivations of sample diversity and redundancy's impact on generalization error, SynDR-IQA employs two strategies: distribution-aware diverse content upsampling, which enhances visual diversity while preserving content distribution, and density-aware redundant cluster downsampling, which balances samples by reducing the density of densely clustered areas. Extensive experiments across three cross-dataset settings (synthetic-to-authentic, synthetic-to-algorithmic, and synthetic-to-synthetic) demonstrate the effectiveness of our method. The code is available at https://github.com/Li-aobo/SynDR-IQA.
>
---
#### [new 004] SafeMo: Linguistically Grounded Unlearning for Trustworthy Text-to-Motion Generation
- **分类: cs.CV**

- **简介: 该论文属于文本到动作生成任务，解决模型安全性问题。提出SafeMo框架，通过最小运动遗忘策略实现安全动作生成，提升安全性和性能。**

- **链接: [https://arxiv.org/pdf/2601.00590v1](https://arxiv.org/pdf/2601.00590v1)**

> **作者:** Yiling Wang; Zeyu Zhang; Yiran Wang; Hao Tang
>
> **摘要:** Text-to-motion (T2M) generation with diffusion backbones achieves strong realism and alignment. Safety concerns in T2M methods have been raised in recent years; existing methods replace discrete VQ-VAE codebook entries to steer the model away from unsafe behaviors. However, discrete codebook replacement-based methods have two critical flaws: firstly, replacing codebook entries which are reused by benign prompts leads to drifts on everyday tasks, degrading the model's benign performance; secondly, discrete token-based methods introduce quantization and smoothness loss, resulting in artifacts and jerky transitions. Moreover, existing text-to-motion datasets naturally contain unsafe intents and corresponding motions, making them unsuitable for safety-driven machine learning. To address these challenges, we propose SafeMo, a trustworthy motion generative framework integrating Minimal Motion Unlearning (MMU), a two-stage machine unlearning strategy, enabling safe human motion generation in continuous space, preserving continuous kinematics without codebook loss and delivering strong safety-utility trade-offs compared to current baselines. Additionally, we present the first safe text-to-motion dataset SafeMoVAE-29K integrating rewritten safe text prompts and continuous refined motion for trustworthy human motion unlearning. Built upon DiP, SafeMo efficiently generates safe human motions with natural transitions. Experiments demonstrate effective unlearning performance of SafeMo by showing strengthened forgetting on unsafe prompts, reaching 2.5x and 14.4x higher forget-set FID on HumanML3D and Motion-X respectively, compared to the previous SOTA human motion unlearning method LCR, with benign performance on safe prompts being better or comparable. Code: https://github.com/AIGeeksGroup/SafeMo. Website: https://aigeeksgroup.github.io/SafeMo.
>
---
#### [new 005] Pixel-to-4D: Camera-Controlled Image-to-Video Generation with Dynamic 3D Gaussians
- **分类: cs.CV**

- **简介: 该论文属于图像到视频生成任务，旨在解决单图生成视频时的动态3D一致性与相机控制问题。通过构建3D高斯场景表示，实现高效、可控的视频生成。**

- **链接: [https://arxiv.org/pdf/2601.00678v1](https://arxiv.org/pdf/2601.00678v1)**
...
>
---
#### [new 006] Reconstructing Building Height from Spaceborne TomoSAR Point Clouds Using a Dual-Topology Network
- **分类: cs.CV**

- **简介: 该论文属于建筑高度重建任务，解决TomoSAR点云噪声和数据缺失问题，提出双拓扑网络进行点云到高度图的转换。**

- **链接: [https://arxiv.org/pdf/2601.00658v1](https://arxiv.org/pdf/2601.00658v1)**
...
>
---
#### [new 016] SV-GS: Sparse View 4D Reconstruction with Skeleton-Driven Gaussian Splatting
- **分类: cs.CV**

- **简介: 该论文属于4D动态重建任务，解决稀疏观测下的运动重建问题。提出SV-GS框架，结合骨架驱动的变形场，实现高效、准确的动态场景重建。**

- **链接: [https://arxiv.org/pdf/2601.00285v1](https://arxiv.org/pdf/2601.00285v1)**

> **作者:** Jun-Jee Chao; Volkan Isler
>
> **摘要:** Reconstructing a dynamic target moving over a large area is challenging. Standard approaches for dynamic object reconstruction require dense coverage in both the viewing space and the temporal dimension, typically relying on multi-view videos captured at each time step. However, such setups are only possible in constrained environments. In real-world scenarios, observations are often sparse over time and captured sparsely from diverse viewpoints (e.g., from security cameras), making dynamic reconstruction highly ill-posed. We present SV-GS, a framework that simultaneously estimates a deformation model and the object's motion over time under sparse observations. To initialize SV-GS, we leverage a rough skeleton graph and an initial static reconstruction as inputs to guide motion estimation. (Later, we show that this input requirement can be relaxed.) Our method optimizes a skeleton-driven deformation field composed of a coarse skeleton joint pose estimator and a module for fine-grained deformations. By making only the joint pose estimator time-dependent, our model enables smooth motion interpolation while preserving learned geometric details. Experiments on synthetic datasets show that our method outperforms existing approaches under sparse observations by up to 34% in PSNR, and achieves comparable performance to dense monocular video methods on real-world datasets despite using significantly fewer frames. Moreover, we demonstrate that the input initial static reconstruction can be replaced by a diffusion-based generative prior, making our method more practical for real-world scenarios.
>
---
#### [new 017] Unified Primitive Proxies for Structured Shape Completion
- **分类: cs.CV**

- **简介: 该论文属于3D形状补全任务，解决从不完整数据中恢复结构化几何的问题。提出UniCo方法，通过统一的原始代理实现更准确的补全。**

- **链接: [https://arxiv.org/pdf/2601.00759v1](https://arxiv.org/pdf/2601.00759v1)**
...
>
---
#### [new 018] FCMBench: A Comprehensive Financial Credit Multimodal Benchmark for Real-world Applications
- **分类: cs.CV; cs.AI; cs.CE; cs.MM**

- **简介: 该论文提出FCMBench，一个面向金融信用的多模态基准，解决真实场景下的信用评估与文档审核问题，涵盖18种证书类型，包含隐私合规数据和多种任务评估模型性能。**

- **链接: [https://arxiv.org/pdf/2601.00150v1](https://arxiv.org/pdf/2601.00150v1)**
...
>
---
#### [new 019] CropNeRF: A Neural Radiance Field-Based Framework for Crop Counting
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 020] Grading Handwritten Engineering Exams with Multimodal Large Language Models
- **分类: cs.CV**

- **简介: 该论文属于自动评分任务，旨在解决手写工程试题人工评分效率低的问题。通过多模态大语言模型构建端到端评分流程，实现高效、可靠且可审计的评分。**

- **链接: [https://arxiv.org/pdf/2601.00730v1](https://arxiv.org/pdf/2601.00730v1)**
...
>
---
#### [new 032] FreeText: Training-Free Text Rendering in Diffusion Transformers via Attention Localization and Spectral Glyph Injection
- **分类: cs.CV**

- **简介: 该论文属于文本图像生成任务，解决多行文本、密集排版和长尾语言（如中文）的精确渲染问题。提出FreeText框架，通过注意力定位和频域字形注入提升文本可读性。**

- **链接: [https://arxiv.org/pdf/2601.00535v1](https://arxiv.org/pdf/2601.00535v1)**

> **作者:** Ruiqiang Zhang; Hengyi Wang; Chang Liu; Guanjie Wang; Zehua Ma; Weiming Zhang
>
> **摘要:** Large-scale text-to-image (T2I) diffusion models excel at open-domain synthesis but still struggle with precise text rendering, especially for multi-line layouts, dense typography, and long-tailed scripts such as Chinese. Prior solutions typically require costly retraining or rigid external layout constraints, which can degrade aesthetics and limit flexibility. We propose \textbf{FreeText}, a training-free, plug-and-play framework that improves text rendering by exploiting intrinsic mechanisms of \emph{Diffusion Transformer (DiT)} models. \textbf{FreeText} decomposes the problem into \emph{where to write} and \emph{what to write}. For \emph{where to write}, we localize writing regions by reading token-wise spatial attribution from endogenous image-to-text attention, using sink-like tokens as stable spatial anchors and topology-aware refinement to produce high-confidence masks. For \emph{what to write}, we introduce Spectral-Modulated Glyph Injection (SGMI), which injects a noise-aligned glyph prior with frequency-domain band-pass modulation to strengthen glyph structure and suppress semantic leakage (rendering the concept instead of the word). Extensive experiments on Qwen-Image, FLUX.1-dev, and SD3 variants across longText-Benchmark, CVTG, and our CLT-Bench show consistent gains in text readability while largely preserving semantic alignment and aesthetic quality, with modest inference overhead.
>
---
#### [new 033] IntraStyler: Exemplar-based Style Synthesis for Cross-modality Domain Adaptation
- **分类: cs.CV**

- **简介: 该论文属于跨模态域适应任务，旨在解决目标域数据风格多样性不足的问题。提出IntraStyler方法，通过示例图像引导风格合成，提升生成数据的多样性。**

- **链接: [https://arxiv.org/pdf/2601.00212v1](https://arxiv.org/pdf/2601.00212v1)**
...
>
> **摘要:** Image-level domain alignment is the de facto approach for unsupervised domain adaptation, where unpaired image translation is used to minimize the domain gap. Prior studies mainly focus on the domain shift between the source and target domains, whereas the intra-domain variability remains under-explored. To address the latter, an effective strategy is to diversify the styles of the synthetic target domain data during image translation. However, previous methods typically require intra-domain variations to be pre-specified for style synthesis, which may be impractical. In this paper, we propose an exemplar-based style synthesis method named IntraStyler, which can capture diverse intra-domain styles without any prior knowledge. Specifically, IntraStyler uses an exemplar image to guide the style synthesis such that the output style matches the exemplar style. To extract the style-only features, we introduce a style encoder to learn styles discriminatively based on contrastive learning. We evaluate the proposed method on the largest public dataset for cross-modality domain adaptation, CrossMoDA 2023. Our experiments show the efficacy of our method in controllable style synthesis and the benefits of diverse synthetic data for downstream segmentation. Code is available at https://github.com/han-liu/IntraStyler.
>
---
#### [new 034] Intelligent Traffic Surveillance for Real-Time Vehicle Detection, License Plate Recognition, and Speed Estimation
- **分类: cs.CV**

- **简介: 该论文属于交通监控任务，旨在解决道路安全问题。通过计算机视觉技术实现车辆检测、车牌识别和速度估计，并建立数据库支持自动开罚单，提升交通管理效率。**

- **链接: [https://arxiv.org/pdf/2601.00344v1](https://arxiv.org/pdf/2601.00344v1)**
...
>
---
#### [new 037] TotalFM: An Organ-Separated Framework for 3D-CT Vision Foundation Models
- **分类: cs.CV**

- **简介: 该论文提出TotalFM，解决3D-CT影像与文本对齐问题，通过器官分离框架提升计算效率与模型性能。**

- **链接: [https://arxiv.org/pdf/2601.00260v1](https://arxiv.org/pdf/2601.00260v1)**

> **作者:** Kohei Yamamoto; Tomohiro Kikuchi
>
> **摘要:** While foundation models in radiology are expected to be applied to various clinical tasks, computational cost constraints remain a major challenge when training on 3D-CT volumetric data. In this study, we propose TotalFM, a radiological foundation model that efficiently learns the correspondence between 3D-CT images and linguistic expressions based on the concept of organ separation, utilizing a large-scale dataset of 140,000 series. By automating the creation of organ volume and finding-sentence pairs through segmentation techniques and Large Language Model (LLM)-based radiology report processing, and by combining self-supervised pre-training via VideoMAE with contrastive learning using volume-text pairs, we aimed to balance computational efficiency and representation capability. In zero-shot organ-wise lesion classification tasks, the proposed model achieved higher F1 scores in 83% (5/6) of organs compared to CT-CLIP and 64% (9/14) of organs compared to Merlin. These results suggest that the proposed model exhibits high generalization performance in a clinical evaluation setting using actual radiology report sentences. Furthermore, in zero-shot finding-wise lesion classification tasks, our model achieved a higher AUROC in 83% (25/30) of finding categories compared to Merlin. We also confirmed performance comparable to existing Vision-Language Models (VLMs) in radiology report generation tasks. Our results demonstrate that the organ-separated learning framework can serve as a realistic and effective design guideline for the practical implementation of 3D-CT foundation models.
>
---
#### [new 038] From Sight to Insight: Improving Visual Reasoning Capabilities of Multimodal Models via Reinforcement Learning
- **分类: cs.CV; cs.CL**
...
>
---
#### [new 039] Efficient Deep Demosaicing with Spatially Downsampled Isotropic Networks
- **分类: cs.CV**

- **简介: 该论文属于图像去马赛克任务，旨在提升深度学习模型的效率与性能。通过引入空间下采样，设计高效网络结构，提升移动端应用的可行性。**

- **链接: [https://arxiv.org/pdf/2601.00703v1](https://arxiv.org/pdf/2601.00703v1)**
...
>
---
#### [new 040] Quality Detection of Stored Potatoes via Transfer Learning: A CNN and Vision Transformer Approach
- **分类: cs.CV**

- **简介: 该论文属于图像质量检测任务，旨在通过深度学习技术检测存储土豆的品质问题，如发芽、重量损失和保质期预测。研究采用迁移学习方法，构建了高效的分类模型。**

- **链接: [https://arxiv.org/pdf/2601.00645v1](https://arxiv.org/pdf/2601.00645v1)**
...
>
---
#### [new 047] Context-Aware Pesticide Recommendation via Few-Shot Pest Recognition for Precision Agriculture
- **分类: cs.CV**

- **简介: 该论文属于农业害虫识别与农药推荐任务，旨在解决传统 pest 管理成本高、效率低的问题。通过轻量级 CNN 和元学习实现少样本害虫识别，并结合环境因素推荐环保农药。**

- **链接: [https://arxiv.org/pdf/2601.00243v1](https://arxiv.org/pdf/2601.00243v1)**
...
>
---
#### [new 049] HyperPriv-EPN: Hypergraph Learning with Privileged Knowledge for Ependymoma Prognosis
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医疗诊断任务，旨在解决术前脑膜瘤预后预测问题。通过引入超图学习框架，利用术后文本信息提升术前影像分析效果。**

- **链接: [https://arxiv.org/pdf/2601.00626v1](https://arxiv.org/pdf/2601.00626v1)**
...
>
---
#### [new 050] Boosting Segment Anything Model to Generalize Visually Non-Salient Scenarios
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，旨在解决SAM在低对比度场景下的分割效果问题。通过改进模型结构和构建专用数据集，提升其在非显著场景中的性能。**

- **链接: [https://arxiv.org/pdf/2601.00537v1](https://arxiv.org/pdf/2601.00537v1)**

> **作者:** Guangqian Guo; Pengfei Chen; Yong Guo; Huafeng Chen; Boqiang Zhang; Shan Gao
>
> **备注:** Accepted by IEEE TIP
>
> **摘要:** Segment Anything Model (SAM), known for its remarkable zero-shot segmentation capabilities, has garnered significant attention in the community. Nevertheless, its performance is challenged when dealing with what we refer to as visually non-salient scenarios, where there is low contrast between the foreground and background. In these cases, existing methods often cannot capture accurate contours and fail to produce promising segmentation results. In this paper, we propose Visually Non-Salient SAM (VNS-SAM), aiming to enhance SAM's perception of visually non-salient scenarios while preserving its original zero-shot generalizability. We achieve this by effectively exploiting SAM's low-level features through two designs: Mask-Edge Token Interactive decoder and Non-Salient Feature Mining module. These designs help the SAM decoder gain a deeper understanding of non-salient characteristics with only marginal parameter increments and computational requirements. The additional parameters of VNS-SAM can be optimized within 4 hours, demonstrating its feasibility and practicality. In terms of data, we established VNS-SEG, a unified dataset for various VNS scenarios, with more than 35K images, in contrast to previous single-task adaptations. It is designed to make the model learn more robust VNS features and comprehensively benchmark the model's segmentation performance and generalizability on VNS scenarios. Extensive experiments across various VNS segmentation tasks demonstrate the superior performance of VNS-SAM, particularly under zero-shot settings, highlighting its potential for broad real-world applications. Codes and datasets are publicly available at https://guangqian-guo.github.io/VNS-SAM.
>
---
#### [new 051] RePose: A Real-Time 3D Human Pose Estimation and Biomechanical Analysis Framework for Rehabilitation
- **分类: cs.CV**

- **简介: 该论文提出RePose框架，用于康复训练中的实时3D人体姿态估计与运动分析，解决康复过程中动作监测与反馈问题，实现快速、准确的姿势评估与可视化。**

- **链接: [https://arxiv.org/pdf/2601.00625v1](https://arxiv.org/pdf/2601.00625v1)**
...
>
---
#### [new 055] A Comprehensive Dataset for Human vs. AI Generated Image Detection
- **分类: cs.CV; cs.AI**

- **简介: 该论文提出MS COCOAI数据集，用于检测AI生成图像。任务包括区分真实与生成图像及识别生成模型，解决虚假信息传播问题。**

- **链接: [https://arxiv.org/pdf/2601.00553v1](https://arxiv.org/pdf/2601.00553v1)**
...
>
---
#### [new 056] It's Never Too Late: Noise Optimization for Collapse Recovery in Trained Diffusion Models
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于文本到图像生成任务，旨在解决模式崩溃问题。通过噪声优化提升生成多样性，同时保持模型质量。**

- **链接: [https://arxiv.org/pdf/2601.00090v1](https://arxiv.org/pdf/2601.00090v1)**
...
>
---
#### [new 057] RGS-SLAM: Robust Gaussian Splatting SLAM with One-Shot Dense Initialization
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 058] Spatial4D-Bench: A Versatile 4D Spatial Intelligence Benchmark
- **分类: cs.CV**

- **简介: 该论文提出Spatial4D-Bench，用于评估多模态大语言模型的4D空间智能。旨在解决模型在时空推理方面的不足，通过大规模多任务基准测试，揭示其局限性。**

- **链接: [https://arxiv.org/pdf/2601.00092v1](https://arxiv.org/pdf/2601.00092v1)**
...
>
---
#### [new 059] Multi-Level Feature Fusion for Continual Learning in Visual Quality Inspection
- **分类: cs.CV**

- **简介: 该论文属于视觉质量检测任务，解决持续学习中的模型适应与遗忘问题。提出多层级特征融合方法，提升模型适应新场景的能力，同时减少参数量和遗忘现象。**

- **链接: [https://arxiv.org/pdf/2601.00725v1](https://arxiv.org/pdf/2601.00725v1)**
...
>
---
#### [new 060] AEGIS: Exploring the Limit of World Knowledge Capabilities for Unified Mulitmodal Models
- **分类: cs.CV**

- **简介: 该论文属于多模态模型研究，旨在解决统一多模态模型在跨任务应用世界知识的不足。提出AEGIS基准和DCE评估方法，以更可靠地测试模型的世界知识能力。**

- **链接: [https://arxiv.org/pdf/2601.00561v1](https://arxiv.org/pdf/2601.00561v1)**

> **作者:** Jintao Lin; Bowen Dong; Weikang Shi; Chenyang Lei; Suiyun Zhang; Rui Liu; Xihui Liu
>
> **摘要:** The capability of Unified Multimodal Models (UMMs) to apply world knowledge across diverse tasks remains a critical, unresolved challenge. Existing benchmarks fall short, offering only siloed, single-task evaluations with limited diagnostic power. To bridge this gap, we propose AEGIS (\emph{i.e.}, \textbf{A}ssessing \textbf{E}diting, \textbf{G}eneration, \textbf{I}nterpretation-Understanding for \textbf{S}uper-intelligence), a comprehensive multi-task benchmark covering visual understanding, generation, editing, and interleaved generation. AEGIS comprises 1,050 challenging, manually-annotated questions spanning 21 topics (including STEM, humanities, daily life, etc.) and 6 reasoning types. To concretely evaluate the performance of UMMs in world knowledge scope without ambiguous metrics, we further propose Deterministic Checklist-based Evaluation (DCE), a protocol that replaces ambiguous prompt-based scoring with atomic ``Y/N'' judgments, to enhance evaluation reliability. Our extensive experiments reveal that most UMMs exhibit severe world knowledge deficits and that performance degrades significantly with complex reasoning. Additionally, simple plug-in reasoning modules can partially mitigate these vulnerabilities, highlighting a promising direction for future research. These results highlight the importance of world-knowledge-based reasoning as a critical frontier for UMMs.
>
---
#### [new 061] ActErase: A Training-Free Paradigm for Precise Concept Erasure via Activation Patching
- **分类: cs.CV**

- **简介: 该论文属于概念擦除任务，旨在解决扩散模型中敏感概念泄露问题。提出无需训练的ActErase方法，通过激活差异区域替换实现高效概念擦除。**

- **链接: [https://arxiv.org/pdf/2601.00267v1](https://arxiv.org/pdf/2601.00267v1)**
...
>
---
#### [new 064] SingBAG Pro: Accelerating point cloud-based iterative reconstruction for 3D photoacoustic imaging under arbitrary array
- **分类: cs.CV**

- **简介: 该论文属于3D光声成像任务，旨在解决不规则阵列下重建速度慢的问题。提出SlingBAG Pro算法，提升重建效率与兼容性。**

- **链接: [https://arxiv.org/pdf/2601.00551v1](https://arxiv.org/pdf/2601.00551v1)**
...
>
---
#### [new 068] FaithSCAN: Model-Driven Single-Pass Hallucination Detection for Faithful Visual Question Answering
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉问答任务，解决VQA中的幻觉问题。提出FaithSCAN模型，通过内部信号检测幻觉，提升检测效果与效率。**

- **链接: [https://arxiv.org/pdf/2601.00269v1](https://arxiv.org/pdf/2601.00269v1)**
...
>
---
#### [new 069] Next Generation Intelligent Low-Altitude Economy Deployments: The O-RAN Perspective
- **分类: eess.SY; cs.AI; cs.CV; cs.MA; cs.NI**

- **简介: 该论文属于智能低空经济部署任务，解决复杂环境中无人机协同调度问题，提出基于O-RAN的框架，结合AI实现高效任务执行。**

- **链接: [https://arxiv.org/pdf/2601.00257v1](https://arxiv.org/pdf/2601.00257v1)**
...
>
---
#### [new 071] Optimized Hybrid Feature Engineering for Resource-Efficient Arrhythmia Detection in ECG Signals: An Optimization Framework
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于心律失常检测任务，旨在解决深度学习模型计算开销大的问题，通过优化特征工程实现资源高效检测。**

- **链接: [https://arxiv.org/pdf/2601.00192v1](https://arxiv.org/pdf/2601.00192v1)**
...
>
---
#### [new 072] Investigating the Viability of Employing Multi-modal Large Language Models in the Context of Audio Deepfake Detection
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 073] From Clay to Code: Typological and Material Reasoning in AI Interpretations of Iranian Pigeon Towers
- **分类: cs.AI; cs.CV**

- **简介: 论文研究AI对伊朗鸽塔建筑智能的解读，分析其在形态、材料、环境等方面的再现能力。属于AI与建筑认知任务，旨在探讨AI如何感知和重构传统设计。**

- **链接: [https://arxiv.org/pdf/2601.00029v1](https://arxiv.org/pdf/2601.00029v1)**
...
>
---
#### [new 076] Neural Brain Fields: A NeRF-Inspired Approach for Generating Nonexistent EEG Electrodes
...
>
---
#### [new 077] Explicit Abstention Knobs for Predictable Reliability in Video Question Answering
- **分类: cs.AI; cs.CV**

- **简介: 该论文属于视频问答任务，研究如何通过置信度阈值控制错误率，提升模型在分布变化下的可靠性。**

- **链接: [https://arxiv.org/pdf/2601.00138v1](https://arxiv.org/pdf/2601.00138v1)**
...
>
---
#### [new 078] Automated electrostatic characterization of quantum dot devices in single- and bilayer heterostructures
- **分类: cond-mat.mes-hall; cs.CV; cs.ET; cs.LG; quant-ph**

- **简介: 该论文属于量子点器件表征任务，旨在解决手动分析电荷稳定性图耗时且易错的问题。通过机器学习和图像处理实现自动化分析，提取电容特性参数。**

- **链接: [https://arxiv.org/pdf/2601.00067v1](https://arxiv.org/pdf/2601.00067v1)**
...
>
---
#### [new 079] Deep Learning Approach for the Diagnosis of Pediatric Pneumonia Using Chest X-ray Imaging
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学图像分类任务，旨在解决儿科肺炎的自动化诊断问题。通过迁移学习使用CNN模型对胸片进行分类，提升诊断准确性和效率。**

- **链接: [https://arxiv.org/pdf/2601.00041v1](https://arxiv.org/pdf/2601.00041v1)**
...
>
---
#### [new 080] FedHypeVAE: Federated Learning with Hypernetwork Generated Conditional VAEs for Differentially Private Embedding Sharing
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文提出FedHypeVAE，解决联邦学习中嵌入数据合成的隐私与分布对齐问题，通过生成式方法实现安全共享。**

- **链接: [https://arxiv.org/pdf/2601.00785v1](https://arxiv.org/pdf/2601.00785v1)**
...
#### [replaced 001] Physically-Grounded Manifold Projection Model for Generalizable Metal Artifact Reduction in Dental CBCT
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.24260v2](https://arxiv.org/pdf/2512.24260v2)**
...
>
---
#### [replaced 003] Fair Domain Generalization: An Information-Theoretic View
- **分类: cs.LG; cs.CV**

- **链接: [https://arxiv.org/pdf/2507.05823v3](https://arxiv.org/pdf/2507.05823v3)**

> **作者:** Tangzheng Lian; Guanyu Hu; Dimitrios Kollias; Xinyu Yang; Oya Celiktutan
>
> **备注:** Accepted at AAAI (Oral)
>
...
>
---
#### [replaced 004] Med-2D SegNet: A Light Weight Deep Neural Network for Medical 2D Image Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.14715v2](https://arxiv.org/pdf/2504.14715v2)**

> **作者:** Lameya Sabrin; Md. Sanaullah Chowdhury; Salauddin Tapu; Noyon Kumar Sarkar; Ferdous Bin Ali
>
...
>
---
#### [replaced 005] Spatially-Grounded Document Retrieval via Patch-to-Region Relevance Propagation
- **分类: cs.CV; cs.IR**

- **链接: [https://arxiv.org/pdf/2512.02660v3](https://arxiv.org/pdf/2512.02660v3)**
...
- **链接: [https://arxiv.org/pdf/2510.06751v2](https://arxiv.org/pdf/2510.06751v2)**
...
>
---
#### [replaced 007] UltraGS: Real-Time Physically-Decoupled Gaussian Splatting for Ultrasound Novel View Synthesis
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.07743v2](https://arxiv.org/pdf/2511.07743v2)**

> **作者:** Yuezhe Yang; Qingqing Ruan; Wenjie Cai; Yudang Dong; Dexin Yang; Xingbo Dong; Zhe Jin; Yong Dai
>
> **备注:** Under Review
>
...
>
---
#### [replaced 008] YOLO-IOD: Towards Real Time Incremental Object Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22973v2](https://arxiv.org/pdf/2512.22973v2)**
...
>
---
#### [replaced 009] Semantic Anchor Transport: Robust Test-Time Adaptation for Vision-Language Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2411.17002v3](https://arxiv.org/pdf/2411.17002v3)**
...
>
---
#### [replaced 010] Towards Knowledge Guided Pretraining Approaches for Multimodal Foundation Models: Applications in Remote Sensing
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2407.19660v4](https://arxiv.org/pdf/2407.19660v4)**

> **作者:** Praveen Ravirathinam; Ajitesh Parthasarathy; Ankush Khandelwal; Rahul Ghosh; Vipin Kumar
>
> **备注:** 31 pages with appendix
>
...
>
---
#### [replaced 013] AutoTrust: Benchmarking Trustworthiness in Large Vision Language Models for Autonomous Driving
- **分类: cs.CV; cs.LG; cs.RO**
...
>
---
#### [replaced 014] GameTileNet: A Semantic Dataset for Low-Resolution Game Art in Procedural Content Generation
...
>
---
#### [replaced 015] AnyCXR: Human Anatomy Segmentation of Chest X-ray at Any Acquisition Position using Multi-stage Domain Randomized Synthetic Data with Imperfect Annotations and Conditional Joint Annotation Regularization Learning
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.17263v2](https://arxiv.org/pdf/2512.17263v2)**

> **作者:** Zifei Dong; Wenjie Wu; Jinkui Hao; Tianqi Chen; Ziqiao Weng; Bo Zhou
>
...
>
---
#### [replaced 016] FoundationSLAM: Unleashing the Power of Depth Foundation Models for End-to-End Dense Visual SLAM
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.25008v2](https://arxiv.org/pdf/2512.25008v2)**

> **作者:** Yuchen Wu; Jiahe Li; Fabio Tosi; Matteo Poggi; Jin Zheng; Xiao Bai
>
> **备注:** Accept at AAAI 2026 (Oral)
>
> **摘要:** We present FoundationSLAM, a learning-based monocular dense SLAM system that addresses the absence of geometric consistency in previous flow-based approaches for accurate and robust tracking and mapping. Our core idea is to bridge flow estimation with geometric reasoning by leveraging the guidance from foundation depth models. To this end, we first develop a Hybrid Flow Network that produces geometry-aware correspondences, enabling consistent depth and pose inference across diverse keyframes. To enforce global consistency, we propose a Bi-Consistent Bundle Adjustment Layer that jointly optimizes keyframe pose and depth under multi-view constraints. Furthermore, we introduce a Reliability-Aware Refinement mechanism that dynamically adapts the flow update process by distinguishing between reliable and uncertain regions, forming a closed feedback loop between matching and optimization. Extensive experiments demonstrate that FoundationSLAM achieves superior trajectory accuracy and dense reconstruction quality across multiple challenging datasets, while running in real-time at 18 FPS, demonstrating strong generalization to various scenarios and practical applicability of our method.
>
---
#### [replaced 017] NeRF-VIO: Map-Based Visual-Inertial Odometry with Initialization Leveraging Neural Radiance Fields
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 018] Satellite to Street : Disaster Impact Estimator
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.00065v2](https://arxiv.org/pdf/2512.00065v2)**
...
>
---
#### [replaced 019] LEL: Lipschitz Continuity Constrained Ensemble Learning for Efficient EEG-Based Intra-subject Emotion Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.09156v3](https://arxiv.org/pdf/2504.09156v3)**
...
>
---
#### [replaced 020] A Low-Cost UAV Deep Learning Pipeline for Integrated Apple Disease Diagnosis,Freshness Assessment, and Fruit Detection
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22990v2](https://arxiv.org/pdf/2512.22990v2)**

> **作者:** Soham Dutta; Soham Banerjee; Sneha Mahata; Anindya Sen; Sayantani Datta
>
> **备注:** This revision fixes minor typographical and phrasing issues
>
...
>
---
#### [replaced 023] A Survey on 3D Gaussian Splatting Applications: Segmentation, Editing, and Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.09977v3](https://arxiv.org/pdf/2508.09977v3)**
...
>
---
#### [replaced 024] JavisGPT: A Unified Multi-modal LLM for Sounding-Video Comprehension and Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22905v2](https://arxiv.org/pdf/2512.22905v2)**
...
>
---
#### [replaced 025] CrownGen: Patient-customized Crown Generation via Point Diffusion Model
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.21890v2](https://arxiv.org/pdf/2512.21890v2)**
...
>
---
#### [replaced 026] Task-oriented Learnable Diffusion Timesteps for Universal Few-shot Learning of Dense Tasks
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23210v2](https://arxiv.org/pdf/2512.23210v2)**

> **作者:** Changgyoon Oh; Jongoh Jeong; Jegyeong Cho; Kuk-Jin Yoon
>
> **备注:** Prematurely uploaded without mutual consent by all authors, with critical modifications necessary in the references
>
...
>
---
#### [replaced 032] Lamps: Learning Anatomy from Multiple Perspectives via Self-supervision in Chest Radiographs
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22872v2](https://arxiv.org/pdf/2512.22872v2)**
...
>
---
#### [replaced 033] EndoStreamDepth: Temporally Consistent Monocular Depth Estimation for Endoscopic Video Streams
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.18159v2](https://arxiv.org/pdf/2512.18159v2)**
...
>
---
#### [replaced 034] PoseStreamer: A Multi-modal Framework for 3D Tracking of Unseen Moving Objects
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.22979v3](https://arxiv.org/pdf/2512.22979v3)**
...
>
---
#### [replaced 035] Digital implementations of deep feature extractors are intrinsically informative
- **分类: cs.LG; cs.CV; math.FA**

- **链接: [https://arxiv.org/pdf/2502.15004v3](https://arxiv.org/pdf/2502.15004v3)**

> **作者:** Max Getter
>
> **备注:** 6 pages; updated to match the published manuscript of SampTA 2025 proceedings (IEEE Xplore); added IEEE copyright notice
>
> **摘要:** Rapid information (energy) propagation in deep feature extractors is crucial to balance computational complexity versus expressiveness as a representation of the input. We prove an upper bound for the speed of energy propagation in a unified framework that covers different neural network models, both over Euclidean and non-Euclidean domains. Additional structural information about the signal domain can be used to explicitly determine or improve the rate of decay. To illustrate this, we show global exponential energy decay for a range of 1) feature extractors with discrete-domain input signals, and 2) convolutional neural networks (CNNs) via scattering over locally compact abelian (LCA) groups.
>
---
#### [replaced 036] HiSin: A Sinogram-Aware Framework for Efficient High-Resolution Inpainting
- **分类: cs.CV; eess.IV**

- **链接: [https://arxiv.org/pdf/2506.08809v3](https://arxiv.org/pdf/2506.08809v3)**
...
>
---
#### [replaced 039] Error Propagation Mechanisms and Compensation Strategies for Quantized Diffusion
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.12094v3](https://arxiv.org/pdf/2508.12094v3)**
...
>
---
#### [replaced 040] Revisiting Out-of-Distribution Detection in Real-time Object Detection: From Benchmark Pitfalls to a New Mitigation Paradigm
- **分类: cs.CV; cs.AI; cs.SE**

- **链接: [https://arxiv.org/pdf/2503.07330v4](https://arxiv.org/pdf/2503.07330v4)**

> **作者:** Changshun Wu; Weicheng He; Chih-Hong Cheng; Xiaowei Huang; Saddek Bensalem
>
> **备注:** Accepted at IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)
>
...
>
---
#### [replaced 041] CubeBench: Diagnosing Interactive, Long-Horizon Spatial Reasoning Under Partial Observations
...
>
---
#### [replaced 042] Body-Hand Modality Expertized Networks with Cross-attention for Fine-grained Skeleton Action Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.14960v4](https://arxiv.org/pdf/2503.14960v4)**

> **作者:** Seungyeon Cho; Tae-Kyun Kim
>
> **备注:** 7 figures, 8 pages. Accepted to IROS 2025, project page: https://github.com/VinnyCSY/BHaRNet
>
...
>
---
#### [replaced 043] Beyond Accuracy: What Matters in Designing Well-Behaved Image Classification Models?
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2503.17110v2](https://arxiv.org/pdf/2503.17110v2)**

> **作者:** Robin Hesse; Doğukan Bağcı; Bernt Schiele; Simone Schaub-Meyer; Stefan Roth
>
> **备注:** Published in TMLR (12/2025) | OpenReview: https://openreview.net/forum?id=E7HDtLCoT6 | Project page: https://visinf.github.io/beyond-accuracy/
>
...
>
---
#### [replaced 046] Matrix-free Second-order Optimization of Gaussian Splats with Residual Sampling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.12905v2](https://arxiv.org/pdf/2504.12905v2)**
...
>
---
#### [replaced 047] WorldMem: Long-term Consistent World Simulation with Memory
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.12369v3](https://arxiv.org/pdf/2504.12369v3)**
...
>
---
#### [replaced 048] Efficient Multi-Task Scene Analysis with RGB-D Transformers
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 049] FreeGraftor: Training-Free Cross-Image Feature Grafting for Subject-Driven Text-to-Image Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.15958v4](https://arxiv.org/pdf/2504.15958v4)**

> **作者:** Zebin Yao; Lei Ren; Huixing Jiang; Wei Chen; Xiaojie Wang; Ruifan Li; Fangxiang Feng
>
> **备注:** Code: https://github.com/Nihukat/FreeGraftor
>
...
>
---
#### [replaced 050] Unsupervised Representation Learning for 3D Mesh Parameterization with Semantic and Visibility Objectives
- **分类: cs.GR; cs.CV**

- **链接: [https://arxiv.org/pdf/2509.25094v2](https://arxiv.org/pdf/2509.25094v2)**
...
>
---
#### [replaced 051] ASemConsist: Adaptive Semantic Feature Control for Training-Free Identity-Consistent Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.23245v2](https://arxiv.org/pdf/2512.23245v2)**
