...
#### [new 001] UNIC: Learning Unified Multimodal Extrinsic Contact Estimation
...
>
---
#### [new 006] Generate, Transfer, Adapt: Learning Functional Dexterous Grasping from a Single Human Demonstration
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 012] Data-Driven Terramechanics Approach Towards a Realistic Real-Time Simulator for Lunar Rovers
- **分类: cs.RO**

- **简介: 该论文属于 lunar rover 模拟任务，旨在解决现有模拟器在视觉与物理准确性上的不足。通过数据驱动方法构建 terramechanics 模型，实现高精度实时地形交互模拟。**

- **链接: [https://arxiv.org/pdf/2601.04547v1](https://arxiv.org/pdf/2601.04547v1)**
...
>
---
#### [new 016] Multiagent Reinforcement Learning with Neighbor Action Estimation
- **分类: cs.RO; cs.LG**

- **简介: 该论文属于多智能体强化学习任务，旨在解决真实环境中通信受限导致的协作难题。通过引入动作估计网络，实现无需共享动作的协同决策，提升系统鲁棒性与可行性。**

- **链接: [https://arxiv.org/pdf/2601.04511v1](https://arxiv.org/pdf/2601.04511v1)**
...
>
---
#### [new 022] RoboVIP: Multi-View Video Generation with Visual Identity Prompting Augments Robot Manipulation
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [new 023] Enhanced-FQL($λ$), an Efficient and Interpretable RL with novel Fuzzy Eligibility Traces and Segmented Experience Replay
- **分类: cs.LG; cs.AI; cs.RO; eess.SY; math.OC**

- **简介: 该论文提出Enhanced-FQL(λ)框架，用于连续控制任务，解决样本效率和可解释性问题，结合模糊规则与经验回放机制，提升性能并降低复杂度。**

- **链接: [https://arxiv.org/pdf/2601.04392v1](https://arxiv.org/pdf/2601.04392v1)**
...
>
---
#### [new 024] Online Action-Stacking Improves Reinforcement Learning Performance for Air Traffic Control
- **分类: cs.LG; cs.AI; cs.MA; cs.RO**

- **简介: 该论文属于强化学习在空中交通管制中的应用任务，旨在解决指令频繁和动作空间复杂的问题。通过在线动作叠加技术，减少指令数量并提升性能。**

- **链接: [https://arxiv.org/pdf/2601.04287v1](https://arxiv.org/pdf/2601.04287v1)**
...
>
---
#### [new 025] DAVOS: An Autonomous Vehicle Operating System in the Vehicle Computing Era
- **分类: cs.OS; cs.RO**

- **简介: 该论文属于车载操作系统研究，旨在解决自动驾驶车辆中实时控制与数据服务协调问题。提出DAVOS系统，实现安全、高效、可扩展的统一操作系统架构。**

- **链接: [https://arxiv.org/pdf/2601.05072v1](https://arxiv.org/pdf/2601.05072v1)**
...
>
---
#### [new 028] Nightmare Dreamer: Dreaming About Unsafe States And Planning Ahead
- **分类: cs.LG; cs.RO**

- **简介: 该论文属于安全强化学习任务，旨在解决RL应用中的安全问题。通过构建世界模型预测并避免安全违规，提出Nightmare Dreamer算法，在保证安全的同时提升效率。**

- **链接: [https://arxiv.org/pdf/2601.04686v1](https://arxiv.org/pdf/2601.04686v1)**
...
#### [replaced 001] Generative Models From and For Sampling-Based MPC: A Bootstrapped Approach For Adaptive Contact-Rich Manipulation
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，解决接触丰富的操作问题。通过生成模型优化采样预测控制，提升采样效率与规划性能。**

- **链接: [https://arxiv.org/pdf/2510.14643v2](https://arxiv.org/pdf/2510.14643v2)**
...
>
---
#### [replaced 002] Uncertainty-Aware Robotic World Model Makes Offline Model-Based Reinforcement Learning Work on Real Robots
- **分类: cs.RO; cs.AI; cs.LG**

- **简介: 该论文属于机器人强化学习任务，解决真实机器人中离线模型基于强化学习的泛化与稳定性问题。通过引入不确定性感知的世界模型和优化策略，提升长期滚动的可靠性与性能。**

- **链接: [https://arxiv.org/pdf/2504.16680v3](https://arxiv.org/pdf/2504.16680v3)**
...
>
---
#### [replaced 003] Bio-Skin: A Cost-Effective Thermostatic Tactile Sensor with Multi-Modal Force and Temperature Detection
- **分类: cs.RO**

- **简介: 该论文属于机器人感知任务，旨在解决高成本、复杂结构的触觉传感器问题。提出Bio-Skin，集成力与温度检测，采用低成本元件实现多模态传感。**

- **链接: [https://arxiv.org/pdf/2503.07989v3](https://arxiv.org/pdf/2503.07989v3)**
...
>
---
#### [replaced 004] Cognitive-Hierarchy Guided End-to-End Planning for Autonomous Driving
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 005] $π_0$: A Vision-Language-Action Flow Model for General Robot Control
- **分类: cs.LG; cs.RO**

- **简介: 该论文提出一种视觉-语言-动作流模型π_0，用于通用机器人控制。解决机器人学习在数据、泛化和鲁棒性方面的难题，通过预训练模型和多平台数据训练，实现零样本任务执行与技能迁移。**

- **链接: [https://arxiv.org/pdf/2410.24164v4](https://arxiv.org/pdf/2410.24164v4)**
...
>
---
#### [replaced 006] Nonholonomic Robot Parking by Feedback -- Part I: Modular Strict CLF Designs
- **分类: eess.SY; cs.RO; math.DS; math.OC**

- **简介: 该论文属于非完整机器人停车控制任务，解决非holonomic系统稳定问题。通过模块化设计，提出多种反馈控制律及严格控制Lyapunov函数，实现系统稳定与约束满足。**

- **链接: [https://arxiv.org/pdf/2511.15119v3](https://arxiv.org/pdf/2511.15119v3)**
...
>
---
#### [replaced 007] Enhancing Sampling-based Planning with a Library of Paths
- **分类: cs.RO**

- **简介: 该论文属于机器人路径规划任务，解决3D物体在狭窄通道中采样困难的问题。通过构建路径库复用历史经验，提升规划效率。**

- **链接: [https://arxiv.org/pdf/2510.12962v2](https://arxiv.org/pdf/2510.12962v2)**
...
>
---
#### [replaced 008] Forging Spatial Intelligence: A Roadmap of Multi-Modal Data Pre-Training for Autonomous Systems
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 009] Human-Aided Trajectory Planning for Automated Vehicles through Teleoperation and Arbitration Graphs
- **分类: cs.RO; cs.HC**

- **简介: 该论文属于自动驾驶任务，解决远程协助集成难题。通过仲裁图框架，在不修改原有系统的情况下，实现远程干预规划，扩展车辆操作范围。**

- **链接: [https://arxiv.org/pdf/2502.02207v2](https://arxiv.org/pdf/2502.02207v2)**
...
>
---
#### [replaced 011] SynDroneVision: A Synthetic Dataset for Image-Based Drone Detection
- **分类: cs.CV; cs.AI; cs.RO**
...
>
---
#### [replaced 012] Solving Robotics Tasks with Prior Demonstration via Exploration-Efficient Deep Reinforcement Learning
- **分类: cs.RO; cs.LG**

- **简介: 该论文研究机器人任务学习，解决探索效率低和过拟合问题。提出DRLR框架，结合示范与深度强化学习，提升任务性能与泛化能力。**

- **链接: [https://arxiv.org/pdf/2509.04069v2](https://arxiv.org/pdf/2509.04069v2)**
...
>
---
#### [replaced 015] FoldNet: Learning Generalizable Closed-Loop Policy for Garment Folding via Keypoint-Driven Asset and Demonstration Synthesis
- **分类: cs.RO; cs.CV**
