...
#### [new 001] Optimized Human-Robot Co-Dispatch Planning for Petro-Site Surveillance under Varying Criticalities
- **分类: cs.RO; cs.AI; math.OC**

- **简介: 该论文属于优化调度任务，解决石油站点监控中人机协同分配问题，通过建立HRCD-FLP模型，实现高效且可靠的资源部署。**

- **链接: [https://arxiv.org/pdf/2602.07924v1](https://arxiv.org/pdf/2602.07924v1)**
...
>
---
#### [new 002] A Distributed Multi-Modal Sensing Approach for Human Activity Recognition in Real-Time Human-Robot Collaboration
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 003] Chamelion: Reliable Change Detection for Long-Term LiDAR Mapping in Transient Environments
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 008] Constrained Sampling to Guide Universal Manipulation RL
- **分类: cs.RO**

- **简介: 该论文属于强化学习任务，旨在解决复杂操作中的稀疏奖励问题。通过模型引导采样，提升策略探索效率，实现通用操作控制。**

- **链接: [https://arxiv.org/pdf/2602.08557v1](https://arxiv.org/pdf/2602.08557v1)**
...
>
---
#### [new 022] Feasibility-Guided Planning over Multi-Specialized Locomotion Policies
- **分类: cs.RO**

- **简介: 该论文属于机器人路径规划任务，解决多专家策略在复杂地形中的整合问题。提出一种基于可行性网络的规划框架，实现高效可靠路径生成。**

- **链接: [https://arxiv.org/pdf/2602.07932v1](https://arxiv.org/pdf/2602.07932v1)**
...
>
---
#### [new 027] Research on a Camera Position Measurement Method based on a Parallel Perspective Error Transfer Model
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 028] Robustness Is a Function, Not a Number: A Factorized Comprehensive Study of OOD Robustness in Vision-Based Driving
...
>
---
#### [new 033] When Simultaneous Localization and Mapping Meets Wireless Communications: A Survey
...
>
---
#### [new 034] TwinRL-VLA: Digital Twin-Driven Reinforcement Learning for Real-World Robotic Manipulation
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，旨在解决VLA模型在真实世界中探索效率低、依赖专家示范的问题。通过构建数字孪生框架TwinRL，提升探索效率与泛化能力。**

- **链接: [https://arxiv.org/pdf/2602.09023v1](https://arxiv.org/pdf/2602.09023v1)**
...
>
---
#### [new 042] FeudalNav: A Simple Framework for Visual Navigation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 050] Reliability-aware Execution Gating for Near-field and Off-axis Vision-guided Robotic Alignment
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 051] RLinf-USER: A Unified and Extensible System for Real-World Online Policy Learning in Embodied AI
- **分类: cs.RO**

- **简介: 该论文属于 embodied AI 领域，解决真实世界在线策略学习的系统问题。提出 USER 系统，实现多机器人协调与高效训练。**

- **链接: [https://arxiv.org/pdf/2602.07837v1](https://arxiv.org/pdf/2602.07837v1)**
...
>
---
#### [new 065] $χ_{0}$: Resource-Aware Robust Manipulation via Taming Distributional Inconsistencies
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 066] Continuum Robot Localization using Distributed Time-of-Flight Sensors
- **分类: cs.RO**

- **简介: 该论文属于机器人定位任务，解决软体机器人在非结构化环境中的定位问题。通过分布式低分辨率时间飞行传感器，结合机器人形状先验，实现精准定位。**

- **链接: [https://arxiv.org/pdf/2602.07209v1](https://arxiv.org/pdf/2602.07209v1)**
...
>
---
#### [new 067] GaussianCaR: Gaussian Splatting for Efficient Camera-Radar Fusion
- **分类: cs.RO**

- **简介: 该论文属于多传感器融合任务，旨在提升自动驾驶中的环境感知。针对视觉与雷达数据的视差问题，提出GaussianCaR方法，通过高斯泼溅实现高效相机-雷达融合，提升BEV分割性能。**

- **链接: [https://arxiv.org/pdf/2602.08784v1](https://arxiv.org/pdf/2602.08784v1)**
...
>
> **摘要:** Robust and accurate perception of dynamic objects and map elements is crucial for autonomous vehicles performing safe navigation in complex traffic scenarios. While vision-only methods have become the de facto standard due to their technical advances, they can benefit from effective and cost-efficient fusion with radar measurements. In this work, we advance fusion methods by repurposing Gaussian Splatting as an efficient universal view transformer that bridges the view disparity gap, mapping both image pixels and radar points into a common Bird's-Eye View (BEV) representation. Our main contribution is GaussianCaR, an end-to-end network for BEV segmentation that, unlike prior BEV fusion methods, leverages Gaussian Splatting to map raw sensor information into latent features for efficient camera-radar fusion. Our architecture combines multi-scale fusion with a transformer decoder to efficiently extract BEV features. Experimental results demonstrate that our approach achieves performance on par with, or even surpassing, the state of the art on BEV segmentation tasks (57.3%, 82.9%, and 50.1% IoU for vehicles, roads, and lane dividers) on the nuScenes dataset, while maintaining a 3.2x faster inference runtime. Code and project page are available online.
>
---
#### [new 068] Going with the Flow: Koopman Behavioral Models as Implicit Planners for Visuo-Motor Dexterity
- **分类: cs.RO**

- **简介: 该论文属于机器人视觉-运动控制任务，旨在解决多指灵巧操作中的技能学习与规划问题。提出UBMs框架，通过动态系统建模实现更连贯、灵活的控制。**

- **链接: [https://arxiv.org/pdf/2602.07413v1](https://arxiv.org/pdf/2602.07413v1)**
...
>
---
#### [new 088] Hierarchical JEPA Meets Predictive Remote Control in Beyond 5G Networks
- **分类: eess.SY; cs.AI; cs.RO**

- **简介: 该论文属于无线控制任务，解决高维状态传输与通信效率的矛盾。提出H-JEPA架构，通过嵌入空间预测实现高效控制，提升设备支持数量。**

- **链接: [https://arxiv.org/pdf/2602.07000v1](https://arxiv.org/pdf/2602.07000v1)**

> **作者:** Abanoub M. Girgis; Ibtissam Labriji; Mehdi Bennis
>
> **摘要:** In wireless networked control systems, ensuring timely and reliable state updates from distributed devices to remote controllers is essential for robust control performance. However, when multiple devices transmit high-dimensional states (e.g., images or video frames) over bandwidth-limited wireless networks, a critical trade-off emerges between communication efficiency and control performance. To address this challenge, we propose a Hierarchical Joint-Embedding Predictive Architecture (H-JEPA) for scalable predictive control. Instead of transmitting states, device observations are encoded into low-dimensional embeddings that preserve essential dynamics. The proposed architecture employs a three-level hierarchical prediction, with high-level, medium-level, and low-level predictors operating across different temporal resolutions, to achieve long-term prediction stability, intermediate interpolation, and fine-grained refinement, respectively. Control actions are derived within the embedding space, removing the need for state reconstruction. Simulation results on inverted cart-pole systems demonstrate that H-JEPA enables up to 42.83 % more devices to be supported under limited wireless capacity without compromising control performance.
>
---
#### [new 089] RAPiD: Real-time Deterministic Trajectory Planning via Diffusion Behavior Priors for Safe and Efficient Autonomous Driving
- **分类: cs.AI; cs.LG; cs.RO**

- **简介: 该论文提出RAPiD，解决自动驾驶中轨迹规划的实时性与安全性问题。通过提取扩散模型的确定性策略，提升效率并保障安全。**

- **链接: [https://arxiv.org/pdf/2602.07339v1](https://arxiv.org/pdf/2602.07339v1)**

> **作者:** Ruturaj Reddy; Hrishav Bakul Barua; Junn Yong Loo; Thanh Thi Nguyen; Ganesh Krishnasamy
>
> **摘要:** Diffusion-based trajectory planners have demonstrated strong capability for modeling the multimodal nature of human driving behavior, but their reliance on iterative stochastic sampling poses critical challenges for real-time, safety-critical deployment. In this work, we present RAPiD, a deterministic policy extraction framework that distills a pretrained diffusion-based planner into an efficient policy while eliminating diffusion sampling. Using score-regularized policy optimization, we leverage the score function of a pre-trained diffusion planner as a behavior prior to regularize policy learning. To promote safety and passenger comfort, the policy is optimized using a critic trained to imitate a predictive driver controller, providing dense, safety-focused supervision beyond conventional imitation learning. Evaluations demonstrate that RAPiD achieves competitive performance on closed-loop nuPlan scenarios with an 8x speedup over diffusion baselines, while achieving state-of-the-art generalization among learning-based planners on the interPlan benchmark. The official website of this work is: https://github.com/ruturajreddy/RAPiD.
>
---
#### [new 090] Looking and Listening Inside and Outside: Multimodal Artificial Intelligence Systems for Driver Safety Assessment and Intelligent Vehicle Decision-Making
...
>
---
#### [new 091] Picasso: Holistic Scene Reconstruction with Physics-Constrained Sampling
...
>
---
#### [new 095] Modeling 3D Pedestrian-Vehicle Interactions for Vehicle-Conditioned Pose Forecasting
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 096] Vision and language: Novel Representations and Artificial intelligence for Driving Scene Safety Assessment and Autonomous Vehicle Planning
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [new 097] WorldArena: A Unified Benchmark for Evaluating Perception and Functional Utility of Embodied World Models
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 098] ForecastOcc: Vision-based Semantic Occupancy Forecasting
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [new 099] Seeing Roads Through Words: A Language-Guided Framework for RGB-T Driving Scene Segmentation
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
#### [replaced 001] GRAND: Guidance, Rebalancing, and Assignment for Networked Dispatch in Multi-Agent Path Finding
- **分类: cs.RO; cs.LG; cs.MA**

- **简介: 该论文属于多智能体路径规划任务，解决大规模仓库中机器人调度问题。通过结合学习与优化方法，提升调度效率与实时性。**

- **链接: [https://arxiv.org/pdf/2512.03194v2](https://arxiv.org/pdf/2512.03194v2)**
...
>
---
#### [replaced 002] RLinf-VLA: A Unified and Efficient Framework for Reinforcement Learning of Vision-Language-Action Models
- **分类: cs.RO**

- **简介: 该论文提出RLinf-VLA，解决VLA模型在具身智能中的强化学习训练问题，通过统一框架和高效设计提升训练效果与效率。**

- **链接: [https://arxiv.org/pdf/2510.06710v2](https://arxiv.org/pdf/2510.06710v2)**
...
>
---
#### [replaced 003] RoboPaint: From Human Demonstration to Any Robot and Any View
- **分类: cs.RO**

- **简介: 该论文属于机器人操作任务，旨在解决获取高质量机器人演示数据的问题。通过人类示范生成适用于机器人的训练数据，提升复杂操作性能。**

- **链接: [https://arxiv.org/pdf/2602.05325v2](https://arxiv.org/pdf/2602.05325v2)**
...
>
---
#### [replaced 004] Omni-LIVO: Robust RGB-Colored Multi-Camera Visual-Inertial-LiDAR Odometry via Photometric Migration and ESIKF Fusion
- **分类: cs.RO**

- **简介: 该论文提出Omni-LIVO，解决多相机LiDAR惯性视觉里程计问题，通过跨视图对齐和ESIKF融合提升定位精度与鲁棒性。**

- **链接: [https://arxiv.org/pdf/2509.15673v4](https://arxiv.org/pdf/2509.15673v4)**

> **作者:** Yinong Cao; Chenyang Zhang; Xin He; Yuwei Chen; Chengyu Pu; Bingtao Wang; Kaile Wu; Fei Han; Shijie Liu; Chunlai Li; Jianyu Wang
>
...
>
---
#### [replaced 005] CostNav: A Navigation Benchmark for Real-World Economic-Cost Evaluation of Physical AI Agents
...
>
---
#### [replaced 006] Virtual Community: An Open World for Humans, Robots, and Society
...
>
---
#### [replaced 007] Neural-Augmented Kelvinlet for Real-Time Soft Tissue Deformation Modeling
...
>
---
#### [replaced 008] Safe Exploration via Policy Priors
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于安全强化学习任务，旨在解决在线学习中的安全探索问题。通过使用保守策略作为先验，提出SOOPER方法，在保证安全的同时实现有效探索与最优策略收敛。**

- **链接: [https://arxiv.org/pdf/2601.19612v2](https://arxiv.org/pdf/2601.19612v2)**
...
>
---
#### [replaced 009] MomaGraph: State-Aware Unified Scene Graphs with Vision-Language Model for Embodied Task Planning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 010] Nimbus: A Unified Embodied Synthetic Data Generation Framework
- **分类: cs.RO; cs.DC**

- **简介: 该论文提出Nimbus框架，解决合成数据生成效率低的问题，属于机器人或AI数据生成任务。通过统一架构提升吞吐量和稳定性。**

- **链接: [https://arxiv.org/pdf/2601.21449v2](https://arxiv.org/pdf/2601.21449v2)**

> **作者:** Zeyu He; Yuchang Zhang; Yuanzhen Zhou; Miao Tao; Hengjie Li; Hui Wang; Yang Tian; Jia Zeng; Tai Wang; Wenzhe Cai; Yilun Chen; Ning Gao; Jiangmiao Pang
>
...
>
---
#### [replaced 011] OpenGVL -- Benchmarking Visual Temporal Progress for Data Curation
- **分类: cs.RO; cs.CL**
...
>
---
#### [replaced 012] A Software-Only Post-Processor for Indexed Rotary Machining on GRBL-Based CNCs
- **分类: cs.RO**

- **简介: 该论文属于数控加工领域，解决GRBL控制器缺乏旋转轴的问题。通过软件后处理将平面路径转为旋转步骤，实现多面加工，降低硬件成本与复杂度。**

- **链接: [https://arxiv.org/pdf/2509.11433v2](https://arxiv.org/pdf/2509.11433v2)**

> **作者:** Pedro Portugal; Damian D. Venghaus; Diego Lopez
>
> **备注:** 13 pages, 10 figures, Python post-processor source code and web interface included
>
...
>
---
#### [replaced 013] Embodying Physical Computing into Soft Robots
- **分类: cs.RO**

- **简介: 该论文属于软体机器人领域，旨在将物理计算嵌入软体机器人以提升其智能与适应性。通过三种策略实现复杂行为，解决传统电子控制的局限。**

- **链接: [https://arxiv.org/pdf/2510.24692v2](https://arxiv.org/pdf/2510.24692v2)**
...
>
---
#### [replaced 014] Multi-Robot Data-Free Continual Communicative Learning (CCL) from Black-Box Visual Place Recognition Models
- **分类: cs.RO**

- **简介: 该论文属于多机器人视觉定位任务，解决未知机器人间知识共享问题。通过通信机制，低性能机器人从黑盒模型中学习，提升定位能力。**

- **链接: [https://arxiv.org/pdf/2503.02256v3](https://arxiv.org/pdf/2503.02256v3)**
...
>
---
#### [replaced 015] SPICE-HL3: Single-Photon, Inertial, and Stereo Camera dataset for Exploration of High-Latitude Lunar Landscapes
- **分类: cs.RO**

- **简介: 该论文介绍SPICE-HL3数据集，用于高纬度月球环境的机器人探索。解决视觉挑战问题，通过多传感器数据模拟月球光照条件，支持自主导航与科学成像研究。**

- **链接: [https://arxiv.org/pdf/2506.22956v2](https://arxiv.org/pdf/2506.22956v2)**

> **作者:** David Rodríguez-Martínez; Dave van der Meer; Junlin Song; Abishek Bera; C. J. Pérez-del-Pulgar; Miguel Angel Olivares-Mendez
>
> **备注:** 12 pages, 7 figures, dataset
>
...
>
---
#### [replaced 016] An Adaptive Inspection Planning Approach Towards Routine Monitoring in Uncertain Environments
- **分类: cs.RO**

- **简介: 该论文属于机器人巡检任务，解决环境不确定性下的路径规划问题。通过分层框架实现全局规划与局部重规划，提升巡检鲁棒性。**

- **链接: [https://arxiv.org/pdf/2510.24554v2](https://arxiv.org/pdf/2510.24554v2)**
...
>
---
#### [replaced 017] Information-Theoretic Graph Fusion with Vision-Language-Action Model for Policy Reasoning and Dual Robotic Control
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于机器人操作任务，旨在解决从人类视频中学习精细操作技能的问题。通过信息理论图融合与视觉-语言-动作模型，实现双臂机器人任务推理与执行。**

- **链接: [https://arxiv.org/pdf/2508.05342v2](https://arxiv.org/pdf/2508.05342v2)**

> **作者:** Shunlei Li; Longsen Gao; Jin Wang; Chang Che; Xi Xiao; Jiuwen Cao; Yingbai Hu; Hamid Reza Karimi
>
> **备注:** Journal accepted by Information Fusion
>
...
>
---
#### [replaced 018] Learning-based Adaptive Control of Quadruped Robots for Active Stabilization on Moving Platforms
- **分类: cs.RO**

- **简介: 该论文属于机器人控制任务，旨在解决四足机器人在移动平台上的稳定问题。通过学习方法实现自适应姿态调整和状态估计，提升机器人在复杂运动环境中的平衡能力。**

- **链接: [https://arxiv.org/pdf/2602.03367v2](https://arxiv.org/pdf/2602.03367v2)**

> **作者:** Minsung Yoon; Heechan Shin; Jeil Jeong; Sung-Eui Yoon
>
> **备注:** Accepted at IROS 2024. Project Page: https://sgvr.kaist.ac.kr/~msyoon/papers/IROS24/
>
...
>
---
#### [replaced 019] Optimizing Automated Picking Systems in Warehouse Robots Using Machine Learning
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于物流自动化任务，旨在提升仓库机器人的拣选效率与准确性。通过深度学习和强化学习技术优化系统，解决高峰期订单处理和环境适应性问题。**

- **链接: [https://arxiv.org/pdf/2408.16633v2](https://arxiv.org/pdf/2408.16633v2)**
...
>
---
#### [replaced 020] Residual Vector Quantization For Communication-Efficient Multi-Agent Perception
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 021] Efficient Policy Optimization in Robust Constrained MDPs with Iteration Complexity Guarantees
- **分类: cs.LG; cs.AI; cs.RO; eess.SY**

- **简介: 该论文属于强化学习任务，解决鲁棒约束MDP中的策略优化问题，提出新方法在保证约束条件下最大化奖励，提升计算效率。**

- **链接: [https://arxiv.org/pdf/2505.19238v3](https://arxiv.org/pdf/2505.19238v3)**

> **作者:** Sourav Ganguly; Kishan Panaganti; Arnob Ghosh; Adam Wierman
>
...
>
---
#### [replaced 022] ManiVID-3D: Generalizable View-Invariant Reinforcement Learning for Robotic Manipulation via Disentangled 3D Representations
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 025] Collaborative-Online-Learning-Enabled Distributionally Robust Motion Control for Multi-Robot Systems
- **分类: math.OC; cs.RO; eess.SY**

- **简介: 该论文属于多机器人运动控制任务，解决随机障碍物下的碰撞避免问题。通过协同在线学习和分布鲁棒优化，构建障碍物运动不确定性集，生成安全轨迹。**

- **链接: [https://arxiv.org/pdf/2508.17173v2](https://arxiv.org/pdf/2508.17173v2)**
...
>
---
#### [replaced 028] Gust Estimation and Rejection with a Disturbance Observer for Proprioceptive Underwater Soft Morphing Wings
- **分类: cs.RO**

- **简介: 该论文属于水下机器人控制任务，旨在解决水流扰动影响车辆稳定的问题。通过仿生软翼与本体感觉传感结合，实现扰动估计与抑制。**

- **链接: [https://arxiv.org/pdf/2602.04438v2](https://arxiv.org/pdf/2602.04438v2)**
...
>
---
#### [replaced 029] Constructing the Umwelt: Cognitive Planning through Belief-Intent Co-Evolution
...
>
---
#### [replaced 030] Sim-to-Real Dynamic Object Manipulation on Conveyor Systems via Optimization Path Shaping
- **分类: cs.RO**

- **简介: 该论文属于动态物体操作任务，解决 conveyor 系统中数据稀缺问题。通过模拟生成演示并提出 GEM 模型，提升策略泛化能力，实现在真实场景中的高成功率操作。**

- **链接: [https://arxiv.org/pdf/2508.14042v2](https://arxiv.org/pdf/2508.14042v2)**

> **作者:** Zhuoling Li; Jinrong Yang; Yong Zhao; Liangliang Ren; Xiaoyang Wu; Zhenhua Xu; Hengshuang Zhao
>
...
>
---
#### [replaced 031] Lyapunov Constrained Soft Actor-Critic (LC-SAC) using Koopman Operator Theory for Quadrotor Trajectory Tracking
- **分类: eess.SY; cs.LG; cs.RO**

- **简介: 该论文属于强化学习任务，旨在解决安全关键系统中策略稳定性问题。通过结合Lyapunov函数与Koopman理论，提出LC-SAC算法，提升四旋翼轨迹跟踪的稳定性与安全性。**

- **链接: [https://arxiv.org/pdf/2602.04132v2](https://arxiv.org/pdf/2602.04132v2)**
...
>
---
#### [replaced 032] Delay-Aware Reinforcement Learning for Highway On-Ramp Merging under Stochastic Communication Latency
- **分类: cs.RO; cs.AI**

- **简介: 该论文属于自动驾驶控制任务，解决高速匝道合并中因通信延迟导致的强化学习性能下降问题。提出DAROM框架，通过延迟感知编码器和物理安全控制器提升控制鲁棒性。**

- **链接: [https://arxiv.org/pdf/2403.11852v4](https://arxiv.org/pdf/2403.11852v4)**
...
>
---
#### [replaced 033] CoBEVMoE: Heterogeneity-aware Feature Fusion with Dynamic Mixture-of-Experts for Collaborative Perception
...
>
---
#### [replaced 034] Multi-Player, Multi-Strategy Quantum Game Model for Interaction-Aware Decision-Making in Automated Driving
- **分类: cs.RO**

- **简介: 该论文属于自动驾驶决策任务，解决交互感知不足的问题。通过结合量子力学与博弈论，提出QGDM模型，提升多车复杂场景下的决策效果。**

- **链接: [https://arxiv.org/pdf/2602.03571v2](https://arxiv.org/pdf/2602.03571v2)**
...
>
---
#### [replaced 035] Beware Untrusted Simulators -- Reward-Free Backdoor Attacks in Reinforcement Learning
- **分类: cs.CR; cs.LG; cs.RO**

- **简介: 该论文属于强化学习安全任务，解决模拟器被攻击的问题。提出新攻击方法Daze，在不修改奖励的情况下植入后门，实现隐蔽控制。**

- **链接: [https://arxiv.org/pdf/2602.05089v2](https://arxiv.org/pdf/2602.05089v2)**
...
>
---
#### [replaced 036] SpecPrune-VLA: Accelerating Vision-Language-Action Models via Action-Aware Self-Speculative Pruning
...
>
---
#### [replaced 037] AgenticLab: A Real-World Robot Agent Platform that Can See, Think, and Act
- **分类: cs.RO**

- **简介: 该论文提出AgenticLab平台，解决真实机器人在开放环境中的操作问题。通过构建闭环代理流程，评估视觉语言模型的现实任务表现，揭示传统测试未捕捉的失败模式。**

- **链接: [https://arxiv.org/pdf/2602.01662v2](https://arxiv.org/pdf/2602.01662v2)**
...
>
---
#### [replaced 040] A Survey of Behavior Foundation Model: Next-Generation Whole-Body Control System of Humanoid Robots
- **分类: cs.RO**

- **简介: 本文综述行为基础模型在人形机器人全身控制中的应用，旨在解决复杂任务下的高效控制问题。通过预训练学习通用技能，提升模型适应性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2506.20487v5](https://arxiv.org/pdf/2506.20487v5)**
...
>
---
#### [replaced 041] Parallel Simulation of Contact and Actuation for Soft Growing Robots
- **分类: cs.RO**

- **简介: 该论文属于软体机器人设计任务，旨在解决复杂环境中软体攀爬机器人的导航问题。通过建立统一模型和并行仿真框架，优化设计以减少所需执行器数量。**

- **链接: [https://arxiv.org/pdf/2509.15180v2](https://arxiv.org/pdf/2509.15180v2)**

> **作者:** Yitian Gao; Lucas Chen; Priyanka Bhovad; Sicheng Wang; Zachary Kingston; Laura H. Blumenschein
>
> **备注:** 37 pages, 12 figures, 2 tables. To appear in Soft Robotics
>
...
>
---
#### [replaced 042] Learning-based Initialization of Trajectory Optimization for Path-following Problems of Redundant Manipulators
- **分类: cs.RO**

- **简介: 该论文属于路径跟踪任务，解决冗余机械臂轨迹优化初始轨迹选择困难的问题。通过学习方法生成高质量初始轨迹，提升优化效率与可行性。**

- **链接: [https://arxiv.org/pdf/2602.03418v2](https://arxiv.org/pdf/2602.03418v2)**

> **作者:** Minsung Yoon; Mincheul Kang; Daehyung Park; Sung-Eui Yoon
>
> **备注:** Accepted at ICRA 2023. Project page: https://sgvr.kaist.ac.kr/~msyoon/papers/ICRA23_RLITG/
>
...
>
---
#### [replaced 043] RAP: 3D Rasterization Augmented End-to-End Planning
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 046] Enhancing Navigation Efficiency of Quadruped Robots via Leveraging Personal Transportation Platforms
- **分类: cs.RO**

- **简介: 该论文属于机器人导航任务，旨在提升四足机器人的长距离导航效率。通过引入RL-ATR方法，使机器人能利用个人交通工具，降低能耗并提高运动能力。**

- **链接: [https://arxiv.org/pdf/2602.03397v2](https://arxiv.org/pdf/2602.03397v2)**

> **作者:** Minsung Yoon; Sung-Eui Yoon
>
> **备注:** Accepted at ICRA 2025. Project page: https://sgvr.kaist.ac.kr/~msyoon/papers/ICRA25/
>
...
>
---
#### [replaced 047] Aligning Microscopic Vehicle and Macroscopic Traffic Statistics: Reconstructing Driving Behavior from Partial Data
- **分类: cs.MA; cs.LG; cs.RO**

- **简介: 该论文属于自动驾驶领域，旨在解决如何从部分数据中重建驾驶行为的问题。通过融合微观与宏观交通数据，构建一致且安全的驾驶策略。**

- **链接: [https://arxiv.org/pdf/2601.22242v2](https://arxiv.org/pdf/2601.22242v2)**
...
>
---
#### [replaced 048] A Review of Online Diffusion Policy RL Algorithms for Scalable Robotic Control
- **分类: cs.LG; cs.AI; cs.RO**

- **简介: 该论文属于机器人控制领域，解决在线扩散策略强化学习的整合难题。通过分类和评估不同算法，分析其性能与局限，提出优化方向。**

- **链接: [https://arxiv.org/pdf/2601.06133v2](https://arxiv.org/pdf/2601.06133v2)**
...
>
---
#### [replaced 049] SPOT: Spatio-Temporal Obstacle-free Trajectory Planning for UAVs in an Unknown Dynamic Environment
- **分类: cs.RO; eess.SY**

- **简介: 该论文属于无人机路径规划任务，解决未知动态环境中的实时避障问题。通过4D时空规划与视觉感知结合，实现无地图的高效避障与轨迹优化。**

- **链接: [https://arxiv.org/pdf/2602.01189v2](https://arxiv.org/pdf/2602.01189v2)**
...
>
---
#### [replaced 050] StreamVLA: Breaking the Reason-Act Cycle via Completion-State Gating
- **分类: cs.RO**

- **简介: 该论文提出StreamVLA，解决长周期机器人操作中的高延迟与目标不稳定问题，通过双系统架构实现高效任务分解与动作生成。**

- **链接: [https://arxiv.org/pdf/2602.01100v2](https://arxiv.org/pdf/2602.01100v2)**
...
>
---
#### [replaced 051] Addressing the Waypoint-Action Gap in End-to-End Autonomous Driving via Vehicle Motion Models
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [replaced 052] Simultaneous Tactile-Visual Perception for Learning Multimodal Robot Manipulation
- **分类: cs.RO; cs.CV**
