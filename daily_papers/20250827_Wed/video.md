...
>
---
#### [new 006] Learning Binary Sampling Patterns for Single-Pixel Imaging using Bilevel Optimisation
- **分类: cs.CV; cs.LG; math.OC; physics.optics**

- **简介: 论文针对单像素成像的二进制采样模式优化问题，提出双水平优化方法，结合Straight-Through Estimator和TV正则化，提升重建性能，尤其在欠采样条件下表现优异。**

- **链接: [http://arxiv.org/pdf/2508.19068v1](http://arxiv.org/pdf/2508.19068v1)**
...
>
---
#### [new 013] GReAT: leveraging geometric artery data to improve wall shear stress assessment
- **分类: cs.CV; cs.LG**

- **简介: 该论文任务是利用几何数据提升冠状动脉壁剪切应力评估。解决小样本数据下模型泛化能力不足的问题，通过自监督预训练（基于热核签名）和大规模几何模型数据，提升冠状动脉区域分割精度。**

- **链接: [http://arxiv.org/pdf/2508.19030v1](http://arxiv.org/pdf/2508.19030v1)**
...
>
> **摘要:** The growing integration of smart environments and low-power computing devices, coupled with mass-market sensor technologies, is driving advancements in remote and non-contact physiological monitoring. However, deploying these systems in real-time on resource-constrained platforms introduces significant challenges related to scalability, interoperability, and performance. This paper presents a real-time remote photoplethysmography (rPPG) system optimized for low-power devices, designed to extract physiological signals, such as heart rate (HR), respiratory rate (RR), and oxygen saturation (SpO2), from facial video streams. The system is built on the Face2PPG pipeline, which processes video frames sequentially for rPPG signal extraction and analysis, while leveraging a multithreaded architecture to manage video capture, real-time processing, network communication, and graphical user interface (GUI) updates concurrently. This design ensures continuous, reliable operation at 30 frames per second (fps), with adaptive feedback through a collaborative user interface to guide optimal signal capture conditions. The network interface includes both an HTTP server for continuous video streaming and a RESTful API for on-demand vital sign retrieval. To ensure accurate performance despite the limitations of low-power devices, we use a hybrid programming model combining Functional Reactive Programming (FRP) and the Actor Model, allowing event-driven processing and efficient task parallelization. The system is evaluated under real-time constraints, demonstrating robustness while minimizing computational overhead. Our work addresses key challenges in real-time biosignal monitoring, offering practical solutions for optimizing performance in modern healthcare and human-computer interaction applications.
>
---
#### [new 017] Wan-S2V: Audio-Driven Cinematic Video Generation
- **分类: cs.CV**

- **简介: 论文提出Wan-S2V模型，用于音频驱动的电影级视频生成，解决现有方法在复杂影视场景中表现不足的问题，通过改进模型提升表达力和真实性，并在长视频生成和唇部同步编辑中验证效果。**

- **链接: [http://arxiv.org/pdf/2508.18621v1](http://arxiv.org/pdf/2508.18621v1)**
...
>
---
#### [new 019] Automated Classification of Normal and Atypical Mitotic Figures Using ConvNeXt V2: MIDOG 2025 Track 2
- **分类: cs.CV**

- **简介: 本论文针对病理图像中正常与异常分裂相的二分类任务，提出基于ConvNeXt V2的解决方案，通过中心裁剪和五折交叉验证处理类别不平衡及形态差异等挑战，实现高效准确分类。**

- **链接: [http://arxiv.org/pdf/2508.18831v1](http://arxiv.org/pdf/2508.18831v1)**
...
>
---
#### [new 020] Automated Landfill Detection Using Deep Learning: A Comparative Study of Lightweight and Custom Architectures with the AerialWaste Dataset
- **分类: cs.CV; cs.AI**

- **简介: 论文任务为自动检测非法垃圾填埋场，利用深度学习模型解决手动识别效率低的问题，基于AerialWaste数据集比较轻量级模型，通过集成优化实现92.33%的检测准确率。**

- **链接: [http://arxiv.org/pdf/2508.18315v1](http://arxiv.org/pdf/2508.18315v1)**
...
>
---
#### [new 026] Articulate3D: Zero-Shot Text-Driven 3D Object Posing
- **分类: cs.CV**

- **简介: 论文提出Articulate3D，通过文本指令实现零样本3D物体姿势调整。其核心是利用改进的图像生成器与关键点对应，解耦结构与姿态，通过多视图优化实现精准对齐，有效提升文本驱动的3D姿势控制性能。**

- **链接: [http://arxiv.org/pdf/2508.19244v1](http://arxiv.org/pdf/2508.19244v1)**

> **作者:** Oishi Deb; Anjun Hu; Ashkan Khakzar; Philip Torr; Christian Rupprecht
>
> **备注:** Project page:https://odeb1.github.io/articulate3d_page_deb/
>
...
>
---
#### [new 030] Few-Shot Connectivity-Aware Text Line Segmentation in Historical Documents
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对历史文档文本行分割任务，解决少样本下自动分割难题。采用轻量UNet++与拓扑损失函数，通过少量标注数据提升分割精度，取得200%准确率和75%交并比提升，实现高效少样本学习。**

- **链接: [http://arxiv.org/pdf/2508.19162v1](http://arxiv.org/pdf/2508.19162v1)**
...
>
---
#### [new 031] ProPy: Building Interactive Prompt Pyramids upon CLIP for Partially Relevant Video Retrieval
- **分类: cs.CV**

- **简介: 论文针对部分相关视频检索任务，提出ProPy模型，通过Prompt Pyramid和Ancestor-Descendant机制，利用CLIP处理多粒度语义，实现动态交互，取得SOTA性能。**

- **链接: [http://arxiv.org/pdf/2508.19024v1](http://arxiv.org/pdf/2508.19024v1)**
...
>
---
#### [new 036] LSD-3D: Large-Scale 3D Driving Scene Generation with Geometry Grounding
- **分类: cs.CV; cs.AI; cs.GR**

- **简介: 该论文旨在解决大规模3D驾驶场景生成中几何与因果控制不足的问题，提出结合代理几何生成与分数蒸馏的方法，实现高可控性、几何准确的场景生成。**

- **链接: [http://arxiv.org/pdf/2508.19204v1](http://arxiv.org/pdf/2508.19204v1)**

> **作者:** Julian Ost; Andrea Ramazzina; Amogh Joshi; Maximilian Bömer; Mario Bijelic; Felix Heide
>
> **备注:** Project webpage: https://light.princeton.edu/LSD-3D
>
> **摘要:** Large-scale scene data is essential for training and testing in robot learning. Neural reconstruction methods have promised the capability of reconstructing large physically-grounded outdoor scenes from captured sensor data. However, these methods have baked-in static environments and only allow for limited scene control -- they are functionally constrained in scene and trajectory diversity by the captures from which they are reconstructed. In contrast, generating driving data with recent image or video diffusion models offers control, however, at the cost of geometry grounding and causality. In this work, we aim to bridge this gap and present a method that directly generates large-scale 3D driving scenes with accurate geometry, allowing for causal novel view synthesis with object permanence and explicit 3D geometry estimation. The proposed method combines the generation of a proxy geometry and environment representation with score distillation from learned 2D image priors. We find that this approach allows for high controllability, enabling the prompt-guided geometry and high-fidelity texture and structure that can be conditioned on map layouts -- producing realistic and geometrically consistent 3D generations of complex driving scenes.
>
---
#### [new 037] MicroDetect-Net (MDN): Leveraging Deep Learning to Detect Microplastics in Clam Blood, a Step Towards Human Blood Analysis
- **分类: cs.CV**

- **简介: 该论文提出MicroDetect-Net模型，利用荧光显微镜与深度学习检测血液中微塑料，通过蛤血样本验证，实现高精度检测，为人类血液分析提供方法。**

- **链接: [http://arxiv.org/pdf/2508.19021v1](http://arxiv.org/pdf/2508.19021v1)**
...
>
---
#### [new 050] Flatness-aware Curriculum Learning via Adversarial Difficulty
- **分类: cs.CV**

- **简介: 论文针对神经网络过拟合问题，提出Adversarial Difficulty Measure (ADM)结合课程学习与SAM，动态评估样本难度，提升泛化能力，实验证明优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.18726v1](http://arxiv.org/pdf/2508.18726v1)**
...
>
---
#### [new 051] A Novel Deep Hybrid Framework with Ensemble-Based Feature Optimization for Robust Real-Time Human Activity Recognition
- **分类: cs.CV**

- **简介: 该论文提出一种混合深度学习框架，结合定制InceptionV3、LSTM和集成特征优化策略，解决实时HAR中的高计算成本、冗余特征和可扩展性问题，提升准确率与效率。**

- **链接: [http://arxiv.org/pdf/2508.18695v1](http://arxiv.org/pdf/2508.18695v1)**
...
>
---
#### [new 052] Towards Training-Free Underwater 3D Object Detection from Sonar Point Clouds: A Comparison of Traditional and Deep Learning Approaches
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [new 055] VQualA 2025 Challenge on Face Image Quality Assessment: Methods and Results
- **分类: cs.CV**

- **简介: 论文组织VQualA 2025挑战，针对人脸图像在现实退化下的质量评估，要求参与者开发轻量模型预测MOS，通过综合评估推动实用FIQA方法发展。**

- **链接: [http://arxiv.org/pdf/2508.18445v1](http://arxiv.org/pdf/2508.18445v1)**
...
>
---
#### [new 058] Beyond the Textual: Generating Coherent Visual Options for MCQs
- **分类: cs.CV; cs.CL**

- **简介: 该论文提出CmOS框架，用于生成带视觉选项的MCQs，解决传统方法忽视视觉选项及干扰项生成难题，通过多模态推理与检索增强生成技术，结合区分模块提升内容适配性。**
...
>
---
#### [new 059] Boosting Micro-Expression Analysis via Prior-Guided Video-Level Regression
- **分类: cs.CV**

- **简介: 论文针对微表情分析中时序动态捕捉不足的问题，提出基于先验引导的视频级回归方法，通过可扩展区间选择和协同优化框架提升识别精度。**

- **链接: [http://arxiv.org/pdf/2508.18834v1](http://arxiv.org/pdf/2508.18834v1)**
...
>
---
#### [new 060] VibES: Induced Vibration for Persistent Event-Based Sensing
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 069] Generative AI in Map-Making: A Technical Exploration and Its Implications for Cartographers
- **分类: cs.CV**

- **简介: 该论文研究生成式AI在地图制作中的应用，解决传统制图耗时且需专业技能的问题，通过整合矢量数据指导风格生成，开发网页工具并评估其有效性，探索AI辅助制图的未来方向。**

- **链接: [http://arxiv.org/pdf/2508.18959v1](http://arxiv.org/pdf/2508.18959v1)**
...
>
---
#### [new 072] ROSE: Remove Objects with Side Effects in Videos
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文针对视频对象移除中的副作用（如阴影、反射）问题，提出ROSE框架，通过3D渲染生成合成数据并设计自动流水线，结合扩散变换器模型与新基准ROSE-Bench，实现高效副作用消除。**

- **链接: [http://arxiv.org/pdf/2508.18633v1](http://arxiv.org/pdf/2508.18633v1)**
...
>
---
#### [new 073] All-in-One Slider for Attribute Manipulation in Diffusion Models
- **分类: cs.CV**

- **简介: 该论文针对扩散模型中属性操控的参数冗余和灵活性问题，提出All-in-One Slider模块，通过分解文本嵌入空间实现通用滑块，支持零样本操控和多属性组合，提升操控精度与扩展性。**

- **链接: [http://arxiv.org/pdf/2508.19195v1](http://arxiv.org/pdf/2508.19195v1)**
...
>
---
#### [new 076] A Bag of Tricks for Efficient Implicit Neural Point Clouds
- **分类: cs.GR; cs.CV; cs.LG**

- **简介: 该论文针对隐式神经点云（INPC）渲染效率低的问题，提出多种优化策略，包括改进光栅化、高效采样、预训练网络及高斯建模，显著提升训练与推理速度，降低显存占用，保持视觉质量。**

- **链接: [http://arxiv.org/pdf/2508.19140v1](http://arxiv.org/pdf/2508.19140v1)**

> **作者:** Florian Hahlbohm; Linus Franke; Leon Overkämping; Paula Wespe; Susana Castillo; Martin Eisemann; Marcus Magnor
>
> **备注:** Project page: https://fhahlbohm.github.io/inpc_v2/
>
...
>
---
#### [new 077] SemLayoutDiff: Semantic Layout Generation with Diffusion Model for Indoor Scene Synthesis
- **分类: cs.GR; cs.CV**

- **简介: 该论文提出SemLayoutDiff，利用扩散模型生成3D室内场景，通过语义地图与属性结合，解决建筑约束条件下的布局生成问题，提升场景合理性与多样性。**

- **链接: [http://arxiv.org/pdf/2508.18597v1](http://arxiv.org/pdf/2508.18597v1)**
...
>
---
#### [new 080] Analise de Desaprendizado de Maquina em Modelos de Classificacao de Imagens Medicas
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文研究医疗图像分类中的机器遗忘任务，旨在移除敏感数据的同时保持模型性能。通过在三个数据集上评估SalUn模型，并分析数据增强对遗忘效果的影响，结果表明其性能接近全量重训练，适用于医疗场景。**

- **链接: [http://arxiv.org/pdf/2508.18509v1](http://arxiv.org/pdf/2508.18509v1)**
...
>
---
#### [new 081] The Mind's Eye: A Multi-Faceted Reward Framework for Guiding Visual Metaphor Generation
- **分类: cs.CL; cs.CV**

- **简介: 论文针对视觉隐喻生成任务，解决文本隐喻与图像间语义对齐与视觉一致性问题，提出融合自我评估的多维度奖励框架，设计训练-free与训练-based双流程，通过隐喻分解与意义对齐优化生成效果。**
...
>
---
#### [new 082] A Closer Look at Edema Area Segmentation in SD-OCT Images Using Adversarial Framework
- **分类: eess.IV; cs.CV**

- **简介: 该论文针对SD-OCT图像中水肿区域分割任务，解决弱监督下分割精度不足的问题，通过引入视网膜层信息和测试时适应策略，提升分割准确性和鲁棒性。**

- **链接: [http://arxiv.org/pdf/2508.18790v1](http://arxiv.org/pdf/2508.18790v1)**
...
>
---
#### [new 085] SWiFT: Soft-Mask Weight Fine-tuning for Bias Mitigation
- **分类: cs.LG; cs.CV**

- **简介: 论文针对医疗AI中的偏见问题，提出SWiFT框架，通过软掩码权重微调减少偏见同时保持诊断准确率，实验验证其有效性。**

- **链接: [http://arxiv.org/pdf/2508.18826v1](http://arxiv.org/pdf/2508.18826v1)**
...
>
---
#### [new 086] Enhanced UAV Path Planning Using the Tangent Intersection Guidance (TIG) Algorithm
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 087] Uncertainty Awareness on Unsupervised Domain Adaptation for Time Series Data
- **分类: cs.LG; cs.CV**

- **简介: 该论文针对时间序列数据的无监督领域自适应问题，提出多尺度特征提取与不确定性估计方法，通过混合输入架构和证据学习机制增强模型泛化与鲁棒性，实验显示显著提升目标域性能。**

- **链接: [http://arxiv.org/pdf/2508.18630v1](http://arxiv.org/pdf/2508.18630v1)**
...
>
---
#### [new 088] Random forest-based out-of-distribution detection for robust lung cancer segmentation
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 论文针对肺部癌症分割任务，解决模型在分布外数据（OOD）上的性能退化问题，提出基于随机森林的OOD检测方法，利用预训练Transformer特征提升分割可靠性。**

- **链接: [http://arxiv.org/pdf/2508.19112v1](http://arxiv.org/pdf/2508.19112v1)**
...
>
---
#### [new 089] C-Flat++: Towards a More Efficient and Powerful Framework for Continual Learning
- **分类: cs.LG; cs.CV**

- **简介: 论文聚焦于持续学习任务，解决新任务敏感性与旧知识稳定性平衡问题。提出C-Flat++框架，通过促进平坦损失景观提升学习效率与性能，减少更新成本。**

- **链接: [http://arxiv.org/pdf/2508.18860v1](http://arxiv.org/pdf/2508.18860v1)**
...
>
---
#### [new 090] Impact of Target and Tool Visualization on Depth Perception and Usability in Optical See-Through AR
- **分类: cs.HC; cs.CV; cs.GR**

- **简介: 该论文研究光学透视AR中目标与工具可视化对深度感知和可用性的影响，通过对比不同透明度和工具跟踪方式，发现真实工具遮挡提升精度与可用性，高透明度反而损害深度 cues。**

- **链接: [http://arxiv.org/pdf/2508.18481v1](http://arxiv.org/pdf/2508.18481v1)**
...
>
---
#### [new 094] Controllable Single-shot Animation Blending with Temporal Conditioning
- **分类: cs.GR; cs.CV**

- **简介: 该论文解决单帧动画混合中的可控性问题，提出通过时间条件和骨骼归一化机制实现多动作无缝融合，提升生成动画的平滑度与可控性。**

- **链接: [http://arxiv.org/pdf/2508.18525v1](http://arxiv.org/pdf/2508.18525v1)**

> **作者:** Eleni Tselepi; Spyridon Thermos; Gerasimos Potamianos
>
> **备注:** Accepted to the AI for Visual Arts Workshop at ICCV 2025
>
> **摘要:** Training a generative model on a single human skeletal motion sequence without being bound to a specific kinematic tree has drawn significant attention from the animation community. Unlike text-to-motion generation, single-shot models allow animators to controllably generate variations of existing motion patterns without requiring additional data or extensive retraining. However, existing single-shot methods do not explicitly offer a controllable framework for blending two or more motions within a single generative pass. In this paper, we present the first single-shot motion blending framework that enables seamless blending by temporally conditioning the generation process. Our method introduces a skeleton-aware normalization mechanism to guide the transition between motions, allowing smooth, data-driven control over when and how motions blend. We perform extensive quantitative and qualitative evaluations across various animation styles and different kinematic skeletons, demonstrating that our approach produces plausible, smooth, and controllable motion blends in a unified and efficient manner.
>
---
#### [new 095] Federative ischemic stroke segmentation as alternative to overcome domain-shift multi-institution challenges
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文针对多机构医学图像域移位问题，提出联邦学习框架实现缺血性中风分割，通过共享深度中心表示提升模型泛化能力，在跨机构数据上取得优于传统方法的分割性能。**

- **链接: [http://arxiv.org/pdf/2508.18296v1](http://arxiv.org/pdf/2508.18296v1)**
...
>
---
#### [new 096] ZeST: an LLM-based Zero-Shot Traversability Navigation for Unknown Environments
...
>
---
#### [new 097] A Deep Learning Application for Psoriasis Detection
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文针对银屑病皮肤病变检测任务，比较ResNet50、Inception v3和VGG19三种CNN模型的分类性能，通过调整评估指标验证Inception v3在准确率（97.5%）和F1-score上的优越性，用于辅助诊断。**

- **链接: [http://arxiv.org/pdf/2508.18528v1](http://arxiv.org/pdf/2508.18528v1)**

> **作者:** Anna Milani; Fábio S. da Silva; Elloá B. Guedes; Ricardo Rios
>
> **备注:** 15 pages, 4 figures, 1 table, Proceedings of XX Encontro Nacional de Intelig\^encia Artificial e Computacional. in Portuguese language
>
> **摘要:** In this paper a comparative study of the performance of three Convolutional Neural Network models, ResNet50, Inception v3 and VGG19 for classification of skin images with lesions affected by psoriasis is presented. The images used for training and validation of the models were obtained from specialized platforms. Some techniques were used to adjust the evaluation metrics of the neural networks. The results found suggest the model Inception v3 as a valuable tool for supporting the diagnosis of psoriasis. This is due to its satisfactory performance with respect to accuracy and F1-Score (97.5% ${\pm}$ 0.2).
>
---
#### [new 098] MemoryVLA: Perceptual-Cognitive Memory in Vision-Language-Action Models for Robotic Manipulation
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 099] RDDM: Practicing RAW Domain Diffusion Model for Real-world Image Restoration
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 该论文提出RAW域扩散模型RDDM，解决从传感器RAW数据恢复高保真图像的问题，通过RAW域直接生成避免sRGB域的保真与真实冲突，并设计RVAE、PTP模块及可扩展训练方案提升性能。**

- **链接: [http://arxiv.org/pdf/2508.19154v1](http://arxiv.org/pdf/2508.19154v1)**
...
>
---
#### [replaced 003] Uncertainty-Guided Face Matting for Occlusion-Aware Face Transformation
- **分类: cs.CV; cs.AI; I.4.8**

- **链接: [http://arxiv.org/pdf/2508.03055v2](http://arxiv.org/pdf/2508.03055v2)**
...
>
---
#### [replaced 008] MOSformer: Momentum encoder-based inter-slice fusion transformer for medical image segmentation
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2401.11856v3](http://arxiv.org/pdf/2401.11856v3)**
...
>
> **备注:** 13 pages, 9 figures, 8 tables. Under Review
>
...
>
---
#### [replaced 014] M$^2$IV: Towards Efficient and Fine-grained Multimodal In-Context Learning via Representation Engineering
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.04633v3](http://arxiv.org/pdf/2504.04633v3)**
...
>
---
#### [replaced 015] Neuro Symbolic Knowledge Reasoning for Procedural Video Question Answering
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.14957v3](http://arxiv.org/pdf/2503.14957v3)**
...
>
---
#### [replaced 016] EVM-Fusion: An Explainable Vision Mamba Architecture with Neural Algorithmic Fusion
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.17367v4](http://arxiv.org/pdf/2505.17367v4)**

> **作者:** Zichuan Yang; Yongzhi Wang
>
...
>
---
#### [replaced 017] Weakly-Supervised 3D Visual Grounding based on Visual Language Alignment
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2312.09625v5](http://arxiv.org/pdf/2312.09625v5)**

> **作者:** Xiaoxu Xu; Yitian Yuan; Qiudan Zhang; Wenhui Wu; Zequn Jie; Lin Ma; Xu Wang
>
> **摘要:** Learning to ground natural language queries to target objects or regions in 3D point clouds is quite essential for 3D scene understanding. Nevertheless, existing 3D visual grounding approaches require a substantial number of bounding box annotations for text queries, which is time-consuming and labor-intensive to obtain. In this paper, we propose 3D-VLA, a weakly supervised approach for 3D visual grounding based on Visual Linguistic Alignment. Our 3D-VLA exploits the superior ability of current large-scale vision-language models (VLMs) on aligning the semantics between texts and 2D images, as well as the naturally existing correspondences between 2D images and 3D point clouds, and thus implicitly constructs correspondences between texts and 3D point clouds with no need for fine-grained box annotations in the training procedure. During the inference stage, the learned text-3D correspondence will help us ground the text queries to the 3D target objects even without 2D images. To the best of our knowledge, this is the first work to investigate 3D visual grounding in a weakly supervised manner by involving large scale vision-language models, and extensive experiments on ReferIt3D and ScanRefer datasets demonstrate that our 3D-VLA achieves comparable and even superior results over the fully supervised methods.
>
---
#### [replaced 018] Concept-Guided Interpretability via Neural Chunking
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.11576v2](http://arxiv.org/pdf/2505.11576v2)**
...
>
---
#### [replaced 019] Video CLIP Model for Multi-View Echocardiography Interpretation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.18800v2](http://arxiv.org/pdf/2504.18800v2)**
...
>
---
#### [replaced 022] PhysioSync: Temporal and Cross-Modal Contrastive Learning Inspired by Physiological Synchronization for EEG-Based Emotion Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.17163v2](http://arxiv.org/pdf/2504.17163v2)**
...
>
---
#### [replaced 023] Generative Feature Imputing - A Technique for Error-resilient Semantic Communication
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.17957v2](http://arxiv.org/pdf/2508.17957v2)**
...
>
---
#### [replaced 024] Visual-CoG: Stage-Aware Reinforcement Learning with Chain of Guidance for Text-to-Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.18032v2](http://arxiv.org/pdf/2508.18032v2)**
...
>
---
#### [replaced 029] LATex: Leveraging Attribute-based Text Knowledge for Aerial-Ground Person Re-Identification
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.23722v2](http://arxiv.org/pdf/2503.23722v2)**

> **作者:** Xiang Hu; Yuhao Wang; Pingping Zhang; Huchuan Lu
>
> **备注:** Add more experiments and improve the writing
>
...
>
---
#### [replaced 030] Uni-AIMS: AI-Powered Microscopy Image Analysis
- **分类: eess.IV; cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2505.06918v2](http://arxiv.org/pdf/2505.06918v2)**
...
>
---
#### [replaced 034] MicroMIL: Graph-Based Multiple Instance Learning for Context-Aware Diagnosis with Microscopic Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2407.21604v4](http://arxiv.org/pdf/2407.21604v4)**

> **作者:** Jongwoo Kim; Bryan Wong; Huazhu Fu; Willmer Rafell Quiñones; Youngsin Ko; Mun Yong Yi
>
...
>
---
#### [replaced 035] PersPose: 3D Human Pose Estimation with Perspective Encoding and Perspective Rotation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.17239v2](http://arxiv.org/pdf/2508.17239v2)**
...
>
---
#### [replaced 036] Mind the (Language) Gap: Towards Probing Numerical and Cross-Lingual Limits of LVLMs
- **分类: cs.CV; cs.AI; cs.CL; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.17334v2](http://arxiv.org/pdf/2508.17334v2)**
...
>
---
#### [replaced 037] Emerging Semantic Segmentation from Positive and Negative Coarse Label Learning
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.18186v2](http://arxiv.org/pdf/2508.18186v2)**
...
>
---
#### [replaced 041] Prompting with Sign Parameters for Low-resource Sign Language Instruction Generation
- **分类: cs.HC; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.16076v2](http://arxiv.org/pdf/2508.16076v2)**
...
>
---
#### [replaced 042] Waver: Wave Your Way to Lifelike Video Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.15761v2](http://arxiv.org/pdf/2508.15761v2)**

> **作者:** Yifu Zhang; Hao Yang; Yuqi Zhang; Yifei Hu; Fengda Zhu; Chuang Lin; Xiaofeng Mei; Yi Jiang; Bingyue Peng; Zehuan Yuan
>
...
>
---
#### [replaced 043] Objective Task-based Evaluation of Quantitative Medical Imaging Methods: Emerging Frameworks and Future Directions
- **分类: physics.med-ph; cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2507.04591v3](http://arxiv.org/pdf/2507.04591v3)**
...
>
---
#### [replaced 044] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.17437v2](http://arxiv.org/pdf/2508.17437v2)**
...
>
---
#### [replaced 045] MultiRef: Controllable Image Generation with Multiple Visual References
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.06905v3](http://arxiv.org/pdf/2508.06905v3)**
...
>
---
#### [replaced 048] Faster Parameter-Efficient Tuning with Token Redundancy Reduction
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2503.20282v2](http://arxiv.org/pdf/2503.20282v2)**
...
>
---
#### [replaced 049] mRAG: Elucidating the Design Space of Multi-modal Retrieval-Augmented Generation
- **分类: cs.AI; cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2505.24073v2](http://arxiv.org/pdf/2505.24073v2)**
...
>
---
#### [replaced 050] DreamVLA: A Vision-Language-Action Model Dreamed with Comprehensive World Knowledge
- **分类: cs.CV; cs.RO**
...
- **链接: [http://arxiv.org/pdf/2507.12964v3](http://arxiv.org/pdf/2507.12964v3)**
...
>
---
#### [replaced 052] Generative Data Augmentation for Object Point Cloud Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.17783v2](http://arxiv.org/pdf/2505.17783v2)**
...
>
---
#### [replaced 053] Quantifying and Alleviating Co-Adaptation in Sparse-View 3D Gaussian Splatting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12720v2](http://arxiv.org/pdf/2508.12720v2)**

> **作者:** Kangjie Chen; Yingji Zhong; Zhihao Li; Jiaqi Lin; Youyu Chen; Minghan Qin; Haoqian Wang
>
> **备注:** Under review. Project page: https://chenkangjie1123.github.io/Co-Adaptation-3DGS/, Code at: https://github.com/chenkangjie1123/Co-Adaptation-of-3DGS
>
...
>
---
#### [replaced 054] A Hybrid Fully Convolutional CNN-Transformer Model for Inherently Interpretable Disease Detection from Retinal Fundus Images
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.08481v2](http://arxiv.org/pdf/2504.08481v2)**

> **作者:** Kerol Djoumessi; Samuel Ofosu Mensah; Philipp Berens
>
> **备注:** Accepted at the Workshop on Interpretability of Machine Intelligence in Medical Image Computing at MICCAI 2025
>
...
>
---
#### [replaced 055] Enhancing Reusability of Learned Skills for Robot Manipulation via Gaze Information and Motion Bottlenecks
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 058] MM-R1: Unleashing the Power of Unified Multimodal Large Language Models for Personalized Image Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.11433v2](http://arxiv.org/pdf/2508.11433v2)**
...
>
---
#### [replaced 063] Gaussian Splatting Feature Fields for Privacy-Preserving Visual Localization
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23569v2](http://arxiv.org/pdf/2507.23569v2)**
...
>
---
#### [replaced 064] WMKA-Net: A Weighted Multi-Kernel Attention Network for Retinal Vessel Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.14888v2](http://arxiv.org/pdf/2504.14888v2)**

> **作者:** Xinran Xu; Yuliang Ma; Sifu Cai; Ruoyan Shi
>
...
>
---
#### [replaced 065] VFM-Guided Semi-Supervised Detection Transformer under Source-Free Constraints for Remote Sensing Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.11167v2](http://arxiv.org/pdf/2508.11167v2)**

> **作者:** Jianhong Han; Yupei Wang; Liang Chen
>
> **备注:** Manuscript submitted to IEEE TCSVT
>
...
>
---
#### [replaced 066] CAD-Assistant: Tool-Augmented VLLMs as Generic CAD Task Solvers
- **分类: cs.CV; cs.AI; cs.LG; cs.RO**
...
>
---
#### [replaced 067] TRAN-D: 2D Gaussian Splatting-based Sparse-view Transparent Object Depth Reconstruction via Physics Simulation for Scene Update
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 068] UAD: Unsupervised Affordance Distillation for Generalization in Robotic Manipulation
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 069] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2410.11394v2](http://arxiv.org/pdf/2410.11394v2)**
...
>
---
#### [replaced 070] TimeFlow: Temporal Conditioning for Longitudinal Brain MRI Registration and Aging Analysis
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2501.08667v3](http://arxiv.org/pdf/2501.08667v3)**
...
>
---
#### [replaced 071] MonoCoP: Chain-of-Prediction for Monocular 3D Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.04594v5](http://arxiv.org/pdf/2505.04594v5)**

> **作者:** Zhihao Zhang; Abhinav Kumar; Girish Chandar Ganesan; Xiaoming Liu
>
> **备注:** I plan to re-format and re-write this paper
>
...
>
---
#### [replaced 072] Curvature Learning for Generalization of Hyperbolic Neural Networks
- **分类: cs.LG; cs.CV; stat.ML**

- **链接: [http://arxiv.org/pdf/2508.17232v2](http://arxiv.org/pdf/2508.17232v2)**
...
>
---
#### [replaced 073] Rethinking the Detail-Preserved Completion of Complex Tubular Structures based on Point Cloud: a Dataset and a Benchmark
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.17658v2](http://arxiv.org/pdf/2508.17658v2)**
...
- **链接: [http://arxiv.org/pdf/2508.03337v4](http://arxiv.org/pdf/2508.03337v4)**

> **作者:** Shaoguang Wang; Ziyang Chen; Yijie Xu; Weiyu Guo; Hui Xiong
>
...
>
---
#### [replaced 075] Fast Motion Estimation and Context-Aware Refinement for Efficient Bayer-Domain Video Vision
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.05990v2](http://arxiv.org/pdf/2508.05990v2)**
...
>
---
#### [replaced 076] Incremental Multi-Scene Modeling via Continual Neural Graphics Primitives
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.19903v4](http://arxiv.org/pdf/2411.19903v4)**
...
>
---
#### [replaced 077] DriveIndia: An Object Detection Dataset for Diverse Indian Traffic Scenes
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.19912v4](http://arxiv.org/pdf/2507.19912v4)**

> **作者:** Rishav Kumar; D. Santhosh Reddy; P. Rajalakshmi
>
> **备注:** Accepted at ITSC 2025 Conference. Updated the Table 2 of Benchmark Results
>
...
>
---
#### [replaced 078] FastTracker: Real-Time and Accurate Visual Tracking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.14370v3](http://arxiv.org/pdf/2508.14370v3)**
...
>
---
#### [replaced 079] RAFT: Robust Augmentation of FeaTures for Image Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.04529v3](http://arxiv.org/pdf/2505.04529v3)**
...
>
---
#### [replaced 082] Physical Autoregressive Model for Robotic Manipulation without Action Pretraining
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09822v3](http://arxiv.org/pdf/2508.09822v3)**
...
>
---
#### [replaced 083] Image Coding for Machines via Feature-Preserving Rate-Distortion Optimization
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2504.02216v2](http://arxiv.org/pdf/2504.02216v2)**
...
>
---
#### [replaced 084] SocialTrack: Multi-Object Tracking in Complex Urban Traffic Scenes Inspired by Social Behavior
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.12777v2](http://arxiv.org/pdf/2508.12777v2)**
...
>
---
#### [replaced 085] Online Micro-gesture Recognition Using Data Augmentation and Spatial-Temporal Attention
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.09512v2](http://arxiv.org/pdf/2507.09512v2)**
