...
#### [new 001] Vision-Language Models Suppress Female Representations Under Ambiguous Input
...
>
---
#### [new 008] Omni-Supervised Motion Editing: Balancing Change and Invariance through Positive-Negative Learning
- **分类: cs.CV**

- **简介: 该论文属于文本驱动的人体运动编辑任务，旨在解决运动序列修改中的变化与不变性平衡问题。提出OmniME框架，通过多组件协同实现精准编辑与运动保持。**

- **链接: [https://arxiv.org/pdf/2605.30969](https://arxiv.org/pdf/2605.30969)**
...
>
---
#### [new 011] KLIP: localized distribution shift detection via KL-divergence with diffusion priors in Inverse Problems
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于异常检测任务，解决逆问题中分布偏移检测问题。提出基于KL散度的度量，无需校准数据即可检测全局和局部分布偏移。**

- **链接: [https://arxiv.org/pdf/2605.31596](https://arxiv.org/pdf/2605.31596)**
...
>
---
#### [new 021] Variational Adapter for Cross-modal Similarity Representation
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于跨模态相似性学习任务，旨在解决数据标注不精确导致的模型性能下降问题。提出VACSR方法，通过变分推理构建潜在空间，提升模型泛化能力。**

- **链接: [https://arxiv.org/pdf/2605.30968](https://arxiv.org/pdf/2605.30968)**
...
>
---
#### [new 043] Seeing Before Agreeing: Aligning Multi-Agent Consensus with Visual Evidence
- **分类: cs.CV; cs.AI; cs.MA**

- **简介: 该论文属于视觉问答任务，旨在解决多智能体协作中的视觉证据对齐问题。提出EAGLE框架，通过共享视觉证据实现可靠共识。**

- **链接: [https://arxiv.org/pdf/2605.30698](https://arxiv.org/pdf/2605.30698)**
...
>
---
#### [new 054] SpatialAct: Probing Spatial Reasoning-to-Action Capabilities of VLM Agents in 3D Scenes
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 057] Lightweight SAR Ship Detection via Contrastive Distillation
- **分类: cs.CV**

- **简介: 该论文属于SAR船舶检测任务，旨在解决轻量化模型性能不足的问题。通过结构化关系知识蒸馏框架SURGE，提升检测精度。**

- **链接: [https://arxiv.org/pdf/2605.30380](https://arxiv.org/pdf/2605.30380)**
...
>
---
#### [new 068] Crafter: A Multi-Agent Harness for Editable Scientific Figure Generation from Diverse Inputs
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [new 071] MultiAct: Text-to-Motion Generation from Composite Text via Tailored Attention Guidance
- **分类: cs.CV; cs.GR**

- **简介: 该论文属于文本到动作生成任务，解决多动作同时描述时模型表现不佳的问题。提出MultiAct框架，通过调整注意力机制提升多动作的语义覆盖，保持动作真实感。**

- **链接: [https://arxiv.org/pdf/2605.30925](https://arxiv.org/pdf/2605.30925)**
...
>
---
#### [new 084] FSM-Net: An Efficient Frequency-Spatial Network for Real-World Deblurring
- **分类: cs.CV**

- **简介: 该论文属于图像去模糊任务，旨在提升真实场景下图像去模糊的效率与质量。提出FSM-Net，结合频域与空域信息，实现高效高保真去模糊。**

- **链接: [https://arxiv.org/pdf/2605.31400](https://arxiv.org/pdf/2605.31400)**

> **作者:** Vinh-Thuan Ly
>
> **备注:** Accepted to NTIRE Workshop at CVPR 2026. Project page: this https URL
>
> **摘要:** Real-world image deblurring demands both high-fidelity restoration and computational efficiency, a balance existing methods often struggle to achieve. In this paper, we propose FSM-Net (Frequency-Spatial Multi-branch Network), a highly efficient solution that secured 2nd place in the NTIRE 2026 Challenge on Efficient Real-World Deblurring. FSM-Net pioneers a dual-domain approach: a novel Frequency Attention module explicitly recovers high-frequency structural details via FFT, while a Cross-Gated Vision E-Branchformer at the bottleneck captures global dependencies with linear complexity. To ensure robust convergence, we employ a progressive curriculum training strategy guided by a composite loss function (Multi-Scale Charbonnier, Structural Edge, and Frequency). Evaluated on the RSBlur benchmark, FSM-Net achieves an outstanding 33.144 dB PSNR with only 4.94M parameters and 159.35 GMACs (at 1920x1200 resolution). By effectively pushing the Pareto frontier of efficiency and quality, FSM-Net establishes a strong baseline for resource-constrained image restoration.
>
---
#### [new 085] Latent Geometric Chords for Query-Efficient Decision-Based Adversarial Attacks
- **分类: cs.CV; cs.CR; cs.LG**

- **简介: 该论文属于对抗攻击任务，旨在解决决策型黑盒攻击中视觉伪影和搜索空间受限的问题。提出LGC方法，通过几何搜索和RAG机制提升攻击效果与视觉质量。**

- **链接: [https://arxiv.org/pdf/2605.31219](https://arxiv.org/pdf/2605.31219)**
...
>
---
#### [new 109] SurGe: Improved Surface Geometry in Point Maps
- **分类: cs.CV**

- **简介: 该论文属于3D重建任务，旨在解决点云表面几何不准确的问题。提出点法线度量和两个改进组件，提升局部表面精度。**

- **链接: [https://arxiv.org/pdf/2605.31577](https://arxiv.org/pdf/2605.31577)**
...
>
---
#### [new 117] Clustering Guided Domain-Specific Pretrained Foundation Model Very High-Resolution Arctic Remote Sensing
- **分类: cs.CV**

- **简介: 该论文提出一种针对北极高分辨率遥感的领域专用预训练模型，解决遥感图像分析中的特征提取问题，通过聚类优化数据分布提升模型性能。**

- **链接: [https://arxiv.org/pdf/2605.30467](https://arxiv.org/pdf/2605.30467)**
...
>
---
#### [new 118] Representation Forcing for Bottleneck-Free Unified Multimodal Models
- **分类: cs.CV**

- **简介: 该论文属于多模态任务，旨在解决统一多模态模型中的结构瓶颈问题。通过引入Representation Forcing技术，使模型直接预测视觉表示，提升生成与理解性能。**

- **链接: [https://arxiv.org/pdf/2605.31604](https://arxiv.org/pdf/2605.31604)**
...
> **备注:** Project page: this https URL
>
> **摘要:** Unified multimodal models (UMMs) aim to handle perception and generation in a single model. Yet existing UMMs still rely on a frozen, separately pretrained VAE for image generation, imposing a structural bottleneck. Naively removing it introduces a quality gap, as the model must learn both high-level structure and low-level details from raw pixels. In this paper, we propose Representation Forcing (RF), a technique that closes this gap by making representation prediction a native capability of the model. Concretely, RF forces the decoder to autoregressively predict visual representations as intermediate tokens before pixels; these tokens then stay in context to guide pixel diffusion within the same backbone. By turning representations from perception outputs into generation targets, RF eliminates the need for any external generative latent space. We find that RF benefits both understanding and generation. On image generation, our pixel-space model with RF matches state-of-the-art VAE-based unified models. On image understanding, pixel-space RF generally outperforms its VAE-based variant. Together, these results offer an effective step toward end-to-end, bottleneck-free UMMs.
>
---
#### [new 119] Learning Global Motion with Compact Gaussians for Feed-Forward 4D Reconstruction
- **分类: cs.CV**

- **简介: 该论文属于动态场景重建任务，解决单目视频中运动建模困难的问题。提出C4G框架，通过紧凑高斯查询令牌实现全局运动建模，提升重建效果与效率。**

- **链接: [https://arxiv.org/pdf/2605.31595](https://arxiv.org/pdf/2605.31595)**
...
>
---
#### [new 129] 3DAE: Binaural Quality Assessment for Audio Novel View Synthesis with Spatial Maps and Benchmark
- **分类: cs.SD; cs.CV**
...
>
---
#### [new 130] A Unifying View of Variational Generative Wasserstein Flows
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于生成模型领域，旨在统一多种生成方法。通过 Wasserstein 梯度流框架，解决不同算法间的理论差异，提出 Generative Wasserstein Flows（GWF）模型。**

- **链接: [https://arxiv.org/pdf/2605.31369](https://arxiv.org/pdf/2605.31369)**
...
>
---
#### [new 131] Self-Tuning Regularization for Image Scanning Microscopy
- **分类: eess.IV; cs.CV; math.OC**

- **简介: 该论文属于图像重建任务，旨在解决ISMs中因迭代方法导致的噪声和伪影问题。提出自调参正则化框架，提升重建稳定性与质量。**

- **链接: [https://arxiv.org/pdf/2605.31426](https://arxiv.org/pdf/2605.31426)**
...
>
---
#### [new 139] A Visually Impaired Assistance Benchmark for VLM-as-a-Judge Evaluation
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 147] A Pilot Study on Curator-Guided Multilingual Art Description for Blind and Low-Vision Audiences with Small Vision-Language Models
...
>
---
#### [replaced 004] 3ViewSense: Spatial and Mental Perspective Reasoning from Orthographic Views in Vision-Language Models
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 005] Causal Forcing++: Scalable Few-Step Autoregressive Diffusion Distillation for Real-Time Interactive Video Generation
- **分类: cs.CV**
...
>
---
#### [replaced 006] Joint angle based learning to refine kinematic human pose estimation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2507.11075](https://arxiv.org/pdf/2507.11075)**

> **作者:** Chang Peng; Yifei Zhou; Haoqiang Ren; Shiqing Huang; Chuangye Chen; Jianming Yang; Bao Yang; Huifeng Xi; Zhenyu Jiang
>
...
>
---
#### [replaced 008] SpaMEM: Benchmarking Dynamic Spatial Reasoning via Perception-Memory Integration in Embodied Environments
- **分类: cs.CV**
...
>
---
#### [replaced 009] Rethinking Multimodal Few-Shot 3D Point Cloud Segmentation: From Fused Refinement to Decoupled Arbitration
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2601.01456](https://arxiv.org/pdf/2601.01456)**

> **作者:** Wentao Bian; Fenglei Xu
>
> **备注:** Accepted to IJCAI-ECAI 2026 (Main Track). 9 pages, 3 figures, 3 tables
>
...
>
---
#### [replaced 010] Causal Forcing: Autoregressive Diffusion Distillation Done Right for High-Quality Real-Time Interactive Video Generation
- **分类: cs.CV**
...
>
---
#### [replaced 011] SpatialBench: Is Your Spatial Foundation Model an All-Round Player?
- **分类: cs.CV**
...
>
---
#### [replaced 016] SuperVoxelGPT: Adaptive and Ordered 3D Tokenization for Autoregressive Shape Generation
- **分类: cs.CV; cs.GR**
...
>
---
#### [replaced 019] ParCo-SDF: Learning Prior-Free Partial-to-Complete Signed Distance Fields of Deformable Objects
- **分类: cs.CV**
...
>
---
#### [replaced 023] Cross-Modal Attention Calibration for LVLM Hallucination Mitigation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2501.01926](https://arxiv.org/pdf/2501.01926)**
...
>
---
#### [replaced 024] Mixture of Horizons in Action Chunking
- **分类: cs.RO; cs.AI; cs.CV**

- **简介: 该论文属于机器人操作任务，解决动作块长度（horizon）选择的权衡问题。提出混合时间步长策略（MoH），提升模型在长期与短期任务中的表现。**

- **链接: [https://arxiv.org/pdf/2511.19433](https://arxiv.org/pdf/2511.19433)**
...
>
---
#### [replaced 025] Synthetic Stimuli, Real Gains: Rethinking VLM Fine-Tuning Through Fully Controlled Data Generation
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 026] MAVEN A Multi-Agent Framework for Multicultural Text-to-Video Generation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 028] LiteViLNet: Lightweight Vision-LiDAR Fusion Network for Efficient Road Segmentation
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于道路分割任务，旨在解决多模态方法计算成本高、难以实时部署的问题。提出LiteViLNet，通过轻量编码和特征融合实现高效准确的分割。**
...
>
---
#### [replaced 032] Flow Equivariant World Models: Memory for Partially Observed Dynamic Environments
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.01075](https://arxiv.org/pdf/2601.01075)**
...
>
---
#### [replaced 033] HUNT: High-Speed UAV Navigation and Tracking in Unstructured Environments via Instantaneous Relative Frames
- **分类: cs.RO; cs.CV; cs.LG**

- **简介: 该论文提出HUNT框架，解决无人机在非结构化环境中高速导航与目标跟踪问题。通过相对帧实现统一控制，提升自主性。**

- **链接: [https://arxiv.org/pdf/2509.19452](https://arxiv.org/pdf/2509.19452)**
...
>
---
#### [replaced 034] CaptionFormer: Unified Segmentation, Tracking, and Captioning for Spatio-Temporal Objects
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2510.14904](https://arxiv.org/pdf/2510.14904)**

> **作者:** Gabriel Fiastre; Antoine Yang; Cordelia Schmid
>
> **备注:** 17 pages, 10 figures
>
> **摘要:** Dense Video Object Captioning (DVOC) is the task of jointly detecting, tracking, and captioning object trajectories in a video, requiring the ability to understand spatio-temporal details and describe them in natural language. Due to the complexity of the task and the high cost associated with manual annotation, previous approaches resort to training strategies with limited data, potentially leading to suboptimal performance. To circumvent this issue, we propose to generate captions about spatio-temporally localized entities leveraging a state-of-the-art VLM, and extend the LVIS and LV-VIS datasets with our synthetic captions (LVISCap and LV-VISCap). Moreover, we introduce an end-to-end model, CaptionFormer, capable of jointly detecting, segmenting, tracking and captioning object trajectories. CaptionFormer achieves state-of-the-art DVOC results on three existing benchmarks, VidSTG, VLN and BenSMOT. The datasets and code are available at this https URL.
>
---
#### [replaced 035] DISCO: Mitigating Bias in Deep Learning with Conditional Distance Correlation
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2506.11653](https://arxiv.org/pdf/2506.11653)**
...
>
---
#### [replaced 036] Stream3D: Sequential Multi-View 3D Generation via Evidential Memory
- **分类: cs.CV**
...
>
---
#### [replaced 037] 3D-Belief: Embodied Belief Inference via Generative 3D World Modeling
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.11367](https://arxiv.org/pdf/2605.11367)**

> **作者:** Yifan Yin; Zehao Wen; Suyu Ye; Jieneng Chen; Zehan Zheng; Nanru Dai; Haojun Shi; Aydan Huang; Zheyuan Zhang; Alan Yuille; Jianwen Xie; Ayush Tewari; Tianmin Shu
>
...
>
---
#### [replaced 038] Calibrated Uncertainty for Trustworthy Clinical Gait Analysis Using Probabilistic Multiview Markerless Motion Capture
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2601.22412](https://arxiv.org/pdf/2601.22412)**
...
>
---
#### [replaced 039] X-GS: An Extensible Framework for Perceiving and Thinking via 3D Gaussian Splatting
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 040] SpectralTrain: A Universal Framework for Hyperspectral Image Classification
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2511.16084](https://arxiv.org/pdf/2511.16084)**

> **作者:** Meihua Zhou; Liping Yu; Xinyu Tong; Wai Kin Fung; Ruiguo Hu; Jiarui Zhao; Nan Wan
>
...
>
---
#### [replaced 041] SAW-Bench: Learning Situated Awareness in the Real World
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2602.16682](https://arxiv.org/pdf/2602.16682)**

> **作者:** Chuhan Li; Rilyn Han; Joy Hsu; Yongyuan Liang; Rajiv Dhawan; Jiajun Wu; Ming-Hsuan Yang; Xin Eric Wang
>
> **摘要:** A core aspect of human perception is situated awareness, the ability to relate ourselves to the surrounding physical environment and reason over possible actions in context. However, most existing benchmarks for multimodal foundation models (MFMs) emphasize environment-centric spatial relations (relations among objects in a scene), while largely overlooking observer-centric relationships that require reasoning relative to agent's viewpoint, pose, and motion. To bridge this gap, we introduce SAW-Bench (Situated Awareness in the Real World), a novel benchmark for evaluating egocentric situated awareness using real-world videos. SAW-Bench comprises 786 self-recorded videos captured with Ray-Ban Meta (Gen 2) smart glasses spanning diverse indoor and outdoor environments, and over 2,071 human-annotated question-answer pairs. It probes a model's observer-centric understanding with six different awareness tasks. Our comprehensive evaluation reveals a human-model performance gap of 37.66%, even with the best-performing MFM, Gemini 3 Flash. Beyond this gap, our in-depth analysis uncovers several notable findings; for example, while models can exploit partial geometric cues in egocentric videos, they often fail to infer a coherent camera geometry, leading to systematic spatial reasoning errors. We position SAW-Bench as a benchmark for situated spatial intelligence, moving beyond passive observation to understanding physically grounded, observer-centric dynamics.
>
---
#### [replaced 042] SpaCeFormer: Fast Proposal-Free Open-Vocabulary 3D Instance Segmentation
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出SpaCeFormer，解决开放词汇3D实例分割任务，通过无提议方法实现快速准确分割，提升效率与召回率。**
...
> **备注:** Project page: this https URL
>
> **摘要:** Open-vocabulary 3D instance segmentation is a core capability for robotics and AR/VR, but prior methods trade one bottleneck for another: multi-stage 2D+3D pipelines aggregate foundation-model outputs at hundreds of seconds per scene, while pseudo-labeled end-to-end approaches rely on fragmented masks and external region proposals. We present SpaCeFormer, a proposal-free space-curve transformer that runs in 0.12--0.30 seconds per scene across standard benchmarks, 2--3 orders of magnitude faster than multi-stage 2D+3D pipelines. We pair it with SpaCeFormer-3M, the largest open-vocabulary 3D instance segmentation dataset (3.0M multi-view-consistent captions over 604K instances from 7.4K scenes) built through multi-view mask clustering and multi-view VLM captioning; it reaches 21$\times$ higher mask recall than prior single-view pipelines (54.3% vs 2.5% at IoU$>$0.5). SpaCeFormer combines spatial window attention with Morton-curve serialization for spatially coherent features, and uses a RoPE-enhanced decoder to predict instance masks directly from learned queries without external proposals. On ScanNet200 we achieve 11.1 zero-shot mAP, a 2.8$\times$ improvement over the prior best proposal-free method; on ScanNet++ and Replica, we reach 22.9 and 24.1 mAP, surpassing all prior methods including those using multi-view 2D inputs.
>
---
#### [replaced 043] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.18898](https://arxiv.org/pdf/2509.18898)**

> **作者:** Pengteng Li; Yunfan Lu; Pinhao Song; Weiyu Guo; Huizai Yao; F. Richard Yu; Hui Xiong
>
> **备注:** Accepted by TMM 2026
>
> **摘要:** In this paper, we propose the first Structure-from-Motion (SfM)-free deblurring 3D Gaussian Splatting method via event camera, dubbed DeblurSplat. We address the motion-deblurring problem in two ways. First, we leverage the pretrained capability of the dense stereo module (DUSt3R) to directly obtain accurate initial point clouds from blurred images. Without calculating camera poses as an intermediate result, we avoid the cumulative errors transfer from inaccurate camera poses to the initial point clouds' positions. Second, we introduce the event stream into the deblur pipeline for its high sensitivity to dynamic change. By decoding the latent sharp images from the event stream and blurred images, we can provide a fine-grained supervision signal for scene reconstruction optimization. Extensive experiments across a range of scenes demonstrate that DeblurSplat not only excels in generating high-fidelity novel views but also achieves significant rendering efficiency compared to the SOTAs in deblur 3D-GS.
>
---
#### [replaced 044] Capturing Gaze Shifts for Guidance: Cross-Modal Fusion Enhancement for VLM Hallucination Mitigation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.22067](https://arxiv.org/pdf/2510.22067)**
...
>
---
#### [replaced 045] DGSG-Mind: Dynamic 3D Gaussian Scene Graphs for Long-Term Scene Understanding and Grounding
- **分类: cs.CV; cs.RO**

- **简介: 该论文属于3D场景理解任务，旨在解决动态场景中语义信息融合与长期跟踪问题。提出DGSG-Mind系统，结合高斯图与场景图，实现鲁棒的语义映射与动态更新。**
...
>
---
#### [replaced 046] Parameter-Efficient Subspace Decoupling ViT for Mitigating Multi-Task Negative Transfer in Histological Scoring
...
>
> **备注:** 6 pages, 5 figures, 2 tables. IEEE ICME 2026 (Oral). Camera-ready version
>
...
>
---
#### [replaced 047] BackSplit: The Importance of Sub-dividing the Background in Biomedical Lesion Segmentation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.19394](https://arxiv.org/pdf/2511.19394)**
...
>
---
#### [replaced 048] Rays as Pixels: Learning A Joint Distribution of Videos and Camera Trajectories
- **分类: cs.CV; cs.AI; cs.LG**
...
>
> **备注:** Accepted to ICML 2026. 9-page main paper plus supplementary material. Project page: this https URL
>
...
>
---
#### [replaced 049] Certified Circuits: Stability Guarantees for Mechanistic Circuits
- **分类: cs.AI; cs.CV; cs.CY**

- **链接: [https://arxiv.org/pdf/2602.22968](https://arxiv.org/pdf/2602.22968)**
...
>
---
#### [replaced 050] Autoregressive Visual Generation Needs a Prologue
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2605.06137](https://arxiv.org/pdf/2605.06137)**

> **作者:** Bowen Zheng; Weijian Luo; Guang Yang; Colin Zhang; Tianyang Hu
>
> **备注:** Code: this https URL Demo: this https URL
>
...
>
---
#### [replaced 051] DeepImageSearch: Benchmarking Multimodal Agents for Context-Aware Image Retrieval in Visual Histories
- **分类: cs.CV; cs.IR**

- **链接: [https://arxiv.org/pdf/2602.10809](https://arxiv.org/pdf/2602.10809)**
...
>
---
#### [replaced 058] Towards Consistent Video Geometry Estimation
- **分类: cs.CV**
...
>
---
#### [replaced 059] Broken Memories: Detecting and Mitigating Memorization in Diffusion Models with Degraded Generations
- **分类: cs.CV**
...
>
---
#### [replaced 060] Semantic Foam: Unifying Spatial and Semantic Scene Decomposition
- **分类: cs.CV**
...
>
---
#### [replaced 063] A Survey on Semantic Communication for Vision: Categories, Frameworks, Enabling Techniques, and Applications
- **分类: eess.IV; cs.CV**

- **链接: [https://arxiv.org/pdf/2601.22202](https://arxiv.org/pdf/2601.22202)**
...
>
---
#### [replaced 064] EEmo-Logic: A Unified Dataset and Multi-Stage Framework for Comprehensive Image-Evoked Emotion Assessment
- **分类: cs.CV**
...
>
---
#### [replaced 065] Optimizing Rank for High-Fidelity Implicit Neural Representations
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2512.14366](https://arxiv.org/pdf/2512.14366)**
...
>
---
#### [replaced 066] Eulerian Motion Guidance: Robust Image Animation via Bidirectional Geometric Consistency
- **分类: cs.CV**
...
>
> **备注:** Accepted at MIDL 2026 in the short paper track
>
...
>
---
#### [replaced 071] SRUG: Shadow-Guided Relightable Urban Scene with Generation Model
- **分类: cs.CV; cs.GR**
...
>
---
#### [replaced 072] DeliCIR: Deliberative Test-Time Evolutionary Hierarchical Multi-Agents for Composed Image Retrieval
- **分类: cs.CV**
...
>
---
#### [replaced 073] LPTR-AFLNet: Lightweight Integrated Chinese License Plate Rectification and Recognition Network
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.16362](https://arxiv.org/pdf/2507.16362)**
...
>
---
#### [replaced 074] Dual-Exposure Imaging with Events
- **分类: cs.CV**
...
>
---
#### [replaced 075] Label tree semantic losses for rich multi-class medical image segmentation
- **分类: cs.CV**
...
>
---
#### [replaced 076] Déjà View: Looping Transformers for Multi-View 3D Reconstruction
- **分类: cs.CV**
...
>
---
#### [replaced 077] Pocket-Dentist: On-Device Dental Image Understanding via Efficient Multimodal Large Language Models
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 080] GEM-4D: Geometry-Enhanced Video World Models for Robot Manipulation
- **分类: cs.CV; cs.RO**

- **简介: 该论文提出GEM-4D，解决视频世界模型在物理一致性上的不足，通过几何监督提升机器人操作的可靠性。属于视频生成与机器人控制任务。**
...
>
---
#### [replaced 083] Self-Supervised Online Robot-Agnostic Traversability Estimation for Open-World Environments
- **分类: cs.RO; cs.CV**

- **简介: 该论文属于机器人导航任务，旨在解决开放环境中地形可 traversability 估计问题。提出 COTRATE 框架，实现在线学习与知识迁移，提升导航安全性与效率。**
...
>
---
#### [replaced 084] GenClaw: Code-Driven Agentic Image Generation
- **分类: cs.CV**
...
>
---
#### [replaced 085] PRISM: Self-Pruning Intrinsic Selection Method for Training-Free Multimodal Data Selection
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 086] What is Missing? Explaining Neurons Activated by Absent Concepts
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2603.09787](https://arxiv.org/pdf/2603.09787)**
...
>
---
#### [replaced 087] Guidance Contrastive Token Credit Assignment for Discrete Policy Optimization
- **分类: cs.CV**
...
>
---
#### [replaced 088] A Lightweight Ensemble-Based Face Image Quality Assessment Method with Correlation-Aware Loss
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2509.10114](https://arxiv.org/pdf/2509.10114)**

> **作者:** MohammadAli Hamidi; Hadi Amirpour; Luigi Atzori; Christian Timmerer
>
> **备注:** This paper has been published in the Proceedings of ICCV 2025. The final published version is available via IEEE Xplore
>
...
>
---
#### [replaced 089] Video-MTR: Reinforced Multi-Turn Reasoning for Long Video Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2508.20478](https://arxiv.org/pdf/2508.20478)**

> **作者:** Yuan Xie; Tianshui Chen; Zheng Ge; Lionel Ni
>
> **备注:** Accepted by ICML 2026. Camera-ready version
>
...
>
---
#### [replaced 094] Reasoning-Aware Multimodal Fusion for Hateful Video Detection
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2512.02743](https://arxiv.org/pdf/2512.02743)**
