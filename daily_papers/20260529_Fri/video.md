...
>
---
#### [new 014] Parameter-Efficient Subspace Decoupling ViT for Mitigating Multi-Task Negative Transfer in Histological Scoring
- **分类: cs.CV; cs.LG; cs.MM**

- **简介: 该论文属于多任务学习任务，旨在解决NAFLD评分中任务间负迁移问题。通过设计解耦子空间ViT模型，提升多任务稳定性与泛化能力。**

- **链接: [https://arxiv.org/pdf/2605.29852](https://arxiv.org/pdf/2605.29852)**
...
>
---
#### [new 015] From General Vision to Reliable Traversability Estimation: Adapting Vision Foundation Models for Unstructured Outdoor Environments
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 026] Robust Cross-Domain Generalization Using Unlabeled Target Data with Source-Domain Supervision
- **分类: cs.CV**

- **简介: 该论文属于医学影像AI的跨域泛化任务，旨在解决模型在不同设备间性能下降的问题。通过自监督预训练和模型集成，利用源域监督与目标域无标签数据提升泛化能力。**

- **链接: [https://arxiv.org/pdf/2605.29122](https://arxiv.org/pdf/2605.29122)**
...
>
---
#### [new 028] Eulerian Gaussian Splatting using Hashed Probability Pyramids
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于三维重建任务，旨在提升辐射场的重建质量与效率。通过引入基于概率的高斯点云框架，结合梯度优化与哈希金字塔结构，实现更高效、稳定的渲染效果。**

- **链接: [https://arxiv.org/pdf/2605.29136](https://arxiv.org/pdf/2605.29136)**
...
>
---
#### [new 029] Optimizing Latent Representations for Robust Building Damage Assessment Onboard Earth Observation Satellites
- **分类: cs.CV**

- **简介: 该论文属于建筑损毁评估任务，旨在解决卫星数据处理延迟问题。通过在轨AI处理，实现快速损毁识别与分类，提升应急响应效率。**

- **链接: [https://arxiv.org/pdf/2605.29575](https://arxiv.org/pdf/2605.29575)**
...
>
> **摘要:** This work presents ViGeo, a feed-forward foundation model for recovering spatially dense and temporally consistent geometry from video sequences. Built upon a plain transformer architecture without task-specific architectural modifications, ViGeo supports streaming, full-sequence, and long-video inference within a unified model. The key design is dynamic chunking attention, which exposes the model to both bidirectional and causal temporal contexts during training and allows it to adapt its attention pattern at test time without retraining. To improve supervision quality, we further introduce a completion-based data refinement framework. This framework trains a video depth completion teacher that conditions on sparse and noisy annotations and exploits video/multi-view context to produce dense, temporally coherent, and geometrically reliable training targets. Beyond depth and point maps, ViGeo also predicts surface normals within the same framework. Trained solely on public datasets, ViGeo achieves state-of-the-art performance across online, offline, and long-video depth estimation, surface normal estimation, and video point map estimation.
>
---
#### [new 033] Supercharging Thermal Gaussian Splatting with Depth Estimation
- **分类: cs.CV**

- **简介: 该论文属于3D场景重建任务，旨在解决多模态数据融合带来的效率与挑战问题。工作是提出仅使用热红外和深度估计的TDg方法，提升渲染质量并减少训练时间。**

- **链接: [https://arxiv.org/pdf/2605.30328](https://arxiv.org/pdf/2605.30328)**
...
>
---
#### [new 072] Geometry-Guided Modeling of Foundation Features Enables Generalizable Object Shape Deformation Learning
- **分类: cs.CV**

- **简介: 该论文属于单目3D形状恢复任务，旨在解决跨视角和新类别泛化难题。通过几何引导的特征建模和视图自适应特征聚合，实现精确的形状变形学习。**

- **链接: [https://arxiv.org/pdf/2605.29661](https://arxiv.org/pdf/2605.29661)**
...
>
---
#### [new 087] Beyond 3D VQAs: Injecting 3D Spatial Priors into Vision-Language Models for Enhanced Geometric Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视觉-语言模型的3D空间推理任务，旨在解决VLMs在3D空间理解上的不足。通过注入几何先验，提升模型的几何推理能力。**

- **链接: [https://arxiv.org/pdf/2605.30231](https://arxiv.org/pdf/2605.30231)**

> **作者:** Chun-Hsiao Yeh; Shengyi Qian; Manchen Wang; Yi Ma; Joseph Tighe; Fanyi Xiao
>
> **备注:** CVPR 2026. Project page: this https URL
>
> **摘要:** Vision-Language Models (VLMs) often struggle with robust 3D spatial reasoning. Prevailing methods that rely on fine-tuning with 3D visual question-answering (VQA) datasets may overfit dataset-specific biases, while integrating specialized 3D visual encoders is often inflexible and cumbersome. In this paper, we argue that genuine spatial understanding should emerge from learning fundamental geometric priors, not only from high-level VQA supervision. We propose GASP (Geometric-Aware Spatial Priors), a framework that injects these priors directly into the LLM's transformer layers. GASP employs a small correspondence head, applied as a deep supervision signal across all layers, and is trained with a dual objective leveraging ground-truth geometry from large-scale video scenes: a contrastive loss on ground-truth point correspondences enforces 2D view-invariance, while a depth consistency supervision resolves 3D geometric ambiguities. Our analysis first provides a diagnostic showing that standard VLMs' internal correspondence matching accuracy is very low (often below 5%). We then demonstrate that our training substantially improves this behavior, boosting peak layer-wise correspondence to over 70% and maintaining over 85% temporal robustness while baselines remain below 5%. These internal improvements translate to significant gains on downstream spatial benchmarks including +18.2% on All-Angles Bench and +29.0% on VSI-Bench, all without training on any 3D VQA data. Our findings indicate that learning from fundamental geometric priors is a promising and generalizable pathway towards VLMs with more reliable 3D spatial reasoning.
>
---
#### [new 088] Native Audio-Visual Alignment for Generation
- **分类: cs.CV**

- **简介: 该论文属于多模态生成任务，旨在解决音频视频同步与语义一致性问题。提出NAVA框架，通过原生对齐实现更精准的音视频联合生成。**

- **链接: [https://arxiv.org/pdf/2605.30073](https://arxiv.org/pdf/2605.30073)**
...
>
---
#### [new 089] Déjà View: Looping Transformers for Multi-View 3D Reconstruction
- **分类: cs.CV**

- **简介: 该论文提出DéjàView模型，用于多视角3D重建任务，通过循环使用单一Transformer块替代多层结构，提升效率与性能。**

- **链接: [https://arxiv.org/pdf/2605.30215](https://arxiv.org/pdf/2605.30215)**
...
>
> **摘要:** Recent feed-forward 3D reconstruction transformers have scaled to over a billion parameters, following the broader trend of increasing model capacity in computer vision. Yet emerging evidence suggests that contiguous transformer layers often behave like repeated applications of similar operations, and multi-view reconstruction transformers refine their predictions progressively across decoder depth. We posit that model depth partially buys iteration, paid for inefficiently in unique parameters, and instead make that iteration explicit in architecture. Our model, DéjàView, applies a single looped transformer block recurrently to per-view features for K refinement steps. Trained once, it exposes K as an inference-time compute knob, matching or outperforming substantially larger feed-forward baselines across five reconstruction benchmarks spanning indoor, outdoor, object-centric, and driving scenes, while using a fraction of their parameters and comparable or lower compute. Importantly, the same looped block formulation outperforms an otherwise identical variant with independent per-step parameters under matched training data and compute, suggesting that explicit iteration is not merely a compute-efficient substitute for capacity but a stronger inductive bias for multi-view 3D reconstruction.
>
---
#### [new 090] Improving CLIP Adaptation by Breaking Tail Alignment for Source-Free Cross-Domain Few-Shot Learning
- **分类: cs.CV**

- **简介: 该论文属于跨域小样本学习任务，旨在提升CLIP在目标域数据稀缺时的适应能力。通过引入ATHA策略，优化图像与文本嵌入的对齐方式，解决因领域差异导致的性能下降问题。**

- **链接: [https://arxiv.org/pdf/2605.29776](https://arxiv.org/pdf/2605.29776)**
...
>
---
#### [new 115] EarlyTom: Early Token Compression Completes Fast Video Understanding
- **分类: cs.CV**

- **简介: 该论文属于视频理解任务，旨在解决Video-LLMs效率低的问题。通过早期视觉token压缩提升速度与吞吐量，提出EarlyTom框架，在保持精度的同时显著降低TTFT和FLOPs。**

- **链接: [https://arxiv.org/pdf/2605.30010](https://arxiv.org/pdf/2605.30010)**
...
>
---
#### [new 124] FlowSeg: Dynamic Semantic Guidance for LLM-Conditioned Segmentation
- **分类: cs.CV**

- **简介: 该论文属于图像分割任务，解决LLM条件下的语义对齐问题。通过动态语义引导提升语言与掩码的匹配效果，提出FlowSeg模型实现更准确的分割。**

- **链接: [https://arxiv.org/pdf/2605.29461](https://arxiv.org/pdf/2605.29461)**
...
>
> **摘要:** Over the past decades, numerous Image Quality Assessment (IQA) models have emerged, aiming to predict the perceptual quality of images. However, individual models are often biased toward certain types of image content or distortions, depending on the design principle and process. An intuitive idea is to harness the strengths and mitigate the weaknesses of each IQA model, by fusing the scores of multiple models into a stronger one. Here we make one of the first attempts to seek an optimal solution for the idea and propose a general framework for unsupervised IQA score fusion using deep Maximum a Posteriori (MAP) estimation. The proposed model conducts fine-grained uncertainty estimation at the score level to increase the accuracy and reduce the uncertainty in fused predictions. Comprehensive experiments demonstrate the superiority of the proposed model over individual IQA models and other fusion methods. It also exhibits an interesting capability of rejecting ``bad" models in the fusion process.
>
---
#### [new 139] Analyzing Persona Effects in Generated Explanations from Multimodal LLM Agents in Urban Perception
...
>
---
#### [new 140] Reducing Experimental Testing in Space Propulsion Film Cooling Analyses by Pixelwise Generative Image Interpolation
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于图像回归任务，旨在减少航天推进系统中实验测试需求。通过生成对抗网络从少量数据生成高质量图像，提升冷却结构优化效率。**

- **链接: [https://arxiv.org/pdf/2605.29911](https://arxiv.org/pdf/2605.29911)**
...
>
---
#### [new 144] STAMP: Training Explicit Memory for Mobile GUI Agents in Controllable and Scalable Virtual Environments
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 148] Subcortical Shape Variations and Their Associations with Cognition Across the 8th Decade of Life. A Study in the Lothian Birth Cohort 1936
- **分类: q-bio.NC; cs.CV; q-bio.TO**

- **简介: 该论文属于神经影像学任务，研究老年人脑结构变化与认知的关系。通过分析Lothian出生队列数据，探讨皮层下结构形状变化及其对认知的影响。**

- **链接: [https://arxiv.org/pdf/2605.29703](https://arxiv.org/pdf/2605.29703)**
...
>
---
#### [new 149] FreeForm: Reduced-Order Deformable Simulation from Particle-Based Skinning Eigenmodes
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于可变形物体模拟任务，解决传统方法依赖网格或需优化的问题。提出基于RKPM的降阶模拟方法，提升训练速度并降低误差。**

- **链接: [https://arxiv.org/pdf/2605.29318](https://arxiv.org/pdf/2605.29318)**
...
>
---
#### [new 150] Mask the Target: A Plug-and-Play Regularizer Against LoRA Forgetting
- **分类: cs.CL; cs.CV**
...
>
---
#### [new 160] How LoRA Remembers? A Parametric Memory Law for LLM Finetuning
...
>
---
#### [new 161] Planning with the Views via Scene Self-Exploration
...
>
---
#### [new 162] AgentDoG 1.5: A Lightweight and Scalable Alignment Framework for AI Agent Safety and Security
...
>
---
#### [new 167] Audio Deepfake Detection with Half-Truth Localisation Using Cross-Attentive Feature Fusion
...
>
---
#### [new 168] Ciphera: A Decentralised Biometric Identity Framework
- **分类: cs.CR; cs.CV; cs.DC**

- **简介: 该论文属于身份认证任务，旨在解决传统生物识别系统的问题，提出Ciphera框架，结合去中心化技术实现安全的生物身份验证。**

- **链接: [https://arxiv.org/pdf/2605.29868](https://arxiv.org/pdf/2605.29868)**
...
>
---
#### [replaced 008] Dual-Stream Diffusion for World-Model Augmented Vision-Language-Action Model
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 009] PipeMFL-240K: A Large-scale Dataset and Benchmark for Object Detection in Pipeline Magnetic Flux Leakage Imaging
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 012] LoCoT2V-Bench: Benchmarking Long-Form and Complex Text-to-Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2510.26412](https://arxiv.org/pdf/2510.26412)**
...
>
---
#### [replaced 013] Privacy Protection Against Personalized Text-to-Image Synthesis via Cross-image Consistency Constraints
- **分类: cs.CV**
...
>
---
#### [replaced 014] Diffusion Models, Denoiser Architecture and Creativity
- **分类: cs.CV; cs.LG**

- **链接: [https://arxiv.org/pdf/2605.16415](https://arxiv.org/pdf/2605.16415)**
...
>
---
#### [replaced 015] HumanEgo: Zero-Shot Robot Learning from Minutes of Human Egocentric Videos
...
>
---
#### [replaced 016] Beyond Chain-of-Thought: Rewrite as a Universal Interface for Generative Multimodal Embeddings
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2604.22280](https://arxiv.org/pdf/2604.22280)**
...
>
---
#### [replaced 018] Causal Disentanglement-Inspired Degradation Representation Learning for Full-Reference Image Quality Assessment
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2604.21654](https://arxiv.org/pdf/2604.21654)**

> **作者:** Zhen Zhang; Jielei Chu; Tian Zhang; Lin Ma; Fengmao Lv; Weide Liu; Tianrui Li; Yuming Fang
>
...
>
---
#### [replaced 019] CamC2V: Context-aware Controllable Video Generation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2504.06022](https://arxiv.org/pdf/2504.06022)**

> **作者:** Luis Denninger; Sina Mokhtarzadeh Azar; Juergen Gall
>
> **备注:** Published at 3DV 2026
>
...
>
---
#### [replaced 022] SDF-Net: Structure-Aware Disentangled Feature Learning for Opticall-SAR Ship Re-identification
- **分类: cs.CV**
...
>
---
#### [replaced 023] VEOcc: Voxel-Centric Online Semantic Occupancy Prediction For Embodied Scene Understanding
- **分类: cs.CV**
...
>
---
#### [replaced 024] F-RNG: Feed-Forward Relightable Neural Gaussians
- **分类: cs.GR; cs.CV**
...
>
---
#### [replaced 025] SCOPE: Simulating Cross-game Operations in Playable Environments for FPS World Models
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.23345](https://arxiv.org/pdf/2605.23345)**

> **作者:** Zizhao Tong; Yeying Jin; Hongfeng Lai; Zeqing Wang; Zhaohu Xing; Kexu Cheng; Haoran Xu; Zhao Pu; Shangwen Zhu; Ruili Feng; Jian Zhao; Yan Zhang; Hao Tang; Ling Shao
>
...
>
---
#### [replaced 026] OmniAID: Decoupling Semantic and Artifacts for Universal AI-Generated Image Detection in the Wild
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2511.08423](https://arxiv.org/pdf/2511.08423)**
...
>
---
#### [replaced 027] Streaming Drag-Oriented Interactive Video Manipulation: Drag Anything, Anytime!
- **分类: cs.CV**
...
>
---
#### [replaced 031] Soften the Mask: Adaptive Temporal Soft Mask for Efficient Dynamic Facial Expression Recognition
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2502.21004](https://arxiv.org/pdf/2502.21004)**

> **作者:** Meng-zhu Li; Quanxing Zha; Hongjun Wu
>
...
>
---
#### [replaced 032] JAEGER: Joint 3D Audio-Visual Grounding and Reasoning in Simulated Physical Environments
...
>
---
#### [replaced 033] ReSpinQuant: Efficient Layer-Wise LLM Quantization via Subspace Residual Rotation Approximation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 034] Dual Quaternion SE(3) Synchronization with Recovery Guarantees
...
>
---
#### [replaced 035] InfoGeo: Information-Theoretic Object-Centric Learning for Cross-View Generalizable UAV Geo-Localization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.07099](https://arxiv.org/pdf/2605.07099)**

> **作者:** Hongyang Zhang; Maonnan Wang; Ziyao Wang; Hongrui Yin; Man On Pun
>
...
>
---
#### [replaced 038] Aes3D: Aesthetic Assessment in 3D Gaussian Splatting
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 041] Structure over Pixels: Learning Variable-Length Visual Programs
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 042] Direct content-based retrieval from music scores images
- **分类: cs.CV; cs.IR**

- **链接: [https://arxiv.org/pdf/2605.22255](https://arxiv.org/pdf/2605.22255)**

> **作者:** Noelia Luna-Barahona; Antonio Ríos-Vila; Félix Fuentes-Hurtado; David Rizo; Jorge Calvo-Zaragoza
>
...
>
---
#### [replaced 043] PrecisionCUA: Iterative Visual Refinement for Pixel-Precise Cursor Grounding in Code Editors
- **分类: cs.CV**
...
>
---
#### [replaced 044] Domain-Agnostic Feature Modulation for Semi-Supervised Domain Generalization
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2503.20897](https://arxiv.org/pdf/2503.20897)**

> **作者:** Venuri Amarasinghe; Kalinga Bandara; Isun Randila; Asini Jayakody; Chamuditha Jayanga Galappaththige; Ranga Rodrigo
>
...
>
---
#### [replaced 047] CaC: Advancing Video Reward Models via Hierarchical Spatiotemporal Concentrating
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 048] A Multi-Agent Feedback System for Detecting and Describing News Events in Satellite Imagery
- **分类: cs.CV; cs.MA**
...
>
---
#### [replaced 049] ROVER: Routing Object-Centric Visual Evidence for Grounded Multi-Image Reasoning
- **分类: cs.CV; cs.AI**

- **链接: [https://arxiv.org/pdf/2605.27959](https://arxiv.org/pdf/2605.27959)**

> **作者:** Guannan Lv; Ren Nie; Hongjian Dou; Tingting Gao
>
...
>
---
#### [replaced 050] Reinforcing Few-step Generators via Reward-Tilted Distribution Matching
- **分类: cs.CV**
...
>
---
#### [replaced 051] Finding DoRI: Discovery of Retained Images in Diffusion Models
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [https://arxiv.org/pdf/2507.16880](https://arxiv.org/pdf/2507.16880)**
...
>
---
#### [replaced 052] SAGE: Segment-Aware Gloss-Free Encoding for Token-Efficient Sign Language Translation
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2507.09266](https://arxiv.org/pdf/2507.09266)**

> **作者:** JianHe Low; Ozge Mercanoglu Sincan; Richard Bowden
>
> **备注:** Accepted in International Conference on Computer Vision (ICCV) Workshops. Code released at this https URL
>
...
>
---
#### [replaced 056] The Vision Wormhole: Latent-Space Communication in Heterogeneous Multi-Agent Systems
...
>
---
#### [replaced 057] MENTOR: Efficient Multimodal-Conditioned Tuning for Autoregressive Vision Generation Models
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 060] Gaga: Group Any Gaussians via 3D-aware Memory Bank
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2404.07977](https://arxiv.org/pdf/2404.07977)**

> **作者:** Weijie Lyu; Xueting Li; Abhijit Kundu; Yi-Hsuan Tsai; Ming-Hsuan Yang
>
> **备注:** TMLR Camera-Ready Version. Project Page: this https URL
>
...
>
---
#### [replaced 065] Resolution as a Direction: Vector-Panning Feature Alignment for Cross-Resolution Re-Identification
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2510.00936](https://arxiv.org/pdf/2510.00936)**

> **作者:** Zanwu Liu; Chao Yuan; Bo Li; Xiaowei Zhang; Guanglin Niu
>
> **摘要:** Cross-resolution person re-identification (CR-ReID) remains challenging in practical surveillance, where camera quality and capture distance lead to substantial resolution gaps between low-resolution (LR) queries and high-resolution (HR) gallery images. Prior approaches commonly rely on super-resolution (SR) or resolution-invariant representation learning, which often increases system complexity and may not directly address the feature mismatch induced by resolution degradation. In this work, we report a new empirical finding from a dedicated analysis in which identity-specific variation is averaged out: the HR--LR feature discrepancy produced by standard ReID backbones exhibits a consistent, resolution-related semantic direction in the embedding space. We further support this observation with statistical analyses based on Canonical Correlation Analysis (CCA) and Pearson correlation analysis. Motivated by this finding, we propose Vector Panning Feature Alignment (VPFA), a lightweight post-hoc module that learns to pan LR features along the learned resolution direction to obtain pseudo-HR representations. VPFA operates after feature extraction and can be integrated into existing ReID systems with negligible overhead. Extensive experiments on multiple CR-ReID benchmarks show that VPFA achieves state-of-the-art performance while improving efficiency compared to SR-based or jointly trained alternatives.
>
---
#### [replaced 066] Structure-Aware Text Recognition for Ancient Greek Critical Editions
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2603.02803](https://arxiv.org/pdf/2603.02803)**
...
>
---
#### [replaced 067] VRAG: Learning World Models for Interactive Video Generation
- **分类: cs.CV; cs.AI**
...
>
> **备注:** Published at NeurIPS 2025. Project page: this https URL
>
...
> **作者:** Kateryna Lutsai
>
> **备注:** Dataset licensing issues occurred
>
...
>
---
#### [replaced 073] ChartAct: A Benchmark for Dynamic Chart Understanding
- **分类: cs.CV**

- **链接: [https://arxiv.org/pdf/2605.26994](https://arxiv.org/pdf/2605.26994)**

> **作者:** Muye Huang; Lin Wu; Lingling Zhang; Hang Yan; Zhiyuan Wang; Yumeng Fu; Zesheng Yang; Jun Liu
>
...
>
---
#### [replaced 076] RHO: Robust Holistic OSM-Based Metric Cross-View Geo-Localization
- **分类: cs.CV**
...
>
---
#### [replaced 077] Coarse-to-Fine Domain Incremental Learning with Attentive Distillation for Mining Footprint Segmentation in Multispectral Imagery
- **分类: cs.CV; cs.AI**
...
>
> **备注:** Accepted at the 35th International Joint Conference on Artificial Intelligence (IJCAI 2026), AI and Social Good track
>
...
>
---
#### [replaced 078] SRUG: Shadow-Guided Relightable Urban Scene with Generation Model
- **分类: cs.CV; cs.GR**
...
>
---
#### [replaced 079] MOO: A Multi-view Oriented Observations Dataset for Viewpoint Analysis in Cattle Re-Identification
- **分类: cs.CV; cs.AI**
...
>
> **备注:** 6 pages, 3 figures, accepted to the CVPR 2026 Workshop on Computer Vision for Animal Behavior Tracking and Modeling (CV4Animals)
>
...
>
---
#### [replaced 080] JMed48k: A Multi-Profession Japanese Medical Licensing Benchmark for Vision-Language Model Evaluation
- **分类: cs.CV; cs.AI**
...
>
---
#### [replaced 083] Getting to the Point: Pointing Improves LVLMs at Counting
- **分类: cs.CV**
...
>
---
#### [replaced 085] TWINGS: Thin Plate Splines Warp-aligned Initialization for Sparse-View Gaussian Splatting
- **分类: cs.CV; cs.LG**
...
>
---
#### [replaced 086] X-GS: An Extensible Framework for Perceiving and Thinking via 3D Gaussian Splatting
- **分类: cs.CV; cs.CL**
...
>
---
#### [replaced 089] PixIE: Prompted Pixel-Space Low-Light Image Enhancement
- **分类: cs.CV**
