...
>
---
#### [new 005] MAESTRO: Masked AutoEncoders for Multimodal, Multitemporal, and Multispectral Earth Observation Data
- **分类: cs.CV**
...
- **链接: [http://arxiv.org/pdf/2508.10528v1](http://arxiv.org/pdf/2508.10528v1)**
...
- **简介: 论文提出一种难度分级的视觉推理基准JRDB-Reasoning，针对现有任务复杂度定义模糊、问题难度控制不足及结构化注释缺失等问题，设计自适应查询引擎生成多难度问题并扩展数据集，用于评估视觉推理框架与模型表现。**
...
- **简介: 论文提出VasoMIM框架，针对X射线angiograms血管分割中因类别不平衡导致的性能瓶颈，通过整合解剖知识与双模块机制（引导掩码+一致性损失）提升血管表示，实现SOTA性能。**
...
- **简介: 论文研究视觉编码器在图像采集与处理中的细微参数对语义预测的影响，发现其可显著改变模型输出，依赖标签相关性。**
...
- **简介: 论文提出NSegment+框架，通过分离图像与标签变换，仅对标签施加弹性变形，应对隐式标签噪声，提升语义分割鲁棒性，实验显示性能显著提升。**
...
- **简介: 论文提出P$^3$A框架，针对2D目标检测在自动驾驶中的对抗攻击，解决传统方法评估指标不准确、高分辨率数据效果受限等问题，通过改进PASR、LCSL和PSPP提升攻击有效性与实用性。**
...
- **简介: 论文综述出分布分割方法，针对自动驾驶中OoD对象像素级定位问题，分类讨论四种技术路线，并分析挑战与未来方向。**
...
- **链接: [http://arxiv.org/pdf/2508.10731v1](http://arxiv.org/pdf/2508.10731v1)**
...
- **简介: 本文提出跨视图定位新框架，通过Surface Model和SimRefiner模块提升图像匹配精度，解决传统方法依赖RANSAC等后处理的问题，构建CVFM基准数据集。**
...
- **简介: 论文提出基于因果Transformer的流式3D重建方法，解决多视图重建中长序列处理效率低及内存瓶颈问题，通过几何先验学习提升动态场景重建性能，兼容LLM训练架构。**
...
- **简介: 该论文针对花样滑冰跳跃动作识别任务，解决数据不足和三维结构未考虑问题，提出VIFSS框架，结合对比学习与动作分类，构建FS-Jump3D数据集并使用细粒度标注。**
...
- **简介: 论文提出结合egocentric视频和音乐的舞蹈运动估计方法，解决视频遮挡和音乐同步问题，使用Skeleton Mamba网络提升精度。**
...
- **简介: 论文提出AtomDiffuser框架，通过预测仿射变换和空间变衰减图解耦STEM图像退化，解决时间相关漂移与辐射损伤干扰问题，实现原子级材料动态建模。**
...
- **简介: 该论文提出MRFD方法，用于LVLMs的多模态任务，解决幻觉问题，通过跨区域一致性建模和融合提升事实准确性。**
...
- **链接: [http://arxiv.org/pdf/2508.10554v1](http://arxiv.org/pdf/2508.10554v1)**
...
- **简介: 论文针对视频类增量学习（VCIL）中内存效率与性能的矛盾，提出ESSENTIAL方法，通过结合时序稀疏特征与语义知识，利用跨注意力机制整合记忆，提升学习效果。**
...
- **简介: 论文提出TexVerse，一个包含高分辨率纹理的3D数据集，解决纹理生成难题，通过858K模型及PBR材料实现端到端生成，支持纹理合成与PBR开发等任务。**
...
- **简介: 该论文提出一种图增强的上下文与区域感知网络（GCRPNet），针对光学遥感图像显著目标检测中尺度变化和背景对比度低的问题，通过多尺度特征提取、跨层级图注意力机制及自适应扫描策略，提升特征融合与局部建模能力，实现高效准确的目标定位。**
...
- **简介: 论文提出FIND-Net，通过融合傅里叶与空间域处理，结合FFC和可训练高斯滤波，解决金属伪影抑制与结构保留矛盾，实现CT图像质量提升。**
...
- **简介: 论文提出量子视觉场（QVF）任务，解决量子架构与训练效率问题，通过神经振幅编码和全纠缠量子电路实现2D/3D图像/几何场学习，无需经典后处理，直接利用投影测量提取信号，实验表明其在准确性和效率上优于传统方法。**
...
>
---
#### [new 066] Video-BLADE: Block-Sparse Attention Meets Step Distillation for Efficient Video Generation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 论文提出BLADE框架，结合块稀疏注意力与步骤蒸馏，解决视频生成中计算瓶颈，提升效率并保持质量。**

- **链接: [http://arxiv.org/pdf/2508.10774v1](http://arxiv.org/pdf/2508.10774v1)**
...
>
---
#### [new 072] Hierarchical Fine-grained Preference Optimization for Physically Plausible Video Generation
- **分类: cs.CV**

- **简介: 该论文提出PhysHPO框架，通过层级化偏好优化提升物理真实的视频生成，解决物理规律约束不足问题，采用四层结构（实例/状态/运动/语义）及自动数据筛选，显著增强视频真实性和质量。**

- **链接: [http://arxiv.org/pdf/2508.10858v1](http://arxiv.org/pdf/2508.10858v1)**
...
- **简介: 论文提出DINOv3，通过改进数据准备和引入Gram anchoring解决长期训练中的特征退化问题，提升模型在不同场景下的泛化能力，实现高效自监督视觉表示学习。**

- **链接: [http://arxiv.org/pdf/2508.10104v1](http://arxiv.org/pdf/2508.10104v1)**
...
>
---
#### [new 074] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
- **分类: cs.CV**

- **简介: 论文提出EntropyGS方法，针对3D Gaussian Splatting数据高效压缩，通过分析属性分布特性实现参数化熵编码，降低30倍速率同时保持渲染质量。**

- **链接: [http://arxiv.org/pdf/2508.10227v1](http://arxiv.org/pdf/2508.10227v1)**
...
>
---
#### [new 083] AEGIS: Authenticity Evaluation Benchmark for AI-Generated Video Sequences
- **分类: cs.CV; cs.AI**

- **简介: 论文提出AEGIS作为AI生成视频真实性评估基准，解决现有基准不足的问题，通过大规模真实/合成视频及多模态注释，验证先进模型检测能力，推动可信视频检测研究。**

- **链接: [http://arxiv.org/pdf/2508.10771v1](http://arxiv.org/pdf/2508.10771v1)**
...
>
---
#### [new 084] Cooperative Face Liveness Detection from Optical Flow
- **分类: cs.CV**

- **简介: 论文提出基于光学流的协作面部活体检测方法，通过控制参与者靠近摄像头的面部协议与神经网络分类，提取空间-时间特征提升真实人脸与伪造攻击的区分度。**

- **链接: [http://arxiv.org/pdf/2508.10786v1](http://arxiv.org/pdf/2508.10786v1)**
...
>
---
#### [new 097] Performance of GPT-5 in Brain Tumor MRI Reasoning
- **分类: cs.CV; cs.AI**

- **简介: 论文评估GPT-5系列模型在脑肿瘤MRI视觉问答任务中的性能，旨在解决脑肿瘤类型区分的临床需求，通过对比不同规模模型在结构化VQA任务中的表现，发现GPT-5-mini达到44.19%准确率，但未满足临床应用标准。**

- **链接: [http://arxiv.org/pdf/2508.10865v1](http://arxiv.org/pdf/2508.10865v1)**

> **作者:** Mojtaba Safari; Shansong Wang; Mingzhe Hu; Zach Eidex; Qiang Li; Xiaofeng Yang
>
> **摘要:** Accurate differentiation of brain tumor types on magnetic resonance imaging (MRI) is critical for guiding treatment planning in neuro-oncology. Recent advances in large language models (LLMs) have enabled visual question answering (VQA) approaches that integrate image interpretation with natural language reasoning. In this study, we evaluated GPT-4o, GPT-5-nano, GPT-5-mini, and GPT-5 on a curated brain tumor VQA benchmark derived from 3 Brain Tumor Segmentation (BraTS) datasets - glioblastoma (GLI), meningioma (MEN), and brain metastases (MET). Each case included multi-sequence MRI triplanar mosaics and structured clinical features transformed into standardized VQA items. Models were assessed in a zero-shot chain-of-thought setting for accuracy on both visual and reasoning tasks. Results showed that GPT-5-mini achieved the highest macro-average accuracy (44.19%), followed by GPT-5 (43.71%), GPT-4o (41.49%), and GPT-5-nano (35.85%). Performance varied by tumor subtype, with no single model dominating across all cohorts. These findings suggest that GPT-5 family models can achieve moderate accuracy in structured neuro-oncological VQA tasks, but not at a level acceptable for clinical use.
>
---
#### [new 098] STAMP: Multi-pattern Attention-aware Multiple Instance Learning for STAS Diagnosis in Multi-center Histopathology Images
- **分类: cs.CV; cs.CY**
...
>
---
#### [new 101] Exploiting Discriminative Codebook Prior for Autoregressive Image Generation
- **分类: cs.CV**

- **简介: 论文提出DCPE，通过实例距离和聚合技术解决代码本先验利用不足问题，提升自回归图像生成效率。**

- **链接: [http://arxiv.org/pdf/2508.10719v1](http://arxiv.org/pdf/2508.10719v1)**
...
>
---
#### [new 105] Deep Learning Enables Large-Scale Shape and Appearance Modeling in Total-Body DXA Imaging
- **分类: cs.CV**

- **简介: 论文提出一种深度学习方法，用于在全身DXA影像中自动放置关键点，解决大规模数据下的精度问题，通过高准确率验证，应用于不同模式，关联健康指标，生成代码资源。**

- **链接: [http://arxiv.org/pdf/2508.10132v1](http://arxiv.org/pdf/2508.10132v1)**
...
>
---
#### [new 108] Geospatial Diffusion for Land Cover Imperviousness Change Forecasting
- **分类: cs.LG; cs.CV**

- **简介: 论文提出基于生成式AI的地理扩散模型，通过结合历史与辅助数据预测地表覆盖不透水变化，解决传统方法精度不足问题，验证其在高分辨率下的有效性，并探讨未来融入物理属性与情景模拟的可能性。**

- **链接: [http://arxiv.org/pdf/2508.10649v1](http://arxiv.org/pdf/2508.10649v1)**
...
>
---
#### [new 111] On the Complexity-Faithfulness Trade-off of Gradient-Based Explanations
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 论文研究梯度解释中复杂度与忠实度的权衡，解决现有方法牺牲faithfulness的问题，提出频谱框架量化ReLU网络对高频率信息的贡献，识别trade-off并分析平滑影响，定义解释差距并验证结果。**

- **链接: [http://arxiv.org/pdf/2508.10490v1](http://arxiv.org/pdf/2508.10490v1)**
...
>
---
#### [new 112] When Experts Disagree: Characterizing Annotator Variability for Vessel Segmentation in DSA Images
- **分类: eess.IV; cs.CV**

- **简介: 论文研究多专家标注血管分割中的变异，量化不确定性并指导注释与鲁棒分割方法开发。**

- **链接: [http://arxiv.org/pdf/2508.10797v1](http://arxiv.org/pdf/2508.10797v1)**
...
>
---
#### [new 115] Data-Efficient Learning for Generalizable Surgical Video Understanding
- **分类: eess.IV; cs.CV**

- **简介: 论文提出基于半监督学习的手术视频理解方法，解决标注稀缺与领域差距问题，通过DIST、SemiVT-Surge等框架提升模型泛化能力，并发布GynSurg和Catateract-1K数据集，推动临床可扩展的AI手术分析系统。**

- **链接: [http://arxiv.org/pdf/2508.10215v1](http://arxiv.org/pdf/2508.10215v1)**
...
>
---
#### [new 116] ReconVLA: Reconstructive Vision-Language-Action Model as Effective Robot Perceiver
- **分类: cs.RO; cs.CV**
...
>
---
#### [new 117] CorrectNav: Self-Correction Flywheel Empowers Vision-Language-Action Navigation Model
...
>
---
#### [new 118] Explainable AI Technique in Lung Cancer Detection Using Convolutional Neural Networks
- **分类: eess.IV; cs.CV; 68T07**

- **简介: 论文提出基于CNN的肺癌检测框架，利用迁移学习模型解决类别不平衡问题，通过SHAP解释提升可解释性，实现快速准确的筛查，适用于资源受限场景。**

- **链接: [http://arxiv.org/pdf/2508.10196v1](http://arxiv.org/pdf/2508.10196v1)**
...
>
---
#### [new 119] SynBrain: Enhancing Visual-to-fMRI Synthesis via Probabilistic Representation Learning
- **分类: cs.LG; cs.CV; eess.IV**

- **简介: 论文提出SynBrain框架，通过概率表示学习增强视觉到fMRI合成，解决生物变异性和功能一致性问题，采用BrainVAE和语义映射器，提升解码性能并揭示功能一致性。**

- **链接: [http://arxiv.org/pdf/2508.10298v1](http://arxiv.org/pdf/2508.10298v1)**
...
>
---
#### [new 120] MM-Food-100K: A 100,000-Sample Multimodal Food Intelligence Dataset with Verifiable Provenance
- **分类: cs.AI; cs.CR; cs.CV; I.2.10; I.2.6**

- **简介: 论文提出MM-Food-100K多模态食物数据集，通过社区贡献与AI质量验证构建可追溯的10万样本，用于营养预测任务，验证模型微调效果。**

- **链接: [http://arxiv.org/pdf/2508.10429v1](http://arxiv.org/pdf/2508.10429v1)**
...
>
> **摘要:** We present MM-Food-100K, a public 100,000-sample multimodal food intelligence dataset with verifiable provenance. It is a curated approximately 10% open subset of an original 1.2 million, quality-accepted corpus of food images annotated for a wide range of information (such as dish name, region of creation). The corpus was collected over six weeks from over 87,000 contributors using the Codatta contribution model, which combines community sourcing with configurable AI-assisted quality checks; each submission is linked to a wallet address in a secure off-chain ledger for traceability, with a full on-chain protocol on the roadmap. We describe the schema, pipeline, and QA, and validate utility by fine-tuning large vision-language models (ChatGPT 5, ChatGPT OSS, Qwen-Max) on image-based nutrition prediction. Fine-tuning yields consistent gains over out-of-box baselines across standard metrics; we report results primarily on the MM-Food-100K subset. We release MM-Food-100K for publicly free access and retain approximately 90% for potential commercial access with revenue sharing to contributors.
>
---
#### [new 121] DIVA-VQA: Detecting Inter-frame Variations in UGC Video Quality
- **分类: eess.IV; cs.CV; cs.MM**

- **简介: 论文提出基于帧间差异的空间时间分割模型，解决无参考视频质量评估中帧间变化捕捉难题，通过多尺度分析与多维度特征提取提升评估精度，实验显示在UGC数据集上表现优于现有方法。**

- **链接: [http://arxiv.org/pdf/2508.10605v1](http://arxiv.org/pdf/2508.10605v1)**
...
>
---
#### [new 122] Agentic Design Review System
- **分类: cs.AI; cs.CV; cs.LG; cs.MA; cs.MM**

- **简介: 论文提出基于多代理协作的图形设计评审系统，通过图匹配与提示扩展提升设计意识，构建DRS-BENCH基准，验证其在设计评估与反馈生成中的有效性。任务为设计评估，解决传统单专家评审效率低的问题。**

- **链接: [http://arxiv.org/pdf/2508.10745v1](http://arxiv.org/pdf/2508.10745v1)**
...
>
---
#### [new 123] DINOMotion: advanced robust tissue motion tracking with DINOv2 in 2D-Cine MRI-guided radiotherapy
- **分类: eess.IV; cs.AI; cs.CV**

- **简介: 论文提出DINOMotion，基于DINOv2与LoRA的深度学习框架，解决2D-Cine MRI引导放疗中组织运动跟踪的高错位和可解释性问题，通过自动地标检测与可视化对应关系，提升鲁棒性与效率。**

- **链接: [http://arxiv.org/pdf/2508.10260v1](http://arxiv.org/pdf/2508.10260v1)**
...
>
---
#### [new 124] We-Math 2.0: A Versatile MathBook System for Incentivizing Visual Mathematical Reasoning
- **分类: cs.AI; cs.CV; cs.LG**

- **简介: 论文提出We-Math 2.0系统，通过构建多层次数学知识体系、设计难度梯度数据集及RL训练框架，提升MLLMs在复杂数学推理中的表现。**

- **链接: [http://arxiv.org/pdf/2508.10433v1](http://arxiv.org/pdf/2508.10433v1)**
...
>
---
#### [new 125] AI-Driven Detection and Analysis of Handwriting on Seized Ivory: A Tool to Uncover Criminal Networks in the Illicit Wildlife Trade
- **分类: cs.LG; cs.CV**

- **简介: 论文提出AI驱动的工具分析象牙手写标记，揭示犯罪网络，填补数据空白，建立链接。**

- **链接: [http://arxiv.org/pdf/2508.10219v1](http://arxiv.org/pdf/2508.10219v1)**
...
>
---
#### [new 126] From Intent to Execution: Multimodal Chain-of-Thought Reinforcement Learning for Precise CAD Code Generation
- **分类: cs.LG; cs.CV**

- **简介: 论文提出基于多模态Chain-of-Thought的强化学习框架CAD-RL，解决CAD代码生成中意图到执行的挑战，通过三类任务奖励与优化策略提升推理精度与代码可执行性，并发布ExeCAD数据集。**

- **链接: [http://arxiv.org/pdf/2508.10118v1](http://arxiv.org/pdf/2508.10118v1)**
...
>
---
#### [new 127] Improving Learning of New Diseases through Knowledge-Enhanced Initialization for Federated Adapter Tuning
- **分类: cs.LG; cs.CV**

- **简介: 论文提出FedKEI框架，通过跨客户端和任务的知识迁移优化联邦适配器初始化，解决医疗领域快速适应新疾病的问题，提升模型泛化能力。**

- **链接: [http://arxiv.org/pdf/2508.10299v1](http://arxiv.org/pdf/2508.10299v1)**
...
#### [replaced 001] EventRR: Event Referential Reasoning for Referring Video Object Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.07171v2](http://arxiv.org/pdf/2508.07171v2)**
...
>
---
#### [replaced 002] MSC: A Marine Wildlife Video Dataset with Grounded Segmentation and Clip-Level Captioning
- **分类: cs.CV; cs.AI; cs.MM**

- **链接: [http://arxiv.org/pdf/2508.04549v2](http://arxiv.org/pdf/2508.04549v2)**
...
>
---
#### [replaced 003] Exploring the Application of Visual Question Answering (VQA) for Classroom Activity Monitoring
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.22369v2](http://arxiv.org/pdf/2507.22369v2)**
...
>
---
#### [replaced 004] Unifying Self-Supervised Clustering and Energy-Based Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2401.00873v5](http://arxiv.org/pdf/2401.00873v5)**

> **作者:** Emanuele Sansone; Robin Manhaeve
>
> **备注:** Changes from previous version: change introductions and added acknowledgments. Integral version of workshop paper arXiv:2309.15420. Improved GEDI version (from two stages to single stage training) arxiv:2212.13425 - ACCEPTED TO TMLR 2025
>
...
>
---
#### [replaced 008] A Linear N-Point Solver for Structure and Motion from Asynchronous Tracks
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.22733v2](http://arxiv.org/pdf/2507.22733v2)**
...
>
---
#### [replaced 011] Hierarchical Cross-modal Prompt Learning for Vision-Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.14976v2](http://arxiv.org/pdf/2507.14976v2)**
...
>
---
#### [replaced 021] Preacher: Paper-to-Video Agentic System
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09632v2](http://arxiv.org/pdf/2508.09632v2)**
...
>
---
#### [replaced 022] Evaluation of Cultural Competence of Vision-Language Models
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2505.22793v2](http://arxiv.org/pdf/2505.22793v2)**
...
>
---
#### [replaced 023] Reinforcement Learning in Vision: A Survey
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.08189v2](http://arxiv.org/pdf/2508.08189v2)**
...
>
---
#### [replaced 024] TikZero: Zero-Shot Text-Guided Graphics Program Synthesis
- **分类: cs.CL; cs.CV**

- **链接: [http://arxiv.org/pdf/2503.11509v3](http://arxiv.org/pdf/2503.11509v3)**

> **作者:** Jonas Belouadi; Eddy Ilg; Margret Keuper; Hideki Tanaka; Masao Utiyama; Raj Dabre; Steffen Eger; Simone Paolo Ponzetto
>
> **备注:** Accepted at ICCV 2025 (highlight); Project page: https://github.com/potamides/DeTikZify
>
> **摘要:** Automatically synthesizing figures from text captions is a compelling capability. However, achieving high geometric precision and editability requires representing figures as graphics programs in languages like TikZ, and aligned training data (i.e., graphics programs with captions) remains scarce. Meanwhile, large amounts of unaligned graphics programs and captioned raster images are more readily available. We reconcile these disparate data sources by presenting TikZero, which decouples graphics program generation from text understanding by using image representations as an intermediary bridge. It enables independent training on graphics programs and captioned images and allows for zero-shot text-guided graphics program synthesis during inference. We show that our method substantially outperforms baselines that can only operate with caption-aligned graphics programs. Furthermore, when leveraging caption-aligned graphics programs as a complementary training signal, TikZero matches or exceeds the performance of much larger models, including commercial systems like GPT-4o. Our code, datasets, and select models are publicly available.
>
---
#### [replaced 025] Vision Transformers in Precision Agriculture: A Comprehensive Survey
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.21706v4](http://arxiv.org/pdf/2504.21706v4)**
...
>
---
#### [replaced 026] DualPM: Dual Posed-Canonical Point Maps for 3D Shape and Pose Reconstruction
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.04464v5](http://arxiv.org/pdf/2412.04464v5)**
...
>
---
#### [replaced 028] UniOcc: A Unified Benchmark for Occupancy Forecasting and Prediction in Autonomous Driving
...
>
---
#### [replaced 029] OrderChain: Towards General Instruct-Tuning for Stimulating the Ordinal Understanding Ability of MLLM
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.04801v3](http://arxiv.org/pdf/2504.04801v3)**
...
>
---
#### [replaced 030] EXAONE Path 2.0: Pathology Foundation Model with End-to-End Supervision
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.06639v2](http://arxiv.org/pdf/2507.06639v2)**

> **作者:** Myeongjang Pyeon; Janghyeon Lee; Minsoo Lee; Juseung Yun; Hwanil Choi; Jonghyun Kim; Jiwon Kim; Yi Hu; Jongseong Jang; Soonyoung Lee
>
...
>
---
#### [replaced 031] WeatherPrompt: Multi-modality Representation Learning for All-Weather Drone Visual Geo-Localization
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 032] Re:Verse -- Can Your VLM Read a Manga?
- **分类: cs.CV; cs.CL**

- **链接: [http://arxiv.org/pdf/2508.08508v2](http://arxiv.org/pdf/2508.08508v2)**

> **作者:** Aaditya Baranwal; Madhav Kataria; Naitik Agrawal; Yogesh S Rawat; Shruti Vyas
>
> **备注:** Accepted at ICCV (AISTORY Workshop) 2025
>
...
- **链接: [http://arxiv.org/pdf/2507.08307v3](http://arxiv.org/pdf/2507.08307v3)**
...
>
---
#### [replaced 039] Warehouse Spatial Question Answering with LLM Agent
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2507.10778v2](http://arxiv.org/pdf/2507.10778v2)**
...
>
---
#### [replaced 042] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
- **分类: cs.CV; cs.GR**

- **链接: [http://arxiv.org/pdf/2412.00578v3](http://arxiv.org/pdf/2412.00578v3)**
...
>
---
#### [replaced 043] OpenCUA: Open Foundations for Computer-Use Agents
- **分类: cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09123v2](http://arxiv.org/pdf/2508.09123v2)**
...
>
---
#### [replaced 044] MIDAS: Modeling Ground-Truth Distributions with Dark Knowledge for Domain Generalized Stereo Matching
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.04376v2](http://arxiv.org/pdf/2503.04376v2)**
...
>
---
#### [replaced 045] SOI is the Root of All Evil: Quantifying and Breaking Similar Object Interference in Single Object Tracking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09524v2](http://arxiv.org/pdf/2508.09524v2)**
...
>
---
#### [replaced 046] Visual SLAMMOT Considering Multiple Motion Models
...
>
---
#### [replaced 050] MEDTalk: Multimodal Controlled 3D Facial Animation with Dynamic Emotions by Disentangled Embedding
- **分类: cs.CV; cs.MM**

- **链接: [http://arxiv.org/pdf/2507.06071v4](http://arxiv.org/pdf/2507.06071v4)**
...
>
---
#### [replaced 051] MusiXQA: Advancing Visual Music Understanding in Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.23009v3](http://arxiv.org/pdf/2506.23009v3)**
...
>
---
#### [replaced 052] VMem: Consistent Interactive Video Scene Generation with Surfel-Indexed View Memory
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.18903v3](http://arxiv.org/pdf/2506.18903v3)**

> **作者:** Runjia Li; Philip Torr; Andrea Vedaldi; Tomas Jakab
>
> **备注:** ICCV 2025 highlight. Project page: https://v-mem.github.io
>
...
>
---
#### [replaced 055] IAD-R1: Reinforcing Consistent Reasoning in Industrial Anomaly Detection
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09178v2](http://arxiv.org/pdf/2508.09178v2)**
...
>
---
#### [replaced 056] From Large Angles to Consistent Faces: Identity-Preserving Video Generation via Mixture of Facial Experts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09476v2](http://arxiv.org/pdf/2508.09476v2)**
...
>
---
#### [replaced 057] Unifying Locality of KANs and Feature Drift Compensation Projection for Data-free Replay based Continual Face Forgery Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03189v2](http://arxiv.org/pdf/2508.03189v2)**
...
>
---
#### [replaced 058] PiT: Progressive Diffusion Transformer
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.13219v5](http://arxiv.org/pdf/2505.13219v5)**
...
>
---
#### [replaced 059] CCL-LGS: Contrastive Codebook Learning for 3D Language Gaussian Splatting
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.20469v2](http://arxiv.org/pdf/2505.20469v2)**
...
>
---
#### [replaced 060] Personalized Feature Translation for Expression Recognition: An Efficient Source-Free Domain Adaptation Method
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09202v2](http://arxiv.org/pdf/2508.09202v2)**
...
>
---
#### [replaced 061] SIFThinker: Spatially-Aware Image Focus for Visual Reasoning
- **分类: cs.CV; cs.AI; I.2.10**

- **链接: [http://arxiv.org/pdf/2508.06259v2](http://arxiv.org/pdf/2508.06259v2)**
...
>
---
#### [replaced 062] Yan: Foundational Interactive Video Generation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.08601v3](http://arxiv.org/pdf/2508.08601v3)**
...
>
---
#### [replaced 063] GraspClutter6D: A Large-scale Real-world Dataset for Robust Perception and Grasping in Cluttered Scenes
- **分类: cs.RO; cs.AI; cs.CV**
...
>
---
#### [replaced 064] GLM-4.1V-Thinking and GLM-4.5V: Towards Versatile Multimodal Reasoning with Scalable Reinforcement Learning
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.01006v4](http://arxiv.org/pdf/2507.01006v4)**
...
>
---
#### [replaced 065] A Neurosymbolic Framework for Interpretable Cognitive Attack Detection in Augmented Reality
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2508.09185v2](http://arxiv.org/pdf/2508.09185v2)**
...
>
---
#### [replaced 073] EditGarment: An Instruction-Based Garment Editing Dataset Constructed with Automated MLLM Synthesis and Semantic-Aware Evaluation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03497v2](http://arxiv.org/pdf/2508.03497v2)**
...
>
---
#### [replaced 074] Reinforcement Learning meets Masked Video Modeling : Trajectory-Guided Adaptive Token Selection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.08561v2](http://arxiv.org/pdf/2505.08561v2)**
...
>
---
#### [replaced 077] Robotic Ultrasound-Guided Femoral Artery Reconstruction of Anatomically-Representative Phantoms
- **分类: cs.RO; cs.CV**
...
>
---
#### [replaced 078] MedVLThinker: Simple Baselines for Multimodal Medical Reasoning
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.02669v2](http://arxiv.org/pdf/2508.02669v2)**

> **作者:** Xiaoke Huang; Juncheng Wu; Hui Liu; Xianfeng Tang; Yuyin Zhou
>
> **备注:** Project page: https://ucsc-vlaa.github.io/MedVLThinker/ ; Code: https://github.com/UCSC-VLAA/MedVLThinker ; Model and Data: https://huggingface.co/collections/UCSC-VLAA/medvlthinker-688f52224fb7ff7d965d581d
>
...
>
---
#### [replaced 079] VPOcc: Exploiting Vanishing Point for 3D Semantic Occupancy Prediction
- **分类: cs.CV; cs.RO**
...
>
---
#### [replaced 080] Deblurring in the Wild: A Real-World Dataset from Smartphone High-Speed Videos
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.19445v3](http://arxiv.org/pdf/2506.19445v3)**

> **作者:** Mahdi Mohd Hossain Noki; Syed Mumtahin Mahmud; Prothito Shovon Majumder; Abdul Mohaimen Al Radi; Sudipto Das Sukanto; Afia Lubaina; Md. Mosaddek Khan
>
...
>
---
#### [replaced 081] iSafetyBench: A video-language benchmark for safety in industrial environment
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.00399v2](http://arxiv.org/pdf/2508.00399v2)**
...
>
---
#### [replaced 082] Stepwise Decomposition and Dual-stream Focus: A Novel Approach for Training-free Camouflaged Object Segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.06818v3](http://arxiv.org/pdf/2506.06818v3)**
...
>
---
#### [replaced 083] Scaling Open-Vocabulary Action Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.03096v4](http://arxiv.org/pdf/2504.03096v4)**

> **作者:** Zhen Hao Sia; Yogesh Singh Rawat
>
> **摘要:** In this work, we focus on scaling open-vocabulary action detection. Existing approaches for action detection are predominantly limited to closed-set scenarios and rely on complex, parameter-heavy architectures. Extending these models to the open-vocabulary setting poses two key challenges: (1) the lack of large-scale datasets with many action classes for robust training, and (2) parameter-heavy adaptations to a pretrained vision-language contrastive model to convert it for detection, risking overfitting the additional non-pretrained parameters to base action classes. Firstly, we introduce an encoder-only multimodal model for video action detection, reducing the reliance on parameter-heavy additions for video action detection. Secondly, we introduce a simple weakly supervised training strategy to exploit an existing closed-set action detection dataset for pretraining. Finally, we depart from the ill-posed base-to-novel benchmark used by prior works in open-vocabulary action detection and devise a new benchmark to evaluate on existing closed-set action detection datasets without ever using them for training, showing novel results to serve as baselines for future work. Our code is available at https://siatheindochinese.github.io/sia_act_page/ .
>
---
#### [replaced 084] SHALE: A Scalable Benchmark for Fine-grained Hallucination Evaluation in LVLMs
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.09584v2](http://arxiv.org/pdf/2508.09584v2)**
...
>
---
#### [replaced 085] Point or Line? Using Line-based Representation for Panoptic Symbol Spotting in CAD Drawings
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23395v2](http://arxiv.org/pdf/2505.23395v2)**
...
>
---
#### [replaced 086] Improving Viewpoint Consistency in 3D Generation via Structure Feature and CLIP Guidance
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2412.02287v4](http://arxiv.org/pdf/2412.02287v4)**
