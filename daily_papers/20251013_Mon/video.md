...
- **简介: 该论文属于图像生成任务，旨在解决视觉自回归模型（VAR）在生成高质量图像时计算冗余的问题。通过引入动态Mixture-of-Experts路由机制，根据token复杂度和分辨率动态选择专家，减少Transformer重复计算，在不降低图像质量的前提下提升效率。**
...
- **简介: 该论文属于作物生长建模任务，旨在解决传统蔓越莓生长监测依赖人工、耗时且难以扩展的问题。作者提出一种基于视觉Transformer的自监督微调方法，通过时间回归与类别预测任务构建可解释的生长轨迹模型，并发布了一个包含8个品种、52次观测的蔓越莓时间序列数据集。**
...
- **简介: 该论文属于遥感图像恢复任务，旨在解决多类型复杂退化导致的图像质量下降问题。提出了PhyDAE方法，通过物理引导的退化自适应专家模块，结合残差流形投影和频率感知退化分解，实现对多种退化（如雾霾、噪声、模糊、低光）的精准识别与处理。相比现有方法，提升了恢复质量并降低了计算复杂度。**
...
- **简介: 该论文属于计算机视觉任务，旨在解决数据标注成本高和合成数据多样性不足的问题。工作提出SOS合成数据生成方法，通过合成对象片段提升目标检测、分割和视觉基础任务的性能，实现优于真实数据集的效果。**
...
- **简介: 该论文属于4D场景编辑任务，旨在根据文本提示对单目视频重建的动态场景进行局部精准编辑。核心问题是复杂动态场景中语义编辑的精准性与未编辑区域完整性之间的平衡。论文提出Mono4DEditor框架，结合语言嵌入高斯表示与点级定位策略，实现高效语义查询与精确空间编辑，并通过扩散模型保证编辑的时空一致性。**
...
- **简介: 该论文属于目标检测任务，旨在解决低数据环境下传统模型依赖大量数据的问题。作者比较了CNN与多模态大语言模型（LLM）在人工文本覆盖检测中的表现，发现通过微调LLM可在少量数据（<1000张图像）下实现36%的准确率提升，优于传统CNN。论文探索了语言引导模型在视觉任务中的高效跨模态学习策略。**
...
- **简介: 该论文属于计算机视觉中的图像表示任务，旨在解决传统正交矩方法计算复杂度高、数值不稳定的问题。论文提出了一种可分离的正交变换——极坐标可分离变换（PSepT），通过离散余弦变换径向基和傅里叶角基的张量积构造，实现高效、稳定的图像表示，具有低计算复杂度和良好的数值稳定性。**
...
- **简介: 该论文属于图像隐私分类任务，旨在解决当前使用大视觉-语言模型（VLMs）进行隐私预测可能忽略专用模型性能上限的问题。作者建立了一个零样本基准，评估主流开源VLMs在隐私分类中的表现，并与专用模型对比。结果发现，尽管VLMs更耗资源且推理慢，但其隐私预测准确率仍低于专用模型，但对图像扰动更具鲁棒性。**
...
- **简介: 该论文属于图像识别任务，旨在解决细粒度实例级识别（ILR）中缺乏大规模标注数据的问题。作者提出了一种无需真实图像的数据合成方法，可生成多领域、多条件下的物体实例，用于训练视觉模型，显著提升了跨多个领域的ILR性能。**
...
- **简介: 该论文属于图像恢复任务，旨在防御未经授权的知识蒸馏攻击。作者提出ASVP方法，通过在特征空间中进行奇异值扰动，破坏学生模型的学习效果，同时保持教师模型的输出质量。实验表明该方法在多个图像恢复任务中均有效抑制蒸馏攻击。**
...
- **简介: 该论文属于视频质量评估（VQA）任务，旨在解决现有模型泛化性差、可解释性低和扩展性弱的问题。论文提出Q-Router框架，通过多层级模型路由系统动态选择专家模型，并结合视觉-语言模型实现视频语义驱动的评估与时空伪影定位，提升了模型在多样视频源和任务上的性能与可解释性。**
...
- **简介: 该论文属于视频生成任务，旨在解决长视频生成中的误差累积和场景单一问题。论文提出Stable Video Infinity（SVI），通过“错误回收微调”方法，使模型能自我纠正生成过程中的错误，实现无限长度、高时间一致性的视频生成，并支持多样化条件输入。**
...
- **简介: 该论文属于医学视觉-语言理解任务，旨在解决临床决策中多模态数据整合难题。论文提出了Hulu-Med，一个透明的通用医学视觉-语言模型，统一理解文本、2D/3D图像和视频，通过渐进式训练实现高效多模态学习，开源代码提升医疗AI可及性。**
...
- **简介: 该论文属于文本到图像生成任务，旨在解决自回归模型生成速度慢的问题。作者提出了一种名为SJD2的方法，通过引入去噪过程和雅可比迭代，实现并行生成图像标记，减少模型前向计算次数，同时保持图像质量。**
...
- **简介: 该论文属于视频深度估计任务，旨在解决现有方法无法在线处理且显存消耗高的问题。作者提出oVDA，借鉴大语言模型技术，实现低显存、高精度的在线视频深度预测，适用于边缘设备部署。**
...
- **简介: 该论文属于医学图像翻译任务，旨在解决扩散模型在生成医学图像时细节丢失、尤其是病灶区域重建不准确的问题。作者提出了一种结合病灶感知目标的扩散模型后训练方法，提升了从CT灌注合成扩散MRI图像的质量与病灶勾画精度。**
...
- **简介: 该论文属于医学信号处理任务，旨在解决癫痫患者中高频振荡（HFOs）的自动检测问题。作者提出一种基于S变换和无监督聚类的新方法，有效区分HFOs与干扰信号，在控制数据和临床数据中均表现优异，并验证了HFOs作为癫痫灶生物标志物的价值。**
...
- **简介: 该论文属于多尺度空间推理任务，旨在解决现有方法依赖室内3D扫描与手动标注、缺乏全尺度建模能力的问题。作者构建了大规模数据集SpaceVista-1M和模型SpaceVista-7B，实现从毫米到千米的全尺度空间智能推理，并提出渐进训练策略缓解知识冲突，提升了跨场景泛化能力。**
...
- **简介: 该论文属于计算机视觉任务，旨在解决基于Transformer的目标检测模型（DETR）推理效率低的问题。作者分析DETR中MLP层的固有稀疏性，提出两种无需重新训练的稀疏化方法：静态的SIBS和动态的MGS。其中MGS通过轻量级门控机制实现高稀疏性，在COCO数据集上显著减少计算量，同时保持或提升检测性能。**
...
- **简介: 论文提出Cattle-CLIP，一种用于牛行为识别的多模态深度学习框架。该工作属于视频行为识别任务，旨在解决农业中牛行为自动监测的问题，特别是在数据稀缺情况下的识别准确性。通过改进CLIP模型并引入时间整合模块、数据增强策略和文本提示，提升了识别性能。在自建的CattleBehaviours6数据集上验证，取得了高准确率和良好泛化能力。**
...
>
---
#### [new 059] Diagonal Artifacts in Samsung Images: PRNU Challenges and Solutions
- **分类: cs.CV**

- **简介: 该论文属于图像取证任务，旨在解决三星手机图像中的对角线伪影影响源验证的问题。作者分析了伪影在不同机型中的表现，提出使用RAW图像进行可靠验证，并探讨了伪影在HDR和人像模式中的应用。**

- **链接: [http://arxiv.org/pdf/2510.09509v1](http://arxiv.org/pdf/2510.09509v1)**
...
>
---
#### [new 060] Reproducible Evaluation of Data Augmentation and Loss Functions for Brain Tumor Segmentation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分割任务，旨在解决脑肿瘤MRI图像分割中的类别不平衡和模型泛化问题。作者通过实验评估了U-Net结合焦点损失和三种数据增强方法的效果，取得了90%的精度，并提供了可复现的代码和结果，为后续研究建立基准。**

- **链接: [http://arxiv.org/pdf/2510.08617v1](http://arxiv.org/pdf/2510.08617v1)**

> **作者:** Saumya B
>
> **备注:** Code and results available at https://github.com/Saumya4321/2d-brain-tumor-segmentation
>
...
>
---
#### [new 061] Vision Language Models: A Survey of 26K Papers
- **分类: cs.CV**

- **简介: 该论文属于科研趋势分析任务，旨在梳理计算机视觉与机器学习领域的研究动态。通过分析26,104篇论文的标题与摘要，识别研究热点与演变趋势，揭示三大宏观变化：多模态视觉语言模型的崛起、生成模型的扩展及3D与视频理解的进展。论文还比较了不同会议的研究侧重点，并公开方法与词典，以支持后续研究。**

- **链接: [http://arxiv.org/pdf/2510.09586v1](http://arxiv.org/pdf/2510.09586v1)**
...
>
---
#### [new 062] Modern Deep Learning Approaches for Cricket Shot Classification: A Comprehensive Baseline Study
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于体育视频分析任务，旨在解决从视频中准确分类板球击球动作的问题。作者系统比较了七种深度学习方法在统一基准上的表现，发现文献中声称的高准确率在实际复现中显著降低。通过使用现代架构如EfficientNet-B0与GRU结合，取得了92.25%的准确率，展示了标准化评估和现代方法的重要性。**

- **链接: [http://arxiv.org/pdf/2510.09187v1](http://arxiv.org/pdf/2510.09187v1)**
...
>
---
#### [new 063] Dynamic Weight-based Temporal Aggregation for Low-light Video Enhancement
- **分类: cs.CV**

- **简介: 该论文属于低光视频增强任务，旨在解决低光视频中的噪声、低对比度和颜色失真问题。论文提出了DWTA-Net框架，通过结合短时和长时时间信息，利用动态权重聚合和光流优化，提升了视频的亮度、颜色和结构一致性，并有效抑制噪声与伪影。**

- **链接: [http://arxiv.org/pdf/2510.09450v1](http://arxiv.org/pdf/2510.09450v1)**
...
>
---
#### [new 064] VITA-VLA: Efficiently Teaching Vision-Language Models to Act via Action Expert Distillation
- **分类: cs.CV**

- **简介: 该论文属于视觉-语言动作（VLA）模型任务，旨在解决训练成本高的问题。通过知识蒸馏方法，将小动作模型的知识转移到预训练视觉-语言模型中，仅添加动作标记和状态编码器，实现高效动作生成，在多个任务上表现优异。**

- **链接: [http://arxiv.org/pdf/2510.09607v1](http://arxiv.org/pdf/2510.09607v1)**
...
>
---
#### [new 065] FSP-DETR: Few-Shot Prototypical Parasitic Ova Detection
- **分类: cs.CV**

- **简介: 该论文属于医学图像检测任务，旨在解决标注数据稀缺及新类别识别问题。提出FSP-DETR框架，结合DETR与原型学习，统一实现少样本检测、开集识别与跨任务泛化。通过联合优化多损失函数，提升特征判别能力，并支持推理阶段灵活适应新类别与任务，无需重新训练。**

- **链接: [http://arxiv.org/pdf/2510.09583v1](http://arxiv.org/pdf/2510.09583v1)**
...
>
---
#### [new 066] Instance-Aware Robust Consistency Regularization for Semi-Supervised Nuclei Instance Segmentation
- **分类: cs.CV**

- **简介: 该论文属于医学图像分析任务，旨在解决半监督条件下的细胞核实例分割问题。现有方法在一致性正则化和伪标签生成方面存在不足。论文提出IRCR-Net，通过MIAC和PIAC机制结合先验知识，提升密集和重叠细胞核的分割效果，并减少训练中的伪标签噪声。**

- **链接: [http://arxiv.org/pdf/2510.09329v1](http://arxiv.org/pdf/2510.09329v1)**
...
>
---
#### [new 067] Hierarchical Scheduling for Multi-Vector Image Retrieval
- **分类: cs.CV; cs.DC; cs.IR**

- **简介: 该论文属于图像检索任务，旨在解决多模态检索中查询与图像对象对齐不足、检索效率低的问题。提出了HiMIR框架，采用多层次粒度增强对齐，利用跨层次相似性和层次稀疏性减少冗余计算，并自动配置参数。实验表明其在准确率和计算效率上均优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.08976v1](http://arxiv.org/pdf/2510.08976v1)**
...
>
---
#### [new 068] The Digital Mirror: Gender Bias and Occupational Stereotypes in AI-Generated Images
- **分类: cs.CV**

- **简介: 该论文研究AI生成图像中的性别偏见与职业刻板印象，属于图像生成与社会偏见分析任务。旨在解决AI图像工具可能强化性别刻板印象的问题。通过分析DALL-E 3和Ideogram生成的750多张职业图像，发现两者均在不同程度上强化传统性别 stereotype。提出应采取措施以提升AI生成图像的多样性与公平性。**

- **链接: [http://arxiv.org/pdf/2510.08628v1](http://arxiv.org/pdf/2510.08628v1)**

> **作者:** Siiri Leppälampi; Sonja M. Hyrynsalmi; Erno Vanhala
>
...
>
---
#### [new 069] Towards Safer and Understandable Driver Intention Prediction
- **分类: cs.CV; cs.AI; cs.HC**

- **简介: 该论文属于自动驾驶中驾驶员意图预测任务，旨在提升模型可解释性以增强安全性。作者构建了DAAD-X数据集，提出了视频概念瓶颈模型（VCBM），并验证了其在生成时空连贯解释上的有效性，表明Transformer模型比CNN更具可解释性。**

- **链接: [http://arxiv.org/pdf/2510.09200v1](http://arxiv.org/pdf/2510.09200v1)**
...
>
---
#### [new 070] Enhancing Infrared Vision: Progressive Prompt Fusion Network and Benchmark
- **分类: cs.CV**

- **简介: 该论文属于红外图像增强任务，旨在解决红外图像中多种复杂退化难以同时处理的问题。作者提出了一种渐进式提示融合网络（PPFN）和选择性渐进训练机制（SPT），并构建了高质量多场景红外图像基准，以提升红外图像的去噪、细节保留和对比度增强效果。**

- **链接: [http://arxiv.org/pdf/2510.09343v1](http://arxiv.org/pdf/2510.09343v1)**
...
>
---
#### [new 071] Diagnosing Shoulder Disorders Using Multimodal Large Language Models and Consumer-Grade Cameras
...
>
---
#### [new 072] PhysToolBench: Benchmarking Physical Tool Understanding for MLLMs
- **分类: cs.CV; cs.RO**
...
>
---
#### [new 073] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
- **分类: cs.CV**

- **简介: 该论文属于三维重建任务，旨在解决动态城市场景中3D高斯点云初始化不完整导致的渲染失真问题。论文提出VAD-GS框架，通过可见性分析、视角选择与多视角立体重建，有效恢复缺失几何结构，提升重建质量。**

- **链接: [http://arxiv.org/pdf/2510.09364v1](http://arxiv.org/pdf/2510.09364v1)**
...
>
---
#### [new 074] Into the Rabbit Hull: From Task-Relevant Concepts in DINO to Minkowski Geometry
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于计算机视觉与模型解释任务，旨在探究DINOv2模型的内部表示机制。通过构建32,000单元的SAE字典，分析其在分类、分割和深度估计中的功能特性，发现表示结构超越线性稀疏性，提出基于凸组合原型的Minkowski表示假设，为理解视觉Transformer提供新视角。**

- **链接: [http://arxiv.org/pdf/2510.08638v1](http://arxiv.org/pdf/2510.08638v1)**
...
>
---
#### [new 075] Alignment, Mining and Fusion: Representation Alignment with Hard Negative Mining and Selective Knowledge Fusion for Medical Visual Question Answering
- **分类: cs.CV**

- **简介: 该论文属于医学视觉问答（Med-VQA）任务，旨在解决多模态对齐、难负样本挖掘和知识融合问题。作者提出了一种统一的多级对齐框架，结合对比学习与最优传输理论，引入软标签进行难负样本挖掘，并设计了门控交叉注意力模块以选择性融合知识。方法在多个Med-VQA数据集上超越了现有最优表现。**

- **链接: [http://arxiv.org/pdf/2510.08791v1](http://arxiv.org/pdf/2510.08791v1)**
...
>
---
#### [new 076] Uncolorable Examples: Preventing Unauthorized AI Colorization via Perception-Aware Chroma-Restrictive Perturbation
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于图像生成任务，旨在解决未经授权的AI彩色化导致的版权问题。作者提出了一种防御方法PAChroma，通过在灰度图像中添加不可察觉的扰动，使未经授权的彩色化效果变差，同时保持图像视觉质量。方法满足有效性、不可察觉性、可迁移性和鲁棒性四个标准。**

- **链接: [http://arxiv.org/pdf/2510.08979v1](http://arxiv.org/pdf/2510.08979v1)**
...
>
---
#### [new 077] A Novel Multi-branch ConvNeXt Architecture for Identifying Subtle Pathological Features in CT Scans
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于医学图像分析任务，旨在解决CT扫描中细微病理特征识别问题。为实现此目标，作者提出了一种新颖的多分支ConvNeXt架构，融合全局平均池化、全局最大池化和注意力加权池化机制，并采用严谨的数据处理和两阶段训练策略。实验表明，该模型在COVID-19诊断中表现优异，性能优于现有模型。**

- **链接: [http://arxiv.org/pdf/2510.09107v1](http://arxiv.org/pdf/2510.09107v1)**
...
>
---
#### [new 078] A methodology for clinically driven interactive segmentation evaluation
- **分类: cs.CV; cs.AI; cs.LG**

- **简介: 该论文属于医学图像分割任务，旨在解决交互式分割算法评估不一致、不贴近临床的问题。作者提出了一种基于临床需求的评估方法论，构建了标准化评估框架，并通过实验得出影响模型鲁棒性的关键因素。**

- **链接: [http://arxiv.org/pdf/2510.09499v1](http://arxiv.org/pdf/2510.09499v1)**
...
>
---
#### [new 079] D-TPT: Dimensional Entropy Maximization for Calibrating Test-Time Prompt Tuning in Vision-Language Models
- **分类: cs.CV; cs.LG**

- **简介: 论文属于视觉-语言模型（VLM）测试时提示调优任务，旨在解决跨模态领域适应中的模态差距和校准性能下降问题。作者提出D-TPT方法，通过最大化文本特征的维度熵，缓解模型对主导特征维度的依赖，从而提升VLM在实际应用中的可靠性。**

- **链接: [http://arxiv.org/pdf/2510.09473v1](http://arxiv.org/pdf/2510.09473v1)**
...
>
---
#### [new 080] PHyCLIP: $\ell_1$-Product of Hyperbolic Factors Unifies Hierarchy and Compositionality in Vision-Language Representation Learning
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于视觉-语言表示学习任务，旨在同时建模语义层次结构与组合性。现有方法难以统一表达概念内的层次（如动物→哺乳动物→狗）和跨概念的组合（如“车里的狗”）。作者提出PHyCLIP，采用$\ell_1$-Product度量结合多个双曲空间因子，分别捕捉层次与组合结构。实验表明其在多项任务上优于单空间方法，且嵌入空间更具可解释性。**

- **链接: [http://arxiv.org/pdf/2510.08919v1](http://arxiv.org/pdf/2510.08919v1)**
...
>
---
#### [new 081] Spotlight on Token Perception for Multimodal Reinforcement Learning
- **分类: cs.CV**

- **简介: 该论文属于多模态强化学习任务，旨在解决现有方法忽视视觉感知在推理中的作用问题。作者提出了一种新的策略优化算法VPPO，通过分析每个生成token的视觉依赖性，重新加权优势并专注于关键token，从而提升多模态推理能力。**

- **链接: [http://arxiv.org/pdf/2510.09285v1](http://arxiv.org/pdf/2510.09285v1)**
...
>
---
#### [new 082] Detecting spills using thermal imaging, pretrained deep learning models, and a robotic platform
- **分类: cs.CV; cs.LG; cs.RO**
...
>
---
#### [new 083] TARO: Toward Semantically Rich Open-World Object Detection
- **分类: cs.CV**

- **简介: 论文提出TARO，用于开放世界目标检测任务，旨在解决传统检测模型在面对未知类别时仅标记为“Unknown”不够细致的问题。TARO通过语义层次结构，将未知目标进一步分类到更具体的父类，提升自动驾驶等安全关键场景中的决策能力。**

- **链接: [http://arxiv.org/pdf/2510.09173v1](http://arxiv.org/pdf/2510.09173v1)**
...
>
---
#### [new 084] PRNet: Original Information Is All You Have
- **分类: cs.CV**

- **简介: 该论文属于小目标检测任务，旨在解决航空图像中小目标因像素表示有限导致的信息退化问题。作者提出PRNet框架，包含PRN模块实现空间-语义对齐，ESSamp模块保留浅层信息，有效提升小目标检测精度与效率。**

- **链接: [http://arxiv.org/pdf/2510.09531v1](http://arxiv.org/pdf/2510.09531v1)**
...
>
---
#### [new 085] RO-Bench: Large-scale robustness evaluation of MLLMs with text-driven counterfactual videos
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于视频理解任务，旨在评估和提升多模态大语言模型（MLLMs）在面对反事实视频内容时的鲁棒性。论文构建了Ro-Bench基准，包含风格、对象和背景编辑的高质量视频，验证了当前模型在该基准上的性能下降，并通过反事实数据微调提升了模型表现。**

- **链接: [http://arxiv.org/pdf/2510.08936v1](http://arxiv.org/pdf/2510.08936v1)**
...
>
---
#### [new 086] Hi-OSCAR: Hierarchical Open-set Classifier for Human Activity Recognition
- **分类: cs.CV; cs.AI; I.2**

- **简介: 该论文属于人类活动识别（HAR）任务，旨在解决开放集场景下未见活动的识别与拒绝问题。作者提出了Hi-OSCAR，一种分层开放集分类器，可准确定位已知活动，并将未知活动归类到最近的父节点，提供更细粒度的识别结果。此外，作者发布了新数据集NFI_FARED，支持开放集HAR研究。**

- **链接: [http://arxiv.org/pdf/2510.08635v1](http://arxiv.org/pdf/2510.08635v1)**

> **作者:** Conor McCarthy; Loes Quirijnen; Jan Peter van Zandwijk; Zeno Geradts; Marcel Worring
>
...
>
---
#### [new 087] MomentSeg: Moment-Centric Sampling for Enhanced Video Pixel Understanding
- **分类: cs.CV**

- **简介: 该论文属于视频目标分割任务，旨在通过自然语言描述分割视频中的目标物体。现有方法依赖手工规则或外部模型选择关键帧，忽略时间线索或增加复杂度。论文提出MomentSeg框架，结合时间句子定位与分割，引入[FIND]标记识别关键时刻，并设计MCS采样策略和BAP传播方法，提升分割精度与稳定性。**

- **链接: [http://arxiv.org/pdf/2510.09274v1](http://arxiv.org/pdf/2510.09274v1)**
...
>
---
#### [new 088] Out-of-Distribution Detection in LiDAR Semantic Segmentation Using Epistemic Uncertainty from Hierarchical GMMs
- **分类: cs.CV; cs.LG**

- **简介: 该论文属于激光雷达语义分割任务，旨在解决未知类别物体的检测问题。现有方法混淆模型和数据不确定性，导致误判。作者提出一种基于分层贝叶斯建模的无监督方法，分离模型不确定性，提升检测性能。**

- **链接: [http://arxiv.org/pdf/2510.08631v1](http://arxiv.org/pdf/2510.08631v1)**
...
>
---
#### [new 089] RadioFlow: Efficient Radio Map Construction Framework with Flow Matching
- **分类: cs.CV**

- **简介: 论文提出RadioFlow，一种基于流匹配的射频图生成框架，用于解决现有扩散模型在参数量、推理速度等方面的瓶颈问题。该工作实现了更高效的单步采样，提升了生成效率与精度，适用于6G网络中的电磁数字孪生构建任务。**

- **链接: [http://arxiv.org/pdf/2510.09314v1](http://arxiv.org/pdf/2510.09314v1)**
...
>
---
#### [new 090] TC-LoRA: Temporally Modulated Conditional LoRA for Adaptive Diffusion Control
- **分类: cs.CV**

- **简介: 该论文属于图像生成任务，旨在解决可控扩散模型在动态生成过程中适应性不足的问题。作者提出TC-LoRA方法，通过在扩散过程中动态调整模型权重，实现更精确的条件控制，从而提升生成质量和对空间条件的匹配能力。**

- **链接: [http://arxiv.org/pdf/2510.09561v1](http://arxiv.org/pdf/2510.09561v1)**
...
>
---
#### [new 091] Boosting Multi-modal Keyphrase Prediction with Dynamic Chain-of-Thought in Vision-Language Models
- **分类: cs.CV**

- **简介: 该论文属于多模态关键短语预测（MMKP）任务，旨在解决传统方法在处理缺失和未见场景中的局限性及现有基准测试高估模型能力的问题。论文提出利用视觉-语言模型（VLMs），通过零样本、监督微调评估性能下限，并引入基于高质量推理数据的Fine-tune-CoT和动态CoT策略，以提升复杂推理能力和避免“过度思考”现象。**

- **链接: [http://arxiv.org/pdf/2510.09358v1](http://arxiv.org/pdf/2510.09358v1)**
...
>
---
#### [new 092] SAFER-AiD: Saccade-Assisted Foveal-peripheral vision Enhanced Reconstruction for Adversarial Defense
- **分类: cs.CV; cs.AI**

- **简介: 该论文属于图像分类任务，旨在提升深度学习模型对抗攻击的鲁棒性。受人类视觉系统启发，提出SAFER-AiD框架，结合注视点处理、眼跳采样和皮层填充机制，通过强化学习引导采样并重建图像，有效抑制对抗噪声，无需重新训练分类器。实验验证了其在ImageNet上的有效性。**

- **链接: [http://arxiv.org/pdf/2510.08761v1](http://arxiv.org/pdf/2510.08761v1)**

> **作者:** Jiayang Liu; Daniel Tso; Yiming Bu; Qinru Qiu
>
...
>
---
#### [new 093] Goal-oriented Backdoor Attack against Vision-Language-Action Models via Physical Objects
- **分类: cs.CR; cs.CV; cs.LG**

- **简介: 论文研究视觉-语言-动作（VLA）模型的安全问题，提出一种基于物理物体触发的目标导向后门攻击方法GoBA。通过在训练数据中注入特定物理物体作为触发器，使模型在正常输入下表现正常，而在触发器存在时执行预设恶意动作。实验表明攻击成功率高且难以察觉。**

- **链接: [http://arxiv.org/pdf/2510.09269v1](http://arxiv.org/pdf/2510.09269v1)**
...
>
---
#### [new 094] The Boundaries of Fair AI in Medical Image Prognosis: A Causal Perspective
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于医学图像预后任务，旨在解决时间事件预测中的公平性问题。作者提出了FairTTE框架，结合因果分析技术，评估并量化医学影像数据中的偏差来源，揭示现有方法在不同影像模态中对偏差缓解的局限性，并强调需更全面、稳健的公平性方法。**

- **链接: [http://arxiv.org/pdf/2510.08840v1](http://arxiv.org/pdf/2510.08840v1)**

> **作者:** Thai-Hoang Pham; Jiayuan Chen; Seungyeon Lee; Yuanlong Wang; Sayoko Moroi; Xueru Zhang; Ping Zhang
>
...
>
---
#### [new 095] Efficient Bayesian Inference from Noisy Pairwise Comparisons
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于生成模型评估任务，旨在解决人类评估成本高且存在噪声的问题。通过引入BBQ模型，基于贝叶斯推理和Bradley-Terry方法，对评估者质量进行建模，提高评估的鲁棒性和可解释性，实现更可靠和经济的人类评估。**

- **链接: [http://arxiv.org/pdf/2510.09333v1](http://arxiv.org/pdf/2510.09333v1)**
...
>
---
#### [new 096] STaTS: Structure-Aware Temporal Sequence Summarization via Statistical Window Merging
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于时间序列建模任务，旨在解决现有方法忽略时间结构、效率低的问题。作者提出STaTS，一种无监督的时间序列压缩框架，通过统计窗口合并，自适应提取结构信息，实现高效、鲁棒的序列摘要，在分类与预测任务中表现优异。**

- **链接: [http://arxiv.org/pdf/2510.09593v1](http://arxiv.org/pdf/2510.09593v1)**
...
>
---
#### [new 097] Reinforcement Learning-Driven Edge Management for Reliable Multi-view 3D Reconstruction
- **分类: cs.LG; cs.AI; cs.CV; cs.DC; cs.GR; cs.MM**

- **简介: 该论文属于边缘计算与三维重建任务，旨在解决资源受限和易受干扰环境下多视角实时3D重建的可靠性问题。论文提出了一种基于强化学习的边缘资源管理框架，采用两个协同Q学习代理进行摄像头和服务器选择，以平衡端到端延迟与重建质量。通过实验测试验证了框架在动态环境中的有效性。**

- **链接: [http://arxiv.org/pdf/2510.08839v1](http://arxiv.org/pdf/2510.08839v1)**
...
>
---
#### [new 098] Sparse components distinguish visual pathways & their alignment to neural networks
- **分类: cs.LG; cs.CV**

- **简介: 该论文属于神经科学与人工智能交叉任务，旨在探究人脑视觉通路与深度神经网络（DNNs）表示之间的对齐关系。为解决传统方法难以刻画神经调谐差异的问题，作者提出稀疏成分分解与稀疏成分对齐（SCA）方法，揭示DNN更贴近腹侧视觉通路的表示特性。**

- **链接: [http://arxiv.org/pdf/2510.08858v1](http://arxiv.org/pdf/2510.08858v1)**

> **作者:** Ammar I Marvi; Nancy G Kanwisher; Meenakshi Khosla
>
...
>
---
#### [new 099] Rewiring Development in Brain Segmentation: Leveraging Adult Brain Priors for Enhancing Infant MRI Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在解决婴儿脑部MRI分割不准确的问题。通过迁移成人脑分割模型的先验知识，结合弱监督学习与领域自适应方法，提出LODi框架，提升婴儿脑MRI的分割效果，克服数据少、结构变化大等挑战。**

- **链接: [http://arxiv.org/pdf/2510.09306v1](http://arxiv.org/pdf/2510.09306v1)**
...
>
---
#### [new 100] Dyna-Mind: Learning to Simulate from Experience for Better AI Agents
...
>
---
#### [new 101] A 3D Generation Framework from Cross Modality to Parameterized Primitive
- **分类: cs.GR; cs.AI; cs.CV**

- **简介: 该论文属于3D模型生成任务，旨在解决生成模型表面不光滑和存储开销大的问题。论文提出了一种基于参数化基元的多阶段框架，利用文本和图像输入生成高质量3D模型，并设计了保留表面质量的存储方法。实验表明方法在多个指标上表现优异，适合简单模型的快速原型设计。**

- **链接: [http://arxiv.org/pdf/2510.08656v1](http://arxiv.org/pdf/2510.08656v1)**

> **作者:** Yiming Liang; Huan Yu; Zili Wang; Shuyou Zhang; Guodong Yi; Jin Wang; Jianrong Tan
>
...
>
---
#### [new 102] Unified World Models: Memory-Augmented Planning and Foresight for Visual Navigation
...
>
---
#### [new 103] Identifying & Interactively Refining Ambiguous User Goals for Data Visualization Code Generation
...
>
---
#### [new 104] Bi-level Meta-Policy Control for Dynamic Uncertainty Calibration in Evidential Deep Learning
- **分类: cs.LG; cs.CV**

- **简介: 论文属于不确定性建模任务，旨在解决传统EDL方法在动态数据分布下校准能力差的问题。作者提出MPC框架，通过双层优化动态调整KL散度系数和狄利克雷先验强度，提升模型在高风险决策中的不确定性和预测性能。**

- **链接: [http://arxiv.org/pdf/2510.08938v1](http://arxiv.org/pdf/2510.08938v1)**
...
>
---
#### [new 105] Progressive Uncertainty-Guided Evidential U-KAN for Trustworthy Medical Image Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像分割任务，旨在提升分割结果的准确性和可靠性。针对现有证据深度学习方法忽略利用不确定性图优化模糊边界分割的问题，作者提出了一种渐进式不确定性引导注意力机制（PEUA）和语义保持证据学习策略（SAEL），并将其嵌入U-KAN网络，形成Evidential U-KAN，以更好地处理复杂区域的特征学习与不确定性建模。**

- **链接: [http://arxiv.org/pdf/2510.08949v1](http://arxiv.org/pdf/2510.08949v1)**
...
>
---
#### [new 106] Auto-scaling Continuous Memory for GUI Agent
...
>
---
#### [new 107] Look before Transcription: End-to-End SlideASR with Visually-Anchored Policy Optimization
...
>
---
#### [new 108] MMAudioSep: Taming Video-to-Audio Generative Model Towards Video/Text-Queried Sound Separation
...
>
---
#### [new 109] FS-RWKV: Leveraging Frequency Spatial-Aware RWKV for 3T-to-7T MRI Translation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于医学图像合成任务，旨在解决从低场强3T MRI合成高分辨率7T MRI图像的问题。通过提出FS-RWKV模型，结合频率空间全局建模与结构保真增强，提升图像质量与细节还原。**

- **链接: [http://arxiv.org/pdf/2510.08951v1](http://arxiv.org/pdf/2510.08951v1)**
...
>
---
#### [new 110] A Biophysically-Conditioned Generative Framework for 3D Brain Tumor MRI Synthesis
- **分类: eess.IV; cs.CV; cs.LG**

- **简介: 该论文属于医学图像生成任务，旨在解决脑肿瘤MRI图像修复问题。作者提出了一种基于生物物理条件的生成框架，利用潜在扩散模型，结合组织分割和肿瘤浓度信息，实现高质量的3D脑肿瘤MRI合成与健康组织修复。**

- **链接: [http://arxiv.org/pdf/2510.09365v1](http://arxiv.org/pdf/2510.09365v1)**
...
>
---
#### [new 111] OSCAR: Orthogonal Stochastic Control for Alignment-Respecting Diversity in Flow Matching
- **分类: cs.AI; cs.CV**

- **简介: 论文提出OSCAR方法，用于文本到图像生成任务，解决多样性不足问题。通过推理阶段控制流的正交随机扰动，在保持图像质量和提示对齐的同时提升生成多样性，无需重新训练模型。**

- **链接: [http://arxiv.org/pdf/2510.09060v1](http://arxiv.org/pdf/2510.09060v1)**
...
>
---
#### [new 112] Generating Sizing Fields for Mesh Generation via GCN-based Simplification of Adaptive Background Grids
- **分类: cs.GR; cs.CV**

- **简介: 该论文属于网格生成任务，旨在解决背景网格简化问题。通过构建基于图卷积网络（GCN）的自适应背景网格简化框架，将网格简化转化为边评分回归问题，实现高效生成高质量的网格。方法兼顾几何保真度与尺寸场精度，显著减少网格元素数量及查询时间。**

- **链接: [http://arxiv.org/pdf/2510.08645v1](http://arxiv.org/pdf/2510.08645v1)**

> **作者:** Xunyang Zhu; Hongfei Ye; Yifei Wang; Taoran Liu; Jianjun Chen
>
...
>
---
#### [new 113] FreqCa: Accelerating Diffusion Models via Frequency-Aware Caching
- **分类: cs.LG; cs.AI; cs.CV**

- **简介: 该论文属于图像生成任务，旨在加速扩散模型推理。针对特征缓存方法在相邻时间步特征相似性假设不成立的问题，论文提出FreqCa，通过频域分析发现低频结构特征适合直接复用，而高频细节特征适合插值预测，从而设计频率感知的缓存策略，并提出缓存累积残差特征以减少内存占用，有效提升推理效率。**

- **链接: [http://arxiv.org/pdf/2510.08669v1](http://arxiv.org/pdf/2510.08669v1)**

> **作者:** Jiacheng Liu; Peiliang Cai; Qinming Zhou; Yuqi Lin; Deyang Kong; Benhao Huang; Yupei Pan; Haowen Xu; Chang Zou; Junshu Tang; Shikang Zheng; Linfeng Zhang
>
...
>
---
#### [new 114] SAM2-3dMed: Empowering SAM2 for 3D Medical Image Segmentation
- **分类: eess.IV; cs.CV**

- **简介: 该论文属于3D医学图像分割任务，旨在解决SAM2模型在医学图像中因缺乏时间连续性和边界精度导致的性能下降问题。论文提出了SAM2-3dMed框架，通过引入切片相对位置预测和边界检测模块，提升分割精度。实验表明其在多个医学数据集上优于现有方法。**

- **链接: [http://arxiv.org/pdf/2510.08967v1](http://arxiv.org/pdf/2510.08967v1)**
...
>
---
#### [new 115] Interlaced dynamic XCT reconstruction with spatio-temporal implicit neural representations
- **分类: eess.IV; cond-mat.mtrl-sci; cs.CV**

- **简介: 该论文属于动态X射线断层扫描（XCT）重建任务，旨在解决欠采样和噪声干扰下的高质量图像重建问题。论文提出了一种基于时空隐式神经表示（INRs）的重建方法，结合ADMM优化与INCODE框架，提升了重建效果，并探索了噪声建模、探测器非理想性建模及4D并行重建等实用化扩展。**

- **链接: [http://arxiv.org/pdf/2510.08641v1](http://arxiv.org/pdf/2510.08641v1)**
...
#### [replaced 001] G$^2$RPO: Granular GRPO for Precise Reward in Flow Models
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.01982v2](http://arxiv.org/pdf/2510.01982v2)**
...
>
---
#### [replaced 005] Unified Multimodal Model as Auto-Encoder
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.09666v3](http://arxiv.org/pdf/2509.09666v3)**
...
>
---
#### [replaced 006] AMFT: Aligning LLM Reasoners by Meta-Learning the Optimal Imitation-Exploration Balance
...
>
---
#### [replaced 007] Visual Representation Alignment for Multimodal Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.07979v2](http://arxiv.org/pdf/2509.07979v2)**
...
>
---
#### [replaced 008] A Survey on Self-supervised Contrastive Learning for Multimodal Text-Image Analysis
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2503.11101v5](http://arxiv.org/pdf/2503.11101v5)**
...
>
---
#### [replaced 009] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.23044v2](http://arxiv.org/pdf/2505.23044v2)**
...
>
---
#### [replaced 010] Interpretable and Granular Video-Based Quantification of Motor Characteristics from the Finger Tapping Test in Parkinson Disease
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.18925v2](http://arxiv.org/pdf/2506.18925v2)**
...
>
---
#### [replaced 014] TBStar-Edit: From Image Editing Pattern Shifting to Consistency Enhancement
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.04483v2](http://arxiv.org/pdf/2510.04483v2)**
...
>
---
#### [replaced 015] EMedNeXt: An Enhanced Brain Tumor Segmentation Framework for Sub-Saharan Africa using MedNeXt V2 with Deep Supervision
- **分类: eess.IV; cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23256v3](http://arxiv.org/pdf/2507.23256v3)**
...
>
> **备注:** Won Third Place Award at Challenge 5 at BraTS-Lighthouse 2025 Challenge (MICCAI 2025)
>
...
>
---
#### [replaced 016] MOCHA: Multi-modal Objects-aware Cross-arcHitecture Alignment
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2509.14001v3](http://arxiv.org/pdf/2509.14001v3)**
...
>
---
#### [replaced 017] A Multimodal Depth-Aware Method For Embodied Reference Understanding
...
>
---
#### [replaced 018] The Role of Video Generation in Enhancing Data-Limited Action Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.19495v2](http://arxiv.org/pdf/2505.19495v2)**
...
>
---
#### [replaced 019] The 1st Solution for CARE Liver Task Challenge 2025: Contrast-Aware Semi-Supervised Segmentation with Domain Generalization and Test-Time Adaptation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.04243v2](http://arxiv.org/pdf/2510.04243v2)**
...
>
> **摘要:** The widespread use of chest X-rays (CXRs), coupled with a shortage of radiologists, has driven growing interest in automated CXR analysis and AI-assisted reporting. While existing vision-language models (VLMs) show promise in specific tasks such as report generation or abnormality detection, they often lack support for interactive diagnostic capabilities. In this work we present RadVLM, a compact, multitask conversational foundation model designed for CXR interpretation. To this end, we curate a large-scale instruction dataset comprising over 1 million image-instruction pairs containing both single-turn tasks -- such as report generation, abnormality classification, and visual grounding -- and multi-turn, multi-task conversational interactions. After fine-tuning RadVLM on this instruction dataset, we evaluate it across different tasks along with re-implemented baseline VLMs. Our results show that RadVLM achieves state-of-the-art performance in conversational capabilities and visual grounding while remaining competitive in other radiology tasks. Ablation studies further highlight the benefit of joint training across multiple tasks, particularly for scenarios with limited annotated data. Together, these findings highlight the potential of RadVLM as a clinically relevant AI assistant, providing structured CXR interpretation and conversational capabilities to support more effective and accessible diagnostic workflows.
>
---
#### [replaced 022] Any-to-Bokeh: Arbitrary-Subject Video Refocusing with Video Diffusion Model
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2505.21593v3](http://arxiv.org/pdf/2505.21593v3)**

> **作者:** Yang Yang; Siming Zheng; Qirui Yang; Jinwei Chen; Boxi Wu; Xiaofei He; Deng Cai; Bo Li; Peng-Tao Jiang
>
> **备注:** project page: https://vivocameraresearch.github.io/any2bokeh/
>
> **摘要:** Diffusion models have recently emerged as powerful tools for camera simulation, enabling both geometric transformations and realistic optical effects. Among these, image-based bokeh rendering has shown promising results, but diffusion for video bokeh remains unexplored. Existing image-based methods are plagued by temporal flickering and inconsistent blur transitions, while current video editing methods lack explicit control over the focus plane and bokeh intensity. These issues limit their applicability for controllable video bokeh. In this work, we propose a one-step diffusion framework for generating temporally coherent, depth-aware video bokeh rendering. The framework employs a multi-plane image (MPI) representation adapted to the focal plane to condition the video diffusion model, thereby enabling it to exploit strong 3D priors from pretrained backbones. To further enhance temporal stability, depth robustness, and detail preservation, we introduce a progressive training strategy. Experiments on synthetic and real-world benchmarks demonstrate superior temporal coherence, spatial accuracy, and controllability, outperforming prior baselines. This work represents the first dedicated diffusion framework for video bokeh generation, establishing a new baseline for temporally coherent and controllable depth-of-field effects.
>
---
#### [replaced 023] Editable Noise Map Inversion: Encoding Target-image into Noise For High-Fidelity Image Manipulation
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.25776v2](http://arxiv.org/pdf/2509.25776v2)**
...
>
---
#### [replaced 024] RangeSAM: Leveraging Visual Foundation Models for Range-View repesented LiDAR segmentation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.15886v2](http://arxiv.org/pdf/2509.15886v2)**
...
>
---
#### [replaced 025] Towards Sequence Modeling Alignment between Tokenizer and Autoregressive Model
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.05289v2](http://arxiv.org/pdf/2506.05289v2)**
...
>
---
#### [replaced 026] LaV-CoT: Language-Aware Visual CoT with Multi-Aspect Reward Optimization for Real-World Multilingual VQA
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.10026v3](http://arxiv.org/pdf/2509.10026v3)**
...
>
---
#### [replaced 027] RAGDiffusion: Faithful Cloth Generation via External Knowledge Assimilation
- **分类: cs.CV; cs.AI; cs.GR; cs.LG**

- **链接: [http://arxiv.org/pdf/2411.19528v3](http://arxiv.org/pdf/2411.19528v3)**
...
>
---
#### [replaced 028] ProbRes: Probabilistic Jump Diffusion for Open-World Egocentric Activity Recognition
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.03948v2](http://arxiv.org/pdf/2504.03948v2)**
...
>
---
#### [replaced 029] Learning Neural Exposure Fields for View Synthesis
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2510.08279v2](http://arxiv.org/pdf/2510.08279v2)**
...
>
> **备注:** Accepted to NeurIPS 2025. Project page available at https://m-niemeyer.github.io/nexf/index.html
>
...
>
---
#### [replaced 030] RetouchLLM: Training-free Code-based Image Retouching with Vision Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.08054v2](http://arxiv.org/pdf/2510.08054v2)**
...
>
---
#### [replaced 031] Differentially Private 2D Human Pose Estimation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2504.10190v3](http://arxiv.org/pdf/2504.10190v3)**
...
>
---
#### [replaced 034] Enhancing Feature Fusion of U-like Networks with Dynamic Skip Connections
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.14610v2](http://arxiv.org/pdf/2509.14610v2)**
...
>
---
#### [replaced 035] Contour Errors: An Ego-Centric Metric for Reliable 3D Multi-Object Tracking
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.04122v2](http://arxiv.org/pdf/2506.04122v2)**
...
>
---
#### [replaced 036] Site-Level Fine-Tuning with Progressive Layer Freezing: Towards Robust Prediction of Bronchopulmonary Dysplasia from Day-1 Chest Radiographs in Extremely Preterm Infants
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2507.12269v3](http://arxiv.org/pdf/2507.12269v3)**
...
>
---
#### [replaced 037] MedCAL-Bench: A Comprehensive Benchmark on Cold-Start Active Learning with Foundation Models for Medical Image Analysis
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2508.03441v2](http://arxiv.org/pdf/2508.03441v2)**
...
>
---
#### [replaced 038] Improving Image Captioning Descriptiveness by Ranking and LLM-based Fusion
...
>
---
#### [replaced 039] One Stone with Two Birds: A Null-Text-Null Frequency-Aware Diffusion Models for Text-Guided Image Inpainting
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.08273v2](http://arxiv.org/pdf/2510.08273v2)**

> **作者:** Haipeng Liu; Yang Wang; Meng Wang
>
> **备注:** 25 pages, 11 figures, to appear at NeurIPS 2025
>
...
>
---
#### [replaced 040] Covariances for Free: Exploiting Mean Distributions for Training-free Federated Learning
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2412.14326v3](http://arxiv.org/pdf/2412.14326v3)**
...
>
---
#### [replaced 041] A Comprehensive Survey of Mamba Architectures for Medical Image Analysis: Classification, Segmentation, Restoration and Beyond
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2410.02362v3](http://arxiv.org/pdf/2410.02362v3)**
...
>
---
#### [replaced 044] UniLiP: Adapting CLIP for Unified Multimodal Understanding, Generation and Editing
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.23278v2](http://arxiv.org/pdf/2507.23278v2)**
...
>
---
#### [replaced 045] SkipClick: Combining Quick Responses and Low-Level Features for Interactive Segmentation in Winter Sports Contexts
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2501.07960v2](http://arxiv.org/pdf/2501.07960v2)**
...
>
---
#### [replaced 046] CQ-DINO: Mitigating Gradient Dilution via Category Queries for Vast Vocabulary Object Detection
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2503.18430v4](http://arxiv.org/pdf/2503.18430v4)**

> **作者:** Zhichao Sun; Huazhang Hu; Yidong Ma; Gang Liu; Yibo Chen; Xu Tang; Yao Hu; Yongchao Xu
>
> **备注:** Accepted at NeurIPS 2025
>
...
>
---
#### [replaced 047] TimeScope: Towards Task-Oriented Temporal Grounding In Long Videos
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.26360v2](http://arxiv.org/pdf/2509.26360v2)**
...
>
---
#### [replaced 048] Generate Any Scene: Scene Graph Driven Data Synthesis for Visual Generation Training
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2412.08221v3](http://arxiv.org/pdf/2412.08221v3)**
...
>
---
#### [replaced 049] CAPE: A CLIP-Aware Pointing Ensemble of Complementary Heatmap Cues for Embodied Reference Understanding
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.21888v2](http://arxiv.org/pdf/2507.21888v2)**
...
>
---
#### [replaced 050] DenseDPO: Fine-Grained Temporal Preference Optimization for Video Diffusion Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03517v2](http://arxiv.org/pdf/2506.03517v2)**
...
>
> **备注:** NeurIPS 2025 Spotlight. Project page: https://snap-research.github.io/DenseDPO/
>
...
>
---
#### [replaced 055] HoliTom: Holistic Token Merging for Fast Video Large Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2505.21334v3](http://arxiv.org/pdf/2505.21334v3)**
...
>
---
#### [replaced 056] ALISE: Annotation-Free LiDAR Instance Segmentation for Autonomous Driving
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2510.05752v2](http://arxiv.org/pdf/2510.05752v2)**
...
>
---
#### [replaced 057] UltraSeP: Sequence-aware Pre-training for Echocardiography Probe Movement Guidance
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2408.15026v3](http://arxiv.org/pdf/2408.15026v3)**
...
>
---
#### [replaced 058] Benchmarking and Mitigate Sycophancy in Medical Vision-Language Models
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2509.21979v2](http://arxiv.org/pdf/2509.21979v2)**
...
>
---
#### [replaced 059] High-Rate Mixout: Revisiting Mixout for Robust Domain Generalization
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.06955v2](http://arxiv.org/pdf/2510.06955v2)**

> **作者:** Masih Aminbeidokhti; Heitor Rapela Medeiros; Srikanth Muralidharan; Eric Granger; Marco Pedersoli
>
...
>
---
#### [replaced 065] RePIC: Reinforced Post-Training for Personalizing Multi-Modal Language Models
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2506.18369v4](http://arxiv.org/pdf/2506.18369v4)**
...
>
---
#### [replaced 066] Multimodal Language Models See Better When They Look Shallower
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2504.21447v2](http://arxiv.org/pdf/2504.21447v2)**
...
>
> **摘要:** Multimodal large language models (MLLMs) typically extract visual features from the final layers of a pretrained Vision Transformer (ViT). This widespread deep-layer bias, however, is largely driven by empirical convention rather than principled analysis. While prior studies suggest that different ViT layers capture different types of information, with shallower layers focusing on fine visual details and deeper layers aligning more closely with textual semantics, the impact of this variation on MLLM performance remains underexplored. We present the first comprehensive study of visual layer selection for MLLMs, analyzing representation similarity across ViT layers to establish shallow, middle, and deep layer groupings. Through extensive evaluation of MLLMs (1.4B-7B parameters) across 10 benchmarks encompassing 60+ tasks, we find that while deep layers excel in semantic-rich tasks like OCR, shallow and middle layers significantly outperform them on fine-grained visual tasks including counting, positioning, and object localization. Building on these insights, we propose a lightweight feature fusion method that strategically incorporates shallower layers, achieving consistent improvements over both single-layer and specialized fusion baselines. Our work offers the first principled study of visual layer selection in MLLMs, showing that MLLMs can often see better when they look shallower.
>
---
#### [replaced 067] Mem4Nav: Boosting Vision-and-Language Navigation in Urban Environments with a Hierarchical Spatial-Cognition Long-Short Memory System
- **分类: cs.CV; cs.AI; cs.CL**
...
>
---
#### [replaced 068] Solving Inverse Problems with FLAIR
- **分类: cs.CV; eess.IV**

- **链接: [http://arxiv.org/pdf/2506.02680v2](http://arxiv.org/pdf/2506.02680v2)**
...
>
---
#### [replaced 071] TTS-VAR: A Test-Time Scaling Framework for Visual Auto-Regressive Generation
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2507.18537v2](http://arxiv.org/pdf/2507.18537v2)**
...
>
---
#### [replaced 072] Robustness in Both Domains: CLIP Needs a Robust Text Encoder
- **分类: cs.LG; cs.AI; cs.CV**

- **链接: [http://arxiv.org/pdf/2506.03355v2](http://arxiv.org/pdf/2506.03355v2)**
...
>
---
#### [replaced 073] Understanding Ice Crystal Habit Diversity with Self-Supervised Learning
- **分类: physics.ao-ph; cs.CV**

- **链接: [http://arxiv.org/pdf/2509.07688v2](http://arxiv.org/pdf/2509.07688v2)**
...
>
---
#### [replaced 074] MultiMAE for Brain MRIs: Robustness to Missing Inputs Using Multi-Modal Masked Autoencoder
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.11442v2](http://arxiv.org/pdf/2509.11442v2)**
...
>
---
#### [replaced 075] VisionTS++: Cross-Modal Time Series Foundation Model with Continual Pre-trained Vision Backbones
- **分类: cs.CV; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.04379v3](http://arxiv.org/pdf/2508.04379v3)**
...
>
---
#### [replaced 076] HA-VLN 2.0: An Open Benchmark and Leaderboard for Human-Aware Navigation in Discrete and Continuous Environments with Dynamic Multi-Human Interactions
- **分类: cs.AI; cs.CV; cs.RO**
...
>
---
#### [replaced 077] AD-EE: Early Exiting for Fast and Reliable Vision-Language Models in Autonomous Driving
- **分类: cs.CV; cs.AI**

- **链接: [http://arxiv.org/pdf/2506.05404v2](http://arxiv.org/pdf/2506.05404v2)**

> **作者:** Lianming Huang; Haibo Hu; Yufei Cui; Jiacheng Zuo; Shangyu Wu; Nan Guan; Chun Jason Xue
>
> **备注:** We believe that the contribution of this paper is not enough, so we integrated it into another new paper. The arXiv ID of the new paper is arXiv:2510.01795
>
...
>
---
#### [replaced 078] Post-training quantization of vision encoders needs prefixing registers
- **分类: cs.LG; cs.CV**

- **链接: [http://arxiv.org/pdf/2510.04547v2](http://arxiv.org/pdf/2510.04547v2)**
...
>
---
#### [replaced 079] ACD-CLIP: Decoupling Representation and Dynamic Fusion for Zero-Shot Anomaly Detection
- **分类: cs.CV; cs.AI; cs.LG**

- **链接: [http://arxiv.org/pdf/2508.07819v5](http://arxiv.org/pdf/2508.07819v5)**

> **作者:** Ke Ma; Jun Long; Hongxiao Fei; Liujie Hua; Zhen Dai; Yueyi Luo
>
...
>
---
#### [replaced 080] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
- **分类: cs.CV**

- **链接: [http://arxiv.org/pdf/2509.07552v2](http://arxiv.org/pdf/2509.07552v2)**

> **作者:** Peng Li; Yisheng He; Yingdong Hu; Yuan Dong; Weihao Yuan; Yuan Liu; Siyu Zhu; Gang Cheng; Zilong Dong; Yike Guo
>
...
>
---
#### [replaced 081] TARO: Timestep-Adaptive Representation Alignment with Onset-Aware Conditioning for Synchronized Video-to-Audio Synthesis
